...
class SBOMReferenceOccurrence extends $pb.GeneratedMessage {
  factory SBOMReferenceOccurrence({
    ...
    $core.Iterable<$591.EnvelopeSignature>? signatures,
  }) {
    final $result = create();
    if (payload != null) {
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(
    ...
    ..pc<$591.EnvelopeSignature>(
        3, _omitFieldNames ? '' : 'signatures', $pb.PbFieldType.PM,
        subBuilder: $591.EnvelopeSignature.create)
    ..hasRequiredFields = false;
  ...
  @$pb.TagNumber(3)
  $core.List<$591.EnvelopeSignature> get signatures => $_getList(2);
}
...
class SbomReferenceIntotoPayload extends $pb.GeneratedMessage {
  factory SbomReferenceIntotoPayload({
    ...
    $core.Iterable<$596.Subject>? subject,
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(
    ...
    ..pc<$596.Subject>(3, _omitFieldNames ? '' : 'subject', $pb.PbFieldType.PM,
        subBuilder: $596.Subject.create)
  ...
  @$pb.TagNumber(3)
  $core.List<$596.Subject> get subject => $_getList(2);
