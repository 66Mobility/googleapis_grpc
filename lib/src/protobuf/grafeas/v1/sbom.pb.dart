...
class SBOMReferenceOccurrence extends $pb.GeneratedMessage {
  factory SBOMReferenceOccurrence({
    ...
    $core.Iterable<$4426.EnvelopeSignature>? signatures,
  }) {
    final $result = create();
    if (payload != null) {
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(_omitMessageNames ? '' : 'SBOMReferenceOccurrence', package: const $pb.PackageName(_omitMessageNames ? '' : 'grafeas.v1'), createEmptyInstance: create)
    ...
    ..pc<$4426.EnvelopeSignature>(3, _omitFieldNames ? '' : 'signatures', $pb.PbFieldType.PM, subBuilder: $4426.EnvelopeSignature.create)
    ..hasRequiredFields = false
  ;
  ...
  @$pb.TagNumber(3)
  $core.List<$4426.EnvelopeSignature> get signatures => $_getList(2);
}
...
class SbomReferenceIntotoPayload extends $pb.GeneratedMessage {
  factory SbomReferenceIntotoPayload({
    ...
    $core.Iterable<$4897.Subject>? subject,
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(_omitMessageNames ? '' : 'SbomReferenceIntotoPayload', package: const $pb.PackageName(_omitMessageNames ? '' : 'grafeas.v1'), createEmptyInstance: create)
    ...
    ..pc<$4897.Subject>(3, _omitFieldNames ? '' : 'subject', $pb.PbFieldType.PM, subBuilder: $4897.Subject.create)
  ...
  @$pb.TagNumber(3)
  $core.List<$4897.Subject> get subject => $_getList(2);
