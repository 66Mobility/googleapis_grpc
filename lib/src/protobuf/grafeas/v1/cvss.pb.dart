...
class CVSSv3 extends $pb.GeneratedMessage {
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(_omitMessageNames ? '' : 'CVSSv3', package: const $pb.PackageName(_omitMessageNames ? '' : 'grafeas.v1'), createEmptyInstance: create)
    ..a<$core.double>(1, _omitFieldNames ? '' : 'baseScore', $pb.PbFieldType.OF)
    ..a<$core.double>(2, _omitFieldNames ? '' : 'exploitabilityScore', $pb.PbFieldType.OF)
    ..a<$core.double>(3, _omitFieldNames ? '' : 'impactScore', $pb.PbFieldType.OF)
...
class CVSS extends $pb.GeneratedMessage {
  ...
  CVSS._() : super();
  factory CVSS.fromBuffer($core.List<$core.int> i, [$pb.ExtensionRegistry r = $pb.ExtensionRegistry.EMPTY]) => create()..mergeFromBuffer(i, r);
  factory CVSS.fromJson($core.String i, [$pb.ExtensionRegistry r = $pb.ExtensionRegistry.EMPTY]) => create()..mergeFromJson(i, r);

  static final $pb.BuilderInfo _i = $pb.BuilderInfo(_omitMessageNames ? '' : 'CVSS', package: const $pb.PackageName(_omitMessageNames ? '' : 'grafeas.v1'), createEmptyInstance: create)
    ..a<$core.double>(1, _omitFieldNames ? '' : 'baseScore', $pb.PbFieldType.OF)
    ..a<$core.double>(2, _omitFieldNames ? '' : 'exploitabilityScore', $pb.PbFieldType.OF)
    ..a<$core.double>(3, _omitFieldNames ? '' : 'impactScore', $pb.PbFieldType.OF)
    ..e<CVSS_AttackVector>(4, _omitFieldNames ? '' : 'attackVector', $pb.PbFieldType.OE, defaultOrMaker: CVSS_AttackVector.ATTACK_VECTOR_UNSPECIFIED, valueOf: CVSS_AttackVector.valueOf, enumValues: CVSS_AttackVector.values)
    ..e<CVSS_AttackComplexity>(5, _omitFieldNames ? '' : 'attackComplexity', $pb.PbFieldType.OE, defaultOrMaker: CVSS_AttackComplexity.ATTACK_COMPLEXITY_UNSPECIFIED, valueOf: CVSS_AttackComplexity.valueOf, enumValues: CVSS_AttackComplexity.values)
    ..e<CVSS_Authentication>(6, _omitFieldNames ? '' : 'authentication', $pb.PbFieldType.OE, defaultOrMaker: CVSS_Authentication.AUTHENTICATION_UNSPECIFIED, valueOf: CVSS_Authentication.valueOf, enumValues: CVSS_Authentication.values)
    ..e<CVSS_PrivilegesRequired>(7, _omitFieldNames ? '' : 'privilegesRequired', $pb.PbFieldType.OE, defaultOrMaker: CVSS_PrivilegesRequired.PRIVILEGES_REQUIRED_UNSPECIFIED, valueOf: CVSS_PrivilegesRequired.valueOf, enumValues: CVSS_PrivilegesRequired.values)
    ..e<CVSS_UserInteraction>(8, _omitFieldNames ? '' : 'userInteraction', $pb.PbFieldType.OE, defaultOrMaker: CVSS_UserInteraction.USER_INTERACTION_UNSPECIFIED, valueOf: CVSS_UserInteraction.valueOf, enumValues: CVSS_UserInteraction.values)
    ..e<CVSS_Scope>(9, _omitFieldNames ? '' : 'scope', $pb.PbFieldType.OE, defaultOrMaker: CVSS_Scope.SCOPE_UNSPECIFIED, valueOf: CVSS_Scope.valueOf, enumValues: CVSS_Scope.values)
    ..e<CVSS_Impact>(10, _omitFieldNames ? '' : 'confidentialityImpact', $pb.PbFieldType.OE, defaultOrMaker: CVSS_Impact.IMPACT_UNSPECIFIED, valueOf: CVSS_Impact.valueOf, enumValues: CVSS_Impact.values)
    ..e<CVSS_Impact>(11, _omitFieldNames ? '' : 'integrityImpact', $pb.PbFieldType.OE, defaultOrMaker: CVSS_Impact.IMPACT_UNSPECIFIED, valueOf: CVSS_Impact.valueOf, enumValues: CVSS_Impact.values)
    ..e<CVSS_Impact>(12, _omitFieldNames ? '' : 'availabilityImpact', $pb.PbFieldType.OE, defaultOrMaker: CVSS_Impact.IMPACT_UNSPECIFIED, valueOf: CVSS_Impact.valueOf, enumValues: CVSS_Impact.values)
    ..hasRequiredFields = false
  ;
  ...
  'Use [GeneratedMessageGenericExtensions.rebuild] instead. '
  'Will be removed in next major version')
  CVSS copyWith(void Function(CVSS) updates) => super.copyWith((message) => updates(message as CVSS)) as CVSS;
  ...
  @$core.pragma('dart2js:noInline')
  static CVSS getDefault() => _defaultInstance ??= $pb.GeneratedMessage.$_defaultFor<CVSS>(create);
  ...
  @$pb.TagNumber(4)
  set attackVector(CVSS_AttackVector v) { setField(4, v); }
  @$pb.TagNumber(4)
  $core.bool hasAttackVector() => $_has(3);
  @$pb.TagNumber(4)
  ...
  @$pb.TagNumber(5)
  set attackComplexity(CVSS_AttackComplexity v) { setField(5, v); }
  @$pb.TagNumber(5)
  $core.bool hasAttackComplexity() => $_has(4);
  @$pb.TagNumber(5)
  ...
  @$pb.TagNumber(6)
  set authentication(CVSS_Authentication v) { setField(6, v); }
  @$pb.TagNumber(6)
  ...
  @$pb.TagNumber(7)
  set privilegesRequired(CVSS_PrivilegesRequired v) { setField(7, v); }
  @$pb.TagNumber(7)
  ...
  @$pb.TagNumber(8)
  set userInteraction(CVSS_UserInteraction v) { setField(8, v); }
  @$pb.TagNumber(8)
  ...
  @$pb.TagNumber(9)
  set scope(CVSS_Scope v) { setField(9, v); }
  @$pb.TagNumber(9)
  ...
  @$pb.TagNumber(10)
  set confidentialityImpact(CVSS_Impact v) { setField(10, v); }
  @$pb.TagNumber(10)
  ...
  @$pb.TagNumber(11)
  set integrityImpact(CVSS_Impact v) { setField(11, v); }
  @$pb.TagNumber(11)
  ...
  @$pb.TagNumber(12)
  set availabilityImpact(CVSS_Impact v) { setField(12, v); }
  @$pb.TagNumber(12)
