...
class DeploymentOccurrence extends $pb.GeneratedMessage {
  factory DeploymentOccurrence({
    ...
    $330.Timestamp? deployTime,
    $330.Timestamp? undeployTime,
    $core.String? config,
    $core.String? address,
    $core.Iterable<$core.String>? resourceUri,
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(
    ...
    ..aOM<$330.Timestamp>(2, _omitFieldNames ? '' : 'deployTime',
        subBuilder: $330.Timestamp.create)
    ..aOM<$330.Timestamp>(3, _omitFieldNames ? '' : 'undeployTime',
        subBuilder: $330.Timestamp.create)
  ...
  @$pb.TagNumber(2)
  $330.Timestamp get deployTime => $_getN(1);
  @$pb.TagNumber(2)
  set deployTime($330.Timestamp v) {
    setField(2, v);
  }
  ...
  @$pb.TagNumber(2)
  $330.Timestamp ensureDeployTime() => $_ensure(1);

  /// End of the lifetime of this deployment.
  @$pb.TagNumber(3)
  $330.Timestamp get undeployTime => $_getN(2);
  @$pb.TagNumber(3)
  set undeployTime($330.Timestamp v) {
    setField(3, v);
  }
  ...
  @$pb.TagNumber(3)
  $330.Timestamp ensureUndeployTime() => $_ensure(2);
