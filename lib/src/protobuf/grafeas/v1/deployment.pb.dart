...
class DeploymentOccurrence extends $pb.GeneratedMessage {
  factory DeploymentOccurrence({
    ...
    $299.Timestamp? deployTime,
    $299.Timestamp? undeployTime,
    $core.String? config,
    $core.String? address,
    $core.Iterable<$core.String>? resourceUri,
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(_omitMessageNames ? '' : 'DeploymentOccurrence', package: const $pb.PackageName(_omitMessageNames ? '' : 'grafeas.v1'), createEmptyInstance: create)
    ...
    ..aOM<$299.Timestamp>(2, _omitFieldNames ? '' : 'deployTime', subBuilder: $299.Timestamp.create)
    ..aOM<$299.Timestamp>(3, _omitFieldNames ? '' : 'undeployTime', subBuilder: $299.Timestamp.create)
  ...
  @$pb.TagNumber(2)
  $299.Timestamp get deployTime => $_getN(1);
  @$pb.TagNumber(2)
  set deployTime($299.Timestamp v) { setField(2, v); }
  @$pb.TagNumber(2)
  $core.bool hasDeployTime() => $_has(1);
  @$pb.TagNumber(2)
  void clearDeployTime() => clearField(2);
  @$pb.TagNumber(2)
  $299.Timestamp ensureDeployTime() => $_ensure(1);

  /// End of the lifetime of this deployment.
  @$pb.TagNumber(3)
  $299.Timestamp get undeployTime => $_getN(2);
  @$pb.TagNumber(3)
  set undeployTime($299.Timestamp v) { setField(3, v); }
  @$pb.TagNumber(3)
  $core.bool hasUndeployTime() => $_has(2);
  @$pb.TagNumber(3)
  void clearUndeployTime() => clearField(3);
  @$pb.TagNumber(3)
  $299.Timestamp ensureUndeployTime() => $_ensure(2);
