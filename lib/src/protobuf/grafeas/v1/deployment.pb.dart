...
class DeploymentOccurrence extends $pb.GeneratedMessage {
  factory DeploymentOccurrence({
    ...
    $4.Timestamp? deployTime,
    $4.Timestamp? undeployTime,
    $core.String? config,
    $core.String? address,
    $core.Iterable<$core.String>? resourceUri,
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(_omitMessageNames ? '' : 'DeploymentOccurrence', package: const $pb.PackageName(_omitMessageNames ? '' : 'grafeas.v1'), createEmptyInstance: create)
    ...
    ..aOM<$4.Timestamp>(2, _omitFieldNames ? '' : 'deployTime', subBuilder: $4.Timestamp.create)
    ..aOM<$4.Timestamp>(3, _omitFieldNames ? '' : 'undeployTime', subBuilder: $4.Timestamp.create)
  ...
  @$pb.TagNumber(2)
  $4.Timestamp get deployTime => $_getN(1);
  @$pb.TagNumber(2)
  set deployTime($4.Timestamp v) { setField(2, v); }
  @$pb.TagNumber(2)
  $core.bool hasDeployTime() => $_has(1);
  @$pb.TagNumber(2)
  void clearDeployTime() => clearField(2);
  @$pb.TagNumber(2)
  $4.Timestamp ensureDeployTime() => $_ensure(1);

  /// End of the lifetime of this deployment.
  @$pb.TagNumber(3)
  $4.Timestamp get undeployTime => $_getN(2);
  @$pb.TagNumber(3)
  set undeployTime($4.Timestamp v) { setField(3, v); }
  @$pb.TagNumber(3)
  $core.bool hasUndeployTime() => $_has(2);
  @$pb.TagNumber(3)
  void clearUndeployTime() => clearField(3);
  @$pb.TagNumber(3)
  $4.Timestamp ensureUndeployTime() => $_ensure(2);
