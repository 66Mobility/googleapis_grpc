...
class AliasContext_Kind extends $pb.ProtobufEnum {
  static const AliasContext_Kind KIND_UNSPECIFIED = AliasContext_Kind._(0, _omitEnumNames ? '' : 'KIND_UNSPECIFIED');
  static const AliasContext_Kind FIXED = AliasContext_Kind._(1, _omitEnumNames ? '' : 'FIXED');
  static const AliasContext_Kind MOVABLE = AliasContext_Kind._(2, _omitEnumNames ? '' : 'MOVABLE');
  static const AliasContext_Kind OTHER = AliasContext_Kind._(4, _omitEnumNames ? '' : 'OTHER');
