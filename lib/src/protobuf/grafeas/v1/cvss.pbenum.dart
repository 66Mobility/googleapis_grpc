...
class CVSSVersion extends $pb.ProtobufEnum {
  static const CVSSVersion CVSS_VERSION_UNSPECIFIED = CVSSVersion._(0, _omitEnumNames ? '' : 'CVSS_VERSION_UNSPECIFIED');
  static const CVSSVersion CVSS_VERSION_2 = CVSSVersion._(1, _omitEnumNames ? '' : 'CVSS_VERSION_2');
  static const CVSSVersion CVSS_VERSION_3 = CVSSVersion._(2, _omitEnumNames ? '' : 'CVSS_VERSION_3');
  ...
  static final $core.Map<$core.int, CVSSVersion> _byValue = $pb.ProtobufEnum.initByValue(values);
...
class CVSS_AttackVector extends $pb.ProtobufEnum {
  static const CVSS_AttackVector ATTACK_VECTOR_UNSPECIFIED = CVSS_AttackVector._(0, _omitEnumNames ? '' : 'ATTACK_VECTOR_UNSPECIFIED');
  static const CVSS_AttackVector ATTACK_VECTOR_NETWORK = CVSS_AttackVector._(1, _omitEnumNames ? '' : 'ATTACK_VECTOR_NETWORK');
  static const CVSS_AttackVector ATTACK_VECTOR_ADJACENT = CVSS_AttackVector._(2, _omitEnumNames ? '' : 'ATTACK_VECTOR_ADJACENT');
  static const CVSS_AttackVector ATTACK_VECTOR_LOCAL = CVSS_AttackVector._(3, _omitEnumNames ? '' : 'ATTACK_VECTOR_LOCAL');
  static const CVSS_AttackVector ATTACK_VECTOR_PHYSICAL = CVSS_AttackVector._(4, _omitEnumNames ? '' : 'ATTACK_VECTOR_PHYSICAL');
  ...
  static final $core.Map<$core.int, CVSS_AttackVector> _byValue = $pb.ProtobufEnum.initByValue(values);
...
class CVSS_AttackComplexity extends $pb.ProtobufEnum {
  static const CVSS_AttackComplexity ATTACK_COMPLEXITY_UNSPECIFIED = CVSS_AttackComplexity._(0, _omitEnumNames ? '' : 'ATTACK_COMPLEXITY_UNSPECIFIED');
  static const CVSS_AttackComplexity ATTACK_COMPLEXITY_LOW = CVSS_AttackComplexity._(1, _omitEnumNames ? '' : 'ATTACK_COMPLEXITY_LOW');
  static const CVSS_AttackComplexity ATTACK_COMPLEXITY_HIGH = CVSS_AttackComplexity._(2, _omitEnumNames ? '' : 'ATTACK_COMPLEXITY_HIGH');
  static const CVSS_AttackComplexity ATTACK_COMPLEXITY_MEDIUM = CVSS_AttackComplexity._(3, _omitEnumNames ? '' : 'ATTACK_COMPLEXITY_MEDIUM');

  static const $core.List<CVSS_AttackComplexity> values = <CVSS_AttackComplexity> [
    ATTACK_COMPLEXITY_UNSPECIFIED,
    ATTACK_COMPLEXITY_LOW,
    ATTACK_COMPLEXITY_HIGH,
  ...
  static final $core.Map<$core.int, CVSS_AttackComplexity> _byValue = $pb.ProtobufEnum.initByValue(values);
...
class CVSS_Authentication extends $pb.ProtobufEnum {
  static const CVSS_Authentication AUTHENTICATION_UNSPECIFIED = CVSS_Authentication._(0, _omitEnumNames ? '' : 'AUTHENTICATION_UNSPECIFIED');
  static const CVSS_Authentication AUTHENTICATION_MULTIPLE = CVSS_Authentication._(1, _omitEnumNames ? '' : 'AUTHENTICATION_MULTIPLE');
  static const CVSS_Authentication AUTHENTICATION_SINGLE = CVSS_Authentication._(2, _omitEnumNames ? '' : 'AUTHENTICATION_SINGLE');
  static const CVSS_Authentication AUTHENTICATION_NONE = CVSS_Authentication._(3, _omitEnumNames ? '' : 'AUTHENTICATION_NONE');
  ...
  static final $core.Map<$core.int, CVSS_Authentication> _byValue = $pb.ProtobufEnum.initByValue(values);
...
class CVSS_PrivilegesRequired extends $pb.ProtobufEnum {
  static const CVSS_PrivilegesRequired PRIVILEGES_REQUIRED_UNSPECIFIED = CVSS_PrivilegesRequired._(0, _omitEnumNames ? '' : 'PRIVILEGES_REQUIRED_UNSPECIFIED');
  static const CVSS_PrivilegesRequired PRIVILEGES_REQUIRED_NONE = CVSS_PrivilegesRequired._(1, _omitEnumNames ? '' : 'PRIVILEGES_REQUIRED_NONE');
  static const CVSS_PrivilegesRequired PRIVILEGES_REQUIRED_LOW = CVSS_PrivilegesRequired._(2, _omitEnumNames ? '' : 'PRIVILEGES_REQUIRED_LOW');
  static const CVSS_PrivilegesRequired PRIVILEGES_REQUIRED_HIGH = CVSS_PrivilegesRequired._(3, _omitEnumNames ? '' : 'PRIVILEGES_REQUIRED_HIGH');

  static const $core.List<CVSS_PrivilegesRequired> values = <CVSS_PrivilegesRequired> [
    PRIVILEGES_REQUIRED_UNSPECIFIED,
    PRIVILEGES_REQUIRED_NONE,
    PRIVILEGES_REQUIRED_LOW,
    PRIVILEGES_REQUIRED_HIGH,
  ...
  static final $core.Map<$core.int, CVSS_PrivilegesRequired> _byValue = $pb.ProtobufEnum.initByValue(values);
...
class CVSS_UserInteraction extends $pb.ProtobufEnum {
  static const CVSS_UserInteraction USER_INTERACTION_UNSPECIFIED = CVSS_UserInteraction._(0, _omitEnumNames ? '' : 'USER_INTERACTION_UNSPECIFIED');
  static const CVSS_UserInteraction USER_INTERACTION_NONE = CVSS_UserInteraction._(1, _omitEnumNames ? '' : 'USER_INTERACTION_NONE');
  static const CVSS_UserInteraction USER_INTERACTION_REQUIRED = CVSS_UserInteraction._(2, _omitEnumNames ? '' : 'USER_INTERACTION_REQUIRED');
  ...
  static final $core.Map<$core.int, CVSS_UserInteraction> _byValue = $pb.ProtobufEnum.initByValue(values);
...
class CVSS_Scope extends $pb.ProtobufEnum {
  static const CVSS_Scope SCOPE_UNSPECIFIED = CVSS_Scope._(0, _omitEnumNames ? '' : 'SCOPE_UNSPECIFIED');
  static const CVSS_Scope SCOPE_UNCHANGED = CVSS_Scope._(1, _omitEnumNames ? '' : 'SCOPE_UNCHANGED');
  static const CVSS_Scope SCOPE_CHANGED = CVSS_Scope._(2, _omitEnumNames ? '' : 'SCOPE_CHANGED');
  ...
  static final $core.Map<$core.int, CVSS_Scope> _byValue = $pb.ProtobufEnum.initByValue(values);
...
class CVSS_Impact extends $pb.ProtobufEnum {
  static const CVSS_Impact IMPACT_UNSPECIFIED = CVSS_Impact._(0, _omitEnumNames ? '' : 'IMPACT_UNSPECIFIED');
  static const CVSS_Impact IMPACT_HIGH = CVSS_Impact._(1, _omitEnumNames ? '' : 'IMPACT_HIGH');
  static const CVSS_Impact IMPACT_LOW = CVSS_Impact._(2, _omitEnumNames ? '' : 'IMPACT_LOW');
  static const CVSS_Impact IMPACT_NONE = CVSS_Impact._(3, _omitEnumNames ? '' : 'IMPACT_NONE');
  static const CVSS_Impact IMPACT_PARTIAL = CVSS_Impact._(4, _omitEnumNames ? '' : 'IMPACT_PARTIAL');
  static const CVSS_Impact IMPACT_COMPLETE = CVSS_Impact._(5, _omitEnumNames ? '' : 'IMPACT_COMPLETE');
  ...
  static final $core.Map<$core.int, CVSS_Impact> _byValue = $pb.ProtobufEnum.initByValue(values);
