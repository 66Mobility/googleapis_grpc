...
import '../../google/rpc/status.pb.dart' as $350;
...
class DiscoveryNote extends $pb.GeneratedMessage {
  ...
  /// discovery.
  @$pb.TagNumber(1)
  $591.NoteKind get analysisKind => $_getN(0);
  @$pb.TagNumber(1)
  set analysisKind($591.NoteKind v) {
    setField(1, v);
  }
...
class DiscoveryOccurrence_VulnerabilityAttestation
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(
      ...
      package: const $pb.PackageName(_omitMessageNames ? '' : 'grafeas.v1'),
      createEmptyInstance: create)
    ..aOM<$330.Timestamp>(1, _omitFieldNames ? '' : 'lastAttemptTime',
  ...
  @$pb.TagNumber(1)
  $330.Timestamp get lastAttemptTime => $_getN(0);
  @$pb.TagNumber(1)
  set lastAttemptTime($330.Timestamp v) {
    setField(1, v);
  }
  ...
  @$pb.TagNumber(1)
  $330.Timestamp ensureLastAttemptTime() => $_ensure(0);
...
class DiscoveryOccurrence extends $pb.GeneratedMessage {
  factory DiscoveryOccurrence({
    ...
    $350.Status? analysisStatusError,
    $core.String? cpe,
    $330.Timestamp? lastScanTime,
    $330.Timestamp? archiveTime,
    DiscoveryOccurrence_AnalysisCompleted? analysisCompleted,
    $core.Iterable<$350.Status>? analysisError,
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(
    ...
    ..aOM<$350.Status>(3, _omitFieldNames ? '' : 'analysisStatusError',
        subBuilder: $350.Status.create)
    ..aOS(4, _omitFieldNames ? '' : 'cpe')
    ..aOM<$330.Timestamp>(5, _omitFieldNames ? '' : 'lastScanTime',
        subBuilder: $330.Timestamp.create)
    ..aOM<$330.Timestamp>(6, _omitFieldNames ? '' : 'archiveTime',
        subBuilder: $330.Timestamp.create)
  ...
  @$pb.TagNumber(3)
  $350.Status get analysisStatusError => $_getN(2);
  @$pb.TagNumber(3)
  set analysisStatusError($350.Status v) {
    setField(3, v);
  }
  ...
  @$pb.TagNumber(3)
  $350.Status ensureAnalysisStatusError() => $_ensure(2);
  ...
  @$pb.TagNumber(5)
  $330.Timestamp get lastScanTime => $_getN(4);
  @$pb.TagNumber(5)
  set lastScanTime($330.Timestamp v) {
    setField(5, v);
  }
  ...
  @$pb.TagNumber(5)
  $330.Timestamp ensureLastScanTime() => $_ensure(4);

  /// The time occurrences related to this discovery occurrence were archived.
  @$pb.TagNumber(6)
  $330.Timestamp get archiveTime => $_getN(5);
  @$pb.TagNumber(6)
  set archiveTime($330.Timestamp v) {
    setField(6, v);
  }
  ...
  @$pb.TagNumber(6)
  $330.Timestamp ensureArchiveTime() => $_ensure(5);
  ...
  @$pb.TagNumber(8)
  $core.List<$350.Status> get analysisError => $_getList(7);
