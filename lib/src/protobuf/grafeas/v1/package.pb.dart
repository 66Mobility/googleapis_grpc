...
class PackageNote extends $pb.GeneratedMessage {
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(_omitMessageNames ? '' : 'PackageNote', package: const $pb.PackageName(_omitMessageNames ? '' : 'grafeas.v1'), createEmptyInstance: create)
    ...
    ..aOM<$2.License>(18, _omitFieldNames ? '' : 'license', subBuilder: $2.License.create)
    ..pc<$2.Digest>(19, _omitFieldNames ? '' : 'digest', $pb.PbFieldType.PM, subBuilder: $2.Digest.create)
    ..hasRequiredFields = false
  ;
...
class PackageOccurrence extends $pb.GeneratedMessage {
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(_omitMessageNames ? '' : 'PackageOccurrence', package: const $pb.PackageName(_omitMessageNames ? '' : 'grafeas.v1'), createEmptyInstance: create)
    ...
    ..aOM<$2.License>(6, _omitFieldNames ? '' : 'license', subBuilder: $2.License.create)
  ...
  /// Licenses that have been declared by the authors of the package.
  @$pb.TagNumber(6)
  $2.License get license => $_getN(5);
  @$pb.TagNumber(6)
  set license($2.License v) { setField(6, v); }
  @$pb.TagNumber(6)
  $core.bool hasLicense() => $_has(5);
  @$pb.TagNumber(6)
  void clearLicense() => clearField(6);
  @$pb.TagNumber(6)
  $2.License ensureLicense() => $_ensure(5);
