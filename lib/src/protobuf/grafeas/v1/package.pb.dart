...
class PackageNote extends $pb.GeneratedMessage {
  factory PackageNote({
    ...
    $core.String? url,
    $core.String? description,
    $4426.License? license,
    $core.Iterable<$4426.Digest>? digest,
  }) {
    final $result = create();
    if (name != null) {
      $result.name = name;
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(_omitMessageNames ? '' : 'PackageNote', package: const $pb.PackageName(_omitMessageNames ? '' : 'grafeas.v1'), createEmptyInstance: create)
    ...
    ..aOM<$4426.License>(18, _omitFieldNames ? '' : 'license', subBuilder: $4426.License.create)
    ..pc<$4426.Digest>(19, _omitFieldNames ? '' : 'digest', $pb.PbFieldType.PM, subBuilder: $4426.Digest.create)
    ..hasRequiredFields = false
  ;
  ...
  @$pb.TagNumber(18)
  $4426.License get license => $_getN(9);
  @$pb.TagNumber(18)
  set license($4426.License v) { setField(18, v); }
  @$pb.TagNumber(18)
  $core.bool hasLicense() => $_has(9);
  @$pb.TagNumber(18)
  void clearLicense() => clearField(18);
  @$pb.TagNumber(18)
  $4426.License ensureLicense() => $_ensure(9);

  /// Hash value, typically a file digest, that allows unique
  /// identification a specific package.
  @$pb.TagNumber(19)
  $core.List<$4426.Digest> get digest => $_getList(10);
}
...
class PackageOccurrence extends $pb.GeneratedMessage {
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(_omitMessageNames ? '' : 'PackageOccurrence', package: const $pb.PackageName(_omitMessageNames ? '' : 'grafeas.v1'), createEmptyInstance: create)
    ...
    ..aOM<$4426.License>(6, _omitFieldNames ? '' : 'license', subBuilder: $4426.License.create)
  ...
  /// Licenses that have been declared by the authors of the package.
  @$pb.TagNumber(6)
  $4426.License get license => $_getN(5);
  @$pb.TagNumber(6)
  set license($4426.License v) { setField(6, v); }
  @$pb.TagNumber(6)
  $core.bool hasLicense() => $_has(5);
  @$pb.TagNumber(6)
  void clearLicense() => clearField(6);
  @$pb.TagNumber(6)
  $4426.License ensureLicense() => $_ensure(5);
