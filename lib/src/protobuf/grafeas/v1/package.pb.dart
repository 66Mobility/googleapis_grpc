...
class PackageNote extends $pb.GeneratedMessage {
  factory PackageNote({
    ...
    $core.String? description,
    $591.License? license,
    $core.Iterable<$591.Digest>? digest,
  }) {
    final $result = create();
    if (name != null) {
      $result.name = name;
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(
    ...
    ..aOM<$591.License>(18, _omitFieldNames ? '' : 'license',
        subBuilder: $591.License.create)
    ..pc<$591.Digest>(19, _omitFieldNames ? '' : 'digest', $pb.PbFieldType.PM,
        subBuilder: $591.Digest.create)
    ..hasRequiredFields = false;
  ...
  @$pb.TagNumber(18)
  $591.License get license => $_getN(9);
  @$pb.TagNumber(18)
  set license($591.License v) {
    setField(18, v);
  }
...
class PackageOccurrence extends $pb.GeneratedMessage {
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(
    ...
    ..e<Architecture>(
        ...
        valueOf: Architecture.valueOf,
        enumValues: Architecture.values)
    ..aOM<$591.License>(6, _omitFieldNames ? '' : 'license',
        subBuilder: $591.License.create)
  ...
  /// Licenses that have been declared by the authors of the package.
  @$pb.TagNumber(6)
  $591.License get license => $_getN(5);
  @$pb.TagNumber(6)
  set license($591.License v) {
    setField(6, v);
  }
  ...
  @$pb.TagNumber(6)
  $591.License ensureLicense() => $_ensure(5);
