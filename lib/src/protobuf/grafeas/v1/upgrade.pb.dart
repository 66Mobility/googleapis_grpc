...
class WindowsUpdate extends $pb.GeneratedMessage {
  factory WindowsUpdate({
    ...
    $299.Timestamp? lastPublishedTimestamp,
  }) {
    final $result = create();
    if (identity != null) {
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(_omitMessageNames ? '' : 'WindowsUpdate', package: const $pb.PackageName(_omitMessageNames ? '' : 'grafeas.v1'), createEmptyInstance: create)
    ...
    ..aOM<$299.Timestamp>(7, _omitFieldNames ? '' : 'lastPublishedTimestamp', subBuilder: $299.Timestamp.create)
    ..hasRequiredFields = false
  ;
  ...
  @$pb.TagNumber(7)
  $299.Timestamp get lastPublishedTimestamp => $_getN(6);
  @$pb.TagNumber(7)
  set lastPublishedTimestamp($299.Timestamp v) { setField(7, v); }
  @$pb.TagNumber(7)
  $core.bool hasLastPublishedTimestamp() => $_has(6);
  @$pb.TagNumber(7)
  void clearLastPublishedTimestamp() => clearField(7);
  @$pb.TagNumber(7)
  $299.Timestamp ensureLastPublishedTimestamp() => $_ensure(6);
}
