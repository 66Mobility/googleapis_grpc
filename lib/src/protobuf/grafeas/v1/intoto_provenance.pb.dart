...
class Recipe extends $pb.GeneratedMessage {
  factory Recipe({
    ...
    $core.Iterable<$321.Any>? arguments,
    $core.Iterable<$321.Any>? environment,
  }) {
    final $result = create();
    if (type != null) {
      $result.type = type;
  ...
  @$pb.TagNumber(4)
  $core.List<$321.Any> get arguments => $_getList(3);
  ...
  @$pb.TagNumber(5)
  $core.List<$321.Any> get environment => $_getList(4);
}
