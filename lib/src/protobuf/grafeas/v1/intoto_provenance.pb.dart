...
import '../../google/protobuf/any.pb.dart' as $349;
...
class Recipe extends $pb.GeneratedMessage {
  factory Recipe({
    ...
    $core.Iterable<$349.Any>? arguments,
    $core.Iterable<$349.Any>? environment,
  }) {
    final $result = create();
    if (type != null) {
      $result.type = type;
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(
    ...
    ..pc<$349.Any>(4, _omitFieldNames ? '' : 'arguments', $pb.PbFieldType.PM,
        subBuilder: $349.Any.create)
    ..pc<$349.Any>(5, _omitFieldNames ? '' : 'environment', $pb.PbFieldType.PM,
        subBuilder: $349.Any.create)
  ...
  @$pb.TagNumber(4)
  $core.List<$349.Any> get arguments => $_getList(3);
  ...
  @$pb.TagNumber(5)
  $core.List<$349.Any> get environment => $_getList(4);
}
