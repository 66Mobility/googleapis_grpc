...
import 'citation.pb.dart' as $4142;
import 'content.pb.dart' as $4140;
import 'generative_service.pbenum.dart';
import 'safety.pb.dart' as $4141;
...
class GenerateContentRequest extends $pb.GeneratedMessage {
  factory GenerateContentRequest({
    $core.String? model,
    $core.Iterable<$4140.Content>? contents,
    $core.Iterable<$4141.SafetySetting>? safetySettings,
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(_omitMessageNames ? '' : 'GenerateContentRequest', package: const $pb.PackageName(_omitMessageNames ? '' : 'google.ai.generativelanguage.v1'), createEmptyInstance: create)
    ...
    ..pc<$4140.Content>(2, _omitFieldNames ? '' : 'contents', $pb.PbFieldType.PM, subBuilder: $4140.Content.create)
    ..pc<$4141.SafetySetting>(3, _omitFieldNames ? '' : 'safetySettings', $pb.PbFieldType.PM, subBuilder: $4141.SafetySetting.create)
  ...
  ///  latest request.
  @$pb.TagNumber(2)
  $core.List<$4140.Content> get contents => $_getList(1);
  ...
  @$pb.TagNumber(3)
  $core.List<$4141.SafetySetting> get safetySettings => $_getList(2);
...
class GenerateContentResponse_PromptFeedback extends $pb.GeneratedMessage {
  factory GenerateContentResponse_PromptFeedback({
    ...
    $core.Iterable<$4141.SafetyRating>? safetyRatings,
  }) {
    final $result = create();
    if (blockReason != null) {
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(_omitMessageNames ? '' : 'GenerateContentResponse.PromptFeedback', package: const $pb.PackageName(_omitMessageNames ? '' : 'google.ai.generativelanguage.v1'), createEmptyInstance: create)
    ...
    ..pc<$4141.SafetyRating>(2, _omitFieldNames ? '' : 'safetyRatings', $pb.PbFieldType.PM, subBuilder: $4141.SafetyRating.create)
    ..hasRequiredFields = false
  ;
  ...
  @$pb.TagNumber(2)
  $core.List<$4141.SafetyRating> get safetyRatings => $_getList(1);
}
...
class Candidate extends $pb.GeneratedMessage {
  factory Candidate({
    $4140.Content? content,
    Candidate_FinishReason? finishReason,
    $core.int? index,
    $core.Iterable<$4141.SafetyRating>? safetyRatings,
    $4142.CitationMetadata? citationMetadata,
    $core.int? tokenCount,
  }) {
    final $result = create();
    if (content != null) {
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(_omitMessageNames ? '' : 'Candidate', package: const $pb.PackageName(_omitMessageNames ? '' : 'google.ai.generativelanguage.v1'), createEmptyInstance: create)
    ..aOM<$4140.Content>(1, _omitFieldNames ? '' : 'content', subBuilder: $4140.Content.create)
    ...
    ..pc<$4141.SafetyRating>(5, _omitFieldNames ? '' : 'safetyRatings', $pb.PbFieldType.PM, subBuilder: $4141.SafetyRating.create)
    ..aOM<$4142.CitationMetadata>(6, _omitFieldNames ? '' : 'citationMetadata', subBuilder: $4142.CitationMetadata.create)
  ...
  @$pb.TagNumber(1)
  $4140.Content get content => $_getN(0);
  @$pb.TagNumber(1)
  set content($4140.Content v) { setField(1, v); }
  @$pb.TagNumber(1)
  $core.bool hasContent() => $_has(0);
  @$pb.TagNumber(1)
  void clearContent() => clearField(1);
  @$pb.TagNumber(1)
  $4140.Content ensureContent() => $_ensure(0);
  ...
  ///  There is at most one rating per category.
  @$pb.TagNumber(5)
  $core.List<$4141.SafetyRating> get safetyRatings => $_getList(3);
  ...
  @$pb.TagNumber(6)
  $4142.CitationMetadata get citationMetadata => $_getN(4);
  @$pb.TagNumber(6)
  set citationMetadata($4142.CitationMetadata v) { setField(6, v); }
  @$pb.TagNumber(6)
  $core.bool hasCitationMetadata() => $_has(4);
  @$pb.TagNumber(6)
  void clearCitationMetadata() => clearField(6);
  @$pb.TagNumber(6)
  $4142.CitationMetadata ensureCitationMetadata() => $_ensure(4);
...
class EmbedContentRequest extends $pb.GeneratedMessage {
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(_omitMessageNames ? '' : 'EmbedContentRequest', package: const $pb.PackageName(_omitMessageNames ? '' : 'google.ai.generativelanguage.v1'), createEmptyInstance: create)
    ..aOS(1, _omitFieldNames ? '' : 'model')
    ..aOM<$4140.Content>(2, _omitFieldNames ? '' : 'content', subBuilder: $4140.Content.create)
  ...
  /// counted.
  @$pb.TagNumber(2)
  $4140.Content get content => $_getN(1);
  @$pb.TagNumber(2)
  set content($4140.Content v) { setField(2, v); }
  @$pb.TagNumber(2)
  $core.bool hasContent() => $_has(1);
  @$pb.TagNumber(2)
  void clearContent() => clearField(2);
  @$pb.TagNumber(2)
  $4140.Content ensureContent() => $_ensure(1);
