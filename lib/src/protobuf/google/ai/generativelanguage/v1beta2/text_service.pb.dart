...
import 'citation.pb.dart' as $368;
import 'safety.pb.dart' as $367;
...
class GenerateTextRequest extends $pb.GeneratedMessage {
  factory GenerateTextRequest({
    ...
    $core.double? topP,
    $core.int? topK,
    $core.Iterable<$367.SafetySetting>? safetySettings,
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(
    ...
    ..pc<$367.SafetySetting>(
        8, _omitFieldNames ? '' : 'safetySettings', $pb.PbFieldType.PM,
        subBuilder: $367.SafetySetting.create)
  ...
  @$pb.TagNumber(8)
  $core.List<$367.SafetySetting> get safetySettings => $_getList(7);
...
class GenerateTextResponse extends $pb.GeneratedMessage {
  factory GenerateTextResponse({
    ...
    $core.Iterable<$367.ContentFilter>? filters,
    $core.Iterable<$367.SafetyFeedback>? safetyFeedback,
  }) {
    final $result = create();
    if (candidates != null) {
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(
    ...
    ..pc<$367.ContentFilter>(
        3, _omitFieldNames ? '' : 'filters', $pb.PbFieldType.PM,
        subBuilder: $367.ContentFilter.create)
    ..pc<$367.SafetyFeedback>(
        4, _omitFieldNames ? '' : 'safetyFeedback', $pb.PbFieldType.PM,
        subBuilder: $367.SafetyFeedback.create)
    ..hasRequiredFields = false;
  ...
  @$pb.TagNumber(3)
  $core.List<$367.ContentFilter> get filters => $_getList(1);

  /// Returns any safety feedback related to content filtering.
  @$pb.TagNumber(4)
  $core.List<$367.SafetyFeedback> get safetyFeedback => $_getList(2);
}
...
class TextCompletion extends $pb.GeneratedMessage {
  factory TextCompletion({
    $core.String? output,
    $core.Iterable<$367.SafetyRating>? safetyRatings,
    $368.CitationMetadata? citationMetadata,
  }) {
    final $result = create();
    if (output != null) {
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(
    ...
    ..pc<$367.SafetyRating>(
        ...
        subBuilder: $367.SafetyRating.create)
    ..aOM<$368.CitationMetadata>(3, _omitFieldNames ? '' : 'citationMetadata',
        subBuilder: $368.CitationMetadata.create)
    ..hasRequiredFields = false;
  ...
  @$pb.TagNumber(2)
  $core.List<$367.SafetyRating> get safetyRatings => $_getList(1);
  ...
  @$pb.TagNumber(3)
  $368.CitationMetadata get citationMetadata => $_getN(2);
  @$pb.TagNumber(3)
  set citationMetadata($368.CitationMetadata v) {
    setField(3, v);
  }
  ...
  @$pb.TagNumber(3)
  $368.CitationMetadata ensureCitationMetadata() => $_ensure(2);
}
