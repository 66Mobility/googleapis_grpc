...
class GenerateTextRequest extends $pb.GeneratedMessage {
  factory GenerateTextRequest({
    ...
    $core.double? topP,
    $core.int? topK,
    $core.Iterable<$4147.SafetySetting>? safetySettings,
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(_omitMessageNames ? '' : 'GenerateTextRequest', package: const $pb.PackageName(_omitMessageNames ? '' : 'google.ai.generativelanguage.v1beta2'), createEmptyInstance: create)
    ...
    ..pc<$4147.SafetySetting>(8, _omitFieldNames ? '' : 'safetySettings', $pb.PbFieldType.PM, subBuilder: $4147.SafetySetting.create)
  ...
  @$pb.TagNumber(8)
  $core.List<$4147.SafetySetting> get safetySettings => $_getList(7);
...
class GenerateTextResponse extends $pb.GeneratedMessage {
  factory GenerateTextResponse({
    ...
    $core.Iterable<$4147.SafetyFeedback>? safetyFeedback,
  }) {
    final $result = create();
    if (candidates != null) {
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(_omitMessageNames ? '' : 'GenerateTextResponse', package: const $pb.PackageName(_omitMessageNames ? '' : 'google.ai.generativelanguage.v1beta2'), createEmptyInstance: create)
    ...
    ..pc<$4147.SafetyFeedback>(4, _omitFieldNames ? '' : 'safetyFeedback', $pb.PbFieldType.PM, subBuilder: $4147.SafetyFeedback.create)
    ..hasRequiredFields = false
  ;
  ...
  @$pb.TagNumber(3)
  $core.List<$4147.ContentFilter> get filters => $_getList(1);

  /// Returns any safety feedback related to content filtering.
  @$pb.TagNumber(4)
  $core.List<$4147.SafetyFeedback> get safetyFeedback => $_getList(2);
}
...
class TextCompletion extends $pb.GeneratedMessage {
  factory TextCompletion({
    $core.String? output,
    $core.Iterable<$4147.SafetyRating>? safetyRatings,
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(_omitMessageNames ? '' : 'TextCompletion', package: const $pb.PackageName(_omitMessageNames ? '' : 'google.ai.generativelanguage.v1beta2'), createEmptyInstance: create)
    ...
    ..pc<$4147.SafetyRating>(2, _omitFieldNames ? '' : 'safetyRatings', $pb.PbFieldType.PM, subBuilder: $4147.SafetyRating.create)
  ...
  @$pb.TagNumber(2)
  $core.List<$4147.SafetyRating> get safetyRatings => $_getList(1);
