...
class Document extends $pb.GeneratedMessage {
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(_omitMessageNames ? '' : 'Document', package: const $pb.PackageName(_omitMessageNames ? '' : 'google.ai.generativelanguage.v1beta'), createEmptyInstance: create)
    ..aOS(1, _omitFieldNames ? '' : 'name')
    ..aOS(2, _omitFieldNames ? '' : 'displayName')
...
class StringList extends $pb.GeneratedMessage {
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(_omitMessageNames ? '' : 'StringList', package: const $pb.PackageName(_omitMessageNames ? '' : 'google.ai.generativelanguage.v1beta'), createEmptyInstance: create)
...
class CustomMetadata extends $pb.GeneratedMessage {
  ...
  static const $core.Map<$core.int, CustomMetadata_Value> _CustomMetadata_ValueByTag = {
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(_omitMessageNames ? '' : 'CustomMetadata', package: const $pb.PackageName(_omitMessageNames ? '' : 'google.ai.generativelanguage.v1beta'), createEmptyInstance: create)
    ..oo(0, [2, 6, 7])
    ..aOS(1, _omitFieldNames ? '' : 'key')
    ..aOS(2, _omitFieldNames ? '' : 'stringValue')
    ..aOM<StringList>(6, _omitFieldNames ? '' : 'stringListValue', subBuilder: StringList.create)
    ..a<$core.double>(7, _omitFieldNames ? '' : 'numericValue', $pb.PbFieldType.OF)
    ..hasRequiredFields = false
  ;
  ...
  CustomMetadata_Value whichValue() => _CustomMetadata_ValueByTag[$_whichOneof(0)]!;
  ...
  @$pb.TagNumber(6)
  set stringListValue(StringList v) { setField(6, v); }
  @$pb.TagNumber(6)
  ...
  @$pb.TagNumber(7)
  set numericValue($core.double v) { $_setFloat(3, v); }
  @$pb.TagNumber(7)
...
class MetadataFilter extends $pb.GeneratedMessage {
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(_omitMessageNames ? '' : 'MetadataFilter', package: const $pb.PackageName(_omitMessageNames ? '' : 'google.ai.generativelanguage.v1beta'), createEmptyInstance: create)
    ..aOS(1, _omitFieldNames ? '' : 'key')
...
class Condition extends $pb.GeneratedMessage {
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(_omitMessageNames ? '' : 'Condition', package: const $pb.PackageName(_omitMessageNames ? '' : 'google.ai.generativelanguage.v1beta'), createEmptyInstance: create)
    ..oo(0, [1, 6])
    ..aOS(1, _omitFieldNames ? '' : 'stringValue')
    ..e<Condition_Operator>(5, _omitFieldNames ? '' : 'operation', $pb.PbFieldType.OE, defaultOrMaker: Condition_Operator.OPERATOR_UNSPECIFIED, valueOf: Condition_Operator.valueOf, enumValues: Condition_Operator.values)
    ..a<$core.double>(6, _omitFieldNames ? '' : 'numericValue', $pb.PbFieldType.OF)
    ..hasRequiredFields = false
  ;
  ...
  @$pb.TagNumber(5)
  set operation(Condition_Operator v) { setField(5, v); }
  @$pb.TagNumber(5)
  ...
  @$pb.TagNumber(6)
  set numericValue($core.double v) { $_setFloat(2, v); }
  @$pb.TagNumber(6)
...
class Chunk extends $pb.GeneratedMessage {
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(_omitMessageNames ? '' : 'Chunk', package: const $pb.PackageName(_omitMessageNames ? '' : 'google.ai.generativelanguage.v1beta'), createEmptyInstance: create)
    ..aOS(1, _omitFieldNames ? '' : 'name')
  ...
  @$pb.TagNumber(2)
  set data(ChunkData v) { setField(2, v); }
  @$pb.TagNumber(2)
  ...
  @$pb.TagNumber(6)
  set state(Chunk_State v) { setField(6, v); }
  @$pb.TagNumber(6)
...
class ChunkData extends $pb.GeneratedMessage {
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(_omitMessageNames ? '' : 'ChunkData', package: const $pb.PackageName(_omitMessageNames ? '' : 'google.ai.generativelanguage.v1beta'), createEmptyInstance: create)
    ..oo(0, [1])
    ..aOS(1, _omitFieldNames ? '' : 'stringValue')
    ..hasRequiredFields = false
  ;
