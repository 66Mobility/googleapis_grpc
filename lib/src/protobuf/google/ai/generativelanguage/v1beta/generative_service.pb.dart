...
import 'content.pb.dart' as $4143;
...
class GenerateContentRequest extends $pb.GeneratedMessage {
  factory GenerateContentRequest({
    $core.String? model,
    $core.Iterable<$4143.Content>? contents,
    $core.Iterable<$4144.SafetySetting>? safetySettings,
    GenerationConfig? generationConfig,
    $core.Iterable<$4143.Tool>? tools,
    $4143.ToolConfig? toolConfig,
    $4143.Content? systemInstruction,
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(_omitMessageNames ? '' : 'GenerateContentRequest', package: const $pb.PackageName(_omitMessageNames ? '' : 'google.ai.generativelanguage.v1beta'), createEmptyInstance: create)
    ...
    ..pc<$4143.Content>(2, _omitFieldNames ? '' : 'contents', $pb.PbFieldType.PM, subBuilder: $4143.Content.create)
    ..pc<$4144.SafetySetting>(3, _omitFieldNames ? '' : 'safetySettings', $pb.PbFieldType.PM, subBuilder: $4144.SafetySetting.create)
    ..aOM<GenerationConfig>(4, _omitFieldNames ? '' : 'generationConfig', subBuilder: GenerationConfig.create)
    ..pc<$4143.Tool>(5, _omitFieldNames ? '' : 'tools', $pb.PbFieldType.PM, subBuilder: $4143.Tool.create)
    ..aOM<$4143.ToolConfig>(7, _omitFieldNames ? '' : 'toolConfig', subBuilder: $4143.ToolConfig.create)
    ..aOM<$4143.Content>(8, _omitFieldNames ? '' : 'systemInstruction', subBuilder: $4143.Content.create)
  ...
  ///  latest request.
  @$pb.TagNumber(2)
  $core.List<$4143.Content> get contents => $_getList(1);
  ...
  @$pb.TagNumber(3)
  $core.List<$4144.SafetySetting> get safetySettings => $_getList(2);
  ...
  @$pb.TagNumber(5)
  $core.List<$4143.Tool> get tools => $_getList(4);
  ...
  /// for a usage example.
  @$pb.TagNumber(7)
  $4143.ToolConfig get toolConfig => $_getN(5);
  @$pb.TagNumber(7)
  set toolConfig($4143.ToolConfig v) { setField(7, v); }
  @$pb.TagNumber(7)
  $core.bool hasToolConfig() => $_has(5);
  @$pb.TagNumber(7)
  void clearToolConfig() => clearField(7);
  @$pb.TagNumber(7)
  $4143.ToolConfig ensureToolConfig() => $_ensure(5);

  /// Optional. Developer set [system
  /// instruction(s)](https://ai.google.dev/gemini-api/docs/system-instructions).
  /// Currently, text only.
  @$pb.TagNumber(8)
  $4143.Content get systemInstruction => $_getN(6);
  @$pb.TagNumber(8)
  set systemInstruction($4143.Content v) { setField(8, v); }
  @$pb.TagNumber(8)
  $core.bool hasSystemInstruction() => $_has(6);
  @$pb.TagNumber(8)
  void clearSystemInstruction() => clearField(8);
  @$pb.TagNumber(8)
  $4143.Content ensureSystemInstruction() => $_ensure(6);
...
class GenerationConfig extends $pb.GeneratedMessage {
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(_omitMessageNames ? '' : 'GenerationConfig', package: const $pb.PackageName(_omitMessageNames ? '' : 'google.ai.generativelanguage.v1beta'), createEmptyInstance: create)
    ...
    ..aOM<$4143.Schema>(14, _omitFieldNames ? '' : 'responseSchema', subBuilder: $4143.Schema.create)
    ..hasRequiredFields = false
  ;
  ...
  @$pb.TagNumber(14)
  $4143.Schema get responseSchema => $_getN(7);
  @$pb.TagNumber(14)
  set responseSchema($4143.Schema v) { setField(14, v); }
  @$pb.TagNumber(14)
  $core.bool hasResponseSchema() => $_has(7);
  @$pb.TagNumber(14)
  void clearResponseSchema() => clearField(14);
  @$pb.TagNumber(14)
  $4143.Schema ensureResponseSchema() => $_ensure(7);
}
...
class SemanticRetrieverConfig extends $pb.GeneratedMessage {
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(_omitMessageNames ? '' : 'SemanticRetrieverConfig', package: const $pb.PackageName(_omitMessageNames ? '' : 'google.ai.generativelanguage.v1beta'), createEmptyInstance: create)
    ...
    ..aOM<$4143.Content>(2, _omitFieldNames ? '' : 'query', subBuilder: $4143.Content.create)
  ...
  /// similarity.
  @$pb.TagNumber(2)
  $4143.Content get query => $_getN(1);
  @$pb.TagNumber(2)
  set query($4143.Content v) { setField(2, v); }
  @$pb.TagNumber(2)
  $core.bool hasQuery() => $_has(1);
  @$pb.TagNumber(2)
  void clearQuery() => clearField(2);
  @$pb.TagNumber(2)
  $4143.Content ensureQuery() => $_ensure(1);
...
class Candidate extends $pb.GeneratedMessage {
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(_omitMessageNames ? '' : 'Candidate', package: const $pb.PackageName(_omitMessageNames ? '' : 'google.ai.generativelanguage.v1beta'), createEmptyInstance: create)
    ..aOM<$4143.Content>(1, _omitFieldNames ? '' : 'content', subBuilder: $4143.Content.create)
    ...
    ..pc<$4144.SafetyRating>(5, _omitFieldNames ? '' : 'safetyRatings', $pb.PbFieldType.PM, subBuilder: $4144.SafetyRating.create)
    ..aOM<$4145.CitationMetadata>(6, _omitFieldNames ? '' : 'citationMetadata', subBuilder: $4145.CitationMetadata.create)
  ...
  @$pb.TagNumber(1)
  $4143.Content get content => $_getN(0);
  @$pb.TagNumber(1)
  set content($4143.Content v) { setField(1, v); }
  @$pb.TagNumber(1)
  $core.bool hasContent() => $_has(0);
  @$pb.TagNumber(1)
  void clearContent() => clearField(1);
  @$pb.TagNumber(1)
  $4143.Content ensureContent() => $_ensure(0);
  ...
  ///  There is at most one rating per category.
  @$pb.TagNumber(5)
  $core.List<$4144.SafetyRating> get safetyRatings => $_getList(3);
  ...
  @$pb.TagNumber(6)
  $4145.CitationMetadata get citationMetadata => $_getN(4);
  @$pb.TagNumber(6)
  set citationMetadata($4145.CitationMetadata v) { setField(6, v); }
  @$pb.TagNumber(6)
  $core.bool hasCitationMetadata() => $_has(4);
  @$pb.TagNumber(6)
  void clearCitationMetadata() => clearField(6);
  @$pb.TagNumber(6)
  $4145.CitationMetadata ensureCitationMetadata() => $_ensure(4);
...
class GroundingAttribution extends $pb.GeneratedMessage {
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(_omitMessageNames ? '' : 'GroundingAttribution', package: const $pb.PackageName(_omitMessageNames ? '' : 'google.ai.generativelanguage.v1beta'), createEmptyInstance: create)
    ..aOM<$4143.Content>(2, _omitFieldNames ? '' : 'content', subBuilder: $4143.Content.create)
  ...
  $4143.Content get content => $_getN(0);
  @$pb.TagNumber(2)
  set content($4143.Content v) { setField(2, v); }
  @$pb.TagNumber(2)
  $core.bool hasContent() => $_has(0);
  @$pb.TagNumber(2)
...
class GenerateAnswerRequest extends $pb.GeneratedMessage {
  factory GenerateAnswerRequest({
    ...
    $4143.GroundingPassages? inlinePassages,
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(_omitMessageNames ? '' : 'GenerateAnswerRequest', package: const $pb.PackageName(_omitMessageNames ? '' : 'google.ai.generativelanguage.v1beta'), createEmptyInstance: create)
    ...
    ..aOM<$4143.GroundingPassages>(6, _omitFieldNames ? '' : 'inlinePassages', subBuilder: $4143.GroundingPassages.create)
  ...
  @$pb.TagNumber(6)
  $4143.GroundingPassages get inlinePassages => $_getN(5);
  @$pb.TagNumber(6)
  set inlinePassages($4143.GroundingPassages v) { setField(6, v); }
  @$pb.TagNumber(6)
  $core.bool hasInlinePassages() => $_has(5);
  @$pb.TagNumber(6)
  void clearInlinePassages() => clearField(6);
  @$pb.TagNumber(6)
  $4143.GroundingPassages ensureInlinePassages() => $_ensure(5);
...
class EmbedContentRequest extends $pb.GeneratedMessage {
  ...
  /// counted.
  @$pb.TagNumber(2)
  $4143.Content get content => $_getN(1);
  @$pb.TagNumber(2)
  set content($4143.Content v) { setField(2, v); }
  @$pb.TagNumber(2)
  ...
  void clearContent() => clearField(2);
  @$pb.TagNumber(2)
  $4143.Content ensureContent() => $_ensure(1);
