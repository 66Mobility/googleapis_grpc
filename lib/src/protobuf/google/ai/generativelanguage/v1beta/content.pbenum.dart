...
class ExecutableCode_Language extends $pb.ProtobufEnum {
  static const ExecutableCode_Language LANGUAGE_UNSPECIFIED = ExecutableCode_Language._(0, _omitEnumNames ? '' : 'LANGUAGE_UNSPECIFIED');
  static const ExecutableCode_Language PYTHON = ExecutableCode_Language._(1, _omitEnumNames ? '' : 'PYTHON');

  static const $core.List<ExecutableCode_Language> values = <ExecutableCode_Language> [
    LANGUAGE_UNSPECIFIED,
    PYTHON,
  ];

  static final $core.Map<$core.int, ExecutableCode_Language> _byValue = $pb.ProtobufEnum.initByValue(values);
...
class CodeExecutionResult_Outcome extends $pb.ProtobufEnum {
  static const CodeExecutionResult_Outcome OUTCOME_UNSPECIFIED = CodeExecutionResult_Outcome._(0, _omitEnumNames ? '' : 'OUTCOME_UNSPECIFIED');
  static const CodeExecutionResult_Outcome OUTCOME_OK = CodeExecutionResult_Outcome._(1, _omitEnumNames ? '' : 'OUTCOME_OK');
  static const CodeExecutionResult_Outcome OUTCOME_FAILED = CodeExecutionResult_Outcome._(2, _omitEnumNames ? '' : 'OUTCOME_FAILED');
  static const CodeExecutionResult_Outcome OUTCOME_DEADLINE_EXCEEDED = CodeExecutionResult_Outcome._(3, _omitEnumNames ? '' : 'OUTCOME_DEADLINE_EXCEEDED');

  static const $core.List<CodeExecutionResult_Outcome> values = <CodeExecutionResult_Outcome> [
    OUTCOME_UNSPECIFIED,
    OUTCOME_OK,
    OUTCOME_FAILED,
  ...
  static final $core.Map<$core.int, CodeExecutionResult_Outcome> _byValue = $pb.ProtobufEnum.initByValue(values);
  static CodeExecutionResult_Outcome? valueOf($core.int value) => _byValue[value];
