...
class PredictRequest extends $pb.GeneratedMessage {
  factory PredictRequest({
    $core.String? model,
    $core.Iterable<$289.Value>? instances,
    $289.Value? parameters,
  }) {
    final $result = create();
    if (model != null) {
      $result.model = model;
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(
    ...
    ..pc<$289.Value>(2, _omitFieldNames ? '' : 'instances', $pb.PbFieldType.PM,
        subBuilder: $289.Value.create)
    ..aOM<$289.Value>(3, _omitFieldNames ? '' : 'parameters',
        subBuilder: $289.Value.create)
  ...
  @$pb.TagNumber(2)
  $core.List<$289.Value> get instances => $_getList(1);

  /// Optional. The parameters that govern the prediction call.
  @$pb.TagNumber(3)
  $289.Value get parameters => $_getN(2);
  @$pb.TagNumber(3)
  set parameters($289.Value v) {
    setField(3, v);
  }
...
class PredictResponse extends $pb.GeneratedMessage {
  ...
  @$pb.TagNumber(1)
  $core.List<$289.Value> get predictions => $_getList(0);
}
