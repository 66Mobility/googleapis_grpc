...
class CachedContent extends $pb.GeneratedMessage {
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(_omitMessageNames ? '' : 'CachedContent', package: const $pb.PackageName(_omitMessageNames ? '' : 'google.ai.generativelanguage.v1beta'), createEmptyInstance: create)
    ...
    ..aOM<$4143.Content>(3, _omitFieldNames ? '' : 'systemInstruction', subBuilder: $4143.Content.create)
    ..pc<$4143.Content>(4, _omitFieldNames ? '' : 'contents', $pb.PbFieldType.PM, subBuilder: $4143.Content.create)
    ..pc<$4143.Tool>(5, _omitFieldNames ? '' : 'tools', $pb.PbFieldType.PM, subBuilder: $4143.Tool.create)
    ..aOM<$4143.ToolConfig>(6, _omitFieldNames ? '' : 'toolConfig', subBuilder: $4143.ToolConfig.create)
  ...
  /// Currently text only.
  @$pb.TagNumber(3)
  $4143.Content get systemInstruction => $_getN(2);
  @$pb.TagNumber(3)
  set systemInstruction($4143.Content v) { setField(3, v); }
  @$pb.TagNumber(3)
  $core.bool hasSystemInstruction() => $_has(2);
  @$pb.TagNumber(3)
  void clearSystemInstruction() => clearField(3);
  @$pb.TagNumber(3)
  $4143.Content ensureSystemInstruction() => $_ensure(2);

  /// Optional. Input only. Immutable. The content to cache.
  @$pb.TagNumber(4)
  $core.List<$4143.Content> get contents => $_getList(3);
  ...
  @$pb.TagNumber(6)
  set toolConfig($4143.ToolConfig v) { setField(6, v); }
  @$pb.TagNumber(6)
