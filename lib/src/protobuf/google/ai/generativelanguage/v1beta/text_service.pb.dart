...
import 'citation.pb.dart' as $4145;
import 'safety.pb.dart' as $4144;
...
class GenerateTextRequest extends $pb.GeneratedMessage {
  factory GenerateTextRequest({
    ...
    $core.double? topP,
    $core.int? topK,
    $core.Iterable<$4144.SafetySetting>? safetySettings,
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(_omitMessageNames ? '' : 'GenerateTextRequest', package: const $pb.PackageName(_omitMessageNames ? '' : 'google.ai.generativelanguage.v1beta'), createEmptyInstance: create)
    ...
    ..pc<$4144.SafetySetting>(8, _omitFieldNames ? '' : 'safetySettings', $pb.PbFieldType.PM, subBuilder: $4144.SafetySetting.create)
  ...
  ///  service.
  @$pb.TagNumber(8)
  $core.List<$4144.SafetySetting> get safetySettings => $_getList(7);
...
class GenerateTextResponse extends $pb.GeneratedMessage {
  factory GenerateTextResponse({
    ...
    $core.Iterable<$4144.ContentFilter>? filters,
    $core.Iterable<$4144.SafetyFeedback>? safetyFeedback,
  }) {
    final $result = create();
    if (candidates != null) {
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(_omitMessageNames ? '' : 'GenerateTextResponse', package: const $pb.PackageName(_omitMessageNames ? '' : 'google.ai.generativelanguage.v1beta'), createEmptyInstance: create)
    ..pc<TextCompletion>(1, _omitFieldNames ? '' : 'candidates', $pb.PbFieldType.PM, subBuilder: TextCompletion.create)
    ..pc<$4144.ContentFilter>(3, _omitFieldNames ? '' : 'filters', $pb.PbFieldType.PM, subBuilder: $4144.ContentFilter.create)
    ..pc<$4144.SafetyFeedback>(4, _omitFieldNames ? '' : 'safetyFeedback', $pb.PbFieldType.PM, subBuilder: $4144.SafetyFeedback.create)
    ..hasRequiredFields = false
  ;
  ...
  @$pb.TagNumber(3)
  $core.List<$4144.ContentFilter> get filters => $_getList(1);

  /// Returns any safety feedback related to content filtering.
  @$pb.TagNumber(4)
  $core.List<$4144.SafetyFeedback> get safetyFeedback => $_getList(2);
}
...
class TextPrompt extends $pb.GeneratedMessage {
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(_omitMessageNames ? '' : 'TextPrompt', package: const $pb.PackageName(_omitMessageNames ? '' : 'google.ai.generativelanguage.v1beta'), createEmptyInstance: create)
...
class TextCompletion extends $pb.GeneratedMessage {
  factory TextCompletion({
    $core.String? output,
    $core.Iterable<$4144.SafetyRating>? safetyRatings,
    $4145.CitationMetadata? citationMetadata,
  }) {
    final $result = create();
    if (output != null) {
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(_omitMessageNames ? '' : 'TextCompletion', package: const $pb.PackageName(_omitMessageNames ? '' : 'google.ai.generativelanguage.v1beta'), createEmptyInstance: create)
    ..aOS(1, _omitFieldNames ? '' : 'output')
    ..pc<$4144.SafetyRating>(2, _omitFieldNames ? '' : 'safetyRatings', $pb.PbFieldType.PM, subBuilder: $4144.SafetyRating.create)
    ..aOM<$4145.CitationMetadata>(3, _omitFieldNames ? '' : 'citationMetadata', subBuilder: $4145.CitationMetadata.create)
    ..hasRequiredFields = false
  ;
  ...
  @$pb.TagNumber(2)
  $core.List<$4144.SafetyRating> get safetyRatings => $_getList(1);
  ...
  @$pb.TagNumber(3)
  $4145.CitationMetadata get citationMetadata => $_getN(2);
  @$pb.TagNumber(3)
  set citationMetadata($4145.CitationMetadata v) { setField(3, v); }
  @$pb.TagNumber(3)
  $core.bool hasCitationMetadata() => $_has(2);
  @$pb.TagNumber(3)
  void clearCitationMetadata() => clearField(3);
  @$pb.TagNumber(3)
  $4145.CitationMetadata ensureCitationMetadata() => $_ensure(2);
}
...
class EmbedTextRequest extends $pb.GeneratedMessage {
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(_omitMessageNames ? '' : 'EmbedTextRequest', package: const $pb.PackageName(_omitMessageNames ? '' : 'google.ai.generativelanguage.v1beta'), createEmptyInstance: create)
    ..aOS(1, _omitFieldNames ? '' : 'model')
...
class EmbedTextResponse extends $pb.GeneratedMessage {
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(_omitMessageNames ? '' : 'EmbedTextResponse', package: const $pb.PackageName(_omitMessageNames ? '' : 'google.ai.generativelanguage.v1beta'), createEmptyInstance: create)
...
class BatchEmbedTextRequest extends $pb.GeneratedMessage {
  ...
  factory BatchEmbedTextRequest.fromBuffer($core.List<$core.int> i, [$pb.ExtensionRegistry r = $pb.ExtensionRegistry.EMPTY]) => create()..mergeFromBuffer(i, r);
  factory BatchEmbedTextRequest.fromJson($core.String i, [$pb.ExtensionRegistry r = $pb.ExtensionRegistry.EMPTY]) => create()..mergeFromJson(i, r);

  static final $pb.BuilderInfo _i = $pb.BuilderInfo(_omitMessageNames ? '' : 'BatchEmbedTextRequest', package: const $pb.PackageName(_omitMessageNames ? '' : 'google.ai.generativelanguage.v1beta'), createEmptyInstance: create)
    ..aOS(1, _omitFieldNames ? '' : 'model')
    ..pPS(2, _omitFieldNames ? '' : 'texts')
    ..pc<EmbedTextRequest>(3, _omitFieldNames ? '' : 'requests', $pb.PbFieldType.PM, subBuilder: EmbedTextRequest.create)
    ..hasRequiredFields = false
  ;
  ...
  'Use [GeneratedMessageGenericExtensions.deepCopy] instead. '
  'Will be removed in next major version')
  BatchEmbedTextRequest clone() => BatchEmbedTextRequest()..mergeFromMessage(this);
  @$core.Deprecated(
  'Using this can add significant overhead to your binary. '
  'Use [GeneratedMessageGenericExtensions.rebuild] instead. '
  'Will be removed in next major version')
  BatchEmbedTextRequest copyWith(void Function(BatchEmbedTextRequest) updates) => super.copyWith((message) => updates(message as BatchEmbedTextRequest)) as BatchEmbedTextRequest;
  ...
  static $pb.PbList<BatchEmbedTextRequest> createRepeated() => $pb.PbList<BatchEmbedTextRequest>();
  @$core.pragma('dart2js:noInline')
  static BatchEmbedTextRequest getDefault() => _defaultInstance ??= $pb.GeneratedMessage.$_defaultFor<BatchEmbedTextRequest>(create);
...
class BatchEmbedTextResponse extends $pb.GeneratedMessage {
  ...
  factory BatchEmbedTextResponse.fromBuffer($core.List<$core.int> i, [$pb.ExtensionRegistry r = $pb.ExtensionRegistry.EMPTY]) => create()..mergeFromBuffer(i, r);
  factory BatchEmbedTextResponse.fromJson($core.String i, [$pb.ExtensionRegistry r = $pb.ExtensionRegistry.EMPTY]) => create()..mergeFromJson(i, r);

  static final $pb.BuilderInfo _i = $pb.BuilderInfo(_omitMessageNames ? '' : 'BatchEmbedTextResponse', package: const $pb.PackageName(_omitMessageNames ? '' : 'google.ai.generativelanguage.v1beta'), createEmptyInstance: create)
    ..pc<Embedding>(1, _omitFieldNames ? '' : 'embeddings', $pb.PbFieldType.PM, subBuilder: Embedding.create)
    ..hasRequiredFields = false
  ;
  ...
  'Use [GeneratedMessageGenericExtensions.deepCopy] instead. '
  'Will be removed in next major version')
  BatchEmbedTextResponse clone() => BatchEmbedTextResponse()..mergeFromMessage(this);
  @$core.Deprecated(
  'Using this can add significant overhead to your binary. '
  'Use [GeneratedMessageGenericExtensions.rebuild] instead. '
  'Will be removed in next major version')
  BatchEmbedTextResponse copyWith(void Function(BatchEmbedTextResponse) updates) => super.copyWith((message) => updates(message as BatchEmbedTextResponse)) as BatchEmbedTextResponse;
  ...
  static $pb.PbList<BatchEmbedTextResponse> createRepeated() => $pb.PbList<BatchEmbedTextResponse>();
  @$core.pragma('dart2js:noInline')
  static BatchEmbedTextResponse getDefault() => _defaultInstance ??= $pb.GeneratedMessage.$_defaultFor<BatchEmbedTextResponse>(create);
...
class Embedding extends $pb.GeneratedMessage {
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(_omitMessageNames ? '' : 'Embedding', package: const $pb.PackageName(_omitMessageNames ? '' : 'google.ai.generativelanguage.v1beta'), createEmptyInstance: create)
...
class CountTextTokensRequest extends $pb.GeneratedMessage {
  ...
  factory CountTextTokensRequest.fromBuffer($core.List<$core.int> i, [$pb.ExtensionRegistry r = $pb.ExtensionRegistry.EMPTY]) => create()..mergeFromBuffer(i, r);
  factory CountTextTokensRequest.fromJson($core.String i, [$pb.ExtensionRegistry r = $pb.ExtensionRegistry.EMPTY]) => create()..mergeFromJson(i, r);

  static final $pb.BuilderInfo _i = $pb.BuilderInfo(_omitMessageNames ? '' : 'CountTextTokensRequest', package: const $pb.PackageName(_omitMessageNames ? '' : 'google.ai.generativelanguage.v1beta'), createEmptyInstance: create)
    ..aOS(1, _omitFieldNames ? '' : 'model')
    ..aOM<TextPrompt>(2, _omitFieldNames ? '' : 'prompt', subBuilder: TextPrompt.create)
    ..hasRequiredFields = false
  ;
  ...
  'Use [GeneratedMessageGenericExtensions.deepCopy] instead. '
  'Will be removed in next major version')
  CountTextTokensRequest clone() => CountTextTokensRequest()..mergeFromMessage(this);
  @$core.Deprecated(
  'Using this can add significant overhead to your binary. '
  'Use [GeneratedMessageGenericExtensions.rebuild] instead. '
  'Will be removed in next major version')
  CountTextTokensRequest copyWith(void Function(CountTextTokensRequest) updates) => super.copyWith((message) => updates(message as CountTextTokensRequest)) as CountTextTokensRequest;
  ...
  static $pb.PbList<CountTextTokensRequest> createRepeated() => $pb.PbList<CountTextTokensRequest>();
  @$core.pragma('dart2js:noInline')
  static CountTextTokensRequest getDefault() => _defaultInstance ??= $pb.GeneratedMessage.$_defaultFor<CountTextTokensRequest>(create);
...
class CountTextTokensResponse extends $pb.GeneratedMessage {
  ...
  factory CountTextTokensResponse.fromBuffer($core.List<$core.int> i, [$pb.ExtensionRegistry r = $pb.ExtensionRegistry.EMPTY]) => create()..mergeFromBuffer(i, r);
  factory CountTextTokensResponse.fromJson($core.String i, [$pb.ExtensionRegistry r = $pb.ExtensionRegistry.EMPTY]) => create()..mergeFromJson(i, r);

  static final $pb.BuilderInfo _i = $pb.BuilderInfo(_omitMessageNames ? '' : 'CountTextTokensResponse', package: const $pb.PackageName(_omitMessageNames ? '' : 'google.ai.generativelanguage.v1beta'), createEmptyInstance: create)
  ...
  'Use [GeneratedMessageGenericExtensions.deepCopy] instead. '
  'Will be removed in next major version')
  CountTextTokensResponse clone() => CountTextTokensResponse()..mergeFromMessage(this);
  @$core.Deprecated(
  'Using this can add significant overhead to your binary. '
  'Use [GeneratedMessageGenericExtensions.rebuild] instead. '
  'Will be removed in next major version')
  CountTextTokensResponse copyWith(void Function(CountTextTokensResponse) updates) => super.copyWith((message) => updates(message as CountTextTokensResponse)) as CountTextTokensResponse;
  ...
  static $pb.PbList<CountTextTokensResponse> createRepeated() => $pb.PbList<CountTextTokensResponse>();
  @$core.pragma('dart2js:noInline')
  static CountTextTokensResponse getDefault() => _defaultInstance ??= $pb.GeneratedMessage.$_defaultFor<CountTextTokensResponse>(create);
  ...
  @$pb.TagNumber(1)
  set tokenCount($core.int v) { $_setSignedInt32(0, v); }
  @$pb.TagNumber(1)
