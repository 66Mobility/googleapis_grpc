...
class GenerateTextRequest extends $pb.GeneratedMessage {
  ...
  ///  service.
  @$pb.TagNumber(8)
  $core.List<$365.SafetySetting> get safetySettings => $_getList(7);
...
class GenerateTextResponse extends $pb.GeneratedMessage {
  factory GenerateTextResponse({
    ...
    $core.Iterable<$365.ContentFilter>? filters,
    $core.Iterable<$365.SafetyFeedback>? safetyFeedback,
  }) {
    final $result = create();
    if (candidates != null) {
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(
    ...
    ..pc<$365.ContentFilter>(
        3, _omitFieldNames ? '' : 'filters', $pb.PbFieldType.PM,
        subBuilder: $365.ContentFilter.create)
    ..pc<$365.SafetyFeedback>(
        4, _omitFieldNames ? '' : 'safetyFeedback', $pb.PbFieldType.PM,
        subBuilder: $365.SafetyFeedback.create)
    ..hasRequiredFields = false;
  ...
  @$pb.TagNumber(3)
  $core.List<$365.ContentFilter> get filters => $_getList(1);

  /// Returns any safety feedback related to content filtering.
  @$pb.TagNumber(4)
  $core.List<$365.SafetyFeedback> get safetyFeedback => $_getList(2);
}
...
class TextCompletion extends $pb.GeneratedMessage {
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(
    ...
    ..aOM<$366.CitationMetadata>(3, _omitFieldNames ? '' : 'citationMetadata',
  ...
  @$pb.TagNumber(3)
  $366.CitationMetadata get citationMetadata => $_getN(2);
  @$pb.TagNumber(3)
  ...
  @$pb.TagNumber(3)
  $366.CitationMetadata ensureCitationMetadata() => $_ensure(2);
}
