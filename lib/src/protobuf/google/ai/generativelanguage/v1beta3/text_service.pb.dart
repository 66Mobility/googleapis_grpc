...
import 'citation.pb.dart' as $4150;
import 'safety.pb.dart' as $4149;
...
class GenerateTextRequest extends $pb.GeneratedMessage {
  factory GenerateTextRequest({
    ...
    $core.double? topP,
    $core.int? topK,
    $core.Iterable<$4149.SafetySetting>? safetySettings,
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(_omitMessageNames ? '' : 'GenerateTextRequest', package: const $pb.PackageName(_omitMessageNames ? '' : 'google.ai.generativelanguage.v1beta3'), createEmptyInstance: create)
    ...
    ..pc<$4149.SafetySetting>(8, _omitFieldNames ? '' : 'safetySettings', $pb.PbFieldType.PM, subBuilder: $4149.SafetySetting.create)
  ...
  @$pb.TagNumber(8)
  $core.List<$4149.SafetySetting> get safetySettings => $_getList(7);
...
class GenerateTextResponse extends $pb.GeneratedMessage {
  factory GenerateTextResponse({
    ...
    $core.Iterable<$4149.ContentFilter>? filters,
    $core.Iterable<$4149.SafetyFeedback>? safetyFeedback,
  }) {
    final $result = create();
    if (candidates != null) {
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(_omitMessageNames ? '' : 'GenerateTextResponse', package: const $pb.PackageName(_omitMessageNames ? '' : 'google.ai.generativelanguage.v1beta3'), createEmptyInstance: create)
    ...
    ..pc<$4149.ContentFilter>(3, _omitFieldNames ? '' : 'filters', $pb.PbFieldType.PM, subBuilder: $4149.ContentFilter.create)
    ..pc<$4149.SafetyFeedback>(4, _omitFieldNames ? '' : 'safetyFeedback', $pb.PbFieldType.PM, subBuilder: $4149.SafetyFeedback.create)
    ..hasRequiredFields = false
  ;
  ...
  @$pb.TagNumber(3)
  $core.List<$4149.ContentFilter> get filters => $_getList(1);

  /// Returns any safety feedback related to content filtering.
  @$pb.TagNumber(4)
  $core.List<$4149.SafetyFeedback> get safetyFeedback => $_getList(2);
}
...
class TextCompletion extends $pb.GeneratedMessage {
  factory TextCompletion({
    $core.String? output,
    $core.Iterable<$4149.SafetyRating>? safetyRatings,
    $4150.CitationMetadata? citationMetadata,
  }) {
    final $result = create();
    if (output != null) {
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(_omitMessageNames ? '' : 'TextCompletion', package: const $pb.PackageName(_omitMessageNames ? '' : 'google.ai.generativelanguage.v1beta3'), createEmptyInstance: create)
    ...
    ..pc<$4149.SafetyRating>(2, _omitFieldNames ? '' : 'safetyRatings', $pb.PbFieldType.PM, subBuilder: $4149.SafetyRating.create)
    ..aOM<$4150.CitationMetadata>(3, _omitFieldNames ? '' : 'citationMetadata', subBuilder: $4150.CitationMetadata.create)
    ..hasRequiredFields = false
  ;
  ...
  @$pb.TagNumber(2)
  $core.List<$4149.SafetyRating> get safetyRatings => $_getList(1);
  ...
  @$pb.TagNumber(3)
  $4150.CitationMetadata get citationMetadata => $_getN(2);
  @$pb.TagNumber(3)
  set citationMetadata($4150.CitationMetadata v) { setField(3, v); }
  @$pb.TagNumber(3)
  $core.bool hasCitationMetadata() => $_has(2);
  @$pb.TagNumber(3)
  void clearCitationMetadata() => clearField(3);
  @$pb.TagNumber(3)
  $4150.CitationMetadata ensureCitationMetadata() => $_ensure(2);
}
