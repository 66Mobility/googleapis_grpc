...
class Permission extends $pb.GeneratedMessage {
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(_omitMessageNames ? '' : 'Permission', package: const $pb.PackageName(_omitMessageNames ? '' : 'google.ai.generativelanguage.v1beta3'), createEmptyInstance: create)
    ..aOS(1, _omitFieldNames ? '' : 'name')
    ..e<Permission_GranteeType>(2, _omitFieldNames ? '' : 'granteeType', $pb.PbFieldType.OE, defaultOrMaker: Permission_GranteeType.GRANTEE_TYPE_UNSPECIFIED, valueOf: Permission_GranteeType.valueOf, enumValues: Permission_GranteeType.values)
    ..aOS(3, _omitFieldNames ? '' : 'emailAddress')
    ..e<Permission_Role>(4, _omitFieldNames ? '' : 'role', $pb.PbFieldType.OE, defaultOrMaker: Permission_Role.ROLE_UNSPECIFIED, valueOf: Permission_Role.valueOf, enumValues: Permission_Role.values)
  ...
  @$pb.TagNumber(2)
  set granteeType(Permission_GranteeType v) { setField(2, v); }
  @$pb.TagNumber(2)
  ...
  @$pb.TagNumber(4)
  set role(Permission_Role v) { setField(4, v); }
  @$pb.TagNumber(4)
