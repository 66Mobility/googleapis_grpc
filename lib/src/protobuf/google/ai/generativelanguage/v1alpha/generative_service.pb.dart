...
import 'citation.pb.dart' as $363;
import 'content.pb.dart' as $360;
import 'generative_service.pbenum.dart';
import 'retriever.pb.dart' as $21;
import 'safety.pb.dart' as $362;
...
class GenerateContentRequest extends $pb.GeneratedMessage {
  factory GenerateContentRequest({
    $core.String? model,
    $core.Iterable<$360.Content>? contents,
    $core.Iterable<$362.SafetySetting>? safetySettings,
    GenerationConfig? generationConfig,
    $core.Iterable<$360.Tool>? tools,
    $360.ToolConfig? toolConfig,
    $360.Content? systemInstruction,
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(
    ...
    ..pc<$360.Content>(2, _omitFieldNames ? '' : 'contents', $pb.PbFieldType.PM,
        subBuilder: $360.Content.create)
    ..pc<$362.SafetySetting>(
        3, _omitFieldNames ? '' : 'safetySettings', $pb.PbFieldType.PM,
        subBuilder: $362.SafetySetting.create)
    ..aOM<GenerationConfig>(4, _omitFieldNames ? '' : 'generationConfig',
        subBuilder: GenerationConfig.create)
    ..pc<$360.Tool>(5, _omitFieldNames ? '' : 'tools', $pb.PbFieldType.PM,
        subBuilder: $360.Tool.create)
    ..aOM<$360.ToolConfig>(7, _omitFieldNames ? '' : 'toolConfig',
        subBuilder: $360.ToolConfig.create)
    ..aOM<$360.Content>(8, _omitFieldNames ? '' : 'systemInstruction',
        subBuilder: $360.Content.create)
  ...
  ///  latest request.
  @$pb.TagNumber(2)
  $core.List<$360.Content> get contents => $_getList(1);
  ...
  @$pb.TagNumber(3)
  $core.List<$362.SafetySetting> get safetySettings => $_getList(2);
  ...
  @$pb.TagNumber(5)
  $core.List<$360.Tool> get tools => $_getList(4);
  ...
  /// for a usage example.
  @$pb.TagNumber(7)
  $360.ToolConfig get toolConfig => $_getN(5);
  @$pb.TagNumber(7)
  set toolConfig($360.ToolConfig v) {
    setField(7, v);
  }
  ...
  @$pb.TagNumber(7)
  $360.ToolConfig ensureToolConfig() => $_ensure(5);

  /// Optional. Developer set [system
  /// instruction(s)](https://ai.google.dev/gemini-api/docs/system-instructions).
  /// Currently, text only.
  @$pb.TagNumber(8)
  $360.Content get systemInstruction => $_getN(6);
  @$pb.TagNumber(8)
  set systemInstruction($360.Content v) {
    setField(8, v);
  }
  ...
  @$pb.TagNumber(8)
  $360.Content ensureSystemInstruction() => $_ensure(6);
...
class GenerationConfig extends $pb.GeneratedMessage {
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(
    ...
    ..aOM<$360.Schema>(14, _omitFieldNames ? '' : 'responseSchema',
        subBuilder: $360.Schema.create)
    ..a<$core.double>(
  ...
  @$pb.TagNumber(14)
  $360.Schema get responseSchema => $_getN(7);
  @$pb.TagNumber(14)
  set responseSchema($360.Schema v) {
    setField(14, v);
  }
  ...
  @$pb.TagNumber(14)
  $360.Schema ensureResponseSchema() => $_ensure(7);
...
class SemanticRetrieverConfig extends $pb.GeneratedMessage {
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(
    ...
    ..aOM<$360.Content>(2, _omitFieldNames ? '' : 'query',
        subBuilder: $360.Content.create)
  ...
  /// similarity.
  @$pb.TagNumber(2)
  $360.Content get query => $_getN(1);
  @$pb.TagNumber(2)
  set query($360.Content v) {
    setField(2, v);
  }
  ...
  @$pb.TagNumber(2)
  $360.Content ensureQuery() => $_ensure(1);
...
class GenerateContentResponse_PromptFeedback extends $pb.GeneratedMessage {
  factory GenerateContentResponse_PromptFeedback({
    ...
    $core.Iterable<$362.SafetyRating>? safetyRatings,
  }) {
    final $result = create();
    if (blockReason != null) {
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(
    ...
    ..pc<$362.SafetyRating>(
        ...
        subBuilder: $362.SafetyRating.create)
    ..hasRequiredFields = false;
  ...
  @$pb.TagNumber(2)
  $core.List<$362.SafetyRating> get safetyRatings => $_getList(1);
}
...
class Candidate extends $pb.GeneratedMessage {
  factory Candidate({
    ...
    $core.int? index,
    $core.Iterable<$362.SafetyRating>? safetyRatings,
    $363.CitationMetadata? citationMetadata,
    $core.int? tokenCount,
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(
      ...
      package: const $pb.PackageName(
          _omitMessageNames ? '' : 'google.ai.generativelanguage.v1alpha'),
      createEmptyInstance: create)
    ..aOM<$360.Content>(1, _omitFieldNames ? '' : 'content',
        subBuilder: $360.Content.create)
    ...
    ..pc<$362.SafetyRating>(
        ...
        subBuilder: $362.SafetyRating.create)
    ..aOM<$363.CitationMetadata>(6, _omitFieldNames ? '' : 'citationMetadata',
        subBuilder: $363.CitationMetadata.create)
  ...
  @$pb.TagNumber(1)
  $360.Content get content => $_getN(0);
  @$pb.TagNumber(1)
  set content($360.Content v) {
    setField(1, v);
  }
  ...
  @$pb.TagNumber(1)
  $360.Content ensureContent() => $_ensure(0);
  ...
  ///  There is at most one rating per category.
  @$pb.TagNumber(5)
  $core.List<$362.SafetyRating> get safetyRatings => $_getList(3);
  ...
  @$pb.TagNumber(6)
  $363.CitationMetadata get citationMetadata => $_getN(4);
  @$pb.TagNumber(6)
  set citationMetadata($363.CitationMetadata v) {
    setField(6, v);
  }
  ...
  @$pb.TagNumber(6)
  $363.CitationMetadata ensureCitationMetadata() => $_ensure(4);
...
class GroundingAttribution extends $pb.GeneratedMessage {
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(
      ...
      package: const $pb.PackageName(
          _omitMessageNames ? '' : 'google.ai.generativelanguage.v1alpha'),
      createEmptyInstance: create)
    ..aOM<$360.Content>(2, _omitFieldNames ? '' : 'content',
        subBuilder: $360.Content.create)
...
class GenerateAnswerRequest extends $pb.GeneratedMessage {
  factory GenerateAnswerRequest({
    ...
    $360.GroundingPassages? inlinePassages,
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(
    ...
    ..aOM<$360.GroundingPassages>(6, _omitFieldNames ? '' : 'inlinePassages',
        subBuilder: $360.GroundingPassages.create)
  ...
  @$pb.TagNumber(6)
  $360.GroundingPassages get inlinePassages => $_getN(5);
  @$pb.TagNumber(6)
  set inlinePassages($360.GroundingPassages v) {
    setField(6, v);
  }
  ...
  @$pb.TagNumber(6)
  $360.GroundingPassages ensureInlinePassages() => $_ensure(5);
...
class EmbedContentRequest extends $pb.GeneratedMessage {
  ...
  /// counted.
  @$pb.TagNumber(2)
  $360.Content get content => $_getN(1);
  @$pb.TagNumber(2)
  set content($360.Content v) {
    setField(2, v);
  }
  ...
  void clearContent() => clearField(2);
  @$pb.TagNumber(2)
  $360.Content ensureContent() => $_ensure(1);
...
class BidiGenerateContentSetup extends $pb.GeneratedMessage {
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(
    ...
    ..aOM<GenerationConfig>(2, _omitFieldNames ? '' : 'generationConfig',
        subBuilder: GenerationConfig.create)
    ..aOM<$360.Content>(3, _omitFieldNames ? '' : 'systemInstruction',
        subBuilder: $360.Content.create)
    ..pc<$360.Tool>(4, _omitFieldNames ? '' : 'tools', $pb.PbFieldType.PM,
        subBuilder: $360.Tool.create)
    ..hasRequiredFields = false;
  ...
  @$pb.TagNumber(3)
  $360.Content get systemInstruction => $_getN(2);
  @$pb.TagNumber(3)
  set systemInstruction($360.Content v) {
    setField(3, v);
  }
  ...
  @$pb.TagNumber(3)
  $360.Content ensureSystemInstruction() => $_ensure(2);
  ...
  @$pb.TagNumber(4)
  $core.List<$360.Tool> get tools => $_getList(3);
}
...
class BidiGenerateContentClientContent extends $pb.GeneratedMessage {
  factory BidiGenerateContentClientContent({
    $core.Iterable<$360.Content>? turns,
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(
      ...
      package: const $pb.PackageName(
          _omitMessageNames ? '' : 'google.ai.generativelanguage.v1alpha'),
      createEmptyInstance: create)
    ..pc<$360.Content>(1, _omitFieldNames ? '' : 'turns', $pb.PbFieldType.PM,
        subBuilder: $360.Content.create)
  ...
  ///  the latest request.
  @$pb.TagNumber(1)
  $core.List<$360.Content> get turns => $_getList(0);
...
class BidiGenerateContentRealtimeInput extends $pb.GeneratedMessage {
  factory BidiGenerateContentRealtimeInput({
    $core.Iterable<$360.Blob>? mediaChunks,
  }) {
    final $result = create();
    if (mediaChunks != null) {
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(
      ...
      package: const $pb.PackageName(
          _omitMessageNames ? '' : 'google.ai.generativelanguage.v1alpha'),
      createEmptyInstance: create)
    ..pc<$360.Blob>(1, _omitFieldNames ? '' : 'mediaChunks', $pb.PbFieldType.PM,
        subBuilder: $360.Blob.create)
    ..hasRequiredFields = false;
  ...
  @$pb.TagNumber(1)
  $core.List<$360.Blob> get mediaChunks => $_getList(0);
}
...
class BidiGenerateContentToolResponse extends $pb.GeneratedMessage {
  factory BidiGenerateContentToolResponse({
    $core.Iterable<$360.FunctionResponse>? functionResponses,
  }) {
    final $result = create();
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(
      ...
      package: const $pb.PackageName(
          _omitMessageNames ? '' : 'google.ai.generativelanguage.v1alpha'),
      createEmptyInstance: create)
    ..pc<$360.FunctionResponse>(
        1, _omitFieldNames ? '' : 'functionResponses', $pb.PbFieldType.PM,
        subBuilder: $360.FunctionResponse.create)
    ..hasRequiredFields = false;
  ...
  @$pb.TagNumber(1)
  $core.List<$360.FunctionResponse> get functionResponses => $_getList(0);
}
...
class BidiGenerateContentServerContent extends $pb.GeneratedMessage {
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(
      ...
      package: const $pb.PackageName(
          _omitMessageNames ? '' : 'google.ai.generativelanguage.v1alpha'),
      createEmptyInstance: create)
    ..aOM<$360.Content>(1, _omitFieldNames ? '' : 'modelTurn',
        subBuilder: $360.Content.create)
    ..aOB(2, _omitFieldNames ? '' : 'turnComplete')
  ...
  @$pb.TagNumber(1)
  $360.Content get modelTurn => $_getN(0);
  @$pb.TagNumber(1)
  set modelTurn($360.Content v) {
    setField(1, v);
  }
  ...
  @$pb.TagNumber(1)
  $360.Content ensureModelTurn() => $_ensure(0);
...
class BidiGenerateContentToolCall extends $pb.GeneratedMessage {
  factory BidiGenerateContentToolCall({
    $core.Iterable<$360.FunctionCall>? functionCalls,
  }) {
    final $result = create();
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(
    ...
    ..pc<$360.FunctionCall>(
        ...
        subBuilder: $360.FunctionCall.create)
    ..hasRequiredFields = false;
  ...
  @$pb.TagNumber(2)
  $core.List<$360.FunctionCall> get functionCalls => $_getList(0);
}
