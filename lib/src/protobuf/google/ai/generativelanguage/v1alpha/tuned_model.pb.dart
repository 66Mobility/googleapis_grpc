...
class TuningTask extends $pb.GeneratedMessage {
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(
    ...
    ..aOM<$330.Timestamp>(1, _omitFieldNames ? '' : 'startTime',
        subBuilder: $330.Timestamp.create)
    ..aOM<$330.Timestamp>(2, _omitFieldNames ? '' : 'completeTime',
        subBuilder: $330.Timestamp.create)
    ..pc<TuningSnapshot>(
  ...
  @$pb.TagNumber(2)
  $330.Timestamp get completeTime => $_getN(1);
  @$pb.TagNumber(2)
  ...
  @$pb.TagNumber(2)
  $330.Timestamp ensureCompleteTime() => $_ensure(1);
...
class TuningSnapshot extends $pb.GeneratedMessage {
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(
    ...
    ..aOM<$330.Timestamp>(4, _omitFieldNames ? '' : 'computeTime',
        subBuilder: $330.Timestamp.create)
    ..hasRequiredFields = false;
  ...
  @$pb.TagNumber(4)
  $330.Timestamp get computeTime => $_getN(3);
  @$pb.TagNumber(4)
  set computeTime($330.Timestamp v) {
    setField(4, v);
  }
  ...
  @$pb.TagNumber(4)
  $330.Timestamp ensureComputeTime() => $_ensure(3);
}
