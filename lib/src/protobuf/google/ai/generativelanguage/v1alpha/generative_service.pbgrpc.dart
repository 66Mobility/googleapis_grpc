...
class GenerativeServiceClient extends $grpc.Client {
  ...
  static final _$streamGenerateContent = $grpc.ClientMethod<
      ...
      ($core.List<$core.int> value) =>
          $12.GenerateContentResponse.fromBuffer(value));
  static final _$embedContent = $grpc.ClientMethod<$12.EmbedContentRequest,
  ...
  static final _$bidiGenerateContent = $grpc.ClientMethod<
          $12.BidiGenerateContentClientMessage,
          $12.BidiGenerateContentServerMessage>(
      '/google.ai.generativelanguage.v1alpha.GenerativeService/BidiGenerateContent',
      ($12.BidiGenerateContentClientMessage value) => value.writeToBuffer(),
      ($core.List<$core.int> value) =>
          $12.BidiGenerateContentServerMessage.fromBuffer(value));
  ...
  $grpc.ResponseStream<$12.BidiGenerateContentServerMessage>
      bidiGenerateContent(
          $async.Stream<$12.BidiGenerateContentClientMessage> request,
          {$grpc.CallOptions? options}) {
...
abstract class GenerativeServiceBase extends $grpc.Service {
  ...
  GenerativeServiceBase() {
    ...
    $addMethod($grpc.ServiceMethod<$12.BidiGenerateContentClientMessage,
            $12.BidiGenerateContentServerMessage>(
        'BidiGenerateContent',
        bidiGenerateContent,
        true,
        true,
        ($core.List<$core.int> value) =>
            $12.BidiGenerateContentClientMessage.fromBuffer(value),
        ($12.BidiGenerateContentServerMessage value) => value.writeToBuffer()));
  }
  ...
  $async.Stream<$12.BidiGenerateContentServerMessage> bidiGenerateContent(
      $grpc.ServiceCall call,
      $async.Stream<$12.BidiGenerateContentClientMessage> request);
}
