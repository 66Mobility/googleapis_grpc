...
class CachedContent extends $pb.GeneratedMessage {
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(
    ...
    ..pc<$360.Content>(4, _omitFieldNames ? '' : 'contents', $pb.PbFieldType.PM,
        subBuilder: $360.Content.create)
    ..pc<$360.Tool>(5, _omitFieldNames ? '' : 'tools', $pb.PbFieldType.PM,
        subBuilder: $360.Tool.create)
    ..aOM<$360.ToolConfig>(6, _omitFieldNames ? '' : 'toolConfig',
    ...
    ..aOM<$330.Timestamp>(8, _omitFieldNames ? '' : 'updateTime',
        subBuilder: $330.Timestamp.create)
    ..aOM<$330.Timestamp>(9, _omitFieldNames ? '' : 'expireTime',
        subBuilder: $330.Timestamp.create)
    ..aOM<$292.Duration>(10, _omitFieldNames ? '' : 'ttl',
  ...
  @$pb.TagNumber(4)
  $core.List<$360.Content> get contents => $_getList(3);
  ...
  /// on input.
  @$pb.TagNumber(9)
  $330.Timestamp get expireTime => $_getN(8);
  @$pb.TagNumber(9)
  ...
  @$pb.TagNumber(9)
  $330.Timestamp ensureExpireTime() => $_ensure(8);

  /// Input only. New TTL for this resource, input only.
  @$pb.TagNumber(10)
  $292.Duration get ttl => $_getN(9);
  @$pb.TagNumber(10)
  ...
  @$pb.TagNumber(10)
  $292.Duration ensureTtl() => $_ensure(9);
