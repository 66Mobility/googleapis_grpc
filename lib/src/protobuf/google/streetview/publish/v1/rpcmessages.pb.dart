...
class CreatePhotoRequest extends $pb.GeneratedMessage {
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(_omitMessageNames ? '' : 'CreatePhotoRequest', package: const $pb.PackageName(_omitMessageNames ? '' : 'google.streetview.publish.v1'), createEmptyInstance: create)
    ..aOM<$254.Photo>(1, _omitFieldNames ? '' : 'photo', subBuilder: $254.Photo.create)
  ...
  'Will be removed in next major version')
  CreatePhotoRequest copyWith(void Function(CreatePhotoRequest) updates) => super.copyWith((message) => updates(message as CreatePhotoRequest)) as CreatePhotoRequest;
  ...
  @$pb.TagNumber(1)
  $254.Photo get photo => $_getN(0);
  @$pb.TagNumber(1)
  set photo($254.Photo v) { setField(1, v); }
  @$pb.TagNumber(1)
  $core.bool hasPhoto() => $_has(0);
  @$pb.TagNumber(1)
  void clearPhoto() => clearField(1);
  @$pb.TagNumber(1)
  $254.Photo ensurePhoto() => $_ensure(0);
}
...
class GetPhotoRequest extends $pb.GeneratedMessage {
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(_omitMessageNames ? '' : 'GetPhotoRequest', package: const $pb.PackageName(_omitMessageNames ? '' : 'google.streetview.publish.v1'), createEmptyInstance: create)
    ..aOS(1, _omitFieldNames ? '' : 'photoId')
    ..e<PhotoView>(2, _omitFieldNames ? '' : 'view', $pb.PbFieldType.OE, defaultOrMaker: PhotoView.BASIC, valueOf: PhotoView.valueOf, enumValues: PhotoView.values)
  ...
  'Use [GeneratedMessageGenericExtensions.rebuild] instead. '
  'Will be removed in next major version')
  GetPhotoRequest copyWith(void Function(GetPhotoRequest) updates) => super.copyWith((message) => updates(message as GetPhotoRequest)) as GetPhotoRequest;
...
class BatchGetPhotosRequest extends $pb.GeneratedMessage {
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(_omitMessageNames ? '' : 'BatchGetPhotosRequest', package: const $pb.PackageName(_omitMessageNames ? '' : 'google.streetview.publish.v1'), createEmptyInstance: create)
  ...
  'Use [GeneratedMessageGenericExtensions.rebuild] instead. '
  'Will be removed in next major version')
  BatchGetPhotosRequest copyWith(void Function(BatchGetPhotosRequest) updates) => super.copyWith((message) => updates(message as BatchGetPhotosRequest)) as BatchGetPhotosRequest;
...
class BatchGetPhotosResponse extends $pb.GeneratedMessage {
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(_omitMessageNames ? '' : 'BatchGetPhotosResponse', package: const $pb.PackageName(_omitMessageNames ? '' : 'google.streetview.publish.v1'), createEmptyInstance: create)
    ..pc<PhotoResponse>(1, _omitFieldNames ? '' : 'results', $pb.PbFieldType.PM, subBuilder: PhotoResponse.create)
    ..hasRequiredFields = false
  ;
  ...
  'Use [GeneratedMessageGenericExtensions.rebuild] instead. '
  'Will be removed in next major version')
  BatchGetPhotosResponse copyWith(void Function(BatchGetPhotosResponse) updates) => super.copyWith((message) => updates(message as BatchGetPhotosResponse)) as BatchGetPhotosResponse;
...
class PhotoResponse extends $pb.GeneratedMessage {
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(_omitMessageNames ? '' : 'PhotoResponse', package: const $pb.PackageName(_omitMessageNames ? '' : 'google.streetview.publish.v1'), createEmptyInstance: create)
    ...
    ..aOM<$254.Photo>(2, _omitFieldNames ? '' : 'photo', subBuilder: $254.Photo.create)
    ..hasRequiredFields = false
  ;
  ...
  'Use [GeneratedMessageGenericExtensions.rebuild] instead. '
  'Will be removed in next major version')
  PhotoResponse copyWith(void Function(PhotoResponse) updates) => super.copyWith((message) => updates(message as PhotoResponse)) as PhotoResponse;
  ...
  /// was successful.
  @$pb.TagNumber(2)
  $254.Photo get photo => $_getN(1);
  @$pb.TagNumber(2)
  set photo($254.Photo v) { setField(2, v); }
  @$pb.TagNumber(2)
  $core.bool hasPhoto() => $_has(1);
  @$pb.TagNumber(2)
  void clearPhoto() => clearField(2);
  @$pb.TagNumber(2)
  $254.Photo ensurePhoto() => $_ensure(1);
}
...
class ListPhotosRequest extends $pb.GeneratedMessage {
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(_omitMessageNames ? '' : 'ListPhotosRequest', package: const $pb.PackageName(_omitMessageNames ? '' : 'google.streetview.publish.v1'), createEmptyInstance: create)
    ..e<PhotoView>(1, _omitFieldNames ? '' : 'view', $pb.PbFieldType.OE, defaultOrMaker: PhotoView.BASIC, valueOf: PhotoView.valueOf, enumValues: PhotoView.values)
  ...
  'Use [GeneratedMessageGenericExtensions.rebuild] instead. '
  'Will be removed in next major version')
  ListPhotosRequest copyWith(void Function(ListPhotosRequest) updates) => super.copyWith((message) => updates(message as ListPhotosRequest)) as ListPhotosRequest;
...
class ListPhotosResponse extends $pb.GeneratedMessage {
  factory ListPhotosResponse({
    $core.Iterable<$254.Photo>? photos,
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(_omitMessageNames ? '' : 'ListPhotosResponse', package: const $pb.PackageName(_omitMessageNames ? '' : 'google.streetview.publish.v1'), createEmptyInstance: create)
    ..pc<$254.Photo>(1, _omitFieldNames ? '' : 'photos', $pb.PbFieldType.PM, subBuilder: $254.Photo.create)
  ...
  'Use [GeneratedMessageGenericExtensions.rebuild] instead. '
  'Will be removed in next major version')
  ListPhotosResponse copyWith(void Function(ListPhotosResponse) updates) => super.copyWith((message) => updates(message as ListPhotosResponse)) as ListPhotosResponse;
  ...
  @$pb.TagNumber(1)
  $core.List<$254.Photo> get photos => $_getList(0);
...
class BatchUpdatePhotosRequest extends $pb.GeneratedMessage {
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(_omitMessageNames ? '' : 'BatchUpdatePhotosRequest', package: const $pb.PackageName(_omitMessageNames ? '' : 'google.streetview.publish.v1'), createEmptyInstance: create)
    ..pc<UpdatePhotoRequest>(1, _omitFieldNames ? '' : 'updatePhotoRequests', $pb.PbFieldType.PM, subBuilder: UpdatePhotoRequest.create)
    ..hasRequiredFields = false
  ;
  ...
  'Use [GeneratedMessageGenericExtensions.rebuild] instead. '
  'Will be removed in next major version')
  BatchUpdatePhotosRequest copyWith(void Function(BatchUpdatePhotosRequest) updates) => super.copyWith((message) => updates(message as BatchUpdatePhotosRequest)) as BatchUpdatePhotosRequest;
...
class BatchUpdatePhotosResponse extends $pb.GeneratedMessage {
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(_omitMessageNames ? '' : 'BatchUpdatePhotosResponse', package: const $pb.PackageName(_omitMessageNames ? '' : 'google.streetview.publish.v1'), createEmptyInstance: create)
    ..pc<PhotoResponse>(1, _omitFieldNames ? '' : 'results', $pb.PbFieldType.PM, subBuilder: PhotoResponse.create)
    ..hasRequiredFields = false
  ;
  ...
  'Use [GeneratedMessageGenericExtensions.rebuild] instead. '
  'Will be removed in next major version')
  BatchUpdatePhotosResponse copyWith(void Function(BatchUpdatePhotosResponse) updates) => super.copyWith((message) => updates(message as BatchUpdatePhotosResponse)) as BatchUpdatePhotosResponse;
...
class DeletePhotoRequest extends $pb.GeneratedMessage {
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(_omitMessageNames ? '' : 'DeletePhotoRequest', package: const $pb.PackageName(_omitMessageNames ? '' : 'google.streetview.publish.v1'), createEmptyInstance: create)
    ..aOS(1, _omitFieldNames ? '' : 'photoId')
    ..hasRequiredFields = false
  ;
...
class BatchDeletePhotosRequest extends $pb.GeneratedMessage {
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(_omitMessageNames ? '' : 'BatchDeletePhotosRequest', package: const $pb.PackageName(_omitMessageNames ? '' : 'google.streetview.publish.v1'), createEmptyInstance: create)
    ..pPS(1, _omitFieldNames ? '' : 'photoIds')
    ..hasRequiredFields = false
  ;
  ...
  'Use [GeneratedMessageGenericExtensions.rebuild] instead. '
  'Will be removed in next major version')
  BatchDeletePhotosRequest copyWith(void Function(BatchDeletePhotosRequest) updates) => super.copyWith((message) => updates(message as BatchDeletePhotosRequest)) as BatchDeletePhotosRequest;
...
class CreatePhotoSequenceRequest extends $pb.GeneratedMessage {
  factory CreatePhotoSequenceRequest({
    $254.PhotoSequence? photoSequence,
  ...
  factory CreatePhotoSequenceRequest.fromBuffer($core.List<$core.int> i, [$pb.ExtensionRegistry r = $pb.ExtensionRegistry.EMPTY]) => create()..mergeFromBuffer(i, r);
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(_omitMessageNames ? '' : 'CreatePhotoSequenceRequest', package: const $pb.PackageName(_omitMessageNames ? '' : 'google.streetview.publish.v1'), createEmptyInstance: create)
    ..aOM<$254.PhotoSequence>(1, _omitFieldNames ? '' : 'photoSequence', subBuilder: $254.PhotoSequence.create)
  ...
  'Use [GeneratedMessageGenericExtensions.deepCopy] instead. '
  'Will be removed in next major version')
  CreatePhotoSequenceRequest clone() => CreatePhotoSequenceRequest()..mergeFromMessage(this);
  @$core.Deprecated(
  'Using this can add significant overhead to your binary. '
  'Use [GeneratedMessageGenericExtensions.rebuild] instead. '
  'Will be removed in next major version')
  CreatePhotoSequenceRequest copyWith(void Function(CreatePhotoSequenceRequest) updates) => super.copyWith((message) => updates(message as CreatePhotoSequenceRequest)) as CreatePhotoSequenceRequest;
  ...
  static $pb.PbList<CreatePhotoSequenceRequest> createRepeated() => $pb.PbList<CreatePhotoSequenceRequest>();
  @$core.pragma('dart2js:noInline')
  static CreatePhotoSequenceRequest getDefault() => _defaultInstance ??= $pb.GeneratedMessage.$_defaultFor<CreatePhotoSequenceRequest>(create);
  static CreatePhotoSequenceRequest? _defaultInstance;

  /// Required. [PhotoSequence][google.streetview.publish.v1.PhotoSequence] to
  /// create.
  @$pb.TagNumber(1)
  $254.PhotoSequence get photoSequence => $_getN(0);
  @$pb.TagNumber(1)
  set photoSequence($254.PhotoSequence v) { setField(1, v); }
  @$pb.TagNumber(1)
  $core.bool hasPhotoSequence() => $_has(0);
  @$pb.TagNumber(1)
  void clearPhotoSequence() => clearField(1);
  @$pb.TagNumber(1)
  $254.PhotoSequence ensurePhotoSequence() => $_ensure(0);
  ...
  @$pb.TagNumber(2)
  set inputType(CreatePhotoSequenceRequest_InputType v) { setField(2, v); }
  @$pb.TagNumber(2)
...
class GetPhotoSequenceRequest extends $pb.GeneratedMessage {
  ...
  factory GetPhotoSequenceRequest.fromBuffer($core.List<$core.int> i, [$pb.ExtensionRegistry r = $pb.ExtensionRegistry.EMPTY]) => create()..mergeFromBuffer(i, r);
  factory GetPhotoSequenceRequest.fromJson($core.String i, [$pb.ExtensionRegistry r = $pb.ExtensionRegistry.EMPTY]) => create()..mergeFromJson(i, r);

  static final $pb.BuilderInfo _i = $pb.BuilderInfo(_omitMessageNames ? '' : 'GetPhotoSequenceRequest', package: const $pb.PackageName(_omitMessageNames ? '' : 'google.streetview.publish.v1'), createEmptyInstance: create)
  ...
  'Use [GeneratedMessageGenericExtensions.deepCopy] instead. '
  'Will be removed in next major version')
  GetPhotoSequenceRequest clone() => GetPhotoSequenceRequest()..mergeFromMessage(this);
  @$core.Deprecated(
  'Using this can add significant overhead to your binary. '
  'Use [GeneratedMessageGenericExtensions.rebuild] instead. '
  'Will be removed in next major version')
  GetPhotoSequenceRequest copyWith(void Function(GetPhotoSequenceRequest) updates) => super.copyWith((message) => updates(message as GetPhotoSequenceRequest)) as GetPhotoSequenceRequest;
  ...
  static $pb.PbList<GetPhotoSequenceRequest> createRepeated() => $pb.PbList<GetPhotoSequenceRequest>();
  @$core.pragma('dart2js:noInline')
  static GetPhotoSequenceRequest getDefault() => _defaultInstance ??= $pb.GeneratedMessage.$_defaultFor<GetPhotoSequenceRequest>(create);
...
class DeletePhotoSequenceRequest extends $pb.GeneratedMessage {
  ...
  factory DeletePhotoSequenceRequest.fromBuffer($core.List<$core.int> i, [$pb.ExtensionRegistry r = $pb.ExtensionRegistry.EMPTY]) => create()..mergeFromBuffer(i, r);
  factory DeletePhotoSequenceRequest.fromJson($core.String i, [$pb.ExtensionRegistry r = $pb.ExtensionRegistry.EMPTY]) => create()..mergeFromJson(i, r);

  static final $pb.BuilderInfo _i = $pb.BuilderInfo(_omitMessageNames ? '' : 'DeletePhotoSequenceRequest', package: const $pb.PackageName(_omitMessageNames ? '' : 'google.streetview.publish.v1'), createEmptyInstance: create)
    ..aOS(1, _omitFieldNames ? '' : 'sequenceId')
    ..hasRequiredFields = false
  ;
  ...
  'Use [GeneratedMessageGenericExtensions.deepCopy] instead. '
  'Will be removed in next major version')
  DeletePhotoSequenceRequest clone() => DeletePhotoSequenceRequest()..mergeFromMessage(this);
  @$core.Deprecated(
  'Using this can add significant overhead to your binary. '
  'Use [GeneratedMessageGenericExtensions.rebuild] instead. '
  'Will be removed in next major version')
  DeletePhotoSequenceRequest copyWith(void Function(DeletePhotoSequenceRequest) updates) => super.copyWith((message) => updates(message as DeletePhotoSequenceRequest)) as DeletePhotoSequenceRequest;
  ...
  static $pb.PbList<DeletePhotoSequenceRequest> createRepeated() => $pb.PbList<DeletePhotoSequenceRequest>();
  @$core.pragma('dart2js:noInline')
  static DeletePhotoSequenceRequest getDefault() => _defaultInstance ??= $pb.GeneratedMessage.$_defaultFor<DeletePhotoSequenceRequest>(create);
...
class BatchDeletePhotosResponse extends $pb.GeneratedMessage {
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(_omitMessageNames ? '' : 'BatchDeletePhotosResponse', package: const $pb.PackageName(_omitMessageNames ? '' : 'google.streetview.publish.v1'), createEmptyInstance: create)
    ..pc<$319.Status>(1, _omitFieldNames ? '' : 'status', $pb.PbFieldType.PM, subBuilder: $319.Status.create)
    ..hasRequiredFields = false
  ;
  ...
  'Use [GeneratedMessageGenericExtensions.rebuild] instead. '
  'Will be removed in next major version')
  BatchDeletePhotosResponse copyWith(void Function(BatchDeletePhotosResponse) updates) => super.copyWith((message) => updates(message as BatchDeletePhotosResponse)) as BatchDeletePhotosResponse;
  ...
  @$pb.TagNumber(1)
  $core.List<$319.Status> get status => $_getList(0);
}
...
class ListPhotoSequencesRequest extends $pb.GeneratedMessage {
  ...
  factory ListPhotoSequencesRequest.fromBuffer($core.List<$core.int> i, [$pb.ExtensionRegistry r = $pb.ExtensionRegistry.EMPTY]) => create()..mergeFromBuffer(i, r);
  factory ListPhotoSequencesRequest.fromJson($core.String i, [$pb.ExtensionRegistry r = $pb.ExtensionRegistry.EMPTY]) => create()..mergeFromJson(i, r);

  static final $pb.BuilderInfo _i = $pb.BuilderInfo(_omitMessageNames ? '' : 'ListPhotoSequencesRequest', package: const $pb.PackageName(_omitMessageNames ? '' : 'google.streetview.publish.v1'), createEmptyInstance: create)
  ...
  'Use [GeneratedMessageGenericExtensions.deepCopy] instead. '
  'Will be removed in next major version')
  ListPhotoSequencesRequest clone() => ListPhotoSequencesRequest()..mergeFromMessage(this);
  @$core.Deprecated(
  'Using this can add significant overhead to your binary. '
  'Use [GeneratedMessageGenericExtensions.rebuild] instead. '
  'Will be removed in next major version')
  ListPhotoSequencesRequest copyWith(void Function(ListPhotoSequencesRequest) updates) => super.copyWith((message) => updates(message as ListPhotoSequencesRequest)) as ListPhotoSequencesRequest;
  ...
  static $pb.PbList<ListPhotoSequencesRequest> createRepeated() => $pb.PbList<ListPhotoSequencesRequest>();
  @$core.pragma('dart2js:noInline')
  static ListPhotoSequencesRequest getDefault() => _defaultInstance ??= $pb.GeneratedMessage.$_defaultFor<ListPhotoSequencesRequest>(create);
...
class ListPhotoSequencesResponse extends $pb.GeneratedMessage {
  factory ListPhotoSequencesResponse({
    $core.Iterable<$13.Operation>? photoSequences,
    $core.String? nextPageToken,
  }) {
    final $result = create();
  ...
  factory ListPhotoSequencesResponse.fromBuffer($core.List<$core.int> i, [$pb.ExtensionRegistry r = $pb.ExtensionRegistry.EMPTY]) => create()..mergeFromBuffer(i, r);
  factory ListPhotoSequencesResponse.fromJson($core.String i, [$pb.ExtensionRegistry r = $pb.ExtensionRegistry.EMPTY]) => create()..mergeFromJson(i, r);

  static final $pb.BuilderInfo _i = $pb.BuilderInfo(_omitMessageNames ? '' : 'ListPhotoSequencesResponse', package: const $pb.PackageName(_omitMessageNames ? '' : 'google.streetview.publish.v1'), createEmptyInstance: create)
    ..pc<$13.Operation>(1, _omitFieldNames ? '' : 'photoSequences', $pb.PbFieldType.PM, subBuilder: $13.Operation.create)
    ..aOS(2, _omitFieldNames ? '' : 'nextPageToken')
    ..hasRequiredFields = false
  ;
  ...
  'Use [GeneratedMessageGenericExtensions.deepCopy] instead. '
  'Will be removed in next major version')
  ListPhotoSequencesResponse clone() => ListPhotoSequencesResponse()..mergeFromMessage(this);
  @$core.Deprecated(
  'Using this can add significant overhead to your binary. '
  'Use [GeneratedMessageGenericExtensions.rebuild] instead. '
  'Will be removed in next major version')
  ListPhotoSequencesResponse copyWith(void Function(ListPhotoSequencesResponse) updates) => super.copyWith((message) => updates(message as ListPhotoSequencesResponse)) as ListPhotoSequencesResponse;
  ...
  static $pb.PbList<ListPhotoSequencesResponse> createRepeated() => $pb.PbList<ListPhotoSequencesResponse>();
  @$core.pragma('dart2js:noInline')
  static ListPhotoSequencesResponse getDefault() => _defaultInstance ??= $pb.GeneratedMessage.$_defaultFor<ListPhotoSequencesResponse>(create);
  ...
  @$pb.TagNumber(1)
  $core.List<$13.Operation> get photoSequences => $_getList(0);
