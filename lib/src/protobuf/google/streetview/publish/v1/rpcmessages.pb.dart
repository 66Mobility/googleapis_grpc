...
class CreatePhotoRequest extends $pb.GeneratedMessage {
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(
    ...
    ..aOM<$285.Photo>(1, _omitFieldNames ? '' : 'photo',
        subBuilder: $285.Photo.create)
  ...
  @$pb.TagNumber(1)
  $285.Photo get photo => $_getN(0);
  @$pb.TagNumber(1)
  set photo($285.Photo v) {
    setField(1, v);
  }
  ...
  @$pb.TagNumber(1)
  $285.Photo ensurePhoto() => $_ensure(0);
}
...
class PhotoResponse extends $pb.GeneratedMessage {
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(
    ...
    ..aOM<$285.Photo>(2, _omitFieldNames ? '' : 'photo',
        subBuilder: $285.Photo.create)
    ..hasRequiredFields = false;
  ...
  @$pb.TagNumber(2)
  $285.Photo ensurePhoto() => $_ensure(1);
}
...
class ListPhotosResponse extends $pb.GeneratedMessage {
  factory ListPhotosResponse({
    $core.Iterable<$285.Photo>? photos,
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(
      ...
      package: const $pb.PackageName(
          _omitMessageNames ? '' : 'google.streetview.publish.v1'),
      createEmptyInstance: create)
    ..pc<$285.Photo>(1, _omitFieldNames ? '' : 'photos', $pb.PbFieldType.PM,
        subBuilder: $285.Photo.create)
  ...
  @$pb.TagNumber(1)
  $core.List<$285.Photo> get photos => $_getList(0);
...
class CreatePhotoSequenceRequest extends $pb.GeneratedMessage {
  factory CreatePhotoSequenceRequest({
    $285.PhotoSequence? photoSequence,
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(
      ...
      package: const $pb.PackageName(
          _omitMessageNames ? '' : 'google.streetview.publish.v1'),
      createEmptyInstance: create)
    ..aOM<$285.PhotoSequence>(1, _omitFieldNames ? '' : 'photoSequence',
        subBuilder: $285.PhotoSequence.create)
  ...
  /// create.
  @$pb.TagNumber(1)
  $285.PhotoSequence get photoSequence => $_getN(0);
  @$pb.TagNumber(1)
  set photoSequence($285.PhotoSequence v) {
    setField(1, v);
  }
  ...
  @$pb.TagNumber(1)
  $285.PhotoSequence ensurePhotoSequence() => $_ensure(0);
...
class BatchDeletePhotosResponse extends $pb.GeneratedMessage {
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(
      ...
      package: const $pb.PackageName(
          _omitMessageNames ? '' : 'google.streetview.publish.v1'),
      createEmptyInstance: create)
    ..pc<$350.Status>(1, _omitFieldNames ? '' : 'status', $pb.PbFieldType.PM,
        subBuilder: $350.Status.create)
    ..hasRequiredFields = false;
  ...
  @$pb.TagNumber(1)
  $core.List<$350.Status> get status => $_getList(0);
}
