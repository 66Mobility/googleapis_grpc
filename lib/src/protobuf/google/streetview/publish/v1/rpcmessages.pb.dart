...
class CreatePhotoRequest extends $pb.GeneratedMessage {
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(
    ...
    ..aOM<$259.Photo>(1, _omitFieldNames ? '' : 'photo',
        subBuilder: $259.Photo.create)
  ...
  @$pb.TagNumber(1)
  $259.Photo get photo => $_getN(0);
  @$pb.TagNumber(1)
  set photo($259.Photo v) {
    setField(1, v);
  }
  ...
  @$pb.TagNumber(1)
  $259.Photo ensurePhoto() => $_ensure(0);
}
...
class PhotoResponse extends $pb.GeneratedMessage {
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(
    ...
    ..aOM<$259.Photo>(2, _omitFieldNames ? '' : 'photo',
        subBuilder: $259.Photo.create)
    ..hasRequiredFields = false;
  ...
  @$pb.TagNumber(2)
  $259.Photo ensurePhoto() => $_ensure(1);
}
...
class ListPhotosResponse extends $pb.GeneratedMessage {
  factory ListPhotosResponse({
    $core.Iterable<$259.Photo>? photos,
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(
      ...
      package: const $pb.PackageName(
          _omitMessageNames ? '' : 'google.streetview.publish.v1'),
      createEmptyInstance: create)
    ..pc<$259.Photo>(1, _omitFieldNames ? '' : 'photos', $pb.PbFieldType.PM,
        subBuilder: $259.Photo.create)
  ...
  @$pb.TagNumber(1)
  $core.List<$259.Photo> get photos => $_getList(0);
...
class CreatePhotoSequenceRequest extends $pb.GeneratedMessage {
  factory CreatePhotoSequenceRequest({
    $259.PhotoSequence? photoSequence,
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(
      ...
      package: const $pb.PackageName(
          _omitMessageNames ? '' : 'google.streetview.publish.v1'),
      createEmptyInstance: create)
    ..aOM<$259.PhotoSequence>(1, _omitFieldNames ? '' : 'photoSequence',
        subBuilder: $259.PhotoSequence.create)
  ...
  /// create.
  @$pb.TagNumber(1)
  $259.PhotoSequence get photoSequence => $_getN(0);
  @$pb.TagNumber(1)
  set photoSequence($259.PhotoSequence v) {
    setField(1, v);
  }
  ...
  @$pb.TagNumber(1)
  $259.PhotoSequence ensurePhotoSequence() => $_ensure(0);
...
class BatchDeletePhotosResponse extends $pb.GeneratedMessage {
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(
      ...
      package: const $pb.PackageName(
          _omitMessageNames ? '' : 'google.streetview.publish.v1'),
      createEmptyInstance: create)
    ..pc<$324.Status>(1, _omitFieldNames ? '' : 'status', $pb.PbFieldType.PM,
        subBuilder: $324.Status.create)
    ..hasRequiredFields = false;
  ...
  @$pb.TagNumber(1)
  $core.List<$324.Status> get status => $_getList(0);
}
