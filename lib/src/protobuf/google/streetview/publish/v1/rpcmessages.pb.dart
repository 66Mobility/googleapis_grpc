...
class CreatePhotoRequest extends $pb.GeneratedMessage {
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(
    ...
    ..aOM<$257.Photo>(1, _omitFieldNames ? '' : 'photo',
        subBuilder: $257.Photo.create)
...
class PhotoResponse extends $pb.GeneratedMessage {
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(
    ...
    ..aOM<$257.Photo>(2, _omitFieldNames ? '' : 'photo',
        subBuilder: $257.Photo.create)
    ..hasRequiredFields = false;
...
class ListPhotosResponse extends $pb.GeneratedMessage {
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(
      ...
      package: const $pb.PackageName(
          _omitMessageNames ? '' : 'google.streetview.publish.v1'),
      createEmptyInstance: create)
    ..pc<$257.Photo>(1, _omitFieldNames ? '' : 'photos', $pb.PbFieldType.PM,
        subBuilder: $257.Photo.create)
...
class CreatePhotoSequenceRequest extends $pb.GeneratedMessage {
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(
      ...
      package: const $pb.PackageName(
          _omitMessageNames ? '' : 'google.streetview.publish.v1'),
      createEmptyInstance: create)
    ..aOM<$257.PhotoSequence>(1, _omitFieldNames ? '' : 'photoSequence',
        subBuilder: $257.PhotoSequence.create)
  ...
  @$pb.TagNumber(1)
  set photoSequence($257.PhotoSequence v) {
    setField(1, v);
  }
...
class BatchDeletePhotosResponse extends $pb.GeneratedMessage {
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(
      ...
      package: const $pb.PackageName(
          _omitMessageNames ? '' : 'google.streetview.publish.v1'),
      createEmptyInstance: create)
    ..pc<$322.Status>(1, _omitFieldNames ? '' : 'status', $pb.PbFieldType.PM,
        subBuilder: $322.Status.create)
    ..hasRequiredFields = false;
