...
import 'log_entry.pb.dart' as $478;
...
class WriteLogEntriesRequest extends $pb.GeneratedMessage {
  factory WriteLogEntriesRequest({
    ...
    $core.Iterable<$478.LogEntry>? entries,
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(
    ...
    ..pc<$478.LogEntry>(4, _omitFieldNames ? '' : 'entries', $pb.PbFieldType.PM,
        subBuilder: $478.LogEntry.create)
  ...
  @$pb.TagNumber(4)
  $core.List<$478.LogEntry> get entries => $_getList(3);
...
class WriteLogEntriesPartialErrors extends $pb.GeneratedMessage {
  factory WriteLogEntriesPartialErrors({
    $core.Map<$core.int, $350.Status>? logEntryErrors,
  }) {
    final $result = create();
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(
      ...
      package:
          const $pb.PackageName(_omitMessageNames ? '' : 'google.logging.v2'),
      createEmptyInstance: create)
    ..m<$core.int, $350.Status>(1, _omitFieldNames ? '' : 'logEntryErrors',
        entryClassName: 'WriteLogEntriesPartialErrors.LogEntryErrorsEntry',
        keyFieldType: $pb.PbFieldType.O3,
        valueFieldType: $pb.PbFieldType.OM,
        valueCreator: $350.Status.create,
        valueDefaultOrMaker: $350.Status.getDefault,
        packageName: const $pb.PackageName('google.logging.v2'))
    ..hasRequiredFields = false;
  ...
  ///  per-entry errors.
  @$pb.TagNumber(1)
  $core.Map<$core.int, $350.Status> get logEntryErrors => $_getMap(0);
}
...
class ListLogEntriesResponse extends $pb.GeneratedMessage {
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(
      ...
      package:
          const $pb.PackageName(_omitMessageNames ? '' : 'google.logging.v2'),
      createEmptyInstance: create)
    ..pc<$478.LogEntry>(1, _omitFieldNames ? '' : 'entries', $pb.PbFieldType.PM,
        subBuilder: $478.LogEntry.create)
  ...
  /// more information.
  @$pb.TagNumber(1)
  $core.List<$478.LogEntry> get entries => $_getList(0);
...
class TailLogEntriesRequest extends $pb.GeneratedMessage {
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(
    ...
    ..aOS(2, _omitFieldNames ? '' : 'filter')
    ..aOM<$292.Duration>(3, _omitFieldNames ? '' : 'bufferWindow',
  ...
  /// milliseconds.
  @$pb.TagNumber(3)
  $292.Duration get bufferWindow => $_getN(2);
  @$pb.TagNumber(3)
  set bufferWindow($292.Duration v) {
    setField(3, v);
  }
  ...
  @$pb.TagNumber(3)
  $292.Duration ensureBufferWindow() => $_ensure(2);
}
