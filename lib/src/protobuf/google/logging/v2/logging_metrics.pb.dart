...
class LogMetric extends $pb.GeneratedMessage {
  ...
  ///  their description.
  @$pb.TagNumber(5)
  $1673.MetricDescriptor get metricDescriptor => $_getN(4);
  @$pb.TagNumber(5)
  set metricDescriptor($1673.MetricDescriptor v) { setField(5, v); }
  @$pb.TagNumber(5)
  $core.bool hasMetricDescriptor() => $_has(4);
  @$pb.TagNumber(5)
  void clearMetricDescriptor() => clearField(5);
  @$pb.TagNumber(5)
  $1673.MetricDescriptor ensureMetricDescriptor() => $_ensure(4);
