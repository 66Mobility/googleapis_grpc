...
class Reaction extends $pb.GeneratedMessage {
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(_omitMessageNames ? '' : 'Reaction', package: const $pb.PackageName(_omitMessageNames ? '' : 'google.chat.v1'), createEmptyInstance: create)
    ...
    ..aOM<$4220.User>(2, _omitFieldNames ? '' : 'user', subBuilder: $4220.User.create)
  ...
  @$pb.TagNumber(2)
  $4220.User get user => $_getN(1);
  @$pb.TagNumber(2)
  set user($4220.User v) { setField(2, v); }
  @$pb.TagNumber(2)
  $core.bool hasUser() => $_has(1);
  @$pb.TagNumber(2)
  void clearUser() => clearField(2);
  @$pb.TagNumber(2)
  $4220.User ensureUser() => $_ensure(1);
