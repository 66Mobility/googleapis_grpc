...
import '../../apps/card/v1/card.pb.dart' as $414;
import '../../protobuf/field_mask.pb.dart' as $332;
import '../../protobuf/timestamp.pb.dart' as $301;
import 'action_status.pb.dart' as $415;
import 'annotation.pb.dart' as $410;
import 'attachment.pb.dart' as $97;
import 'contextual_addon.pb.dart' as $409;
import 'deletion_metadata.pb.dart' as $413;
import 'matched_url.pb.dart' as $412;
import 'message.pbenum.dart';
import 'reaction.pb.dart' as $100;
import 'slash_command.pb.dart' as $411;
import 'space.pb.dart' as $98;
import 'user.pb.dart' as $405;
...
class Message extends $pb.GeneratedMessage {
  ...
  @$core.Deprecated('This field is deprecated.')
    $core.Iterable<$409.ContextualAddOnMarkup_Card>? cards,
    $core.Iterable<$410.Annotation>? annotations,
    Thread? thread,
    $98.Space? space,
    $core.String? fallbackText,
    ActionResponse? actionResponse,
    $core.String? argumentText,
    $411.SlashCommand? slashCommand,
    $core.Iterable<$97.Attachment>? attachment,
    $412.MatchedUrl? matchedUrl,
    $core.Iterable<CardWithId>? cardsV2,
    $301.Timestamp? lastUpdateTime,
    ...
    $405.User? privateMessageViewer,
    $413.DeletionMetadata? deletionMetadata,
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(_omitMessageNames ? '' : 'Message', package: const $pb.PackageName(_omitMessageNames ? '' : 'google.chat.v1'), createEmptyInstance: create)
    ...
    ..aOM<$405.User>(2, _omitFieldNames ? '' : 'sender', subBuilder: $405.User.create)
    ..aOM<$301.Timestamp>(3, _omitFieldNames ? '' : 'createTime', subBuilder: $301.Timestamp.create)
    ..aOS(4, _omitFieldNames ? '' : 'text')
    ..pc<$409.ContextualAddOnMarkup_Card>(5, _omitFieldNames ? '' : 'cards', $pb.PbFieldType.PM, subBuilder: $409.ContextualAddOnMarkup_Card.create)
    ..pc<$410.Annotation>(10, _omitFieldNames ? '' : 'annotations', $pb.PbFieldType.PM, subBuilder: $410.Annotation.create)
    ..aOM<Thread>(11, _omitFieldNames ? '' : 'thread', subBuilder: Thread.create)
    ..aOM<$98.Space>(12, _omitFieldNames ? '' : 'space', subBuilder: $98.Space.create)
    ...
    ..aOM<$411.SlashCommand>(17, _omitFieldNames ? '' : 'slashCommand', subBuilder: $411.SlashCommand.create)
    ..pc<$97.Attachment>(18, _omitFieldNames ? '' : 'attachment', $pb.PbFieldType.PM, subBuilder: $97.Attachment.create)
    ..aOM<$412.MatchedUrl>(20, _omitFieldNames ? '' : 'matchedUrl', subBuilder: $412.MatchedUrl.create)
    ..pc<CardWithId>(22, _omitFieldNames ? '' : 'cardsV2', $pb.PbFieldType.PM, subBuilder: CardWithId.create)
    ..aOM<$301.Timestamp>(23, _omitFieldNames ? '' : 'lastUpdateTime', subBuilder: $301.Timestamp.create)
    ..aOB(25, _omitFieldNames ? '' : 'threadReply')
    ..aOM<$301.Timestamp>(26, _omitFieldNames ? '' : 'deleteTime', subBuilder: $301.Timestamp.create)
    ..aOS(32, _omitFieldNames ? '' : 'clientAssignedMessageId')
    ..pc<$100.EmojiReactionSummary>(33, _omitFieldNames ? '' : 'emojiReactionSummaries', $pb.PbFieldType.PM, subBuilder: $100.EmojiReactionSummary.create)
    ..aOM<$405.User>(36, _omitFieldNames ? '' : 'privateMessageViewer', subBuilder: $405.User.create)
    ..aOM<$413.DeletionMetadata>(38, _omitFieldNames ? '' : 'deletionMetadata', subBuilder: $413.DeletionMetadata.create)
  ...
  /// `name` and `type`.
  @$pb.TagNumber(2)
  $405.User get sender => $_getN(1);
  @$pb.TagNumber(2)
  set sender($405.User v) { setField(2, v); }
  @$pb.TagNumber(2)
  $core.bool hasSender() => $_has(1);
  @$pb.TagNumber(2)
  void clearSender() => clearField(2);
  @$pb.TagNumber(2)
  $405.User ensureSender() => $_ensure(1);
  ...
  @$core.Deprecated('This field is deprecated.')
  @$pb.TagNumber(5)
  $core.List<$409.ContextualAddOnMarkup_Card> get cards => $_getList(4);

  /// Output only. Annotations associated with the `text` in this message.
  @$pb.TagNumber(10)
  $core.List<$410.Annotation> get annotations => $_getList(5);
  ...
  @$pb.TagNumber(12)
  set space($98.Space v) { setField(12, v); }
  @$pb.TagNumber(12)
  ...
  @$pb.TagNumber(17)
  $411.SlashCommand get slashCommand => $_getN(11);
  @$pb.TagNumber(17)
  set slashCommand($411.SlashCommand v) { setField(17, v); }
  @$pb.TagNumber(17)
  $core.bool hasSlashCommand() => $_has(11);
  @$pb.TagNumber(17)
  void clearSlashCommand() => clearField(17);
  @$pb.TagNumber(17)
  $411.SlashCommand ensureSlashCommand() => $_ensure(11);
  ...
  @$pb.TagNumber(20)
  $412.MatchedUrl get matchedUrl => $_getN(13);
  @$pb.TagNumber(20)
  set matchedUrl($412.MatchedUrl v) { setField(20, v); }
  @$pb.TagNumber(20)
  $core.bool hasMatchedUrl() => $_has(13);
  @$pb.TagNumber(20)
  void clearMatchedUrl() => clearField(20);
  @$pb.TagNumber(20)
  $412.MatchedUrl ensureMatchedUrl() => $_ensure(13);
  ...
  @$pb.TagNumber(23)
  $301.Timestamp get lastUpdateTime => $_getN(15);
  @$pb.TagNumber(23)
  set lastUpdateTime($301.Timestamp v) { setField(23, v); }
  @$pb.TagNumber(23)
  $core.bool hasLastUpdateTime() => $_has(15);
  @$pb.TagNumber(23)
  void clearLastUpdateTime() => clearField(23);
  @$pb.TagNumber(23)
  $301.Timestamp ensureLastUpdateTime() => $_ensure(15);
  ...
  @$pb.TagNumber(26)
  $301.Timestamp get deleteTime => $_getN(17);
  @$pb.TagNumber(26)
  set deleteTime($301.Timestamp v) { setField(26, v); }
  @$pb.TagNumber(26)
  $core.bool hasDeleteTime() => $_has(17);
  @$pb.TagNumber(26)
  void clearDeleteTime() => clearField(26);
  @$pb.TagNumber(26)
  $301.Timestamp ensureDeleteTime() => $_ensure(17);
  ...
  @$pb.TagNumber(33)
  $core.List<$100.EmojiReactionSummary> get emojiReactionSummaries => $_getList(19);
  ...
  @$pb.TagNumber(36)
  $405.User get privateMessageViewer => $_getN(20);
  @$pb.TagNumber(36)
  set privateMessageViewer($405.User v) { setField(36, v); }
  @$pb.TagNumber(36)
  $core.bool hasPrivateMessageViewer() => $_has(20);
  @$pb.TagNumber(36)
  void clearPrivateMessageViewer() => clearField(36);
  @$pb.TagNumber(36)
  $405.User ensurePrivateMessageViewer() => $_ensure(20);

  /// Output only. Information about a deleted message. A message is deleted when
  /// `delete_time` is set.
  @$pb.TagNumber(38)
  $413.DeletionMetadata get deletionMetadata => $_getN(21);
  @$pb.TagNumber(38)
  set deletionMetadata($413.DeletionMetadata v) { setField(38, v); }
  @$pb.TagNumber(38)
  $core.bool hasDeletionMetadata() => $_has(21);
  @$pb.TagNumber(38)
  void clearDeletionMetadata() => clearField(38);
  @$pb.TagNumber(38)
  $413.DeletionMetadata ensureDeletionMetadata() => $_ensure(21);
...
class QuotedMessageMetadata extends $pb.GeneratedMessage {
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(_omitMessageNames ? '' : 'QuotedMessageMetadata', package: const $pb.PackageName(_omitMessageNames ? '' : 'google.chat.v1'), createEmptyInstance: create)
    ..aOS(1, _omitFieldNames ? '' : 'name')
    ..aOM<$301.Timestamp>(2, _omitFieldNames ? '' : 'lastUpdateTime', subBuilder: $301.Timestamp.create)
    ..hasRequiredFields = false
  ;
  ...
  @$pb.TagNumber(2)
  $301.Timestamp get lastUpdateTime => $_getN(1);
  @$pb.TagNumber(2)
  set lastUpdateTime($301.Timestamp v) { setField(2, v); }
  @$pb.TagNumber(2)
  $core.bool hasLastUpdateTime() => $_has(1);
  @$pb.TagNumber(2)
  void clearLastUpdateTime() => clearField(2);
  @$pb.TagNumber(2)
  $301.Timestamp ensureLastUpdateTime() => $_ensure(1);
}
...
class ActionResponse_SelectionItems extends $pb.GeneratedMessage {
  factory ActionResponse_SelectionItems({
    $core.Iterable<$414.SelectionInput_SelectionItem>? items,
  }) {
    final $result = create();
    if (items != null) {
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(_omitMessageNames ? '' : 'ActionResponse.SelectionItems', package: const $pb.PackageName(_omitMessageNames ? '' : 'google.chat.v1'), createEmptyInstance: create)
    ..pc<$414.SelectionInput_SelectionItem>(1, _omitFieldNames ? '' : 'items', $pb.PbFieldType.PM, subBuilder: $414.SelectionInput_SelectionItem.create)
    ..hasRequiredFields = false
  ;
  ...
  @$pb.TagNumber(1)
  $core.List<$414.SelectionInput_SelectionItem> get items => $_getList(0);
}
...
class AccessoryWidget extends $pb.GeneratedMessage {
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(_omitMessageNames ? '' : 'AccessoryWidget', package: const $pb.PackageName(_omitMessageNames ? '' : 'google.chat.v1'), createEmptyInstance: create)
    ..oo(0, [1])
    ..aOM<$414.ButtonList>(1, _omitFieldNames ? '' : 'buttonList', subBuilder: $414.ButtonList.create)
    ..hasRequiredFields = false
  ;
  ...
  /// A list of buttons.
  @$pb.TagNumber(1)
  $414.ButtonList get buttonList => $_getN(0);
  @$pb.TagNumber(1)
  set buttonList($414.ButtonList v) { setField(1, v); }
  @$pb.TagNumber(1)
  $core.bool hasButtonList() => $_has(0);
  @$pb.TagNumber(1)
  void clearButtonList() => clearField(1);
  @$pb.TagNumber(1)
  $414.ButtonList ensureButtonList() => $_ensure(0);
}
...
class DialogAction extends $pb.GeneratedMessage {
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(_omitMessageNames ? '' : 'DialogAction', package: const $pb.PackageName(_omitMessageNames ? '' : 'google.chat.v1'), createEmptyInstance: create)
    ...
    ..aOM<$415.ActionStatus>(2, _omitFieldNames ? '' : 'actionStatus', subBuilder: $415.ActionStatus.create)
    ..hasRequiredFields = false
  ;
  ...
  @$pb.TagNumber(2)
  $415.ActionStatus get actionStatus => $_getN(1);
  @$pb.TagNumber(2)
  set actionStatus($415.ActionStatus v) { setField(2, v); }
  @$pb.TagNumber(2)
  $core.bool hasActionStatus() => $_has(1);
  @$pb.TagNumber(2)
  void clearActionStatus() => clearField(2);
  @$pb.TagNumber(2)
  $415.ActionStatus ensureActionStatus() => $_ensure(1);
}
...
class Dialog extends $pb.GeneratedMessage {
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(_omitMessageNames ? '' : 'Dialog', package: const $pb.PackageName(_omitMessageNames ? '' : 'google.chat.v1'), createEmptyInstance: create)
    ..aOM<$414.Card>(1, _omitFieldNames ? '' : 'body', subBuilder: $414.Card.create)
    ..hasRequiredFields = false
  ;
  ...
  @$pb.TagNumber(1)
  $414.Card get body => $_getN(0);
  @$pb.TagNumber(1)
  set body($414.Card v) { setField(1, v); }
  @$pb.TagNumber(1)
  $core.bool hasBody() => $_has(0);
  @$pb.TagNumber(1)
  void clearBody() => clearField(1);
  @$pb.TagNumber(1)
  $414.Card ensureBody() => $_ensure(0);
}
...
class CardWithId extends $pb.GeneratedMessage {
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(_omitMessageNames ? '' : 'CardWithId', package: const $pb.PackageName(_omitMessageNames ? '' : 'google.chat.v1'), createEmptyInstance: create)
    ...
    ..aOM<$414.Card>(2, _omitFieldNames ? '' : 'card', subBuilder: $414.Card.create)
    ..hasRequiredFields = false
  ;
  ...
  @$pb.TagNumber(2)
  $414.Card get card => $_getN(1);
  @$pb.TagNumber(2)
  set card($414.Card v) { setField(2, v); }
  @$pb.TagNumber(2)
  $core.bool hasCard() => $_has(1);
  @$pb.TagNumber(2)
  void clearCard() => clearField(2);
  @$pb.TagNumber(2)
  $414.Card ensureCard() => $_ensure(1);
}
