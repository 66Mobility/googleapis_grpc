...
class AnnotationType extends $pb.ProtobufEnum {
  ...
  static const AnnotationType USER_MENTION = AnnotationType._(1, _omitEnumNames ? '' : 'USER_MENTION');
  static const AnnotationType SLASH_COMMAND = AnnotationType._(2, _omitEnumNames ? '' : 'SLASH_COMMAND');
  static const AnnotationType RICH_LINK = AnnotationType._(3, _omitEnumNames ? '' : 'RICH_LINK');
...
class UserMentionMetadata_Type extends $pb.ProtobufEnum {
  static const UserMentionMetadata_Type TYPE_UNSPECIFIED = UserMentionMetadata_Type._(0, _omitEnumNames ? '' : 'TYPE_UNSPECIFIED');
  static const UserMentionMetadata_Type ADD = UserMentionMetadata_Type._(1, _omitEnumNames ? '' : 'ADD');
  static const UserMentionMetadata_Type MENTION = UserMentionMetadata_Type._(2, _omitEnumNames ? '' : 'MENTION');

  static const $core.List<UserMentionMetadata_Type> values = <UserMentionMetadata_Type> [
    TYPE_UNSPECIFIED,
    ADD,
    MENTION,
  ];

  static final $core.Map<$core.int, UserMentionMetadata_Type> _byValue = $pb.ProtobufEnum.initByValue(values);
...
class SlashCommandMetadata_Type extends $pb.ProtobufEnum {
  static const SlashCommandMetadata_Type TYPE_UNSPECIFIED = SlashCommandMetadata_Type._(0, _omitEnumNames ? '' : 'TYPE_UNSPECIFIED');
  static const SlashCommandMetadata_Type ADD = SlashCommandMetadata_Type._(1, _omitEnumNames ? '' : 'ADD');
  static const SlashCommandMetadata_Type INVOKE = SlashCommandMetadata_Type._(2, _omitEnumNames ? '' : 'INVOKE');

  static const $core.List<SlashCommandMetadata_Type> values = <SlashCommandMetadata_Type> [
    TYPE_UNSPECIFIED,
    ADD,
    INVOKE,
  ];

  static final $core.Map<$core.int, SlashCommandMetadata_Type> _byValue = $pb.ProtobufEnum.initByValue(values);
...
class RichLinkMetadata_RichLinkType extends $pb.ProtobufEnum {
  ...
  static RichLinkMetadata_RichLinkType? valueOf($core.int value) => _byValue[value];

  const RichLinkMetadata_RichLinkType._($core.int v, $core.String n) : super(v, n);
}
