...
class SpaceReadState extends $pb.GeneratedMessage {
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(
    ...
    ..aOM<$330.Timestamp>(2, _omitFieldNames ? '' : 'lastReadTime',
  ...
  @$pb.TagNumber(2)
  $330.Timestamp get lastReadTime => $_getN(1);
  @$pb.TagNumber(2)
  set lastReadTime($330.Timestamp v) {
    setField(2, v);
  }
  ...
  @$pb.TagNumber(2)
  $330.Timestamp ensureLastReadTime() => $_ensure(1);
}
