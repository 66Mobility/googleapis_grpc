...
class ContextualAddOnMarkup_Card_Section extends $pb.GeneratedMessage {
  factory ContextualAddOnMarkup_Card_Section({
    $core.String? header,
    $core.Iterable<$439.WidgetMarkup>? widgets,
  }) {
    final $result = create();
    if (header != null) {
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(
    ...
    ..pc<$439.WidgetMarkup>(
        ...
        subBuilder: $439.WidgetMarkup.create)
    ..hasRequiredFields = false;
  ...
  @$pb.TagNumber(2)
  $core.List<$439.WidgetMarkup> get widgets => $_getList(1);
}
...
class ContextualAddOnMarkup_Card_CardAction extends $pb.GeneratedMessage {
  factory ContextualAddOnMarkup_Card_CardAction({
    ...
    $439.WidgetMarkup_OnClick? onClick,
  }) {
    final $result = create();
    if (actionLabel != null) {
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(
    ...
    ..aOM<$439.WidgetMarkup_OnClick>(2, _omitFieldNames ? '' : 'onClick',
        subBuilder: $439.WidgetMarkup_OnClick.create)
    ..hasRequiredFields = false;
  ...
  @$pb.TagNumber(2)
  $439.WidgetMarkup_OnClick get onClick => $_getN(1);
  @$pb.TagNumber(2)
  set onClick($439.WidgetMarkup_OnClick v) {
    setField(2, v);
  }
  ...
  @$pb.TagNumber(2)
  $439.WidgetMarkup_OnClick ensureOnClick() => $_ensure(1);
}
