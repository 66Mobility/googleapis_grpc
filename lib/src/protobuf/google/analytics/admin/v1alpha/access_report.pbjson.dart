...
const AccessFilterExpression$json = {
  ...
  '2': [
    {'1': 'and_group', '3': 1, '4': 1, '5': 11, '6': '.google.analytics.admin.v1alpha.AccessFilterExpressionList', '9': 0, '10': 'andGroup'},
    {'1': 'or_group', '3': 2, '4': 1, '5': 11, '6': '.google.analytics.admin.v1alpha.AccessFilterExpressionList', '9': 0, '10': 'orGroup'},
    {'1': 'not_expression', '3': 3, '4': 1, '5': 11, '6': '.google.analytics.admin.v1alpha.AccessFilterExpression', '9': 0, '10': 'notExpression'},
    {'1': 'access_filter', '3': 4, '4': 1, '5': 11, '6': '.google.analytics.admin.v1alpha.AccessFilter', '9': 0, '10': 'accessFilter'},
  ],
  '8': [
    {'1': 'one_expression'},
  ],
...
const AccessFilterExpressionList$json = {
  ...
  '2': [
    {'1': 'expressions', '3': 1, '4': 3, '5': 11, '6': '.google.analytics.admin.v1alpha.AccessFilterExpression', '10': 'expressions'},
  ],
};

/// Descriptor for `AccessFilterExpressionList`. Decode as a `google.protobuf.DescriptorProto`.
final $typed_data.Uint8List accessFilterExpressionListDescriptor = $convert.base64Decode(
...
const AccessFilter$json = {
  '1': 'AccessFilter',
  '2': [
    {'1': 'string_filter', '3': 2, '4': 1, '5': 11, '6': '.google.analytics.admin.v1alpha.AccessStringFilter', '9': 0, '10': 'stringFilter'},
    {'1': 'in_list_filter', '3': 3, '4': 1, '5': 11, '6': '.google.analytics.admin.v1alpha.AccessInListFilter', '9': 0, '10': 'inListFilter'},
    {'1': 'numeric_filter', '3': 4, '4': 1, '5': 11, '6': '.google.analytics.admin.v1alpha.AccessNumericFilter', '9': 0, '10': 'numericFilter'},
    {'1': 'between_filter', '3': 5, '4': 1, '5': 11, '6': '.google.analytics.admin.v1alpha.AccessBetweenFilter', '9': 0, '10': 'betweenFilter'},
...
const AccessStringFilter$json = {
  ...
  '2': [
    {'1': 'match_type', '3': 1, '4': 1, '5': 14, '6': '.google.analytics.admin.v1alpha.AccessStringFilter.MatchType', '10': 'matchType'},
...
const AccessNumericFilter$json = {
  ...
  '2': [
    {'1': 'operation', '3': 1, '4': 1, '5': 14, '6': '.google.analytics.admin.v1alpha.AccessNumericFilter.Operation', '10': 'operation'},
    {'1': 'value', '3': 2, '4': 1, '5': 11, '6': '.google.analytics.admin.v1alpha.NumericValue', '10': 'value'},
  ],
...
const AccessBetweenFilter$json = {
  ...
  '2': [
    {'1': 'from_value', '3': 1, '4': 1, '5': 11, '6': '.google.analytics.admin.v1alpha.NumericValue', '10': 'fromValue'},
    {'1': 'to_value', '3': 2, '4': 1, '5': 11, '6': '.google.analytics.admin.v1alpha.NumericValue', '10': 'toValue'},
  ],
};
...
const AccessOrderBy$json = {
  '1': 'AccessOrderBy',
  '2': [
    {'1': 'metric', '3': 1, '4': 1, '5': 11, '6': '.google.analytics.admin.v1alpha.AccessOrderBy.MetricOrderBy', '9': 0, '10': 'metric'},
    {'1': 'dimension', '3': 2, '4': 1, '5': 11, '6': '.google.analytics.admin.v1alpha.AccessOrderBy.DimensionOrderBy', '9': 0, '10': 'dimension'},
...
const AccessOrderBy_DimensionOrderBy$json = {
  ...
  '2': [
    {'1': 'dimension_name', '3': 1, '4': 1, '5': 9, '10': 'dimensionName'},
    {'1': 'order_type', '3': 2, '4': 1, '5': 14, '6': '.google.analytics.admin.v1alpha.AccessOrderBy.DimensionOrderBy.OrderType', '10': 'orderType'},
  ],
...
const AccessRow$json = {
  '1': 'AccessRow',
  '2': [
    {'1': 'dimension_values', '3': 1, '4': 3, '5': 11, '6': '.google.analytics.admin.v1alpha.AccessDimensionValue', '10': 'dimensionValues'},
    {'1': 'metric_values', '3': 2, '4': 3, '5': 11, '6': '.google.analytics.admin.v1alpha.AccessMetricValue', '10': 'metricValues'},
  ],
};
...
final $typed_data.Uint8List accessDimensionValueDescriptor = $convert.base64Decode(
...
final $typed_data.Uint8List accessMetricValueDescriptor = $convert.base64Decode(
    'ChFBY2Nlc3NNZXRyaWNWYWx1ZRIUCgV2YWx1ZRgBIAEoCVIFdmFsdWU=');

@$core.Deprecated('Use accessQuotaDescriptor instead')
const AccessQuota$json = {
  '1': 'AccessQuota',
  '2': [
    {'1': 'tokens_per_day', '3': 1, '4': 1, '5': 11, '6': '.google.analytics.admin.v1alpha.AccessQuotaStatus', '10': 'tokensPerDay'},
    {'1': 'tokens_per_hour', '3': 2, '4': 1, '5': 11, '6': '.google.analytics.admin.v1alpha.AccessQuotaStatus', '10': 'tokensPerHour'},
    {'1': 'concurrent_requests', '3': 3, '4': 1, '5': 11, '6': '.google.analytics.admin.v1alpha.AccessQuotaStatus', '10': 'concurrentRequests'},
    {'1': 'server_errors_per_project_per_hour', '3': 4, '4': 1, '5': 11, '6': '.google.analytics.admin.v1alpha.AccessQuotaStatus', '10': 'serverErrorsPerProjectPerHour'},
    {'1': 'tokens_per_project_per_hour', '3': 5, '4': 1, '5': 11, '6': '.google.analytics.admin.v1alpha.AccessQuotaStatus', '10': 'tokensPerProjectPerHour'},
  ],
};
