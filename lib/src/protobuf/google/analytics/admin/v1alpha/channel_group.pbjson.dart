...
const ChannelGroupFilter$json = {
  ...
  '2': [
    {'1': 'string_filter', '3': 2, '4': 1, '5': 11, '6': '.google.analytics.admin.v1alpha.ChannelGroupFilter.StringFilter', '9': 0, '10': 'stringFilter'},
    {'1': 'in_list_filter', '3': 3, '4': 1, '5': 11, '6': '.google.analytics.admin.v1alpha.ChannelGroupFilter.InListFilter', '9': 0, '10': 'inListFilter'},
    {'1': 'field_name', '3': 1, '4': 1, '5': 9, '8': {}, '10': 'fieldName'},
  ],
  '3': [ChannelGroupFilter_StringFilter$json, ChannelGroupFilter_InListFilter$json],
  '8': [
    {'1': 'value_filter'},
  ],
};
...
const ChannelGroupFilter_StringFilter$json = {
  '1': 'StringFilter',
  '2': [
    {'1': 'match_type', '3': 1, '4': 1, '5': 14, '6': '.google.analytics.admin.v1alpha.ChannelGroupFilter.StringFilter.MatchType', '8': {}, '10': 'matchType'},
...
const ChannelGroupFilterExpression$json = {
  ...
  '2': [
    {'1': 'and_group', '3': 1, '4': 1, '5': 11, '6': '.google.analytics.admin.v1alpha.ChannelGroupFilterExpressionList', '9': 0, '10': 'andGroup'},
    {'1': 'or_group', '3': 2, '4': 1, '5': 11, '6': '.google.analytics.admin.v1alpha.ChannelGroupFilterExpressionList', '9': 0, '10': 'orGroup'},
    {'1': 'not_expression', '3': 3, '4': 1, '5': 11, '6': '.google.analytics.admin.v1alpha.ChannelGroupFilterExpression', '9': 0, '10': 'notExpression'},
    {'1': 'filter', '3': 4, '4': 1, '5': 11, '6': '.google.analytics.admin.v1alpha.ChannelGroupFilter', '9': 0, '10': 'filter'},
  ],
  '8': [
    {'1': 'expr'},
  ],
...
const ChannelGroupFilterExpressionList$json = {
  ...
  '2': [
    {'1': 'filter_expressions', '3': 1, '4': 3, '5': 11, '6': '.google.analytics.admin.v1alpha.ChannelGroupFilterExpression', '10': 'filterExpressions'},
  ],
};

/// Descriptor for `ChannelGroupFilterExpressionList`. Decode as a `google.protobuf.DescriptorProto`.
final $typed_data.Uint8List channelGroupFilterExpressionListDescriptor = $convert.base64Decode(
...
const GroupingRule$json = {
  ...
  '2': [
    ...
    {'1': 'expression', '3': 2, '4': 1, '5': 11, '6': '.google.analytics.admin.v1alpha.ChannelGroupFilterExpression', '8': {}, '10': 'expression'},
  ],
};
...
const ChannelGroup$json = {
  ...
  '2': [
    ...
    {'1': 'grouping_rule', '3': 4, '4': 3, '5': 11, '6': '.google.analytics.admin.v1alpha.GroupingRule', '8': {}, '10': 'groupingRule'},
    {'1': 'system_defined', '3': 5, '4': 1, '5': 8, '8': {}, '10': 'systemDefined'},
