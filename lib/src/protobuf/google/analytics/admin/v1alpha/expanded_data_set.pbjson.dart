...
const ExpandedDataSetFilter$json = {
  ...
  '2': [
    {'1': 'string_filter', '3': 2, '4': 1, '5': 11, '6': '.google.analytics.admin.v1alpha.ExpandedDataSetFilter.StringFilter', '9': 0, '10': 'stringFilter'},
    {'1': 'in_list_filter', '3': 3, '4': 1, '5': 11, '6': '.google.analytics.admin.v1alpha.ExpandedDataSetFilter.InListFilter', '9': 0, '10': 'inListFilter'},
    {'1': 'field_name', '3': 1, '4': 1, '5': 9, '8': {}, '10': 'fieldName'},
  ],
  '3': [ExpandedDataSetFilter_StringFilter$json, ExpandedDataSetFilter_InListFilter$json],
  '8': [
    {'1': 'one_filter'},
  ],
};
...
const ExpandedDataSetFilter_StringFilter$json = {
  '1': 'StringFilter',
  '2': [
    {'1': 'match_type', '3': 1, '4': 1, '5': 14, '6': '.google.analytics.admin.v1alpha.ExpandedDataSetFilter.StringFilter.MatchType', '8': {}, '10': 'matchType'},
...
const ExpandedDataSetFilterExpression$json = {
  ...
  '2': [
    {'1': 'and_group', '3': 1, '4': 1, '5': 11, '6': '.google.analytics.admin.v1alpha.ExpandedDataSetFilterExpressionList', '9': 0, '10': 'andGroup'},
    {'1': 'not_expression', '3': 2, '4': 1, '5': 11, '6': '.google.analytics.admin.v1alpha.ExpandedDataSetFilterExpression', '9': 0, '10': 'notExpression'},
    {'1': 'filter', '3': 3, '4': 1, '5': 11, '6': '.google.analytics.admin.v1alpha.ExpandedDataSetFilter', '9': 0, '10': 'filter'},
  ],
  '8': [
    {'1': 'expr'},
  ],
...
const ExpandedDataSetFilterExpressionList$json = {
  ...
  '2': [
    {'1': 'filter_expressions', '3': 1, '4': 3, '5': 11, '6': '.google.analytics.admin.v1alpha.ExpandedDataSetFilterExpression', '10': 'filterExpressions'},
  ],
};

/// Descriptor for `ExpandedDataSetFilterExpressionList`. Decode as a `google.protobuf.DescriptorProto`.
final $typed_data.Uint8List expandedDataSetFilterExpressionListDescriptor = $convert.base64Decode(
...
const ExpandedDataSet$json = {
  ...
  '2': [
    ...
    {'1': 'dimension_names', '3': 4, '4': 3, '5': 9, '8': {}, '10': 'dimensionNames'},
    {'1': 'metric_names', '3': 5, '4': 3, '5': 9, '8': {}, '10': 'metricNames'},
    {'1': 'dimension_filter_expression', '3': 6, '4': 1, '5': 11, '6': '.google.analytics.admin.v1alpha.ExpandedDataSetFilterExpression', '8': {}, '10': 'dimensionFilterExpression'},
    {'1': 'data_collection_start_time', '3': 7, '4': 1, '5': 11, '6': '.google.protobuf.Timestamp', '8': {}, '10': 'dataCollectionStartTime'},
  ],
  '7': {},
};
