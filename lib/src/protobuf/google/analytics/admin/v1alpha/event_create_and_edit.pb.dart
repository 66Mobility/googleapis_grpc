...
class ParameterMutation extends $pb.GeneratedMessage {
  ...
  factory ParameterMutation.fromBuffer($core.List<$core.int> i, [$pb.ExtensionRegistry r = $pb.ExtensionRegistry.EMPTY]) => create()..mergeFromBuffer(i, r);
  factory ParameterMutation.fromJson($core.String i, [$pb.ExtensionRegistry r = $pb.ExtensionRegistry.EMPTY]) => create()..mergeFromJson(i, r);

  static final $pb.BuilderInfo _i = $pb.BuilderInfo(_omitMessageNames ? '' : 'ParameterMutation', package: const $pb.PackageName(_omitMessageNames ? '' : 'google.analytics.admin.v1alpha'), createEmptyInstance: create)
  ...
  'Will be removed in next major version')
  ParameterMutation copyWith(void Function(ParameterMutation) updates) => super.copyWith((message) => updates(message as ParameterMutation)) as ParameterMutation;
  ...
  static $pb.PbList<ParameterMutation> createRepeated() => $pb.PbList<ParameterMutation>();
  @$core.pragma('dart2js:noInline')
  static ParameterMutation getDefault() => _defaultInstance ??= $pb.GeneratedMessage.$_defaultFor<ParameterMutation>(create);
  ...
  @$pb.TagNumber(2)
  set parameterValue($core.String v) { $_setString(1, v); }
  @$pb.TagNumber(2)
...
class EventCreateRule extends $pb.GeneratedMessage {
  ...
  factory EventCreateRule.fromBuffer($core.List<$core.int> i, [$pb.ExtensionRegistry r = $pb.ExtensionRegistry.EMPTY]) => create()..mergeFromBuffer(i, r);
  factory EventCreateRule.fromJson($core.String i, [$pb.ExtensionRegistry r = $pb.ExtensionRegistry.EMPTY]) => create()..mergeFromJson(i, r);

  static final $pb.BuilderInfo _i = $pb.BuilderInfo(_omitMessageNames ? '' : 'EventCreateRule', package: const $pb.PackageName(_omitMessageNames ? '' : 'google.analytics.admin.v1alpha'), createEmptyInstance: create)
    ..aOS(1, _omitFieldNames ? '' : 'name')
    ..aOS(2, _omitFieldNames ? '' : 'destinationEvent')
    ..pc<MatchingCondition>(3, _omitFieldNames ? '' : 'eventConditions', $pb.PbFieldType.PM, subBuilder: MatchingCondition.create)
    ..aOB(4, _omitFieldNames ? '' : 'sourceCopyParameters')
    ..pc<ParameterMutation>(5, _omitFieldNames ? '' : 'parameterMutations', $pb.PbFieldType.PM, subBuilder: ParameterMutation.create)
    ..hasRequiredFields = false
  ;
  ...
  'Use [GeneratedMessageGenericExtensions.rebuild] instead. '
  'Will be removed in next major version')
  EventCreateRule copyWith(void Function(EventCreateRule) updates) => super.copyWith((message) => updates(message as EventCreateRule)) as EventCreateRule;
  ...
  static $pb.PbList<EventCreateRule> createRepeated() => $pb.PbList<EventCreateRule>();
  @$core.pragma('dart2js:noInline')
  static EventCreateRule getDefault() => _defaultInstance ??= $pb.GeneratedMessage.$_defaultFor<EventCreateRule>(create);
  ...
  @$pb.TagNumber(2)
  set destinationEvent($core.String v) { $_setString(1, v); }
  @$pb.TagNumber(2)
  ...
  @$pb.TagNumber(4)
  set sourceCopyParameters($core.bool v) { $_setBool(3, v); }
  @$pb.TagNumber(4)
...
class EventEditRule extends $pb.GeneratedMessage {
  ...
  factory EventEditRule.fromBuffer($core.List<$core.int> i, [$pb.ExtensionRegistry r = $pb.ExtensionRegistry.EMPTY]) => create()..mergeFromBuffer(i, r);
  factory EventEditRule.fromJson($core.String i, [$pb.ExtensionRegistry r = $pb.ExtensionRegistry.EMPTY]) => create()..mergeFromJson(i, r);

  static final $pb.BuilderInfo _i = $pb.BuilderInfo(_omitMessageNames ? '' : 'EventEditRule', package: const $pb.PackageName(_omitMessageNames ? '' : 'google.analytics.admin.v1alpha'), createEmptyInstance: create)
    ..aOS(1, _omitFieldNames ? '' : 'name')
    ..aOS(2, _omitFieldNames ? '' : 'displayName')
    ..pc<MatchingCondition>(3, _omitFieldNames ? '' : 'eventConditions', $pb.PbFieldType.PM, subBuilder: MatchingCondition.create)
    ..pc<ParameterMutation>(4, _omitFieldNames ? '' : 'parameterMutations', $pb.PbFieldType.PM, subBuilder: ParameterMutation.create)
  ...
  'Use [GeneratedMessageGenericExtensions.rebuild] instead. '
  'Will be removed in next major version')
  EventEditRule copyWith(void Function(EventEditRule) updates) => super.copyWith((message) => updates(message as EventEditRule)) as EventEditRule;
  ...
  static $pb.PbList<EventEditRule> createRepeated() => $pb.PbList<EventEditRule>();
  @$core.pragma('dart2js:noInline')
  static EventEditRule getDefault() => _defaultInstance ??= $pb.GeneratedMessage.$_defaultFor<EventEditRule>(create);
  ...
  @$pb.TagNumber(5)
  set processingOrder($fixnum.Int64 v) { $_setInt64(4, v); }
  @$pb.TagNumber(5)
...
class MatchingCondition extends $pb.GeneratedMessage {
  ...
  factory MatchingCondition.fromBuffer($core.List<$core.int> i, [$pb.ExtensionRegistry r = $pb.ExtensionRegistry.EMPTY]) => create()..mergeFromBuffer(i, r);
  factory MatchingCondition.fromJson($core.String i, [$pb.ExtensionRegistry r = $pb.ExtensionRegistry.EMPTY]) => create()..mergeFromJson(i, r);

  static final $pb.BuilderInfo _i = $pb.BuilderInfo(_omitMessageNames ? '' : 'MatchingCondition', package: const $pb.PackageName(_omitMessageNames ? '' : 'google.analytics.admin.v1alpha'), createEmptyInstance: create)
    ..aOS(1, _omitFieldNames ? '' : 'field')
    ..e<MatchingCondition_ComparisonType>(2, _omitFieldNames ? '' : 'comparisonType', $pb.PbFieldType.OE, defaultOrMaker: MatchingCondition_ComparisonType.COMPARISON_TYPE_UNSPECIFIED, valueOf: MatchingCondition_ComparisonType.valueOf, enumValues: MatchingCondition_ComparisonType.values)
  ...
  'Use [GeneratedMessageGenericExtensions.rebuild] instead. '
  'Will be removed in next major version')
  MatchingCondition copyWith(void Function(MatchingCondition) updates) => super.copyWith((message) => updates(message as MatchingCondition)) as MatchingCondition;
  ...
  static $pb.PbList<MatchingCondition> createRepeated() => $pb.PbList<MatchingCondition>();
  @$core.pragma('dart2js:noInline')
  static MatchingCondition getDefault() => _defaultInstance ??= $pb.GeneratedMessage.$_defaultFor<MatchingCondition>(create);
  ...
  @$pb.TagNumber(2)
  set comparisonType(MatchingCondition_ComparisonType v) { setField(2, v); }
  @$pb.TagNumber(2)
