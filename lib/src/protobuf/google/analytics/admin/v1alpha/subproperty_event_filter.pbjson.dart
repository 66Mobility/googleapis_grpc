...
const SubpropertyEventFilterCondition$json = {
  ...
  '2': [
    ...
    {'1': 'string_filter', '3': 3, '4': 1, '5': 11, '6': '.google.analytics.admin.v1alpha.SubpropertyEventFilterCondition.StringFilter', '9': 0, '10': 'stringFilter'},
...
const SubpropertyEventFilterCondition_StringFilter$json = {
  '1': 'StringFilter',
  '2': [
    {'1': 'match_type', '3': 1, '4': 1, '5': 14, '6': '.google.analytics.admin.v1alpha.SubpropertyEventFilterCondition.StringFilter.MatchType', '8': {}, '10': 'matchType'},
...
const SubpropertyEventFilterExpression$json = {
  ...
  '2': [
    {'1': 'or_group', '3': 1, '4': 1, '5': 11, '6': '.google.analytics.admin.v1alpha.SubpropertyEventFilterExpressionList', '9': 0, '10': 'orGroup'},
    {'1': 'not_expression', '3': 2, '4': 1, '5': 11, '6': '.google.analytics.admin.v1alpha.SubpropertyEventFilterExpression', '9': 0, '10': 'notExpression'},
    {'1': 'filter_condition', '3': 3, '4': 1, '5': 11, '6': '.google.analytics.admin.v1alpha.SubpropertyEventFilterCondition', '9': 0, '10': 'filterCondition'},
  ],
  '8': [
    {'1': 'expr'},
  ],
...
const SubpropertyEventFilterExpressionList$json = {
  ...
  '2': [
    {'1': 'filter_expressions', '3': 1, '4': 3, '5': 11, '6': '.google.analytics.admin.v1alpha.SubpropertyEventFilterExpression', '8': {}, '10': 'filterExpressions'},
  ],
};

/// Descriptor for `SubpropertyEventFilterExpressionList`. Decode as a `google.protobuf.DescriptorProto`.
final $typed_data.Uint8List subpropertyEventFilterExpressionListDescriptor = $convert.base64Decode(
...
const SubpropertyEventFilterClause$json = {
  ...
  '2': [
    {'1': 'filter_clause_type', '3': 1, '4': 1, '5': 14, '6': '.google.analytics.admin.v1alpha.SubpropertyEventFilterClause.FilterClauseType', '8': {}, '10': 'filterClauseType'},
    {'1': 'filter_expression', '3': 2, '4': 1, '5': 11, '6': '.google.analytics.admin.v1alpha.SubpropertyEventFilterExpression', '8': {}, '10': 'filterExpression'},
  ],
...
const SubpropertyEventFilter$json = {
  ...
  '2': [
    ...
    {'1': 'apply_to_property', '3': 2, '4': 1, '5': 9, '8': {}, '9': 0, '10': 'applyToProperty', '17': true},
    {'1': 'filter_clauses', '3': 3, '4': 3, '5': 11, '6': '.google.analytics.admin.v1alpha.SubpropertyEventFilterClause', '8': {}, '10': 'filterClauses'},
  ],
  '7': {},
  '8': [
