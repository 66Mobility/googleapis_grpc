...
class CreatePolicyBindingRequest extends $pb.GeneratedMessage {
  factory CreatePolicyBindingRequest({
    ...
    $172.PolicyBinding? policyBinding,
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(
    ...
    ..aOM<$172.PolicyBinding>(3, _omitFieldNames ? '' : 'policyBinding',
  ...
  @$pb.TagNumber(3)
  $172.PolicyBinding get policyBinding => $_getN(2);
  @$pb.TagNumber(3)
  set policyBinding($172.PolicyBinding v) {
    setField(3, v);
  }
  ...
  @$pb.TagNumber(3)
  $172.PolicyBinding ensurePolicyBinding() => $_ensure(2);
...
class UpdatePolicyBindingRequest extends $pb.GeneratedMessage {
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(
      ...
      package:
          const $pb.PackageName(_omitMessageNames ? '' : 'google.iam.v3beta'),
      createEmptyInstance: create)
    ..aOM<$172.PolicyBinding>(1, _omitFieldNames ? '' : 'policyBinding',
        subBuilder: $172.PolicyBinding.create)
  ...
  ///  update.
  @$pb.TagNumber(1)
  $172.PolicyBinding get policyBinding => $_getN(0);
  @$pb.TagNumber(1)
  set policyBinding($172.PolicyBinding v) {
    setField(1, v);
  }
  ...
  @$pb.TagNumber(1)
  $172.PolicyBinding ensurePolicyBinding() => $_ensure(0);
