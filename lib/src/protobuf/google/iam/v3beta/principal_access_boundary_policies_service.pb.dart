...
class CreatePrincipalAccessBoundaryPolicyRequest extends $pb.GeneratedMessage {
  factory CreatePrincipalAccessBoundaryPolicyRequest({
    ...
    $174.PrincipalAccessBoundaryPolicy? principalAccessBoundaryPolicy,
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(
    ...
    ..aOM<$174.PrincipalAccessBoundaryPolicy>(
        3, _omitFieldNames ? '' : 'principalAccessBoundaryPolicy',
        subBuilder: $174.PrincipalAccessBoundaryPolicy.create)
  ...
  @$pb.TagNumber(3)
  $174.PrincipalAccessBoundaryPolicy get principalAccessBoundaryPolicy =>
      $_getN(2);
  @$pb.TagNumber(3)
  set principalAccessBoundaryPolicy($174.PrincipalAccessBoundaryPolicy v) {
    setField(3, v);
  }
  ...
  @$pb.TagNumber(3)
  $174.PrincipalAccessBoundaryPolicy ensurePrincipalAccessBoundaryPolicy() =>
      $_ensure(2);
...
class ListPrincipalAccessBoundaryPoliciesResponse extends $pb.GeneratedMessage {
  factory ListPrincipalAccessBoundaryPoliciesResponse({
    $core.Iterable<$174.PrincipalAccessBoundaryPolicy>?
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(
      ...
      package:
          const $pb.PackageName(_omitMessageNames ? '' : 'google.iam.v3beta'),
      createEmptyInstance: create)
    ..pc<$174.PrincipalAccessBoundaryPolicy>(
        1,
  ...
  @$pb.TagNumber(1)
  $core.List<$174.PrincipalAccessBoundaryPolicy>
...
class SearchPrincipalAccessBoundaryPolicyBindingsResponse
  ...
  factory SearchPrincipalAccessBoundaryPolicyBindingsResponse({
    $core.Iterable<$172.PolicyBinding>? policyBindings,
    $core.String? nextPageToken,
  }) {
    final $result = create();
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(
      ...
      package:
          const $pb.PackageName(_omitMessageNames ? '' : 'google.iam.v3beta'),
      createEmptyInstance: create)
    ..pc<$172.PolicyBinding>(
        1, _omitFieldNames ? '' : 'policyBindings', $pb.PbFieldType.PM,
        subBuilder: $172.PolicyBinding.create)
    ..aOS(2, _omitFieldNames ? '' : 'nextPageToken')
    ..hasRequiredFields = false;
  ...
  @$pb.TagNumber(1)
  $core.List<$172.PolicyBinding> get policyBindings => $_getList(0);
