...
class Policy extends $pb.GeneratedMessage {
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(
    ...
    ..aOM<$330.Timestamp>(8, _omitFieldNames ? '' : 'updateTime',
        subBuilder: $330.Timestamp.create)
    ..aOM<$330.Timestamp>(9, _omitFieldNames ? '' : 'deleteTime',
        subBuilder: $330.Timestamp.create)
  ...
  @$pb.TagNumber(9)
  $330.Timestamp get deleteTime => $_getN(8);
  @$pb.TagNumber(9)
  ...
  @$pb.TagNumber(9)
  $330.Timestamp ensureDeleteTime() => $_ensure(8);
...
class PolicyRule extends $pb.GeneratedMessage {
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(
    ...
    ..aOM<$474.DenyRule>(2, _omitFieldNames ? '' : 'denyRule',
        subBuilder: $474.DenyRule.create)
    ..hasRequiredFields = false;
  ...
  @$pb.TagNumber(2)
  $474.DenyRule get denyRule => $_getN(1);
  @$pb.TagNumber(2)
  set denyRule($474.DenyRule v) {
    setField(2, v);
  }
  ...
  @$pb.TagNumber(2)
  $474.DenyRule ensureDenyRule() => $_ensure(1);
}
...
class PolicyOperationMetadata extends $pb.GeneratedMessage {
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(
      ...
      package: const $pb.PackageName(_omitMessageNames ? '' : 'google.iam.v2'),
      createEmptyInstance: create)
    ..aOM<$330.Timestamp>(1, _omitFieldNames ? '' : 'createTime',
        subBuilder: $330.Timestamp.create)
    ..hasRequiredFields = false;
  ...
  @$pb.TagNumber(1)
  $330.Timestamp get createTime => $_getN(0);
  @$pb.TagNumber(1)
  set createTime($330.Timestamp v) {
    setField(1, v);
  }
  ...
  @$pb.TagNumber(1)
  $330.Timestamp ensureCreateTime() => $_ensure(0);
}
