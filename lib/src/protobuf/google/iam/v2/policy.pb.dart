...
class Policy extends $pb.GeneratedMessage {
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(_omitMessageNames ? '' : 'Policy', package: const $pb.PackageName(_omitMessageNames ? '' : 'google.iam.v2'), createEmptyInstance: create)
    ...
    ..aOM<$301.Timestamp>(9, _omitFieldNames ? '' : 'deleteTime', subBuilder: $301.Timestamp.create)
  ...
  @$pb.TagNumber(9)
  $301.Timestamp get deleteTime => $_getN(8);
  @$pb.TagNumber(9)
  set deleteTime($301.Timestamp v) { setField(9, v); }
  @$pb.TagNumber(9)
  $core.bool hasDeleteTime() => $_has(8);
  @$pb.TagNumber(9)
  void clearDeleteTime() => clearField(9);
  @$pb.TagNumber(9)
  $301.Timestamp ensureDeleteTime() => $_ensure(8);
  ...
  @$pb.TagNumber(11)
  set managingAuthority($core.String v) { $_setString(10, v); }
  @$pb.TagNumber(11)
...
class PolicyRule extends $pb.GeneratedMessage {
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(_omitMessageNames ? '' : 'PolicyRule', package: const $pb.PackageName(_omitMessageNames ? '' : 'google.iam.v2'), createEmptyInstance: create)
    ...
    ..aOM<$442.DenyRule>(2, _omitFieldNames ? '' : 'denyRule', subBuilder: $442.DenyRule.create)
    ..hasRequiredFields = false
  ;
  ...
  @$pb.TagNumber(2)
  $442.DenyRule get denyRule => $_getN(1);
  @$pb.TagNumber(2)
  set denyRule($442.DenyRule v) { setField(2, v); }
  @$pb.TagNumber(2)
  $core.bool hasDenyRule() => $_has(1);
  @$pb.TagNumber(2)
  void clearDenyRule() => clearField(2);
  @$pb.TagNumber(2)
  $442.DenyRule ensureDenyRule() => $_ensure(1);
}
...
class ListPoliciesRequest extends $pb.GeneratedMessage {
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(_omitMessageNames ? '' : 'ListPoliciesRequest', package: const $pb.PackageName(_omitMessageNames ? '' : 'google.iam.v2'), createEmptyInstance: create)
...
class ListPoliciesResponse extends $pb.GeneratedMessage {
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(_omitMessageNames ? '' : 'ListPoliciesResponse', package: const $pb.PackageName(_omitMessageNames ? '' : 'google.iam.v2'), createEmptyInstance: create)
...
class GetPolicyRequest extends $pb.GeneratedMessage {
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(_omitMessageNames ? '' : 'GetPolicyRequest', package: const $pb.PackageName(_omitMessageNames ? '' : 'google.iam.v2'), createEmptyInstance: create)
    ..aOS(1, _omitFieldNames ? '' : 'name')
    ..hasRequiredFields = false
  ;
...
class CreatePolicyRequest extends $pb.GeneratedMessage {
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(_omitMessageNames ? '' : 'CreatePolicyRequest', package: const $pb.PackageName(_omitMessageNames ? '' : 'google.iam.v2'), createEmptyInstance: create)
    ..aOS(1, _omitFieldNames ? '' : 'parent')
...
class UpdatePolicyRequest extends $pb.GeneratedMessage {
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(_omitMessageNames ? '' : 'UpdatePolicyRequest', package: const $pb.PackageName(_omitMessageNames ? '' : 'google.iam.v2'), createEmptyInstance: create)
...
class DeletePolicyRequest extends $pb.GeneratedMessage {
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(_omitMessageNames ? '' : 'DeletePolicyRequest', package: const $pb.PackageName(_omitMessageNames ? '' : 'google.iam.v2'), createEmptyInstance: create)
    ..aOS(1, _omitFieldNames ? '' : 'name')
