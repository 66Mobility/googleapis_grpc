...
class PolicyRule extends $pb.GeneratedMessage {
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(
    ...
    ..aOM<$446.DenyRule>(2, _omitFieldNames ? '' : 'denyRule',
        subBuilder: $446.DenyRule.create)
    ..hasRequiredFields = false;
  ...
  @$pb.TagNumber(2)
  $446.DenyRule get denyRule => $_getN(1);
  @$pb.TagNumber(2)
  set denyRule($446.DenyRule v) {
    setField(2, v);
  }
  ...
  @$pb.TagNumber(2)
  $446.DenyRule ensureDenyRule() => $_ensure(1);
}
