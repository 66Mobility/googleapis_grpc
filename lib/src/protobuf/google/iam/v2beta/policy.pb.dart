...
class PolicyRule extends $pb.GeneratedMessage {
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(
    ...
    ..aOM<$475.DenyRule>(2, _omitFieldNames ? '' : 'denyRule',
        subBuilder: $475.DenyRule.create)
    ..hasRequiredFields = false;
  ...
  @$pb.TagNumber(2)
  $475.DenyRule get denyRule => $_getN(1);
  @$pb.TagNumber(2)
  set denyRule($475.DenyRule v) {
    setField(2, v);
  }
  ...
  @$pb.TagNumber(2)
  $475.DenyRule ensureDenyRule() => $_ensure(1);
}
