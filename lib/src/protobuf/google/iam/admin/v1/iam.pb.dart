...
class ServiceAccountKey extends $pb.GeneratedMessage {
  factory ServiceAccountKey({
    ...
    $299.Timestamp? validAfterTime,
    $299.Timestamp? validBeforeTime,
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(_omitMessageNames ? '' : 'ServiceAccountKey', package: const $pb.PackageName(_omitMessageNames ? '' : 'google.iam.admin.v1'), createEmptyInstance: create)
    ...
    ..aOM<$299.Timestamp>(4, _omitFieldNames ? '' : 'validAfterTime', subBuilder: $299.Timestamp.create)
    ..aOM<$299.Timestamp>(5, _omitFieldNames ? '' : 'validBeforeTime', subBuilder: $299.Timestamp.create)
  ...
  @$pb.TagNumber(4)
  $299.Timestamp get validAfterTime => $_getN(3);
  @$pb.TagNumber(4)
  set validAfterTime($299.Timestamp v) { setField(4, v); }
  @$pb.TagNumber(4)
  $core.bool hasValidAfterTime() => $_has(3);
  @$pb.TagNumber(4)
  void clearValidAfterTime() => clearField(4);
  @$pb.TagNumber(4)
  $299.Timestamp ensureValidAfterTime() => $_ensure(3);
  ...
  @$pb.TagNumber(5)
  $299.Timestamp get validBeforeTime => $_getN(4);
  @$pb.TagNumber(5)
  set validBeforeTime($299.Timestamp v) { setField(5, v); }
  @$pb.TagNumber(5)
  $core.bool hasValidBeforeTime() => $_has(4);
  @$pb.TagNumber(5)
  void clearValidBeforeTime() => clearField(5);
  @$pb.TagNumber(5)
  $299.Timestamp ensureValidBeforeTime() => $_ensure(4);
...
class LintPolicyRequest extends $pb.GeneratedMessage {
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(_omitMessageNames ? '' : 'LintPolicyRequest', package: const $pb.PackageName(_omitMessageNames ? '' : 'google.iam.admin.v1'), createEmptyInstance: create)
    ..oo(0, [5])
    ..aOS(1, _omitFieldNames ? '' : 'fullResourceName')
    ..aOM<$396.Expr>(5, _omitFieldNames ? '' : 'condition', subBuilder: $396.Expr.create)
    ..hasRequiredFields = false
  ;
  ...
  @$pb.TagNumber(5)
  $396.Expr get condition => $_getN(1);
  @$pb.TagNumber(5)
  set condition($396.Expr v) { setField(5, v); }
  @$pb.TagNumber(5)
  $core.bool hasCondition() => $_has(1);
  @$pb.TagNumber(5)
  void clearCondition() => clearField(5);
  @$pb.TagNumber(5)
  $396.Expr ensureCondition() => $_ensure(1);
}
