...
class CreatePrincipalAccessBoundaryPolicyRequest extends $pb.GeneratedMessage {
  factory CreatePrincipalAccessBoundaryPolicyRequest({
    ...
    $170.PrincipalAccessBoundaryPolicy? principalAccessBoundaryPolicy,
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(
    ...
    ..aOM<$170.PrincipalAccessBoundaryPolicy>(
        3, _omitFieldNames ? '' : 'principalAccessBoundaryPolicy',
        subBuilder: $170.PrincipalAccessBoundaryPolicy.create)
  ...
  @$pb.TagNumber(3)
  $170.PrincipalAccessBoundaryPolicy get principalAccessBoundaryPolicy =>
      $_getN(2);
  @$pb.TagNumber(3)
  set principalAccessBoundaryPolicy($170.PrincipalAccessBoundaryPolicy v) {
    setField(3, v);
  }
  ...
  @$pb.TagNumber(3)
  $170.PrincipalAccessBoundaryPolicy ensurePrincipalAccessBoundaryPolicy() =>
      $_ensure(2);
...
class ListPrincipalAccessBoundaryPoliciesResponse extends $pb.GeneratedMessage {
  factory ListPrincipalAccessBoundaryPoliciesResponse({
    $core.Iterable<$170.PrincipalAccessBoundaryPolicy>?
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(
      ...
      package: const $pb.PackageName(_omitMessageNames ? '' : 'google.iam.v3'),
      createEmptyInstance: create)
    ..pc<$170.PrincipalAccessBoundaryPolicy>(
        1,
  ...
  @$pb.TagNumber(1)
  $core.List<$170.PrincipalAccessBoundaryPolicy>
...
class SearchPrincipalAccessBoundaryPolicyBindingsResponse
  ...
  factory SearchPrincipalAccessBoundaryPolicyBindingsResponse({
    $core.Iterable<$168.PolicyBinding>? policyBindings,
    $core.String? nextPageToken,
  }) {
    final $result = create();
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(
      ...
      package: const $pb.PackageName(_omitMessageNames ? '' : 'google.iam.v3'),
      createEmptyInstance: create)
    ..pc<$168.PolicyBinding>(
        1, _omitFieldNames ? '' : 'policyBindings', $pb.PbFieldType.PM,
        subBuilder: $168.PolicyBinding.create)
    ..aOS(2, _omitFieldNames ? '' : 'nextPageToken')
    ..hasRequiredFields = false;
  ...
  @$pb.TagNumber(1)
  $core.List<$168.PolicyBinding> get policyBindings => $_getList(0);
