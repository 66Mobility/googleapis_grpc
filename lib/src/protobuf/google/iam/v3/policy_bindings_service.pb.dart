...
class CreatePolicyBindingRequest extends $pb.GeneratedMessage {
  factory CreatePolicyBindingRequest({
    ...
    $168.PolicyBinding? policyBinding,
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(
    ...
    ..aOM<$168.PolicyBinding>(3, _omitFieldNames ? '' : 'policyBinding',
  ...
  @$pb.TagNumber(3)
  $168.PolicyBinding get policyBinding => $_getN(2);
  @$pb.TagNumber(3)
  set policyBinding($168.PolicyBinding v) {
    setField(3, v);
  }
  ...
  @$pb.TagNumber(3)
  $168.PolicyBinding ensurePolicyBinding() => $_ensure(2);
...
class UpdatePolicyBindingRequest extends $pb.GeneratedMessage {
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(
      ...
      package: const $pb.PackageName(_omitMessageNames ? '' : 'google.iam.v3'),
      createEmptyInstance: create)
    ..aOM<$168.PolicyBinding>(1, _omitFieldNames ? '' : 'policyBinding',
        subBuilder: $168.PolicyBinding.create)
  ...
  ///  update.
  @$pb.TagNumber(1)
  $168.PolicyBinding get policyBinding => $_getN(0);
  @$pb.TagNumber(1)
  set policyBinding($168.PolicyBinding v) {
    setField(1, v);
  }
  ...
  @$pb.TagNumber(1)
  $168.PolicyBinding ensurePolicyBinding() => $_ensure(0);
