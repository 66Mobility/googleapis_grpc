...
class Binding extends $pb.GeneratedMessage {
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(
    ...
    ..aOM<$430.Expr>(3, _omitFieldNames ? '' : 'condition',
  ...
  ///  documentation](https://cloud.google.com/iam/help/conditions/resource-policies).
  @$pb.TagNumber(3)
  $430.Expr get condition => $_getN(2);
  @$pb.TagNumber(3)
  ...
  @$pb.TagNumber(3)
  $430.Expr ensureCondition() => $_ensure(2);
}
...
class BindingDelta extends $pb.GeneratedMessage {
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(
    ...
    ..aOM<$430.Expr>(4, _omitFieldNames ? '' : 'condition',
        subBuilder: $430.Expr.create)
    ..hasRequiredFields = false;
  ...
  /// The condition that is associated with this binding.
  @$pb.TagNumber(4)
  $430.Expr get condition => $_getN(3);
  @$pb.TagNumber(4)
  set condition($430.Expr v) {
    setField(4, v);
  }
  ...
  @$pb.TagNumber(4)
  $430.Expr ensureCondition() => $_ensure(3);
}
