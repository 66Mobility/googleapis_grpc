...
class Binding extends $pb.GeneratedMessage {
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(_omitMessageNames ? '' : 'Binding', package: const $pb.PackageName(_omitMessageNames ? '' : 'google.iam.v1'), createEmptyInstance: create)
    ...
    ..aOM<$396.Expr>(3, _omitFieldNames ? '' : 'condition', subBuilder: $396.Expr.create)
    ..hasRequiredFields = false
  ;
  ...
  ///  documentation](https://cloud.google.com/iam/help/conditions/resource-policies).
  @$pb.TagNumber(3)
  $396.Expr get condition => $_getN(2);
  @$pb.TagNumber(3)
  set condition($396.Expr v) { setField(3, v); }
  @$pb.TagNumber(3)
  $core.bool hasCondition() => $_has(2);
  @$pb.TagNumber(3)
  void clearCondition() => clearField(3);
  @$pb.TagNumber(3)
  $396.Expr ensureCondition() => $_ensure(2);
}
...
class BindingDelta extends $pb.GeneratedMessage {
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(_omitMessageNames ? '' : 'BindingDelta', package: const $pb.PackageName(_omitMessageNames ? '' : 'google.iam.v1'), createEmptyInstance: create)
    ...
    ..aOM<$396.Expr>(4, _omitFieldNames ? '' : 'condition', subBuilder: $396.Expr.create)
    ..hasRequiredFields = false
  ;
  ...
  /// The condition that is associated with this binding.
  @$pb.TagNumber(4)
  $396.Expr get condition => $_getN(3);
  @$pb.TagNumber(4)
  set condition($396.Expr v) { setField(4, v); }
  @$pb.TagNumber(4)
  $core.bool hasCondition() => $_has(3);
  @$pb.TagNumber(4)
  void clearCondition() => clearField(4);
  @$pb.TagNumber(4)
  $396.Expr ensureCondition() => $_ensure(3);
}
