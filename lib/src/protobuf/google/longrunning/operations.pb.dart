...
class Operation extends $pb.GeneratedMessage {
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(_omitMessageNames ? '' : 'Operation', package: const $pb.PackageName(_omitMessageNames ? '' : 'google.longrunning'), createEmptyInstance: create)
    ...
    ..aOM<$1794.Any>(2, _omitFieldNames ? '' : 'metadata', subBuilder: $1794.Any.create)
    ..aOB(3, _omitFieldNames ? '' : 'done')
    ..aOM<$1795.Status>(4, _omitFieldNames ? '' : 'error', subBuilder: $1795.Status.create)
    ..aOM<$1794.Any>(5, _omitFieldNames ? '' : 'response', subBuilder: $1794.Any.create)
  ...
  @$pb.TagNumber(2)
  $1794.Any get metadata => $_getN(1);
  @$pb.TagNumber(2)
  set metadata($1794.Any v) { setField(2, v); }
  @$pb.TagNumber(2)
  $core.bool hasMetadata() => $_has(1);
  @$pb.TagNumber(2)
  void clearMetadata() => clearField(2);
  @$pb.TagNumber(2)
  $1794.Any ensureMetadata() => $_ensure(1);
  ...
  @$pb.TagNumber(5)
  $1794.Any get response => $_getN(4);
  @$pb.TagNumber(5)
  set response($1794.Any v) { setField(5, v); }
  @$pb.TagNumber(5)
  $core.bool hasResponse() => $_has(4);
  @$pb.TagNumber(5)
  void clearResponse() => clearField(5);
  @$pb.TagNumber(5)
  $1794.Any ensureResponse() => $_ensure(4);
}
