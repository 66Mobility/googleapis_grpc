...
class CssProductInput extends $pb.GeneratedMessage {
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(_omitMessageNames ? '' : 'CssProductInput', package: const $pb.PackageName(_omitMessageNames ? '' : 'google.shopping.css.v1'), createEmptyInstance: create)
    ...
    ..aOM<$1776.Timestamp>(6, _omitFieldNames ? '' : 'freshnessTime', subBuilder: $1776.Timestamp.create)
    ..aOM<$4875.Attributes>(7, _omitFieldNames ? '' : 'attributes', subBuilder: $4875.Attributes.create)
  ...
  ///  thrown.
  @$pb.TagNumber(6)
  $1776.Timestamp get freshnessTime => $_getN(5);
  @$pb.TagNumber(6)
  set freshnessTime($1776.Timestamp v) { setField(6, v); }
  @$pb.TagNumber(6)
  $core.bool hasFreshnessTime() => $_has(5);
  @$pb.TagNumber(6)
  void clearFreshnessTime() => clearField(6);
  @$pb.TagNumber(6)
  $1776.Timestamp ensureFreshnessTime() => $_ensure(5);

  /// A list of CSS Product attributes.
  @$pb.TagNumber(7)
  $4875.Attributes get attributes => $_getN(6);
  @$pb.TagNumber(7)
  set attributes($4875.Attributes v) { setField(7, v); }
  @$pb.TagNumber(7)
  $core.bool hasAttributes() => $_has(6);
  @$pb.TagNumber(7)
  void clearAttributes() => clearField(7);
  @$pb.TagNumber(7)
  $4875.Attributes ensureAttributes() => $_ensure(6);
