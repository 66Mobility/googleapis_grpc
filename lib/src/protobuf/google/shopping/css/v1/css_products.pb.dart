...
class CssProduct extends $pb.GeneratedMessage {
  factory CssProduct({
    ...
    $537.CssProductStatus? cssProductStatus,
  }) {
    final $result = create();
    if (name != null) {
      $result.name = name;
  ...
  @$pb.TagNumber(5)
  $537.Attributes ensureAttributes() => $_ensure(4);
  ...
  @$pb.TagNumber(6)
  $core.List<$536.CustomAttribute> get customAttributes => $_getList(5);
  ...
  @$pb.TagNumber(8)
  $537.CssProductStatus ensureCssProductStatus() => $_ensure(6);
}
