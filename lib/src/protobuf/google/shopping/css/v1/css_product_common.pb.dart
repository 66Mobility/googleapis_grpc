...
class Attributes extends $pb.GeneratedMessage {
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(_omitMessageNames ? '' : 'Attributes', package: const $pb.PackageName(_omitMessageNames ? '' : 'google.shopping.css.v1'), createEmptyInstance: create)
    ...
    ..aOM<$536.Price>(3, _omitFieldNames ? '' : 'lowPrice', subBuilder: $536.Price.create)
    ..aOM<$536.Price>(4, _omitFieldNames ? '' : 'highPrice', subBuilder: $536.Price.create)
    ..aInt64(5, _omitFieldNames ? '' : 'numberOfOffers')
    ..aOS(6, _omitFieldNames ? '' : 'headlineOfferCondition')
    ..aOM<$536.Price>(7, _omitFieldNames ? '' : 'headlineOfferPrice', subBuilder: $536.Price.create)
    ...
    ..aOM<$302.Timestamp>(40, _omitFieldNames ? '' : 'expirationDate', subBuilder: $302.Timestamp.create)
    ..aOM<$536.Price>(41, _omitFieldNames ? '' : 'headlineOfferShippingPrice', subBuilder: $536.Price.create)
  ...
  @$pb.TagNumber(3)
  set lowPrice($536.Price v) { setField(3, v); }
  @$pb.TagNumber(3)
  ...
  @$pb.TagNumber(4)
  set highPrice($536.Price v) { setField(4, v); }
  @$pb.TagNumber(4)
  ...
  @$pb.TagNumber(7)
  set headlineOfferPrice($536.Price v) { setField(7, v); }
  @$pb.TagNumber(7)
  ...
  @$pb.TagNumber(40)
  set expirationDate($302.Timestamp v) { setField(40, v); }
  @$pb.TagNumber(40)
  ...
  @$pb.TagNumber(41)
  set headlineOfferShippingPrice($536.Price v) { setField(41, v); }
  @$pb.TagNumber(41)
