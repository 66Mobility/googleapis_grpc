...
class Attributes extends $pb.GeneratedMessage {
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(
    ...
    ..pc<ProductDetail>(
        30, _omitFieldNames ? '' : 'productDetails', $pb.PbFieldType.PM,
        subBuilder: ProductDetail.create)
    ..aOM<ProductWeight>(31, _omitFieldNames ? '' : 'productWeight',
        subBuilder: ProductWeight.create)
    ..aOM<ProductDimension>(32, _omitFieldNames ? '' : 'productLength',
        subBuilder: ProductDimension.create)
    ..aOM<ProductDimension>(33, _omitFieldNames ? '' : 'productWidth',
        subBuilder: ProductDimension.create)
    ..aOM<ProductDimension>(34, _omitFieldNames ? '' : 'productHeight',
        subBuilder: ProductDimension.create)
    ...
    ..aOS(46, _omitFieldNames ? '' : 'customLabel0',
        protoName: 'custom_label_0')
    ..aOS(47, _omitFieldNames ? '' : 'customLabel1',
        protoName: 'custom_label_1')
    ..aOS(48, _omitFieldNames ? '' : 'customLabel2',
        protoName: 'custom_label_2')
    ..aOS(49, _omitFieldNames ? '' : 'customLabel3',
  ...
  @$pb.TagNumber(2)
  set cppMobileLink($core.String v) {
    $_setString(1, v);
  }
  ...
  @$pb.TagNumber(5)
  set numberOfOffers($fixnum.Int64 v) {
    $_setInt64(4, v);
  }
  ...
  @$pb.TagNumber(6)
  set headlineOfferCondition($core.String v) {
    $_setString(5, v);
  }
  ...
  @$pb.TagNumber(8)
  set headlineOfferLink($core.String v) {
    $_setString(7, v);
  }
  ...
  @$pb.TagNumber(9)
  set headlineOfferMobileLink($core.String v) {
    $_setString(8, v);
  }
  ...
  @$pb.TagNumber(40)
  $302.Timestamp get expirationDate => $_getN(37);
  @$pb.TagNumber(40)
  ...
  @$pb.TagNumber(40)
  $302.Timestamp ensureExpirationDate() => $_ensure(37);
  ...
  @$pb.TagNumber(42)
  set cppAdsRedirect($core.String v) {
    $_setString(39, v);
  }
...
class CssProductStatus_DestinationStatus extends $pb.GeneratedMessage {
  ...
  factory CssProductStatus_DestinationStatus.fromBuffer($core.List<$core.int> i,
          [$pb.ExtensionRegistry r = $pb.ExtensionRegistry.EMPTY]) =>
      create()..mergeFromBuffer(i, r);
  factory CssProductStatus_DestinationStatus.fromJson($core.String i,
          [$pb.ExtensionRegistry r = $pb.ExtensionRegistry.EMPTY]) =>
      create()..mergeFromJson(i, r);

  static final $pb.BuilderInfo _i = $pb.BuilderInfo(
      _omitMessageNames ? '' : 'CssProductStatus.DestinationStatus',
      package: const $pb.PackageName(
          _omitMessageNames ? '' : 'google.shopping.css.v1'),
      createEmptyInstance: create)
  ...
  @$core.Deprecated('Using this can add significant overhead to your binary. '
      'Use [GeneratedMessageGenericExtensions.deepCopy] instead. '
      'Will be removed in next major version')
  CssProductStatus_DestinationStatus clone() =>
      CssProductStatus_DestinationStatus()..mergeFromMessage(this);
  @$core.Deprecated('Using this can add significant overhead to your binary. '
      'Use [GeneratedMessageGenericExtensions.rebuild] instead. '
      'Will be removed in next major version')
  CssProductStatus_DestinationStatus copyWith(
          void Function(CssProductStatus_DestinationStatus) updates) =>
      super.copyWith((message) =>
              updates(message as CssProductStatus_DestinationStatus))
          as CssProductStatus_DestinationStatus;

  $pb.BuilderInfo get info_ => _i;

  @$core.pragma('dart2js:noInline')
  static CssProductStatus_DestinationStatus create() =>
      CssProductStatus_DestinationStatus._();
  CssProductStatus_DestinationStatus createEmptyInstance() => create();
  static $pb.PbList<CssProductStatus_DestinationStatus> createRepeated() =>
      $pb.PbList<CssProductStatus_DestinationStatus>();
  @$core.pragma('dart2js:noInline')
  static CssProductStatus_DestinationStatus getDefault() => _defaultInstance ??=
      $pb.GeneratedMessage.$_defaultFor<CssProductStatus_DestinationStatus>(
          create);
...
class CssProductStatus_ItemLevelIssue extends $pb.GeneratedMessage {
  ...
  factory CssProductStatus_ItemLevelIssue.fromBuffer($core.List<$core.int> i,
          [$pb.ExtensionRegistry r = $pb.ExtensionRegistry.EMPTY]) =>
      create()..mergeFromBuffer(i, r);
  factory CssProductStatus_ItemLevelIssue.fromJson($core.String i,
          [$pb.ExtensionRegistry r = $pb.ExtensionRegistry.EMPTY]) =>
      create()..mergeFromJson(i, r);

  static final $pb.BuilderInfo _i = $pb.BuilderInfo(
      _omitMessageNames ? '' : 'CssProductStatus.ItemLevelIssue',
      package: const $pb.PackageName(
          _omitMessageNames ? '' : 'google.shopping.css.v1'),
      createEmptyInstance: create)
  ...
  @$core.Deprecated('Using this can add significant overhead to your binary. '
      'Use [GeneratedMessageGenericExtensions.deepCopy] instead. '
      'Will be removed in next major version')
  CssProductStatus_ItemLevelIssue clone() =>
      CssProductStatus_ItemLevelIssue()..mergeFromMessage(this);
  @$core.Deprecated('Using this can add significant overhead to your binary. '
      'Use [GeneratedMessageGenericExtensions.rebuild] instead. '
      'Will be removed in next major version')
  CssProductStatus_ItemLevelIssue copyWith(
          void Function(CssProductStatus_ItemLevelIssue) updates) =>
      super.copyWith(
              (message) => updates(message as CssProductStatus_ItemLevelIssue))
          as CssProductStatus_ItemLevelIssue;

  $pb.BuilderInfo get info_ => _i;

  @$core.pragma('dart2js:noInline')
  static CssProductStatus_ItemLevelIssue create() =>
      CssProductStatus_ItemLevelIssue._();
  CssProductStatus_ItemLevelIssue createEmptyInstance() => create();
  static $pb.PbList<CssProductStatus_ItemLevelIssue> createRepeated() =>
      $pb.PbList<CssProductStatus_ItemLevelIssue>();
  @$core.pragma('dart2js:noInline')
  static CssProductStatus_ItemLevelIssue getDefault() => _defaultInstance ??=
      $pb.GeneratedMessage.$_defaultFor<CssProductStatus_ItemLevelIssue>(
          create);
...
class CssProductStatus extends $pb.GeneratedMessage {
  ...
  factory CssProductStatus.fromBuffer($core.List<$core.int> i,
          [$pb.ExtensionRegistry r = $pb.ExtensionRegistry.EMPTY]) =>
      create()..mergeFromBuffer(i, r);
  factory CssProductStatus.fromJson($core.String i,
          [$pb.ExtensionRegistry r = $pb.ExtensionRegistry.EMPTY]) =>
      create()..mergeFromJson(i, r);

  static final $pb.BuilderInfo _i = $pb.BuilderInfo(
      _omitMessageNames ? '' : 'CssProductStatus',
      package: const $pb.PackageName(
          _omitMessageNames ? '' : 'google.shopping.css.v1'),
      createEmptyInstance: create)
    ..pc<CssProductStatus_DestinationStatus>(
        3, _omitFieldNames ? '' : 'destinationStatuses', $pb.PbFieldType.PM,
        subBuilder: CssProductStatus_DestinationStatus.create)
  ...
  @$core.Deprecated('Using this can add significant overhead to your binary. '
      'Use [GeneratedMessageGenericExtensions.rebuild] instead. '
      'Will be removed in next major version')
  CssProductStatus copyWith(void Function(CssProductStatus) updates) =>
      super.copyWith((message) => updates(message as CssProductStatus))
          as CssProductStatus;
  ...
  static $pb.PbList<CssProductStatus> createRepeated() =>
      $pb.PbList<CssProductStatus>();
  @$core.pragma('dart2js:noInline')
  static CssProductStatus getDefault() => _defaultInstance ??=
      $pb.GeneratedMessage.$_defaultFor<CssProductStatus>(create);
  static CssProductStatus? _defaultInstance;

  /// The intended destinations for the product.
  @$pb.TagNumber(3)
  $core.List<CssProductStatus_DestinationStatus> get destinationStatuses =>
      $_getList(0);

  /// A list of all issues associated with the product.
  @$pb.TagNumber(4)
  $core.List<CssProductStatus_ItemLevelIssue> get itemLevelIssues =>
      $_getList(1);
