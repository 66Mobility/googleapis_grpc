...
class ProductInput extends $pb.GeneratedMessage {
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(_omitMessageNames ? '' : 'ProductInput', package: const $pb.PackageName(_omitMessageNames ? '' : 'google.shopping.merchant.products.v1beta'), createEmptyInstance: create)
    ...
    ..e<$4872.Channel_ChannelEnum>(3, _omitFieldNames ? '' : 'channel', $pb.PbFieldType.OE, defaultOrMaker: $4872.Channel_ChannelEnum.CHANNEL_ENUM_UNSPECIFIED, valueOf: $4872.Channel_ChannelEnum.valueOf, enumValues: $4872.Channel_ChannelEnum.values)
  ...
  /// product.
  @$pb.TagNumber(3)
  $4872.Channel_ChannelEnum get channel => $_getN(2);
  @$pb.TagNumber(3)
  set channel($4872.Channel_ChannelEnum v) { setField(3, v); }
  @$pb.TagNumber(3)
