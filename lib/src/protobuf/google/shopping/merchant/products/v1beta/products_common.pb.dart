...
class Attributes extends $pb.GeneratedMessage {
  factory Attributes({
    ...
    $1775.Timestamp? expirationDate,
    $core.bool? adult,
    $core.String? ageGroup,
    $core.String? availability,
    $1775.Timestamp? availabilityDate,
    $core.String? brand,
    $core.String? color,
    ...
    $4872.Price? salePrice,
    $4256.Interval? salePriceEffectiveDate,
    ...
    $4872.Price? autoPricingMinPrice,
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(_omitMessageNames ? '' : 'Attributes', package: const $pb.PackageName(_omitMessageNames ? '' : 'google.shopping.merchant.products.v1beta'), createEmptyInstance: create)
    ...
    ..aOM<$1775.Timestamp>(16, _omitFieldNames ? '' : 'expirationDate', subBuilder: $1775.Timestamp.create)
    ..aOB(17, _omitFieldNames ? '' : 'adult')
    ..aOS(18, _omitFieldNames ? '' : 'ageGroup')
    ..aOS(19, _omitFieldNames ? '' : 'availability')
    ..aOM<$1775.Timestamp>(20, _omitFieldNames ? '' : 'availabilityDate', subBuilder: $1775.Timestamp.create)
    ...
    ..aOM<$4872.Price>(31, _omitFieldNames ? '' : 'price', subBuilder: $4872.Price.create)
    ...
    ..aOM<$4872.Price>(36, _omitFieldNames ? '' : 'salePrice', subBuilder: $4872.Price.create)
    ..aOM<$4256.Interval>(37, _omitFieldNames ? '' : 'salePriceEffectiveDate', subBuilder: $4256.Interval.create)
    ...
    ..aOM<$4872.Price>(62, _omitFieldNames ? '' : 'costOfGoodsSold', subBuilder: $4872.Price.create)
    ...
    ..aOM<$1775.Timestamp>(79, _omitFieldNames ? '' : 'disclosureDate', subBuilder: $1775.Timestamp.create)
    ...
    ..aOM<$4872.Price>(124, _omitFieldNames ? '' : 'autoPricingMinPrice', subBuilder: $4872.Price.create)
  ...
  @$pb.TagNumber(16)
  $1775.Timestamp get expirationDate => $_getN(12);
  @$pb.TagNumber(16)
  set expirationDate($1775.Timestamp v) { setField(16, v); }
  @$pb.TagNumber(16)
  $core.bool hasExpirationDate() => $_has(12);
  @$pb.TagNumber(16)
  void clearExpirationDate() => clearField(16);
  @$pb.TagNumber(16)
  $1775.Timestamp ensureExpirationDate() => $_ensure(12);
  ...
  @$pb.TagNumber(20)
  $1775.Timestamp get availabilityDate => $_getN(16);
  @$pb.TagNumber(20)
  set availabilityDate($1775.Timestamp v) { setField(20, v); }
  @$pb.TagNumber(20)
  $core.bool hasAvailabilityDate() => $_has(16);
  @$pb.TagNumber(20)
  void clearAvailabilityDate() => clearField(20);
  @$pb.TagNumber(20)
  $1775.Timestamp ensureAvailabilityDate() => $_ensure(16);
  ...
  /// Price of the item.
  @$pb.TagNumber(31)
  $4872.Price get price => $_getN(27);
  @$pb.TagNumber(31)
  set price($4872.Price v) { setField(31, v); }
  @$pb.TagNumber(31)
  $core.bool hasPrice() => $_has(27);
  @$pb.TagNumber(31)
  void clearPrice() => clearField(31);
  @$pb.TagNumber(31)
  $4872.Price ensurePrice() => $_ensure(27);
  ...
  @$pb.TagNumber(36)
  $4872.Price get salePrice => $_getN(32);
  @$pb.TagNumber(36)
  set salePrice($4872.Price v) { setField(36, v); }
  @$pb.TagNumber(36)
  $core.bool hasSalePrice() => $_has(32);
  @$pb.TagNumber(36)
  void clearSalePrice() => clearField(36);
  @$pb.TagNumber(36)
  $4872.Price ensureSalePrice() => $_ensure(32);
  ...
  @$pb.TagNumber(37)
  $4256.Interval get salePriceEffectiveDate => $_getN(33);
  @$pb.TagNumber(37)
  set salePriceEffectiveDate($4256.Interval v) { setField(37, v); }
  @$pb.TagNumber(37)
  $core.bool hasSalePriceEffectiveDate() => $_has(33);
  @$pb.TagNumber(37)
  void clearSalePriceEffectiveDate() => clearField(37);
  @$pb.TagNumber(37)
  $4256.Interval ensureSalePriceEffectiveDate() => $_ensure(33);
  ...
  @$pb.TagNumber(62)
  $4872.Price get costOfGoodsSold => $_getN(58);
  @$pb.TagNumber(62)
  set costOfGoodsSold($4872.Price v) { setField(62, v); }
  @$pb.TagNumber(62)
  $core.bool hasCostOfGoodsSold() => $_has(58);
  @$pb.TagNumber(62)
  void clearCostOfGoodsSold() => clearField(62);
  @$pb.TagNumber(62)
  $4872.Price ensureCostOfGoodsSold() => $_ensure(58);
  ...
  @$pb.TagNumber(79)
  $1775.Timestamp get disclosureDate => $_getN(75);
  @$pb.TagNumber(79)
  set disclosureDate($1775.Timestamp v) { setField(79, v); }
  @$pb.TagNumber(79)
  $core.bool hasDisclosureDate() => $_has(75);
  @$pb.TagNumber(79)
  void clearDisclosureDate() => clearField(79);
  @$pb.TagNumber(79)
  $1775.Timestamp ensureDisclosureDate() => $_ensure(75);
  ...
  @$pb.TagNumber(124)
  $4872.Price get autoPricingMinPrice => $_getN(86);
  @$pb.TagNumber(124)
  set autoPricingMinPrice($4872.Price v) { setField(124, v); }
  @$pb.TagNumber(124)
  $core.bool hasAutoPricingMinPrice() => $_has(86);
  @$pb.TagNumber(124)
  void clearAutoPricingMinPrice() => clearField(124);
  @$pb.TagNumber(124)
  $4872.Price ensureAutoPricingMinPrice() => $_ensure(86);
...
class SubscriptionCost extends $pb.GeneratedMessage {
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(_omitMessageNames ? '' : 'SubscriptionCost', package: const $pb.PackageName(_omitMessageNames ? '' : 'google.shopping.merchant.products.v1beta'), createEmptyInstance: create)
    ...
    ..aOM<$4872.Price>(3, _omitFieldNames ? '' : 'amount', subBuilder: $4872.Price.create)
    ..hasRequiredFields = false
  ;
  ...
  @$pb.TagNumber(3)
  $4872.Price get amount => $_getN(2);
  @$pb.TagNumber(3)
  set amount($4872.Price v) { setField(3, v); }
  @$pb.TagNumber(3)
  $core.bool hasAmount() => $_has(2);
  @$pb.TagNumber(3)
  void clearAmount() => clearField(3);
  @$pb.TagNumber(3)
  $4872.Price ensureAmount() => $_ensure(2);
}
...
class Installment extends $pb.GeneratedMessage {
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(_omitMessageNames ? '' : 'Installment', package: const $pb.PackageName(_omitMessageNames ? '' : 'google.shopping.merchant.products.v1beta'), createEmptyInstance: create)
    ...
    ..aOM<$4872.Price>(2, _omitFieldNames ? '' : 'amount', subBuilder: $4872.Price.create)
    ..aOM<$4872.Price>(3, _omitFieldNames ? '' : 'downpayment', subBuilder: $4872.Price.create)
  ...
  @$pb.TagNumber(2)
  $4872.Price get amount => $_getN(1);
  @$pb.TagNumber(2)
  set amount($4872.Price v) { setField(2, v); }
  @$pb.TagNumber(2)
  $core.bool hasAmount() => $_has(1);
  @$pb.TagNumber(2)
  void clearAmount() => clearField(2);
  @$pb.TagNumber(2)
  $4872.Price ensureAmount() => $_ensure(1);

  /// The up-front down payment amount the buyer has to pay.
  @$pb.TagNumber(3)
  $4872.Price get downpayment => $_getN(2);
  @$pb.TagNumber(3)
  set downpayment($4872.Price v) { setField(3, v); }
  @$pb.TagNumber(3)
  $core.bool hasDownpayment() => $_has(2);
  @$pb.TagNumber(3)
  void clearDownpayment() => clearField(3);
  @$pb.TagNumber(3)
  $4872.Price ensureDownpayment() => $_ensure(2);
...
class LoyaltyProgram extends $pb.GeneratedMessage {
  factory LoyaltyProgram({
    ...
    $4872.Price? price,
    $4872.Price? cashbackForFutureUse,
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(_omitMessageNames ? '' : 'LoyaltyProgram', package: const $pb.PackageName(_omitMessageNames ? '' : 'google.shopping.merchant.products.v1beta'), createEmptyInstance: create)
    ...
    ..aOM<$4872.Price>(3, _omitFieldNames ? '' : 'price', subBuilder: $4872.Price.create)
    ..aOM<$4872.Price>(4, _omitFieldNames ? '' : 'cashbackForFutureUse', subBuilder: $4872.Price.create)
  ...
  @$pb.TagNumber(3)
  $4872.Price get price => $_getN(2);
  @$pb.TagNumber(3)
  set price($4872.Price v) { setField(3, v); }
  @$pb.TagNumber(3)
  $core.bool hasPrice() => $_has(2);
  @$pb.TagNumber(3)
  void clearPrice() => clearField(3);
  @$pb.TagNumber(3)
  $4872.Price ensurePrice() => $_ensure(2);

  /// The cashback that can be used for future purchases.
  @$pb.TagNumber(4)
  $4872.Price get cashbackForFutureUse => $_getN(3);
  @$pb.TagNumber(4)
  set cashbackForFutureUse($4872.Price v) { setField(4, v); }
  @$pb.TagNumber(4)
  $core.bool hasCashbackForFutureUse() => $_has(3);
  @$pb.TagNumber(4)
  void clearCashbackForFutureUse() => clearField(4);
  @$pb.TagNumber(4)
  $4872.Price ensureCashbackForFutureUse() => $_ensure(3);
...
class Shipping extends $pb.GeneratedMessage {
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(_omitMessageNames ? '' : 'Shipping', package: const $pb.PackageName(_omitMessageNames ? '' : 'google.shopping.merchant.products.v1beta'), createEmptyInstance: create)
    ..aOM<$4872.Price>(1, _omitFieldNames ? '' : 'price', subBuilder: $4872.Price.create)
    ..aOS(2, _omitFieldNames ? '' : 'country')
    ..aOS(3, _omitFieldNames ? '' : 'region')
  ...
  @$pb.TagNumber(1)
  $4872.Price get price => $_getN(0);
  @$pb.TagNumber(1)
  set price($4872.Price v) { setField(1, v); }
  @$pb.TagNumber(1)
  $core.bool hasPrice() => $_has(0);
  @$pb.TagNumber(1)
  void clearPrice() => clearField(1);
  @$pb.TagNumber(1)
  $4872.Price ensurePrice() => $_ensure(0);
...
class FreeShippingThreshold extends $pb.GeneratedMessage {
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(_omitMessageNames ? '' : 'FreeShippingThreshold', package: const $pb.PackageName(_omitMessageNames ? '' : 'google.shopping.merchant.products.v1beta'), createEmptyInstance: create)
    ...
    ..aOM<$4872.Price>(2, _omitFieldNames ? '' : 'priceThreshold', subBuilder: $4872.Price.create)
    ..hasRequiredFields = false
  ;
  ...
  /// as a number.
  @$pb.TagNumber(2)
  $4872.Price get priceThreshold => $_getN(1);
  @$pb.TagNumber(2)
  set priceThreshold($4872.Price v) { setField(2, v); }
  @$pb.TagNumber(2)
  $core.bool hasPriceThreshold() => $_has(1);
  @$pb.TagNumber(2)
  void clearPriceThreshold() => clearField(2);
  @$pb.TagNumber(2)
  $4872.Price ensurePriceThreshold() => $_ensure(1);
}
...
class ProductStatus_DestinationStatus extends $pb.GeneratedMessage {
  factory ProductStatus_DestinationStatus({
    $4872.ReportingContext_ReportingContextEnum? reportingContext,
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(_omitMessageNames ? '' : 'ProductStatus.DestinationStatus', package: const $pb.PackageName(_omitMessageNames ? '' : 'google.shopping.merchant.products.v1beta'), createEmptyInstance: create)
    ..e<$4872.ReportingContext_ReportingContextEnum>(1, _omitFieldNames ? '' : 'reportingContext', $pb.PbFieldType.OE, defaultOrMaker: $4872.ReportingContext_ReportingContextEnum.REPORTING_CONTEXT_ENUM_UNSPECIFIED, valueOf: $4872.ReportingContext_ReportingContextEnum.valueOf, enumValues: $4872.ReportingContext_ReportingContextEnum.values)
  ...
  @$pb.TagNumber(1)
  $4872.ReportingContext_ReportingContextEnum get reportingContext => $_getN(0);
  @$pb.TagNumber(1)
  set reportingContext($4872.ReportingContext_ReportingContextEnum v) { setField(1, v); }
  @$pb.TagNumber(1)
...
class ProductStatus_ItemLevelIssue extends $pb.GeneratedMessage {
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(_omitMessageNames ? '' : 'ProductStatus.ItemLevelIssue', package: const $pb.PackageName(_omitMessageNames ? '' : 'google.shopping.merchant.products.v1beta'), createEmptyInstance: create)
    ...
    ..e<$4872.ReportingContext_ReportingContextEnum>(5, _omitFieldNames ? '' : 'reportingContext', $pb.PbFieldType.OE, defaultOrMaker: $4872.ReportingContext_ReportingContextEnum.REPORTING_CONTEXT_ENUM_UNSPECIFIED, valueOf: $4872.ReportingContext_ReportingContextEnum.valueOf, enumValues: $4872.ReportingContext_ReportingContextEnum.values)
  ...
  @$pb.TagNumber(5)
  $4872.ReportingContext_ReportingContextEnum get reportingContext => $_getN(4);
  @$pb.TagNumber(5)
  set reportingContext($4872.ReportingContext_ReportingContextEnum v) { setField(5, v); }
  @$pb.TagNumber(5)
...
class ProductStatus extends $pb.GeneratedMessage {
  factory ProductStatus({
    ...
    $1775.Timestamp? creationDate,
    $1775.Timestamp? lastUpdateDate,
    $1775.Timestamp? googleExpirationDate,
  }) {
    final $result = create();
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(_omitMessageNames ? '' : 'ProductStatus', package: const $pb.PackageName(_omitMessageNames ? '' : 'google.shopping.merchant.products.v1beta'), createEmptyInstance: create)
    ...
    ..aOM<$1775.Timestamp>(5, _omitFieldNames ? '' : 'creationDate', subBuilder: $1775.Timestamp.create)
    ..aOM<$1775.Timestamp>(6, _omitFieldNames ? '' : 'lastUpdateDate', subBuilder: $1775.Timestamp.create)
    ..aOM<$1775.Timestamp>(7, _omitFieldNames ? '' : 'googleExpirationDate', subBuilder: $1775.Timestamp.create)
    ..hasRequiredFields = false
  ;
  ...
  /// 8601](http://en.wikipedia.org/wiki/ISO_8601) format.
  @$pb.TagNumber(5)
  $1775.Timestamp get creationDate => $_getN(2);
  @$pb.TagNumber(5)
  set creationDate($1775.Timestamp v) { setField(5, v); }
  @$pb.TagNumber(5)
  $core.bool hasCreationDate() => $_has(2);
  @$pb.TagNumber(5)
  void clearCreationDate() => clearField(5);
  @$pb.TagNumber(5)
  $1775.Timestamp ensureCreationDate() => $_ensure(2);

  /// Date on which the item has been last updated, in [ISO
  /// 8601](http://en.wikipedia.org/wiki/ISO_8601) format.
  @$pb.TagNumber(6)
  $1775.Timestamp get lastUpdateDate => $_getN(3);
  @$pb.TagNumber(6)
  set lastUpdateDate($1775.Timestamp v) { setField(6, v); }
  @$pb.TagNumber(6)
  $core.bool hasLastUpdateDate() => $_has(3);
  @$pb.TagNumber(6)
  void clearLastUpdateDate() => clearField(6);
  @$pb.TagNumber(6)
  $1775.Timestamp ensureLastUpdateDate() => $_ensure(3);

  /// Date on which the item expires, in [ISO
  /// 8601](http://en.wikipedia.org/wiki/ISO_8601) format.
  @$pb.TagNumber(7)
  $1775.Timestamp get googleExpirationDate => $_getN(4);
  @$pb.TagNumber(7)
  set googleExpirationDate($1775.Timestamp v) { setField(7, v); }
  @$pb.TagNumber(7)
  $core.bool hasGoogleExpirationDate() => $_has(4);
  @$pb.TagNumber(7)
  void clearGoogleExpirationDate() => clearField(7);
  @$pb.TagNumber(7)
  $1775.Timestamp ensureGoogleExpirationDate() => $_ensure(4);
}
