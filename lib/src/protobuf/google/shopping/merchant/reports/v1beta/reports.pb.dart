...
class ProductPerformanceView extends $pb.GeneratedMessage {
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(_omitMessageNames ? '' : 'ProductPerformanceView', package: const $pb.PackageName(_omitMessageNames ? '' : 'google.shopping.merchant.reports.v1beta'), createEmptyInstance: create)
    ...
    ..aOM<$1800.Date>(2, _omitFieldNames ? '' : 'date', subBuilder: $1800.Date.create)
    ..aOM<$1800.Date>(3, _omitFieldNames ? '' : 'week', subBuilder: $1800.Date.create)
    ...
    ..aOM<$4872.Price>(27, _omitFieldNames ? '' : 'conversionValue', subBuilder: $4872.Price.create)
  ...
  @$pb.TagNumber(2)
  $1800.Date get date => $_getN(1);
  @$pb.TagNumber(2)
  set date($1800.Date v) { setField(2, v); }
  @$pb.TagNumber(2)
  $core.bool hasDate() => $_has(1);
  @$pb.TagNumber(2)
  void clearDate() => clearField(2);
  @$pb.TagNumber(2)
  $1800.Date ensureDate() => $_ensure(1);

  /// First day of the week (Monday) of the metrics date in the merchant
  /// timezone. Segment.
  @$pb.TagNumber(3)
  $1800.Date get week => $_getN(2);
  @$pb.TagNumber(3)
  set week($1800.Date v) { setField(3, v); }
  @$pb.TagNumber(3)
  $core.bool hasWeek() => $_has(2);
  @$pb.TagNumber(3)
  void clearWeek() => clearField(3);
  @$pb.TagNumber(3)
  $1800.Date ensureWeek() => $_ensure(2);
  ...
  ///  Available only for the `FREE` traffic source.
  @$pb.TagNumber(27)
  $4872.Price get conversionValue => $_getN(26);
  @$pb.TagNumber(27)
  set conversionValue($4872.Price v) { setField(27, v); }
  @$pb.TagNumber(27)
  $core.bool hasConversionValue() => $_has(26);
  @$pb.TagNumber(27)
  void clearConversionValue() => clearField(27);
  @$pb.TagNumber(27)
  $4872.Price ensureConversionValue() => $_ensure(26);
...
class ProductView extends $pb.GeneratedMessage {
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(_omitMessageNames ? '' : 'ProductView', package: const $pb.PackageName(_omitMessageNames ? '' : 'google.shopping.merchant.reports.v1beta'), createEmptyInstance: create)
    ...
    ..aOM<$4872.Price>(17, _omitFieldNames ? '' : 'price', subBuilder: $4872.Price.create)
    ...
    ..aOM<$1775.Timestamp>(24, _omitFieldNames ? '' : 'creationTime', subBuilder: $1775.Timestamp.create)
    ..aOM<$1800.Date>(25, _omitFieldNames ? '' : 'expirationDate', subBuilder: $1800.Date.create)
    ...
    ..e<$4872.Channel_ChannelEnum>(28, _omitFieldNames ? '' : 'channel', $pb.PbFieldType.OE, defaultOrMaker: $4872.Channel_ChannelEnum.CHANNEL_ENUM_UNSPECIFIED, valueOf: $4872.Channel_ChannelEnum.valueOf, enumValues: $4872.Channel_ChannelEnum.values)
  ...
  /// not available.
  @$pb.TagNumber(17)
  $4872.Price get price => $_getN(16);
  @$pb.TagNumber(17)
  set price($4872.Price v) { setField(17, v); }
  @$pb.TagNumber(17)
  $core.bool hasPrice() => $_has(16);
  @$pb.TagNumber(17)
  void clearPrice() => clearField(17);
  @$pb.TagNumber(17)
  $4872.Price ensurePrice() => $_ensure(16);
  ...
  @$pb.TagNumber(24)
  $1775.Timestamp get creationTime => $_getN(23);
  @$pb.TagNumber(24)
  set creationTime($1775.Timestamp v) { setField(24, v); }
  @$pb.TagNumber(24)
  $core.bool hasCreationTime() => $_has(23);
  @$pb.TagNumber(24)
  void clearCreationTime() => clearField(24);
  @$pb.TagNumber(24)
  $1775.Timestamp ensureCreationTime() => $_ensure(23);

  /// Expiration date for the product, specified on insertion.
  @$pb.TagNumber(25)
  $1800.Date get expirationDate => $_getN(24);
  @$pb.TagNumber(25)
  set expirationDate($1800.Date v) { setField(25, v); }
  @$pb.TagNumber(25)
  $core.bool hasExpirationDate() => $_has(24);
  @$pb.TagNumber(25)
  void clearExpirationDate() => clearField(25);
  @$pb.TagNumber(25)
  $1800.Date ensureExpirationDate() => $_ensure(24);
  ...
  @$pb.TagNumber(28)
  $4872.Channel_ChannelEnum get channel => $_getN(27);
  @$pb.TagNumber(28)
  set channel($4872.Channel_ChannelEnum v) { setField(28, v); }
  @$pb.TagNumber(28)
...
class PriceCompetitivenessProductView extends $pb.GeneratedMessage {
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(_omitMessageNames ? '' : 'PriceCompetitivenessProductView', package: const $pb.PackageName(_omitMessageNames ? '' : 'google.shopping.merchant.reports.v1beta'), createEmptyInstance: create)
    ...
    ..aOM<$4872.Price>(16, _omitFieldNames ? '' : 'price', subBuilder: $4872.Price.create)
    ..aOM<$4872.Price>(17, _omitFieldNames ? '' : 'benchmarkPrice', subBuilder: $4872.Price.create)
    ..hasRequiredFields = false
  ;
  ...
  @$pb.TagNumber(16)
  $4872.Price get price => $_getN(15);
  @$pb.TagNumber(16)
  set price($4872.Price v) { setField(16, v); }
  @$pb.TagNumber(16)
  $core.bool hasPrice() => $_has(15);
  @$pb.TagNumber(16)
  void clearPrice() => clearField(16);
  @$pb.TagNumber(16)
  $4872.Price ensurePrice() => $_ensure(15);

  /// Latest available price benchmark for the product's catalog in the benchmark
  /// country.
  @$pb.TagNumber(17)
  $4872.Price get benchmarkPrice => $_getN(16);
  @$pb.TagNumber(17)
  set benchmarkPrice($4872.Price v) { setField(17, v); }
  @$pb.TagNumber(17)
  $core.bool hasBenchmarkPrice() => $_has(16);
  @$pb.TagNumber(17)
  void clearBenchmarkPrice() => clearField(17);
  @$pb.TagNumber(17)
  $4872.Price ensureBenchmarkPrice() => $_ensure(16);
}
...
class PriceInsightsProductView extends $pb.GeneratedMessage {
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(_omitMessageNames ? '' : 'PriceInsightsProductView', package: const $pb.PackageName(_omitMessageNames ? '' : 'google.shopping.merchant.reports.v1beta'), createEmptyInstance: create)
    ...
    ..aOM<$4872.Price>(15, _omitFieldNames ? '' : 'price', subBuilder: $4872.Price.create)
    ..aOM<$4872.Price>(16, _omitFieldNames ? '' : 'suggestedPrice', subBuilder: $4872.Price.create)
  ...
  /// Current price of the product.
  @$pb.TagNumber(15)
  $4872.Price get price => $_getN(14);
  @$pb.TagNumber(15)
  set price($4872.Price v) { setField(15, v); }
  @$pb.TagNumber(15)
  $core.bool hasPrice() => $_has(14);
  @$pb.TagNumber(15)
  void clearPrice() => clearField(15);
  @$pb.TagNumber(15)
  $4872.Price ensurePrice() => $_ensure(14);

  /// Latest suggested price for the product.
  @$pb.TagNumber(16)
  $4872.Price get suggestedPrice => $_getN(15);
  @$pb.TagNumber(16)
  set suggestedPrice($4872.Price v) { setField(16, v); }
  @$pb.TagNumber(16)
  $core.bool hasSuggestedPrice() => $_has(15);
  @$pb.TagNumber(16)
  void clearSuggestedPrice() => clearField(16);
  @$pb.TagNumber(16)
  $4872.Price ensureSuggestedPrice() => $_ensure(15);
...
class BestSellersProductClusterView extends $pb.GeneratedMessage {
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(_omitMessageNames ? '' : 'BestSellersProductClusterView', package: const $pb.PackageName(_omitMessageNames ? '' : 'google.shopping.merchant.reports.v1beta'), createEmptyInstance: create)
    ..aOM<$1800.Date>(1, _omitFieldNames ? '' : 'reportDate', subBuilder: $1800.Date.create)
  ...
  ///  is returned.
  @$pb.TagNumber(1)
  $1800.Date get reportDate => $_getN(0);
  @$pb.TagNumber(1)
  set reportDate($1800.Date v) { setField(1, v); }
  @$pb.TagNumber(1)
  $core.bool hasReportDate() => $_has(0);
  @$pb.TagNumber(1)
  void clearReportDate() => clearField(1);
  @$pb.TagNumber(1)
  $1800.Date ensureReportDate() => $_ensure(0);
...
class NonProductPerformanceView extends $pb.GeneratedMessage {
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(_omitMessageNames ? '' : 'NonProductPerformanceView', package: const $pb.PackageName(_omitMessageNames ? '' : 'google.shopping.merchant.reports.v1beta'), createEmptyInstance: create)
    ...
    ..aOM<$1800.Date>(2, _omitFieldNames ? '' : 'week', subBuilder: $1800.Date.create)
  ...
  /// timezone. Segment.
  @$pb.TagNumber(2)
  $1800.Date get week => $_getN(1);
  @$pb.TagNumber(2)
  set week($1800.Date v) { setField(2, v); }
  @$pb.TagNumber(2)
  $core.bool hasWeek() => $_has(1);
  @$pb.TagNumber(2)
  void clearWeek() => clearField(2);
  @$pb.TagNumber(2)
  $1800.Date ensureWeek() => $_ensure(1);
