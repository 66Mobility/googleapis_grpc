...
class ProductPerformanceView extends $pb.GeneratedMessage {
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(_omitMessageNames ? '' : 'ProductPerformanceView', package: const $pb.PackageName(_omitMessageNames ? '' : 'google.shopping.merchant.reports.v1beta'), createEmptyInstance: create)
    ...
    ..aOM<$528.Price>(27, _omitFieldNames ? '' : 'conversionValue', subBuilder: $528.Price.create)
  ...
  ///  Available only for the `FREE` traffic source.
  @$pb.TagNumber(27)
  $528.Price get conversionValue => $_getN(26);
  @$pb.TagNumber(27)
  set conversionValue($528.Price v) { setField(27, v); }
  @$pb.TagNumber(27)
  $core.bool hasConversionValue() => $_has(26);
  @$pb.TagNumber(27)
  void clearConversionValue() => clearField(27);
  @$pb.TagNumber(27)
  $528.Price ensureConversionValue() => $_ensure(26);
...
class ProductView extends $pb.GeneratedMessage {
  factory ProductView({
    ...
    $528.Channel_ChannelEnum? channel,
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(_omitMessageNames ? '' : 'ProductView', package: const $pb.PackageName(_omitMessageNames ? '' : 'google.shopping.merchant.reports.v1beta'), createEmptyInstance: create)
    ...
    ..aOM<$528.Price>(17, _omitFieldNames ? '' : 'price', subBuilder: $528.Price.create)
    ...
    ..e<$528.Channel_ChannelEnum>(28, _omitFieldNames ? '' : 'channel', $pb.PbFieldType.OE, defaultOrMaker: $528.Channel_ChannelEnum.CHANNEL_ENUM_UNSPECIFIED, valueOf: $528.Channel_ChannelEnum.valueOf, enumValues: $528.Channel_ChannelEnum.values)
  ...
  /// not available.
  @$pb.TagNumber(17)
  $528.Price get price => $_getN(16);
  @$pb.TagNumber(17)
  set price($528.Price v) { setField(17, v); }
  @$pb.TagNumber(17)
  $core.bool hasPrice() => $_has(16);
  @$pb.TagNumber(17)
  void clearPrice() => clearField(17);
  @$pb.TagNumber(17)
  $528.Price ensurePrice() => $_ensure(16);
  ...
  @$pb.TagNumber(28)
  $528.Channel_ChannelEnum get channel => $_getN(27);
  @$pb.TagNumber(28)
  set channel($528.Channel_ChannelEnum v) { setField(28, v); }
  @$pb.TagNumber(28)
...
class PriceCompetitivenessProductView extends $pb.GeneratedMessage {
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(_omitMessageNames ? '' : 'PriceCompetitivenessProductView', package: const $pb.PackageName(_omitMessageNames ? '' : 'google.shopping.merchant.reports.v1beta'), createEmptyInstance: create)
    ...
    ..aOM<$528.Price>(16, _omitFieldNames ? '' : 'price', subBuilder: $528.Price.create)
    ..aOM<$528.Price>(17, _omitFieldNames ? '' : 'benchmarkPrice', subBuilder: $528.Price.create)
    ..hasRequiredFields = false
  ;
  ...
  @$pb.TagNumber(16)
  $528.Price get price => $_getN(15);
  @$pb.TagNumber(16)
  set price($528.Price v) { setField(16, v); }
  @$pb.TagNumber(16)
  $core.bool hasPrice() => $_has(15);
  @$pb.TagNumber(16)
  void clearPrice() => clearField(16);
  @$pb.TagNumber(16)
  $528.Price ensurePrice() => $_ensure(15);

  /// Latest available price benchmark for the product's catalog in the benchmark
  /// country.
  @$pb.TagNumber(17)
  $528.Price get benchmarkPrice => $_getN(16);
  @$pb.TagNumber(17)
  set benchmarkPrice($528.Price v) { setField(17, v); }
  @$pb.TagNumber(17)
  $core.bool hasBenchmarkPrice() => $_has(16);
  @$pb.TagNumber(17)
  void clearBenchmarkPrice() => clearField(17);
  @$pb.TagNumber(17)
  $528.Price ensureBenchmarkPrice() => $_ensure(16);
}
...
class PriceInsightsProductView extends $pb.GeneratedMessage {
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(_omitMessageNames ? '' : 'PriceInsightsProductView', package: const $pb.PackageName(_omitMessageNames ? '' : 'google.shopping.merchant.reports.v1beta'), createEmptyInstance: create)
    ...
    ..aOM<$528.Price>(15, _omitFieldNames ? '' : 'price', subBuilder: $528.Price.create)
    ..aOM<$528.Price>(16, _omitFieldNames ? '' : 'suggestedPrice', subBuilder: $528.Price.create)
  ...
  /// Current price of the product.
  @$pb.TagNumber(15)
  $528.Price get price => $_getN(14);
  @$pb.TagNumber(15)
  set price($528.Price v) { setField(15, v); }
  @$pb.TagNumber(15)
  $core.bool hasPrice() => $_has(14);
  @$pb.TagNumber(15)
  void clearPrice() => clearField(15);
  @$pb.TagNumber(15)
  $528.Price ensurePrice() => $_ensure(14);

  /// Latest suggested price for the product.
  @$pb.TagNumber(16)
  $528.Price get suggestedPrice => $_getN(15);
  @$pb.TagNumber(16)
  set suggestedPrice($528.Price v) { setField(16, v); }
  @$pb.TagNumber(16)
  $core.bool hasSuggestedPrice() => $_has(15);
  @$pb.TagNumber(16)
  void clearSuggestedPrice() => clearField(16);
  @$pb.TagNumber(16)
  $528.Price ensureSuggestedPrice() => $_ensure(15);
