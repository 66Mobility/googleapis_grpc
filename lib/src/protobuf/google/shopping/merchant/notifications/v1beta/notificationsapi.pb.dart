...
class ProductChange extends $pb.GeneratedMessage {
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(_omitMessageNames ? '' : 'ProductChange', package: const $pb.PackageName(_omitMessageNames ? '' : 'google.shopping.merchant.notifications.v1beta'), createEmptyInstance: create)
    ...
    ..e<$4872.ReportingContext_ReportingContextEnum>(4, _omitFieldNames ? '' : 'reportingContext', $pb.PbFieldType.OE, defaultOrMaker: $4872.ReportingContext_ReportingContextEnum.REPORTING_CONTEXT_ENUM_UNSPECIFIED, valueOf: $4872.ReportingContext_ReportingContextEnum.valueOf, enumValues: $4872.ReportingContext_ReportingContextEnum.values)
    ..hasRequiredFields = false
  ;
  ...
  @$pb.TagNumber(4)
  $4872.ReportingContext_ReportingContextEnum get reportingContext => $_getN(3);
  @$pb.TagNumber(4)
  set reportingContext($4872.ReportingContext_ReportingContextEnum v) { setField(4, v); }
  @$pb.TagNumber(4)
