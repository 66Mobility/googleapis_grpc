...
class Attributes extends $pb.GeneratedMessage {
  factory Attributes({
    ...
    $core.Iterable<$4872.Destination_DestinationEnum>? promotionDestinations,
    ...
    $4872.Price? minimumPurchaseAmount,
    $fixnum.Int64? minimumPurchaseQuantity,
    $fixnum.Int64? limitQuantity,
    $4872.Price? limitValue,
    $fixnum.Int64? percentOff,
    $4872.Price? moneyOffAmount,
    $fixnum.Int64? getThisQuantityDiscounted,
    $4872.Price? freeGiftValue,
    $core.String? freeGiftDescription,
    $core.String? freeGiftItemId,
    $4256.Interval? promotionEffectiveTimePeriod,
    $4256.Interval? promotionDisplayTimePeriod,
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(_omitMessageNames ? '' : 'Attributes', package: const $pb.PackageName(_omitMessageNames ? '' : 'google.shopping.merchant.promotions.v1beta'), createEmptyInstance: create)
    ...
    ..pc<$4872.Destination_DestinationEnum>(6, _omitFieldNames ? '' : 'promotionDestinations', $pb.PbFieldType.KE, valueOf: $4872.Destination_DestinationEnum.valueOf, enumValues: $4872.Destination_DestinationEnum.values, defaultEnumValue: $4872.Destination_DestinationEnum.DESTINATION_ENUM_UNSPECIFIED)
    ...
    ..aOM<$4872.Price>(15, _omitFieldNames ? '' : 'minimumPurchaseAmount', subBuilder: $4872.Price.create)
    ..aInt64(16, _omitFieldNames ? '' : 'minimumPurchaseQuantity')
    ..aInt64(17, _omitFieldNames ? '' : 'limitQuantity')
    ..aOM<$4872.Price>(18, _omitFieldNames ? '' : 'limitValue', subBuilder: $4872.Price.create)
    ..aInt64(19, _omitFieldNames ? '' : 'percentOff')
    ..aOM<$4872.Price>(20, _omitFieldNames ? '' : 'moneyOffAmount', subBuilder: $4872.Price.create)
    ..aInt64(21, _omitFieldNames ? '' : 'getThisQuantityDiscounted')
    ..aOM<$4872.Price>(22, _omitFieldNames ? '' : 'freeGiftValue', subBuilder: $4872.Price.create)
    ..aOS(23, _omitFieldNames ? '' : 'freeGiftDescription')
    ..aOS(24, _omitFieldNames ? '' : 'freeGiftItemId')
    ..aOM<$4256.Interval>(25, _omitFieldNames ? '' : 'promotionEffectiveTimePeriod', subBuilder: $4256.Interval.create)
    ..aOM<$4256.Interval>(26, _omitFieldNames ? '' : 'promotionDisplayTimePeriod', subBuilder: $4256.Interval.create)
  ...
  @$pb.TagNumber(6)
  $core.List<$4872.Destination_DestinationEnum> get promotionDestinations => $_getList(5);
  ...
  /// for the promotion.
  @$pb.TagNumber(15)
  $4872.Price get minimumPurchaseAmount => $_getN(14);
  @$pb.TagNumber(15)
  set minimumPurchaseAmount($4872.Price v) { setField(15, v); }
  @$pb.TagNumber(15)
  $core.bool hasMinimumPurchaseAmount() => $_has(14);
  @$pb.TagNumber(15)
  void clearMinimumPurchaseAmount() => clearField(15);
  @$pb.TagNumber(15)
  $4872.Price ensureMinimumPurchaseAmount() => $_ensure(14);
  ...
  /// promotion.
  @$pb.TagNumber(18)
  $4872.Price get limitValue => $_getN(17);
  @$pb.TagNumber(18)
  set limitValue($4872.Price v) { setField(18, v); }
  @$pb.TagNumber(18)
  $core.bool hasLimitValue() => $_has(17);
  @$pb.TagNumber(18)
  void clearLimitValue() => clearField(18);
  @$pb.TagNumber(18)
  $4872.Price ensureLimitValue() => $_ensure(17);
  ...
  /// offered in the promotion.
  @$pb.TagNumber(20)
  $4872.Price get moneyOffAmount => $_getN(19);
  @$pb.TagNumber(20)
  set moneyOffAmount($4872.Price v) { setField(20, v); }
  @$pb.TagNumber(20)
  $core.bool hasMoneyOffAmount() => $_has(19);
  @$pb.TagNumber(20)
  void clearMoneyOffAmount() => clearField(20);
  @$pb.TagNumber(20)
  $4872.Price ensureMoneyOffAmount() => $_ensure(19);
  ...
  /// for the promotion.
  @$pb.TagNumber(22)
  $4872.Price get freeGiftValue => $_getN(21);
  @$pb.TagNumber(22)
  set freeGiftValue($4872.Price v) { setField(22, v); }
  @$pb.TagNumber(22)
  $core.bool hasFreeGiftValue() => $_has(21);
  @$pb.TagNumber(22)
  void clearFreeGiftValue() => clearField(22);
  @$pb.TagNumber(22)
  $4872.Price ensureFreeGiftValue() => $_ensure(21);
  ...
  @$pb.TagNumber(25)
  $4256.Interval get promotionEffectiveTimePeriod => $_getN(24);
  @$pb.TagNumber(25)
  set promotionEffectiveTimePeriod($4256.Interval v) { setField(25, v); }
  @$pb.TagNumber(25)
  $core.bool hasPromotionEffectiveTimePeriod() => $_has(24);
  @$pb.TagNumber(25)
  void clearPromotionEffectiveTimePeriod() => clearField(25);
  @$pb.TagNumber(25)
  $4256.Interval ensurePromotionEffectiveTimePeriod() => $_ensure(24);
  ...
  @$pb.TagNumber(26)
  $4256.Interval get promotionDisplayTimePeriod => $_getN(25);
  @$pb.TagNumber(26)
  set promotionDisplayTimePeriod($4256.Interval v) { setField(26, v); }
  @$pb.TagNumber(26)
  $core.bool hasPromotionDisplayTimePeriod() => $_has(25);
  @$pb.TagNumber(26)
  void clearPromotionDisplayTimePeriod() => clearField(26);
  @$pb.TagNumber(26)
  $4256.Interval ensurePromotionDisplayTimePeriod() => $_ensure(25);
...
class PromotionStatus extends $pb.GeneratedMessage {
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(_omitMessageNames ? '' : 'PromotionStatus', package: const $pb.PackageName(_omitMessageNames ? '' : 'google.shopping.merchant.promotions.v1beta'), createEmptyInstance: create)
    ...
    ..aOM<$1775.Timestamp>(3, _omitFieldNames ? '' : 'creationDate', subBuilder: $1775.Timestamp.create)
    ..aOM<$1775.Timestamp>(4, _omitFieldNames ? '' : 'lastUpdateDate', subBuilder: $1775.Timestamp.create)
    ..hasRequiredFields = false
  ;
  ...
  @$pb.TagNumber(3)
  set creationDate($1775.Timestamp v) { setField(3, v); }
  @$pb.TagNumber(3)
  ...
  @$pb.TagNumber(4)
  set lastUpdateDate($1775.Timestamp v) { setField(4, v); }
  @$pb.TagNumber(4)
