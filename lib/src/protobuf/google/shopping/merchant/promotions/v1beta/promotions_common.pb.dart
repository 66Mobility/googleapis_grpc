...
class Attributes extends $pb.GeneratedMessage {
  factory Attributes({
    ...
    $core.Iterable<$569.Destination_DestinationEnum>? promotionDestinations,
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(
    ...
    ..pc<$569.Destination_DestinationEnum>(
        6, _omitFieldNames ? '' : 'promotionDestinations', $pb.PbFieldType.KE,
        valueOf: $569.Destination_DestinationEnum.valueOf,
        enumValues: $569.Destination_DestinationEnum.values,
        defaultEnumValue:
            $569.Destination_DestinationEnum.DESTINATION_ENUM_UNSPECIFIED)
  ...
  @$pb.TagNumber(6)
  $core.List<$569.Destination_DestinationEnum> get promotionDestinations =>
      $_getList(5);
  ...
  /// for the promotion.
  @$pb.TagNumber(15)
  $569.Price get minimumPurchaseAmount => $_getN(14);
  @$pb.TagNumber(15)
  set minimumPurchaseAmount($569.Price v) {
    setField(15, v);
  }
  ...
  @$pb.TagNumber(15)
  $569.Price ensureMinimumPurchaseAmount() => $_ensure(14);
  ...
  /// promotion.
  @$pb.TagNumber(18)
  $569.Price get limitValue => $_getN(17);
  @$pb.TagNumber(18)
  set limitValue($569.Price v) {
    setField(18, v);
  }
  ...
  @$pb.TagNumber(18)
  $569.Price ensureLimitValue() => $_ensure(17);
  ...
  /// offered in the promotion.
  @$pb.TagNumber(20)
  $569.Price get moneyOffAmount => $_getN(19);
  @$pb.TagNumber(20)
  set moneyOffAmount($569.Price v) {
    setField(20, v);
  }
  ...
  @$pb.TagNumber(20)
  $569.Price ensureMoneyOffAmount() => $_ensure(19);
  ...
  /// for the promotion.
  @$pb.TagNumber(22)
  $569.Price get freeGiftValue => $_getN(21);
  @$pb.TagNumber(22)
  set freeGiftValue($569.Price v) {
    setField(22, v);
  }
  ...
  @$pb.TagNumber(22)
  $569.Price ensureFreeGiftValue() => $_ensure(21);
  ...
  @$pb.TagNumber(25)
  $544.Interval get promotionEffectiveTimePeriod => $_getN(24);
  @$pb.TagNumber(25)
  set promotionEffectiveTimePeriod($544.Interval v) {
    setField(25, v);
  }
  ...
  @$pb.TagNumber(25)
  $544.Interval ensurePromotionEffectiveTimePeriod() => $_ensure(24);
  ...
  @$pb.TagNumber(26)
  $544.Interval get promotionDisplayTimePeriod => $_getN(25);
  @$pb.TagNumber(26)
  set promotionDisplayTimePeriod($544.Interval v) {
    setField(26, v);
  }
  ...
  @$pb.TagNumber(26)
  $544.Interval ensurePromotionDisplayTimePeriod() => $_ensure(25);
...
class PromotionStatus extends $pb.GeneratedMessage {
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(
    ...
    ..aOM<$330.Timestamp>(3, _omitFieldNames ? '' : 'creationDate',
        subBuilder: $330.Timestamp.create)
    ..aOM<$330.Timestamp>(4, _omitFieldNames ? '' : 'lastUpdateDate',
        subBuilder: $330.Timestamp.create)
    ..hasRequiredFields = false;
