...
import 'promotions_common.pb.dart' as $546;
import 'promotions_common.pbenum.dart' as $546;
...
class Promotion extends $pb.GeneratedMessage {
  factory Promotion({
    ...
    $core.Iterable<$546.RedemptionChannel>? redemptionChannel,
    $core.String? dataSource,
    $546.Attributes? attributes,
    $core.Iterable<$535.CustomAttribute>? customAttributes,
    $546.PromotionStatus? promotionStatus,
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(_omitMessageNames ? '' : 'Promotion', package: const $pb.PackageName(_omitMessageNames ? '' : 'google.shopping.merchant.promotions.v1beta'), createEmptyInstance: create)
    ...
    ..pc<$546.RedemptionChannel>(5, _omitFieldNames ? '' : 'redemptionChannel', $pb.PbFieldType.KE, valueOf: $546.RedemptionChannel.valueOf, enumValues: $546.RedemptionChannel.values, defaultEnumValue: $546.RedemptionChannel.REDEMPTION_CHANNEL_UNSPECIFIED)
    ..aOS(6, _omitFieldNames ? '' : 'dataSource')
    ..aOM<$546.Attributes>(7, _omitFieldNames ? '' : 'attributes', subBuilder: $546.Attributes.create)
    ..pc<$535.CustomAttribute>(8, _omitFieldNames ? '' : 'customAttributes', $pb.PbFieldType.PM, subBuilder: $535.CustomAttribute.create)
    ..aOM<$546.PromotionStatus>(9, _omitFieldNames ? '' : 'promotionStatus', subBuilder: $546.PromotionStatus.create)
  ...
  @$pb.TagNumber(5)
  $core.List<$546.RedemptionChannel> get redemptionChannel => $_getList(4);
  ...
  @$pb.TagNumber(7)
  $546.Attributes get attributes => $_getN(6);
  @$pb.TagNumber(7)
  set attributes($546.Attributes v) { setField(7, v); }
  @$pb.TagNumber(7)
  $core.bool hasAttributes() => $_has(6);
  @$pb.TagNumber(7)
  void clearAttributes() => clearField(7);
  @$pb.TagNumber(7)
  $546.Attributes ensureAttributes() => $_ensure(6);
  ...
  /// asynchronously.
  @$pb.TagNumber(9)
  $546.PromotionStatus get promotionStatus => $_getN(8);
  @$pb.TagNumber(9)
  set promotionStatus($546.PromotionStatus v) { setField(9, v); }
  @$pb.TagNumber(9)
  $core.bool hasPromotionStatus() => $_has(8);
  @$pb.TagNumber(9)
  void clearPromotionStatus() => clearField(9);
  @$pb.TagNumber(9)
  $546.PromotionStatus ensurePromotionStatus() => $_ensure(8);
