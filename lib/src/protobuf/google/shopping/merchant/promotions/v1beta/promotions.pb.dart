...
import 'promotions_common.pb.dart' as $4885;
import 'promotions_common.pbenum.dart' as $4885;
...
class Promotion extends $pb.GeneratedMessage {
  factory Promotion({
    ...
    $core.Iterable<$4885.RedemptionChannel>? redemptionChannel,
    $core.String? dataSource,
    $4885.Attributes? attributes,
    $core.Iterable<$4874.CustomAttribute>? customAttributes,
    $4885.PromotionStatus? promotionStatus,
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(_omitMessageNames ? '' : 'Promotion', package: const $pb.PackageName(_omitMessageNames ? '' : 'google.shopping.merchant.promotions.v1beta'), createEmptyInstance: create)
    ...
    ..pc<$4885.RedemptionChannel>(5, _omitFieldNames ? '' : 'redemptionChannel', $pb.PbFieldType.KE, valueOf: $4885.RedemptionChannel.valueOf, enumValues: $4885.RedemptionChannel.values, defaultEnumValue: $4885.RedemptionChannel.REDEMPTION_CHANNEL_UNSPECIFIED)
    ..aOS(6, _omitFieldNames ? '' : 'dataSource')
    ..aOM<$4885.Attributes>(7, _omitFieldNames ? '' : 'attributes', subBuilder: $4885.Attributes.create)
    ..pc<$4874.CustomAttribute>(8, _omitFieldNames ? '' : 'customAttributes', $pb.PbFieldType.PM, subBuilder: $4874.CustomAttribute.create)
    ..aOM<$4885.PromotionStatus>(9, _omitFieldNames ? '' : 'promotionStatus', subBuilder: $4885.PromotionStatus.create)
  ...
  @$pb.TagNumber(5)
  $core.List<$4885.RedemptionChannel> get redemptionChannel => $_getList(4);
  ...
  @$pb.TagNumber(7)
  $4885.Attributes get attributes => $_getN(6);
  @$pb.TagNumber(7)
  set attributes($4885.Attributes v) { setField(7, v); }
  @$pb.TagNumber(7)
  $core.bool hasAttributes() => $_has(6);
  @$pb.TagNumber(7)
  void clearAttributes() => clearField(7);
  @$pb.TagNumber(7)
  $4885.Attributes ensureAttributes() => $_ensure(6);
  ...
  /// API.
  @$pb.TagNumber(8)
  $core.List<$4874.CustomAttribute> get customAttributes => $_getList(7);
  ...
  /// asynchronously.
  @$pb.TagNumber(9)
  $4885.PromotionStatus get promotionStatus => $_getN(8);
  @$pb.TagNumber(9)
  set promotionStatus($4885.PromotionStatus v) { setField(9, v); }
  @$pb.TagNumber(9)
  $core.bool hasPromotionStatus() => $_has(8);
  @$pb.TagNumber(9)
  void clearPromotionStatus() => clearField(9);
  @$pb.TagNumber(9)
  $4885.PromotionStatus ensurePromotionStatus() => $_ensure(8);
