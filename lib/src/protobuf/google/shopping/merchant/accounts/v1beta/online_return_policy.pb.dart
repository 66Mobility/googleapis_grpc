...
class OnlineReturnPolicy_ReturnShippingFee extends $pb.GeneratedMessage {
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(
    ...
    ..aOM<$540.Price>(2, _omitFieldNames ? '' : 'fixedFee',
  ...
  @$pb.TagNumber(2)
  $540.Price get fixedFee => $_getN(1);
  @$pb.TagNumber(2)
  set fixedFee($540.Price v) {
    setField(2, v);
  }
  ...
  @$pb.TagNumber(2)
  $540.Price ensureFixedFee() => $_ensure(1);
}
...
class OnlineReturnPolicy_RestockingFee extends $pb.GeneratedMessage {
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(
      ...
      createEmptyInstance: create)
    ..oo(0, [1, 2])
    ..aOM<$540.Price>(1, _omitFieldNames ? '' : 'fixedFee',
        subBuilder: $540.Price.create)
  ...
  @$pb.TagNumber(1)
  $540.Price get fixedFee => $_getN(0);
  @$pb.TagNumber(1)
  set fixedFee($540.Price v) {
    setField(1, v);
  }
  ...
  @$pb.TagNumber(1)
  $540.Price ensureFixedFee() => $_ensure(0);
