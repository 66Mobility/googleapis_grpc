...
import 'termsofservicekind.pbenum.dart' as $4879;
...
class TermsOfService extends $pb.GeneratedMessage {
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(_omitMessageNames ? '' : 'TermsOfService', package: const $pb.PackageName(_omitMessageNames ? '' : 'google.shopping.merchant.accounts.v1beta'), createEmptyInstance: create)
    ...
    ..e<$4879.TermsOfServiceKind>(3, _omitFieldNames ? '' : 'kind', $pb.PbFieldType.OE, defaultOrMaker: $4879.TermsOfServiceKind.TERMS_OF_SERVICE_KIND_UNSPECIFIED, valueOf: $4879.TermsOfServiceKind.valueOf, enumValues: $4879.TermsOfServiceKind.values)
  ...
  @$pb.TagNumber(3)
  $4879.TermsOfServiceKind get kind => $_getN(2);
  @$pb.TagNumber(3)
  set kind($4879.TermsOfServiceKind v) { setField(3, v); }
  @$pb.TagNumber(3)
...
class RetrieveLatestTermsOfServiceRequest extends $pb.GeneratedMessage {
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(_omitMessageNames ? '' : 'RetrieveLatestTermsOfServiceRequest', package: const $pb.PackageName(_omitMessageNames ? '' : 'google.shopping.merchant.accounts.v1beta'), createEmptyInstance: create)
    ...
    ..e<$4879.TermsOfServiceKind>(2, _omitFieldNames ? '' : 'kind', $pb.PbFieldType.OE, defaultOrMaker: $4879.TermsOfServiceKind.TERMS_OF_SERVICE_KIND_UNSPECIFIED, valueOf: $4879.TermsOfServiceKind.valueOf, enumValues: $4879.TermsOfServiceKind.values)
    ..hasRequiredFields = false
  ;
  ...
  /// The Kind this terms of service version applies to.
  @$pb.TagNumber(2)
  $4879.TermsOfServiceKind get kind => $_getN(1);
  @$pb.TagNumber(2)
  set kind($4879.TermsOfServiceKind v) { setField(2, v); }
  @$pb.TagNumber(2)
