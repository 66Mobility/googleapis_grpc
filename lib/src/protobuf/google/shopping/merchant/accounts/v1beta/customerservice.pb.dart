...
class CustomerService extends $pb.GeneratedMessage {
  ...
  factory CustomerService.fromBuffer($core.List<$core.int> i, [$pb.ExtensionRegistry r = $pb.ExtensionRegistry.EMPTY]) => create()..mergeFromBuffer(i, r);
  factory CustomerService.fromJson($core.String i, [$pb.ExtensionRegistry r = $pb.ExtensionRegistry.EMPTY]) => create()..mergeFromJson(i, r);
  ...
  'Will be removed in next major version')
  CustomerService copyWith(void Function(CustomerService) updates) => super.copyWith((message) => updates(message as CustomerService)) as CustomerService;
  ...
  static $pb.PbList<CustomerService> createRepeated() => $pb.PbList<CustomerService>();
  @$core.pragma('dart2js:noInline')
  static CustomerService getDefault() => _defaultInstance ??= $pb.GeneratedMessage.$_defaultFor<CustomerService>(create);
