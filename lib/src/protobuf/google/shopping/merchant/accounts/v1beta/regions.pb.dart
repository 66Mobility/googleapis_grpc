...
class Region extends $pb.GeneratedMessage {
  factory Region({
    ...
    $1780.BoolValue? regionalInventoryEligible,
    $1780.BoolValue? shippingEligible,
  }) {
    final $result = create();
    if (name != null) {
      $result.name = name;
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(_omitMessageNames ? '' : 'Region', package: const $pb.PackageName(_omitMessageNames ? '' : 'google.shopping.merchant.accounts.v1beta'), createEmptyInstance: create)
    ...
    ..aOM<$1780.BoolValue>(5, _omitFieldNames ? '' : 'regionalInventoryEligible', subBuilder: $1780.BoolValue.create)
    ..aOM<$1780.BoolValue>(6, _omitFieldNames ? '' : 'shippingEligible', subBuilder: $1780.BoolValue.create)
    ..hasRequiredFields = false
  ;
  ...
  @$pb.TagNumber(5)
  $1780.BoolValue get regionalInventoryEligible => $_getN(4);
  @$pb.TagNumber(5)
  set regionalInventoryEligible($1780.BoolValue v) { setField(5, v); }
  @$pb.TagNumber(5)
  $core.bool hasRegionalInventoryEligible() => $_has(4);
  @$pb.TagNumber(5)
  void clearRegionalInventoryEligible() => clearField(5);
  @$pb.TagNumber(5)
  $1780.BoolValue ensureRegionalInventoryEligible() => $_ensure(4);

  /// Output only. Indicates if the region is eligible for use in the Shipping
  /// Services configuration.
  @$pb.TagNumber(6)
  $1780.BoolValue get shippingEligible => $_getN(5);
  @$pb.TagNumber(6)
  set shippingEligible($1780.BoolValue v) { setField(6, v); }
  @$pb.TagNumber(6)
  $core.bool hasShippingEligible() => $_has(5);
  @$pb.TagNumber(6)
  void clearShippingEligible() => clearField(6);
  @$pb.TagNumber(6)
  $1780.BoolValue ensureShippingEligible() => $_ensure(5);
}
