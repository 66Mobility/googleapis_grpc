...
class Region extends $pb.GeneratedMessage {
  factory Region({
    ...
    $335.BoolValue? regionalInventoryEligible,
    $335.BoolValue? shippingEligible,
  }) {
    final $result = create();
    if (name != null) {
      $result.name = name;
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(
    ...
    ..aOM<$335.BoolValue>(5, _omitFieldNames ? '' : 'regionalInventoryEligible',
        subBuilder: $335.BoolValue.create)
    ..aOM<$335.BoolValue>(6, _omitFieldNames ? '' : 'shippingEligible',
        subBuilder: $335.BoolValue.create)
    ..hasRequiredFields = false;
  ...
  @$pb.TagNumber(5)
  $335.BoolValue get regionalInventoryEligible => $_getN(4);
  @$pb.TagNumber(5)
  set regionalInventoryEligible($335.BoolValue v) {
    setField(5, v);
  }
  ...
  @$pb.TagNumber(5)
  $335.BoolValue ensureRegionalInventoryEligible() => $_ensure(4);

  /// Output only. Indicates if the region is eligible for use in the Shipping
  /// Services configuration.
  @$pb.TagNumber(6)
  $335.BoolValue get shippingEligible => $_getN(5);
  @$pb.TagNumber(6)
  set shippingEligible($335.BoolValue v) {
    setField(6, v);
  }
  ...
  @$pb.TagNumber(6)
  $335.BoolValue ensureShippingEligible() => $_ensure(5);
}
