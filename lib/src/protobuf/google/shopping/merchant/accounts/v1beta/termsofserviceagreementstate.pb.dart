...
class TermsOfServiceAgreementState extends $pb.GeneratedMessage {
  factory TermsOfServiceAgreementState({
    ...
    $577.TermsOfServiceKind? termsOfServiceKind,
    Accepted? accepted,
    Required? required,
  }) {
    final $result = create();
  ...
  @$pb.TagNumber(3)
  $577.TermsOfServiceKind get termsOfServiceKind => $_getN(2);
  @$pb.TagNumber(3)
  set termsOfServiceKind($577.TermsOfServiceKind v) {
    setField(3, v);
  }
...
class Accepted extends $pb.GeneratedMessage {
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(
    ...
    ..aOM<$355.Date>(3, _omitFieldNames ? '' : 'validUntil',
  ...
  @$pb.TagNumber(3)
  $355.Date get validUntil => $_getN(2);
  @$pb.TagNumber(3)
  set validUntil($355.Date v) {
    setField(3, v);
  }
  ...
  @$pb.TagNumber(3)
  $355.Date ensureValidUntil() => $_ensure(2);
}
