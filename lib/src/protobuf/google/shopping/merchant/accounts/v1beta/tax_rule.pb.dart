...
class TaxRule extends $pb.GeneratedMessage {
  factory TaxRule({
    ...
    $544.Interval? effectiveTimePeriod,
  }) {
    final $result = create();
    if (regionCode != null) {
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(
    ...
    ..aOM<$544.Interval>(7, _omitFieldNames ? '' : 'effectiveTimePeriod',
  ...
  @$pb.TagNumber(7)
  $544.Interval get effectiveTimePeriod => $_getN(6);
  @$pb.TagNumber(7)
  set effectiveTimePeriod($544.Interval v) {
    setField(7, v);
  }
  ...
  @$pb.TagNumber(7)
  $544.Interval ensureEffectiveTimePeriod() => $_ensure(6);
}
