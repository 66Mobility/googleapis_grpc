...
class TaxRule extends $pb.GeneratedMessage {
  factory TaxRule({
    ...
    $4256.Interval? effectiveTimePeriod,
  }) {
    final $result = create();
    if (regionCode != null) {
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(_omitMessageNames ? '' : 'TaxRule', package: const $pb.PackageName(_omitMessageNames ? '' : 'google.shopping.merchant.accounts.v1beta'), createEmptyInstance: create)
    ...
    ..aOM<$4256.Interval>(7, _omitFieldNames ? '' : 'effectiveTimePeriod', subBuilder: $4256.Interval.create)
    ..hasRequiredFields = false
  ;
  ...
  @$pb.TagNumber(7)
  $4256.Interval get effectiveTimePeriod => $_getN(6);
  @$pb.TagNumber(7)
  set effectiveTimePeriod($4256.Interval v) { setField(7, v); }
  @$pb.TagNumber(7)
  $core.bool hasEffectiveTimePeriod() => $_has(6);
  @$pb.TagNumber(7)
  void clearEffectiveTimePeriod() => clearField(7);
  @$pb.TagNumber(7)
  $4256.Interval ensureEffectiveTimePeriod() => $_ensure(6);
}
