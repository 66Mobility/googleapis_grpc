...
class Service extends $pb.GeneratedMessage {
  ...
  @$pb.TagNumber(8)
  $536.Price ensureMinimumOrderValue() => $_ensure(7);
...
class MinimumOrderValueTable_StoreCodeSetWithMov extends $pb.GeneratedMessage {
  ...
  @$pb.TagNumber(2)
  $536.Price ensureValue() => $_ensure(1);
}
...
class Headers extends $pb.GeneratedMessage {
  factory Headers({
    $core.Iterable<$536.Price>? prices,
    $core.Iterable<$536.Weight>? weights,
  ...
  @$pb.TagNumber(1)
  $core.List<$536.Price> get prices => $_getList(0);
  ...
  @$pb.TagNumber(2)
  $core.List<$536.Weight> get weights => $_getList(1);
...
class Value extends $pb.GeneratedMessage {
  ...
  @$pb.TagNumber(2)
  $536.Price ensureFlatRate() => $_ensure(1);
...
class CarrierRate extends $pb.GeneratedMessage {
  ...
  @$pb.TagNumber(6)
  $536.Price ensureFlatAdjustment() => $_ensure(5);
}
