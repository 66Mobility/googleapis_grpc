...
class Service extends $pb.GeneratedMessage {
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(_omitMessageNames ? '' : 'Service', package: const $pb.PackageName(_omitMessageNames ? '' : 'google.shopping.merchant.accounts.v1beta'), createEmptyInstance: create)
    ...
    ..aOM<$535.Price>(8, _omitFieldNames ? '' : 'minimumOrderValue', subBuilder: $535.Price.create)
  ...
  @$pb.TagNumber(8)
  $535.Price get minimumOrderValue => $_getN(7);
  @$pb.TagNumber(8)
  set minimumOrderValue($535.Price v) { setField(8, v); }
  @$pb.TagNumber(8)
  $core.bool hasMinimumOrderValue() => $_has(7);
  @$pb.TagNumber(8)
  void clearMinimumOrderValue() => clearField(8);
  @$pb.TagNumber(8)
  $535.Price ensureMinimumOrderValue() => $_ensure(7);
...
class MinimumOrderValueTable_StoreCodeSetWithMov extends $pb.GeneratedMessage {
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(_omitMessageNames ? '' : 'MinimumOrderValueTable.StoreCodeSetWithMov', package: const $pb.PackageName(_omitMessageNames ? '' : 'google.shopping.merchant.accounts.v1beta'), createEmptyInstance: create)
    ...
    ..aOM<$535.Price>(2, _omitFieldNames ? '' : 'value', subBuilder: $535.Price.create)
    ..hasRequiredFields = false
  ;
  ...
  @$pb.TagNumber(2)
  $535.Price get value => $_getN(1);
  @$pb.TagNumber(2)
  set value($535.Price v) { setField(2, v); }
  @$pb.TagNumber(2)
  $core.bool hasValue() => $_has(1);
  @$pb.TagNumber(2)
  void clearValue() => clearField(2);
  @$pb.TagNumber(2)
  $535.Price ensureValue() => $_ensure(1);
}
...
class Headers extends $pb.GeneratedMessage {
  factory Headers({
    $core.Iterable<$535.Price>? prices,
    $core.Iterable<$535.Weight>? weights,
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(_omitMessageNames ? '' : 'Headers', package: const $pb.PackageName(_omitMessageNames ? '' : 'google.shopping.merchant.accounts.v1beta'), createEmptyInstance: create)
    ..pc<$535.Price>(1, _omitFieldNames ? '' : 'prices', $pb.PbFieldType.PM, subBuilder: $535.Price.create)
    ..pc<$535.Weight>(2, _omitFieldNames ? '' : 'weights', $pb.PbFieldType.PM, subBuilder: $535.Weight.create)
  ...
  @$pb.TagNumber(1)
  $core.List<$535.Price> get prices => $_getList(0);
  ...
  @$pb.TagNumber(2)
  $core.List<$535.Weight> get weights => $_getList(1);
...
class Value extends $pb.GeneratedMessage {
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(_omitMessageNames ? '' : 'Value', package: const $pb.PackageName(_omitMessageNames ? '' : 'google.shopping.merchant.accounts.v1beta'), createEmptyInstance: create)
    ...
    ..aOM<$535.Price>(2, _omitFieldNames ? '' : 'flatRate', subBuilder: $535.Price.create)
  ...
  @$pb.TagNumber(2)
  $535.Price get flatRate => $_getN(1);
  @$pb.TagNumber(2)
  set flatRate($535.Price v) { setField(2, v); }
  @$pb.TagNumber(2)
  $core.bool hasFlatRate() => $_has(1);
  @$pb.TagNumber(2)
  void clearFlatRate() => clearField(2);
  @$pb.TagNumber(2)
  $535.Price ensureFlatRate() => $_ensure(1);
...
class CarrierRate extends $pb.GeneratedMessage {
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(_omitMessageNames ? '' : 'CarrierRate', package: const $pb.PackageName(_omitMessageNames ? '' : 'google.shopping.merchant.accounts.v1beta'), createEmptyInstance: create)
    ...
    ..aOM<$535.Price>(6, _omitFieldNames ? '' : 'flatAdjustment', subBuilder: $535.Price.create)
    ..hasRequiredFields = false
  ;
  ...
  /// rate.
  @$pb.TagNumber(6)
  $535.Price get flatAdjustment => $_getN(5);
  @$pb.TagNumber(6)
  set flatAdjustment($535.Price v) { setField(6, v); }
  @$pb.TagNumber(6)
  $core.bool hasFlatAdjustment() => $_has(5);
  @$pb.TagNumber(6)
  void clearFlatAdjustment() => clearField(6);
  @$pb.TagNumber(6)
  $535.Price ensureFlatAdjustment() => $_ensure(5);
}
