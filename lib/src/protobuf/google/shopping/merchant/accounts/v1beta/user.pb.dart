...
import 'accessright.pbenum.dart' as $4875;
...
class User extends $pb.GeneratedMessage {
  factory User({
    $core.String? name,
    User_State? state,
    $core.Iterable<$4875.AccessRight>? accessRights,
  }) {
    final $result = create();
    if (name != null) {
      $result.name = name;
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(_omitMessageNames ? '' : 'User', package: const $pb.PackageName(_omitMessageNames ? '' : 'google.shopping.merchant.accounts.v1beta'), createEmptyInstance: create)
    ...
    ..pc<$4875.AccessRight>(4, _omitFieldNames ? '' : 'accessRights', $pb.PbFieldType.KE, valueOf: $4875.AccessRight.valueOf, enumValues: $4875.AccessRight.values, defaultEnumValue: $4875.AccessRight.ACCESS_RIGHT_UNSPECIFIED)
  ...
  /// the user has.
  @$pb.TagNumber(4)
  $core.List<$4875.AccessRight> get accessRights => $_getList(2);
}
