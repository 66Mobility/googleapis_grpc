...
class RegionsServiceClient extends $grpc.Client {
  static final _$getRegion =
      $grpc.ClientMethod<$226.GetRegionRequest, $226.Region>(
  ...
  static final _$listRegions = $grpc.ClientMethod<$226.ListRegionsRequest,
          $226.ListRegionsResponse>(
      '/google.shopping.merchant.accounts.v1beta.RegionsService/ListRegions',
      ($226.ListRegionsRequest value) => value.writeToBuffer(),
      ($core.List<$core.int> value) =>
          $226.ListRegionsResponse.fromBuffer(value));
  ...
  $grpc.ResponseFuture<$226.Region> getRegion($226.GetRegionRequest request,
      {$grpc.CallOptions? options}) {
    return $createUnaryCall(_$getRegion, request, options: options);
  }

  $grpc.ResponseFuture<$226.Region> createRegion(
      $226.CreateRegionRequest request,
      {$grpc.CallOptions? options}) {
    return $createUnaryCall(_$createRegion, request, options: options);
  }

  $grpc.ResponseFuture<$226.Region> updateRegion(
      $226.UpdateRegionRequest request,
      {$grpc.CallOptions? options}) {
    return $createUnaryCall(_$updateRegion, request, options: options);
  }

  $grpc.ResponseFuture<$3.Empty> deleteRegion($226.DeleteRegionRequest request,
      {$grpc.CallOptions? options}) {
    return $createUnaryCall(_$deleteRegion, request, options: options);
  }

  $grpc.ResponseFuture<$226.ListRegionsResponse> listRegions(
      $226.ListRegionsRequest request,
      {$grpc.CallOptions? options}) {
...
abstract class RegionsServiceBase extends $grpc.Service {
  ...
  RegionsServiceBase() {
    $addMethod($grpc.ServiceMethod<$226.GetRegionRequest, $226.Region>(
        ...
        false,
        ($core.List<$core.int> value) =>
            $226.GetRegionRequest.fromBuffer(value),
    ...
    $addMethod($grpc.ServiceMethod<$226.CreateRegionRequest, $226.Region>(
        ...
        false,
        ($core.List<$core.int> value) =>
            $226.CreateRegionRequest.fromBuffer(value),
        ($226.Region value) => value.writeToBuffer()));
    $addMethod($grpc.ServiceMethod<$226.UpdateRegionRequest, $226.Region>(
        ...
        false,
        ($core.List<$core.int> value) =>
            $226.UpdateRegionRequest.fromBuffer(value),
        ($226.Region value) => value.writeToBuffer()));
    $addMethod($grpc.ServiceMethod<$226.DeleteRegionRequest, $3.Empty>(
        ...
        false,
        ($core.List<$core.int> value) =>
            $226.DeleteRegionRequest.fromBuffer(value),
        ($3.Empty value) => value.writeToBuffer()));
    $addMethod(
        $grpc.ServiceMethod<$226.ListRegionsRequest, $226.ListRegionsResponse>(
            'ListRegions',
            listRegions_Pre,
            false,
            false,
            ($core.List<$core.int> value) =>
                $226.ListRegionsRequest.fromBuffer(value),
            ($226.ListRegionsResponse value) => value.writeToBuffer()));
  }

  $async.Future<$226.Region> getRegion_Pre($grpc.ServiceCall call,
      $async.Future<$226.GetRegionRequest> request) async {
    return getRegion(call, await request);
  }

  $async.Future<$226.Region> createRegion_Pre($grpc.ServiceCall call,
      $async.Future<$226.CreateRegionRequest> request) async {
    return createRegion(call, await request);
  }

  $async.Future<$226.Region> updateRegion_Pre($grpc.ServiceCall call,
      $async.Future<$226.UpdateRegionRequest> request) async {
    return updateRegion(call, await request);
  }

  $async.Future<$3.Empty> deleteRegion_Pre($grpc.ServiceCall call,
      $async.Future<$226.DeleteRegionRequest> request) async {
    return deleteRegion(call, await request);
  }

  $async.Future<$226.ListRegionsResponse> listRegions_Pre(
      $grpc.ServiceCall call,
      $async.Future<$226.ListRegionsRequest> request) async {
    return listRegions(call, await request);
  }

  $async.Future<$226.Region> getRegion(
      $grpc.ServiceCall call, $226.GetRegionRequest request);
  $async.Future<$226.Region> createRegion(
      $grpc.ServiceCall call, $226.CreateRegionRequest request);
  $async.Future<$226.Region> updateRegion(
      $grpc.ServiceCall call, $226.UpdateRegionRequest request);
  $async.Future<$3.Empty> deleteRegion(
      $grpc.ServiceCall call, $226.DeleteRegionRequest request);
  $async.Future<$226.ListRegionsResponse> listRegions(
      $grpc.ServiceCall call, $226.ListRegionsRequest request);
}
