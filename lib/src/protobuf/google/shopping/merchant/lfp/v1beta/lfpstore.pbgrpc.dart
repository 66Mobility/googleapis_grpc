...
class LfpStoreServiceClient extends $grpc.Client {
  static final _$getLfpStore =
      $grpc.ClientMethod<$237.GetLfpStoreRequest, $237.LfpStore>(
  ...
  static final _$insertLfpStore =
      $grpc.ClientMethod<$237.InsertLfpStoreRequest, $237.LfpStore>(
  ...
  static final _$deleteLfpStore =
      $grpc.ClientMethod<$237.DeleteLfpStoreRequest, $3.Empty>(
  ...
  $grpc.ResponseFuture<$237.LfpStore> getLfpStore(
      $237.GetLfpStoreRequest request,
      {$grpc.CallOptions? options}) {
    return $createUnaryCall(_$getLfpStore, request, options: options);
  }

  $grpc.ResponseFuture<$237.LfpStore> insertLfpStore(
      $237.InsertLfpStoreRequest request,
      {$grpc.CallOptions? options}) {
    return $createUnaryCall(_$insertLfpStore, request, options: options);
  }

  $grpc.ResponseFuture<$3.Empty> deleteLfpStore(
      $237.DeleteLfpStoreRequest request,
      {$grpc.CallOptions? options}) {
    return $createUnaryCall(_$deleteLfpStore, request, options: options);
  }

  $grpc.ResponseFuture<$237.ListLfpStoresResponse> listLfpStores(
      $237.ListLfpStoresRequest request,
      {$grpc.CallOptions? options}) {
...
abstract class LfpStoreServiceBase extends $grpc.Service {
  ...
  LfpStoreServiceBase() {
    $addMethod($grpc.ServiceMethod<$237.GetLfpStoreRequest, $237.LfpStore>(
        ...
        false,
        ($core.List<$core.int> value) =>
            $237.GetLfpStoreRequest.fromBuffer(value),
    ...
    $addMethod($grpc.ServiceMethod<$237.InsertLfpStoreRequest, $237.LfpStore>(
        ...
        false,
        ($core.List<$core.int> value) =>
            $237.InsertLfpStoreRequest.fromBuffer(value),
        ($237.LfpStore value) => value.writeToBuffer()));
    $addMethod($grpc.ServiceMethod<$237.DeleteLfpStoreRequest, $3.Empty>(
        ...
        false,
        ($core.List<$core.int> value) =>
            $237.DeleteLfpStoreRequest.fromBuffer(value),
        ($3.Empty value) => value.writeToBuffer()));
    $addMethod($grpc.ServiceMethod<$237.ListLfpStoresRequest,
            $237.ListLfpStoresResponse>(
        'ListLfpStores',
        listLfpStores_Pre,
        false,
        false,
        ($core.List<$core.int> value) =>
            $237.ListLfpStoresRequest.fromBuffer(value),
        ($237.ListLfpStoresResponse value) => value.writeToBuffer()));
  }

  $async.Future<$237.LfpStore> getLfpStore_Pre($grpc.ServiceCall call,
      $async.Future<$237.GetLfpStoreRequest> request) async {
    return getLfpStore(call, await request);
  }

  $async.Future<$237.LfpStore> insertLfpStore_Pre($grpc.ServiceCall call,
      $async.Future<$237.InsertLfpStoreRequest> request) async {
    return insertLfpStore(call, await request);
  }

  $async.Future<$3.Empty> deleteLfpStore_Pre($grpc.ServiceCall call,
      $async.Future<$237.DeleteLfpStoreRequest> request) async {
    return deleteLfpStore(call, await request);
  }

  $async.Future<$237.ListLfpStoresResponse> listLfpStores_Pre(
      $grpc.ServiceCall call,
      $async.Future<$237.ListLfpStoresRequest> request) async {
    return listLfpStores(call, await request);
  }

  $async.Future<$237.LfpStore> getLfpStore(
      $grpc.ServiceCall call, $237.GetLfpStoreRequest request);
  $async.Future<$237.LfpStore> insertLfpStore(
      $grpc.ServiceCall call, $237.InsertLfpStoreRequest request);
  $async.Future<$3.Empty> deleteLfpStore(
      $grpc.ServiceCall call, $237.DeleteLfpStoreRequest request);
  $async.Future<$237.ListLfpStoresResponse> listLfpStores(
      $grpc.ServiceCall call, $237.ListLfpStoresRequest request);
}
