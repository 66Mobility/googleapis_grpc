...
class LfpInventory extends $pb.GeneratedMessage {
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(_omitMessageNames ? '' : 'LfpInventory', package: const $pb.PackageName(_omitMessageNames ? '' : 'google.shopping.merchant.lfp.v1beta'), createEmptyInstance: create)
    ...
    ..aOM<$4872.Price>(8, _omitFieldNames ? '' : 'price', subBuilder: $4872.Price.create)
    ..aOS(9, _omitFieldNames ? '' : 'availability')
    ..aInt64(10, _omitFieldNames ? '' : 'quantity')
    ..aOM<$1775.Timestamp>(11, _omitFieldNames ? '' : 'collectionTime', subBuilder: $1775.Timestamp.create)
  ...
  @$pb.TagNumber(8)
  $4872.Price get price => $_getN(7);
  @$pb.TagNumber(8)
  set price($4872.Price v) { setField(8, v); }
  @$pb.TagNumber(8)
  $core.bool hasPrice() => $_has(7);
  @$pb.TagNumber(8)
  void clearPrice() => clearField(8);
  @$pb.TagNumber(8)
  $4872.Price ensurePrice() => $_ensure(7);
  ...
  @$pb.TagNumber(11)
  $1775.Timestamp get collectionTime => $_getN(10);
  @$pb.TagNumber(11)
  set collectionTime($1775.Timestamp v) { setField(11, v); }
  @$pb.TagNumber(11)
  $core.bool hasCollectionTime() => $_has(10);
  @$pb.TagNumber(11)
  void clearCollectionTime() => clearField(11);
  @$pb.TagNumber(11)
  $1775.Timestamp ensureCollectionTime() => $_ensure(10);
