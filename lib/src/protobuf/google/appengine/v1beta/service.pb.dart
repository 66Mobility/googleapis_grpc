...
import 'network_settings.pb.dart' as $383;
...
class Service extends $pb.GeneratedMessage {
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(_omitMessageNames ? '' : 'Service', package: const $pb.PackageName(_omitMessageNames ? '' : 'google.appengine.v1beta'), createEmptyInstance: create)
    ...
    ..aOM<$383.NetworkSettings>(6, _omitFieldNames ? '' : 'networkSettings', subBuilder: $383.NetworkSettings.create)
  ...
  @$pb.TagNumber(6)
  $383.NetworkSettings get networkSettings => $_getN(3);
  @$pb.TagNumber(6)
  set networkSettings($383.NetworkSettings v) { setField(6, v); }
  @$pb.TagNumber(6)
  $core.bool hasNetworkSettings() => $_has(3);
  @$pb.TagNumber(6)
  void clearNetworkSettings() => clearField(6);
  @$pb.TagNumber(6)
  $383.NetworkSettings ensureNetworkSettings() => $_ensure(3);
}
