...
import 'network_settings.pb.dart' as $382;
...
class Service extends $pb.GeneratedMessage {
  factory Service({
    ...
    $core.String? id,
    TrafficSplit? split,
    $382.NetworkSettings? networkSettings,
  }) {
    final $result = create();
    if (name != null) {
      $result.name = name;
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(_omitMessageNames ? '' : 'Service', package: const $pb.PackageName(_omitMessageNames ? '' : 'google.appengine.v1beta'), createEmptyInstance: create)
    ..aOS(1, _omitFieldNames ? '' : 'name')
    ..aOS(2, _omitFieldNames ? '' : 'id')
    ..aOM<TrafficSplit>(3, _omitFieldNames ? '' : 'split', subBuilder: TrafficSplit.create)
    ..aOM<$382.NetworkSettings>(6, _omitFieldNames ? '' : 'networkSettings', subBuilder: $382.NetworkSettings.create)
  ...
  @$pb.TagNumber(6)
  $382.NetworkSettings get networkSettings => $_getN(3);
  @$pb.TagNumber(6)
  set networkSettings($382.NetworkSettings v) { setField(6, v); }
  @$pb.TagNumber(6)
  $core.bool hasNetworkSettings() => $_has(3);
  @$pb.TagNumber(6)
  void clearNetworkSettings() => clearField(6);
  @$pb.TagNumber(6)
  $382.NetworkSettings ensureNetworkSettings() => $_ensure(3);
}
...
class TrafficSplit extends $pb.GeneratedMessage {
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(_omitMessageNames ? '' : 'TrafficSplit', package: const $pb.PackageName(_omitMessageNames ? '' : 'google.appengine.v1beta'), createEmptyInstance: create)
    ...
    ..m<$core.String, $core.double>(2, _omitFieldNames ? '' : 'allocations', entryClassName: 'TrafficSplit.AllocationsEntry', keyFieldType: $pb.PbFieldType.OS, valueFieldType: $pb.PbFieldType.OD, packageName: const $pb.PackageName('google.appengine.v1beta'))
    ..hasRequiredFields = false
  ;
