...
class OperationMetadataV1Beta extends $pb.GeneratedMessage {
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(
    ...
    ..aOM<$330.Timestamp>(2, _omitFieldNames ? '' : 'insertTime',
  ...
  ///  @OutputOnly
  @$pb.TagNumber(2)
  $330.Timestamp get insertTime => $_getN(1);
  @$pb.TagNumber(2)
  set insertTime($330.Timestamp v) {
    setField(2, v);
  }
  ...
  @$pb.TagNumber(2)
  $330.Timestamp ensureInsertTime() => $_ensure(1);
