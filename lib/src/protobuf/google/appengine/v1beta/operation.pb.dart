...
class OperationMetadataV1Beta extends $pb.GeneratedMessage {
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(_omitMessageNames ? '' : 'OperationMetadataV1Beta', package: const $pb.PackageName(_omitMessageNames ? '' : 'google.appengine.v1beta'), createEmptyInstance: create)
    ...
    ..aOM<$301.Timestamp>(2, _omitFieldNames ? '' : 'insertTime', subBuilder: $301.Timestamp.create)
    ...
    ..aOM<CreateVersionMetadataV1Beta>(8, _omitFieldNames ? '' : 'createVersionMetadata', subBuilder: CreateVersionMetadataV1Beta.create)
  ...
  'Will be removed in next major version')
  OperationMetadataV1Beta copyWith(void Function(OperationMetadataV1Beta) updates) => super.copyWith((message) => updates(message as OperationMetadataV1Beta)) as OperationMetadataV1Beta;
  ...
  ///  @OutputOnly
  @$pb.TagNumber(2)
  $301.Timestamp get insertTime => $_getN(1);
  @$pb.TagNumber(2)
  set insertTime($301.Timestamp v) { setField(2, v); }
  @$pb.TagNumber(2)
  $core.bool hasInsertTime() => $_has(1);
  @$pb.TagNumber(2)
  void clearInsertTime() => clearField(2);
  @$pb.TagNumber(2)
  $301.Timestamp ensureInsertTime() => $_ensure(1);
...
class CreateVersionMetadataV1Beta extends $pb.GeneratedMessage {
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(_omitMessageNames ? '' : 'CreateVersionMetadataV1Beta', package: const $pb.PackageName(_omitMessageNames ? '' : 'google.appengine.v1beta'), createEmptyInstance: create)
  ...
  'Use [GeneratedMessageGenericExtensions.rebuild] instead. '
  'Will be removed in next major version')
  CreateVersionMetadataV1Beta copyWith(void Function(CreateVersionMetadataV1Beta) updates) => super.copyWith((message) => updates(message as CreateVersionMetadataV1Beta)) as CreateVersionMetadataV1Beta;
