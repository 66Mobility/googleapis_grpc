...
class CloudBuildOptions extends $pb.GeneratedMessage {
  factory CloudBuildOptions({
    ...
    $292.Duration? cloudBuildTimeout,
  }) {
    final $result = create();
    if (appYamlPath != null) {
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(
    ...
    ..aOM<$292.Duration>(2, _omitFieldNames ? '' : 'cloudBuildTimeout',
  ...
  @$pb.TagNumber(2)
  $292.Duration get cloudBuildTimeout => $_getN(1);
  @$pb.TagNumber(2)
  set cloudBuildTimeout($292.Duration v) {
    setField(2, v);
  }
  ...
  @$pb.TagNumber(2)
  $292.Duration ensureCloudBuildTimeout() => $_ensure(1);
}
