...
class Application_IdentityAwareProxy extends $pb.GeneratedMessage {
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(_omitMessageNames ? '' : 'Application.IdentityAwareProxy', package: const $pb.PackageName(_omitMessageNames ? '' : 'google.appengine.v1beta'), createEmptyInstance: create)
...
class Application_FeatureSettings extends $pb.GeneratedMessage {
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(_omitMessageNames ? '' : 'Application.FeatureSettings', package: const $pb.PackageName(_omitMessageNames ? '' : 'google.appengine.v1beta'), createEmptyInstance: create)
...
class Application extends $pb.GeneratedMessage {
  factory Application({
    ...
    $1738.Duration? defaultCookieExpiration,
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(_omitMessageNames ? '' : 'Application', package: const $pb.PackageName(_omitMessageNames ? '' : 'google.appengine.v1beta'), createEmptyInstance: create)
    ...
    ..aOM<$1738.Duration>(9, _omitFieldNames ? '' : 'defaultCookieExpiration', subBuilder: $1738.Duration.create)
  ...
  @$pb.TagNumber(9)
  $1738.Duration get defaultCookieExpiration => $_getN(6);
  @$pb.TagNumber(9)
  set defaultCookieExpiration($1738.Duration v) { setField(9, v); }
  @$pb.TagNumber(9)
  $core.bool hasDefaultCookieExpiration() => $_has(6);
  @$pb.TagNumber(9)
  void clearDefaultCookieExpiration() => clearField(9);
  @$pb.TagNumber(9)
  $1738.Duration ensureDefaultCookieExpiration() => $_ensure(6);
...
class UrlDispatchRule extends $pb.GeneratedMessage {
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(_omitMessageNames ? '' : 'UrlDispatchRule', package: const $pb.PackageName(_omitMessageNames ? '' : 'google.appengine.v1beta'), createEmptyInstance: create)
