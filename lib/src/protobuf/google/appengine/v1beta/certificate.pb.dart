...
class ManagedCertificate extends $pb.GeneratedMessage {
  factory ManagedCertificate({
    $1775.Timestamp? lastRenewalTime,
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(_omitMessageNames ? '' : 'ManagedCertificate', package: const $pb.PackageName(_omitMessageNames ? '' : 'google.appengine.v1beta'), createEmptyInstance: create)
    ..aOM<$1775.Timestamp>(1, _omitFieldNames ? '' : 'lastRenewalTime', subBuilder: $1775.Timestamp.create)
  ...
  ///  @OutputOnly
  @$pb.TagNumber(1)
  $1775.Timestamp get lastRenewalTime => $_getN(0);
  @$pb.TagNumber(1)
  set lastRenewalTime($1775.Timestamp v) { setField(1, v); }
  @$pb.TagNumber(1)
  $core.bool hasLastRenewalTime() => $_has(0);
  @$pb.TagNumber(1)
  void clearLastRenewalTime() => clearField(1);
  @$pb.TagNumber(1)
  $1775.Timestamp ensureLastRenewalTime() => $_ensure(0);
