...
class AuthorizedCertificate extends $pb.GeneratedMessage {
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(_omitMessageNames ? '' : 'AuthorizedCertificate', package: const $pb.PackageName(_omitMessageNames ? '' : 'google.appengine.v1beta'), createEmptyInstance: create)
...
class CertificateRawData extends $pb.GeneratedMessage {
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(_omitMessageNames ? '' : 'CertificateRawData', package: const $pb.PackageName(_omitMessageNames ? '' : 'google.appengine.v1beta'), createEmptyInstance: create)
...
class ManagedCertificate extends $pb.GeneratedMessage {
  factory ManagedCertificate({
    $1776.Timestamp? lastRenewalTime,
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(_omitMessageNames ? '' : 'ManagedCertificate', package: const $pb.PackageName(_omitMessageNames ? '' : 'google.appengine.v1beta'), createEmptyInstance: create)
    ..aOM<$1776.Timestamp>(1, _omitFieldNames ? '' : 'lastRenewalTime', subBuilder: $1776.Timestamp.create)
  ...
  ///  @OutputOnly
  @$pb.TagNumber(1)
  $1776.Timestamp get lastRenewalTime => $_getN(0);
  @$pb.TagNumber(1)
  set lastRenewalTime($1776.Timestamp v) { setField(1, v); }
  @$pb.TagNumber(1)
  $core.bool hasLastRenewalTime() => $_has(0);
  @$pb.TagNumber(1)
  void clearLastRenewalTime() => clearField(1);
  @$pb.TagNumber(1)
  $1776.Timestamp ensureLastRenewalTime() => $_ensure(0);
