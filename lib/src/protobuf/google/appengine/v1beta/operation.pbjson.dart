...
const OperationMetadataV1Beta$json = {
  ...
  '2': [
    ...
    {'1': 'create_version_metadata', '3': 8, '4': 1, '5': 11, '6': '.google.appengine.v1beta.CreateVersionMetadataV1Beta', '9': 0, '10': 'createVersionMetadata'},
  ],
  '8': [
    {'1': 'method_metadata'},
  ],
...
final $typed_data.Uint8List createVersionMetadataV1BetaDescriptor = $convert.base64Decode(
