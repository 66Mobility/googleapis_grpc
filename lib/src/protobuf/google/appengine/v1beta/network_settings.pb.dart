...
class NetworkSettings extends $pb.GeneratedMessage {
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(_omitMessageNames ? '' : 'NetworkSettings', package: const $pb.PackageName(_omitMessageNames ? '' : 'google.appengine.v1beta'), createEmptyInstance: create)
    ..e<NetworkSettings_IngressTrafficAllowed>(1, _omitFieldNames ? '' : 'ingressTrafficAllowed', $pb.PbFieldType.OE, defaultOrMaker: NetworkSettings_IngressTrafficAllowed.INGRESS_TRAFFIC_ALLOWED_UNSPECIFIED, valueOf: NetworkSettings_IngressTrafficAllowed.valueOf, enumValues: NetworkSettings_IngressTrafficAllowed.values)
