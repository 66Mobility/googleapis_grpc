...
class StaticFilesHandler extends $pb.GeneratedMessage {
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(
    ...
    ..aOM<$292.Duration>(5, _omitFieldNames ? '' : 'expiration',
  ...
  @$pb.TagNumber(5)
  $292.Duration get expiration => $_getN(4);
  @$pb.TagNumber(5)
  set expiration($292.Duration v) {
    setField(5, v);
  }
  ...
  @$pb.TagNumber(5)
  $292.Duration ensureExpiration() => $_ensure(4);
...
class HealthCheck extends $pb.GeneratedMessage {
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(
    ...
    ..aOM<$292.Duration>(6, _omitFieldNames ? '' : 'checkInterval',
        subBuilder: $292.Duration.create)
    ..aOM<$292.Duration>(7, _omitFieldNames ? '' : 'timeout',
        subBuilder: $292.Duration.create)
    ..hasRequiredFields = false;
  ...
  @$pb.TagNumber(6)
  $292.Duration get checkInterval => $_getN(5);
  @$pb.TagNumber(6)
  set checkInterval($292.Duration v) {
    setField(6, v);
  }
  ...
  @$pb.TagNumber(6)
  $292.Duration ensureCheckInterval() => $_ensure(5);

  /// Time before the health check is considered failed.
  @$pb.TagNumber(7)
  $292.Duration get timeout => $_getN(6);
  @$pb.TagNumber(7)
  ...
  @$pb.TagNumber(7)
  $292.Duration ensureTimeout() => $_ensure(6);
}
...
class ReadinessCheck extends $pb.GeneratedMessage {
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(
    ...
    ..aOM<$292.Duration>(5, _omitFieldNames ? '' : 'checkInterval',
        subBuilder: $292.Duration.create)
    ..aOM<$292.Duration>(6, _omitFieldNames ? '' : 'timeout',
        subBuilder: $292.Duration.create)
    ..aOM<$292.Duration>(7, _omitFieldNames ? '' : 'appStartTimeout',
        subBuilder: $292.Duration.create)
    ..hasRequiredFields = false;
  ...
  /// Interval between health checks.
  @$pb.TagNumber(5)
  $292.Duration get checkInterval => $_getN(4);
  @$pb.TagNumber(5)
  set checkInterval($292.Duration v) {
    setField(5, v);
  }
  ...
  @$pb.TagNumber(5)
  $292.Duration ensureCheckInterval() => $_ensure(4);

  /// Time before the check is considered failed.
  @$pb.TagNumber(6)
  $292.Duration get timeout => $_getN(5);
  @$pb.TagNumber(6)
  set timeout($292.Duration v) {
    setField(6, v);
  }
  ...
  @$pb.TagNumber(6)
  $292.Duration ensureTimeout() => $_ensure(5);

  /// A maximum time limit on application initialization, measured from moment
  /// the application successfully replies to a healthcheck until it is ready to
  /// serve traffic.
  @$pb.TagNumber(7)
  $292.Duration get appStartTimeout => $_getN(6);
  @$pb.TagNumber(7)
  set appStartTimeout($292.Duration v) {
    setField(7, v);
  }
  ...
  @$pb.TagNumber(7)
  $292.Duration ensureAppStartTimeout() => $_ensure(6);
}
...
class LivenessCheck extends $pb.GeneratedMessage {
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(
    ...
    ..aOM<$292.Duration>(6, _omitFieldNames ? '' : 'timeout',
        subBuilder: $292.Duration.create)
    ..aOM<$292.Duration>(7, _omitFieldNames ? '' : 'initialDelay',
        subBuilder: $292.Duration.create)
    ..hasRequiredFields = false;
  ...
  @$pb.TagNumber(7)
  $292.Duration get initialDelay => $_getN(6);
  @$pb.TagNumber(7)
  set initialDelay($292.Duration v) {
    setField(7, v);
  }
  ...
  @$pb.TagNumber(7)
  $292.Duration ensureInitialDelay() => $_ensure(6);
}
