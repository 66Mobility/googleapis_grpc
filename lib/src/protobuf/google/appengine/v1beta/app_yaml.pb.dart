...
class StaticFilesHandler extends $pb.GeneratedMessage {
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(_omitMessageNames ? '' : 'StaticFilesHandler', package: const $pb.PackageName(_omitMessageNames ? '' : 'google.appengine.v1beta'), createEmptyInstance: create)
    ...
    ..aOM<$264.Duration>(5, _omitFieldNames ? '' : 'expiration', subBuilder: $264.Duration.create)
  ...
  @$pb.TagNumber(5)
  set expiration($264.Duration v) { setField(5, v); }
  @$pb.TagNumber(5)
...
class HealthCheck extends $pb.GeneratedMessage {
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(_omitMessageNames ? '' : 'HealthCheck', package: const $pb.PackageName(_omitMessageNames ? '' : 'google.appengine.v1beta'), createEmptyInstance: create)
    ...
    ..aOM<$264.Duration>(6, _omitFieldNames ? '' : 'checkInterval', subBuilder: $264.Duration.create)
    ..aOM<$264.Duration>(7, _omitFieldNames ? '' : 'timeout', subBuilder: $264.Duration.create)
    ..hasRequiredFields = false
  ;
  ...
  @$pb.TagNumber(6)
  set checkInterval($264.Duration v) { setField(6, v); }
  @$pb.TagNumber(6)
  ...
  @$pb.TagNumber(7)
  set timeout($264.Duration v) { setField(7, v); }
  @$pb.TagNumber(7)
...
class ReadinessCheck extends $pb.GeneratedMessage {
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(_omitMessageNames ? '' : 'ReadinessCheck', package: const $pb.PackageName(_omitMessageNames ? '' : 'google.appengine.v1beta'), createEmptyInstance: create)
    ...
    ..aOM<$264.Duration>(5, _omitFieldNames ? '' : 'checkInterval', subBuilder: $264.Duration.create)
    ..aOM<$264.Duration>(6, _omitFieldNames ? '' : 'timeout', subBuilder: $264.Duration.create)
    ..aOM<$264.Duration>(7, _omitFieldNames ? '' : 'appStartTimeout', subBuilder: $264.Duration.create)
    ..hasRequiredFields = false
  ;
  ...
  @$pb.TagNumber(5)
  set checkInterval($264.Duration v) { setField(5, v); }
  @$pb.TagNumber(5)
  ...
  @$pb.TagNumber(6)
  set timeout($264.Duration v) { setField(6, v); }
  @$pb.TagNumber(6)
  ...
  @$pb.TagNumber(7)
  set appStartTimeout($264.Duration v) { setField(7, v); }
  @$pb.TagNumber(7)
...
class LivenessCheck extends $pb.GeneratedMessage {
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(_omitMessageNames ? '' : 'LivenessCheck', package: const $pb.PackageName(_omitMessageNames ? '' : 'google.appengine.v1beta'), createEmptyInstance: create)
    ...
    ..aOM<$264.Duration>(5, _omitFieldNames ? '' : 'checkInterval', subBuilder: $264.Duration.create)
    ..aOM<$264.Duration>(6, _omitFieldNames ? '' : 'timeout', subBuilder: $264.Duration.create)
    ..aOM<$264.Duration>(7, _omitFieldNames ? '' : 'initialDelay', subBuilder: $264.Duration.create)
    ..hasRequiredFields = false
  ;
  ...
  @$pb.TagNumber(7)
  set initialDelay($264.Duration v) { setField(7, v); }
  @$pb.TagNumber(7)
