...
class StaticFilesHandler extends $pb.GeneratedMessage {
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(_omitMessageNames ? '' : 'StaticFilesHandler', package: const $pb.PackageName(_omitMessageNames ? '' : 'google.appengine.v1beta'), createEmptyInstance: create)
    ...
    ..aOM<$1737.Duration>(5, _omitFieldNames ? '' : 'expiration', subBuilder: $1737.Duration.create)
  ...
  @$pb.TagNumber(5)
  $1737.Duration get expiration => $_getN(4);
  @$pb.TagNumber(5)
  set expiration($1737.Duration v) { setField(5, v); }
  @$pb.TagNumber(5)
  $core.bool hasExpiration() => $_has(4);
  @$pb.TagNumber(5)
  void clearExpiration() => clearField(5);
  @$pb.TagNumber(5)
  $1737.Duration ensureExpiration() => $_ensure(4);
...
class HealthCheck extends $pb.GeneratedMessage {
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(_omitMessageNames ? '' : 'HealthCheck', package: const $pb.PackageName(_omitMessageNames ? '' : 'google.appengine.v1beta'), createEmptyInstance: create)
    ...
    ..aOM<$1737.Duration>(6, _omitFieldNames ? '' : 'checkInterval', subBuilder: $1737.Duration.create)
  ...
  @$pb.TagNumber(6)
  $1737.Duration get checkInterval => $_getN(5);
  @$pb.TagNumber(6)
  set checkInterval($1737.Duration v) { setField(6, v); }
  @$pb.TagNumber(6)
  $core.bool hasCheckInterval() => $_has(5);
  @$pb.TagNumber(6)
  void clearCheckInterval() => clearField(6);
  @$pb.TagNumber(6)
  $1737.Duration ensureCheckInterval() => $_ensure(5);
...
class ReadinessCheck extends $pb.GeneratedMessage {
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(_omitMessageNames ? '' : 'ReadinessCheck', package: const $pb.PackageName(_omitMessageNames ? '' : 'google.appengine.v1beta'), createEmptyInstance: create)
    ...
    ..aOM<$1737.Duration>(5, _omitFieldNames ? '' : 'checkInterval', subBuilder: $1737.Duration.create)
    ..aOM<$1737.Duration>(6, _omitFieldNames ? '' : 'timeout', subBuilder: $1737.Duration.create)
    ..aOM<$1737.Duration>(7, _omitFieldNames ? '' : 'appStartTimeout', subBuilder: $1737.Duration.create)
    ..hasRequiredFields = false
  ;
  ...
  /// Interval between health checks.
  @$pb.TagNumber(5)
  $1737.Duration get checkInterval => $_getN(4);
  @$pb.TagNumber(5)
  set checkInterval($1737.Duration v) { setField(5, v); }
  @$pb.TagNumber(5)
  $core.bool hasCheckInterval() => $_has(4);
  @$pb.TagNumber(5)
  void clearCheckInterval() => clearField(5);
  @$pb.TagNumber(5)
  $1737.Duration ensureCheckInterval() => $_ensure(4);
  ...
  /// serve traffic.
  @$pb.TagNumber(7)
  $1737.Duration get appStartTimeout => $_getN(6);
  @$pb.TagNumber(7)
  set appStartTimeout($1737.Duration v) { setField(7, v); }
  @$pb.TagNumber(7)
  $core.bool hasAppStartTimeout() => $_has(6);
  @$pb.TagNumber(7)
  void clearAppStartTimeout() => clearField(7);
  @$pb.TagNumber(7)
  $1737.Duration ensureAppStartTimeout() => $_ensure(6);
}
...
class LivenessCheck extends $pb.GeneratedMessage {
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(_omitMessageNames ? '' : 'LivenessCheck', package: const $pb.PackageName(_omitMessageNames ? '' : 'google.appengine.v1beta'), createEmptyInstance: create)
    ...
    ..aOM<$1737.Duration>(5, _omitFieldNames ? '' : 'checkInterval', subBuilder: $1737.Duration.create)
    ..aOM<$1737.Duration>(6, _omitFieldNames ? '' : 'timeout', subBuilder: $1737.Duration.create)
    ..aOM<$1737.Duration>(7, _omitFieldNames ? '' : 'initialDelay', subBuilder: $1737.Duration.create)
    ..hasRequiredFields = false
  ;
  ...
  @$pb.TagNumber(7)
  $1737.Duration get initialDelay => $_getN(6);
  @$pb.TagNumber(7)
  set initialDelay($1737.Duration v) { setField(7, v); }
  @$pb.TagNumber(7)
  $core.bool hasInitialDelay() => $_has(6);
  @$pb.TagNumber(7)
  void clearInitialDelay() => clearField(7);
  @$pb.TagNumber(7)
  $1737.Duration ensureInitialDelay() => $_ensure(6);
}
