...
import 'network_settings.pb.dart' as $376;
...
class Service extends $pb.GeneratedMessage {
  factory Service({
    ...
    $376.NetworkSettings? networkSettings,
  }) {
    final $result = create();
    if (name != null) {
      $result.name = name;
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(_omitMessageNames ? '' : 'Service', package: const $pb.PackageName(_omitMessageNames ? '' : 'google.appengine.v1'), createEmptyInstance: create)
    ...
    ..aOM<$376.NetworkSettings>(6, _omitFieldNames ? '' : 'networkSettings', subBuilder: $376.NetworkSettings.create)
  ...
  @$pb.TagNumber(6)
  $376.NetworkSettings get networkSettings => $_getN(4);
  @$pb.TagNumber(6)
  set networkSettings($376.NetworkSettings v) { setField(6, v); }
  @$pb.TagNumber(6)
  $core.bool hasNetworkSettings() => $_has(4);
  @$pb.TagNumber(6)
  void clearNetworkSettings() => clearField(6);
  @$pb.TagNumber(6)
  $376.NetworkSettings ensureNetworkSettings() => $_ensure(4);
}
