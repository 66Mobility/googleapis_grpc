...
class OperationMetadataV1 extends $pb.GeneratedMessage {
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(_omitMessageNames ? '' : 'OperationMetadataV1', package: const $pb.PackageName(_omitMessageNames ? '' : 'google.appengine.v1'), createEmptyInstance: create)
    ..oo(0, [8])
    ...
    ..aOM<CreateVersionMetadataV1>(8, _omitFieldNames ? '' : 'createVersionMetadata', subBuilder: CreateVersionMetadataV1.create)
...
class CreateVersionMetadataV1 extends $pb.GeneratedMessage {
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(_omitMessageNames ? '' : 'CreateVersionMetadataV1', package: const $pb.PackageName(_omitMessageNames ? '' : 'google.appengine.v1'), createEmptyInstance: create)
  ...
  'Use [GeneratedMessageGenericExtensions.rebuild] instead. '
  'Will be removed in next major version')
  CreateVersionMetadataV1 copyWith(void Function(CreateVersionMetadataV1) updates) => super.copyWith((message) => updates(message as CreateVersionMetadataV1)) as CreateVersionMetadataV1;
