...
import 'app_yaml.pb.dart' as $375;
import 'deploy.pb.dart' as $376;
...
class Version extends $pb.GeneratedMessage {
  factory Version({
    ...
    $core.Iterable<$375.UrlMap>? handlers,
    $core.Iterable<$375.ErrorHandler>? errorHandlers,
    $core.Iterable<$375.Library>? libraries,
    $375.ApiConfigHandler? apiConfig,
    $core.Map<$core.String, $core.String>? envVariables,
    $261.Duration? defaultExpiration,
    $375.HealthCheck? healthCheck,
    $core.String? nobuildFilesRegex,
    $376.Deployment? deployment,
    $core.String? versionUrl,
    EndpointsApiService? endpointsApiService,
    $375.ReadinessCheck? readinessCheck,
    $375.LivenessCheck? livenessCheck,
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(_omitMessageNames ? '' : 'Version', package: const $pb.PackageName(_omitMessageNames ? '' : 'google.appengine.v1'), createEmptyInstance: create)
    ...
    ..pc<$375.UrlMap>(100, _omitFieldNames ? '' : 'handlers', $pb.PbFieldType.PM, subBuilder: $375.UrlMap.create)
    ..pc<$375.ErrorHandler>(101, _omitFieldNames ? '' : 'errorHandlers', $pb.PbFieldType.PM, subBuilder: $375.ErrorHandler.create)
    ..pc<$375.Library>(102, _omitFieldNames ? '' : 'libraries', $pb.PbFieldType.PM, subBuilder: $375.Library.create)
    ..aOM<$375.ApiConfigHandler>(103, _omitFieldNames ? '' : 'apiConfig', subBuilder: $375.ApiConfigHandler.create)
    ...
    ..aOM<$261.Duration>(105, _omitFieldNames ? '' : 'defaultExpiration', subBuilder: $261.Duration.create)
    ..aOM<$375.HealthCheck>(106, _omitFieldNames ? '' : 'healthCheck', subBuilder: $375.HealthCheck.create)
    ..aOS(107, _omitFieldNames ? '' : 'nobuildFilesRegex')
    ..aOM<$376.Deployment>(108, _omitFieldNames ? '' : 'deployment', subBuilder: $376.Deployment.create)
    ...
    ..aOM<$375.ReadinessCheck>(112, _omitFieldNames ? '' : 'readinessCheck', subBuilder: $375.ReadinessCheck.create)
    ..aOM<$375.LivenessCheck>(113, _omitFieldNames ? '' : 'livenessCheck', subBuilder: $375.LivenessCheck.create)
  ...
  ///  @OutputOnly
  @$pb.TagNumber(17)
  $299.Timestamp get createTime => $_getN(16);
  @$pb.TagNumber(17)
  set createTime($299.Timestamp v) { setField(17, v); }
  @$pb.TagNumber(17)
  $core.bool hasCreateTime() => $_has(16);
  @$pb.TagNumber(17)
  void clearCreateTime() => clearField(17);
  @$pb.TagNumber(17)
  $299.Timestamp ensureCreateTime() => $_ensure(16);
  ...
  @$pb.TagNumber(100)
  $core.List<$375.UrlMap> get handlers => $_getList(20);

  ///  Custom static error pages. Limited to 10KB per page.
  ///
  ///  Only returned in `GET` requests if `view=FULL` is set.
  @$pb.TagNumber(101)
  $core.List<$375.ErrorHandler> get errorHandlers => $_getList(21);
  ...
  ///  Only returned in `GET` requests if `view=FULL` is set.
  @$pb.TagNumber(102)
  $core.List<$375.Library> get libraries => $_getList(22);
  ...
  ///  Only returned in `GET` requests if `view=FULL` is set.
  @$pb.TagNumber(103)
  $375.ApiConfigHandler get apiConfig => $_getN(23);
  @$pb.TagNumber(103)
  set apiConfig($375.ApiConfigHandler v) { setField(103, v); }
  @$pb.TagNumber(103)
  $core.bool hasApiConfig() => $_has(23);
  @$pb.TagNumber(103)
  void clearApiConfig() => clearField(103);
  @$pb.TagNumber(103)
  $375.ApiConfigHandler ensureApiConfig() => $_ensure(23);
  ...
  ///  Only returned in `GET` requests if `view=FULL` is set.
  @$pb.TagNumber(105)
  $261.Duration get defaultExpiration => $_getN(25);
  @$pb.TagNumber(105)
  set defaultExpiration($261.Duration v) { setField(105, v); }
  @$pb.TagNumber(105)
  $core.bool hasDefaultExpiration() => $_has(25);
  @$pb.TagNumber(105)
  void clearDefaultExpiration() => clearField(105);
  @$pb.TagNumber(105)
  $261.Duration ensureDefaultExpiration() => $_ensure(25);
  ...
  ///  Only returned in `GET` requests if `view=FULL` is set.
  @$pb.TagNumber(106)
  $375.HealthCheck get healthCheck => $_getN(26);
  @$pb.TagNumber(106)
  set healthCheck($375.HealthCheck v) { setField(106, v); }
  @$pb.TagNumber(106)
  $core.bool hasHealthCheck() => $_has(26);
  @$pb.TagNumber(106)
  void clearHealthCheck() => clearField(106);
  @$pb.TagNumber(106)
  $375.HealthCheck ensureHealthCheck() => $_ensure(26);
  ...
  ///  Only returned in `GET` requests if `view=FULL` is set.
  @$pb.TagNumber(108)
  $376.Deployment get deployment => $_getN(28);
  @$pb.TagNumber(108)
  set deployment($376.Deployment v) { setField(108, v); }
  @$pb.TagNumber(108)
  $core.bool hasDeployment() => $_has(28);
  @$pb.TagNumber(108)
  void clearDeployment() => clearField(108);
  @$pb.TagNumber(108)
  $376.Deployment ensureDeployment() => $_ensure(28);
  ...
  ///  Only returned in `GET` requests if `view=FULL` is set.
  @$pb.TagNumber(112)
  $375.ReadinessCheck get readinessCheck => $_getN(31);
  @$pb.TagNumber(112)
  set readinessCheck($375.ReadinessCheck v) { setField(112, v); }
  @$pb.TagNumber(112)
  $core.bool hasReadinessCheck() => $_has(31);
  @$pb.TagNumber(112)
  void clearReadinessCheck() => clearField(112);
  @$pb.TagNumber(112)
  $375.ReadinessCheck ensureReadinessCheck() => $_ensure(31);
  ...
  ///  Only returned in `GET` requests if `view=FULL` is set.
  @$pb.TagNumber(113)
  $375.LivenessCheck get livenessCheck => $_getN(32);
  @$pb.TagNumber(113)
  set livenessCheck($375.LivenessCheck v) { setField(113, v); }
  @$pb.TagNumber(113)
  $core.bool hasLivenessCheck() => $_has(32);
  @$pb.TagNumber(113)
  void clearLivenessCheck() => clearField(113);
  @$pb.TagNumber(113)
  $375.LivenessCheck ensureLivenessCheck() => $_ensure(32);
...
class AutomaticScaling extends $pb.GeneratedMessage {
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(_omitMessageNames ? '' : 'AutomaticScaling', package: const $pb.PackageName(_omitMessageNames ? '' : 'google.appengine.v1'), createEmptyInstance: create)
    ..aOM<$261.Duration>(1, _omitFieldNames ? '' : 'coolDownPeriod', subBuilder: $261.Duration.create)
    ...
    ..aOM<$261.Duration>(6, _omitFieldNames ? '' : 'maxPendingLatency', subBuilder: $261.Duration.create)
    ...
    ..aOM<$261.Duration>(9, _omitFieldNames ? '' : 'minPendingLatency', subBuilder: $261.Duration.create)
  ...
  /// Only applicable in the App Engine flexible environment.
  @$pb.TagNumber(1)
  $261.Duration get coolDownPeriod => $_getN(0);
  @$pb.TagNumber(1)
  set coolDownPeriod($261.Duration v) { setField(1, v); }
  @$pb.TagNumber(1)
  $core.bool hasCoolDownPeriod() => $_has(0);
  @$pb.TagNumber(1)
  void clearCoolDownPeriod() => clearField(1);
  @$pb.TagNumber(1)
  $261.Duration ensureCoolDownPeriod() => $_ensure(0);
  ...
  @$pb.TagNumber(6)
  $261.Duration get maxPendingLatency => $_getN(5);
  @$pb.TagNumber(6)
  set maxPendingLatency($261.Duration v) { setField(6, v); }
  @$pb.TagNumber(6)
  $core.bool hasMaxPendingLatency() => $_has(5);
  @$pb.TagNumber(6)
  void clearMaxPendingLatency() => clearField(6);
  @$pb.TagNumber(6)
  $261.Duration ensureMaxPendingLatency() => $_ensure(5);
  ...
  @$pb.TagNumber(9)
  $261.Duration get minPendingLatency => $_getN(8);
  @$pb.TagNumber(9)
  set minPendingLatency($261.Duration v) { setField(9, v); }
  @$pb.TagNumber(9)
  $core.bool hasMinPendingLatency() => $_has(8);
  @$pb.TagNumber(9)
  void clearMinPendingLatency() => clearField(9);
  @$pb.TagNumber(9)
  $261.Duration ensureMinPendingLatency() => $_ensure(8);
...
class BasicScaling extends $pb.GeneratedMessage {
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(_omitMessageNames ? '' : 'BasicScaling', package: const $pb.PackageName(_omitMessageNames ? '' : 'google.appengine.v1'), createEmptyInstance: create)
    ..aOM<$261.Duration>(1, _omitFieldNames ? '' : 'idleTimeout', subBuilder: $261.Duration.create)
  ...
  @$pb.TagNumber(1)
  $261.Duration get idleTimeout => $_getN(0);
  @$pb.TagNumber(1)
  set idleTimeout($261.Duration v) { setField(1, v); }
  @$pb.TagNumber(1)
  $core.bool hasIdleTimeout() => $_has(0);
  @$pb.TagNumber(1)
  void clearIdleTimeout() => clearField(1);
  @$pb.TagNumber(1)
  $261.Duration ensureIdleTimeout() => $_ensure(0);
...
class CpuUtilization extends $pb.GeneratedMessage {
  factory CpuUtilization({
    $261.Duration? aggregationWindowLength,
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(_omitMessageNames ? '' : 'CpuUtilization', package: const $pb.PackageName(_omitMessageNames ? '' : 'google.appengine.v1'), createEmptyInstance: create)
    ..aOM<$261.Duration>(1, _omitFieldNames ? '' : 'aggregationWindowLength', subBuilder: $261.Duration.create)
  ...
  @$pb.TagNumber(1)
  $261.Duration get aggregationWindowLength => $_getN(0);
  @$pb.TagNumber(1)
  set aggregationWindowLength($261.Duration v) { setField(1, v); }
  @$pb.TagNumber(1)
  $core.bool hasAggregationWindowLength() => $_has(0);
  @$pb.TagNumber(1)
  void clearAggregationWindowLength() => clearField(1);
  @$pb.TagNumber(1)
  $261.Duration ensureAggregationWindowLength() => $_ensure(0);
