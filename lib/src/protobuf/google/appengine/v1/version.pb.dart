...
import 'app_yaml.pb.dart' as $377;
import 'deploy.pb.dart' as $378;
...
class Version extends $pb.GeneratedMessage {
  factory Version({
    ...
    $core.Iterable<$377.UrlMap>? handlers,
    $core.Iterable<$377.ErrorHandler>? errorHandlers,
    $core.Iterable<$377.Library>? libraries,
    $377.ApiConfigHandler? apiConfig,
    $core.Map<$core.String, $core.String>? envVariables,
    $263.Duration? defaultExpiration,
    $377.HealthCheck? healthCheck,
    $core.String? nobuildFilesRegex,
    $378.Deployment? deployment,
    $core.String? versionUrl,
    EndpointsApiService? endpointsApiService,
    $377.ReadinessCheck? readinessCheck,
    $377.LivenessCheck? livenessCheck,
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(_omitMessageNames ? '' : 'Version', package: const $pb.PackageName(_omitMessageNames ? '' : 'google.appengine.v1'), createEmptyInstance: create)
    ..oo(0, [3, 4, 5])
    ...
    ..m<$core.String, $core.String>(13, _omitFieldNames ? '' : 'betaSettings', entryClassName: 'Version.BetaSettingsEntry', keyFieldType: $pb.PbFieldType.OS, valueFieldType: $pb.PbFieldType.OS, packageName: const $pb.PackageName('google.appengine.v1'))
    ...
    ..aOM<$301.Timestamp>(17, _omitFieldNames ? '' : 'createTime', subBuilder: $301.Timestamp.create)
    ...
    ..pc<$377.UrlMap>(100, _omitFieldNames ? '' : 'handlers', $pb.PbFieldType.PM, subBuilder: $377.UrlMap.create)
    ..pc<$377.ErrorHandler>(101, _omitFieldNames ? '' : 'errorHandlers', $pb.PbFieldType.PM, subBuilder: $377.ErrorHandler.create)
    ..pc<$377.Library>(102, _omitFieldNames ? '' : 'libraries', $pb.PbFieldType.PM, subBuilder: $377.Library.create)
    ..aOM<$377.ApiConfigHandler>(103, _omitFieldNames ? '' : 'apiConfig', subBuilder: $377.ApiConfigHandler.create)
    ...
    ..aOM<$263.Duration>(105, _omitFieldNames ? '' : 'defaultExpiration', subBuilder: $263.Duration.create)
    ..aOM<$377.HealthCheck>(106, _omitFieldNames ? '' : 'healthCheck', subBuilder: $377.HealthCheck.create)
    ..aOS(107, _omitFieldNames ? '' : 'nobuildFilesRegex')
    ..aOM<$378.Deployment>(108, _omitFieldNames ? '' : 'deployment', subBuilder: $378.Deployment.create)
    ...
    ..aOM<$377.ReadinessCheck>(112, _omitFieldNames ? '' : 'readinessCheck', subBuilder: $377.ReadinessCheck.create)
    ..aOM<$377.LivenessCheck>(113, _omitFieldNames ? '' : 'livenessCheck', subBuilder: $377.LivenessCheck.create)
    ...
    ..m<$core.String, $core.String>(125, _omitFieldNames ? '' : 'buildEnvVariables', entryClassName: 'Version.BuildEnvVariablesEntry', keyFieldType: $pb.PbFieldType.OS, valueFieldType: $pb.PbFieldType.OS, packageName: const $pb.PackageName('google.appengine.v1'))
  ...
  ///  @OutputOnly
  @$pb.TagNumber(17)
  $301.Timestamp get createTime => $_getN(16);
  @$pb.TagNumber(17)
  set createTime($301.Timestamp v) { setField(17, v); }
  @$pb.TagNumber(17)
  $core.bool hasCreateTime() => $_has(16);
  @$pb.TagNumber(17)
  void clearCreateTime() => clearField(17);
  @$pb.TagNumber(17)
  $301.Timestamp ensureCreateTime() => $_ensure(16);
  ...
  @$pb.TagNumber(100)
  $core.List<$377.UrlMap> get handlers => $_getList(20);

  ///  Custom static error pages. Limited to 10KB per page.
  ///
  ///  Only returned in `GET` requests if `view=FULL` is set.
  @$pb.TagNumber(101)
  $core.List<$377.ErrorHandler> get errorHandlers => $_getList(21);
  ...
  ///  Only returned in `GET` requests if `view=FULL` is set.
  @$pb.TagNumber(102)
  $core.List<$377.Library> get libraries => $_getList(22);
  ...
  ///  Only returned in `GET` requests if `view=FULL` is set.
  @$pb.TagNumber(103)
  $377.ApiConfigHandler get apiConfig => $_getN(23);
  @$pb.TagNumber(103)
  set apiConfig($377.ApiConfigHandler v) { setField(103, v); }
  @$pb.TagNumber(103)
  $core.bool hasApiConfig() => $_has(23);
  @$pb.TagNumber(103)
  void clearApiConfig() => clearField(103);
  @$pb.TagNumber(103)
  $377.ApiConfigHandler ensureApiConfig() => $_ensure(23);
  ...
  ///  Only returned in `GET` requests if `view=FULL` is set.
  @$pb.TagNumber(105)
  $263.Duration get defaultExpiration => $_getN(25);
  @$pb.TagNumber(105)
  set defaultExpiration($263.Duration v) { setField(105, v); }
  @$pb.TagNumber(105)
  $core.bool hasDefaultExpiration() => $_has(25);
  @$pb.TagNumber(105)
  void clearDefaultExpiration() => clearField(105);
  @$pb.TagNumber(105)
  $263.Duration ensureDefaultExpiration() => $_ensure(25);
  ...
  ///  Only returned in `GET` requests if `view=FULL` is set.
  @$pb.TagNumber(106)
  $377.HealthCheck get healthCheck => $_getN(26);
  @$pb.TagNumber(106)
  set healthCheck($377.HealthCheck v) { setField(106, v); }
  @$pb.TagNumber(106)
  $core.bool hasHealthCheck() => $_has(26);
  @$pb.TagNumber(106)
  void clearHealthCheck() => clearField(106);
  @$pb.TagNumber(106)
  $377.HealthCheck ensureHealthCheck() => $_ensure(26);
  ...
  ///  Only returned in `GET` requests if `view=FULL` is set.
  @$pb.TagNumber(108)
  $378.Deployment get deployment => $_getN(28);
  @$pb.TagNumber(108)
  set deployment($378.Deployment v) { setField(108, v); }
  @$pb.TagNumber(108)
  $core.bool hasDeployment() => $_has(28);
  @$pb.TagNumber(108)
  void clearDeployment() => clearField(108);
  @$pb.TagNumber(108)
  $378.Deployment ensureDeployment() => $_ensure(28);
  ...
  ///  Only returned in `GET` requests if `view=FULL` is set.
  @$pb.TagNumber(112)
  $377.ReadinessCheck get readinessCheck => $_getN(31);
  @$pb.TagNumber(112)
  set readinessCheck($377.ReadinessCheck v) { setField(112, v); }
  @$pb.TagNumber(112)
  $core.bool hasReadinessCheck() => $_has(31);
  @$pb.TagNumber(112)
  void clearReadinessCheck() => clearField(112);
  @$pb.TagNumber(112)
  $377.ReadinessCheck ensureReadinessCheck() => $_ensure(31);
  ...
  ///  Only returned in `GET` requests if `view=FULL` is set.
  @$pb.TagNumber(113)
  $377.LivenessCheck get livenessCheck => $_getN(32);
  @$pb.TagNumber(113)
  set livenessCheck($377.LivenessCheck v) { setField(113, v); }
  @$pb.TagNumber(113)
  $core.bool hasLivenessCheck() => $_has(32);
  @$pb.TagNumber(113)
  void clearLivenessCheck() => clearField(113);
  @$pb.TagNumber(113)
  $377.LivenessCheck ensureLivenessCheck() => $_ensure(32);
...
class EndpointsApiService extends $pb.GeneratedMessage {
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(_omitMessageNames ? '' : 'EndpointsApiService', package: const $pb.PackageName(_omitMessageNames ? '' : 'google.appengine.v1'), createEmptyInstance: create)
    ..aOS(1, _omitFieldNames ? '' : 'name')
...
class AutomaticScaling extends $pb.GeneratedMessage {
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(_omitMessageNames ? '' : 'AutomaticScaling', package: const $pb.PackageName(_omitMessageNames ? '' : 'google.appengine.v1'), createEmptyInstance: create)
    ..aOM<$263.Duration>(1, _omitFieldNames ? '' : 'coolDownPeriod', subBuilder: $263.Duration.create)
    ...
    ..aOM<$263.Duration>(6, _omitFieldNames ? '' : 'maxPendingLatency', subBuilder: $263.Duration.create)
    ...
    ..aOM<$263.Duration>(9, _omitFieldNames ? '' : 'minPendingLatency', subBuilder: $263.Duration.create)
  ...
  /// Only applicable in the App Engine flexible environment.
  @$pb.TagNumber(1)
  $263.Duration get coolDownPeriod => $_getN(0);
  @$pb.TagNumber(1)
  set coolDownPeriod($263.Duration v) { setField(1, v); }
  @$pb.TagNumber(1)
  $core.bool hasCoolDownPeriod() => $_has(0);
  @$pb.TagNumber(1)
  void clearCoolDownPeriod() => clearField(1);
  @$pb.TagNumber(1)
  $263.Duration ensureCoolDownPeriod() => $_ensure(0);
  ...
  @$pb.TagNumber(6)
  $263.Duration get maxPendingLatency => $_getN(5);
  @$pb.TagNumber(6)
  set maxPendingLatency($263.Duration v) { setField(6, v); }
  @$pb.TagNumber(6)
  $core.bool hasMaxPendingLatency() => $_has(5);
  @$pb.TagNumber(6)
  void clearMaxPendingLatency() => clearField(6);
  @$pb.TagNumber(6)
  $263.Duration ensureMaxPendingLatency() => $_ensure(5);
  ...
  @$pb.TagNumber(9)
  $263.Duration get minPendingLatency => $_getN(8);
  @$pb.TagNumber(9)
  set minPendingLatency($263.Duration v) { setField(9, v); }
  @$pb.TagNumber(9)
  $core.bool hasMinPendingLatency() => $_has(8);
  @$pb.TagNumber(9)
  void clearMinPendingLatency() => clearField(9);
  @$pb.TagNumber(9)
  $263.Duration ensureMinPendingLatency() => $_ensure(8);
...
class BasicScaling extends $pb.GeneratedMessage {
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(_omitMessageNames ? '' : 'BasicScaling', package: const $pb.PackageName(_omitMessageNames ? '' : 'google.appengine.v1'), createEmptyInstance: create)
    ..aOM<$263.Duration>(1, _omitFieldNames ? '' : 'idleTimeout', subBuilder: $263.Duration.create)
  ...
  @$pb.TagNumber(1)
  $263.Duration get idleTimeout => $_getN(0);
  @$pb.TagNumber(1)
  set idleTimeout($263.Duration v) { setField(1, v); }
  @$pb.TagNumber(1)
  $core.bool hasIdleTimeout() => $_has(0);
  @$pb.TagNumber(1)
  void clearIdleTimeout() => clearField(1);
  @$pb.TagNumber(1)
  $263.Duration ensureIdleTimeout() => $_ensure(0);
...
class ManualScaling extends $pb.GeneratedMessage {
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(_omitMessageNames ? '' : 'ManualScaling', package: const $pb.PackageName(_omitMessageNames ? '' : 'google.appengine.v1'), createEmptyInstance: create)
...
class CpuUtilization extends $pb.GeneratedMessage {
  factory CpuUtilization({
    $263.Duration? aggregationWindowLength,
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(_omitMessageNames ? '' : 'CpuUtilization', package: const $pb.PackageName(_omitMessageNames ? '' : 'google.appengine.v1'), createEmptyInstance: create)
    ..aOM<$263.Duration>(1, _omitFieldNames ? '' : 'aggregationWindowLength', subBuilder: $263.Duration.create)
  ...
  @$pb.TagNumber(1)
  $263.Duration get aggregationWindowLength => $_getN(0);
  @$pb.TagNumber(1)
  set aggregationWindowLength($263.Duration v) { setField(1, v); }
  @$pb.TagNumber(1)
  $core.bool hasAggregationWindowLength() => $_has(0);
  @$pb.TagNumber(1)
  void clearAggregationWindowLength() => clearField(1);
  @$pb.TagNumber(1)
  $263.Duration ensureAggregationWindowLength() => $_ensure(0);
...
class RequestUtilization extends $pb.GeneratedMessage {
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(_omitMessageNames ? '' : 'RequestUtilization', package: const $pb.PackageName(_omitMessageNames ? '' : 'google.appengine.v1'), createEmptyInstance: create)
...
class DiskUtilization extends $pb.GeneratedMessage {
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(_omitMessageNames ? '' : 'DiskUtilization', package: const $pb.PackageName(_omitMessageNames ? '' : 'google.appengine.v1'), createEmptyInstance: create)
...
class NetworkUtilization extends $pb.GeneratedMessage {
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(_omitMessageNames ? '' : 'NetworkUtilization', package: const $pb.PackageName(_omitMessageNames ? '' : 'google.appengine.v1'), createEmptyInstance: create)
...
class StandardSchedulerSettings extends $pb.GeneratedMessage {
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(_omitMessageNames ? '' : 'StandardSchedulerSettings', package: const $pb.PackageName(_omitMessageNames ? '' : 'google.appengine.v1'), createEmptyInstance: create)
...
class Network extends $pb.GeneratedMessage {
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(_omitMessageNames ? '' : 'Network', package: const $pb.PackageName(_omitMessageNames ? '' : 'google.appengine.v1'), createEmptyInstance: create)
...
class Volume extends $pb.GeneratedMessage {
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(_omitMessageNames ? '' : 'Volume', package: const $pb.PackageName(_omitMessageNames ? '' : 'google.appengine.v1'), createEmptyInstance: create)
    ..aOS(1, _omitFieldNames ? '' : 'name')
...
class Resources extends $pb.GeneratedMessage {
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(_omitMessageNames ? '' : 'Resources', package: const $pb.PackageName(_omitMessageNames ? '' : 'google.appengine.v1'), createEmptyInstance: create)
...
class VpcAccessConnector extends $pb.GeneratedMessage {
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(_omitMessageNames ? '' : 'VpcAccessConnector', package: const $pb.PackageName(_omitMessageNames ? '' : 'google.appengine.v1'), createEmptyInstance: create)
    ..aOS(1, _omitFieldNames ? '' : 'name')
    ..e<VpcAccessConnector_EgressSetting>(2, _omitFieldNames ? '' : 'egressSetting', $pb.PbFieldType.OE, defaultOrMaker: VpcAccessConnector_EgressSetting.EGRESS_SETTING_UNSPECIFIED, valueOf: VpcAccessConnector_EgressSetting.valueOf, enumValues: VpcAccessConnector_EgressSetting.values)
    ..hasRequiredFields = false
  ;
...
class Entrypoint extends $pb.GeneratedMessage {
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(_omitMessageNames ? '' : 'Entrypoint', package: const $pb.PackageName(_omitMessageNames ? '' : 'google.appengine.v1'), createEmptyInstance: create)
    ..oo(0, [1])
