...
import 'app_yaml.pb.dart' as $409;
import 'deploy.pb.dart' as $410;
...
class Version extends $pb.GeneratedMessage {
  factory Version({
    ...
    $core.Iterable<$409.UrlMap>? handlers,
    $core.Iterable<$409.ErrorHandler>? errorHandlers,
    $core.Iterable<$409.Library>? libraries,
    $409.ApiConfigHandler? apiConfig,
    $core.Map<$core.String, $core.String>? envVariables,
    $292.Duration? defaultExpiration,
    $409.HealthCheck? healthCheck,
    $core.String? nobuildFilesRegex,
    $410.Deployment? deployment,
    $core.String? versionUrl,
    EndpointsApiService? endpointsApiService,
    $409.ReadinessCheck? readinessCheck,
    $409.LivenessCheck? livenessCheck,
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(
    ...
    ..pc<$409.UrlMap>(
        ...
        subBuilder: $409.UrlMap.create)
    ..pc<$409.ErrorHandler>(
        101, _omitFieldNames ? '' : 'errorHandlers', $pb.PbFieldType.PM,
        subBuilder: $409.ErrorHandler.create)
    ..pc<$409.Library>(
        102, _omitFieldNames ? '' : 'libraries', $pb.PbFieldType.PM,
        subBuilder: $409.Library.create)
    ..aOM<$409.ApiConfigHandler>(103, _omitFieldNames ? '' : 'apiConfig',
        subBuilder: $409.ApiConfigHandler.create)
    ..m<$core.String, $core.String>(104, _omitFieldNames ? '' : 'envVariables',
        entryClassName: 'Version.EnvVariablesEntry',
        keyFieldType: $pb.PbFieldType.OS,
        valueFieldType: $pb.PbFieldType.OS,
        packageName: const $pb.PackageName('google.appengine.v1'))
    ..aOM<$292.Duration>(105, _omitFieldNames ? '' : 'defaultExpiration',
        subBuilder: $292.Duration.create)
    ..aOM<$409.HealthCheck>(106, _omitFieldNames ? '' : 'healthCheck',
        subBuilder: $409.HealthCheck.create)
    ..aOS(107, _omitFieldNames ? '' : 'nobuildFilesRegex')
    ..aOM<$410.Deployment>(108, _omitFieldNames ? '' : 'deployment',
        subBuilder: $410.Deployment.create)
    ...
    ..aOM<$409.ReadinessCheck>(112, _omitFieldNames ? '' : 'readinessCheck',
        subBuilder: $409.ReadinessCheck.create)
    ..aOM<$409.LivenessCheck>(113, _omitFieldNames ? '' : 'livenessCheck',
        subBuilder: $409.LivenessCheck.create)
  ...
  ///  @OutputOnly
  @$pb.TagNumber(17)
  $330.Timestamp get createTime => $_getN(16);
  @$pb.TagNumber(17)
  ...
  @$pb.TagNumber(17)
  $330.Timestamp ensureCreateTime() => $_ensure(16);
  ...
  @$pb.TagNumber(100)
  $core.List<$409.UrlMap> get handlers => $_getList(20);

  ///  Custom static error pages. Limited to 10KB per page.
  ///
  ///  Only returned in `GET` requests if `view=FULL` is set.
  @$pb.TagNumber(101)
  $core.List<$409.ErrorHandler> get errorHandlers => $_getList(21);
  ...
  ///  Only returned in `GET` requests if `view=FULL` is set.
  @$pb.TagNumber(102)
  $core.List<$409.Library> get libraries => $_getList(22);
  ...
  ///  Only returned in `GET` requests if `view=FULL` is set.
  @$pb.TagNumber(103)
  $409.ApiConfigHandler get apiConfig => $_getN(23);
  @$pb.TagNumber(103)
  set apiConfig($409.ApiConfigHandler v) {
    setField(103, v);
  }
  ...
  @$pb.TagNumber(103)
  $409.ApiConfigHandler ensureApiConfig() => $_ensure(23);
  ...
  ///  Only returned in `GET` requests if `view=FULL` is set.
  @$pb.TagNumber(105)
  $292.Duration get defaultExpiration => $_getN(25);
  @$pb.TagNumber(105)
  set defaultExpiration($292.Duration v) {
    setField(105, v);
  }
  ...
  @$pb.TagNumber(105)
  $292.Duration ensureDefaultExpiration() => $_ensure(25);
  ...
  ///  Only returned in `GET` requests if `view=FULL` is set.
  @$pb.TagNumber(106)
  $409.HealthCheck get healthCheck => $_getN(26);
  @$pb.TagNumber(106)
  set healthCheck($409.HealthCheck v) {
    setField(106, v);
  }
  ...
  @$pb.TagNumber(106)
  $409.HealthCheck ensureHealthCheck() => $_ensure(26);
  ...
  ///  Only returned in `GET` requests if `view=FULL` is set.
  @$pb.TagNumber(108)
  $410.Deployment get deployment => $_getN(28);
  @$pb.TagNumber(108)
  set deployment($410.Deployment v) {
    setField(108, v);
  }
  ...
  @$pb.TagNumber(108)
  $410.Deployment ensureDeployment() => $_ensure(28);
  ...
  ///  Only returned in `GET` requests if `view=FULL` is set.
  @$pb.TagNumber(112)
  $409.ReadinessCheck get readinessCheck => $_getN(31);
  @$pb.TagNumber(112)
  set readinessCheck($409.ReadinessCheck v) {
    setField(112, v);
  }
  ...
  @$pb.TagNumber(112)
  $409.ReadinessCheck ensureReadinessCheck() => $_ensure(31);
  ...
  ///  Only returned in `GET` requests if `view=FULL` is set.
  @$pb.TagNumber(113)
  $409.LivenessCheck get livenessCheck => $_getN(32);
  @$pb.TagNumber(113)
  set livenessCheck($409.LivenessCheck v) {
    setField(113, v);
  }
  ...
  @$pb.TagNumber(113)
  $409.LivenessCheck ensureLivenessCheck() => $_ensure(32);
...
class AutomaticScaling extends $pb.GeneratedMessage {
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(
      ...
      package:
          const $pb.PackageName(_omitMessageNames ? '' : 'google.appengine.v1'),
      createEmptyInstance: create)
    ..aOM<$292.Duration>(1, _omitFieldNames ? '' : 'coolDownPeriod',
        subBuilder: $292.Duration.create)
  ...
  /// Only applicable in the App Engine flexible environment.
  @$pb.TagNumber(1)
  $292.Duration get coolDownPeriod => $_getN(0);
  @$pb.TagNumber(1)
  set coolDownPeriod($292.Duration v) {
    setField(1, v);
  }
  ...
  @$pb.TagNumber(1)
  $292.Duration ensureCoolDownPeriod() => $_ensure(0);
  ...
  @$pb.TagNumber(6)
  $292.Duration get maxPendingLatency => $_getN(5);
  @$pb.TagNumber(6)
  set maxPendingLatency($292.Duration v) {
    setField(6, v);
  }
  ...
  @$pb.TagNumber(6)
  $292.Duration ensureMaxPendingLatency() => $_ensure(5);
  ...
  @$pb.TagNumber(9)
  $292.Duration get minPendingLatency => $_getN(8);
  @$pb.TagNumber(9)
  set minPendingLatency($292.Duration v) {
    setField(9, v);
  }
  ...
  @$pb.TagNumber(9)
  $292.Duration ensureMinPendingLatency() => $_ensure(8);
...
class BasicScaling extends $pb.GeneratedMessage {
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(
      ...
      package:
          const $pb.PackageName(_omitMessageNames ? '' : 'google.appengine.v1'),
      createEmptyInstance: create)
    ..aOM<$292.Duration>(1, _omitFieldNames ? '' : 'idleTimeout',
        subBuilder: $292.Duration.create)
  ...
  @$pb.TagNumber(1)
  $292.Duration get idleTimeout => $_getN(0);
  @$pb.TagNumber(1)
  set idleTimeout($292.Duration v) {
    setField(1, v);
  }
  ...
  @$pb.TagNumber(1)
  $292.Duration ensureIdleTimeout() => $_ensure(0);
...
class CpuUtilization extends $pb.GeneratedMessage {
  factory CpuUtilization({
    $292.Duration? aggregationWindowLength,
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(
      ...
      package:
          const $pb.PackageName(_omitMessageNames ? '' : 'google.appengine.v1'),
      createEmptyInstance: create)
    ..aOM<$292.Duration>(1, _omitFieldNames ? '' : 'aggregationWindowLength',
        subBuilder: $292.Duration.create)
    ..a<$core.double>(
  ...
  @$pb.TagNumber(1)
  $292.Duration get aggregationWindowLength => $_getN(0);
  @$pb.TagNumber(1)
  set aggregationWindowLength($292.Duration v) {
    setField(1, v);
  }
  ...
  @$pb.TagNumber(1)
  $292.Duration ensureAggregationWindowLength() => $_ensure(0);
