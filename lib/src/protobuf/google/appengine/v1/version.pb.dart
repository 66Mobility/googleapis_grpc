...
import 'app_yaml.pb.dart' as $378;
import 'deploy.pb.dart' as $379;
...
class Version extends $pb.GeneratedMessage {
  factory Version({
    ...
    $core.Iterable<$378.UrlMap>? handlers,
    $core.Iterable<$378.ErrorHandler>? errorHandlers,
    $core.Iterable<$378.Library>? libraries,
    $378.ApiConfigHandler? apiConfig,
    $core.Map<$core.String, $core.String>? envVariables,
    $264.Duration? defaultExpiration,
    $378.HealthCheck? healthCheck,
    $core.String? nobuildFilesRegex,
    $379.Deployment? deployment,
    $core.String? versionUrl,
    EndpointsApiService? endpointsApiService,
    $378.ReadinessCheck? readinessCheck,
    $378.LivenessCheck? livenessCheck,
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(_omitMessageNames ? '' : 'Version', package: const $pb.PackageName(_omitMessageNames ? '' : 'google.appengine.v1'), createEmptyInstance: create)
    ...
    ..pc<$378.UrlMap>(100, _omitFieldNames ? '' : 'handlers', $pb.PbFieldType.PM, subBuilder: $378.UrlMap.create)
    ..pc<$378.ErrorHandler>(101, _omitFieldNames ? '' : 'errorHandlers', $pb.PbFieldType.PM, subBuilder: $378.ErrorHandler.create)
    ..pc<$378.Library>(102, _omitFieldNames ? '' : 'libraries', $pb.PbFieldType.PM, subBuilder: $378.Library.create)
    ..aOM<$378.ApiConfigHandler>(103, _omitFieldNames ? '' : 'apiConfig', subBuilder: $378.ApiConfigHandler.create)
    ...
    ..aOM<$378.HealthCheck>(106, _omitFieldNames ? '' : 'healthCheck', subBuilder: $378.HealthCheck.create)
    ..aOS(107, _omitFieldNames ? '' : 'nobuildFilesRegex')
    ..aOM<$379.Deployment>(108, _omitFieldNames ? '' : 'deployment', subBuilder: $379.Deployment.create)
    ...
    ..aOM<$378.ReadinessCheck>(112, _omitFieldNames ? '' : 'readinessCheck', subBuilder: $378.ReadinessCheck.create)
    ..aOM<$378.LivenessCheck>(113, _omitFieldNames ? '' : 'livenessCheck', subBuilder: $378.LivenessCheck.create)
  ...
  @$pb.TagNumber(17)
  $302.Timestamp ensureCreateTime() => $_ensure(16);
  ...
  @$pb.TagNumber(100)
  $core.List<$378.UrlMap> get handlers => $_getList(20);

  ///  Custom static error pages. Limited to 10KB per page.
  ///
  ///  Only returned in `GET` requests if `view=FULL` is set.
  @$pb.TagNumber(101)
  $core.List<$378.ErrorHandler> get errorHandlers => $_getList(21);
  ...
  ///  Only returned in `GET` requests if `view=FULL` is set.
  @$pb.TagNumber(102)
  $core.List<$378.Library> get libraries => $_getList(22);
  ...
  ///  Only returned in `GET` requests if `view=FULL` is set.
  @$pb.TagNumber(103)
  $378.ApiConfigHandler get apiConfig => $_getN(23);
  @$pb.TagNumber(103)
  set apiConfig($378.ApiConfigHandler v) { setField(103, v); }
  @$pb.TagNumber(103)
  $core.bool hasApiConfig() => $_has(23);
  @$pb.TagNumber(103)
  void clearApiConfig() => clearField(103);
  @$pb.TagNumber(103)
  $378.ApiConfigHandler ensureApiConfig() => $_ensure(23);
  ...
  @$pb.TagNumber(105)
  $264.Duration ensureDefaultExpiration() => $_ensure(25);
  ...
  ///  Only returned in `GET` requests if `view=FULL` is set.
  @$pb.TagNumber(106)
  $378.HealthCheck get healthCheck => $_getN(26);
  @$pb.TagNumber(106)
  set healthCheck($378.HealthCheck v) { setField(106, v); }
  @$pb.TagNumber(106)
  $core.bool hasHealthCheck() => $_has(26);
  @$pb.TagNumber(106)
  void clearHealthCheck() => clearField(106);
  @$pb.TagNumber(106)
  $378.HealthCheck ensureHealthCheck() => $_ensure(26);
  ...
  ///  Only returned in `GET` requests if `view=FULL` is set.
  @$pb.TagNumber(108)
  $379.Deployment get deployment => $_getN(28);
  @$pb.TagNumber(108)
  set deployment($379.Deployment v) { setField(108, v); }
  @$pb.TagNumber(108)
  $core.bool hasDeployment() => $_has(28);
  @$pb.TagNumber(108)
  void clearDeployment() => clearField(108);
  @$pb.TagNumber(108)
  $379.Deployment ensureDeployment() => $_ensure(28);
  ...
  ///  Only returned in `GET` requests if `view=FULL` is set.
  @$pb.TagNumber(112)
  $378.ReadinessCheck get readinessCheck => $_getN(31);
  @$pb.TagNumber(112)
  set readinessCheck($378.ReadinessCheck v) { setField(112, v); }
  @$pb.TagNumber(112)
  $core.bool hasReadinessCheck() => $_has(31);
  @$pb.TagNumber(112)
  void clearReadinessCheck() => clearField(112);
  @$pb.TagNumber(112)
  $378.ReadinessCheck ensureReadinessCheck() => $_ensure(31);
  ...
  ///  Only returned in `GET` requests if `view=FULL` is set.
  @$pb.TagNumber(113)
  $378.LivenessCheck get livenessCheck => $_getN(32);
  @$pb.TagNumber(113)
  set livenessCheck($378.LivenessCheck v) { setField(113, v); }
  @$pb.TagNumber(113)
  $core.bool hasLivenessCheck() => $_has(32);
  @$pb.TagNumber(113)
  void clearLivenessCheck() => clearField(113);
  @$pb.TagNumber(113)
  $378.LivenessCheck ensureLivenessCheck() => $_ensure(32);
...
class AutomaticScaling extends $pb.GeneratedMessage {
  ...
  @$pb.TagNumber(1)
  $264.Duration ensureCoolDownPeriod() => $_ensure(0);
  ...
  @$pb.TagNumber(6)
  $264.Duration ensureMaxPendingLatency() => $_ensure(5);
  ...
  @$pb.TagNumber(9)
  $264.Duration ensureMinPendingLatency() => $_ensure(8);
...
class BasicScaling extends $pb.GeneratedMessage {
  ...
  @$pb.TagNumber(1)
  $264.Duration ensureIdleTimeout() => $_ensure(0);
...
class CpuUtilization extends $pb.GeneratedMessage {
  factory CpuUtilization({
    $264.Duration? aggregationWindowLength,
  ...
  @$pb.TagNumber(1)
  $264.Duration ensureAggregationWindowLength() => $_ensure(0);
