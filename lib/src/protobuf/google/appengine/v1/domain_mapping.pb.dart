...
class DomainMapping extends $pb.GeneratedMessage {
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(_omitMessageNames ? '' : 'DomainMapping', package: const $pb.PackageName(_omitMessageNames ? '' : 'google.appengine.v1'), createEmptyInstance: create)
...
class SslSettings extends $pb.GeneratedMessage {
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(_omitMessageNames ? '' : 'SslSettings', package: const $pb.PackageName(_omitMessageNames ? '' : 'google.appengine.v1'), createEmptyInstance: create)
    ..aOS(1, _omitFieldNames ? '' : 'certificateId')
    ..e<SslSettings_SslManagementType>(3, _omitFieldNames ? '' : 'sslManagementType', $pb.PbFieldType.OE, defaultOrMaker: SslSettings_SslManagementType.SSL_MANAGEMENT_TYPE_UNSPECIFIED, valueOf: SslSettings_SslManagementType.valueOf, enumValues: SslSettings_SslManagementType.values)
...
class ResourceRecord extends $pb.GeneratedMessage {
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(_omitMessageNames ? '' : 'ResourceRecord', package: const $pb.PackageName(_omitMessageNames ? '' : 'google.appengine.v1'), createEmptyInstance: create)
    ..aOS(1, _omitFieldNames ? '' : 'name')
    ..aOS(2, _omitFieldNames ? '' : 'rrdata')
    ..e<ResourceRecord_RecordType>(3, _omitFieldNames ? '' : 'type', $pb.PbFieldType.OE, defaultOrMaker: ResourceRecord_RecordType.RECORD_TYPE_UNSPECIFIED, valueOf: ResourceRecord_RecordType.valueOf, enumValues: ResourceRecord_RecordType.values)
    ..hasRequiredFields = false
  ;
