...
class Application extends $pb.GeneratedMessage {
  factory Application({
    ...
    $292.Duration? defaultCookieExpiration,
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(
    ...
    ..aOM<$292.Duration>(9, _omitFieldNames ? '' : 'defaultCookieExpiration',
  ...
  @$pb.TagNumber(9)
  $292.Duration get defaultCookieExpiration => $_getN(6);
  @$pb.TagNumber(9)
  set defaultCookieExpiration($292.Duration v) {
    setField(9, v);
  }
  ...
  @$pb.TagNumber(9)
  $292.Duration ensureDefaultCookieExpiration() => $_ensure(6);
