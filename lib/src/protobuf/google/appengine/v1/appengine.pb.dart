...
class CreateApplicationRequest extends $pb.GeneratedMessage {
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(
      ...
      package:
          const $pb.PackageName(_omitMessageNames ? '' : 'google.appengine.v1'),
      createEmptyInstance: create)
    ..aOM<$50.Application>(2, _omitFieldNames ? '' : 'application',
        subBuilder: $50.Application.create)
    ..hasRequiredFields = false;
  ...
  @$pb.TagNumber(2)
  set application($50.Application v) {
    setField(2, v);
  }
...
class ListServicesResponse extends $pb.GeneratedMessage {
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(
      ...
      package:
          const $pb.PackageName(_omitMessageNames ? '' : 'google.appengine.v1'),
      createEmptyInstance: create)
    ..pc<$51.Service>(1, _omitFieldNames ? '' : 'services', $pb.PbFieldType.PM,
        subBuilder: $51.Service.create)
...
class UpdateServiceRequest extends $pb.GeneratedMessage {
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(
      ...
      createEmptyInstance: create)
    ..aOS(1, _omitFieldNames ? '' : 'name')
    ..aOM<$51.Service>(2, _omitFieldNames ? '' : 'service',
        subBuilder: $51.Service.create)
    ..aOM<$335.FieldMask>(3, _omitFieldNames ? '' : 'updateMask',
        subBuilder: $335.FieldMask.create)
...
class ListVersionsResponse extends $pb.GeneratedMessage {
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(
      ...
      package:
          const $pb.PackageName(_omitMessageNames ? '' : 'google.appengine.v1'),
      createEmptyInstance: create)
    ..pc<$52.Version>(1, _omitFieldNames ? '' : 'versions', $pb.PbFieldType.PM,
        subBuilder: $52.Version.create)
    ..aOS(2, _omitFieldNames ? '' : 'nextPageToken')
    ..hasRequiredFields = false;
...
class CreateVersionRequest extends $pb.GeneratedMessage {
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(
      ...
      createEmptyInstance: create)
    ..aOS(1, _omitFieldNames ? '' : 'parent')
    ..aOM<$52.Version>(2, _omitFieldNames ? '' : 'version',
        subBuilder: $52.Version.create)
    ..hasRequiredFields = false;
...
class ListIngressRulesResponse extends $pb.GeneratedMessage {
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(
    ...
    ..pc<$54.FirewallRule>(
        ...
        subBuilder: $54.FirewallRule.create)
    ..aOS(2, _omitFieldNames ? '' : 'nextPageToken')
    ..hasRequiredFields = false;
...
class CreateIngressRuleRequest extends $pb.GeneratedMessage {
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(
      ...
      createEmptyInstance: create)
    ..aOS(1, _omitFieldNames ? '' : 'parent')
    ..aOM<$54.FirewallRule>(2, _omitFieldNames ? '' : 'rule',
        subBuilder: $54.FirewallRule.create)
    ..hasRequiredFields = false;
...
class ListAuthorizedDomainsResponse extends $pb.GeneratedMessage {
  factory ListAuthorizedDomainsResponse({
    $core.Iterable<$382.AuthorizedDomain>? domains,
    $core.String? nextPageToken,
  }) {
    final $result = create();
    if (domains != null) {
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(
      ...
      package:
          const $pb.PackageName(_omitMessageNames ? '' : 'google.appengine.v1'),
      createEmptyInstance: create)
    ..pc<$382.AuthorizedDomain>(
        1, _omitFieldNames ? '' : 'domains', $pb.PbFieldType.PM,
        subBuilder: $382.AuthorizedDomain.create)
    ..aOS(2, _omitFieldNames ? '' : 'nextPageToken')
    ..hasRequiredFields = false;
  ...
  @$pb.TagNumber(1)
  $core.List<$382.AuthorizedDomain> get domains => $_getList(0);
...
class ListAuthorizedCertificatesResponse extends $pb.GeneratedMessage {
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(
      ...
      package:
          const $pb.PackageName(_omitMessageNames ? '' : 'google.appengine.v1'),
      createEmptyInstance: create)
    ..pc<$55.AuthorizedCertificate>(
        1, _omitFieldNames ? '' : 'certificates', $pb.PbFieldType.PM,
        subBuilder: $55.AuthorizedCertificate.create)
    ..aOS(2, _omitFieldNames ? '' : 'nextPageToken')
    ..hasRequiredFields = false;
...
class CreateAuthorizedCertificateRequest extends $pb.GeneratedMessage {
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(
      ...
      createEmptyInstance: create)
    ..aOS(1, _omitFieldNames ? '' : 'parent')
    ..aOM<$55.AuthorizedCertificate>(2, _omitFieldNames ? '' : 'certificate',
        subBuilder: $55.AuthorizedCertificate.create)
    ..hasRequiredFields = false;
  ...
  @$pb.TagNumber(2)
  set certificate($55.AuthorizedCertificate v) {
    setField(2, v);
  }
...
class ListDomainMappingsResponse extends $pb.GeneratedMessage {
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(
    ...
    ..pc<$56.DomainMapping>(
        ...
        subBuilder: $56.DomainMapping.create)
    ..aOS(2, _omitFieldNames ? '' : 'nextPageToken')
    ..hasRequiredFields = false;
...
class CreateDomainMappingRequest extends $pb.GeneratedMessage {
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(
      ...
      createEmptyInstance: create)
    ..aOS(1, _omitFieldNames ? '' : 'parent')
    ..aOM<$56.DomainMapping>(2, _omitFieldNames ? '' : 'domainMapping',
        subBuilder: $56.DomainMapping.create)
  ...
  @$pb.TagNumber(2)
  set domainMapping($56.DomainMapping v) {
    setField(2, v);
  }
