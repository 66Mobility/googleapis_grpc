...
class LogLine extends $pb.GeneratedMessage {
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(_omitMessageNames ? '' : 'LogLine', package: const $pb.PackageName(_omitMessageNames ? '' : 'google.appengine.logging.v1'), createEmptyInstance: create)
    ...
    ..e<$366.LogSeverity>(2, _omitFieldNames ? '' : 'severity', $pb.PbFieldType.OE, defaultOrMaker: $366.LogSeverity.DEFAULT, valueOf: $366.LogSeverity.valueOf, enumValues: $366.LogSeverity.values)
  ...
  @$pb.TagNumber(2)
  $366.LogSeverity get severity => $_getN(1);
  @$pb.TagNumber(2)
  set severity($366.LogSeverity v) { setField(2, v); }
  @$pb.TagNumber(2)
...
class RequestLog extends $pb.GeneratedMessage {
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(_omitMessageNames ? '' : 'RequestLog', package: const $pb.PackageName(_omitMessageNames ? '' : 'google.appengine.logging.v1'), createEmptyInstance: create)
    ...
    ..aOM<$261.Duration>(8, _omitFieldNames ? '' : 'latency', subBuilder: $261.Duration.create)
    ...
    ..aOM<$261.Duration>(25, _omitFieldNames ? '' : 'pendingTime', subBuilder: $261.Duration.create)
  ...
  @$pb.TagNumber(8)
  $261.Duration get latency => $_getN(6);
  @$pb.TagNumber(8)
  set latency($261.Duration v) { setField(8, v); }
  @$pb.TagNumber(8)
  $core.bool hasLatency() => $_has(6);
  @$pb.TagNumber(8)
  void clearLatency() => clearField(8);
  @$pb.TagNumber(8)
  $261.Duration ensureLatency() => $_ensure(6);
  ...
  @$pb.TagNumber(25)
  $261.Duration get pendingTime => $_getN(21);
  @$pb.TagNumber(25)
  set pendingTime($261.Duration v) { setField(25, v); }
  @$pb.TagNumber(25)
  $core.bool hasPendingTime() => $_has(21);
  @$pb.TagNumber(25)
  void clearPendingTime() => clearField(25);
  @$pb.TagNumber(25)
  $261.Duration ensurePendingTime() => $_ensure(21);
