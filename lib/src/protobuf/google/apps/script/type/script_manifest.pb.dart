...
import 'addon_widget_set.pb.dart' as $4211;
...
class CommonAddOnManifest extends $pb.GeneratedMessage {
  factory CommonAddOnManifest({
    ...
    $4211.AddOnWidgetSet? addOnWidgetSet,
    $core.bool? useLocaleFromApp,
    $4210.HomepageExtensionPoint? homepageTrigger,
    $core.Iterable<$4210.UniversalActionExtensionPoint>? universalActions,
    $1734.ListValue? openLinkUrlPrefixes,
  }) {
    final $result = create();
    if (name != null) {
      $result.name = name;
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(_omitMessageNames ? '' : 'CommonAddOnManifest', package: const $pb.PackageName(_omitMessageNames ? '' : 'google.apps.script.type'), createEmptyInstance: create)
    ..aOS(1, _omitFieldNames ? '' : 'name')
    ..aOS(2, _omitFieldNames ? '' : 'logoUrl')
    ..aOM<LayoutProperties>(3, _omitFieldNames ? '' : 'layoutProperties', subBuilder: LayoutProperties.create)
    ..aOM<$4211.AddOnWidgetSet>(4, _omitFieldNames ? '' : 'addOnWidgetSet', subBuilder: $4211.AddOnWidgetSet.create)
    ..aOB(5, _omitFieldNames ? '' : 'useLocaleFromApp')
    ..aOM<$4210.HomepageExtensionPoint>(6, _omitFieldNames ? '' : 'homepageTrigger', subBuilder: $4210.HomepageExtensionPoint.create)
    ..pc<$4210.UniversalActionExtensionPoint>(7, _omitFieldNames ? '' : 'universalActions', $pb.PbFieldType.PM, subBuilder: $4210.UniversalActionExtensionPoint.create)
    ..aOM<$1734.ListValue>(8, _omitFieldNames ? '' : 'openLinkUrlPrefixes', subBuilder: $1734.ListValue.create)
  ...
  'Will be removed in next major version')
  CommonAddOnManifest copyWith(void Function(CommonAddOnManifest) updates) => super.copyWith((message) => updates(message as CommonAddOnManifest)) as CommonAddOnManifest;
  ...
  @$pb.TagNumber(4)
  $4211.AddOnWidgetSet get addOnWidgetSet => $_getN(3);
  @$pb.TagNumber(4)
  set addOnWidgetSet($4211.AddOnWidgetSet v) { setField(4, v); }
  @$pb.TagNumber(4)
  $core.bool hasAddOnWidgetSet() => $_has(3);
  @$pb.TagNumber(4)
  void clearAddOnWidgetSet() => clearField(4);
  @$pb.TagNumber(4)
  $4211.AddOnWidgetSet ensureAddOnWidgetSet() => $_ensure(3);
  ...
  @$pb.TagNumber(6)
  $4210.HomepageExtensionPoint get homepageTrigger => $_getN(5);
  @$pb.TagNumber(6)
  set homepageTrigger($4210.HomepageExtensionPoint v) { setField(6, v); }
  @$pb.TagNumber(6)
  $core.bool hasHomepageTrigger() => $_has(5);
  @$pb.TagNumber(6)
  void clearHomepageTrigger() => clearField(6);
  @$pb.TagNumber(6)
  $4210.HomepageExtensionPoint ensureHomepageTrigger() => $_ensure(5);
  ...
  /// submission.
  @$pb.TagNumber(7)
  $core.List<$4210.UniversalActionExtensionPoint> get universalActions => $_getList(6);
  ...
  /// links.
  @$pb.TagNumber(8)
  $1734.ListValue get openLinkUrlPrefixes => $_getN(7);
  @$pb.TagNumber(8)
  set openLinkUrlPrefixes($1734.ListValue v) { setField(8, v); }
  @$pb.TagNumber(8)
  $core.bool hasOpenLinkUrlPrefixes() => $_has(7);
  @$pb.TagNumber(8)
  void clearOpenLinkUrlPrefixes() => clearField(8);
  @$pb.TagNumber(8)
  $1734.ListValue ensureOpenLinkUrlPrefixes() => $_ensure(7);
}
...
class LayoutProperties extends $pb.GeneratedMessage {
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(_omitMessageNames ? '' : 'LayoutProperties', package: const $pb.PackageName(_omitMessageNames ? '' : 'google.apps.script.type'), createEmptyInstance: create)
  ...
  'Use [GeneratedMessageGenericExtensions.rebuild] instead. '
  'Will be removed in next major version')
  LayoutProperties copyWith(void Function(LayoutProperties) updates) => super.copyWith((message) => updates(message as LayoutProperties)) as LayoutProperties;
...
class HttpOptions extends $pb.GeneratedMessage {
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(_omitMessageNames ? '' : 'HttpOptions', package: const $pb.PackageName(_omitMessageNames ? '' : 'google.apps.script.type'), createEmptyInstance: create)
    ..e<HttpAuthorizationHeader>(1, _omitFieldNames ? '' : 'authorizationHeader', $pb.PbFieldType.OE, defaultOrMaker: HttpAuthorizationHeader.HTTP_AUTHORIZATION_HEADER_UNSPECIFIED, valueOf: HttpAuthorizationHeader.valueOf, enumValues: HttpAuthorizationHeader.values)
    ..hasRequiredFields = false
  ;
  ...
  'Use [GeneratedMessageGenericExtensions.rebuild] instead. '
  'Will be removed in next major version')
  HttpOptions copyWith(void Function(HttpOptions) updates) => super.copyWith((message) => updates(message as HttpOptions)) as HttpOptions;
