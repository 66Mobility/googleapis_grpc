...
class GmailAddOnManifest extends $pb.GeneratedMessage {
  ...
  @$pb.TagNumber(14)
  $427.HomepageExtensionPoint get homepageTrigger => $_getN(4);
  @$pb.TagNumber(14)
  ...
  @$pb.TagNumber(14)
  $427.HomepageExtensionPoint ensureHomepageTrigger() => $_ensure(4);
}
...
class ComposeTrigger extends $pb.GeneratedMessage {
  factory ComposeTrigger({
    ...
    $core.Iterable<$427.MenuItemExtensionPoint>? actions,
  }) {
    final $result = create();
    if (draftAccess != null) {
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(
    ...
    ..pc<$427.MenuItemExtensionPoint>(
        5, _omitFieldNames ? '' : 'actions', $pb.PbFieldType.PM,
        subBuilder: $427.MenuItemExtensionPoint.create)
    ..hasRequiredFields = false;
  ...
  @$pb.TagNumber(5)
  $core.List<$427.MenuItemExtensionPoint> get actions => $_getList(1);
}
