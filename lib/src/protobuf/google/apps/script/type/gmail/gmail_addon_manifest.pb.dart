...
class GmailAddOnManifest extends $pb.GeneratedMessage {
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(_omitMessageNames ? '' : 'GmailAddOnManifest', package: const $pb.PackageName(_omitMessageNames ? '' : 'google.apps.script.type.gmail'), createEmptyInstance: create)
    ...
    ..aOM<$4210.HomepageExtensionPoint>(14, _omitFieldNames ? '' : 'homepageTrigger', subBuilder: $4210.HomepageExtensionPoint.create)
  ...
  @$pb.TagNumber(14)
  $4210.HomepageExtensionPoint get homepageTrigger => $_getN(4);
  @$pb.TagNumber(14)
  set homepageTrigger($4210.HomepageExtensionPoint v) { setField(14, v); }
  @$pb.TagNumber(14)
  $core.bool hasHomepageTrigger() => $_has(4);
  @$pb.TagNumber(14)
  void clearHomepageTrigger() => clearField(14);
  @$pb.TagNumber(14)
  $4210.HomepageExtensionPoint ensureHomepageTrigger() => $_ensure(4);
}
...
class ComposeTrigger extends $pb.GeneratedMessage {
  factory ComposeTrigger({
    ...
    $core.Iterable<$4210.MenuItemExtensionPoint>? actions,
  }) {
    final $result = create();
    if (draftAccess != null) {
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(_omitMessageNames ? '' : 'ComposeTrigger', package: const $pb.PackageName(_omitMessageNames ? '' : 'google.apps.script.type.gmail'), createEmptyInstance: create)
    ...
    ..pc<$4210.MenuItemExtensionPoint>(5, _omitFieldNames ? '' : 'actions', $pb.PbFieldType.PM, subBuilder: $4210.MenuItemExtensionPoint.create)
    ..hasRequiredFields = false
  ;
  ...
  @$pb.TagNumber(5)
  $core.List<$4210.MenuItemExtensionPoint> get actions => $_getList(1);
}
