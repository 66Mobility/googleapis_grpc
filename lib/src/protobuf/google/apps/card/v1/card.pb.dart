...
class Button extends $pb.GeneratedMessage {
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(_omitMessageNames ? '' : 'Button', package: const $pb.PackageName(_omitMessageNames ? '' : 'google.apps.card.v1'), createEmptyInstance: create)
    ...
    ..aOM<$4199.Color>(3, _omitFieldNames ? '' : 'color', subBuilder: $4199.Color.create)
  ...
  ///  ```
  @$pb.TagNumber(3)
  $4199.Color get color => $_getN(2);
  @$pb.TagNumber(3)
  set color($4199.Color v) { setField(3, v); }
  @$pb.TagNumber(3)
  $core.bool hasColor() => $_has(2);
  @$pb.TagNumber(3)
  void clearColor() => clearField(3);
  @$pb.TagNumber(3)
  $4199.Color ensureColor() => $_ensure(2);
...
class BorderStyle extends $pb.GeneratedMessage {
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(_omitMessageNames ? '' : 'BorderStyle', package: const $pb.PackageName(_omitMessageNames ? '' : 'google.apps.card.v1'), createEmptyInstance: create)
    ...
    ..aOM<$4199.Color>(2, _omitFieldNames ? '' : 'strokeColor', subBuilder: $4199.Color.create)
  ...
  @$pb.TagNumber(2)
  $4199.Color get strokeColor => $_getN(1);
  @$pb.TagNumber(2)
  set strokeColor($4199.Color v) { setField(2, v); }
  @$pb.TagNumber(2)
  $core.bool hasStrokeColor() => $_has(1);
  @$pb.TagNumber(2)
  void clearStrokeColor() => clearField(2);
  @$pb.TagNumber(2)
  $4199.Color ensureStrokeColor() => $_ensure(1);
