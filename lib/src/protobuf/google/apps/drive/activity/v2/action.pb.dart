...
class Action extends $pb.GeneratedMessage {
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(
    ...
    ..aOM<$386.Actor>(3, _omitFieldNames ? '' : 'actor',
        subBuilder: $386.Actor.create)
    ..aOM<$388.Target>(4, _omitFieldNames ? '' : 'target',
        subBuilder: $388.Target.create)
    ..aOM<$302.Timestamp>(5, _omitFieldNames ? '' : 'timestamp',
        subBuilder: $302.Timestamp.create)
    ..aOM<$387.TimeRange>(6, _omitFieldNames ? '' : 'timeRange',
        subBuilder: $387.TimeRange.create)
...
class Create_Copy extends $pb.GeneratedMessage {
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(
      ...
      package: const $pb.PackageName(
          _omitMessageNames ? '' : 'google.apps.drive.activity.v2'),
      createEmptyInstance: create)
    ..aOM<$388.TargetReference>(1, _omitFieldNames ? '' : 'originalObject',
        subBuilder: $388.TargetReference.create)
    ..hasRequiredFields = false;
  ...
  @$pb.TagNumber(1)
  set originalObject($388.TargetReference v) {
    setField(1, v);
  }
...
class Permission extends $pb.GeneratedMessage {
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(
    ...
    ..aOM<$386.User>(2, _omitFieldNames ? '' : 'user',
        subBuilder: $386.User.create)
    ..aOM<$387.Group>(3, _omitFieldNames ? '' : 'group',
        subBuilder: $387.Group.create)
    ..aOM<$387.Domain>(4, _omitFieldNames ? '' : 'domain',
...
class Comment_Assignment extends $pb.GeneratedMessage {
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(
    ...
    ..aOM<$386.User>(7, _omitFieldNames ? '' : 'assignedUser',
        subBuilder: $386.User.create)
    ..hasRequiredFields = false;
...
class AppliedLabelChange_AppliedLabelChangeDetail_FieldValueChange_FieldValue_Date
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(
      ...
      package: const $pb.PackageName(
          _omitMessageNames ? '' : 'google.apps.drive.activity.v2'),
      createEmptyInstance: create)
    ..aOM<$302.Timestamp>(1, _omitFieldNames ? '' : 'value',
        subBuilder: $302.Timestamp.create)
    ..hasRequiredFields = false;
