...
class Actor extends $pb.GeneratedMessage {
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(_omitMessageNames ? '' : 'Actor', package: const $pb.PackageName(_omitMessageNames ? '' : 'google.apps.drive.activity.v2'), createEmptyInstance: create)
    ..oo(0, [1, 2, 3, 4, 5])
    ..aOM<User>(1, _omitFieldNames ? '' : 'user', subBuilder: User.create)
    ..aOM<AnonymousUser>(2, _omitFieldNames ? '' : 'anonymous', subBuilder: AnonymousUser.create)
    ..aOM<Impersonation>(3, _omitFieldNames ? '' : 'impersonation', subBuilder: Impersonation.create)
    ..aOM<SystemEvent>(4, _omitFieldNames ? '' : 'system', subBuilder: SystemEvent.create)
    ..aOM<Administrator>(5, _omitFieldNames ? '' : 'administrator', subBuilder: Administrator.create)
...
class User_KnownUser extends $pb.GeneratedMessage {
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(_omitMessageNames ? '' : 'User.KnownUser', package: const $pb.PackageName(_omitMessageNames ? '' : 'google.apps.drive.activity.v2'), createEmptyInstance: create)
  ...
  'Use [GeneratedMessageGenericExtensions.rebuild] instead. '
  'Will be removed in next major version')
  User_KnownUser copyWith(void Function(User_KnownUser) updates) => super.copyWith((message) => updates(message as User_KnownUser)) as User_KnownUser;
...
class User_DeletedUser extends $pb.GeneratedMessage {
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(_omitMessageNames ? '' : 'User.DeletedUser', package: const $pb.PackageName(_omitMessageNames ? '' : 'google.apps.drive.activity.v2'), createEmptyInstance: create)
    ..hasRequiredFields = false
  ;
  ...
  'Use [GeneratedMessageGenericExtensions.rebuild] instead. '
  'Will be removed in next major version')
  User_DeletedUser copyWith(void Function(User_DeletedUser) updates) => super.copyWith((message) => updates(message as User_DeletedUser)) as User_DeletedUser;
...
class User_UnknownUser extends $pb.GeneratedMessage {
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(_omitMessageNames ? '' : 'User.UnknownUser', package: const $pb.PackageName(_omitMessageNames ? '' : 'google.apps.drive.activity.v2'), createEmptyInstance: create)
    ..hasRequiredFields = false
  ;
  ...
  'Use [GeneratedMessageGenericExtensions.rebuild] instead. '
  'Will be removed in next major version')
  User_UnknownUser copyWith(void Function(User_UnknownUser) updates) => super.copyWith((message) => updates(message as User_UnknownUser)) as User_UnknownUser;
...
class User extends $pb.GeneratedMessage {
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(_omitMessageNames ? '' : 'User', package: const $pb.PackageName(_omitMessageNames ? '' : 'google.apps.drive.activity.v2'), createEmptyInstance: create)
    ..oo(0, [2, 3, 4])
    ..aOM<User_KnownUser>(2, _omitFieldNames ? '' : 'knownUser', subBuilder: User_KnownUser.create)
    ..aOM<User_DeletedUser>(3, _omitFieldNames ? '' : 'deletedUser', subBuilder: User_DeletedUser.create)
    ..aOM<User_UnknownUser>(4, _omitFieldNames ? '' : 'unknownUser', subBuilder: User_UnknownUser.create)
    ..hasRequiredFields = false
  ;
...
class AnonymousUser extends $pb.GeneratedMessage {
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(_omitMessageNames ? '' : 'AnonymousUser', package: const $pb.PackageName(_omitMessageNames ? '' : 'google.apps.drive.activity.v2'), createEmptyInstance: create)
    ..hasRequiredFields = false
  ;
...
class Impersonation extends $pb.GeneratedMessage {
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(_omitMessageNames ? '' : 'Impersonation', package: const $pb.PackageName(_omitMessageNames ? '' : 'google.apps.drive.activity.v2'), createEmptyInstance: create)
    ..aOM<User>(1, _omitFieldNames ? '' : 'impersonatedUser', subBuilder: User.create)
    ..hasRequiredFields = false
  ;
  ...
  'Use [GeneratedMessageGenericExtensions.rebuild] instead. '
  'Will be removed in next major version')
  Impersonation copyWith(void Function(Impersonation) updates) => super.copyWith((message) => updates(message as Impersonation)) as Impersonation;
...
class SystemEvent extends $pb.GeneratedMessage {
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(_omitMessageNames ? '' : 'SystemEvent', package: const $pb.PackageName(_omitMessageNames ? '' : 'google.apps.drive.activity.v2'), createEmptyInstance: create)
...
class Administrator extends $pb.GeneratedMessage {
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(_omitMessageNames ? '' : 'Administrator', package: const $pb.PackageName(_omitMessageNames ? '' : 'google.apps.drive.activity.v2'), createEmptyInstance: create)
    ..hasRequiredFields = false
  ;
