...
class SystemEvent_Type extends $pb.ProtobufEnum {
  ...
  static const SystemEvent_Type USER_DELETION = SystemEvent_Type._(1, _omitEnumNames ? '' : 'USER_DELETION');
  static const SystemEvent_Type TRASH_AUTO_PURGE = SystemEvent_Type._(2, _omitEnumNames ? '' : 'TRASH_AUTO_PURGE');
