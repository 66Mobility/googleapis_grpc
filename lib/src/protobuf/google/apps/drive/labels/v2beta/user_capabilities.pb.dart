...
class UserCapabilities extends $pb.GeneratedMessage {
  ...
  factory UserCapabilities.fromBuffer($core.List<$core.int> i, [$pb.ExtensionRegistry r = $pb.ExtensionRegistry.EMPTY]) => create()..mergeFromBuffer(i, r);
  factory UserCapabilities.fromJson($core.String i, [$pb.ExtensionRegistry r = $pb.ExtensionRegistry.EMPTY]) => create()..mergeFromJson(i, r);

  static final $pb.BuilderInfo _i = $pb.BuilderInfo(_omitMessageNames ? '' : 'UserCapabilities', package: const $pb.PackageName(_omitMessageNames ? '' : 'google.apps.drive.labels.v2beta'), createEmptyInstance: create)
  ...
  'Will be removed in next major version')
  UserCapabilities copyWith(void Function(UserCapabilities) updates) => super.copyWith((message) => updates(message as UserCapabilities)) as UserCapabilities;
  ...
  static $pb.PbList<UserCapabilities> createRepeated() => $pb.PbList<UserCapabilities>();
  @$core.pragma('dart2js:noInline')
  static UserCapabilities getDefault() => _defaultInstance ??= $pb.GeneratedMessage.$_defaultFor<UserCapabilities>(create);
  ...
  @$pb.TagNumber(2)
  set canAccessLabelManager($core.bool v) { $_setBool(1, v); }
  @$pb.TagNumber(2)
  ...
  @$pb.TagNumber(3)
  set canAdministrateLabels($core.bool v) { $_setBool(2, v); }
  @$pb.TagNumber(3)
  ...
  @$pb.TagNumber(4)
  set canCreateSharedLabels($core.bool v) { $_setBool(3, v); }
  @$pb.TagNumber(4)
  ...
  @$pb.TagNumber(5)
  set canCreateAdminLabels($core.bool v) { $_setBool(4, v); }
  @$pb.TagNumber(5)
