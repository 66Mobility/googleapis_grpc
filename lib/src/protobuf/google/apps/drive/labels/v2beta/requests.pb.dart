...
import 'field.pb.dart' as $4208;
import 'label.pb.dart' as $450;
import 'label.pbenum.dart' as $450;
import 'label_lock.pb.dart' as $4209;
...
class DeltaUpdateLabelRequest_DisableFieldRequest extends $pb.GeneratedMessage {
  factory DeltaUpdateLabelRequest_DisableFieldRequest({
    $2209.FieldMask? updateMask,
    $core.String? id,
    $4207.Lifecycle_DisabledPolicy? disabledPolicy,
  }) {
    final $result = create();
    if (updateMask != null) {
      $result.updateMask = updateMask;
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(_omitMessageNames ? '' : 'DeltaUpdateLabelRequest.DisableFieldRequest', package: const $pb.PackageName(_omitMessageNames ? '' : 'google.apps.drive.labels.v2beta'), createEmptyInstance: create)
    ...
    ..aOM<$4207.Lifecycle_DisabledPolicy>(3, _omitFieldNames ? '' : 'disabledPolicy', subBuilder: $4207.Lifecycle_DisabledPolicy.create)
    ..hasRequiredFields = false
  ;
  ...
  @$pb.TagNumber(3)
  $4207.Lifecycle_DisabledPolicy get disabledPolicy => $_getN(2);
  @$pb.TagNumber(3)
  set disabledPolicy($4207.Lifecycle_DisabledPolicy v) { setField(3, v); }
  @$pb.TagNumber(3)
  $core.bool hasDisabledPolicy() => $_has(2);
  @$pb.TagNumber(3)
  void clearDisabledPolicy() => clearField(3);
  @$pb.TagNumber(3)
  $4207.Lifecycle_DisabledPolicy ensureDisabledPolicy() => $_ensure(2);
}
...
class DeltaUpdateLabelRequest_CreateFieldRequest extends $pb.GeneratedMessage {
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(_omitMessageNames ? '' : 'DeltaUpdateLabelRequest.CreateFieldRequest', package: const $pb.PackageName(_omitMessageNames ? '' : 'google.apps.drive.labels.v2beta'), createEmptyInstance: create)
    ..aOM<$4208.Field>(1, _omitFieldNames ? '' : 'field', subBuilder: $4208.Field.create)
    ..hasRequiredFields = false
  ;
  ...
  @$pb.TagNumber(1)
  $4208.Field get field_1 => $_getN(0);
  @$pb.TagNumber(1)
  set field_1($4208.Field v) { setField(1, v); }
  @$pb.TagNumber(1)
  $core.bool hasField_1() => $_has(0);
  @$pb.TagNumber(1)
  void clearField_1() => clearField(1);
  @$pb.TagNumber(1)
  $4208.Field ensureField_1() => $_ensure(0);
}
...
class DeltaUpdateLabelRequest_UpdateFieldPropertiesRequest extends $pb.GeneratedMessage {
  factory DeltaUpdateLabelRequest_UpdateFieldPropertiesRequest({
    $2209.FieldMask? updateMask,
    $core.String? id,
    $4208.Field_Properties? properties,
  }) {
    final $result = create();
    if (updateMask != null) {
      $result.updateMask = updateMask;
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(_omitMessageNames ? '' : 'DeltaUpdateLabelRequest.UpdateFieldPropertiesRequest', package: const $pb.PackageName(_omitMessageNames ? '' : 'google.apps.drive.labels.v2beta'), createEmptyInstance: create)
    ..aOM<$2209.FieldMask>(1, _omitFieldNames ? '' : 'updateMask', subBuilder: $2209.FieldMask.create)
    ..aOS(2, _omitFieldNames ? '' : 'id')
    ..aOM<$4208.Field_Properties>(3, _omitFieldNames ? '' : 'properties', subBuilder: $4208.Field_Properties.create)
    ..hasRequiredFields = false
  ;
  ...
  @$pb.TagNumber(3)
  $4208.Field_Properties get properties => $_getN(2);
  @$pb.TagNumber(3)
  set properties($4208.Field_Properties v) { setField(3, v); }
  @$pb.TagNumber(3)
  $core.bool hasProperties() => $_has(2);
  @$pb.TagNumber(3)
  void clearProperties() => clearField(3);
  @$pb.TagNumber(3)
  $4208.Field_Properties ensureProperties() => $_ensure(2);
}
...
class DeltaUpdateLabelRequest_UpdateFieldTypeRequest extends $pb.GeneratedMessage {
  factory DeltaUpdateLabelRequest_UpdateFieldTypeRequest({
    $2209.FieldMask? updateMask,
    $core.String? id,
    $4208.Field_TextOptions? textOptions,
    $4208.Field_IntegerOptions? integerOptions,
    $4208.Field_DateOptions? dateOptions,
    $4208.Field_SelectionOptions? selectionOptions,
    $4208.Field_UserOptions? userOptions,
  }) {
    final $result = create();
    if (updateMask != null) {
      $result.updateMask = updateMask;
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(_omitMessageNames ? '' : 'DeltaUpdateLabelRequest.UpdateFieldTypeRequest', package: const $pb.PackageName(_omitMessageNames ? '' : 'google.apps.drive.labels.v2beta'), createEmptyInstance: create)
    ...
    ..aOM<$2209.FieldMask>(1, _omitFieldNames ? '' : 'updateMask', subBuilder: $2209.FieldMask.create)
    ..aOS(2, _omitFieldNames ? '' : 'id')
    ..aOM<$4208.Field_TextOptions>(3, _omitFieldNames ? '' : 'textOptions', subBuilder: $4208.Field_TextOptions.create)
    ..aOM<$4208.Field_IntegerOptions>(5, _omitFieldNames ? '' : 'integerOptions', subBuilder: $4208.Field_IntegerOptions.create)
    ..aOM<$4208.Field_DateOptions>(6, _omitFieldNames ? '' : 'dateOptions', subBuilder: $4208.Field_DateOptions.create)
    ..aOM<$4208.Field_SelectionOptions>(7, _omitFieldNames ? '' : 'selectionOptions', subBuilder: $4208.Field_SelectionOptions.create)
    ..aOM<$4208.Field_UserOptions>(8, _omitFieldNames ? '' : 'userOptions', subBuilder: $4208.Field_UserOptions.create)
    ..hasRequiredFields = false
  ;
  ...
  @$pb.TagNumber(3)
  $4208.Field_TextOptions get textOptions => $_getN(2);
  @$pb.TagNumber(3)
  set textOptions($4208.Field_TextOptions v) { setField(3, v); }
  @$pb.TagNumber(3)
  $core.bool hasTextOptions() => $_has(2);
  @$pb.TagNumber(3)
  void clearTextOptions() => clearField(3);
  @$pb.TagNumber(3)
  $4208.Field_TextOptions ensureTextOptions() => $_ensure(2);

  /// Update field to Integer.
  @$pb.TagNumber(5)
  $4208.Field_IntegerOptions get integerOptions => $_getN(3);
  @$pb.TagNumber(5)
  set integerOptions($4208.Field_IntegerOptions v) { setField(5, v); }
  @$pb.TagNumber(5)
  $core.bool hasIntegerOptions() => $_has(3);
  @$pb.TagNumber(5)
  void clearIntegerOptions() => clearField(5);
  @$pb.TagNumber(5)
  $4208.Field_IntegerOptions ensureIntegerOptions() => $_ensure(3);

  /// Update field to Date.
  @$pb.TagNumber(6)
  $4208.Field_DateOptions get dateOptions => $_getN(4);
  @$pb.TagNumber(6)
  set dateOptions($4208.Field_DateOptions v) { setField(6, v); }
  @$pb.TagNumber(6)
  $core.bool hasDateOptions() => $_has(4);
  @$pb.TagNumber(6)
  void clearDateOptions() => clearField(6);
  @$pb.TagNumber(6)
  $4208.Field_DateOptions ensureDateOptions() => $_ensure(4);

  /// Update field to Selection.
  @$pb.TagNumber(7)
  $4208.Field_SelectionOptions get selectionOptions => $_getN(5);
  @$pb.TagNumber(7)
  set selectionOptions($4208.Field_SelectionOptions v) { setField(7, v); }
  @$pb.TagNumber(7)
  $core.bool hasSelectionOptions() => $_has(5);
  @$pb.TagNumber(7)
  void clearSelectionOptions() => clearField(7);
  @$pb.TagNumber(7)
  $4208.Field_SelectionOptions ensureSelectionOptions() => $_ensure(5);

  /// Update field to User.
  @$pb.TagNumber(8)
  $4208.Field_UserOptions get userOptions => $_getN(6);
  @$pb.TagNumber(8)
  set userOptions($4208.Field_UserOptions v) { setField(8, v); }
  @$pb.TagNumber(8)
  $core.bool hasUserOptions() => $_has(6);
  @$pb.TagNumber(8)
  void clearUserOptions() => clearField(8);
  @$pb.TagNumber(8)
  $4208.Field_UserOptions ensureUserOptions() => $_ensure(6);
}
...
class DeltaUpdateLabelRequest_CreateSelectionChoiceRequest extends $pb.GeneratedMessage {
  factory DeltaUpdateLabelRequest_CreateSelectionChoiceRequest({
    $core.String? fieldId,
    $4208.Field_SelectionOptions_Choice? choice,
  }) {
    final $result = create();
    if (fieldId != null) {
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(_omitMessageNames ? '' : 'DeltaUpdateLabelRequest.CreateSelectionChoiceRequest', package: const $pb.PackageName(_omitMessageNames ? '' : 'google.apps.drive.labels.v2beta'), createEmptyInstance: create)
    ...
    ..aOM<$4208.Field_SelectionOptions_Choice>(2, _omitFieldNames ? '' : 'choice', subBuilder: $4208.Field_SelectionOptions_Choice.create)
    ..hasRequiredFields = false
  ;
  ...
  @$pb.TagNumber(2)
  $4208.Field_SelectionOptions_Choice get choice => $_getN(1);
  @$pb.TagNumber(2)
  set choice($4208.Field_SelectionOptions_Choice v) { setField(2, v); }
  @$pb.TagNumber(2)
  $core.bool hasChoice() => $_has(1);
  @$pb.TagNumber(2)
  void clearChoice() => clearField(2);
  @$pb.TagNumber(2)
  $4208.Field_SelectionOptions_Choice ensureChoice() => $_ensure(1);
}
...
class DeltaUpdateLabelRequest_UpdateSelectionChoicePropertiesRequest extends $pb.GeneratedMessage {
  factory DeltaUpdateLabelRequest_UpdateSelectionChoicePropertiesRequest({
    ...
    $core.String? fieldId,
    $core.String? id,
    $4208.Field_SelectionOptions_Choice_Properties? properties,
  }) {
    final $result = create();
    if (updateMask != null) {
      $result.updateMask = updateMask;
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(_omitMessageNames ? '' : 'DeltaUpdateLabelRequest.UpdateSelectionChoicePropertiesRequest', package: const $pb.PackageName(_omitMessageNames ? '' : 'google.apps.drive.labels.v2beta'), createEmptyInstance: create)
    ...
    ..aOM<$4208.Field_SelectionOptions_Choice_Properties>(4, _omitFieldNames ? '' : 'properties', subBuilder: $4208.Field_SelectionOptions_Choice_Properties.create)
    ..hasRequiredFields = false
  ;
  ...
  @$pb.TagNumber(4)
  $4208.Field_SelectionOptions_Choice_Properties get properties => $_getN(3);
  @$pb.TagNumber(4)
  set properties($4208.Field_SelectionOptions_Choice_Properties v) { setField(4, v); }
  @$pb.TagNumber(4)
  $core.bool hasProperties() => $_has(3);
  @$pb.TagNumber(4)
  void clearProperties() => clearField(4);
  @$pb.TagNumber(4)
  $4208.Field_SelectionOptions_Choice_Properties ensureProperties() => $_ensure(3);
}
...
class DeltaUpdateLabelRequest_DisableSelectionChoiceRequest extends $pb.GeneratedMessage {
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(_omitMessageNames ? '' : 'DeltaUpdateLabelRequest.DisableSelectionChoiceRequest', package: const $pb.PackageName(_omitMessageNames ? '' : 'google.apps.drive.labels.v2beta'), createEmptyInstance: create)
    ...
    ..aOS(2, _omitFieldNames ? '' : 'fieldId')
    ..aOS(3, _omitFieldNames ? '' : 'id')
    ..aOM<$4207.Lifecycle_DisabledPolicy>(4, _omitFieldNames ? '' : 'disabledPolicy', subBuilder: $4207.Lifecycle_DisabledPolicy.create)
    ..hasRequiredFields = false
  ;
  ...
  @$pb.TagNumber(4)
  $4207.Lifecycle_DisabledPolicy get disabledPolicy => $_getN(3);
  @$pb.TagNumber(4)
  set disabledPolicy($4207.Lifecycle_DisabledPolicy v) { setField(4, v); }
  @$pb.TagNumber(4)
  $core.bool hasDisabledPolicy() => $_has(3);
  @$pb.TagNumber(4)
  void clearDisabledPolicy() => clearField(4);
  @$pb.TagNumber(4)
  $4207.Lifecycle_DisabledPolicy ensureDisabledPolicy() => $_ensure(3);
}
...
class DisableLabelRequest extends $pb.GeneratedMessage {
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(_omitMessageNames ? '' : 'DisableLabelRequest', package: const $pb.PackageName(_omitMessageNames ? '' : 'google.apps.drive.labels.v2beta'), createEmptyInstance: create)
    ...
    ..aOM<$4207.Lifecycle_DisabledPolicy>(5, _omitFieldNames ? '' : 'disabledPolicy', subBuilder: $4207.Lifecycle_DisabledPolicy.create)
    ..aOS(6, _omitFieldNames ? '' : 'languageCode')
    ..hasRequiredFields = false
  ;
  ...
  @$pb.TagNumber(5)
  $4207.Lifecycle_DisabledPolicy get disabledPolicy => $_getN(4);
  @$pb.TagNumber(5)
  set disabledPolicy($4207.Lifecycle_DisabledPolicy v) { setField(5, v); }
  @$pb.TagNumber(5)
  $core.bool hasDisabledPolicy() => $_has(4);
  @$pb.TagNumber(5)
  void clearDisabledPolicy() => clearField(5);
  @$pb.TagNumber(5)
  $4207.Lifecycle_DisabledPolicy ensureDisabledPolicy() => $_ensure(4);
...
class ListLabelLocksResponse extends $pb.GeneratedMessage {
  factory ListLabelLocksResponse({
    $core.Iterable<$4209.LabelLock>? labelLocks,
    $core.String? nextPageToken,
  }) {
    final $result = create();
    if (labelLocks != null) {
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(_omitMessageNames ? '' : 'ListLabelLocksResponse', package: const $pb.PackageName(_omitMessageNames ? '' : 'google.apps.drive.labels.v2beta'), createEmptyInstance: create)
    ..pc<$4209.LabelLock>(1, _omitFieldNames ? '' : 'labelLocks', $pb.PbFieldType.PM, subBuilder: $4209.LabelLock.create)
    ..aOS(2, _omitFieldNames ? '' : 'nextPageToken')
    ..hasRequiredFields = false
  ;
  ...
  /// LabelLocks.
  @$pb.TagNumber(1)
  $core.List<$4209.LabelLock> get labelLocks => $_getList(0);
