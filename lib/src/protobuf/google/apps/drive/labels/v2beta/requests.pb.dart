...
import 'label.pbenum.dart' as $74;
import 'label_lock.pb.dart' as $392;
import 'label_permission.pb.dart' as $76;
import 'label_permission.pbenum.dart' as $76;
...
class CreateLabelRequest extends $pb.GeneratedMessage {
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(_omitMessageNames ? '' : 'CreateLabelRequest', package: const $pb.PackageName(_omitMessageNames ? '' : 'google.apps.drive.labels.v2beta'), createEmptyInstance: create)
    ..aOM<$74.Label>(1, _omitFieldNames ? '' : 'label', subBuilder: $74.Label.create)
  ...
  @$pb.TagNumber(1)
  $74.Label get label => $_getN(0);
  @$pb.TagNumber(1)
  set label($74.Label v) { setField(1, v); }
  @$pb.TagNumber(1)
  $core.bool hasLabel() => $_has(0);
  @$pb.TagNumber(1)
  void clearLabel() => clearField(1);
  @$pb.TagNumber(1)
  $74.Label ensureLabel() => $_ensure(0);
...
class DeltaUpdateLabelRequest_UpdateLabelPropertiesRequest extends $pb.GeneratedMessage {
  factory DeltaUpdateLabelRequest_UpdateLabelPropertiesRequest({
    ...
    $74.Label_Properties? properties,
  }) {
    final $result = create();
    if (updateMask != null) {
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(_omitMessageNames ? '' : 'DeltaUpdateLabelRequest.UpdateLabelPropertiesRequest', package: const $pb.PackageName(_omitMessageNames ? '' : 'google.apps.drive.labels.v2beta'), createEmptyInstance: create)
    ...
    ..aOM<$74.Label_Properties>(2, _omitFieldNames ? '' : 'properties', subBuilder: $74.Label_Properties.create)
    ..hasRequiredFields = false
  ;
  ...
  @$pb.TagNumber(2)
  $74.Label_Properties get properties => $_getN(1);
  @$pb.TagNumber(2)
  set properties($74.Label_Properties v) { setField(2, v); }
  @$pb.TagNumber(2)
  $core.bool hasProperties() => $_has(1);
  @$pb.TagNumber(2)
  void clearProperties() => clearField(2);
  @$pb.TagNumber(2)
  $74.Label_Properties ensureProperties() => $_ensure(1);
}
...
class DeltaUpdateLabelResponse extends $pb.GeneratedMessage {
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(_omitMessageNames ? '' : 'DeltaUpdateLabelResponse', package: const $pb.PackageName(_omitMessageNames ? '' : 'google.apps.drive.labels.v2beta'), createEmptyInstance: create)
    ...
    ..aOM<$74.Label>(6, _omitFieldNames ? '' : 'updatedLabel', subBuilder: $74.Label.create)
    ..hasRequiredFields = false
  ;
  ...
  /// were no errors.
  @$pb.TagNumber(6)
  $74.Label get updatedLabel => $_getN(1);
  @$pb.TagNumber(6)
  set updatedLabel($74.Label v) { setField(6, v); }
  @$pb.TagNumber(6)
  $core.bool hasUpdatedLabel() => $_has(1);
  @$pb.TagNumber(6)
  void clearUpdatedLabel() => clearField(6);
  @$pb.TagNumber(6)
  $74.Label ensureUpdatedLabel() => $_ensure(1);
}
...
class UpdateLabelCopyModeRequest extends $pb.GeneratedMessage {
  factory UpdateLabelCopyModeRequest({
    $core.String? name,
    $74.Label_AppliedLabelPolicy_CopyMode? copyMode,
    $core.bool? useAdminAccess,
    $core.String? languageCode,
    LabelView? view,
  }) {
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(_omitMessageNames ? '' : 'UpdateLabelCopyModeRequest', package: const $pb.PackageName(_omitMessageNames ? '' : 'google.apps.drive.labels.v2beta'), createEmptyInstance: create)
    ..aOS(1, _omitFieldNames ? '' : 'name')
    ..e<$74.Label_AppliedLabelPolicy_CopyMode>(2, _omitFieldNames ? '' : 'copyMode', $pb.PbFieldType.OE, defaultOrMaker: $74.Label_AppliedLabelPolicy_CopyMode.COPY_MODE_UNSPECIFIED, valueOf: $74.Label_AppliedLabelPolicy_CopyMode.valueOf, enumValues: $74.Label_AppliedLabelPolicy_CopyMode.values)
  ...
  @$pb.TagNumber(2)
  $74.Label_AppliedLabelPolicy_CopyMode get copyMode => $_getN(1);
  @$pb.TagNumber(2)
  set copyMode($74.Label_AppliedLabelPolicy_CopyMode v) { setField(2, v); }
  @$pb.TagNumber(2)
...
class ListLabelsRequest extends $pb.GeneratedMessage {
  factory ListLabelsRequest({
    ...
    $core.String? customer,
    $core.bool? useAdminAccess,
    $76.LabelPermission_LabelRole? minimumRole,
    $core.String? languageCode,
    $core.int? pageSize,
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(_omitMessageNames ? '' : 'ListLabelsRequest', package: const $pb.PackageName(_omitMessageNames ? '' : 'google.apps.drive.labels.v2beta'), createEmptyInstance: create)
    ...
    ..aOS(2, _omitFieldNames ? '' : 'customer')
    ..aOB(3, _omitFieldNames ? '' : 'useAdminAccess')
    ..e<$76.LabelPermission_LabelRole>(4, _omitFieldNames ? '' : 'minimumRole', $pb.PbFieldType.OE, defaultOrMaker: $76.LabelPermission_LabelRole.LABEL_ROLE_UNSPECIFIED, valueOf: $76.LabelPermission_LabelRole.valueOf, enumValues: $76.LabelPermission_LabelRole.values)
  ...
  /// Defaults to `READER`.
  @$pb.TagNumber(4)
  $76.LabelPermission_LabelRole get minimumRole => $_getN(3);
  @$pb.TagNumber(4)
  set minimumRole($76.LabelPermission_LabelRole v) { setField(4, v); }
  @$pb.TagNumber(4)
...
class ListLabelsResponse extends $pb.GeneratedMessage {
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(_omitMessageNames ? '' : 'ListLabelsResponse', package: const $pb.PackageName(_omitMessageNames ? '' : 'google.apps.drive.labels.v2beta'), createEmptyInstance: create)
    ..pc<$74.Label>(1, _omitFieldNames ? '' : 'labels', $pb.PbFieldType.PM, subBuilder: $74.Label.create)
  ...
  /// Labels.
  @$pb.TagNumber(1)
  $core.List<$74.Label> get labels => $_getList(0);
...
class CreateLabelPermissionRequest extends $pb.GeneratedMessage {
  factory CreateLabelPermissionRequest({
    $core.String? parent,
    $76.LabelPermission? labelPermission,
    $core.bool? useAdminAccess,
  }) {
    final $result = create();
    if (parent != null) {
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(_omitMessageNames ? '' : 'CreateLabelPermissionRequest', package: const $pb.PackageName(_omitMessageNames ? '' : 'google.apps.drive.labels.v2beta'), createEmptyInstance: create)
    ...
    ..aOM<$76.LabelPermission>(2, _omitFieldNames ? '' : 'labelPermission', subBuilder: $76.LabelPermission.create)
    ..aOB(3, _omitFieldNames ? '' : 'useAdminAccess')
    ..hasRequiredFields = false
  ;
  ...
  @$pb.TagNumber(2)
  $76.LabelPermission get labelPermission => $_getN(1);
  @$pb.TagNumber(2)
  set labelPermission($76.LabelPermission v) { setField(2, v); }
  @$pb.TagNumber(2)
  $core.bool hasLabelPermission() => $_has(1);
  @$pb.TagNumber(2)
  void clearLabelPermission() => clearField(2);
  @$pb.TagNumber(2)
  $76.LabelPermission ensureLabelPermission() => $_ensure(1);
...
class ListLabelPermissionsResponse extends $pb.GeneratedMessage {
  factory ListLabelPermissionsResponse({
    $core.Iterable<$76.LabelPermission>? labelPermissions,
    $core.String? nextPageToken,
  }) {
    final $result = create();
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(_omitMessageNames ? '' : 'ListLabelPermissionsResponse', package: const $pb.PackageName(_omitMessageNames ? '' : 'google.apps.drive.labels.v2beta'), createEmptyInstance: create)
    ..pc<$76.LabelPermission>(1, _omitFieldNames ? '' : 'labelPermissions', $pb.PbFieldType.PM, subBuilder: $76.LabelPermission.create)
    ..aOS(2, _omitFieldNames ? '' : 'nextPageToken')
    ..hasRequiredFields = false
  ;
  ...
  /// Label permissions.
  @$pb.TagNumber(1)
  $core.List<$76.LabelPermission> get labelPermissions => $_getList(0);
...
class BatchUpdateLabelPermissionsResponse extends $pb.GeneratedMessage {
  factory BatchUpdateLabelPermissionsResponse({
    $core.Iterable<$76.LabelPermission>? permissions,
  }) {
    final $result = create();
    if (permissions != null) {
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(_omitMessageNames ? '' : 'BatchUpdateLabelPermissionsResponse', package: const $pb.PackageName(_omitMessageNames ? '' : 'google.apps.drive.labels.v2beta'), createEmptyInstance: create)
    ..pc<$76.LabelPermission>(1, _omitFieldNames ? '' : 'permissions', $pb.PbFieldType.PM, subBuilder: $76.LabelPermission.create)
    ..hasRequiredFields = false
  ;
  ...
  @$pb.TagNumber(1)
  $core.List<$76.LabelPermission> get permissions => $_getList(0);
}
