...
class Field_DateOptions extends $pb.GeneratedMessage {
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(_omitMessageNames ? '' : 'Field.DateOptions', package: const $pb.PackageName(_omitMessageNames ? '' : 'google.apps.drive.labels.v2beta'), createEmptyInstance: create)
    ...
    ..aOM<$327.Date>(3, _omitFieldNames ? '' : 'minValue', subBuilder: $327.Date.create)
    ..aOM<$327.Date>(4, _omitFieldNames ? '' : 'maxValue', subBuilder: $327.Date.create)
    ..hasRequiredFields = false
  ;
  ...
  @$pb.TagNumber(3)
  $327.Date get minValue => $_getN(2);
  @$pb.TagNumber(3)
  set minValue($327.Date v) { setField(3, v); }
  @$pb.TagNumber(3)
  $core.bool hasMinValue() => $_has(2);
  @$pb.TagNumber(3)
  void clearMinValue() => clearField(3);
  @$pb.TagNumber(3)
  $327.Date ensureMinValue() => $_ensure(2);

  /// Output only. Maximum valid value (year, month, day).
  @$pb.TagNumber(4)
  $327.Date get maxValue => $_getN(3);
  @$pb.TagNumber(4)
  set maxValue($327.Date v) { setField(4, v); }
  @$pb.TagNumber(4)
  $core.bool hasMaxValue() => $_has(3);
  @$pb.TagNumber(4)
  void clearMaxValue() => clearField(4);
  @$pb.TagNumber(4)
  $327.Date ensureMaxValue() => $_ensure(3);
}
...
class Field_SelectionOptions_Choice_Properties extends $pb.GeneratedMessage {
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(_omitMessageNames ? '' : 'Field.SelectionOptions.Choice.Properties', package: const $pb.PackageName(_omitMessageNames ? '' : 'google.apps.drive.labels.v2beta'), createEmptyInstance: create)
    ...
    ..aOM<$393.BadgeConfig>(3, _omitFieldNames ? '' : 'badgeConfig', subBuilder: $393.BadgeConfig.create)
  ...
  @$pb.TagNumber(3)
  $393.BadgeConfig get badgeConfig => $_getN(2);
  @$pb.TagNumber(3)
  set badgeConfig($393.BadgeConfig v) { setField(3, v); }
  @$pb.TagNumber(3)
  $core.bool hasBadgeConfig() => $_has(2);
  @$pb.TagNumber(3)
  void clearBadgeConfig() => clearField(3);
  @$pb.TagNumber(3)
  $393.BadgeConfig ensureBadgeConfig() => $_ensure(2);
...
class Field_SelectionOptions_Choice_DisplayHints extends $pb.GeneratedMessage {
  factory Field_SelectionOptions_Choice_DisplayHints({
    ...
    $core.bool? hiddenInSearch,
    $core.bool? shownInApply,
    $393.BadgeColors? badgeColors,
    $393.BadgeColors? darkBadgeColors,
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(_omitMessageNames ? '' : 'Field.SelectionOptions.Choice.DisplayHints', package: const $pb.PackageName(_omitMessageNames ? '' : 'google.apps.drive.labels.v2beta'), createEmptyInstance: create)
    ...
    ..aOM<$393.BadgeColors>(4, _omitFieldNames ? '' : 'badgeColors', subBuilder: $393.BadgeColors.create)
    ..aOM<$393.BadgeColors>(5, _omitFieldNames ? '' : 'darkBadgeColors', subBuilder: $393.BadgeColors.create)
  ...
  @$pb.TagNumber(4)
  $393.BadgeColors get badgeColors => $_getN(3);
  @$pb.TagNumber(4)
  set badgeColors($393.BadgeColors v) { setField(4, v); }
  @$pb.TagNumber(4)
  $core.bool hasBadgeColors() => $_has(3);
  @$pb.TagNumber(4)
  void clearBadgeColors() => clearField(4);
  @$pb.TagNumber(4)
  $393.BadgeColors ensureBadgeColors() => $_ensure(3);
  ...
  @$pb.TagNumber(5)
  $393.BadgeColors get darkBadgeColors => $_getN(4);
  @$pb.TagNumber(5)
  set darkBadgeColors($393.BadgeColors v) { setField(5, v); }
  @$pb.TagNumber(5)
  $core.bool hasDarkBadgeColors() => $_has(4);
  @$pb.TagNumber(5)
  void clearDarkBadgeColors() => clearField(5);
  @$pb.TagNumber(5)
  $393.BadgeColors ensureDarkBadgeColors() => $_ensure(4);
...
class Field_SelectionOptions_Choice extends $pb.GeneratedMessage {
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(_omitMessageNames ? '' : 'Field.SelectionOptions.Choice', package: const $pb.PackageName(_omitMessageNames ? '' : 'google.apps.drive.labels.v2beta'), createEmptyInstance: create)
    ...
    ..aOM<$393.Lifecycle>(3, _omitFieldNames ? '' : 'lifecycle', subBuilder: $393.Lifecycle.create)
    ...
    ..aOM<$393.UserInfo>(7, _omitFieldNames ? '' : 'creator', subBuilder: $393.UserInfo.create)
    ..aOM<$302.Timestamp>(8, _omitFieldNames ? '' : 'createTime', subBuilder: $302.Timestamp.create)
    ..aOM<$393.UserInfo>(9, _omitFieldNames ? '' : 'updater', subBuilder: $393.UserInfo.create)
    ..aOM<$302.Timestamp>(10, _omitFieldNames ? '' : 'updateTime', subBuilder: $302.Timestamp.create)
    ..aOM<$393.UserInfo>(11, _omitFieldNames ? '' : 'publisher', subBuilder: $393.UserInfo.create)
    ..aOM<$302.Timestamp>(12, _omitFieldNames ? '' : 'publishTime', subBuilder: $302.Timestamp.create)
    ..aOM<$393.UserInfo>(13, _omitFieldNames ? '' : 'disabler', subBuilder: $393.UserInfo.create)
    ..aOM<$302.Timestamp>(14, _omitFieldNames ? '' : 'disableTime', subBuilder: $302.Timestamp.create)
    ..aOM<$393.LockStatus>(15, _omitFieldNames ? '' : 'lockStatus', subBuilder: $393.LockStatus.create)
    ..hasRequiredFields = false
  ;
  ...
  @$pb.TagNumber(3)
  $393.Lifecycle get lifecycle => $_getN(2);
  @$pb.TagNumber(3)
  set lifecycle($393.Lifecycle v) { setField(3, v); }
  @$pb.TagNumber(3)
  $core.bool hasLifecycle() => $_has(2);
  @$pb.TagNumber(3)
  void clearLifecycle() => clearField(3);
  @$pb.TagNumber(3)
  $393.Lifecycle ensureLifecycle() => $_ensure(2);
  ...
  @$pb.TagNumber(7)
  $393.UserInfo get creator => $_getN(6);
  @$pb.TagNumber(7)
  set creator($393.UserInfo v) { setField(7, v); }
  @$pb.TagNumber(7)
  $core.bool hasCreator() => $_has(6);
  @$pb.TagNumber(7)
  void clearCreator() => clearField(7);
  @$pb.TagNumber(7)
  $393.UserInfo ensureCreator() => $_ensure(6);
  ...
  @$pb.TagNumber(9)
  $393.UserInfo get updater => $_getN(8);
  @$pb.TagNumber(9)
  set updater($393.UserInfo v) { setField(9, v); }
  @$pb.TagNumber(9)
  $core.bool hasUpdater() => $_has(8);
  @$pb.TagNumber(9)
  void clearUpdater() => clearField(9);
  @$pb.TagNumber(9)
  $393.UserInfo ensureUpdater() => $_ensure(8);
...
class Field extends $pb.GeneratedMessage {
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(_omitMessageNames ? '' : 'Field', package: const $pb.PackageName(_omitMessageNames ? '' : 'google.apps.drive.labels.v2beta'), createEmptyInstance: create)
    ...
    ..aOM<$393.Lifecycle>(4, _omitFieldNames ? '' : 'lifecycle', subBuilder: $393.Lifecycle.create)
    ...
    ..aOM<$393.UserInfo>(8, _omitFieldNames ? '' : 'creator', subBuilder: $393.UserInfo.create)
    ..aOM<$302.Timestamp>(9, _omitFieldNames ? '' : 'createTime', subBuilder: $302.Timestamp.create)
    ..aOM<$393.UserInfo>(10, _omitFieldNames ? '' : 'updater', subBuilder: $393.UserInfo.create)
    ..aOM<$302.Timestamp>(11, _omitFieldNames ? '' : 'updateTime', subBuilder: $302.Timestamp.create)
    ..aOM<$393.UserInfo>(12, _omitFieldNames ? '' : 'publisher', subBuilder: $393.UserInfo.create)
    ..aOM<$393.UserInfo>(13, _omitFieldNames ? '' : 'disabler', subBuilder: $393.UserInfo.create)
    ..aOM<$302.Timestamp>(14, _omitFieldNames ? '' : 'disableTime', subBuilder: $302.Timestamp.create)
    ..aOM<$393.LockStatus>(15, _omitFieldNames ? '' : 'lockStatus', subBuilder: $393.LockStatus.create)
  ...
  @$pb.TagNumber(4)
  $393.Lifecycle get lifecycle => $_getN(3);
  @$pb.TagNumber(4)
  set lifecycle($393.Lifecycle v) { setField(4, v); }
  @$pb.TagNumber(4)
  $core.bool hasLifecycle() => $_has(3);
  @$pb.TagNumber(4)
  void clearLifecycle() => clearField(4);
  @$pb.TagNumber(4)
  $393.Lifecycle ensureLifecycle() => $_ensure(3);
  ...
  @$pb.TagNumber(8)
  $393.UserInfo get creator => $_getN(7);
  @$pb.TagNumber(8)
  set creator($393.UserInfo v) { setField(8, v); }
  @$pb.TagNumber(8)
  $core.bool hasCreator() => $_has(7);
  @$pb.TagNumber(8)
  void clearCreator() => clearField(8);
  @$pb.TagNumber(8)
  $393.UserInfo ensureCreator() => $_ensure(7);
  ...
  @$pb.TagNumber(10)
  $393.UserInfo get updater => $_getN(9);
  @$pb.TagNumber(10)
  set updater($393.UserInfo v) { setField(10, v); }
  @$pb.TagNumber(10)
  $core.bool hasUpdater() => $_has(9);
  @$pb.TagNumber(10)
  void clearUpdater() => clearField(10);
  @$pb.TagNumber(10)
  $393.UserInfo ensureUpdater() => $_ensure(9);

  /// Output only. The time this field was updated.
  @$pb.TagNumber(11)
  $302.Timestamp get updateTime => $_getN(10);
  @$pb.TagNumber(11)
  set updateTime($302.Timestamp v) { setField(11, v); }
  @$pb.TagNumber(11)
  $core.bool hasUpdateTime() => $_has(10);
  @$pb.TagNumber(11)
  void clearUpdateTime() => clearField(11);
  @$pb.TagNumber(11)
  $302.Timestamp ensureUpdateTime() => $_ensure(10);

  /// Output only. The user who published this field. This value has no meaning
  /// when the field is not published.
  @$pb.TagNumber(12)
  $393.UserInfo get publisher => $_getN(11);
  @$pb.TagNumber(12)
  set publisher($393.UserInfo v) { setField(12, v); }
  @$pb.TagNumber(12)
  $core.bool hasPublisher() => $_has(11);
  @$pb.TagNumber(12)
  void clearPublisher() => clearField(12);
  @$pb.TagNumber(12)
  $393.UserInfo ensurePublisher() => $_ensure(11);
