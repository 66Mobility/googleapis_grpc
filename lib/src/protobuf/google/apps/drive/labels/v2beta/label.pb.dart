...
class Label_Properties extends $pb.GeneratedMessage {
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(_omitMessageNames ? '' : 'Label.Properties', package: const $pb.PackageName(_omitMessageNames ? '' : 'google.apps.drive.labels.v2beta'), createEmptyInstance: create)
...
class Label_DisplayHints extends $pb.GeneratedMessage {
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(_omitMessageNames ? '' : 'Label.DisplayHints', package: const $pb.PackageName(_omitMessageNames ? '' : 'google.apps.drive.labels.v2beta'), createEmptyInstance: create)
...
class Label_AppliedCapabilities extends $pb.GeneratedMessage {
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(_omitMessageNames ? '' : 'Label.AppliedCapabilities', package: const $pb.PackageName(_omitMessageNames ? '' : 'google.apps.drive.labels.v2beta'), createEmptyInstance: create)
...
class Label_SchemaCapabilities extends $pb.GeneratedMessage {
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(_omitMessageNames ? '' : 'Label.SchemaCapabilities', package: const $pb.PackageName(_omitMessageNames ? '' : 'google.apps.drive.labels.v2beta'), createEmptyInstance: create)
...
class Label_AppliedLabelPolicy extends $pb.GeneratedMessage {
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(_omitMessageNames ? '' : 'Label.AppliedLabelPolicy', package: const $pb.PackageName(_omitMessageNames ? '' : 'google.apps.drive.labels.v2beta'), createEmptyInstance: create)
...
class Label extends $pb.GeneratedMessage {
  factory Label({
    ...
    $core.Iterable<$4208.Field>? fields,
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(_omitMessageNames ? '' : 'Label', package: const $pb.PackageName(_omitMessageNames ? '' : 'google.apps.drive.labels.v2beta'), createEmptyInstance: create)
    ...
    ..aOM<$4207.UserInfo>(7, _omitFieldNames ? '' : 'revisionCreator', subBuilder: $4207.UserInfo.create)
    ..aOM<$1775.Timestamp>(8, _omitFieldNames ? '' : 'revisionCreateTime', subBuilder: $1775.Timestamp.create)
    ..aOM<$4207.UserInfo>(9, _omitFieldNames ? '' : 'publisher', subBuilder: $4207.UserInfo.create)
    ..aOM<$1775.Timestamp>(10, _omitFieldNames ? '' : 'publishTime', subBuilder: $1775.Timestamp.create)
    ..aOM<$4207.UserInfo>(11, _omitFieldNames ? '' : 'disabler', subBuilder: $4207.UserInfo.create)
    ..aOM<$1775.Timestamp>(12, _omitFieldNames ? '' : 'disableTime', subBuilder: $1775.Timestamp.create)
    ..aOS(13, _omitFieldNames ? '' : 'customer')
    ..aOM<Label_Properties>(14, _omitFieldNames ? '' : 'properties', subBuilder: Label_Properties.create)
    ..aOM<$4207.Lifecycle>(15, _omitFieldNames ? '' : 'lifecycle', subBuilder: $4207.Lifecycle.create)
    ...
    ..pc<$4208.Field>(20, _omitFieldNames ? '' : 'fields', $pb.PbFieldType.PM, subBuilder: $4208.Field.create)
    ..aOS(21, _omitFieldNames ? '' : 'learnMoreUri')
    ..aOM<$4207.LockStatus>(22, _omitFieldNames ? '' : 'lockStatus', subBuilder: $4207.LockStatus.create)
    ..hasRequiredFields = false
  ;
  ...
  @$pb.TagNumber(7)
  $4207.UserInfo get revisionCreator => $_getN(6);
  @$pb.TagNumber(7)
  set revisionCreator($4207.UserInfo v) { setField(7, v); }
  @$pb.TagNumber(7)
  $core.bool hasRevisionCreator() => $_has(6);
  @$pb.TagNumber(7)
  void clearRevisionCreator() => clearField(7);
  @$pb.TagNumber(7)
  $4207.UserInfo ensureRevisionCreator() => $_ensure(6);
  ...
  @$pb.TagNumber(15)
  $4207.Lifecycle get lifecycle => $_getN(14);
  @$pb.TagNumber(15)
  set lifecycle($4207.Lifecycle v) { setField(15, v); }
  @$pb.TagNumber(15)
  $core.bool hasLifecycle() => $_has(14);
  @$pb.TagNumber(15)
  void clearLifecycle() => clearField(15);
  @$pb.TagNumber(15)
  $4207.Lifecycle ensureLifecycle() => $_ensure(14);
  ...
  @$pb.TagNumber(20)
  $core.List<$4208.Field> get fields => $_getList(19);
  ...
  @$pb.TagNumber(22)
  $4207.LockStatus get lockStatus => $_getN(21);
  @$pb.TagNumber(22)
  set lockStatus($4207.LockStatus v) { setField(22, v); }
  @$pb.TagNumber(22)
  $core.bool hasLockStatus() => $_has(21);
  @$pb.TagNumber(22)
  void clearLockStatus() => clearField(22);
  @$pb.TagNumber(22)
  $4207.LockStatus ensureLockStatus() => $_ensure(21);
}
