...
class Label extends $pb.GeneratedMessage {
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(
    ...
    ..aOM<$393.Lifecycle>(15, _omitFieldNames ? '' : 'lifecycle',
    ...
    ..pc<$394.Field>(20, _omitFieldNames ? '' : 'fields', $pb.PbFieldType.PM,
        subBuilder: $394.Field.create)
    ..aOS(21, _omitFieldNames ? '' : 'learnMoreUri')
    ..aOM<$393.LockStatus>(22, _omitFieldNames ? '' : 'lockStatus',
  ...
  @$pb.TagNumber(7)
  set revisionCreator($393.UserInfo v) {
    setField(7, v);
  }
