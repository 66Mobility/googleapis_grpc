...
class DateLimits extends $pb.GeneratedMessage {
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(
      ...
      package: const $pb.PackageName(
          _omitMessageNames ? '' : 'google.apps.drive.labels.v2'),
      createEmptyInstance: create)
    ..aOM<$355.Date>(1, _omitFieldNames ? '' : 'minValue',
        subBuilder: $355.Date.create)
    ..aOM<$355.Date>(2, _omitFieldNames ? '' : 'maxValue',
        subBuilder: $355.Date.create)
    ..hasRequiredFields = false;
  ...
  void clearMinValue() => clearField(1);
  @$pb.TagNumber(1)
  $355.Date ensureMinValue() => $_ensure(0);

  /// Maximum value for the date Field type.
  @$pb.TagNumber(2)
  $355.Date get maxValue => $_getN(1);
  @$pb.TagNumber(2)
  ...
  void clearMaxValue() => clearField(2);
  @$pb.TagNumber(2)
  $355.Date ensureMaxValue() => $_ensure(1);
}
