...
class LabelLock extends $pb.GeneratedMessage {
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(_omitMessageNames ? '' : 'LabelLock', package: const $pb.PackageName(_omitMessageNames ? '' : 'google.apps.drive.labels.v2'), createEmptyInstance: create)
    ...
    ..aOM<$299.Timestamp>(6, _omitFieldNames ? '' : 'deleteTime', subBuilder: $299.Timestamp.create)
  ...
  /// state.
  @$pb.TagNumber(6)
  $299.Timestamp get deleteTime => $_getN(5);
  @$pb.TagNumber(6)
  set deleteTime($299.Timestamp v) { setField(6, v); }
  @$pb.TagNumber(6)
  $core.bool hasDeleteTime() => $_has(5);
  @$pb.TagNumber(6)
  void clearDeleteTime() => clearField(6);
  @$pb.TagNumber(6)
  $299.Timestamp ensureDeleteTime() => $_ensure(5);
