...
class Label extends $pb.GeneratedMessage {
  factory Label({
    ...
    $core.Iterable<$4206.Field>? fields,
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(_omitMessageNames ? '' : 'Label', package: const $pb.PackageName(_omitMessageNames ? '' : 'google.apps.drive.labels.v2'), createEmptyInstance: create)
    ...
    ..aOM<$4205.UserInfo>(5, _omitFieldNames ? '' : 'creator', subBuilder: $4205.UserInfo.create)
    ..aOM<$1776.Timestamp>(6, _omitFieldNames ? '' : 'createTime', subBuilder: $1776.Timestamp.create)
    ..aOM<$4205.UserInfo>(7, _omitFieldNames ? '' : 'revisionCreator', subBuilder: $4205.UserInfo.create)
    ..aOM<$1776.Timestamp>(8, _omitFieldNames ? '' : 'revisionCreateTime', subBuilder: $1776.Timestamp.create)
    ..aOM<$4205.UserInfo>(9, _omitFieldNames ? '' : 'publisher', subBuilder: $4205.UserInfo.create)
    ..aOM<$1776.Timestamp>(10, _omitFieldNames ? '' : 'publishTime', subBuilder: $1776.Timestamp.create)
    ..aOM<$4205.UserInfo>(11, _omitFieldNames ? '' : 'disabler', subBuilder: $4205.UserInfo.create)
    ...
    ..aOM<$4205.Lifecycle>(15, _omitFieldNames ? '' : 'lifecycle', subBuilder: $4205.Lifecycle.create)
    ...
    ..pc<$4206.Field>(20, _omitFieldNames ? '' : 'fields', $pb.PbFieldType.PM, subBuilder: $4206.Field.create)
    ..aOS(21, _omitFieldNames ? '' : 'learnMoreUri')
    ..aOM<$4205.LockStatus>(22, _omitFieldNames ? '' : 'lockStatus', subBuilder: $4205.LockStatus.create)
    ..hasRequiredFields = false
  ;
  ...
  @$pb.TagNumber(5)
  $4205.UserInfo get creator => $_getN(4);
  @$pb.TagNumber(5)
  set creator($4205.UserInfo v) { setField(5, v); }
  @$pb.TagNumber(5)
  $core.bool hasCreator() => $_has(4);
  @$pb.TagNumber(5)
  void clearCreator() => clearField(5);
  @$pb.TagNumber(5)
  $4205.UserInfo ensureCreator() => $_ensure(4);
  ...
  @$pb.TagNumber(7)
  $4205.UserInfo get revisionCreator => $_getN(6);
  @$pb.TagNumber(7)
  set revisionCreator($4205.UserInfo v) { setField(7, v); }
  @$pb.TagNumber(7)
  $core.bool hasRevisionCreator() => $_has(6);
  @$pb.TagNumber(7)
  void clearRevisionCreator() => clearField(7);
  @$pb.TagNumber(7)
  $4205.UserInfo ensureRevisionCreator() => $_ensure(6);
  ...
  @$pb.TagNumber(9)
  $4205.UserInfo get publisher => $_getN(8);
  @$pb.TagNumber(9)
  set publisher($4205.UserInfo v) { setField(9, v); }
  @$pb.TagNumber(9)
  $core.bool hasPublisher() => $_has(8);
  @$pb.TagNumber(9)
  void clearPublisher() => clearField(9);
  @$pb.TagNumber(9)
  $4205.UserInfo ensurePublisher() => $_ensure(8);
  ...
  @$pb.TagNumber(11)
  $4205.UserInfo get disabler => $_getN(10);
  @$pb.TagNumber(11)
  set disabler($4205.UserInfo v) { setField(11, v); }
  @$pb.TagNumber(11)
  $core.bool hasDisabler() => $_has(10);
  @$pb.TagNumber(11)
  void clearDisabler() => clearField(11);
  @$pb.TagNumber(11)
  $4205.UserInfo ensureDisabler() => $_ensure(10);
  ...
  @$pb.TagNumber(15)
  $4205.Lifecycle get lifecycle => $_getN(14);
  @$pb.TagNumber(15)
  set lifecycle($4205.Lifecycle v) { setField(15, v); }
  @$pb.TagNumber(15)
  $core.bool hasLifecycle() => $_has(14);
  @$pb.TagNumber(15)
  void clearLifecycle() => clearField(15);
  @$pb.TagNumber(15)
  $4205.Lifecycle ensureLifecycle() => $_ensure(14);
  ...
  @$pb.TagNumber(20)
  $core.List<$4206.Field> get fields => $_getList(19);
  ...
  @$pb.TagNumber(22)
  $4205.LockStatus get lockStatus => $_getN(21);
  @$pb.TagNumber(22)
  set lockStatus($4205.LockStatus v) { setField(22, v); }
  @$pb.TagNumber(22)
  $core.bool hasLockStatus() => $_has(21);
  @$pb.TagNumber(22)
  void clearLockStatus() => clearField(22);
  @$pb.TagNumber(22)
  $4205.LockStatus ensureLockStatus() => $_ensure(21);
}
