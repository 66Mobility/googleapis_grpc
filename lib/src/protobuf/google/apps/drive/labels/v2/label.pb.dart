...
class Label extends $pb.GeneratedMessage {
  factory Label({
    ...
    $core.Iterable<$4205.Field>? fields,
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(_omitMessageNames ? '' : 'Label', package: const $pb.PackageName(_omitMessageNames ? '' : 'google.apps.drive.labels.v2'), createEmptyInstance: create)
    ...
    ..aOM<$4204.UserInfo>(5, _omitFieldNames ? '' : 'creator', subBuilder: $4204.UserInfo.create)
    ..aOM<$1775.Timestamp>(6, _omitFieldNames ? '' : 'createTime', subBuilder: $1775.Timestamp.create)
    ..aOM<$4204.UserInfo>(7, _omitFieldNames ? '' : 'revisionCreator', subBuilder: $4204.UserInfo.create)
    ..aOM<$1775.Timestamp>(8, _omitFieldNames ? '' : 'revisionCreateTime', subBuilder: $1775.Timestamp.create)
    ..aOM<$4204.UserInfo>(9, _omitFieldNames ? '' : 'publisher', subBuilder: $4204.UserInfo.create)
    ..aOM<$1775.Timestamp>(10, _omitFieldNames ? '' : 'publishTime', subBuilder: $1775.Timestamp.create)
    ..aOM<$4204.UserInfo>(11, _omitFieldNames ? '' : 'disabler', subBuilder: $4204.UserInfo.create)
    ...
    ..aOM<$4204.Lifecycle>(15, _omitFieldNames ? '' : 'lifecycle', subBuilder: $4204.Lifecycle.create)
    ...
    ..pc<$4205.Field>(20, _omitFieldNames ? '' : 'fields', $pb.PbFieldType.PM, subBuilder: $4205.Field.create)
    ..aOS(21, _omitFieldNames ? '' : 'learnMoreUri')
    ..aOM<$4204.LockStatus>(22, _omitFieldNames ? '' : 'lockStatus', subBuilder: $4204.LockStatus.create)
    ..hasRequiredFields = false
  ;
  ...
  @$pb.TagNumber(5)
  $4204.UserInfo get creator => $_getN(4);
  @$pb.TagNumber(5)
  set creator($4204.UserInfo v) { setField(5, v); }
  @$pb.TagNumber(5)
  $core.bool hasCreator() => $_has(4);
  @$pb.TagNumber(5)
  void clearCreator() => clearField(5);
  @$pb.TagNumber(5)
  $4204.UserInfo ensureCreator() => $_ensure(4);
  ...
  @$pb.TagNumber(7)
  $4204.UserInfo get revisionCreator => $_getN(6);
  @$pb.TagNumber(7)
  set revisionCreator($4204.UserInfo v) { setField(7, v); }
  @$pb.TagNumber(7)
  $core.bool hasRevisionCreator() => $_has(6);
  @$pb.TagNumber(7)
  void clearRevisionCreator() => clearField(7);
  @$pb.TagNumber(7)
  $4204.UserInfo ensureRevisionCreator() => $_ensure(6);
  ...
  @$pb.TagNumber(9)
  $4204.UserInfo get publisher => $_getN(8);
  @$pb.TagNumber(9)
  set publisher($4204.UserInfo v) { setField(9, v); }
  @$pb.TagNumber(9)
  $core.bool hasPublisher() => $_has(8);
  @$pb.TagNumber(9)
  void clearPublisher() => clearField(9);
  @$pb.TagNumber(9)
  $4204.UserInfo ensurePublisher() => $_ensure(8);
  ...
  @$pb.TagNumber(11)
  $4204.UserInfo get disabler => $_getN(10);
  @$pb.TagNumber(11)
  set disabler($4204.UserInfo v) { setField(11, v); }
  @$pb.TagNumber(11)
  $core.bool hasDisabler() => $_has(10);
  @$pb.TagNumber(11)
  void clearDisabler() => clearField(11);
  @$pb.TagNumber(11)
  $4204.UserInfo ensureDisabler() => $_ensure(10);
  ...
  @$pb.TagNumber(15)
  $4204.Lifecycle get lifecycle => $_getN(14);
  @$pb.TagNumber(15)
  set lifecycle($4204.Lifecycle v) { setField(15, v); }
  @$pb.TagNumber(15)
  $core.bool hasLifecycle() => $_has(14);
  @$pb.TagNumber(15)
  void clearLifecycle() => clearField(15);
  @$pb.TagNumber(15)
  $4204.Lifecycle ensureLifecycle() => $_ensure(14);
  ...
  @$pb.TagNumber(20)
  $core.List<$4205.Field> get fields => $_getList(19);
  ...
  @$pb.TagNumber(22)
  $4204.LockStatus get lockStatus => $_getN(21);
  @$pb.TagNumber(22)
  set lockStatus($4204.LockStatus v) { setField(22, v); }
  @$pb.TagNumber(22)
  $core.bool hasLockStatus() => $_has(21);
  @$pb.TagNumber(22)
  void clearLockStatus() => clearField(22);
  @$pb.TagNumber(22)
  $4204.LockStatus ensureLockStatus() => $_ensure(21);
}
