...
class Field_SelectionOptions_Choice_Properties extends $pb.GeneratedMessage {
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(_omitMessageNames ? '' : 'Field.SelectionOptions.Choice.Properties', package: const $pb.PackageName(_omitMessageNames ? '' : 'google.apps.drive.labels.v2'), createEmptyInstance: create)
    ...
    ..aOM<$389.BadgeConfig>(3, _omitFieldNames ? '' : 'badgeConfig', subBuilder: $389.BadgeConfig.create)
  ...
  @$pb.TagNumber(3)
  $389.BadgeConfig get badgeConfig => $_getN(2);
  @$pb.TagNumber(3)
  set badgeConfig($389.BadgeConfig v) { setField(3, v); }
  @$pb.TagNumber(3)
  $core.bool hasBadgeConfig() => $_has(2);
  @$pb.TagNumber(3)
  void clearBadgeConfig() => clearField(3);
  @$pb.TagNumber(3)
  $389.BadgeConfig ensureBadgeConfig() => $_ensure(2);
...
class Field_SelectionOptions_Choice_DisplayHints extends $pb.GeneratedMessage {
  factory Field_SelectionOptions_Choice_DisplayHints({
    ...
    $core.bool? hiddenInSearch,
    $core.bool? shownInApply,
    $389.BadgeColors? badgeColors,
    $389.BadgeColors? darkBadgeColors,
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(_omitMessageNames ? '' : 'Field.SelectionOptions.Choice.DisplayHints', package: const $pb.PackageName(_omitMessageNames ? '' : 'google.apps.drive.labels.v2'), createEmptyInstance: create)
    ...
    ..aOM<$389.BadgeColors>(4, _omitFieldNames ? '' : 'badgeColors', subBuilder: $389.BadgeColors.create)
    ..aOM<$389.BadgeColors>(5, _omitFieldNames ? '' : 'darkBadgeColors', subBuilder: $389.BadgeColors.create)
  ...
  @$pb.TagNumber(4)
  $389.BadgeColors get badgeColors => $_getN(3);
  @$pb.TagNumber(4)
  set badgeColors($389.BadgeColors v) { setField(4, v); }
  @$pb.TagNumber(4)
  $core.bool hasBadgeColors() => $_has(3);
  @$pb.TagNumber(4)
  void clearBadgeColors() => clearField(4);
  @$pb.TagNumber(4)
  $389.BadgeColors ensureBadgeColors() => $_ensure(3);
  ...
  @$pb.TagNumber(5)
  $389.BadgeColors get darkBadgeColors => $_getN(4);
  @$pb.TagNumber(5)
  set darkBadgeColors($389.BadgeColors v) { setField(5, v); }
  @$pb.TagNumber(5)
  $core.bool hasDarkBadgeColors() => $_has(4);
  @$pb.TagNumber(5)
  void clearDarkBadgeColors() => clearField(5);
  @$pb.TagNumber(5)
  $389.BadgeColors ensureDarkBadgeColors() => $_ensure(4);
...
class Field_SelectionOptions_Choice extends $pb.GeneratedMessage {
  factory Field_SelectionOptions_Choice({
    ...
    $389.UserInfo? creator,
    $301.Timestamp? createTime,
    $389.UserInfo? updater,
    $301.Timestamp? updateTime,
    $389.UserInfo? publisher,
    $301.Timestamp? publishTime,
    $389.UserInfo? disabler,
    $301.Timestamp? disableTime,
    $389.LockStatus? lockStatus,
  }) {
    final $result = create();
    if (id != null) {
      $result.id = id;
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(_omitMessageNames ? '' : 'Field.SelectionOptions.Choice', package: const $pb.PackageName(_omitMessageNames ? '' : 'google.apps.drive.labels.v2'), createEmptyInstance: create)
    ...
    ..aOM<$389.Lifecycle>(3, _omitFieldNames ? '' : 'lifecycle', subBuilder: $389.Lifecycle.create)
    ...
    ..aOM<$389.UserInfo>(7, _omitFieldNames ? '' : 'creator', subBuilder: $389.UserInfo.create)
    ..aOM<$301.Timestamp>(8, _omitFieldNames ? '' : 'createTime', subBuilder: $301.Timestamp.create)
    ..aOM<$389.UserInfo>(9, _omitFieldNames ? '' : 'updater', subBuilder: $389.UserInfo.create)
    ..aOM<$301.Timestamp>(10, _omitFieldNames ? '' : 'updateTime', subBuilder: $301.Timestamp.create)
    ..aOM<$389.UserInfo>(11, _omitFieldNames ? '' : 'publisher', subBuilder: $389.UserInfo.create)
    ..aOM<$301.Timestamp>(12, _omitFieldNames ? '' : 'publishTime', subBuilder: $301.Timestamp.create)
    ..aOM<$389.UserInfo>(13, _omitFieldNames ? '' : 'disabler', subBuilder: $389.UserInfo.create)
    ..aOM<$301.Timestamp>(14, _omitFieldNames ? '' : 'disableTime', subBuilder: $301.Timestamp.create)
    ..aOM<$389.LockStatus>(15, _omitFieldNames ? '' : 'lockStatus', subBuilder: $389.LockStatus.create)
    ..hasRequiredFields = false
  ;
  ...
  @$pb.TagNumber(3)
  $389.Lifecycle get lifecycle => $_getN(2);
  @$pb.TagNumber(3)
  set lifecycle($389.Lifecycle v) { setField(3, v); }
  @$pb.TagNumber(3)
  $core.bool hasLifecycle() => $_has(2);
  @$pb.TagNumber(3)
  void clearLifecycle() => clearField(3);
  @$pb.TagNumber(3)
  $389.Lifecycle ensureLifecycle() => $_ensure(2);
  ...
  @$pb.TagNumber(7)
  $389.UserInfo get creator => $_getN(6);
  @$pb.TagNumber(7)
  set creator($389.UserInfo v) { setField(7, v); }
  @$pb.TagNumber(7)
  $core.bool hasCreator() => $_has(6);
  @$pb.TagNumber(7)
  void clearCreator() => clearField(7);
  @$pb.TagNumber(7)
  $389.UserInfo ensureCreator() => $_ensure(6);
  ...
  @$pb.TagNumber(9)
  $389.UserInfo get updater => $_getN(8);
  @$pb.TagNumber(9)
  set updater($389.UserInfo v) { setField(9, v); }
  @$pb.TagNumber(9)
  $core.bool hasUpdater() => $_has(8);
  @$pb.TagNumber(9)
  void clearUpdater() => clearField(9);
  @$pb.TagNumber(9)
  $389.UserInfo ensureUpdater() => $_ensure(8);
  ...
  @$pb.TagNumber(11)
  $389.UserInfo get publisher => $_getN(10);
  @$pb.TagNumber(11)
  set publisher($389.UserInfo v) { setField(11, v); }
  @$pb.TagNumber(11)
  $core.bool hasPublisher() => $_has(10);
  @$pb.TagNumber(11)
  void clearPublisher() => clearField(11);
  @$pb.TagNumber(11)
  $389.UserInfo ensurePublisher() => $_ensure(10);
  ...
  @$pb.TagNumber(13)
  $389.UserInfo get disabler => $_getN(12);
  @$pb.TagNumber(13)
  set disabler($389.UserInfo v) { setField(13, v); }
  @$pb.TagNumber(13)
  $core.bool hasDisabler() => $_has(12);
  @$pb.TagNumber(13)
  void clearDisabler() => clearField(13);
  @$pb.TagNumber(13)
  $389.UserInfo ensureDisabler() => $_ensure(12);
  ...
  @$pb.TagNumber(15)
  $389.LockStatus get lockStatus => $_getN(14);
  @$pb.TagNumber(15)
  set lockStatus($389.LockStatus v) { setField(15, v); }
  @$pb.TagNumber(15)
  $core.bool hasLockStatus() => $_has(14);
  @$pb.TagNumber(15)
  void clearLockStatus() => clearField(15);
  @$pb.TagNumber(15)
  $389.LockStatus ensureLockStatus() => $_ensure(14);
}
...
class Field extends $pb.GeneratedMessage {
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(_omitMessageNames ? '' : 'Field', package: const $pb.PackageName(_omitMessageNames ? '' : 'google.apps.drive.labels.v2'), createEmptyInstance: create)
    ...
    ..aOM<$389.Lifecycle>(4, _omitFieldNames ? '' : 'lifecycle', subBuilder: $389.Lifecycle.create)
    ...
    ..aOM<$389.UserInfo>(8, _omitFieldNames ? '' : 'creator', subBuilder: $389.UserInfo.create)
    ..aOM<$301.Timestamp>(9, _omitFieldNames ? '' : 'createTime', subBuilder: $301.Timestamp.create)
    ..aOM<$389.UserInfo>(10, _omitFieldNames ? '' : 'updater', subBuilder: $389.UserInfo.create)
    ..aOM<$301.Timestamp>(11, _omitFieldNames ? '' : 'updateTime', subBuilder: $301.Timestamp.create)
    ..aOM<$389.UserInfo>(12, _omitFieldNames ? '' : 'publisher', subBuilder: $389.UserInfo.create)
    ..aOM<$389.UserInfo>(13, _omitFieldNames ? '' : 'disabler', subBuilder: $389.UserInfo.create)
    ..aOM<$301.Timestamp>(14, _omitFieldNames ? '' : 'disableTime', subBuilder: $301.Timestamp.create)
    ..aOM<$389.LockStatus>(15, _omitFieldNames ? '' : 'lockStatus', subBuilder: $389.LockStatus.create)
  ...
  @$pb.TagNumber(4)
  $389.Lifecycle get lifecycle => $_getN(3);
  @$pb.TagNumber(4)
  set lifecycle($389.Lifecycle v) { setField(4, v); }
  @$pb.TagNumber(4)
  $core.bool hasLifecycle() => $_has(3);
  @$pb.TagNumber(4)
  void clearLifecycle() => clearField(4);
  @$pb.TagNumber(4)
  $389.Lifecycle ensureLifecycle() => $_ensure(3);
  ...
  @$pb.TagNumber(8)
  $389.UserInfo get creator => $_getN(7);
  @$pb.TagNumber(8)
  set creator($389.UserInfo v) { setField(8, v); }
  @$pb.TagNumber(8)
  $core.bool hasCreator() => $_has(7);
  @$pb.TagNumber(8)
  void clearCreator() => clearField(8);
  @$pb.TagNumber(8)
  $389.UserInfo ensureCreator() => $_ensure(7);
  ...
  @$pb.TagNumber(10)
  $389.UserInfo get updater => $_getN(9);
  @$pb.TagNumber(10)
  set updater($389.UserInfo v) { setField(10, v); }
  @$pb.TagNumber(10)
  $core.bool hasUpdater() => $_has(9);
  @$pb.TagNumber(10)
  void clearUpdater() => clearField(10);
  @$pb.TagNumber(10)
  $389.UserInfo ensureUpdater() => $_ensure(9);
  ...
  @$pb.TagNumber(12)
  $389.UserInfo get publisher => $_getN(11);
  @$pb.TagNumber(12)
  set publisher($389.UserInfo v) { setField(12, v); }
  @$pb.TagNumber(12)
  $core.bool hasPublisher() => $_has(11);
  @$pb.TagNumber(12)
  void clearPublisher() => clearField(12);
  @$pb.TagNumber(12)
  $389.UserInfo ensurePublisher() => $_ensure(11);
