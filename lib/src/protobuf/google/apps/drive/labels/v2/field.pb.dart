...
class Field_SelectionOptions_Choice_Properties extends $pb.GeneratedMessage {
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(
    ...
    ..aOM<$390.BadgeConfig>(3, _omitFieldNames ? '' : 'badgeConfig',
        subBuilder: $390.BadgeConfig.create)
  ...
  @$pb.TagNumber(3)
  set badgeConfig($390.BadgeConfig v) {
    setField(3, v);
  }
...
class Field_SelectionOptions_Choice_DisplayHints extends $pb.GeneratedMessage {
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(
    ...
    ..aOM<$390.BadgeColors>(4, _omitFieldNames ? '' : 'badgeColors',
        subBuilder: $390.BadgeColors.create)
    ..aOM<$390.BadgeColors>(5, _omitFieldNames ? '' : 'darkBadgeColors',
        subBuilder: $390.BadgeColors.create)
  ...
  @$pb.TagNumber(4)
  set badgeColors($390.BadgeColors v) {
    setField(4, v);
  }
  ...
  @$pb.TagNumber(5)
  set darkBadgeColors($390.BadgeColors v) {
    setField(5, v);
  }
...
class Field_SelectionOptions_Choice extends $pb.GeneratedMessage {
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(
    ...
    ..aOM<$390.Lifecycle>(3, _omitFieldNames ? '' : 'lifecycle',
...
class Field extends $pb.GeneratedMessage {
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(
    ...
    ..aOM<$390.Lifecycle>(4, _omitFieldNames ? '' : 'lifecycle',
        subBuilder: $390.Lifecycle.create)
    ...
    ..aOM<$390.UserInfo>(8, _omitFieldNames ? '' : 'creator',
        subBuilder: $390.UserInfo.create)
    ..aOM<$302.Timestamp>(9, _omitFieldNames ? '' : 'createTime',
        subBuilder: $302.Timestamp.create)
    ..aOM<$390.UserInfo>(10, _omitFieldNames ? '' : 'updater',
        subBuilder: $390.UserInfo.create)
    ..aOM<$302.Timestamp>(11, _omitFieldNames ? '' : 'updateTime',
        subBuilder: $302.Timestamp.create)
    ..aOM<$390.UserInfo>(12, _omitFieldNames ? '' : 'publisher',
        subBuilder: $390.UserInfo.create)
    ..aOM<$390.UserInfo>(13, _omitFieldNames ? '' : 'disabler',
        subBuilder: $390.UserInfo.create)
    ..aOM<$302.Timestamp>(14, _omitFieldNames ? '' : 'disableTime',
