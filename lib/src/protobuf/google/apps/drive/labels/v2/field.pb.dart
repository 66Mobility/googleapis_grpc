...
class Field_DateOptions extends $pb.GeneratedMessage {
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(
    ...
    ..aOM<$355.Date>(3, _omitFieldNames ? '' : 'minValue',
        subBuilder: $355.Date.create)
    ..aOM<$355.Date>(4, _omitFieldNames ? '' : 'maxValue',
        subBuilder: $355.Date.create)
    ..hasRequiredFields = false;
  ...
  @$pb.TagNumber(3)
  $355.Date get minValue => $_getN(2);
  @$pb.TagNumber(3)
  set minValue($355.Date v) {
    setField(3, v);
  }
  ...
  @$pb.TagNumber(3)
  $355.Date ensureMinValue() => $_ensure(2);

  /// Output only. Maximum valid value (year, month, day).
  @$pb.TagNumber(4)
  $355.Date get maxValue => $_getN(3);
  @$pb.TagNumber(4)
  set maxValue($355.Date v) {
    setField(4, v);
  }
  ...
  @$pb.TagNumber(4)
  $355.Date ensureMaxValue() => $_ensure(3);
}
...
class Field_SelectionOptions_Choice_Properties extends $pb.GeneratedMessage {
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(
    ...
    ..aOM<$421.BadgeConfig>(3, _omitFieldNames ? '' : 'badgeConfig',
        subBuilder: $421.BadgeConfig.create)
  ...
  @$pb.TagNumber(3)
  $421.BadgeConfig get badgeConfig => $_getN(2);
  @$pb.TagNumber(3)
  set badgeConfig($421.BadgeConfig v) {
    setField(3, v);
  }
  ...
  @$pb.TagNumber(3)
  $421.BadgeConfig ensureBadgeConfig() => $_ensure(2);
...
class Field_SelectionOptions_Choice_DisplayHints extends $pb.GeneratedMessage {
  factory Field_SelectionOptions_Choice_DisplayHints({
    ...
    $core.bool? hiddenInSearch,
    $core.bool? shownInApply,
    $421.BadgeColors? badgeColors,
    $421.BadgeColors? darkBadgeColors,
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(
    ...
    ..aOM<$421.BadgeColors>(4, _omitFieldNames ? '' : 'badgeColors',
        subBuilder: $421.BadgeColors.create)
    ..aOM<$421.BadgeColors>(5, _omitFieldNames ? '' : 'darkBadgeColors',
        subBuilder: $421.BadgeColors.create)
  ...
  @$pb.TagNumber(4)
  $421.BadgeColors get badgeColors => $_getN(3);
  @$pb.TagNumber(4)
  set badgeColors($421.BadgeColors v) {
    setField(4, v);
  }
  ...
  @$pb.TagNumber(4)
  $421.BadgeColors ensureBadgeColors() => $_ensure(3);
  ...
  @$pb.TagNumber(5)
  $421.BadgeColors get darkBadgeColors => $_getN(4);
  @$pb.TagNumber(5)
  set darkBadgeColors($421.BadgeColors v) {
    setField(5, v);
  }
  ...
  @$pb.TagNumber(5)
  $421.BadgeColors ensureDarkBadgeColors() => $_ensure(4);
...
class Field_SelectionOptions_Choice extends $pb.GeneratedMessage {
  factory Field_SelectionOptions_Choice({
    ...
    $421.UserInfo? creator,
    $330.Timestamp? createTime,
    $421.UserInfo? updater,
    $330.Timestamp? updateTime,
    $421.UserInfo? publisher,
    $330.Timestamp? publishTime,
    $421.UserInfo? disabler,
    $330.Timestamp? disableTime,
    $421.LockStatus? lockStatus,
  }) {
    final $result = create();
    if (id != null) {
      $result.id = id;
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(
    ...
    ..aOM<$421.Lifecycle>(3, _omitFieldNames ? '' : 'lifecycle',
        subBuilder: $421.Lifecycle.create)
    ...
    ..aOM<$421.UserInfo>(7, _omitFieldNames ? '' : 'creator',
        subBuilder: $421.UserInfo.create)
    ..aOM<$330.Timestamp>(8, _omitFieldNames ? '' : 'createTime',
        subBuilder: $330.Timestamp.create)
    ..aOM<$421.UserInfo>(9, _omitFieldNames ? '' : 'updater',
        subBuilder: $421.UserInfo.create)
    ..aOM<$330.Timestamp>(10, _omitFieldNames ? '' : 'updateTime',
        subBuilder: $330.Timestamp.create)
    ..aOM<$421.UserInfo>(11, _omitFieldNames ? '' : 'publisher',
        subBuilder: $421.UserInfo.create)
    ..aOM<$330.Timestamp>(12, _omitFieldNames ? '' : 'publishTime',
        subBuilder: $330.Timestamp.create)
    ..aOM<$421.UserInfo>(13, _omitFieldNames ? '' : 'disabler',
        subBuilder: $421.UserInfo.create)
    ..aOM<$330.Timestamp>(14, _omitFieldNames ? '' : 'disableTime',
        subBuilder: $330.Timestamp.create)
    ..aOM<$421.LockStatus>(15, _omitFieldNames ? '' : 'lockStatus',
        subBuilder: $421.LockStatus.create)
    ..hasRequiredFields = false;
  ...
  @$pb.TagNumber(3)
  $421.Lifecycle get lifecycle => $_getN(2);
  @$pb.TagNumber(3)
  set lifecycle($421.Lifecycle v) {
    setField(3, v);
  }
  ...
  @$pb.TagNumber(3)
  $421.Lifecycle ensureLifecycle() => $_ensure(2);
  ...
  @$pb.TagNumber(7)
  $421.UserInfo get creator => $_getN(6);
  @$pb.TagNumber(7)
  set creator($421.UserInfo v) {
    setField(7, v);
  }
  ...
  @$pb.TagNumber(7)
  $421.UserInfo ensureCreator() => $_ensure(6);
  ...
  @$pb.TagNumber(9)
  $421.UserInfo get updater => $_getN(8);
  @$pb.TagNumber(9)
  set updater($421.UserInfo v) {
    setField(9, v);
  }
  ...
  @$pb.TagNumber(9)
  $421.UserInfo ensureUpdater() => $_ensure(8);
  ...
  @$pb.TagNumber(11)
  $421.UserInfo get publisher => $_getN(10);
  @$pb.TagNumber(11)
  set publisher($421.UserInfo v) {
    setField(11, v);
  }
  ...
  @$pb.TagNumber(11)
  $421.UserInfo ensurePublisher() => $_ensure(10);

  /// Output only. The time this choice was published. This value has no
  /// meaning when the choice is not published.
  @$pb.TagNumber(12)
  $330.Timestamp get publishTime => $_getN(11);
  @$pb.TagNumber(12)
  ...
  @$pb.TagNumber(12)
  $330.Timestamp ensurePublishTime() => $_ensure(11);

  /// Output only. The user who disabled this choice. This value has no
  /// meaning when the option is not disabled.
  @$pb.TagNumber(13)
  $421.UserInfo get disabler => $_getN(12);
  @$pb.TagNumber(13)
  set disabler($421.UserInfo v) {
    setField(13, v);
  }
  ...
  @$pb.TagNumber(13)
  $421.UserInfo ensureDisabler() => $_ensure(12);

  /// Output only. The time this choice was disabled. This value has no
  /// meaning when the choice is not disabled.
  @$pb.TagNumber(14)
  $330.Timestamp get disableTime => $_getN(13);
  @$pb.TagNumber(14)
  set disableTime($330.Timestamp v) {
    setField(14, v);
  }
  ...
  @$pb.TagNumber(14)
  $330.Timestamp ensureDisableTime() => $_ensure(13);

  /// Output only. The LockStatus of this choice.
  @$pb.TagNumber(15)
  $421.LockStatus get lockStatus => $_getN(14);
  @$pb.TagNumber(15)
  set lockStatus($421.LockStatus v) {
    setField(15, v);
  }
  ...
  @$pb.TagNumber(15)
  $421.LockStatus ensureLockStatus() => $_ensure(14);
}
...
class Field extends $pb.GeneratedMessage {
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(
    ...
    ..aOM<$421.Lifecycle>(4, _omitFieldNames ? '' : 'lifecycle',
        subBuilder: $421.Lifecycle.create)
    ...
    ..aOM<$421.UserInfo>(8, _omitFieldNames ? '' : 'creator',
        subBuilder: $421.UserInfo.create)
    ..aOM<$330.Timestamp>(9, _omitFieldNames ? '' : 'createTime',
        subBuilder: $330.Timestamp.create)
    ..aOM<$421.UserInfo>(10, _omitFieldNames ? '' : 'updater',
        subBuilder: $421.UserInfo.create)
    ..aOM<$330.Timestamp>(11, _omitFieldNames ? '' : 'updateTime',
        subBuilder: $330.Timestamp.create)
    ..aOM<$421.UserInfo>(12, _omitFieldNames ? '' : 'publisher',
        subBuilder: $421.UserInfo.create)
    ..aOM<$421.UserInfo>(13, _omitFieldNames ? '' : 'disabler',
        subBuilder: $421.UserInfo.create)
    ..aOM<$330.Timestamp>(14, _omitFieldNames ? '' : 'disableTime',
  ...
  @$pb.TagNumber(4)
  $421.Lifecycle get lifecycle => $_getN(3);
  @$pb.TagNumber(4)
  set lifecycle($421.Lifecycle v) {
    setField(4, v);
  }
  ...
  @$pb.TagNumber(4)
  $421.Lifecycle ensureLifecycle() => $_ensure(3);
  ...
  @$pb.TagNumber(8)
  $421.UserInfo get creator => $_getN(7);
  @$pb.TagNumber(8)
  set creator($421.UserInfo v) {
    setField(8, v);
  }
  ...
  @$pb.TagNumber(8)
  $421.UserInfo ensureCreator() => $_ensure(7);
  ...
  @$pb.TagNumber(10)
  $421.UserInfo get updater => $_getN(9);
  @$pb.TagNumber(10)
  set updater($421.UserInfo v) {
    setField(10, v);
  }
  ...
  @$pb.TagNumber(10)
  $421.UserInfo ensureUpdater() => $_ensure(9);
  ...
  @$pb.TagNumber(12)
  $421.UserInfo get publisher => $_getN(11);
  @$pb.TagNumber(12)
  set publisher($421.UserInfo v) {
    setField(12, v);
  }
  ...
  @$pb.TagNumber(12)
  $421.UserInfo ensurePublisher() => $_ensure(11);
