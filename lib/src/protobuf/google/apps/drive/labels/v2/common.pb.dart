...
class Lifecycle_DisabledPolicy extends $pb.GeneratedMessage {
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(_omitMessageNames ? '' : 'Lifecycle.DisabledPolicy', package: const $pb.PackageName(_omitMessageNames ? '' : 'google.apps.drive.labels.v2'), createEmptyInstance: create)
...
class Lifecycle extends $pb.GeneratedMessage {
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(_omitMessageNames ? '' : 'Lifecycle', package: const $pb.PackageName(_omitMessageNames ? '' : 'google.apps.drive.labels.v2'), createEmptyInstance: create)
...
class UserInfo extends $pb.GeneratedMessage {
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(_omitMessageNames ? '' : 'UserInfo', package: const $pb.PackageName(_omitMessageNames ? '' : 'google.apps.drive.labels.v2'), createEmptyInstance: create)
...
class BadgeConfig extends $pb.GeneratedMessage {
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(_omitMessageNames ? '' : 'BadgeConfig', package: const $pb.PackageName(_omitMessageNames ? '' : 'google.apps.drive.labels.v2'), createEmptyInstance: create)
    ..aOM<$382.Color>(1, _omitFieldNames ? '' : 'color', subBuilder: $382.Color.create)
  ...
  @$pb.TagNumber(1)
  $382.Color get color => $_getN(0);
  @$pb.TagNumber(1)
  set color($382.Color v) { setField(1, v); }
  @$pb.TagNumber(1)
  $core.bool hasColor() => $_has(0);
  @$pb.TagNumber(1)
  void clearColor() => clearField(1);
  @$pb.TagNumber(1)
  $382.Color ensureColor() => $_ensure(0);
...
class BadgeColors extends $pb.GeneratedMessage {
  factory BadgeColors({
    $382.Color? backgroundColor,
    $382.Color? foregroundColor,
    $382.Color? soloColor,
  }) {
    final $result = create();
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(_omitMessageNames ? '' : 'BadgeColors', package: const $pb.PackageName(_omitMessageNames ? '' : 'google.apps.drive.labels.v2'), createEmptyInstance: create)
    ..aOM<$382.Color>(1, _omitFieldNames ? '' : 'backgroundColor', subBuilder: $382.Color.create)
    ..aOM<$382.Color>(2, _omitFieldNames ? '' : 'foregroundColor', subBuilder: $382.Color.create)
    ..aOM<$382.Color>(3, _omitFieldNames ? '' : 'soloColor', subBuilder: $382.Color.create)
    ..hasRequiredFields = false
  ;
  ...
  @$pb.TagNumber(1)
  $382.Color get backgroundColor => $_getN(0);
  @$pb.TagNumber(1)
  set backgroundColor($382.Color v) { setField(1, v); }
  @$pb.TagNumber(1)
  $core.bool hasBackgroundColor() => $_has(0);
  @$pb.TagNumber(1)
  void clearBackgroundColor() => clearField(1);
  @$pb.TagNumber(1)
  $382.Color ensureBackgroundColor() => $_ensure(0);

  /// Output only. Badge foreground that pairs with the background.
  @$pb.TagNumber(2)
  $382.Color get foregroundColor => $_getN(1);
  @$pb.TagNumber(2)
  set foregroundColor($382.Color v) { setField(2, v); }
  @$pb.TagNumber(2)
  $core.bool hasForegroundColor() => $_has(1);
  @$pb.TagNumber(2)
  void clearForegroundColor() => clearField(2);
  @$pb.TagNumber(2)
  $382.Color ensureForegroundColor() => $_ensure(1);

  /// Output only. Color that can be used for text without a background.
  @$pb.TagNumber(3)
  $382.Color get soloColor => $_getN(2);
  @$pb.TagNumber(3)
  set soloColor($382.Color v) { setField(3, v); }
  @$pb.TagNumber(3)
  $core.bool hasSoloColor() => $_has(2);
  @$pb.TagNumber(3)
  void clearSoloColor() => clearField(3);
  @$pb.TagNumber(3)
  $382.Color ensureSoloColor() => $_ensure(2);
}
...
class LockStatus extends $pb.GeneratedMessage {
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(_omitMessageNames ? '' : 'LockStatus', package: const $pb.PackageName(_omitMessageNames ? '' : 'google.apps.drive.labels.v2'), createEmptyInstance: create)
