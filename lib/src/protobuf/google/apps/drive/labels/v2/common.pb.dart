...
import '../../../../type/color.pb.dart' as $416;
...
class BadgeConfig extends $pb.GeneratedMessage {
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(
      ...
      package: const $pb.PackageName(
          _omitMessageNames ? '' : 'google.apps.drive.labels.v2'),
      createEmptyInstance: create)
    ..aOM<$416.Color>(1, _omitFieldNames ? '' : 'color',
        subBuilder: $416.Color.create)
  ...
  @$pb.TagNumber(1)
  $416.Color get color => $_getN(0);
  @$pb.TagNumber(1)
  set color($416.Color v) {
    setField(1, v);
  }
  ...
  @$pb.TagNumber(1)
  $416.Color ensureColor() => $_ensure(0);
...
class BadgeColors extends $pb.GeneratedMessage {
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(
      ...
      package: const $pb.PackageName(
          _omitMessageNames ? '' : 'google.apps.drive.labels.v2'),
      createEmptyInstance: create)
    ..aOM<$416.Color>(1, _omitFieldNames ? '' : 'backgroundColor',
        subBuilder: $416.Color.create)
    ..aOM<$416.Color>(2, _omitFieldNames ? '' : 'foregroundColor',
        subBuilder: $416.Color.create)
    ..aOM<$416.Color>(3, _omitFieldNames ? '' : 'soloColor',
        subBuilder: $416.Color.create)
    ..hasRequiredFields = false;
  ...
  @$pb.TagNumber(1)
  $416.Color get backgroundColor => $_getN(0);
  @$pb.TagNumber(1)
  set backgroundColor($416.Color v) {
    setField(1, v);
  }
  ...
  @$pb.TagNumber(1)
  $416.Color ensureBackgroundColor() => $_ensure(0);

  /// Output only. Badge foreground that pairs with the background.
  @$pb.TagNumber(2)
  $416.Color get foregroundColor => $_getN(1);
  @$pb.TagNumber(2)
  set foregroundColor($416.Color v) {
    setField(2, v);
  }
  ...
  @$pb.TagNumber(2)
  $416.Color ensureForegroundColor() => $_ensure(1);

  /// Output only. Color that can be used for text without a background.
  @$pb.TagNumber(3)
  $416.Color get soloColor => $_getN(2);
  @$pb.TagNumber(3)
  set soloColor($416.Color v) {
    setField(3, v);
  }
  ...
  @$pb.TagNumber(3)
  $416.Color ensureSoloColor() => $_ensure(2);
}
