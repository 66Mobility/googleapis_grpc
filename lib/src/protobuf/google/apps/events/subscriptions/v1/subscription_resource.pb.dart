...
class Subscription extends $pb.GeneratedMessage {
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(
    ...
    ..aOM<$330.Timestamp>(12, _omitFieldNames ? '' : 'updateTime',
        subBuilder: $330.Timestamp.create)
    ..aOM<$330.Timestamp>(13, _omitFieldNames ? '' : 'expireTime',
        subBuilder: $330.Timestamp.create)
    ..aOM<$292.Duration>(14, _omitFieldNames ? '' : 'ttl',
  ...
  @$pb.TagNumber(13)
  $330.Timestamp get expireTime => $_getN(10);
  @$pb.TagNumber(13)
  ...
  @$pb.TagNumber(13)
  $330.Timestamp ensureExpireTime() => $_ensure(10);
  ...
  @$pb.TagNumber(14)
  $292.Duration ensureTtl() => $_ensure(11);
