...
class SubscriptionsServiceClient extends $grpc.Client {
  static final _$createSubscription = $grpc.ClientMethod<
          $78.CreateSubscriptionRequest, $13.Operation>(
  ...
  static final _$deleteSubscription = $grpc.ClientMethod<
          $78.DeleteSubscriptionRequest, $13.Operation>(
  ...
  static final _$getSubscription = $grpc.ClientMethod<
          $78.GetSubscriptionRequest, $79.Subscription>(
  ...
  static final _$listSubscriptions = $grpc.ClientMethod<
          $78.ListSubscriptionsRequest, $78.ListSubscriptionsResponse>(
      ...
      ($core.List<$core.int> value) =>
          $78.ListSubscriptionsResponse.fromBuffer(value));
  static final _$updateSubscription = $grpc.ClientMethod<
          $78.UpdateSubscriptionRequest, $13.Operation>(
  ...
  static final _$reactivateSubscription = $grpc.ClientMethod<
          $78.ReactivateSubscriptionRequest, $13.Operation>(
  ...
  $grpc.ResponseFuture<$13.Operation> reactivateSubscription(
      $78.ReactivateSubscriptionRequest request,
      {$grpc.CallOptions? options}) {
...
abstract class SubscriptionsServiceBase extends $grpc.Service {
  ...
  SubscriptionsServiceBase() {
    $addMethod(
        $grpc.ServiceMethod<$78.CreateSubscriptionRequest, $13.Operation>(
            'CreateSubscription',
            createSubscription_Pre,
            false,
            false,
            ($core.List<$core.int> value) =>
                $78.CreateSubscriptionRequest.fromBuffer(value),
            ($13.Operation value) => value.writeToBuffer()));
    $addMethod(
        $grpc.ServiceMethod<$78.DeleteSubscriptionRequest, $13.Operation>(
            'DeleteSubscription',
            deleteSubscription_Pre,
            false,
            false,
            ($core.List<$core.int> value) =>
                $78.DeleteSubscriptionRequest.fromBuffer(value),
            ($13.Operation value) => value.writeToBuffer()));
    $addMethod(
        $grpc.ServiceMethod<$78.GetSubscriptionRequest, $79.Subscription>(
            'GetSubscription',
            getSubscription_Pre,
            false,
            false,
            ($core.List<$core.int> value) =>
                $78.GetSubscriptionRequest.fromBuffer(value),
            ($79.Subscription value) => value.writeToBuffer()));
    $addMethod($grpc.ServiceMethod<$78.ListSubscriptionsRequest,
            $78.ListSubscriptionsResponse>(
        'ListSubscriptions',
        listSubscriptions_Pre,
        false,
        false,
        ($core.List<$core.int> value) =>
            $78.ListSubscriptionsRequest.fromBuffer(value),
        ($78.ListSubscriptionsResponse value) => value.writeToBuffer()));
    $addMethod(
        $grpc.ServiceMethod<$78.UpdateSubscriptionRequest, $13.Operation>(
            'UpdateSubscription',
            updateSubscription_Pre,
            false,
            false,
            ($core.List<$core.int> value) =>
                $78.UpdateSubscriptionRequest.fromBuffer(value),
            ($13.Operation value) => value.writeToBuffer()));
    $addMethod(
        $grpc.ServiceMethod<$78.ReactivateSubscriptionRequest, $13.Operation>(
            'ReactivateSubscription',
            reactivateSubscription_Pre,
            false,
            false,
            ($core.List<$core.int> value) =>
                $78.ReactivateSubscriptionRequest.fromBuffer(value),
            ($13.Operation value) => value.writeToBuffer()));
  }

  $async.Future<$13.Operation> createSubscription_Pre($grpc.ServiceCall call,
      $async.Future<$78.CreateSubscriptionRequest> request) async {
    return createSubscription(call, await request);
  }

  $async.Future<$13.Operation> deleteSubscription_Pre($grpc.ServiceCall call,
      $async.Future<$78.DeleteSubscriptionRequest> request) async {
    return deleteSubscription(call, await request);
  }

  $async.Future<$79.Subscription> getSubscription_Pre($grpc.ServiceCall call,
      $async.Future<$78.GetSubscriptionRequest> request) async {
    return getSubscription(call, await request);
  }

  $async.Future<$78.ListSubscriptionsResponse> listSubscriptions_Pre(
      $grpc.ServiceCall call,
      $async.Future<$78.ListSubscriptionsRequest> request) async {
    return listSubscriptions(call, await request);
  }

  $async.Future<$13.Operation> updateSubscription_Pre($grpc.ServiceCall call,
      $async.Future<$78.UpdateSubscriptionRequest> request) async {
    return updateSubscription(call, await request);
  }

  $async.Future<$13.Operation> reactivateSubscription_Pre(
      $grpc.ServiceCall call,
      $async.Future<$78.ReactivateSubscriptionRequest> request) async {
    return reactivateSubscription(call, await request);
  }

  $async.Future<$13.Operation> createSubscription(
      $grpc.ServiceCall call, $78.CreateSubscriptionRequest request);
  $async.Future<$13.Operation> deleteSubscription(
      $grpc.ServiceCall call, $78.DeleteSubscriptionRequest request);
  $async.Future<$79.Subscription> getSubscription(
      $grpc.ServiceCall call, $78.GetSubscriptionRequest request);
  $async.Future<$78.ListSubscriptionsResponse> listSubscriptions(
      $grpc.ServiceCall call, $78.ListSubscriptionsRequest request);
  $async.Future<$13.Operation> updateSubscription(
      $grpc.ServiceCall call, $78.UpdateSubscriptionRequest request);
  $async.Future<$13.Operation> reactivateSubscription(
      $grpc.ServiceCall call, $78.ReactivateSubscriptionRequest request);
}
