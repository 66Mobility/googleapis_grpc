...
class Alert extends $pb.GeneratedMessage {
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(
    ...
    ..aOM<$349.Any>(8, _omitFieldNames ? '' : 'data',
  ...
  @$pb.TagNumber(13)
  $330.Timestamp get updateTime => $_getN(11);
  @$pb.TagNumber(13)
  ...
  @$pb.TagNumber(13)
  $330.Timestamp ensureUpdateTime() => $_ensure(11);
...
class AlertMetadata extends $pb.GeneratedMessage {
  ...
  @$pb.TagNumber(6)
  $330.Timestamp get updateTime => $_getN(4);
  @$pb.TagNumber(6)
  set updateTime($330.Timestamp v) {
    setField(6, v);
  }
  ...
  @$pb.TagNumber(6)
  $330.Timestamp ensureUpdateTime() => $_ensure(4);
...
class BatchDeleteAlertsResponse extends $pb.GeneratedMessage {
  factory BatchDeleteAlertsResponse({
    ...
    $core.Map<$core.String, $350.Status>? failedAlertStatus,
  }) {
    final $result = create();
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(
    ...
    ..m<$core.String, $350.Status>(
        2, _omitFieldNames ? '' : 'failedAlertStatus',
  ...
  @$pb.TagNumber(2)
  $core.Map<$core.String, $350.Status> get failedAlertStatus => $_getMap(1);
}
