...
class Participant extends $pb.GeneratedMessage {
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(
    ...
    ..aOM<$330.Timestamp>(7, _omitFieldNames ? '' : 'earliestStartTime',
        subBuilder: $330.Timestamp.create)
    ..aOM<$330.Timestamp>(8, _omitFieldNames ? '' : 'latestEndTime',
        subBuilder: $330.Timestamp.create)
    ..hasRequiredFields = false;
  ...
  @$pb.TagNumber(7)
  $330.Timestamp get earliestStartTime => $_getN(4);
  @$pb.TagNumber(7)
  ...
  @$pb.TagNumber(7)
  $330.Timestamp ensureEarliestStartTime() => $_ensure(4);

  /// Output only. Time when the participant left the meeting for the last time.
  /// This can be null if it's an active meeting.
  @$pb.TagNumber(8)
  $330.Timestamp get latestEndTime => $_getN(5);
  @$pb.TagNumber(8)
  set latestEndTime($330.Timestamp v) {
    setField(8, v);
  }
  ...
  @$pb.TagNumber(8)
  $330.Timestamp ensureLatestEndTime() => $_ensure(5);
}
...
class TranscriptEntry extends $pb.GeneratedMessage {
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(
    ...
    ..aOM<$330.Timestamp>(5, _omitFieldNames ? '' : 'startTime',
        subBuilder: $330.Timestamp.create)
    ..aOM<$330.Timestamp>(6, _omitFieldNames ? '' : 'endTime',
        subBuilder: $330.Timestamp.create)
    ..hasRequiredFields = false;
