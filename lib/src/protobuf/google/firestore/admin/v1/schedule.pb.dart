...
import '../../../type/dayofweek.pbenum.dart' as $424;
...
class BackupSchedule extends $pb.GeneratedMessage {
  ...
  static const $core.Map<$core.int, BackupSchedule_Recurrence> _BackupSchedule_RecurrenceByTag = {
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(_omitMessageNames ? '' : 'BackupSchedule', package: const $pb.PackageName(_omitMessageNames ? '' : 'google.firestore.admin.v1'), createEmptyInstance: create)
    ...
    ..aOM<$261.Duration>(6, _omitFieldNames ? '' : 'retention', subBuilder: $261.Duration.create)
  ...
  BackupSchedule_Recurrence whichRecurrence() => _BackupSchedule_RecurrenceByTag[$_whichOneof(0)]!;
  ...
  @$pb.TagNumber(6)
  set retention($261.Duration v) { setField(6, v); }
  @$pb.TagNumber(6)
  $core.bool hasRetention() => $_has(2);
  @$pb.TagNumber(6)
  void clearRetention() => clearField(6);
  @$pb.TagNumber(6)
  $261.Duration ensureRetention() => $_ensure(2);

  /// For a schedule that runs daily.
  @$pb.TagNumber(7)
  DailyRecurrence get dailyRecurrence => $_getN(3);
  @$pb.TagNumber(7)
  set dailyRecurrence(DailyRecurrence v) { setField(7, v); }
  @$pb.TagNumber(7)
  ...
  @$pb.TagNumber(8)
  set weeklyRecurrence(WeeklyRecurrence v) { setField(8, v); }
  @$pb.TagNumber(8)
...
class DailyRecurrence extends $pb.GeneratedMessage {
  ...
  factory DailyRecurrence.fromBuffer($core.List<$core.int> i, [$pb.ExtensionRegistry r = $pb.ExtensionRegistry.EMPTY]) => create()..mergeFromBuffer(i, r);
  factory DailyRecurrence.fromJson($core.String i, [$pb.ExtensionRegistry r = $pb.ExtensionRegistry.EMPTY]) => create()..mergeFromJson(i, r);

  static final $pb.BuilderInfo _i = $pb.BuilderInfo(_omitMessageNames ? '' : 'DailyRecurrence', package: const $pb.PackageName(_omitMessageNames ? '' : 'google.firestore.admin.v1'), createEmptyInstance: create)
    ..hasRequiredFields = false
  ;
  ...
  'Use [GeneratedMessageGenericExtensions.rebuild] instead. '
  'Will be removed in next major version')
  DailyRecurrence copyWith(void Function(DailyRecurrence) updates) => super.copyWith((message) => updates(message as DailyRecurrence)) as DailyRecurrence;
  ...
  static $pb.PbList<DailyRecurrence> createRepeated() => $pb.PbList<DailyRecurrence>();
  @$core.pragma('dart2js:noInline')
  static DailyRecurrence getDefault() => _defaultInstance ??= $pb.GeneratedMessage.$_defaultFor<DailyRecurrence>(create);
...
class WeeklyRecurrence extends $pb.GeneratedMessage {
  ...
  factory WeeklyRecurrence.fromBuffer($core.List<$core.int> i, [$pb.ExtensionRegistry r = $pb.ExtensionRegistry.EMPTY]) => create()..mergeFromBuffer(i, r);
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(_omitMessageNames ? '' : 'WeeklyRecurrence', package: const $pb.PackageName(_omitMessageNames ? '' : 'google.firestore.admin.v1'), createEmptyInstance: create)
    ..e<$424.DayOfWeek>(2, _omitFieldNames ? '' : 'day', $pb.PbFieldType.OE, defaultOrMaker: $424.DayOfWeek.DAY_OF_WEEK_UNSPECIFIED, valueOf: $424.DayOfWeek.valueOf, enumValues: $424.DayOfWeek.values)
    ..hasRequiredFields = false
  ;
  ...
  'Use [GeneratedMessageGenericExtensions.rebuild] instead. '
  'Will be removed in next major version')
  WeeklyRecurrence copyWith(void Function(WeeklyRecurrence) updates) => super.copyWith((message) => updates(message as WeeklyRecurrence)) as WeeklyRecurrence;
  ...
  static $pb.PbList<WeeklyRecurrence> createRepeated() => $pb.PbList<WeeklyRecurrence>();
  @$core.pragma('dart2js:noInline')
  static WeeklyRecurrence getDefault() => _defaultInstance ??= $pb.GeneratedMessage.$_defaultFor<WeeklyRecurrence>(create);
  ...
  @$pb.TagNumber(2)
  $424.DayOfWeek get day => $_getN(0);
  @$pb.TagNumber(2)
  set day($424.DayOfWeek v) { setField(2, v); }
  @$pb.TagNumber(2)
