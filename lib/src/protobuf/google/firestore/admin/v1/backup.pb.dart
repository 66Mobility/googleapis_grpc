...
class Backup_Stats extends $pb.GeneratedMessage {
  ...
  factory Backup_Stats.fromBuffer($core.List<$core.int> i, [$pb.ExtensionRegistry r = $pb.ExtensionRegistry.EMPTY]) => create()..mergeFromBuffer(i, r);
  factory Backup_Stats.fromJson($core.String i, [$pb.ExtensionRegistry r = $pb.ExtensionRegistry.EMPTY]) => create()..mergeFromJson(i, r);

  static final $pb.BuilderInfo _i = $pb.BuilderInfo(_omitMessageNames ? '' : 'Backup.Stats', package: const $pb.PackageName(_omitMessageNames ? '' : 'google.firestore.admin.v1'), createEmptyInstance: create)
  ...
  'Will be removed in next major version')
  Backup_Stats copyWith(void Function(Backup_Stats) updates) => super.copyWith((message) => updates(message as Backup_Stats)) as Backup_Stats;
  ...
  static $pb.PbList<Backup_Stats> createRepeated() => $pb.PbList<Backup_Stats>();
  @$core.pragma('dart2js:noInline')
  static Backup_Stats getDefault() => _defaultInstance ??= $pb.GeneratedMessage.$_defaultFor<Backup_Stats>(create);
  ...
  @$pb.TagNumber(3)
  set indexCount($fixnum.Int64 v) { $_setInt64(2, v); }
  @$pb.TagNumber(3)
...
class Backup extends $pb.GeneratedMessage {
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(_omitMessageNames ? '' : 'Backup', package: const $pb.PackageName(_omitMessageNames ? '' : 'google.firestore.admin.v1'), createEmptyInstance: create)
    ...
    ..aOM<$302.Timestamp>(3, _omitFieldNames ? '' : 'snapshotTime', subBuilder: $302.Timestamp.create)
  ...
  @$pb.TagNumber(3)
  $302.Timestamp get snapshotTime => $_getN(2);
  @$pb.TagNumber(3)
  set snapshotTime($302.Timestamp v) { setField(3, v); }
  @$pb.TagNumber(3)
  $core.bool hasSnapshotTime() => $_has(2);
  @$pb.TagNumber(3)
  void clearSnapshotTime() => clearField(3);
  @$pb.TagNumber(3)
  $302.Timestamp ensureSnapshotTime() => $_ensure(2);
  ...
  @$pb.TagNumber(6)
  set stats(Backup_Stats v) { setField(6, v); }
  @$pb.TagNumber(6)
  ...
  @$pb.TagNumber(7)
  set databaseUid($core.String v) { $_setString(5, v); }
  @$pb.TagNumber(7)
  ...
  @$pb.TagNumber(8)
  set state(Backup_State v) { setField(8, v); }
  @$pb.TagNumber(8)
