...
class ExportDocumentsMetadata extends $pb.GeneratedMessage {
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(
    ...
    ..aOM<$330.Timestamp>(9, _omitFieldNames ? '' : 'snapshotTime',
        subBuilder: $330.Timestamp.create)
    ..hasRequiredFields = false;
  ...
  @$pb.TagNumber(9)
  $330.Timestamp get snapshotTime => $_getN(8);
  @$pb.TagNumber(9)
  ...
  @$pb.TagNumber(9)
  $330.Timestamp ensureSnapshotTime() => $_ensure(8);
}
...
class BulkDeleteDocumentsMetadata extends $pb.GeneratedMessage {
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(
    ...
    ..aOM<$330.Timestamp>(8, _omitFieldNames ? '' : 'snapshotTime',
        subBuilder: $330.Timestamp.create)
    ..hasRequiredFields = false;
  ...
  /// limit).
  @$pb.TagNumber(8)
  $330.Timestamp get snapshotTime => $_getN(7);
  @$pb.TagNumber(8)
  set snapshotTime($330.Timestamp v) {
    setField(8, v);
  }
  ...
  @$pb.TagNumber(8)
  $330.Timestamp ensureSnapshotTime() => $_ensure(7);
}
