...
class IndexOperationMetadata extends $pb.GeneratedMessage {
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(_omitMessageNames ? '' : 'IndexOperationMetadata', package: const $pb.PackageName(_omitMessageNames ? '' : 'google.firestore.admin.v1'), createEmptyInstance: create)
...
class FieldOperationMetadata_IndexConfigDelta extends $pb.GeneratedMessage {
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(_omitMessageNames ? '' : 'FieldOperationMetadata.IndexConfigDelta', package: const $pb.PackageName(_omitMessageNames ? '' : 'google.firestore.admin.v1'), createEmptyInstance: create)
    ...
    ..aOM<$1597.Index>(2, _omitFieldNames ? '' : 'index', subBuilder: $1597.Index.create)
    ..hasRequiredFields = false
  ;
  ...
  @$pb.TagNumber(2)
  $1597.Index get index => $_getN(1);
  @$pb.TagNumber(2)
  set index($1597.Index v) { setField(2, v); }
  @$pb.TagNumber(2)
  $core.bool hasIndex() => $_has(1);
  @$pb.TagNumber(2)
  void clearIndex() => clearField(2);
  @$pb.TagNumber(2)
  $1597.Index ensureIndex() => $_ensure(1);
}
...
class FieldOperationMetadata_TtlConfigDelta extends $pb.GeneratedMessage {
  ...
  factory FieldOperationMetadata_TtlConfigDelta.fromBuffer($core.List<$core.int> i, [$pb.ExtensionRegistry r = $pb.ExtensionRegistry.EMPTY]) => create()..mergeFromBuffer(i, r);
  factory FieldOperationMetadata_TtlConfigDelta.fromJson($core.String i, [$pb.ExtensionRegistry r = $pb.ExtensionRegistry.EMPTY]) => create()..mergeFromJson(i, r);

  static final $pb.BuilderInfo _i = $pb.BuilderInfo(_omitMessageNames ? '' : 'FieldOperationMetadata.TtlConfigDelta', package: const $pb.PackageName(_omitMessageNames ? '' : 'google.firestore.admin.v1'), createEmptyInstance: create)
    ..e<FieldOperationMetadata_TtlConfigDelta_ChangeType>(1, _omitFieldNames ? '' : 'changeType', $pb.PbFieldType.OE, defaultOrMaker: FieldOperationMetadata_TtlConfigDelta_ChangeType.CHANGE_TYPE_UNSPECIFIED, valueOf: FieldOperationMetadata_TtlConfigDelta_ChangeType.valueOf, enumValues: FieldOperationMetadata_TtlConfigDelta_ChangeType.values)
    ..hasRequiredFields = false
  ;
  ...
  'Use [GeneratedMessageGenericExtensions.deepCopy] instead. '
  'Will be removed in next major version')
  FieldOperationMetadata_TtlConfigDelta clone() => FieldOperationMetadata_TtlConfigDelta()..mergeFromMessage(this);
  @$core.Deprecated(
  'Using this can add significant overhead to your binary. '
  'Use [GeneratedMessageGenericExtensions.rebuild] instead. '
  'Will be removed in next major version')
  FieldOperationMetadata_TtlConfigDelta copyWith(void Function(FieldOperationMetadata_TtlConfigDelta) updates) => super.copyWith((message) => updates(message as FieldOperationMetadata_TtlConfigDelta)) as FieldOperationMetadata_TtlConfigDelta;

  $pb.BuilderInfo get info_ => _i;

  @$core.pragma('dart2js:noInline')
  static FieldOperationMetadata_TtlConfigDelta create() => FieldOperationMetadata_TtlConfigDelta._();
  FieldOperationMetadata_TtlConfigDelta createEmptyInstance() => create();
  static $pb.PbList<FieldOperationMetadata_TtlConfigDelta> createRepeated() => $pb.PbList<FieldOperationMetadata_TtlConfigDelta>();
  @$core.pragma('dart2js:noInline')
  static FieldOperationMetadata_TtlConfigDelta getDefault() => _defaultInstance ??= $pb.GeneratedMessage.$_defaultFor<FieldOperationMetadata_TtlConfigDelta>(create);
  ...
  @$pb.TagNumber(1)
  set changeType(FieldOperationMetadata_TtlConfigDelta_ChangeType v) { setField(1, v); }
  @$pb.TagNumber(1)
  $core.bool hasChangeType() => $_has(0);
  @$pb.TagNumber(1)
  void clearChangeType() => clearField(1);
...
class FieldOperationMetadata extends $pb.GeneratedMessage {
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(_omitMessageNames ? '' : 'FieldOperationMetadata', package: const $pb.PackageName(_omitMessageNames ? '' : 'google.firestore.admin.v1'), createEmptyInstance: create)
    ..aOM<$1775.Timestamp>(1, _omitFieldNames ? '' : 'startTime', subBuilder: $1775.Timestamp.create)
    ..aOM<$1775.Timestamp>(2, _omitFieldNames ? '' : 'endTime', subBuilder: $1775.Timestamp.create)
    ...
    ..aOM<Progress>(6, _omitFieldNames ? '' : 'progressDocuments', subBuilder: Progress.create)
    ..aOM<Progress>(7, _omitFieldNames ? '' : 'progressBytes', subBuilder: Progress.create)
    ..aOM<FieldOperationMetadata_TtlConfigDelta>(8, _omitFieldNames ? '' : 'ttlConfigDelta', subBuilder: FieldOperationMetadata_TtlConfigDelta.create)
    ..hasRequiredFields = false
  ;
  ...
  @$pb.TagNumber(8)
  set ttlConfigDelta(FieldOperationMetadata_TtlConfigDelta v) { setField(8, v); }
  @$pb.TagNumber(8)
...
class ExportDocumentsMetadata extends $pb.GeneratedMessage {
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(_omitMessageNames ? '' : 'ExportDocumentsMetadata', package: const $pb.PackageName(_omitMessageNames ? '' : 'google.firestore.admin.v1'), createEmptyInstance: create)
    ..aOM<$1775.Timestamp>(1, _omitFieldNames ? '' : 'startTime', subBuilder: $1775.Timestamp.create)
    ..aOM<$1775.Timestamp>(2, _omitFieldNames ? '' : 'endTime', subBuilder: $1775.Timestamp.create)
    ...
    ..aOM<$1775.Timestamp>(9, _omitFieldNames ? '' : 'snapshotTime', subBuilder: $1775.Timestamp.create)
    ..hasRequiredFields = false
  ;
  ...
  @$pb.TagNumber(9)
  $1775.Timestamp get snapshotTime => $_getN(8);
  @$pb.TagNumber(9)
  set snapshotTime($1775.Timestamp v) { setField(9, v); }
  @$pb.TagNumber(9)
  $core.bool hasSnapshotTime() => $_has(8);
  @$pb.TagNumber(9)
  void clearSnapshotTime() => clearField(9);
  @$pb.TagNumber(9)
  $1775.Timestamp ensureSnapshotTime() => $_ensure(8);
}
...
class ImportDocumentsMetadata extends $pb.GeneratedMessage {
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(_omitMessageNames ? '' : 'ImportDocumentsMetadata', package: const $pb.PackageName(_omitMessageNames ? '' : 'google.firestore.admin.v1'), createEmptyInstance: create)
    ..aOM<$1775.Timestamp>(1, _omitFieldNames ? '' : 'startTime', subBuilder: $1775.Timestamp.create)
    ..aOM<$1775.Timestamp>(2, _omitFieldNames ? '' : 'endTime', subBuilder: $1775.Timestamp.create)
    ..e<OperationState>(3, _omitFieldNames ? '' : 'operationState', $pb.PbFieldType.OE, defaultOrMaker: OperationState.OPERATION_STATE_UNSPECIFIED, valueOf: OperationState.valueOf, enumValues: OperationState.values)
    ..aOM<Progress>(4, _omitFieldNames ? '' : 'progressDocuments', subBuilder: Progress.create)
...
class BulkDeleteDocumentsMetadata extends $pb.GeneratedMessage {
  ...
  factory BulkDeleteDocumentsMetadata.fromBuffer($core.List<$core.int> i, [$pb.ExtensionRegistry r = $pb.ExtensionRegistry.EMPTY]) => create()..mergeFromBuffer(i, r);
  factory BulkDeleteDocumentsMetadata.fromJson($core.String i, [$pb.ExtensionRegistry r = $pb.ExtensionRegistry.EMPTY]) => create()..mergeFromJson(i, r);

  static final $pb.BuilderInfo _i = $pb.BuilderInfo(_omitMessageNames ? '' : 'BulkDeleteDocumentsMetadata', package: const $pb.PackageName(_omitMessageNames ? '' : 'google.firestore.admin.v1'), createEmptyInstance: create)
    ..aOM<$1775.Timestamp>(1, _omitFieldNames ? '' : 'startTime', subBuilder: $1775.Timestamp.create)
    ..aOM<$1775.Timestamp>(2, _omitFieldNames ? '' : 'endTime', subBuilder: $1775.Timestamp.create)
    ..e<OperationState>(3, _omitFieldNames ? '' : 'operationState', $pb.PbFieldType.OE, defaultOrMaker: OperationState.OPERATION_STATE_UNSPECIFIED, valueOf: OperationState.valueOf, enumValues: OperationState.values)
    ..aOM<Progress>(4, _omitFieldNames ? '' : 'progressDocuments', subBuilder: Progress.create)
    ...
    ..aOM<$1775.Timestamp>(8, _omitFieldNames ? '' : 'snapshotTime', subBuilder: $1775.Timestamp.create)
    ..hasRequiredFields = false
  ;
  ...
  'Use [GeneratedMessageGenericExtensions.deepCopy] instead. '
  'Will be removed in next major version')
  BulkDeleteDocumentsMetadata clone() => BulkDeleteDocumentsMetadata()..mergeFromMessage(this);
  @$core.Deprecated(
  'Using this can add significant overhead to your binary. '
  'Use [GeneratedMessageGenericExtensions.rebuild] instead. '
  'Will be removed in next major version')
  BulkDeleteDocumentsMetadata copyWith(void Function(BulkDeleteDocumentsMetadata) updates) => super.copyWith((message) => updates(message as BulkDeleteDocumentsMetadata)) as BulkDeleteDocumentsMetadata;

  $pb.BuilderInfo get info_ => _i;

  @$core.pragma('dart2js:noInline')
  static BulkDeleteDocumentsMetadata create() => BulkDeleteDocumentsMetadata._();
  BulkDeleteDocumentsMetadata createEmptyInstance() => create();
  static $pb.PbList<BulkDeleteDocumentsMetadata> createRepeated() => $pb.PbList<BulkDeleteDocumentsMetadata>();
  @$core.pragma('dart2js:noInline')
  static BulkDeleteDocumentsMetadata getDefault() => _defaultInstance ??= $pb.GeneratedMessage.$_defaultFor<BulkDeleteDocumentsMetadata>(create);
  ...
  /// limit).
  @$pb.TagNumber(8)
  $1775.Timestamp get snapshotTime => $_getN(7);
  @$pb.TagNumber(8)
  set snapshotTime($1775.Timestamp v) { setField(8, v); }
  @$pb.TagNumber(8)
  $core.bool hasSnapshotTime() => $_has(7);
  @$pb.TagNumber(8)
  void clearSnapshotTime() => clearField(8);
  @$pb.TagNumber(8)
  $1775.Timestamp ensureSnapshotTime() => $_ensure(7);
}
...
class ExportDocumentsResponse extends $pb.GeneratedMessage {
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(_omitMessageNames ? '' : 'ExportDocumentsResponse', package: const $pb.PackageName(_omitMessageNames ? '' : 'google.firestore.admin.v1'), createEmptyInstance: create)
...
class RestoreDatabaseMetadata extends $pb.GeneratedMessage {
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(_omitMessageNames ? '' : 'RestoreDatabaseMetadata', package: const $pb.PackageName(_omitMessageNames ? '' : 'google.firestore.admin.v1'), createEmptyInstance: create)
    ..aOM<$1775.Timestamp>(1, _omitFieldNames ? '' : 'startTime', subBuilder: $1775.Timestamp.create)
    ..aOM<$1775.Timestamp>(2, _omitFieldNames ? '' : 'endTime', subBuilder: $1775.Timestamp.create)
    ..e<OperationState>(3, _omitFieldNames ? '' : 'operationState', $pb.PbFieldType.OE, defaultOrMaker: OperationState.OPERATION_STATE_UNSPECIFIED, valueOf: OperationState.valueOf, enumValues: OperationState.values)
    ..aOS(4, _omitFieldNames ? '' : 'database')
    ..aOS(5, _omitFieldNames ? '' : 'backup')
    ..aOM<Progress>(8, _omitFieldNames ? '' : 'progressPercentage', subBuilder: Progress.create)
    ..hasRequiredFields = false
  ;
  ...
  @$pb.TagNumber(5)
  set backup($core.String v) { $_setString(4, v); }
  @$pb.TagNumber(5)
  ...
  @$pb.TagNumber(8)
  set progressPercentage(Progress v) { setField(8, v); }
  @$pb.TagNumber(8)
...
class Progress extends $pb.GeneratedMessage {
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(_omitMessageNames ? '' : 'Progress', package: const $pb.PackageName(_omitMessageNames ? '' : 'google.firestore.admin.v1'), createEmptyInstance: create)
