...
class FirestoreAdminClient extends $grpc.Client {
  static final _$createIndex =
      $grpc.ClientMethod<$126.CreateIndexRequest, $13.Operation>(
  ...
  static final _$listIndexes =
      $grpc.ClientMethod<$126.ListIndexesRequest, $126.ListIndexesResponse>(
          '/google.firestore.admin.v1beta2.FirestoreAdmin/ListIndexes',
          ($126.ListIndexesRequest value) => value.writeToBuffer(),
          ($core.List<$core.int> value) =>
              $126.ListIndexesResponse.fromBuffer(value));
  static final _$getIndex =
      $grpc.ClientMethod<$126.GetIndexRequest, $127.Index>(
  ...
  static final _$deleteIndex =
      $grpc.ClientMethod<$126.DeleteIndexRequest, $3.Empty>(
  ...
  static final _$getField =
      $grpc.ClientMethod<$126.GetFieldRequest, $128.Field>(
  ...
  static final _$updateField =
      $grpc.ClientMethod<$126.UpdateFieldRequest, $13.Operation>(
  ...
  static final _$listFields =
      $grpc.ClientMethod<$126.ListFieldsRequest, $126.ListFieldsResponse>(
          '/google.firestore.admin.v1beta2.FirestoreAdmin/ListFields',
          ($126.ListFieldsRequest value) => value.writeToBuffer(),
          ($core.List<$core.int> value) =>
              $126.ListFieldsResponse.fromBuffer(value));
  static final _$exportDocuments =
      $grpc.ClientMethod<$126.ExportDocumentsRequest, $13.Operation>(
  ...
  static final _$importDocuments =
      $grpc.ClientMethod<$126.ImportDocumentsRequest, $13.Operation>(
...
abstract class FirestoreAdminServiceBase extends $grpc.Service {
  ...
  FirestoreAdminServiceBase() {
    $addMethod($grpc.ServiceMethod<$126.CreateIndexRequest, $13.Operation>(
        ...
        false,
        ($core.List<$core.int> value) =>
            $126.CreateIndexRequest.fromBuffer(value),
        ($13.Operation value) => value.writeToBuffer()));
    $addMethod(
        $grpc.ServiceMethod<$126.ListIndexesRequest, $126.ListIndexesResponse>(
            'ListIndexes',
            listIndexes_Pre,
            false,
            false,
            ($core.List<$core.int> value) =>
                $126.ListIndexesRequest.fromBuffer(value),
    ...
    $addMethod($grpc.ServiceMethod<$126.DeleteIndexRequest, $3.Empty>(
        ...
        false,
        ($core.List<$core.int> value) =>
            $126.DeleteIndexRequest.fromBuffer(value),
    ...
    $addMethod($grpc.ServiceMethod<$126.UpdateFieldRequest, $13.Operation>(
        ...
        false,
        ($core.List<$core.int> value) =>
            $126.UpdateFieldRequest.fromBuffer(value),
        ($13.Operation value) => value.writeToBuffer()));
    $addMethod(
        $grpc.ServiceMethod<$126.ListFieldsRequest, $126.ListFieldsResponse>(
            'ListFields',
            listFields_Pre,
            false,
            false,
            ($core.List<$core.int> value) =>
                $126.ListFieldsRequest.fromBuffer(value),
    ...
    $addMethod($grpc.ServiceMethod<$126.ExportDocumentsRequest, $13.Operation>(
        ...
        false,
        ($core.List<$core.int> value) =>
            $126.ExportDocumentsRequest.fromBuffer(value),
        ($13.Operation value) => value.writeToBuffer()));
    $addMethod($grpc.ServiceMethod<$126.ImportDocumentsRequest, $13.Operation>(
        ...
        false,
        ($core.List<$core.int> value) =>
            $126.ImportDocumentsRequest.fromBuffer(value),
        ($13.Operation value) => value.writeToBuffer()));
  }

  $async.Future<$13.Operation> createIndex_Pre($grpc.ServiceCall call,
      $async.Future<$126.CreateIndexRequest> request) async {
    return createIndex(call, await request);
  }

  $async.Future<$126.ListIndexesResponse> listIndexes_Pre(
      $grpc.ServiceCall call,
      $async.Future<$126.ListIndexesRequest> request) async {
    return listIndexes(call, await request);
  }

  $async.Future<$127.Index> getIndex_Pre($grpc.ServiceCall call,
      $async.Future<$126.GetIndexRequest> request) async {
    return getIndex(call, await request);
  }

  $async.Future<$3.Empty> deleteIndex_Pre($grpc.ServiceCall call,
      $async.Future<$126.DeleteIndexRequest> request) async {
    return deleteIndex(call, await request);
  }

  $async.Future<$128.Field> getField_Pre($grpc.ServiceCall call,
      $async.Future<$126.GetFieldRequest> request) async {
    return getField(call, await request);
  }

  $async.Future<$13.Operation> updateField_Pre($grpc.ServiceCall call,
      $async.Future<$126.UpdateFieldRequest> request) async {
    return updateField(call, await request);
  }

  $async.Future<$126.ListFieldsResponse> listFields_Pre($grpc.ServiceCall call,
      $async.Future<$126.ListFieldsRequest> request) async {
    return listFields(call, await request);
  }

  $async.Future<$13.Operation> exportDocuments_Pre($grpc.ServiceCall call,
      $async.Future<$126.ExportDocumentsRequest> request) async {
    return exportDocuments(call, await request);
  }

  $async.Future<$13.Operation> importDocuments_Pre($grpc.ServiceCall call,
      $async.Future<$126.ImportDocumentsRequest> request) async {
    return importDocuments(call, await request);
  }

  $async.Future<$13.Operation> createIndex(
      $grpc.ServiceCall call, $126.CreateIndexRequest request);
  $async.Future<$126.ListIndexesResponse> listIndexes(
      $grpc.ServiceCall call, $126.ListIndexesRequest request);
  $async.Future<$127.Index> getIndex(
      $grpc.ServiceCall call, $126.GetIndexRequest request);
  $async.Future<$3.Empty> deleteIndex(
      $grpc.ServiceCall call, $126.DeleteIndexRequest request);
  $async.Future<$128.Field> getField(
      $grpc.ServiceCall call, $126.GetFieldRequest request);
  $async.Future<$13.Operation> updateField(
      $grpc.ServiceCall call, $126.UpdateFieldRequest request);
  $async.Future<$126.ListFieldsResponse> listFields(
      $grpc.ServiceCall call, $126.ListFieldsRequest request);
  $async.Future<$13.Operation> exportDocuments(
      $grpc.ServiceCall call, $126.ExportDocumentsRequest request);
  $async.Future<$13.Operation> importDocuments(
      $grpc.ServiceCall call, $126.ImportDocumentsRequest request);
}
