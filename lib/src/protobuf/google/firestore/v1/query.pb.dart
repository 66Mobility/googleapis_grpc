...
class StructuredQuery_FindNearest extends $pb.GeneratedMessage {
  factory StructuredQuery_FindNearest({
    ...
    $1780.DoubleValue? distanceThreshold,
  }) {
    final $result = create();
    if (vectorField != null) {
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(_omitMessageNames ? '' : 'StructuredQuery.FindNearest', package: const $pb.PackageName(_omitMessageNames ? '' : 'google.firestore.v1'), createEmptyInstance: create)
    ...
    ..aOM<$1780.Int32Value>(4, _omitFieldNames ? '' : 'limit', subBuilder: $1780.Int32Value.create)
    ..aOS(5, _omitFieldNames ? '' : 'distanceResultField')
    ..aOM<$1780.DoubleValue>(6, _omitFieldNames ? '' : 'distanceThreshold', subBuilder: $1780.DoubleValue.create)
    ..hasRequiredFields = false
  ;
  ...
  @$pb.TagNumber(4)
  $1780.Int32Value get limit => $_getN(3);
  @$pb.TagNumber(4)
  set limit($1780.Int32Value v) { setField(4, v); }
  @$pb.TagNumber(4)
  $core.bool hasLimit() => $_has(3);
  @$pb.TagNumber(4)
  void clearLimit() => clearField(4);
  @$pb.TagNumber(4)
  $1780.Int32Value ensureLimit() => $_ensure(3);
  ...
  @$pb.TagNumber(6)
  $1780.DoubleValue get distanceThreshold => $_getN(5);
  @$pb.TagNumber(6)
  set distanceThreshold($1780.DoubleValue v) { setField(6, v); }
  @$pb.TagNumber(6)
  $core.bool hasDistanceThreshold() => $_has(5);
  @$pb.TagNumber(6)
  void clearDistanceThreshold() => clearField(6);
  @$pb.TagNumber(6)
  $1780.DoubleValue ensureDistanceThreshold() => $_ensure(5);
}
