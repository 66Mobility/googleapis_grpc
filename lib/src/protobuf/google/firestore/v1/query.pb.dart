...
class StructuredQuery_FieldFilter extends $pb.GeneratedMessage {
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(_omitMessageNames ? '' : 'StructuredQuery.FieldFilter', package: const $pb.PackageName(_omitMessageNames ? '' : 'google.firestore.v1'), createEmptyInstance: create)
    ...
    ..aOM<$1608.Value>(3, _omitFieldNames ? '' : 'value', subBuilder: $1608.Value.create)
    ..hasRequiredFields = false
  ;
  ...
  @$pb.TagNumber(3)
  $1608.Value get value => $_getN(2);
  @$pb.TagNumber(3)
  set value($1608.Value v) { setField(3, v); }
  @$pb.TagNumber(3)
  $core.bool hasValue() => $_has(2);
  @$pb.TagNumber(3)
  void clearValue() => clearField(3);
  @$pb.TagNumber(3)
  $1608.Value ensureValue() => $_ensure(2);
}
...
class StructuredQuery_FindNearest extends $pb.GeneratedMessage {
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(_omitMessageNames ? '' : 'StructuredQuery.FindNearest', package: const $pb.PackageName(_omitMessageNames ? '' : 'google.firestore.v1'), createEmptyInstance: create)
    ...
    ..aOM<$1608.Value>(2, _omitFieldNames ? '' : 'queryVector', subBuilder: $1608.Value.create)
    ...
    ..aOM<$1781.Int32Value>(4, _omitFieldNames ? '' : 'limit', subBuilder: $1781.Int32Value.create)
    ..aOS(5, _omitFieldNames ? '' : 'distanceResultField')
    ..aOM<$1781.DoubleValue>(6, _omitFieldNames ? '' : 'distanceThreshold', subBuilder: $1781.DoubleValue.create)
    ..hasRequiredFields = false
  ;
  ...
  @$pb.TagNumber(2)
  $1608.Value get queryVector => $_getN(1);
  @$pb.TagNumber(2)
  set queryVector($1608.Value v) { setField(2, v); }
  @$pb.TagNumber(2)
  $core.bool hasQueryVector() => $_has(1);
  @$pb.TagNumber(2)
  void clearQueryVector() => clearField(2);
  @$pb.TagNumber(2)
  $1608.Value ensureQueryVector() => $_ensure(1);
  ...
  @$pb.TagNumber(4)
  $1781.Int32Value get limit => $_getN(3);
  @$pb.TagNumber(4)
  set limit($1781.Int32Value v) { setField(4, v); }
  @$pb.TagNumber(4)
  $core.bool hasLimit() => $_has(3);
  @$pb.TagNumber(4)
  void clearLimit() => clearField(4);
  @$pb.TagNumber(4)
  $1781.Int32Value ensureLimit() => $_ensure(3);
  ...
  @$pb.TagNumber(6)
  $1781.DoubleValue get distanceThreshold => $_getN(5);
  @$pb.TagNumber(6)
  set distanceThreshold($1781.DoubleValue v) { setField(6, v); }
  @$pb.TagNumber(6)
  $core.bool hasDistanceThreshold() => $_has(5);
  @$pb.TagNumber(6)
  void clearDistanceThreshold() => clearField(6);
  @$pb.TagNumber(6)
  $1781.DoubleValue ensureDistanceThreshold() => $_ensure(5);
}
...
class Cursor extends $pb.GeneratedMessage {
  factory Cursor({
    $core.Iterable<$1608.Value>? values,
    $core.bool? before,
  }) {
    final $result = create();
    if (values != null) {
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(_omitMessageNames ? '' : 'Cursor', package: const $pb.PackageName(_omitMessageNames ? '' : 'google.firestore.v1'), createEmptyInstance: create)
    ..pc<$1608.Value>(1, _omitFieldNames ? '' : 'values', $pb.PbFieldType.PM, subBuilder: $1608.Value.create)
  ...
  @$pb.TagNumber(1)
  $core.List<$1608.Value> get values => $_getList(0);
