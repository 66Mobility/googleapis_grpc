...
class AggregationResult extends $pb.GeneratedMessage {
  factory AggregationResult({
    $core.Map<$core.String, $1608.Value>? aggregateFields,
  }) {
    final $result = create();
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(_omitMessageNames ? '' : 'AggregationResult', package: const $pb.PackageName(_omitMessageNames ? '' : 'google.firestore.v1'), createEmptyInstance: create)
    ..m<$core.String, $1608.Value>(2, _omitFieldNames ? '' : 'aggregateFields', entryClassName: 'AggregationResult.AggregateFieldsEntry', keyFieldType: $pb.PbFieldType.OS, valueFieldType: $pb.PbFieldType.OM, valueCreator: $1608.Value.create, valueDefaultOrMaker: $1608.Value.getDefault, packageName: const $pb.PackageName('google.firestore.v1'))
  ...
  @$pb.TagNumber(2)
  $core.Map<$core.String, $1608.Value> get aggregateFields => $_getMap(0);
}
