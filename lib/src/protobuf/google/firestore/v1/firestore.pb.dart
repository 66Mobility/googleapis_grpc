...
import 'aggregation_result.pb.dart' as $464;
import 'common.pb.dart' as $460;
import 'document.pb.dart' as $148;
import 'firestore.pbenum.dart';
import 'query.pb.dart' as $459;
import 'query_profile.pb.dart' as $463;
import 'write.pb.dart' as $462;
...
class GetDocumentRequest extends $pb.GeneratedMessage {
  factory GetDocumentRequest({
    $core.String? name,
    $460.DocumentMask? mask,
    $core.List<$core.int>? transaction,
    $330.Timestamp? readTime,
  }) {
    final $result = create();
    if (name != null) {
      $result.name = name;
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(
    ...
    ..aOM<$460.DocumentMask>(2, _omitFieldNames ? '' : 'mask',
        subBuilder: $460.DocumentMask.create)
    ..a<$core.List<$core.int>>(
        3, _omitFieldNames ? '' : 'transaction', $pb.PbFieldType.OY)
    ..aOM<$330.Timestamp>(5, _omitFieldNames ? '' : 'readTime',
  ...
  @$pb.TagNumber(2)
  $460.DocumentMask get mask => $_getN(1);
  @$pb.TagNumber(2)
  set mask($460.DocumentMask v) {
    setField(2, v);
  }
  ...
  @$pb.TagNumber(2)
  $460.DocumentMask ensureMask() => $_ensure(1);
  ...
  @$pb.TagNumber(5)
  $330.Timestamp get readTime => $_getN(3);
  @$pb.TagNumber(5)
  set readTime($330.Timestamp v) {
    setField(5, v);
  }
  ...
  @$pb.TagNumber(5)
  $330.Timestamp ensureReadTime() => $_ensure(3);
}
...
class ListDocumentsRequest extends $pb.GeneratedMessage {
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(
    ...
    ..aOM<$460.DocumentMask>(7, _omitFieldNames ? '' : 'mask',
        subBuilder: $460.DocumentMask.create)
    ..a<$core.List<$core.int>>(
        8, _omitFieldNames ? '' : 'transaction', $pb.PbFieldType.OY)
    ..aOM<$330.Timestamp>(10, _omitFieldNames ? '' : 'readTime',
        subBuilder: $330.Timestamp.create)
  ...
  ///  will not be returned in the response.
  @$pb.TagNumber(7)
  $460.DocumentMask get mask => $_getN(5);
  @$pb.TagNumber(7)
  set mask($460.DocumentMask v) {
    setField(7, v);
  }
  ...
  @$pb.TagNumber(7)
  $460.DocumentMask ensureMask() => $_ensure(5);
  ...
  ///  minute timestamp within the past 7 days.
  @$pb.TagNumber(10)
  $330.Timestamp get readTime => $_getN(7);
  @$pb.TagNumber(10)
  set readTime($330.Timestamp v) {
    setField(10, v);
  }
  ...
  @$pb.TagNumber(10)
  $330.Timestamp ensureReadTime() => $_ensure(7);
...
class ListDocumentsResponse extends $pb.GeneratedMessage {
  factory ListDocumentsResponse({
    $core.Iterable<$148.Document>? documents,
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(
    ...
    ..pc<$148.Document>(
        ...
        subBuilder: $148.Document.create)
  ...
  /// The Documents found.
  @$pb.TagNumber(1)
  $core.List<$148.Document> get documents => $_getList(0);
...
class CreateDocumentRequest extends $pb.GeneratedMessage {
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(
    ...
    ..aOM<$148.Document>(4, _omitFieldNames ? '' : 'document',
        subBuilder: $148.Document.create)
    ..aOM<$460.DocumentMask>(5, _omitFieldNames ? '' : 'mask',
        subBuilder: $460.DocumentMask.create)
    ..hasRequiredFields = false;
  ...
  @$pb.TagNumber(4)
  $148.Document get document => $_getN(3);
  @$pb.TagNumber(4)
  set document($148.Document v) {
    setField(4, v);
  }
  ...
  @$pb.TagNumber(4)
  $148.Document ensureDocument() => $_ensure(3);
  ...
  ///  will not be returned in the response.
  @$pb.TagNumber(5)
  $460.DocumentMask get mask => $_getN(4);
  @$pb.TagNumber(5)
  set mask($460.DocumentMask v) {
    setField(5, v);
  }
  ...
  @$pb.TagNumber(5)
  $460.DocumentMask ensureMask() => $_ensure(4);
}
...
class UpdateDocumentRequest extends $pb.GeneratedMessage {
  factory UpdateDocumentRequest({
    $148.Document? document,
    $460.DocumentMask? updateMask,
    $460.DocumentMask? mask,
    $460.Precondition? currentDocument,
  }) {
    final $result = create();
    if (document != null) {
      $result.document = document;
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(
      ...
      package:
          const $pb.PackageName(_omitMessageNames ? '' : 'google.firestore.v1'),
      createEmptyInstance: create)
    ..aOM<$148.Document>(1, _omitFieldNames ? '' : 'document',
        subBuilder: $148.Document.create)
    ..aOM<$460.DocumentMask>(2, _omitFieldNames ? '' : 'updateMask',
        subBuilder: $460.DocumentMask.create)
    ..aOM<$460.DocumentMask>(3, _omitFieldNames ? '' : 'mask',
        subBuilder: $460.DocumentMask.create)
    ..aOM<$460.Precondition>(4, _omitFieldNames ? '' : 'currentDocument',
        subBuilder: $460.Precondition.create)
    ..hasRequiredFields = false;
  ...
  @$pb.TagNumber(1)
  $148.Document get document => $_getN(0);
  @$pb.TagNumber(1)
  set document($148.Document v) {
    setField(1, v);
  }
  ...
  @$pb.TagNumber(1)
  $148.Document ensureDocument() => $_ensure(0);
  ...
  @$pb.TagNumber(2)
  $460.DocumentMask get updateMask => $_getN(1);
  @$pb.TagNumber(2)
  set updateMask($460.DocumentMask v) {
    setField(2, v);
  }
  ...
  @$pb.TagNumber(2)
  $460.DocumentMask ensureUpdateMask() => $_ensure(1);
  ...
  ///  will not be returned in the response.
  @$pb.TagNumber(3)
  $460.DocumentMask get mask => $_getN(2);
  @$pb.TagNumber(3)
  set mask($460.DocumentMask v) {
    setField(3, v);
  }
  ...
  @$pb.TagNumber(3)
  $460.DocumentMask ensureMask() => $_ensure(2);

  /// An optional precondition on the document.
  /// The request will fail if this is set and not met by the target document.
  @$pb.TagNumber(4)
  $460.Precondition get currentDocument => $_getN(3);
  @$pb.TagNumber(4)
  set currentDocument($460.Precondition v) {
    setField(4, v);
  }
  ...
  @$pb.TagNumber(4)
  $460.Precondition ensureCurrentDocument() => $_ensure(3);
}
...
class DeleteDocumentRequest extends $pb.GeneratedMessage {
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(
      ...
      createEmptyInstance: create)
    ..aOS(1, _omitFieldNames ? '' : 'name')
    ..aOM<$460.Precondition>(2, _omitFieldNames ? '' : 'currentDocument',
        subBuilder: $460.Precondition.create)
    ..hasRequiredFields = false;
  ...
  /// The request will fail if this is set and not met by the target document.
  @$pb.TagNumber(2)
  $460.Precondition get currentDocument => $_getN(1);
  @$pb.TagNumber(2)
  set currentDocument($460.Precondition v) {
    setField(2, v);
  }
  ...
  @$pb.TagNumber(2)
  $460.Precondition ensureCurrentDocument() => $_ensure(1);
}
...
class BatchGetDocumentsRequest extends $pb.GeneratedMessage {
  factory BatchGetDocumentsRequest({
    ...
    $460.DocumentMask? mask,
    $core.List<$core.int>? transaction,
    $460.TransactionOptions? newTransaction,
    $330.Timestamp? readTime,
  }) {
    final $result = create();
    if (database != null) {
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(
    ...
    ..aOM<$460.TransactionOptions>(5, _omitFieldNames ? '' : 'newTransaction',
        subBuilder: $460.TransactionOptions.create)
    ..aOM<$330.Timestamp>(7, _omitFieldNames ? '' : 'readTime',
        subBuilder: $330.Timestamp.create)
    ..hasRequiredFields = false;
  ...
  /// stream.
  @$pb.TagNumber(5)
  $460.TransactionOptions get newTransaction => $_getN(4);
  @$pb.TagNumber(5)
  set newTransaction($460.TransactionOptions v) {
    setField(5, v);
  }
  ...
  @$pb.TagNumber(5)
  $460.TransactionOptions ensureNewTransaction() => $_ensure(4);
  ...
  ///  minute timestamp within the past 7 days.
  @$pb.TagNumber(7)
  $330.Timestamp get readTime => $_getN(5);
  @$pb.TagNumber(7)
  set readTime($330.Timestamp v) {
    setField(7, v);
  }
  ...
  @$pb.TagNumber(7)
  $330.Timestamp ensureReadTime() => $_ensure(5);
}
...
class BatchGetDocumentsResponse extends $pb.GeneratedMessage {
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(
      ...
      createEmptyInstance: create)
    ..oo(0, [1, 2])
    ..aOM<$148.Document>(1, _omitFieldNames ? '' : 'found',
        subBuilder: $148.Document.create)
    ..aOS(2, _omitFieldNames ? '' : 'missing')
    ..a<$core.List<$core.int>>(
        3, _omitFieldNames ? '' : 'transaction', $pb.PbFieldType.OY)
    ..aOM<$330.Timestamp>(4, _omitFieldNames ? '' : 'readTime',
        subBuilder: $330.Timestamp.create)
    ..hasRequiredFields = false;
  ...
  @$pb.TagNumber(1)
  $148.Document get found => $_getN(0);
  @$pb.TagNumber(1)
  set found($148.Document v) {
    setField(1, v);
  }
  ...
  @$pb.TagNumber(1)
  $148.Document ensureFound() => $_ensure(0);
...
class BeginTransactionRequest extends $pb.GeneratedMessage {
  factory BeginTransactionRequest({
    $core.String? database,
    $460.TransactionOptions? options,
  }) {
    final $result = create();
    if (database != null) {
      $result.database = database;
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(
      ...
      createEmptyInstance: create)
    ..aOS(1, _omitFieldNames ? '' : 'database')
    ..aOM<$460.TransactionOptions>(2, _omitFieldNames ? '' : 'options',
        subBuilder: $460.TransactionOptions.create)
    ..hasRequiredFields = false;
  ...
  @$pb.TagNumber(2)
  $460.TransactionOptions get options => $_getN(1);
  @$pb.TagNumber(2)
  set options($460.TransactionOptions v) {
    setField(2, v);
  }
  ...
  @$pb.TagNumber(2)
  $460.TransactionOptions ensureOptions() => $_ensure(1);
}
...
class CommitRequest extends $pb.GeneratedMessage {
  factory CommitRequest({
    $core.String? database,
    $core.Iterable<$462.Write>? writes,
    $core.List<$core.int>? transaction,
  }) {
    final $result = create();
    if (database != null) {
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(
      ...
      createEmptyInstance: create)
    ..aOS(1, _omitFieldNames ? '' : 'database')
    ..pc<$462.Write>(2, _omitFieldNames ? '' : 'writes', $pb.PbFieldType.PM,
        subBuilder: $462.Write.create)
    ..a<$core.List<$core.int>>(
        3, _omitFieldNames ? '' : 'transaction', $pb.PbFieldType.OY)
    ..hasRequiredFields = false;
  ...
  @$pb.TagNumber(2)
  $core.List<$462.Write> get writes => $_getList(1);
...
class CommitResponse extends $pb.GeneratedMessage {
  factory CommitResponse({
    $core.Iterable<$462.WriteResult>? writeResults,
    $330.Timestamp? commitTime,
  }) {
    final $result = create();
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(
    ...
    ..pc<$462.WriteResult>(
        ...
        subBuilder: $462.WriteResult.create)
    ..aOM<$330.Timestamp>(2, _omitFieldNames ? '' : 'commitTime',
        subBuilder: $330.Timestamp.create)
    ..hasRequiredFields = false;
  ...
  ///  request.
  @$pb.TagNumber(1)
  $core.List<$462.WriteResult> get writeResults => $_getList(0);

  /// The time at which the commit occurred. Any read with an equal or greater
  /// `read_time` is guaranteed to see the effects of the commit.
  @$pb.TagNumber(2)
  $330.Timestamp get commitTime => $_getN(1);
  @$pb.TagNumber(2)
  set commitTime($330.Timestamp v) {
    setField(2, v);
  }
  ...
  @$pb.TagNumber(2)
  $330.Timestamp ensureCommitTime() => $_ensure(1);
}
...
class RunQueryRequest extends $pb.GeneratedMessage {
  factory RunQueryRequest({
    $core.String? parent,
    $459.StructuredQuery? structuredQuery,
    $core.List<$core.int>? transaction,
    $460.TransactionOptions? newTransaction,
    $330.Timestamp? readTime,
    $463.ExplainOptions? explainOptions,
  }) {
    final $result = create();
    if (parent != null) {
      $result.parent = parent;
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(
    ...
    ..oo(1, [5, 6, 7])
    ..aOS(1, _omitFieldNames ? '' : 'parent')
    ..aOM<$459.StructuredQuery>(2, _omitFieldNames ? '' : 'structuredQuery',
        subBuilder: $459.StructuredQuery.create)
    ..a<$core.List<$core.int>>(
        5, _omitFieldNames ? '' : 'transaction', $pb.PbFieldType.OY)
    ..aOM<$460.TransactionOptions>(6, _omitFieldNames ? '' : 'newTransaction',
        subBuilder: $460.TransactionOptions.create)
    ..aOM<$330.Timestamp>(7, _omitFieldNames ? '' : 'readTime',
        subBuilder: $330.Timestamp.create)
    ..aOM<$463.ExplainOptions>(10, _omitFieldNames ? '' : 'explainOptions',
        subBuilder: $463.ExplainOptions.create)
    ..hasRequiredFields = false;
  ...
  /// A structured query.
  @$pb.TagNumber(2)
  $459.StructuredQuery get structuredQuery => $_getN(1);
  @$pb.TagNumber(2)
  set structuredQuery($459.StructuredQuery v) {
    setField(2, v);
  }
  ...
  @$pb.TagNumber(2)
  $459.StructuredQuery ensureStructuredQuery() => $_ensure(1);
  ...
  /// stream.
  @$pb.TagNumber(6)
  $460.TransactionOptions get newTransaction => $_getN(3);
  @$pb.TagNumber(6)
  set newTransaction($460.TransactionOptions v) {
    setField(6, v);
  }
  ...
  @$pb.TagNumber(6)
  $460.TransactionOptions ensureNewTransaction() => $_ensure(3);
  ...
  ///  minute timestamp within the past 7 days.
  @$pb.TagNumber(7)
  $330.Timestamp get readTime => $_getN(4);
  @$pb.TagNumber(7)
  set readTime($330.Timestamp v) {
    setField(7, v);
  }
  ...
  void clearReadTime() => clearField(7);
  @$pb.TagNumber(7)
  $330.Timestamp ensureReadTime() => $_ensure(4);

  /// Optional. Explain options for the query. If set, additional query
  /// statistics will be returned. If not, only query results will be returned.
  @$pb.TagNumber(10)
  $463.ExplainOptions get explainOptions => $_getN(5);
  @$pb.TagNumber(10)
  set explainOptions($463.ExplainOptions v) {
    setField(10, v);
  }
  ...
  @$pb.TagNumber(10)
  $463.ExplainOptions ensureExplainOptions() => $_ensure(5);
}
...
class RunQueryResponse extends $pb.GeneratedMessage {
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(
    ...
    ..a<$core.List<$core.int>>(
        2, _omitFieldNames ? '' : 'transaction', $pb.PbFieldType.OY)
    ..aOM<$330.Timestamp>(3, _omitFieldNames ? '' : 'readTime',
        subBuilder: $330.Timestamp.create)
    ..a<$core.int>(
        4, _omitFieldNames ? '' : 'skippedResults', $pb.PbFieldType.O3)
    ..aOB(6, _omitFieldNames ? '' : 'done')
    ..aOM<$463.ExplainMetrics>(11, _omitFieldNames ? '' : 'explainMetrics',
        subBuilder: $463.ExplainMetrics.create)
    ..hasRequiredFields = false;
  ...
  ///  was run.
  @$pb.TagNumber(3)
  $330.Timestamp get readTime => $_getN(2);
  @$pb.TagNumber(3)
  set readTime($330.Timestamp v) {
    setField(3, v);
  }
  ...
  @$pb.TagNumber(3)
  $330.Timestamp ensureReadTime() => $_ensure(2);
  ...
  @$pb.TagNumber(11)
  $463.ExplainMetrics get explainMetrics => $_getN(5);
  @$pb.TagNumber(11)
  set explainMetrics($463.ExplainMetrics v) {
    setField(11, v);
  }
  ...
  @$pb.TagNumber(11)
  $463.ExplainMetrics ensureExplainMetrics() => $_ensure(5);
}
...
class RunAggregationQueryRequest extends $pb.GeneratedMessage {
  factory RunAggregationQueryRequest({
    $core.String? parent,
    $459.StructuredAggregationQuery? structuredAggregationQuery,
    $core.List<$core.int>? transaction,
    $460.TransactionOptions? newTransaction,
    $330.Timestamp? readTime,
    $463.ExplainOptions? explainOptions,
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(
    ...
    ..oo(1, [4, 5, 6])
    ..aOS(1, _omitFieldNames ? '' : 'parent')
    ..aOM<$459.StructuredAggregationQuery>(
        2, _omitFieldNames ? '' : 'structuredAggregationQuery',
        subBuilder: $459.StructuredAggregationQuery.create)
    ..a<$core.List<$core.int>>(
        4, _omitFieldNames ? '' : 'transaction', $pb.PbFieldType.OY)
    ..aOM<$460.TransactionOptions>(5, _omitFieldNames ? '' : 'newTransaction',
        subBuilder: $460.TransactionOptions.create)
    ..aOM<$330.Timestamp>(6, _omitFieldNames ? '' : 'readTime',
        subBuilder: $330.Timestamp.create)
    ..aOM<$463.ExplainOptions>(8, _omitFieldNames ? '' : 'explainOptions',
        subBuilder: $463.ExplainOptions.create)
    ..hasRequiredFields = false;
  ...
  @$pb.TagNumber(2)
  $459.StructuredAggregationQuery get structuredAggregationQuery => $_getN(1);
  @$pb.TagNumber(2)
  set structuredAggregationQuery($459.StructuredAggregationQuery v) {
    setField(2, v);
  }
  ...
  @$pb.TagNumber(2)
  $459.StructuredAggregationQuery ensureStructuredAggregationQuery() =>
      $_ensure(1);
...
class RunAggregationQueryResponse extends $pb.GeneratedMessage {
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(
      ...
      package:
          const $pb.PackageName(_omitMessageNames ? '' : 'google.firestore.v1'),
      createEmptyInstance: create)
    ..aOM<$464.AggregationResult>(1, _omitFieldNames ? '' : 'result',
        subBuilder: $464.AggregationResult.create)
    ..a<$core.List<$core.int>>(
        2, _omitFieldNames ? '' : 'transaction', $pb.PbFieldType.OY)
    ..aOM<$330.Timestamp>(3, _omitFieldNames ? '' : 'readTime',
        subBuilder: $330.Timestamp.create)
    ..aOM<$463.ExplainMetrics>(10, _omitFieldNames ? '' : 'explainMetrics',
        subBuilder: $463.ExplainMetrics.create)
    ..hasRequiredFields = false;
  ...
  @$pb.TagNumber(1)
  $464.AggregationResult get result => $_getN(0);
  @$pb.TagNumber(1)
  set result($464.AggregationResult v) {
    setField(1, v);
  }
  ...
  @$pb.TagNumber(1)
  $464.AggregationResult ensureResult() => $_ensure(0);
  ...
  /// is provided, and it is sent only once with the last response in the stream.
  @$pb.TagNumber(10)
  $463.ExplainMetrics get explainMetrics => $_getN(3);
  @$pb.TagNumber(10)
  set explainMetrics($463.ExplainMetrics v) {
    setField(10, v);
  }
  ...
  @$pb.TagNumber(10)
  $463.ExplainMetrics ensureExplainMetrics() => $_ensure(3);
}
...
class PartitionQueryResponse extends $pb.GeneratedMessage {
  factory PartitionQueryResponse({
    $core.Iterable<$459.Cursor>? partitions,
    $core.String? nextPageToken,
  }) {
    final $result = create();
    if (partitions != null) {
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(
      ...
      createEmptyInstance: create)
    ..pc<$459.Cursor>(
        1, _omitFieldNames ? '' : 'partitions', $pb.PbFieldType.PM,
        subBuilder: $459.Cursor.create)
    ..aOS(2, _omitFieldNames ? '' : 'nextPageToken')
    ..hasRequiredFields = false;
  ...
  @$pb.TagNumber(1)
  $core.List<$459.Cursor> get partitions => $_getList(0);
...
class WriteRequest extends $pb.GeneratedMessage {
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(
    ...
    ..pc<$462.Write>(3, _omitFieldNames ? '' : 'writes', $pb.PbFieldType.PM,
        subBuilder: $462.Write.create)
    ..a<$core.List<$core.int>>(
  ...
  @$pb.TagNumber(3)
  $core.List<$462.Write> get writes => $_getList(2);
...
class WriteResponse extends $pb.GeneratedMessage {
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(
    ...
    ..pc<$462.WriteResult>(
        ...
        subBuilder: $462.WriteResult.create)
    ..aOM<$330.Timestamp>(4, _omitFieldNames ? '' : 'commitTime',
        subBuilder: $330.Timestamp.create)
    ..hasRequiredFields = false;
  ...
  ///  request.
  @$pb.TagNumber(3)
  $core.List<$462.WriteResult> get writeResults => $_getList(2);

  /// The time at which the commit occurred. Any read with an equal or greater
  /// `read_time` is guaranteed to see the effects of the write.
  @$pb.TagNumber(4)
  $330.Timestamp get commitTime => $_getN(3);
  @$pb.TagNumber(4)
  set commitTime($330.Timestamp v) {
    setField(4, v);
  }
  ...
  @$pb.TagNumber(4)
  $330.Timestamp ensureCommitTime() => $_ensure(3);
}
...
class ListenResponse extends $pb.GeneratedMessage {
  factory ListenResponse({
    ...
    $462.DocumentChange? documentChange,
    $462.DocumentDelete? documentDelete,
    $462.ExistenceFilter? filter,
    $462.DocumentRemove? documentRemove,
  }) {
    final $result = create();
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(
    ...
    ..aOM<$462.DocumentChange>(3, _omitFieldNames ? '' : 'documentChange',
        subBuilder: $462.DocumentChange.create)
    ..aOM<$462.DocumentDelete>(4, _omitFieldNames ? '' : 'documentDelete',
        subBuilder: $462.DocumentDelete.create)
    ..aOM<$462.ExistenceFilter>(5, _omitFieldNames ? '' : 'filter',
        subBuilder: $462.ExistenceFilter.create)
    ..aOM<$462.DocumentRemove>(6, _omitFieldNames ? '' : 'documentRemove',
        subBuilder: $462.DocumentRemove.create)
    ..hasRequiredFields = false;
  ...
  @$pb.TagNumber(3)
  $462.DocumentChange get documentChange => $_getN(1);
  @$pb.TagNumber(3)
  set documentChange($462.DocumentChange v) {
    setField(3, v);
  }
  ...
  @$pb.TagNumber(3)
  $462.DocumentChange ensureDocumentChange() => $_ensure(1);

  /// A [Document][google.firestore.v1.Document] has been deleted.
  @$pb.TagNumber(4)
  $462.DocumentDelete get documentDelete => $_getN(2);
  @$pb.TagNumber(4)
  set documentDelete($462.DocumentDelete v) {
    setField(4, v);
  }
  ...
  @$pb.TagNumber(4)
  $462.DocumentDelete ensureDocumentDelete() => $_ensure(2);
  ...
  @$pb.TagNumber(5)
  $462.ExistenceFilter get filter => $_getN(3);
  @$pb.TagNumber(5)
  set filter($462.ExistenceFilter v) {
    setField(5, v);
  }
  ...
  @$pb.TagNumber(5)
  $462.ExistenceFilter ensureFilter() => $_ensure(3);

  /// A [Document][google.firestore.v1.Document] has been removed from a target
  /// (because it is no longer relevant to that target).
  @$pb.TagNumber(6)
  $462.DocumentRemove get documentRemove => $_getN(4);
  @$pb.TagNumber(6)
  set documentRemove($462.DocumentRemove v) {
    setField(6, v);
  }
  ...
  @$pb.TagNumber(6)
  $462.DocumentRemove ensureDocumentRemove() => $_ensure(4);
}
...
class Target extends $pb.GeneratedMessage {
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(
    ...
    ..aOM<$330.Timestamp>(11, _omitFieldNames ? '' : 'readTime',
        subBuilder: $330.Timestamp.create)
    ..aOM<$335.Int32Value>(12, _omitFieldNames ? '' : 'expectedCount',
  ...
  @$pb.TagNumber(12)
  $335.Int32Value get expectedCount => $_getN(6);
  @$pb.TagNumber(12)
  set expectedCount($335.Int32Value v) {
    setField(12, v);
  }
  ...
  @$pb.TagNumber(12)
  $335.Int32Value ensureExpectedCount() => $_ensure(6);
}
...
class TargetChange extends $pb.GeneratedMessage {
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(
    ...
    ..aOM<$350.Status>(3, _omitFieldNames ? '' : 'cause',
  ...
  @$pb.TagNumber(3)
  $350.Status get cause => $_getN(2);
  @$pb.TagNumber(3)
  set cause($350.Status v) {
    setField(3, v);
  }
  ...
  @$pb.TagNumber(3)
  $350.Status ensureCause() => $_ensure(2);
...
class BatchWriteResponse extends $pb.GeneratedMessage {
  factory BatchWriteResponse({
    $core.Iterable<$462.WriteResult>? writeResults,
    $core.Iterable<$350.Status>? status,
  }) {
    final $result = create();
    if (writeResults != null) {
      $result.writeResults.addAll(writeResults);
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(
    ...
    ..pc<$462.WriteResult>(
        1, _omitFieldNames ? '' : 'writeResults', $pb.PbFieldType.PM,
        subBuilder: $462.WriteResult.create)
    ..pc<$350.Status>(2, _omitFieldNames ? '' : 'status', $pb.PbFieldType.PM,
        subBuilder: $350.Status.create)
    ..hasRequiredFields = false;
  ...
  ///  request.
  @$pb.TagNumber(2)
  $core.List<$350.Status> get status => $_getList(1);
}
