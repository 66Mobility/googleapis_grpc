...
import 'aggregation_result.pb.dart' as $432;
import 'common.pb.dart' as $428;
import 'document.pb.dart' as $130;
import 'firestore.pbenum.dart';
import 'query.pb.dart' as $427;
import 'query_profile.pb.dart' as $431;
import 'write.pb.dart' as $430;
...
class GetDocumentRequest extends $pb.GeneratedMessage {
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(_omitMessageNames ? '' : 'GetDocumentRequest', package: const $pb.PackageName(_omitMessageNames ? '' : 'google.firestore.v1'), createEmptyInstance: create)
    ...
    ..aOM<$428.DocumentMask>(2, _omitFieldNames ? '' : 'mask', subBuilder: $428.DocumentMask.create)
  ...
  @$pb.TagNumber(2)
  $428.DocumentMask get mask => $_getN(1);
  @$pb.TagNumber(2)
  set mask($428.DocumentMask v) { setField(2, v); }
  @$pb.TagNumber(2)
  $core.bool hasMask() => $_has(1);
  @$pb.TagNumber(2)
  void clearMask() => clearField(2);
  @$pb.TagNumber(2)
  $428.DocumentMask ensureMask() => $_ensure(1);
...
class ListDocumentsRequest extends $pb.GeneratedMessage {
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(_omitMessageNames ? '' : 'ListDocumentsRequest', package: const $pb.PackageName(_omitMessageNames ? '' : 'google.firestore.v1'), createEmptyInstance: create)
    ...
    ..aOM<$428.DocumentMask>(7, _omitFieldNames ? '' : 'mask', subBuilder: $428.DocumentMask.create)
  ...
  ///  will not be returned in the response.
  @$pb.TagNumber(7)
  $428.DocumentMask get mask => $_getN(5);
  @$pb.TagNumber(7)
  set mask($428.DocumentMask v) { setField(7, v); }
  @$pb.TagNumber(7)
  $core.bool hasMask() => $_has(5);
  @$pb.TagNumber(7)
  void clearMask() => clearField(7);
  @$pb.TagNumber(7)
  $428.DocumentMask ensureMask() => $_ensure(5);
...
class ListDocumentsResponse extends $pb.GeneratedMessage {
  factory ListDocumentsResponse({
    $core.Iterable<$130.Document>? documents,
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(_omitMessageNames ? '' : 'ListDocumentsResponse', package: const $pb.PackageName(_omitMessageNames ? '' : 'google.firestore.v1'), createEmptyInstance: create)
    ..pc<$130.Document>(1, _omitFieldNames ? '' : 'documents', $pb.PbFieldType.PM, subBuilder: $130.Document.create)
  ...
  /// The Documents found.
  @$pb.TagNumber(1)
  $core.List<$130.Document> get documents => $_getList(0);
...
class CreateDocumentRequest extends $pb.GeneratedMessage {
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(_omitMessageNames ? '' : 'CreateDocumentRequest', package: const $pb.PackageName(_omitMessageNames ? '' : 'google.firestore.v1'), createEmptyInstance: create)
    ...
    ..aOM<$428.DocumentMask>(5, _omitFieldNames ? '' : 'mask', subBuilder: $428.DocumentMask.create)
    ..hasRequiredFields = false
  ;
  ...
  ///  will not be returned in the response.
  @$pb.TagNumber(5)
  $428.DocumentMask get mask => $_getN(4);
  @$pb.TagNumber(5)
  set mask($428.DocumentMask v) { setField(5, v); }
  @$pb.TagNumber(5)
  $core.bool hasMask() => $_has(4);
  @$pb.TagNumber(5)
  void clearMask() => clearField(5);
  @$pb.TagNumber(5)
  $428.DocumentMask ensureMask() => $_ensure(4);
}
...
class UpdateDocumentRequest extends $pb.GeneratedMessage {
  factory UpdateDocumentRequest({
    $130.Document? document,
    $428.DocumentMask? updateMask,
    $428.DocumentMask? mask,
    $428.Precondition? currentDocument,
  }) {
    final $result = create();
    if (document != null) {
      $result.document = document;
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(_omitMessageNames ? '' : 'UpdateDocumentRequest', package: const $pb.PackageName(_omitMessageNames ? '' : 'google.firestore.v1'), createEmptyInstance: create)
    ..aOM<$130.Document>(1, _omitFieldNames ? '' : 'document', subBuilder: $130.Document.create)
    ..aOM<$428.DocumentMask>(2, _omitFieldNames ? '' : 'updateMask', subBuilder: $428.DocumentMask.create)
    ..aOM<$428.DocumentMask>(3, _omitFieldNames ? '' : 'mask', subBuilder: $428.DocumentMask.create)
    ..aOM<$428.Precondition>(4, _omitFieldNames ? '' : 'currentDocument', subBuilder: $428.Precondition.create)
    ..hasRequiredFields = false
  ;
  ...
  @$pb.TagNumber(1)
  $130.Document get document => $_getN(0);
  @$pb.TagNumber(1)
  set document($130.Document v) { setField(1, v); }
  @$pb.TagNumber(1)
  $core.bool hasDocument() => $_has(0);
  @$pb.TagNumber(1)
  void clearDocument() => clearField(1);
  @$pb.TagNumber(1)
  $130.Document ensureDocument() => $_ensure(0);
  ...
  @$pb.TagNumber(2)
  $428.DocumentMask get updateMask => $_getN(1);
  @$pb.TagNumber(2)
  set updateMask($428.DocumentMask v) { setField(2, v); }
  @$pb.TagNumber(2)
  $core.bool hasUpdateMask() => $_has(1);
  @$pb.TagNumber(2)
  void clearUpdateMask() => clearField(2);
  @$pb.TagNumber(2)
  $428.DocumentMask ensureUpdateMask() => $_ensure(1);
  ...
  ///  will not be returned in the response.
  @$pb.TagNumber(3)
  $428.DocumentMask get mask => $_getN(2);
  @$pb.TagNumber(3)
  set mask($428.DocumentMask v) { setField(3, v); }
  @$pb.TagNumber(3)
  $core.bool hasMask() => $_has(2);
  @$pb.TagNumber(3)
  void clearMask() => clearField(3);
  @$pb.TagNumber(3)
  $428.DocumentMask ensureMask() => $_ensure(2);

  /// An optional precondition on the document.
  /// The request will fail if this is set and not met by the target document.
  @$pb.TagNumber(4)
  $428.Precondition get currentDocument => $_getN(3);
  @$pb.TagNumber(4)
  set currentDocument($428.Precondition v) { setField(4, v); }
  @$pb.TagNumber(4)
  $core.bool hasCurrentDocument() => $_has(3);
  @$pb.TagNumber(4)
  void clearCurrentDocument() => clearField(4);
  @$pb.TagNumber(4)
  $428.Precondition ensureCurrentDocument() => $_ensure(3);
}
...
class DeleteDocumentRequest extends $pb.GeneratedMessage {
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(_omitMessageNames ? '' : 'DeleteDocumentRequest', package: const $pb.PackageName(_omitMessageNames ? '' : 'google.firestore.v1'), createEmptyInstance: create)
    ..aOS(1, _omitFieldNames ? '' : 'name')
    ..aOM<$428.Precondition>(2, _omitFieldNames ? '' : 'currentDocument', subBuilder: $428.Precondition.create)
    ..hasRequiredFields = false
  ;
  ...
  /// The request will fail if this is set and not met by the target document.
  @$pb.TagNumber(2)
  $428.Precondition get currentDocument => $_getN(1);
  @$pb.TagNumber(2)
  set currentDocument($428.Precondition v) { setField(2, v); }
  @$pb.TagNumber(2)
  $core.bool hasCurrentDocument() => $_has(1);
  @$pb.TagNumber(2)
  void clearCurrentDocument() => clearField(2);
  @$pb.TagNumber(2)
  $428.Precondition ensureCurrentDocument() => $_ensure(1);
}
...
class BatchGetDocumentsRequest extends $pb.GeneratedMessage {
  factory BatchGetDocumentsRequest({
    ...
    $428.DocumentMask? mask,
    $core.List<$core.int>? transaction,
    $428.TransactionOptions? newTransaction,
    $301.Timestamp? readTime,
  }) {
    final $result = create();
    if (database != null) {
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(_omitMessageNames ? '' : 'BatchGetDocumentsRequest', package: const $pb.PackageName(_omitMessageNames ? '' : 'google.firestore.v1'), createEmptyInstance: create)
    ...
    ..aOM<$428.TransactionOptions>(5, _omitFieldNames ? '' : 'newTransaction', subBuilder: $428.TransactionOptions.create)
  ...
  /// stream.
  @$pb.TagNumber(5)
  $428.TransactionOptions get newTransaction => $_getN(4);
  @$pb.TagNumber(5)
  set newTransaction($428.TransactionOptions v) { setField(5, v); }
  @$pb.TagNumber(5)
  $core.bool hasNewTransaction() => $_has(4);
  @$pb.TagNumber(5)
  void clearNewTransaction() => clearField(5);
  @$pb.TagNumber(5)
  $428.TransactionOptions ensureNewTransaction() => $_ensure(4);
...
class BatchGetDocumentsResponse extends $pb.GeneratedMessage {
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(_omitMessageNames ? '' : 'BatchGetDocumentsResponse', package: const $pb.PackageName(_omitMessageNames ? '' : 'google.firestore.v1'), createEmptyInstance: create)
    ..oo(0, [1, 2])
    ..aOM<$130.Document>(1, _omitFieldNames ? '' : 'found', subBuilder: $130.Document.create)
  ...
  @$pb.TagNumber(1)
  $130.Document get found => $_getN(0);
  @$pb.TagNumber(1)
  set found($130.Document v) { setField(1, v); }
  @$pb.TagNumber(1)
  $core.bool hasFound() => $_has(0);
  @$pb.TagNumber(1)
  void clearFound() => clearField(1);
  @$pb.TagNumber(1)
  $130.Document ensureFound() => $_ensure(0);
...
class BeginTransactionRequest extends $pb.GeneratedMessage {
  factory BeginTransactionRequest({
    $core.String? database,
    $428.TransactionOptions? options,
  }) {
    final $result = create();
    if (database != null) {
      $result.database = database;
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(_omitMessageNames ? '' : 'BeginTransactionRequest', package: const $pb.PackageName(_omitMessageNames ? '' : 'google.firestore.v1'), createEmptyInstance: create)
    ..aOS(1, _omitFieldNames ? '' : 'database')
    ..aOM<$428.TransactionOptions>(2, _omitFieldNames ? '' : 'options', subBuilder: $428.TransactionOptions.create)
    ..hasRequiredFields = false
  ;
  ...
  @$pb.TagNumber(2)
  $428.TransactionOptions get options => $_getN(1);
  @$pb.TagNumber(2)
  set options($428.TransactionOptions v) { setField(2, v); }
  @$pb.TagNumber(2)
  $core.bool hasOptions() => $_has(1);
  @$pb.TagNumber(2)
  void clearOptions() => clearField(2);
  @$pb.TagNumber(2)
  $428.TransactionOptions ensureOptions() => $_ensure(1);
}
...
class CommitRequest extends $pb.GeneratedMessage {
  factory CommitRequest({
    $core.String? database,
    $core.Iterable<$430.Write>? writes,
    $core.List<$core.int>? transaction,
  }) {
    final $result = create();
    if (database != null) {
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(_omitMessageNames ? '' : 'CommitRequest', package: const $pb.PackageName(_omitMessageNames ? '' : 'google.firestore.v1'), createEmptyInstance: create)
    ..aOS(1, _omitFieldNames ? '' : 'database')
    ..pc<$430.Write>(2, _omitFieldNames ? '' : 'writes', $pb.PbFieldType.PM, subBuilder: $430.Write.create)
    ..a<$core.List<$core.int>>(3, _omitFieldNames ? '' : 'transaction', $pb.PbFieldType.OY)
    ..hasRequiredFields = false
  ;
  ...
  @$pb.TagNumber(2)
  $core.List<$430.Write> get writes => $_getList(1);
...
class CommitResponse extends $pb.GeneratedMessage {
  factory CommitResponse({
    $core.Iterable<$430.WriteResult>? writeResults,
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(_omitMessageNames ? '' : 'CommitResponse', package: const $pb.PackageName(_omitMessageNames ? '' : 'google.firestore.v1'), createEmptyInstance: create)
    ..pc<$430.WriteResult>(1, _omitFieldNames ? '' : 'writeResults', $pb.PbFieldType.PM, subBuilder: $430.WriteResult.create)
  ...
  ///  request.
  @$pb.TagNumber(1)
  $core.List<$430.WriteResult> get writeResults => $_getList(0);
...
class RunQueryRequest extends $pb.GeneratedMessage {
  factory RunQueryRequest({
    $core.String? parent,
    $427.StructuredQuery? structuredQuery,
    $core.List<$core.int>? transaction,
    $428.TransactionOptions? newTransaction,
    $301.Timestamp? readTime,
    $431.ExplainOptions? explainOptions,
  }) {
    final $result = create();
    if (parent != null) {
      $result.parent = parent;
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(_omitMessageNames ? '' : 'RunQueryRequest', package: const $pb.PackageName(_omitMessageNames ? '' : 'google.firestore.v1'), createEmptyInstance: create)
    ...
    ..oo(1, [5, 6, 7])
    ..aOS(1, _omitFieldNames ? '' : 'parent')
    ..aOM<$427.StructuredQuery>(2, _omitFieldNames ? '' : 'structuredQuery', subBuilder: $427.StructuredQuery.create)
    ..a<$core.List<$core.int>>(5, _omitFieldNames ? '' : 'transaction', $pb.PbFieldType.OY)
    ..aOM<$428.TransactionOptions>(6, _omitFieldNames ? '' : 'newTransaction', subBuilder: $428.TransactionOptions.create)
    ..aOM<$301.Timestamp>(7, _omitFieldNames ? '' : 'readTime', subBuilder: $301.Timestamp.create)
    ..aOM<$431.ExplainOptions>(10, _omitFieldNames ? '' : 'explainOptions', subBuilder: $431.ExplainOptions.create)
    ..hasRequiredFields = false
  ;
  ...
  /// A structured query.
  @$pb.TagNumber(2)
  $427.StructuredQuery get structuredQuery => $_getN(1);
  @$pb.TagNumber(2)
  set structuredQuery($427.StructuredQuery v) { setField(2, v); }
  @$pb.TagNumber(2)
  $core.bool hasStructuredQuery() => $_has(1);
  @$pb.TagNumber(2)
  void clearStructuredQuery() => clearField(2);
  @$pb.TagNumber(2)
  $427.StructuredQuery ensureStructuredQuery() => $_ensure(1);
  ...
  /// stream.
  @$pb.TagNumber(6)
  $428.TransactionOptions get newTransaction => $_getN(3);
  @$pb.TagNumber(6)
  set newTransaction($428.TransactionOptions v) { setField(6, v); }
  @$pb.TagNumber(6)
  $core.bool hasNewTransaction() => $_has(3);
  @$pb.TagNumber(6)
  void clearNewTransaction() => clearField(6);
  @$pb.TagNumber(6)
  $428.TransactionOptions ensureNewTransaction() => $_ensure(3);
  ...
  @$pb.TagNumber(10)
  $431.ExplainOptions get explainOptions => $_getN(5);
  @$pb.TagNumber(10)
  set explainOptions($431.ExplainOptions v) { setField(10, v); }
  @$pb.TagNumber(10)
  $core.bool hasExplainOptions() => $_has(5);
  @$pb.TagNumber(10)
  void clearExplainOptions() => clearField(10);
  @$pb.TagNumber(10)
  $431.ExplainOptions ensureExplainOptions() => $_ensure(5);
}
...
class RunQueryResponse extends $pb.GeneratedMessage {
  factory RunQueryResponse({
    ...
    $core.bool? done,
    $431.ExplainMetrics? explainMetrics,
  }) {
    final $result = create();
    if (document != null) {
      $result.document = document;
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(_omitMessageNames ? '' : 'RunQueryResponse', package: const $pb.PackageName(_omitMessageNames ? '' : 'google.firestore.v1'), createEmptyInstance: create)
    ...
    ..aOM<$431.ExplainMetrics>(11, _omitFieldNames ? '' : 'explainMetrics', subBuilder: $431.ExplainMetrics.create)
    ..hasRequiredFields = false
  ;
  ...
  @$pb.TagNumber(11)
  $431.ExplainMetrics get explainMetrics => $_getN(5);
  @$pb.TagNumber(11)
  set explainMetrics($431.ExplainMetrics v) { setField(11, v); }
  @$pb.TagNumber(11)
  $core.bool hasExplainMetrics() => $_has(5);
  @$pb.TagNumber(11)
  void clearExplainMetrics() => clearField(11);
  @$pb.TagNumber(11)
  $431.ExplainMetrics ensureExplainMetrics() => $_ensure(5);
}
...
class RunAggregationQueryRequest extends $pb.GeneratedMessage {
  factory RunAggregationQueryRequest({
    $core.String? parent,
    $427.StructuredAggregationQuery? structuredAggregationQuery,
    $core.List<$core.int>? transaction,
    $428.TransactionOptions? newTransaction,
    $301.Timestamp? readTime,
    $431.ExplainOptions? explainOptions,
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(_omitMessageNames ? '' : 'RunAggregationQueryRequest', package: const $pb.PackageName(_omitMessageNames ? '' : 'google.firestore.v1'), createEmptyInstance: create)
    ...
    ..oo(1, [4, 5, 6])
    ..aOS(1, _omitFieldNames ? '' : 'parent')
    ..aOM<$427.StructuredAggregationQuery>(2, _omitFieldNames ? '' : 'structuredAggregationQuery', subBuilder: $427.StructuredAggregationQuery.create)
    ..a<$core.List<$core.int>>(4, _omitFieldNames ? '' : 'transaction', $pb.PbFieldType.OY)
    ..aOM<$428.TransactionOptions>(5, _omitFieldNames ? '' : 'newTransaction', subBuilder: $428.TransactionOptions.create)
    ..aOM<$301.Timestamp>(6, _omitFieldNames ? '' : 'readTime', subBuilder: $301.Timestamp.create)
    ..aOM<$431.ExplainOptions>(8, _omitFieldNames ? '' : 'explainOptions', subBuilder: $431.ExplainOptions.create)
    ..hasRequiredFields = false
  ;
  ...
  @$pb.TagNumber(2)
  $427.StructuredAggregationQuery get structuredAggregationQuery => $_getN(1);
  @$pb.TagNumber(2)
  set structuredAggregationQuery($427.StructuredAggregationQuery v) { setField(2, v); }
  @$pb.TagNumber(2)
  $core.bool hasStructuredAggregationQuery() => $_has(1);
  @$pb.TagNumber(2)
  void clearStructuredAggregationQuery() => clearField(2);
  @$pb.TagNumber(2)
  $427.StructuredAggregationQuery ensureStructuredAggregationQuery() => $_ensure(1);
  ...
  $431.ExplainOptions get explainOptions => $_getN(5);
  @$pb.TagNumber(8)
  set explainOptions($431.ExplainOptions v) { setField(8, v); }
  @$pb.TagNumber(8)
  $core.bool hasExplainOptions() => $_has(5);
  @$pb.TagNumber(8)
...
class RunAggregationQueryResponse extends $pb.GeneratedMessage {
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(_omitMessageNames ? '' : 'RunAggregationQueryResponse', package: const $pb.PackageName(_omitMessageNames ? '' : 'google.firestore.v1'), createEmptyInstance: create)
    ..aOM<$432.AggregationResult>(1, _omitFieldNames ? '' : 'result', subBuilder: $432.AggregationResult.create)
    ..a<$core.List<$core.int>>(2, _omitFieldNames ? '' : 'transaction', $pb.PbFieldType.OY)
    ..aOM<$301.Timestamp>(3, _omitFieldNames ? '' : 'readTime', subBuilder: $301.Timestamp.create)
    ..aOM<$431.ExplainMetrics>(10, _omitFieldNames ? '' : 'explainMetrics', subBuilder: $431.ExplainMetrics.create)
    ..hasRequiredFields = false
  ;
  ...
  @$pb.TagNumber(1)
  $432.AggregationResult get result => $_getN(0);
  @$pb.TagNumber(1)
  set result($432.AggregationResult v) { setField(1, v); }
  @$pb.TagNumber(1)
  $core.bool hasResult() => $_has(0);
  @$pb.TagNumber(1)
  void clearResult() => clearField(1);
  @$pb.TagNumber(1)
  $432.AggregationResult ensureResult() => $_ensure(0);
  ...
  /// is provided, and it is sent only once with the last response in the stream.
  @$pb.TagNumber(10)
  $431.ExplainMetrics get explainMetrics => $_getN(3);
  @$pb.TagNumber(10)
  set explainMetrics($431.ExplainMetrics v) { setField(10, v); }
  @$pb.TagNumber(10)
  $core.bool hasExplainMetrics() => $_has(3);
  @$pb.TagNumber(10)
  void clearExplainMetrics() => clearField(10);
  @$pb.TagNumber(10)
  $431.ExplainMetrics ensureExplainMetrics() => $_ensure(3);
}
...
class PartitionQueryResponse extends $pb.GeneratedMessage {
  factory PartitionQueryResponse({
    $core.Iterable<$427.Cursor>? partitions,
    $core.String? nextPageToken,
  }) {
    final $result = create();
    if (partitions != null) {
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(_omitMessageNames ? '' : 'PartitionQueryResponse', package: const $pb.PackageName(_omitMessageNames ? '' : 'google.firestore.v1'), createEmptyInstance: create)
    ..pc<$427.Cursor>(1, _omitFieldNames ? '' : 'partitions', $pb.PbFieldType.PM, subBuilder: $427.Cursor.create)
    ..aOS(2, _omitFieldNames ? '' : 'nextPageToken')
    ..hasRequiredFields = false
  ;
  ...
  @$pb.TagNumber(1)
  $core.List<$427.Cursor> get partitions => $_getList(0);
...
class WriteRequest extends $pb.GeneratedMessage {
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(_omitMessageNames ? '' : 'WriteRequest', package: const $pb.PackageName(_omitMessageNames ? '' : 'google.firestore.v1'), createEmptyInstance: create)
    ...
    ..pc<$430.Write>(3, _omitFieldNames ? '' : 'writes', $pb.PbFieldType.PM, subBuilder: $430.Write.create)
  ...
  @$pb.TagNumber(3)
  $core.List<$430.Write> get writes => $_getList(2);
...
class WriteResponse extends $pb.GeneratedMessage {
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(_omitMessageNames ? '' : 'WriteResponse', package: const $pb.PackageName(_omitMessageNames ? '' : 'google.firestore.v1'), createEmptyInstance: create)
    ...
    ..pc<$430.WriteResult>(3, _omitFieldNames ? '' : 'writeResults', $pb.PbFieldType.PM, subBuilder: $430.WriteResult.create)
  ...
  ///  request.
  @$pb.TagNumber(3)
  $core.List<$430.WriteResult> get writeResults => $_getList(2);
...
class ListenResponse extends $pb.GeneratedMessage {
  factory ListenResponse({
    ...
    $430.DocumentChange? documentChange,
    $430.DocumentDelete? documentDelete,
    $430.ExistenceFilter? filter,
    $430.DocumentRemove? documentRemove,
  }) {
    final $result = create();
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(_omitMessageNames ? '' : 'ListenResponse', package: const $pb.PackageName(_omitMessageNames ? '' : 'google.firestore.v1'), createEmptyInstance: create)
    ...
    ..aOM<$430.DocumentChange>(3, _omitFieldNames ? '' : 'documentChange', subBuilder: $430.DocumentChange.create)
    ..aOM<$430.DocumentDelete>(4, _omitFieldNames ? '' : 'documentDelete', subBuilder: $430.DocumentDelete.create)
    ..aOM<$430.ExistenceFilter>(5, _omitFieldNames ? '' : 'filter', subBuilder: $430.ExistenceFilter.create)
    ..aOM<$430.DocumentRemove>(6, _omitFieldNames ? '' : 'documentRemove', subBuilder: $430.DocumentRemove.create)
    ..hasRequiredFields = false
  ;
  ...
  @$pb.TagNumber(3)
  $430.DocumentChange get documentChange => $_getN(1);
  @$pb.TagNumber(3)
  set documentChange($430.DocumentChange v) { setField(3, v); }
  @$pb.TagNumber(3)
  $core.bool hasDocumentChange() => $_has(1);
  @$pb.TagNumber(3)
  void clearDocumentChange() => clearField(3);
  @$pb.TagNumber(3)
  $430.DocumentChange ensureDocumentChange() => $_ensure(1);

  /// A [Document][google.firestore.v1.Document] has been deleted.
  @$pb.TagNumber(4)
  $430.DocumentDelete get documentDelete => $_getN(2);
  @$pb.TagNumber(4)
  set documentDelete($430.DocumentDelete v) { setField(4, v); }
  @$pb.TagNumber(4)
  $core.bool hasDocumentDelete() => $_has(2);
  @$pb.TagNumber(4)
  void clearDocumentDelete() => clearField(4);
  @$pb.TagNumber(4)
  $430.DocumentDelete ensureDocumentDelete() => $_ensure(2);
  ...
  @$pb.TagNumber(5)
  $430.ExistenceFilter get filter => $_getN(3);
  @$pb.TagNumber(5)
  set filter($430.ExistenceFilter v) { setField(5, v); }
  @$pb.TagNumber(5)
  $core.bool hasFilter() => $_has(3);
  @$pb.TagNumber(5)
  void clearFilter() => clearField(5);
  @$pb.TagNumber(5)
  $430.ExistenceFilter ensureFilter() => $_ensure(3);

  /// A [Document][google.firestore.v1.Document] has been removed from a target
  /// (because it is no longer relevant to that target).
  @$pb.TagNumber(6)
  $430.DocumentRemove get documentRemove => $_getN(4);
  @$pb.TagNumber(6)
  set documentRemove($430.DocumentRemove v) { setField(6, v); }
  @$pb.TagNumber(6)
  $core.bool hasDocumentRemove() => $_has(4);
  @$pb.TagNumber(6)
  void clearDocumentRemove() => clearField(6);
  @$pb.TagNumber(6)
  $430.DocumentRemove ensureDocumentRemove() => $_ensure(4);
}
...
class Target extends $pb.GeneratedMessage {
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(_omitMessageNames ? '' : 'Target', package: const $pb.PackageName(_omitMessageNames ? '' : 'google.firestore.v1'), createEmptyInstance: create)
    ...
    ..aOM<$306.Int32Value>(12, _omitFieldNames ? '' : 'expectedCount', subBuilder: $306.Int32Value.create)
    ..hasRequiredFields = false
  ;
  ...
  @$pb.TagNumber(12)
  $306.Int32Value get expectedCount => $_getN(6);
  @$pb.TagNumber(12)
  set expectedCount($306.Int32Value v) { setField(12, v); }
  @$pb.TagNumber(12)
  $core.bool hasExpectedCount() => $_has(6);
  @$pb.TagNumber(12)
  void clearExpectedCount() => clearField(12);
  @$pb.TagNumber(12)
  $306.Int32Value ensureExpectedCount() => $_ensure(6);
}
