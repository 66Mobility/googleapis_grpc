...
class PlanSummary extends $pb.GeneratedMessage {
  factory PlanSummary({
    $core.Iterable<$1734.Struct>? indexesUsed,
  }) {
    final $result = create();
    if (indexesUsed != null) {
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(_omitMessageNames ? '' : 'PlanSummary', package: const $pb.PackageName(_omitMessageNames ? '' : 'google.firestore.v1'), createEmptyInstance: create)
    ..pc<$1734.Struct>(1, _omitFieldNames ? '' : 'indexesUsed', $pb.PbFieldType.PM, subBuilder: $1734.Struct.create)
    ..hasRequiredFields = false
  ;
  ...
  ///  ]
  @$pb.TagNumber(1)
  $core.List<$1734.Struct> get indexesUsed => $_getList(0);
}
...
class ExecutionStats extends $pb.GeneratedMessage {
  factory ExecutionStats({
    ...
    $1737.Duration? executionDuration,
    $fixnum.Int64? readOperations,
    $1734.Struct? debugStats,
  }) {
    final $result = create();
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(_omitMessageNames ? '' : 'ExecutionStats', package: const $pb.PackageName(_omitMessageNames ? '' : 'google.firestore.v1'), createEmptyInstance: create)
    ...
    ..aOM<$1737.Duration>(3, _omitFieldNames ? '' : 'executionDuration', subBuilder: $1737.Duration.create)
    ..aInt64(4, _omitFieldNames ? '' : 'readOperations')
    ..aOM<$1734.Struct>(5, _omitFieldNames ? '' : 'debugStats', subBuilder: $1734.Struct.create)
    ..hasRequiredFields = false
  ;
  ...
  @$pb.TagNumber(3)
  $1737.Duration get executionDuration => $_getN(1);
  @$pb.TagNumber(3)
  set executionDuration($1737.Duration v) { setField(3, v); }
  @$pb.TagNumber(3)
  $core.bool hasExecutionDuration() => $_has(1);
  @$pb.TagNumber(3)
  void clearExecutionDuration() => clearField(3);
  @$pb.TagNumber(3)
  $1737.Duration ensureExecutionDuration() => $_ensure(1);
  ...
  ///  }
  @$pb.TagNumber(5)
  $1734.Struct get debugStats => $_getN(3);
  @$pb.TagNumber(5)
  set debugStats($1734.Struct v) { setField(5, v); }
  @$pb.TagNumber(5)
  $core.bool hasDebugStats() => $_has(3);
  @$pb.TagNumber(5)
  void clearDebugStats() => clearField(5);
  @$pb.TagNumber(5)
  $1734.Struct ensureDebugStats() => $_ensure(3);
}
