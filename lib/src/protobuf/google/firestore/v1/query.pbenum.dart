...
class StructuredQuery_FindNearest_DistanceMeasure extends $pb.ProtobufEnum {
  ...
  static final $core.Map<$core.int, StructuredQuery_FindNearest_DistanceMeasure> _byValue = $pb.ProtobufEnum.initByValue(values);
  static StructuredQuery_FindNearest_DistanceMeasure? valueOf($core.int value) => _byValue[value];

  const StructuredQuery_FindNearest_DistanceMeasure._($core.int v, $core.String n) : super(v, n);
}
