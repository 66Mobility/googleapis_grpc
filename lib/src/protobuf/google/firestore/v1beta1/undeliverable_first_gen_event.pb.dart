...
class UndeliverableFirstGenEvent extends $pb.GeneratedMessage {
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(_omitMessageNames ? '' : 'UndeliverableFirstGenEvent', package: const $pb.PackageName(_omitMessageNames ? '' : 'google.firestore.v1beta1'), createEmptyInstance: create)
    ...
    ..aOM<$301.Timestamp>(6, _omitFieldNames ? '' : 'triggeredTime', subBuilder: $301.Timestamp.create)
  ...
  @$pb.TagNumber(6)
  $301.Timestamp get triggeredTime => $_getN(5);
  @$pb.TagNumber(6)
  set triggeredTime($301.Timestamp v) { setField(6, v); }
  @$pb.TagNumber(6)
  $core.bool hasTriggeredTime() => $_has(5);
  @$pb.TagNumber(6)
  void clearTriggeredTime() => clearField(6);
  @$pb.TagNumber(6)
  $301.Timestamp ensureTriggeredTime() => $_ensure(5);
}
