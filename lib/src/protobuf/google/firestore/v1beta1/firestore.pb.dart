...
import 'common.pb.dart' as $433;
import 'document.pb.dart' as $132;
import 'firestore.pbenum.dart';
import 'query.pb.dart' as $435;
import 'write.pb.dart' as $434;
...
class GetDocumentRequest extends $pb.GeneratedMessage {
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(_omitMessageNames ? '' : 'GetDocumentRequest', package: const $pb.PackageName(_omitMessageNames ? '' : 'google.firestore.v1beta1'), createEmptyInstance: create)
    ..oo(0, [3, 5])
    ..aOS(1, _omitFieldNames ? '' : 'name')
    ..aOM<$433.DocumentMask>(2, _omitFieldNames ? '' : 'mask', subBuilder: $433.DocumentMask.create)
    ..a<$core.List<$core.int>>(3, _omitFieldNames ? '' : 'transaction', $pb.PbFieldType.OY)
    ..aOM<$301.Timestamp>(5, _omitFieldNames ? '' : 'readTime', subBuilder: $301.Timestamp.create)
  ...
  @$pb.TagNumber(2)
  $433.DocumentMask get mask => $_getN(1);
  @$pb.TagNumber(2)
  set mask($433.DocumentMask v) { setField(2, v); }
  @$pb.TagNumber(2)
  $core.bool hasMask() => $_has(1);
  @$pb.TagNumber(2)
  void clearMask() => clearField(2);
  @$pb.TagNumber(2)
  $433.DocumentMask ensureMask() => $_ensure(1);
  ...
  @$pb.TagNumber(5)
  $301.Timestamp get readTime => $_getN(3);
  @$pb.TagNumber(5)
  set readTime($301.Timestamp v) { setField(5, v); }
  @$pb.TagNumber(5)
  $core.bool hasReadTime() => $_has(3);
  @$pb.TagNumber(5)
  void clearReadTime() => clearField(5);
  @$pb.TagNumber(5)
  $301.Timestamp ensureReadTime() => $_ensure(3);
}
...
class ListDocumentsRequest extends $pb.GeneratedMessage {
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(_omitMessageNames ? '' : 'ListDocumentsRequest', package: const $pb.PackageName(_omitMessageNames ? '' : 'google.firestore.v1beta1'), createEmptyInstance: create)
    ..oo(0, [8, 10])
    ...
    ..aOM<$433.DocumentMask>(7, _omitFieldNames ? '' : 'mask', subBuilder: $433.DocumentMask.create)
    ..a<$core.List<$core.int>>(8, _omitFieldNames ? '' : 'transaction', $pb.PbFieldType.OY)
    ..aOM<$301.Timestamp>(10, _omitFieldNames ? '' : 'readTime', subBuilder: $301.Timestamp.create)
  ...
  ///  will not be returned in the response.
  @$pb.TagNumber(7)
  $433.DocumentMask get mask => $_getN(5);
  @$pb.TagNumber(7)
  set mask($433.DocumentMask v) { setField(7, v); }
  @$pb.TagNumber(7)
  $core.bool hasMask() => $_has(5);
  @$pb.TagNumber(7)
  void clearMask() => clearField(7);
  @$pb.TagNumber(7)
  $433.DocumentMask ensureMask() => $_ensure(5);
  ...
  @$pb.TagNumber(10)
  set readTime($301.Timestamp v) { setField(10, v); }
  @$pb.TagNumber(10)
...
class ListDocumentsResponse extends $pb.GeneratedMessage {
  factory ListDocumentsResponse({
    $core.Iterable<$132.Document>? documents,
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(_omitMessageNames ? '' : 'ListDocumentsResponse', package: const $pb.PackageName(_omitMessageNames ? '' : 'google.firestore.v1beta1'), createEmptyInstance: create)
    ..pc<$132.Document>(1, _omitFieldNames ? '' : 'documents', $pb.PbFieldType.PM, subBuilder: $132.Document.create)
  ...
  /// The Documents found.
  @$pb.TagNumber(1)
  $core.List<$132.Document> get documents => $_getList(0);
...
class CreateDocumentRequest extends $pb.GeneratedMessage {
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(_omitMessageNames ? '' : 'CreateDocumentRequest', package: const $pb.PackageName(_omitMessageNames ? '' : 'google.firestore.v1beta1'), createEmptyInstance: create)
    ..aOS(1, _omitFieldNames ? '' : 'parent')
    ..aOS(2, _omitFieldNames ? '' : 'collectionId')
    ..aOS(3, _omitFieldNames ? '' : 'documentId')
    ..aOM<$132.Document>(4, _omitFieldNames ? '' : 'document', subBuilder: $132.Document.create)
    ..aOM<$433.DocumentMask>(5, _omitFieldNames ? '' : 'mask', subBuilder: $433.DocumentMask.create)
    ..hasRequiredFields = false
  ;
  ...
  @$pb.TagNumber(4)
  $132.Document get document => $_getN(3);
  @$pb.TagNumber(4)
  set document($132.Document v) { setField(4, v); }
  @$pb.TagNumber(4)
  $core.bool hasDocument() => $_has(3);
  @$pb.TagNumber(4)
  void clearDocument() => clearField(4);
  @$pb.TagNumber(4)
  $132.Document ensureDocument() => $_ensure(3);
  ...
  ///  will not be returned in the response.
  @$pb.TagNumber(5)
  $433.DocumentMask get mask => $_getN(4);
  @$pb.TagNumber(5)
  set mask($433.DocumentMask v) { setField(5, v); }
  @$pb.TagNumber(5)
  $core.bool hasMask() => $_has(4);
  @$pb.TagNumber(5)
  void clearMask() => clearField(5);
  @$pb.TagNumber(5)
  $433.DocumentMask ensureMask() => $_ensure(4);
}
...
class UpdateDocumentRequest extends $pb.GeneratedMessage {
  factory UpdateDocumentRequest({
    $132.Document? document,
    $433.DocumentMask? updateMask,
    $433.DocumentMask? mask,
    $433.Precondition? currentDocument,
  }) {
    final $result = create();
    if (document != null) {
      $result.document = document;
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(_omitMessageNames ? '' : 'UpdateDocumentRequest', package: const $pb.PackageName(_omitMessageNames ? '' : 'google.firestore.v1beta1'), createEmptyInstance: create)
    ..aOM<$132.Document>(1, _omitFieldNames ? '' : 'document', subBuilder: $132.Document.create)
    ..aOM<$433.DocumentMask>(2, _omitFieldNames ? '' : 'updateMask', subBuilder: $433.DocumentMask.create)
    ..aOM<$433.DocumentMask>(3, _omitFieldNames ? '' : 'mask', subBuilder: $433.DocumentMask.create)
    ..aOM<$433.Precondition>(4, _omitFieldNames ? '' : 'currentDocument', subBuilder: $433.Precondition.create)
    ..hasRequiredFields = false
  ;
  ...
  @$pb.TagNumber(1)
  set document($132.Document v) { setField(1, v); }
  @$pb.TagNumber(1)
  ...
  @$pb.TagNumber(2)
  $433.DocumentMask get updateMask => $_getN(1);
  @$pb.TagNumber(2)
  set updateMask($433.DocumentMask v) { setField(2, v); }
  @$pb.TagNumber(2)
  $core.bool hasUpdateMask() => $_has(1);
  @$pb.TagNumber(2)
  void clearUpdateMask() => clearField(2);
  @$pb.TagNumber(2)
  $433.DocumentMask ensureUpdateMask() => $_ensure(1);
  ...
  ///  will not be returned in the response.
  @$pb.TagNumber(3)
  $433.DocumentMask get mask => $_getN(2);
  @$pb.TagNumber(3)
  set mask($433.DocumentMask v) { setField(3, v); }
  @$pb.TagNumber(3)
  $core.bool hasMask() => $_has(2);
  @$pb.TagNumber(3)
  void clearMask() => clearField(3);
  @$pb.TagNumber(3)
  $433.DocumentMask ensureMask() => $_ensure(2);

  /// An optional precondition on the document.
  /// The request will fail if this is set and not met by the target document.
  @$pb.TagNumber(4)
  $433.Precondition get currentDocument => $_getN(3);
  @$pb.TagNumber(4)
  set currentDocument($433.Precondition v) { setField(4, v); }
  @$pb.TagNumber(4)
  $core.bool hasCurrentDocument() => $_has(3);
  @$pb.TagNumber(4)
  void clearCurrentDocument() => clearField(4);
  @$pb.TagNumber(4)
  $433.Precondition ensureCurrentDocument() => $_ensure(3);
}
...
class DeleteDocumentRequest extends $pb.GeneratedMessage {
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(_omitMessageNames ? '' : 'DeleteDocumentRequest', package: const $pb.PackageName(_omitMessageNames ? '' : 'google.firestore.v1beta1'), createEmptyInstance: create)
    ..aOS(1, _omitFieldNames ? '' : 'name')
    ..aOM<$433.Precondition>(2, _omitFieldNames ? '' : 'currentDocument', subBuilder: $433.Precondition.create)
    ..hasRequiredFields = false
  ;
  ...
  /// The request will fail if this is set and not met by the target document.
  @$pb.TagNumber(2)
  $433.Precondition get currentDocument => $_getN(1);
  @$pb.TagNumber(2)
  set currentDocument($433.Precondition v) { setField(2, v); }
  @$pb.TagNumber(2)
  $core.bool hasCurrentDocument() => $_has(1);
  @$pb.TagNumber(2)
  void clearCurrentDocument() => clearField(2);
  @$pb.TagNumber(2)
  $433.Precondition ensureCurrentDocument() => $_ensure(1);
}
...
class BatchGetDocumentsRequest extends $pb.GeneratedMessage {
  factory BatchGetDocumentsRequest({
    ...
    $433.DocumentMask? mask,
    $core.List<$core.int>? transaction,
    $433.TransactionOptions? newTransaction,
    $301.Timestamp? readTime,
  }) {
    final $result = create();
    if (database != null) {
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(_omitMessageNames ? '' : 'BatchGetDocumentsRequest', package: const $pb.PackageName(_omitMessageNames ? '' : 'google.firestore.v1beta1'), createEmptyInstance: create)
    ..oo(0, [4, 5, 7])
    ...
    ..aOM<$433.TransactionOptions>(5, _omitFieldNames ? '' : 'newTransaction', subBuilder: $433.TransactionOptions.create)
    ..aOM<$301.Timestamp>(7, _omitFieldNames ? '' : 'readTime', subBuilder: $301.Timestamp.create)
    ..hasRequiredFields = false
  ;
  ...
  /// stream.
  @$pb.TagNumber(5)
  $433.TransactionOptions get newTransaction => $_getN(4);
  @$pb.TagNumber(5)
  set newTransaction($433.TransactionOptions v) { setField(5, v); }
  @$pb.TagNumber(5)
  $core.bool hasNewTransaction() => $_has(4);
  @$pb.TagNumber(5)
  void clearNewTransaction() => clearField(5);
  @$pb.TagNumber(5)
  $433.TransactionOptions ensureNewTransaction() => $_ensure(4);

  /// Reads documents as they were at the given time.
  /// This may not be older than 270 seconds.
  @$pb.TagNumber(7)
  $301.Timestamp get readTime => $_getN(5);
  @$pb.TagNumber(7)
  set readTime($301.Timestamp v) { setField(7, v); }
  @$pb.TagNumber(7)
  $core.bool hasReadTime() => $_has(5);
  @$pb.TagNumber(7)
  void clearReadTime() => clearField(7);
  @$pb.TagNumber(7)
  $301.Timestamp ensureReadTime() => $_ensure(5);
}
...
class BatchGetDocumentsResponse extends $pb.GeneratedMessage {
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(_omitMessageNames ? '' : 'BatchGetDocumentsResponse', package: const $pb.PackageName(_omitMessageNames ? '' : 'google.firestore.v1beta1'), createEmptyInstance: create)
    ..oo(0, [1, 2])
    ..aOM<$132.Document>(1, _omitFieldNames ? '' : 'found', subBuilder: $132.Document.create)
    ..aOS(2, _omitFieldNames ? '' : 'missing')
    ..a<$core.List<$core.int>>(3, _omitFieldNames ? '' : 'transaction', $pb.PbFieldType.OY)
    ..aOM<$301.Timestamp>(4, _omitFieldNames ? '' : 'readTime', subBuilder: $301.Timestamp.create)
    ..hasRequiredFields = false
  ;
  ...
  @$pb.TagNumber(1)
  $132.Document get found => $_getN(0);
  @$pb.TagNumber(1)
  set found($132.Document v) { setField(1, v); }
  @$pb.TagNumber(1)
  $core.bool hasFound() => $_has(0);
  @$pb.TagNumber(1)
  void clearFound() => clearField(1);
  @$pb.TagNumber(1)
  $132.Document ensureFound() => $_ensure(0);
  ...
  $301.Timestamp get readTime => $_getN(3);
  @$pb.TagNumber(4)
  set readTime($301.Timestamp v) { setField(4, v); }
  @$pb.TagNumber(4)
  $core.bool hasReadTime() => $_has(3);
  @$pb.TagNumber(4)
...
class BeginTransactionRequest extends $pb.GeneratedMessage {
  factory BeginTransactionRequest({
    $core.String? database,
    $433.TransactionOptions? options,
  }) {
    final $result = create();
    if (database != null) {
      $result.database = database;
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(_omitMessageNames ? '' : 'BeginTransactionRequest', package: const $pb.PackageName(_omitMessageNames ? '' : 'google.firestore.v1beta1'), createEmptyInstance: create)
    ..aOS(1, _omitFieldNames ? '' : 'database')
    ..aOM<$433.TransactionOptions>(2, _omitFieldNames ? '' : 'options', subBuilder: $433.TransactionOptions.create)
    ..hasRequiredFields = false
  ;
  ...
  @$pb.TagNumber(2)
  $433.TransactionOptions get options => $_getN(1);
  @$pb.TagNumber(2)
  set options($433.TransactionOptions v) { setField(2, v); }
  @$pb.TagNumber(2)
  $core.bool hasOptions() => $_has(1);
  @$pb.TagNumber(2)
  void clearOptions() => clearField(2);
  @$pb.TagNumber(2)
  $433.TransactionOptions ensureOptions() => $_ensure(1);
}
...
class BeginTransactionResponse extends $pb.GeneratedMessage {
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(_omitMessageNames ? '' : 'BeginTransactionResponse', package: const $pb.PackageName(_omitMessageNames ? '' : 'google.firestore.v1beta1'), createEmptyInstance: create)
...
class CommitRequest extends $pb.GeneratedMessage {
  factory CommitRequest({
    $core.String? database,
    $core.Iterable<$434.Write>? writes,
    $core.List<$core.int>? transaction,
  }) {
    final $result = create();
    if (database != null) {
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(_omitMessageNames ? '' : 'CommitRequest', package: const $pb.PackageName(_omitMessageNames ? '' : 'google.firestore.v1beta1'), createEmptyInstance: create)
    ..aOS(1, _omitFieldNames ? '' : 'database')
    ..pc<$434.Write>(2, _omitFieldNames ? '' : 'writes', $pb.PbFieldType.PM, subBuilder: $434.Write.create)
    ..a<$core.List<$core.int>>(3, _omitFieldNames ? '' : 'transaction', $pb.PbFieldType.OY)
    ..hasRequiredFields = false
  ;
  ...
  @$pb.TagNumber(2)
  $core.List<$434.Write> get writes => $_getList(1);
...
class CommitResponse extends $pb.GeneratedMessage {
  factory CommitResponse({
    $core.Iterable<$434.WriteResult>? writeResults,
    $301.Timestamp? commitTime,
  }) {
    final $result = create();
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(_omitMessageNames ? '' : 'CommitResponse', package: const $pb.PackageName(_omitMessageNames ? '' : 'google.firestore.v1beta1'), createEmptyInstance: create)
    ..pc<$434.WriteResult>(1, _omitFieldNames ? '' : 'writeResults', $pb.PbFieldType.PM, subBuilder: $434.WriteResult.create)
    ..aOM<$301.Timestamp>(2, _omitFieldNames ? '' : 'commitTime', subBuilder: $301.Timestamp.create)
    ..hasRequiredFields = false
  ;
  ...
  ///  request.
  @$pb.TagNumber(1)
  $core.List<$434.WriteResult> get writeResults => $_getList(0);

  /// The time at which the commit occurred. Any read with an equal or greater
  /// `read_time` is guaranteed to see the effects of the commit.
  @$pb.TagNumber(2)
  $301.Timestamp get commitTime => $_getN(1);
  @$pb.TagNumber(2)
  set commitTime($301.Timestamp v) { setField(2, v); }
  @$pb.TagNumber(2)
  $core.bool hasCommitTime() => $_has(1);
  @$pb.TagNumber(2)
  void clearCommitTime() => clearField(2);
  @$pb.TagNumber(2)
  $301.Timestamp ensureCommitTime() => $_ensure(1);
}
...
class RollbackRequest extends $pb.GeneratedMessage {
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(_omitMessageNames ? '' : 'RollbackRequest', package: const $pb.PackageName(_omitMessageNames ? '' : 'google.firestore.v1beta1'), createEmptyInstance: create)
    ..aOS(1, _omitFieldNames ? '' : 'database')
...
class RunQueryRequest extends $pb.GeneratedMessage {
  factory RunQueryRequest({
    $core.String? parent,
    $435.StructuredQuery? structuredQuery,
    $core.List<$core.int>? transaction,
    $433.TransactionOptions? newTransaction,
    $301.Timestamp? readTime,
  }) {
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(_omitMessageNames ? '' : 'RunQueryRequest', package: const $pb.PackageName(_omitMessageNames ? '' : 'google.firestore.v1beta1'), createEmptyInstance: create)
    ..oo(0, [2])
    ..oo(1, [5, 6, 7])
    ..aOS(1, _omitFieldNames ? '' : 'parent')
    ..aOM<$435.StructuredQuery>(2, _omitFieldNames ? '' : 'structuredQuery', subBuilder: $435.StructuredQuery.create)
    ..a<$core.List<$core.int>>(5, _omitFieldNames ? '' : 'transaction', $pb.PbFieldType.OY)
    ..aOM<$433.TransactionOptions>(6, _omitFieldNames ? '' : 'newTransaction', subBuilder: $433.TransactionOptions.create)
    ..aOM<$301.Timestamp>(7, _omitFieldNames ? '' : 'readTime', subBuilder: $301.Timestamp.create)
    ..hasRequiredFields = false
  ;
  ...
  /// A structured query.
  @$pb.TagNumber(2)
  $435.StructuredQuery get structuredQuery => $_getN(1);
  @$pb.TagNumber(2)
  set structuredQuery($435.StructuredQuery v) { setField(2, v); }
  @$pb.TagNumber(2)
  $core.bool hasStructuredQuery() => $_has(1);
  @$pb.TagNumber(2)
  void clearStructuredQuery() => clearField(2);
  @$pb.TagNumber(2)
  $435.StructuredQuery ensureStructuredQuery() => $_ensure(1);
  ...
  /// stream.
  @$pb.TagNumber(6)
  $433.TransactionOptions get newTransaction => $_getN(3);
  @$pb.TagNumber(6)
  set newTransaction($433.TransactionOptions v) { setField(6, v); }
  @$pb.TagNumber(6)
  $core.bool hasNewTransaction() => $_has(3);
  @$pb.TagNumber(6)
  void clearNewTransaction() => clearField(6);
  @$pb.TagNumber(6)
  $433.TransactionOptions ensureNewTransaction() => $_ensure(3);

  /// Reads documents as they were at the given time.
  /// This may not be older than 270 seconds.
  @$pb.TagNumber(7)
  $301.Timestamp get readTime => $_getN(4);
  @$pb.TagNumber(7)
  set readTime($301.Timestamp v) { setField(7, v); }
  @$pb.TagNumber(7)
  ...
  void clearReadTime() => clearField(7);
  @$pb.TagNumber(7)
  $301.Timestamp ensureReadTime() => $_ensure(4);
}
...
class RunQueryResponse extends $pb.GeneratedMessage {
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(_omitMessageNames ? '' : 'RunQueryResponse', package: const $pb.PackageName(_omitMessageNames ? '' : 'google.firestore.v1beta1'), createEmptyInstance: create)
    ..aOM<$132.Document>(1, _omitFieldNames ? '' : 'document', subBuilder: $132.Document.create)
    ..a<$core.List<$core.int>>(2, _omitFieldNames ? '' : 'transaction', $pb.PbFieldType.OY)
...
class PartitionQueryRequest extends $pb.GeneratedMessage {
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(_omitMessageNames ? '' : 'PartitionQueryRequest', package: const $pb.PackageName(_omitMessageNames ? '' : 'google.firestore.v1beta1'), createEmptyInstance: create)
    ..oo(0, [2])
    ..aOS(1, _omitFieldNames ? '' : 'parent')
    ..aOM<$435.StructuredQuery>(2, _omitFieldNames ? '' : 'structuredQuery', subBuilder: $435.StructuredQuery.create)
...
class PartitionQueryResponse extends $pb.GeneratedMessage {
  factory PartitionQueryResponse({
    $core.Iterable<$435.Cursor>? partitions,
    $core.String? nextPageToken,
  }) {
    final $result = create();
    if (partitions != null) {
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(_omitMessageNames ? '' : 'PartitionQueryResponse', package: const $pb.PackageName(_omitMessageNames ? '' : 'google.firestore.v1beta1'), createEmptyInstance: create)
    ..pc<$435.Cursor>(1, _omitFieldNames ? '' : 'partitions', $pb.PbFieldType.PM, subBuilder: $435.Cursor.create)
    ..aOS(2, _omitFieldNames ? '' : 'nextPageToken')
    ..hasRequiredFields = false
  ;
  ...
  ///  partitioned.
  @$pb.TagNumber(1)
  $core.List<$435.Cursor> get partitions => $_getList(0);
...
class WriteRequest extends $pb.GeneratedMessage {
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(_omitMessageNames ? '' : 'WriteRequest', package: const $pb.PackageName(_omitMessageNames ? '' : 'google.firestore.v1beta1'), createEmptyInstance: create)
    ..aOS(1, _omitFieldNames ? '' : 'database')
    ..aOS(2, _omitFieldNames ? '' : 'streamId')
    ..pc<$434.Write>(3, _omitFieldNames ? '' : 'writes', $pb.PbFieldType.PM, subBuilder: $434.Write.create)
    ..a<$core.List<$core.int>>(4, _omitFieldNames ? '' : 'streamToken', $pb.PbFieldType.OY)
    ..m<$core.String, $core.String>(5, _omitFieldNames ? '' : 'labels', entryClassName: 'WriteRequest.LabelsEntry', keyFieldType: $pb.PbFieldType.OS, valueFieldType: $pb.PbFieldType.OS, packageName: const $pb.PackageName('google.firestore.v1beta1'))
    ..hasRequiredFields = false
  ;
  ...
  @$pb.TagNumber(3)
  $core.List<$434.Write> get writes => $_getList(2);
...
class WriteResponse extends $pb.GeneratedMessage {
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(_omitMessageNames ? '' : 'WriteResponse', package: const $pb.PackageName(_omitMessageNames ? '' : 'google.firestore.v1beta1'), createEmptyInstance: create)
    ..aOS(1, _omitFieldNames ? '' : 'streamId')
    ..a<$core.List<$core.int>>(2, _omitFieldNames ? '' : 'streamToken', $pb.PbFieldType.OY)
    ..pc<$434.WriteResult>(3, _omitFieldNames ? '' : 'writeResults', $pb.PbFieldType.PM, subBuilder: $434.WriteResult.create)
    ..aOM<$301.Timestamp>(4, _omitFieldNames ? '' : 'commitTime', subBuilder: $301.Timestamp.create)
    ..hasRequiredFields = false
  ;
  ...
  ///  request.
  @$pb.TagNumber(3)
  $core.List<$434.WriteResult> get writeResults => $_getList(2);

  /// The time at which the commit occurred. Any read with an equal or greater
  /// `read_time` is guaranteed to see the effects of the write.
  @$pb.TagNumber(4)
  $301.Timestamp get commitTime => $_getN(3);
  @$pb.TagNumber(4)
  set commitTime($301.Timestamp v) { setField(4, v); }
  @$pb.TagNumber(4)
  $core.bool hasCommitTime() => $_has(3);
  @$pb.TagNumber(4)
  void clearCommitTime() => clearField(4);
  @$pb.TagNumber(4)
  $301.Timestamp ensureCommitTime() => $_ensure(3);
}
...
class ListenRequest extends $pb.GeneratedMessage {
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(_omitMessageNames ? '' : 'ListenRequest', package: const $pb.PackageName(_omitMessageNames ? '' : 'google.firestore.v1beta1'), createEmptyInstance: create)
    ..oo(0, [2, 3])
    ..aOS(1, _omitFieldNames ? '' : 'database')
    ...
    ..m<$core.String, $core.String>(4, _omitFieldNames ? '' : 'labels', entryClassName: 'ListenRequest.LabelsEntry', keyFieldType: $pb.PbFieldType.OS, valueFieldType: $pb.PbFieldType.OS, packageName: const $pb.PackageName('google.firestore.v1beta1'))
    ..hasRequiredFields = false
  ;
...
class ListenResponse extends $pb.GeneratedMessage {
  factory ListenResponse({
    ...
    $434.DocumentChange? documentChange,
    $434.DocumentDelete? documentDelete,
    $434.ExistenceFilter? filter,
    $434.DocumentRemove? documentRemove,
  }) {
    final $result = create();
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(_omitMessageNames ? '' : 'ListenResponse', package: const $pb.PackageName(_omitMessageNames ? '' : 'google.firestore.v1beta1'), createEmptyInstance: create)
    ..oo(0, [2, 3, 4, 5, 6])
    ..aOM<TargetChange>(2, _omitFieldNames ? '' : 'targetChange', subBuilder: TargetChange.create)
    ..aOM<$434.DocumentChange>(3, _omitFieldNames ? '' : 'documentChange', subBuilder: $434.DocumentChange.create)
    ..aOM<$434.DocumentDelete>(4, _omitFieldNames ? '' : 'documentDelete', subBuilder: $434.DocumentDelete.create)
    ..aOM<$434.ExistenceFilter>(5, _omitFieldNames ? '' : 'filter', subBuilder: $434.ExistenceFilter.create)
    ..aOM<$434.DocumentRemove>(6, _omitFieldNames ? '' : 'documentRemove', subBuilder: $434.DocumentRemove.create)
    ..hasRequiredFields = false
  ;
  ...
  @$pb.TagNumber(3)
  $434.DocumentChange get documentChange => $_getN(1);
  @$pb.TagNumber(3)
  set documentChange($434.DocumentChange v) { setField(3, v); }
  @$pb.TagNumber(3)
  $core.bool hasDocumentChange() => $_has(1);
  @$pb.TagNumber(3)
  void clearDocumentChange() => clearField(3);
  @$pb.TagNumber(3)
  $434.DocumentChange ensureDocumentChange() => $_ensure(1);

  /// A [Document][google.firestore.v1beta1.Document] has been deleted.
  @$pb.TagNumber(4)
  $434.DocumentDelete get documentDelete => $_getN(2);
  @$pb.TagNumber(4)
  set documentDelete($434.DocumentDelete v) { setField(4, v); }
  @$pb.TagNumber(4)
  $core.bool hasDocumentDelete() => $_has(2);
  @$pb.TagNumber(4)
  void clearDocumentDelete() => clearField(4);
  @$pb.TagNumber(4)
  $434.DocumentDelete ensureDocumentDelete() => $_ensure(2);
  ...
  @$pb.TagNumber(5)
  $434.ExistenceFilter get filter => $_getN(3);
  @$pb.TagNumber(5)
  set filter($434.ExistenceFilter v) { setField(5, v); }
  @$pb.TagNumber(5)
  $core.bool hasFilter() => $_has(3);
  @$pb.TagNumber(5)
  void clearFilter() => clearField(5);
  @$pb.TagNumber(5)
  $434.ExistenceFilter ensureFilter() => $_ensure(3);

  /// A [Document][google.firestore.v1beta1.Document] has been removed from a target (because it is no longer
  /// relevant to that target).
  @$pb.TagNumber(6)
  $434.DocumentRemove get documentRemove => $_getN(4);
  @$pb.TagNumber(6)
  set documentRemove($434.DocumentRemove v) { setField(6, v); }
  @$pb.TagNumber(6)
  $core.bool hasDocumentRemove() => $_has(4);
  @$pb.TagNumber(6)
  void clearDocumentRemove() => clearField(6);
  @$pb.TagNumber(6)
  $434.DocumentRemove ensureDocumentRemove() => $_ensure(4);
}
...
class Target_DocumentsTarget extends $pb.GeneratedMessage {
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(_omitMessageNames ? '' : 'Target.DocumentsTarget', package: const $pb.PackageName(_omitMessageNames ? '' : 'google.firestore.v1beta1'), createEmptyInstance: create)
    ..pPS(2, _omitFieldNames ? '' : 'documents')
    ..hasRequiredFields = false
  ;
...
class Target_QueryTarget extends $pb.GeneratedMessage {
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(_omitMessageNames ? '' : 'Target.QueryTarget', package: const $pb.PackageName(_omitMessageNames ? '' : 'google.firestore.v1beta1'), createEmptyInstance: create)
    ..oo(0, [2])
    ..aOS(1, _omitFieldNames ? '' : 'parent')
    ..aOM<$435.StructuredQuery>(2, _omitFieldNames ? '' : 'structuredQuery', subBuilder: $435.StructuredQuery.create)
    ..hasRequiredFields = false
...
class Target extends $pb.GeneratedMessage {
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(_omitMessageNames ? '' : 'Target', package: const $pb.PackageName(_omitMessageNames ? '' : 'google.firestore.v1beta1'), createEmptyInstance: create)
    ..oo(0, [2, 3])
    ..oo(1, [4, 11])
    ...
    ..aOM<$301.Timestamp>(11, _omitFieldNames ? '' : 'readTime', subBuilder: $301.Timestamp.create)
    ..hasRequiredFields = false
  ;
  ...
  $301.Timestamp get readTime => $_getN(5);
  @$pb.TagNumber(11)
  set readTime($301.Timestamp v) { setField(11, v); }
  @$pb.TagNumber(11)
  $core.bool hasReadTime() => $_has(5);
  @$pb.TagNumber(11)
...
class TargetChange extends $pb.GeneratedMessage {
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(_omitMessageNames ? '' : 'TargetChange', package: const $pb.PackageName(_omitMessageNames ? '' : 'google.firestore.v1beta1'), createEmptyInstance: create)
    ...
    ..aOM<$321.Status>(3, _omitFieldNames ? '' : 'cause', subBuilder: $321.Status.create)
    ..a<$core.List<$core.int>>(4, _omitFieldNames ? '' : 'resumeToken', $pb.PbFieldType.OY)
    ..aOM<$301.Timestamp>(6, _omitFieldNames ? '' : 'readTime', subBuilder: $301.Timestamp.create)
    ..hasRequiredFields = false
  ;
  ...
  @$pb.TagNumber(3)
  $321.Status get cause => $_getN(2);
  @$pb.TagNumber(3)
  set cause($321.Status v) { setField(3, v); }
  @$pb.TagNumber(3)
  $core.bool hasCause() => $_has(2);
  @$pb.TagNumber(3)
  void clearCause() => clearField(3);
  @$pb.TagNumber(3)
  $321.Status ensureCause() => $_ensure(2);
  ...
  $301.Timestamp get readTime => $_getN(4);
  @$pb.TagNumber(6)
  set readTime($301.Timestamp v) { setField(6, v); }
  @$pb.TagNumber(6)
  $core.bool hasReadTime() => $_has(4);
  @$pb.TagNumber(6)
...
class ListCollectionIdsRequest extends $pb.GeneratedMessage {
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(_omitMessageNames ? '' : 'ListCollectionIdsRequest', package: const $pb.PackageName(_omitMessageNames ? '' : 'google.firestore.v1beta1'), createEmptyInstance: create)
    ..aOS(1, _omitFieldNames ? '' : 'parent')
...
class ListCollectionIdsResponse extends $pb.GeneratedMessage {
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(_omitMessageNames ? '' : 'ListCollectionIdsResponse', package: const $pb.PackageName(_omitMessageNames ? '' : 'google.firestore.v1beta1'), createEmptyInstance: create)
...
class BatchWriteRequest extends $pb.GeneratedMessage {
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(_omitMessageNames ? '' : 'BatchWriteRequest', package: const $pb.PackageName(_omitMessageNames ? '' : 'google.firestore.v1beta1'), createEmptyInstance: create)
    ..aOS(1, _omitFieldNames ? '' : 'database')
    ..pc<$434.Write>(2, _omitFieldNames ? '' : 'writes', $pb.PbFieldType.PM, subBuilder: $434.Write.create)
    ..m<$core.String, $core.String>(3, _omitFieldNames ? '' : 'labels', entryClassName: 'BatchWriteRequest.LabelsEntry', keyFieldType: $pb.PbFieldType.OS, valueFieldType: $pb.PbFieldType.OS, packageName: const $pb.PackageName('google.firestore.v1beta1'))
    ..hasRequiredFields = false
  ;
...
class BatchWriteResponse extends $pb.GeneratedMessage {
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(_omitMessageNames ? '' : 'BatchWriteResponse', package: const $pb.PackageName(_omitMessageNames ? '' : 'google.firestore.v1beta1'), createEmptyInstance: create)
    ..pc<$434.WriteResult>(1, _omitFieldNames ? '' : 'writeResults', $pb.PbFieldType.PM, subBuilder: $434.WriteResult.create)
    ..pc<$321.Status>(2, _omitFieldNames ? '' : 'status', $pb.PbFieldType.PM, subBuilder: $321.Status.create)
    ..hasRequiredFields = false
  ;
  ...
  ///  request.
  @$pb.TagNumber(2)
  $core.List<$321.Status> get status => $_getList(1);
}
