...
import 'common.pb.dart' as $4781;
import 'document.pb.dart' as $1610;
import 'firestore.pbenum.dart';
import 'query.pb.dart' as $4783;
import 'write.pb.dart' as $4782;
...
class GetDocumentRequest extends $pb.GeneratedMessage {
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(_omitMessageNames ? '' : 'GetDocumentRequest', package: const $pb.PackageName(_omitMessageNames ? '' : 'google.firestore.v1beta1'), createEmptyInstance: create)
    ...
    ..aOM<$4781.DocumentMask>(2, _omitFieldNames ? '' : 'mask', subBuilder: $4781.DocumentMask.create)
  ...
  @$pb.TagNumber(2)
  $4781.DocumentMask get mask => $_getN(1);
  @$pb.TagNumber(2)
  set mask($4781.DocumentMask v) { setField(2, v); }
  @$pb.TagNumber(2)
  $core.bool hasMask() => $_has(1);
  @$pb.TagNumber(2)
  void clearMask() => clearField(2);
  @$pb.TagNumber(2)
  $4781.DocumentMask ensureMask() => $_ensure(1);
...
class ListDocumentsRequest extends $pb.GeneratedMessage {
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(_omitMessageNames ? '' : 'ListDocumentsRequest', package: const $pb.PackageName(_omitMessageNames ? '' : 'google.firestore.v1beta1'), createEmptyInstance: create)
    ...
    ..aOM<$4781.DocumentMask>(7, _omitFieldNames ? '' : 'mask', subBuilder: $4781.DocumentMask.create)
    ..a<$core.List<$core.int>>(8, _omitFieldNames ? '' : 'transaction', $pb.PbFieldType.OY)
    ..aOM<$1775.Timestamp>(10, _omitFieldNames ? '' : 'readTime', subBuilder: $1775.Timestamp.create)
  ...
  ///  will not be returned in the response.
  @$pb.TagNumber(7)
  $4781.DocumentMask get mask => $_getN(5);
  @$pb.TagNumber(7)
  set mask($4781.DocumentMask v) { setField(7, v); }
  @$pb.TagNumber(7)
  $core.bool hasMask() => $_has(5);
  @$pb.TagNumber(7)
  void clearMask() => clearField(7);
  @$pb.TagNumber(7)
  $4781.DocumentMask ensureMask() => $_ensure(5);
  ...
  @$pb.TagNumber(10)
  set readTime($1775.Timestamp v) { setField(10, v); }
  @$pb.TagNumber(10)
...
class ListDocumentsResponse extends $pb.GeneratedMessage {
  factory ListDocumentsResponse({
    $core.Iterable<$1610.Document>? documents,
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(_omitMessageNames ? '' : 'ListDocumentsResponse', package: const $pb.PackageName(_omitMessageNames ? '' : 'google.firestore.v1beta1'), createEmptyInstance: create)
    ..pc<$1610.Document>(1, _omitFieldNames ? '' : 'documents', $pb.PbFieldType.PM, subBuilder: $1610.Document.create)
  ...
  /// The Documents found.
  @$pb.TagNumber(1)
  $core.List<$1610.Document> get documents => $_getList(0);
...
class CreateDocumentRequest extends $pb.GeneratedMessage {
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(_omitMessageNames ? '' : 'CreateDocumentRequest', package: const $pb.PackageName(_omitMessageNames ? '' : 'google.firestore.v1beta1'), createEmptyInstance: create)
    ...
    ..aOM<$1610.Document>(4, _omitFieldNames ? '' : 'document', subBuilder: $1610.Document.create)
    ..aOM<$4781.DocumentMask>(5, _omitFieldNames ? '' : 'mask', subBuilder: $4781.DocumentMask.create)
    ..hasRequiredFields = false
  ;
  ...
  @$pb.TagNumber(4)
  $1610.Document get document => $_getN(3);
  @$pb.TagNumber(4)
  set document($1610.Document v) { setField(4, v); }
  @$pb.TagNumber(4)
  $core.bool hasDocument() => $_has(3);
  @$pb.TagNumber(4)
  void clearDocument() => clearField(4);
  @$pb.TagNumber(4)
  $1610.Document ensureDocument() => $_ensure(3);
  ...
  ///  will not be returned in the response.
  @$pb.TagNumber(5)
  $4781.DocumentMask get mask => $_getN(4);
  @$pb.TagNumber(5)
  set mask($4781.DocumentMask v) { setField(5, v); }
  @$pb.TagNumber(5)
  $core.bool hasMask() => $_has(4);
  @$pb.TagNumber(5)
  void clearMask() => clearField(5);
  @$pb.TagNumber(5)
  $4781.DocumentMask ensureMask() => $_ensure(4);
}
...
class UpdateDocumentRequest extends $pb.GeneratedMessage {
  factory UpdateDocumentRequest({
    $1610.Document? document,
    $4781.DocumentMask? updateMask,
    $4781.DocumentMask? mask,
    $4781.Precondition? currentDocument,
  }) {
    final $result = create();
    if (document != null) {
      $result.document = document;
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(_omitMessageNames ? '' : 'UpdateDocumentRequest', package: const $pb.PackageName(_omitMessageNames ? '' : 'google.firestore.v1beta1'), createEmptyInstance: create)
    ..aOM<$1610.Document>(1, _omitFieldNames ? '' : 'document', subBuilder: $1610.Document.create)
    ..aOM<$4781.DocumentMask>(2, _omitFieldNames ? '' : 'updateMask', subBuilder: $4781.DocumentMask.create)
    ..aOM<$4781.DocumentMask>(3, _omitFieldNames ? '' : 'mask', subBuilder: $4781.DocumentMask.create)
    ..aOM<$4781.Precondition>(4, _omitFieldNames ? '' : 'currentDocument', subBuilder: $4781.Precondition.create)
    ..hasRequiredFields = false
  ;
  ...
  @$pb.TagNumber(1)
  $1610.Document get document => $_getN(0);
  @$pb.TagNumber(1)
  set document($1610.Document v) { setField(1, v); }
  @$pb.TagNumber(1)
  $core.bool hasDocument() => $_has(0);
  @$pb.TagNumber(1)
  void clearDocument() => clearField(1);
  @$pb.TagNumber(1)
  $1610.Document ensureDocument() => $_ensure(0);
  ...
  @$pb.TagNumber(2)
  $4781.DocumentMask get updateMask => $_getN(1);
  @$pb.TagNumber(2)
  set updateMask($4781.DocumentMask v) { setField(2, v); }
  @$pb.TagNumber(2)
  $core.bool hasUpdateMask() => $_has(1);
  @$pb.TagNumber(2)
  void clearUpdateMask() => clearField(2);
  @$pb.TagNumber(2)
  $4781.DocumentMask ensureUpdateMask() => $_ensure(1);
  ...
  ///  will not be returned in the response.
  @$pb.TagNumber(3)
  $4781.DocumentMask get mask => $_getN(2);
  @$pb.TagNumber(3)
  set mask($4781.DocumentMask v) { setField(3, v); }
  @$pb.TagNumber(3)
  $core.bool hasMask() => $_has(2);
  @$pb.TagNumber(3)
  void clearMask() => clearField(3);
  @$pb.TagNumber(3)
  $4781.DocumentMask ensureMask() => $_ensure(2);

  /// An optional precondition on the document.
  /// The request will fail if this is set and not met by the target document.
  @$pb.TagNumber(4)
  $4781.Precondition get currentDocument => $_getN(3);
  @$pb.TagNumber(4)
  set currentDocument($4781.Precondition v) { setField(4, v); }
  @$pb.TagNumber(4)
  $core.bool hasCurrentDocument() => $_has(3);
  @$pb.TagNumber(4)
  void clearCurrentDocument() => clearField(4);
  @$pb.TagNumber(4)
  $4781.Precondition ensureCurrentDocument() => $_ensure(3);
}
...
class DeleteDocumentRequest extends $pb.GeneratedMessage {
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(_omitMessageNames ? '' : 'DeleteDocumentRequest', package: const $pb.PackageName(_omitMessageNames ? '' : 'google.firestore.v1beta1'), createEmptyInstance: create)
    ..aOS(1, _omitFieldNames ? '' : 'name')
    ..aOM<$4781.Precondition>(2, _omitFieldNames ? '' : 'currentDocument', subBuilder: $4781.Precondition.create)
    ..hasRequiredFields = false
  ;
  ...
  /// The request will fail if this is set and not met by the target document.
  @$pb.TagNumber(2)
  $4781.Precondition get currentDocument => $_getN(1);
  @$pb.TagNumber(2)
  set currentDocument($4781.Precondition v) { setField(2, v); }
  @$pb.TagNumber(2)
  $core.bool hasCurrentDocument() => $_has(1);
  @$pb.TagNumber(2)
  void clearCurrentDocument() => clearField(2);
  @$pb.TagNumber(2)
  $4781.Precondition ensureCurrentDocument() => $_ensure(1);
}
...
class BatchGetDocumentsRequest extends $pb.GeneratedMessage {
  factory BatchGetDocumentsRequest({
    ...
    $4781.DocumentMask? mask,
    $core.List<$core.int>? transaction,
    $4781.TransactionOptions? newTransaction,
    $1775.Timestamp? readTime,
  }) {
    final $result = create();
    if (database != null) {
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(_omitMessageNames ? '' : 'BatchGetDocumentsRequest', package: const $pb.PackageName(_omitMessageNames ? '' : 'google.firestore.v1beta1'), createEmptyInstance: create)
    ...
    ..aOM<$4781.TransactionOptions>(5, _omitFieldNames ? '' : 'newTransaction', subBuilder: $4781.TransactionOptions.create)
  ...
  /// stream.
  @$pb.TagNumber(5)
  $4781.TransactionOptions get newTransaction => $_getN(4);
  @$pb.TagNumber(5)
  set newTransaction($4781.TransactionOptions v) { setField(5, v); }
  @$pb.TagNumber(5)
  $core.bool hasNewTransaction() => $_has(4);
  @$pb.TagNumber(5)
  void clearNewTransaction() => clearField(5);
  @$pb.TagNumber(5)
  $4781.TransactionOptions ensureNewTransaction() => $_ensure(4);

  /// Reads documents as they were at the given time.
  /// This may not be older than 270 seconds.
  @$pb.TagNumber(7)
  $1775.Timestamp get readTime => $_getN(5);
  @$pb.TagNumber(7)
  ...
  @$pb.TagNumber(7)
  $1775.Timestamp ensureReadTime() => $_ensure(5);
}
...
class BatchGetDocumentsResponse extends $pb.GeneratedMessage {
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(_omitMessageNames ? '' : 'BatchGetDocumentsResponse', package: const $pb.PackageName(_omitMessageNames ? '' : 'google.firestore.v1beta1'), createEmptyInstance: create)
    ..oo(0, [1, 2])
    ..aOM<$1610.Document>(1, _omitFieldNames ? '' : 'found', subBuilder: $1610.Document.create)
  ...
  @$pb.TagNumber(1)
  $1610.Document get found => $_getN(0);
  @$pb.TagNumber(1)
  set found($1610.Document v) { setField(1, v); }
  @$pb.TagNumber(1)
  $core.bool hasFound() => $_has(0);
  @$pb.TagNumber(1)
  void clearFound() => clearField(1);
  @$pb.TagNumber(1)
  $1610.Document ensureFound() => $_ensure(0);
...
class BeginTransactionRequest extends $pb.GeneratedMessage {
  factory BeginTransactionRequest({
    $core.String? database,
    $4781.TransactionOptions? options,
  }) {
    final $result = create();
    if (database != null) {
      $result.database = database;
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(_omitMessageNames ? '' : 'BeginTransactionRequest', package: const $pb.PackageName(_omitMessageNames ? '' : 'google.firestore.v1beta1'), createEmptyInstance: create)
    ..aOS(1, _omitFieldNames ? '' : 'database')
    ..aOM<$4781.TransactionOptions>(2, _omitFieldNames ? '' : 'options', subBuilder: $4781.TransactionOptions.create)
    ..hasRequiredFields = false
  ;
  ...
  @$pb.TagNumber(2)
  $4781.TransactionOptions get options => $_getN(1);
  @$pb.TagNumber(2)
  set options($4781.TransactionOptions v) { setField(2, v); }
  @$pb.TagNumber(2)
  $core.bool hasOptions() => $_has(1);
  @$pb.TagNumber(2)
  void clearOptions() => clearField(2);
  @$pb.TagNumber(2)
  $4781.TransactionOptions ensureOptions() => $_ensure(1);
}
...
class CommitRequest extends $pb.GeneratedMessage {
  factory CommitRequest({
    $core.String? database,
    $core.Iterable<$4782.Write>? writes,
    $core.List<$core.int>? transaction,
  }) {
    final $result = create();
    if (database != null) {
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(_omitMessageNames ? '' : 'CommitRequest', package: const $pb.PackageName(_omitMessageNames ? '' : 'google.firestore.v1beta1'), createEmptyInstance: create)
    ..aOS(1, _omitFieldNames ? '' : 'database')
    ..pc<$4782.Write>(2, _omitFieldNames ? '' : 'writes', $pb.PbFieldType.PM, subBuilder: $4782.Write.create)
    ..a<$core.List<$core.int>>(3, _omitFieldNames ? '' : 'transaction', $pb.PbFieldType.OY)
    ..hasRequiredFields = false
  ;
  ...
  @$pb.TagNumber(2)
  $core.List<$4782.Write> get writes => $_getList(1);
...
class CommitResponse extends $pb.GeneratedMessage {
  factory CommitResponse({
    $core.Iterable<$4782.WriteResult>? writeResults,
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(_omitMessageNames ? '' : 'CommitResponse', package: const $pb.PackageName(_omitMessageNames ? '' : 'google.firestore.v1beta1'), createEmptyInstance: create)
    ..pc<$4782.WriteResult>(1, _omitFieldNames ? '' : 'writeResults', $pb.PbFieldType.PM, subBuilder: $4782.WriteResult.create)
  ...
  ///  request.
  @$pb.TagNumber(1)
  $core.List<$4782.WriteResult> get writeResults => $_getList(0);
...
class RunQueryRequest extends $pb.GeneratedMessage {
  factory RunQueryRequest({
    $core.String? parent,
    $4783.StructuredQuery? structuredQuery,
    $core.List<$core.int>? transaction,
    $4781.TransactionOptions? newTransaction,
    $1775.Timestamp? readTime,
  }) {
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(_omitMessageNames ? '' : 'RunQueryRequest', package: const $pb.PackageName(_omitMessageNames ? '' : 'google.firestore.v1beta1'), createEmptyInstance: create)
    ...
    ..oo(1, [5, 6, 7])
    ..aOS(1, _omitFieldNames ? '' : 'parent')
    ..aOM<$4783.StructuredQuery>(2, _omitFieldNames ? '' : 'structuredQuery', subBuilder: $4783.StructuredQuery.create)
    ..a<$core.List<$core.int>>(5, _omitFieldNames ? '' : 'transaction', $pb.PbFieldType.OY)
    ..aOM<$4781.TransactionOptions>(6, _omitFieldNames ? '' : 'newTransaction', subBuilder: $4781.TransactionOptions.create)
    ..aOM<$1775.Timestamp>(7, _omitFieldNames ? '' : 'readTime', subBuilder: $1775.Timestamp.create)
    ..hasRequiredFields = false
  ;
  ...
  /// A structured query.
  @$pb.TagNumber(2)
  $4783.StructuredQuery get structuredQuery => $_getN(1);
  @$pb.TagNumber(2)
  set structuredQuery($4783.StructuredQuery v) { setField(2, v); }
  @$pb.TagNumber(2)
  $core.bool hasStructuredQuery() => $_has(1);
  @$pb.TagNumber(2)
  void clearStructuredQuery() => clearField(2);
  @$pb.TagNumber(2)
  $4783.StructuredQuery ensureStructuredQuery() => $_ensure(1);
  ...
  /// stream.
  @$pb.TagNumber(6)
  $4781.TransactionOptions get newTransaction => $_getN(3);
  @$pb.TagNumber(6)
  set newTransaction($4781.TransactionOptions v) { setField(6, v); }
  @$pb.TagNumber(6)
  $core.bool hasNewTransaction() => $_has(3);
  @$pb.TagNumber(6)
  void clearNewTransaction() => clearField(6);
  @$pb.TagNumber(6)
  $4781.TransactionOptions ensureNewTransaction() => $_ensure(3);
...
class RunQueryResponse extends $pb.GeneratedMessage {
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(_omitMessageNames ? '' : 'RunQueryResponse', package: const $pb.PackageName(_omitMessageNames ? '' : 'google.firestore.v1beta1'), createEmptyInstance: create)
    ..aOM<$1610.Document>(1, _omitFieldNames ? '' : 'document', subBuilder: $1610.Document.create)
    ..a<$core.List<$core.int>>(2, _omitFieldNames ? '' : 'transaction', $pb.PbFieldType.OY)
    ..aOM<$1775.Timestamp>(3, _omitFieldNames ? '' : 'readTime', subBuilder: $1775.Timestamp.create)
  ...
  @$pb.TagNumber(3)
  set readTime($1775.Timestamp v) { setField(3, v); }
  @$pb.TagNumber(3)
...
class PartitionQueryResponse extends $pb.GeneratedMessage {
  factory PartitionQueryResponse({
    $core.Iterable<$4783.Cursor>? partitions,
    $core.String? nextPageToken,
  }) {
    final $result = create();
    if (partitions != null) {
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(_omitMessageNames ? '' : 'PartitionQueryResponse', package: const $pb.PackageName(_omitMessageNames ? '' : 'google.firestore.v1beta1'), createEmptyInstance: create)
    ..pc<$4783.Cursor>(1, _omitFieldNames ? '' : 'partitions', $pb.PbFieldType.PM, subBuilder: $4783.Cursor.create)
    ..aOS(2, _omitFieldNames ? '' : 'nextPageToken')
    ..hasRequiredFields = false
  ;
  ...
  ///  partitioned.
  @$pb.TagNumber(1)
  $core.List<$4783.Cursor> get partitions => $_getList(0);
...
class WriteRequest extends $pb.GeneratedMessage {
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(_omitMessageNames ? '' : 'WriteRequest', package: const $pb.PackageName(_omitMessageNames ? '' : 'google.firestore.v1beta1'), createEmptyInstance: create)
    ...
    ..pc<$4782.Write>(3, _omitFieldNames ? '' : 'writes', $pb.PbFieldType.PM, subBuilder: $4782.Write.create)
  ...
  @$pb.TagNumber(3)
  $core.List<$4782.Write> get writes => $_getList(2);
...
class WriteResponse extends $pb.GeneratedMessage {
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(_omitMessageNames ? '' : 'WriteResponse', package: const $pb.PackageName(_omitMessageNames ? '' : 'google.firestore.v1beta1'), createEmptyInstance: create)
    ...
    ..pc<$4782.WriteResult>(3, _omitFieldNames ? '' : 'writeResults', $pb.PbFieldType.PM, subBuilder: $4782.WriteResult.create)
  ...
  ///  request.
  @$pb.TagNumber(3)
  $core.List<$4782.WriteResult> get writeResults => $_getList(2);
...
class ListenResponse extends $pb.GeneratedMessage {
  factory ListenResponse({
    ...
    $4782.DocumentChange? documentChange,
    $4782.DocumentDelete? documentDelete,
    $4782.ExistenceFilter? filter,
    $4782.DocumentRemove? documentRemove,
  }) {
    final $result = create();
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(_omitMessageNames ? '' : 'ListenResponse', package: const $pb.PackageName(_omitMessageNames ? '' : 'google.firestore.v1beta1'), createEmptyInstance: create)
    ...
    ..aOM<$4782.DocumentChange>(3, _omitFieldNames ? '' : 'documentChange', subBuilder: $4782.DocumentChange.create)
    ..aOM<$4782.DocumentDelete>(4, _omitFieldNames ? '' : 'documentDelete', subBuilder: $4782.DocumentDelete.create)
    ..aOM<$4782.ExistenceFilter>(5, _omitFieldNames ? '' : 'filter', subBuilder: $4782.ExistenceFilter.create)
    ..aOM<$4782.DocumentRemove>(6, _omitFieldNames ? '' : 'documentRemove', subBuilder: $4782.DocumentRemove.create)
    ..hasRequiredFields = false
  ;
  ...
  @$pb.TagNumber(3)
  $4782.DocumentChange get documentChange => $_getN(1);
  @$pb.TagNumber(3)
  set documentChange($4782.DocumentChange v) { setField(3, v); }
  @$pb.TagNumber(3)
  $core.bool hasDocumentChange() => $_has(1);
  @$pb.TagNumber(3)
  void clearDocumentChange() => clearField(3);
  @$pb.TagNumber(3)
  $4782.DocumentChange ensureDocumentChange() => $_ensure(1);

  /// A [Document][google.firestore.v1beta1.Document] has been deleted.
  @$pb.TagNumber(4)
  $4782.DocumentDelete get documentDelete => $_getN(2);
  @$pb.TagNumber(4)
  set documentDelete($4782.DocumentDelete v) { setField(4, v); }
  @$pb.TagNumber(4)
  $core.bool hasDocumentDelete() => $_has(2);
  @$pb.TagNumber(4)
  void clearDocumentDelete() => clearField(4);
  @$pb.TagNumber(4)
  $4782.DocumentDelete ensureDocumentDelete() => $_ensure(2);
  ...
  @$pb.TagNumber(5)
  $4782.ExistenceFilter get filter => $_getN(3);
  @$pb.TagNumber(5)
  set filter($4782.ExistenceFilter v) { setField(5, v); }
  @$pb.TagNumber(5)
  $core.bool hasFilter() => $_has(3);
  @$pb.TagNumber(5)
  void clearFilter() => clearField(5);
  @$pb.TagNumber(5)
  $4782.ExistenceFilter ensureFilter() => $_ensure(3);

  /// A [Document][google.firestore.v1beta1.Document] has been removed from a target (because it is no longer
  /// relevant to that target).
  @$pb.TagNumber(6)
  $4782.DocumentRemove get documentRemove => $_getN(4);
  @$pb.TagNumber(6)
  set documentRemove($4782.DocumentRemove v) { setField(6, v); }
  @$pb.TagNumber(6)
  $core.bool hasDocumentRemove() => $_has(4);
  @$pb.TagNumber(6)
  void clearDocumentRemove() => clearField(6);
  @$pb.TagNumber(6)
  $4782.DocumentRemove ensureDocumentRemove() => $_ensure(4);
}
...
class Target extends $pb.GeneratedMessage {
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(_omitMessageNames ? '' : 'Target', package: const $pb.PackageName(_omitMessageNames ? '' : 'google.firestore.v1beta1'), createEmptyInstance: create)
    ...
    ..aOM<$1775.Timestamp>(11, _omitFieldNames ? '' : 'readTime', subBuilder: $1775.Timestamp.create)
    ..hasRequiredFields = false
  ;
  ...
  $1775.Timestamp get readTime => $_getN(5);
  @$pb.TagNumber(11)
  set readTime($1775.Timestamp v) { setField(11, v); }
  @$pb.TagNumber(11)
  $core.bool hasReadTime() => $_has(5);
  @$pb.TagNumber(11)
...
class TargetChange extends $pb.GeneratedMessage {
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(_omitMessageNames ? '' : 'TargetChange', package: const $pb.PackageName(_omitMessageNames ? '' : 'google.firestore.v1beta1'), createEmptyInstance: create)
    ...
    ..aOM<$1795.Status>(3, _omitFieldNames ? '' : 'cause', subBuilder: $1795.Status.create)
    ..a<$core.List<$core.int>>(4, _omitFieldNames ? '' : 'resumeToken', $pb.PbFieldType.OY)
    ..aOM<$1775.Timestamp>(6, _omitFieldNames ? '' : 'readTime', subBuilder: $1775.Timestamp.create)
    ..hasRequiredFields = false
  ;
  ...
  @$pb.TagNumber(3)
  $1795.Status get cause => $_getN(2);
  @$pb.TagNumber(3)
  set cause($1795.Status v) { setField(3, v); }
  @$pb.TagNumber(3)
  $core.bool hasCause() => $_has(2);
  @$pb.TagNumber(3)
  void clearCause() => clearField(3);
  @$pb.TagNumber(3)
  $1795.Status ensureCause() => $_ensure(2);
  ...
  $1775.Timestamp get readTime => $_getN(4);
  @$pb.TagNumber(6)
  set readTime($1775.Timestamp v) { setField(6, v); }
  @$pb.TagNumber(6)
  $core.bool hasReadTime() => $_has(4);
  @$pb.TagNumber(6)
...
class BatchWriteResponse extends $pb.GeneratedMessage {
  factory BatchWriteResponse({
    $core.Iterable<$4782.WriteResult>? writeResults,
    $core.Iterable<$1795.Status>? status,
  }) {
    final $result = create();
    if (writeResults != null) {
      $result.writeResults.addAll(writeResults);
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(_omitMessageNames ? '' : 'BatchWriteResponse', package: const $pb.PackageName(_omitMessageNames ? '' : 'google.firestore.v1beta1'), createEmptyInstance: create)
    ..pc<$4782.WriteResult>(1, _omitFieldNames ? '' : 'writeResults', $pb.PbFieldType.PM, subBuilder: $4782.WriteResult.create)
    ..pc<$1795.Status>(2, _omitFieldNames ? '' : 'status', $pb.PbFieldType.PM, subBuilder: $1795.Status.create)
    ..hasRequiredFields = false
  ;
  ...
  ///  request.
  @$pb.TagNumber(2)
  $core.List<$1795.Status> get status => $_getList(1);
}
