...
class FeatureFlags extends $pb.GeneratedMessage {
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(_omitMessageNames ? '' : 'FeatureFlags', package: const $pb.PackageName(_omitMessageNames ? '' : 'google.bigtable.v2'), createEmptyInstance: create)
  ...
  'Will be removed in next major version')
  FeatureFlags copyWith(void Function(FeatureFlags) updates) => super.copyWith((message) => updates(message as FeatureFlags)) as FeatureFlags;
  ...
  @$pb.TagNumber(1)
  set reverseScans($core.bool v) { $_setBool(0, v); }
  @$pb.TagNumber(1)
  ...
  @$pb.TagNumber(3)
  set mutateRowsRateLimit($core.bool v) { $_setBool(1, v); }
  @$pb.TagNumber(3)
  ...
  @$pb.TagNumber(4)
  set lastScannedRowResponses($core.bool v) { $_setBool(2, v); }
  @$pb.TagNumber(4)
  ...
  @$pb.TagNumber(5)
  set mutateRowsRateLimit2($core.bool v) { $_setBool(3, v); }
  @$pb.TagNumber(5)
  ...
  @$pb.TagNumber(6)
  set routingCookie($core.bool v) { $_setBool(4, v); }
  @$pb.TagNumber(6)
  ...
  @$pb.TagNumber(7)
  set retryInfo($core.bool v) { $_setBool(5, v); }
  @$pb.TagNumber(7)
  ...
  @$pb.TagNumber(8)
  set clientSideMetricsEnabled($core.bool v) { $_setBool(6, v); }
  @$pb.TagNumber(8)
