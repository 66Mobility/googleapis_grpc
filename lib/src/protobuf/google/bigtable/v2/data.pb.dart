...
class Value extends $pb.GeneratedMessage {
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(
    ...
    ..aOM<$433.Type>(7, _omitFieldNames ? '' : 'type',
        subBuilder: $433.Type.create)
    ..a<$core.List<$core.int>>(
    ...
    ..aOM<$330.Timestamp>(12, _omitFieldNames ? '' : 'timestampValue',
        subBuilder: $330.Timestamp.create)
    ..aOM<$355.Date>(13, _omitFieldNames ? '' : 'dateValue',
  ...
  @$pb.TagNumber(12)
  $330.Timestamp get timestampValue => $_getN(9);
  @$pb.TagNumber(12)
  ...
  @$pb.TagNumber(12)
  $330.Timestamp ensureTimestampValue() => $_ensure(9);

  /// Represents a typed value transported as a date.
  @$pb.TagNumber(13)
  $355.Date get dateValue => $_getN(10);
  @$pb.TagNumber(13)
  set dateValue($355.Date v) {
    setField(13, v);
  }
  ...
  @$pb.TagNumber(13)
  $355.Date ensureDateValue() => $_ensure(10);
}
...
class ColumnMetadata extends $pb.GeneratedMessage {
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(
      ...
      createEmptyInstance: create)
    ..aOS(1, _omitFieldNames ? '' : 'name')
    ..aOM<$433.Type>(2, _omitFieldNames ? '' : 'type',
        subBuilder: $433.Type.create)
    ..hasRequiredFields = false;
