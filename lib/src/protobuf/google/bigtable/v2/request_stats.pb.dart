...
class RequestLatencyStats extends $pb.GeneratedMessage {
  factory RequestLatencyStats({
    $261.Duration? frontendServerLatency,
  }) {
    final $result = create();
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(_omitMessageNames ? '' : 'RequestLatencyStats', package: const $pb.PackageName(_omitMessageNames ? '' : 'google.bigtable.v2'), createEmptyInstance: create)
    ..aOM<$261.Duration>(1, _omitFieldNames ? '' : 'frontendServerLatency', subBuilder: $261.Duration.create)
    ..hasRequiredFields = false
  ;
  ...
  ///  caller.
  @$pb.TagNumber(1)
  $261.Duration get frontendServerLatency => $_getN(0);
  @$pb.TagNumber(1)
  set frontendServerLatency($261.Duration v) { setField(1, v); }
  @$pb.TagNumber(1)
  $core.bool hasFrontendServerLatency() => $_has(0);
  @$pb.TagNumber(1)
  void clearFrontendServerLatency() => clearField(1);
  @$pb.TagNumber(1)
  $261.Duration ensureFrontendServerLatency() => $_ensure(0);
}
