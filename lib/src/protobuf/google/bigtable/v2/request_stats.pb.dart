...
class RequestLatencyStats extends $pb.GeneratedMessage {
  factory RequestLatencyStats({
    $292.Duration? frontendServerLatency,
  }) {
    final $result = create();
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(
      ...
      package:
          const $pb.PackageName(_omitMessageNames ? '' : 'google.bigtable.v2'),
      createEmptyInstance: create)
    ..aOM<$292.Duration>(1, _omitFieldNames ? '' : 'frontendServerLatency',
  ...
  ///  caller.
  @$pb.TagNumber(1)
  $292.Duration get frontendServerLatency => $_getN(0);
  @$pb.TagNumber(1)
  set frontendServerLatency($292.Duration v) {
    setField(1, v);
  }
  ...
  @$pb.TagNumber(1)
  $292.Duration ensureFrontendServerLatency() => $_ensure(0);
}
