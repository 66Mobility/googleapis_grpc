...
import 'common.pbenum.dart' as $429;
...
class Cluster extends $pb.GeneratedMessage {
  factory Cluster({
    ...
    Cluster_State? state,
    $core.int? serveNodes,
    $429.StorageType? defaultStorageType,
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(
    ...
    ..e<$429.StorageType>(
        ...
        defaultOrMaker: $429.StorageType.STORAGE_TYPE_UNSPECIFIED,
        valueOf: $429.StorageType.valueOf,
        enumValues: $429.StorageType.values)
  ...
  @$pb.TagNumber(5)
  $429.StorageType get defaultStorageType => $_getN(4);
  @$pb.TagNumber(5)
  set defaultStorageType($429.StorageType v) {
    setField(5, v);
  }
