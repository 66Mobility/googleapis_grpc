...
class ChangeStreamConfig extends $pb.GeneratedMessage {
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(
      ...
      package: const $pb.PackageName(
          _omitMessageNames ? '' : 'google.bigtable.admin.v2'),
      createEmptyInstance: create)
    ..aOM<$266.Duration>(1, _omitFieldNames ? '' : 'retentionPeriod',
  ...
  @$pb.TagNumber(1)
  $266.Duration get retentionPeriod => $_getN(0);
  @$pb.TagNumber(1)
  set retentionPeriod($266.Duration v) {
    setField(1, v);
  }
  ...
  @$pb.TagNumber(1)
  $266.Duration ensureRetentionPeriod() => $_ensure(0);
}
...
class Table_AutomatedBackupPolicy extends $pb.GeneratedMessage {
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(
    ...
    ..aOM<$266.Duration>(1, _omitFieldNames ? '' : 'retentionPeriod',
        subBuilder: $266.Duration.create)
    ..aOM<$266.Duration>(2, _omitFieldNames ? '' : 'frequency',
        subBuilder: $266.Duration.create)
    ..hasRequiredFields = false;
  ...
  @$pb.TagNumber(2)
  $266.Duration get frequency => $_getN(1);
  @$pb.TagNumber(2)
  set frequency($266.Duration v) {
    setField(2, v);
  }
  ...
  @$pb.TagNumber(2)
  $266.Duration ensureFrequency() => $_ensure(1);
}
...
class ColumnFamily extends $pb.GeneratedMessage {
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(
    ...
    ..aOM<$403.Type>(3, _omitFieldNames ? '' : 'valueType',
        subBuilder: $403.Type.create)
    ..hasRequiredFields = false;
  ...
  @$pb.TagNumber(3)
  $403.Type get valueType => $_getN(1);
  @$pb.TagNumber(3)
  set valueType($403.Type v) {
    setField(3, v);
  }
  ...
  @$pb.TagNumber(3)
  $403.Type ensureValueType() => $_ensure(1);
}
...
class GcRule extends $pb.GeneratedMessage {
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(
    ...
    ..aOM<$266.Duration>(2, _omitFieldNames ? '' : 'maxAge',
        subBuilder: $266.Duration.create)
  ...
  /// microsecond granularity.
  @$pb.TagNumber(2)
  $266.Duration get maxAge => $_getN(1);
  @$pb.TagNumber(2)
  set maxAge($266.Duration v) {
    setField(2, v);
  }
  ...
  @$pb.TagNumber(2)
  $266.Duration ensureMaxAge() => $_ensure(1);
...
class Snapshot extends $pb.GeneratedMessage {
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(
    ...
    ..aOM<$304.Timestamp>(5, _omitFieldNames ? '' : 'deleteTime',
        subBuilder: $304.Timestamp.create)
  ...
  @$pb.TagNumber(5)
  $304.Timestamp get deleteTime => $_getN(4);
  @$pb.TagNumber(5)
  ...
  @$pb.TagNumber(5)
  $304.Timestamp ensureDeleteTime() => $_ensure(4);
...
class Backup extends $pb.GeneratedMessage {
  factory Backup({
    ...
    $304.Timestamp? hotToStandardTime,
  }) {
    final $result = create();
    if (name != null) {
      $result.name = name;
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(
    ...
    ..aOM<$304.Timestamp>(12, _omitFieldNames ? '' : 'hotToStandardTime',
        subBuilder: $304.Timestamp.create)
    ..hasRequiredFields = false;
  ...
  @$pb.TagNumber(12)
  $304.Timestamp get hotToStandardTime => $_getN(10);
  @$pb.TagNumber(12)
  set hotToStandardTime($304.Timestamp v) {
    setField(12, v);
  }
  ...
  @$pb.TagNumber(12)
  $304.Timestamp ensureHotToStandardTime() => $_ensure(10);
}
