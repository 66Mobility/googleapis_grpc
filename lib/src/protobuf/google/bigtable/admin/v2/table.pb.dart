...
class ChangeStreamConfig extends $pb.GeneratedMessage {
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(
      ...
      package: const $pb.PackageName(
          _omitMessageNames ? '' : 'google.bigtable.admin.v2'),
      createEmptyInstance: create)
    ..aOM<$292.Duration>(1, _omitFieldNames ? '' : 'retentionPeriod',
  ...
  @$pb.TagNumber(1)
  $292.Duration get retentionPeriod => $_getN(0);
  @$pb.TagNumber(1)
  set retentionPeriod($292.Duration v) {
    setField(1, v);
  }
  ...
  @$pb.TagNumber(1)
  $292.Duration ensureRetentionPeriod() => $_ensure(0);
}
...
class Table_AutomatedBackupPolicy extends $pb.GeneratedMessage {
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(
    ...
    ..aOM<$292.Duration>(1, _omitFieldNames ? '' : 'retentionPeriod',
        subBuilder: $292.Duration.create)
    ..aOM<$292.Duration>(2, _omitFieldNames ? '' : 'frequency',
        subBuilder: $292.Duration.create)
    ..hasRequiredFields = false;
  ...
  @$pb.TagNumber(2)
  $292.Duration get frequency => $_getN(1);
  @$pb.TagNumber(2)
  set frequency($292.Duration v) {
    setField(2, v);
  }
  ...
  @$pb.TagNumber(2)
  $292.Duration ensureFrequency() => $_ensure(1);
}
...
class ColumnFamily extends $pb.GeneratedMessage {
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(
    ...
    ..aOM<$432.Type>(3, _omitFieldNames ? '' : 'valueType',
        subBuilder: $432.Type.create)
    ..hasRequiredFields = false;
  ...
  @$pb.TagNumber(3)
  $432.Type get valueType => $_getN(1);
  @$pb.TagNumber(3)
  set valueType($432.Type v) {
    setField(3, v);
  }
  ...
  @$pb.TagNumber(3)
  $432.Type ensureValueType() => $_ensure(1);
}
...
class GcRule extends $pb.GeneratedMessage {
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(
    ...
    ..aOM<$292.Duration>(2, _omitFieldNames ? '' : 'maxAge',
        subBuilder: $292.Duration.create)
  ...
  /// microsecond granularity.
  @$pb.TagNumber(2)
  $292.Duration get maxAge => $_getN(1);
  @$pb.TagNumber(2)
  set maxAge($292.Duration v) {
    setField(2, v);
  }
  ...
  @$pb.TagNumber(2)
  $292.Duration ensureMaxAge() => $_ensure(1);
...
class EncryptionInfo extends $pb.GeneratedMessage {
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(
    ...
    ..aOM<$350.Status>(4, _omitFieldNames ? '' : 'encryptionStatus',
  ...
  /// at rest.
  @$pb.TagNumber(4)
  $350.Status get encryptionStatus => $_getN(2);
  @$pb.TagNumber(4)
  set encryptionStatus($350.Status v) {
    setField(4, v);
  }
  ...
  @$pb.TagNumber(4)
  $350.Status ensureEncryptionStatus() => $_ensure(2);
}
...
class Snapshot extends $pb.GeneratedMessage {
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(
    ...
    ..aOM<$330.Timestamp>(5, _omitFieldNames ? '' : 'deleteTime',
        subBuilder: $330.Timestamp.create)
  ...
  @$pb.TagNumber(5)
  $330.Timestamp get deleteTime => $_getN(4);
  @$pb.TagNumber(5)
  ...
  @$pb.TagNumber(5)
  $330.Timestamp ensureDeleteTime() => $_ensure(4);
...
class Backup extends $pb.GeneratedMessage {
  factory Backup({
    ...
    $330.Timestamp? hotToStandardTime,
  }) {
    final $result = create();
    if (name != null) {
      $result.name = name;
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(
    ...
    ..aOM<$330.Timestamp>(12, _omitFieldNames ? '' : 'hotToStandardTime',
        subBuilder: $330.Timestamp.create)
    ..hasRequiredFields = false;
  ...
  @$pb.TagNumber(12)
  $330.Timestamp get hotToStandardTime => $_getN(10);
  @$pb.TagNumber(12)
  set hotToStandardTime($330.Timestamp v) {
    setField(12, v);
  }
  ...
  @$pb.TagNumber(12)
  $330.Timestamp ensureHotToStandardTime() => $_ensure(10);
}
