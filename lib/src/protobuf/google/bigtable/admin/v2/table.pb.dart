...
class ChangeStreamConfig extends $pb.GeneratedMessage {
  ...
  @$pb.TagNumber(1)
  $264.Duration ensureRetentionPeriod() => $_ensure(0);
}
...
class ColumnFamily extends $pb.GeneratedMessage {
  ...
  @$pb.TagNumber(3)
  $401.Type ensureValueType() => $_ensure(1);
}
...
class GcRule extends $pb.GeneratedMessage {
  ...
  @$pb.TagNumber(2)
  $264.Duration ensureMaxAge() => $_ensure(1);
...
class Snapshot extends $pb.GeneratedMessage {
  ...
  @$pb.TagNumber(5)
  $302.Timestamp ensureDeleteTime() => $_ensure(4);
...
class Backup extends $pb.GeneratedMessage {
  factory Backup({
    ...
    $302.Timestamp? hotToStandardTime,
  }) {
    final $result = create();
    if (name != null) {
      $result.name = name;
  ...
  @$pb.TagNumber(12)
  $302.Timestamp ensureHotToStandardTime() => $_ensure(10);
}
