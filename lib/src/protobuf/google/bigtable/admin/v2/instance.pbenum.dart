...
class Instance_State extends $pb.ProtobufEnum {
  static const Instance_State STATE_NOT_KNOWN = Instance_State._(0, _omitEnumNames ? '' : 'STATE_NOT_KNOWN');
...
class Instance_Type extends $pb.ProtobufEnum {
  ...
  static const Instance_Type PRODUCTION = Instance_Type._(1, _omitEnumNames ? '' : 'PRODUCTION');
  static const Instance_Type DEVELOPMENT = Instance_Type._(2, _omitEnumNames ? '' : 'DEVELOPMENT');
...
class Cluster_State extends $pb.ProtobufEnum {
  static const Cluster_State STATE_NOT_KNOWN = Cluster_State._(0, _omitEnumNames ? '' : 'STATE_NOT_KNOWN');
  ...
  static const Cluster_State RESIZING = Cluster_State._(3, _omitEnumNames ? '' : 'RESIZING');
  static const Cluster_State DISABLED = Cluster_State._(4, _omitEnumNames ? '' : 'DISABLED');
...
class AppProfile_Priority extends $pb.ProtobufEnum {
  static const AppProfile_Priority PRIORITY_UNSPECIFIED = AppProfile_Priority._(0, _omitEnumNames ? '' : 'PRIORITY_UNSPECIFIED');
  static const AppProfile_Priority PRIORITY_LOW = AppProfile_Priority._(1, _omitEnumNames ? '' : 'PRIORITY_LOW');
  static const AppProfile_Priority PRIORITY_MEDIUM = AppProfile_Priority._(2, _omitEnumNames ? '' : 'PRIORITY_MEDIUM');
  static const AppProfile_Priority PRIORITY_HIGH = AppProfile_Priority._(3, _omitEnumNames ? '' : 'PRIORITY_HIGH');
  ...
  static final $core.Map<$core.int, AppProfile_Priority> _byValue = $pb.ProtobufEnum.initByValue(values);
...
class AppProfile_DataBoostIsolationReadOnly_ComputeBillingOwner extends $pb.ProtobufEnum {
  static const AppProfile_DataBoostIsolationReadOnly_ComputeBillingOwner COMPUTE_BILLING_OWNER_UNSPECIFIED = AppProfile_DataBoostIsolationReadOnly_ComputeBillingOwner._(0, _omitEnumNames ? '' : 'COMPUTE_BILLING_OWNER_UNSPECIFIED');
  static const AppProfile_DataBoostIsolationReadOnly_ComputeBillingOwner HOST_PAYS = AppProfile_DataBoostIsolationReadOnly_ComputeBillingOwner._(1, _omitEnumNames ? '' : 'HOST_PAYS');

  static const $core.List<AppProfile_DataBoostIsolationReadOnly_ComputeBillingOwner> values = <AppProfile_DataBoostIsolationReadOnly_ComputeBillingOwner> [
    COMPUTE_BILLING_OWNER_UNSPECIFIED,
    HOST_PAYS,
  ];

  static final $core.Map<$core.int, AppProfile_DataBoostIsolationReadOnly_ComputeBillingOwner> _byValue = $pb.ProtobufEnum.initByValue(values);
  static AppProfile_DataBoostIsolationReadOnly_ComputeBillingOwner? valueOf($core.int value) => _byValue[value];

  const AppProfile_DataBoostIsolationReadOnly_ComputeBillingOwner._($core.int v, $core.String n) : super(v, n);
}
