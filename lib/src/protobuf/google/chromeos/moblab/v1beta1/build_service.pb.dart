...
import 'resources.pb.dart' as $449;
...
class FindMostStableBuildResponse extends $pb.GeneratedMessage {
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(
      ...
      package: const $pb.PackageName(
          _omitMessageNames ? '' : 'google.chromeos.moblab.v1beta1'),
      createEmptyInstance: create)
    ..aOM<$449.Build>(1, _omitFieldNames ? '' : 'build',
        subBuilder: $449.Build.create)
    ..hasRequiredFields = false;
  ...
  @$pb.TagNumber(1)
  $449.Build get build => $_getN(0);
  @$pb.TagNumber(1)
  set build($449.Build v) {
    setField(1, v);
  }
  ...
  @$pb.TagNumber(1)
  $449.Build ensureBuild() => $_ensure(0);
}
...
class ListBuildTargetsResponse extends $pb.GeneratedMessage {
  factory ListBuildTargetsResponse({
    $core.Iterable<$449.BuildTarget>? buildTargets,
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(
    ...
    ..pc<$449.BuildTarget>(
        ...
        subBuilder: $449.BuildTarget.create)
  ...
  @$pb.TagNumber(1)
  $core.List<$449.BuildTarget> get buildTargets => $_getList(0);
...
class ListModelsResponse extends $pb.GeneratedMessage {
  factory ListModelsResponse({
    $core.Iterable<$449.Model>? models,
    $core.String? nextPageToken,
    $core.int? totalSize,
  }) {
    final $result = create();
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(
      ...
      package: const $pb.PackageName(
          _omitMessageNames ? '' : 'google.chromeos.moblab.v1beta1'),
      createEmptyInstance: create)
    ..pc<$449.Model>(1, _omitFieldNames ? '' : 'models', $pb.PbFieldType.PM,
        subBuilder: $449.Model.create)
    ..aOS(2, _omitFieldNames ? '' : 'nextPageToken')
    ..a<$core.int>(3, _omitFieldNames ? '' : 'totalSize', $pb.PbFieldType.O3)
    ..hasRequiredFields = false;
  ...
  /// The list of models.
  @$pb.TagNumber(1)
  $core.List<$449.Model> get models => $_getList(0);
...
class ListBuildsRequest extends $pb.GeneratedMessage {
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(
    ...
    ..aOM<$361.FieldMask>(6, _omitFieldNames ? '' : 'groupBy',
        subBuilder: $361.FieldMask.create)
    ..hasRequiredFields = false;
  ...
  @$pb.TagNumber(6)
  $361.FieldMask get groupBy => $_getN(5);
  @$pb.TagNumber(6)
  set groupBy($361.FieldMask v) {
    setField(6, v);
  }
  ...
  @$pb.TagNumber(6)
  $361.FieldMask ensureGroupBy() => $_ensure(5);
}
...
class ListBuildsResponse extends $pb.GeneratedMessage {
  factory ListBuildsResponse({
    $core.Iterable<$449.Build>? builds,
    $core.String? nextPageToken,
    $core.int? totalSize,
  }) {
    final $result = create();
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(
      ...
      package: const $pb.PackageName(
          _omitMessageNames ? '' : 'google.chromeos.moblab.v1beta1'),
      createEmptyInstance: create)
    ..pc<$449.Build>(1, _omitFieldNames ? '' : 'builds', $pb.PbFieldType.PM,
        subBuilder: $449.Build.create)
    ..aOS(2, _omitFieldNames ? '' : 'nextPageToken')
    ..a<$core.int>(3, _omitFieldNames ? '' : 'totalSize', $pb.PbFieldType.O3)
    ..hasRequiredFields = false;
  ...
  /// The list of builds.
  @$pb.TagNumber(1)
  $core.List<$449.Build> get builds => $_getList(0);
...
class CheckBuildStageStatusResponse extends $pb.GeneratedMessage {
  factory CheckBuildStageStatusResponse({
    ...
    $449.BuildArtifact? stagedBuildArtifact,
    $449.BuildArtifact? sourceBuildArtifact,
  }) {
    final $result = create();
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(
    ...
    ..aOM<$449.BuildArtifact>(2, _omitFieldNames ? '' : 'stagedBuildArtifact',
        subBuilder: $449.BuildArtifact.create)
    ..aOM<$449.BuildArtifact>(3, _omitFieldNames ? '' : 'sourceBuildArtifact',
        subBuilder: $449.BuildArtifact.create)
    ..hasRequiredFields = false;
  ...
  @$pb.TagNumber(2)
  $449.BuildArtifact get stagedBuildArtifact => $_getN(1);
  @$pb.TagNumber(2)
  set stagedBuildArtifact($449.BuildArtifact v) {
    setField(2, v);
  }
  ...
  @$pb.TagNumber(2)
  $449.BuildArtifact ensureStagedBuildArtifact() => $_ensure(1);

  /// The source build artifact in the source bucket.
  @$pb.TagNumber(3)
  $449.BuildArtifact get sourceBuildArtifact => $_getN(2);
  @$pb.TagNumber(3)
  set sourceBuildArtifact($449.BuildArtifact v) {
    setField(3, v);
  }
  ...
  @$pb.TagNumber(3)
  $449.BuildArtifact ensureSourceBuildArtifact() => $_ensure(2);
}
...
class StageBuildResponse extends $pb.GeneratedMessage {
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(
      ...
      package: const $pb.PackageName(
          _omitMessageNames ? '' : 'google.chromeos.moblab.v1beta1'),
      createEmptyInstance: create)
    ..aOM<$449.BuildArtifact>(1, _omitFieldNames ? '' : 'stagedBuildArtifact',
        subBuilder: $449.BuildArtifact.create)
    ..hasRequiredFields = false;
  ...
  @$pb.TagNumber(1)
  $449.BuildArtifact get stagedBuildArtifact => $_getN(0);
  @$pb.TagNumber(1)
  set stagedBuildArtifact($449.BuildArtifact v) {
    setField(1, v);
  }
  ...
  @$pb.TagNumber(1)
  $449.BuildArtifact ensureStagedBuildArtifact() => $_ensure(0);
}
