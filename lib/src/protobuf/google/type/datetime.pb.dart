...
class DateTime extends $pb.GeneratedMessage {
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(_omitMessageNames ? '' : 'DateTime', package: const $pb.PackageName(_omitMessageNames ? '' : 'google.type'), createEmptyInstance: create)
    ...
    ..aOM<$1737.Duration>(8, _omitFieldNames ? '' : 'utcOffset', subBuilder: $1737.Duration.create)
  ...
  /// { seconds: -14400 }.
  @$pb.TagNumber(8)
  $1737.Duration get utcOffset => $_getN(7);
  @$pb.TagNumber(8)
  set utcOffset($1737.Duration v) { setField(8, v); }
  @$pb.TagNumber(8)
  $core.bool hasUtcOffset() => $_has(7);
  @$pb.TagNumber(8)
  void clearUtcOffset() => clearField(8);
  @$pb.TagNumber(8)
  $1737.Duration ensureUtcOffset() => $_ensure(7);
