...
class AwsS3ObjectMetadata extends $pb.GeneratedMessage {
  factory AwsS3ObjectMetadata({
    ...
    $330.Timestamp? lastModifiedTime,
    $core.String? md5,
    $fixnum.Int64? size,
  }) {
    final $result = create();
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(
    ...
    ..aOM<$330.Timestamp>(3, _omitFieldNames ? '' : 'lastModifiedTime',
  ...
  @$pb.TagNumber(3)
  $330.Timestamp get lastModifiedTime => $_getN(2);
  @$pb.TagNumber(3)
  set lastModifiedTime($330.Timestamp v) {
    setField(3, v);
  }
  ...
  @$pb.TagNumber(3)
  $330.Timestamp ensureLastModifiedTime() => $_ensure(2);
...
class AzureBlobMetadata extends $pb.GeneratedMessage {
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(
    ...
    ..aOM<$330.Timestamp>(4, _omitFieldNames ? '' : 'lastModifiedTime',
        subBuilder: $330.Timestamp.create)
  ...
  @$pb.TagNumber(4)
  $330.Timestamp get lastModifiedTime => $_getN(3);
  @$pb.TagNumber(4)
  set lastModifiedTime($330.Timestamp v) {
    setField(4, v);
  }
  ...
  @$pb.TagNumber(4)
  $330.Timestamp ensureLastModifiedTime() => $_ensure(3);
...
class PosixFileMetadata extends $pb.GeneratedMessage {
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(
    ...
    ..aOM<$330.Timestamp>(2, _omitFieldNames ? '' : 'lastModifiedTime',
        subBuilder: $330.Timestamp.create)
  ...
  @$pb.TagNumber(2)
  $330.Timestamp get lastModifiedTime => $_getN(1);
  @$pb.TagNumber(2)
  set lastModifiedTime($330.Timestamp v) {
    setField(2, v);
  }
  ...
  @$pb.TagNumber(2)
  $330.Timestamp ensureLastModifiedTime() => $_ensure(1);
...
class TransferActivityLog extends $pb.GeneratedMessage {
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(
    ...
    ..aOM<ObjectMetadata>(7, _omitFieldNames ? '' : 'destinationObject',
        subBuilder: ObjectMetadata.create)
    ..aOM<$330.Timestamp>(8, _omitFieldNames ? '' : 'completeTime',
        subBuilder: $330.Timestamp.create)
    ..hasRequiredFields = false;
  ...
  @$pb.TagNumber(8)
  $330.Timestamp get completeTime => $_getN(7);
  @$pb.TagNumber(8)
  set completeTime($330.Timestamp v) {
    setField(8, v);
  }
  ...
  @$pb.TagNumber(8)
  $330.Timestamp ensureCompleteTime() => $_ensure(7);
}
