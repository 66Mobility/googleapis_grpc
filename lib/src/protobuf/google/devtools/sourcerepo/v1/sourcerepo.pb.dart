...
class Repo extends $pb.GeneratedMessage {
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(_omitMessageNames ? '' : 'Repo', package: const $pb.PackageName(_omitMessageNames ? '' : 'google.devtools.sourcerepo.v1'), createEmptyInstance: create)
    ..aOS(1, _omitFieldNames ? '' : 'name')
    ..aInt64(2, _omitFieldNames ? '' : 'size')
    ..aOS(3, _omitFieldNames ? '' : 'url')
    ..aOM<MirrorConfig>(4, _omitFieldNames ? '' : 'mirrorConfig', subBuilder: MirrorConfig.create)
...
class MirrorConfig extends $pb.GeneratedMessage {
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(_omitMessageNames ? '' : 'MirrorConfig', package: const $pb.PackageName(_omitMessageNames ? '' : 'google.devtools.sourcerepo.v1'), createEmptyInstance: create)
  ...
  'Use [GeneratedMessageGenericExtensions.rebuild] instead. '
  'Will be removed in next major version')
  MirrorConfig copyWith(void Function(MirrorConfig) updates) => super.copyWith((message) => updates(message as MirrorConfig)) as MirrorConfig;
...
class GetRepoRequest extends $pb.GeneratedMessage {
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(_omitMessageNames ? '' : 'GetRepoRequest', package: const $pb.PackageName(_omitMessageNames ? '' : 'google.devtools.sourcerepo.v1'), createEmptyInstance: create)
    ..aOS(1, _omitFieldNames ? '' : 'name')
    ..hasRequiredFields = false
  ;
  ...
  'Use [GeneratedMessageGenericExtensions.rebuild] instead. '
  'Will be removed in next major version')
  GetRepoRequest copyWith(void Function(GetRepoRequest) updates) => super.copyWith((message) => updates(message as GetRepoRequest)) as GetRepoRequest;
...
class ListReposRequest extends $pb.GeneratedMessage {
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(_omitMessageNames ? '' : 'ListReposRequest', package: const $pb.PackageName(_omitMessageNames ? '' : 'google.devtools.sourcerepo.v1'), createEmptyInstance: create)
    ..aOS(1, _omitFieldNames ? '' : 'name')
...
class ListReposResponse extends $pb.GeneratedMessage {
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(_omitMessageNames ? '' : 'ListReposResponse', package: const $pb.PackageName(_omitMessageNames ? '' : 'google.devtools.sourcerepo.v1'), createEmptyInstance: create)
    ..pc<Repo>(1, _omitFieldNames ? '' : 'repos', $pb.PbFieldType.PM, subBuilder: Repo.create)
...
class CreateRepoRequest extends $pb.GeneratedMessage {
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(_omitMessageNames ? '' : 'CreateRepoRequest', package: const $pb.PackageName(_omitMessageNames ? '' : 'google.devtools.sourcerepo.v1'), createEmptyInstance: create)
...
class DeleteRepoRequest extends $pb.GeneratedMessage {
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(_omitMessageNames ? '' : 'DeleteRepoRequest', package: const $pb.PackageName(_omitMessageNames ? '' : 'google.devtools.sourcerepo.v1'), createEmptyInstance: create)
    ..aOS(1, _omitFieldNames ? '' : 'name')
    ..hasRequiredFields = false
  ;
