...
class Worker_Property extends $pb.GeneratedMessage {
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(_omitMessageNames ? '' : 'Worker.Property', package: const $pb.PackageName(_omitMessageNames ? '' : 'google.devtools.remoteworkers.v1test2'), createEmptyInstance: create)
  ...
  'Will be removed in next major version')
  Worker_Property copyWith(void Function(Worker_Property) updates) => super.copyWith((message) => updates(message as Worker_Property)) as Worker_Property;
...
class Worker_Config extends $pb.GeneratedMessage {
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(_omitMessageNames ? '' : 'Worker.Config', package: const $pb.PackageName(_omitMessageNames ? '' : 'google.devtools.remoteworkers.v1test2'), createEmptyInstance: create)
    ..aOS(1, _omitFieldNames ? '' : 'key')
    ..aOS(2, _omitFieldNames ? '' : 'value')
    ..hasRequiredFields = false
  ;
  ...
  'Use [GeneratedMessageGenericExtensions.rebuild] instead. '
  'Will be removed in next major version')
  Worker_Config copyWith(void Function(Worker_Config) updates) => super.copyWith((message) => updates(message as Worker_Config)) as Worker_Config;
...
class Worker extends $pb.GeneratedMessage {
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(_omitMessageNames ? '' : 'Worker', package: const $pb.PackageName(_omitMessageNames ? '' : 'google.devtools.remoteworkers.v1test2'), createEmptyInstance: create)
    ..pc<Device>(1, _omitFieldNames ? '' : 'devices', $pb.PbFieldType.PM, subBuilder: Device.create)
    ..pc<Worker_Property>(2, _omitFieldNames ? '' : 'properties', $pb.PbFieldType.PM, subBuilder: Worker_Property.create)
    ..pc<Worker_Config>(3, _omitFieldNames ? '' : 'configs', $pb.PbFieldType.PM, subBuilder: Worker_Config.create)
    ..hasRequiredFields = false
  ;
...
class Device_Property extends $pb.GeneratedMessage {
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(_omitMessageNames ? '' : 'Device.Property', package: const $pb.PackageName(_omitMessageNames ? '' : 'google.devtools.remoteworkers.v1test2'), createEmptyInstance: create)
    ..aOS(1, _omitFieldNames ? '' : 'key')
    ..aOS(2, _omitFieldNames ? '' : 'value')
    ..hasRequiredFields = false
  ;
  ...
  'Use [GeneratedMessageGenericExtensions.rebuild] instead. '
  'Will be removed in next major version')
  Device_Property copyWith(void Function(Device_Property) updates) => super.copyWith((message) => updates(message as Device_Property)) as Device_Property;
...
class Device extends $pb.GeneratedMessage {
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(_omitMessageNames ? '' : 'Device', package: const $pb.PackageName(_omitMessageNames ? '' : 'google.devtools.remoteworkers.v1test2'), createEmptyInstance: create)
    ..aOS(1, _omitFieldNames ? '' : 'handle')
    ..pc<Device_Property>(2, _omitFieldNames ? '' : 'properties', $pb.PbFieldType.PM, subBuilder: Device_Property.create)
    ..hasRequiredFields = false
  ;
