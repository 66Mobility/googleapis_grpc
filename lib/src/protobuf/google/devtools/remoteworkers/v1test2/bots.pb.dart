...
class BotSession extends $pb.GeneratedMessage {
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(_omitMessageNames ? '' : 'BotSession', package: const $pb.PackageName(_omitMessageNames ? '' : 'google.devtools.remoteworkers.v1test2'), createEmptyInstance: create)
  ...
  'Will be removed in next major version')
  BotSession copyWith(void Function(BotSession) updates) => super.copyWith((message) => updates(message as BotSession)) as BotSession;
...
class AdminTemp extends $pb.GeneratedMessage {
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(_omitMessageNames ? '' : 'AdminTemp', package: const $pb.PackageName(_omitMessageNames ? '' : 'google.devtools.remoteworkers.v1test2'), createEmptyInstance: create)
    ..e<AdminTemp_Command>(1, _omitFieldNames ? '' : 'command', $pb.PbFieldType.OE, defaultOrMaker: AdminTemp_Command.UNSPECIFIED, valueOf: AdminTemp_Command.valueOf, enumValues: AdminTemp_Command.values)
  ...
  'Use [GeneratedMessageGenericExtensions.rebuild] instead. '
  'Will be removed in next major version')
  AdminTemp copyWith(void Function(AdminTemp) updates) => super.copyWith((message) => updates(message as AdminTemp)) as AdminTemp;
...
class CreateBotSessionRequest extends $pb.GeneratedMessage {
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(_omitMessageNames ? '' : 'CreateBotSessionRequest', package: const $pb.PackageName(_omitMessageNames ? '' : 'google.devtools.remoteworkers.v1test2'), createEmptyInstance: create)
  ...
  'Use [GeneratedMessageGenericExtensions.rebuild] instead. '
  'Will be removed in next major version')
  CreateBotSessionRequest copyWith(void Function(CreateBotSessionRequest) updates) => super.copyWith((message) => updates(message as CreateBotSessionRequest)) as CreateBotSessionRequest;
...
class UpdateBotSessionRequest extends $pb.GeneratedMessage {
  ...
  'Use [GeneratedMessageGenericExtensions.rebuild] instead. '
  'Will be removed in next major version')
  UpdateBotSessionRequest copyWith(void Function(UpdateBotSessionRequest) updates) => super.copyWith((message) => updates(message as UpdateBotSessionRequest)) as UpdateBotSessionRequest;
