...
class ReportErrorEventRequest extends $pb.GeneratedMessage {
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(_omitMessageNames ? '' : 'ReportErrorEventRequest', package: const $pb.PackageName(_omitMessageNames ? '' : 'google.devtools.clouderrorreporting.v1beta1'), createEmptyInstance: create)
    ..aOS(1, _omitFieldNames ? '' : 'projectName')
    ..aOM<ReportedErrorEvent>(2, _omitFieldNames ? '' : 'event', subBuilder: ReportedErrorEvent.create)
  ...
  'Will be removed in next major version')
  ReportErrorEventRequest copyWith(void Function(ReportErrorEventRequest) updates) => super.copyWith((message) => updates(message as ReportErrorEventRequest)) as ReportErrorEventRequest;
...
class ReportErrorEventResponse extends $pb.GeneratedMessage {
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(_omitMessageNames ? '' : 'ReportErrorEventResponse', package: const $pb.PackageName(_omitMessageNames ? '' : 'google.devtools.clouderrorreporting.v1beta1'), createEmptyInstance: create)
    ..hasRequiredFields = false
  ;
  ...
  'Use [GeneratedMessageGenericExtensions.rebuild] instead. '
  'Will be removed in next major version')
  ReportErrorEventResponse copyWith(void Function(ReportErrorEventResponse) updates) => super.copyWith((message) => updates(message as ReportErrorEventResponse)) as ReportErrorEventResponse;
...
class ReportedErrorEvent extends $pb.GeneratedMessage {
  ...
  'Use [GeneratedMessageGenericExtensions.rebuild] instead. '
  'Will be removed in next major version')
  ReportedErrorEvent copyWith(void Function(ReportedErrorEvent) updates) => super.copyWith((message) => updates(message as ReportedErrorEvent)) as ReportedErrorEvent;
  ...
  @$pb.TagNumber(2)
  $1566.ServiceContext get serviceContext => $_getN(1);
  @$pb.TagNumber(2)
  set serviceContext($1566.ServiceContext v) { setField(2, v); }
  @$pb.TagNumber(2)
  $core.bool hasServiceContext() => $_has(1);
  @$pb.TagNumber(2)
  void clearServiceContext() => clearField(2);
  @$pb.TagNumber(2)
  $1566.ServiceContext ensureServiceContext() => $_ensure(1);
  ...
  @$pb.TagNumber(4)
  $1566.ErrorContext get context => $_getN(3);
  @$pb.TagNumber(4)
  set context($1566.ErrorContext v) { setField(4, v); }
  @$pb.TagNumber(4)
  $core.bool hasContext() => $_has(3);
  @$pb.TagNumber(4)
  void clearContext() => clearField(4);
  @$pb.TagNumber(4)
  $1566.ErrorContext ensureContext() => $_ensure(3);
}
