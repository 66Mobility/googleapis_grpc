...
const ReportErrorEventRequest$json = {
  ...
  '2': [
    ...
    {'1': 'event', '3': 2, '4': 1, '5': 11, '6': '.google.devtools.clouderrorreporting.v1beta1.ReportedErrorEvent', '8': {}, '10': 'event'},
  ],
};
...
final $typed_data.Uint8List reportErrorEventResponseDescriptor = $convert.base64Decode(
    'ChhSZXBvcnRFcnJvckV2ZW50UmVzcG9uc2U=');
...
const ReportedErrorEvent$json = {
  ...
  '2': [
    ...
    {'1': 'service_context', '3': 2, '4': 1, '5': 11, '6': '.google.devtools.clouderrorreporting.v1beta1.ServiceContext', '8': {}, '10': 'serviceContext'},
    {'1': 'message', '3': 3, '4': 1, '5': 9, '8': {}, '10': 'message'},
    {'1': 'context', '3': 4, '4': 1, '5': 11, '6': '.google.devtools.clouderrorreporting.v1beta1.ErrorContext', '8': {}, '10': 'context'},
  ],
};
