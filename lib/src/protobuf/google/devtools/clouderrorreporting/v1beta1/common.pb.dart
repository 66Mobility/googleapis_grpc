...
class ErrorGroup extends $pb.GeneratedMessage {
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(_omitMessageNames ? '' : 'ErrorGroup', package: const $pb.PackageName(_omitMessageNames ? '' : 'google.devtools.clouderrorreporting.v1beta1'), createEmptyInstance: create)
    ..aOS(1, _omitFieldNames ? '' : 'name')
    ..aOS(2, _omitFieldNames ? '' : 'groupId')
    ..pc<TrackingIssue>(3, _omitFieldNames ? '' : 'trackingIssues', $pb.PbFieldType.PM, subBuilder: TrackingIssue.create)
    ..e<ResolutionStatus>(5, _omitFieldNames ? '' : 'resolutionStatus', $pb.PbFieldType.OE, defaultOrMaker: ResolutionStatus.RESOLUTION_STATUS_UNSPECIFIED, valueOf: ResolutionStatus.valueOf, enumValues: ResolutionStatus.values)
  ...
  'Will be removed in next major version')
  ErrorGroup copyWith(void Function(ErrorGroup) updates) => super.copyWith((message) => updates(message as ErrorGroup)) as ErrorGroup;
...
class TrackingIssue extends $pb.GeneratedMessage {
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(_omitMessageNames ? '' : 'TrackingIssue', package: const $pb.PackageName(_omitMessageNames ? '' : 'google.devtools.clouderrorreporting.v1beta1'), createEmptyInstance: create)
  ...
  'Use [GeneratedMessageGenericExtensions.rebuild] instead. '
  'Will be removed in next major version')
  TrackingIssue copyWith(void Function(TrackingIssue) updates) => super.copyWith((message) => updates(message as TrackingIssue)) as TrackingIssue;
...
class ErrorEvent extends $pb.GeneratedMessage {
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(_omitMessageNames ? '' : 'ErrorEvent', package: const $pb.PackageName(_omitMessageNames ? '' : 'google.devtools.clouderrorreporting.v1beta1'), createEmptyInstance: create)
    ..aOM<$1775.Timestamp>(1, _omitFieldNames ? '' : 'eventTime', subBuilder: $1775.Timestamp.create)
    ..aOM<ServiceContext>(2, _omitFieldNames ? '' : 'serviceContext', subBuilder: ServiceContext.create)
    ..aOS(3, _omitFieldNames ? '' : 'message')
    ..aOM<ErrorContext>(5, _omitFieldNames ? '' : 'context', subBuilder: ErrorContext.create)
    ..hasRequiredFields = false
  ;
...
class ServiceContext extends $pb.GeneratedMessage {
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(_omitMessageNames ? '' : 'ServiceContext', package: const $pb.PackageName(_omitMessageNames ? '' : 'google.devtools.clouderrorreporting.v1beta1'), createEmptyInstance: create)
...
class ErrorContext extends $pb.GeneratedMessage {
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(_omitMessageNames ? '' : 'ErrorContext', package: const $pb.PackageName(_omitMessageNames ? '' : 'google.devtools.clouderrorreporting.v1beta1'), createEmptyInstance: create)
    ..aOM<HttpRequestContext>(1, _omitFieldNames ? '' : 'httpRequest', subBuilder: HttpRequestContext.create)
    ..aOS(2, _omitFieldNames ? '' : 'user')
    ..aOM<SourceLocation>(3, _omitFieldNames ? '' : 'reportLocation', subBuilder: SourceLocation.create)
    ..hasRequiredFields = false
  ;
...
class HttpRequestContext extends $pb.GeneratedMessage {
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(_omitMessageNames ? '' : 'HttpRequestContext', package: const $pb.PackageName(_omitMessageNames ? '' : 'google.devtools.clouderrorreporting.v1beta1'), createEmptyInstance: create)
    ..aOS(1, _omitFieldNames ? '' : 'method')
    ..aOS(2, _omitFieldNames ? '' : 'url')
    ..aOS(3, _omitFieldNames ? '' : 'userAgent')
    ..aOS(4, _omitFieldNames ? '' : 'referrer')
    ..a<$core.int>(5, _omitFieldNames ? '' : 'responseStatusCode', $pb.PbFieldType.O3)
...
class SourceLocation extends $pb.GeneratedMessage {
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(_omitMessageNames ? '' : 'SourceLocation', package: const $pb.PackageName(_omitMessageNames ? '' : 'google.devtools.clouderrorreporting.v1beta1'), createEmptyInstance: create)
