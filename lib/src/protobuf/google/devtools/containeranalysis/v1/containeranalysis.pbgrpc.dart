...
import 'containeranalysis.pb.dart' as $1573;
...
class ContainerAnalysisClient extends $grpc.Client {
  ...
  static final _$getVulnerabilityOccurrencesSummary = $grpc.ClientMethod<$1573.GetVulnerabilityOccurrencesSummaryRequest, $1573.VulnerabilityOccurrencesSummary>(
      '/google.devtools.containeranalysis.v1.ContainerAnalysis/GetVulnerabilityOccurrencesSummary',
      ($1573.GetVulnerabilityOccurrencesSummaryRequest value) => value.writeToBuffer(),
      ($core.List<$core.int> value) => $1573.VulnerabilityOccurrencesSummary.fromBuffer(value));
  ...
  $grpc.ResponseFuture<$1573.VulnerabilityOccurrencesSummary> getVulnerabilityOccurrencesSummary($1573.GetVulnerabilityOccurrencesSummaryRequest request, {$grpc.CallOptions? options}) {
...
abstract class ContainerAnalysisServiceBase extends $grpc.Service {
  $core.String get $name => 'google.devtools.containeranalysis.v1.ContainerAnalysis';
  ...
  ContainerAnalysisServiceBase() {
    ...
    $addMethod($grpc.ServiceMethod<$1573.GetVulnerabilityOccurrencesSummaryRequest, $1573.VulnerabilityOccurrencesSummary>(
        'GetVulnerabilityOccurrencesSummary',
        getVulnerabilityOccurrencesSummary_Pre,
        false,
        false,
        ($core.List<$core.int> value) => $1573.GetVulnerabilityOccurrencesSummaryRequest.fromBuffer(value),
        ($1573.VulnerabilityOccurrencesSummary value) => value.writeToBuffer()));
  }
  ...
  $async.Future<$1573.VulnerabilityOccurrencesSummary> getVulnerabilityOccurrencesSummary_Pre($grpc.ServiceCall call, $async.Future<$1573.GetVulnerabilityOccurrencesSummaryRequest> request) async {
  ...
  $async.Future<$1573.VulnerabilityOccurrencesSummary> getVulnerabilityOccurrencesSummary($grpc.ServiceCall call, $1573.GetVulnerabilityOccurrencesSummaryRequest request);
}
