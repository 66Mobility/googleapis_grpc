...
class GetVulnerabilityOccurrencesSummaryRequest extends $pb.GeneratedMessage {
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(_omitMessageNames ? '' : 'GetVulnerabilityOccurrencesSummaryRequest', package: const $pb.PackageName(_omitMessageNames ? '' : 'google.devtools.containeranalysis.v1'), createEmptyInstance: create)
...
class VulnerabilityOccurrencesSummary_FixableTotalByDigest extends $pb.GeneratedMessage {
  ...
  @$pb.TagNumber(1)
  set resourceUri($core.String v) { $_setString(0, v); }
  @$pb.TagNumber(1)
...
class VulnerabilityOccurrencesSummary extends $pb.GeneratedMessage {
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(_omitMessageNames ? '' : 'VulnerabilityOccurrencesSummary', package: const $pb.PackageName(_omitMessageNames ? '' : 'google.devtools.containeranalysis.v1'), createEmptyInstance: create)
