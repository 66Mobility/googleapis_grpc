...
class RelatedUrl extends $pb.GeneratedMessage {
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(_omitMessageNames ? '' : 'RelatedUrl', package: const $pb.PackageName(_omitMessageNames ? '' : 'grafeas.v1beta1'), createEmptyInstance: create)
...
class Signature extends $pb.GeneratedMessage {
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(_omitMessageNames ? '' : 'Signature', package: const $pb.PackageName(_omitMessageNames ? '' : 'grafeas.v1beta1'), createEmptyInstance: create)
