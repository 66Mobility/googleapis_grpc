...
class Layer extends $pb.GeneratedMessage {
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(_omitMessageNames ? '' : 'Layer', package: const $pb.PackageName(_omitMessageNames ? '' : 'grafeas.v1beta1.image'), createEmptyInstance: create)
    ..e<Layer_Directive>(1, _omitFieldNames ? '' : 'directive', $pb.PbFieldType.OE, defaultOrMaker: Layer_Directive.DIRECTIVE_UNSPECIFIED, valueOf: Layer_Directive.valueOf, enumValues: Layer_Directive.values)
...
class Fingerprint extends $pb.GeneratedMessage {
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(_omitMessageNames ? '' : 'Fingerprint', package: const $pb.PackageName(_omitMessageNames ? '' : 'grafeas.v1beta1.image'), createEmptyInstance: create)
...
class Basis extends $pb.GeneratedMessage {
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(_omitMessageNames ? '' : 'Basis', package: const $pb.PackageName(_omitMessageNames ? '' : 'grafeas.v1beta1.image'), createEmptyInstance: create)
  ...
  'Use [GeneratedMessageGenericExtensions.rebuild] instead. '
  'Will be removed in next major version')
  Basis copyWith(void Function(Basis) updates) => super.copyWith((message) => updates(message as Basis)) as Basis;
...
class Details extends $pb.GeneratedMessage {
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(_omitMessageNames ? '' : 'Details', package: const $pb.PackageName(_omitMessageNames ? '' : 'grafeas.v1beta1.image'), createEmptyInstance: create)
    ..aOM<Derived>(1, _omitFieldNames ? '' : 'derivedImage', subBuilder: Derived.create)
    ..hasRequiredFields = false
  ;
...
class Derived extends $pb.GeneratedMessage {
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(_omitMessageNames ? '' : 'Derived', package: const $pb.PackageName(_omitMessageNames ? '' : 'grafeas.v1beta1.image'), createEmptyInstance: create)
  ...
  'Use [GeneratedMessageGenericExtensions.rebuild] instead. '
  'Will be removed in next major version')
  Derived copyWith(void Function(Derived) updates) => super.copyWith((message) => updates(message as Derived)) as Derived;
