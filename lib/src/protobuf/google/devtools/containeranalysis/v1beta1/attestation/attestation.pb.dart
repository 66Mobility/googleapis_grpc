...
class PgpSignedAttestation extends $pb.GeneratedMessage {
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(_omitMessageNames ? '' : 'PgpSignedAttestation', package: const $pb.PackageName(_omitMessageNames ? '' : 'grafeas.v1beta1.attestation'), createEmptyInstance: create)
    ..oo(0, [2])
    ..aOS(1, _omitFieldNames ? '' : 'signature')
    ..aOS(2, _omitFieldNames ? '' : 'pgpKeyId')
    ..e<PgpSignedAttestation_ContentType>(3, _omitFieldNames ? '' : 'contentType', $pb.PbFieldType.OE, defaultOrMaker: PgpSignedAttestation_ContentType.CONTENT_TYPE_UNSPECIFIED, valueOf: PgpSignedAttestation_ContentType.valueOf, enumValues: PgpSignedAttestation_ContentType.values)
  ...
  'Will be removed in next major version')
  PgpSignedAttestation copyWith(void Function(PgpSignedAttestation) updates) => super.copyWith((message) => updates(message as PgpSignedAttestation)) as PgpSignedAttestation;
...
class GenericSignedAttestation extends $pb.GeneratedMessage {
  ...
  'Use [GeneratedMessageGenericExtensions.rebuild] instead. '
  'Will be removed in next major version')
  GenericSignedAttestation copyWith(void Function(GenericSignedAttestation) updates) => super.copyWith((message) => updates(message as GenericSignedAttestation)) as GenericSignedAttestation;
...
class Authority_Hint extends $pb.GeneratedMessage {
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(_omitMessageNames ? '' : 'Authority.Hint', package: const $pb.PackageName(_omitMessageNames ? '' : 'grafeas.v1beta1.attestation'), createEmptyInstance: create)
  ...
  'Use [GeneratedMessageGenericExtensions.rebuild] instead. '
  'Will be removed in next major version')
  Authority_Hint copyWith(void Function(Authority_Hint) updates) => super.copyWith((message) => updates(message as Authority_Hint)) as Authority_Hint;
...
class Authority extends $pb.GeneratedMessage {
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(_omitMessageNames ? '' : 'Authority', package: const $pb.PackageName(_omitMessageNames ? '' : 'grafeas.v1beta1.attestation'), createEmptyInstance: create)
    ..aOM<Authority_Hint>(1, _omitFieldNames ? '' : 'hint', subBuilder: Authority_Hint.create)
    ..hasRequiredFields = false
  ;
...
class Details extends $pb.GeneratedMessage {
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(_omitMessageNames ? '' : 'Details', package: const $pb.PackageName(_omitMessageNames ? '' : 'grafeas.v1beta1.attestation'), createEmptyInstance: create)
    ..aOM<Attestation>(1, _omitFieldNames ? '' : 'attestation', subBuilder: Attestation.create)
    ..hasRequiredFields = false
  ;
...
class Attestation extends $pb.GeneratedMessage {
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(_omitMessageNames ? '' : 'Attestation', package: const $pb.PackageName(_omitMessageNames ? '' : 'grafeas.v1beta1.attestation'), createEmptyInstance: create)
    ..oo(0, [1, 2])
    ..aOM<PgpSignedAttestation>(1, _omitFieldNames ? '' : 'pgpSignedAttestation', subBuilder: PgpSignedAttestation.create)
    ..aOM<GenericSignedAttestation>(2, _omitFieldNames ? '' : 'genericSignedAttestation', subBuilder: GenericSignedAttestation.create)
    ..hasRequiredFields = false
  ;
