...
class Details extends $pb.GeneratedMessage {
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(_omitMessageNames ? '' : 'Details', package: const $pb.PackageName(_omitMessageNames ? '' : 'grafeas.v1beta1.discovery'), createEmptyInstance: create)
    ..aOM<Discovered>(1, _omitFieldNames ? '' : 'discovered', subBuilder: Discovered.create)
    ..hasRequiredFields = false
  ;
...
class Discovered extends $pb.GeneratedMessage {
  ...
  'Use [GeneratedMessageGenericExtensions.rebuild] instead. '
  'Will be removed in next major version')
  Discovered copyWith(void Function(Discovered) updates) => super.copyWith((message) => updates(message as Discovered)) as Discovered;
