...
import '../source/source.pb.dart' as $4758;
...
class BuildProvenance extends $pb.GeneratedMessage {
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(_omitMessageNames ? '' : 'BuildProvenance', package: const $pb.PackageName(_omitMessageNames ? '' : 'grafeas.v1beta1.provenance'), createEmptyInstance: create)
    ...
    ..m<$core.String, $core.String>(12, _omitFieldNames ? '' : 'buildOptions', entryClassName: 'BuildProvenance.BuildOptionsEntry', keyFieldType: $pb.PbFieldType.OS, valueFieldType: $pb.PbFieldType.OS, packageName: const $pb.PackageName('grafeas.v1beta1.provenance'))
...
class Source extends $pb.GeneratedMessage {
  factory Source({
    ...
    $4758.SourceContext? context,
    $core.Iterable<$4758.SourceContext>? additionalContexts,
  }) {
    final $result = create();
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(_omitMessageNames ? '' : 'Source', package: const $pb.PackageName(_omitMessageNames ? '' : 'grafeas.v1beta1.provenance'), createEmptyInstance: create)
    ..aOS(1, _omitFieldNames ? '' : 'artifactStorageSourceUri')
    ..m<$core.String, FileHashes>(2, _omitFieldNames ? '' : 'fileHashes', entryClassName: 'Source.FileHashesEntry', keyFieldType: $pb.PbFieldType.OS, valueFieldType: $pb.PbFieldType.OM, valueCreator: FileHashes.create, valueDefaultOrMaker: FileHashes.getDefault, packageName: const $pb.PackageName('grafeas.v1beta1.provenance'))
    ..aOM<$4758.SourceContext>(3, _omitFieldNames ? '' : 'context', subBuilder: $4758.SourceContext.create)
    ..pc<$4758.SourceContext>(4, _omitFieldNames ? '' : 'additionalContexts', $pb.PbFieldType.PM, subBuilder: $4758.SourceContext.create)
    ..hasRequiredFields = false
  ;
  ...
  @$pb.TagNumber(3)
  $4758.SourceContext get context => $_getN(2);
  @$pb.TagNumber(3)
  set context($4758.SourceContext v) { setField(3, v); }
  @$pb.TagNumber(3)
  $core.bool hasContext() => $_has(2);
  @$pb.TagNumber(3)
  void clearContext() => clearField(3);
  @$pb.TagNumber(3)
  $4758.SourceContext ensureContext() => $_ensure(2);
  ...
  /// the context field.
  @$pb.TagNumber(4)
  $core.List<$4758.SourceContext> get additionalContexts => $_getList(3);
}
...
class FileHashes extends $pb.GeneratedMessage {
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(_omitMessageNames ? '' : 'FileHashes', package: const $pb.PackageName(_omitMessageNames ? '' : 'grafeas.v1beta1.provenance'), createEmptyInstance: create)
...
class Hash extends $pb.GeneratedMessage {
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(_omitMessageNames ? '' : 'Hash', package: const $pb.PackageName(_omitMessageNames ? '' : 'grafeas.v1beta1.provenance'), createEmptyInstance: create)
    ..e<Hash_HashType>(1, _omitFieldNames ? '' : 'type', $pb.PbFieldType.OE, defaultOrMaker: Hash_HashType.HASH_TYPE_UNSPECIFIED, valueOf: Hash_HashType.valueOf, enumValues: Hash_HashType.values)
...
class Command extends $pb.GeneratedMessage {
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(_omitMessageNames ? '' : 'Command', package: const $pb.PackageName(_omitMessageNames ? '' : 'grafeas.v1beta1.provenance'), createEmptyInstance: create)
...
class Artifact extends $pb.GeneratedMessage {
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(_omitMessageNames ? '' : 'Artifact', package: const $pb.PackageName(_omitMessageNames ? '' : 'grafeas.v1beta1.provenance'), createEmptyInstance: create)
