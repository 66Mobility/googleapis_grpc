...
class Architecture extends $pb.ProtobufEnum {
  static const Architecture ARCHITECTURE_UNSPECIFIED = Architecture._(0, _omitEnumNames ? '' : 'ARCHITECTURE_UNSPECIFIED');
  static const Architecture X86 = Architecture._(1, _omitEnumNames ? '' : 'X86');
  static const Architecture X64 = Architecture._(2, _omitEnumNames ? '' : 'X64');
...
class Version_VersionKind extends $pb.ProtobufEnum {
  static const Version_VersionKind VERSION_KIND_UNSPECIFIED = Version_VersionKind._(0, _omitEnumNames ? '' : 'VERSION_KIND_UNSPECIFIED');
  static const Version_VersionKind NORMAL = Version_VersionKind._(1, _omitEnumNames ? '' : 'NORMAL');
  static const Version_VersionKind MINIMUM = Version_VersionKind._(2, _omitEnumNames ? '' : 'MINIMUM');
  static const Version_VersionKind MAXIMUM = Version_VersionKind._(3, _omitEnumNames ? '' : 'MAXIMUM');
