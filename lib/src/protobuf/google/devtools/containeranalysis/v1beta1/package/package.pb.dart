...
class Distribution extends $pb.GeneratedMessage {
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(_omitMessageNames ? '' : 'Distribution', package: const $pb.PackageName(_omitMessageNames ? '' : 'grafeas.v1beta1.package'), createEmptyInstance: create)
...
class Location extends $pb.GeneratedMessage {
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(_omitMessageNames ? '' : 'Location', package: const $pb.PackageName(_omitMessageNames ? '' : 'grafeas.v1beta1.package'), createEmptyInstance: create)
    ..aOS(1, _omitFieldNames ? '' : 'cpeUri')
...
class Package extends $pb.GeneratedMessage {
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(_omitMessageNames ? '' : 'Package', package: const $pb.PackageName(_omitMessageNames ? '' : 'grafeas.v1beta1.package'), createEmptyInstance: create)
...
class Details extends $pb.GeneratedMessage {
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(_omitMessageNames ? '' : 'Details', package: const $pb.PackageName(_omitMessageNames ? '' : 'grafeas.v1beta1.package'), createEmptyInstance: create)
    ..aOM<Installation>(1, _omitFieldNames ? '' : 'installation', subBuilder: Installation.create)
    ..hasRequiredFields = false
  ;
...
class Installation extends $pb.GeneratedMessage {
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(_omitMessageNames ? '' : 'Installation', package: const $pb.PackageName(_omitMessageNames ? '' : 'grafeas.v1beta1.package'), createEmptyInstance: create)
    ..aOS(1, _omitFieldNames ? '' : 'name')
...
class Version extends $pb.GeneratedMessage {
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(_omitMessageNames ? '' : 'Version', package: const $pb.PackageName(_omitMessageNames ? '' : 'grafeas.v1beta1.package'), createEmptyInstance: create)
