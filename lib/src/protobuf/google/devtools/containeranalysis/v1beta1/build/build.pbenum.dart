...
class BuildSignature_KeyType extends $pb.ProtobufEnum {
  static const BuildSignature_KeyType KEY_TYPE_UNSPECIFIED = BuildSignature_KeyType._(0, _omitEnumNames ? '' : 'KEY_TYPE_UNSPECIFIED');
  static const BuildSignature_KeyType PGP_ASCII_ARMORED = BuildSignature_KeyType._(1, _omitEnumNames ? '' : 'PGP_ASCII_ARMORED');
  static const BuildSignature_KeyType PKIX_PEM = BuildSignature_KeyType._(2, _omitEnumNames ? '' : 'PKIX_PEM');
