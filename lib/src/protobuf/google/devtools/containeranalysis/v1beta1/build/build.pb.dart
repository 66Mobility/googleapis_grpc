...
class Build extends $pb.GeneratedMessage {
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(_omitMessageNames ? '' : 'Build', package: const $pb.PackageName(_omitMessageNames ? '' : 'grafeas.v1beta1.build'), createEmptyInstance: create)
    ..aOS(1, _omitFieldNames ? '' : 'builderVersion')
    ..aOM<BuildSignature>(2, _omitFieldNames ? '' : 'signature', subBuilder: BuildSignature.create)
...
class BuildSignature extends $pb.GeneratedMessage {
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(_omitMessageNames ? '' : 'BuildSignature', package: const $pb.PackageName(_omitMessageNames ? '' : 'grafeas.v1beta1.build'), createEmptyInstance: create)
    ...
    ..e<BuildSignature_KeyType>(4, _omitFieldNames ? '' : 'keyType', $pb.PbFieldType.OE, defaultOrMaker: BuildSignature_KeyType.KEY_TYPE_UNSPECIFIED, valueOf: BuildSignature_KeyType.valueOf, enumValues: BuildSignature_KeyType.values)
    ..hasRequiredFields = false
  ;
  ...
  'Use [GeneratedMessageGenericExtensions.rebuild] instead. '
  'Will be removed in next major version')
  BuildSignature copyWith(void Function(BuildSignature) updates) => super.copyWith((message) => updates(message as BuildSignature)) as BuildSignature;
