...
class Deployment_Platform extends $pb.ProtobufEnum {
  static const Deployment_Platform PLATFORM_UNSPECIFIED = Deployment_Platform._(0, _omitEnumNames ? '' : 'PLATFORM_UNSPECIFIED');
  static const Deployment_Platform GKE = Deployment_Platform._(1, _omitEnumNames ? '' : 'GKE');
  static const Deployment_Platform FLEX = Deployment_Platform._(2, _omitEnumNames ? '' : 'FLEX');
  static const Deployment_Platform CUSTOM = Deployment_Platform._(3, _omitEnumNames ? '' : 'CUSTOM');
