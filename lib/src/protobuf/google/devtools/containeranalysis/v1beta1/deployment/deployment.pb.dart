...
class Deployable extends $pb.GeneratedMessage {
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(_omitMessageNames ? '' : 'Deployable', package: const $pb.PackageName(_omitMessageNames ? '' : 'grafeas.v1beta1.deployment'), createEmptyInstance: create)
  ...
  'Will be removed in next major version')
  Deployable copyWith(void Function(Deployable) updates) => super.copyWith((message) => updates(message as Deployable)) as Deployable;
...
class Details extends $pb.GeneratedMessage {
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(_omitMessageNames ? '' : 'Details', package: const $pb.PackageName(_omitMessageNames ? '' : 'grafeas.v1beta1.deployment'), createEmptyInstance: create)
...
class Deployment extends $pb.GeneratedMessage {
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(_omitMessageNames ? '' : 'Deployment', package: const $pb.PackageName(_omitMessageNames ? '' : 'grafeas.v1beta1.deployment'), createEmptyInstance: create)
    ...
    ..e<Deployment_Platform>(7, _omitFieldNames ? '' : 'platform', $pb.PbFieldType.OE, defaultOrMaker: Deployment_Platform.PLATFORM_UNSPECIFIED, valueOf: Deployment_Platform.valueOf, enumValues: Deployment_Platform.values)
    ..hasRequiredFields = false
  ;
