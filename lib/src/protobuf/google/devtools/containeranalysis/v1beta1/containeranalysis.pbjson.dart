...
final $typed_data.Uint8List generatePackagesSummaryRequestDescriptor = $convert.base64Decode(
...
const PackagesSummaryResponse$json = {
  ...
  '2': [
    ...
    {'1': 'licenses_summary', '3': 2, '4': 3, '5': 11, '6': '.google.devtools.containeranalysis.v1beta1.PackagesSummaryResponse.LicensesSummary', '10': 'licensesSummary'},
  ],
...
const ExportSBOMResponse$json = {
  ...
  '2': [
    {'1': 'discovery_occurrence_id', '3': 1, '4': 1, '5': 9, '10': 'discoveryOccurrenceId'},
  ],
};
