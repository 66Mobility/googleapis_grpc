...
class CVSSv3 extends $pb.GeneratedMessage {
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(_omitMessageNames ? '' : 'CVSSv3', package: const $pb.PackageName(_omitMessageNames ? '' : 'grafeas.v1beta1.vulnerability'), createEmptyInstance: create)
