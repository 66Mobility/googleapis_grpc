...
class PublishLifecycleEventRequest extends $pb.GeneratedMessage {
  factory PublishLifecycleEventRequest({
    ...
    if (checkPrecedingLifecycleEventsPresent != null) {
      $result.checkPrecedingLifecycleEventsPresent = checkPrecedingLifecycleEventsPresent;
    }
    return $result;
  }
  ...
  'Will be removed in next major version')
  PublishLifecycleEventRequest copyWith(void Function(PublishLifecycleEventRequest) updates) => super.copyWith((message) => updates(message as PublishLifecycleEventRequest)) as PublishLifecycleEventRequest;
...
class PublishBuildToolEventStreamResponse extends $pb.GeneratedMessage {
  ...
  'Use [GeneratedMessageGenericExtensions.rebuild] instead. '
  'Will be removed in next major version')
  PublishBuildToolEventStreamResponse copyWith(void Function(PublishBuildToolEventStreamResponse) updates) => super.copyWith((message) => updates(message as PublishBuildToolEventStreamResponse)) as PublishBuildToolEventStreamResponse;
...
class OrderedBuildEvent extends $pb.GeneratedMessage {
  ...
  'Use [GeneratedMessageGenericExtensions.rebuild] instead. '
  'Will be removed in next major version')
  OrderedBuildEvent copyWith(void Function(OrderedBuildEvent) updates) => super.copyWith((message) => updates(message as OrderedBuildEvent)) as OrderedBuildEvent;
...
class PublishBuildToolEventStreamRequest extends $pb.GeneratedMessage {
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(_omitMessageNames ? '' : 'PublishBuildToolEventStreamRequest', package: const $pb.PackageName(_omitMessageNames ? '' : 'google.devtools.build.v1'), createEmptyInstance: create)
    ..aOM<OrderedBuildEvent>(4, _omitFieldNames ? '' : 'orderedBuildEvent', subBuilder: OrderedBuildEvent.create)
  ...
  'Use [GeneratedMessageGenericExtensions.rebuild] instead. '
  'Will be removed in next major version')
  PublishBuildToolEventStreamRequest copyWith(void Function(PublishBuildToolEventStreamRequest) updates) => super.copyWith((message) => updates(message as PublishBuildToolEventStreamRequest)) as PublishBuildToolEventStreamRequest;
