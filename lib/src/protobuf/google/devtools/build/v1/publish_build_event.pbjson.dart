...
const PublishLifecycleEventRequest$json = {
  ...
  '2': [
    {'1': 'service_level', '3': 1, '4': 1, '5': 14, '6': '.google.devtools.build.v1.PublishLifecycleEventRequest.ServiceLevel', '10': 'serviceLevel'},
    {'1': 'build_event', '3': 2, '4': 1, '5': 11, '6': '.google.devtools.build.v1.OrderedBuildEvent', '8': {}, '10': 'buildEvent'},
    {'1': 'stream_timeout', '3': 3, '4': 1, '5': 11, '6': '.google.protobuf.Duration', '10': 'streamTimeout'},
    {'1': 'notification_keywords', '3': 4, '4': 3, '5': 9, '10': 'notificationKeywords'},
    {'1': 'project_id', '3': 6, '4': 1, '5': 9, '8': {}, '10': 'projectId'},
    {'1': 'check_preceding_lifecycle_events_present', '3': 7, '4': 1, '5': 8, '10': 'checkPrecedingLifecycleEventsPresent'},
  ],
...
const PublishBuildToolEventStreamResponse$json = {
  ...
  '2': [
    {'1': 'stream_id', '3': 1, '4': 1, '5': 11, '6': '.google.devtools.build.v1.StreamId', '10': 'streamId'},
...
final $typed_data.Uint8List publishBuildToolEventStreamResponseDescriptor = $convert.base64Decode(
...
const OrderedBuildEvent$json = {
  ...
  '2': [
    {'1': 'stream_id', '3': 1, '4': 1, '5': 11, '6': '.google.devtools.build.v1.StreamId', '10': 'streamId'},
    {'1': 'sequence_number', '3': 2, '4': 1, '5': 3, '10': 'sequenceNumber'},
    {'1': 'event', '3': 3, '4': 1, '5': 11, '6': '.google.devtools.build.v1.BuildEvent', '10': 'event'},
  ],
};
...
const PublishBuildToolEventStreamRequest$json = {
  ...
  '2': [
    {'1': 'ordered_build_event', '3': 4, '4': 1, '5': 11, '6': '.google.devtools.build.v1.OrderedBuildEvent', '8': {}, '10': 'orderedBuildEvent'},
    {'1': 'notification_keywords', '3': 5, '4': 3, '5': 9, '10': 'notificationKeywords'},
    {'1': 'project_id', '3': 6, '4': 1, '5': 9, '8': {}, '10': 'projectId'},
    {'1': 'check_preceding_lifecycle_events_present', '3': 7, '4': 1, '5': 8, '10': 'checkPrecedingLifecycleEventsPresent'},
  ],
};
