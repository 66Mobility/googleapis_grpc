...
class ConsoleOutputStream extends $pb.ProtobufEnum {
  static const ConsoleOutputStream UNKNOWN = ConsoleOutputStream._(0, _omitEnumNames ? '' : 'UNKNOWN');
  static const ConsoleOutputStream STDOUT = ConsoleOutputStream._(1, _omitEnumNames ? '' : 'STDOUT');
  static const ConsoleOutputStream STDERR = ConsoleOutputStream._(2, _omitEnumNames ? '' : 'STDERR');
...
class BuildEvent_BuildComponentStreamFinished_FinishType extends $pb.ProtobufEnum {
  static const BuildEvent_BuildComponentStreamFinished_FinishType FINISH_TYPE_UNSPECIFIED = BuildEvent_BuildComponentStreamFinished_FinishType._(0, _omitEnumNames ? '' : 'FINISH_TYPE_UNSPECIFIED');
  static const BuildEvent_BuildComponentStreamFinished_FinishType FINISHED = BuildEvent_BuildComponentStreamFinished_FinishType._(1, _omitEnumNames ? '' : 'FINISHED');
  static const BuildEvent_BuildComponentStreamFinished_FinishType EXPIRED = BuildEvent_BuildComponentStreamFinished_FinishType._(2, _omitEnumNames ? '' : 'EXPIRED');
...
class StreamId_BuildComponent extends $pb.ProtobufEnum {
  static const StreamId_BuildComponent UNKNOWN_COMPONENT = StreamId_BuildComponent._(0, _omitEnumNames ? '' : 'UNKNOWN_COMPONENT');
  static const StreamId_BuildComponent CONTROLLER = StreamId_BuildComponent._(1, _omitEnumNames ? '' : 'CONTROLLER');
  static const StreamId_BuildComponent WORKER = StreamId_BuildComponent._(2, _omitEnumNames ? '' : 'WORKER');
  static const StreamId_BuildComponent TOOL = StreamId_BuildComponent._(3, _omitEnumNames ? '' : 'TOOL');
