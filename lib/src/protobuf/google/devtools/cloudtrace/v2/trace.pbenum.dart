...
class Span_SpanKind extends $pb.ProtobufEnum {
  ...
  static const Span_SpanKind INTERNAL = Span_SpanKind._(1, _omitEnumNames ? '' : 'INTERNAL');
  static const Span_SpanKind SERVER = Span_SpanKind._(2, _omitEnumNames ? '' : 'SERVER');
  static const Span_SpanKind CLIENT = Span_SpanKind._(3, _omitEnumNames ? '' : 'CLIENT');
  static const Span_SpanKind PRODUCER = Span_SpanKind._(4, _omitEnumNames ? '' : 'PRODUCER');
  static const Span_SpanKind CONSUMER = Span_SpanKind._(5, _omitEnumNames ? '' : 'CONSUMER');
...
class Span_TimeEvent_MessageEvent_Type extends $pb.ProtobufEnum {
  static const Span_TimeEvent_MessageEvent_Type TYPE_UNSPECIFIED = Span_TimeEvent_MessageEvent_Type._(0, _omitEnumNames ? '' : 'TYPE_UNSPECIFIED');
  static const Span_TimeEvent_MessageEvent_Type SENT = Span_TimeEvent_MessageEvent_Type._(1, _omitEnumNames ? '' : 'SENT');
  static const Span_TimeEvent_MessageEvent_Type RECEIVED = Span_TimeEvent_MessageEvent_Type._(2, _omitEnumNames ? '' : 'RECEIVED');
...
class Span_Link_Type extends $pb.ProtobufEnum {
  static const Span_Link_Type TYPE_UNSPECIFIED = Span_Link_Type._(0, _omitEnumNames ? '' : 'TYPE_UNSPECIFIED');
  static const Span_Link_Type CHILD_LINKED_SPAN = Span_Link_Type._(1, _omitEnumNames ? '' : 'CHILD_LINKED_SPAN');
  static const Span_Link_Type PARENT_LINKED_SPAN = Span_Link_Type._(2, _omitEnumNames ? '' : 'PARENT_LINKED_SPAN');
