...
class Configuration_Id extends $pb.GeneratedMessage {
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(_omitMessageNames ? '' : 'Configuration.Id', package: const $pb.PackageName(_omitMessageNames ? '' : 'google.devtools.resultstore.v2'), createEmptyInstance: create)
  ...
  'Will be removed in next major version')
  Configuration_Id copyWith(void Function(Configuration_Id) updates) => super.copyWith((message) => updates(message as Configuration_Id)) as Configuration_Id;
...
class ConfigurationAttributes extends $pb.GeneratedMessage {
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(_omitMessageNames ? '' : 'ConfigurationAttributes', package: const $pb.PackageName(_omitMessageNames ? '' : 'google.devtools.resultstore.v2'), createEmptyInstance: create)
  ...
  'Use [GeneratedMessageGenericExtensions.rebuild] instead. '
  'Will be removed in next major version')
  ConfigurationAttributes copyWith(void Function(ConfigurationAttributes) updates) => super.copyWith((message) => updates(message as ConfigurationAttributes)) as ConfigurationAttributes;
