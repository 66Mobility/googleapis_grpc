...
class LineCoverage extends $pb.GeneratedMessage {
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(_omitMessageNames ? '' : 'LineCoverage', package: const $pb.PackageName(_omitMessageNames ? '' : 'google.devtools.resultstore.v2'), createEmptyInstance: create)
    ..a<$core.List<$core.int>>(1, _omitFieldNames ? '' : 'instrumentedLines', $pb.PbFieldType.OY)
    ..a<$core.List<$core.int>>(2, _omitFieldNames ? '' : 'executedLines', $pb.PbFieldType.OY)
  ...
  'Will be removed in next major version')
  LineCoverage copyWith(void Function(LineCoverage) updates) => super.copyWith((message) => updates(message as LineCoverage)) as LineCoverage;
...
class BranchCoverage extends $pb.GeneratedMessage {
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(_omitMessageNames ? '' : 'BranchCoverage', package: const $pb.PackageName(_omitMessageNames ? '' : 'google.devtools.resultstore.v2'), createEmptyInstance: create)
    ..a<$core.List<$core.int>>(1, _omitFieldNames ? '' : 'branchPresent', $pb.PbFieldType.OY)
    ..p<$core.int>(2, _omitFieldNames ? '' : 'branchesInLine', $pb.PbFieldType.K3)
    ..a<$core.List<$core.int>>(3, _omitFieldNames ? '' : 'executed', $pb.PbFieldType.OY)
    ..a<$core.List<$core.int>>(4, _omitFieldNames ? '' : 'taken', $pb.PbFieldType.OY)
    ..hasRequiredFields = false
  ;
  ...
  'Use [GeneratedMessageGenericExtensions.rebuild] instead. '
  'Will be removed in next major version')
  BranchCoverage copyWith(void Function(BranchCoverage) updates) => super.copyWith((message) => updates(message as BranchCoverage)) as BranchCoverage;
...
class FileCoverage extends $pb.GeneratedMessage {
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(_omitMessageNames ? '' : 'FileCoverage', package: const $pb.PackageName(_omitMessageNames ? '' : 'google.devtools.resultstore.v2'), createEmptyInstance: create)
    ..aOS(1, _omitFieldNames ? '' : 'path')
    ..aOM<LineCoverage>(2, _omitFieldNames ? '' : 'lineCoverage', subBuilder: LineCoverage.create)
    ..aOM<BranchCoverage>(3, _omitFieldNames ? '' : 'branchCoverage', subBuilder: BranchCoverage.create)
    ..hasRequiredFields = false
  ;
  ...
  'Use [GeneratedMessageGenericExtensions.rebuild] instead. '
  'Will be removed in next major version')
  FileCoverage copyWith(void Function(FileCoverage) updates) => super.copyWith((message) => updates(message as FileCoverage)) as FileCoverage;
...
class ActionCoverage extends $pb.GeneratedMessage {
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(_omitMessageNames ? '' : 'ActionCoverage', package: const $pb.PackageName(_omitMessageNames ? '' : 'google.devtools.resultstore.v2'), createEmptyInstance: create)
    ..pc<FileCoverage>(2, _omitFieldNames ? '' : 'fileCoverages', $pb.PbFieldType.PM, subBuilder: FileCoverage.create)
    ..hasRequiredFields = false
  ;
  ...
  'Use [GeneratedMessageGenericExtensions.rebuild] instead. '
  'Will be removed in next major version')
  ActionCoverage copyWith(void Function(ActionCoverage) updates) => super.copyWith((message) => updates(message as ActionCoverage)) as ActionCoverage;
...
class AggregateCoverage extends $pb.GeneratedMessage {
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(_omitMessageNames ? '' : 'AggregateCoverage', package: const $pb.PackageName(_omitMessageNames ? '' : 'google.devtools.resultstore.v2'), createEmptyInstance: create)
    ..pc<FileCoverage>(1, _omitFieldNames ? '' : 'fileCoverages', $pb.PbFieldType.PM, subBuilder: FileCoverage.create)
    ..hasRequiredFields = false
  ;
  ...
  'Use [GeneratedMessageGenericExtensions.rebuild] instead. '
  'Will be removed in next major version')
  AggregateCoverage copyWith(void Function(AggregateCoverage) updates) => super.copyWith((message) => updates(message as AggregateCoverage)) as AggregateCoverage;
