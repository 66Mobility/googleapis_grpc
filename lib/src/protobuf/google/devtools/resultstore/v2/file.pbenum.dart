...
class File_HashType extends $pb.ProtobufEnum {
  static const File_HashType HASH_TYPE_UNSPECIFIED = File_HashType._(0, _omitEnumNames ? '' : 'HASH_TYPE_UNSPECIFIED');
  static const File_HashType MD5 = File_HashType._(1, _omitEnumNames ? '' : 'MD5');
  static const File_HashType SHA1 = File_HashType._(2, _omitEnumNames ? '' : 'SHA1');
  static const File_HashType SHA256 = File_HashType._(3, _omitEnumNames ? '' : 'SHA256');
