...
class LineCoverageSummary extends $pb.GeneratedMessage {
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(_omitMessageNames ? '' : 'LineCoverageSummary', package: const $pb.PackageName(_omitMessageNames ? '' : 'google.devtools.resultstore.v2'), createEmptyInstance: create)
    ..a<$core.int>(1, _omitFieldNames ? '' : 'instrumentedLineCount', $pb.PbFieldType.O3)
    ..a<$core.int>(2, _omitFieldNames ? '' : 'executedLineCount', $pb.PbFieldType.O3)
  ...
  'Will be removed in next major version')
  LineCoverageSummary copyWith(void Function(LineCoverageSummary) updates) => super.copyWith((message) => updates(message as LineCoverageSummary)) as LineCoverageSummary;
...
class BranchCoverageSummary extends $pb.GeneratedMessage {
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(_omitMessageNames ? '' : 'BranchCoverageSummary', package: const $pb.PackageName(_omitMessageNames ? '' : 'google.devtools.resultstore.v2'), createEmptyInstance: create)
    ..a<$core.int>(1, _omitFieldNames ? '' : 'totalBranchCount', $pb.PbFieldType.O3)
    ..a<$core.int>(2, _omitFieldNames ? '' : 'executedBranchCount', $pb.PbFieldType.O3)
    ..a<$core.int>(3, _omitFieldNames ? '' : 'takenBranchCount', $pb.PbFieldType.O3)
    ..hasRequiredFields = false
  ;
  ...
  'Use [GeneratedMessageGenericExtensions.rebuild] instead. '
  'Will be removed in next major version')
  BranchCoverageSummary copyWith(void Function(BranchCoverageSummary) updates) => super.copyWith((message) => updates(message as BranchCoverageSummary)) as BranchCoverageSummary;
...
class LanguageCoverageSummary extends $pb.GeneratedMessage {
  ...
  'Use [GeneratedMessageGenericExtensions.rebuild] instead. '
  'Will be removed in next major version')
  LanguageCoverageSummary copyWith(void Function(LanguageCoverageSummary) updates) => super.copyWith((message) => updates(message as LanguageCoverageSummary)) as LanguageCoverageSummary;
