...
class File extends $pb.GeneratedMessage {
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(_omitMessageNames ? '' : 'File', package: const $pb.PackageName(_omitMessageNames ? '' : 'google.devtools.resultstore.v2'), createEmptyInstance: create)
    ...
    ..e<File_HashType>(10, _omitFieldNames ? '' : 'hashType', $pb.PbFieldType.OE, defaultOrMaker: File_HashType.HASH_TYPE_UNSPECIFIED, valueOf: File_HashType.valueOf, enumValues: File_HashType.values)
...
class ArchiveEntry extends $pb.GeneratedMessage {
  ...
  'Use [GeneratedMessageGenericExtensions.rebuild] instead. '
  'Will be removed in next major version')
  ArchiveEntry copyWith(void Function(ArchiveEntry) updates) => super.copyWith((message) => updates(message as ArchiveEntry)) as ArchiveEntry;
