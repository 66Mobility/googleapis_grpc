...
class Target_Id extends $pb.GeneratedMessage {
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(_omitMessageNames ? '' : 'Target.Id', package: const $pb.PackageName(_omitMessageNames ? '' : 'google.devtools.resultstore.v2'), createEmptyInstance: create)
  ...
  'Will be removed in next major version')
  Target_Id copyWith(void Function(Target_Id) updates) => super.copyWith((message) => updates(message as Target_Id)) as Target_Id;
...
class TargetAttributes extends $pb.GeneratedMessage {
  ...
  'Use [GeneratedMessageGenericExtensions.rebuild] instead. '
  'Will be removed in next major version')
  TargetAttributes copyWith(void Function(TargetAttributes) updates) => super.copyWith((message) => updates(message as TargetAttributes)) as TargetAttributes;
...
class TestAttributes extends $pb.GeneratedMessage {
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(_omitMessageNames ? '' : 'TestAttributes', package: const $pb.PackageName(_omitMessageNames ? '' : 'google.devtools.resultstore.v2'), createEmptyInstance: create)
    ..e<TestSize>(1, _omitFieldNames ? '' : 'size', $pb.PbFieldType.OE, defaultOrMaker: TestSize.TEST_SIZE_UNSPECIFIED, valueOf: TestSize.valueOf, enumValues: TestSize.values)
    ..hasRequiredFields = false
  ;
  ...
  'Use [GeneratedMessageGenericExtensions.rebuild] instead. '
  'Will be removed in next major version')
  TestAttributes copyWith(void Function(TestAttributes) updates) => super.copyWith((message) => updates(message as TestAttributes)) as TestAttributes;
