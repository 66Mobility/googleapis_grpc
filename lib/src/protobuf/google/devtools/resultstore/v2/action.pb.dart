...
import 'test_suite.pb.dart' as $4775;
...
class Action extends $pb.GeneratedMessage {
  factory Action({
    ...
    $4773.ActionCoverage? coverage,
    $core.Iterable<$4774.FileProcessingErrors>? fileProcessingErrors,
    $core.Iterable<$4771.Dependency>? actionDependencies,
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(_omitMessageNames ? '' : 'Action', package: const $pb.PackageName(_omitMessageNames ? '' : 'google.devtools.resultstore.v2'), createEmptyInstance: create)
    ...
    ..aOM<$4773.ActionCoverage>(11, _omitFieldNames ? '' : 'coverage', subBuilder: $4773.ActionCoverage.create)
    ..pc<$4774.FileProcessingErrors>(13, _omitFieldNames ? '' : 'fileProcessingErrors', $pb.PbFieldType.PM, subBuilder: $4774.FileProcessingErrors.create)
    ..pc<$4771.Dependency>(14, _omitFieldNames ? '' : 'actionDependencies', $pb.PbFieldType.PM, subBuilder: $4771.Dependency.create)
  ...
  @$pb.TagNumber(11)
  $4773.ActionCoverage get coverage => $_getN(9);
  @$pb.TagNumber(11)
  set coverage($4773.ActionCoverage v) { setField(11, v); }
  @$pb.TagNumber(11)
  $core.bool hasCoverage() => $_has(9);
  @$pb.TagNumber(11)
  void clearCoverage() => clearField(11);
  @$pb.TagNumber(11)
  $4773.ActionCoverage ensureCoverage() => $_ensure(9);
  ...
  @$pb.TagNumber(14)
  $core.List<$4771.Dependency> get actionDependencies => $_getList(11);
...
class TestAction extends $pb.GeneratedMessage {
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(_omitMessageNames ? '' : 'TestAction', package: const $pb.PackageName(_omitMessageNames ? '' : 'google.devtools.resultstore.v2'), createEmptyInstance: create)
    ...
    ..aOM<$4775.TestSuite>(5, _omitFieldNames ? '' : 'testSuite', subBuilder: $4775.TestSuite.create)
  ...
  /// by clients.
  @$pb.TagNumber(5)
  $4775.TestSuite get testSuite => $_getN(4);
  @$pb.TagNumber(5)
  set testSuite($4775.TestSuite v) { setField(5, v); }
  @$pb.TagNumber(5)
  $core.bool hasTestSuite() => $_has(4);
  @$pb.TagNumber(5)
  void clearTestSuite() => clearField(5);
  @$pb.TagNumber(5)
  $4775.TestSuite ensureTestSuite() => $_ensure(4);
...
class LocalTestTiming extends $pb.GeneratedMessage {
  factory LocalTestTiming({
    $1738.Duration? testProcessDuration,
  }) {
    final $result = create();
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(_omitMessageNames ? '' : 'LocalTestTiming', package: const $pb.PackageName(_omitMessageNames ? '' : 'google.devtools.resultstore.v2'), createEmptyInstance: create)
    ..aOM<$1738.Duration>(1, _omitFieldNames ? '' : 'testProcessDuration', subBuilder: $1738.Duration.create)
    ..hasRequiredFields = false
  ;
  ...
  /// script.
  @$pb.TagNumber(1)
  $1738.Duration get testProcessDuration => $_getN(0);
  @$pb.TagNumber(1)
  set testProcessDuration($1738.Duration v) { setField(1, v); }
  @$pb.TagNumber(1)
  $core.bool hasTestProcessDuration() => $_has(0);
  @$pb.TagNumber(1)
  void clearTestProcessDuration() => clearField(1);
  @$pb.TagNumber(1)
  $1738.Duration ensureTestProcessDuration() => $_ensure(0);
}
...
class RemoteTestAttemptTiming extends $pb.GeneratedMessage {
  factory RemoteTestAttemptTiming({
    $1738.Duration? queueDuration,
    $1738.Duration? uploadDuration,
    $1738.Duration? machineSetupDuration,
    $1738.Duration? testProcessDuration,
    $1738.Duration? downloadDuration,
  }) {
    final $result = create();
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(_omitMessageNames ? '' : 'RemoteTestAttemptTiming', package: const $pb.PackageName(_omitMessageNames ? '' : 'google.devtools.resultstore.v2'), createEmptyInstance: create)
    ..aOM<$1738.Duration>(1, _omitFieldNames ? '' : 'queueDuration', subBuilder: $1738.Duration.create)
    ..aOM<$1738.Duration>(2, _omitFieldNames ? '' : 'uploadDuration', subBuilder: $1738.Duration.create)
    ..aOM<$1738.Duration>(3, _omitFieldNames ? '' : 'machineSetupDuration', subBuilder: $1738.Duration.create)
    ..aOM<$1738.Duration>(4, _omitFieldNames ? '' : 'testProcessDuration', subBuilder: $1738.Duration.create)
    ..aOM<$1738.Duration>(5, _omitFieldNames ? '' : 'downloadDuration', subBuilder: $1738.Duration.create)
    ..hasRequiredFields = false
  ;
  ...
  @$pb.TagNumber(1)
  $1738.Duration get queueDuration => $_getN(0);
  @$pb.TagNumber(1)
  set queueDuration($1738.Duration v) { setField(1, v); }
  @$pb.TagNumber(1)
  $core.bool hasQueueDuration() => $_has(0);
  @$pb.TagNumber(1)
  void clearQueueDuration() => clearField(1);
  @$pb.TagNumber(1)
  $1738.Duration ensureQueueDuration() => $_ensure(0);
  ...
  @$pb.TagNumber(2)
  $1738.Duration get uploadDuration => $_getN(1);
  @$pb.TagNumber(2)
  set uploadDuration($1738.Duration v) { setField(2, v); }
  @$pb.TagNumber(2)
  $core.bool hasUploadDuration() => $_has(1);
  @$pb.TagNumber(2)
  void clearUploadDuration() => clearField(2);
  @$pb.TagNumber(2)
  $1738.Duration ensureUploadDuration() => $_ensure(1);
  ...
  @$pb.TagNumber(3)
  $1738.Duration get machineSetupDuration => $_getN(2);
  @$pb.TagNumber(3)
  set machineSetupDuration($1738.Duration v) { setField(3, v); }
  @$pb.TagNumber(3)
  $core.bool hasMachineSetupDuration() => $_has(2);
  @$pb.TagNumber(3)
  void clearMachineSetupDuration() => clearField(3);
  @$pb.TagNumber(3)
  $1738.Duration ensureMachineSetupDuration() => $_ensure(2);
  ...
  @$pb.TagNumber(4)
  $1738.Duration get testProcessDuration => $_getN(3);
  @$pb.TagNumber(4)
  set testProcessDuration($1738.Duration v) { setField(4, v); }
  @$pb.TagNumber(4)
  $core.bool hasTestProcessDuration() => $_has(3);
  @$pb.TagNumber(4)
  void clearTestProcessDuration() => clearField(4);
  @$pb.TagNumber(4)
  $1738.Duration ensureTestProcessDuration() => $_ensure(3);

  /// Time spent retrieving test logs and any other test outputs, back to the
  /// local machine.
  @$pb.TagNumber(5)
  $1738.Duration get downloadDuration => $_getN(4);
  @$pb.TagNumber(5)
  set downloadDuration($1738.Duration v) { setField(5, v); }
  @$pb.TagNumber(5)
  $core.bool hasDownloadDuration() => $_has(4);
  @$pb.TagNumber(5)
  void clearDownloadDuration() => clearField(5);
  @$pb.TagNumber(5)
  $1738.Duration ensureDownloadDuration() => $_ensure(4);
}
...
class RemoteTestTiming extends $pb.GeneratedMessage {
  factory RemoteTestTiming({
    $1738.Duration? localAnalysisDuration,
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(_omitMessageNames ? '' : 'RemoteTestTiming', package: const $pb.PackageName(_omitMessageNames ? '' : 'google.devtools.resultstore.v2'), createEmptyInstance: create)
    ..aOM<$1738.Duration>(1, _omitFieldNames ? '' : 'localAnalysisDuration', subBuilder: $1738.Duration.create)
  ...
  @$pb.TagNumber(1)
  $1738.Duration get localAnalysisDuration => $_getN(0);
  @$pb.TagNumber(1)
  set localAnalysisDuration($1738.Duration v) { setField(1, v); }
  @$pb.TagNumber(1)
  $core.bool hasLocalAnalysisDuration() => $_has(0);
  @$pb.TagNumber(1)
  void clearLocalAnalysisDuration() => clearField(1);
  @$pb.TagNumber(1)
  $1738.Duration ensureLocalAnalysisDuration() => $_ensure(0);
...
class TestTiming extends $pb.GeneratedMessage {
  factory TestTiming({
    ...
    $1738.Duration? systemTimeDuration,
    $1738.Duration? userTimeDuration,
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(_omitMessageNames ? '' : 'TestTiming', package: const $pb.PackageName(_omitMessageNames ? '' : 'google.devtools.resultstore.v2'), createEmptyInstance: create)
    ...
    ..aOM<$1738.Duration>(3, _omitFieldNames ? '' : 'systemTimeDuration', subBuilder: $1738.Duration.create)
    ..aOM<$1738.Duration>(4, _omitFieldNames ? '' : 'userTimeDuration', subBuilder: $1738.Duration.create)
  ...
  @$pb.TagNumber(3)
  $1738.Duration get systemTimeDuration => $_getN(2);
  @$pb.TagNumber(3)
  set systemTimeDuration($1738.Duration v) { setField(3, v); }
  @$pb.TagNumber(3)
  $core.bool hasSystemTimeDuration() => $_has(2);
  @$pb.TagNumber(3)
  void clearSystemTimeDuration() => clearField(3);
  @$pb.TagNumber(3)
  $1738.Duration ensureSystemTimeDuration() => $_ensure(2);
  ...
  @$pb.TagNumber(4)
  $1738.Duration get userTimeDuration => $_getN(3);
  @$pb.TagNumber(4)
  set userTimeDuration($1738.Duration v) { setField(4, v); }
  @$pb.TagNumber(4)
  $core.bool hasUserTimeDuration() => $_has(3);
  @$pb.TagNumber(4)
  void clearUserTimeDuration() => clearField(4);
  @$pb.TagNumber(4)
  $1738.Duration ensureUserTimeDuration() => $_ensure(3);
