...
import 'test_suite.pb.dart' as $4773;
...
class Action_Id extends $pb.GeneratedMessage {
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(_omitMessageNames ? '' : 'Action.Id', package: const $pb.PackageName(_omitMessageNames ? '' : 'google.devtools.resultstore.v2'), createEmptyInstance: create)
  ...
  'Will be removed in next major version')
  Action_Id copyWith(void Function(Action_Id) updates) => super.copyWith((message) => updates(message as Action_Id)) as Action_Id;
...
class Action extends $pb.GeneratedMessage {
  factory Action({
    ...
    $4771.ActionCoverage? coverage,
    $core.Iterable<$4772.FileProcessingErrors>? fileProcessingErrors,
    $core.Iterable<$4769.Dependency>? actionDependencies,
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(_omitMessageNames ? '' : 'Action', package: const $pb.PackageName(_omitMessageNames ? '' : 'google.devtools.resultstore.v2'), createEmptyInstance: create)
    ..oo(0, [9, 10])
    ..aOS(1, _omitFieldNames ? '' : 'name')
    ..aOM<Action_Id>(2, _omitFieldNames ? '' : 'id', subBuilder: Action_Id.create)
    ...
    ..aOM<ActionAttributes>(5, _omitFieldNames ? '' : 'actionAttributes', subBuilder: ActionAttributes.create)
    ...
    ..aOM<BuildAction>(9, _omitFieldNames ? '' : 'buildAction', subBuilder: BuildAction.create)
    ..aOM<TestAction>(10, _omitFieldNames ? '' : 'testAction', subBuilder: TestAction.create)
    ..aOM<$4771.ActionCoverage>(11, _omitFieldNames ? '' : 'coverage', subBuilder: $4771.ActionCoverage.create)
    ..pc<$4772.FileProcessingErrors>(13, _omitFieldNames ? '' : 'fileProcessingErrors', $pb.PbFieldType.PM, subBuilder: $4772.FileProcessingErrors.create)
    ..pc<$4769.Dependency>(14, _omitFieldNames ? '' : 'actionDependencies', $pb.PbFieldType.PM, subBuilder: $4769.Dependency.create)
  ...
  @$pb.TagNumber(11)
  $4771.ActionCoverage get coverage => $_getN(9);
  @$pb.TagNumber(11)
  set coverage($4771.ActionCoverage v) { setField(11, v); }
  @$pb.TagNumber(11)
  $core.bool hasCoverage() => $_has(9);
  @$pb.TagNumber(11)
  void clearCoverage() => clearField(11);
  @$pb.TagNumber(11)
  $4771.ActionCoverage ensureCoverage() => $_ensure(9);
  ...
  @$pb.TagNumber(14)
  $core.List<$4769.Dependency> get actionDependencies => $_getList(11);
...
class BuildAction extends $pb.GeneratedMessage {
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(_omitMessageNames ? '' : 'BuildAction', package: const $pb.PackageName(_omitMessageNames ? '' : 'google.devtools.resultstore.v2'), createEmptyInstance: create)
  ...
  'Use [GeneratedMessageGenericExtensions.rebuild] instead. '
  'Will be removed in next major version')
  BuildAction copyWith(void Function(BuildAction) updates) => super.copyWith((message) => updates(message as BuildAction)) as BuildAction;
...
class TestAction extends $pb.GeneratedMessage {
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(_omitMessageNames ? '' : 'TestAction', package: const $pb.PackageName(_omitMessageNames ? '' : 'google.devtools.resultstore.v2'), createEmptyInstance: create)
    ..aOM<TestTiming>(1, _omitFieldNames ? '' : 'testTiming', subBuilder: TestTiming.create)
    ..a<$core.int>(2, _omitFieldNames ? '' : 'shardNumber', $pb.PbFieldType.O3)
    ..a<$core.int>(3, _omitFieldNames ? '' : 'runNumber', $pb.PbFieldType.O3)
    ..a<$core.int>(4, _omitFieldNames ? '' : 'attemptNumber', $pb.PbFieldType.O3)
    ..aOM<$4773.TestSuite>(5, _omitFieldNames ? '' : 'testSuite', subBuilder: $4773.TestSuite.create)
    ..pc<TestWarning>(8, _omitFieldNames ? '' : 'warnings', $pb.PbFieldType.PM, subBuilder: TestWarning.create)
  ...
  'Use [GeneratedMessageGenericExtensions.rebuild] instead. '
  'Will be removed in next major version')
  TestAction copyWith(void Function(TestAction) updates) => super.copyWith((message) => updates(message as TestAction)) as TestAction;
  ...
  /// by clients.
  @$pb.TagNumber(5)
  $4773.TestSuite get testSuite => $_getN(4);
  @$pb.TagNumber(5)
  set testSuite($4773.TestSuite v) { setField(5, v); }
  @$pb.TagNumber(5)
  $core.bool hasTestSuite() => $_has(4);
  @$pb.TagNumber(5)
  void clearTestSuite() => clearField(5);
  @$pb.TagNumber(5)
  $4773.TestSuite ensureTestSuite() => $_ensure(4);
...
class ActionAttributes extends $pb.GeneratedMessage {
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(_omitMessageNames ? '' : 'ActionAttributes', package: const $pb.PackageName(_omitMessageNames ? '' : 'google.devtools.resultstore.v2'), createEmptyInstance: create)
    ..e<ExecutionStrategy>(1, _omitFieldNames ? '' : 'executionStrategy', $pb.PbFieldType.OE, defaultOrMaker: ExecutionStrategy.EXECUTION_STRATEGY_UNSPECIFIED, valueOf: ExecutionStrategy.valueOf, enumValues: ExecutionStrategy.values)
    ..a<$core.int>(2, _omitFieldNames ? '' : 'exitCode', $pb.PbFieldType.O3)
    ..aOS(3, _omitFieldNames ? '' : 'hostname')
    ..aOM<InputFileInfo>(4, _omitFieldNames ? '' : 'inputFileInfo', subBuilder: InputFileInfo.create)
    ..hasRequiredFields = false
  ;
  ...
  'Use [GeneratedMessageGenericExtensions.rebuild] instead. '
  'Will be removed in next major version')
  ActionAttributes copyWith(void Function(ActionAttributes) updates) => super.copyWith((message) => updates(message as ActionAttributes)) as ActionAttributes;
...
class InputFileInfo extends $pb.GeneratedMessage {
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(_omitMessageNames ? '' : 'InputFileInfo', package: const $pb.PackageName(_omitMessageNames ? '' : 'google.devtools.resultstore.v2'), createEmptyInstance: create)
  ...
  'Use [GeneratedMessageGenericExtensions.rebuild] instead. '
  'Will be removed in next major version')
  InputFileInfo copyWith(void Function(InputFileInfo) updates) => super.copyWith((message) => updates(message as InputFileInfo)) as InputFileInfo;
...
class LocalTestTiming extends $pb.GeneratedMessage {
  factory LocalTestTiming({
    $1737.Duration? testProcessDuration,
  }) {
    final $result = create();
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(_omitMessageNames ? '' : 'LocalTestTiming', package: const $pb.PackageName(_omitMessageNames ? '' : 'google.devtools.resultstore.v2'), createEmptyInstance: create)
    ..aOM<$1737.Duration>(1, _omitFieldNames ? '' : 'testProcessDuration', subBuilder: $1737.Duration.create)
    ..hasRequiredFields = false
  ;
  ...
  'Use [GeneratedMessageGenericExtensions.rebuild] instead. '
  'Will be removed in next major version')
  LocalTestTiming copyWith(void Function(LocalTestTiming) updates) => super.copyWith((message) => updates(message as LocalTestTiming)) as LocalTestTiming;
  ...
  /// script.
  @$pb.TagNumber(1)
  $1737.Duration get testProcessDuration => $_getN(0);
  @$pb.TagNumber(1)
  set testProcessDuration($1737.Duration v) { setField(1, v); }
  @$pb.TagNumber(1)
  $core.bool hasTestProcessDuration() => $_has(0);
  @$pb.TagNumber(1)
  void clearTestProcessDuration() => clearField(1);
  @$pb.TagNumber(1)
  $1737.Duration ensureTestProcessDuration() => $_ensure(0);
}
...
class RemoteTestAttemptTiming extends $pb.GeneratedMessage {
  factory RemoteTestAttemptTiming({
    $1737.Duration? queueDuration,
    $1737.Duration? uploadDuration,
    $1737.Duration? machineSetupDuration,
    $1737.Duration? testProcessDuration,
    $1737.Duration? downloadDuration,
  }) {
    final $result = create();
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(_omitMessageNames ? '' : 'RemoteTestAttemptTiming', package: const $pb.PackageName(_omitMessageNames ? '' : 'google.devtools.resultstore.v2'), createEmptyInstance: create)
    ..aOM<$1737.Duration>(1, _omitFieldNames ? '' : 'queueDuration', subBuilder: $1737.Duration.create)
    ..aOM<$1737.Duration>(2, _omitFieldNames ? '' : 'uploadDuration', subBuilder: $1737.Duration.create)
    ..aOM<$1737.Duration>(3, _omitFieldNames ? '' : 'machineSetupDuration', subBuilder: $1737.Duration.create)
    ..aOM<$1737.Duration>(4, _omitFieldNames ? '' : 'testProcessDuration', subBuilder: $1737.Duration.create)
    ..aOM<$1737.Duration>(5, _omitFieldNames ? '' : 'downloadDuration', subBuilder: $1737.Duration.create)
    ..hasRequiredFields = false
  ;
  ...
  'Use [GeneratedMessageGenericExtensions.rebuild] instead. '
  'Will be removed in next major version')
  RemoteTestAttemptTiming copyWith(void Function(RemoteTestAttemptTiming) updates) => super.copyWith((message) => updates(message as RemoteTestAttemptTiming)) as RemoteTestAttemptTiming;
  ...
  @$pb.TagNumber(1)
  $1737.Duration get queueDuration => $_getN(0);
  @$pb.TagNumber(1)
  set queueDuration($1737.Duration v) { setField(1, v); }
  @$pb.TagNumber(1)
  $core.bool hasQueueDuration() => $_has(0);
  @$pb.TagNumber(1)
  void clearQueueDuration() => clearField(1);
  @$pb.TagNumber(1)
  $1737.Duration ensureQueueDuration() => $_ensure(0);
  ...
  @$pb.TagNumber(2)
  $1737.Duration get uploadDuration => $_getN(1);
  @$pb.TagNumber(2)
  set uploadDuration($1737.Duration v) { setField(2, v); }
  @$pb.TagNumber(2)
  $core.bool hasUploadDuration() => $_has(1);
  @$pb.TagNumber(2)
  void clearUploadDuration() => clearField(2);
  @$pb.TagNumber(2)
  $1737.Duration ensureUploadDuration() => $_ensure(1);
  ...
  @$pb.TagNumber(3)
  $1737.Duration get machineSetupDuration => $_getN(2);
  @$pb.TagNumber(3)
  set machineSetupDuration($1737.Duration v) { setField(3, v); }
  @$pb.TagNumber(3)
  $core.bool hasMachineSetupDuration() => $_has(2);
  @$pb.TagNumber(3)
  void clearMachineSetupDuration() => clearField(3);
  @$pb.TagNumber(3)
  $1737.Duration ensureMachineSetupDuration() => $_ensure(2);
  ...
  @$pb.TagNumber(4)
  $1737.Duration get testProcessDuration => $_getN(3);
  @$pb.TagNumber(4)
  set testProcessDuration($1737.Duration v) { setField(4, v); }
  @$pb.TagNumber(4)
  $core.bool hasTestProcessDuration() => $_has(3);
  @$pb.TagNumber(4)
  void clearTestProcessDuration() => clearField(4);
  @$pb.TagNumber(4)
  $1737.Duration ensureTestProcessDuration() => $_ensure(3);

  /// Time spent retrieving test logs and any other test outputs, back to the
  /// local machine.
  @$pb.TagNumber(5)
  $1737.Duration get downloadDuration => $_getN(4);
  @$pb.TagNumber(5)
  set downloadDuration($1737.Duration v) { setField(5, v); }
  @$pb.TagNumber(5)
  $core.bool hasDownloadDuration() => $_has(4);
  @$pb.TagNumber(5)
  void clearDownloadDuration() => clearField(5);
  @$pb.TagNumber(5)
  $1737.Duration ensureDownloadDuration() => $_ensure(4);
}
...
class RemoteTestTiming extends $pb.GeneratedMessage {
  factory RemoteTestTiming({
    $1737.Duration? localAnalysisDuration,
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(_omitMessageNames ? '' : 'RemoteTestTiming', package: const $pb.PackageName(_omitMessageNames ? '' : 'google.devtools.resultstore.v2'), createEmptyInstance: create)
    ..aOM<$1737.Duration>(1, _omitFieldNames ? '' : 'localAnalysisDuration', subBuilder: $1737.Duration.create)
    ..pc<RemoteTestAttemptTiming>(2, _omitFieldNames ? '' : 'attempts', $pb.PbFieldType.PM, subBuilder: RemoteTestAttemptTiming.create)
    ..hasRequiredFields = false
  ;
  ...
  'Use [GeneratedMessageGenericExtensions.rebuild] instead. '
  'Will be removed in next major version')
  RemoteTestTiming copyWith(void Function(RemoteTestTiming) updates) => super.copyWith((message) => updates(message as RemoteTestTiming)) as RemoteTestTiming;
  ...
  @$pb.TagNumber(1)
  $1737.Duration get localAnalysisDuration => $_getN(0);
  @$pb.TagNumber(1)
  set localAnalysisDuration($1737.Duration v) { setField(1, v); }
  @$pb.TagNumber(1)
  $core.bool hasLocalAnalysisDuration() => $_has(0);
  @$pb.TagNumber(1)
  void clearLocalAnalysisDuration() => clearField(1);
  @$pb.TagNumber(1)
  $1737.Duration ensureLocalAnalysisDuration() => $_ensure(0);
...
class TestTiming extends $pb.GeneratedMessage {
  factory TestTiming({
    ...
    $1737.Duration? systemTimeDuration,
    $1737.Duration? userTimeDuration,
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(_omitMessageNames ? '' : 'TestTiming', package: const $pb.PackageName(_omitMessageNames ? '' : 'google.devtools.resultstore.v2'), createEmptyInstance: create)
    ..oo(0, [1, 2])
    ..aOM<LocalTestTiming>(1, _omitFieldNames ? '' : 'local', subBuilder: LocalTestTiming.create)
    ..aOM<RemoteTestTiming>(2, _omitFieldNames ? '' : 'remote', subBuilder: RemoteTestTiming.create)
    ..aOM<$1737.Duration>(3, _omitFieldNames ? '' : 'systemTimeDuration', subBuilder: $1737.Duration.create)
    ..aOM<$1737.Duration>(4, _omitFieldNames ? '' : 'userTimeDuration', subBuilder: $1737.Duration.create)
    ..e<TestCaching>(5, _omitFieldNames ? '' : 'testCaching', $pb.PbFieldType.OE, defaultOrMaker: TestCaching.TEST_CACHING_UNSPECIFIED, valueOf: TestCaching.valueOf, enumValues: TestCaching.values)
    ..hasRequiredFields = false
  ;
  ...
  'Use [GeneratedMessageGenericExtensions.rebuild] instead. '
  'Will be removed in next major version')
  TestTiming copyWith(void Function(TestTiming) updates) => super.copyWith((message) => updates(message as TestTiming)) as TestTiming;
  ...
  @$pb.TagNumber(3)
  $1737.Duration get systemTimeDuration => $_getN(2);
  @$pb.TagNumber(3)
  set systemTimeDuration($1737.Duration v) { setField(3, v); }
  @$pb.TagNumber(3)
  $core.bool hasSystemTimeDuration() => $_has(2);
  @$pb.TagNumber(3)
  void clearSystemTimeDuration() => clearField(3);
  @$pb.TagNumber(3)
  $1737.Duration ensureSystemTimeDuration() => $_ensure(2);
  ...
  @$pb.TagNumber(4)
  $1737.Duration get userTimeDuration => $_getN(3);
  @$pb.TagNumber(4)
  set userTimeDuration($1737.Duration v) { setField(4, v); }
  @$pb.TagNumber(4)
  $core.bool hasUserTimeDuration() => $_has(3);
  @$pb.TagNumber(4)
  void clearUserTimeDuration() => clearField(4);
  @$pb.TagNumber(4)
  $1737.Duration ensureUserTimeDuration() => $_ensure(3);
...
class TestWarning extends $pb.GeneratedMessage {
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(_omitMessageNames ? '' : 'TestWarning', package: const $pb.PackageName(_omitMessageNames ? '' : 'google.devtools.resultstore.v2'), createEmptyInstance: create)
  ...
  'Use [GeneratedMessageGenericExtensions.rebuild] instead. '
  'Will be removed in next major version')
  TestWarning copyWith(void Function(TestWarning) updates) => super.copyWith((message) => updates(message as TestWarning)) as TestWarning;
