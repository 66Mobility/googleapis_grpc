...
class ConfiguredTarget_Id extends $pb.GeneratedMessage {
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(_omitMessageNames ? '' : 'ConfiguredTarget.Id', package: const $pb.PackageName(_omitMessageNames ? '' : 'google.devtools.resultstore.v2'), createEmptyInstance: create)
  ...
  'Will be removed in next major version')
  ConfiguredTarget_Id copyWith(void Function(ConfiguredTarget_Id) updates) => super.copyWith((message) => updates(message as ConfiguredTarget_Id)) as ConfiguredTarget_Id;
...
class ConfiguredTarget extends $pb.GeneratedMessage {
  ...
  'Use [GeneratedMessageGenericExtensions.rebuild] instead. '
  'Will be removed in next major version')
  ConfiguredTarget copyWith(void Function(ConfiguredTarget) updates) => super.copyWith((message) => updates(message as ConfiguredTarget)) as ConfiguredTarget;
...
class ConfiguredTestAttributes extends $pb.GeneratedMessage {
  ...
  'Use [GeneratedMessageGenericExtensions.rebuild] instead. '
  'Will be removed in next major version')
  ConfiguredTestAttributes copyWith(void Function(ConfiguredTestAttributes) updates) => super.copyWith((message) => updates(message as ConfiguredTestAttributes)) as ConfiguredTestAttributes;
