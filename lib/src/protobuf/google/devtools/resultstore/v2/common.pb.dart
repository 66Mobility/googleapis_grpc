...
class StatusAttributes extends $pb.GeneratedMessage {
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(_omitMessageNames ? '' : 'StatusAttributes', package: const $pb.PackageName(_omitMessageNames ? '' : 'google.devtools.resultstore.v2'), createEmptyInstance: create)
  ...
  'Will be removed in next major version')
  StatusAttributes copyWith(void Function(StatusAttributes) updates) => super.copyWith((message) => updates(message as StatusAttributes)) as StatusAttributes;
...
class Property extends $pb.GeneratedMessage {
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(_omitMessageNames ? '' : 'Property', package: const $pb.PackageName(_omitMessageNames ? '' : 'google.devtools.resultstore.v2'), createEmptyInstance: create)
...
class Timing extends $pb.GeneratedMessage {
  ...
  'Use [GeneratedMessageGenericExtensions.rebuild] instead. '
  'Will be removed in next major version')
  Timing copyWith(void Function(Timing) updates) => super.copyWith((message) => updates(message as Timing)) as Timing;
...
class Dependency_Id extends $pb.GeneratedMessage {
  ...
  factory Dependency_Id.fromBuffer($core.List<$core.int> i, [$pb.ExtensionRegistry r = $pb.ExtensionRegistry.EMPTY]) => create()..mergeFromBuffer(i, r);
  factory Dependency_Id.fromJson($core.String i, [$pb.ExtensionRegistry r = $pb.ExtensionRegistry.EMPTY]) => create()..mergeFromJson(i, r);

  static final $pb.BuilderInfo _i = $pb.BuilderInfo(_omitMessageNames ? '' : 'Dependency.Id', package: const $pb.PackageName(_omitMessageNames ? '' : 'google.devtools.resultstore.v2'), createEmptyInstance: create)
  ...
  'Use [GeneratedMessageGenericExtensions.rebuild] instead. '
  'Will be removed in next major version')
  Dependency_Id copyWith(void Function(Dependency_Id) updates) => super.copyWith((message) => updates(message as Dependency_Id)) as Dependency_Id;
  ...
  static $pb.PbList<Dependency_Id> createRepeated() => $pb.PbList<Dependency_Id>();
  @$core.pragma('dart2js:noInline')
  static Dependency_Id getDefault() => _defaultInstance ??= $pb.GeneratedMessage.$_defaultFor<Dependency_Id>(create);
...
class Dependency extends $pb.GeneratedMessage {
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(_omitMessageNames ? '' : 'Dependency', package: const $pb.PackageName(_omitMessageNames ? '' : 'google.devtools.resultstore.v2'), createEmptyInstance: create)
    ..oo(0, [1, 2, 3])
    ..aOS(1, _omitFieldNames ? '' : 'target')
    ..aOS(2, _omitFieldNames ? '' : 'configuredTarget')
    ..aOS(3, _omitFieldNames ? '' : 'action')
    ..aOS(4, _omitFieldNames ? '' : 'label')
    ..aOM<Dependency_Id>(5, _omitFieldNames ? '' : 'id', subBuilder: Dependency_Id.create)
    ..hasRequiredFields = false
  ;
  ...
  @$pb.TagNumber(5)
  set id(Dependency_Id v) { setField(5, v); }
  @$pb.TagNumber(5)
