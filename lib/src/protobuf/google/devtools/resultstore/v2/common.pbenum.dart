...
class Language extends $pb.ProtobufEnum {
  static const Language LANGUAGE_UNSPECIFIED = Language._(0, _omitEnumNames ? '' : 'LANGUAGE_UNSPECIFIED');
  static const Language NONE = Language._(1, _omitEnumNames ? '' : 'NONE');
  static const Language ANDROID = Language._(2, _omitEnumNames ? '' : 'ANDROID');
  ...
  static const Language HASKELL = Language._(9, _omitEnumNames ? '' : 'HASKELL');
...
class Status extends $pb.ProtobufEnum {
  ...
  static const Status FAILED_TO_BUILD = Status._(3, _omitEnumNames ? '' : 'FAILED_TO_BUILD');
  ...
  static const Status TIMED_OUT = Status._(7, _omitEnumNames ? '' : 'TIMED_OUT');
  static const Status CANCELLED = Status._(8, _omitEnumNames ? '' : 'CANCELLED');
  static const Status TOOL_FAILED = Status._(9, _omitEnumNames ? '' : 'TOOL_FAILED');
  static const Status INCOMPLETE = Status._(10, _omitEnumNames ? '' : 'INCOMPLETE');
...
class UploadStatus extends $pb.ProtobufEnum {
  static const UploadStatus UPLOAD_STATUS_UNSPECIFIED = UploadStatus._(0, _omitEnumNames ? '' : 'UPLOAD_STATUS_UNSPECIFIED');
  static const UploadStatus UPLOADING = UploadStatus._(1, _omitEnumNames ? '' : 'UPLOADING');
  static const UploadStatus POST_PROCESSING = UploadStatus._(2, _omitEnumNames ? '' : 'POST_PROCESSING');
  static const UploadStatus IMMUTABLE = UploadStatus._(3, _omitEnumNames ? '' : 'IMMUTABLE');
