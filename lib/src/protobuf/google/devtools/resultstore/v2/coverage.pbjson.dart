...
const LineCoverage$json = {
  '1': 'LineCoverage',
  '2': [
    {'1': 'instrumented_lines', '3': 1, '4': 1, '5': 12, '10': 'instrumentedLines'},
...
const FileCoverage$json = {
  ...
  '2': [
    ...
    {'1': 'line_coverage', '3': 2, '4': 1, '5': 11, '6': '.google.devtools.resultstore.v2.LineCoverage', '10': 'lineCoverage'},
    {'1': 'branch_coverage', '3': 3, '4': 1, '5': 11, '6': '.google.devtools.resultstore.v2.BranchCoverage', '10': 'branchCoverage'},
  ],
};
...
const ActionCoverage$json = {
  '1': 'ActionCoverage',
  '2': [
    {'1': 'file_coverages', '3': 2, '4': 3, '5': 11, '6': '.google.devtools.resultstore.v2.FileCoverage', '10': 'fileCoverages'},
  ],
};
...
const AggregateCoverage$json = {
  '1': 'AggregateCoverage',
  '2': [
    {'1': 'file_coverages', '3': 1, '4': 3, '5': 11, '6': '.google.devtools.resultstore.v2.FileCoverage', '10': 'fileCoverages'},
  ],
};
