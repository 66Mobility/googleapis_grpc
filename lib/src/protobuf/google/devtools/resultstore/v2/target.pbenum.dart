...
class TargetType extends $pb.ProtobufEnum {
  ...
  static const TargetType APPLICATION = TargetType._(1, _omitEnumNames ? '' : 'APPLICATION');
  static const TargetType BINARY = TargetType._(2, _omitEnumNames ? '' : 'BINARY');
  static const TargetType LIBRARY = TargetType._(3, _omitEnumNames ? '' : 'LIBRARY');
  static const TargetType PACKAGE = TargetType._(4, _omitEnumNames ? '' : 'PACKAGE');
...
class TestSize extends $pb.ProtobufEnum {
  static const TestSize TEST_SIZE_UNSPECIFIED = TestSize._(0, _omitEnumNames ? '' : 'TEST_SIZE_UNSPECIFIED');
  ...
  static const TestSize ENORMOUS = TestSize._(4, _omitEnumNames ? '' : 'ENORMOUS');
  static const TestSize OTHER_SIZE = TestSize._(5, _omitEnumNames ? '' : 'OTHER_SIZE');
