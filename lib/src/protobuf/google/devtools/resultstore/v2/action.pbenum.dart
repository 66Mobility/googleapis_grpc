...
class ExecutionStrategy extends $pb.ProtobufEnum {
  static const ExecutionStrategy EXECUTION_STRATEGY_UNSPECIFIED = ExecutionStrategy._(0, _omitEnumNames ? '' : 'EXECUTION_STRATEGY_UNSPECIFIED');
  static const ExecutionStrategy OTHER_ENVIRONMENT = ExecutionStrategy._(1, _omitEnumNames ? '' : 'OTHER_ENVIRONMENT');
  static const ExecutionStrategy REMOTE_SERVICE = ExecutionStrategy._(2, _omitEnumNames ? '' : 'REMOTE_SERVICE');
  static const ExecutionStrategy LOCAL_PARALLEL = ExecutionStrategy._(3, _omitEnumNames ? '' : 'LOCAL_PARALLEL');
  static const ExecutionStrategy LOCAL_SEQUENTIAL = ExecutionStrategy._(4, _omitEnumNames ? '' : 'LOCAL_SEQUENTIAL');
...
class TestCaching extends $pb.ProtobufEnum {
  static const TestCaching TEST_CACHING_UNSPECIFIED = TestCaching._(0, _omitEnumNames ? '' : 'TEST_CACHING_UNSPECIFIED');
  static const TestCaching LOCAL_CACHE_HIT = TestCaching._(1, _omitEnumNames ? '' : 'LOCAL_CACHE_HIT');
  static const TestCaching REMOTE_CACHE_HIT = TestCaching._(2, _omitEnumNames ? '' : 'REMOTE_CACHE_HIT');
  static const TestCaching CACHE_MISS = TestCaching._(3, _omitEnumNames ? '' : 'CACHE_MISS');
