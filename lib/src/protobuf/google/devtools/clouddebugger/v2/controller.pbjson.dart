...
const RegisterDebuggeeRequest$json = {
  ...
  '2': [
    {'1': 'debuggee', '3': 1, '4': 1, '5': 11, '6': '.google.devtools.clouddebugger.v2.Debuggee', '8': {}, '10': 'debuggee'},
  ],
};

/// Descriptor for `RegisterDebuggeeRequest`. Decode as a `google.protobuf.DescriptorProto`.
final $typed_data.Uint8List registerDebuggeeRequestDescriptor = $convert.base64Decode(
...
const RegisterDebuggeeResponse$json = {
  ...
  '2': [
    {'1': 'debuggee', '3': 1, '4': 1, '5': 11, '6': '.google.devtools.clouddebugger.v2.Debuggee', '10': 'debuggee'},
  ],
};

/// Descriptor for `RegisterDebuggeeResponse`. Decode as a `google.protobuf.DescriptorProto`.
final $typed_data.Uint8List registerDebuggeeResponseDescriptor = $convert.base64Decode(
...
const ListActiveBreakpointsRequest$json = {
  ...
  '2': [
    ...
    {'1': 'success_on_timeout', '3': 3, '4': 1, '5': 8, '10': 'successOnTimeout'},
  ],
};

/// Descriptor for `ListActiveBreakpointsRequest`. Decode as a `google.protobuf.DescriptorProto`.
final $typed_data.Uint8List listActiveBreakpointsRequestDescriptor = $convert.base64Decode(
...
const ListActiveBreakpointsResponse$json = {
  ...
  '2': [
    {'1': 'breakpoints', '3': 1, '4': 3, '5': 11, '6': '.google.devtools.clouddebugger.v2.Breakpoint', '10': 'breakpoints'},
...
const UpdateActiveBreakpointRequest$json = {
  ...
  '2': [
    {'1': 'debuggee_id', '3': 1, '4': 1, '5': 9, '8': {}, '10': 'debuggeeId'},
    {'1': 'breakpoint', '3': 2, '4': 1, '5': 11, '6': '.google.devtools.clouddebugger.v2.Breakpoint', '8': {}, '10': 'breakpoint'},
  ],
};

/// Descriptor for `UpdateActiveBreakpointRequest`. Decode as a `google.protobuf.DescriptorProto`.
final $typed_data.Uint8List updateActiveBreakpointRequestDescriptor = $convert.base64Decode(
...
final $typed_data.Uint8List updateActiveBreakpointResponseDescriptor = $convert.base64Decode(
    'Ch5VcGRhdGVBY3RpdmVCcmVha3BvaW50UmVzcG9uc2U=');
