...
class FormatMessage extends $pb.GeneratedMessage {
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(_omitMessageNames ? '' : 'FormatMessage', package: const $pb.PackageName(_omitMessageNames ? '' : 'google.devtools.clouddebugger.v2'), createEmptyInstance: create)
  ...
  'Will be removed in next major version')
  FormatMessage copyWith(void Function(FormatMessage) updates) => super.copyWith((message) => updates(message as FormatMessage)) as FormatMessage;
...
class StatusMessage extends $pb.GeneratedMessage {
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(_omitMessageNames ? '' : 'StatusMessage', package: const $pb.PackageName(_omitMessageNames ? '' : 'google.devtools.clouddebugger.v2'), createEmptyInstance: create)
    ..aOB(1, _omitFieldNames ? '' : 'isError')
    ..e<StatusMessage_Reference>(2, _omitFieldNames ? '' : 'refersTo', $pb.PbFieldType.OE, defaultOrMaker: StatusMessage_Reference.UNSPECIFIED, valueOf: StatusMessage_Reference.valueOf, enumValues: StatusMessage_Reference.values)
    ..aOM<FormatMessage>(3, _omitFieldNames ? '' : 'description', subBuilder: FormatMessage.create)
    ..hasRequiredFields = false
  ;
...
class SourceLocation extends $pb.GeneratedMessage {
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(_omitMessageNames ? '' : 'SourceLocation', package: const $pb.PackageName(_omitMessageNames ? '' : 'google.devtools.clouddebugger.v2'), createEmptyInstance: create)
...
class Variable extends $pb.GeneratedMessage {
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(_omitMessageNames ? '' : 'Variable', package: const $pb.PackageName(_omitMessageNames ? '' : 'google.devtools.clouddebugger.v2'), createEmptyInstance: create)
...
class StackFrame extends $pb.GeneratedMessage {
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(_omitMessageNames ? '' : 'StackFrame', package: const $pb.PackageName(_omitMessageNames ? '' : 'google.devtools.clouddebugger.v2'), createEmptyInstance: create)
    ..aOS(1, _omitFieldNames ? '' : 'function')
    ..aOM<SourceLocation>(2, _omitFieldNames ? '' : 'location', subBuilder: SourceLocation.create)
    ..pc<Variable>(3, _omitFieldNames ? '' : 'arguments', $pb.PbFieldType.PM, subBuilder: Variable.create)
    ..pc<Variable>(4, _omitFieldNames ? '' : 'locals', $pb.PbFieldType.PM, subBuilder: Variable.create)
    ..hasRequiredFields = false
  ;
  ...
  'Use [GeneratedMessageGenericExtensions.rebuild] instead. '
  'Will be removed in next major version')
  StackFrame copyWith(void Function(StackFrame) updates) => super.copyWith((message) => updates(message as StackFrame)) as StackFrame;
...
class Breakpoint extends $pb.GeneratedMessage {
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(_omitMessageNames ? '' : 'Breakpoint', package: const $pb.PackageName(_omitMessageNames ? '' : 'google.devtools.clouddebugger.v2'), createEmptyInstance: create)
    ..aOS(1, _omitFieldNames ? '' : 'id')
    ..aOM<SourceLocation>(2, _omitFieldNames ? '' : 'location', subBuilder: SourceLocation.create)
    ..aOS(3, _omitFieldNames ? '' : 'condition')
    ..pPS(4, _omitFieldNames ? '' : 'expressions')
    ..aOB(5, _omitFieldNames ? '' : 'isFinalState')
    ..pc<StackFrame>(7, _omitFieldNames ? '' : 'stackFrames', $pb.PbFieldType.PM, subBuilder: StackFrame.create)
    ...
    ..m<$core.String, $core.String>(17, _omitFieldNames ? '' : 'labels', entryClassName: 'Breakpoint.LabelsEntry', keyFieldType: $pb.PbFieldType.OS, valueFieldType: $pb.PbFieldType.OS, packageName: const $pb.PackageName('google.devtools.clouddebugger.v2'))
    ..hasRequiredFields = false
  ;
  ...
  'Use [GeneratedMessageGenericExtensions.rebuild] instead. '
  'Will be removed in next major version')
  Breakpoint copyWith(void Function(Breakpoint) updates) => super.copyWith((message) => updates(message as Breakpoint)) as Breakpoint;
...
class Debuggee extends $pb.GeneratedMessage {
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(_omitMessageNames ? '' : 'Debuggee', package: const $pb.PackageName(_omitMessageNames ? '' : 'google.devtools.clouddebugger.v2'), createEmptyInstance: create)
    ..aOS(1, _omitFieldNames ? '' : 'id')
  ...
  'Use [GeneratedMessageGenericExtensions.rebuild] instead. '
  'Will be removed in next major version')
  Debuggee copyWith(void Function(Debuggee) updates) => super.copyWith((message) => updates(message as Debuggee)) as Debuggee;
