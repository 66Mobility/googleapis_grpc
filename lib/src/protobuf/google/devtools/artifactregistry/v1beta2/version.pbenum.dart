...
class VersionView extends $pb.ProtobufEnum {
  static const VersionView VERSION_VIEW_UNSPECIFIED = VersionView._(0, _omitEnumNames ? '' : 'VERSION_VIEW_UNSPECIFIED');
  static const VersionView BASIC = VersionView._(1, _omitEnumNames ? '' : 'BASIC');
  static const VersionView FULL = VersionView._(2, _omitEnumNames ? '' : 'FULL');
