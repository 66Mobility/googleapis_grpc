...
const Hash$json = {
  '1': 'Hash',
  '2': [
    {'1': 'type', '3': 1, '4': 1, '5': 14, '6': '.google.devtools.artifactregistry.v1beta2.Hash.HashType', '10': 'type'},
...
const File$json = {
  ...
  '2': [
    ...
    {'1': 'hashes', '3': 4, '4': 3, '5': 11, '6': '.google.devtools.artifactregistry.v1beta2.Hash', '10': 'hashes'},
...
const ListFilesResponse$json = {
  '1': 'ListFilesResponse',
  '2': [
    {'1': 'files', '3': 1, '4': 3, '5': 11, '6': '.google.devtools.artifactregistry.v1beta2.File', '10': 'files'},
...
final $typed_data.Uint8List getFileRequestDescriptor = $convert.base64Decode(
    'Cg5HZXRGaWxlUmVxdWVzdBISCgRuYW1lGAEgASgJUgRuYW1l');
