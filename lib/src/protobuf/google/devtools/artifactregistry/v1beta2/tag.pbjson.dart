...
const ListTagsResponse$json = {
  '1': 'ListTagsResponse',
  '2': [
    {'1': 'tags', '3': 1, '4': 3, '5': 11, '6': '.google.devtools.artifactregistry.v1beta2.Tag', '10': 'tags'},
...
final $typed_data.Uint8List getTagRequestDescriptor = $convert.base64Decode(
    'Cg1HZXRUYWdSZXF1ZXN0EhIKBG5hbWUYASABKAlSBG5hbWU=');
...
const CreateTagRequest$json = {
  ...
  '2': [
    ...
    {'1': 'tag', '3': 3, '4': 1, '5': 11, '6': '.google.devtools.artifactregistry.v1beta2.Tag', '10': 'tag'},
  ],
};
...
const UpdateTagRequest$json = {
  '1': 'UpdateTagRequest',
  '2': [
    {'1': 'tag', '3': 1, '4': 1, '5': 11, '6': '.google.devtools.artifactregistry.v1beta2.Tag', '10': 'tag'},
...
final $typed_data.Uint8List deleteTagRequestDescriptor = $convert.base64Decode(
    'ChBEZWxldGVUYWdSZXF1ZXN0EhIKBG5hbWUYASABKAlSBG5hbWU=');
