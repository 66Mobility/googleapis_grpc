...
const ListPackagesResponse$json = {
  ...
  '2': [
    {'1': 'packages', '3': 1, '4': 3, '5': 11, '6': '.google.devtools.artifactregistry.v1beta2.Package', '10': 'packages'},
...
final $typed_data.Uint8List getPackageRequestDescriptor = $convert.base64Decode(
    'ChFHZXRQYWNrYWdlUmVxdWVzdBISCgRuYW1lGAEgASgJUgRuYW1l');
...
final $typed_data.Uint8List deletePackageRequestDescriptor = $convert.base64Decode(
    'ChREZWxldGVQYWNrYWdlUmVxdWVzdBISCgRuYW1lGAEgASgJUgRuYW1l');
