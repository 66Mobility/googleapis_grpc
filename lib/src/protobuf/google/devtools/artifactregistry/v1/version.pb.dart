...
class Version extends $pb.GeneratedMessage {
  factory Version({
    ...
    $core.Iterable<$1549.Tag>? relatedTags,
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(_omitMessageNames ? '' : 'Version', package: const $pb.PackageName(_omitMessageNames ? '' : 'google.devtools.artifactregistry.v1'), createEmptyInstance: create)
    ..aOS(1, _omitFieldNames ? '' : 'name')
    ..aOS(3, _omitFieldNames ? '' : 'description')
    ..aOM<$1776.Timestamp>(5, _omitFieldNames ? '' : 'createTime', subBuilder: $1776.Timestamp.create)
    ..aOM<$1776.Timestamp>(6, _omitFieldNames ? '' : 'updateTime', subBuilder: $1776.Timestamp.create)
    ..pc<$1549.Tag>(7, _omitFieldNames ? '' : 'relatedTags', $pb.PbFieldType.PM, subBuilder: $1549.Tag.create)
  ...
  @$pb.TagNumber(7)
  $core.List<$1549.Tag> get relatedTags => $_getList(4);
...
class ListVersionsRequest extends $pb.GeneratedMessage {
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(_omitMessageNames ? '' : 'ListVersionsRequest', package: const $pb.PackageName(_omitMessageNames ? '' : 'google.devtools.artifactregistry.v1'), createEmptyInstance: create)
    ..aOS(1, _omitFieldNames ? '' : 'parent')
    ..a<$core.int>(2, _omitFieldNames ? '' : 'pageSize', $pb.PbFieldType.O3)
    ..aOS(3, _omitFieldNames ? '' : 'pageToken')
    ..e<VersionView>(4, _omitFieldNames ? '' : 'view', $pb.PbFieldType.OE, defaultOrMaker: VersionView.VERSION_VIEW_UNSPECIFIED, valueOf: VersionView.valueOf, enumValues: VersionView.values)
...
class ListVersionsResponse extends $pb.GeneratedMessage {
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(_omitMessageNames ? '' : 'ListVersionsResponse', package: const $pb.PackageName(_omitMessageNames ? '' : 'google.devtools.artifactregistry.v1'), createEmptyInstance: create)
...
class GetVersionRequest extends $pb.GeneratedMessage {
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(_omitMessageNames ? '' : 'GetVersionRequest', package: const $pb.PackageName(_omitMessageNames ? '' : 'google.devtools.artifactregistry.v1'), createEmptyInstance: create)
    ..aOS(1, _omitFieldNames ? '' : 'name')
    ..e<VersionView>(2, _omitFieldNames ? '' : 'view', $pb.PbFieldType.OE, defaultOrMaker: VersionView.VERSION_VIEW_UNSPECIFIED, valueOf: VersionView.valueOf, enumValues: VersionView.values)
    ..hasRequiredFields = false
  ;
...
class DeleteVersionRequest extends $pb.GeneratedMessage {
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(_omitMessageNames ? '' : 'DeleteVersionRequest', package: const $pb.PackageName(_omitMessageNames ? '' : 'google.devtools.artifactregistry.v1'), createEmptyInstance: create)
    ..aOS(1, _omitFieldNames ? '' : 'name')
...
class BatchDeleteVersionsRequest extends $pb.GeneratedMessage {
  ...
  factory BatchDeleteVersionsRequest.fromBuffer($core.List<$core.int> i, [$pb.ExtensionRegistry r = $pb.ExtensionRegistry.EMPTY]) => create()..mergeFromBuffer(i, r);
  factory BatchDeleteVersionsRequest.fromJson($core.String i, [$pb.ExtensionRegistry r = $pb.ExtensionRegistry.EMPTY]) => create()..mergeFromJson(i, r);

  static final $pb.BuilderInfo _i = $pb.BuilderInfo(_omitMessageNames ? '' : 'BatchDeleteVersionsRequest', package: const $pb.PackageName(_omitMessageNames ? '' : 'google.devtools.artifactregistry.v1'), createEmptyInstance: create)
    ..aOS(1, _omitFieldNames ? '' : 'parent')
  ...
  'Use [GeneratedMessageGenericExtensions.deepCopy] instead. '
  'Will be removed in next major version')
  BatchDeleteVersionsRequest clone() => BatchDeleteVersionsRequest()..mergeFromMessage(this);
  @$core.Deprecated(
  'Using this can add significant overhead to your binary. '
  'Use [GeneratedMessageGenericExtensions.rebuild] instead. '
  'Will be removed in next major version')
  BatchDeleteVersionsRequest copyWith(void Function(BatchDeleteVersionsRequest) updates) => super.copyWith((message) => updates(message as BatchDeleteVersionsRequest)) as BatchDeleteVersionsRequest;
  ...
  static $pb.PbList<BatchDeleteVersionsRequest> createRepeated() => $pb.PbList<BatchDeleteVersionsRequest>();
  @$core.pragma('dart2js:noInline')
  static BatchDeleteVersionsRequest getDefault() => _defaultInstance ??= $pb.GeneratedMessage.$_defaultFor<BatchDeleteVersionsRequest>(create);
...
class BatchDeleteVersionsMetadata extends $pb.GeneratedMessage {
  ...
  factory BatchDeleteVersionsMetadata.fromBuffer($core.List<$core.int> i, [$pb.ExtensionRegistry r = $pb.ExtensionRegistry.EMPTY]) => create()..mergeFromBuffer(i, r);
  factory BatchDeleteVersionsMetadata.fromJson($core.String i, [$pb.ExtensionRegistry r = $pb.ExtensionRegistry.EMPTY]) => create()..mergeFromJson(i, r);

  static final $pb.BuilderInfo _i = $pb.BuilderInfo(_omitMessageNames ? '' : 'BatchDeleteVersionsMetadata', package: const $pb.PackageName(_omitMessageNames ? '' : 'google.devtools.artifactregistry.v1'), createEmptyInstance: create)
  ...
  'Use [GeneratedMessageGenericExtensions.deepCopy] instead. '
  'Will be removed in next major version')
  BatchDeleteVersionsMetadata clone() => BatchDeleteVersionsMetadata()..mergeFromMessage(this);
  @$core.Deprecated(
  'Using this can add significant overhead to your binary. '
  'Use [GeneratedMessageGenericExtensions.rebuild] instead. '
  'Will be removed in next major version')
  BatchDeleteVersionsMetadata copyWith(void Function(BatchDeleteVersionsMetadata) updates) => super.copyWith((message) => updates(message as BatchDeleteVersionsMetadata)) as BatchDeleteVersionsMetadata;

  $pb.BuilderInfo get info_ => _i;

  @$core.pragma('dart2js:noInline')
  static BatchDeleteVersionsMetadata create() => BatchDeleteVersionsMetadata._();
  BatchDeleteVersionsMetadata createEmptyInstance() => create();
  static $pb.PbList<BatchDeleteVersionsMetadata> createRepeated() => $pb.PbList<BatchDeleteVersionsMetadata>();
  @$core.pragma('dart2js:noInline')
  static BatchDeleteVersionsMetadata getDefault() => _defaultInstance ??= $pb.GeneratedMessage.$_defaultFor<BatchDeleteVersionsMetadata>(create);
