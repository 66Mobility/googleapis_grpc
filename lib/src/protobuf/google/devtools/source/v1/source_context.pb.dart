...
class SourceContext extends $pb.GeneratedMessage {
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(_omitMessageNames ? '' : 'SourceContext', package: const $pb.PackageName(_omitMessageNames ? '' : 'google.devtools.source.v1'), createEmptyInstance: create)
    ..oo(0, [1, 2, 3, 6])
    ..aOM<CloudRepoSourceContext>(1, _omitFieldNames ? '' : 'cloudRepo', subBuilder: CloudRepoSourceContext.create)
    ..aOM<CloudWorkspaceSourceContext>(2, _omitFieldNames ? '' : 'cloudWorkspace', subBuilder: CloudWorkspaceSourceContext.create)
    ..aOM<GerritSourceContext>(3, _omitFieldNames ? '' : 'gerrit', subBuilder: GerritSourceContext.create)
    ..aOM<GitSourceContext>(6, _omitFieldNames ? '' : 'git', subBuilder: GitSourceContext.create)
...
class ExtendedSourceContext extends $pb.GeneratedMessage {
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(_omitMessageNames ? '' : 'ExtendedSourceContext', package: const $pb.PackageName(_omitMessageNames ? '' : 'google.devtools.source.v1'), createEmptyInstance: create)
    ..aOM<SourceContext>(1, _omitFieldNames ? '' : 'context', subBuilder: SourceContext.create)
    ..m<$core.String, $core.String>(2, _omitFieldNames ? '' : 'labels', entryClassName: 'ExtendedSourceContext.LabelsEntry', keyFieldType: $pb.PbFieldType.OS, valueFieldType: $pb.PbFieldType.OS, packageName: const $pb.PackageName('google.devtools.source.v1'))
    ..hasRequiredFields = false
  ;
  ...
  'Use [GeneratedMessageGenericExtensions.rebuild] instead. '
  'Will be removed in next major version')
  ExtendedSourceContext copyWith(void Function(ExtendedSourceContext) updates) => super.copyWith((message) => updates(message as ExtendedSourceContext)) as ExtendedSourceContext;
...
class AliasContext extends $pb.GeneratedMessage {
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(_omitMessageNames ? '' : 'AliasContext', package: const $pb.PackageName(_omitMessageNames ? '' : 'google.devtools.source.v1'), createEmptyInstance: create)
    ..e<AliasContext_Kind>(1, _omitFieldNames ? '' : 'kind', $pb.PbFieldType.OE, defaultOrMaker: AliasContext_Kind.ANY, valueOf: AliasContext_Kind.valueOf, enumValues: AliasContext_Kind.values)
...
class CloudRepoSourceContext extends $pb.GeneratedMessage {
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(_omitMessageNames ? '' : 'CloudRepoSourceContext', package: const $pb.PackageName(_omitMessageNames ? '' : 'google.devtools.source.v1'), createEmptyInstance: create)
    ..oo(0, [2, 3, 4])
...
class CloudWorkspaceSourceContext extends $pb.GeneratedMessage {
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(_omitMessageNames ? '' : 'CloudWorkspaceSourceContext', package: const $pb.PackageName(_omitMessageNames ? '' : 'google.devtools.source.v1'), createEmptyInstance: create)
    ..aOM<CloudWorkspaceId>(1, _omitFieldNames ? '' : 'workspaceId', subBuilder: CloudWorkspaceId.create)
  ...
  'Use [GeneratedMessageGenericExtensions.rebuild] instead. '
  'Will be removed in next major version')
  CloudWorkspaceSourceContext copyWith(void Function(CloudWorkspaceSourceContext) updates) => super.copyWith((message) => updates(message as CloudWorkspaceSourceContext)) as CloudWorkspaceSourceContext;
...
class GerritSourceContext extends $pb.GeneratedMessage {
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(_omitMessageNames ? '' : 'GerritSourceContext', package: const $pb.PackageName(_omitMessageNames ? '' : 'google.devtools.source.v1'), createEmptyInstance: create)
    ..oo(0, [3, 4, 5])
    ...
    ..aOM<AliasContext>(5, _omitFieldNames ? '' : 'aliasContext', subBuilder: AliasContext.create)
    ..hasRequiredFields = false
  ;
...
class GitSourceContext extends $pb.GeneratedMessage {
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(_omitMessageNames ? '' : 'GitSourceContext', package: const $pb.PackageName(_omitMessageNames ? '' : 'google.devtools.source.v1'), createEmptyInstance: create)
...
class RepoId extends $pb.GeneratedMessage {
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(_omitMessageNames ? '' : 'RepoId', package: const $pb.PackageName(_omitMessageNames ? '' : 'google.devtools.source.v1'), createEmptyInstance: create)
    ..oo(0, [1, 2])
...
class ProjectRepoId extends $pb.GeneratedMessage {
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(_omitMessageNames ? '' : 'ProjectRepoId', package: const $pb.PackageName(_omitMessageNames ? '' : 'google.devtools.source.v1'), createEmptyInstance: create)
...
class CloudWorkspaceId extends $pb.GeneratedMessage {
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(_omitMessageNames ? '' : 'CloudWorkspaceId', package: const $pb.PackageName(_omitMessageNames ? '' : 'google.devtools.source.v1'), createEmptyInstance: create)
    ..aOM<RepoId>(1, _omitFieldNames ? '' : 'repoId', subBuilder: RepoId.create)
    ..aOS(2, _omitFieldNames ? '' : 'name')
    ..hasRequiredFields = false
  ;
  ...
  'Use [GeneratedMessageGenericExtensions.rebuild] instead. '
  'Will be removed in next major version')
  CloudWorkspaceId copyWith(void Function(CloudWorkspaceId) updates) => super.copyWith((message) => updates(message as CloudWorkspaceId)) as CloudWorkspaceId;
