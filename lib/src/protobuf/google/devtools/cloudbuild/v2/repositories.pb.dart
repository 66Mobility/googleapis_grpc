...
class Connection extends $pb.GeneratedMessage {
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(_omitMessageNames ? '' : 'Connection', package: const $pb.PackageName(_omitMessageNames ? '' : 'google.devtools.cloudbuild.v2'), createEmptyInstance: create)
    ..oo(0, [5, 6, 7, 8, 9])
    ..aOS(1, _omitFieldNames ? '' : 'name')
    ..aOM<$1775.Timestamp>(3, _omitFieldNames ? '' : 'createTime', subBuilder: $1775.Timestamp.create)
    ..aOM<$1775.Timestamp>(4, _omitFieldNames ? '' : 'updateTime', subBuilder: $1775.Timestamp.create)
    ..aOM<GitHubConfig>(5, _omitFieldNames ? '' : 'githubConfig', subBuilder: GitHubConfig.create)
    ..aOM<GitHubEnterpriseConfig>(6, _omitFieldNames ? '' : 'githubEnterpriseConfig', subBuilder: GitHubEnterpriseConfig.create)
    ..aOM<GitLabConfig>(7, _omitFieldNames ? '' : 'gitlabConfig', subBuilder: GitLabConfig.create)
    ..aOM<BitbucketDataCenterConfig>(8, _omitFieldNames ? '' : 'bitbucketDataCenterConfig', subBuilder: BitbucketDataCenterConfig.create)
    ..aOM<BitbucketCloudConfig>(9, _omitFieldNames ? '' : 'bitbucketCloudConfig', subBuilder: BitbucketCloudConfig.create)
    ..aOM<InstallationState>(12, _omitFieldNames ? '' : 'installationState', subBuilder: InstallationState.create)
    ..aOB(13, _omitFieldNames ? '' : 'disabled')
    ..aOB(14, _omitFieldNames ? '' : 'reconciling')
    ..m<$core.String, $core.String>(15, _omitFieldNames ? '' : 'annotations', entryClassName: 'Connection.AnnotationsEntry', keyFieldType: $pb.PbFieldType.OS, valueFieldType: $pb.PbFieldType.OS, packageName: const $pb.PackageName('google.devtools.cloudbuild.v2'))
  ...
  @$pb.TagNumber(6)
  set githubEnterpriseConfig(GitHubEnterpriseConfig v) { setField(6, v); }
  @$pb.TagNumber(6)
  ...
  @$pb.TagNumber(7)
  set gitlabConfig(GitLabConfig v) { setField(7, v); }
  @$pb.TagNumber(7)
  ...
  @$pb.TagNumber(8)
  set bitbucketDataCenterConfig(BitbucketDataCenterConfig v) { setField(8, v); }
  @$pb.TagNumber(8)
  ...
  @$pb.TagNumber(9)
  set bitbucketCloudConfig(BitbucketCloudConfig v) { setField(9, v); }
  @$pb.TagNumber(9)
  ...
  @$pb.TagNumber(12)
  set installationState(InstallationState v) { setField(12, v); }
  @$pb.TagNumber(12)
...
class InstallationState extends $pb.GeneratedMessage {
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(_omitMessageNames ? '' : 'InstallationState', package: const $pb.PackageName(_omitMessageNames ? '' : 'google.devtools.cloudbuild.v2'), createEmptyInstance: create)
...
class FetchLinkableRepositoriesRequest extends $pb.GeneratedMessage {
  ...
  factory FetchLinkableRepositoriesRequest.fromBuffer($core.List<$core.int> i, [$pb.ExtensionRegistry r = $pb.ExtensionRegistry.EMPTY]) => create()..mergeFromBuffer(i, r);
  factory FetchLinkableRepositoriesRequest.fromJson($core.String i, [$pb.ExtensionRegistry r = $pb.ExtensionRegistry.EMPTY]) => create()..mergeFromJson(i, r);

  static final $pb.BuilderInfo _i = $pb.BuilderInfo(_omitMessageNames ? '' : 'FetchLinkableRepositoriesRequest', package: const $pb.PackageName(_omitMessageNames ? '' : 'google.devtools.cloudbuild.v2'), createEmptyInstance: create)
  ...
  'Use [GeneratedMessageGenericExtensions.deepCopy] instead. '
  'Will be removed in next major version')
  FetchLinkableRepositoriesRequest clone() => FetchLinkableRepositoriesRequest()..mergeFromMessage(this);
  @$core.Deprecated(
  'Using this can add significant overhead to your binary. '
  'Use [GeneratedMessageGenericExtensions.rebuild] instead. '
  'Will be removed in next major version')
  FetchLinkableRepositoriesRequest copyWith(void Function(FetchLinkableRepositoriesRequest) updates) => super.copyWith((message) => updates(message as FetchLinkableRepositoriesRequest)) as FetchLinkableRepositoriesRequest;

  $pb.BuilderInfo get info_ => _i;

  @$core.pragma('dart2js:noInline')
  static FetchLinkableRepositoriesRequest create() => FetchLinkableRepositoriesRequest._();
  FetchLinkableRepositoriesRequest createEmptyInstance() => create();
  static $pb.PbList<FetchLinkableRepositoriesRequest> createRepeated() => $pb.PbList<FetchLinkableRepositoriesRequest>();
  @$core.pragma('dart2js:noInline')
  static FetchLinkableRepositoriesRequest getDefault() => _defaultInstance ??= $pb.GeneratedMessage.$_defaultFor<FetchLinkableRepositoriesRequest>(create);
...
class FetchLinkableRepositoriesResponse extends $pb.GeneratedMessage {
  ...
  factory FetchLinkableRepositoriesResponse.fromBuffer($core.List<$core.int> i, [$pb.ExtensionRegistry r = $pb.ExtensionRegistry.EMPTY]) => create()..mergeFromBuffer(i, r);
  factory FetchLinkableRepositoriesResponse.fromJson($core.String i, [$pb.ExtensionRegistry r = $pb.ExtensionRegistry.EMPTY]) => create()..mergeFromJson(i, r);

  static final $pb.BuilderInfo _i = $pb.BuilderInfo(_omitMessageNames ? '' : 'FetchLinkableRepositoriesResponse', package: const $pb.PackageName(_omitMessageNames ? '' : 'google.devtools.cloudbuild.v2'), createEmptyInstance: create)
  ...
  'Use [GeneratedMessageGenericExtensions.deepCopy] instead. '
  'Will be removed in next major version')
  FetchLinkableRepositoriesResponse clone() => FetchLinkableRepositoriesResponse()..mergeFromMessage(this);
  @$core.Deprecated(
  'Using this can add significant overhead to your binary. '
  'Use [GeneratedMessageGenericExtensions.rebuild] instead. '
  'Will be removed in next major version')
  FetchLinkableRepositoriesResponse copyWith(void Function(FetchLinkableRepositoriesResponse) updates) => super.copyWith((message) => updates(message as FetchLinkableRepositoriesResponse)) as FetchLinkableRepositoriesResponse;

  $pb.BuilderInfo get info_ => _i;

  @$core.pragma('dart2js:noInline')
  static FetchLinkableRepositoriesResponse create() => FetchLinkableRepositoriesResponse._();
  FetchLinkableRepositoriesResponse createEmptyInstance() => create();
  static $pb.PbList<FetchLinkableRepositoriesResponse> createRepeated() => $pb.PbList<FetchLinkableRepositoriesResponse>();
  @$core.pragma('dart2js:noInline')
  static FetchLinkableRepositoriesResponse getDefault() => _defaultInstance ??= $pb.GeneratedMessage.$_defaultFor<FetchLinkableRepositoriesResponse>(create);
...
class GitHubConfig extends $pb.GeneratedMessage {
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(_omitMessageNames ? '' : 'GitHubConfig', package: const $pb.PackageName(_omitMessageNames ? '' : 'google.devtools.cloudbuild.v2'), createEmptyInstance: create)
    ..aOM<OAuthCredential>(1, _omitFieldNames ? '' : 'authorizerCredential', subBuilder: OAuthCredential.create)
  ...
  @$pb.TagNumber(1)
  set authorizerCredential(OAuthCredential v) { setField(1, v); }
  @$pb.TagNumber(1)
  ...
  @$pb.TagNumber(2)
  set appInstallationId($fixnum.Int64 v) { $_setInt64(1, v); }
  @$pb.TagNumber(2)
...
class GitHubEnterpriseConfig extends $pb.GeneratedMessage {
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(_omitMessageNames ? '' : 'GitHubEnterpriseConfig', package: const $pb.PackageName(_omitMessageNames ? '' : 'google.devtools.cloudbuild.v2'), createEmptyInstance: create)
    ...
    ..aOM<ServiceDirectoryConfig>(10, _omitFieldNames ? '' : 'serviceDirectoryConfig', subBuilder: ServiceDirectoryConfig.create)
  ...
  @$pb.TagNumber(4)
  set privateKeySecretVersion($core.String v) { $_setString(2, v); }
  @$pb.TagNumber(4)
  ...
  @$pb.TagNumber(5)
  set webhookSecretSecretVersion($core.String v) { $_setString(3, v); }
  @$pb.TagNumber(5)
  ...
  @$pb.TagNumber(9)
  set appInstallationId($fixnum.Int64 v) { $_setInt64(4, v); }
  @$pb.TagNumber(9)
  ...
  @$pb.TagNumber(10)
  set serviceDirectoryConfig(ServiceDirectoryConfig v) { setField(10, v); }
  @$pb.TagNumber(10)
  ...
  @$pb.TagNumber(11)
  set sslCa($core.String v) { $_setString(6, v); }
  @$pb.TagNumber(11)
  ...
  @$pb.TagNumber(13)
  set appSlug($core.String v) { $_setString(8, v); }
  @$pb.TagNumber(13)
  ...
  @$pb.TagNumber(14)
  set serverVersion($core.String v) { $_setString(9, v); }
  @$pb.TagNumber(14)
...
class GitLabConfig extends $pb.GeneratedMessage {
  ...
  factory GitLabConfig.fromBuffer($core.List<$core.int> i, [$pb.ExtensionRegistry r = $pb.ExtensionRegistry.EMPTY]) => create()..mergeFromBuffer(i, r);
  factory GitLabConfig.fromJson($core.String i, [$pb.ExtensionRegistry r = $pb.ExtensionRegistry.EMPTY]) => create()..mergeFromJson(i, r);

  static final $pb.BuilderInfo _i = $pb.BuilderInfo(_omitMessageNames ? '' : 'GitLabConfig', package: const $pb.PackageName(_omitMessageNames ? '' : 'google.devtools.cloudbuild.v2'), createEmptyInstance: create)
    ..aOS(1, _omitFieldNames ? '' : 'hostUri')
    ..aOS(2, _omitFieldNames ? '' : 'webhookSecretSecretVersion')
    ..aOM<UserCredential>(3, _omitFieldNames ? '' : 'readAuthorizerCredential', subBuilder: UserCredential.create)
    ..aOM<UserCredential>(4, _omitFieldNames ? '' : 'authorizerCredential', subBuilder: UserCredential.create)
    ..aOM<ServiceDirectoryConfig>(5, _omitFieldNames ? '' : 'serviceDirectoryConfig', subBuilder: ServiceDirectoryConfig.create)
  ...
  'Use [GeneratedMessageGenericExtensions.rebuild] instead. '
  'Will be removed in next major version')
  GitLabConfig copyWith(void Function(GitLabConfig) updates) => super.copyWith((message) => updates(message as GitLabConfig)) as GitLabConfig;
  ...
  static $pb.PbList<GitLabConfig> createRepeated() => $pb.PbList<GitLabConfig>();
  @$core.pragma('dart2js:noInline')
  static GitLabConfig getDefault() => _defaultInstance ??= $pb.GeneratedMessage.$_defaultFor<GitLabConfig>(create);
  ...
  @$pb.TagNumber(2)
  set webhookSecretSecretVersion($core.String v) { $_setString(1, v); }
  @$pb.TagNumber(2)
  ...
  @$pb.TagNumber(3)
  set readAuthorizerCredential(UserCredential v) { setField(3, v); }
  @$pb.TagNumber(3)
  ...
  @$pb.TagNumber(4)
  set authorizerCredential(UserCredential v) { setField(4, v); }
  @$pb.TagNumber(4)
  ...
  @$pb.TagNumber(5)
  set serviceDirectoryConfig(ServiceDirectoryConfig v) { setField(5, v); }
  @$pb.TagNumber(5)
  ...
  @$pb.TagNumber(6)
  set sslCa($core.String v) { $_setString(5, v); }
  @$pb.TagNumber(6)
  ...
  @$pb.TagNumber(7)
  set serverVersion($core.String v) { $_setString(6, v); }
  @$pb.TagNumber(7)
...
class BitbucketDataCenterConfig extends $pb.GeneratedMessage {
  ...
  factory BitbucketDataCenterConfig.fromBuffer($core.List<$core.int> i, [$pb.ExtensionRegistry r = $pb.ExtensionRegistry.EMPTY]) => create()..mergeFromBuffer(i, r);
  factory BitbucketDataCenterConfig.fromJson($core.String i, [$pb.ExtensionRegistry r = $pb.ExtensionRegistry.EMPTY]) => create()..mergeFromJson(i, r);

  static final $pb.BuilderInfo _i = $pb.BuilderInfo(_omitMessageNames ? '' : 'BitbucketDataCenterConfig', package: const $pb.PackageName(_omitMessageNames ? '' : 'google.devtools.cloudbuild.v2'), createEmptyInstance: create)
    ..aOS(1, _omitFieldNames ? '' : 'hostUri')
    ..aOS(2, _omitFieldNames ? '' : 'webhookSecretSecretVersion')
    ..aOM<UserCredential>(3, _omitFieldNames ? '' : 'readAuthorizerCredential', subBuilder: UserCredential.create)
    ..aOM<UserCredential>(4, _omitFieldNames ? '' : 'authorizerCredential', subBuilder: UserCredential.create)
  ...
  'Use [GeneratedMessageGenericExtensions.deepCopy] instead. '
  'Will be removed in next major version')
  BitbucketDataCenterConfig clone() => BitbucketDataCenterConfig()..mergeFromMessage(this);
  @$core.Deprecated(
  'Using this can add significant overhead to your binary. '
  'Use [GeneratedMessageGenericExtensions.rebuild] instead. '
  'Will be removed in next major version')
  BitbucketDataCenterConfig copyWith(void Function(BitbucketDataCenterConfig) updates) => super.copyWith((message) => updates(message as BitbucketDataCenterConfig)) as BitbucketDataCenterConfig;
  ...
  static $pb.PbList<BitbucketDataCenterConfig> createRepeated() => $pb.PbList<BitbucketDataCenterConfig>();
  @$core.pragma('dart2js:noInline')
  static BitbucketDataCenterConfig getDefault() => _defaultInstance ??= $pb.GeneratedMessage.$_defaultFor<BitbucketDataCenterConfig>(create);
...
class BitbucketCloudConfig extends $pb.GeneratedMessage {
  ...
  factory BitbucketCloudConfig.fromBuffer($core.List<$core.int> i, [$pb.ExtensionRegistry r = $pb.ExtensionRegistry.EMPTY]) => create()..mergeFromBuffer(i, r);
  factory BitbucketCloudConfig.fromJson($core.String i, [$pb.ExtensionRegistry r = $pb.ExtensionRegistry.EMPTY]) => create()..mergeFromJson(i, r);

  static final $pb.BuilderInfo _i = $pb.BuilderInfo(_omitMessageNames ? '' : 'BitbucketCloudConfig', package: const $pb.PackageName(_omitMessageNames ? '' : 'google.devtools.cloudbuild.v2'), createEmptyInstance: create)
  ...
  'Use [GeneratedMessageGenericExtensions.deepCopy] instead. '
  'Will be removed in next major version')
  BitbucketCloudConfig clone() => BitbucketCloudConfig()..mergeFromMessage(this);
  @$core.Deprecated(
  'Using this can add significant overhead to your binary. '
  'Use [GeneratedMessageGenericExtensions.rebuild] instead. '
  'Will be removed in next major version')
  BitbucketCloudConfig copyWith(void Function(BitbucketCloudConfig) updates) => super.copyWith((message) => updates(message as BitbucketCloudConfig)) as BitbucketCloudConfig;
  ...
  static $pb.PbList<BitbucketCloudConfig> createRepeated() => $pb.PbList<BitbucketCloudConfig>();
  @$core.pragma('dart2js:noInline')
  static BitbucketCloudConfig getDefault() => _defaultInstance ??= $pb.GeneratedMessage.$_defaultFor<BitbucketCloudConfig>(create);
...
class ServiceDirectoryConfig extends $pb.GeneratedMessage {
  ...
  factory ServiceDirectoryConfig.fromBuffer($core.List<$core.int> i, [$pb.ExtensionRegistry r = $pb.ExtensionRegistry.EMPTY]) => create()..mergeFromBuffer(i, r);
  factory ServiceDirectoryConfig.fromJson($core.String i, [$pb.ExtensionRegistry r = $pb.ExtensionRegistry.EMPTY]) => create()..mergeFromJson(i, r);

  static final $pb.BuilderInfo _i = $pb.BuilderInfo(_omitMessageNames ? '' : 'ServiceDirectoryConfig', package: const $pb.PackageName(_omitMessageNames ? '' : 'google.devtools.cloudbuild.v2'), createEmptyInstance: create)
  ...
  'Use [GeneratedMessageGenericExtensions.deepCopy] instead. '
  'Will be removed in next major version')
  ServiceDirectoryConfig clone() => ServiceDirectoryConfig()..mergeFromMessage(this);
  @$core.Deprecated(
  'Using this can add significant overhead to your binary. '
  'Use [GeneratedMessageGenericExtensions.rebuild] instead. '
  'Will be removed in next major version')
  ServiceDirectoryConfig copyWith(void Function(ServiceDirectoryConfig) updates) => super.copyWith((message) => updates(message as ServiceDirectoryConfig)) as ServiceDirectoryConfig;
  ...
  static $pb.PbList<ServiceDirectoryConfig> createRepeated() => $pb.PbList<ServiceDirectoryConfig>();
  @$core.pragma('dart2js:noInline')
  static ServiceDirectoryConfig getDefault() => _defaultInstance ??= $pb.GeneratedMessage.$_defaultFor<ServiceDirectoryConfig>(create);
...
class Repository extends $pb.GeneratedMessage {
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(_omitMessageNames ? '' : 'Repository', package: const $pb.PackageName(_omitMessageNames ? '' : 'google.devtools.cloudbuild.v2'), createEmptyInstance: create)
    ..aOS(1, _omitFieldNames ? '' : 'name')
    ...
    ..m<$core.String, $core.String>(6, _omitFieldNames ? '' : 'annotations', entryClassName: 'Repository.AnnotationsEntry', keyFieldType: $pb.PbFieldType.OS, valueFieldType: $pb.PbFieldType.OS, packageName: const $pb.PackageName('google.devtools.cloudbuild.v2'))
  ...
  @$pb.TagNumber(2)
  set remoteUri($core.String v) { $_setString(1, v); }
  @$pb.TagNumber(2)
...
class OAuthCredential extends $pb.GeneratedMessage {
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(_omitMessageNames ? '' : 'OAuthCredential', package: const $pb.PackageName(_omitMessageNames ? '' : 'google.devtools.cloudbuild.v2'), createEmptyInstance: create)
...
class UserCredential extends $pb.GeneratedMessage {
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(_omitMessageNames ? '' : 'UserCredential', package: const $pb.PackageName(_omitMessageNames ? '' : 'google.devtools.cloudbuild.v2'), createEmptyInstance: create)
  ...
  @$pb.TagNumber(1)
  set userTokenSecretVersion($core.String v) { $_setString(0, v); }
  @$pb.TagNumber(1)
...
class CreateConnectionRequest extends $pb.GeneratedMessage {
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(_omitMessageNames ? '' : 'CreateConnectionRequest', package: const $pb.PackageName(_omitMessageNames ? '' : 'google.devtools.cloudbuild.v2'), createEmptyInstance: create)
...
class GetConnectionRequest extends $pb.GeneratedMessage {
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(_omitMessageNames ? '' : 'GetConnectionRequest', package: const $pb.PackageName(_omitMessageNames ? '' : 'google.devtools.cloudbuild.v2'), createEmptyInstance: create)
    ..aOS(1, _omitFieldNames ? '' : 'name')
    ..hasRequiredFields = false
  ;
...
class ListConnectionsRequest extends $pb.GeneratedMessage {
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(_omitMessageNames ? '' : 'ListConnectionsRequest', package: const $pb.PackageName(_omitMessageNames ? '' : 'google.devtools.cloudbuild.v2'), createEmptyInstance: create)
    ..aOS(1, _omitFieldNames ? '' : 'parent')
    ..a<$core.int>(2, _omitFieldNames ? '' : 'pageSize', $pb.PbFieldType.O3)
    ..aOS(3, _omitFieldNames ? '' : 'pageToken')
    ..hasRequiredFields = false
...
class ListConnectionsResponse extends $pb.GeneratedMessage {
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(_omitMessageNames ? '' : 'ListConnectionsResponse', package: const $pb.PackageName(_omitMessageNames ? '' : 'google.devtools.cloudbuild.v2'), createEmptyInstance: create)
...
class UpdateConnectionRequest extends $pb.GeneratedMessage {
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(_omitMessageNames ? '' : 'UpdateConnectionRequest', package: const $pb.PackageName(_omitMessageNames ? '' : 'google.devtools.cloudbuild.v2'), createEmptyInstance: create)
...
class DeleteConnectionRequest extends $pb.GeneratedMessage {
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(_omitMessageNames ? '' : 'DeleteConnectionRequest', package: const $pb.PackageName(_omitMessageNames ? '' : 'google.devtools.cloudbuild.v2'), createEmptyInstance: create)
    ..aOS(1, _omitFieldNames ? '' : 'name')
...
class CreateRepositoryRequest extends $pb.GeneratedMessage {
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(_omitMessageNames ? '' : 'CreateRepositoryRequest', package: const $pb.PackageName(_omitMessageNames ? '' : 'google.devtools.cloudbuild.v2'), createEmptyInstance: create)
    ..aOS(1, _omitFieldNames ? '' : 'parent')
...
class BatchCreateRepositoriesRequest extends $pb.GeneratedMessage {
  ...
  factory BatchCreateRepositoriesRequest.fromBuffer($core.List<$core.int> i, [$pb.ExtensionRegistry r = $pb.ExtensionRegistry.EMPTY]) => create()..mergeFromBuffer(i, r);
  factory BatchCreateRepositoriesRequest.fromJson($core.String i, [$pb.ExtensionRegistry r = $pb.ExtensionRegistry.EMPTY]) => create()..mergeFromJson(i, r);

  static final $pb.BuilderInfo _i = $pb.BuilderInfo(_omitMessageNames ? '' : 'BatchCreateRepositoriesRequest', package: const $pb.PackageName(_omitMessageNames ? '' : 'google.devtools.cloudbuild.v2'), createEmptyInstance: create)
    ..aOS(1, _omitFieldNames ? '' : 'parent')
    ..pc<CreateRepositoryRequest>(2, _omitFieldNames ? '' : 'requests', $pb.PbFieldType.PM, subBuilder: CreateRepositoryRequest.create)
    ..hasRequiredFields = false
  ;
  ...
  'Use [GeneratedMessageGenericExtensions.deepCopy] instead. '
  'Will be removed in next major version')
  BatchCreateRepositoriesRequest clone() => BatchCreateRepositoriesRequest()..mergeFromMessage(this);
  @$core.Deprecated(
  'Using this can add significant overhead to your binary. '
  'Use [GeneratedMessageGenericExtensions.rebuild] instead. '
  'Will be removed in next major version')
  BatchCreateRepositoriesRequest copyWith(void Function(BatchCreateRepositoriesRequest) updates) => super.copyWith((message) => updates(message as BatchCreateRepositoriesRequest)) as BatchCreateRepositoriesRequest;

  $pb.BuilderInfo get info_ => _i;

  @$core.pragma('dart2js:noInline')
  static BatchCreateRepositoriesRequest create() => BatchCreateRepositoriesRequest._();
  BatchCreateRepositoriesRequest createEmptyInstance() => create();
  static $pb.PbList<BatchCreateRepositoriesRequest> createRepeated() => $pb.PbList<BatchCreateRepositoriesRequest>();
  @$core.pragma('dart2js:noInline')
  static BatchCreateRepositoriesRequest getDefault() => _defaultInstance ??= $pb.GeneratedMessage.$_defaultFor<BatchCreateRepositoriesRequest>(create);
...
class BatchCreateRepositoriesResponse extends $pb.GeneratedMessage {
  ...
  factory BatchCreateRepositoriesResponse.fromBuffer($core.List<$core.int> i, [$pb.ExtensionRegistry r = $pb.ExtensionRegistry.EMPTY]) => create()..mergeFromBuffer(i, r);
  factory BatchCreateRepositoriesResponse.fromJson($core.String i, [$pb.ExtensionRegistry r = $pb.ExtensionRegistry.EMPTY]) => create()..mergeFromJson(i, r);

  static final $pb.BuilderInfo _i = $pb.BuilderInfo(_omitMessageNames ? '' : 'BatchCreateRepositoriesResponse', package: const $pb.PackageName(_omitMessageNames ? '' : 'google.devtools.cloudbuild.v2'), createEmptyInstance: create)
    ..pc<Repository>(1, _omitFieldNames ? '' : 'repositories', $pb.PbFieldType.PM, subBuilder: Repository.create)
    ..hasRequiredFields = false
  ;
  ...
  'Use [GeneratedMessageGenericExtensions.deepCopy] instead. '
  'Will be removed in next major version')
  BatchCreateRepositoriesResponse clone() => BatchCreateRepositoriesResponse()..mergeFromMessage(this);
  @$core.Deprecated(
  'Using this can add significant overhead to your binary. '
  'Use [GeneratedMessageGenericExtensions.rebuild] instead. '
  'Will be removed in next major version')
  BatchCreateRepositoriesResponse copyWith(void Function(BatchCreateRepositoriesResponse) updates) => super.copyWith((message) => updates(message as BatchCreateRepositoriesResponse)) as BatchCreateRepositoriesResponse;

  $pb.BuilderInfo get info_ => _i;

  @$core.pragma('dart2js:noInline')
  static BatchCreateRepositoriesResponse create() => BatchCreateRepositoriesResponse._();
  BatchCreateRepositoriesResponse createEmptyInstance() => create();
  static $pb.PbList<BatchCreateRepositoriesResponse> createRepeated() => $pb.PbList<BatchCreateRepositoriesResponse>();
  @$core.pragma('dart2js:noInline')
  static BatchCreateRepositoriesResponse getDefault() => _defaultInstance ??= $pb.GeneratedMessage.$_defaultFor<BatchCreateRepositoriesResponse>(create);
...
class GetRepositoryRequest extends $pb.GeneratedMessage {
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(_omitMessageNames ? '' : 'GetRepositoryRequest', package: const $pb.PackageName(_omitMessageNames ? '' : 'google.devtools.cloudbuild.v2'), createEmptyInstance: create)
    ..aOS(1, _omitFieldNames ? '' : 'name')
    ..hasRequiredFields = false
  ;
...
class ListRepositoriesRequest extends $pb.GeneratedMessage {
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(_omitMessageNames ? '' : 'ListRepositoriesRequest', package: const $pb.PackageName(_omitMessageNames ? '' : 'google.devtools.cloudbuild.v2'), createEmptyInstance: create)
    ..aOS(1, _omitFieldNames ? '' : 'parent')
    ..a<$core.int>(2, _omitFieldNames ? '' : 'pageSize', $pb.PbFieldType.O3)
    ..aOS(3, _omitFieldNames ? '' : 'pageToken')
...
class ListRepositoriesResponse extends $pb.GeneratedMessage {
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(_omitMessageNames ? '' : 'ListRepositoriesResponse', package: const $pb.PackageName(_omitMessageNames ? '' : 'google.devtools.cloudbuild.v2'), createEmptyInstance: create)
    ..pc<Repository>(1, _omitFieldNames ? '' : 'repositories', $pb.PbFieldType.PM, subBuilder: Repository.create)
    ..aOS(2, _omitFieldNames ? '' : 'nextPageToken')
    ..hasRequiredFields = false
  ;
...
class DeleteRepositoryRequest extends $pb.GeneratedMessage {
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(_omitMessageNames ? '' : 'DeleteRepositoryRequest', package: const $pb.PackageName(_omitMessageNames ? '' : 'google.devtools.cloudbuild.v2'), createEmptyInstance: create)
    ..aOS(1, _omitFieldNames ? '' : 'name')
    ..aOS(2, _omitFieldNames ? '' : 'etag')
    ..aOB(3, _omitFieldNames ? '' : 'validateOnly')
    ..hasRequiredFields = false
...
class FetchReadWriteTokenRequest extends $pb.GeneratedMessage {
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(_omitMessageNames ? '' : 'FetchReadWriteTokenRequest', package: const $pb.PackageName(_omitMessageNames ? '' : 'google.devtools.cloudbuild.v2'), createEmptyInstance: create)
...
class FetchReadTokenRequest extends $pb.GeneratedMessage {
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(_omitMessageNames ? '' : 'FetchReadTokenRequest', package: const $pb.PackageName(_omitMessageNames ? '' : 'google.devtools.cloudbuild.v2'), createEmptyInstance: create)
    ..aOS(1, _omitFieldNames ? '' : 'repository')
    ..hasRequiredFields = false
  ;
...
class FetchReadTokenResponse extends $pb.GeneratedMessage {
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(_omitMessageNames ? '' : 'FetchReadTokenResponse', package: const $pb.PackageName(_omitMessageNames ? '' : 'google.devtools.cloudbuild.v2'), createEmptyInstance: create)
...
class FetchReadWriteTokenResponse extends $pb.GeneratedMessage {
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(_omitMessageNames ? '' : 'FetchReadWriteTokenResponse', package: const $pb.PackageName(_omitMessageNames ? '' : 'google.devtools.cloudbuild.v2'), createEmptyInstance: create)
    ..aOS(1, _omitFieldNames ? '' : 'token')
    ..aOM<$1775.Timestamp>(2, _omitFieldNames ? '' : 'expirationTime', subBuilder: $1775.Timestamp.create)
    ..hasRequiredFields = false
  ;
...
class ProcessWebhookRequest extends $pb.GeneratedMessage {
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(_omitMessageNames ? '' : 'ProcessWebhookRequest', package: const $pb.PackageName(_omitMessageNames ? '' : 'google.devtools.cloudbuild.v2'), createEmptyInstance: create)
    ..aOS(1, _omitFieldNames ? '' : 'parent')
    ..aOM<$518.HttpBody>(2, _omitFieldNames ? '' : 'body', subBuilder: $518.HttpBody.create)
  ...
  /// HTTP request body.
  @$pb.TagNumber(2)
  $518.HttpBody get body => $_getN(1);
  @$pb.TagNumber(2)
  set body($518.HttpBody v) { setField(2, v); }
  @$pb.TagNumber(2)
  $core.bool hasBody() => $_has(1);
  @$pb.TagNumber(2)
  void clearBody() => clearField(2);
  @$pb.TagNumber(2)
  $518.HttpBody ensureBody() => $_ensure(1);
  ...
  @$pb.TagNumber(3)
  set webhookKey($core.String v) { $_setString(2, v); }
  @$pb.TagNumber(3)
...
class FetchGitRefsRequest extends $pb.GeneratedMessage {
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(_omitMessageNames ? '' : 'FetchGitRefsRequest', package: const $pb.PackageName(_omitMessageNames ? '' : 'google.devtools.cloudbuild.v2'), createEmptyInstance: create)
    ..aOS(1, _omitFieldNames ? '' : 'repository')
...
class FetchGitRefsResponse extends $pb.GeneratedMessage {
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(_omitMessageNames ? '' : 'FetchGitRefsResponse', package: const $pb.PackageName(_omitMessageNames ? '' : 'google.devtools.cloudbuild.v2'), createEmptyInstance: create)
