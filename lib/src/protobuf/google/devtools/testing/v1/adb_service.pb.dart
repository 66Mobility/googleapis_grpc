...
class DeviceMessage extends $pb.GeneratedMessage {
  ...
  factory DeviceMessage.fromBuffer($core.List<$core.int> i, [$pb.ExtensionRegistry r = $pb.ExtensionRegistry.EMPTY]) => create()..mergeFromBuffer(i, r);
  factory DeviceMessage.fromJson($core.String i, [$pb.ExtensionRegistry r = $pb.ExtensionRegistry.EMPTY]) => create()..mergeFromJson(i, r);

  static const $core.Map<$core.int, DeviceMessage_Contents> _DeviceMessage_ContentsByTag = {
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(_omitMessageNames ? '' : 'DeviceMessage', package: const $pb.PackageName(_omitMessageNames ? '' : 'google.devtools.testing.v1'), createEmptyInstance: create)
    ..oo(0, [1, 2, 3])
    ..aOM<StatusUpdate>(1, _omitFieldNames ? '' : 'statusUpdate', subBuilder: StatusUpdate.create)
    ..aOM<StreamStatus>(2, _omitFieldNames ? '' : 'streamStatus', subBuilder: StreamStatus.create)
    ..aOM<StreamData>(3, _omitFieldNames ? '' : 'streamData', subBuilder: StreamData.create)
  ...
  'Will be removed in next major version')
  DeviceMessage copyWith(void Function(DeviceMessage) updates) => super.copyWith((message) => updates(message as DeviceMessage)) as DeviceMessage;
  ...
  static $pb.PbList<DeviceMessage> createRepeated() => $pb.PbList<DeviceMessage>();
  @$core.pragma('dart2js:noInline')
  static DeviceMessage getDefault() => _defaultInstance ??= $pb.GeneratedMessage.$_defaultFor<DeviceMessage>(create);
  static DeviceMessage? _defaultInstance;

  DeviceMessage_Contents whichContents() => _DeviceMessage_ContentsByTag[$_whichOneof(0)]!;
  ...
  @$pb.TagNumber(1)
  set statusUpdate(StatusUpdate v) { setField(1, v); }
  @$pb.TagNumber(1)
  ...
  @$pb.TagNumber(2)
  set streamStatus(StreamStatus v) { setField(2, v); }
  @$pb.TagNumber(2)
  ...
  @$pb.TagNumber(3)
  set streamData(StreamData v) { setField(3, v); }
  @$pb.TagNumber(3)
...
class AdbMessage extends $pb.GeneratedMessage {
  ...
  AdbMessage._() : super();
  factory AdbMessage.fromBuffer($core.List<$core.int> i, [$pb.ExtensionRegistry r = $pb.ExtensionRegistry.EMPTY]) => create()..mergeFromBuffer(i, r);
  factory AdbMessage.fromJson($core.String i, [$pb.ExtensionRegistry r = $pb.ExtensionRegistry.EMPTY]) => create()..mergeFromJson(i, r);

  static const $core.Map<$core.int, AdbMessage_Contents> _AdbMessage_ContentsByTag = {
    1 : AdbMessage_Contents.open,
    2 : AdbMessage_Contents.streamData,
    0 : AdbMessage_Contents.notSet
  };
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(_omitMessageNames ? '' : 'AdbMessage', package: const $pb.PackageName(_omitMessageNames ? '' : 'google.devtools.testing.v1'), createEmptyInstance: create)
    ..oo(0, [1, 2])
    ..aOM<Open>(1, _omitFieldNames ? '' : 'open', subBuilder: Open.create)
    ..aOM<StreamData>(2, _omitFieldNames ? '' : 'streamData', subBuilder: StreamData.create)
    ..hasRequiredFields = false
  ;
  ...
  'Use [GeneratedMessageGenericExtensions.rebuild] instead. '
  'Will be removed in next major version')
  AdbMessage copyWith(void Function(AdbMessage) updates) => super.copyWith((message) => updates(message as AdbMessage)) as AdbMessage;
  ...
  @$core.pragma('dart2js:noInline')
  static AdbMessage getDefault() => _defaultInstance ??= $pb.GeneratedMessage.$_defaultFor<AdbMessage>(create);
  static AdbMessage? _defaultInstance;

  AdbMessage_Contents whichContents() => _AdbMessage_ContentsByTag[$_whichOneof(0)]!;
  void clearContents() => clearField($_whichOneof(0));
  ...
  @$pb.TagNumber(2)
  set streamData(StreamData v) { setField(2, v); }
  @$pb.TagNumber(2)
...
class StatusUpdate extends $pb.GeneratedMessage {
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(_omitMessageNames ? '' : 'StatusUpdate', package: const $pb.PackageName(_omitMessageNames ? '' : 'google.devtools.testing.v1'), createEmptyInstance: create)
    ..e<StatusUpdate_DeviceState>(1, _omitFieldNames ? '' : 'state', $pb.PbFieldType.OE, defaultOrMaker: StatusUpdate_DeviceState.DEVICE_STATE_UNSPECIFIED, valueOf: StatusUpdate_DeviceState.valueOf, enumValues: StatusUpdate_DeviceState.values)
    ..m<$core.String, $core.String>(2, _omitFieldNames ? '' : 'properties', entryClassName: 'StatusUpdate.PropertiesEntry', keyFieldType: $pb.PbFieldType.OS, valueFieldType: $pb.PbFieldType.OS, packageName: const $pb.PackageName('google.devtools.testing.v1'))
  ...
  @$pb.TagNumber(1)
  set state(StatusUpdate_DeviceState v) { setField(1, v); }
  @$pb.TagNumber(1)
  ...
  @$pb.TagNumber(3)
  set features($core.String v) { $_setString(2, v); }
  @$pb.TagNumber(3)
...
class StreamStatus extends $pb.GeneratedMessage {
  ...
  static const $core.Map<$core.int, StreamStatus_Status> _StreamStatus_StatusByTag = {
    2 : StreamStatus_Status.okay,
    3 : StreamStatus_Status.fail,
    0 : StreamStatus_Status.notSet
  };
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(_omitMessageNames ? '' : 'StreamStatus', package: const $pb.PackageName(_omitMessageNames ? '' : 'google.devtools.testing.v1'), createEmptyInstance: create)
    ..oo(0, [2, 3])
  ...
  StreamStatus_Status whichStatus() => _StreamStatus_StatusByTag[$_whichOneof(0)]!;
...
class Open extends $pb.GeneratedMessage {
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(_omitMessageNames ? '' : 'Open', package: const $pb.PackageName(_omitMessageNames ? '' : 'google.devtools.testing.v1'), createEmptyInstance: create)
    ..a<$core.int>(1, _omitFieldNames ? '' : 'streamId', $pb.PbFieldType.O3)
  ...
  'Use [GeneratedMessageGenericExtensions.rebuild] instead. '
  'Will be removed in next major version')
  Open copyWith(void Function(Open) updates) => super.copyWith((message) => updates(message as Open)) as Open;
...
class StreamData extends $pb.GeneratedMessage {
  ...
  static const $core.Map<$core.int, StreamData_Contents> _StreamData_ContentsByTag = {
    2 : StreamData_Contents.data,
    3 : StreamData_Contents.close,
    0 : StreamData_Contents.notSet
  };
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(_omitMessageNames ? '' : 'StreamData', package: const $pb.PackageName(_omitMessageNames ? '' : 'google.devtools.testing.v1'), createEmptyInstance: create)
    ..oo(0, [2, 3])
    ..a<$core.int>(1, _omitFieldNames ? '' : 'streamId', $pb.PbFieldType.O3)
  ...
  StreamData_Contents whichContents() => _StreamData_ContentsByTag[$_whichOneof(0)]!;
  void clearContents() => clearField($_whichOneof(0));
  ...
  @$pb.TagNumber(3)
  set close(Close v) { setField(3, v); }
  @$pb.TagNumber(3)
...
class Okay extends $pb.GeneratedMessage {
  factory Okay() => create();
  Okay._() : super();
  factory Okay.fromBuffer($core.List<$core.int> i, [$pb.ExtensionRegistry r = $pb.ExtensionRegistry.EMPTY]) => create()..mergeFromBuffer(i, r);
  factory Okay.fromJson($core.String i, [$pb.ExtensionRegistry r = $pb.ExtensionRegistry.EMPTY]) => create()..mergeFromJson(i, r);

  static final $pb.BuilderInfo _i = $pb.BuilderInfo(_omitMessageNames ? '' : 'Okay', package: const $pb.PackageName(_omitMessageNames ? '' : 'google.devtools.testing.v1'), createEmptyInstance: create)
    ..hasRequiredFields = false
  ;
  ...
  'Use [GeneratedMessageGenericExtensions.rebuild] instead. '
  'Will be removed in next major version')
  Okay copyWith(void Function(Okay) updates) => super.copyWith((message) => updates(message as Okay)) as Okay;
  ...
  @$core.pragma('dart2js:noInline')
  static Okay getDefault() => _defaultInstance ??= $pb.GeneratedMessage.$_defaultFor<Okay>(create);
...
class Fail extends $pb.GeneratedMessage {
  ...
  Fail._() : super();
  factory Fail.fromBuffer($core.List<$core.int> i, [$pb.ExtensionRegistry r = $pb.ExtensionRegistry.EMPTY]) => create()..mergeFromBuffer(i, r);
  factory Fail.fromJson($core.String i, [$pb.ExtensionRegistry r = $pb.ExtensionRegistry.EMPTY]) => create()..mergeFromJson(i, r);

  static final $pb.BuilderInfo _i = $pb.BuilderInfo(_omitMessageNames ? '' : 'Fail', package: const $pb.PackageName(_omitMessageNames ? '' : 'google.devtools.testing.v1'), createEmptyInstance: create)
  ...
  'Use [GeneratedMessageGenericExtensions.rebuild] instead. '
  'Will be removed in next major version')
  Fail copyWith(void Function(Fail) updates) => super.copyWith((message) => updates(message as Fail)) as Fail;
  ...
  @$core.pragma('dart2js:noInline')
  static Fail getDefault() => _defaultInstance ??= $pb.GeneratedMessage.$_defaultFor<Fail>(create);
...
class Close extends $pb.GeneratedMessage {
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(_omitMessageNames ? '' : 'Close', package: const $pb.PackageName(_omitMessageNames ? '' : 'google.devtools.testing.v1'), createEmptyInstance: create)
    ..hasRequiredFields = false
  ;
