...
class CreateDeviceSessionRequest extends $pb.GeneratedMessage {
  ...
  factory CreateDeviceSessionRequest.fromBuffer($core.List<$core.int> i, [$pb.ExtensionRegistry r = $pb.ExtensionRegistry.EMPTY]) => create()..mergeFromBuffer(i, r);
  factory CreateDeviceSessionRequest.fromJson($core.String i, [$pb.ExtensionRegistry r = $pb.ExtensionRegistry.EMPTY]) => create()..mergeFromJson(i, r);

  static final $pb.BuilderInfo _i = $pb.BuilderInfo(_omitMessageNames ? '' : 'CreateDeviceSessionRequest', package: const $pb.PackageName(_omitMessageNames ? '' : 'google.devtools.testing.v1'), createEmptyInstance: create)
    ..aOS(1, _omitFieldNames ? '' : 'parent')
    ..aOM<DeviceSession>(2, _omitFieldNames ? '' : 'deviceSession', subBuilder: DeviceSession.create)
  ...
  CreateDeviceSessionRequest clone() => CreateDeviceSessionRequest()..mergeFromMessage(this);
  @$core.Deprecated(
  'Using this can add significant overhead to your binary. '
  'Use [GeneratedMessageGenericExtensions.rebuild] instead. '
  'Will be removed in next major version')
  CreateDeviceSessionRequest copyWith(void Function(CreateDeviceSessionRequest) updates) => super.copyWith((message) => updates(message as CreateDeviceSessionRequest)) as CreateDeviceSessionRequest;
  ...
  static $pb.PbList<CreateDeviceSessionRequest> createRepeated() => $pb.PbList<CreateDeviceSessionRequest>();
  @$core.pragma('dart2js:noInline')
  static CreateDeviceSessionRequest getDefault() => _defaultInstance ??= $pb.GeneratedMessage.$_defaultFor<CreateDeviceSessionRequest>(create);
  ...
  @$pb.TagNumber(2)
  set deviceSession(DeviceSession v) { setField(2, v); }
  @$pb.TagNumber(2)
...
class ListDeviceSessionsRequest extends $pb.GeneratedMessage {
  ...
  factory ListDeviceSessionsRequest.fromBuffer($core.List<$core.int> i, [$pb.ExtensionRegistry r = $pb.ExtensionRegistry.EMPTY]) => create()..mergeFromBuffer(i, r);
  factory ListDeviceSessionsRequest.fromJson($core.String i, [$pb.ExtensionRegistry r = $pb.ExtensionRegistry.EMPTY]) => create()..mergeFromJson(i, r);

  static final $pb.BuilderInfo _i = $pb.BuilderInfo(_omitMessageNames ? '' : 'ListDeviceSessionsRequest', package: const $pb.PackageName(_omitMessageNames ? '' : 'google.devtools.testing.v1'), createEmptyInstance: create)
  ...
  'Use [GeneratedMessageGenericExtensions.deepCopy] instead. '
  'Will be removed in next major version')
  ListDeviceSessionsRequest clone() => ListDeviceSessionsRequest()..mergeFromMessage(this);
  @$core.Deprecated(
  'Using this can add significant overhead to your binary. '
  'Use [GeneratedMessageGenericExtensions.rebuild] instead. '
  'Will be removed in next major version')
  ListDeviceSessionsRequest copyWith(void Function(ListDeviceSessionsRequest) updates) => super.copyWith((message) => updates(message as ListDeviceSessionsRequest)) as ListDeviceSessionsRequest;
  ...
  static $pb.PbList<ListDeviceSessionsRequest> createRepeated() => $pb.PbList<ListDeviceSessionsRequest>();
  @$core.pragma('dart2js:noInline')
  static ListDeviceSessionsRequest getDefault() => _defaultInstance ??= $pb.GeneratedMessage.$_defaultFor<ListDeviceSessionsRequest>(create);
...
class ListDeviceSessionsResponse extends $pb.GeneratedMessage {
  ...
  factory ListDeviceSessionsResponse.fromBuffer($core.List<$core.int> i, [$pb.ExtensionRegistry r = $pb.ExtensionRegistry.EMPTY]) => create()..mergeFromBuffer(i, r);
  factory ListDeviceSessionsResponse.fromJson($core.String i, [$pb.ExtensionRegistry r = $pb.ExtensionRegistry.EMPTY]) => create()..mergeFromJson(i, r);

  static final $pb.BuilderInfo _i = $pb.BuilderInfo(_omitMessageNames ? '' : 'ListDeviceSessionsResponse', package: const $pb.PackageName(_omitMessageNames ? '' : 'google.devtools.testing.v1'), createEmptyInstance: create)
    ..pc<DeviceSession>(1, _omitFieldNames ? '' : 'deviceSessions', $pb.PbFieldType.PM, subBuilder: DeviceSession.create)
  ...
  'Use [GeneratedMessageGenericExtensions.deepCopy] instead. '
  'Will be removed in next major version')
  ListDeviceSessionsResponse clone() => ListDeviceSessionsResponse()..mergeFromMessage(this);
  @$core.Deprecated(
  'Using this can add significant overhead to your binary. '
  'Use [GeneratedMessageGenericExtensions.rebuild] instead. '
  'Will be removed in next major version')
  ListDeviceSessionsResponse copyWith(void Function(ListDeviceSessionsResponse) updates) => super.copyWith((message) => updates(message as ListDeviceSessionsResponse)) as ListDeviceSessionsResponse;
  ...
  static $pb.PbList<ListDeviceSessionsResponse> createRepeated() => $pb.PbList<ListDeviceSessionsResponse>();
  @$core.pragma('dart2js:noInline')
  static ListDeviceSessionsResponse getDefault() => _defaultInstance ??= $pb.GeneratedMessage.$_defaultFor<ListDeviceSessionsResponse>(create);
...
class GetDeviceSessionRequest extends $pb.GeneratedMessage {
  ...
  factory GetDeviceSessionRequest.fromBuffer($core.List<$core.int> i, [$pb.ExtensionRegistry r = $pb.ExtensionRegistry.EMPTY]) => create()..mergeFromBuffer(i, r);
  factory GetDeviceSessionRequest.fromJson($core.String i, [$pb.ExtensionRegistry r = $pb.ExtensionRegistry.EMPTY]) => create()..mergeFromJson(i, r);

  static final $pb.BuilderInfo _i = $pb.BuilderInfo(_omitMessageNames ? '' : 'GetDeviceSessionRequest', package: const $pb.PackageName(_omitMessageNames ? '' : 'google.devtools.testing.v1'), createEmptyInstance: create)
  ...
  'Use [GeneratedMessageGenericExtensions.deepCopy] instead. '
  'Will be removed in next major version')
  GetDeviceSessionRequest clone() => GetDeviceSessionRequest()..mergeFromMessage(this);
  @$core.Deprecated(
  'Using this can add significant overhead to your binary. '
  'Use [GeneratedMessageGenericExtensions.rebuild] instead. '
  'Will be removed in next major version')
  GetDeviceSessionRequest copyWith(void Function(GetDeviceSessionRequest) updates) => super.copyWith((message) => updates(message as GetDeviceSessionRequest)) as GetDeviceSessionRequest;
  ...
  static $pb.PbList<GetDeviceSessionRequest> createRepeated() => $pb.PbList<GetDeviceSessionRequest>();
  @$core.pragma('dart2js:noInline')
  static GetDeviceSessionRequest getDefault() => _defaultInstance ??= $pb.GeneratedMessage.$_defaultFor<GetDeviceSessionRequest>(create);
...
class CancelDeviceSessionRequest extends $pb.GeneratedMessage {
  ...
  factory CancelDeviceSessionRequest.fromBuffer($core.List<$core.int> i, [$pb.ExtensionRegistry r = $pb.ExtensionRegistry.EMPTY]) => create()..mergeFromBuffer(i, r);
  factory CancelDeviceSessionRequest.fromJson($core.String i, [$pb.ExtensionRegistry r = $pb.ExtensionRegistry.EMPTY]) => create()..mergeFromJson(i, r);

  static final $pb.BuilderInfo _i = $pb.BuilderInfo(_omitMessageNames ? '' : 'CancelDeviceSessionRequest', package: const $pb.PackageName(_omitMessageNames ? '' : 'google.devtools.testing.v1'), createEmptyInstance: create)
    ..aOS(1, _omitFieldNames ? '' : 'name')
    ..hasRequiredFields = false
  ;
  ...
  'Use [GeneratedMessageGenericExtensions.deepCopy] instead. '
  'Will be removed in next major version')
  CancelDeviceSessionRequest clone() => CancelDeviceSessionRequest()..mergeFromMessage(this);
  @$core.Deprecated(
  'Using this can add significant overhead to your binary. '
  'Use [GeneratedMessageGenericExtensions.rebuild] instead. '
  'Will be removed in next major version')
  CancelDeviceSessionRequest copyWith(void Function(CancelDeviceSessionRequest) updates) => super.copyWith((message) => updates(message as CancelDeviceSessionRequest)) as CancelDeviceSessionRequest;
  ...
  static $pb.PbList<CancelDeviceSessionRequest> createRepeated() => $pb.PbList<CancelDeviceSessionRequest>();
  @$core.pragma('dart2js:noInline')
  static CancelDeviceSessionRequest getDefault() => _defaultInstance ??= $pb.GeneratedMessage.$_defaultFor<CancelDeviceSessionRequest>(create);
...
class UpdateDeviceSessionRequest extends $pb.GeneratedMessage {
  ...
  factory UpdateDeviceSessionRequest.fromBuffer($core.List<$core.int> i, [$pb.ExtensionRegistry r = $pb.ExtensionRegistry.EMPTY]) => create()..mergeFromBuffer(i, r);
  factory UpdateDeviceSessionRequest.fromJson($core.String i, [$pb.ExtensionRegistry r = $pb.ExtensionRegistry.EMPTY]) => create()..mergeFromJson(i, r);
  ...
  'Use [GeneratedMessageGenericExtensions.deepCopy] instead. '
  'Will be removed in next major version')
  UpdateDeviceSessionRequest clone() => UpdateDeviceSessionRequest()..mergeFromMessage(this);
  @$core.Deprecated(
  'Using this can add significant overhead to your binary. '
  'Use [GeneratedMessageGenericExtensions.rebuild] instead. '
  'Will be removed in next major version')
  UpdateDeviceSessionRequest copyWith(void Function(UpdateDeviceSessionRequest) updates) => super.copyWith((message) => updates(message as UpdateDeviceSessionRequest)) as UpdateDeviceSessionRequest;
  ...
  static $pb.PbList<UpdateDeviceSessionRequest> createRepeated() => $pb.PbList<UpdateDeviceSessionRequest>();
  @$core.pragma('dart2js:noInline')
  static UpdateDeviceSessionRequest getDefault() => _defaultInstance ??= $pb.GeneratedMessage.$_defaultFor<UpdateDeviceSessionRequest>(create);
  ...
  @$pb.TagNumber(1)
  set deviceSession(DeviceSession v) { setField(1, v); }
  @$pb.TagNumber(1)
...
class DeviceSession_SessionStateEvent extends $pb.GeneratedMessage {
  ...
  factory DeviceSession_SessionStateEvent.fromBuffer($core.List<$core.int> i, [$pb.ExtensionRegistry r = $pb.ExtensionRegistry.EMPTY]) => create()..mergeFromBuffer(i, r);
  factory DeviceSession_SessionStateEvent.fromJson($core.String i, [$pb.ExtensionRegistry r = $pb.ExtensionRegistry.EMPTY]) => create()..mergeFromJson(i, r);
  ...
  'Use [GeneratedMessageGenericExtensions.deepCopy] instead. '
  'Will be removed in next major version')
  DeviceSession_SessionStateEvent clone() => DeviceSession_SessionStateEvent()..mergeFromMessage(this);
  @$core.Deprecated(
  'Using this can add significant overhead to your binary. '
  'Use [GeneratedMessageGenericExtensions.rebuild] instead. '
  'Will be removed in next major version')
  DeviceSession_SessionStateEvent copyWith(void Function(DeviceSession_SessionStateEvent) updates) => super.copyWith((message) => updates(message as DeviceSession_SessionStateEvent)) as DeviceSession_SessionStateEvent;

  $pb.BuilderInfo get info_ => _i;

  @$core.pragma('dart2js:noInline')
  static DeviceSession_SessionStateEvent create() => DeviceSession_SessionStateEvent._();
  DeviceSession_SessionStateEvent createEmptyInstance() => create();
  static $pb.PbList<DeviceSession_SessionStateEvent> createRepeated() => $pb.PbList<DeviceSession_SessionStateEvent>();
  @$core.pragma('dart2js:noInline')
  static DeviceSession_SessionStateEvent getDefault() => _defaultInstance ??= $pb.GeneratedMessage.$_defaultFor<DeviceSession_SessionStateEvent>(create);
  ...
  @$pb.TagNumber(1)
  set sessionState(DeviceSession_SessionState v) { setField(1, v); }
  @$pb.TagNumber(1)
  ...
  @$pb.TagNumber(3)
  set stateMessage($core.String v) { $_setString(2, v); }
  @$pb.TagNumber(3)
...
class DeviceSession extends $pb.GeneratedMessage {
  ...
  static const $core.Map<$core.int, DeviceSession_Expiration> _DeviceSession_ExpirationByTag = {
    5 : DeviceSession_Expiration.expireTime,
    13 : DeviceSession_Expiration.ttl,
    0 : DeviceSession_Expiration.notSet
  };
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(_omitMessageNames ? '' : 'DeviceSession', package: const $pb.PackageName(_omitMessageNames ? '' : 'google.devtools.testing.v1'), createEmptyInstance: create)
    ..oo(0, [5, 13])
    ..aOS(1, _omitFieldNames ? '' : 'name')
  ...
  DeviceSession_Expiration whichExpiration() => _DeviceSession_ExpirationByTag[$_whichOneof(0)]!;
  ...
  @$pb.TagNumber(3)
  set state(DeviceSession_SessionState v) { setField(3, v); }
  @$pb.TagNumber(3)
  ...
  @$pb.TagNumber(14)
  $core.List<DeviceSession_SessionStateEvent> get stateHistories => $_getList(8);

  /// Required. The requested device
  @$pb.TagNumber(15)
  $1589.AndroidDevice get androidDevice => $_getN(9);
  @$pb.TagNumber(15)
  set androidDevice($1589.AndroidDevice v) { setField(15, v); }
  @$pb.TagNumber(15)
  $core.bool hasAndroidDevice() => $_has(9);
  @$pb.TagNumber(15)
  void clearAndroidDevice() => clearField(15);
  @$pb.TagNumber(15)
  $1589.AndroidDevice ensureAndroidDevice() => $_ensure(9);
}
