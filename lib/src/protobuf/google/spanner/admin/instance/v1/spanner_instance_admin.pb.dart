...
import 'common.pb.dart' as $548;
import 'common.pbenum.dart' as $548;
...
class Instance extends $pb.GeneratedMessage {
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(_omitMessageNames ? '' : 'Instance', package: const $pb.PackageName(_omitMessageNames ? '' : 'google.spanner.admin.instance.v1'), createEmptyInstance: create)
    ...
    ..aOM<$301.Timestamp>(12, _omitFieldNames ? '' : 'updateTime', subBuilder: $301.Timestamp.create)
  ...
  @$pb.TagNumber(12)
  set updateTime($301.Timestamp v) { setField(12, v); }
  @$pb.TagNumber(12)
...
class GetInstanceRequest extends $pb.GeneratedMessage {
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(_omitMessageNames ? '' : 'GetInstanceRequest', package: const $pb.PackageName(_omitMessageNames ? '' : 'google.spanner.admin.instance.v1'), createEmptyInstance: create)
    ..aOS(1, _omitFieldNames ? '' : 'name')
    ..aOM<$332.FieldMask>(2, _omitFieldNames ? '' : 'fieldMask', subBuilder: $332.FieldMask.create)
    ..hasRequiredFields = false
  ;
  ...
  @$pb.TagNumber(2)
  $332.FieldMask get fieldMask => $_getN(1);
  @$pb.TagNumber(2)
  set fieldMask($332.FieldMask v) { setField(2, v); }
  @$pb.TagNumber(2)
  $core.bool hasFieldMask() => $_has(1);
  @$pb.TagNumber(2)
  void clearFieldMask() => clearField(2);
  @$pb.TagNumber(2)
  $332.FieldMask ensureFieldMask() => $_ensure(1);
}
...
class ListInstancesRequest extends $pb.GeneratedMessage {
  factory ListInstancesRequest({
    ...
    $core.String? pageToken,
    $core.String? filter,
    $301.Timestamp? instanceDeadline,
  }) {
    final $result = create();
    if (parent != null) {
      $result.parent = parent;
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(_omitMessageNames ? '' : 'ListInstancesRequest', package: const $pb.PackageName(_omitMessageNames ? '' : 'google.spanner.admin.instance.v1'), createEmptyInstance: create)
    ...
    ..aOM<$301.Timestamp>(5, _omitFieldNames ? '' : 'instanceDeadline', subBuilder: $301.Timestamp.create)
    ..hasRequiredFields = false
  ;
  ...
  /// [ListInstancesResponse][google.spanner.admin.instance.v1.ListInstancesResponse].
  @$pb.TagNumber(5)
  $301.Timestamp get instanceDeadline => $_getN(4);
  @$pb.TagNumber(5)
  set instanceDeadline($301.Timestamp v) { setField(5, v); }
  @$pb.TagNumber(5)
  $core.bool hasInstanceDeadline() => $_has(4);
  @$pb.TagNumber(5)
  void clearInstanceDeadline() => clearField(5);
  @$pb.TagNumber(5)
  $301.Timestamp ensureInstanceDeadline() => $_ensure(4);
}
...
class CreateInstanceMetadata extends $pb.GeneratedMessage {
  factory CreateInstanceMetadata({
    ...
    $548.FulfillmentPeriod? expectedFulfillmentPeriod,
  }) {
    final $result = create();
    if (instance != null) {
      $result.instance = instance;
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(_omitMessageNames ? '' : 'CreateInstanceMetadata', package: const $pb.PackageName(_omitMessageNames ? '' : 'google.spanner.admin.instance.v1'), createEmptyInstance: create)
    ...
    ..e<$548.FulfillmentPeriod>(5, _omitFieldNames ? '' : 'expectedFulfillmentPeriod', $pb.PbFieldType.OE, defaultOrMaker: $548.FulfillmentPeriod.FULFILLMENT_PERIOD_UNSPECIFIED, valueOf: $548.FulfillmentPeriod.valueOf, enumValues: $548.FulfillmentPeriod.values)
    ..hasRequiredFields = false
  ;
  ...
  @$pb.TagNumber(5)
  $548.FulfillmentPeriod get expectedFulfillmentPeriod => $_getN(4);
  @$pb.TagNumber(5)
  set expectedFulfillmentPeriod($548.FulfillmentPeriod v) { setField(5, v); }
  @$pb.TagNumber(5)
...
class CreateInstanceConfigMetadata extends $pb.GeneratedMessage {
  factory CreateInstanceConfigMetadata({
    InstanceConfig? instanceConfig,
    $548.OperationProgress? progress,
    $301.Timestamp? cancelTime,
  }) {
    final $result = create();
    if (instanceConfig != null) {
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(_omitMessageNames ? '' : 'CreateInstanceConfigMetadata', package: const $pb.PackageName(_omitMessageNames ? '' : 'google.spanner.admin.instance.v1'), createEmptyInstance: create)
    ..aOM<InstanceConfig>(1, _omitFieldNames ? '' : 'instanceConfig', subBuilder: InstanceConfig.create)
    ..aOM<$548.OperationProgress>(2, _omitFieldNames ? '' : 'progress', subBuilder: $548.OperationProgress.create)
    ..aOM<$301.Timestamp>(3, _omitFieldNames ? '' : 'cancelTime', subBuilder: $301.Timestamp.create)
    ..hasRequiredFields = false
  ;
  ...
  /// operation.
  @$pb.TagNumber(2)
  $548.OperationProgress get progress => $_getN(1);
  @$pb.TagNumber(2)
  set progress($548.OperationProgress v) { setField(2, v); }
  @$pb.TagNumber(2)
  $core.bool hasProgress() => $_has(1);
  @$pb.TagNumber(2)
  void clearProgress() => clearField(2);
  @$pb.TagNumber(2)
  $548.OperationProgress ensureProgress() => $_ensure(1);
...
class ListInstancePartitionsRequest extends $pb.GeneratedMessage {
  factory ListInstancePartitionsRequest({
    ...
    $core.int? pageSize,
    $core.String? pageToken,
    $301.Timestamp? instancePartitionDeadline,
  }) {
    final $result = create();
    if (parent != null) {
      $result.parent = parent;
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(_omitMessageNames ? '' : 'ListInstancePartitionsRequest', package: const $pb.PackageName(_omitMessageNames ? '' : 'google.spanner.admin.instance.v1'), createEmptyInstance: create)
    ...
    ..a<$core.int>(2, _omitFieldNames ? '' : 'pageSize', $pb.PbFieldType.O3)
    ..aOS(3, _omitFieldNames ? '' : 'pageToken')
    ..aOM<$301.Timestamp>(4, _omitFieldNames ? '' : 'instancePartitionDeadline', subBuilder: $301.Timestamp.create)
    ..hasRequiredFields = false
  ;
  ...
  /// [ListInstancePartitionsResponse][google.spanner.admin.instance.v1.ListInstancePartitionsResponse].
  @$pb.TagNumber(4)
  $301.Timestamp get instancePartitionDeadline => $_getN(3);
  @$pb.TagNumber(4)
  set instancePartitionDeadline($301.Timestamp v) { setField(4, v); }
  @$pb.TagNumber(4)
  $core.bool hasInstancePartitionDeadline() => $_has(3);
  @$pb.TagNumber(4)
  void clearInstancePartitionDeadline() => clearField(4);
  @$pb.TagNumber(4)
  $301.Timestamp ensureInstancePartitionDeadline() => $_ensure(3);
}
...
class ListInstancePartitionOperationsRequest extends $pb.GeneratedMessage {
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(_omitMessageNames ? '' : 'ListInstancePartitionOperationsRequest', package: const $pb.PackageName(_omitMessageNames ? '' : 'google.spanner.admin.instance.v1'), createEmptyInstance: create)
    ...
    ..a<$core.int>(3, _omitFieldNames ? '' : 'pageSize', $pb.PbFieldType.O3)
    ..aOS(4, _omitFieldNames ? '' : 'pageToken')
    ..aOM<$301.Timestamp>(5, _omitFieldNames ? '' : 'instancePartitionDeadline', subBuilder: $301.Timestamp.create)
    ..hasRequiredFields = false
  ;
  ...
  /// [ListInstancePartitionOperationsResponse][google.spanner.admin.instance.v1.ListInstancePartitionOperationsResponse].
  @$pb.TagNumber(5)
  $301.Timestamp get instancePartitionDeadline => $_getN(4);
  @$pb.TagNumber(5)
  set instancePartitionDeadline($301.Timestamp v) { setField(5, v); }
  @$pb.TagNumber(5)
  $core.bool hasInstancePartitionDeadline() => $_has(4);
  @$pb.TagNumber(5)
  void clearInstancePartitionDeadline() => clearField(5);
  @$pb.TagNumber(5)
  $301.Timestamp ensureInstancePartitionDeadline() => $_ensure(4);
}
