...
class BackupSchedule extends $pb.GeneratedMessage {
  factory BackupSchedule({
    ...
    $273.CreateBackupEncryptionConfig? encryptionConfig,
    BackupScheduleSpec? spec,
    $273.FullBackupSpec? fullBackupSpec,
    $273.IncrementalBackupSpec? incrementalBackupSpec,
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(
    ...
    ..aOM<$292.Duration>(3, _omitFieldNames ? '' : 'retentionDuration',
        subBuilder: $292.Duration.create)
    ..aOM<$273.CreateBackupEncryptionConfig>(
        4, _omitFieldNames ? '' : 'encryptionConfig',
        subBuilder: $273.CreateBackupEncryptionConfig.create)
    ..aOM<BackupScheduleSpec>(6, _omitFieldNames ? '' : 'spec',
        subBuilder: BackupScheduleSpec.create)
    ..aOM<$273.FullBackupSpec>(7, _omitFieldNames ? '' : 'fullBackupSpec',
        subBuilder: $273.FullBackupSpec.create)
    ..aOM<$273.IncrementalBackupSpec>(
        8, _omitFieldNames ? '' : 'incrementalBackupSpec',
        subBuilder: $273.IncrementalBackupSpec.create)
  ...
  @$pb.TagNumber(3)
  $292.Duration get retentionDuration => $_getN(1);
  @$pb.TagNumber(3)
  ...
  @$pb.TagNumber(3)
  $292.Duration ensureRetentionDuration() => $_ensure(1);
  ...
  @$pb.TagNumber(4)
  $273.CreateBackupEncryptionConfig get encryptionConfig => $_getN(2);
  @$pb.TagNumber(4)
  set encryptionConfig($273.CreateBackupEncryptionConfig v) {
    setField(4, v);
  }
  ...
  @$pb.TagNumber(4)
  $273.CreateBackupEncryptionConfig ensureEncryptionConfig() => $_ensure(2);
  ...
  @$pb.TagNumber(7)
  $273.FullBackupSpec get fullBackupSpec => $_getN(4);
  @$pb.TagNumber(7)
  set fullBackupSpec($273.FullBackupSpec v) {
    setField(7, v);
  }
  ...
  @$pb.TagNumber(7)
  $273.FullBackupSpec ensureFullBackupSpec() => $_ensure(4);

  /// The schedule creates incremental backup chains.
  @$pb.TagNumber(8)
  $273.IncrementalBackupSpec get incrementalBackupSpec => $_getN(5);
  @$pb.TagNumber(8)
  set incrementalBackupSpec($273.IncrementalBackupSpec v) {
    setField(8, v);
  }
  ...
  @$pb.TagNumber(8)
  $273.IncrementalBackupSpec ensureIncrementalBackupSpec() => $_ensure(5);
...
class CrontabSpec extends $pb.GeneratedMessage {
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(
    ...
    ..aOM<$292.Duration>(3, _omitFieldNames ? '' : 'creationWindow',
        subBuilder: $292.Duration.create)
    ..hasRequiredFields = false;
  ...
  /// `creation_window`.
  @$pb.TagNumber(3)
  $292.Duration get creationWindow => $_getN(2);
  @$pb.TagNumber(3)
  set creationWindow($292.Duration v) {
    setField(3, v);
  }
  ...
  @$pb.TagNumber(3)
  $292.Duration ensureCreationWindow() => $_ensure(2);
}
