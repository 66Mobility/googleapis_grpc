...
class RestoreInfo extends $pb.GeneratedMessage {
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(
    ...
    ..aOM<$273.BackupInfo>(2, _omitFieldNames ? '' : 'backupInfo',
        subBuilder: $273.BackupInfo.create)
  ...
  /// may no longer exist.
  @$pb.TagNumber(2)
  $273.BackupInfo get backupInfo => $_getN(1);
  @$pb.TagNumber(2)
  set backupInfo($273.BackupInfo v) {
    setField(2, v);
  }
  ...
  @$pb.TagNumber(2)
  $273.BackupInfo ensureBackupInfo() => $_ensure(1);
}
...
class Database extends $pb.GeneratedMessage {
  factory Database({
    ...
    $330.Timestamp? earliestVersionTime,
    $core.Iterable<$584.EncryptionInfo>? encryptionInfo,
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(
    ...
    ..aOM<$330.Timestamp>(7, _omitFieldNames ? '' : 'earliestVersionTime',
        subBuilder: $330.Timestamp.create)
  ...
  @$pb.TagNumber(7)
  $330.Timestamp get earliestVersionTime => $_getN(6);
  @$pb.TagNumber(7)
  set earliestVersionTime($330.Timestamp v) {
    setField(7, v);
  }
  ...
  @$pb.TagNumber(7)
  $330.Timestamp ensureEarliestVersionTime() => $_ensure(6);
  ...
  @$pb.TagNumber(8)
  $core.List<$584.EncryptionInfo> get encryptionInfo => $_getList(7);
...
class CreateDatabaseRequest extends $pb.GeneratedMessage {
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(
    ...
    ..aOM<$584.EncryptionConfig>(4, _omitFieldNames ? '' : 'encryptionConfig',
        subBuilder: $584.EncryptionConfig.create)
    ..e<$584.DatabaseDialect>(
  ...
  @$pb.TagNumber(4)
  $584.EncryptionConfig get encryptionConfig => $_getN(3);
  @$pb.TagNumber(4)
  set encryptionConfig($584.EncryptionConfig v) {
    setField(4, v);
  }
  ...
  @$pb.TagNumber(4)
  $584.EncryptionConfig ensureEncryptionConfig() => $_ensure(3);

  /// Optional. The dialect of the Cloud Spanner Database.
  @$pb.TagNumber(5)
  $584.DatabaseDialect get databaseDialect => $_getN(4);
  @$pb.TagNumber(5)
  set databaseDialect($584.DatabaseDialect v) {
    setField(5, v);
  }
...
class UpdateDatabaseMetadata extends $pb.GeneratedMessage {
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(
    ...
    ..aOM<$584.OperationProgress>(2, _omitFieldNames ? '' : 'progress',
  ...
  /// operation.
  @$pb.TagNumber(2)
  $584.OperationProgress get progress => $_getN(1);
  @$pb.TagNumber(2)
  ...
  @$pb.TagNumber(2)
  $584.OperationProgress ensureProgress() => $_ensure(1);
...
class UpdateDatabaseDdlMetadata extends $pb.GeneratedMessage {
  factory UpdateDatabaseDdlMetadata({
    $core.String? database,
    $core.Iterable<$core.String>? statements,
    $core.Iterable<$330.Timestamp>? commitTimestamps,
    $core.bool? throttled,
    $core.Iterable<$584.OperationProgress>? progress,
  ...
  @$pb.TagNumber(3)
  $core.List<$330.Timestamp> get commitTimestamps => $_getList(2);
  ...
  /// has completed.
  @$pb.TagNumber(5)
  $core.List<$584.OperationProgress> get progress => $_getList(4);
...
class RestoreDatabaseMetadata extends $pb.GeneratedMessage {
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(
    ...
    ..e<RestoreSourceType>(
        ...
        valueOf: RestoreSourceType.valueOf,
        enumValues: RestoreSourceType.values)
    ..aOM<$273.BackupInfo>(3, _omitFieldNames ? '' : 'backupInfo',
        subBuilder: $273.BackupInfo.create)
    ..aOM<$584.OperationProgress>(4, _omitFieldNames ? '' : 'progress',
        subBuilder: $584.OperationProgress.create)
    ..aOM<$330.Timestamp>(5, _omitFieldNames ? '' : 'cancelTime',
        subBuilder: $330.Timestamp.create)
  ...
  @$pb.TagNumber(3)
  $273.BackupInfo get backupInfo => $_getN(2);
  @$pb.TagNumber(3)
  set backupInfo($273.BackupInfo v) {
    setField(3, v);
  }
  ...
  @$pb.TagNumber(3)
  $273.BackupInfo ensureBackupInfo() => $_ensure(2);

  /// The progress of the
  /// [RestoreDatabase][google.spanner.admin.database.v1.DatabaseAdmin.RestoreDatabase]
  /// operation.
  @$pb.TagNumber(4)
  $584.OperationProgress get progress => $_getN(3);
  @$pb.TagNumber(4)
  set progress($584.OperationProgress v) {
    setField(4, v);
  }
  ...
  @$pb.TagNumber(4)
  $584.OperationProgress ensureProgress() => $_ensure(3);
  ...
  /// `Code.CANCELLED`.
  @$pb.TagNumber(5)
  $330.Timestamp get cancelTime => $_getN(4);
  @$pb.TagNumber(5)
  set cancelTime($330.Timestamp v) {
    setField(5, v);
  }
  ...
  @$pb.TagNumber(5)
  $330.Timestamp ensureCancelTime() => $_ensure(4);
