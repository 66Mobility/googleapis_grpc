...
class DatabaseDialect extends $pb.ProtobufEnum {
  static const DatabaseDialect DATABASE_DIALECT_UNSPECIFIED = DatabaseDialect._(0, _omitEnumNames ? '' : 'DATABASE_DIALECT_UNSPECIFIED');
  static const DatabaseDialect GOOGLE_STANDARD_SQL = DatabaseDialect._(1, _omitEnumNames ? '' : 'GOOGLE_STANDARD_SQL');
  static const DatabaseDialect POSTGRESQL = DatabaseDialect._(2, _omitEnumNames ? '' : 'POSTGRESQL');
