...
import 'common.pb.dart' as $4884;
import 'common.pbenum.dart' as $4884;
...
class Backup extends $pb.GeneratedMessage {
  factory Backup({
    ...
    $4884.EncryptionInfo? encryptionInfo,
    $1775.Timestamp? versionTime,
    $4884.DatabaseDialect? databaseDialect,
    $core.Iterable<$core.String>? referencingBackups,
    $1775.Timestamp? maxExpireTime,
    $core.Iterable<$4884.EncryptionInfo>? encryptionInformation,
    ...
    $1775.Timestamp? oldestVersionTime,
  }) {
    final $result = create();
    if (name != null) {
      $result.name = name;
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(_omitMessageNames ? '' : 'Backup', package: const $pb.PackageName(_omitMessageNames ? '' : 'google.spanner.admin.database.v1'), createEmptyInstance: create)
    ...
    ..aOM<$4884.EncryptionInfo>(8, _omitFieldNames ? '' : 'encryptionInfo', subBuilder: $4884.EncryptionInfo.create)
    ..aOM<$1775.Timestamp>(9, _omitFieldNames ? '' : 'versionTime', subBuilder: $1775.Timestamp.create)
    ..e<$4884.DatabaseDialect>(10, _omitFieldNames ? '' : 'databaseDialect', $pb.PbFieldType.OE, defaultOrMaker: $4884.DatabaseDialect.DATABASE_DIALECT_UNSPECIFIED, valueOf: $4884.DatabaseDialect.valueOf, enumValues: $4884.DatabaseDialect.values)
    ..pPS(11, _omitFieldNames ? '' : 'referencingBackups')
    ..aOM<$1775.Timestamp>(12, _omitFieldNames ? '' : 'maxExpireTime', subBuilder: $1775.Timestamp.create)
    ..pc<$4884.EncryptionInfo>(13, _omitFieldNames ? '' : 'encryptionInformation', $pb.PbFieldType.PM, subBuilder: $4884.EncryptionInfo.create)
    ...
    ..aOM<$1775.Timestamp>(18, _omitFieldNames ? '' : 'oldestVersionTime', subBuilder: $1775.Timestamp.create)
  ...
  @$pb.TagNumber(8)
  $4884.EncryptionInfo get encryptionInfo => $_getN(7);
  @$pb.TagNumber(8)
  set encryptionInfo($4884.EncryptionInfo v) { setField(8, v); }
  @$pb.TagNumber(8)
  $core.bool hasEncryptionInfo() => $_has(7);
  @$pb.TagNumber(8)
  void clearEncryptionInfo() => clearField(8);
  @$pb.TagNumber(8)
  $4884.EncryptionInfo ensureEncryptionInfo() => $_ensure(7);
  ...
  /// backup.
  @$pb.TagNumber(9)
  $1775.Timestamp get versionTime => $_getN(8);
  @$pb.TagNumber(9)
  set versionTime($1775.Timestamp v) { setField(9, v); }
  @$pb.TagNumber(9)
  $core.bool hasVersionTime() => $_has(8);
  @$pb.TagNumber(9)
  void clearVersionTime() => clearField(9);
  @$pb.TagNumber(9)
  $1775.Timestamp ensureVersionTime() => $_ensure(8);

  /// Output only. The database dialect information for the backup.
  @$pb.TagNumber(10)
  $4884.DatabaseDialect get databaseDialect => $_getN(9);
  @$pb.TagNumber(10)
  set databaseDialect($4884.DatabaseDialect v) { setField(10, v); }
  @$pb.TagNumber(10)
  ...
  @$pb.TagNumber(12)
  $1775.Timestamp get maxExpireTime => $_getN(11);
  @$pb.TagNumber(12)
  set maxExpireTime($1775.Timestamp v) { setField(12, v); }
  @$pb.TagNumber(12)
  $core.bool hasMaxExpireTime() => $_has(11);
  @$pb.TagNumber(12)
  void clearMaxExpireTime() => clearField(12);
  @$pb.TagNumber(12)
  $1775.Timestamp ensureMaxExpireTime() => $_ensure(11);
  ...
  @$pb.TagNumber(13)
  $core.List<$4884.EncryptionInfo> get encryptionInformation => $_getList(12);
  ...
  @$pb.TagNumber(18)
  $1775.Timestamp get oldestVersionTime => $_getN(17);
  @$pb.TagNumber(18)
  set oldestVersionTime($1775.Timestamp v) { setField(18, v); }
  @$pb.TagNumber(18)
  $core.bool hasOldestVersionTime() => $_has(17);
  @$pb.TagNumber(18)
  void clearOldestVersionTime() => clearField(18);
  @$pb.TagNumber(18)
  $1775.Timestamp ensureOldestVersionTime() => $_ensure(17);
}
...
class CreateBackupMetadata extends $pb.GeneratedMessage {
  factory CreateBackupMetadata({
    $core.String? name,
    $core.String? database,
    $4884.OperationProgress? progress,
    $1775.Timestamp? cancelTime,
  }) {
    final $result = create();
    if (name != null) {
      $result.name = name;
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(_omitMessageNames ? '' : 'CreateBackupMetadata', package: const $pb.PackageName(_omitMessageNames ? '' : 'google.spanner.admin.database.v1'), createEmptyInstance: create)
    ..aOS(1, _omitFieldNames ? '' : 'name')
    ..aOS(2, _omitFieldNames ? '' : 'database')
    ..aOM<$4884.OperationProgress>(3, _omitFieldNames ? '' : 'progress', subBuilder: $4884.OperationProgress.create)
    ..aOM<$1775.Timestamp>(4, _omitFieldNames ? '' : 'cancelTime', subBuilder: $1775.Timestamp.create)
    ..hasRequiredFields = false
  ;
  ...
  /// operation.
  @$pb.TagNumber(3)
  $4884.OperationProgress get progress => $_getN(2);
  @$pb.TagNumber(3)
  set progress($4884.OperationProgress v) { setField(3, v); }
  @$pb.TagNumber(3)
  $core.bool hasProgress() => $_has(2);
  @$pb.TagNumber(3)
  void clearProgress() => clearField(3);
  @$pb.TagNumber(3)
  $4884.OperationProgress ensureProgress() => $_ensure(2);
  ...
  @$pb.TagNumber(4)
  $1775.Timestamp get cancelTime => $_getN(3);
  @$pb.TagNumber(4)
  set cancelTime($1775.Timestamp v) { setField(4, v); }
  @$pb.TagNumber(4)
  $core.bool hasCancelTime() => $_has(3);
  @$pb.TagNumber(4)
  void clearCancelTime() => clearField(4);
  @$pb.TagNumber(4)
  $1775.Timestamp ensureCancelTime() => $_ensure(3);
}
...
class BackupInfo extends $pb.GeneratedMessage {
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(_omitMessageNames ? '' : 'BackupInfo', package: const $pb.PackageName(_omitMessageNames ? '' : 'google.spanner.admin.database.v1'), createEmptyInstance: create)
    ...
    ..aOM<$1775.Timestamp>(4, _omitFieldNames ? '' : 'versionTime', subBuilder: $1775.Timestamp.create)
    ..hasRequiredFields = false
  ;
  ...
  @$pb.TagNumber(4)
  $1775.Timestamp get versionTime => $_getN(3);
  @$pb.TagNumber(4)
  set versionTime($1775.Timestamp v) { setField(4, v); }
  @$pb.TagNumber(4)
  $core.bool hasVersionTime() => $_has(3);
  @$pb.TagNumber(4)
  void clearVersionTime() => clearField(4);
  @$pb.TagNumber(4)
  $1775.Timestamp ensureVersionTime() => $_ensure(3);
}
