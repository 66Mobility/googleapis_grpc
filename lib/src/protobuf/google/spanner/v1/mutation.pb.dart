...
class Mutation_Write extends $pb.GeneratedMessage {
  factory Mutation_Write({
    ...
    $core.Iterable<$258.ListValue>? values,
  }) {
    final $result = create();
    if (table != null) {
      $result.table = table;
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(_omitMessageNames ? '' : 'Mutation.Write', package: const $pb.PackageName(_omitMessageNames ? '' : 'google.spanner.v1'), createEmptyInstance: create)
    ...
    ..pc<$258.ListValue>(3, _omitFieldNames ? '' : 'values', $pb.PbFieldType.PM, subBuilder: $258.ListValue.create)
  ...
  @$pb.TagNumber(3)
  $core.List<$258.ListValue> get values => $_getList(2);
}
...
class Mutation_Delete extends $pb.GeneratedMessage {
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(_omitMessageNames ? '' : 'Mutation.Delete', package: const $pb.PackageName(_omitMessageNames ? '' : 'google.spanner.v1'), createEmptyInstance: create)
    ..aOS(1, _omitFieldNames ? '' : 'table')
    ..aOM<$542.KeySet>(2, _omitFieldNames ? '' : 'keySet', subBuilder: $542.KeySet.create)
    ..hasRequiredFields = false
  ;
  ...
  /// rows do not exist.
  @$pb.TagNumber(2)
  $542.KeySet get keySet => $_getN(1);
  @$pb.TagNumber(2)
  set keySet($542.KeySet v) { setField(2, v); }
  @$pb.TagNumber(2)
  $core.bool hasKeySet() => $_has(1);
  @$pb.TagNumber(2)
  void clearKeySet() => clearField(2);
  @$pb.TagNumber(2)
  $542.KeySet ensureKeySet() => $_ensure(1);
}
