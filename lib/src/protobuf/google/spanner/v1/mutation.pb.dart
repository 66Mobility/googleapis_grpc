...
class Mutation_Write extends $pb.GeneratedMessage {
  factory Mutation_Write({
    ...
    $core.Iterable<$289.ListValue>? values,
  }) {
    final $result = create();
    if (table != null) {
      $result.table = table;
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(
    ...
    ..pc<$289.ListValue>(3, _omitFieldNames ? '' : 'values', $pb.PbFieldType.PM,
  ...
  @$pb.TagNumber(3)
  $core.List<$289.ListValue> get values => $_getList(2);
}
...
class Mutation_Delete extends $pb.GeneratedMessage {
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(
      ...
      createEmptyInstance: create)
    ..aOS(1, _omitFieldNames ? '' : 'table')
    ..aOM<$586.KeySet>(2, _omitFieldNames ? '' : 'keySet',
  ...
  @$pb.TagNumber(2)
  $586.KeySet ensureKeySet() => $_ensure(1);
}
