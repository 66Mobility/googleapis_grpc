...
class TransactionOptions_ReadOnly extends $pb.GeneratedMessage {
  factory TransactionOptions_ReadOnly({
    $core.bool? strong,
    $1775.Timestamp? minReadTimestamp,
    $1737.Duration? maxStaleness,
    $1775.Timestamp? readTimestamp,
    $1737.Duration? exactStaleness,
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(_omitMessageNames ? '' : 'TransactionOptions.ReadOnly', package: const $pb.PackageName(_omitMessageNames ? '' : 'google.spanner.v1'), createEmptyInstance: create)
    ...
    ..aOM<$1775.Timestamp>(2, _omitFieldNames ? '' : 'minReadTimestamp', subBuilder: $1775.Timestamp.create)
    ..aOM<$1737.Duration>(3, _omitFieldNames ? '' : 'maxStaleness', subBuilder: $1737.Duration.create)
    ..aOM<$1775.Timestamp>(4, _omitFieldNames ? '' : 'readTimestamp', subBuilder: $1775.Timestamp.create)
    ..aOM<$1737.Duration>(5, _omitFieldNames ? '' : 'exactStaleness', subBuilder: $1737.Duration.create)
  ...
  @$pb.TagNumber(2)
  $1775.Timestamp get minReadTimestamp => $_getN(1);
  @$pb.TagNumber(2)
  set minReadTimestamp($1775.Timestamp v) { setField(2, v); }
  @$pb.TagNumber(2)
  $core.bool hasMinReadTimestamp() => $_has(1);
  @$pb.TagNumber(2)
  void clearMinReadTimestamp() => clearField(2);
  @$pb.TagNumber(2)
  $1775.Timestamp ensureMinReadTimestamp() => $_ensure(1);
  ...
  ///  transactions.
  @$pb.TagNumber(3)
  $1737.Duration get maxStaleness => $_getN(2);
  @$pb.TagNumber(3)
  set maxStaleness($1737.Duration v) { setField(3, v); }
  @$pb.TagNumber(3)
  $core.bool hasMaxStaleness() => $_has(2);
  @$pb.TagNumber(3)
  void clearMaxStaleness() => clearField(3);
  @$pb.TagNumber(3)
  $1737.Duration ensureMaxStaleness() => $_ensure(2);
  ...
  ///  Example: `"2014-10-02T15:01:23.045123456Z"`.
  @$pb.TagNumber(4)
  $1775.Timestamp get readTimestamp => $_getN(3);
  @$pb.TagNumber(4)
  set readTimestamp($1775.Timestamp v) { setField(4, v); }
  @$pb.TagNumber(4)
  $core.bool hasReadTimestamp() => $_has(3);
  @$pb.TagNumber(4)
  void clearReadTimestamp() => clearField(4);
  @$pb.TagNumber(4)
  $1775.Timestamp ensureReadTimestamp() => $_ensure(3);
  ...
  @$pb.TagNumber(5)
  $1737.Duration get exactStaleness => $_getN(4);
  @$pb.TagNumber(5)
  set exactStaleness($1737.Duration v) { setField(5, v); }
  @$pb.TagNumber(5)
  $core.bool hasExactStaleness() => $_has(4);
  @$pb.TagNumber(5)
  void clearExactStaleness() => clearField(5);
  @$pb.TagNumber(5)
  $1737.Duration ensureExactStaleness() => $_ensure(4);
...
class Transaction extends $pb.GeneratedMessage {
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(_omitMessageNames ? '' : 'Transaction', package: const $pb.PackageName(_omitMessageNames ? '' : 'google.spanner.v1'), createEmptyInstance: create)
    ...
    ..aOM<$1775.Timestamp>(2, _omitFieldNames ? '' : 'readTimestamp', subBuilder: $1775.Timestamp.create)
    ..hasRequiredFields = false
  ;
  ...
  ///  Example: `"2014-10-02T15:01:23.045123456Z"`.
  @$pb.TagNumber(2)
  $1775.Timestamp get readTimestamp => $_getN(1);
  @$pb.TagNumber(2)
  set readTimestamp($1775.Timestamp v) { setField(2, v); }
  @$pb.TagNumber(2)
  $core.bool hasReadTimestamp() => $_has(1);
  @$pb.TagNumber(2)
  void clearReadTimestamp() => clearField(2);
  @$pb.TagNumber(2)
  $1775.Timestamp ensureReadTimestamp() => $_ensure(1);
}
