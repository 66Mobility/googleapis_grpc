...
import 'query_plan.pb.dart' as $4888;
...
class ResultSet extends $pb.GeneratedMessage {
  factory ResultSet({
    ...
    $core.Iterable<$1734.ListValue>? rows,
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(_omitMessageNames ? '' : 'ResultSet', package: const $pb.PackageName(_omitMessageNames ? '' : 'google.spanner.v1'), createEmptyInstance: create)
    ...
    ..pc<$1734.ListValue>(2, _omitFieldNames ? '' : 'rows', $pb.PbFieldType.PM, subBuilder: $1734.ListValue.create)
  ...
  @$pb.TagNumber(2)
  $core.List<$1734.ListValue> get rows => $_getList(1);
...
class PartialResultSet extends $pb.GeneratedMessage {
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(_omitMessageNames ? '' : 'PartialResultSet', package: const $pb.PackageName(_omitMessageNames ? '' : 'google.spanner.v1'), createEmptyInstance: create)
    ..aOM<ResultSetMetadata>(1, _omitFieldNames ? '' : 'metadata', subBuilder: ResultSetMetadata.create)
    ..pc<$1734.Value>(2, _omitFieldNames ? '' : 'values', $pb.PbFieldType.PM, subBuilder: $1734.Value.create)
...
class ResultSetMetadata extends $pb.GeneratedMessage {
  factory ResultSetMetadata({
    ...
    $4887.StructType? undeclaredParameters,
  }) {
    final $result = create();
    if (rowType != null) {
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(_omitMessageNames ? '' : 'ResultSetMetadata', package: const $pb.PackageName(_omitMessageNames ? '' : 'google.spanner.v1'), createEmptyInstance: create)
    ..aOM<$4887.StructType>(1, _omitFieldNames ? '' : 'rowType', subBuilder: $4887.StructType.create)
    ..aOM<$1724.Transaction>(2, _omitFieldNames ? '' : 'transaction', subBuilder: $1724.Transaction.create)
    ..aOM<$4887.StructType>(3, _omitFieldNames ? '' : 'undeclaredParameters', subBuilder: $4887.StructType.create)
    ..hasRequiredFields = false
  ;
  ...
  ///      ]
  @$pb.TagNumber(1)
  $4887.StructType get rowType => $_getN(0);
  @$pb.TagNumber(1)
  set rowType($4887.StructType v) { setField(1, v); }
  @$pb.TagNumber(1)
  $core.bool hasRowType() => $_has(0);
  @$pb.TagNumber(1)
  void clearRowType() => clearField(1);
  @$pb.TagNumber(1)
  $4887.StructType ensureRowType() => $_ensure(0);
  ...
  ///      ]
  @$pb.TagNumber(3)
  $4887.StructType get undeclaredParameters => $_getN(2);
  @$pb.TagNumber(3)
  set undeclaredParameters($4887.StructType v) { setField(3, v); }
  @$pb.TagNumber(3)
  $core.bool hasUndeclaredParameters() => $_has(2);
  @$pb.TagNumber(3)
  void clearUndeclaredParameters() => clearField(3);
  @$pb.TagNumber(3)
  $4887.StructType ensureUndeclaredParameters() => $_ensure(2);
}
...
class ResultSetStats extends $pb.GeneratedMessage {
  factory ResultSetStats({
    $4888.QueryPlan? queryPlan,
    $1734.Struct? queryStats,
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(_omitMessageNames ? '' : 'ResultSetStats', package: const $pb.PackageName(_omitMessageNames ? '' : 'google.spanner.v1'), createEmptyInstance: create)
    ..oo(0, [3, 4])
    ..aOM<$4888.QueryPlan>(1, _omitFieldNames ? '' : 'queryPlan', subBuilder: $4888.QueryPlan.create)
    ..aOM<$1734.Struct>(2, _omitFieldNames ? '' : 'queryStats', subBuilder: $1734.Struct.create)
  ...
  @$pb.TagNumber(1)
  $4888.QueryPlan get queryPlan => $_getN(0);
  @$pb.TagNumber(1)
  set queryPlan($4888.QueryPlan v) { setField(1, v); }
  @$pb.TagNumber(1)
  $core.bool hasQueryPlan() => $_has(0);
  @$pb.TagNumber(1)
  void clearQueryPlan() => clearField(1);
  @$pb.TagNumber(1)
  $4888.QueryPlan ensureQueryPlan() => $_ensure(0);
  ...
  ///      }
  @$pb.TagNumber(2)
  $1734.Struct get queryStats => $_getN(1);
  @$pb.TagNumber(2)
  set queryStats($1734.Struct v) { setField(2, v); }
  @$pb.TagNumber(2)
  $core.bool hasQueryStats() => $_has(1);
  @$pb.TagNumber(2)
  void clearQueryStats() => clearField(2);
  @$pb.TagNumber(2)
  $1734.Struct ensureQueryStats() => $_ensure(1);
