...
class KeyRange extends $pb.GeneratedMessage {
  factory KeyRange({
    $289.ListValue? startClosed,
    $289.ListValue? startOpen,
    $289.ListValue? endClosed,
    $289.ListValue? endOpen,
  }) {
    final $result = create();
    if (startClosed != null) {
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(
    ...
    ..oo(0, [1, 2])
    ..oo(1, [3, 4])
    ..aOM<$289.ListValue>(1, _omitFieldNames ? '' : 'startClosed',
        subBuilder: $289.ListValue.create)
    ..aOM<$289.ListValue>(2, _omitFieldNames ? '' : 'startOpen',
        subBuilder: $289.ListValue.create)
    ..aOM<$289.ListValue>(3, _omitFieldNames ? '' : 'endClosed',
        subBuilder: $289.ListValue.create)
    ..aOM<$289.ListValue>(4, _omitFieldNames ? '' : 'endOpen',
        subBuilder: $289.ListValue.create)
  ...
  @$pb.TagNumber(1)
  $289.ListValue get startClosed => $_getN(0);
  @$pb.TagNumber(1)
  set startClosed($289.ListValue v) {
    setField(1, v);
  }
  ...
  @$pb.TagNumber(1)
  $289.ListValue ensureStartClosed() => $_ensure(0);

  /// If the start is open, then the range excludes rows whose first
  /// `len(start_open)` key columns exactly match `start_open`.
  @$pb.TagNumber(2)
  $289.ListValue get startOpen => $_getN(1);
  @$pb.TagNumber(2)
  set startOpen($289.ListValue v) {
    setField(2, v);
  }
  ...
  @$pb.TagNumber(2)
  $289.ListValue ensureStartOpen() => $_ensure(1);

  /// If the end is closed, then the range includes all rows whose
  /// first `len(end_closed)` key columns exactly match `end_closed`.
  @$pb.TagNumber(3)
  $289.ListValue get endClosed => $_getN(2);
  @$pb.TagNumber(3)
  set endClosed($289.ListValue v) {
    setField(3, v);
  }
  ...
  @$pb.TagNumber(3)
  $289.ListValue ensureEndClosed() => $_ensure(2);

  /// If the end is open, then the range excludes rows whose first
  /// `len(end_open)` key columns exactly match `end_open`.
  @$pb.TagNumber(4)
  $289.ListValue get endOpen => $_getN(3);
  @$pb.TagNumber(4)
  set endOpen($289.ListValue v) {
    setField(4, v);
  }
  ...
  @$pb.TagNumber(4)
  $289.ListValue ensureEndOpen() => $_ensure(3);
}
...
class KeySet extends $pb.GeneratedMessage {
  factory KeySet({
    $core.Iterable<$289.ListValue>? keys,
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(
      ...
      package:
          const $pb.PackageName(_omitMessageNames ? '' : 'google.spanner.v1'),
      createEmptyInstance: create)
    ..pc<$289.ListValue>(1, _omitFieldNames ? '' : 'keys', $pb.PbFieldType.PM,
        subBuilder: $289.ListValue.create)
  ...
  @$pb.TagNumber(1)
  $core.List<$289.ListValue> get keys => $_getList(0);
