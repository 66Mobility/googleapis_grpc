...
class KeyRange extends $pb.GeneratedMessage {
  factory KeyRange({
    $1735.ListValue? startClosed,
    $1735.ListValue? startOpen,
    $1735.ListValue? endClosed,
    $1735.ListValue? endOpen,
  }) {
    final $result = create();
    if (startClosed != null) {
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(_omitMessageNames ? '' : 'KeyRange', package: const $pb.PackageName(_omitMessageNames ? '' : 'google.spanner.v1'), createEmptyInstance: create)
    ..oo(0, [1, 2])
    ..oo(1, [3, 4])
    ..aOM<$1735.ListValue>(1, _omitFieldNames ? '' : 'startClosed', subBuilder: $1735.ListValue.create)
    ..aOM<$1735.ListValue>(2, _omitFieldNames ? '' : 'startOpen', subBuilder: $1735.ListValue.create)
    ..aOM<$1735.ListValue>(3, _omitFieldNames ? '' : 'endClosed', subBuilder: $1735.ListValue.create)
    ..aOM<$1735.ListValue>(4, _omitFieldNames ? '' : 'endOpen', subBuilder: $1735.ListValue.create)
  ...
  @$pb.TagNumber(1)
  $1735.ListValue get startClosed => $_getN(0);
  @$pb.TagNumber(1)
  set startClosed($1735.ListValue v) { setField(1, v); }
  @$pb.TagNumber(1)
  $core.bool hasStartClosed() => $_has(0);
  @$pb.TagNumber(1)
  void clearStartClosed() => clearField(1);
  @$pb.TagNumber(1)
  $1735.ListValue ensureStartClosed() => $_ensure(0);

  /// If the start is open, then the range excludes rows whose first
  /// `len(start_open)` key columns exactly match `start_open`.
  @$pb.TagNumber(2)
  $1735.ListValue get startOpen => $_getN(1);
  @$pb.TagNumber(2)
  set startOpen($1735.ListValue v) { setField(2, v); }
  @$pb.TagNumber(2)
  $core.bool hasStartOpen() => $_has(1);
  @$pb.TagNumber(2)
  void clearStartOpen() => clearField(2);
  @$pb.TagNumber(2)
  $1735.ListValue ensureStartOpen() => $_ensure(1);

  /// If the end is closed, then the range includes all rows whose
  /// first `len(end_closed)` key columns exactly match `end_closed`.
  @$pb.TagNumber(3)
  $1735.ListValue get endClosed => $_getN(2);
  @$pb.TagNumber(3)
  set endClosed($1735.ListValue v) { setField(3, v); }
  @$pb.TagNumber(3)
  $core.bool hasEndClosed() => $_has(2);
  @$pb.TagNumber(3)
  void clearEndClosed() => clearField(3);
  @$pb.TagNumber(3)
  $1735.ListValue ensureEndClosed() => $_ensure(2);

  /// If the end is open, then the range excludes rows whose first
  /// `len(end_open)` key columns exactly match `end_open`.
  @$pb.TagNumber(4)
  $1735.ListValue get endOpen => $_getN(3);
  @$pb.TagNumber(4)
  set endOpen($1735.ListValue v) { setField(4, v); }
  @$pb.TagNumber(4)
  $core.bool hasEndOpen() => $_has(3);
  @$pb.TagNumber(4)
  void clearEndOpen() => clearField(4);
  @$pb.TagNumber(4)
  $1735.ListValue ensureEndOpen() => $_ensure(3);
}
...
class KeySet extends $pb.GeneratedMessage {
  factory KeySet({
    $core.Iterable<$1735.ListValue>? keys,
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(_omitMessageNames ? '' : 'KeySet', package: const $pb.PackageName(_omitMessageNames ? '' : 'google.spanner.v1'), createEmptyInstance: create)
    ..pc<$1735.ListValue>(1, _omitFieldNames ? '' : 'keys', $pb.PbFieldType.PM, subBuilder: $1735.ListValue.create)
  ...
  @$pb.TagNumber(1)
  $core.List<$1735.ListValue> get keys => $_getList(0);
