...
class PlanNode_Kind extends $pb.ProtobufEnum {
  static const PlanNode_Kind KIND_UNSPECIFIED = PlanNode_Kind._(0, _omitEnumNames ? '' : 'KIND_UNSPECIFIED');
  static const PlanNode_Kind RELATIONAL = PlanNode_Kind._(1, _omitEnumNames ? '' : 'RELATIONAL');
  static const PlanNode_Kind SCALAR = PlanNode_Kind._(2, _omitEnumNames ? '' : 'SCALAR');
