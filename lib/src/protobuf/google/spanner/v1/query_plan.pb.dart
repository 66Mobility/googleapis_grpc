...
class PlanNode extends $pb.GeneratedMessage {
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(_omitMessageNames ? '' : 'PlanNode', package: const $pb.PackageName(_omitMessageNames ? '' : 'google.spanner.v1'), createEmptyInstance: create)
    ...
    ..aOM<$1734.Struct>(6, _omitFieldNames ? '' : 'metadata', subBuilder: $1734.Struct.create)
    ..aOM<$1734.Struct>(7, _omitFieldNames ? '' : 'executionStats', subBuilder: $1734.Struct.create)
    ..hasRequiredFields = false
  ;
  ...
  @$pb.TagNumber(6)
  set metadata($1734.Struct v) { setField(6, v); }
  @$pb.TagNumber(6)
  ...
  /// execution etc.
  @$pb.TagNumber(7)
  $1734.Struct get executionStats => $_getN(6);
  @$pb.TagNumber(7)
  set executionStats($1734.Struct v) { setField(7, v); }
  @$pb.TagNumber(7)
  $core.bool hasExecutionStats() => $_has(6);
  @$pb.TagNumber(7)
  void clearExecutionStats() => clearField(7);
  @$pb.TagNumber(7)
  $1734.Struct ensureExecutionStats() => $_ensure(6);
}
