...
class PlanNode extends $pb.GeneratedMessage {
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(
    ...
    ..aOM<$289.Struct>(6, _omitFieldNames ? '' : 'metadata',
        subBuilder: $289.Struct.create)
    ..aOM<$289.Struct>(7, _omitFieldNames ? '' : 'executionStats',
        subBuilder: $289.Struct.create)
    ..hasRequiredFields = false;
  ...
  ///      }
  @$pb.TagNumber(6)
  $289.Struct get metadata => $_getN(5);
  @$pb.TagNumber(6)
  set metadata($289.Struct v) {
    setField(6, v);
  }
  ...
  @$pb.TagNumber(6)
  $289.Struct ensureMetadata() => $_ensure(5);
  ...
  /// execution etc.
  @$pb.TagNumber(7)
  $289.Struct get executionStats => $_getN(6);
  @$pb.TagNumber(7)
  set executionStats($289.Struct v) {
    setField(7, v);
  }
  ...
  @$pb.TagNumber(7)
  $289.Struct ensureExecutionStats() => $_ensure(6);
}
