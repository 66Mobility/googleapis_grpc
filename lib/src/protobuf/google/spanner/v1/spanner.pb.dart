...
import 'keys.pb.dart' as $586;
import 'mutation.pb.dart' as $589;
...
class Session extends $pb.GeneratedMessage {
  factory Session({
    ...
    $330.Timestamp? approximateLastUseTime,
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(
    ...
    ..aOM<$330.Timestamp>(4, _omitFieldNames ? '' : 'approximateLastUseTime',
        subBuilder: $330.Timestamp.create)
  ...
  @$pb.TagNumber(4)
  $330.Timestamp get approximateLastUseTime => $_getN(3);
  @$pb.TagNumber(4)
  set approximateLastUseTime($330.Timestamp v) {
    setField(4, v);
  }
  ...
  @$pb.TagNumber(4)
  $330.Timestamp ensureApproximateLastUseTime() => $_ensure(3);
...
class ExecuteSqlRequest extends $pb.GeneratedMessage {
  factory ExecuteSqlRequest({
    $core.String? session,
    $278.TransactionSelector? transaction,
    $core.String? sql,
    $289.Struct? params,
    $core.Map<$core.String, $587.Type>? paramTypes,
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(
    ...
    ..aOM<$278.TransactionSelector>(2, _omitFieldNames ? '' : 'transaction',
        subBuilder: $278.TransactionSelector.create)
    ..aOS(3, _omitFieldNames ? '' : 'sql')
    ..aOM<$289.Struct>(4, _omitFieldNames ? '' : 'params',
        subBuilder: $289.Struct.create)
    ..m<$core.String, $587.Type>(5, _omitFieldNames ? '' : 'paramTypes',
        entryClassName: 'ExecuteSqlRequest.ParamTypesEntry',
        keyFieldType: $pb.PbFieldType.OS,
        valueFieldType: $pb.PbFieldType.OM,
        valueCreator: $587.Type.create,
        valueDefaultOrMaker: $587.Type.getDefault,
        packageName: const $pb.PackageName('google.spanner.v1'))
  ...
  @$pb.TagNumber(2)
  $278.TransactionSelector get transaction => $_getN(1);
  @$pb.TagNumber(2)
  set transaction($278.TransactionSelector v) {
    setField(2, v);
  }
  ...
  @$pb.TagNumber(2)
  $278.TransactionSelector ensureTransaction() => $_ensure(1);
  ...
  @$pb.TagNumber(4)
  $289.Struct ensureParams() => $_ensure(3);
  ...
  ///  about SQL types.
  @$pb.TagNumber(5)
  $core.Map<$core.String, $587.Type> get paramTypes => $_getMap(4);
...
class ExecuteBatchDmlRequest_Statement extends $pb.GeneratedMessage {
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(
    ...
    ..aOM<$289.Struct>(2, _omitFieldNames ? '' : 'params',
        subBuilder: $289.Struct.create)
    ..m<$core.String, $587.Type>(3, _omitFieldNames ? '' : 'paramTypes',
  ...
  @$pb.TagNumber(2)
  $289.Struct ensureParams() => $_ensure(1);
  ...
  ///  about SQL types.
  @$pb.TagNumber(3)
  $core.Map<$core.String, $587.Type> get paramTypes => $_getMap(2);
}
...
class ExecuteBatchDmlResponse extends $pb.GeneratedMessage {
  factory ExecuteBatchDmlResponse({
    $core.Iterable<$277.ResultSet>? resultSets,
    $350.Status? status,
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(
    ...
    ..pc<$277.ResultSet>(
        ...
        subBuilder: $277.ResultSet.create)
  ...
  @$pb.TagNumber(1)
  $core.List<$277.ResultSet> get resultSets => $_getList(0);
  ...
  /// error.
  @$pb.TagNumber(3)
  $278.MultiplexedSessionPrecommitToken get precommitToken => $_getN(2);
  @$pb.TagNumber(3)
  ...
  @$pb.TagNumber(3)
  $278.MultiplexedSessionPrecommitToken ensurePrecommitToken() => $_ensure(2);
}
...
class PartitionReadRequest extends $pb.GeneratedMessage {
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(
    ...
    ..aOM<$586.KeySet>(6, _omitFieldNames ? '' : 'keySet',
        subBuilder: $586.KeySet.create)
  ...
  @$pb.TagNumber(6)
  $586.KeySet get keySet => $_getN(5);
  @$pb.TagNumber(6)
  set keySet($586.KeySet v) {
    setField(6, v);
  }
  ...
  @$pb.TagNumber(6)
  $586.KeySet ensureKeySet() => $_ensure(5);
...
class BeginTransactionRequest extends $pb.GeneratedMessage {
  factory BeginTransactionRequest({
    $core.String? session,
    $278.TransactionOptions? options,
    RequestOptions? requestOptions,
    $589.Mutation? mutationKey,
  }) {
    final $result = create();
    if (session != null) {
      $result.session = session;
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(
      ...
      createEmptyInstance: create)
    ..aOS(1, _omitFieldNames ? '' : 'session')
    ..aOM<$278.TransactionOptions>(2, _omitFieldNames ? '' : 'options',
        subBuilder: $278.TransactionOptions.create)
    ..aOM<RequestOptions>(3, _omitFieldNames ? '' : 'requestOptions',
        subBuilder: RequestOptions.create)
    ..aOM<$589.Mutation>(4, _omitFieldNames ? '' : 'mutationKey',
        subBuilder: $589.Mutation.create)
    ..hasRequiredFields = false;
  ...
  @$pb.TagNumber(2)
  $278.TransactionOptions get options => $_getN(1);
  @$pb.TagNumber(2)
  set options($278.TransactionOptions v) {
    setField(2, v);
  }
  ...
  @$pb.TagNumber(2)
  $278.TransactionOptions ensureOptions() => $_ensure(1);
  ...
  /// error.
  @$pb.TagNumber(4)
  $589.Mutation get mutationKey => $_getN(3);
  @$pb.TagNumber(4)
  set mutationKey($589.Mutation v) {
    setField(4, v);
  }
  ...
  @$pb.TagNumber(4)
  $589.Mutation ensureMutationKey() => $_ensure(3);
}
...
class CommitRequest extends $pb.GeneratedMessage {
  factory CommitRequest({
    ...
    $278.TransactionOptions? singleUseTransaction,
    $core.Iterable<$589.Mutation>? mutations,
    $core.bool? returnCommitStats,
    RequestOptions? requestOptions,
    $292.Duration? maxCommitDelay,
    $278.MultiplexedSessionPrecommitToken? precommitToken,
  }) {
    final $result = create();
    if (session != null) {
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(
    ...
    ..aOM<RequestOptions>(6, _omitFieldNames ? '' : 'requestOptions',
        subBuilder: RequestOptions.create)
    ..aOM<$292.Duration>(8, _omitFieldNames ? '' : 'maxCommitDelay',
  ...
  @$pb.TagNumber(3)
  $278.TransactionOptions get singleUseTransaction => $_getN(2);
  @$pb.TagNumber(3)
  set singleUseTransaction($278.TransactionOptions v) {
    setField(3, v);
  }
  ...
  @$pb.TagNumber(3)
  $278.TransactionOptions ensureSingleUseTransaction() => $_ensure(2);

  /// The mutations to be executed when this transaction commits. All
  /// mutations are applied atomically, in the order they appear in
  /// this list.
  @$pb.TagNumber(4)
  $core.List<$589.Mutation> get mutations => $_getList(3);
  ...
  /// and 500 ms.
  @$pb.TagNumber(8)
  $292.Duration get maxCommitDelay => $_getN(6);
  @$pb.TagNumber(8)
  set maxCommitDelay($292.Duration v) {
    setField(8, v);
  }
  ...
  @$pb.TagNumber(8)
  $292.Duration ensureMaxCommitDelay() => $_ensure(6);
  ...
  /// error.
  @$pb.TagNumber(9)
  $278.MultiplexedSessionPrecommitToken get precommitToken => $_getN(7);
  @$pb.TagNumber(9)
  set precommitToken($278.MultiplexedSessionPrecommitToken v) {
    setField(9, v);
  }
  ...
  @$pb.TagNumber(9)
  $278.MultiplexedSessionPrecommitToken ensurePrecommitToken() => $_ensure(7);
}
...
class BatchWriteRequest_MutationGroup extends $pb.GeneratedMessage {
  ...
  @$pb.TagNumber(1)
  $core.List<$589.Mutation> get mutations => $_getList(0);
}
...
class BatchWriteResponse extends $pb.GeneratedMessage {
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(
    ...
    ..aOM<$350.Status>(2, _omitFieldNames ? '' : 'status',
        subBuilder: $350.Status.create)
    ..aOM<$330.Timestamp>(3, _omitFieldNames ? '' : 'commitTimestamp',
        subBuilder: $330.Timestamp.create)
    ..hasRequiredFields = false;
  ...
  @$pb.TagNumber(3)
  $330.Timestamp get commitTimestamp => $_getN(2);
  @$pb.TagNumber(3)
  ...
  @$pb.TagNumber(3)
  $330.Timestamp ensureCommitTimestamp() => $_ensure(2);
}
