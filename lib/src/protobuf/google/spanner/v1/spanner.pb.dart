...
class ExecuteSqlRequest extends $pb.GeneratedMessage {
  ...
  @$pb.TagNumber(2)
  $1724.TransactionSelector get transaction => $_getN(1);
  @$pb.TagNumber(2)
  set transaction($1724.TransactionSelector v) { setField(2, v); }
  @$pb.TagNumber(2)
  $core.bool hasTransaction() => $_has(1);
  @$pb.TagNumber(2)
  void clearTransaction() => clearField(2);
  @$pb.TagNumber(2)
  $1724.TransactionSelector ensureTransaction() => $_ensure(1);
...
class ExecuteBatchDmlResponse extends $pb.GeneratedMessage {
  ...
  @$pb.TagNumber(1)
  $core.List<$1723.ResultSet> get resultSets => $_getList(0);
...
class BeginTransactionRequest extends $pb.GeneratedMessage {
  factory BeginTransactionRequest({
    $core.String? session,
    $1724.TransactionOptions? options,
    RequestOptions? requestOptions,
  }) {
    final $result = create();
    if (session != null) {
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(_omitMessageNames ? '' : 'BeginTransactionRequest', package: const $pb.PackageName(_omitMessageNames ? '' : 'google.spanner.v1'), createEmptyInstance: create)
    ..aOS(1, _omitFieldNames ? '' : 'session')
    ..aOM<$1724.TransactionOptions>(2, _omitFieldNames ? '' : 'options', subBuilder: $1724.TransactionOptions.create)
  ...
  @$pb.TagNumber(2)
  $1724.TransactionOptions get options => $_getN(1);
  @$pb.TagNumber(2)
  set options($1724.TransactionOptions v) { setField(2, v); }
  @$pb.TagNumber(2)
  $core.bool hasOptions() => $_has(1);
  @$pb.TagNumber(2)
  void clearOptions() => clearField(2);
  @$pb.TagNumber(2)
  $1724.TransactionOptions ensureOptions() => $_ensure(1);
...
class CommitRequest extends $pb.GeneratedMessage {
  ...
  @$pb.TagNumber(3)
  $1724.TransactionOptions get singleUseTransaction => $_getN(2);
  @$pb.TagNumber(3)
  set singleUseTransaction($1724.TransactionOptions v) { setField(3, v); }
  @$pb.TagNumber(3)
  $core.bool hasSingleUseTransaction() => $_has(2);
  @$pb.TagNumber(3)
  void clearSingleUseTransaction() => clearField(3);
  @$pb.TagNumber(3)
  $1724.TransactionOptions ensureSingleUseTransaction() => $_ensure(2);
