...
class EntityResult extends $pb.GeneratedMessage {
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(_omitMessageNames ? '' : 'EntityResult', package: const $pb.PackageName(_omitMessageNames ? '' : 'google.datastore.v1beta3'), createEmptyInstance: create)
    ..aOM<$4752.Entity>(1, _omitFieldNames ? '' : 'entity', subBuilder: $4752.Entity.create)
  ...
  @$pb.TagNumber(1)
  $4752.Entity get entity => $_getN(0);
  @$pb.TagNumber(1)
  set entity($4752.Entity v) { setField(1, v); }
  @$pb.TagNumber(1)
  $core.bool hasEntity() => $_has(0);
  @$pb.TagNumber(1)
  void clearEntity() => clearField(1);
  @$pb.TagNumber(1)
  $4752.Entity ensureEntity() => $_ensure(0);
...
class PropertyFilter extends $pb.GeneratedMessage {
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(_omitMessageNames ? '' : 'PropertyFilter', package: const $pb.PackageName(_omitMessageNames ? '' : 'google.datastore.v1beta3'), createEmptyInstance: create)
    ...
    ..aOM<$4752.Value>(3, _omitFieldNames ? '' : 'value', subBuilder: $4752.Value.create)
    ..hasRequiredFields = false
  ;
  ...
  @$pb.TagNumber(3)
  $4752.Value get value => $_getN(2);
  @$pb.TagNumber(3)
  set value($4752.Value v) { setField(3, v); }
  @$pb.TagNumber(3)
  $core.bool hasValue() => $_has(2);
  @$pb.TagNumber(3)
  void clearValue() => clearField(3);
  @$pb.TagNumber(3)
  $4752.Value ensureValue() => $_ensure(2);
}
...
class GqlQueryParameter extends $pb.GeneratedMessage {
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(_omitMessageNames ? '' : 'GqlQueryParameter', package: const $pb.PackageName(_omitMessageNames ? '' : 'google.datastore.v1beta3'), createEmptyInstance: create)
    ..oo(0, [2, 3])
    ..aOM<$4752.Value>(2, _omitFieldNames ? '' : 'value', subBuilder: $4752.Value.create)
    ..a<$core.List<$core.int>>(3, _omitFieldNames ? '' : 'cursor', $pb.PbFieldType.OY)
    ..hasRequiredFields = false
  ;
  ...
  /// A value parameter.
  @$pb.TagNumber(2)
  $4752.Value get value => $_getN(0);
  @$pb.TagNumber(2)
  set value($4752.Value v) { setField(2, v); }
  @$pb.TagNumber(2)
  $core.bool hasValue() => $_has(0);
  @$pb.TagNumber(2)
  void clearValue() => clearField(2);
  @$pb.TagNumber(2)
  $4752.Value ensureValue() => $_ensure(0);
