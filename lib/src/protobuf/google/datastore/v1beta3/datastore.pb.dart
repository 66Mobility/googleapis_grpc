...
import 'entity.pb.dart' as $456;
import 'query.pb.dart' as $457;
...
class LookupRequest extends $pb.GeneratedMessage {
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(
    ...
    ..pc<$456.Key>(3, _omitFieldNames ? '' : 'keys', $pb.PbFieldType.PM,
        subBuilder: $456.Key.create)
  ...
  @$pb.TagNumber(3)
  $core.List<$456.Key> get keys => $_getList(1);
...
class LookupResponse extends $pb.GeneratedMessage {
  factory LookupResponse({
    $core.Iterable<$457.EntityResult>? found,
    $core.Iterable<$457.EntityResult>? missing,
    $core.Iterable<$456.Key>? deferred,
  }) {
    final $result = create();
    if (found != null) {
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(
    ...
    ..pc<$457.EntityResult>(
        ...
        subBuilder: $457.EntityResult.create)
    ..pc<$457.EntityResult>(
        2, _omitFieldNames ? '' : 'missing', $pb.PbFieldType.PM,
        subBuilder: $457.EntityResult.create)
    ..pc<$456.Key>(3, _omitFieldNames ? '' : 'deferred', $pb.PbFieldType.PM,
        subBuilder: $456.Key.create)
    ..hasRequiredFields = false;
  ...
  /// input.
  @$pb.TagNumber(1)
  $core.List<$457.EntityResult> get found => $_getList(0);

  /// Entities not found as `ResultType.KEY_ONLY` entities. The order of results
  /// in this field is undefined and has no relation to the order of the keys
  /// in the input.
  @$pb.TagNumber(2)
  $core.List<$457.EntityResult> get missing => $_getList(1);

  /// A list of keys that were not looked up due to resource constraints. The
  /// order of results in this field is undefined and has no relation to the
  /// order of the keys in the input.
  @$pb.TagNumber(3)
  $core.List<$456.Key> get deferred => $_getList(2);
}
...
class RunQueryRequest extends $pb.GeneratedMessage {
  factory RunQueryRequest({
    ReadOptions? readOptions,
    $456.PartitionId? partitionId,
    $457.Query? query,
    $457.GqlQuery? gqlQuery,
    $core.String? projectId,
  }) {
    final $result = create();
    if (readOptions != null) {
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(
    ...
    ..aOM<ReadOptions>(1, _omitFieldNames ? '' : 'readOptions',
        subBuilder: ReadOptions.create)
    ..aOM<$456.PartitionId>(2, _omitFieldNames ? '' : 'partitionId',
        subBuilder: $456.PartitionId.create)
    ..aOM<$457.Query>(3, _omitFieldNames ? '' : 'query',
        subBuilder: $457.Query.create)
    ..aOM<$457.GqlQuery>(7, _omitFieldNames ? '' : 'gqlQuery',
        subBuilder: $457.GqlQuery.create)
    ..aOS(8, _omitFieldNames ? '' : 'projectId')
    ..hasRequiredFields = false;
  ...
  /// partition ID.
  @$pb.TagNumber(2)
  $456.PartitionId get partitionId => $_getN(1);
  @$pb.TagNumber(2)
  set partitionId($456.PartitionId v) {
    setField(2, v);
  }
  ...
  @$pb.TagNumber(2)
  $456.PartitionId ensurePartitionId() => $_ensure(1);

  /// The query to run.
  @$pb.TagNumber(3)
  $457.Query get query => $_getN(2);
  @$pb.TagNumber(3)
  set query($457.Query v) {
    setField(3, v);
  }
  ...
  @$pb.TagNumber(3)
  $457.Query ensureQuery() => $_ensure(2);

  /// The GQL query to run.
  @$pb.TagNumber(7)
  $457.GqlQuery get gqlQuery => $_getN(3);
  @$pb.TagNumber(7)
  set gqlQuery($457.GqlQuery v) {
    setField(7, v);
  }
  ...
  @$pb.TagNumber(7)
  $457.GqlQuery ensureGqlQuery() => $_ensure(3);
...
class RunQueryResponse extends $pb.GeneratedMessage {
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(
      ...
      package: const $pb.PackageName(
          _omitMessageNames ? '' : 'google.datastore.v1beta3'),
      createEmptyInstance: create)
    ..aOM<$457.QueryResultBatch>(1, _omitFieldNames ? '' : 'batch',
        subBuilder: $457.QueryResultBatch.create)
    ..aOM<$457.Query>(2, _omitFieldNames ? '' : 'query',
        subBuilder: $457.Query.create)
    ..hasRequiredFields = false;
  ...
  @$pb.TagNumber(1)
  $457.QueryResultBatch get batch => $_getN(0);
  @$pb.TagNumber(1)
  set batch($457.QueryResultBatch v) {
    setField(1, v);
  }
  ...
  @$pb.TagNumber(1)
  $457.QueryResultBatch ensureBatch() => $_ensure(0);

  /// The parsed form of the `GqlQuery` from the request, if it was set.
  @$pb.TagNumber(2)
  $457.Query get query => $_getN(1);
  @$pb.TagNumber(2)
  set query($457.Query v) {
    setField(2, v);
  }
  ...
  @$pb.TagNumber(2)
  $457.Query ensureQuery() => $_ensure(1);
}
...
class AllocateIdsRequest extends $pb.GeneratedMessage {
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(
      ...
      package: const $pb.PackageName(
          _omitMessageNames ? '' : 'google.datastore.v1beta3'),
      createEmptyInstance: create)
    ..pc<$456.Key>(1, _omitFieldNames ? '' : 'keys', $pb.PbFieldType.PM,
        subBuilder: $456.Key.create)
    ..aOS(8, _omitFieldNames ? '' : 'projectId')
    ..hasRequiredFields = false;
  ...
  @$pb.TagNumber(1)
  $core.List<$456.Key> get keys => $_getList(0);
...
class Mutation extends $pb.GeneratedMessage {
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(
    ...
    ..oo(0, [4, 5, 6, 7])
    ..oo(1, [8])
    ..aOM<$456.Entity>(4, _omitFieldNames ? '' : 'insert',
        subBuilder: $456.Entity.create)
    ..aOM<$456.Entity>(5, _omitFieldNames ? '' : 'update',
        subBuilder: $456.Entity.create)
    ..aOM<$456.Entity>(6, _omitFieldNames ? '' : 'upsert',
        subBuilder: $456.Entity.create)
    ..aOM<$456.Key>(7, _omitFieldNames ? '' : 'delete',
        subBuilder: $456.Key.create)
  ...
  @$pb.TagNumber(4)
  $456.Entity get insert => $_getN(0);
  @$pb.TagNumber(4)
  set insert($456.Entity v) {
    setField(4, v);
  }
  ...
  @$pb.TagNumber(4)
  $456.Entity ensureInsert() => $_ensure(0);

  /// The entity to update. The entity must already exist.
  /// Must have a complete key path.
  @$pb.TagNumber(5)
  $456.Entity get update => $_getN(1);
  @$pb.TagNumber(5)
  set update($456.Entity v) {
    setField(5, v);
  }
  ...
  @$pb.TagNumber(5)
  $456.Entity ensureUpdate() => $_ensure(1);

  /// The entity to upsert. The entity may or may not already exist.
  /// The entity key's final path element may be incomplete.
  @$pb.TagNumber(6)
  $456.Entity get upsert => $_getN(2);
  @$pb.TagNumber(6)
  set upsert($456.Entity v) {
    setField(6, v);
  }
  ...
  @$pb.TagNumber(6)
  $456.Entity ensureUpsert() => $_ensure(2);

  /// The key of the entity to delete. The entity may or may not already exist.
  /// Must have a complete key path and must not be reserved/read-only.
  @$pb.TagNumber(7)
  $456.Key get delete => $_getN(3);
  @$pb.TagNumber(7)
  set delete($456.Key v) {
    setField(7, v);
  }
  ...
  @$pb.TagNumber(7)
  $456.Key ensureDelete() => $_ensure(3);
...
class MutationResult extends $pb.GeneratedMessage {
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(
      ...
      package: const $pb.PackageName(
          _omitMessageNames ? '' : 'google.datastore.v1beta3'),
      createEmptyInstance: create)
    ..aOM<$456.Key>(3, _omitFieldNames ? '' : 'key',
        subBuilder: $456.Key.create)
