...
import 'entity.pb.dart' as $422;
import 'query.pb.dart' as $423;
...
class LookupRequest extends $pb.GeneratedMessage {
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(_omitMessageNames ? '' : 'LookupRequest', package: const $pb.PackageName(_omitMessageNames ? '' : 'google.datastore.v1beta3'), createEmptyInstance: create)
    ...
    ..pc<$422.Key>(3, _omitFieldNames ? '' : 'keys', $pb.PbFieldType.PM, subBuilder: $422.Key.create)
  ...
  @$pb.TagNumber(3)
  $core.List<$422.Key> get keys => $_getList(1);
...
class LookupResponse extends $pb.GeneratedMessage {
  factory LookupResponse({
    $core.Iterable<$423.EntityResult>? found,
    $core.Iterable<$423.EntityResult>? missing,
    $core.Iterable<$422.Key>? deferred,
  }) {
    final $result = create();
    if (found != null) {
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(_omitMessageNames ? '' : 'LookupResponse', package: const $pb.PackageName(_omitMessageNames ? '' : 'google.datastore.v1beta3'), createEmptyInstance: create)
    ..pc<$423.EntityResult>(1, _omitFieldNames ? '' : 'found', $pb.PbFieldType.PM, subBuilder: $423.EntityResult.create)
    ..pc<$423.EntityResult>(2, _omitFieldNames ? '' : 'missing', $pb.PbFieldType.PM, subBuilder: $423.EntityResult.create)
    ..pc<$422.Key>(3, _omitFieldNames ? '' : 'deferred', $pb.PbFieldType.PM, subBuilder: $422.Key.create)
    ..hasRequiredFields = false
  ;
  ...
  /// input.
  @$pb.TagNumber(1)
  $core.List<$423.EntityResult> get found => $_getList(0);

  /// Entities not found as `ResultType.KEY_ONLY` entities. The order of results
  /// in this field is undefined and has no relation to the order of the keys
  /// in the input.
  @$pb.TagNumber(2)
  $core.List<$423.EntityResult> get missing => $_getList(1);

  /// A list of keys that were not looked up due to resource constraints. The
  /// order of results in this field is undefined and has no relation to the
  /// order of the keys in the input.
  @$pb.TagNumber(3)
  $core.List<$422.Key> get deferred => $_getList(2);
}
...
class RunQueryRequest extends $pb.GeneratedMessage {
  factory RunQueryRequest({
    ReadOptions? readOptions,
    $422.PartitionId? partitionId,
    $423.Query? query,
    $423.GqlQuery? gqlQuery,
    $core.String? projectId,
  }) {
    final $result = create();
    if (readOptions != null) {
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(_omitMessageNames ? '' : 'RunQueryRequest', package: const $pb.PackageName(_omitMessageNames ? '' : 'google.datastore.v1beta3'), createEmptyInstance: create)
    ..oo(0, [3, 7])
    ..aOM<ReadOptions>(1, _omitFieldNames ? '' : 'readOptions', subBuilder: ReadOptions.create)
    ..aOM<$422.PartitionId>(2, _omitFieldNames ? '' : 'partitionId', subBuilder: $422.PartitionId.create)
    ..aOM<$423.Query>(3, _omitFieldNames ? '' : 'query', subBuilder: $423.Query.create)
    ..aOM<$423.GqlQuery>(7, _omitFieldNames ? '' : 'gqlQuery', subBuilder: $423.GqlQuery.create)
    ..aOS(8, _omitFieldNames ? '' : 'projectId')
    ..hasRequiredFields = false
  ;
  ...
  /// partition ID.
  @$pb.TagNumber(2)
  $422.PartitionId get partitionId => $_getN(1);
  @$pb.TagNumber(2)
  set partitionId($422.PartitionId v) { setField(2, v); }
  @$pb.TagNumber(2)
  $core.bool hasPartitionId() => $_has(1);
  @$pb.TagNumber(2)
  void clearPartitionId() => clearField(2);
  @$pb.TagNumber(2)
  $422.PartitionId ensurePartitionId() => $_ensure(1);

  /// The query to run.
  @$pb.TagNumber(3)
  $423.Query get query => $_getN(2);
  @$pb.TagNumber(3)
  set query($423.Query v) { setField(3, v); }
  @$pb.TagNumber(3)
  $core.bool hasQuery() => $_has(2);
  @$pb.TagNumber(3)
  void clearQuery() => clearField(3);
  @$pb.TagNumber(3)
  $423.Query ensureQuery() => $_ensure(2);

  /// The GQL query to run.
  @$pb.TagNumber(7)
  $423.GqlQuery get gqlQuery => $_getN(3);
  @$pb.TagNumber(7)
  set gqlQuery($423.GqlQuery v) { setField(7, v); }
  @$pb.TagNumber(7)
  $core.bool hasGqlQuery() => $_has(3);
  @$pb.TagNumber(7)
  void clearGqlQuery() => clearField(7);
  @$pb.TagNumber(7)
  $423.GqlQuery ensureGqlQuery() => $_ensure(3);
...
class RunQueryResponse extends $pb.GeneratedMessage {
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(_omitMessageNames ? '' : 'RunQueryResponse', package: const $pb.PackageName(_omitMessageNames ? '' : 'google.datastore.v1beta3'), createEmptyInstance: create)
    ..aOM<$423.QueryResultBatch>(1, _omitFieldNames ? '' : 'batch', subBuilder: $423.QueryResultBatch.create)
    ..aOM<$423.Query>(2, _omitFieldNames ? '' : 'query', subBuilder: $423.Query.create)
    ..hasRequiredFields = false
  ;
  ...
  @$pb.TagNumber(1)
  $423.QueryResultBatch get batch => $_getN(0);
  @$pb.TagNumber(1)
  set batch($423.QueryResultBatch v) { setField(1, v); }
  @$pb.TagNumber(1)
  $core.bool hasBatch() => $_has(0);
  @$pb.TagNumber(1)
  void clearBatch() => clearField(1);
  @$pb.TagNumber(1)
  $423.QueryResultBatch ensureBatch() => $_ensure(0);

  /// The parsed form of the `GqlQuery` from the request, if it was set.
  @$pb.TagNumber(2)
  $423.Query get query => $_getN(1);
  @$pb.TagNumber(2)
  set query($423.Query v) { setField(2, v); }
  @$pb.TagNumber(2)
  $core.bool hasQuery() => $_has(1);
  @$pb.TagNumber(2)
  void clearQuery() => clearField(2);
  @$pb.TagNumber(2)
  $423.Query ensureQuery() => $_ensure(1);
}
...
class AllocateIdsRequest extends $pb.GeneratedMessage {
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(_omitMessageNames ? '' : 'AllocateIdsRequest', package: const $pb.PackageName(_omitMessageNames ? '' : 'google.datastore.v1beta3'), createEmptyInstance: create)
    ..pc<$422.Key>(1, _omitFieldNames ? '' : 'keys', $pb.PbFieldType.PM, subBuilder: $422.Key.create)
    ..aOS(8, _omitFieldNames ? '' : 'projectId')
    ..hasRequiredFields = false
  ;
  ...
  @$pb.TagNumber(1)
  $core.List<$422.Key> get keys => $_getList(0);
...
class Mutation extends $pb.GeneratedMessage {
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(_omitMessageNames ? '' : 'Mutation', package: const $pb.PackageName(_omitMessageNames ? '' : 'google.datastore.v1beta3'), createEmptyInstance: create)
    ..oo(0, [4, 5, 6, 7])
    ..oo(1, [8])
    ..aOM<$422.Entity>(4, _omitFieldNames ? '' : 'insert', subBuilder: $422.Entity.create)
    ..aOM<$422.Entity>(5, _omitFieldNames ? '' : 'update', subBuilder: $422.Entity.create)
    ..aOM<$422.Entity>(6, _omitFieldNames ? '' : 'upsert', subBuilder: $422.Entity.create)
    ..aOM<$422.Key>(7, _omitFieldNames ? '' : 'delete', subBuilder: $422.Key.create)
  ...
  @$pb.TagNumber(4)
  $422.Entity get insert => $_getN(0);
  @$pb.TagNumber(4)
  set insert($422.Entity v) { setField(4, v); }
  @$pb.TagNumber(4)
  $core.bool hasInsert() => $_has(0);
  @$pb.TagNumber(4)
  void clearInsert() => clearField(4);
  @$pb.TagNumber(4)
  $422.Entity ensureInsert() => $_ensure(0);

  /// The entity to update. The entity must already exist.
  /// Must have a complete key path.
  @$pb.TagNumber(5)
  $422.Entity get update => $_getN(1);
  @$pb.TagNumber(5)
  set update($422.Entity v) { setField(5, v); }
  @$pb.TagNumber(5)
  $core.bool hasUpdate() => $_has(1);
  @$pb.TagNumber(5)
  void clearUpdate() => clearField(5);
  @$pb.TagNumber(5)
  $422.Entity ensureUpdate() => $_ensure(1);

  /// The entity to upsert. The entity may or may not already exist.
  /// The entity key's final path element may be incomplete.
  @$pb.TagNumber(6)
  $422.Entity get upsert => $_getN(2);
  @$pb.TagNumber(6)
  set upsert($422.Entity v) { setField(6, v); }
  @$pb.TagNumber(6)
  $core.bool hasUpsert() => $_has(2);
  @$pb.TagNumber(6)
  void clearUpsert() => clearField(6);
  @$pb.TagNumber(6)
  $422.Entity ensureUpsert() => $_ensure(2);

  /// The key of the entity to delete. The entity may or may not already exist.
  /// Must have a complete key path and must not be reserved/read-only.
  @$pb.TagNumber(7)
  $422.Key get delete => $_getN(3);
  @$pb.TagNumber(7)
  set delete($422.Key v) { setField(7, v); }
  @$pb.TagNumber(7)
  $core.bool hasDelete() => $_has(3);
  @$pb.TagNumber(7)
  void clearDelete() => clearField(7);
  @$pb.TagNumber(7)
  $422.Key ensureDelete() => $_ensure(3);
...
class MutationResult extends $pb.GeneratedMessage {
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(_omitMessageNames ? '' : 'MutationResult', package: const $pb.PackageName(_omitMessageNames ? '' : 'google.datastore.v1beta3'), createEmptyInstance: create)
    ..aOM<$422.Key>(3, _omitFieldNames ? '' : 'key', subBuilder: $422.Key.create)
  ...
  @$pb.TagNumber(3)
  $422.Key get key => $_getN(0);
  @$pb.TagNumber(3)
  set key($422.Key v) { setField(3, v); }
  @$pb.TagNumber(3)
  $core.bool hasKey() => $_has(0);
  @$pb.TagNumber(3)
  void clearKey() => clearField(3);
  @$pb.TagNumber(3)
  $422.Key ensureKey() => $_ensure(0);
