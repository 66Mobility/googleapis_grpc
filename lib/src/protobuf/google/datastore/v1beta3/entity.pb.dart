...
class PartitionId extends $pb.GeneratedMessage {
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(_omitMessageNames ? '' : 'PartitionId', package: const $pb.PackageName(_omitMessageNames ? '' : 'google.datastore.v1beta3'), createEmptyInstance: create)
...
class Key_PathElement extends $pb.GeneratedMessage {
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(_omitMessageNames ? '' : 'Key.PathElement', package: const $pb.PackageName(_omitMessageNames ? '' : 'google.datastore.v1beta3'), createEmptyInstance: create)
    ..oo(0, [2, 3])
...
class Key extends $pb.GeneratedMessage {
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(_omitMessageNames ? '' : 'Key', package: const $pb.PackageName(_omitMessageNames ? '' : 'google.datastore.v1beta3'), createEmptyInstance: create)
...
class ArrayValue extends $pb.GeneratedMessage {
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(_omitMessageNames ? '' : 'ArrayValue', package: const $pb.PackageName(_omitMessageNames ? '' : 'google.datastore.v1beta3'), createEmptyInstance: create)
...
class Value extends $pb.GeneratedMessage {
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(_omitMessageNames ? '' : 'Value', package: const $pb.PackageName(_omitMessageNames ? '' : 'google.datastore.v1beta3'), createEmptyInstance: create)
    ...
    ..aOM<$325.LatLng>(8, _omitFieldNames ? '' : 'geoPointValue', subBuilder: $325.LatLng.create)
    ..aOM<ArrayValue>(9, _omitFieldNames ? '' : 'arrayValue', subBuilder: ArrayValue.create)
    ..aOM<$302.Timestamp>(10, _omitFieldNames ? '' : 'timestampValue', subBuilder: $302.Timestamp.create)
    ..e<$261.NullValue>(11, _omitFieldNames ? '' : 'nullValue', $pb.PbFieldType.OE, defaultOrMaker: $261.NullValue.NULL_VALUE, valueOf: $261.NullValue.valueOf, enumValues: $261.NullValue.values)
  ...
  @$pb.TagNumber(8)
  set geoPointValue($325.LatLng v) { setField(8, v); }
  @$pb.TagNumber(8)
  ...
  @$pb.TagNumber(10)
  set timestampValue($302.Timestamp v) { setField(10, v); }
  @$pb.TagNumber(10)
  ...
  @$pb.TagNumber(11)
  set nullValue($261.NullValue v) { setField(11, v); }
  @$pb.TagNumber(11)
...
class Entity extends $pb.GeneratedMessage {
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(_omitMessageNames ? '' : 'Entity', package: const $pb.PackageName(_omitMessageNames ? '' : 'google.datastore.v1beta3'), createEmptyInstance: create)
    ..aOM<Key>(1, _omitFieldNames ? '' : 'key', subBuilder: Key.create)
    ..m<$core.String, Value>(3, _omitFieldNames ? '' : 'properties', entryClassName: 'Entity.PropertiesEntry', keyFieldType: $pb.PbFieldType.OS, valueFieldType: $pb.PbFieldType.OM, valueCreator: Value.create, valueDefaultOrMaker: Value.getDefault, packageName: const $pb.PackageName('google.datastore.v1beta3'))
    ..hasRequiredFields = false
  ;
