...
class Index_AncestorMode extends $pb.ProtobufEnum {
  static const Index_AncestorMode ANCESTOR_MODE_UNSPECIFIED = Index_AncestorMode._(0, _omitEnumNames ? '' : 'ANCESTOR_MODE_UNSPECIFIED');
  static const Index_AncestorMode NONE = Index_AncestorMode._(1, _omitEnumNames ? '' : 'NONE');
  static const Index_AncestorMode ALL_ANCESTORS = Index_AncestorMode._(2, _omitEnumNames ? '' : 'ALL_ANCESTORS');
...
class Index_Direction extends $pb.ProtobufEnum {
  static const Index_Direction DIRECTION_UNSPECIFIED = Index_Direction._(0, _omitEnumNames ? '' : 'DIRECTION_UNSPECIFIED');
  static const Index_Direction ASCENDING = Index_Direction._(1, _omitEnumNames ? '' : 'ASCENDING');
  static const Index_Direction DESCENDING = Index_Direction._(2, _omitEnumNames ? '' : 'DESCENDING');
...
class Index_State extends $pb.ProtobufEnum {
  ...
  static const Index_State DELETING = Index_State._(3, _omitEnumNames ? '' : 'DELETING');
  static const Index_State ERROR = Index_State._(4, _omitEnumNames ? '' : 'ERROR');
