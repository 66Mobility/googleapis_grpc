...
import 'datastore_admin.pb.dart' as $131;
...
class DatastoreAdminClient extends $grpc.Client {
  static final _$exportEntities =
      $grpc.ClientMethod<$131.ExportEntitiesRequest, $13.Operation>(
          '/google.datastore.admin.v1beta1.DatastoreAdmin/ExportEntities',
          ($131.ExportEntitiesRequest value) => value.writeToBuffer(),
          ($core.List<$core.int> value) => $13.Operation.fromBuffer(value));
  static final _$importEntities =
      $grpc.ClientMethod<$131.ImportEntitiesRequest, $13.Operation>(
          '/google.datastore.admin.v1beta1.DatastoreAdmin/ImportEntities',
          ($131.ImportEntitiesRequest value) => value.writeToBuffer(),
          ($core.List<$core.int> value) => $13.Operation.fromBuffer(value));
...
abstract class DatastoreAdminServiceBase extends $grpc.Service {
  ...
  DatastoreAdminServiceBase() {
    $addMethod($grpc.ServiceMethod<$131.ExportEntitiesRequest, $13.Operation>(
        'ExportEntities',
        exportEntities_Pre,
        false,
        false,
        ($core.List<$core.int> value) =>
            $131.ExportEntitiesRequest.fromBuffer(value),
        ($13.Operation value) => value.writeToBuffer()));
    $addMethod($grpc.ServiceMethod<$131.ImportEntitiesRequest, $13.Operation>(
        'ImportEntities',
        importEntities_Pre,
        false,
        false,
        ($core.List<$core.int> value) =>
            $131.ImportEntitiesRequest.fromBuffer(value),
        ($13.Operation value) => value.writeToBuffer()));
  }

  $async.Future<$13.Operation> exportEntities_Pre($grpc.ServiceCall call,
      $async.Future<$131.ExportEntitiesRequest> request) async {
    return exportEntities(call, await request);
  }

  $async.Future<$13.Operation> importEntities_Pre($grpc.ServiceCall call,
      $async.Future<$131.ImportEntitiesRequest> request) async {
    return importEntities(call, await request);
  }

  $async.Future<$13.Operation> exportEntities(
      $grpc.ServiceCall call, $131.ExportEntitiesRequest request);
  $async.Future<$13.Operation> importEntities(
      $grpc.ServiceCall call, $131.ImportEntitiesRequest request);
}
