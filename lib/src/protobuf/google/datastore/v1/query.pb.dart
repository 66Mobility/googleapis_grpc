...
class EntityResult extends $pb.GeneratedMessage {
  ...
  @$pb.TagNumber(1)
  $452.Entity get entity => $_getN(0);
  @$pb.TagNumber(1)
  set entity($452.Entity v) {
    setField(1, v);
  }
  ...
  @$pb.TagNumber(1)
  $452.Entity ensureEntity() => $_ensure(0);
...
class Query extends $pb.GeneratedMessage {
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(
    ...
    ..aOM<$335.Int32Value>(12, _omitFieldNames ? '' : 'limit',
  ...
  @$pb.TagNumber(12)
  $335.Int32Value get limit => $_getN(8);
  @$pb.TagNumber(12)
  ...
  @$pb.TagNumber(12)
  $335.Int32Value ensureLimit() => $_ensure(8);
...
class AggregationQuery_Aggregation_Count extends $pb.GeneratedMessage {
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(
      ...
      package:
          const $pb.PackageName(_omitMessageNames ? '' : 'google.datastore.v1'),
      createEmptyInstance: create)
    ..aOM<$335.Int64Value>(1, _omitFieldNames ? '' : 'upTo',
  ...
  @$pb.TagNumber(1)
  $335.Int64Value get upTo => $_getN(0);
  @$pb.TagNumber(1)
  set upTo($335.Int64Value v) {
    setField(1, v);
  }
  ...
  @$pb.TagNumber(1)
  $335.Int64Value ensureUpTo() => $_ensure(0);
}
...
class PropertyFilter extends $pb.GeneratedMessage {
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(
    ...
    ..aOM<$452.Value>(3, _omitFieldNames ? '' : 'value',
  ...
  @$pb.TagNumber(3)
  $452.Value get value => $_getN(2);
  @$pb.TagNumber(3)
  set value($452.Value v) {
    setField(3, v);
  }
  ...
  @$pb.TagNumber(3)
  $452.Value ensureValue() => $_ensure(2);
}
...
class FindNearest extends $pb.GeneratedMessage {
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(
    ...
    ..aOM<PropertyReference>(1, _omitFieldNames ? '' : 'vectorProperty',
        subBuilder: PropertyReference.create)
    ..aOM<$452.Value>(2, _omitFieldNames ? '' : 'queryVector',
        subBuilder: $452.Value.create)
    ...
    ..aOM<$335.Int32Value>(4, _omitFieldNames ? '' : 'limit',
        subBuilder: $335.Int32Value.create)
    ..aOS(5, _omitFieldNames ? '' : 'distanceResultProperty')
    ..aOM<$335.DoubleValue>(6, _omitFieldNames ? '' : 'distanceThreshold',
  ...
  @$pb.TagNumber(2)
  $452.Value get queryVector => $_getN(1);
  @$pb.TagNumber(2)
  set queryVector($452.Value v) {
    setField(2, v);
  }
  ...
  @$pb.TagNumber(2)
  $452.Value ensureQueryVector() => $_ensure(1);
  ...
  @$pb.TagNumber(4)
  $335.Int32Value get limit => $_getN(3);
  @$pb.TagNumber(4)
  set limit($335.Int32Value v) {
    setField(4, v);
  }
  ...
  @$pb.TagNumber(4)
  $335.Int32Value ensureLimit() => $_ensure(3);
  ...
  @$pb.TagNumber(6)
  $335.DoubleValue get distanceThreshold => $_getN(5);
  @$pb.TagNumber(6)
  set distanceThreshold($335.DoubleValue v) {
    setField(6, v);
  }
  ...
  @$pb.TagNumber(6)
  $335.DoubleValue ensureDistanceThreshold() => $_ensure(5);
}
...
class GqlQueryParameter extends $pb.GeneratedMessage {
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(
      ...
      createEmptyInstance: create)
    ..oo(0, [2, 3])
    ..aOM<$452.Value>(2, _omitFieldNames ? '' : 'value',
        subBuilder: $452.Value.create)
    ..a<$core.List<$core.int>>(
        3, _omitFieldNames ? '' : 'cursor', $pb.PbFieldType.OY)
    ..hasRequiredFields = false;
  ...
  @$pb.TagNumber(2)
  $452.Value ensureValue() => $_ensure(0);
...
class QueryResultBatch extends $pb.GeneratedMessage {
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(
    ...
    ..aOM<$330.Timestamp>(8, _omitFieldNames ? '' : 'readTime',
        subBuilder: $330.Timestamp.create)
    ..hasRequiredFields = false;
