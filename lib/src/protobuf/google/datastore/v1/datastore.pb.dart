...
import 'aggregation_result.pb.dart' as $4751;
import 'datastore.pbenum.dart';
import 'entity.pb.dart' as $4748;
import 'query.pb.dart' as $4749;
import 'query_profile.pb.dart' as $4750;
...
class LookupRequest extends $pb.GeneratedMessage {
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(_omitMessageNames ? '' : 'LookupRequest', package: const $pb.PackageName(_omitMessageNames ? '' : 'google.datastore.v1'), createEmptyInstance: create)
    ...
    ..pc<$4748.Key>(3, _omitFieldNames ? '' : 'keys', $pb.PbFieldType.PM, subBuilder: $4748.Key.create)
  ...
  @$pb.TagNumber(3)
  $core.List<$4748.Key> get keys => $_getList(1);
...
class LookupResponse extends $pb.GeneratedMessage {
  factory LookupResponse({
    $core.Iterable<$4749.EntityResult>? found,
    $core.Iterable<$4749.EntityResult>? missing,
    $core.Iterable<$4748.Key>? deferred,
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(_omitMessageNames ? '' : 'LookupResponse', package: const $pb.PackageName(_omitMessageNames ? '' : 'google.datastore.v1'), createEmptyInstance: create)
    ..pc<$4749.EntityResult>(1, _omitFieldNames ? '' : 'found', $pb.PbFieldType.PM, subBuilder: $4749.EntityResult.create)
    ..pc<$4749.EntityResult>(2, _omitFieldNames ? '' : 'missing', $pb.PbFieldType.PM, subBuilder: $4749.EntityResult.create)
    ..pc<$4748.Key>(3, _omitFieldNames ? '' : 'deferred', $pb.PbFieldType.PM, subBuilder: $4748.Key.create)
  ...
  /// input.
  @$pb.TagNumber(1)
  $core.List<$4749.EntityResult> get found => $_getList(0);

  /// Entities not found as `ResultType.KEY_ONLY` entities. The order of results
  /// in this field is undefined and has no relation to the order of the keys
  /// in the input.
  @$pb.TagNumber(2)
  $core.List<$4749.EntityResult> get missing => $_getList(1);

  /// A list of keys that were not looked up due to resource constraints. The
  /// order of results in this field is undefined and has no relation to the
  /// order of the keys in the input.
  @$pb.TagNumber(3)
  $core.List<$4748.Key> get deferred => $_getList(2);
...
class RunQueryRequest extends $pb.GeneratedMessage {
  factory RunQueryRequest({
    ReadOptions? readOptions,
    $4748.PartitionId? partitionId,
    $4749.Query? query,
    $4749.GqlQuery? gqlQuery,
    $core.String? projectId,
    $core.String? databaseId,
    PropertyMask? propertyMask,
    $4750.ExplainOptions? explainOptions,
  }) {
    final $result = create();
    if (readOptions != null) {
      $result.readOptions = readOptions;
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(_omitMessageNames ? '' : 'RunQueryRequest', package: const $pb.PackageName(_omitMessageNames ? '' : 'google.datastore.v1'), createEmptyInstance: create)
    ..oo(0, [3, 7])
    ..aOM<ReadOptions>(1, _omitFieldNames ? '' : 'readOptions', subBuilder: ReadOptions.create)
    ..aOM<$4748.PartitionId>(2, _omitFieldNames ? '' : 'partitionId', subBuilder: $4748.PartitionId.create)
    ..aOM<$4749.Query>(3, _omitFieldNames ? '' : 'query', subBuilder: $4749.Query.create)
    ..aOM<$4749.GqlQuery>(7, _omitFieldNames ? '' : 'gqlQuery', subBuilder: $4749.GqlQuery.create)
    ..aOS(8, _omitFieldNames ? '' : 'projectId')
    ..aOS(9, _omitFieldNames ? '' : 'databaseId')
    ..aOM<PropertyMask>(10, _omitFieldNames ? '' : 'propertyMask', subBuilder: PropertyMask.create)
    ..aOM<$4750.ExplainOptions>(12, _omitFieldNames ? '' : 'explainOptions', subBuilder: $4750.ExplainOptions.create)
    ..hasRequiredFields = false
  ;
  ...
  /// partition ID.
  @$pb.TagNumber(2)
  $4748.PartitionId get partitionId => $_getN(1);
  @$pb.TagNumber(2)
  set partitionId($4748.PartitionId v) { setField(2, v); }
  @$pb.TagNumber(2)
  $core.bool hasPartitionId() => $_has(1);
  @$pb.TagNumber(2)
  void clearPartitionId() => clearField(2);
  @$pb.TagNumber(2)
  $4748.PartitionId ensurePartitionId() => $_ensure(1);

  /// The query to run.
  @$pb.TagNumber(3)
  $4749.Query get query => $_getN(2);
  @$pb.TagNumber(3)
  set query($4749.Query v) { setField(3, v); }
  @$pb.TagNumber(3)
  $core.bool hasQuery() => $_has(2);
  @$pb.TagNumber(3)
  void clearQuery() => clearField(3);
  @$pb.TagNumber(3)
  $4749.Query ensureQuery() => $_ensure(2);

  /// The GQL query to run. This query must be a non-aggregation query.
  @$pb.TagNumber(7)
  $4749.GqlQuery get gqlQuery => $_getN(3);
  @$pb.TagNumber(7)
  set gqlQuery($4749.GqlQuery v) { setField(7, v); }
  @$pb.TagNumber(7)
  $core.bool hasGqlQuery() => $_has(3);
  @$pb.TagNumber(7)
  void clearGqlQuery() => clearField(7);
  @$pb.TagNumber(7)
  $4749.GqlQuery ensureGqlQuery() => $_ensure(3);
  ...
  @$pb.TagNumber(12)
  $4750.ExplainOptions get explainOptions => $_getN(7);
  @$pb.TagNumber(12)
  set explainOptions($4750.ExplainOptions v) { setField(12, v); }
  @$pb.TagNumber(12)
  $core.bool hasExplainOptions() => $_has(7);
  @$pb.TagNumber(12)
  void clearExplainOptions() => clearField(12);
  @$pb.TagNumber(12)
  $4750.ExplainOptions ensureExplainOptions() => $_ensure(7);
}
...
class RunQueryResponse extends $pb.GeneratedMessage {
  factory RunQueryResponse({
    $4749.QueryResultBatch? batch,
    $4749.Query? query,
    $core.List<$core.int>? transaction,
    $4750.ExplainMetrics? explainMetrics,
  }) {
    final $result = create();
    if (batch != null) {
      $result.batch = batch;
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(_omitMessageNames ? '' : 'RunQueryResponse', package: const $pb.PackageName(_omitMessageNames ? '' : 'google.datastore.v1'), createEmptyInstance: create)
    ..aOM<$4749.QueryResultBatch>(1, _omitFieldNames ? '' : 'batch', subBuilder: $4749.QueryResultBatch.create)
    ..aOM<$4749.Query>(2, _omitFieldNames ? '' : 'query', subBuilder: $4749.Query.create)
    ..a<$core.List<$core.int>>(5, _omitFieldNames ? '' : 'transaction', $pb.PbFieldType.OY)
    ..aOM<$4750.ExplainMetrics>(9, _omitFieldNames ? '' : 'explainMetrics', subBuilder: $4750.ExplainMetrics.create)
    ..hasRequiredFields = false
  ;
  ...
  @$pb.TagNumber(1)
  $4749.QueryResultBatch get batch => $_getN(0);
  @$pb.TagNumber(1)
  set batch($4749.QueryResultBatch v) { setField(1, v); }
  @$pb.TagNumber(1)
  $core.bool hasBatch() => $_has(0);
  @$pb.TagNumber(1)
  void clearBatch() => clearField(1);
  @$pb.TagNumber(1)
  $4749.QueryResultBatch ensureBatch() => $_ensure(0);

  /// The parsed form of the `GqlQuery` from the request, if it was set.
  @$pb.TagNumber(2)
  $4749.Query get query => $_getN(1);
  @$pb.TagNumber(2)
  set query($4749.Query v) { setField(2, v); }
  @$pb.TagNumber(2)
  $core.bool hasQuery() => $_has(1);
  @$pb.TagNumber(2)
  void clearQuery() => clearField(2);
  @$pb.TagNumber(2)
  $4749.Query ensureQuery() => $_ensure(1);
  ...
  @$pb.TagNumber(9)
  $4750.ExplainMetrics get explainMetrics => $_getN(3);
  @$pb.TagNumber(9)
  set explainMetrics($4750.ExplainMetrics v) { setField(9, v); }
  @$pb.TagNumber(9)
  $core.bool hasExplainMetrics() => $_has(3);
  @$pb.TagNumber(9)
  void clearExplainMetrics() => clearField(9);
  @$pb.TagNumber(9)
  $4750.ExplainMetrics ensureExplainMetrics() => $_ensure(3);
}
...
class RunAggregationQueryRequest extends $pb.GeneratedMessage {
  factory RunAggregationQueryRequest({
    ReadOptions? readOptions,
    $4748.PartitionId? partitionId,
    $4749.AggregationQuery? aggregationQuery,
    $4749.GqlQuery? gqlQuery,
    $core.String? projectId,
    $core.String? databaseId,
    $4750.ExplainOptions? explainOptions,
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(_omitMessageNames ? '' : 'RunAggregationQueryRequest', package: const $pb.PackageName(_omitMessageNames ? '' : 'google.datastore.v1'), createEmptyInstance: create)
    ...
    ..aOM<ReadOptions>(1, _omitFieldNames ? '' : 'readOptions', subBuilder: ReadOptions.create)
    ..aOM<$4748.PartitionId>(2, _omitFieldNames ? '' : 'partitionId', subBuilder: $4748.PartitionId.create)
    ..aOM<$4749.AggregationQuery>(3, _omitFieldNames ? '' : 'aggregationQuery', subBuilder: $4749.AggregationQuery.create)
    ..aOM<$4749.GqlQuery>(7, _omitFieldNames ? '' : 'gqlQuery', subBuilder: $4749.GqlQuery.create)
    ..aOS(8, _omitFieldNames ? '' : 'projectId')
    ..aOS(9, _omitFieldNames ? '' : 'databaseId')
    ..aOM<$4750.ExplainOptions>(11, _omitFieldNames ? '' : 'explainOptions', subBuilder: $4750.ExplainOptions.create)
    ..hasRequiredFields = false
  ;
  ...
  /// The query to run.
  @$pb.TagNumber(3)
  $4749.AggregationQuery get aggregationQuery => $_getN(2);
  @$pb.TagNumber(3)
  set aggregationQuery($4749.AggregationQuery v) { setField(3, v); }
  @$pb.TagNumber(3)
  $core.bool hasAggregationQuery() => $_has(2);
  @$pb.TagNumber(3)
  void clearAggregationQuery() => clearField(3);
  @$pb.TagNumber(3)
  $4749.AggregationQuery ensureAggregationQuery() => $_ensure(2);
  ...
  /// statistics will be returned. If not, only query results will be returned.
  @$pb.TagNumber(11)
  $4750.ExplainOptions get explainOptions => $_getN(6);
  @$pb.TagNumber(11)
  set explainOptions($4750.ExplainOptions v) { setField(11, v); }
  @$pb.TagNumber(11)
  $core.bool hasExplainOptions() => $_has(6);
  @$pb.TagNumber(11)
  void clearExplainOptions() => clearField(11);
  @$pb.TagNumber(11)
  $4750.ExplainOptions ensureExplainOptions() => $_ensure(6);
}
...
class RunAggregationQueryResponse extends $pb.GeneratedMessage {
  factory RunAggregationQueryResponse({
    $4751.AggregationResultBatch? batch,
    $4749.AggregationQuery? query,
    $core.List<$core.int>? transaction,
    $4750.ExplainMetrics? explainMetrics,
  }) {
    final $result = create();
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(_omitMessageNames ? '' : 'RunAggregationQueryResponse', package: const $pb.PackageName(_omitMessageNames ? '' : 'google.datastore.v1'), createEmptyInstance: create)
    ..aOM<$4751.AggregationResultBatch>(1, _omitFieldNames ? '' : 'batch', subBuilder: $4751.AggregationResultBatch.create)
    ..aOM<$4749.AggregationQuery>(2, _omitFieldNames ? '' : 'query', subBuilder: $4749.AggregationQuery.create)
    ..a<$core.List<$core.int>>(5, _omitFieldNames ? '' : 'transaction', $pb.PbFieldType.OY)
    ..aOM<$4750.ExplainMetrics>(9, _omitFieldNames ? '' : 'explainMetrics', subBuilder: $4750.ExplainMetrics.create)
    ..hasRequiredFields = false
  ;
  ...
  @$pb.TagNumber(1)
  $4751.AggregationResultBatch get batch => $_getN(0);
  @$pb.TagNumber(1)
  set batch($4751.AggregationResultBatch v) { setField(1, v); }
  @$pb.TagNumber(1)
  $core.bool hasBatch() => $_has(0);
  @$pb.TagNumber(1)
  void clearBatch() => clearField(1);
  @$pb.TagNumber(1)
  $4751.AggregationResultBatch ensureBatch() => $_ensure(0);

  /// The parsed form of the `GqlQuery` from the request, if it was set.
  @$pb.TagNumber(2)
  $4749.AggregationQuery get query => $_getN(1);
  @$pb.TagNumber(2)
  set query($4749.AggregationQuery v) { setField(2, v); }
  @$pb.TagNumber(2)
  $core.bool hasQuery() => $_has(1);
  @$pb.TagNumber(2)
  void clearQuery() => clearField(2);
  @$pb.TagNumber(2)
  $4749.AggregationQuery ensureQuery() => $_ensure(1);
...
class CommitResponse extends $pb.GeneratedMessage {
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(_omitMessageNames ? '' : 'CommitResponse', package: const $pb.PackageName(_omitMessageNames ? '' : 'google.datastore.v1'), createEmptyInstance: create)
    ...
    ..aOM<$1776.Timestamp>(8, _omitFieldNames ? '' : 'commitTime', subBuilder: $1776.Timestamp.create)
    ..hasRequiredFields = false
  ;
  ...
  @$pb.TagNumber(8)
  $1776.Timestamp get commitTime => $_getN(2);
  @$pb.TagNumber(8)
  set commitTime($1776.Timestamp v) { setField(8, v); }
  @$pb.TagNumber(8)
  $core.bool hasCommitTime() => $_has(2);
  @$pb.TagNumber(8)
  void clearCommitTime() => clearField(8);
  @$pb.TagNumber(8)
  $1776.Timestamp ensureCommitTime() => $_ensure(2);
}
...
class AllocateIdsRequest extends $pb.GeneratedMessage {
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(_omitMessageNames ? '' : 'AllocateIdsRequest', package: const $pb.PackageName(_omitMessageNames ? '' : 'google.datastore.v1'), createEmptyInstance: create)
    ..pc<$4748.Key>(1, _omitFieldNames ? '' : 'keys', $pb.PbFieldType.PM, subBuilder: $4748.Key.create)
    ..aOS(8, _omitFieldNames ? '' : 'projectId')
    ..aOS(9, _omitFieldNames ? '' : 'databaseId')
    ..hasRequiredFields = false
  ;
  ...
  @$pb.TagNumber(1)
  $core.List<$4748.Key> get keys => $_getList(0);
...
class Mutation extends $pb.GeneratedMessage {
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(_omitMessageNames ? '' : 'Mutation', package: const $pb.PackageName(_omitMessageNames ? '' : 'google.datastore.v1'), createEmptyInstance: create)
    ..oo(0, [4, 5, 6, 7])
    ..oo(1, [8, 11])
    ..aOM<$4748.Entity>(4, _omitFieldNames ? '' : 'insert', subBuilder: $4748.Entity.create)
    ..aOM<$4748.Entity>(5, _omitFieldNames ? '' : 'update', subBuilder: $4748.Entity.create)
    ..aOM<$4748.Entity>(6, _omitFieldNames ? '' : 'upsert', subBuilder: $4748.Entity.create)
    ..aOM<$4748.Key>(7, _omitFieldNames ? '' : 'delete', subBuilder: $4748.Key.create)
  ...
  @$pb.TagNumber(4)
  $4748.Entity get insert => $_getN(0);
  @$pb.TagNumber(4)
  set insert($4748.Entity v) { setField(4, v); }
  @$pb.TagNumber(4)
  $core.bool hasInsert() => $_has(0);
  @$pb.TagNumber(4)
  void clearInsert() => clearField(4);
  @$pb.TagNumber(4)
  $4748.Entity ensureInsert() => $_ensure(0);

  /// The entity to update. The entity must already exist.
  /// Must have a complete key path.
  @$pb.TagNumber(5)
  $4748.Entity get update => $_getN(1);
  @$pb.TagNumber(5)
  set update($4748.Entity v) { setField(5, v); }
  @$pb.TagNumber(5)
  $core.bool hasUpdate() => $_has(1);
  @$pb.TagNumber(5)
  void clearUpdate() => clearField(5);
  @$pb.TagNumber(5)
  $4748.Entity ensureUpdate() => $_ensure(1);

  /// The entity to upsert. The entity may or may not already exist.
  /// The entity key's final path element may be incomplete.
  @$pb.TagNumber(6)
  $4748.Entity get upsert => $_getN(2);
  @$pb.TagNumber(6)
  set upsert($4748.Entity v) { setField(6, v); }
  @$pb.TagNumber(6)
  $core.bool hasUpsert() => $_has(2);
  @$pb.TagNumber(6)
  void clearUpsert() => clearField(6);
  @$pb.TagNumber(6)
  $4748.Entity ensureUpsert() => $_ensure(2);

  /// The key of the entity to delete. The entity may or may not already exist.
  /// Must have a complete key path and must not be reserved/read-only.
  @$pb.TagNumber(7)
  $4748.Key get delete => $_getN(3);
  @$pb.TagNumber(7)
  set delete($4748.Key v) { setField(7, v); }
  @$pb.TagNumber(7)
  $core.bool hasDelete() => $_has(3);
  @$pb.TagNumber(7)
  void clearDelete() => clearField(7);
  @$pb.TagNumber(7)
  $4748.Key ensureDelete() => $_ensure(3);
...
class MutationResult extends $pb.GeneratedMessage {
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(_omitMessageNames ? '' : 'MutationResult', package: const $pb.PackageName(_omitMessageNames ? '' : 'google.datastore.v1'), createEmptyInstance: create)
    ..aOM<$4748.Key>(3, _omitFieldNames ? '' : 'key', subBuilder: $4748.Key.create)
  ...
  @$pb.TagNumber(3)
  $4748.Key get key => $_getN(0);
  @$pb.TagNumber(3)
  set key($4748.Key v) { setField(3, v); }
  @$pb.TagNumber(3)
  $core.bool hasKey() => $_has(0);
  @$pb.TagNumber(3)
  void clearKey() => clearField(3);
  @$pb.TagNumber(3)
  $4748.Key ensureKey() => $_ensure(0);
