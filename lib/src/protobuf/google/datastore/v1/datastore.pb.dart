...
import 'aggregation_result.pb.dart' as $455;
import 'datastore.pbenum.dart';
import 'entity.pb.dart' as $452;
import 'query.pb.dart' as $453;
import 'query_profile.pb.dart' as $454;
...
class LookupRequest extends $pb.GeneratedMessage {
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(
    ...
    ..pc<$452.Key>(3, _omitFieldNames ? '' : 'keys', $pb.PbFieldType.PM,
        subBuilder: $452.Key.create)
  ...
  @$pb.TagNumber(3)
  $core.List<$452.Key> get keys => $_getList(1);
...
class LookupResponse extends $pb.GeneratedMessage {
  factory LookupResponse({
    $core.Iterable<$453.EntityResult>? found,
    $core.Iterable<$453.EntityResult>? missing,
    $core.Iterable<$452.Key>? deferred,
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(
    ...
    ..pc<$453.EntityResult>(
        ...
        subBuilder: $453.EntityResult.create)
    ..pc<$453.EntityResult>(
        2, _omitFieldNames ? '' : 'missing', $pb.PbFieldType.PM,
        subBuilder: $453.EntityResult.create)
    ..pc<$452.Key>(3, _omitFieldNames ? '' : 'deferred', $pb.PbFieldType.PM,
        subBuilder: $452.Key.create)
  ...
  /// input.
  @$pb.TagNumber(1)
  $core.List<$453.EntityResult> get found => $_getList(0);

  /// Entities not found as `ResultType.KEY_ONLY` entities. The order of results
  /// in this field is undefined and has no relation to the order of the keys
  /// in the input.
  @$pb.TagNumber(2)
  $core.List<$453.EntityResult> get missing => $_getList(1);

  /// A list of keys that were not looked up due to resource constraints. The
  /// order of results in this field is undefined and has no relation to the
  /// order of the keys in the input.
  @$pb.TagNumber(3)
  $core.List<$452.Key> get deferred => $_getList(2);
...
class RunQueryRequest extends $pb.GeneratedMessage {
  factory RunQueryRequest({
    ...
    $453.Query? query,
    $453.GqlQuery? gqlQuery,
    $core.String? projectId,
    $core.String? databaseId,
    PropertyMask? propertyMask,
    $454.ExplainOptions? explainOptions,
  }) {
    final $result = create();
    if (readOptions != null) {
      $result.readOptions = readOptions;
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(
    ...
    ..aOM<ReadOptions>(1, _omitFieldNames ? '' : 'readOptions',
        subBuilder: ReadOptions.create)
    ..aOM<$452.PartitionId>(2, _omitFieldNames ? '' : 'partitionId',
        subBuilder: $452.PartitionId.create)
    ..aOM<$453.Query>(3, _omitFieldNames ? '' : 'query',
        subBuilder: $453.Query.create)
    ..aOM<$453.GqlQuery>(7, _omitFieldNames ? '' : 'gqlQuery',
        subBuilder: $453.GqlQuery.create)
    ..aOS(8, _omitFieldNames ? '' : 'projectId')
    ..aOS(9, _omitFieldNames ? '' : 'databaseId')
    ..aOM<PropertyMask>(10, _omitFieldNames ? '' : 'propertyMask',
        subBuilder: PropertyMask.create)
    ..aOM<$454.ExplainOptions>(12, _omitFieldNames ? '' : 'explainOptions',
        subBuilder: $454.ExplainOptions.create)
    ..hasRequiredFields = false;
  ...
  /// partition ID.
  @$pb.TagNumber(2)
  $452.PartitionId get partitionId => $_getN(1);
  @$pb.TagNumber(2)
  set partitionId($452.PartitionId v) {
    setField(2, v);
  }
  ...
  @$pb.TagNumber(2)
  $452.PartitionId ensurePartitionId() => $_ensure(1);

  /// The query to run.
  @$pb.TagNumber(3)
  $453.Query get query => $_getN(2);
  @$pb.TagNumber(3)
  set query($453.Query v) {
    setField(3, v);
  }
  ...
  @$pb.TagNumber(3)
  $453.Query ensureQuery() => $_ensure(2);

  /// The GQL query to run. This query must be a non-aggregation query.
  @$pb.TagNumber(7)
  $453.GqlQuery get gqlQuery => $_getN(3);
  @$pb.TagNumber(7)
  set gqlQuery($453.GqlQuery v) {
    setField(7, v);
  }
  ...
  @$pb.TagNumber(7)
  $453.GqlQuery ensureGqlQuery() => $_ensure(3);
  ...
  @$pb.TagNumber(12)
  $454.ExplainOptions get explainOptions => $_getN(7);
  @$pb.TagNumber(12)
  set explainOptions($454.ExplainOptions v) {
    setField(12, v);
  }
  ...
  @$pb.TagNumber(12)
  $454.ExplainOptions ensureExplainOptions() => $_ensure(7);
}
...
class RunQueryResponse extends $pb.GeneratedMessage {
  factory RunQueryResponse({
    $453.QueryResultBatch? batch,
    $453.Query? query,
    $core.List<$core.int>? transaction,
    $454.ExplainMetrics? explainMetrics,
  }) {
    final $result = create();
    if (batch != null) {
      $result.batch = batch;
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(
      ...
      package:
          const $pb.PackageName(_omitMessageNames ? '' : 'google.datastore.v1'),
      createEmptyInstance: create)
    ..aOM<$453.QueryResultBatch>(1, _omitFieldNames ? '' : 'batch',
        subBuilder: $453.QueryResultBatch.create)
    ..aOM<$453.Query>(2, _omitFieldNames ? '' : 'query',
        subBuilder: $453.Query.create)
    ..a<$core.List<$core.int>>(
        5, _omitFieldNames ? '' : 'transaction', $pb.PbFieldType.OY)
    ..aOM<$454.ExplainMetrics>(9, _omitFieldNames ? '' : 'explainMetrics',
        subBuilder: $454.ExplainMetrics.create)
    ..hasRequiredFields = false;
  ...
  @$pb.TagNumber(1)
  $453.QueryResultBatch get batch => $_getN(0);
  @$pb.TagNumber(1)
  set batch($453.QueryResultBatch v) {
    setField(1, v);
  }
  ...
  @$pb.TagNumber(1)
  $453.QueryResultBatch ensureBatch() => $_ensure(0);

  /// The parsed form of the `GqlQuery` from the request, if it was set.
  @$pb.TagNumber(2)
  $453.Query get query => $_getN(1);
  @$pb.TagNumber(2)
  set query($453.Query v) {
    setField(2, v);
  }
  ...
  @$pb.TagNumber(2)
  $453.Query ensureQuery() => $_ensure(1);
  ...
  @$pb.TagNumber(9)
  $454.ExplainMetrics get explainMetrics => $_getN(3);
  @$pb.TagNumber(9)
  set explainMetrics($454.ExplainMetrics v) {
    setField(9, v);
  }
  ...
  @$pb.TagNumber(9)
  $454.ExplainMetrics ensureExplainMetrics() => $_ensure(3);
}
...
class RunAggregationQueryRequest extends $pb.GeneratedMessage {
  factory RunAggregationQueryRequest({
    ReadOptions? readOptions,
    $452.PartitionId? partitionId,
    $453.AggregationQuery? aggregationQuery,
    $453.GqlQuery? gqlQuery,
    $core.String? projectId,
    $core.String? databaseId,
    $454.ExplainOptions? explainOptions,
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(
    ...
    ..aOM<$452.PartitionId>(2, _omitFieldNames ? '' : 'partitionId',
        subBuilder: $452.PartitionId.create)
    ..aOM<$453.AggregationQuery>(3, _omitFieldNames ? '' : 'aggregationQuery',
        subBuilder: $453.AggregationQuery.create)
    ..aOM<$453.GqlQuery>(7, _omitFieldNames ? '' : 'gqlQuery',
        subBuilder: $453.GqlQuery.create)
    ..aOS(8, _omitFieldNames ? '' : 'projectId')
    ..aOS(9, _omitFieldNames ? '' : 'databaseId')
    ..aOM<$454.ExplainOptions>(11, _omitFieldNames ? '' : 'explainOptions',
        subBuilder: $454.ExplainOptions.create)
    ..hasRequiredFields = false;
  ...
  /// The query to run.
  @$pb.TagNumber(3)
  $453.AggregationQuery get aggregationQuery => $_getN(2);
  @$pb.TagNumber(3)
  set aggregationQuery($453.AggregationQuery v) {
    setField(3, v);
  }
  ...
  @$pb.TagNumber(3)
  $453.AggregationQuery ensureAggregationQuery() => $_ensure(2);
  ...
  /// statistics will be returned. If not, only query results will be returned.
  @$pb.TagNumber(11)
  $454.ExplainOptions get explainOptions => $_getN(6);
  @$pb.TagNumber(11)
  set explainOptions($454.ExplainOptions v) {
    setField(11, v);
  }
  ...
  @$pb.TagNumber(11)
  $454.ExplainOptions ensureExplainOptions() => $_ensure(6);
}
...
class RunAggregationQueryResponse extends $pb.GeneratedMessage {
  factory RunAggregationQueryResponse({
    $455.AggregationResultBatch? batch,
    $453.AggregationQuery? query,
    $core.List<$core.int>? transaction,
    $454.ExplainMetrics? explainMetrics,
  }) {
    final $result = create();
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(
      ...
      package:
          const $pb.PackageName(_omitMessageNames ? '' : 'google.datastore.v1'),
      createEmptyInstance: create)
    ..aOM<$455.AggregationResultBatch>(1, _omitFieldNames ? '' : 'batch',
        subBuilder: $455.AggregationResultBatch.create)
    ..aOM<$453.AggregationQuery>(2, _omitFieldNames ? '' : 'query',
        subBuilder: $453.AggregationQuery.create)
    ..a<$core.List<$core.int>>(
        5, _omitFieldNames ? '' : 'transaction', $pb.PbFieldType.OY)
    ..aOM<$454.ExplainMetrics>(9, _omitFieldNames ? '' : 'explainMetrics',
  ...
  @$pb.TagNumber(1)
  $455.AggregationResultBatch get batch => $_getN(0);
  @$pb.TagNumber(1)
  set batch($455.AggregationResultBatch v) {
    setField(1, v);
  }
  ...
  void clearBatch() => clearField(1);
  @$pb.TagNumber(1)
  $455.AggregationResultBatch ensureBatch() => $_ensure(0);

  /// The parsed form of the `GqlQuery` from the request, if it was set.
  @$pb.TagNumber(2)
  $453.AggregationQuery get query => $_getN(1);
  @$pb.TagNumber(2)
  set query($453.AggregationQuery v) {
    setField(2, v);
  }
  ...
  void clearQuery() => clearField(2);
  @$pb.TagNumber(2)
  $453.AggregationQuery ensureQuery() => $_ensure(1);
...
class CommitResponse extends $pb.GeneratedMessage {
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(
    ...
    ..aOM<$330.Timestamp>(8, _omitFieldNames ? '' : 'commitTime',
        subBuilder: $330.Timestamp.create)
    ..hasRequiredFields = false;
  ...
  @$pb.TagNumber(8)
  $330.Timestamp get commitTime => $_getN(2);
  @$pb.TagNumber(8)
  ...
  @$pb.TagNumber(8)
  $330.Timestamp ensureCommitTime() => $_ensure(2);
}
...
class AllocateIdsRequest extends $pb.GeneratedMessage {
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(
      ...
      package:
          const $pb.PackageName(_omitMessageNames ? '' : 'google.datastore.v1'),
      createEmptyInstance: create)
    ..pc<$452.Key>(1, _omitFieldNames ? '' : 'keys', $pb.PbFieldType.PM,
        subBuilder: $452.Key.create)
    ..aOS(8, _omitFieldNames ? '' : 'projectId')
    ..aOS(9, _omitFieldNames ? '' : 'databaseId')
    ..hasRequiredFields = false;
  ...
  @$pb.TagNumber(1)
  $core.List<$452.Key> get keys => $_getList(0);
...
class Mutation extends $pb.GeneratedMessage {
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(
    ...
    ..oo(0, [4, 5, 6, 7])
    ..oo(1, [8, 11])
    ..aOM<$452.Entity>(4, _omitFieldNames ? '' : 'insert',
        subBuilder: $452.Entity.create)
    ..aOM<$452.Entity>(5, _omitFieldNames ? '' : 'update',
        subBuilder: $452.Entity.create)
    ..aOM<$452.Entity>(6, _omitFieldNames ? '' : 'upsert',
        subBuilder: $452.Entity.create)
    ..aOM<$452.Key>(7, _omitFieldNames ? '' : 'delete',
        subBuilder: $452.Key.create)
    ...
    ..aOM<$330.Timestamp>(11, _omitFieldNames ? '' : 'updateTime',
        subBuilder: $330.Timestamp.create)
  ...
  @$pb.TagNumber(4)
  $452.Entity get insert => $_getN(0);
  @$pb.TagNumber(4)
  set insert($452.Entity v) {
    setField(4, v);
  }
  ...
  @$pb.TagNumber(4)
  $452.Entity ensureInsert() => $_ensure(0);

  /// The entity to update. The entity must already exist.
  /// Must have a complete key path.
  @$pb.TagNumber(5)
  $452.Entity get update => $_getN(1);
  @$pb.TagNumber(5)
  set update($452.Entity v) {
    setField(5, v);
  }
  ...
  @$pb.TagNumber(5)
  $452.Entity ensureUpdate() => $_ensure(1);

  /// The entity to upsert. The entity may or may not already exist.
  /// The entity key's final path element may be incomplete.
  @$pb.TagNumber(6)
  $452.Entity get upsert => $_getN(2);
  @$pb.TagNumber(6)
  set upsert($452.Entity v) {
    setField(6, v);
  }
  ...
  @$pb.TagNumber(6)
  $452.Entity ensureUpsert() => $_ensure(2);

  /// The key of the entity to delete. The entity may or may not already exist.
  /// Must have a complete key path and must not be reserved/read-only.
  @$pb.TagNumber(7)
  $452.Key get delete => $_getN(3);
  @$pb.TagNumber(7)
  set delete($452.Key v) {
    setField(7, v);
  }
  ...
  @$pb.TagNumber(7)
  $452.Key ensureDelete() => $_ensure(3);
...
class PropertyTransform extends $pb.GeneratedMessage {
  factory PropertyTransform({
    ...
    $452.Value? maximum,
    $452.Value? minimum,
    $452.ArrayValue? appendMissingElements,
    $452.ArrayValue? removeAllFromArray,
  }) {
    final $result = create();
    if (property != null) {
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(
    ...
    ..aOM<$452.Value>(3, _omitFieldNames ? '' : 'increment',
        subBuilder: $452.Value.create)
    ..aOM<$452.Value>(4, _omitFieldNames ? '' : 'maximum',
        subBuilder: $452.Value.create)
    ..aOM<$452.Value>(5, _omitFieldNames ? '' : 'minimum',
        subBuilder: $452.Value.create)
    ..aOM<$452.ArrayValue>(6, _omitFieldNames ? '' : 'appendMissingElements',
        subBuilder: $452.ArrayValue.create)
    ..aOM<$452.ArrayValue>(7, _omitFieldNames ? '' : 'removeAllFromArray',
        subBuilder: $452.ArrayValue.create)
    ..hasRequiredFields = false;
  ...
  @$pb.TagNumber(3)
  $452.Value get increment => $_getN(2);
  @$pb.TagNumber(3)
  set increment($452.Value v) {
    setField(3, v);
  }
  ...
  @$pb.TagNumber(3)
  $452.Value ensureIncrement() => $_ensure(2);
  ...
  @$pb.TagNumber(4)
  $452.Value get maximum => $_getN(3);
  @$pb.TagNumber(4)
  set maximum($452.Value v) {
    setField(4, v);
  }
  ...
  @$pb.TagNumber(4)
  $452.Value ensureMaximum() => $_ensure(3);
  ...
  ///  NaN is NaN.
  @$pb.TagNumber(5)
  $452.Value get minimum => $_getN(4);
  @$pb.TagNumber(5)
  set minimum($452.Value v) {
    setField(5, v);
  }
  ...
  @$pb.TagNumber(5)
  $452.Value ensureMinimum() => $_ensure(4);
  ...
  @$pb.TagNumber(6)
  $452.ArrayValue get appendMissingElements => $_getN(5);
  @$pb.TagNumber(6)
  set appendMissingElements($452.ArrayValue v) {
    setField(6, v);
  }
  ...
  @$pb.TagNumber(6)
  $452.ArrayValue ensureAppendMissingElements() => $_ensure(5);
  ...
  ///  The corresponding transform result will be the null value.
  @$pb.TagNumber(7)
  $452.ArrayValue get removeAllFromArray => $_getN(6);
  @$pb.TagNumber(7)
  set removeAllFromArray($452.ArrayValue v) {
    setField(7, v);
  }
  ...
  @$pb.TagNumber(7)
  $452.ArrayValue ensureRemoveAllFromArray() => $_ensure(6);
}
...
class MutationResult extends $pb.GeneratedMessage {
  factory MutationResult({
    ...
    $core.Iterable<$452.Value>? transformResults,
  }) {
    final $result = create();
    if (key != null) {
      $result.key = key;
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(
      ...
      package:
          const $pb.PackageName(_omitMessageNames ? '' : 'google.datastore.v1'),
      createEmptyInstance: create)
    ..aOM<$452.Key>(3, _omitFieldNames ? '' : 'key',
        subBuilder: $452.Key.create)
  ...
  @$pb.TagNumber(8)
  $core.List<$452.Value> get transformResults => $_getList(5);
}
...
class TransactionOptions_ReadOnly extends $pb.GeneratedMessage {
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(
      ...
      package:
          const $pb.PackageName(_omitMessageNames ? '' : 'google.datastore.v1'),
      createEmptyInstance: create)
    ..aOM<$330.Timestamp>(1, _omitFieldNames ? '' : 'readTime',
        subBuilder: $330.Timestamp.create)
    ..hasRequiredFields = false;
  ...
  ///  minute timestamp within the past 7 days.
  @$pb.TagNumber(1)
  $330.Timestamp get readTime => $_getN(0);
  @$pb.TagNumber(1)
  set readTime($330.Timestamp v) {
    setField(1, v);
  }
  ...
  @$pb.TagNumber(1)
  $330.Timestamp ensureReadTime() => $_ensure(0);
}
