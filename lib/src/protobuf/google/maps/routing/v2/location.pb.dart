...
class Location extends $pb.GeneratedMessage {
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(
    ...
    ..aOM<$5.Int32Value>(2, _omitFieldNames ? '' : 'heading',
  ...
  @$pb.TagNumber(2)
  $5.Int32Value get heading => $_getN(1);
  @$pb.TagNumber(2)
  set heading($5.Int32Value v) {
    setField(2, v);
  }
  ...
  @$pb.TagNumber(2)
  $5.Int32Value ensureHeading() => $_ensure(1);
}
