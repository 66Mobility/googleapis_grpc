...
class VehicleInfo extends $pb.GeneratedMessage {
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(_omitMessageNames ? '' : 'VehicleInfo', package: const $pb.PackageName(_omitMessageNames ? '' : 'google.maps.routing.v2'), createEmptyInstance: create)
    ..e<$4837.VehicleEmissionType>(2, _omitFieldNames ? '' : 'emissionType', $pb.PbFieldType.OE, defaultOrMaker: $4837.VehicleEmissionType.VEHICLE_EMISSION_TYPE_UNSPECIFIED, valueOf: $4837.VehicleEmissionType.valueOf, enumValues: $4837.VehicleEmissionType.values)
  ...
  @$pb.TagNumber(2)
  $4837.VehicleEmissionType get emissionType => $_getN(0);
  @$pb.TagNumber(2)
  set emissionType($4837.VehicleEmissionType v) { setField(2, v); }
  @$pb.TagNumber(2)
