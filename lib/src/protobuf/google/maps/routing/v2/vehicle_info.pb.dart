...
class VehicleInfo extends $pb.GeneratedMessage {
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(
    ...
    ..e<$22.VehicleEmissionType>(
        2, _omitFieldNames ? '' : 'emissionType', $pb.PbFieldType.OE,
        defaultOrMaker:
            $22.VehicleEmissionType.VEHICLE_EMISSION_TYPE_UNSPECIFIED,
        valueOf: $22.VehicleEmissionType.valueOf,
        enumValues: $22.VehicleEmissionType.values)
  ...
  @$pb.TagNumber(2)
  $22.VehicleEmissionType get emissionType => $_getN(0);
  @$pb.TagNumber(2)
  set emissionType($22.VehicleEmissionType v) {
    setField(2, v);
  }
