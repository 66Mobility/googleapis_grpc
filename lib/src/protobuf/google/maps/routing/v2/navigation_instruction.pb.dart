...
import 'maneuver.pbenum.dart' as $481;
...
class NavigationInstruction extends $pb.GeneratedMessage {
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(_omitMessageNames ? '' : 'NavigationInstruction', package: const $pb.PackageName(_omitMessageNames ? '' : 'google.maps.routing.v2'), createEmptyInstance: create)
    ..e<$481.Maneuver>(1, _omitFieldNames ? '' : 'maneuver', $pb.PbFieldType.OE, defaultOrMaker: $481.Maneuver.MANEUVER_UNSPECIFIED, valueOf: $481.Maneuver.valueOf, enumValues: $481.Maneuver.values)
  ...
  /// display.
  @$pb.TagNumber(1)
  $481.Maneuver get maneuver => $_getN(0);
  @$pb.TagNumber(1)
  set maneuver($481.Maneuver v) { setField(1, v); }
  @$pb.TagNumber(1)
