...
class LocalizedTime extends $pb.GeneratedMessage {
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(
    ...
    ..aOM<$3.LocalizedText>(1, _omitFieldNames ? '' : 'time',
  ...
  @$pb.TagNumber(1)
  $3.LocalizedText get time => $_getN(0);
  @$pb.TagNumber(1)
  set time($3.LocalizedText v) {
    setField(1, v);
  }
  ...
  @$pb.TagNumber(1)
  $3.LocalizedText ensureTime() => $_ensure(0);
