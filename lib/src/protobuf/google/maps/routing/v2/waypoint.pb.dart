...
class Waypoint extends $pb.GeneratedMessage {
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(_omitMessageNames ? '' : 'Waypoint', package: const $pb.PackageName(_omitMessageNames ? '' : 'google.maps.routing.v2'), createEmptyInstance: create)
    ..oo(0, [1, 2, 7])
    ..aOM<$482.Location>(1, _omitFieldNames ? '' : 'location', subBuilder: $482.Location.create)
  ...
  /// heading.
  @$pb.TagNumber(1)
  $482.Location get location => $_getN(0);
  @$pb.TagNumber(1)
  set location($482.Location v) { setField(1, v); }
  @$pb.TagNumber(1)
  $core.bool hasLocation() => $_has(0);
  @$pb.TagNumber(1)
  void clearLocation() => clearField(1);
  @$pb.TagNumber(1)
  $482.Location ensureLocation() => $_ensure(0);
