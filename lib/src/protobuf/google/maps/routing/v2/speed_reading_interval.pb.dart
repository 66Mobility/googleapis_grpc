...
enum SpeedReadingInterval_SpeedType {
  speed, 
  notSet
}
...
class SpeedReadingInterval extends $pb.GeneratedMessage {
  ...
  static const $core.Map<$core.int, SpeedReadingInterval_SpeedType> _SpeedReadingInterval_SpeedTypeByTag = {
    3 : SpeedReadingInterval_SpeedType.speed,
    0 : SpeedReadingInterval_SpeedType.notSet
  };
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(_omitMessageNames ? '' : 'SpeedReadingInterval', package: const $pb.PackageName(_omitMessageNames ? '' : 'google.maps.routing.v2'), createEmptyInstance: create)
    ..oo(0, [3])
  ...
  SpeedReadingInterval_SpeedType whichSpeedType() => _SpeedReadingInterval_SpeedTypeByTag[$_whichOneof(0)]!;
