...
class Maneuver extends $pb.ProtobufEnum {
  ...
  static const Maneuver TURN_SHARP_LEFT = Maneuver._(2, _omitEnumNames ? '' : 'TURN_SHARP_LEFT');
  static const Maneuver UTURN_LEFT = Maneuver._(3, _omitEnumNames ? '' : 'UTURN_LEFT');
  static const Maneuver TURN_LEFT = Maneuver._(4, _omitEnumNames ? '' : 'TURN_LEFT');
  static const Maneuver TURN_SLIGHT_RIGHT = Maneuver._(5, _omitEnumNames ? '' : 'TURN_SLIGHT_RIGHT');
  static const Maneuver TURN_SHARP_RIGHT = Maneuver._(6, _omitEnumNames ? '' : 'TURN_SHARP_RIGHT');
  static const Maneuver UTURN_RIGHT = Maneuver._(7, _omitEnumNames ? '' : 'UTURN_RIGHT');
  static const Maneuver TURN_RIGHT = Maneuver._(8, _omitEnumNames ? '' : 'TURN_RIGHT');
  static const Maneuver STRAIGHT = Maneuver._(9, _omitEnumNames ? '' : 'STRAIGHT');
  static const Maneuver RAMP_LEFT = Maneuver._(10, _omitEnumNames ? '' : 'RAMP_LEFT');
  static const Maneuver RAMP_RIGHT = Maneuver._(11, _omitEnumNames ? '' : 'RAMP_RIGHT');
  static const Maneuver MERGE = Maneuver._(12, _omitEnumNames ? '' : 'MERGE');
  static const Maneuver FORK_LEFT = Maneuver._(13, _omitEnumNames ? '' : 'FORK_LEFT');
  static const Maneuver FORK_RIGHT = Maneuver._(14, _omitEnumNames ? '' : 'FORK_RIGHT');
