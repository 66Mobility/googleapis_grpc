...
class DeliveryRequestHeader extends $pb.GeneratedMessage {
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(_omitMessageNames ? '' : 'DeliveryRequestHeader', package: const $pb.PackageName(_omitMessageNames ? '' : 'maps.fleetengine.delivery.v1'), createEmptyInstance: create)
    ...
    ..e<DeliveryRequestHeader_SdkType>(6, _omitFieldNames ? '' : 'sdkType', $pb.PbFieldType.OE, defaultOrMaker: DeliveryRequestHeader_SdkType.SDK_TYPE_UNSPECIFIED, valueOf: DeliveryRequestHeader_SdkType.valueOf, enumValues: DeliveryRequestHeader_SdkType.values)
    ..aOS(7, _omitFieldNames ? '' : 'mapsSdkVersion')
    ..aOS(8, _omitFieldNames ? '' : 'navSdkVersion')
    ..e<DeliveryRequestHeader_Platform>(9, _omitFieldNames ? '' : 'platform', $pb.PbFieldType.OE, defaultOrMaker: DeliveryRequestHeader_Platform.PLATFORM_UNSPECIFIED, valueOf: DeliveryRequestHeader_Platform.valueOf, enumValues: DeliveryRequestHeader_Platform.values)
  ...
  'Will be removed in next major version')
  DeliveryRequestHeader copyWith(void Function(DeliveryRequestHeader) updates) => super.copyWith((message) => updates(message as DeliveryRequestHeader)) as DeliveryRequestHeader;
