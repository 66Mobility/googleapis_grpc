...
class TripServiceClient extends $grpc.Client {
  static final _$createTrip =
      $grpc.ClientMethod<$164.CreateTripRequest, $165.Trip>(
  ...
  static final _$reportBillableTrip =
      $grpc.ClientMethod<$164.ReportBillableTripRequest, $3.Empty>(
  ...
  static final _$searchTrips =
      $grpc.ClientMethod<$164.SearchTripsRequest, $164.SearchTripsResponse>(
          '/maps.fleetengine.v1.TripService/SearchTrips',
          ($164.SearchTripsRequest value) => value.writeToBuffer(),
          ($core.List<$core.int> value) =>
              $164.SearchTripsResponse.fromBuffer(value));
  static final _$updateTrip =
      $grpc.ClientMethod<$164.UpdateTripRequest, $165.Trip>(
  ...
  $grpc.ResponseFuture<$165.Trip> createTrip($164.CreateTripRequest request,
      {$grpc.CallOptions? options}) {
    return $createUnaryCall(_$createTrip, request, options: options);
  }

  $grpc.ResponseFuture<$165.Trip> getTrip($164.GetTripRequest request,
      {$grpc.CallOptions? options}) {
    return $createUnaryCall(_$getTrip, request, options: options);
  }

  $grpc.ResponseFuture<$3.Empty> reportBillableTrip(
      $164.ReportBillableTripRequest request,
      {$grpc.CallOptions? options}) {
    return $createUnaryCall(_$reportBillableTrip, request, options: options);
  }

  $grpc.ResponseFuture<$164.SearchTripsResponse> searchTrips(
      $164.SearchTripsRequest request,
      {$grpc.CallOptions? options}) {
    return $createUnaryCall(_$searchTrips, request, options: options);
  }

  $grpc.ResponseFuture<$165.Trip> updateTrip($164.UpdateTripRequest request,
      {$grpc.CallOptions? options}) {
...
abstract class TripServiceBase extends $grpc.Service {
  ...
  TripServiceBase() {
    $addMethod($grpc.ServiceMethod<$164.CreateTripRequest, $165.Trip>(
        ...
        false,
        ($core.List<$core.int> value) =>
            $164.CreateTripRequest.fromBuffer(value),
    ...
    $addMethod($grpc.ServiceMethod<$164.ReportBillableTripRequest, $3.Empty>(
        ...
        false,
        ($core.List<$core.int> value) =>
            $164.ReportBillableTripRequest.fromBuffer(value),
        ($3.Empty value) => value.writeToBuffer()));
    $addMethod(
        $grpc.ServiceMethod<$164.SearchTripsRequest, $164.SearchTripsResponse>(
            'SearchTrips',
            searchTrips_Pre,
            false,
            false,
            ($core.List<$core.int> value) =>
                $164.SearchTripsRequest.fromBuffer(value),
    ...
    $addMethod($grpc.ServiceMethod<$164.UpdateTripRequest, $165.Trip>(
        ...
        false,
        ($core.List<$core.int> value) =>
            $164.UpdateTripRequest.fromBuffer(value),
        ($165.Trip value) => value.writeToBuffer()));
  }

  $async.Future<$165.Trip> createTrip_Pre($grpc.ServiceCall call,
      $async.Future<$164.CreateTripRequest> request) async {
    return createTrip(call, await request);
  }

  $async.Future<$165.Trip> getTrip_Pre($grpc.ServiceCall call,
      $async.Future<$164.GetTripRequest> request) async {
    return getTrip(call, await request);
  }

  $async.Future<$3.Empty> reportBillableTrip_Pre($grpc.ServiceCall call,
      $async.Future<$164.ReportBillableTripRequest> request) async {
    return reportBillableTrip(call, await request);
  }

  $async.Future<$164.SearchTripsResponse> searchTrips_Pre(
      $grpc.ServiceCall call,
      $async.Future<$164.SearchTripsRequest> request) async {
    return searchTrips(call, await request);
  }

  $async.Future<$165.Trip> updateTrip_Pre($grpc.ServiceCall call,
      $async.Future<$164.UpdateTripRequest> request) async {
    return updateTrip(call, await request);
  }

  $async.Future<$165.Trip> createTrip(
      $grpc.ServiceCall call, $164.CreateTripRequest request);
  $async.Future<$165.Trip> getTrip(
      $grpc.ServiceCall call, $164.GetTripRequest request);
  $async.Future<$3.Empty> reportBillableTrip(
      $grpc.ServiceCall call, $164.ReportBillableTripRequest request);
  $async.Future<$164.SearchTripsResponse> searchTrips(
      $grpc.ServiceCall call, $164.SearchTripsRequest request);
  $async.Future<$165.Trip> updateTrip(
      $grpc.ServiceCall call, $164.UpdateTripRequest request);
}
