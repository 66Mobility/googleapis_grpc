...
class SpeedReadingInterval extends $pb.GeneratedMessage {
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(_omitMessageNames ? '' : 'SpeedReadingInterval', package: const $pb.PackageName(_omitMessageNames ? '' : 'maps.fleetengine.v1'), createEmptyInstance: create)
...
class ConsumableTrafficPolyline extends $pb.GeneratedMessage {
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(_omitMessageNames ? '' : 'ConsumableTrafficPolyline', package: const $pb.PackageName(_omitMessageNames ? '' : 'maps.fleetengine.v1'), createEmptyInstance: create)
    ..pc<SpeedReadingInterval>(1, _omitFieldNames ? '' : 'speedReadingInterval', $pb.PbFieldType.PM, subBuilder: SpeedReadingInterval.create)
  ...
  'Use [GeneratedMessageGenericExtensions.rebuild] instead. '
  'Will be removed in next major version')
  ConsumableTrafficPolyline copyWith(void Function(ConsumableTrafficPolyline) updates) => super.copyWith((message) => updates(message as ConsumableTrafficPolyline)) as ConsumableTrafficPolyline;
