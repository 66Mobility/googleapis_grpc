...
class Insight extends $pb.ProtobufEnum {
  static const Insight INSIGHT_UNSPECIFIED = Insight._(0, _omitEnumNames ? '' : 'INSIGHT_UNSPECIFIED');
  static const Insight INSIGHT_COUNT = Insight._(1, _omitEnumNames ? '' : 'INSIGHT_COUNT');
  static const Insight INSIGHT_PLACES = Insight._(2, _omitEnumNames ? '' : 'INSIGHT_PLACES');
  ...
  static final $core.Map<$core.int, Insight> _byValue = $pb.ProtobufEnum.initByValue(values);
...
class OperatingStatus extends $pb.ProtobufEnum {
  static const OperatingStatus OPERATING_STATUS_UNSPECIFIED = OperatingStatus._(0, _omitEnumNames ? '' : 'OPERATING_STATUS_UNSPECIFIED');
  static const OperatingStatus OPERATING_STATUS_OPERATIONAL = OperatingStatus._(1, _omitEnumNames ? '' : 'OPERATING_STATUS_OPERATIONAL');
  static const OperatingStatus OPERATING_STATUS_PERMANENTLY_CLOSED = OperatingStatus._(3, _omitEnumNames ? '' : 'OPERATING_STATUS_PERMANENTLY_CLOSED');
  static const OperatingStatus OPERATING_STATUS_TEMPORARILY_CLOSED = OperatingStatus._(4, _omitEnumNames ? '' : 'OPERATING_STATUS_TEMPORARILY_CLOSED');
  ...
  static final $core.Map<$core.int, OperatingStatus> _byValue = $pb.ProtobufEnum.initByValue(values);
