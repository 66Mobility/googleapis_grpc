...
enum RegionIdentifier_Location {
  place, 
  unitCode, 
  notSet
}
...
class RegionIdentifier extends $pb.GeneratedMessage {
  ...
  factory RegionIdentifier.fromBuffer($core.List<$core.int> i, [$pb.ExtensionRegistry r = $pb.ExtensionRegistry.EMPTY]) => create()..mergeFromBuffer(i, r);
  factory RegionIdentifier.fromJson($core.String i, [$pb.ExtensionRegistry r = $pb.ExtensionRegistry.EMPTY]) => create()..mergeFromJson(i, r);

  static const $core.Map<$core.int, RegionIdentifier_Location> _RegionIdentifier_LocationByTag = {
    4 : RegionIdentifier_Location.place,
    5 : RegionIdentifier_Location.unitCode,
    0 : RegionIdentifier_Location.notSet
  };
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(_omitMessageNames ? '' : 'RegionIdentifier', package: const $pb.PackageName(_omitMessageNames ? '' : 'google.maps.regionlookup.v1alpha'), createEmptyInstance: create)
    ..oo(0, [4, 5])
    ..aOS(4, _omitFieldNames ? '' : 'place')
    ..aOS(5, _omitFieldNames ? '' : 'unitCode')
    ..e<RegionIdentifier_PlaceType>(6, _omitFieldNames ? '' : 'placeType', $pb.PbFieldType.OE, defaultOrMaker: RegionIdentifier_PlaceType.PLACE_TYPE_UNSPECIFIED, valueOf: RegionIdentifier_PlaceType.valueOf, enumValues: RegionIdentifier_PlaceType.values)
  ...
  'Will be removed in next major version')
  RegionIdentifier copyWith(void Function(RegionIdentifier) updates) => super.copyWith((message) => updates(message as RegionIdentifier)) as RegionIdentifier;
  ...
  static $pb.PbList<RegionIdentifier> createRepeated() => $pb.PbList<RegionIdentifier>();
  @$core.pragma('dart2js:noInline')
  static RegionIdentifier getDefault() => _defaultInstance ??= $pb.GeneratedMessage.$_defaultFor<RegionIdentifier>(create);
  static RegionIdentifier? _defaultInstance;

  RegionIdentifier_Location whichLocation() => _RegionIdentifier_LocationByTag[$_whichOneof(0)]!;
  ...
  @$pb.TagNumber(6)
  set placeType(RegionIdentifier_PlaceType v) { setField(6, v); }
  @$pb.TagNumber(6)
