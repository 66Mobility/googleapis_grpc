...
import 'region_identifier.pb.dart' as $511;
import 'region_match.pb.dart' as $512;
import 'region_search_values.pb.dart' as $513;
...
class LookupRegionRequest extends $pb.GeneratedMessage {
  factory LookupRegionRequest({
    $core.Iterable<$511.RegionIdentifier>? identifiers,
    $core.int? pageSize,
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(
    ...
    ..pc<$511.RegionIdentifier>(
        1, _omitFieldNames ? '' : 'identifiers', $pb.PbFieldType.PM,
        subBuilder: $511.RegionIdentifier.create)
  ...
  @$pb.TagNumber(1)
  $core.List<$511.RegionIdentifier> get identifiers => $_getList(0);
...
class LookupRegionResponse extends $pb.GeneratedMessage {
  factory LookupRegionResponse({
    $core.Iterable<$512.RegionMatch>? matches,
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(
    ...
    ..pc<$512.RegionMatch>(
        ...
        subBuilder: $512.RegionMatch.create)
  ...
  @$pb.TagNumber(1)
  $core.List<$512.RegionMatch> get matches => $_getList(0);
...
class SearchRegionRequest extends $pb.GeneratedMessage {
  factory SearchRegionRequest({
    $core.Iterable<$513.RegionSearchValue>? searchValues,
    $core.int? pageSize,
    $core.String? pageToken,
  }) {
    final $result = create();
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(
      ...
      package: const $pb.PackageName(
          _omitMessageNames ? '' : 'google.maps.regionlookup.v1alpha'),
      createEmptyInstance: create)
    ..pc<$513.RegionSearchValue>(
        1, _omitFieldNames ? '' : 'searchValues', $pb.PbFieldType.PM,
        subBuilder: $513.RegionSearchValue.create)
    ..a<$core.int>(2, _omitFieldNames ? '' : 'pageSize', $pb.PbFieldType.O3)
    ..aOS(3, _omitFieldNames ? '' : 'pageToken')
    ..hasRequiredFields = false;
  ...
  @$pb.TagNumber(1)
  $core.List<$513.RegionSearchValue> get searchValues => $_getList(0);
