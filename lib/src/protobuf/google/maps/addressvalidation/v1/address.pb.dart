...
class Address extends $pb.GeneratedMessage {
  factory Address({
    ...
    $445.PostalAddress? postalAddress,
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(_omitMessageNames ? '' : 'Address', package: const $pb.PackageName(_omitMessageNames ? '' : 'google.maps.addressvalidation.v1'), createEmptyInstance: create)
    ...
    ..aOM<$445.PostalAddress>(3, _omitFieldNames ? '' : 'postalAddress', subBuilder: $445.PostalAddress.create)
  ...
  @$pb.TagNumber(3)
  $445.PostalAddress get postalAddress => $_getN(1);
  @$pb.TagNumber(3)
  set postalAddress($445.PostalAddress v) { setField(3, v); }
  @$pb.TagNumber(3)
  $core.bool hasPostalAddress() => $_has(1);
  @$pb.TagNumber(3)
  void clearPostalAddress() => clearField(3);
  @$pb.TagNumber(3)
  $445.PostalAddress ensurePostalAddress() => $_ensure(1);
