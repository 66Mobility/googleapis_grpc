...
class AddressMetadata extends $pb.GeneratedMessage {
  ...
  factory AddressMetadata.fromBuffer($core.List<$core.int> i, [$pb.ExtensionRegistry r = $pb.ExtensionRegistry.EMPTY]) => create()..mergeFromBuffer(i, r);
  factory AddressMetadata.fromJson($core.String i, [$pb.ExtensionRegistry r = $pb.ExtensionRegistry.EMPTY]) => create()..mergeFromJson(i, r);

  static final $pb.BuilderInfo _i = $pb.BuilderInfo(_omitMessageNames ? '' : 'AddressMetadata', package: const $pb.PackageName(_omitMessageNames ? '' : 'google.maps.addressvalidation.v1'), createEmptyInstance: create)
  ...
  'Will be removed in next major version')
  AddressMetadata copyWith(void Function(AddressMetadata) updates) => super.copyWith((message) => updates(message as AddressMetadata)) as AddressMetadata;
  ...
  static $pb.PbList<AddressMetadata> createRepeated() => $pb.PbList<AddressMetadata>();
  @$core.pragma('dart2js:noInline')
  static AddressMetadata getDefault() => _defaultInstance ??= $pb.GeneratedMessage.$_defaultFor<AddressMetadata>(create);
  ...
  @$pb.TagNumber(2)
  set business($core.bool v) { $_setBool(0, v); }
  @$pb.TagNumber(2)
  ...
  @$pb.TagNumber(3)
  set poBox($core.bool v) { $_setBool(1, v); }
  @$pb.TagNumber(3)
  ...
  @$pb.TagNumber(6)
  set residential($core.bool v) { $_setBool(2, v); }
  @$pb.TagNumber(6)
