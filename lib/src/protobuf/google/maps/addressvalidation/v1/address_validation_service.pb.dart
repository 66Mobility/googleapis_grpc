...
import 'address.pb.dart' as $4794;
import 'address_validation_service.pbenum.dart';
import 'geocode.pb.dart' as $4795;
import 'metadata.pb.dart' as $4796;
import 'usps_data.pb.dart' as $4797;
...
class ValidationResult extends $pb.GeneratedMessage {
  factory ValidationResult({
    Verdict? verdict,
    $4794.Address? address,
    $4795.Geocode? geocode,
    $4796.AddressMetadata? metadata,
    $4797.UspsData? uspsData,
  }) {
    final $result = create();
    if (verdict != null) {
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(_omitMessageNames ? '' : 'ValidationResult', package: const $pb.PackageName(_omitMessageNames ? '' : 'google.maps.addressvalidation.v1'), createEmptyInstance: create)
    ...
    ..aOM<$4794.Address>(2, _omitFieldNames ? '' : 'address', subBuilder: $4794.Address.create)
    ..aOM<$4795.Geocode>(3, _omitFieldNames ? '' : 'geocode', subBuilder: $4795.Geocode.create)
    ..aOM<$4796.AddressMetadata>(4, _omitFieldNames ? '' : 'metadata', subBuilder: $4796.AddressMetadata.create)
    ..aOM<$4797.UspsData>(5, _omitFieldNames ? '' : 'uspsData', subBuilder: $4797.UspsData.create)
    ..hasRequiredFields = false
  ;
  ...
  @$pb.TagNumber(2)
  $4794.Address get address => $_getN(1);
  @$pb.TagNumber(2)
  set address($4794.Address v) { setField(2, v); }
  @$pb.TagNumber(2)
  $core.bool hasAddress() => $_has(1);
  @$pb.TagNumber(2)
  void clearAddress() => clearField(2);
  @$pb.TagNumber(2)
  $4794.Address ensureAddress() => $_ensure(1);

  /// Information about the location and place that the address geocoded to.
  @$pb.TagNumber(3)
  $4795.Geocode get geocode => $_getN(2);
  @$pb.TagNumber(3)
  set geocode($4795.Geocode v) { setField(3, v); }
  @$pb.TagNumber(3)
  $core.bool hasGeocode() => $_has(2);
  @$pb.TagNumber(3)
  void clearGeocode() => clearField(3);
  @$pb.TagNumber(3)
  $4795.Geocode ensureGeocode() => $_ensure(2);
  ...
  @$pb.TagNumber(4)
  $4796.AddressMetadata get metadata => $_getN(3);
  @$pb.TagNumber(4)
  set metadata($4796.AddressMetadata v) { setField(4, v); }
  @$pb.TagNumber(4)
  $core.bool hasMetadata() => $_has(3);
  @$pb.TagNumber(4)
  void clearMetadata() => clearField(4);
  @$pb.TagNumber(4)
  $4796.AddressMetadata ensureMetadata() => $_ensure(3);

  /// Extra deliverability flags provided by USPS. Only provided in region `US`
  /// and `PR`.
  @$pb.TagNumber(5)
  $4797.UspsData get uspsData => $_getN(4);
  @$pb.TagNumber(5)
  set uspsData($4797.UspsData v) { setField(5, v); }
  @$pb.TagNumber(5)
  $core.bool hasUspsData() => $_has(4);
  @$pb.TagNumber(5)
  void clearUspsData() => clearField(5);
  @$pb.TagNumber(5)
  $4797.UspsData ensureUspsData() => $_ensure(4);
}
