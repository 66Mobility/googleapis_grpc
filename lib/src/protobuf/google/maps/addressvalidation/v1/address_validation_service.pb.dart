...
import 'address.pb.dart' as $481;
import 'address_validation_service.pbenum.dart';
import 'geocode.pb.dart' as $482;
import 'metadata.pb.dart' as $483;
import 'usps_data.pb.dart' as $484;
...
class ValidateAddressRequest extends $pb.GeneratedMessage {
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(
    ...
    ..aOM<$479.PostalAddress>(1, _omitFieldNames ? '' : 'address',
  ...
  @$pb.TagNumber(1)
  $479.PostalAddress get address => $_getN(0);
  @$pb.TagNumber(1)
  ...
  @$pb.TagNumber(1)
  $479.PostalAddress ensureAddress() => $_ensure(0);
...
class ValidationResult extends $pb.GeneratedMessage {
  factory ValidationResult({
    ...
    $481.Address? address,
    $482.Geocode? geocode,
    $483.AddressMetadata? metadata,
    $484.UspsData? uspsData,
  }) {
    final $result = create();
    if (verdict != null) {
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(
    ...
    ..aOM<$481.Address>(2, _omitFieldNames ? '' : 'address',
        subBuilder: $481.Address.create)
    ..aOM<$482.Geocode>(3, _omitFieldNames ? '' : 'geocode',
        subBuilder: $482.Geocode.create)
    ..aOM<$483.AddressMetadata>(4, _omitFieldNames ? '' : 'metadata',
        subBuilder: $483.AddressMetadata.create)
    ..aOM<$484.UspsData>(5, _omitFieldNames ? '' : 'uspsData',
        subBuilder: $484.UspsData.create)
    ..hasRequiredFields = false;
  ...
  @$pb.TagNumber(2)
  $481.Address get address => $_getN(1);
  @$pb.TagNumber(2)
  set address($481.Address v) {
    setField(2, v);
  }
  ...
  @$pb.TagNumber(2)
  $481.Address ensureAddress() => $_ensure(1);

  /// Information about the location and place that the address geocoded to.
  @$pb.TagNumber(3)
  $482.Geocode get geocode => $_getN(2);
  @$pb.TagNumber(3)
  set geocode($482.Geocode v) {
    setField(3, v);
  }
  ...
  @$pb.TagNumber(3)
  $482.Geocode ensureGeocode() => $_ensure(2);
  ...
  @$pb.TagNumber(4)
  $483.AddressMetadata get metadata => $_getN(3);
  @$pb.TagNumber(4)
  set metadata($483.AddressMetadata v) {
    setField(4, v);
  }
  ...
  @$pb.TagNumber(4)
  $483.AddressMetadata ensureMetadata() => $_ensure(3);

  /// Extra deliverability flags provided by USPS. Only provided in region `US`
  /// and `PR`.
  @$pb.TagNumber(5)
  $484.UspsData get uspsData => $_getN(4);
  @$pb.TagNumber(5)
  set uspsData($484.UspsData v) {
    setField(5, v);
  }
  ...
  @$pb.TagNumber(5)
  $484.UspsData ensureUspsData() => $_ensure(4);
}
