...
class PlayableLocation extends $pb.GeneratedMessage {
  factory PlayableLocation({
    ...
    $353.LatLng? centerPoint,
    $353.LatLng? snappedPoint,
  }) {
    final $result = create();
    if (name != null) {
      $result.name = name;
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(
    ...
    ..aOM<$353.LatLng>(5, _omitFieldNames ? '' : 'centerPoint',
        subBuilder: $353.LatLng.create)
    ..aOM<$353.LatLng>(6, _omitFieldNames ? '' : 'snappedPoint',
        subBuilder: $353.LatLng.create)
  ...
  @$pb.TagNumber(5)
  $353.LatLng get centerPoint => $_getN(4);
  @$pb.TagNumber(5)
  set centerPoint($353.LatLng v) {
    setField(5, v);
  }
  ...
  @$pb.TagNumber(5)
  $353.LatLng ensureCenterPoint() => $_ensure(4);

  /// The playable location's coordinates, snapped to the sidewalk of the
  /// nearest road, if a nearby road exists.
  @$pb.TagNumber(6)
  $353.LatLng get snappedPoint => $_getN(5);
  @$pb.TagNumber(6)
  set snappedPoint($353.LatLng v) {
    setField(6, v);
  }
  ...
  @$pb.TagNumber(6)
  $353.LatLng ensureSnappedPoint() => $_ensure(5);
}
...
class Criterion extends $pb.GeneratedMessage {
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(
    ...
    ..aOM<$361.FieldMask>(3, _omitFieldNames ? '' : 'fieldsToReturn',
  ...
  @$pb.TagNumber(3)
  $361.FieldMask get fieldsToReturn => $_getN(2);
  @$pb.TagNumber(3)
  set fieldsToReturn($361.FieldMask v) {
    setField(3, v);
  }
  ...
  @$pb.TagNumber(3)
  $361.FieldMask ensureFieldsToReturn() => $_ensure(2);
}
