...
import '../../unity/clientinfo.pb.dart' as $510;
import 'resources.pb.dart' as $509;
import 'sample/resources.pb.dart' as $508;
...
class SamplePlayableLocationsRequest extends $pb.GeneratedMessage {
  factory SamplePlayableLocationsRequest({
    $508.AreaFilter? areaFilter,
    $core.Iterable<$508.Criterion>? criteria,
  }) {
    final $result = create();
    if (areaFilter != null) {
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(
    ...
    ..aOM<$508.AreaFilter>(1, _omitFieldNames ? '' : 'areaFilter',
        subBuilder: $508.AreaFilter.create)
    ..pc<$508.Criterion>(
        2, _omitFieldNames ? '' : 'criteria', $pb.PbFieldType.PM,
        subBuilder: $508.Criterion.create)
  ...
  @$pb.TagNumber(1)
  $508.AreaFilter get areaFilter => $_getN(0);
  @$pb.TagNumber(1)
  set areaFilter($508.AreaFilter v) {
    setField(1, v);
  }
...
class SamplePlayableLocationsResponse extends $pb.GeneratedMessage {
  factory SamplePlayableLocationsResponse({
    $core.Map<$core.int, $508.PlayableLocationList>? locationsPerGameObjectType,
    $292.Duration? ttl,
  }) {
    final $result = create();
  ...
  /// in the request.
  @$pb.TagNumber(1)
  $core.Map<$core.int, $508.PlayableLocationList>
...
class LogPlayerReportsRequest extends $pb.GeneratedMessage {
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(
    ...
    ..pc<$509.PlayerReport>(
        ...
        subBuilder: $509.PlayerReport.create)
    ..aOS(2, _omitFieldNames ? '' : 'requestId')
    ..aOM<$510.ClientInfo>(3, _omitFieldNames ? '' : 'clientInfo',
        subBuilder: $510.ClientInfo.create)
    ..hasRequiredFields = false;
  ...
  /// log at once is 50.
  @$pb.TagNumber(1)
  $core.List<$509.PlayerReport> get playerReports => $_getList(0);
  ...
  @$pb.TagNumber(3)
  $510.ClientInfo get clientInfo => $_getN(2);
  @$pb.TagNumber(3)
  set clientInfo($510.ClientInfo v) {
    setField(3, v);
  }
  ...
  @$pb.TagNumber(3)
  $510.ClientInfo ensureClientInfo() => $_ensure(2);
}
...
class LogImpressionsRequest extends $pb.GeneratedMessage {
  factory LogImpressionsRequest({
    $core.Iterable<$509.Impression>? impressions,
    $core.String? requestId,
    $510.ClientInfo? clientInfo,
  }) {
    final $result = create();
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(
    ...
    ..pc<$509.Impression>(
        ...
        subBuilder: $509.Impression.create)
    ..aOS(2, _omitFieldNames ? '' : 'requestId')
    ..aOM<$510.ClientInfo>(3, _omitFieldNames ? '' : 'clientInfo',
        subBuilder: $510.ClientInfo.create)
    ..hasRequiredFields = false;
  ...
  @$pb.TagNumber(1)
  $core.List<$509.Impression> get impressions => $_getList(0);
