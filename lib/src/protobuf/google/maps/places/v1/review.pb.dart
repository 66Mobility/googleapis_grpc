...
import 'attribution.pb.dart' as $492;
...
class Review extends $pb.GeneratedMessage {
  factory Review({
    ...
    $core.double? rating,
    $491.LocalizedText? text,
    $491.LocalizedText? originalText,
    $492.AuthorAttribution? authorAttribution,
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(
    ...
    ..aOM<$491.LocalizedText>(9, _omitFieldNames ? '' : 'text',
        subBuilder: $491.LocalizedText.create)
    ..aOM<$491.LocalizedText>(12, _omitFieldNames ? '' : 'originalText',
        subBuilder: $491.LocalizedText.create)
    ..aOM<$492.AuthorAttribution>(
        13, _omitFieldNames ? '' : 'authorAttribution',
        subBuilder: $492.AuthorAttribution.create)
    ..aOM<$330.Timestamp>(14, _omitFieldNames ? '' : 'publishTime',
  ...
  @$pb.TagNumber(9)
  $491.LocalizedText get text => $_getN(3);
  @$pb.TagNumber(9)
  set text($491.LocalizedText v) {
    setField(9, v);
  }
  ...
  @$pb.TagNumber(9)
  $491.LocalizedText ensureText() => $_ensure(3);

  /// The review text in its original language.
  @$pb.TagNumber(12)
  $491.LocalizedText get originalText => $_getN(4);
  @$pb.TagNumber(12)
  set originalText($491.LocalizedText v) {
    setField(12, v);
  }
  ...
  @$pb.TagNumber(12)
  $491.LocalizedText ensureOriginalText() => $_ensure(4);

  /// This review's author.
  @$pb.TagNumber(13)
  $492.AuthorAttribution get authorAttribution => $_getN(5);
  @$pb.TagNumber(13)
  set authorAttribution($492.AuthorAttribution v) {
    setField(13, v);
  }
  ...
  @$pb.TagNumber(13)
  $492.AuthorAttribution ensureAuthorAttribution() => $_ensure(5);

  /// Timestamp for the review.
  @$pb.TagNumber(14)
  $330.Timestamp get publishTime => $_getN(6);
  @$pb.TagNumber(14)
  ...
  @$pb.TagNumber(14)
  $330.Timestamp ensurePublishTime() => $_ensure(6);
}
