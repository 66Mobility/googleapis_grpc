...
import 'content_block.pb.dart' as $500;
import 'ev_charging.pb.dart' as $498;
import 'fuel_options.pb.dart' as $497;
import 'photo.pb.dart' as $495;
import 'place.pbenum.dart';
import 'price_range.pb.dart' as $499;
import 'reference.pb.dart' as $494;
import 'review.pb.dart' as $493;
...
class Place_OpeningHours_Period_Point extends $pb.GeneratedMessage {
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(
    ...
    ..aOM<$355.Date>(6, _omitFieldNames ? '' : 'date',
...
class Place_OpeningHours extends $pb.GeneratedMessage {
  factory Place_OpeningHours({
    ...
    $330.Timestamp? nextOpenTime,
    $330.Timestamp? nextCloseTime,
  }) {
    final $result = create();
    if (openNow != null) {
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(
    ...
    ..aOM<$330.Timestamp>(6, _omitFieldNames ? '' : 'nextOpenTime',
        subBuilder: $330.Timestamp.create)
    ..aOM<$330.Timestamp>(7, _omitFieldNames ? '' : 'nextCloseTime',
        subBuilder: $330.Timestamp.create)
    ..hasRequiredFields = false;
  ...
  @$pb.TagNumber(6)
  $330.Timestamp get nextOpenTime => $_getN(5);
  @$pb.TagNumber(6)
  set nextOpenTime($330.Timestamp v) {
    setField(6, v);
  }
  ...
  @$pb.TagNumber(6)
  $330.Timestamp ensureNextOpenTime() => $_ensure(5);
  ...
  /// active at the time of serving the request.
  @$pb.TagNumber(7)
  $330.Timestamp get nextCloseTime => $_getN(6);
  @$pb.TagNumber(7)
  set nextCloseTime($330.Timestamp v) {
    setField(7, v);
  }
  ...
  @$pb.TagNumber(7)
  $330.Timestamp ensureNextCloseTime() => $_ensure(6);
}
...
class Place_GenerativeSummary extends $pb.GeneratedMessage {
  factory Place_GenerativeSummary({
    $491.LocalizedText? overview,
    $491.LocalizedText? description,
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(
      ...
      package: const $pb.PackageName(
          _omitMessageNames ? '' : 'google.maps.places.v1'),
      createEmptyInstance: create)
    ..aOM<$491.LocalizedText>(1, _omitFieldNames ? '' : 'overview',
        subBuilder: $491.LocalizedText.create)
    ..aOM<$491.LocalizedText>(2, _omitFieldNames ? '' : 'description',
        subBuilder: $491.LocalizedText.create)
    ..aOM<$494.References>(3, _omitFieldNames ? '' : 'references',
        subBuilder: $494.References.create)
    ..hasRequiredFields = false;
  ...
  @$pb.TagNumber(1)
  $491.LocalizedText get overview => $_getN(0);
  @$pb.TagNumber(1)
  set overview($491.LocalizedText v) {
    setField(1, v);
  }
  ...
  @$pb.TagNumber(1)
  $491.LocalizedText ensureOverview() => $_ensure(0);

  /// The detailed description of the place.
  @$pb.TagNumber(2)
  $491.LocalizedText get description => $_getN(1);
  @$pb.TagNumber(2)
  set description($491.LocalizedText v) {
    setField(2, v);
  }
  ...
  @$pb.TagNumber(2)
  $491.LocalizedText ensureDescription() => $_ensure(1);

  /// References that are used to generate the summary description.
  @$pb.TagNumber(3)
  $494.References get references => $_getN(2);
  @$pb.TagNumber(3)
  set references($494.References v) {
    setField(3, v);
  }
  ...
  @$pb.TagNumber(3)
  $494.References ensureReferences() => $_ensure(2);
}
...
class Place_AreaSummary extends $pb.GeneratedMessage {
  factory Place_AreaSummary({
    $core.Iterable<$500.ContentBlock>? contentBlocks,
  }) {
    final $result = create();
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(
    ...
    ..pc<$500.ContentBlock>(
        ...
        subBuilder: $500.ContentBlock.create)
    ..hasRequiredFields = false;
  ...
  @$pb.TagNumber(4)
  $core.List<$500.ContentBlock> get contentBlocks => $_getList(0);
}
...
class Place extends $pb.GeneratedMessage {
  factory Place({
    ...
    $491.LocalizedText? displayName,
    $491.LocalizedText? primaryTypeDisplayName,
    $core.bool? takeout,
    $core.bool? delivery,
    $core.bool? dineIn,
    ...
    $491.LocalizedText? editorialSummary,
    $core.Iterable<$493.Review>? reviews,
    $core.Iterable<$495.Photo>? photos,
    ...
    $497.FuelOptions? fuelOptions,
    $498.EVChargeOptions? evChargeOptions,
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(
    ...
    ..aOM<$353.LatLng>(12, _omitFieldNames ? '' : 'location',
        subBuilder: $353.LatLng.create)
    ..aOM<$480.Viewport>(13, _omitFieldNames ? '' : 'viewport',
    ...
    ..aOM<$491.LocalizedText>(31, _omitFieldNames ? '' : 'displayName',
        subBuilder: $491.LocalizedText.create)
    ..aOM<$491.LocalizedText>(
    ...
    ..aOM<$491.LocalizedText>(52, _omitFieldNames ? '' : 'editorialSummary',
        subBuilder: $491.LocalizedText.create)
    ..pc<$493.Review>(53, _omitFieldNames ? '' : 'reviews', $pb.PbFieldType.PM,
        subBuilder: $493.Review.create)
    ..pc<$495.Photo>(54, _omitFieldNames ? '' : 'photos', $pb.PbFieldType.PM,
        subBuilder: $495.Photo.create)
    ...
    ..aOM<$497.FuelOptions>(78, _omitFieldNames ? '' : 'fuelOptions',
        subBuilder: $497.FuelOptions.create)
    ..aOM<$498.EVChargeOptions>(79, _omitFieldNames ? '' : 'evChargeOptions',
        subBuilder: $498.EVChargeOptions.create)
    ...
    ..aOM<$499.PriceRange>(86, _omitFieldNames ? '' : 'priceRange',
        subBuilder: $499.PriceRange.create)
    ..hasRequiredFields = false;
  ...
  @$pb.TagNumber(12)
  $353.LatLng get location => $_getN(8);
  @$pb.TagNumber(12)
  ...
  @$pb.TagNumber(12)
  $353.LatLng ensureLocation() => $_ensure(8);
  ...
  /// the business.
  @$pb.TagNumber(13)
  $480.Viewport get viewport => $_getN(9);
  @$pb.TagNumber(13)
  ...
  @$pb.TagNumber(13)
  $480.Viewport ensureViewport() => $_ensure(9);
  ...
  @$pb.TagNumber(31)
  $491.LocalizedText get displayName => $_getN(22);
  @$pb.TagNumber(31)
  set displayName($491.LocalizedText v) {
    setField(31, v);
  }
  ...
  @$pb.TagNumber(31)
  $491.LocalizedText ensureDisplayName() => $_ensure(22);
  ...
  /// https://developers.google.com/maps/documentation/places/web-service/place-types
  @$pb.TagNumber(32)
  $491.LocalizedText get primaryTypeDisplayName => $_getN(23);
  @$pb.TagNumber(32)
  set primaryTypeDisplayName($491.LocalizedText v) {
    setField(32, v);
  }
  ...
  @$pb.TagNumber(32)
  $491.LocalizedText ensurePrimaryTypeDisplayName() => $_ensure(23);
  ...
  @$pb.TagNumber(52)
  $491.LocalizedText get editorialSummary => $_getN(41);
  @$pb.TagNumber(52)
  set editorialSummary($491.LocalizedText v) {
    setField(52, v);
  }
  ...
  @$pb.TagNumber(78)
  $497.FuelOptions get fuelOptions => $_getN(59);
  @$pb.TagNumber(78)
  set fuelOptions($497.FuelOptions v) {
    setField(78, v);
  }
  ...
  @$pb.TagNumber(78)
  $497.FuelOptions ensureFuelOptions() => $_ensure(59);

  /// Information of ev charging options.
  @$pb.TagNumber(79)
  $498.EVChargeOptions get evChargeOptions => $_getN(60);
  @$pb.TagNumber(79)
  set evChargeOptions($498.EVChargeOptions v) {
    setField(79, v);
  }
  ...
  @$pb.TagNumber(79)
  $498.EVChargeOptions ensureEvChargeOptions() => $_ensure(60);
  ...
  @$pb.TagNumber(86)
  $499.PriceRange get priceRange => $_getN(65);
  @$pb.TagNumber(86)
  set priceRange($499.PriceRange v) {
    setField(86, v);
  }
  ...
  @$pb.TagNumber(86)
  $499.PriceRange ensurePriceRange() => $_ensure(65);
}
