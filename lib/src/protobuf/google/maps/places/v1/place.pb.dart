...
import 'content_block.pb.dart' as $4811;
import 'ev_charging.pb.dart' as $4810;
import 'fuel_options.pb.dart' as $4809;
import 'photo.pb.dart' as $4808;
import 'place.pbenum.dart';
import 'reference.pb.dart' as $4807;
...
class Place_OpeningHours_Period_Point extends $pb.GeneratedMessage {
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(_omitMessageNames ? '' : 'Place.OpeningHours.Period.Point', package: const $pb.PackageName(_omitMessageNames ? '' : 'google.maps.places.v1'), createEmptyInstance: create)
    ...
    ..aOM<$1800.Date>(6, _omitFieldNames ? '' : 'date', subBuilder: $1800.Date.create)
    ..hasRequiredFields = false
  ;
  ...
  @$pb.TagNumber(6)
  $1800.Date get date => $_getN(4);
  @$pb.TagNumber(6)
  set date($1800.Date v) { setField(6, v); }
  @$pb.TagNumber(6)
  $core.bool hasDate() => $_has(4);
  @$pb.TagNumber(6)
  void clearDate() => clearField(6);
  @$pb.TagNumber(6)
  $1800.Date ensureDate() => $_ensure(4);
}
...
class Place_GenerativeSummary extends $pb.GeneratedMessage {
  factory Place_GenerativeSummary({
    $4804.LocalizedText? overview,
    $4804.LocalizedText? description,
    $4807.References? references,
  }) {
    final $result = create();
    if (overview != null) {
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(_omitMessageNames ? '' : 'Place.GenerativeSummary', package: const $pb.PackageName(_omitMessageNames ? '' : 'google.maps.places.v1'), createEmptyInstance: create)
    ..aOM<$4804.LocalizedText>(1, _omitFieldNames ? '' : 'overview', subBuilder: $4804.LocalizedText.create)
    ..aOM<$4804.LocalizedText>(2, _omitFieldNames ? '' : 'description', subBuilder: $4804.LocalizedText.create)
    ..aOM<$4807.References>(3, _omitFieldNames ? '' : 'references', subBuilder: $4807.References.create)
    ..hasRequiredFields = false
  ;
  ...
  @$pb.TagNumber(1)
  $4804.LocalizedText get overview => $_getN(0);
  @$pb.TagNumber(1)
  set overview($4804.LocalizedText v) { setField(1, v); }
  @$pb.TagNumber(1)
  $core.bool hasOverview() => $_has(0);
  @$pb.TagNumber(1)
  void clearOverview() => clearField(1);
  @$pb.TagNumber(1)
  $4804.LocalizedText ensureOverview() => $_ensure(0);

  /// The detailed description of the place.
  @$pb.TagNumber(2)
  $4804.LocalizedText get description => $_getN(1);
  @$pb.TagNumber(2)
  set description($4804.LocalizedText v) { setField(2, v); }
  @$pb.TagNumber(2)
  $core.bool hasDescription() => $_has(1);
  @$pb.TagNumber(2)
  void clearDescription() => clearField(2);
  @$pb.TagNumber(2)
  $4804.LocalizedText ensureDescription() => $_ensure(1);

  /// References that are used to generate the summary description.
  @$pb.TagNumber(3)
  $4807.References get references => $_getN(2);
  @$pb.TagNumber(3)
  set references($4807.References v) { setField(3, v); }
  @$pb.TagNumber(3)
  $core.bool hasReferences() => $_has(2);
  @$pb.TagNumber(3)
  void clearReferences() => clearField(3);
  @$pb.TagNumber(3)
  $4807.References ensureReferences() => $_ensure(2);
}
...
class Place_AreaSummary extends $pb.GeneratedMessage {
  factory Place_AreaSummary({
    $core.Iterable<$4811.ContentBlock>? contentBlocks,
  }) {
    final $result = create();
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(_omitMessageNames ? '' : 'Place.AreaSummary', package: const $pb.PackageName(_omitMessageNames ? '' : 'google.maps.places.v1'), createEmptyInstance: create)
    ..pc<$4811.ContentBlock>(4, _omitFieldNames ? '' : 'contentBlocks', $pb.PbFieldType.PM, subBuilder: $4811.ContentBlock.create)
    ..hasRequiredFields = false
  ;
  ...
  @$pb.TagNumber(4)
  $core.List<$4811.ContentBlock> get contentBlocks => $_getList(0);
}
...
class Place extends $pb.GeneratedMessage {
  factory Place({
    ...
    $4804.LocalizedText? displayName,
    $4804.LocalizedText? primaryTypeDisplayName,
    $core.bool? takeout,
    $core.bool? delivery,
    $core.bool? dineIn,
    ...
    $4804.LocalizedText? editorialSummary,
    ...
    $4809.FuelOptions? fuelOptions,
    $4810.EVChargeOptions? evChargeOptions,
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(_omitMessageNames ? '' : 'Place', package: const $pb.PackageName(_omitMessageNames ? '' : 'google.maps.places.v1'), createEmptyInstance: create)
    ...
    ..aOM<$1798.LatLng>(12, _omitFieldNames ? '' : 'location', subBuilder: $1798.LatLng.create)
    ..aOM<$4793.Viewport>(13, _omitFieldNames ? '' : 'viewport', subBuilder: $4793.Viewport.create)
    ...
    ..aOM<$4804.LocalizedText>(31, _omitFieldNames ? '' : 'displayName', subBuilder: $4804.LocalizedText.create)
    ..aOM<$4804.LocalizedText>(32, _omitFieldNames ? '' : 'primaryTypeDisplayName', subBuilder: $4804.LocalizedText.create)
    ...
    ..aOM<$4804.LocalizedText>(52, _omitFieldNames ? '' : 'editorialSummary', subBuilder: $4804.LocalizedText.create)
    ..pc<$4806.Review>(53, _omitFieldNames ? '' : 'reviews', $pb.PbFieldType.PM, subBuilder: $4806.Review.create)
    ..pc<$4808.Photo>(54, _omitFieldNames ? '' : 'photos', $pb.PbFieldType.PM, subBuilder: $4808.Photo.create)
    ...
    ..aOM<$4809.FuelOptions>(78, _omitFieldNames ? '' : 'fuelOptions', subBuilder: $4809.FuelOptions.create)
    ..aOM<$4810.EVChargeOptions>(79, _omitFieldNames ? '' : 'evChargeOptions', subBuilder: $4810.EVChargeOptions.create)
  ...
  @$pb.TagNumber(12)
  $1798.LatLng get location => $_getN(8);
  @$pb.TagNumber(12)
  set location($1798.LatLng v) { setField(12, v); }
  @$pb.TagNumber(12)
  $core.bool hasLocation() => $_has(8);
  @$pb.TagNumber(12)
  void clearLocation() => clearField(12);
  @$pb.TagNumber(12)
  $1798.LatLng ensureLocation() => $_ensure(8);

  /// A viewport suitable for displaying the place on an average-sized map.
  @$pb.TagNumber(13)
  $4793.Viewport get viewport => $_getN(9);
  @$pb.TagNumber(13)
  set viewport($4793.Viewport v) { setField(13, v); }
  @$pb.TagNumber(13)
  $core.bool hasViewport() => $_has(9);
  @$pb.TagNumber(13)
  void clearViewport() => clearField(13);
  @$pb.TagNumber(13)
  $4793.Viewport ensureViewport() => $_ensure(9);
  ...
  @$pb.TagNumber(31)
  $4804.LocalizedText get displayName => $_getN(22);
  @$pb.TagNumber(31)
  set displayName($4804.LocalizedText v) { setField(31, v); }
  @$pb.TagNumber(31)
  $core.bool hasDisplayName() => $_has(22);
  @$pb.TagNumber(31)
  void clearDisplayName() => clearField(31);
  @$pb.TagNumber(31)
  $4804.LocalizedText ensureDisplayName() => $_ensure(22);
  ...
  /// https://developers.google.com/maps/documentation/places/web-service/place-types
  @$pb.TagNumber(32)
  $4804.LocalizedText get primaryTypeDisplayName => $_getN(23);
  @$pb.TagNumber(32)
  set primaryTypeDisplayName($4804.LocalizedText v) { setField(32, v); }
  @$pb.TagNumber(32)
  $core.bool hasPrimaryTypeDisplayName() => $_has(23);
  @$pb.TagNumber(32)
  void clearPrimaryTypeDisplayName() => clearField(32);
  @$pb.TagNumber(32)
  $4804.LocalizedText ensurePrimaryTypeDisplayName() => $_ensure(23);
  ...
  @$pb.TagNumber(78)
  $4809.FuelOptions get fuelOptions => $_getN(59);
  @$pb.TagNumber(78)
  set fuelOptions($4809.FuelOptions v) { setField(78, v); }
  @$pb.TagNumber(78)
  $core.bool hasFuelOptions() => $_has(59);
  @$pb.TagNumber(78)
  void clearFuelOptions() => clearField(78);
  @$pb.TagNumber(78)
  $4809.FuelOptions ensureFuelOptions() => $_ensure(59);

  /// Information of ev charging options.
  @$pb.TagNumber(79)
  $4810.EVChargeOptions get evChargeOptions => $_getN(60);
  @$pb.TagNumber(79)
  set evChargeOptions($4810.EVChargeOptions v) { setField(79, v); }
  @$pb.TagNumber(79)
  $core.bool hasEvChargeOptions() => $_has(60);
  @$pb.TagNumber(79)
  void clearEvChargeOptions() => clearField(79);
  @$pb.TagNumber(79)
  $4810.EVChargeOptions ensureEvChargeOptions() => $_ensure(60);
