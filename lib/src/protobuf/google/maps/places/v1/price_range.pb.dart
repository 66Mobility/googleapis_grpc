...
class PriceRange extends $pb.GeneratedMessage {
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(
    ...
    ..aOM<$496.Money>(1, _omitFieldNames ? '' : 'startPrice',
        subBuilder: $496.Money.create)
    ..aOM<$496.Money>(2, _omitFieldNames ? '' : 'endPrice',
        subBuilder: $496.Money.create)
  ...
  /// this amount.
  @$pb.TagNumber(1)
  $496.Money get startPrice => $_getN(0);
  @$pb.TagNumber(1)
  set startPrice($496.Money v) {
    setField(1, v);
  }
  ...
  @$pb.TagNumber(1)
  $496.Money ensureStartPrice() => $_ensure(0);

  /// The high end of the price range (exclusive). Price should be lower than
  /// this amount.
  @$pb.TagNumber(2)
  $496.Money get endPrice => $_getN(1);
  @$pb.TagNumber(2)
  set endPrice($496.Money v) {
    setField(2, v);
  }
  ...
  @$pb.TagNumber(2)
  $496.Money ensureEndPrice() => $_ensure(1);
}
