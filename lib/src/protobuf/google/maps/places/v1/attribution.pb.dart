...
class AuthorAttribution extends $pb.GeneratedMessage {
  ...
  factory AuthorAttribution.fromBuffer($core.List<$core.int> i, [$pb.ExtensionRegistry r = $pb.ExtensionRegistry.EMPTY]) => create()..mergeFromBuffer(i, r);
  factory AuthorAttribution.fromJson($core.String i, [$pb.ExtensionRegistry r = $pb.ExtensionRegistry.EMPTY]) => create()..mergeFromJson(i, r);

  static final $pb.BuilderInfo _i = $pb.BuilderInfo(_omitMessageNames ? '' : 'AuthorAttribution', package: const $pb.PackageName(_omitMessageNames ? '' : 'google.maps.places.v1'), createEmptyInstance: create)
  ...
  'Will be removed in next major version')
  AuthorAttribution copyWith(void Function(AuthorAttribution) updates) => super.copyWith((message) => updates(message as AuthorAttribution)) as AuthorAttribution;
  ...
  static $pb.PbList<AuthorAttribution> createRepeated() => $pb.PbList<AuthorAttribution>();
  @$core.pragma('dart2js:noInline')
  static AuthorAttribution getDefault() => _defaultInstance ??= $pb.GeneratedMessage.$_defaultFor<AuthorAttribution>(create);
  ...
  @$pb.TagNumber(3)
  set photoUri($core.String v) { $_setString(2, v); }
  @$pb.TagNumber(3)
