...
class ContextualContent_Justification_ReviewJustification
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(
    ...
    ..aOM<ContextualContent_Justification_ReviewJustification_HighlightedText>(
        ...
        subBuilder:
            ContextualContent_Justification_ReviewJustification_HighlightedText
                .create)
    ..aOM<$493.Review>(2, _omitFieldNames ? '' : 'review',
  ...
  @$pb.TagNumber(2)
  $493.Review get review => $_getN(1);
  @$pb.TagNumber(2)
  set review($493.Review v) {
    setField(2, v);
  }
  ...
  @$pb.TagNumber(2)
  $493.Review ensureReview() => $_ensure(1);
}
...
class ContextualContent extends $pb.GeneratedMessage {
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(
      ...
      package: const $pb.PackageName(
          _omitMessageNames ? '' : 'google.maps.places.v1'),
      createEmptyInstance: create)
    ..pc<$493.Review>(1, _omitFieldNames ? '' : 'reviews', $pb.PbFieldType.PM,
        subBuilder: $493.Review.create)
    ..pc<$495.Photo>(2, _omitFieldNames ? '' : 'photos', $pb.PbFieldType.PM,
  ...
  @$pb.TagNumber(1)
  $core.List<$493.Review> get reviews => $_getList(0);

  /// Information (including references) about photos of this place, contexual to
  /// the place query.
  @$pb.TagNumber(2)
  $core.List<$495.Photo> get photos => $_getList(1);
