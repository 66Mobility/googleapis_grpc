...
class RoutingSummary_Leg extends $pb.GeneratedMessage {
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(_omitMessageNames ? '' : 'RoutingSummary.Leg', package: const $pb.PackageName(_omitMessageNames ? '' : 'google.maps.places.v1'), createEmptyInstance: create)
    ..aOM<$261.Duration>(1, _omitFieldNames ? '' : 'duration', subBuilder: $261.Duration.create)
  ...
  @$pb.TagNumber(1)
  $261.Duration get duration => $_getN(0);
  @$pb.TagNumber(1)
  set duration($261.Duration v) { setField(1, v); }
  @$pb.TagNumber(1)
  $core.bool hasDuration() => $_has(0);
  @$pb.TagNumber(1)
  void clearDuration() => clearField(1);
  @$pb.TagNumber(1)
  $261.Duration ensureDuration() => $_ensure(0);
