...
class Photo extends $pb.GeneratedMessage {
  factory Photo({
    ...
    $core.int? widthPx,
    $core.int? heightPx,
    $core.Iterable<$458.AuthorAttribution>? authorAttributions,
  }) {
    final $result = create();
    if (name != null) {
      $result.name = name;
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(_omitMessageNames ? '' : 'Photo', package: const $pb.PackageName(_omitMessageNames ? '' : 'google.maps.places.v1'), createEmptyInstance: create)
    ...
    ..pc<$458.AuthorAttribution>(4, _omitFieldNames ? '' : 'authorAttributions', $pb.PbFieldType.PM, subBuilder: $458.AuthorAttribution.create)
  ...
  @$pb.TagNumber(4)
  $core.List<$458.AuthorAttribution> get authorAttributions => $_getList(3);
}
