...
class ClientInfo extends $pb.GeneratedMessage {
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(_omitMessageNames ? '' : 'ClientInfo', package: const $pb.PackageName(_omitMessageNames ? '' : 'google.maps.unity'), createEmptyInstance: create)
    ..aOS(1, _omitFieldNames ? '' : 'applicationId')
    ..aOS(2, _omitFieldNames ? '' : 'applicationVersion')
    ..e<ClientInfo_Platform>(3, _omitFieldNames ? '' : 'platform', $pb.PbFieldType.OE, defaultOrMaker: ClientInfo_Platform.PLATFORM_UNSPECIFIED, valueOf: ClientInfo_Platform.valueOf, enumValues: ClientInfo_Platform.values)
