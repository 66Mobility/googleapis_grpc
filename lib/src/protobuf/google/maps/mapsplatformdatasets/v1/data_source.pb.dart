...
class LocalFileSource extends $pb.GeneratedMessage {
  ...
  factory LocalFileSource.fromBuffer($core.List<$core.int> i, [$pb.ExtensionRegistry r = $pb.ExtensionRegistry.EMPTY]) => create()..mergeFromBuffer(i, r);
  factory LocalFileSource.fromJson($core.String i, [$pb.ExtensionRegistry r = $pb.ExtensionRegistry.EMPTY]) => create()..mergeFromJson(i, r);

  static final $pb.BuilderInfo _i = $pb.BuilderInfo(_omitMessageNames ? '' : 'LocalFileSource', package: const $pb.PackageName(_omitMessageNames ? '' : 'google.maps.mapsplatformdatasets.v1'), createEmptyInstance: create)
    ..aOS(1, _omitFieldNames ? '' : 'filename')
    ..e<FileFormat>(2, _omitFieldNames ? '' : 'fileFormat', $pb.PbFieldType.OE, defaultOrMaker: FileFormat.FILE_FORMAT_UNSPECIFIED, valueOf: FileFormat.valueOf, enumValues: FileFormat.values)
  ...
  'Will be removed in next major version')
  LocalFileSource copyWith(void Function(LocalFileSource) updates) => super.copyWith((message) => updates(message as LocalFileSource)) as LocalFileSource;
  ...
  static $pb.PbList<LocalFileSource> createRepeated() => $pb.PbList<LocalFileSource>();
  @$core.pragma('dart2js:noInline')
  static LocalFileSource getDefault() => _defaultInstance ??= $pb.GeneratedMessage.$_defaultFor<LocalFileSource>(create);
  ...
  @$pb.TagNumber(2)
  set fileFormat(FileFormat v) { setField(2, v); }
  @$pb.TagNumber(2)
...
class GcsSource extends $pb.GeneratedMessage {
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(_omitMessageNames ? '' : 'GcsSource', package: const $pb.PackageName(_omitMessageNames ? '' : 'google.maps.mapsplatformdatasets.v1'), createEmptyInstance: create)
