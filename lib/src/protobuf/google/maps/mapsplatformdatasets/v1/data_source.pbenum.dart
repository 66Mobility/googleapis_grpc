...
class FileFormat extends $pb.ProtobufEnum {
  ...
  static const FileFormat FILE_FORMAT_GEOJSON = FileFormat._(1, _omitEnumNames ? '' : 'FILE_FORMAT_GEOJSON');
  static const FileFormat FILE_FORMAT_KML = FileFormat._(2, _omitEnumNames ? '' : 'FILE_FORMAT_KML');
  static const FileFormat FILE_FORMAT_CSV = FileFormat._(3, _omitEnumNames ? '' : 'FILE_FORMAT_CSV');
