...
class RunPipelineArgs extends $pb.GeneratedMessage {
  factory RunPipelineArgs({
    ...
    $292.Duration? keepVmAliveOnFailureDuration,
  ...
  @$pb.TagNumber(8)
  $292.Duration get keepVmAliveOnFailureDuration => $_getN(7);
  @$pb.TagNumber(8)
  set keepVmAliveOnFailureDuration($292.Duration v) {
    setField(8, v);
  }
  ...
  @$pb.TagNumber(8)
  $292.Duration ensureKeepVmAliveOnFailureDuration() => $_ensure(7);
...
class SetOperationStatusRequest extends $pb.GeneratedMessage {
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(
    ...
    ..e<$436.Code>(3, _omitFieldNames ? '' : 'errorCode', $pb.PbFieldType.OE,
  ...
  @$pb.TagNumber(3)
  $436.Code get errorCode => $_getN(2);
  @$pb.TagNumber(3)
