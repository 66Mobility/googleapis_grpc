...
import 'range.pb.dart' as $471;
import 'readalignment.pb.dart' as $472;
...
class SearchReadGroupSetsResponse extends $pb.GeneratedMessage {
  factory SearchReadGroupSetsResponse({
    $core.Iterable<$154.ReadGroupSet>? readGroupSets,
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(
    ...
    ..pc<$154.ReadGroupSet>(
        ...
        subBuilder: $154.ReadGroupSet.create)
  ...
  @$pb.TagNumber(1)
  $core.List<$154.ReadGroupSet> get readGroupSets => $_getList(0);
...
class UpdateReadGroupSetRequest extends $pb.GeneratedMessage {
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(
    ...
    ..aOM<$154.ReadGroupSet>(2, _omitFieldNames ? '' : 'readGroupSet',
        subBuilder: $154.ReadGroupSet.create)
  ...
  /// fields.
  @$pb.TagNumber(2)
  $154.ReadGroupSet get readGroupSet => $_getN(1);
  @$pb.TagNumber(2)
  set readGroupSet($154.ReadGroupSet v) {
    setField(2, v);
  }
  ...
  @$pb.TagNumber(2)
  $154.ReadGroupSet ensureReadGroupSet() => $_ensure(1);
...
class CoverageBucket extends $pb.GeneratedMessage {
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(
      ...
      package:
          const $pb.PackageName(_omitMessageNames ? '' : 'google.genomics.v1'),
      createEmptyInstance: create)
    ..aOM<$471.Range>(1, _omitFieldNames ? '' : 'range',
        subBuilder: $471.Range.create)
    ..a<$core.double>(
  ...
  @$pb.TagNumber(1)
  $471.Range get range => $_getN(0);
  @$pb.TagNumber(1)
  set range($471.Range v) {
    setField(1, v);
  }
  ...
  @$pb.TagNumber(1)
  $471.Range ensureRange() => $_ensure(0);
...
class SearchReadsResponse extends $pb.GeneratedMessage {
  factory SearchReadsResponse({
    $core.Iterable<$472.Read>? alignments,
    $core.String? nextPageToken,
  }) {
    final $result = create();
    if (alignments != null) {
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(
      ...
      package:
          const $pb.PackageName(_omitMessageNames ? '' : 'google.genomics.v1'),
      createEmptyInstance: create)
    ..pc<$472.Read>(1, _omitFieldNames ? '' : 'alignments', $pb.PbFieldType.PM,
        subBuilder: $472.Read.create)
    ..aOS(2, _omitFieldNames ? '' : 'nextPageToken')
    ..hasRequiredFields = false;
  ...
  @$pb.TagNumber(1)
  $core.List<$472.Read> get alignments => $_getList(0);
