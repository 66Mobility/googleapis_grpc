...
class OperationMetadata extends $pb.GeneratedMessage {
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(_omitMessageNames ? '' : 'OperationMetadata', package: const $pb.PackageName(_omitMessageNames ? '' : 'google.genomics.v1'), createEmptyInstance: create)
    ...
    ..aOM<$318.Any>(5, _omitFieldNames ? '' : 'request', subBuilder: $318.Any.create)
    ...
    ..aOM<$318.Any>(8, _omitFieldNames ? '' : 'runtimeMetadata', subBuilder: $318.Any.create)
  ...
  @$pb.TagNumber(5)
  $318.Any get request => $_getN(4);
  @$pb.TagNumber(5)
  set request($318.Any v) { setField(5, v); }
  @$pb.TagNumber(5)
  $core.bool hasRequest() => $_has(4);
  @$pb.TagNumber(5)
  void clearRequest() => clearField(5);
  @$pb.TagNumber(5)
  $318.Any ensureRequest() => $_ensure(4);
  ...
  @$pb.TagNumber(8)
  $318.Any get runtimeMetadata => $_getN(7);
  @$pb.TagNumber(8)
  set runtimeMetadata($318.Any v) { setField(8, v); }
  @$pb.TagNumber(8)
  $core.bool hasRuntimeMetadata() => $_has(7);
  @$pb.TagNumber(8)
  void clearRuntimeMetadata() => clearField(8);
  @$pb.TagNumber(8)
  $318.Any ensureRuntimeMetadata() => $_ensure(7);
