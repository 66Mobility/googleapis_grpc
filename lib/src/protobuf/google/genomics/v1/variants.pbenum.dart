...
class InfoMergeOperation extends $pb.ProtobufEnum {
  static const InfoMergeOperation INFO_MERGE_OPERATION_UNSPECIFIED = InfoMergeOperation._(0, _omitEnumNames ? '' : 'INFO_MERGE_OPERATION_UNSPECIFIED');
  static const InfoMergeOperation IGNORE_NEW = InfoMergeOperation._(1, _omitEnumNames ? '' : 'IGNORE_NEW');
  static const InfoMergeOperation MOVE_TO_CALLS = InfoMergeOperation._(2, _omitEnumNames ? '' : 'MOVE_TO_CALLS');
...
class VariantSetMetadata_Type extends $pb.ProtobufEnum {
  static const VariantSetMetadata_Type TYPE_UNSPECIFIED = VariantSetMetadata_Type._(0, _omitEnumNames ? '' : 'TYPE_UNSPECIFIED');
  static const VariantSetMetadata_Type INTEGER = VariantSetMetadata_Type._(1, _omitEnumNames ? '' : 'INTEGER');
  static const VariantSetMetadata_Type FLOAT = VariantSetMetadata_Type._(2, _omitEnumNames ? '' : 'FLOAT');
  static const VariantSetMetadata_Type FLAG = VariantSetMetadata_Type._(3, _omitEnumNames ? '' : 'FLAG');
  static const VariantSetMetadata_Type CHARACTER = VariantSetMetadata_Type._(4, _omitEnumNames ? '' : 'CHARACTER');
  static const VariantSetMetadata_Type STRING = VariantSetMetadata_Type._(5, _omitEnumNames ? '' : 'STRING');
...
class ImportVariantsRequest_Format extends $pb.ProtobufEnum {
  static const ImportVariantsRequest_Format FORMAT_UNSPECIFIED = ImportVariantsRequest_Format._(0, _omitEnumNames ? '' : 'FORMAT_UNSPECIFIED');
  static const ImportVariantsRequest_Format FORMAT_VCF = ImportVariantsRequest_Format._(1, _omitEnumNames ? '' : 'FORMAT_VCF');
  static const ImportVariantsRequest_Format FORMAT_COMPLETE_GENOMICS = ImportVariantsRequest_Format._(2, _omitEnumNames ? '' : 'FORMAT_COMPLETE_GENOMICS');
...
class ExportVariantSetRequest_Format extends $pb.ProtobufEnum {
  static const ExportVariantSetRequest_Format FORMAT_UNSPECIFIED = ExportVariantSetRequest_Format._(0, _omitEnumNames ? '' : 'FORMAT_UNSPECIFIED');
  static const ExportVariantSetRequest_Format FORMAT_BIGQUERY = ExportVariantSetRequest_Format._(1, _omitEnumNames ? '' : 'FORMAT_BIGQUERY');
