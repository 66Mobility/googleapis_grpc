...
import 'readgroup.pb.dart' as $4786;
...
class ReadGroupSet extends $pb.GeneratedMessage {
  factory ReadGroupSet({
    ...
    $core.Iterable<$4786.ReadGroup>? readGroups,
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(_omitMessageNames ? '' : 'ReadGroupSet', package: const $pb.PackageName(_omitMessageNames ? '' : 'google.genomics.v1'), createEmptyInstance: create)
    ...
    ..pc<$4786.ReadGroup>(6, _omitFieldNames ? '' : 'readGroups', $pb.PbFieldType.PM, subBuilder: $4786.ReadGroup.create)
    ..m<$core.String, $1734.ListValue>(7, _omitFieldNames ? '' : 'info', entryClassName: 'ReadGroupSet.InfoEntry', keyFieldType: $pb.PbFieldType.OS, valueFieldType: $pb.PbFieldType.OM, valueCreator: $1734.ListValue.create, valueDefaultOrMaker: $1734.ListValue.getDefault, packageName: const $pb.PackageName('google.genomics.v1'))
  ...
  /// group set.
  @$pb.TagNumber(6)
  $core.List<$4786.ReadGroup> get readGroups => $_getList(5);
