...
class VariantSetMetadata extends $pb.GeneratedMessage {
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(_omitMessageNames ? '' : 'VariantSetMetadata', package: const $pb.PackageName(_omitMessageNames ? '' : 'google.genomics.v1'), createEmptyInstance: create)
    ...
    ..m<$core.String, $260.ListValue>(3, _omitFieldNames ? '' : 'info', entryClassName: 'VariantSetMetadata.InfoEntry', keyFieldType: $pb.PbFieldType.OS, valueFieldType: $pb.PbFieldType.OM, valueCreator: $260.ListValue.create, valueDefaultOrMaker: $260.ListValue.getDefault, packageName: const $pb.PackageName('google.genomics.v1'))
  ...
  @$pb.TagNumber(3)
  $core.Map<$core.String, $260.ListValue> get info => $_getMap(2);
...
class Variant extends $pb.GeneratedMessage {
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(_omitMessageNames ? '' : 'Variant', package: const $pb.PackageName(_omitMessageNames ? '' : 'google.genomics.v1'), createEmptyInstance: create)
    ...
    ..m<$core.String, $260.ListValue>(10, _omitFieldNames ? '' : 'info', entryClassName: 'Variant.InfoEntry', keyFieldType: $pb.PbFieldType.OS, valueFieldType: $pb.PbFieldType.OM, valueCreator: $260.ListValue.create, valueDefaultOrMaker: $260.ListValue.getDefault, packageName: const $pb.PackageName('google.genomics.v1'))
  ...
  /// map<string, string[]> (string key mapping to a list of string values).
  @$pb.TagNumber(10)
  $core.Map<$core.String, $260.ListValue> get info => $_getMap(6);
...
class VariantCall extends $pb.GeneratedMessage {
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(_omitMessageNames ? '' : 'VariantCall', package: const $pb.PackageName(_omitMessageNames ? '' : 'google.genomics.v1'), createEmptyInstance: create)
    ..m<$core.String, $260.ListValue>(2, _omitFieldNames ? '' : 'info', entryClassName: 'VariantCall.InfoEntry', keyFieldType: $pb.PbFieldType.OS, valueFieldType: $pb.PbFieldType.OM, valueCreator: $260.ListValue.create, valueDefaultOrMaker: $260.ListValue.getDefault, packageName: const $pb.PackageName('google.genomics.v1'))
  ...
  /// map<string, string[]> (string key mapping to a list of string values).
  @$pb.TagNumber(2)
  $core.Map<$core.String, $260.ListValue> get info => $_getMap(0);
...
class CallSet extends $pb.GeneratedMessage {
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(_omitMessageNames ? '' : 'CallSet', package: const $pb.PackageName(_omitMessageNames ? '' : 'google.genomics.v1'), createEmptyInstance: create)
    ...
    ..m<$core.String, $260.ListValue>(4, _omitFieldNames ? '' : 'info', entryClassName: 'CallSet.InfoEntry', keyFieldType: $pb.PbFieldType.OS, valueFieldType: $pb.PbFieldType.OM, valueCreator: $260.ListValue.create, valueDefaultOrMaker: $260.ListValue.getDefault, packageName: const $pb.PackageName('google.genomics.v1'))
