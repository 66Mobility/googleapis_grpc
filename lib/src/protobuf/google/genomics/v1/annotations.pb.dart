...
class Annotation extends $pb.GeneratedMessage {
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(
    ...
    ..m<$core.String, $289.ListValue>(12, _omitFieldNames ? '' : 'info',
  ...
  /// map<string, string[]> (string key mapping to a list of string values).
  @$pb.TagNumber(12)
  $core.Map<$core.String, $289.ListValue> get info => $_getMap(11);
}
...
class Transcript_Exon extends $pb.GeneratedMessage {
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(
    ...
    ..aOM<$335.Int32Value>(3, _omitFieldNames ? '' : 'frame',
  ...
  ///  coding exons.
  @$pb.TagNumber(3)
  $335.Int32Value get frame => $_getN(2);
  @$pb.TagNumber(3)
  set frame($335.Int32Value v) {
    setField(3, v);
  }
  ...
  @$pb.TagNumber(3)
  $335.Int32Value ensureFrame() => $_ensure(2);
}
