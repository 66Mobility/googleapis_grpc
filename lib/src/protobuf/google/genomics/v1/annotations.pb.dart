...
class AnnotationSet extends $pb.GeneratedMessage {
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(_omitMessageNames ? '' : 'AnnotationSet', package: const $pb.PackageName(_omitMessageNames ? '' : 'google.genomics.v1'), createEmptyInstance: create)
    ...
    ..m<$core.String, $258.ListValue>(17, _omitFieldNames ? '' : 'info', entryClassName: 'AnnotationSet.InfoEntry', keyFieldType: $pb.PbFieldType.OS, valueFieldType: $pb.PbFieldType.OM, valueCreator: $258.ListValue.create, valueDefaultOrMaker: $258.ListValue.getDefault, packageName: const $pb.PackageName('google.genomics.v1'))
...
class Annotation extends $pb.GeneratedMessage {
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(_omitMessageNames ? '' : 'Annotation', package: const $pb.PackageName(_omitMessageNames ? '' : 'google.genomics.v1'), createEmptyInstance: create)
    ...
    ..m<$core.String, $258.ListValue>(12, _omitFieldNames ? '' : 'info', entryClassName: 'Annotation.InfoEntry', keyFieldType: $pb.PbFieldType.OS, valueFieldType: $pb.PbFieldType.OM, valueCreator: $258.ListValue.create, valueDefaultOrMaker: $258.ListValue.getDefault, packageName: const $pb.PackageName('google.genomics.v1'))
    ..hasRequiredFields = false
  ;
  ...
  /// map<string, string[]> (string key mapping to a list of string values).
  @$pb.TagNumber(12)
  $core.Map<$core.String, $258.ListValue> get info => $_getMap(11);
}
...
class Transcript_Exon extends $pb.GeneratedMessage {
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(_omitMessageNames ? '' : 'Transcript.Exon', package: const $pb.PackageName(_omitMessageNames ? '' : 'google.genomics.v1'), createEmptyInstance: create)
    ...
    ..aOM<$304.Int32Value>(3, _omitFieldNames ? '' : 'frame', subBuilder: $304.Int32Value.create)
    ..hasRequiredFields = false
  ;
  ...
  ///  coding exons.
  @$pb.TagNumber(3)
  $304.Int32Value get frame => $_getN(2);
  @$pb.TagNumber(3)
  set frame($304.Int32Value v) { setField(3, v); }
  @$pb.TagNumber(3)
  $core.bool hasFrame() => $_has(2);
  @$pb.TagNumber(3)
  void clearFrame() => clearField(3);
  @$pb.TagNumber(3)
  $304.Int32Value ensureFrame() => $_ensure(2);
}
