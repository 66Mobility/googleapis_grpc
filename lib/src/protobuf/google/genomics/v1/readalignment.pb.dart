...
import 'cigar.pb.dart' as $437;
import 'position.pb.dart' as $436;
...
class LinearAlignment extends $pb.GeneratedMessage {
  factory LinearAlignment({
    ...
    $core.Iterable<$437.CigarUnit>? cigar,
  }) {
    final $result = create();
    if (position != null) {
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(_omitMessageNames ? '' : 'LinearAlignment', package: const $pb.PackageName(_omitMessageNames ? '' : 'google.genomics.v1'), createEmptyInstance: create)
    ..aOM<$436.Position>(1, _omitFieldNames ? '' : 'position', subBuilder: $436.Position.create)
    ..a<$core.int>(2, _omitFieldNames ? '' : 'mappingQuality', $pb.PbFieldType.O3)
    ..pc<$437.CigarUnit>(3, _omitFieldNames ? '' : 'cigar', $pb.PbFieldType.PM, subBuilder: $437.CigarUnit.create)
  ...
  @$pb.TagNumber(1)
  $436.Position get position => $_getN(0);
  @$pb.TagNumber(1)
  set position($436.Position v) { setField(1, v); }
  @$pb.TagNumber(1)
  $core.bool hasPosition() => $_has(0);
  @$pb.TagNumber(1)
  void clearPosition() => clearField(1);
  @$pb.TagNumber(1)
  $436.Position ensurePosition() => $_ensure(0);
  ...
  @$pb.TagNumber(3)
  $core.List<$437.CigarUnit> get cigar => $_getList(2);
}
...
class Read extends $pb.GeneratedMessage {
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(_omitMessageNames ? '' : 'Read', package: const $pb.PackageName(_omitMessageNames ? '' : 'google.genomics.v1'), createEmptyInstance: create)
    ...
    ..aOM<$436.Position>(16, _omitFieldNames ? '' : 'nextMatePosition', subBuilder: $436.Position.create)
    ..m<$core.String, $260.ListValue>(17, _omitFieldNames ? '' : 'info', entryClassName: 'Read.InfoEntry', keyFieldType: $pb.PbFieldType.OS, valueFieldType: $pb.PbFieldType.OM, valueCreator: $260.ListValue.create, valueDefaultOrMaker: $260.ListValue.getDefault, packageName: const $pb.PackageName('google.genomics.v1'))
    ..hasRequiredFields = false
  ;
  ...
  @$pb.TagNumber(16)
  $436.Position get nextMatePosition => $_getN(15);
  @$pb.TagNumber(16)
  set nextMatePosition($436.Position v) { setField(16, v); }
  @$pb.TagNumber(16)
  $core.bool hasNextMatePosition() => $_has(15);
  @$pb.TagNumber(16)
  void clearNextMatePosition() => clearField(16);
  @$pb.TagNumber(16)
  $436.Position ensureNextMatePosition() => $_ensure(15);

  /// A map of additional read alignment information. This must be of the form
  /// map<string, string[]> (string key mapping to a list of string values).
  @$pb.TagNumber(17)
  $core.Map<$core.String, $260.ListValue> get info => $_getMap(16);
}
