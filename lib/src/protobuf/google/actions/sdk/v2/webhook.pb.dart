...
class Webhook_Handler extends $pb.GeneratedMessage {
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(_omitMessageNames ? '' : 'Webhook.Handler', package: const $pb.PackageName(_omitMessageNames ? '' : 'google.actions.sdk.v2'), createEmptyInstance: create)
  ...
  'Will be removed in next major version')
  Webhook_Handler copyWith(void Function(Webhook_Handler) updates) => super.copyWith((message) => updates(message as Webhook_Handler)) as Webhook_Handler;
...
class Webhook_HttpsEndpoint extends $pb.GeneratedMessage {
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(_omitMessageNames ? '' : 'Webhook.HttpsEndpoint', package: const $pb.PackageName(_omitMessageNames ? '' : 'google.actions.sdk.v2'), createEmptyInstance: create)
    ..aOS(1, _omitFieldNames ? '' : 'baseUrl')
    ..m<$core.String, $core.String>(2, _omitFieldNames ? '' : 'httpHeaders', entryClassName: 'Webhook.HttpsEndpoint.HttpHeadersEntry', keyFieldType: $pb.PbFieldType.OS, valueFieldType: $pb.PbFieldType.OS, packageName: const $pb.PackageName('google.actions.sdk.v2'))
    ..a<$core.int>(3, _omitFieldNames ? '' : 'endpointApiVersion', $pb.PbFieldType.O3)
    ..hasRequiredFields = false
  ;
  ...
  'Use [GeneratedMessageGenericExtensions.rebuild] instead. '
  'Will be removed in next major version')
  Webhook_HttpsEndpoint copyWith(void Function(Webhook_HttpsEndpoint) updates) => super.copyWith((message) => updates(message as Webhook_HttpsEndpoint)) as Webhook_HttpsEndpoint;
...
class Webhook_InlineCloudFunction extends $pb.GeneratedMessage {
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(_omitMessageNames ? '' : 'Webhook.InlineCloudFunction', package: const $pb.PackageName(_omitMessageNames ? '' : 'google.actions.sdk.v2'), createEmptyInstance: create)
  ...
  'Use [GeneratedMessageGenericExtensions.rebuild] instead. '
  'Will be removed in next major version')
  Webhook_InlineCloudFunction copyWith(void Function(Webhook_InlineCloudFunction) updates) => super.copyWith((message) => updates(message as Webhook_InlineCloudFunction)) as Webhook_InlineCloudFunction;
...
class Webhook extends $pb.GeneratedMessage {
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(_omitMessageNames ? '' : 'Webhook', package: const $pb.PackageName(_omitMessageNames ? '' : 'google.actions.sdk.v2'), createEmptyInstance: create)
    ..oo(0, [2, 3])
    ..pc<Webhook_Handler>(1, _omitFieldNames ? '' : 'handlers', $pb.PbFieldType.PM, subBuilder: Webhook_Handler.create)
    ..aOM<Webhook_HttpsEndpoint>(2, _omitFieldNames ? '' : 'httpsEndpoint', subBuilder: Webhook_HttpsEndpoint.create)
    ..aOM<Webhook_InlineCloudFunction>(3, _omitFieldNames ? '' : 'inlineCloudFunction', subBuilder: Webhook_InlineCloudFunction.create)
    ..hasRequiredFields = false
  ;
