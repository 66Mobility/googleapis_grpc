...
import 'config_file.pb.dart' as $1773;
import 'data_file.pb.dart' as $1774;
...
class Files extends $pb.GeneratedMessage {
  factory Files({
    $1773.ConfigFiles? configFiles,
    $1774.DataFiles? dataFiles,
  }) {
    final $result = create();
    if (configFiles != null) {
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(_omitMessageNames ? '' : 'Files', package: const $pb.PackageName(_omitMessageNames ? '' : 'google.actions.sdk.v2'), createEmptyInstance: create)
    ..oo(0, [1, 2])
    ..aOM<$1773.ConfigFiles>(1, _omitFieldNames ? '' : 'configFiles', subBuilder: $1773.ConfigFiles.create)
    ..aOM<$1774.DataFiles>(2, _omitFieldNames ? '' : 'dataFiles', subBuilder: $1774.DataFiles.create)
  ...
  @$pb.TagNumber(1)
  $1773.ConfigFiles get configFiles => $_getN(0);
  @$pb.TagNumber(1)
  set configFiles($1773.ConfigFiles v) { setField(1, v); }
  @$pb.TagNumber(1)
  $core.bool hasConfigFiles() => $_has(0);
  @$pb.TagNumber(1)
  void clearConfigFiles() => clearField(1);
  @$pb.TagNumber(1)
  $1773.ConfigFiles ensureConfigFiles() => $_ensure(0);

  /// List of data files. This includes image, audio file, cloud function
  /// source code.
  @$pb.TagNumber(2)
  $1774.DataFiles get dataFiles => $_getN(1);
  @$pb.TagNumber(2)
  set dataFiles($1774.DataFiles v) { setField(2, v); }
  @$pb.TagNumber(2)
  $core.bool hasDataFiles() => $_has(1);
  @$pb.TagNumber(2)
  void clearDataFiles() => clearField(2);
  @$pb.TagNumber(2)
  $1774.DataFiles ensureDataFiles() => $_ensure(1);
}
