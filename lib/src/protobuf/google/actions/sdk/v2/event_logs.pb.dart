...
class ExecutionEvent extends $pb.GeneratedMessage {
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(_omitMessageNames ? '' : 'ExecutionEvent', package: const $pb.PackageName(_omitMessageNames ? '' : 'google.actions.sdk.v2'), createEmptyInstance: create)
    ...
    ..aOM<$302.Timestamp>(1, _omitFieldNames ? '' : 'eventTime', subBuilder: $302.Timestamp.create)
  ...
  @$pb.TagNumber(1)
  set eventTime($302.Timestamp v) { setField(1, v); }
  @$pb.TagNumber(1)
...
class ExecutionState extends $pb.GeneratedMessage {
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(_omitMessageNames ? '' : 'ExecutionState', package: const $pb.PackageName(_omitMessageNames ? '' : 'google.actions.sdk.v2'), createEmptyInstance: create)
    ...
    ..aOM<$261.Struct>(2, _omitFieldNames ? '' : 'sessionStorage', subBuilder: $261.Struct.create)
    ..aOM<Slots>(5, _omitFieldNames ? '' : 'slots', subBuilder: Slots.create)
    ..aOM<$261.Struct>(6, _omitFieldNames ? '' : 'userStorage', subBuilder: $261.Struct.create)
    ..pc<$320.Prompt>(7, _omitFieldNames ? '' : 'promptQueue', $pb.PbFieldType.PM, subBuilder: $320.Prompt.create)
    ..aOM<$261.Struct>(8, _omitFieldNames ? '' : 'householdStorage', subBuilder: $261.Struct.create)
    ..hasRequiredFields = false
  ;
  ...
  @$pb.TagNumber(2)
  set sessionStorage($261.Struct v) { setField(2, v); }
  @$pb.TagNumber(2)
  ...
  @$pb.TagNumber(6)
  set userStorage($261.Struct v) { setField(6, v); }
  @$pb.TagNumber(6)
  ...
  @$pb.TagNumber(8)
  set householdStorage($261.Struct v) { setField(8, v); }
  @$pb.TagNumber(8)
...
class Slots extends $pb.GeneratedMessage {
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(_omitMessageNames ? '' : 'Slots', package: const $pb.PackageName(_omitMessageNames ? '' : 'google.actions.sdk.v2'), createEmptyInstance: create)
    ..e<$323.SlotFillingStatus>(2, _omitFieldNames ? '' : 'status', $pb.PbFieldType.OE, defaultOrMaker: $323.SlotFillingStatus.UNSPECIFIED, valueOf: $323.SlotFillingStatus.valueOf, enumValues: $323.SlotFillingStatus.values)
    ..m<$core.String, $323.Slot>(3, _omitFieldNames ? '' : 'slots', entryClassName: 'Slots.SlotsEntry', keyFieldType: $pb.PbFieldType.OS, valueFieldType: $pb.PbFieldType.OM, valueCreator: $323.Slot.create, valueDefaultOrMaker: $323.Slot.getDefault, packageName: const $pb.PackageName('google.actions.sdk.v2'))
    ..hasRequiredFields = false
  ;
  ...
  @$pb.TagNumber(2)
  set status($323.SlotFillingStatus v) { setField(2, v); }
  @$pb.TagNumber(2)
...
class IntentMatch extends $pb.GeneratedMessage {
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(_omitMessageNames ? '' : 'IntentMatch', package: const $pb.PackageName(_omitMessageNames ? '' : 'google.actions.sdk.v2'), createEmptyInstance: create)
    ...
    ..m<$core.String, $324.IntentParameterValue>(5, _omitFieldNames ? '' : 'intentParameters', entryClassName: 'IntentMatch.IntentParametersEntry', keyFieldType: $pb.PbFieldType.OS, valueFieldType: $pb.PbFieldType.OM, valueCreator: $324.IntentParameterValue.create, valueDefaultOrMaker: $324.IntentParameterValue.getDefault, packageName: const $pb.PackageName('google.actions.sdk.v2'))
    ..hasRequiredFields = false
  ;
  ...
  @$pb.TagNumber(5)
  $core.Map<$core.String, $324.IntentParameterValue> get intentParameters => $_getMap(3);
}
...
class SlotMatch extends $pb.GeneratedMessage {
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(_omitMessageNames ? '' : 'SlotMatch', package: const $pb.PackageName(_omitMessageNames ? '' : 'google.actions.sdk.v2'), createEmptyInstance: create)
    ..m<$core.String, $324.IntentParameterValue>(2, _omitFieldNames ? '' : 'nluParameters', entryClassName: 'SlotMatch.NluParametersEntry', keyFieldType: $pb.PbFieldType.OS, valueFieldType: $pb.PbFieldType.OM, valueCreator: $324.IntentParameterValue.create, valueDefaultOrMaker: $324.IntentParameterValue.getDefault, packageName: const $pb.PackageName('google.actions.sdk.v2'))
    ..hasRequiredFields = false
  ;
  ...
  @$pb.TagNumber(2)
  $core.Map<$core.String, $324.IntentParameterValue> get nluParameters => $_getMap(0);
}
...
class SlotRequested extends $pb.GeneratedMessage {
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(_omitMessageNames ? '' : 'SlotRequested', package: const $pb.PackageName(_omitMessageNames ? '' : 'google.actions.sdk.v2'), createEmptyInstance: create)
    ...
    ..aOM<$320.Prompt>(3, _omitFieldNames ? '' : 'prompt', subBuilder: $320.Prompt.create)
    ..hasRequiredFields = false
  ;
  ...
  @$pb.TagNumber(3)
  set prompt($320.Prompt v) { setField(3, v); }
  @$pb.TagNumber(3)
