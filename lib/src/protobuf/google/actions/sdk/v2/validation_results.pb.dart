...
class ValidationResults extends $pb.GeneratedMessage {
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(_omitMessageNames ? '' : 'ValidationResults', package: const $pb.PackageName(_omitMessageNames ? '' : 'google.actions.sdk.v2'), createEmptyInstance: create)
    ..pc<ValidationResult>(1, _omitFieldNames ? '' : 'results', $pb.PbFieldType.PM, subBuilder: ValidationResult.create)
  ...
  'Will be removed in next major version')
  ValidationResults copyWith(void Function(ValidationResults) updates) => super.copyWith((message) => updates(message as ValidationResults)) as ValidationResults;
...
class ValidationResult_ValidationContext extends $pb.GeneratedMessage {
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(_omitMessageNames ? '' : 'ValidationResult.ValidationContext', package: const $pb.PackageName(_omitMessageNames ? '' : 'google.actions.sdk.v2'), createEmptyInstance: create)
  ...
  'Use [GeneratedMessageGenericExtensions.rebuild] instead. '
  'Will be removed in next major version')
  ValidationResult_ValidationContext copyWith(void Function(ValidationResult_ValidationContext) updates) => super.copyWith((message) => updates(message as ValidationResult_ValidationContext)) as ValidationResult_ValidationContext;
...
class ValidationResult extends $pb.GeneratedMessage {
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(_omitMessageNames ? '' : 'ValidationResult', package: const $pb.PackageName(_omitMessageNames ? '' : 'google.actions.sdk.v2'), createEmptyInstance: create)
    ..aOS(1, _omitFieldNames ? '' : 'validationMessage')
    ..aOM<ValidationResult_ValidationContext>(2, _omitFieldNames ? '' : 'validationContext', subBuilder: ValidationResult_ValidationContext.create)
    ..hasRequiredFields = false
  ;
