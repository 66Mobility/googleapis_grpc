...
import 'content/canvas.pb.dart' as $342;
import 'content/content.pb.dart' as $346;
import 'content/link.pb.dart' as $338;
import 'simple.pb.dart' as $345;
import 'suggestion.pb.dart' as $347;
...
class Prompt extends $pb.GeneratedMessage {
  factory Prompt({
    ...
    $345.Simple? firstSimple,
    $346.Content? content,
    $345.Simple? lastSimple,
    $core.Iterable<$347.Suggestion>? suggestions,
    $338.Link? link,
    $core.bool? override,
    $342.Canvas? canvas,
  }) {
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(
    ...
    ..aOM<$345.Simple>(2, _omitFieldNames ? '' : 'firstSimple',
        subBuilder: $345.Simple.create)
    ..aOM<$346.Content>(3, _omitFieldNames ? '' : 'content',
        subBuilder: $346.Content.create)
    ..aOM<$345.Simple>(4, _omitFieldNames ? '' : 'lastSimple',
        subBuilder: $345.Simple.create)
    ..pc<$347.Suggestion>(
        5, _omitFieldNames ? '' : 'suggestions', $pb.PbFieldType.PM,
        subBuilder: $347.Suggestion.create)
    ..aOM<$338.Link>(6, _omitFieldNames ? '' : 'link',
        subBuilder: $338.Link.create)
    ..aOB(8, _omitFieldNames ? '' : 'override')
    ..aOM<$342.Canvas>(9, _omitFieldNames ? '' : 'canvas',
  ...
  @$pb.TagNumber(2)
  $345.Simple get firstSimple => $_getN(1);
  @$pb.TagNumber(2)
  set firstSimple($345.Simple v) {
    setField(2, v);
  }
  ...
  @$pb.TagNumber(2)
  $345.Simple ensureFirstSimple() => $_ensure(1);

  /// Optional. A content like a card, list or media to display to the user.
  @$pb.TagNumber(3)
  $346.Content get content => $_getN(2);
  @$pb.TagNumber(3)
  set content($346.Content v) {
    setField(3, v);
  }
  ...
  @$pb.TagNumber(3)
  $346.Content ensureContent() => $_ensure(2);

  /// Optional. The last voice and text-only response.
  @$pb.TagNumber(4)
  $345.Simple get lastSimple => $_getN(3);
  @$pb.TagNumber(4)
  set lastSimple($345.Simple v) {
    setField(4, v);
  }
  ...
  @$pb.TagNumber(4)
  $345.Simple ensureLastSimple() => $_ensure(3);
  ...
  @$pb.TagNumber(5)
  $core.List<$347.Suggestion> get suggestions => $_getList(4);
  ...
  @$pb.TagNumber(9)
  $342.Canvas ensureCanvas() => $_ensure(7);
}
