...
import 'image.pbenum.dart' as $1783;
import 'link.pb.dart' as $1784;
...
class Card extends $pb.GeneratedMessage {
  factory Card({
    ...
    $core.String? text,
    $1783.Image? image,
    $1783.Image_ImageFill? imageFill,
    $1784.Link? button,
  }) {
    final $result = create();
    if (title != null) {
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(_omitMessageNames ? '' : 'Card', package: const $pb.PackageName(_omitMessageNames ? '' : 'google.actions.sdk.v2.conversation'), createEmptyInstance: create)
    ...
    ..aOM<$1783.Image>(4, _omitFieldNames ? '' : 'image', subBuilder: $1783.Image.create)
    ..e<$1783.Image_ImageFill>(5, _omitFieldNames ? '' : 'imageFill', $pb.PbFieldType.OE, defaultOrMaker: $1783.Image_ImageFill.UNSPECIFIED, valueOf: $1783.Image_ImageFill.valueOf, enumValues: $1783.Image_ImageFill.values)
    ..aOM<$1784.Link>(6, _omitFieldNames ? '' : 'button', subBuilder: $1784.Link.create)
  ...
  /// Optional.
  @$pb.TagNumber(4)
  $1783.Image get image => $_getN(3);
  @$pb.TagNumber(4)
  set image($1783.Image v) { setField(4, v); }
  @$pb.TagNumber(4)
  $core.bool hasImage() => $_has(3);
  @$pb.TagNumber(4)
  void clearImage() => clearField(4);
  @$pb.TagNumber(4)
  $1783.Image ensureImage() => $_ensure(3);

  /// How the image background will be filled. Optional.
  @$pb.TagNumber(5)
  $1783.Image_ImageFill get imageFill => $_getN(4);
  @$pb.TagNumber(5)
  set imageFill($1783.Image_ImageFill v) { setField(5, v); }
  @$pb.TagNumber(5)
  ...
  /// Optional.
  @$pb.TagNumber(6)
  $1784.Link get button => $_getN(5);
  @$pb.TagNumber(6)
  set button($1784.Link v) { setField(6, v); }
  @$pb.TagNumber(6)
  $core.bool hasButton() => $_has(5);
  @$pb.TagNumber(6)
  void clearButton() => clearField(6);
  @$pb.TagNumber(6)
  $1784.Link ensureButton() => $_ensure(5);
}
