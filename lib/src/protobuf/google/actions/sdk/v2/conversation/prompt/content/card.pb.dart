...
import 'image.pbenum.dart' as $1782;
import 'link.pb.dart' as $1783;
...
class Card extends $pb.GeneratedMessage {
  factory Card({
    ...
    $core.String? text,
    $1782.Image? image,
    $1782.Image_ImageFill? imageFill,
    $1783.Link? button,
  }) {
    final $result = create();
    if (title != null) {
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(_omitMessageNames ? '' : 'Card', package: const $pb.PackageName(_omitMessageNames ? '' : 'google.actions.sdk.v2.conversation'), createEmptyInstance: create)
    ..aOS(1, _omitFieldNames ? '' : 'title')
    ..aOS(2, _omitFieldNames ? '' : 'subtitle')
    ..aOS(3, _omitFieldNames ? '' : 'text')
    ..aOM<$1782.Image>(4, _omitFieldNames ? '' : 'image', subBuilder: $1782.Image.create)
    ..e<$1782.Image_ImageFill>(5, _omitFieldNames ? '' : 'imageFill', $pb.PbFieldType.OE, defaultOrMaker: $1782.Image_ImageFill.UNSPECIFIED, valueOf: $1782.Image_ImageFill.valueOf, enumValues: $1782.Image_ImageFill.values)
    ..aOM<$1783.Link>(6, _omitFieldNames ? '' : 'button', subBuilder: $1783.Link.create)
  ...
  /// Optional.
  @$pb.TagNumber(4)
  $1782.Image get image => $_getN(3);
  @$pb.TagNumber(4)
  set image($1782.Image v) { setField(4, v); }
  @$pb.TagNumber(4)
  $core.bool hasImage() => $_has(3);
  @$pb.TagNumber(4)
  void clearImage() => clearField(4);
  @$pb.TagNumber(4)
  $1782.Image ensureImage() => $_ensure(3);

  /// How the image background will be filled. Optional.
  @$pb.TagNumber(5)
  $1782.Image_ImageFill get imageFill => $_getN(4);
  @$pb.TagNumber(5)
  set imageFill($1782.Image_ImageFill v) { setField(5, v); }
  @$pb.TagNumber(5)
  ...
  /// Optional.
  @$pb.TagNumber(6)
  $1783.Link get button => $_getN(5);
  @$pb.TagNumber(6)
  set button($1783.Link v) { setField(6, v); }
  @$pb.TagNumber(6)
  $core.bool hasButton() => $_has(5);
  @$pb.TagNumber(6)
  void clearButton() => clearField(6);
  @$pb.TagNumber(6)
  $1783.Link ensureButton() => $_ensure(5);
}
