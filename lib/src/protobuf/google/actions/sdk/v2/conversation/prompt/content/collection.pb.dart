...
class Collection extends $pb.GeneratedMessage {
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(_omitMessageNames ? '' : 'Collection', package: const $pb.PackageName(_omitMessageNames ? '' : 'google.actions.sdk.v2.conversation'), createEmptyInstance: create)
    ...
    ..e<$1782.Image_ImageFill>(4, _omitFieldNames ? '' : 'imageFill', $pb.PbFieldType.OE, defaultOrMaker: $1782.Image_ImageFill.UNSPECIFIED, valueOf: $1782.Image_ImageFill.valueOf, enumValues: $1782.Image_ImageFill.values)
    ..hasRequiredFields = false
  ;
  ...
  @$pb.TagNumber(4)
  $1782.Image_ImageFill get imageFill => $_getN(3);
  @$pb.TagNumber(4)
  set imageFill($1782.Image_ImageFill v) { setField(4, v); }
  @$pb.TagNumber(4)
