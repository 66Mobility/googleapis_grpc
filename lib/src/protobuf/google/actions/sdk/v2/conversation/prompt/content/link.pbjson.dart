...
final $typed_data.Uint8List urlHintDescriptor = $convert.base64Decode(
    'CgdVcmxIaW50EhQKEExJTktfVU5TUEVDSUZJRUQQABIHCgNBTVAQAQ==');
...
const Link$json = {
  ...
  '2': [
    ...
    {'1': 'open', '3': 2, '4': 1, '5': 11, '6': '.google.actions.sdk.v2.conversation.OpenUrl', '10': 'open'},
  ],
};
...
const OpenUrl$json = {
  ...
  '2': [
    ...
    {'1': 'hint', '3': 2, '4': 1, '5': 14, '6': '.google.actions.sdk.v2.conversation.UrlHint', '10': 'hint'},
  ],
};
