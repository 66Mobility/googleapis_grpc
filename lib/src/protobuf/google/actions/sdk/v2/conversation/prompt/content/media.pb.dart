...
class MediaImage extends $pb.GeneratedMessage {
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(
      ...
      createEmptyInstance: create)
    ..oo(0, [1, 2])
    ..aOM<$337.Image>(1, _omitFieldNames ? '' : 'large',
        subBuilder: $337.Image.create)
    ..aOM<$337.Image>(2, _omitFieldNames ? '' : 'icon',
        subBuilder: $337.Image.create)
    ..hasRequiredFields = false;
  ...
  @$pb.TagNumber(1)
  $337.Image get large => $_getN(0);
  @$pb.TagNumber(1)
  set large($337.Image v) {
    setField(1, v);
  }
  ...
  @$pb.TagNumber(2)
  $337.Image ensureIcon() => $_ensure(1);
}
