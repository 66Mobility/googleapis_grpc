...
import 'prompt/prompt.pb.dart' as $1794;
...
class Slot extends $pb.GeneratedMessage {
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(_omitMessageNames ? '' : 'Slot', package: const $pb.PackageName(_omitMessageNames ? '' : 'google.actions.sdk.v2.conversation'), createEmptyInstance: create)
    ...
    ..aOM<$1794.Prompt>(5, _omitFieldNames ? '' : 'prompt', subBuilder: $1794.Prompt.create)
  ...
  @$pb.TagNumber(5)
  $1794.Prompt get prompt => $_getN(4);
  @$pb.TagNumber(5)
  set prompt($1794.Prompt v) { setField(5, v); }
  @$pb.TagNumber(5)
  $core.bool hasPrompt() => $_has(4);
  @$pb.TagNumber(5)
  void clearPrompt() => clearField(5);
  @$pb.TagNumber(5)
  $1794.Prompt ensurePrompt() => $_ensure(4);
}
