...
import 'prompt/prompt.pb.dart' as $1793;
...
class Slot extends $pb.GeneratedMessage {
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(_omitMessageNames ? '' : 'Slot', package: const $pb.PackageName(_omitMessageNames ? '' : 'google.actions.sdk.v2.conversation'), createEmptyInstance: create)
    ...
    ..aOM<$1793.Prompt>(5, _omitFieldNames ? '' : 'prompt', subBuilder: $1793.Prompt.create)
  ...
  @$pb.TagNumber(5)
  $1793.Prompt get prompt => $_getN(4);
  @$pb.TagNumber(5)
  set prompt($1793.Prompt v) { setField(5, v); }
  @$pb.TagNumber(5)
  $core.bool hasPrompt() => $_has(4);
  @$pb.TagNumber(5)
  void clearPrompt() => clearField(5);
  @$pb.TagNumber(5)
  $1793.Prompt ensurePrompt() => $_ensure(4);
}
