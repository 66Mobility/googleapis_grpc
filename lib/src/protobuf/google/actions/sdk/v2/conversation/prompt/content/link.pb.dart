...
class Link extends $pb.GeneratedMessage {
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(_omitMessageNames ? '' : 'Link', package: const $pb.PackageName(_omitMessageNames ? '' : 'google.actions.sdk.v2.conversation'), createEmptyInstance: create)
...
class OpenUrl extends $pb.GeneratedMessage {
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(_omitMessageNames ? '' : 'OpenUrl', package: const $pb.PackageName(_omitMessageNames ? '' : 'google.actions.sdk.v2.conversation'), createEmptyInstance: create)
    ..aOS(1, _omitFieldNames ? '' : 'url')
    ..e<UrlHint>(2, _omitFieldNames ? '' : 'hint', $pb.PbFieldType.OE, defaultOrMaker: UrlHint.LINK_UNSPECIFIED, valueOf: UrlHint.valueOf, enumValues: UrlHint.values)
    ..hasRequiredFields = false
  ;
