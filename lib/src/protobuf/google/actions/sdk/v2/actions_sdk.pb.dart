...
import 'files.pb.dart' as $333;
import 'release_channel.pb.dart' as $336;
import 'validation_results.pb.dart' as $334;
...
class WriteDraftRequest extends $pb.GeneratedMessage {
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(
    ...
    ..aOM<$333.Files>(4, _omitFieldNames ? '' : 'files',
        subBuilder: $333.Files.create)
  ...
  @$pb.TagNumber(4)
  $333.Files get files => $_getN(1);
  @$pb.TagNumber(4)
  set files($333.Files v) {
    setField(4, v);
  }
  ...
  @$pb.TagNumber(4)
  $333.Files ensureFiles() => $_ensure(1);
}
...
class Draft extends $pb.GeneratedMessage {
  factory Draft({
    $core.String? name,
    $334.ValidationResults? validationResults,
  }) {
    final $result = create();
    if (name != null) {
      $result.name = name;
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(
    ...
    ..aOM<$334.ValidationResults>(2, _omitFieldNames ? '' : 'validationResults',
        subBuilder: $334.ValidationResults.create)
    ..hasRequiredFields = false;
  ...
  /// blocking.
  @$pb.TagNumber(2)
  $334.ValidationResults get validationResults => $_getN(1);
  @$pb.TagNumber(2)
  set validationResults($334.ValidationResults v) {
    setField(2, v);
  }
  ...
  @$pb.TagNumber(2)
  $334.ValidationResults ensureValidationResults() => $_ensure(1);
}
...
class WritePreviewRequest_PreviewSettings extends $pb.GeneratedMessage {
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(
      ...
      package: const $pb.PackageName(
          _omitMessageNames ? '' : 'google.actions.sdk.v2'),
      createEmptyInstance: create)
    ..aOM<$335.BoolValue>(1, _omitFieldNames ? '' : 'sandbox',
  ...
  @$pb.TagNumber(1)
  $335.BoolValue get sandbox => $_getN(0);
  @$pb.TagNumber(1)
  set sandbox($335.BoolValue v) {
    setField(1, v);
  }
  ...
  @$pb.TagNumber(1)
  $335.BoolValue ensureSandbox() => $_ensure(0);
}
...
class WritePreviewRequest extends $pb.GeneratedMessage {
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(
    ...
    ..aOM<$333.Files>(5, _omitFieldNames ? '' : 'files',
        subBuilder: $333.Files.create)
  ...
  @$pb.TagNumber(5)
  $333.Files ensureFiles() => $_ensure(2);
...
class ReadDraftResponse extends $pb.GeneratedMessage {
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(
      ...
      package: const $pb.PackageName(
          _omitMessageNames ? '' : 'google.actions.sdk.v2'),
      createEmptyInstance: create)
    ..aOM<$333.Files>(3, _omitFieldNames ? '' : 'files',
        subBuilder: $333.Files.create)
    ..hasRequiredFields = false;
  ...
  @$pb.TagNumber(3)
  $333.Files ensureFiles() => $_ensure(0);
}
...
class ReadVersionResponse extends $pb.GeneratedMessage {
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(
      ...
      package: const $pb.PackageName(
          _omitMessageNames ? '' : 'google.actions.sdk.v2'),
      createEmptyInstance: create)
    ..aOM<$333.Files>(1, _omitFieldNames ? '' : 'files',
        subBuilder: $333.Files.create)
    ..hasRequiredFields = false;
...
class EncryptSecretResponse extends $pb.GeneratedMessage {
  ...
  @$pb.TagNumber(1)
  $326.AccountLinkingSecret get accountLinkingSecret => $_getN(0);
  @$pb.TagNumber(1)
  ...
  @$pb.TagNumber(1)
  $326.AccountLinkingSecret ensureAccountLinkingSecret() => $_ensure(0);
}
...
class ListReleaseChannelsResponse extends $pb.GeneratedMessage {
  factory ListReleaseChannelsResponse({
    $core.Iterable<$336.ReleaseChannel>? releaseChannels,
    $core.String? nextPageToken,
  }) {
    final $result = create();
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(
      ...
      package: const $pb.PackageName(
          _omitMessageNames ? '' : 'google.actions.sdk.v2'),
      createEmptyInstance: create)
    ..pc<$336.ReleaseChannel>(
        1, _omitFieldNames ? '' : 'releaseChannels', $pb.PbFieldType.PM,
        subBuilder: $336.ReleaseChannel.create)
    ..aOS(2, _omitFieldNames ? '' : 'nextPageToken')
    ..hasRequiredFields = false;
  ...
  @$pb.TagNumber(1)
  $core.List<$336.ReleaseChannel> get releaseChannels => $_getList(0);
