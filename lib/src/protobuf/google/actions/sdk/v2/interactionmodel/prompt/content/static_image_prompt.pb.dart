...
class StaticImagePrompt extends $pb.GeneratedMessage {
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(_omitMessageNames ? '' : 'StaticImagePrompt', package: const $pb.PackageName(_omitMessageNames ? '' : 'google.actions.sdk.v2.interactionmodel.prompt'), createEmptyInstance: create)
  ...
  'Will be removed in next major version')
  StaticImagePrompt copyWith(void Function(StaticImagePrompt) updates) => super.copyWith((message) => updates(message as StaticImagePrompt)) as StaticImagePrompt;
