...
class SynonymType_MatchType extends $pb.ProtobufEnum {
  static const SynonymType_MatchType UNSPECIFIED = SynonymType_MatchType._(0, _omitEnumNames ? '' : 'UNSPECIFIED');
  static const SynonymType_MatchType EXACT_MATCH = SynonymType_MatchType._(1, _omitEnumNames ? '' : 'EXACT_MATCH');
  static const SynonymType_MatchType FUZZY_MATCH = SynonymType_MatchType._(2, _omitEnumNames ? '' : 'FUZZY_MATCH');
