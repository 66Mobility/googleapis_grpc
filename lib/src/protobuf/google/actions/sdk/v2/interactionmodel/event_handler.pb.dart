...
import 'prompt/static_prompt.pb.dart' as $304;
...
class EventHandler extends $pb.GeneratedMessage {
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(
    ...
    ..aOM<$304.StaticPrompt>(2, _omitFieldNames ? '' : 'staticPrompt',
  ...
  /// bundles.
  @$pb.TagNumber(2)
  $304.StaticPrompt get staticPrompt => $_getN(1);
  @$pb.TagNumber(2)
  ...
  @$pb.TagNumber(2)
  $304.StaticPrompt ensureStaticPrompt() => $_ensure(1);
