...
class StaticTablePrompt extends $pb.GeneratedMessage {
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(_omitMessageNames ? '' : 'StaticTablePrompt', package: const $pb.PackageName(_omitMessageNames ? '' : 'google.actions.sdk.v2.interactionmodel.prompt'), createEmptyInstance: create)
    ...
    ..aOM<$259.StaticImagePrompt>(3, _omitFieldNames ? '' : 'image', subBuilder: $259.StaticImagePrompt.create)
  ...
  @$pb.TagNumber(3)
  $259.StaticImagePrompt get image => $_getN(2);
  @$pb.TagNumber(3)
  set image($259.StaticImagePrompt v) { setField(3, v); }
  @$pb.TagNumber(3)
  $core.bool hasImage() => $_has(2);
  @$pb.TagNumber(3)
  void clearImage() => clearField(3);
  @$pb.TagNumber(3)
  $259.StaticImagePrompt ensureImage() => $_ensure(2);
