...
class ClassReference extends $pb.GeneratedMessage {
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(_omitMessageNames ? '' : 'ClassReference', package: const $pb.PackageName(_omitMessageNames ? '' : 'google.actions.sdk.v2.interactionmodel.type'), createEmptyInstance: create)
  ...
  'Will be removed in next major version')
  ClassReference copyWith(void Function(ClassReference) updates) => super.copyWith((message) => updates(message as ClassReference)) as ClassReference;
