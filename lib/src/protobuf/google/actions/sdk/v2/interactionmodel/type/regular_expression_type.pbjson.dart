...
const RegularExpressionType$json = {
  ...
  '2': [
    {'1': 'entities', '3': 1, '4': 3, '5': 11, '6': '.google.actions.sdk.v2.interactionmodel.type.RegularExpressionType.EntitiesEntry', '8': {}, '10': 'entities'},
  ],
  '3': [RegularExpressionType_Entity$json, RegularExpressionType_EntitiesEntry$json],
};
...
const RegularExpressionType_Entity$json = {
  ...
  '2': [
    ...
    {'1': 'regular_expressions', '3': 2, '4': 3, '5': 9, '8': {}, '10': 'regularExpressions'},
  ],
};
...
const RegularExpressionType_EntitiesEntry$json = {
  ...
  '2': [
    ...
    {'1': 'value', '3': 2, '4': 1, '5': 11, '6': '.google.actions.sdk.v2.interactionmodel.type.RegularExpressionType.Entity', '10': 'value'},
  ],
  '7': {'7': true},
};
