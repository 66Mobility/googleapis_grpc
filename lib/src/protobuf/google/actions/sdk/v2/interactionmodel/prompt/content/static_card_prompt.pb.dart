...
class StaticCardPrompt extends $pb.GeneratedMessage {
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(_omitMessageNames ? '' : 'StaticCardPrompt', package: const $pb.PackageName(_omitMessageNames ? '' : 'google.actions.sdk.v2.interactionmodel.prompt'), createEmptyInstance: create)
    ...
    ..e<$1735.StaticImagePrompt_ImageFill>(5, _omitFieldNames ? '' : 'imageFill', $pb.PbFieldType.OE, defaultOrMaker: $1735.StaticImagePrompt_ImageFill.UNSPECIFIED, valueOf: $1735.StaticImagePrompt_ImageFill.valueOf, enumValues: $1735.StaticImagePrompt_ImageFill.values)
  ...
  @$pb.TagNumber(5)
  $1735.StaticImagePrompt_ImageFill get imageFill => $_getN(4);
  @$pb.TagNumber(5)
  set imageFill($1735.StaticImagePrompt_ImageFill v) { setField(5, v); }
  @$pb.TagNumber(5)
