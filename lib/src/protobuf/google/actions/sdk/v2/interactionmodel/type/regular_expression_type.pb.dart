...
import 'entity_display.pb.dart' as $310;
...
class RegularExpressionType_Entity extends $pb.GeneratedMessage {
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(
    ...
    ..aOM<$310.EntityDisplay>(1, _omitFieldNames ? '' : 'display',
        subBuilder: $310.EntityDisplay.create)
  ...
  @$pb.TagNumber(1)
  $310.EntityDisplay get display => $_getN(0);
  @$pb.TagNumber(1)
  set display($310.EntityDisplay v) {
    setField(1, v);
  }
  ...
  @$pb.TagNumber(1)
  $310.EntityDisplay ensureDisplay() => $_ensure(0);
