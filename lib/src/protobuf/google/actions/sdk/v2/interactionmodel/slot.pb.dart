...
import 'event_handler.pb.dart' as $305;
import 'type/class_reference.pb.dart' as $306;
...
class Slot_PromptSettings extends $pb.GeneratedMessage {
  factory Slot_PromptSettings({
    $305.EventHandler? initialPrompt,
    $305.EventHandler? noMatchPrompt1,
    $305.EventHandler? noMatchPrompt2,
    $305.EventHandler? noMatchFinalPrompt,
    $305.EventHandler? noInputPrompt1,
    $305.EventHandler? noInputPrompt2,
    $305.EventHandler? noInputFinalPrompt,
  }) {
    final $result = create();
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(
    ...
    ..aOM<$305.EventHandler>(1, _omitFieldNames ? '' : 'initialPrompt',
        subBuilder: $305.EventHandler.create)
    ..aOM<$305.EventHandler>(2, _omitFieldNames ? '' : 'noMatchPrompt1',
        subBuilder: $305.EventHandler.create)
    ..aOM<$305.EventHandler>(3, _omitFieldNames ? '' : 'noMatchPrompt2',
        subBuilder: $305.EventHandler.create)
    ..aOM<$305.EventHandler>(4, _omitFieldNames ? '' : 'noMatchFinalPrompt',
        subBuilder: $305.EventHandler.create)
    ..aOM<$305.EventHandler>(5, _omitFieldNames ? '' : 'noInputPrompt1',
        subBuilder: $305.EventHandler.create)
    ..aOM<$305.EventHandler>(6, _omitFieldNames ? '' : 'noInputPrompt2',
        subBuilder: $305.EventHandler.create)
    ..aOM<$305.EventHandler>(7, _omitFieldNames ? '' : 'noInputFinalPrompt',
        subBuilder: $305.EventHandler.create)
  ...
  @$pb.TagNumber(1)
  $305.EventHandler get initialPrompt => $_getN(0);
  @$pb.TagNumber(1)
  set initialPrompt($305.EventHandler v) {
    setField(1, v);
  }
  ...
  @$pb.TagNumber(1)
  $305.EventHandler ensureInitialPrompt() => $_ensure(0);
  ...
  /// didn't get that."
  @$pb.TagNumber(2)
  $305.EventHandler get noMatchPrompt1 => $_getN(1);
  @$pb.TagNumber(2)
  set noMatchPrompt1($305.EventHandler v) {
    setField(2, v);
  }
  ...
  @$pb.TagNumber(2)
  $305.EventHandler ensureNoMatchPrompt1() => $_ensure(1);

  /// Prompt to give when the user's input does not match the expected
  /// value type for the slot for the second time. Example: "Sorry, I
  /// didn't get that."
  @$pb.TagNumber(3)
  $305.EventHandler get noMatchPrompt2 => $_getN(2);
  @$pb.TagNumber(3)
  set noMatchPrompt2($305.EventHandler v) {
    setField(3, v);
  }
  ...
  @$pb.TagNumber(3)
  $305.EventHandler ensureNoMatchPrompt2() => $_ensure(2);

  /// Prompt to give when the user's input does not match the expected
  /// value type for the slot for the last time. Example: "Sorry, I
  /// didn't get that."
  @$pb.TagNumber(4)
  $305.EventHandler get noMatchFinalPrompt => $_getN(3);
  @$pb.TagNumber(4)
  set noMatchFinalPrompt($305.EventHandler v) {
    setField(4, v);
  }
  ...
  @$pb.TagNumber(4)
  $305.EventHandler ensureNoMatchFinalPrompt() => $_ensure(3);

  /// Prompt to give when the user does not provide an input for the first
  /// time. Example: "Sorry, I didn't get that."
  @$pb.TagNumber(5)
  $305.EventHandler get noInputPrompt1 => $_getN(4);
  @$pb.TagNumber(5)
  set noInputPrompt1($305.EventHandler v) {
    setField(5, v);
  }
  ...
  @$pb.TagNumber(5)
  $305.EventHandler ensureNoInputPrompt1() => $_ensure(4);

  /// Prompt to give when the user does not provide an input for the second
  /// time. Example: "Sorry, I didn't get that."
  @$pb.TagNumber(6)
  $305.EventHandler get noInputPrompt2 => $_getN(5);
  @$pb.TagNumber(6)
  set noInputPrompt2($305.EventHandler v) {
    setField(6, v);
  }
  ...
  @$pb.TagNumber(6)
  $305.EventHandler ensureNoInputPrompt2() => $_ensure(5);

  /// Prompt to give when the user does not provide an input for the last
  /// time. Example: "Sorry, I didn't get that."
  @$pb.TagNumber(7)
  $305.EventHandler get noInputFinalPrompt => $_getN(6);
  @$pb.TagNumber(7)
  set noInputFinalPrompt($305.EventHandler v) {
    setField(7, v);
  }
  ...
  @$pb.TagNumber(7)
  $305.EventHandler ensureNoInputFinalPrompt() => $_ensure(6);
}
...
class Slot_DefaultValue extends $pb.GeneratedMessage {
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(
    ...
    ..aOM<$289.Value>(2, _omitFieldNames ? '' : 'constant',
  ...
  @$pb.TagNumber(2)
  $289.Value get constant => $_getN(1);
  @$pb.TagNumber(2)
  set constant($289.Value v) {
    setField(2, v);
  }
  ...
  @$pb.TagNumber(2)
  $289.Value ensureConstant() => $_ensure(1);
}
...
class Slot extends $pb.GeneratedMessage {
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(
    ...
    ..aOM<$306.ClassReference>(2, _omitFieldNames ? '' : 'type',
        subBuilder: $306.ClassReference.create)
    ...
    ..aOM<$289.Value>(6, _omitFieldNames ? '' : 'config',
        subBuilder: $289.Value.create)
  ...
  @$pb.TagNumber(2)
  $306.ClassReference get type => $_getN(1);
  @$pb.TagNumber(2)
  set type($306.ClassReference v) {
    setField(2, v);
  }
  ...
  @$pb.TagNumber(2)
  $306.ClassReference ensureType() => $_ensure(1);
  ...
  ///     }
  @$pb.TagNumber(6)
  $289.Value get config => $_getN(5);
  @$pb.TagNumber(6)
  set config($289.Value v) {
    setField(6, v);
  }
  ...
  @$pb.TagNumber(6)
  $289.Value ensureConfig() => $_ensure(5);
