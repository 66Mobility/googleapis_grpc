...
class StaticMediaPrompt extends $pb.GeneratedMessage {
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(_omitMessageNames ? '' : 'StaticMediaPrompt', package: const $pb.PackageName(_omitMessageNames ? '' : 'google.actions.sdk.v2.interactionmodel.prompt'), createEmptyInstance: create)
    ..aOM<$1737.Duration>(5, _omitFieldNames ? '' : 'startOffset', subBuilder: $1737.Duration.create)
  ...
  @$pb.TagNumber(5)
  set startOffset($1737.Duration v) { setField(5, v); }
  @$pb.TagNumber(5)
...
class MediaImage extends $pb.GeneratedMessage {
  factory MediaImage({
    $1735.StaticImagePrompt? large,
    $1735.StaticImagePrompt? icon,
  }) {
    final $result = create();
    if (large != null) {
      $result.large = large;
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(_omitMessageNames ? '' : 'MediaImage', package: const $pb.PackageName(_omitMessageNames ? '' : 'google.actions.sdk.v2.interactionmodel.prompt'), createEmptyInstance: create)
    ..oo(0, [1, 2])
    ..aOM<$1735.StaticImagePrompt>(1, _omitFieldNames ? '' : 'large', subBuilder: $1735.StaticImagePrompt.create)
    ..aOM<$1735.StaticImagePrompt>(2, _omitFieldNames ? '' : 'icon', subBuilder: $1735.StaticImagePrompt.create)
    ..hasRequiredFields = false
  ;
  ...
  @$pb.TagNumber(1)
  $1735.StaticImagePrompt get large => $_getN(0);
  @$pb.TagNumber(1)
  set large($1735.StaticImagePrompt v) { setField(1, v); }
  @$pb.TagNumber(1)
  $core.bool hasLarge() => $_has(0);
  @$pb.TagNumber(1)
  void clearLarge() => clearField(1);
  @$pb.TagNumber(1)
  $1735.StaticImagePrompt ensureLarge() => $_ensure(0);

  /// A small image icon displayed on the right from the title.
  /// It's resized to 36x36 dp.
  @$pb.TagNumber(2)
  $1735.StaticImagePrompt get icon => $_getN(1);
  @$pb.TagNumber(2)
  set icon($1735.StaticImagePrompt v) { setField(2, v); }
  @$pb.TagNumber(2)
  $core.bool hasIcon() => $_has(1);
  @$pb.TagNumber(2)
  void clearIcon() => clearField(2);
  @$pb.TagNumber(2)
  $1735.StaticImagePrompt ensureIcon() => $_ensure(1);
}
