...
class StaticMediaPrompt extends $pb.GeneratedMessage {
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(
    ...
    ..aOM<$292.Duration>(5, _omitFieldNames ? '' : 'startOffset',
  ...
  @$pb.TagNumber(5)
  $292.Duration get startOffset => $_getN(0);
  @$pb.TagNumber(5)
  set startOffset($292.Duration v) {
    setField(5, v);
  }
  ...
  @$pb.TagNumber(5)
  $292.Duration ensureStartOffset() => $_ensure(0);
...
class MediaImage extends $pb.GeneratedMessage {
  factory MediaImage({
    $290.StaticImagePrompt? large,
    $290.StaticImagePrompt? icon,
  }) {
    final $result = create();
    if (large != null) {
      $result.large = large;
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(
      ...
      createEmptyInstance: create)
    ..oo(0, [1, 2])
    ..aOM<$290.StaticImagePrompt>(1, _omitFieldNames ? '' : 'large',
        subBuilder: $290.StaticImagePrompt.create)
    ..aOM<$290.StaticImagePrompt>(2, _omitFieldNames ? '' : 'icon',
        subBuilder: $290.StaticImagePrompt.create)
    ..hasRequiredFields = false;
  ...
  @$pb.TagNumber(1)
  $290.StaticImagePrompt get large => $_getN(0);
  @$pb.TagNumber(1)
  set large($290.StaticImagePrompt v) {
    setField(1, v);
  }
  ...
  @$pb.TagNumber(1)
  $290.StaticImagePrompt ensureLarge() => $_ensure(0);

  /// A small image icon displayed on the right from the title.
  /// It's resized to 36x36 dp.
  @$pb.TagNumber(2)
  $290.StaticImagePrompt get icon => $_getN(1);
  @$pb.TagNumber(2)
  set icon($290.StaticImagePrompt v) {
    setField(2, v);
  }
  ...
  @$pb.TagNumber(2)
  $290.StaticImagePrompt ensureIcon() => $_ensure(1);
}
