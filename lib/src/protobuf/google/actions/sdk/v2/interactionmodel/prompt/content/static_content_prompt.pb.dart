...
class StaticContentPrompt extends $pb.GeneratedMessage {
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(_omitMessageNames ? '' : 'StaticContentPrompt', package: const $pb.PackageName(_omitMessageNames ? '' : 'google.actions.sdk.v2.interactionmodel.prompt'), createEmptyInstance: create)
    ..oo(0, [1, 2, 3, 4, 5, 6, 7])
    ..aOM<$265.StaticCardPrompt>(1, _omitFieldNames ? '' : 'card', subBuilder: $265.StaticCardPrompt.create)
    ..aOM<$262.StaticImagePrompt>(2, _omitFieldNames ? '' : 'image', subBuilder: $262.StaticImagePrompt.create)
    ..aOM<$266.StaticTablePrompt>(3, _omitFieldNames ? '' : 'table', subBuilder: $266.StaticTablePrompt.create)
    ..aOM<$267.StaticMediaPrompt>(4, _omitFieldNames ? '' : 'media', subBuilder: $267.StaticMediaPrompt.create)
    ..aOM<$268.StaticListPrompt>(5, _omitFieldNames ? '' : 'list', subBuilder: $268.StaticListPrompt.create)
    ..aOM<$269.StaticCollectionPrompt>(6, _omitFieldNames ? '' : 'collection', subBuilder: $269.StaticCollectionPrompt.create)
    ..aOM<$270.StaticCollectionBrowsePrompt>(7, _omitFieldNames ? '' : 'collectionBrowse', subBuilder: $270.StaticCollectionBrowsePrompt.create)
  ...
  @$pb.TagNumber(1)
  set card($265.StaticCardPrompt v) { setField(1, v); }
  @$pb.TagNumber(1)
  ...
  @$pb.TagNumber(2)
  set image($262.StaticImagePrompt v) { setField(2, v); }
  @$pb.TagNumber(2)
  ...
  @$pb.TagNumber(3)
  set table($266.StaticTablePrompt v) { setField(3, v); }
  @$pb.TagNumber(3)
  ...
  @$pb.TagNumber(4)
  set media($267.StaticMediaPrompt v) { setField(4, v); }
  @$pb.TagNumber(4)
  ...
  @$pb.TagNumber(5)
  set list($268.StaticListPrompt v) { setField(5, v); }
  @$pb.TagNumber(5)
  ...
  @$pb.TagNumber(6)
  set collection($269.StaticCollectionPrompt v) { setField(6, v); }
  @$pb.TagNumber(6)
  ...
  @$pb.TagNumber(7)
  set collectionBrowse($270.StaticCollectionBrowsePrompt v) { setField(7, v); }
  @$pb.TagNumber(7)
