...
import 'conditional_event.pb.dart' as $1753;
import 'event_handler.pb.dart' as $1750;
import 'intent_event.pb.dart' as $1752;
import 'slot.pb.dart' as $1754;
...
class Scene extends $pb.GeneratedMessage {
  factory Scene({
    $1750.EventHandler? onEnter,
    $core.Iterable<$1752.IntentEvent>? intentEvents,
    $core.Iterable<$1753.ConditionalEvent>? conditionalEvents,
    $core.Iterable<$1754.Slot>? slots,
    $1750.EventHandler? onSlotUpdated,
  }) {
    final $result = create();
    if (onEnter != null) {
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(_omitMessageNames ? '' : 'Scene', package: const $pb.PackageName(_omitMessageNames ? '' : 'google.actions.sdk.v2.interactionmodel'), createEmptyInstance: create)
    ..aOM<$1750.EventHandler>(1, _omitFieldNames ? '' : 'onEnter', subBuilder: $1750.EventHandler.create)
    ..pc<$1752.IntentEvent>(2, _omitFieldNames ? '' : 'intentEvents', $pb.PbFieldType.PM, subBuilder: $1752.IntentEvent.create)
    ..pc<$1753.ConditionalEvent>(3, _omitFieldNames ? '' : 'conditionalEvents', $pb.PbFieldType.PM, subBuilder: $1753.ConditionalEvent.create)
    ..pc<$1754.Slot>(4, _omitFieldNames ? '' : 'slots', $pb.PbFieldType.PM, subBuilder: $1754.Slot.create)
    ..aOM<$1750.EventHandler>(5, _omitFieldNames ? '' : 'onSlotUpdated', subBuilder: $1750.EventHandler.create)
  ...
  @$pb.TagNumber(1)
  $1750.EventHandler get onEnter => $_getN(0);
  @$pb.TagNumber(1)
  set onEnter($1750.EventHandler v) { setField(1, v); }
  @$pb.TagNumber(1)
  $core.bool hasOnEnter() => $_has(0);
  @$pb.TagNumber(1)
  void clearOnEnter() => clearField(1);
  @$pb.TagNumber(1)
  $1750.EventHandler ensureOnEnter() => $_ensure(0);
  ...
  @$pb.TagNumber(2)
  $core.List<$1752.IntentEvent> get intentEvents => $_getList(1);
  ...
  @$pb.TagNumber(3)
  $core.List<$1753.ConditionalEvent> get conditionalEvents => $_getList(2);
  ...
  @$pb.TagNumber(4)
  $core.List<$1754.Slot> get slots => $_getList(3);
  ...
  @$pb.TagNumber(5)
  $1750.EventHandler get onSlotUpdated => $_getN(4);
  @$pb.TagNumber(5)
  set onSlotUpdated($1750.EventHandler v) { setField(5, v); }
  @$pb.TagNumber(5)
  $core.bool hasOnSlotUpdated() => $_has(4);
  @$pb.TagNumber(5)
  void clearOnSlotUpdated() => clearField(5);
  @$pb.TagNumber(5)
  $1750.EventHandler ensureOnSlotUpdated() => $_ensure(4);
}
