...
import 'conditional_event.pb.dart' as $282;
import 'event_handler.pb.dart' as $279;
import 'intent_event.pb.dart' as $281;
import 'slot.pb.dart' as $283;
...
class Scene extends $pb.GeneratedMessage {
  factory Scene({
    $279.EventHandler? onEnter,
    $core.Iterable<$281.IntentEvent>? intentEvents,
    $core.Iterable<$282.ConditionalEvent>? conditionalEvents,
    $core.Iterable<$283.Slot>? slots,
    $279.EventHandler? onSlotUpdated,
  }) {
    final $result = create();
    if (onEnter != null) {
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(
    ...
    ..aOM<$279.EventHandler>(1, _omitFieldNames ? '' : 'onEnter',
        subBuilder: $279.EventHandler.create)
    ..pc<$281.IntentEvent>(
        2, _omitFieldNames ? '' : 'intentEvents', $pb.PbFieldType.PM,
        subBuilder: $281.IntentEvent.create)
    ..pc<$282.ConditionalEvent>(
        3, _omitFieldNames ? '' : 'conditionalEvents', $pb.PbFieldType.PM,
        subBuilder: $282.ConditionalEvent.create)
    ..pc<$283.Slot>(4, _omitFieldNames ? '' : 'slots', $pb.PbFieldType.PM,
        subBuilder: $283.Slot.create)
    ..aOM<$279.EventHandler>(5, _omitFieldNames ? '' : 'onSlotUpdated',
        subBuilder: $279.EventHandler.create)
  ...
  @$pb.TagNumber(1)
  $279.EventHandler get onEnter => $_getN(0);
  @$pb.TagNumber(1)
  set onEnter($279.EventHandler v) {
    setField(1, v);
  }
  ...
  @$pb.TagNumber(1)
  $279.EventHandler ensureOnEnter() => $_ensure(0);
  ...
  @$pb.TagNumber(2)
  $core.List<$281.IntentEvent> get intentEvents => $_getList(1);
  ...
  @$pb.TagNumber(3)
  $core.List<$282.ConditionalEvent> get conditionalEvents => $_getList(2);
  ...
  @$pb.TagNumber(4)
  $core.List<$283.Slot> get slots => $_getList(3);
  ...
  @$pb.TagNumber(5)
  $279.EventHandler get onSlotUpdated => $_getN(4);
  @$pb.TagNumber(5)
  set onSlotUpdated($279.EventHandler v) {
    setField(5, v);
  }
  ...
  @$pb.TagNumber(5)
  $279.EventHandler ensureOnSlotUpdated() => $_ensure(4);
}
