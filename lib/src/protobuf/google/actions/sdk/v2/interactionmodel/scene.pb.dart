...
import 'conditional_event.pb.dart' as $308;
import 'event_handler.pb.dart' as $305;
import 'intent_event.pb.dart' as $307;
import 'slot.pb.dart' as $309;
...
class Scene extends $pb.GeneratedMessage {
  factory Scene({
    $305.EventHandler? onEnter,
    $core.Iterable<$307.IntentEvent>? intentEvents,
    $core.Iterable<$308.ConditionalEvent>? conditionalEvents,
    $core.Iterable<$309.Slot>? slots,
    $305.EventHandler? onSlotUpdated,
  }) {
    final $result = create();
    if (onEnter != null) {
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(
    ...
    ..aOM<$305.EventHandler>(1, _omitFieldNames ? '' : 'onEnter',
        subBuilder: $305.EventHandler.create)
    ..pc<$307.IntentEvent>(
        2, _omitFieldNames ? '' : 'intentEvents', $pb.PbFieldType.PM,
        subBuilder: $307.IntentEvent.create)
    ..pc<$308.ConditionalEvent>(
        3, _omitFieldNames ? '' : 'conditionalEvents', $pb.PbFieldType.PM,
        subBuilder: $308.ConditionalEvent.create)
    ..pc<$309.Slot>(4, _omitFieldNames ? '' : 'slots', $pb.PbFieldType.PM,
        subBuilder: $309.Slot.create)
    ..aOM<$305.EventHandler>(5, _omitFieldNames ? '' : 'onSlotUpdated',
        subBuilder: $305.EventHandler.create)
  ...
  @$pb.TagNumber(1)
  $305.EventHandler get onEnter => $_getN(0);
  @$pb.TagNumber(1)
  set onEnter($305.EventHandler v) {
    setField(1, v);
  }
  ...
  @$pb.TagNumber(1)
  $305.EventHandler ensureOnEnter() => $_ensure(0);
  ...
  @$pb.TagNumber(2)
  $core.List<$307.IntentEvent> get intentEvents => $_getList(1);
  ...
  @$pb.TagNumber(3)
  $core.List<$308.ConditionalEvent> get conditionalEvents => $_getList(2);
  ...
  @$pb.TagNumber(4)
  $core.List<$309.Slot> get slots => $_getList(3);
  ...
  @$pb.TagNumber(5)
  $305.EventHandler get onSlotUpdated => $_getN(4);
  @$pb.TagNumber(5)
  set onSlotUpdated($305.EventHandler v) {
    setField(5, v);
  }
  ...
  @$pb.TagNumber(5)
  $305.EventHandler ensureOnSlotUpdated() => $_ensure(4);
}
