...
class DateRange extends $pb.GeneratedMessage {
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(_omitMessageNames ? '' : 'DateRange', package: const $pb.PackageName(_omitMessageNames ? '' : 'google.actions.type'), createEmptyInstance: create)
    ..aOM<$324.Date>(1, _omitFieldNames ? '' : 'start', subBuilder: $324.Date.create)
    ..aOM<$324.Date>(2, _omitFieldNames ? '' : 'end', subBuilder: $324.Date.create)
  ...
  /// beginning bound.
  @$pb.TagNumber(1)
  $324.Date get start => $_getN(0);
  @$pb.TagNumber(1)
  set start($324.Date v) { setField(1, v); }
  @$pb.TagNumber(1)
  $core.bool hasStart() => $_has(0);
  @$pb.TagNumber(1)
  void clearStart() => clearField(1);
  @$pb.TagNumber(1)
  $324.Date ensureStart() => $_ensure(0);

  /// Date at which the date range ends. If unset, the date range has no ending
  /// bound.
  @$pb.TagNumber(2)
  $324.Date get end => $_getN(1);
  @$pb.TagNumber(2)
  set end($324.Date v) { setField(2, v); }
  @$pb.TagNumber(2)
  $core.bool hasEnd() => $_has(1);
  @$pb.TagNumber(2)
  void clearEnd() => clearField(2);
  @$pb.TagNumber(2)
  $324.Date ensureEnd() => $_ensure(1);
}
