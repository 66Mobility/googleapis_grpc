...
import '../type/device_resources.pbenum.dart' as $445;
...
class DevicePolicy extends $pb.GeneratedMessage {
  factory DevicePolicy({
    ...
    $core.Iterable<$445.DeviceEncryptionStatus>? allowedEncryptionStatuses,
    $core.Iterable<OsConstraint>? osConstraints,
    $core.Iterable<$445.DeviceManagementLevel>? allowedDeviceManagementLevels,
