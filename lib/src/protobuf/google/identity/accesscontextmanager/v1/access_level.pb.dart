...
import '../type/device_resources.pbenum.dart' as $4323;
...
class CustomLevel extends $pb.GeneratedMessage {
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(_omitMessageNames ? '' : 'CustomLevel', package: const $pb.PackageName(_omitMessageNames ? '' : 'google.identity.accesscontextmanager.v1'), createEmptyInstance: create)
    ..aOM<$4213.Expr>(1, _omitFieldNames ? '' : 'expr', subBuilder: $4213.Expr.create)
    ..hasRequiredFields = false
  ;
  ...
  @$pb.TagNumber(1)
  $4213.Expr get expr => $_getN(0);
  @$pb.TagNumber(1)
  set expr($4213.Expr v) { setField(1, v); }
  @$pb.TagNumber(1)
  $core.bool hasExpr() => $_has(0);
  @$pb.TagNumber(1)
  void clearExpr() => clearField(1);
  @$pb.TagNumber(1)
  $4213.Expr ensureExpr() => $_ensure(0);
}
...
class DevicePolicy extends $pb.GeneratedMessage {
  factory DevicePolicy({
    ...
    $core.Iterable<$4323.DeviceEncryptionStatus>? allowedEncryptionStatuses,
    $core.Iterable<OsConstraint>? osConstraints,
    $core.Iterable<$4323.DeviceManagementLevel>? allowedDeviceManagementLevels,
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(_omitMessageNames ? '' : 'DevicePolicy', package: const $pb.PackageName(_omitMessageNames ? '' : 'google.identity.accesscontextmanager.v1'), createEmptyInstance: create)
    ...
    ..pc<$4323.DeviceEncryptionStatus>(2, _omitFieldNames ? '' : 'allowedEncryptionStatuses', $pb.PbFieldType.KE, valueOf: $4323.DeviceEncryptionStatus.valueOf, enumValues: $4323.DeviceEncryptionStatus.values, defaultEnumValue: $4323.DeviceEncryptionStatus.ENCRYPTION_UNSPECIFIED)
    ..pc<OsConstraint>(3, _omitFieldNames ? '' : 'osConstraints', $pb.PbFieldType.PM, subBuilder: OsConstraint.create)
    ..pc<$4323.DeviceManagementLevel>(6, _omitFieldNames ? '' : 'allowedDeviceManagementLevels', $pb.PbFieldType.KE, valueOf: $4323.DeviceManagementLevel.valueOf, enumValues: $4323.DeviceManagementLevel.values, defaultEnumValue: $4323.DeviceManagementLevel.MANAGEMENT_UNSPECIFIED)
  ...
  @$pb.TagNumber(2)
  $core.List<$4323.DeviceEncryptionStatus> get allowedEncryptionStatuses => $_getList(1);
  ...
  /// levels.
  @$pb.TagNumber(6)
  $core.List<$4323.DeviceManagementLevel> get allowedDeviceManagementLevels => $_getList(3);
...
class OsConstraint extends $pb.GeneratedMessage {
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(_omitMessageNames ? '' : 'OsConstraint', package: const $pb.PackageName(_omitMessageNames ? '' : 'google.identity.accesscontextmanager.v1'), createEmptyInstance: create)
    ..e<$4323.OsType>(1, _omitFieldNames ? '' : 'osType', $pb.PbFieldType.OE, defaultOrMaker: $4323.OsType.OS_UNSPECIFIED, valueOf: $4323.OsType.valueOf, enumValues: $4323.OsType.values)
  ...
  @$pb.TagNumber(1)
  $4323.OsType get osType => $_getN(0);
  @$pb.TagNumber(1)
  set osType($4323.OsType v) { setField(1, v); }
  @$pb.TagNumber(1)
