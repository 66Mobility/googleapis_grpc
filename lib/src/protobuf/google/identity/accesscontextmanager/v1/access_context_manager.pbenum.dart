...
class LevelFormat extends $pb.ProtobufEnum {
  static const LevelFormat LEVEL_FORMAT_UNSPECIFIED = LevelFormat._(0, _omitEnumNames ? '' : 'LEVEL_FORMAT_UNSPECIFIED');
  static const LevelFormat AS_DEFINED = LevelFormat._(1, _omitEnumNames ? '' : 'AS_DEFINED');
