...
class MqttState extends $pb.ProtobufEnum {
  static const MqttState MQTT_STATE_UNSPECIFIED = MqttState._(0, _omitEnumNames ? '' : 'MQTT_STATE_UNSPECIFIED');
  static const MqttState MQTT_ENABLED = MqttState._(1, _omitEnumNames ? '' : 'MQTT_ENABLED');
  static const MqttState MQTT_DISABLED = MqttState._(2, _omitEnumNames ? '' : 'MQTT_DISABLED');
...
class HttpState extends $pb.ProtobufEnum {
  static const HttpState HTTP_STATE_UNSPECIFIED = HttpState._(0, _omitEnumNames ? '' : 'HTTP_STATE_UNSPECIFIED');
  static const HttpState HTTP_ENABLED = HttpState._(1, _omitEnumNames ? '' : 'HTTP_ENABLED');
  static const HttpState HTTP_DISABLED = HttpState._(2, _omitEnumNames ? '' : 'HTTP_DISABLED');
...
class GatewayType extends $pb.ProtobufEnum {
  static const GatewayType GATEWAY_TYPE_UNSPECIFIED = GatewayType._(0, _omitEnumNames ? '' : 'GATEWAY_TYPE_UNSPECIFIED');
  static const GatewayType GATEWAY = GatewayType._(1, _omitEnumNames ? '' : 'GATEWAY');
  static const GatewayType NON_GATEWAY = GatewayType._(2, _omitEnumNames ? '' : 'NON_GATEWAY');
...
class GatewayAuthMethod extends $pb.ProtobufEnum {
  static const GatewayAuthMethod GATEWAY_AUTH_METHOD_UNSPECIFIED = GatewayAuthMethod._(0, _omitEnumNames ? '' : 'GATEWAY_AUTH_METHOD_UNSPECIFIED');
  static const GatewayAuthMethod ASSOCIATION_ONLY = GatewayAuthMethod._(1, _omitEnumNames ? '' : 'ASSOCIATION_ONLY');
  static const GatewayAuthMethod DEVICE_AUTH_TOKEN_ONLY = GatewayAuthMethod._(2, _omitEnumNames ? '' : 'DEVICE_AUTH_TOKEN_ONLY');
  static const GatewayAuthMethod ASSOCIATION_AND_DEVICE_AUTH_TOKEN = GatewayAuthMethod._(3, _omitEnumNames ? '' : 'ASSOCIATION_AND_DEVICE_AUTH_TOKEN');
...
class PublicKeyCertificateFormat extends $pb.ProtobufEnum {
  static const PublicKeyCertificateFormat UNSPECIFIED_PUBLIC_KEY_CERTIFICATE_FORMAT = PublicKeyCertificateFormat._(0, _omitEnumNames ? '' : 'UNSPECIFIED_PUBLIC_KEY_CERTIFICATE_FORMAT');
  static const PublicKeyCertificateFormat X509_CERTIFICATE_PEM = PublicKeyCertificateFormat._(1, _omitEnumNames ? '' : 'X509_CERTIFICATE_PEM');
...
class PublicKeyFormat extends $pb.ProtobufEnum {
  static const PublicKeyFormat UNSPECIFIED_PUBLIC_KEY_FORMAT = PublicKeyFormat._(0, _omitEnumNames ? '' : 'UNSPECIFIED_PUBLIC_KEY_FORMAT');
  static const PublicKeyFormat RSA_PEM = PublicKeyFormat._(3, _omitEnumNames ? '' : 'RSA_PEM');
  static const PublicKeyFormat RSA_X509_PEM = PublicKeyFormat._(1, _omitEnumNames ? '' : 'RSA_X509_PEM');
  static const PublicKeyFormat ES256_PEM = PublicKeyFormat._(2, _omitEnumNames ? '' : 'ES256_PEM');
  static const PublicKeyFormat ES256_X509_PEM = PublicKeyFormat._(4, _omitEnumNames ? '' : 'ES256_X509_PEM');
