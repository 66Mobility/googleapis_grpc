...
class Form extends $pb.GeneratedMessage {
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(_omitMessageNames ? '' : 'Form', package: const $pb.PackageName(_omitMessageNames ? '' : 'google.cloud.websecurityscanner.v1'), createEmptyInstance: create)
...
class OutdatedLibrary extends $pb.GeneratedMessage {
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(_omitMessageNames ? '' : 'OutdatedLibrary', package: const $pb.PackageName(_omitMessageNames ? '' : 'google.cloud.websecurityscanner.v1'), createEmptyInstance: create)
...
class ViolatingResource extends $pb.GeneratedMessage {
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(_omitMessageNames ? '' : 'ViolatingResource', package: const $pb.PackageName(_omitMessageNames ? '' : 'google.cloud.websecurityscanner.v1'), createEmptyInstance: create)
...
class VulnerableParameters extends $pb.GeneratedMessage {
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(_omitMessageNames ? '' : 'VulnerableParameters', package: const $pb.PackageName(_omitMessageNames ? '' : 'google.cloud.websecurityscanner.v1'), createEmptyInstance: create)
...
class VulnerableHeaders_Header extends $pb.GeneratedMessage {
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(_omitMessageNames ? '' : 'VulnerableHeaders.Header', package: const $pb.PackageName(_omitMessageNames ? '' : 'google.cloud.websecurityscanner.v1'), createEmptyInstance: create)
...
class VulnerableHeaders extends $pb.GeneratedMessage {
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(_omitMessageNames ? '' : 'VulnerableHeaders', package: const $pb.PackageName(_omitMessageNames ? '' : 'google.cloud.websecurityscanner.v1'), createEmptyInstance: create)
...
class Xss extends $pb.GeneratedMessage {
  factory Xss({
    ...
    if (storedXssSeedingUrl != null) {
      $result.storedXssSeedingUrl = storedXssSeedingUrl;
    }
    return $result;
  }
  Xss._() : super();
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(_omitMessageNames ? '' : 'Xss', package: const $pb.PackageName(_omitMessageNames ? '' : 'google.cloud.websecurityscanner.v1'), createEmptyInstance: create)
    ..pPS(1, _omitFieldNames ? '' : 'stackTraces')
    ..aOS(2, _omitFieldNames ? '' : 'errorMessage')
    ..e<Xss_AttackVector>(3, _omitFieldNames ? '' : 'attackVector', $pb.PbFieldType.OE, defaultOrMaker: Xss_AttackVector.ATTACK_VECTOR_UNSPECIFIED, valueOf: Xss_AttackVector.valueOf, enumValues: Xss_AttackVector.values)
    ..aOS(4, _omitFieldNames ? '' : 'storedXssSeedingUrl')
    ..hasRequiredFields = false
  ;
...
class Xxe extends $pb.GeneratedMessage {
  factory Xxe({
    $core.String? payloadValue,
    Xxe_Location? payloadLocation,
  }) {
    final $result = create();
    if (payloadValue != null) {
      $result.payloadValue = payloadValue;
    }
  ...
  Xxe._() : super();
  factory Xxe.fromBuffer($core.List<$core.int> i, [$pb.ExtensionRegistry r = $pb.ExtensionRegistry.EMPTY]) => create()..mergeFromBuffer(i, r);
  factory Xxe.fromJson($core.String i, [$pb.ExtensionRegistry r = $pb.ExtensionRegistry.EMPTY]) => create()..mergeFromJson(i, r);

  static final $pb.BuilderInfo _i = $pb.BuilderInfo(_omitMessageNames ? '' : 'Xxe', package: const $pb.PackageName(_omitMessageNames ? '' : 'google.cloud.websecurityscanner.v1'), createEmptyInstance: create)
    ..aOS(1, _omitFieldNames ? '' : 'payloadValue')
    ..e<Xxe_Location>(2, _omitFieldNames ? '' : 'payloadLocation', $pb.PbFieldType.OE, defaultOrMaker: Xxe_Location.LOCATION_UNSPECIFIED, valueOf: Xxe_Location.valueOf, enumValues: Xxe_Location.values)
    ..hasRequiredFields = false
  ;
  ...
  'Use [GeneratedMessageGenericExtensions.deepCopy] instead. '
  'Will be removed in next major version')
  Xxe clone() => Xxe()..mergeFromMessage(this);
  @$core.Deprecated(
  'Using this can add significant overhead to your binary. '
  'Use [GeneratedMessageGenericExtensions.rebuild] instead. '
  'Will be removed in next major version')
  Xxe copyWith(void Function(Xxe) updates) => super.copyWith((message) => updates(message as Xxe)) as Xxe;

  $pb.BuilderInfo get info_ => _i;

  @$core.pragma('dart2js:noInline')
  static Xxe create() => Xxe._();
  Xxe createEmptyInstance() => create();
  static $pb.PbList<Xxe> createRepeated() => $pb.PbList<Xxe>();
  @$core.pragma('dart2js:noInline')
  static Xxe getDefault() => _defaultInstance ??= $pb.GeneratedMessage.$_defaultFor<Xxe>(create);
  static Xxe? _defaultInstance;

  /// The XML string that triggered the XXE vulnerability. Non-payload values
  /// might be redacted.
  @$pb.TagNumber(1)
  $core.String get payloadValue => $_getSZ(0);
  @$pb.TagNumber(1)
  set payloadValue($core.String v) { $_setString(0, v); }
  @$pb.TagNumber(1)
  $core.bool hasPayloadValue() => $_has(0);
  @$pb.TagNumber(1)
  void clearPayloadValue() => clearField(1);

  /// Location within the request where the payload was placed.
  @$pb.TagNumber(2)
  Xxe_Location get payloadLocation => $_getN(1);
  @$pb.TagNumber(2)
  set payloadLocation(Xxe_Location v) { setField(2, v); }
  @$pb.TagNumber(2)
  $core.bool hasPayloadLocation() => $_has(1);
  @$pb.TagNumber(2)
  void clearPayloadLocation() => clearField(2);
}
