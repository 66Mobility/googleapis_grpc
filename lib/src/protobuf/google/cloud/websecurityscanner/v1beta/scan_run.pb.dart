...
import 'scan_run_error_trace.pb.dart' as $4740;
import 'scan_run_warning_trace.pb.dart' as $4741;
...
class ScanRun extends $pb.GeneratedMessage {
  factory ScanRun({
    ...
    $4740.ScanRunErrorTrace? errorTrace,
    $core.Iterable<$4741.ScanRunWarningTrace>? warningTraces,
  }) {
    final $result = create();
    if (name != null) {
      $result.name = name;
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(_omitMessageNames ? '' : 'ScanRun', package: const $pb.PackageName(_omitMessageNames ? '' : 'google.cloud.websecurityscanner.v1beta'), createEmptyInstance: create)
    ...
    ..aOM<$4740.ScanRunErrorTrace>(10, _omitFieldNames ? '' : 'errorTrace', subBuilder: $4740.ScanRunErrorTrace.create)
    ..pc<$4741.ScanRunWarningTrace>(11, _omitFieldNames ? '' : 'warningTraces', $pb.PbFieldType.PM, subBuilder: $4741.ScanRunWarningTrace.create)
  ...
  @$pb.TagNumber(10)
  $4740.ScanRunErrorTrace get errorTrace => $_getN(9);
  @$pb.TagNumber(10)
  set errorTrace($4740.ScanRunErrorTrace v) { setField(10, v); }
  @$pb.TagNumber(10)
  $core.bool hasErrorTrace() => $_has(9);
  @$pb.TagNumber(10)
  void clearErrorTrace() => clearField(10);
  @$pb.TagNumber(10)
  $4740.ScanRunErrorTrace ensureErrorTrace() => $_ensure(9);

  /// A list of warnings, if such are encountered during this scan run.
  @$pb.TagNumber(11)
  $core.List<$4741.ScanRunWarningTrace> get warningTraces => $_getList(10);
}
