...
const VulnerableHeaders$json = {
  '1': 'VulnerableHeaders',
  '2': [
    {'1': 'headers', '3': 1, '4': 3, '5': 11, '6': '.google.cloud.websecurityscanner.v1beta.VulnerableHeaders.Header', '10': 'headers'},
    {'1': 'missing_headers', '3': 2, '4': 3, '5': 11, '6': '.google.cloud.websecurityscanner.v1beta.VulnerableHeaders.Header', '10': 'missingHeaders'},
  ],
...
final $typed_data.Uint8List vulnerableHeadersDescriptor = $convert.base64Decode(
    'ChFWdWxuZXJhYmxlSGVhZGVycxJaCgdoZWFkZXJzGAEgAygLMkAuZ29vZ2xlLmNsb3VkLndlYn'
    'NlY3VyaXR5c2Nhbm5lci52MWJldGEuVnVsbmVyYWJsZUhlYWRlcnMuSGVhZGVyUgdoZWFkZXJz'
    'EmkKD21pc3NpbmdfaGVhZGVycxgCIAMoCzJALmdvb2dsZS5jbG91ZC53ZWJzZWN1cml0eXNjYW'
    '5uZXIudjFiZXRhLlZ1bG5lcmFibGVIZWFkZXJzLkhlYWRlclIObWlzc2luZ0hlYWRlcnMaMgoG'
    'SGVhZGVyEhIKBG5hbWUYASABKAlSBG5hbWUSFAoFdmFsdWUYAiABKAlSBXZhbHVl');
