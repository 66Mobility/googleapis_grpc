...
class ScanConfig_Authentication_GoogleAccount extends $pb.GeneratedMessage {
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(_omitMessageNames ? '' : 'ScanConfig.Authentication.GoogleAccount', package: const $pb.PackageName(_omitMessageNames ? '' : 'google.cloud.websecurityscanner.v1beta'), createEmptyInstance: create)
...
class ScanConfig_Authentication_CustomAccount extends $pb.GeneratedMessage {
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(_omitMessageNames ? '' : 'ScanConfig.Authentication.CustomAccount', package: const $pb.PackageName(_omitMessageNames ? '' : 'google.cloud.websecurityscanner.v1beta'), createEmptyInstance: create)
    ..aOS(1, _omitFieldNames ? '' : 'username')
    ..aOS(2, _omitFieldNames ? '' : 'password')
...
class ScanConfig_Authentication extends $pb.GeneratedMessage {
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(_omitMessageNames ? '' : 'ScanConfig.Authentication', package: const $pb.PackageName(_omitMessageNames ? '' : 'google.cloud.websecurityscanner.v1beta'), createEmptyInstance: create)
    ..oo(0, [1, 2])
...
class ScanConfig_Schedule extends $pb.GeneratedMessage {
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(_omitMessageNames ? '' : 'ScanConfig.Schedule', package: const $pb.PackageName(_omitMessageNames ? '' : 'google.cloud.websecurityscanner.v1beta'), createEmptyInstance: create)
...
class ScanConfig extends $pb.GeneratedMessage {
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(_omitMessageNames ? '' : 'ScanConfig', package: const $pb.PackageName(_omitMessageNames ? '' : 'google.cloud.websecurityscanner.v1beta'), createEmptyInstance: create)
    ...
    ..aOM<$1521.ScanRun>(11, _omitFieldNames ? '' : 'latestRun', subBuilder: $1521.ScanRun.create)
  ...
  @$pb.TagNumber(11)
  $1521.ScanRun get latestRun => $_getN(10);
  @$pb.TagNumber(11)
  set latestRun($1521.ScanRun v) { setField(11, v); }
  @$pb.TagNumber(11)
  $core.bool hasLatestRun() => $_has(10);
  @$pb.TagNumber(11)
  void clearLatestRun() => clearField(11);
  @$pb.TagNumber(11)
  $1521.ScanRun ensureLatestRun() => $_ensure(10);
