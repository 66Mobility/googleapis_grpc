...
class Finding extends $pb.GeneratedMessage {
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(_omitMessageNames ? '' : 'Finding', package: const $pb.PackageName(_omitMessageNames ? '' : 'google.cloud.websecurityscanner.v1alpha'), createEmptyInstance: create)
    ..aOS(1, _omitFieldNames ? '' : 'name')
    ..e<Finding_FindingType>(2, _omitFieldNames ? '' : 'findingType', $pb.PbFieldType.OE, defaultOrMaker: Finding_FindingType.FINDING_TYPE_UNSPECIFIED, valueOf: Finding_FindingType.valueOf, enumValues: Finding_FindingType.values)
