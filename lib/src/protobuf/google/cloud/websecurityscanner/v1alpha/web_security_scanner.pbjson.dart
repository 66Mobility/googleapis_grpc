...
const CreateScanConfigRequest$json = {
  ...
  '2': [
    ...
    {'1': 'scan_config', '3': 2, '4': 1, '5': 11, '6': '.google.cloud.websecurityscanner.v1alpha.ScanConfig', '8': {}, '10': 'scanConfig'},
  ],
};
...
final $typed_data.Uint8List createScanConfigRequestDescriptor = $convert.base64Decode(
    ...
    'RyZXNvdXJjZW1hbmFnZXIuZ29vZ2xlYXBpcy5jb20vUHJvamVjdFIGcGFyZW50ElkKC3NjYW5f'
    'Y29uZmlnGAIgASgLMjMuZ29vZ2xlLmNsb3VkLndlYnNlY3VyaXR5c2Nhbm5lci52MWFscGhhLl'
    'NjYW5Db25maWdCA+BBAlIKc2NhbkNvbmZpZw==');
...
final $typed_data.Uint8List updateScanConfigRequestDescriptor = $convert.base64Decode(
    'ChdVcGRhdGVTY2FuQ29uZmlnUmVxdWVzdBJZCgtzY2FuX2NvbmZpZxgCIAEoCzIzLmdvb2dsZS'
    '5jbG91ZC53ZWJzZWN1cml0eXNjYW5uZXIudjFhbHBoYS5TY2FuQ29uZmlnQgPgQQJSCnNjYW5D'
    'b25maWcSQAoLdXBkYXRlX21hc2sYAyABKAsyGi5nb29nbGUucHJvdG9idWYuRmllbGRNYXNrQg'
...
const ListScanConfigsResponse$json = {
  ...
  '2': [
    {'1': 'scan_configs', '3': 1, '4': 3, '5': 11, '6': '.google.cloud.websecurityscanner.v1alpha.ScanConfig', '10': 'scanConfigs'},
...
final $typed_data.Uint8List listScanConfigsResponseDescriptor = $convert.base64Decode(
    'ChdMaXN0U2NhbkNvbmZpZ3NSZXNwb25zZRJWCgxzY2FuX2NvbmZpZ3MYASADKAsyMy5nb29nbG'
    'UuY2xvdWQud2Vic2VjdXJpdHlzY2FubmVyLnYxYWxwaGEuU2NhbkNvbmZpZ1ILc2NhbkNvbmZp'
...
const ListScanRunsResponse$json = {
  ...
  '2': [
    {'1': 'scan_runs', '3': 1, '4': 3, '5': 11, '6': '.google.cloud.websecurityscanner.v1alpha.ScanRun', '10': 'scanRuns'},
    {'1': 'next_page_token', '3': 2, '4': 1, '5': 9, '10': 'nextPageToken'},
  ],
};
...
final $typed_data.Uint8List listScanRunsResponseDescriptor = $convert.base64Decode(
    'ChRMaXN0U2NhblJ1bnNSZXNwb25zZRJNCglzY2FuX3J1bnMYASADKAsyMC5nb29nbGUuY2xvdW'
    'Qud2Vic2VjdXJpdHlzY2FubmVyLnYxYWxwaGEuU2NhblJ1blIIc2NhblJ1bnMSJgoPbmV4dF9w'
...
const ListCrawledUrlsResponse$json = {
  ...
  '2': [
    {'1': 'crawled_urls', '3': 1, '4': 3, '5': 11, '6': '.google.cloud.websecurityscanner.v1alpha.CrawledUrl', '10': 'crawledUrls'},
    {'1': 'next_page_token', '3': 2, '4': 1, '5': 9, '10': 'nextPageToken'},
  ],
};
...
final $typed_data.Uint8List listCrawledUrlsResponseDescriptor = $convert.base64Decode(
    'ChdMaXN0Q3Jhd2xlZFVybHNSZXNwb25zZRJWCgxjcmF3bGVkX3VybHMYASADKAsyMy5nb29nbG'
    'UuY2xvdWQud2Vic2VjdXJpdHlzY2FubmVyLnYxYWxwaGEuQ3Jhd2xlZFVybFILY3Jhd2xlZFVy'
    'bHMSJgoPbmV4dF9wYWdlX3Rva2VuGAIgASgJUg1uZXh0UGFnZVRva2Vu');
...
const ListFindingsResponse$json = {
  ...
  '2': [
    {'1': 'findings', '3': 1, '4': 3, '5': 11, '6': '.google.cloud.websecurityscanner.v1alpha.Finding', '10': 'findings'},
    {'1': 'next_page_token', '3': 2, '4': 1, '5': 9, '10': 'nextPageToken'},
  ],
};
...
final $typed_data.Uint8List listFindingsResponseDescriptor = $convert.base64Decode(
    'ChRMaXN0RmluZGluZ3NSZXNwb25zZRJMCghmaW5kaW5ncxgBIAMoCzIwLmdvb2dsZS5jbG91ZC'
    '53ZWJzZWN1cml0eXNjYW5uZXIudjFhbHBoYS5GaW5kaW5nUghmaW5kaW5ncxImCg9uZXh0X3Bh'
...
const ListFindingTypeStatsResponse$json = {
  ...
  '2': [
    {'1': 'finding_type_stats', '3': 1, '4': 3, '5': 11, '6': '.google.cloud.websecurityscanner.v1alpha.FindingTypeStats', '10': 'findingTypeStats'},
  ],
};
...
final $typed_data.Uint8List listFindingTypeStatsResponseDescriptor = $convert.base64Decode(
    'ChxMaXN0RmluZGluZ1R5cGVTdGF0c1Jlc3BvbnNlEmcKEmZpbmRpbmdfdHlwZV9zdGF0cxgBIA'
    'MoCzI5Lmdvb2dsZS5jbG91ZC53ZWJzZWN1cml0eXNjYW5uZXIudjFhbHBoYS5GaW5kaW5nVHlw'
    'ZVN0YXRzUhBmaW5kaW5nVHlwZVN0YXRz');
