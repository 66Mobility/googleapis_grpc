...
class FindingTypeStats extends $pb.GeneratedMessage {
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(_omitMessageNames ? '' : 'FindingTypeStats', package: const $pb.PackageName(_omitMessageNames ? '' : 'google.cloud.websecurityscanner.v1alpha'), createEmptyInstance: create)
    ..e<$1518.Finding_FindingType>(1, _omitFieldNames ? '' : 'findingType', $pb.PbFieldType.OE, defaultOrMaker: $1518.Finding_FindingType.FINDING_TYPE_UNSPECIFIED, valueOf: $1518.Finding_FindingType.valueOf, enumValues: $1518.Finding_FindingType.values)
  ...
  @$pb.TagNumber(1)
  $1518.Finding_FindingType get findingType => $_getN(0);
  @$pb.TagNumber(1)
  set findingType($1518.Finding_FindingType v) { setField(1, v); }
  @$pb.TagNumber(1)
