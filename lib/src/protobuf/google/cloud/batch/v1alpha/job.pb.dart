...
class Job extends $pb.GeneratedMessage {
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(_omitMessageNames ? '' : 'Job', package: const $pb.PackageName(_omitMessageNames ? '' : 'google.cloud.batch.v1alpha'), createEmptyInstance: create)
    ...
    ..e<Job_SchedulingPolicy>(5, _omitFieldNames ? '' : 'schedulingPolicy', $pb.PbFieldType.OE, defaultOrMaker: Job_SchedulingPolicy.SCHEDULING_POLICY_UNSPECIFIED, valueOf: Job_SchedulingPolicy.valueOf, enumValues: Job_SchedulingPolicy.values)
    ..pc<JobDependency>(6, _omitFieldNames ? '' : 'dependencies', $pb.PbFieldType.PM, subBuilder: JobDependency.create)
  ...
  @$pb.TagNumber(14)
  $core.List<JobNotification> get notifications => $_getList(13);
}
...
class LogsPolicy_CloudLoggingOption extends $pb.GeneratedMessage {
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(_omitMessageNames ? '' : 'LogsPolicy.CloudLoggingOption', package: const $pb.PackageName(_omitMessageNames ? '' : 'google.cloud.batch.v1alpha'), createEmptyInstance: create)
...
class LogsPolicy extends $pb.GeneratedMessage {
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(_omitMessageNames ? '' : 'LogsPolicy', package: const $pb.PackageName(_omitMessageNames ? '' : 'google.cloud.batch.v1alpha'), createEmptyInstance: create)
...
class JobDependency extends $pb.GeneratedMessage {
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(_omitMessageNames ? '' : 'JobDependency', package: const $pb.PackageName(_omitMessageNames ? '' : 'google.cloud.batch.v1alpha'), createEmptyInstance: create)
    ..m<$core.String, JobDependency_Type>(1, _omitFieldNames ? '' : 'items', entryClassName: 'JobDependency.ItemsEntry', keyFieldType: $pb.PbFieldType.OS, valueFieldType: $pb.PbFieldType.OE, valueOf: JobDependency_Type.valueOf, enumValues: JobDependency_Type.values, valueDefaultOrMaker: JobDependency_Type.TYPE_UNSPECIFIED, defaultEnumValue: JobDependency_Type.TYPE_UNSPECIFIED, packageName: const $pb.PackageName('google.cloud.batch.v1alpha'))
    ..hasRequiredFields = false
  ;
  ...
  'Use [GeneratedMessageGenericExtensions.rebuild] instead. '
  'Will be removed in next major version')
  JobDependency copyWith(void Function(JobDependency) updates) => super.copyWith((message) => updates(message as JobDependency)) as JobDependency;
...
class JobStatus_InstanceStatus extends $pb.GeneratedMessage {
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(_omitMessageNames ? '' : 'JobStatus.InstanceStatus', package: const $pb.PackageName(_omitMessageNames ? '' : 'google.cloud.batch.v1alpha'), createEmptyInstance: create)
...
class JobStatus_TaskGroupStatus extends $pb.GeneratedMessage {
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(_omitMessageNames ? '' : 'JobStatus.TaskGroupStatus', package: const $pb.PackageName(_omitMessageNames ? '' : 'google.cloud.batch.v1alpha'), createEmptyInstance: create)
    ..m<$core.String, $fixnum.Int64>(1, _omitFieldNames ? '' : 'counts', entryClassName: 'JobStatus.TaskGroupStatus.CountsEntry', keyFieldType: $pb.PbFieldType.OS, valueFieldType: $pb.PbFieldType.O6, packageName: const $pb.PackageName('google.cloud.batch.v1alpha'))
...
class JobStatus extends $pb.GeneratedMessage {
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(_omitMessageNames ? '' : 'JobStatus', package: const $pb.PackageName(_omitMessageNames ? '' : 'google.cloud.batch.v1alpha'), createEmptyInstance: create)
  ...
  /// Job status events
  @$pb.TagNumber(2)
  $core.List<$698.StatusEvent> get statusEvents => $_getList(1);
  ...
  @$pb.TagNumber(6)
  ResourceUsage get resourceUsage => $_getN(4);
  @$pb.TagNumber(6)
  set resourceUsage(ResourceUsage v) { setField(6, v); }
  @$pb.TagNumber(6)
  $core.bool hasResourceUsage() => $_has(4);
  @$pb.TagNumber(6)
  void clearResourceUsage() => clearField(6);
  @$pb.TagNumber(6)
  ResourceUsage ensureResourceUsage() => $_ensure(4);
}

/// ResourceUsage describes the resource usage of the job.
class ResourceUsage extends $pb.GeneratedMessage {
  factory ResourceUsage({
    $core.double? coreHours,
  }) {
    final $result = create();
    if (coreHours != null) {
      $result.coreHours = coreHours;
    }
    return $result;
  }
  ResourceUsage._() : super();
  factory ResourceUsage.fromBuffer($core.List<$core.int> i, [$pb.ExtensionRegistry r = $pb.ExtensionRegistry.EMPTY]) => create()..mergeFromBuffer(i, r);
  factory ResourceUsage.fromJson($core.String i, [$pb.ExtensionRegistry r = $pb.ExtensionRegistry.EMPTY]) => create()..mergeFromJson(i, r);

  static final $pb.BuilderInfo _i = $pb.BuilderInfo(_omitMessageNames ? '' : 'ResourceUsage', package: const $pb.PackageName(_omitMessageNames ? '' : 'google.cloud.batch.v1alpha'), createEmptyInstance: create)
    ..a<$core.double>(1, _omitFieldNames ? '' : 'coreHours', $pb.PbFieldType.OD)
    ..hasRequiredFields = false
  ;
  ...
  'Use [GeneratedMessageGenericExtensions.deepCopy] instead. '
  'Will be removed in next major version')
  ResourceUsage clone() => ResourceUsage()..mergeFromMessage(this);
  @$core.Deprecated(
  'Using this can add significant overhead to your binary. '
  'Use [GeneratedMessageGenericExtensions.rebuild] instead. '
  'Will be removed in next major version')
  ResourceUsage copyWith(void Function(ResourceUsage) updates) => super.copyWith((message) => updates(message as ResourceUsage)) as ResourceUsage;

  $pb.BuilderInfo get info_ => _i;

  @$core.pragma('dart2js:noInline')
  static ResourceUsage create() => ResourceUsage._();
  ResourceUsage createEmptyInstance() => create();
  static $pb.PbList<ResourceUsage> createRepeated() => $pb.PbList<ResourceUsage>();
  @$core.pragma('dart2js:noInline')
  static ResourceUsage getDefault() => _defaultInstance ??= $pb.GeneratedMessage.$_defaultFor<ResourceUsage>(create);
  static ResourceUsage? _defaultInstance;

  /// The CPU core hours that the job consumes.
  @$pb.TagNumber(1)
  $core.double get coreHours => $_getN(0);
  @$pb.TagNumber(1)
  set coreHours($core.double v) { $_setDouble(0, v); }
  @$pb.TagNumber(1)
  $core.bool hasCoreHours() => $_has(0);
  @$pb.TagNumber(1)
  void clearCoreHours() => clearField(1);
}
...
class JobNotification_Message extends $pb.GeneratedMessage {
  factory JobNotification_Message({
    ...
    $698.TaskStatus_State? newTaskState,
  }) {
    final $result = create();
    if (type != null) {
      $result.type = type;
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(_omitMessageNames ? '' : 'JobNotification.Message', package: const $pb.PackageName(_omitMessageNames ? '' : 'google.cloud.batch.v1alpha'), createEmptyInstance: create)
    ...
    ..e<$698.TaskStatus_State>(3, _omitFieldNames ? '' : 'newTaskState', $pb.PbFieldType.OE, defaultOrMaker: $698.TaskStatus_State.STATE_UNSPECIFIED, valueOf: $698.TaskStatus_State.valueOf, enumValues: $698.TaskStatus_State.values)
    ..hasRequiredFields = false
  ;
  ...
  /// The new task state.
  @$pb.TagNumber(3)
  $698.TaskStatus_State get newTaskState => $_getN(2);
  @$pb.TagNumber(3)
  set newTaskState($698.TaskStatus_State v) { setField(3, v); }
  @$pb.TagNumber(3)
...
class JobNotification extends $pb.GeneratedMessage {
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(_omitMessageNames ? '' : 'JobNotification', package: const $pb.PackageName(_omitMessageNames ? '' : 'google.cloud.batch.v1alpha'), createEmptyInstance: create)
...
class AllocationPolicy_LocationPolicy extends $pb.GeneratedMessage {
  factory AllocationPolicy_LocationPolicy({
    ...
    if (deniedLocations != null) {
      $result.deniedLocations.addAll(deniedLocations);
    }
    return $result;
  }
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(_omitMessageNames ? '' : 'AllocationPolicy.LocationPolicy', package: const $pb.PackageName(_omitMessageNames ? '' : 'google.cloud.batch.v1alpha'), createEmptyInstance: create)
    ..pPS(1, _omitFieldNames ? '' : 'allowedLocations')
    ..pPS(2, _omitFieldNames ? '' : 'deniedLocations')
    ..hasRequiredFields = false
  ;
...
class AllocationPolicy_Disk extends $pb.GeneratedMessage {
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(_omitMessageNames ? '' : 'AllocationPolicy.Disk', package: const $pb.PackageName(_omitMessageNames ? '' : 'google.cloud.batch.v1alpha'), createEmptyInstance: create)
    ..oo(0, [4, 5])
...
class AllocationPolicy_AttachedDisk extends $pb.GeneratedMessage {
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(_omitMessageNames ? '' : 'AllocationPolicy.AttachedDisk', package: const $pb.PackageName(_omitMessageNames ? '' : 'google.cloud.batch.v1alpha'), createEmptyInstance: create)
    ..oo(0, [1, 2])
...
class AllocationPolicy_Accelerator extends $pb.GeneratedMessage {
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(_omitMessageNames ? '' : 'AllocationPolicy.Accelerator', package: const $pb.PackageName(_omitMessageNames ? '' : 'google.cloud.batch.v1alpha'), createEmptyInstance: create)
    ..aOS(1, _omitFieldNames ? '' : 'type')
...
class AllocationPolicy_InstancePolicy extends $pb.GeneratedMessage {
  ...
  @$core.Deprecated('This field is deprecated.')
    ...
    if (allowedMachineTypes != null) {
      // ignore: deprecated_member_use_from_same_package
      $result.allowedMachineTypes.addAll(allowedMachineTypes);
    }
    if (machineType != null) {
      $result.machineType = machineType;
    }
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(_omitMessageNames ? '' : 'AllocationPolicy.InstancePolicy', package: const $pb.PackageName(_omitMessageNames ? '' : 'google.cloud.batch.v1alpha'), createEmptyInstance: create)
    ..pPS(1, _omitFieldNames ? '' : 'allowedMachineTypes')
  ...
  @$pb.TagNumber(3)
  $core.String get minCpuPlatform => $_getSZ(2);
  @$pb.TagNumber(3)
  set minCpuPlatform($core.String v) { $_setString(2, v); }
  @$pb.TagNumber(3)
  $core.bool hasMinCpuPlatform() => $_has(2);
  @$pb.TagNumber(3)
  void clearMinCpuPlatform() => clearField(3);

  /// The provisioning model.
  @$pb.TagNumber(4)
  AllocationPolicy_ProvisioningModel get provisioningModel => $_getN(3);
  @$pb.TagNumber(4)
  set provisioningModel(AllocationPolicy_ProvisioningModel v) { setField(4, v); }
  @$pb.TagNumber(4)
  $core.bool hasProvisioningModel() => $_has(3);
  @$pb.TagNumber(4)
  void clearProvisioningModel() => clearField(4);

  /// The accelerators attached to each VM instance.
  @$pb.TagNumber(5)
  $core.List<AllocationPolicy_Accelerator> get accelerators => $_getList(4);
  ...
  @$pb.TagNumber(6)
  $core.List<AllocationPolicy_AttachedDisk> get disks => $_getList(5);
  ...
  @$pb.TagNumber(7)
  $core.String get reservation => $_getSZ(6);
  @$pb.TagNumber(7)
  set reservation($core.String v) { $_setString(6, v); }
  @$pb.TagNumber(7)
  $core.bool hasReservation() => $_has(6);
  @$pb.TagNumber(7)
  ...
  @$pb.TagNumber(8)
  AllocationPolicy_Disk get bootDisk => $_getN(7);
  @$pb.TagNumber(8)
  set bootDisk(AllocationPolicy_Disk v) { setField(8, v); }
  @$pb.TagNumber(8)
  $core.bool hasBootDisk() => $_has(7);
  @$pb.TagNumber(8)
  void clearBootDisk() => clearField(8);
  @$pb.TagNumber(8)
  AllocationPolicy_Disk ensureBootDisk() => $_ensure(7);
}
...
class AllocationPolicy_InstancePolicyOrTemplate extends $pb.GeneratedMessage {
  factory AllocationPolicy_InstancePolicyOrTemplate({
    ...
    if (blockProjectSshKeys != null) {
      $result.blockProjectSshKeys = blockProjectSshKeys;
    }
    return $result;
  }
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(_omitMessageNames ? '' : 'AllocationPolicy.InstancePolicyOrTemplate', package: const $pb.PackageName(_omitMessageNames ? '' : 'google.cloud.batch.v1alpha'), createEmptyInstance: create)
    ..oo(0, [1, 2])
    ...
    ..aOB(5, _omitFieldNames ? '' : 'blockProjectSshKeys')
    ..hasRequiredFields = false
  ;
  ...
  @$pb.TagNumber(5)
  $core.bool get blockProjectSshKeys => $_getBF(4);
  @$pb.TagNumber(5)
  set blockProjectSshKeys($core.bool v) { $_setBool(4, v); }
  @$pb.TagNumber(5)
  $core.bool hasBlockProjectSshKeys() => $_has(4);
  @$pb.TagNumber(5)
  void clearBlockProjectSshKeys() => clearField(5);
}
...
class AllocationPolicy_NetworkInterface extends $pb.GeneratedMessage {
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(_omitMessageNames ? '' : 'AllocationPolicy.NetworkInterface', package: const $pb.PackageName(_omitMessageNames ? '' : 'google.cloud.batch.v1alpha'), createEmptyInstance: create)
...
class AllocationPolicy_NetworkPolicy extends $pb.GeneratedMessage {
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(_omitMessageNames ? '' : 'AllocationPolicy.NetworkPolicy', package: const $pb.PackageName(_omitMessageNames ? '' : 'google.cloud.batch.v1alpha'), createEmptyInstance: create)
...
class AllocationPolicy_PlacementPolicy extends $pb.GeneratedMessage {
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(_omitMessageNames ? '' : 'AllocationPolicy.PlacementPolicy', package: const $pb.PackageName(_omitMessageNames ? '' : 'google.cloud.batch.v1alpha'), createEmptyInstance: create)
...
class AllocationPolicy extends $pb.GeneratedMessage {
  ...
  @$core.Deprecated('This field is deprecated.')
    ...
    if (instanceTemplates != null) {
      // ignore: deprecated_member_use_from_same_package
      $result.instanceTemplates.addAll(instanceTemplates);
    }
    if (provisioningModels != null) {
      // ignore: deprecated_member_use_from_same_package
      $result.provisioningModels.addAll(provisioningModels);
    }
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(_omitMessageNames ? '' : 'AllocationPolicy', package: const $pb.PackageName(_omitMessageNames ? '' : 'google.cloud.batch.v1alpha'), createEmptyInstance: create)
    ..aOM<AllocationPolicy_LocationPolicy>(1, _omitFieldNames ? '' : 'location', subBuilder: AllocationPolicy_LocationPolicy.create)
    ..aOM<AllocationPolicy_InstancePolicy>(2, _omitFieldNames ? '' : 'instance', subBuilder: AllocationPolicy_InstancePolicy.create)
    ..pPS(3, _omitFieldNames ? '' : 'instanceTemplates')
    ..pc<AllocationPolicy_ProvisioningModel>(4, _omitFieldNames ? '' : 'provisioningModels', $pb.PbFieldType.KE, valueOf: AllocationPolicy_ProvisioningModel.valueOf, enumValues: AllocationPolicy_ProvisioningModel.values, defaultEnumValue: AllocationPolicy_ProvisioningModel.PROVISIONING_MODEL_UNSPECIFIED)
    ..aOS(5, _omitFieldNames ? '' : 'serviceAccountEmail')
    ..m<$core.String, $core.String>(6, _omitFieldNames ? '' : 'labels', entryClassName: 'AllocationPolicy.LabelsEntry', keyFieldType: $pb.PbFieldType.OS, valueFieldType: $pb.PbFieldType.OS, packageName: const $pb.PackageName('google.cloud.batch.v1alpha'))
  ...
  @$core.Deprecated('This field is deprecated.')
  @$pb.TagNumber(5)
  $core.String get serviceAccountEmail => $_getSZ(4);
  @$core.Deprecated('This field is deprecated.')
  @$pb.TagNumber(5)
  set serviceAccountEmail($core.String v) { $_setString(4, v); }
  @$core.Deprecated('This field is deprecated.')
  @$pb.TagNumber(5)
  $core.bool hasServiceAccountEmail() => $_has(4);
  @$core.Deprecated('This field is deprecated.')
  @$pb.TagNumber(5)
  void clearServiceAccountEmail() => clearField(5);
  ...
  @$pb.TagNumber(8)
  $core.List<AllocationPolicy_InstancePolicyOrTemplate> get instances => $_getList(7);
  ...
  @$pb.TagNumber(9)
  ServiceAccount get serviceAccount => $_getN(8);
  @$pb.TagNumber(9)
  ...
  @$pb.TagNumber(9)
  ServiceAccount ensureServiceAccount() => $_ensure(8);

  /// The placement policy.
  @$pb.TagNumber(10)
  AllocationPolicy_PlacementPolicy get placement => $_getN(9);
  @$pb.TagNumber(10)
  set placement(AllocationPolicy_PlacementPolicy v) { setField(10, v); }
  @$pb.TagNumber(10)
  $core.bool hasPlacement() => $_has(9);
  @$pb.TagNumber(10)
  void clearPlacement() => clearField(10);
  @$pb.TagNumber(10)
  AllocationPolicy_PlacementPolicy ensurePlacement() => $_ensure(9);
...
class TaskGroup extends $pb.GeneratedMessage {
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(_omitMessageNames ? '' : 'TaskGroup', package: const $pb.PackageName(_omitMessageNames ? '' : 'google.cloud.batch.v1alpha'), createEmptyInstance: create)
    ..aOS(1, _omitFieldNames ? '' : 'name')
    ..aOM<$698.TaskSpec>(3, _omitFieldNames ? '' : 'taskSpec', subBuilder: $698.TaskSpec.create)
    ...
    ..aOM<AllocationPolicy>(7, _omitFieldNames ? '' : 'allocationPolicy', subBuilder: AllocationPolicy.create)
    ..m<$core.String, $core.String>(8, _omitFieldNames ? '' : 'labels', entryClassName: 'TaskGroup.LabelsEntry', keyFieldType: $pb.PbFieldType.OS, valueFieldType: $pb.PbFieldType.OS, packageName: const $pb.PackageName('google.cloud.batch.v1alpha'))
    ..pc<$698.Environment>(9, _omitFieldNames ? '' : 'taskEnvironments', $pb.PbFieldType.PM, subBuilder: $698.Environment.create)
    ...
    ..aOM<ServiceAccount>(15, _omitFieldNames ? '' : 'serviceAccount', subBuilder: ServiceAccount.create)
    ..hasRequiredFields = false
  ;
  ...
  @$pb.TagNumber(3)
  $698.TaskSpec get taskSpec => $_getN(1);
  @$pb.TagNumber(3)
  set taskSpec($698.TaskSpec v) { setField(3, v); }
  @$pb.TagNumber(3)
  $core.bool hasTaskSpec() => $_has(1);
  @$pb.TagNumber(3)
  void clearTaskSpec() => clearField(3);
  @$pb.TagNumber(3)
  $698.TaskSpec ensureTaskSpec() => $_ensure(1);
  ...
  @$pb.TagNumber(9)
  $core.List<$698.Environment> get taskEnvironments => $_getList(7);
  ...
  @$pb.TagNumber(12)
  $core.bool get permissiveSsh => $_getBF(10);
  @$pb.TagNumber(12)
  set permissiveSsh($core.bool v) { $_setBool(10, v); }
  @$pb.TagNumber(12)
  $core.bool hasPermissiveSsh() => $_has(10);
  @$pb.TagNumber(12)
  ...
  @$pb.TagNumber(14)
  $core.bool get runAsNonRoot => $_getBF(11);
  @$pb.TagNumber(14)
  set runAsNonRoot($core.bool v) { $_setBool(11, v); }
  @$pb.TagNumber(14)
  $core.bool hasRunAsNonRoot() => $_has(11);
  @$pb.TagNumber(14)
  ...
  @$pb.TagNumber(15)
  ServiceAccount get serviceAccount => $_getN(12);
  @$pb.TagNumber(15)
  set serviceAccount(ServiceAccount v) { setField(15, v); }
  @$pb.TagNumber(15)
  $core.bool hasServiceAccount() => $_has(12);
  @$pb.TagNumber(15)
  void clearServiceAccount() => clearField(15);
  @$pb.TagNumber(15)
  ServiceAccount ensureServiceAccount() => $_ensure(12);
}
...
class ServiceAccount extends $pb.GeneratedMessage {
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(_omitMessageNames ? '' : 'ServiceAccount', package: const $pb.PackageName(_omitMessageNames ? '' : 'google.cloud.batch.v1alpha'), createEmptyInstance: create)
