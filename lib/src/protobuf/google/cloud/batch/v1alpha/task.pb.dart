...
class ComputeResource extends $pb.GeneratedMessage {
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(_omitMessageNames ? '' : 'ComputeResource', package: const $pb.PackageName(_omitMessageNames ? '' : 'google.cloud.batch.v1alpha'), createEmptyInstance: create)
    ..aInt64(1, _omitFieldNames ? '' : 'cpuMilli')
    ..aInt64(2, _omitFieldNames ? '' : 'memoryMib')
    ..aInt64(3, _omitFieldNames ? '' : 'gpuCount')
...
class StatusEvent extends $pb.GeneratedMessage {
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(_omitMessageNames ? '' : 'StatusEvent', package: const $pb.PackageName(_omitMessageNames ? '' : 'google.cloud.batch.v1alpha'), createEmptyInstance: create)
...
class TaskExecution extends $pb.GeneratedMessage {
  factory TaskExecution({
    ...
    if (stderrSnippet != null) {
      $result.stderrSnippet = stderrSnippet;
    }
    return $result;
  }
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(_omitMessageNames ? '' : 'TaskExecution', package: const $pb.PackageName(_omitMessageNames ? '' : 'google.cloud.batch.v1alpha'), createEmptyInstance: create)
    ..a<$core.int>(1, _omitFieldNames ? '' : 'exitCode', $pb.PbFieldType.O3)
    ..aOS(2, _omitFieldNames ? '' : 'stderrSnippet')
    ..hasRequiredFields = false
  ;
  ...
  @$pb.TagNumber(2)
  $core.String get stderrSnippet => $_getSZ(1);
  @$pb.TagNumber(2)
  set stderrSnippet($core.String v) { $_setString(1, v); }
  @$pb.TagNumber(2)
  $core.bool hasStderrSnippet() => $_has(1);
  @$pb.TagNumber(2)
  void clearStderrSnippet() => clearField(2);
}
...
class TaskStatus extends $pb.GeneratedMessage {
  factory TaskStatus({
    ...
    TaskResourceUsage? resourceUsage,
  }) {
    final $result = create();
    if (state != null) {
      $result.state = state;
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(_omitMessageNames ? '' : 'TaskStatus', package: const $pb.PackageName(_omitMessageNames ? '' : 'google.cloud.batch.v1alpha'), createEmptyInstance: create)
    ...
    ..aOM<TaskResourceUsage>(3, _omitFieldNames ? '' : 'resourceUsage', subBuilder: TaskResourceUsage.create)
    ..hasRequiredFields = false
  ;
  ...
  @$pb.TagNumber(3)
  TaskResourceUsage get resourceUsage => $_getN(2);
  @$pb.TagNumber(3)
  set resourceUsage(TaskResourceUsage v) { setField(3, v); }
  @$pb.TagNumber(3)
  $core.bool hasResourceUsage() => $_has(2);
  @$pb.TagNumber(3)
  void clearResourceUsage() => clearField(3);
  @$pb.TagNumber(3)
  TaskResourceUsage ensureResourceUsage() => $_ensure(2);
}

/// TaskResourceUsage describes the resource usage of the task.
class TaskResourceUsage extends $pb.GeneratedMessage {
  factory TaskResourceUsage({
  ...
  TaskResourceUsage._() : super();
  factory TaskResourceUsage.fromBuffer($core.List<$core.int> i, [$pb.ExtensionRegistry r = $pb.ExtensionRegistry.EMPTY]) => create()..mergeFromBuffer(i, r);
  factory TaskResourceUsage.fromJson($core.String i, [$pb.ExtensionRegistry r = $pb.ExtensionRegistry.EMPTY]) => create()..mergeFromJson(i, r);

  static final $pb.BuilderInfo _i = $pb.BuilderInfo(_omitMessageNames ? '' : 'TaskResourceUsage', package: const $pb.PackageName(_omitMessageNames ? '' : 'google.cloud.batch.v1alpha'), createEmptyInstance: create)
  ...
  'Use [GeneratedMessageGenericExtensions.deepCopy] instead. '
  'Will be removed in next major version')
  TaskResourceUsage clone() => TaskResourceUsage()..mergeFromMessage(this);
  @$core.Deprecated(
  'Using this can add significant overhead to your binary. '
  'Use [GeneratedMessageGenericExtensions.rebuild] instead. '
  'Will be removed in next major version')
  TaskResourceUsage copyWith(void Function(TaskResourceUsage) updates) => super.copyWith((message) => updates(message as TaskResourceUsage)) as TaskResourceUsage;

  $pb.BuilderInfo get info_ => _i;

  @$core.pragma('dart2js:noInline')
  static TaskResourceUsage create() => TaskResourceUsage._();
  TaskResourceUsage createEmptyInstance() => create();
  static $pb.PbList<TaskResourceUsage> createRepeated() => $pb.PbList<TaskResourceUsage>();
  @$core.pragma('dart2js:noInline')
  static TaskResourceUsage getDefault() => _defaultInstance ??= $pb.GeneratedMessage.$_defaultFor<TaskResourceUsage>(create);
  static TaskResourceUsage? _defaultInstance;
...
class Runnable_Container extends $pb.GeneratedMessage {
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(_omitMessageNames ? '' : 'Runnable.Container', package: const $pb.PackageName(_omitMessageNames ? '' : 'google.cloud.batch.v1alpha'), createEmptyInstance: create)
...
class Runnable_Script extends $pb.GeneratedMessage {
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(_omitMessageNames ? '' : 'Runnable.Script', package: const $pb.PackageName(_omitMessageNames ? '' : 'google.cloud.batch.v1alpha'), createEmptyInstance: create)
    ..oo(0, [1, 2])
...
class Runnable_Barrier extends $pb.GeneratedMessage {
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(_omitMessageNames ? '' : 'Runnable.Barrier', package: const $pb.PackageName(_omitMessageNames ? '' : 'google.cloud.batch.v1alpha'), createEmptyInstance: create)
...
class Runnable extends $pb.GeneratedMessage {
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(_omitMessageNames ? '' : 'Runnable', package: const $pb.PackageName(_omitMessageNames ? '' : 'google.cloud.batch.v1alpha'), createEmptyInstance: create)
    ..oo(0, [1, 2, 6])
    ...
    ..m<$core.String, $core.String>(9, _omitFieldNames ? '' : 'labels', entryClassName: 'Runnable.LabelsEntry', keyFieldType: $pb.PbFieldType.OS, valueFieldType: $pb.PbFieldType.OS, packageName: const $pb.PackageName('google.cloud.batch.v1alpha'))
...
class TaskSpec extends $pb.GeneratedMessage {
  ...
  @$core.Deprecated('This field is deprecated.')
    ...
    $core.Iterable<$4363.Volume>? volumes,
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(_omitMessageNames ? '' : 'TaskSpec', package: const $pb.PackageName(_omitMessageNames ? '' : 'google.cloud.batch.v1alpha'), createEmptyInstance: create)
    ...
    ..m<$core.String, $core.String>(6, _omitFieldNames ? '' : 'environments', entryClassName: 'TaskSpec.EnvironmentsEntry', keyFieldType: $pb.PbFieldType.OS, valueFieldType: $pb.PbFieldType.OS, packageName: const $pb.PackageName('google.cloud.batch.v1alpha'))
    ..pc<$4363.Volume>(7, _omitFieldNames ? '' : 'volumes', $pb.PbFieldType.PM, subBuilder: $4363.Volume.create)
  ...
  @$pb.TagNumber(7)
  $core.List<$4363.Volume> get volumes => $_getList(4);
...
class LifecyclePolicy_ActionCondition extends $pb.GeneratedMessage {
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(_omitMessageNames ? '' : 'LifecyclePolicy.ActionCondition', package: const $pb.PackageName(_omitMessageNames ? '' : 'google.cloud.batch.v1alpha'), createEmptyInstance: create)
...
class LifecyclePolicy extends $pb.GeneratedMessage {
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(_omitMessageNames ? '' : 'LifecyclePolicy', package: const $pb.PackageName(_omitMessageNames ? '' : 'google.cloud.batch.v1alpha'), createEmptyInstance: create)
...
class Task extends $pb.GeneratedMessage {
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(_omitMessageNames ? '' : 'Task', package: const $pb.PackageName(_omitMessageNames ? '' : 'google.cloud.batch.v1alpha'), createEmptyInstance: create)
    ..aOS(1, _omitFieldNames ? '' : 'name')
...
class Environment_KMSEnvMap extends $pb.GeneratedMessage {
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(_omitMessageNames ? '' : 'Environment.KMSEnvMap', package: const $pb.PackageName(_omitMessageNames ? '' : 'google.cloud.batch.v1alpha'), createEmptyInstance: create)
...
class Environment extends $pb.GeneratedMessage {
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(_omitMessageNames ? '' : 'Environment', package: const $pb.PackageName(_omitMessageNames ? '' : 'google.cloud.batch.v1alpha'), createEmptyInstance: create)
    ..m<$core.String, $core.String>(1, _omitFieldNames ? '' : 'variables', entryClassName: 'Environment.VariablesEntry', keyFieldType: $pb.PbFieldType.OS, valueFieldType: $pb.PbFieldType.OS, packageName: const $pb.PackageName('google.cloud.batch.v1alpha'))
    ..m<$core.String, $core.String>(2, _omitFieldNames ? '' : 'secretVariables', entryClassName: 'Environment.SecretVariablesEntry', keyFieldType: $pb.PbFieldType.OS, valueFieldType: $pb.PbFieldType.OS, packageName: const $pb.PackageName('google.cloud.batch.v1alpha'))
