...
const ListSecretsResponse$json = {
  ...
  '2': [
    {'1': 'secrets', '3': 1, '4': 3, '5': 11, '6': '.google.cloud.secretmanager.v1.Secret', '10': 'secrets'},
...
final $typed_data.Uint8List listSecretsResponseDescriptor = $convert.base64Decode(
    'ChNMaXN0U2VjcmV0c1Jlc3BvbnNlEj8KB3NlY3JldHMYASADKAsyJS5nb29nbGUuY2xvdWQuc2'
    'VjcmV0bWFuYWdlci52MS5TZWNyZXRSB3NlY3JldHMSJgoPbmV4dF9wYWdlX3Rva2VuGAIgASgJ'
    'Ug1uZXh0UGFnZVRva2VuEh0KCnRvdGFsX3NpemUYAyABKAVSCXRvdGFsU2l6ZQ==');
...
const CreateSecretRequest$json = {
  ...
  '2': [
    ...
    {'1': 'secret', '3': 3, '4': 1, '5': 11, '6': '.google.cloud.secretmanager.v1.Secret', '8': {}, '10': 'secret'},
  ],
};
...
final $typed_data.Uint8List createSecretRequestDescriptor = $convert.base64Decode(
    ...
    '4EECUghzZWNyZXRJZBJCCgZzZWNyZXQYAyABKAsyJS5nb29nbGUuY2xvdWQuc2VjcmV0bWFuYW'
    'dlci52MS5TZWNyZXRCA+BBAlIGc2VjcmV0');
...
const AddSecretVersionRequest$json = {
  ...
  '2': [
    {'1': 'parent', '3': 1, '4': 1, '5': 9, '8': {}, '10': 'parent'},
    {'1': 'payload', '3': 2, '4': 1, '5': 11, '6': '.google.cloud.secretmanager.v1.SecretPayload', '8': {}, '10': 'payload'},
  ],
};
...
final $typed_data.Uint8List addSecretVersionRequestDescriptor = $convert.base64Decode(
    ...
    'V0bWFuYWdlci5nb29nbGVhcGlzLmNvbS9TZWNyZXRSBnBhcmVudBJLCgdwYXlsb2FkGAIgASgL'
    'MiwuZ29vZ2xlLmNsb3VkLnNlY3JldG1hbmFnZXIudjEuU2VjcmV0UGF5bG9hZEID4EECUgdwYX'
    'lsb2Fk');
...
const ListSecretVersionsResponse$json = {
  ...
  '2': [
    {'1': 'versions', '3': 1, '4': 3, '5': 11, '6': '.google.cloud.secretmanager.v1.SecretVersion', '10': 'versions'},
    {'1': 'next_page_token', '3': 2, '4': 1, '5': 9, '10': 'nextPageToken'},
    {'1': 'total_size', '3': 3, '4': 1, '5': 5, '10': 'totalSize'},
  ],
};
...
final $typed_data.Uint8List listSecretVersionsResponseDescriptor = $convert.base64Decode(
    'ChpMaXN0U2VjcmV0VmVyc2lvbnNSZXNwb25zZRJICgh2ZXJzaW9ucxgBIAMoCzIsLmdvb2dsZS'
    '5jbG91ZC5zZWNyZXRtYW5hZ2VyLnYxLlNlY3JldFZlcnNpb25SCHZlcnNpb25zEiYKD25leHRf'
    'cGFnZV90b2tlbhgCIAEoCVINbmV4dFBhZ2VUb2tlbhIdCgp0b3RhbF9zaXplGAMgASgFUgl0b3'
    'RhbFNpemU=');
...
const UpdateSecretRequest$json = {
  ...
  '2': [
    {'1': 'secret', '3': 1, '4': 1, '5': 11, '6': '.google.cloud.secretmanager.v1.Secret', '8': {}, '10': 'secret'},
...
final $typed_data.Uint8List updateSecretRequestDescriptor = $convert.base64Decode(
    'ChNVcGRhdGVTZWNyZXRSZXF1ZXN0EkIKBnNlY3JldBgBIAEoCzIlLmdvb2dsZS5jbG91ZC5zZW'
    'NyZXRtYW5hZ2VyLnYxLlNlY3JldEID4EECUgZzZWNyZXQSQAoLdXBkYXRlX21hc2sYAiABKAsy'
    'Gi5nb29nbGUucHJvdG9idWYuRmllbGRNYXNrQgPgQQJSCnVwZGF0ZU1hc2s=');
...
const AccessSecretVersionResponse$json = {
  ...
  '2': [
    {'1': 'name', '3': 1, '4': 1, '5': 9, '8': {}, '10': 'name'},
    {'1': 'payload', '3': 2, '4': 1, '5': 11, '6': '.google.cloud.secretmanager.v1.SecretPayload', '10': 'payload'},
  ],
};
...
final $typed_data.Uint8List accessSecretVersionResponseDescriptor = $convert.base64Decode(
    ...
    'RtYW5hZ2VyLmdvb2dsZWFwaXMuY29tL1NlY3JldFZlcnNpb25SBG5hbWUSRgoHcGF5bG9hZBgC'
    'IAEoCzIsLmdvb2dsZS5jbG91ZC5zZWNyZXRtYW5hZ2VyLnYxLlNlY3JldFBheWxvYWRSB3BheW'
    'xvYWQ=');
