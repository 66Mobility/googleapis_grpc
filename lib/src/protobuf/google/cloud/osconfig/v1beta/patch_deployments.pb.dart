...
class PatchDeployment extends $pb.GeneratedMessage {
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(_omitMessageNames ? '' : 'PatchDeployment', package: const $pb.PackageName(_omitMessageNames ? '' : 'google.cloud.osconfig.v1beta'), createEmptyInstance: create)
    ..oo(0, [6, 7])
  ...
  @$pb.TagNumber(3)
  $1191.PatchInstanceFilter get instanceFilter => $_getN(2);
  @$pb.TagNumber(3)
  set instanceFilter($1191.PatchInstanceFilter v) { setField(3, v); }
  @$pb.TagNumber(3)
  $core.bool hasInstanceFilter() => $_has(2);
  @$pb.TagNumber(3)
  void clearInstanceFilter() => clearField(3);
  @$pb.TagNumber(3)
  $1191.PatchInstanceFilter ensureInstanceFilter() => $_ensure(2);

  /// Optional. Patch configuration that is applied.
  @$pb.TagNumber(4)
  $1191.PatchConfig get patchConfig => $_getN(3);
  @$pb.TagNumber(4)
  set patchConfig($1191.PatchConfig v) { setField(4, v); }
  @$pb.TagNumber(4)
  $core.bool hasPatchConfig() => $_has(3);
  @$pb.TagNumber(4)
  void clearPatchConfig() => clearField(4);
  @$pb.TagNumber(4)
  $1191.PatchConfig ensurePatchConfig() => $_ensure(3);
  ...
  @$pb.TagNumber(11)
  $1191.PatchRollout get rollout => $_getN(10);
  @$pb.TagNumber(11)
  set rollout($1191.PatchRollout v) { setField(11, v); }
  @$pb.TagNumber(11)
  $core.bool hasRollout() => $_has(10);
  @$pb.TagNumber(11)
  void clearRollout() => clearField(11);
  @$pb.TagNumber(11)
  $1191.PatchRollout ensureRollout() => $_ensure(10);
...
class MonthlySchedule extends $pb.GeneratedMessage {
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(_omitMessageNames ? '' : 'MonthlySchedule', package: const $pb.PackageName(_omitMessageNames ? '' : 'google.cloud.osconfig.v1beta'), createEmptyInstance: create)
    ..oo(0, [1, 2])
...
class CreatePatchDeploymentRequest extends $pb.GeneratedMessage {
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(_omitMessageNames ? '' : 'CreatePatchDeploymentRequest', package: const $pb.PackageName(_omitMessageNames ? '' : 'google.cloud.osconfig.v1beta'), createEmptyInstance: create)
...
class GetPatchDeploymentRequest extends $pb.GeneratedMessage {
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(_omitMessageNames ? '' : 'GetPatchDeploymentRequest', package: const $pb.PackageName(_omitMessageNames ? '' : 'google.cloud.osconfig.v1beta'), createEmptyInstance: create)
    ..aOS(1, _omitFieldNames ? '' : 'name')
    ..hasRequiredFields = false
  ;
...
class ListPatchDeploymentsRequest extends $pb.GeneratedMessage {
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(_omitMessageNames ? '' : 'ListPatchDeploymentsRequest', package: const $pb.PackageName(_omitMessageNames ? '' : 'google.cloud.osconfig.v1beta'), createEmptyInstance: create)
    ..aOS(1, _omitFieldNames ? '' : 'parent')
...
class ListPatchDeploymentsResponse extends $pb.GeneratedMessage {
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(_omitMessageNames ? '' : 'ListPatchDeploymentsResponse', package: const $pb.PackageName(_omitMessageNames ? '' : 'google.cloud.osconfig.v1beta'), createEmptyInstance: create)
...
class DeletePatchDeploymentRequest extends $pb.GeneratedMessage {
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(_omitMessageNames ? '' : 'DeletePatchDeploymentRequest', package: const $pb.PackageName(_omitMessageNames ? '' : 'google.cloud.osconfig.v1beta'), createEmptyInstance: create)
    ..aOS(1, _omitFieldNames ? '' : 'name')
    ..hasRequiredFields = false
  ;
...
class PausePatchDeploymentRequest extends $pb.GeneratedMessage {
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(_omitMessageNames ? '' : 'PausePatchDeploymentRequest', package: const $pb.PackageName(_omitMessageNames ? '' : 'google.cloud.osconfig.v1beta'), createEmptyInstance: create)
    ..aOS(1, _omitFieldNames ? '' : 'name')
    ..hasRequiredFields = false
  ;
...
class ResumePatchDeploymentRequest extends $pb.GeneratedMessage {
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(_omitMessageNames ? '' : 'ResumePatchDeploymentRequest', package: const $pb.PackageName(_omitMessageNames ? '' : 'google.cloud.osconfig.v1beta'), createEmptyInstance: create)
    ..aOS(1, _omitFieldNames ? '' : 'name')
    ..hasRequiredFields = false
  ;
