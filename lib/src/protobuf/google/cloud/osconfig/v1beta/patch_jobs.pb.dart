...
import 'osconfig_common.pb.dart' as $4589;
...
class PatchRollout extends $pb.GeneratedMessage {
  factory PatchRollout({
    ...
    $4589.FixedOrPercent? disruptionBudget,
  }) {
    final $result = create();
    if (mode != null) {
      $result.mode = mode;
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(_omitMessageNames ? '' : 'PatchRollout', package: const $pb.PackageName(_omitMessageNames ? '' : 'google.cloud.osconfig.v1beta'), createEmptyInstance: create)
    ...
    ..aOM<$4589.FixedOrPercent>(2, _omitFieldNames ? '' : 'disruptionBudget', subBuilder: $4589.FixedOrPercent.create)
    ..hasRequiredFields = false
  ;
  ...
  @$pb.TagNumber(2)
  $4589.FixedOrPercent get disruptionBudget => $_getN(1);
  @$pb.TagNumber(2)
  set disruptionBudget($4589.FixedOrPercent v) { setField(2, v); }
  @$pb.TagNumber(2)
  $core.bool hasDisruptionBudget() => $_has(1);
  @$pb.TagNumber(2)
  void clearDisruptionBudget() => clearField(2);
  @$pb.TagNumber(2)
  $4589.FixedOrPercent ensureDisruptionBudget() => $_ensure(1);
}
