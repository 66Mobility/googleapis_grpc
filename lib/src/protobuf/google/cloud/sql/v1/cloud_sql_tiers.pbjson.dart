...
const TiersListResponse$json = {
  ...
  '2': [
    ...
    {'1': 'items', '3': 2, '4': 3, '5': 11, '6': '.google.cloud.sql.v1.Tier', '10': 'items'},
  ],
};
...
final $typed_data.Uint8List tiersListResponseDescriptor = $convert.base64Decode(
    'ChFUaWVyc0xpc3RSZXNwb25zZRISCgRraW5kGAEgASgJUgRraW5kEi8KBWl0ZW1zGAIgAygLMh'
    'kuZ29vZ2xlLmNsb3VkLnNxbC52MS5UaWVyUgVpdGVtcw==');
