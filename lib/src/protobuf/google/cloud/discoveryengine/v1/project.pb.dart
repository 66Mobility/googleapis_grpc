...
class Project_ServiceTerms extends $pb.GeneratedMessage {
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(_omitMessageNames ? '' : 'Project.ServiceTerms', package: const $pb.PackageName(_omitMessageNames ? '' : 'google.cloud.discoveryengine.v1'), createEmptyInstance: create)
...
class Project extends $pb.GeneratedMessage {
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(_omitMessageNames ? '' : 'Project', package: const $pb.PackageName(_omitMessageNames ? '' : 'google.cloud.discoveryengine.v1'), createEmptyInstance: create)
    ..aOS(1, _omitFieldNames ? '' : 'name')
    ..aOM<$1776.Timestamp>(2, _omitFieldNames ? '' : 'createTime', subBuilder: $1776.Timestamp.create)
    ..aOM<$1776.Timestamp>(3, _omitFieldNames ? '' : 'provisionCompletionTime', subBuilder: $1776.Timestamp.create)
    ..m<$core.String, Project_ServiceTerms>(4, _omitFieldNames ? '' : 'serviceTermsMap', entryClassName: 'Project.ServiceTermsMapEntry', keyFieldType: $pb.PbFieldType.OS, valueFieldType: $pb.PbFieldType.OM, valueCreator: Project_ServiceTerms.create, valueDefaultOrMaker: Project_ServiceTerms.getDefault, packageName: const $pb.PackageName('google.cloud.discoveryengine.v1'))
    ..hasRequiredFields = false
  ;
