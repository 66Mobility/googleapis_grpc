...
class UserEvent extends $pb.GeneratedMessage {
  factory UserEvent({
    ...
    $core.Map<$core.String, $4501.CustomAttribute>? attributes,
    MediaInfo? mediaInfo,
    $core.String? engine,
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(_omitMessageNames ? '' : 'UserEvent', package: const $pb.PackageName(_omitMessageNames ? '' : 'google.cloud.discoveryengine.v1'), createEmptyInstance: create)
    ...
    ..aOM<$4501.UserInfo>(4, _omitFieldNames ? '' : 'userInfo', subBuilder: $4501.UserInfo.create)
    ...
    ..m<$core.String, $4501.CustomAttribute>(17, _omitFieldNames ? '' : 'attributes', entryClassName: 'UserEvent.AttributesEntry', keyFieldType: $pb.PbFieldType.OS, valueFieldType: $pb.PbFieldType.OM, valueCreator: $4501.CustomAttribute.create, valueDefaultOrMaker: $4501.CustomAttribute.getDefault, packageName: const $pb.PackageName('google.cloud.discoveryengine.v1'))
  ...
  @$pb.TagNumber(4)
  $4501.UserInfo get userInfo => $_getN(3);
  @$pb.TagNumber(4)
  set userInfo($4501.UserInfo v) { setField(4, v); }
  @$pb.TagNumber(4)
  $core.bool hasUserInfo() => $_has(3);
  @$pb.TagNumber(4)
  void clearUserInfo() => clearField(4);
  @$pb.TagNumber(4)
  $4501.UserInfo ensureUserInfo() => $_ensure(3);
  ...
  @$pb.TagNumber(17)
  $core.Map<$core.String, $4501.CustomAttribute> get attributes => $_getMap(16);
