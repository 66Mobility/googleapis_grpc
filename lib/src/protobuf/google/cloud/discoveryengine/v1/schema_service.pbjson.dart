...
const ListSchemasResponse$json = {
  ...
  '2': [
    {'1': 'schemas', '3': 1, '4': 3, '5': 11, '6': '.google.cloud.discoveryengine.v1.Schema', '10': 'schemas'},
...
final $typed_data.Uint8List listSchemasResponseDescriptor = $convert.base64Decode(
    'ChNMaXN0U2NoZW1hc1Jlc3BvbnNlEkEKB3NjaGVtYXMYASADKAsyJy5nb29nbGUuY2xvdWQuZG'
    'lzY292ZXJ5ZW5naW5lLnYxLlNjaGVtYVIHc2NoZW1hcxImCg9uZXh0X3BhZ2VfdG9rZW4YAiAB'
...
const CreateSchemaRequest$json = {
  ...
  '2': [
    {'1': 'parent', '3': 1, '4': 1, '5': 9, '8': {}, '10': 'parent'},
    {'1': 'schema', '3': 2, '4': 1, '5': 11, '6': '.google.cloud.discoveryengine.v1.Schema', '8': {}, '10': 'schema'},
...
final $typed_data.Uint8List createSchemaRequestDescriptor = $convert.base64Decode(
    ...
    'llbmdpbmUuZ29vZ2xlYXBpcy5jb20vRGF0YVN0b3JlUgZwYXJlbnQSRAoGc2NoZW1hGAIgASgL'
    'MicuZ29vZ2xlLmNsb3VkLmRpc2NvdmVyeWVuZ2luZS52MS5TY2hlbWFCA+BBAlIGc2NoZW1hEi'
    'AKCXNjaGVtYV9pZBgDIAEoCUID4EECUghzY2hlbWFJZA==');

@$core.Deprecated('Use updateSchemaRequestDescriptor instead')
const UpdateSchemaRequest$json = {
  '1': 'UpdateSchemaRequest',
  '2': [
    {'1': 'schema', '3': 1, '4': 1, '5': 11, '6': '.google.cloud.discoveryengine.v1.Schema', '8': {}, '10': 'schema'},
...
final $typed_data.Uint8List updateSchemaRequestDescriptor = $convert.base64Decode(
    'ChNVcGRhdGVTY2hlbWFSZXF1ZXN0EkQKBnNjaGVtYRgBIAEoCzInLmdvb2dsZS5jbG91ZC5kaX'
    'Njb3ZlcnllbmdpbmUudjEuU2NoZW1hQgPgQQJSBnNjaGVtYRIjCg1hbGxvd19taXNzaW5nGAMg'
    'ASgIUgxhbGxvd01pc3Npbmc=');
