...
class CreateDataStoreRequest extends $pb.GeneratedMessage {
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(_omitMessageNames ? '' : 'CreateDataStoreRequest', package: const $pb.PackageName(_omitMessageNames ? '' : 'google.cloud.discoveryengine.v1'), createEmptyInstance: create)
    ..aOS(1, _omitFieldNames ? '' : 'parent')
    ..aOM<$935.DataStore>(2, _omitFieldNames ? '' : 'dataStore', subBuilder: $935.DataStore.create)
  ...
  /// create.
  @$pb.TagNumber(2)
  $935.DataStore get dataStore => $_getN(1);
  @$pb.TagNumber(2)
  set dataStore($935.DataStore v) { setField(2, v); }
  @$pb.TagNumber(2)
  $core.bool hasDataStore() => $_has(1);
  @$pb.TagNumber(2)
  void clearDataStore() => clearField(2);
  @$pb.TagNumber(2)
  $935.DataStore ensureDataStore() => $_ensure(1);
...
class GetDataStoreRequest extends $pb.GeneratedMessage {
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(_omitMessageNames ? '' : 'GetDataStoreRequest', package: const $pb.PackageName(_omitMessageNames ? '' : 'google.cloud.discoveryengine.v1'), createEmptyInstance: create)
...
class CreateDataStoreMetadata extends $pb.GeneratedMessage {
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(_omitMessageNames ? '' : 'CreateDataStoreMetadata', package: const $pb.PackageName(_omitMessageNames ? '' : 'google.cloud.discoveryengine.v1'), createEmptyInstance: create)
...
class ListDataStoresRequest extends $pb.GeneratedMessage {
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(_omitMessageNames ? '' : 'ListDataStoresRequest', package: const $pb.PackageName(_omitMessageNames ? '' : 'google.cloud.discoveryengine.v1'), createEmptyInstance: create)
    ..aOS(1, _omitFieldNames ? '' : 'parent')
...
class ListDataStoresResponse extends $pb.GeneratedMessage {
  factory ListDataStoresResponse({
    $core.Iterable<$935.DataStore>? dataStores,
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(_omitMessageNames ? '' : 'ListDataStoresResponse', package: const $pb.PackageName(_omitMessageNames ? '' : 'google.cloud.discoveryengine.v1'), createEmptyInstance: create)
    ..pc<$935.DataStore>(1, _omitFieldNames ? '' : 'dataStores', $pb.PbFieldType.PM, subBuilder: $935.DataStore.create)
  ...
  @$pb.TagNumber(1)
  $core.List<$935.DataStore> get dataStores => $_getList(0);
...
class DeleteDataStoreRequest extends $pb.GeneratedMessage {
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(_omitMessageNames ? '' : 'DeleteDataStoreRequest', package: const $pb.PackageName(_omitMessageNames ? '' : 'google.cloud.discoveryengine.v1'), createEmptyInstance: create)
    ..aOS(1, _omitFieldNames ? '' : 'name')
    ..hasRequiredFields = false
  ;
...
class UpdateDataStoreRequest extends $pb.GeneratedMessage {
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(_omitMessageNames ? '' : 'UpdateDataStoreRequest', package: const $pb.PackageName(_omitMessageNames ? '' : 'google.cloud.discoveryengine.v1'), createEmptyInstance: create)
    ..aOM<$935.DataStore>(1, _omitFieldNames ? '' : 'dataStore', subBuilder: $935.DataStore.create)
  ...
  ///  does not exist, a NOT_FOUND error is returned.
  @$pb.TagNumber(1)
  $935.DataStore get dataStore => $_getN(0);
  @$pb.TagNumber(1)
  set dataStore($935.DataStore v) { setField(1, v); }
  @$pb.TagNumber(1)
  $core.bool hasDataStore() => $_has(0);
  @$pb.TagNumber(1)
  void clearDataStore() => clearField(1);
  @$pb.TagNumber(1)
  $935.DataStore ensureDataStore() => $_ensure(0);
...
class DeleteDataStoreMetadata extends $pb.GeneratedMessage {
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(_omitMessageNames ? '' : 'DeleteDataStoreMetadata', package: const $pb.PackageName(_omitMessageNames ? '' : 'google.cloud.discoveryengine.v1'), createEmptyInstance: create)
    ..aOM<$1776.Timestamp>(1, _omitFieldNames ? '' : 'createTime', subBuilder: $1776.Timestamp.create)
    ..aOM<$1776.Timestamp>(2, _omitFieldNames ? '' : 'updateTime', subBuilder: $1776.Timestamp.create)
    ..hasRequiredFields = false
  ;
