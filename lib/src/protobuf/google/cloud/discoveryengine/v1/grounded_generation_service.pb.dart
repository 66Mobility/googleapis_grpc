...
import 'grounding.pb.dart' as $4503;
...
class CheckGroundingRequest extends $pb.GeneratedMessage {
  factory CheckGroundingRequest({
    ...
    $core.Iterable<$4503.GroundingFact>? facts,
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(_omitMessageNames ? '' : 'CheckGroundingRequest', package: const $pb.PackageName(_omitMessageNames ? '' : 'google.cloud.discoveryengine.v1'), createEmptyInstance: create)
    ...
    ..pc<$4503.GroundingFact>(3, _omitFieldNames ? '' : 'facts', $pb.PbFieldType.PM, subBuilder: $4503.GroundingFact.create)
  ...
  @$pb.TagNumber(3)
  $core.List<$4503.GroundingFact> get facts => $_getList(2);
...
class CheckGroundingResponse extends $pb.GeneratedMessage {
  factory CheckGroundingResponse({
    ...
    $core.Iterable<$4503.FactChunk>? citedChunks,
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(_omitMessageNames ? '' : 'CheckGroundingResponse', package: const $pb.PackageName(_omitMessageNames ? '' : 'google.cloud.discoveryengine.v1'), createEmptyInstance: create)
    ...
    ..pc<$4503.FactChunk>(3, _omitFieldNames ? '' : 'citedChunks', $pb.PbFieldType.PM, subBuilder: $4503.FactChunk.create)
  ...
  @$pb.TagNumber(3)
  $core.List<$4503.FactChunk> get citedChunks => $_getList(1);
