...
import 'grounding.pb.dart' as $4505;
...
class CheckGroundingSpec extends $pb.GeneratedMessage {
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(_omitMessageNames ? '' : 'CheckGroundingSpec', package: const $pb.PackageName(_omitMessageNames ? '' : 'google.cloud.discoveryengine.v1'), createEmptyInstance: create)
...
class CheckGroundingRequest extends $pb.GeneratedMessage {
  factory CheckGroundingRequest({
    ...
    $core.Iterable<$4505.GroundingFact>? facts,
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(_omitMessageNames ? '' : 'CheckGroundingRequest', package: const $pb.PackageName(_omitMessageNames ? '' : 'google.cloud.discoveryengine.v1'), createEmptyInstance: create)
    ..aOS(1, _omitFieldNames ? '' : 'groundingConfig')
    ..aOS(2, _omitFieldNames ? '' : 'answerCandidate')
    ..pc<$4505.GroundingFact>(3, _omitFieldNames ? '' : 'facts', $pb.PbFieldType.PM, subBuilder: $4505.GroundingFact.create)
    ..aOM<CheckGroundingSpec>(4, _omitFieldNames ? '' : 'groundingSpec', subBuilder: CheckGroundingSpec.create)
    ..m<$core.String, $core.String>(5, _omitFieldNames ? '' : 'userLabels', entryClassName: 'CheckGroundingRequest.UserLabelsEntry', keyFieldType: $pb.PbFieldType.OS, valueFieldType: $pb.PbFieldType.OS, packageName: const $pb.PackageName('google.cloud.discoveryengine.v1'))
    ..hasRequiredFields = false
  ;
  ...
  @$pb.TagNumber(3)
  $core.List<$4505.GroundingFact> get facts => $_getList(2);
...
class CheckGroundingResponse_Claim extends $pb.GeneratedMessage {
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(_omitMessageNames ? '' : 'CheckGroundingResponse.Claim', package: const $pb.PackageName(_omitMessageNames ? '' : 'google.cloud.discoveryengine.v1'), createEmptyInstance: create)
...
class CheckGroundingResponse extends $pb.GeneratedMessage {
  factory CheckGroundingResponse({
    ...
    $core.Iterable<$4505.FactChunk>? citedChunks,
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(_omitMessageNames ? '' : 'CheckGroundingResponse', package: const $pb.PackageName(_omitMessageNames ? '' : 'google.cloud.discoveryengine.v1'), createEmptyInstance: create)
    ..a<$core.double>(1, _omitFieldNames ? '' : 'supportScore', $pb.PbFieldType.OF)
    ..pc<$4505.FactChunk>(3, _omitFieldNames ? '' : 'citedChunks', $pb.PbFieldType.PM, subBuilder: $4505.FactChunk.create)
  ...
  @$pb.TagNumber(3)
  $core.List<$4505.FactChunk> get citedChunks => $_getList(1);
