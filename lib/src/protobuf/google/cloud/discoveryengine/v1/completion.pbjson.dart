...
const SuggestionDenyListEntry$json = {
  ...
  '2': [
    ...
    {'1': 'match_operator', '3': 2, '4': 1, '5': 14, '6': '.google.cloud.discoveryengine.v1.SuggestionDenyListEntry.MatchOperator', '8': {}, '10': 'matchOperator'},
  ],
...
final $typed_data.Uint8List suggestionDenyListEntryDescriptor = $convert.base64Decode(
    ...
    'xvY2tQaHJhc2UScgoObWF0Y2hfb3BlcmF0b3IYAiABKA4yRi5nb29nbGUuY2xvdWQuZGlzY292'
    'ZXJ5ZW5naW5lLnYxLlN1Z2dlc3Rpb25EZW55TGlzdEVudHJ5Lk1hdGNoT3BlcmF0b3JCA+BBAl'
    'INbWF0Y2hPcGVyYXRvciJOCg1NYXRjaE9wZXJhdG9yEh4KGk1BVENIX09QRVJBVE9SX1VOU1BF'
    'Q0lGSUVEEAASDwoLRVhBQ1RfTUFUQ0gQARIMCghDT05UQUlOUxAC');
