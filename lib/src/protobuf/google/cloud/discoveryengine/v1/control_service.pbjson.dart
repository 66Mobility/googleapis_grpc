...
const CreateControlRequest$json = {
  ...
  '2': [
    ...
    {'1': 'control', '3': 2, '4': 1, '5': 11, '6': '.google.cloud.discoveryengine.v1.Control', '8': {}, '10': 'control'},
...
final $typed_data.Uint8List createControlRequestDescriptor = $convert.base64Decode(
    ...
    'J5ZW5naW5lLmdvb2dsZWFwaXMuY29tL0NvbnRyb2xSBnBhcmVudBJHCgdjb250cm9sGAIgASgL'
    'MiguZ29vZ2xlLmNsb3VkLmRpc2NvdmVyeWVuZ2luZS52MS5Db250cm9sQgPgQQJSB2NvbnRyb2'
    'wSIgoKY29udHJvbF9pZBgDIAEoCUID4EECUgljb250cm9sSWQ=');

@$core.Deprecated('Use updateControlRequestDescriptor instead')
const UpdateControlRequest$json = {
  '1': 'UpdateControlRequest',
  '2': [
    {'1': 'control', '3': 1, '4': 1, '5': 11, '6': '.google.cloud.discoveryengine.v1.Control', '8': {}, '10': 'control'},
...
final $typed_data.Uint8List updateControlRequestDescriptor = $convert.base64Decode(
    'ChRVcGRhdGVDb250cm9sUmVxdWVzdBJHCgdjb250cm9sGAEgASgLMiguZ29vZ2xlLmNsb3VkLm'
    'Rpc2NvdmVyeWVuZ2luZS52MS5Db250cm9sQgPgQQJSB2NvbnRyb2wSQAoLdXBkYXRlX21hc2sY'
...
const ListControlsResponse$json = {
  ...
  '2': [
    {'1': 'controls', '3': 1, '4': 3, '5': 11, '6': '.google.cloud.discoveryengine.v1.Control', '10': 'controls'},
...
final $typed_data.Uint8List listControlsResponseDescriptor = $convert.base64Decode(
    'ChRMaXN0Q29udHJvbHNSZXNwb25zZRJECghjb250cm9scxgBIAMoCzIoLmdvb2dsZS5jbG91ZC'
    '5kaXNjb3ZlcnllbmdpbmUudjEuQ29udHJvbFIIY29udHJvbHMSJgoPbmV4dF9wYWdlX3Rva2Vu'
