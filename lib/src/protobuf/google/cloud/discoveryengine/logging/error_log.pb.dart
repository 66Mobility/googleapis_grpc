...
class ServiceContext extends $pb.GeneratedMessage {
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(_omitMessageNames ? '' : 'ServiceContext', package: const $pb.PackageName(_omitMessageNames ? '' : 'google.cloud.discoveryengine.logging'), createEmptyInstance: create)
...
class HttpRequestContext extends $pb.GeneratedMessage {
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(_omitMessageNames ? '' : 'HttpRequestContext', package: const $pb.PackageName(_omitMessageNames ? '' : 'google.cloud.discoveryengine.logging'), createEmptyInstance: create)
...
class SourceLocation extends $pb.GeneratedMessage {
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(_omitMessageNames ? '' : 'SourceLocation', package: const $pb.PackageName(_omitMessageNames ? '' : 'google.cloud.discoveryengine.logging'), createEmptyInstance: create)
...
class ErrorContext extends $pb.GeneratedMessage {
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(_omitMessageNames ? '' : 'ErrorContext', package: const $pb.PackageName(_omitMessageNames ? '' : 'google.cloud.discoveryengine.logging'), createEmptyInstance: create)
...
class ImportErrorContext extends $pb.GeneratedMessage {
  ...
  static const $core.Map<$core.int, ImportErrorContext_LineContent> _ImportErrorContext_LineContentByTag = {
    4 : ImportErrorContext_LineContent.document,
    5 : ImportErrorContext_LineContent.userEvent,
    0 : ImportErrorContext_LineContent.notSet
  };
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(_omitMessageNames ? '' : 'ImportErrorContext', package: const $pb.PackageName(_omitMessageNames ? '' : 'google.cloud.discoveryengine.logging'), createEmptyInstance: create)
    ..oo(0, [4, 5])
    ..aOS(1, _omitFieldNames ? '' : 'operation')
    ..aOS(2, _omitFieldNames ? '' : 'gcsPath')
    ..aOS(3, _omitFieldNames ? '' : 'lineNumber')
    ..aOS(4, _omitFieldNames ? '' : 'document')
    ..aOS(5, _omitFieldNames ? '' : 'userEvent')
    ..hasRequiredFields = false
  ;
  ...
  @$pb.TagNumber(4)
  set document($core.String v) { $_setString(3, v); }
  @$pb.TagNumber(4)
  ...
  @$pb.TagNumber(5)
  $core.String get userEvent => $_getSZ(4);
  @$pb.TagNumber(5)
  set userEvent($core.String v) { $_setString(4, v); }
  @$pb.TagNumber(5)
  $core.bool hasUserEvent() => $_has(4);
  @$pb.TagNumber(5)
  void clearUserEvent() => clearField(5);
}
...
class ErrorLog extends $pb.GeneratedMessage {
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(_omitMessageNames ? '' : 'ErrorLog', package: const $pb.PackageName(_omitMessageNames ? '' : 'google.cloud.discoveryengine.logging'), createEmptyInstance: create)
