...
class ListCustomModelsRequest extends $pb.GeneratedMessage {
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(_omitMessageNames ? '' : 'ListCustomModelsRequest', package: const $pb.PackageName(_omitMessageNames ? '' : 'google.cloud.discoveryengine.v1alpha'), createEmptyInstance: create)
...
class TrainCustomModelRequest_GcsTrainingInput extends $pb.GeneratedMessage {
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(_omitMessageNames ? '' : 'TrainCustomModelRequest.GcsTrainingInput', package: const $pb.PackageName(_omitMessageNames ? '' : 'google.cloud.discoveryengine.v1alpha'), createEmptyInstance: create)
...
class TrainCustomModelRequest extends $pb.GeneratedMessage {
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(_omitMessageNames ? '' : 'TrainCustomModelRequest', package: const $pb.PackageName(_omitMessageNames ? '' : 'google.cloud.discoveryengine.v1alpha'), createEmptyInstance: create)
    ..oo(0, [2])
    ..aOS(1, _omitFieldNames ? '' : 'dataStore')
    ...
    ..aOM<$955.ImportErrorConfig>(4, _omitFieldNames ? '' : 'errorConfig', subBuilder: $955.ImportErrorConfig.create)
  ...
  /// training.
  @$pb.TagNumber(4)
  $955.ImportErrorConfig get errorConfig => $_getN(3);
  @$pb.TagNumber(4)
  set errorConfig($955.ImportErrorConfig v) { setField(4, v); }
  @$pb.TagNumber(4)
  $core.bool hasErrorConfig() => $_has(3);
  @$pb.TagNumber(4)
  void clearErrorConfig() => clearField(4);
  @$pb.TagNumber(4)
  $955.ImportErrorConfig ensureErrorConfig() => $_ensure(3);
...
class TrainCustomModelResponse extends $pb.GeneratedMessage {
  ...
  @$pb.TagNumber(2)
  $955.ImportErrorConfig get errorConfig => $_getN(1);
  @$pb.TagNumber(2)
  set errorConfig($955.ImportErrorConfig v) { setField(2, v); }
  @$pb.TagNumber(2)
  $core.bool hasErrorConfig() => $_has(1);
  @$pb.TagNumber(2)
  void clearErrorConfig() => clearField(2);
  @$pb.TagNumber(2)
  $955.ImportErrorConfig ensureErrorConfig() => $_ensure(1);
