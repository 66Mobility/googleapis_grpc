...
const ListSchemasResponse$json = {
  ...
  '2': [
    {'1': 'schemas', '3': 1, '4': 3, '5': 11, '6': '.google.cloud.discoveryengine.v1alpha.Schema', '10': 'schemas'},
...
final $typed_data.Uint8List listSchemasResponseDescriptor = $convert.base64Decode(
    'ChNMaXN0U2NoZW1hc1Jlc3BvbnNlEkYKB3NjaGVtYXMYASADKAsyLC5nb29nbGUuY2xvdWQuZG'
    'lzY292ZXJ5ZW5naW5lLnYxYWxwaGEuU2NoZW1hUgdzY2hlbWFzEiYKD25leHRfcGFnZV90b2tl'
...
const CreateSchemaRequest$json = {
  ...
  '2': [
    {'1': 'parent', '3': 1, '4': 1, '5': 9, '8': {}, '10': 'parent'},
    {'1': 'schema', '3': 2, '4': 1, '5': 11, '6': '.google.cloud.discoveryengine.v1alpha.Schema', '8': {}, '10': 'schema'},
...
final $typed_data.Uint8List createSchemaRequestDescriptor = $convert.base64Decode(
    ...
    'llbmdpbmUuZ29vZ2xlYXBpcy5jb20vRGF0YVN0b3JlUgZwYXJlbnQSSQoGc2NoZW1hGAIgASgL'
    'MiwuZ29vZ2xlLmNsb3VkLmRpc2NvdmVyeWVuZ2luZS52MWFscGhhLlNjaGVtYUID4EECUgZzY2'
    'hlbWESIAoJc2NoZW1hX2lkGAMgASgJQgPgQQJSCHNjaGVtYUlk');

@$core.Deprecated('Use updateSchemaRequestDescriptor instead')
const UpdateSchemaRequest$json = {
  '1': 'UpdateSchemaRequest',
  '2': [
    {'1': 'schema', '3': 1, '4': 1, '5': 11, '6': '.google.cloud.discoveryengine.v1alpha.Schema', '8': {}, '10': 'schema'},
...
final $typed_data.Uint8List updateSchemaRequestDescriptor = $convert.base64Decode(
    'ChNVcGRhdGVTY2hlbWFSZXF1ZXN0EkkKBnNjaGVtYRgBIAEoCzIsLmdvb2dsZS5jbG91ZC5kaX'
    'Njb3ZlcnllbmdpbmUudjFhbHBoYS5TY2hlbWFCA+BBAlIGc2NoZW1hEiMKDWFsbG93X21pc3Np'
    'bmcYAyABKAhSDGFsbG93TWlzc2luZw==');
