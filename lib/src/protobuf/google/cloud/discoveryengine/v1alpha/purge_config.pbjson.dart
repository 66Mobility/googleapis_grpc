...
@$core.Deprecated('Use purgeErrorConfigDescriptor instead')
const PurgeErrorConfig$json = {
  '1': 'PurgeErrorConfig',
  '2': [
...
/// Descriptor for `PurgeErrorConfig`. Decode as a `google.protobuf.DescriptorProto`.
final $typed_data.Uint8List purgeErrorConfigDescriptor = $convert.base64Decode(
    'ChBQdXJnZUVycm9yQ29uZmlnEh8KCmdjc19wcmVmaXgYASABKAlIAFIJZ2NzUHJlZml4Qg0KC2'
    'Rlc3RpbmF0aW9u');
...
const PurgeDocumentsRequest$json = {
  ...
  '2': [
    {'1': 'gcs_source', '3': 5, '4': 1, '5': 11, '6': '.google.cloud.discoveryengine.v1alpha.GcsSource', '9': 0, '10': 'gcsSource'},
    {'1': 'inline_source', '3': 6, '4': 1, '5': 11, '6': '.google.cloud.discoveryengine.v1alpha.PurgeDocumentsRequest.InlineSource', '9': 0, '10': 'inlineSource'},
    {'1': 'parent', '3': 1, '4': 1, '5': 9, '8': {}, '10': 'parent'},
    {'1': 'filter', '3': 2, '4': 1, '5': 9, '8': {}, '10': 'filter'},
    {'1': 'error_config', '3': 7, '4': 1, '5': 11, '6': '.google.cloud.discoveryengine.v1alpha.PurgeErrorConfig', '10': 'errorConfig'},
    {'1': 'force', '3': 3, '4': 1, '5': 8, '10': 'force'},
  ],
  '3': [PurgeDocumentsRequest_InlineSource$json],
  '8': [
    {'1': 'source'},
  ],
};
...
@$core.Deprecated('Use purgeDocumentsRequestDescriptor instead')
const PurgeDocumentsRequest_InlineSource$json = {
  '1': 'InlineSource',
  '2': [
...
final $typed_data.Uint8List purgeDocumentsRequestDescriptor = $convert.base64Decode(
    'ChVQdXJnZURvY3VtZW50c1JlcXVlc3QSUAoKZ2NzX3NvdXJjZRgFIAEoCzIvLmdvb2dsZS5jbG'
    '91ZC5kaXNjb3ZlcnllbmdpbmUudjFhbHBoYS5HY3NTb3VyY2VIAFIJZ2NzU291cmNlEm8KDWlu'
    'bGluZV9zb3VyY2UYBiABKAsySC5nb29nbGUuY2xvdWQuZGlzY292ZXJ5ZW5naW5lLnYxYWxwaG'
    'EuUHVyZ2VEb2N1bWVudHNSZXF1ZXN0LklubGluZVNvdXJjZUgAUgxpbmxpbmVTb3VyY2USRQoG'
    'cGFyZW50GAEgASgJQi3gQQL6QScKJWRpc2NvdmVyeWVuZ2luZS5nb29nbGVhcGlzLmNvbS9Ccm'
    'FuY2hSBnBhcmVudBIbCgZmaWx0ZXIYAiABKAlCA+BBAlIGZmlsdGVyElkKDGVycm9yX2NvbmZp'
    'ZxgHIAEoCzI2Lmdvb2dsZS5jbG91ZC5kaXNjb3ZlcnllbmdpbmUudjFhbHBoYS5QdXJnZUVycm'
    '9yQ29uZmlnUgtlcnJvckNvbmZpZxIUCgVmb3JjZRgDIAEoCFIFZm9yY2UaXQoMSW5saW5lU291'
    'cmNlEk0KCWRvY3VtZW50cxgBIAMoCUIv4EEC+kEpCidkaXNjb3ZlcnllbmdpbmUuZ29vZ2xlYX'
    'Bpcy5jb20vRG9jdW1lbnRSCWRvY3VtZW50c0IICgZzb3VyY2U=');
