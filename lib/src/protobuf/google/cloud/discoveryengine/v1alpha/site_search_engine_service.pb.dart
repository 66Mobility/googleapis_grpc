...
class GetSiteSearchEngineRequest extends $pb.GeneratedMessage {
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(_omitMessageNames ? '' : 'GetSiteSearchEngineRequest', package: const $pb.PackageName(_omitMessageNames ? '' : 'google.cloud.discoveryengine.v1alpha'), createEmptyInstance: create)
...
class CreateTargetSiteRequest extends $pb.GeneratedMessage {
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(_omitMessageNames ? '' : 'CreateTargetSiteRequest', package: const $pb.PackageName(_omitMessageNames ? '' : 'google.cloud.discoveryengine.v1alpha'), createEmptyInstance: create)
    ..aOS(1, _omitFieldNames ? '' : 'parent')
    ..aOM<$989.TargetSite>(2, _omitFieldNames ? '' : 'targetSite', subBuilder: $989.TargetSite.create)
    ..hasRequiredFields = false
  ;
  ...
  /// to create.
  @$pb.TagNumber(2)
  $989.TargetSite get targetSite => $_getN(1);
  @$pb.TagNumber(2)
  set targetSite($989.TargetSite v) { setField(2, v); }
  @$pb.TagNumber(2)
  $core.bool hasTargetSite() => $_has(1);
  @$pb.TagNumber(2)
  void clearTargetSite() => clearField(2);
  @$pb.TagNumber(2)
  $989.TargetSite ensureTargetSite() => $_ensure(1);
}
...
class CreateTargetSiteMetadata extends $pb.GeneratedMessage {
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(_omitMessageNames ? '' : 'CreateTargetSiteMetadata', package: const $pb.PackageName(_omitMessageNames ? '' : 'google.cloud.discoveryengine.v1alpha'), createEmptyInstance: create)
...
class BatchCreateTargetSitesRequest extends $pb.GeneratedMessage {
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(_omitMessageNames ? '' : 'BatchCreateTargetSitesRequest', package: const $pb.PackageName(_omitMessageNames ? '' : 'google.cloud.discoveryengine.v1alpha'), createEmptyInstance: create)
    ..aOS(1, _omitFieldNames ? '' : 'parent')
...
class GetTargetSiteRequest extends $pb.GeneratedMessage {
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(_omitMessageNames ? '' : 'GetTargetSiteRequest', package: const $pb.PackageName(_omitMessageNames ? '' : 'google.cloud.discoveryengine.v1alpha'), createEmptyInstance: create)
    ..aOS(1, _omitFieldNames ? '' : 'name')
    ..hasRequiredFields = false
  ;
...
class UpdateTargetSiteRequest extends $pb.GeneratedMessage {
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(_omitMessageNames ? '' : 'UpdateTargetSiteRequest', package: const $pb.PackageName(_omitMessageNames ? '' : 'google.cloud.discoveryengine.v1alpha'), createEmptyInstance: create)
    ..aOM<$989.TargetSite>(1, _omitFieldNames ? '' : 'targetSite', subBuilder: $989.TargetSite.create)
    ..hasRequiredFields = false
  ;
  ...
  @$pb.TagNumber(1)
  $989.TargetSite get targetSite => $_getN(0);
  @$pb.TagNumber(1)
  set targetSite($989.TargetSite v) { setField(1, v); }
  @$pb.TagNumber(1)
  $core.bool hasTargetSite() => $_has(0);
  @$pb.TagNumber(1)
  void clearTargetSite() => clearField(1);
  @$pb.TagNumber(1)
  $989.TargetSite ensureTargetSite() => $_ensure(0);
}
...
class UpdateTargetSiteMetadata extends $pb.GeneratedMessage {
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(_omitMessageNames ? '' : 'UpdateTargetSiteMetadata', package: const $pb.PackageName(_omitMessageNames ? '' : 'google.cloud.discoveryengine.v1alpha'), createEmptyInstance: create)
    ..aOM<$1775.Timestamp>(1, _omitFieldNames ? '' : 'createTime', subBuilder: $1775.Timestamp.create)
    ..aOM<$1775.Timestamp>(2, _omitFieldNames ? '' : 'updateTime', subBuilder: $1775.Timestamp.create)
    ..hasRequiredFields = false
  ;
...
class DeleteTargetSiteRequest extends $pb.GeneratedMessage {
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(_omitMessageNames ? '' : 'DeleteTargetSiteRequest', package: const $pb.PackageName(_omitMessageNames ? '' : 'google.cloud.discoveryengine.v1alpha'), createEmptyInstance: create)
    ..aOS(1, _omitFieldNames ? '' : 'name')
    ..hasRequiredFields = false
  ;
...
class DeleteTargetSiteMetadata extends $pb.GeneratedMessage {
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(_omitMessageNames ? '' : 'DeleteTargetSiteMetadata', package: const $pb.PackageName(_omitMessageNames ? '' : 'google.cloud.discoveryengine.v1alpha'), createEmptyInstance: create)
    ..aOM<$1775.Timestamp>(1, _omitFieldNames ? '' : 'createTime', subBuilder: $1775.Timestamp.create)
    ..aOM<$1775.Timestamp>(2, _omitFieldNames ? '' : 'updateTime', subBuilder: $1775.Timestamp.create)
    ..hasRequiredFields = false
  ;
...
class ListTargetSitesRequest extends $pb.GeneratedMessage {
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(_omitMessageNames ? '' : 'ListTargetSitesRequest', package: const $pb.PackageName(_omitMessageNames ? '' : 'google.cloud.discoveryengine.v1alpha'), createEmptyInstance: create)
    ..aOS(1, _omitFieldNames ? '' : 'parent')
...
class ListTargetSitesResponse extends $pb.GeneratedMessage {
  factory ListTargetSitesResponse({
    $core.Iterable<$989.TargetSite>? targetSites,
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(_omitMessageNames ? '' : 'ListTargetSitesResponse', package: const $pb.PackageName(_omitMessageNames ? '' : 'google.cloud.discoveryengine.v1alpha'), createEmptyInstance: create)
    ..pc<$989.TargetSite>(1, _omitFieldNames ? '' : 'targetSites', $pb.PbFieldType.PM, subBuilder: $989.TargetSite.create)
  ...
  /// List of TargetSites.
  @$pb.TagNumber(1)
  $core.List<$989.TargetSite> get targetSites => $_getList(0);
...
class BatchCreateTargetSiteMetadata extends $pb.GeneratedMessage {
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(_omitMessageNames ? '' : 'BatchCreateTargetSiteMetadata', package: const $pb.PackageName(_omitMessageNames ? '' : 'google.cloud.discoveryengine.v1alpha'), createEmptyInstance: create)
    ..aOM<$1775.Timestamp>(1, _omitFieldNames ? '' : 'createTime', subBuilder: $1775.Timestamp.create)
    ..aOM<$1775.Timestamp>(2, _omitFieldNames ? '' : 'updateTime', subBuilder: $1775.Timestamp.create)
    ..hasRequiredFields = false
  ;
...
class BatchCreateTargetSitesResponse extends $pb.GeneratedMessage {
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(_omitMessageNames ? '' : 'BatchCreateTargetSitesResponse', package: const $pb.PackageName(_omitMessageNames ? '' : 'google.cloud.discoveryengine.v1alpha'), createEmptyInstance: create)
    ..pc<$989.TargetSite>(1, _omitFieldNames ? '' : 'targetSites', $pb.PbFieldType.PM, subBuilder: $989.TargetSite.create)
    ..hasRequiredFields = false
  ;
...
class EnableAdvancedSiteSearchRequest extends $pb.GeneratedMessage {
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(_omitMessageNames ? '' : 'EnableAdvancedSiteSearchRequest', package: const $pb.PackageName(_omitMessageNames ? '' : 'google.cloud.discoveryengine.v1alpha'), createEmptyInstance: create)
...
class EnableAdvancedSiteSearchResponse extends $pb.GeneratedMessage {
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(_omitMessageNames ? '' : 'EnableAdvancedSiteSearchResponse', package: const $pb.PackageName(_omitMessageNames ? '' : 'google.cloud.discoveryengine.v1alpha'), createEmptyInstance: create)
    ..hasRequiredFields = false
  ;
...
class EnableAdvancedSiteSearchMetadata extends $pb.GeneratedMessage {
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(_omitMessageNames ? '' : 'EnableAdvancedSiteSearchMetadata', package: const $pb.PackageName(_omitMessageNames ? '' : 'google.cloud.discoveryengine.v1alpha'), createEmptyInstance: create)
    ..aOM<$1775.Timestamp>(1, _omitFieldNames ? '' : 'createTime', subBuilder: $1775.Timestamp.create)
    ..aOM<$1775.Timestamp>(2, _omitFieldNames ? '' : 'updateTime', subBuilder: $1775.Timestamp.create)
    ..hasRequiredFields = false
  ;
...
class DisableAdvancedSiteSearchRequest extends $pb.GeneratedMessage {
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(_omitMessageNames ? '' : 'DisableAdvancedSiteSearchRequest', package: const $pb.PackageName(_omitMessageNames ? '' : 'google.cloud.discoveryengine.v1alpha'), createEmptyInstance: create)
    ..aOS(1, _omitFieldNames ? '' : 'siteSearchEngine')
    ..hasRequiredFields = false
  ;
...
class DisableAdvancedSiteSearchResponse extends $pb.GeneratedMessage {
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(_omitMessageNames ? '' : 'DisableAdvancedSiteSearchResponse', package: const $pb.PackageName(_omitMessageNames ? '' : 'google.cloud.discoveryengine.v1alpha'), createEmptyInstance: create)
    ..hasRequiredFields = false
  ;
...
class DisableAdvancedSiteSearchMetadata extends $pb.GeneratedMessage {
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(_omitMessageNames ? '' : 'DisableAdvancedSiteSearchMetadata', package: const $pb.PackageName(_omitMessageNames ? '' : 'google.cloud.discoveryengine.v1alpha'), createEmptyInstance: create)
    ..aOM<$1775.Timestamp>(1, _omitFieldNames ? '' : 'createTime', subBuilder: $1775.Timestamp.create)
    ..aOM<$1775.Timestamp>(2, _omitFieldNames ? '' : 'updateTime', subBuilder: $1775.Timestamp.create)
    ..hasRequiredFields = false
  ;
...
class RecrawlUrisRequest extends $pb.GeneratedMessage {
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(_omitMessageNames ? '' : 'RecrawlUrisRequest', package: const $pb.PackageName(_omitMessageNames ? '' : 'google.cloud.discoveryengine.v1alpha'), createEmptyInstance: create)
    ..aOS(1, _omitFieldNames ? '' : 'siteSearchEngine')
...
class RecrawlUrisResponse_FailureInfo_FailureReason extends $pb.GeneratedMessage {
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(_omitMessageNames ? '' : 'RecrawlUrisResponse.FailureInfo.FailureReason', package: const $pb.PackageName(_omitMessageNames ? '' : 'google.cloud.discoveryengine.v1alpha'), createEmptyInstance: create)
...
class RecrawlUrisResponse_FailureInfo extends $pb.GeneratedMessage {
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(_omitMessageNames ? '' : 'RecrawlUrisResponse.FailureInfo', package: const $pb.PackageName(_omitMessageNames ? '' : 'google.cloud.discoveryengine.v1alpha'), createEmptyInstance: create)
...
class RecrawlUrisResponse extends $pb.GeneratedMessage {
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(_omitMessageNames ? '' : 'RecrawlUrisResponse', package: const $pb.PackageName(_omitMessageNames ? '' : 'google.cloud.discoveryengine.v1alpha'), createEmptyInstance: create)
...
class RecrawlUrisMetadata extends $pb.GeneratedMessage {
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(_omitMessageNames ? '' : 'RecrawlUrisMetadata', package: const $pb.PackageName(_omitMessageNames ? '' : 'google.cloud.discoveryengine.v1alpha'), createEmptyInstance: create)
    ..aOM<$1775.Timestamp>(1, _omitFieldNames ? '' : 'createTime', subBuilder: $1775.Timestamp.create)
    ..aOM<$1775.Timestamp>(2, _omitFieldNames ? '' : 'updateTime', subBuilder: $1775.Timestamp.create)
...
class BatchVerifyTargetSitesRequest extends $pb.GeneratedMessage {
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(_omitMessageNames ? '' : 'BatchVerifyTargetSitesRequest', package: const $pb.PackageName(_omitMessageNames ? '' : 'google.cloud.discoveryengine.v1alpha'), createEmptyInstance: create)
    ..aOS(1, _omitFieldNames ? '' : 'parent')
    ..hasRequiredFields = false
  ;
...
class BatchVerifyTargetSitesResponse extends $pb.GeneratedMessage {
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(_omitMessageNames ? '' : 'BatchVerifyTargetSitesResponse', package: const $pb.PackageName(_omitMessageNames ? '' : 'google.cloud.discoveryengine.v1alpha'), createEmptyInstance: create)
    ..hasRequiredFields = false
  ;
...
class BatchVerifyTargetSitesMetadata extends $pb.GeneratedMessage {
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(_omitMessageNames ? '' : 'BatchVerifyTargetSitesMetadata', package: const $pb.PackageName(_omitMessageNames ? '' : 'google.cloud.discoveryengine.v1alpha'), createEmptyInstance: create)
    ..aOM<$1775.Timestamp>(1, _omitFieldNames ? '' : 'createTime', subBuilder: $1775.Timestamp.create)
    ..aOM<$1775.Timestamp>(2, _omitFieldNames ? '' : 'updateTime', subBuilder: $1775.Timestamp.create)
    ..hasRequiredFields = false
  ;
...
class FetchDomainVerificationStatusRequest extends $pb.GeneratedMessage {
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(_omitMessageNames ? '' : 'FetchDomainVerificationStatusRequest', package: const $pb.PackageName(_omitMessageNames ? '' : 'google.cloud.discoveryengine.v1alpha'), createEmptyInstance: create)
    ..aOS(1, _omitFieldNames ? '' : 'siteSearchEngine')
    ..a<$core.int>(2, _omitFieldNames ? '' : 'pageSize', $pb.PbFieldType.O3)
    ..aOS(3, _omitFieldNames ? '' : 'pageToken')
    ..hasRequiredFields = false
...
class FetchDomainVerificationStatusResponse extends $pb.GeneratedMessage {
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(_omitMessageNames ? '' : 'FetchDomainVerificationStatusResponse', package: const $pb.PackageName(_omitMessageNames ? '' : 'google.cloud.discoveryengine.v1alpha'), createEmptyInstance: create)
    ..pc<$989.TargetSite>(1, _omitFieldNames ? '' : 'targetSites', $pb.PbFieldType.PM, subBuilder: $989.TargetSite.create)
    ..aOS(2, _omitFieldNames ? '' : 'nextPageToken')
    ..a<$core.int>(3, _omitFieldNames ? '' : 'totalSize', $pb.PbFieldType.O3)
    ..hasRequiredFields = false
...
/// method.
class SetUriPatternDocumentDataRequest extends $pb.GeneratedMessage {
  factory SetUriPatternDocumentDataRequest({
    $core.String? siteSearchEngine,
    $core.Map<$core.String, $1734.Struct>? documentDataMap,
    $1734.Struct? schema,
    ...
    if (documentDataMap != null) {
      $result.documentDataMap.addAll(documentDataMap);
    }
    if (schema != null) {
      $result.schema = schema;
    }
    if (emptyDocumentDataMap != null) {
      $result.emptyDocumentDataMap = emptyDocumentDataMap;
    }
    return $result;
  }
  SetUriPatternDocumentDataRequest._() : super();
  factory SetUriPatternDocumentDataRequest.fromBuffer($core.List<$core.int> i, [$pb.ExtensionRegistry r = $pb.ExtensionRegistry.EMPTY]) => create()..mergeFromBuffer(i, r);
  factory SetUriPatternDocumentDataRequest.fromJson($core.String i, [$pb.ExtensionRegistry r = $pb.ExtensionRegistry.EMPTY]) => create()..mergeFromJson(i, r);

  static final $pb.BuilderInfo _i = $pb.BuilderInfo(_omitMessageNames ? '' : 'SetUriPatternDocumentDataRequest', package: const $pb.PackageName(_omitMessageNames ? '' : 'google.cloud.discoveryengine.v1alpha'), createEmptyInstance: create)
    ..aOS(1, _omitFieldNames ? '' : 'siteSearchEngine')
    ..m<$core.String, $1734.Struct>(2, _omitFieldNames ? '' : 'documentDataMap', entryClassName: 'SetUriPatternDocumentDataRequest.DocumentDataMapEntry', keyFieldType: $pb.PbFieldType.OS, valueFieldType: $pb.PbFieldType.OM, valueCreator: $1734.Struct.create, valueDefaultOrMaker: $1734.Struct.getDefault, packageName: const $pb.PackageName('google.cloud.discoveryengine.v1alpha'))
    ..aOM<$1734.Struct>(3, _omitFieldNames ? '' : 'schema', subBuilder: $1734.Struct.create)
    ..aOB(4, _omitFieldNames ? '' : 'emptyDocumentDataMap')
    ..hasRequiredFields = false
  ;
  ...
  'Use [GeneratedMessageGenericExtensions.deepCopy] instead. '
  'Will be removed in next major version')
  SetUriPatternDocumentDataRequest clone() => SetUriPatternDocumentDataRequest()..mergeFromMessage(this);
  @$core.Deprecated(
  'Using this can add significant overhead to your binary. '
  'Use [GeneratedMessageGenericExtensions.rebuild] instead. '
  'Will be removed in next major version')
  SetUriPatternDocumentDataRequest copyWith(void Function(SetUriPatternDocumentDataRequest) updates) => super.copyWith((message) => updates(message as SetUriPatternDocumentDataRequest)) as SetUriPatternDocumentDataRequest;

  $pb.BuilderInfo get info_ => _i;

  @$core.pragma('dart2js:noInline')
  static SetUriPatternDocumentDataRequest create() => SetUriPatternDocumentDataRequest._();
  SetUriPatternDocumentDataRequest createEmptyInstance() => create();
  static $pb.PbList<SetUriPatternDocumentDataRequest> createRepeated() => $pb.PbList<SetUriPatternDocumentDataRequest>();
  @$core.pragma('dart2js:noInline')
  static SetUriPatternDocumentDataRequest getDefault() => _defaultInstance ??= $pb.GeneratedMessage.$_defaultFor<SetUriPatternDocumentDataRequest>(create);
  static SetUriPatternDocumentDataRequest? _defaultInstance;
  ...
  ///  }
  @$pb.TagNumber(2)
  $core.Map<$core.String, $1734.Struct> get documentDataMap => $_getMap(1);
  ...
  @$pb.TagNumber(3)
  $1734.Struct get schema => $_getN(2);
  @$pb.TagNumber(3)
  set schema($1734.Struct v) { setField(3, v); }
  @$pb.TagNumber(3)
  $core.bool hasSchema() => $_has(2);
  @$pb.TagNumber(3)
  void clearSchema() => clearField(3);
  @$pb.TagNumber(3)
  $1734.Struct ensureSchema() => $_ensure(2);
  ...
  /// must be empty.
  @$pb.TagNumber(4)
  $core.bool get emptyDocumentDataMap => $_getBF(3);
  @$pb.TagNumber(4)
  set emptyDocumentDataMap($core.bool v) { $_setBool(3, v); }
  @$pb.TagNumber(4)
  $core.bool hasEmptyDocumentDataMap() => $_has(3);
  @$pb.TagNumber(4)
  void clearEmptyDocumentDataMap() => clearField(4);
}

/// Response message for
/// [SiteSearchEngineService.SetUriPatternDocumentData][google.cloud.discoveryengine.v1alpha.SiteSearchEngineService.SetUriPatternDocumentData]
/// method.
class SetUriPatternDocumentDataResponse extends $pb.GeneratedMessage {
  factory SetUriPatternDocumentDataResponse() => create();
  SetUriPatternDocumentDataResponse._() : super();
  factory SetUriPatternDocumentDataResponse.fromBuffer($core.List<$core.int> i, [$pb.ExtensionRegistry r = $pb.ExtensionRegistry.EMPTY]) => create()..mergeFromBuffer(i, r);
  factory SetUriPatternDocumentDataResponse.fromJson($core.String i, [$pb.ExtensionRegistry r = $pb.ExtensionRegistry.EMPTY]) => create()..mergeFromJson(i, r);

  static final $pb.BuilderInfo _i = $pb.BuilderInfo(_omitMessageNames ? '' : 'SetUriPatternDocumentDataResponse', package: const $pb.PackageName(_omitMessageNames ? '' : 'google.cloud.discoveryengine.v1alpha'), createEmptyInstance: create)
    ..hasRequiredFields = false
  ;
  ...
  'Use [GeneratedMessageGenericExtensions.deepCopy] instead. '
  'Will be removed in next major version')
  SetUriPatternDocumentDataResponse clone() => SetUriPatternDocumentDataResponse()..mergeFromMessage(this);
  @$core.Deprecated(
  'Using this can add significant overhead to your binary. '
  'Use [GeneratedMessageGenericExtensions.rebuild] instead. '
  'Will be removed in next major version')
  SetUriPatternDocumentDataResponse copyWith(void Function(SetUriPatternDocumentDataResponse) updates) => super.copyWith((message) => updates(message as SetUriPatternDocumentDataResponse)) as SetUriPatternDocumentDataResponse;

  $pb.BuilderInfo get info_ => _i;

  @$core.pragma('dart2js:noInline')
  static SetUriPatternDocumentDataResponse create() => SetUriPatternDocumentDataResponse._();
  SetUriPatternDocumentDataResponse createEmptyInstance() => create();
  static $pb.PbList<SetUriPatternDocumentDataResponse> createRepeated() => $pb.PbList<SetUriPatternDocumentDataResponse>();
  @$core.pragma('dart2js:noInline')
  static SetUriPatternDocumentDataResponse getDefault() => _defaultInstance ??= $pb.GeneratedMessage.$_defaultFor<SetUriPatternDocumentDataResponse>(create);
  static SetUriPatternDocumentDataResponse? _defaultInstance;
}
...
/// operation. This will be returned by the google.longrunning.Operation.metadata
/// field.
class SetUriPatternDocumentDataMetadata extends $pb.GeneratedMessage {
  factory SetUriPatternDocumentDataMetadata({
    $1775.Timestamp? createTime,
    $1775.Timestamp? updateTime,
  }) {
    final $result = create();
  ...
  SetUriPatternDocumentDataMetadata._() : super();
  factory SetUriPatternDocumentDataMetadata.fromBuffer($core.List<$core.int> i, [$pb.ExtensionRegistry r = $pb.ExtensionRegistry.EMPTY]) => create()..mergeFromBuffer(i, r);
  factory SetUriPatternDocumentDataMetadata.fromJson($core.String i, [$pb.ExtensionRegistry r = $pb.ExtensionRegistry.EMPTY]) => create()..mergeFromJson(i, r);

  static final $pb.BuilderInfo _i = $pb.BuilderInfo(_omitMessageNames ? '' : 'SetUriPatternDocumentDataMetadata', package: const $pb.PackageName(_omitMessageNames ? '' : 'google.cloud.discoveryengine.v1alpha'), createEmptyInstance: create)
    ..aOM<$1775.Timestamp>(1, _omitFieldNames ? '' : 'createTime', subBuilder: $1775.Timestamp.create)
    ..aOM<$1775.Timestamp>(2, _omitFieldNames ? '' : 'updateTime', subBuilder: $1775.Timestamp.create)
    ..hasRequiredFields = false
  ;
  ...
  'Use [GeneratedMessageGenericExtensions.deepCopy] instead. '
  'Will be removed in next major version')
  SetUriPatternDocumentDataMetadata clone() => SetUriPatternDocumentDataMetadata()..mergeFromMessage(this);
  @$core.Deprecated(
  'Using this can add significant overhead to your binary. '
  'Use [GeneratedMessageGenericExtensions.rebuild] instead. '
  'Will be removed in next major version')
  SetUriPatternDocumentDataMetadata copyWith(void Function(SetUriPatternDocumentDataMetadata) updates) => super.copyWith((message) => updates(message as SetUriPatternDocumentDataMetadata)) as SetUriPatternDocumentDataMetadata;

  $pb.BuilderInfo get info_ => _i;

  @$core.pragma('dart2js:noInline')
  static SetUriPatternDocumentDataMetadata create() => SetUriPatternDocumentDataMetadata._();
  SetUriPatternDocumentDataMetadata createEmptyInstance() => create();
  static $pb.PbList<SetUriPatternDocumentDataMetadata> createRepeated() => $pb.PbList<SetUriPatternDocumentDataMetadata>();
  @$core.pragma('dart2js:noInline')
  static SetUriPatternDocumentDataMetadata getDefault() => _defaultInstance ??= $pb.GeneratedMessage.$_defaultFor<SetUriPatternDocumentDataMetadata>(create);
  static SetUriPatternDocumentDataMetadata? _defaultInstance;
...
/// method.
class GetUriPatternDocumentDataRequest extends $pb.GeneratedMessage {
  factory GetUriPatternDocumentDataRequest({
    $core.String? siteSearchEngine,
  }) {
    final $result = create();
    if (siteSearchEngine != null) {
  ...
  GetUriPatternDocumentDataRequest._() : super();
  factory GetUriPatternDocumentDataRequest.fromBuffer($core.List<$core.int> i, [$pb.ExtensionRegistry r = $pb.ExtensionRegistry.EMPTY]) => create()..mergeFromBuffer(i, r);
  factory GetUriPatternDocumentDataRequest.fromJson($core.String i, [$pb.ExtensionRegistry r = $pb.ExtensionRegistry.EMPTY]) => create()..mergeFromJson(i, r);

  static final $pb.BuilderInfo _i = $pb.BuilderInfo(_omitMessageNames ? '' : 'GetUriPatternDocumentDataRequest', package: const $pb.PackageName(_omitMessageNames ? '' : 'google.cloud.discoveryengine.v1alpha'), createEmptyInstance: create)
    ..aOS(1, _omitFieldNames ? '' : 'siteSearchEngine')
    ..hasRequiredFields = false
  ;
  ...
  'Use [GeneratedMessageGenericExtensions.deepCopy] instead. '
  'Will be removed in next major version')
  GetUriPatternDocumentDataRequest clone() => GetUriPatternDocumentDataRequest()..mergeFromMessage(this);
  @$core.Deprecated(
  'Using this can add significant overhead to your binary. '
  'Use [GeneratedMessageGenericExtensions.rebuild] instead. '
  'Will be removed in next major version')
  GetUriPatternDocumentDataRequest copyWith(void Function(GetUriPatternDocumentDataRequest) updates) => super.copyWith((message) => updates(message as GetUriPatternDocumentDataRequest)) as GetUriPatternDocumentDataRequest;

  $pb.BuilderInfo get info_ => _i;

  @$core.pragma('dart2js:noInline')
  static GetUriPatternDocumentDataRequest create() => GetUriPatternDocumentDataRequest._();
  GetUriPatternDocumentDataRequest createEmptyInstance() => create();
  static $pb.PbList<GetUriPatternDocumentDataRequest> createRepeated() => $pb.PbList<GetUriPatternDocumentDataRequest>();
  @$core.pragma('dart2js:noInline')
  static GetUriPatternDocumentDataRequest getDefault() => _defaultInstance ??= $pb.GeneratedMessage.$_defaultFor<GetUriPatternDocumentDataRequest>(create);
  static GetUriPatternDocumentDataRequest? _defaultInstance;
...
/// [SiteSearchEngineService.GetUriPatternDocumentData][google.cloud.discoveryengine.v1alpha.SiteSearchEngineService.GetUriPatternDocumentData]
/// method.
class GetUriPatternDocumentDataResponse extends $pb.GeneratedMessage {
  factory GetUriPatternDocumentDataResponse({
    $core.Map<$core.String, $1734.Struct>? documentDataMap,
  }) {
    final $result = create();
    if (documentDataMap != null) {
  ...
  GetUriPatternDocumentDataResponse._() : super();
  factory GetUriPatternDocumentDataResponse.fromBuffer($core.List<$core.int> i, [$pb.ExtensionRegistry r = $pb.ExtensionRegistry.EMPTY]) => create()..mergeFromBuffer(i, r);
  factory GetUriPatternDocumentDataResponse.fromJson($core.String i, [$pb.ExtensionRegistry r = $pb.ExtensionRegistry.EMPTY]) => create()..mergeFromJson(i, r);

  static final $pb.BuilderInfo _i = $pb.BuilderInfo(_omitMessageNames ? '' : 'GetUriPatternDocumentDataResponse', package: const $pb.PackageName(_omitMessageNames ? '' : 'google.cloud.discoveryengine.v1alpha'), createEmptyInstance: create)
    ..m<$core.String, $1734.Struct>(1, _omitFieldNames ? '' : 'documentDataMap', entryClassName: 'GetUriPatternDocumentDataResponse.DocumentDataMapEntry', keyFieldType: $pb.PbFieldType.OS, valueFieldType: $pb.PbFieldType.OM, valueCreator: $1734.Struct.create, valueDefaultOrMaker: $1734.Struct.getDefault, packageName: const $pb.PackageName('google.cloud.discoveryengine.v1alpha'))
    ..hasRequiredFields = false
  ;
  ...
  'Use [GeneratedMessageGenericExtensions.deepCopy] instead. '
  'Will be removed in next major version')
  GetUriPatternDocumentDataResponse clone() => GetUriPatternDocumentDataResponse()..mergeFromMessage(this);
  @$core.Deprecated(
  'Using this can add significant overhead to your binary. '
  'Use [GeneratedMessageGenericExtensions.rebuild] instead. '
  'Will be removed in next major version')
  GetUriPatternDocumentDataResponse copyWith(void Function(GetUriPatternDocumentDataResponse) updates) => super.copyWith((message) => updates(message as GetUriPatternDocumentDataResponse)) as GetUriPatternDocumentDataResponse;

  $pb.BuilderInfo get info_ => _i;

  @$core.pragma('dart2js:noInline')
  static GetUriPatternDocumentDataResponse create() => GetUriPatternDocumentDataResponse._();
  GetUriPatternDocumentDataResponse createEmptyInstance() => create();
  static $pb.PbList<GetUriPatternDocumentDataResponse> createRepeated() => $pb.PbList<GetUriPatternDocumentDataResponse>();
  @$core.pragma('dart2js:noInline')
  static GetUriPatternDocumentDataResponse getDefault() => _defaultInstance ??= $pb.GeneratedMessage.$_defaultFor<GetUriPatternDocumentDataResponse>(create);
  static GetUriPatternDocumentDataResponse? _defaultInstance;
  ...
  /// }
  @$pb.TagNumber(1)
  $core.Map<$core.String, $1734.Struct> get documentDataMap => $_getMap(0);
}
