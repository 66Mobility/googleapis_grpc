...
class SetUriPatternDocumentDataRequest extends $pb.GeneratedMessage {
  factory SetUriPatternDocumentDataRequest({
    $core.String? siteSearchEngine,
    $core.Map<$core.String, $1735.Struct>? documentDataMap,
    $1735.Struct? schema,
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(_omitMessageNames ? '' : 'SetUriPatternDocumentDataRequest', package: const $pb.PackageName(_omitMessageNames ? '' : 'google.cloud.discoveryengine.v1alpha'), createEmptyInstance: create)
    ..aOS(1, _omitFieldNames ? '' : 'siteSearchEngine')
    ..m<$core.String, $1735.Struct>(2, _omitFieldNames ? '' : 'documentDataMap', entryClassName: 'SetUriPatternDocumentDataRequest.DocumentDataMapEntry', keyFieldType: $pb.PbFieldType.OS, valueFieldType: $pb.PbFieldType.OM, valueCreator: $1735.Struct.create, valueDefaultOrMaker: $1735.Struct.getDefault, packageName: const $pb.PackageName('google.cloud.discoveryengine.v1alpha'))
    ..aOM<$1735.Struct>(3, _omitFieldNames ? '' : 'schema', subBuilder: $1735.Struct.create)
  ...
  ///  }
  @$pb.TagNumber(2)
  $core.Map<$core.String, $1735.Struct> get documentDataMap => $_getMap(1);
  ...
  @$pb.TagNumber(3)
  $1735.Struct get schema => $_getN(2);
  @$pb.TagNumber(3)
  set schema($1735.Struct v) { setField(3, v); }
  @$pb.TagNumber(3)
  $core.bool hasSchema() => $_has(2);
  @$pb.TagNumber(3)
  void clearSchema() => clearField(3);
  @$pb.TagNumber(3)
  $1735.Struct ensureSchema() => $_ensure(2);
...
class GetUriPatternDocumentDataResponse extends $pb.GeneratedMessage {
  ...
  /// }
  @$pb.TagNumber(1)
  $core.Map<$core.String, $1735.Struct> get documentDataMap => $_getMap(0);
}
