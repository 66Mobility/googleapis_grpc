...
class SearchRequest_RelevanceThreshold extends $pb.ProtobufEnum {
  static const SearchRequest_RelevanceThreshold RELEVANCE_THRESHOLD_UNSPECIFIED = SearchRequest_RelevanceThreshold._(0, _omitEnumNames ? '' : 'RELEVANCE_THRESHOLD_UNSPECIFIED');
  static const SearchRequest_RelevanceThreshold LOWEST = SearchRequest_RelevanceThreshold._(1, _omitEnumNames ? '' : 'LOWEST');
  static const SearchRequest_RelevanceThreshold LOW = SearchRequest_RelevanceThreshold._(2, _omitEnumNames ? '' : 'LOW');
  static const SearchRequest_RelevanceThreshold MEDIUM = SearchRequest_RelevanceThreshold._(3, _omitEnumNames ? '' : 'MEDIUM');
  static const SearchRequest_RelevanceThreshold HIGH = SearchRequest_RelevanceThreshold._(4, _omitEnumNames ? '' : 'HIGH');
...
class SearchResponse_Summary_SummarySkippedReason extends $pb.ProtobufEnum {
  ...
  static const SearchResponse_Summary_SummarySkippedReason JAIL_BREAKING_QUERY_IGNORED = SearchResponse_Summary_SummarySkippedReason._(7, _omitEnumNames ? '' : 'JAIL_BREAKING_QUERY_IGNORED');
...
class SearchResponse_OneBoxResult_OneBoxType extends $pb.ProtobufEnum {
  static const SearchResponse_OneBoxResult_OneBoxType ONE_BOX_TYPE_UNSPECIFIED = SearchResponse_OneBoxResult_OneBoxType._(0, _omitEnumNames ? '' : 'ONE_BOX_TYPE_UNSPECIFIED');
  static const SearchResponse_OneBoxResult_OneBoxType PEOPLE = SearchResponse_OneBoxResult_OneBoxType._(1, _omitEnumNames ? '' : 'PEOPLE');
  static const SearchResponse_OneBoxResult_OneBoxType ORGANIZATION = SearchResponse_OneBoxResult_OneBoxType._(2, _omitEnumNames ? '' : 'ORGANIZATION');
  static const SearchResponse_OneBoxResult_OneBoxType SLACK = SearchResponse_OneBoxResult_OneBoxType._(3, _omitEnumNames ? '' : 'SLACK');

  static const $core.List<SearchResponse_OneBoxResult_OneBoxType> values = <SearchResponse_OneBoxResult_OneBoxType> [
  ...
  static final $core.Map<$core.int, SearchResponse_OneBoxResult_OneBoxType> _byValue = $pb.ProtobufEnum.initByValue(values);
  static SearchResponse_OneBoxResult_OneBoxType? valueOf($core.int value) => _byValue[value];

  const SearchResponse_OneBoxResult_OneBoxType._($core.int v, $core.String n) : super(v, n);
}
