...
class GetDocumentRequest extends $pb.GeneratedMessage {
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(_omitMessageNames ? '' : 'GetDocumentRequest', package: const $pb.PackageName(_omitMessageNames ? '' : 'google.cloud.discoveryengine.v1alpha'), createEmptyInstance: create)
...
class ListDocumentsRequest extends $pb.GeneratedMessage {
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(_omitMessageNames ? '' : 'ListDocumentsRequest', package: const $pb.PackageName(_omitMessageNames ? '' : 'google.cloud.discoveryengine.v1alpha'), createEmptyInstance: create)
...
class ListDocumentsResponse extends $pb.GeneratedMessage {
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(_omitMessageNames ? '' : 'ListDocumentsResponse', package: const $pb.PackageName(_omitMessageNames ? '' : 'google.cloud.discoveryengine.v1alpha'), createEmptyInstance: create)
...
class CreateDocumentRequest extends $pb.GeneratedMessage {
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(_omitMessageNames ? '' : 'CreateDocumentRequest', package: const $pb.PackageName(_omitMessageNames ? '' : 'google.cloud.discoveryengine.v1alpha'), createEmptyInstance: create)
    ..aOS(1, _omitFieldNames ? '' : 'parent')
...
class UpdateDocumentRequest extends $pb.GeneratedMessage {
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(_omitMessageNames ? '' : 'UpdateDocumentRequest', package: const $pb.PackageName(_omitMessageNames ? '' : 'google.cloud.discoveryengine.v1alpha'), createEmptyInstance: create)
    ..aOM<$968.Document>(1, _omitFieldNames ? '' : 'document', subBuilder: $968.Document.create)
  ...
  @$pb.TagNumber(1)
  $968.Document get document => $_getN(0);
  @$pb.TagNumber(1)
  set document($968.Document v) { setField(1, v); }
  @$pb.TagNumber(1)
  $core.bool hasDocument() => $_has(0);
  @$pb.TagNumber(1)
  void clearDocument() => clearField(1);
  @$pb.TagNumber(1)
  $968.Document ensureDocument() => $_ensure(0);
...
class DeleteDocumentRequest extends $pb.GeneratedMessage {
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(_omitMessageNames ? '' : 'DeleteDocumentRequest', package: const $pb.PackageName(_omitMessageNames ? '' : 'google.cloud.discoveryengine.v1alpha'), createEmptyInstance: create)
    ..aOS(1, _omitFieldNames ? '' : 'name')
    ..hasRequiredFields = false
  ;
...
/// [DocumentService.GetDocument][google.cloud.discoveryengine.v1alpha.DocumentService.GetDocument]
/// method.
class GetProcessedDocumentRequest extends $pb.GeneratedMessage {
  factory GetProcessedDocumentRequest({
    $core.String? name,
    GetProcessedDocumentRequest_ProcessedDocumentType? processedDocumentType,
    GetProcessedDocumentRequest_ProcessedDocumentFormat? processedDocumentFormat,
  }) {
    final $result = create();
    if (name != null) {
      $result.name = name;
    ...
    if (processedDocumentType != null) {
      $result.processedDocumentType = processedDocumentType;
    }
    if (processedDocumentFormat != null) {
      $result.processedDocumentFormat = processedDocumentFormat;
    }
    return $result;
  }
  GetProcessedDocumentRequest._() : super();
  factory GetProcessedDocumentRequest.fromBuffer($core.List<$core.int> i, [$pb.ExtensionRegistry r = $pb.ExtensionRegistry.EMPTY]) => create()..mergeFromBuffer(i, r);
  factory GetProcessedDocumentRequest.fromJson($core.String i, [$pb.ExtensionRegistry r = $pb.ExtensionRegistry.EMPTY]) => create()..mergeFromJson(i, r);

  static final $pb.BuilderInfo _i = $pb.BuilderInfo(_omitMessageNames ? '' : 'GetProcessedDocumentRequest', package: const $pb.PackageName(_omitMessageNames ? '' : 'google.cloud.discoveryengine.v1alpha'), createEmptyInstance: create)
    ..aOS(1, _omitFieldNames ? '' : 'name')
    ..e<GetProcessedDocumentRequest_ProcessedDocumentType>(2, _omitFieldNames ? '' : 'processedDocumentType', $pb.PbFieldType.OE, defaultOrMaker: GetProcessedDocumentRequest_ProcessedDocumentType.PROCESSED_DOCUMENT_TYPE_UNSPECIFIED, valueOf: GetProcessedDocumentRequest_ProcessedDocumentType.valueOf, enumValues: GetProcessedDocumentRequest_ProcessedDocumentType.values)
    ..e<GetProcessedDocumentRequest_ProcessedDocumentFormat>(3, _omitFieldNames ? '' : 'processedDocumentFormat', $pb.PbFieldType.OE, defaultOrMaker: GetProcessedDocumentRequest_ProcessedDocumentFormat.PROCESSED_DOCUMENT_FORMAT_UNSPECIFIED, valueOf: GetProcessedDocumentRequest_ProcessedDocumentFormat.valueOf, enumValues: GetProcessedDocumentRequest_ProcessedDocumentFormat.values)
    ..hasRequiredFields = false
  ;
  ...
  'Use [GeneratedMessageGenericExtensions.deepCopy] instead. '
  'Will be removed in next major version')
  GetProcessedDocumentRequest clone() => GetProcessedDocumentRequest()..mergeFromMessage(this);
  @$core.Deprecated(
  'Using this can add significant overhead to your binary. '
  'Use [GeneratedMessageGenericExtensions.rebuild] instead. '
  'Will be removed in next major version')
  GetProcessedDocumentRequest copyWith(void Function(GetProcessedDocumentRequest) updates) => super.copyWith((message) => updates(message as GetProcessedDocumentRequest)) as GetProcessedDocumentRequest;

  $pb.BuilderInfo get info_ => _i;

  @$core.pragma('dart2js:noInline')
  static GetProcessedDocumentRequest create() => GetProcessedDocumentRequest._();
  GetProcessedDocumentRequest createEmptyInstance() => create();
  static $pb.PbList<GetProcessedDocumentRequest> createRepeated() => $pb.PbList<GetProcessedDocumentRequest>();
  @$core.pragma('dart2js:noInline')
  static GetProcessedDocumentRequest getDefault() => _defaultInstance ??= $pb.GeneratedMessage.$_defaultFor<GetProcessedDocumentRequest>(create);
  static GetProcessedDocumentRequest? _defaultInstance;
  ...
  @$pb.TagNumber(2)
  GetProcessedDocumentRequest_ProcessedDocumentType get processedDocumentType => $_getN(1);
  @$pb.TagNumber(2)
  set processedDocumentType(GetProcessedDocumentRequest_ProcessedDocumentType v) { setField(2, v); }
  @$pb.TagNumber(2)
  $core.bool hasProcessedDocumentType() => $_has(1);
  @$pb.TagNumber(2)
  void clearProcessedDocumentType() => clearField(2);

  /// What format output should be.  If unspecified, defaults to JSON.
  @$pb.TagNumber(3)
  GetProcessedDocumentRequest_ProcessedDocumentFormat get processedDocumentFormat => $_getN(2);
  @$pb.TagNumber(3)
  set processedDocumentFormat(GetProcessedDocumentRequest_ProcessedDocumentFormat v) { setField(3, v); }
  @$pb.TagNumber(3)
  $core.bool hasProcessedDocumentFormat() => $_has(2);
  @$pb.TagNumber(3)
  void clearProcessedDocumentFormat() => clearField(3);
}
