...
class Answer_AnswerSkippedReason extends $pb.ProtobufEnum {
  ...
  static const Answer_AnswerSkippedReason JAIL_BREAKING_QUERY_IGNORED = Answer_AnswerSkippedReason._(6, _omitEnumNames ? '' : 'JAIL_BREAKING_QUERY_IGNORED');
...
class Answer_QueryUnderstandingInfo_QueryClassificationInfo_Type extends $pb.ProtobufEnum {
  ...
  static const Answer_QueryUnderstandingInfo_QueryClassificationInfo_Type JAIL_BREAKING_QUERY = Answer_QueryUnderstandingInfo_QueryClassificationInfo_Type._(3, _omitEnumNames ? '' : 'JAIL_BREAKING_QUERY');
