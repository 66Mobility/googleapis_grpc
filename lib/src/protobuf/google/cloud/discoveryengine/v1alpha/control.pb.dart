...
class Control extends $pb.GeneratedMessage {
  factory Control({
    ...
    $core.Iterable<$4506.SearchUseCase>? useCases,
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(_omitMessageNames ? '' : 'Control', package: const $pb.PackageName(_omitMessageNames ? '' : 'google.cloud.discoveryengine.v1alpha'), createEmptyInstance: create)
    ...
    ..e<$4506.SolutionType>(4, _omitFieldNames ? '' : 'solutionType', $pb.PbFieldType.OE, defaultOrMaker: $4506.SolutionType.SOLUTION_TYPE_UNSPECIFIED, valueOf: $4506.SolutionType.valueOf, enumValues: $4506.SolutionType.values)
    ...
    ..pc<$4506.SearchUseCase>(8, _omitFieldNames ? '' : 'useCases', $pb.PbFieldType.KE, valueOf: $4506.SearchUseCase.valueOf, enumValues: $4506.SearchUseCase.values, defaultEnumValue: $4506.SearchUseCase.SEARCH_USE_CASE_UNSPECIFIED)
  ...
  ///  Otherwise an INVALID ARGUMENT error is thrown.
  @$pb.TagNumber(4)
  $4506.SolutionType get solutionType => $_getN(3);
  @$pb.TagNumber(4)
  set solutionType($4506.SolutionType v) { setField(4, v); }
  @$pb.TagNumber(4)
  ...
  @$pb.TagNumber(8)
  $core.List<$4506.SearchUseCase> get useCases => $_getList(7);
