...
class Condition_QueryTerm extends $pb.GeneratedMessage {
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(_omitMessageNames ? '' : 'Condition.QueryTerm', package: const $pb.PackageName(_omitMessageNames ? '' : 'google.cloud.discoveryengine.v1alpha'), createEmptyInstance: create)
...
class Condition_TimeRange extends $pb.GeneratedMessage {
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(_omitMessageNames ? '' : 'Condition.TimeRange', package: const $pb.PackageName(_omitMessageNames ? '' : 'google.cloud.discoveryengine.v1alpha'), createEmptyInstance: create)
...
class Condition extends $pb.GeneratedMessage {
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(_omitMessageNames ? '' : 'Condition', package: const $pb.PackageName(_omitMessageNames ? '' : 'google.cloud.discoveryengine.v1alpha'), createEmptyInstance: create)
...
class Control_BoostAction extends $pb.GeneratedMessage {
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(_omitMessageNames ? '' : 'Control.BoostAction', package: const $pb.PackageName(_omitMessageNames ? '' : 'google.cloud.discoveryengine.v1alpha'), createEmptyInstance: create)
...
class Control_FilterAction extends $pb.GeneratedMessage {
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(_omitMessageNames ? '' : 'Control.FilterAction', package: const $pb.PackageName(_omitMessageNames ? '' : 'google.cloud.discoveryengine.v1alpha'), createEmptyInstance: create)
...
class Control_RedirectAction extends $pb.GeneratedMessage {
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(_omitMessageNames ? '' : 'Control.RedirectAction', package: const $pb.PackageName(_omitMessageNames ? '' : 'google.cloud.discoveryengine.v1alpha'), createEmptyInstance: create)
...
class Control_SynonymsAction extends $pb.GeneratedMessage {
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(_omitMessageNames ? '' : 'Control.SynonymsAction', package: const $pb.PackageName(_omitMessageNames ? '' : 'google.cloud.discoveryengine.v1alpha'), createEmptyInstance: create)
...
class Control extends $pb.GeneratedMessage {
  factory Control({
    ...
    $core.Iterable<$4504.SearchUseCase>? useCases,
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(_omitMessageNames ? '' : 'Control', package: const $pb.PackageName(_omitMessageNames ? '' : 'google.cloud.discoveryengine.v1alpha'), createEmptyInstance: create)
    ..oo(0, [6, 7, 9, 10])
    ..aOS(1, _omitFieldNames ? '' : 'name')
    ..aOS(2, _omitFieldNames ? '' : 'displayName')
    ..pPS(3, _omitFieldNames ? '' : 'associatedServingConfigIds')
    ..e<$4504.SolutionType>(4, _omitFieldNames ? '' : 'solutionType', $pb.PbFieldType.OE, defaultOrMaker: $4504.SolutionType.SOLUTION_TYPE_UNSPECIFIED, valueOf: $4504.SolutionType.valueOf, enumValues: $4504.SolutionType.values)
    ...
    ..pc<$4504.SearchUseCase>(8, _omitFieldNames ? '' : 'useCases', $pb.PbFieldType.KE, valueOf: $4504.SearchUseCase.valueOf, enumValues: $4504.SearchUseCase.values, defaultEnumValue: $4504.SearchUseCase.SEARCH_USE_CASE_UNSPECIFIED)
  ...
  ///  Otherwise an INVALID ARGUMENT error is thrown.
  @$pb.TagNumber(4)
  $4504.SolutionType get solutionType => $_getN(3);
  @$pb.TagNumber(4)
  set solutionType($4504.SolutionType v) { setField(4, v); }
  @$pb.TagNumber(4)
  ...
  @$pb.TagNumber(8)
  $core.List<$4504.SearchUseCase> get useCases => $_getList(7);
