...
class Answer_Citation extends $pb.GeneratedMessage {
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(_omitMessageNames ? '' : 'Answer.Citation', package: const $pb.PackageName(_omitMessageNames ? '' : 'google.cloud.discoveryengine.v1alpha'), createEmptyInstance: create)
...
class Answer_CitationSource extends $pb.GeneratedMessage {
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(_omitMessageNames ? '' : 'Answer.CitationSource', package: const $pb.PackageName(_omitMessageNames ? '' : 'google.cloud.discoveryengine.v1alpha'), createEmptyInstance: create)
...
class Answer_Reference_UnstructuredDocumentInfo_ChunkContent extends $pb.GeneratedMessage {
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(_omitMessageNames ? '' : 'Answer.Reference.UnstructuredDocumentInfo.ChunkContent', package: const $pb.PackageName(_omitMessageNames ? '' : 'google.cloud.discoveryengine.v1alpha'), createEmptyInstance: create)
...
class Answer_Reference_UnstructuredDocumentInfo extends $pb.GeneratedMessage {
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(_omitMessageNames ? '' : 'Answer.Reference.UnstructuredDocumentInfo', package: const $pb.PackageName(_omitMessageNames ? '' : 'google.cloud.discoveryengine.v1alpha'), createEmptyInstance: create)
...
class Answer_Reference_ChunkInfo_DocumentMetadata extends $pb.GeneratedMessage {
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(_omitMessageNames ? '' : 'Answer.Reference.ChunkInfo.DocumentMetadata', package: const $pb.PackageName(_omitMessageNames ? '' : 'google.cloud.discoveryengine.v1alpha'), createEmptyInstance: create)
    ..aOS(1, _omitFieldNames ? '' : 'document')
    ..aOS(2, _omitFieldNames ? '' : 'uri')
    ..aOS(3, _omitFieldNames ? '' : 'title')
...
class Answer_Reference_ChunkInfo extends $pb.GeneratedMessage {
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(_omitMessageNames ? '' : 'Answer.Reference.ChunkInfo', package: const $pb.PackageName(_omitMessageNames ? '' : 'google.cloud.discoveryengine.v1alpha'), createEmptyInstance: create)
...
class Answer_Reference_StructuredDocumentInfo extends $pb.GeneratedMessage {
  ...
  Answer_Reference_StructuredDocumentInfo._() : super();
  factory Answer_Reference_StructuredDocumentInfo.fromBuffer($core.List<$core.int> i, [$pb.ExtensionRegistry r = $pb.ExtensionRegistry.EMPTY]) => create()..mergeFromBuffer(i, r);
  factory Answer_Reference_StructuredDocumentInfo.fromJson($core.String i, [$pb.ExtensionRegistry r = $pb.ExtensionRegistry.EMPTY]) => create()..mergeFromJson(i, r);
  ...
  'Use [GeneratedMessageGenericExtensions.deepCopy] instead. '
  'Will be removed in next major version')
  Answer_Reference_StructuredDocumentInfo clone() => Answer_Reference_StructuredDocumentInfo()..mergeFromMessage(this);
  @$core.Deprecated(
  'Using this can add significant overhead to your binary. '
  'Use [GeneratedMessageGenericExtensions.rebuild] instead. '
  'Will be removed in next major version')
  Answer_Reference_StructuredDocumentInfo copyWith(void Function(Answer_Reference_StructuredDocumentInfo) updates) => super.copyWith((message) => updates(message as Answer_Reference_StructuredDocumentInfo)) as Answer_Reference_StructuredDocumentInfo;

  $pb.BuilderInfo get info_ => _i;

  @$core.pragma('dart2js:noInline')
  static Answer_Reference_StructuredDocumentInfo create() => Answer_Reference_StructuredDocumentInfo._();
  Answer_Reference_StructuredDocumentInfo createEmptyInstance() => create();
  static $pb.PbList<Answer_Reference_StructuredDocumentInfo> createRepeated() => $pb.PbList<Answer_Reference_StructuredDocumentInfo>();
  @$core.pragma('dart2js:noInline')
  static Answer_Reference_StructuredDocumentInfo getDefault() => _defaultInstance ??= $pb.GeneratedMessage.$_defaultFor<Answer_Reference_StructuredDocumentInfo>(create);
  static Answer_Reference_StructuredDocumentInfo? _defaultInstance;
...
class Answer_Reference extends $pb.GeneratedMessage {
  factory Answer_Reference({
    ...
    Answer_Reference_StructuredDocumentInfo? structuredDocumentInfo,
  }) {
    final $result = create();
    ...
    if (structuredDocumentInfo != null) {
      $result.structuredDocumentInfo = structuredDocumentInfo;
    }
    return $result;
  }
  ...
  static const $core.Map<$core.int, Answer_Reference_Content> _Answer_Reference_ContentByTag = {
    ...
    3 : Answer_Reference_Content.structuredDocumentInfo,
    0 : Answer_Reference_Content.notSet
  };
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(_omitMessageNames ? '' : 'Answer.Reference', package: const $pb.PackageName(_omitMessageNames ? '' : 'google.cloud.discoveryengine.v1alpha'), createEmptyInstance: create)
    ..oo(0, [1, 2, 3])
    ...
    ..aOM<Answer_Reference_StructuredDocumentInfo>(3, _omitFieldNames ? '' : 'structuredDocumentInfo', subBuilder: Answer_Reference_StructuredDocumentInfo.create)
    ..hasRequiredFields = false
  ;
  ...
  @$pb.TagNumber(3)
  Answer_Reference_StructuredDocumentInfo get structuredDocumentInfo => $_getN(2);
  @$pb.TagNumber(3)
  set structuredDocumentInfo(Answer_Reference_StructuredDocumentInfo v) { setField(3, v); }
  @$pb.TagNumber(3)
  $core.bool hasStructuredDocumentInfo() => $_has(2);
  @$pb.TagNumber(3)
  void clearStructuredDocumentInfo() => clearField(3);
  @$pb.TagNumber(3)
  Answer_Reference_StructuredDocumentInfo ensureStructuredDocumentInfo() => $_ensure(2);
}
...
class Answer_Step_Action_SearchAction extends $pb.GeneratedMessage {
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(_omitMessageNames ? '' : 'Answer.Step.Action.SearchAction', package: const $pb.PackageName(_omitMessageNames ? '' : 'google.cloud.discoveryengine.v1alpha'), createEmptyInstance: create)
...
class Answer_Step_Action_Observation_SearchResult_SnippetInfo extends $pb.GeneratedMessage {
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(_omitMessageNames ? '' : 'Answer.Step.Action.Observation.SearchResult.SnippetInfo', package: const $pb.PackageName(_omitMessageNames ? '' : 'google.cloud.discoveryengine.v1alpha'), createEmptyInstance: create)
...
class Answer_Step_Action_Observation_SearchResult_ChunkInfo extends $pb.GeneratedMessage {
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(_omitMessageNames ? '' : 'Answer.Step.Action.Observation.SearchResult.ChunkInfo', package: const $pb.PackageName(_omitMessageNames ? '' : 'google.cloud.discoveryengine.v1alpha'), createEmptyInstance: create)
    ..aOS(1, _omitFieldNames ? '' : 'chunk')
    ..aOS(2, _omitFieldNames ? '' : 'content')
    ..a<$core.double>(3, _omitFieldNames ? '' : 'relevanceScore', $pb.PbFieldType.OF)
    ..hasRequiredFields = false
...
class Answer_Step_Action_Observation_SearchResult extends $pb.GeneratedMessage {
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(_omitMessageNames ? '' : 'Answer.Step.Action.Observation.SearchResult', package: const $pb.PackageName(_omitMessageNames ? '' : 'google.cloud.discoveryengine.v1alpha'), createEmptyInstance: create)
    ..aOS(1, _omitFieldNames ? '' : 'document')
    ..aOS(2, _omitFieldNames ? '' : 'uri')
    ..aOS(3, _omitFieldNames ? '' : 'title')
...
class Answer_Step_Action_Observation extends $pb.GeneratedMessage {
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(_omitMessageNames ? '' : 'Answer.Step.Action.Observation', package: const $pb.PackageName(_omitMessageNames ? '' : 'google.cloud.discoveryengine.v1alpha'), createEmptyInstance: create)
...
class Answer_Step_Action extends $pb.GeneratedMessage {
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(_omitMessageNames ? '' : 'Answer.Step.Action', package: const $pb.PackageName(_omitMessageNames ? '' : 'google.cloud.discoveryengine.v1alpha'), createEmptyInstance: create)
    ..oo(0, [2])
...
class Answer_Step extends $pb.GeneratedMessage {
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(_omitMessageNames ? '' : 'Answer.Step', package: const $pb.PackageName(_omitMessageNames ? '' : 'google.cloud.discoveryengine.v1alpha'), createEmptyInstance: create)
...
class Answer_QueryUnderstandingInfo_QueryClassificationInfo extends $pb.GeneratedMessage {
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(_omitMessageNames ? '' : 'Answer.QueryUnderstandingInfo.QueryClassificationInfo', package: const $pb.PackageName(_omitMessageNames ? '' : 'google.cloud.discoveryengine.v1alpha'), createEmptyInstance: create)
...
class Answer_QueryUnderstandingInfo extends $pb.GeneratedMessage {
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(_omitMessageNames ? '' : 'Answer.QueryUnderstandingInfo', package: const $pb.PackageName(_omitMessageNames ? '' : 'google.cloud.discoveryengine.v1alpha'), createEmptyInstance: create)
...
class Answer extends $pb.GeneratedMessage {
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(_omitMessageNames ? '' : 'Answer', package: const $pb.PackageName(_omitMessageNames ? '' : 'google.cloud.discoveryengine.v1alpha'), createEmptyInstance: create)
