...
const WriteUserEventRequest$json = {
  ...
  '2': [
    ...
    {'1': 'user_event', '3': 2, '4': 1, '5': 11, '6': '.google.cloud.discoveryengine.v1alpha.UserEvent', '8': {}, '9': 0, '10': 'userEvent', '17': true},
...
final $typed_data.Uint8List writeUserEventRequestDescriptor = $convert.base64Decode(
    ...
    'VyeWVuZ2luZS5nb29nbGVhcGlzLmNvbS9EYXRhU3RvcmVSBnBhcmVudBJYCgp1c2VyX2V2ZW50'
    'GAIgASgLMi8uZ29vZ2xlLmNsb3VkLmRpc2NvdmVyeWVuZ2luZS52MWFscGhhLlVzZXJFdmVudE'
    'ID4EECSABSCXVzZXJFdmVudIgBARIfCgt3cml0ZV9hc3luYxgDIAEoCFIKd3JpdGVBc3luY0IN'
    'CgtfdXNlcl9ldmVudA==');
