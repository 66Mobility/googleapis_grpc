...
class ServingConfig_MediaConfig extends $pb.GeneratedMessage {
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(_omitMessageNames ? '' : 'ServingConfig.MediaConfig', package: const $pb.PackageName(_omitMessageNames ? '' : 'google.cloud.discoveryengine.v1alpha'), createEmptyInstance: create)
    ..oo(0, [2, 5])
...
class ServingConfig_GenericConfig extends $pb.GeneratedMessage {
  factory ServingConfig_GenericConfig({
    $959.SearchRequest_ContentSearchSpec? contentSearchSpec,
  }) {
    final $result = create();
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(_omitMessageNames ? '' : 'ServingConfig.GenericConfig', package: const $pb.PackageName(_omitMessageNames ? '' : 'google.cloud.discoveryengine.v1alpha'), createEmptyInstance: create)
    ..aOM<$959.SearchRequest_ContentSearchSpec>(1, _omitFieldNames ? '' : 'contentSearchSpec', subBuilder: $959.SearchRequest_ContentSearchSpec.create)
    ..hasRequiredFields = false
  ;
  ...
  @$pb.TagNumber(1)
  $959.SearchRequest_ContentSearchSpec get contentSearchSpec => $_getN(0);
  @$pb.TagNumber(1)
  set contentSearchSpec($959.SearchRequest_ContentSearchSpec v) { setField(1, v); }
  @$pb.TagNumber(1)
  $core.bool hasContentSearchSpec() => $_has(0);
  @$pb.TagNumber(1)
  void clearContentSearchSpec() => clearField(1);
  @$pb.TagNumber(1)
  $959.SearchRequest_ContentSearchSpec ensureContentSearchSpec() => $_ensure(0);
}
...
class ServingConfig extends $pb.GeneratedMessage {
  factory ServingConfig({
    ...
    if (guidedSearchSpec != null) {
      $result.guidedSearchSpec = guidedSearchSpec;
    }
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(_omitMessageNames ? '' : 'ServingConfig', package: const $pb.PackageName(_omitMessageNames ? '' : 'google.cloud.discoveryengine.v1alpha'), createEmptyInstance: create)
    ..oo(0, [7, 10])
