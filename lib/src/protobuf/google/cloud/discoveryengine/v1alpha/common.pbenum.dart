...
class IdpConfig_IdpType extends $pb.ProtobufEnum {
  static const IdpConfig_IdpType IDP_TYPE_UNSPECIFIED = IdpConfig_IdpType._(0, _omitEnumNames ? '' : 'IDP_TYPE_UNSPECIFIED');
  static const IdpConfig_IdpType GSUITE = IdpConfig_IdpType._(1, _omitEnumNames ? '' : 'GSUITE');
  static const IdpConfig_IdpType THIRD_PARTY = IdpConfig_IdpType._(2, _omitEnumNames ? '' : 'THIRD_PARTY');

  static const $core.List<IdpConfig_IdpType> values = <IdpConfig_IdpType> [
    IDP_TYPE_UNSPECIFIED,
    GSUITE,
    THIRD_PARTY,
  ];

  static final $core.Map<$core.int, IdpConfig_IdpType> _byValue = $pb.ProtobufEnum.initByValue(values);
  static IdpConfig_IdpType? valueOf($core.int value) => _byValue[value];

  const IdpConfig_IdpType._($core.int v, $core.String n) : super(v, n);
}
