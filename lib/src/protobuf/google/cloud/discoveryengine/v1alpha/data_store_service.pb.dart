...
class CreateDataStoreRequest extends $pb.GeneratedMessage {
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(_omitMessageNames ? '' : 'CreateDataStoreRequest', package: const $pb.PackageName(_omitMessageNames ? '' : 'google.cloud.discoveryengine.v1alpha'), createEmptyInstance: create)
    ..aOS(1, _omitFieldNames ? '' : 'parent')
    ..aOM<$965.DataStore>(2, _omitFieldNames ? '' : 'dataStore', subBuilder: $965.DataStore.create)
  ...
  /// to create.
  @$pb.TagNumber(2)
  $965.DataStore get dataStore => $_getN(1);
  @$pb.TagNumber(2)
  set dataStore($965.DataStore v) { setField(2, v); }
  @$pb.TagNumber(2)
  $core.bool hasDataStore() => $_has(1);
  @$pb.TagNumber(2)
  void clearDataStore() => clearField(2);
  @$pb.TagNumber(2)
  $965.DataStore ensureDataStore() => $_ensure(1);
...
class GetDataStoreRequest extends $pb.GeneratedMessage {
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(_omitMessageNames ? '' : 'GetDataStoreRequest', package: const $pb.PackageName(_omitMessageNames ? '' : 'google.cloud.discoveryengine.v1alpha'), createEmptyInstance: create)
...
class CreateDataStoreMetadata extends $pb.GeneratedMessage {
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(_omitMessageNames ? '' : 'CreateDataStoreMetadata', package: const $pb.PackageName(_omitMessageNames ? '' : 'google.cloud.discoveryengine.v1alpha'), createEmptyInstance: create)
...
class ListDataStoresRequest extends $pb.GeneratedMessage {
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(_omitMessageNames ? '' : 'ListDataStoresRequest', package: const $pb.PackageName(_omitMessageNames ? '' : 'google.cloud.discoveryengine.v1alpha'), createEmptyInstance: create)
    ..aOS(1, _omitFieldNames ? '' : 'parent')
...
class ListDataStoresResponse extends $pb.GeneratedMessage {
  factory ListDataStoresResponse({
    $core.Iterable<$965.DataStore>? dataStores,
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(_omitMessageNames ? '' : 'ListDataStoresResponse', package: const $pb.PackageName(_omitMessageNames ? '' : 'google.cloud.discoveryengine.v1alpha'), createEmptyInstance: create)
    ..pc<$965.DataStore>(1, _omitFieldNames ? '' : 'dataStores', $pb.PbFieldType.PM, subBuilder: $965.DataStore.create)
  ...
  @$pb.TagNumber(1)
  $core.List<$965.DataStore> get dataStores => $_getList(0);
...
class DeleteDataStoreRequest extends $pb.GeneratedMessage {
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(_omitMessageNames ? '' : 'DeleteDataStoreRequest', package: const $pb.PackageName(_omitMessageNames ? '' : 'google.cloud.discoveryengine.v1alpha'), createEmptyInstance: create)
    ..aOS(1, _omitFieldNames ? '' : 'name')
    ..hasRequiredFields = false
  ;
...
class UpdateDataStoreRequest extends $pb.GeneratedMessage {
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(_omitMessageNames ? '' : 'UpdateDataStoreRequest', package: const $pb.PackageName(_omitMessageNames ? '' : 'google.cloud.discoveryengine.v1alpha'), createEmptyInstance: create)
    ..aOM<$965.DataStore>(1, _omitFieldNames ? '' : 'dataStore', subBuilder: $965.DataStore.create)
  ...
  @$pb.TagNumber(1)
  $965.DataStore get dataStore => $_getN(0);
  @$pb.TagNumber(1)
  set dataStore($965.DataStore v) { setField(1, v); }
  @$pb.TagNumber(1)
  $core.bool hasDataStore() => $_has(0);
  @$pb.TagNumber(1)
  void clearDataStore() => clearField(1);
  @$pb.TagNumber(1)
  $965.DataStore ensureDataStore() => $_ensure(0);
...
class DeleteDataStoreMetadata extends $pb.GeneratedMessage {
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(_omitMessageNames ? '' : 'DeleteDataStoreMetadata', package: const $pb.PackageName(_omitMessageNames ? '' : 'google.cloud.discoveryengine.v1alpha'), createEmptyInstance: create)
    ..aOM<$1776.Timestamp>(1, _omitFieldNames ? '' : 'createTime', subBuilder: $1776.Timestamp.create)
    ..aOM<$1776.Timestamp>(2, _omitFieldNames ? '' : 'updateTime', subBuilder: $1776.Timestamp.create)
    ..hasRequiredFields = false
  ;
...
/// method.
class GetDocumentProcessingConfigRequest extends $pb.GeneratedMessage {
  factory GetDocumentProcessingConfigRequest({
    $core.String? name,
  }) {
    final $result = create();
    if (name != null) {
  ...
  GetDocumentProcessingConfigRequest._() : super();
  factory GetDocumentProcessingConfigRequest.fromBuffer($core.List<$core.int> i, [$pb.ExtensionRegistry r = $pb.ExtensionRegistry.EMPTY]) => create()..mergeFromBuffer(i, r);
  factory GetDocumentProcessingConfigRequest.fromJson($core.String i, [$pb.ExtensionRegistry r = $pb.ExtensionRegistry.EMPTY]) => create()..mergeFromJson(i, r);

  static final $pb.BuilderInfo _i = $pb.BuilderInfo(_omitMessageNames ? '' : 'GetDocumentProcessingConfigRequest', package: const $pb.PackageName(_omitMessageNames ? '' : 'google.cloud.discoveryengine.v1alpha'), createEmptyInstance: create)
    ..aOS(1, _omitFieldNames ? '' : 'name')
    ..hasRequiredFields = false
  ;
  ...
  'Use [GeneratedMessageGenericExtensions.deepCopy] instead. '
  'Will be removed in next major version')
  GetDocumentProcessingConfigRequest clone() => GetDocumentProcessingConfigRequest()..mergeFromMessage(this);
  @$core.Deprecated(
  'Using this can add significant overhead to your binary. '
  'Use [GeneratedMessageGenericExtensions.rebuild] instead. '
  'Will be removed in next major version')
  GetDocumentProcessingConfigRequest copyWith(void Function(GetDocumentProcessingConfigRequest) updates) => super.copyWith((message) => updates(message as GetDocumentProcessingConfigRequest)) as GetDocumentProcessingConfigRequest;

  $pb.BuilderInfo get info_ => _i;

  @$core.pragma('dart2js:noInline')
  static GetDocumentProcessingConfigRequest create() => GetDocumentProcessingConfigRequest._();
  GetDocumentProcessingConfigRequest createEmptyInstance() => create();
  static $pb.PbList<GetDocumentProcessingConfigRequest> createRepeated() => $pb.PbList<GetDocumentProcessingConfigRequest>();
  @$core.pragma('dart2js:noInline')
  static GetDocumentProcessingConfigRequest getDefault() => _defaultInstance ??= $pb.GeneratedMessage.$_defaultFor<GetDocumentProcessingConfigRequest>(create);
  static GetDocumentProcessingConfigRequest? _defaultInstance;
...
/// method.
class UpdateDocumentProcessingConfigRequest extends $pb.GeneratedMessage {
  factory UpdateDocumentProcessingConfigRequest({
  ...
  UpdateDocumentProcessingConfigRequest._() : super();
  factory UpdateDocumentProcessingConfigRequest.fromBuffer($core.List<$core.int> i, [$pb.ExtensionRegistry r = $pb.ExtensionRegistry.EMPTY]) => create()..mergeFromBuffer(i, r);
  factory UpdateDocumentProcessingConfigRequest.fromJson($core.String i, [$pb.ExtensionRegistry r = $pb.ExtensionRegistry.EMPTY]) => create()..mergeFromJson(i, r);

  static final $pb.BuilderInfo _i = $pb.BuilderInfo(_omitMessageNames ? '' : 'UpdateDocumentProcessingConfigRequest', package: const $pb.PackageName(_omitMessageNames ? '' : 'google.cloud.discoveryengine.v1alpha'), createEmptyInstance: create)
    ..aOM<$966.DocumentProcessingConfig>(1, _omitFieldNames ? '' : 'documentProcessingConfig', subBuilder: $966.DocumentProcessingConfig.create)
    ..aOM<$2210.FieldMask>(2, _omitFieldNames ? '' : 'updateMask', subBuilder: $2210.FieldMask.create)
    ..hasRequiredFields = false
  ;
  ...
  'Use [GeneratedMessageGenericExtensions.deepCopy] instead. '
  'Will be removed in next major version')
  UpdateDocumentProcessingConfigRequest clone() => UpdateDocumentProcessingConfigRequest()..mergeFromMessage(this);
  @$core.Deprecated(
  'Using this can add significant overhead to your binary. '
  'Use [GeneratedMessageGenericExtensions.rebuild] instead. '
  'Will be removed in next major version')
  UpdateDocumentProcessingConfigRequest copyWith(void Function(UpdateDocumentProcessingConfigRequest) updates) => super.copyWith((message) => updates(message as UpdateDocumentProcessingConfigRequest)) as UpdateDocumentProcessingConfigRequest;

  $pb.BuilderInfo get info_ => _i;

  @$core.pragma('dart2js:noInline')
  static UpdateDocumentProcessingConfigRequest create() => UpdateDocumentProcessingConfigRequest._();
  UpdateDocumentProcessingConfigRequest createEmptyInstance() => create();
  static $pb.PbList<UpdateDocumentProcessingConfigRequest> createRepeated() => $pb.PbList<UpdateDocumentProcessingConfigRequest>();
  @$core.pragma('dart2js:noInline')
  static UpdateDocumentProcessingConfigRequest getDefault() => _defaultInstance ??= $pb.GeneratedMessage.$_defaultFor<UpdateDocumentProcessingConfigRequest>(create);
  static UpdateDocumentProcessingConfigRequest? _defaultInstance;
  ...
  @$pb.TagNumber(1)
  $966.DocumentProcessingConfig get documentProcessingConfig => $_getN(0);
  @$pb.TagNumber(1)
  set documentProcessingConfig($966.DocumentProcessingConfig v) { setField(1, v); }
  @$pb.TagNumber(1)
  $core.bool hasDocumentProcessingConfig() => $_has(0);
  @$pb.TagNumber(1)
  void clearDocumentProcessingConfig() => clearField(1);
  @$pb.TagNumber(1)
  $966.DocumentProcessingConfig ensureDocumentProcessingConfig() => $_ensure(0);
