...
class GetEvaluationRequest extends $pb.GeneratedMessage {
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(_omitMessageNames ? '' : 'GetEvaluationRequest', package: const $pb.PackageName(_omitMessageNames ? '' : 'google.cloud.discoveryengine.v1alpha'), createEmptyInstance: create)
...
class ListEvaluationsRequest extends $pb.GeneratedMessage {
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(_omitMessageNames ? '' : 'ListEvaluationsRequest', package: const $pb.PackageName(_omitMessageNames ? '' : 'google.cloud.discoveryengine.v1alpha'), createEmptyInstance: create)
...
class ListEvaluationsResponse extends $pb.GeneratedMessage {
  factory ListEvaluationsResponse({
    $core.Iterable<$973.Evaluation>? evaluations,
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(_omitMessageNames ? '' : 'ListEvaluationsResponse', package: const $pb.PackageName(_omitMessageNames ? '' : 'google.cloud.discoveryengine.v1alpha'), createEmptyInstance: create)
    ..pc<$973.Evaluation>(1, _omitFieldNames ? '' : 'evaluations', $pb.PbFieldType.PM, subBuilder: $973.Evaluation.create)
  ...
  @$pb.TagNumber(1)
  $core.List<$973.Evaluation> get evaluations => $_getList(0);
...
class CreateEvaluationRequest extends $pb.GeneratedMessage {
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(_omitMessageNames ? '' : 'CreateEvaluationRequest', package: const $pb.PackageName(_omitMessageNames ? '' : 'google.cloud.discoveryengine.v1alpha'), createEmptyInstance: create)
    ..aOS(1, _omitFieldNames ? '' : 'parent')
    ..aOM<$973.Evaluation>(2, _omitFieldNames ? '' : 'evaluation', subBuilder: $973.Evaluation.create)
    ..hasRequiredFields = false
  ;
  ...
  /// to create.
  @$pb.TagNumber(2)
  $973.Evaluation get evaluation => $_getN(1);
  @$pb.TagNumber(2)
  set evaluation($973.Evaluation v) { setField(2, v); }
  @$pb.TagNumber(2)
  $core.bool hasEvaluation() => $_has(1);
  @$pb.TagNumber(2)
  void clearEvaluation() => clearField(2);
  @$pb.TagNumber(2)
  $973.Evaluation ensureEvaluation() => $_ensure(1);
}
...
class CreateEvaluationMetadata extends $pb.GeneratedMessage {
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(_omitMessageNames ? '' : 'CreateEvaluationMetadata', package: const $pb.PackageName(_omitMessageNames ? '' : 'google.cloud.discoveryengine.v1alpha'), createEmptyInstance: create)
    ..hasRequiredFields = false
  ;
...
class ListEvaluationResultsRequest extends $pb.GeneratedMessage {
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(_omitMessageNames ? '' : 'ListEvaluationResultsRequest', package: const $pb.PackageName(_omitMessageNames ? '' : 'google.cloud.discoveryengine.v1alpha'), createEmptyInstance: create)
...
class ListEvaluationResultsResponse_EvaluationResult extends $pb.GeneratedMessage {
  factory ListEvaluationResultsResponse_EvaluationResult({
    $980.SampleQuery? sampleQuery,
    $973.QualityMetrics? qualityMetrics,
  }) {
    final $result = create();
    if (sampleQuery != null) {
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(_omitMessageNames ? '' : 'ListEvaluationResultsResponse.EvaluationResult', package: const $pb.PackageName(_omitMessageNames ? '' : 'google.cloud.discoveryengine.v1alpha'), createEmptyInstance: create)
    ..aOM<$980.SampleQuery>(1, _omitFieldNames ? '' : 'sampleQuery', subBuilder: $980.SampleQuery.create)
    ..aOM<$973.QualityMetrics>(2, _omitFieldNames ? '' : 'qualityMetrics', subBuilder: $973.QualityMetrics.create)
    ..hasRequiredFields = false
  ;
  ...
  /// evaluated.
  @$pb.TagNumber(1)
  $980.SampleQuery get sampleQuery => $_getN(0);
  @$pb.TagNumber(1)
  set sampleQuery($980.SampleQuery v) { setField(1, v); }
  @$pb.TagNumber(1)
  $core.bool hasSampleQuery() => $_has(0);
  @$pb.TagNumber(1)
  void clearSampleQuery() => clearField(1);
  @$pb.TagNumber(1)
  $980.SampleQuery ensureSampleQuery() => $_ensure(0);

  /// Output only. The metrics produced by the evaluation, for a given
  /// [SampleQuery][google.cloud.discoveryengine.v1alpha.SampleQuery].
  @$pb.TagNumber(2)
  $973.QualityMetrics get qualityMetrics => $_getN(1);
  @$pb.TagNumber(2)
  set qualityMetrics($973.QualityMetrics v) { setField(2, v); }
  @$pb.TagNumber(2)
  $core.bool hasQualityMetrics() => $_has(1);
  @$pb.TagNumber(2)
  void clearQualityMetrics() => clearField(2);
  @$pb.TagNumber(2)
  $973.QualityMetrics ensureQualityMetrics() => $_ensure(1);
}
...
class ListEvaluationResultsResponse extends $pb.GeneratedMessage {
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(_omitMessageNames ? '' : 'ListEvaluationResultsResponse', package: const $pb.PackageName(_omitMessageNames ? '' : 'google.cloud.discoveryengine.v1alpha'), createEmptyInstance: create)
