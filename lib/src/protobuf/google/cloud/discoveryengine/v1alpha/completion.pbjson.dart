...
const SuggestionDenyListEntry$json = {
  ...
  '2': [
    ...
    {'1': 'match_operator', '3': 2, '4': 1, '5': 14, '6': '.google.cloud.discoveryengine.v1alpha.SuggestionDenyListEntry.MatchOperator', '8': {}, '10': 'matchOperator'},
  ],
...
final $typed_data.Uint8List suggestionDenyListEntryDescriptor = $convert.base64Decode(
    ...
    'xvY2tQaHJhc2USdwoObWF0Y2hfb3BlcmF0b3IYAiABKA4ySy5nb29nbGUuY2xvdWQuZGlzY292'
    'ZXJ5ZW5naW5lLnYxYWxwaGEuU3VnZ2VzdGlvbkRlbnlMaXN0RW50cnkuTWF0Y2hPcGVyYXRvck'
    'ID4EECUg1tYXRjaE9wZXJhdG9yIk4KDU1hdGNoT3BlcmF0b3ISHgoaTUFUQ0hfT1BFUkFUT1Jf'
    'VU5TUEVDSUZJRUQQABIPCgtFWEFDVF9NQVRDSBABEgwKCENPTlRBSU5TEAI=');
