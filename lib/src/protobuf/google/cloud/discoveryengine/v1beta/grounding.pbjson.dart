...
const GroundingFact$json = {
  ...
  '2': [
    ...
    {'1': 'attributes', '3': 2, '4': 3, '5': 11, '6': '.google.cloud.discoveryengine.v1beta.GroundingFact.AttributesEntry', '10': 'attributes'},
  ],
...
final $typed_data.Uint8List groundingFactDescriptor = $convert.base64Decode(
    'Cg1Hcm91bmRpbmdGYWN0EhsKCWZhY3RfdGV4dBgBIAEoCVIIZmFjdFRleHQSYgoKYXR0cmlidX'
    'RlcxgCIAMoCzJCLmdvb2dsZS5jbG91ZC5kaXNjb3ZlcnllbmdpbmUudjFiZXRhLkdyb3VuZGlu'
    'Z0ZhY3QuQXR0cmlidXRlc0VudHJ5UgphdHRyaWJ1dGVzGj0KD0F0dHJpYnV0ZXNFbnRyeRIQCg'
...
const FactChunk$json = {
  ...
  '2': [
    ...
    {'1': 'source_metadata', '3': 3, '4': 3, '5': 11, '6': '.google.cloud.discoveryengine.v1beta.FactChunk.SourceMetadataEntry', '10': 'sourceMetadata'},
  ],
...
final $typed_data.Uint8List factChunkDescriptor = $convert.base64Decode(
    ...
    'EoCVIGc291cmNlEhQKBWluZGV4GAQgASgFUgVpbmRleBJrCg9zb3VyY2VfbWV0YWRhdGEYAyAD'
    'KAsyQi5nb29nbGUuY2xvdWQuZGlzY292ZXJ5ZW5naW5lLnYxYmV0YS5GYWN0Q2h1bmsuU291cm'
    'NlTWV0YWRhdGFFbnRyeVIOc291cmNlTWV0YWRhdGEaQQoTU291cmNlTWV0YWRhdGFFbnRyeRIQ'
