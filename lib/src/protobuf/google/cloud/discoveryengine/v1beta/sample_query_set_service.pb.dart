...
class GetSampleQuerySetRequest extends $pb.GeneratedMessage {
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(_omitMessageNames ? '' : 'GetSampleQuerySetRequest', package: const $pb.PackageName(_omitMessageNames ? '' : 'google.cloud.discoveryengine.v1beta'), createEmptyInstance: create)
...
class ListSampleQuerySetsRequest extends $pb.GeneratedMessage {
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(_omitMessageNames ? '' : 'ListSampleQuerySetsRequest', package: const $pb.PackageName(_omitMessageNames ? '' : 'google.cloud.discoveryengine.v1beta'), createEmptyInstance: create)
...
class ListSampleQuerySetsResponse extends $pb.GeneratedMessage {
  factory ListSampleQuerySetsResponse({
    $core.Iterable<$1017.SampleQuerySet>? sampleQuerySets,
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(_omitMessageNames ? '' : 'ListSampleQuerySetsResponse', package: const $pb.PackageName(_omitMessageNames ? '' : 'google.cloud.discoveryengine.v1beta'), createEmptyInstance: create)
    ..pc<$1017.SampleQuerySet>(1, _omitFieldNames ? '' : 'sampleQuerySets', $pb.PbFieldType.PM, subBuilder: $1017.SampleQuerySet.create)
  ...
  @$pb.TagNumber(1)
  $core.List<$1017.SampleQuerySet> get sampleQuerySets => $_getList(0);
...
class CreateSampleQuerySetRequest extends $pb.GeneratedMessage {
  factory CreateSampleQuerySetRequest({
    $core.String? parent,
    $1017.SampleQuerySet? sampleQuerySet,
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(_omitMessageNames ? '' : 'CreateSampleQuerySetRequest', package: const $pb.PackageName(_omitMessageNames ? '' : 'google.cloud.discoveryengine.v1beta'), createEmptyInstance: create)
    ..aOS(1, _omitFieldNames ? '' : 'parent')
    ..aOM<$1017.SampleQuerySet>(2, _omitFieldNames ? '' : 'sampleQuerySet', subBuilder: $1017.SampleQuerySet.create)
  ...
  /// create.
  @$pb.TagNumber(2)
  $1017.SampleQuerySet get sampleQuerySet => $_getN(1);
  @$pb.TagNumber(2)
  set sampleQuerySet($1017.SampleQuerySet v) { setField(2, v); }
  @$pb.TagNumber(2)
  $core.bool hasSampleQuerySet() => $_has(1);
  @$pb.TagNumber(2)
  void clearSampleQuerySet() => clearField(2);
  @$pb.TagNumber(2)
  $1017.SampleQuerySet ensureSampleQuerySet() => $_ensure(1);
...
class UpdateSampleQuerySetRequest extends $pb.GeneratedMessage {
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(_omitMessageNames ? '' : 'UpdateSampleQuerySetRequest', package: const $pb.PackageName(_omitMessageNames ? '' : 'google.cloud.discoveryengine.v1beta'), createEmptyInstance: create)
    ..aOM<$1017.SampleQuerySet>(1, _omitFieldNames ? '' : 'sampleQuerySet', subBuilder: $1017.SampleQuerySet.create)
  ...
  @$pb.TagNumber(1)
  $1017.SampleQuerySet get sampleQuerySet => $_getN(0);
  @$pb.TagNumber(1)
  set sampleQuerySet($1017.SampleQuerySet v) { setField(1, v); }
  @$pb.TagNumber(1)
  $core.bool hasSampleQuerySet() => $_has(0);
  @$pb.TagNumber(1)
  void clearSampleQuerySet() => clearField(1);
  @$pb.TagNumber(1)
  $1017.SampleQuerySet ensureSampleQuerySet() => $_ensure(0);
...
class DeleteSampleQuerySetRequest extends $pb.GeneratedMessage {
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(_omitMessageNames ? '' : 'DeleteSampleQuerySetRequest', package: const $pb.PackageName(_omitMessageNames ? '' : 'google.cloud.discoveryengine.v1beta'), createEmptyInstance: create)
    ..aOS(1, _omitFieldNames ? '' : 'name')
    ..hasRequiredFields = false
  ;
