...
const CreateControlRequest$json = {
  ...
  '2': [
    ...
    {'1': 'control', '3': 2, '4': 1, '5': 11, '6': '.google.cloud.discoveryengine.v1beta.Control', '8': {}, '10': 'control'},
...
final $typed_data.Uint8List createControlRequestDescriptor = $convert.base64Decode(
    ...
    'J5ZW5naW5lLmdvb2dsZWFwaXMuY29tL0NvbnRyb2xSBnBhcmVudBJLCgdjb250cm9sGAIgASgL'
    'MiwuZ29vZ2xlLmNsb3VkLmRpc2NvdmVyeWVuZ2luZS52MWJldGEuQ29udHJvbEID4EECUgdjb2'
    '50cm9sEiIKCmNvbnRyb2xfaWQYAyABKAlCA+BBAlIJY29udHJvbElk');

@$core.Deprecated('Use updateControlRequestDescriptor instead')
const UpdateControlRequest$json = {
  '1': 'UpdateControlRequest',
  '2': [
    {'1': 'control', '3': 1, '4': 1, '5': 11, '6': '.google.cloud.discoveryengine.v1beta.Control', '8': {}, '10': 'control'},
...
final $typed_data.Uint8List updateControlRequestDescriptor = $convert.base64Decode(
    'ChRVcGRhdGVDb250cm9sUmVxdWVzdBJLCgdjb250cm9sGAEgASgLMiwuZ29vZ2xlLmNsb3VkLm'
    'Rpc2NvdmVyeWVuZ2luZS52MWJldGEuQ29udHJvbEID4EECUgdjb250cm9sEkAKC3VwZGF0ZV9t'
...
const ListControlsResponse$json = {
  ...
  '2': [
    {'1': 'controls', '3': 1, '4': 3, '5': 11, '6': '.google.cloud.discoveryengine.v1beta.Control', '10': 'controls'},
...
final $typed_data.Uint8List listControlsResponseDescriptor = $convert.base64Decode(
    'ChRMaXN0Q29udHJvbHNSZXNwb25zZRJICghjb250cm9scxgBIAMoCzIsLmdvb2dsZS5jbG91ZC'
    '5kaXNjb3ZlcnllbmdpbmUudjFiZXRhLkNvbnRyb2xSCGNvbnRyb2xzEiYKD25leHRfcGFnZV90'
