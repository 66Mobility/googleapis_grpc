...
class UpdateServingConfigRequest extends $pb.GeneratedMessage {
  factory UpdateServingConfigRequest({
    $1022.ServingConfig? servingConfig,
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(_omitMessageNames ? '' : 'UpdateServingConfigRequest', package: const $pb.PackageName(_omitMessageNames ? '' : 'google.cloud.discoveryengine.v1beta'), createEmptyInstance: create)
    ..aOM<$1022.ServingConfig>(1, _omitFieldNames ? '' : 'servingConfig', subBuilder: $1022.ServingConfig.create)
  ...
  @$pb.TagNumber(1)
  $1022.ServingConfig get servingConfig => $_getN(0);
  @$pb.TagNumber(1)
  set servingConfig($1022.ServingConfig v) { setField(1, v); }
  @$pb.TagNumber(1)
  $core.bool hasServingConfig() => $_has(0);
  @$pb.TagNumber(1)
  void clearServingConfig() => clearField(1);
  @$pb.TagNumber(1)
  $1022.ServingConfig ensureServingConfig() => $_ensure(0);
...
class GetServingConfigRequest extends $pb.GeneratedMessage {
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(_omitMessageNames ? '' : 'GetServingConfigRequest', package: const $pb.PackageName(_omitMessageNames ? '' : 'google.cloud.discoveryengine.v1beta'), createEmptyInstance: create)
...
class ListServingConfigsRequest extends $pb.GeneratedMessage {
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(_omitMessageNames ? '' : 'ListServingConfigsRequest', package: const $pb.PackageName(_omitMessageNames ? '' : 'google.cloud.discoveryengine.v1beta'), createEmptyInstance: create)
...
class ListServingConfigsResponse extends $pb.GeneratedMessage {
  factory ListServingConfigsResponse({
    $core.Iterable<$1022.ServingConfig>? servingConfigs,
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(_omitMessageNames ? '' : 'ListServingConfigsResponse', package: const $pb.PackageName(_omitMessageNames ? '' : 'google.cloud.discoveryengine.v1beta'), createEmptyInstance: create)
    ..pc<$1022.ServingConfig>(1, _omitFieldNames ? '' : 'servingConfigs', $pb.PbFieldType.PM, subBuilder: $1022.ServingConfig.create)
  ...
  @$pb.TagNumber(1)
  $core.List<$1022.ServingConfig> get servingConfigs => $_getList(0);
