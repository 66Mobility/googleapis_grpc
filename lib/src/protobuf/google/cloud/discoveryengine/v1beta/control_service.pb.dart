...
class CreateControlRequest extends $pb.GeneratedMessage {
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(_omitMessageNames ? '' : 'CreateControlRequest', package: const $pb.PackageName(_omitMessageNames ? '' : 'google.cloud.discoveryengine.v1beta'), createEmptyInstance: create)
    ..aOS(1, _omitFieldNames ? '' : 'parent')
    ..aOM<$996.Control>(2, _omitFieldNames ? '' : 'control', subBuilder: $996.Control.create)
  ...
  @$pb.TagNumber(2)
  $996.Control get control => $_getN(1);
  @$pb.TagNumber(2)
  set control($996.Control v) { setField(2, v); }
  @$pb.TagNumber(2)
  $core.bool hasControl() => $_has(1);
  @$pb.TagNumber(2)
  void clearControl() => clearField(2);
  @$pb.TagNumber(2)
  $996.Control ensureControl() => $_ensure(1);
...
class UpdateControlRequest extends $pb.GeneratedMessage {
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(_omitMessageNames ? '' : 'UpdateControlRequest', package: const $pb.PackageName(_omitMessageNames ? '' : 'google.cloud.discoveryengine.v1beta'), createEmptyInstance: create)
    ..aOM<$996.Control>(1, _omitFieldNames ? '' : 'control', subBuilder: $996.Control.create)
  ...
  @$pb.TagNumber(1)
  $996.Control get control => $_getN(0);
  @$pb.TagNumber(1)
  set control($996.Control v) { setField(1, v); }
  @$pb.TagNumber(1)
  $core.bool hasControl() => $_has(0);
  @$pb.TagNumber(1)
  void clearControl() => clearField(1);
  @$pb.TagNumber(1)
  $996.Control ensureControl() => $_ensure(0);
...
class DeleteControlRequest extends $pb.GeneratedMessage {
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(_omitMessageNames ? '' : 'DeleteControlRequest', package: const $pb.PackageName(_omitMessageNames ? '' : 'google.cloud.discoveryengine.v1beta'), createEmptyInstance: create)
...
class GetControlRequest extends $pb.GeneratedMessage {
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(_omitMessageNames ? '' : 'GetControlRequest', package: const $pb.PackageName(_omitMessageNames ? '' : 'google.cloud.discoveryengine.v1beta'), createEmptyInstance: create)
    ..aOS(1, _omitFieldNames ? '' : 'name')
    ..hasRequiredFields = false
  ;
...
class ListControlsRequest extends $pb.GeneratedMessage {
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(_omitMessageNames ? '' : 'ListControlsRequest', package: const $pb.PackageName(_omitMessageNames ? '' : 'google.cloud.discoveryengine.v1beta'), createEmptyInstance: create)
    ..aOS(1, _omitFieldNames ? '' : 'parent')
...
class ListControlsResponse extends $pb.GeneratedMessage {
  factory ListControlsResponse({
    $core.Iterable<$996.Control>? controls,
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(_omitMessageNames ? '' : 'ListControlsResponse', package: const $pb.PackageName(_omitMessageNames ? '' : 'google.cloud.discoveryengine.v1beta'), createEmptyInstance: create)
    ..pc<$996.Control>(1, _omitFieldNames ? '' : 'controls', $pb.PbFieldType.PM, subBuilder: $996.Control.create)
  ...
  @$pb.TagNumber(1)
  $core.List<$996.Control> get controls => $_getList(0);
