...
const RankRequest$json = {
  ...
  '2': [
    ...
    {'1': 'records', '3': 5, '4': 3, '5': 11, '6': '.google.cloud.discoveryengine.v1beta.RankingRecord', '8': {}, '10': 'records'},
    {'1': 'ignore_record_details_in_response', '3': 6, '4': 1, '5': 8, '10': 'ignoreRecordDetailsInResponse'},
    {'1': 'user_labels', '3': 7, '4': 3, '5': 11, '6': '.google.cloud.discoveryengine.v1beta.RankRequest.UserLabelsEntry', '10': 'userLabels'},
  ],
...
final $typed_data.Uint8List rankRequestDescriptor = $convert.base64Decode(
    ...
    'F1ZXJ5ElEKB3JlY29yZHMYBSADKAsyMi5nb29nbGUuY2xvdWQuZGlzY292ZXJ5ZW5naW5lLnYx'
    'YmV0YS5SYW5raW5nUmVjb3JkQgPgQQJSB3JlY29yZHMSSAohaWdub3JlX3JlY29yZF9kZXRhaW'
    'xzX2luX3Jlc3BvbnNlGAYgASgIUh1pZ25vcmVSZWNvcmREZXRhaWxzSW5SZXNwb25zZRJhCgt1'
    'c2VyX2xhYmVscxgHIAMoCzJALmdvb2dsZS5jbG91ZC5kaXNjb3ZlcnllbmdpbmUudjFiZXRhLl'
    'JhbmtSZXF1ZXN0LlVzZXJMYWJlbHNFbnRyeVIKdXNlckxhYmVscxo9Cg9Vc2VyTGFiZWxzRW50'
...
const RankResponse$json = {
  '1': 'RankResponse',
  '2': [
    {'1': 'records', '3': 5, '4': 3, '5': 11, '6': '.google.cloud.discoveryengine.v1beta.RankingRecord', '10': 'records'},
  ],
};
...
final $typed_data.Uint8List rankResponseDescriptor = $convert.base64Decode(
    'CgxSYW5rUmVzcG9uc2USTAoHcmVjb3JkcxgFIAMoCzIyLmdvb2dsZS5jbG91ZC5kaXNjb3Zlcn'
    'llbmdpbmUudjFiZXRhLlJhbmtpbmdSZWNvcmRSB3JlY29yZHM=');
