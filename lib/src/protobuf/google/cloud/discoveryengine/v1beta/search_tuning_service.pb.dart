...
import 'custom_tuning_model.pb.dart' as $4513;
...
class ListCustomModelsResponse extends $pb.GeneratedMessage {
  factory ListCustomModelsResponse({
    $core.Iterable<$4513.CustomTuningModel>? models,
  }) {
    final $result = create();
    if (models != null) {
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(_omitMessageNames ? '' : 'ListCustomModelsResponse', package: const $pb.PackageName(_omitMessageNames ? '' : 'google.cloud.discoveryengine.v1beta'), createEmptyInstance: create)
    ..pc<$4513.CustomTuningModel>(1, _omitFieldNames ? '' : 'models', $pb.PbFieldType.PM, subBuilder: $4513.CustomTuningModel.create)
    ..hasRequiredFields = false
  ;
  ...
  @$pb.TagNumber(1)
  $core.List<$4513.CustomTuningModel> get models => $_getList(0);
}
