...
class Evaluation_EvaluationSpec_QuerySetSpec extends $pb.GeneratedMessage {
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(_omitMessageNames ? '' : 'Evaluation.EvaluationSpec.QuerySetSpec', package: const $pb.PackageName(_omitMessageNames ? '' : 'google.cloud.discoveryengine.v1beta'), createEmptyInstance: create)
...
class Evaluation_EvaluationSpec extends $pb.GeneratedMessage {
  factory Evaluation_EvaluationSpec({
    ...
    $997.SearchRequest? searchRequest,
  }) {
    final $result = create();
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(_omitMessageNames ? '' : 'Evaluation.EvaluationSpec', package: const $pb.PackageName(_omitMessageNames ? '' : 'google.cloud.discoveryengine.v1beta'), createEmptyInstance: create)
    ..oo(0, [2])
    ...
    ..aOM<$997.SearchRequest>(2, _omitFieldNames ? '' : 'searchRequest', subBuilder: $997.SearchRequest.create)
    ..hasRequiredFields = false
  ;
  ...
  @$pb.TagNumber(2)
  $997.SearchRequest get searchRequest => $_getN(1);
  @$pb.TagNumber(2)
  set searchRequest($997.SearchRequest v) { setField(2, v); }
  @$pb.TagNumber(2)
  $core.bool hasSearchRequest() => $_has(1);
  @$pb.TagNumber(2)
  void clearSearchRequest() => clearField(2);
  @$pb.TagNumber(2)
  $997.SearchRequest ensureSearchRequest() => $_ensure(1);
}
...
class Evaluation extends $pb.GeneratedMessage {
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(_omitMessageNames ? '' : 'Evaluation', package: const $pb.PackageName(_omitMessageNames ? '' : 'google.cloud.discoveryengine.v1beta'), createEmptyInstance: create)
...
class QualityMetrics_TopkMetrics extends $pb.GeneratedMessage {
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(_omitMessageNames ? '' : 'QualityMetrics.TopkMetrics', package: const $pb.PackageName(_omitMessageNames ? '' : 'google.cloud.discoveryengine.v1beta'), createEmptyInstance: create)
...
class QualityMetrics extends $pb.GeneratedMessage {
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(_omitMessageNames ? '' : 'QualityMetrics', package: const $pb.PackageName(_omitMessageNames ? '' : 'google.cloud.discoveryengine.v1beta'), createEmptyInstance: create)
