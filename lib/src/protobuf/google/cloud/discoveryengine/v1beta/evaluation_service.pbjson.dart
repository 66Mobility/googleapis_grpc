...
const ListEvaluationsResponse$json = {
  ...
  '2': [
    {'1': 'evaluations', '3': 1, '4': 3, '5': 11, '6': '.google.cloud.discoveryengine.v1beta.Evaluation', '10': 'evaluations'},
...
final $typed_data.Uint8List listEvaluationsResponseDescriptor = $convert.base64Decode(
    'ChdMaXN0RXZhbHVhdGlvbnNSZXNwb25zZRJRCgtldmFsdWF0aW9ucxgBIAMoCzIvLmdvb2dsZS'
    '5jbG91ZC5kaXNjb3ZlcnllbmdpbmUudjFiZXRhLkV2YWx1YXRpb25SC2V2YWx1YXRpb25zEiYK'
...
const CreateEvaluationRequest$json = {
  ...
  '2': [
    {'1': 'parent', '3': 1, '4': 1, '5': 9, '8': {}, '10': 'parent'},
    {'1': 'evaluation', '3': 2, '4': 1, '5': 11, '6': '.google.cloud.discoveryengine.v1beta.Evaluation', '8': {}, '10': 'evaluation'},
  ],
};
...
final $typed_data.Uint8List createEvaluationRequestDescriptor = $convert.base64Decode(
    ...
    '92ZXJ5ZW5naW5lLmdvb2dsZWFwaXMuY29tL0xvY2F0aW9uUgZwYXJlbnQSVAoKZXZhbHVhdGlv'
    'bhgCIAEoCzIvLmdvb2dsZS5jbG91ZC5kaXNjb3ZlcnllbmdpbmUudjFiZXRhLkV2YWx1YXRpb2'
    '5CA+BBAlIKZXZhbHVhdGlvbg==');
...
const ListEvaluationResultsResponse$json = {
  ...
  '2': [
    {'1': 'evaluation_results', '3': 1, '4': 3, '5': 11, '6': '.google.cloud.discoveryengine.v1beta.ListEvaluationResultsResponse.EvaluationResult', '10': 'evaluationResults'},
    {'1': 'next_page_token', '3': 2, '4': 1, '5': 9, '10': 'nextPageToken'},
  ],
...
const ListEvaluationResultsResponse_EvaluationResult$json = {
  ...
  '2': [
    ...
    {'1': 'quality_metrics', '3': 2, '4': 1, '5': 11, '6': '.google.cloud.discoveryengine.v1beta.QualityMetrics', '8': {}, '10': 'qualityMetrics'},
  ],
};
...
final $typed_data.Uint8List listEvaluationResultsResponseDescriptor = $convert.base64Decode(
    'Ch1MaXN0RXZhbHVhdGlvblJlc3VsdHNSZXNwb25zZRKCAQoSZXZhbHVhdGlvbl9yZXN1bHRzGA'
    'EgAygLMlMuZ29vZ2xlLmNsb3VkLmRpc2NvdmVyeWVuZ2luZS52MWJldGEuTGlzdEV2YWx1YXRp'
    'b25SZXN1bHRzUmVzcG9uc2UuRXZhbHVhdGlvblJlc3VsdFIRZXZhbHVhdGlvblJlc3VsdHMSJg'
    'oPbmV4dF9wYWdlX3Rva2VuGAIgASgJUg1uZXh0UGFnZVRva2VuGs8BChBFdmFsdWF0aW9uUmVz'
    'dWx0ElgKDHNhbXBsZV9xdWVyeRgBIAEoCzIwLmdvb2dsZS5jbG91ZC5kaXNjb3Zlcnllbmdpbm'
    'UudjFiZXRhLlNhbXBsZVF1ZXJ5QgPgQQNSC3NhbXBsZVF1ZXJ5EmEKD3F1YWxpdHlfbWV0cmlj'
    'cxgCIAEoCzIzLmdvb2dsZS5jbG91ZC5kaXNjb3ZlcnllbmdpbmUudjFiZXRhLlF1YWxpdHlNZX'
    'RyaWNzQgPgQQNSDnF1YWxpdHlNZXRyaWNz');
