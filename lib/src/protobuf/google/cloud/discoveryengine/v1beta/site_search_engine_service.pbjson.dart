...
const CreateTargetSiteRequest$json = {
  ...
  '2': [
    ...
    {'1': 'target_site', '3': 2, '4': 1, '5': 11, '6': '.google.cloud.discoveryengine.v1beta.TargetSite', '8': {}, '10': 'targetSite'},
  ],
};
...
final $typed_data.Uint8List createTargetSiteRequestDescriptor = $convert.base64Decode(
    ...
    '92ZXJ5ZW5naW5lLmdvb2dsZWFwaXMuY29tL1NpdGVTZWFyY2hFbmdpbmVSBnBhcmVudBJVCgt0'
    'YXJnZXRfc2l0ZRgCIAEoCzIvLmdvb2dsZS5jbG91ZC5kaXNjb3ZlcnllbmdpbmUudjFiZXRhLl'
    'RhcmdldFNpdGVCA+BBAlIKdGFyZ2V0U2l0ZQ==');
...
const BatchCreateTargetSitesRequest$json = {
  ...
  '2': [
    {'1': 'parent', '3': 1, '4': 1, '5': 9, '8': {}, '10': 'parent'},
    {'1': 'requests', '3': 2, '4': 3, '5': 11, '6': '.google.cloud.discoveryengine.v1beta.CreateTargetSiteRequest', '8': {}, '10': 'requests'},
  ],
};
...
final $typed_data.Uint8List batchCreateTargetSitesRequestDescriptor = $convert.base64Decode(
    ...
    'dBJdCghyZXF1ZXN0cxgCIAMoCzI8Lmdvb2dsZS5jbG91ZC5kaXNjb3ZlcnllbmdpbmUudjFiZX'
    'RhLkNyZWF0ZVRhcmdldFNpdGVSZXF1ZXN0QgPgQQJSCHJlcXVlc3Rz');
...
const UpdateTargetSiteRequest$json = {
  ...
  '2': [
    {'1': 'target_site', '3': 1, '4': 1, '5': 11, '6': '.google.cloud.discoveryengine.v1beta.TargetSite', '8': {}, '10': 'targetSite'},
  ],
};
...
final $typed_data.Uint8List updateTargetSiteRequestDescriptor = $convert.base64Decode(
    'ChdVcGRhdGVUYXJnZXRTaXRlUmVxdWVzdBJVCgt0YXJnZXRfc2l0ZRgBIAEoCzIvLmdvb2dsZS'
    '5jbG91ZC5kaXNjb3ZlcnllbmdpbmUudjFiZXRhLlRhcmdldFNpdGVCA+BBAlIKdGFyZ2V0U2l0'
    'ZQ==');
...
const ListTargetSitesResponse$json = {
  ...
  '2': [
    {'1': 'target_sites', '3': 1, '4': 3, '5': 11, '6': '.google.cloud.discoveryengine.v1beta.TargetSite', '10': 'targetSites'},
...
final $typed_data.Uint8List listTargetSitesResponseDescriptor = $convert.base64Decode(
    'ChdMaXN0VGFyZ2V0U2l0ZXNSZXNwb25zZRJSCgx0YXJnZXRfc2l0ZXMYASADKAsyLy5nb29nbG'
    'UuY2xvdWQuZGlzY292ZXJ5ZW5naW5lLnYxYmV0YS5UYXJnZXRTaXRlUgt0YXJnZXRTaXRlcxIm'
    'Cg9uZXh0X3BhZ2VfdG9rZW4YAiABKAlSDW5leHRQYWdlVG9rZW4SHQoKdG90YWxfc2l6ZRgDIA'
    'EoBVIJdG90YWxTaXpl');
...
final $typed_data.Uint8List batchCreateTargetSitesResponseDescriptor = $convert.base64Decode(
    'Ch5CYXRjaENyZWF0ZVRhcmdldFNpdGVzUmVzcG9uc2USUgoMdGFyZ2V0X3NpdGVzGAEgAygLMi'
    '8uZ29vZ2xlLmNsb3VkLmRpc2NvdmVyeWVuZ2luZS52MWJldGEuVGFyZ2V0U2l0ZVILdGFyZ2V0'
    'U2l0ZXM=');
...
const RecrawlUrisResponse$json = {
  ...
  '2': [
    {'1': 'failure_samples', '3': 1, '4': 3, '5': 11, '6': '.google.cloud.discoveryengine.v1beta.RecrawlUrisResponse.FailureInfo', '10': 'failureSamples'},
...
const RecrawlUrisResponse_FailureInfo$json = {
  ...
  '2': [
    ...
    {'1': 'failure_reasons', '3': 2, '4': 3, '5': 11, '6': '.google.cloud.discoveryengine.v1beta.RecrawlUrisResponse.FailureInfo.FailureReason', '10': 'failureReasons'},
  ],
...
const RecrawlUrisResponse_FailureInfo_FailureReason$json = {
  '1': 'FailureReason',
  '2': [
    {'1': 'corpus_type', '3': 1, '4': 1, '5': 14, '6': '.google.cloud.discoveryengine.v1beta.RecrawlUrisResponse.FailureInfo.FailureReason.CorpusType', '10': 'corpusType'},
...
final $typed_data.Uint8List recrawlUrisResponseDescriptor = $convert.base64Decode(
    'ChNSZWNyYXdsVXJpc1Jlc3BvbnNlEm0KD2ZhaWx1cmVfc2FtcGxlcxgBIAMoCzJELmdvb2dsZS'
    '5jbG91ZC5kaXNjb3ZlcnllbmdpbmUudjFiZXRhLlJlY3Jhd2xVcmlzUmVzcG9uc2UuRmFpbHVy'
    'ZUluZm9SDmZhaWx1cmVTYW1wbGVzEh8KC2ZhaWxlZF91cmlzGAIgAygJUgpmYWlsZWRVcmlzGp'
    'cDCgtGYWlsdXJlSW5mbxIQCgN1cmkYASABKAlSA3VyaRJ7Cg9mYWlsdXJlX3JlYXNvbnMYAiAD'
    'KAsyUi5nb29nbGUuY2xvdWQuZGlzY292ZXJ5ZW5naW5lLnYxYmV0YS5SZWNyYXdsVXJpc1Jlc3'
    'BvbnNlLkZhaWx1cmVJbmZvLkZhaWx1cmVSZWFzb25SDmZhaWx1cmVSZWFzb25zGvgBCg1GYWls'
    'dXJlUmVhc29uEn4KC2NvcnB1c190eXBlGAEgASgOMl0uZ29vZ2xlLmNsb3VkLmRpc2NvdmVyeW'
    'VuZ2luZS52MWJldGEuUmVjcmF3bFVyaXNSZXNwb25zZS5GYWlsdXJlSW5mby5GYWlsdXJlUmVh'
    'c29uLkNvcnB1c1R5cGVSCmNvcnB1c1R5cGUSIwoNZXJyb3JfbWVzc2FnZRgCIAEoCVIMZXJyb3'
    'JNZXNzYWdlIkIKCkNvcnB1c1R5cGUSGwoXQ09SUFVTX1RZUEVfVU5TUEVDSUZJRUQQABILCgdE'
    'RVNLVE9QEAESCgoGTU9CSUxFEAI=');
...
final $typed_data.Uint8List fetchDomainVerificationStatusResponseDescriptor = $convert.base64Decode(
    'CiVGZXRjaERvbWFpblZlcmlmaWNhdGlvblN0YXR1c1Jlc3BvbnNlElIKDHRhcmdldF9zaXRlcx'
    'gBIAMoCzIvLmdvb2dsZS5jbG91ZC5kaXNjb3ZlcnllbmdpbmUudjFiZXRhLlRhcmdldFNpdGVS'
    'C3RhcmdldFNpdGVzEiYKD25leHRfcGFnZV90b2tlbhgCIAEoCVINbmV4dFBhZ2VUb2tlbhIdCg'
