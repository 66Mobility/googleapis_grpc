...
class ProductSearchParams extends $pb.GeneratedMessage {
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(_omitMessageNames ? '' : 'ProductSearchParams', package: const $pb.PackageName(_omitMessageNames ? '' : 'google.cloud.vision.v1p4beta1'), createEmptyInstance: create)
...
class ProductSearchResults_Result extends $pb.GeneratedMessage {
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(_omitMessageNames ? '' : 'ProductSearchResults.Result', package: const $pb.PackageName(_omitMessageNames ? '' : 'google.cloud.vision.v1p4beta1'), createEmptyInstance: create)
    ..aOM<$1486.Product>(1, _omitFieldNames ? '' : 'product', subBuilder: $1486.Product.create)
  ...
  /// The Product.
  @$pb.TagNumber(1)
  $1486.Product get product => $_getN(0);
  @$pb.TagNumber(1)
  set product($1486.Product v) { setField(1, v); }
  @$pb.TagNumber(1)
  $core.bool hasProduct() => $_has(0);
  @$pb.TagNumber(1)
  void clearProduct() => clearField(1);
  @$pb.TagNumber(1)
  $1486.Product ensureProduct() => $_ensure(0);
...
class ProductSearchResults_ObjectAnnotation extends $pb.GeneratedMessage {
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(_omitMessageNames ? '' : 'ProductSearchResults.ObjectAnnotation', package: const $pb.PackageName(_omitMessageNames ? '' : 'google.cloud.vision.v1p4beta1'), createEmptyInstance: create)
