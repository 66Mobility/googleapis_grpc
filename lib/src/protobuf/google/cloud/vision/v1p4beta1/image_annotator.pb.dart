...
import 'face.pb.dart' as $4721;
import 'geometry.pb.dart' as $4720;
import 'image_annotator.pbenum.dart';
import 'product_search.pb.dart' as $4722;
import 'text_annotation.pb.dart' as $4723;
import 'web_detection.pb.dart' as $4724;
...
class FaceAnnotation_Landmark extends $pb.GeneratedMessage {
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(_omitMessageNames ? '' : 'FaceAnnotation.Landmark', package: const $pb.PackageName(_omitMessageNames ? '' : 'google.cloud.vision.v1p4beta1'), createEmptyInstance: create)
    ...
    ..aOM<$4720.Position>(4, _omitFieldNames ? '' : 'position', subBuilder: $4720.Position.create)
    ..hasRequiredFields = false
  ;
  ...
  @$pb.TagNumber(4)
  $4720.Position get position => $_getN(1);
  @$pb.TagNumber(4)
  set position($4720.Position v) { setField(4, v); }
  @$pb.TagNumber(4)
  $core.bool hasPosition() => $_has(1);
  @$pb.TagNumber(4)
  void clearPosition() => clearField(4);
  @$pb.TagNumber(4)
  $4720.Position ensurePosition() => $_ensure(1);
}
...
class FaceAnnotation extends $pb.GeneratedMessage {
  factory FaceAnnotation({
    ...
    $4720.BoundingPoly? fdBoundingPoly,
    ...
    $core.Iterable<$4721.FaceRecognitionResult>? recognitionResult,
  }) {
    final $result = create();
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(_omitMessageNames ? '' : 'FaceAnnotation', package: const $pb.PackageName(_omitMessageNames ? '' : 'google.cloud.vision.v1p4beta1'), createEmptyInstance: create)
    ...
    ..aOM<$4720.BoundingPoly>(2, _omitFieldNames ? '' : 'fdBoundingPoly', subBuilder: $4720.BoundingPoly.create)
    ...
    ..pc<$4721.FaceRecognitionResult>(16, _omitFieldNames ? '' : 'recognitionResult', $pb.PbFieldType.PM, subBuilder: $4721.FaceRecognitionResult.create)
    ..hasRequiredFields = false
  ;
  ...
  @$pb.TagNumber(2)
  $4720.BoundingPoly get fdBoundingPoly => $_getN(1);
  @$pb.TagNumber(2)
  set fdBoundingPoly($4720.BoundingPoly v) { setField(2, v); }
  @$pb.TagNumber(2)
  $core.bool hasFdBoundingPoly() => $_has(1);
  @$pb.TagNumber(2)
  void clearFdBoundingPoly() => clearField(2);
  @$pb.TagNumber(2)
  $4720.BoundingPoly ensureFdBoundingPoly() => $_ensure(1);
  ...
  @$pb.TagNumber(16)
  $core.List<$4721.FaceRecognitionResult> get recognitionResult => $_getList(15);
}
...
class EntityAnnotation extends $pb.GeneratedMessage {
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(_omitMessageNames ? '' : 'EntityAnnotation', package: const $pb.PackageName(_omitMessageNames ? '' : 'google.cloud.vision.v1p4beta1'), createEmptyInstance: create)
    ...
    ..aOM<$4720.BoundingPoly>(7, _omitFieldNames ? '' : 'boundingPoly', subBuilder: $4720.BoundingPoly.create)
  ...
  @$pb.TagNumber(7)
  $4720.BoundingPoly get boundingPoly => $_getN(6);
  @$pb.TagNumber(7)
  set boundingPoly($4720.BoundingPoly v) { setField(7, v); }
  @$pb.TagNumber(7)
  $core.bool hasBoundingPoly() => $_has(6);
  @$pb.TagNumber(7)
  void clearBoundingPoly() => clearField(7);
  @$pb.TagNumber(7)
  $4720.BoundingPoly ensureBoundingPoly() => $_ensure(6);
...
class LocalizedObjectAnnotation extends $pb.GeneratedMessage {
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(_omitMessageNames ? '' : 'LocalizedObjectAnnotation', package: const $pb.PackageName(_omitMessageNames ? '' : 'google.cloud.vision.v1p4beta1'), createEmptyInstance: create)
    ...
    ..a<$core.double>(4, _omitFieldNames ? '' : 'score', $pb.PbFieldType.OF)
    ..aOM<$4720.BoundingPoly>(5, _omitFieldNames ? '' : 'boundingPoly', subBuilder: $4720.BoundingPoly.create)
    ..hasRequiredFields = false
  ;
  ...
  @$pb.TagNumber(5)
  $4720.BoundingPoly get boundingPoly => $_getN(4);
  @$pb.TagNumber(5)
  set boundingPoly($4720.BoundingPoly v) { setField(5, v); }
  @$pb.TagNumber(5)
  $core.bool hasBoundingPoly() => $_has(4);
  @$pb.TagNumber(5)
  void clearBoundingPoly() => clearField(5);
  @$pb.TagNumber(5)
  $4720.BoundingPoly ensureBoundingPoly() => $_ensure(4);
}
...
class ImageContext extends $pb.GeneratedMessage {
  factory ImageContext({
    ...
    $4722.ProductSearchParams? productSearchParams,
    WebDetectionParams? webDetectionParams,
    $4721.FaceRecognitionParams? faceRecognitionParams,
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(_omitMessageNames ? '' : 'ImageContext', package: const $pb.PackageName(_omitMessageNames ? '' : 'google.cloud.vision.v1p4beta1'), createEmptyInstance: create)
    ...
    ..aOM<$4722.ProductSearchParams>(5, _omitFieldNames ? '' : 'productSearchParams', subBuilder: $4722.ProductSearchParams.create)
    ..aOM<WebDetectionParams>(6, _omitFieldNames ? '' : 'webDetectionParams', subBuilder: WebDetectionParams.create)
    ..aOM<$4721.FaceRecognitionParams>(10, _omitFieldNames ? '' : 'faceRecognitionParams', subBuilder: $4721.FaceRecognitionParams.create)
  ...
  @$pb.TagNumber(5)
  $4722.ProductSearchParams get productSearchParams => $_getN(3);
  @$pb.TagNumber(5)
  set productSearchParams($4722.ProductSearchParams v) { setField(5, v); }
  @$pb.TagNumber(5)
  $core.bool hasProductSearchParams() => $_has(3);
  @$pb.TagNumber(5)
  void clearProductSearchParams() => clearField(5);
  @$pb.TagNumber(5)
  $4722.ProductSearchParams ensureProductSearchParams() => $_ensure(3);
  ...
  @$pb.TagNumber(10)
  $4721.FaceRecognitionParams get faceRecognitionParams => $_getN(5);
  @$pb.TagNumber(10)
  set faceRecognitionParams($4721.FaceRecognitionParams v) { setField(10, v); }
  @$pb.TagNumber(10)
  $core.bool hasFaceRecognitionParams() => $_has(5);
  @$pb.TagNumber(10)
  void clearFaceRecognitionParams() => clearField(10);
  @$pb.TagNumber(10)
  $4721.FaceRecognitionParams ensureFaceRecognitionParams() => $_ensure(5);
...
class AnnotateImageResponse extends $pb.GeneratedMessage {
  factory AnnotateImageResponse({
    ...
    $4723.TextAnnotation? fullTextAnnotation,
    $4724.WebDetection? webDetection,
    $4722.ProductSearchResults? productSearchResults,
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(_omitMessageNames ? '' : 'AnnotateImageResponse', package: const $pb.PackageName(_omitMessageNames ? '' : 'google.cloud.vision.v1p4beta1'), createEmptyInstance: create)
    ...
    ..aOM<$4723.TextAnnotation>(12, _omitFieldNames ? '' : 'fullTextAnnotation', subBuilder: $4723.TextAnnotation.create)
    ..aOM<$4724.WebDetection>(13, _omitFieldNames ? '' : 'webDetection', subBuilder: $4724.WebDetection.create)
    ..aOM<$4722.ProductSearchResults>(14, _omitFieldNames ? '' : 'productSearchResults', subBuilder: $4722.ProductSearchResults.create)
  ...
  /// text.
  @$pb.TagNumber(12)
  $4723.TextAnnotation get fullTextAnnotation => $_getN(9);
  @$pb.TagNumber(12)
  set fullTextAnnotation($4723.TextAnnotation v) { setField(12, v); }
  @$pb.TagNumber(12)
  $core.bool hasFullTextAnnotation() => $_has(9);
  @$pb.TagNumber(12)
  void clearFullTextAnnotation() => clearField(12);
  @$pb.TagNumber(12)
  $4723.TextAnnotation ensureFullTextAnnotation() => $_ensure(9);

  /// If present, web detection has completed successfully.
  @$pb.TagNumber(13)
  $4724.WebDetection get webDetection => $_getN(10);
  @$pb.TagNumber(13)
  set webDetection($4724.WebDetection v) { setField(13, v); }
  @$pb.TagNumber(13)
  $core.bool hasWebDetection() => $_has(10);
  @$pb.TagNumber(13)
  void clearWebDetection() => clearField(13);
  @$pb.TagNumber(13)
  $4724.WebDetection ensureWebDetection() => $_ensure(10);

  /// If present, product search has completed successfully.
  @$pb.TagNumber(14)
  $4722.ProductSearchResults get productSearchResults => $_getN(11);
  @$pb.TagNumber(14)
  set productSearchResults($4722.ProductSearchResults v) { setField(14, v); }
  @$pb.TagNumber(14)
  $core.bool hasProductSearchResults() => $_has(11);
  @$pb.TagNumber(14)
  void clearProductSearchResults() => clearField(14);
  @$pb.TagNumber(14)
  $4722.ProductSearchResults ensureProductSearchResults() => $_ensure(11);
