...
const Product$json = {
  ...
  '2': [
    ...
    {'1': 'product_labels', '3': 5, '4': 3, '5': 11, '6': '.google.cloud.vision.v1p4beta1.Product.KeyValue', '10': 'productLabels'},
  ],
...
final $typed_data.Uint8List productDescriptor = $convert.base64Decode(
    ...
    'ADKAsyLy5nb29nbGUuY2xvdWQudmlzaW9uLnYxcDRiZXRhMS5Qcm9kdWN0LktleVZhbHVlUg1w'
...
const ReferenceImage$json = {
  ...
  '2': [
    ...
    {'1': 'bounding_polys', '3': 3, '4': 3, '5': 11, '6': '.google.cloud.vision.v1p4beta1.BoundingPoly', '8': {}, '10': 'boundingPolys'},
  ],
  '7': {},
};
...
final $typed_data.Uint8List referenceImageDescriptor = $convert.base64Decode(
    ...
    'N1cmkSVwoOYm91bmRpbmdfcG9seXMYAyADKAsyKy5nb29nbGUuY2xvdWQudmlzaW9uLnYxcDRi'
...
const CreateProductRequest$json = {
  ...
  '2': [
    ...
    {'1': 'product', '3': 2, '4': 1, '5': 11, '6': '.google.cloud.vision.v1p4beta1.Product', '8': {}, '10': 'product'},
...
final $typed_data.Uint8List createProductRequestDescriptor = $convert.base64Decode(
    ...
    'b2dsZS5jbG91ZC52aXNpb24udjFwNGJldGExLlByb2R1Y3RCA+BBAlIHcHJvZHVjdBIdCgpwcm'
...
const ListProductsResponse$json = {
  ...
  '2': [
    {'1': 'products', '3': 1, '4': 3, '5': 11, '6': '.google.cloud.vision.v1p4beta1.Product', '10': 'products'},
...
final $typed_data.Uint8List listProductsResponseDescriptor = $convert.base64Decode(
    ...
    '52aXNpb24udjFwNGJldGExLlByb2R1Y3RSCHByb2R1Y3RzEiYKD25leHRfcGFnZV90b2tlbhgC'
...
const UpdateProductRequest$json = {
  ...
  '2': [
    {'1': 'product', '3': 1, '4': 1, '5': 11, '6': '.google.cloud.vision.v1p4beta1.Product', '8': {}, '10': 'product'},
...
final $typed_data.Uint8List updateProductRequestDescriptor = $convert.base64Decode(
    ...
    'Zpc2lvbi52MXA0YmV0YTEuUHJvZHVjdEID4EECUgdwcm9kdWN0EjsKC3VwZGF0ZV9tYXNrGAIg'
...
const CreateProductSetRequest$json = {
  ...
  '2': [
    {'1': 'parent', '3': 1, '4': 1, '5': 9, '8': {}, '10': 'parent'},
    {'1': 'product_set', '3': 2, '4': 1, '5': 11, '6': '.google.cloud.vision.v1p4beta1.ProductSet', '8': {}, '10': 'productSet'},
...
final $typed_data.Uint8List createProductSetRequestDescriptor = $convert.base64Decode(
    ...
    'KAsyKS5nb29nbGUuY2xvdWQudmlzaW9uLnYxcDRiZXRhMS5Qcm9kdWN0U2V0QgPgQQJSCnByb2'
...
const ListProductSetsResponse$json = {
  ...
  '2': [
    {'1': 'product_sets', '3': 1, '4': 3, '5': 11, '6': '.google.cloud.vision.v1p4beta1.ProductSet', '10': 'productSets'},
    {'1': 'next_page_token', '3': 2, '4': 1, '5': 9, '10': 'nextPageToken'},
  ],
};
...
final $typed_data.Uint8List listProductSetsResponseDescriptor = $convert.base64Decode(
    ...
    'UuY2xvdWQudmlzaW9uLnYxcDRiZXRhMS5Qcm9kdWN0U2V0Ugtwcm9kdWN0U2V0cxImCg9uZXh0'
...
const UpdateProductSetRequest$json = {
  ...
  '2': [
    {'1': 'product_set', '3': 1, '4': 1, '5': 11, '6': '.google.cloud.vision.v1p4beta1.ProductSet', '8': {}, '10': 'productSet'},
    {'1': 'update_mask', '3': 2, '4': 1, '5': 11, '6': '.google.protobuf.FieldMask', '10': 'updateMask'},
  ],
};
...
final $typed_data.Uint8List updateProductSetRequestDescriptor = $convert.base64Decode(
    ...
    '5jbG91ZC52aXNpb24udjFwNGJldGExLlByb2R1Y3RTZXRCA+BBAlIKcHJvZHVjdFNldBI7Cgt1'
...
const CreateReferenceImageRequest$json = {
  ...
  '2': [
    {'1': 'parent', '3': 1, '4': 1, '5': 9, '8': {}, '10': 'parent'},
    {'1': 'reference_image', '3': 2, '4': 1, '5': 11, '6': '.google.cloud.vision.v1p4beta1.ReferenceImage', '8': {}, '10': 'referenceImage'},
...
final $typed_data.Uint8List createReferenceImageRequestDescriptor = $convert.base64Decode(
    ...
    'GAIgASgLMi0uZ29vZ2xlLmNsb3VkLnZpc2lvbi52MXA0YmV0YTEuUmVmZXJlbmNlSW1hZ2VCA+'
...
const ListReferenceImagesResponse$json = {
  ...
  '2': [
    {'1': 'reference_images', '3': 1, '4': 3, '5': 11, '6': '.google.cloud.vision.v1p4beta1.ReferenceImage', '10': 'referenceImages'},
    {'1': 'page_size', '3': 2, '4': 1, '5': 5, '10': 'pageSize'},
...
final $typed_data.Uint8List listReferenceImagesResponseDescriptor = $convert.base64Decode(
    ...
    'ItLmdvb2dsZS5jbG91ZC52aXNpb24udjFwNGJldGExLlJlZmVyZW5jZUltYWdlUg9yZWZlcmVu'
...
final $typed_data.Uint8List listProductsInProductSetResponseDescriptor = $convert.base64Decode(
    ...
    'dvb2dsZS5jbG91ZC52aXNpb24udjFwNGJldGExLlByb2R1Y3RSCHByb2R1Y3RzEiYKD25leHRf'
...
const ImportProductSetsInputConfig$json = {
  ...
  '2': [
    {'1': 'gcs_source', '3': 1, '4': 1, '5': 11, '6': '.google.cloud.vision.v1p4beta1.ImportProductSetsGcsSource', '9': 0, '10': 'gcsSource'},
  ],
  '8': [
    {'1': 'source'},
  ],
...
final $typed_data.Uint8List importProductSetsInputConfigDescriptor = $convert.base64Decode(
    ...
    '9nbGUuY2xvdWQudmlzaW9uLnYxcDRiZXRhMS5JbXBvcnRQcm9kdWN0U2V0c0djc1NvdXJjZUgA'
...
const ImportProductSetsRequest$json = {
  ...
  '2': [
    {'1': 'parent', '3': 1, '4': 1, '5': 9, '8': {}, '10': 'parent'},
    {'1': 'input_config', '3': 2, '4': 1, '5': 11, '6': '.google.cloud.vision.v1p4beta1.ImportProductSetsInputConfig', '8': {}, '10': 'inputConfig'},
  ],
};
...
final $typed_data.Uint8List importProductSetsRequestDescriptor = $convert.base64Decode(
    ...
    'IAEoCzI7Lmdvb2dsZS5jbG91ZC52aXNpb24udjFwNGJldGExLkltcG9ydFByb2R1Y3RTZXRzSW'
...
final $typed_data.Uint8List importProductSetsResponseDescriptor = $convert.base64Decode(
    ...
    '5nb29nbGUuY2xvdWQudmlzaW9uLnYxcDRiZXRhMS5SZWZlcmVuY2VJbWFnZVIPcmVmZXJlbmNl'
...
const BatchOperationMetadata$json = {
  ...
  '2': [
    {'1': 'state', '3': 1, '4': 1, '5': 14, '6': '.google.cloud.vision.v1p4beta1.BatchOperationMetadata.State', '10': 'state'},
...
final $typed_data.Uint8List batchOperationMetadataDescriptor = $convert.base64Decode(
    ...
    'Zpc2lvbi52MXA0YmV0YTEuQmF0Y2hPcGVyYXRpb25NZXRhZGF0YS5TdGF0ZVIFc3RhdGUSOwoL'
...
const PurgeProductsRequest$json = {
  ...
  '2': [
    {'1': 'product_set_purge_config', '3': 2, '4': 1, '5': 11, '6': '.google.cloud.vision.v1p4beta1.ProductSetPurgeConfig', '9': 0, '10': 'productSetPurgeConfig'},
...
final $typed_data.Uint8List purgeProductsRequestDescriptor = $convert.base64Decode(
    'ChRQdXJnZVByb2R1Y3RzUmVxdWVzdBJvChhwcm9kdWN0X3NldF9wdXJnZV9jb25maWcYAiABKA'
    'syNC5nb29nbGUuY2xvdWQudmlzaW9uLnYxcDRiZXRhMS5Qcm9kdWN0U2V0UHVyZ2VDb25maWdI'
    'AFIVcHJvZHVjdFNldFB1cmdlQ29uZmlnEjYKFmRlbGV0ZV9vcnBoYW5fcHJvZHVjdHMYAyABKA'
    'hIAFIUZGVsZXRlT3JwaGFuUHJvZHVjdHMSQQoGcGFyZW50GAEgASgJQingQQL6QSMKIWxvY2F0'
    'aW9ucy5nb29nbGVhcGlzLmNvbS9Mb2NhdGlvblIGcGFyZW50EhQKBWZvcmNlGAQgASgIUgVmb3'
    'JjZUIICgZ0YXJnZXQ=');
