...
class ReferenceImage extends $pb.GeneratedMessage {
  factory ReferenceImage({
    $core.String? name,
    $core.String? uri,
    $core.Iterable<$4714.BoundingPoly>? boundingPolys,
  }) {
    final $result = create();
    if (name != null) {
      $result.name = name;
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(_omitMessageNames ? '' : 'ReferenceImage', package: const $pb.PackageName(_omitMessageNames ? '' : 'google.cloud.vision.v1p3beta1'), createEmptyInstance: create)
    ...
    ..pc<$4714.BoundingPoly>(3, _omitFieldNames ? '' : 'boundingPolys', $pb.PbFieldType.PM, subBuilder: $4714.BoundingPoly.create)
    ..hasRequiredFields = false
  ;
  ...
  ///  is not).
  @$pb.TagNumber(3)
  $core.List<$4714.BoundingPoly> get boundingPolys => $_getList(2);
}
