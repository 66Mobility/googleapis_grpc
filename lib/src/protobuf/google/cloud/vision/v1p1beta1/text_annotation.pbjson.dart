...
const TextAnnotation$json = {
  '1': 'TextAnnotation',
  '2': [
    {'1': 'pages', '3': 1, '4': 3, '5': 11, '6': '.google.cloud.vision.v1p1beta1.Page', '10': 'pages'},
...
const TextAnnotation_DetectedBreak$json = {
  '1': 'DetectedBreak',
  '2': [
    {'1': 'type', '3': 1, '4': 1, '5': 14, '6': '.google.cloud.vision.v1p1beta1.TextAnnotation.DetectedBreak.BreakType', '10': 'type'},
...
const TextAnnotation_TextProperty$json = {
  '1': 'TextProperty',
  '2': [
    {'1': 'detected_languages', '3': 1, '4': 3, '5': 11, '6': '.google.cloud.vision.v1p1beta1.TextAnnotation.DetectedLanguage', '10': 'detectedLanguages'},
    {'1': 'detected_break', '3': 2, '4': 1, '5': 11, '6': '.google.cloud.vision.v1p1beta1.TextAnnotation.DetectedBreak', '10': 'detectedBreak'},
  ],
};
...
final $typed_data.Uint8List textAnnotationDescriptor = $convert.base64Decode(
    ...
    'FwMWJldGExLlBhZ2VSBXBhZ2VzEhIKBHRleHQYAiABKAlSBHRleHQaVwoQRGV0ZWN0ZWRMYW5n'
    ...
    'Z2xlLmNsb3VkLnZpc2lvbi52MXAxYmV0YTEuVGV4dEFubm90YXRpb24uRGV0ZWN0ZWRCcmVhay'
    ...
    'ZGV0ZWN0ZWRfbGFuZ3VhZ2VzGAEgAygLMj4uZ29vZ2xlLmNsb3VkLnZpc2lvbi52MXAxYmV0YT'
    'EuVGV4dEFubm90YXRpb24uRGV0ZWN0ZWRMYW5ndWFnZVIRZGV0ZWN0ZWRMYW5ndWFnZXMSYgoO'
    'ZGV0ZWN0ZWRfYnJlYWsYAiABKAsyOy5nb29nbGUuY2xvdWQudmlzaW9uLnYxcDFiZXRhMS5UZX'
...
const Page$json = {
  '1': 'Page',
  '2': [
    {'1': 'property', '3': 1, '4': 1, '5': 11, '6': '.google.cloud.vision.v1p1beta1.TextAnnotation.TextProperty', '10': 'property'},
    {'1': 'width', '3': 2, '4': 1, '5': 5, '10': 'width'},
    {'1': 'height', '3': 3, '4': 1, '5': 5, '10': 'height'},
    {'1': 'blocks', '3': 4, '4': 3, '5': 11, '6': '.google.cloud.vision.v1p1beta1.Block', '10': 'blocks'},
...
final $typed_data.Uint8List pageDescriptor = $convert.base64Decode(
    'CgRQYWdlElYKCHByb3BlcnR5GAEgASgLMjouZ29vZ2xlLmNsb3VkLnZpc2lvbi52MXAxYmV0YT'
    ...
    'Nsb3VkLnZpc2lvbi52MXAxYmV0YTEuQmxvY2tSBmJsb2NrcxIeCgpjb25maWRlbmNlGAUgASgC'
    'Ugpjb25maWRlbmNl');
...
const Block$json = {
  ...
  '2': [
    {'1': 'property', '3': 1, '4': 1, '5': 11, '6': '.google.cloud.vision.v1p1beta1.TextAnnotation.TextProperty', '10': 'property'},
    {'1': 'bounding_box', '3': 2, '4': 1, '5': 11, '6': '.google.cloud.vision.v1p1beta1.BoundingPoly', '10': 'boundingBox'},
    {'1': 'paragraphs', '3': 3, '4': 3, '5': 11, '6': '.google.cloud.vision.v1p1beta1.Paragraph', '10': 'paragraphs'},
    {'1': 'block_type', '3': 4, '4': 1, '5': 14, '6': '.google.cloud.vision.v1p1beta1.Block.BlockType', '10': 'blockType'},
    {'1': 'confidence', '3': 5, '4': 1, '5': 2, '10': 'confidence'},
  ],
...
final $typed_data.Uint8List blockDescriptor = $convert.base64Decode(
    'CgVCbG9jaxJWCghwcm9wZXJ0eRgBIAEoCzI6Lmdvb2dsZS5jbG91ZC52aXNpb24udjFwMWJldG'
    'ExLlRleHRBbm5vdGF0aW9uLlRleHRQcm9wZXJ0eVIIcHJvcGVydHkSTgoMYm91bmRpbmdfYm94'
    'GAIgASgLMisuZ29vZ2xlLmNsb3VkLnZpc2lvbi52MXAxYmV0YTEuQm91bmRpbmdQb2x5Ugtib3'
    'VuZGluZ0JveBJICgpwYXJhZ3JhcGhzGAMgAygLMiguZ29vZ2xlLmNsb3VkLnZpc2lvbi52MXAx'
    'YmV0YTEuUGFyYWdyYXBoUgpwYXJhZ3JhcGhzEk0KCmJsb2NrX3R5cGUYBCABKA4yLi5nb29nbG'
    'UuY2xvdWQudmlzaW9uLnYxcDFiZXRhMS5CbG9jay5CbG9ja1R5cGVSCWJsb2NrVHlwZRIeCgpj'
...
const Paragraph$json = {
  ...
  '2': [
    {'1': 'property', '3': 1, '4': 1, '5': 11, '6': '.google.cloud.vision.v1p1beta1.TextAnnotation.TextProperty', '10': 'property'},
    {'1': 'bounding_box', '3': 2, '4': 1, '5': 11, '6': '.google.cloud.vision.v1p1beta1.BoundingPoly', '10': 'boundingBox'},
    {'1': 'words', '3': 3, '4': 3, '5': 11, '6': '.google.cloud.vision.v1p1beta1.Word', '10': 'words'},
...
final $typed_data.Uint8List paragraphDescriptor = $convert.base64Decode(
    ...
    'FiZXRhMS5UZXh0QW5ub3RhdGlvbi5UZXh0UHJvcGVydHlSCHByb3BlcnR5Ek4KDGJvdW5kaW5n'
    'X2JveBgCIAEoCzIrLmdvb2dsZS5jbG91ZC52aXNpb24udjFwMWJldGExLkJvdW5kaW5nUG9seV'
    'ILYm91bmRpbmdCb3gSOQoFd29yZHMYAyADKAsyIy5nb29nbGUuY2xvdWQudmlzaW9uLnYxcDFi'
...
const Word$json = {
  ...
  '2': [
    {'1': 'property', '3': 1, '4': 1, '5': 11, '6': '.google.cloud.vision.v1p1beta1.TextAnnotation.TextProperty', '10': 'property'},
    {'1': 'bounding_box', '3': 2, '4': 1, '5': 11, '6': '.google.cloud.vision.v1p1beta1.BoundingPoly', '10': 'boundingBox'},
    {'1': 'symbols', '3': 3, '4': 3, '5': 11, '6': '.google.cloud.vision.v1p1beta1.Symbol', '10': 'symbols'},
    {'1': 'confidence', '3': 4, '4': 1, '5': 2, '10': 'confidence'},
  ],
};
...
final $typed_data.Uint8List wordDescriptor = $convert.base64Decode(
    'CgRXb3JkElYKCHByb3BlcnR5GAEgASgLMjouZ29vZ2xlLmNsb3VkLnZpc2lvbi52MXAxYmV0YT'
    'EuVGV4dEFubm90YXRpb24uVGV4dFByb3BlcnR5Ughwcm9wZXJ0eRJOCgxib3VuZGluZ19ib3gY'
    'AiABKAsyKy5nb29nbGUuY2xvdWQudmlzaW9uLnYxcDFiZXRhMS5Cb3VuZGluZ1BvbHlSC2JvdW'
    '5kaW5nQm94Ej8KB3N5bWJvbHMYAyADKAsyJS5nb29nbGUuY2xvdWQudmlzaW9uLnYxcDFiZXRh'
...
final $typed_data.Uint8List symbolDescriptor = $convert.base64Decode(
    'CgZTeW1ib2wSVgoIcHJvcGVydHkYASABKAsyOi5nb29nbGUuY2xvdWQudmlzaW9uLnYxcDFiZX'
    'RhMS5UZXh0QW5ub3RhdGlvbi5UZXh0UHJvcGVydHlSCHByb3BlcnR5Ek4KDGJvdW5kaW5nX2Jv'
    'eBgCIAEoCzIrLmdvb2dsZS5jbG91ZC52aXNpb24udjFwMWJldGExLkJvdW5kaW5nUG9seVILYm'
