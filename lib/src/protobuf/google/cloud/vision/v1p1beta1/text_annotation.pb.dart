...
class TextAnnotation_DetectedLanguage extends $pb.GeneratedMessage {
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(_omitMessageNames ? '' : 'TextAnnotation.DetectedLanguage', package: const $pb.PackageName(_omitMessageNames ? '' : 'google.cloud.vision.v1p1beta1'), createEmptyInstance: create)
...
class TextAnnotation_DetectedBreak extends $pb.GeneratedMessage {
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(_omitMessageNames ? '' : 'TextAnnotation.DetectedBreak', package: const $pb.PackageName(_omitMessageNames ? '' : 'google.cloud.vision.v1p1beta1'), createEmptyInstance: create)
...
class TextAnnotation_TextProperty extends $pb.GeneratedMessage {
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(_omitMessageNames ? '' : 'TextAnnotation.TextProperty', package: const $pb.PackageName(_omitMessageNames ? '' : 'google.cloud.vision.v1p1beta1'), createEmptyInstance: create)
...
class TextAnnotation extends $pb.GeneratedMessage {
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(_omitMessageNames ? '' : 'TextAnnotation', package: const $pb.PackageName(_omitMessageNames ? '' : 'google.cloud.vision.v1p1beta1'), createEmptyInstance: create)
...
class Page extends $pb.GeneratedMessage {
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(_omitMessageNames ? '' : 'Page', package: const $pb.PackageName(_omitMessageNames ? '' : 'google.cloud.vision.v1p1beta1'), createEmptyInstance: create)
