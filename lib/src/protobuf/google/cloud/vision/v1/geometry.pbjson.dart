...
const BoundingPoly$json = {
  '1': 'BoundingPoly',
  '2': [
    {'1': 'vertices', '3': 1, '4': 3, '5': 11, '6': '.google.cloud.vision.v1.Vertex', '10': 'vertices'},
    {'1': 'normalized_vertices', '3': 2, '4': 3, '5': 11, '6': '.google.cloud.vision.v1.NormalizedVertex', '10': 'normalizedVertices'},
  ],
};
...
final $typed_data.Uint8List boundingPolyDescriptor = $convert.base64Decode(
    'CgxCb3VuZGluZ1BvbHkSOgoIdmVydGljZXMYASADKAsyHi5nb29nbGUuY2xvdWQudmlzaW9uLn'
    'YxLlZlcnRleFIIdmVydGljZXMSWQoTbm9ybWFsaXplZF92ZXJ0aWNlcxgCIAMoCzIoLmdvb2ds'
    'ZS5jbG91ZC52aXNpb24udjEuTm9ybWFsaXplZFZlcnRleFISbm9ybWFsaXplZFZlcnRpY2Vz');
