...
class ProductSearchParams extends $pb.GeneratedMessage {
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(_omitMessageNames ? '' : 'ProductSearchParams', package: const $pb.PackageName(_omitMessageNames ? '' : 'google.cloud.vision.v1'), createEmptyInstance: create)
    ..aOS(6, _omitFieldNames ? '' : 'productSet')
    ..pPS(7, _omitFieldNames ? '' : 'productCategories')
    ..aOS(8, _omitFieldNames ? '' : 'filter')
    ..aOM<$4704.BoundingPoly>(9, _omitFieldNames ? '' : 'boundingPoly', subBuilder: $4704.BoundingPoly.create)
...
class ProductSearchResults_Result extends $pb.GeneratedMessage {
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(_omitMessageNames ? '' : 'ProductSearchResults.Result', package: const $pb.PackageName(_omitMessageNames ? '' : 'google.cloud.vision.v1'), createEmptyInstance: create)
    ..aOM<$1480.Product>(1, _omitFieldNames ? '' : 'product', subBuilder: $1480.Product.create)
  ...
  /// The Product.
  @$pb.TagNumber(1)
  $1480.Product get product => $_getN(0);
  @$pb.TagNumber(1)
  set product($1480.Product v) { setField(1, v); }
  @$pb.TagNumber(1)
  $core.bool hasProduct() => $_has(0);
  @$pb.TagNumber(1)
  void clearProduct() => clearField(1);
  @$pb.TagNumber(1)
  $1480.Product ensureProduct() => $_ensure(0);
...
class ProductSearchResults_ObjectAnnotation extends $pb.GeneratedMessage {
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(_omitMessageNames ? '' : 'ProductSearchResults.ObjectAnnotation', package: const $pb.PackageName(_omitMessageNames ? '' : 'google.cloud.vision.v1'), createEmptyInstance: create)
...
class ProductSearchResults_GroupedResult extends $pb.GeneratedMessage {
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(_omitMessageNames ? '' : 'ProductSearchResults.GroupedResult', package: const $pb.PackageName(_omitMessageNames ? '' : 'google.cloud.vision.v1'), createEmptyInstance: create)
...
class ProductSearchResults extends $pb.GeneratedMessage {
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(_omitMessageNames ? '' : 'ProductSearchResults', package: const $pb.PackageName(_omitMessageNames ? '' : 'google.cloud.vision.v1'), createEmptyInstance: create)
