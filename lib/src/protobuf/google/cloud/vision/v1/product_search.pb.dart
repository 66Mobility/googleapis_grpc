...
class ProductSearchParams extends $pb.GeneratedMessage {
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(_omitMessageNames ? '' : 'ProductSearchParams', package: const $pb.PackageName(_omitMessageNames ? '' : 'google.cloud.vision.v1'), createEmptyInstance: create)
    ...
    ..aOM<$4706.BoundingPoly>(9, _omitFieldNames ? '' : 'boundingPoly', subBuilder: $4706.BoundingPoly.create)
  ...
  @$pb.TagNumber(9)
  $4706.BoundingPoly get boundingPoly => $_getN(3);
  @$pb.TagNumber(9)
  set boundingPoly($4706.BoundingPoly v) { setField(9, v); }
  @$pb.TagNumber(9)
  $core.bool hasBoundingPoly() => $_has(3);
  @$pb.TagNumber(9)
  void clearBoundingPoly() => clearField(9);
  @$pb.TagNumber(9)
  $4706.BoundingPoly ensureBoundingPoly() => $_ensure(3);
}
