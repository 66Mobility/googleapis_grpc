...
const BoundingPoly$json = {
  '1': 'BoundingPoly',
  '2': [
    {'1': 'vertices', '3': 1, '4': 3, '5': 11, '6': '.google.cloud.vision.v1p2beta1.Vertex', '10': 'vertices'},
    {'1': 'normalized_vertices', '3': 2, '4': 3, '5': 11, '6': '.google.cloud.vision.v1p2beta1.NormalizedVertex', '10': 'normalizedVertices'},
  ],
};
...
final $typed_data.Uint8List boundingPolyDescriptor = $convert.base64Decode(
    ...
    'YxcDJiZXRhMS5WZXJ0ZXhSCHZlcnRpY2VzEmAKE25vcm1hbGl6ZWRfdmVydGljZXMYAiADKAsy'
    'Ly5nb29nbGUuY2xvdWQudmlzaW9uLnYxcDJiZXRhMS5Ob3JtYWxpemVkVmVydGV4UhJub3JtYW'
    'xpemVkVmVydGljZXM=');
