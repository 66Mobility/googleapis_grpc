...
const CreateMicrosoftAdDomainRequest$json = {
  ...
  '2': [
    ...
    {'1': 'domain', '3': 3, '4': 1, '5': 11, '6': '.google.cloud.managedidentities.v1beta1.Domain', '8': {}, '10': 'domain'},
  ],
};
...
final $typed_data.Uint8List createMicrosoftAdDomainRequestDescriptor = $convert.base64Decode(
    ...
    'bWFpbl9uYW1lGAIgASgJQgPgQQJSCmRvbWFpbk5hbWUSSwoGZG9tYWluGAMgASgLMi4uZ29vZ2'
    'xlLmNsb3VkLm1hbmFnZWRpZGVudGl0aWVzLnYxYmV0YTEuRG9tYWluQgPgQQJSBmRvbWFpbg==');
...
final $typed_data.Uint8List listDomainsRequestDescriptor = $convert.base64Decode(
    ...
    'VudGl0aWVzLmdvb2dsZWFwaXMuY29tL0RvbWFpblIGcGFyZW50EhsKCXBhZ2Vfc2l6ZRgCIAEo'
...
const ListDomainsResponse$json = {
  ...
  '2': [
    {'1': 'domains', '3': 1, '4': 3, '5': 11, '6': '.google.cloud.managedidentities.v1beta1.Domain', '10': 'domains'},
...
final $typed_data.Uint8List listDomainsResponseDescriptor = $convert.base64Decode(
    'ChNMaXN0RG9tYWluc1Jlc3BvbnNlEkgKB2RvbWFpbnMYASADKAsyLi5nb29nbGUuY2xvdWQubW'
    'FuYWdlZGlkZW50aXRpZXMudjFiZXRhMS5Eb21haW5SB2RvbWFpbnMSJgoPbmV4dF9wYWdlX3Rv'
...
const UpdateDomainRequest$json = {
  ...
  '2': [
    ...
    {'1': 'domain', '3': 2, '4': 1, '5': 11, '6': '.google.cloud.managedidentities.v1beta1.Domain', '8': {}, '10': 'domain'},
  ],
};
...
final $typed_data.Uint8List updateDomainRequestDescriptor = $convert.base64Decode(
    ...
    'RvYnVmLkZpZWxkTWFza0ID4EECUgp1cGRhdGVNYXNrEksKBmRvbWFpbhgCIAEoCzIuLmdvb2ds'
    'ZS5jbG91ZC5tYW5hZ2VkaWRlbnRpdGllcy52MWJldGExLkRvbWFpbkID4EECUgZkb21haW4=');
...
const AttachTrustRequest$json = {
  ...
  '2': [
    {'1': 'name', '3': 1, '4': 1, '5': 9, '8': {}, '10': 'name'},
    {'1': 'trust', '3': 2, '4': 1, '5': 11, '6': '.google.cloud.managedidentities.v1beta1.Trust', '8': {}, '10': 'trust'},
  ],
};
...
final $typed_data.Uint8List attachTrustRequestDescriptor = $convert.base64Decode(
    ...
    'RpdGllcy5nb29nbGVhcGlzLmNvbS9Eb21haW5SBG5hbWUSSAoFdHJ1c3QYAiABKAsyLS5nb29n'
    'bGUuY2xvdWQubWFuYWdlZGlkZW50aXRpZXMudjFiZXRhMS5UcnVzdEID4EECUgV0cnVzdA==');
...
final $typed_data.Uint8List validateTrustRequestDescriptor = $convert.base64Decode(
    ...
    'VudGl0aWVzLmdvb2dsZWFwaXMuY29tL0RvbWFpblIEbmFtZRJICgV0cnVzdBgCIAEoCzItLmdv'
    'b2dsZS5jbG91ZC5tYW5hZ2VkaWRlbnRpdGllcy52MWJldGExLlRydXN0QgPgQQJSBXRydXN0');
