...
const DiscoverConnectionProfileRequest$json = {
  ...
  '2': [
    ...
    {'1': 'connection_profile', '3': 200, '4': 1, '5': 11, '6': '.google.cloud.datastream.v1alpha1.ConnectionProfile', '9': 0, '10': 'connectionProfile'},
    {'1': 'connection_profile_name', '3': 201, '4': 1, '5': 9, '9': 0, '10': 'connectionProfileName'},
    {'1': 'recursive', '3': 3, '4': 1, '5': 8, '9': 1, '10': 'recursive'},
    {'1': 'recursion_depth', '3': 4, '4': 1, '5': 5, '9': 1, '10': 'recursionDepth'},
    {'1': 'oracle_rdbms', '3': 100, '4': 1, '5': 11, '6': '.google.cloud.datastream.v1alpha1.OracleRdbms', '9': 2, '10': 'oracleRdbms'},
    {'1': 'mysql_rdbms', '3': 101, '4': 1, '5': 11, '6': '.google.cloud.datastream.v1alpha1.MysqlRdbms', '9': 2, '10': 'mysqlRdbms'},
  ],
  '8': [
    {'1': 'target'},
    {'1': 'depth'},
...
final $typed_data.Uint8List discoverConnectionProfileRequestDescriptor = $convert.base64Decode(
    ...
    'EmUKEmNvbm5lY3Rpb25fcHJvZmlsZRjIASABKAsyMy5nb29nbGUuY2xvdWQuZGF0YXN0cmVhbS'
    '52MWFscGhhMS5Db25uZWN0aW9uUHJvZmlsZUgAUhFjb25uZWN0aW9uUHJvZmlsZRI5Chdjb25u'
    'ZWN0aW9uX3Byb2ZpbGVfbmFtZRjJASABKAlIAFIVY29ubmVjdGlvblByb2ZpbGVOYW1lEh4KCX'
    'JlY3Vyc2l2ZRgDIAEoCEgBUglyZWN1cnNpdmUSKQoPcmVjdXJzaW9uX2RlcHRoGAQgASgFSAFS'
    'DnJlY3Vyc2lvbkRlcHRoElIKDG9yYWNsZV9yZGJtcxhkIAEoCzItLmdvb2dsZS5jbG91ZC5kYX'
    'Rhc3RyZWFtLnYxYWxwaGExLk9yYWNsZVJkYm1zSAJSC29yYWNsZVJkYm1zEk8KC215c3FsX3Jk'
    'Ym1zGGUgASgLMiwuZ29vZ2xlLmNsb3VkLmRhdGFzdHJlYW0udjFhbHBoYTEuTXlzcWxSZGJtc0'
    'gCUgpteXNxbFJkYm1zQggKBnRhcmdldEIHCgVkZXB0aEINCgtkYXRhX29iamVjdA==');
...
const DiscoverConnectionProfileResponse$json = {
  ...
  '2': [
    {'1': 'oracle_rdbms', '3': 100, '4': 1, '5': 11, '6': '.google.cloud.datastream.v1alpha1.OracleRdbms', '9': 0, '10': 'oracleRdbms'},
    {'1': 'mysql_rdbms', '3': 101, '4': 1, '5': 11, '6': '.google.cloud.datastream.v1alpha1.MysqlRdbms', '9': 0, '10': 'mysqlRdbms'},
  ],
  '8': [
    {'1': 'data_object'},
  ],
...
final $typed_data.Uint8List discoverConnectionProfileResponseDescriptor = $convert.base64Decode(
    'CiFEaXNjb3ZlckNvbm5lY3Rpb25Qcm9maWxlUmVzcG9uc2USUgoMb3JhY2xlX3JkYm1zGGQgAS'
    'gLMi0uZ29vZ2xlLmNsb3VkLmRhdGFzdHJlYW0udjFhbHBoYTEuT3JhY2xlUmRibXNIAFILb3Jh'
    'Y2xlUmRibXMSTwoLbXlzcWxfcmRibXMYZSABKAsyLC5nb29nbGUuY2xvdWQuZGF0YXN0cmVhbS'
    '52MWFscGhhMS5NeXNxbFJkYm1zSABSCm15c3FsUmRibXNCDQoLZGF0YV9vYmplY3Q=');
...
final $typed_data.Uint8List fetchErrorsRequestDescriptor = $convert.base64Decode(
    'ChJGZXRjaEVycm9yc1JlcXVlc3QSPQoGc3RyZWFtGAEgASgJQiX6QSIKIGRhdGFzdHJlYW0uZ2'
    '9vZ2xlYXBpcy5jb20vU3RyZWFtUgZzdHJlYW0=');

@$core.Deprecated('Use fetchErrorsResponseDescriptor instead')
const FetchErrorsResponse$json = {
  '1': 'FetchErrorsResponse',
  '2': [
    {'1': 'errors', '3': 1, '4': 3, '5': 11, '6': '.google.cloud.datastream.v1alpha1.Error', '10': 'errors'},
  ],
};
...
final $typed_data.Uint8List fetchErrorsResponseDescriptor = $convert.base64Decode(
    'ChNGZXRjaEVycm9yc1Jlc3BvbnNlEj8KBmVycm9ycxgBIAMoCzInLmdvb2dsZS5jbG91ZC5kYX'
    'Rhc3RyZWFtLnYxYWxwaGExLkVycm9yUgZlcnJvcnM=');
...
const ListConnectionProfilesResponse$json = {
  ...
  '2': [
    {'1': 'connection_profiles', '3': 1, '4': 3, '5': 11, '6': '.google.cloud.datastream.v1alpha1.ConnectionProfile', '10': 'connectionProfiles'},
    {'1': 'next_page_token', '3': 2, '4': 1, '5': 9, '10': 'nextPageToken'},
...
final $typed_data.Uint8List listConnectionProfilesResponseDescriptor = $convert.base64Decode(
    'Ch5MaXN0Q29ubmVjdGlvblByb2ZpbGVzUmVzcG9uc2USZAoTY29ubmVjdGlvbl9wcm9maWxlcx'
    'gBIAMoCzIzLmdvb2dsZS5jbG91ZC5kYXRhc3RyZWFtLnYxYWxwaGExLkNvbm5lY3Rpb25Qcm9m'
    'aWxlUhJjb25uZWN0aW9uUHJvZmlsZXMSJgoPbmV4dF9wYWdlX3Rva2VuGAIgASgJUg1uZXh0UG'
...
const CreateConnectionProfileRequest$json = {
  ...
  '2': [
    ...
    {'1': 'connection_profile', '3': 3, '4': 1, '5': 11, '6': '.google.cloud.datastream.v1alpha1.ConnectionProfile', '8': {}, '10': 'connectionProfile'},
...
final $typed_data.Uint8List createConnectionProfileRequestDescriptor = $convert.base64Decode(
    ...
    'JnChJjb25uZWN0aW9uX3Byb2ZpbGUYAyABKAsyMy5nb29nbGUuY2xvdWQuZGF0YXN0cmVhbS52'
    'MWFscGhhMS5Db25uZWN0aW9uUHJvZmlsZUID4EECUhFjb25uZWN0aW9uUHJvZmlsZRIiCgpyZX'
    'F1ZXN0X2lkGAQgASgJQgPgQQFSCXJlcXVlc3RJZA==');
...
const UpdateConnectionProfileRequest$json = {
  ...
  '2': [
    ...
    {'1': 'connection_profile', '3': 2, '4': 1, '5': 11, '6': '.google.cloud.datastream.v1alpha1.ConnectionProfile', '8': {}, '10': 'connectionProfile'},
...
final $typed_data.Uint8List updateConnectionProfileRequestDescriptor = $convert.base64Decode(
    ...
    '5nb29nbGUucHJvdG9idWYuRmllbGRNYXNrQgPgQQFSCnVwZGF0ZU1hc2sSZwoSY29ubmVjdGlv'
    'bl9wcm9maWxlGAIgASgLMjMuZ29vZ2xlLmNsb3VkLmRhdGFzdHJlYW0udjFhbHBoYTEuQ29ubm'
    'VjdGlvblByb2ZpbGVCA+BBAlIRY29ubmVjdGlvblByb2ZpbGUSIgoKcmVxdWVzdF9pZBgDIAEo'
...
const ListStreamsResponse$json = {
  ...
  '2': [
    {'1': 'streams', '3': 1, '4': 3, '5': 11, '6': '.google.cloud.datastream.v1alpha1.Stream', '10': 'streams'},
    {'1': 'next_page_token', '3': 2, '4': 1, '5': 9, '10': 'nextPageToken'},
    {'1': 'unreachable', '3': 3, '4': 3, '5': 9, '10': 'unreachable'},
  ],
};
...
final $typed_data.Uint8List listStreamsResponseDescriptor = $convert.base64Decode(
    'ChNMaXN0U3RyZWFtc1Jlc3BvbnNlEkIKB3N0cmVhbXMYASADKAsyKC5nb29nbGUuY2xvdWQuZG'
    'F0YXN0cmVhbS52MWFscGhhMS5TdHJlYW1SB3N0cmVhbXMSJgoPbmV4dF9wYWdlX3Rva2VuGAIg'
...
const CreateStreamRequest$json = {
  ...
  '2': [
    ...
    {'1': 'stream', '3': 3, '4': 1, '5': 11, '6': '.google.cloud.datastream.v1alpha1.Stream', '8': {}, '10': 'stream'},
    {'1': 'request_id', '3': 4, '4': 1, '5': 9, '8': {}, '10': 'requestId'},
...
final $typed_data.Uint8List createStreamRequestDescriptor = $convert.base64Decode(
    ...
    'UghzdHJlYW1JZBJFCgZzdHJlYW0YAyABKAsyKC5nb29nbGUuY2xvdWQuZGF0YXN0cmVhbS52MW'
    'FscGhhMS5TdHJlYW1CA+BBAlIGc3RyZWFtEiIKCnJlcXVlc3RfaWQYBCABKAlCA+BBAVIJcmVx'
    'dWVzdElkEigKDXZhbGlkYXRlX29ubHkYBSABKAhCA+BBAVIMdmFsaWRhdGVPbmx5EhkKBWZvcm'
    'NlGAYgASgIQgPgQQFSBWZvcmNl');
...
const UpdateStreamRequest$json = {
  ...
  '2': [
    {'1': 'update_mask', '3': 1, '4': 1, '5': 11, '6': '.google.protobuf.FieldMask', '8': {}, '10': 'updateMask'},
    {'1': 'stream', '3': 2, '4': 1, '5': 11, '6': '.google.cloud.datastream.v1alpha1.Stream', '8': {}, '10': 'stream'},
    {'1': 'request_id', '3': 3, '4': 1, '5': 9, '8': {}, '10': 'requestId'},
...
final $typed_data.Uint8List updateStreamRequestDescriptor = $convert.base64Decode(
    ...
    'RvYnVmLkZpZWxkTWFza0ID4EEBUgp1cGRhdGVNYXNrEkUKBnN0cmVhbRgCIAEoCzIoLmdvb2ds'
    'ZS5jbG91ZC5kYXRhc3RyZWFtLnYxYWxwaGExLlN0cmVhbUID4EECUgZzdHJlYW0SIgoKcmVxdW'
    'VzdF9pZBgDIAEoCUID4EEBUglyZXF1ZXN0SWQSKAoNdmFsaWRhdGVfb25seRgEIAEoCEID4EEB'
    'Ugx2YWxpZGF0ZU9ubHkSGQoFZm9yY2UYBSABKAhCA+BBAVIFZm9yY2U=');
...
const OperationMetadata$json = {
  ...
  '2': [
    ...
    {'1': 'validation_result', '3': 8, '4': 1, '5': 11, '6': '.google.cloud.datastream.v1alpha1.ValidationResult', '8': {}, '10': 'validationResult'},
  ],
};
...
final $typed_data.Uint8List operationMetadataDescriptor = $convert.base64Decode(
    ...
    'aVZlcnNpb24SZAoRdmFsaWRhdGlvbl9yZXN1bHQYCCABKAsyMi5nb29nbGUuY2xvdWQuZGF0YX'
    'N0cmVhbS52MWFscGhhMS5WYWxpZGF0aW9uUmVzdWx0QgPgQQNSEHZhbGlkYXRpb25SZXN1bHQ=');
...
const CreatePrivateConnectionRequest$json = {
  ...
  '2': [
    ...
    {'1': 'private_connection', '3': 3, '4': 1, '5': 11, '6': '.google.cloud.datastream.v1alpha1.PrivateConnection', '8': {}, '10': 'privateConnection'},
    {'1': 'request_id', '3': 4, '4': 1, '5': 9, '8': {}, '10': 'requestId'},
  ],
};
...
final $typed_data.Uint8List createPrivateConnectionRequestDescriptor = $convert.base64Decode(
    ...
    'JnChJwcml2YXRlX2Nvbm5lY3Rpb24YAyABKAsyMy5nb29nbGUuY2xvdWQuZGF0YXN0cmVhbS52'
    'MWFscGhhMS5Qcml2YXRlQ29ubmVjdGlvbkID4EECUhFwcml2YXRlQ29ubmVjdGlvbhIiCgpyZX'
    'F1ZXN0X2lkGAQgASgJQgPgQQFSCXJlcXVlc3RJZA==');
...
const ListPrivateConnectionsResponse$json = {
  ...
  '2': [
    {'1': 'private_connections', '3': 1, '4': 3, '5': 11, '6': '.google.cloud.datastream.v1alpha1.PrivateConnection', '10': 'privateConnections'},
    {'1': 'next_page_token', '3': 2, '4': 1, '5': 9, '10': 'nextPageToken'},
    {'1': 'unreachable', '3': 3, '4': 3, '5': 9, '10': 'unreachable'},
  ],
};
...
final $typed_data.Uint8List listPrivateConnectionsResponseDescriptor = $convert.base64Decode(
    'Ch5MaXN0UHJpdmF0ZUNvbm5lY3Rpb25zUmVzcG9uc2USZAoTcHJpdmF0ZV9jb25uZWN0aW9ucx'
    'gBIAMoCzIzLmdvb2dsZS5jbG91ZC5kYXRhc3RyZWFtLnYxYWxwaGExLlByaXZhdGVDb25uZWN0'
    'aW9uUhJwcml2YXRlQ29ubmVjdGlvbnMSJgoPbmV4dF9wYWdlX3Rva2VuGAIgASgJUg1uZXh0UG'
    'FnZVRva2VuEiAKC3VucmVhY2hhYmxlGAMgAygJUgt1bnJlYWNoYWJsZQ==');
...
const CreateRouteRequest$json = {
  ...
  '2': [
    ...
    {'1': 'route', '3': 3, '4': 1, '5': 11, '6': '.google.cloud.datastream.v1alpha1.Route', '8': {}, '10': 'route'},
    {'1': 'request_id', '3': 4, '4': 1, '5': 9, '8': {}, '10': 'requestId'},
  ],
};
...
final $typed_data.Uint8List createRouteRequestDescriptor = $convert.base64Decode(
    ...
    'b3V0ZUlkEkIKBXJvdXRlGAMgASgLMicuZ29vZ2xlLmNsb3VkLmRhdGFzdHJlYW0udjFhbHBoYT'
    'EuUm91dGVCA+BBAlIFcm91dGUSIgoKcmVxdWVzdF9pZBgEIAEoCUID4EEBUglyZXF1ZXN0SWQ=');
...
const ListRoutesResponse$json = {
  ...
  '2': [
    {'1': 'routes', '3': 1, '4': 3, '5': 11, '6': '.google.cloud.datastream.v1alpha1.Route', '10': 'routes'},
    {'1': 'next_page_token', '3': 2, '4': 1, '5': 9, '10': 'nextPageToken'},
    {'1': 'unreachable', '3': 3, '4': 3, '5': 9, '10': 'unreachable'},
  ],
};
...
final $typed_data.Uint8List listRoutesResponseDescriptor = $convert.base64Decode(
    'ChJMaXN0Um91dGVzUmVzcG9uc2USPwoGcm91dGVzGAEgAygLMicuZ29vZ2xlLmNsb3VkLmRhdG'
    'FzdHJlYW0udjFhbHBoYTEuUm91dGVSBnJvdXRlcxImCg9uZXh0X3BhZ2VfdG9rZW4YAiABKAlS'
