...
import 'streaming_resources.pb.dart' as $4725;
...
class SendPacketsRequest extends $pb.GeneratedMessage {
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(_omitMessageNames ? '' : 'SendPacketsRequest', package: const $pb.PackageName(_omitMessageNames ? '' : 'google.cloud.visionai.v1'), createEmptyInstance: create)
    ..oo(0, [1, 2])
    ..aOM<$4725.Packet>(1, _omitFieldNames ? '' : 'packet', subBuilder: $4725.Packet.create)
  ...
  @$pb.TagNumber(1)
  $4725.Packet get packet => $_getN(0);
  @$pb.TagNumber(1)
  set packet($4725.Packet v) { setField(1, v); }
  @$pb.TagNumber(1)
  $core.bool hasPacket() => $_has(0);
  @$pb.TagNumber(1)
  void clearPacket() => clearField(1);
  @$pb.TagNumber(1)
  $4725.Packet ensurePacket() => $_ensure(0);
