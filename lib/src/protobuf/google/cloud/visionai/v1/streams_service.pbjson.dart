...
const ListClustersResponse$json = {
  ...
  '2': [
    {'1': 'clusters', '3': 1, '4': 3, '5': 11, '6': '.google.cloud.visionai.v1.Cluster', '10': 'clusters'},
...
final $typed_data.Uint8List listClustersResponseDescriptor = $convert.base64Decode(
    'ChRMaXN0Q2x1c3RlcnNSZXNwb25zZRI9CghjbHVzdGVycxgBIAMoCzIhLmdvb2dsZS5jbG91ZC'
    '52aXNpb25haS52MS5DbHVzdGVyUghjbHVzdGVycxImCg9uZXh0X3BhZ2VfdG9rZW4YAiABKAlS'
...
const CreateClusterRequest$json = {
  ...
  '2': [
    ...
    {'1': 'cluster', '3': 3, '4': 1, '5': 11, '6': '.google.cloud.visionai.v1.Cluster', '8': {}, '10': 'cluster'},
...
final $typed_data.Uint8List createClusterRequestDescriptor = $convert.base64Decode(
    ...
    'AlIJY2x1c3RlcklkEkAKB2NsdXN0ZXIYAyABKAsyIS5nb29nbGUuY2xvdWQudmlzaW9uYWkudj'
    'EuQ2x1c3RlckID4EECUgdjbHVzdGVyEiIKCnJlcXVlc3RfaWQYBCABKAlCA+BBAVIJcmVxdWVz'
    'dElk');
...
const UpdateClusterRequest$json = {
  ...
  '2': [
    ...
    {'1': 'cluster', '3': 2, '4': 1, '5': 11, '6': '.google.cloud.visionai.v1.Cluster', '8': {}, '10': 'cluster'},
...
final $typed_data.Uint8List updateClusterRequestDescriptor = $convert.base64Decode(
    ...
    '90b2J1Zi5GaWVsZE1hc2tCA+BBAlIKdXBkYXRlTWFzaxJACgdjbHVzdGVyGAIgASgLMiEuZ29v'
    'Z2xlLmNsb3VkLnZpc2lvbmFpLnYxLkNsdXN0ZXJCA+BBAlIHY2x1c3RlchIiCgpyZXF1ZXN0X2'
...
const ListStreamsResponse$json = {
  ...
  '2': [
    {'1': 'streams', '3': 1, '4': 3, '5': 11, '6': '.google.cloud.visionai.v1.Stream', '10': 'streams'},
    {'1': 'next_page_token', '3': 2, '4': 1, '5': 9, '10': 'nextPageToken'},
    {'1': 'unreachable', '3': 3, '4': 3, '5': 9, '10': 'unreachable'},
  ],
};
...
final $typed_data.Uint8List listStreamsResponseDescriptor = $convert.base64Decode(
    'ChNMaXN0U3RyZWFtc1Jlc3BvbnNlEjoKB3N0cmVhbXMYASADKAsyIC5nb29nbGUuY2xvdWQudm'
    'lzaW9uYWkudjEuU3RyZWFtUgdzdHJlYW1zEiYKD25leHRfcGFnZV90b2tlbhgCIAEoCVINbmV4'
...
const CreateStreamRequest$json = {
  ...
  '2': [
    ...
    {'1': 'stream', '3': 3, '4': 1, '5': 11, '6': '.google.cloud.visionai.v1.Stream', '8': {}, '10': 'stream'},
    {'1': 'request_id', '3': 4, '4': 1, '5': 9, '8': {}, '10': 'requestId'},
  ],
};
...
final $typed_data.Uint8List createStreamRequestDescriptor = $convert.base64Decode(
    ...
    'CHN0cmVhbUlkEj0KBnN0cmVhbRgDIAEoCzIgLmdvb2dsZS5jbG91ZC52aXNpb25haS52MS5TdH'
    'JlYW1CA+BBAlIGc3RyZWFtEiIKCnJlcXVlc3RfaWQYBCABKAlCA+BBAVIJcmVxdWVzdElk');
...
const UpdateStreamRequest$json = {
  ...
  '2': [
    {'1': 'update_mask', '3': 1, '4': 1, '5': 11, '6': '.google.protobuf.FieldMask', '8': {}, '10': 'updateMask'},
    {'1': 'stream', '3': 2, '4': 1, '5': 11, '6': '.google.cloud.visionai.v1.Stream', '8': {}, '10': 'stream'},
    {'1': 'request_id', '3': 3, '4': 1, '5': 9, '8': {}, '10': 'requestId'},
  ],
};
...
final $typed_data.Uint8List updateStreamRequestDescriptor = $convert.base64Decode(
    ...
    'RvYnVmLkZpZWxkTWFza0ID4EECUgp1cGRhdGVNYXNrEj0KBnN0cmVhbRgCIAEoCzIgLmdvb2ds'
    'ZS5jbG91ZC52aXNpb25haS52MS5TdHJlYW1CA+BBAlIGc3RyZWFtEiIKCnJlcXVlc3RfaWQYAy'
...
@$core.Deprecated('Use getStreamThumbnailRequestDescriptor instead')
const GetStreamThumbnailRequest$json = {
  '1': 'GetStreamThumbnailRequest',
  '2': [
    {'1': 'stream', '3': 1, '4': 1, '5': 9, '8': {}, '10': 'stream'},
    {'1': 'gcs_object_name', '3': 2, '4': 1, '5': 9, '8': {}, '10': 'gcsObjectName'},
    {'1': 'event', '3': 3, '4': 1, '5': 9, '8': {}, '10': 'event'},
    {'1': 'request_id', '3': 4, '4': 1, '5': 9, '8': {}, '10': 'requestId'},
  ],
};

/// Descriptor for `GetStreamThumbnailRequest`. Decode as a `google.protobuf.DescriptorProto`.
final $typed_data.Uint8List getStreamThumbnailRequestDescriptor = $convert.base64Decode(
    'ChlHZXRTdHJlYW1UaHVtYm5haWxSZXF1ZXN0EhsKBnN0cmVhbRgBIAEoCUID4EECUgZzdHJlYW'
    '0SKwoPZ2NzX29iamVjdF9uYW1lGAIgASgJQgPgQQJSDWdjc09iamVjdE5hbWUSGQoFZXZlbnQY'
    'AyABKAlCA+BBAVIFZXZlbnQSIgoKcmVxdWVzdF9pZBgEIAEoCUID4EEBUglyZXF1ZXN0SWQ=');
...
const ListEventsResponse$json = {
  ...
  '2': [
    {'1': 'events', '3': 1, '4': 3, '5': 11, '6': '.google.cloud.visionai.v1.Event', '10': 'events'},
    {'1': 'next_page_token', '3': 2, '4': 1, '5': 9, '10': 'nextPageToken'},
    {'1': 'unreachable', '3': 3, '4': 3, '5': 9, '10': 'unreachable'},
  ],
};
...
final $typed_data.Uint8List listEventsResponseDescriptor = $convert.base64Decode(
    'ChJMaXN0RXZlbnRzUmVzcG9uc2USNwoGZXZlbnRzGAEgAygLMh8uZ29vZ2xlLmNsb3VkLnZpc2'
    'lvbmFpLnYxLkV2ZW50UgZldmVudHMSJgoPbmV4dF9wYWdlX3Rva2VuGAIgASgJUg1uZXh0UGFn'
...
const CreateEventRequest$json = {
  ...
  '2': [
    ...
    {'1': 'event', '3': 3, '4': 1, '5': 11, '6': '.google.cloud.visionai.v1.Event', '8': {}, '10': 'event'},
    {'1': 'request_id', '3': 4, '4': 1, '5': 9, '8': {}, '10': 'requestId'},
  ],
};
...
final $typed_data.Uint8List createEventRequestDescriptor = $convert.base64Decode(
    ...
    'dmVudElkEjoKBWV2ZW50GAMgASgLMh8uZ29vZ2xlLmNsb3VkLnZpc2lvbmFpLnYxLkV2ZW50Qg'
    'PgQQJSBWV2ZW50EiIKCnJlcXVlc3RfaWQYBCABKAlCA+BBAVIJcmVxdWVzdElk');
...
const UpdateEventRequest$json = {
  ...
  '2': [
    {'1': 'update_mask', '3': 1, '4': 1, '5': 11, '6': '.google.protobuf.FieldMask', '8': {}, '10': 'updateMask'},
    {'1': 'event', '3': 2, '4': 1, '5': 11, '6': '.google.cloud.visionai.v1.Event', '8': {}, '10': 'event'},
    {'1': 'request_id', '3': 3, '4': 1, '5': 9, '8': {}, '10': 'requestId'},
  ],
};
...
final $typed_data.Uint8List updateEventRequestDescriptor = $convert.base64Decode(
    ...
    '9idWYuRmllbGRNYXNrQgPgQQJSCnVwZGF0ZU1hc2sSOgoFZXZlbnQYAiABKAsyHy5nb29nbGUu'
    'Y2xvdWQudmlzaW9uYWkudjEuRXZlbnRCA+BBAlIFZXZlbnQSIgoKcmVxdWVzdF9pZBgDIAEoCU'
    'ID4EEBUglyZXF1ZXN0SWQ=');
...
const ListSeriesResponse$json = {
  ...
  '2': [
    {'1': 'series', '3': 1, '4': 3, '5': 11, '6': '.google.cloud.visionai.v1.Series', '10': 'series'},
    {'1': 'next_page_token', '3': 2, '4': 1, '5': 9, '10': 'nextPageToken'},
    {'1': 'unreachable', '3': 3, '4': 3, '5': 9, '10': 'unreachable'},
  ],
};
...
final $typed_data.Uint8List listSeriesResponseDescriptor = $convert.base64Decode(
    'ChJMaXN0U2VyaWVzUmVzcG9uc2USOAoGc2VyaWVzGAEgAygLMiAuZ29vZ2xlLmNsb3VkLnZpc2'
    'lvbmFpLnYxLlNlcmllc1IGc2VyaWVzEiYKD25leHRfcGFnZV90b2tlbhgCIAEoCVINbmV4dFBh'
...
const CreateSeriesRequest$json = {
  ...
  '2': [
    ...
    {'1': 'series', '3': 3, '4': 1, '5': 11, '6': '.google.cloud.visionai.v1.Series', '8': {}, '10': 'series'},
    {'1': 'request_id', '3': 4, '4': 1, '5': 9, '8': {}, '10': 'requestId'},
  ],
};
...
final $typed_data.Uint8List createSeriesRequestDescriptor = $convert.base64Decode(
    ...
    'CHNlcmllc0lkEj0KBnNlcmllcxgDIAEoCzIgLmdvb2dsZS5jbG91ZC52aXNpb25haS52MS5TZX'
    'JpZXNCA+BBAlIGc2VyaWVzEiIKCnJlcXVlc3RfaWQYBCABKAlCA+BBAVIJcmVxdWVzdElk');
...
const UpdateSeriesRequest$json = {
  ...
  '2': [
    {'1': 'update_mask', '3': 1, '4': 1, '5': 11, '6': '.google.protobuf.FieldMask', '8': {}, '10': 'updateMask'},
    {'1': 'series', '3': 2, '4': 1, '5': 11, '6': '.google.cloud.visionai.v1.Series', '8': {}, '10': 'series'},
    {'1': 'request_id', '3': 3, '4': 1, '5': 9, '8': {}, '10': 'requestId'},
  ],
};
...
final $typed_data.Uint8List updateSeriesRequestDescriptor = $convert.base64Decode(
    ...
    'RvYnVmLkZpZWxkTWFza0ID4EECUgp1cGRhdGVNYXNrEj0KBnNlcmllcxgCIAEoCzIgLmdvb2ds'
    'ZS5jbG91ZC52aXNpb25haS52MS5TZXJpZXNCA+BBAlIGc2VyaWVzEiIKCnJlcXVlc3RfaWQYAy'
    'ABKAlCA+BBAVIJcmVxdWVzdElk');
...
const MaterializeChannelRequest$json = {
  ...
  '2': [
    ...
    {'1': 'channel', '3': 3, '4': 1, '5': 11, '6': '.google.cloud.visionai.v1.Channel', '8': {}, '10': 'channel'},
    {'1': 'request_id', '3': 4, '4': 1, '5': 9, '8': {}, '10': 'requestId'},
  ],
};
...
final $typed_data.Uint8List materializeChannelRequestDescriptor = $convert.base64Decode(
    ...
    'CUID4EECUgljaGFubmVsSWQSQAoHY2hhbm5lbBgDIAEoCzIhLmdvb2dsZS5jbG91ZC52aXNpb2'
    '5haS52MS5DaGFubmVsQgPgQQJSB2NoYW5uZWwSIgoKcmVxdWVzdF9pZBgEIAEoCUID4EEBUgly'
    'ZXF1ZXN0SWQ=');
