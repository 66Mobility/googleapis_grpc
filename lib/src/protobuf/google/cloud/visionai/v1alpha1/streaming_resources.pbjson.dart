...
const PacketType$json = {
  ...
  '2': [
    ...
    {'1': 'type_descriptor', '3': 2, '4': 1, '5': 11, '6': '.google.cloud.visionai.v1alpha1.PacketType.TypeDescriptor', '10': 'typeDescriptor'},
  ],
...
const PacketType_TypeDescriptor$json = {
  '1': 'TypeDescriptor',
  '2': [
    {'1': 'gstreamer_buffer_descriptor', '3': 2, '4': 1, '5': 11, '6': '.google.cloud.visionai.v1alpha1.GstreamerBufferDescriptor', '9': 0, '10': 'gstreamerBufferDescriptor'},
    {'1': 'raw_image_descriptor', '3': 3, '4': 1, '5': 11, '6': '.google.cloud.visionai.v1alpha1.RawImageDescriptor', '9': 0, '10': 'rawImageDescriptor'},
...
final $typed_data.Uint8List packetTypeDescriptor = $convert.base64Decode(
    'CgpQYWNrZXRUeXBlEh0KCnR5cGVfY2xhc3MYASABKAlSCXR5cGVDbGFzcxJiCg90eXBlX2Rlc2'
    'NyaXB0b3IYAiABKAsyOS5nb29nbGUuY2xvdWQudmlzaW9uYWkudjFhbHBoYTEuUGFja2V0VHlw'
    'ZS5UeXBlRGVzY3JpcHRvclIOdHlwZURlc2NyaXB0b3IamQIKDlR5cGVEZXNjcmlwdG9yEnsKG2'
    'dzdHJlYW1lcl9idWZmZXJfZGVzY3JpcHRvchgCIAEoCzI5Lmdvb2dsZS5jbG91ZC52aXNpb25h'
    'aS52MWFscGhhMS5Hc3RyZWFtZXJCdWZmZXJEZXNjcmlwdG9ySABSGWdzdHJlYW1lckJ1ZmZlck'
    'Rlc2NyaXB0b3ISZgoUcmF3X2ltYWdlX2Rlc2NyaXB0b3IYAyABKAsyMi5nb29nbGUuY2xvdWQu'
    'dmlzaW9uYWkudjFhbHBoYTEuUmF3SW1hZ2VEZXNjcmlwdG9ySABSEnJhd0ltYWdlRGVzY3JpcH'
    'RvchISCgR0eXBlGAEgASgJUgR0eXBlQg4KDHR5cGVfZGV0YWlscw==');
...
const PacketHeader$json = {
  ...
  '2': [
    ...
    {'1': 'type', '3': 2, '4': 1, '5': 11, '6': '.google.cloud.visionai.v1alpha1.PacketType', '8': {}, '10': 'type'},
    {'1': 'metadata', '3': 3, '4': 1, '5': 11, '6': '.google.protobuf.Struct', '8': {}, '10': 'metadata'},
    {'1': 'server_metadata', '3': 4, '4': 1, '5': 11, '6': '.google.cloud.visionai.v1alpha1.ServerMetadata', '8': {}, '10': 'serverMetadata'},
    {'1': 'series_metadata', '3': 5, '4': 1, '5': 11, '6': '.google.cloud.visionai.v1alpha1.SeriesMetadata', '8': {}, '10': 'seriesMetadata'},
...
final $typed_data.Uint8List packetHeaderDescriptor = $convert.base64Decode(
    ...
    'RpbWVzdGFtcEID4EEEUgtjYXB0dXJlVGltZRJGCgR0eXBlGAIgASgLMiouZ29vZ2xlLmNsb3Vk'
    'LnZpc2lvbmFpLnYxYWxwaGExLlBhY2tldFR5cGVCBuBBBOBBBVIEdHlwZRI4CghtZXRhZGF0YR'
    'gDIAEoCzIXLmdvb2dsZS5wcm90b2J1Zi5TdHJ1Y3RCA+BBBFIIbWV0YWRhdGESXAoPc2VydmVy'
    'X21ldGFkYXRhGAQgASgLMi4uZ29vZ2xlLmNsb3VkLnZpc2lvbmFpLnYxYWxwaGExLlNlcnZlck'
    '1ldGFkYXRhQgPgQQNSDnNlcnZlck1ldGFkYXRhEl8KD3Nlcmllc19tZXRhZGF0YRgFIAEoCzIu'
    'Lmdvb2dsZS5jbG91ZC52aXNpb25haS52MWFscGhhMS5TZXJpZXNNZXRhZGF0YUIG4EEE4EEFUg'
    '5zZXJpZXNNZXRhZGF0YRIZCgVmbGFncxgGIAEoBUID4EEFUgVmbGFncxIoCg10cmFjZV9jb250'
    'ZXh0GAcgASgJQgPgQQVSDHRyYWNlQ29udGV4dA==');

@$core.Deprecated('Use packetDescriptor instead')
const Packet$json = {
  '1': 'Packet',
  '2': [
    {'1': 'header', '3': 1, '4': 1, '5': 11, '6': '.google.cloud.visionai.v1alpha1.PacketHeader', '10': 'header'},
...
final $typed_data.Uint8List packetDescriptor = $convert.base64Decode(
    'CgZQYWNrZXQSRAoGaGVhZGVyGAEgASgLMiwuZ29vZ2xlLmNsb3VkLnZpc2lvbmFpLnYxYWxwaG'
    'ExLlBhY2tldEhlYWRlclIGaGVhZGVyEhgKB3BheWxvYWQYAiABKAxSB3BheWxvYWQ=');
