...
class ProcessorIOSpec_DataType extends $pb.ProtobufEnum {
  static const ProcessorIOSpec_DataType DATA_TYPE_UNSPECIFIED = ProcessorIOSpec_DataType._(0, _omitEnumNames ? '' : 'DATA_TYPE_UNSPECIFIED');
  static const ProcessorIOSpec_DataType VIDEO = ProcessorIOSpec_DataType._(1, _omitEnumNames ? '' : 'VIDEO');
  static const ProcessorIOSpec_DataType PROTO = ProcessorIOSpec_DataType._(2, _omitEnumNames ? '' : 'PROTO');

  static const $core.List<ProcessorIOSpec_DataType> values = <ProcessorIOSpec_DataType> [
    DATA_TYPE_UNSPECIFIED,
    VIDEO,
    PROTO,
  ];

  static final $core.Map<$core.int, ProcessorIOSpec_DataType> _byValue = $pb.ProtobufEnum.initByValue(values);
  static ProcessorIOSpec_DataType? valueOf($core.int value) => _byValue[value];

  const ProcessorIOSpec_DataType._($core.int v, $core.String n) : super(v, n);
}
