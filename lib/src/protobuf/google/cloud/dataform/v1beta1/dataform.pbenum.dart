...
class ComputeRepositoryAccessTokenStatusResponse_TokenStatus extends $pb.ProtobufEnum {
  static const ComputeRepositoryAccessTokenStatusResponse_TokenStatus TOKEN_STATUS_UNSPECIFIED = ComputeRepositoryAccessTokenStatusResponse_TokenStatus._(0, _omitEnumNames ? '' : 'TOKEN_STATUS_UNSPECIFIED');
  static const ComputeRepositoryAccessTokenStatusResponse_TokenStatus NOT_FOUND = ComputeRepositoryAccessTokenStatusResponse_TokenStatus._(1, _omitEnumNames ? '' : 'NOT_FOUND');
  static const ComputeRepositoryAccessTokenStatusResponse_TokenStatus INVALID = ComputeRepositoryAccessTokenStatusResponse_TokenStatus._(2, _omitEnumNames ? '' : 'INVALID');
  static const ComputeRepositoryAccessTokenStatusResponse_TokenStatus VALID = ComputeRepositoryAccessTokenStatusResponse_TokenStatus._(3, _omitEnumNames ? '' : 'VALID');

  static const $core.List<ComputeRepositoryAccessTokenStatusResponse_TokenStatus> values = <ComputeRepositoryAccessTokenStatusResponse_TokenStatus> [
    TOKEN_STATUS_UNSPECIFIED,
    NOT_FOUND,
    INVALID,
    VALID,
  ...
  static final $core.Map<$core.int, ComputeRepositoryAccessTokenStatusResponse_TokenStatus> _byValue = $pb.ProtobufEnum.initByValue(values);
  static ComputeRepositoryAccessTokenStatusResponse_TokenStatus? valueOf($core.int value) => _byValue[value];

  const ComputeRepositoryAccessTokenStatusResponse_TokenStatus._($core.int v, $core.String n) : super(v, n);
}
