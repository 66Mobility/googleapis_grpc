...
class CreateExternalAccountKeyRequest extends $pb.GeneratedMessage {
  factory CreateExternalAccountKeyRequest({
    $core.String? parent,
    $1335.ExternalAccountKey? externalAccountKey,
  }) {
    final $result = create();
    if (parent != null) {
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(_omitMessageNames ? '' : 'CreateExternalAccountKeyRequest', package: const $pb.PackageName(_omitMessageNames ? '' : 'google.cloud.security.publicca.v1'), createEmptyInstance: create)
    ..aOS(1, _omitFieldNames ? '' : 'parent')
    ..aOM<$1335.ExternalAccountKey>(2, _omitFieldNames ? '' : 'externalAccountKey', subBuilder: $1335.ExternalAccountKey.create)
  ...
  @$pb.TagNumber(2)
  $1335.ExternalAccountKey get externalAccountKey => $_getN(1);
  @$pb.TagNumber(2)
  set externalAccountKey($1335.ExternalAccountKey v) { setField(2, v); }
  @$pb.TagNumber(2)
  $core.bool hasExternalAccountKey() => $_has(1);
  @$pb.TagNumber(2)
  void clearExternalAccountKey() => clearField(2);
  @$pb.TagNumber(2)
  $1335.ExternalAccountKey ensureExternalAccountKey() => $_ensure(1);
}
