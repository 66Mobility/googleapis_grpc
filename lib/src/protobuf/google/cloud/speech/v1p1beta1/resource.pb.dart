...
class CustomClass_ClassItem extends $pb.GeneratedMessage {
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(_omitMessageNames ? '' : 'CustomClass.ClassItem', package: const $pb.PackageName(_omitMessageNames ? '' : 'google.cloud.speech.v1p1beta1'), createEmptyInstance: create)
...
class CustomClass extends $pb.GeneratedMessage {
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(_omitMessageNames ? '' : 'CustomClass', package: const $pb.PackageName(_omitMessageNames ? '' : 'google.cloud.speech.v1p1beta1'), createEmptyInstance: create)
...
class PhraseSet_Phrase extends $pb.GeneratedMessage {
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(_omitMessageNames ? '' : 'PhraseSet.Phrase', package: const $pb.PackageName(_omitMessageNames ? '' : 'google.cloud.speech.v1p1beta1'), createEmptyInstance: create)
    ..aOS(1, _omitFieldNames ? '' : 'value')
...
class PhraseSet extends $pb.GeneratedMessage {
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(_omitMessageNames ? '' : 'PhraseSet', package: const $pb.PackageName(_omitMessageNames ? '' : 'google.cloud.speech.v1p1beta1'), createEmptyInstance: create)
    ..aOS(1, _omitFieldNames ? '' : 'name')
...
class SpeechAdaptation_ABNFGrammar extends $pb.GeneratedMessage {
  ...
  factory SpeechAdaptation_ABNFGrammar.fromBuffer($core.List<$core.int> i, [$pb.ExtensionRegistry r = $pb.ExtensionRegistry.EMPTY]) => create()..mergeFromBuffer(i, r);
  factory SpeechAdaptation_ABNFGrammar.fromJson($core.String i, [$pb.ExtensionRegistry r = $pb.ExtensionRegistry.EMPTY]) => create()..mergeFromJson(i, r);

  static final $pb.BuilderInfo _i = $pb.BuilderInfo(_omitMessageNames ? '' : 'SpeechAdaptation.ABNFGrammar', package: const $pb.PackageName(_omitMessageNames ? '' : 'google.cloud.speech.v1p1beta1'), createEmptyInstance: create)
...
class SpeechAdaptation extends $pb.GeneratedMessage {
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(_omitMessageNames ? '' : 'SpeechAdaptation', package: const $pb.PackageName(_omitMessageNames ? '' : 'google.cloud.speech.v1p1beta1'), createEmptyInstance: create)
  ...
  @$pb.TagNumber(4)
  set abnfGrammar(SpeechAdaptation_ABNFGrammar v) { setField(4, v); }
  @$pb.TagNumber(4)
...
class TranscriptNormalization_Entry extends $pb.GeneratedMessage {
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(_omitMessageNames ? '' : 'TranscriptNormalization.Entry', package: const $pb.PackageName(_omitMessageNames ? '' : 'google.cloud.speech.v1p1beta1'), createEmptyInstance: create)
...
class TranscriptNormalization extends $pb.GeneratedMessage {
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(_omitMessageNames ? '' : 'TranscriptNormalization', package: const $pb.PackageName(_omitMessageNames ? '' : 'google.cloud.speech.v1p1beta1'), createEmptyInstance: create)
