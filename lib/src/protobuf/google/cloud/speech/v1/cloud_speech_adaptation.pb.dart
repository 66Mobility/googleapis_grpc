...
class CreatePhraseSetRequest extends $pb.GeneratedMessage {
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(_omitMessageNames ? '' : 'CreatePhraseSetRequest', package: const $pb.PackageName(_omitMessageNames ? '' : 'google.cloud.speech.v1'), createEmptyInstance: create)
    ...
    ..aOM<$1395.PhraseSet>(3, _omitFieldNames ? '' : 'phraseSet', subBuilder: $1395.PhraseSet.create)
  ...
  @$pb.TagNumber(3)
  $1395.PhraseSet get phraseSet => $_getN(2);
  @$pb.TagNumber(3)
  set phraseSet($1395.PhraseSet v) { setField(3, v); }
  @$pb.TagNumber(3)
  $core.bool hasPhraseSet() => $_has(2);
  @$pb.TagNumber(3)
  void clearPhraseSet() => clearField(3);
  @$pb.TagNumber(3)
  $1395.PhraseSet ensurePhraseSet() => $_ensure(2);
}
...
class UpdatePhraseSetRequest extends $pb.GeneratedMessage {
  ...
  ///  with matching `us` or `eu` location value.
  @$pb.TagNumber(1)
  $1395.PhraseSet get phraseSet => $_getN(0);
  @$pb.TagNumber(1)
  set phraseSet($1395.PhraseSet v) { setField(1, v); }
  @$pb.TagNumber(1)
  $core.bool hasPhraseSet() => $_has(0);
  @$pb.TagNumber(1)
  void clearPhraseSet() => clearField(1);
  @$pb.TagNumber(1)
  $1395.PhraseSet ensurePhraseSet() => $_ensure(0);
...
class ListPhraseSetResponse extends $pb.GeneratedMessage {
  factory ListPhraseSetResponse({
    $core.Iterable<$1395.PhraseSet>? phraseSets,
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(_omitMessageNames ? '' : 'ListPhraseSetResponse', package: const $pb.PackageName(_omitMessageNames ? '' : 'google.cloud.speech.v1'), createEmptyInstance: create)
    ..pc<$1395.PhraseSet>(1, _omitFieldNames ? '' : 'phraseSets', $pb.PbFieldType.PM, subBuilder: $1395.PhraseSet.create)
  ...
  /// The phrase set.
  @$pb.TagNumber(1)
  $core.List<$1395.PhraseSet> get phraseSets => $_getList(0);
...
class CreateCustomClassRequest extends $pb.GeneratedMessage {
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(_omitMessageNames ? '' : 'CreateCustomClassRequest', package: const $pb.PackageName(_omitMessageNames ? '' : 'google.cloud.speech.v1'), createEmptyInstance: create)
    ...
    ..aOM<$1395.CustomClass>(3, _omitFieldNames ? '' : 'customClass', subBuilder: $1395.CustomClass.create)
    ..hasRequiredFields = false
  ;
  ...
  @$pb.TagNumber(3)
  $1395.CustomClass get customClass => $_getN(2);
  @$pb.TagNumber(3)
  set customClass($1395.CustomClass v) { setField(3, v); }
  @$pb.TagNumber(3)
  $core.bool hasCustomClass() => $_has(2);
  @$pb.TagNumber(3)
  void clearCustomClass() => clearField(3);
  @$pb.TagNumber(3)
  $1395.CustomClass ensureCustomClass() => $_ensure(2);
}
...
class UpdateCustomClassRequest extends $pb.GeneratedMessage {
  ...
  ///  with matching `us` or `eu` location value.
  @$pb.TagNumber(1)
  $1395.CustomClass get customClass => $_getN(0);
  @$pb.TagNumber(1)
  set customClass($1395.CustomClass v) { setField(1, v); }
  @$pb.TagNumber(1)
  $core.bool hasCustomClass() => $_has(0);
  @$pb.TagNumber(1)
  void clearCustomClass() => clearField(1);
  @$pb.TagNumber(1)
  $1395.CustomClass ensureCustomClass() => $_ensure(0);
...
class ListCustomClassesResponse extends $pb.GeneratedMessage {
  factory ListCustomClassesResponse({
    $core.Iterable<$1395.CustomClass>? customClasses,
    $core.String? nextPageToken,
  }) {
    final $result = create();
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(_omitMessageNames ? '' : 'ListCustomClassesResponse', package: const $pb.PackageName(_omitMessageNames ? '' : 'google.cloud.speech.v1'), createEmptyInstance: create)
    ..pc<$1395.CustomClass>(1, _omitFieldNames ? '' : 'customClasses', $pb.PbFieldType.PM, subBuilder: $1395.CustomClass.create)
    ..aOS(2, _omitFieldNames ? '' : 'nextPageToken')
    ..hasRequiredFields = false
  ;
  ...
  /// The custom classes.
  @$pb.TagNumber(1)
  $core.List<$1395.CustomClass> get customClasses => $_getList(0);
