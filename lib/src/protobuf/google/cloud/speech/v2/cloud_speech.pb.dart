...
class CreateRecognizerRequest extends $pb.GeneratedMessage {
  ...
  factory CreateRecognizerRequest.fromBuffer($core.List<$core.int> i, [$pb.ExtensionRegistry r = $pb.ExtensionRegistry.EMPTY]) => create()..mergeFromBuffer(i, r);
  factory CreateRecognizerRequest.fromJson($core.String i, [$pb.ExtensionRegistry r = $pb.ExtensionRegistry.EMPTY]) => create()..mergeFromJson(i, r);

  static final $pb.BuilderInfo _i = $pb.BuilderInfo(_omitMessageNames ? '' : 'CreateRecognizerRequest', package: const $pb.PackageName(_omitMessageNames ? '' : 'google.cloud.speech.v2'), createEmptyInstance: create)
  ...
  CreateRecognizerRequest clone() => CreateRecognizerRequest()..mergeFromMessage(this);
  @$core.Deprecated(
  'Using this can add significant overhead to your binary. '
  'Use [GeneratedMessageGenericExtensions.rebuild] instead. '
  'Will be removed in next major version')
  CreateRecognizerRequest copyWith(void Function(CreateRecognizerRequest) updates) => super.copyWith((message) => updates(message as CreateRecognizerRequest)) as CreateRecognizerRequest;
  ...
  static $pb.PbList<CreateRecognizerRequest> createRepeated() => $pb.PbList<CreateRecognizerRequest>();
  @$core.pragma('dart2js:noInline')
  static CreateRecognizerRequest getDefault() => _defaultInstance ??= $pb.GeneratedMessage.$_defaultFor<CreateRecognizerRequest>(create);
  ...
  @$pb.TagNumber(1)
  set recognizer(Recognizer v) { setField(1, v); }
  @$pb.TagNumber(1)
  ...
  @$pb.TagNumber(3)
  set recognizerId($core.String v) { $_setString(2, v); }
  @$pb.TagNumber(3)
...
enum OperationMetadata_Metadata {
...
class OperationMetadata extends $pb.GeneratedMessage {
  ...
  static const $core.Map<$core.int, OperationMetadata_Request> _OperationMetadata_RequestByTag = {
  ...
  static const $core.Map<$core.int, OperationMetadata_Metadata> _OperationMetadata_MetadataByTag = {
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(_omitMessageNames ? '' : 'OperationMetadata', package: const $pb.PackageName(_omitMessageNames ? '' : 'google.cloud.speech.v2'), createEmptyInstance: create)
    ...
    ..aOM<BatchRecognizeRequest>(8, _omitFieldNames ? '' : 'batchRecognizeRequest', subBuilder: BatchRecognizeRequest.create)
    ..aOM<CreateRecognizerRequest>(9, _omitFieldNames ? '' : 'createRecognizerRequest', subBuilder: CreateRecognizerRequest.create)
    ..aOM<UpdateRecognizerRequest>(10, _omitFieldNames ? '' : 'updateRecognizerRequest', subBuilder: UpdateRecognizerRequest.create)
    ..aOM<DeleteRecognizerRequest>(11, _omitFieldNames ? '' : 'deleteRecognizerRequest', subBuilder: DeleteRecognizerRequest.create)
    ..aOM<UndeleteRecognizerRequest>(12, _omitFieldNames ? '' : 'undeleteRecognizerRequest', subBuilder: UndeleteRecognizerRequest.create)
    ..aOM<CreateCustomClassRequest>(13, _omitFieldNames ? '' : 'createCustomClassRequest', subBuilder: CreateCustomClassRequest.create)
    ..aOM<UpdateCustomClassRequest>(14, _omitFieldNames ? '' : 'updateCustomClassRequest', subBuilder: UpdateCustomClassRequest.create)
    ..aOM<DeleteCustomClassRequest>(15, _omitFieldNames ? '' : 'deleteCustomClassRequest', subBuilder: DeleteCustomClassRequest.create)
    ..aOM<UndeleteCustomClassRequest>(16, _omitFieldNames ? '' : 'undeleteCustomClassRequest', subBuilder: UndeleteCustomClassRequest.create)
    ..aOM<CreatePhraseSetRequest>(17, _omitFieldNames ? '' : 'createPhraseSetRequest', subBuilder: CreatePhraseSetRequest.create)
    ..aOM<UpdatePhraseSetRequest>(18, _omitFieldNames ? '' : 'updatePhraseSetRequest', subBuilder: UpdatePhraseSetRequest.create)
    ..aOM<DeletePhraseSetRequest>(19, _omitFieldNames ? '' : 'deletePhraseSetRequest', subBuilder: DeletePhraseSetRequest.create)
    ..aOM<UndeletePhraseSetRequest>(20, _omitFieldNames ? '' : 'undeletePhraseSetRequest', subBuilder: UndeletePhraseSetRequest.create)
    ..aOM<UpdateConfigRequest>(21, _omitFieldNames ? '' : 'updateConfigRequest', subBuilder: UpdateConfigRequest.create)
    ..a<$core.int>(22, _omitFieldNames ? '' : 'progressPercent', $pb.PbFieldType.O3)
    ..aOM<BatchRecognizeMetadata>(23, _omitFieldNames ? '' : 'batchRecognizeMetadata', subBuilder: BatchRecognizeMetadata.create)
    ..hasRequiredFields = false
  ;
  ...
  OperationMetadata_Request whichRequest() => _OperationMetadata_RequestByTag[$_whichOneof(0)]!;
  void clearRequest() => clearField($_whichOneof(0));

  OperationMetadata_Metadata whichMetadata() => _OperationMetadata_MetadataByTag[$_whichOneof(1)]!;
  ...
  @$pb.TagNumber(7)
  set kmsKeyVersionName($core.String v) { $_setString(5, v); }
  @$pb.TagNumber(7)
  ...
  @$pb.TagNumber(8)
  set batchRecognizeRequest(BatchRecognizeRequest v) { setField(8, v); }
  @$pb.TagNumber(8)
  ...
  @$pb.TagNumber(9)
  set createRecognizerRequest(CreateRecognizerRequest v) { setField(9, v); }
  @$pb.TagNumber(9)
  ...
  @$pb.TagNumber(10)
  set updateRecognizerRequest(UpdateRecognizerRequest v) { setField(10, v); }
  @$pb.TagNumber(10)
  ...
  @$pb.TagNumber(11)
  set deleteRecognizerRequest(DeleteRecognizerRequest v) { setField(11, v); }
  @$pb.TagNumber(11)
  ...
  @$pb.TagNumber(12)
  set undeleteRecognizerRequest(UndeleteRecognizerRequest v) { setField(12, v); }
  @$pb.TagNumber(12)
  ...
  @$pb.TagNumber(13)
  set createCustomClassRequest(CreateCustomClassRequest v) { setField(13, v); }
  @$pb.TagNumber(13)
  ...
  @$pb.TagNumber(14)
  set updateCustomClassRequest(UpdateCustomClassRequest v) { setField(14, v); }
  @$pb.TagNumber(14)
  ...
  @$pb.TagNumber(15)
  set deleteCustomClassRequest(DeleteCustomClassRequest v) { setField(15, v); }
  @$pb.TagNumber(15)
  ...
  @$pb.TagNumber(16)
  set undeleteCustomClassRequest(UndeleteCustomClassRequest v) { setField(16, v); }
  @$pb.TagNumber(16)
  ...
  @$pb.TagNumber(17)
  set createPhraseSetRequest(CreatePhraseSetRequest v) { setField(17, v); }
  @$pb.TagNumber(17)
  ...
  @$pb.TagNumber(18)
  set updatePhraseSetRequest(UpdatePhraseSetRequest v) { setField(18, v); }
  @$pb.TagNumber(18)
  ...
  @$pb.TagNumber(19)
  set deletePhraseSetRequest(DeletePhraseSetRequest v) { setField(19, v); }
  @$pb.TagNumber(19)
  ...
  @$pb.TagNumber(20)
  set undeletePhraseSetRequest(UndeletePhraseSetRequest v) { setField(20, v); }
  @$pb.TagNumber(20)
  ...
  @$core.Deprecated('This field is deprecated.')
  @$pb.TagNumber(21)
  set updateConfigRequest(UpdateConfigRequest v) { setField(21, v); }
  @$core.Deprecated('This field is deprecated.')
  @$pb.TagNumber(21)
  ...
  @$pb.TagNumber(22)
  set progressPercent($core.int v) { $_setSignedInt32(20, v); }
  @$pb.TagNumber(22)
  ...
  @$pb.TagNumber(23)
  set batchRecognizeMetadata(BatchRecognizeMetadata v) { setField(23, v); }
  @$pb.TagNumber(23)
...
class ListRecognizersRequest extends $pb.GeneratedMessage {
  ...
  factory ListRecognizersRequest.fromBuffer($core.List<$core.int> i, [$pb.ExtensionRegistry r = $pb.ExtensionRegistry.EMPTY]) => create()..mergeFromBuffer(i, r);
  factory ListRecognizersRequest.fromJson($core.String i, [$pb.ExtensionRegistry r = $pb.ExtensionRegistry.EMPTY]) => create()..mergeFromJson(i, r);

  static final $pb.BuilderInfo _i = $pb.BuilderInfo(_omitMessageNames ? '' : 'ListRecognizersRequest', package: const $pb.PackageName(_omitMessageNames ? '' : 'google.cloud.speech.v2'), createEmptyInstance: create)
  ...
  'Use [GeneratedMessageGenericExtensions.deepCopy] instead. '
  'Will be removed in next major version')
  ListRecognizersRequest clone() => ListRecognizersRequest()..mergeFromMessage(this);
  @$core.Deprecated(
  'Using this can add significant overhead to your binary. '
  'Use [GeneratedMessageGenericExtensions.rebuild] instead. '
  'Will be removed in next major version')
  ListRecognizersRequest copyWith(void Function(ListRecognizersRequest) updates) => super.copyWith((message) => updates(message as ListRecognizersRequest)) as ListRecognizersRequest;
  ...
  static $pb.PbList<ListRecognizersRequest> createRepeated() => $pb.PbList<ListRecognizersRequest>();
  @$core.pragma('dart2js:noInline')
  static ListRecognizersRequest getDefault() => _defaultInstance ??= $pb.GeneratedMessage.$_defaultFor<ListRecognizersRequest>(create);
...
class ListRecognizersResponse extends $pb.GeneratedMessage {
  ...
  factory ListRecognizersResponse.fromBuffer($core.List<$core.int> i, [$pb.ExtensionRegistry r = $pb.ExtensionRegistry.EMPTY]) => create()..mergeFromBuffer(i, r);
  factory ListRecognizersResponse.fromJson($core.String i, [$pb.ExtensionRegistry r = $pb.ExtensionRegistry.EMPTY]) => create()..mergeFromJson(i, r);

  static final $pb.BuilderInfo _i = $pb.BuilderInfo(_omitMessageNames ? '' : 'ListRecognizersResponse', package: const $pb.PackageName(_omitMessageNames ? '' : 'google.cloud.speech.v2'), createEmptyInstance: create)
    ..pc<Recognizer>(1, _omitFieldNames ? '' : 'recognizers', $pb.PbFieldType.PM, subBuilder: Recognizer.create)
  ...
  'Use [GeneratedMessageGenericExtensions.deepCopy] instead. '
  'Will be removed in next major version')
  ListRecognizersResponse clone() => ListRecognizersResponse()..mergeFromMessage(this);
  @$core.Deprecated(
  'Using this can add significant overhead to your binary. '
  'Use [GeneratedMessageGenericExtensions.rebuild] instead. '
  'Will be removed in next major version')
  ListRecognizersResponse copyWith(void Function(ListRecognizersResponse) updates) => super.copyWith((message) => updates(message as ListRecognizersResponse)) as ListRecognizersResponse;
  ...
  static $pb.PbList<ListRecognizersResponse> createRepeated() => $pb.PbList<ListRecognizersResponse>();
  @$core.pragma('dart2js:noInline')
  static ListRecognizersResponse getDefault() => _defaultInstance ??= $pb.GeneratedMessage.$_defaultFor<ListRecognizersResponse>(create);
...
class GetRecognizerRequest extends $pb.GeneratedMessage {
  ...
  factory GetRecognizerRequest.fromBuffer($core.List<$core.int> i, [$pb.ExtensionRegistry r = $pb.ExtensionRegistry.EMPTY]) => create()..mergeFromBuffer(i, r);
  factory GetRecognizerRequest.fromJson($core.String i, [$pb.ExtensionRegistry r = $pb.ExtensionRegistry.EMPTY]) => create()..mergeFromJson(i, r);

  static final $pb.BuilderInfo _i = $pb.BuilderInfo(_omitMessageNames ? '' : 'GetRecognizerRequest', package: const $pb.PackageName(_omitMessageNames ? '' : 'google.cloud.speech.v2'), createEmptyInstance: create)
  ...
  'Use [GeneratedMessageGenericExtensions.deepCopy] instead. '
  'Will be removed in next major version')
  GetRecognizerRequest clone() => GetRecognizerRequest()..mergeFromMessage(this);
  @$core.Deprecated(
  'Using this can add significant overhead to your binary. '
  'Use [GeneratedMessageGenericExtensions.rebuild] instead. '
  'Will be removed in next major version')
  GetRecognizerRequest copyWith(void Function(GetRecognizerRequest) updates) => super.copyWith((message) => updates(message as GetRecognizerRequest)) as GetRecognizerRequest;
  ...
  static $pb.PbList<GetRecognizerRequest> createRepeated() => $pb.PbList<GetRecognizerRequest>();
  @$core.pragma('dart2js:noInline')
  static GetRecognizerRequest getDefault() => _defaultInstance ??= $pb.GeneratedMessage.$_defaultFor<GetRecognizerRequest>(create);
...
class UpdateRecognizerRequest extends $pb.GeneratedMessage {
  ...
  factory UpdateRecognizerRequest.fromBuffer($core.List<$core.int> i, [$pb.ExtensionRegistry r = $pb.ExtensionRegistry.EMPTY]) => create()..mergeFromBuffer(i, r);
  factory UpdateRecognizerRequest.fromJson($core.String i, [$pb.ExtensionRegistry r = $pb.ExtensionRegistry.EMPTY]) => create()..mergeFromJson(i, r);
  ...
  'Use [GeneratedMessageGenericExtensions.deepCopy] instead. '
  'Will be removed in next major version')
  UpdateRecognizerRequest clone() => UpdateRecognizerRequest()..mergeFromMessage(this);
  @$core.Deprecated(
  'Using this can add significant overhead to your binary. '
  'Use [GeneratedMessageGenericExtensions.rebuild] instead. '
  'Will be removed in next major version')
  UpdateRecognizerRequest copyWith(void Function(UpdateRecognizerRequest) updates) => super.copyWith((message) => updates(message as UpdateRecognizerRequest)) as UpdateRecognizerRequest;
  ...
  static $pb.PbList<UpdateRecognizerRequest> createRepeated() => $pb.PbList<UpdateRecognizerRequest>();
  @$core.pragma('dart2js:noInline')
  static UpdateRecognizerRequest getDefault() => _defaultInstance ??= $pb.GeneratedMessage.$_defaultFor<UpdateRecognizerRequest>(create);
...
class DeleteRecognizerRequest extends $pb.GeneratedMessage {
  ...
  factory DeleteRecognizerRequest.fromBuffer($core.List<$core.int> i, [$pb.ExtensionRegistry r = $pb.ExtensionRegistry.EMPTY]) => create()..mergeFromBuffer(i, r);
  factory DeleteRecognizerRequest.fromJson($core.String i, [$pb.ExtensionRegistry r = $pb.ExtensionRegistry.EMPTY]) => create()..mergeFromJson(i, r);

  static final $pb.BuilderInfo _i = $pb.BuilderInfo(_omitMessageNames ? '' : 'DeleteRecognizerRequest', package: const $pb.PackageName(_omitMessageNames ? '' : 'google.cloud.speech.v2'), createEmptyInstance: create)
    ..aOS(1, _omitFieldNames ? '' : 'name')
    ..aOB(2, _omitFieldNames ? '' : 'validateOnly')
  ...
  'Use [GeneratedMessageGenericExtensions.deepCopy] instead. '
  'Will be removed in next major version')
  DeleteRecognizerRequest clone() => DeleteRecognizerRequest()..mergeFromMessage(this);
  @$core.Deprecated(
  'Using this can add significant overhead to your binary. '
  'Use [GeneratedMessageGenericExtensions.rebuild] instead. '
  'Will be removed in next major version')
  DeleteRecognizerRequest copyWith(void Function(DeleteRecognizerRequest) updates) => super.copyWith((message) => updates(message as DeleteRecognizerRequest)) as DeleteRecognizerRequest;
  ...
  static $pb.PbList<DeleteRecognizerRequest> createRepeated() => $pb.PbList<DeleteRecognizerRequest>();
  @$core.pragma('dart2js:noInline')
  static DeleteRecognizerRequest getDefault() => _defaultInstance ??= $pb.GeneratedMessage.$_defaultFor<DeleteRecognizerRequest>(create);
...
class UndeleteRecognizerRequest extends $pb.GeneratedMessage {
  ...
  factory UndeleteRecognizerRequest.fromBuffer($core.List<$core.int> i, [$pb.ExtensionRegistry r = $pb.ExtensionRegistry.EMPTY]) => create()..mergeFromBuffer(i, r);
  factory UndeleteRecognizerRequest.fromJson($core.String i, [$pb.ExtensionRegistry r = $pb.ExtensionRegistry.EMPTY]) => create()..mergeFromJson(i, r);

  static final $pb.BuilderInfo _i = $pb.BuilderInfo(_omitMessageNames ? '' : 'UndeleteRecognizerRequest', package: const $pb.PackageName(_omitMessageNames ? '' : 'google.cloud.speech.v2'), createEmptyInstance: create)
    ..aOS(1, _omitFieldNames ? '' : 'name')
  ...
  'Use [GeneratedMessageGenericExtensions.deepCopy] instead. '
  'Will be removed in next major version')
  UndeleteRecognizerRequest clone() => UndeleteRecognizerRequest()..mergeFromMessage(this);
  @$core.Deprecated(
  'Using this can add significant overhead to your binary. '
  'Use [GeneratedMessageGenericExtensions.rebuild] instead. '
  'Will be removed in next major version')
  UndeleteRecognizerRequest copyWith(void Function(UndeleteRecognizerRequest) updates) => super.copyWith((message) => updates(message as UndeleteRecognizerRequest)) as UndeleteRecognizerRequest;
  ...
  static $pb.PbList<UndeleteRecognizerRequest> createRepeated() => $pb.PbList<UndeleteRecognizerRequest>();
  @$core.pragma('dart2js:noInline')
  static UndeleteRecognizerRequest getDefault() => _defaultInstance ??= $pb.GeneratedMessage.$_defaultFor<UndeleteRecognizerRequest>(create);
...
class Recognizer extends $pb.GeneratedMessage {
  ...
  Recognizer._() : super();
  factory Recognizer.fromBuffer($core.List<$core.int> i, [$pb.ExtensionRegistry r = $pb.ExtensionRegistry.EMPTY]) => create()..mergeFromBuffer(i, r);
  factory Recognizer.fromJson($core.String i, [$pb.ExtensionRegistry r = $pb.ExtensionRegistry.EMPTY]) => create()..mergeFromJson(i, r);

  static final $pb.BuilderInfo _i = $pb.BuilderInfo(_omitMessageNames ? '' : 'Recognizer', package: const $pb.PackageName(_omitMessageNames ? '' : 'google.cloud.speech.v2'), createEmptyInstance: create)
    ..aOS(1, _omitFieldNames ? '' : 'name')
  ...
  'Use [GeneratedMessageGenericExtensions.rebuild] instead. '
  'Will be removed in next major version')
  Recognizer copyWith(void Function(Recognizer) updates) => super.copyWith((message) => updates(message as Recognizer)) as Recognizer;
  ...
  @$core.pragma('dart2js:noInline')
  static Recognizer getDefault() => _defaultInstance ??= $pb.GeneratedMessage.$_defaultFor<Recognizer>(create);
  ...
  @$pb.TagNumber(6)
  set defaultRecognitionConfig(RecognitionConfig v) { setField(6, v); }
  @$pb.TagNumber(6)
  ...
  @$pb.TagNumber(8)
  set state(Recognizer_State v) { setField(8, v); }
  @$pb.TagNumber(8)
  ...
  @$pb.TagNumber(15)
  set kmsKeyName($core.String v) { $_setString(13, v); }
  @$pb.TagNumber(15)
  ...
  @$pb.TagNumber(16)
  set kmsKeyVersionName($core.String v) { $_setString(14, v); }
  @$pb.TagNumber(16)
...
class AutoDetectDecodingConfig extends $pb.GeneratedMessage {
  ...
  factory AutoDetectDecodingConfig.fromBuffer($core.List<$core.int> i, [$pb.ExtensionRegistry r = $pb.ExtensionRegistry.EMPTY]) => create()..mergeFromBuffer(i, r);
  factory AutoDetectDecodingConfig.fromJson($core.String i, [$pb.ExtensionRegistry r = $pb.ExtensionRegistry.EMPTY]) => create()..mergeFromJson(i, r);

  static final $pb.BuilderInfo _i = $pb.BuilderInfo(_omitMessageNames ? '' : 'AutoDetectDecodingConfig', package: const $pb.PackageName(_omitMessageNames ? '' : 'google.cloud.speech.v2'), createEmptyInstance: create)
    ..hasRequiredFields = false
  ;
  ...
  'Use [GeneratedMessageGenericExtensions.deepCopy] instead. '
  'Will be removed in next major version')
  AutoDetectDecodingConfig clone() => AutoDetectDecodingConfig()..mergeFromMessage(this);
  @$core.Deprecated(
  'Using this can add significant overhead to your binary. '
  'Use [GeneratedMessageGenericExtensions.rebuild] instead. '
  'Will be removed in next major version')
  AutoDetectDecodingConfig copyWith(void Function(AutoDetectDecodingConfig) updates) => super.copyWith((message) => updates(message as AutoDetectDecodingConfig)) as AutoDetectDecodingConfig;
  ...
  static $pb.PbList<AutoDetectDecodingConfig> createRepeated() => $pb.PbList<AutoDetectDecodingConfig>();
  @$core.pragma('dart2js:noInline')
  static AutoDetectDecodingConfig getDefault() => _defaultInstance ??= $pb.GeneratedMessage.$_defaultFor<AutoDetectDecodingConfig>(create);
...
class ExplicitDecodingConfig extends $pb.GeneratedMessage {
  ...
  factory ExplicitDecodingConfig.fromBuffer($core.List<$core.int> i, [$pb.ExtensionRegistry r = $pb.ExtensionRegistry.EMPTY]) => create()..mergeFromBuffer(i, r);
  factory ExplicitDecodingConfig.fromJson($core.String i, [$pb.ExtensionRegistry r = $pb.ExtensionRegistry.EMPTY]) => create()..mergeFromJson(i, r);

  static final $pb.BuilderInfo _i = $pb.BuilderInfo(_omitMessageNames ? '' : 'ExplicitDecodingConfig', package: const $pb.PackageName(_omitMessageNames ? '' : 'google.cloud.speech.v2'), createEmptyInstance: create)
    ..e<ExplicitDecodingConfig_AudioEncoding>(1, _omitFieldNames ? '' : 'encoding', $pb.PbFieldType.OE, defaultOrMaker: ExplicitDecodingConfig_AudioEncoding.AUDIO_ENCODING_UNSPECIFIED, valueOf: ExplicitDecodingConfig_AudioEncoding.valueOf, enumValues: ExplicitDecodingConfig_AudioEncoding.values)
    ..a<$core.int>(2, _omitFieldNames ? '' : 'sampleRateHertz', $pb.PbFieldType.O3)
    ..a<$core.int>(3, _omitFieldNames ? '' : 'audioChannelCount', $pb.PbFieldType.O3)
    ..hasRequiredFields = false
  ;
  ...
  'Use [GeneratedMessageGenericExtensions.deepCopy] instead. '
  'Will be removed in next major version')
  ExplicitDecodingConfig clone() => ExplicitDecodingConfig()..mergeFromMessage(this);
  @$core.Deprecated(
  'Using this can add significant overhead to your binary. '
  'Use [GeneratedMessageGenericExtensions.rebuild] instead. '
  'Will be removed in next major version')
  ExplicitDecodingConfig copyWith(void Function(ExplicitDecodingConfig) updates) => super.copyWith((message) => updates(message as ExplicitDecodingConfig)) as ExplicitDecodingConfig;
  ...
  static $pb.PbList<ExplicitDecodingConfig> createRepeated() => $pb.PbList<ExplicitDecodingConfig>();
  @$core.pragma('dart2js:noInline')
  static ExplicitDecodingConfig getDefault() => _defaultInstance ??= $pb.GeneratedMessage.$_defaultFor<ExplicitDecodingConfig>(create);
  ...
  @$pb.TagNumber(1)
  set encoding(ExplicitDecodingConfig_AudioEncoding v) { setField(1, v); }
  @$pb.TagNumber(1)
  ...
  @$pb.TagNumber(3)
  set audioChannelCount($core.int v) { $_setSignedInt32(2, v); }
  @$pb.TagNumber(3)
...
class SpeakerDiarizationConfig extends $pb.GeneratedMessage {
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(_omitMessageNames ? '' : 'SpeakerDiarizationConfig', package: const $pb.PackageName(_omitMessageNames ? '' : 'google.cloud.speech.v2'), createEmptyInstance: create)
  ...
  @$pb.TagNumber(2)
  set minSpeakerCount($core.int v) { $_setSignedInt32(0, v); }
  @$pb.TagNumber(2)
  ...
  @$pb.TagNumber(3)
  set maxSpeakerCount($core.int v) { $_setSignedInt32(1, v); }
  @$pb.TagNumber(3)
...
class RecognitionFeatures extends $pb.GeneratedMessage {
  ...
  factory RecognitionFeatures.fromBuffer($core.List<$core.int> i, [$pb.ExtensionRegistry r = $pb.ExtensionRegistry.EMPTY]) => create()..mergeFromBuffer(i, r);
  factory RecognitionFeatures.fromJson($core.String i, [$pb.ExtensionRegistry r = $pb.ExtensionRegistry.EMPTY]) => create()..mergeFromJson(i, r);

  static final $pb.BuilderInfo _i = $pb.BuilderInfo(_omitMessageNames ? '' : 'RecognitionFeatures', package: const $pb.PackageName(_omitMessageNames ? '' : 'google.cloud.speech.v2'), createEmptyInstance: create)
    ...
    ..aOM<SpeakerDiarizationConfig>(9, _omitFieldNames ? '' : 'diarizationConfig', subBuilder: SpeakerDiarizationConfig.create)
    ..aOB(14, _omitFieldNames ? '' : 'enableSpokenPunctuation')
    ..aOB(15, _omitFieldNames ? '' : 'enableSpokenEmojis')
    ..a<$core.int>(16, _omitFieldNames ? '' : 'maxAlternatives', $pb.PbFieldType.O3)
    ..e<RecognitionFeatures_MultiChannelMode>(17, _omitFieldNames ? '' : 'multiChannelMode', $pb.PbFieldType.OE, defaultOrMaker: RecognitionFeatures_MultiChannelMode.MULTI_CHANNEL_MODE_UNSPECIFIED, valueOf: RecognitionFeatures_MultiChannelMode.valueOf, enumValues: RecognitionFeatures_MultiChannelMode.values)
    ..hasRequiredFields = false
  ;
  ...
  'Use [GeneratedMessageGenericExtensions.rebuild] instead. '
  'Will be removed in next major version')
  RecognitionFeatures copyWith(void Function(RecognitionFeatures) updates) => super.copyWith((message) => updates(message as RecognitionFeatures)) as RecognitionFeatures;
  ...
  static $pb.PbList<RecognitionFeatures> createRepeated() => $pb.PbList<RecognitionFeatures>();
  @$core.pragma('dart2js:noInline')
  static RecognitionFeatures getDefault() => _defaultInstance ??= $pb.GeneratedMessage.$_defaultFor<RecognitionFeatures>(create);
  ...
  @$pb.TagNumber(1)
  set profanityFilter($core.bool v) { $_setBool(0, v); }
  @$pb.TagNumber(1)
  ...
  @$pb.TagNumber(2)
  set enableWordTimeOffsets($core.bool v) { $_setBool(1, v); }
  @$pb.TagNumber(2)
  ...
  @$pb.TagNumber(3)
  set enableWordConfidence($core.bool v) { $_setBool(2, v); }
  @$pb.TagNumber(3)
  ...
  @$pb.TagNumber(4)
  set enableAutomaticPunctuation($core.bool v) { $_setBool(3, v); }
  @$pb.TagNumber(4)
  ...
  @$pb.TagNumber(9)
  set diarizationConfig(SpeakerDiarizationConfig v) { setField(9, v); }
  @$pb.TagNumber(9)
  ...
  @$pb.TagNumber(14)
  set enableSpokenPunctuation($core.bool v) { $_setBool(5, v); }
  @$pb.TagNumber(14)
  ...
  @$pb.TagNumber(15)
  set enableSpokenEmojis($core.bool v) { $_setBool(6, v); }
  @$pb.TagNumber(15)
  ...
  @$pb.TagNumber(16)
  set maxAlternatives($core.int v) { $_setSignedInt32(7, v); }
  @$pb.TagNumber(16)
  ...
  @$pb.TagNumber(17)
  set multiChannelMode(RecognitionFeatures_MultiChannelMode v) { setField(17, v); }
  @$pb.TagNumber(17)
...
class TranscriptNormalization_Entry extends $pb.GeneratedMessage {
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(_omitMessageNames ? '' : 'TranscriptNormalization.Entry', package: const $pb.PackageName(_omitMessageNames ? '' : 'google.cloud.speech.v2'), createEmptyInstance: create)
...
class TranscriptNormalization extends $pb.GeneratedMessage {
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(_omitMessageNames ? '' : 'TranscriptNormalization', package: const $pb.PackageName(_omitMessageNames ? '' : 'google.cloud.speech.v2'), createEmptyInstance: create)
...
class TranslationConfig extends $pb.GeneratedMessage {
  ...
  factory TranslationConfig.fromBuffer($core.List<$core.int> i, [$pb.ExtensionRegistry r = $pb.ExtensionRegistry.EMPTY]) => create()..mergeFromBuffer(i, r);
  factory TranslationConfig.fromJson($core.String i, [$pb.ExtensionRegistry r = $pb.ExtensionRegistry.EMPTY]) => create()..mergeFromJson(i, r);

  static final $pb.BuilderInfo _i = $pb.BuilderInfo(_omitMessageNames ? '' : 'TranslationConfig', package: const $pb.PackageName(_omitMessageNames ? '' : 'google.cloud.speech.v2'), createEmptyInstance: create)
  ...
  'Use [GeneratedMessageGenericExtensions.rebuild] instead. '
  'Will be removed in next major version')
  TranslationConfig copyWith(void Function(TranslationConfig) updates) => super.copyWith((message) => updates(message as TranslationConfig)) as TranslationConfig;
  ...
  static $pb.PbList<TranslationConfig> createRepeated() => $pb.PbList<TranslationConfig>();
  @$core.pragma('dart2js:noInline')
  static TranslationConfig getDefault() => _defaultInstance ??= $pb.GeneratedMessage.$_defaultFor<TranslationConfig>(create);
  ...
  @$pb.TagNumber(1)
  set targetLanguage($core.String v) { $_setString(0, v); }
  @$pb.TagNumber(1)
  $core.bool hasTargetLanguage() => $_has(0);
  @$pb.TagNumber(1)
  void clearTargetLanguage() => clearField(1);
}
...
class SpeechAdaptation_AdaptationPhraseSet extends $pb.GeneratedMessage {
  ...
  factory SpeechAdaptation_AdaptationPhraseSet.fromBuffer($core.List<$core.int> i, [$pb.ExtensionRegistry r = $pb.ExtensionRegistry.EMPTY]) => create()..mergeFromBuffer(i, r);
  factory SpeechAdaptation_AdaptationPhraseSet.fromJson($core.String i, [$pb.ExtensionRegistry r = $pb.ExtensionRegistry.EMPTY]) => create()..mergeFromJson(i, r);

  static const $core.Map<$core.int, SpeechAdaptation_AdaptationPhraseSet_Value> _SpeechAdaptation_AdaptationPhraseSet_ValueByTag = {
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(_omitMessageNames ? '' : 'SpeechAdaptation.AdaptationPhraseSet', package: const $pb.PackageName(_omitMessageNames ? '' : 'google.cloud.speech.v2'), createEmptyInstance: create)
    ..oo(0, [1, 2])
    ..aOS(1, _omitFieldNames ? '' : 'phraseSet')
    ..aOM<PhraseSet>(2, _omitFieldNames ? '' : 'inlinePhraseSet', subBuilder: PhraseSet.create)
    ..hasRequiredFields = false
  ;
  ...
  'Use [GeneratedMessageGenericExtensions.deepCopy] instead. '
  'Will be removed in next major version')
  SpeechAdaptation_AdaptationPhraseSet clone() => SpeechAdaptation_AdaptationPhraseSet()..mergeFromMessage(this);
  @$core.Deprecated(
  'Using this can add significant overhead to your binary. '
  'Use [GeneratedMessageGenericExtensions.rebuild] instead. '
  'Will be removed in next major version')
  SpeechAdaptation_AdaptationPhraseSet copyWith(void Function(SpeechAdaptation_AdaptationPhraseSet) updates) => super.copyWith((message) => updates(message as SpeechAdaptation_AdaptationPhraseSet)) as SpeechAdaptation_AdaptationPhraseSet;

  $pb.BuilderInfo get info_ => _i;

  @$core.pragma('dart2js:noInline')
  static SpeechAdaptation_AdaptationPhraseSet create() => SpeechAdaptation_AdaptationPhraseSet._();
  SpeechAdaptation_AdaptationPhraseSet createEmptyInstance() => create();
  static $pb.PbList<SpeechAdaptation_AdaptationPhraseSet> createRepeated() => $pb.PbList<SpeechAdaptation_AdaptationPhraseSet>();
  @$core.pragma('dart2js:noInline')
  static SpeechAdaptation_AdaptationPhraseSet getDefault() => _defaultInstance ??= $pb.GeneratedMessage.$_defaultFor<SpeechAdaptation_AdaptationPhraseSet>(create);
  static SpeechAdaptation_AdaptationPhraseSet? _defaultInstance;

  SpeechAdaptation_AdaptationPhraseSet_Value whichValue() => _SpeechAdaptation_AdaptationPhraseSet_ValueByTag[$_whichOneof(0)]!;
  ...
  @$pb.TagNumber(1)
  set phraseSet($core.String v) { $_setString(0, v); }
  @$pb.TagNumber(1)
  ...
  @$pb.TagNumber(2)
  set inlinePhraseSet(PhraseSet v) { setField(2, v); }
  @$pb.TagNumber(2)
...
class SpeechAdaptation extends $pb.GeneratedMessage {
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(_omitMessageNames ? '' : 'SpeechAdaptation', package: const $pb.PackageName(_omitMessageNames ? '' : 'google.cloud.speech.v2'), createEmptyInstance: create)
    ..pc<SpeechAdaptation_AdaptationPhraseSet>(1, _omitFieldNames ? '' : 'phraseSets', $pb.PbFieldType.PM, subBuilder: SpeechAdaptation_AdaptationPhraseSet.create)
    ..pc<CustomClass>(2, _omitFieldNames ? '' : 'customClasses', $pb.PbFieldType.PM, subBuilder: CustomClass.create)
    ..hasRequiredFields = false
  ;
  ...
  @$pb.TagNumber(1)
  $core.List<SpeechAdaptation_AdaptationPhraseSet> get phraseSets => $_getList(0);
...
class RecognitionConfig extends $pb.GeneratedMessage {
  ...
  static const $core.Map<$core.int, RecognitionConfig_DecodingConfig> _RecognitionConfig_DecodingConfigByTag = {
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(_omitMessageNames ? '' : 'RecognitionConfig', package: const $pb.PackageName(_omitMessageNames ? '' : 'google.cloud.speech.v2'), createEmptyInstance: create)
    ..oo(0, [7, 8])
    ..aOM<RecognitionFeatures>(2, _omitFieldNames ? '' : 'features', subBuilder: RecognitionFeatures.create)
    ..aOM<SpeechAdaptation>(6, _omitFieldNames ? '' : 'adaptation', subBuilder: SpeechAdaptation.create)
    ..aOM<AutoDetectDecodingConfig>(7, _omitFieldNames ? '' : 'autoDecodingConfig', subBuilder: AutoDetectDecodingConfig.create)
    ..aOM<ExplicitDecodingConfig>(8, _omitFieldNames ? '' : 'explicitDecodingConfig', subBuilder: ExplicitDecodingConfig.create)
    ..aOS(9, _omitFieldNames ? '' : 'model')
    ..pPS(10, _omitFieldNames ? '' : 'languageCodes')
    ..aOM<TranscriptNormalization>(11, _omitFieldNames ? '' : 'transcriptNormalization', subBuilder: TranscriptNormalization.create)
    ..aOM<TranslationConfig>(15, _omitFieldNames ? '' : 'translationConfig', subBuilder: TranslationConfig.create)
    ..hasRequiredFields = false
  ;
  ...
  RecognitionConfig_DecodingConfig whichDecodingConfig() => _RecognitionConfig_DecodingConfigByTag[$_whichOneof(0)]!;
  ...
  @$pb.TagNumber(2)
  set features(RecognitionFeatures v) { setField(2, v); }
  @$pb.TagNumber(2)
  ...
  @$pb.TagNumber(6)
  set adaptation(SpeechAdaptation v) { setField(6, v); }
  @$pb.TagNumber(6)
  ...
  @$pb.TagNumber(7)
  set autoDecodingConfig(AutoDetectDecodingConfig v) { setField(7, v); }
  @$pb.TagNumber(7)
  ...
  @$pb.TagNumber(8)
  set explicitDecodingConfig(ExplicitDecodingConfig v) { setField(8, v); }
  @$pb.TagNumber(8)
  ...
  @$pb.TagNumber(11)
  set transcriptNormalization(TranscriptNormalization v) { setField(11, v); }
  @$pb.TagNumber(11)
  $core.bool hasTranscriptNormalization() => $_has(6);
  @$pb.TagNumber(11)
  void clearTranscriptNormalization() => clearField(11);
  @$pb.TagNumber(11)
  ...
  @$pb.TagNumber(15)
  set translationConfig(TranslationConfig v) { setField(15, v); }
  @$pb.TagNumber(15)
  $core.bool hasTranslationConfig() => $_has(7);
  @$pb.TagNumber(15)
  void clearTranslationConfig() => clearField(15);
  @$pb.TagNumber(15)
  TranslationConfig ensureTranslationConfig() => $_ensure(7);
}

enum RecognizeRequest_AudioSource {
  content, 
  uri, 
  notSet
}
...
class RecognizeRequest extends $pb.GeneratedMessage {
  ...
  static const $core.Map<$core.int, RecognizeRequest_AudioSource> _RecognizeRequest_AudioSourceByTag = {
    5 : RecognizeRequest_AudioSource.content,
    6 : RecognizeRequest_AudioSource.uri,
    0 : RecognizeRequest_AudioSource.notSet
  };
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(_omitMessageNames ? '' : 'RecognizeRequest', package: const $pb.PackageName(_omitMessageNames ? '' : 'google.cloud.speech.v2'), createEmptyInstance: create)
    ..oo(0, [5, 6])
  ...
  RecognizeRequest_AudioSource whichAudioSource() => _RecognizeRequest_AudioSourceByTag[$_whichOneof(0)]!;
  ...
  @$pb.TagNumber(3)
  set recognizer($core.String v) { $_setString(1, v); }
  @$pb.TagNumber(3)
...
class RecognitionResponseMetadata extends $pb.GeneratedMessage {
  ...
  factory RecognitionResponseMetadata.fromBuffer($core.List<$core.int> i, [$pb.ExtensionRegistry r = $pb.ExtensionRegistry.EMPTY]) => create()..mergeFromBuffer(i, r);
  ...
  'Use [GeneratedMessageGenericExtensions.deepCopy] instead. '
  'Will be removed in next major version')
  RecognitionResponseMetadata clone() => RecognitionResponseMetadata()..mergeFromMessage(this);
  @$core.Deprecated(
  'Using this can add significant overhead to your binary. '
  'Use [GeneratedMessageGenericExtensions.rebuild] instead. '
  'Will be removed in next major version')
  RecognitionResponseMetadata copyWith(void Function(RecognitionResponseMetadata) updates) => super.copyWith((message) => updates(message as RecognitionResponseMetadata)) as RecognitionResponseMetadata;

  $pb.BuilderInfo get info_ => _i;

  @$core.pragma('dart2js:noInline')
  static RecognitionResponseMetadata create() => RecognitionResponseMetadata._();
  RecognitionResponseMetadata createEmptyInstance() => create();
  static $pb.PbList<RecognitionResponseMetadata> createRepeated() => $pb.PbList<RecognitionResponseMetadata>();
  @$core.pragma('dart2js:noInline')
  static RecognitionResponseMetadata getDefault() => _defaultInstance ??= $pb.GeneratedMessage.$_defaultFor<RecognitionResponseMetadata>(create);
...
class SpeechRecognitionAlternative extends $pb.GeneratedMessage {
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(_omitMessageNames ? '' : 'SpeechRecognitionAlternative', package: const $pb.PackageName(_omitMessageNames ? '' : 'google.cloud.speech.v2'), createEmptyInstance: create)
...
class WordInfo extends $pb.GeneratedMessage {
  ...
  @$pb.TagNumber(6)
  set speakerLabel($core.String v) { $_setString(4, v); }
  @$pb.TagNumber(6)
...
class RecognizeResponse extends $pb.GeneratedMessage {
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(_omitMessageNames ? '' : 'RecognizeResponse', package: const $pb.PackageName(_omitMessageNames ? '' : 'google.cloud.speech.v2'), createEmptyInstance: create)
    ..aOM<RecognitionResponseMetadata>(2, _omitFieldNames ? '' : 'metadata', subBuilder: RecognitionResponseMetadata.create)
    ..pc<SpeechRecognitionResult>(3, _omitFieldNames ? '' : 'results', $pb.PbFieldType.PM, subBuilder: SpeechRecognitionResult.create)
    ..hasRequiredFields = false
  ;
  ...
  @$pb.TagNumber(2)
  set metadata(RecognitionResponseMetadata v) { setField(2, v); }
  @$pb.TagNumber(2)
...
class StreamingRecognitionFeatures_VoiceActivityTimeout extends $pb.GeneratedMessage {
  ...
  factory StreamingRecognitionFeatures_VoiceActivityTimeout.fromBuffer($core.List<$core.int> i, [$pb.ExtensionRegistry r = $pb.ExtensionRegistry.EMPTY]) => create()..mergeFromBuffer(i, r);
  ...
  'Use [GeneratedMessageGenericExtensions.deepCopy] instead. '
  'Will be removed in next major version')
  StreamingRecognitionFeatures_VoiceActivityTimeout clone() => StreamingRecognitionFeatures_VoiceActivityTimeout()..mergeFromMessage(this);
  @$core.Deprecated(
  'Using this can add significant overhead to your binary. '
  'Use [GeneratedMessageGenericExtensions.rebuild] instead. '
  'Will be removed in next major version')
  StreamingRecognitionFeatures_VoiceActivityTimeout copyWith(void Function(StreamingRecognitionFeatures_VoiceActivityTimeout) updates) => super.copyWith((message) => updates(message as StreamingRecognitionFeatures_VoiceActivityTimeout)) as StreamingRecognitionFeatures_VoiceActivityTimeout;

  $pb.BuilderInfo get info_ => _i;

  @$core.pragma('dart2js:noInline')
  static StreamingRecognitionFeatures_VoiceActivityTimeout create() => StreamingRecognitionFeatures_VoiceActivityTimeout._();
  StreamingRecognitionFeatures_VoiceActivityTimeout createEmptyInstance() => create();
  static $pb.PbList<StreamingRecognitionFeatures_VoiceActivityTimeout> createRepeated() => $pb.PbList<StreamingRecognitionFeatures_VoiceActivityTimeout>();
  @$core.pragma('dart2js:noInline')
  static StreamingRecognitionFeatures_VoiceActivityTimeout getDefault() => _defaultInstance ??= $pb.GeneratedMessage.$_defaultFor<StreamingRecognitionFeatures_VoiceActivityTimeout>(create);
...
class StreamingRecognitionFeatures extends $pb.GeneratedMessage {
  ...
  factory StreamingRecognitionFeatures.fromBuffer($core.List<$core.int> i, [$pb.ExtensionRegistry r = $pb.ExtensionRegistry.EMPTY]) => create()..mergeFromBuffer(i, r);
  factory StreamingRecognitionFeatures.fromJson($core.String i, [$pb.ExtensionRegistry r = $pb.ExtensionRegistry.EMPTY]) => create()..mergeFromJson(i, r);

  static final $pb.BuilderInfo _i = $pb.BuilderInfo(_omitMessageNames ? '' : 'StreamingRecognitionFeatures', package: const $pb.PackageName(_omitMessageNames ? '' : 'google.cloud.speech.v2'), createEmptyInstance: create)
    ..aOB(1, _omitFieldNames ? '' : 'enableVoiceActivityEvents')
    ..aOB(2, _omitFieldNames ? '' : 'interimResults')
    ..aOM<StreamingRecognitionFeatures_VoiceActivityTimeout>(3, _omitFieldNames ? '' : 'voiceActivityTimeout', subBuilder: StreamingRecognitionFeatures_VoiceActivityTimeout.create)
    ..hasRequiredFields = false
  ;
  ...
  'Use [GeneratedMessageGenericExtensions.deepCopy] instead. '
  'Will be removed in next major version')
  StreamingRecognitionFeatures clone() => StreamingRecognitionFeatures()..mergeFromMessage(this);
  @$core.Deprecated(
  'Using this can add significant overhead to your binary. '
  'Use [GeneratedMessageGenericExtensions.rebuild] instead. '
  'Will be removed in next major version')
  StreamingRecognitionFeatures copyWith(void Function(StreamingRecognitionFeatures) updates) => super.copyWith((message) => updates(message as StreamingRecognitionFeatures)) as StreamingRecognitionFeatures;

  $pb.BuilderInfo get info_ => _i;

  @$core.pragma('dart2js:noInline')
  static StreamingRecognitionFeatures create() => StreamingRecognitionFeatures._();
  StreamingRecognitionFeatures createEmptyInstance() => create();
  static $pb.PbList<StreamingRecognitionFeatures> createRepeated() => $pb.PbList<StreamingRecognitionFeatures>();
  @$core.pragma('dart2js:noInline')
  static StreamingRecognitionFeatures getDefault() => _defaultInstance ??= $pb.GeneratedMessage.$_defaultFor<StreamingRecognitionFeatures>(create);
  ...
  @$pb.TagNumber(1)
  set enableVoiceActivityEvents($core.bool v) { $_setBool(0, v); }
  @$pb.TagNumber(1)
  ...
  @$pb.TagNumber(3)
  StreamingRecognitionFeatures_VoiceActivityTimeout get voiceActivityTimeout => $_getN(2);
  @$pb.TagNumber(3)
  set voiceActivityTimeout(StreamingRecognitionFeatures_VoiceActivityTimeout v) { setField(3, v); }
  @$pb.TagNumber(3)
  $core.bool hasVoiceActivityTimeout() => $_has(2);
  @$pb.TagNumber(3)
  void clearVoiceActivityTimeout() => clearField(3);
  @$pb.TagNumber(3)
  StreamingRecognitionFeatures_VoiceActivityTimeout ensureVoiceActivityTimeout() => $_ensure(2);
}
...
class StreamingRecognitionConfig extends $pb.GeneratedMessage {
  ...
  @$pb.TagNumber(2)
  set streamingFeatures(StreamingRecognitionFeatures v) { setField(2, v); }
  @$pb.TagNumber(2)
...
class StreamingRecognizeRequest extends $pb.GeneratedMessage {
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(_omitMessageNames ? '' : 'StreamingRecognizeRequest', package: const $pb.PackageName(_omitMessageNames ? '' : 'google.cloud.speech.v2'), createEmptyInstance: create)
    ..oo(0, [5, 6])
    ..aOS(3, _omitFieldNames ? '' : 'recognizer')
    ..a<$core.List<$core.int>>(5, _omitFieldNames ? '' : 'audio', $pb.PbFieldType.OY)
    ..aOM<StreamingRecognitionConfig>(6, _omitFieldNames ? '' : 'streamingConfig', subBuilder: StreamingRecognitionConfig.create)
    ..hasRequiredFields = false
  ;
  ...
  @$pb.TagNumber(3)
  set recognizer($core.String v) { $_setString(0, v); }
  @$pb.TagNumber(3)
  $core.bool hasRecognizer() => $_has(0);
  @$pb.TagNumber(3)
  void clearRecognizer() => clearField(3);
  ...
  @$pb.TagNumber(6)
  set streamingConfig(StreamingRecognitionConfig v) { setField(6, v); }
  @$pb.TagNumber(6)
...
class BatchRecognizeRequest extends $pb.GeneratedMessage {
  ...
  factory BatchRecognizeRequest.fromBuffer($core.List<$core.int> i, [$pb.ExtensionRegistry r = $pb.ExtensionRegistry.EMPTY]) => create()..mergeFromBuffer(i, r);
  factory BatchRecognizeRequest.fromJson($core.String i, [$pb.ExtensionRegistry r = $pb.ExtensionRegistry.EMPTY]) => create()..mergeFromJson(i, r);

  static final $pb.BuilderInfo _i = $pb.BuilderInfo(_omitMessageNames ? '' : 'BatchRecognizeRequest', package: const $pb.PackageName(_omitMessageNames ? '' : 'google.cloud.speech.v2'), createEmptyInstance: create)
  ...
  'Use [GeneratedMessageGenericExtensions.deepCopy] instead. '
  'Will be removed in next major version')
  BatchRecognizeRequest clone() => BatchRecognizeRequest()..mergeFromMessage(this);
  @$core.Deprecated(
  'Using this can add significant overhead to your binary. '
  'Use [GeneratedMessageGenericExtensions.rebuild] instead. '
  'Will be removed in next major version')
  BatchRecognizeRequest copyWith(void Function(BatchRecognizeRequest) updates) => super.copyWith((message) => updates(message as BatchRecognizeRequest)) as BatchRecognizeRequest;
  ...
  static $pb.PbList<BatchRecognizeRequest> createRepeated() => $pb.PbList<BatchRecognizeRequest>();
  @$core.pragma('dart2js:noInline')
  static BatchRecognizeRequest getDefault() => _defaultInstance ??= $pb.GeneratedMessage.$_defaultFor<BatchRecognizeRequest>(create);
  ...
  @$pb.TagNumber(4)
  set config(RecognitionConfig v) { setField(4, v); }
  @$pb.TagNumber(4)
  ...
  @$pb.TagNumber(6)
  set recognitionOutputConfig(RecognitionOutputConfig v) { setField(6, v); }
  @$pb.TagNumber(6)
  ...
  @$pb.TagNumber(7)
  set processingStrategy(BatchRecognizeRequest_ProcessingStrategy v) { setField(7, v); }
  @$pb.TagNumber(7)
...
class GcsOutputConfig extends $pb.GeneratedMessage {
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(_omitMessageNames ? '' : 'GcsOutputConfig', package: const $pb.PackageName(_omitMessageNames ? '' : 'google.cloud.speech.v2'), createEmptyInstance: create)
...
class InlineOutputConfig extends $pb.GeneratedMessage {
  ...
  factory InlineOutputConfig.fromBuffer($core.List<$core.int> i, [$pb.ExtensionRegistry r = $pb.ExtensionRegistry.EMPTY]) => create()..mergeFromBuffer(i, r);
  factory InlineOutputConfig.fromJson($core.String i, [$pb.ExtensionRegistry r = $pb.ExtensionRegistry.EMPTY]) => create()..mergeFromJson(i, r);

  static final $pb.BuilderInfo _i = $pb.BuilderInfo(_omitMessageNames ? '' : 'InlineOutputConfig', package: const $pb.PackageName(_omitMessageNames ? '' : 'google.cloud.speech.v2'), createEmptyInstance: create)
    ..hasRequiredFields = false
  ;
  ...
  'Use [GeneratedMessageGenericExtensions.rebuild] instead. '
  'Will be removed in next major version')
  InlineOutputConfig copyWith(void Function(InlineOutputConfig) updates) => super.copyWith((message) => updates(message as InlineOutputConfig)) as InlineOutputConfig;
  ...
  static $pb.PbList<InlineOutputConfig> createRepeated() => $pb.PbList<InlineOutputConfig>();
  @$core.pragma('dart2js:noInline')
  static InlineOutputConfig getDefault() => _defaultInstance ??= $pb.GeneratedMessage.$_defaultFor<InlineOutputConfig>(create);
...
class NativeOutputFileFormatConfig extends $pb.GeneratedMessage {
  ...
  factory NativeOutputFileFormatConfig.fromBuffer($core.List<$core.int> i, [$pb.ExtensionRegistry r = $pb.ExtensionRegistry.EMPTY]) => create()..mergeFromBuffer(i, r);
  factory NativeOutputFileFormatConfig.fromJson($core.String i, [$pb.ExtensionRegistry r = $pb.ExtensionRegistry.EMPTY]) => create()..mergeFromJson(i, r);

  static final $pb.BuilderInfo _i = $pb.BuilderInfo(_omitMessageNames ? '' : 'NativeOutputFileFormatConfig', package: const $pb.PackageName(_omitMessageNames ? '' : 'google.cloud.speech.v2'), createEmptyInstance: create)
    ..hasRequiredFields = false
  ;
  ...
  'Use [GeneratedMessageGenericExtensions.deepCopy] instead. '
  'Will be removed in next major version')
  NativeOutputFileFormatConfig clone() => NativeOutputFileFormatConfig()..mergeFromMessage(this);
  @$core.Deprecated(
  'Using this can add significant overhead to your binary. '
  'Use [GeneratedMessageGenericExtensions.rebuild] instead. '
  'Will be removed in next major version')
  NativeOutputFileFormatConfig copyWith(void Function(NativeOutputFileFormatConfig) updates) => super.copyWith((message) => updates(message as NativeOutputFileFormatConfig)) as NativeOutputFileFormatConfig;

  $pb.BuilderInfo get info_ => _i;

  @$core.pragma('dart2js:noInline')
  static NativeOutputFileFormatConfig create() => NativeOutputFileFormatConfig._();
  NativeOutputFileFormatConfig createEmptyInstance() => create();
  static $pb.PbList<NativeOutputFileFormatConfig> createRepeated() => $pb.PbList<NativeOutputFileFormatConfig>();
  @$core.pragma('dart2js:noInline')
  static NativeOutputFileFormatConfig getDefault() => _defaultInstance ??= $pb.GeneratedMessage.$_defaultFor<NativeOutputFileFormatConfig>(create);
...
class VttOutputFileFormatConfig extends $pb.GeneratedMessage {
  ...
  factory VttOutputFileFormatConfig.fromBuffer($core.List<$core.int> i, [$pb.ExtensionRegistry r = $pb.ExtensionRegistry.EMPTY]) => create()..mergeFromBuffer(i, r);
  factory VttOutputFileFormatConfig.fromJson($core.String i, [$pb.ExtensionRegistry r = $pb.ExtensionRegistry.EMPTY]) => create()..mergeFromJson(i, r);

  static final $pb.BuilderInfo _i = $pb.BuilderInfo(_omitMessageNames ? '' : 'VttOutputFileFormatConfig', package: const $pb.PackageName(_omitMessageNames ? '' : 'google.cloud.speech.v2'), createEmptyInstance: create)
    ..hasRequiredFields = false
  ;
  ...
  'Use [GeneratedMessageGenericExtensions.deepCopy] instead. '
  'Will be removed in next major version')
  VttOutputFileFormatConfig clone() => VttOutputFileFormatConfig()..mergeFromMessage(this);
  @$core.Deprecated(
  'Using this can add significant overhead to your binary. '
  'Use [GeneratedMessageGenericExtensions.rebuild] instead. '
  'Will be removed in next major version')
  VttOutputFileFormatConfig copyWith(void Function(VttOutputFileFormatConfig) updates) => super.copyWith((message) => updates(message as VttOutputFileFormatConfig)) as VttOutputFileFormatConfig;
  ...
  static $pb.PbList<VttOutputFileFormatConfig> createRepeated() => $pb.PbList<VttOutputFileFormatConfig>();
  @$core.pragma('dart2js:noInline')
  static VttOutputFileFormatConfig getDefault() => _defaultInstance ??= $pb.GeneratedMessage.$_defaultFor<VttOutputFileFormatConfig>(create);
...
class SrtOutputFileFormatConfig extends $pb.GeneratedMessage {
  ...
  factory SrtOutputFileFormatConfig.fromBuffer($core.List<$core.int> i, [$pb.ExtensionRegistry r = $pb.ExtensionRegistry.EMPTY]) => create()..mergeFromBuffer(i, r);
  factory SrtOutputFileFormatConfig.fromJson($core.String i, [$pb.ExtensionRegistry r = $pb.ExtensionRegistry.EMPTY]) => create()..mergeFromJson(i, r);

  static final $pb.BuilderInfo _i = $pb.BuilderInfo(_omitMessageNames ? '' : 'SrtOutputFileFormatConfig', package: const $pb.PackageName(_omitMessageNames ? '' : 'google.cloud.speech.v2'), createEmptyInstance: create)
    ..hasRequiredFields = false
  ;
  ...
  'Use [GeneratedMessageGenericExtensions.deepCopy] instead. '
  'Will be removed in next major version')
  SrtOutputFileFormatConfig clone() => SrtOutputFileFormatConfig()..mergeFromMessage(this);
  @$core.Deprecated(
  'Using this can add significant overhead to your binary. '
  'Use [GeneratedMessageGenericExtensions.rebuild] instead. '
  'Will be removed in next major version')
  SrtOutputFileFormatConfig copyWith(void Function(SrtOutputFileFormatConfig) updates) => super.copyWith((message) => updates(message as SrtOutputFileFormatConfig)) as SrtOutputFileFormatConfig;
  ...
  static $pb.PbList<SrtOutputFileFormatConfig> createRepeated() => $pb.PbList<SrtOutputFileFormatConfig>();
  @$core.pragma('dart2js:noInline')
  static SrtOutputFileFormatConfig getDefault() => _defaultInstance ??= $pb.GeneratedMessage.$_defaultFor<SrtOutputFileFormatConfig>(create);
...
class OutputFormatConfig extends $pb.GeneratedMessage {
  ...
  factory OutputFormatConfig.fromBuffer($core.List<$core.int> i, [$pb.ExtensionRegistry r = $pb.ExtensionRegistry.EMPTY]) => create()..mergeFromBuffer(i, r);
  factory OutputFormatConfig.fromJson($core.String i, [$pb.ExtensionRegistry r = $pb.ExtensionRegistry.EMPTY]) => create()..mergeFromJson(i, r);

  static final $pb.BuilderInfo _i = $pb.BuilderInfo(_omitMessageNames ? '' : 'OutputFormatConfig', package: const $pb.PackageName(_omitMessageNames ? '' : 'google.cloud.speech.v2'), createEmptyInstance: create)
    ..aOM<NativeOutputFileFormatConfig>(1, _omitFieldNames ? '' : 'native', subBuilder: NativeOutputFileFormatConfig.create)
    ..aOM<VttOutputFileFormatConfig>(2, _omitFieldNames ? '' : 'vtt', subBuilder: VttOutputFileFormatConfig.create)
    ..aOM<SrtOutputFileFormatConfig>(3, _omitFieldNames ? '' : 'srt', subBuilder: SrtOutputFileFormatConfig.create)
    ..hasRequiredFields = false
  ;
  ...
  'Use [GeneratedMessageGenericExtensions.rebuild] instead. '
  'Will be removed in next major version')
  OutputFormatConfig copyWith(void Function(OutputFormatConfig) updates) => super.copyWith((message) => updates(message as OutputFormatConfig)) as OutputFormatConfig;
  ...
  static $pb.PbList<OutputFormatConfig> createRepeated() => $pb.PbList<OutputFormatConfig>();
  @$core.pragma('dart2js:noInline')
  static OutputFormatConfig getDefault() => _defaultInstance ??= $pb.GeneratedMessage.$_defaultFor<OutputFormatConfig>(create);
  ...
  @$pb.TagNumber(1)
  set native(NativeOutputFileFormatConfig v) { setField(1, v); }
  @$pb.TagNumber(1)
  ...
  @$pb.TagNumber(2)
  set vtt(VttOutputFileFormatConfig v) { setField(2, v); }
  @$pb.TagNumber(2)
  $core.bool hasVtt() => $_has(1);
  @$pb.TagNumber(2)
  void clearVtt() => clearField(2);
  @$pb.TagNumber(2)
  ...
  @$pb.TagNumber(3)
  set srt(SrtOutputFileFormatConfig v) { setField(3, v); }
  @$pb.TagNumber(3)
  $core.bool hasSrt() => $_has(2);
  @$pb.TagNumber(3)
  void clearSrt() => clearField(3);
  @$pb.TagNumber(3)
...
class RecognitionOutputConfig extends $pb.GeneratedMessage {
  ...
  factory RecognitionOutputConfig.fromBuffer($core.List<$core.int> i, [$pb.ExtensionRegistry r = $pb.ExtensionRegistry.EMPTY]) => create()..mergeFromBuffer(i, r);
  factory RecognitionOutputConfig.fromJson($core.String i, [$pb.ExtensionRegistry r = $pb.ExtensionRegistry.EMPTY]) => create()..mergeFromJson(i, r);

  static const $core.Map<$core.int, RecognitionOutputConfig_Output> _RecognitionOutputConfig_OutputByTag = {
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(_omitMessageNames ? '' : 'RecognitionOutputConfig', package: const $pb.PackageName(_omitMessageNames ? '' : 'google.cloud.speech.v2'), createEmptyInstance: create)
    ..oo(0, [1, 2])
    ..aOM<GcsOutputConfig>(1, _omitFieldNames ? '' : 'gcsOutputConfig', subBuilder: GcsOutputConfig.create)
    ..aOM<InlineOutputConfig>(2, _omitFieldNames ? '' : 'inlineResponseConfig', subBuilder: InlineOutputConfig.create)
    ..aOM<OutputFormatConfig>(3, _omitFieldNames ? '' : 'outputFormatConfig', subBuilder: OutputFormatConfig.create)
    ..hasRequiredFields = false
  ;
  ...
  'Use [GeneratedMessageGenericExtensions.deepCopy] instead. '
  'Will be removed in next major version')
  RecognitionOutputConfig clone() => RecognitionOutputConfig()..mergeFromMessage(this);
  @$core.Deprecated(
  'Using this can add significant overhead to your binary. '
  'Use [GeneratedMessageGenericExtensions.rebuild] instead. '
  'Will be removed in next major version')
  RecognitionOutputConfig copyWith(void Function(RecognitionOutputConfig) updates) => super.copyWith((message) => updates(message as RecognitionOutputConfig)) as RecognitionOutputConfig;
  ...
  static $pb.PbList<RecognitionOutputConfig> createRepeated() => $pb.PbList<RecognitionOutputConfig>();
  @$core.pragma('dart2js:noInline')
  static RecognitionOutputConfig getDefault() => _defaultInstance ??= $pb.GeneratedMessage.$_defaultFor<RecognitionOutputConfig>(create);
  static RecognitionOutputConfig? _defaultInstance;

  RecognitionOutputConfig_Output whichOutput() => _RecognitionOutputConfig_OutputByTag[$_whichOneof(0)]!;
  ...
  @$pb.TagNumber(1)
  set gcsOutputConfig(GcsOutputConfig v) { setField(1, v); }
  @$pb.TagNumber(1)
  ...
  @$pb.TagNumber(2)
  set inlineResponseConfig(InlineOutputConfig v) { setField(2, v); }
  @$pb.TagNumber(2)
  ...
  @$pb.TagNumber(3)
  set outputFormatConfig(OutputFormatConfig v) { setField(3, v); }
  @$pb.TagNumber(3)
  $core.bool hasOutputFormatConfig() => $_has(2);
  @$pb.TagNumber(3)
  void clearOutputFormatConfig() => clearField(3);
  @$pb.TagNumber(3)
...
class BatchRecognizeResponse extends $pb.GeneratedMessage {
  ...
  factory BatchRecognizeResponse.fromBuffer($core.List<$core.int> i, [$pb.ExtensionRegistry r = $pb.ExtensionRegistry.EMPTY]) => create()..mergeFromBuffer(i, r);
  factory BatchRecognizeResponse.fromJson($core.String i, [$pb.ExtensionRegistry r = $pb.ExtensionRegistry.EMPTY]) => create()..mergeFromJson(i, r);
  ...
  'Use [GeneratedMessageGenericExtensions.deepCopy] instead. '
  'Will be removed in next major version')
  BatchRecognizeResponse clone() => BatchRecognizeResponse()..mergeFromMessage(this);
  @$core.Deprecated(
  'Using this can add significant overhead to your binary. '
  'Use [GeneratedMessageGenericExtensions.rebuild] instead. '
  'Will be removed in next major version')
  BatchRecognizeResponse copyWith(void Function(BatchRecognizeResponse) updates) => super.copyWith((message) => updates(message as BatchRecognizeResponse)) as BatchRecognizeResponse;
  ...
  static $pb.PbList<BatchRecognizeResponse> createRepeated() => $pb.PbList<BatchRecognizeResponse>();
  @$core.pragma('dart2js:noInline')
  static BatchRecognizeResponse getDefault() => _defaultInstance ??= $pb.GeneratedMessage.$_defaultFor<BatchRecognizeResponse>(create);
...
class BatchRecognizeResults extends $pb.GeneratedMessage {
  ...
  factory BatchRecognizeResults.fromBuffer($core.List<$core.int> i, [$pb.ExtensionRegistry r = $pb.ExtensionRegistry.EMPTY]) => create()..mergeFromBuffer(i, r);
  factory BatchRecognizeResults.fromJson($core.String i, [$pb.ExtensionRegistry r = $pb.ExtensionRegistry.EMPTY]) => create()..mergeFromJson(i, r);

  static final $pb.BuilderInfo _i = $pb.BuilderInfo(_omitMessageNames ? '' : 'BatchRecognizeResults', package: const $pb.PackageName(_omitMessageNames ? '' : 'google.cloud.speech.v2'), createEmptyInstance: create)
    ..pc<SpeechRecognitionResult>(1, _omitFieldNames ? '' : 'results', $pb.PbFieldType.PM, subBuilder: SpeechRecognitionResult.create)
    ..aOM<RecognitionResponseMetadata>(2, _omitFieldNames ? '' : 'metadata', subBuilder: RecognitionResponseMetadata.create)
    ..hasRequiredFields = false
  ;
  ...
  'Use [GeneratedMessageGenericExtensions.deepCopy] instead. '
  'Will be removed in next major version')
  BatchRecognizeResults clone() => BatchRecognizeResults()..mergeFromMessage(this);
  @$core.Deprecated(
  'Using this can add significant overhead to your binary. '
  'Use [GeneratedMessageGenericExtensions.rebuild] instead. '
  'Will be removed in next major version')
  BatchRecognizeResults copyWith(void Function(BatchRecognizeResults) updates) => super.copyWith((message) => updates(message as BatchRecognizeResults)) as BatchRecognizeResults;
  ...
  static $pb.PbList<BatchRecognizeResults> createRepeated() => $pb.PbList<BatchRecognizeResults>();
  @$core.pragma('dart2js:noInline')
  static BatchRecognizeResults getDefault() => _defaultInstance ??= $pb.GeneratedMessage.$_defaultFor<BatchRecognizeResults>(create);
...
class CloudStorageResult extends $pb.GeneratedMessage {
  ...
  factory CloudStorageResult.fromBuffer($core.List<$core.int> i, [$pb.ExtensionRegistry r = $pb.ExtensionRegistry.EMPTY]) => create()..mergeFromBuffer(i, r);
  factory CloudStorageResult.fromJson($core.String i, [$pb.ExtensionRegistry r = $pb.ExtensionRegistry.EMPTY]) => create()..mergeFromJson(i, r);

  static final $pb.BuilderInfo _i = $pb.BuilderInfo(_omitMessageNames ? '' : 'CloudStorageResult', package: const $pb.PackageName(_omitMessageNames ? '' : 'google.cloud.speech.v2'), createEmptyInstance: create)
    ..aOS(1, _omitFieldNames ? '' : 'uri')
  ...
  'Use [GeneratedMessageGenericExtensions.rebuild] instead. '
  'Will be removed in next major version')
  CloudStorageResult copyWith(void Function(CloudStorageResult) updates) => super.copyWith((message) => updates(message as CloudStorageResult)) as CloudStorageResult;
  ...
  static $pb.PbList<CloudStorageResult> createRepeated() => $pb.PbList<CloudStorageResult>();
  @$core.pragma('dart2js:noInline')
  static CloudStorageResult getDefault() => _defaultInstance ??= $pb.GeneratedMessage.$_defaultFor<CloudStorageResult>(create);
  ...
  @$pb.TagNumber(2)
  set vttFormatUri($core.String v) { $_setString(1, v); }
  @$pb.TagNumber(2)
  $core.bool hasVttFormatUri() => $_has(1);
  @$pb.TagNumber(2)
  void clearVttFormatUri() => clearField(2);
  ...
  @$pb.TagNumber(3)
  set srtFormatUri($core.String v) { $_setString(2, v); }
  @$pb.TagNumber(3)
  $core.bool hasSrtFormatUri() => $_has(2);
  @$pb.TagNumber(3)
  void clearSrtFormatUri() => clearField(3);
}
...
class InlineResult extends $pb.GeneratedMessage {
  ...
  factory InlineResult.fromBuffer($core.List<$core.int> i, [$pb.ExtensionRegistry r = $pb.ExtensionRegistry.EMPTY]) => create()..mergeFromBuffer(i, r);
  factory InlineResult.fromJson($core.String i, [$pb.ExtensionRegistry r = $pb.ExtensionRegistry.EMPTY]) => create()..mergeFromJson(i, r);

  static final $pb.BuilderInfo _i = $pb.BuilderInfo(_omitMessageNames ? '' : 'InlineResult', package: const $pb.PackageName(_omitMessageNames ? '' : 'google.cloud.speech.v2'), createEmptyInstance: create)
    ..aOM<BatchRecognizeResults>(1, _omitFieldNames ? '' : 'transcript', subBuilder: BatchRecognizeResults.create)
  ...
  'Use [GeneratedMessageGenericExtensions.rebuild] instead. '
  'Will be removed in next major version')
  InlineResult copyWith(void Function(InlineResult) updates) => super.copyWith((message) => updates(message as InlineResult)) as InlineResult;
  ...
  static $pb.PbList<InlineResult> createRepeated() => $pb.PbList<InlineResult>();
  @$core.pragma('dart2js:noInline')
  static InlineResult getDefault() => _defaultInstance ??= $pb.GeneratedMessage.$_defaultFor<InlineResult>(create);
  ...
  @$pb.TagNumber(1)
  set transcript(BatchRecognizeResults v) { setField(1, v); }
  @$pb.TagNumber(1)
  $core.bool hasTranscript() => $_has(0);
  @$pb.TagNumber(1)
  void clearTranscript() => clearField(1);
  ...
  @$pb.TagNumber(2)
  set vttCaptions($core.String v) { $_setString(1, v); }
  @$pb.TagNumber(2)
  $core.bool hasVttCaptions() => $_has(1);
  @$pb.TagNumber(2)
  void clearVttCaptions() => clearField(2);
  ...
  @$pb.TagNumber(3)
  set srtCaptions($core.String v) { $_setString(2, v); }
  @$pb.TagNumber(3)
  $core.bool hasSrtCaptions() => $_has(2);
  @$pb.TagNumber(3)
  void clearSrtCaptions() => clearField(3);
}
...
class BatchRecognizeFileResult extends $pb.GeneratedMessage {
  ...
  factory BatchRecognizeFileResult.fromBuffer($core.List<$core.int> i, [$pb.ExtensionRegistry r = $pb.ExtensionRegistry.EMPTY]) => create()..mergeFromBuffer(i, r);
  factory BatchRecognizeFileResult.fromJson($core.String i, [$pb.ExtensionRegistry r = $pb.ExtensionRegistry.EMPTY]) => create()..mergeFromJson(i, r);

  static const $core.Map<$core.int, BatchRecognizeFileResult_Result> _BatchRecognizeFileResult_ResultByTag = {
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(_omitMessageNames ? '' : 'BatchRecognizeFileResult', package: const $pb.PackageName(_omitMessageNames ? '' : 'google.cloud.speech.v2'), createEmptyInstance: create)
    ...
    ..aOM<InlineResult>(6, _omitFieldNames ? '' : 'inlineResult', subBuilder: InlineResult.create)
    ..hasRequiredFields = false
  ;
  ...
  'Use [GeneratedMessageGenericExtensions.deepCopy] instead. '
  'Will be removed in next major version')
  BatchRecognizeFileResult clone() => BatchRecognizeFileResult()..mergeFromMessage(this);
  @$core.Deprecated(
  'Using this can add significant overhead to your binary. '
  'Use [GeneratedMessageGenericExtensions.rebuild] instead. '
  'Will be removed in next major version')
  BatchRecognizeFileResult copyWith(void Function(BatchRecognizeFileResult) updates) => super.copyWith((message) => updates(message as BatchRecognizeFileResult)) as BatchRecognizeFileResult;
  ...
  static $pb.PbList<BatchRecognizeFileResult> createRepeated() => $pb.PbList<BatchRecognizeFileResult>();
  @$core.pragma('dart2js:noInline')
  static BatchRecognizeFileResult getDefault() => _defaultInstance ??= $pb.GeneratedMessage.$_defaultFor<BatchRecognizeFileResult>(create);
  static BatchRecognizeFileResult? _defaultInstance;

  BatchRecognizeFileResult_Result whichResult() => _BatchRecognizeFileResult_ResultByTag[$_whichOneof(0)]!;
  ...
  @$pb.TagNumber(3)
  set metadata(RecognitionResponseMetadata v) { setField(3, v); }
  @$pb.TagNumber(3)
  ...
  @$core.Deprecated('This field is deprecated.')
  @$pb.TagNumber(4)
  set transcript(BatchRecognizeResults v) { setField(4, v); }
  @$core.Deprecated('This field is deprecated.')
  @$pb.TagNumber(4)
  ...
  @$pb.TagNumber(5)
  set cloudStorageResult(CloudStorageResult v) { setField(5, v); }
  @$pb.TagNumber(5)
  $core.bool hasCloudStorageResult() => $_has(4);
  @$pb.TagNumber(5)
  void clearCloudStorageResult() => clearField(5);
  @$pb.TagNumber(5)
  ...
  @$pb.TagNumber(6)
  set inlineResult(InlineResult v) { setField(6, v); }
  @$pb.TagNumber(6)
  $core.bool hasInlineResult() => $_has(5);
  @$pb.TagNumber(6)
  void clearInlineResult() => clearField(6);
  @$pb.TagNumber(6)
...
class BatchRecognizeTranscriptionMetadata extends $pb.GeneratedMessage {
  ...
  factory BatchRecognizeTranscriptionMetadata.fromBuffer($core.List<$core.int> i, [$pb.ExtensionRegistry r = $pb.ExtensionRegistry.EMPTY]) => create()..mergeFromBuffer(i, r);
  factory BatchRecognizeTranscriptionMetadata.fromJson($core.String i, [$pb.ExtensionRegistry r = $pb.ExtensionRegistry.EMPTY]) => create()..mergeFromJson(i, r);
  ...
  'Use [GeneratedMessageGenericExtensions.deepCopy] instead. '
  'Will be removed in next major version')
  BatchRecognizeTranscriptionMetadata clone() => BatchRecognizeTranscriptionMetadata()..mergeFromMessage(this);
  @$core.Deprecated(
  'Using this can add significant overhead to your binary. '
  'Use [GeneratedMessageGenericExtensions.rebuild] instead. '
  'Will be removed in next major version')
  BatchRecognizeTranscriptionMetadata copyWith(void Function(BatchRecognizeTranscriptionMetadata) updates) => super.copyWith((message) => updates(message as BatchRecognizeTranscriptionMetadata)) as BatchRecognizeTranscriptionMetadata;

  $pb.BuilderInfo get info_ => _i;

  @$core.pragma('dart2js:noInline')
  static BatchRecognizeTranscriptionMetadata create() => BatchRecognizeTranscriptionMetadata._();
  BatchRecognizeTranscriptionMetadata createEmptyInstance() => create();
  static $pb.PbList<BatchRecognizeTranscriptionMetadata> createRepeated() => $pb.PbList<BatchRecognizeTranscriptionMetadata>();
  @$core.pragma('dart2js:noInline')
  static BatchRecognizeTranscriptionMetadata getDefault() => _defaultInstance ??= $pb.GeneratedMessage.$_defaultFor<BatchRecognizeTranscriptionMetadata>(create);
...
class BatchRecognizeMetadata extends $pb.GeneratedMessage {
  factory BatchRecognizeMetadata({
    $core.Map<$core.String, BatchRecognizeTranscriptionMetadata>? transcriptionMetadata,
  }) {
    final $result = create();
  ...
  factory BatchRecognizeMetadata.fromBuffer($core.List<$core.int> i, [$pb.ExtensionRegistry r = $pb.ExtensionRegistry.EMPTY]) => create()..mergeFromBuffer(i, r);
  factory BatchRecognizeMetadata.fromJson($core.String i, [$pb.ExtensionRegistry r = $pb.ExtensionRegistry.EMPTY]) => create()..mergeFromJson(i, r);

  static final $pb.BuilderInfo _i = $pb.BuilderInfo(_omitMessageNames ? '' : 'BatchRecognizeMetadata', package: const $pb.PackageName(_omitMessageNames ? '' : 'google.cloud.speech.v2'), createEmptyInstance: create)
    ..m<$core.String, BatchRecognizeTranscriptionMetadata>(1, _omitFieldNames ? '' : 'transcriptionMetadata', entryClassName: 'BatchRecognizeMetadata.TranscriptionMetadataEntry', keyFieldType: $pb.PbFieldType.OS, valueFieldType: $pb.PbFieldType.OM, valueCreator: BatchRecognizeTranscriptionMetadata.create, valueDefaultOrMaker: BatchRecognizeTranscriptionMetadata.getDefault, packageName: const $pb.PackageName('google.cloud.speech.v2'))
    ..hasRequiredFields = false
  ;
  ...
  'Use [GeneratedMessageGenericExtensions.deepCopy] instead. '
  'Will be removed in next major version')
  BatchRecognizeMetadata clone() => BatchRecognizeMetadata()..mergeFromMessage(this);
  @$core.Deprecated(
  'Using this can add significant overhead to your binary. '
  'Use [GeneratedMessageGenericExtensions.rebuild] instead. '
  'Will be removed in next major version')
  BatchRecognizeMetadata copyWith(void Function(BatchRecognizeMetadata) updates) => super.copyWith((message) => updates(message as BatchRecognizeMetadata)) as BatchRecognizeMetadata;
  ...
  static $pb.PbList<BatchRecognizeMetadata> createRepeated() => $pb.PbList<BatchRecognizeMetadata>();
  @$core.pragma('dart2js:noInline')
  static BatchRecognizeMetadata getDefault() => _defaultInstance ??= $pb.GeneratedMessage.$_defaultFor<BatchRecognizeMetadata>(create);
  static BatchRecognizeMetadata? _defaultInstance;

  /// Map from provided filename to the transcription metadata for that file.
  @$pb.TagNumber(1)
  $core.Map<$core.String, BatchRecognizeTranscriptionMetadata> get transcriptionMetadata => $_getMap(0);
}

enum BatchRecognizeFileMetadata_AudioSource {
  uri, 
  notSet
}
...
class BatchRecognizeFileMetadata extends $pb.GeneratedMessage {
  ...
  factory BatchRecognizeFileMetadata.fromBuffer($core.List<$core.int> i, [$pb.ExtensionRegistry r = $pb.ExtensionRegistry.EMPTY]) => create()..mergeFromBuffer(i, r);
  factory BatchRecognizeFileMetadata.fromJson($core.String i, [$pb.ExtensionRegistry r = $pb.ExtensionRegistry.EMPTY]) => create()..mergeFromJson(i, r);

  static const $core.Map<$core.int, BatchRecognizeFileMetadata_AudioSource> _BatchRecognizeFileMetadata_AudioSourceByTag = {
    1 : BatchRecognizeFileMetadata_AudioSource.uri,
    0 : BatchRecognizeFileMetadata_AudioSource.notSet
  };
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(_omitMessageNames ? '' : 'BatchRecognizeFileMetadata', package: const $pb.PackageName(_omitMessageNames ? '' : 'google.cloud.speech.v2'), createEmptyInstance: create)
    ..oo(0, [1])
    ..aOS(1, _omitFieldNames ? '' : 'uri')
    ..aOM<RecognitionConfig>(4, _omitFieldNames ? '' : 'config', subBuilder: RecognitionConfig.create)
    ..aOM<$2210.FieldMask>(5, _omitFieldNames ? '' : 'configMask', subBuilder: $2210.FieldMask.create)
  ...
  'Use [GeneratedMessageGenericExtensions.deepCopy] instead. '
  'Will be removed in next major version')
  BatchRecognizeFileMetadata clone() => BatchRecognizeFileMetadata()..mergeFromMessage(this);
  @$core.Deprecated(
  'Using this can add significant overhead to your binary. '
  'Use [GeneratedMessageGenericExtensions.rebuild] instead. '
  'Will be removed in next major version')
  BatchRecognizeFileMetadata copyWith(void Function(BatchRecognizeFileMetadata) updates) => super.copyWith((message) => updates(message as BatchRecognizeFileMetadata)) as BatchRecognizeFileMetadata;
  ...
  static $pb.PbList<BatchRecognizeFileMetadata> createRepeated() => $pb.PbList<BatchRecognizeFileMetadata>();
  @$core.pragma('dart2js:noInline')
  static BatchRecognizeFileMetadata getDefault() => _defaultInstance ??= $pb.GeneratedMessage.$_defaultFor<BatchRecognizeFileMetadata>(create);
  static BatchRecognizeFileMetadata? _defaultInstance;

  BatchRecognizeFileMetadata_AudioSource whichAudioSource() => _BatchRecognizeFileMetadata_AudioSourceByTag[$_whichOneof(0)]!;
  void clearAudioSource() => clearField($_whichOneof(0));
...
class StreamingRecognitionResult extends $pb.GeneratedMessage {
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(_omitMessageNames ? '' : 'StreamingRecognitionResult', package: const $pb.PackageName(_omitMessageNames ? '' : 'google.cloud.speech.v2'), createEmptyInstance: create)
    ..pc<SpeechRecognitionAlternative>(1, _omitFieldNames ? '' : 'alternatives', $pb.PbFieldType.PM, subBuilder: SpeechRecognitionAlternative.create)
...
class StreamingRecognizeResponse extends $pb.GeneratedMessage {
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(_omitMessageNames ? '' : 'StreamingRecognizeResponse', package: const $pb.PackageName(_omitMessageNames ? '' : 'google.cloud.speech.v2'), createEmptyInstance: create)
  ...
  @$pb.TagNumber(3)
  set speechEventType(StreamingRecognizeResponse_SpeechEventType v) { setField(3, v); }
  @$pb.TagNumber(3)
  ...
  RecognitionResponseMetadata get metadata => $_getN(1);
  @$pb.TagNumber(5)
  set metadata(RecognitionResponseMetadata v) { setField(5, v); }
  @$pb.TagNumber(5)
  $core.bool hasMetadata() => $_has(1);
  @$pb.TagNumber(5)
...
class GetConfigRequest extends $pb.GeneratedMessage {
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(_omitMessageNames ? '' : 'GetConfigRequest', package: const $pb.PackageName(_omitMessageNames ? '' : 'google.cloud.speech.v2'), createEmptyInstance: create)
    ..aOS(1, _omitFieldNames ? '' : 'name')
    ..hasRequiredFields = false
  ;
...
class CustomClass_ClassItem extends $pb.GeneratedMessage {
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(_omitMessageNames ? '' : 'CustomClass.ClassItem', package: const $pb.PackageName(_omitMessageNames ? '' : 'google.cloud.speech.v2'), createEmptyInstance: create)
...
class CustomClass extends $pb.GeneratedMessage {
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(_omitMessageNames ? '' : 'CustomClass', package: const $pb.PackageName(_omitMessageNames ? '' : 'google.cloud.speech.v2'), createEmptyInstance: create)
    ..aOS(1, _omitFieldNames ? '' : 'name')
    ..aOS(2, _omitFieldNames ? '' : 'uid')
    ...
    ..e<CustomClass_State>(15, _omitFieldNames ? '' : 'state', $pb.PbFieldType.OE, defaultOrMaker: CustomClass_State.STATE_UNSPECIFIED, valueOf: CustomClass_State.valueOf, enumValues: CustomClass_State.values)
    ..hasRequiredFields = false
  ;
  ...
  @$pb.TagNumber(14)
  set kmsKeyVersionName($core.String v) { $_setString(12, v); }
  @$pb.TagNumber(14)
  ...
  @$pb.TagNumber(15)
  set state(CustomClass_State v) { setField(15, v); }
  @$pb.TagNumber(15)
...
class PhraseSet_Phrase extends $pb.GeneratedMessage {
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(_omitMessageNames ? '' : 'PhraseSet.Phrase', package: const $pb.PackageName(_omitMessageNames ? '' : 'google.cloud.speech.v2'), createEmptyInstance: create)
    ..aOS(1, _omitFieldNames ? '' : 'value')
...
class PhraseSet extends $pb.GeneratedMessage {
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(_omitMessageNames ? '' : 'PhraseSet', package: const $pb.PackageName(_omitMessageNames ? '' : 'google.cloud.speech.v2'), createEmptyInstance: create)
    ..aOS(1, _omitFieldNames ? '' : 'name')
    ..aOS(2, _omitFieldNames ? '' : 'uid')
    ...
    ..aOS(13, _omitFieldNames ? '' : 'kmsKeyName')
    ..aOS(14, _omitFieldNames ? '' : 'kmsKeyVersionName')
    ..e<PhraseSet_State>(15, _omitFieldNames ? '' : 'state', $pb.PbFieldType.OE, defaultOrMaker: PhraseSet_State.STATE_UNSPECIFIED, valueOf: PhraseSet_State.valueOf, enumValues: PhraseSet_State.values)
    ..hasRequiredFields = false
  ;
  ...
  @$pb.TagNumber(4)
  set boost($core.double v) { $_setFloat(3, v); }
  @$pb.TagNumber(4)
  ...
  @$pb.TagNumber(14)
  set kmsKeyVersionName($core.String v) { $_setString(13, v); }
  @$pb.TagNumber(14)
  ...
  @$pb.TagNumber(15)
  set state(PhraseSet_State v) { setField(15, v); }
  @$pb.TagNumber(15)
...
class CreateCustomClassRequest extends $pb.GeneratedMessage {
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(_omitMessageNames ? '' : 'CreateCustomClassRequest', package: const $pb.PackageName(_omitMessageNames ? '' : 'google.cloud.speech.v2'), createEmptyInstance: create)
  ...
  @$pb.TagNumber(1)
  set customClass(CustomClass v) { setField(1, v); }
  @$pb.TagNumber(1)
  ...
  @$pb.TagNumber(3)
  set customClassId($core.String v) { $_setString(2, v); }
  @$pb.TagNumber(3)
...
class ListCustomClassesRequest extends $pb.GeneratedMessage {
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(_omitMessageNames ? '' : 'ListCustomClassesRequest', package: const $pb.PackageName(_omitMessageNames ? '' : 'google.cloud.speech.v2'), createEmptyInstance: create)
    ..aOS(1, _omitFieldNames ? '' : 'parent')
    ..a<$core.int>(2, _omitFieldNames ? '' : 'pageSize', $pb.PbFieldType.O3)
    ..aOS(3, _omitFieldNames ? '' : 'pageToken')
    ..aOB(4, _omitFieldNames ? '' : 'showDeleted')
...
class ListCustomClassesResponse extends $pb.GeneratedMessage {
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(_omitMessageNames ? '' : 'ListCustomClassesResponse', package: const $pb.PackageName(_omitMessageNames ? '' : 'google.cloud.speech.v2'), createEmptyInstance: create)
    ..pc<CustomClass>(1, _omitFieldNames ? '' : 'customClasses', $pb.PbFieldType.PM, subBuilder: CustomClass.create)
    ..aOS(2, _omitFieldNames ? '' : 'nextPageToken')
    ..hasRequiredFields = false
  ;
...
class GetCustomClassRequest extends $pb.GeneratedMessage {
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(_omitMessageNames ? '' : 'GetCustomClassRequest', package: const $pb.PackageName(_omitMessageNames ? '' : 'google.cloud.speech.v2'), createEmptyInstance: create)
    ..aOS(1, _omitFieldNames ? '' : 'name')
    ..hasRequiredFields = false
  ;
...
class DeleteCustomClassRequest extends $pb.GeneratedMessage {
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(_omitMessageNames ? '' : 'DeleteCustomClassRequest', package: const $pb.PackageName(_omitMessageNames ? '' : 'google.cloud.speech.v2'), createEmptyInstance: create)
    ..aOS(1, _omitFieldNames ? '' : 'name')
    ..aOB(2, _omitFieldNames ? '' : 'validateOnly')
    ..aOS(3, _omitFieldNames ? '' : 'etag')
    ..aOB(4, _omitFieldNames ? '' : 'allowMissing')
...
class UndeleteCustomClassRequest extends $pb.GeneratedMessage {
  ...
  factory UndeleteCustomClassRequest.fromBuffer($core.List<$core.int> i, [$pb.ExtensionRegistry r = $pb.ExtensionRegistry.EMPTY]) => create()..mergeFromBuffer(i, r);
  factory UndeleteCustomClassRequest.fromJson($core.String i, [$pb.ExtensionRegistry r = $pb.ExtensionRegistry.EMPTY]) => create()..mergeFromJson(i, r);

  static final $pb.BuilderInfo _i = $pb.BuilderInfo(_omitMessageNames ? '' : 'UndeleteCustomClassRequest', package: const $pb.PackageName(_omitMessageNames ? '' : 'google.cloud.speech.v2'), createEmptyInstance: create)
    ..aOS(1, _omitFieldNames ? '' : 'name')
    ..aOB(3, _omitFieldNames ? '' : 'validateOnly')
    ..aOS(4, _omitFieldNames ? '' : 'etag')
    ..hasRequiredFields = false
  ...
  'Use [GeneratedMessageGenericExtensions.deepCopy] instead. '
  'Will be removed in next major version')
  UndeleteCustomClassRequest clone() => UndeleteCustomClassRequest()..mergeFromMessage(this);
  @$core.Deprecated(
  'Using this can add significant overhead to your binary. '
  'Use [GeneratedMessageGenericExtensions.rebuild] instead. '
  'Will be removed in next major version')
  UndeleteCustomClassRequest copyWith(void Function(UndeleteCustomClassRequest) updates) => super.copyWith((message) => updates(message as UndeleteCustomClassRequest)) as UndeleteCustomClassRequest;
  ...
  static $pb.PbList<UndeleteCustomClassRequest> createRepeated() => $pb.PbList<UndeleteCustomClassRequest>();
  @$core.pragma('dart2js:noInline')
  static UndeleteCustomClassRequest getDefault() => _defaultInstance ??= $pb.GeneratedMessage.$_defaultFor<UndeleteCustomClassRequest>(create);
...
class CreatePhraseSetRequest extends $pb.GeneratedMessage {
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(_omitMessageNames ? '' : 'CreatePhraseSetRequest', package: const $pb.PackageName(_omitMessageNames ? '' : 'google.cloud.speech.v2'), createEmptyInstance: create)
  ...
  @$pb.TagNumber(1)
  set phraseSet(PhraseSet v) { setField(1, v); }
  @$pb.TagNumber(1)
  $core.bool hasPhraseSet() => $_has(0);
  @$pb.TagNumber(1)
  void clearPhraseSet() => clearField(1);
  ...
  @$pb.TagNumber(3)
  set phraseSetId($core.String v) { $_setString(2, v); }
  @$pb.TagNumber(3)
...
class ListPhraseSetsRequest extends $pb.GeneratedMessage {
  ...
  factory ListPhraseSetsRequest.fromBuffer($core.List<$core.int> i, [$pb.ExtensionRegistry r = $pb.ExtensionRegistry.EMPTY]) => create()..mergeFromBuffer(i, r);
  factory ListPhraseSetsRequest.fromJson($core.String i, [$pb.ExtensionRegistry r = $pb.ExtensionRegistry.EMPTY]) => create()..mergeFromJson(i, r);

  static final $pb.BuilderInfo _i = $pb.BuilderInfo(_omitMessageNames ? '' : 'ListPhraseSetsRequest', package: const $pb.PackageName(_omitMessageNames ? '' : 'google.cloud.speech.v2'), createEmptyInstance: create)
    ..aOS(1, _omitFieldNames ? '' : 'parent')
    ..a<$core.int>(2, _omitFieldNames ? '' : 'pageSize', $pb.PbFieldType.O3)
    ..aOS(3, _omitFieldNames ? '' : 'pageToken')
    ..aOB(4, _omitFieldNames ? '' : 'showDeleted')
  ...
  'Use [GeneratedMessageGenericExtensions.deepCopy] instead. '
  'Will be removed in next major version')
  ListPhraseSetsRequest clone() => ListPhraseSetsRequest()..mergeFromMessage(this);
  @$core.Deprecated(
  'Using this can add significant overhead to your binary. '
  'Use [GeneratedMessageGenericExtensions.rebuild] instead. '
  'Will be removed in next major version')
  ListPhraseSetsRequest copyWith(void Function(ListPhraseSetsRequest) updates) => super.copyWith((message) => updates(message as ListPhraseSetsRequest)) as ListPhraseSetsRequest;
  ...
  static $pb.PbList<ListPhraseSetsRequest> createRepeated() => $pb.PbList<ListPhraseSetsRequest>();
  @$core.pragma('dart2js:noInline')
  static ListPhraseSetsRequest getDefault() => _defaultInstance ??= $pb.GeneratedMessage.$_defaultFor<ListPhraseSetsRequest>(create);
...
class ListPhraseSetsResponse extends $pb.GeneratedMessage {
  ...
  factory ListPhraseSetsResponse.fromBuffer($core.List<$core.int> i, [$pb.ExtensionRegistry r = $pb.ExtensionRegistry.EMPTY]) => create()..mergeFromBuffer(i, r);
  factory ListPhraseSetsResponse.fromJson($core.String i, [$pb.ExtensionRegistry r = $pb.ExtensionRegistry.EMPTY]) => create()..mergeFromJson(i, r);

  static final $pb.BuilderInfo _i = $pb.BuilderInfo(_omitMessageNames ? '' : 'ListPhraseSetsResponse', package: const $pb.PackageName(_omitMessageNames ? '' : 'google.cloud.speech.v2'), createEmptyInstance: create)
  ...
  'Use [GeneratedMessageGenericExtensions.deepCopy] instead. '
  'Will be removed in next major version')
  ListPhraseSetsResponse clone() => ListPhraseSetsResponse()..mergeFromMessage(this);
  @$core.Deprecated(
  'Using this can add significant overhead to your binary. '
  'Use [GeneratedMessageGenericExtensions.rebuild] instead. '
  'Will be removed in next major version')
  ListPhraseSetsResponse copyWith(void Function(ListPhraseSetsResponse) updates) => super.copyWith((message) => updates(message as ListPhraseSetsResponse)) as ListPhraseSetsResponse;
  ...
  static $pb.PbList<ListPhraseSetsResponse> createRepeated() => $pb.PbList<ListPhraseSetsResponse>();
  @$core.pragma('dart2js:noInline')
  static ListPhraseSetsResponse getDefault() => _defaultInstance ??= $pb.GeneratedMessage.$_defaultFor<ListPhraseSetsResponse>(create);
...
class GetPhraseSetRequest extends $pb.GeneratedMessage {
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(_omitMessageNames ? '' : 'GetPhraseSetRequest', package: const $pb.PackageName(_omitMessageNames ? '' : 'google.cloud.speech.v2'), createEmptyInstance: create)
    ..aOS(1, _omitFieldNames ? '' : 'name')
    ..hasRequiredFields = false
  ;
...
class DeletePhraseSetRequest extends $pb.GeneratedMessage {
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(_omitMessageNames ? '' : 'DeletePhraseSetRequest', package: const $pb.PackageName(_omitMessageNames ? '' : 'google.cloud.speech.v2'), createEmptyInstance: create)
    ..aOS(1, _omitFieldNames ? '' : 'name')
    ..aOB(2, _omitFieldNames ? '' : 'validateOnly')
    ..aOS(3, _omitFieldNames ? '' : 'etag')
    ..aOB(4, _omitFieldNames ? '' : 'allowMissing')
...
class UndeletePhraseSetRequest extends $pb.GeneratedMessage {
  ...
  factory UndeletePhraseSetRequest.fromBuffer($core.List<$core.int> i, [$pb.ExtensionRegistry r = $pb.ExtensionRegistry.EMPTY]) => create()..mergeFromBuffer(i, r);
  factory UndeletePhraseSetRequest.fromJson($core.String i, [$pb.ExtensionRegistry r = $pb.ExtensionRegistry.EMPTY]) => create()..mergeFromJson(i, r);

  static final $pb.BuilderInfo _i = $pb.BuilderInfo(_omitMessageNames ? '' : 'UndeletePhraseSetRequest', package: const $pb.PackageName(_omitMessageNames ? '' : 'google.cloud.speech.v2'), createEmptyInstance: create)
    ..aOS(1, _omitFieldNames ? '' : 'name')
    ..aOB(3, _omitFieldNames ? '' : 'validateOnly')
    ..aOS(4, _omitFieldNames ? '' : 'etag')
    ..hasRequiredFields = false
  ...
  'Use [GeneratedMessageGenericExtensions.deepCopy] instead. '
  'Will be removed in next major version')
  UndeletePhraseSetRequest clone() => UndeletePhraseSetRequest()..mergeFromMessage(this);
  @$core.Deprecated(
  'Using this can add significant overhead to your binary. '
  'Use [GeneratedMessageGenericExtensions.rebuild] instead. '
  'Will be removed in next major version')
  UndeletePhraseSetRequest copyWith(void Function(UndeletePhraseSetRequest) updates) => super.copyWith((message) => updates(message as UndeletePhraseSetRequest)) as UndeletePhraseSetRequest;
  ...
  static $pb.PbList<UndeletePhraseSetRequest> createRepeated() => $pb.PbList<UndeletePhraseSetRequest>();
  @$core.pragma('dart2js:noInline')
  static UndeletePhraseSetRequest getDefault() => _defaultInstance ??= $pb.GeneratedMessage.$_defaultFor<UndeletePhraseSetRequest>(create);
