...
class ListImageVersionsRequest extends $pb.GeneratedMessage {
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(_omitMessageNames ? '' : 'ListImageVersionsRequest', package: const $pb.PackageName(_omitMessageNames ? '' : 'google.cloud.orchestration.airflow.service.v1'), createEmptyInstance: create)
...
class ListImageVersionsResponse extends $pb.GeneratedMessage {
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(_omitMessageNames ? '' : 'ListImageVersionsResponse', package: const $pb.PackageName(_omitMessageNames ? '' : 'google.cloud.orchestration.airflow.service.v1'), createEmptyInstance: create)
...
class ImageVersion extends $pb.GeneratedMessage {
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(_omitMessageNames ? '' : 'ImageVersion', package: const $pb.PackageName(_omitMessageNames ? '' : 'google.cloud.orchestration.airflow.service.v1'), createEmptyInstance: create)
