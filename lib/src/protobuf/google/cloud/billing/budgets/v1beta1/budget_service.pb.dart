...
class CreateBudgetRequest extends $pb.GeneratedMessage {
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(_omitMessageNames ? '' : 'CreateBudgetRequest', package: const $pb.PackageName(_omitMessageNames ? '' : 'google.cloud.billing.budgets.v1beta1'), createEmptyInstance: create)
    ..aOS(1, _omitFieldNames ? '' : 'parent')
    ..aOM<$737.Budget>(2, _omitFieldNames ? '' : 'budget', subBuilder: $737.Budget.create)
  ...
  @$pb.TagNumber(2)
  $737.Budget get budget => $_getN(1);
  @$pb.TagNumber(2)
  set budget($737.Budget v) { setField(2, v); }
  @$pb.TagNumber(2)
  $core.bool hasBudget() => $_has(1);
  @$pb.TagNumber(2)
  void clearBudget() => clearField(2);
  @$pb.TagNumber(2)
  $737.Budget ensureBudget() => $_ensure(1);
}
...
class UpdateBudgetRequest extends $pb.GeneratedMessage {
  ...
  @$pb.TagNumber(1)
  $737.Budget get budget => $_getN(0);
  @$pb.TagNumber(1)
  set budget($737.Budget v) { setField(1, v); }
  @$pb.TagNumber(1)
  $core.bool hasBudget() => $_has(0);
  @$pb.TagNumber(1)
  void clearBudget() => clearField(1);
  @$pb.TagNumber(1)
  $737.Budget ensureBudget() => $_ensure(0);
...
class GetBudgetRequest extends $pb.GeneratedMessage {
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(_omitMessageNames ? '' : 'GetBudgetRequest', package: const $pb.PackageName(_omitMessageNames ? '' : 'google.cloud.billing.budgets.v1beta1'), createEmptyInstance: create)
...
class ListBudgetsRequest extends $pb.GeneratedMessage {
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(_omitMessageNames ? '' : 'ListBudgetsRequest', package: const $pb.PackageName(_omitMessageNames ? '' : 'google.cloud.billing.budgets.v1beta1'), createEmptyInstance: create)
    ..aOS(1, _omitFieldNames ? '' : 'parent')
...
class ListBudgetsResponse extends $pb.GeneratedMessage {
  factory ListBudgetsResponse({
    $core.Iterable<$737.Budget>? budgets,
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(_omitMessageNames ? '' : 'ListBudgetsResponse', package: const $pb.PackageName(_omitMessageNames ? '' : 'google.cloud.billing.budgets.v1beta1'), createEmptyInstance: create)
    ..pc<$737.Budget>(1, _omitFieldNames ? '' : 'budgets', $pb.PbFieldType.PM, subBuilder: $737.Budget.create)
  ...
  @$pb.TagNumber(1)
  $core.List<$737.Budget> get budgets => $_getList(0);
...
class DeleteBudgetRequest extends $pb.GeneratedMessage {
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(_omitMessageNames ? '' : 'DeleteBudgetRequest', package: const $pb.PackageName(_omitMessageNames ? '' : 'google.cloud.billing.budgets.v1beta1'), createEmptyInstance: create)
    ..aOS(1, _omitFieldNames ? '' : 'name')
    ..hasRequiredFields = false
  ;
