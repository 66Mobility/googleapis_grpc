...
class Filter extends $pb.GeneratedMessage {
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(_omitMessageNames ? '' : 'Filter', package: const $pb.PackageName(_omitMessageNames ? '' : 'google.cloud.billing.budgets.v1beta1'), createEmptyInstance: create)
    ...
    ..m<$core.String, $1735.ListValue>(6, _omitFieldNames ? '' : 'labels', entryClassName: 'Filter.LabelsEntry', keyFieldType: $pb.PbFieldType.OS, valueFieldType: $pb.PbFieldType.OM, valueCreator: $1735.ListValue.create, valueDefaultOrMaker: $1735.ListValue.getDefault, packageName: const $pb.PackageName('google.cloud.billing.budgets.v1beta1'))
