...
class Budget extends $pb.GeneratedMessage {
  factory Budget({
    ...
    if (allUpdatesRule != null) {
      $result.allUpdatesRule = allUpdatesRule;
    }
    if (etag != null) {
      $result.etag = etag;
    }
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(_omitMessageNames ? '' : 'Budget', package: const $pb.PackageName(_omitMessageNames ? '' : 'google.cloud.billing.budgets.v1beta1'), createEmptyInstance: create)
    ...
    ..aOM<AllUpdatesRule>(6, _omitFieldNames ? '' : 'allUpdatesRule', subBuilder: AllUpdatesRule.create)
...
class BudgetAmount extends $pb.GeneratedMessage {
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(_omitMessageNames ? '' : 'BudgetAmount', package: const $pb.PackageName(_omitMessageNames ? '' : 'google.cloud.billing.budgets.v1beta1'), createEmptyInstance: create)
    ..oo(0, [1, 2])
...
class LastPeriodAmount extends $pb.GeneratedMessage {
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(_omitMessageNames ? '' : 'LastPeriodAmount', package: const $pb.PackageName(_omitMessageNames ? '' : 'google.cloud.billing.budgets.v1beta1'), createEmptyInstance: create)
    ..hasRequiredFields = false
  ;
...
class ThresholdRule extends $pb.GeneratedMessage {
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(_omitMessageNames ? '' : 'ThresholdRule', package: const $pb.PackageName(_omitMessageNames ? '' : 'google.cloud.billing.budgets.v1beta1'), createEmptyInstance: create)
...
class AllUpdatesRule extends $pb.GeneratedMessage {
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(_omitMessageNames ? '' : 'AllUpdatesRule', package: const $pb.PackageName(_omitMessageNames ? '' : 'google.cloud.billing.budgets.v1beta1'), createEmptyInstance: create)
  ...
  'Use [GeneratedMessageGenericExtensions.rebuild] instead. '
  'Will be removed in next major version')
  AllUpdatesRule copyWith(void Function(AllUpdatesRule) updates) => super.copyWith((message) => updates(message as AllUpdatesRule)) as AllUpdatesRule;
...
class Filter extends $pb.GeneratedMessage {
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(_omitMessageNames ? '' : 'Filter', package: const $pb.PackageName(_omitMessageNames ? '' : 'google.cloud.billing.budgets.v1beta1'), createEmptyInstance: create)
    ..oo(0, [8, 9])
    ...
    ..m<$core.String, $1734.ListValue>(6, _omitFieldNames ? '' : 'labels', entryClassName: 'Filter.LabelsEntry', keyFieldType: $pb.PbFieldType.OS, valueFieldType: $pb.PbFieldType.OM, valueCreator: $1734.ListValue.create, valueDefaultOrMaker: $1734.ListValue.getDefault, packageName: const $pb.PackageName('google.cloud.billing.budgets.v1beta1'))
...
class CustomPeriod extends $pb.GeneratedMessage {
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(_omitMessageNames ? '' : 'CustomPeriod', package: const $pb.PackageName(_omitMessageNames ? '' : 'google.cloud.billing.budgets.v1beta1'), createEmptyInstance: create)
