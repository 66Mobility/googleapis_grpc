...
const CreateBudgetRequest$json = {
  ...
  '2': [
    ...
    {'1': 'budget', '3': 2, '4': 1, '5': 11, '6': '.google.cloud.billing.budgets.v1.Budget', '8': {}, '10': 'budget'},
  ],
};
...
final $typed_data.Uint8List createBudgetRequestDescriptor = $convert.base64Decode(
    ...
    'VkZ2V0cy5nb29nbGVhcGlzLmNvbS9CdWRnZXRSBnBhcmVudBJECgZidWRnZXQYAiABKAsyJy5n'
    'b29nbGUuY2xvdWQuYmlsbGluZy5idWRnZXRzLnYxLkJ1ZGdldEID4EECUgZidWRnZXQ=');

@$core.Deprecated('Use updateBudgetRequestDescriptor instead')
const UpdateBudgetRequest$json = {
  '1': 'UpdateBudgetRequest',
  '2': [
    {'1': 'budget', '3': 1, '4': 1, '5': 11, '6': '.google.cloud.billing.budgets.v1.Budget', '8': {}, '10': 'budget'},
...
final $typed_data.Uint8List updateBudgetRequestDescriptor = $convert.base64Decode(
    'ChNVcGRhdGVCdWRnZXRSZXF1ZXN0EkQKBmJ1ZGdldBgBIAEoCzInLmdvb2dsZS5jbG91ZC5iaW'
    'xsaW5nLmJ1ZGdldHMudjEuQnVkZ2V0QgPgQQJSBmJ1ZGdldBJACgt1cGRhdGVfbWFzaxgCIAEo'
...
const ListBudgetsResponse$json = {
  ...
  '2': [
    {'1': 'budgets', '3': 1, '4': 3, '5': 11, '6': '.google.cloud.billing.budgets.v1.Budget', '10': 'budgets'},
...
final $typed_data.Uint8List listBudgetsResponseDescriptor = $convert.base64Decode(
    'ChNMaXN0QnVkZ2V0c1Jlc3BvbnNlEkEKB2J1ZGdldHMYASADKAsyJy5nb29nbGUuY2xvdWQuYm'
    'lsbGluZy5idWRnZXRzLnYxLkJ1ZGdldFIHYnVkZ2V0cxImCg9uZXh0X3BhZ2VfdG9rZW4YAiAB'
