...
class Replication_Automatic extends $pb.GeneratedMessage {
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(_omitMessageNames ? '' : 'Replication.Automatic', package: const $pb.PackageName(_omitMessageNames ? '' : 'google.cloud.secrets.v1beta1'), createEmptyInstance: create)
    ..hasRequiredFields = false
  ;
...
class Replication_UserManaged_Replica extends $pb.GeneratedMessage {
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(_omitMessageNames ? '' : 'Replication.UserManaged.Replica', package: const $pb.PackageName(_omitMessageNames ? '' : 'google.cloud.secrets.v1beta1'), createEmptyInstance: create)
...
class Replication_UserManaged extends $pb.GeneratedMessage {
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(_omitMessageNames ? '' : 'Replication.UserManaged', package: const $pb.PackageName(_omitMessageNames ? '' : 'google.cloud.secrets.v1beta1'), createEmptyInstance: create)
...
class Replication extends $pb.GeneratedMessage {
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(_omitMessageNames ? '' : 'Replication', package: const $pb.PackageName(_omitMessageNames ? '' : 'google.cloud.secrets.v1beta1'), createEmptyInstance: create)
    ..oo(0, [1, 2])
...
class SecretPayload extends $pb.GeneratedMessage {
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(_omitMessageNames ? '' : 'SecretPayload', package: const $pb.PackageName(_omitMessageNames ? '' : 'google.cloud.secrets.v1beta1'), createEmptyInstance: create)
