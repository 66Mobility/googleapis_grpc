...
class GrpcEndpoint extends $pb.GeneratedMessage {
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(_omitMessageNames ? '' : 'GrpcEndpoint', package: const $pb.PackageName(_omitMessageNames ? '' : 'google.cloud.networksecurity.v1beta1'), createEmptyInstance: create)
...
class ValidationCA extends $pb.GeneratedMessage {
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(_omitMessageNames ? '' : 'ValidationCA', package: const $pb.PackageName(_omitMessageNames ? '' : 'google.cloud.networksecurity.v1beta1'), createEmptyInstance: create)
    ..oo(0, [2, 3])
...
class CertificateProviderInstance extends $pb.GeneratedMessage {
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(_omitMessageNames ? '' : 'CertificateProviderInstance', package: const $pb.PackageName(_omitMessageNames ? '' : 'google.cloud.networksecurity.v1beta1'), createEmptyInstance: create)
...
class CertificateProvider extends $pb.GeneratedMessage {
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(_omitMessageNames ? '' : 'CertificateProvider', package: const $pb.PackageName(_omitMessageNames ? '' : 'google.cloud.networksecurity.v1beta1'), createEmptyInstance: create)
    ..oo(0, [2, 3])
    ..aOM<GrpcEndpoint>(2, _omitFieldNames ? '' : 'grpcEndpoint', subBuilder: GrpcEndpoint.create)
    ..aOM<CertificateProviderInstance>(3, _omitFieldNames ? '' : 'certificateProviderInstance', subBuilder: CertificateProviderInstance.create)
    ..hasRequiredFields = false
