...
const AuthorizationPolicy$json = {
  ...
  '2': [
    ...
    {'1': 'labels', '3': 5, '4': 3, '5': 11, '6': '.google.cloud.networksecurity.v1beta1.AuthorizationPolicy.LabelsEntry', '8': {}, '10': 'labels'},
    {'1': 'action', '3': 6, '4': 1, '5': 14, '6': '.google.cloud.networksecurity.v1beta1.AuthorizationPolicy.Action', '8': {}, '10': 'action'},
    {'1': 'rules', '3': 7, '4': 3, '5': 11, '6': '.google.cloud.networksecurity.v1beta1.AuthorizationPolicy.Rule', '8': {}, '10': 'rules'},
  ],
...
const AuthorizationPolicy_Rule$json = {
  '1': 'Rule',
  '2': [
    {'1': 'sources', '3': 1, '4': 3, '5': 11, '6': '.google.cloud.networksecurity.v1beta1.AuthorizationPolicy.Rule.Source', '8': {}, '10': 'sources'},
    {'1': 'destinations', '3': 2, '4': 3, '5': 11, '6': '.google.cloud.networksecurity.v1beta1.AuthorizationPolicy.Rule.Destination', '8': {}, '10': 'destinations'},
  ],
...
const AuthorizationPolicy_Rule_Destination$json = {
  ...
  '2': [
    ...
    {'1': 'http_header_match', '3': 5, '4': 1, '5': 11, '6': '.google.cloud.networksecurity.v1beta1.AuthorizationPolicy.Rule.Destination.HttpHeaderMatch', '8': {}, '10': 'httpHeaderMatch'},
  ],
...
final $typed_data.Uint8List authorizationPolicyDescriptor = $convert.base64Decode(
    ...
    'gEIAEoCzIaLmdvb2dsZS5wcm90b2J1Zi5UaW1lc3RhbXBCA+BBA1IKdXBkYXRlVGltZRJiCgZs'
    'YWJlbHMYBSADKAsyRS5nb29nbGUuY2xvdWQubmV0d29ya3NlY3VyaXR5LnYxYmV0YTEuQXV0aG'
    '9yaXphdGlvblBvbGljeS5MYWJlbHNFbnRyeUID4EEBUgZsYWJlbHMSXQoGYWN0aW9uGAYgASgO'
    'MkAuZ29vZ2xlLmNsb3VkLm5ldHdvcmtzZWN1cml0eS52MWJldGExLkF1dGhvcml6YXRpb25Qb2'
    'xpY3kuQWN0aW9uQgPgQQJSBmFjdGlvbhJZCgVydWxlcxgHIAMoCzI+Lmdvb2dsZS5jbG91ZC5u'
    'ZXR3b3Jrc2VjdXJpdHkudjFiZXRhMS5BdXRob3JpemF0aW9uUG9saWN5LlJ1bGVCA+BBAVIFcn'
    'VsZXMajgUKBFJ1bGUSZAoHc291cmNlcxgBIAMoCzJFLmdvb2dsZS5jbG91ZC5uZXR3b3Jrc2Vj'
    'dXJpdHkudjFiZXRhMS5BdXRob3JpemF0aW9uUG9saWN5LlJ1bGUuU291cmNlQgPgQQFSB3NvdX'
    'JjZXMScwoMZGVzdGluYXRpb25zGAIgAygLMkouZ29vZ2xlLmNsb3VkLm5ldHdvcmtzZWN1cml0'
    'eS52MWJldGExLkF1dGhvcml6YXRpb25Qb2xpY3kuUnVsZS5EZXN0aW5hdGlvbkID4EEBUgxkZX'
    'N0aW5hdGlvbnMaTwoGU291cmNlEiMKCnByaW5jaXBhbHMYASADKAlCA+BBAVIKcHJpbmNpcGFs'
    'cxIgCglpcF9ibG9ja3MYAiADKAlCA+BBAVIIaXBCbG9ja3Ma2QIKC0Rlc3RpbmF0aW9uEhkKBW'
    'hvc3RzGAEgAygJQgPgQQJSBWhvc3RzEhkKBXBvcnRzGAIgAygNQgPgQQJSBXBvcnRzEh0KB21l'
    'dGhvZHMYBCADKAlCA+BBAVIHbWV0aG9kcxKLAQoRaHR0cF9oZWFkZXJfbWF0Y2gYBSABKAsyWi'
    '5nb29nbGUuY2xvdWQubmV0d29ya3NlY3VyaXR5LnYxYmV0YTEuQXV0aG9yaXphdGlvblBvbGlj'
    'eS5SdWxlLkRlc3RpbmF0aW9uLkh0dHBIZWFkZXJNYXRjaEID4EEBUg9odHRwSGVhZGVyTWF0Y2'
    'gaZwoPSHR0cEhlYWRlck1hdGNoEiYKC3JlZ2V4X21hdGNoGAIgASgJQgPgQQJIAFIKcmVnZXhN'
    'YXRjaBIkCgtoZWFkZXJfbmFtZRgBIAEoCUID4EECUgpoZWFkZXJOYW1lQgYKBHR5cGUaOQoLTG'
    'FiZWxzRW50cnkSEAoDa2V5GAEgASgJUgNrZXkSFAoFdmFsdWUYAiABKAlSBXZhbHVlOgI4ASI1'
    'CgZBY3Rpb24SFgoSQUNUSU9OX1VOU1BFQ0lGSUVEEAASCQoFQUxMT1cQARIICgRERU5ZEAI6jg'
    'HqQYoBCjJuZXR3b3Jrc2VjdXJpdHkuZ29vZ2xlYXBpcy5jb20vQXV0aG9yaXphdGlvblBvbGlj'
    'eRJUcHJvamVjdHMve3Byb2plY3R9L2xvY2F0aW9ucy97bG9jYXRpb259L2F1dGhvcml6YXRpb2'
    '5Qb2xpY2llcy97YXV0aG9yaXphdGlvbl9wb2xpY3l9');
...
const ListAuthorizationPoliciesResponse$json = {
  ...
  '2': [
    {'1': 'authorization_policies', '3': 1, '4': 3, '5': 11, '6': '.google.cloud.networksecurity.v1beta1.AuthorizationPolicy', '10': 'authorizationPolicies'},
...
final $typed_data.Uint8List listAuthorizationPoliciesResponseDescriptor = $convert.base64Decode(
    'CiFMaXN0QXV0aG9yaXphdGlvblBvbGljaWVzUmVzcG9uc2UScAoWYXV0aG9yaXphdGlvbl9wb2'
    'xpY2llcxgBIAMoCzI5Lmdvb2dsZS5jbG91ZC5uZXR3b3Jrc2VjdXJpdHkudjFiZXRhMS5BdXRo'
    'b3JpemF0aW9uUG9saWN5UhVhdXRob3JpemF0aW9uUG9saWNpZXMSJgoPbmV4dF9wYWdlX3Rva2'
...
const CreateAuthorizationPolicyRequest$json = {
  ...
  '2': [
    ...
    {'1': 'authorization_policy', '3': 3, '4': 1, '5': 11, '6': '.google.cloud.networksecurity.v1beta1.AuthorizationPolicy', '8': {}, '10': 'authorizationPolicy'},
  ],
};
...
final $typed_data.Uint8List createAuthorizationPolicyRequestDescriptor = $convert.base64Decode(
    ...
    'F0aW9uUG9saWN5SWQScQoUYXV0aG9yaXphdGlvbl9wb2xpY3kYAyABKAsyOS5nb29nbGUuY2xv'
    'dWQubmV0d29ya3NlY3VyaXR5LnYxYmV0YTEuQXV0aG9yaXphdGlvblBvbGljeUID4EECUhNhdX'
    'Rob3JpemF0aW9uUG9saWN5');
...
const UpdateAuthorizationPolicyRequest$json = {
  ...
  '2': [
    ...
    {'1': 'authorization_policy', '3': 2, '4': 1, '5': 11, '6': '.google.cloud.networksecurity.v1beta1.AuthorizationPolicy', '8': {}, '10': 'authorizationPolicy'},
  ],
};
...
final $typed_data.Uint8List updateAuthorizationPolicyRequestDescriptor = $convert.base64Decode(
    ...
    'IaLmdvb2dsZS5wcm90b2J1Zi5GaWVsZE1hc2tCA+BBAVIKdXBkYXRlTWFzaxJxChRhdXRob3Jp'
    'emF0aW9uX3BvbGljeRgCIAEoCzI5Lmdvb2dsZS5jbG91ZC5uZXR3b3Jrc2VjdXJpdHkudjFiZX'
    'RhMS5BdXRob3JpemF0aW9uUG9saWN5QgPgQQJSE2F1dGhvcml6YXRpb25Qb2xpY3k=');
