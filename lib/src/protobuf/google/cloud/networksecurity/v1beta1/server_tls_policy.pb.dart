...
class ServerTlsPolicy_MTLSPolicy extends $pb.GeneratedMessage {
  factory ServerTlsPolicy_MTLSPolicy({
    $core.Iterable<$4566.ValidationCA>? clientValidationCa,
  }) {
    final $result = create();
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(_omitMessageNames ? '' : 'ServerTlsPolicy.MTLSPolicy', package: const $pb.PackageName(_omitMessageNames ? '' : 'google.cloud.networksecurity.v1beta1'), createEmptyInstance: create)
    ..pc<$4566.ValidationCA>(1, _omitFieldNames ? '' : 'clientValidationCa', $pb.PbFieldType.PM, subBuilder: $4566.ValidationCA.create)
  ...
  @$pb.TagNumber(1)
  $core.List<$4566.ValidationCA> get clientValidationCa => $_getList(0);
}
...
class ServerTlsPolicy extends $pb.GeneratedMessage {
  factory ServerTlsPolicy({
    ...
    $core.bool? allowOpen,
    $4566.CertificateProvider? serverCertificate,
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(_omitMessageNames ? '' : 'ServerTlsPolicy', package: const $pb.PackageName(_omitMessageNames ? '' : 'google.cloud.networksecurity.v1beta1'), createEmptyInstance: create)
    ...
    ..aOM<$4566.CertificateProvider>(7, _omitFieldNames ? '' : 'serverCertificate', subBuilder: $4566.CertificateProvider.create)
  ...
  @$pb.TagNumber(7)
  $4566.CertificateProvider get serverCertificate => $_getN(6);
  @$pb.TagNumber(7)
  set serverCertificate($4566.CertificateProvider v) { setField(7, v); }
  @$pb.TagNumber(7)
  $core.bool hasServerCertificate() => $_has(6);
  @$pb.TagNumber(7)
  void clearServerCertificate() => clearField(7);
  @$pb.TagNumber(7)
  $4566.CertificateProvider ensureServerCertificate() => $_ensure(6);
