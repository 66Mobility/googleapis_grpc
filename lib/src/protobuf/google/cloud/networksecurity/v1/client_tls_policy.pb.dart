...
class ClientTlsPolicy extends $pb.GeneratedMessage {
  factory ClientTlsPolicy({
    ...
    $core.String? sni,
    $4565.CertificateProvider? clientCertificate,
    $core.Iterable<$4565.ValidationCA>? serverValidationCa,
  }) {
    final $result = create();
    if (name != null) {
      $result.name = name;
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(_omitMessageNames ? '' : 'ClientTlsPolicy', package: const $pb.PackageName(_omitMessageNames ? '' : 'google.cloud.networksecurity.v1'), createEmptyInstance: create)
    ..aOS(1, _omitFieldNames ? '' : 'name')
    ..aOS(2, _omitFieldNames ? '' : 'description')
    ..aOM<$1775.Timestamp>(3, _omitFieldNames ? '' : 'createTime', subBuilder: $1775.Timestamp.create)
    ..aOM<$1775.Timestamp>(4, _omitFieldNames ? '' : 'updateTime', subBuilder: $1775.Timestamp.create)
    ..m<$core.String, $core.String>(5, _omitFieldNames ? '' : 'labels', entryClassName: 'ClientTlsPolicy.LabelsEntry', keyFieldType: $pb.PbFieldType.OS, valueFieldType: $pb.PbFieldType.OS, packageName: const $pb.PackageName('google.cloud.networksecurity.v1'))
    ..aOS(6, _omitFieldNames ? '' : 'sni')
    ..aOM<$4565.CertificateProvider>(7, _omitFieldNames ? '' : 'clientCertificate', subBuilder: $4565.CertificateProvider.create)
    ..pc<$4565.ValidationCA>(8, _omitFieldNames ? '' : 'serverValidationCa', $pb.PbFieldType.PM, subBuilder: $4565.ValidationCA.create)
  ...
  @$pb.TagNumber(7)
  $4565.CertificateProvider get clientCertificate => $_getN(6);
  @$pb.TagNumber(7)
  set clientCertificate($4565.CertificateProvider v) { setField(7, v); }
  @$pb.TagNumber(7)
  $core.bool hasClientCertificate() => $_has(6);
  @$pb.TagNumber(7)
  void clearClientCertificate() => clearField(7);
  @$pb.TagNumber(7)
  $4565.CertificateProvider ensureClientCertificate() => $_ensure(6);
  ...
  /// server certificate.
  @$pb.TagNumber(8)
  $core.List<$4565.ValidationCA> get serverValidationCa => $_getList(7);
}
...
class ListClientTlsPoliciesRequest extends $pb.GeneratedMessage {
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(_omitMessageNames ? '' : 'ListClientTlsPoliciesRequest', package: const $pb.PackageName(_omitMessageNames ? '' : 'google.cloud.networksecurity.v1'), createEmptyInstance: create)
...
class ListClientTlsPoliciesResponse extends $pb.GeneratedMessage {
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(_omitMessageNames ? '' : 'ListClientTlsPoliciesResponse', package: const $pb.PackageName(_omitMessageNames ? '' : 'google.cloud.networksecurity.v1'), createEmptyInstance: create)
...
class GetClientTlsPolicyRequest extends $pb.GeneratedMessage {
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(_omitMessageNames ? '' : 'GetClientTlsPolicyRequest', package: const $pb.PackageName(_omitMessageNames ? '' : 'google.cloud.networksecurity.v1'), createEmptyInstance: create)
    ..aOS(1, _omitFieldNames ? '' : 'name')
    ..hasRequiredFields = false
  ;
...
class CreateClientTlsPolicyRequest extends $pb.GeneratedMessage {
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(_omitMessageNames ? '' : 'CreateClientTlsPolicyRequest', package: const $pb.PackageName(_omitMessageNames ? '' : 'google.cloud.networksecurity.v1'), createEmptyInstance: create)
    ..aOS(1, _omitFieldNames ? '' : 'parent')
...
class UpdateClientTlsPolicyRequest extends $pb.GeneratedMessage {
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(_omitMessageNames ? '' : 'UpdateClientTlsPolicyRequest', package: const $pb.PackageName(_omitMessageNames ? '' : 'google.cloud.networksecurity.v1'), createEmptyInstance: create)
...
class DeleteClientTlsPolicyRequest extends $pb.GeneratedMessage {
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(_omitMessageNames ? '' : 'DeleteClientTlsPolicyRequest', package: const $pb.PackageName(_omitMessageNames ? '' : 'google.cloud.networksecurity.v1'), createEmptyInstance: create)
    ..aOS(1, _omitFieldNames ? '' : 'name')
    ..hasRequiredFields = false
  ;
