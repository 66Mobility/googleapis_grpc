...
class CreateTenantRequest extends $pb.GeneratedMessage {
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(_omitMessageNames ? '' : 'CreateTenantRequest', package: const $pb.PackageName(_omitMessageNames ? '' : 'google.cloud.talent.v4beta1'), createEmptyInstance: create)
    ..aOS(1, _omitFieldNames ? '' : 'parent')
    ..aOM<$1438.Tenant>(2, _omitFieldNames ? '' : 'tenant', subBuilder: $1438.Tenant.create)
  ...
  @$pb.TagNumber(2)
  $1438.Tenant get tenant => $_getN(1);
  @$pb.TagNumber(2)
  set tenant($1438.Tenant v) { setField(2, v); }
  @$pb.TagNumber(2)
  $core.bool hasTenant() => $_has(1);
  @$pb.TagNumber(2)
  void clearTenant() => clearField(2);
  @$pb.TagNumber(2)
  $1438.Tenant ensureTenant() => $_ensure(1);
}
...
class GetTenantRequest extends $pb.GeneratedMessage {
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(_omitMessageNames ? '' : 'GetTenantRequest', package: const $pb.PackageName(_omitMessageNames ? '' : 'google.cloud.talent.v4beta1'), createEmptyInstance: create)
...
class UpdateTenantRequest extends $pb.GeneratedMessage {
  ...
  /// system.
  @$pb.TagNumber(1)
  $1438.Tenant get tenant => $_getN(0);
  @$pb.TagNumber(1)
  set tenant($1438.Tenant v) { setField(1, v); }
  @$pb.TagNumber(1)
  $core.bool hasTenant() => $_has(0);
  @$pb.TagNumber(1)
  void clearTenant() => clearField(1);
  @$pb.TagNumber(1)
  $1438.Tenant ensureTenant() => $_ensure(0);
...
class DeleteTenantRequest extends $pb.GeneratedMessage {
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(_omitMessageNames ? '' : 'DeleteTenantRequest', package: const $pb.PackageName(_omitMessageNames ? '' : 'google.cloud.talent.v4beta1'), createEmptyInstance: create)
    ..aOS(1, _omitFieldNames ? '' : 'name')
    ..hasRequiredFields = false
  ;
...
class ListTenantsRequest extends $pb.GeneratedMessage {
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(_omitMessageNames ? '' : 'ListTenantsRequest', package: const $pb.PackageName(_omitMessageNames ? '' : 'google.cloud.talent.v4beta1'), createEmptyInstance: create)
    ..aOS(1, _omitFieldNames ? '' : 'parent')
...
class ListTenantsResponse extends $pb.GeneratedMessage {
  ...
  @$pb.TagNumber(1)
  $core.List<$1438.Tenant> get tenants => $_getList(0);
