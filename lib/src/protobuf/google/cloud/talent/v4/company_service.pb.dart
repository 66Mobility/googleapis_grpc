...
class CreateCompanyRequest extends $pb.GeneratedMessage {
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(_omitMessageNames ? '' : 'CreateCompanyRequest', package: const $pb.PackageName(_omitMessageNames ? '' : 'google.cloud.talent.v4'), createEmptyInstance: create)
    ..aOS(1, _omitFieldNames ? '' : 'parent')
    ..aOM<$1422.Company>(2, _omitFieldNames ? '' : 'company', subBuilder: $1422.Company.create)
  ...
  @$pb.TagNumber(2)
  $1422.Company get company => $_getN(1);
  @$pb.TagNumber(2)
  set company($1422.Company v) { setField(2, v); }
  @$pb.TagNumber(2)
  $core.bool hasCompany() => $_has(1);
  @$pb.TagNumber(2)
  void clearCompany() => clearField(2);
  @$pb.TagNumber(2)
  $1422.Company ensureCompany() => $_ensure(1);
}
...
class GetCompanyRequest extends $pb.GeneratedMessage {
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(_omitMessageNames ? '' : 'GetCompanyRequest', package: const $pb.PackageName(_omitMessageNames ? '' : 'google.cloud.talent.v4'), createEmptyInstance: create)
...
class UpdateCompanyRequest extends $pb.GeneratedMessage {
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(_omitMessageNames ? '' : 'UpdateCompanyRequest', package: const $pb.PackageName(_omitMessageNames ? '' : 'google.cloud.talent.v4'), createEmptyInstance: create)
    ..aOM<$1422.Company>(1, _omitFieldNames ? '' : 'company', subBuilder: $1422.Company.create)
  ...
  /// system.
  @$pb.TagNumber(1)
  $1422.Company get company => $_getN(0);
  @$pb.TagNumber(1)
  set company($1422.Company v) { setField(1, v); }
  @$pb.TagNumber(1)
  $core.bool hasCompany() => $_has(0);
  @$pb.TagNumber(1)
  void clearCompany() => clearField(1);
  @$pb.TagNumber(1)
  $1422.Company ensureCompany() => $_ensure(0);
...
class DeleteCompanyRequest extends $pb.GeneratedMessage {
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(_omitMessageNames ? '' : 'DeleteCompanyRequest', package: const $pb.PackageName(_omitMessageNames ? '' : 'google.cloud.talent.v4'), createEmptyInstance: create)
    ..aOS(1, _omitFieldNames ? '' : 'name')
    ..hasRequiredFields = false
  ;
...
class ListCompaniesRequest extends $pb.GeneratedMessage {
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(_omitMessageNames ? '' : 'ListCompaniesRequest', package: const $pb.PackageName(_omitMessageNames ? '' : 'google.cloud.talent.v4'), createEmptyInstance: create)
    ..aOS(1, _omitFieldNames ? '' : 'parent')
...
class ListCompaniesResponse extends $pb.GeneratedMessage {
  factory ListCompaniesResponse({
    $core.Iterable<$1422.Company>? companies,
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(_omitMessageNames ? '' : 'ListCompaniesResponse', package: const $pb.PackageName(_omitMessageNames ? '' : 'google.cloud.talent.v4'), createEmptyInstance: create)
    ..pc<$1422.Company>(1, _omitFieldNames ? '' : 'companies', $pb.PbFieldType.PM, subBuilder: $1422.Company.create)
  ...
  @$pb.TagNumber(1)
  $core.List<$1422.Company> get companies => $_getList(0);
