...
const CreateTenantRequest$json = {
  ...
  '2': [
    ...
    {'1': 'tenant', '3': 2, '4': 1, '5': 11, '6': '.google.cloud.talent.v4.Tenant', '8': {}, '10': 'tenant'},
  ],
};
...
final $typed_data.Uint8List createTenantRequestDescriptor = $convert.base64Decode(
    ...
    '91cmNlbWFuYWdlci5nb29nbGVhcGlzLmNvbS9Qcm9qZWN0UgZwYXJlbnQSOwoGdGVuYW50GAIg'
    'ASgLMh4uZ29vZ2xlLmNsb3VkLnRhbGVudC52NC5UZW5hbnRCA+BBAlIGdGVuYW50');
...
const UpdateTenantRequest$json = {
  ...
  '2': [
    {'1': 'tenant', '3': 1, '4': 1, '5': 11, '6': '.google.cloud.talent.v4.Tenant', '8': {}, '10': 'tenant'},
...
final $typed_data.Uint8List updateTenantRequestDescriptor = $convert.base64Decode(
    'ChNVcGRhdGVUZW5hbnRSZXF1ZXN0EjsKBnRlbmFudBgBIAEoCzIeLmdvb2dsZS5jbG91ZC50YW'
    'xlbnQudjQuVGVuYW50QgPgQQJSBnRlbmFudBI7Cgt1cGRhdGVfbWFzaxgCIAEoCzIaLmdvb2ds'
...
const ListTenantsResponse$json = {
  ...
  '2': [
    {'1': 'tenants', '3': 1, '4': 3, '5': 11, '6': '.google.cloud.talent.v4.Tenant', '10': 'tenants'},
...
final $typed_data.Uint8List listTenantsResponseDescriptor = $convert.base64Decode(
    'ChNMaXN0VGVuYW50c1Jlc3BvbnNlEjgKB3RlbmFudHMYASADKAsyHi5nb29nbGUuY2xvdWQudG'
    'FsZW50LnY0LlRlbmFudFIHdGVuYW50cxImCg9uZXh0X3BhZ2VfdG9rZW4YAiABKAlSDW5leHRQ'
    'YWdlVG9rZW4SRAoIbWV0YWRhdGEYAyABKAsyKC5nb29nbGUuY2xvdWQudGFsZW50LnY0LlJlc3'
    'BvbnNlTWV0YWRhdGFSCG1ldGFkYXRh');
