...
class CreateClientEventRequest extends $pb.GeneratedMessage {
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(_omitMessageNames ? '' : 'CreateClientEventRequest', package: const $pb.PackageName(_omitMessageNames ? '' : 'google.cloud.talent.v4'), createEmptyInstance: create)
    ..aOS(1, _omitFieldNames ? '' : 'parent')
    ..aOM<$1425.ClientEvent>(2, _omitFieldNames ? '' : 'clientEvent', subBuilder: $1425.ClientEvent.create)
  ...
  @$pb.TagNumber(2)
  $1425.ClientEvent get clientEvent => $_getN(1);
  @$pb.TagNumber(2)
  set clientEvent($1425.ClientEvent v) { setField(2, v); }
  @$pb.TagNumber(2)
  $core.bool hasClientEvent() => $_has(1);
  @$pb.TagNumber(2)
  void clearClientEvent() => clearField(2);
  @$pb.TagNumber(2)
  $1425.ClientEvent ensureClientEvent() => $_ensure(1);
}
