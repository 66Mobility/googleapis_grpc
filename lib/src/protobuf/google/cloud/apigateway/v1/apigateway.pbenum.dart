...
class GetApiConfigRequest_ConfigView extends $pb.ProtobufEnum {
  static const GetApiConfigRequest_ConfigView CONFIG_VIEW_UNSPECIFIED = GetApiConfigRequest_ConfigView._(0, _omitEnumNames ? '' : 'CONFIG_VIEW_UNSPECIFIED');
  static const GetApiConfigRequest_ConfigView BASIC = GetApiConfigRequest_ConfigView._(1, _omitEnumNames ? '' : 'BASIC');
  static const GetApiConfigRequest_ConfigView FULL = GetApiConfigRequest_ConfigView._(2, _omitEnumNames ? '' : 'FULL');
