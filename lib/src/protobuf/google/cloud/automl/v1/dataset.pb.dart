...
class Dataset extends $pb.GeneratedMessage {
  factory Dataset({
    ...
    $4335.TranslationDatasetMetadata? translationDatasetMetadata,
    $4339.ImageClassificationDatasetMetadata? imageClassificationDatasetMetadata,
    $4340.TextClassificationDatasetMetadata? textClassificationDatasetMetadata,
    $4339.ImageObjectDetectionDatasetMetadata? imageObjectDetectionDatasetMetadata,
    $4340.TextExtractionDatasetMetadata? textExtractionDatasetMetadata,
    $4340.TextSentimentDatasetMetadata? textSentimentDatasetMetadata,
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(_omitMessageNames ? '' : 'Dataset', package: const $pb.PackageName(_omitMessageNames ? '' : 'google.cloud.automl.v1'), createEmptyInstance: create)
    ...
    ..aOM<$4335.TranslationDatasetMetadata>(23, _omitFieldNames ? '' : 'translationDatasetMetadata', subBuilder: $4335.TranslationDatasetMetadata.create)
    ..aOM<$4339.ImageClassificationDatasetMetadata>(24, _omitFieldNames ? '' : 'imageClassificationDatasetMetadata', subBuilder: $4339.ImageClassificationDatasetMetadata.create)
    ..aOM<$4340.TextClassificationDatasetMetadata>(25, _omitFieldNames ? '' : 'textClassificationDatasetMetadata', subBuilder: $4340.TextClassificationDatasetMetadata.create)
    ..aOM<$4339.ImageObjectDetectionDatasetMetadata>(26, _omitFieldNames ? '' : 'imageObjectDetectionDatasetMetadata', subBuilder: $4339.ImageObjectDetectionDatasetMetadata.create)
    ..aOM<$4340.TextExtractionDatasetMetadata>(28, _omitFieldNames ? '' : 'textExtractionDatasetMetadata', subBuilder: $4340.TextExtractionDatasetMetadata.create)
    ..aOM<$4340.TextSentimentDatasetMetadata>(30, _omitFieldNames ? '' : 'textSentimentDatasetMetadata', subBuilder: $4340.TextSentimentDatasetMetadata.create)
  ...
  @$pb.TagNumber(23)
  $4335.TranslationDatasetMetadata get translationDatasetMetadata => $_getN(6);
  @$pb.TagNumber(23)
  set translationDatasetMetadata($4335.TranslationDatasetMetadata v) { setField(23, v); }
  @$pb.TagNumber(23)
  $core.bool hasTranslationDatasetMetadata() => $_has(6);
  @$pb.TagNumber(23)
  void clearTranslationDatasetMetadata() => clearField(23);
  @$pb.TagNumber(23)
  $4335.TranslationDatasetMetadata ensureTranslationDatasetMetadata() => $_ensure(6);

  /// Metadata for a dataset used for image classification.
  @$pb.TagNumber(24)
  $4339.ImageClassificationDatasetMetadata get imageClassificationDatasetMetadata => $_getN(7);
  @$pb.TagNumber(24)
  set imageClassificationDatasetMetadata($4339.ImageClassificationDatasetMetadata v) { setField(24, v); }
  @$pb.TagNumber(24)
  $core.bool hasImageClassificationDatasetMetadata() => $_has(7);
  @$pb.TagNumber(24)
  void clearImageClassificationDatasetMetadata() => clearField(24);
  @$pb.TagNumber(24)
  $4339.ImageClassificationDatasetMetadata ensureImageClassificationDatasetMetadata() => $_ensure(7);

  /// Metadata for a dataset used for text classification.
  @$pb.TagNumber(25)
  $4340.TextClassificationDatasetMetadata get textClassificationDatasetMetadata => $_getN(8);
  @$pb.TagNumber(25)
  set textClassificationDatasetMetadata($4340.TextClassificationDatasetMetadata v) { setField(25, v); }
  @$pb.TagNumber(25)
  $core.bool hasTextClassificationDatasetMetadata() => $_has(8);
  @$pb.TagNumber(25)
  void clearTextClassificationDatasetMetadata() => clearField(25);
  @$pb.TagNumber(25)
  $4340.TextClassificationDatasetMetadata ensureTextClassificationDatasetMetadata() => $_ensure(8);

  /// Metadata for a dataset used for image object detection.
  @$pb.TagNumber(26)
  $4339.ImageObjectDetectionDatasetMetadata get imageObjectDetectionDatasetMetadata => $_getN(9);
  @$pb.TagNumber(26)
  set imageObjectDetectionDatasetMetadata($4339.ImageObjectDetectionDatasetMetadata v) { setField(26, v); }
  @$pb.TagNumber(26)
  $core.bool hasImageObjectDetectionDatasetMetadata() => $_has(9);
  @$pb.TagNumber(26)
  void clearImageObjectDetectionDatasetMetadata() => clearField(26);
  @$pb.TagNumber(26)
  $4339.ImageObjectDetectionDatasetMetadata ensureImageObjectDetectionDatasetMetadata() => $_ensure(9);

  /// Metadata for a dataset used for text extraction.
  @$pb.TagNumber(28)
  $4340.TextExtractionDatasetMetadata get textExtractionDatasetMetadata => $_getN(10);
  @$pb.TagNumber(28)
  set textExtractionDatasetMetadata($4340.TextExtractionDatasetMetadata v) { setField(28, v); }
  @$pb.TagNumber(28)
  $core.bool hasTextExtractionDatasetMetadata() => $_has(10);
  @$pb.TagNumber(28)
  void clearTextExtractionDatasetMetadata() => clearField(28);
  @$pb.TagNumber(28)
  $4340.TextExtractionDatasetMetadata ensureTextExtractionDatasetMetadata() => $_ensure(10);

  /// Metadata for a dataset used for text sentiment.
  @$pb.TagNumber(30)
  $4340.TextSentimentDatasetMetadata get textSentimentDatasetMetadata => $_getN(11);
  @$pb.TagNumber(30)
  set textSentimentDatasetMetadata($4340.TextSentimentDatasetMetadata v) { setField(30, v); }
  @$pb.TagNumber(30)
  $core.bool hasTextSentimentDatasetMetadata() => $_has(11);
  @$pb.TagNumber(30)
  void clearTextSentimentDatasetMetadata() => clearField(30);
  @$pb.TagNumber(30)
  $4340.TextSentimentDatasetMetadata ensureTextSentimentDatasetMetadata() => $_ensure(11);
