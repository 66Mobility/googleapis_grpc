...
import 'annotation_payload.pb.dart' as $4340;
...
class PredictRequest extends $pb.GeneratedMessage {
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(_omitMessageNames ? '' : 'PredictRequest', package: const $pb.PackageName(_omitMessageNames ? '' : 'google.cloud.automl.v1'), createEmptyInstance: create)
    ...
    ..aOM<$4333.ExamplePayload>(2, _omitFieldNames ? '' : 'payload', subBuilder: $4333.ExamplePayload.create)
  ...
  @$pb.TagNumber(2)
  $4333.ExamplePayload get payload => $_getN(1);
  @$pb.TagNumber(2)
  set payload($4333.ExamplePayload v) { setField(2, v); }
  @$pb.TagNumber(2)
  $core.bool hasPayload() => $_has(1);
  @$pb.TagNumber(2)
  void clearPayload() => clearField(2);
  @$pb.TagNumber(2)
  $4333.ExamplePayload ensurePayload() => $_ensure(1);
...
class PredictResponse extends $pb.GeneratedMessage {
  factory PredictResponse({
    $core.Iterable<$4340.AnnotationPayload>? payload,
    $core.Map<$core.String, $core.String>? metadata,
    $4333.ExamplePayload? preprocessedInput,
  }) {
    final $result = create();
    if (payload != null) {
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(_omitMessageNames ? '' : 'PredictResponse', package: const $pb.PackageName(_omitMessageNames ? '' : 'google.cloud.automl.v1'), createEmptyInstance: create)
    ..pc<$4340.AnnotationPayload>(1, _omitFieldNames ? '' : 'payload', $pb.PbFieldType.PM, subBuilder: $4340.AnnotationPayload.create)
    ...
    ..aOM<$4333.ExamplePayload>(3, _omitFieldNames ? '' : 'preprocessedInput', subBuilder: $4333.ExamplePayload.create)
    ..hasRequiredFields = false
  ;
  ...
  @$pb.TagNumber(1)
  $core.List<$4340.AnnotationPayload> get payload => $_getList(0);
  ...
  ///  property.
  @$pb.TagNumber(3)
  $4333.ExamplePayload get preprocessedInput => $_getN(2);
  @$pb.TagNumber(3)
  set preprocessedInput($4333.ExamplePayload v) { setField(3, v); }
  @$pb.TagNumber(3)
  $core.bool hasPreprocessedInput() => $_has(2);
  @$pb.TagNumber(3)
  void clearPreprocessedInput() => clearField(3);
  @$pb.TagNumber(3)
  $4333.ExamplePayload ensurePreprocessedInput() => $_ensure(2);
}
...
class BatchPredictRequest extends $pb.GeneratedMessage {
  factory BatchPredictRequest({
    ...
    $4332.BatchPredictOutputConfig? outputConfig,
    $core.Map<$core.String, $core.String>? params,
  }) {
    final $result = create();
    if (name != null) {
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(_omitMessageNames ? '' : 'BatchPredictRequest', package: const $pb.PackageName(_omitMessageNames ? '' : 'google.cloud.automl.v1'), createEmptyInstance: create)
    ..aOS(1, _omitFieldNames ? '' : 'name')
    ..aOM<$4332.BatchPredictInputConfig>(3, _omitFieldNames ? '' : 'inputConfig', subBuilder: $4332.BatchPredictInputConfig.create)
    ..aOM<$4332.BatchPredictOutputConfig>(4, _omitFieldNames ? '' : 'outputConfig', subBuilder: $4332.BatchPredictOutputConfig.create)
  ...
  @$pb.TagNumber(3)
  $4332.BatchPredictInputConfig get inputConfig => $_getN(1);
  @$pb.TagNumber(3)
  set inputConfig($4332.BatchPredictInputConfig v) { setField(3, v); }
  @$pb.TagNumber(3)
  $core.bool hasInputConfig() => $_has(1);
  @$pb.TagNumber(3)
  void clearInputConfig() => clearField(3);
  @$pb.TagNumber(3)
  $4332.BatchPredictInputConfig ensureInputConfig() => $_ensure(1);

  /// Required. The Configuration specifying where output predictions should
  /// be written.
  @$pb.TagNumber(4)
  $4332.BatchPredictOutputConfig get outputConfig => $_getN(2);
  @$pb.TagNumber(4)
  set outputConfig($4332.BatchPredictOutputConfig v) { setField(4, v); }
  @$pb.TagNumber(4)
  $core.bool hasOutputConfig() => $_has(2);
  @$pb.TagNumber(4)
  void clearOutputConfig() => clearField(4);
  @$pb.TagNumber(4)
  $4332.BatchPredictOutputConfig ensureOutputConfig() => $_ensure(2);
