...
class TextClassificationModelMetadata extends $pb.GeneratedMessage {
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(_omitMessageNames ? '' : 'TextClassificationModelMetadata', package: const $pb.PackageName(_omitMessageNames ? '' : 'google.cloud.automl.v1'), createEmptyInstance: create)
    ..e<$4332.ClassificationType>(3, _omitFieldNames ? '' : 'classificationType', $pb.PbFieldType.OE, defaultOrMaker: $4332.ClassificationType.CLASSIFICATION_TYPE_UNSPECIFIED, valueOf: $4332.ClassificationType.valueOf, enumValues: $4332.ClassificationType.values)
    ..hasRequiredFields = false
  ;
  ...
  $4332.ClassificationType get classificationType => $_getN(0);
  @$pb.TagNumber(3)
  set classificationType($4332.ClassificationType v) { setField(3, v); }
  @$pb.TagNumber(3)
  $core.bool hasClassificationType() => $_has(0);
  @$pb.TagNumber(3)
