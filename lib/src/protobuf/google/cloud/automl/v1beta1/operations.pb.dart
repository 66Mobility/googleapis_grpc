...
class BatchPredictOperationMetadata extends $pb.GeneratedMessage {
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(_omitMessageNames ? '' : 'BatchPredictOperationMetadata', package: const $pb.PackageName(_omitMessageNames ? '' : 'google.cloud.automl.v1beta1'), createEmptyInstance: create)
    ..aOM<$4345.BatchPredictInputConfig>(1, _omitFieldNames ? '' : 'inputConfig', subBuilder: $4345.BatchPredictInputConfig.create)
  ...
  @$pb.TagNumber(1)
  $4345.BatchPredictInputConfig get inputConfig => $_getN(0);
  @$pb.TagNumber(1)
  set inputConfig($4345.BatchPredictInputConfig v) { setField(1, v); }
  @$pb.TagNumber(1)
  $core.bool hasInputConfig() => $_has(0);
  @$pb.TagNumber(1)
  void clearInputConfig() => clearField(1);
  @$pb.TagNumber(1)
  $4345.BatchPredictInputConfig ensureInputConfig() => $_ensure(0);
