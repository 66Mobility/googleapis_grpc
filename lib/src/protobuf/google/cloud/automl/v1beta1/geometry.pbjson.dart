...
const BoundingPoly$json = {
  '1': 'BoundingPoly',
  '2': [
    {'1': 'normalized_vertices', '3': 2, '4': 3, '5': 11, '6': '.google.cloud.automl.v1beta1.NormalizedVertex', '10': 'normalizedVertices'},
  ],
};
...
final $typed_data.Uint8List boundingPolyDescriptor = $convert.base64Decode(
    'CgxCb3VuZGluZ1BvbHkSXgoTbm9ybWFsaXplZF92ZXJ0aWNlcxgCIAMoCzItLmdvb2dsZS5jbG'
    '91ZC5hdXRvbWwudjFiZXRhMS5Ob3JtYWxpemVkVmVydGV4UhJub3JtYWxpemVkVmVydGljZXM=');
