...
class ModelEvaluation extends $pb.GeneratedMessage {
  factory ModelEvaluation({
    ...
    if (videoObjectTrackingEvaluationMetrics != null) {
      $result.videoObjectTrackingEvaluationMetrics = videoObjectTrackingEvaluationMetrics;
    }
    if (displayName != null) {
      $result.displayName = displayName;
    }
    if (regressionEvaluationMetrics != null) {
      $result.regressionEvaluationMetrics = regressionEvaluationMetrics;
    }
    return $result;
  }
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(_omitMessageNames ? '' : 'ModelEvaluation', package: const $pb.PackageName(_omitMessageNames ? '' : 'google.cloud.automl.v1beta1'), createEmptyInstance: create)
