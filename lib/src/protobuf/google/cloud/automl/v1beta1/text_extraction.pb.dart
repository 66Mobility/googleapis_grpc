...
class TextExtractionAnnotation extends $pb.GeneratedMessage {
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(_omitMessageNames ? '' : 'TextExtractionAnnotation', package: const $pb.PackageName(_omitMessageNames ? '' : 'google.cloud.automl.v1beta1'), createEmptyInstance: create)
    ..oo(0, [3])
    ..a<$core.double>(1, _omitFieldNames ? '' : 'score', $pb.PbFieldType.OF)
    ..aOM<$4347.TextSegment>(3, _omitFieldNames ? '' : 'textSegment', subBuilder: $4347.TextSegment.create)
  ...
  @$pb.TagNumber(3)
  $4347.TextSegment get textSegment => $_getN(1);
  @$pb.TagNumber(3)
  set textSegment($4347.TextSegment v) { setField(3, v); }
  @$pb.TagNumber(3)
  $core.bool hasTextSegment() => $_has(1);
  @$pb.TagNumber(3)
  void clearTextSegment() => clearField(3);
  @$pb.TagNumber(3)
  $4347.TextSegment ensureTextSegment() => $_ensure(1);
}
...
class TextExtractionEvaluationMetrics_ConfidenceMetricsEntry extends $pb.GeneratedMessage {
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(_omitMessageNames ? '' : 'TextExtractionEvaluationMetrics.ConfidenceMetricsEntry', package: const $pb.PackageName(_omitMessageNames ? '' : 'google.cloud.automl.v1beta1'), createEmptyInstance: create)
...
class TextExtractionEvaluationMetrics extends $pb.GeneratedMessage {
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(_omitMessageNames ? '' : 'TextExtractionEvaluationMetrics', package: const $pb.PackageName(_omitMessageNames ? '' : 'google.cloud.automl.v1beta1'), createEmptyInstance: create)
