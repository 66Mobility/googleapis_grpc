...
class TextExtractionAnnotation extends $pb.GeneratedMessage {
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(_omitMessageNames ? '' : 'TextExtractionAnnotation', package: const $pb.PackageName(_omitMessageNames ? '' : 'google.cloud.automl.v1beta1'), createEmptyInstance: create)
    ...
    ..aOM<$4346.TextSegment>(3, _omitFieldNames ? '' : 'textSegment', subBuilder: $4346.TextSegment.create)
  ...
  @$pb.TagNumber(3)
  $4346.TextSegment get textSegment => $_getN(1);
  @$pb.TagNumber(3)
  set textSegment($4346.TextSegment v) { setField(3, v); }
  @$pb.TagNumber(3)
  $core.bool hasTextSegment() => $_has(1);
  @$pb.TagNumber(3)
  void clearTextSegment() => clearField(3);
  @$pb.TagNumber(3)
  $4346.TextSegment ensureTextSegment() => $_ensure(1);
}
