...
class TranslationDatasetMetadata extends $pb.GeneratedMessage {
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(_omitMessageNames ? '' : 'TranslationDatasetMetadata', package: const $pb.PackageName(_omitMessageNames ? '' : 'google.cloud.automl.v1beta1'), createEmptyInstance: create)
  ...
  'Will be removed in next major version')
  TranslationDatasetMetadata copyWith(void Function(TranslationDatasetMetadata) updates) => super.copyWith((message) => updates(message as TranslationDatasetMetadata)) as TranslationDatasetMetadata;
...
class TranslationEvaluationMetrics extends $pb.GeneratedMessage {
  factory TranslationEvaluationMetrics({
    ...
    final $result = create();
    if (bleuScore != null) {
      $result.bleuScore = bleuScore;
    }
    if (baseBleuScore != null) {
      $result.baseBleuScore = baseBleuScore;
    }
    return $result;
  }
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(_omitMessageNames ? '' : 'TranslationEvaluationMetrics', package: const $pb.PackageName(_omitMessageNames ? '' : 'google.cloud.automl.v1beta1'), createEmptyInstance: create)
    ..a<$core.double>(1, _omitFieldNames ? '' : 'bleuScore', $pb.PbFieldType.OD)
    ..a<$core.double>(2, _omitFieldNames ? '' : 'baseBleuScore', $pb.PbFieldType.OD)
    ..hasRequiredFields = false
  ;
  ...
  'Use [GeneratedMessageGenericExtensions.rebuild] instead. '
  'Will be removed in next major version')
  TranslationEvaluationMetrics copyWith(void Function(TranslationEvaluationMetrics) updates) => super.copyWith((message) => updates(message as TranslationEvaluationMetrics)) as TranslationEvaluationMetrics;
...
class TranslationModelMetadata extends $pb.GeneratedMessage {
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(_omitMessageNames ? '' : 'TranslationModelMetadata', package: const $pb.PackageName(_omitMessageNames ? '' : 'google.cloud.automl.v1beta1'), createEmptyInstance: create)
    ..aOS(1, _omitFieldNames ? '' : 'baseModel')
  ...
  'Use [GeneratedMessageGenericExtensions.rebuild] instead. '
  'Will be removed in next major version')
  TranslationModelMetadata copyWith(void Function(TranslationModelMetadata) updates) => super.copyWith((message) => updates(message as TranslationModelMetadata)) as TranslationModelMetadata;
...
class TranslationAnnotation extends $pb.GeneratedMessage {
  factory TranslationAnnotation({
    $4349.TextSnippet? translatedContent,
  }) {
    final $result = create();
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(_omitMessageNames ? '' : 'TranslationAnnotation', package: const $pb.PackageName(_omitMessageNames ? '' : 'google.cloud.automl.v1beta1'), createEmptyInstance: create)
    ..aOM<$4349.TextSnippet>(1, _omitFieldNames ? '' : 'translatedContent', subBuilder: $4349.TextSnippet.create)
    ..hasRequiredFields = false
  ;
  ...
  'Use [GeneratedMessageGenericExtensions.rebuild] instead. '
  'Will be removed in next major version')
  TranslationAnnotation copyWith(void Function(TranslationAnnotation) updates) => super.copyWith((message) => updates(message as TranslationAnnotation)) as TranslationAnnotation;
  ...
  @$pb.TagNumber(1)
  $4349.TextSnippet get translatedContent => $_getN(0);
  @$pb.TagNumber(1)
  set translatedContent($4349.TextSnippet v) { setField(1, v); }
  @$pb.TagNumber(1)
  $core.bool hasTranslatedContent() => $_has(0);
  @$pb.TagNumber(1)
  void clearTranslatedContent() => clearField(1);
  @$pb.TagNumber(1)
  $4349.TextSnippet ensureTranslatedContent() => $_ensure(0);
}
