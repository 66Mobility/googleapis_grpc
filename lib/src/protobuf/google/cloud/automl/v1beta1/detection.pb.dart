...
class BoundingBoxMetricsEntry_ConfidenceMetricsEntry extends $pb.GeneratedMessage {
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(_omitMessageNames ? '' : 'BoundingBoxMetricsEntry.ConfidenceMetricsEntry', package: const $pb.PackageName(_omitMessageNames ? '' : 'google.cloud.automl.v1beta1'), createEmptyInstance: create)
...
class BoundingBoxMetricsEntry extends $pb.GeneratedMessage {
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(_omitMessageNames ? '' : 'BoundingBoxMetricsEntry', package: const $pb.PackageName(_omitMessageNames ? '' : 'google.cloud.automl.v1beta1'), createEmptyInstance: create)
...
class ImageObjectDetectionEvaluationMetrics extends $pb.GeneratedMessage {
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(_omitMessageNames ? '' : 'ImageObjectDetectionEvaluationMetrics', package: const $pb.PackageName(_omitMessageNames ? '' : 'google.cloud.automl.v1beta1'), createEmptyInstance: create)
...
class VideoObjectTrackingEvaluationMetrics extends $pb.GeneratedMessage {
  factory VideoObjectTrackingEvaluationMetrics({
    ...
    if (evaluatedFrameCount != null) {
      $result.evaluatedFrameCount = evaluatedFrameCount;
    }
    if (evaluatedBoundingBoxCount != null) {
      $result.evaluatedBoundingBoxCount = evaluatedBoundingBoxCount;
    }
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(_omitMessageNames ? '' : 'VideoObjectTrackingEvaluationMetrics', package: const $pb.PackageName(_omitMessageNames ? '' : 'google.cloud.automl.v1beta1'), createEmptyInstance: create)
    ..a<$core.int>(1, _omitFieldNames ? '' : 'evaluatedFrameCount', $pb.PbFieldType.O3)
    ..a<$core.int>(2, _omitFieldNames ? '' : 'evaluatedBoundingBoxCount', $pb.PbFieldType.O3)
    ..pc<BoundingBoxMetricsEntry>(4, _omitFieldNames ? '' : 'boundingBoxMetricsEntries', $pb.PbFieldType.PM, subBuilder: BoundingBoxMetricsEntry.create)
    ..a<$core.double>(6, _omitFieldNames ? '' : 'boundingBoxMeanAveragePrecision', $pb.PbFieldType.OF)
    ..hasRequiredFields = false
  ;
  ...
  'Use [GeneratedMessageGenericExtensions.rebuild] instead. '
  'Will be removed in next major version')
  VideoObjectTrackingEvaluationMetrics copyWith(void Function(VideoObjectTrackingEvaluationMetrics) updates) => super.copyWith((message) => updates(message as VideoObjectTrackingEvaluationMetrics)) as VideoObjectTrackingEvaluationMetrics;
