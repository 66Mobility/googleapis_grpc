...
class TemporalAsset extends $pb.GeneratedMessage {
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(_omitMessageNames ? '' : 'TemporalAsset', package: const $pb.PackageName(_omitMessageNames ? '' : 'google.cloud.asset.v1p2beta1'), createEmptyInstance: create)
...
class Asset extends $pb.GeneratedMessage {
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(_omitMessageNames ? '' : 'Asset', package: const $pb.PackageName(_omitMessageNames ? '' : 'google.cloud.asset.v1p2beta1'), createEmptyInstance: create)
    ..oo(0, [7, 8, 9])
    ...
    ..pPS(6, _omitFieldNames ? '' : 'ancestors')
...
class Resource extends $pb.GeneratedMessage {
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(_omitMessageNames ? '' : 'Resource', package: const $pb.PackageName(_omitMessageNames ? '' : 'google.cloud.asset.v1p2beta1'), createEmptyInstance: create)
