...
class ResourceSearchResult extends $pb.GeneratedMessage {
  factory ResourceSearchResult({
    ...
    $1735.Struct? additionalAttributes,
  @$core.Deprecated('This field is deprecated.')
    $core.String? kmsKey,
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(_omitMessageNames ? '' : 'ResourceSearchResult', package: const $pb.PackageName(_omitMessageNames ? '' : 'google.cloud.asset.v1'), createEmptyInstance: create)
    ...
    ..aOM<$1735.Struct>(9, _omitFieldNames ? '' : 'additionalAttributes', subBuilder: $1735.Struct.create)
  ...
  ///    `foobar`.
  @$pb.TagNumber(9)
  $1735.Struct get additionalAttributes => $_getN(8);
  @$pb.TagNumber(9)
  set additionalAttributes($1735.Struct v) { setField(9, v); }
  @$pb.TagNumber(9)
  $core.bool hasAdditionalAttributes() => $_has(8);
  @$pb.TagNumber(9)
  void clearAdditionalAttributes() => clearField(9);
  @$pb.TagNumber(9)
  $1735.Struct ensureAdditionalAttributes() => $_ensure(8);
...
class VersionedResource extends $pb.GeneratedMessage {
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(_omitMessageNames ? '' : 'VersionedResource', package: const $pb.PackageName(_omitMessageNames ? '' : 'google.cloud.asset.v1'), createEmptyInstance: create)
    ..aOS(1, _omitFieldNames ? '' : 'version')
    ..aOM<$1735.Struct>(2, _omitFieldNames ? '' : 'resource', subBuilder: $1735.Struct.create)
    ..hasRequiredFields = false
  ;
  ...
  @$pb.TagNumber(2)
  $1735.Struct get resource => $_getN(1);
  @$pb.TagNumber(2)
  set resource($1735.Struct v) { setField(2, v); }
  @$pb.TagNumber(2)
  $core.bool hasResource() => $_has(1);
  @$pb.TagNumber(2)
  void clearResource() => clearField(2);
  @$pb.TagNumber(2)
  $1735.Struct ensureResource() => $_ensure(1);
}
