...
const ListQueuesResponse$json = {
  ...
  '2': [
    {'1': 'queues', '3': 1, '4': 3, '5': 11, '6': '.google.cloud.tasks.v2beta3.Queue', '10': 'queues'},
...
final $typed_data.Uint8List listQueuesResponseDescriptor = $convert.base64Decode(
    ...
    'tzLnYyYmV0YTMuUXVldWVSBnF1ZXVlcxImCg9uZXh0X3BhZ2VfdG9rZW4YAiABKAlSDW5leHRQ'
    'YWdlVG9rZW4=');
...
const CreateQueueRequest$json = {
  ...
  '2': [
    {'1': 'parent', '3': 1, '4': 1, '5': 9, '8': {}, '10': 'parent'},
    {'1': 'queue', '3': 2, '4': 1, '5': 11, '6': '.google.cloud.tasks.v2beta3.Queue', '8': {}, '10': 'queue'},
  ],
};
...
final $typed_data.Uint8List createQueueRequestDescriptor = $convert.base64Decode(
    ...
    'bG91ZC50YXNrcy52MmJldGEzLlF1ZXVlQgPgQQJSBXF1ZXVl');

@$core.Deprecated('Use updateQueueRequestDescriptor instead')
const UpdateQueueRequest$json = {
  '1': 'UpdateQueueRequest',
  '2': [
    {'1': 'queue', '3': 1, '4': 1, '5': 11, '6': '.google.cloud.tasks.v2beta3.Queue', '8': {}, '10': 'queue'},
...
final $typed_data.Uint8List updateQueueRequestDescriptor = $convert.base64Decode(
    ...
    'MudjJiZXRhMy5RdWV1ZUID4EECUgVxdWV1ZRI7Cgt1cGRhdGVfbWFzaxgCIAEoCzIaLmdvb2ds'
...
const ListTasksRequest$json = {
  ...
  '2': [
    {'1': 'parent', '3': 1, '4': 1, '5': 9, '8': {}, '10': 'parent'},
    {'1': 'response_view', '3': 2, '4': 1, '5': 14, '6': '.google.cloud.tasks.v2beta3.Task.View', '10': 'responseView'},
    {'1': 'page_size', '3': 3, '4': 1, '5': 5, '10': 'pageSize'},
    {'1': 'page_token', '3': 4, '4': 1, '5': 9, '10': 'pageToken'},
  ],
};
...
final $typed_data.Uint8List listTasksRequestDescriptor = $convert.base64Decode(
    ...
    'Z2xlLmNsb3VkLnRhc2tzLnYyYmV0YTMuVGFzay5WaWV3UgxyZXNwb25zZVZpZXcSGwoJcGFnZV'
...
const ListTasksResponse$json = {
  '1': 'ListTasksResponse',
  '2': [
    {'1': 'tasks', '3': 1, '4': 3, '5': 11, '6': '.google.cloud.tasks.v2beta3.Task', '10': 'tasks'},
    {'1': 'next_page_token', '3': 2, '4': 1, '5': 9, '10': 'nextPageToken'},
  ],
};
...
final $typed_data.Uint8List listTasksResponseDescriptor = $convert.base64Decode(
    ...
    '52MmJldGEzLlRhc2tSBXRhc2tzEiYKD25leHRfcGFnZV90b2tlbhgCIAEoCVINbmV4dFBhZ2VU'
    'b2tlbg==');
...
final $typed_data.Uint8List getTaskRequestDescriptor = $convert.base64Decode(
    ...
    'b3VkLnRhc2tzLnYyYmV0YTMuVGFzay5WaWV3UgxyZXNwb25zZVZpZXc=');
...
const CreateTaskRequest$json = {
  ...
  '2': [
    {'1': 'parent', '3': 1, '4': 1, '5': 9, '8': {}, '10': 'parent'},
    {'1': 'task', '3': 2, '4': 1, '5': 11, '6': '.google.cloud.tasks.v2beta3.Task', '8': {}, '10': 'task'},
    {'1': 'response_view', '3': 3, '4': 1, '5': 14, '6': '.google.cloud.tasks.v2beta3.Task.View', '10': 'responseView'},
  ],
};
...
final $typed_data.Uint8List createTaskRequestDescriptor = $convert.base64Decode(
    ...
    'ZC50YXNrcy52MmJldGEzLlRhc2tCA+BBAlIEdGFzaxJKCg1yZXNwb25zZV92aWV3GAMgASgOMi'
    'UuZ29vZ2xlLmNsb3VkLnRhc2tzLnYyYmV0YTMuVGFzay5WaWV3UgxyZXNwb25zZVZpZXc=');
