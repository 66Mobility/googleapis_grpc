...
const UriOverride$json = {
  '1': 'UriOverride',
  '2': [
    {'1': 'scheme', '3': 1, '4': 1, '5': 14, '6': '.google.cloud.tasks.v2beta3.UriOverride.Scheme', '9': 0, '10': 'scheme', '17': true},
    {'1': 'host', '3': 2, '4': 1, '5': 9, '9': 1, '10': 'host', '17': true},
    {'1': 'port', '3': 3, '4': 1, '5': 3, '9': 2, '10': 'port', '17': true},
    {'1': 'path_override', '3': 4, '4': 1, '5': 11, '6': '.google.cloud.tasks.v2beta3.PathOverride', '10': 'pathOverride'},
    {'1': 'query_override', '3': 5, '4': 1, '5': 11, '6': '.google.cloud.tasks.v2beta3.QueryOverride', '10': 'queryOverride'},
    {'1': 'uri_override_enforce_mode', '3': 6, '4': 1, '5': 14, '6': '.google.cloud.tasks.v2beta3.UriOverride.UriOverrideEnforceMode', '10': 'uriOverrideEnforceMode'},
  ],
...
final $typed_data.Uint8List uriOverrideDescriptor = $convert.base64Decode(
    ...
    'RhMy5VcmlPdmVycmlkZS5TY2hlbWVIAFIGc2NoZW1liAEBEhcKBGhvc3QYAiABKAlIAVIEaG9z'
    'dIgBARIXCgRwb3J0GAMgASgDSAJSBHBvcnSIAQESTQoNcGF0aF9vdmVycmlkZRgEIAEoCzIoLm'
    'dvb2dsZS5jbG91ZC50YXNrcy52MmJldGEzLlBhdGhPdmVycmlkZVIMcGF0aE92ZXJyaWRlElAK'
    'DnF1ZXJ5X292ZXJyaWRlGAUgASgLMikuZ29vZ2xlLmNsb3VkLnRhc2tzLnYyYmV0YTMuUXVlcn'
    'lPdmVycmlkZVINcXVlcnlPdmVycmlkZRJ5Chl1cmlfb3ZlcnJpZGVfZW5mb3JjZV9tb2RlGAYg'
    'ASgOMj4uZ29vZ2xlLmNsb3VkLnRhc2tzLnYyYmV0YTMuVXJpT3ZlcnJpZGUuVXJpT3ZlcnJpZG'
...
const HttpTarget$json = {
  '1': 'HttpTarget',
  '2': [
    {'1': 'uri_override', '3': 1, '4': 1, '5': 11, '6': '.google.cloud.tasks.v2beta3.UriOverride', '10': 'uriOverride'},
    {'1': 'http_method', '3': 2, '4': 1, '5': 14, '6': '.google.cloud.tasks.v2beta3.HttpMethod', '10': 'httpMethod'},
    {'1': 'header_overrides', '3': 3, '4': 3, '5': 11, '6': '.google.cloud.tasks.v2beta3.HttpTarget.HeaderOverride', '10': 'headerOverrides'},
    {'1': 'oauth_token', '3': 5, '4': 1, '5': 11, '6': '.google.cloud.tasks.v2beta3.OAuthToken', '9': 0, '10': 'oauthToken'},
    {'1': 'oidc_token', '3': 6, '4': 1, '5': 11, '6': '.google.cloud.tasks.v2beta3.OidcToken', '9': 0, '10': 'oidcToken'},
  ],
...
const HttpTarget_HeaderOverride$json = {
  '1': 'HeaderOverride',
  '2': [
    {'1': 'header', '3': 1, '4': 1, '5': 11, '6': '.google.cloud.tasks.v2beta3.HttpTarget.Header', '10': 'header'},
  ],
};
...
final $typed_data.Uint8List httpTargetDescriptor = $convert.base64Decode(
    ...
    '52MmJldGEzLlVyaU92ZXJyaWRlUgt1cmlPdmVycmlkZRJHCgtodHRwX21ldGhvZBgCIAEoDjIm'
    'Lmdvb2dsZS5jbG91ZC50YXNrcy52MmJldGEzLkh0dHBNZXRob2RSCmh0dHBNZXRob2QSYAoQaG'
    'VhZGVyX292ZXJyaWRlcxgDIAMoCzI1Lmdvb2dsZS5jbG91ZC50YXNrcy52MmJldGEzLkh0dHBU'
    'YXJnZXQuSGVhZGVyT3ZlcnJpZGVSD2hlYWRlck92ZXJyaWRlcxJJCgtvYXV0aF90b2tlbhgFIA'
    'EoCzImLmdvb2dsZS5jbG91ZC50YXNrcy52MmJldGEzLk9BdXRoVG9rZW5IAFIKb2F1dGhUb2tl'
    'bhJGCgpvaWRjX3Rva2VuGAYgASgLMiUuZ29vZ2xlLmNsb3VkLnRhc2tzLnYyYmV0YTMuT2lkY1'
    ...
    '5jbG91ZC50YXNrcy52MmJldGEzLkh0dHBUYXJnZXQuSGVhZGVyUgZoZWFkZXJCFgoUYXV0aG9y'
    'aXphdGlvbl9oZWFkZXI=');
...
const HttpRequest$json = {
  ...
  '2': [
    ...
    {'1': 'http_method', '3': 2, '4': 1, '5': 14, '6': '.google.cloud.tasks.v2beta3.HttpMethod', '10': 'httpMethod'},
    {'1': 'headers', '3': 3, '4': 3, '5': 11, '6': '.google.cloud.tasks.v2beta3.HttpRequest.HeadersEntry', '10': 'headers'},
...
final $typed_data.Uint8List httpRequestDescriptor = $convert.base64Decode(
    'CgtIdHRwUmVxdWVzdBIQCgN1cmwYASABKAlSA3VybBJHCgtodHRwX21ldGhvZBgCIAEoDjImLm'
    'dvb2dsZS5jbG91ZC50YXNrcy52MmJldGEzLkh0dHBNZXRob2RSCmh0dHBNZXRob2QSTgoHaGVh'
    'ZGVycxgDIAMoCzI0Lmdvb2dsZS5jbG91ZC50YXNrcy52MmJldGEzLkh0dHBSZXF1ZXN0LkhlYW'
    'RlcnNFbnRyeVIHaGVhZGVycxISCgRib2R5GAQgASgMUgRib2R5EkkKC29hdXRoX3Rva2VuGAUg'
    'ASgLMiYuZ29vZ2xlLmNsb3VkLnRhc2tzLnYyYmV0YTMuT0F1dGhUb2tlbkgAUgpvYXV0aFRva2'
    'VuEkYKCm9pZGNfdG9rZW4YBiABKAsyJS5nb29nbGUuY2xvdWQudGFza3MudjJiZXRhMy5PaWRj'
    'VG9rZW5IAFIJb2lkY1Rva2VuGjoKDEhlYWRlcnNFbnRyeRIQCgNrZXkYASABKAlSA2tleRIUCg'
    'V2YWx1ZRgCIAEoCVIFdmFsdWU6AjgBQhYKFGF1dGhvcml6YXRpb25faGVhZGVy');

@$core.Deprecated('Use appEngineHttpQueueDescriptor instead')
const AppEngineHttpQueue$json = {
  '1': 'AppEngineHttpQueue',
  '2': [
    {'1': 'app_engine_routing_override', '3': 1, '4': 1, '5': 11, '6': '.google.cloud.tasks.v2beta3.AppEngineRouting', '10': 'appEngineRoutingOverride'},
  ],
};
...
final $typed_data.Uint8List appEngineHttpQueueDescriptor = $convert.base64Decode(
    'ChJBcHBFbmdpbmVIdHRwUXVldWUSawobYXBwX2VuZ2luZV9yb3V0aW5nX292ZXJyaWRlGAEgAS'
    'gLMiwuZ29vZ2xlLmNsb3VkLnRhc2tzLnYyYmV0YTMuQXBwRW5naW5lUm91dGluZ1IYYXBwRW5n'
    'aW5lUm91dGluZ092ZXJyaWRl');

@$core.Deprecated('Use appEngineHttpRequestDescriptor instead')
const AppEngineHttpRequest$json = {
  '1': 'AppEngineHttpRequest',
  '2': [
    {'1': 'http_method', '3': 1, '4': 1, '5': 14, '6': '.google.cloud.tasks.v2beta3.HttpMethod', '10': 'httpMethod'},
    {'1': 'app_engine_routing', '3': 2, '4': 1, '5': 11, '6': '.google.cloud.tasks.v2beta3.AppEngineRouting', '10': 'appEngineRouting'},
    {'1': 'relative_uri', '3': 3, '4': 1, '5': 9, '10': 'relativeUri'},
    {'1': 'headers', '3': 4, '4': 3, '5': 11, '6': '.google.cloud.tasks.v2beta3.AppEngineHttpRequest.HeadersEntry', '10': 'headers'},
...
final $typed_data.Uint8List appEngineHttpRequestDescriptor = $convert.base64Decode(
    ...
    '91ZC50YXNrcy52MmJldGEzLkh0dHBNZXRob2RSCmh0dHBNZXRob2QSWgoSYXBwX2VuZ2luZV9y'
    'b3V0aW5nGAIgASgLMiwuZ29vZ2xlLmNsb3VkLnRhc2tzLnYyYmV0YTMuQXBwRW5naW5lUm91dG'
    'luZ1IQYXBwRW5naW5lUm91dGluZxIhCgxyZWxhdGl2ZV91cmkYAyABKAlSC3JlbGF0aXZlVXJp'
    'ElcKB2hlYWRlcnMYBCADKAsyPS5nb29nbGUuY2xvdWQudGFza3MudjJiZXRhMy5BcHBFbmdpbm'
    'VIdHRwUmVxdWVzdC5IZWFkZXJzRW50cnlSB2hlYWRlcnMSEgoEYm9keRgFIAEoDFIEYm9keRo6'
