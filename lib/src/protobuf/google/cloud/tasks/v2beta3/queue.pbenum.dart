...
class Queue_Type extends $pb.ProtobufEnum {
  static const Queue_Type TYPE_UNSPECIFIED = Queue_Type._(0, _omitEnumNames ? '' : 'TYPE_UNSPECIFIED');
  static const Queue_Type PULL = Queue_Type._(1, _omitEnumNames ? '' : 'PULL');
  static const Queue_Type PUSH = Queue_Type._(2, _omitEnumNames ? '' : 'PUSH');
