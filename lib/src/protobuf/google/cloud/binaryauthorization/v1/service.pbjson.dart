...
const UpdatePolicyRequest$json = {
  ...
  '2': [
    {'1': 'policy', '3': 1, '4': 1, '5': 11, '6': '.google.cloud.binaryauthorization.v1.Policy', '8': {}, '10': 'policy'},
  ],
};
...
final $typed_data.Uint8List updatePolicyRequestDescriptor = $convert.base64Decode(
    'ChNVcGRhdGVQb2xpY3lSZXF1ZXN0EkgKBnBvbGljeRgBIAEoCzIrLmdvb2dsZS5jbG91ZC5iaW'
    '5hcnlhdXRob3JpemF0aW9uLnYxLlBvbGljeUID4EECUgZwb2xpY3k=');
...
const CreateAttestorRequest$json = {
  ...
  '2': [
    ...
    {'1': 'attestor', '3': 3, '4': 1, '5': 11, '6': '.google.cloud.binaryauthorization.v1.Attestor', '8': {}, '10': 'attestor'},
  ],
};
...
final $typed_data.Uint8List createAttestorRequestDescriptor = $convert.base64Decode(
    ...
    'cl9pZBgCIAEoCUID4EECUgphdHRlc3RvcklkEk4KCGF0dGVzdG9yGAMgASgLMi0uZ29vZ2xlLm'
    'Nsb3VkLmJpbmFyeWF1dGhvcml6YXRpb24udjEuQXR0ZXN0b3JCA+BBAlIIYXR0ZXN0b3I=');
...
const UpdateAttestorRequest$json = {
  ...
  '2': [
    {'1': 'attestor', '3': 1, '4': 1, '5': 11, '6': '.google.cloud.binaryauthorization.v1.Attestor', '8': {}, '10': 'attestor'},
  ],
};
...
final $typed_data.Uint8List updateAttestorRequestDescriptor = $convert.base64Decode(
    'ChVVcGRhdGVBdHRlc3RvclJlcXVlc3QSTgoIYXR0ZXN0b3IYASABKAsyLS5nb29nbGUuY2xvdW'
    'QuYmluYXJ5YXV0aG9yaXphdGlvbi52MS5BdHRlc3RvckID4EECUghhdHRlc3Rvcg==');
...
const ListAttestorsResponse$json = {
  ...
  '2': [
    {'1': 'attestors', '3': 1, '4': 3, '5': 11, '6': '.google.cloud.binaryauthorization.v1.Attestor', '10': 'attestors'},
...
final $typed_data.Uint8List listAttestorsResponseDescriptor = $convert.base64Decode(
    'ChVMaXN0QXR0ZXN0b3JzUmVzcG9uc2USSwoJYXR0ZXN0b3JzGAEgAygLMi0uZ29vZ2xlLmNsb3'
    'VkLmJpbmFyeWF1dGhvcml6YXRpb24udjEuQXR0ZXN0b3JSCWF0dGVzdG9ycxImCg9uZXh0X3Bh'
...
const ValidateAttestationOccurrenceRequest$json = {
  '1': 'ValidateAttestationOccurrenceRequest',
  '2': [
    {'1': 'attestor', '3': 1, '4': 1, '5': 9, '8': {}, '10': 'attestor'},
    {'1': 'attestation', '3': 2, '4': 1, '5': 11, '6': '.grafeas.v1.AttestationOccurrence', '8': {}, '10': 'attestation'},
    {'1': 'occurrence_note', '3': 3, '4': 1, '5': 9, '8': {}, '10': 'occurrenceNote'},
    {'1': 'occurrence_resource_uri', '3': 4, '4': 1, '5': 9, '8': {}, '10': 'occurrenceResourceUri'},
  ],
};

/// Descriptor for `ValidateAttestationOccurrenceRequest`. Decode as a `google.protobuf.DescriptorProto`.
final $typed_data.Uint8List validateAttestationOccurrenceRequestDescriptor = $convert.base64Decode(
    'CiRWYWxpZGF0ZUF0dGVzdGF0aW9uT2NjdXJyZW5jZVJlcXVlc3QSHwoIYXR0ZXN0b3IYASABKA'
    'lCA+BBAlIIYXR0ZXN0b3ISSAoLYXR0ZXN0YXRpb24YAiABKAsyIS5ncmFmZWFzLnYxLkF0dGVz'
    'dGF0aW9uT2NjdXJyZW5jZUID4EECUgthdHRlc3RhdGlvbhIsCg9vY2N1cnJlbmNlX25vdGUYAy'
    'ABKAlCA+BBAlIOb2NjdXJyZW5jZU5vdGUSOwoXb2NjdXJyZW5jZV9yZXNvdXJjZV91cmkYBCAB'
    'KAlCA+BBAlIVb2NjdXJyZW5jZVJlc291cmNlVXJp');

@$core.Deprecated('Use validateAttestationOccurrenceResponseDescriptor instead')
const ValidateAttestationOccurrenceResponse$json = {
  '1': 'ValidateAttestationOccurrenceResponse',
  '2': [
    {'1': 'result', '3': 1, '4': 1, '5': 14, '6': '.google.cloud.binaryauthorization.v1.ValidateAttestationOccurrenceResponse.Result', '10': 'result'},
    {'1': 'denial_reason', '3': 2, '4': 1, '5': 9, '10': 'denialReason'},
  ],
  '4': [ValidateAttestationOccurrenceResponse_Result$json],
};

@$core.Deprecated('Use validateAttestationOccurrenceResponseDescriptor instead')
const ValidateAttestationOccurrenceResponse_Result$json = {
  '1': 'Result',
  '2': [
    {'1': 'RESULT_UNSPECIFIED', '2': 0},
    {'1': 'VERIFIED', '2': 1},
    {'1': 'ATTESTATION_NOT_VERIFIABLE', '2': 2},
  ],
};

/// Descriptor for `ValidateAttestationOccurrenceResponse`. Decode as a `google.protobuf.DescriptorProto`.
final $typed_data.Uint8List validateAttestationOccurrenceResponseDescriptor = $convert.base64Decode(
    'CiVWYWxpZGF0ZUF0dGVzdGF0aW9uT2NjdXJyZW5jZVJlc3BvbnNlEmkKBnJlc3VsdBgBIAEoDj'
    'JRLmdvb2dsZS5jbG91ZC5iaW5hcnlhdXRob3JpemF0aW9uLnYxLlZhbGlkYXRlQXR0ZXN0YXRp'
    'b25PY2N1cnJlbmNlUmVzcG9uc2UuUmVzdWx0UgZyZXN1bHQSIwoNZGVuaWFsX3JlYXNvbhgCIA'
    'EoCVIMZGVuaWFsUmVhc29uIk4KBlJlc3VsdBIWChJSRVNVTFRfVU5TUEVDSUZJRUQQABIMCghW'
    'RVJJRklFRBABEh4KGkFUVEVTVEFUSU9OX05PVF9WRVJJRklBQkxFEAI=');
