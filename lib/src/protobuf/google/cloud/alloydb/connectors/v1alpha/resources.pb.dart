...
class MetadataExchangeRequest extends $pb.GeneratedMessage {
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(_omitMessageNames ? '' : 'MetadataExchangeRequest', package: const $pb.PackageName(_omitMessageNames ? '' : 'google.cloud.alloydb.connectors.v1alpha'), createEmptyInstance: create)
...
class MetadataExchangeResponse extends $pb.GeneratedMessage {
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(_omitMessageNames ? '' : 'MetadataExchangeResponse', package: const $pb.PackageName(_omitMessageNames ? '' : 'google.cloud.alloydb.connectors.v1alpha'), createEmptyInstance: create)
