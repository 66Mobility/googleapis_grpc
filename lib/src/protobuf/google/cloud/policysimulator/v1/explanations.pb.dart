...
class AccessTuple extends $pb.GeneratedMessage {
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(_omitMessageNames ? '' : 'AccessTuple', package: const $pb.PackageName(_omitMessageNames ? '' : 'google.cloud.policysimulator.v1'), createEmptyInstance: create)
...
class ExplainedPolicy extends $pb.GeneratedMessage {
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(_omitMessageNames ? '' : 'ExplainedPolicy', package: const $pb.PackageName(_omitMessageNames ? '' : 'google.cloud.policysimulator.v1'), createEmptyInstance: create)
...
class BindingExplanation_AnnotatedMembership extends $pb.GeneratedMessage {
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(_omitMessageNames ? '' : 'BindingExplanation.AnnotatedMembership', package: const $pb.PackageName(_omitMessageNames ? '' : 'google.cloud.policysimulator.v1'), createEmptyInstance: create)
...
class BindingExplanation extends $pb.GeneratedMessage {
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(_omitMessageNames ? '' : 'BindingExplanation', package: const $pb.PackageName(_omitMessageNames ? '' : 'google.cloud.policysimulator.v1'), createEmptyInstance: create)
    ..e<AccessState>(1, _omitFieldNames ? '' : 'access', $pb.PbFieldType.OE, defaultOrMaker: AccessState.ACCESS_STATE_UNSPECIFIED, valueOf: AccessState.valueOf, enumValues: AccessState.values)
