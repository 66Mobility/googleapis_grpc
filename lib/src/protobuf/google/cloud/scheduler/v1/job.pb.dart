...
class Job extends $pb.GeneratedMessage {
  factory Job({
    ...
    $4608.PubsubTarget? pubsubTarget,
    $4608.AppEngineHttpTarget? appEngineHttpTarget,
    $4608.HttpTarget? httpTarget,
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(_omitMessageNames ? '' : 'Job', package: const $pb.PackageName(_omitMessageNames ? '' : 'google.cloud.scheduler.v1'), createEmptyInstance: create)
    ..oo(0, [4, 5, 6])
    ..aOS(1, _omitFieldNames ? '' : 'name')
    ..aOS(2, _omitFieldNames ? '' : 'description')
    ..aOM<$4608.PubsubTarget>(4, _omitFieldNames ? '' : 'pubsubTarget', subBuilder: $4608.PubsubTarget.create)
    ..aOM<$4608.AppEngineHttpTarget>(5, _omitFieldNames ? '' : 'appEngineHttpTarget', subBuilder: $4608.AppEngineHttpTarget.create)
    ..aOM<$4608.HttpTarget>(6, _omitFieldNames ? '' : 'httpTarget', subBuilder: $4608.HttpTarget.create)
  ...
  /// Pub/Sub target.
  @$pb.TagNumber(4)
  $4608.PubsubTarget get pubsubTarget => $_getN(2);
  @$pb.TagNumber(4)
  set pubsubTarget($4608.PubsubTarget v) { setField(4, v); }
  @$pb.TagNumber(4)
  $core.bool hasPubsubTarget() => $_has(2);
  @$pb.TagNumber(4)
  void clearPubsubTarget() => clearField(4);
  @$pb.TagNumber(4)
  $4608.PubsubTarget ensurePubsubTarget() => $_ensure(2);

  /// App Engine HTTP target.
  @$pb.TagNumber(5)
  $4608.AppEngineHttpTarget get appEngineHttpTarget => $_getN(3);
  @$pb.TagNumber(5)
  set appEngineHttpTarget($4608.AppEngineHttpTarget v) { setField(5, v); }
  @$pb.TagNumber(5)
  $core.bool hasAppEngineHttpTarget() => $_has(3);
  @$pb.TagNumber(5)
  void clearAppEngineHttpTarget() => clearField(5);
  @$pb.TagNumber(5)
  $4608.AppEngineHttpTarget ensureAppEngineHttpTarget() => $_ensure(3);

  /// HTTP target.
  @$pb.TagNumber(6)
  $4608.HttpTarget get httpTarget => $_getN(4);
  @$pb.TagNumber(6)
  set httpTarget($4608.HttpTarget v) { setField(6, v); }
  @$pb.TagNumber(6)
  $core.bool hasHttpTarget() => $_has(4);
  @$pb.TagNumber(6)
  void clearHttpTarget() => clearField(6);
  @$pb.TagNumber(6)
  $4608.HttpTarget ensureHttpTarget() => $_ensure(4);
...
class RetryConfig extends $pb.GeneratedMessage {
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(_omitMessageNames ? '' : 'RetryConfig', package: const $pb.PackageName(_omitMessageNames ? '' : 'google.cloud.scheduler.v1'), createEmptyInstance: create)
