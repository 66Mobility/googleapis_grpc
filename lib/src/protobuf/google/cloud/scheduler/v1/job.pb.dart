...
class Job extends $pb.GeneratedMessage {
  factory Job({
    ...
    $4610.PubsubTarget? pubsubTarget,
    $4610.AppEngineHttpTarget? appEngineHttpTarget,
    $4610.HttpTarget? httpTarget,
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(_omitMessageNames ? '' : 'Job', package: const $pb.PackageName(_omitMessageNames ? '' : 'google.cloud.scheduler.v1'), createEmptyInstance: create)
    ...
    ..aOM<$4610.PubsubTarget>(4, _omitFieldNames ? '' : 'pubsubTarget', subBuilder: $4610.PubsubTarget.create)
    ..aOM<$4610.AppEngineHttpTarget>(5, _omitFieldNames ? '' : 'appEngineHttpTarget', subBuilder: $4610.AppEngineHttpTarget.create)
    ..aOM<$4610.HttpTarget>(6, _omitFieldNames ? '' : 'httpTarget', subBuilder: $4610.HttpTarget.create)
  ...
  /// Pub/Sub target.
  @$pb.TagNumber(4)
  $4610.PubsubTarget get pubsubTarget => $_getN(2);
  @$pb.TagNumber(4)
  set pubsubTarget($4610.PubsubTarget v) { setField(4, v); }
  @$pb.TagNumber(4)
  $core.bool hasPubsubTarget() => $_has(2);
  @$pb.TagNumber(4)
  void clearPubsubTarget() => clearField(4);
  @$pb.TagNumber(4)
  $4610.PubsubTarget ensurePubsubTarget() => $_ensure(2);

  /// App Engine HTTP target.
  @$pb.TagNumber(5)
  $4610.AppEngineHttpTarget get appEngineHttpTarget => $_getN(3);
  @$pb.TagNumber(5)
  set appEngineHttpTarget($4610.AppEngineHttpTarget v) { setField(5, v); }
  @$pb.TagNumber(5)
  $core.bool hasAppEngineHttpTarget() => $_has(3);
  @$pb.TagNumber(5)
  void clearAppEngineHttpTarget() => clearField(5);
  @$pb.TagNumber(5)
  $4610.AppEngineHttpTarget ensureAppEngineHttpTarget() => $_ensure(3);

  /// HTTP target.
  @$pb.TagNumber(6)
  $4610.HttpTarget get httpTarget => $_getN(4);
  @$pb.TagNumber(6)
  set httpTarget($4610.HttpTarget v) { setField(6, v); }
  @$pb.TagNumber(6)
  $core.bool hasHttpTarget() => $_has(4);
  @$pb.TagNumber(6)
  void clearHttpTarget() => clearField(6);
  @$pb.TagNumber(6)
  $4610.HttpTarget ensureHttpTarget() => $_ensure(4);
