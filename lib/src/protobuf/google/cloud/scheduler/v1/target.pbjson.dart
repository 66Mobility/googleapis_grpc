...
const HttpTarget$json = {
  ...
  '2': [
    ...
    {'1': 'http_method', '3': 2, '4': 1, '5': 14, '6': '.google.cloud.scheduler.v1.HttpMethod', '10': 'httpMethod'},
    {'1': 'headers', '3': 3, '4': 3, '5': 11, '6': '.google.cloud.scheduler.v1.HttpTarget.HeadersEntry', '10': 'headers'},
    {'1': 'body', '3': 4, '4': 1, '5': 12, '10': 'body'},
    {'1': 'oauth_token', '3': 5, '4': 1, '5': 11, '6': '.google.cloud.scheduler.v1.OAuthToken', '9': 0, '10': 'oauthToken'},
    {'1': 'oidc_token', '3': 6, '4': 1, '5': 11, '6': '.google.cloud.scheduler.v1.OidcToken', '9': 0, '10': 'oidcToken'},
  ],
...
final $typed_data.Uint8List httpTargetDescriptor = $convert.base64Decode(
    'CgpIdHRwVGFyZ2V0EhAKA3VyaRgBIAEoCVIDdXJpEkYKC2h0dHBfbWV0aG9kGAIgASgOMiUuZ2'
    '9vZ2xlLmNsb3VkLnNjaGVkdWxlci52MS5IdHRwTWV0aG9kUgpodHRwTWV0aG9kEkwKB2hlYWRl'
    'cnMYAyADKAsyMi5nb29nbGUuY2xvdWQuc2NoZWR1bGVyLnYxLkh0dHBUYXJnZXQuSGVhZGVyc0'
    'VudHJ5UgdoZWFkZXJzEhIKBGJvZHkYBCABKAxSBGJvZHkSSAoLb2F1dGhfdG9rZW4YBSABKAsy'
    'JS5nb29nbGUuY2xvdWQuc2NoZWR1bGVyLnYxLk9BdXRoVG9rZW5IAFIKb2F1dGhUb2tlbhJFCg'
    'pvaWRjX3Rva2VuGAYgASgLMiQuZ29vZ2xlLmNsb3VkLnNjaGVkdWxlci52MS5PaWRjVG9rZW5I'
    'AFIJb2lkY1Rva2VuGjoKDEhlYWRlcnNFbnRyeRIQCgNrZXkYASABKAlSA2tleRIUCgV2YWx1ZR'
    'gCIAEoCVIFdmFsdWU6AjgBQhYKFGF1dGhvcml6YXRpb25faGVhZGVy');

@$core.Deprecated('Use appEngineHttpTargetDescriptor instead')
const AppEngineHttpTarget$json = {
  '1': 'AppEngineHttpTarget',
  '2': [
    {'1': 'http_method', '3': 1, '4': 1, '5': 14, '6': '.google.cloud.scheduler.v1.HttpMethod', '10': 'httpMethod'},
    {'1': 'app_engine_routing', '3': 2, '4': 1, '5': 11, '6': '.google.cloud.scheduler.v1.AppEngineRouting', '10': 'appEngineRouting'},
    {'1': 'relative_uri', '3': 3, '4': 1, '5': 9, '10': 'relativeUri'},
    {'1': 'headers', '3': 4, '4': 3, '5': 11, '6': '.google.cloud.scheduler.v1.AppEngineHttpTarget.HeadersEntry', '10': 'headers'},
...
final $typed_data.Uint8List appEngineHttpTargetDescriptor = $convert.base64Decode(
    'ChNBcHBFbmdpbmVIdHRwVGFyZ2V0EkYKC2h0dHBfbWV0aG9kGAEgASgOMiUuZ29vZ2xlLmNsb3'
    'VkLnNjaGVkdWxlci52MS5IdHRwTWV0aG9kUgpodHRwTWV0aG9kElkKEmFwcF9lbmdpbmVfcm91'
    'dGluZxgCIAEoCzIrLmdvb2dsZS5jbG91ZC5zY2hlZHVsZXIudjEuQXBwRW5naW5lUm91dGluZ1'
    'IQYXBwRW5naW5lUm91dGluZxIhCgxyZWxhdGl2ZV91cmkYAyABKAlSC3JlbGF0aXZlVXJpElUK'
    'B2hlYWRlcnMYBCADKAsyOy5nb29nbGUuY2xvdWQuc2NoZWR1bGVyLnYxLkFwcEVuZ2luZUh0dH'
    'BUYXJnZXQuSGVhZGVyc0VudHJ5UgdoZWFkZXJzEhIKBGJvZHkYBSABKAxSBGJvZHkaOgoMSGVh'
...
const PubsubTarget$json = {
  ...
  '2': [
    ...
    {'1': 'attributes', '3': 4, '4': 3, '5': 11, '6': '.google.cloud.scheduler.v1.PubsubTarget.AttributesEntry', '10': 'attributes'},
  ],
...
final $typed_data.Uint8List pubsubTargetDescriptor = $convert.base64Decode(
    ...
    'Bpcy5jb20vVG9waWNSCXRvcGljTmFtZRISCgRkYXRhGAMgASgMUgRkYXRhElcKCmF0dHJpYnV0'
    'ZXMYBCADKAsyNy5nb29nbGUuY2xvdWQuc2NoZWR1bGVyLnYxLlB1YnN1YlRhcmdldC5BdHRyaW'
    'J1dGVzRW50cnlSCmF0dHJpYnV0ZXMaPQoPQXR0cmlidXRlc0VudHJ5EhAKA2tleRgBIAEoCVID'
