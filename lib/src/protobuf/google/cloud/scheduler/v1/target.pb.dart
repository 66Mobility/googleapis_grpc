...
class HttpTarget extends $pb.GeneratedMessage {
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(_omitMessageNames ? '' : 'HttpTarget', package: const $pb.PackageName(_omitMessageNames ? '' : 'google.cloud.scheduler.v1'), createEmptyInstance: create)
    ..oo(0, [5, 6])
    ...
    ..m<$core.String, $core.String>(3, _omitFieldNames ? '' : 'headers', entryClassName: 'HttpTarget.HeadersEntry', keyFieldType: $pb.PbFieldType.OS, valueFieldType: $pb.PbFieldType.OS, packageName: const $pb.PackageName('google.cloud.scheduler.v1'))
...
class AppEngineHttpTarget extends $pb.GeneratedMessage {
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(_omitMessageNames ? '' : 'AppEngineHttpTarget', package: const $pb.PackageName(_omitMessageNames ? '' : 'google.cloud.scheduler.v1'), createEmptyInstance: create)
    ...
    ..m<$core.String, $core.String>(4, _omitFieldNames ? '' : 'headers', entryClassName: 'AppEngineHttpTarget.HeadersEntry', keyFieldType: $pb.PbFieldType.OS, valueFieldType: $pb.PbFieldType.OS, packageName: const $pb.PackageName('google.cloud.scheduler.v1'))
...
class PubsubTarget extends $pb.GeneratedMessage {
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(_omitMessageNames ? '' : 'PubsubTarget', package: const $pb.PackageName(_omitMessageNames ? '' : 'google.cloud.scheduler.v1'), createEmptyInstance: create)
    ..aOS(1, _omitFieldNames ? '' : 'topicName')
    ..a<$core.List<$core.int>>(3, _omitFieldNames ? '' : 'data', $pb.PbFieldType.OY)
    ..m<$core.String, $core.String>(4, _omitFieldNames ? '' : 'attributes', entryClassName: 'PubsubTarget.AttributesEntry', keyFieldType: $pb.PbFieldType.OS, valueFieldType: $pb.PbFieldType.OS, packageName: const $pb.PackageName('google.cloud.scheduler.v1'))
    ..hasRequiredFields = false
  ;
...
class AppEngineRouting extends $pb.GeneratedMessage {
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(_omitMessageNames ? '' : 'AppEngineRouting', package: const $pb.PackageName(_omitMessageNames ? '' : 'google.cloud.scheduler.v1'), createEmptyInstance: create)
...
class OAuthToken extends $pb.GeneratedMessage {
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(_omitMessageNames ? '' : 'OAuthToken', package: const $pb.PackageName(_omitMessageNames ? '' : 'google.cloud.scheduler.v1'), createEmptyInstance: create)
...
class OidcToken extends $pb.GeneratedMessage {
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(_omitMessageNames ? '' : 'OidcToken', package: const $pb.PackageName(_omitMessageNames ? '' : 'google.cloud.scheduler.v1'), createEmptyInstance: create)
    ..aOS(1, _omitFieldNames ? '' : 'serviceAccountEmail')
