...
const ListJobsRequest$json = {
  ...
  '2': [
    ...
    {'1': 'legacy_app_engine_cron', '3': 7, '4': 1, '5': 8, '10': 'legacyAppEngineCron'},
  ],
};
...
final $typed_data.Uint8List listJobsRequestDescriptor = $convert.base64Decode(
    ...
    'VyLmdvb2dsZWFwaXMuY29tL0pvYlIGcGFyZW50EhYKBmZpbHRlchgEIAEoCVIGZmlsdGVyEhsK'
    'CXBhZ2Vfc2l6ZRgFIAEoBVIIcGFnZVNpemUSHQoKcGFnZV90b2tlbhgGIAEoCVIJcGFnZVRva2'
    'VuEjMKFmxlZ2FjeV9hcHBfZW5naW5lX2Nyb24YByABKAhSE2xlZ2FjeUFwcEVuZ2luZUNyb24=');

@$core.Deprecated('Use listJobsResponseDescriptor instead')
const ListJobsResponse$json = {
  '1': 'ListJobsResponse',
  '2': [
    {'1': 'jobs', '3': 1, '4': 3, '5': 11, '6': '.google.cloud.scheduler.v1beta1.Job', '10': 'jobs'},
...
final $typed_data.Uint8List listJobsResponseDescriptor = $convert.base64Decode(
    'ChBMaXN0Sm9ic1Jlc3BvbnNlEjcKBGpvYnMYASADKAsyIy5nb29nbGUuY2xvdWQuc2NoZWR1bG'
    'VyLnYxYmV0YTEuSm9iUgRqb2JzEiYKD25leHRfcGFnZV90b2tlbhgCIAEoCVINbmV4dFBhZ2VU'
    'b2tlbg==');
...
const CreateJobRequest$json = {
  ...
  '2': [
    {'1': 'parent', '3': 1, '4': 1, '5': 9, '8': {}, '10': 'parent'},
    {'1': 'job', '3': 2, '4': 1, '5': 11, '6': '.google.cloud.scheduler.v1beta1.Job', '8': {}, '10': 'job'},
  ],
};
...
final $typed_data.Uint8List createJobRequestDescriptor = $convert.base64Decode(
    ...
    'xlci5nb29nbGVhcGlzLmNvbS9Kb2JSBnBhcmVudBI6CgNqb2IYAiABKAsyIy5nb29nbGUuY2xv'
    'dWQuc2NoZWR1bGVyLnYxYmV0YTEuSm9iQgPgQQJSA2pvYg==');

@$core.Deprecated('Use updateJobRequestDescriptor instead')
const UpdateJobRequest$json = {
  '1': 'UpdateJobRequest',
  '2': [
    {'1': 'job', '3': 1, '4': 1, '5': 11, '6': '.google.cloud.scheduler.v1beta1.Job', '8': {}, '10': 'job'},
...
final $typed_data.Uint8List updateJobRequestDescriptor = $convert.base64Decode(
    'ChBVcGRhdGVKb2JSZXF1ZXN0EjoKA2pvYhgBIAEoCzIjLmdvb2dsZS5jbG91ZC5zY2hlZHVsZX'
    'IudjFiZXRhMS5Kb2JCA+BBAlIDam9iEjsKC3VwZGF0ZV9tYXNrGAIgASgLMhouZ29vZ2xlLnBy'
...
const DeleteJobRequest$json = {
  ...
  '2': [
    {'1': 'name', '3': 1, '4': 1, '5': 9, '8': {}, '10': 'name'},
    {'1': 'legacy_app_engine_cron', '3': 2, '4': 1, '5': 8, '10': 'legacyAppEngineCron'},
  ],
};
...
final $typed_data.Uint8List deleteJobRequestDescriptor = $convert.base64Decode(
    ...
    'IuZ29vZ2xlYXBpcy5jb20vSm9iUgRuYW1lEjMKFmxlZ2FjeV9hcHBfZW5naW5lX2Nyb24YAiAB'
    'KAhSE2xlZ2FjeUFwcEVuZ2luZUNyb24=');
...
final $typed_data.Uint8List runJobRequestDescriptor = $convert.base64Decode(
    ...
    '9vZ2xlYXBpcy5jb20vSm9iUgRuYW1lEjMKFmxlZ2FjeV9hcHBfZW5naW5lX2Nyb24YAiABKAhS'
    'E2xlZ2FjeUFwcEVuZ2luZUNyb24=');
