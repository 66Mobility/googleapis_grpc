...
class ListJobsRequest extends $pb.GeneratedMessage {
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(_omitMessageNames ? '' : 'ListJobsRequest', package: const $pb.PackageName(_omitMessageNames ? '' : 'google.cloud.scheduler.v1beta1'), createEmptyInstance: create)
    ..aOS(1, _omitFieldNames ? '' : 'parent')
    ..aOS(4, _omitFieldNames ? '' : 'filter')
    ..a<$core.int>(5, _omitFieldNames ? '' : 'pageSize', $pb.PbFieldType.O3)
    ..aOS(6, _omitFieldNames ? '' : 'pageToken')
    ..aOB(7, _omitFieldNames ? '' : 'legacyAppEngineCron')
  ...
  @$pb.TagNumber(7)
  $core.bool get legacyAppEngineCron => $_getBF(4);
  @$pb.TagNumber(7)
  set legacyAppEngineCron($core.bool v) { $_setBool(4, v); }
  @$pb.TagNumber(7)
  $core.bool hasLegacyAppEngineCron() => $_has(4);
  @$pb.TagNumber(7)
  void clearLegacyAppEngineCron() => clearField(7);
}
...
class ListJobsResponse extends $pb.GeneratedMessage {
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(_omitMessageNames ? '' : 'ListJobsResponse', package: const $pb.PackageName(_omitMessageNames ? '' : 'google.cloud.scheduler.v1beta1'), createEmptyInstance: create)
    ..pc<$1322.Job>(1, _omitFieldNames ? '' : 'jobs', $pb.PbFieldType.PM, subBuilder: $1322.Job.create)
  ...
  /// The list of jobs.
  @$pb.TagNumber(1)
  $core.List<$1322.Job> get jobs => $_getList(0);
...
class GetJobRequest extends $pb.GeneratedMessage {
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(_omitMessageNames ? '' : 'GetJobRequest', package: const $pb.PackageName(_omitMessageNames ? '' : 'google.cloud.scheduler.v1beta1'), createEmptyInstance: create)
...
class CreateJobRequest extends $pb.GeneratedMessage {
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(_omitMessageNames ? '' : 'CreateJobRequest', package: const $pb.PackageName(_omitMessageNames ? '' : 'google.cloud.scheduler.v1beta1'), createEmptyInstance: create)
    ..aOS(1, _omitFieldNames ? '' : 'parent')
    ..aOM<$1322.Job>(2, _omitFieldNames ? '' : 'job', subBuilder: $1322.Job.create)
    ..hasRequiredFields = false
  ;
  ...
  @$pb.TagNumber(2)
  $1322.Job get job => $_getN(1);
  @$pb.TagNumber(2)
  set job($1322.Job v) { setField(2, v); }
  @$pb.TagNumber(2)
  $core.bool hasJob() => $_has(1);
  @$pb.TagNumber(2)
  void clearJob() => clearField(2);
  @$pb.TagNumber(2)
  $1322.Job ensureJob() => $_ensure(1);
}
...
class UpdateJobRequest extends $pb.GeneratedMessage {
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(_omitMessageNames ? '' : 'UpdateJobRequest', package: const $pb.PackageName(_omitMessageNames ? '' : 'google.cloud.scheduler.v1beta1'), createEmptyInstance: create)
    ..aOM<$1322.Job>(1, _omitFieldNames ? '' : 'job', subBuilder: $1322.Job.create)
  ...
  @$pb.TagNumber(1)
  $1322.Job get job => $_getN(0);
  @$pb.TagNumber(1)
  set job($1322.Job v) { setField(1, v); }
  @$pb.TagNumber(1)
  $core.bool hasJob() => $_has(0);
  @$pb.TagNumber(1)
  void clearJob() => clearField(1);
  @$pb.TagNumber(1)
  $1322.Job ensureJob() => $_ensure(0);
...
class DeleteJobRequest extends $pb.GeneratedMessage {
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(_omitMessageNames ? '' : 'DeleteJobRequest', package: const $pb.PackageName(_omitMessageNames ? '' : 'google.cloud.scheduler.v1beta1'), createEmptyInstance: create)
    ..aOS(1, _omitFieldNames ? '' : 'name')
    ..aOB(2, _omitFieldNames ? '' : 'legacyAppEngineCron')
    ..hasRequiredFields = false
  ;
  ...
  @$pb.TagNumber(2)
  $core.bool get legacyAppEngineCron => $_getBF(1);
  @$pb.TagNumber(2)
  set legacyAppEngineCron($core.bool v) { $_setBool(1, v); }
  @$pb.TagNumber(2)
  $core.bool hasLegacyAppEngineCron() => $_has(1);
  @$pb.TagNumber(2)
  void clearLegacyAppEngineCron() => clearField(2);
}
...
class PauseJobRequest extends $pb.GeneratedMessage {
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(_omitMessageNames ? '' : 'PauseJobRequest', package: const $pb.PackageName(_omitMessageNames ? '' : 'google.cloud.scheduler.v1beta1'), createEmptyInstance: create)
    ..aOS(1, _omitFieldNames ? '' : 'name')
    ..hasRequiredFields = false
  ;
...
class ResumeJobRequest extends $pb.GeneratedMessage {
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(_omitMessageNames ? '' : 'ResumeJobRequest', package: const $pb.PackageName(_omitMessageNames ? '' : 'google.cloud.scheduler.v1beta1'), createEmptyInstance: create)
    ..aOS(1, _omitFieldNames ? '' : 'name')
    ..hasRequiredFields = false
  ;
...
class RunJobRequest extends $pb.GeneratedMessage {
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(_omitMessageNames ? '' : 'RunJobRequest', package: const $pb.PackageName(_omitMessageNames ? '' : 'google.cloud.scheduler.v1beta1'), createEmptyInstance: create)
    ..aOS(1, _omitFieldNames ? '' : 'name')
    ..aOB(2, _omitFieldNames ? '' : 'legacyAppEngineCron')
    ..hasRequiredFields = false
  ;
