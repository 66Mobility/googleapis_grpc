...
const PlaceOrderRequest$json = {
  ...
  '2': [
    ...
    {'1': 'line_item_info', '3': 10, '4': 3, '5': 11, '6': '.google.cloud.commerce.consumer.procurement.v1.LineItemInfo', '8': {}, '10': 'lineItemInfo'},
...
final $typed_data.Uint8List placeOrderRequestDescriptor = $convert.base64Decode(
    ...
    'GAYgASgJQgPgQQJSC2Rpc3BsYXlOYW1lEmYKDmxpbmVfaXRlbV9pbmZvGAogAygLMjsuZ29vZ2'
    'xlLmNsb3VkLmNvbW1lcmNlLmNvbnN1bWVyLnByb2N1cmVtZW50LnYxLkxpbmVJdGVtSW5mb0ID'
    '4EEBUgxsaW5lSXRlbUluZm8SIgoKcmVxdWVzdF9pZBgHIAEoCUID4EEBUglyZXF1ZXN0SWQ=');
...
const ListOrdersResponse$json = {
  ...
  '2': [
    {'1': 'orders', '3': 1, '4': 3, '5': 11, '6': '.google.cloud.commerce.consumer.procurement.v1.Order', '10': 'orders'},
...
final $typed_data.Uint8List listOrdersResponseDescriptor = $convert.base64Decode(
    'ChJMaXN0T3JkZXJzUmVzcG9uc2USTAoGb3JkZXJzGAEgAygLMjQuZ29vZ2xlLmNsb3VkLmNvbW'
    '1lcmNlLmNvbnN1bWVyLnByb2N1cmVtZW50LnYxLk9yZGVyUgZvcmRlcnMSJgoPbmV4dF9wYWdl'
