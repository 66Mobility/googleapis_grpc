...
class PlaceOrderRequest extends $pb.GeneratedMessage {
  factory PlaceOrderRequest({
    ...
    $core.Iterable<$775.LineItemInfo>? lineItemInfo,
  }) {
    final $result = create();
    if (parent != null) {
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(_omitMessageNames ? '' : 'PlaceOrderRequest', package: const $pb.PackageName(_omitMessageNames ? '' : 'google.cloud.commerce.consumer.procurement.v1alpha1'), createEmptyInstance: create)
    ..aOS(1, _omitFieldNames ? '' : 'parent')
    ..aOS(6, _omitFieldNames ? '' : 'displayName')
    ..aOS(7, _omitFieldNames ? '' : 'requestId')
    ..pc<$775.LineItemInfo>(10, _omitFieldNames ? '' : 'lineItemInfo', $pb.PbFieldType.PM, subBuilder: $775.LineItemInfo.create)
  ...
  /// being placed.
  @$pb.TagNumber(10)
  $core.List<$775.LineItemInfo> get lineItemInfo => $_getList(3);
}
...
class PlaceOrderMetadata extends $pb.GeneratedMessage {
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(_omitMessageNames ? '' : 'PlaceOrderMetadata', package: const $pb.PackageName(_omitMessageNames ? '' : 'google.cloud.commerce.consumer.procurement.v1alpha1'), createEmptyInstance: create)
    ..hasRequiredFields = false
  ;
...
class GetOrderRequest extends $pb.GeneratedMessage {
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(_omitMessageNames ? '' : 'GetOrderRequest', package: const $pb.PackageName(_omitMessageNames ? '' : 'google.cloud.commerce.consumer.procurement.v1alpha1'), createEmptyInstance: create)
...
class ListOrdersRequest extends $pb.GeneratedMessage {
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(_omitMessageNames ? '' : 'ListOrdersRequest', package: const $pb.PackageName(_omitMessageNames ? '' : 'google.cloud.commerce.consumer.procurement.v1alpha1'), createEmptyInstance: create)
    ..aOS(1, _omitFieldNames ? '' : 'parent')
...
class ListOrdersResponse extends $pb.GeneratedMessage {
  factory ListOrdersResponse({
    $core.Iterable<$775.Order>? orders,
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(_omitMessageNames ? '' : 'ListOrdersResponse', package: const $pb.PackageName(_omitMessageNames ? '' : 'google.cloud.commerce.consumer.procurement.v1alpha1'), createEmptyInstance: create)
    ..pc<$775.Order>(1, _omitFieldNames ? '' : 'orders', $pb.PbFieldType.PM, subBuilder: $775.Order.create)
  ...
  @$pb.TagNumber(1)
  $core.List<$775.Order> get orders => $_getList(0);
