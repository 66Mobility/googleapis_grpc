...
class NfsExportOptions_SecurityFlavor extends $pb.ProtobufEnum {
  static const NfsExportOptions_SecurityFlavor SECURITY_FLAVOR_UNSPECIFIED = NfsExportOptions_SecurityFlavor._(0, _omitEnumNames ? '' : 'SECURITY_FLAVOR_UNSPECIFIED');
  static const NfsExportOptions_SecurityFlavor AUTH_SYS = NfsExportOptions_SecurityFlavor._(1, _omitEnumNames ? '' : 'AUTH_SYS');
  static const NfsExportOptions_SecurityFlavor KRB5 = NfsExportOptions_SecurityFlavor._(2, _omitEnumNames ? '' : 'KRB5');
  static const NfsExportOptions_SecurityFlavor KRB5I = NfsExportOptions_SecurityFlavor._(3, _omitEnumNames ? '' : 'KRB5I');
  static const NfsExportOptions_SecurityFlavor KRB5P = NfsExportOptions_SecurityFlavor._(4, _omitEnumNames ? '' : 'KRB5P');

  static const $core.List<NfsExportOptions_SecurityFlavor> values = <NfsExportOptions_SecurityFlavor> [
  ...
  static final $core.Map<$core.int, NfsExportOptions_SecurityFlavor> _byValue = $pb.ProtobufEnum.initByValue(values);
  static NfsExportOptions_SecurityFlavor? valueOf($core.int value) => _byValue[value];

  const NfsExportOptions_SecurityFlavor._($core.int v, $core.String n) : super(v, n);
}
...
class Instance_State extends $pb.ProtobufEnum {
  ...
  static const Instance_State REVERTING = Instance_State._(9, _omitEnumNames ? '' : 'REVERTING');
  static const Instance_State SUSPENDING = Instance_State._(10, _omitEnumNames ? '' : 'SUSPENDING');
  static const Instance_State RESUMING = Instance_State._(11, _omitEnumNames ? '' : 'RESUMING');
...
class Instance_Tier extends $pb.ProtobufEnum {
  ...
  static const Instance_Tier HIGH_SCALE_SSD = Instance_Tier._(6, _omitEnumNames ? '' : 'HIGH_SCALE_SSD');
  static const Instance_Tier ENTERPRISE = Instance_Tier._(7, _omitEnumNames ? '' : 'ENTERPRISE');
  static const Instance_Tier ZONAL = Instance_Tier._(8, _omitEnumNames ? '' : 'ZONAL');
  static const Instance_Tier REGIONAL = Instance_Tier._(9, _omitEnumNames ? '' : 'REGIONAL');
...
class Instance_FileProtocol extends $pb.ProtobufEnum {
  static const Instance_FileProtocol FILE_PROTOCOL_UNSPECIFIED = Instance_FileProtocol._(0, _omitEnumNames ? '' : 'FILE_PROTOCOL_UNSPECIFIED');
  static const Instance_FileProtocol NFS_V3 = Instance_FileProtocol._(1, _omitEnumNames ? '' : 'NFS_V3');
  static const Instance_FileProtocol NFS_V4_1 = Instance_FileProtocol._(2, _omitEnumNames ? '' : 'NFS_V4_1');

  static const $core.List<Instance_FileProtocol> values = <Instance_FileProtocol> [
    FILE_PROTOCOL_UNSPECIFIED,
    NFS_V3,
    NFS_V4_1,
  ];

  static final $core.Map<$core.int, Instance_FileProtocol> _byValue = $pb.ProtobufEnum.initByValue(values);
  static Instance_FileProtocol? valueOf($core.int value) => _byValue[value];

  const Instance_FileProtocol._($core.int v, $core.String n) : super(v, n);
}
...
class Snapshot_State extends $pb.ProtobufEnum {
  ...
  static const Snapshot_State READY = Snapshot_State._(3, _omitEnumNames ? '' : 'READY');
  static const Snapshot_State DELETING = Snapshot_State._(4, _omitEnumNames ? '' : 'DELETING');
...
/// The share state.
class Share_State extends $pb.ProtobufEnum {
  static const Share_State STATE_UNSPECIFIED = Share_State._(0, _omitEnumNames ? '' : 'STATE_UNSPECIFIED');
  static const Share_State CREATING = Share_State._(1, _omitEnumNames ? '' : 'CREATING');
  static const Share_State READY = Share_State._(3, _omitEnumNames ? '' : 'READY');
  static const Share_State DELETING = Share_State._(4, _omitEnumNames ? '' : 'DELETING');

  static const $core.List<Share_State> values = <Share_State> [
    STATE_UNSPECIFIED,
    CREATING,
    READY,
    DELETING,
  ...
  static final $core.Map<$core.int, Share_State> _byValue = $pb.ProtobufEnum.initByValue(values);
  static Share_State? valueOf($core.int value) => _byValue[value];

  const Share_State._($core.int v, $core.String n) : super(v, n);
}
