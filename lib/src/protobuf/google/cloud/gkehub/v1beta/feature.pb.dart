...
class Feature extends $pb.GeneratedMessage {
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(_omitMessageNames ? '' : 'Feature', package: const $pb.PackageName(_omitMessageNames ? '' : 'google.cloud.gkehub.v1beta'), createEmptyInstance: create)
    ..aOS(1, _omitFieldNames ? '' : 'name')
    ..m<$core.String, $core.String>(2, _omitFieldNames ? '' : 'labels', entryClassName: 'Feature.LabelsEntry', keyFieldType: $pb.PbFieldType.OS, valueFieldType: $pb.PbFieldType.OS, packageName: const $pb.PackageName('google.cloud.gkehub.v1beta'))
...
class FeatureResourceState extends $pb.GeneratedMessage {
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(_omitMessageNames ? '' : 'FeatureResourceState', package: const $pb.PackageName(_omitMessageNames ? '' : 'google.cloud.gkehub.v1beta'), createEmptyInstance: create)
...
class CommonFeatureState extends $pb.GeneratedMessage {
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(_omitMessageNames ? '' : 'CommonFeatureState', package: const $pb.PackageName(_omitMessageNames ? '' : 'google.cloud.gkehub.v1beta'), createEmptyInstance: create)
...
class MembershipFeatureSpec extends $pb.GeneratedMessage {
  ...
  static const $core.Map<$core.int, MembershipFeatureSpec_FeatureSpec> _MembershipFeatureSpec_FeatureSpecByTag = {
    ...
    116 : MembershipFeatureSpec_FeatureSpec.mesh,
