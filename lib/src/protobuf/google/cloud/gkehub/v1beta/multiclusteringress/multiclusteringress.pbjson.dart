...
const FeatureSpec$json = {
  ...
  '2': [
    ...
    {'1': 'billing', '3': 2, '4': 1, '5': 14, '6': '.google.cloud.gkehub.multiclusteringress.v1beta.Billing', '10': 'billing'},
  ],
};
...
final $typed_data.Uint8List featureSpecDescriptor = $convert.base64Decode(
    ...
    'hpcBJRCgdiaWxsaW5nGAIgASgOMjcuZ29vZ2xlLmNsb3VkLmdrZWh1Yi5tdWx0aWNsdXN0ZXJp'
    'bmdyZXNzLnYxYmV0YS5CaWxsaW5nUgdiaWxsaW5n');
