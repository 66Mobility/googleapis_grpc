...
const ListConnectivityTestsResponse$json = {
  ...
  '2': [
    {'1': 'resources', '3': 1, '4': 3, '5': 11, '6': '.google.cloud.networkmanagement.v1beta1.ConnectivityTest', '10': 'resources'},
...
final $typed_data.Uint8List listConnectivityTestsResponseDescriptor = $convert.base64Decode(
    'Ch1MaXN0Q29ubmVjdGl2aXR5VGVzdHNSZXNwb25zZRJWCglyZXNvdXJjZXMYASADKAsyOC5nb2'
    '9nbGUuY2xvdWQubmV0d29ya21hbmFnZW1lbnQudjFiZXRhMS5Db25uZWN0aXZpdHlUZXN0Ugly'
    'ZXNvdXJjZXMSJgoPbmV4dF9wYWdlX3Rva2VuGAIgASgJUg1uZXh0UGFnZVRva2VuEiAKC3Vucm'
...
const CreateConnectivityTestRequest$json = {
  ...
  '2': [
    ...
    {'1': 'resource', '3': 3, '4': 1, '5': 11, '6': '.google.cloud.networkmanagement.v1beta1.ConnectivityTest', '8': {}, '10': 'resource'},
  ],
};
...
final $typed_data.Uint8List createConnectivityTestRequestDescriptor = $convert.base64Decode(
    ...
    'FyZW50EhwKB3Rlc3RfaWQYAiABKAlCA+BBAlIGdGVzdElkElkKCHJlc291cmNlGAMgASgLMjgu'
    'Z29vZ2xlLmNsb3VkLm5ldHdvcmttYW5hZ2VtZW50LnYxYmV0YTEuQ29ubmVjdGl2aXR5VGVzdE'
    'ID4EECUghyZXNvdXJjZQ==');
...
const UpdateConnectivityTestRequest$json = {
  ...
  '2': [
    ...
    {'1': 'resource', '3': 2, '4': 1, '5': 11, '6': '.google.cloud.networkmanagement.v1beta1.ConnectivityTest', '8': {}, '10': 'resource'},
  ],
};
...
final $typed_data.Uint8List updateConnectivityTestRequestDescriptor = $convert.base64Decode(
    ...
    'dvb2dsZS5wcm90b2J1Zi5GaWVsZE1hc2tCA+BBAlIKdXBkYXRlTWFzaxJZCghyZXNvdXJjZRgC'
    'IAEoCzI4Lmdvb2dsZS5jbG91ZC5uZXR3b3JrbWFuYWdlbWVudC52MWJldGExLkNvbm5lY3Rpdm'
    'l0eVRlc3RCA+BBAlIIcmVzb3VyY2U=');
