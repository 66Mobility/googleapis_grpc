...
import 'trace.pb.dart' as $4563;
import 'trace.pbenum.dart' as $4563;
...
class Endpoint extends $pb.GeneratedMessage {
  factory Endpoint({
    ...
    $4563.LoadBalancerType? loadBalancerType,
  }) {
    final $result = create();
    if (ipAddress != null) {
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(_omitMessageNames ? '' : 'Endpoint', package: const $pb.PackageName(_omitMessageNames ? '' : 'google.cloud.networkmanagement.v1'), createEmptyInstance: create)
    ...
    ..e<$4563.LoadBalancerType>(16, _omitFieldNames ? '' : 'loadBalancerType', $pb.PbFieldType.OE, defaultOrMaker: $4563.LoadBalancerType.LOAD_BALANCER_TYPE_UNSPECIFIED, valueOf: $4563.LoadBalancerType.valueOf, enumValues: $4563.LoadBalancerType.values)
    ..hasRequiredFields = false
  ;
  ...
  @$pb.TagNumber(16)
  $4563.LoadBalancerType get loadBalancerType => $_getN(14);
  @$pb.TagNumber(16)
  set loadBalancerType($4563.LoadBalancerType v) { setField(16, v); }
  @$pb.TagNumber(16)
...
class ReachabilityDetails extends $pb.GeneratedMessage {
  factory ReachabilityDetails({
    ...
    $1795.Status? error,
    $core.Iterable<$4563.Trace>? traces,
  }) {
    final $result = create();
    if (result != null) {
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(_omitMessageNames ? '' : 'ReachabilityDetails', package: const $pb.PackageName(_omitMessageNames ? '' : 'google.cloud.networkmanagement.v1'), createEmptyInstance: create)
    ...
    ..pc<$4563.Trace>(5, _omitFieldNames ? '' : 'traces', $pb.PbFieldType.PM, subBuilder: $4563.Trace.create)
    ..hasRequiredFields = false
  ;
  ...
  @$pb.TagNumber(5)
  $core.List<$4563.Trace> get traces => $_getList(3);
}
...
class ProbingDetails extends $pb.GeneratedMessage {
  factory ProbingDetails({
    ...
    $4563.EndpointInfo? endpointInfo,
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(_omitMessageNames ? '' : 'ProbingDetails', package: const $pb.PackageName(_omitMessageNames ? '' : 'google.cloud.networkmanagement.v1'), createEmptyInstance: create)
    ...
    ..aOM<$4563.EndpointInfo>(7, _omitFieldNames ? '' : 'endpointInfo', subBuilder: $4563.EndpointInfo.create)
  ...
  /// for active probing.
  @$pb.TagNumber(7)
  $4563.EndpointInfo get endpointInfo => $_getN(6);
  @$pb.TagNumber(7)
  set endpointInfo($4563.EndpointInfo v) { setField(7, v); }
  @$pb.TagNumber(7)
  $core.bool hasEndpointInfo() => $_has(6);
  @$pb.TagNumber(7)
  void clearEndpointInfo() => clearField(7);
  @$pb.TagNumber(7)
  $4563.EndpointInfo ensureEndpointInfo() => $_ensure(6);
