...
import 'trace.pb.dart' as $4565;
import 'trace.pbenum.dart' as $4565;
...
class ConnectivityTest extends $pb.GeneratedMessage {
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(_omitMessageNames ? '' : 'ConnectivityTest', package: const $pb.PackageName(_omitMessageNames ? '' : 'google.cloud.networkmanagement.v1'), createEmptyInstance: create)
    ...
    ..m<$core.String, $core.String>(8, _omitFieldNames ? '' : 'labels', entryClassName: 'ConnectivityTest.LabelsEntry', keyFieldType: $pb.PbFieldType.OS, valueFieldType: $pb.PbFieldType.OS, packageName: const $pb.PackageName('google.cloud.networkmanagement.v1'))
...
class Endpoint_CloudFunctionEndpoint extends $pb.GeneratedMessage {
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(_omitMessageNames ? '' : 'Endpoint.CloudFunctionEndpoint', package: const $pb.PackageName(_omitMessageNames ? '' : 'google.cloud.networkmanagement.v1'), createEmptyInstance: create)
...
class Endpoint_AppEngineVersionEndpoint extends $pb.GeneratedMessage {
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(_omitMessageNames ? '' : 'Endpoint.AppEngineVersionEndpoint', package: const $pb.PackageName(_omitMessageNames ? '' : 'google.cloud.networkmanagement.v1'), createEmptyInstance: create)
    ..aOS(1, _omitFieldNames ? '' : 'uri')
    ..hasRequiredFields = false
  ;
...
class Endpoint_CloudRunRevisionEndpoint extends $pb.GeneratedMessage {
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(_omitMessageNames ? '' : 'Endpoint.CloudRunRevisionEndpoint', package: const $pb.PackageName(_omitMessageNames ? '' : 'google.cloud.networkmanagement.v1'), createEmptyInstance: create)
    ..aOS(1, _omitFieldNames ? '' : 'uri')
    ..hasRequiredFields = false
  ;
...
class Endpoint extends $pb.GeneratedMessage {
  factory Endpoint({
    ...
    $4565.LoadBalancerType? loadBalancerType,
  }) {
    final $result = create();
    if (ipAddress != null) {
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(_omitMessageNames ? '' : 'Endpoint', package: const $pb.PackageName(_omitMessageNames ? '' : 'google.cloud.networkmanagement.v1'), createEmptyInstance: create)
    ...
    ..e<$4565.LoadBalancerType>(16, _omitFieldNames ? '' : 'loadBalancerType', $pb.PbFieldType.OE, defaultOrMaker: $4565.LoadBalancerType.LOAD_BALANCER_TYPE_UNSPECIFIED, valueOf: $4565.LoadBalancerType.valueOf, enumValues: $4565.LoadBalancerType.values)
    ..hasRequiredFields = false
  ;
  ...
  @$pb.TagNumber(16)
  $4565.LoadBalancerType get loadBalancerType => $_getN(14);
  @$pb.TagNumber(16)
  set loadBalancerType($4565.LoadBalancerType v) { setField(16, v); }
  @$pb.TagNumber(16)
...
class ReachabilityDetails extends $pb.GeneratedMessage {
  factory ReachabilityDetails({
    ...
    $1796.Status? error,
    $core.Iterable<$4565.Trace>? traces,
  }) {
    final $result = create();
    if (result != null) {
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(_omitMessageNames ? '' : 'ReachabilityDetails', package: const $pb.PackageName(_omitMessageNames ? '' : 'google.cloud.networkmanagement.v1'), createEmptyInstance: create)
    ...
    ..pc<$4565.Trace>(5, _omitFieldNames ? '' : 'traces', $pb.PbFieldType.PM, subBuilder: $4565.Trace.create)
    ..hasRequiredFields = false
  ;
  ...
  @$pb.TagNumber(5)
  $core.List<$4565.Trace> get traces => $_getList(3);
}
...
class LatencyPercentile extends $pb.GeneratedMessage {
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(_omitMessageNames ? '' : 'LatencyPercentile', package: const $pb.PackageName(_omitMessageNames ? '' : 'google.cloud.networkmanagement.v1'), createEmptyInstance: create)
...
class LatencyDistribution extends $pb.GeneratedMessage {
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(_omitMessageNames ? '' : 'LatencyDistribution', package: const $pb.PackageName(_omitMessageNames ? '' : 'google.cloud.networkmanagement.v1'), createEmptyInstance: create)
...
class ProbingDetails_EdgeLocation extends $pb.GeneratedMessage {
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(_omitMessageNames ? '' : 'ProbingDetails.EdgeLocation', package: const $pb.PackageName(_omitMessageNames ? '' : 'google.cloud.networkmanagement.v1'), createEmptyInstance: create)
...
class ProbingDetails extends $pb.GeneratedMessage {
  factory ProbingDetails({
    ...
    $4565.EndpointInfo? endpointInfo,
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(_omitMessageNames ? '' : 'ProbingDetails', package: const $pb.PackageName(_omitMessageNames ? '' : 'google.cloud.networkmanagement.v1'), createEmptyInstance: create)
    ...
    ..aOM<$4565.EndpointInfo>(7, _omitFieldNames ? '' : 'endpointInfo', subBuilder: $4565.EndpointInfo.create)
  ...
  /// for active probing.
  @$pb.TagNumber(7)
  $4565.EndpointInfo get endpointInfo => $_getN(6);
  @$pb.TagNumber(7)
  set endpointInfo($4565.EndpointInfo v) { setField(7, v); }
  @$pb.TagNumber(7)
  $core.bool hasEndpointInfo() => $_has(6);
  @$pb.TagNumber(7)
  void clearEndpointInfo() => clearField(7);
  @$pb.TagNumber(7)
  $4565.EndpointInfo ensureEndpointInfo() => $_ensure(6);
