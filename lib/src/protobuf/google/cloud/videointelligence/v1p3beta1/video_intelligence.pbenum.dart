...
class StreamingFeature extends $pb.ProtobufEnum {
  static const StreamingFeature STREAMING_FEATURE_UNSPECIFIED = StreamingFeature._(0, _omitEnumNames ? '' : 'STREAMING_FEATURE_UNSPECIFIED');
  static const StreamingFeature STREAMING_LABEL_DETECTION = StreamingFeature._(1, _omitEnumNames ? '' : 'STREAMING_LABEL_DETECTION');
  static const StreamingFeature STREAMING_SHOT_CHANGE_DETECTION = StreamingFeature._(2, _omitEnumNames ? '' : 'STREAMING_SHOT_CHANGE_DETECTION');
  static const StreamingFeature STREAMING_EXPLICIT_CONTENT_DETECTION = StreamingFeature._(3, _omitEnumNames ? '' : 'STREAMING_EXPLICIT_CONTENT_DETECTION');
  static const StreamingFeature STREAMING_OBJECT_TRACKING = StreamingFeature._(4, _omitEnumNames ? '' : 'STREAMING_OBJECT_TRACKING');
  static const StreamingFeature STREAMING_AUTOML_ACTION_RECOGNITION = StreamingFeature._(23, _omitEnumNames ? '' : 'STREAMING_AUTOML_ACTION_RECOGNITION');
  static const StreamingFeature STREAMING_AUTOML_CLASSIFICATION = StreamingFeature._(21, _omitEnumNames ? '' : 'STREAMING_AUTOML_CLASSIFICATION');
  static const StreamingFeature STREAMING_AUTOML_OBJECT_TRACKING = StreamingFeature._(22, _omitEnumNames ? '' : 'STREAMING_AUTOML_OBJECT_TRACKING');
...
class Feature extends $pb.ProtobufEnum {
  ...
  static const Feature SPEECH_TRANSCRIPTION = Feature._(6, _omitEnumNames ? '' : 'SPEECH_TRANSCRIPTION');
  static const Feature TEXT_DETECTION = Feature._(7, _omitEnumNames ? '' : 'TEXT_DETECTION');
  static const Feature OBJECT_TRACKING = Feature._(9, _omitEnumNames ? '' : 'OBJECT_TRACKING');
  static const Feature LOGO_RECOGNITION = Feature._(12, _omitEnumNames ? '' : 'LOGO_RECOGNITION');
  static const Feature CELEBRITY_RECOGNITION = Feature._(13, _omitEnumNames ? '' : 'CELEBRITY_RECOGNITION');
  static const Feature PERSON_DETECTION = Feature._(14, _omitEnumNames ? '' : 'PERSON_DETECTION');
