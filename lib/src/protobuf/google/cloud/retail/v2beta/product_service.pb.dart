...
class AddLocalInventoriesRequest extends $pb.GeneratedMessage {
  factory AddLocalInventoriesRequest({
    $core.String? product,
    $core.Iterable<$4598.LocalInventory>? localInventories,
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(_omitMessageNames ? '' : 'AddLocalInventoriesRequest', package: const $pb.PackageName(_omitMessageNames ? '' : 'google.cloud.retail.v2beta'), createEmptyInstance: create)
    ..aOS(1, _omitFieldNames ? '' : 'product')
    ..pc<$4598.LocalInventory>(2, _omitFieldNames ? '' : 'localInventories', $pb.PbFieldType.PM, subBuilder: $4598.LocalInventory.create)
  ...
  /// request.
  @$pb.TagNumber(2)
  $core.List<$4598.LocalInventory> get localInventories => $_getList(1);
