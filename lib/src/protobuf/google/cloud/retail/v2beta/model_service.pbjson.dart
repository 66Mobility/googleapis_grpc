...
const CreateModelRequest$json = {
  ...
  '2': [
    ...
    {'1': 'model', '3': 2, '4': 1, '5': 11, '6': '.google.cloud.retail.v2beta.Model', '8': {}, '10': 'model'},
...
final $typed_data.Uint8List createModelRequestDescriptor = $convert.base64Decode(
    ...
    '9nbGVhcGlzLmNvbS9DYXRhbG9nUgZwYXJlbnQSPAoFbW9kZWwYAiABKAsyIS5nb29nbGUuY2xv'
    'dWQucmV0YWlsLnYyYmV0YS5Nb2RlbEID4EECUgVtb2RlbBIcCgdkcnlfcnVuGAMgASgIQgPgQQ'
    'FSBmRyeVJ1bg==');
...
const UpdateModelRequest$json = {
  ...
  '2': [
    {'1': 'model', '3': 1, '4': 1, '5': 11, '6': '.google.cloud.retail.v2beta.Model', '8': {}, '10': 'model'},
...
final $typed_data.Uint8List updateModelRequestDescriptor = $convert.base64Decode(
    'ChJVcGRhdGVNb2RlbFJlcXVlc3QSPAoFbW9kZWwYASABKAsyIS5nb29nbGUuY2xvdWQucmV0YW'
    'lsLnYyYmV0YS5Nb2RlbEID4EECUgVtb2RlbBJACgt1cGRhdGVfbWFzaxgCIAEoCzIaLmdvb2ds'
    'ZS5wcm90b2J1Zi5GaWVsZE1hc2tCA+BBAVIKdXBkYXRlTWFzaw==');
...
const ListModelsResponse$json = {
  ...
  '2': [
    {'1': 'models', '3': 1, '4': 3, '5': 11, '6': '.google.cloud.retail.v2beta.Model', '10': 'models'},
...
final $typed_data.Uint8List listModelsResponseDescriptor = $convert.base64Decode(
    'ChJMaXN0TW9kZWxzUmVzcG9uc2USOQoGbW9kZWxzGAEgAygLMiEuZ29vZ2xlLmNsb3VkLnJldG'
    'FpbC52MmJldGEuTW9kZWxSBm1vZGVscxImCg9uZXh0X3BhZ2VfdG9rZW4YAiABKAlSDW5leHRQ'
    'YWdlVG9rZW4=');
