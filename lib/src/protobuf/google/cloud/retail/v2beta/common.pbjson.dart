...
const Condition$json = {
  '1': 'Condition',
  '2': [
    {'1': 'query_terms', '3': 1, '4': 3, '5': 11, '6': '.google.cloud.retail.v2beta.Condition.QueryTerm', '10': 'queryTerms'},
    {'1': 'active_time_range', '3': 3, '4': 3, '5': 11, '6': '.google.cloud.retail.v2beta.Condition.TimeRange', '10': 'activeTimeRange'},
...
final $typed_data.Uint8List conditionDescriptor = $convert.base64Decode(
    'CglDb25kaXRpb24SUAoLcXVlcnlfdGVybXMYASADKAsyLy5nb29nbGUuY2xvdWQucmV0YWlsLn'
    'YyYmV0YS5Db25kaXRpb24uUXVlcnlUZXJtUgpxdWVyeVRlcm1zElsKEWFjdGl2ZV90aW1lX3Jh'
    'bmdlGAMgAygLMi8uZ29vZ2xlLmNsb3VkLnJldGFpbC52MmJldGEuQ29uZGl0aW9uLlRpbWVSYW'
    '5nZVIPYWN0aXZlVGltZVJhbmdlEicKD3BhZ2VfY2F0ZWdvcmllcxgEIAMoCVIOcGFnZUNhdGVn'
    'b3JpZXMaQAoJUXVlcnlUZXJtEhQKBXZhbHVlGAEgASgJUgV2YWx1ZRIdCgpmdWxsX21hdGNoGA'
    'IgASgIUglmdWxsTWF0Y2gafQoJVGltZVJhbmdlEjkKCnN0YXJ0X3RpbWUYASABKAsyGi5nb29n'
    'bGUucHJvdG9idWYuVGltZXN0YW1wUglzdGFydFRpbWUSNQoIZW5kX3RpbWUYAiABKAsyGi5nb2'
...
const Rule$json = {
  '1': 'Rule',
  '2': [
    {'1': 'boost_action', '3': 2, '4': 1, '5': 11, '6': '.google.cloud.retail.v2beta.Rule.BoostAction', '9': 0, '10': 'boostAction'},
    {'1': 'redirect_action', '3': 3, '4': 1, '5': 11, '6': '.google.cloud.retail.v2beta.Rule.RedirectAction', '9': 0, '10': 'redirectAction'},
    {'1': 'oneway_synonyms_action', '3': 6, '4': 1, '5': 11, '6': '.google.cloud.retail.v2beta.Rule.OnewaySynonymsAction', '9': 0, '10': 'onewaySynonymsAction'},
    {'1': 'do_not_associate_action', '3': 7, '4': 1, '5': 11, '6': '.google.cloud.retail.v2beta.Rule.DoNotAssociateAction', '9': 0, '10': 'doNotAssociateAction'},
    {'1': 'replacement_action', '3': 8, '4': 1, '5': 11, '6': '.google.cloud.retail.v2beta.Rule.ReplacementAction', '9': 0, '10': 'replacementAction'},
    {'1': 'ignore_action', '3': 9, '4': 1, '5': 11, '6': '.google.cloud.retail.v2beta.Rule.IgnoreAction', '9': 0, '10': 'ignoreAction'},
    {'1': 'filter_action', '3': 10, '4': 1, '5': 11, '6': '.google.cloud.retail.v2beta.Rule.FilterAction', '9': 0, '10': 'filterAction'},
    {'1': 'twoway_synonyms_action', '3': 11, '4': 1, '5': 11, '6': '.google.cloud.retail.v2beta.Rule.TwowaySynonymsAction', '9': 0, '10': 'twowaySynonymsAction'},
    {'1': 'force_return_facet_action', '3': 12, '4': 1, '5': 11, '6': '.google.cloud.retail.v2beta.Rule.ForceReturnFacetAction', '9': 0, '10': 'forceReturnFacetAction'},
    {'1': 'remove_facet_action', '3': 13, '4': 1, '5': 11, '6': '.google.cloud.retail.v2beta.Rule.RemoveFacetAction', '9': 0, '10': 'removeFacetAction'},
    {'1': 'condition', '3': 1, '4': 1, '5': 11, '6': '.google.cloud.retail.v2beta.Condition', '8': {}, '10': 'condition'},
  ],
...
const Rule_ForceReturnFacetAction$json = {
  ...
  '2': [
    {'1': 'facet_position_adjustments', '3': 1, '4': 3, '5': 11, '6': '.google.cloud.retail.v2beta.Rule.ForceReturnFacetAction.FacetPositionAdjustment', '10': 'facetPositionAdjustments'},
  ],
...
final $typed_data.Uint8List ruleDescriptor = $convert.base64Decode(
    'CgRSdWxlElEKDGJvb3N0X2FjdGlvbhgCIAEoCzIsLmdvb2dsZS5jbG91ZC5yZXRhaWwudjJiZX'
    'RhLlJ1bGUuQm9vc3RBY3Rpb25IAFILYm9vc3RBY3Rpb24SWgoPcmVkaXJlY3RfYWN0aW9uGAMg'
    'ASgLMi8uZ29vZ2xlLmNsb3VkLnJldGFpbC52MmJldGEuUnVsZS5SZWRpcmVjdEFjdGlvbkgAUg'
    '5yZWRpcmVjdEFjdGlvbhJtChZvbmV3YXlfc3lub255bXNfYWN0aW9uGAYgASgLMjUuZ29vZ2xl'
    'LmNsb3VkLnJldGFpbC52MmJldGEuUnVsZS5PbmV3YXlTeW5vbnltc0FjdGlvbkgAUhRvbmV3YX'
    'lTeW5vbnltc0FjdGlvbhJuChdkb19ub3RfYXNzb2NpYXRlX2FjdGlvbhgHIAEoCzI1Lmdvb2ds'
    'ZS5jbG91ZC5yZXRhaWwudjJiZXRhLlJ1bGUuRG9Ob3RBc3NvY2lhdGVBY3Rpb25IAFIUZG9Ob3'
    'RBc3NvY2lhdGVBY3Rpb24SYwoScmVwbGFjZW1lbnRfYWN0aW9uGAggASgLMjIuZ29vZ2xlLmNs'
    'b3VkLnJldGFpbC52MmJldGEuUnVsZS5SZXBsYWNlbWVudEFjdGlvbkgAUhFyZXBsYWNlbWVudE'
    'FjdGlvbhJUCg1pZ25vcmVfYWN0aW9uGAkgASgLMi0uZ29vZ2xlLmNsb3VkLnJldGFpbC52MmJl'
    'dGEuUnVsZS5JZ25vcmVBY3Rpb25IAFIMaWdub3JlQWN0aW9uElQKDWZpbHRlcl9hY3Rpb24YCi'
    'ABKAsyLS5nb29nbGUuY2xvdWQucmV0YWlsLnYyYmV0YS5SdWxlLkZpbHRlckFjdGlvbkgAUgxm'
    'aWx0ZXJBY3Rpb24SbQoWdHdvd2F5X3N5bm9ueW1zX2FjdGlvbhgLIAEoCzI1Lmdvb2dsZS5jbG'
    '91ZC5yZXRhaWwudjJiZXRhLlJ1bGUuVHdvd2F5U3lub255bXNBY3Rpb25IAFIUdHdvd2F5U3lu'
    'b255bXNBY3Rpb24SdAoZZm9yY2VfcmV0dXJuX2ZhY2V0X2FjdGlvbhgMIAEoCzI3Lmdvb2dsZS'
    '5jbG91ZC5yZXRhaWwudjJiZXRhLlJ1bGUuRm9yY2VSZXR1cm5GYWNldEFjdGlvbkgAUhZmb3Jj'
    'ZVJldHVybkZhY2V0QWN0aW9uEmQKE3JlbW92ZV9mYWNldF9hY3Rpb24YDSABKAsyMi5nb29nbG'
    'UuY2xvdWQucmV0YWlsLnYyYmV0YS5SdWxlLlJlbW92ZUZhY2V0QWN0aW9uSABSEXJlbW92ZUZh'
    'Y2V0QWN0aW9uEkgKCWNvbmRpdGlvbhgBIAEoCzIlLmdvb2dsZS5jbG91ZC5yZXRhaWwudjJiZX'
    'RhLkNvbmRpdGlvbkID4EECUgljb25kaXRpb24aTAoLQm9vc3RBY3Rpb24SFAoFYm9vc3QYASAB'
    'KAJSBWJvb3N0EicKD3Byb2R1Y3RzX2ZpbHRlchgCIAEoCVIOcHJvZHVjdHNGaWx0ZXIaJgoMRm'
    'lsdGVyQWN0aW9uEhYKBmZpbHRlchgBIAEoCVIGZmlsdGVyGjMKDlJlZGlyZWN0QWN0aW9uEiEK'
    'DHJlZGlyZWN0X3VyaRgBIAEoCVILcmVkaXJlY3RVcmkaMgoUVHdvd2F5U3lub255bXNBY3Rpb2'
    '4SGgoIc3lub255bXMYASADKAlSCHN5bm9ueW1zGnYKFE9uZXdheVN5bm9ueW1zQWN0aW9uEh8K'
    'C3F1ZXJ5X3Rlcm1zGAMgAygJUgpxdWVyeVRlcm1zEhoKCHN5bm9ueW1zGAQgAygJUghzeW5vbn'
    'ltcxIhCgxvbmV3YXlfdGVybXMYAiADKAlSC29uZXdheVRlcm1zGoIBChREb05vdEFzc29jaWF0'
    'ZUFjdGlvbhIfCgtxdWVyeV90ZXJtcxgCIAMoCVIKcXVlcnlUZXJtcxIzChZkb19ub3RfYXNzb2'
    'NpYXRlX3Rlcm1zGAMgAygJUhNkb05vdEFzc29jaWF0ZVRlcm1zEhQKBXRlcm1zGAEgAygJUgV0'
    'ZXJtcxpzChFSZXBsYWNlbWVudEFjdGlvbhIfCgtxdWVyeV90ZXJtcxgCIAMoCVIKcXVlcnlUZX'
    'JtcxIpChByZXBsYWNlbWVudF90ZXJtGAMgASgJUg9yZXBsYWNlbWVudFRlcm0SEgoEdGVybRgB'
    'IAEoCVIEdGVybRoxCgxJZ25vcmVBY3Rpb24SIQoMaWdub3JlX3Rlcm1zGAEgAygJUgtpZ25vcm'
    'VUZXJtcxqGAgoWRm9yY2VSZXR1cm5GYWNldEFjdGlvbhKNAQoaZmFjZXRfcG9zaXRpb25fYWRq'
    'dXN0bWVudHMYASADKAsyTy5nb29nbGUuY2xvdWQucmV0YWlsLnYyYmV0YS5SdWxlLkZvcmNlUm'
    'V0dXJuRmFjZXRBY3Rpb24uRmFjZXRQb3NpdGlvbkFkanVzdG1lbnRSGGZhY2V0UG9zaXRpb25B'
    'ZGp1c3RtZW50cxpcChdGYWNldFBvc2l0aW9uQWRqdXN0bWVudBIlCg5hdHRyaWJ1dGVfbmFtZR'
    'gBIAEoCVINYXR0cmlidXRlTmFtZRIaCghwb3NpdGlvbhgCIAEoBVIIcG9zaXRpb24aPAoRUmVt'
    'b3ZlRmFjZXRBY3Rpb24SJwoPYXR0cmlidXRlX25hbWVzGAEgAygJUg5hdHRyaWJ1dGVOYW1lc0'
    'IICgZhY3Rpb24=');
...
const PriceInfo$json = {
  ...
  '2': [
    ...
    {'1': 'price_range', '3': 7, '4': 1, '5': 11, '6': '.google.cloud.retail.v2beta.PriceInfo.PriceRange', '8': {}, '10': 'priceRange'},
  ],
...
const PriceInfo_PriceRange$json = {
  '1': 'PriceRange',
  '2': [
    {'1': 'price', '3': 1, '4': 1, '5': 11, '6': '.google.cloud.retail.v2beta.Interval', '10': 'price'},
    {'1': 'original_price', '3': 2, '4': 1, '5': 11, '6': '.google.cloud.retail.v2beta.Interval', '10': 'originalPrice'},
  ],
};
...
final $typed_data.Uint8List priceInfoDescriptor = $convert.base64Decode(
    ...
    '1lElYKC3ByaWNlX3JhbmdlGAcgASgLMjAuZ29vZ2xlLmNsb3VkLnJldGFpbC52MmJldGEuUHJp'
    'Y2VJbmZvLlByaWNlUmFuZ2VCA+BBA1IKcHJpY2VSYW5nZRqVAQoKUHJpY2VSYW5nZRI6CgVwcm'
    'ljZRgBIAEoCzIkLmdvb2dsZS5jbG91ZC5yZXRhaWwudjJiZXRhLkludGVydmFsUgVwcmljZRJL'
    'Cg5vcmlnaW5hbF9wcmljZRgCIAEoCzIkLmdvb2dsZS5jbG91ZC5yZXRhaWwudjJiZXRhLkludG'
    'VydmFsUg1vcmlnaW5hbFByaWNl');
...
const LocalInventory$json = {
  ...
  '2': [
    ...
    {'1': 'price_info', '3': 2, '4': 1, '5': 11, '6': '.google.cloud.retail.v2beta.PriceInfo', '10': 'priceInfo'},
    {'1': 'attributes', '3': 3, '4': 3, '5': 11, '6': '.google.cloud.retail.v2beta.LocalInventory.AttributesEntry', '10': 'attributes'},
...
final $typed_data.Uint8List localInventoryDescriptor = $convert.base64Decode(
    'Cg5Mb2NhbEludmVudG9yeRIZCghwbGFjZV9pZBgBIAEoCVIHcGxhY2VJZBJECgpwcmljZV9pbm'
    'ZvGAIgASgLMiUuZ29vZ2xlLmNsb3VkLnJldGFpbC52MmJldGEuUHJpY2VJbmZvUglwcmljZUlu'
    'Zm8SWgoKYXR0cmlidXRlcxgDIAMoCzI6Lmdvb2dsZS5jbG91ZC5yZXRhaWwudjJiZXRhLkxvY2'
    'FsSW52ZW50b3J5LkF0dHJpYnV0ZXNFbnRyeVIKYXR0cmlidXRlcxIwChFmdWxmaWxsbWVudF90'
    'eXBlcxgEIAMoCUID4EEEUhBmdWxmaWxsbWVudFR5cGVzGmoKD0F0dHJpYnV0ZXNFbnRyeRIQCg'
    'NrZXkYASABKAlSA2tleRJBCgV2YWx1ZRgCIAEoCzIrLmdvb2dsZS5jbG91ZC5yZXRhaWwudjJi'
    'ZXRhLkN1c3RvbUF0dHJpYnV0ZVIFdmFsdWU6AjgB');
