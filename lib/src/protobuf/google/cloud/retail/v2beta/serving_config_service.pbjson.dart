...
const CreateServingConfigRequest$json = {
  ...
  '2': [
    ...
    {'1': 'serving_config', '3': 2, '4': 1, '5': 11, '6': '.google.cloud.retail.v2beta.ServingConfig', '8': {}, '10': 'servingConfig'},
...
final $typed_data.Uint8List createServingConfigRequestDescriptor = $convert.base64Decode(
    ...
    'V0YWlsLmdvb2dsZWFwaXMuY29tL0NhdGFsb2dSBnBhcmVudBJVCg5zZXJ2aW5nX2NvbmZpZxgC'
    'IAEoCzIpLmdvb2dsZS5jbG91ZC5yZXRhaWwudjJiZXRhLlNlcnZpbmdDb25maWdCA+BBAlINc2'
    'VydmluZ0NvbmZpZxIvChFzZXJ2aW5nX2NvbmZpZ19pZBgDIAEoCUID4EECUg9zZXJ2aW5nQ29u'
    'ZmlnSWQ=');
...
const UpdateServingConfigRequest$json = {
  ...
  '2': [
    {'1': 'serving_config', '3': 1, '4': 1, '5': 11, '6': '.google.cloud.retail.v2beta.ServingConfig', '8': {}, '10': 'servingConfig'},
...
final $typed_data.Uint8List updateServingConfigRequestDescriptor = $convert.base64Decode(
    'ChpVcGRhdGVTZXJ2aW5nQ29uZmlnUmVxdWVzdBJVCg5zZXJ2aW5nX2NvbmZpZxgBIAEoCzIpLm'
    'dvb2dsZS5jbG91ZC5yZXRhaWwudjJiZXRhLlNlcnZpbmdDb25maWdCA+BBAlINc2VydmluZ0Nv'
...
const ListServingConfigsResponse$json = {
  ...
  '2': [
    {'1': 'serving_configs', '3': 1, '4': 3, '5': 11, '6': '.google.cloud.retail.v2beta.ServingConfig', '10': 'servingConfigs'},
...
final $typed_data.Uint8List listServingConfigsResponseDescriptor = $convert.base64Decode(
    'ChpMaXN0U2VydmluZ0NvbmZpZ3NSZXNwb25zZRJSCg9zZXJ2aW5nX2NvbmZpZ3MYASADKAsyKS'
    '5nb29nbGUuY2xvdWQucmV0YWlsLnYyYmV0YS5TZXJ2aW5nQ29uZmlnUg5zZXJ2aW5nQ29uZmln'
