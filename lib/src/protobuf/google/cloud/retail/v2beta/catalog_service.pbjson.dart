...
const ListCatalogsResponse$json = {
  ...
  '2': [
    {'1': 'catalogs', '3': 1, '4': 3, '5': 11, '6': '.google.cloud.retail.v2beta.Catalog', '10': 'catalogs'},
...
final $typed_data.Uint8List listCatalogsResponseDescriptor = $convert.base64Decode(
    'ChRMaXN0Q2F0YWxvZ3NSZXNwb25zZRI/CghjYXRhbG9ncxgBIAMoCzIjLmdvb2dsZS5jbG91ZC'
    '5yZXRhaWwudjJiZXRhLkNhdGFsb2dSCGNhdGFsb2dzEiYKD25leHRfcGFnZV90b2tlbhgCIAEo'
...
const UpdateCatalogRequest$json = {
  ...
  '2': [
    {'1': 'catalog', '3': 1, '4': 1, '5': 11, '6': '.google.cloud.retail.v2beta.Catalog', '8': {}, '10': 'catalog'},
...
final $typed_data.Uint8List updateCatalogRequestDescriptor = $convert.base64Decode(
    'ChRVcGRhdGVDYXRhbG9nUmVxdWVzdBJCCgdjYXRhbG9nGAEgASgLMiMuZ29vZ2xlLmNsb3VkLn'
    'JldGFpbC52MmJldGEuQ2F0YWxvZ0ID4EECUgdjYXRhbG9nEjsKC3VwZGF0ZV9tYXNrGAIgASgL'
...
const UpdateCompletionConfigRequest$json = {
  ...
  '2': [
    {'1': 'completion_config', '3': 1, '4': 1, '5': 11, '6': '.google.cloud.retail.v2beta.CompletionConfig', '8': {}, '10': 'completionConfig'},
    {'1': 'update_mask', '3': 2, '4': 1, '5': 11, '6': '.google.protobuf.FieldMask', '10': 'updateMask'},
  ],
};
...
final $typed_data.Uint8List updateCompletionConfigRequestDescriptor = $convert.base64Decode(
    'Ch1VcGRhdGVDb21wbGV0aW9uQ29uZmlnUmVxdWVzdBJeChFjb21wbGV0aW9uX2NvbmZpZxgBIA'
    'EoCzIsLmdvb2dsZS5jbG91ZC5yZXRhaWwudjJiZXRhLkNvbXBsZXRpb25Db25maWdCA+BBAlIQ'
    'Y29tcGxldGlvbkNvbmZpZxI7Cgt1cGRhdGVfbWFzaxgCIAEoCzIaLmdvb2dsZS5wcm90b2J1Zi'
...
const UpdateAttributesConfigRequest$json = {
  ...
  '2': [
    {'1': 'attributes_config', '3': 1, '4': 1, '5': 11, '6': '.google.cloud.retail.v2beta.AttributesConfig', '8': {}, '10': 'attributesConfig'},
    {'1': 'update_mask', '3': 2, '4': 1, '5': 11, '6': '.google.protobuf.FieldMask', '10': 'updateMask'},
  ],
};
...
final $typed_data.Uint8List updateAttributesConfigRequestDescriptor = $convert.base64Decode(
    'Ch1VcGRhdGVBdHRyaWJ1dGVzQ29uZmlnUmVxdWVzdBJeChFhdHRyaWJ1dGVzX2NvbmZpZxgBIA'
    'EoCzIsLmdvb2dsZS5jbG91ZC5yZXRhaWwudjJiZXRhLkF0dHJpYnV0ZXNDb25maWdCA+BBAlIQ'
    'YXR0cmlidXRlc0NvbmZpZxI7Cgt1cGRhdGVfbWFzaxgCIAEoCzIaLmdvb2dsZS5wcm90b2J1Zi'
    '5GaWVsZE1hc2tSCnVwZGF0ZU1hc2s=');
...
const AddCatalogAttributeRequest$json = {
  ...
  '2': [
    ...
    {'1': 'catalog_attribute', '3': 2, '4': 1, '5': 11, '6': '.google.cloud.retail.v2beta.CatalogAttribute', '8': {}, '10': 'catalogAttribute'},
  ],
};
...
final $typed_data.Uint8List addCatalogAttributeRequestDescriptor = $convert.base64Decode(
    ...
    'dXRlc0NvbmZpZxJeChFjYXRhbG9nX2F0dHJpYnV0ZRgCIAEoCzIsLmdvb2dsZS5jbG91ZC5yZX'
    'RhaWwudjJiZXRhLkNhdGFsb2dBdHRyaWJ1dGVCA+BBAlIQY2F0YWxvZ0F0dHJpYnV0ZQ==');
...
final $typed_data.Uint8List replaceCatalogAttributeRequestDescriptor = $convert.base64Decode(
    ...
    'dHJpYnV0ZXNDb25maWcSXgoRY2F0YWxvZ19hdHRyaWJ1dGUYAiABKAsyLC5nb29nbGUuY2xvdW'
    'QucmV0YWlsLnYyYmV0YS5DYXRhbG9nQXR0cmlidXRlQgPgQQJSEGNhdGFsb2dBdHRyaWJ1dGUS'
