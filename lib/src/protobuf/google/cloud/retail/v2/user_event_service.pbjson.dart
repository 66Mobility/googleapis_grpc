...
final $typed_data.Uint8List writeUserEventRequestDescriptor = $convert.base64Decode(
    'ChVXcml0ZVVzZXJFdmVudFJlcXVlc3QSGwoGcGFyZW50GAEgASgJQgPgQQJSBnBhcmVudBJFCg'
    'p1c2VyX2V2ZW50GAIgASgLMiEuZ29vZ2xlLmNsb3VkLnJldGFpbC52Mi5Vc2VyRXZlbnRCA+BB'
    'AlIJdXNlckV2ZW50Eh8KC3dyaXRlX2FzeW5jGAMgASgIUgp3cml0ZUFzeW5j');
...
const RejoinUserEventsRequest$json = {
  ...
  '2': [
    {'1': 'parent', '3': 1, '4': 1, '5': 9, '8': {}, '10': 'parent'},
    {'1': 'user_event_rejoin_scope', '3': 2, '4': 1, '5': 14, '6': '.google.cloud.retail.v2.RejoinUserEventsRequest.UserEventRejoinScope', '10': 'userEventRejoinScope'},
  ],
...
final $typed_data.Uint8List rejoinUserEventsRequestDescriptor = $convert.base64Decode(
    ...
    'sKF3VzZXJfZXZlbnRfcmVqb2luX3Njb3BlGAIgASgOMkQuZ29vZ2xlLmNsb3VkLnJldGFpbC52'
    'Mi5SZWpvaW5Vc2VyRXZlbnRzUmVxdWVzdC5Vc2VyRXZlbnRSZWpvaW5TY29wZVIUdXNlckV2ZW'
    '50UmVqb2luU2NvcGUiZwoUVXNlckV2ZW50UmVqb2luU2NvcGUSJwojVVNFUl9FVkVOVF9SRUpP'
    'SU5fU0NPUEVfVU5TUEVDSUZJRUQQABIRCg1KT0lORURfRVZFTlRTEAESEwoPVU5KT0lORURfRV'
    'ZFTlRTEAI=');
