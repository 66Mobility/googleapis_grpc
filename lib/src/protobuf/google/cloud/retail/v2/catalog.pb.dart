...
class ProductLevelConfig extends $pb.GeneratedMessage {
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(_omitMessageNames ? '' : 'ProductLevelConfig', package: const $pb.PackageName(_omitMessageNames ? '' : 'google.cloud.retail.v2'), createEmptyInstance: create)
...
class CatalogAttribute_FacetConfig_MergedFacetValue extends $pb.GeneratedMessage {
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(_omitMessageNames ? '' : 'CatalogAttribute.FacetConfig.MergedFacetValue', package: const $pb.PackageName(_omitMessageNames ? '' : 'google.cloud.retail.v2'), createEmptyInstance: create)
    ..pPS(1, _omitFieldNames ? '' : 'values')
...
class CatalogAttribute_FacetConfig_MergedFacet extends $pb.GeneratedMessage {
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(_omitMessageNames ? '' : 'CatalogAttribute.FacetConfig.MergedFacet', package: const $pb.PackageName(_omitMessageNames ? '' : 'google.cloud.retail.v2'), createEmptyInstance: create)
...
class CatalogAttribute_FacetConfig_RerankConfig extends $pb.GeneratedMessage {
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(_omitMessageNames ? '' : 'CatalogAttribute.FacetConfig.RerankConfig', package: const $pb.PackageName(_omitMessageNames ? '' : 'google.cloud.retail.v2'), createEmptyInstance: create)
...
class CatalogAttribute extends $pb.GeneratedMessage {
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(_omitMessageNames ? '' : 'CatalogAttribute', package: const $pb.PackageName(_omitMessageNames ? '' : 'google.cloud.retail.v2'), createEmptyInstance: create)
  ...
  @$pb.TagNumber(11)
  CatalogAttribute_ExactSearchableOption get exactSearchableOption => $_getN(6);
  @$pb.TagNumber(11)
  set exactSearchableOption(CatalogAttribute_ExactSearchableOption v) { setField(11, v); }
  @$pb.TagNumber(11)
  $core.bool hasExactSearchableOption() => $_has(6);
  @$pb.TagNumber(11)
  ...
  @$pb.TagNumber(12)
  CatalogAttribute_RetrievableOption get retrievableOption => $_getN(7);
  @$pb.TagNumber(12)
  set retrievableOption(CatalogAttribute_RetrievableOption v) { setField(12, v); }
  @$pb.TagNumber(12)
  $core.bool hasRetrievableOption() => $_has(7);
  @$pb.TagNumber(12)
  void clearRetrievableOption() => clearField(12);

  /// Contains facet options.
  @$pb.TagNumber(13)
  CatalogAttribute_FacetConfig get facetConfig => $_getN(8);
  @$pb.TagNumber(13)
  set facetConfig(CatalogAttribute_FacetConfig v) { setField(13, v); }
  @$pb.TagNumber(13)
  $core.bool hasFacetConfig() => $_has(8);
  @$pb.TagNumber(13)
  void clearFacetConfig() => clearField(13);
  @$pb.TagNumber(13)
  CatalogAttribute_FacetConfig ensureFacetConfig() => $_ensure(8);
}
...
class CompletionConfig extends $pb.GeneratedMessage {
  factory CompletionConfig({
    ...
    $1257.CompletionDataInputConfig? suggestionsInputConfig,
    $core.String? lastSuggestionsImportOperation,
    $1257.CompletionDataInputConfig? denylistInputConfig,
    $core.String? lastDenylistImportOperation,
    $1257.CompletionDataInputConfig? allowlistInputConfig,
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(_omitMessageNames ? '' : 'CompletionConfig', package: const $pb.PackageName(_omitMessageNames ? '' : 'google.cloud.retail.v2'), createEmptyInstance: create)
    ..aOS(1, _omitFieldNames ? '' : 'name')
    ...
    ..aOM<$1257.CompletionDataInputConfig>(5, _omitFieldNames ? '' : 'suggestionsInputConfig', subBuilder: $1257.CompletionDataInputConfig.create)
    ..aOS(6, _omitFieldNames ? '' : 'lastSuggestionsImportOperation')
    ..aOM<$1257.CompletionDataInputConfig>(7, _omitFieldNames ? '' : 'denylistInputConfig', subBuilder: $1257.CompletionDataInputConfig.create)
    ..aOS(8, _omitFieldNames ? '' : 'lastDenylistImportOperation')
    ..aOM<$1257.CompletionDataInputConfig>(9, _omitFieldNames ? '' : 'allowlistInputConfig', subBuilder: $1257.CompletionDataInputConfig.create)
  ...
  /// suggestion phrases.
  @$pb.TagNumber(5)
  $1257.CompletionDataInputConfig get suggestionsInputConfig => $_getN(4);
  @$pb.TagNumber(5)
  set suggestionsInputConfig($1257.CompletionDataInputConfig v) { setField(5, v); }
  @$pb.TagNumber(5)
  $core.bool hasSuggestionsInputConfig() => $_has(4);
  @$pb.TagNumber(5)
  void clearSuggestionsInputConfig() => clearField(5);
  @$pb.TagNumber(5)
  $1257.CompletionDataInputConfig ensureSuggestionsInputConfig() => $_ensure(4);
  ...
  /// denylist phrases.
  @$pb.TagNumber(7)
  $1257.CompletionDataInputConfig get denylistInputConfig => $_getN(6);
  @$pb.TagNumber(7)
  set denylistInputConfig($1257.CompletionDataInputConfig v) { setField(7, v); }
  @$pb.TagNumber(7)
  $core.bool hasDenylistInputConfig() => $_has(6);
  @$pb.TagNumber(7)
  void clearDenylistInputConfig() => clearField(7);
  @$pb.TagNumber(7)
  $1257.CompletionDataInputConfig ensureDenylistInputConfig() => $_ensure(6);
  ...
  /// allowlist phrases.
  @$pb.TagNumber(9)
  $1257.CompletionDataInputConfig get allowlistInputConfig => $_getN(8);
  @$pb.TagNumber(9)
  set allowlistInputConfig($1257.CompletionDataInputConfig v) { setField(9, v); }
  @$pb.TagNumber(9)
  $core.bool hasAllowlistInputConfig() => $_has(8);
  @$pb.TagNumber(9)
  void clearAllowlistInputConfig() => clearField(9);
  @$pb.TagNumber(9)
  $1257.CompletionDataInputConfig ensureAllowlistInputConfig() => $_ensure(8);
...
class Catalog extends $pb.GeneratedMessage {
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(_omitMessageNames ? '' : 'Catalog', package: const $pb.PackageName(_omitMessageNames ? '' : 'google.cloud.retail.v2'), createEmptyInstance: create)
    ..aOS(1, _omitFieldNames ? '' : 'name')
