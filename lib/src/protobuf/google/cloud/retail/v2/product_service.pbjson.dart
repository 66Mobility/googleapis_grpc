...
const CreateProductRequest$json = {
  ...
  '2': [
    ...
    {'1': 'product', '3': 2, '4': 1, '5': 11, '6': '.google.cloud.retail.v2.Product', '8': {}, '10': 'product'},
...
final $typed_data.Uint8List createProductRequestDescriptor = $convert.base64Decode(
    ...
    'dvb2dsZWFwaXMuY29tL0JyYW5jaFIGcGFyZW50Ej4KB3Byb2R1Y3QYAiABKAsyHy5nb29nbGUu'
    'Y2xvdWQucmV0YWlsLnYyLlByb2R1Y3RCA+BBAlIHcHJvZHVjdBIiCgpwcm9kdWN0X2lkGAMgAS'
    'gJQgPgQQJSCXByb2R1Y3RJZA==');
...
final $typed_data.Uint8List updateProductRequestDescriptor = $convert.base64Decode(
    ...
    'JldGFpbC52Mi5Qcm9kdWN0QgPgQQJSB3Byb2R1Y3QSOwoLdXBkYXRlX21hc2sYAiABKAsyGi5n'
    'b29nbGUucHJvdG9idWYuRmllbGRNYXNrUgp1cGRhdGVNYXNrEiMKDWFsbG93X21pc3NpbmcYAy'
    'ABKAhSDGFsbG93TWlzc2luZw==');
...
const ListProductsResponse$json = {
  ...
  '2': [
    {'1': 'products', '3': 1, '4': 3, '5': 11, '6': '.google.cloud.retail.v2.Product', '10': 'products'},
...
final $typed_data.Uint8List listProductsResponseDescriptor = $convert.base64Decode(
    ...
    '5yZXRhaWwudjIuUHJvZHVjdFIIcHJvZHVjdHMSJgoPbmV4dF9wYWdlX3Rva2VuGAIgASgJUg1u'
    'ZXh0UGFnZVRva2Vu');
...
const SetInventoryRequest$json = {
  ...
  '2': [
    {'1': 'inventory', '3': 1, '4': 1, '5': 11, '6': '.google.cloud.retail.v2.Product', '8': {}, '10': 'inventory'},
...
final $typed_data.Uint8List setInventoryRequestDescriptor = $convert.base64Decode(
    'ChNTZXRJbnZlbnRvcnlSZXF1ZXN0EkIKCWludmVudG9yeRgBIAEoCzIfLmdvb2dsZS5jbG91ZC'
    '5yZXRhaWwudjIuUHJvZHVjdEID4EECUglpbnZlbnRvcnkSNQoIc2V0X21hc2sYAiABKAsyGi5n'
    'b29nbGUucHJvdG9idWYuRmllbGRNYXNrUgdzZXRNYXNrEjUKCHNldF90aW1lGAMgASgLMhouZ2'
    '9vZ2xlLnByb3RvYnVmLlRpbWVzdGFtcFIHc2V0VGltZRIjCg1hbGxvd19taXNzaW5nGAQgASgI'
    'UgxhbGxvd01pc3Npbmc=');
...
const AddLocalInventoriesRequest$json = {
  ...
  '2': [
    {'1': 'product', '3': 1, '4': 1, '5': 9, '8': {}, '10': 'product'},
    {'1': 'local_inventories', '3': 2, '4': 3, '5': 11, '6': '.google.cloud.retail.v2.LocalInventory', '8': {}, '10': 'localInventories'},
...
final $typed_data.Uint8List addLocalInventoriesRequestDescriptor = $convert.base64Decode(
    ...
    'JldGFpbC5nb29nbGVhcGlzLmNvbS9Qcm9kdWN0Ugdwcm9kdWN0ElgKEWxvY2FsX2ludmVudG9y'
    'aWVzGAIgAygLMiYuZ29vZ2xlLmNsb3VkLnJldGFpbC52Mi5Mb2NhbEludmVudG9yeUID4EECUh'
    'Bsb2NhbEludmVudG9yaWVzEjUKCGFkZF9tYXNrGAQgASgLMhouZ29vZ2xlLnByb3RvYnVmLkZp'
    'ZWxkTWFza1IHYWRkTWFzaxI1CghhZGRfdGltZRgFIAEoCzIaLmdvb2dsZS5wcm90b2J1Zi5UaW'
    '1lc3RhbXBSB2FkZFRpbWUSIwoNYWxsb3dfbWlzc2luZxgGIAEoCFIMYWxsb3dNaXNzaW5n');
