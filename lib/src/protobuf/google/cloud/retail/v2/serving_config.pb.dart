...
class ServingConfig extends $pb.GeneratedMessage {
  factory ServingConfig({
    ...
    $1266.SearchRequest_DynamicFacetSpec? dynamicFacetSpec,
    ...
    $1266.SearchRequest_PersonalizationSpec? personalizationSpec,
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(_omitMessageNames ? '' : 'ServingConfig', package: const $pb.PackageName(_omitMessageNames ? '' : 'google.cloud.retail.v2'), createEmptyInstance: create)
    ..aOS(1, _omitFieldNames ? '' : 'name')
    ..aOS(2, _omitFieldNames ? '' : 'displayName')
    ..aOS(3, _omitFieldNames ? '' : 'modelId')
    ..aOS(4, _omitFieldNames ? '' : 'priceRerankingLevel')
    ..pPS(5, _omitFieldNames ? '' : 'facetControlIds')
    ..aOM<$1266.SearchRequest_DynamicFacetSpec>(6, _omitFieldNames ? '' : 'dynamicFacetSpec', subBuilder: $1266.SearchRequest_DynamicFacetSpec.create)
    ...
    ..pc<$4593.SolutionType>(19, _omitFieldNames ? '' : 'solutionTypes', $pb.PbFieldType.KE, valueOf: $4593.SolutionType.valueOf, enumValues: $4593.SolutionType.values, defaultEnumValue: $4593.SolutionType.SOLUTION_TYPE_UNSPECIFIED)
    ...
    ..aOM<$1266.SearchRequest_PersonalizationSpec>(21, _omitFieldNames ? '' : 'personalizationSpec', subBuilder: $1266.SearchRequest_PersonalizationSpec.create)
  ...
  ///  [SOLUTION_TYPE_SEARCH][google.cloud.retail.v2main.SolutionType.SOLUTION_TYPE_SEARCH].
  @$pb.TagNumber(6)
  $1266.SearchRequest_DynamicFacetSpec get dynamicFacetSpec => $_getN(5);
  @$pb.TagNumber(6)
  set dynamicFacetSpec($1266.SearchRequest_DynamicFacetSpec v) { setField(6, v); }
  @$pb.TagNumber(6)
  $core.bool hasDynamicFacetSpec() => $_has(5);
  @$pb.TagNumber(6)
  void clearDynamicFacetSpec() => clearField(6);
  @$pb.TagNumber(6)
  $1266.SearchRequest_DynamicFacetSpec ensureDynamicFacetSpec() => $_ensure(5);
  ...
  @$pb.TagNumber(19)
  $core.List<$4593.SolutionType> get solutionTypes => $_getList(16);
  ...
  ///  [ServingConfig.personalization_spec][google.cloud.retail.v2.ServingConfig.personalization_spec].
  @$pb.TagNumber(21)
  $1266.SearchRequest_PersonalizationSpec get personalizationSpec => $_getN(18);
  @$pb.TagNumber(21)
  set personalizationSpec($1266.SearchRequest_PersonalizationSpec v) { setField(21, v); }
  @$pb.TagNumber(21)
  $core.bool hasPersonalizationSpec() => $_has(18);
  @$pb.TagNumber(21)
  void clearPersonalizationSpec() => clearField(21);
  @$pb.TagNumber(21)
  $1266.SearchRequest_PersonalizationSpec ensurePersonalizationSpec() => $_ensure(18);
