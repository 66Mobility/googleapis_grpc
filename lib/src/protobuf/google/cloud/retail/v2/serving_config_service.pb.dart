...
class CreateServingConfigRequest extends $pb.GeneratedMessage {
  factory CreateServingConfigRequest({
    $core.String? parent,
    $1268.ServingConfig? servingConfig,
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(_omitMessageNames ? '' : 'CreateServingConfigRequest', package: const $pb.PackageName(_omitMessageNames ? '' : 'google.cloud.retail.v2'), createEmptyInstance: create)
    ..aOS(1, _omitFieldNames ? '' : 'parent')
    ..aOM<$1268.ServingConfig>(2, _omitFieldNames ? '' : 'servingConfig', subBuilder: $1268.ServingConfig.create)
  ...
  @$pb.TagNumber(2)
  $1268.ServingConfig get servingConfig => $_getN(1);
  @$pb.TagNumber(2)
  set servingConfig($1268.ServingConfig v) { setField(2, v); }
  @$pb.TagNumber(2)
  $core.bool hasServingConfig() => $_has(1);
  @$pb.TagNumber(2)
  void clearServingConfig() => clearField(2);
  @$pb.TagNumber(2)
  $1268.ServingConfig ensureServingConfig() => $_ensure(1);
...
class UpdateServingConfigRequest extends $pb.GeneratedMessage {
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(_omitMessageNames ? '' : 'UpdateServingConfigRequest', package: const $pb.PackageName(_omitMessageNames ? '' : 'google.cloud.retail.v2'), createEmptyInstance: create)
    ..aOM<$1268.ServingConfig>(1, _omitFieldNames ? '' : 'servingConfig', subBuilder: $1268.ServingConfig.create)
  ...
  @$pb.TagNumber(1)
  $1268.ServingConfig get servingConfig => $_getN(0);
  @$pb.TagNumber(1)
  set servingConfig($1268.ServingConfig v) { setField(1, v); }
  @$pb.TagNumber(1)
  $core.bool hasServingConfig() => $_has(0);
  @$pb.TagNumber(1)
  void clearServingConfig() => clearField(1);
  @$pb.TagNumber(1)
  $1268.ServingConfig ensureServingConfig() => $_ensure(0);
...
class DeleteServingConfigRequest extends $pb.GeneratedMessage {
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(_omitMessageNames ? '' : 'DeleteServingConfigRequest', package: const $pb.PackageName(_omitMessageNames ? '' : 'google.cloud.retail.v2'), createEmptyInstance: create)
...
class GetServingConfigRequest extends $pb.GeneratedMessage {
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(_omitMessageNames ? '' : 'GetServingConfigRequest', package: const $pb.PackageName(_omitMessageNames ? '' : 'google.cloud.retail.v2'), createEmptyInstance: create)
    ..aOS(1, _omitFieldNames ? '' : 'name')
    ..hasRequiredFields = false
  ;
...
class ListServingConfigsRequest extends $pb.GeneratedMessage {
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(_omitMessageNames ? '' : 'ListServingConfigsRequest', package: const $pb.PackageName(_omitMessageNames ? '' : 'google.cloud.retail.v2'), createEmptyInstance: create)
    ..aOS(1, _omitFieldNames ? '' : 'parent')
...
class ListServingConfigsResponse extends $pb.GeneratedMessage {
  factory ListServingConfigsResponse({
    $core.Iterable<$1268.ServingConfig>? servingConfigs,
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(_omitMessageNames ? '' : 'ListServingConfigsResponse', package: const $pb.PackageName(_omitMessageNames ? '' : 'google.cloud.retail.v2'), createEmptyInstance: create)
    ..pc<$1268.ServingConfig>(1, _omitFieldNames ? '' : 'servingConfigs', $pb.PbFieldType.PM, subBuilder: $1268.ServingConfig.create)
  ...
  @$pb.TagNumber(1)
  $core.List<$1268.ServingConfig> get servingConfigs => $_getList(0);
...
class AddControlRequest extends $pb.GeneratedMessage {
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(_omitMessageNames ? '' : 'AddControlRequest', package: const $pb.PackageName(_omitMessageNames ? '' : 'google.cloud.retail.v2'), createEmptyInstance: create)
...
class RemoveControlRequest extends $pb.GeneratedMessage {
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(_omitMessageNames ? '' : 'RemoveControlRequest', package: const $pb.PackageName(_omitMessageNames ? '' : 'google.cloud.retail.v2'), createEmptyInstance: create)
    ..aOS(1, _omitFieldNames ? '' : 'servingConfig')
    ..aOS(2, _omitFieldNames ? '' : 'controlId')
    ..hasRequiredFields = false
  ;
