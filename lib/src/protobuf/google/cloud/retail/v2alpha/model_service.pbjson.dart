...
const CreateModelRequest$json = {
  ...
  '2': [
    ...
    {'1': 'model', '3': 2, '4': 1, '5': 11, '6': '.google.cloud.retail.v2alpha.Model', '8': {}, '10': 'model'},
...
final $typed_data.Uint8List createModelRequestDescriptor = $convert.base64Decode(
    ...
    '9nbGVhcGlzLmNvbS9DYXRhbG9nUgZwYXJlbnQSPQoFbW9kZWwYAiABKAsyIi5nb29nbGUuY2xv'
    'dWQucmV0YWlsLnYyYWxwaGEuTW9kZWxCA+BBAlIFbW9kZWwSHAoHZHJ5X3J1bhgDIAEoCEID4E'
    'EBUgZkcnlSdW4=');
...
const UpdateModelRequest$json = {
  ...
  '2': [
    {'1': 'model', '3': 1, '4': 1, '5': 11, '6': '.google.cloud.retail.v2alpha.Model', '8': {}, '10': 'model'},
...
final $typed_data.Uint8List updateModelRequestDescriptor = $convert.base64Decode(
    'ChJVcGRhdGVNb2RlbFJlcXVlc3QSPQoFbW9kZWwYASABKAsyIi5nb29nbGUuY2xvdWQucmV0YW'
    'lsLnYyYWxwaGEuTW9kZWxCA+BBAlIFbW9kZWwSQAoLdXBkYXRlX21hc2sYAiABKAsyGi5nb29n'
...
const ListModelsResponse$json = {
  ...
  '2': [
    {'1': 'models', '3': 1, '4': 3, '5': 11, '6': '.google.cloud.retail.v2alpha.Model', '10': 'models'},
...
final $typed_data.Uint8List listModelsResponseDescriptor = $convert.base64Decode(
    'ChJMaXN0TW9kZWxzUmVzcG9uc2USOgoGbW9kZWxzGAEgAygLMiIuZ29vZ2xlLmNsb3VkLnJldG'
    'FpbC52MmFscGhhLk1vZGVsUgZtb2RlbHMSJgoPbmV4dF9wYWdlX3Rva2VuGAIgASgJUg1uZXh0'
    'UGFnZVRva2Vu');
