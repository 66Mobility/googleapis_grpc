...
class SearchRequest_RelevanceThreshold extends $pb.ProtobufEnum {
  ...
  static const SearchRequest_RelevanceThreshold HIGH = SearchRequest_RelevanceThreshold._(1, _omitEnumNames ? '' : 'HIGH');
  static const SearchRequest_RelevanceThreshold MEDIUM = SearchRequest_RelevanceThreshold._(2, _omitEnumNames ? '' : 'MEDIUM');
  static const SearchRequest_RelevanceThreshold LOW = SearchRequest_RelevanceThreshold._(3, _omitEnumNames ? '' : 'LOW');
  static const SearchRequest_RelevanceThreshold LOWEST = SearchRequest_RelevanceThreshold._(4, _omitEnumNames ? '' : 'LOWEST');
