...
class CatalogAttribute extends $pb.GeneratedMessage {
  factory CatalogAttribute({
    ...
    $4595.RecommendationsFilteringOption? recommendationsFilteringOption,
    $core.bool? inUse,
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(_omitMessageNames ? '' : 'CatalogAttribute', package: const $pb.PackageName(_omitMessageNames ? '' : 'google.cloud.retail.v2alpha'), createEmptyInstance: create)
    ...
    ..e<$4595.RecommendationsFilteringOption>(8, _omitFieldNames ? '' : 'recommendationsFilteringOption', $pb.PbFieldType.OE, defaultOrMaker: $4595.RecommendationsFilteringOption.RECOMMENDATIONS_FILTERING_OPTION_UNSPECIFIED, valueOf: $4595.RecommendationsFilteringOption.valueOf, enumValues: $4595.RecommendationsFilteringOption.values)
  ...
  @$pb.TagNumber(8)
  $4595.RecommendationsFilteringOption get recommendationsFilteringOption => $_getN(4);
  @$pb.TagNumber(8)
  set recommendationsFilteringOption($4595.RecommendationsFilteringOption v) { setField(8, v); }
  @$pb.TagNumber(8)
