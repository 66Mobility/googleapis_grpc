...
class ProductLevelConfig extends $pb.GeneratedMessage {
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(_omitMessageNames ? '' : 'ProductLevelConfig', package: const $pb.PackageName(_omitMessageNames ? '' : 'google.cloud.retail.v2alpha'), createEmptyInstance: create)
...
class CatalogAttribute_FacetConfig_IgnoredFacetValues extends $pb.GeneratedMessage {
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(_omitMessageNames ? '' : 'CatalogAttribute.FacetConfig.IgnoredFacetValues', package: const $pb.PackageName(_omitMessageNames ? '' : 'google.cloud.retail.v2alpha'), createEmptyInstance: create)
...
class CatalogAttribute_FacetConfig_MergedFacetValue extends $pb.GeneratedMessage {
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(_omitMessageNames ? '' : 'CatalogAttribute.FacetConfig.MergedFacetValue', package: const $pb.PackageName(_omitMessageNames ? '' : 'google.cloud.retail.v2alpha'), createEmptyInstance: create)
    ..pPS(1, _omitFieldNames ? '' : 'values')
...
class CatalogAttribute_FacetConfig_MergedFacet extends $pb.GeneratedMessage {
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(_omitMessageNames ? '' : 'CatalogAttribute.FacetConfig.MergedFacet', package: const $pb.PackageName(_omitMessageNames ? '' : 'google.cloud.retail.v2alpha'), createEmptyInstance: create)
...
class CatalogAttribute_FacetConfig_RerankConfig extends $pb.GeneratedMessage {
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(_omitMessageNames ? '' : 'CatalogAttribute.FacetConfig.RerankConfig', package: const $pb.PackageName(_omitMessageNames ? '' : 'google.cloud.retail.v2alpha'), createEmptyInstance: create)
...
class CatalogAttribute_FacetConfig extends $pb.GeneratedMessage {
  factory CatalogAttribute_FacetConfig({
    $core.Iterable<$4597.Interval>? facetIntervals,
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(_omitMessageNames ? '' : 'CatalogAttribute.FacetConfig', package: const $pb.PackageName(_omitMessageNames ? '' : 'google.cloud.retail.v2alpha'), createEmptyInstance: create)
    ..pc<$4597.Interval>(1, _omitFieldNames ? '' : 'facetIntervals', $pb.PbFieldType.PM, subBuilder: $4597.Interval.create)
  ...
  /// upper bound.
  @$pb.TagNumber(1)
  $core.List<$4597.Interval> get facetIntervals => $_getList(0);
...
class CatalogAttribute extends $pb.GeneratedMessage {
  factory CatalogAttribute({
    ...
    $4597.RecommendationsFilteringOption? recommendationsFilteringOption,
    $core.bool? inUse,
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(_omitMessageNames ? '' : 'CatalogAttribute', package: const $pb.PackageName(_omitMessageNames ? '' : 'google.cloud.retail.v2alpha'), createEmptyInstance: create)
    ...
    ..e<$4597.RecommendationsFilteringOption>(8, _omitFieldNames ? '' : 'recommendationsFilteringOption', $pb.PbFieldType.OE, defaultOrMaker: $4597.RecommendationsFilteringOption.RECOMMENDATIONS_FILTERING_OPTION_UNSPECIFIED, valueOf: $4597.RecommendationsFilteringOption.valueOf, enumValues: $4597.RecommendationsFilteringOption.values)
  ...
  @$pb.TagNumber(8)
  $4597.RecommendationsFilteringOption get recommendationsFilteringOption => $_getN(4);
  @$pb.TagNumber(8)
  set recommendationsFilteringOption($4597.RecommendationsFilteringOption v) { setField(8, v); }
  @$pb.TagNumber(8)
...
class AttributesConfig extends $pb.GeneratedMessage {
  factory AttributesConfig({
    ...
    $4597.AttributeConfigLevel? attributeConfigLevel,
  }) {
    final $result = create();
    if (name != null) {
      $result.name = name;
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(_omitMessageNames ? '' : 'AttributesConfig', package: const $pb.PackageName(_omitMessageNames ? '' : 'google.cloud.retail.v2alpha'), createEmptyInstance: create)
    ..aOS(1, _omitFieldNames ? '' : 'name')
    ..m<$core.String, CatalogAttribute>(2, _omitFieldNames ? '' : 'catalogAttributes', entryClassName: 'AttributesConfig.CatalogAttributesEntry', keyFieldType: $pb.PbFieldType.OS, valueFieldType: $pb.PbFieldType.OM, valueCreator: CatalogAttribute.create, valueDefaultOrMaker: CatalogAttribute.getDefault, packageName: const $pb.PackageName('google.cloud.retail.v2alpha'))
    ..e<$4597.AttributeConfigLevel>(3, _omitFieldNames ? '' : 'attributeConfigLevel', $pb.PbFieldType.OE, defaultOrMaker: $4597.AttributeConfigLevel.ATTRIBUTE_CONFIG_LEVEL_UNSPECIFIED, valueOf: $4597.AttributeConfigLevel.valueOf, enumValues: $4597.AttributeConfigLevel.values)
    ..hasRequiredFields = false
  ;
  ...
  @$pb.TagNumber(3)
  $4597.AttributeConfigLevel get attributeConfigLevel => $_getN(2);
  @$pb.TagNumber(3)
  set attributeConfigLevel($4597.AttributeConfigLevel v) { setField(3, v); }
  @$pb.TagNumber(3)
...
class CompletionConfig extends $pb.GeneratedMessage {
  factory CompletionConfig({
    ...
    $1278.CompletionDataInputConfig? suggestionsInputConfig,
    $core.String? lastSuggestionsImportOperation,
    $1278.CompletionDataInputConfig? denylistInputConfig,
    $core.String? lastDenylistImportOperation,
    $1278.CompletionDataInputConfig? allowlistInputConfig,
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(_omitMessageNames ? '' : 'CompletionConfig', package: const $pb.PackageName(_omitMessageNames ? '' : 'google.cloud.retail.v2alpha'), createEmptyInstance: create)
    ..aOS(1, _omitFieldNames ? '' : 'name')
    ...
    ..aOM<$1278.CompletionDataInputConfig>(5, _omitFieldNames ? '' : 'suggestionsInputConfig', subBuilder: $1278.CompletionDataInputConfig.create)
    ..aOS(6, _omitFieldNames ? '' : 'lastSuggestionsImportOperation')
    ..aOM<$1278.CompletionDataInputConfig>(7, _omitFieldNames ? '' : 'denylistInputConfig', subBuilder: $1278.CompletionDataInputConfig.create)
    ..aOS(8, _omitFieldNames ? '' : 'lastDenylistImportOperation')
    ..aOM<$1278.CompletionDataInputConfig>(9, _omitFieldNames ? '' : 'allowlistInputConfig', subBuilder: $1278.CompletionDataInputConfig.create)
  ...
  /// suggestion phrases.
  @$pb.TagNumber(5)
  $1278.CompletionDataInputConfig get suggestionsInputConfig => $_getN(4);
  @$pb.TagNumber(5)
  set suggestionsInputConfig($1278.CompletionDataInputConfig v) { setField(5, v); }
  @$pb.TagNumber(5)
  $core.bool hasSuggestionsInputConfig() => $_has(4);
  @$pb.TagNumber(5)
  void clearSuggestionsInputConfig() => clearField(5);
  @$pb.TagNumber(5)
  $1278.CompletionDataInputConfig ensureSuggestionsInputConfig() => $_ensure(4);
  ...
  /// denylist phrases.
  @$pb.TagNumber(7)
  $1278.CompletionDataInputConfig get denylistInputConfig => $_getN(6);
  @$pb.TagNumber(7)
  set denylistInputConfig($1278.CompletionDataInputConfig v) { setField(7, v); }
  @$pb.TagNumber(7)
  $core.bool hasDenylistInputConfig() => $_has(6);
  @$pb.TagNumber(7)
  void clearDenylistInputConfig() => clearField(7);
  @$pb.TagNumber(7)
  $1278.CompletionDataInputConfig ensureDenylistInputConfig() => $_ensure(6);
  ...
  /// allowlist phrases.
  @$pb.TagNumber(9)
  $1278.CompletionDataInputConfig get allowlistInputConfig => $_getN(8);
  @$pb.TagNumber(9)
  set allowlistInputConfig($1278.CompletionDataInputConfig v) { setField(9, v); }
  @$pb.TagNumber(9)
  $core.bool hasAllowlistInputConfig() => $_has(8);
  @$pb.TagNumber(9)
  void clearAllowlistInputConfig() => clearField(9);
  @$pb.TagNumber(9)
  $1278.CompletionDataInputConfig ensureAllowlistInputConfig() => $_ensure(8);
...
class MerchantCenterLink extends $pb.GeneratedMessage {
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(_omitMessageNames ? '' : 'MerchantCenterLink', package: const $pb.PackageName(_omitMessageNames ? '' : 'google.cloud.retail.v2alpha'), createEmptyInstance: create)
...
class MerchantCenterFeedFilter extends $pb.GeneratedMessage {
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(_omitMessageNames ? '' : 'MerchantCenterFeedFilter', package: const $pb.PackageName(_omitMessageNames ? '' : 'google.cloud.retail.v2alpha'), createEmptyInstance: create)
...
class MerchantCenterLinkingConfig extends $pb.GeneratedMessage {
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(_omitMessageNames ? '' : 'MerchantCenterLinkingConfig', package: const $pb.PackageName(_omitMessageNames ? '' : 'google.cloud.retail.v2alpha'), createEmptyInstance: create)
...
class Catalog extends $pb.GeneratedMessage {
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(_omitMessageNames ? '' : 'Catalog', package: const $pb.PackageName(_omitMessageNames ? '' : 'google.cloud.retail.v2alpha'), createEmptyInstance: create)
    ..aOS(1, _omitFieldNames ? '' : 'name')
