...
final $typed_data.Uint8List writeUserEventRequestDescriptor = $convert.base64Decode(
    'ChVXcml0ZVVzZXJFdmVudFJlcXVlc3QSGwoGcGFyZW50GAEgASgJQgPgQQJSBnBhcmVudBJKCg'
    'p1c2VyX2V2ZW50GAIgASgLMiYuZ29vZ2xlLmNsb3VkLnJldGFpbC52MmFscGhhLlVzZXJFdmVu'
    'dEID4EECUgl1c2VyRXZlbnQSHwoLd3JpdGVfYXN5bmMYAyABKAhSCndyaXRlQXN5bmM=');
...
const RejoinUserEventsRequest$json = {
  ...
  '2': [
    {'1': 'parent', '3': 1, '4': 1, '5': 9, '8': {}, '10': 'parent'},
    {'1': 'user_event_rejoin_scope', '3': 2, '4': 1, '5': 14, '6': '.google.cloud.retail.v2alpha.RejoinUserEventsRequest.UserEventRejoinScope', '10': 'userEventRejoinScope'},
  ],
...
final $typed_data.Uint8List rejoinUserEventsRequestDescriptor = $convert.base64Decode(
    'ChdSZWpvaW5Vc2VyRXZlbnRzUmVxdWVzdBIbCgZwYXJlbnQYASABKAlCA+BBAlIGcGFyZW50Eo'
    'ABChd1c2VyX2V2ZW50X3Jlam9pbl9zY29wZRgCIAEoDjJJLmdvb2dsZS5jbG91ZC5yZXRhaWwu'
    'djJhbHBoYS5SZWpvaW5Vc2VyRXZlbnRzUmVxdWVzdC5Vc2VyRXZlbnRSZWpvaW5TY29wZVIUdX'
    'NlckV2ZW50UmVqb2luU2NvcGUiZwoUVXNlckV2ZW50UmVqb2luU2NvcGUSJwojVVNFUl9FVkVO'
    'VF9SRUpPSU5fU0NPUEVfVU5TUEVDSUZJRUQQABIRCg1KT0lORURfRVZFTlRTEAESEwoPVU5KT0'
    'lORURfRVZFTlRTEAI=');
