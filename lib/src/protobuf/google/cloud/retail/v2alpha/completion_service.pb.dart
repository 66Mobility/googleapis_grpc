...
class CompleteQueryRequest extends $pb.GeneratedMessage {
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(_omitMessageNames ? '' : 'CompleteQueryRequest', package: const $pb.PackageName(_omitMessageNames ? '' : 'google.cloud.retail.v2alpha'), createEmptyInstance: create)
...
class CompleteQueryResponse_CompletionResult extends $pb.GeneratedMessage {
  factory CompleteQueryResponse_CompletionResult({
    ...
    if (totalProductCount != null) {
      $result.totalProductCount = totalProductCount;
    }
    return $result;
  }
  ...
  @$pb.TagNumber(3)
  $core.List<$1276.SearchResponse_Facet> get facets => $_getList(2);
  ...
  ///  team.
  @$pb.TagNumber(4)
  $core.int get totalProductCount => $_getIZ(3);
  @$pb.TagNumber(4)
  set totalProductCount($core.int v) { $_setSignedInt32(3, v); }
  @$pb.TagNumber(4)
  $core.bool hasTotalProductCount() => $_has(3);
  @$pb.TagNumber(4)
  void clearTotalProductCount() => clearField(4);
}
...
class CompleteQueryResponse_RecentSearchResult extends $pb.GeneratedMessage {
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(_omitMessageNames ? '' : 'CompleteQueryResponse.RecentSearchResult', package: const $pb.PackageName(_omitMessageNames ? '' : 'google.cloud.retail.v2alpha'), createEmptyInstance: create)
...
class CompleteQueryResponse_AttributeResult extends $pb.GeneratedMessage {
  factory CompleteQueryResponse_AttributeResult({
  ...
  CompleteQueryResponse_AttributeResult._() : super();
  factory CompleteQueryResponse_AttributeResult.fromBuffer($core.List<$core.int> i, [$pb.ExtensionRegistry r = $pb.ExtensionRegistry.EMPTY]) => create()..mergeFromBuffer(i, r);
  factory CompleteQueryResponse_AttributeResult.fromJson($core.String i, [$pb.ExtensionRegistry r = $pb.ExtensionRegistry.EMPTY]) => create()..mergeFromJson(i, r);

  static final $pb.BuilderInfo _i = $pb.BuilderInfo(_omitMessageNames ? '' : 'CompleteQueryResponse.AttributeResult', package: const $pb.PackageName(_omitMessageNames ? '' : 'google.cloud.retail.v2alpha'), createEmptyInstance: create)
  ...
  'Use [GeneratedMessageGenericExtensions.deepCopy] instead. '
  'Will be removed in next major version')
  CompleteQueryResponse_AttributeResult clone() => CompleteQueryResponse_AttributeResult()..mergeFromMessage(this);
  @$core.Deprecated(
  'Using this can add significant overhead to your binary. '
  'Use [GeneratedMessageGenericExtensions.rebuild] instead. '
  'Will be removed in next major version')
  CompleteQueryResponse_AttributeResult copyWith(void Function(CompleteQueryResponse_AttributeResult) updates) => super.copyWith((message) => updates(message as CompleteQueryResponse_AttributeResult)) as CompleteQueryResponse_AttributeResult;

  $pb.BuilderInfo get info_ => _i;

  @$core.pragma('dart2js:noInline')
  static CompleteQueryResponse_AttributeResult create() => CompleteQueryResponse_AttributeResult._();
  CompleteQueryResponse_AttributeResult createEmptyInstance() => create();
  static $pb.PbList<CompleteQueryResponse_AttributeResult> createRepeated() => $pb.PbList<CompleteQueryResponse_AttributeResult>();
  @$core.pragma('dart2js:noInline')
  static CompleteQueryResponse_AttributeResult getDefault() => _defaultInstance ??= $pb.GeneratedMessage.$_defaultFor<CompleteQueryResponse_AttributeResult>(create);
  static CompleteQueryResponse_AttributeResult? _defaultInstance;
...
class CompleteQueryResponse extends $pb.GeneratedMessage {
  ...
  @$core.Deprecated('This field is deprecated.')
    ...
    $core.Map<$core.String, CompleteQueryResponse_AttributeResult>? attributeResults,
  }) {
    final $result = create();
    ...
    if (attributeResults != null) {
      $result.attributeResults.addAll(attributeResults);
    }
    return $result;
  }
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(_omitMessageNames ? '' : 'CompleteQueryResponse', package: const $pb.PackageName(_omitMessageNames ? '' : 'google.cloud.retail.v2alpha'), createEmptyInstance: create)
    ...
    ..m<$core.String, CompleteQueryResponse_AttributeResult>(4, _omitFieldNames ? '' : 'attributeResults', entryClassName: 'CompleteQueryResponse.AttributeResultsEntry', keyFieldType: $pb.PbFieldType.OS, valueFieldType: $pb.PbFieldType.OM, valueCreator: CompleteQueryResponse_AttributeResult.create, valueDefaultOrMaker: CompleteQueryResponse_AttributeResult.getDefault, packageName: const $pb.PackageName('google.cloud.retail.v2alpha'))
    ..hasRequiredFields = false
  ;
  ...
  ///  * `categories`
  @$pb.TagNumber(4)
  $core.Map<$core.String, CompleteQueryResponse_AttributeResult> get attributeResults => $_getMap(3);
}
