...
const CreateServingConfigRequest$json = {
  ...
  '2': [
    ...
    {'1': 'serving_config', '3': 2, '4': 1, '5': 11, '6': '.google.cloud.retail.v2alpha.ServingConfig', '8': {}, '10': 'servingConfig'},
...
final $typed_data.Uint8List createServingConfigRequestDescriptor = $convert.base64Decode(
    ...
    'V0YWlsLmdvb2dsZWFwaXMuY29tL0NhdGFsb2dSBnBhcmVudBJWCg5zZXJ2aW5nX2NvbmZpZxgC'
    'IAEoCzIqLmdvb2dsZS5jbG91ZC5yZXRhaWwudjJhbHBoYS5TZXJ2aW5nQ29uZmlnQgPgQQJSDX'
    'NlcnZpbmdDb25maWcSLwoRc2VydmluZ19jb25maWdfaWQYAyABKAlCA+BBAlIPc2VydmluZ0Nv'
    'bmZpZ0lk');
...
const UpdateServingConfigRequest$json = {
  ...
  '2': [
    {'1': 'serving_config', '3': 1, '4': 1, '5': 11, '6': '.google.cloud.retail.v2alpha.ServingConfig', '8': {}, '10': 'servingConfig'},
...
final $typed_data.Uint8List updateServingConfigRequestDescriptor = $convert.base64Decode(
    'ChpVcGRhdGVTZXJ2aW5nQ29uZmlnUmVxdWVzdBJWCg5zZXJ2aW5nX2NvbmZpZxgBIAEoCzIqLm'
    'dvb2dsZS5jbG91ZC5yZXRhaWwudjJhbHBoYS5TZXJ2aW5nQ29uZmlnQgPgQQJSDXNlcnZpbmdD'
...
const ListServingConfigsResponse$json = {
  ...
  '2': [
    {'1': 'serving_configs', '3': 1, '4': 3, '5': 11, '6': '.google.cloud.retail.v2alpha.ServingConfig', '10': 'servingConfigs'},
...
final $typed_data.Uint8List listServingConfigsResponseDescriptor = $convert.base64Decode(
    'ChpMaXN0U2VydmluZ0NvbmZpZ3NSZXNwb25zZRJTCg9zZXJ2aW5nX2NvbmZpZ3MYASADKAsyKi'
    '5nb29nbGUuY2xvdWQucmV0YWlsLnYyYWxwaGEuU2VydmluZ0NvbmZpZ1IOc2VydmluZ0NvbmZp'
