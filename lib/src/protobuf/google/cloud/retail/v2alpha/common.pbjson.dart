...
const Condition$json = {
  '1': 'Condition',
  '2': [
    {'1': 'query_terms', '3': 1, '4': 3, '5': 11, '6': '.google.cloud.retail.v2alpha.Condition.QueryTerm', '10': 'queryTerms'},
    {'1': 'active_time_range', '3': 3, '4': 3, '5': 11, '6': '.google.cloud.retail.v2alpha.Condition.TimeRange', '10': 'activeTimeRange'},
...
final $typed_data.Uint8List conditionDescriptor = $convert.base64Decode(
    'CglDb25kaXRpb24SUQoLcXVlcnlfdGVybXMYASADKAsyMC5nb29nbGUuY2xvdWQucmV0YWlsLn'
    'YyYWxwaGEuQ29uZGl0aW9uLlF1ZXJ5VGVybVIKcXVlcnlUZXJtcxJcChFhY3RpdmVfdGltZV9y'
    'YW5nZRgDIAMoCzIwLmdvb2dsZS5jbG91ZC5yZXRhaWwudjJhbHBoYS5Db25kaXRpb24uVGltZV'
    'JhbmdlUg9hY3RpdmVUaW1lUmFuZ2USJwoPcGFnZV9jYXRlZ29yaWVzGAQgAygJUg5wYWdlQ2F0'
    'ZWdvcmllcxpACglRdWVyeVRlcm0SFAoFdmFsdWUYASABKAlSBXZhbHVlEh0KCmZ1bGxfbWF0Y2'
    'gYAiABKAhSCWZ1bGxNYXRjaBp9CglUaW1lUmFuZ2USOQoKc3RhcnRfdGltZRgBIAEoCzIaLmdv'
    'b2dsZS5wcm90b2J1Zi5UaW1lc3RhbXBSCXN0YXJ0VGltZRI1CghlbmRfdGltZRgCIAEoCzIaLm'
    'dvb2dsZS5wcm90b2J1Zi5UaW1lc3RhbXBSB2VuZFRpbWU=');

@$core.Deprecated('Use ruleDescriptor instead')
const Rule$json = {
  '1': 'Rule',
  '2': [
    {'1': 'boost_action', '3': 2, '4': 1, '5': 11, '6': '.google.cloud.retail.v2alpha.Rule.BoostAction', '9': 0, '10': 'boostAction'},
    {'1': 'redirect_action', '3': 3, '4': 1, '5': 11, '6': '.google.cloud.retail.v2alpha.Rule.RedirectAction', '9': 0, '10': 'redirectAction'},
    {'1': 'oneway_synonyms_action', '3': 6, '4': 1, '5': 11, '6': '.google.cloud.retail.v2alpha.Rule.OnewaySynonymsAction', '9': 0, '10': 'onewaySynonymsAction'},
    {'1': 'do_not_associate_action', '3': 7, '4': 1, '5': 11, '6': '.google.cloud.retail.v2alpha.Rule.DoNotAssociateAction', '9': 0, '10': 'doNotAssociateAction'},
    {'1': 'replacement_action', '3': 8, '4': 1, '5': 11, '6': '.google.cloud.retail.v2alpha.Rule.ReplacementAction', '9': 0, '10': 'replacementAction'},
    {'1': 'ignore_action', '3': 9, '4': 1, '5': 11, '6': '.google.cloud.retail.v2alpha.Rule.IgnoreAction', '9': 0, '10': 'ignoreAction'},
    {'1': 'filter_action', '3': 10, '4': 1, '5': 11, '6': '.google.cloud.retail.v2alpha.Rule.FilterAction', '9': 0, '10': 'filterAction'},
    {'1': 'twoway_synonyms_action', '3': 11, '4': 1, '5': 11, '6': '.google.cloud.retail.v2alpha.Rule.TwowaySynonymsAction', '9': 0, '10': 'twowaySynonymsAction'},
    {'1': 'force_return_facet_action', '3': 12, '4': 1, '5': 11, '6': '.google.cloud.retail.v2alpha.Rule.ForceReturnFacetAction', '9': 0, '10': 'forceReturnFacetAction'},
    {'1': 'remove_facet_action', '3': 13, '4': 1, '5': 11, '6': '.google.cloud.retail.v2alpha.Rule.RemoveFacetAction', '9': 0, '10': 'removeFacetAction'},
    {'1': 'condition', '3': 1, '4': 1, '5': 11, '6': '.google.cloud.retail.v2alpha.Condition', '8': {}, '10': 'condition'},
  ],
...
const Rule_ForceReturnFacetAction$json = {
  ...
  '2': [
    {'1': 'facet_position_adjustments', '3': 1, '4': 3, '5': 11, '6': '.google.cloud.retail.v2alpha.Rule.ForceReturnFacetAction.FacetPositionAdjustment', '10': 'facetPositionAdjustments'},
  ],
...
final $typed_data.Uint8List ruleDescriptor = $convert.base64Decode(
    'CgRSdWxlElIKDGJvb3N0X2FjdGlvbhgCIAEoCzItLmdvb2dsZS5jbG91ZC5yZXRhaWwudjJhbH'
    'BoYS5SdWxlLkJvb3N0QWN0aW9uSABSC2Jvb3N0QWN0aW9uElsKD3JlZGlyZWN0X2FjdGlvbhgD'
    'IAEoCzIwLmdvb2dsZS5jbG91ZC5yZXRhaWwudjJhbHBoYS5SdWxlLlJlZGlyZWN0QWN0aW9uSA'
    'BSDnJlZGlyZWN0QWN0aW9uEm4KFm9uZXdheV9zeW5vbnltc19hY3Rpb24YBiABKAsyNi5nb29n'
    'bGUuY2xvdWQucmV0YWlsLnYyYWxwaGEuUnVsZS5PbmV3YXlTeW5vbnltc0FjdGlvbkgAUhRvbm'
    'V3YXlTeW5vbnltc0FjdGlvbhJvChdkb19ub3RfYXNzb2NpYXRlX2FjdGlvbhgHIAEoCzI2Lmdv'
    'b2dsZS5jbG91ZC5yZXRhaWwudjJhbHBoYS5SdWxlLkRvTm90QXNzb2NpYXRlQWN0aW9uSABSFG'
    'RvTm90QXNzb2NpYXRlQWN0aW9uEmQKEnJlcGxhY2VtZW50X2FjdGlvbhgIIAEoCzIzLmdvb2ds'
    'ZS5jbG91ZC5yZXRhaWwudjJhbHBoYS5SdWxlLlJlcGxhY2VtZW50QWN0aW9uSABSEXJlcGxhY2'
    'VtZW50QWN0aW9uElUKDWlnbm9yZV9hY3Rpb24YCSABKAsyLi5nb29nbGUuY2xvdWQucmV0YWls'
    'LnYyYWxwaGEuUnVsZS5JZ25vcmVBY3Rpb25IAFIMaWdub3JlQWN0aW9uElUKDWZpbHRlcl9hY3'
    'Rpb24YCiABKAsyLi5nb29nbGUuY2xvdWQucmV0YWlsLnYyYWxwaGEuUnVsZS5GaWx0ZXJBY3Rp'
    'b25IAFIMZmlsdGVyQWN0aW9uEm4KFnR3b3dheV9zeW5vbnltc19hY3Rpb24YCyABKAsyNi5nb2'
    '9nbGUuY2xvdWQucmV0YWlsLnYyYWxwaGEuUnVsZS5Ud293YXlTeW5vbnltc0FjdGlvbkgAUhR0'
    'd293YXlTeW5vbnltc0FjdGlvbhJ1Chlmb3JjZV9yZXR1cm5fZmFjZXRfYWN0aW9uGAwgASgLMj'
    'guZ29vZ2xlLmNsb3VkLnJldGFpbC52MmFscGhhLlJ1bGUuRm9yY2VSZXR1cm5GYWNldEFjdGlv'
    'bkgAUhZmb3JjZVJldHVybkZhY2V0QWN0aW9uEmUKE3JlbW92ZV9mYWNldF9hY3Rpb24YDSABKA'
    'syMy5nb29nbGUuY2xvdWQucmV0YWlsLnYyYWxwaGEuUnVsZS5SZW1vdmVGYWNldEFjdGlvbkgA'
    'UhFyZW1vdmVGYWNldEFjdGlvbhJJCgljb25kaXRpb24YASABKAsyJi5nb29nbGUuY2xvdWQucm'
    'V0YWlsLnYyYWxwaGEuQ29uZGl0aW9uQgPgQQJSCWNvbmRpdGlvbhpMCgtCb29zdEFjdGlvbhIU'
    'CgVib29zdBgBIAEoAlIFYm9vc3QSJwoPcHJvZHVjdHNfZmlsdGVyGAIgASgJUg5wcm9kdWN0c0'
    'ZpbHRlchomCgxGaWx0ZXJBY3Rpb24SFgoGZmlsdGVyGAEgASgJUgZmaWx0ZXIaMwoOUmVkaXJl'
    'Y3RBY3Rpb24SIQoMcmVkaXJlY3RfdXJpGAEgASgJUgtyZWRpcmVjdFVyaRoyChRUd293YXlTeW'
    '5vbnltc0FjdGlvbhIaCghzeW5vbnltcxgBIAMoCVIIc3lub255bXMadgoUT25ld2F5U3lub255'
    'bXNBY3Rpb24SHwoLcXVlcnlfdGVybXMYAyADKAlSCnF1ZXJ5VGVybXMSGgoIc3lub255bXMYBC'
    'ADKAlSCHN5bm9ueW1zEiEKDG9uZXdheV90ZXJtcxgCIAMoCVILb25ld2F5VGVybXMaggEKFERv'
    'Tm90QXNzb2NpYXRlQWN0aW9uEh8KC3F1ZXJ5X3Rlcm1zGAIgAygJUgpxdWVyeVRlcm1zEjMKFm'
    'RvX25vdF9hc3NvY2lhdGVfdGVybXMYAyADKAlSE2RvTm90QXNzb2NpYXRlVGVybXMSFAoFdGVy'
    'bXMYASADKAlSBXRlcm1zGnMKEVJlcGxhY2VtZW50QWN0aW9uEh8KC3F1ZXJ5X3Rlcm1zGAIgAy'
    'gJUgpxdWVyeVRlcm1zEikKEHJlcGxhY2VtZW50X3Rlcm0YAyABKAlSD3JlcGxhY2VtZW50VGVy'
    'bRISCgR0ZXJtGAEgASgJUgR0ZXJtGjEKDElnbm9yZUFjdGlvbhIhCgxpZ25vcmVfdGVybXMYAS'
    'ADKAlSC2lnbm9yZVRlcm1zGocCChZGb3JjZVJldHVybkZhY2V0QWN0aW9uEo4BChpmYWNldF9w'
    'b3NpdGlvbl9hZGp1c3RtZW50cxgBIAMoCzJQLmdvb2dsZS5jbG91ZC5yZXRhaWwudjJhbHBoYS'
    '5SdWxlLkZvcmNlUmV0dXJuRmFjZXRBY3Rpb24uRmFjZXRQb3NpdGlvbkFkanVzdG1lbnRSGGZh'
    'Y2V0UG9zaXRpb25BZGp1c3RtZW50cxpcChdGYWNldFBvc2l0aW9uQWRqdXN0bWVudBIlCg5hdH'
    'RyaWJ1dGVfbmFtZRgBIAEoCVINYXR0cmlidXRlTmFtZRIaCghwb3NpdGlvbhgCIAEoBVIIcG9z'
    'aXRpb24aPAoRUmVtb3ZlRmFjZXRBY3Rpb24SJwoPYXR0cmlidXRlX25hbWVzGAEgAygJUg5hdH'
    'RyaWJ1dGVOYW1lc0IICgZhY3Rpb24=');
...
const PriceInfo$json = {
  ...
  '2': [
    ...
    {'1': 'price_range', '3': 7, '4': 1, '5': 11, '6': '.google.cloud.retail.v2alpha.PriceInfo.PriceRange', '8': {}, '10': 'priceRange'},
  ],
...
const PriceInfo_PriceRange$json = {
  '1': 'PriceRange',
  '2': [
    {'1': 'price', '3': 1, '4': 1, '5': 11, '6': '.google.cloud.retail.v2alpha.Interval', '10': 'price'},
    {'1': 'original_price', '3': 2, '4': 1, '5': 11, '6': '.google.cloud.retail.v2alpha.Interval', '10': 'originalPrice'},
  ],
};
...
final $typed_data.Uint8List priceInfoDescriptor = $convert.base64Decode(
    ...
    '1lElcKC3ByaWNlX3JhbmdlGAcgASgLMjEuZ29vZ2xlLmNsb3VkLnJldGFpbC52MmFscGhhLlBy'
    'aWNlSW5mby5QcmljZVJhbmdlQgPgQQNSCnByaWNlUmFuZ2UalwEKClByaWNlUmFuZ2USOwoFcH'
    'JpY2UYASABKAsyJS5nb29nbGUuY2xvdWQucmV0YWlsLnYyYWxwaGEuSW50ZXJ2YWxSBXByaWNl'
    'EkwKDm9yaWdpbmFsX3ByaWNlGAIgASgLMiUuZ29vZ2xlLmNsb3VkLnJldGFpbC52MmFscGhhLk'
    'ludGVydmFsUg1vcmlnaW5hbFByaWNl');
...
const LocalInventory$json = {
  ...
  '2': [
    ...
    {'1': 'price_info', '3': 2, '4': 1, '5': 11, '6': '.google.cloud.retail.v2alpha.PriceInfo', '10': 'priceInfo'},
    {'1': 'attributes', '3': 3, '4': 3, '5': 11, '6': '.google.cloud.retail.v2alpha.LocalInventory.AttributesEntry', '10': 'attributes'},
...
final $typed_data.Uint8List localInventoryDescriptor = $convert.base64Decode(
    'Cg5Mb2NhbEludmVudG9yeRIZCghwbGFjZV9pZBgBIAEoCVIHcGxhY2VJZBJFCgpwcmljZV9pbm'
    'ZvGAIgASgLMiYuZ29vZ2xlLmNsb3VkLnJldGFpbC52MmFscGhhLlByaWNlSW5mb1IJcHJpY2VJ'
    'bmZvElsKCmF0dHJpYnV0ZXMYAyADKAsyOy5nb29nbGUuY2xvdWQucmV0YWlsLnYyYWxwaGEuTG'
    '9jYWxJbnZlbnRvcnkuQXR0cmlidXRlc0VudHJ5UgphdHRyaWJ1dGVzEjAKEWZ1bGZpbGxtZW50'
    'X3R5cGVzGAQgAygJQgPgQQRSEGZ1bGZpbGxtZW50VHlwZXMaawoPQXR0cmlidXRlc0VudHJ5Eh'
    'AKA2tleRgBIAEoCVIDa2V5EkIKBXZhbHVlGAIgASgLMiwuZ29vZ2xlLmNsb3VkLnJldGFpbC52'
    'MmFscGhhLkN1c3RvbUF0dHJpYnV0ZVIFdmFsdWU6AjgB');
