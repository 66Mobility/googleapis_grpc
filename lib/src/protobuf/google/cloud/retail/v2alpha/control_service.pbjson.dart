...
const CreateControlRequest$json = {
  ...
  '2': [
    ...
    {'1': 'control', '3': 2, '4': 1, '5': 11, '6': '.google.cloud.retail.v2alpha.Control', '8': {}, '10': 'control'},
...
final $typed_data.Uint8List createControlRequestDescriptor = $convert.base64Decode(
    ...
    'dvb2dsZWFwaXMuY29tL0NhdGFsb2dSBnBhcmVudBJDCgdjb250cm9sGAIgASgLMiQuZ29vZ2xl'
    'LmNsb3VkLnJldGFpbC52MmFscGhhLkNvbnRyb2xCA+BBAlIHY29udHJvbBIiCgpjb250cm9sX2'
    'lkGAMgASgJQgPgQQJSCWNvbnRyb2xJZA==');

@$core.Deprecated('Use updateControlRequestDescriptor instead')
const UpdateControlRequest$json = {
  '1': 'UpdateControlRequest',
  '2': [
    {'1': 'control', '3': 1, '4': 1, '5': 11, '6': '.google.cloud.retail.v2alpha.Control', '8': {}, '10': 'control'},
...
final $typed_data.Uint8List updateControlRequestDescriptor = $convert.base64Decode(
    'ChRVcGRhdGVDb250cm9sUmVxdWVzdBJDCgdjb250cm9sGAEgASgLMiQuZ29vZ2xlLmNsb3VkLn'
    'JldGFpbC52MmFscGhhLkNvbnRyb2xCA+BBAlIHY29udHJvbBI7Cgt1cGRhdGVfbWFzaxgCIAEo'
...
const ListControlsResponse$json = {
  ...
  '2': [
    {'1': 'controls', '3': 1, '4': 3, '5': 11, '6': '.google.cloud.retail.v2alpha.Control', '10': 'controls'},
...
final $typed_data.Uint8List listControlsResponseDescriptor = $convert.base64Decode(
    'ChRMaXN0Q29udHJvbHNSZXNwb25zZRJACghjb250cm9scxgBIAMoCzIkLmdvb2dsZS5jbG91ZC'
    '5yZXRhaWwudjJhbHBoYS5Db250cm9sUghjb250cm9scxImCg9uZXh0X3BhZ2VfdG9rZW4YAiAB'
