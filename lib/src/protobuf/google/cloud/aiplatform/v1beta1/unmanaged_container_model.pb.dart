...
class UnmanagedContainerModel extends $pb.GeneratedMessage {
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(_omitMessageNames ? '' : 'UnmanagedContainerModel', package: const $pb.PackageName(_omitMessageNames ? '' : 'google.cloud.aiplatform.v1beta1'), createEmptyInstance: create)
    ..aOS(1, _omitFieldNames ? '' : 'artifactUri')
    ..aOM<$609.PredictSchemata>(2, _omitFieldNames ? '' : 'predictSchemata', subBuilder: $609.PredictSchemata.create)
  ...
  @$pb.TagNumber(2)
  $609.PredictSchemata get predictSchemata => $_getN(1);
  @$pb.TagNumber(2)
  set predictSchemata($609.PredictSchemata v) { setField(2, v); }
  @$pb.TagNumber(2)
  $core.bool hasPredictSchemata() => $_has(1);
  @$pb.TagNumber(2)
  void clearPredictSchemata() => clearField(2);
  @$pb.TagNumber(2)
  $609.PredictSchemata ensurePredictSchemata() => $_ensure(1);
