...
class CreateDeploymentResourcePoolRequest extends $pb.GeneratedMessage {
  factory CreateDeploymentResourcePoolRequest({
    $core.String? parent,
    $559.DeploymentResourcePool? deploymentResourcePool,
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(_omitMessageNames ? '' : 'CreateDeploymentResourcePoolRequest', package: const $pb.PackageName(_omitMessageNames ? '' : 'google.cloud.aiplatform.v1beta1'), createEmptyInstance: create)
    ..aOS(1, _omitFieldNames ? '' : 'parent')
    ..aOM<$559.DeploymentResourcePool>(2, _omitFieldNames ? '' : 'deploymentResourcePool', subBuilder: $559.DeploymentResourcePool.create)
  ...
  @$pb.TagNumber(2)
  $559.DeploymentResourcePool get deploymentResourcePool => $_getN(1);
  @$pb.TagNumber(2)
  set deploymentResourcePool($559.DeploymentResourcePool v) { setField(2, v); }
  @$pb.TagNumber(2)
  $core.bool hasDeploymentResourcePool() => $_has(1);
  @$pb.TagNumber(2)
  void clearDeploymentResourcePool() => clearField(2);
  @$pb.TagNumber(2)
  $559.DeploymentResourcePool ensureDeploymentResourcePool() => $_ensure(1);
...
class CreateDeploymentResourcePoolOperationMetadata extends $pb.GeneratedMessage {
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(_omitMessageNames ? '' : 'CreateDeploymentResourcePoolOperationMetadata', package: const $pb.PackageName(_omitMessageNames ? '' : 'google.cloud.aiplatform.v1beta1'), createEmptyInstance: create)
...
class GetDeploymentResourcePoolRequest extends $pb.GeneratedMessage {
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(_omitMessageNames ? '' : 'GetDeploymentResourcePoolRequest', package: const $pb.PackageName(_omitMessageNames ? '' : 'google.cloud.aiplatform.v1beta1'), createEmptyInstance: create)
...
class ListDeploymentResourcePoolsRequest extends $pb.GeneratedMessage {
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(_omitMessageNames ? '' : 'ListDeploymentResourcePoolsRequest', package: const $pb.PackageName(_omitMessageNames ? '' : 'google.cloud.aiplatform.v1beta1'), createEmptyInstance: create)
    ..aOS(1, _omitFieldNames ? '' : 'parent')
...
class ListDeploymentResourcePoolsResponse extends $pb.GeneratedMessage {
  factory ListDeploymentResourcePoolsResponse({
    $core.Iterable<$559.DeploymentResourcePool>? deploymentResourcePools,
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(_omitMessageNames ? '' : 'ListDeploymentResourcePoolsResponse', package: const $pb.PackageName(_omitMessageNames ? '' : 'google.cloud.aiplatform.v1beta1'), createEmptyInstance: create)
    ..pc<$559.DeploymentResourcePool>(1, _omitFieldNames ? '' : 'deploymentResourcePools', $pb.PbFieldType.PM, subBuilder: $559.DeploymentResourcePool.create)
  ...
  @$pb.TagNumber(1)
  $core.List<$559.DeploymentResourcePool> get deploymentResourcePools => $_getList(0);
...
class UpdateDeploymentResourcePoolRequest extends $pb.GeneratedMessage {
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(_omitMessageNames ? '' : 'UpdateDeploymentResourcePoolRequest', package: const $pb.PackageName(_omitMessageNames ? '' : 'google.cloud.aiplatform.v1beta1'), createEmptyInstance: create)
    ..aOM<$559.DeploymentResourcePool>(1, _omitFieldNames ? '' : 'deploymentResourcePool', subBuilder: $559.DeploymentResourcePool.create)
  ...
  ///  `projects/{project}/locations/{location}/deploymentResourcePools/{deployment_resource_pool}`
  @$pb.TagNumber(1)
  $559.DeploymentResourcePool get deploymentResourcePool => $_getN(0);
  @$pb.TagNumber(1)
  set deploymentResourcePool($559.DeploymentResourcePool v) { setField(1, v); }
  @$pb.TagNumber(1)
  $core.bool hasDeploymentResourcePool() => $_has(0);
  @$pb.TagNumber(1)
  void clearDeploymentResourcePool() => clearField(1);
  @$pb.TagNumber(1)
  $559.DeploymentResourcePool ensureDeploymentResourcePool() => $_ensure(0);
...
class UpdateDeploymentResourcePoolOperationMetadata extends $pb.GeneratedMessage {
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(_omitMessageNames ? '' : 'UpdateDeploymentResourcePoolOperationMetadata', package: const $pb.PackageName(_omitMessageNames ? '' : 'google.cloud.aiplatform.v1beta1'), createEmptyInstance: create)
    ..aOM<$4296.GenericOperationMetadata>(1, _omitFieldNames ? '' : 'genericMetadata', subBuilder: $4296.GenericOperationMetadata.create)
    ..hasRequiredFields = false
  ;
...
class DeleteDeploymentResourcePoolRequest extends $pb.GeneratedMessage {
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(_omitMessageNames ? '' : 'DeleteDeploymentResourcePoolRequest', package: const $pb.PackageName(_omitMessageNames ? '' : 'google.cloud.aiplatform.v1beta1'), createEmptyInstance: create)
    ..aOS(1, _omitFieldNames ? '' : 'name')
    ..hasRequiredFields = false
  ;
...
class QueryDeployedModelsRequest extends $pb.GeneratedMessage {
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(_omitMessageNames ? '' : 'QueryDeployedModelsRequest', package: const $pb.PackageName(_omitMessageNames ? '' : 'google.cloud.aiplatform.v1beta1'), createEmptyInstance: create)
...
class QueryDeployedModelsResponse extends $pb.GeneratedMessage {
  ...
  @$core.Deprecated('This field is deprecated.')
    $core.Iterable<$561.DeployedModel>? deployedModels,
    $core.String? nextPageToken,
    $core.Iterable<$4285.DeployedModelRef>? deployedModelRefs,
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(_omitMessageNames ? '' : 'QueryDeployedModelsResponse', package: const $pb.PackageName(_omitMessageNames ? '' : 'google.cloud.aiplatform.v1beta1'), createEmptyInstance: create)
    ..pc<$561.DeployedModel>(1, _omitFieldNames ? '' : 'deployedModels', $pb.PbFieldType.PM, subBuilder: $561.DeployedModel.create)
    ..aOS(2, _omitFieldNames ? '' : 'nextPageToken')
    ..pc<$4285.DeployedModelRef>(3, _omitFieldNames ? '' : 'deployedModelRefs', $pb.PbFieldType.PM, subBuilder: $4285.DeployedModelRef.create)
  ...
  @$core.Deprecated('This field is deprecated.')
  @$pb.TagNumber(1)
  $core.List<$561.DeployedModel> get deployedModels => $_getList(0);
  ...
  @$pb.TagNumber(3)
  $core.List<$4285.DeployedModelRef> get deployedModelRefs => $_getList(2);
