...
class TimeSeriesData extends $pb.GeneratedMessage {
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(_omitMessageNames ? '' : 'TimeSeriesData', package: const $pb.PackageName(_omitMessageNames ? '' : 'google.cloud.aiplatform.v1beta1'), createEmptyInstance: create)
    ..aOS(1, _omitFieldNames ? '' : 'tensorboardTimeSeriesId')
    ..e<$632.TensorboardTimeSeries_ValueType>(2, _omitFieldNames ? '' : 'valueType', $pb.PbFieldType.OE, defaultOrMaker: $632.TensorboardTimeSeries_ValueType.VALUE_TYPE_UNSPECIFIED, valueOf: $632.TensorboardTimeSeries_ValueType.valueOf, enumValues: $632.TensorboardTimeSeries_ValueType.values)
  ...
  @$pb.TagNumber(2)
  $632.TensorboardTimeSeries_ValueType get valueType => $_getN(1);
  @$pb.TagNumber(2)
  set valueType($632.TensorboardTimeSeries_ValueType v) { setField(2, v); }
  @$pb.TagNumber(2)
...
class TimeSeriesDataPoint extends $pb.GeneratedMessage {
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(_omitMessageNames ? '' : 'TimeSeriesDataPoint', package: const $pb.PackageName(_omitMessageNames ? '' : 'google.cloud.aiplatform.v1beta1'), createEmptyInstance: create)
    ..oo(0, [3, 4, 5])
    ..aOM<$1776.Timestamp>(1, _omitFieldNames ? '' : 'wallTime', subBuilder: $1776.Timestamp.create)
  ...
  @$pb.TagNumber(1)
  $1776.Timestamp get wallTime => $_getN(0);
  @$pb.TagNumber(1)
  set wallTime($1776.Timestamp v) { setField(1, v); }
  @$pb.TagNumber(1)
  $core.bool hasWallTime() => $_has(0);
  @$pb.TagNumber(1)
  void clearWallTime() => clearField(1);
  @$pb.TagNumber(1)
  $1776.Timestamp ensureWallTime() => $_ensure(0);
...
class Scalar extends $pb.GeneratedMessage {
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(_omitMessageNames ? '' : 'Scalar', package: const $pb.PackageName(_omitMessageNames ? '' : 'google.cloud.aiplatform.v1beta1'), createEmptyInstance: create)
...
class TensorboardTensor extends $pb.GeneratedMessage {
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(_omitMessageNames ? '' : 'TensorboardTensor', package: const $pb.PackageName(_omitMessageNames ? '' : 'google.cloud.aiplatform.v1beta1'), createEmptyInstance: create)
...
class TensorboardBlobSequence extends $pb.GeneratedMessage {
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(_omitMessageNames ? '' : 'TensorboardBlobSequence', package: const $pb.PackageName(_omitMessageNames ? '' : 'google.cloud.aiplatform.v1beta1'), createEmptyInstance: create)
...
class TensorboardBlob extends $pb.GeneratedMessage {
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(_omitMessageNames ? '' : 'TensorboardBlob', package: const $pb.PackageName(_omitMessageNames ? '' : 'google.cloud.aiplatform.v1beta1'), createEmptyInstance: create)
