...
class VideoClassificationPredictionInstance extends $pb.GeneratedMessage {
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(_omitMessageNames ? '' : 'VideoClassificationPredictionInstance', package: const $pb.PackageName(_omitMessageNames ? '' : 'google.cloud.aiplatform.v1beta1.schema.predict.instance'), createEmptyInstance: create)
  ...
  'Will be removed in next major version')
  VideoClassificationPredictionInstance copyWith(void Function(VideoClassificationPredictionInstance) updates) => super.copyWith((message) => updates(message as VideoClassificationPredictionInstance)) as VideoClassificationPredictionInstance;
