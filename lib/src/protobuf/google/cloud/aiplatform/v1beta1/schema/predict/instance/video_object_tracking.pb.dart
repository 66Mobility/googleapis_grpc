...
class VideoObjectTrackingPredictionInstance extends $pb.GeneratedMessage {
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(_omitMessageNames ? '' : 'VideoObjectTrackingPredictionInstance', package: const $pb.PackageName(_omitMessageNames ? '' : 'google.cloud.aiplatform.v1beta1.schema.predict.instance'), createEmptyInstance: create)
  ...
  'Will be removed in next major version')
  VideoObjectTrackingPredictionInstance copyWith(void Function(VideoObjectTrackingPredictionInstance) updates) => super.copyWith((message) => updates(message as VideoObjectTrackingPredictionInstance)) as VideoObjectTrackingPredictionInstance;
