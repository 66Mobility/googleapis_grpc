...
class NotebookExecutionJob extends $pb.GeneratedMessage {
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(_omitMessageNames ? '' : 'NotebookExecutionJob', package: const $pb.PackageName(_omitMessageNames ? '' : 'google.cloud.aiplatform.v1beta1'), createEmptyInstance: create)
    ...
    ..e<$4284.JobState>(10, _omitFieldNames ? '' : 'jobState', $pb.PbFieldType.OE, defaultOrMaker: $4284.JobState.JOB_STATE_UNSPECIFIED, valueOf: $4284.JobState.valueOf, enumValues: $4284.JobState.values)
    ...
    ..aOM<$4282.EncryptionSpec>(22, _omitFieldNames ? '' : 'encryptionSpec', subBuilder: $4282.EncryptionSpec.create)
    ..hasRequiredFields = false
  ;
  ...
  @$pb.TagNumber(10)
  $4284.JobState get jobState => $_getN(8);
  @$pb.TagNumber(10)
  set jobState($4284.JobState v) { setField(10, v); }
  @$pb.TagNumber(10)
  ...
  @$pb.TagNumber(22)
  $4282.EncryptionSpec get encryptionSpec => $_getN(16);
  @$pb.TagNumber(22)
  set encryptionSpec($4282.EncryptionSpec v) { setField(22, v); }
  @$pb.TagNumber(22)
  $core.bool hasEncryptionSpec() => $_has(16);
  @$pb.TagNumber(22)
  void clearEncryptionSpec() => clearField(22);
  @$pb.TagNumber(22)
  $4282.EncryptionSpec ensureEncryptionSpec() => $_ensure(16);
}
