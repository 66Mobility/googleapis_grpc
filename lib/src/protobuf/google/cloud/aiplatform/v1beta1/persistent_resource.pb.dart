...
class PersistentResource extends $pb.GeneratedMessage {
  factory PersistentResource({
    ...
    $4298.PscInterfaceConfig? pscInterfaceConfig,
  }) {
    final $result = create();
    if (name != null) {
      $result.name = name;
    ...
    if (pscInterfaceConfig != null) {
      $result.pscInterfaceConfig = pscInterfaceConfig;
    }
    return $result;
  }
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(_omitMessageNames ? '' : 'PersistentResource', package: const $pb.PackageName(_omitMessageNames ? '' : 'google.cloud.aiplatform.v1beta1'), createEmptyInstance: create)
    ...
    ..m<$core.String, $core.String>(10, _omitFieldNames ? '' : 'labels', entryClassName: 'PersistentResource.LabelsEntry', keyFieldType: $pb.PbFieldType.OS, valueFieldType: $pb.PbFieldType.OS, packageName: const $pb.PackageName('google.cloud.aiplatform.v1beta1'))
    ..aOS(11, _omitFieldNames ? '' : 'network')
    ..aOM<$4281.EncryptionSpec>(12, _omitFieldNames ? '' : 'encryptionSpec', subBuilder: $4281.EncryptionSpec.create)
    ...
    ..aOM<$4298.PscInterfaceConfig>(17, _omitFieldNames ? '' : 'pscInterfaceConfig', subBuilder: $4298.PscInterfaceConfig.create)
  ...
  @$pb.TagNumber(12)
  set encryptionSpec($4281.EncryptionSpec v) { setField(12, v); }
  @$pb.TagNumber(12)
  ...
  @$pb.TagNumber(17)
  $4298.PscInterfaceConfig get pscInterfaceConfig => $_getN(14);
  @$pb.TagNumber(17)
  set pscInterfaceConfig($4298.PscInterfaceConfig v) { setField(17, v); }
  @$pb.TagNumber(17)
  $core.bool hasPscInterfaceConfig() => $_has(14);
  @$pb.TagNumber(17)
  void clearPscInterfaceConfig() => clearField(17);
  @$pb.TagNumber(17)
  $4298.PscInterfaceConfig ensurePscInterfaceConfig() => $_ensure(14);
}
...
class ResourcePool_AutoscalingSpec extends $pb.GeneratedMessage {
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(_omitMessageNames ? '' : 'ResourcePool.AutoscalingSpec', package: const $pb.PackageName(_omitMessageNames ? '' : 'google.cloud.aiplatform.v1beta1'), createEmptyInstance: create)
...
class ResourcePool extends $pb.GeneratedMessage {
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(_omitMessageNames ? '' : 'ResourcePool', package: const $pb.PackageName(_omitMessageNames ? '' : 'google.cloud.aiplatform.v1beta1'), createEmptyInstance: create)
    ..aOS(1, _omitFieldNames ? '' : 'id')
    ..aOM<$4287.MachineSpec>(2, _omitFieldNames ? '' : 'machineSpec', subBuilder: $4287.MachineSpec.create)
    ..aInt64(3, _omitFieldNames ? '' : 'replicaCount')
    ..aOM<$4287.DiskSpec>(4, _omitFieldNames ? '' : 'diskSpec', subBuilder: $4287.DiskSpec.create)
  ...
  @$pb.TagNumber(2)
  $4287.MachineSpec get machineSpec => $_getN(1);
  @$pb.TagNumber(2)
  set machineSpec($4287.MachineSpec v) { setField(2, v); }
  @$pb.TagNumber(2)
  $core.bool hasMachineSpec() => $_has(1);
  @$pb.TagNumber(2)
  void clearMachineSpec() => clearField(2);
  @$pb.TagNumber(2)
  $4287.MachineSpec ensureMachineSpec() => $_ensure(1);
  ...
  @$pb.TagNumber(4)
  $4287.DiskSpec get diskSpec => $_getN(3);
  @$pb.TagNumber(4)
  set diskSpec($4287.DiskSpec v) { setField(4, v); }
  @$pb.TagNumber(4)
  $core.bool hasDiskSpec() => $_has(3);
  @$pb.TagNumber(4)
  void clearDiskSpec() => clearField(4);
  @$pb.TagNumber(4)
  $4287.DiskSpec ensureDiskSpec() => $_ensure(3);
...
class ResourceRuntimeSpec extends $pb.GeneratedMessage {
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(_omitMessageNames ? '' : 'ResourceRuntimeSpec', package: const $pb.PackageName(_omitMessageNames ? '' : 'google.cloud.aiplatform.v1beta1'), createEmptyInstance: create)
...
class RaySpec extends $pb.GeneratedMessage {
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(_omitMessageNames ? '' : 'RaySpec', package: const $pb.PackageName(_omitMessageNames ? '' : 'google.cloud.aiplatform.v1beta1'), createEmptyInstance: create)
    ..aOS(1, _omitFieldNames ? '' : 'imageUri')
    ..m<$core.String, $core.String>(6, _omitFieldNames ? '' : 'resourcePoolImages', entryClassName: 'RaySpec.ResourcePoolImagesEntry', keyFieldType: $pb.PbFieldType.OS, valueFieldType: $pb.PbFieldType.OS, packageName: const $pb.PackageName('google.cloud.aiplatform.v1beta1'))
...
class ResourceRuntime extends $pb.GeneratedMessage {
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(_omitMessageNames ? '' : 'ResourceRuntime', package: const $pb.PackageName(_omitMessageNames ? '' : 'google.cloud.aiplatform.v1beta1'), createEmptyInstance: create)
    ..m<$core.String, $core.String>(1, _omitFieldNames ? '' : 'accessUris', entryClassName: 'ResourceRuntime.AccessUrisEntry', keyFieldType: $pb.PbFieldType.OS, valueFieldType: $pb.PbFieldType.OS, packageName: const $pb.PackageName('google.cloud.aiplatform.v1beta1'))
...
class ServiceAccountSpec extends $pb.GeneratedMessage {
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(_omitMessageNames ? '' : 'ServiceAccountSpec', package: const $pb.PackageName(_omitMessageNames ? '' : 'google.cloud.aiplatform.v1beta1'), createEmptyInstance: create)
...
class RayMetricSpec extends $pb.GeneratedMessage {
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(_omitMessageNames ? '' : 'RayMetricSpec', package: const $pb.PackageName(_omitMessageNames ? '' : 'google.cloud.aiplatform.v1beta1'), createEmptyInstance: create)
...
class RayLogsSpec extends $pb.GeneratedMessage {
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(_omitMessageNames ? '' : 'RayLogsSpec', package: const $pb.PackageName(_omitMessageNames ? '' : 'google.cloud.aiplatform.v1beta1'), createEmptyInstance: create)
    ..aOB(1, _omitFieldNames ? '' : 'disabled')
    ..hasRequiredFields = false
  ;
