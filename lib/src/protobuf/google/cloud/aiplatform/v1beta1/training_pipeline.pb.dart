...
class TrainingPipeline extends $pb.GeneratedMessage {
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(_omitMessageNames ? '' : 'TrainingPipeline', package: const $pb.PackageName(_omitMessageNames ? '' : 'google.cloud.aiplatform.v1beta1'), createEmptyInstance: create)
  ...
  /// is.
  @$pb.TagNumber(7)
  $609.Model get modelToUpload => $_getN(6);
  @$pb.TagNumber(7)
  set modelToUpload($609.Model v) { setField(7, v); }
  @$pb.TagNumber(7)
  $core.bool hasModelToUpload() => $_has(6);
  @$pb.TagNumber(7)
  void clearModelToUpload() => clearField(7);
  @$pb.TagNumber(7)
  $609.Model ensureModelToUpload() => $_ensure(6);
...
class InputDataConfig extends $pb.GeneratedMessage {
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(_omitMessageNames ? '' : 'InputDataConfig', package: const $pb.PackageName(_omitMessageNames ? '' : 'google.cloud.aiplatform.v1beta1'), createEmptyInstance: create)
    ..oo(0, [2, 3, 4, 5, 12])
    ..oo(1, [8, 10])
...
class FractionSplit extends $pb.GeneratedMessage {
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(_omitMessageNames ? '' : 'FractionSplit', package: const $pb.PackageName(_omitMessageNames ? '' : 'google.cloud.aiplatform.v1beta1'), createEmptyInstance: create)
...
class FilterSplit extends $pb.GeneratedMessage {
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(_omitMessageNames ? '' : 'FilterSplit', package: const $pb.PackageName(_omitMessageNames ? '' : 'google.cloud.aiplatform.v1beta1'), createEmptyInstance: create)
...
class PredefinedSplit extends $pb.GeneratedMessage {
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(_omitMessageNames ? '' : 'PredefinedSplit', package: const $pb.PackageName(_omitMessageNames ? '' : 'google.cloud.aiplatform.v1beta1'), createEmptyInstance: create)
...
class TimestampSplit extends $pb.GeneratedMessage {
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(_omitMessageNames ? '' : 'TimestampSplit', package: const $pb.PackageName(_omitMessageNames ? '' : 'google.cloud.aiplatform.v1beta1'), createEmptyInstance: create)
    ..a<$core.double>(1, _omitFieldNames ? '' : 'trainingFraction', $pb.PbFieldType.OD)
    ..a<$core.double>(2, _omitFieldNames ? '' : 'validationFraction', $pb.PbFieldType.OD)
    ..a<$core.double>(3, _omitFieldNames ? '' : 'testFraction', $pb.PbFieldType.OD)
...
class StratifiedSplit extends $pb.GeneratedMessage {
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(_omitMessageNames ? '' : 'StratifiedSplit', package: const $pb.PackageName(_omitMessageNames ? '' : 'google.cloud.aiplatform.v1beta1'), createEmptyInstance: create)
    ..a<$core.double>(1, _omitFieldNames ? '' : 'trainingFraction', $pb.PbFieldType.OD)
    ..a<$core.double>(2, _omitFieldNames ? '' : 'validationFraction', $pb.PbFieldType.OD)
    ..a<$core.double>(3, _omitFieldNames ? '' : 'testFraction', $pb.PbFieldType.OD)
    ..aOS(4, _omitFieldNames ? '' : 'key')
