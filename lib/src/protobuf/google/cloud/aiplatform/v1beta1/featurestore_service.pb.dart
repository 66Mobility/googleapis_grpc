...
class ImportFeatureValuesRequest extends $pb.GeneratedMessage {
  factory ImportFeatureValuesRequest({
    ...
    $4277.AvroSource? avroSource,
    $4277.BigQuerySource? bigquerySource,
    $4277.CsvSource? csvSource,
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(_omitMessageNames ? '' : 'ImportFeatureValuesRequest', package: const $pb.PackageName(_omitMessageNames ? '' : 'google.cloud.aiplatform.v1beta1'), createEmptyInstance: create)
    ...
    ..aOM<$4277.AvroSource>(2, _omitFieldNames ? '' : 'avroSource', subBuilder: $4277.AvroSource.create)
    ..aOM<$4277.BigQuerySource>(3, _omitFieldNames ? '' : 'bigquerySource', subBuilder: $4277.BigQuerySource.create)
    ..aOM<$4277.CsvSource>(4, _omitFieldNames ? '' : 'csvSource', subBuilder: $4277.CsvSource.create)
  ...
  @$pb.TagNumber(2)
  $4277.AvroSource get avroSource => $_getN(1);
  @$pb.TagNumber(2)
  set avroSource($4277.AvroSource v) { setField(2, v); }
  @$pb.TagNumber(2)
  $core.bool hasAvroSource() => $_has(1);
  @$pb.TagNumber(2)
  void clearAvroSource() => clearField(2);
  @$pb.TagNumber(2)
  $4277.AvroSource ensureAvroSource() => $_ensure(1);
  ...
  @$pb.TagNumber(4)
  $4277.CsvSource get csvSource => $_getN(3);
  @$pb.TagNumber(4)
  set csvSource($4277.CsvSource v) { setField(4, v); }
  @$pb.TagNumber(4)
  $core.bool hasCsvSource() => $_has(3);
  @$pb.TagNumber(4)
  void clearCsvSource() => clearField(4);
  @$pb.TagNumber(4)
  $4277.CsvSource ensureCsvSource() => $_ensure(3);
...
class BatchReadFeatureValuesRequest_EntityTypeSpec extends $pb.GeneratedMessage {
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(_omitMessageNames ? '' : 'BatchReadFeatureValuesRequest.EntityTypeSpec', package: const $pb.PackageName(_omitMessageNames ? '' : 'google.cloud.aiplatform.v1beta1'), createEmptyInstance: create)
    ...
    ..aOM<$4300.FeatureSelector>(2, _omitFieldNames ? '' : 'featureSelector', subBuilder: $4300.FeatureSelector.create)
  ...
  /// EntityType.
  @$pb.TagNumber(2)
  $4300.FeatureSelector get featureSelector => $_getN(1);
  @$pb.TagNumber(2)
  set featureSelector($4300.FeatureSelector v) { setField(2, v); }
  @$pb.TagNumber(2)
  $core.bool hasFeatureSelector() => $_has(1);
  @$pb.TagNumber(2)
  void clearFeatureSelector() => clearField(2);
  @$pb.TagNumber(2)
  $4300.FeatureSelector ensureFeatureSelector() => $_ensure(1);
...
class BatchReadFeatureValuesRequest extends $pb.GeneratedMessage {
  factory BatchReadFeatureValuesRequest({
    ...
    $4277.CsvSource? csvReadInstances,
    FeatureValueDestination? destination,
    $4277.BigQuerySource? bigqueryReadInstances,
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(_omitMessageNames ? '' : 'BatchReadFeatureValuesRequest', package: const $pb.PackageName(_omitMessageNames ? '' : 'google.cloud.aiplatform.v1beta1'), createEmptyInstance: create)
    ...
    ..aOM<$4277.CsvSource>(3, _omitFieldNames ? '' : 'csvReadInstances', subBuilder: $4277.CsvSource.create)
    ..aOM<FeatureValueDestination>(4, _omitFieldNames ? '' : 'destination', subBuilder: FeatureValueDestination.create)
    ..aOM<$4277.BigQuerySource>(5, _omitFieldNames ? '' : 'bigqueryReadInstances', subBuilder: $4277.BigQuerySource.create)
  ...
  @$pb.TagNumber(3)
  $4277.CsvSource get csvReadInstances => $_getN(1);
  @$pb.TagNumber(3)
  set csvReadInstances($4277.CsvSource v) { setField(3, v); }
  @$pb.TagNumber(3)
  $core.bool hasCsvReadInstances() => $_has(1);
  @$pb.TagNumber(3)
  void clearCsvReadInstances() => clearField(3);
  @$pb.TagNumber(3)
  $4277.CsvSource ensureCsvReadInstances() => $_ensure(1);
  ...
  @$pb.TagNumber(5)
  $4277.BigQuerySource get bigqueryReadInstances => $_getN(3);
  @$pb.TagNumber(5)
  set bigqueryReadInstances($4277.BigQuerySource v) { setField(5, v); }
  @$pb.TagNumber(5)
  $core.bool hasBigqueryReadInstances() => $_has(3);
  @$pb.TagNumber(5)
  void clearBigqueryReadInstances() => clearField(5);
  @$pb.TagNumber(5)
  $4277.BigQuerySource ensureBigqueryReadInstances() => $_ensure(3);
...
class ExportFeatureValuesRequest extends $pb.GeneratedMessage {
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(_omitMessageNames ? '' : 'ExportFeatureValuesRequest', package: const $pb.PackageName(_omitMessageNames ? '' : 'google.cloud.aiplatform.v1beta1'), createEmptyInstance: create)
    ...
    ..aOM<FeatureValueDestination>(4, _omitFieldNames ? '' : 'destination', subBuilder: FeatureValueDestination.create)
    ..aOM<$4300.FeatureSelector>(5, _omitFieldNames ? '' : 'featureSelector', subBuilder: $4300.FeatureSelector.create)
  ...
  @$pb.TagNumber(5)
  $4300.FeatureSelector get featureSelector => $_getN(3);
  @$pb.TagNumber(5)
  set featureSelector($4300.FeatureSelector v) { setField(5, v); }
  @$pb.TagNumber(5)
  $core.bool hasFeatureSelector() => $_has(3);
  @$pb.TagNumber(5)
  void clearFeatureSelector() => clearField(5);
  @$pb.TagNumber(5)
  $4300.FeatureSelector ensureFeatureSelector() => $_ensure(3);
...
class FeatureValueDestination extends $pb.GeneratedMessage {
  factory FeatureValueDestination({
    ...
    $4277.TFRecordDestination? tfrecordDestination,
    $4277.CsvDestination? csvDestination,
  }) {
    final $result = create();
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(_omitMessageNames ? '' : 'FeatureValueDestination', package: const $pb.PackageName(_omitMessageNames ? '' : 'google.cloud.aiplatform.v1beta1'), createEmptyInstance: create)
    ..oo(0, [1, 2, 3])
    ..aOM<$4277.BigQueryDestination>(1, _omitFieldNames ? '' : 'bigqueryDestination', subBuilder: $4277.BigQueryDestination.create)
    ..aOM<$4277.TFRecordDestination>(2, _omitFieldNames ? '' : 'tfrecordDestination', subBuilder: $4277.TFRecordDestination.create)
    ..aOM<$4277.CsvDestination>(3, _omitFieldNames ? '' : 'csvDestination', subBuilder: $4277.CsvDestination.create)
    ..hasRequiredFields = false
  ;
  ...
  @$pb.TagNumber(1)
  $4277.BigQueryDestination get bigqueryDestination => $_getN(0);
  @$pb.TagNumber(1)
  set bigqueryDestination($4277.BigQueryDestination v) { setField(1, v); }
  @$pb.TagNumber(1)
  $core.bool hasBigqueryDestination() => $_has(0);
  @$pb.TagNumber(1)
  void clearBigqueryDestination() => clearField(1);
  @$pb.TagNumber(1)
  $4277.BigQueryDestination ensureBigqueryDestination() => $_ensure(0);
  ...
  @$pb.TagNumber(2)
  $4277.TFRecordDestination get tfrecordDestination => $_getN(1);
  @$pb.TagNumber(2)
  set tfrecordDestination($4277.TFRecordDestination v) { setField(2, v); }
  @$pb.TagNumber(2)
  $core.bool hasTfrecordDestination() => $_has(1);
  @$pb.TagNumber(2)
  void clearTfrecordDestination() => clearField(2);
  @$pb.TagNumber(2)
  $4277.TFRecordDestination ensureTfrecordDestination() => $_ensure(1);

  /// Output in CSV format. Array Feature value types are not allowed in CSV
  /// format.
  @$pb.TagNumber(3)
  $4277.CsvDestination get csvDestination => $_getN(2);
  @$pb.TagNumber(3)
  set csvDestination($4277.CsvDestination v) { setField(3, v); }
  @$pb.TagNumber(3)
  $core.bool hasCsvDestination() => $_has(2);
  @$pb.TagNumber(3)
  void clearCsvDestination() => clearField(3);
  @$pb.TagNumber(3)
  $4277.CsvDestination ensureCsvDestination() => $_ensure(2);
}
...
class EntityIdSelector extends $pb.GeneratedMessage {
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(_omitMessageNames ? '' : 'EntityIdSelector', package: const $pb.PackageName(_omitMessageNames ? '' : 'google.cloud.aiplatform.v1beta1'), createEmptyInstance: create)
    ..oo(0, [3])
    ..aOM<$4277.CsvSource>(3, _omitFieldNames ? '' : 'csvSource', subBuilder: $4277.CsvSource.create)
    ..aOS(5, _omitFieldNames ? '' : 'entityIdField')
    ..hasRequiredFields = false
  ;
  ...
  /// Source of Csv
  @$pb.TagNumber(3)
  $4277.CsvSource get csvSource => $_getN(0);
  @$pb.TagNumber(3)
  set csvSource($4277.CsvSource v) { setField(3, v); }
  @$pb.TagNumber(3)
  $core.bool hasCsvSource() => $_has(0);
  @$pb.TagNumber(3)
  void clearCsvSource() => clearField(3);
  @$pb.TagNumber(3)
  $4277.CsvSource ensureCsvSource() => $_ensure(0);
