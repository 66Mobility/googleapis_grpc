...
class ModelEvaluationSlice_Slice_SliceSpec_SliceConfig extends $pb.GeneratedMessage {
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(_omitMessageNames ? '' : 'ModelEvaluationSlice.Slice.SliceSpec.SliceConfig', package: const $pb.PackageName(_omitMessageNames ? '' : 'google.cloud.aiplatform.v1beta1'), createEmptyInstance: create)
    ..oo(0, [1, 2, 3])
...
class ModelEvaluationSlice_Slice_SliceSpec_Range extends $pb.GeneratedMessage {
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(_omitMessageNames ? '' : 'ModelEvaluationSlice.Slice.SliceSpec.Range', package: const $pb.PackageName(_omitMessageNames ? '' : 'google.cloud.aiplatform.v1beta1'), createEmptyInstance: create)
...
class ModelEvaluationSlice_Slice_SliceSpec_Value extends $pb.GeneratedMessage {
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(_omitMessageNames ? '' : 'ModelEvaluationSlice.Slice.SliceSpec.Value', package: const $pb.PackageName(_omitMessageNames ? '' : 'google.cloud.aiplatform.v1beta1'), createEmptyInstance: create)
    ..oo(0, [1, 2])
...
class ModelEvaluationSlice_Slice_SliceSpec extends $pb.GeneratedMessage {
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(_omitMessageNames ? '' : 'ModelEvaluationSlice.Slice.SliceSpec', package: const $pb.PackageName(_omitMessageNames ? '' : 'google.cloud.aiplatform.v1beta1'), createEmptyInstance: create)
    ..m<$core.String, ModelEvaluationSlice_Slice_SliceSpec_SliceConfig>(1, _omitFieldNames ? '' : 'configs', entryClassName: 'ModelEvaluationSlice.Slice.SliceSpec.ConfigsEntry', keyFieldType: $pb.PbFieldType.OS, valueFieldType: $pb.PbFieldType.OM, valueCreator: ModelEvaluationSlice_Slice_SliceSpec_SliceConfig.create, valueDefaultOrMaker: ModelEvaluationSlice_Slice_SliceSpec_SliceConfig.getDefault, packageName: const $pb.PackageName('google.cloud.aiplatform.v1beta1'))
    ..hasRequiredFields = false
  ;
...
class ModelEvaluationSlice_Slice extends $pb.GeneratedMessage {
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(_omitMessageNames ? '' : 'ModelEvaluationSlice.Slice', package: const $pb.PackageName(_omitMessageNames ? '' : 'google.cloud.aiplatform.v1beta1'), createEmptyInstance: create)
...
class ModelEvaluationSlice extends $pb.GeneratedMessage {
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(_omitMessageNames ? '' : 'ModelEvaluationSlice', package: const $pb.PackageName(_omitMessageNames ? '' : 'google.cloud.aiplatform.v1beta1'), createEmptyInstance: create)
    ...
    ..aOM<$4286.ModelExplanation>(6, _omitFieldNames ? '' : 'modelExplanation', subBuilder: $4286.ModelExplanation.create)
    ..hasRequiredFields = false
  ;
  ...
  @$pb.TagNumber(6)
  set modelExplanation($4286.ModelExplanation v) { setField(6, v); }
  @$pb.TagNumber(6)
