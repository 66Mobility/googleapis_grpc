...
class ModelEvaluationSlice extends $pb.GeneratedMessage {
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(_omitMessageNames ? '' : 'ModelEvaluationSlice', package: const $pb.PackageName(_omitMessageNames ? '' : 'google.cloud.aiplatform.v1beta1'), createEmptyInstance: create)
    ...
    ..aOM<$4285.ModelExplanation>(6, _omitFieldNames ? '' : 'modelExplanation', subBuilder: $4285.ModelExplanation.create)
    ..hasRequiredFields = false
  ;
  ...
  @$pb.TagNumber(6)
  set modelExplanation($4285.ModelExplanation v) { setField(6, v); }
  @$pb.TagNumber(6)
