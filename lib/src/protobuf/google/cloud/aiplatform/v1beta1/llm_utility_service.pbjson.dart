...
final $typed_data.Uint8List computeTokensRequestDescriptor = $convert.base64Decode(
    ...
    'gJQgPgQQFSBW1vZGVsEkkKCGNvbnRlbnRzGAQgAygLMiguZ29vZ2xlLmNsb3VkLmFpcGxhdGZv'
    'cm0udjFiZXRhMS5Db250ZW50QgPgQQFSCGNvbnRlbnRz');
...
const ComputeTokensResponse$json = {
  ...
  '2': [
    {'1': 'tokens_info', '3': 1, '4': 3, '5': 11, '6': '.google.cloud.aiplatform.v1beta1.TokensInfo', '10': 'tokensInfo'},
  ],
};
...
final $typed_data.Uint8List computeTokensResponseDescriptor = $convert.base64Decode(
    'ChVDb21wdXRlVG9rZW5zUmVzcG9uc2USTAoLdG9rZW5zX2luZm8YASADKAsyKy5nb29nbGUuY2'
    'xvdWQuYWlwbGF0Zm9ybS52MWJldGExLlRva2Vuc0luZm9SCnRva2Vuc0luZm8=');
