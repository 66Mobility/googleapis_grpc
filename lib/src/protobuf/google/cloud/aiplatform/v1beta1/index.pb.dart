...
import 'deployed_index_ref.pb.dart' as $4302;
...
class Index extends $pb.GeneratedMessage {
  factory Index({
    ...
    $1734.Value? metadata,
    $core.Iterable<$4302.DeployedIndexRef>? deployedIndexes,
    $core.String? etag,
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(_omitMessageNames ? '' : 'Index', package: const $pb.PackageName(_omitMessageNames ? '' : 'google.cloud.aiplatform.v1beta1'), createEmptyInstance: create)
    ...
    ..pc<$4302.DeployedIndexRef>(7, _omitFieldNames ? '' : 'deployedIndexes', $pb.PbFieldType.PM, subBuilder: $4302.DeployedIndexRef.create)
  ...
  /// first.
  @$pb.TagNumber(7)
  $core.List<$4302.DeployedIndexRef> get deployedIndexes => $_getList(5);
