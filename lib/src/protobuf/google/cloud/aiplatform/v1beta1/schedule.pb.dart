...
class Schedule_RunResponse extends $pb.GeneratedMessage {
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(_omitMessageNames ? '' : 'Schedule.RunResponse', package: const $pb.PackageName(_omitMessageNames ? '' : 'google.cloud.aiplatform.v1beta1'), createEmptyInstance: create)
...
class Schedule extends $pb.GeneratedMessage {
  factory Schedule({
    ...
    $core.bool? catchUp,
    $617.CreatePipelineJobRequest? createPipelineJobRequest,
    $605.CreateModelMonitoringJobRequest? createModelMonitoringJobRequest,
    $fixnum.Int64? maxRunCount,
    $fixnum.Int64? startedRunCount,
    Schedule_RunResponse? lastScheduledRunResponse,
    $1775.Timestamp? updateTime,
    $612.CreateNotebookExecutionJobRequest? createNotebookExecutionJobRequest,
  }) {
    final $result = create();
    if (name != null) {
      $result.name = name;
    ...
    if (createModelMonitoringJobRequest != null) {
      $result.createModelMonitoringJobRequest = createModelMonitoringJobRequest;
    }
    if (maxRunCount != null) {
    ...
    if (createNotebookExecutionJobRequest != null) {
      $result.createNotebookExecutionJobRequest = createNotebookExecutionJobRequest;
    }
    return $result;
  }
  Schedule._() : super();
  ...
  static const $core.Map<$core.int, Schedule_Request> _Schedule_RequestByTag = {
    ...
    15 : Schedule_Request.createModelMonitoringJobRequest,
    20 : Schedule_Request.createNotebookExecutionJobRequest,
    0 : Schedule_Request.notSet
  };
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(_omitMessageNames ? '' : 'Schedule', package: const $pb.PackageName(_omitMessageNames ? '' : 'google.cloud.aiplatform.v1beta1'), createEmptyInstance: create)
    ..oo(0, [10])
    ..oo(1, [14, 15, 20])
    ...
    ..aOM<$617.CreatePipelineJobRequest>(14, _omitFieldNames ? '' : 'createPipelineJobRequest', subBuilder: $617.CreatePipelineJobRequest.create)
    ..aOM<$605.CreateModelMonitoringJobRequest>(15, _omitFieldNames ? '' : 'createModelMonitoringJobRequest', subBuilder: $605.CreateModelMonitoringJobRequest.create)
    ...
    ..aOM<$612.CreateNotebookExecutionJobRequest>(20, _omitFieldNames ? '' : 'createNotebookExecutionJobRequest', subBuilder: $612.CreateNotebookExecutionJobRequest.create)
    ..hasRequiredFields = false
  ;
  ...
  @$pb.TagNumber(14)
  $617.CreatePipelineJobRequest get createPipelineJobRequest => $_getN(13);
  @$pb.TagNumber(14)
  set createPipelineJobRequest($617.CreatePipelineJobRequest v) { setField(14, v); }
  @$pb.TagNumber(14)
  $core.bool hasCreatePipelineJobRequest() => $_has(13);
  @$pb.TagNumber(14)
  void clearCreatePipelineJobRequest() => clearField(14);
  @$pb.TagNumber(14)
  $617.CreatePipelineJobRequest ensureCreatePipelineJobRequest() => $_ensure(13);
  ...
  @$pb.TagNumber(15)
  $605.CreateModelMonitoringJobRequest get createModelMonitoringJobRequest => $_getN(14);
  @$pb.TagNumber(15)
  set createModelMonitoringJobRequest($605.CreateModelMonitoringJobRequest v) { setField(15, v); }
  @$pb.TagNumber(15)
  $core.bool hasCreateModelMonitoringJobRequest() => $_has(14);
  @$pb.TagNumber(15)
  void clearCreateModelMonitoringJobRequest() => clearField(15);
  @$pb.TagNumber(15)
  $605.CreateModelMonitoringJobRequest ensureCreateModelMonitoringJobRequest() => $_ensure(14);
  ...
  /// Unset if not specified.
  @$pb.TagNumber(16)
  $fixnum.Int64 get maxRunCount => $_getI64(15);
  @$pb.TagNumber(16)
  set maxRunCount($fixnum.Int64 v) { $_setInt64(15, v); }
  @$pb.TagNumber(16)
  $core.bool hasMaxRunCount() => $_has(15);
  @$pb.TagNumber(16)
  void clearMaxRunCount() => clearField(16);

  /// Output only. The number of runs started by this schedule.
  @$pb.TagNumber(17)
  $fixnum.Int64 get startedRunCount => $_getI64(16);
  @$pb.TagNumber(17)
  set startedRunCount($fixnum.Int64 v) { $_setInt64(16, v); }
  @$pb.TagNumber(17)
  $core.bool hasStartedRunCount() => $_has(16);
  @$pb.TagNumber(17)
  ...
  @$pb.TagNumber(18)
  Schedule_RunResponse get lastScheduledRunResponse => $_getN(17);
  @$pb.TagNumber(18)
  set lastScheduledRunResponse(Schedule_RunResponse v) { setField(18, v); }
  @$pb.TagNumber(18)
  $core.bool hasLastScheduledRunResponse() => $_has(17);
  @$pb.TagNumber(18)
  void clearLastScheduledRunResponse() => clearField(18);
  @$pb.TagNumber(18)
  Schedule_RunResponse ensureLastScheduledRunResponse() => $_ensure(17);

  /// Output only. Timestamp when this Schedule was updated.
  @$pb.TagNumber(19)
  $1775.Timestamp get updateTime => $_getN(18);
  @$pb.TagNumber(19)
  ...
  @$pb.TagNumber(19)
  $1775.Timestamp ensureUpdateTime() => $_ensure(18);

  /// Request for
  /// [NotebookService.CreateNotebookExecutionJob][google.cloud.aiplatform.v1beta1.NotebookService.CreateNotebookExecutionJob].
  @$pb.TagNumber(20)
  $612.CreateNotebookExecutionJobRequest get createNotebookExecutionJobRequest => $_getN(19);
  @$pb.TagNumber(20)
  set createNotebookExecutionJobRequest($612.CreateNotebookExecutionJobRequest v) { setField(20, v); }
  @$pb.TagNumber(20)
  $core.bool hasCreateNotebookExecutionJobRequest() => $_has(19);
  @$pb.TagNumber(20)
  void clearCreateNotebookExecutionJobRequest() => clearField(20);
  @$pb.TagNumber(20)
  $612.CreateNotebookExecutionJobRequest ensureCreateNotebookExecutionJobRequest() => $_ensure(19);
}
