...
class ExplanationMetadata_InputMetadata_FeatureValueDomain extends $pb.GeneratedMessage {
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(_omitMessageNames ? '' : 'ExplanationMetadata.InputMetadata.FeatureValueDomain', package: const $pb.PackageName(_omitMessageNames ? '' : 'google.cloud.aiplatform.v1beta1'), createEmptyInstance: create)
...
class ExplanationMetadata_InputMetadata_Visualization extends $pb.GeneratedMessage {
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(_omitMessageNames ? '' : 'ExplanationMetadata.InputMetadata.Visualization', package: const $pb.PackageName(_omitMessageNames ? '' : 'google.cloud.aiplatform.v1beta1'), createEmptyInstance: create)
...
class ExplanationMetadata_InputMetadata extends $pb.GeneratedMessage {
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(_omitMessageNames ? '' : 'ExplanationMetadata.InputMetadata', package: const $pb.PackageName(_omitMessageNames ? '' : 'google.cloud.aiplatform.v1beta1'), createEmptyInstance: create)
...
class ExplanationMetadata_OutputMetadata extends $pb.GeneratedMessage {
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(_omitMessageNames ? '' : 'ExplanationMetadata.OutputMetadata', package: const $pb.PackageName(_omitMessageNames ? '' : 'google.cloud.aiplatform.v1beta1'), createEmptyInstance: create)
    ..oo(0, [1, 2])
...
class ExplanationMetadata extends $pb.GeneratedMessage {
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(_omitMessageNames ? '' : 'ExplanationMetadata', package: const $pb.PackageName(_omitMessageNames ? '' : 'google.cloud.aiplatform.v1beta1'), createEmptyInstance: create)
    ..m<$core.String, ExplanationMetadata_InputMetadata>(1, _omitFieldNames ? '' : 'inputs', entryClassName: 'ExplanationMetadata.InputsEntry', keyFieldType: $pb.PbFieldType.OS, valueFieldType: $pb.PbFieldType.OM, valueCreator: ExplanationMetadata_InputMetadata.create, valueDefaultOrMaker: ExplanationMetadata_InputMetadata.getDefault, packageName: const $pb.PackageName('google.cloud.aiplatform.v1beta1'))
    ..m<$core.String, ExplanationMetadata_OutputMetadata>(2, _omitFieldNames ? '' : 'outputs', entryClassName: 'ExplanationMetadata.OutputsEntry', keyFieldType: $pb.PbFieldType.OS, valueFieldType: $pb.PbFieldType.OM, valueCreator: ExplanationMetadata_OutputMetadata.create, valueDefaultOrMaker: ExplanationMetadata_OutputMetadata.getDefault, packageName: const $pb.PackageName('google.cloud.aiplatform.v1beta1'))
