...
class ToolUseExample extends $pb.GeneratedMessage {
  factory ToolUseExample({
    ...
    $core.String? query,
    $1734.Struct? requestParams,
    $1734.Struct? responseParams,
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(_omitMessageNames ? '' : 'ToolUseExample', package: const $pb.PackageName(_omitMessageNames ? '' : 'google.cloud.aiplatform.v1beta1'), createEmptyInstance: create)
    ...
    ..aOM<$1734.Struct>(3, _omitFieldNames ? '' : 'requestParams', subBuilder: $1734.Struct.create)
    ..aOM<$1734.Struct>(4, _omitFieldNames ? '' : 'responseParams', subBuilder: $1734.Struct.create)
  ...
  @$pb.TagNumber(3)
  $1734.Struct get requestParams => $_getN(2);
  @$pb.TagNumber(3)
  set requestParams($1734.Struct v) { setField(3, v); }
  @$pb.TagNumber(3)
  $core.bool hasRequestParams() => $_has(2);
  @$pb.TagNumber(3)
  void clearRequestParams() => clearField(3);
  @$pb.TagNumber(3)
  $1734.Struct ensureRequestParams() => $_ensure(2);

  /// Response parameters generated by this tool.
  @$pb.TagNumber(4)
  $1734.Struct get responseParams => $_getN(3);
  @$pb.TagNumber(4)
  set responseParams($1734.Struct v) { setField(4, v); }
  @$pb.TagNumber(4)
  $core.bool hasResponseParams() => $_has(3);
  @$pb.TagNumber(4)
  void clearResponseParams() => clearField(4);
  @$pb.TagNumber(4)
  $1734.Struct ensureResponseParams() => $_ensure(3);
...
class FunctionDeclaration extends $pb.GeneratedMessage {
  factory FunctionDeclaration({
    ...
    $4291.Schema? parameters,
    $4291.Schema? response,
  }) {
    final $result = create();
    if (name != null) {
      $result.name = name;
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(_omitMessageNames ? '' : 'FunctionDeclaration', package: const $pb.PackageName(_omitMessageNames ? '' : 'google.cloud.aiplatform.v1beta1'), createEmptyInstance: create)
    ...
    ..aOM<$4291.Schema>(3, _omitFieldNames ? '' : 'parameters', subBuilder: $4291.Schema.create)
    ..aOM<$4291.Schema>(4, _omitFieldNames ? '' : 'response', subBuilder: $4291.Schema.create)
    ..hasRequiredFields = false
  ;
  ...
  ///  - param1
  @$pb.TagNumber(3)
  $4291.Schema get parameters => $_getN(2);
  @$pb.TagNumber(3)
  set parameters($4291.Schema v) { setField(3, v); }
  @$pb.TagNumber(3)
  $core.bool hasParameters() => $_has(2);
  @$pb.TagNumber(3)
  void clearParameters() => clearField(3);
  @$pb.TagNumber(3)
  $4291.Schema ensureParameters() => $_ensure(2);

  /// Optional. Describes the output from this function in JSON Schema format.
  /// Reflects the Open API 3.03 Response Object. The Schema defines the type
  /// used for the response value of the function.
  @$pb.TagNumber(4)
  $4291.Schema get response => $_getN(3);
  @$pb.TagNumber(4)
  set response($4291.Schema v) { setField(4, v); }
  @$pb.TagNumber(4)
  $core.bool hasResponse() => $_has(3);
  @$pb.TagNumber(4)
  void clearResponse() => clearField(4);
  @$pb.TagNumber(4)
  $4291.Schema ensureResponse() => $_ensure(3);
}
