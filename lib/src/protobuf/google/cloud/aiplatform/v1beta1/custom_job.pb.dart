...
class CustomJob extends $pb.GeneratedMessage {
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(_omitMessageNames ? '' : 'CustomJob', package: const $pb.PackageName(_omitMessageNames ? '' : 'google.cloud.aiplatform.v1beta1'), createEmptyInstance: create)
    ...
    ..e<$4284.JobState>(5, _omitFieldNames ? '' : 'state', $pb.PbFieldType.OE, defaultOrMaker: $4284.JobState.JOB_STATE_UNSPECIFIED, valueOf: $4284.JobState.valueOf, enumValues: $4284.JobState.values)
  ...
  @$pb.TagNumber(5)
  set state($4284.JobState v) { setField(5, v); }
  @$pb.TagNumber(5)
...
class CustomJobSpec extends $pb.GeneratedMessage {
  factory CustomJobSpec({
    ...
    $core.String? network,
    $4278.GcsDestination? baseOutputDirectory,
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(_omitMessageNames ? '' : 'CustomJobSpec', package: const $pb.PackageName(_omitMessageNames ? '' : 'google.cloud.aiplatform.v1beta1'), createEmptyInstance: create)
    ...
    ..aOM<$4278.GcsDestination>(6, _omitFieldNames ? '' : 'baseOutputDirectory', subBuilder: $4278.GcsDestination.create)
  ...
  @$pb.TagNumber(6)
  $4278.GcsDestination get baseOutputDirectory => $_getN(4);
  @$pb.TagNumber(6)
  set baseOutputDirectory($4278.GcsDestination v) { setField(6, v); }
  @$pb.TagNumber(6)
  $core.bool hasBaseOutputDirectory() => $_has(4);
  @$pb.TagNumber(6)
  void clearBaseOutputDirectory() => clearField(6);
  @$pb.TagNumber(6)
  $4278.GcsDestination ensureBaseOutputDirectory() => $_ensure(4);
...
class WorkerPoolSpec extends $pb.GeneratedMessage {
  factory WorkerPoolSpec({
    ...
    $core.Iterable<$4288.NfsMount>? nfsMounts,
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(_omitMessageNames ? '' : 'WorkerPoolSpec', package: const $pb.PackageName(_omitMessageNames ? '' : 'google.cloud.aiplatform.v1beta1'), createEmptyInstance: create)
    ..oo(0, [6, 7])
    ..aOM<$4288.MachineSpec>(1, _omitFieldNames ? '' : 'machineSpec', subBuilder: $4288.MachineSpec.create)
    ..aInt64(2, _omitFieldNames ? '' : 'replicaCount')
    ..pc<$4288.NfsMount>(4, _omitFieldNames ? '' : 'nfsMounts', $pb.PbFieldType.PM, subBuilder: $4288.NfsMount.create)
    ..aOM<$4288.DiskSpec>(5, _omitFieldNames ? '' : 'diskSpec', subBuilder: $4288.DiskSpec.create)
  ...
  @$pb.TagNumber(1)
  $4288.MachineSpec get machineSpec => $_getN(0);
  @$pb.TagNumber(1)
  set machineSpec($4288.MachineSpec v) { setField(1, v); }
  @$pb.TagNumber(1)
  $core.bool hasMachineSpec() => $_has(0);
  @$pb.TagNumber(1)
  void clearMachineSpec() => clearField(1);
  @$pb.TagNumber(1)
  $4288.MachineSpec ensureMachineSpec() => $_ensure(0);
  ...
  @$pb.TagNumber(4)
  $core.List<$4288.NfsMount> get nfsMounts => $_getList(2);

  /// Disk spec.
  @$pb.TagNumber(5)
  $4288.DiskSpec get diskSpec => $_getN(3);
  @$pb.TagNumber(5)
  set diskSpec($4288.DiskSpec v) { setField(5, v); }
  @$pb.TagNumber(5)
...
class PythonPackageSpec extends $pb.GeneratedMessage {
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(_omitMessageNames ? '' : 'PythonPackageSpec', package: const $pb.PackageName(_omitMessageNames ? '' : 'google.cloud.aiplatform.v1beta1'), createEmptyInstance: create)
    ...
    ..pc<$4287.EnvVar>(5, _omitFieldNames ? '' : 'env', $pb.PbFieldType.PM, subBuilder: $4287.EnvVar.create)
    ..hasRequiredFields = false
  ;
  ...
  /// Maximum limit is 100.
  @$pb.TagNumber(5)
  $core.List<$4287.EnvVar> get env => $_getList(4);
}
