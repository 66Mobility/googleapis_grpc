...
class PublisherModel_ResourceReference extends $pb.GeneratedMessage {
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(_omitMessageNames ? '' : 'PublisherModel.ResourceReference', package: const $pb.PackageName(_omitMessageNames ? '' : 'google.cloud.aiplatform.v1beta1'), createEmptyInstance: create)
    ..oo(0, [1, 2, 3, 4])
...
class PublisherModel_Parent extends $pb.GeneratedMessage {
  factory PublisherModel_Parent({
    $core.String? displayName,
    PublisherModel_ResourceReference? reference,
  }) {
    final $result = create();
    if (displayName != null) {
  ...
  PublisherModel_Parent._() : super();
  factory PublisherModel_Parent.fromBuffer($core.List<$core.int> i, [$pb.ExtensionRegistry r = $pb.ExtensionRegistry.EMPTY]) => create()..mergeFromBuffer(i, r);
  factory PublisherModel_Parent.fromJson($core.String i, [$pb.ExtensionRegistry r = $pb.ExtensionRegistry.EMPTY]) => create()..mergeFromJson(i, r);

  static final $pb.BuilderInfo _i = $pb.BuilderInfo(_omitMessageNames ? '' : 'PublisherModel.Parent', package: const $pb.PackageName(_omitMessageNames ? '' : 'google.cloud.aiplatform.v1beta1'), createEmptyInstance: create)
    ..aOS(1, _omitFieldNames ? '' : 'displayName')
    ..aOM<PublisherModel_ResourceReference>(2, _omitFieldNames ? '' : 'reference', subBuilder: PublisherModel_ResourceReference.create)
    ..hasRequiredFields = false
  ;
  ...
  'Use [GeneratedMessageGenericExtensions.deepCopy] instead. '
  'Will be removed in next major version')
  PublisherModel_Parent clone() => PublisherModel_Parent()..mergeFromMessage(this);
  @$core.Deprecated(
  'Using this can add significant overhead to your binary. '
  'Use [GeneratedMessageGenericExtensions.rebuild] instead. '
  'Will be removed in next major version')
  PublisherModel_Parent copyWith(void Function(PublisherModel_Parent) updates) => super.copyWith((message) => updates(message as PublisherModel_Parent)) as PublisherModel_Parent;

  $pb.BuilderInfo get info_ => _i;

  @$core.pragma('dart2js:noInline')
  static PublisherModel_Parent create() => PublisherModel_Parent._();
  PublisherModel_Parent createEmptyInstance() => create();
  static $pb.PbList<PublisherModel_Parent> createRepeated() => $pb.PbList<PublisherModel_Parent>();
  @$core.pragma('dart2js:noInline')
  static PublisherModel_Parent getDefault() => _defaultInstance ??= $pb.GeneratedMessage.$_defaultFor<PublisherModel_Parent>(create);
  static PublisherModel_Parent? _defaultInstance;
  ...
  @$pb.TagNumber(2)
  PublisherModel_ResourceReference get reference => $_getN(1);
  @$pb.TagNumber(2)
  set reference(PublisherModel_ResourceReference v) { setField(2, v); }
  @$pb.TagNumber(2)
  $core.bool hasReference() => $_has(1);
  @$pb.TagNumber(2)
  void clearReference() => clearField(2);
  @$pb.TagNumber(2)
  PublisherModel_ResourceReference ensureReference() => $_ensure(1);
}
...
class PublisherModel_Documentation extends $pb.GeneratedMessage {
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(_omitMessageNames ? '' : 'PublisherModel.Documentation', package: const $pb.PackageName(_omitMessageNames ? '' : 'google.cloud.aiplatform.v1beta1'), createEmptyInstance: create)
...
class PublisherModel_CallToAction_RegionalResourceReferences extends $pb.GeneratedMessage {
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(_omitMessageNames ? '' : 'PublisherModel.CallToAction.RegionalResourceReferences', package: const $pb.PackageName(_omitMessageNames ? '' : 'google.cloud.aiplatform.v1beta1'), createEmptyInstance: create)
    ..m<$core.String, PublisherModel_ResourceReference>(1, _omitFieldNames ? '' : 'references', entryClassName: 'PublisherModel.CallToAction.RegionalResourceReferences.ReferencesEntry', keyFieldType: $pb.PbFieldType.OS, valueFieldType: $pb.PbFieldType.OM, valueCreator: PublisherModel_ResourceReference.create, valueDefaultOrMaker: PublisherModel_ResourceReference.getDefault, packageName: const $pb.PackageName('google.cloud.aiplatform.v1beta1'))
...
class PublisherModel_CallToAction_ViewRestApi extends $pb.GeneratedMessage {
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(_omitMessageNames ? '' : 'PublisherModel.CallToAction.ViewRestApi', package: const $pb.PackageName(_omitMessageNames ? '' : 'google.cloud.aiplatform.v1beta1'), createEmptyInstance: create)
...
class PublisherModel_CallToAction_OpenNotebooks extends $pb.GeneratedMessage {
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(_omitMessageNames ? '' : 'PublisherModel.CallToAction.OpenNotebooks', package: const $pb.PackageName(_omitMessageNames ? '' : 'google.cloud.aiplatform.v1beta1'), createEmptyInstance: create)
...
class PublisherModel_CallToAction_OpenFineTuningPipelines extends $pb.GeneratedMessage {
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(_omitMessageNames ? '' : 'PublisherModel.CallToAction.OpenFineTuningPipelines', package: const $pb.PackageName(_omitMessageNames ? '' : 'google.cloud.aiplatform.v1beta1'), createEmptyInstance: create)
...
class PublisherModel_CallToAction_Deploy_DeployMetadata extends $pb.GeneratedMessage {
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(_omitMessageNames ? '' : 'PublisherModel.CallToAction.Deploy.DeployMetadata', package: const $pb.PackageName(_omitMessageNames ? '' : 'google.cloud.aiplatform.v1beta1'), createEmptyInstance: create)
    ..m<$core.String, $core.String>(1, _omitFieldNames ? '' : 'labels', entryClassName: 'PublisherModel.CallToAction.Deploy.DeployMetadata.LabelsEntry', keyFieldType: $pb.PbFieldType.OS, valueFieldType: $pb.PbFieldType.OS, packageName: const $pb.PackageName('google.cloud.aiplatform.v1beta1'))
...
class PublisherModel_CallToAction_Deploy extends $pb.GeneratedMessage {
  factory PublisherModel_CallToAction_Deploy({
    ...
    $609.LargeModelReference? largeModelReference,
    $609.ModelContainerSpec? containerSpec,
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(_omitMessageNames ? '' : 'PublisherModel.CallToAction.Deploy', package: const $pb.PackageName(_omitMessageNames ? '' : 'google.cloud.aiplatform.v1beta1'), createEmptyInstance: create)
    ..oo(0, [5, 6, 7])
    ..aOS(1, _omitFieldNames ? '' : 'modelDisplayName')
    ..aOM<$609.LargeModelReference>(2, _omitFieldNames ? '' : 'largeModelReference', subBuilder: $609.LargeModelReference.create)
    ..aOM<$609.ModelContainerSpec>(3, _omitFieldNames ? '' : 'containerSpec', subBuilder: $609.ModelContainerSpec.create)
    ..aOS(4, _omitFieldNames ? '' : 'artifactUri')
    ..aOM<$4288.DedicatedResources>(5, _omitFieldNames ? '' : 'dedicatedResources', subBuilder: $4288.DedicatedResources.create)
    ..aOM<$4288.AutomaticResources>(6, _omitFieldNames ? '' : 'automaticResources', subBuilder: $4288.AutomaticResources.create)
  ...
  /// is not needed.
  @$pb.TagNumber(2)
  $609.LargeModelReference get largeModelReference => $_getN(1);
  @$pb.TagNumber(2)
  set largeModelReference($609.LargeModelReference v) { setField(2, v); }
  @$pb.TagNumber(2)
  $core.bool hasLargeModelReference() => $_has(1);
  @$pb.TagNumber(2)
  void clearLargeModelReference() => clearField(2);
  @$pb.TagNumber(2)
  $609.LargeModelReference ensureLargeModelReference() => $_ensure(1);

  /// Optional. The specification of the container that is to be used when
  /// deploying this Model in Vertex AI. Not present for Large Models.
  @$pb.TagNumber(3)
  $609.ModelContainerSpec get containerSpec => $_getN(2);
  @$pb.TagNumber(3)
  set containerSpec($609.ModelContainerSpec v) { setField(3, v); }
  @$pb.TagNumber(3)
  $core.bool hasContainerSpec() => $_has(2);
  @$pb.TagNumber(3)
  void clearContainerSpec() => clearField(3);
  @$pb.TagNumber(3)
  $609.ModelContainerSpec ensureContainerSpec() => $_ensure(2);
  ...
  @$pb.TagNumber(5)
  set dedicatedResources($4288.DedicatedResources v) { setField(5, v); }
  @$pb.TagNumber(5)
  ...
  @$pb.TagNumber(6)
  set automaticResources($4288.AutomaticResources v) { setField(6, v); }
  @$pb.TagNumber(6)
...
class PublisherModel_CallToAction_DeployGke extends $pb.GeneratedMessage {
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(_omitMessageNames ? '' : 'PublisherModel.CallToAction.DeployGke', package: const $pb.PackageName(_omitMessageNames ? '' : 'google.cloud.aiplatform.v1beta1'), createEmptyInstance: create)
...
class PublisherModel_CallToAction extends $pb.GeneratedMessage {
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(_omitMessageNames ? '' : 'PublisherModel.CallToAction', package: const $pb.PackageName(_omitMessageNames ? '' : 'google.cloud.aiplatform.v1beta1'), createEmptyInstance: create)
...
class PublisherModel extends $pb.GeneratedMessage {
  factory PublisherModel({
    ...
    $609.PredictSchemata? predictSchemata,
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(_omitMessageNames ? '' : 'PublisherModel', package: const $pb.PackageName(_omitMessageNames ? '' : 'google.cloud.aiplatform.v1beta1'), createEmptyInstance: create)
    ...
    ..aOM<PublisherModel_Parent>(14, _omitFieldNames ? '' : 'parent', subBuilder: PublisherModel_Parent.create)
    ...
    ..aOM<$609.PredictSchemata>(31, _omitFieldNames ? '' : 'predictSchemata', subBuilder: $609.PredictSchemata.create)
  ...
  @$pb.TagNumber(14)
  PublisherModel_Parent get parent => $_getN(3);
  @$pb.TagNumber(14)
  set parent(PublisherModel_Parent v) { setField(14, v); }
  @$pb.TagNumber(14)
  $core.bool hasParent() => $_has(3);
  @$pb.TagNumber(14)
  void clearParent() => clearField(14);
  @$pb.TagNumber(14)
  PublisherModel_Parent ensureParent() => $_ensure(3);

  /// Optional. Supported call-to-action options.
  @$pb.TagNumber(19)
  PublisherModel_CallToAction get supportedActions => $_getN(4);
  @$pb.TagNumber(19)
  set supportedActions(PublisherModel_CallToAction v) { setField(19, v); }
  @$pb.TagNumber(19)
  $core.bool hasSupportedActions() => $_has(4);
  @$pb.TagNumber(19)
  void clearSupportedActions() => clearField(19);
  @$pb.TagNumber(19)
  PublisherModel_CallToAction ensureSupportedActions() => $_ensure(4);

  /// Optional. Additional information about the model's Frameworks.
  @$pb.TagNumber(23)
  $core.List<$core.String> get frameworks => $_getList(5);

  /// Optional. Indicates the launch stage of the model.
  @$pb.TagNumber(29)
  PublisherModel_LaunchStage get launchStage => $_getN(6);
  @$pb.TagNumber(29)
  ...
  /// name.
  @$pb.TagNumber(30)
  $core.String get publisherModelTemplate => $_getSZ(7);
  @$pb.TagNumber(30)
  set publisherModelTemplate($core.String v) { $_setString(7, v); }
  @$pb.TagNumber(30)
  $core.bool hasPublisherModelTemplate() => $_has(7);
  @$pb.TagNumber(30)
  ...
  @$pb.TagNumber(31)
  $609.PredictSchemata get predictSchemata => $_getN(8);
  @$pb.TagNumber(31)
  set predictSchemata($609.PredictSchemata v) { setField(31, v); }
  @$pb.TagNumber(31)
  $core.bool hasPredictSchemata() => $_has(8);
  @$pb.TagNumber(31)
  void clearPredictSchemata() => clearField(31);
  @$pb.TagNumber(31)
  $609.PredictSchemata ensurePredictSchemata() => $_ensure(8);

  /// Optional. Indicates the state of the model version.
  @$pb.TagNumber(37)
  PublisherModel_VersionState get versionState => $_getN(9);
  @$pb.TagNumber(37)
  set versionState(PublisherModel_VersionState v) { setField(37, v); }
  @$pb.TagNumber(37)
  $core.bool hasVersionState() => $_has(9);
  @$pb.TagNumber(37)
