...
import 'tensorboard_data.pb.dart' as $4319;
...
class ReadTensorboardBlobDataResponse extends $pb.GeneratedMessage {
  factory ReadTensorboardBlobDataResponse({
    $core.Iterable<$4319.TensorboardBlob>? blobs,
  }) {
    final $result = create();
    if (blobs != null) {
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(_omitMessageNames ? '' : 'ReadTensorboardBlobDataResponse', package: const $pb.PackageName(_omitMessageNames ? '' : 'google.cloud.aiplatform.v1beta1'), createEmptyInstance: create)
    ..pc<$4319.TensorboardBlob>(1, _omitFieldNames ? '' : 'blobs', $pb.PbFieldType.PM, subBuilder: $4319.TensorboardBlob.create)
    ..hasRequiredFields = false
  ;
  ...
  @$pb.TagNumber(1)
  $core.List<$4319.TensorboardBlob> get blobs => $_getList(0);
}
...
class BatchReadTensorboardTimeSeriesDataResponse extends $pb.GeneratedMessage {
  factory BatchReadTensorboardTimeSeriesDataResponse({
    $core.Iterable<$4319.TimeSeriesData>? timeSeriesData,
  }) {
    final $result = create();
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(_omitMessageNames ? '' : 'BatchReadTensorboardTimeSeriesDataResponse', package: const $pb.PackageName(_omitMessageNames ? '' : 'google.cloud.aiplatform.v1beta1'), createEmptyInstance: create)
    ..pc<$4319.TimeSeriesData>(1, _omitFieldNames ? '' : 'timeSeriesData', $pb.PbFieldType.PM, subBuilder: $4319.TimeSeriesData.create)
    ..hasRequiredFields = false
  ;
  ...
  @$pb.TagNumber(1)
  $core.List<$4319.TimeSeriesData> get timeSeriesData => $_getList(0);
}
...
class ReadTensorboardTimeSeriesDataResponse extends $pb.GeneratedMessage {
  factory ReadTensorboardTimeSeriesDataResponse({
    $4319.TimeSeriesData? timeSeriesData,
  }) {
    final $result = create();
    if (timeSeriesData != null) {
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(_omitMessageNames ? '' : 'ReadTensorboardTimeSeriesDataResponse', package: const $pb.PackageName(_omitMessageNames ? '' : 'google.cloud.aiplatform.v1beta1'), createEmptyInstance: create)
    ..aOM<$4319.TimeSeriesData>(1, _omitFieldNames ? '' : 'timeSeriesData', subBuilder: $4319.TimeSeriesData.create)
    ..hasRequiredFields = false
  ;
  ...
  /// The returned time series data.
  @$pb.TagNumber(1)
  $4319.TimeSeriesData get timeSeriesData => $_getN(0);
  @$pb.TagNumber(1)
  set timeSeriesData($4319.TimeSeriesData v) { setField(1, v); }
  @$pb.TagNumber(1)
  $core.bool hasTimeSeriesData() => $_has(0);
  @$pb.TagNumber(1)
  void clearTimeSeriesData() => clearField(1);
  @$pb.TagNumber(1)
  $4319.TimeSeriesData ensureTimeSeriesData() => $_ensure(0);
}
...
class WriteTensorboardRunDataRequest extends $pb.GeneratedMessage {
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(_omitMessageNames ? '' : 'WriteTensorboardRunDataRequest', package: const $pb.PackageName(_omitMessageNames ? '' : 'google.cloud.aiplatform.v1beta1'), createEmptyInstance: create)
    ...
    ..pc<$4319.TimeSeriesData>(2, _omitFieldNames ? '' : 'timeSeriesData', $pb.PbFieldType.PM, subBuilder: $4319.TimeSeriesData.create)
    ..hasRequiredFields = false
  ;
  ...
  @$pb.TagNumber(2)
  $core.List<$4319.TimeSeriesData> get timeSeriesData => $_getList(1);
}
...
class ExportTensorboardTimeSeriesDataResponse extends $pb.GeneratedMessage {
  factory ExportTensorboardTimeSeriesDataResponse({
    $core.Iterable<$4319.TimeSeriesDataPoint>? timeSeriesDataPoints,
    $core.String? nextPageToken,
  }) {
    final $result = create();
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(_omitMessageNames ? '' : 'ExportTensorboardTimeSeriesDataResponse', package: const $pb.PackageName(_omitMessageNames ? '' : 'google.cloud.aiplatform.v1beta1'), createEmptyInstance: create)
    ..pc<$4319.TimeSeriesDataPoint>(1, _omitFieldNames ? '' : 'timeSeriesDataPoints', $pb.PbFieldType.PM, subBuilder: $4319.TimeSeriesDataPoint.create)
    ..aOS(2, _omitFieldNames ? '' : 'nextPageToken')
    ..hasRequiredFields = false
  ;
  ...
  @$pb.TagNumber(1)
  $core.List<$4319.TimeSeriesDataPoint> get timeSeriesDataPoints => $_getList(0);
