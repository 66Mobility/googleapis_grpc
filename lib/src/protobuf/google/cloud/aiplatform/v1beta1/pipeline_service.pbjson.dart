...
final $typed_data.Uint8List batchCancelPipelineJobsOperationMetadataDescriptor = $convert.base64Decode(
    'CihCYXRjaENhbmNlbFBpcGVsaW5lSm9ic09wZXJhdGlvbk1ldGFkYXRhEmQKEGdlbmVyaWNfbW'
    'V0YWRhdGEYASABKAsyOS5nb29nbGUuY2xvdWQuYWlwbGF0Zm9ybS52MWJldGExLkdlbmVyaWNP'
...
const CreateTrainingPipelineRequest$json = {
  ...
  '2': [
    ...
    {'1': 'training_pipeline', '3': 2, '4': 1, '5': 11, '6': '.google.cloud.aiplatform.v1beta1.TrainingPipeline', '8': {}, '10': 'trainingPipeline'},
  ],
};
...
final $typed_data.Uint8List createTrainingPipelineRequestDescriptor = $convert.base64Decode(
    ...
    'ohbG9jYXRpb25zLmdvb2dsZWFwaXMuY29tL0xvY2F0aW9uUgZwYXJlbnQSYwoRdHJhaW5pbmdf'
    'cGlwZWxpbmUYAiABKAsyMS5nb29nbGUuY2xvdWQuYWlwbGF0Zm9ybS52MWJldGExLlRyYWluaW'
    '5nUGlwZWxpbmVCA+BBAlIQdHJhaW5pbmdQaXBlbGluZQ==');
...
const ListTrainingPipelinesResponse$json = {
  ...
  '2': [
    {'1': 'training_pipelines', '3': 1, '4': 3, '5': 11, '6': '.google.cloud.aiplatform.v1beta1.TrainingPipeline', '10': 'trainingPipelines'},
...
final $typed_data.Uint8List listTrainingPipelinesResponseDescriptor = $convert.base64Decode(
    'Ch1MaXN0VHJhaW5pbmdQaXBlbGluZXNSZXNwb25zZRJgChJ0cmFpbmluZ19waXBlbGluZXMYAS'
    'ADKAsyMS5nb29nbGUuY2xvdWQuYWlwbGF0Zm9ybS52MWJldGExLlRyYWluaW5nUGlwZWxpbmVS'
    'EXRyYWluaW5nUGlwZWxpbmVzEiYKD25leHRfcGFnZV90b2tlbhgCIAEoCVINbmV4dFBhZ2VUb2'
    'tlbg==');
...
const CreatePipelineJobRequest$json = {
  ...
  '2': [
    {'1': 'parent', '3': 1, '4': 1, '5': 9, '8': {}, '10': 'parent'},
    {'1': 'pipeline_job', '3': 2, '4': 1, '5': 11, '6': '.google.cloud.aiplatform.v1beta1.PipelineJob', '8': {}, '10': 'pipelineJob'},
...
final $typed_data.Uint8List createPipelineJobRequestDescriptor = $convert.base64Decode(
    ...
    'F0aW9ucy5nb29nbGVhcGlzLmNvbS9Mb2NhdGlvblIGcGFyZW50ElQKDHBpcGVsaW5lX2pvYhgC'
    'IAEoCzIsLmdvb2dsZS5jbG91ZC5haXBsYXRmb3JtLnYxYmV0YTEuUGlwZWxpbmVKb2JCA+BBAl'
    'ILcGlwZWxpbmVKb2ISJgoPcGlwZWxpbmVfam9iX2lkGAMgASgJUg1waXBlbGluZUpvYklk');
...
const ListPipelineJobsResponse$json = {
  ...
  '2': [
    {'1': 'pipeline_jobs', '3': 1, '4': 3, '5': 11, '6': '.google.cloud.aiplatform.v1beta1.PipelineJob', '10': 'pipelineJobs'},
    {'1': 'next_page_token', '3': 2, '4': 1, '5': 9, '10': 'nextPageToken'},
  ],
};
...
final $typed_data.Uint8List listPipelineJobsResponseDescriptor = $convert.base64Decode(
    'ChhMaXN0UGlwZWxpbmVKb2JzUmVzcG9uc2USUQoNcGlwZWxpbmVfam9icxgBIAMoCzIsLmdvb2'
    'dsZS5jbG91ZC5haXBsYXRmb3JtLnYxYmV0YTEuUGlwZWxpbmVKb2JSDHBpcGVsaW5lSm9icxIm'
...
final $typed_data.Uint8List batchDeletePipelineJobsResponseDescriptor = $convert.base64Decode(
    'Ch9CYXRjaERlbGV0ZVBpcGVsaW5lSm9ic1Jlc3BvbnNlElEKDXBpcGVsaW5lX2pvYnMYASADKA'
    'syLC5nb29nbGUuY2xvdWQuYWlwbGF0Zm9ybS52MWJldGExLlBpcGVsaW5lSm9iUgxwaXBlbGlu'
    'ZUpvYnM=');
...
final $typed_data.Uint8List batchCancelPipelineJobsResponseDescriptor = $convert.base64Decode(
    'Ch9CYXRjaENhbmNlbFBpcGVsaW5lSm9ic1Jlc3BvbnNlElEKDXBpcGVsaW5lX2pvYnMYASADKA'
    'syLC5nb29nbGUuY2xvdWQuYWlwbGF0Zm9ybS52MWJldGExLlBpcGVsaW5lSm9iUgxwaXBlbGlu'
    'ZUpvYnM=');
