...
class IndexEndpoint extends $pb.GeneratedMessage {
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(_omitMessageNames ? '' : 'IndexEndpoint', package: const $pb.PackageName(_omitMessageNames ? '' : 'google.cloud.aiplatform.v1beta1'), createEmptyInstance: create)
    ...
    ..aOM<$4298.PrivateServiceConnectConfig>(12, _omitFieldNames ? '' : 'privateServiceConnectConfig', subBuilder: $4298.PrivateServiceConnectConfig.create)
    ..aOB(13, _omitFieldNames ? '' : 'publicEndpointEnabled')
    ..aOS(14, _omitFieldNames ? '' : 'publicEndpointDomainName')
    ..aOM<$4281.EncryptionSpec>(15, _omitFieldNames ? '' : 'encryptionSpec', subBuilder: $4281.EncryptionSpec.create)
  ...
  ///  are mutually exclusive.
  @$pb.TagNumber(12)
  $4298.PrivateServiceConnectConfig get privateServiceConnectConfig => $_getN(10);
  @$pb.TagNumber(12)
  set privateServiceConnectConfig($4298.PrivateServiceConnectConfig v) { setField(12, v); }
  @$pb.TagNumber(12)
  $core.bool hasPrivateServiceConnectConfig() => $_has(10);
  @$pb.TagNumber(12)
  void clearPrivateServiceConnectConfig() => clearField(12);
  @$pb.TagNumber(12)
  $4298.PrivateServiceConnectConfig ensurePrivateServiceConnectConfig() => $_ensure(10);
  ...
  /// secured by this key.
  @$pb.TagNumber(15)
  $4281.EncryptionSpec get encryptionSpec => $_getN(13);
  @$pb.TagNumber(15)
  set encryptionSpec($4281.EncryptionSpec v) { setField(15, v); }
  @$pb.TagNumber(15)
  $core.bool hasEncryptionSpec() => $_has(13);
  @$pb.TagNumber(15)
  void clearEncryptionSpec() => clearField(15);
  @$pb.TagNumber(15)
  $4281.EncryptionSpec ensureEncryptionSpec() => $_ensure(13);
...
class DeployedIndex extends $pb.GeneratedMessage {
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(_omitMessageNames ? '' : 'DeployedIndex', package: const $pb.PackageName(_omitMessageNames ? '' : 'google.cloud.aiplatform.v1beta1'), createEmptyInstance: create)
    ...
    ..aOM<$4287.AutomaticResources>(7, _omitFieldNames ? '' : 'automaticResources', subBuilder: $4287.AutomaticResources.create)
    ...
    ..aOM<$4287.DedicatedResources>(16, _omitFieldNames ? '' : 'dedicatedResources', subBuilder: $4287.DedicatedResources.create)
    ..hasRequiredFields = false
  ;
  ...
  /// 1000.
  @$pb.TagNumber(7)
  $4287.AutomaticResources get automaticResources => $_getN(6);
  @$pb.TagNumber(7)
  set automaticResources($4287.AutomaticResources v) { setField(7, v); }
  @$pb.TagNumber(7)
  $core.bool hasAutomaticResources() => $_has(6);
  @$pb.TagNumber(7)
  void clearAutomaticResources() => clearField(7);
  @$pb.TagNumber(7)
  $4287.AutomaticResources ensureAutomaticResources() => $_ensure(6);
  ...
  @$pb.TagNumber(16)
  $4287.DedicatedResources get dedicatedResources => $_getN(11);
  @$pb.TagNumber(16)
  set dedicatedResources($4287.DedicatedResources v) { setField(16, v); }
  @$pb.TagNumber(16)
  $core.bool hasDedicatedResources() => $_has(11);
  @$pb.TagNumber(16)
  void clearDedicatedResources() => clearField(16);
  @$pb.TagNumber(16)
  $4287.DedicatedResources ensureDedicatedResources() => $_ensure(11);
}
...
class IndexPrivateEndpoints extends $pb.GeneratedMessage {
  factory IndexPrivateEndpoints({
    ...
    $core.Iterable<$4298.PscAutomatedEndpoints>? pscAutomatedEndpoints,
  }) {
    final $result = create();
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(_omitMessageNames ? '' : 'IndexPrivateEndpoints', package: const $pb.PackageName(_omitMessageNames ? '' : 'google.cloud.aiplatform.v1beta1'), createEmptyInstance: create)
    ...
    ..pc<$4298.PscAutomatedEndpoints>(3, _omitFieldNames ? '' : 'pscAutomatedEndpoints', $pb.PbFieldType.PM, subBuilder: $4298.PscAutomatedEndpoints.create)
    ..hasRequiredFields = false
  ;
  ...
  @$pb.TagNumber(3)
  $core.List<$4298.PscAutomatedEndpoints> get pscAutomatedEndpoints => $_getList(2);
}
