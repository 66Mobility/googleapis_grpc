...
class FeatureOnlineStore_Bigtable_AutoScaling extends $pb.GeneratedMessage {
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(_omitMessageNames ? '' : 'FeatureOnlineStore.Bigtable.AutoScaling', package: const $pb.PackageName(_omitMessageNames ? '' : 'google.cloud.aiplatform.v1beta1'), createEmptyInstance: create)
...
class FeatureOnlineStore_Bigtable extends $pb.GeneratedMessage {
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(_omitMessageNames ? '' : 'FeatureOnlineStore.Bigtable', package: const $pb.PackageName(_omitMessageNames ? '' : 'google.cloud.aiplatform.v1beta1'), createEmptyInstance: create)
...
class FeatureOnlineStore_Optimized extends $pb.GeneratedMessage {
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(_omitMessageNames ? '' : 'FeatureOnlineStore.Optimized', package: const $pb.PackageName(_omitMessageNames ? '' : 'google.cloud.aiplatform.v1beta1'), createEmptyInstance: create)
    ..hasRequiredFields = false
  ;
...
class FeatureOnlineStore_EmbeddingManagement extends $pb.GeneratedMessage {
  factory FeatureOnlineStore_EmbeddingManagement({
    $core.bool? enabled,
  }) {
    final $result = create();
    if (enabled != null) {
  ...
  FeatureOnlineStore_EmbeddingManagement._() : super();
  factory FeatureOnlineStore_EmbeddingManagement.fromBuffer($core.List<$core.int> i, [$pb.ExtensionRegistry r = $pb.ExtensionRegistry.EMPTY]) => create()..mergeFromBuffer(i, r);
  factory FeatureOnlineStore_EmbeddingManagement.fromJson($core.String i, [$pb.ExtensionRegistry r = $pb.ExtensionRegistry.EMPTY]) => create()..mergeFromJson(i, r);

  static final $pb.BuilderInfo _i = $pb.BuilderInfo(_omitMessageNames ? '' : 'FeatureOnlineStore.EmbeddingManagement', package: const $pb.PackageName(_omitMessageNames ? '' : 'google.cloud.aiplatform.v1beta1'), createEmptyInstance: create)
  ...
  'Use [GeneratedMessageGenericExtensions.deepCopy] instead. '
  'Will be removed in next major version')
  FeatureOnlineStore_EmbeddingManagement clone() => FeatureOnlineStore_EmbeddingManagement()..mergeFromMessage(this);
  @$core.Deprecated(
  'Using this can add significant overhead to your binary. '
  'Use [GeneratedMessageGenericExtensions.rebuild] instead. '
  'Will be removed in next major version')
  FeatureOnlineStore_EmbeddingManagement copyWith(void Function(FeatureOnlineStore_EmbeddingManagement) updates) => super.copyWith((message) => updates(message as FeatureOnlineStore_EmbeddingManagement)) as FeatureOnlineStore_EmbeddingManagement;

  $pb.BuilderInfo get info_ => _i;

  @$core.pragma('dart2js:noInline')
  static FeatureOnlineStore_EmbeddingManagement create() => FeatureOnlineStore_EmbeddingManagement._();
  FeatureOnlineStore_EmbeddingManagement createEmptyInstance() => create();
  static $pb.PbList<FeatureOnlineStore_EmbeddingManagement> createRepeated() => $pb.PbList<FeatureOnlineStore_EmbeddingManagement>();
  @$core.pragma('dart2js:noInline')
  static FeatureOnlineStore_EmbeddingManagement getDefault() => _defaultInstance ??= $pb.GeneratedMessage.$_defaultFor<FeatureOnlineStore_EmbeddingManagement>(create);
  static FeatureOnlineStore_EmbeddingManagement? _defaultInstance;
...
class FeatureOnlineStore extends $pb.GeneratedMessage {
  ...
  @$core.Deprecated('This field is deprecated.')
    ...
    if (embeddingManagement != null) {
      ...
      $result.embeddingManagement = embeddingManagement;
    }
    if (optimized != null) {
  ...
  @$core.Deprecated('This field is deprecated.')
  @$pb.TagNumber(11)
  FeatureOnlineStore_EmbeddingManagement get embeddingManagement => $_getN(8);
  @$core.Deprecated('This field is deprecated.')
  @$pb.TagNumber(11)
  set embeddingManagement(FeatureOnlineStore_EmbeddingManagement v) { setField(11, v); }
  @$core.Deprecated('This field is deprecated.')
  @$pb.TagNumber(11)
  $core.bool hasEmbeddingManagement() => $_has(8);
  @$core.Deprecated('This field is deprecated.')
  @$pb.TagNumber(11)
  void clearEmbeddingManagement() => clearField(11);
  @$core.Deprecated('This field is deprecated.')
  @$pb.TagNumber(11)
  FeatureOnlineStore_EmbeddingManagement ensureEmbeddingManagement() => $_ensure(8);
  ...
  @$pb.TagNumber(12)
  FeatureOnlineStore_Optimized get optimized => $_getN(9);
  @$pb.TagNumber(12)
  set optimized(FeatureOnlineStore_Optimized v) { setField(12, v); }
  @$pb.TagNumber(12)
  $core.bool hasOptimized() => $_has(9);
  @$pb.TagNumber(12)
  void clearOptimized() => clearField(12);
  @$pb.TagNumber(12)
  FeatureOnlineStore_Optimized ensureOptimized() => $_ensure(9);
