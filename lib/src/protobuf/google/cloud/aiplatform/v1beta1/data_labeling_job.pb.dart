...
class DataLabelingJob extends $pb.GeneratedMessage {
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(_omitMessageNames ? '' : 'DataLabelingJob', package: const $pb.PackageName(_omitMessageNames ? '' : 'google.cloud.aiplatform.v1beta1'), createEmptyInstance: create)
    ...
    ..e<$4283.JobState>(8, _omitFieldNames ? '' : 'state', $pb.PbFieldType.OE, defaultOrMaker: $4283.JobState.JOB_STATE_UNSPECIFIED, valueOf: $4283.JobState.valueOf, enumValues: $4283.JobState.values)
    ...
    ..aOM<$4281.EncryptionSpec>(20, _omitFieldNames ? '' : 'encryptionSpec', subBuilder: $4281.EncryptionSpec.create)
  ...
  @$pb.TagNumber(8)
  $4283.JobState get state => $_getN(7);
  @$pb.TagNumber(8)
  set state($4283.JobState v) { setField(8, v); }
  @$pb.TagNumber(8)
  ...
  @$pb.TagNumber(20)
  set encryptionSpec($4281.EncryptionSpec v) { setField(20, v); }
  @$pb.TagNumber(20)
