...
class FeaturestoreMonitoringConfig_SnapshotAnalysis extends $pb.GeneratedMessage {
  ...
  @$core.Deprecated('This field is deprecated.')
    ...
    if (monitoringInterval != null) {
      ...
      $result.monitoringInterval = monitoringInterval;
    }
...
class FeaturestoreMonitoringConfig_ImportFeaturesAnalysis extends $pb.GeneratedMessage {
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(_omitMessageNames ? '' : 'FeaturestoreMonitoringConfig.ImportFeaturesAnalysis', package: const $pb.PackageName(_omitMessageNames ? '' : 'google.cloud.aiplatform.v1beta1'), createEmptyInstance: create)
...
class FeaturestoreMonitoringConfig_ThresholdConfig extends $pb.GeneratedMessage {
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(_omitMessageNames ? '' : 'FeaturestoreMonitoringConfig.ThresholdConfig', package: const $pb.PackageName(_omitMessageNames ? '' : 'google.cloud.aiplatform.v1beta1'), createEmptyInstance: create)
    ..oo(0, [1])
...
class FeaturestoreMonitoringConfig extends $pb.GeneratedMessage {
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(_omitMessageNames ? '' : 'FeaturestoreMonitoringConfig', package: const $pb.PackageName(_omitMessageNames ? '' : 'google.cloud.aiplatform.v1beta1'), createEmptyInstance: create)
