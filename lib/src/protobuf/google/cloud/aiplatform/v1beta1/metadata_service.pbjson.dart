...
const CreateMetadataStoreRequest$json = {
  ...
  '2': [
    ...
    {'1': 'metadata_store', '3': 2, '4': 1, '5': 11, '6': '.google.cloud.aiplatform.v1beta1.MetadataStore', '8': {}, '10': 'metadataStore'},
...
final $typed_data.Uint8List createMetadataStoreRequestDescriptor = $convert.base64Decode(
    ...
    '9jYXRpb25zLmdvb2dsZWFwaXMuY29tL0xvY2F0aW9uUgZwYXJlbnQSWgoObWV0YWRhdGFfc3Rv'
    'cmUYAiABKAsyLi5nb29nbGUuY2xvdWQuYWlwbGF0Zm9ybS52MWJldGExLk1ldGFkYXRhU3Rvcm'
    'VCA+BBAlINbWV0YWRhdGFTdG9yZRIqChFtZXRhZGF0YV9zdG9yZV9pZBgDIAEoCVIPbWV0YWRh'
    'dGFTdG9yZUlk');
...
final $typed_data.Uint8List createMetadataStoreOperationMetadataDescriptor = $convert.base64Decode(
    'CiRDcmVhdGVNZXRhZGF0YVN0b3JlT3BlcmF0aW9uTWV0YWRhdGESZAoQZ2VuZXJpY19tZXRhZG'
...
const ListMetadataStoresResponse$json = {
  ...
  '2': [
    {'1': 'metadata_stores', '3': 1, '4': 3, '5': 11, '6': '.google.cloud.aiplatform.v1beta1.MetadataStore', '10': 'metadataStores'},
...
final $typed_data.Uint8List listMetadataStoresResponseDescriptor = $convert.base64Decode(
    'ChpMaXN0TWV0YWRhdGFTdG9yZXNSZXNwb25zZRJXCg9tZXRhZGF0YV9zdG9yZXMYASADKAsyLi'
    '5nb29nbGUuY2xvdWQuYWlwbGF0Zm9ybS52MWJldGExLk1ldGFkYXRhU3RvcmVSDm1ldGFkYXRh'
    'U3RvcmVzEiYKD25leHRfcGFnZV90b2tlbhgCIAEoCVINbmV4dFBhZ2VUb2tlbg==');
...
final $typed_data.Uint8List deleteMetadataStoreOperationMetadataDescriptor = $convert.base64Decode(
    'CiREZWxldGVNZXRhZGF0YVN0b3JlT3BlcmF0aW9uTWV0YWRhdGESZAoQZ2VuZXJpY19tZXRhZG'
    'F0YRgBIAEoCzI5Lmdvb2dsZS5jbG91ZC5haXBsYXRmb3JtLnYxYmV0YTEuR2VuZXJpY09wZXJh'
    'dGlvbk1ldGFkYXRhUg9nZW5lcmljTWV0YWRhdGE=');
...
const CreateArtifactRequest$json = {
  ...
  '2': [
    {'1': 'parent', '3': 1, '4': 1, '5': 9, '8': {}, '10': 'parent'},
    {'1': 'artifact', '3': 2, '4': 1, '5': 11, '6': '.google.cloud.aiplatform.v1beta1.Artifact', '8': {}, '10': 'artifact'},
...
final $typed_data.Uint8List createArtifactRequestDescriptor = $convert.base64Decode(
    ...
    'Zvcm0uZ29vZ2xlYXBpcy5jb20vTWV0YWRhdGFTdG9yZVIGcGFyZW50EkoKCGFydGlmYWN0GAIg'
    'ASgLMikuZ29vZ2xlLmNsb3VkLmFpcGxhdGZvcm0udjFiZXRhMS5BcnRpZmFjdEID4EECUghhcn'
    'RpZmFjdBIfCgthcnRpZmFjdF9pZBgDIAEoCVIKYXJ0aWZhY3RJZA==');
...
const ListArtifactsResponse$json = {
  ...
  '2': [
    {'1': 'artifacts', '3': 1, '4': 3, '5': 11, '6': '.google.cloud.aiplatform.v1beta1.Artifact', '10': 'artifacts'},
    {'1': 'next_page_token', '3': 2, '4': 1, '5': 9, '10': 'nextPageToken'},
  ],
};
...
final $typed_data.Uint8List listArtifactsResponseDescriptor = $convert.base64Decode(
    'ChVMaXN0QXJ0aWZhY3RzUmVzcG9uc2USRwoJYXJ0aWZhY3RzGAEgAygLMikuZ29vZ2xlLmNsb3'
    'VkLmFpcGxhdGZvcm0udjFiZXRhMS5BcnRpZmFjdFIJYXJ0aWZhY3RzEiYKD25leHRfcGFnZV90'
...
const UpdateArtifactRequest$json = {
  ...
  '2': [
    {'1': 'artifact', '3': 1, '4': 1, '5': 11, '6': '.google.cloud.aiplatform.v1beta1.Artifact', '8': {}, '10': 'artifact'},
...
final $typed_data.Uint8List updateArtifactRequestDescriptor = $convert.base64Decode(
    'ChVVcGRhdGVBcnRpZmFjdFJlcXVlc3QSSgoIYXJ0aWZhY3QYASABKAsyKS5nb29nbGUuY2xvdW'
    'QuYWlwbGF0Zm9ybS52MWJldGExLkFydGlmYWN0QgPgQQJSCGFydGlmYWN0EkAKC3VwZGF0ZV9t'
    'YXNrGAIgASgLMhouZ29vZ2xlLnByb3RvYnVmLkZpZWxkTWFza0ID4EEBUgp1cGRhdGVNYXNrEi'
    'MKDWFsbG93X21pc3NpbmcYAyABKAhSDGFsbG93TWlzc2luZw==');
...
final $typed_data.Uint8List purgeArtifactsMetadataDescriptor = $convert.base64Decode(
    'ChZQdXJnZUFydGlmYWN0c01ldGFkYXRhEmQKEGdlbmVyaWNfbWV0YWRhdGEYASABKAsyOS5nb2'
    '9nbGUuY2xvdWQuYWlwbGF0Zm9ybS52MWJldGExLkdlbmVyaWNPcGVyYXRpb25NZXRhZGF0YVIP'
...
const CreateContextRequest$json = {
  ...
  '2': [
    {'1': 'parent', '3': 1, '4': 1, '5': 9, '8': {}, '10': 'parent'},
    {'1': 'context', '3': 2, '4': 1, '5': 11, '6': '.google.cloud.aiplatform.v1beta1.Context', '8': {}, '10': 'context'},
...
final $typed_data.Uint8List createContextRequestDescriptor = $convert.base64Decode(
    ...
    '9ybS5nb29nbGVhcGlzLmNvbS9NZXRhZGF0YVN0b3JlUgZwYXJlbnQSRwoHY29udGV4dBgCIAEo'
    'CzIoLmdvb2dsZS5jbG91ZC5haXBsYXRmb3JtLnYxYmV0YTEuQ29udGV4dEID4EECUgdjb250ZX'
    'h0Eh0KCmNvbnRleHRfaWQYAyABKAlSCWNvbnRleHRJZA==');
...
const ListContextsResponse$json = {
  ...
  '2': [
    {'1': 'contexts', '3': 1, '4': 3, '5': 11, '6': '.google.cloud.aiplatform.v1beta1.Context', '10': 'contexts'},
    {'1': 'next_page_token', '3': 2, '4': 1, '5': 9, '10': 'nextPageToken'},
  ],
};
...
final $typed_data.Uint8List listContextsResponseDescriptor = $convert.base64Decode(
    ...
    '5haXBsYXRmb3JtLnYxYmV0YTEuQ29udGV4dFIIY29udGV4dHMSJgoPbmV4dF9wYWdlX3Rva2Vu'
...
const UpdateContextRequest$json = {
  ...
  '2': [
    {'1': 'context', '3': 1, '4': 1, '5': 11, '6': '.google.cloud.aiplatform.v1beta1.Context', '8': {}, '10': 'context'},
    {'1': 'update_mask', '3': 2, '4': 1, '5': 11, '6': '.google.protobuf.FieldMask', '8': {}, '10': 'updateMask'},
    {'1': 'allow_missing', '3': 3, '4': 1, '5': 8, '10': 'allowMissing'},
  ],
};
...
final $typed_data.Uint8List updateContextRequestDescriptor = $convert.base64Decode(
    ...
    'FpcGxhdGZvcm0udjFiZXRhMS5Db250ZXh0QgPgQQJSB2NvbnRleHQSQAoLdXBkYXRlX21hc2sY'
    'AiABKAsyGi5nb29nbGUucHJvdG9idWYuRmllbGRNYXNrQgPgQQFSCnVwZGF0ZU1hc2sSIwoNYW'
    'xsb3dfbWlzc2luZxgDIAEoCFIMYWxsb3dNaXNzaW5n');
...
final $typed_data.Uint8List purgeContextsMetadataDescriptor = $convert.base64Decode(
    'ChVQdXJnZUNvbnRleHRzTWV0YWRhdGESZAoQZ2VuZXJpY19tZXRhZGF0YRgBIAEoCzI5Lmdvb2'
...
const CreateExecutionRequest$json = {
  ...
  '2': [
    {'1': 'parent', '3': 1, '4': 1, '5': 9, '8': {}, '10': 'parent'},
    {'1': 'execution', '3': 2, '4': 1, '5': 11, '6': '.google.cloud.aiplatform.v1beta1.Execution', '8': {}, '10': 'execution'},
...
final $typed_data.Uint8List createExecutionRequestDescriptor = $convert.base64Decode(
    ...
    'Rmb3JtLmdvb2dsZWFwaXMuY29tL01ldGFkYXRhU3RvcmVSBnBhcmVudBJNCglleGVjdXRpb24Y'
    'AiABKAsyKi5nb29nbGUuY2xvdWQuYWlwbGF0Zm9ybS52MWJldGExLkV4ZWN1dGlvbkID4EECUg'
    'lleGVjdXRpb24SIQoMZXhlY3V0aW9uX2lkGAMgASgJUgtleGVjdXRpb25JZA==');
...
const ListExecutionsResponse$json = {
  ...
  '2': [
    {'1': 'executions', '3': 1, '4': 3, '5': 11, '6': '.google.cloud.aiplatform.v1beta1.Execution', '10': 'executions'},
    {'1': 'next_page_token', '3': 2, '4': 1, '5': 9, '10': 'nextPageToken'},
  ],
};
...
final $typed_data.Uint8List listExecutionsResponseDescriptor = $convert.base64Decode(
    'ChZMaXN0RXhlY3V0aW9uc1Jlc3BvbnNlEkoKCmV4ZWN1dGlvbnMYASADKAsyKi5nb29nbGUuY2'
    'xvdWQuYWlwbGF0Zm9ybS52MWJldGExLkV4ZWN1dGlvblIKZXhlY3V0aW9ucxImCg9uZXh0X3Bh'
...
const UpdateExecutionRequest$json = {
  ...
  '2': [
    {'1': 'execution', '3': 1, '4': 1, '5': 11, '6': '.google.cloud.aiplatform.v1beta1.Execution', '8': {}, '10': 'execution'},
    {'1': 'update_mask', '3': 2, '4': 1, '5': 11, '6': '.google.protobuf.FieldMask', '8': {}, '10': 'updateMask'},
    {'1': 'allow_missing', '3': 3, '4': 1, '5': 8, '10': 'allowMissing'},
  ],
};
...
final $typed_data.Uint8List updateExecutionRequestDescriptor = $convert.base64Decode(
    'ChZVcGRhdGVFeGVjdXRpb25SZXF1ZXN0Ek0KCWV4ZWN1dGlvbhgBIAEoCzIqLmdvb2dsZS5jbG'
    '91ZC5haXBsYXRmb3JtLnYxYmV0YTEuRXhlY3V0aW9uQgPgQQJSCWV4ZWN1dGlvbhJACgt1cGRh'
    'dGVfbWFzaxgCIAEoCzIaLmdvb2dsZS5wcm90b2J1Zi5GaWVsZE1hc2tCA+BBAVIKdXBkYXRlTW'
    'FzaxIjCg1hbGxvd19taXNzaW5nGAMgASgIUgxhbGxvd01pc3Npbmc=');
...
final $typed_data.Uint8List purgeExecutionsMetadataDescriptor = $convert.base64Decode(
    'ChdQdXJnZUV4ZWN1dGlvbnNNZXRhZGF0YRJkChBnZW5lcmljX21ldGFkYXRhGAEgASgLMjkuZ2'
...
const AddExecutionEventsRequest$json = {
  ...
  '2': [
    ...
    {'1': 'events', '3': 2, '4': 3, '5': 11, '6': '.google.cloud.aiplatform.v1beta1.Event', '10': 'events'},
  ],
};
...
final $typed_data.Uint8List addExecutionEventsRequestDescriptor = $convert.base64Decode(
    ...
    'NhaXBsYXRmb3JtLmdvb2dsZWFwaXMuY29tL0V4ZWN1dGlvblIJZXhlY3V0aW9uEj4KBmV2ZW50'
    'cxgCIAMoCzImLmdvb2dsZS5jbG91ZC5haXBsYXRmb3JtLnYxYmV0YTEuRXZlbnRSBmV2ZW50cw'
    '==');
...
const CreateMetadataSchemaRequest$json = {
  ...
  '2': [
    {'1': 'parent', '3': 1, '4': 1, '5': 9, '8': {}, '10': 'parent'},
    {'1': 'metadata_schema', '3': 2, '4': 1, '5': 11, '6': '.google.cloud.aiplatform.v1beta1.MetadataSchema', '8': {}, '10': 'metadataSchema'},
...
final $typed_data.Uint8List createMetadataSchemaRequestDescriptor = $convert.base64Decode(
    ...
    'FpcGxhdGZvcm0uZ29vZ2xlYXBpcy5jb20vTWV0YWRhdGFTdG9yZVIGcGFyZW50El0KD21ldGFk'
    'YXRhX3NjaGVtYRgCIAEoCzIvLmdvb2dsZS5jbG91ZC5haXBsYXRmb3JtLnYxYmV0YTEuTWV0YW'
    'RhdGFTY2hlbWFCA+BBAlIObWV0YWRhdGFTY2hlbWESLAoSbWV0YWRhdGFfc2NoZW1hX2lkGAMg'
    'ASgJUhBtZXRhZGF0YVNjaGVtYUlk');
...
const ListMetadataSchemasResponse$json = {
  ...
  '2': [
    {'1': 'metadata_schemas', '3': 1, '4': 3, '5': 11, '6': '.google.cloud.aiplatform.v1beta1.MetadataSchema', '10': 'metadataSchemas'},
    {'1': 'next_page_token', '3': 2, '4': 1, '5': 9, '10': 'nextPageToken'},
  ],
};
...
final $typed_data.Uint8List listMetadataSchemasResponseDescriptor = $convert.base64Decode(
    'ChtMaXN0TWV0YWRhdGFTY2hlbWFzUmVzcG9uc2USWgoQbWV0YWRhdGFfc2NoZW1hcxgBIAMoCz'
    'IvLmdvb2dsZS5jbG91ZC5haXBsYXRmb3JtLnYxYmV0YTEuTWV0YWRhdGFTY2hlbWFSD21ldGFk'
    'YXRhU2NoZW1hcxImCg9uZXh0X3BhZ2VfdG9rZW4YAiABKAlSDW5leHRQYWdlVG9rZW4=');
