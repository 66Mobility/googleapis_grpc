...
import 'feature_monitoring_stats.pb.dart' as $4282;
...
class ModelDeploymentMonitoringJob_LatestMonitoringPipelineMetadata extends $pb.GeneratedMessage {
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(_omitMessageNames ? '' : 'ModelDeploymentMonitoringJob.LatestMonitoringPipelineMetadata', package: const $pb.PackageName(_omitMessageNames ? '' : 'google.cloud.aiplatform.v1beta1'), createEmptyInstance: create)
...
class ModelDeploymentMonitoringJob extends $pb.GeneratedMessage {
  factory ModelDeploymentMonitoringJob({
    ...
    $4280.SamplingStrategy? loggingSamplingStrategy,
    ...
    $4280.ModelMonitoringAlertConfig? modelMonitoringAlertConfig,
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(_omitMessageNames ? '' : 'ModelDeploymentMonitoringJob', package: const $pb.PackageName(_omitMessageNames ? '' : 'google.cloud.aiplatform.v1beta1'), createEmptyInstance: create)
    ..aOS(1, _omitFieldNames ? '' : 'name')
    ..aOS(2, _omitFieldNames ? '' : 'displayName')
    ..aOS(3, _omitFieldNames ? '' : 'endpoint')
    ..e<$4283.JobState>(4, _omitFieldNames ? '' : 'state', $pb.PbFieldType.OE, defaultOrMaker: $4283.JobState.JOB_STATE_UNSPECIFIED, valueOf: $4283.JobState.valueOf, enumValues: $4283.JobState.values)
    ...
    ..aOM<$4280.SamplingStrategy>(8, _omitFieldNames ? '' : 'loggingSamplingStrategy', subBuilder: $4280.SamplingStrategy.create)
    ...
    ..m<$core.String, $core.String>(11, _omitFieldNames ? '' : 'labels', entryClassName: 'ModelDeploymentMonitoringJob.LabelsEntry', keyFieldType: $pb.PbFieldType.OS, valueFieldType: $pb.PbFieldType.OS, packageName: const $pb.PackageName('google.cloud.aiplatform.v1beta1'))
    ...
    ..aOM<$4280.ModelMonitoringAlertConfig>(15, _omitFieldNames ? '' : 'modelMonitoringAlertConfig', subBuilder: $4280.ModelMonitoringAlertConfig.create)
    ...
    ..aOM<$4277.GcsDestination>(20, _omitFieldNames ? '' : 'statsAnomaliesBaseDirectory', subBuilder: $4277.GcsDestination.create)
    ..aOM<$4281.EncryptionSpec>(21, _omitFieldNames ? '' : 'encryptionSpec', subBuilder: $4281.EncryptionSpec.create)
  ...
  @$pb.TagNumber(4)
  $4283.JobState get state => $_getN(3);
  @$pb.TagNumber(4)
  set state($4283.JobState v) { setField(4, v); }
  @$pb.TagNumber(4)
  ...
  @$pb.TagNumber(8)
  $4280.SamplingStrategy get loggingSamplingStrategy => $_getN(7);
  @$pb.TagNumber(8)
  set loggingSamplingStrategy($4280.SamplingStrategy v) { setField(8, v); }
  @$pb.TagNumber(8)
  $core.bool hasLoggingSamplingStrategy() => $_has(7);
  @$pb.TagNumber(8)
  void clearLoggingSamplingStrategy() => clearField(8);
  @$pb.TagNumber(8)
  $4280.SamplingStrategy ensureLoggingSamplingStrategy() => $_ensure(7);
  ...
  @$pb.TagNumber(15)
  $4280.ModelMonitoringAlertConfig get modelMonitoringAlertConfig => $_getN(14);
  @$pb.TagNumber(15)
  set modelMonitoringAlertConfig($4280.ModelMonitoringAlertConfig v) { setField(15, v); }
  @$pb.TagNumber(15)
  $core.bool hasModelMonitoringAlertConfig() => $_has(14);
  @$pb.TagNumber(15)
  void clearModelMonitoringAlertConfig() => clearField(15);
  @$pb.TagNumber(15)
  $4280.ModelMonitoringAlertConfig ensureModelMonitoringAlertConfig() => $_ensure(14);
  ...
  @$pb.TagNumber(20)
  $4277.GcsDestination get statsAnomaliesBaseDirectory => $_getN(18);
  @$pb.TagNumber(20)
  set statsAnomaliesBaseDirectory($4277.GcsDestination v) { setField(20, v); }
  @$pb.TagNumber(20)
  $core.bool hasStatsAnomaliesBaseDirectory() => $_has(18);
  @$pb.TagNumber(20)
  void clearStatsAnomaliesBaseDirectory() => clearField(20);
  @$pb.TagNumber(20)
  $4277.GcsDestination ensureStatsAnomaliesBaseDirectory() => $_ensure(18);
  ...
  @$pb.TagNumber(21)
  $4281.EncryptionSpec get encryptionSpec => $_getN(19);
  @$pb.TagNumber(21)
  set encryptionSpec($4281.EncryptionSpec v) { setField(21, v); }
  @$pb.TagNumber(21)
  $core.bool hasEncryptionSpec() => $_has(19);
  @$pb.TagNumber(21)
  void clearEncryptionSpec() => clearField(21);
  @$pb.TagNumber(21)
  $4281.EncryptionSpec ensureEncryptionSpec() => $_ensure(19);
...
class ModelDeploymentMonitoringBigQueryTable extends $pb.GeneratedMessage {
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(_omitMessageNames ? '' : 'ModelDeploymentMonitoringBigQueryTable', package: const $pb.PackageName(_omitMessageNames ? '' : 'google.cloud.aiplatform.v1beta1'), createEmptyInstance: create)
...
class ModelDeploymentMonitoringObjectiveConfig extends $pb.GeneratedMessage {
  factory ModelDeploymentMonitoringObjectiveConfig({
    ...
    $4280.ModelMonitoringObjectiveConfig? objectiveConfig,
  }) {
    final $result = create();
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(_omitMessageNames ? '' : 'ModelDeploymentMonitoringObjectiveConfig', package: const $pb.PackageName(_omitMessageNames ? '' : 'google.cloud.aiplatform.v1beta1'), createEmptyInstance: create)
    ..aOS(1, _omitFieldNames ? '' : 'deployedModelId')
    ..aOM<$4280.ModelMonitoringObjectiveConfig>(2, _omitFieldNames ? '' : 'objectiveConfig', subBuilder: $4280.ModelMonitoringObjectiveConfig.create)
    ..hasRequiredFields = false
  ;
  ...
  @$pb.TagNumber(2)
  $4280.ModelMonitoringObjectiveConfig get objectiveConfig => $_getN(1);
  @$pb.TagNumber(2)
  set objectiveConfig($4280.ModelMonitoringObjectiveConfig v) { setField(2, v); }
  @$pb.TagNumber(2)
  $core.bool hasObjectiveConfig() => $_has(1);
  @$pb.TagNumber(2)
  void clearObjectiveConfig() => clearField(2);
  @$pb.TagNumber(2)
  $4280.ModelMonitoringObjectiveConfig ensureObjectiveConfig() => $_ensure(1);
}
...
class ModelDeploymentMonitoringScheduleConfig extends $pb.GeneratedMessage {
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(_omitMessageNames ? '' : 'ModelDeploymentMonitoringScheduleConfig', package: const $pb.PackageName(_omitMessageNames ? '' : 'google.cloud.aiplatform.v1beta1'), createEmptyInstance: create)
...
class ModelMonitoringStatsAnomalies_FeatureHistoricStatsAnomalies extends $pb.GeneratedMessage {
  factory ModelMonitoringStatsAnomalies_FeatureHistoricStatsAnomalies({
    ...
    $4280.ThresholdConfig? threshold,
    $4282.FeatureStatsAnomaly? trainingStats,
    $core.Iterable<$4282.FeatureStatsAnomaly>? predictionStats,
  }) {
    final $result = create();
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(_omitMessageNames ? '' : 'ModelMonitoringStatsAnomalies.FeatureHistoricStatsAnomalies', package: const $pb.PackageName(_omitMessageNames ? '' : 'google.cloud.aiplatform.v1beta1'), createEmptyInstance: create)
    ..aOS(1, _omitFieldNames ? '' : 'featureDisplayName')
    ..aOM<$4280.ThresholdConfig>(3, _omitFieldNames ? '' : 'threshold', subBuilder: $4280.ThresholdConfig.create)
    ..aOM<$4282.FeatureStatsAnomaly>(4, _omitFieldNames ? '' : 'trainingStats', subBuilder: $4282.FeatureStatsAnomaly.create)
    ..pc<$4282.FeatureStatsAnomaly>(5, _omitFieldNames ? '' : 'predictionStats', $pb.PbFieldType.PM, subBuilder: $4282.FeatureStatsAnomaly.create)
    ..hasRequiredFields = false
  ;
  ...
  @$pb.TagNumber(3)
  $4280.ThresholdConfig get threshold => $_getN(1);
  @$pb.TagNumber(3)
  set threshold($4280.ThresholdConfig v) { setField(3, v); }
  @$pb.TagNumber(3)
  $core.bool hasThreshold() => $_has(1);
  @$pb.TagNumber(3)
  void clearThreshold() => clearField(3);
  @$pb.TagNumber(3)
  $4280.ThresholdConfig ensureThreshold() => $_ensure(1);

  /// Stats calculated for the Training Dataset.
  @$pb.TagNumber(4)
  $4282.FeatureStatsAnomaly get trainingStats => $_getN(2);
  @$pb.TagNumber(4)
  set trainingStats($4282.FeatureStatsAnomaly v) { setField(4, v); }
  @$pb.TagNumber(4)
  $core.bool hasTrainingStats() => $_has(2);
  @$pb.TagNumber(4)
  void clearTrainingStats() => clearField(4);
  @$pb.TagNumber(4)
  $4282.FeatureStatsAnomaly ensureTrainingStats() => $_ensure(2);

  /// A list of historical stats generated by different time window's
  /// Prediction Dataset.
  @$pb.TagNumber(5)
  $core.List<$4282.FeatureStatsAnomaly> get predictionStats => $_getList(3);
}
...
class ModelMonitoringStatsAnomalies extends $pb.GeneratedMessage {
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(_omitMessageNames ? '' : 'ModelMonitoringStatsAnomalies', package: const $pb.PackageName(_omitMessageNames ? '' : 'google.cloud.aiplatform.v1beta1'), createEmptyInstance: create)
