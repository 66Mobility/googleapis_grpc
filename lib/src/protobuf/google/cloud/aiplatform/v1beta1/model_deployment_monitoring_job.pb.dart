...
class ModelDeploymentMonitoringJob extends $pb.GeneratedMessage {
  factory ModelDeploymentMonitoringJob({
    ...
    $4281.SamplingStrategy? loggingSamplingStrategy,
    ...
    $4281.ModelMonitoringAlertConfig? modelMonitoringAlertConfig,
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(_omitMessageNames ? '' : 'ModelDeploymentMonitoringJob', package: const $pb.PackageName(_omitMessageNames ? '' : 'google.cloud.aiplatform.v1beta1'), createEmptyInstance: create)
    ...
    ..e<$4284.JobState>(4, _omitFieldNames ? '' : 'state', $pb.PbFieldType.OE, defaultOrMaker: $4284.JobState.JOB_STATE_UNSPECIFIED, valueOf: $4284.JobState.valueOf, enumValues: $4284.JobState.values)
    ...
    ..aOM<$4281.SamplingStrategy>(8, _omitFieldNames ? '' : 'loggingSamplingStrategy', subBuilder: $4281.SamplingStrategy.create)
    ...
    ..aOM<$4281.ModelMonitoringAlertConfig>(15, _omitFieldNames ? '' : 'modelMonitoringAlertConfig', subBuilder: $4281.ModelMonitoringAlertConfig.create)
    ...
    ..aOM<$4278.GcsDestination>(20, _omitFieldNames ? '' : 'statsAnomaliesBaseDirectory', subBuilder: $4278.GcsDestination.create)
    ..aOM<$4282.EncryptionSpec>(21, _omitFieldNames ? '' : 'encryptionSpec', subBuilder: $4282.EncryptionSpec.create)
  ...
  @$pb.TagNumber(4)
  $4284.JobState get state => $_getN(3);
  @$pb.TagNumber(4)
  set state($4284.JobState v) { setField(4, v); }
  @$pb.TagNumber(4)
  ...
  @$pb.TagNumber(8)
  $4281.SamplingStrategy get loggingSamplingStrategy => $_getN(7);
  @$pb.TagNumber(8)
  set loggingSamplingStrategy($4281.SamplingStrategy v) { setField(8, v); }
  @$pb.TagNumber(8)
  $core.bool hasLoggingSamplingStrategy() => $_has(7);
  @$pb.TagNumber(8)
  void clearLoggingSamplingStrategy() => clearField(8);
  @$pb.TagNumber(8)
  $4281.SamplingStrategy ensureLoggingSamplingStrategy() => $_ensure(7);
  ...
  @$pb.TagNumber(15)
  $4281.ModelMonitoringAlertConfig get modelMonitoringAlertConfig => $_getN(14);
  @$pb.TagNumber(15)
  set modelMonitoringAlertConfig($4281.ModelMonitoringAlertConfig v) { setField(15, v); }
  @$pb.TagNumber(15)
  $core.bool hasModelMonitoringAlertConfig() => $_has(14);
  @$pb.TagNumber(15)
  void clearModelMonitoringAlertConfig() => clearField(15);
  @$pb.TagNumber(15)
  $4281.ModelMonitoringAlertConfig ensureModelMonitoringAlertConfig() => $_ensure(14);
  ...
  @$pb.TagNumber(20)
  $4278.GcsDestination get statsAnomaliesBaseDirectory => $_getN(18);
  @$pb.TagNumber(20)
  set statsAnomaliesBaseDirectory($4278.GcsDestination v) { setField(20, v); }
  @$pb.TagNumber(20)
  $core.bool hasStatsAnomaliesBaseDirectory() => $_has(18);
  @$pb.TagNumber(20)
  void clearStatsAnomaliesBaseDirectory() => clearField(20);
  @$pb.TagNumber(20)
  $4278.GcsDestination ensureStatsAnomaliesBaseDirectory() => $_ensure(18);
  ...
  @$pb.TagNumber(21)
  $4282.EncryptionSpec get encryptionSpec => $_getN(19);
  @$pb.TagNumber(21)
  set encryptionSpec($4282.EncryptionSpec v) { setField(21, v); }
  @$pb.TagNumber(21)
  $core.bool hasEncryptionSpec() => $_has(19);
  @$pb.TagNumber(21)
  void clearEncryptionSpec() => clearField(21);
  @$pb.TagNumber(21)
  $4282.EncryptionSpec ensureEncryptionSpec() => $_ensure(19);
...
class ModelDeploymentMonitoringObjectiveConfig extends $pb.GeneratedMessage {
  factory ModelDeploymentMonitoringObjectiveConfig({
    ...
    $4281.ModelMonitoringObjectiveConfig? objectiveConfig,
  }) {
    final $result = create();
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(_omitMessageNames ? '' : 'ModelDeploymentMonitoringObjectiveConfig', package: const $pb.PackageName(_omitMessageNames ? '' : 'google.cloud.aiplatform.v1beta1'), createEmptyInstance: create)
    ...
    ..aOM<$4281.ModelMonitoringObjectiveConfig>(2, _omitFieldNames ? '' : 'objectiveConfig', subBuilder: $4281.ModelMonitoringObjectiveConfig.create)
    ..hasRequiredFields = false
  ;
  ...
  @$pb.TagNumber(2)
  $4281.ModelMonitoringObjectiveConfig get objectiveConfig => $_getN(1);
  @$pb.TagNumber(2)
  set objectiveConfig($4281.ModelMonitoringObjectiveConfig v) { setField(2, v); }
  @$pb.TagNumber(2)
  $core.bool hasObjectiveConfig() => $_has(1);
  @$pb.TagNumber(2)
  void clearObjectiveConfig() => clearField(2);
  @$pb.TagNumber(2)
  $4281.ModelMonitoringObjectiveConfig ensureObjectiveConfig() => $_ensure(1);
}
...
class ModelMonitoringStatsAnomalies_FeatureHistoricStatsAnomalies extends $pb.GeneratedMessage {
  factory ModelMonitoringStatsAnomalies_FeatureHistoricStatsAnomalies({
    ...
    $4281.ThresholdConfig? threshold,
    $4283.FeatureStatsAnomaly? trainingStats,
    $core.Iterable<$4283.FeatureStatsAnomaly>? predictionStats,
  }) {
    final $result = create();
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(_omitMessageNames ? '' : 'ModelMonitoringStatsAnomalies.FeatureHistoricStatsAnomalies', package: const $pb.PackageName(_omitMessageNames ? '' : 'google.cloud.aiplatform.v1beta1'), createEmptyInstance: create)
    ...
    ..aOM<$4281.ThresholdConfig>(3, _omitFieldNames ? '' : 'threshold', subBuilder: $4281.ThresholdConfig.create)
    ..aOM<$4283.FeatureStatsAnomaly>(4, _omitFieldNames ? '' : 'trainingStats', subBuilder: $4283.FeatureStatsAnomaly.create)
    ..pc<$4283.FeatureStatsAnomaly>(5, _omitFieldNames ? '' : 'predictionStats', $pb.PbFieldType.PM, subBuilder: $4283.FeatureStatsAnomaly.create)
    ..hasRequiredFields = false
  ;
  ...
  @$pb.TagNumber(3)
  $4281.ThresholdConfig get threshold => $_getN(1);
  @$pb.TagNumber(3)
  set threshold($4281.ThresholdConfig v) { setField(3, v); }
  @$pb.TagNumber(3)
  $core.bool hasThreshold() => $_has(1);
  @$pb.TagNumber(3)
  void clearThreshold() => clearField(3);
  @$pb.TagNumber(3)
  $4281.ThresholdConfig ensureThreshold() => $_ensure(1);

  /// Stats calculated for the Training Dataset.
  @$pb.TagNumber(4)
  $4283.FeatureStatsAnomaly get trainingStats => $_getN(2);
  @$pb.TagNumber(4)
  set trainingStats($4283.FeatureStatsAnomaly v) { setField(4, v); }
  @$pb.TagNumber(4)
  $core.bool hasTrainingStats() => $_has(2);
  @$pb.TagNumber(4)
  void clearTrainingStats() => clearField(4);
  @$pb.TagNumber(4)
  $4283.FeatureStatsAnomaly ensureTrainingStats() => $_ensure(2);

  /// A list of historical stats generated by different time window's
  /// Prediction Dataset.
  @$pb.TagNumber(5)
  $core.List<$4283.FeatureStatsAnomaly> get predictionStats => $_getList(3);
}
