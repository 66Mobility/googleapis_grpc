...
class PrivateServiceConnectConfig extends $pb.GeneratedMessage {
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(_omitMessageNames ? '' : 'PrivateServiceConnectConfig', package: const $pb.PackageName(_omitMessageNames ? '' : 'google.cloud.aiplatform.v1beta1'), createEmptyInstance: create)
...
class PscAutomatedEndpoints extends $pb.GeneratedMessage {
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(_omitMessageNames ? '' : 'PscAutomatedEndpoints', package: const $pb.PackageName(_omitMessageNames ? '' : 'google.cloud.aiplatform.v1beta1'), createEmptyInstance: create)
...
class PscInterfaceConfig extends $pb.GeneratedMessage {
  factory PscInterfaceConfig({
  ...
  PscInterfaceConfig._() : super();
  factory PscInterfaceConfig.fromBuffer($core.List<$core.int> i, [$pb.ExtensionRegistry r = $pb.ExtensionRegistry.EMPTY]) => create()..mergeFromBuffer(i, r);
  factory PscInterfaceConfig.fromJson($core.String i, [$pb.ExtensionRegistry r = $pb.ExtensionRegistry.EMPTY]) => create()..mergeFromJson(i, r);

  static final $pb.BuilderInfo _i = $pb.BuilderInfo(_omitMessageNames ? '' : 'PscInterfaceConfig', package: const $pb.PackageName(_omitMessageNames ? '' : 'google.cloud.aiplatform.v1beta1'), createEmptyInstance: create)
  ...
  'Use [GeneratedMessageGenericExtensions.deepCopy] instead. '
  'Will be removed in next major version')
  PscInterfaceConfig clone() => PscInterfaceConfig()..mergeFromMessage(this);
  @$core.Deprecated(
  'Using this can add significant overhead to your binary. '
  'Use [GeneratedMessageGenericExtensions.rebuild] instead. '
  'Will be removed in next major version')
  PscInterfaceConfig copyWith(void Function(PscInterfaceConfig) updates) => super.copyWith((message) => updates(message as PscInterfaceConfig)) as PscInterfaceConfig;

  $pb.BuilderInfo get info_ => _i;

  @$core.pragma('dart2js:noInline')
  static PscInterfaceConfig create() => PscInterfaceConfig._();
  PscInterfaceConfig createEmptyInstance() => create();
  static $pb.PbList<PscInterfaceConfig> createRepeated() => $pb.PbList<PscInterfaceConfig>();
  @$core.pragma('dart2js:noInline')
  static PscInterfaceConfig getDefault() => _defaultInstance ??= $pb.GeneratedMessage.$_defaultFor<PscInterfaceConfig>(create);
  static PscInterfaceConfig? _defaultInstance;
  ...
  @$pb.TagNumber(1)
  set networkAttachment($core.String v) { $_setString(0, v); }
  @$pb.TagNumber(1)
