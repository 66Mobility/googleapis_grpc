...
class CreateSpecialistPoolRequest extends $pb.GeneratedMessage {
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(_omitMessageNames ? '' : 'CreateSpecialistPoolRequest', package: const $pb.PackageName(_omitMessageNames ? '' : 'google.cloud.aiplatform.v1beta1'), createEmptyInstance: create)
    ..aOS(1, _omitFieldNames ? '' : 'parent')
    ..aOM<$627.SpecialistPool>(2, _omitFieldNames ? '' : 'specialistPool', subBuilder: $627.SpecialistPool.create)
  ...
  @$pb.TagNumber(2)
  $627.SpecialistPool get specialistPool => $_getN(1);
  @$pb.TagNumber(2)
  set specialistPool($627.SpecialistPool v) { setField(2, v); }
  @$pb.TagNumber(2)
  $core.bool hasSpecialistPool() => $_has(1);
  @$pb.TagNumber(2)
  void clearSpecialistPool() => clearField(2);
  @$pb.TagNumber(2)
  $627.SpecialistPool ensureSpecialistPool() => $_ensure(1);
}
...
class GetSpecialistPoolRequest extends $pb.GeneratedMessage {
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(_omitMessageNames ? '' : 'GetSpecialistPoolRequest', package: const $pb.PackageName(_omitMessageNames ? '' : 'google.cloud.aiplatform.v1beta1'), createEmptyInstance: create)
...
class ListSpecialistPoolsRequest extends $pb.GeneratedMessage {
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(_omitMessageNames ? '' : 'ListSpecialistPoolsRequest', package: const $pb.PackageName(_omitMessageNames ? '' : 'google.cloud.aiplatform.v1beta1'), createEmptyInstance: create)
    ..aOS(1, _omitFieldNames ? '' : 'parent')
...
class ListSpecialistPoolsResponse extends $pb.GeneratedMessage {
  factory ListSpecialistPoolsResponse({
    $core.Iterable<$627.SpecialistPool>? specialistPools,
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(_omitMessageNames ? '' : 'ListSpecialistPoolsResponse', package: const $pb.PackageName(_omitMessageNames ? '' : 'google.cloud.aiplatform.v1beta1'), createEmptyInstance: create)
    ..pc<$627.SpecialistPool>(1, _omitFieldNames ? '' : 'specialistPools', $pb.PbFieldType.PM, subBuilder: $627.SpecialistPool.create)
  ...
  @$pb.TagNumber(1)
  $core.List<$627.SpecialistPool> get specialistPools => $_getList(0);
...
class DeleteSpecialistPoolRequest extends $pb.GeneratedMessage {
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(_omitMessageNames ? '' : 'DeleteSpecialistPoolRequest', package: const $pb.PackageName(_omitMessageNames ? '' : 'google.cloud.aiplatform.v1beta1'), createEmptyInstance: create)
    ..aOS(1, _omitFieldNames ? '' : 'name')
...
class UpdateSpecialistPoolRequest extends $pb.GeneratedMessage {
  ...
  @$pb.TagNumber(1)
  $627.SpecialistPool get specialistPool => $_getN(0);
  @$pb.TagNumber(1)
  set specialistPool($627.SpecialistPool v) { setField(1, v); }
  @$pb.TagNumber(1)
  $core.bool hasSpecialistPool() => $_has(0);
  @$pb.TagNumber(1)
  void clearSpecialistPool() => clearField(1);
  @$pb.TagNumber(1)
  $627.SpecialistPool ensureSpecialistPool() => $_ensure(0);
