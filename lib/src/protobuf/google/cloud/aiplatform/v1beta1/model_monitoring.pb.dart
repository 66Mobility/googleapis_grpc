...
class ModelMonitoringConfig extends $pb.GeneratedMessage {
  factory ModelMonitoringConfig({
    ...
    if (objectiveConfigs != null) {
      $result.objectiveConfigs.addAll(objectiveConfigs);
    }
  ...
  ModelMonitoringConfig._() : super();
  factory ModelMonitoringConfig.fromBuffer($core.List<$core.int> i, [$pb.ExtensionRegistry r = $pb.ExtensionRegistry.EMPTY]) => create()..mergeFromBuffer(i, r);
  factory ModelMonitoringConfig.fromJson($core.String i, [$pb.ExtensionRegistry r = $pb.ExtensionRegistry.EMPTY]) => create()..mergeFromJson(i, r);

  static final $pb.BuilderInfo _i = $pb.BuilderInfo(_omitMessageNames ? '' : 'ModelMonitoringConfig', package: const $pb.PackageName(_omitMessageNames ? '' : 'google.cloud.aiplatform.v1beta1'), createEmptyInstance: create)
  ...
  ModelMonitoringConfig clone() => ModelMonitoringConfig()..mergeFromMessage(this);
  @$core.Deprecated(
  'Using this can add significant overhead to your binary. '
  'Use [GeneratedMessageGenericExtensions.rebuild] instead. '
  'Will be removed in next major version')
  ModelMonitoringConfig copyWith(void Function(ModelMonitoringConfig) updates) => super.copyWith((message) => updates(message as ModelMonitoringConfig)) as ModelMonitoringConfig;

  $pb.BuilderInfo get info_ => _i;

  @$core.pragma('dart2js:noInline')
  static ModelMonitoringConfig create() => ModelMonitoringConfig._();
  ModelMonitoringConfig createEmptyInstance() => create();
  static $pb.PbList<ModelMonitoringConfig> createRepeated() => $pb.PbList<ModelMonitoringConfig>();
  @$core.pragma('dart2js:noInline')
  static ModelMonitoringConfig getDefault() => _defaultInstance ??= $pb.GeneratedMessage.$_defaultFor<ModelMonitoringConfig>(create);
  static ModelMonitoringConfig? _defaultInstance;

  /// Model monitoring alert config.
  @$pb.TagNumber(2)
  ModelMonitoringAlertConfig get alertConfig => $_getN(0);
  @$pb.TagNumber(2)
  set alertConfig(ModelMonitoringAlertConfig v) { setField(2, v); }
  @$pb.TagNumber(2)
  $core.bool hasAlertConfig() => $_has(0);
  @$pb.TagNumber(2)
  void clearAlertConfig() => clearField(2);
  @$pb.TagNumber(2)
  ModelMonitoringAlertConfig ensureAlertConfig() => $_ensure(0);

  /// Model monitoring objective config.
  @$pb.TagNumber(3)
  $core.List<ModelMonitoringObjectiveConfig> get objectiveConfigs => $_getList(1);
  ...
  @$pb.TagNumber(4)
  $core.String get analysisInstanceSchemaUri => $_getSZ(2);
  @$pb.TagNumber(4)
  set analysisInstanceSchemaUri($core.String v) { $_setString(2, v); }
  @$pb.TagNumber(4)
  $core.bool hasAnalysisInstanceSchemaUri() => $_has(2);
  @$pb.TagNumber(4)
  void clearAnalysisInstanceSchemaUri() => clearField(4);
...
class ModelMonitoringObjectiveConfig_TrainingDataset extends $pb.GeneratedMessage {
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(_omitMessageNames ? '' : 'ModelMonitoringObjectiveConfig.TrainingDataset', package: const $pb.PackageName(_omitMessageNames ? '' : 'google.cloud.aiplatform.v1beta1'), createEmptyInstance: create)
    ..oo(0, [3, 4, 5])
...
class ModelMonitoringObjectiveConfig_TrainingPredictionSkewDetectionConfig extends $pb.GeneratedMessage {
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(_omitMessageNames ? '' : 'ModelMonitoringObjectiveConfig.TrainingPredictionSkewDetectionConfig', package: const $pb.PackageName(_omitMessageNames ? '' : 'google.cloud.aiplatform.v1beta1'), createEmptyInstance: create)
    ..m<$core.String, ThresholdConfig>(1, _omitFieldNames ? '' : 'skewThresholds', entryClassName: 'ModelMonitoringObjectiveConfig.TrainingPredictionSkewDetectionConfig.SkewThresholdsEntry', keyFieldType: $pb.PbFieldType.OS, valueFieldType: $pb.PbFieldType.OM, valueCreator: ThresholdConfig.create, valueDefaultOrMaker: ThresholdConfig.getDefault, packageName: const $pb.PackageName('google.cloud.aiplatform.v1beta1'))
...
class ModelMonitoringObjectiveConfig_PredictionDriftDetectionConfig extends $pb.GeneratedMessage {
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(_omitMessageNames ? '' : 'ModelMonitoringObjectiveConfig.PredictionDriftDetectionConfig', package: const $pb.PackageName(_omitMessageNames ? '' : 'google.cloud.aiplatform.v1beta1'), createEmptyInstance: create)
...
class ModelMonitoringObjectiveConfig_ExplanationConfig extends $pb.GeneratedMessage {
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(_omitMessageNames ? '' : 'ModelMonitoringObjectiveConfig.ExplanationConfig', package: const $pb.PackageName(_omitMessageNames ? '' : 'google.cloud.aiplatform.v1beta1'), createEmptyInstance: create)
...
class ModelMonitoringObjectiveConfig extends $pb.GeneratedMessage {
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(_omitMessageNames ? '' : 'ModelMonitoringObjectiveConfig', package: const $pb.PackageName(_omitMessageNames ? '' : 'google.cloud.aiplatform.v1beta1'), createEmptyInstance: create)
...
class ModelMonitoringAlertConfig_EmailAlertConfig extends $pb.GeneratedMessage {
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(_omitMessageNames ? '' : 'ModelMonitoringAlertConfig.EmailAlertConfig', package: const $pb.PackageName(_omitMessageNames ? '' : 'google.cloud.aiplatform.v1beta1'), createEmptyInstance: create)
...
class ModelMonitoringAlertConfig extends $pb.GeneratedMessage {
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(_omitMessageNames ? '' : 'ModelMonitoringAlertConfig', package: const $pb.PackageName(_omitMessageNames ? '' : 'google.cloud.aiplatform.v1beta1'), createEmptyInstance: create)
    ..oo(0, [1])
...
class ThresholdConfig extends $pb.GeneratedMessage {
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(_omitMessageNames ? '' : 'ThresholdConfig', package: const $pb.PackageName(_omitMessageNames ? '' : 'google.cloud.aiplatform.v1beta1'), createEmptyInstance: create)
    ..oo(0, [1])
...
class SamplingStrategy_RandomSampleConfig extends $pb.GeneratedMessage {
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(_omitMessageNames ? '' : 'SamplingStrategy.RandomSampleConfig', package: const $pb.PackageName(_omitMessageNames ? '' : 'google.cloud.aiplatform.v1beta1'), createEmptyInstance: create)
...
class SamplingStrategy extends $pb.GeneratedMessage {
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(_omitMessageNames ? '' : 'SamplingStrategy', package: const $pb.PackageName(_omitMessageNames ? '' : 'google.cloud.aiplatform.v1beta1'), createEmptyInstance: create)
