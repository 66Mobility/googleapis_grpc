...
class Feature extends $pb.GeneratedMessage {
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(_omitMessageNames ? '' : 'Feature', package: const $pb.PackageName(_omitMessageNames ? '' : 'google.cloud.aiplatform.v1'), createEmptyInstance: create)
  ...
  @$pb.TagNumber(106)
  $core.String get versionColumnName => $_getSZ(9);
  @$pb.TagNumber(106)
  set versionColumnName($core.String v) { $_setString(9, v); }
  @$pb.TagNumber(106)
  $core.bool hasVersionColumnName() => $_has(9);
  @$pb.TagNumber(106)
  ...
  @$pb.TagNumber(107)
  $core.String get pointOfContact => $_getSZ(10);
  @$pb.TagNumber(107)
  set pointOfContact($core.String v) { $_setString(10, v); }
  @$pb.TagNumber(107)
  $core.bool hasPointOfContact() => $_has(10);
  @$pb.TagNumber(107)
