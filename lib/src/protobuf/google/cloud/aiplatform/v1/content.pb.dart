...
class Part extends $pb.GeneratedMessage {
  factory Part({
    ...
    $4249.FunctionCall? functionCall,
    $4249.FunctionResponse? functionResponse,
  }) {
    final $result = create();
    if (text != null) {
      $result.text = text;
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(_omitMessageNames ? '' : 'Part', package: const $pb.PackageName(_omitMessageNames ? '' : 'google.cloud.aiplatform.v1'), createEmptyInstance: create)
    ...
    ..aOM<$4249.FunctionCall>(5, _omitFieldNames ? '' : 'functionCall', subBuilder: $4249.FunctionCall.create)
    ..aOM<$4249.FunctionResponse>(6, _omitFieldNames ? '' : 'functionResponse', subBuilder: $4249.FunctionResponse.create)
    ..hasRequiredFields = false
  ;
  ...
  @$pb.TagNumber(5)
  $4249.FunctionCall get functionCall => $_getN(4);
  @$pb.TagNumber(5)
  set functionCall($4249.FunctionCall v) { setField(5, v); }
  @$pb.TagNumber(5)
  $core.bool hasFunctionCall() => $_has(4);
  @$pb.TagNumber(5)
  void clearFunctionCall() => clearField(5);
  @$pb.TagNumber(5)
  $4249.FunctionCall ensureFunctionCall() => $_ensure(4);
  ...
  /// the model.
  @$pb.TagNumber(6)
  $4249.FunctionResponse get functionResponse => $_getN(5);
  @$pb.TagNumber(6)
  set functionResponse($4249.FunctionResponse v) { setField(6, v); }
  @$pb.TagNumber(6)
  $core.bool hasFunctionResponse() => $_has(5);
  @$pb.TagNumber(6)
  void clearFunctionResponse() => clearField(6);
  @$pb.TagNumber(6)
  $4249.FunctionResponse ensureFunctionResponse() => $_ensure(5);
}
...
class GenerationConfig extends $pb.GeneratedMessage {
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(_omitMessageNames ? '' : 'GenerationConfig', package: const $pb.PackageName(_omitMessageNames ? '' : 'google.cloud.aiplatform.v1'), createEmptyInstance: create)
    ...
    ..aOM<$4248.Schema>(16, _omitFieldNames ? '' : 'responseSchema', subBuilder: $4248.Schema.create)
  ...
  @$pb.TagNumber(16)
  $4248.Schema get responseSchema => $_getN(10);
  @$pb.TagNumber(16)
  set responseSchema($4248.Schema v) { setField(16, v); }
  @$pb.TagNumber(16)
  $core.bool hasResponseSchema() => $_has(10);
  @$pb.TagNumber(16)
  void clearResponseSchema() => clearField(16);
  @$pb.TagNumber(16)
  $4248.Schema ensureResponseSchema() => $_ensure(10);
