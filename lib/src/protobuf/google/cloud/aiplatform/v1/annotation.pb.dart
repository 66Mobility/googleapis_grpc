...
import 'user_action_reference.pb.dart' as $4234;
...
class Annotation extends $pb.GeneratedMessage {
  factory Annotation({
    ...
    $4234.UserActionReference? annotationSource,
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(_omitMessageNames ? '' : 'Annotation', package: const $pb.PackageName(_omitMessageNames ? '' : 'google.cloud.aiplatform.v1'), createEmptyInstance: create)
    ...
    ..aOM<$4234.UserActionReference>(5, _omitFieldNames ? '' : 'annotationSource', subBuilder: $4234.UserActionReference.create)
  ...
  @$pb.TagNumber(5)
  $4234.UserActionReference get annotationSource => $_getN(4);
  @$pb.TagNumber(5)
  set annotationSource($4234.UserActionReference v) { setField(5, v); }
  @$pb.TagNumber(5)
  $core.bool hasAnnotationSource() => $_has(4);
  @$pb.TagNumber(5)
  void clearAnnotationSource() => clearField(5);
  @$pb.TagNumber(5)
  $4234.UserActionReference ensureAnnotationSource() => $_ensure(4);
