...
import 'user_action_reference.pb.dart' as $4233;
...
class Annotation extends $pb.GeneratedMessage {
  factory Annotation({
    ...
    $4233.UserActionReference? annotationSource,
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(_omitMessageNames ? '' : 'Annotation', package: const $pb.PackageName(_omitMessageNames ? '' : 'google.cloud.aiplatform.v1'), createEmptyInstance: create)
    ...
    ..aOM<$4233.UserActionReference>(5, _omitFieldNames ? '' : 'annotationSource', subBuilder: $4233.UserActionReference.create)
    ..m<$core.String, $core.String>(6, _omitFieldNames ? '' : 'labels', entryClassName: 'Annotation.LabelsEntry', keyFieldType: $pb.PbFieldType.OS, valueFieldType: $pb.PbFieldType.OS, packageName: const $pb.PackageName('google.cloud.aiplatform.v1'))
  ...
  @$pb.TagNumber(5)
  $4233.UserActionReference get annotationSource => $_getN(4);
  @$pb.TagNumber(5)
  set annotationSource($4233.UserActionReference v) { setField(5, v); }
  @$pb.TagNumber(5)
  $core.bool hasAnnotationSource() => $_has(4);
  @$pb.TagNumber(5)
  void clearAnnotationSource() => clearField(5);
  @$pb.TagNumber(5)
  $4233.UserActionReference ensureAnnotationSource() => $_ensure(4);
