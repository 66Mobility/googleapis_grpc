...
class MetadataStore_MetadataStoreState extends $pb.GeneratedMessage {
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(_omitMessageNames ? '' : 'MetadataStore.MetadataStoreState', package: const $pb.PackageName(_omitMessageNames ? '' : 'google.cloud.aiplatform.v1'), createEmptyInstance: create)
...
class MetadataStore_DataplexConfig extends $pb.GeneratedMessage {
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(_omitMessageNames ? '' : 'MetadataStore.DataplexConfig', package: const $pb.PackageName(_omitMessageNames ? '' : 'google.cloud.aiplatform.v1'), createEmptyInstance: create)
...
class MetadataStore extends $pb.GeneratedMessage {
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(_omitMessageNames ? '' : 'MetadataStore', package: const $pb.PackageName(_omitMessageNames ? '' : 'google.cloud.aiplatform.v1'), createEmptyInstance: create)
    ..aOS(1, _omitFieldNames ? '' : 'name')
    ..aOM<$1776.Timestamp>(3, _omitFieldNames ? '' : 'createTime', subBuilder: $1776.Timestamp.create)
    ..aOM<$1776.Timestamp>(4, _omitFieldNames ? '' : 'updateTime', subBuilder: $1776.Timestamp.create)
    ..aOM<$4241.EncryptionSpec>(5, _omitFieldNames ? '' : 'encryptionSpec', subBuilder: $4241.EncryptionSpec.create)
  ...
  /// using this key.
  @$pb.TagNumber(5)
  $4241.EncryptionSpec get encryptionSpec => $_getN(3);
  @$pb.TagNumber(5)
  set encryptionSpec($4241.EncryptionSpec v) { setField(5, v); }
  @$pb.TagNumber(5)
  $core.bool hasEncryptionSpec() => $_has(3);
  @$pb.TagNumber(5)
  void clearEncryptionSpec() => clearField(5);
  @$pb.TagNumber(5)
  $4241.EncryptionSpec ensureEncryptionSpec() => $_ensure(3);
