...
class MetadataStore extends $pb.GeneratedMessage {
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(_omitMessageNames ? '' : 'MetadataStore', package: const $pb.PackageName(_omitMessageNames ? '' : 'google.cloud.aiplatform.v1'), createEmptyInstance: create)
    ...
    ..aOM<$4240.EncryptionSpec>(5, _omitFieldNames ? '' : 'encryptionSpec', subBuilder: $4240.EncryptionSpec.create)
  ...
  /// using this key.
  @$pb.TagNumber(5)
  $4240.EncryptionSpec get encryptionSpec => $_getN(3);
  @$pb.TagNumber(5)
  set encryptionSpec($4240.EncryptionSpec v) { setField(5, v); }
  @$pb.TagNumber(5)
  $core.bool hasEncryptionSpec() => $_has(3);
  @$pb.TagNumber(5)
  void clearEncryptionSpec() => clearField(5);
  @$pb.TagNumber(5)
  $4240.EncryptionSpec ensureEncryptionSpec() => $_ensure(3);
