...
const FindNeighborsRequest$json = {
  ...
  '2': [
    ...
    {'1': 'queries', '3': 3, '4': 3, '5': 11, '6': '.google.cloud.aiplatform.v1.FindNeighborsRequest.Query', '10': 'queries'},
...
const FindNeighborsRequest_Query$json = {
  '1': 'Query',
  '2': [
    {'1': 'rrf', '3': 6, '4': 1, '5': 11, '6': '.google.cloud.aiplatform.v1.FindNeighborsRequest.Query.RRF', '8': {}, '9': 0, '10': 'rrf'},
    {'1': 'datapoint', '3': 1, '4': 1, '5': 11, '6': '.google.cloud.aiplatform.v1.IndexDatapoint', '8': {}, '10': 'datapoint'},
...
final $typed_data.Uint8List findNeighborsRequestDescriptor = $convert.base64Decode(
    ...
    'KgoRZGVwbG95ZWRfaW5kZXhfaWQYAiABKAlSD2RlcGxveWVkSW5kZXhJZBJQCgdxdWVyaWVzGA'
    'MgAygLMjYuZ29vZ2xlLmNsb3VkLmFpcGxhdGZvcm0udjEuRmluZE5laWdoYm9yc1JlcXVlc3Qu'
    'UXVlcnlSB3F1ZXJpZXMSMgoVcmV0dXJuX2Z1bGxfZGF0YXBvaW50GAQgASgIUhNyZXR1cm5GdW'
    'xsRGF0YXBvaW50GuIDCgVRdWVyeRJTCgNycmYYBiABKAsyOi5nb29nbGUuY2xvdWQuYWlwbGF0'
    'Zm9ybS52MS5GaW5kTmVpZ2hib3JzUmVxdWVzdC5RdWVyeS5SUkZCA+BBAUgAUgNycmYSTQoJZG'
    'F0YXBvaW50GAEgASgLMiouZ29vZ2xlLmNsb3VkLmFpcGxhdGZvcm0udjEuSW5kZXhEYXRhcG9p'
    'bnRCA+BBAlIJZGF0YXBvaW50EiUKDm5laWdoYm9yX2NvdW50GAIgASgFUg1uZWlnaGJvckNvdW'
    '50ElAKJXBlcl9jcm93ZGluZ19hdHRyaWJ1dGVfbmVpZ2hib3JfY291bnQYAyABKAVSIXBlckNy'
    'b3dkaW5nQXR0cmlidXRlTmVpZ2hib3JDb3VudBI8ChphcHByb3hpbWF0ZV9uZWlnaGJvcl9jb3'
    'VudBgEIAEoBVIYYXBwcm94aW1hdGVOZWlnaGJvckNvdW50ElEKJmZyYWN0aW9uX2xlYWZfbm9k'
    'ZXNfdG9fc2VhcmNoX292ZXJyaWRlGAUgASgBUiFmcmFjdGlvbkxlYWZOb2Rlc1RvU2VhcmNoT3'
    'ZlcnJpZGUaIAoDUlJGEhkKBWFscGhhGAEgASgCQgPgQQJSBWFscGhhQgkKB3Jhbmtpbmc=');

@$core.Deprecated('Use findNeighborsResponseDescriptor instead')
const FindNeighborsResponse$json = {
  '1': 'FindNeighborsResponse',
  '2': [
    {'1': 'nearest_neighbors', '3': 1, '4': 3, '5': 11, '6': '.google.cloud.aiplatform.v1.FindNeighborsResponse.NearestNeighbors', '10': 'nearestNeighbors'},
  ],
...
const FindNeighborsResponse_Neighbor$json = {
  '1': 'Neighbor',
  '2': [
    {'1': 'datapoint', '3': 1, '4': 1, '5': 11, '6': '.google.cloud.aiplatform.v1.IndexDatapoint', '10': 'datapoint'},
...
const FindNeighborsResponse_NearestNeighbors$json = {
  ...
  '2': [
    ...
    {'1': 'neighbors', '3': 2, '4': 3, '5': 11, '6': '.google.cloud.aiplatform.v1.FindNeighborsResponse.Neighbor', '10': 'neighbors'},
  ],
};
...
final $typed_data.Uint8List findNeighborsResponseDescriptor = $convert.base64Decode(
    'ChVGaW5kTmVpZ2hib3JzUmVzcG9uc2USbwoRbmVhcmVzdF9uZWlnaGJvcnMYASADKAsyQi5nb2'
    '9nbGUuY2xvdWQuYWlwbGF0Zm9ybS52MS5GaW5kTmVpZ2hib3JzUmVzcG9uc2UuTmVhcmVzdE5l'
    'aWdoYm9yc1IQbmVhcmVzdE5laWdoYm9ycxqZAQoITmVpZ2hib3ISSAoJZGF0YXBvaW50GAEgAS'
    'gLMiouZ29vZ2xlLmNsb3VkLmFpcGxhdGZvcm0udjEuSW5kZXhEYXRhcG9pbnRSCWRhdGFwb2lu'
    'dBIaCghkaXN0YW5jZRgCIAEoAVIIZGlzdGFuY2USJwoPc3BhcnNlX2Rpc3RhbmNlGAMgASgBUg'
    '5zcGFyc2VEaXN0YW5jZRp8ChBOZWFyZXN0TmVpZ2hib3JzEg4KAmlkGAEgASgJUgJpZBJYCglu'
    'ZWlnaGJvcnMYAiADKAsyOi5nb29nbGUuY2xvdWQuYWlwbGF0Zm9ybS52MS5GaW5kTmVpZ2hib3'
    'JzUmVzcG9uc2UuTmVpZ2hib3JSCW5laWdoYm9ycw==');
...
const ReadIndexDatapointsResponse$json = {
  ...
  '2': [
    {'1': 'datapoints', '3': 1, '4': 3, '5': 11, '6': '.google.cloud.aiplatform.v1.IndexDatapoint', '10': 'datapoints'},
  ],
};
...
final $typed_data.Uint8List readIndexDatapointsResponseDescriptor = $convert.base64Decode(
    'ChtSZWFkSW5kZXhEYXRhcG9pbnRzUmVzcG9uc2USSgoKZGF0YXBvaW50cxgBIAMoCzIqLmdvb2'
    'dsZS5jbG91ZC5haXBsYXRmb3JtLnYxLkluZGV4RGF0YXBvaW50UgpkYXRhcG9pbnRz');
