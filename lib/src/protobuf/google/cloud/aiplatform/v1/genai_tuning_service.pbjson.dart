...
const CreateTuningJobRequest$json = {
  ...
  '2': [
    ...
    {'1': 'tuning_job', '3': 2, '4': 1, '5': 11, '6': '.google.cloud.aiplatform.v1.TuningJob', '8': {}, '10': 'tuningJob'},
  ],
};
...
final $typed_data.Uint8List createTuningJobRequestDescriptor = $convert.base64Decode(
    ...
    'lvbnMuZ29vZ2xlYXBpcy5jb20vTG9jYXRpb25SBnBhcmVudBJJCgp0dW5pbmdfam9iGAIgASgL'
    'MiUuZ29vZ2xlLmNsb3VkLmFpcGxhdGZvcm0udjEuVHVuaW5nSm9iQgPgQQJSCXR1bmluZ0pvYg'
    '==');
...
const ListTuningJobsResponse$json = {
  ...
  '2': [
    {'1': 'tuning_jobs', '3': 1, '4': 3, '5': 11, '6': '.google.cloud.aiplatform.v1.TuningJob', '10': 'tuningJobs'},
...
final $typed_data.Uint8List listTuningJobsResponseDescriptor = $convert.base64Decode(
    'ChZMaXN0VHVuaW5nSm9ic1Jlc3BvbnNlEkYKC3R1bmluZ19qb2JzGAEgAygLMiUuZ29vZ2xlLm'
    'Nsb3VkLmFpcGxhdGZvcm0udjEuVHVuaW5nSm9iUgp0dW5pbmdKb2JzEiYKD25leHRfcGFnZV90'
