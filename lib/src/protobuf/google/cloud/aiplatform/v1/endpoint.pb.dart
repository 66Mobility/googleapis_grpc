...
class Endpoint extends $pb.GeneratedMessage {
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(_omitMessageNames ? '' : 'Endpoint', package: const $pb.PackageName(_omitMessageNames ? '' : 'google.cloud.aiplatform.v1'), createEmptyInstance: create)
    ...
    ..aOM<$4254.PrivateServiceConnectConfig>(21, _omitFieldNames ? '' : 'privateServiceConnectConfig', subBuilder: $4254.PrivateServiceConnectConfig.create)
  ...
  @$pb.TagNumber(21)
  $4254.PrivateServiceConnectConfig get privateServiceConnectConfig => $_getN(14);
  @$pb.TagNumber(21)
  set privateServiceConnectConfig($4254.PrivateServiceConnectConfig v) { setField(21, v); }
  @$pb.TagNumber(21)
  $core.bool hasPrivateServiceConnectConfig() => $_has(14);
  @$pb.TagNumber(21)
  void clearPrivateServiceConnectConfig() => clearField(21);
  @$pb.TagNumber(21)
  $4254.PrivateServiceConnectConfig ensurePrivateServiceConnectConfig() => $_ensure(14);
...
class DeployedModel extends $pb.GeneratedMessage {
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(_omitMessageNames ? '' : 'DeployedModel', package: const $pb.PackageName(_omitMessageNames ? '' : 'google.cloud.aiplatform.v1'), createEmptyInstance: create)
    ...
    ..aOM<$4243.DedicatedResources>(7, _omitFieldNames ? '' : 'dedicatedResources', subBuilder: $4243.DedicatedResources.create)
    ..aOM<$4243.AutomaticResources>(8, _omitFieldNames ? '' : 'automaticResources', subBuilder: $4243.AutomaticResources.create)
    ..aOM<$4240.ExplanationSpec>(9, _omitFieldNames ? '' : 'explanationSpec', subBuilder: $4240.ExplanationSpec.create)
  ...
  @$pb.TagNumber(7)
  set dedicatedResources($4243.DedicatedResources v) { setField(7, v); }
  @$pb.TagNumber(7)
  ...
  @$pb.TagNumber(8)
  set automaticResources($4243.AutomaticResources v) { setField(8, v); }
  @$pb.TagNumber(8)
  ...
  @$pb.TagNumber(9)
  $4240.ExplanationSpec get explanationSpec => $_getN(6);
  @$pb.TagNumber(9)
  set explanationSpec($4240.ExplanationSpec v) { setField(9, v); }
  @$pb.TagNumber(9)
  $core.bool hasExplanationSpec() => $_has(6);
  @$pb.TagNumber(9)
  void clearExplanationSpec() => clearField(9);
  @$pb.TagNumber(9)
  $4240.ExplanationSpec ensureExplanationSpec() => $_ensure(6);
