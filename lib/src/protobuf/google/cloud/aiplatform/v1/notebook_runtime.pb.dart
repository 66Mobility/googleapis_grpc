...
import 'network_spec.pb.dart' as $4265;
import 'notebook_euc_config.pb.dart' as $4267;
import 'notebook_idle_shutdown_config.pb.dart' as $4266;
import 'notebook_runtime.pbenum.dart';
import 'notebook_runtime_template_ref.pb.dart' as $4268;
...
class NotebookRuntimeTemplate extends $pb.GeneratedMessage {
  factory NotebookRuntimeTemplate({
    ...
    $4242.PersistentDiskSpec? dataPersistentDiskSpec,
    $1775.Timestamp? createTime,
    $1775.Timestamp? updateTime,
    $4265.NetworkSpec? networkSpec,
    $core.String? serviceAccount,
    $core.String? etag,
    $core.Map<$core.String, $core.String>? labels,
    $4266.NotebookIdleShutdownConfig? idleShutdownConfig,
    $4267.NotebookEucConfig? eucConfig,
    NotebookRuntimeType? notebookRuntimeType,
    $4242.ShieldedVmConfig? shieldedVmConfig,
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(_omitMessageNames ? '' : 'NotebookRuntimeTemplate', package: const $pb.PackageName(_omitMessageNames ? '' : 'google.cloud.aiplatform.v1'), createEmptyInstance: create)
    ...
    ..aOM<$4242.MachineSpec>(5, _omitFieldNames ? '' : 'machineSpec', subBuilder: $4242.MachineSpec.create)
    ..aOM<$4242.PersistentDiskSpec>(8, _omitFieldNames ? '' : 'dataPersistentDiskSpec', subBuilder: $4242.PersistentDiskSpec.create)
    ...
    ..aOM<$4265.NetworkSpec>(12, _omitFieldNames ? '' : 'networkSpec', subBuilder: $4265.NetworkSpec.create)
    ...
    ..aOM<$4266.NotebookIdleShutdownConfig>(17, _omitFieldNames ? '' : 'idleShutdownConfig', subBuilder: $4266.NotebookIdleShutdownConfig.create)
    ..aOM<$4267.NotebookEucConfig>(18, _omitFieldNames ? '' : 'eucConfig', subBuilder: $4267.NotebookEucConfig.create)
    ...
    ..aOM<$4242.ShieldedVmConfig>(20, _omitFieldNames ? '' : 'shieldedVmConfig', subBuilder: $4242.ShieldedVmConfig.create)
    ..pPS(21, _omitFieldNames ? '' : 'networkTags')
    ..aOM<$4240.EncryptionSpec>(23, _omitFieldNames ? '' : 'encryptionSpec', subBuilder: $4240.EncryptionSpec.create)
  ...
  /// template.
  @$pb.TagNumber(5)
  $4242.MachineSpec get machineSpec => $_getN(4);
  @$pb.TagNumber(5)
  set machineSpec($4242.MachineSpec v) { setField(5, v); }
  @$pb.TagNumber(5)
  $core.bool hasMachineSpec() => $_has(4);
  @$pb.TagNumber(5)
  void clearMachineSpec() => clearField(5);
  @$pb.TagNumber(5)
  $4242.MachineSpec ensureMachineSpec() => $_ensure(4);

  /// Optional. The specification of [persistent
  /// disk][https://cloud.google.com/compute/docs/disks/persistent-disks]
  /// attached to the runtime as data disk storage.
  @$pb.TagNumber(8)
  $4242.PersistentDiskSpec get dataPersistentDiskSpec => $_getN(5);
  @$pb.TagNumber(8)
  set dataPersistentDiskSpec($4242.PersistentDiskSpec v) { setField(8, v); }
  @$pb.TagNumber(8)
  $core.bool hasDataPersistentDiskSpec() => $_has(5);
  @$pb.TagNumber(8)
  void clearDataPersistentDiskSpec() => clearField(8);
  @$pb.TagNumber(8)
  $4242.PersistentDiskSpec ensureDataPersistentDiskSpec() => $_ensure(5);
  ...
  @$pb.TagNumber(12)
  $4265.NetworkSpec get networkSpec => $_getN(8);
  @$pb.TagNumber(12)
  set networkSpec($4265.NetworkSpec v) { setField(12, v); }
  @$pb.TagNumber(12)
  $core.bool hasNetworkSpec() => $_has(8);
  @$pb.TagNumber(12)
  void clearNetworkSpec() => clearField(12);
  @$pb.TagNumber(12)
  $4265.NetworkSpec ensureNetworkSpec() => $_ensure(8);
  ...
  @$pb.TagNumber(17)
  $4266.NotebookIdleShutdownConfig get idleShutdownConfig => $_getN(12);
  @$pb.TagNumber(17)
  set idleShutdownConfig($4266.NotebookIdleShutdownConfig v) { setField(17, v); }
  @$pb.TagNumber(17)
  $core.bool hasIdleShutdownConfig() => $_has(12);
  @$pb.TagNumber(17)
  void clearIdleShutdownConfig() => clearField(17);
  @$pb.TagNumber(17)
  $4266.NotebookIdleShutdownConfig ensureIdleShutdownConfig() => $_ensure(12);

  /// EUC configuration of the NotebookRuntimeTemplate.
  @$pb.TagNumber(18)
  $4267.NotebookEucConfig get eucConfig => $_getN(13);
  @$pb.TagNumber(18)
  set eucConfig($4267.NotebookEucConfig v) { setField(18, v); }
  @$pb.TagNumber(18)
  $core.bool hasEucConfig() => $_has(13);
  @$pb.TagNumber(18)
  void clearEucConfig() => clearField(18);
  @$pb.TagNumber(18)
  $4267.NotebookEucConfig ensureEucConfig() => $_ensure(13);
  ...
  @$pb.TagNumber(20)
  $4242.ShieldedVmConfig get shieldedVmConfig => $_getN(15);
  @$pb.TagNumber(20)
  set shieldedVmConfig($4242.ShieldedVmConfig v) { setField(20, v); }
  @$pb.TagNumber(20)
  $core.bool hasShieldedVmConfig() => $_has(15);
  @$pb.TagNumber(20)
  void clearShieldedVmConfig() => clearField(20);
  @$pb.TagNumber(20)
  $4242.ShieldedVmConfig ensureShieldedVmConfig() => $_ensure(15);
  ...
  @$pb.TagNumber(23)
  $4240.EncryptionSpec get encryptionSpec => $_getN(17);
  @$pb.TagNumber(23)
  set encryptionSpec($4240.EncryptionSpec v) { setField(23, v); }
  @$pb.TagNumber(23)
  $core.bool hasEncryptionSpec() => $_has(17);
  @$pb.TagNumber(23)
  void clearEncryptionSpec() => clearField(23);
  @$pb.TagNumber(23)
  $4240.EncryptionSpec ensureEncryptionSpec() => $_ensure(17);
}
...
class NotebookRuntime extends $pb.GeneratedMessage {
  factory NotebookRuntime({
    ...
    $4268.NotebookRuntimeTemplateRef? notebookRuntimeTemplateRef,
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(_omitMessageNames ? '' : 'NotebookRuntime', package: const $pb.PackageName(_omitMessageNames ? '' : 'google.cloud.aiplatform.v1'), createEmptyInstance: create)
    ...
    ..aOM<$4268.NotebookRuntimeTemplateRef>(3, _omitFieldNames ? '' : 'notebookRuntimeTemplateRef', subBuilder: $4268.NotebookRuntimeTemplateRef.create)
    ...
    ..e<NotebookRuntimeType>(19, _omitFieldNames ? '' : 'notebookRuntimeType', $pb.PbFieldType.OE, defaultOrMaker: NotebookRuntimeType.NOTEBOOK_RUNTIME_TYPE_UNSPECIFIED, valueOf: NotebookRuntimeType.valueOf, enumValues: NotebookRuntimeType.values)
    ..aOM<$4266.NotebookIdleShutdownConfig>(23, _omitFieldNames ? '' : 'idleShutdownConfig', subBuilder: $4266.NotebookIdleShutdownConfig.create)
    ..pPS(25, _omitFieldNames ? '' : 'networkTags')
    ..aOM<$4240.EncryptionSpec>(28, _omitFieldNames ? '' : 'encryptionSpec', subBuilder: $4240.EncryptionSpec.create)
  ...
  /// created from.
  @$pb.TagNumber(3)
  $4268.NotebookRuntimeTemplateRef get notebookRuntimeTemplateRef => $_getN(2);
  @$pb.TagNumber(3)
  set notebookRuntimeTemplateRef($4268.NotebookRuntimeTemplateRef v) { setField(3, v); }
  @$pb.TagNumber(3)
  $core.bool hasNotebookRuntimeTemplateRef() => $_has(2);
  @$pb.TagNumber(3)
  void clearNotebookRuntimeTemplateRef() => clearField(3);
  @$pb.TagNumber(3)
  $4268.NotebookRuntimeTemplateRef ensureNotebookRuntimeTemplateRef() => $_ensure(2);
  ...
  @$pb.TagNumber(23)
  $4266.NotebookIdleShutdownConfig get idleShutdownConfig => $_getN(16);
  @$pb.TagNumber(23)
  set idleShutdownConfig($4266.NotebookIdleShutdownConfig v) { setField(23, v); }
  @$pb.TagNumber(23)
  $core.bool hasIdleShutdownConfig() => $_has(16);
  @$pb.TagNumber(23)
  void clearIdleShutdownConfig() => clearField(23);
  @$pb.TagNumber(23)
  $4266.NotebookIdleShutdownConfig ensureIdleShutdownConfig() => $_ensure(16);
  ...
  @$pb.TagNumber(28)
  $4240.EncryptionSpec get encryptionSpec => $_getN(18);
  @$pb.TagNumber(28)
  set encryptionSpec($4240.EncryptionSpec v) { setField(28, v); }
  @$pb.TagNumber(28)
  $core.bool hasEncryptionSpec() => $_has(18);
  @$pb.TagNumber(28)
  void clearEncryptionSpec() => clearField(28);
  @$pb.TagNumber(28)
  $4240.EncryptionSpec ensureEncryptionSpec() => $_ensure(18);
