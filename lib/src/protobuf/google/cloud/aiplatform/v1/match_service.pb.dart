...
class FindNeighborsRequest_Query_RRF extends $pb.GeneratedMessage {
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(_omitMessageNames ? '' : 'FindNeighborsRequest.Query.RRF', package: const $pb.PackageName(_omitMessageNames ? '' : 'google.cloud.aiplatform.v1'), createEmptyInstance: create)
...
class FindNeighborsRequest_Query extends $pb.GeneratedMessage {
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(_omitMessageNames ? '' : 'FindNeighborsRequest.Query', package: const $pb.PackageName(_omitMessageNames ? '' : 'google.cloud.aiplatform.v1'), createEmptyInstance: create)
    ..oo(0, [6])
    ..aOM<$509.IndexDatapoint>(1, _omitFieldNames ? '' : 'datapoint', subBuilder: $509.IndexDatapoint.create)
  ...
  /// for.
  @$pb.TagNumber(1)
  $509.IndexDatapoint get datapoint => $_getN(0);
  @$pb.TagNumber(1)
  set datapoint($509.IndexDatapoint v) { setField(1, v); }
  @$pb.TagNumber(1)
  $core.bool hasDatapoint() => $_has(0);
  @$pb.TagNumber(1)
  void clearDatapoint() => clearField(1);
  @$pb.TagNumber(1)
  $509.IndexDatapoint ensureDatapoint() => $_ensure(0);
...
class FindNeighborsRequest extends $pb.GeneratedMessage {
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(_omitMessageNames ? '' : 'FindNeighborsRequest', package: const $pb.PackageName(_omitMessageNames ? '' : 'google.cloud.aiplatform.v1'), createEmptyInstance: create)
...
class FindNeighborsResponse_Neighbor extends $pb.GeneratedMessage {
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(_omitMessageNames ? '' : 'FindNeighborsResponse.Neighbor', package: const $pb.PackageName(_omitMessageNames ? '' : 'google.cloud.aiplatform.v1'), createEmptyInstance: create)
    ..aOM<$509.IndexDatapoint>(1, _omitFieldNames ? '' : 'datapoint', subBuilder: $509.IndexDatapoint.create)
...
class FindNeighborsResponse_NearestNeighbors extends $pb.GeneratedMessage {
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(_omitMessageNames ? '' : 'FindNeighborsResponse.NearestNeighbors', package: const $pb.PackageName(_omitMessageNames ? '' : 'google.cloud.aiplatform.v1'), createEmptyInstance: create)
...
class FindNeighborsResponse extends $pb.GeneratedMessage {
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(_omitMessageNames ? '' : 'FindNeighborsResponse', package: const $pb.PackageName(_omitMessageNames ? '' : 'google.cloud.aiplatform.v1'), createEmptyInstance: create)
...
class ReadIndexDatapointsRequest extends $pb.GeneratedMessage {
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(_omitMessageNames ? '' : 'ReadIndexDatapointsRequest', package: const $pb.PackageName(_omitMessageNames ? '' : 'google.cloud.aiplatform.v1'), createEmptyInstance: create)
    ..aOS(1, _omitFieldNames ? '' : 'indexEndpoint')
    ..aOS(2, _omitFieldNames ? '' : 'deployedIndexId')
...
class ReadIndexDatapointsResponse extends $pb.GeneratedMessage {
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(_omitMessageNames ? '' : 'ReadIndexDatapointsResponse', package: const $pb.PackageName(_omitMessageNames ? '' : 'google.cloud.aiplatform.v1'), createEmptyInstance: create)
    ..pc<$509.IndexDatapoint>(1, _omitFieldNames ? '' : 'datapoints', $pb.PbFieldType.PM, subBuilder: $509.IndexDatapoint.create)
    ..hasRequiredFields = false
  ;
  ...
  @$pb.TagNumber(1)
  $core.List<$509.IndexDatapoint> get datapoints => $_getList(0);
}
