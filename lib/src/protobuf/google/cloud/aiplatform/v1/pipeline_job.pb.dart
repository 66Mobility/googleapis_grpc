...
import 'pipeline_failure_policy.pbenum.dart' as $4271;
import 'pipeline_job.pbenum.dart';
import 'pipeline_state.pbenum.dart' as $4270;
import 'value.pb.dart' as $4269;
...
class PipelineJob_RuntimeConfig_InputArtifact extends $pb.GeneratedMessage {
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(_omitMessageNames ? '' : 'PipelineJob.RuntimeConfig.InputArtifact', package: const $pb.PackageName(_omitMessageNames ? '' : 'google.cloud.aiplatform.v1'), createEmptyInstance: create)
    ..oo(0, [1])
...
class PipelineJob_RuntimeConfig extends $pb.GeneratedMessage {
  ...
  @$core.Deprecated('This field is deprecated.')
    $core.Map<$core.String, $4269.Value>? parameters,
    $core.String? gcsOutputDirectory,
    $core.Map<$core.String, $1734.Value>? parameterValues,
    $4271.PipelineFailurePolicy? failurePolicy,
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(_omitMessageNames ? '' : 'PipelineJob.RuntimeConfig', package: const $pb.PackageName(_omitMessageNames ? '' : 'google.cloud.aiplatform.v1'), createEmptyInstance: create)
    ..m<$core.String, $4269.Value>(1, _omitFieldNames ? '' : 'parameters', entryClassName: 'PipelineJob.RuntimeConfig.ParametersEntry', keyFieldType: $pb.PbFieldType.OS, valueFieldType: $pb.PbFieldType.OM, valueCreator: $4269.Value.create, valueDefaultOrMaker: $4269.Value.getDefault, packageName: const $pb.PackageName('google.cloud.aiplatform.v1'))
    ..aOS(2, _omitFieldNames ? '' : 'gcsOutputDirectory')
    ..m<$core.String, $1734.Value>(3, _omitFieldNames ? '' : 'parameterValues', entryClassName: 'PipelineJob.RuntimeConfig.ParameterValuesEntry', keyFieldType: $pb.PbFieldType.OS, valueFieldType: $pb.PbFieldType.OM, valueCreator: $1734.Value.create, valueDefaultOrMaker: $1734.Value.getDefault, packageName: const $pb.PackageName('google.cloud.aiplatform.v1'))
    ..e<$4271.PipelineFailurePolicy>(4, _omitFieldNames ? '' : 'failurePolicy', $pb.PbFieldType.OE, defaultOrMaker: $4271.PipelineFailurePolicy.PIPELINE_FAILURE_POLICY_UNSPECIFIED, valueOf: $4271.PipelineFailurePolicy.valueOf, enumValues: $4271.PipelineFailurePolicy.values)
  ...
  @$core.Deprecated('This field is deprecated.')
  @$pb.TagNumber(1)
  $core.Map<$core.String, $4269.Value> get parameters => $_getMap(0);
  ...
  @$pb.TagNumber(4)
  $4271.PipelineFailurePolicy get failurePolicy => $_getN(3);
  @$pb.TagNumber(4)
  set failurePolicy($4271.PipelineFailurePolicy v) { setField(4, v); }
  @$pb.TagNumber(4)
...
class PipelineJob extends $pb.GeneratedMessage {
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(_omitMessageNames ? '' : 'PipelineJob', package: const $pb.PackageName(_omitMessageNames ? '' : 'google.cloud.aiplatform.v1'), createEmptyInstance: create)
    ...
    ..e<$4270.PipelineState>(8, _omitFieldNames ? '' : 'state', $pb.PbFieldType.OE, defaultOrMaker: $4270.PipelineState.PIPELINE_STATE_UNSPECIFIED, valueOf: $4270.PipelineState.valueOf, enumValues: $4270.PipelineState.values)
    ...
    ..m<$core.String, $core.String>(11, _omitFieldNames ? '' : 'labels', entryClassName: 'PipelineJob.LabelsEntry', keyFieldType: $pb.PbFieldType.OS, valueFieldType: $pb.PbFieldType.OS, packageName: const $pb.PackageName('google.cloud.aiplatform.v1'))
    ..aOM<PipelineJob_RuntimeConfig>(12, _omitFieldNames ? '' : 'runtimeConfig', subBuilder: PipelineJob_RuntimeConfig.create)
    ..aOM<$4240.EncryptionSpec>(16, _omitFieldNames ? '' : 'encryptionSpec', subBuilder: $4240.EncryptionSpec.create)
  ...
  @$pb.TagNumber(8)
  $4270.PipelineState get state => $_getN(7);
  @$pb.TagNumber(8)
  set state($4270.PipelineState v) { setField(8, v); }
  @$pb.TagNumber(8)
  ...
  @$pb.TagNumber(16)
  set encryptionSpec($4240.EncryptionSpec v) { setField(16, v); }
  @$pb.TagNumber(16)
...
class PipelineTemplateMetadata extends $pb.GeneratedMessage {
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(_omitMessageNames ? '' : 'PipelineTemplateMetadata', package: const $pb.PackageName(_omitMessageNames ? '' : 'google.cloud.aiplatform.v1'), createEmptyInstance: create)
...
class PipelineJobDetail extends $pb.GeneratedMessage {
  factory PipelineJobDetail({
    $524.Context? pipelineContext,
    $524.Context? pipelineRunContext,
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(_omitMessageNames ? '' : 'PipelineJobDetail', package: const $pb.PackageName(_omitMessageNames ? '' : 'google.cloud.aiplatform.v1'), createEmptyInstance: create)
    ..aOM<$524.Context>(1, _omitFieldNames ? '' : 'pipelineContext', subBuilder: $524.Context.create)
    ..aOM<$524.Context>(2, _omitFieldNames ? '' : 'pipelineRunContext', subBuilder: $524.Context.create)
  ...
  @$pb.TagNumber(1)
  $524.Context get pipelineContext => $_getN(0);
  @$pb.TagNumber(1)
  set pipelineContext($524.Context v) { setField(1, v); }
  @$pb.TagNumber(1)
  $core.bool hasPipelineContext() => $_has(0);
  @$pb.TagNumber(1)
  void clearPipelineContext() => clearField(1);
  @$pb.TagNumber(1)
  $524.Context ensurePipelineContext() => $_ensure(0);

  /// Output only. The context of the current pipeline run.
  @$pb.TagNumber(2)
  $524.Context get pipelineRunContext => $_getN(1);
  @$pb.TagNumber(2)
  set pipelineRunContext($524.Context v) { setField(2, v); }
  @$pb.TagNumber(2)
  $core.bool hasPipelineRunContext() => $_has(1);
  @$pb.TagNumber(2)
  void clearPipelineRunContext() => clearField(2);
  @$pb.TagNumber(2)
  $524.Context ensurePipelineRunContext() => $_ensure(1);
...
class PipelineTaskDetail_PipelineTaskStatus extends $pb.GeneratedMessage {
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(_omitMessageNames ? '' : 'PipelineTaskDetail.PipelineTaskStatus', package: const $pb.PackageName(_omitMessageNames ? '' : 'google.cloud.aiplatform.v1'), createEmptyInstance: create)
...
class PipelineTaskDetail_ArtifactList extends $pb.GeneratedMessage {
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(_omitMessageNames ? '' : 'PipelineTaskDetail.ArtifactList', package: const $pb.PackageName(_omitMessageNames ? '' : 'google.cloud.aiplatform.v1'), createEmptyInstance: create)
  ...
  @$pb.TagNumber(1)
  $core.List<$523.Artifact> get artifacts => $_getList(0);
}
...
class PipelineTaskDetail extends $pb.GeneratedMessage {
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(_omitMessageNames ? '' : 'PipelineTaskDetail', package: const $pb.PackageName(_omitMessageNames ? '' : 'google.cloud.aiplatform.v1'), createEmptyInstance: create)
    ...
    ..aOM<$526.Execution>(8, _omitFieldNames ? '' : 'execution', subBuilder: $526.Execution.create)
  ...
  @$pb.TagNumber(8)
  $526.Execution get execution => $_getN(7);
  @$pb.TagNumber(8)
  set execution($526.Execution v) { setField(8, v); }
  @$pb.TagNumber(8)
  $core.bool hasExecution() => $_has(7);
  @$pb.TagNumber(8)
  void clearExecution() => clearField(8);
  @$pb.TagNumber(8)
  $526.Execution ensureExecution() => $_ensure(7);
...
class PipelineTaskExecutorDetail_ContainerDetail extends $pb.GeneratedMessage {
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(_omitMessageNames ? '' : 'PipelineTaskExecutorDetail.ContainerDetail', package: const $pb.PackageName(_omitMessageNames ? '' : 'google.cloud.aiplatform.v1'), createEmptyInstance: create)
...
class PipelineTaskExecutorDetail_CustomJobDetail extends $pb.GeneratedMessage {
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(_omitMessageNames ? '' : 'PipelineTaskExecutorDetail.CustomJobDetail', package: const $pb.PackageName(_omitMessageNames ? '' : 'google.cloud.aiplatform.v1'), createEmptyInstance: create)
...
class PipelineTaskExecutorDetail extends $pb.GeneratedMessage {
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(_omitMessageNames ? '' : 'PipelineTaskExecutorDetail', package: const $pb.PackageName(_omitMessageNames ? '' : 'google.cloud.aiplatform.v1'), createEmptyInstance: create)
    ..oo(0, [1, 2])
