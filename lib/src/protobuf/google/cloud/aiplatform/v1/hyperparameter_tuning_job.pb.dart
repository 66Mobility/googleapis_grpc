...
class HyperparameterTuningJob extends $pb.GeneratedMessage {
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(_omitMessageNames ? '' : 'HyperparameterTuningJob', package: const $pb.PackageName(_omitMessageNames ? '' : 'google.cloud.aiplatform.v1'), createEmptyInstance: create)
    ..aOS(1, _omitFieldNames ? '' : 'name')
    ..aOS(2, _omitFieldNames ? '' : 'displayName')
    ..aOM<$553.StudySpec>(4, _omitFieldNames ? '' : 'studySpec', subBuilder: $553.StudySpec.create)
    ...
    ..aOM<$511.CustomJobSpec>(8, _omitFieldNames ? '' : 'trialJobSpec', subBuilder: $511.CustomJobSpec.create)
    ..pc<$553.Trial>(9, _omitFieldNames ? '' : 'trials', $pb.PbFieldType.PM, subBuilder: $553.Trial.create)
    ...
    ..m<$core.String, $core.String>(16, _omitFieldNames ? '' : 'labels', entryClassName: 'HyperparameterTuningJob.LabelsEntry', keyFieldType: $pb.PbFieldType.OS, valueFieldType: $pb.PbFieldType.OS, packageName: const $pb.PackageName('google.cloud.aiplatform.v1'))
  ...
  @$pb.TagNumber(4)
  $553.StudySpec get studySpec => $_getN(2);
  @$pb.TagNumber(4)
  set studySpec($553.StudySpec v) { setField(4, v); }
  @$pb.TagNumber(4)
  $core.bool hasStudySpec() => $_has(2);
  @$pb.TagNumber(4)
  void clearStudySpec() => clearField(4);
  @$pb.TagNumber(4)
  $553.StudySpec ensureStudySpec() => $_ensure(2);
  ...
  @$pb.TagNumber(8)
  $511.CustomJobSpec get trialJobSpec => $_getN(6);
  @$pb.TagNumber(8)
  set trialJobSpec($511.CustomJobSpec v) { setField(8, v); }
  @$pb.TagNumber(8)
  $core.bool hasTrialJobSpec() => $_has(6);
  @$pb.TagNumber(8)
  void clearTrialJobSpec() => clearField(8);
  @$pb.TagNumber(8)
  $511.CustomJobSpec ensureTrialJobSpec() => $_ensure(6);

  /// Output only. Trials of the HyperparameterTuningJob.
  @$pb.TagNumber(9)
  $core.List<$553.Trial> get trials => $_getList(7);

  /// Output only. The detailed state of the job.
  @$pb.TagNumber(10)
  $4246.JobState get state => $_getN(8);
  @$pb.TagNumber(10)
