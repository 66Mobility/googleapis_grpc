...
class FeatureView_BigQuerySource extends $pb.GeneratedMessage {
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(_omitMessageNames ? '' : 'FeatureView.BigQuerySource', package: const $pb.PackageName(_omitMessageNames ? '' : 'google.cloud.aiplatform.v1'), createEmptyInstance: create)
...
class FeatureView_SyncConfig extends $pb.GeneratedMessage {
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(_omitMessageNames ? '' : 'FeatureView.SyncConfig', package: const $pb.PackageName(_omitMessageNames ? '' : 'google.cloud.aiplatform.v1'), createEmptyInstance: create)
...
class FeatureView_IndexConfig_BruteForceConfig extends $pb.GeneratedMessage {
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(_omitMessageNames ? '' : 'FeatureView.IndexConfig.BruteForceConfig', package: const $pb.PackageName(_omitMessageNames ? '' : 'google.cloud.aiplatform.v1'), createEmptyInstance: create)
    ..hasRequiredFields = false
  ;
...
class FeatureView_IndexConfig_TreeAHConfig extends $pb.GeneratedMessage {
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(_omitMessageNames ? '' : 'FeatureView.IndexConfig.TreeAHConfig', package: const $pb.PackageName(_omitMessageNames ? '' : 'google.cloud.aiplatform.v1'), createEmptyInstance: create)
...
class FeatureView_IndexConfig extends $pb.GeneratedMessage {
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(_omitMessageNames ? '' : 'FeatureView.IndexConfig', package: const $pb.PackageName(_omitMessageNames ? '' : 'google.cloud.aiplatform.v1'), createEmptyInstance: create)
    ..oo(0, [6, 7])
...
class FeatureView_FeatureRegistrySource_FeatureGroup extends $pb.GeneratedMessage {
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(_omitMessageNames ? '' : 'FeatureView.FeatureRegistrySource.FeatureGroup', package: const $pb.PackageName(_omitMessageNames ? '' : 'google.cloud.aiplatform.v1'), createEmptyInstance: create)
...
class FeatureView_FeatureRegistrySource extends $pb.GeneratedMessage {
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(_omitMessageNames ? '' : 'FeatureView.FeatureRegistrySource', package: const $pb.PackageName(_omitMessageNames ? '' : 'google.cloud.aiplatform.v1'), createEmptyInstance: create)
...
class FeatureView extends $pb.GeneratedMessage {
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(_omitMessageNames ? '' : 'FeatureView', package: const $pb.PackageName(_omitMessageNames ? '' : 'google.cloud.aiplatform.v1'), createEmptyInstance: create)
    ..oo(0, [6, 9])
    ..aOS(1, _omitFieldNames ? '' : 'name')
    ..aOM<$1776.Timestamp>(2, _omitFieldNames ? '' : 'createTime', subBuilder: $1776.Timestamp.create)
    ..aOM<$1776.Timestamp>(3, _omitFieldNames ? '' : 'updateTime', subBuilder: $1776.Timestamp.create)
    ..aOS(4, _omitFieldNames ? '' : 'etag')
    ..m<$core.String, $core.String>(5, _omitFieldNames ? '' : 'labels', entryClassName: 'FeatureView.LabelsEntry', keyFieldType: $pb.PbFieldType.OS, valueFieldType: $pb.PbFieldType.OS, packageName: const $pb.PackageName('google.cloud.aiplatform.v1'))
  ...
  @$pb.TagNumber(9)
  FeatureView_FeatureRegistrySource get featureRegistrySource => $_getN(7);
  @$pb.TagNumber(9)
  set featureRegistrySource(FeatureView_FeatureRegistrySource v) { setField(9, v); }
  @$pb.TagNumber(9)
  $core.bool hasFeatureRegistrySource() => $_has(7);
  @$pb.TagNumber(9)
  void clearFeatureRegistrySource() => clearField(9);
  @$pb.TagNumber(9)
  FeatureView_FeatureRegistrySource ensureFeatureRegistrySource() => $_ensure(7);
  ...
  @$pb.TagNumber(15)
  FeatureView_IndexConfig get indexConfig => $_getN(8);
  @$pb.TagNumber(15)
  set indexConfig(FeatureView_IndexConfig v) { setField(15, v); }
  @$pb.TagNumber(15)
  $core.bool hasIndexConfig() => $_has(8);
  @$pb.TagNumber(15)
  void clearIndexConfig() => clearField(15);
  @$pb.TagNumber(15)
  FeatureView_IndexConfig ensureIndexConfig() => $_ensure(8);
