...
import 'accelerator_type.pbenum.dart' as $4237;
import 'reservation_affinity.pb.dart' as $4236;

/// Specification of a single machine.
class MachineSpec extends $pb.GeneratedMessage {
  factory MachineSpec({
    $core.String? machineType,
    $4237.AcceleratorType? acceleratorType,
    $core.int? acceleratorCount,
    $core.String? tpuTopology,
    $4236.ReservationAffinity? reservationAffinity,
  }) {
    final $result = create();
    if (machineType != null) {
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(_omitMessageNames ? '' : 'MachineSpec', package: const $pb.PackageName(_omitMessageNames ? '' : 'google.cloud.aiplatform.v1'), createEmptyInstance: create)
    ..aOS(1, _omitFieldNames ? '' : 'machineType')
    ..e<$4237.AcceleratorType>(2, _omitFieldNames ? '' : 'acceleratorType', $pb.PbFieldType.OE, defaultOrMaker: $4237.AcceleratorType.ACCELERATOR_TYPE_UNSPECIFIED, valueOf: $4237.AcceleratorType.valueOf, enumValues: $4237.AcceleratorType.values)
    ..a<$core.int>(3, _omitFieldNames ? '' : 'acceleratorCount', $pb.PbFieldType.O3)
    ..aOS(4, _omitFieldNames ? '' : 'tpuTopology')
    ..aOM<$4236.ReservationAffinity>(5, _omitFieldNames ? '' : 'reservationAffinity', subBuilder: $4236.ReservationAffinity.create)
  ...
  @$pb.TagNumber(2)
  $4237.AcceleratorType get acceleratorType => $_getN(1);
  @$pb.TagNumber(2)
  set acceleratorType($4237.AcceleratorType v) { setField(2, v); }
  @$pb.TagNumber(2)
  ...
  @$pb.TagNumber(5)
  $4236.ReservationAffinity get reservationAffinity => $_getN(4);
  @$pb.TagNumber(5)
  set reservationAffinity($4236.ReservationAffinity v) { setField(5, v); }
  @$pb.TagNumber(5)
  $core.bool hasReservationAffinity() => $_has(4);
  @$pb.TagNumber(5)
  void clearReservationAffinity() => clearField(5);
  @$pb.TagNumber(5)
  $4236.ReservationAffinity ensureReservationAffinity() => $_ensure(4);
}
...
class DedicatedResources extends $pb.GeneratedMessage {
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(_omitMessageNames ? '' : 'DedicatedResources', package: const $pb.PackageName(_omitMessageNames ? '' : 'google.cloud.aiplatform.v1'), createEmptyInstance: create)
...
class AutomaticResources extends $pb.GeneratedMessage {
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(_omitMessageNames ? '' : 'AutomaticResources', package: const $pb.PackageName(_omitMessageNames ? '' : 'google.cloud.aiplatform.v1'), createEmptyInstance: create)
...
class BatchDedicatedResources extends $pb.GeneratedMessage {
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(_omitMessageNames ? '' : 'BatchDedicatedResources', package: const $pb.PackageName(_omitMessageNames ? '' : 'google.cloud.aiplatform.v1'), createEmptyInstance: create)
    ..aOM<MachineSpec>(1, _omitFieldNames ? '' : 'machineSpec', subBuilder: MachineSpec.create)
...
class ResourcesConsumed extends $pb.GeneratedMessage {
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(_omitMessageNames ? '' : 'ResourcesConsumed', package: const $pb.PackageName(_omitMessageNames ? '' : 'google.cloud.aiplatform.v1'), createEmptyInstance: create)
...
class DiskSpec extends $pb.GeneratedMessage {
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(_omitMessageNames ? '' : 'DiskSpec', package: const $pb.PackageName(_omitMessageNames ? '' : 'google.cloud.aiplatform.v1'), createEmptyInstance: create)
...
class PersistentDiskSpec extends $pb.GeneratedMessage {
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(_omitMessageNames ? '' : 'PersistentDiskSpec', package: const $pb.PackageName(_omitMessageNames ? '' : 'google.cloud.aiplatform.v1'), createEmptyInstance: create)
...
class NfsMount extends $pb.GeneratedMessage {
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(_omitMessageNames ? '' : 'NfsMount', package: const $pb.PackageName(_omitMessageNames ? '' : 'google.cloud.aiplatform.v1'), createEmptyInstance: create)
...
class AutoscalingMetricSpec extends $pb.GeneratedMessage {
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(_omitMessageNames ? '' : 'AutoscalingMetricSpec', package: const $pb.PackageName(_omitMessageNames ? '' : 'google.cloud.aiplatform.v1'), createEmptyInstance: create)
...
class ShieldedVmConfig extends $pb.GeneratedMessage {
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(_omitMessageNames ? '' : 'ShieldedVmConfig', package: const $pb.PackageName(_omitMessageNames ? '' : 'google.cloud.aiplatform.v1'), createEmptyInstance: create)
