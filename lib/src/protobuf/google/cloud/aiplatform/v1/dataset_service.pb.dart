...
import 'annotation.pb.dart' as $4252;
import 'data_item.pb.dart' as $4251;
...
class ListDataItemsResponse extends $pb.GeneratedMessage {
  factory ListDataItemsResponse({
    $core.Iterable<$4251.DataItem>? dataItems,
    $core.String? nextPageToken,
  }) {
    final $result = create();
    if (dataItems != null) {
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(_omitMessageNames ? '' : 'ListDataItemsResponse', package: const $pb.PackageName(_omitMessageNames ? '' : 'google.cloud.aiplatform.v1'), createEmptyInstance: create)
    ..pc<$4251.DataItem>(1, _omitFieldNames ? '' : 'dataItems', $pb.PbFieldType.PM, subBuilder: $4251.DataItem.create)
    ..aOS(2, _omitFieldNames ? '' : 'nextPageToken')
    ..hasRequiredFields = false
  ;
  ...
  @$pb.TagNumber(1)
  $core.List<$4251.DataItem> get dataItems => $_getList(0);
...
class DataItemView extends $pb.GeneratedMessage {
  factory DataItemView({
    $4251.DataItem? dataItem,
    $core.Iterable<$4252.Annotation>? annotations,
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(_omitMessageNames ? '' : 'DataItemView', package: const $pb.PackageName(_omitMessageNames ? '' : 'google.cloud.aiplatform.v1'), createEmptyInstance: create)
    ..aOM<$4251.DataItem>(1, _omitFieldNames ? '' : 'dataItem', subBuilder: $4251.DataItem.create)
    ..pc<$4252.Annotation>(2, _omitFieldNames ? '' : 'annotations', $pb.PbFieldType.PM, subBuilder: $4252.Annotation.create)
  ...
  /// The DataItem.
  @$pb.TagNumber(1)
  $4251.DataItem get dataItem => $_getN(0);
  @$pb.TagNumber(1)
  set dataItem($4251.DataItem v) { setField(1, v); }
  @$pb.TagNumber(1)
  $core.bool hasDataItem() => $_has(0);
  @$pb.TagNumber(1)
  void clearDataItem() => clearField(1);
  @$pb.TagNumber(1)
  $4251.DataItem ensureDataItem() => $_ensure(0);
  ...
  @$pb.TagNumber(2)
  $core.List<$4252.Annotation> get annotations => $_getList(1);
...
class ListSavedQueriesResponse extends $pb.GeneratedMessage {
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(_omitMessageNames ? '' : 'ListSavedQueriesResponse', package: const $pb.PackageName(_omitMessageNames ? '' : 'google.cloud.aiplatform.v1'), createEmptyInstance: create)
    ..pc<$4249.SavedQuery>(1, _omitFieldNames ? '' : 'savedQueries', $pb.PbFieldType.PM, subBuilder: $4249.SavedQuery.create)
    ..aOS(2, _omitFieldNames ? '' : 'nextPageToken')
    ..hasRequiredFields = false
  ;
  ...
  @$pb.TagNumber(1)
  $core.List<$4249.SavedQuery> get savedQueries => $_getList(0);
...
class ListAnnotationsResponse extends $pb.GeneratedMessage {
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(_omitMessageNames ? '' : 'ListAnnotationsResponse', package: const $pb.PackageName(_omitMessageNames ? '' : 'google.cloud.aiplatform.v1'), createEmptyInstance: create)
    ..pc<$4252.Annotation>(1, _omitFieldNames ? '' : 'annotations', $pb.PbFieldType.PM, subBuilder: $4252.Annotation.create)
    ..aOS(2, _omitFieldNames ? '' : 'nextPageToken')
    ..hasRequiredFields = false
  ;
  ...
  @$pb.TagNumber(1)
  $core.List<$4252.Annotation> get annotations => $_getList(0);
