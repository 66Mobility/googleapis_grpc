...
import 'featurestore_monitoring.pb.dart' as $4255;
...
class EntityType extends $pb.GeneratedMessage {
  factory EntityType({
    ...
    $core.String? etag,
    $4255.FeaturestoreMonitoringConfig? monitoringConfig,
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(_omitMessageNames ? '' : 'EntityType', package: const $pb.PackageName(_omitMessageNames ? '' : 'google.cloud.aiplatform.v1'), createEmptyInstance: create)
    ...
    ..aOM<$4255.FeaturestoreMonitoringConfig>(8, _omitFieldNames ? '' : 'monitoringConfig', subBuilder: $4255.FeaturestoreMonitoringConfig.create)
  ...
  ///  disabled.
  @$pb.TagNumber(8)
  $4255.FeaturestoreMonitoringConfig get monitoringConfig => $_getN(6);
  @$pb.TagNumber(8)
  set monitoringConfig($4255.FeaturestoreMonitoringConfig v) { setField(8, v); }
  @$pb.TagNumber(8)
  $core.bool hasMonitoringConfig() => $_has(6);
  @$pb.TagNumber(8)
  void clearMonitoringConfig() => clearField(8);
  @$pb.TagNumber(8)
  $4255.FeaturestoreMonitoringConfig ensureMonitoringConfig() => $_ensure(6);
