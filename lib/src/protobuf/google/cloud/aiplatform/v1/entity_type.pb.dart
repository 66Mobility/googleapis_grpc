...
import 'featurestore_monitoring.pb.dart' as $4254;
...
class EntityType extends $pb.GeneratedMessage {
  factory EntityType({
    ...
    $core.String? etag,
    $4254.FeaturestoreMonitoringConfig? monitoringConfig,
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(_omitMessageNames ? '' : 'EntityType', package: const $pb.PackageName(_omitMessageNames ? '' : 'google.cloud.aiplatform.v1'), createEmptyInstance: create)
    ..aOS(1, _omitFieldNames ? '' : 'name')
    ..aOS(2, _omitFieldNames ? '' : 'description')
    ..aOM<$1775.Timestamp>(3, _omitFieldNames ? '' : 'createTime', subBuilder: $1775.Timestamp.create)
    ..aOM<$1775.Timestamp>(4, _omitFieldNames ? '' : 'updateTime', subBuilder: $1775.Timestamp.create)
    ..m<$core.String, $core.String>(6, _omitFieldNames ? '' : 'labels', entryClassName: 'EntityType.LabelsEntry', keyFieldType: $pb.PbFieldType.OS, valueFieldType: $pb.PbFieldType.OS, packageName: const $pb.PackageName('google.cloud.aiplatform.v1'))
    ..aOS(7, _omitFieldNames ? '' : 'etag')
    ..aOM<$4254.FeaturestoreMonitoringConfig>(8, _omitFieldNames ? '' : 'monitoringConfig', subBuilder: $4254.FeaturestoreMonitoringConfig.create)
  ...
  ///  disabled.
  @$pb.TagNumber(8)
  $4254.FeaturestoreMonitoringConfig get monitoringConfig => $_getN(6);
  @$pb.TagNumber(8)
  set monitoringConfig($4254.FeaturestoreMonitoringConfig v) { setField(8, v); }
  @$pb.TagNumber(8)
  $core.bool hasMonitoringConfig() => $_has(6);
  @$pb.TagNumber(8)
  void clearMonitoringConfig() => clearField(8);
  @$pb.TagNumber(8)
  $4254.FeaturestoreMonitoringConfig ensureMonitoringConfig() => $_ensure(6);
