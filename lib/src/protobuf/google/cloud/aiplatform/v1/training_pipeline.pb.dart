...
class TrainingPipeline extends $pb.GeneratedMessage {
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(_omitMessageNames ? '' : 'TrainingPipeline', package: const $pb.PackageName(_omitMessageNames ? '' : 'google.cloud.aiplatform.v1'), createEmptyInstance: create)
    ...
    ..e<$4270.PipelineState>(9, _omitFieldNames ? '' : 'state', $pb.PbFieldType.OE, defaultOrMaker: $4270.PipelineState.PIPELINE_STATE_UNSPECIFIED, valueOf: $4270.PipelineState.valueOf, enumValues: $4270.PipelineState.values)
    ...
    ..aOM<$4240.EncryptionSpec>(18, _omitFieldNames ? '' : 'encryptionSpec', subBuilder: $4240.EncryptionSpec.create)
  ...
  @$pb.TagNumber(9)
  set state($4270.PipelineState v) { setField(9, v); }
  @$pb.TagNumber(9)
  ...
  @$pb.TagNumber(18)
  $4240.EncryptionSpec get encryptionSpec => $_getN(14);
  @$pb.TagNumber(18)
  set encryptionSpec($4240.EncryptionSpec v) { setField(18, v); }
  @$pb.TagNumber(18)
  $core.bool hasEncryptionSpec() => $_has(14);
  @$pb.TagNumber(18)
  void clearEncryptionSpec() => clearField(18);
  @$pb.TagNumber(18)
  $4240.EncryptionSpec ensureEncryptionSpec() => $_ensure(14);
...
class InputDataConfig extends $pb.GeneratedMessage {
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(_omitMessageNames ? '' : 'InputDataConfig', package: const $pb.PackageName(_omitMessageNames ? '' : 'google.cloud.aiplatform.v1'), createEmptyInstance: create)
    ...
    ..aOM<$4235.GcsDestination>(8, _omitFieldNames ? '' : 'gcsDestination', subBuilder: $4235.GcsDestination.create)
    ..aOS(9, _omitFieldNames ? '' : 'annotationSchemaUri')
    ..aOM<$4235.BigQueryDestination>(10, _omitFieldNames ? '' : 'bigqueryDestination', subBuilder: $4235.BigQueryDestination.create)
  ...
  @$pb.TagNumber(8)
  $4235.GcsDestination get gcsDestination => $_getN(7);
  @$pb.TagNumber(8)
  set gcsDestination($4235.GcsDestination v) { setField(8, v); }
  @$pb.TagNumber(8)
  $core.bool hasGcsDestination() => $_has(7);
  @$pb.TagNumber(8)
  void clearGcsDestination() => clearField(8);
  @$pb.TagNumber(8)
  $4235.GcsDestination ensureGcsDestination() => $_ensure(7);
  ...
  @$pb.TagNumber(10)
  $4235.BigQueryDestination get bigqueryDestination => $_getN(9);
  @$pb.TagNumber(10)
  set bigqueryDestination($4235.BigQueryDestination v) { setField(10, v); }
  @$pb.TagNumber(10)
  $core.bool hasBigqueryDestination() => $_has(9);
  @$pb.TagNumber(10)
  void clearBigqueryDestination() => clearField(10);
  @$pb.TagNumber(10)
  $4235.BigQueryDestination ensureBigqueryDestination() => $_ensure(9);
