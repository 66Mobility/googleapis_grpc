...
class ReadFeatureValuesRequest extends $pb.GeneratedMessage {
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(_omitMessageNames ? '' : 'ReadFeatureValuesRequest', package: const $pb.PackageName(_omitMessageNames ? '' : 'google.cloud.aiplatform.v1'), createEmptyInstance: create)
    ...
    ..aOM<$4257.FeatureSelector>(3, _omitFieldNames ? '' : 'featureSelector', subBuilder: $4257.FeatureSelector.create)
    ..hasRequiredFields = false
  ;
  ...
  @$pb.TagNumber(3)
  $4257.FeatureSelector get featureSelector => $_getN(2);
  @$pb.TagNumber(3)
  set featureSelector($4257.FeatureSelector v) { setField(3, v); }
  @$pb.TagNumber(3)
  $core.bool hasFeatureSelector() => $_has(2);
  @$pb.TagNumber(3)
  void clearFeatureSelector() => clearField(3);
  @$pb.TagNumber(3)
  $4257.FeatureSelector ensureFeatureSelector() => $_ensure(2);
}
...
class FeatureValue extends $pb.GeneratedMessage {
  factory FeatureValue({
    ...
    $4258.BoolArray? boolArrayValue,
    $4258.DoubleArray? doubleArrayValue,
    $4258.Int64Array? int64ArrayValue,
    $4258.StringArray? stringArrayValue,
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(_omitMessageNames ? '' : 'FeatureValue', package: const $pb.PackageName(_omitMessageNames ? '' : 'google.cloud.aiplatform.v1'), createEmptyInstance: create)
    ...
    ..aOM<$4258.BoolArray>(7, _omitFieldNames ? '' : 'boolArrayValue', subBuilder: $4258.BoolArray.create)
    ..aOM<$4258.DoubleArray>(8, _omitFieldNames ? '' : 'doubleArrayValue', subBuilder: $4258.DoubleArray.create)
    ..aOM<$4258.Int64Array>(11, _omitFieldNames ? '' : 'int64ArrayValue', subBuilder: $4258.Int64Array.create)
    ..aOM<$4258.StringArray>(12, _omitFieldNames ? '' : 'stringArrayValue', subBuilder: $4258.StringArray.create)
  ...
  @$pb.TagNumber(7)
  $4258.BoolArray get boolArrayValue => $_getN(4);
  @$pb.TagNumber(7)
  set boolArrayValue($4258.BoolArray v) { setField(7, v); }
  @$pb.TagNumber(7)
  $core.bool hasBoolArrayValue() => $_has(4);
  @$pb.TagNumber(7)
  void clearBoolArrayValue() => clearField(7);
  @$pb.TagNumber(7)
  $4258.BoolArray ensureBoolArrayValue() => $_ensure(4);

  /// A list of double type feature value.
  @$pb.TagNumber(8)
  $4258.DoubleArray get doubleArrayValue => $_getN(5);
  @$pb.TagNumber(8)
  set doubleArrayValue($4258.DoubleArray v) { setField(8, v); }
  @$pb.TagNumber(8)
  $core.bool hasDoubleArrayValue() => $_has(5);
  @$pb.TagNumber(8)
  void clearDoubleArrayValue() => clearField(8);
  @$pb.TagNumber(8)
  $4258.DoubleArray ensureDoubleArrayValue() => $_ensure(5);

  /// A list of int64 type feature value.
  @$pb.TagNumber(11)
  $4258.Int64Array get int64ArrayValue => $_getN(6);
  @$pb.TagNumber(11)
  set int64ArrayValue($4258.Int64Array v) { setField(11, v); }
  @$pb.TagNumber(11)
  $core.bool hasInt64ArrayValue() => $_has(6);
  @$pb.TagNumber(11)
  void clearInt64ArrayValue() => clearField(11);
  @$pb.TagNumber(11)
  $4258.Int64Array ensureInt64ArrayValue() => $_ensure(6);

  /// A list of string type feature value.
  @$pb.TagNumber(12)
  $4258.StringArray get stringArrayValue => $_getN(7);
  @$pb.TagNumber(12)
  set stringArrayValue($4258.StringArray v) { setField(12, v); }
  @$pb.TagNumber(12)
  $core.bool hasStringArrayValue() => $_has(7);
  @$pb.TagNumber(12)
  void clearStringArrayValue() => clearField(12);
  @$pb.TagNumber(12)
  $4258.StringArray ensureStringArrayValue() => $_ensure(7);
