...
class WriteFeatureValuesRequest extends $pb.GeneratedMessage {
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(_omitMessageNames ? '' : 'WriteFeatureValuesRequest', package: const $pb.PackageName(_omitMessageNames ? '' : 'google.cloud.aiplatform.v1'), createEmptyInstance: create)
...
class WriteFeatureValuesPayload extends $pb.GeneratedMessage {
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(_omitMessageNames ? '' : 'WriteFeatureValuesPayload', package: const $pb.PackageName(_omitMessageNames ? '' : 'google.cloud.aiplatform.v1'), createEmptyInstance: create)
    ..aOS(1, _omitFieldNames ? '' : 'entityId')
    ..m<$core.String, FeatureValue>(2, _omitFieldNames ? '' : 'featureValues', entryClassName: 'WriteFeatureValuesPayload.FeatureValuesEntry', keyFieldType: $pb.PbFieldType.OS, valueFieldType: $pb.PbFieldType.OM, valueCreator: FeatureValue.create, valueDefaultOrMaker: FeatureValue.getDefault, packageName: const $pb.PackageName('google.cloud.aiplatform.v1'))
    ..hasRequiredFields = false
  ;
...
class WriteFeatureValuesResponse extends $pb.GeneratedMessage {
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(_omitMessageNames ? '' : 'WriteFeatureValuesResponse', package: const $pb.PackageName(_omitMessageNames ? '' : 'google.cloud.aiplatform.v1'), createEmptyInstance: create)
    ..hasRequiredFields = false
  ;
...
class ReadFeatureValuesRequest extends $pb.GeneratedMessage {
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(_omitMessageNames ? '' : 'ReadFeatureValuesRequest', package: const $pb.PackageName(_omitMessageNames ? '' : 'google.cloud.aiplatform.v1'), createEmptyInstance: create)
    ..aOS(1, _omitFieldNames ? '' : 'entityType')
    ..aOS(2, _omitFieldNames ? '' : 'entityId')
    ..aOM<$4258.FeatureSelector>(3, _omitFieldNames ? '' : 'featureSelector', subBuilder: $4258.FeatureSelector.create)
    ..hasRequiredFields = false
  ;
  ...
  @$pb.TagNumber(3)
  $4258.FeatureSelector get featureSelector => $_getN(2);
  @$pb.TagNumber(3)
  set featureSelector($4258.FeatureSelector v) { setField(3, v); }
  @$pb.TagNumber(3)
  $core.bool hasFeatureSelector() => $_has(2);
  @$pb.TagNumber(3)
  void clearFeatureSelector() => clearField(3);
  @$pb.TagNumber(3)
  $4258.FeatureSelector ensureFeatureSelector() => $_ensure(2);
}
...
class ReadFeatureValuesResponse_FeatureDescriptor extends $pb.GeneratedMessage {
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(_omitMessageNames ? '' : 'ReadFeatureValuesResponse.FeatureDescriptor', package: const $pb.PackageName(_omitMessageNames ? '' : 'google.cloud.aiplatform.v1'), createEmptyInstance: create)
...
class ReadFeatureValuesResponse_Header extends $pb.GeneratedMessage {
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(_omitMessageNames ? '' : 'ReadFeatureValuesResponse.Header', package: const $pb.PackageName(_omitMessageNames ? '' : 'google.cloud.aiplatform.v1'), createEmptyInstance: create)
    ..aOS(1, _omitFieldNames ? '' : 'entityType')
...
class ReadFeatureValuesResponse_EntityView_Data extends $pb.GeneratedMessage {
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(_omitMessageNames ? '' : 'ReadFeatureValuesResponse.EntityView.Data', package: const $pb.PackageName(_omitMessageNames ? '' : 'google.cloud.aiplatform.v1'), createEmptyInstance: create)
    ..oo(0, [1, 2])
...
class ReadFeatureValuesResponse_EntityView extends $pb.GeneratedMessage {
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(_omitMessageNames ? '' : 'ReadFeatureValuesResponse.EntityView', package: const $pb.PackageName(_omitMessageNames ? '' : 'google.cloud.aiplatform.v1'), createEmptyInstance: create)
    ..aOS(1, _omitFieldNames ? '' : 'entityId')
...
class ReadFeatureValuesResponse extends $pb.GeneratedMessage {
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(_omitMessageNames ? '' : 'ReadFeatureValuesResponse', package: const $pb.PackageName(_omitMessageNames ? '' : 'google.cloud.aiplatform.v1'), createEmptyInstance: create)
...
class StreamingReadFeatureValuesRequest extends $pb.GeneratedMessage {
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(_omitMessageNames ? '' : 'StreamingReadFeatureValuesRequest', package: const $pb.PackageName(_omitMessageNames ? '' : 'google.cloud.aiplatform.v1'), createEmptyInstance: create)
    ..aOS(1, _omitFieldNames ? '' : 'entityType')
...
class FeatureValue_Metadata extends $pb.GeneratedMessage {
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(_omitMessageNames ? '' : 'FeatureValue.Metadata', package: const $pb.PackageName(_omitMessageNames ? '' : 'google.cloud.aiplatform.v1'), createEmptyInstance: create)
...
class FeatureValue extends $pb.GeneratedMessage {
  factory FeatureValue({
    ...
    $4259.BoolArray? boolArrayValue,
    $4259.DoubleArray? doubleArrayValue,
    $4259.Int64Array? int64ArrayValue,
    $4259.StringArray? stringArrayValue,
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(_omitMessageNames ? '' : 'FeatureValue', package: const $pb.PackageName(_omitMessageNames ? '' : 'google.cloud.aiplatform.v1'), createEmptyInstance: create)
    ...
    ..aOM<$4259.BoolArray>(7, _omitFieldNames ? '' : 'boolArrayValue', subBuilder: $4259.BoolArray.create)
    ..aOM<$4259.DoubleArray>(8, _omitFieldNames ? '' : 'doubleArrayValue', subBuilder: $4259.DoubleArray.create)
    ..aOM<$4259.Int64Array>(11, _omitFieldNames ? '' : 'int64ArrayValue', subBuilder: $4259.Int64Array.create)
    ..aOM<$4259.StringArray>(12, _omitFieldNames ? '' : 'stringArrayValue', subBuilder: $4259.StringArray.create)
  ...
  @$pb.TagNumber(7)
  $4259.BoolArray get boolArrayValue => $_getN(4);
  @$pb.TagNumber(7)
  set boolArrayValue($4259.BoolArray v) { setField(7, v); }
  @$pb.TagNumber(7)
  $core.bool hasBoolArrayValue() => $_has(4);
  @$pb.TagNumber(7)
  void clearBoolArrayValue() => clearField(7);
  @$pb.TagNumber(7)
  $4259.BoolArray ensureBoolArrayValue() => $_ensure(4);

  /// A list of double type feature value.
  @$pb.TagNumber(8)
  $4259.DoubleArray get doubleArrayValue => $_getN(5);
  @$pb.TagNumber(8)
  set doubleArrayValue($4259.DoubleArray v) { setField(8, v); }
  @$pb.TagNumber(8)
  $core.bool hasDoubleArrayValue() => $_has(5);
  @$pb.TagNumber(8)
  void clearDoubleArrayValue() => clearField(8);
  @$pb.TagNumber(8)
  $4259.DoubleArray ensureDoubleArrayValue() => $_ensure(5);

  /// A list of int64 type feature value.
  @$pb.TagNumber(11)
  $4259.Int64Array get int64ArrayValue => $_getN(6);
  @$pb.TagNumber(11)
  set int64ArrayValue($4259.Int64Array v) { setField(11, v); }
  @$pb.TagNumber(11)
  $core.bool hasInt64ArrayValue() => $_has(6);
  @$pb.TagNumber(11)
  void clearInt64ArrayValue() => clearField(11);
  @$pb.TagNumber(11)
  $4259.Int64Array ensureInt64ArrayValue() => $_ensure(6);

  /// A list of string type feature value.
  @$pb.TagNumber(12)
  $4259.StringArray get stringArrayValue => $_getN(7);
  @$pb.TagNumber(12)
  set stringArrayValue($4259.StringArray v) { setField(12, v); }
  @$pb.TagNumber(12)
  $core.bool hasStringArrayValue() => $_has(7);
  @$pb.TagNumber(12)
  void clearStringArrayValue() => clearField(12);
  @$pb.TagNumber(12)
  $4259.StringArray ensureStringArrayValue() => $_ensure(7);
...
class StructValue extends $pb.GeneratedMessage {
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(_omitMessageNames ? '' : 'StructValue', package: const $pb.PackageName(_omitMessageNames ? '' : 'google.cloud.aiplatform.v1'), createEmptyInstance: create)
...
class StructFieldValue extends $pb.GeneratedMessage {
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(_omitMessageNames ? '' : 'StructFieldValue', package: const $pb.PackageName(_omitMessageNames ? '' : 'google.cloud.aiplatform.v1'), createEmptyInstance: create)
...
class FeatureValueList extends $pb.GeneratedMessage {
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(_omitMessageNames ? '' : 'FeatureValueList', package: const $pb.PackageName(_omitMessageNames ? '' : 'google.cloud.aiplatform.v1'), createEmptyInstance: create)
