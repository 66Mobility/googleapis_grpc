...
class VideoObjectTrackingPredictionResult_Frame extends $pb.GeneratedMessage {
  factory VideoObjectTrackingPredictionResult_Frame({
    ...
    $1780.FloatValue? xMin,
    $1780.FloatValue? xMax,
    $1780.FloatValue? yMin,
    $1780.FloatValue? yMax,
  }) {
    final $result = create();
    if (timeOffset != null) {
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(_omitMessageNames ? '' : 'VideoObjectTrackingPredictionResult.Frame', package: const $pb.PackageName(_omitMessageNames ? '' : 'google.cloud.aiplatform.v1.schema.predict.prediction'), createEmptyInstance: create)
    ..aOM<$1737.Duration>(1, _omitFieldNames ? '' : 'timeOffset', subBuilder: $1737.Duration.create)
    ..aOM<$1780.FloatValue>(2, _omitFieldNames ? '' : 'xMin', subBuilder: $1780.FloatValue.create)
    ..aOM<$1780.FloatValue>(3, _omitFieldNames ? '' : 'xMax', subBuilder: $1780.FloatValue.create)
    ..aOM<$1780.FloatValue>(4, _omitFieldNames ? '' : 'yMin', subBuilder: $1780.FloatValue.create)
    ..aOM<$1780.FloatValue>(5, _omitFieldNames ? '' : 'yMax', subBuilder: $1780.FloatValue.create)
  ...
  @$pb.TagNumber(2)
  $1780.FloatValue get xMin => $_getN(1);
  @$pb.TagNumber(2)
  set xMin($1780.FloatValue v) { setField(2, v); }
  @$pb.TagNumber(2)
  $core.bool hasXMin() => $_has(1);
  @$pb.TagNumber(2)
  void clearXMin() => clearField(2);
  @$pb.TagNumber(2)
  $1780.FloatValue ensureXMin() => $_ensure(1);

  /// The rightmost coordinate of the bounding box.
  @$pb.TagNumber(3)
  $1780.FloatValue get xMax => $_getN(2);
  @$pb.TagNumber(3)
  set xMax($1780.FloatValue v) { setField(3, v); }
  @$pb.TagNumber(3)
  $core.bool hasXMax() => $_has(2);
  @$pb.TagNumber(3)
  void clearXMax() => clearField(3);
  @$pb.TagNumber(3)
  $1780.FloatValue ensureXMax() => $_ensure(2);

  /// The topmost coordinate of the bounding box.
  @$pb.TagNumber(4)
  $1780.FloatValue get yMin => $_getN(3);
  @$pb.TagNumber(4)
  set yMin($1780.FloatValue v) { setField(4, v); }
  @$pb.TagNumber(4)
  $core.bool hasYMin() => $_has(3);
  @$pb.TagNumber(4)
  void clearYMin() => clearField(4);
  @$pb.TagNumber(4)
  $1780.FloatValue ensureYMin() => $_ensure(3);

  /// The bottommost coordinate of the bounding box.
  @$pb.TagNumber(5)
  $1780.FloatValue get yMax => $_getN(4);
  @$pb.TagNumber(5)
  set yMax($1780.FloatValue v) { setField(5, v); }
  @$pb.TagNumber(5)
  $core.bool hasYMax() => $_has(4);
  @$pb.TagNumber(5)
  void clearYMax() => clearField(5);
  @$pb.TagNumber(5)
  $1780.FloatValue ensureYMax() => $_ensure(4);
}
...
class VideoObjectTrackingPredictionResult extends $pb.GeneratedMessage {
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(_omitMessageNames ? '' : 'VideoObjectTrackingPredictionResult', package: const $pb.PackageName(_omitMessageNames ? '' : 'google.cloud.aiplatform.v1.schema.predict.prediction'), createEmptyInstance: create)
    ..aOS(1, _omitFieldNames ? '' : 'id')
    ..aOS(2, _omitFieldNames ? '' : 'displayName')
    ..aOM<$1737.Duration>(3, _omitFieldNames ? '' : 'timeSegmentStart', subBuilder: $1737.Duration.create)
    ..aOM<$1737.Duration>(4, _omitFieldNames ? '' : 'timeSegmentEnd', subBuilder: $1737.Duration.create)
    ..aOM<$1780.FloatValue>(5, _omitFieldNames ? '' : 'confidence', subBuilder: $1780.FloatValue.create)
  ...
  @$pb.TagNumber(3)
  set timeSegmentStart($1737.Duration v) { setField(3, v); }
  @$pb.TagNumber(3)
  ...
  @$pb.TagNumber(4)
  set timeSegmentEnd($1737.Duration v) { setField(4, v); }
  @$pb.TagNumber(4)
  ...
  @$pb.TagNumber(5)
  set confidence($1780.FloatValue v) { setField(5, v); }
  @$pb.TagNumber(5)
