...
class VideoClassificationPredictionResult extends $pb.GeneratedMessage {
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(_omitMessageNames ? '' : 'VideoClassificationPredictionResult', package: const $pb.PackageName(_omitMessageNames ? '' : 'google.cloud.aiplatform.v1.schema.predict.prediction'), createEmptyInstance: create)
  ...
  @$pb.TagNumber(4)
  $1737.Duration get timeSegmentStart => $_getN(3);
  @$pb.TagNumber(4)
  ...
  @$pb.TagNumber(4)
  $1737.Duration ensureTimeSegmentStart() => $_ensure(3);
  ...
  @$pb.TagNumber(5)
  $1737.Duration get timeSegmentEnd => $_getN(4);
  @$pb.TagNumber(5)
  ...
  @$pb.TagNumber(5)
  $1737.Duration ensureTimeSegmentEnd() => $_ensure(4);

  /// The Model's confidence in correction of this prediction, higher
  /// value means higher confidence.
  @$pb.TagNumber(6)
  $1780.FloatValue get confidence => $_getN(5);
  @$pb.TagNumber(6)
  ...
  @$pb.TagNumber(6)
  $1780.FloatValue ensureConfidence() => $_ensure(5);
}
