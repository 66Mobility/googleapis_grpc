...
class CreateTuningJobRequest extends $pb.GeneratedMessage {
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(_omitMessageNames ? '' : 'CreateTuningJobRequest', package: const $pb.PackageName(_omitMessageNames ? '' : 'google.cloud.aiplatform.v1'), createEmptyInstance: create)
    ..aOS(1, _omitFieldNames ? '' : 'parent')
    ..aOM<$505.TuningJob>(2, _omitFieldNames ? '' : 'tuningJob', subBuilder: $505.TuningJob.create)
  ...
  @$pb.TagNumber(2)
  $505.TuningJob get tuningJob => $_getN(1);
  @$pb.TagNumber(2)
  set tuningJob($505.TuningJob v) { setField(2, v); }
  @$pb.TagNumber(2)
  $core.bool hasTuningJob() => $_has(1);
  @$pb.TagNumber(2)
  void clearTuningJob() => clearField(2);
  @$pb.TagNumber(2)
  $505.TuningJob ensureTuningJob() => $_ensure(1);
}
...
class GetTuningJobRequest extends $pb.GeneratedMessage {
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(_omitMessageNames ? '' : 'GetTuningJobRequest', package: const $pb.PackageName(_omitMessageNames ? '' : 'google.cloud.aiplatform.v1'), createEmptyInstance: create)
...
class ListTuningJobsRequest extends $pb.GeneratedMessage {
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(_omitMessageNames ? '' : 'ListTuningJobsRequest', package: const $pb.PackageName(_omitMessageNames ? '' : 'google.cloud.aiplatform.v1'), createEmptyInstance: create)
    ..aOS(1, _omitFieldNames ? '' : 'parent')
...
class ListTuningJobsResponse extends $pb.GeneratedMessage {
  factory ListTuningJobsResponse({
    $core.Iterable<$505.TuningJob>? tuningJobs,
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(_omitMessageNames ? '' : 'ListTuningJobsResponse', package: const $pb.PackageName(_omitMessageNames ? '' : 'google.cloud.aiplatform.v1'), createEmptyInstance: create)
    ..pc<$505.TuningJob>(1, _omitFieldNames ? '' : 'tuningJobs', $pb.PbFieldType.PM, subBuilder: $505.TuningJob.create)
  ...
  @$pb.TagNumber(1)
  $core.List<$505.TuningJob> get tuningJobs => $_getList(0);
...
class CancelTuningJobRequest extends $pb.GeneratedMessage {
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(_omitMessageNames ? '' : 'CancelTuningJobRequest', package: const $pb.PackageName(_omitMessageNames ? '' : 'google.cloud.aiplatform.v1'), createEmptyInstance: create)
    ..aOS(1, _omitFieldNames ? '' : 'name')
    ..hasRequiredFields = false
  ;
