...
class ModelEvaluation_ModelEvaluationExplanationSpec extends $pb.GeneratedMessage {
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(_omitMessageNames ? '' : 'ModelEvaluation.ModelEvaluationExplanationSpec', package: const $pb.PackageName(_omitMessageNames ? '' : 'google.cloud.aiplatform.v1'), createEmptyInstance: create)
    ...
    ..aOM<$4239.ExplanationSpec>(2, _omitFieldNames ? '' : 'explanationSpec', subBuilder: $4239.ExplanationSpec.create)
  ...
  @$pb.TagNumber(2)
  $4239.ExplanationSpec get explanationSpec => $_getN(1);
  @$pb.TagNumber(2)
  set explanationSpec($4239.ExplanationSpec v) { setField(2, v); }
  @$pb.TagNumber(2)
  $core.bool hasExplanationSpec() => $_has(1);
  @$pb.TagNumber(2)
  void clearExplanationSpec() => clearField(2);
  @$pb.TagNumber(2)
  $4239.ExplanationSpec ensureExplanationSpec() => $_ensure(1);
}
...
class ModelEvaluation extends $pb.GeneratedMessage {
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(_omitMessageNames ? '' : 'ModelEvaluation', package: const $pb.PackageName(_omitMessageNames ? '' : 'google.cloud.aiplatform.v1'), createEmptyInstance: create)
    ...
    ..aOM<$4239.ModelExplanation>(8, _omitFieldNames ? '' : 'modelExplanation', subBuilder: $4239.ModelExplanation.create)
  ...
  @$pb.TagNumber(8)
  $4239.ModelExplanation get modelExplanation => $_getN(7);
  @$pb.TagNumber(8)
  set modelExplanation($4239.ModelExplanation v) { setField(8, v); }
  @$pb.TagNumber(8)
  $core.bool hasModelExplanation() => $_has(7);
  @$pb.TagNumber(8)
  void clearModelExplanation() => clearField(8);
  @$pb.TagNumber(8)
  $4239.ModelExplanation ensureModelExplanation() => $_ensure(7);
  ...
  @$pb.TagNumber(11)
  $1734.Value get metadata => $_getN(10);
  @$pb.TagNumber(11)
  ...
  @$pb.TagNumber(11)
  $1734.Value ensureMetadata() => $_ensure(10);
}
