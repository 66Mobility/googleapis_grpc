...
class UpdateSpecialistPoolOperationMetadata extends $pb.GeneratedMessage {
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(_omitMessageNames ? '' : 'UpdateSpecialistPoolOperationMetadata', package: const $pb.PackageName(_omitMessageNames ? '' : 'google.cloud.aiplatform.v1'), createEmptyInstance: create)
    ...
    ..aOM<$4250.GenericOperationMetadata>(2, _omitFieldNames ? '' : 'genericMetadata', subBuilder: $4250.GenericOperationMetadata.create)
    ..hasRequiredFields = false
  ;
  ...
  /// The operation generic information.
  @$pb.TagNumber(2)
  $4250.GenericOperationMetadata get genericMetadata => $_getN(1);
  @$pb.TagNumber(2)
  set genericMetadata($4250.GenericOperationMetadata v) { setField(2, v); }
  @$pb.TagNumber(2)
  $core.bool hasGenericMetadata() => $_has(1);
  @$pb.TagNumber(2)
  void clearGenericMetadata() => clearField(2);
  @$pb.TagNumber(2)
  $4250.GenericOperationMetadata ensureGenericMetadata() => $_ensure(1);
}
