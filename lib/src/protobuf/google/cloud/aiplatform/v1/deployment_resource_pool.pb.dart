...
class DeploymentResourcePool extends $pb.GeneratedMessage {
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(_omitMessageNames ? '' : 'DeploymentResourcePool', package: const $pb.PackageName(_omitMessageNames ? '' : 'google.cloud.aiplatform.v1'), createEmptyInstance: create)
    ..aOS(1, _omitFieldNames ? '' : 'name')
    ..aOM<$4242.DedicatedResources>(2, _omitFieldNames ? '' : 'dedicatedResources', subBuilder: $4242.DedicatedResources.create)
  ...
  /// uses.
  @$pb.TagNumber(2)
  $4242.DedicatedResources get dedicatedResources => $_getN(1);
  @$pb.TagNumber(2)
  set dedicatedResources($4242.DedicatedResources v) { setField(2, v); }
  @$pb.TagNumber(2)
  $core.bool hasDedicatedResources() => $_has(1);
  @$pb.TagNumber(2)
  void clearDedicatedResources() => clearField(2);
  @$pb.TagNumber(2)
  $4242.DedicatedResources ensureDedicatedResources() => $_ensure(1);
