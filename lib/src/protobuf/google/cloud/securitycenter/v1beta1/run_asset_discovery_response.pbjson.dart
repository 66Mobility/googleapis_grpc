...
const RunAssetDiscoveryResponse$json = {
  ...
  '2': [
    {'1': 'state', '3': 1, '4': 1, '5': 14, '6': '.google.cloud.securitycenter.v1beta1.RunAssetDiscoveryResponse.State', '10': 'state'},
...
final $typed_data.Uint8List runAssetDiscoveryResponseDescriptor = $convert.base64Decode(
    'ChlSdW5Bc3NldERpc2NvdmVyeVJlc3BvbnNlEloKBXN0YXRlGAEgASgOMkQuZ29vZ2xlLmNsb3'
    'VkLnNlY3VyaXR5Y2VudGVyLnYxYmV0YTEuUnVuQXNzZXREaXNjb3ZlcnlSZXNwb25zZS5TdGF0'
    'ZVIFc3RhdGUSNQoIZHVyYXRpb24YAiABKAsyGS5nb29nbGUucHJvdG9idWYuRHVyYXRpb25SCG'
    'R1cmF0aW9uIk0KBVN0YXRlEhUKEVNUQVRFX1VOU1BFQ0lGSUVEEAASDQoJQ09NUExFVEVEEAES'
    'DgoKU1VQRVJTRURFRBACEg4KClRFUk1JTkFURUQQAw==');
