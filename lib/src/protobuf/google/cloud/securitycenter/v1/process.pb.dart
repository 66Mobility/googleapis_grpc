...
class Process extends $pb.GeneratedMessage {
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(_omitMessageNames ? '' : 'Process', package: const $pb.PackageName(_omitMessageNames ? '' : 'google.cloud.securitycenter.v1'), createEmptyInstance: create)
    ...
    ..aOB(9, _omitFieldNames ? '' : 'envVariablesTruncated')
    ..aInt64(10, _omitFieldNames ? '' : 'pid')
    ..aInt64(11, _omitFieldNames ? '' : 'parentPid')
  ...
  @$pb.TagNumber(7)
  $core.bool get argumentsTruncated => $_getBF(4);
  @$pb.TagNumber(7)
  set argumentsTruncated($core.bool v) { $_setBool(4, v); }
  @$pb.TagNumber(7)
  $core.bool hasArgumentsTruncated() => $_has(4);
  @$pb.TagNumber(7)
  void clearArgumentsTruncated() => clearField(7);

  /// Process environment variables.
  @$pb.TagNumber(8)
  $core.List<EnvironmentVariable> get envVariables => $_getList(5);

  /// True if `env_variables` is incomplete.
  @$pb.TagNumber(9)
  $core.bool get envVariablesTruncated => $_getBF(6);
  @$pb.TagNumber(9)
  set envVariablesTruncated($core.bool v) { $_setBool(6, v); }
  @$pb.TagNumber(9)
  $core.bool hasEnvVariablesTruncated() => $_has(6);
  @$pb.TagNumber(9)
  void clearEnvVariablesTruncated() => clearField(9);

  /// The process ID.
  @$pb.TagNumber(10)
  $fixnum.Int64 get pid => $_getI64(7);
  @$pb.TagNumber(10)
  set pid($fixnum.Int64 v) { $_setInt64(7, v); }
  @$pb.TagNumber(10)
  $core.bool hasPid() => $_has(7);
  @$pb.TagNumber(10)
  void clearPid() => clearField(10);

  /// The parent process ID.
  @$pb.TagNumber(11)
  $fixnum.Int64 get parentPid => $_getI64(8);
  @$pb.TagNumber(11)
  set parentPid($fixnum.Int64 v) { $_setInt64(8, v); }
  @$pb.TagNumber(11)
  $core.bool hasParentPid() => $_has(8);
  @$pb.TagNumber(11)
  void clearParentPid() => clearField(11);
...
class EnvironmentVariable extends $pb.GeneratedMessage {
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(_omitMessageNames ? '' : 'EnvironmentVariable', package: const $pb.PackageName(_omitMessageNames ? '' : 'google.cloud.securitycenter.v1'), createEmptyInstance: create)
