...
class NotificationMessage extends $pb.GeneratedMessage {
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(_omitMessageNames ? '' : 'NotificationMessage', package: const $pb.PackageName(_omitMessageNames ? '' : 'google.cloud.securitycenter.v1'), createEmptyInstance: create)
    ..oo(0, [2])
  ...
  /// populated.
  @$pb.TagNumber(2)
  $1344.Finding get finding => $_getN(1);
  @$pb.TagNumber(2)
  set finding($1344.Finding v) { setField(2, v); }
  @$pb.TagNumber(2)
  $core.bool hasFinding() => $_has(1);
  @$pb.TagNumber(2)
  void clearFinding() => clearField(2);
  @$pb.TagNumber(2)
  $1344.Finding ensureFinding() => $_ensure(1);
