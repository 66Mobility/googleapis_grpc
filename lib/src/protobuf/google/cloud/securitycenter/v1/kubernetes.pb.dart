...
class Kubernetes_Pod extends $pb.GeneratedMessage {
  factory Kubernetes_Pod({
    $core.String? ns,
    $core.String? name,
    $core.Iterable<$4616.Label>? labels,
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(_omitMessageNames ? '' : 'Kubernetes.Pod', package: const $pb.PackageName(_omitMessageNames ? '' : 'google.cloud.securitycenter.v1'), createEmptyInstance: create)
    ..aOS(1, _omitFieldNames ? '' : 'ns')
    ..aOS(2, _omitFieldNames ? '' : 'name')
    ..pc<$4616.Label>(3, _omitFieldNames ? '' : 'labels', $pb.PbFieldType.PM, subBuilder: $4616.Label.create)
    ..pc<$4618.Container>(4, _omitFieldNames ? '' : 'containers', $pb.PbFieldType.PM, subBuilder: $4618.Container.create)
  ...
  /// container.
  @$pb.TagNumber(3)
  $core.List<$4616.Label> get labels => $_getList(2);

  /// Pod containers associated with this finding, if any.
  @$pb.TagNumber(4)
  $core.List<$4618.Container> get containers => $_getList(3);
}
...
class Kubernetes_Node extends $pb.GeneratedMessage {
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(_omitMessageNames ? '' : 'Kubernetes.Node', package: const $pb.PackageName(_omitMessageNames ? '' : 'google.cloud.securitycenter.v1'), createEmptyInstance: create)
...
class Kubernetes_NodePool extends $pb.GeneratedMessage {
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(_omitMessageNames ? '' : 'Kubernetes.NodePool', package: const $pb.PackageName(_omitMessageNames ? '' : 'google.cloud.securitycenter.v1'), createEmptyInstance: create)
    ..aOS(1, _omitFieldNames ? '' : 'name')
...
class Kubernetes_Role extends $pb.GeneratedMessage {
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(_omitMessageNames ? '' : 'Kubernetes.Role', package: const $pb.PackageName(_omitMessageNames ? '' : 'google.cloud.securitycenter.v1'), createEmptyInstance: create)
...
class Kubernetes_Binding extends $pb.GeneratedMessage {
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(_omitMessageNames ? '' : 'Kubernetes.Binding', package: const $pb.PackageName(_omitMessageNames ? '' : 'google.cloud.securitycenter.v1'), createEmptyInstance: create)
    ..aOS(1, _omitFieldNames ? '' : 'ns')
    ..aOS(2, _omitFieldNames ? '' : 'name')
...
class Kubernetes_Subject extends $pb.GeneratedMessage {
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(_omitMessageNames ? '' : 'Kubernetes.Subject', package: const $pb.PackageName(_omitMessageNames ? '' : 'google.cloud.securitycenter.v1'), createEmptyInstance: create)
...
class Kubernetes_AccessReview extends $pb.GeneratedMessage {
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(_omitMessageNames ? '' : 'Kubernetes.AccessReview', package: const $pb.PackageName(_omitMessageNames ? '' : 'google.cloud.securitycenter.v1'), createEmptyInstance: create)
...
class Kubernetes_Object extends $pb.GeneratedMessage {
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(_omitMessageNames ? '' : 'Kubernetes.Object', package: const $pb.PackageName(_omitMessageNames ? '' : 'google.cloud.securitycenter.v1'), createEmptyInstance: create)
    ..aOS(1, _omitFieldNames ? '' : 'group')
    ..aOS(2, _omitFieldNames ? '' : 'kind')
    ..aOS(3, _omitFieldNames ? '' : 'ns')
    ..aOS(4, _omitFieldNames ? '' : 'name')
    ..pc<$4618.Container>(5, _omitFieldNames ? '' : 'containers', $pb.PbFieldType.PM, subBuilder: $4618.Container.create)
    ..hasRequiredFields = false
  ;
  ...
  /// Pod containers associated with this finding, if any.
  @$pb.TagNumber(5)
  $core.List<$4618.Container> get containers => $_getList(4);
}
...
class Kubernetes extends $pb.GeneratedMessage {
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(_omitMessageNames ? '' : 'Kubernetes', package: const $pb.PackageName(_omitMessageNames ? '' : 'google.cloud.securitycenter.v1'), createEmptyInstance: create)
