...
class ResourceValueConfig_SensitiveDataProtectionMapping extends $pb.GeneratedMessage {
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(_omitMessageNames ? '' : 'ResourceValueConfig.SensitiveDataProtectionMapping', package: const $pb.PackageName(_omitMessageNames ? '' : 'google.cloud.securitycenter.v1'), createEmptyInstance: create)
...
class ResourceValueConfig extends $pb.GeneratedMessage {
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(_omitMessageNames ? '' : 'ResourceValueConfig', package: const $pb.PackageName(_omitMessageNames ? '' : 'google.cloud.securitycenter.v1'), createEmptyInstance: create)
    ...
    ..m<$core.String, $core.String>(6, _omitFieldNames ? '' : 'resourceLabelsSelector', entryClassName: 'ResourceValueConfig.ResourceLabelsSelectorEntry', keyFieldType: $pb.PbFieldType.OS, valueFieldType: $pb.PbFieldType.OS, packageName: const $pb.PackageName('google.cloud.securitycenter.v1'))
    ...
    ..e<$4644.CloudProvider>(10, _omitFieldNames ? '' : 'cloudProvider', $pb.PbFieldType.OE, defaultOrMaker: $4644.CloudProvider.CLOUD_PROVIDER_UNSPECIFIED, valueOf: $4644.CloudProvider.valueOf, enumValues: $4644.CloudProvider.values)
  ...
  @$pb.TagNumber(10)
  $4644.CloudProvider get cloudProvider => $_getN(9);
  @$pb.TagNumber(10)
  set cloudProvider($4644.CloudProvider v) { setField(10, v); }
  @$pb.TagNumber(10)
