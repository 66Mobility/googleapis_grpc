...
class ResourceValueConfig extends $pb.GeneratedMessage {
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(_omitMessageNames ? '' : 'ResourceValueConfig', package: const $pb.PackageName(_omitMessageNames ? '' : 'google.cloud.securitycenter.v1'), createEmptyInstance: create)
    ...
    ..e<$4646.CloudProvider>(10, _omitFieldNames ? '' : 'cloudProvider', $pb.PbFieldType.OE, defaultOrMaker: $4646.CloudProvider.CLOUD_PROVIDER_UNSPECIFIED, valueOf: $4646.CloudProvider.valueOf, enumValues: $4646.CloudProvider.values)
  ...
  @$pb.TagNumber(10)
  $4646.CloudProvider get cloudProvider => $_getN(9);
  @$pb.TagNumber(10)
  set cloudProvider($4646.CloudProvider v) { setField(10, v); }
  @$pb.TagNumber(10)
