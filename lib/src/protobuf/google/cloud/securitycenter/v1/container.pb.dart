...
class Container extends $pb.GeneratedMessage {
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(_omitMessageNames ? '' : 'Container', package: const $pb.PackageName(_omitMessageNames ? '' : 'google.cloud.securitycenter.v1'), createEmptyInstance: create)
    ..aOS(1, _omitFieldNames ? '' : 'name')
    ..aOS(2, _omitFieldNames ? '' : 'uri')
    ..aOS(3, _omitFieldNames ? '' : 'imageId')
    ..pc<$4616.Label>(4, _omitFieldNames ? '' : 'labels', $pb.PbFieldType.PM, subBuilder: $4616.Label.create)
  ...
  @$pb.TagNumber(4)
  $core.List<$4616.Label> get labels => $_getList(3);
