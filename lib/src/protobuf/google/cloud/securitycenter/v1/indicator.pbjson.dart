...
const Indicator$json = {
  ...
  '2': [
    ...
    {'1': 'signatures', '3': 3, '4': 3, '5': 11, '6': '.google.cloud.securitycenter.v1.Indicator.ProcessSignature', '10': 'signatures'},
...
const Indicator_ProcessSignature$json = {
  '1': 'ProcessSignature',
  '2': [
    {'1': 'memory_hash_signature', '3': 6, '4': 1, '5': 11, '6': '.google.cloud.securitycenter.v1.Indicator.ProcessSignature.MemoryHashSignature', '9': 0, '10': 'memoryHashSignature'},
    {'1': 'yara_rule_signature', '3': 7, '4': 1, '5': 11, '6': '.google.cloud.securitycenter.v1.Indicator.ProcessSignature.YaraRuleSignature', '9': 0, '10': 'yaraRuleSignature'},
    {'1': 'signature_type', '3': 8, '4': 1, '5': 14, '6': '.google.cloud.securitycenter.v1.Indicator.ProcessSignature.SignatureType', '10': 'signatureType'},
  ],
...
const Indicator_ProcessSignature_MemoryHashSignature$json = {
  ...
  '2': [
    ...
    {'1': 'detections', '3': 4, '4': 3, '5': 11, '6': '.google.cloud.securitycenter.v1.Indicator.ProcessSignature.MemoryHashSignature.Detection', '10': 'detections'},
  ],
...
final $typed_data.Uint8List indicatorDescriptor = $convert.base64Decode(
    ...
    'dXJpdHljZW50ZXIudjEuSW5kaWNhdG9yLlByb2Nlc3NTaWduYXR1cmVSCnNpZ25hdHVyZXMSEg'
    'oEdXJpcxgEIAMoCVIEdXJpcxq/BgoQUHJvY2Vzc1NpZ25hdHVyZRKEAQoVbWVtb3J5X2hhc2hf'
    'c2lnbmF0dXJlGAYgASgLMk4uZ29vZ2xlLmNsb3VkLnNlY3VyaXR5Y2VudGVyLnYxLkluZGljYX'
    ...
    'VyaXR5Y2VudGVyLnYxLkluZGljYXRvci5Qcm9jZXNzU2lnbmF0dXJlLllhcmFSdWxlU2lnbmF0'
    'dXJlSABSEXlhcmFSdWxlU2lnbmF0dXJlEm8KDnNpZ25hdHVyZV90eXBlGAggASgOMkguZ29vZ2'
    'xlLmNsb3VkLnNlY3VyaXR5Y2VudGVyLnYxLkluZGljYXRvci5Qcm9jZXNzU2lnbmF0dXJlLlNp'
    ...
    'b29nbGUuY2xvdWQuc2VjdXJpdHljZW50ZXIudjEuSW5kaWNhdG9yLlByb2Nlc3NTaWduYXR1cm'
