...
const LogEntry$json = {
  '1': 'LogEntry',
  '2': [
    {'1': 'cloud_logging_entry', '3': 1, '4': 1, '5': 11, '6': '.google.cloud.securitycenter.v1.CloudLoggingEntry', '9': 0, '10': 'cloudLoggingEntry'},
  ],
  '8': [
    {'1': 'log_entry'},
  ],
...
final $typed_data.Uint8List logEntryDescriptor = $convert.base64Decode(
    ...
    'NlY3VyaXR5Y2VudGVyLnYxLkNsb3VkTG9nZ2luZ0VudHJ5SABSEWNsb3VkTG9nZ2luZ0VudHJ5'
    'QgsKCWxvZ19lbnRyeQ==');
