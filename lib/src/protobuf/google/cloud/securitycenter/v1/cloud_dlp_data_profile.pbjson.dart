...
const CloudDlpDataProfile$json = {
  ...
  '2': [
    ...
    {'1': 'parent_type', '3': 2, '4': 1, '5': 14, '6': '.google.cloud.securitycenter.v1.CloudDlpDataProfile.ParentType', '10': 'parentType'},
  ],
...
final $typed_data.Uint8List cloudDlpDataProfileDescriptor = $convert.base64Decode(
    ...
    'cGUYAiABKA4yPi5nb29nbGUuY2xvdWQuc2VjdXJpdHljZW50ZXIudjEuQ2xvdWREbHBEYXRhUH'
