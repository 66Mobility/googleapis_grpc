...
const NotificationMessage$json = {
  ...
  '2': [
    ...
    {'1': 'finding', '3': 2, '4': 1, '5': 11, '6': '.google.cloud.securitycenter.v1.Finding', '9': 0, '10': 'finding'},
    {'1': 'resource', '3': 3, '4': 1, '5': 11, '6': '.google.cloud.securitycenter.v1.Resource', '10': 'resource'},
  ],
  '8': [
    {'1': 'event'},
  ],
...
final $typed_data.Uint8List notificationMessageDescriptor = $convert.base64Decode(
    ...
    'LnNlY3VyaXR5Y2VudGVyLnYxLkZpbmRpbmdIAFIHZmluZGluZxJECghyZXNvdXJjZRgDIAEoCz'
    'IoLmdvb2dsZS5jbG91ZC5zZWN1cml0eWNlbnRlci52MS5SZXNvdXJjZVIIcmVzb3VyY2VCBwoF'
    'ZXZlbnQ=');
