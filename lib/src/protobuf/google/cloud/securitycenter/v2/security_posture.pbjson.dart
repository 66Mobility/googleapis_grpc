...
const SecurityPosture$json = {
  ...
  '2': [
    ...
    {'1': 'policy_drift_details', '3': 8, '4': 3, '5': 11, '6': '.google.cloud.securitycenter.v2.SecurityPosture.PolicyDriftDetails', '10': 'policyDriftDetails'},
  ],
...
final $typed_data.Uint8List securityPostureDescriptor = $convert.base64Decode(
    ...
    'ZXIudjIuU2VjdXJpdHlQb3N0dXJlLlBvbGljeURyaWZ0RGV0YWlsc1IScG9saWN5RHJpZnREZX'
