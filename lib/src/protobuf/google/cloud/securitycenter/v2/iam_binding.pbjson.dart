...
const IamBinding$json = {
  '1': 'IamBinding',
  '2': [
    {'1': 'action', '3': 1, '4': 1, '5': 14, '6': '.google.cloud.securitycenter.v2.IamBinding.Action', '10': 'action'},
...
final $typed_data.Uint8List iamBindingDescriptor = $convert.base64Decode(
    ...
    'Rlci52Mi5JYW1CaW5kaW5nLkFjdGlvblIGYWN0aW9uEhIKBHJvbGUYAiABKAlSBHJvbGUSFgoG'
