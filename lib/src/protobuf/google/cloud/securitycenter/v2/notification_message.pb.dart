...
class NotificationMessage extends $pb.GeneratedMessage {
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(_omitMessageNames ? '' : 'NotificationMessage', package: const $pb.PackageName(_omitMessageNames ? '' : 'google.cloud.securitycenter.v2'), createEmptyInstance: create)
    ...
    ..aOM<$4682.Resource>(3, _omitFieldNames ? '' : 'resource', subBuilder: $4682.Resource.create)
  ...
  @$pb.TagNumber(3)
  $4682.Resource get resource => $_getN(2);
  @$pb.TagNumber(3)
  set resource($4682.Resource v) { setField(3, v); }
  @$pb.TagNumber(3)
  $core.bool hasResource() => $_has(2);
  @$pb.TagNumber(3)
  void clearResource() => clearField(3);
  @$pb.TagNumber(3)
  $4682.Resource ensureResource() => $_ensure(2);
}
