...
const Connection$json = {
  ...
  '2': [
    ...
    {'1': 'protocol', '3': 5, '4': 1, '5': 14, '6': '.google.cloud.securitycenter.v2.Connection.Protocol', '10': 'protocol'},
  ],
...
final $typed_data.Uint8List connectionDescriptor = $convert.base64Decode(
    ...
    '9sGAUgASgOMjMuZ29vZ2xlLmNsb3VkLnNlY3VyaXR5Y2VudGVyLnYyLkNvbm5lY3Rpb24uUHJv'
