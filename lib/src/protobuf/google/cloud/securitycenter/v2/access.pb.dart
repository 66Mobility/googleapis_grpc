...
class Access extends $pb.GeneratedMessage {
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(_omitMessageNames ? '' : 'Access', package: const $pb.PackageName(_omitMessageNames ? '' : 'google.cloud.securitycenter.v2'), createEmptyInstance: create)
    ...
    ..aOS(6, _omitFieldNames ? '' : 'serviceName')
    ..aOS(7, _omitFieldNames ? '' : 'methodName')
    ..aOS(8, _omitFieldNames ? '' : 'principalSubject')
    ..aOS(9, _omitFieldNames ? '' : 'serviceAccountKeyName')
    ..pc<ServiceAccountDelegationInfo>(10, _omitFieldNames ? '' : 'serviceAccountDelegationInfo', $pb.PbFieldType.PM, subBuilder: ServiceAccountDelegationInfo.create)
  ...
  @$pb.TagNumber(7)
  $core.String get methodName => $_getSZ(6);
  @$pb.TagNumber(7)
  set methodName($core.String v) { $_setString(6, v); }
  @$pb.TagNumber(7)
  $core.bool hasMethodName() => $_has(6);
  @$pb.TagNumber(7)
  void clearMethodName() => clearField(7);
  ...
  /// name}[{subject}]`.
  @$pb.TagNumber(8)
  $core.String get principalSubject => $_getSZ(7);
  @$pb.TagNumber(8)
  set principalSubject($core.String v) { $_setString(7, v); }
  @$pb.TagNumber(8)
  $core.bool hasPrincipalSubject() => $_has(7);
  @$pb.TagNumber(8)
  ...
  @$pb.TagNumber(9)
  $core.String get serviceAccountKeyName => $_getSZ(8);
  @$pb.TagNumber(9)
  set serviceAccountKeyName($core.String v) { $_setString(8, v); }
  @$pb.TagNumber(9)
  $core.bool hasServiceAccountKeyName() => $_has(8);
  @$pb.TagNumber(9)
  void clearServiceAccountKeyName() => clearField(9);
  ...
  @$pb.TagNumber(10)
  $core.List<ServiceAccountDelegationInfo> get serviceAccountDelegationInfo => $_getList(9);
...
class ServiceAccountDelegationInfo extends $pb.GeneratedMessage {
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(_omitMessageNames ? '' : 'ServiceAccountDelegationInfo', package: const $pb.PackageName(_omitMessageNames ? '' : 'google.cloud.securitycenter.v2'), createEmptyInstance: create)
    ..aOS(1, _omitFieldNames ? '' : 'principalEmail')
...
class Geolocation extends $pb.GeneratedMessage {
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(_omitMessageNames ? '' : 'Geolocation', package: const $pb.PackageName(_omitMessageNames ? '' : 'google.cloud.securitycenter.v2'), createEmptyInstance: create)
