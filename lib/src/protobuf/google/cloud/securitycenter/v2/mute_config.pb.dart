...
class MuteConfig extends $pb.GeneratedMessage {
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(_omitMessageNames ? '' : 'MuteConfig', package: const $pb.PackageName(_omitMessageNames ? '' : 'google.cloud.securitycenter.v2'), createEmptyInstance: create)
    ..aOS(1, _omitFieldNames ? '' : 'name')
    ..aOS(2, _omitFieldNames ? '' : 'description')
    ..aOS(3, _omitFieldNames ? '' : 'filter')
    ..aOM<$1776.Timestamp>(4, _omitFieldNames ? '' : 'createTime', subBuilder: $1776.Timestamp.create)
    ..aOM<$1776.Timestamp>(5, _omitFieldNames ? '' : 'updateTime', subBuilder: $1776.Timestamp.create)
    ..aOS(6, _omitFieldNames ? '' : 'mostRecentEditor')
  ...
  /// creation or update.
  @$pb.TagNumber(6)
  $core.String get mostRecentEditor => $_getSZ(5);
  @$pb.TagNumber(6)
  set mostRecentEditor($core.String v) { $_setString(5, v); }
  @$pb.TagNumber(6)
  $core.bool hasMostRecentEditor() => $_has(5);
  @$pb.TagNumber(6)
  void clearMostRecentEditor() => clearField(6);

  /// Required. The type of the mute config, which determines what type of mute
  /// state the config affects. Immutable after creation.
  @$pb.TagNumber(8)
  MuteConfig_MuteConfigType get type => $_getN(6);
  @$pb.TagNumber(8)
  ...
  /// all findings.
  @$pb.TagNumber(9)
  $1776.Timestamp get expiryTime => $_getN(7);
  @$pb.TagNumber(9)
  set expiryTime($1776.Timestamp v) { setField(9, v); }
  @$pb.TagNumber(9)
  $core.bool hasExpiryTime() => $_has(7);
  @$pb.TagNumber(9)
  void clearExpiryTime() => clearField(9);
  @$pb.TagNumber(9)
  $1776.Timestamp ensureExpiryTime() => $_ensure(7);
}
