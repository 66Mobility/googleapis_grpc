...
class Asset_SecurityCenterProperties extends $pb.GeneratedMessage {
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(_omitMessageNames ? '' : 'Asset.SecurityCenterProperties', package: const $pb.PackageName(_omitMessageNames ? '' : 'google.cloud.securitycenter.v1p1beta1'), createEmptyInstance: create)
...
class Asset_IamPolicy extends $pb.GeneratedMessage {
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(_omitMessageNames ? '' : 'Asset.IamPolicy', package: const $pb.PackageName(_omitMessageNames ? '' : 'google.cloud.securitycenter.v1p1beta1'), createEmptyInstance: create)
...
class Asset extends $pb.GeneratedMessage {
  ...
  @$pb.TagNumber(8)
  $1367.SecurityMarks get securityMarks => $_getN(3);
  @$pb.TagNumber(8)
  ...
  @$pb.TagNumber(8)
  $1367.SecurityMarks ensureSecurityMarks() => $_ensure(3);
