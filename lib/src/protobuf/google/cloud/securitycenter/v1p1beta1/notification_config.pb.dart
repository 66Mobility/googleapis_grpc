...
class NotificationConfig_StreamingConfig extends $pb.GeneratedMessage {
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(_omitMessageNames ? '' : 'NotificationConfig.StreamingConfig', package: const $pb.PackageName(_omitMessageNames ? '' : 'google.cloud.securitycenter.v1p1beta1'), createEmptyInstance: create)
...
class NotificationConfig extends $pb.GeneratedMessage {
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(_omitMessageNames ? '' : 'NotificationConfig', package: const $pb.PackageName(_omitMessageNames ? '' : 'google.cloud.securitycenter.v1p1beta1'), createEmptyInstance: create)
    ..oo(0, [6])
    ..aOS(1, _omitFieldNames ? '' : 'name')
    ..aOS(2, _omitFieldNames ? '' : 'description')
    ..e<NotificationConfig_EventType>(3, _omitFieldNames ? '' : 'eventType', $pb.PbFieldType.OE, defaultOrMaker: NotificationConfig_EventType.EVENT_TYPE_UNSPECIFIED, valueOf: NotificationConfig_EventType.valueOf, enumValues: NotificationConfig_EventType.values)
    ..aOS(4, _omitFieldNames ? '' : 'pubsubTopic')
    ..aOS(5, _omitFieldNames ? '' : 'serviceAccount')
    ..aOM<NotificationConfig_StreamingConfig>(6, _omitFieldNames ? '' : 'streamingConfig', subBuilder: NotificationConfig_StreamingConfig.create)
    ..hasRequiredFields = false
  ;
