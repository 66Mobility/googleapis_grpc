...
import 'resource.pb.dart' as $4650;
...
class NotificationMessage extends $pb.GeneratedMessage {
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(_omitMessageNames ? '' : 'NotificationMessage', package: const $pb.PackageName(_omitMessageNames ? '' : 'google.cloud.securitycenter.v1p1beta1'), createEmptyInstance: create)
    ..oo(0, [2])
    ..aOS(1, _omitFieldNames ? '' : 'notificationConfigName')
    ..aOM<$1364.Finding>(2, _omitFieldNames ? '' : 'finding', subBuilder: $1364.Finding.create)
    ..aOM<$4650.Resource>(3, _omitFieldNames ? '' : 'resource', subBuilder: $4650.Resource.create)
  ...
  /// populated.
  @$pb.TagNumber(2)
  $1364.Finding get finding => $_getN(1);
  @$pb.TagNumber(2)
  set finding($1364.Finding v) { setField(2, v); }
  @$pb.TagNumber(2)
  $core.bool hasFinding() => $_has(1);
  @$pb.TagNumber(2)
  void clearFinding() => clearField(2);
  @$pb.TagNumber(2)
  $1364.Finding ensureFinding() => $_ensure(1);

  /// The Cloud resource tied to the notification.
  @$pb.TagNumber(3)
  $4650.Resource get resource => $_getN(2);
  @$pb.TagNumber(3)
  set resource($4650.Resource v) { setField(3, v); }
  @$pb.TagNumber(3)
  $core.bool hasResource() => $_has(2);
  @$pb.TagNumber(3)
  void clearResource() => clearField(3);
  @$pb.TagNumber(3)
  $4650.Resource ensureResource() => $_ensure(2);
}
