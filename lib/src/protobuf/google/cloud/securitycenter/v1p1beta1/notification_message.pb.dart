...
import 'resource.pb.dart' as $4652;
...
class NotificationMessage extends $pb.GeneratedMessage {
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(_omitMessageNames ? '' : 'NotificationMessage', package: const $pb.PackageName(_omitMessageNames ? '' : 'google.cloud.securitycenter.v1p1beta1'), createEmptyInstance: create)
    ...
    ..aOM<$4652.Resource>(3, _omitFieldNames ? '' : 'resource', subBuilder: $4652.Resource.create)
  ...
  @$pb.TagNumber(3)
  $4652.Resource get resource => $_getN(2);
  @$pb.TagNumber(3)
  set resource($4652.Resource v) { setField(3, v); }
  @$pb.TagNumber(3)
  $core.bool hasResource() => $_has(2);
  @$pb.TagNumber(3)
  void clearResource() => clearField(3);
  @$pb.TagNumber(3)
  $4652.Resource ensureResource() => $_ensure(2);
}
