...
const NotificationMessage$json = {
  ...
  '2': [
    ...
    {'1': 'finding', '3': 2, '4': 1, '5': 11, '6': '.google.cloud.securitycenter.v1p1beta1.Finding', '9': 0, '10': 'finding'},
    {'1': 'resource', '3': 3, '4': 1, '5': 11, '6': '.google.cloud.securitycenter.v1p1beta1.Resource', '10': 'resource'},
  ],
  '8': [
    {'1': 'event'},
  ],
...
final $typed_data.Uint8List notificationMessageDescriptor = $convert.base64Decode(
    ...
    'IWbm90aWZpY2F0aW9uQ29uZmlnTmFtZRJKCgdmaW5kaW5nGAIgASgLMi4uZ29vZ2xlLmNsb3Vk'
    'LnNlY3VyaXR5Y2VudGVyLnYxcDFiZXRhMS5GaW5kaW5nSABSB2ZpbmRpbmcSSwoIcmVzb3VyY2'
    'UYAyABKAsyLy5nb29nbGUuY2xvdWQuc2VjdXJpdHljZW50ZXIudjFwMWJldGExLlJlc291cmNl'
    'UghyZXNvdXJjZUIHCgVldmVudA==');
