...
class SynthesizeLongAudioRequest extends $pb.GeneratedMessage {
  factory SynthesizeLongAudioRequest({
    $core.String? parent,
    $1452.SynthesisInput? input,
    $1452.AudioConfig? audioConfig,
    $core.String? outputGcsUri,
    $1452.VoiceSelectionParams? voice,
  }) {
    final $result = create();
    if (parent != null) {
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(_omitMessageNames ? '' : 'SynthesizeLongAudioRequest', package: const $pb.PackageName(_omitMessageNames ? '' : 'google.cloud.texttospeech.v1beta1'), createEmptyInstance: create)
    ..aOS(1, _omitFieldNames ? '' : 'parent')
    ..aOM<$1452.SynthesisInput>(2, _omitFieldNames ? '' : 'input', subBuilder: $1452.SynthesisInput.create)
    ..aOM<$1452.AudioConfig>(3, _omitFieldNames ? '' : 'audioConfig', subBuilder: $1452.AudioConfig.create)
    ..aOS(4, _omitFieldNames ? '' : 'outputGcsUri')
    ..aOM<$1452.VoiceSelectionParams>(5, _omitFieldNames ? '' : 'voice', subBuilder: $1452.VoiceSelectionParams.create)
  ...
  @$pb.TagNumber(2)
  $1452.SynthesisInput get input => $_getN(1);
  @$pb.TagNumber(2)
  set input($1452.SynthesisInput v) { setField(2, v); }
  @$pb.TagNumber(2)
  $core.bool hasInput() => $_has(1);
  @$pb.TagNumber(2)
  void clearInput() => clearField(2);
  @$pb.TagNumber(2)
  $1452.SynthesisInput ensureInput() => $_ensure(1);

  /// Required. The configuration of the synthesized audio.
  @$pb.TagNumber(3)
  $1452.AudioConfig get audioConfig => $_getN(2);
  @$pb.TagNumber(3)
  set audioConfig($1452.AudioConfig v) { setField(3, v); }
  @$pb.TagNumber(3)
  $core.bool hasAudioConfig() => $_has(2);
  @$pb.TagNumber(3)
  void clearAudioConfig() => clearField(3);
  @$pb.TagNumber(3)
  $1452.AudioConfig ensureAudioConfig() => $_ensure(2);
  ...
  @$pb.TagNumber(5)
  $1452.VoiceSelectionParams get voice => $_getN(4);
  @$pb.TagNumber(5)
  set voice($1452.VoiceSelectionParams v) { setField(5, v); }
  @$pb.TagNumber(5)
  $core.bool hasVoice() => $_has(4);
  @$pb.TagNumber(5)
  void clearVoice() => clearField(5);
  @$pb.TagNumber(5)
  $1452.VoiceSelectionParams ensureVoice() => $_ensure(4);
}
...
class SynthesizeLongAudioResponse extends $pb.GeneratedMessage {
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(_omitMessageNames ? '' : 'SynthesizeLongAudioResponse', package: const $pb.PackageName(_omitMessageNames ? '' : 'google.cloud.texttospeech.v1beta1'), createEmptyInstance: create)
    ..hasRequiredFields = false
  ;
