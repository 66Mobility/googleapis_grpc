...
class AudioEncoding extends $pb.ProtobufEnum {
  ...
  static const AudioEncoding MP3_64_KBPS = AudioEncoding._(4, _omitEnumNames ? '' : 'MP3_64_KBPS');
...
class SynthesizeSpeechRequest_TimepointType extends $pb.ProtobufEnum {
  static const SynthesizeSpeechRequest_TimepointType TIMEPOINT_TYPE_UNSPECIFIED = SynthesizeSpeechRequest_TimepointType._(0, _omitEnumNames ? '' : 'TIMEPOINT_TYPE_UNSPECIFIED');
  static const SynthesizeSpeechRequest_TimepointType SSML_MARK = SynthesizeSpeechRequest_TimepointType._(1, _omitEnumNames ? '' : 'SSML_MARK');
