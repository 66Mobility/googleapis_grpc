...
class ListVoicesRequest extends $pb.GeneratedMessage {
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(_omitMessageNames ? '' : 'ListVoicesRequest', package: const $pb.PackageName(_omitMessageNames ? '' : 'google.cloud.texttospeech.v1beta1'), createEmptyInstance: create)
...
class ListVoicesResponse extends $pb.GeneratedMessage {
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(_omitMessageNames ? '' : 'ListVoicesResponse', package: const $pb.PackageName(_omitMessageNames ? '' : 'google.cloud.texttospeech.v1beta1'), createEmptyInstance: create)
...
class Voice extends $pb.GeneratedMessage {
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(_omitMessageNames ? '' : 'Voice', package: const $pb.PackageName(_omitMessageNames ? '' : 'google.cloud.texttospeech.v1beta1'), createEmptyInstance: create)
...
class SynthesizeSpeechRequest extends $pb.GeneratedMessage {
  factory SynthesizeSpeechRequest({
    ...
    if (enableTimePointing != null) {
      $result.enableTimePointing.addAll(enableTimePointing);
    }
    return $result;
  }
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(_omitMessageNames ? '' : 'SynthesizeSpeechRequest', package: const $pb.PackageName(_omitMessageNames ? '' : 'google.cloud.texttospeech.v1beta1'), createEmptyInstance: create)
    ...
    ..pc<SynthesizeSpeechRequest_TimepointType>(4, _omitFieldNames ? '' : 'enableTimePointing', $pb.PbFieldType.KE, valueOf: SynthesizeSpeechRequest_TimepointType.valueOf, enumValues: SynthesizeSpeechRequest_TimepointType.values, defaultEnumValue: SynthesizeSpeechRequest_TimepointType.TIMEPOINT_TYPE_UNSPECIFIED)
    ..hasRequiredFields = false
  ;
...
class SynthesisInput extends $pb.GeneratedMessage {
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(_omitMessageNames ? '' : 'SynthesisInput', package: const $pb.PackageName(_omitMessageNames ? '' : 'google.cloud.texttospeech.v1beta1'), createEmptyInstance: create)
    ..oo(0, [1, 2])
...
class VoiceSelectionParams extends $pb.GeneratedMessage {
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(_omitMessageNames ? '' : 'VoiceSelectionParams', package: const $pb.PackageName(_omitMessageNames ? '' : 'google.cloud.texttospeech.v1beta1'), createEmptyInstance: create)
    ..aOS(1, _omitFieldNames ? '' : 'languageCode')
    ..aOS(2, _omitFieldNames ? '' : 'name')
    ..e<SsmlVoiceGender>(3, _omitFieldNames ? '' : 'ssmlGender', $pb.PbFieldType.OE, defaultOrMaker: SsmlVoiceGender.SSML_VOICE_GENDER_UNSPECIFIED, valueOf: SsmlVoiceGender.valueOf, enumValues: SsmlVoiceGender.values)
...
class AudioConfig extends $pb.GeneratedMessage {
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(_omitMessageNames ? '' : 'AudioConfig', package: const $pb.PackageName(_omitMessageNames ? '' : 'google.cloud.texttospeech.v1beta1'), createEmptyInstance: create)
...
class CustomVoiceParams extends $pb.GeneratedMessage {
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(_omitMessageNames ? '' : 'CustomVoiceParams', package: const $pb.PackageName(_omitMessageNames ? '' : 'google.cloud.texttospeech.v1beta1'), createEmptyInstance: create)
...
class SynthesizeSpeechResponse extends $pb.GeneratedMessage {
  factory SynthesizeSpeechResponse({
    ...
    if (timepoints != null) {
      $result.timepoints.addAll(timepoints);
    }
    if (audioConfig != null) {
      $result.audioConfig = audioConfig;
    }
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(_omitMessageNames ? '' : 'SynthesizeSpeechResponse', package: const $pb.PackageName(_omitMessageNames ? '' : 'google.cloud.texttospeech.v1beta1'), createEmptyInstance: create)
    ..a<$core.List<$core.int>>(1, _omitFieldNames ? '' : 'audioContent', $pb.PbFieldType.OY)
    ..pc<Timepoint>(2, _omitFieldNames ? '' : 'timepoints', $pb.PbFieldType.PM, subBuilder: Timepoint.create)
    ..aOM<AudioConfig>(4, _omitFieldNames ? '' : 'audioConfig', subBuilder: AudioConfig.create)
    ..hasRequiredFields = false
  ;
...
class Timepoint extends $pb.GeneratedMessage {
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(_omitMessageNames ? '' : 'Timepoint', package: const $pb.PackageName(_omitMessageNames ? '' : 'google.cloud.texttospeech.v1beta1'), createEmptyInstance: create)
    ..a<$core.double>(3, _omitFieldNames ? '' : 'timeSeconds', $pb.PbFieldType.OD)
    ..aOS(4, _omitFieldNames ? '' : 'markName')
    ..hasRequiredFields = false
  ;
...
class StreamingSynthesizeConfig extends $pb.GeneratedMessage {
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(_omitMessageNames ? '' : 'StreamingSynthesizeConfig', package: const $pb.PackageName(_omitMessageNames ? '' : 'google.cloud.texttospeech.v1beta1'), createEmptyInstance: create)
...
class StreamingSynthesisInput extends $pb.GeneratedMessage {
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(_omitMessageNames ? '' : 'StreamingSynthesisInput', package: const $pb.PackageName(_omitMessageNames ? '' : 'google.cloud.texttospeech.v1beta1'), createEmptyInstance: create)
    ..oo(0, [1])
    ..aOS(1, _omitFieldNames ? '' : 'text')
    ..hasRequiredFields = false
  ;
...
class StreamingSynthesizeRequest extends $pb.GeneratedMessage {
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(_omitMessageNames ? '' : 'StreamingSynthesizeRequest', package: const $pb.PackageName(_omitMessageNames ? '' : 'google.cloud.texttospeech.v1beta1'), createEmptyInstance: create)
    ..oo(0, [1, 2])
...
class StreamingSynthesizeResponse extends $pb.GeneratedMessage {
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(_omitMessageNames ? '' : 'StreamingSynthesizeResponse', package: const $pb.PackageName(_omitMessageNames ? '' : 'google.cloud.texttospeech.v1beta1'), createEmptyInstance: create)
    ..a<$core.List<$core.int>>(1, _omitFieldNames ? '' : 'audioContent', $pb.PbFieldType.OY)
    ..hasRequiredFields = false
  ;
