...
class RevisionRef_RevisionCase extends $pb.ProtobufEnum {
  static const RevisionRef_RevisionCase REVISION_CASE_UNSPECIFIED = RevisionRef_RevisionCase._(0, _omitEnumNames ? '' : 'REVISION_CASE_UNSPECIFIED');
  static const RevisionRef_RevisionCase LATEST_HUMAN_REVIEW = RevisionRef_RevisionCase._(1, _omitEnumNames ? '' : 'LATEST_HUMAN_REVIEW');
  static const RevisionRef_RevisionCase LATEST_TIMESTAMP = RevisionRef_RevisionCase._(2, _omitEnumNames ? '' : 'LATEST_TIMESTAMP');
  static const RevisionRef_RevisionCase BASE_OCR_REVISION = RevisionRef_RevisionCase._(3, _omitEnumNames ? '' : 'BASE_OCR_REVISION');

  static const $core.List<RevisionRef_RevisionCase> values = <RevisionRef_RevisionCase> [
  ...
  static final $core.Map<$core.int, RevisionRef_RevisionCase> _byValue = $pb.ProtobufEnum.initByValue(values);
  static RevisionRef_RevisionCase? valueOf($core.int value) => _byValue[value];

  const RevisionRef_RevisionCase._($core.int v, $core.String n) : super(v, n);
}
