...
import 'barcode.pb.dart' as $4523;
import 'document.pbenum.dart';
import 'geometry.pb.dart' as $4522;
...
class Document_ShardInfo extends $pb.GeneratedMessage {
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(_omitMessageNames ? '' : 'Document.ShardInfo', package: const $pb.PackageName(_omitMessageNames ? '' : 'google.cloud.documentai.v1beta3'), createEmptyInstance: create)
...
class Document_Style_FontSize extends $pb.GeneratedMessage {
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(_omitMessageNames ? '' : 'Document.Style.FontSize', package: const $pb.PackageName(_omitMessageNames ? '' : 'google.cloud.documentai.v1beta3'), createEmptyInstance: create)
...
class Document_Style extends $pb.GeneratedMessage {
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(_omitMessageNames ? '' : 'Document.Style', package: const $pb.PackageName(_omitMessageNames ? '' : 'google.cloud.documentai.v1beta3'), createEmptyInstance: create)
...
class Document_Page_Dimension extends $pb.GeneratedMessage {
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(_omitMessageNames ? '' : 'Document.Page.Dimension', package: const $pb.PackageName(_omitMessageNames ? '' : 'google.cloud.documentai.v1beta3'), createEmptyInstance: create)
...
class Document_Page_Image extends $pb.GeneratedMessage {
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(_omitMessageNames ? '' : 'Document.Page.Image', package: const $pb.PackageName(_omitMessageNames ? '' : 'google.cloud.documentai.v1beta3'), createEmptyInstance: create)
...
class Document_Page_Matrix extends $pb.GeneratedMessage {
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(_omitMessageNames ? '' : 'Document.Page.Matrix', package: const $pb.PackageName(_omitMessageNames ? '' : 'google.cloud.documentai.v1beta3'), createEmptyInstance: create)
...
class Document_Page_Layout extends $pb.GeneratedMessage {
  factory Document_Page_Layout({
    ...
    $4522.BoundingPoly? boundingPoly,
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(_omitMessageNames ? '' : 'Document.Page.Layout', package: const $pb.PackageName(_omitMessageNames ? '' : 'google.cloud.documentai.v1beta3'), createEmptyInstance: create)
    ..aOM<Document_TextAnchor>(1, _omitFieldNames ? '' : 'textAnchor', subBuilder: Document_TextAnchor.create)
    ..a<$core.double>(2, _omitFieldNames ? '' : 'confidence', $pb.PbFieldType.OF)
    ..aOM<$4522.BoundingPoly>(3, _omitFieldNames ? '' : 'boundingPoly', subBuilder: $4522.BoundingPoly.create)
  ...
  @$pb.TagNumber(3)
  $4522.BoundingPoly get boundingPoly => $_getN(2);
  @$pb.TagNumber(3)
  set boundingPoly($4522.BoundingPoly v) { setField(3, v); }
  @$pb.TagNumber(3)
  $core.bool hasBoundingPoly() => $_has(2);
  @$pb.TagNumber(3)
  void clearBoundingPoly() => clearField(3);
  @$pb.TagNumber(3)
  $4522.BoundingPoly ensureBoundingPoly() => $_ensure(2);
...
class Document_Page_Block extends $pb.GeneratedMessage {
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(_omitMessageNames ? '' : 'Document.Page.Block', package: const $pb.PackageName(_omitMessageNames ? '' : 'google.cloud.documentai.v1beta3'), createEmptyInstance: create)
...
class Document_Page_Paragraph extends $pb.GeneratedMessage {
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(_omitMessageNames ? '' : 'Document.Page.Paragraph', package: const $pb.PackageName(_omitMessageNames ? '' : 'google.cloud.documentai.v1beta3'), createEmptyInstance: create)
    ..aOM<Document_Page_Layout>(1, _omitFieldNames ? '' : 'layout', subBuilder: Document_Page_Layout.create)
    ..pc<Document_Page_DetectedLanguage>(2, _omitFieldNames ? '' : 'detectedLanguages', $pb.PbFieldType.PM, subBuilder: Document_Page_DetectedLanguage.create)
    ..aOM<Document_Provenance>(3, _omitFieldNames ? '' : 'provenance', subBuilder: Document_Provenance.create)
    ..hasRequiredFields = false
...
class Document_Page_Line extends $pb.GeneratedMessage {
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(_omitMessageNames ? '' : 'Document.Page.Line', package: const $pb.PackageName(_omitMessageNames ? '' : 'google.cloud.documentai.v1beta3'), createEmptyInstance: create)
    ..aOM<Document_Page_Layout>(1, _omitFieldNames ? '' : 'layout', subBuilder: Document_Page_Layout.create)
    ..pc<Document_Page_DetectedLanguage>(2, _omitFieldNames ? '' : 'detectedLanguages', $pb.PbFieldType.PM, subBuilder: Document_Page_DetectedLanguage.create)
    ..aOM<Document_Provenance>(3, _omitFieldNames ? '' : 'provenance', subBuilder: Document_Provenance.create)
    ..hasRequiredFields = false
...
class Document_Page_Token_DetectedBreak extends $pb.GeneratedMessage {
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(_omitMessageNames ? '' : 'Document.Page.Token.DetectedBreak', package: const $pb.PackageName(_omitMessageNames ? '' : 'google.cloud.documentai.v1beta3'), createEmptyInstance: create)
...
class Document_Page_Token_StyleInfo extends $pb.GeneratedMessage {
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(_omitMessageNames ? '' : 'Document.Page.Token.StyleInfo', package: const $pb.PackageName(_omitMessageNames ? '' : 'google.cloud.documentai.v1beta3'), createEmptyInstance: create)
...
class Document_Page_Token extends $pb.GeneratedMessage {
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(_omitMessageNames ? '' : 'Document.Page.Token', package: const $pb.PackageName(_omitMessageNames ? '' : 'google.cloud.documentai.v1beta3'), createEmptyInstance: create)
    ..aOM<Document_Page_Layout>(1, _omitFieldNames ? '' : 'layout', subBuilder: Document_Page_Layout.create)
...
class Document_Page_Symbol extends $pb.GeneratedMessage {
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(_omitMessageNames ? '' : 'Document.Page.Symbol', package: const $pb.PackageName(_omitMessageNames ? '' : 'google.cloud.documentai.v1beta3'), createEmptyInstance: create)
    ..aOM<Document_Page_Layout>(1, _omitFieldNames ? '' : 'layout', subBuilder: Document_Page_Layout.create)
    ..pc<Document_Page_DetectedLanguage>(2, _omitFieldNames ? '' : 'detectedLanguages', $pb.PbFieldType.PM, subBuilder: Document_Page_DetectedLanguage.create)
    ..hasRequiredFields = false
  ;
...
class Document_Page_VisualElement extends $pb.GeneratedMessage {
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(_omitMessageNames ? '' : 'Document.Page.VisualElement', package: const $pb.PackageName(_omitMessageNames ? '' : 'google.cloud.documentai.v1beta3'), createEmptyInstance: create)
    ..aOM<Document_Page_Layout>(1, _omitFieldNames ? '' : 'layout', subBuilder: Document_Page_Layout.create)
...
class Document_Page_Table_TableRow extends $pb.GeneratedMessage {
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(_omitMessageNames ? '' : 'Document.Page.Table.TableRow', package: const $pb.PackageName(_omitMessageNames ? '' : 'google.cloud.documentai.v1beta3'), createEmptyInstance: create)
...
class Document_Page_Table_TableCell extends $pb.GeneratedMessage {
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(_omitMessageNames ? '' : 'Document.Page.Table.TableCell', package: const $pb.PackageName(_omitMessageNames ? '' : 'google.cloud.documentai.v1beta3'), createEmptyInstance: create)
    ..aOM<Document_Page_Layout>(1, _omitFieldNames ? '' : 'layout', subBuilder: Document_Page_Layout.create)
...
class Document_Page_Table extends $pb.GeneratedMessage {
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(_omitMessageNames ? '' : 'Document.Page.Table', package: const $pb.PackageName(_omitMessageNames ? '' : 'google.cloud.documentai.v1beta3'), createEmptyInstance: create)
    ..aOM<Document_Page_Layout>(1, _omitFieldNames ? '' : 'layout', subBuilder: Document_Page_Layout.create)
...
class Document_Page_FormField extends $pb.GeneratedMessage {
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(_omitMessageNames ? '' : 'Document.Page.FormField', package: const $pb.PackageName(_omitMessageNames ? '' : 'google.cloud.documentai.v1beta3'), createEmptyInstance: create)
...
class Document_Page_DetectedBarcode extends $pb.GeneratedMessage {
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(_omitMessageNames ? '' : 'Document.Page.DetectedBarcode', package: const $pb.PackageName(_omitMessageNames ? '' : 'google.cloud.documentai.v1beta3'), createEmptyInstance: create)
    ..aOM<Document_Page_Layout>(1, _omitFieldNames ? '' : 'layout', subBuilder: Document_Page_Layout.create)
    ..aOM<$4523.Barcode>(2, _omitFieldNames ? '' : 'barcode', subBuilder: $4523.Barcode.create)
    ..hasRequiredFields = false
  ;
  ...
  /// [DetectedBarcode][google.cloud.documentai.v1beta3.Document.Page.DetectedBarcode].
  @$pb.TagNumber(2)
  $4523.Barcode get barcode => $_getN(1);
  @$pb.TagNumber(2)
  set barcode($4523.Barcode v) { setField(2, v); }
  @$pb.TagNumber(2)
  $core.bool hasBarcode() => $_has(1);
  @$pb.TagNumber(2)
  void clearBarcode() => clearField(2);
  @$pb.TagNumber(2)
  $4523.Barcode ensureBarcode() => $_ensure(1);
}
...
class Document_Page_DetectedLanguage extends $pb.GeneratedMessage {
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(_omitMessageNames ? '' : 'Document.Page.DetectedLanguage', package: const $pb.PackageName(_omitMessageNames ? '' : 'google.cloud.documentai.v1beta3'), createEmptyInstance: create)
...
class Document_Page_ImageQualityScores_DetectedDefect extends $pb.GeneratedMessage {
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(_omitMessageNames ? '' : 'Document.Page.ImageQualityScores.DetectedDefect', package: const $pb.PackageName(_omitMessageNames ? '' : 'google.cloud.documentai.v1beta3'), createEmptyInstance: create)
...
class Document_Page_ImageQualityScores extends $pb.GeneratedMessage {
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(_omitMessageNames ? '' : 'Document.Page.ImageQualityScores', package: const $pb.PackageName(_omitMessageNames ? '' : 'google.cloud.documentai.v1beta3'), createEmptyInstance: create)
...
class Document_Page extends $pb.GeneratedMessage {
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(_omitMessageNames ? '' : 'Document.Page', package: const $pb.PackageName(_omitMessageNames ? '' : 'google.cloud.documentai.v1beta3'), createEmptyInstance: create)
...
class Document_Entity_NormalizedValue extends $pb.GeneratedMessage {
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(_omitMessageNames ? '' : 'Document.Entity.NormalizedValue', package: const $pb.PackageName(_omitMessageNames ? '' : 'google.cloud.documentai.v1beta3'), createEmptyInstance: create)
    ..oo(0, [2, 3, 4, 5, 6, 7, 8])
...
class Document_Entity extends $pb.GeneratedMessage {
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(_omitMessageNames ? '' : 'Document.Entity', package: const $pb.PackageName(_omitMessageNames ? '' : 'google.cloud.documentai.v1beta3'), createEmptyInstance: create)
    ..aOM<Document_TextAnchor>(1, _omitFieldNames ? '' : 'textAnchor', subBuilder: Document_TextAnchor.create)
    ..aOS(2, _omitFieldNames ? '' : 'type')
...
class Document_EntityRelation extends $pb.GeneratedMessage {
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(_omitMessageNames ? '' : 'Document.EntityRelation', package: const $pb.PackageName(_omitMessageNames ? '' : 'google.cloud.documentai.v1beta3'), createEmptyInstance: create)
...
class Document_TextAnchor_TextSegment extends $pb.GeneratedMessage {
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(_omitMessageNames ? '' : 'Document.TextAnchor.TextSegment', package: const $pb.PackageName(_omitMessageNames ? '' : 'google.cloud.documentai.v1beta3'), createEmptyInstance: create)
...
class Document_TextAnchor extends $pb.GeneratedMessage {
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(_omitMessageNames ? '' : 'Document.TextAnchor', package: const $pb.PackageName(_omitMessageNames ? '' : 'google.cloud.documentai.v1beta3'), createEmptyInstance: create)
...
class Document_PageAnchor_PageRef extends $pb.GeneratedMessage {
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(_omitMessageNames ? '' : 'Document.PageAnchor.PageRef', package: const $pb.PackageName(_omitMessageNames ? '' : 'google.cloud.documentai.v1beta3'), createEmptyInstance: create)
    ...
    ..aOM<$4522.BoundingPoly>(4, _omitFieldNames ? '' : 'boundingPoly', subBuilder: $4522.BoundingPoly.create)
    ..a<$core.double>(5, _omitFieldNames ? '' : 'confidence', $pb.PbFieldType.OF)
    ..hasRequiredFields = false
  ;
  ...
  @$pb.TagNumber(4)
  $4522.BoundingPoly get boundingPoly => $_getN(3);
  @$pb.TagNumber(4)
  set boundingPoly($4522.BoundingPoly v) { setField(4, v); }
  @$pb.TagNumber(4)
  $core.bool hasBoundingPoly() => $_has(3);
  @$pb.TagNumber(4)
  void clearBoundingPoly() => clearField(4);
  @$pb.TagNumber(4)
  $4522.BoundingPoly ensureBoundingPoly() => $_ensure(3);
...
class Document_PageAnchor extends $pb.GeneratedMessage {
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(_omitMessageNames ? '' : 'Document.PageAnchor', package: const $pb.PackageName(_omitMessageNames ? '' : 'google.cloud.documentai.v1beta3'), createEmptyInstance: create)
...
class Document_Provenance_Parent extends $pb.GeneratedMessage {
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(_omitMessageNames ? '' : 'Document.Provenance.Parent', package: const $pb.PackageName(_omitMessageNames ? '' : 'google.cloud.documentai.v1beta3'), createEmptyInstance: create)
...
class Document_Provenance extends $pb.GeneratedMessage {
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(_omitMessageNames ? '' : 'Document.Provenance', package: const $pb.PackageName(_omitMessageNames ? '' : 'google.cloud.documentai.v1beta3'), createEmptyInstance: create)
    ..a<$core.int>(1, _omitFieldNames ? '' : 'revision', $pb.PbFieldType.O3)
    ..a<$core.int>(2, _omitFieldNames ? '' : 'id', $pb.PbFieldType.O3)
...
class Document_Revision_HumanReview extends $pb.GeneratedMessage {
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(_omitMessageNames ? '' : 'Document.Revision.HumanReview', package: const $pb.PackageName(_omitMessageNames ? '' : 'google.cloud.documentai.v1beta3'), createEmptyInstance: create)
...
class Document_Revision extends $pb.GeneratedMessage {
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(_omitMessageNames ? '' : 'Document.Revision', package: const $pb.PackageName(_omitMessageNames ? '' : 'google.cloud.documentai.v1beta3'), createEmptyInstance: create)
    ..oo(0, [4, 5])
...
class Document_TextChange extends $pb.GeneratedMessage {
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(_omitMessageNames ? '' : 'Document.TextChange', package: const $pb.PackageName(_omitMessageNames ? '' : 'google.cloud.documentai.v1beta3'), createEmptyInstance: create)
    ..aOM<Document_TextAnchor>(1, _omitFieldNames ? '' : 'textAnchor', subBuilder: Document_TextAnchor.create)
...
class Document_DocumentLayout_DocumentLayoutBlock_LayoutPageSpan extends $pb.GeneratedMessage {
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(_omitMessageNames ? '' : 'Document.DocumentLayout.DocumentLayoutBlock.LayoutPageSpan', package: const $pb.PackageName(_omitMessageNames ? '' : 'google.cloud.documentai.v1beta3'), createEmptyInstance: create)
...
class Document_DocumentLayout_DocumentLayoutBlock_LayoutTextBlock extends $pb.GeneratedMessage {
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(_omitMessageNames ? '' : 'Document.DocumentLayout.DocumentLayoutBlock.LayoutTextBlock', package: const $pb.PackageName(_omitMessageNames ? '' : 'google.cloud.documentai.v1beta3'), createEmptyInstance: create)
    ..aOS(1, _omitFieldNames ? '' : 'text')
    ..aOS(2, _omitFieldNames ? '' : 'type')
...
class Document_DocumentLayout_DocumentLayoutBlock_LayoutTableBlock extends $pb.GeneratedMessage {
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(_omitMessageNames ? '' : 'Document.DocumentLayout.DocumentLayoutBlock.LayoutTableBlock', package: const $pb.PackageName(_omitMessageNames ? '' : 'google.cloud.documentai.v1beta3'), createEmptyInstance: create)
...
class Document_DocumentLayout_DocumentLayoutBlock_LayoutTableRow extends $pb.GeneratedMessage {
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(_omitMessageNames ? '' : 'Document.DocumentLayout.DocumentLayoutBlock.LayoutTableRow', package: const $pb.PackageName(_omitMessageNames ? '' : 'google.cloud.documentai.v1beta3'), createEmptyInstance: create)
...
class Document_DocumentLayout_DocumentLayoutBlock_LayoutTableCell extends $pb.GeneratedMessage {
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(_omitMessageNames ? '' : 'Document.DocumentLayout.DocumentLayoutBlock.LayoutTableCell', package: const $pb.PackageName(_omitMessageNames ? '' : 'google.cloud.documentai.v1beta3'), createEmptyInstance: create)
...
class Document_DocumentLayout_DocumentLayoutBlock_LayoutListBlock extends $pb.GeneratedMessage {
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(_omitMessageNames ? '' : 'Document.DocumentLayout.DocumentLayoutBlock.LayoutListBlock', package: const $pb.PackageName(_omitMessageNames ? '' : 'google.cloud.documentai.v1beta3'), createEmptyInstance: create)
...
class Document_DocumentLayout_DocumentLayoutBlock_LayoutListEntry extends $pb.GeneratedMessage {
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(_omitMessageNames ? '' : 'Document.DocumentLayout.DocumentLayoutBlock.LayoutListEntry', package: const $pb.PackageName(_omitMessageNames ? '' : 'google.cloud.documentai.v1beta3'), createEmptyInstance: create)
    ..pc<Document_DocumentLayout_DocumentLayoutBlock>(1, _omitFieldNames ? '' : 'blocks', $pb.PbFieldType.PM, subBuilder: Document_DocumentLayout_DocumentLayoutBlock.create)
    ..hasRequiredFields = false
  ;
...
class Document_DocumentLayout_DocumentLayoutBlock extends $pb.GeneratedMessage {
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(_omitMessageNames ? '' : 'Document.DocumentLayout.DocumentLayoutBlock', package: const $pb.PackageName(_omitMessageNames ? '' : 'google.cloud.documentai.v1beta3'), createEmptyInstance: create)
    ..oo(0, [2, 3, 4])
...
class Document_DocumentLayout extends $pb.GeneratedMessage {
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(_omitMessageNames ? '' : 'Document.DocumentLayout', package: const $pb.PackageName(_omitMessageNames ? '' : 'google.cloud.documentai.v1beta3'), createEmptyInstance: create)
    ..pc<Document_DocumentLayout_DocumentLayoutBlock>(1, _omitFieldNames ? '' : 'blocks', $pb.PbFieldType.PM, subBuilder: Document_DocumentLayout_DocumentLayoutBlock.create)
    ..hasRequiredFields = false
  ;
...
class Document_ChunkedDocument_Chunk_ChunkPageSpan extends $pb.GeneratedMessage {
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(_omitMessageNames ? '' : 'Document.ChunkedDocument.Chunk.ChunkPageSpan', package: const $pb.PackageName(_omitMessageNames ? '' : 'google.cloud.documentai.v1beta3'), createEmptyInstance: create)
    ..a<$core.int>(1, _omitFieldNames ? '' : 'pageStart', $pb.PbFieldType.O3)
    ..a<$core.int>(2, _omitFieldNames ? '' : 'pageEnd', $pb.PbFieldType.O3)
    ..hasRequiredFields = false
  ;
...
class Document_ChunkedDocument_Chunk_ChunkPageHeader extends $pb.GeneratedMessage {
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(_omitMessageNames ? '' : 'Document.ChunkedDocument.Chunk.ChunkPageHeader', package: const $pb.PackageName(_omitMessageNames ? '' : 'google.cloud.documentai.v1beta3'), createEmptyInstance: create)
    ..aOS(1, _omitFieldNames ? '' : 'text')
...
class Document_ChunkedDocument_Chunk_ChunkPageFooter extends $pb.GeneratedMessage {
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(_omitMessageNames ? '' : 'Document.ChunkedDocument.Chunk.ChunkPageFooter', package: const $pb.PackageName(_omitMessageNames ? '' : 'google.cloud.documentai.v1beta3'), createEmptyInstance: create)
    ..aOS(1, _omitFieldNames ? '' : 'text')
    ..aOM<Document_ChunkedDocument_Chunk_ChunkPageSpan>(2, _omitFieldNames ? '' : 'pageSpan', subBuilder: Document_ChunkedDocument_Chunk_ChunkPageSpan.create)
    ..hasRequiredFields = false
  ;
...
class Document_ChunkedDocument_Chunk extends $pb.GeneratedMessage {
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(_omitMessageNames ? '' : 'Document.ChunkedDocument.Chunk', package: const $pb.PackageName(_omitMessageNames ? '' : 'google.cloud.documentai.v1beta3'), createEmptyInstance: create)
...
class Document_ChunkedDocument extends $pb.GeneratedMessage {
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(_omitMessageNames ? '' : 'Document.ChunkedDocument', package: const $pb.PackageName(_omitMessageNames ? '' : 'google.cloud.documentai.v1beta3'), createEmptyInstance: create)
...
class Document extends $pb.GeneratedMessage {
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(_omitMessageNames ? '' : 'Document', package: const $pb.PackageName(_omitMessageNames ? '' : 'google.cloud.documentai.v1beta3'), createEmptyInstance: create)
    ..oo(0, [1, 2])
...
class RevisionRef extends $pb.GeneratedMessage {
  factory RevisionRef({
    RevisionRef_RevisionCase? revisionCase,
    $core.String? revisionId,
    $core.String? latestProcessorVersion,
  }) {
    final $result = create();
    if (revisionCase != null) {
      $result.revisionCase = revisionCase;
    }
    if (revisionId != null) {
      $result.revisionId = revisionId;
    }
    if (latestProcessorVersion != null) {
      $result.latestProcessorVersion = latestProcessorVersion;
    }
    return $result;
  }
  RevisionRef._() : super();
  factory RevisionRef.fromBuffer($core.List<$core.int> i, [$pb.ExtensionRegistry r = $pb.ExtensionRegistry.EMPTY]) => create()..mergeFromBuffer(i, r);
  factory RevisionRef.fromJson($core.String i, [$pb.ExtensionRegistry r = $pb.ExtensionRegistry.EMPTY]) => create()..mergeFromJson(i, r);

  static const $core.Map<$core.int, RevisionRef_Source> _RevisionRef_SourceByTag = {
    1 : RevisionRef_Source.revisionCase,
    2 : RevisionRef_Source.revisionId,
    3 : RevisionRef_Source.latestProcessorVersion,
    0 : RevisionRef_Source.notSet
  };
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(_omitMessageNames ? '' : 'RevisionRef', package: const $pb.PackageName(_omitMessageNames ? '' : 'google.cloud.documentai.v1beta3'), createEmptyInstance: create)
    ..oo(0, [1, 2, 3])
    ..e<RevisionRef_RevisionCase>(1, _omitFieldNames ? '' : 'revisionCase', $pb.PbFieldType.OE, defaultOrMaker: RevisionRef_RevisionCase.REVISION_CASE_UNSPECIFIED, valueOf: RevisionRef_RevisionCase.valueOf, enumValues: RevisionRef_RevisionCase.values)
    ..aOS(2, _omitFieldNames ? '' : 'revisionId')
    ..aOS(3, _omitFieldNames ? '' : 'latestProcessorVersion')
    ..hasRequiredFields = false
  ;
  ...
  'Use [GeneratedMessageGenericExtensions.deepCopy] instead. '
  'Will be removed in next major version')
  RevisionRef clone() => RevisionRef()..mergeFromMessage(this);
  @$core.Deprecated(
  'Using this can add significant overhead to your binary. '
  'Use [GeneratedMessageGenericExtensions.rebuild] instead. '
  'Will be removed in next major version')
  RevisionRef copyWith(void Function(RevisionRef) updates) => super.copyWith((message) => updates(message as RevisionRef)) as RevisionRef;

  $pb.BuilderInfo get info_ => _i;

  @$core.pragma('dart2js:noInline')
  static RevisionRef create() => RevisionRef._();
  RevisionRef createEmptyInstance() => create();
  static $pb.PbList<RevisionRef> createRepeated() => $pb.PbList<RevisionRef>();
  @$core.pragma('dart2js:noInline')
  static RevisionRef getDefault() => _defaultInstance ??= $pb.GeneratedMessage.$_defaultFor<RevisionRef>(create);
  static RevisionRef? _defaultInstance;

  RevisionRef_Source whichSource() => _RevisionRef_SourceByTag[$_whichOneof(0)]!;
  void clearSource() => clearField($_whichOneof(0));

  /// Reads the revision by the predefined case.
  @$pb.TagNumber(1)
  RevisionRef_RevisionCase get revisionCase => $_getN(0);
  @$pb.TagNumber(1)
  set revisionCase(RevisionRef_RevisionCase v) { setField(1, v); }
  @$pb.TagNumber(1)
  $core.bool hasRevisionCase() => $_has(0);
  @$pb.TagNumber(1)
  void clearRevisionCase() => clearField(1);
  ...
  @$pb.TagNumber(3)
  $core.String get latestProcessorVersion => $_getSZ(2);
  @$pb.TagNumber(3)
  set latestProcessorVersion($core.String v) { $_setString(2, v); }
  @$pb.TagNumber(3)
  $core.bool hasLatestProcessorVersion() => $_has(2);
  @$pb.TagNumber(3)
  void clearLatestProcessorVersion() => clearField(3);
}
