...
class ReviewDocumentOperationMetadata_State extends $pb.ProtobufEnum {
  static const ReviewDocumentOperationMetadata_State STATE_UNSPECIFIED = ReviewDocumentOperationMetadata_State._(0, _omitEnumNames ? '' : 'STATE_UNSPECIFIED');
  static const ReviewDocumentOperationMetadata_State RUNNING = ReviewDocumentOperationMetadata_State._(1, _omitEnumNames ? '' : 'RUNNING');
  static const ReviewDocumentOperationMetadata_State CANCELLING = ReviewDocumentOperationMetadata_State._(2, _omitEnumNames ? '' : 'CANCELLING');
  static const ReviewDocumentOperationMetadata_State SUCCEEDED = ReviewDocumentOperationMetadata_State._(3, _omitEnumNames ? '' : 'SUCCEEDED');
  static const ReviewDocumentOperationMetadata_State FAILED = ReviewDocumentOperationMetadata_State._(4, _omitEnumNames ? '' : 'FAILED');
  static const ReviewDocumentOperationMetadata_State CANCELLED = ReviewDocumentOperationMetadata_State._(5, _omitEnumNames ? '' : 'CANCELLED');
