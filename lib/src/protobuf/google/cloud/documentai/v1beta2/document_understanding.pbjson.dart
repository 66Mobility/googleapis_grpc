...
const BatchProcessDocumentsRequest$json = {
  ...
  '2': [
    {'1': 'requests', '3': 1, '4': 3, '5': 11, '6': '.google.cloud.documentai.v1beta2.ProcessDocumentRequest', '8': {}, '10': 'requests'},
...
final $typed_data.Uint8List batchProcessDocumentsRequestDescriptor = $convert.base64Decode(
    ...
    'xlLmNsb3VkLmRvY3VtZW50YWkudjFiZXRhMi5Qcm9jZXNzRG9jdW1lbnRSZXF1ZXN0QgPgQQJS'
...
const ProcessDocumentRequest$json = {
  ...
  '2': [
    ...
    {'1': 'input_config', '3': 1, '4': 1, '5': 11, '6': '.google.cloud.documentai.v1beta2.InputConfig', '8': {}, '10': 'inputConfig'},
    {'1': 'output_config', '3': 2, '4': 1, '5': 11, '6': '.google.cloud.documentai.v1beta2.OutputConfig', '10': 'outputConfig'},
    {'1': 'document_type', '3': 3, '4': 1, '5': 9, '10': 'documentType'},
    {'1': 'table_extraction_params', '3': 4, '4': 1, '5': 11, '6': '.google.cloud.documentai.v1beta2.TableExtractionParams', '10': 'tableExtractionParams'},
    {'1': 'form_extraction_params', '3': 5, '4': 1, '5': 11, '6': '.google.cloud.documentai.v1beta2.FormExtractionParams', '10': 'formExtractionParams'},
    {'1': 'entity_extraction_params', '3': 6, '4': 1, '5': 11, '6': '.google.cloud.documentai.v1beta2.EntityExtractionParams', '10': 'entityExtractionParams'},
    {'1': 'ocr_params', '3': 7, '4': 1, '5': 11, '6': '.google.cloud.documentai.v1beta2.OcrParams', '10': 'ocrParams'},
    {'1': 'automl_params', '3': 8, '4': 1, '5': 11, '6': '.google.cloud.documentai.v1beta2.AutoMlParams', '10': 'automlParams'},
  ],
};
...
final $typed_data.Uint8List processDocumentRequestDescriptor = $convert.base64Decode(
    'ChZQcm9jZXNzRG9jdW1lbnRSZXF1ZXN0EhYKBnBhcmVudBgJIAEoCVIGcGFyZW50ElQKDGlucH'
    'V0X2NvbmZpZxgBIAEoCzIsLmdvb2dsZS5jbG91ZC5kb2N1bWVudGFpLnYxYmV0YTIuSW5wdXRD'
    'b25maWdCA+BBAlILaW5wdXRDb25maWcSUgoNb3V0cHV0X2NvbmZpZxgCIAEoCzItLmdvb2dsZS'
    '5jbG91ZC5kb2N1bWVudGFpLnYxYmV0YTIuT3V0cHV0Q29uZmlnUgxvdXRwdXRDb25maWcSIwoN'
    'ZG9jdW1lbnRfdHlwZRgDIAEoCVIMZG9jdW1lbnRUeXBlEm4KF3RhYmxlX2V4dHJhY3Rpb25fcG'
    'FyYW1zGAQgASgLMjYuZ29vZ2xlLmNsb3VkLmRvY3VtZW50YWkudjFiZXRhMi5UYWJsZUV4dHJh'
    'Y3Rpb25QYXJhbXNSFXRhYmxlRXh0cmFjdGlvblBhcmFtcxJrChZmb3JtX2V4dHJhY3Rpb25fcG'
    'FyYW1zGAUgASgLMjUuZ29vZ2xlLmNsb3VkLmRvY3VtZW50YWkudjFiZXRhMi5Gb3JtRXh0cmFj'
    'dGlvblBhcmFtc1IUZm9ybUV4dHJhY3Rpb25QYXJhbXMScQoYZW50aXR5X2V4dHJhY3Rpb25fcG'
    'FyYW1zGAYgASgLMjcuZ29vZ2xlLmNsb3VkLmRvY3VtZW50YWkudjFiZXRhMi5FbnRpdHlFeHRy'
    'YWN0aW9uUGFyYW1zUhZlbnRpdHlFeHRyYWN0aW9uUGFyYW1zEkkKCm9jcl9wYXJhbXMYByABKA'
    'syKi5nb29nbGUuY2xvdWQuZG9jdW1lbnRhaS52MWJldGEyLk9jclBhcmFtc1IJb2NyUGFyYW1z'
    'ElIKDWF1dG9tbF9wYXJhbXMYCCABKAsyLS5nb29nbGUuY2xvdWQuZG9jdW1lbnRhaS52MWJldG'
    'EyLkF1dG9NbFBhcmFtc1IMYXV0b21sUGFyYW1z');
...
const BatchProcessDocumentsResponse$json = {
  ...
  '2': [
    {'1': 'responses', '3': 1, '4': 3, '5': 11, '6': '.google.cloud.documentai.v1beta2.ProcessDocumentResponse', '10': 'responses'},
  ],
};
...
final $typed_data.Uint8List batchProcessDocumentsResponseDescriptor = $convert.base64Decode(
    ...
    '9nbGUuY2xvdWQuZG9jdW1lbnRhaS52MWJldGEyLlByb2Nlc3NEb2N1bWVudFJlc3BvbnNlUgly'
    'ZXNwb25zZXM=');
...
const ProcessDocumentResponse$json = {
  ...
  '2': [
    {'1': 'input_config', '3': 1, '4': 1, '5': 11, '6': '.google.cloud.documentai.v1beta2.InputConfig', '10': 'inputConfig'},
    {'1': 'output_config', '3': 2, '4': 1, '5': 11, '6': '.google.cloud.documentai.v1beta2.OutputConfig', '10': 'outputConfig'},
  ],
};
...
final $typed_data.Uint8List processDocumentResponseDescriptor = $convert.base64Decode(
    ...
    'UuY2xvdWQuZG9jdW1lbnRhaS52MWJldGEyLklucHV0Q29uZmlnUgtpbnB1dENvbmZpZxJSCg1v'
    'dXRwdXRfY29uZmlnGAIgASgLMi0uZ29vZ2xlLmNsb3VkLmRvY3VtZW50YWkudjFiZXRhMi5PdX'
...
const TableExtractionParams$json = {
  ...
  '2': [
    ...
    {'1': 'table_bound_hints', '3': 2, '4': 3, '5': 11, '6': '.google.cloud.documentai.v1beta2.TableBoundHint', '8': {}, '10': 'tableBoundHints'},
...
final $typed_data.Uint8List tableExtractionParamsDescriptor = $convert.base64Decode(
    ...
    'JsZV9ib3VuZF9oaW50cxgCIAMoCzIvLmdvb2dsZS5jbG91ZC5kb2N1bWVudGFpLnYxYmV0YTIu'
...
const TableBoundHint$json = {
  ...
  '2': [
    ...
    {'1': 'bounding_box', '3': 2, '4': 1, '5': 11, '6': '.google.cloud.documentai.v1beta2.BoundingPoly', '10': 'boundingBox'},
  ],
};
...
final $typed_data.Uint8List tableBoundHintDescriptor = $convert.base64Decode(
    ...
    'AKDGJvdW5kaW5nX2JveBgCIAEoCzItLmdvb2dsZS5jbG91ZC5kb2N1bWVudGFpLnYxYmV0YTIu'
...
const FormExtractionParams$json = {
  ...
  '2': [
    {'1': 'enabled', '3': 1, '4': 1, '5': 8, '10': 'enabled'},
    {'1': 'key_value_pair_hints', '3': 2, '4': 3, '5': 11, '6': '.google.cloud.documentai.v1beta2.KeyValuePairHint', '10': 'keyValuePairHints'},
...
final $typed_data.Uint8List formExtractionParamsDescriptor = $convert.base64Decode(
    ...
    'Mi5LZXlWYWx1ZVBhaXJIaW50UhFrZXlWYWx1ZVBhaXJIaW50cxIjCg1tb2RlbF92ZXJzaW9uGA'
...
final $typed_data.Uint8List autoMlParamsDescriptor = $convert.base64Decode(
    'CgxBdXRvTWxQYXJhbXMSFAoFbW9kZWwYASABKAlSBW1vZGVs');

@$core.Deprecated('Use inputConfigDescriptor instead')
const InputConfig$json = {
  '1': 'InputConfig',
  '2': [
    {'1': 'gcs_source', '3': 1, '4': 1, '5': 11, '6': '.google.cloud.documentai.v1beta2.GcsSource', '9': 0, '10': 'gcsSource'},
    {'1': 'contents', '3': 3, '4': 1, '5': 12, '9': 0, '10': 'contents'},
...
final $typed_data.Uint8List inputConfigDescriptor = $convert.base64Decode(
    ...
    '50YWkudjFiZXRhMi5HY3NTb3VyY2VIAFIJZ2NzU291cmNlEhwKCGNvbnRlbnRzGAMgASgMSABS'
    'CGNvbnRlbnRzEiAKCW1pbWVfdHlwZRgCIAEoCUID4EECUghtaW1lVHlwZUIICgZzb3VyY2U=');

@$core.Deprecated('Use outputConfigDescriptor instead')
const OutputConfig$json = {
  '1': 'OutputConfig',
  '2': [
    {'1': 'gcs_destination', '3': 1, '4': 1, '5': 11, '6': '.google.cloud.documentai.v1beta2.GcsDestination', '9': 0, '10': 'gcsDestination'},
...
final $typed_data.Uint8List outputConfigDescriptor = $convert.base64Decode(
    ...
    'RvY3VtZW50YWkudjFiZXRhMi5HY3NEZXN0aW5hdGlvbkgAUg5nY3NEZXN0aW5hdGlvbhImCg9w'
...
const OperationMetadata$json = {
  '1': 'OperationMetadata',
  '2': [
    {'1': 'state', '3': 1, '4': 1, '5': 14, '6': '.google.cloud.documentai.v1beta2.OperationMetadata.State', '10': 'state'},
...
final $typed_data.Uint8List operationMetadataDescriptor = $convert.base64Decode(
    ...
    'VudGFpLnYxYmV0YTIuT3BlcmF0aW9uTWV0YWRhdGEuU3RhdGVSBXN0YXRlEiMKDXN0YXRlX21l'
