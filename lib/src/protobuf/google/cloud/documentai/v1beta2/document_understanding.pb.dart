...
class TableBoundHint extends $pb.GeneratedMessage {
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(_omitMessageNames ? '' : 'TableBoundHint', package: const $pb.PackageName(_omitMessageNames ? '' : 'google.cloud.documentai.v1beta2'), createEmptyInstance: create)
    ...
    ..aOM<$4518.BoundingPoly>(2, _omitFieldNames ? '' : 'boundingBox', subBuilder: $4518.BoundingPoly.create)
    ..hasRequiredFields = false
  ;
  ...
  @$pb.TagNumber(2)
  $4518.BoundingPoly get boundingBox => $_getN(1);
  @$pb.TagNumber(2)
  set boundingBox($4518.BoundingPoly v) { setField(2, v); }
  @$pb.TagNumber(2)
  $core.bool hasBoundingBox() => $_has(1);
  @$pb.TagNumber(2)
  void clearBoundingBox() => clearField(2);
  @$pb.TagNumber(2)
  $4518.BoundingPoly ensureBoundingBox() => $_ensure(1);
}
