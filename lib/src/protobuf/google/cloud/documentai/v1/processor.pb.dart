...
class ProcessorVersion extends $pb.GeneratedMessage {
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(_omitMessageNames ? '' : 'ProcessorVersion', package: const $pb.PackageName(_omitMessageNames ? '' : 'google.cloud.documentai.v1'), createEmptyInstance: create)
    ...
    ..aOM<$4514.DocumentSchema>(12, _omitFieldNames ? '' : 'documentSchema', subBuilder: $4514.DocumentSchema.create)
  ...
  @$pb.TagNumber(12)
  $4514.DocumentSchema get documentSchema => $_getN(8);
  @$pb.TagNumber(12)
  set documentSchema($4514.DocumentSchema v) { setField(12, v); }
  @$pb.TagNumber(12)
  $core.bool hasDocumentSchema() => $_has(8);
  @$pb.TagNumber(12)
  void clearDocumentSchema() => clearField(12);
  @$pb.TagNumber(12)
  $4514.DocumentSchema ensureDocumentSchema() => $_ensure(8);
