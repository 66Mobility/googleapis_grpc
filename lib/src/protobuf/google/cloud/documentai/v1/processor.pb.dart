...
class ProcessorVersion_DeprecationInfo extends $pb.GeneratedMessage {
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(_omitMessageNames ? '' : 'ProcessorVersion.DeprecationInfo', package: const $pb.PackageName(_omitMessageNames ? '' : 'google.cloud.documentai.v1'), createEmptyInstance: create)
...
class ProcessorVersion_GenAiModelInfo_FoundationGenAiModelInfo extends $pb.GeneratedMessage {
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(_omitMessageNames ? '' : 'ProcessorVersion.GenAiModelInfo.FoundationGenAiModelInfo', package: const $pb.PackageName(_omitMessageNames ? '' : 'google.cloud.documentai.v1'), createEmptyInstance: create)
...
class ProcessorVersion_GenAiModelInfo_CustomGenAiModelInfo extends $pb.GeneratedMessage {
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(_omitMessageNames ? '' : 'ProcessorVersion.GenAiModelInfo.CustomGenAiModelInfo', package: const $pb.PackageName(_omitMessageNames ? '' : 'google.cloud.documentai.v1'), createEmptyInstance: create)
...
class ProcessorVersion_GenAiModelInfo extends $pb.GeneratedMessage {
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(_omitMessageNames ? '' : 'ProcessorVersion.GenAiModelInfo', package: const $pb.PackageName(_omitMessageNames ? '' : 'google.cloud.documentai.v1'), createEmptyInstance: create)
    ..oo(0, [1, 2])
...
class ProcessorVersion extends $pb.GeneratedMessage {
  factory ProcessorVersion({
    ...
    $1030.EvaluationReference? latestEvaluation,
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(_omitMessageNames ? '' : 'ProcessorVersion', package: const $pb.PackageName(_omitMessageNames ? '' : 'google.cloud.documentai.v1'), createEmptyInstance: create)
    ...
    ..aOM<$1030.EvaluationReference>(8, _omitFieldNames ? '' : 'latestEvaluation', subBuilder: $1030.EvaluationReference.create)
    ..aOS(9, _omitFieldNames ? '' : 'kmsKeyName')
    ..aOS(10, _omitFieldNames ? '' : 'kmsKeyVersionName')
    ..aOB(11, _omitFieldNames ? '' : 'googleManaged')
    ..aOM<$4516.DocumentSchema>(12, _omitFieldNames ? '' : 'documentSchema', subBuilder: $4516.DocumentSchema.create)
  ...
  @$pb.TagNumber(8)
  $1030.EvaluationReference get latestEvaluation => $_getN(4);
  @$pb.TagNumber(8)
  set latestEvaluation($1030.EvaluationReference v) { setField(8, v); }
  @$pb.TagNumber(8)
  $core.bool hasLatestEvaluation() => $_has(4);
  @$pb.TagNumber(8)
  void clearLatestEvaluation() => clearField(8);
  @$pb.TagNumber(8)
  $1030.EvaluationReference ensureLatestEvaluation() => $_ensure(4);
  ...
  @$pb.TagNumber(12)
  $4516.DocumentSchema get documentSchema => $_getN(8);
  @$pb.TagNumber(12)
  set documentSchema($4516.DocumentSchema v) { setField(12, v); }
  @$pb.TagNumber(12)
  $core.bool hasDocumentSchema() => $_has(8);
  @$pb.TagNumber(12)
  void clearDocumentSchema() => clearField(12);
  @$pb.TagNumber(12)
  $4516.DocumentSchema ensureDocumentSchema() => $_ensure(8);
...
class ProcessorVersionAlias extends $pb.GeneratedMessage {
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(_omitMessageNames ? '' : 'ProcessorVersionAlias', package: const $pb.PackageName(_omitMessageNames ? '' : 'google.cloud.documentai.v1'), createEmptyInstance: create)
...
class Processor extends $pb.GeneratedMessage {
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(_omitMessageNames ? '' : 'Processor', package: const $pb.PackageName(_omitMessageNames ? '' : 'google.cloud.documentai.v1'), createEmptyInstance: create)
    ..aOS(1, _omitFieldNames ? '' : 'name')
