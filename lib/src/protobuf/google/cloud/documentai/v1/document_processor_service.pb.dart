...
import 'document.pb.dart' as $4442;
import 'document_io.pb.dart' as $4517;
import 'document_processor_service.pbenum.dart';
import 'document_schema.pb.dart' as $4516;
import 'evaluation.pb.dart' as $1030;
import 'operation_metadata.pb.dart' as $4518;
...
class ProcessOptions_LayoutConfig_ChunkingConfig extends $pb.GeneratedMessage {
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(_omitMessageNames ? '' : 'ProcessOptions.LayoutConfig.ChunkingConfig', package: const $pb.PackageName(_omitMessageNames ? '' : 'google.cloud.documentai.v1'), createEmptyInstance: create)
...
class ProcessOptions_LayoutConfig extends $pb.GeneratedMessage {
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(_omitMessageNames ? '' : 'ProcessOptions.LayoutConfig', package: const $pb.PackageName(_omitMessageNames ? '' : 'google.cloud.documentai.v1'), createEmptyInstance: create)
...
class ProcessOptions_IndividualPageSelector extends $pb.GeneratedMessage {
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(_omitMessageNames ? '' : 'ProcessOptions.IndividualPageSelector', package: const $pb.PackageName(_omitMessageNames ? '' : 'google.cloud.documentai.v1'), createEmptyInstance: create)
...
class ProcessOptions extends $pb.GeneratedMessage {
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(_omitMessageNames ? '' : 'ProcessOptions', package: const $pb.PackageName(_omitMessageNames ? '' : 'google.cloud.documentai.v1'), createEmptyInstance: create)
    ..oo(0, [5, 6, 7])
    ..aOM<$4517.OcrConfig>(1, _omitFieldNames ? '' : 'ocrConfig', subBuilder: $4517.OcrConfig.create)
    ...
    ..aOM<$4516.DocumentSchema>(8, _omitFieldNames ? '' : 'schemaOverride', subBuilder: $4516.DocumentSchema.create)
  ...
  @$pb.TagNumber(1)
  $4517.OcrConfig get ocrConfig => $_getN(0);
  @$pb.TagNumber(1)
  set ocrConfig($4517.OcrConfig v) { setField(1, v); }
  @$pb.TagNumber(1)
  $core.bool hasOcrConfig() => $_has(0);
  @$pb.TagNumber(1)
  void clearOcrConfig() => clearField(1);
  @$pb.TagNumber(1)
  $4517.OcrConfig ensureOcrConfig() => $_ensure(0);
  ...
  @$pb.TagNumber(8)
  $4516.DocumentSchema get schemaOverride => $_getN(4);
  @$pb.TagNumber(8)
  set schemaOverride($4516.DocumentSchema v) { setField(8, v); }
  @$pb.TagNumber(8)
  $core.bool hasSchemaOverride() => $_has(4);
  @$pb.TagNumber(8)
  void clearSchemaOverride() => clearField(8);
  @$pb.TagNumber(8)
  $4516.DocumentSchema ensureSchemaOverride() => $_ensure(4);
...
class ProcessRequest extends $pb.GeneratedMessage {
  factory ProcessRequest({
    ...
    $4442.Document? inlineDocument,
    $4517.RawDocument? rawDocument,
    $2210.FieldMask? fieldMask,
    ProcessOptions? processOptions,
    $4517.GcsDocument? gcsDocument,
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(_omitMessageNames ? '' : 'ProcessRequest', package: const $pb.PackageName(_omitMessageNames ? '' : 'google.cloud.documentai.v1'), createEmptyInstance: create)
    ..oo(0, [4, 5, 8])
    ..aOS(1, _omitFieldNames ? '' : 'name')
    ..aOB(3, _omitFieldNames ? '' : 'skipHumanReview')
    ..aOM<$4442.Document>(4, _omitFieldNames ? '' : 'inlineDocument', subBuilder: $4442.Document.create)
    ..aOM<$4517.RawDocument>(5, _omitFieldNames ? '' : 'rawDocument', subBuilder: $4517.RawDocument.create)
    ...
    ..aOM<$4517.GcsDocument>(8, _omitFieldNames ? '' : 'gcsDocument', subBuilder: $4517.GcsDocument.create)
    ..m<$core.String, $core.String>(10, _omitFieldNames ? '' : 'labels', entryClassName: 'ProcessRequest.LabelsEntry', keyFieldType: $pb.PbFieldType.OS, valueFieldType: $pb.PbFieldType.OS, packageName: const $pb.PackageName('google.cloud.documentai.v1'))
  ...
  @$pb.TagNumber(4)
  $4442.Document get inlineDocument => $_getN(2);
  @$pb.TagNumber(4)
  set inlineDocument($4442.Document v) { setField(4, v); }
  @$pb.TagNumber(4)
  $core.bool hasInlineDocument() => $_has(2);
  @$pb.TagNumber(4)
  void clearInlineDocument() => clearField(4);
  @$pb.TagNumber(4)
  $4442.Document ensureInlineDocument() => $_ensure(2);

  /// A raw document content (bytes).
  @$pb.TagNumber(5)
  $4517.RawDocument get rawDocument => $_getN(3);
  @$pb.TagNumber(5)
  set rawDocument($4517.RawDocument v) { setField(5, v); }
  @$pb.TagNumber(5)
  $core.bool hasRawDocument() => $_has(3);
  @$pb.TagNumber(5)
  void clearRawDocument() => clearField(5);
  @$pb.TagNumber(5)
  $4517.RawDocument ensureRawDocument() => $_ensure(3);
  ...
  @$pb.TagNumber(7)
  ProcessOptions get processOptions => $_getN(5);
  @$pb.TagNumber(7)
  set processOptions(ProcessOptions v) { setField(7, v); }
  @$pb.TagNumber(7)
  $core.bool hasProcessOptions() => $_has(5);
  @$pb.TagNumber(7)
  void clearProcessOptions() => clearField(7);
  @$pb.TagNumber(7)
  ProcessOptions ensureProcessOptions() => $_ensure(5);

  /// A raw document on Google Cloud Storage.
  @$pb.TagNumber(8)
  $4517.GcsDocument get gcsDocument => $_getN(6);
  @$pb.TagNumber(8)
  set gcsDocument($4517.GcsDocument v) { setField(8, v); }
  @$pb.TagNumber(8)
  $core.bool hasGcsDocument() => $_has(6);
  @$pb.TagNumber(8)
  void clearGcsDocument() => clearField(8);
  @$pb.TagNumber(8)
  $4517.GcsDocument ensureGcsDocument() => $_ensure(6);
  ...
  @$pb.TagNumber(11)
  $core.bool get imagelessMode => $_getBF(8);
  @$pb.TagNumber(11)
  set imagelessMode($core.bool v) { $_setBool(8, v); }
  @$pb.TagNumber(11)
  $core.bool hasImagelessMode() => $_has(8);
  @$pb.TagNumber(11)
...
class HumanReviewStatus extends $pb.GeneratedMessage {
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(_omitMessageNames ? '' : 'HumanReviewStatus', package: const $pb.PackageName(_omitMessageNames ? '' : 'google.cloud.documentai.v1'), createEmptyInstance: create)
...
class ProcessResponse extends $pb.GeneratedMessage {
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(_omitMessageNames ? '' : 'ProcessResponse', package: const $pb.PackageName(_omitMessageNames ? '' : 'google.cloud.documentai.v1'), createEmptyInstance: create)
    ..aOM<$4442.Document>(1, _omitFieldNames ? '' : 'document', subBuilder: $4442.Document.create)
  ...
  /// behavior.
  @$pb.TagNumber(1)
  $4442.Document get document => $_getN(0);
  @$pb.TagNumber(1)
  set document($4442.Document v) { setField(1, v); }
  @$pb.TagNumber(1)
  $core.bool hasDocument() => $_has(0);
  @$pb.TagNumber(1)
  void clearDocument() => clearField(1);
  @$pb.TagNumber(1)
  $4442.Document ensureDocument() => $_ensure(0);
...
class BatchProcessRequest extends $pb.GeneratedMessage {
  factory BatchProcessRequest({
    $core.String? name,
    $core.bool? skipHumanReview,
    $4517.BatchDocumentsInputConfig? inputDocuments,
    $4517.DocumentOutputConfig? documentOutputConfig,
    ProcessOptions? processOptions,
    $core.Map<$core.String, $core.String>? labels,
  }) {
    final $result = create();
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(_omitMessageNames ? '' : 'BatchProcessRequest', package: const $pb.PackageName(_omitMessageNames ? '' : 'google.cloud.documentai.v1'), createEmptyInstance: create)
    ..aOS(1, _omitFieldNames ? '' : 'name')
    ..aOB(4, _omitFieldNames ? '' : 'skipHumanReview')
    ..aOM<$4517.BatchDocumentsInputConfig>(5, _omitFieldNames ? '' : 'inputDocuments', subBuilder: $4517.BatchDocumentsInputConfig.create)
    ..aOM<$4517.DocumentOutputConfig>(6, _omitFieldNames ? '' : 'documentOutputConfig', subBuilder: $4517.DocumentOutputConfig.create)
    ..aOM<ProcessOptions>(7, _omitFieldNames ? '' : 'processOptions', subBuilder: ProcessOptions.create)
    ..m<$core.String, $core.String>(9, _omitFieldNames ? '' : 'labels', entryClassName: 'BatchProcessRequest.LabelsEntry', keyFieldType: $pb.PbFieldType.OS, valueFieldType: $pb.PbFieldType.OS, packageName: const $pb.PackageName('google.cloud.documentai.v1'))
    ..hasRequiredFields = false
  ;
  ...
  /// method.
  @$pb.TagNumber(5)
  $4517.BatchDocumentsInputConfig get inputDocuments => $_getN(2);
  @$pb.TagNumber(5)
  set inputDocuments($4517.BatchDocumentsInputConfig v) { setField(5, v); }
  @$pb.TagNumber(5)
  $core.bool hasInputDocuments() => $_has(2);
  @$pb.TagNumber(5)
  void clearInputDocuments() => clearField(5);
  @$pb.TagNumber(5)
  $4517.BatchDocumentsInputConfig ensureInputDocuments() => $_ensure(2);

  /// The output configuration for the
  /// [BatchProcessDocuments][google.cloud.documentai.v1.DocumentProcessorService.BatchProcessDocuments]
  /// method.
  @$pb.TagNumber(6)
  $4517.DocumentOutputConfig get documentOutputConfig => $_getN(3);
  @$pb.TagNumber(6)
  set documentOutputConfig($4517.DocumentOutputConfig v) { setField(6, v); }
  @$pb.TagNumber(6)
  $core.bool hasDocumentOutputConfig() => $_has(3);
  @$pb.TagNumber(6)
  void clearDocumentOutputConfig() => clearField(6);
  @$pb.TagNumber(6)
  $4517.DocumentOutputConfig ensureDocumentOutputConfig() => $_ensure(3);

  /// Inference-time options for the process API
  @$pb.TagNumber(7)
  ProcessOptions get processOptions => $_getN(4);
  @$pb.TagNumber(7)
  set processOptions(ProcessOptions v) { setField(7, v); }
  @$pb.TagNumber(7)
  $core.bool hasProcessOptions() => $_has(4);
  @$pb.TagNumber(7)
  void clearProcessOptions() => clearField(7);
  @$pb.TagNumber(7)
  ProcessOptions ensureProcessOptions() => $_ensure(4);
...
class BatchProcessResponse extends $pb.GeneratedMessage {
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(_omitMessageNames ? '' : 'BatchProcessResponse', package: const $pb.PackageName(_omitMessageNames ? '' : 'google.cloud.documentai.v1'), createEmptyInstance: create)
    ..hasRequiredFields = false
  ;
...
class BatchProcessMetadata_IndividualProcessStatus extends $pb.GeneratedMessage {
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(_omitMessageNames ? '' : 'BatchProcessMetadata.IndividualProcessStatus', package: const $pb.PackageName(_omitMessageNames ? '' : 'google.cloud.documentai.v1'), createEmptyInstance: create)
...
class BatchProcessMetadata extends $pb.GeneratedMessage {
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(_omitMessageNames ? '' : 'BatchProcessMetadata', package: const $pb.PackageName(_omitMessageNames ? '' : 'google.cloud.documentai.v1'), createEmptyInstance: create)
...
class FetchProcessorTypesRequest extends $pb.GeneratedMessage {
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(_omitMessageNames ? '' : 'FetchProcessorTypesRequest', package: const $pb.PackageName(_omitMessageNames ? '' : 'google.cloud.documentai.v1'), createEmptyInstance: create)
...
class FetchProcessorTypesResponse extends $pb.GeneratedMessage {
  factory FetchProcessorTypesResponse({
    $core.Iterable<$1028.ProcessorType>? processorTypes,
  }) {
    final $result = create();
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(_omitMessageNames ? '' : 'FetchProcessorTypesResponse', package: const $pb.PackageName(_omitMessageNames ? '' : 'google.cloud.documentai.v1'), createEmptyInstance: create)
    ..pc<$1028.ProcessorType>(1, _omitFieldNames ? '' : 'processorTypes', $pb.PbFieldType.PM, subBuilder: $1028.ProcessorType.create)
    ..hasRequiredFields = false
  ;
  ...
  @$pb.TagNumber(1)
  $core.List<$1028.ProcessorType> get processorTypes => $_getList(0);
}
...
class ListProcessorTypesRequest extends $pb.GeneratedMessage {
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(_omitMessageNames ? '' : 'ListProcessorTypesRequest', package: const $pb.PackageName(_omitMessageNames ? '' : 'google.cloud.documentai.v1'), createEmptyInstance: create)
    ..aOS(1, _omitFieldNames ? '' : 'parent')
...
class ListProcessorTypesResponse extends $pb.GeneratedMessage {
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(_omitMessageNames ? '' : 'ListProcessorTypesResponse', package: const $pb.PackageName(_omitMessageNames ? '' : 'google.cloud.documentai.v1'), createEmptyInstance: create)
    ..pc<$1028.ProcessorType>(1, _omitFieldNames ? '' : 'processorTypes', $pb.PbFieldType.PM, subBuilder: $1028.ProcessorType.create)
...
class ListProcessorsRequest extends $pb.GeneratedMessage {
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(_omitMessageNames ? '' : 'ListProcessorsRequest', package: const $pb.PackageName(_omitMessageNames ? '' : 'google.cloud.documentai.v1'), createEmptyInstance: create)
    ..aOS(1, _omitFieldNames ? '' : 'parent')
    ..a<$core.int>(2, _omitFieldNames ? '' : 'pageSize', $pb.PbFieldType.O3)
    ..aOS(3, _omitFieldNames ? '' : 'pageToken')
    ..hasRequiredFields = false
...
class ListProcessorsResponse extends $pb.GeneratedMessage {
  factory ListProcessorsResponse({
    $core.Iterable<$1029.Processor>? processors,
    $core.String? nextPageToken,
  }) {
    final $result = create();
    if (processors != null) {
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(_omitMessageNames ? '' : 'ListProcessorsResponse', package: const $pb.PackageName(_omitMessageNames ? '' : 'google.cloud.documentai.v1'), createEmptyInstance: create)
    ..pc<$1029.Processor>(1, _omitFieldNames ? '' : 'processors', $pb.PbFieldType.PM, subBuilder: $1029.Processor.create)
    ..aOS(2, _omitFieldNames ? '' : 'nextPageToken')
    ..hasRequiredFields = false
  ;
  ...
  @$pb.TagNumber(1)
  $core.List<$1029.Processor> get processors => $_getList(0);
...
class GetProcessorTypeRequest extends $pb.GeneratedMessage {
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(_omitMessageNames ? '' : 'GetProcessorTypeRequest', package: const $pb.PackageName(_omitMessageNames ? '' : 'google.cloud.documentai.v1'), createEmptyInstance: create)
    ..aOS(1, _omitFieldNames ? '' : 'name')
    ..hasRequiredFields = false
  ;
...
class GetProcessorRequest extends $pb.GeneratedMessage {
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(_omitMessageNames ? '' : 'GetProcessorRequest', package: const $pb.PackageName(_omitMessageNames ? '' : 'google.cloud.documentai.v1'), createEmptyInstance: create)
    ..aOS(1, _omitFieldNames ? '' : 'name')
    ..hasRequiredFields = false
  ;
...
class GetProcessorVersionRequest extends $pb.GeneratedMessage {
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(_omitMessageNames ? '' : 'GetProcessorVersionRequest', package: const $pb.PackageName(_omitMessageNames ? '' : 'google.cloud.documentai.v1'), createEmptyInstance: create)
    ..aOS(1, _omitFieldNames ? '' : 'name')
    ..hasRequiredFields = false
  ;
...
class ListProcessorVersionsRequest extends $pb.GeneratedMessage {
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(_omitMessageNames ? '' : 'ListProcessorVersionsRequest', package: const $pb.PackageName(_omitMessageNames ? '' : 'google.cloud.documentai.v1'), createEmptyInstance: create)
    ..aOS(1, _omitFieldNames ? '' : 'parent')
    ..a<$core.int>(2, _omitFieldNames ? '' : 'pageSize', $pb.PbFieldType.O3)
    ..aOS(3, _omitFieldNames ? '' : 'pageToken')
    ..hasRequiredFields = false
...
class ListProcessorVersionsResponse extends $pb.GeneratedMessage {
  factory ListProcessorVersionsResponse({
    $core.Iterable<$1029.ProcessorVersion>? processorVersions,
    $core.String? nextPageToken,
  }) {
    final $result = create();
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(_omitMessageNames ? '' : 'ListProcessorVersionsResponse', package: const $pb.PackageName(_omitMessageNames ? '' : 'google.cloud.documentai.v1'), createEmptyInstance: create)
    ..pc<$1029.ProcessorVersion>(1, _omitFieldNames ? '' : 'processorVersions', $pb.PbFieldType.PM, subBuilder: $1029.ProcessorVersion.create)
    ..aOS(2, _omitFieldNames ? '' : 'nextPageToken')
    ..hasRequiredFields = false
  ;
  ...
  /// The list of processors.
  @$pb.TagNumber(1)
  $core.List<$1029.ProcessorVersion> get processorVersions => $_getList(0);
...
class DeleteProcessorVersionRequest extends $pb.GeneratedMessage {
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(_omitMessageNames ? '' : 'DeleteProcessorVersionRequest', package: const $pb.PackageName(_omitMessageNames ? '' : 'google.cloud.documentai.v1'), createEmptyInstance: create)
    ..aOS(1, _omitFieldNames ? '' : 'name')
    ..hasRequiredFields = false
  ;
...
class DeleteProcessorVersionMetadata extends $pb.GeneratedMessage {
  factory DeleteProcessorVersionMetadata({
    $4518.CommonOperationMetadata? commonMetadata,
  }) {
    final $result = create();
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(_omitMessageNames ? '' : 'DeleteProcessorVersionMetadata', package: const $pb.PackageName(_omitMessageNames ? '' : 'google.cloud.documentai.v1'), createEmptyInstance: create)
    ..aOM<$4518.CommonOperationMetadata>(1, _omitFieldNames ? '' : 'commonMetadata', subBuilder: $4518.CommonOperationMetadata.create)
    ..hasRequiredFields = false
  ;
  ...
  @$pb.TagNumber(1)
  $4518.CommonOperationMetadata get commonMetadata => $_getN(0);
  @$pb.TagNumber(1)
  set commonMetadata($4518.CommonOperationMetadata v) { setField(1, v); }
  @$pb.TagNumber(1)
  $core.bool hasCommonMetadata() => $_has(0);
  @$pb.TagNumber(1)
  void clearCommonMetadata() => clearField(1);
  @$pb.TagNumber(1)
  $4518.CommonOperationMetadata ensureCommonMetadata() => $_ensure(0);
}
...
class DeployProcessorVersionRequest extends $pb.GeneratedMessage {
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(_omitMessageNames ? '' : 'DeployProcessorVersionRequest', package: const $pb.PackageName(_omitMessageNames ? '' : 'google.cloud.documentai.v1'), createEmptyInstance: create)
    ..aOS(1, _omitFieldNames ? '' : 'name')
    ..hasRequiredFields = false
  ;
...
class DeployProcessorVersionResponse extends $pb.GeneratedMessage {
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(_omitMessageNames ? '' : 'DeployProcessorVersionResponse', package: const $pb.PackageName(_omitMessageNames ? '' : 'google.cloud.documentai.v1'), createEmptyInstance: create)
    ..hasRequiredFields = false
  ;
...
class DeployProcessorVersionMetadata extends $pb.GeneratedMessage {
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(_omitMessageNames ? '' : 'DeployProcessorVersionMetadata', package: const $pb.PackageName(_omitMessageNames ? '' : 'google.cloud.documentai.v1'), createEmptyInstance: create)
    ..aOM<$4518.CommonOperationMetadata>(1, _omitFieldNames ? '' : 'commonMetadata', subBuilder: $4518.CommonOperationMetadata.create)
    ..hasRequiredFields = false
  ;
...
class UndeployProcessorVersionRequest extends $pb.GeneratedMessage {
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(_omitMessageNames ? '' : 'UndeployProcessorVersionRequest', package: const $pb.PackageName(_omitMessageNames ? '' : 'google.cloud.documentai.v1'), createEmptyInstance: create)
    ..aOS(1, _omitFieldNames ? '' : 'name')
    ..hasRequiredFields = false
  ;
...
class UndeployProcessorVersionResponse extends $pb.GeneratedMessage {
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(_omitMessageNames ? '' : 'UndeployProcessorVersionResponse', package: const $pb.PackageName(_omitMessageNames ? '' : 'google.cloud.documentai.v1'), createEmptyInstance: create)
    ..hasRequiredFields = false
  ;
...
class UndeployProcessorVersionMetadata extends $pb.GeneratedMessage {
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(_omitMessageNames ? '' : 'UndeployProcessorVersionMetadata', package: const $pb.PackageName(_omitMessageNames ? '' : 'google.cloud.documentai.v1'), createEmptyInstance: create)
    ..aOM<$4518.CommonOperationMetadata>(1, _omitFieldNames ? '' : 'commonMetadata', subBuilder: $4518.CommonOperationMetadata.create)
    ..hasRequiredFields = false
  ;
...
class CreateProcessorRequest extends $pb.GeneratedMessage {
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(_omitMessageNames ? '' : 'CreateProcessorRequest', package: const $pb.PackageName(_omitMessageNames ? '' : 'google.cloud.documentai.v1'), createEmptyInstance: create)
    ..aOS(1, _omitFieldNames ? '' : 'parent')
    ..aOM<$1029.Processor>(2, _omitFieldNames ? '' : 'processor', subBuilder: $1029.Processor.create)
    ..hasRequiredFields = false
  ;
  ...
  @$pb.TagNumber(2)
  $1029.Processor get processor => $_getN(1);
  @$pb.TagNumber(2)
  set processor($1029.Processor v) { setField(2, v); }
  @$pb.TagNumber(2)
  $core.bool hasProcessor() => $_has(1);
  @$pb.TagNumber(2)
  void clearProcessor() => clearField(2);
  @$pb.TagNumber(2)
  $1029.Processor ensureProcessor() => $_ensure(1);
}
...
class DeleteProcessorRequest extends $pb.GeneratedMessage {
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(_omitMessageNames ? '' : 'DeleteProcessorRequest', package: const $pb.PackageName(_omitMessageNames ? '' : 'google.cloud.documentai.v1'), createEmptyInstance: create)
    ..aOS(1, _omitFieldNames ? '' : 'name')
    ..hasRequiredFields = false
  ;
...
class DeleteProcessorMetadata extends $pb.GeneratedMessage {
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(_omitMessageNames ? '' : 'DeleteProcessorMetadata', package: const $pb.PackageName(_omitMessageNames ? '' : 'google.cloud.documentai.v1'), createEmptyInstance: create)
    ..aOM<$4518.CommonOperationMetadata>(5, _omitFieldNames ? '' : 'commonMetadata', subBuilder: $4518.CommonOperationMetadata.create)
    ..hasRequiredFields = false
  ;
  ...
  $4518.CommonOperationMetadata get commonMetadata => $_getN(0);
  @$pb.TagNumber(5)
  set commonMetadata($4518.CommonOperationMetadata v) { setField(5, v); }
  @$pb.TagNumber(5)
  $core.bool hasCommonMetadata() => $_has(0);
  @$pb.TagNumber(5)
...
class EnableProcessorRequest extends $pb.GeneratedMessage {
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(_omitMessageNames ? '' : 'EnableProcessorRequest', package: const $pb.PackageName(_omitMessageNames ? '' : 'google.cloud.documentai.v1'), createEmptyInstance: create)
    ..aOS(1, _omitFieldNames ? '' : 'name')
    ..hasRequiredFields = false
  ;
...
class EnableProcessorResponse extends $pb.GeneratedMessage {
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(_omitMessageNames ? '' : 'EnableProcessorResponse', package: const $pb.PackageName(_omitMessageNames ? '' : 'google.cloud.documentai.v1'), createEmptyInstance: create)
    ..hasRequiredFields = false
  ;
...
class EnableProcessorMetadata extends $pb.GeneratedMessage {
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(_omitMessageNames ? '' : 'EnableProcessorMetadata', package: const $pb.PackageName(_omitMessageNames ? '' : 'google.cloud.documentai.v1'), createEmptyInstance: create)
    ..aOM<$4518.CommonOperationMetadata>(5, _omitFieldNames ? '' : 'commonMetadata', subBuilder: $4518.CommonOperationMetadata.create)
    ..hasRequiredFields = false
  ;
...
class DisableProcessorRequest extends $pb.GeneratedMessage {
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(_omitMessageNames ? '' : 'DisableProcessorRequest', package: const $pb.PackageName(_omitMessageNames ? '' : 'google.cloud.documentai.v1'), createEmptyInstance: create)
    ..aOS(1, _omitFieldNames ? '' : 'name')
    ..hasRequiredFields = false
  ;
...
class DisableProcessorResponse extends $pb.GeneratedMessage {
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(_omitMessageNames ? '' : 'DisableProcessorResponse', package: const $pb.PackageName(_omitMessageNames ? '' : 'google.cloud.documentai.v1'), createEmptyInstance: create)
    ..hasRequiredFields = false
  ;
...
class DisableProcessorMetadata extends $pb.GeneratedMessage {
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(_omitMessageNames ? '' : 'DisableProcessorMetadata', package: const $pb.PackageName(_omitMessageNames ? '' : 'google.cloud.documentai.v1'), createEmptyInstance: create)
    ..aOM<$4518.CommonOperationMetadata>(5, _omitFieldNames ? '' : 'commonMetadata', subBuilder: $4518.CommonOperationMetadata.create)
    ..hasRequiredFields = false
  ;
...
class SetDefaultProcessorVersionRequest extends $pb.GeneratedMessage {
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(_omitMessageNames ? '' : 'SetDefaultProcessorVersionRequest', package: const $pb.PackageName(_omitMessageNames ? '' : 'google.cloud.documentai.v1'), createEmptyInstance: create)
...
class SetDefaultProcessorVersionResponse extends $pb.GeneratedMessage {
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(_omitMessageNames ? '' : 'SetDefaultProcessorVersionResponse', package: const $pb.PackageName(_omitMessageNames ? '' : 'google.cloud.documentai.v1'), createEmptyInstance: create)
    ..hasRequiredFields = false
  ;
...
class SetDefaultProcessorVersionMetadata extends $pb.GeneratedMessage {
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(_omitMessageNames ? '' : 'SetDefaultProcessorVersionMetadata', package: const $pb.PackageName(_omitMessageNames ? '' : 'google.cloud.documentai.v1'), createEmptyInstance: create)
    ..aOM<$4518.CommonOperationMetadata>(1, _omitFieldNames ? '' : 'commonMetadata', subBuilder: $4518.CommonOperationMetadata.create)
    ..hasRequiredFields = false
  ;
...
class TrainProcessorVersionRequest_InputData extends $pb.GeneratedMessage {
  factory TrainProcessorVersionRequest_InputData({
    $4517.BatchDocumentsInputConfig? trainingDocuments,
    $4517.BatchDocumentsInputConfig? testDocuments,
  }) {
    final $result = create();
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(_omitMessageNames ? '' : 'TrainProcessorVersionRequest.InputData', package: const $pb.PackageName(_omitMessageNames ? '' : 'google.cloud.documentai.v1'), createEmptyInstance: create)
    ..aOM<$4517.BatchDocumentsInputConfig>(3, _omitFieldNames ? '' : 'trainingDocuments', subBuilder: $4517.BatchDocumentsInputConfig.create)
    ..aOM<$4517.BatchDocumentsInputConfig>(4, _omitFieldNames ? '' : 'testDocuments', subBuilder: $4517.BatchDocumentsInputConfig.create)
    ..hasRequiredFields = false
  ;
  ...
  @$pb.TagNumber(3)
  $4517.BatchDocumentsInputConfig get trainingDocuments => $_getN(0);
  @$pb.TagNumber(3)
  set trainingDocuments($4517.BatchDocumentsInputConfig v) { setField(3, v); }
  @$pb.TagNumber(3)
  $core.bool hasTrainingDocuments() => $_has(0);
  @$pb.TagNumber(3)
  void clearTrainingDocuments() => clearField(3);
  @$pb.TagNumber(3)
  $4517.BatchDocumentsInputConfig ensureTrainingDocuments() => $_ensure(0);

  /// The documents used for testing the trained version.
  @$pb.TagNumber(4)
  $4517.BatchDocumentsInputConfig get testDocuments => $_getN(1);
  @$pb.TagNumber(4)
  set testDocuments($4517.BatchDocumentsInputConfig v) { setField(4, v); }
  @$pb.TagNumber(4)
  $core.bool hasTestDocuments() => $_has(1);
  @$pb.TagNumber(4)
  void clearTestDocuments() => clearField(4);
  @$pb.TagNumber(4)
  $4517.BatchDocumentsInputConfig ensureTestDocuments() => $_ensure(1);
}
...
class TrainProcessorVersionRequest_CustomDocumentExtractionOptions extends $pb.GeneratedMessage {
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(_omitMessageNames ? '' : 'TrainProcessorVersionRequest.CustomDocumentExtractionOptions', package: const $pb.PackageName(_omitMessageNames ? '' : 'google.cloud.documentai.v1'), createEmptyInstance: create)
...
class TrainProcessorVersionRequest_FoundationModelTuningOptions extends $pb.GeneratedMessage {
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(_omitMessageNames ? '' : 'TrainProcessorVersionRequest.FoundationModelTuningOptions', package: const $pb.PackageName(_omitMessageNames ? '' : 'google.cloud.documentai.v1'), createEmptyInstance: create)
...
class TrainProcessorVersionRequest extends $pb.GeneratedMessage {
  factory TrainProcessorVersionRequest({
    $core.String? parent,
    $1029.ProcessorVersion? processorVersion,
    ...
    $4516.DocumentSchema? documentSchema,
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(_omitMessageNames ? '' : 'TrainProcessorVersionRequest', package: const $pb.PackageName(_omitMessageNames ? '' : 'google.cloud.documentai.v1'), createEmptyInstance: create)
    ..oo(0, [5, 12])
    ..aOS(1, _omitFieldNames ? '' : 'parent')
    ..aOM<$1029.ProcessorVersion>(2, _omitFieldNames ? '' : 'processorVersion', subBuilder: $1029.ProcessorVersion.create)
    ...
    ..aOM<$4516.DocumentSchema>(10, _omitFieldNames ? '' : 'documentSchema', subBuilder: $4516.DocumentSchema.create)
  ...
  @$pb.TagNumber(2)
  $1029.ProcessorVersion get processorVersion => $_getN(1);
  @$pb.TagNumber(2)
  set processorVersion($1029.ProcessorVersion v) { setField(2, v); }
  @$pb.TagNumber(2)
  $core.bool hasProcessorVersion() => $_has(1);
  @$pb.TagNumber(2)
  void clearProcessorVersion() => clearField(2);
  @$pb.TagNumber(2)
  $1029.ProcessorVersion ensureProcessorVersion() => $_ensure(1);
  ...
  @$pb.TagNumber(10)
  $4516.DocumentSchema get documentSchema => $_getN(5);
  @$pb.TagNumber(10)
  set documentSchema($4516.DocumentSchema v) { setField(10, v); }
  @$pb.TagNumber(10)
  $core.bool hasDocumentSchema() => $_has(5);
  @$pb.TagNumber(10)
  void clearDocumentSchema() => clearField(10);
  @$pb.TagNumber(10)
  $4516.DocumentSchema ensureDocumentSchema() => $_ensure(5);
...
class TrainProcessorVersionResponse extends $pb.GeneratedMessage {
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(_omitMessageNames ? '' : 'TrainProcessorVersionResponse', package: const $pb.PackageName(_omitMessageNames ? '' : 'google.cloud.documentai.v1'), createEmptyInstance: create)
...
class TrainProcessorVersionMetadata_DatasetValidation extends $pb.GeneratedMessage {
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(_omitMessageNames ? '' : 'TrainProcessorVersionMetadata.DatasetValidation', package: const $pb.PackageName(_omitMessageNames ? '' : 'google.cloud.documentai.v1'), createEmptyInstance: create)
...
class TrainProcessorVersionMetadata extends $pb.GeneratedMessage {
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(_omitMessageNames ? '' : 'TrainProcessorVersionMetadata', package: const $pb.PackageName(_omitMessageNames ? '' : 'google.cloud.documentai.v1'), createEmptyInstance: create)
    ..aOM<$4518.CommonOperationMetadata>(1, _omitFieldNames ? '' : 'commonMetadata', subBuilder: $4518.CommonOperationMetadata.create)
...
class ReviewDocumentRequest extends $pb.GeneratedMessage {
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(_omitMessageNames ? '' : 'ReviewDocumentRequest', package: const $pb.PackageName(_omitMessageNames ? '' : 'google.cloud.documentai.v1'), createEmptyInstance: create)
    ..oo(0, [4])
    ...
    ..aOM<$4516.DocumentSchema>(6, _omitFieldNames ? '' : 'documentSchema', subBuilder: $4516.DocumentSchema.create)
    ..hasRequiredFields = false
  ;
  ...
  @$pb.TagNumber(6)
  $4516.DocumentSchema get documentSchema => $_getN(4);
  @$pb.TagNumber(6)
  set documentSchema($4516.DocumentSchema v) { setField(6, v); }
  @$pb.TagNumber(6)
  $core.bool hasDocumentSchema() => $_has(4);
  @$pb.TagNumber(6)
  void clearDocumentSchema() => clearField(6);
  @$pb.TagNumber(6)
  $4516.DocumentSchema ensureDocumentSchema() => $_ensure(4);
}
...
class ReviewDocumentResponse extends $pb.GeneratedMessage {
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(_omitMessageNames ? '' : 'ReviewDocumentResponse', package: const $pb.PackageName(_omitMessageNames ? '' : 'google.cloud.documentai.v1'), createEmptyInstance: create)
...
class ReviewDocumentOperationMetadata extends $pb.GeneratedMessage {
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(_omitMessageNames ? '' : 'ReviewDocumentOperationMetadata', package: const $pb.PackageName(_omitMessageNames ? '' : 'google.cloud.documentai.v1'), createEmptyInstance: create)
    ..aOM<$4518.CommonOperationMetadata>(5, _omitFieldNames ? '' : 'commonMetadata', subBuilder: $4518.CommonOperationMetadata.create)
...
class EvaluateProcessorVersionRequest extends $pb.GeneratedMessage {
  factory EvaluateProcessorVersionRequest({
    $core.String? processorVersion,
    $4517.BatchDocumentsInputConfig? evaluationDocuments,
  }) {
    final $result = create();
    if (processorVersion != null) {
      $result.processorVersion = processorVersion;
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(_omitMessageNames ? '' : 'EvaluateProcessorVersionRequest', package: const $pb.PackageName(_omitMessageNames ? '' : 'google.cloud.documentai.v1'), createEmptyInstance: create)
    ..aOS(1, _omitFieldNames ? '' : 'processorVersion')
    ..aOM<$4517.BatchDocumentsInputConfig>(3, _omitFieldNames ? '' : 'evaluationDocuments', subBuilder: $4517.BatchDocumentsInputConfig.create)
    ..hasRequiredFields = false
  ;
  ...
  @$pb.TagNumber(3)
  $4517.BatchDocumentsInputConfig get evaluationDocuments => $_getN(1);
  @$pb.TagNumber(3)
  set evaluationDocuments($4517.BatchDocumentsInputConfig v) { setField(3, v); }
  @$pb.TagNumber(3)
  $core.bool hasEvaluationDocuments() => $_has(1);
  @$pb.TagNumber(3)
  void clearEvaluationDocuments() => clearField(3);
  @$pb.TagNumber(3)
  $4517.BatchDocumentsInputConfig ensureEvaluationDocuments() => $_ensure(1);
}
...
class EvaluateProcessorVersionMetadata extends $pb.GeneratedMessage {
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(_omitMessageNames ? '' : 'EvaluateProcessorVersionMetadata', package: const $pb.PackageName(_omitMessageNames ? '' : 'google.cloud.documentai.v1'), createEmptyInstance: create)
    ..aOM<$4518.CommonOperationMetadata>(1, _omitFieldNames ? '' : 'commonMetadata', subBuilder: $4518.CommonOperationMetadata.create)
    ..hasRequiredFields = false
  ;
...
class EvaluateProcessorVersionResponse extends $pb.GeneratedMessage {
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(_omitMessageNames ? '' : 'EvaluateProcessorVersionResponse', package: const $pb.PackageName(_omitMessageNames ? '' : 'google.cloud.documentai.v1'), createEmptyInstance: create)
...
class GetEvaluationRequest extends $pb.GeneratedMessage {
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(_omitMessageNames ? '' : 'GetEvaluationRequest', package: const $pb.PackageName(_omitMessageNames ? '' : 'google.cloud.documentai.v1'), createEmptyInstance: create)
    ..aOS(1, _omitFieldNames ? '' : 'name')
    ..hasRequiredFields = false
  ;
...
class ListEvaluationsRequest extends $pb.GeneratedMessage {
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(_omitMessageNames ? '' : 'ListEvaluationsRequest', package: const $pb.PackageName(_omitMessageNames ? '' : 'google.cloud.documentai.v1'), createEmptyInstance: create)
    ..aOS(1, _omitFieldNames ? '' : 'parent')
    ..a<$core.int>(2, _omitFieldNames ? '' : 'pageSize', $pb.PbFieldType.O3)
    ..aOS(3, _omitFieldNames ? '' : 'pageToken')
    ..hasRequiredFields = false
...
class ListEvaluationsResponse extends $pb.GeneratedMessage {
  factory ListEvaluationsResponse({
    $core.Iterable<$1030.Evaluation>? evaluations,
    $core.String? nextPageToken,
  }) {
    final $result = create();
    if (evaluations != null) {
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(_omitMessageNames ? '' : 'ListEvaluationsResponse', package: const $pb.PackageName(_omitMessageNames ? '' : 'google.cloud.documentai.v1'), createEmptyInstance: create)
    ..pc<$1030.Evaluation>(1, _omitFieldNames ? '' : 'evaluations', $pb.PbFieldType.PM, subBuilder: $1030.Evaluation.create)
    ..aOS(2, _omitFieldNames ? '' : 'nextPageToken')
    ..hasRequiredFields = false
  ;
  ...
  @$pb.TagNumber(1)
  $core.List<$1030.Evaluation> get evaluations => $_getList(0);
