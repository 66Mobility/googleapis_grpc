...
const BoundingPoly$json = {
  '1': 'BoundingPoly',
  '2': [
    {'1': 'vertices', '3': 1, '4': 3, '5': 11, '6': '.google.cloud.documentai.v1beta1.Vertex', '10': 'vertices'},
    {'1': 'normalized_vertices', '3': 2, '4': 3, '5': 11, '6': '.google.cloud.documentai.v1beta1.NormalizedVertex', '10': 'normalizedVertices'},
  ],
};
...
final $typed_data.Uint8List boundingPolyDescriptor = $convert.base64Decode(
    ...
    'RhaS52MWJldGExLlZlcnRleFIIdmVydGljZXMSYgoTbm9ybWFsaXplZF92ZXJ0aWNlcxgCIAMo'
    'CzIxLmdvb2dsZS5jbG91ZC5kb2N1bWVudGFpLnYxYmV0YTEuTm9ybWFsaXplZFZlcnRleFISbm'
