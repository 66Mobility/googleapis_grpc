...
class Accelerator_AcceleratorType extends $pb.ProtobufEnum {
  ...
  static const Accelerator_AcceleratorType CCAI_INSIGHTS = Accelerator_AcceleratorType._(3, _omitEnumNames ? '' : 'CCAI_INSIGHTS');
...
class Accelerator_State extends $pb.ProtobufEnum {
  static const Accelerator_State STATE_UNSPECIFIED = Accelerator_State._(0, _omitEnumNames ? '' : 'STATE_UNSPECIFIED');
  static const Accelerator_State ENABLED = Accelerator_State._(1, _omitEnumNames ? '' : 'ENABLED');
  static const Accelerator_State DISABLED = Accelerator_State._(2, _omitEnumNames ? '' : 'DISABLED');
  static const Accelerator_State UNKNOWN = Accelerator_State._(3, _omitEnumNames ? '' : 'UNKNOWN');
