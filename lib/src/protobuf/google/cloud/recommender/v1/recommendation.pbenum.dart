...
class ReliabilityProjection_RiskType extends $pb.ProtobufEnum {
  static const ReliabilityProjection_RiskType RISK_TYPE_UNSPECIFIED = ReliabilityProjection_RiskType._(0, _omitEnumNames ? '' : 'RISK_TYPE_UNSPECIFIED');
  static const ReliabilityProjection_RiskType SERVICE_DISRUPTION = ReliabilityProjection_RiskType._(1, _omitEnumNames ? '' : 'SERVICE_DISRUPTION');
  static const ReliabilityProjection_RiskType DATA_LOSS = ReliabilityProjection_RiskType._(2, _omitEnumNames ? '' : 'DATA_LOSS');
  static const ReliabilityProjection_RiskType ACCESS_DENY = ReliabilityProjection_RiskType._(3, _omitEnumNames ? '' : 'ACCESS_DENY');

  static const $core.List<ReliabilityProjection_RiskType> values = <ReliabilityProjection_RiskType> [
  ...
  static final $core.Map<$core.int, ReliabilityProjection_RiskType> _byValue = $pb.ProtobufEnum.initByValue(values);
  static ReliabilityProjection_RiskType? valueOf($core.int value) => _byValue[value];

  const ReliabilityProjection_RiskType._($core.int v, $core.String n) : super(v, n);
}
...
class Impact_Category extends $pb.ProtobufEnum {
  ...
  static const Impact_Category RELIABILITY = Impact_Category._(6, _omitEnumNames ? '' : 'RELIABILITY');
