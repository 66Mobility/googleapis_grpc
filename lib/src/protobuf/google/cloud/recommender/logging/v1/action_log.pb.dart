...
import '../../v1/insight.pbenum.dart' as $1231;
import '../../v1/recommendation.pbenum.dart' as $1232;

/// Log content of an action on a recommendation. This includes Mark* actions.
class ActionLog extends $pb.GeneratedMessage {
  factory ActionLog({
    $core.String? actor,
    $1232.RecommendationStateInfo_State? state,
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(_omitMessageNames ? '' : 'ActionLog', package: const $pb.PackageName(_omitMessageNames ? '' : 'google.cloud.recommender.logging.v1'), createEmptyInstance: create)
    ..aOS(1, _omitFieldNames ? '' : 'actor')
    ..e<$1232.RecommendationStateInfo_State>(2, _omitFieldNames ? '' : 'state', $pb.PbFieldType.OE, defaultOrMaker: $1232.RecommendationStateInfo_State.STATE_UNSPECIFIED, valueOf: $1232.RecommendationStateInfo_State.valueOf, enumValues: $1232.RecommendationStateInfo_State.values)
    ..m<$core.String, $core.String>(3, _omitFieldNames ? '' : 'stateMetadata', entryClassName: 'ActionLog.StateMetadataEntry', keyFieldType: $pb.PbFieldType.OS, valueFieldType: $pb.PbFieldType.OS, packageName: const $pb.PackageName('google.cloud.recommender.logging.v1'))
  ...
  @$pb.TagNumber(2)
  $1232.RecommendationStateInfo_State get state => $_getN(1);
  @$pb.TagNumber(2)
  set state($1232.RecommendationStateInfo_State v) { setField(2, v); }
  @$pb.TagNumber(2)
...
class InsightActionLog extends $pb.GeneratedMessage {
  factory InsightActionLog({
    $core.String? actor,
    $1231.InsightStateInfo_State? state,
    $core.Map<$core.String, $core.String>? stateMetadata,
    $core.String? insight,
  }) {
    final $result = create();
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(_omitMessageNames ? '' : 'InsightActionLog', package: const $pb.PackageName(_omitMessageNames ? '' : 'google.cloud.recommender.logging.v1'), createEmptyInstance: create)
    ..aOS(1, _omitFieldNames ? '' : 'actor')
    ..e<$1231.InsightStateInfo_State>(2, _omitFieldNames ? '' : 'state', $pb.PbFieldType.OE, defaultOrMaker: $1231.InsightStateInfo_State.STATE_UNSPECIFIED, valueOf: $1231.InsightStateInfo_State.valueOf, enumValues: $1231.InsightStateInfo_State.values)
    ..m<$core.String, $core.String>(3, _omitFieldNames ? '' : 'stateMetadata', entryClassName: 'InsightActionLog.StateMetadataEntry', keyFieldType: $pb.PbFieldType.OS, valueFieldType: $pb.PbFieldType.OS, packageName: const $pb.PackageName('google.cloud.recommender.logging.v1'))
  ...
  @$pb.TagNumber(2)
  $1231.InsightStateInfo_State get state => $_getN(1);
  @$pb.TagNumber(2)
  set state($1231.InsightStateInfo_State v) { setField(2, v); }
  @$pb.TagNumber(2)
  $core.bool hasState() => $_has(1);
  @$pb.TagNumber(2)
  void clearState() => clearField(2);
