...
class ListInsightsRequest extends $pb.GeneratedMessage {
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(_omitMessageNames ? '' : 'ListInsightsRequest', package: const $pb.PackageName(_omitMessageNames ? '' : 'google.cloud.recommender.v1beta1'), createEmptyInstance: create)
...
class ListInsightsResponse extends $pb.GeneratedMessage {
  factory ListInsightsResponse({
    $core.Iterable<$1236.Insight>? insights,
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(_omitMessageNames ? '' : 'ListInsightsResponse', package: const $pb.PackageName(_omitMessageNames ? '' : 'google.cloud.recommender.v1beta1'), createEmptyInstance: create)
    ..pc<$1236.Insight>(1, _omitFieldNames ? '' : 'insights', $pb.PbFieldType.PM, subBuilder: $1236.Insight.create)
  ...
  @$pb.TagNumber(1)
  $core.List<$1236.Insight> get insights => $_getList(0);
...
class GetInsightRequest extends $pb.GeneratedMessage {
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(_omitMessageNames ? '' : 'GetInsightRequest', package: const $pb.PackageName(_omitMessageNames ? '' : 'google.cloud.recommender.v1beta1'), createEmptyInstance: create)
...
class MarkInsightAcceptedRequest extends $pb.GeneratedMessage {
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(_omitMessageNames ? '' : 'MarkInsightAcceptedRequest', package: const $pb.PackageName(_omitMessageNames ? '' : 'google.cloud.recommender.v1beta1'), createEmptyInstance: create)
    ..aOS(1, _omitFieldNames ? '' : 'name')
    ..m<$core.String, $core.String>(2, _omitFieldNames ? '' : 'stateMetadata', entryClassName: 'MarkInsightAcceptedRequest.StateMetadataEntry', keyFieldType: $pb.PbFieldType.OS, valueFieldType: $pb.PbFieldType.OS, packageName: const $pb.PackageName('google.cloud.recommender.v1beta1'))
...
class ListRecommendationsRequest extends $pb.GeneratedMessage {
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(_omitMessageNames ? '' : 'ListRecommendationsRequest', package: const $pb.PackageName(_omitMessageNames ? '' : 'google.cloud.recommender.v1beta1'), createEmptyInstance: create)
    ..aOS(1, _omitFieldNames ? '' : 'parent')
    ..a<$core.int>(2, _omitFieldNames ? '' : 'pageSize', $pb.PbFieldType.O3)
    ..aOS(3, _omitFieldNames ? '' : 'pageToken')
...
class ListRecommendationsResponse extends $pb.GeneratedMessage {
  factory ListRecommendationsResponse({
    $core.Iterable<$1237.Recommendation>? recommendations,
    $core.String? nextPageToken,
  }) {
    final $result = create();
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(_omitMessageNames ? '' : 'ListRecommendationsResponse', package: const $pb.PackageName(_omitMessageNames ? '' : 'google.cloud.recommender.v1beta1'), createEmptyInstance: create)
    ..pc<$1237.Recommendation>(1, _omitFieldNames ? '' : 'recommendations', $pb.PbFieldType.PM, subBuilder: $1237.Recommendation.create)
    ..aOS(2, _omitFieldNames ? '' : 'nextPageToken')
    ..hasRequiredFields = false
  ;
  ...
  @$pb.TagNumber(1)
  $core.List<$1237.Recommendation> get recommendations => $_getList(0);
...
class GetRecommendationRequest extends $pb.GeneratedMessage {
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(_omitMessageNames ? '' : 'GetRecommendationRequest', package: const $pb.PackageName(_omitMessageNames ? '' : 'google.cloud.recommender.v1beta1'), createEmptyInstance: create)
    ..aOS(1, _omitFieldNames ? '' : 'name')
    ..hasRequiredFields = false
  ;
...
class MarkRecommendationClaimedRequest extends $pb.GeneratedMessage {
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(_omitMessageNames ? '' : 'MarkRecommendationClaimedRequest', package: const $pb.PackageName(_omitMessageNames ? '' : 'google.cloud.recommender.v1beta1'), createEmptyInstance: create)
    ..aOS(1, _omitFieldNames ? '' : 'name')
    ..m<$core.String, $core.String>(2, _omitFieldNames ? '' : 'stateMetadata', entryClassName: 'MarkRecommendationClaimedRequest.StateMetadataEntry', keyFieldType: $pb.PbFieldType.OS, valueFieldType: $pb.PbFieldType.OS, packageName: const $pb.PackageName('google.cloud.recommender.v1beta1'))
    ..aOS(3, _omitFieldNames ? '' : 'etag')
    ..hasRequiredFields = false
  ;
...
class MarkRecommendationSucceededRequest extends $pb.GeneratedMessage {
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(_omitMessageNames ? '' : 'MarkRecommendationSucceededRequest', package: const $pb.PackageName(_omitMessageNames ? '' : 'google.cloud.recommender.v1beta1'), createEmptyInstance: create)
    ..aOS(1, _omitFieldNames ? '' : 'name')
    ..m<$core.String, $core.String>(2, _omitFieldNames ? '' : 'stateMetadata', entryClassName: 'MarkRecommendationSucceededRequest.StateMetadataEntry', keyFieldType: $pb.PbFieldType.OS, valueFieldType: $pb.PbFieldType.OS, packageName: const $pb.PackageName('google.cloud.recommender.v1beta1'))
    ..aOS(3, _omitFieldNames ? '' : 'etag')
    ..hasRequiredFields = false
  ;
...
class MarkRecommendationFailedRequest extends $pb.GeneratedMessage {
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(_omitMessageNames ? '' : 'MarkRecommendationFailedRequest', package: const $pb.PackageName(_omitMessageNames ? '' : 'google.cloud.recommender.v1beta1'), createEmptyInstance: create)
    ..aOS(1, _omitFieldNames ? '' : 'name')
    ..m<$core.String, $core.String>(2, _omitFieldNames ? '' : 'stateMetadata', entryClassName: 'MarkRecommendationFailedRequest.StateMetadataEntry', keyFieldType: $pb.PbFieldType.OS, valueFieldType: $pb.PbFieldType.OS, packageName: const $pb.PackageName('google.cloud.recommender.v1beta1'))
    ..aOS(3, _omitFieldNames ? '' : 'etag')
    ..hasRequiredFields = false
  ;
...
class GetRecommenderConfigRequest extends $pb.GeneratedMessage {
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(_omitMessageNames ? '' : 'GetRecommenderConfigRequest', package: const $pb.PackageName(_omitMessageNames ? '' : 'google.cloud.recommender.v1beta1'), createEmptyInstance: create)
    ..aOS(1, _omitFieldNames ? '' : 'name')
    ..hasRequiredFields = false
  ;
...
class UpdateRecommenderConfigRequest extends $pb.GeneratedMessage {
  factory UpdateRecommenderConfigRequest({
    $1238.RecommenderConfig? recommenderConfig,
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(_omitMessageNames ? '' : 'UpdateRecommenderConfigRequest', package: const $pb.PackageName(_omitMessageNames ? '' : 'google.cloud.recommender.v1beta1'), createEmptyInstance: create)
    ..aOM<$1238.RecommenderConfig>(1, _omitFieldNames ? '' : 'recommenderConfig', subBuilder: $1238.RecommenderConfig.create)
  ...
  @$pb.TagNumber(1)
  $1238.RecommenderConfig get recommenderConfig => $_getN(0);
  @$pb.TagNumber(1)
  set recommenderConfig($1238.RecommenderConfig v) { setField(1, v); }
  @$pb.TagNumber(1)
  $core.bool hasRecommenderConfig() => $_has(0);
  @$pb.TagNumber(1)
  void clearRecommenderConfig() => clearField(1);
  @$pb.TagNumber(1)
  $1238.RecommenderConfig ensureRecommenderConfig() => $_ensure(0);
...
class GetInsightTypeConfigRequest extends $pb.GeneratedMessage {
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(_omitMessageNames ? '' : 'GetInsightTypeConfigRequest', package: const $pb.PackageName(_omitMessageNames ? '' : 'google.cloud.recommender.v1beta1'), createEmptyInstance: create)
    ..aOS(1, _omitFieldNames ? '' : 'name')
    ..hasRequiredFields = false
  ;
...
class UpdateInsightTypeConfigRequest extends $pb.GeneratedMessage {
  factory UpdateInsightTypeConfigRequest({
    $1239.InsightTypeConfig? insightTypeConfig,
    $2209.FieldMask? updateMask,
    $core.bool? validateOnly,
  }) {
    final $result = create();
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(_omitMessageNames ? '' : 'UpdateInsightTypeConfigRequest', package: const $pb.PackageName(_omitMessageNames ? '' : 'google.cloud.recommender.v1beta1'), createEmptyInstance: create)
    ..aOM<$1239.InsightTypeConfig>(1, _omitFieldNames ? '' : 'insightTypeConfig', subBuilder: $1239.InsightTypeConfig.create)
    ..aOM<$2209.FieldMask>(2, _omitFieldNames ? '' : 'updateMask', subBuilder: $2209.FieldMask.create)
    ..aOB(3, _omitFieldNames ? '' : 'validateOnly')
    ..hasRequiredFields = false
  ;
  ...
  @$pb.TagNumber(1)
  $1239.InsightTypeConfig get insightTypeConfig => $_getN(0);
  @$pb.TagNumber(1)
  set insightTypeConfig($1239.InsightTypeConfig v) { setField(1, v); }
  @$pb.TagNumber(1)
  $core.bool hasInsightTypeConfig() => $_has(0);
  @$pb.TagNumber(1)
  void clearInsightTypeConfig() => clearField(1);
  @$pb.TagNumber(1)
  $1239.InsightTypeConfig ensureInsightTypeConfig() => $_ensure(0);
...
class ListRecommendersRequest extends $pb.GeneratedMessage {
  factory ListRecommendersRequest({
    $core.int? pageSize,
    $core.String? pageToken,
  }) {
    final $result = create();
  ...
  ListRecommendersRequest._() : super();
  factory ListRecommendersRequest.fromBuffer($core.List<$core.int> i, [$pb.ExtensionRegistry r = $pb.ExtensionRegistry.EMPTY]) => create()..mergeFromBuffer(i, r);
  factory ListRecommendersRequest.fromJson($core.String i, [$pb.ExtensionRegistry r = $pb.ExtensionRegistry.EMPTY]) => create()..mergeFromJson(i, r);

  static final $pb.BuilderInfo _i = $pb.BuilderInfo(_omitMessageNames ? '' : 'ListRecommendersRequest', package: const $pb.PackageName(_omitMessageNames ? '' : 'google.cloud.recommender.v1beta1'), createEmptyInstance: create)
  ...
  'Use [GeneratedMessageGenericExtensions.deepCopy] instead. '
  'Will be removed in next major version')
  ListRecommendersRequest clone() => ListRecommendersRequest()..mergeFromMessage(this);
  @$core.Deprecated(
  'Using this can add significant overhead to your binary. '
  'Use [GeneratedMessageGenericExtensions.rebuild] instead. '
  'Will be removed in next major version')
  ListRecommendersRequest copyWith(void Function(ListRecommendersRequest) updates) => super.copyWith((message) => updates(message as ListRecommendersRequest)) as ListRecommendersRequest;

  $pb.BuilderInfo get info_ => _i;

  @$core.pragma('dart2js:noInline')
  static ListRecommendersRequest create() => ListRecommendersRequest._();
  ListRecommendersRequest createEmptyInstance() => create();
  static $pb.PbList<ListRecommendersRequest> createRepeated() => $pb.PbList<ListRecommendersRequest>();
  @$core.pragma('dart2js:noInline')
  static ListRecommendersRequest getDefault() => _defaultInstance ??= $pb.GeneratedMessage.$_defaultFor<ListRecommendersRequest>(create);
  static ListRecommendersRequest? _defaultInstance;
...
class ListRecommendersResponse extends $pb.GeneratedMessage {
  factory ListRecommendersResponse({
    $core.Iterable<$1237.RecommenderType>? recommenders,
    $core.String? nextPageToken,
  }) {
    final $result = create();
    if (recommenders != null) {
      $result.recommenders.addAll(recommenders);
    }
    if (nextPageToken != null) {
      $result.nextPageToken = nextPageToken;
    }
  ...
  ListRecommendersResponse._() : super();
  factory ListRecommendersResponse.fromBuffer($core.List<$core.int> i, [$pb.ExtensionRegistry r = $pb.ExtensionRegistry.EMPTY]) => create()..mergeFromBuffer(i, r);
  factory ListRecommendersResponse.fromJson($core.String i, [$pb.ExtensionRegistry r = $pb.ExtensionRegistry.EMPTY]) => create()..mergeFromJson(i, r);

  static final $pb.BuilderInfo _i = $pb.BuilderInfo(_omitMessageNames ? '' : 'ListRecommendersResponse', package: const $pb.PackageName(_omitMessageNames ? '' : 'google.cloud.recommender.v1beta1'), createEmptyInstance: create)
    ..pc<$1237.RecommenderType>(1, _omitFieldNames ? '' : 'recommenders', $pb.PbFieldType.PM, subBuilder: $1237.RecommenderType.create)
    ..aOS(2, _omitFieldNames ? '' : 'nextPageToken')
    ..hasRequiredFields = false
  ;
  ...
  'Use [GeneratedMessageGenericExtensions.deepCopy] instead. '
  'Will be removed in next major version')
  ListRecommendersResponse clone() => ListRecommendersResponse()..mergeFromMessage(this);
  @$core.Deprecated(
  'Using this can add significant overhead to your binary. '
  'Use [GeneratedMessageGenericExtensions.rebuild] instead. '
  'Will be removed in next major version')
  ListRecommendersResponse copyWith(void Function(ListRecommendersResponse) updates) => super.copyWith((message) => updates(message as ListRecommendersResponse)) as ListRecommendersResponse;

  $pb.BuilderInfo get info_ => _i;

  @$core.pragma('dart2js:noInline')
  static ListRecommendersResponse create() => ListRecommendersResponse._();
  ListRecommendersResponse createEmptyInstance() => create();
  static $pb.PbList<ListRecommendersResponse> createRepeated() => $pb.PbList<ListRecommendersResponse>();
  @$core.pragma('dart2js:noInline')
  static ListRecommendersResponse getDefault() => _defaultInstance ??= $pb.GeneratedMessage.$_defaultFor<ListRecommendersResponse>(create);
  static ListRecommendersResponse? _defaultInstance;

  /// The set of recommenders available
  @$pb.TagNumber(1)
  $core.List<$1237.RecommenderType> get recommenders => $_getList(0);
...
class ListInsightTypesRequest extends $pb.GeneratedMessage {
  factory ListInsightTypesRequest({
    $core.int? pageSize,
    $core.String? pageToken,
  }) {
    final $result = create();
  ...
  ListInsightTypesRequest._() : super();
  factory ListInsightTypesRequest.fromBuffer($core.List<$core.int> i, [$pb.ExtensionRegistry r = $pb.ExtensionRegistry.EMPTY]) => create()..mergeFromBuffer(i, r);
  factory ListInsightTypesRequest.fromJson($core.String i, [$pb.ExtensionRegistry r = $pb.ExtensionRegistry.EMPTY]) => create()..mergeFromJson(i, r);

  static final $pb.BuilderInfo _i = $pb.BuilderInfo(_omitMessageNames ? '' : 'ListInsightTypesRequest', package: const $pb.PackageName(_omitMessageNames ? '' : 'google.cloud.recommender.v1beta1'), createEmptyInstance: create)
    ..a<$core.int>(1, _omitFieldNames ? '' : 'pageSize', $pb.PbFieldType.O3)
    ..aOS(2, _omitFieldNames ? '' : 'pageToken')
    ..hasRequiredFields = false
  ;
  ...
  'Use [GeneratedMessageGenericExtensions.deepCopy] instead. '
  'Will be removed in next major version')
  ListInsightTypesRequest clone() => ListInsightTypesRequest()..mergeFromMessage(this);
  @$core.Deprecated(
  'Using this can add significant overhead to your binary. '
  'Use [GeneratedMessageGenericExtensions.rebuild] instead. '
  'Will be removed in next major version')
  ListInsightTypesRequest copyWith(void Function(ListInsightTypesRequest) updates) => super.copyWith((message) => updates(message as ListInsightTypesRequest)) as ListInsightTypesRequest;

  $pb.BuilderInfo get info_ => _i;

  @$core.pragma('dart2js:noInline')
  static ListInsightTypesRequest create() => ListInsightTypesRequest._();
  ListInsightTypesRequest createEmptyInstance() => create();
  static $pb.PbList<ListInsightTypesRequest> createRepeated() => $pb.PbList<ListInsightTypesRequest>();
  @$core.pragma('dart2js:noInline')
  static ListInsightTypesRequest getDefault() => _defaultInstance ??= $pb.GeneratedMessage.$_defaultFor<ListInsightTypesRequest>(create);
  static ListInsightTypesRequest? _defaultInstance;
...
class ListInsightTypesResponse extends $pb.GeneratedMessage {
  factory ListInsightTypesResponse({
    $core.Iterable<$1236.InsightType>? insightTypes,
    $core.String? nextPageToken,
  }) {
    final $result = create();
    if (insightTypes != null) {
      $result.insightTypes.addAll(insightTypes);
    }
    if (nextPageToken != null) {
      $result.nextPageToken = nextPageToken;
    }
  ...
  ListInsightTypesResponse._() : super();
  factory ListInsightTypesResponse.fromBuffer($core.List<$core.int> i, [$pb.ExtensionRegistry r = $pb.ExtensionRegistry.EMPTY]) => create()..mergeFromBuffer(i, r);
  factory ListInsightTypesResponse.fromJson($core.String i, [$pb.ExtensionRegistry r = $pb.ExtensionRegistry.EMPTY]) => create()..mergeFromJson(i, r);

  static final $pb.BuilderInfo _i = $pb.BuilderInfo(_omitMessageNames ? '' : 'ListInsightTypesResponse', package: const $pb.PackageName(_omitMessageNames ? '' : 'google.cloud.recommender.v1beta1'), createEmptyInstance: create)
    ..pc<$1236.InsightType>(1, _omitFieldNames ? '' : 'insightTypes', $pb.PbFieldType.PM, subBuilder: $1236.InsightType.create)
    ..aOS(2, _omitFieldNames ? '' : 'nextPageToken')
    ..hasRequiredFields = false
  ;
  ...
  'Use [GeneratedMessageGenericExtensions.deepCopy] instead. '
  'Will be removed in next major version')
  ListInsightTypesResponse clone() => ListInsightTypesResponse()..mergeFromMessage(this);
  @$core.Deprecated(
  'Using this can add significant overhead to your binary. '
  'Use [GeneratedMessageGenericExtensions.rebuild] instead. '
  'Will be removed in next major version')
  ListInsightTypesResponse copyWith(void Function(ListInsightTypesResponse) updates) => super.copyWith((message) => updates(message as ListInsightTypesResponse)) as ListInsightTypesResponse;

  $pb.BuilderInfo get info_ => _i;

  @$core.pragma('dart2js:noInline')
  static ListInsightTypesResponse create() => ListInsightTypesResponse._();
  ListInsightTypesResponse createEmptyInstance() => create();
  static $pb.PbList<ListInsightTypesResponse> createRepeated() => $pb.PbList<ListInsightTypesResponse>();
  @$core.pragma('dart2js:noInline')
  static ListInsightTypesResponse getDefault() => _defaultInstance ??= $pb.GeneratedMessage.$_defaultFor<ListInsightTypesResponse>(create);
  static ListInsightTypesResponse? _defaultInstance;

  /// The set of recommenders available
  @$pb.TagNumber(1)
  $core.List<$1236.InsightType> get insightTypes => $_getList(0);
