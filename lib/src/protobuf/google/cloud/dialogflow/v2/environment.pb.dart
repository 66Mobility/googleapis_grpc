...
import 'audio_config.pbenum.dart' as $4495;
...
class Environment extends $pb.GeneratedMessage {
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(_omitMessageNames ? '' : 'Environment', package: const $pb.PackageName(_omitMessageNames ? '' : 'google.cloud.dialogflow.v2'), createEmptyInstance: create)
    ...
    ..aOM<$902.Fulfillment>(8, _omitFieldNames ? '' : 'fulfillment', subBuilder: $902.Fulfillment.create)
  ...
  @$pb.TagNumber(8)
  $902.Fulfillment get fulfillment => $_getN(6);
  @$pb.TagNumber(8)
  set fulfillment($902.Fulfillment v) { setField(8, v); }
  @$pb.TagNumber(8)
  $core.bool hasFulfillment() => $_has(6);
  @$pb.TagNumber(8)
  void clearFulfillment() => clearField(8);
  @$pb.TagNumber(8)
  $902.Fulfillment ensureFulfillment() => $_ensure(6);
}
...
class TextToSpeechSettings extends $pb.GeneratedMessage {
  factory TextToSpeechSettings({
    ...
    $4495.OutputAudioEncoding? outputAudioEncoding,
    $core.int? sampleRateHertz,
    $core.Map<$core.String, $4495.SynthesizeSpeechConfig>? synthesizeSpeechConfigs,
  }) {
    final $result = create();
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(_omitMessageNames ? '' : 'TextToSpeechSettings', package: const $pb.PackageName(_omitMessageNames ? '' : 'google.cloud.dialogflow.v2'), createEmptyInstance: create)
    ..aOB(1, _omitFieldNames ? '' : 'enableTextToSpeech')
    ..e<$4495.OutputAudioEncoding>(2, _omitFieldNames ? '' : 'outputAudioEncoding', $pb.PbFieldType.OE, defaultOrMaker: $4495.OutputAudioEncoding.OUTPUT_AUDIO_ENCODING_UNSPECIFIED, valueOf: $4495.OutputAudioEncoding.valueOf, enumValues: $4495.OutputAudioEncoding.values)
    ..a<$core.int>(3, _omitFieldNames ? '' : 'sampleRateHertz', $pb.PbFieldType.O3)
    ..m<$core.String, $4495.SynthesizeSpeechConfig>(4, _omitFieldNames ? '' : 'synthesizeSpeechConfigs', entryClassName: 'TextToSpeechSettings.SynthesizeSpeechConfigsEntry', keyFieldType: $pb.PbFieldType.OS, valueFieldType: $pb.PbFieldType.OM, valueCreator: $4495.SynthesizeSpeechConfig.create, valueDefaultOrMaker: $4495.SynthesizeSpeechConfig.getDefault, packageName: const $pb.PackageName('google.cloud.dialogflow.v2'))
    ..hasRequiredFields = false
  ;
  ...
  @$pb.TagNumber(2)
  $4495.OutputAudioEncoding get outputAudioEncoding => $_getN(1);
  @$pb.TagNumber(2)
  set outputAudioEncoding($4495.OutputAudioEncoding v) { setField(2, v); }
  @$pb.TagNumber(2)
  ...
  @$pb.TagNumber(4)
  $core.Map<$core.String, $4495.SynthesizeSpeechConfig> get synthesizeSpeechConfigs => $_getMap(3);
}
...
class ListEnvironmentsRequest extends $pb.GeneratedMessage {
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(_omitMessageNames ? '' : 'ListEnvironmentsRequest', package: const $pb.PackageName(_omitMessageNames ? '' : 'google.cloud.dialogflow.v2'), createEmptyInstance: create)
...
class ListEnvironmentsResponse extends $pb.GeneratedMessage {
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(_omitMessageNames ? '' : 'ListEnvironmentsResponse', package: const $pb.PackageName(_omitMessageNames ? '' : 'google.cloud.dialogflow.v2'), createEmptyInstance: create)
...
class GetEnvironmentRequest extends $pb.GeneratedMessage {
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(_omitMessageNames ? '' : 'GetEnvironmentRequest', package: const $pb.PackageName(_omitMessageNames ? '' : 'google.cloud.dialogflow.v2'), createEmptyInstance: create)
    ..aOS(1, _omitFieldNames ? '' : 'name')
    ..hasRequiredFields = false
  ;
...
class CreateEnvironmentRequest extends $pb.GeneratedMessage {
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(_omitMessageNames ? '' : 'CreateEnvironmentRequest', package: const $pb.PackageName(_omitMessageNames ? '' : 'google.cloud.dialogflow.v2'), createEmptyInstance: create)
    ..aOS(1, _omitFieldNames ? '' : 'parent')
...
class UpdateEnvironmentRequest extends $pb.GeneratedMessage {
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(_omitMessageNames ? '' : 'UpdateEnvironmentRequest', package: const $pb.PackageName(_omitMessageNames ? '' : 'google.cloud.dialogflow.v2'), createEmptyInstance: create)
...
class DeleteEnvironmentRequest extends $pb.GeneratedMessage {
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(_omitMessageNames ? '' : 'DeleteEnvironmentRequest', package: const $pb.PackageName(_omitMessageNames ? '' : 'google.cloud.dialogflow.v2'), createEmptyInstance: create)
    ..aOS(1, _omitFieldNames ? '' : 'name')
    ..hasRequiredFields = false
  ;
...
class GetEnvironmentHistoryRequest extends $pb.GeneratedMessage {
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(_omitMessageNames ? '' : 'GetEnvironmentHistoryRequest', package: const $pb.PackageName(_omitMessageNames ? '' : 'google.cloud.dialogflow.v2'), createEmptyInstance: create)
    ..aOS(1, _omitFieldNames ? '' : 'parent')
    ..a<$core.int>(2, _omitFieldNames ? '' : 'pageSize', $pb.PbFieldType.O3)
    ..aOS(3, _omitFieldNames ? '' : 'pageToken')
    ..hasRequiredFields = false
...
class EnvironmentHistory_Entry extends $pb.GeneratedMessage {
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(_omitMessageNames ? '' : 'EnvironmentHistory.Entry', package: const $pb.PackageName(_omitMessageNames ? '' : 'google.cloud.dialogflow.v2'), createEmptyInstance: create)
...
class EnvironmentHistory extends $pb.GeneratedMessage {
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(_omitMessageNames ? '' : 'EnvironmentHistory', package: const $pb.PackageName(_omitMessageNames ? '' : 'google.cloud.dialogflow.v2'), createEmptyInstance: create)
    ..aOS(1, _omitFieldNames ? '' : 'parent')
