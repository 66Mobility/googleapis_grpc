...
class AnswerRecord extends $pb.GeneratedMessage {
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(_omitMessageNames ? '' : 'AnswerRecord', package: const $pb.PackageName(_omitMessageNames ? '' : 'google.cloud.dialogflow.v2'), createEmptyInstance: create)
    ..oo(0, [4])
    ..aOS(1, _omitFieldNames ? '' : 'name')
    ..aOM<AnswerFeedback>(2, _omitFieldNames ? '' : 'answerFeedback', subBuilder: AnswerFeedback.create)
...
class ListAnswerRecordsRequest extends $pb.GeneratedMessage {
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(_omitMessageNames ? '' : 'ListAnswerRecordsRequest', package: const $pb.PackageName(_omitMessageNames ? '' : 'google.cloud.dialogflow.v2'), createEmptyInstance: create)
...
class ListAnswerRecordsResponse extends $pb.GeneratedMessage {
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(_omitMessageNames ? '' : 'ListAnswerRecordsResponse', package: const $pb.PackageName(_omitMessageNames ? '' : 'google.cloud.dialogflow.v2'), createEmptyInstance: create)
...
class AnswerFeedback extends $pb.GeneratedMessage {
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(_omitMessageNames ? '' : 'AnswerFeedback', package: const $pb.PackageName(_omitMessageNames ? '' : 'google.cloud.dialogflow.v2'), createEmptyInstance: create)
    ..oo(0, [2])
...
class AgentAssistantFeedback_KnowledgeSearchFeedback extends $pb.GeneratedMessage {
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(_omitMessageNames ? '' : 'AgentAssistantFeedback.KnowledgeSearchFeedback', package: const $pb.PackageName(_omitMessageNames ? '' : 'google.cloud.dialogflow.v2'), createEmptyInstance: create)
...
class AgentAssistantFeedback_KnowledgeAssistFeedback extends $pb.GeneratedMessage {
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(_omitMessageNames ? '' : 'AgentAssistantFeedback.KnowledgeAssistFeedback', package: const $pb.PackageName(_omitMessageNames ? '' : 'google.cloud.dialogflow.v2'), createEmptyInstance: create)
    ..aOB(1, _omitFieldNames ? '' : 'answerCopied')
    ..pPS(2, _omitFieldNames ? '' : 'clickedUris')
    ..hasRequiredFields = false
  ;
...
class AgentAssistantFeedback extends $pb.GeneratedMessage {
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(_omitMessageNames ? '' : 'AgentAssistantFeedback', package: const $pb.PackageName(_omitMessageNames ? '' : 'google.cloud.dialogflow.v2'), createEmptyInstance: create)
...
class AgentAssistantRecord extends $pb.GeneratedMessage {
  factory AgentAssistantRecord({
    $893.ArticleAnswer? articleSuggestionAnswer,
    $893.FaqAnswer? faqAnswer,
    $893.DialogflowAssistAnswer? dialogflowAssistAnswer,
  }) {
    final $result = create();
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(_omitMessageNames ? '' : 'AgentAssistantRecord', package: const $pb.PackageName(_omitMessageNames ? '' : 'google.cloud.dialogflow.v2'), createEmptyInstance: create)
    ..oo(0, [5, 6, 7])
    ..aOM<$893.ArticleAnswer>(5, _omitFieldNames ? '' : 'articleSuggestionAnswer', subBuilder: $893.ArticleAnswer.create)
    ..aOM<$893.FaqAnswer>(6, _omitFieldNames ? '' : 'faqAnswer', subBuilder: $893.FaqAnswer.create)
    ..aOM<$893.DialogflowAssistAnswer>(7, _omitFieldNames ? '' : 'dialogflowAssistAnswer', subBuilder: $893.DialogflowAssistAnswer.create)
    ..hasRequiredFields = false
  ;
  ...
  @$pb.TagNumber(5)
  $893.ArticleAnswer get articleSuggestionAnswer => $_getN(0);
  @$pb.TagNumber(5)
  set articleSuggestionAnswer($893.ArticleAnswer v) { setField(5, v); }
  @$pb.TagNumber(5)
  $core.bool hasArticleSuggestionAnswer() => $_has(0);
  @$pb.TagNumber(5)
  void clearArticleSuggestionAnswer() => clearField(5);
  @$pb.TagNumber(5)
  $893.ArticleAnswer ensureArticleSuggestionAnswer() => $_ensure(0);

  /// Output only. The FAQ answer.
  @$pb.TagNumber(6)
  $893.FaqAnswer get faqAnswer => $_getN(1);
  @$pb.TagNumber(6)
  set faqAnswer($893.FaqAnswer v) { setField(6, v); }
  @$pb.TagNumber(6)
  $core.bool hasFaqAnswer() => $_has(1);
  @$pb.TagNumber(6)
  void clearFaqAnswer() => clearField(6);
  @$pb.TagNumber(6)
  $893.FaqAnswer ensureFaqAnswer() => $_ensure(1);

  /// Output only. Dialogflow assist answer.
  @$pb.TagNumber(7)
  $893.DialogflowAssistAnswer get dialogflowAssistAnswer => $_getN(2);
  @$pb.TagNumber(7)
  set dialogflowAssistAnswer($893.DialogflowAssistAnswer v) { setField(7, v); }
  @$pb.TagNumber(7)
  $core.bool hasDialogflowAssistAnswer() => $_has(2);
  @$pb.TagNumber(7)
  void clearDialogflowAssistAnswer() => clearField(7);
  @$pb.TagNumber(7)
  $893.DialogflowAssistAnswer ensureDialogflowAssistAnswer() => $_ensure(2);
}
