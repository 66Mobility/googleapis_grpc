...
const ListKnowledgeBasesResponse$json = {
  ...
  '2': [
    {'1': 'knowledge_bases', '3': 1, '4': 3, '5': 11, '6': '.google.cloud.dialogflow.v2beta1.KnowledgeBase', '10': 'knowledgeBases'},
...
final $typed_data.Uint8List listKnowledgeBasesResponseDescriptor = $convert.base64Decode(
    'ChpMaXN0S25vd2xlZGdlQmFzZXNSZXNwb25zZRJXCg9rbm93bGVkZ2VfYmFzZXMYASADKAsyLi'
    '5nb29nbGUuY2xvdWQuZGlhbG9nZmxvdy52MmJldGExLktub3dsZWRnZUJhc2VSDmtub3dsZWRn'
    'ZUJhc2VzEiYKD25leHRfcGFnZV90b2tlbhgCIAEoCVINbmV4dFBhZ2VUb2tlbg==');
...
const CreateKnowledgeBaseRequest$json = {
  ...
  '2': [
    {'1': 'parent', '3': 1, '4': 1, '5': 9, '8': {}, '10': 'parent'},
    {'1': 'knowledge_base', '3': 2, '4': 1, '5': 11, '6': '.google.cloud.dialogflow.v2beta1.KnowledgeBase', '8': {}, '10': 'knowledgeBase'},
  ],
};
...
final $typed_data.Uint8List createKnowledgeBaseRequestDescriptor = $convert.base64Decode(
    ...
    'lhbG9nZmxvdy5nb29nbGVhcGlzLmNvbS9Lbm93bGVkZ2VCYXNlUgZwYXJlbnQSWgoOa25vd2xl'
    'ZGdlX2Jhc2UYAiABKAsyLi5nb29nbGUuY2xvdWQuZGlhbG9nZmxvdy52MmJldGExLktub3dsZW'
    'RnZUJhc2VCA+BBAlINa25vd2xlZGdlQmFzZQ==');
...
const UpdateKnowledgeBaseRequest$json = {
  ...
  '2': [
    {'1': 'knowledge_base', '3': 1, '4': 1, '5': 11, '6': '.google.cloud.dialogflow.v2beta1.KnowledgeBase', '8': {}, '10': 'knowledgeBase'},
...
final $typed_data.Uint8List updateKnowledgeBaseRequestDescriptor = $convert.base64Decode(
    'ChpVcGRhdGVLbm93bGVkZ2VCYXNlUmVxdWVzdBJaCg5rbm93bGVkZ2VfYmFzZRgBIAEoCzIuLm'
    'dvb2dsZS5jbG91ZC5kaWFsb2dmbG93LnYyYmV0YTEuS25vd2xlZGdlQmFzZUID4EECUg1rbm93'
    'bGVkZ2VCYXNlEkAKC3VwZGF0ZV9tYXNrGAIgASgLMhouZ29vZ2xlLnByb3RvYnVmLkZpZWxkTW'
    'Fza0ID4EEBUgp1cGRhdGVNYXNr');
