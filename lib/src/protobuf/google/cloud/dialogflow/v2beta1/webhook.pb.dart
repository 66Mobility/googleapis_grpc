...
class WebhookRequest extends $pb.GeneratedMessage {
  factory WebhookRequest({
    ...
    $core.String? session,
    $core.Iterable<$912.QueryResult>? alternativeQueryResults,
  }) {
    final $result = create();
    if (responseId != null) {
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(_omitMessageNames ? '' : 'WebhookRequest', package: const $pb.PackageName(_omitMessageNames ? '' : 'google.cloud.dialogflow.v2beta1'), createEmptyInstance: create)
    ..aOS(1, _omitFieldNames ? '' : 'responseId')
    ..aOM<$912.QueryResult>(2, _omitFieldNames ? '' : 'queryResult', subBuilder: $912.QueryResult.create)
    ...
    ..pc<$912.QueryResult>(5, _omitFieldNames ? '' : 'alternativeQueryResults', $pb.PbFieldType.PM, subBuilder: $912.QueryResult.create)
  ...
  @$pb.TagNumber(2)
  $912.QueryResult get queryResult => $_getN(1);
  @$pb.TagNumber(2)
  set queryResult($912.QueryResult v) { setField(2, v); }
  @$pb.TagNumber(2)
  $core.bool hasQueryResult() => $_has(1);
  @$pb.TagNumber(2)
  void clearQueryResult() => clearField(2);
  @$pb.TagNumber(2)
  $912.QueryResult ensureQueryResult() => $_ensure(1);
  ...
  @$pb.TagNumber(5)
  $core.List<$912.QueryResult> get alternativeQueryResults => $_getList(4);
}
...
class WebhookResponse extends $pb.GeneratedMessage {
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(_omitMessageNames ? '' : 'WebhookResponse', package: const $pb.PackageName(_omitMessageNames ? '' : 'google.cloud.dialogflow.v2beta1'), createEmptyInstance: create)
    ...
    ..aOB(8, _omitFieldNames ? '' : 'endInteraction')
    ..pc<$911.SessionEntityType>(10, _omitFieldNames ? '' : 'sessionEntityTypes', $pb.PbFieldType.PM, subBuilder: $911.SessionEntityType.create)
    ..hasRequiredFields = false
  ;
  ...
  /// sent to the integration or API caller.
  @$pb.TagNumber(2)
  $core.List<$909.Intent_Message> get fulfillmentMessages => $_getList(1);
  ...
  /// sent to the integration or API caller.
  @$pb.TagNumber(5)
  $core.List<$908.Context> get outputContexts => $_getList(4);

  /// Optional. Invokes the supplied events.
  /// When this field is set, Dialogflow ignores the `fulfillment_text`,
  /// `fulfillment_messages`, and `payload` fields.
  @$pb.TagNumber(6)
  $912.EventInput get followupEventInput => $_getN(5);
  @$pb.TagNumber(6)
  set followupEventInput($912.EventInput v) { setField(6, v); }
  @$pb.TagNumber(6)
  $core.bool hasFollowupEventInput() => $_has(5);
  @$pb.TagNumber(6)
  void clearFollowupEventInput() => clearField(6);
  @$pb.TagNumber(6)
  $912.EventInput ensureFollowupEventInput() => $_ensure(5);
  ...
  /// management methods.
  @$pb.TagNumber(10)
  $core.List<$911.SessionEntityType> get sessionEntityTypes => $_getList(8);
}
