...
class DetectIntentRequest extends $pb.GeneratedMessage {
  factory DetectIntentRequest({
    ...
    $4497.OutputAudioConfig? outputAudioConfig,
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(_omitMessageNames ? '' : 'DetectIntentRequest', package: const $pb.PackageName(_omitMessageNames ? '' : 'google.cloud.dialogflow.v2beta1'), createEmptyInstance: create)
    ...
    ..aOM<$4497.OutputAudioConfig>(4, _omitFieldNames ? '' : 'outputAudioConfig', subBuilder: $4497.OutputAudioConfig.create)
  ...
  @$pb.TagNumber(4)
  $4497.OutputAudioConfig get outputAudioConfig => $_getN(3);
  @$pb.TagNumber(4)
  set outputAudioConfig($4497.OutputAudioConfig v) { setField(4, v); }
  @$pb.TagNumber(4)
  $core.bool hasOutputAudioConfig() => $_has(3);
  @$pb.TagNumber(4)
  void clearOutputAudioConfig() => clearField(4);
  @$pb.TagNumber(4)
  $4497.OutputAudioConfig ensureOutputAudioConfig() => $_ensure(3);
...
class DetectIntentResponse extends $pb.GeneratedMessage {
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(_omitMessageNames ? '' : 'DetectIntentResponse', package: const $pb.PackageName(_omitMessageNames ? '' : 'google.cloud.dialogflow.v2beta1'), createEmptyInstance: create)
    ...
    ..aOM<$4497.OutputAudioConfig>(6, _omitFieldNames ? '' : 'outputAudioConfig', subBuilder: $4497.OutputAudioConfig.create)
    ..hasRequiredFields = false
  ;
  ...
  @$pb.TagNumber(6)
  $4497.OutputAudioConfig get outputAudioConfig => $_getN(5);
  @$pb.TagNumber(6)
  set outputAudioConfig($4497.OutputAudioConfig v) { setField(6, v); }
  @$pb.TagNumber(6)
  $core.bool hasOutputAudioConfig() => $_has(5);
  @$pb.TagNumber(6)
  void clearOutputAudioConfig() => clearField(6);
  @$pb.TagNumber(6)
  $4497.OutputAudioConfig ensureOutputAudioConfig() => $_ensure(5);
}
...
class QueryInput extends $pb.GeneratedMessage {
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(_omitMessageNames ? '' : 'QueryInput', package: const $pb.PackageName(_omitMessageNames ? '' : 'google.cloud.dialogflow.v2beta1'), createEmptyInstance: create)
    ..oo(0, [1, 2, 3, 4])
    ..aOM<$4497.InputAudioConfig>(1, _omitFieldNames ? '' : 'audioConfig', subBuilder: $4497.InputAudioConfig.create)
    ...
    ..aOM<$4497.TelephonyDtmfEvents>(4, _omitFieldNames ? '' : 'dtmf', subBuilder: $4497.TelephonyDtmfEvents.create)
    ..hasRequiredFields = false
  ;
  ...
  @$pb.TagNumber(1)
  $4497.InputAudioConfig get audioConfig => $_getN(0);
  @$pb.TagNumber(1)
  set audioConfig($4497.InputAudioConfig v) { setField(1, v); }
  @$pb.TagNumber(1)
  $core.bool hasAudioConfig() => $_has(0);
  @$pb.TagNumber(1)
  void clearAudioConfig() => clearField(1);
  @$pb.TagNumber(1)
  $4497.InputAudioConfig ensureAudioConfig() => $_ensure(0);
  ...
  @$pb.TagNumber(4)
  $4497.TelephonyDtmfEvents get dtmf => $_getN(3);
  @$pb.TagNumber(4)
  set dtmf($4497.TelephonyDtmfEvents v) { setField(4, v); }
  @$pb.TagNumber(4)
  $core.bool hasDtmf() => $_has(3);
  @$pb.TagNumber(4)
  void clearDtmf() => clearField(4);
  @$pb.TagNumber(4)
  $4497.TelephonyDtmfEvents ensureDtmf() => $_ensure(3);
}
...
class StreamingDetectIntentRequest extends $pb.GeneratedMessage {
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(_omitMessageNames ? '' : 'StreamingDetectIntentRequest', package: const $pb.PackageName(_omitMessageNames ? '' : 'google.cloud.dialogflow.v2beta1'), createEmptyInstance: create)
    ...
    ..aOM<$4497.OutputAudioConfig>(5, _omitFieldNames ? '' : 'outputAudioConfig', subBuilder: $4497.OutputAudioConfig.create)
  ...
  /// configured, no output audio is generated.
  @$pb.TagNumber(5)
  $4497.OutputAudioConfig get outputAudioConfig => $_getN(4);
  @$pb.TagNumber(5)
  set outputAudioConfig($4497.OutputAudioConfig v) { setField(5, v); }
  @$pb.TagNumber(5)
  $core.bool hasOutputAudioConfig() => $_has(4);
  @$pb.TagNumber(5)
  void clearOutputAudioConfig() => clearField(5);
  @$pb.TagNumber(5)
  $4497.OutputAudioConfig ensureOutputAudioConfig() => $_ensure(4);
...
class StreamingRecognitionResult extends $pb.GeneratedMessage {
  factory StreamingRecognitionResult({
    ...
    $4497.TelephonyDtmfEvents? dtmfDigits,
    $core.double? stability,
    $core.Iterable<$4497.SpeechWordInfo>? speechWordInfo,
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(_omitMessageNames ? '' : 'StreamingRecognitionResult', package: const $pb.PackageName(_omitMessageNames ? '' : 'google.cloud.dialogflow.v2beta1'), createEmptyInstance: create)
    ...
    ..aOM<$4497.TelephonyDtmfEvents>(5, _omitFieldNames ? '' : 'dtmfDigits', subBuilder: $4497.TelephonyDtmfEvents.create)
    ..a<$core.double>(6, _omitFieldNames ? '' : 'stability', $pb.PbFieldType.OF)
    ..pc<$4497.SpeechWordInfo>(7, _omitFieldNames ? '' : 'speechWordInfo', $pb.PbFieldType.PM, subBuilder: $4497.SpeechWordInfo.create)
  ...
  @$pb.TagNumber(5)
  $4497.TelephonyDtmfEvents get dtmfDigits => $_getN(4);
  @$pb.TagNumber(5)
  set dtmfDigits($4497.TelephonyDtmfEvents v) { setField(5, v); }
  @$pb.TagNumber(5)
  $core.bool hasDtmfDigits() => $_has(4);
  @$pb.TagNumber(5)
  void clearDtmfDigits() => clearField(5);
  @$pb.TagNumber(5)
  $4497.TelephonyDtmfEvents ensureDtmfDigits() => $_ensure(4);
  ...
  @$pb.TagNumber(7)
  $core.List<$4497.SpeechWordInfo> get speechWordInfo => $_getList(6);

  /// Time offset of the end of this Speech recognition result relative to the
  /// beginning of the audio. Only populated for `message_type` = `TRANSCRIPT`.
  @$pb.TagNumber(8)
  $1737.Duration get speechEndOffset => $_getN(7);
  @$pb.TagNumber(8)
  ...
  @$pb.TagNumber(8)
  $1737.Duration ensureSpeechEndOffset() => $_ensure(7);
