...
class ConversationProfile extends $pb.GeneratedMessage {
  factory ConversationProfile({
    ...
    $4499.SpeechToTextConfig? sttConfig,
    $core.String? languageCode,
    $1776.Timestamp? createTime,
    $1776.Timestamp? updateTime,
    $core.String? securitySettings,
    $core.String? timeZone,
    $4499.SynthesizeSpeechConfig? ttsConfig,
  }) {
    final $result = create();
    if (name != null) {
      $result.name = name;
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(_omitMessageNames ? '' : 'ConversationProfile', package: const $pb.PackageName(_omitMessageNames ? '' : 'google.cloud.dialogflow.v2beta1'), createEmptyInstance: create)
    ...
    ..aOM<$4499.SpeechToTextConfig>(9, _omitFieldNames ? '' : 'sttConfig', subBuilder: $4499.SpeechToTextConfig.create)
    ...
    ..aOM<$4499.SynthesizeSpeechConfig>(18, _omitFieldNames ? '' : 'ttsConfig', subBuilder: $4499.SynthesizeSpeechConfig.create)
  ...
  @$pb.TagNumber(9)
  $4499.SpeechToTextConfig get sttConfig => $_getN(8);
  @$pb.TagNumber(9)
  set sttConfig($4499.SpeechToTextConfig v) { setField(9, v); }
  @$pb.TagNumber(9)
  $core.bool hasSttConfig() => $_has(8);
  @$pb.TagNumber(9)
  void clearSttConfig() => clearField(9);
  @$pb.TagNumber(9)
  $4499.SpeechToTextConfig ensureSttConfig() => $_ensure(8);
  ...
  @$pb.TagNumber(18)
  $4499.SynthesizeSpeechConfig get ttsConfig => $_getN(14);
  @$pb.TagNumber(18)
  set ttsConfig($4499.SynthesizeSpeechConfig v) { setField(18, v); }
  @$pb.TagNumber(18)
  $core.bool hasTtsConfig() => $_has(14);
  @$pb.TagNumber(18)
  void clearTtsConfig() => clearField(18);
  @$pb.TagNumber(18)
  $4499.SynthesizeSpeechConfig ensureTtsConfig() => $_ensure(14);
}
