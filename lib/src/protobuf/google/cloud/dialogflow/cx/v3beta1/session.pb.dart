...
class DetectIntentRequest extends $pb.GeneratedMessage {
  factory DetectIntentRequest({
    ...
    $4492.OutputAudioConfig? outputAudioConfig,
  }) {
    final $result = create();
    if (session != null) {
      $result.session = session;
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(_omitMessageNames ? '' : 'DetectIntentRequest', package: const $pb.PackageName(_omitMessageNames ? '' : 'google.cloud.dialogflow.cx.v3beta1'), createEmptyInstance: create)
    ...
    ..aOM<$4492.OutputAudioConfig>(4, _omitFieldNames ? '' : 'outputAudioConfig', subBuilder: $4492.OutputAudioConfig.create)
    ..hasRequiredFields = false
  ;
  ...
  @$pb.TagNumber(4)
  $4492.OutputAudioConfig get outputAudioConfig => $_getN(3);
  @$pb.TagNumber(4)
  set outputAudioConfig($4492.OutputAudioConfig v) { setField(4, v); }
  @$pb.TagNumber(4)
  $core.bool hasOutputAudioConfig() => $_has(3);
  @$pb.TagNumber(4)
  void clearOutputAudioConfig() => clearField(4);
  @$pb.TagNumber(4)
  $4492.OutputAudioConfig ensureOutputAudioConfig() => $_ensure(3);
}
...
class DetectIntentResponse extends $pb.GeneratedMessage {
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(_omitMessageNames ? '' : 'DetectIntentResponse', package: const $pb.PackageName(_omitMessageNames ? '' : 'google.cloud.dialogflow.cx.v3beta1'), createEmptyInstance: create)
    ...
    ..aOM<$4492.OutputAudioConfig>(5, _omitFieldNames ? '' : 'outputAudioConfig', subBuilder: $4492.OutputAudioConfig.create)
  ...
  $4492.OutputAudioConfig get outputAudioConfig => $_getN(3);
  @$pb.TagNumber(5)
  set outputAudioConfig($4492.OutputAudioConfig v) { setField(5, v); }
  @$pb.TagNumber(5)
  $core.bool hasOutputAudioConfig() => $_has(3);
  @$pb.TagNumber(5)
...
class StreamingRecognitionResult extends $pb.GeneratedMessage {
  factory StreamingRecognitionResult({
    ...
    $core.Iterable<$4492.SpeechWordInfo>? speechWordInfo,
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(_omitMessageNames ? '' : 'StreamingRecognitionResult', package: const $pb.PackageName(_omitMessageNames ? '' : 'google.cloud.dialogflow.cx.v3beta1'), createEmptyInstance: create)
    ...
    ..pc<$4492.SpeechWordInfo>(7, _omitFieldNames ? '' : 'speechWordInfo', $pb.PbFieldType.PM, subBuilder: $4492.SpeechWordInfo.create)
  ...
  @$pb.TagNumber(7)
  $core.List<$4492.SpeechWordInfo> get speechWordInfo => $_getList(5);
...
class QueryInput extends $pb.GeneratedMessage {
  factory QueryInput({
    ...
    EventInput? event,
    DtmfInput? dtmf,
    $4484.ToolCallResult? toolCallResult,
  }) {
    final $result = create();
    if (text != null) {
      $result.text = text;
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(_omitMessageNames ? '' : 'QueryInput', package: const $pb.PackageName(_omitMessageNames ? '' : 'google.cloud.dialogflow.cx.v3beta1'), createEmptyInstance: create)
    ...
    ..aOM<$4484.ToolCallResult>(11, _omitFieldNames ? '' : 'toolCallResult', subBuilder: $4484.ToolCallResult.create)
    ..hasRequiredFields = false
  ;
  ...
  @$pb.TagNumber(11)
  $4484.ToolCallResult get toolCallResult => $_getN(6);
  @$pb.TagNumber(11)
  set toolCallResult($4484.ToolCallResult v) { setField(11, v); }
  @$pb.TagNumber(11)
  $core.bool hasToolCallResult() => $_has(6);
  @$pb.TagNumber(11)
  void clearToolCallResult() => clearField(11);
  @$pb.TagNumber(11)
  $4484.ToolCallResult ensureToolCallResult() => $_ensure(6);
}
...
class QueryResult extends $pb.GeneratedMessage {
  factory QueryResult({
    ...
    $core.String? languageCode,
    $1734.Struct? parameters,
    $core.Iterable<$4485.ResponseMessage>? responseMessages,
  ...
  @$core.Deprecated('This field is deprecated.')
    ...
    $4488.DataStoreConnectionSignals? dataStoreConnectionSignals,
  }) {
    final $result = create();
    if (text != null) {
      $result.text = text;
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(_omitMessageNames ? '' : 'QueryResult', package: const $pb.PackageName(_omitMessageNames ? '' : 'google.cloud.dialogflow.cx.v3beta1'), createEmptyInstance: create)
    ...
    ..pc<$4485.ResponseMessage>(4, _omitFieldNames ? '' : 'responseMessages', $pb.PbFieldType.PM, subBuilder: $4485.ResponseMessage.create)
    ...
    ..aOM<$4486.AdvancedSettings>(21, _omitFieldNames ? '' : 'advancedSettings', subBuilder: $4486.AdvancedSettings.create)
    ...
    ..aOM<$4488.DataStoreConnectionSignals>(35, _omitFieldNames ? '' : 'dataStoreConnectionSignals', subBuilder: $4488.DataStoreConnectionSignals.create)
    ..hasRequiredFields = false
  ;
  ...
  @$pb.TagNumber(4)
  $core.List<$4485.ResponseMessage> get responseMessages => $_getList(3);
  ...
  @$pb.TagNumber(21)
  $4486.AdvancedSettings get advancedSettings => $_getN(15);
  @$pb.TagNumber(21)
  set advancedSettings($4486.AdvancedSettings v) { setField(21, v); }
  @$pb.TagNumber(21)
  $core.bool hasAdvancedSettings() => $_has(15);
  @$pb.TagNumber(21)
  void clearAdvancedSettings() => clearField(21);
  @$pb.TagNumber(21)
  $4486.AdvancedSettings ensureAdvancedSettings() => $_ensure(15);
  ...
  @$pb.TagNumber(35)
  $4488.DataStoreConnectionSignals get dataStoreConnectionSignals => $_getN(24);
  @$pb.TagNumber(35)
  set dataStoreConnectionSignals($4488.DataStoreConnectionSignals v) { setField(35, v); }
  @$pb.TagNumber(35)
  $core.bool hasDataStoreConnectionSignals() => $_has(24);
  @$pb.TagNumber(35)
  void clearDataStoreConnectionSignals() => clearField(35);
  @$pb.TagNumber(35)
  $4488.DataStoreConnectionSignals ensureDataStoreConnectionSignals() => $_ensure(24);
}
...
class AudioInput extends $pb.GeneratedMessage {
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(_omitMessageNames ? '' : 'AudioInput', package: const $pb.PackageName(_omitMessageNames ? '' : 'google.cloud.dialogflow.cx.v3beta1'), createEmptyInstance: create)
    ..aOM<$4492.InputAudioConfig>(1, _omitFieldNames ? '' : 'config', subBuilder: $4492.InputAudioConfig.create)
  ...
  @$pb.TagNumber(1)
  $4492.InputAudioConfig get config => $_getN(0);
  @$pb.TagNumber(1)
  set config($4492.InputAudioConfig v) { setField(1, v); }
  @$pb.TagNumber(1)
  $core.bool hasConfig() => $_has(0);
  @$pb.TagNumber(1)
  void clearConfig() => clearField(1);
  @$pb.TagNumber(1)
  $4492.InputAudioConfig ensureConfig() => $_ensure(0);
...
class FulfillIntentRequest extends $pb.GeneratedMessage {
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(_omitMessageNames ? '' : 'FulfillIntentRequest', package: const $pb.PackageName(_omitMessageNames ? '' : 'google.cloud.dialogflow.cx.v3beta1'), createEmptyInstance: create)
    ...
    ..aOM<$4492.OutputAudioConfig>(3, _omitFieldNames ? '' : 'outputAudioConfig', subBuilder: $4492.OutputAudioConfig.create)
    ..hasRequiredFields = false
  ;
  ...
  @$pb.TagNumber(3)
  $4492.OutputAudioConfig get outputAudioConfig => $_getN(2);
  @$pb.TagNumber(3)
  set outputAudioConfig($4492.OutputAudioConfig v) { setField(3, v); }
  @$pb.TagNumber(3)
  $core.bool hasOutputAudioConfig() => $_has(2);
  @$pb.TagNumber(3)
  void clearOutputAudioConfig() => clearField(3);
  @$pb.TagNumber(3)
  $4492.OutputAudioConfig ensureOutputAudioConfig() => $_ensure(2);
}
