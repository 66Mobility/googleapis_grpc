...
import 'safety_settings.pb.dart' as $4491;
...
class GenerativeSettings_FallbackSettings_PromptTemplate extends $pb.GeneratedMessage {
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(_omitMessageNames ? '' : 'GenerativeSettings.FallbackSettings.PromptTemplate', package: const $pb.PackageName(_omitMessageNames ? '' : 'google.cloud.dialogflow.cx.v3beta1'), createEmptyInstance: create)
...
class GenerativeSettings_FallbackSettings extends $pb.GeneratedMessage {
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(_omitMessageNames ? '' : 'GenerativeSettings.FallbackSettings', package: const $pb.PackageName(_omitMessageNames ? '' : 'google.cloud.dialogflow.cx.v3beta1'), createEmptyInstance: create)
...
class GenerativeSettings_KnowledgeConnectorSettings extends $pb.GeneratedMessage {
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(_omitMessageNames ? '' : 'GenerativeSettings.KnowledgeConnectorSettings', package: const $pb.PackageName(_omitMessageNames ? '' : 'google.cloud.dialogflow.cx.v3beta1'), createEmptyInstance: create)
...
class GenerativeSettings extends $pb.GeneratedMessage {
  factory GenerativeSettings({
    ...
    $4491.SafetySettings? generativeSafetySettings,
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(_omitMessageNames ? '' : 'GenerativeSettings', package: const $pb.PackageName(_omitMessageNames ? '' : 'google.cloud.dialogflow.cx.v3beta1'), createEmptyInstance: create)
    ...
    ..aOM<$4491.SafetySettings>(3, _omitFieldNames ? '' : 'generativeSafetySettings', subBuilder: $4491.SafetySettings.create)
    ...
    ..aOM<LlmModelSettings>(8, _omitFieldNames ? '' : 'llmModelSettings', subBuilder: LlmModelSettings.create)
    ..hasRequiredFields = false
  ;
  ...
  @$pb.TagNumber(3)
  $4491.SafetySettings get generativeSafetySettings => $_getN(1);
  @$pb.TagNumber(3)
  set generativeSafetySettings($4491.SafetySettings v) { setField(3, v); }
  @$pb.TagNumber(3)
  $core.bool hasGenerativeSafetySettings() => $_has(1);
  @$pb.TagNumber(3)
  void clearGenerativeSafetySettings() => clearField(3);
  @$pb.TagNumber(3)
  $4491.SafetySettings ensureGenerativeSafetySettings() => $_ensure(1);
  ...
  /// LLM model settings.
  @$pb.TagNumber(8)
  LlmModelSettings get llmModelSettings => $_getN(5);
  @$pb.TagNumber(8)
  set llmModelSettings(LlmModelSettings v) { setField(8, v); }
  @$pb.TagNumber(8)
  $core.bool hasLlmModelSettings() => $_has(5);
  @$pb.TagNumber(8)
  void clearLlmModelSettings() => clearField(8);
  @$pb.TagNumber(8)
  LlmModelSettings ensureLlmModelSettings() => $_ensure(5);
}

/// Settings for LLM models.
class LlmModelSettings extends $pb.GeneratedMessage {
  factory LlmModelSettings({
    $core.String? model,
    $core.String? promptText,
  }) {
    final $result = create();
  ...
  LlmModelSettings._() : super();
  factory LlmModelSettings.fromBuffer($core.List<$core.int> i, [$pb.ExtensionRegistry r = $pb.ExtensionRegistry.EMPTY]) => create()..mergeFromBuffer(i, r);
  factory LlmModelSettings.fromJson($core.String i, [$pb.ExtensionRegistry r = $pb.ExtensionRegistry.EMPTY]) => create()..mergeFromJson(i, r);

  static final $pb.BuilderInfo _i = $pb.BuilderInfo(_omitMessageNames ? '' : 'LlmModelSettings', package: const $pb.PackageName(_omitMessageNames ? '' : 'google.cloud.dialogflow.cx.v3beta1'), createEmptyInstance: create)
  ...
  'Use [GeneratedMessageGenericExtensions.deepCopy] instead. '
  'Will be removed in next major version')
  LlmModelSettings clone() => LlmModelSettings()..mergeFromMessage(this);
  @$core.Deprecated(
  'Using this can add significant overhead to your binary. '
  'Use [GeneratedMessageGenericExtensions.rebuild] instead. '
  'Will be removed in next major version')
  LlmModelSettings copyWith(void Function(LlmModelSettings) updates) => super.copyWith((message) => updates(message as LlmModelSettings)) as LlmModelSettings;

  $pb.BuilderInfo get info_ => _i;

  @$core.pragma('dart2js:noInline')
  static LlmModelSettings create() => LlmModelSettings._();
  LlmModelSettings createEmptyInstance() => create();
  static $pb.PbList<LlmModelSettings> createRepeated() => $pb.PbList<LlmModelSettings>();
  @$core.pragma('dart2js:noInline')
  static LlmModelSettings getDefault() => _defaultInstance ??= $pb.GeneratedMessage.$_defaultFor<LlmModelSettings>(create);
  static LlmModelSettings? _defaultInstance;
