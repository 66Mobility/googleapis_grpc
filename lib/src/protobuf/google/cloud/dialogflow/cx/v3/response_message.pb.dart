...
class ResponseMessage_Text extends $pb.GeneratedMessage {
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(_omitMessageNames ? '' : 'ResponseMessage.Text', package: const $pb.PackageName(_omitMessageNames ? '' : 'google.cloud.dialogflow.cx.v3'), createEmptyInstance: create)
...
class ResponseMessage_OutputAudioText extends $pb.GeneratedMessage {
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(_omitMessageNames ? '' : 'ResponseMessage.OutputAudioText', package: const $pb.PackageName(_omitMessageNames ? '' : 'google.cloud.dialogflow.cx.v3'), createEmptyInstance: create)
    ..oo(0, [1, 2])
...
class ResponseMessage_EndInteraction extends $pb.GeneratedMessage {
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(_omitMessageNames ? '' : 'ResponseMessage.EndInteraction', package: const $pb.PackageName(_omitMessageNames ? '' : 'google.cloud.dialogflow.cx.v3'), createEmptyInstance: create)
    ..hasRequiredFields = false
  ;
...
class ResponseMessage_PlayAudio extends $pb.GeneratedMessage {
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(_omitMessageNames ? '' : 'ResponseMessage.PlayAudio', package: const $pb.PackageName(_omitMessageNames ? '' : 'google.cloud.dialogflow.cx.v3'), createEmptyInstance: create)
...
class ResponseMessage_MixedAudio_Segment extends $pb.GeneratedMessage {
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(_omitMessageNames ? '' : 'ResponseMessage.MixedAudio.Segment', package: const $pb.PackageName(_omitMessageNames ? '' : 'google.cloud.dialogflow.cx.v3'), createEmptyInstance: create)
    ..oo(0, [1, 2])
...
class ResponseMessage_MixedAudio extends $pb.GeneratedMessage {
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(_omitMessageNames ? '' : 'ResponseMessage.MixedAudio', package: const $pb.PackageName(_omitMessageNames ? '' : 'google.cloud.dialogflow.cx.v3'), createEmptyInstance: create)
...
class ResponseMessage_TelephonyTransferCall extends $pb.GeneratedMessage {
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(_omitMessageNames ? '' : 'ResponseMessage.TelephonyTransferCall', package: const $pb.PackageName(_omitMessageNames ? '' : 'google.cloud.dialogflow.cx.v3'), createEmptyInstance: create)
    ..oo(0, [1])
...
class ResponseMessage_KnowledgeInfoCard extends $pb.GeneratedMessage {
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(_omitMessageNames ? '' : 'ResponseMessage.KnowledgeInfoCard', package: const $pb.PackageName(_omitMessageNames ? '' : 'google.cloud.dialogflow.cx.v3'), createEmptyInstance: create)
    ..hasRequiredFields = false
  ;
...
class ResponseMessage extends $pb.GeneratedMessage {
  ...
  /// Response type.
  @$pb.TagNumber(4)
  ResponseMessage_ResponseType get responseType => $_getN(2);
  @$pb.TagNumber(4)
  set responseType(ResponseMessage_ResponseType v) { setField(4, v); }
  @$pb.TagNumber(4)
  ...
  /// synthesis, as described in the comment on the ResponseMessage message.
  @$pb.TagNumber(8)
  ResponseMessage_OutputAudioText get outputAudioText => $_getN(3);
  @$pb.TagNumber(8)
  set outputAudioText(ResponseMessage_OutputAudioText v) { setField(8, v); }
  @$pb.TagNumber(8)
  $core.bool hasOutputAudioText() => $_has(3);
  @$pb.TagNumber(8)
  void clearOutputAudioText() => clearField(8);
  @$pb.TagNumber(8)
  ResponseMessage_OutputAudioText ensureOutputAudioText() => $_ensure(3);

  /// Indicates that the conversation succeeded.
  @$pb.TagNumber(9)
  ResponseMessage_ConversationSuccess get conversationSuccess => $_getN(4);
  @$pb.TagNumber(9)
  set conversationSuccess(ResponseMessage_ConversationSuccess v) { setField(9, v); }
  @$pb.TagNumber(9)
  $core.bool hasConversationSuccess() => $_has(4);
  @$pb.TagNumber(9)
  void clearConversationSuccess() => clearField(9);
  @$pb.TagNumber(9)
  ResponseMessage_ConversationSuccess ensureConversationSuccess() => $_ensure(4);

  /// Hands off conversation to a human agent.
  @$pb.TagNumber(10)
  ResponseMessage_LiveAgentHandoff get liveAgentHandoff => $_getN(5);
  @$pb.TagNumber(10)
  set liveAgentHandoff(ResponseMessage_LiveAgentHandoff v) { setField(10, v); }
  @$pb.TagNumber(10)
  $core.bool hasLiveAgentHandoff() => $_has(5);
  @$pb.TagNumber(10)
  void clearLiveAgentHandoff() => clearField(10);
  @$pb.TagNumber(10)
  ResponseMessage_LiveAgentHandoff ensureLiveAgentHandoff() => $_ensure(5);
  ...
  @$pb.TagNumber(11)
  ResponseMessage_EndInteraction get endInteraction => $_getN(6);
  @$pb.TagNumber(11)
  ...
  @$pb.TagNumber(11)
  ResponseMessage_EndInteraction ensureEndInteraction() => $_ensure(6);
  ...
  /// way.
  @$pb.TagNumber(12)
  ResponseMessage_PlayAudio get playAudio => $_getN(7);
  @$pb.TagNumber(12)
  set playAudio(ResponseMessage_PlayAudio v) { setField(12, v); }
  @$pb.TagNumber(12)
  $core.bool hasPlayAudio() => $_has(7);
  @$pb.TagNumber(12)
  void clearPlayAudio() => clearField(12);
  @$pb.TagNumber(12)
  ResponseMessage_PlayAudio ensurePlayAudio() => $_ensure(7);
  ...
  /// defined by the user.
  @$pb.TagNumber(13)
  ResponseMessage_MixedAudio get mixedAudio => $_getN(8);
  @$pb.TagNumber(13)
  set mixedAudio(ResponseMessage_MixedAudio v) { setField(13, v); }
  @$pb.TagNumber(13)
  $core.bool hasMixedAudio() => $_has(8);
  @$pb.TagNumber(13)
  void clearMixedAudio() => clearField(13);
  @$pb.TagNumber(13)
  ResponseMessage_MixedAudio ensureMixedAudio() => $_ensure(8);

  /// A signal that the client should transfer the phone call connected to
  /// this agent to a third-party endpoint.
  @$pb.TagNumber(18)
  ResponseMessage_TelephonyTransferCall get telephonyTransferCall => $_getN(9);
  @$pb.TagNumber(18)
  set telephonyTransferCall(ResponseMessage_TelephonyTransferCall v) { setField(18, v); }
  @$pb.TagNumber(18)
  $core.bool hasTelephonyTransferCall() => $_has(9);
  @$pb.TagNumber(18)
  void clearTelephonyTransferCall() => clearField(18);
  @$pb.TagNumber(18)
  ResponseMessage_TelephonyTransferCall ensureTelephonyTransferCall() => $_ensure(9);
  ...
  @$pb.TagNumber(20)
  ResponseMessage_KnowledgeInfoCard get knowledgeInfoCard => $_getN(11);
  @$pb.TagNumber(20)
  set knowledgeInfoCard(ResponseMessage_KnowledgeInfoCard v) { setField(20, v); }
  @$pb.TagNumber(20)
  $core.bool hasKnowledgeInfoCard() => $_has(11);
  @$pb.TagNumber(20)
  void clearKnowledgeInfoCard() => clearField(20);
  @$pb.TagNumber(20)
  ResponseMessage_KnowledgeInfoCard ensureKnowledgeInfoCard() => $_ensure(11);
}
