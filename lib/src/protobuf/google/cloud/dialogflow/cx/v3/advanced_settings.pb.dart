...
class AdvancedSettings extends $pb.GeneratedMessage {
  factory AdvancedSettings({
    $4473.GcsDestination? audioExportGcsDestination,
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(_omitMessageNames ? '' : 'AdvancedSettings', package: const $pb.PackageName(_omitMessageNames ? '' : 'google.cloud.dialogflow.cx.v3'), createEmptyInstance: create)
    ..aOM<$4473.GcsDestination>(2, _omitFieldNames ? '' : 'audioExportGcsDestination', subBuilder: $4473.GcsDestination.create)
  ...
  /// - Flow level
  @$pb.TagNumber(2)
  $4473.GcsDestination get audioExportGcsDestination => $_getN(0);
  @$pb.TagNumber(2)
  set audioExportGcsDestination($4473.GcsDestination v) { setField(2, v); }
  @$pb.TagNumber(2)
  $core.bool hasAudioExportGcsDestination() => $_has(0);
  @$pb.TagNumber(2)
  void clearAudioExportGcsDestination() => clearField(2);
  @$pb.TagNumber(2)
  $4473.GcsDestination ensureAudioExportGcsDestination() => $_ensure(0);
