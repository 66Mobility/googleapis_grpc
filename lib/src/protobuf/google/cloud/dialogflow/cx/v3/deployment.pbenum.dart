...
class Deployment_State extends $pb.ProtobufEnum {
  ...
  static const Deployment_State RUNNING = Deployment_State._(1, _omitEnumNames ? '' : 'RUNNING');
  static const Deployment_State SUCCEEDED = Deployment_State._(2, _omitEnumNames ? '' : 'SUCCEEDED');
  static const Deployment_State FAILED = Deployment_State._(3, _omitEnumNames ? '' : 'FAILED');
