...
class AvroSchema extends $pb.GeneratedMessage {
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(_omitMessageNames ? '' : 'AvroSchema', package: const $pb.PackageName(_omitMessageNames ? '' : 'google.cloud.bigquery.storage.v1'), createEmptyInstance: create)
...
class AvroRows extends $pb.GeneratedMessage {
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(_omitMessageNames ? '' : 'AvroRows', package: const $pb.PackageName(_omitMessageNames ? '' : 'google.cloud.bigquery.storage.v1'), createEmptyInstance: create)
...
class AvroSerializationOptions extends $pb.GeneratedMessage {
  factory AvroSerializationOptions({
    $core.bool? enableDisplayNameAttribute,
  }) {
    final $result = create();
    if (enableDisplayNameAttribute != null) {
      $result.enableDisplayNameAttribute = enableDisplayNameAttribute;
    }
    return $result;
  }
  AvroSerializationOptions._() : super();
  factory AvroSerializationOptions.fromBuffer($core.List<$core.int> i, [$pb.ExtensionRegistry r = $pb.ExtensionRegistry.EMPTY]) => create()..mergeFromBuffer(i, r);
  factory AvroSerializationOptions.fromJson($core.String i, [$pb.ExtensionRegistry r = $pb.ExtensionRegistry.EMPTY]) => create()..mergeFromJson(i, r);

  static final $pb.BuilderInfo _i = $pb.BuilderInfo(_omitMessageNames ? '' : 'AvroSerializationOptions', package: const $pb.PackageName(_omitMessageNames ? '' : 'google.cloud.bigquery.storage.v1'), createEmptyInstance: create)
    ..aOB(1, _omitFieldNames ? '' : 'enableDisplayNameAttribute')
    ..hasRequiredFields = false
  ;
  ...
  'Use [GeneratedMessageGenericExtensions.deepCopy] instead. '
  'Will be removed in next major version')
  AvroSerializationOptions clone() => AvroSerializationOptions()..mergeFromMessage(this);
  @$core.Deprecated(
  'Using this can add significant overhead to your binary. '
  'Use [GeneratedMessageGenericExtensions.rebuild] instead. '
  'Will be removed in next major version')
  AvroSerializationOptions copyWith(void Function(AvroSerializationOptions) updates) => super.copyWith((message) => updates(message as AvroSerializationOptions)) as AvroSerializationOptions;

  $pb.BuilderInfo get info_ => _i;

  @$core.pragma('dart2js:noInline')
  static AvroSerializationOptions create() => AvroSerializationOptions._();
  AvroSerializationOptions createEmptyInstance() => create();
  static $pb.PbList<AvroSerializationOptions> createRepeated() => $pb.PbList<AvroSerializationOptions>();
  @$core.pragma('dart2js:noInline')
  static AvroSerializationOptions getDefault() => _defaultInstance ??= $pb.GeneratedMessage.$_defaultFor<AvroSerializationOptions>(create);
  static AvroSerializationOptions? _defaultInstance;
  ...
  @$pb.TagNumber(1)
  $core.bool get enableDisplayNameAttribute => $_getBF(0);
  @$pb.TagNumber(1)
  set enableDisplayNameAttribute($core.bool v) { $_setBool(0, v); }
  @$pb.TagNumber(1)
  $core.bool hasEnableDisplayNameAttribute() => $_has(0);
  @$pb.TagNumber(1)
  void clearEnableDisplayNameAttribute() => clearField(1);
}
