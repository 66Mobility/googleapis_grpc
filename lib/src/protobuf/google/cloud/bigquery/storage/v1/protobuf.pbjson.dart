...
const ProtoSchema$json = {
  '1': 'ProtoSchema',
  '2': [
    {'1': 'proto_descriptor', '3': 1, '4': 1, '5': 11, '6': '.google.protobuf.DescriptorProto', '10': 'protoDescriptor'},
  ],
};
...
final $typed_data.Uint8List protoSchemaDescriptor = $convert.base64Decode(
    'CgtQcm90b1NjaGVtYRJLChBwcm90b19kZXNjcmlwdG9yGAEgASgLMiAuZ29vZ2xlLnByb3RvYn'
    'VmLkRlc2NyaXB0b3JQcm90b1IPcHJvdG9EZXNjcmlwdG9y');

@$core.Deprecated('Use protoRowsDescriptor instead')
const ProtoRows$json = {
  '1': 'ProtoRows',
  '2': [
    {'1': 'serialized_rows', '3': 1, '4': 3, '5': 12, '10': 'serializedRows'},
  ],
};
