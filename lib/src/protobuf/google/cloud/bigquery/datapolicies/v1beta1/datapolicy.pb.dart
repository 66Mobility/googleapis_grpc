...
class CreateDataPolicyRequest extends $pb.GeneratedMessage {
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(_omitMessageNames ? '' : 'CreateDataPolicyRequest', package: const $pb.PackageName(_omitMessageNames ? '' : 'google.cloud.bigquery.datapolicies.v1beta1'), createEmptyInstance: create)
...
class UpdateDataPolicyRequest extends $pb.GeneratedMessage {
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(_omitMessageNames ? '' : 'UpdateDataPolicyRequest', package: const $pb.PackageName(_omitMessageNames ? '' : 'google.cloud.bigquery.datapolicies.v1beta1'), createEmptyInstance: create)
...
class DeleteDataPolicyRequest extends $pb.GeneratedMessage {
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(_omitMessageNames ? '' : 'DeleteDataPolicyRequest', package: const $pb.PackageName(_omitMessageNames ? '' : 'google.cloud.bigquery.datapolicies.v1beta1'), createEmptyInstance: create)
...
class GetDataPolicyRequest extends $pb.GeneratedMessage {
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(_omitMessageNames ? '' : 'GetDataPolicyRequest', package: const $pb.PackageName(_omitMessageNames ? '' : 'google.cloud.bigquery.datapolicies.v1beta1'), createEmptyInstance: create)
    ..aOS(1, _omitFieldNames ? '' : 'name')
    ..hasRequiredFields = false
  ;
...
class ListDataPoliciesRequest extends $pb.GeneratedMessage {
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(_omitMessageNames ? '' : 'ListDataPoliciesRequest', package: const $pb.PackageName(_omitMessageNames ? '' : 'google.cloud.bigquery.datapolicies.v1beta1'), createEmptyInstance: create)
    ..aOS(1, _omitFieldNames ? '' : 'parent')
...
class ListDataPoliciesResponse extends $pb.GeneratedMessage {
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(_omitMessageNames ? '' : 'ListDataPoliciesResponse', package: const $pb.PackageName(_omitMessageNames ? '' : 'google.cloud.bigquery.datapolicies.v1beta1'), createEmptyInstance: create)
...
class DataPolicy extends $pb.GeneratedMessage {
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(_omitMessageNames ? '' : 'DataPolicy', package: const $pb.PackageName(_omitMessageNames ? '' : 'google.cloud.bigquery.datapolicies.v1beta1'), createEmptyInstance: create)
    ..oo(0, [4])
    ..oo(1, [5])
    ..aOS(1, _omitFieldNames ? '' : 'name')
...
class DataMaskingPolicy extends $pb.GeneratedMessage {
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(_omitMessageNames ? '' : 'DataMaskingPolicy', package: const $pb.PackageName(_omitMessageNames ? '' : 'google.cloud.bigquery.datapolicies.v1beta1'), createEmptyInstance: create)
    ..oo(0, [1])
