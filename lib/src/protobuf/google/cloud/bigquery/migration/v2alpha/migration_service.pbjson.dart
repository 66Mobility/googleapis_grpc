...
const CreateMigrationWorkflowRequest$json = {
  ...
  '2': [
    ...
    {'1': 'migration_workflow', '3': 2, '4': 1, '5': 11, '6': '.google.cloud.bigquery.migration.v2alpha.MigrationWorkflow', '8': {}, '10': 'migrationWorkflow'},
  ],
};
...
final $typed_data.Uint8List createMigrationWorkflowRequestDescriptor = $convert.base64Decode(
    ...
    'MKIWxvY2F0aW9ucy5nb29nbGVhcGlzLmNvbS9Mb2NhdGlvblIGcGFyZW50Em4KEm1pZ3JhdGlv'
    'bl93b3JrZmxvdxgCIAEoCzI6Lmdvb2dsZS5jbG91ZC5iaWdxdWVyeS5taWdyYXRpb24udjJhbH'
    'BoYS5NaWdyYXRpb25Xb3JrZmxvd0ID4EECUhFtaWdyYXRpb25Xb3JrZmxvdw==');
...
const ListMigrationWorkflowsResponse$json = {
  ...
  '2': [
    {'1': 'migration_workflows', '3': 1, '4': 3, '5': 11, '6': '.google.cloud.bigquery.migration.v2alpha.MigrationWorkflow', '10': 'migrationWorkflows'},
...
final $typed_data.Uint8List listMigrationWorkflowsResponseDescriptor = $convert.base64Decode(
    'Ch5MaXN0TWlncmF0aW9uV29ya2Zsb3dzUmVzcG9uc2USawoTbWlncmF0aW9uX3dvcmtmbG93cx'
    'gBIAMoCzI6Lmdvb2dsZS5jbG91ZC5iaWdxdWVyeS5taWdyYXRpb24udjJhbHBoYS5NaWdyYXRp'
    'b25Xb3JrZmxvd1ISbWlncmF0aW9uV29ya2Zsb3dzEiYKD25leHRfcGFnZV90b2tlbhgCIAEoCV'
...
const ListMigrationSubtasksResponse$json = {
  ...
  '2': [
    {'1': 'migration_subtasks', '3': 1, '4': 3, '5': 11, '6': '.google.cloud.bigquery.migration.v2alpha.MigrationSubtask', '10': 'migrationSubtasks'},
    {'1': 'next_page_token', '3': 2, '4': 1, '5': 9, '10': 'nextPageToken'},
  ],
};
...
final $typed_data.Uint8List listMigrationSubtasksResponseDescriptor = $convert.base64Decode(
    'Ch1MaXN0TWlncmF0aW9uU3VidGFza3NSZXNwb25zZRJoChJtaWdyYXRpb25fc3VidGFza3MYAS'
    'ADKAsyOS5nb29nbGUuY2xvdWQuYmlncXVlcnkubWlncmF0aW9uLnYyYWxwaGEuTWlncmF0aW9u'
    'U3VidGFza1IRbWlncmF0aW9uU3VidGFza3MSJgoPbmV4dF9wYWdlX3Rva2VuGAIgASgJUg1uZX'
    'h0UGFnZVRva2Vu');
