...
const TimeSeries$json = {
  ...
  '2': [
    ...
    {'1': 'points', '3': 4, '4': 3, '5': 11, '6': '.google.cloud.bigquery.migration.v2.Point', '8': {}, '10': 'points'},
  ],
};
...
final $typed_data.Uint8List timeSeriesDescriptor = $convert.base64Decode(
    ...
    '9yLk1ldHJpY0tpbmRCA+BBAVIKbWV0cmljS2luZBJGCgZwb2ludHMYBCADKAsyKS5nb29nbGUu'
    'Y2xvdWQuYmlncXVlcnkubWlncmF0aW9uLnYyLlBvaW50QgPgQQJSBnBvaW50cw==');

@$core.Deprecated('Use pointDescriptor instead')
const Point$json = {
  '1': 'Point',
  '2': [
    {'1': 'interval', '3': 1, '4': 1, '5': 11, '6': '.google.cloud.bigquery.migration.v2.TimeInterval', '10': 'interval'},
    {'1': 'value', '3': 2, '4': 1, '5': 11, '6': '.google.cloud.bigquery.migration.v2.TypedValue', '10': 'value'},
  ],
};

/// Descriptor for `Point`. Decode as a `google.protobuf.DescriptorProto`.
final $typed_data.Uint8List pointDescriptor = $convert.base64Decode(
    'CgVQb2ludBJMCghpbnRlcnZhbBgBIAEoCzIwLmdvb2dsZS5jbG91ZC5iaWdxdWVyeS5taWdyYX'
    'Rpb24udjIuVGltZUludGVydmFsUghpbnRlcnZhbBJECgV2YWx1ZRgCIAEoCzIuLmdvb2dsZS5j'
    'bG91ZC5iaWdxdWVyeS5taWdyYXRpb24udjIuVHlwZWRWYWx1ZVIFdmFsdWU=');
