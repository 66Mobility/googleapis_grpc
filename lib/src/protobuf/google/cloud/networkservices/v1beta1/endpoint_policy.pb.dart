...
class EndpointPolicy extends $pb.GeneratedMessage {
  factory EndpointPolicy({
    ...
    $4568.EndpointMatcher? endpointMatcher,
    $4568.TrafficPortSelector? trafficPortSelector,
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(_omitMessageNames ? '' : 'EndpointPolicy', package: const $pb.PackageName(_omitMessageNames ? '' : 'google.cloud.networkservices.v1beta1'), createEmptyInstance: create)
    ...
    ..aOM<$4568.EndpointMatcher>(9, _omitFieldNames ? '' : 'endpointMatcher', subBuilder: $4568.EndpointMatcher.create)
    ..aOM<$4568.TrafficPortSelector>(10, _omitFieldNames ? '' : 'trafficPortSelector', subBuilder: $4568.TrafficPortSelector.create)
  ...
  /// applied.
  @$pb.TagNumber(9)
  $4568.EndpointMatcher get endpointMatcher => $_getN(6);
  @$pb.TagNumber(9)
  set endpointMatcher($4568.EndpointMatcher v) { setField(9, v); }
  @$pb.TagNumber(9)
  $core.bool hasEndpointMatcher() => $_has(6);
  @$pb.TagNumber(9)
  void clearEndpointMatcher() => clearField(9);
  @$pb.TagNumber(9)
  $4568.EndpointMatcher ensureEndpointMatcher() => $_ensure(6);
  ...
  @$pb.TagNumber(10)
  $4568.TrafficPortSelector get trafficPortSelector => $_getN(7);
  @$pb.TagNumber(10)
  set trafficPortSelector($4568.TrafficPortSelector v) { setField(10, v); }
  @$pb.TagNumber(10)
  $core.bool hasTrafficPortSelector() => $_has(7);
  @$pb.TagNumber(10)
  void clearTrafficPortSelector() => clearField(10);
  @$pb.TagNumber(10)
  $4568.TrafficPortSelector ensureTrafficPortSelector() => $_ensure(7);
