...
class OperationMetadata extends $pb.GeneratedMessage {
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(_omitMessageNames ? '' : 'OperationMetadata', package: const $pb.PackageName(_omitMessageNames ? '' : 'google.cloud.networkservices.v1beta1'), createEmptyInstance: create)
...
class TrafficPortSelector extends $pb.GeneratedMessage {
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(_omitMessageNames ? '' : 'TrafficPortSelector', package: const $pb.PackageName(_omitMessageNames ? '' : 'google.cloud.networkservices.v1beta1'), createEmptyInstance: create)
...
class EndpointMatcher_MetadataLabelMatcher_MetadataLabels extends $pb.GeneratedMessage {
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(_omitMessageNames ? '' : 'EndpointMatcher.MetadataLabelMatcher.MetadataLabels', package: const $pb.PackageName(_omitMessageNames ? '' : 'google.cloud.networkservices.v1beta1'), createEmptyInstance: create)
...
class EndpointMatcher_MetadataLabelMatcher extends $pb.GeneratedMessage {
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(_omitMessageNames ? '' : 'EndpointMatcher.MetadataLabelMatcher', package: const $pb.PackageName(_omitMessageNames ? '' : 'google.cloud.networkservices.v1beta1'), createEmptyInstance: create)
...
class EndpointMatcher extends $pb.GeneratedMessage {
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(_omitMessageNames ? '' : 'EndpointMatcher', package: const $pb.PackageName(_omitMessageNames ? '' : 'google.cloud.networkservices.v1beta1'), createEmptyInstance: create)
    ..oo(0, [1])
