...
export 'adaptive_mt.pbenum.dart';
export 'automl_translation.pbenum.dart';
...
class UpdateGlossaryMetadata_State extends $pb.ProtobufEnum {
  static const UpdateGlossaryMetadata_State STATE_UNSPECIFIED = UpdateGlossaryMetadata_State._(0, _omitEnumNames ? '' : 'STATE_UNSPECIFIED');
  static const UpdateGlossaryMetadata_State RUNNING = UpdateGlossaryMetadata_State._(1, _omitEnumNames ? '' : 'RUNNING');
  static const UpdateGlossaryMetadata_State SUCCEEDED = UpdateGlossaryMetadata_State._(2, _omitEnumNames ? '' : 'SUCCEEDED');
  static const UpdateGlossaryMetadata_State FAILED = UpdateGlossaryMetadata_State._(3, _omitEnumNames ? '' : 'FAILED');
  static const UpdateGlossaryMetadata_State CANCELLING = UpdateGlossaryMetadata_State._(4, _omitEnumNames ? '' : 'CANCELLING');
  static const UpdateGlossaryMetadata_State CANCELLED = UpdateGlossaryMetadata_State._(5, _omitEnumNames ? '' : 'CANCELLED');

  static const $core.List<UpdateGlossaryMetadata_State> values = <UpdateGlossaryMetadata_State> [
    STATE_UNSPECIFIED,
    RUNNING,
    SUCCEEDED,
    FAILED,
  ...
  static final $core.Map<$core.int, UpdateGlossaryMetadata_State> _byValue = $pb.ProtobufEnum.initByValue(values);
  static UpdateGlossaryMetadata_State? valueOf($core.int value) => _byValue[value];

  const UpdateGlossaryMetadata_State._($core.int v, $core.String n) : super(v, n);
}
