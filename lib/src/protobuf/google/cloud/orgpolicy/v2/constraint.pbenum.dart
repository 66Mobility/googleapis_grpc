...
class Constraint_ConstraintDefault extends $pb.ProtobufEnum {
  static const Constraint_ConstraintDefault CONSTRAINT_DEFAULT_UNSPECIFIED = Constraint_ConstraintDefault._(0, _omitEnumNames ? '' : 'CONSTRAINT_DEFAULT_UNSPECIFIED');
  static const Constraint_ConstraintDefault ALLOW = Constraint_ConstraintDefault._(1, _omitEnumNames ? '' : 'ALLOW');
  static const Constraint_ConstraintDefault DENY = Constraint_ConstraintDefault._(2, _omitEnumNames ? '' : 'DENY');
