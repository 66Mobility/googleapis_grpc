...
class GenerateCredentialsRequest extends $pb.GeneratedMessage {
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(_omitMessageNames ? '' : 'GenerateCredentialsRequest', package: const $pb.PackageName(_omitMessageNames ? '' : 'google.cloud.gkeconnect.gateway.v1beta1'), createEmptyInstance: create)
...
class GenerateCredentialsResponse extends $pb.GeneratedMessage {
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(_omitMessageNames ? '' : 'GenerateCredentialsResponse', package: const $pb.PackageName(_omitMessageNames ? '' : 'google.cloud.gkeconnect.gateway.v1beta1'), createEmptyInstance: create)
