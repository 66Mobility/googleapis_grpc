...
class Instance_AcceleratorType extends $pb.ProtobufEnum {
  ...
  static const Instance_AcceleratorType NVIDIA_TESLA_A100 = Instance_AcceleratorType._(11, _omitEnumNames ? '' : 'NVIDIA_TESLA_A100');
...
class Instance_DiskType extends $pb.ProtobufEnum {
  ...
  static const Instance_DiskType PD_EXTREME = Instance_DiskType._(4, _omitEnumNames ? '' : 'PD_EXTREME');
...
class Instance_UpgradeHistoryEntry_State extends $pb.ProtobufEnum {
  static const Instance_UpgradeHistoryEntry_State STATE_UNSPECIFIED = Instance_UpgradeHistoryEntry_State._(0, _omitEnumNames ? '' : 'STATE_UNSPECIFIED');
  static const Instance_UpgradeHistoryEntry_State STARTED = Instance_UpgradeHistoryEntry_State._(1, _omitEnumNames ? '' : 'STARTED');
  static const Instance_UpgradeHistoryEntry_State SUCCEEDED = Instance_UpgradeHistoryEntry_State._(2, _omitEnumNames ? '' : 'SUCCEEDED');
  static const Instance_UpgradeHistoryEntry_State FAILED = Instance_UpgradeHistoryEntry_State._(3, _omitEnumNames ? '' : 'FAILED');
...
class Instance_UpgradeHistoryEntry_Action extends $pb.ProtobufEnum {
  static const Instance_UpgradeHistoryEntry_Action ACTION_UNSPECIFIED = Instance_UpgradeHistoryEntry_Action._(0, _omitEnumNames ? '' : 'ACTION_UNSPECIFIED');
  static const Instance_UpgradeHistoryEntry_Action UPGRADE = Instance_UpgradeHistoryEntry_Action._(1, _omitEnumNames ? '' : 'UPGRADE');
  static const Instance_UpgradeHistoryEntry_Action ROLLBACK = Instance_UpgradeHistoryEntry_Action._(2, _omitEnumNames ? '' : 'ROLLBACK');
