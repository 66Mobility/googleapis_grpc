...
class DiagnosticConfig extends $pb.GeneratedMessage {
  factory DiagnosticConfig({
    ...
    if (enableRepairFlag != null) {
      $result.enableRepairFlag = enableRepairFlag;
    }
    if (enablePacketCaptureFlag != null) {
      $result.enablePacketCaptureFlag = enablePacketCaptureFlag;
    }
    if (enableCopyHomeFilesFlag != null) {
      $result.enableCopyHomeFilesFlag = enableCopyHomeFilesFlag;
    }
    return $result;
  }
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(_omitMessageNames ? '' : 'DiagnosticConfig', package: const $pb.PackageName(_omitMessageNames ? '' : 'google.cloud.notebooks.v2'), createEmptyInstance: create)
    ..aOS(1, _omitFieldNames ? '' : 'gcsBucket')
    ..aOS(2, _omitFieldNames ? '' : 'relativePath')
    ..aOB(3, _omitFieldNames ? '' : 'enableRepairFlag')
    ..aOB(4, _omitFieldNames ? '' : 'enablePacketCaptureFlag')
    ..aOB(5, _omitFieldNames ? '' : 'enableCopyHomeFilesFlag')
  ...
  @$pb.TagNumber(3)
  $core.bool get enableRepairFlag => $_getBF(2);
  @$pb.TagNumber(3)
  set enableRepairFlag($core.bool v) { $_setBool(2, v); }
  @$pb.TagNumber(3)
  $core.bool hasEnableRepairFlag() => $_has(2);
  @$pb.TagNumber(3)
  void clearEnableRepairFlag() => clearField(3);

  /// Optional. Enables flag to capture packets from the instance for 30 seconds
  @$pb.TagNumber(4)
  $core.bool get enablePacketCaptureFlag => $_getBF(3);
  @$pb.TagNumber(4)
  set enablePacketCaptureFlag($core.bool v) { $_setBool(3, v); }
  @$pb.TagNumber(4)
  $core.bool hasEnablePacketCaptureFlag() => $_has(3);
  @$pb.TagNumber(4)
  void clearEnablePacketCaptureFlag() => clearField(4);

  /// Optional. Enables flag to copy all `/home/jupyter` folder contents
  @$pb.TagNumber(5)
  $core.bool get enableCopyHomeFilesFlag => $_getBF(4);
  @$pb.TagNumber(5)
  set enableCopyHomeFilesFlag($core.bool v) { $_setBool(4, v); }
  @$pb.TagNumber(5)
  $core.bool hasEnableCopyHomeFilesFlag() => $_has(4);
  @$pb.TagNumber(5)
  void clearEnableCopyHomeFilesFlag() => clearField(5);
}
