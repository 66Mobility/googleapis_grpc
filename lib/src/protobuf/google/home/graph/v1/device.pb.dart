...
class Device extends $pb.GeneratedMessage {
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(
    ...
    ..aOM<$289.Struct>(9, _omitFieldNames ? '' : 'attributes',
        subBuilder: $289.Struct.create)
    ..aOM<$289.Struct>(10, _omitFieldNames ? '' : 'customData',
        subBuilder: $289.Struct.create)
  ...
  @$pb.TagNumber(9)
  $289.Struct get attributes => $_getN(8);
  @$pb.TagNumber(9)
  set attributes($289.Struct v) {
    setField(9, v);
  }
  ...
  @$pb.TagNumber(9)
  $289.Struct ensureAttributes() => $_ensure(8);
  ...
  @$pb.TagNumber(10)
  $289.Struct get customData => $_getN(9);
  @$pb.TagNumber(10)
  set customData($289.Struct v) {
    setField(10, v);
  }
  ...
  @$pb.TagNumber(10)
  $289.Struct ensureCustomData() => $_ensure(9);
