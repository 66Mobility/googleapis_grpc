...
class Device extends $pb.GeneratedMessage {
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(_omitMessageNames ? '' : 'Device', package: const $pb.PackageName(_omitMessageNames ? '' : 'google.home.graph.v1'), createEmptyInstance: create)
    ...
    ..aOM<$260.Struct>(9, _omitFieldNames ? '' : 'attributes', subBuilder: $260.Struct.create)
    ..aOM<$260.Struct>(10, _omitFieldNames ? '' : 'customData', subBuilder: $260.Struct.create)
  ...
  @$pb.TagNumber(9)
  $260.Struct get attributes => $_getN(8);
  @$pb.TagNumber(9)
  set attributes($260.Struct v) { setField(9, v); }
  @$pb.TagNumber(9)
  $core.bool hasAttributes() => $_has(8);
  @$pb.TagNumber(9)
  void clearAttributes() => clearField(9);
  @$pb.TagNumber(9)
  $260.Struct ensureAttributes() => $_ensure(8);
  ...
  @$pb.TagNumber(10)
  $260.Struct get customData => $_getN(9);
  @$pb.TagNumber(10)
  set customData($260.Struct v) { setField(10, v); }
  @$pb.TagNumber(10)
  $core.bool hasCustomData() => $_has(9);
  @$pb.TagNumber(10)
  void clearCustomData() => clearField(10);
  @$pb.TagNumber(10)
  $260.Struct ensureCustomData() => $_ensure(9);
