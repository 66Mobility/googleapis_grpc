...
class ReportStateAndNotificationDevice extends $pb.GeneratedMessage {
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(_omitMessageNames ? '' : 'ReportStateAndNotificationDevice', package: const $pb.PackageName(_omitMessageNames ? '' : 'google.home.graph.v1'), createEmptyInstance: create)
    ..aOM<$1734.Struct>(1, _omitFieldNames ? '' : 'states', subBuilder: $1734.Struct.create)
    ..aOM<$1734.Struct>(2, _omitFieldNames ? '' : 'notifications', subBuilder: $1734.Struct.create)
    ..hasRequiredFields = false
  ;
  ...
  @$pb.TagNumber(1)
  $1734.Struct get states => $_getN(0);
  @$pb.TagNumber(1)
  set states($1734.Struct v) { setField(1, v); }
  @$pb.TagNumber(1)
  $core.bool hasStates() => $_has(0);
  @$pb.TagNumber(1)
  void clearStates() => clearField(1);
  @$pb.TagNumber(1)
  $1734.Struct ensureStates() => $_ensure(0);

  /// Notifications metadata for devices. See the **Device NOTIFICATIONS**
  /// section of the individual trait [reference
  /// guides](https://developers.home.google.com/cloud-to-cloud/traits).
  @$pb.TagNumber(2)
  $1734.Struct get notifications => $_getN(1);
  @$pb.TagNumber(2)
  set notifications($1734.Struct v) { setField(2, v); }
  @$pb.TagNumber(2)
  $core.bool hasNotifications() => $_has(1);
  @$pb.TagNumber(2)
  void clearNotifications() => clearField(2);
  @$pb.TagNumber(2)
  $1734.Struct ensureNotifications() => $_ensure(1);
}
...
class QueryResponsePayload extends $pb.GeneratedMessage {
  factory QueryResponsePayload({
    $core.Map<$core.String, $1734.Struct>? devices,
  }) {
    final $result = create();
    if (devices != null) {
      $result.devices.addAll(devices);
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(_omitMessageNames ? '' : 'QueryResponsePayload', package: const $pb.PackageName(_omitMessageNames ? '' : 'google.home.graph.v1'), createEmptyInstance: create)
    ..m<$core.String, $1734.Struct>(1, _omitFieldNames ? '' : 'devices', entryClassName: 'QueryResponsePayload.DevicesEntry', keyFieldType: $pb.PbFieldType.OS, valueFieldType: $pb.PbFieldType.OM, valueCreator: $1734.Struct.create, valueDefaultOrMaker: $1734.Struct.getDefault, packageName: const $pb.PackageName('google.home.graph.v1'))
    ..hasRequiredFields = false
  ;
  ...
  /// states.
  @$pb.TagNumber(1)
  $core.Map<$core.String, $1734.Struct> get devices => $_getMap(0);
}
...
class SyncResponsePayload extends $pb.GeneratedMessage {
  factory SyncResponsePayload({
    $core.String? agentUserId,
    $core.Iterable<$4789.Device>? devices,
  }) {
    final $result = create();
    if (agentUserId != null) {
      $result.agentUserId = agentUserId;
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(_omitMessageNames ? '' : 'SyncResponsePayload', package: const $pb.PackageName(_omitMessageNames ? '' : 'google.home.graph.v1'), createEmptyInstance: create)
    ..aOS(1, _omitFieldNames ? '' : 'agentUserId')
    ..pc<$4789.Device>(2, _omitFieldNames ? '' : 'devices', $pb.PbFieldType.PM, subBuilder: $4789.Device.create)
    ..hasRequiredFields = false
  ;
  ...
  /// Devices associated with the third-party user.
  @$pb.TagNumber(2)
  $core.List<$4789.Device> get devices => $_getList(1);
}
