...
class ReportStateAndNotificationDevice extends $pb.GeneratedMessage {
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(
      ...
      package: const $pb.PackageName(
          _omitMessageNames ? '' : 'google.home.graph.v1'),
      createEmptyInstance: create)
    ..aOM<$289.Struct>(1, _omitFieldNames ? '' : 'states',
        subBuilder: $289.Struct.create)
    ..aOM<$289.Struct>(2, _omitFieldNames ? '' : 'notifications',
        subBuilder: $289.Struct.create)
    ..hasRequiredFields = false;
  ...
  @$pb.TagNumber(1)
  $289.Struct get states => $_getN(0);
  @$pb.TagNumber(1)
  set states($289.Struct v) {
    setField(1, v);
  }
  ...
  @$pb.TagNumber(1)
  $289.Struct ensureStates() => $_ensure(0);

  /// Notifications metadata for devices. See the **Device NOTIFICATIONS**
  /// section of the individual trait [reference
  /// guides](https://developers.home.google.com/cloud-to-cloud/traits).
  @$pb.TagNumber(2)
  $289.Struct get notifications => $_getN(1);
  @$pb.TagNumber(2)
  set notifications($289.Struct v) {
    setField(2, v);
  }
  ...
  @$pb.TagNumber(2)
  $289.Struct ensureNotifications() => $_ensure(1);
}
...
class QueryResponsePayload extends $pb.GeneratedMessage {
  factory QueryResponsePayload({
    $core.Map<$core.String, $289.Struct>? devices,
  }) {
    final $result = create();
    if (devices != null) {
      $result.devices.addAll(devices);
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(
      ...
      package: const $pb.PackageName(
          _omitMessageNames ? '' : 'google.home.graph.v1'),
      createEmptyInstance: create)
    ..m<$core.String, $289.Struct>(1, _omitFieldNames ? '' : 'devices',
        entryClassName: 'QueryResponsePayload.DevicesEntry',
        keyFieldType: $pb.PbFieldType.OS,
        valueFieldType: $pb.PbFieldType.OM,
        valueCreator: $289.Struct.create,
        valueDefaultOrMaker: $289.Struct.getDefault,
  ...
  /// states.
  @$pb.TagNumber(1)
  $core.Map<$core.String, $289.Struct> get devices => $_getMap(0);
}
...
class SyncResponsePayload extends $pb.GeneratedMessage {
  factory SyncResponsePayload({
    $core.String? agentUserId,
    $core.Iterable<$473.Device>? devices,
  }) {
    final $result = create();
    if (agentUserId != null) {
      $result.agentUserId = agentUserId;
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(
      ...
      createEmptyInstance: create)
    ..aOS(1, _omitFieldNames ? '' : 'agentUserId')
    ..pc<$473.Device>(2, _omitFieldNames ? '' : 'devices', $pb.PbFieldType.PM,
        subBuilder: $473.Device.create)
    ..hasRequiredFields = false;
  ...
  /// Devices associated with the third-party user.
  @$pb.TagNumber(2)
  $core.List<$473.Device> get devices => $_getList(1);
}
