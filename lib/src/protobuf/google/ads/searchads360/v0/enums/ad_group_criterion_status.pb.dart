...
class AdGroupCriterionStatusEnum extends $pb.GeneratedMessage {
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(_omitMessageNames ? '' : 'AdGroupCriterionStatusEnum', package: const $pb.PackageName(_omitMessageNames ? '' : 'google.ads.searchads360.v0.enums'), createEmptyInstance: create)
  ...
  'Will be removed in next major version')
  AdGroupCriterionStatusEnum copyWith(void Function(AdGroupCriterionStatusEnum) updates) => super.copyWith((message) => updates(message as AdGroupCriterionStatusEnum)) as AdGroupCriterionStatusEnum;
