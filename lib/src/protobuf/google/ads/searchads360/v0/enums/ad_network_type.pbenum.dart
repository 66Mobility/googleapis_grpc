...
class AdNetworkTypeEnum_AdNetworkType extends $pb.ProtobufEnum {
  ...
  static const AdNetworkTypeEnum_AdNetworkType YOUTUBE_SEARCH = AdNetworkTypeEnum_AdNetworkType._(5, _omitEnumNames ? '' : 'YOUTUBE_SEARCH');
  static const AdNetworkTypeEnum_AdNetworkType YOUTUBE_WATCH = AdNetworkTypeEnum_AdNetworkType._(6, _omitEnumNames ? '' : 'YOUTUBE_WATCH');
