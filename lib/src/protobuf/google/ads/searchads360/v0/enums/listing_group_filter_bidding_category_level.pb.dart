...
class ListingGroupFilterBiddingCategoryLevelEnum extends $pb.GeneratedMessage {
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(_omitMessageNames ? '' : 'ListingGroupFilterBiddingCategoryLevelEnum', package: const $pb.PackageName(_omitMessageNames ? '' : 'google.ads.searchads360.v0.enums'), createEmptyInstance: create)
  ...
  'Will be removed in next major version')
  ListingGroupFilterBiddingCategoryLevelEnum copyWith(void Function(ListingGroupFilterBiddingCategoryLevelEnum) updates) => super.copyWith((message) => updates(message as ListingGroupFilterBiddingCategoryLevelEnum)) as ListingGroupFilterBiddingCategoryLevelEnum;
