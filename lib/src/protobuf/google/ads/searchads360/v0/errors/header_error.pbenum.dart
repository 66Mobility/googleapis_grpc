...
class HeaderErrorEnum_HeaderError extends $pb.ProtobufEnum {
  ...
  static const HeaderErrorEnum_HeaderError INVALID_USER_SELECTED_CUSTOMER_ID = HeaderErrorEnum_HeaderError._(2, _omitEnumNames ? '' : 'INVALID_USER_SELECTED_CUSTOMER_ID');
