...
import '../enums/bidding_strategy_status.pbenum.dart' as $4045;
...
class BiddingStrategy extends $pb.GeneratedMessage {
  factory BiddingStrategy({
    ...
    $4012.BiddingStrategyTypeEnum_BiddingStrategyType? type,
    $4044.EnhancedCpc? enhancedCpc,
    $4044.TargetCpa? targetCpa,
    $4044.TargetOutrankShare? targetOutrankShare,
    $4044.TargetRoas? targetRoas,
    $4044.TargetSpend? targetSpend,
    $4045.BiddingStrategyStatusEnum_BiddingStrategyStatus? status,
    $fixnum.Int64? id,
    $core.String? name,
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(_omitMessageNames ? '' : 'BiddingStrategy', package: const $pb.PackageName(_omitMessageNames ? '' : 'google.ads.searchads360.v0.resources'), createEmptyInstance: create)
    ...
    ..e<$4012.BiddingStrategyTypeEnum_BiddingStrategyType>(5, _omitFieldNames ? '' : 'type', $pb.PbFieldType.OE, defaultOrMaker: $4012.BiddingStrategyTypeEnum_BiddingStrategyType.UNSPECIFIED, valueOf: $4012.BiddingStrategyTypeEnum_BiddingStrategyType.valueOf, enumValues: $4012.BiddingStrategyTypeEnum_BiddingStrategyType.values)
    ..aOM<$4044.EnhancedCpc>(7, _omitFieldNames ? '' : 'enhancedCpc', subBuilder: $4044.EnhancedCpc.create)
    ..aOM<$4044.TargetCpa>(9, _omitFieldNames ? '' : 'targetCpa', subBuilder: $4044.TargetCpa.create)
    ..aOM<$4044.TargetOutrankShare>(10, _omitFieldNames ? '' : 'targetOutrankShare', subBuilder: $4044.TargetOutrankShare.create)
    ..aOM<$4044.TargetRoas>(11, _omitFieldNames ? '' : 'targetRoas', subBuilder: $4044.TargetRoas.create)
    ..aOM<$4044.TargetSpend>(12, _omitFieldNames ? '' : 'targetSpend', subBuilder: $4044.TargetSpend.create)
    ..e<$4045.BiddingStrategyStatusEnum_BiddingStrategyStatus>(15, _omitFieldNames ? '' : 'status', $pb.PbFieldType.OE, defaultOrMaker: $4045.BiddingStrategyStatusEnum_BiddingStrategyStatus.UNSPECIFIED, valueOf: $4045.BiddingStrategyStatusEnum_BiddingStrategyStatus.valueOf, enumValues: $4045.BiddingStrategyStatusEnum_BiddingStrategyStatus.values)
    ...
    ..aOM<$4044.MaximizeConversionValue>(21, _omitFieldNames ? '' : 'maximizeConversionValue', subBuilder: $4044.MaximizeConversionValue.create)
    ..aOM<$4044.MaximizeConversions>(22, _omitFieldNames ? '' : 'maximizeConversions', subBuilder: $4044.MaximizeConversions.create)
  ...
  @$pb.TagNumber(5)
  $4012.BiddingStrategyTypeEnum_BiddingStrategyType get type => $_getN(1);
  @$pb.TagNumber(5)
  set type($4012.BiddingStrategyTypeEnum_BiddingStrategyType v) { setField(5, v); }
  @$pb.TagNumber(5)
  ...
  /// likely.
  @$pb.TagNumber(7)
  $4044.EnhancedCpc get enhancedCpc => $_getN(2);
  @$pb.TagNumber(7)
  set enhancedCpc($4044.EnhancedCpc v) { setField(7, v); }
  @$pb.TagNumber(7)
  $core.bool hasEnhancedCpc() => $_has(2);
  @$pb.TagNumber(7)
  void clearEnhancedCpc() => clearField(7);
  @$pb.TagNumber(7)
  $4044.EnhancedCpc ensureEnhancedCpc() => $_ensure(2);

  /// A bidding strategy that sets bids to help get as many conversions as
  /// possible at the target cost-per-acquisition (CPA) you set.
  @$pb.TagNumber(9)
  $4044.TargetCpa get targetCpa => $_getN(3);
  @$pb.TagNumber(9)
  set targetCpa($4044.TargetCpa v) { setField(9, v); }
  @$pb.TagNumber(9)
  $core.bool hasTargetCpa() => $_has(3);
  @$pb.TagNumber(9)
  void clearTargetCpa() => clearField(9);
  @$pb.TagNumber(9)
  $4044.TargetCpa ensureTargetCpa() => $_ensure(3);
  ...
  /// allowed.
  @$pb.TagNumber(10)
  $4044.TargetOutrankShare get targetOutrankShare => $_getN(4);
  @$pb.TagNumber(10)
  set targetOutrankShare($4044.TargetOutrankShare v) { setField(10, v); }
  @$pb.TagNumber(10)
  $core.bool hasTargetOutrankShare() => $_has(4);
  @$pb.TagNumber(10)
  void clearTargetOutrankShare() => clearField(10);
  @$pb.TagNumber(10)
  $4044.TargetOutrankShare ensureTargetOutrankShare() => $_ensure(4);

  /// A bidding strategy that helps you maximize revenue while averaging a
  /// specific target Return On Ad Spend (ROAS).
  @$pb.TagNumber(11)
  $4044.TargetRoas get targetRoas => $_getN(5);
  @$pb.TagNumber(11)
  set targetRoas($4044.TargetRoas v) { setField(11, v); }
  @$pb.TagNumber(11)
  $core.bool hasTargetRoas() => $_has(5);
  @$pb.TagNumber(11)
  void clearTargetRoas() => clearField(11);
  @$pb.TagNumber(11)
  $4044.TargetRoas ensureTargetRoas() => $_ensure(5);

  /// A bid strategy that sets your bids to help get as many clicks as
  /// possible within your budget.
  @$pb.TagNumber(12)
  $4044.TargetSpend get targetSpend => $_getN(6);
  @$pb.TagNumber(12)
  set targetSpend($4044.TargetSpend v) { setField(12, v); }
  @$pb.TagNumber(12)
  $core.bool hasTargetSpend() => $_has(6);
  @$pb.TagNumber(12)
  void clearTargetSpend() => clearField(12);
  @$pb.TagNumber(12)
  $4044.TargetSpend ensureTargetSpend() => $_ensure(6);

  ///  Output only. The status of the bidding strategy.
  ///
  ///  This field is read-only.
  @$pb.TagNumber(15)
  $4045.BiddingStrategyStatusEnum_BiddingStrategyStatus get status => $_getN(7);
  @$pb.TagNumber(15)
  set status($4045.BiddingStrategyStatusEnum_BiddingStrategyStatus v) { setField(15, v); }
  @$pb.TagNumber(15)
  ...
  @$pb.TagNumber(21)
  $4044.MaximizeConversionValue get maximizeConversionValue => $_getN(13);
  @$pb.TagNumber(21)
  set maximizeConversionValue($4044.MaximizeConversionValue v) { setField(21, v); }
  @$pb.TagNumber(21)
  $core.bool hasMaximizeConversionValue() => $_has(13);
  @$pb.TagNumber(21)
  void clearMaximizeConversionValue() => clearField(21);
  @$pb.TagNumber(21)
  $4044.MaximizeConversionValue ensureMaximizeConversionValue() => $_ensure(13);
  ...
  @$pb.TagNumber(22)
  set maximizeConversions($4044.MaximizeConversions v) { setField(22, v); }
  @$pb.TagNumber(22)
  ...
  @$pb.TagNumber(48)
  $4044.TargetImpressionShare get targetImpressionShare => $_getN(16);
  @$pb.TagNumber(48)
  ...
  @$pb.TagNumber(48)
  $4044.TargetImpressionShare ensureTargetImpressionShare() => $_ensure(16);
}
