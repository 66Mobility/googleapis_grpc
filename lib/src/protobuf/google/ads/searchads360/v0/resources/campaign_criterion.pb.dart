...
import '../enums/campaign_criterion_status.pbenum.dart' as $4060;
...
class CampaignCriterion extends $pb.GeneratedMessage {
  factory CampaignCriterion({
    ...
    $3982.LanguageInfo? language,
    $3982.WebpageInfo? webpage,
    $3982.LocationGroupInfo? locationGroup,
    $4060.CampaignCriterionStatusEnum_CampaignCriterionStatus? status,
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(_omitMessageNames ? '' : 'CampaignCriterion', package: const $pb.PackageName(_omitMessageNames ? '' : 'google.ads.searchads360.v0.resources'), createEmptyInstance: create)
    ...
    ..e<$4026.CriterionTypeEnum_CriterionType>(6, _omitFieldNames ? '' : 'type', $pb.PbFieldType.OE, defaultOrMaker: $4026.CriterionTypeEnum_CriterionType.UNSPECIFIED, valueOf: $4026.CriterionTypeEnum_CriterionType.valueOf, enumValues: $4026.CriterionTypeEnum_CriterionType.values)
    ..aOM<$3982.KeywordInfo>(8, _omitFieldNames ? '' : 'keyword', subBuilder: $3982.KeywordInfo.create)
    ..aOM<$3982.LocationInfo>(12, _omitFieldNames ? '' : 'location', subBuilder: $3982.LocationInfo.create)
    ..aOM<$3982.DeviceInfo>(13, _omitFieldNames ? '' : 'device', subBuilder: $3982.DeviceInfo.create)
    ..aOM<$3982.AgeRangeInfo>(16, _omitFieldNames ? '' : 'ageRange', subBuilder: $3982.AgeRangeInfo.create)
    ..aOM<$3982.GenderInfo>(17, _omitFieldNames ? '' : 'gender', subBuilder: $3982.GenderInfo.create)
    ..aOM<$3982.UserListInfo>(22, _omitFieldNames ? '' : 'userList', subBuilder: $3982.UserListInfo.create)
    ..aOM<$3982.LanguageInfo>(26, _omitFieldNames ? '' : 'language', subBuilder: $3982.LanguageInfo.create)
    ..aOM<$3982.WebpageInfo>(31, _omitFieldNames ? '' : 'webpage', subBuilder: $3982.WebpageInfo.create)
    ..aOM<$3982.LocationGroupInfo>(34, _omitFieldNames ? '' : 'locationGroup', subBuilder: $3982.LocationGroupInfo.create)
    ..e<$4060.CampaignCriterionStatusEnum_CampaignCriterionStatus>(35, _omitFieldNames ? '' : 'status', $pb.PbFieldType.OE, defaultOrMaker: $4060.CampaignCriterionStatusEnum_CampaignCriterionStatus.UNSPECIFIED, valueOf: $4060.CampaignCriterionStatusEnum_CampaignCriterionStatus.valueOf, enumValues: $4060.CampaignCriterionStatusEnum_CampaignCriterionStatus.values)
  ...
  @$pb.TagNumber(6)
  $4026.CriterionTypeEnum_CriterionType get type => $_getN(1);
  @$pb.TagNumber(6)
  set type($4026.CriterionTypeEnum_CriterionType v) { setField(6, v); }
  @$pb.TagNumber(6)
  ...
  /// Immutable. Keyword.
  @$pb.TagNumber(8)
  $3982.KeywordInfo get keyword => $_getN(2);
  @$pb.TagNumber(8)
  set keyword($3982.KeywordInfo v) { setField(8, v); }
  @$pb.TagNumber(8)
  $core.bool hasKeyword() => $_has(2);
  @$pb.TagNumber(8)
  void clearKeyword() => clearField(8);
  @$pb.TagNumber(8)
  $3982.KeywordInfo ensureKeyword() => $_ensure(2);

  /// Immutable. Location.
  @$pb.TagNumber(12)
  $3982.LocationInfo get location => $_getN(3);
  @$pb.TagNumber(12)
  set location($3982.LocationInfo v) { setField(12, v); }
  @$pb.TagNumber(12)
  $core.bool hasLocation() => $_has(3);
  @$pb.TagNumber(12)
  void clearLocation() => clearField(12);
  @$pb.TagNumber(12)
  $3982.LocationInfo ensureLocation() => $_ensure(3);

  /// Immutable. Device.
  @$pb.TagNumber(13)
  $3982.DeviceInfo get device => $_getN(4);
  @$pb.TagNumber(13)
  set device($3982.DeviceInfo v) { setField(13, v); }
  @$pb.TagNumber(13)
  $core.bool hasDevice() => $_has(4);
  @$pb.TagNumber(13)
  void clearDevice() => clearField(13);
  @$pb.TagNumber(13)
  $3982.DeviceInfo ensureDevice() => $_ensure(4);

  /// Immutable. Age range.
  @$pb.TagNumber(16)
  $3982.AgeRangeInfo get ageRange => $_getN(5);
  @$pb.TagNumber(16)
  set ageRange($3982.AgeRangeInfo v) { setField(16, v); }
  @$pb.TagNumber(16)
  $core.bool hasAgeRange() => $_has(5);
  @$pb.TagNumber(16)
  void clearAgeRange() => clearField(16);
  @$pb.TagNumber(16)
  $3982.AgeRangeInfo ensureAgeRange() => $_ensure(5);

  /// Immutable. Gender.
  @$pb.TagNumber(17)
  $3982.GenderInfo get gender => $_getN(6);
  @$pb.TagNumber(17)
  set gender($3982.GenderInfo v) { setField(17, v); }
  @$pb.TagNumber(17)
  $core.bool hasGender() => $_has(6);
  @$pb.TagNumber(17)
  void clearGender() => clearField(17);
  @$pb.TagNumber(17)
  $3982.GenderInfo ensureGender() => $_ensure(6);

  /// Immutable. User List.
  @$pb.TagNumber(22)
  $3982.UserListInfo get userList => $_getN(7);
  @$pb.TagNumber(22)
  set userList($3982.UserListInfo v) { setField(22, v); }
  @$pb.TagNumber(22)
  $core.bool hasUserList() => $_has(7);
  @$pb.TagNumber(22)
  void clearUserList() => clearField(22);
  @$pb.TagNumber(22)
  $3982.UserListInfo ensureUserList() => $_ensure(7);

  /// Immutable. Language.
  @$pb.TagNumber(26)
  $3982.LanguageInfo get language => $_getN(8);
  @$pb.TagNumber(26)
  set language($3982.LanguageInfo v) { setField(26, v); }
  @$pb.TagNumber(26)
  $core.bool hasLanguage() => $_has(8);
  @$pb.TagNumber(26)
  void clearLanguage() => clearField(26);
  @$pb.TagNumber(26)
  $3982.LanguageInfo ensureLanguage() => $_ensure(8);

  /// Immutable. Webpage.
  @$pb.TagNumber(31)
  $3982.WebpageInfo get webpage => $_getN(9);
  @$pb.TagNumber(31)
  set webpage($3982.WebpageInfo v) { setField(31, v); }
  @$pb.TagNumber(31)
  $core.bool hasWebpage() => $_has(9);
  @$pb.TagNumber(31)
  void clearWebpage() => clearField(31);
  @$pb.TagNumber(31)
  $3982.WebpageInfo ensureWebpage() => $_ensure(9);

  /// Immutable. Location Group
  @$pb.TagNumber(34)
  $3982.LocationGroupInfo get locationGroup => $_getN(10);
  @$pb.TagNumber(34)
  set locationGroup($3982.LocationGroupInfo v) { setField(34, v); }
  @$pb.TagNumber(34)
  $core.bool hasLocationGroup() => $_has(10);
  @$pb.TagNumber(34)
  void clearLocationGroup() => clearField(34);
  @$pb.TagNumber(34)
  $3982.LocationGroupInfo ensureLocationGroup() => $_ensure(10);

  /// The status of the criterion.
  @$pb.TagNumber(35)
  $4060.CampaignCriterionStatusEnum_CampaignCriterionStatus get status => $_getN(11);
  @$pb.TagNumber(35)
  set status($4060.CampaignCriterionStatusEnum_CampaignCriterionStatus v) { setField(35, v); }
  @$pb.TagNumber(35)
