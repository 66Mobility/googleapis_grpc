...
class AudienceErrorEnum extends $pb.GeneratedMessage {
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(_omitMessageNames ? '' : 'AudienceErrorEnum', package: const $pb.PackageName(_omitMessageNames ? '' : 'google.ads.googleads.v15.errors'), createEmptyInstance: create)
  ...
  'Will be removed in next major version')
  AudienceErrorEnum copyWith(void Function(AudienceErrorEnum) updates) => super.copyWith((message) => updates(message as AudienceErrorEnum)) as AudienceErrorEnum;
