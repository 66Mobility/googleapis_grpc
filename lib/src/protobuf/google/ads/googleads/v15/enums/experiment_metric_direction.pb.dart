...
class ExperimentMetricDirectionEnum extends $pb.GeneratedMessage {
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(_omitMessageNames ? '' : 'ExperimentMetricDirectionEnum', package: const $pb.PackageName(_omitMessageNames ? '' : 'google.ads.googleads.v15.enums'), createEmptyInstance: create)
  ...
  'Will be removed in next major version')
  ExperimentMetricDirectionEnum copyWith(void Function(ExperimentMetricDirectionEnum) updates) => super.copyWith((message) => updates(message as ExperimentMetricDirectionEnum)) as ExperimentMetricDirectionEnum;
