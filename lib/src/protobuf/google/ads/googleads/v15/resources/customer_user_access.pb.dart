...
class CustomerUserAccess extends $pb.GeneratedMessage {
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(_omitMessageNames ? '' : 'CustomerUserAccess', package: const $pb.PackageName(_omitMessageNames ? '' : 'google.ads.googleads.v15.resources'), createEmptyInstance: create)
  ...
  @$pb.TagNumber(4)
  $2262.AccessRoleEnum_AccessRole get accessRole => $_getN(3);
  @$pb.TagNumber(4)
