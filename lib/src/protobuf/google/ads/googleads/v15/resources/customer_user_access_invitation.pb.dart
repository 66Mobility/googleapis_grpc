...
import '../enums/access_invitation_status.pbenum.dart' as $2263;
...
class CustomerUserAccessInvitation extends $pb.GeneratedMessage {
  factory CustomerUserAccessInvitation({
    ...
    $2263.AccessInvitationStatusEnum_AccessInvitationStatus? invitationStatus,
  }) {
    final $result = create();
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(_omitMessageNames ? '' : 'CustomerUserAccessInvitation', package: const $pb.PackageName(_omitMessageNames ? '' : 'google.ads.googleads.v15.resources'), createEmptyInstance: create)
    ..aOS(1, _omitFieldNames ? '' : 'resourceName')
    ..aInt64(2, _omitFieldNames ? '' : 'invitationId')
    ..e<$2262.AccessRoleEnum_AccessRole>(3, _omitFieldNames ? '' : 'accessRole', $pb.PbFieldType.OE, defaultOrMaker: $2262.AccessRoleEnum_AccessRole.UNSPECIFIED, valueOf: $2262.AccessRoleEnum_AccessRole.valueOf, enumValues: $2262.AccessRoleEnum_AccessRole.values)
    ..aOS(4, _omitFieldNames ? '' : 'emailAddress')
    ..aOS(5, _omitFieldNames ? '' : 'creationDateTime')
    ..e<$2263.AccessInvitationStatusEnum_AccessInvitationStatus>(6, _omitFieldNames ? '' : 'invitationStatus', $pb.PbFieldType.OE, defaultOrMaker: $2263.AccessInvitationStatusEnum_AccessInvitationStatus.UNSPECIFIED, valueOf: $2263.AccessInvitationStatusEnum_AccessInvitationStatus.valueOf, enumValues: $2263.AccessInvitationStatusEnum_AccessInvitationStatus.values)
  ...
  @$pb.TagNumber(3)
  set accessRole($2262.AccessRoleEnum_AccessRole v) { setField(3, v); }
  @$pb.TagNumber(3)
  ...
  @$pb.TagNumber(6)
  $2263.AccessInvitationStatusEnum_AccessInvitationStatus get invitationStatus => $_getN(5);
  @$pb.TagNumber(6)
  set invitationStatus($2263.AccessInvitationStatusEnum_AccessInvitationStatus v) { setField(6, v); }
  @$pb.TagNumber(6)
