...
import '../enums/custom_conversion_goal_status.pbenum.dart' as $2254;
...
class CustomConversionGoal extends $pb.GeneratedMessage {
  factory CustomConversionGoal({
    ...
    $2254.CustomConversionGoalStatusEnum_CustomConversionGoalStatus? status,
  }) {
    final $result = create();
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(_omitMessageNames ? '' : 'CustomConversionGoal', package: const $pb.PackageName(_omitMessageNames ? '' : 'google.ads.googleads.v15.resources'), createEmptyInstance: create)
    ..aOS(1, _omitFieldNames ? '' : 'resourceName')
    ..aInt64(2, _omitFieldNames ? '' : 'id')
    ..aOS(3, _omitFieldNames ? '' : 'name')
    ..pPS(4, _omitFieldNames ? '' : 'conversionActions')
    ..e<$2254.CustomConversionGoalStatusEnum_CustomConversionGoalStatus>(5, _omitFieldNames ? '' : 'status', $pb.PbFieldType.OE, defaultOrMaker: $2254.CustomConversionGoalStatusEnum_CustomConversionGoalStatus.UNSPECIFIED, valueOf: $2254.CustomConversionGoalStatusEnum_CustomConversionGoalStatus.valueOf, enumValues: $2254.CustomConversionGoalStatusEnum_CustomConversionGoalStatus.values)
  ...
  @$pb.TagNumber(5)
  $2254.CustomConversionGoalStatusEnum_CustomConversionGoalStatus get status => $_getN(4);
  @$pb.TagNumber(5)
  set status($2254.CustomConversionGoalStatusEnum_CustomConversionGoalStatus v) { setField(5, v); }
  @$pb.TagNumber(5)
