...
import '../enums/combined_audience_status.pbenum.dart' as $2235;
...
class CombinedAudience extends $pb.GeneratedMessage {
  factory CombinedAudience({
    ...
    $fixnum.Int64? id,
    $2235.CombinedAudienceStatusEnum_CombinedAudienceStatus? status,
    $core.String? name,
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(_omitMessageNames ? '' : 'CombinedAudience', package: const $pb.PackageName(_omitMessageNames ? '' : 'google.ads.googleads.v15.resources'), createEmptyInstance: create)
    ...
    ..e<$2235.CombinedAudienceStatusEnum_CombinedAudienceStatus>(3, _omitFieldNames ? '' : 'status', $pb.PbFieldType.OE, defaultOrMaker: $2235.CombinedAudienceStatusEnum_CombinedAudienceStatus.UNSPECIFIED, valueOf: $2235.CombinedAudienceStatusEnum_CombinedAudienceStatus.valueOf, enumValues: $2235.CombinedAudienceStatusEnum_CombinedAudienceStatus.values)
  ...
  @$pb.TagNumber(3)
  $2235.CombinedAudienceStatusEnum_CombinedAudienceStatus get status => $_getN(2);
  @$pb.TagNumber(3)
  set status($2235.CombinedAudienceStatusEnum_CombinedAudienceStatus v) { setField(3, v); }
  @$pb.TagNumber(3)
