...
import '../enums/android_privacy_network_type.pbenum.dart' as $2136;
...
class AndroidPrivacySharedKeyGoogleNetworkType extends $pb.GeneratedMessage {
  factory AndroidPrivacySharedKeyGoogleNetworkType({
    ...
    $2136.AndroidPrivacyNetworkTypeEnum_AndroidPrivacyNetworkType? androidPrivacyNetworkType,
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(_omitMessageNames ? '' : 'AndroidPrivacySharedKeyGoogleNetworkType', package: const $pb.PackageName(_omitMessageNames ? '' : 'google.ads.googleads.v15.resources'), createEmptyInstance: create)
    ...
    ..e<$2136.AndroidPrivacyNetworkTypeEnum_AndroidPrivacyNetworkType>(5, _omitFieldNames ? '' : 'androidPrivacyNetworkType', $pb.PbFieldType.OE, defaultOrMaker: $2136.AndroidPrivacyNetworkTypeEnum_AndroidPrivacyNetworkType.UNSPECIFIED, valueOf: $2136.AndroidPrivacyNetworkTypeEnum_AndroidPrivacyNetworkType.valueOf, enumValues: $2136.AndroidPrivacyNetworkTypeEnum_AndroidPrivacyNetworkType.values)
  ...
  @$pb.TagNumber(5)
  $2136.AndroidPrivacyNetworkTypeEnum_AndroidPrivacyNetworkType get androidPrivacyNetworkType => $_getN(4);
  @$pb.TagNumber(5)
  set androidPrivacyNetworkType($2136.AndroidPrivacyNetworkTypeEnum_AndroidPrivacyNetworkType v) { setField(5, v); }
  @$pb.TagNumber(5)
