...
class CustomerFeed extends $pb.GeneratedMessage {
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(_omitMessageNames ? '' : 'CustomerFeed', package: const $pb.PackageName(_omitMessageNames ? '' : 'google.ads.googleads.v15.resources'), createEmptyInstance: create)
    ...
    ..pc<$1910.PlaceholderTypeEnum_PlaceholderType>(3, _omitFieldNames ? '' : 'placeholderTypes', $pb.PbFieldType.KE, valueOf: $1910.PlaceholderTypeEnum_PlaceholderType.valueOf, enumValues: $1910.PlaceholderTypeEnum_PlaceholderType.values, defaultEnumValue: $1910.PlaceholderTypeEnum_PlaceholderType.UNSPECIFIED)
    ..aOM<$2134.MatchingFunction>(4, _omitFieldNames ? '' : 'matchingFunction', subBuilder: $2134.MatchingFunction.create)
    ..e<$2135.FeedLinkStatusEnum_FeedLinkStatus>(5, _omitFieldNames ? '' : 'status', $pb.PbFieldType.OE, defaultOrMaker: $2135.FeedLinkStatusEnum_FeedLinkStatus.UNSPECIFIED, valueOf: $2135.FeedLinkStatusEnum_FeedLinkStatus.valueOf, enumValues: $2135.FeedLinkStatusEnum_FeedLinkStatus.values)
  ...
  @$pb.TagNumber(4)
  set matchingFunction($2134.MatchingFunction v) { setField(4, v); }
  @$pb.TagNumber(4)
  ...
  @$pb.TagNumber(5)
  set status($2135.FeedLinkStatusEnum_FeedLinkStatus v) { setField(5, v); }
  @$pb.TagNumber(5)
