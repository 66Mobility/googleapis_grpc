...
import '../common/matching_function.pb.dart' as $2133;
import '../enums/feed_link_status.pbenum.dart' as $2134;
...
class CustomerFeed extends $pb.GeneratedMessage {
  factory CustomerFeed({
    ...
    $core.Iterable<$1909.PlaceholderTypeEnum_PlaceholderType>? placeholderTypes,
    $2133.MatchingFunction? matchingFunction,
    $2134.FeedLinkStatusEnum_FeedLinkStatus? status,
    $core.String? feed,
  }) {
    final $result = create();
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(_omitMessageNames ? '' : 'CustomerFeed', package: const $pb.PackageName(_omitMessageNames ? '' : 'google.ads.googleads.v15.resources'), createEmptyInstance: create)
    ..aOS(1, _omitFieldNames ? '' : 'resourceName')
    ..pc<$1909.PlaceholderTypeEnum_PlaceholderType>(3, _omitFieldNames ? '' : 'placeholderTypes', $pb.PbFieldType.KE, valueOf: $1909.PlaceholderTypeEnum_PlaceholderType.valueOf, enumValues: $1909.PlaceholderTypeEnum_PlaceholderType.values, defaultEnumValue: $1909.PlaceholderTypeEnum_PlaceholderType.UNSPECIFIED)
    ..aOM<$2133.MatchingFunction>(4, _omitFieldNames ? '' : 'matchingFunction', subBuilder: $2133.MatchingFunction.create)
    ..e<$2134.FeedLinkStatusEnum_FeedLinkStatus>(5, _omitFieldNames ? '' : 'status', $pb.PbFieldType.OE, defaultOrMaker: $2134.FeedLinkStatusEnum_FeedLinkStatus.UNSPECIFIED, valueOf: $2134.FeedLinkStatusEnum_FeedLinkStatus.valueOf, enumValues: $2134.FeedLinkStatusEnum_FeedLinkStatus.values)
  ...
  /// customer. Required.
  @$pb.TagNumber(3)
  $core.List<$1909.PlaceholderTypeEnum_PlaceholderType> get placeholderTypes => $_getList(1);

  /// Matching function associated with the CustomerFeed.
  /// The matching function is used to filter the set of feed items selected.
  /// Required.
  @$pb.TagNumber(4)
  $2133.MatchingFunction get matchingFunction => $_getN(2);
  @$pb.TagNumber(4)
  set matchingFunction($2133.MatchingFunction v) { setField(4, v); }
  @$pb.TagNumber(4)
  $core.bool hasMatchingFunction() => $_has(2);
  @$pb.TagNumber(4)
  void clearMatchingFunction() => clearField(4);
  @$pb.TagNumber(4)
  $2133.MatchingFunction ensureMatchingFunction() => $_ensure(2);

  /// Output only. Status of the customer feed.
  /// This field is read-only.
  @$pb.TagNumber(5)
  $2134.FeedLinkStatusEnum_FeedLinkStatus get status => $_getN(3);
  @$pb.TagNumber(5)
  set status($2134.FeedLinkStatusEnum_FeedLinkStatus v) { setField(5, v); }
  @$pb.TagNumber(5)
