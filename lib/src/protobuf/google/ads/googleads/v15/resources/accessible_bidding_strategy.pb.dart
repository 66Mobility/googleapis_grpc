...
class AccessibleBiddingStrategy extends $pb.GeneratedMessage {
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(_omitMessageNames ? '' : 'AccessibleBiddingStrategy', package: const $pb.PackageName(_omitMessageNames ? '' : 'google.ads.googleads.v15.resources'), createEmptyInstance: create)
    ...
    ..e<$2096.BiddingStrategyTypeEnum_BiddingStrategyType>(4, _omitFieldNames ? '' : 'type', $pb.PbFieldType.OE, defaultOrMaker: $2096.BiddingStrategyTypeEnum_BiddingStrategyType.UNSPECIFIED, valueOf: $2096.BiddingStrategyTypeEnum_BiddingStrategyType.valueOf, enumValues: $2096.BiddingStrategyTypeEnum_BiddingStrategyType.values)
  ...
  @$pb.TagNumber(4)
  $2096.BiddingStrategyTypeEnum_BiddingStrategyType get type => $_getN(3);
  @$pb.TagNumber(4)
  set type($2096.BiddingStrategyTypeEnum_BiddingStrategyType v) { setField(4, v); }
  @$pb.TagNumber(4)
