...
import '../enums/target_impression_share_location.pbenum.dart' as $1880;
...
class AccessibleBiddingStrategy_MaximizeConversionValue extends $pb.GeneratedMessage {
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(_omitMessageNames ? '' : 'AccessibleBiddingStrategy.MaximizeConversionValue', package: const $pb.PackageName(_omitMessageNames ? '' : 'google.ads.googleads.v15.resources'), createEmptyInstance: create)
...
class AccessibleBiddingStrategy_MaximizeConversions extends $pb.GeneratedMessage {
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(_omitMessageNames ? '' : 'AccessibleBiddingStrategy.MaximizeConversions', package: const $pb.PackageName(_omitMessageNames ? '' : 'google.ads.googleads.v15.resources'), createEmptyInstance: create)
...
class AccessibleBiddingStrategy_TargetCpa extends $pb.GeneratedMessage {
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(_omitMessageNames ? '' : 'AccessibleBiddingStrategy.TargetCpa', package: const $pb.PackageName(_omitMessageNames ? '' : 'google.ads.googleads.v15.resources'), createEmptyInstance: create)
...
class AccessibleBiddingStrategy_TargetImpressionShare extends $pb.GeneratedMessage {
  factory AccessibleBiddingStrategy_TargetImpressionShare({
    $1880.TargetImpressionShareLocationEnum_TargetImpressionShareLocation? location,
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(_omitMessageNames ? '' : 'AccessibleBiddingStrategy.TargetImpressionShare', package: const $pb.PackageName(_omitMessageNames ? '' : 'google.ads.googleads.v15.resources'), createEmptyInstance: create)
    ..e<$1880.TargetImpressionShareLocationEnum_TargetImpressionShareLocation>(1, _omitFieldNames ? '' : 'location', $pb.PbFieldType.OE, defaultOrMaker: $1880.TargetImpressionShareLocationEnum_TargetImpressionShareLocation.UNSPECIFIED, valueOf: $1880.TargetImpressionShareLocationEnum_TargetImpressionShareLocation.valueOf, enumValues: $1880.TargetImpressionShareLocationEnum_TargetImpressionShareLocation.values)
  ...
  @$pb.TagNumber(1)
  $1880.TargetImpressionShareLocationEnum_TargetImpressionShareLocation get location => $_getN(0);
  @$pb.TagNumber(1)
  set location($1880.TargetImpressionShareLocationEnum_TargetImpressionShareLocation v) { setField(1, v); }
  @$pb.TagNumber(1)
...
class AccessibleBiddingStrategy_TargetRoas extends $pb.GeneratedMessage {
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(_omitMessageNames ? '' : 'AccessibleBiddingStrategy.TargetRoas', package: const $pb.PackageName(_omitMessageNames ? '' : 'google.ads.googleads.v15.resources'), createEmptyInstance: create)
    ..a<$core.double>(1, _omitFieldNames ? '' : 'targetRoas', $pb.PbFieldType.OD)
    ..hasRequiredFields = false
  ;
...
class AccessibleBiddingStrategy_TargetSpend extends $pb.GeneratedMessage {
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(_omitMessageNames ? '' : 'AccessibleBiddingStrategy.TargetSpend', package: const $pb.PackageName(_omitMessageNames ? '' : 'google.ads.googleads.v15.resources'), createEmptyInstance: create)
...
class AccessibleBiddingStrategy extends $pb.GeneratedMessage {
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(_omitMessageNames ? '' : 'AccessibleBiddingStrategy', package: const $pb.PackageName(_omitMessageNames ? '' : 'google.ads.googleads.v15.resources'), createEmptyInstance: create)
    ..oo(0, [7, 8, 9, 10, 11, 12])
    ..aOS(1, _omitFieldNames ? '' : 'resourceName')
    ..aInt64(2, _omitFieldNames ? '' : 'id')
    ..aOS(3, _omitFieldNames ? '' : 'name')
    ..e<$2095.BiddingStrategyTypeEnum_BiddingStrategyType>(4, _omitFieldNames ? '' : 'type', $pb.PbFieldType.OE, defaultOrMaker: $2095.BiddingStrategyTypeEnum_BiddingStrategyType.UNSPECIFIED, valueOf: $2095.BiddingStrategyTypeEnum_BiddingStrategyType.valueOf, enumValues: $2095.BiddingStrategyTypeEnum_BiddingStrategyType.values)
  ...
  @$pb.TagNumber(4)
  $2095.BiddingStrategyTypeEnum_BiddingStrategyType get type => $_getN(3);
  @$pb.TagNumber(4)
  set type($2095.BiddingStrategyTypeEnum_BiddingStrategyType v) { setField(4, v); }
  @$pb.TagNumber(4)
