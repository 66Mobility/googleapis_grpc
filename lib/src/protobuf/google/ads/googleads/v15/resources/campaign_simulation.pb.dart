...
class CampaignSimulation extends $pb.GeneratedMessage {
  factory CampaignSimulation({
    ...
    $2129.TargetImpressionShareSimulationPointList? targetImpressionSharePointList,
    $2129.BudgetSimulationPointList? budgetPointList,
  }) {
    final $result = create();
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(_omitMessageNames ? '' : 'CampaignSimulation', package: const $pb.PackageName(_omitMessageNames ? '' : 'google.ads.googleads.v15.resources'), createEmptyInstance: create)
    ...
    ..aOM<$2129.CpcBidSimulationPointList>(7, _omitFieldNames ? '' : 'cpcBidPointList', subBuilder: $2129.CpcBidSimulationPointList.create)
    ..aOM<$2129.TargetCpaSimulationPointList>(8, _omitFieldNames ? '' : 'targetCpaPointList', subBuilder: $2129.TargetCpaSimulationPointList.create)
    ..aOM<$2129.TargetRoasSimulationPointList>(9, _omitFieldNames ? '' : 'targetRoasPointList', subBuilder: $2129.TargetRoasSimulationPointList.create)
    ..aOM<$2129.TargetImpressionShareSimulationPointList>(10, _omitFieldNames ? '' : 'targetImpressionSharePointList', subBuilder: $2129.TargetImpressionShareSimulationPointList.create)
    ..aOM<$2129.BudgetSimulationPointList>(11, _omitFieldNames ? '' : 'budgetPointList', subBuilder: $2129.BudgetSimulationPointList.create)
  ...
  @$pb.TagNumber(3)
  $2130.SimulationTypeEnum_SimulationType get type => $_getN(2);
  @$pb.TagNumber(3)
  ...
  @$pb.TagNumber(4)
  $2131.SimulationModificationMethodEnum_SimulationModificationMethod get modificationMethod => $_getN(3);
  @$pb.TagNumber(4)
  ...
  @$pb.TagNumber(7)
  $2129.CpcBidSimulationPointList get cpcBidPointList => $_getN(6);
  @$pb.TagNumber(7)
  set cpcBidPointList($2129.CpcBidSimulationPointList v) { setField(7, v); }
  @$pb.TagNumber(7)
  $core.bool hasCpcBidPointList() => $_has(6);
  @$pb.TagNumber(7)
  void clearCpcBidPointList() => clearField(7);
  @$pb.TagNumber(7)
  $2129.CpcBidSimulationPointList ensureCpcBidPointList() => $_ensure(6);

  /// Output only. Simulation points if the simulation type is TARGET_CPA.
  @$pb.TagNumber(8)
  $2129.TargetCpaSimulationPointList get targetCpaPointList => $_getN(7);
  @$pb.TagNumber(8)
  set targetCpaPointList($2129.TargetCpaSimulationPointList v) { setField(8, v); }
  @$pb.TagNumber(8)
  $core.bool hasTargetCpaPointList() => $_has(7);
  @$pb.TagNumber(8)
  void clearTargetCpaPointList() => clearField(8);
  @$pb.TagNumber(8)
  $2129.TargetCpaSimulationPointList ensureTargetCpaPointList() => $_ensure(7);

  /// Output only. Simulation points if the simulation type is TARGET_ROAS.
  @$pb.TagNumber(9)
  $2129.TargetRoasSimulationPointList get targetRoasPointList => $_getN(8);
  @$pb.TagNumber(9)
  set targetRoasPointList($2129.TargetRoasSimulationPointList v) { setField(9, v); }
  @$pb.TagNumber(9)
  $core.bool hasTargetRoasPointList() => $_has(8);
  @$pb.TagNumber(9)
  void clearTargetRoasPointList() => clearField(9);
  @$pb.TagNumber(9)
  $2129.TargetRoasSimulationPointList ensureTargetRoasPointList() => $_ensure(8);

  /// Output only. Simulation points if the simulation type is
  /// TARGET_IMPRESSION_SHARE.
  @$pb.TagNumber(10)
  $2129.TargetImpressionShareSimulationPointList get targetImpressionSharePointList => $_getN(9);
  @$pb.TagNumber(10)
  set targetImpressionSharePointList($2129.TargetImpressionShareSimulationPointList v) { setField(10, v); }
  @$pb.TagNumber(10)
  $core.bool hasTargetImpressionSharePointList() => $_has(9);
  @$pb.TagNumber(10)
  void clearTargetImpressionSharePointList() => clearField(10);
  @$pb.TagNumber(10)
  $2129.TargetImpressionShareSimulationPointList ensureTargetImpressionSharePointList() => $_ensure(9);

  /// Output only. Simulation points if the simulation type is BUDGET.
  @$pb.TagNumber(11)
  $2129.BudgetSimulationPointList get budgetPointList => $_getN(10);
  @$pb.TagNumber(11)
  set budgetPointList($2129.BudgetSimulationPointList v) { setField(11, v); }
  @$pb.TagNumber(11)
  $core.bool hasBudgetPointList() => $_has(10);
  @$pb.TagNumber(11)
  void clearBudgetPointList() => clearField(11);
  @$pb.TagNumber(11)
  $2129.BudgetSimulationPointList ensureBudgetPointList() => $_ensure(10);
}
