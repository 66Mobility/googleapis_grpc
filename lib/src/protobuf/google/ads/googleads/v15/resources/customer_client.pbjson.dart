...
const CustomerClient$json = {
  ...
  '2': [
    ...
    {'1': 'status', '3': 22, '4': 1, '5': 14, '6': '.google.ads.googleads.v15.enums.CustomerStatusEnum.CustomerStatus', '8': {}, '10': 'status'},
  ],
  '7': {},
  '8': [
    {'1': '_client_customer'},
...
final $typed_data.Uint8List customerClientDescriptor = $convert.base64Decode(
    ...
    'MuZ29vZ2xlYWRzLnYxNS5lbnVtcy5DdXN0b21lclN0YXR1c0VudW0uQ3VzdG9tZXJTdGF0dXNC'
