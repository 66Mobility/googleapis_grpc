...
const Customer$json = {
  ...
  '2': [
    ...
    {'1': 'call_reporting_setting', '3': 10, '4': 1, '5': 11, '6': '.google.ads.googleads.v15.resources.CallReportingSetting', '10': 'callReportingSetting'},
    {'1': 'conversion_tracking_setting', '3': 14, '4': 1, '5': 11, '6': '.google.ads.googleads.v15.resources.ConversionTrackingSetting', '8': {}, '10': 'conversionTrackingSetting'},
    {'1': 'remarketing_setting', '3': 15, '4': 1, '5': 11, '6': '.google.ads.googleads.v15.resources.RemarketingSetting', '8': {}, '10': 'remarketingSetting'},
    {'1': 'pay_per_conversion_eligibility_failure_reasons', '3': 16, '4': 3, '5': 14, '6': '.google.ads.googleads.v15.enums.CustomerPayPerConversionEligibilityFailureReasonEnum.CustomerPayPerConversionEligibilityFailureReason', '8': {}, '10': 'payPerConversionEligibilityFailureReasons'},
    ...
    {'1': 'status', '3': 36, '4': 1, '5': 14, '6': '.google.ads.googleads.v15.enums.CustomerStatusEnum.CustomerStatus', '8': {}, '10': 'status'},
    ...
    {'1': 'customer_agreement_setting', '3': 44, '4': 1, '5': 11, '6': '.google.ads.googleads.v15.resources.CustomerAgreementSetting', '8': {}, '10': 'customerAgreementSetting'},
    {'1': 'local_services_settings', '3': 45, '4': 1, '5': 11, '6': '.google.ads.googleads.v15.resources.LocalServicesSettings', '8': {}, '10': 'localServicesSettings'},
  ],
  '7': {},
  '8': [
    {'1': '_id'},
...
final $typed_data.Uint8List customerDescriptor = $convert.base64Decode(
    ...
    'cmVwb3J0aW5nX3NldHRpbmcYCiABKAsyOC5nb29nbGUuYWRzLmdvb2dsZWFkcy52MTUucmVzb3'
    ...
    'E1LnJlc291cmNlcy5Db252ZXJzaW9uVHJhY2tpbmdTZXR0aW5nQgPgQQNSGWNvbnZlcnNpb25U'
    'cmFja2luZ1NldHRpbmcSbAoTcmVtYXJrZXRpbmdfc2V0dGluZxgPIAEoCzI2Lmdvb2dsZS5hZH'
    'MuZ29vZ2xlYWRzLnYxNS5yZXNvdXJjZXMuUmVtYXJrZXRpbmdTZXR0aW5nQgPgQQNSEnJlbWFy'
    'a2V0aW5nU2V0dGluZxLuAQoucGF5X3Blcl9jb252ZXJzaW9uX2VsaWdpYmlsaXR5X2ZhaWx1cm'
    'VfcmVhc29ucxgQIAMoDjKFAS5nb29nbGUuYWRzLmdvb2dsZWFkcy52MTUuZW51bXMuQ3VzdG9t'
    ...
    'ABKA4yQS5nb29nbGUuYWRzLmdvb2dsZWFkcy52MTUuZW51bXMuQ3VzdG9tZXJTdGF0dXNFbnVt'
    ...
    'cy5nb29nbGVhZHMudjE1LnJlc291cmNlcy5DdXN0b21lckFncmVlbWVudFNldHRpbmdCA+BBA1'
    'IYY3VzdG9tZXJBZ3JlZW1lbnRTZXR0aW5nEnYKF2xvY2FsX3NlcnZpY2VzX3NldHRpbmdzGC0g'
    'ASgLMjkuZ29vZ2xlLmFkcy5nb29nbGVhZHMudjE1LnJlc291cmNlcy5Mb2NhbFNlcnZpY2VzU2'
    'V0dGluZ3NCA+BBA1IVbG9jYWxTZXJ2aWNlc1NldHRpbmdzOj/qQTwKIWdvb2dsZWFkcy5nb29n'
    'bGVhcGlzLmNvbS9DdXN0b21lchIXY3VzdG9tZXJzL3tjdXN0b21lcl9pZH1CBQoDX2lkQhMKEV'
    '9kZXNjcmlwdGl2ZV9uYW1lQhAKDl9jdXJyZW5jeV9jb2RlQgwKCl90aW1lX3pvbmVCGAoWX3Ry'
    'YWNraW5nX3VybF90ZW1wbGF0ZUITChFfZmluYWxfdXJsX3N1ZmZpeEIXChVfYXV0b190YWdnaW'
    '5nX2VuYWJsZWRCFQoTX2hhc19wYXJ0bmVyc19iYWRnZUIKCghfbWFuYWdlckIPCg1fdGVzdF9h'
    'Y2NvdW50QhUKE19vcHRpbWl6YXRpb25fc2NvcmVCJQojX2xvY2F0aW9uX2Fzc2V0X2F1dG9fbW'
    'lncmF0aW9uX2RvbmVCIgogX2ltYWdlX2Fzc2V0X2F1dG9fbWlncmF0aW9uX2RvbmVCLwotX2xv'
    'Y2F0aW9uX2Fzc2V0X2F1dG9fbWlncmF0aW9uX2RvbmVfZGF0ZV90aW1lQiwKKl9pbWFnZV9hc3'
    'NldF9hdXRvX21pZ3JhdGlvbl9kb25lX2RhdGVfdGltZQ==');
...
const ConversionTrackingSetting$json = {
  ...
  '2': [
    ...
    {'1': 'conversion_tracking_status', '3': 6, '4': 1, '5': 14, '6': '.google.ads.googleads.v15.enums.ConversionTrackingStatusEnum.ConversionTrackingStatus', '8': {}, '10': 'conversionTrackingStatus'},
...
final $typed_data.Uint8List conversionTrackingSettingDescriptor = $convert.base64Decode(
    ...
    'RhdHVzGAYgASgOMlUuZ29vZ2xlLmFkcy5nb29nbGVhZHMudjE1LmVudW1zLkNvbnZlcnNpb25U'
...
const LocalServicesSettings$json = {
  ...
  '2': [
    {'1': 'granular_license_statuses', '3': 1, '4': 3, '5': 11, '6': '.google.ads.googleads.v15.resources.GranularLicenseStatus', '8': {}, '10': 'granularLicenseStatuses'},
    {'1': 'granular_insurance_statuses', '3': 2, '4': 3, '5': 11, '6': '.google.ads.googleads.v15.resources.GranularInsuranceStatus', '8': {}, '10': 'granularInsuranceStatuses'},
  ],
};
...
final $typed_data.Uint8List localServicesSettingsDescriptor = $convert.base64Decode(
    ...
    'MoCzI5Lmdvb2dsZS5hZHMuZ29vZ2xlYWRzLnYxNS5yZXNvdXJjZXMuR3JhbnVsYXJMaWNlbnNl'
    'U3RhdHVzQgPgQQNSF2dyYW51bGFyTGljZW5zZVN0YXR1c2VzEoABChtncmFudWxhcl9pbnN1cm'
    'FuY2Vfc3RhdHVzZXMYAiADKAsyOy5nb29nbGUuYWRzLmdvb2dsZWFkcy52MTUucmVzb3VyY2Vz'
...
const GranularLicenseStatus$json = {
  ...
  '2': [
    ...
    {'1': 'verification_status', '3': 3, '4': 1, '5': 14, '6': '.google.ads.googleads.v15.enums.LocalServicesVerificationStatusEnum.LocalServicesVerificationStatus', '8': {}, '9': 2, '10': 'verificationStatus', '17': true},
  ],
  '8': [
    {'1': '_geo_criterion_id'},
    {'1': '_category_id'},
...
final $typed_data.Uint8List granularLicenseStatusDescriptor = $convert.base64Decode(
    ...
    'xlYWRzLnYxNS5lbnVtcy5Mb2NhbFNlcnZpY2VzVmVyaWZpY2F0aW9uU3RhdHVzRW51bS5Mb2Nh'
...
final $typed_data.Uint8List granularInsuranceStatusDescriptor = $convert.base64Decode(
    ...
    '9nbGVhZHMudjE1LmVudW1zLkxvY2FsU2VydmljZXNWZXJpZmljYXRpb25TdGF0dXNFbnVtLkxv'
