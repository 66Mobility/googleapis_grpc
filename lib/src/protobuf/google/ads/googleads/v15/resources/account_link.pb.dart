...
import '../enums/account_link_status.pbenum.dart' as $2102;
import '../enums/linked_account_type.pbenum.dart' as $2103;
...
class AccountLink extends $pb.GeneratedMessage {
  factory AccountLink({
    ...
    $2102.AccountLinkStatusEnum_AccountLinkStatus? status,
    $2103.LinkedAccountTypeEnum_LinkedAccountType? type,
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(_omitMessageNames ? '' : 'AccountLink', package: const $pb.PackageName(_omitMessageNames ? '' : 'google.ads.googleads.v15.resources'), createEmptyInstance: create)
    ...
    ..e<$2102.AccountLinkStatusEnum_AccountLinkStatus>(3, _omitFieldNames ? '' : 'status', $pb.PbFieldType.OE, defaultOrMaker: $2102.AccountLinkStatusEnum_AccountLinkStatus.UNSPECIFIED, valueOf: $2102.AccountLinkStatusEnum_AccountLinkStatus.valueOf, enumValues: $2102.AccountLinkStatusEnum_AccountLinkStatus.values)
    ..e<$2103.LinkedAccountTypeEnum_LinkedAccountType>(4, _omitFieldNames ? '' : 'type', $pb.PbFieldType.OE, defaultOrMaker: $2103.LinkedAccountTypeEnum_LinkedAccountType.UNSPECIFIED, valueOf: $2103.LinkedAccountTypeEnum_LinkedAccountType.valueOf, enumValues: $2103.LinkedAccountTypeEnum_LinkedAccountType.values)
  ...
  @$pb.TagNumber(3)
  $2102.AccountLinkStatusEnum_AccountLinkStatus get status => $_getN(1);
  @$pb.TagNumber(3)
  set status($2102.AccountLinkStatusEnum_AccountLinkStatus v) { setField(3, v); }
  @$pb.TagNumber(3)
  ...
  @$pb.TagNumber(4)
  $2103.LinkedAccountTypeEnum_LinkedAccountType get type => $_getN(2);
  @$pb.TagNumber(4)
  set type($2103.LinkedAccountTypeEnum_LinkedAccountType v) { setField(4, v); }
  @$pb.TagNumber(4)
...
class ThirdPartyAppAnalyticsLinkIdentifier extends $pb.GeneratedMessage {
  factory ThirdPartyAppAnalyticsLinkIdentifier({
    $1875.MobileAppVendorEnum_MobileAppVendor? appVendor,
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(_omitMessageNames ? '' : 'ThirdPartyAppAnalyticsLinkIdentifier', package: const $pb.PackageName(_omitMessageNames ? '' : 'google.ads.googleads.v15.resources'), createEmptyInstance: create)
    ..e<$1875.MobileAppVendorEnum_MobileAppVendor>(3, _omitFieldNames ? '' : 'appVendor', $pb.PbFieldType.OE, defaultOrMaker: $1875.MobileAppVendorEnum_MobileAppVendor.UNSPECIFIED, valueOf: $1875.MobileAppVendorEnum_MobileAppVendor.valueOf, enumValues: $1875.MobileAppVendorEnum_MobileAppVendor.values)
  ...
  /// the link.
  @$pb.TagNumber(3)
  $1875.MobileAppVendorEnum_MobileAppVendor get appVendor => $_getN(0);
  @$pb.TagNumber(3)
  set appVendor($1875.MobileAppVendorEnum_MobileAppVendor v) { setField(3, v); }
  @$pb.TagNumber(3)
