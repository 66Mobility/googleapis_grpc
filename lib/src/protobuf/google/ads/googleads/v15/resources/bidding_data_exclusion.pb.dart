...
class BiddingDataExclusion extends $pb.GeneratedMessage {
  ...
  /// campaign_ids is not supported.
  @$pb.TagNumber(11)
  $core.List<$1883.AdvertisingChannelTypeEnum_AdvertisingChannelType> get advertisingChannelTypes => $_getList(10);
}
