...
const AdTextAsset$json = {
  ...
  '2': [
    ...
    {'1': 'pinned_field', '3': 2, '4': 1, '5': 14, '6': '.google.ads.googleads.v15.enums.ServedAssetFieldTypeEnum.ServedAssetFieldType', '10': 'pinnedField'},
    {'1': 'asset_performance_label', '3': 5, '4': 1, '5': 14, '6': '.google.ads.googleads.v15.enums.AssetPerformanceLabelEnum.AssetPerformanceLabel', '10': 'assetPerformanceLabel'},
    {'1': 'policy_summary_info', '3': 6, '4': 1, '5': 11, '6': '.google.ads.googleads.v15.common.AdAssetPolicySummary', '10': 'policySummaryInfo'},
  ],
  '8': [
    {'1': '_text'},
  ],
...
final $typed_data.Uint8List adTextAssetDescriptor = $convert.base64Decode(
    ...
    'IgASgOMk0uZ29vZ2xlLmFkcy5nb29nbGVhZHMudjE1LmVudW1zLlNlcnZlZEFzc2V0RmllbGRU'
    'eXBlRW51bS5TZXJ2ZWRBc3NldEZpZWxkVHlwZVILcGlubmVkRmllbGQShwEKF2Fzc2V0X3Blcm'
    'Zvcm1hbmNlX2xhYmVsGAUgASgOMk8uZ29vZ2xlLmFkcy5nb29nbGVhZHMudjE1LmVudW1zLkFz'
    ...
    'Z29vZ2xlYWRzLnYxNS5jb21tb24uQWRBc3NldFBvbGljeVN1bW1hcnlSEXBvbGljeVN1bW1hcn'
    'lJbmZvQgcKBV90ZXh0');
