...
import '../enums/chain_relationship_type.pbenum.dart' as $1842;
import '../enums/location_ownership_type.pbenum.dart' as $1841;
import '../enums/location_string_filter_type.pbenum.dart' as $1843;
...
class ChainSet extends $pb.GeneratedMessage {
  factory ChainSet({
    $1842.ChainRelationshipTypeEnum_ChainRelationshipType? relationshipType,
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(_omitMessageNames ? '' : 'ChainSet', package: const $pb.PackageName(_omitMessageNames ? '' : 'google.ads.googleads.v15.common'), createEmptyInstance: create)
    ..e<$1842.ChainRelationshipTypeEnum_ChainRelationshipType>(1, _omitFieldNames ? '' : 'relationshipType', $pb.PbFieldType.OE, defaultOrMaker: $1842.ChainRelationshipTypeEnum_ChainRelationshipType.UNSPECIFIED, valueOf: $1842.ChainRelationshipTypeEnum_ChainRelationshipType.valueOf, enumValues: $1842.ChainRelationshipTypeEnum_ChainRelationshipType.values)
  ...
  /// advertiser.
  @$pb.TagNumber(1)
  $1842.ChainRelationshipTypeEnum_ChainRelationshipType get relationshipType => $_getN(0);
  @$pb.TagNumber(1)
  set relationshipType($1842.ChainRelationshipTypeEnum_ChainRelationshipType v) { setField(1, v); }
  @$pb.TagNumber(1)
...
class BusinessProfileBusinessNameFilter extends $pb.GeneratedMessage {
  factory BusinessProfileBusinessNameFilter({
    ...
    $1843.LocationStringFilterTypeEnum_LocationStringFilterType? filterType,
  }) {
    final $result = create();
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(_omitMessageNames ? '' : 'BusinessProfileBusinessNameFilter', package: const $pb.PackageName(_omitMessageNames ? '' : 'google.ads.googleads.v15.common'), createEmptyInstance: create)
    ...
    ..e<$1843.LocationStringFilterTypeEnum_LocationStringFilterType>(2, _omitFieldNames ? '' : 'filterType', $pb.PbFieldType.OE, defaultOrMaker: $1843.LocationStringFilterTypeEnum_LocationStringFilterType.UNSPECIFIED, valueOf: $1843.LocationStringFilterTypeEnum_LocationStringFilterType.valueOf, enumValues: $1843.LocationStringFilterTypeEnum_LocationStringFilterType.values)
    ..hasRequiredFields = false
  ;
  ...
  @$pb.TagNumber(2)
  $1843.LocationStringFilterTypeEnum_LocationStringFilterType get filterType => $_getN(1);
  @$pb.TagNumber(2)
  set filterType($1843.LocationStringFilterTypeEnum_LocationStringFilterType v) { setField(2, v); }
  @$pb.TagNumber(2)
