...
const KeywordPlanHistoricalMetrics$json = {
  ...
  '2': [
    ...
    {'1': 'monthly_search_volumes', '3': 6, '4': 3, '5': 11, '6': '.google.ads.googleads.v15.common.MonthlySearchVolume', '10': 'monthlySearchVolumes'},
    {'1': 'competition', '3': 2, '4': 1, '5': 14, '6': '.google.ads.googleads.v15.enums.KeywordPlanCompetitionLevelEnum.KeywordPlanCompetitionLevel', '10': 'competition'},
...
final $typed_data.Uint8List keywordPlanHistoricalMetricsDescriptor = $convert.base64Decode(
    ...
    'GAYgAygLMjQuZ29vZ2xlLmFkcy5nb29nbGVhZHMudjE1LmNvbW1vbi5Nb250aGx5U2VhcmNoVm'
    '9sdW1lUhRtb250aGx5U2VhcmNoVm9sdW1lcxJ9Cgtjb21wZXRpdGlvbhgCIAEoDjJbLmdvb2ds'
    'ZS5hZHMuZ29vZ2xlYWRzLnYxNS5lbnVtcy5LZXl3b3JkUGxhbkNvbXBldGl0aW9uTGV2ZWxFbn'
...
const HistoricalMetricsOptions$json = {
  ...
  '2': [
    {'1': 'year_month_range', '3': 1, '4': 1, '5': 11, '6': '.google.ads.googleads.v15.common.YearMonthRange', '9': 0, '10': 'yearMonthRange', '17': true},
...
final $typed_data.Uint8List historicalMetricsOptionsDescriptor = $convert.base64Decode(
    ...
    'dvb2dsZS5hZHMuZ29vZ2xlYWRzLnYxNS5jb21tb24uWWVhck1vbnRoUmFuZ2VIAFIOeWVhck1v'
...
const MonthlySearchVolume$json = {
  ...
  '2': [
    ...
    {'1': 'month', '3': 2, '4': 1, '5': 14, '6': '.google.ads.googleads.v15.enums.MonthOfYearEnum.MonthOfYear', '10': 'month'},
...
final $typed_data.Uint8List monthlySearchVolumeDescriptor = $convert.base64Decode(
    ...
    'gCIAEoDjI7Lmdvb2dsZS5hZHMuZ29vZ2xlYWRzLnYxNS5lbnVtcy5Nb250aE9mWWVhckVudW0u'
...
const KeywordPlanAggregateMetrics$json = {
  ...
  '2': [
    {'1': 'aggregate_metric_types', '3': 1, '4': 3, '5': 14, '6': '.google.ads.googleads.v15.enums.KeywordPlanAggregateMetricTypeEnum.KeywordPlanAggregateMetricType', '10': 'aggregateMetricTypes'},
  ],
};
...
final $typed_data.Uint8List keywordPlanAggregateMetricsDescriptor = $convert.base64Decode(
    ...
    'MYASADKA4yYS5nb29nbGUuYWRzLmdvb2dsZWFkcy52MTUuZW51bXMuS2V5d29yZFBsYW5BZ2dy'
...
const KeywordPlanAggregateMetricResults$json = {
  ...
  '2': [
    {'1': 'device_searches', '3': 1, '4': 3, '5': 11, '6': '.google.ads.googleads.v15.common.KeywordPlanDeviceSearches', '10': 'deviceSearches'},
  ],
};
...
final $typed_data.Uint8List keywordPlanAggregateMetricResultsDescriptor = $convert.base64Decode(
    ...
    'EgAygLMjouZ29vZ2xlLmFkcy5nb29nbGVhZHMudjE1LmNvbW1vbi5LZXl3b3JkUGxhbkRldmlj'
...
final $typed_data.Uint8List keywordPlanDeviceSearchesDescriptor = $convert.base64Decode(
    ...
    'MuZ29vZ2xlYWRzLnYxNS5lbnVtcy5EZXZpY2VFbnVtLkRldmljZVIGZGV2aWNlEiYKDHNlYXJj'
...
const KeywordAnnotations$json = {
  ...
  '2': [
    {'1': 'concepts', '3': 1, '4': 3, '5': 11, '6': '.google.ads.googleads.v15.common.KeywordConcept', '10': 'concepts'},
  ],
};
...
final $typed_data.Uint8List keywordAnnotationsDescriptor = $convert.base64Decode(
    ...
    'dsZWFkcy52MTUuY29tbW9uLktleXdvcmRDb25jZXB0Ughjb25jZXB0cw==');
...
const KeywordConcept$json = {
  ...
  '2': [
    ...
    {'1': 'concept_group', '3': 2, '4': 1, '5': 11, '6': '.google.ads.googleads.v15.common.ConceptGroup', '10': 'conceptGroup'},
  ],
};
...
final $typed_data.Uint8List keywordConceptDescriptor = $convert.base64Decode(
    ...
    'ABKAsyLS5nb29nbGUuYWRzLmdvb2dsZWFkcy52MTUuY29tbW9uLkNvbmNlcHRHcm91cFIMY29u'
    'Y2VwdEdyb3Vw');
...
const ConceptGroup$json = {
  ...
  '2': [
    {'1': 'name', '3': 1, '4': 1, '5': 9, '10': 'name'},
    {'1': 'type', '3': 2, '4': 1, '5': 14, '6': '.google.ads.googleads.v15.enums.KeywordPlanConceptGroupTypeEnum.KeywordPlanConceptGroupType', '10': 'type'},
  ],
};
...
final $typed_data.Uint8List conceptGroupDescriptor = $convert.base64Decode(
    ...
    'xlLmFkcy5nb29nbGVhZHMudjE1LmVudW1zLktleXdvcmRQbGFuQ29uY2VwdEdyb3VwVHlwZUVu'
