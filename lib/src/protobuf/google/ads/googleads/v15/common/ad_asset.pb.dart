...
import 'asset_policy.pb.dart' as $1830;
...
class AdTextAsset extends $pb.GeneratedMessage {
  factory AdTextAsset({
    ...
    $core.String? text,
    $1832.AssetPerformanceLabelEnum_AssetPerformanceLabel? assetPerformanceLabel,
    $1830.AdAssetPolicySummary? policySummaryInfo,
  }) {
    final $result = create();
    if (pinnedField != null) {
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(_omitMessageNames ? '' : 'AdTextAsset', package: const $pb.PackageName(_omitMessageNames ? '' : 'google.ads.googleads.v15.common'), createEmptyInstance: create)
    ..e<$1831.ServedAssetFieldTypeEnum_ServedAssetFieldType>(2, _omitFieldNames ? '' : 'pinnedField', $pb.PbFieldType.OE, defaultOrMaker: $1831.ServedAssetFieldTypeEnum_ServedAssetFieldType.UNSPECIFIED, valueOf: $1831.ServedAssetFieldTypeEnum_ServedAssetFieldType.valueOf, enumValues: $1831.ServedAssetFieldTypeEnum_ServedAssetFieldType.values)
    ..aOS(4, _omitFieldNames ? '' : 'text')
    ..e<$1832.AssetPerformanceLabelEnum_AssetPerformanceLabel>(5, _omitFieldNames ? '' : 'assetPerformanceLabel', $pb.PbFieldType.OE, defaultOrMaker: $1832.AssetPerformanceLabelEnum_AssetPerformanceLabel.UNSPECIFIED, valueOf: $1832.AssetPerformanceLabelEnum_AssetPerformanceLabel.valueOf, enumValues: $1832.AssetPerformanceLabelEnum_AssetPerformanceLabel.values)
    ..aOM<$1830.AdAssetPolicySummary>(6, _omitFieldNames ? '' : 'policySummaryInfo', subBuilder: $1830.AdAssetPolicySummary.create)
  ...
  @$pb.TagNumber(2)
  $1831.ServedAssetFieldTypeEnum_ServedAssetFieldType get pinnedField => $_getN(0);
  @$pb.TagNumber(2)
  set pinnedField($1831.ServedAssetFieldTypeEnum_ServedAssetFieldType v) { setField(2, v); }
  @$pb.TagNumber(2)
  ...
  @$pb.TagNumber(5)
  $1832.AssetPerformanceLabelEnum_AssetPerformanceLabel get assetPerformanceLabel => $_getN(2);
  @$pb.TagNumber(5)
  set assetPerformanceLabel($1832.AssetPerformanceLabelEnum_AssetPerformanceLabel v) { setField(5, v); }
  @$pb.TagNumber(5)
  ...
  @$pb.TagNumber(6)
  $1830.AdAssetPolicySummary get policySummaryInfo => $_getN(3);
  @$pb.TagNumber(6)
  set policySummaryInfo($1830.AdAssetPolicySummary v) { setField(6, v); }
  @$pb.TagNumber(6)
  $core.bool hasPolicySummaryInfo() => $_has(3);
  @$pb.TagNumber(6)
  void clearPolicySummaryInfo() => clearField(6);
  @$pb.TagNumber(6)
  $1830.AdAssetPolicySummary ensurePolicySummaryInfo() => $_ensure(3);
}
