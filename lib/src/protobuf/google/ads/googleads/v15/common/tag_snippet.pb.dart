...
import '../enums/tracking_code_page_format.pbenum.dart' as $1932;
import '../enums/tracking_code_type.pbenum.dart' as $1931;

/// The site tag and event snippet pair for a TrackingCodeType.
class TagSnippet extends $pb.GeneratedMessage {
  factory TagSnippet({
    $1931.TrackingCodeTypeEnum_TrackingCodeType? type,
    $1932.TrackingCodePageFormatEnum_TrackingCodePageFormat? pageFormat,
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(_omitMessageNames ? '' : 'TagSnippet', package: const $pb.PackageName(_omitMessageNames ? '' : 'google.ads.googleads.v15.common'), createEmptyInstance: create)
    ..e<$1931.TrackingCodeTypeEnum_TrackingCodeType>(1, _omitFieldNames ? '' : 'type', $pb.PbFieldType.OE, defaultOrMaker: $1931.TrackingCodeTypeEnum_TrackingCodeType.UNSPECIFIED, valueOf: $1931.TrackingCodeTypeEnum_TrackingCodeType.valueOf, enumValues: $1931.TrackingCodeTypeEnum_TrackingCodeType.values)
    ..e<$1932.TrackingCodePageFormatEnum_TrackingCodePageFormat>(2, _omitFieldNames ? '' : 'pageFormat', $pb.PbFieldType.OE, defaultOrMaker: $1932.TrackingCodePageFormatEnum_TrackingCodePageFormat.UNSPECIFIED, valueOf: $1932.TrackingCodePageFormatEnum_TrackingCodePageFormat.valueOf, enumValues: $1932.TrackingCodePageFormatEnum_TrackingCodePageFormat.values)
  ...
  @$pb.TagNumber(1)
  $1931.TrackingCodeTypeEnum_TrackingCodeType get type => $_getN(0);
  @$pb.TagNumber(1)
  set type($1931.TrackingCodeTypeEnum_TrackingCodeType v) { setField(1, v); }
  @$pb.TagNumber(1)
  ...
  @$pb.TagNumber(2)
  $1932.TrackingCodePageFormatEnum_TrackingCodePageFormat get pageFormat => $_getN(1);
  @$pb.TagNumber(2)
  set pageFormat($1932.TrackingCodePageFormatEnum_TrackingCodePageFormat v) { setField(2, v); }
  @$pb.TagNumber(2)
