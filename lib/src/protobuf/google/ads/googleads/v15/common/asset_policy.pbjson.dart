...
const AdAssetPolicySummary$json = {
  ...
  '2': [
    ...
    {'1': 'review_status', '3': 2, '4': 1, '5': 14, '6': '.google.ads.googleads.v15.enums.PolicyReviewStatusEnum.PolicyReviewStatus', '10': 'reviewStatus'},
    {'1': 'approval_status', '3': 3, '4': 1, '5': 14, '6': '.google.ads.googleads.v15.enums.PolicyApprovalStatusEnum.PolicyApprovalStatus', '10': 'approvalStatus'},
  ],
};
...
final $typed_data.Uint8List adAssetPolicySummaryDescriptor = $convert.base64Decode(
    ...
    'Fkcy52MTUuZW51bXMuUG9saWN5UmV2aWV3U3RhdHVzRW51bS5Qb2xpY3lSZXZpZXdTdGF0dXNS'
    'DHJldmlld1N0YXR1cxJ2Cg9hcHByb3ZhbF9zdGF0dXMYAyABKA4yTS5nb29nbGUuYWRzLmdvb2'
    'dsZWFkcy52MTUuZW51bXMuUG9saWN5QXBwcm92YWxTdGF0dXNFbnVtLlBvbGljeUFwcHJvdmFs'
...
const AssetLinkPrimaryStatusDetails$json = {
  ...
  '2': [
    {'1': 'reason', '3': 1, '4': 1, '5': 14, '6': '.google.ads.googleads.v15.enums.AssetLinkPrimaryStatusReasonEnum.AssetLinkPrimaryStatusReason', '9': 1, '10': 'reason', '17': true},
    {'1': 'status', '3': 2, '4': 1, '5': 14, '6': '.google.ads.googleads.v15.enums.AssetLinkPrimaryStatusEnum.AssetLinkPrimaryStatus', '9': 2, '10': 'status', '17': true},
    {'1': 'asset_disapproved', '3': 3, '4': 1, '5': 11, '6': '.google.ads.googleads.v15.common.AssetDisapproved', '9': 0, '10': 'assetDisapproved'},
  ],
  '8': [
    {'1': 'details'},
    {'1': '_reason'},
...
final $typed_data.Uint8List assetLinkPrimaryStatusDetailsDescriptor = $convert.base64Decode(
    ...
    'UuYWRzLmdvb2dsZWFkcy52MTUuZW51bXMuQXNzZXRMaW5rUHJpbWFyeVN0YXR1c1JlYXNvbkVu'
    'dW0uQXNzZXRMaW5rUHJpbWFyeVN0YXR1c1JlYXNvbkgBUgZyZWFzb26IAQESbgoGc3RhdHVzGA'
    'IgASgOMlEuZ29vZ2xlLmFkcy5nb29nbGVhZHMudjE1LmVudW1zLkFzc2V0TGlua1ByaW1hcnlT'
    'dGF0dXNFbnVtLkFzc2V0TGlua1ByaW1hcnlTdGF0dXNIAlIGc3RhdHVziAEBEmAKEWFzc2V0X2'
    'Rpc2FwcHJvdmVkGAMgASgLMjEuZ29vZ2xlLmFkcy5nb29nbGVhZHMudjE1LmNvbW1vbi5Bc3Nl'
...
const AssetDisapproved$json = {
  '1': 'AssetDisapproved',
  '2': [
    {'1': 'offline_evaluation_error_reasons', '3': 1, '4': 3, '5': 14, '6': '.google.ads.googleads.v15.enums.AssetOfflineEvaluationErrorReasonsEnum.AssetOfflineEvaluationErrorReasons', '10': 'offlineEvaluationErrorReasons'},
  ],
};
...
final $typed_data.Uint8List assetDisapprovedDescriptor = $convert.base64Decode(
    ...
    'gBIAMoDjJpLmdvb2dsZS5hZHMuZ29vZ2xlYWRzLnYxNS5lbnVtcy5Bc3NldE9mZmxpbmVFdmFs'
