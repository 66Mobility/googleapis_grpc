...
import '../enums/customer_match_upload_key_type.pbenum.dart' as $1934;
import '../enums/lookalike_expansion_level.pbenum.dart' as $1933;
import '../enums/user_list_crm_data_source_type.pbenum.dart' as $1935;
import '../enums/user_list_date_rule_item_operator.pbenum.dart' as $1937;
import '../enums/user_list_flexible_rule_operator.pbenum.dart' as $1940;
import '../enums/user_list_logical_rule_operator.pbenum.dart' as $1942;
import '../enums/user_list_number_rule_item_operator.pbenum.dart' as $1938;
import '../enums/user_list_prepopulation_status.pbenum.dart' as $1941;
import '../enums/user_list_rule_type.pbenum.dart' as $1936;
import '../enums/user_list_string_rule_item_operator.pbenum.dart' as $1939;
...
class LookalikeUserListInfo extends $pb.GeneratedMessage {
  factory LookalikeUserListInfo({
    ...
    $1933.LookalikeExpansionLevelEnum_LookalikeExpansionLevel? expansionLevel,
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(_omitMessageNames ? '' : 'LookalikeUserListInfo', package: const $pb.PackageName(_omitMessageNames ? '' : 'google.ads.googleads.v15.common'), createEmptyInstance: create)
    ..p<$fixnum.Int64>(1, _omitFieldNames ? '' : 'seedUserListIds', $pb.PbFieldType.K6)
    ..e<$1933.LookalikeExpansionLevelEnum_LookalikeExpansionLevel>(2, _omitFieldNames ? '' : 'expansionLevel', $pb.PbFieldType.OE, defaultOrMaker: $1933.LookalikeExpansionLevelEnum_LookalikeExpansionLevel.UNSPECIFIED, valueOf: $1933.LookalikeExpansionLevelEnum_LookalikeExpansionLevel.valueOf, enumValues: $1933.LookalikeExpansionLevelEnum_LookalikeExpansionLevel.values)
  ...
  @$pb.TagNumber(2)
  $1933.LookalikeExpansionLevelEnum_LookalikeExpansionLevel get expansionLevel => $_getN(1);
  @$pb.TagNumber(2)
  set expansionLevel($1933.LookalikeExpansionLevelEnum_LookalikeExpansionLevel v) { setField(2, v); }
  @$pb.TagNumber(2)
...
class SimilarUserListInfo extends $pb.GeneratedMessage {
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(_omitMessageNames ? '' : 'SimilarUserListInfo', package: const $pb.PackageName(_omitMessageNames ? '' : 'google.ads.googleads.v15.common'), createEmptyInstance: create)
...
class CrmBasedUserListInfo extends $pb.GeneratedMessage {
  factory CrmBasedUserListInfo({
    $1934.CustomerMatchUploadKeyTypeEnum_CustomerMatchUploadKeyType? uploadKeyType,
    $1935.UserListCrmDataSourceTypeEnum_UserListCrmDataSourceType? dataSourceType,
    $core.String? appId,
  }) {
    final $result = create();
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(_omitMessageNames ? '' : 'CrmBasedUserListInfo', package: const $pb.PackageName(_omitMessageNames ? '' : 'google.ads.googleads.v15.common'), createEmptyInstance: create)
    ..e<$1934.CustomerMatchUploadKeyTypeEnum_CustomerMatchUploadKeyType>(2, _omitFieldNames ? '' : 'uploadKeyType', $pb.PbFieldType.OE, defaultOrMaker: $1934.CustomerMatchUploadKeyTypeEnum_CustomerMatchUploadKeyType.UNSPECIFIED, valueOf: $1934.CustomerMatchUploadKeyTypeEnum_CustomerMatchUploadKeyType.valueOf, enumValues: $1934.CustomerMatchUploadKeyTypeEnum_CustomerMatchUploadKeyType.values)
    ..e<$1935.UserListCrmDataSourceTypeEnum_UserListCrmDataSourceType>(3, _omitFieldNames ? '' : 'dataSourceType', $pb.PbFieldType.OE, defaultOrMaker: $1935.UserListCrmDataSourceTypeEnum_UserListCrmDataSourceType.UNSPECIFIED, valueOf: $1935.UserListCrmDataSourceTypeEnum_UserListCrmDataSourceType.valueOf, enumValues: $1935.UserListCrmDataSourceTypeEnum_UserListCrmDataSourceType.values)
  ...
  @$pb.TagNumber(2)
  $1934.CustomerMatchUploadKeyTypeEnum_CustomerMatchUploadKeyType get uploadKeyType => $_getN(0);
  @$pb.TagNumber(2)
  set uploadKeyType($1934.CustomerMatchUploadKeyTypeEnum_CustomerMatchUploadKeyType v) { setField(2, v); }
  @$pb.TagNumber(2)
  ...
  @$pb.TagNumber(3)
  $1935.UserListCrmDataSourceTypeEnum_UserListCrmDataSourceType get dataSourceType => $_getN(1);
  @$pb.TagNumber(3)
  set dataSourceType($1935.UserListCrmDataSourceTypeEnum_UserListCrmDataSourceType v) { setField(3, v); }
  @$pb.TagNumber(3)
...
class UserListRuleInfo extends $pb.GeneratedMessage {
  factory UserListRuleInfo({
    $1936.UserListRuleTypeEnum_UserListRuleType? ruleType,
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(_omitMessageNames ? '' : 'UserListRuleInfo', package: const $pb.PackageName(_omitMessageNames ? '' : 'google.ads.googleads.v15.common'), createEmptyInstance: create)
    ..e<$1936.UserListRuleTypeEnum_UserListRuleType>(1, _omitFieldNames ? '' : 'ruleType', $pb.PbFieldType.OE, defaultOrMaker: $1936.UserListRuleTypeEnum_UserListRuleType.UNSPECIFIED, valueOf: $1936.UserListRuleTypeEnum_UserListRuleType.valueOf, enumValues: $1936.UserListRuleTypeEnum_UserListRuleType.values)
  ...
  @$pb.TagNumber(1)
  $1936.UserListRuleTypeEnum_UserListRuleType get ruleType => $_getN(0);
  @$pb.TagNumber(1)
  set ruleType($1936.UserListRuleTypeEnum_UserListRuleType v) { setField(1, v); }
  @$pb.TagNumber(1)
...
class UserListRuleItemGroupInfo extends $pb.GeneratedMessage {
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(_omitMessageNames ? '' : 'UserListRuleItemGroupInfo', package: const $pb.PackageName(_omitMessageNames ? '' : 'google.ads.googleads.v15.common'), createEmptyInstance: create)
...
class UserListRuleItemInfo extends $pb.GeneratedMessage {
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(_omitMessageNames ? '' : 'UserListRuleItemInfo', package: const $pb.PackageName(_omitMessageNames ? '' : 'google.ads.googleads.v15.common'), createEmptyInstance: create)
    ..oo(0, [2, 3, 4])
...
class UserListDateRuleItemInfo extends $pb.GeneratedMessage {
  factory UserListDateRuleItemInfo({
    $1937.UserListDateRuleItemOperatorEnum_UserListDateRuleItemOperator? operator,
    $core.String? value,
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(_omitMessageNames ? '' : 'UserListDateRuleItemInfo', package: const $pb.PackageName(_omitMessageNames ? '' : 'google.ads.googleads.v15.common'), createEmptyInstance: create)
    ..e<$1937.UserListDateRuleItemOperatorEnum_UserListDateRuleItemOperator>(1, _omitFieldNames ? '' : 'operator', $pb.PbFieldType.OE, defaultOrMaker: $1937.UserListDateRuleItemOperatorEnum_UserListDateRuleItemOperator.UNSPECIFIED, valueOf: $1937.UserListDateRuleItemOperatorEnum_UserListDateRuleItemOperator.valueOf, enumValues: $1937.UserListDateRuleItemOperatorEnum_UserListDateRuleItemOperator.values)
  ...
  /// rule item.
  @$pb.TagNumber(1)
  $1937.UserListDateRuleItemOperatorEnum_UserListDateRuleItemOperator get operator => $_getN(0);
  @$pb.TagNumber(1)
  set operator($1937.UserListDateRuleItemOperatorEnum_UserListDateRuleItemOperator v) { setField(1, v); }
  @$pb.TagNumber(1)
...
class UserListNumberRuleItemInfo extends $pb.GeneratedMessage {
  factory UserListNumberRuleItemInfo({
    $1938.UserListNumberRuleItemOperatorEnum_UserListNumberRuleItemOperator? operator,
    $core.double? value,
  }) {
    final $result = create();
    if (operator != null) {
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(_omitMessageNames ? '' : 'UserListNumberRuleItemInfo', package: const $pb.PackageName(_omitMessageNames ? '' : 'google.ads.googleads.v15.common'), createEmptyInstance: create)
    ..e<$1938.UserListNumberRuleItemOperatorEnum_UserListNumberRuleItemOperator>(1, _omitFieldNames ? '' : 'operator', $pb.PbFieldType.OE, defaultOrMaker: $1938.UserListNumberRuleItemOperatorEnum_UserListNumberRuleItemOperator.UNSPECIFIED, valueOf: $1938.UserListNumberRuleItemOperatorEnum_UserListNumberRuleItemOperator.valueOf, enumValues: $1938.UserListNumberRuleItemOperatorEnum_UserListNumberRuleItemOperator.values)
  ...
  /// rule item.
  @$pb.TagNumber(1)
  $1938.UserListNumberRuleItemOperatorEnum_UserListNumberRuleItemOperator get operator => $_getN(0);
  @$pb.TagNumber(1)
  set operator($1938.UserListNumberRuleItemOperatorEnum_UserListNumberRuleItemOperator v) { setField(1, v); }
  @$pb.TagNumber(1)
  $core.bool hasOperator() => $_has(0);
  @$pb.TagNumber(1)
  void clearOperator() => clearField(1);
...
class UserListStringRuleItemInfo extends $pb.GeneratedMessage {
  factory UserListStringRuleItemInfo({
    $1939.UserListStringRuleItemOperatorEnum_UserListStringRuleItemOperator? operator,
    $core.String? value,
  }) {
    final $result = create();
    if (operator != null) {
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(_omitMessageNames ? '' : 'UserListStringRuleItemInfo', package: const $pb.PackageName(_omitMessageNames ? '' : 'google.ads.googleads.v15.common'), createEmptyInstance: create)
    ..e<$1939.UserListStringRuleItemOperatorEnum_UserListStringRuleItemOperator>(1, _omitFieldNames ? '' : 'operator', $pb.PbFieldType.OE, defaultOrMaker: $1939.UserListStringRuleItemOperatorEnum_UserListStringRuleItemOperator.UNSPECIFIED, valueOf: $1939.UserListStringRuleItemOperatorEnum_UserListStringRuleItemOperator.valueOf, enumValues: $1939.UserListStringRuleItemOperatorEnum_UserListStringRuleItemOperator.values)
  ...
  /// rule item.
  @$pb.TagNumber(1)
  $1939.UserListStringRuleItemOperatorEnum_UserListStringRuleItemOperator get operator => $_getN(0);
  @$pb.TagNumber(1)
  set operator($1939.UserListStringRuleItemOperatorEnum_UserListStringRuleItemOperator v) { setField(1, v); }
  @$pb.TagNumber(1)
  $core.bool hasOperator() => $_has(0);
  @$pb.TagNumber(1)
  void clearOperator() => clearField(1);
...
class FlexibleRuleOperandInfo extends $pb.GeneratedMessage {
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(_omitMessageNames ? '' : 'FlexibleRuleOperandInfo', package: const $pb.PackageName(_omitMessageNames ? '' : 'google.ads.googleads.v15.common'), createEmptyInstance: create)
...
class FlexibleRuleUserListInfo extends $pb.GeneratedMessage {
  factory FlexibleRuleUserListInfo({
    $1940.UserListFlexibleRuleOperatorEnum_UserListFlexibleRuleOperator? inclusiveRuleOperator,
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(_omitMessageNames ? '' : 'FlexibleRuleUserListInfo', package: const $pb.PackageName(_omitMessageNames ? '' : 'google.ads.googleads.v15.common'), createEmptyInstance: create)
    ..e<$1940.UserListFlexibleRuleOperatorEnum_UserListFlexibleRuleOperator>(1, _omitFieldNames ? '' : 'inclusiveRuleOperator', $pb.PbFieldType.OE, defaultOrMaker: $1940.UserListFlexibleRuleOperatorEnum_UserListFlexibleRuleOperator.UNSPECIFIED, valueOf: $1940.UserListFlexibleRuleOperatorEnum_UserListFlexibleRuleOperator.valueOf, enumValues: $1940.UserListFlexibleRuleOperatorEnum_UserListFlexibleRuleOperator.values)
  ...
  @$pb.TagNumber(1)
  $1940.UserListFlexibleRuleOperatorEnum_UserListFlexibleRuleOperator get inclusiveRuleOperator => $_getN(0);
  @$pb.TagNumber(1)
  set inclusiveRuleOperator($1940.UserListFlexibleRuleOperatorEnum_UserListFlexibleRuleOperator v) { setField(1, v); }
  @$pb.TagNumber(1)
...
class RuleBasedUserListInfo extends $pb.GeneratedMessage {
  factory RuleBasedUserListInfo({
    $1941.UserListPrepopulationStatusEnum_UserListPrepopulationStatus? prepopulationStatus,
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(_omitMessageNames ? '' : 'RuleBasedUserListInfo', package: const $pb.PackageName(_omitMessageNames ? '' : 'google.ads.googleads.v15.common'), createEmptyInstance: create)
    ..e<$1941.UserListPrepopulationStatusEnum_UserListPrepopulationStatus>(1, _omitFieldNames ? '' : 'prepopulationStatus', $pb.PbFieldType.OE, defaultOrMaker: $1941.UserListPrepopulationStatusEnum_UserListPrepopulationStatus.UNSPECIFIED, valueOf: $1941.UserListPrepopulationStatusEnum_UserListPrepopulationStatus.valueOf, enumValues: $1941.UserListPrepopulationStatusEnum_UserListPrepopulationStatus.values)
  ...
  @$pb.TagNumber(1)
  $1941.UserListPrepopulationStatusEnum_UserListPrepopulationStatus get prepopulationStatus => $_getN(0);
  @$pb.TagNumber(1)
  set prepopulationStatus($1941.UserListPrepopulationStatusEnum_UserListPrepopulationStatus v) { setField(1, v); }
  @$pb.TagNumber(1)
...
class LogicalUserListInfo extends $pb.GeneratedMessage {
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(_omitMessageNames ? '' : 'LogicalUserListInfo', package: const $pb.PackageName(_omitMessageNames ? '' : 'google.ads.googleads.v15.common'), createEmptyInstance: create)
...
class UserListLogicalRuleInfo extends $pb.GeneratedMessage {
  factory UserListLogicalRuleInfo({
    $1942.UserListLogicalRuleOperatorEnum_UserListLogicalRuleOperator? operator,
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(_omitMessageNames ? '' : 'UserListLogicalRuleInfo', package: const $pb.PackageName(_omitMessageNames ? '' : 'google.ads.googleads.v15.common'), createEmptyInstance: create)
    ..e<$1942.UserListLogicalRuleOperatorEnum_UserListLogicalRuleOperator>(1, _omitFieldNames ? '' : 'operator', $pb.PbFieldType.OE, defaultOrMaker: $1942.UserListLogicalRuleOperatorEnum_UserListLogicalRuleOperator.UNSPECIFIED, valueOf: $1942.UserListLogicalRuleOperatorEnum_UserListLogicalRuleOperator.valueOf, enumValues: $1942.UserListLogicalRuleOperatorEnum_UserListLogicalRuleOperator.values)
  ...
  @$pb.TagNumber(1)
  $1942.UserListLogicalRuleOperatorEnum_UserListLogicalRuleOperator get operator => $_getN(0);
  @$pb.TagNumber(1)
  set operator($1942.UserListLogicalRuleOperatorEnum_UserListLogicalRuleOperator v) { setField(1, v); }
  @$pb.TagNumber(1)
  $core.bool hasOperator() => $_has(0);
  @$pb.TagNumber(1)
  void clearOperator() => clearField(1);
...
class LogicalUserListOperandInfo extends $pb.GeneratedMessage {
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(_omitMessageNames ? '' : 'LogicalUserListOperandInfo', package: const $pb.PackageName(_omitMessageNames ? '' : 'google.ads.googleads.v15.common'), createEmptyInstance: create)
...
class BasicUserListInfo extends $pb.GeneratedMessage {
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(_omitMessageNames ? '' : 'BasicUserListInfo', package: const $pb.PackageName(_omitMessageNames ? '' : 'google.ads.googleads.v15.common'), createEmptyInstance: create)
...
class UserListActionInfo extends $pb.GeneratedMessage {
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(_omitMessageNames ? '' : 'UserListActionInfo', package: const $pb.PackageName(_omitMessageNames ? '' : 'google.ads.googleads.v15.common'), createEmptyInstance: create)
    ..oo(0, [3, 4])
