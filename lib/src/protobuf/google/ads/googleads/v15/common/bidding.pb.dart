...
class TargetCpmTargetFrequencyGoal extends $pb.GeneratedMessage {
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(_omitMessageNames ? '' : 'TargetCpmTargetFrequencyGoal', package: const $pb.PackageName(_omitMessageNames ? '' : 'google.ads.googleads.v15.common'), createEmptyInstance: create)
    ...
    ..e<$1879.TargetFrequencyTimeUnitEnum_TargetFrequencyTimeUnit>(2, _omitFieldNames ? '' : 'timeUnit', $pb.PbFieldType.OE, defaultOrMaker: $1879.TargetFrequencyTimeUnitEnum_TargetFrequencyTimeUnit.UNSPECIFIED, valueOf: $1879.TargetFrequencyTimeUnitEnum_TargetFrequencyTimeUnit.valueOf, enumValues: $1879.TargetFrequencyTimeUnitEnum_TargetFrequencyTimeUnit.values)
    ..hasRequiredFields = false
  ;
  ...
  @$pb.TagNumber(2)
  $1879.TargetFrequencyTimeUnitEnum_TargetFrequencyTimeUnit get timeUnit => $_getN(1);
  @$pb.TagNumber(2)
  set timeUnit($1879.TargetFrequencyTimeUnitEnum_TargetFrequencyTimeUnit v) { setField(2, v); }
  @$pb.TagNumber(2)
