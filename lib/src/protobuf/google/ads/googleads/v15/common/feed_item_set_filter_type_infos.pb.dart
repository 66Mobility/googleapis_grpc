...
import '../enums/feed_item_set_string_filter_type.pbenum.dart' as $1890;
...
class BusinessNameFilter extends $pb.GeneratedMessage {
  factory BusinessNameFilter({
    ...
    $1890.FeedItemSetStringFilterTypeEnum_FeedItemSetStringFilterType? filterType,
  }) {
    final $result = create();
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(_omitMessageNames ? '' : 'BusinessNameFilter', package: const $pb.PackageName(_omitMessageNames ? '' : 'google.ads.googleads.v15.common'), createEmptyInstance: create)
    ...
    ..e<$1890.FeedItemSetStringFilterTypeEnum_FeedItemSetStringFilterType>(2, _omitFieldNames ? '' : 'filterType', $pb.PbFieldType.OE, defaultOrMaker: $1890.FeedItemSetStringFilterTypeEnum_FeedItemSetStringFilterType.UNSPECIFIED, valueOf: $1890.FeedItemSetStringFilterTypeEnum_FeedItemSetStringFilterType.valueOf, enumValues: $1890.FeedItemSetStringFilterTypeEnum_FeedItemSetStringFilterType.values)
    ..hasRequiredFields = false
  ;
  ...
  @$pb.TagNumber(2)
  $1890.FeedItemSetStringFilterTypeEnum_FeedItemSetStringFilterType get filterType => $_getN(1);
  @$pb.TagNumber(2)
  set filterType($1890.FeedItemSetStringFilterTypeEnum_FeedItemSetStringFilterType v) { setField(2, v); }
  @$pb.TagNumber(2)
