...
import '../enums/keyword_plan_aggregate_metric_type.pbenum.dart' as $1898;
import '../enums/keyword_plan_competition_level.pbenum.dart' as $1897;
import '../enums/keyword_plan_concept_group_type.pbenum.dart' as $1899;
import '../enums/month_of_year.pbenum.dart' as $1888;
import 'dates.pb.dart' as $1896;
...
class KeywordPlanHistoricalMetrics extends $pb.GeneratedMessage {
  factory KeywordPlanHistoricalMetrics({
    $1897.KeywordPlanCompetitionLevelEnum_KeywordPlanCompetitionLevel? competition,
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(_omitMessageNames ? '' : 'KeywordPlanHistoricalMetrics', package: const $pb.PackageName(_omitMessageNames ? '' : 'google.ads.googleads.v15.common'), createEmptyInstance: create)
    ..e<$1897.KeywordPlanCompetitionLevelEnum_KeywordPlanCompetitionLevel>(2, _omitFieldNames ? '' : 'competition', $pb.PbFieldType.OE, defaultOrMaker: $1897.KeywordPlanCompetitionLevelEnum_KeywordPlanCompetitionLevel.UNSPECIFIED, valueOf: $1897.KeywordPlanCompetitionLevelEnum_KeywordPlanCompetitionLevel.valueOf, enumValues: $1897.KeywordPlanCompetitionLevelEnum_KeywordPlanCompetitionLevel.values)
  ...
  @$pb.TagNumber(2)
  $1897.KeywordPlanCompetitionLevelEnum_KeywordPlanCompetitionLevel get competition => $_getN(0);
  @$pb.TagNumber(2)
  set competition($1897.KeywordPlanCompetitionLevelEnum_KeywordPlanCompetitionLevel v) { setField(2, v); }
  @$pb.TagNumber(2)
...
class HistoricalMetricsOptions extends $pb.GeneratedMessage {
  factory HistoricalMetricsOptions({
    $1896.YearMonthRange? yearMonthRange,
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(_omitMessageNames ? '' : 'HistoricalMetricsOptions', package: const $pb.PackageName(_omitMessageNames ? '' : 'google.ads.googleads.v15.common'), createEmptyInstance: create)
    ..aOM<$1896.YearMonthRange>(1, _omitFieldNames ? '' : 'yearMonthRange', subBuilder: $1896.YearMonthRange.create)
  ...
  @$pb.TagNumber(1)
  $1896.YearMonthRange get yearMonthRange => $_getN(0);
  @$pb.TagNumber(1)
  set yearMonthRange($1896.YearMonthRange v) { setField(1, v); }
  @$pb.TagNumber(1)
  $core.bool hasYearMonthRange() => $_has(0);
  @$pb.TagNumber(1)
  void clearYearMonthRange() => clearField(1);
  @$pb.TagNumber(1)
  $1896.YearMonthRange ensureYearMonthRange() => $_ensure(0);
...
class MonthlySearchVolume extends $pb.GeneratedMessage {
  factory MonthlySearchVolume({
    $1888.MonthOfYearEnum_MonthOfYear? month,
    $fixnum.Int64? year,
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(_omitMessageNames ? '' : 'MonthlySearchVolume', package: const $pb.PackageName(_omitMessageNames ? '' : 'google.ads.googleads.v15.common'), createEmptyInstance: create)
    ..e<$1888.MonthOfYearEnum_MonthOfYear>(2, _omitFieldNames ? '' : 'month', $pb.PbFieldType.OE, defaultOrMaker: $1888.MonthOfYearEnum_MonthOfYear.UNSPECIFIED, valueOf: $1888.MonthOfYearEnum_MonthOfYear.valueOf, enumValues: $1888.MonthOfYearEnum_MonthOfYear.values)
  ...
  @$pb.TagNumber(2)
  $1888.MonthOfYearEnum_MonthOfYear get month => $_getN(0);
  @$pb.TagNumber(2)
  set month($1888.MonthOfYearEnum_MonthOfYear v) { setField(2, v); }
  @$pb.TagNumber(2)
...
class KeywordPlanAggregateMetrics extends $pb.GeneratedMessage {
  factory KeywordPlanAggregateMetrics({
    $core.Iterable<$1898.KeywordPlanAggregateMetricTypeEnum_KeywordPlanAggregateMetricType>? aggregateMetricTypes,
  }) {
    final $result = create();
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(_omitMessageNames ? '' : 'KeywordPlanAggregateMetrics', package: const $pb.PackageName(_omitMessageNames ? '' : 'google.ads.googleads.v15.common'), createEmptyInstance: create)
    ..pc<$1898.KeywordPlanAggregateMetricTypeEnum_KeywordPlanAggregateMetricType>(1, _omitFieldNames ? '' : 'aggregateMetricTypes', $pb.PbFieldType.KE, valueOf: $1898.KeywordPlanAggregateMetricTypeEnum_KeywordPlanAggregateMetricType.valueOf, enumValues: $1898.KeywordPlanAggregateMetricTypeEnum_KeywordPlanAggregateMetricType.values, defaultEnumValue: $1898.KeywordPlanAggregateMetricTypeEnum_KeywordPlanAggregateMetricType.UNSPECIFIED)
    ..hasRequiredFields = false
  ;
  ...
  @$pb.TagNumber(1)
  $core.List<$1898.KeywordPlanAggregateMetricTypeEnum_KeywordPlanAggregateMetricType> get aggregateMetricTypes => $_getList(0);
}
...
class ConceptGroup extends $pb.GeneratedMessage {
  factory ConceptGroup({
    $core.String? name,
    $1899.KeywordPlanConceptGroupTypeEnum_KeywordPlanConceptGroupType? type,
  }) {
    final $result = create();
    if (name != null) {
      $result.name = name;
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(_omitMessageNames ? '' : 'ConceptGroup', package: const $pb.PackageName(_omitMessageNames ? '' : 'google.ads.googleads.v15.common'), createEmptyInstance: create)
    ..aOS(1, _omitFieldNames ? '' : 'name')
    ..e<$1899.KeywordPlanConceptGroupTypeEnum_KeywordPlanConceptGroupType>(2, _omitFieldNames ? '' : 'type', $pb.PbFieldType.OE, defaultOrMaker: $1899.KeywordPlanConceptGroupTypeEnum_KeywordPlanConceptGroupType.UNSPECIFIED, valueOf: $1899.KeywordPlanConceptGroupTypeEnum_KeywordPlanConceptGroupType.valueOf, enumValues: $1899.KeywordPlanConceptGroupTypeEnum_KeywordPlanConceptGroupType.values)
    ..hasRequiredFields = false
  ;
  ...
  @$pb.TagNumber(2)
  $1899.KeywordPlanConceptGroupTypeEnum_KeywordPlanConceptGroupType get type => $_getN(1);
  @$pb.TagNumber(2)
  set type($1899.KeywordPlanConceptGroupTypeEnum_KeywordPlanConceptGroupType v) { setField(2, v); }
  @$pb.TagNumber(2)
