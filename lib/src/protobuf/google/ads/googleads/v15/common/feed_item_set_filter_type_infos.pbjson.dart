...
const DynamicLocationSetFilter$json = {
  ...
  '2': [
    ...
    {'1': 'business_name_filter', '3': 2, '4': 1, '5': 11, '6': '.google.ads.googleads.v15.common.BusinessNameFilter', '10': 'businessNameFilter'},
  ],
};
...
final $typed_data.Uint8List dynamicLocationSetFilterDescriptor = $convert.base64Decode(
    ...
    'VzaW5lc3NfbmFtZV9maWx0ZXIYAiABKAsyMy5nb29nbGUuYWRzLmdvb2dsZWFkcy52MTUuY29t'
...
const BusinessNameFilter$json = {
  ...
  '2': [
    ...
    {'1': 'filter_type', '3': 2, '4': 1, '5': 14, '6': '.google.ads.googleads.v15.enums.FeedItemSetStringFilterTypeEnum.FeedItemSetStringFilterType', '10': 'filterType'},
  ],
};
...
final $typed_data.Uint8List businessNameFilterDescriptor = $convert.base64Decode(
    ...
    '1lEnwKC2ZpbHRlcl90eXBlGAIgASgOMlsuZ29vZ2xlLmFkcy5nb29nbGVhZHMudjE1LmVudW1z'
