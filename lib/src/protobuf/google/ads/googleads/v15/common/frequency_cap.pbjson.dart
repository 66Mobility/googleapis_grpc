...
const FrequencyCapEntry$json = {
  '1': 'FrequencyCapEntry',
  '2': [
    {'1': 'key', '3': 1, '4': 1, '5': 11, '6': '.google.ads.googleads.v15.common.FrequencyCapKey', '10': 'key'},
...
final $typed_data.Uint8List frequencyCapEntryDescriptor = $convert.base64Decode(
    ...
    '52MTUuY29tbW9uLkZyZXF1ZW5jeUNhcEtleVIDa2V5EhUKA2NhcBgDIAEoBUgAUgNjYXCIAQFC'
    'BgoEX2NhcA==');
...
const FrequencyCapKey$json = {
  '1': 'FrequencyCapKey',
  '2': [
    {'1': 'level', '3': 1, '4': 1, '5': 14, '6': '.google.ads.googleads.v15.enums.FrequencyCapLevelEnum.FrequencyCapLevel', '10': 'level'},
    {'1': 'event_type', '3': 3, '4': 1, '5': 14, '6': '.google.ads.googleads.v15.enums.FrequencyCapEventTypeEnum.FrequencyCapEventType', '10': 'eventType'},
    {'1': 'time_unit', '3': 2, '4': 1, '5': 14, '6': '.google.ads.googleads.v15.enums.FrequencyCapTimeUnitEnum.FrequencyCapTimeUnit', '10': 'timeUnit'},
...
final $typed_data.Uint8List frequencyCapKeyDescriptor = $convert.base64Decode(
    ...
    '52MTUuZW51bXMuRnJlcXVlbmN5Q2FwTGV2ZWxFbnVtLkZyZXF1ZW5jeUNhcExldmVsUgVsZXZl'
    'bBJuCgpldmVudF90eXBlGAMgASgOMk8uZ29vZ2xlLmFkcy5nb29nbGVhZHMudjE1LmVudW1zLk'
    'ZyZXF1ZW5jeUNhcEV2ZW50VHlwZUVudW0uRnJlcXVlbmN5Q2FwRXZlbnRUeXBlUglldmVudFR5'
    'cGUSagoJdGltZV91bml0GAIgASgOMk0uZ29vZ2xlLmFkcy5nb29nbGVhZHMudjE1LmVudW1zLk'
