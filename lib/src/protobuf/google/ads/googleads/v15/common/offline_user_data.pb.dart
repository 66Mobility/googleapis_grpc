...
import '../enums/user_identifier_source.pbenum.dart' as $1906;
import 'consent.pb.dart' as $1905;
...
class UserIdentifier extends $pb.GeneratedMessage {
  factory UserIdentifier({
    ...
    $1906.UserIdentifierSourceEnum_UserIdentifierSource? userIdentifierSource,
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(_omitMessageNames ? '' : 'UserIdentifier', package: const $pb.PackageName(_omitMessageNames ? '' : 'google.ads.googleads.v15.common'), createEmptyInstance: create)
    ...
    ..e<$1906.UserIdentifierSourceEnum_UserIdentifierSource>(6, _omitFieldNames ? '' : 'userIdentifierSource', $pb.PbFieldType.OE, defaultOrMaker: $1906.UserIdentifierSourceEnum_UserIdentifierSource.UNSPECIFIED, valueOf: $1906.UserIdentifierSourceEnum_UserIdentifierSource.valueOf, enumValues: $1906.UserIdentifierSourceEnum_UserIdentifierSource.values)
  ...
  @$pb.TagNumber(6)
  $1906.UserIdentifierSourceEnum_UserIdentifierSource get userIdentifierSource => $_getN(1);
  @$pb.TagNumber(6)
  set userIdentifierSource($1906.UserIdentifierSourceEnum_UserIdentifierSource v) { setField(6, v); }
  @$pb.TagNumber(6)
...
class UserData extends $pb.GeneratedMessage {
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(_omitMessageNames ? '' : 'UserData', package: const $pb.PackageName(_omitMessageNames ? '' : 'google.ads.googleads.v15.common'), createEmptyInstance: create)
    ...
    ..aOM<$1905.Consent>(4, _omitFieldNames ? '' : 'consent', subBuilder: $1905.Consent.create)
    ..hasRequiredFields = false
  ;
  ...
  @$pb.TagNumber(4)
  $1905.Consent get consent => $_getN(3);
  @$pb.TagNumber(4)
  set consent($1905.Consent v) { setField(4, v); }
  @$pb.TagNumber(4)
  $core.bool hasConsent() => $_has(3);
  @$pb.TagNumber(4)
  void clearConsent() => clearField(4);
  @$pb.TagNumber(4)
  $1905.Consent ensureConsent() => $_ensure(3);
}
...
class CustomerMatchUserListMetadata extends $pb.GeneratedMessage {
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(_omitMessageNames ? '' : 'CustomerMatchUserListMetadata', package: const $pb.PackageName(_omitMessageNames ? '' : 'google.ads.googleads.v15.common'), createEmptyInstance: create)
    ...
    ..aOM<$1905.Consent>(3, _omitFieldNames ? '' : 'consent', subBuilder: $1905.Consent.create)
    ..hasRequiredFields = false
  ;
  ...
  @$pb.TagNumber(3)
  $1905.Consent get consent => $_getN(1);
  @$pb.TagNumber(3)
  set consent($1905.Consent v) { setField(3, v); }
  @$pb.TagNumber(3)
  $core.bool hasConsent() => $_has(1);
  @$pb.TagNumber(3)
  void clearConsent() => clearField(3);
  @$pb.TagNumber(3)
  $1905.Consent ensureConsent() => $_ensure(1);
}
