...
class GenderDimension extends $pb.GeneratedMessage {
  factory GenderDimension({
    $core.Iterable<$1857.GenderTypeEnum_GenderType>? genders,
    $core.bool? includeUndetermined,
  }) {
    final $result = create();
    if (genders != null) {
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(_omitMessageNames ? '' : 'GenderDimension', package: const $pb.PackageName(_omitMessageNames ? '' : 'google.ads.googleads.v15.common'), createEmptyInstance: create)
    ..pc<$1857.GenderTypeEnum_GenderType>(1, _omitFieldNames ? '' : 'genders', $pb.PbFieldType.KE, valueOf: $1857.GenderTypeEnum_GenderType.valueOf, enumValues: $1857.GenderTypeEnum_GenderType.values, defaultEnumValue: $1857.GenderTypeEnum_GenderType.UNSPECIFIED)
    ..aOB(2, _omitFieldNames ? '' : 'includeUndetermined')
    ..hasRequiredFields = false
  ;
  ...
  @$pb.TagNumber(1)
  $core.List<$1857.GenderTypeEnum_GenderType> get genders => $_getList(0);
...
class HouseholdIncomeDimension extends $pb.GeneratedMessage {
  factory HouseholdIncomeDimension({
    $core.Iterable<$1858.IncomeRangeTypeEnum_IncomeRangeType>? incomeRanges,
    $core.bool? includeUndetermined,
  }) {
    final $result = create();
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(_omitMessageNames ? '' : 'HouseholdIncomeDimension', package: const $pb.PackageName(_omitMessageNames ? '' : 'google.ads.googleads.v15.common'), createEmptyInstance: create)
    ..pc<$1858.IncomeRangeTypeEnum_IncomeRangeType>(1, _omitFieldNames ? '' : 'incomeRanges', $pb.PbFieldType.KE, valueOf: $1858.IncomeRangeTypeEnum_IncomeRangeType.valueOf, enumValues: $1858.IncomeRangeTypeEnum_IncomeRangeType.values, defaultEnumValue: $1858.IncomeRangeTypeEnum_IncomeRangeType.UNSPECIFIED)
    ..aOB(2, _omitFieldNames ? '' : 'includeUndetermined')
    ..hasRequiredFields = false
  ;
  ...
  @$pb.TagNumber(1)
  $core.List<$1858.IncomeRangeTypeEnum_IncomeRangeType> get incomeRanges => $_getList(0);
...
class ParentalStatusDimension extends $pb.GeneratedMessage {
  factory ParentalStatusDimension({
    $core.Iterable<$1859.ParentalStatusTypeEnum_ParentalStatusType>? parentalStatuses,
    $core.bool? includeUndetermined,
  }) {
    final $result = create();
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(_omitMessageNames ? '' : 'ParentalStatusDimension', package: const $pb.PackageName(_omitMessageNames ? '' : 'google.ads.googleads.v15.common'), createEmptyInstance: create)
    ..pc<$1859.ParentalStatusTypeEnum_ParentalStatusType>(1, _omitFieldNames ? '' : 'parentalStatuses', $pb.PbFieldType.KE, valueOf: $1859.ParentalStatusTypeEnum_ParentalStatusType.valueOf, enumValues: $1859.ParentalStatusTypeEnum_ParentalStatusType.values, defaultEnumValue: $1859.ParentalStatusTypeEnum_ParentalStatusType.UNSPECIFIED)
    ..aOB(2, _omitFieldNames ? '' : 'includeUndetermined')
    ..hasRequiredFields = false
  ;
  ...
  @$pb.TagNumber(1)
  $core.List<$1859.ParentalStatusTypeEnum_ParentalStatusType> get parentalStatuses => $_getList(0);
