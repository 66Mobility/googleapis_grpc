...
class AudienceDimension extends $pb.GeneratedMessage {
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(_omitMessageNames ? '' : 'AudienceDimension', package: const $pb.PackageName(_omitMessageNames ? '' : 'google.ads.googleads.v15.common'), createEmptyInstance: create)
    ..oo(0, [1, 2, 3, 4, 5])
...
class AudienceExclusionDimension extends $pb.GeneratedMessage {
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(_omitMessageNames ? '' : 'AudienceExclusionDimension', package: const $pb.PackageName(_omitMessageNames ? '' : 'google.ads.googleads.v15.common'), createEmptyInstance: create)
...
class ExclusionSegment extends $pb.GeneratedMessage {
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(_omitMessageNames ? '' : 'ExclusionSegment', package: const $pb.PackageName(_omitMessageNames ? '' : 'google.ads.googleads.v15.common'), createEmptyInstance: create)
    ..oo(0, [1])
...
class AgeDimension extends $pb.GeneratedMessage {
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(_omitMessageNames ? '' : 'AgeDimension', package: const $pb.PackageName(_omitMessageNames ? '' : 'google.ads.googleads.v15.common'), createEmptyInstance: create)
...
class AgeSegment extends $pb.GeneratedMessage {
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(_omitMessageNames ? '' : 'AgeSegment', package: const $pb.PackageName(_omitMessageNames ? '' : 'google.ads.googleads.v15.common'), createEmptyInstance: create)
...
class GenderDimension extends $pb.GeneratedMessage {
  factory GenderDimension({
    $core.Iterable<$1858.GenderTypeEnum_GenderType>? genders,
    $core.bool? includeUndetermined,
  }) {
    final $result = create();
    if (genders != null) {
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(_omitMessageNames ? '' : 'GenderDimension', package: const $pb.PackageName(_omitMessageNames ? '' : 'google.ads.googleads.v15.common'), createEmptyInstance: create)
    ..pc<$1858.GenderTypeEnum_GenderType>(1, _omitFieldNames ? '' : 'genders', $pb.PbFieldType.KE, valueOf: $1858.GenderTypeEnum_GenderType.valueOf, enumValues: $1858.GenderTypeEnum_GenderType.values, defaultEnumValue: $1858.GenderTypeEnum_GenderType.UNSPECIFIED)
    ..aOB(2, _omitFieldNames ? '' : 'includeUndetermined')
    ..hasRequiredFields = false
  ;
  ...
  @$pb.TagNumber(1)
  $core.List<$1858.GenderTypeEnum_GenderType> get genders => $_getList(0);
...
class HouseholdIncomeDimension extends $pb.GeneratedMessage {
  factory HouseholdIncomeDimension({
    $core.Iterable<$1859.IncomeRangeTypeEnum_IncomeRangeType>? incomeRanges,
    $core.bool? includeUndetermined,
  }) {
    final $result = create();
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(_omitMessageNames ? '' : 'HouseholdIncomeDimension', package: const $pb.PackageName(_omitMessageNames ? '' : 'google.ads.googleads.v15.common'), createEmptyInstance: create)
    ..pc<$1859.IncomeRangeTypeEnum_IncomeRangeType>(1, _omitFieldNames ? '' : 'incomeRanges', $pb.PbFieldType.KE, valueOf: $1859.IncomeRangeTypeEnum_IncomeRangeType.valueOf, enumValues: $1859.IncomeRangeTypeEnum_IncomeRangeType.values, defaultEnumValue: $1859.IncomeRangeTypeEnum_IncomeRangeType.UNSPECIFIED)
    ..aOB(2, _omitFieldNames ? '' : 'includeUndetermined')
    ..hasRequiredFields = false
  ;
  ...
  @$pb.TagNumber(1)
  $core.List<$1859.IncomeRangeTypeEnum_IncomeRangeType> get incomeRanges => $_getList(0);
...
class ParentalStatusDimension extends $pb.GeneratedMessage {
  factory ParentalStatusDimension({
    $core.Iterable<$1860.ParentalStatusTypeEnum_ParentalStatusType>? parentalStatuses,
    $core.bool? includeUndetermined,
  }) {
    final $result = create();
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(_omitMessageNames ? '' : 'ParentalStatusDimension', package: const $pb.PackageName(_omitMessageNames ? '' : 'google.ads.googleads.v15.common'), createEmptyInstance: create)
    ..pc<$1860.ParentalStatusTypeEnum_ParentalStatusType>(1, _omitFieldNames ? '' : 'parentalStatuses', $pb.PbFieldType.KE, valueOf: $1860.ParentalStatusTypeEnum_ParentalStatusType.valueOf, enumValues: $1860.ParentalStatusTypeEnum_ParentalStatusType.values, defaultEnumValue: $1860.ParentalStatusTypeEnum_ParentalStatusType.UNSPECIFIED)
    ..aOB(2, _omitFieldNames ? '' : 'includeUndetermined')
    ..hasRequiredFields = false
  ;
  ...
  @$pb.TagNumber(1)
  $core.List<$1860.ParentalStatusTypeEnum_ParentalStatusType> get parentalStatuses => $_getList(0);
...
class AudienceSegmentDimension extends $pb.GeneratedMessage {
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(_omitMessageNames ? '' : 'AudienceSegmentDimension', package: const $pb.PackageName(_omitMessageNames ? '' : 'google.ads.googleads.v15.common'), createEmptyInstance: create)
...
class AudienceSegment extends $pb.GeneratedMessage {
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(_omitMessageNames ? '' : 'AudienceSegment', package: const $pb.PackageName(_omitMessageNames ? '' : 'google.ads.googleads.v15.common'), createEmptyInstance: create)
    ..oo(0, [1, 2, 3, 4, 5])
    ..aOM<UserListSegment>(1, _omitFieldNames ? '' : 'userList', subBuilder: UserListSegment.create)
...
class UserListSegment extends $pb.GeneratedMessage {
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(_omitMessageNames ? '' : 'UserListSegment', package: const $pb.PackageName(_omitMessageNames ? '' : 'google.ads.googleads.v15.common'), createEmptyInstance: create)
...
class UserInterestSegment extends $pb.GeneratedMessage {
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(_omitMessageNames ? '' : 'UserInterestSegment', package: const $pb.PackageName(_omitMessageNames ? '' : 'google.ads.googleads.v15.common'), createEmptyInstance: create)
...
class LifeEventSegment extends $pb.GeneratedMessage {
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(_omitMessageNames ? '' : 'LifeEventSegment', package: const $pb.PackageName(_omitMessageNames ? '' : 'google.ads.googleads.v15.common'), createEmptyInstance: create)
...
class DetailedDemographicSegment extends $pb.GeneratedMessage {
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(_omitMessageNames ? '' : 'DetailedDemographicSegment', package: const $pb.PackageName(_omitMessageNames ? '' : 'google.ads.googleads.v15.common'), createEmptyInstance: create)
...
class CustomAudienceSegment extends $pb.GeneratedMessage {
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(_omitMessageNames ? '' : 'CustomAudienceSegment', package: const $pb.PackageName(_omitMessageNames ? '' : 'google.ads.googleads.v15.common'), createEmptyInstance: create)
