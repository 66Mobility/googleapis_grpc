...
const AudienceDimension$json = {
  '1': 'AudienceDimension',
  '2': [
    {'1': 'age', '3': 1, '4': 1, '5': 11, '6': '.google.ads.googleads.v15.common.AgeDimension', '9': 0, '10': 'age'},
    {'1': 'gender', '3': 2, '4': 1, '5': 11, '6': '.google.ads.googleads.v15.common.GenderDimension', '9': 0, '10': 'gender'},
    {'1': 'household_income', '3': 3, '4': 1, '5': 11, '6': '.google.ads.googleads.v15.common.HouseholdIncomeDimension', '9': 0, '10': 'householdIncome'},
    {'1': 'parental_status', '3': 4, '4': 1, '5': 11, '6': '.google.ads.googleads.v15.common.ParentalStatusDimension', '9': 0, '10': 'parentalStatus'},
    {'1': 'audience_segments', '3': 5, '4': 1, '5': 11, '6': '.google.ads.googleads.v15.common.AudienceSegmentDimension', '9': 0, '10': 'audienceSegments'},
  ],
  '8': [
    {'1': 'dimension'},
  ],
...
final $typed_data.Uint8List audienceDimensionDescriptor = $convert.base64Decode(
    ...
    '52MTUuY29tbW9uLkFnZURpbWVuc2lvbkgAUgNhZ2USSgoGZ2VuZGVyGAIgASgLMjAuZ29vZ2xl'
    'LmFkcy5nb29nbGVhZHMudjE1LmNvbW1vbi5HZW5kZXJEaW1lbnNpb25IAFIGZ2VuZGVyEmYKEG'
    'hvdXNlaG9sZF9pbmNvbWUYAyABKAsyOS5nb29nbGUuYWRzLmdvb2dsZWFkcy52MTUuY29tbW9u'
    'LkhvdXNlaG9sZEluY29tZURpbWVuc2lvbkgAUg9ob3VzZWhvbGRJbmNvbWUSYwoPcGFyZW50YW'
    'xfc3RhdHVzGAQgASgLMjguZ29vZ2xlLmFkcy5nb29nbGVhZHMudjE1LmNvbW1vbi5QYXJlbnRh'
    'bFN0YXR1c0RpbWVuc2lvbkgAUg5wYXJlbnRhbFN0YXR1cxJoChFhdWRpZW5jZV9zZWdtZW50cx'
    'gFIAEoCzI5Lmdvb2dsZS5hZHMuZ29vZ2xlYWRzLnYxNS5jb21tb24uQXVkaWVuY2VTZWdtZW50'
...
const AudienceExclusionDimension$json = {
  ...
  '2': [
    {'1': 'exclusions', '3': 1, '4': 3, '5': 11, '6': '.google.ads.googleads.v15.common.ExclusionSegment', '10': 'exclusions'},
  ],
};
...
final $typed_data.Uint8List audienceExclusionDimensionDescriptor = $convert.base64Decode(
    ...
    'xlLmFkcy5nb29nbGVhZHMudjE1LmNvbW1vbi5FeGNsdXNpb25TZWdtZW50UgpleGNsdXNpb25z');

@$core.Deprecated('Use exclusionSegmentDescriptor instead')
const ExclusionSegment$json = {
  '1': 'ExclusionSegment',
  '2': [
    {'1': 'user_list', '3': 1, '4': 1, '5': 11, '6': '.google.ads.googleads.v15.common.UserListSegment', '9': 0, '10': 'userList'},
  ],
  '8': [
    {'1': 'segment'},
  ],
...
final $typed_data.Uint8List exclusionSegmentDescriptor = $convert.base64Decode(
    ...
    'xlYWRzLnYxNS5jb21tb24uVXNlckxpc3RTZWdtZW50SABSCHVzZXJMaXN0QgkKB3NlZ21lbnQ=');

@$core.Deprecated('Use ageDimensionDescriptor instead')
const AgeDimension$json = {
  '1': 'AgeDimension',
  '2': [
    {'1': 'age_ranges', '3': 1, '4': 3, '5': 11, '6': '.google.ads.googleads.v15.common.AgeSegment', '10': 'ageRanges'},
...
final $typed_data.Uint8List ageDimensionDescriptor = $convert.base64Decode(
    ...
    'RzLnYxNS5jb21tb24uQWdlU2VnbWVudFIJYWdlUmFuZ2VzEjYKFGluY2x1ZGVfdW5kZXRlcm1p'
...
const GenderDimension$json = {
  '1': 'GenderDimension',
  '2': [
    {'1': 'genders', '3': 1, '4': 3, '5': 14, '6': '.google.ads.googleads.v15.enums.GenderTypeEnum.GenderType', '10': 'genders'},
    {'1': 'include_undetermined', '3': 2, '4': 1, '5': 8, '9': 0, '10': 'includeUndetermined', '17': true},
  ],
  '8': [
    {'1': '_include_undetermined'},
...
final $typed_data.Uint8List genderDimensionDescriptor = $convert.base64Decode(
    ...
    'RzLnYxNS5lbnVtcy5HZW5kZXJUeXBlRW51bS5HZW5kZXJUeXBlUgdnZW5kZXJzEjYKFGluY2x1'
...
const HouseholdIncomeDimension$json = {
  ...
  '2': [
    {'1': 'income_ranges', '3': 1, '4': 3, '5': 14, '6': '.google.ads.googleads.v15.enums.IncomeRangeTypeEnum.IncomeRangeType', '10': 'incomeRanges'},
    {'1': 'include_undetermined', '3': 2, '4': 1, '5': 8, '9': 0, '10': 'includeUndetermined', '17': true},
  ],
  '8': [
    {'1': '_include_undetermined'},
...
final $typed_data.Uint8List householdIncomeDimensionDescriptor = $convert.base64Decode(
    ...
    'dsZS5hZHMuZ29vZ2xlYWRzLnYxNS5lbnVtcy5JbmNvbWVSYW5nZVR5cGVFbnVtLkluY29tZVJh'
...
const ParentalStatusDimension$json = {
  ...
  '2': [
    {'1': 'parental_statuses', '3': 1, '4': 3, '5': 14, '6': '.google.ads.googleads.v15.enums.ParentalStatusTypeEnum.ParentalStatusType', '10': 'parentalStatuses'},
    {'1': 'include_undetermined', '3': 2, '4': 1, '5': 8, '9': 0, '10': 'includeUndetermined', '17': true},
  ],
  '8': [
    {'1': '_include_undetermined'},
...
final $typed_data.Uint8List parentalStatusDimensionDescriptor = $convert.base64Decode(
    ...
    'dvb2dsZS5hZHMuZ29vZ2xlYWRzLnYxNS5lbnVtcy5QYXJlbnRhbFN0YXR1c1R5cGVFbnVtLlBh'
...
const AudienceSegmentDimension$json = {
  ...
  '2': [
    {'1': 'segments', '3': 1, '4': 3, '5': 11, '6': '.google.ads.googleads.v15.common.AudienceSegment', '10': 'segments'},
  ],
};
...
final $typed_data.Uint8List audienceSegmentDimensionDescriptor = $convert.base64Decode(
    ...
    'RzLmdvb2dsZWFkcy52MTUuY29tbW9uLkF1ZGllbmNlU2VnbWVudFIIc2VnbWVudHM=');
...
const AudienceSegment$json = {
  ...
  '2': [
    {'1': 'user_list', '3': 1, '4': 1, '5': 11, '6': '.google.ads.googleads.v15.common.UserListSegment', '9': 0, '10': 'userList'},
    {'1': 'user_interest', '3': 2, '4': 1, '5': 11, '6': '.google.ads.googleads.v15.common.UserInterestSegment', '9': 0, '10': 'userInterest'},
    {'1': 'life_event', '3': 3, '4': 1, '5': 11, '6': '.google.ads.googleads.v15.common.LifeEventSegment', '9': 0, '10': 'lifeEvent'},
    {'1': 'detailed_demographic', '3': 4, '4': 1, '5': 11, '6': '.google.ads.googleads.v15.common.DetailedDemographicSegment', '9': 0, '10': 'detailedDemographic'},
    {'1': 'custom_audience', '3': 5, '4': 1, '5': 11, '6': '.google.ads.googleads.v15.common.CustomAudienceSegment', '9': 0, '10': 'customAudience'},
  ],
  '8': [
    {'1': 'segment'},
  ],
...
final $typed_data.Uint8List audienceSegmentDescriptor = $convert.base64Decode(
    ...
    'VhZHMudjE1LmNvbW1vbi5Vc2VyTGlzdFNlZ21lbnRIAFIIdXNlckxpc3QSWwoNdXNlcl9pbnRl'
    'cmVzdBgCIAEoCzI0Lmdvb2dsZS5hZHMuZ29vZ2xlYWRzLnYxNS5jb21tb24uVXNlckludGVyZX'
    'N0U2VnbWVudEgAUgx1c2VySW50ZXJlc3QSUgoKbGlmZV9ldmVudBgDIAEoCzIxLmdvb2dsZS5h'
    'ZHMuZ29vZ2xlYWRzLnYxNS5jb21tb24uTGlmZUV2ZW50U2VnbWVudEgAUglsaWZlRXZlbnQScA'
    'oUZGV0YWlsZWRfZGVtb2dyYXBoaWMYBCABKAsyOy5nb29nbGUuYWRzLmdvb2dsZWFkcy52MTUu'
    'Y29tbW9uLkRldGFpbGVkRGVtb2dyYXBoaWNTZWdtZW50SABSE2RldGFpbGVkRGVtb2dyYXBoaW'
    'MSYQoPY3VzdG9tX2F1ZGllbmNlGAUgASgLMjYuZ29vZ2xlLmFkcy5nb29nbGVhZHMudjE1LmNv'
...
const LifeEventSegment$json = {
  '1': 'LifeEventSegment',
  '2': [
    {'1': 'life_event', '3': 1, '4': 1, '5': 9, '9': 0, '10': 'lifeEvent', '17': true},
  ],
  '8': [
    {'1': '_life_event'},
  ],
...
final $typed_data.Uint8List lifeEventSegmentDescriptor = $convert.base64Decode(
    'ChBMaWZlRXZlbnRTZWdtZW50EiIKCmxpZmVfZXZlbnQYASABKAlIAFIJbGlmZUV2ZW50iAEBQg'
    '0KC19saWZlX2V2ZW50');
...
const DetailedDemographicSegment$json = {
  ...
  '2': [
    {'1': 'detailed_demographic', '3': 1, '4': 1, '5': 9, '9': 0, '10': 'detailedDemographic', '17': true},
  ],
  '8': [
...
final $typed_data.Uint8List detailedDemographicSegmentDescriptor = $convert.base64Decode(
    'ChpEZXRhaWxlZERlbW9ncmFwaGljU2VnbWVudBI2ChRkZXRhaWxlZF9kZW1vZ3JhcGhpYxgBIA'
    'EoCUgAUhNkZXRhaWxlZERlbW9ncmFwaGljiAEBQhcKFV9kZXRhaWxlZF9kZW1vZ3JhcGhpYw==');
