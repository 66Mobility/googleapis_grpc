...
class CustomerManagerLinkOperation extends $pb.GeneratedMessage {
  factory CustomerManagerLinkOperation({
    $2432.CustomerManagerLink? update,
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(_omitMessageNames ? '' : 'CustomerManagerLinkOperation', package: const $pb.PackageName(_omitMessageNames ? '' : 'google.ads.googleads.v15.services'), createEmptyInstance: create)
    ..oo(0, [2])
    ..aOM<$2432.CustomerManagerLink>(2, _omitFieldNames ? '' : 'update', subBuilder: $2432.CustomerManagerLink.create)
  ...
  @$pb.TagNumber(2)
  $2432.CustomerManagerLink get update => $_getN(0);
  @$pb.TagNumber(2)
  set update($2432.CustomerManagerLink v) { setField(2, v); }
  @$pb.TagNumber(2)
  $core.bool hasUpdate() => $_has(0);
  @$pb.TagNumber(2)
  void clearUpdate() => clearField(2);
  @$pb.TagNumber(2)
  $2432.CustomerManagerLink ensureUpdate() => $_ensure(0);
