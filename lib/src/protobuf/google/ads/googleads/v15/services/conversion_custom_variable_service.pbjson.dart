...
const MutateConversionCustomVariablesRequest$json = {
  ...
  '2': [
    ...
    {'1': 'operations', '3': 2, '4': 3, '5': 11, '6': '.google.ads.googleads.v15.services.ConversionCustomVariableOperation', '8': {}, '10': 'operations'},
...
final $typed_data.Uint8List mutateConversionCustomVariablesRequestDescriptor = $convert.base64Decode(
    ...
    'Lmdvb2dsZWFkcy52MTUuc2VydmljZXMuQ29udmVyc2lvbkN1c3RvbVZhcmlhYmxlT3BlcmF0aW'
...
const ConversionCustomVariableOperation$json = {
  ...
  '2': [
    ...
    {'1': 'create', '3': 1, '4': 1, '5': 11, '6': '.google.ads.googleads.v15.resources.ConversionCustomVariable', '9': 0, '10': 'create'},
    {'1': 'update', '3': 2, '4': 1, '5': 11, '6': '.google.ads.googleads.v15.resources.ConversionCustomVariable', '9': 0, '10': 'update'},
  ],
  '8': [
    {'1': 'operation'},
  ],
...
final $typed_data.Uint8List conversionCustomVariableOperationDescriptor = $convert.base64Decode(
    ...
    'CzI8Lmdvb2dsZS5hZHMuZ29vZ2xlYWRzLnYxNS5yZXNvdXJjZXMuQ29udmVyc2lvbkN1c3RvbV'
    'ZhcmlhYmxlSABSBmNyZWF0ZRJWCgZ1cGRhdGUYAiABKAsyPC5nb29nbGUuYWRzLmdvb2dsZWFk'
    'cy52MTUucmVzb3VyY2VzLkNvbnZlcnNpb25DdXN0b21WYXJpYWJsZUgAUgZ1cGRhdGVCCwoJb3'
    'BlcmF0aW9u');
...
const MutateConversionCustomVariablesResponse$json = {
  ...
  '2': [
    ...
    {'1': 'results', '3': 2, '4': 3, '5': 11, '6': '.google.ads.googleads.v15.services.MutateConversionCustomVariableResult', '10': 'results'},
  ],
};
...
const MutateConversionCustomVariableResult$json = {
  ...
  '2': [
    ...
    {'1': 'conversion_custom_variable', '3': 2, '4': 1, '5': 11, '6': '.google.ads.googleads.v15.resources.ConversionCustomVariable', '10': 'conversionCustomVariable'},
  ],
};
...
final $typed_data.Uint8List mutateConversionCustomVariableResultDescriptor = $convert.base64Decode(
    ...
    'syPC5nb29nbGUuYWRzLmdvb2dsZWFkcy52MTUucmVzb3VyY2VzLkNvbnZlcnNpb25DdXN0b21W'
