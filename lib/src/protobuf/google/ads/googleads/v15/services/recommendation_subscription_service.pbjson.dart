...
const MutateRecommendationSubscriptionRequest$json = {
  ...
  '2': [
    ...
    {'1': 'operations', '3': 2, '4': 3, '5': 11, '6': '.google.ads.googleads.v15.services.RecommendationSubscriptionOperation', '8': {}, '10': 'operations'},
...
final $typed_data.Uint8List mutateRecommendationSubscriptionRequestDescriptor = $convert.base64Decode(
    ...
    'cy5nb29nbGVhZHMudjE1LnNlcnZpY2VzLlJlY29tbWVuZGF0aW9uU3Vic2NyaXB0aW9uT3Blcm'
    ...
    'VfY29udGVudF90eXBlGAUgASgOMksuZ29vZ2xlLmFkcy5nb29nbGVhZHMudjE1LmVudW1zLlJl'
...
const RecommendationSubscriptionOperation$json = {
  ...
  '2': [
    ...
    {'1': 'create', '3': 1, '4': 1, '5': 11, '6': '.google.ads.googleads.v15.resources.RecommendationSubscription', '9': 0, '10': 'create'},
    {'1': 'update', '3': 2, '4': 1, '5': 11, '6': '.google.ads.googleads.v15.resources.RecommendationSubscription', '9': 0, '10': 'update'},
  ],
  '8': [
    {'1': 'operation'},
  ],
...
final $typed_data.Uint8List recommendationSubscriptionOperationDescriptor = $convert.base64Decode(
    ...
    'dGUYASABKAsyPi5nb29nbGUuYWRzLmdvb2dsZWFkcy52MTUucmVzb3VyY2VzLlJlY29tbWVuZG'
    'F0aW9uU3Vic2NyaXB0aW9uSABSBmNyZWF0ZRJYCgZ1cGRhdGUYAiABKAsyPi5nb29nbGUuYWRz'
    'Lmdvb2dsZWFkcy52MTUucmVzb3VyY2VzLlJlY29tbWVuZGF0aW9uU3Vic2NyaXB0aW9uSABSBn'
...
const MutateRecommendationSubscriptionResponse$json = {
  ...
  '2': [
    {'1': 'results', '3': 1, '4': 3, '5': 11, '6': '.google.ads.googleads.v15.services.MutateRecommendationSubscriptionResult', '10': 'results'},
...
final $typed_data.Uint8List mutateRecommendationSubscriptionResponseDescriptor = $convert.base64Decode(
    ...
    'ADKAsySS5nb29nbGUuYWRzLmdvb2dsZWFkcy52MTUuc2VydmljZXMuTXV0YXRlUmVjb21tZW5k'
...
const MutateRecommendationSubscriptionResult$json = {
  ...
  '2': [
    ...
    {'1': 'recommendation_subscription', '3': 2, '4': 1, '5': 11, '6': '.google.ads.googleads.v15.resources.RecommendationSubscription', '10': 'recommendationSubscription'},
  ],
};
...
final $typed_data.Uint8List mutateRecommendationSubscriptionResultDescriptor = $convert.base64Decode(
    ...
    'gCIAEoCzI+Lmdvb2dsZS5hZHMuZ29vZ2xlYWRzLnYxNS5yZXNvdXJjZXMuUmVjb21tZW5kYXRp'
