...
class KeywordPlanAdGroupKeywordOperation extends $pb.GeneratedMessage {
  factory KeywordPlanAdGroupKeywordOperation({
    $2398.KeywordPlanAdGroupKeyword? create_1,
    $2398.KeywordPlanAdGroupKeyword? update,
    $core.String? remove,
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(_omitMessageNames ? '' : 'KeywordPlanAdGroupKeywordOperation', package: const $pb.PackageName(_omitMessageNames ? '' : 'google.ads.googleads.v15.services'), createEmptyInstance: create)
    ..oo(0, [1, 2, 3])
    ..aOM<$2398.KeywordPlanAdGroupKeyword>(1, _omitFieldNames ? '' : 'create', subBuilder: $2398.KeywordPlanAdGroupKeyword.create)
    ..aOM<$2398.KeywordPlanAdGroupKeyword>(2, _omitFieldNames ? '' : 'update', subBuilder: $2398.KeywordPlanAdGroupKeyword.create)
  ...
  /// ad group keyword.
  @$pb.TagNumber(1)
  $2398.KeywordPlanAdGroupKeyword get create_1 => $_getN(0);
  @$pb.TagNumber(1)
  set create_1($2398.KeywordPlanAdGroupKeyword v) { setField(1, v); }
  @$pb.TagNumber(1)
  $core.bool hasCreate_1() => $_has(0);
  @$pb.TagNumber(1)
  void clearCreate_1() => clearField(1);
  @$pb.TagNumber(1)
  $2398.KeywordPlanAdGroupKeyword ensureCreate_1() => $_ensure(0);

  /// Update operation: The Keyword Plan ad group keyword is expected to have a
  /// valid resource name.
  @$pb.TagNumber(2)
  $2398.KeywordPlanAdGroupKeyword get update => $_getN(1);
  @$pb.TagNumber(2)
  set update($2398.KeywordPlanAdGroupKeyword v) { setField(2, v); }
  @$pb.TagNumber(2)
  $core.bool hasUpdate() => $_has(1);
  @$pb.TagNumber(2)
  void clearUpdate() => clearField(2);
  @$pb.TagNumber(2)
  $2398.KeywordPlanAdGroupKeyword ensureUpdate() => $_ensure(1);
