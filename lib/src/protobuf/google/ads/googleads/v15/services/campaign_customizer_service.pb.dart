...
class CampaignCustomizerOperation extends $pb.GeneratedMessage {
  factory CampaignCustomizerOperation({
    $2372.CampaignCustomizer? create_1,
    $core.String? remove,
  }) {
    final $result = create();
    if (create_1 != null) {
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(_omitMessageNames ? '' : 'CampaignCustomizerOperation', package: const $pb.PackageName(_omitMessageNames ? '' : 'google.ads.googleads.v15.services'), createEmptyInstance: create)
    ..oo(0, [1, 2])
    ..aOM<$2372.CampaignCustomizer>(1, _omitFieldNames ? '' : 'create', subBuilder: $2372.CampaignCustomizer.create)
  ...
  /// customizer
  @$pb.TagNumber(1)
  $2372.CampaignCustomizer get create_1 => $_getN(0);
  @$pb.TagNumber(1)
  set create_1($2372.CampaignCustomizer v) { setField(1, v); }
  @$pb.TagNumber(1)
  $core.bool hasCreate_1() => $_has(0);
  @$pb.TagNumber(1)
  void clearCreate_1() => clearField(1);
  @$pb.TagNumber(1)
  $2372.CampaignCustomizer ensureCreate_1() => $_ensure(0);
...
class MutateCampaignCustomizerResult extends $pb.GeneratedMessage {
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(_omitMessageNames ? '' : 'MutateCampaignCustomizerResult', package: const $pb.PackageName(_omitMessageNames ? '' : 'google.ads.googleads.v15.services'), createEmptyInstance: create)
    ...
    ..aOM<$2372.CampaignCustomizer>(2, _omitFieldNames ? '' : 'campaignCustomizer', subBuilder: $2372.CampaignCustomizer.create)
    ..hasRequiredFields = false
  ;
  ...
  /// "MUTABLE_RESOURCE".
  @$pb.TagNumber(2)
  $2372.CampaignCustomizer get campaignCustomizer => $_getN(1);
  @$pb.TagNumber(2)
  set campaignCustomizer($2372.CampaignCustomizer v) { setField(2, v); }
  @$pb.TagNumber(2)
  $core.bool hasCampaignCustomizer() => $_has(1);
  @$pb.TagNumber(2)
  void clearCampaignCustomizer() => clearField(2);
  @$pb.TagNumber(2)
  $2372.CampaignCustomizer ensureCampaignCustomizer() => $_ensure(1);
}
