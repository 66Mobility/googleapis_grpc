...
const ConfigureCampaignLifecycleGoalsRequest$json = {
  ...
  '2': [
    ...
    {'1': 'operation', '3': 2, '4': 1, '5': 11, '6': '.google.ads.googleads.v15.services.CampaignLifecycleGoalOperation', '8': {}, '10': 'operation'},
...
final $typed_data.Uint8List configureCampaignLifecycleGoalsRequestDescriptor = $convert.base64Decode(
    ...
    'Z29vZ2xlYWRzLnYxNS5zZXJ2aWNlcy5DYW1wYWlnbkxpZmVjeWNsZUdvYWxPcGVyYXRpb25CA+'
...
const CampaignLifecycleGoalOperation$json = {
  ...
  '2': [
    ...
    {'1': 'create', '3': 1, '4': 1, '5': 11, '6': '.google.ads.googleads.v15.resources.CampaignLifecycleGoal', '9': 0, '10': 'create'},
  ],
  '8': [
    {'1': 'operation'},
  ],
...
final $typed_data.Uint8List campaignLifecycleGoalOperationDescriptor = $convert.base64Decode(
    ...
    'ASgLMjkuZ29vZ2xlLmFkcy5nb29nbGVhZHMudjE1LnJlc291cmNlcy5DYW1wYWlnbkxpZmVjeW'
...
const ConfigureCampaignLifecycleGoalsResponse$json = {
  ...
  '2': [
    {'1': 'result', '3': 1, '4': 1, '5': 11, '6': '.google.ads.googleads.v15.services.ConfigureCampaignLifecycleGoalsResult', '10': 'result'},
  ],
};
...
final $typed_data.Uint8List configureCampaignLifecycleGoalsResponseDescriptor = $convert.base64Decode(
    ...
    'gLMkguZ29vZ2xlLmFkcy5nb29nbGVhZHMudjE1LnNlcnZpY2VzLkNvbmZpZ3VyZUNhbXBhaWdu'
