...
const MutateCustomInterestsRequest$json = {
  ...
  '2': [
    ...
    {'1': 'operations', '3': 2, '4': 3, '5': 11, '6': '.google.ads.googleads.v15.services.CustomInterestOperation', '8': {}, '10': 'operations'},
...
final $typed_data.Uint8List mutateCustomInterestsRequestDescriptor = $convert.base64Decode(
    ...
    'LnYxNS5zZXJ2aWNlcy5DdXN0b21JbnRlcmVzdE9wZXJhdGlvbkID4EECUgpvcGVyYXRpb25zEi'
...
const CustomInterestOperation$json = {
  ...
  '2': [
    ...
    {'1': 'create', '3': 1, '4': 1, '5': 11, '6': '.google.ads.googleads.v15.resources.CustomInterest', '9': 0, '10': 'create'},
    {'1': 'update', '3': 2, '4': 1, '5': 11, '6': '.google.ads.googleads.v15.resources.CustomInterest', '9': 0, '10': 'update'},
  ],
  '8': [
    {'1': 'operation'},
  ],
...
final $typed_data.Uint8List customInterestOperationDescriptor = $convert.base64Decode(
    ...
    'LmFkcy5nb29nbGVhZHMudjE1LnJlc291cmNlcy5DdXN0b21JbnRlcmVzdEgAUgZjcmVhdGUSTA'
...
const MutateCustomInterestsResponse$json = {
  ...
  '2': [
    {'1': 'results', '3': 2, '4': 3, '5': 11, '6': '.google.ads.googleads.v15.services.MutateCustomInterestResult', '10': 'results'},
  ],
};
...
final $typed_data.Uint8List mutateCustomInterestsResponseDescriptor = $convert.base64Decode(
    ...
    'xlLmFkcy5nb29nbGVhZHMudjE1LnNlcnZpY2VzLk11dGF0ZUN1c3RvbUludGVyZXN0UmVzdWx0'
    'UgdyZXN1bHRz');
