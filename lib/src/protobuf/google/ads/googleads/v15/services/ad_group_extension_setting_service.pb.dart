...
class MutateAdGroupExtensionSettingsRequest extends $pb.GeneratedMessage {
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(_omitMessageNames ? '' : 'MutateAdGroupExtensionSettingsRequest', package: const $pb.PackageName(_omitMessageNames ? '' : 'google.ads.googleads.v15.services'), createEmptyInstance: create)
...
class AdGroupExtensionSettingOperation extends $pb.GeneratedMessage {
  factory AdGroupExtensionSettingOperation({
    $2357.AdGroupExtensionSetting? create_1,
    $2357.AdGroupExtensionSetting? update,
    $core.String? remove,
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(_omitMessageNames ? '' : 'AdGroupExtensionSettingOperation', package: const $pb.PackageName(_omitMessageNames ? '' : 'google.ads.googleads.v15.services'), createEmptyInstance: create)
    ..oo(0, [1, 2, 3])
    ..aOM<$2357.AdGroupExtensionSetting>(1, _omitFieldNames ? '' : 'create', subBuilder: $2357.AdGroupExtensionSetting.create)
    ..aOM<$2357.AdGroupExtensionSetting>(2, _omitFieldNames ? '' : 'update', subBuilder: $2357.AdGroupExtensionSetting.create)
  ...
  /// extension setting.
  @$pb.TagNumber(1)
  $2357.AdGroupExtensionSetting get create_1 => $_getN(0);
  @$pb.TagNumber(1)
  set create_1($2357.AdGroupExtensionSetting v) { setField(1, v); }
  @$pb.TagNumber(1)
  $core.bool hasCreate_1() => $_has(0);
  @$pb.TagNumber(1)
  void clearCreate_1() => clearField(1);
  @$pb.TagNumber(1)
  $2357.AdGroupExtensionSetting ensureCreate_1() => $_ensure(0);

  /// Update operation: The ad group extension setting is expected to have a
  /// valid resource name.
  @$pb.TagNumber(2)
  $2357.AdGroupExtensionSetting get update => $_getN(1);
  @$pb.TagNumber(2)
  set update($2357.AdGroupExtensionSetting v) { setField(2, v); }
  @$pb.TagNumber(2)
  $core.bool hasUpdate() => $_has(1);
  @$pb.TagNumber(2)
  void clearUpdate() => clearField(2);
  @$pb.TagNumber(2)
  $2357.AdGroupExtensionSetting ensureUpdate() => $_ensure(1);
...
class MutateAdGroupExtensionSettingsResponse extends $pb.GeneratedMessage {
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(_omitMessageNames ? '' : 'MutateAdGroupExtensionSettingsResponse', package: const $pb.PackageName(_omitMessageNames ? '' : 'google.ads.googleads.v15.services'), createEmptyInstance: create)
...
class MutateAdGroupExtensionSettingResult extends $pb.GeneratedMessage {
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(_omitMessageNames ? '' : 'MutateAdGroupExtensionSettingResult', package: const $pb.PackageName(_omitMessageNames ? '' : 'google.ads.googleads.v15.services'), createEmptyInstance: create)
    ..aOS(1, _omitFieldNames ? '' : 'resourceName')
    ..aOM<$2357.AdGroupExtensionSetting>(2, _omitFieldNames ? '' : 'adGroupExtensionSetting', subBuilder: $2357.AdGroupExtensionSetting.create)
    ..hasRequiredFields = false
  ;
  ...
  /// "MUTABLE_RESOURCE".
  @$pb.TagNumber(2)
  $2357.AdGroupExtensionSetting get adGroupExtensionSetting => $_getN(1);
  @$pb.TagNumber(2)
  set adGroupExtensionSetting($2357.AdGroupExtensionSetting v) { setField(2, v); }
  @$pb.TagNumber(2)
  $core.bool hasAdGroupExtensionSetting() => $_has(1);
  @$pb.TagNumber(2)
  void clearAdGroupExtensionSetting() => clearField(2);
  @$pb.TagNumber(2)
  $2357.AdGroupExtensionSetting ensureAdGroupExtensionSetting() => $_ensure(1);
}
