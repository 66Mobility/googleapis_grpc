...
class MutateCampaignGroupsRequest extends $pb.GeneratedMessage {
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(_omitMessageNames ? '' : 'MutateCampaignGroupsRequest', package: const $pb.PackageName(_omitMessageNames ? '' : 'google.ads.googleads.v15.services'), createEmptyInstance: create)
...
class CampaignGroupOperation extends $pb.GeneratedMessage {
  factory CampaignGroupOperation({
    $2374.CampaignGroup? create_1,
    $2374.CampaignGroup? update,
    $core.String? remove,
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(_omitMessageNames ? '' : 'CampaignGroupOperation', package: const $pb.PackageName(_omitMessageNames ? '' : 'google.ads.googleads.v15.services'), createEmptyInstance: create)
    ..oo(0, [1, 2, 3])
    ..aOM<$2374.CampaignGroup>(1, _omitFieldNames ? '' : 'create', subBuilder: $2374.CampaignGroup.create)
    ..aOM<$2374.CampaignGroup>(2, _omitFieldNames ? '' : 'update', subBuilder: $2374.CampaignGroup.create)
  ...
  /// group.
  @$pb.TagNumber(1)
  $2374.CampaignGroup get create_1 => $_getN(0);
  @$pb.TagNumber(1)
  set create_1($2374.CampaignGroup v) { setField(1, v); }
  @$pb.TagNumber(1)
  $core.bool hasCreate_1() => $_has(0);
  @$pb.TagNumber(1)
  void clearCreate_1() => clearField(1);
  @$pb.TagNumber(1)
  $2374.CampaignGroup ensureCreate_1() => $_ensure(0);

  /// Update operation: The campaign group is expected to have a valid
  /// resource name.
  @$pb.TagNumber(2)
  $2374.CampaignGroup get update => $_getN(1);
  @$pb.TagNumber(2)
  set update($2374.CampaignGroup v) { setField(2, v); }
  @$pb.TagNumber(2)
  $core.bool hasUpdate() => $_has(1);
  @$pb.TagNumber(2)
  void clearUpdate() => clearField(2);
  @$pb.TagNumber(2)
  $2374.CampaignGroup ensureUpdate() => $_ensure(1);
...
class MutateCampaignGroupsResponse extends $pb.GeneratedMessage {
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(_omitMessageNames ? '' : 'MutateCampaignGroupsResponse', package: const $pb.PackageName(_omitMessageNames ? '' : 'google.ads.googleads.v15.services'), createEmptyInstance: create)
...
class MutateCampaignGroupResult extends $pb.GeneratedMessage {
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(_omitMessageNames ? '' : 'MutateCampaignGroupResult', package: const $pb.PackageName(_omitMessageNames ? '' : 'google.ads.googleads.v15.services'), createEmptyInstance: create)
    ..aOS(1, _omitFieldNames ? '' : 'resourceName')
    ..aOM<$2374.CampaignGroup>(2, _omitFieldNames ? '' : 'campaignGroup', subBuilder: $2374.CampaignGroup.create)
    ..hasRequiredFields = false
  ;
  ...
  /// "MUTABLE_RESOURCE".
  @$pb.TagNumber(2)
  $2374.CampaignGroup get campaignGroup => $_getN(1);
  @$pb.TagNumber(2)
  set campaignGroup($2374.CampaignGroup v) { setField(2, v); }
  @$pb.TagNumber(2)
  $core.bool hasCampaignGroup() => $_has(1);
  @$pb.TagNumber(2)
  void clearCampaignGroup() => clearField(2);
  @$pb.TagNumber(2)
  $2374.CampaignGroup ensureCampaignGroup() => $_ensure(1);
}
