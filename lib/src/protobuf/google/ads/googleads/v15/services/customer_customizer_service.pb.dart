...
class CustomerCustomizerOperation extends $pb.GeneratedMessage {
  factory CustomerCustomizerOperation({
    $2384.CustomerCustomizer? create_1,
    $core.String? remove,
  }) {
    final $result = create();
    if (create_1 != null) {
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(_omitMessageNames ? '' : 'CustomerCustomizerOperation', package: const $pb.PackageName(_omitMessageNames ? '' : 'google.ads.googleads.v15.services'), createEmptyInstance: create)
    ..oo(0, [1, 2])
    ..aOM<$2384.CustomerCustomizer>(1, _omitFieldNames ? '' : 'create', subBuilder: $2384.CustomerCustomizer.create)
  ...
  /// customizer
  @$pb.TagNumber(1)
  $2384.CustomerCustomizer get create_1 => $_getN(0);
  @$pb.TagNumber(1)
  set create_1($2384.CustomerCustomizer v) { setField(1, v); }
  @$pb.TagNumber(1)
  $core.bool hasCreate_1() => $_has(0);
  @$pb.TagNumber(1)
  void clearCreate_1() => clearField(1);
  @$pb.TagNumber(1)
  $2384.CustomerCustomizer ensureCreate_1() => $_ensure(0);
...
class MutateCustomerCustomizerResult extends $pb.GeneratedMessage {
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(_omitMessageNames ? '' : 'MutateCustomerCustomizerResult', package: const $pb.PackageName(_omitMessageNames ? '' : 'google.ads.googleads.v15.services'), createEmptyInstance: create)
    ...
    ..aOM<$2384.CustomerCustomizer>(2, _omitFieldNames ? '' : 'customerCustomizer', subBuilder: $2384.CustomerCustomizer.create)
    ..hasRequiredFields = false
  ;
  ...
  /// "MUTABLE_RESOURCE".
  @$pb.TagNumber(2)
  $2384.CustomerCustomizer get customerCustomizer => $_getN(1);
  @$pb.TagNumber(2)
  set customerCustomizer($2384.CustomerCustomizer v) { setField(2, v); }
  @$pb.TagNumber(2)
  $core.bool hasCustomerCustomizer() => $_has(1);
  @$pb.TagNumber(2)
  void clearCustomerCustomizer() => clearField(2);
  @$pb.TagNumber(2)
  $2384.CustomerCustomizer ensureCustomerCustomizer() => $_ensure(1);
}
