...
class FeedItemSetOperation extends $pb.GeneratedMessage {
  factory FeedItemSetOperation({
    $2396.FeedItemSet? create_1,
    $2396.FeedItemSet? update,
    $core.String? remove,
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(_omitMessageNames ? '' : 'FeedItemSetOperation', package: const $pb.PackageName(_omitMessageNames ? '' : 'google.ads.googleads.v15.services'), createEmptyInstance: create)
    ..oo(0, [1, 2, 3])
    ..aOM<$2396.FeedItemSet>(1, _omitFieldNames ? '' : 'create', subBuilder: $2396.FeedItemSet.create)
    ..aOM<$2396.FeedItemSet>(2, _omitFieldNames ? '' : 'update', subBuilder: $2396.FeedItemSet.create)
  ...
  @$pb.TagNumber(1)
  $2396.FeedItemSet get create_1 => $_getN(0);
  @$pb.TagNumber(1)
  set create_1($2396.FeedItemSet v) { setField(1, v); }
  @$pb.TagNumber(1)
  $core.bool hasCreate_1() => $_has(0);
  @$pb.TagNumber(1)
  void clearCreate_1() => clearField(1);
  @$pb.TagNumber(1)
  $2396.FeedItemSet ensureCreate_1() => $_ensure(0);

  /// Update operation: The feed item set is expected to have a valid resource
  /// name.
  @$pb.TagNumber(2)
  $2396.FeedItemSet get update => $_getN(1);
  @$pb.TagNumber(2)
  set update($2396.FeedItemSet v) { setField(2, v); }
  @$pb.TagNumber(2)
  $core.bool hasUpdate() => $_has(1);
  @$pb.TagNumber(2)
  void clearUpdate() => clearField(2);
  @$pb.TagNumber(2)
  $2396.FeedItemSet ensureUpdate() => $_ensure(1);
