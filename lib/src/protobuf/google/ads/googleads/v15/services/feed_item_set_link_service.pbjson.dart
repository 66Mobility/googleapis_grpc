...
const MutateFeedItemSetLinksRequest$json = {
  ...
  '2': [
    ...
    {'1': 'operations', '3': 2, '4': 3, '5': 11, '6': '.google.ads.googleads.v15.services.FeedItemSetLinkOperation', '8': {}, '10': 'operations'},
...
final $typed_data.Uint8List mutateFeedItemSetLinksRequestDescriptor = $convert.base64Decode(
    ...
    'cy52MTUuc2VydmljZXMuRmVlZEl0ZW1TZXRMaW5rT3BlcmF0aW9uQgPgQQJSCm9wZXJhdGlvbn'
...
const FeedItemSetLinkOperation$json = {
  ...
  '2': [
    {'1': 'create', '3': 1, '4': 1, '5': 11, '6': '.google.ads.googleads.v15.resources.FeedItemSetLink', '9': 0, '10': 'create'},
...
final $typed_data.Uint8List feedItemSetLinkOperationDescriptor = $convert.base64Decode(
    ...
    '5nb29nbGVhZHMudjE1LnJlc291cmNlcy5GZWVkSXRlbVNldExpbmtIAFIGY3JlYXRlEkcKBnJl'
...
const MutateFeedItemSetLinksResponse$json = {
  ...
  '2': [
    {'1': 'results', '3': 1, '4': 3, '5': 11, '6': '.google.ads.googleads.v15.services.MutateFeedItemSetLinkResult', '10': 'results'},
...
final $typed_data.Uint8List mutateFeedItemSetLinksResponseDescriptor = $convert.base64Decode(
    ...
    'dsZS5hZHMuZ29vZ2xlYWRzLnYxNS5zZXJ2aWNlcy5NdXRhdGVGZWVkSXRlbVNldExpbmtSZXN1'
