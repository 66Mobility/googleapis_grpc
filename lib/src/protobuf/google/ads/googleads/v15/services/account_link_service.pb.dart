...
class CreateAccountLinkRequest extends $pb.GeneratedMessage {
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(_omitMessageNames ? '' : 'CreateAccountLinkRequest', package: const $pb.PackageName(_omitMessageNames ? '' : 'google.ads.googleads.v15.services'), createEmptyInstance: create)
    ..aOS(1, _omitFieldNames ? '' : 'customerId')
    ..aOM<$2351.AccountLink>(2, _omitFieldNames ? '' : 'accountLink', subBuilder: $2351.AccountLink.create)
  ...
  @$pb.TagNumber(2)
  $2351.AccountLink get accountLink => $_getN(1);
  @$pb.TagNumber(2)
  set accountLink($2351.AccountLink v) { setField(2, v); }
  @$pb.TagNumber(2)
  $core.bool hasAccountLink() => $_has(1);
  @$pb.TagNumber(2)
  void clearAccountLink() => clearField(2);
  @$pb.TagNumber(2)
  $2351.AccountLink ensureAccountLink() => $_ensure(1);
}
...
class CreateAccountLinkResponse extends $pb.GeneratedMessage {
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(_omitMessageNames ? '' : 'CreateAccountLinkResponse', package: const $pb.PackageName(_omitMessageNames ? '' : 'google.ads.googleads.v15.services'), createEmptyInstance: create)
...
class MutateAccountLinkRequest extends $pb.GeneratedMessage {
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(_omitMessageNames ? '' : 'MutateAccountLinkRequest', package: const $pb.PackageName(_omitMessageNames ? '' : 'google.ads.googleads.v15.services'), createEmptyInstance: create)
    ..aOS(1, _omitFieldNames ? '' : 'customerId')
...
class AccountLinkOperation extends $pb.GeneratedMessage {
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(_omitMessageNames ? '' : 'AccountLinkOperation', package: const $pb.PackageName(_omitMessageNames ? '' : 'google.ads.googleads.v15.services'), createEmptyInstance: create)
    ..oo(0, [2, 3])
    ..aOM<$2351.AccountLink>(2, _omitFieldNames ? '' : 'update', subBuilder: $2351.AccountLink.create)
  ...
  @$pb.TagNumber(2)
  $2351.AccountLink get update => $_getN(0);
  @$pb.TagNumber(2)
  set update($2351.AccountLink v) { setField(2, v); }
  @$pb.TagNumber(2)
  $core.bool hasUpdate() => $_has(0);
  @$pb.TagNumber(2)
  void clearUpdate() => clearField(2);
  @$pb.TagNumber(2)
  $2351.AccountLink ensureUpdate() => $_ensure(0);
...
class MutateAccountLinkResponse extends $pb.GeneratedMessage {
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(_omitMessageNames ? '' : 'MutateAccountLinkResponse', package: const $pb.PackageName(_omitMessageNames ? '' : 'google.ads.googleads.v15.services'), createEmptyInstance: create)
...
class MutateAccountLinkResult extends $pb.GeneratedMessage {
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(_omitMessageNames ? '' : 'MutateAccountLinkResult', package: const $pb.PackageName(_omitMessageNames ? '' : 'google.ads.googleads.v15.services'), createEmptyInstance: create)
    ..aOS(1, _omitFieldNames ? '' : 'resourceName')
    ..hasRequiredFields = false
  ;
