...
class CampaignConversionGoalOperation extends $pb.GeneratedMessage {
  factory CampaignConversionGoalOperation({
    $2371.CampaignConversionGoal? update,
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(_omitMessageNames ? '' : 'CampaignConversionGoalOperation', package: const $pb.PackageName(_omitMessageNames ? '' : 'google.ads.googleads.v15.services'), createEmptyInstance: create)
    ..oo(0, [1])
    ..aOM<$2371.CampaignConversionGoal>(1, _omitFieldNames ? '' : 'update', subBuilder: $2371.CampaignConversionGoal.create)
  ...
  /// valid resource name.
  @$pb.TagNumber(1)
  $2371.CampaignConversionGoal get update => $_getN(0);
  @$pb.TagNumber(1)
  set update($2371.CampaignConversionGoal v) { setField(1, v); }
  @$pb.TagNumber(1)
  $core.bool hasUpdate() => $_has(0);
  @$pb.TagNumber(1)
  void clearUpdate() => clearField(1);
  @$pb.TagNumber(1)
  $2371.CampaignConversionGoal ensureUpdate() => $_ensure(0);
