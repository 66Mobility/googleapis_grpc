...
class CampaignCriterionOperation extends $pb.GeneratedMessage {
  factory CampaignCriterionOperation({
    $2215.CampaignCriterion? create_1,
    $2215.CampaignCriterion? update,
    $core.String? remove,
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(_omitMessageNames ? '' : 'CampaignCriterionOperation', package: const $pb.PackageName(_omitMessageNames ? '' : 'google.ads.googleads.v15.services'), createEmptyInstance: create)
    ..oo(0, [1, 2, 3])
    ..aOM<$2215.CampaignCriterion>(1, _omitFieldNames ? '' : 'create', subBuilder: $2215.CampaignCriterion.create)
    ..aOM<$2215.CampaignCriterion>(2, _omitFieldNames ? '' : 'update', subBuilder: $2215.CampaignCriterion.create)
  ...
  @$pb.TagNumber(1)
  $2215.CampaignCriterion get create_1 => $_getN(0);
  @$pb.TagNumber(1)
  set create_1($2215.CampaignCriterion v) { setField(1, v); }
  @$pb.TagNumber(1)
  $core.bool hasCreate_1() => $_has(0);
  @$pb.TagNumber(1)
  void clearCreate_1() => clearField(1);
  @$pb.TagNumber(1)
  $2215.CampaignCriterion ensureCreate_1() => $_ensure(0);

  /// Update operation: The criterion is expected to have a valid resource
  /// name.
  @$pb.TagNumber(2)
  $2215.CampaignCriterion get update => $_getN(1);
  @$pb.TagNumber(2)
  set update($2215.CampaignCriterion v) { setField(2, v); }
  @$pb.TagNumber(2)
  $core.bool hasUpdate() => $_has(1);
  @$pb.TagNumber(2)
  void clearUpdate() => clearField(2);
  @$pb.TagNumber(2)
  $2215.CampaignCriterion ensureUpdate() => $_ensure(1);
...
class MutateCampaignCriterionResult extends $pb.GeneratedMessage {
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(_omitMessageNames ? '' : 'MutateCampaignCriterionResult', package: const $pb.PackageName(_omitMessageNames ? '' : 'google.ads.googleads.v15.services'), createEmptyInstance: create)
    ...
    ..aOM<$2215.CampaignCriterion>(2, _omitFieldNames ? '' : 'campaignCriterion', subBuilder: $2215.CampaignCriterion.create)
    ..hasRequiredFields = false
  ;
  ...
  /// "MUTABLE_RESOURCE".
  @$pb.TagNumber(2)
  $2215.CampaignCriterion get campaignCriterion => $_getN(1);
  @$pb.TagNumber(2)
  set campaignCriterion($2215.CampaignCriterion v) { setField(2, v); }
  @$pb.TagNumber(2)
  $core.bool hasCampaignCriterion() => $_has(1);
  @$pb.TagNumber(2)
  void clearCampaignCriterion() => clearField(2);
  @$pb.TagNumber(2)
  $2215.CampaignCriterion ensureCampaignCriterion() => $_ensure(1);
}
