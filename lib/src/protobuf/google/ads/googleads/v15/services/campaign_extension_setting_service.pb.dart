...
class MutateCampaignExtensionSettingsRequest extends $pb.GeneratedMessage {
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(_omitMessageNames ? '' : 'MutateCampaignExtensionSettingsRequest', package: const $pb.PackageName(_omitMessageNames ? '' : 'google.ads.googleads.v15.services'), createEmptyInstance: create)
...
class CampaignExtensionSettingOperation extends $pb.GeneratedMessage {
  factory CampaignExtensionSettingOperation({
    $2373.CampaignExtensionSetting? create_1,
    $2373.CampaignExtensionSetting? update,
    $core.String? remove,
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(_omitMessageNames ? '' : 'CampaignExtensionSettingOperation', package: const $pb.PackageName(_omitMessageNames ? '' : 'google.ads.googleads.v15.services'), createEmptyInstance: create)
    ..oo(0, [1, 2, 3])
    ..aOM<$2373.CampaignExtensionSetting>(1, _omitFieldNames ? '' : 'create', subBuilder: $2373.CampaignExtensionSetting.create)
    ..aOM<$2373.CampaignExtensionSetting>(2, _omitFieldNames ? '' : 'update', subBuilder: $2373.CampaignExtensionSetting.create)
  ...
  /// extension setting.
  @$pb.TagNumber(1)
  $2373.CampaignExtensionSetting get create_1 => $_getN(0);
  @$pb.TagNumber(1)
  set create_1($2373.CampaignExtensionSetting v) { setField(1, v); }
  @$pb.TagNumber(1)
  $core.bool hasCreate_1() => $_has(0);
  @$pb.TagNumber(1)
  void clearCreate_1() => clearField(1);
  @$pb.TagNumber(1)
  $2373.CampaignExtensionSetting ensureCreate_1() => $_ensure(0);

  /// Update operation: The campaign extension setting is expected to have a
  /// valid resource name.
  @$pb.TagNumber(2)
  $2373.CampaignExtensionSetting get update => $_getN(1);
  @$pb.TagNumber(2)
  set update($2373.CampaignExtensionSetting v) { setField(2, v); }
  @$pb.TagNumber(2)
  $core.bool hasUpdate() => $_has(1);
  @$pb.TagNumber(2)
  void clearUpdate() => clearField(2);
  @$pb.TagNumber(2)
  $2373.CampaignExtensionSetting ensureUpdate() => $_ensure(1);
...
class MutateCampaignExtensionSettingsResponse extends $pb.GeneratedMessage {
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(_omitMessageNames ? '' : 'MutateCampaignExtensionSettingsResponse', package: const $pb.PackageName(_omitMessageNames ? '' : 'google.ads.googleads.v15.services'), createEmptyInstance: create)
...
class MutateCampaignExtensionSettingResult extends $pb.GeneratedMessage {
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(_omitMessageNames ? '' : 'MutateCampaignExtensionSettingResult', package: const $pb.PackageName(_omitMessageNames ? '' : 'google.ads.googleads.v15.services'), createEmptyInstance: create)
    ..aOS(1, _omitFieldNames ? '' : 'resourceName')
    ..aOM<$2373.CampaignExtensionSetting>(2, _omitFieldNames ? '' : 'campaignExtensionSetting', subBuilder: $2373.CampaignExtensionSetting.create)
    ..hasRequiredFields = false
  ;
  ...
  /// to "MUTABLE_RESOURCE".
  @$pb.TagNumber(2)
  $2373.CampaignExtensionSetting get campaignExtensionSetting => $_getN(1);
  @$pb.TagNumber(2)
  set campaignExtensionSetting($2373.CampaignExtensionSetting v) { setField(2, v); }
  @$pb.TagNumber(2)
  $core.bool hasCampaignExtensionSetting() => $_has(1);
  @$pb.TagNumber(2)
  void clearCampaignExtensionSetting() => clearField(2);
  @$pb.TagNumber(2)
  $2373.CampaignExtensionSetting ensureCampaignExtensionSetting() => $_ensure(1);
}
