...
const MutateCampaignConversionGoalsRequest$json = {
  ...
  '2': [
    ...
    {'1': 'operations', '3': 2, '4': 3, '5': 11, '6': '.google.ads.googleads.v15.services.CampaignConversionGoalOperation', '8': {}, '10': 'operations'},
...
final $typed_data.Uint8List mutateCampaignConversionGoalsRequestDescriptor = $convert.base64Decode(
    ...
    'b29nbGVhZHMudjE1LnNlcnZpY2VzLkNhbXBhaWduQ29udmVyc2lvbkdvYWxPcGVyYXRpb25CA+'
...
const CampaignConversionGoalOperation$json = {
  ...
  '2': [
    ...
    {'1': 'update', '3': 1, '4': 1, '5': 11, '6': '.google.ads.googleads.v15.resources.CampaignConversionGoal', '9': 0, '10': 'update'},
  ],
  '8': [
    {'1': 'operation'},
  ],
...
final $typed_data.Uint8List campaignConversionGoalOperationDescriptor = $convert.base64Decode(
    ...
    'Oi5nb29nbGUuYWRzLmdvb2dsZWFkcy52MTUucmVzb3VyY2VzLkNhbXBhaWduQ29udmVyc2lvbk'
...
const MutateCampaignConversionGoalsResponse$json = {
  ...
  '2': [
    {'1': 'results', '3': 1, '4': 3, '5': 11, '6': '.google.ads.googleads.v15.services.MutateCampaignConversionGoalResult', '10': 'results'},
  ],
};
...
final $typed_data.Uint8List mutateCampaignConversionGoalsResponseDescriptor = $convert.base64Decode(
    ...
    'syRS5nb29nbGUuYWRzLmdvb2dsZWFkcy52MTUuc2VydmljZXMuTXV0YXRlQ2FtcGFpZ25Db252'
