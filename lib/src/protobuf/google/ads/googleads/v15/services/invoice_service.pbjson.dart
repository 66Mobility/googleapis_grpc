...
const ListInvoicesRequest$json = {
  ...
  '2': [
    ...
    {'1': 'issue_month', '3': 4, '4': 1, '5': 14, '6': '.google.ads.googleads.v15.enums.MonthOfYearEnum.MonthOfYear', '8': {}, '10': 'issueMonth'},
  ],
};
...
final $typed_data.Uint8List listInvoicesRequestDescriptor = $convert.base64Decode(
    ...
    'UuYWRzLmdvb2dsZWFkcy52MTUuZW51bXMuTW9udGhPZlllYXJFbnVtLk1vbnRoT2ZZZWFyQgPg'
    'QQJSCmlzc3VlTW9udGg=');
...
const ListInvoicesResponse$json = {
  ...
  '2': [
    {'1': 'invoices', '3': 1, '4': 3, '5': 11, '6': '.google.ads.googleads.v15.resources.Invoice', '10': 'invoices'},
  ],
};
...
final $typed_data.Uint8List listInvoicesResponseDescriptor = $convert.base64Decode(
    ...
    '9vZ2xlYWRzLnYxNS5yZXNvdXJjZXMuSW52b2ljZVIIaW52b2ljZXM=');
