...
class GetGoogleAdsFieldRequest extends $pb.GeneratedMessage {
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(_omitMessageNames ? '' : 'GetGoogleAdsFieldRequest', package: const $pb.PackageName(_omitMessageNames ? '' : 'google.ads.googleads.v15.services'), createEmptyInstance: create)
...
class SearchGoogleAdsFieldsRequest extends $pb.GeneratedMessage {
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(_omitMessageNames ? '' : 'SearchGoogleAdsFieldsRequest', package: const $pb.PackageName(_omitMessageNames ? '' : 'google.ads.googleads.v15.services'), createEmptyInstance: create)
...
class SearchGoogleAdsFieldsResponse extends $pb.GeneratedMessage {
  factory SearchGoogleAdsFieldsResponse({
    $core.Iterable<$122.GoogleAdsField>? results,
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(_omitMessageNames ? '' : 'SearchGoogleAdsFieldsResponse', package: const $pb.PackageName(_omitMessageNames ? '' : 'google.ads.googleads.v15.services'), createEmptyInstance: create)
    ..pc<$122.GoogleAdsField>(1, _omitFieldNames ? '' : 'results', $pb.PbFieldType.PM, subBuilder: $122.GoogleAdsField.create)
  ...
  @$pb.TagNumber(1)
  $core.List<$122.GoogleAdsField> get results => $_getList(0);
