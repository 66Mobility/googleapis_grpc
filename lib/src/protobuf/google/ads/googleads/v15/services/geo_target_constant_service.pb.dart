...
class SuggestGeoTargetConstantsRequest_LocationNames extends $pb.GeneratedMessage {
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(_omitMessageNames ? '' : 'SuggestGeoTargetConstantsRequest.LocationNames', package: const $pb.PackageName(_omitMessageNames ? '' : 'google.ads.googleads.v15.services'), createEmptyInstance: create)
...
class SuggestGeoTargetConstantsRequest_GeoTargets extends $pb.GeneratedMessage {
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(_omitMessageNames ? '' : 'SuggestGeoTargetConstantsRequest.GeoTargets', package: const $pb.PackageName(_omitMessageNames ? '' : 'google.ads.googleads.v15.services'), createEmptyInstance: create)
...
class SuggestGeoTargetConstantsRequest extends $pb.GeneratedMessage {
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(_omitMessageNames ? '' : 'SuggestGeoTargetConstantsRequest', package: const $pb.PackageName(_omitMessageNames ? '' : 'google.ads.googleads.v15.services'), createEmptyInstance: create)
    ..oo(0, [1, 2])
...
class SuggestGeoTargetConstantsResponse extends $pb.GeneratedMessage {
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(_omitMessageNames ? '' : 'SuggestGeoTargetConstantsResponse', package: const $pb.PackageName(_omitMessageNames ? '' : 'google.ads.googleads.v15.services'), createEmptyInstance: create)
...
class GeoTargetConstantSuggestion extends $pb.GeneratedMessage {
  factory GeoTargetConstantSuggestion({
    ...
    $core.Iterable<$2415.GeoTargetConstant>? geoTargetConstantParents,
    $core.String? locale,
    $fixnum.Int64? reach,
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(_omitMessageNames ? '' : 'GeoTargetConstantSuggestion', package: const $pb.PackageName(_omitMessageNames ? '' : 'google.ads.googleads.v15.services'), createEmptyInstance: create)
    ..aOM<$2415.GeoTargetConstant>(4, _omitFieldNames ? '' : 'geoTargetConstant', subBuilder: $2415.GeoTargetConstant.create)
    ..pc<$2415.GeoTargetConstant>(5, _omitFieldNames ? '' : 'geoTargetConstantParents', $pb.PbFieldType.PM, subBuilder: $2415.GeoTargetConstant.create)
    ..aOS(6, _omitFieldNames ? '' : 'locale')
  ...
  @$pb.TagNumber(4)
  $2415.GeoTargetConstant get geoTargetConstant => $_getN(0);
  @$pb.TagNumber(4)
  set geoTargetConstant($2415.GeoTargetConstant v) { setField(4, v); }
  @$pb.TagNumber(4)
  $core.bool hasGeoTargetConstant() => $_has(0);
  @$pb.TagNumber(4)
  void clearGeoTargetConstant() => clearField(4);
  @$pb.TagNumber(4)
  $2415.GeoTargetConstant ensureGeoTargetConstant() => $_ensure(0);

  /// The list of parents of the geo target constant.
  @$pb.TagNumber(5)
  $core.List<$2415.GeoTargetConstant> get geoTargetConstantParents => $_getList(1);
