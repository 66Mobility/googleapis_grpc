...
import '../enums/smart_campaign_not_eligible_reason.pbenum.dart' as $2410;
import '../enums/smart_campaign_status.pbenum.dart' as $2411;
...
class SmartCampaignNotEligibleDetails extends $pb.GeneratedMessage {
  factory SmartCampaignNotEligibleDetails({
    $2410.SmartCampaignNotEligibleReasonEnum_SmartCampaignNotEligibleReason? notEligibleReason,
  }) {
    final $result = create();
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(_omitMessageNames ? '' : 'SmartCampaignNotEligibleDetails', package: const $pb.PackageName(_omitMessageNames ? '' : 'google.ads.googleads.v15.services'), createEmptyInstance: create)
    ..e<$2410.SmartCampaignNotEligibleReasonEnum_SmartCampaignNotEligibleReason>(1, _omitFieldNames ? '' : 'notEligibleReason', $pb.PbFieldType.OE, defaultOrMaker: $2410.SmartCampaignNotEligibleReasonEnum_SmartCampaignNotEligibleReason.UNSPECIFIED, valueOf: $2410.SmartCampaignNotEligibleReasonEnum_SmartCampaignNotEligibleReason.valueOf, enumValues: $2410.SmartCampaignNotEligibleReasonEnum_SmartCampaignNotEligibleReason.values)
    ..hasRequiredFields = false
  ;
  ...
  @$pb.TagNumber(1)
  $2410.SmartCampaignNotEligibleReasonEnum_SmartCampaignNotEligibleReason get notEligibleReason => $_getN(0);
  @$pb.TagNumber(1)
  set notEligibleReason($2410.SmartCampaignNotEligibleReasonEnum_SmartCampaignNotEligibleReason v) { setField(1, v); }
  @$pb.TagNumber(1)
...
class GetSmartCampaignStatusResponse extends $pb.GeneratedMessage {
  factory GetSmartCampaignStatusResponse({
    $2411.SmartCampaignStatusEnum_SmartCampaignStatus? smartCampaignStatus,
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(_omitMessageNames ? '' : 'GetSmartCampaignStatusResponse', package: const $pb.PackageName(_omitMessageNames ? '' : 'google.ads.googleads.v15.services'), createEmptyInstance: create)
    ..oo(0, [2, 3, 4, 5, 6])
    ..e<$2411.SmartCampaignStatusEnum_SmartCampaignStatus>(1, _omitFieldNames ? '' : 'smartCampaignStatus', $pb.PbFieldType.OE, defaultOrMaker: $2411.SmartCampaignStatusEnum_SmartCampaignStatus.UNSPECIFIED, valueOf: $2411.SmartCampaignStatusEnum_SmartCampaignStatus.valueOf, enumValues: $2411.SmartCampaignStatusEnum_SmartCampaignStatus.values)
  ...
  @$pb.TagNumber(1)
  $2411.SmartCampaignStatusEnum_SmartCampaignStatus get smartCampaignStatus => $_getN(0);
  @$pb.TagNumber(1)
  set smartCampaignStatus($2411.SmartCampaignStatusEnum_SmartCampaignStatus v) { setField(1, v); }
  @$pb.TagNumber(1)
...
class SmartCampaignSettingOperation extends $pb.GeneratedMessage {
  factory SmartCampaignSettingOperation({
    $2409.SmartCampaignSetting? update,
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(_omitMessageNames ? '' : 'SmartCampaignSettingOperation', package: const $pb.PackageName(_omitMessageNames ? '' : 'google.ads.googleads.v15.services'), createEmptyInstance: create)
    ..aOM<$2409.SmartCampaignSetting>(1, _omitFieldNames ? '' : 'update', subBuilder: $2409.SmartCampaignSetting.create)
  ...
  /// resource name.
  @$pb.TagNumber(1)
  $2409.SmartCampaignSetting get update => $_getN(0);
  @$pb.TagNumber(1)
  set update($2409.SmartCampaignSetting v) { setField(1, v); }
  @$pb.TagNumber(1)
  $core.bool hasUpdate() => $_has(0);
  @$pb.TagNumber(1)
  void clearUpdate() => clearField(1);
  @$pb.TagNumber(1)
  $2409.SmartCampaignSetting ensureUpdate() => $_ensure(0);
...
class MutateSmartCampaignSettingResult extends $pb.GeneratedMessage {
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(_omitMessageNames ? '' : 'MutateSmartCampaignSettingResult', package: const $pb.PackageName(_omitMessageNames ? '' : 'google.ads.googleads.v15.services'), createEmptyInstance: create)
    ..aOS(1, _omitFieldNames ? '' : 'resourceName')
    ..aOM<$2409.SmartCampaignSetting>(2, _omitFieldNames ? '' : 'smartCampaignSetting', subBuilder: $2409.SmartCampaignSetting.create)
    ..hasRequiredFields = false
  ;
  ...
  /// "MUTABLE_RESOURCE".
  @$pb.TagNumber(2)
  $2409.SmartCampaignSetting get smartCampaignSetting => $_getN(1);
  @$pb.TagNumber(2)
  set smartCampaignSetting($2409.SmartCampaignSetting v) { setField(2, v); }
  @$pb.TagNumber(2)
  $core.bool hasSmartCampaignSetting() => $_has(1);
  @$pb.TagNumber(2)
  void clearSmartCampaignSetting() => clearField(2);
  @$pb.TagNumber(2)
  $2409.SmartCampaignSetting ensureSmartCampaignSetting() => $_ensure(1);
}
