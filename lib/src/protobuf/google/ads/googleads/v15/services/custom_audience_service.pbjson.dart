...
const MutateCustomAudiencesRequest$json = {
  ...
  '2': [
    ...
    {'1': 'operations', '3': 2, '4': 3, '5': 11, '6': '.google.ads.googleads.v15.services.CustomAudienceOperation', '8': {}, '10': 'operations'},
...
final $typed_data.Uint8List mutateCustomAudiencesRequestDescriptor = $convert.base64Decode(
    ...
    'LnYxNS5zZXJ2aWNlcy5DdXN0b21BdWRpZW5jZU9wZXJhdGlvbkID4EECUgpvcGVyYXRpb25zEi'
...
const CustomAudienceOperation$json = {
  ...
  '2': [
    ...
    {'1': 'create', '3': 1, '4': 1, '5': 11, '6': '.google.ads.googleads.v15.resources.CustomAudience', '9': 0, '10': 'create'},
    {'1': 'update', '3': 2, '4': 1, '5': 11, '6': '.google.ads.googleads.v15.resources.CustomAudience', '9': 0, '10': 'update'},
...
final $typed_data.Uint8List customAudienceOperationDescriptor = $convert.base64Decode(
    ...
    'LmFkcy5nb29nbGVhZHMudjE1LnJlc291cmNlcy5DdXN0b21BdWRpZW5jZUgAUgZjcmVhdGUSTA'
    'oGdXBkYXRlGAIgASgLMjIuZ29vZ2xlLmFkcy5nb29nbGVhZHMudjE1LnJlc291cmNlcy5DdXN0'
...
const MutateCustomAudiencesResponse$json = {
  ...
  '2': [
    {'1': 'results', '3': 1, '4': 3, '5': 11, '6': '.google.ads.googleads.v15.services.MutateCustomAudienceResult', '10': 'results'},
  ],
};
...
final $typed_data.Uint8List mutateCustomAudiencesResponseDescriptor = $convert.base64Decode(
    ...
    'xlLmFkcy5nb29nbGVhZHMudjE1LnNlcnZpY2VzLk11dGF0ZUN1c3RvbUF1ZGllbmNlUmVzdWx0'
    'UgdyZXN1bHRz');
