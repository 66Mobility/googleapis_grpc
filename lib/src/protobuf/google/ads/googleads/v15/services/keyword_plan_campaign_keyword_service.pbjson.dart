...
const MutateKeywordPlanCampaignKeywordsRequest$json = {
  ...
  '2': [
    ...
    {'1': 'operations', '3': 2, '4': 3, '5': 11, '6': '.google.ads.googleads.v15.services.KeywordPlanCampaignKeywordOperation', '8': {}, '10': 'operations'},
...
final $typed_data.Uint8List mutateKeywordPlanCampaignKeywordsRequestDescriptor = $convert.base64Decode(
    ...
    'ZHMuZ29vZ2xlYWRzLnYxNS5zZXJ2aWNlcy5LZXl3b3JkUGxhbkNhbXBhaWduS2V5d29yZE9wZX'
...
const KeywordPlanCampaignKeywordOperation$json = {
  ...
  '2': [
    ...
    {'1': 'create', '3': 1, '4': 1, '5': 11, '6': '.google.ads.googleads.v15.resources.KeywordPlanCampaignKeyword', '9': 0, '10': 'create'},
    {'1': 'update', '3': 2, '4': 1, '5': 11, '6': '.google.ads.googleads.v15.resources.KeywordPlanCampaignKeyword', '9': 0, '10': 'update'},
...
final $typed_data.Uint8List keywordPlanCampaignKeywordOperationDescriptor = $convert.base64Decode(
    ...
    'ASgLMj4uZ29vZ2xlLmFkcy5nb29nbGVhZHMudjE1LnJlc291cmNlcy5LZXl3b3JkUGxhbkNhbX'
    'BhaWduS2V5d29yZEgAUgZjcmVhdGUSWAoGdXBkYXRlGAIgASgLMj4uZ29vZ2xlLmFkcy5nb29n'
    'bGVhZHMudjE1LnJlc291cmNlcy5LZXl3b3JkUGxhbkNhbXBhaWduS2V5d29yZEgAUgZ1cGRhdG'
...
const MutateKeywordPlanCampaignKeywordsResponse$json = {
  ...
  '2': [
    ...
    {'1': 'results', '3': 2, '4': 3, '5': 11, '6': '.google.ads.googleads.v15.services.MutateKeywordPlanCampaignKeywordResult', '10': 'results'},
  ],
};
...
final $typed_data.Uint8List mutateKeywordPlanCampaignKeywordsResponseDescriptor = $convert.base64Decode(
    ...
    'cnJvchJjCgdyZXN1bHRzGAIgAygLMkkuZ29vZ2xlLmFkcy5nb29nbGVhZHMudjE1LnNlcnZpY2'
