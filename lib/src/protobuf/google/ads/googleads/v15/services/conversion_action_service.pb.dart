...
class MutateConversionActionsRequest extends $pb.GeneratedMessage {
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(_omitMessageNames ? '' : 'MutateConversionActionsRequest', package: const $pb.PackageName(_omitMessageNames ? '' : 'google.ads.googleads.v15.services'), createEmptyInstance: create)
...
class ConversionActionOperation extends $pb.GeneratedMessage {
  factory ConversionActionOperation({
    $2377.ConversionAction? create_1,
    $2377.ConversionAction? update,
    $core.String? remove,
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(_omitMessageNames ? '' : 'ConversionActionOperation', package: const $pb.PackageName(_omitMessageNames ? '' : 'google.ads.googleads.v15.services'), createEmptyInstance: create)
    ..oo(0, [1, 2, 3])
    ..aOM<$2377.ConversionAction>(1, _omitFieldNames ? '' : 'create', subBuilder: $2377.ConversionAction.create)
    ..aOM<$2377.ConversionAction>(2, _omitFieldNames ? '' : 'update', subBuilder: $2377.ConversionAction.create)
  ...
  /// action.
  @$pb.TagNumber(1)
  $2377.ConversionAction get create_1 => $_getN(0);
  @$pb.TagNumber(1)
  set create_1($2377.ConversionAction v) { setField(1, v); }
  @$pb.TagNumber(1)
  $core.bool hasCreate_1() => $_has(0);
  @$pb.TagNumber(1)
  void clearCreate_1() => clearField(1);
  @$pb.TagNumber(1)
  $2377.ConversionAction ensureCreate_1() => $_ensure(0);

  /// Update operation: The conversion action is expected to have a valid
  /// resource name.
  @$pb.TagNumber(2)
  $2377.ConversionAction get update => $_getN(1);
  @$pb.TagNumber(2)
  set update($2377.ConversionAction v) { setField(2, v); }
  @$pb.TagNumber(2)
  $core.bool hasUpdate() => $_has(1);
  @$pb.TagNumber(2)
  void clearUpdate() => clearField(2);
  @$pb.TagNumber(2)
  $2377.ConversionAction ensureUpdate() => $_ensure(1);
...
class MutateConversionActionsResponse extends $pb.GeneratedMessage {
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(_omitMessageNames ? '' : 'MutateConversionActionsResponse', package: const $pb.PackageName(_omitMessageNames ? '' : 'google.ads.googleads.v15.services'), createEmptyInstance: create)
...
class MutateConversionActionResult extends $pb.GeneratedMessage {
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(_omitMessageNames ? '' : 'MutateConversionActionResult', package: const $pb.PackageName(_omitMessageNames ? '' : 'google.ads.googleads.v15.services'), createEmptyInstance: create)
    ..aOS(1, _omitFieldNames ? '' : 'resourceName')
    ..aOM<$2377.ConversionAction>(2, _omitFieldNames ? '' : 'conversionAction', subBuilder: $2377.ConversionAction.create)
    ..hasRequiredFields = false
  ;
  ...
  /// "MUTABLE_RESOURCE".
  @$pb.TagNumber(2)
  $2377.ConversionAction get conversionAction => $_getN(1);
  @$pb.TagNumber(2)
  set conversionAction($2377.ConversionAction v) { setField(2, v); }
  @$pb.TagNumber(2)
  $core.bool hasConversionAction() => $_has(1);
  @$pb.TagNumber(2)
  void clearConversionAction() => clearField(2);
  @$pb.TagNumber(2)
  $2377.ConversionAction ensureConversionAction() => $_ensure(1);
}
