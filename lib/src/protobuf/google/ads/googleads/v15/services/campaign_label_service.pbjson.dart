...
const MutateCampaignLabelsRequest$json = {
  ...
  '2': [
    ...
    {'1': 'operations', '3': 2, '4': 3, '5': 11, '6': '.google.ads.googleads.v15.services.CampaignLabelOperation', '8': {}, '10': 'operations'},
...
final $typed_data.Uint8List mutateCampaignLabelsRequestDescriptor = $convert.base64Decode(
    ...
    'djE1LnNlcnZpY2VzLkNhbXBhaWduTGFiZWxPcGVyYXRpb25CA+BBAlIKb3BlcmF0aW9ucxInCg'
...
const CampaignLabelOperation$json = {
  ...
  '2': [
    {'1': 'create', '3': 1, '4': 1, '5': 11, '6': '.google.ads.googleads.v15.resources.CampaignLabel', '9': 0, '10': 'create'},
...
final $typed_data.Uint8List campaignLabelOperationDescriptor = $convert.base64Decode(
    ...
    '9vZ2xlYWRzLnYxNS5yZXNvdXJjZXMuQ2FtcGFpZ25MYWJlbEgAUgZjcmVhdGUSRQoGcmVtb3Zl'
...
const MutateCampaignLabelsResponse$json = {
  ...
  '2': [
    ...
    {'1': 'results', '3': 2, '4': 3, '5': 11, '6': '.google.ads.googleads.v15.services.MutateCampaignLabelResult', '10': 'results'},
  ],
};
