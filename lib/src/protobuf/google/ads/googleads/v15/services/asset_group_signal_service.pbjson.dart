...
const MutateAssetGroupSignalsRequest$json = {
  ...
  '2': [
    ...
    {'1': 'operations', '3': 2, '4': 3, '5': 11, '6': '.google.ads.googleads.v15.services.AssetGroupSignalOperation', '8': {}, '10': 'operations'},
...
final $typed_data.Uint8List mutateAssetGroupSignalsRequestDescriptor = $convert.base64Decode(
    ...
    'ZHMudjE1LnNlcnZpY2VzLkFzc2V0R3JvdXBTaWduYWxPcGVyYXRpb25CA+BBAlIKb3BlcmF0aW'
...
const AssetGroupSignalOperation$json = {
  ...
  '2': [
    {'1': 'exempt_policy_violation_keys', '3': 3, '4': 3, '5': 11, '6': '.google.ads.googleads.v15.common.PolicyViolationKey', '8': {}, '10': 'exemptPolicyViolationKeys'},
    {'1': 'create', '3': 1, '4': 1, '5': 11, '6': '.google.ads.googleads.v15.resources.AssetGroupSignal', '9': 0, '10': 'create'},
...
final $typed_data.Uint8List assetGroupSignalOperationDescriptor = $convert.base64Decode(
    ...
    'tleXMYAyADKAsyMy5nb29nbGUuYWRzLmdvb2dsZWFkcy52MTUuY29tbW9uLlBvbGljeVZpb2xh'
    'dGlvbktleUID4EEBUhlleGVtcHRQb2xpY3lWaW9sYXRpb25LZXlzEk4KBmNyZWF0ZRgBIAEoCz'
    'I0Lmdvb2dsZS5hZHMuZ29vZ2xlYWRzLnYxNS5yZXNvdXJjZXMuQXNzZXRHcm91cFNpZ25hbEgA'
...
const MutateAssetGroupSignalsResponse$json = {
  ...
  '2': [
    {'1': 'results', '3': 1, '4': 3, '5': 11, '6': '.google.ads.googleads.v15.services.MutateAssetGroupSignalResult', '10': 'results'},
...
final $typed_data.Uint8List mutateAssetGroupSignalsResponseDescriptor = $convert.base64Decode(
    ...
    '9nbGUuYWRzLmdvb2dsZWFkcy52MTUuc2VydmljZXMuTXV0YXRlQXNzZXRHcm91cFNpZ25hbFJl'
...
const MutateAssetGroupSignalResult$json = {
  ...
  '2': [
    ...
    {'1': 'asset_group_signal', '3': 2, '4': 1, '5': 11, '6': '.google.ads.googleads.v15.resources.AssetGroupSignal', '10': 'assetGroupSignal'},
  ],
};
...
final $typed_data.Uint8List mutateAssetGroupSignalResultDescriptor = $convert.base64Decode(
    ...
    '52MTUucmVzb3VyY2VzLkFzc2V0R3JvdXBTaWduYWxSEGFzc2V0R3JvdXBTaWduYWw=');
