...
class CustomerFeedOperation extends $pb.GeneratedMessage {
  factory CustomerFeedOperation({
    $2387.CustomerFeed? create_1,
    $2387.CustomerFeed? update,
    $core.String? remove,
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(_omitMessageNames ? '' : 'CustomerFeedOperation', package: const $pb.PackageName(_omitMessageNames ? '' : 'google.ads.googleads.v15.services'), createEmptyInstance: create)
    ..oo(0, [1, 2, 3])
    ..aOM<$2387.CustomerFeed>(1, _omitFieldNames ? '' : 'create', subBuilder: $2387.CustomerFeed.create)
    ..aOM<$2387.CustomerFeed>(2, _omitFieldNames ? '' : 'update', subBuilder: $2387.CustomerFeed.create)
  ...
  @$pb.TagNumber(1)
  $2387.CustomerFeed get create_1 => $_getN(0);
  @$pb.TagNumber(1)
  set create_1($2387.CustomerFeed v) { setField(1, v); }
  @$pb.TagNumber(1)
  $core.bool hasCreate_1() => $_has(0);
  @$pb.TagNumber(1)
  void clearCreate_1() => clearField(1);
  @$pb.TagNumber(1)
  $2387.CustomerFeed ensureCreate_1() => $_ensure(0);

  /// Update operation: The customer feed is expected to have a valid resource
  /// name.
  @$pb.TagNumber(2)
  $2387.CustomerFeed get update => $_getN(1);
  @$pb.TagNumber(2)
  set update($2387.CustomerFeed v) { setField(2, v); }
  @$pb.TagNumber(2)
  $core.bool hasUpdate() => $_has(1);
  @$pb.TagNumber(2)
  void clearUpdate() => clearField(2);
  @$pb.TagNumber(2)
  $2387.CustomerFeed ensureUpdate() => $_ensure(1);
...
class MutateCustomerFeedResult extends $pb.GeneratedMessage {
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(_omitMessageNames ? '' : 'MutateCustomerFeedResult', package: const $pb.PackageName(_omitMessageNames ? '' : 'google.ads.googleads.v15.services'), createEmptyInstance: create)
    ...
    ..aOM<$2387.CustomerFeed>(2, _omitFieldNames ? '' : 'customerFeed', subBuilder: $2387.CustomerFeed.create)
    ..hasRequiredFields = false
  ;
  ...
  /// "MUTABLE_RESOURCE".
  @$pb.TagNumber(2)
  $2387.CustomerFeed get customerFeed => $_getN(1);
  @$pb.TagNumber(2)
  set customerFeed($2387.CustomerFeed v) { setField(2, v); }
  @$pb.TagNumber(2)
  $core.bool hasCustomerFeed() => $_has(1);
  @$pb.TagNumber(2)
  void clearCustomerFeed() => clearField(2);
  @$pb.TagNumber(2)
  $2387.CustomerFeed ensureCustomerFeed() => $_ensure(1);
}
