...
class MutateCustomerFeedsRequest extends $pb.GeneratedMessage {
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(_omitMessageNames ? '' : 'MutateCustomerFeedsRequest', package: const $pb.PackageName(_omitMessageNames ? '' : 'google.ads.googleads.v15.services'), createEmptyInstance: create)
...
class CustomerFeedOperation extends $pb.GeneratedMessage {
  factory CustomerFeedOperation({
    $2386.CustomerFeed? create_1,
    $2386.CustomerFeed? update,
    $core.String? remove,
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(_omitMessageNames ? '' : 'CustomerFeedOperation', package: const $pb.PackageName(_omitMessageNames ? '' : 'google.ads.googleads.v15.services'), createEmptyInstance: create)
    ..oo(0, [1, 2, 3])
    ..aOM<$2386.CustomerFeed>(1, _omitFieldNames ? '' : 'create', subBuilder: $2386.CustomerFeed.create)
    ..aOM<$2386.CustomerFeed>(2, _omitFieldNames ? '' : 'update', subBuilder: $2386.CustomerFeed.create)
  ...
  @$pb.TagNumber(1)
  $2386.CustomerFeed get create_1 => $_getN(0);
  @$pb.TagNumber(1)
  set create_1($2386.CustomerFeed v) { setField(1, v); }
  @$pb.TagNumber(1)
  $core.bool hasCreate_1() => $_has(0);
  @$pb.TagNumber(1)
  void clearCreate_1() => clearField(1);
  @$pb.TagNumber(1)
  $2386.CustomerFeed ensureCreate_1() => $_ensure(0);

  /// Update operation: The customer feed is expected to have a valid resource
  /// name.
  @$pb.TagNumber(2)
  $2386.CustomerFeed get update => $_getN(1);
  @$pb.TagNumber(2)
  set update($2386.CustomerFeed v) { setField(2, v); }
  @$pb.TagNumber(2)
  $core.bool hasUpdate() => $_has(1);
  @$pb.TagNumber(2)
  void clearUpdate() => clearField(2);
  @$pb.TagNumber(2)
  $2386.CustomerFeed ensureUpdate() => $_ensure(1);
...
class MutateCustomerFeedsResponse extends $pb.GeneratedMessage {
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(_omitMessageNames ? '' : 'MutateCustomerFeedsResponse', package: const $pb.PackageName(_omitMessageNames ? '' : 'google.ads.googleads.v15.services'), createEmptyInstance: create)
...
class MutateCustomerFeedResult extends $pb.GeneratedMessage {
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(_omitMessageNames ? '' : 'MutateCustomerFeedResult', package: const $pb.PackageName(_omitMessageNames ? '' : 'google.ads.googleads.v15.services'), createEmptyInstance: create)
    ..aOS(1, _omitFieldNames ? '' : 'resourceName')
    ..aOM<$2386.CustomerFeed>(2, _omitFieldNames ? '' : 'customerFeed', subBuilder: $2386.CustomerFeed.create)
    ..hasRequiredFields = false
  ;
  ...
  /// "MUTABLE_RESOURCE".
  @$pb.TagNumber(2)
  $2386.CustomerFeed get customerFeed => $_getN(1);
  @$pb.TagNumber(2)
  set customerFeed($2386.CustomerFeed v) { setField(2, v); }
  @$pb.TagNumber(2)
  $core.bool hasCustomerFeed() => $_has(1);
  @$pb.TagNumber(2)
  void clearCustomerFeed() => clearField(2);
  @$pb.TagNumber(2)
  $2386.CustomerFeed ensureCustomerFeed() => $_ensure(1);
}
