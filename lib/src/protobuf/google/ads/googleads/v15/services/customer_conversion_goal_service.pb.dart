...
class CustomerConversionGoalOperation extends $pb.GeneratedMessage {
  factory CustomerConversionGoalOperation({
    $2384.CustomerConversionGoal? update,
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(_omitMessageNames ? '' : 'CustomerConversionGoalOperation', package: const $pb.PackageName(_omitMessageNames ? '' : 'google.ads.googleads.v15.services'), createEmptyInstance: create)
    ..oo(0, [1])
    ..aOM<$2384.CustomerConversionGoal>(1, _omitFieldNames ? '' : 'update', subBuilder: $2384.CustomerConversionGoal.create)
  ...
  /// valid resource name.
  @$pb.TagNumber(1)
  $2384.CustomerConversionGoal get update => $_getN(0);
  @$pb.TagNumber(1)
  set update($2384.CustomerConversionGoal v) { setField(1, v); }
  @$pb.TagNumber(1)
  $core.bool hasUpdate() => $_has(0);
  @$pb.TagNumber(1)
  void clearUpdate() => clearField(1);
  @$pb.TagNumber(1)
  $2384.CustomerConversionGoal ensureUpdate() => $_ensure(0);
