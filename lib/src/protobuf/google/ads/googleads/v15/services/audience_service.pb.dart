...
class AudienceOperation extends $pb.GeneratedMessage {
  factory AudienceOperation({
    $2365.Audience? create_1,
    $2365.Audience? update,
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(_omitMessageNames ? '' : 'AudienceOperation', package: const $pb.PackageName(_omitMessageNames ? '' : 'google.ads.googleads.v15.services'), createEmptyInstance: create)
    ..oo(0, [1, 2])
    ..aOM<$2365.Audience>(1, _omitFieldNames ? '' : 'create', subBuilder: $2365.Audience.create)
    ..aOM<$2365.Audience>(2, _omitFieldNames ? '' : 'update', subBuilder: $2365.Audience.create)
  ...
  @$pb.TagNumber(1)
  $2365.Audience get create_1 => $_getN(0);
  @$pb.TagNumber(1)
  set create_1($2365.Audience v) { setField(1, v); }
  @$pb.TagNumber(1)
  $core.bool hasCreate_1() => $_has(0);
  @$pb.TagNumber(1)
  void clearCreate_1() => clearField(1);
  @$pb.TagNumber(1)
  $2365.Audience ensureCreate_1() => $_ensure(0);

  /// Update operation: The audience is expected to have a valid resource
  /// name.
  @$pb.TagNumber(2)
  $2365.Audience get update => $_getN(1);
  @$pb.TagNumber(2)
  set update($2365.Audience v) { setField(2, v); }
  @$pb.TagNumber(2)
  $core.bool hasUpdate() => $_has(1);
  @$pb.TagNumber(2)
  void clearUpdate() => clearField(2);
  @$pb.TagNumber(2)
  $2365.Audience ensureUpdate() => $_ensure(1);
...
class MutateAudienceResult extends $pb.GeneratedMessage {
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(_omitMessageNames ? '' : 'MutateAudienceResult', package: const $pb.PackageName(_omitMessageNames ? '' : 'google.ads.googleads.v15.services'), createEmptyInstance: create)
    ...
    ..aOM<$2365.Audience>(2, _omitFieldNames ? '' : 'audience', subBuilder: $2365.Audience.create)
    ..hasRequiredFields = false
  ;
  ...
  /// "MUTABLE_RESOURCE".
  @$pb.TagNumber(2)
  $2365.Audience get audience => $_getN(1);
  @$pb.TagNumber(2)
  set audience($2365.Audience v) { setField(2, v); }
  @$pb.TagNumber(2)
  $core.bool hasAudience() => $_has(1);
  @$pb.TagNumber(2)
  void clearAudience() => clearField(2);
  @$pb.TagNumber(2)
  $2365.Audience ensureAudience() => $_ensure(1);
}
