...
const UploadUserDataRequest$json = {
  ...
  '2': [
    ...
    {'1': 'operations', '3': 3, '4': 3, '5': 11, '6': '.google.ads.googleads.v15.services.UserDataOperation', '8': {}, '10': 'operations'},
    {'1': 'customer_match_user_list_metadata', '3': 2, '4': 1, '5': 11, '6': '.google.ads.googleads.v15.common.CustomerMatchUserListMetadata', '9': 0, '10': 'customerMatchUserListMetadata'},
  ],
  '8': [
    {'1': 'metadata'},
  ],
...
final $typed_data.Uint8List uploadUserDataRequestDescriptor = $convert.base64Decode(
    ...
    '9tZXJJZBJZCgpvcGVyYXRpb25zGAMgAygLMjQuZ29vZ2xlLmFkcy5nb29nbGVhZHMudjE1LnNl'
    ...
    'NS5jb21tb24uQ3VzdG9tZXJNYXRjaFVzZXJMaXN0TWV0YWRhdGFIAFIdY3VzdG9tZXJNYXRjaF'
...
final $typed_data.Uint8List userDataOperationDescriptor = $convert.base64Decode(
    ...
    'Fkcy52MTUuY29tbW9uLlVzZXJEYXRhSABSBmNyZWF0ZRJDCgZyZW1vdmUYAiABKAsyKS5nb29n'
    'bGUuYWRzLmdvb2dsZWFkcy52MTUuY29tbW9uLlVzZXJEYXRhSABSBnJlbW92ZUILCglvcGVyYX'
    'Rpb24=');
