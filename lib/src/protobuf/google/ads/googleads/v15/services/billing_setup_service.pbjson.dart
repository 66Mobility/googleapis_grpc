...
const MutateBillingSetupRequest$json = {
  ...
  '2': [
    ...
    {'1': 'operation', '3': 2, '4': 1, '5': 11, '6': '.google.ads.googleads.v15.services.BillingSetupOperation', '8': {}, '10': 'operation'},
  ],
};
...
final $typed_data.Uint8List mutateBillingSetupRequestDescriptor = $convert.base64Decode(
    ...
    'N1c3RvbWVySWQSWwoJb3BlcmF0aW9uGAIgASgLMjguZ29vZ2xlLmFkcy5nb29nbGVhZHMudjE1'
...
const BillingSetupOperation$json = {
  ...
  '2': [
    {'1': 'create', '3': 2, '4': 1, '5': 11, '6': '.google.ads.googleads.v15.resources.BillingSetup', '9': 0, '10': 'create'},
...
final $typed_data.Uint8List billingSetupOperationDescriptor = $convert.base64Decode(
    ...
    '9nbGVhZHMudjE1LnJlc291cmNlcy5CaWxsaW5nU2V0dXBIAFIGY3JlYXRlEkQKBnJlbW92ZRgB'
...
const MutateBillingSetupResponse$json = {
  ...
  '2': [
    {'1': 'result', '3': 1, '4': 1, '5': 11, '6': '.google.ads.googleads.v15.services.MutateBillingSetupResult', '10': 'result'},
  ],
};
...
final $typed_data.Uint8List mutateBillingSetupResponseDescriptor = $convert.base64Decode(
    ...
    'RzLmdvb2dsZWFkcy52MTUuc2VydmljZXMuTXV0YXRlQmlsbGluZ1NldHVwUmVzdWx0UgZyZXN1'
    'bHQ=');
