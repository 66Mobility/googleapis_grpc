...
const UploadConversionAdjustmentsRequest$json = {
  ...
  '2': [
    ...
    {'1': 'conversion_adjustments', '3': 2, '4': 3, '5': 11, '6': '.google.ads.googleads.v15.services.ConversionAdjustment', '8': {}, '10': 'conversionAdjustments'},
...
final $typed_data.Uint8List uploadConversionAdjustmentsRequestDescriptor = $convert.base64Decode(
    ...
    'b2dsZS5hZHMuZ29vZ2xlYWRzLnYxNS5zZXJ2aWNlcy5Db252ZXJzaW9uQWRqdXN0bWVudEID4E'
...
const UploadConversionAdjustmentsResponse$json = {
  ...
  '2': [
    ...
    {'1': 'results', '3': 2, '4': 3, '5': 11, '6': '.google.ads.googleads.v15.services.ConversionAdjustmentResult', '10': 'results'},
...
final $typed_data.Uint8List uploadConversionAdjustmentsResponseDescriptor = $convert.base64Decode(
    ...
    'CgdyZXN1bHRzGAIgAygLMj0uZ29vZ2xlLmFkcy5nb29nbGVhZHMudjE1LnNlcnZpY2VzLkNvbn'
...
const ConversionAdjustment$json = {
  ...
  '2': [
    {'1': 'gclid_date_time_pair', '3': 12, '4': 1, '5': 11, '6': '.google.ads.googleads.v15.services.GclidDateTimePair', '10': 'gclidDateTimePair'},
    ...
    {'1': 'adjustment_type', '3': 5, '4': 1, '5': 14, '6': '.google.ads.googleads.v15.enums.ConversionAdjustmentTypeEnum.ConversionAdjustmentType', '10': 'adjustmentType'},
    {'1': 'restatement_value', '3': 6, '4': 1, '5': 11, '6': '.google.ads.googleads.v15.services.RestatementValue', '10': 'restatementValue'},
    {'1': 'user_identifiers', '3': 10, '4': 3, '5': 11, '6': '.google.ads.googleads.v15.common.UserIdentifier', '10': 'userIdentifiers'},
...
final $typed_data.Uint8List conversionAdjustmentDescriptor = $convert.base64Decode(
    ...
    'dvb2dsZS5hZHMuZ29vZ2xlYWRzLnYxNS5zZXJ2aWNlcy5HY2xpZERhdGVUaW1lUGFpclIRZ2Ns'
    ...
    'R5cGUYBSABKA4yVS5nb29nbGUuYWRzLmdvb2dsZWFkcy52MTUuZW51bXMuQ29udmVyc2lvbkFk'
    'anVzdG1lbnRUeXBlRW51bS5Db252ZXJzaW9uQWRqdXN0bWVudFR5cGVSDmFkanVzdG1lbnRUeX'
    'BlEmAKEXJlc3RhdGVtZW50X3ZhbHVlGAYgASgLMjMuZ29vZ2xlLmFkcy5nb29nbGVhZHMudjE1'
    'LnNlcnZpY2VzLlJlc3RhdGVtZW50VmFsdWVSEHJlc3RhdGVtZW50VmFsdWUSWgoQdXNlcl9pZG'
    'VudGlmaWVycxgKIAMoCzIvLmdvb2dsZS5hZHMuZ29vZ2xlYWRzLnYxNS5jb21tb24uVXNlcklk'
...
const ConversionAdjustmentResult$json = {
  ...
  '2': [
    {'1': 'gclid_date_time_pair', '3': 9, '4': 1, '5': 11, '6': '.google.ads.googleads.v15.services.GclidDateTimePair', '10': 'gclidDateTimePair'},
...
final $typed_data.Uint8List conversionAdjustmentResultDescriptor = $convert.base64Decode(
    ...
    'EoCzI0Lmdvb2dsZS5hZHMuZ29vZ2xlYWRzLnYxNS5zZXJ2aWNlcy5HY2xpZERhdGVUaW1lUGFp'
    ...
    '90eXBlGAUgASgOMlUuZ29vZ2xlLmFkcy5nb29nbGVhZHMudjE1LmVudW1zLkNvbnZlcnNpb25B'
