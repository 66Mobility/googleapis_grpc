...
const MutateAssetGroupsRequest$json = {
  ...
  '2': [
    ...
    {'1': 'operations', '3': 2, '4': 3, '5': 11, '6': '.google.ads.googleads.v15.services.AssetGroupOperation', '8': {}, '10': 'operations'},
...
const AssetGroupOperation$json = {
  ...
  '2': [
    ...
    {'1': 'create', '3': 1, '4': 1, '5': 11, '6': '.google.ads.googleads.v15.resources.AssetGroup', '9': 0, '10': 'create'},
    {'1': 'update', '3': 2, '4': 1, '5': 11, '6': '.google.ads.googleads.v15.resources.AssetGroup', '9': 0, '10': 'update'},
...
final $typed_data.Uint8List assetGroupOperationDescriptor = $convert.base64Decode(
    ...
    'Lmdvb2dsZWFkcy52MTUucmVzb3VyY2VzLkFzc2V0R3JvdXBIAFIGY3JlYXRlEkgKBnVwZGF0ZR'
    'gCIAEoCzIuLmdvb2dsZS5hZHMuZ29vZ2xlYWRzLnYxNS5yZXNvdXJjZXMuQXNzZXRHcm91cEgA'
...
const MutateAssetGroupsResponse$json = {
  ...
  '2': [
    {'1': 'results', '3': 1, '4': 3, '5': 11, '6': '.google.ads.googleads.v15.services.MutateAssetGroupResult', '10': 'results'},
...
final $typed_data.Uint8List mutateAssetGroupsResponseDescriptor = $convert.base64Decode(
    ...
    'RzLmdvb2dsZWFkcy52MTUuc2VydmljZXMuTXV0YXRlQXNzZXRHcm91cFJlc3VsdFIHcmVzdWx0'
