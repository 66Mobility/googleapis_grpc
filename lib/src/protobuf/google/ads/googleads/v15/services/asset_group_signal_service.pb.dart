...
class AssetGroupSignalOperation extends $pb.GeneratedMessage {
  factory AssetGroupSignalOperation({
    $2364.AssetGroupSignal? create_1,
    $core.String? remove,
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(_omitMessageNames ? '' : 'AssetGroupSignalOperation', package: const $pb.PackageName(_omitMessageNames ? '' : 'google.ads.googleads.v15.services'), createEmptyInstance: create)
    ..oo(0, [1, 2])
    ..aOM<$2364.AssetGroupSignal>(1, _omitFieldNames ? '' : 'create', subBuilder: $2364.AssetGroupSignal.create)
    ..aOS(2, _omitFieldNames ? '' : 'remove')
    ..pc<$1825.PolicyViolationKey>(3, _omitFieldNames ? '' : 'exemptPolicyViolationKeys', $pb.PbFieldType.PM, subBuilder: $1825.PolicyViolationKey.create)
    ..hasRequiredFields = false
  ;
  ...
  /// signal.
  @$pb.TagNumber(1)
  $2364.AssetGroupSignal get create_1 => $_getN(0);
  @$pb.TagNumber(1)
  set create_1($2364.AssetGroupSignal v) { setField(1, v); }
  @$pb.TagNumber(1)
  $core.bool hasCreate_1() => $_has(0);
  @$pb.TagNumber(1)
  void clearCreate_1() => clearField(1);
  @$pb.TagNumber(1)
  $2364.AssetGroupSignal ensureCreate_1() => $_ensure(0);
  ...
  ///  certificates.
  @$pb.TagNumber(3)
  $core.List<$1825.PolicyViolationKey> get exemptPolicyViolationKeys => $_getList(2);
}
...
class MutateAssetGroupSignalResult extends $pb.GeneratedMessage {
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(_omitMessageNames ? '' : 'MutateAssetGroupSignalResult', package: const $pb.PackageName(_omitMessageNames ? '' : 'google.ads.googleads.v15.services'), createEmptyInstance: create)
    ...
    ..aOM<$2364.AssetGroupSignal>(2, _omitFieldNames ? '' : 'assetGroupSignal', subBuilder: $2364.AssetGroupSignal.create)
    ..hasRequiredFields = false
  ;
  ...
  /// "MUTABLE_RESOURCE".
  @$pb.TagNumber(2)
  $2364.AssetGroupSignal get assetGroupSignal => $_getN(1);
  @$pb.TagNumber(2)
  set assetGroupSignal($2364.AssetGroupSignal v) { setField(2, v); }
  @$pb.TagNumber(2)
  $core.bool hasAssetGroupSignal() => $_has(1);
  @$pb.TagNumber(2)
  void clearAssetGroupSignal() => clearField(2);
  @$pb.TagNumber(2)
  $2364.AssetGroupSignal ensureAssetGroupSignal() => $_ensure(1);
}
