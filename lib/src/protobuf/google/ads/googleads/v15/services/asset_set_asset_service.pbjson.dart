...
const MutateAssetSetAssetsRequest$json = {
  ...
  '2': [
    ...
    {'1': 'operations', '3': 2, '4': 3, '5': 11, '6': '.google.ads.googleads.v15.services.AssetSetAssetOperation', '8': {}, '10': 'operations'},
...
final $typed_data.Uint8List mutateAssetSetAssetsRequestDescriptor = $convert.base64Decode(
    ...
    'djE1LnNlcnZpY2VzLkFzc2V0U2V0QXNzZXRPcGVyYXRpb25CA+BBAlIKb3BlcmF0aW9ucxInCg'
...
const AssetSetAssetOperation$json = {
  ...
  '2': [
    {'1': 'create', '3': 1, '4': 1, '5': 11, '6': '.google.ads.googleads.v15.resources.AssetSetAsset', '9': 0, '10': 'create'},
...
final $typed_data.Uint8List assetSetAssetOperationDescriptor = $convert.base64Decode(
    ...
    '9vZ2xlYWRzLnYxNS5yZXNvdXJjZXMuQXNzZXRTZXRBc3NldEgAUgZjcmVhdGUSRQoGcmVtb3Zl'
...
const MutateAssetSetAssetsResponse$json = {
  ...
  '2': [
    {'1': 'results', '3': 1, '4': 3, '5': 11, '6': '.google.ads.googleads.v15.services.MutateAssetSetAssetResult', '10': 'results'},
...
final $typed_data.Uint8List mutateAssetSetAssetsResponseDescriptor = $convert.base64Decode(
    ...
    'UuYWRzLmdvb2dsZWFkcy52MTUuc2VydmljZXMuTXV0YXRlQXNzZXRTZXRBc3NldFJlc3VsdFIH'
...
const MutateAssetSetAssetResult$json = {
  ...
  '2': [
    ...
    {'1': 'asset_set_asset', '3': 2, '4': 1, '5': 11, '6': '.google.ads.googleads.v15.resources.AssetSetAsset', '10': 'assetSetAsset'},
  ],
};
...
final $typed_data.Uint8List mutateAssetSetAssetResultDescriptor = $convert.base64Decode(
    ...
    'Cg9hc3NldF9zZXRfYXNzZXQYAiABKAsyMS5nb29nbGUuYWRzLmdvb2dsZWFkcy52MTUucmVzb3'
