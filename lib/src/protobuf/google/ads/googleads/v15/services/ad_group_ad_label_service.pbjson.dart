...
const MutateAdGroupAdLabelsRequest$json = {
  ...
  '2': [
    ...
    {'1': 'operations', '3': 2, '4': 3, '5': 11, '6': '.google.ads.googleads.v15.services.AdGroupAdLabelOperation', '8': {}, '10': 'operations'},
...
final $typed_data.Uint8List mutateAdGroupAdLabelsRequestDescriptor = $convert.base64Decode(
    ...
    'LnYxNS5zZXJ2aWNlcy5BZEdyb3VwQWRMYWJlbE9wZXJhdGlvbkID4EECUgpvcGVyYXRpb25zEi'
...
const AdGroupAdLabelOperation$json = {
  ...
  '2': [
    {'1': 'create', '3': 1, '4': 1, '5': 11, '6': '.google.ads.googleads.v15.resources.AdGroupAdLabel', '9': 0, '10': 'create'},
...
final $typed_data.Uint8List adGroupAdLabelOperationDescriptor = $convert.base64Decode(
    ...
    'dvb2dsZWFkcy52MTUucmVzb3VyY2VzLkFkR3JvdXBBZExhYmVsSABSBmNyZWF0ZRJGCgZyZW1v'
...
const MutateAdGroupAdLabelsResponse$json = {
  ...
  '2': [
    ...
    {'1': 'results', '3': 2, '4': 3, '5': 11, '6': '.google.ads.googleads.v15.services.MutateAdGroupAdLabelResult', '10': 'results'},
  ],
};
...
final $typed_data.Uint8List mutateAdGroupAdLabelsResponseDescriptor = $convert.base64Decode(
    ...
    'bHRzGAIgAygLMj0uZ29vZ2xlLmFkcy5nb29nbGVhZHMudjE1LnNlcnZpY2VzLk11dGF0ZUFkR3'
