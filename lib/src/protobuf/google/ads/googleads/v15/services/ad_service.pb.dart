...
class GetAdRequest extends $pb.GeneratedMessage {
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(_omitMessageNames ? '' : 'GetAdRequest', package: const $pb.PackageName(_omitMessageNames ? '' : 'google.ads.googleads.v15.services'), createEmptyInstance: create)
...
class MutateAdsRequest extends $pb.GeneratedMessage {
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(_omitMessageNames ? '' : 'MutateAdsRequest', package: const $pb.PackageName(_omitMessageNames ? '' : 'google.ads.googleads.v15.services'), createEmptyInstance: create)
...
class AdOperation extends $pb.GeneratedMessage {
  factory AdOperation({
    ...
    $1825.PolicyValidationParameter? policyValidationParameter,
  }) {
    final $result = create();
    if (update != null) {
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(_omitMessageNames ? '' : 'AdOperation', package: const $pb.PackageName(_omitMessageNames ? '' : 'google.ads.googleads.v15.services'), createEmptyInstance: create)
    ..oo(0, [1])
    ..aOM<$41.Ad>(1, _omitFieldNames ? '' : 'update', subBuilder: $41.Ad.create)
    ..aOM<$2210.FieldMask>(2, _omitFieldNames ? '' : 'updateMask', subBuilder: $2210.FieldMask.create)
    ..aOM<$1825.PolicyValidationParameter>(3, _omitFieldNames ? '' : 'policyValidationParameter', subBuilder: $1825.PolicyValidationParameter.create)
    ..hasRequiredFields = false
  ;
  ...
  @$pb.TagNumber(1)
  $41.Ad get update => $_getN(0);
  @$pb.TagNumber(1)
  set update($41.Ad v) { setField(1, v); }
  @$pb.TagNumber(1)
  $core.bool hasUpdate() => $_has(0);
  @$pb.TagNumber(1)
  void clearUpdate() => clearField(1);
  @$pb.TagNumber(1)
  $41.Ad ensureUpdate() => $_ensure(0);
  ...
  @$pb.TagNumber(3)
  $1825.PolicyValidationParameter get policyValidationParameter => $_getN(2);
  @$pb.TagNumber(3)
  set policyValidationParameter($1825.PolicyValidationParameter v) { setField(3, v); }
  @$pb.TagNumber(3)
  $core.bool hasPolicyValidationParameter() => $_has(2);
  @$pb.TagNumber(3)
  void clearPolicyValidationParameter() => clearField(3);
  @$pb.TagNumber(3)
  $1825.PolicyValidationParameter ensurePolicyValidationParameter() => $_ensure(2);
}
...
class MutateAdsResponse extends $pb.GeneratedMessage {
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(_omitMessageNames ? '' : 'MutateAdsResponse', package: const $pb.PackageName(_omitMessageNames ? '' : 'google.ads.googleads.v15.services'), createEmptyInstance: create)
...
class MutateAdResult extends $pb.GeneratedMessage {
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(_omitMessageNames ? '' : 'MutateAdResult', package: const $pb.PackageName(_omitMessageNames ? '' : 'google.ads.googleads.v15.services'), createEmptyInstance: create)
    ..aOS(1, _omitFieldNames ? '' : 'resourceName')
    ..aOM<$41.Ad>(2, _omitFieldNames ? '' : 'ad', subBuilder: $41.Ad.create)
    ..hasRequiredFields = false
  ;
  ...
  @$pb.TagNumber(2)
  $41.Ad get ad => $_getN(1);
  @$pb.TagNumber(2)
  set ad($41.Ad v) { setField(2, v); }
  @$pb.TagNumber(2)
  $core.bool hasAd() => $_has(1);
  @$pb.TagNumber(2)
  void clearAd() => clearField(2);
  @$pb.TagNumber(2)
  $41.Ad ensureAd() => $_ensure(1);
}
