...
class CustomerNegativeCriterionOperation extends $pb.GeneratedMessage {
  factory CustomerNegativeCriterionOperation({
    $2388.CustomerNegativeCriterion? create_1,
    $core.String? remove,
  }) {
    final $result = create();
    if (create_1 != null) {
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(_omitMessageNames ? '' : 'CustomerNegativeCriterionOperation', package: const $pb.PackageName(_omitMessageNames ? '' : 'google.ads.googleads.v15.services'), createEmptyInstance: create)
    ..oo(0, [1, 2])
    ..aOM<$2388.CustomerNegativeCriterion>(1, _omitFieldNames ? '' : 'create', subBuilder: $2388.CustomerNegativeCriterion.create)
  ...
  @$pb.TagNumber(1)
  $2388.CustomerNegativeCriterion get create_1 => $_getN(0);
  @$pb.TagNumber(1)
  set create_1($2388.CustomerNegativeCriterion v) { setField(1, v); }
  @$pb.TagNumber(1)
  $core.bool hasCreate_1() => $_has(0);
  @$pb.TagNumber(1)
  void clearCreate_1() => clearField(1);
  @$pb.TagNumber(1)
  $2388.CustomerNegativeCriterion ensureCreate_1() => $_ensure(0);
...
class MutateCustomerNegativeCriteriaResult extends $pb.GeneratedMessage {
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(_omitMessageNames ? '' : 'MutateCustomerNegativeCriteriaResult', package: const $pb.PackageName(_omitMessageNames ? '' : 'google.ads.googleads.v15.services'), createEmptyInstance: create)
    ...
    ..aOM<$2388.CustomerNegativeCriterion>(2, _omitFieldNames ? '' : 'customerNegativeCriterion', subBuilder: $2388.CustomerNegativeCriterion.create)
    ..hasRequiredFields = false
  ;
  ...
  @$pb.TagNumber(2)
  $2388.CustomerNegativeCriterion get customerNegativeCriterion => $_getN(1);
  @$pb.TagNumber(2)
  set customerNegativeCriterion($2388.CustomerNegativeCriterion v) { setField(2, v); }
  @$pb.TagNumber(2)
  $core.bool hasCustomerNegativeCriterion() => $_has(1);
  @$pb.TagNumber(2)
  void clearCustomerNegativeCriterion() => clearField(2);
  @$pb.TagNumber(2)
  $2388.CustomerNegativeCriterion ensureCustomerNegativeCriterion() => $_ensure(1);
}
