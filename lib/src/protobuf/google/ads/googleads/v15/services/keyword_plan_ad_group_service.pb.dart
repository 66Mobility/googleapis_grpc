...
class KeywordPlanAdGroupOperation extends $pb.GeneratedMessage {
  factory KeywordPlanAdGroupOperation({
    $2400.KeywordPlanAdGroup? create_1,
    $2400.KeywordPlanAdGroup? update,
    $core.String? remove,
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(_omitMessageNames ? '' : 'KeywordPlanAdGroupOperation', package: const $pb.PackageName(_omitMessageNames ? '' : 'google.ads.googleads.v15.services'), createEmptyInstance: create)
    ..oo(0, [1, 2, 3])
    ..aOM<$2400.KeywordPlanAdGroup>(1, _omitFieldNames ? '' : 'create', subBuilder: $2400.KeywordPlanAdGroup.create)
    ..aOM<$2400.KeywordPlanAdGroup>(2, _omitFieldNames ? '' : 'update', subBuilder: $2400.KeywordPlanAdGroup.create)
  ...
  /// ad group.
  @$pb.TagNumber(1)
  $2400.KeywordPlanAdGroup get create_1 => $_getN(0);
  @$pb.TagNumber(1)
  set create_1($2400.KeywordPlanAdGroup v) { setField(1, v); }
  @$pb.TagNumber(1)
  $core.bool hasCreate_1() => $_has(0);
  @$pb.TagNumber(1)
  void clearCreate_1() => clearField(1);
  @$pb.TagNumber(1)
  $2400.KeywordPlanAdGroup ensureCreate_1() => $_ensure(0);

  /// Update operation: The Keyword Plan ad group is expected to have a valid
  /// resource name.
  @$pb.TagNumber(2)
  $2400.KeywordPlanAdGroup get update => $_getN(1);
  @$pb.TagNumber(2)
  set update($2400.KeywordPlanAdGroup v) { setField(2, v); }
  @$pb.TagNumber(2)
  $core.bool hasUpdate() => $_has(1);
  @$pb.TagNumber(2)
  void clearUpdate() => clearField(2);
  @$pb.TagNumber(2)
  $2400.KeywordPlanAdGroup ensureUpdate() => $_ensure(1);
