...
const MutateAdGroupExtensionSettingsRequest$json = {
  ...
  '2': [
    ...
    {'1': 'operations', '3': 2, '4': 3, '5': 11, '6': '.google.ads.googleads.v15.services.AdGroupExtensionSettingOperation', '8': {}, '10': 'operations'},
...
final $typed_data.Uint8List mutateAdGroupExtensionSettingsRequestDescriptor = $convert.base64Decode(
    ...
    'Z29vZ2xlYWRzLnYxNS5zZXJ2aWNlcy5BZEdyb3VwRXh0ZW5zaW9uU2V0dGluZ09wZXJhdGlvbk'
...
const AdGroupExtensionSettingOperation$json = {
  ...
  '2': [
    ...
    {'1': 'create', '3': 1, '4': 1, '5': 11, '6': '.google.ads.googleads.v15.resources.AdGroupExtensionSetting', '9': 0, '10': 'create'},
    {'1': 'update', '3': 2, '4': 1, '5': 11, '6': '.google.ads.googleads.v15.resources.AdGroupExtensionSetting', '9': 0, '10': 'update'},
...
final $typed_data.Uint8List adGroupExtensionSettingOperationDescriptor = $convert.base64Decode(
    ...
    'cGUSVQoGY3JlYXRlGAEgASgLMjsuZ29vZ2xlLmFkcy5nb29nbGVhZHMudjE1LnJlc291cmNlcy'
    '5BZEdyb3VwRXh0ZW5zaW9uU2V0dGluZ0gAUgZjcmVhdGUSVQoGdXBkYXRlGAIgASgLMjsuZ29v'
    'Z2xlLmFkcy5nb29nbGVhZHMudjE1LnJlc291cmNlcy5BZEdyb3VwRXh0ZW5zaW9uU2V0dGluZ0'
...
const MutateAdGroupExtensionSettingsResponse$json = {
  ...
  '2': [
    ...
    {'1': 'results', '3': 2, '4': 3, '5': 11, '6': '.google.ads.googleads.v15.services.MutateAdGroupExtensionSettingResult', '10': 'results'},
  ],
};
...
final $typed_data.Uint8List mutateAdGroupExtensionSettingsResponseDescriptor = $convert.base64Decode(
    ...
    'chJgCgdyZXN1bHRzGAIgAygLMkYuZ29vZ2xlLmFkcy5nb29nbGVhZHMudjE1LnNlcnZpY2VzLk'
...
const MutateAdGroupExtensionSettingResult$json = {
  ...
  '2': [
    ...
    {'1': 'ad_group_extension_setting', '3': 2, '4': 1, '5': 11, '6': '.google.ads.googleads.v15.resources.AdGroupExtensionSetting', '10': 'adGroupExtensionSetting'},
  ],
};
...
final $typed_data.Uint8List mutateAdGroupExtensionSettingResultDescriptor = $convert.base64Decode(
    ...
    'suZ29vZ2xlLmFkcy5nb29nbGVhZHMudjE1LnJlc291cmNlcy5BZEdyb3VwRXh0ZW5zaW9uU2V0'
