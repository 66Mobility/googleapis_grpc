...
const MutateConversionGoalCampaignConfigsRequest$json = {
  ...
  '2': [
    ...
    {'1': 'operations', '3': 2, '4': 3, '5': 11, '6': '.google.ads.googleads.v15.services.ConversionGoalCampaignConfigOperation', '8': {}, '10': 'operations'},
...
final $typed_data.Uint8List mutateConversionGoalCampaignConfigsRequestDescriptor = $convert.base64Decode(
    ...
    'LmFkcy5nb29nbGVhZHMudjE1LnNlcnZpY2VzLkNvbnZlcnNpb25Hb2FsQ2FtcGFpZ25Db25maW'
...
const ConversionGoalCampaignConfigOperation$json = {
  ...
  '2': [
    ...
    {'1': 'update', '3': 1, '4': 1, '5': 11, '6': '.google.ads.googleads.v15.resources.ConversionGoalCampaignConfig', '9': 0, '10': 'update'},
  ],
  '8': [
    {'1': 'operation'},
  ],
...
final $typed_data.Uint8List conversionGoalCampaignConfigOperationDescriptor = $convert.base64Decode(
    ...
    'ASABKAsyQC5nb29nbGUuYWRzLmdvb2dsZWFkcy52MTUucmVzb3VyY2VzLkNvbnZlcnNpb25Hb2'
...
const MutateConversionGoalCampaignConfigsResponse$json = {
  ...
  '2': [
    {'1': 'results', '3': 1, '4': 3, '5': 11, '6': '.google.ads.googleads.v15.services.MutateConversionGoalCampaignConfigResult', '10': 'results'},
  ],
};
...
final $typed_data.Uint8List mutateConversionGoalCampaignConfigsResponseDescriptor = $convert.base64Decode(
    ...
    'MYASADKAsySy5nb29nbGUuYWRzLmdvb2dsZWFkcy52MTUuc2VydmljZXMuTXV0YXRlQ29udmVy'
...
const MutateConversionGoalCampaignConfigResult$json = {
  ...
  '2': [
    ...
    {'1': 'conversion_goal_campaign_config', '3': 2, '4': 1, '5': 11, '6': '.google.ads.googleads.v15.resources.ConversionGoalCampaignConfig', '10': 'conversionGoalCampaignConfig'},
  ],
};
...
final $typed_data.Uint8List mutateConversionGoalCampaignConfigResultDescriptor = $convert.base64Decode(
    ...
    'duX2NvbmZpZxgCIAEoCzJALmdvb2dsZS5hZHMuZ29vZ2xlYWRzLnYxNS5yZXNvdXJjZXMuQ29u'
