...
class CampaignOperation extends $pb.GeneratedMessage {
  factory CampaignOperation({
    $2213.Campaign? create_1,
    $2213.Campaign? update,
    $core.String? remove,
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(_omitMessageNames ? '' : 'CampaignOperation', package: const $pb.PackageName(_omitMessageNames ? '' : 'google.ads.googleads.v15.services'), createEmptyInstance: create)
    ..oo(0, [1, 2, 3])
    ..aOM<$2213.Campaign>(1, _omitFieldNames ? '' : 'create', subBuilder: $2213.Campaign.create)
    ..aOM<$2213.Campaign>(2, _omitFieldNames ? '' : 'update', subBuilder: $2213.Campaign.create)
  ...
  @$pb.TagNumber(1)
  $2213.Campaign get create_1 => $_getN(0);
  @$pb.TagNumber(1)
  set create_1($2213.Campaign v) { setField(1, v); }
  @$pb.TagNumber(1)
  $core.bool hasCreate_1() => $_has(0);
  @$pb.TagNumber(1)
  void clearCreate_1() => clearField(1);
  @$pb.TagNumber(1)
  $2213.Campaign ensureCreate_1() => $_ensure(0);

  /// Update operation: The campaign is expected to have a valid
  /// resource name.
  @$pb.TagNumber(2)
  $2213.Campaign get update => $_getN(1);
  @$pb.TagNumber(2)
  set update($2213.Campaign v) { setField(2, v); }
  @$pb.TagNumber(2)
  $core.bool hasUpdate() => $_has(1);
  @$pb.TagNumber(2)
  void clearUpdate() => clearField(2);
  @$pb.TagNumber(2)
  $2213.Campaign ensureUpdate() => $_ensure(1);
