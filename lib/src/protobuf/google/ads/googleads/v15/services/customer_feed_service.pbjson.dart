...
const MutateCustomerFeedsRequest$json = {
  ...
  '2': [
    ...
    {'1': 'operations', '3': 2, '4': 3, '5': 11, '6': '.google.ads.googleads.v15.services.CustomerFeedOperation', '8': {}, '10': 'operations'},
...
final $typed_data.Uint8List mutateCustomerFeedsRequestDescriptor = $convert.base64Decode(
    ...
    'MTUuc2VydmljZXMuQ3VzdG9tZXJGZWVkT3BlcmF0aW9uQgPgQQJSCm9wZXJhdGlvbnMSJwoPcG'
...
const CustomerFeedOperation$json = {
  ...
  '2': [
    ...
    {'1': 'create', '3': 1, '4': 1, '5': 11, '6': '.google.ads.googleads.v15.resources.CustomerFeed', '9': 0, '10': 'create'},
    {'1': 'update', '3': 2, '4': 1, '5': 11, '6': '.google.ads.googleads.v15.resources.CustomerFeed', '9': 0, '10': 'update'},
...
final $typed_data.Uint8List customerFeedOperationDescriptor = $convert.base64Decode(
    ...
    'ZHMuZ29vZ2xlYWRzLnYxNS5yZXNvdXJjZXMuQ3VzdG9tZXJGZWVkSABSBmNyZWF0ZRJKCgZ1cG'
    'RhdGUYAiABKAsyMC5nb29nbGUuYWRzLmdvb2dsZWFkcy52MTUucmVzb3VyY2VzLkN1c3RvbWVy'
...
const MutateCustomerFeedsResponse$json = {
  ...
  '2': [
    ...
    {'1': 'results', '3': 2, '4': 3, '5': 11, '6': '.google.ads.googleads.v15.services.MutateCustomerFeedResult', '10': 'results'},
  ],
};
...
final $typed_data.Uint8List mutateCustomerFeedsResponseDescriptor = $convert.base64Decode(
    ...
    'cxgCIAMoCzI7Lmdvb2dsZS5hZHMuZ29vZ2xlYWRzLnYxNS5zZXJ2aWNlcy5NdXRhdGVDdXN0b2'
...
const MutateCustomerFeedResult$json = {
  ...
  '2': [
    ...
    {'1': 'customer_feed', '3': 2, '4': 1, '5': 11, '6': '.google.ads.googleads.v15.resources.CustomerFeed', '10': 'customerFeed'},
  ],
};
...
final $typed_data.Uint8List mutateCustomerFeedResultDescriptor = $convert.base64Decode(
    ...
    'Y3VzdG9tZXJfZmVlZBgCIAEoCzIwLmdvb2dsZS5hZHMuZ29vZ2xlYWRzLnYxNS5yZXNvdXJjZX'
