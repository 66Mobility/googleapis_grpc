...
const MutateAdGroupBidModifiersRequest$json = {
  ...
  '2': [
    ...
    {'1': 'operations', '3': 2, '4': 3, '5': 11, '6': '.google.ads.googleads.v15.services.AdGroupBidModifierOperation', '8': {}, '10': 'operations'},
...
final $typed_data.Uint8List mutateAdGroupBidModifiersRequestDescriptor = $convert.base64Decode(
    ...
    'ZWFkcy52MTUuc2VydmljZXMuQWRHcm91cEJpZE1vZGlmaWVyT3BlcmF0aW9uQgPgQQJSCm9wZX'
...
const AdGroupBidModifierOperation$json = {
  ...
  '2': [
    ...
    {'1': 'create', '3': 1, '4': 1, '5': 11, '6': '.google.ads.googleads.v15.resources.AdGroupBidModifier', '9': 0, '10': 'create'},
    {'1': 'update', '3': 2, '4': 1, '5': 11, '6': '.google.ads.googleads.v15.resources.AdGroupBidModifier', '9': 0, '10': 'update'},
...
final $typed_data.Uint8List adGroupBidModifierOperationDescriptor = $convert.base64Decode(
    ...
    'b2dsZS5hZHMuZ29vZ2xlYWRzLnYxNS5yZXNvdXJjZXMuQWRHcm91cEJpZE1vZGlmaWVySABSBm'
...
const MutateAdGroupBidModifiersResponse$json = {
  ...
  '2': [
    ...
    {'1': 'results', '3': 2, '4': 3, '5': 11, '6': '.google.ads.googleads.v15.services.MutateAdGroupBidModifierResult', '10': 'results'},
  ],
};
...
const MutateAdGroupBidModifierResult$json = {
  ...
  '2': [
    ...
    {'1': 'ad_group_bid_modifier', '3': 2, '4': 1, '5': 11, '6': '.google.ads.googleads.v15.resources.AdGroupBidModifier', '10': 'adGroupBidModifier'},
  ],
};
...
final $typed_data.Uint8List mutateAdGroupBidModifierResultDescriptor = $convert.base64Decode(
    ...
    '9nbGVhZHMudjE1LnJlc291cmNlcy5BZEdyb3VwQmlkTW9kaWZpZXJSEmFkR3JvdXBCaWRNb2Rp'
    'Zmllcg==');
