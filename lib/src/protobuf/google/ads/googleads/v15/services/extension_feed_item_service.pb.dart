...
class MutateExtensionFeedItemsRequest extends $pb.GeneratedMessage {
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(_omitMessageNames ? '' : 'MutateExtensionFeedItemsRequest', package: const $pb.PackageName(_omitMessageNames ? '' : 'google.ads.googleads.v15.services'), createEmptyInstance: create)
...
class ExtensionFeedItemOperation extends $pb.GeneratedMessage {
  factory ExtensionFeedItemOperation({
    $2394.ExtensionFeedItem? create_1,
    $2394.ExtensionFeedItem? update,
    $core.String? remove,
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(_omitMessageNames ? '' : 'ExtensionFeedItemOperation', package: const $pb.PackageName(_omitMessageNames ? '' : 'google.ads.googleads.v15.services'), createEmptyInstance: create)
    ..oo(0, [1, 2, 3])
    ..aOM<$2394.ExtensionFeedItem>(1, _omitFieldNames ? '' : 'create', subBuilder: $2394.ExtensionFeedItem.create)
    ..aOM<$2394.ExtensionFeedItem>(2, _omitFieldNames ? '' : 'update', subBuilder: $2394.ExtensionFeedItem.create)
  ...
  /// feed item.
  @$pb.TagNumber(1)
  $2394.ExtensionFeedItem get create_1 => $_getN(0);
  @$pb.TagNumber(1)
  set create_1($2394.ExtensionFeedItem v) { setField(1, v); }
  @$pb.TagNumber(1)
  $core.bool hasCreate_1() => $_has(0);
  @$pb.TagNumber(1)
  void clearCreate_1() => clearField(1);
  @$pb.TagNumber(1)
  $2394.ExtensionFeedItem ensureCreate_1() => $_ensure(0);

  /// Update operation: The extension feed item is expected to have a
  /// valid resource name.
  @$pb.TagNumber(2)
  $2394.ExtensionFeedItem get update => $_getN(1);
  @$pb.TagNumber(2)
  set update($2394.ExtensionFeedItem v) { setField(2, v); }
  @$pb.TagNumber(2)
  $core.bool hasUpdate() => $_has(1);
  @$pb.TagNumber(2)
  void clearUpdate() => clearField(2);
  @$pb.TagNumber(2)
  $2394.ExtensionFeedItem ensureUpdate() => $_ensure(1);
...
class MutateExtensionFeedItemsResponse extends $pb.GeneratedMessage {
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(_omitMessageNames ? '' : 'MutateExtensionFeedItemsResponse', package: const $pb.PackageName(_omitMessageNames ? '' : 'google.ads.googleads.v15.services'), createEmptyInstance: create)
...
class MutateExtensionFeedItemResult extends $pb.GeneratedMessage {
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(_omitMessageNames ? '' : 'MutateExtensionFeedItemResult', package: const $pb.PackageName(_omitMessageNames ? '' : 'google.ads.googleads.v15.services'), createEmptyInstance: create)
    ..aOS(1, _omitFieldNames ? '' : 'resourceName')
    ..aOM<$2394.ExtensionFeedItem>(2, _omitFieldNames ? '' : 'extensionFeedItem', subBuilder: $2394.ExtensionFeedItem.create)
    ..hasRequiredFields = false
  ;
  ...
  /// "MUTABLE_RESOURCE".
  @$pb.TagNumber(2)
  $2394.ExtensionFeedItem get extensionFeedItem => $_getN(1);
  @$pb.TagNumber(2)
  set extensionFeedItem($2394.ExtensionFeedItem v) { setField(2, v); }
  @$pb.TagNumber(2)
  $core.bool hasExtensionFeedItem() => $_has(1);
  @$pb.TagNumber(2)
  void clearExtensionFeedItem() => clearField(2);
  @$pb.TagNumber(2)
  $2394.ExtensionFeedItem ensureExtensionFeedItem() => $_ensure(1);
}
