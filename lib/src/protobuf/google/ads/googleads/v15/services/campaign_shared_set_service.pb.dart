...
class CampaignSharedSetOperation extends $pb.GeneratedMessage {
  factory CampaignSharedSetOperation({
    $2376.CampaignSharedSet? create_1,
    $core.String? remove,
  }) {
    final $result = create();
    if (create_1 != null) {
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(_omitMessageNames ? '' : 'CampaignSharedSetOperation', package: const $pb.PackageName(_omitMessageNames ? '' : 'google.ads.googleads.v15.services'), createEmptyInstance: create)
    ..oo(0, [1, 3])
    ..aOM<$2376.CampaignSharedSet>(1, _omitFieldNames ? '' : 'create', subBuilder: $2376.CampaignSharedSet.create)
  ...
  /// shared set.
  @$pb.TagNumber(1)
  $2376.CampaignSharedSet get create_1 => $_getN(0);
  @$pb.TagNumber(1)
  set create_1($2376.CampaignSharedSet v) { setField(1, v); }
  @$pb.TagNumber(1)
  $core.bool hasCreate_1() => $_has(0);
  @$pb.TagNumber(1)
  void clearCreate_1() => clearField(1);
  @$pb.TagNumber(1)
  $2376.CampaignSharedSet ensureCreate_1() => $_ensure(0);
...
class MutateCampaignSharedSetResult extends $pb.GeneratedMessage {
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(_omitMessageNames ? '' : 'MutateCampaignSharedSetResult', package: const $pb.PackageName(_omitMessageNames ? '' : 'google.ads.googleads.v15.services'), createEmptyInstance: create)
    ...
    ..aOM<$2376.CampaignSharedSet>(2, _omitFieldNames ? '' : 'campaignSharedSet', subBuilder: $2376.CampaignSharedSet.create)
    ..hasRequiredFields = false
  ;
  ...
  /// "MUTABLE_RESOURCE".
  @$pb.TagNumber(2)
  $2376.CampaignSharedSet get campaignSharedSet => $_getN(1);
  @$pb.TagNumber(2)
  set campaignSharedSet($2376.CampaignSharedSet v) { setField(2, v); }
  @$pb.TagNumber(2)
  $core.bool hasCampaignSharedSet() => $_has(1);
  @$pb.TagNumber(2)
  void clearCampaignSharedSet() => clearField(2);
  @$pb.TagNumber(2)
  $2376.CampaignSharedSet ensureCampaignSharedSet() => $_ensure(1);
}
