...
class MutateCampaignSharedSetsRequest extends $pb.GeneratedMessage {
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(_omitMessageNames ? '' : 'MutateCampaignSharedSetsRequest', package: const $pb.PackageName(_omitMessageNames ? '' : 'google.ads.googleads.v15.services'), createEmptyInstance: create)
...
class CampaignSharedSetOperation extends $pb.GeneratedMessage {
  factory CampaignSharedSetOperation({
    $2377.CampaignSharedSet? create_1,
    $core.String? remove,
  }) {
    final $result = create();
    if (create_1 != null) {
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(_omitMessageNames ? '' : 'CampaignSharedSetOperation', package: const $pb.PackageName(_omitMessageNames ? '' : 'google.ads.googleads.v15.services'), createEmptyInstance: create)
    ..oo(0, [1, 3])
    ..aOM<$2377.CampaignSharedSet>(1, _omitFieldNames ? '' : 'create', subBuilder: $2377.CampaignSharedSet.create)
  ...
  /// shared set.
  @$pb.TagNumber(1)
  $2377.CampaignSharedSet get create_1 => $_getN(0);
  @$pb.TagNumber(1)
  set create_1($2377.CampaignSharedSet v) { setField(1, v); }
  @$pb.TagNumber(1)
  $core.bool hasCreate_1() => $_has(0);
  @$pb.TagNumber(1)
  void clearCreate_1() => clearField(1);
  @$pb.TagNumber(1)
  $2377.CampaignSharedSet ensureCreate_1() => $_ensure(0);
...
class MutateCampaignSharedSetsResponse extends $pb.GeneratedMessage {
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(_omitMessageNames ? '' : 'MutateCampaignSharedSetsResponse', package: const $pb.PackageName(_omitMessageNames ? '' : 'google.ads.googleads.v15.services'), createEmptyInstance: create)
...
class MutateCampaignSharedSetResult extends $pb.GeneratedMessage {
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(_omitMessageNames ? '' : 'MutateCampaignSharedSetResult', package: const $pb.PackageName(_omitMessageNames ? '' : 'google.ads.googleads.v15.services'), createEmptyInstance: create)
    ..aOS(1, _omitFieldNames ? '' : 'resourceName')
    ..aOM<$2377.CampaignSharedSet>(2, _omitFieldNames ? '' : 'campaignSharedSet', subBuilder: $2377.CampaignSharedSet.create)
    ..hasRequiredFields = false
  ;
  ...
  /// "MUTABLE_RESOURCE".
  @$pb.TagNumber(2)
  $2377.CampaignSharedSet get campaignSharedSet => $_getN(1);
  @$pb.TagNumber(2)
  set campaignSharedSet($2377.CampaignSharedSet v) { setField(2, v); }
  @$pb.TagNumber(2)
  $core.bool hasCampaignSharedSet() => $_has(1);
  @$pb.TagNumber(2)
  void clearCampaignSharedSet() => clearField(2);
  @$pb.TagNumber(2)
  $2377.CampaignSharedSet ensureCampaignSharedSet() => $_ensure(1);
}
