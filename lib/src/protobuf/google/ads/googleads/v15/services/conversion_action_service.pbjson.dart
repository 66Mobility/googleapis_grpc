...
const MutateConversionActionsRequest$json = {
  ...
  '2': [
    ...
    {'1': 'operations', '3': 2, '4': 3, '5': 11, '6': '.google.ads.googleads.v15.services.ConversionActionOperation', '8': {}, '10': 'operations'},
...
final $typed_data.Uint8List mutateConversionActionsRequestDescriptor = $convert.base64Decode(
    ...
    'ZHMudjE1LnNlcnZpY2VzLkNvbnZlcnNpb25BY3Rpb25PcGVyYXRpb25CA+BBAlIKb3BlcmF0aW'
...
const ConversionActionOperation$json = {
  ...
  '2': [
    ...
    {'1': 'create', '3': 1, '4': 1, '5': 11, '6': '.google.ads.googleads.v15.resources.ConversionAction', '9': 0, '10': 'create'},
    {'1': 'update', '3': 2, '4': 1, '5': 11, '6': '.google.ads.googleads.v15.resources.ConversionAction', '9': 0, '10': 'update'},
...
final $typed_data.Uint8List conversionActionOperationDescriptor = $convert.base64Decode(
    ...
    'bGUuYWRzLmdvb2dsZWFkcy52MTUucmVzb3VyY2VzLkNvbnZlcnNpb25BY3Rpb25IAFIGY3JlYX'
    'RlEk4KBnVwZGF0ZRgCIAEoCzI0Lmdvb2dsZS5hZHMuZ29vZ2xlYWRzLnYxNS5yZXNvdXJjZXMu'
...
const MutateConversionActionsResponse$json = {
  ...
  '2': [
    ...
    {'1': 'results', '3': 2, '4': 3, '5': 11, '6': '.google.ads.googleads.v15.services.MutateConversionActionResult', '10': 'results'},
  ],
};
...
final $typed_data.Uint8List mutateConversionActionsResponseDescriptor = $convert.base64Decode(
    ...
    'c3VsdHMYAiADKAsyPy5nb29nbGUuYWRzLmdvb2dsZWFkcy52MTUuc2VydmljZXMuTXV0YXRlQ2'
...
const MutateConversionActionResult$json = {
  ...
  '2': [
    ...
    {'1': 'conversion_action', '3': 2, '4': 1, '5': 11, '6': '.google.ads.googleads.v15.resources.ConversionAction', '10': 'conversionAction'},
  ],
};
...
final $typed_data.Uint8List mutateConversionActionResultDescriptor = $convert.base64Decode(
    ...
    'YxNS5yZXNvdXJjZXMuQ29udmVyc2lvbkFjdGlvblIQY29udmVyc2lvbkFjdGlvbg==');
