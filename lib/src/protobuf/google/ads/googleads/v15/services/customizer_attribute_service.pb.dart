...
class MutateCustomizerAttributesRequest extends $pb.GeneratedMessage {
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(_omitMessageNames ? '' : 'MutateCustomizerAttributesRequest', package: const $pb.PackageName(_omitMessageNames ? '' : 'google.ads.googleads.v15.services'), createEmptyInstance: create)
...
class CustomizerAttributeOperation extends $pb.GeneratedMessage {
  factory CustomizerAttributeOperation({
    $2391.CustomizerAttribute? create_1,
    $core.String? remove,
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(_omitMessageNames ? '' : 'CustomizerAttributeOperation', package: const $pb.PackageName(_omitMessageNames ? '' : 'google.ads.googleads.v15.services'), createEmptyInstance: create)
    ..oo(0, [1, 2])
    ..aOM<$2391.CustomizerAttribute>(1, _omitFieldNames ? '' : 'create', subBuilder: $2391.CustomizerAttribute.create)
  ...
  /// attribute
  @$pb.TagNumber(1)
  $2391.CustomizerAttribute get create_1 => $_getN(0);
  @$pb.TagNumber(1)
  set create_1($2391.CustomizerAttribute v) { setField(1, v); }
  @$pb.TagNumber(1)
  $core.bool hasCreate_1() => $_has(0);
  @$pb.TagNumber(1)
  void clearCreate_1() => clearField(1);
  @$pb.TagNumber(1)
  $2391.CustomizerAttribute ensureCreate_1() => $_ensure(0);
...
class MutateCustomizerAttributesResponse extends $pb.GeneratedMessage {
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(_omitMessageNames ? '' : 'MutateCustomizerAttributesResponse', package: const $pb.PackageName(_omitMessageNames ? '' : 'google.ads.googleads.v15.services'), createEmptyInstance: create)
...
class MutateCustomizerAttributeResult extends $pb.GeneratedMessage {
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(_omitMessageNames ? '' : 'MutateCustomizerAttributeResult', package: const $pb.PackageName(_omitMessageNames ? '' : 'google.ads.googleads.v15.services'), createEmptyInstance: create)
    ..aOS(1, _omitFieldNames ? '' : 'resourceName')
    ..aOM<$2391.CustomizerAttribute>(2, _omitFieldNames ? '' : 'customizerAttribute', subBuilder: $2391.CustomizerAttribute.create)
    ..hasRequiredFields = false
  ;
  ...
  /// "MUTABLE_RESOURCE".
  @$pb.TagNumber(2)
  $2391.CustomizerAttribute get customizerAttribute => $_getN(1);
  @$pb.TagNumber(2)
  set customizerAttribute($2391.CustomizerAttribute v) { setField(2, v); }
  @$pb.TagNumber(2)
  $core.bool hasCustomizerAttribute() => $_has(1);
  @$pb.TagNumber(2)
  void clearCustomizerAttribute() => clearField(2);
  @$pb.TagNumber(2)
  $2391.CustomizerAttribute ensureCustomizerAttribute() => $_ensure(1);
}
