...
const MutateCustomerNegativeCriteriaRequest$json = {
  ...
  '2': [
    ...
    {'1': 'operations', '3': 2, '4': 3, '5': 11, '6': '.google.ads.googleads.v15.services.CustomerNegativeCriterionOperation', '8': {}, '10': 'operations'},
...
const CustomerNegativeCriterionOperation$json = {
  ...
  '2': [
    {'1': 'create', '3': 1, '4': 1, '5': 11, '6': '.google.ads.googleads.v15.resources.CustomerNegativeCriterion', '9': 0, '10': 'create'},
...
final $typed_data.Uint8List customerNegativeCriterionOperationDescriptor = $convert.base64Decode(
    ...
    'dvb2dsZS5hZHMuZ29vZ2xlYWRzLnYxNS5yZXNvdXJjZXMuQ3VzdG9tZXJOZWdhdGl2ZUNyaXRl'
...
const MutateCustomerNegativeCriteriaResponse$json = {
  ...
  '2': [
    ...
    {'1': 'results', '3': 2, '4': 3, '5': 11, '6': '.google.ads.googleads.v15.services.MutateCustomerNegativeCriteriaResult', '10': 'results'},
  ],
};
...
final $typed_data.Uint8List mutateCustomerNegativeCriteriaResponseDescriptor = $convert.base64Decode(
    ...
    'chJhCgdyZXN1bHRzGAIgAygLMkcuZ29vZ2xlLmFkcy5nb29nbGVhZHMudjE1LnNlcnZpY2VzLk'
...
const MutateCustomerNegativeCriteriaResult$json = {
  ...
  '2': [
    ...
    {'1': 'customer_negative_criterion', '3': 2, '4': 1, '5': 11, '6': '.google.ads.googleads.v15.resources.CustomerNegativeCriterion', '10': 'customerNegativeCriterion'},
  ],
};
...
final $typed_data.Uint8List mutateCustomerNegativeCriteriaResultDescriptor = $convert.base64Decode(
    ...
    'EoCzI9Lmdvb2dsZS5hZHMuZ29vZ2xlYWRzLnYxNS5yZXNvdXJjZXMuQ3VzdG9tZXJOZWdhdGl2'
