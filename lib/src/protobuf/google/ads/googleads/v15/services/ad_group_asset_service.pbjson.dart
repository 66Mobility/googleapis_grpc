...
const MutateAdGroupAssetsRequest$json = {
  ...
  '2': [
    ...
    {'1': 'operations', '3': 2, '4': 3, '5': 11, '6': '.google.ads.googleads.v15.services.AdGroupAssetOperation', '8': {}, '10': 'operations'},
...
final $typed_data.Uint8List mutateAdGroupAssetsRequestDescriptor = $convert.base64Decode(
    ...
    'MTUuc2VydmljZXMuQWRHcm91cEFzc2V0T3BlcmF0aW9uQgPgQQJSCm9wZXJhdGlvbnMSJwoPcG'
    ...
    'xlLmFkcy5nb29nbGVhZHMudjE1LmVudW1zLlJlc3BvbnNlQ29udGVudFR5cGVFbnVtLlJlc3Bv'
...
const AdGroupAssetOperation$json = {
  ...
  '2': [
    ...
    {'1': 'create', '3': 1, '4': 1, '5': 11, '6': '.google.ads.googleads.v15.resources.AdGroupAsset', '9': 0, '10': 'create'},
    {'1': 'update', '3': 3, '4': 1, '5': 11, '6': '.google.ads.googleads.v15.resources.AdGroupAsset', '9': 0, '10': 'update'},
...
final $typed_data.Uint8List adGroupAssetOperationDescriptor = $convert.base64Decode(
    ...
    'ZHMuZ29vZ2xlYWRzLnYxNS5yZXNvdXJjZXMuQWRHcm91cEFzc2V0SABSBmNyZWF0ZRJKCgZ1cG'
    'RhdGUYAyABKAsyMC5nb29nbGUuYWRzLmdvb2dsZWFkcy52MTUucmVzb3VyY2VzLkFkR3JvdXBB'
...
const MutateAdGroupAssetsResponse$json = {
  ...
  '2': [
    ...
    {'1': 'results', '3': 2, '4': 3, '5': 11, '6': '.google.ads.googleads.v15.services.MutateAdGroupAssetResult', '10': 'results'},
  ],
};
...
final $typed_data.Uint8List mutateAdGroupAssetsResponseDescriptor = $convert.base64Decode(
    ...
    'cxgCIAMoCzI7Lmdvb2dsZS5hZHMuZ29vZ2xlYWRzLnYxNS5zZXJ2aWNlcy5NdXRhdGVBZEdyb3'
...
const MutateAdGroupAssetResult$json = {
  ...
  '2': [
    ...
    {'1': 'ad_group_asset', '3': 2, '4': 1, '5': 11, '6': '.google.ads.googleads.v15.resources.AdGroupAsset', '10': 'adGroupAsset'},
  ],
};
...
final $typed_data.Uint8List mutateAdGroupAssetResultDescriptor = $convert.base64Decode(
    ...
    'YWRfZ3JvdXBfYXNzZXQYAiABKAsyMC5nb29nbGUuYWRzLmdvb2dsZWFkcy52MTUucmVzb3VyY2'
