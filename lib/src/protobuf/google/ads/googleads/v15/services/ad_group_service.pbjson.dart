...
const MutateAdGroupsRequest$json = {
  ...
  '2': [
    ...
    {'1': 'operations', '3': 2, '4': 3, '5': 11, '6': '.google.ads.googleads.v15.services.AdGroupOperation', '8': {}, '10': 'operations'},
...
final $typed_data.Uint8List mutateAdGroupsRequestDescriptor = $convert.base64Decode(
    ...
    '9tZXJJZBJYCgpvcGVyYXRpb25zGAIgAygLMjMuZ29vZ2xlLmFkcy5nb29nbGVhZHMudjE1LnNl'
    ...
    'dsZWFkcy52MTUuZW51bXMuUmVzcG9uc2VDb250ZW50VHlwZUVudW0uUmVzcG9uc2VDb250ZW50'
...
const AdGroupOperation$json = {
  ...
  '2': [
    ...
    {'1': 'create', '3': 1, '4': 1, '5': 11, '6': '.google.ads.googleads.v15.resources.AdGroup', '9': 0, '10': 'create'},
    {'1': 'update', '3': 2, '4': 1, '5': 11, '6': '.google.ads.googleads.v15.resources.AdGroup', '9': 0, '10': 'update'},
...
final $typed_data.Uint8List adGroupOperationDescriptor = $convert.base64Decode(
    ...
    'b2dsZWFkcy52MTUucmVzb3VyY2VzLkFkR3JvdXBIAFIGY3JlYXRlEkUKBnVwZGF0ZRgCIAEoCz'
    'IrLmdvb2dsZS5hZHMuZ29vZ2xlYWRzLnYxNS5yZXNvdXJjZXMuQWRHcm91cEgAUgZ1cGRhdGUS'
...
const MutateAdGroupsResponse$json = {
  ...
  '2': [
    ...
    {'1': 'results', '3': 2, '4': 3, '5': 11, '6': '.google.ads.googleads.v15.services.MutateAdGroupResult', '10': 'results'},
  ],
};
...
final $typed_data.Uint8List mutateAdGroupsResponseDescriptor = $convert.base64Decode(
    ...
    'KAsyNi5nb29nbGUuYWRzLmdvb2dsZWFkcy52MTUuc2VydmljZXMuTXV0YXRlQWRHcm91cFJlc3'
    'VsdFIHcmVzdWx0cw==');
...
const MutateAdGroupResult$json = {
  ...
  '2': [
    ...
    {'1': 'ad_group', '3': 2, '4': 1, '5': 11, '6': '.google.ads.googleads.v15.resources.AdGroup', '10': 'adGroup'},
  ],
};
...
final $typed_data.Uint8List mutateAdGroupResultDescriptor = $convert.base64Decode(
    ...
    'IAEoCzIrLmdvb2dsZS5hZHMuZ29vZ2xlYWRzLnYxNS5yZXNvdXJjZXMuQWRHcm91cFIHYWRHcm'
    '91cA==');
