...
const MutateAdGroupAdsRequest$json = {
  ...
  '2': [
    ...
    {'1': 'operations', '3': 2, '4': 3, '5': 11, '6': '.google.ads.googleads.v15.services.AdGroupAdOperation', '8': {}, '10': 'operations'},
...
const AdGroupAdOperation$json = {
  ...
  '2': [
    ...
    {'1': 'policy_validation_parameter', '3': 5, '4': 1, '5': 11, '6': '.google.ads.googleads.v15.common.PolicyValidationParameter', '10': 'policyValidationParameter'},
    {'1': 'create', '3': 1, '4': 1, '5': 11, '6': '.google.ads.googleads.v15.resources.AdGroupAd', '9': 0, '10': 'create'},
    {'1': 'update', '3': 2, '4': 1, '5': 11, '6': '.google.ads.googleads.v15.resources.AdGroupAd', '9': 0, '10': 'update'},
...
final $typed_data.Uint8List adGroupAdOperationDescriptor = $convert.base64Decode(
    ...
    'chgFIAEoCzI6Lmdvb2dsZS5hZHMuZ29vZ2xlYWRzLnYxNS5jb21tb24uUG9saWN5VmFsaWRhdG'
    'lvblBhcmFtZXRlclIZcG9saWN5VmFsaWRhdGlvblBhcmFtZXRlchJHCgZjcmVhdGUYASABKAsy'
    'LS5nb29nbGUuYWRzLmdvb2dsZWFkcy52MTUucmVzb3VyY2VzLkFkR3JvdXBBZEgAUgZjcmVhdG'
    'USRwoGdXBkYXRlGAIgASgLMi0uZ29vZ2xlLmFkcy5nb29nbGVhZHMudjE1LnJlc291cmNlcy5B'
...
const MutateAdGroupAdsResponse$json = {
  ...
  '2': [
    ...
    {'1': 'results', '3': 2, '4': 3, '5': 11, '6': '.google.ads.googleads.v15.services.MutateAdGroupAdResult', '10': 'results'},
  ],
};
...
final $typed_data.Uint8List mutateAdGroupAdsResponseDescriptor = $convert.base64Decode(
    ...
    'IAMoCzI4Lmdvb2dsZS5hZHMuZ29vZ2xlYWRzLnYxNS5zZXJ2aWNlcy5NdXRhdGVBZEdyb3VwQW'
...
const MutateAdGroupAdResult$json = {
  ...
  '2': [
    ...
    {'1': 'ad_group_ad', '3': 2, '4': 1, '5': 11, '6': '.google.ads.googleads.v15.resources.AdGroupAd', '10': 'adGroupAd'},
  ],
};
...
final $typed_data.Uint8List mutateAdGroupAdResultDescriptor = $convert.base64Decode(
    ...
    'dXBfYWQYAiABKAsyLS5nb29nbGUuYWRzLmdvb2dsZWFkcy52MTUucmVzb3VyY2VzLkFkR3JvdX'
    'BBZFIJYWRHcm91cEFk');
