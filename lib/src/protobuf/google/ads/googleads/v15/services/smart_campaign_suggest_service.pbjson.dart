...
const SuggestSmartCampaignBudgetOptionsRequest$json = {
  ...
  '2': [
    ...
    {'1': 'suggestion_info', '3': 3, '4': 1, '5': 11, '6': '.google.ads.googleads.v15.services.SmartCampaignSuggestionInfo', '8': {}, '9': 0, '10': 'suggestionInfo'},
  ],
  '8': [
    {'1': 'suggestion_data'},
  ],
...
final $typed_data.Uint8List suggestSmartCampaignBudgetOptionsRequestDescriptor = $convert.base64Decode(
    ...
    '5faW5mbxgDIAEoCzI+Lmdvb2dsZS5hZHMuZ29vZ2xlYWRzLnYxNS5zZXJ2aWNlcy5TbWFydENh'
...
const SmartCampaignSuggestionInfo$json = {
  ...
  '2': [
    ...
    {'1': 'ad_schedules', '3': 6, '4': 3, '5': 11, '6': '.google.ads.googleads.v15.common.AdScheduleInfo', '8': {}, '10': 'adSchedules'},
    {'1': 'keyword_themes', '3': 7, '4': 3, '5': 11, '6': '.google.ads.googleads.v15.common.KeywordThemeInfo', '8': {}, '10': 'keywordThemes'},
    {'1': 'business_context', '3': 8, '4': 1, '5': 11, '6': '.google.ads.googleads.v15.services.SmartCampaignSuggestionInfo.BusinessContext', '8': {}, '9': 0, '10': 'businessContext'},
    {'1': 'business_profile_location', '3': 9, '4': 1, '5': 9, '8': {}, '9': 0, '10': 'businessProfileLocation'},
    {'1': 'location_list', '3': 4, '4': 1, '5': 11, '6': '.google.ads.googleads.v15.services.SmartCampaignSuggestionInfo.LocationList', '8': {}, '9': 1, '10': 'locationList'},
    {'1': 'proximity', '3': 5, '4': 1, '5': 11, '6': '.google.ads.googleads.v15.common.ProximityInfo', '8': {}, '9': 1, '10': 'proximity'},
  ],
...
const SmartCampaignSuggestionInfo_LocationList$json = {
  '1': 'LocationList',
  '2': [
    {'1': 'locations', '3': 1, '4': 3, '5': 11, '6': '.google.ads.googleads.v15.common.LocationInfo', '8': {}, '10': 'locations'},
  ],
};
...
final $typed_data.Uint8List smartCampaignSuggestionInfoDescriptor = $convert.base64Decode(
    ...
    'X3NjaGVkdWxlcxgGIAMoCzIvLmdvb2dsZS5hZHMuZ29vZ2xlYWRzLnYxNS5jb21tb24uQWRTY2'
    'hlZHVsZUluZm9CA+BBAVILYWRTY2hlZHVsZXMSXQoOa2V5d29yZF90aGVtZXMYByADKAsyMS5n'
    'b29nbGUuYWRzLmdvb2dsZWFkcy52MTUuY29tbW9uLktleXdvcmRUaGVtZUluZm9CA+BBAVINa2'
    'V5d29yZFRoZW1lcxKAAQoQYnVzaW5lc3NfY29udGV4dBgIIAEoCzJOLmdvb2dsZS5hZHMuZ29v'
    'Z2xlYWRzLnYxNS5zZXJ2aWNlcy5TbWFydENhbXBhaWduU3VnZ2VzdGlvbkluZm8uQnVzaW5lc3'
    ...
    '9saXN0GAQgASgLMksuZ29vZ2xlLmFkcy5nb29nbGVhZHMudjE1LnNlcnZpY2VzLlNtYXJ0Q2Ft'
    'cGFpZ25TdWdnZXN0aW9uSW5mby5Mb2NhdGlvbkxpc3RCA+BBAUgBUgxsb2NhdGlvbkxpc3QSUw'
    'oJcHJveGltaXR5GAUgASgLMi4uZ29vZ2xlLmFkcy5nb29nbGVhZHMudjE1LmNvbW1vbi5Qcm94'
    'aW1pdHlJbmZvQgPgQQFIAVIJcHJveGltaXR5GmAKDExvY2F0aW9uTGlzdBJQCglsb2NhdGlvbn'
    'MYASADKAsyLS5nb29nbGUuYWRzLmdvb2dsZWFkcy52MTUuY29tbW9uLkxvY2F0aW9uSW5mb0ID'
...
const SuggestSmartCampaignBudgetOptionsResponse$json = {
  ...
  '2': [
    {'1': 'low', '3': 1, '4': 1, '5': 11, '6': '.google.ads.googleads.v15.services.SuggestSmartCampaignBudgetOptionsResponse.BudgetOption', '8': {}, '9': 0, '10': 'low', '17': true},
    {'1': 'recommended', '3': 2, '4': 1, '5': 11, '6': '.google.ads.googleads.v15.services.SuggestSmartCampaignBudgetOptionsResponse.BudgetOption', '8': {}, '9': 1, '10': 'recommended', '17': true},
    {'1': 'high', '3': 3, '4': 1, '5': 11, '6': '.google.ads.googleads.v15.services.SuggestSmartCampaignBudgetOptionsResponse.BudgetOption', '8': {}, '9': 2, '10': 'high', '17': true},
  ],
...
const SuggestSmartCampaignBudgetOptionsResponse_BudgetOption$json = {
  ...
  '2': [
    ...
    {'1': 'metrics', '3': 2, '4': 1, '5': 11, '6': '.google.ads.googleads.v15.services.SuggestSmartCampaignBudgetOptionsResponse.Metrics', '10': 'metrics'},
  ],
};
...
final $typed_data.Uint8List suggestSmartCampaignBudgetOptionsResponseDescriptor = $convert.base64Decode(
    ...
    'syWS5nb29nbGUuYWRzLmdvb2dsZWFkcy52MTUuc2VydmljZXMuU3VnZ2VzdFNtYXJ0Q2FtcGFp'
    'Z25CdWRnZXRPcHRpb25zUmVzcG9uc2UuQnVkZ2V0T3B0aW9uQgPgQQFIAFIDbG93iAEBEoUBCg'
    'tyZWNvbW1lbmRlZBgCIAEoCzJZLmdvb2dsZS5hZHMuZ29vZ2xlYWRzLnYxNS5zZXJ2aWNlcy5T'
    ...
    'ZHMudjE1LnNlcnZpY2VzLlN1Z2dlc3RTbWFydENhbXBhaWduQnVkZ2V0T3B0aW9uc1Jlc3Bvbn'
    ...
    'dvb2dsZWFkcy52MTUuc2VydmljZXMuU3VnZ2VzdFNtYXJ0Q2FtcGFpZ25CdWRnZXRPcHRpb25z'
...
const SuggestSmartCampaignAdRequest$json = {
  ...
  '2': [
    {'1': 'customer_id', '3': 1, '4': 1, '5': 9, '8': {}, '10': 'customerId'},
    {'1': 'suggestion_info', '3': 2, '4': 1, '5': 11, '6': '.google.ads.googleads.v15.services.SmartCampaignSuggestionInfo', '8': {}, '10': 'suggestionInfo'},
  ],
};
...
final $typed_data.Uint8List suggestSmartCampaignAdRequestDescriptor = $convert.base64Decode(
    ...
    'Z2xlYWRzLnYxNS5zZXJ2aWNlcy5TbWFydENhbXBhaWduU3VnZ2VzdGlvbkluZm9CA+BBAlIOc3'
    'VnZ2VzdGlvbkluZm8=');
...
const SuggestSmartCampaignAdResponse$json = {
  ...
  '2': [
    {'1': 'ad_info', '3': 1, '4': 1, '5': 11, '6': '.google.ads.googleads.v15.common.SmartCampaignAdInfo', '8': {}, '10': 'adInfo'},
  ],
};
...
final $typed_data.Uint8List suggestSmartCampaignAdResponseDescriptor = $convert.base64Decode(
    ...
    'dsZS5hZHMuZ29vZ2xlYWRzLnYxNS5jb21tb24uU21hcnRDYW1wYWlnbkFkSW5mb0ID4EEBUgZh'
    'ZEluZm8=');
...
final $typed_data.Uint8List suggestKeywordThemesRequestDescriptor = $convert.base64Decode(
    ...
    'ZWFkcy52MTUuc2VydmljZXMuU21hcnRDYW1wYWlnblN1Z2dlc3Rpb25JbmZvQgPgQQJSDnN1Z2'
    'dlc3Rpb25JbmZv');
...
const SuggestKeywordThemesResponse$json = {
  ...
  '2': [
    {'1': 'keyword_themes', '3': 2, '4': 3, '5': 11, '6': '.google.ads.googleads.v15.services.SuggestKeywordThemesResponse.KeywordTheme', '10': 'keywordThemes'},
  ],
...
const SuggestKeywordThemesResponse_KeywordTheme$json = {
  '1': 'KeywordTheme',
  '2': [
    {'1': 'keyword_theme_constant', '3': 1, '4': 1, '5': 11, '6': '.google.ads.googleads.v15.resources.KeywordThemeConstant', '9': 0, '10': 'keywordThemeConstant'},
...
final $typed_data.Uint8List suggestKeywordThemesResponseDescriptor = $convert.base64Decode(
    ...
    'wuZ29vZ2xlLmFkcy5nb29nbGVhZHMudjE1LnNlcnZpY2VzLlN1Z2dlc3RLZXl3b3JkVGhlbWVz'
    ...
    'NS5yZXNvdXJjZXMuS2V5d29yZFRoZW1lQ29uc3RhbnRIAFIUa2V5d29yZFRoZW1lQ29uc3Rhbn'
