...
import '../enums/brand_state.pbenum.dart' as $2510;
...
class SuggestBrandsRequest extends $pb.GeneratedMessage {
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(_omitMessageNames ? '' : 'SuggestBrandsRequest', package: const $pb.PackageName(_omitMessageNames ? '' : 'google.ads.googleads.v15.services'), createEmptyInstance: create)
...
class SuggestBrandsResponse extends $pb.GeneratedMessage {
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(_omitMessageNames ? '' : 'SuggestBrandsResponse', package: const $pb.PackageName(_omitMessageNames ? '' : 'google.ads.googleads.v15.services'), createEmptyInstance: create)
...
class BrandSuggestion extends $pb.GeneratedMessage {
  factory BrandSuggestion({
    ...
    $2510.BrandStateEnum_BrandState? state,
  }) {
    final $result = create();
    if (id != null) {
      $result.id = id;
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(_omitMessageNames ? '' : 'BrandSuggestion', package: const $pb.PackageName(_omitMessageNames ? '' : 'google.ads.googleads.v15.services'), createEmptyInstance: create)
    ..aOS(1, _omitFieldNames ? '' : 'id')
    ..aOS(2, _omitFieldNames ? '' : 'name')
    ..pPS(3, _omitFieldNames ? '' : 'urls')
    ..e<$2510.BrandStateEnum_BrandState>(4, _omitFieldNames ? '' : 'state', $pb.PbFieldType.OE, defaultOrMaker: $2510.BrandStateEnum_BrandState.UNSPECIFIED, valueOf: $2510.BrandStateEnum_BrandState.valueOf, enumValues: $2510.BrandStateEnum_BrandState.values)
    ..hasRequiredFields = false
  ;
  ...
  @$pb.TagNumber(4)
  $2510.BrandStateEnum_BrandState get state => $_getN(3);
  @$pb.TagNumber(4)
  set state($2510.BrandStateEnum_BrandState v) { setField(4, v); }
  @$pb.TagNumber(4)
