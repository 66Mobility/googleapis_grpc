...
const MutateConversionValueRulesRequest$json = {
  ...
  '2': [
    ...
    {'1': 'operations', '3': 2, '4': 3, '5': 11, '6': '.google.ads.googleads.v15.services.ConversionValueRuleOperation', '8': {}, '10': 'operations'},
...
final $typed_data.Uint8List mutateConversionValueRulesRequestDescriptor = $convert.base64Decode(
    ...
    'bGVhZHMudjE1LnNlcnZpY2VzLkNvbnZlcnNpb25WYWx1ZVJ1bGVPcGVyYXRpb25CA+BBAlIKb3'
    ...
    'UYBCABKA4ySy5nb29nbGUuYWRzLmdvb2dsZWFkcy52MTUuZW51bXMuUmVzcG9uc2VDb250ZW50'
...
const ConversionValueRuleOperation$json = {
  ...
  '2': [
    ...
    {'1': 'create', '3': 1, '4': 1, '5': 11, '6': '.google.ads.googleads.v15.resources.ConversionValueRule', '9': 0, '10': 'create'},
    {'1': 'update', '3': 2, '4': 1, '5': 11, '6': '.google.ads.googleads.v15.resources.ConversionValueRule', '9': 0, '10': 'update'},
...
final $typed_data.Uint8List conversionValueRuleOperationDescriptor = $convert.base64Decode(
    ...
    'b29nbGUuYWRzLmdvb2dsZWFkcy52MTUucmVzb3VyY2VzLkNvbnZlcnNpb25WYWx1ZVJ1bGVIAF'
...
const MutateConversionValueRulesResponse$json = {
  ...
  '2': [
    {'1': 'results', '3': 2, '4': 3, '5': 11, '6': '.google.ads.googleads.v15.services.MutateConversionValueRuleResult', '10': 'results'},
...
final $typed_data.Uint8List mutateConversionValueRulesResponseDescriptor = $convert.base64Decode(
    ...
    '5nb29nbGUuYWRzLmdvb2dsZWFkcy52MTUuc2VydmljZXMuTXV0YXRlQ29udmVyc2lvblZhbHVl'
...
const MutateConversionValueRuleResult$json = {
  ...
  '2': [
    ...
    {'1': 'conversion_value_rule', '3': 2, '4': 1, '5': 11, '6': '.google.ads.googleads.v15.resources.ConversionValueRule', '10': 'conversionValueRule'},
  ],
};
...
final $typed_data.Uint8List mutateConversionValueRuleResultDescriptor = $convert.base64Decode(
    ...
    'dvb2dsZWFkcy52MTUucmVzb3VyY2VzLkNvbnZlcnNpb25WYWx1ZVJ1bGVSE2NvbnZlcnNpb25W'
    'YWx1ZVJ1bGU=');
