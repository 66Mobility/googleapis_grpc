...
const MutateCampaignFeedsRequest$json = {
  ...
  '2': [
    ...
    {'1': 'operations', '3': 2, '4': 3, '5': 11, '6': '.google.ads.googleads.v15.services.CampaignFeedOperation', '8': {}, '10': 'operations'},
...
final $typed_data.Uint8List mutateCampaignFeedsRequestDescriptor = $convert.base64Decode(
    ...
    'MTUuc2VydmljZXMuQ2FtcGFpZ25GZWVkT3BlcmF0aW9uQgPgQQJSCm9wZXJhdGlvbnMSJwoPcG'
...
const CampaignFeedOperation$json = {
  ...
  '2': [
    ...
    {'1': 'create', '3': 1, '4': 1, '5': 11, '6': '.google.ads.googleads.v15.resources.CampaignFeed', '9': 0, '10': 'create'},
    {'1': 'update', '3': 2, '4': 1, '5': 11, '6': '.google.ads.googleads.v15.resources.CampaignFeed', '9': 0, '10': 'update'},
...
final $typed_data.Uint8List campaignFeedOperationDescriptor = $convert.base64Decode(
    ...
    'ZHMuZ29vZ2xlYWRzLnYxNS5yZXNvdXJjZXMuQ2FtcGFpZ25GZWVkSABSBmNyZWF0ZRJKCgZ1cG'
    'RhdGUYAiABKAsyMC5nb29nbGUuYWRzLmdvb2dsZWFkcy52MTUucmVzb3VyY2VzLkNhbXBhaWdu'
...
const MutateCampaignFeedsResponse$json = {
  ...
  '2': [
    ...
    {'1': 'results', '3': 2, '4': 3, '5': 11, '6': '.google.ads.googleads.v15.services.MutateCampaignFeedResult', '10': 'results'},
  ],
};
...
final $typed_data.Uint8List mutateCampaignFeedsResponseDescriptor = $convert.base64Decode(
    ...
    'cxgCIAMoCzI7Lmdvb2dsZS5hZHMuZ29vZ2xlYWRzLnYxNS5zZXJ2aWNlcy5NdXRhdGVDYW1wYW'
...
const MutateCampaignFeedResult$json = {
  ...
  '2': [
    ...
    {'1': 'campaign_feed', '3': 2, '4': 1, '5': 11, '6': '.google.ads.googleads.v15.resources.CampaignFeed', '10': 'campaignFeed'},
  ],
};
...
final $typed_data.Uint8List mutateCampaignFeedResultDescriptor = $convert.base64Decode(
    ...
    'Y2FtcGFpZ25fZmVlZBgCIAEoCzIwLmdvb2dsZS5hZHMuZ29vZ2xlYWRzLnYxNS5yZXNvdXJjZX'
