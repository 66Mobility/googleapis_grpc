...
class CustomerLabelOperation extends $pb.GeneratedMessage {
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(_omitMessageNames ? '' : 'CustomerLabelOperation', package: const $pb.PackageName(_omitMessageNames ? '' : 'google.ads.googleads.v15.services'), createEmptyInstance: create)
    ..oo(0, [1, 2])
    ..aOM<$2388.CustomerLabel>(1, _omitFieldNames ? '' : 'create', subBuilder: $2388.CustomerLabel.create)
  ...
  /// relationship.
  @$pb.TagNumber(1)
  $2388.CustomerLabel get create_1 => $_getN(0);
  @$pb.TagNumber(1)
  set create_1($2388.CustomerLabel v) { setField(1, v); }
  @$pb.TagNumber(1)
  $core.bool hasCreate_1() => $_has(0);
  @$pb.TagNumber(1)
  void clearCreate_1() => clearField(1);
  @$pb.TagNumber(1)
  $2388.CustomerLabel ensureCreate_1() => $_ensure(0);
