...
class AccountBudgetProposalOperation extends $pb.GeneratedMessage {
  factory AccountBudgetProposalOperation({
    $core.String? remove,
    $2349.AccountBudgetProposal? create_2,
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(_omitMessageNames ? '' : 'AccountBudgetProposalOperation', package: const $pb.PackageName(_omitMessageNames ? '' : 'google.ads.googleads.v15.services'), createEmptyInstance: create)
    ...
    ..aOM<$2349.AccountBudgetProposal>(2, _omitFieldNames ? '' : 'create', subBuilder: $2349.AccountBudgetProposal.create)
  ...
  @$pb.TagNumber(2)
  $2349.AccountBudgetProposal get create_2 => $_getN(1);
  @$pb.TagNumber(2)
  set create_2($2349.AccountBudgetProposal v) { setField(2, v); }
  @$pb.TagNumber(2)
  $core.bool hasCreate_2() => $_has(1);
  @$pb.TagNumber(2)
  void clearCreate_2() => clearField(2);
  @$pb.TagNumber(2)
  $2349.AccountBudgetProposal ensureCreate_2() => $_ensure(1);
