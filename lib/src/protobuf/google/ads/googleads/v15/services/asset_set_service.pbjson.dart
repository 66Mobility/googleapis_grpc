...
const MutateAssetSetsRequest$json = {
  ...
  '2': [
    ...
    {'1': 'operations', '3': 2, '4': 3, '5': 11, '6': '.google.ads.googleads.v15.services.AssetSetOperation', '8': {}, '10': 'operations'},
...
const AssetSetOperation$json = {
  ...
  '2': [
    ...
    {'1': 'create', '3': 1, '4': 1, '5': 11, '6': '.google.ads.googleads.v15.resources.AssetSet', '9': 0, '10': 'create'},
    {'1': 'update', '3': 2, '4': 1, '5': 11, '6': '.google.ads.googleads.v15.resources.AssetSet', '9': 0, '10': 'update'},
...
final $typed_data.Uint8List assetSetOperationDescriptor = $convert.base64Decode(
    ...
    'b29nbGVhZHMudjE1LnJlc291cmNlcy5Bc3NldFNldEgAUgZjcmVhdGUSRgoGdXBkYXRlGAIgAS'
    'gLMiwuZ29vZ2xlLmFkcy5nb29nbGVhZHMudjE1LnJlc291cmNlcy5Bc3NldFNldEgAUgZ1cGRh'
...
const MutateAssetSetsResponse$json = {
  ...
  '2': [
    {'1': 'results', '3': 1, '4': 3, '5': 11, '6': '.google.ads.googleads.v15.services.MutateAssetSetResult', '10': 'results'},
...
final $typed_data.Uint8List mutateAssetSetsResponseDescriptor = $convert.base64Decode(
    ...
    '5nb29nbGVhZHMudjE1LnNlcnZpY2VzLk11dGF0ZUFzc2V0U2V0UmVzdWx0UgdyZXN1bHRzEkYK'
...
const MutateAssetSetResult$json = {
  ...
  '2': [
    ...
    {'1': 'asset_set', '3': 2, '4': 1, '5': 11, '6': '.google.ads.googleads.v15.resources.AssetSet', '10': 'assetSet'},
  ],
};
...
final $typed_data.Uint8List mutateAssetSetResultDescriptor = $convert.base64Decode(
    ...
    'dBgCIAEoCzIsLmdvb2dsZS5hZHMuZ29vZ2xlYWRzLnYxNS5yZXNvdXJjZXMuQXNzZXRTZXRSCG'
    'Fzc2V0U2V0');
