...
class MutateCustomerUserAccessInvitationRequest extends $pb.GeneratedMessage {
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(_omitMessageNames ? '' : 'MutateCustomerUserAccessInvitationRequest', package: const $pb.PackageName(_omitMessageNames ? '' : 'google.ads.googleads.v15.services'), createEmptyInstance: create)
...
class CustomerUserAccessInvitationOperation extends $pb.GeneratedMessage {
  factory CustomerUserAccessInvitationOperation({
    $2472.CustomerUserAccessInvitation? create_1,
    $core.String? remove,
  }) {
    final $result = create();
    if (create_1 != null) {
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(_omitMessageNames ? '' : 'CustomerUserAccessInvitationOperation', package: const $pb.PackageName(_omitMessageNames ? '' : 'google.ads.googleads.v15.services'), createEmptyInstance: create)
    ..oo(0, [1, 2])
    ..aOM<$2472.CustomerUserAccessInvitation>(1, _omitFieldNames ? '' : 'create', subBuilder: $2472.CustomerUserAccessInvitation.create)
  ...
  /// invitation.
  @$pb.TagNumber(1)
  $2472.CustomerUserAccessInvitation get create_1 => $_getN(0);
  @$pb.TagNumber(1)
  set create_1($2472.CustomerUserAccessInvitation v) { setField(1, v); }
  @$pb.TagNumber(1)
  $core.bool hasCreate_1() => $_has(0);
  @$pb.TagNumber(1)
  void clearCreate_1() => clearField(1);
  @$pb.TagNumber(1)
  $2472.CustomerUserAccessInvitation ensureCreate_1() => $_ensure(0);
...
class MutateCustomerUserAccessInvitationResponse extends $pb.GeneratedMessage {
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(_omitMessageNames ? '' : 'MutateCustomerUserAccessInvitationResponse', package: const $pb.PackageName(_omitMessageNames ? '' : 'google.ads.googleads.v15.services'), createEmptyInstance: create)
...
class MutateCustomerUserAccessInvitationResult extends $pb.GeneratedMessage {
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(_omitMessageNames ? '' : 'MutateCustomerUserAccessInvitationResult', package: const $pb.PackageName(_omitMessageNames ? '' : 'google.ads.googleads.v15.services'), createEmptyInstance: create)
