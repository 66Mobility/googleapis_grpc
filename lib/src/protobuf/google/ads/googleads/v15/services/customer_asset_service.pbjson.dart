...
const MutateCustomerAssetsRequest$json = {
  ...
  '2': [
    ...
    {'1': 'operations', '3': 2, '4': 3, '5': 11, '6': '.google.ads.googleads.v15.services.CustomerAssetOperation', '8': {}, '10': 'operations'},
...
final $typed_data.Uint8List mutateCustomerAssetsRequestDescriptor = $convert.base64Decode(
    ...
    'djE1LnNlcnZpY2VzLkN1c3RvbWVyQXNzZXRPcGVyYXRpb25CA+BBAlIKb3BlcmF0aW9ucxInCg'
...
const CustomerAssetOperation$json = {
  ...
  '2': [
    ...
    {'1': 'create', '3': 1, '4': 1, '5': 11, '6': '.google.ads.googleads.v15.resources.CustomerAsset', '9': 0, '10': 'create'},
    {'1': 'update', '3': 3, '4': 1, '5': 11, '6': '.google.ads.googleads.v15.resources.CustomerAsset', '9': 0, '10': 'update'},
...
final $typed_data.Uint8List customerAssetOperationDescriptor = $convert.base64Decode(
    ...
    'YWRzLmdvb2dsZWFkcy52MTUucmVzb3VyY2VzLkN1c3RvbWVyQXNzZXRIAFIGY3JlYXRlEksKBn'
    'VwZGF0ZRgDIAEoCzIxLmdvb2dsZS5hZHMuZ29vZ2xlYWRzLnYxNS5yZXNvdXJjZXMuQ3VzdG9t'
...
const MutateCustomerAssetsResponse$json = {
  ...
  '2': [
    ...
    {'1': 'results', '3': 2, '4': 3, '5': 11, '6': '.google.ads.googleads.v15.services.MutateCustomerAssetResult', '10': 'results'},
  ],
};
...
final $typed_data.Uint8List mutateCustomerAssetsResponseDescriptor = $convert.base64Decode(
    ...
    'dHMYAiADKAsyPC5nb29nbGUuYWRzLmdvb2dsZWFkcy52MTUuc2VydmljZXMuTXV0YXRlQ3VzdG'
...
const MutateCustomerAssetResult$json = {
  ...
  '2': [
    ...
    {'1': 'customer_asset', '3': 2, '4': 1, '5': 11, '6': '.google.ads.googleads.v15.resources.CustomerAsset', '10': 'customerAsset'},
  ],
};
...
final $typed_data.Uint8List mutateCustomerAssetResultDescriptor = $convert.base64Decode(
    ...
    'Cg5jdXN0b21lcl9hc3NldBgCIAEoCzIxLmdvb2dsZS5hZHMuZ29vZ2xlYWRzLnYxNS5yZXNvdX'
