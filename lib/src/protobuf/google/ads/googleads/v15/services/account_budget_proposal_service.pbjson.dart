...
const MutateAccountBudgetProposalRequest$json = {
  ...
  '2': [
    ...
    {'1': 'operation', '3': 2, '4': 1, '5': 11, '6': '.google.ads.googleads.v15.services.AccountBudgetProposalOperation', '8': {}, '10': 'operation'},
...
final $typed_data.Uint8List mutateAccountBudgetProposalRequestDescriptor = $convert.base64Decode(
    ...
    'bGVhZHMudjE1LnNlcnZpY2VzLkFjY291bnRCdWRnZXRQcm9wb3NhbE9wZXJhdGlvbkID4EECUg'
...
const AccountBudgetProposalOperation$json = {
  ...
  '2': [
    ...
    {'1': 'create', '3': 2, '4': 1, '5': 11, '6': '.google.ads.googleads.v15.resources.AccountBudgetProposal', '9': 0, '10': 'create'},
...
final $typed_data.Uint8List accountBudgetProposalOperationDescriptor = $convert.base64Decode(
    ...
    'Lmdvb2dsZS5hZHMuZ29vZ2xlYWRzLnYxNS5yZXNvdXJjZXMuQWNjb3VudEJ1ZGdldFByb3Bvc2'
...
const MutateAccountBudgetProposalResponse$json = {
  ...
  '2': [
    {'1': 'result', '3': 2, '4': 1, '5': 11, '6': '.google.ads.googleads.v15.services.MutateAccountBudgetProposalResult', '10': 'result'},
  ],
};
...
final $typed_data.Uint8List mutateAccountBudgetProposalResponseDescriptor = $convert.base64Decode(
    ...
    '5nb29nbGUuYWRzLmdvb2dsZWFkcy52MTUuc2VydmljZXMuTXV0YXRlQWNjb3VudEJ1ZGdldFBy'
