...
const MutateCustomerAssetSetsRequest$json = {
  ...
  '2': [
    ...
    {'1': 'operations', '3': 2, '4': 3, '5': 11, '6': '.google.ads.googleads.v15.services.CustomerAssetSetOperation', '8': {}, '10': 'operations'},
...
final $typed_data.Uint8List mutateCustomerAssetSetsRequestDescriptor = $convert.base64Decode(
    ...
    'ZHMudjE1LnNlcnZpY2VzLkN1c3RvbWVyQXNzZXRTZXRPcGVyYXRpb25CA+BBAlIKb3BlcmF0aW'
...
const CustomerAssetSetOperation$json = {
  ...
  '2': [
    {'1': 'create', '3': 1, '4': 1, '5': 11, '6': '.google.ads.googleads.v15.resources.CustomerAssetSet', '9': 0, '10': 'create'},
...
final $typed_data.Uint8List customerAssetSetOperationDescriptor = $convert.base64Decode(
    ...
    'MuZ29vZ2xlYWRzLnYxNS5yZXNvdXJjZXMuQ3VzdG9tZXJBc3NldFNldEgAUgZjcmVhdGUSSAoG'
...
const MutateCustomerAssetSetsResponse$json = {
  ...
  '2': [
    {'1': 'results', '3': 1, '4': 3, '5': 11, '6': '.google.ads.googleads.v15.services.MutateCustomerAssetSetResult', '10': 'results'},
...
final $typed_data.Uint8List mutateCustomerAssetSetsResponseDescriptor = $convert.base64Decode(
    ...
    '9nbGUuYWRzLmdvb2dsZWFkcy52MTUuc2VydmljZXMuTXV0YXRlQ3VzdG9tZXJBc3NldFNldFJl'
...
const MutateCustomerAssetSetResult$json = {
  ...
  '2': [
    ...
    {'1': 'customer_asset_set', '3': 2, '4': 1, '5': 11, '6': '.google.ads.googleads.v15.resources.CustomerAssetSet', '10': 'customerAssetSet'},
  ],
};
...
final $typed_data.Uint8List mutateCustomerAssetSetResultDescriptor = $convert.base64Decode(
    ...
    '52MTUucmVzb3VyY2VzLkN1c3RvbWVyQXNzZXRTZXRSEGN1c3RvbWVyQXNzZXRTZXQ=');
