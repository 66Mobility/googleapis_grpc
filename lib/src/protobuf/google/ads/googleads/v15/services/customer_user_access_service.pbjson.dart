...
const MutateCustomerUserAccessRequest$json = {
  ...
  '2': [
    ...
    {'1': 'operation', '3': 2, '4': 1, '5': 11, '6': '.google.ads.googleads.v15.services.CustomerUserAccessOperation', '8': {}, '10': 'operation'},
  ],
};
...
final $typed_data.Uint8List mutateCustomerUserAccessRequestDescriptor = $convert.base64Decode(
    ...
    'ZHMudjE1LnNlcnZpY2VzLkN1c3RvbWVyVXNlckFjY2Vzc09wZXJhdGlvbkID4EECUglvcGVyYX'
    'Rpb24=');
...
const CustomerUserAccessOperation$json = {
  ...
  '2': [
    ...
    {'1': 'update', '3': 1, '4': 1, '5': 11, '6': '.google.ads.googleads.v15.resources.CustomerUserAccess', '9': 0, '10': 'update'},
...
final $typed_data.Uint8List customerUserAccessOperationDescriptor = $convert.base64Decode(
    ...
    'b2dsZS5hZHMuZ29vZ2xlYWRzLnYxNS5yZXNvdXJjZXMuQ3VzdG9tZXJVc2VyQWNjZXNzSABSBn'
...
const MutateCustomerUserAccessResponse$json = {
  ...
  '2': [
    {'1': 'result', '3': 1, '4': 1, '5': 11, '6': '.google.ads.googleads.v15.services.MutateCustomerUserAccessResult', '10': 'result'},
  ],
};
...
final $typed_data.Uint8List mutateCustomerUserAccessResponseDescriptor = $convert.base64Decode(
    ...
    '9nbGUuYWRzLmdvb2dsZWFkcy52MTUuc2VydmljZXMuTXV0YXRlQ3VzdG9tZXJVc2VyQWNjZXNz'
    'UmVzdWx0UgZyZXN1bHQ=');
