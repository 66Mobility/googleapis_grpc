...
class BiddingSeasonalityAdjustmentOperation extends $pb.GeneratedMessage {
  factory BiddingSeasonalityAdjustmentOperation({
    $2368.BiddingSeasonalityAdjustment? create_1,
    $2368.BiddingSeasonalityAdjustment? update,
    $core.String? remove,
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(_omitMessageNames ? '' : 'BiddingSeasonalityAdjustmentOperation', package: const $pb.PackageName(_omitMessageNames ? '' : 'google.ads.googleads.v15.services'), createEmptyInstance: create)
    ..oo(0, [1, 2, 3])
    ..aOM<$2368.BiddingSeasonalityAdjustment>(1, _omitFieldNames ? '' : 'create', subBuilder: $2368.BiddingSeasonalityAdjustment.create)
    ..aOM<$2368.BiddingSeasonalityAdjustment>(2, _omitFieldNames ? '' : 'update', subBuilder: $2368.BiddingSeasonalityAdjustment.create)
  ...
  /// adjustment.
  @$pb.TagNumber(1)
  $2368.BiddingSeasonalityAdjustment get create_1 => $_getN(0);
  @$pb.TagNumber(1)
  set create_1($2368.BiddingSeasonalityAdjustment v) { setField(1, v); }
  @$pb.TagNumber(1)
  $core.bool hasCreate_1() => $_has(0);
  @$pb.TagNumber(1)
  void clearCreate_1() => clearField(1);
  @$pb.TagNumber(1)
  $2368.BiddingSeasonalityAdjustment ensureCreate_1() => $_ensure(0);

  /// Update operation: The seasonality adjustment is expected to have a valid
  /// resource name.
  @$pb.TagNumber(2)
  $2368.BiddingSeasonalityAdjustment get update => $_getN(1);
  @$pb.TagNumber(2)
  set update($2368.BiddingSeasonalityAdjustment v) { setField(2, v); }
  @$pb.TagNumber(2)
  $core.bool hasUpdate() => $_has(1);
  @$pb.TagNumber(2)
  void clearUpdate() => clearField(2);
  @$pb.TagNumber(2)
  $2368.BiddingSeasonalityAdjustment ensureUpdate() => $_ensure(1);
...
class MutateBiddingSeasonalityAdjustmentsResult extends $pb.GeneratedMessage {
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(_omitMessageNames ? '' : 'MutateBiddingSeasonalityAdjustmentsResult', package: const $pb.PackageName(_omitMessageNames ? '' : 'google.ads.googleads.v15.services'), createEmptyInstance: create)
    ...
    ..aOM<$2368.BiddingSeasonalityAdjustment>(2, _omitFieldNames ? '' : 'biddingSeasonalityAdjustment', subBuilder: $2368.BiddingSeasonalityAdjustment.create)
    ..hasRequiredFields = false
  ;
  ...
  /// to "MUTABLE_RESOURCE".
  @$pb.TagNumber(2)
  $2368.BiddingSeasonalityAdjustment get biddingSeasonalityAdjustment => $_getN(1);
  @$pb.TagNumber(2)
  set biddingSeasonalityAdjustment($2368.BiddingSeasonalityAdjustment v) { setField(2, v); }
  @$pb.TagNumber(2)
  $core.bool hasBiddingSeasonalityAdjustment() => $_has(1);
  @$pb.TagNumber(2)
  void clearBiddingSeasonalityAdjustment() => clearField(2);
  @$pb.TagNumber(2)
  $2368.BiddingSeasonalityAdjustment ensureBiddingSeasonalityAdjustment() => $_ensure(1);
}
