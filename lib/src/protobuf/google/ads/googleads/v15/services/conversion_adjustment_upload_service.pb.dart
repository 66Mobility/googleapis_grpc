...
import '../enums/conversion_adjustment_type.pbenum.dart' as $2510;
...
class UploadConversionAdjustmentsRequest extends $pb.GeneratedMessage {
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(_omitMessageNames ? '' : 'UploadConversionAdjustmentsRequest', package: const $pb.PackageName(_omitMessageNames ? '' : 'google.ads.googleads.v15.services'), createEmptyInstance: create)
...
class UploadConversionAdjustmentsResponse extends $pb.GeneratedMessage {
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(_omitMessageNames ? '' : 'UploadConversionAdjustmentsResponse', package: const $pb.PackageName(_omitMessageNames ? '' : 'google.ads.googleads.v15.services'), createEmptyInstance: create)
...
class ConversionAdjustment extends $pb.GeneratedMessage {
  factory ConversionAdjustment({
    $2510.ConversionAdjustmentTypeEnum_ConversionAdjustmentType? adjustmentType,
    RestatementValue? restatementValue,
    $core.String? conversionAction,
    $core.String? adjustmentDateTime,
    $core.Iterable<$2325.UserIdentifier>? userIdentifiers,
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(_omitMessageNames ? '' : 'ConversionAdjustment', package: const $pb.PackageName(_omitMessageNames ? '' : 'google.ads.googleads.v15.services'), createEmptyInstance: create)
    ..e<$2510.ConversionAdjustmentTypeEnum_ConversionAdjustmentType>(5, _omitFieldNames ? '' : 'adjustmentType', $pb.PbFieldType.OE, defaultOrMaker: $2510.ConversionAdjustmentTypeEnum_ConversionAdjustmentType.UNSPECIFIED, valueOf: $2510.ConversionAdjustmentTypeEnum_ConversionAdjustmentType.valueOf, enumValues: $2510.ConversionAdjustmentTypeEnum_ConversionAdjustmentType.values)
    ...
    ..pc<$2325.UserIdentifier>(10, _omitFieldNames ? '' : 'userIdentifiers', $pb.PbFieldType.PM, subBuilder: $2325.UserIdentifier.create)
  ...
  /// The adjustment type.
  @$pb.TagNumber(5)
  $2510.ConversionAdjustmentTypeEnum_ConversionAdjustmentType get adjustmentType => $_getN(0);
  @$pb.TagNumber(5)
  set adjustmentType($2510.ConversionAdjustmentTypeEnum_ConversionAdjustmentType v) { setField(5, v); }
  @$pb.TagNumber(5)
  ...
  /// enhancement is 5.
  @$pb.TagNumber(10)
  $core.List<$2325.UserIdentifier> get userIdentifiers => $_getList(4);
...
class RestatementValue extends $pb.GeneratedMessage {
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(_omitMessageNames ? '' : 'RestatementValue', package: const $pb.PackageName(_omitMessageNames ? '' : 'google.ads.googleads.v15.services'), createEmptyInstance: create)
...
class GclidDateTimePair extends $pb.GeneratedMessage {
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(_omitMessageNames ? '' : 'GclidDateTimePair', package: const $pb.PackageName(_omitMessageNames ? '' : 'google.ads.googleads.v15.services'), createEmptyInstance: create)
...
class ConversionAdjustmentResult extends $pb.GeneratedMessage {
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(_omitMessageNames ? '' : 'ConversionAdjustmentResult', package: const $pb.PackageName(_omitMessageNames ? '' : 'google.ads.googleads.v15.services'), createEmptyInstance: create)
    ..e<$2510.ConversionAdjustmentTypeEnum_ConversionAdjustmentType>(5, _omitFieldNames ? '' : 'adjustmentType', $pb.PbFieldType.OE, defaultOrMaker: $2510.ConversionAdjustmentTypeEnum_ConversionAdjustmentType.UNSPECIFIED, valueOf: $2510.ConversionAdjustmentTypeEnum_ConversionAdjustmentType.valueOf, enumValues: $2510.ConversionAdjustmentTypeEnum_ConversionAdjustmentType.values)
