...
import '../enums/conversion_adjustment_type.pbenum.dart' as $2511;
...
class ConversionAdjustment extends $pb.GeneratedMessage {
  factory ConversionAdjustment({
    $2511.ConversionAdjustmentTypeEnum_ConversionAdjustmentType? adjustmentType,
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(_omitMessageNames ? '' : 'ConversionAdjustment', package: const $pb.PackageName(_omitMessageNames ? '' : 'google.ads.googleads.v15.services'), createEmptyInstance: create)
    ..e<$2511.ConversionAdjustmentTypeEnum_ConversionAdjustmentType>(5, _omitFieldNames ? '' : 'adjustmentType', $pb.PbFieldType.OE, defaultOrMaker: $2511.ConversionAdjustmentTypeEnum_ConversionAdjustmentType.UNSPECIFIED, valueOf: $2511.ConversionAdjustmentTypeEnum_ConversionAdjustmentType.valueOf, enumValues: $2511.ConversionAdjustmentTypeEnum_ConversionAdjustmentType.values)
    ...
    ..pc<$2326.UserIdentifier>(10, _omitFieldNames ? '' : 'userIdentifiers', $pb.PbFieldType.PM, subBuilder: $2326.UserIdentifier.create)
  ...
  /// The adjustment type.
  @$pb.TagNumber(5)
  $2511.ConversionAdjustmentTypeEnum_ConversionAdjustmentType get adjustmentType => $_getN(0);
  @$pb.TagNumber(5)
  set adjustmentType($2511.ConversionAdjustmentTypeEnum_ConversionAdjustmentType v) { setField(5, v); }
  @$pb.TagNumber(5)
  ...
  /// enhancement is 5.
  @$pb.TagNumber(10)
  $core.List<$2326.UserIdentifier> get userIdentifiers => $_getList(4);
