...
class AppPlaceholderFieldEnum extends $pb.GeneratedMessage {
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(_omitMessageNames ? '' : 'AppPlaceholderFieldEnum', package: const $pb.PackageName(_omitMessageNames ? '' : 'google.ads.googleads.v16.enums'), createEmptyInstance: create)
  ...
  'Will be removed in next major version')
  AppPlaceholderFieldEnum copyWith(void Function(AppPlaceholderFieldEnum) updates) => super.copyWith((message) => updates(message as AppPlaceholderFieldEnum)) as AppPlaceholderFieldEnum;
