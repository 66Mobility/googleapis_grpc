...
class HotelPriceBucketEnum extends $pb.GeneratedMessage {
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(_omitMessageNames ? '' : 'HotelPriceBucketEnum', package: const $pb.PackageName(_omitMessageNames ? '' : 'google.ads.googleads.v16.enums'), createEmptyInstance: create)
  ...
  'Will be removed in next major version')
  HotelPriceBucketEnum copyWith(void Function(HotelPriceBucketEnum) updates) => super.copyWith((message) => updates(message as HotelPriceBucketEnum)) as HotelPriceBucketEnum;
