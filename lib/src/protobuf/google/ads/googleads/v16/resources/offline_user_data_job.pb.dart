...
import '../enums/offline_user_data_job_failure_reason.pbenum.dart' as $3042;
import '../enums/offline_user_data_job_match_rate_range.pbenum.dart' as $3043;
import '../enums/offline_user_data_job_status.pbenum.dart' as $3041;
import '../enums/offline_user_data_job_type.pbenum.dart' as $3040;
...
class OfflineUserDataJob extends $pb.GeneratedMessage {
  factory OfflineUserDataJob({
    ...
    $3040.OfflineUserDataJobTypeEnum_OfflineUserDataJobType? type,
    $3041.OfflineUserDataJobStatusEnum_OfflineUserDataJobStatus? status,
    $3042.OfflineUserDataJobFailureReasonEnum_OfflineUserDataJobFailureReason? failureReason,
    $3039.CustomerMatchUserListMetadata? customerMatchUserListMetadata,
    $3039.StoreSalesMetadata? storeSalesMetadata,
    $fixnum.Int64? id,
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(_omitMessageNames ? '' : 'OfflineUserDataJob', package: const $pb.PackageName(_omitMessageNames ? '' : 'google.ads.googleads.v16.resources'), createEmptyInstance: create)
    ..oo(0, [7, 8])
    ..aOS(1, _omitFieldNames ? '' : 'resourceName')
    ..e<$3040.OfflineUserDataJobTypeEnum_OfflineUserDataJobType>(4, _omitFieldNames ? '' : 'type', $pb.PbFieldType.OE, defaultOrMaker: $3040.OfflineUserDataJobTypeEnum_OfflineUserDataJobType.UNSPECIFIED, valueOf: $3040.OfflineUserDataJobTypeEnum_OfflineUserDataJobType.valueOf, enumValues: $3040.OfflineUserDataJobTypeEnum_OfflineUserDataJobType.values)
    ..e<$3041.OfflineUserDataJobStatusEnum_OfflineUserDataJobStatus>(5, _omitFieldNames ? '' : 'status', $pb.PbFieldType.OE, defaultOrMaker: $3041.OfflineUserDataJobStatusEnum_OfflineUserDataJobStatus.UNSPECIFIED, valueOf: $3041.OfflineUserDataJobStatusEnum_OfflineUserDataJobStatus.valueOf, enumValues: $3041.OfflineUserDataJobStatusEnum_OfflineUserDataJobStatus.values)
    ..e<$3042.OfflineUserDataJobFailureReasonEnum_OfflineUserDataJobFailureReason>(6, _omitFieldNames ? '' : 'failureReason', $pb.PbFieldType.OE, defaultOrMaker: $3042.OfflineUserDataJobFailureReasonEnum_OfflineUserDataJobFailureReason.UNSPECIFIED, valueOf: $3042.OfflineUserDataJobFailureReasonEnum_OfflineUserDataJobFailureReason.valueOf, enumValues: $3042.OfflineUserDataJobFailureReasonEnum_OfflineUserDataJobFailureReason.values)
    ..aOM<$3039.CustomerMatchUserListMetadata>(7, _omitFieldNames ? '' : 'customerMatchUserListMetadata', subBuilder: $3039.CustomerMatchUserListMetadata.create)
    ..aOM<$3039.StoreSalesMetadata>(8, _omitFieldNames ? '' : 'storeSalesMetadata', subBuilder: $3039.StoreSalesMetadata.create)
  ...
  @$pb.TagNumber(4)
  $3040.OfflineUserDataJobTypeEnum_OfflineUserDataJobType get type => $_getN(1);
  @$pb.TagNumber(4)
  set type($3040.OfflineUserDataJobTypeEnum_OfflineUserDataJobType v) { setField(4, v); }
  @$pb.TagNumber(4)
  ...
  @$pb.TagNumber(5)
  $3041.OfflineUserDataJobStatusEnum_OfflineUserDataJobStatus get status => $_getN(2);
  @$pb.TagNumber(5)
  set status($3041.OfflineUserDataJobStatusEnum_OfflineUserDataJobStatus v) { setField(5, v); }
  @$pb.TagNumber(5)
  ...
  @$pb.TagNumber(6)
  $3042.OfflineUserDataJobFailureReasonEnum_OfflineUserDataJobFailureReason get failureReason => $_getN(3);
  @$pb.TagNumber(6)
  set failureReason($3042.OfflineUserDataJobFailureReasonEnum_OfflineUserDataJobFailureReason v) { setField(6, v); }
  @$pb.TagNumber(6)
  ...
  @$pb.TagNumber(7)
  $3039.CustomerMatchUserListMetadata get customerMatchUserListMetadata => $_getN(4);
  @$pb.TagNumber(7)
  set customerMatchUserListMetadata($3039.CustomerMatchUserListMetadata v) { setField(7, v); }
  @$pb.TagNumber(7)
  $core.bool hasCustomerMatchUserListMetadata() => $_has(4);
  @$pb.TagNumber(7)
  void clearCustomerMatchUserListMetadata() => clearField(7);
  @$pb.TagNumber(7)
  $3039.CustomerMatchUserListMetadata ensureCustomerMatchUserListMetadata() => $_ensure(4);

  /// Immutable. Metadata for store sales data update.
  @$pb.TagNumber(8)
  $3039.StoreSalesMetadata get storeSalesMetadata => $_getN(5);
  @$pb.TagNumber(8)
  set storeSalesMetadata($3039.StoreSalesMetadata v) { setField(8, v); }
  @$pb.TagNumber(8)
  $core.bool hasStoreSalesMetadata() => $_has(5);
  @$pb.TagNumber(8)
  void clearStoreSalesMetadata() => clearField(8);
  @$pb.TagNumber(8)
  $3039.StoreSalesMetadata ensureStoreSalesMetadata() => $_ensure(5);
...
class OfflineUserDataJobMetadata extends $pb.GeneratedMessage {
  factory OfflineUserDataJobMetadata({
    $3043.OfflineUserDataJobMatchRateRangeEnum_OfflineUserDataJobMatchRateRange? matchRateRange,
  }) {
    final $result = create();
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(_omitMessageNames ? '' : 'OfflineUserDataJobMetadata', package: const $pb.PackageName(_omitMessageNames ? '' : 'google.ads.googleads.v16.resources'), createEmptyInstance: create)
    ..e<$3043.OfflineUserDataJobMatchRateRangeEnum_OfflineUserDataJobMatchRateRange>(1, _omitFieldNames ? '' : 'matchRateRange', $pb.PbFieldType.OE, defaultOrMaker: $3043.OfflineUserDataJobMatchRateRangeEnum_OfflineUserDataJobMatchRateRange.UNSPECIFIED, valueOf: $3043.OfflineUserDataJobMatchRateRangeEnum_OfflineUserDataJobMatchRateRange.valueOf, enumValues: $3043.OfflineUserDataJobMatchRateRangeEnum_OfflineUserDataJobMatchRateRange.values)
    ..hasRequiredFields = false
  ;
  ...
  @$pb.TagNumber(1)
  $3043.OfflineUserDataJobMatchRateRangeEnum_OfflineUserDataJobMatchRateRange get matchRateRange => $_getN(0);
  @$pb.TagNumber(1)
  set matchRateRange($3043.OfflineUserDataJobMatchRateRangeEnum_OfflineUserDataJobMatchRateRange v) { setField(1, v); }
  @$pb.TagNumber(1)
