...
import '../enums/asset_set_asset_status.pbenum.dart' as $2862;
...
class AssetSetAsset extends $pb.GeneratedMessage {
  factory AssetSetAsset({
    ...
    $core.String? asset,
    $2862.AssetSetAssetStatusEnum_AssetSetAssetStatus? status,
  }) {
    final $result = create();
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(_omitMessageNames ? '' : 'AssetSetAsset', package: const $pb.PackageName(_omitMessageNames ? '' : 'google.ads.googleads.v16.resources'), createEmptyInstance: create)
    ...
    ..e<$2862.AssetSetAssetStatusEnum_AssetSetAssetStatus>(4, _omitFieldNames ? '' : 'status', $pb.PbFieldType.OE, defaultOrMaker: $2862.AssetSetAssetStatusEnum_AssetSetAssetStatus.UNSPECIFIED, valueOf: $2862.AssetSetAssetStatusEnum_AssetSetAssetStatus.valueOf, enumValues: $2862.AssetSetAssetStatusEnum_AssetSetAssetStatus.values)
  ...
  @$pb.TagNumber(4)
  $2862.AssetSetAssetStatusEnum_AssetSetAssetStatus get status => $_getN(3);
  @$pb.TagNumber(4)
  set status($2862.AssetSetAssetStatusEnum_AssetSetAssetStatus v) { setField(4, v); }
  @$pb.TagNumber(4)
