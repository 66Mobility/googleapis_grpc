...
const AccountLink$json = {
  ...
  '2': [
    ...
    {'1': 'status', '3': 3, '4': 1, '5': 14, '6': '.google.ads.googleads.v16.enums.AccountLinkStatusEnum.AccountLinkStatus', '10': 'status'},
    {'1': 'type', '3': 4, '4': 1, '5': 14, '6': '.google.ads.googleads.v16.enums.LinkedAccountTypeEnum.LinkedAccountType', '8': {}, '10': 'type'},
    {'1': 'third_party_app_analytics', '3': 5, '4': 1, '5': 11, '6': '.google.ads.googleads.v16.resources.ThirdPartyAppAnalyticsLinkIdentifier', '8': {}, '9': 0, '10': 'thirdPartyAppAnalytics'},
  ],
  '7': {},
  '8': [
    {'1': 'linked_account'},
...
final $typed_data.Uint8List accountLinkDescriptor = $convert.base64Decode(
    ...
    '9vZ2xlLmFkcy5nb29nbGVhZHMudjE2LmVudW1zLkFjY291bnRMaW5rU3RhdHVzRW51bS5BY2Nv'
    'dW50TGlua1N0YXR1c1IGc3RhdHVzEmAKBHR5cGUYBCABKA4yRy5nb29nbGUuYWRzLmdvb2dsZW'
    'Fkcy52MTYuZW51bXMuTGlua2VkQWNjb3VudFR5cGVFbnVtLkxpbmtlZEFjY291bnRUeXBlQgPg'
    'QQNSBHR5cGUSigEKGXRoaXJkX3BhcnR5X2FwcF9hbmFseXRpY3MYBSABKAsySC5nb29nbGUuYW'
    'RzLmdvb2dsZWFkcy52MTYucmVzb3VyY2VzLlRoaXJkUGFydHlBcHBBbmFseXRpY3NMaW5rSWRl'
...
const ThirdPartyAppAnalyticsLinkIdentifier$json = {
  ...
  '2': [
    ...
    {'1': 'app_vendor', '3': 3, '4': 1, '5': 14, '6': '.google.ads.googleads.v16.enums.MobileAppVendorEnum.MobileAppVendor', '8': {}, '10': 'appVendor'},
  ],
  '8': [
...
final $typed_data.Uint8List thirdPartyAppAnalyticsLinkIdentifierDescriptor = $convert.base64Decode(
    ...
    'dsZS5hZHMuZ29vZ2xlYWRzLnYxNi5lbnVtcy5Nb2JpbGVBcHBWZW5kb3JFbnVtLk1vYmlsZUFw'
