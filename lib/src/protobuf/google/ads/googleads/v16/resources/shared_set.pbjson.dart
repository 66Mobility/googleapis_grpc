...
const SharedSet$json = {
  ...
  '2': [
    ...
    {'1': 'type', '3': 3, '4': 1, '5': 14, '6': '.google.ads.googleads.v16.enums.SharedSetTypeEnum.SharedSetType', '8': {}, '10': 'type'},
    {'1': 'name', '3': 9, '4': 1, '5': 9, '9': 1, '10': 'name', '17': true},
    {'1': 'status', '3': 5, '4': 1, '5': 14, '6': '.google.ads.googleads.v16.enums.SharedSetStatusEnum.SharedSetStatus', '8': {}, '10': 'status'},
...
final $typed_data.Uint8List sharedSetDescriptor = $convert.base64Decode(
    ...
    'UgJpZIgBARJYCgR0eXBlGAMgASgOMj8uZ29vZ2xlLmFkcy5nb29nbGVhZHMudjE2LmVudW1zLl'
    'NoYXJlZFNldFR5cGVFbnVtLlNoYXJlZFNldFR5cGVCA+BBBVIEdHlwZRIXCgRuYW1lGAkgASgJ'
    'SAFSBG5hbWWIAQESYAoGc3RhdHVzGAUgASgOMkMuZ29vZ2xlLmFkcy5nb29nbGVhZHMudjE2Lm'
