...
const SearchTermView$json = {
  ...
  '2': [
    ...
    {'1': 'status', '3': 4, '4': 1, '5': 14, '6': '.google.ads.googleads.v16.enums.SearchTermTargetingStatusEnum.SearchTermTargetingStatus', '8': {}, '10': 'status'},
  ],
  '7': {},
  '8': [
    {'1': '_search_term'},
...
final $typed_data.Uint8List searchTermViewDescriptor = $convert.base64Decode(
    ...
    'BnN0YXR1cxgEIAEoDjJXLmdvb2dsZS5hZHMuZ29vZ2xlYWRzLnYxNi5lbnVtcy5TZWFyY2hUZX'
