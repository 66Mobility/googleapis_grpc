...
import '../enums/local_services_conversation_type.pbenum.dart' as $3025;
import '../enums/local_services_participant_type.pbenum.dart' as $3026;
...
class LocalServicesLeadConversation extends $pb.GeneratedMessage {
  factory LocalServicesLeadConversation({
    ...
    $fixnum.Int64? id,
    $3025.LocalServicesLeadConversationTypeEnum_ConversationType? conversationChannel,
    $3026.LocalServicesParticipantTypeEnum_ParticipantType? participantType,
    $core.String? lead,
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(_omitMessageNames ? '' : 'LocalServicesLeadConversation', package: const $pb.PackageName(_omitMessageNames ? '' : 'google.ads.googleads.v16.resources'), createEmptyInstance: create)
    ...
    ..e<$3025.LocalServicesLeadConversationTypeEnum_ConversationType>(3, _omitFieldNames ? '' : 'conversationChannel', $pb.PbFieldType.OE, defaultOrMaker: $3025.LocalServicesLeadConversationTypeEnum_ConversationType.UNSPECIFIED, valueOf: $3025.LocalServicesLeadConversationTypeEnum_ConversationType.valueOf, enumValues: $3025.LocalServicesLeadConversationTypeEnum_ConversationType.values)
    ..e<$3026.LocalServicesParticipantTypeEnum_ParticipantType>(4, _omitFieldNames ? '' : 'participantType', $pb.PbFieldType.OE, defaultOrMaker: $3026.LocalServicesParticipantTypeEnum_ParticipantType.UNSPECIFIED, valueOf: $3026.LocalServicesParticipantTypeEnum_ParticipantType.valueOf, enumValues: $3026.LocalServicesParticipantTypeEnum_ParticipantType.values)
  ...
  /// SMS, etc.
  @$pb.TagNumber(3)
  $3025.LocalServicesLeadConversationTypeEnum_ConversationType get conversationChannel => $_getN(2);
  @$pb.TagNumber(3)
  set conversationChannel($3025.LocalServicesLeadConversationTypeEnum_ConversationType v) { setField(3, v); }
  @$pb.TagNumber(3)
  ...
  /// CONSUMER.
  @$pb.TagNumber(4)
  $3026.LocalServicesParticipantTypeEnum_ParticipantType get participantType => $_getN(3);
  @$pb.TagNumber(4)
  set participantType($3026.LocalServicesParticipantTypeEnum_ParticipantType v) { setField(4, v); }
  @$pb.TagNumber(4)
