...
const FeedItemSet$json = {
  ...
  '2': [
    ...
    {'1': 'status', '3': 8, '4': 1, '5': 14, '6': '.google.ads.googleads.v16.enums.FeedItemSetStatusEnum.FeedItemSetStatus', '8': {}, '10': 'status'},
    {'1': 'dynamic_location_set_filter', '3': 5, '4': 1, '5': 11, '6': '.google.ads.googleads.v16.common.DynamicLocationSetFilter', '9': 0, '10': 'dynamicLocationSetFilter'},
    {'1': 'dynamic_affiliate_location_set_filter', '3': 6, '4': 1, '5': 11, '6': '.google.ads.googleads.v16.common.DynamicAffiliateLocationSetFilter', '9': 0, '10': 'dynamicAffiliateLocationSetFilter'},
  ],
  '7': {},
  '8': [
...
final $typed_data.Uint8List feedItemSetDescriptor = $convert.base64Decode(
    ...
    'E2LmVudW1zLkZlZWRJdGVtU2V0U3RhdHVzRW51bS5GZWVkSXRlbVNldFN0YXR1c0ID4EEDUgZz'
    'dGF0dXMSegobZHluYW1pY19sb2NhdGlvbl9zZXRfZmlsdGVyGAUgASgLMjkuZ29vZ2xlLmFkcy'
    '5nb29nbGVhZHMudjE2LmNvbW1vbi5EeW5hbWljTG9jYXRpb25TZXRGaWx0ZXJIAFIYZHluYW1p'
    'Y0xvY2F0aW9uU2V0RmlsdGVyEpYBCiVkeW5hbWljX2FmZmlsaWF0ZV9sb2NhdGlvbl9zZXRfZm'
    'lsdGVyGAYgASgLMkIuZ29vZ2xlLmFkcy5nb29nbGVhZHMudjE2LmNvbW1vbi5EeW5hbWljQWZm'
