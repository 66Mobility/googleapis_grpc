...
const Customer$json = {
  ...
  '2': [
    ...
    {'1': 'call_reporting_setting', '3': 10, '4': 1, '5': 11, '6': '.google.ads.googleads.v16.resources.CallReportingSetting', '10': 'callReportingSetting'},
    {'1': 'conversion_tracking_setting', '3': 14, '4': 1, '5': 11, '6': '.google.ads.googleads.v16.resources.ConversionTrackingSetting', '8': {}, '10': 'conversionTrackingSetting'},
    {'1': 'remarketing_setting', '3': 15, '4': 1, '5': 11, '6': '.google.ads.googleads.v16.resources.RemarketingSetting', '8': {}, '10': 'remarketingSetting'},
    {'1': 'pay_per_conversion_eligibility_failure_reasons', '3': 16, '4': 3, '5': 14, '6': '.google.ads.googleads.v16.enums.CustomerPayPerConversionEligibilityFailureReasonEnum.CustomerPayPerConversionEligibilityFailureReason', '8': {}, '10': 'payPerConversionEligibilityFailureReasons'},
    ...
    {'1': 'status', '3': 36, '4': 1, '5': 14, '6': '.google.ads.googleads.v16.enums.CustomerStatusEnum.CustomerStatus', '8': {}, '10': 'status'},
    ...
    {'1': 'customer_agreement_setting', '3': 44, '4': 1, '5': 11, '6': '.google.ads.googleads.v16.resources.CustomerAgreementSetting', '8': {}, '10': 'customerAgreementSetting'},
    {'1': 'local_services_settings', '3': 45, '4': 1, '5': 11, '6': '.google.ads.googleads.v16.resources.LocalServicesSettings', '8': {}, '10': 'localServicesSettings'},
    {'1': 'video_brand_safety_suitability', '3': 46, '4': 1, '5': 14, '6': '.google.ads.googleads.v16.enums.BrandSafetySuitabilityEnum.BrandSafetySuitability', '8': {}, '10': 'videoBrandSafetySuitability'},
  ],
  '7': {},
  '8': [
    {'1': '_id'},
...
final $typed_data.Uint8List customerDescriptor = $convert.base64Decode(
    ...
    'cmVwb3J0aW5nX3NldHRpbmcYCiABKAsyOC5nb29nbGUuYWRzLmdvb2dsZWFkcy52MTYucmVzb3'
    ...
    'E2LnJlc291cmNlcy5Db252ZXJzaW9uVHJhY2tpbmdTZXR0aW5nQgPgQQNSGWNvbnZlcnNpb25U'
    'cmFja2luZ1NldHRpbmcSbAoTcmVtYXJrZXRpbmdfc2V0dGluZxgPIAEoCzI2Lmdvb2dsZS5hZH'
    'MuZ29vZ2xlYWRzLnYxNi5yZXNvdXJjZXMuUmVtYXJrZXRpbmdTZXR0aW5nQgPgQQNSEnJlbWFy'
    'a2V0aW5nU2V0dGluZxLuAQoucGF5X3Blcl9jb252ZXJzaW9uX2VsaWdpYmlsaXR5X2ZhaWx1cm'
    'VfcmVhc29ucxgQIAMoDjKFAS5nb29nbGUuYWRzLmdvb2dsZWFkcy52MTYuZW51bXMuQ3VzdG9t'
    ...
    'ABKA4yQS5nb29nbGUuYWRzLmdvb2dsZWFkcy52MTYuZW51bXMuQ3VzdG9tZXJTdGF0dXNFbnVt'
    ...
    'cy5nb29nbGVhZHMudjE2LnJlc291cmNlcy5DdXN0b21lckFncmVlbWVudFNldHRpbmdCA+BBA1'
    'IYY3VzdG9tZXJBZ3JlZW1lbnRTZXR0aW5nEnYKF2xvY2FsX3NlcnZpY2VzX3NldHRpbmdzGC0g'
    'ASgLMjkuZ29vZ2xlLmFkcy5nb29nbGVhZHMudjE2LnJlc291cmNlcy5Mb2NhbFNlcnZpY2VzU2'
    'V0dGluZ3NCA+BBA1IVbG9jYWxTZXJ2aWNlc1NldHRpbmdzEpsBCh52aWRlb19icmFuZF9zYWZl'
    'dHlfc3VpdGFiaWxpdHkYLiABKA4yUS5nb29nbGUuYWRzLmdvb2dsZWFkcy52MTYuZW51bXMuQn'
...
const ConversionTrackingSetting$json = {
  ...
  '2': [
    ...
    {'1': 'conversion_tracking_status', '3': 6, '4': 1, '5': 14, '6': '.google.ads.googleads.v16.enums.ConversionTrackingStatusEnum.ConversionTrackingStatus', '8': {}, '10': 'conversionTrackingStatus'},
...
final $typed_data.Uint8List conversionTrackingSettingDescriptor = $convert.base64Decode(
    ...
    'RhdHVzGAYgASgOMlUuZ29vZ2xlLmFkcy5nb29nbGVhZHMudjE2LmVudW1zLkNvbnZlcnNpb25U'
...
const LocalServicesSettings$json = {
  ...
  '2': [
    {'1': 'granular_license_statuses', '3': 1, '4': 3, '5': 11, '6': '.google.ads.googleads.v16.resources.GranularLicenseStatus', '8': {}, '10': 'granularLicenseStatuses'},
    {'1': 'granular_insurance_statuses', '3': 2, '4': 3, '5': 11, '6': '.google.ads.googleads.v16.resources.GranularInsuranceStatus', '8': {}, '10': 'granularInsuranceStatuses'},
  ],
};
...
final $typed_data.Uint8List localServicesSettingsDescriptor = $convert.base64Decode(
    ...
    'MoCzI5Lmdvb2dsZS5hZHMuZ29vZ2xlYWRzLnYxNi5yZXNvdXJjZXMuR3JhbnVsYXJMaWNlbnNl'
    'U3RhdHVzQgPgQQNSF2dyYW51bGFyTGljZW5zZVN0YXR1c2VzEoABChtncmFudWxhcl9pbnN1cm'
    'FuY2Vfc3RhdHVzZXMYAiADKAsyOy5nb29nbGUuYWRzLmdvb2dsZWFkcy52MTYucmVzb3VyY2Vz'
...
const GranularLicenseStatus$json = {
  ...
  '2': [
    ...
    {'1': 'verification_status', '3': 3, '4': 1, '5': 14, '6': '.google.ads.googleads.v16.enums.LocalServicesVerificationStatusEnum.LocalServicesVerificationStatus', '8': {}, '9': 2, '10': 'verificationStatus', '17': true},
  ],
  '8': [
    {'1': '_geo_criterion_id'},
    {'1': '_category_id'},
...
final $typed_data.Uint8List granularLicenseStatusDescriptor = $convert.base64Decode(
    ...
    'xlYWRzLnYxNi5lbnVtcy5Mb2NhbFNlcnZpY2VzVmVyaWZpY2F0aW9uU3RhdHVzRW51bS5Mb2Nh'
...
final $typed_data.Uint8List granularInsuranceStatusDescriptor = $convert.base64Decode(
    ...
    '9nbGVhZHMudjE2LmVudW1zLkxvY2FsU2VydmljZXNWZXJpZmljYXRpb25TdGF0dXNFbnVtLkxv'
