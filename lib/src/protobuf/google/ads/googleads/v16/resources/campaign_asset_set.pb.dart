...
import '../enums/asset_set_link_status.pbenum.dart' as $2829;
...
class CampaignAssetSet extends $pb.GeneratedMessage {
  factory CampaignAssetSet({
    ...
    $2829.AssetSetLinkStatusEnum_AssetSetLinkStatus? status,
  }) {
    final $result = create();
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(_omitMessageNames ? '' : 'CampaignAssetSet', package: const $pb.PackageName(_omitMessageNames ? '' : 'google.ads.googleads.v16.resources'), createEmptyInstance: create)
    ...
    ..e<$2829.AssetSetLinkStatusEnum_AssetSetLinkStatus>(4, _omitFieldNames ? '' : 'status', $pb.PbFieldType.OE, defaultOrMaker: $2829.AssetSetLinkStatusEnum_AssetSetLinkStatus.UNSPECIFIED, valueOf: $2829.AssetSetLinkStatusEnum_AssetSetLinkStatus.valueOf, enumValues: $2829.AssetSetLinkStatusEnum_AssetSetLinkStatus.values)
  ...
  @$pb.TagNumber(4)
  $2829.AssetSetLinkStatusEnum_AssetSetLinkStatus get status => $_getN(3);
  @$pb.TagNumber(4)
  set status($2829.AssetSetLinkStatusEnum_AssetSetLinkStatus v) { setField(4, v); }
  @$pb.TagNumber(4)
