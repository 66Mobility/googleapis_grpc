...
import '../enums/conversion_custom_variable_status.pbenum.dart' as $2950;
...
class ConversionCustomVariable extends $pb.GeneratedMessage {
  factory ConversionCustomVariable({
    ...
    $core.String? name,
    $core.String? tag,
    $2950.ConversionCustomVariableStatusEnum_ConversionCustomVariableStatus? status,
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(_omitMessageNames ? '' : 'ConversionCustomVariable', package: const $pb.PackageName(_omitMessageNames ? '' : 'google.ads.googleads.v16.resources'), createEmptyInstance: create)
    ..aOS(1, _omitFieldNames ? '' : 'resourceName')
    ..aInt64(2, _omitFieldNames ? '' : 'id')
    ..aOS(3, _omitFieldNames ? '' : 'name')
    ..aOS(4, _omitFieldNames ? '' : 'tag')
    ..e<$2950.ConversionCustomVariableStatusEnum_ConversionCustomVariableStatus>(5, _omitFieldNames ? '' : 'status', $pb.PbFieldType.OE, defaultOrMaker: $2950.ConversionCustomVariableStatusEnum_ConversionCustomVariableStatus.UNSPECIFIED, valueOf: $2950.ConversionCustomVariableStatusEnum_ConversionCustomVariableStatus.valueOf, enumValues: $2950.ConversionCustomVariableStatusEnum_ConversionCustomVariableStatus.values)
  ...
  @$pb.TagNumber(5)
  $2950.ConversionCustomVariableStatusEnum_ConversionCustomVariableStatus get status => $_getN(4);
  @$pb.TagNumber(5)
  set status($2950.ConversionCustomVariableStatusEnum_ConversionCustomVariableStatus v) { setField(5, v); }
  @$pb.TagNumber(5)
