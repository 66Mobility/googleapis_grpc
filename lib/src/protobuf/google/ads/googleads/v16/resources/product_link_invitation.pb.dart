...
import '../enums/linked_product_type.pbenum.dart' as $3046;
import '../enums/product_link_invitation_status.pbenum.dart' as $3047;
...
class ProductLinkInvitation extends $pb.GeneratedMessage {
  factory ProductLinkInvitation({
    ...
    $3047.ProductLinkInvitationStatusEnum_ProductLinkInvitationStatus? status,
    HotelCenterLinkInvitationIdentifier? hotelCenter,
    MerchantCenterLinkInvitationIdentifier? merchantCenter,
    $3046.LinkedProductTypeEnum_LinkedProductType? type,
  ...
  static const $core.Map<$core.int, ProductLinkInvitation_InvitedAccount> _ProductLinkInvitation_InvitedAccountByTag = {
    ...
    7 : ProductLinkInvitation_InvitedAccount.advertisingPartner,
    0 : ProductLinkInvitation_InvitedAccount.notSet
  };
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(_omitMessageNames ? '' : 'ProductLinkInvitation', package: const $pb.PackageName(_omitMessageNames ? '' : 'google.ads.googleads.v16.resources'), createEmptyInstance: create)
    ..oo(0, [4, 5, 7])
    ..aOS(1, _omitFieldNames ? '' : 'resourceName')
    ..aInt64(2, _omitFieldNames ? '' : 'productLinkInvitationId')
    ..e<$3047.ProductLinkInvitationStatusEnum_ProductLinkInvitationStatus>(3, _omitFieldNames ? '' : 'status', $pb.PbFieldType.OE, defaultOrMaker: $3047.ProductLinkInvitationStatusEnum_ProductLinkInvitationStatus.UNSPECIFIED, valueOf: $3047.ProductLinkInvitationStatusEnum_ProductLinkInvitationStatus.valueOf, enumValues: $3047.ProductLinkInvitationStatusEnum_ProductLinkInvitationStatus.values)
    ...
    ..e<$3046.LinkedProductTypeEnum_LinkedProductType>(6, _omitFieldNames ? '' : 'type', $pb.PbFieldType.OE, defaultOrMaker: $3046.LinkedProductTypeEnum_LinkedProductType.UNSPECIFIED, valueOf: $3046.LinkedProductTypeEnum_LinkedProductType.valueOf, enumValues: $3046.LinkedProductTypeEnum_LinkedProductType.values)
  ...
  /// This field is read only.
  @$pb.TagNumber(3)
  $3047.ProductLinkInvitationStatusEnum_ProductLinkInvitationStatus get status => $_getN(2);
  @$pb.TagNumber(3)
  set status($3047.ProductLinkInvitationStatusEnum_ProductLinkInvitationStatus v) { setField(3, v); }
  @$pb.TagNumber(3)
  ...
  @$pb.TagNumber(6)
  $3046.LinkedProductTypeEnum_LinkedProductType get type => $_getN(5);
  @$pb.TagNumber(6)
  set type($3046.LinkedProductTypeEnum_LinkedProductType v) { setField(6, v); }
  @$pb.TagNumber(6)
  ...
  @$pb.TagNumber(7)
  AdvertisingPartnerLinkInvitationIdentifier get advertisingPartner => $_getN(6);
  @$pb.TagNumber(7)
  set advertisingPartner(AdvertisingPartnerLinkInvitationIdentifier v) { setField(7, v); }
  @$pb.TagNumber(7)
  $core.bool hasAdvertisingPartner() => $_has(6);
  @$pb.TagNumber(7)
  void clearAdvertisingPartner() => clearField(7);
  @$pb.TagNumber(7)
  AdvertisingPartnerLinkInvitationIdentifier ensureAdvertisingPartner() => $_ensure(6);
}
...
class HotelCenterLinkInvitationIdentifier extends $pb.GeneratedMessage {
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(_omitMessageNames ? '' : 'HotelCenterLinkInvitationIdentifier', package: const $pb.PackageName(_omitMessageNames ? '' : 'google.ads.googleads.v16.resources'), createEmptyInstance: create)
...
class MerchantCenterLinkInvitationIdentifier extends $pb.GeneratedMessage {
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(_omitMessageNames ? '' : 'MerchantCenterLinkInvitationIdentifier', package: const $pb.PackageName(_omitMessageNames ? '' : 'google.ads.googleads.v16.resources'), createEmptyInstance: create)
...
class AdvertisingPartnerLinkInvitationIdentifier extends $pb.GeneratedMessage {
  factory AdvertisingPartnerLinkInvitationIdentifier({
  ...
  AdvertisingPartnerLinkInvitationIdentifier._() : super();
  factory AdvertisingPartnerLinkInvitationIdentifier.fromBuffer($core.List<$core.int> i, [$pb.ExtensionRegistry r = $pb.ExtensionRegistry.EMPTY]) => create()..mergeFromBuffer(i, r);
  factory AdvertisingPartnerLinkInvitationIdentifier.fromJson($core.String i, [$pb.ExtensionRegistry r = $pb.ExtensionRegistry.EMPTY]) => create()..mergeFromJson(i, r);

  static final $pb.BuilderInfo _i = $pb.BuilderInfo(_omitMessageNames ? '' : 'AdvertisingPartnerLinkInvitationIdentifier', package: const $pb.PackageName(_omitMessageNames ? '' : 'google.ads.googleads.v16.resources'), createEmptyInstance: create)
  ...
  'Use [GeneratedMessageGenericExtensions.deepCopy] instead. '
  'Will be removed in next major version')
  AdvertisingPartnerLinkInvitationIdentifier clone() => AdvertisingPartnerLinkInvitationIdentifier()..mergeFromMessage(this);
  @$core.Deprecated(
  'Using this can add significant overhead to your binary. '
  'Use [GeneratedMessageGenericExtensions.rebuild] instead. '
  'Will be removed in next major version')
  AdvertisingPartnerLinkInvitationIdentifier copyWith(void Function(AdvertisingPartnerLinkInvitationIdentifier) updates) => super.copyWith((message) => updates(message as AdvertisingPartnerLinkInvitationIdentifier)) as AdvertisingPartnerLinkInvitationIdentifier;

  $pb.BuilderInfo get info_ => _i;

  @$core.pragma('dart2js:noInline')
  static AdvertisingPartnerLinkInvitationIdentifier create() => AdvertisingPartnerLinkInvitationIdentifier._();
  AdvertisingPartnerLinkInvitationIdentifier createEmptyInstance() => create();
  static $pb.PbList<AdvertisingPartnerLinkInvitationIdentifier> createRepeated() => $pb.PbList<AdvertisingPartnerLinkInvitationIdentifier>();
  @$core.pragma('dart2js:noInline')
  static AdvertisingPartnerLinkInvitationIdentifier getDefault() => _defaultInstance ??= $pb.GeneratedMessage.$_defaultFor<AdvertisingPartnerLinkInvitationIdentifier>(create);
  static AdvertisingPartnerLinkInvitationIdentifier? _defaultInstance;
