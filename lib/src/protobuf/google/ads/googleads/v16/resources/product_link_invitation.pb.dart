...
import '../enums/linked_product_type.pbenum.dart' as $3045;
...
class ProductLinkInvitation extends $pb.GeneratedMessage {
  factory ProductLinkInvitation({
    ...
    $3046.ProductLinkInvitationStatusEnum_ProductLinkInvitationStatus? status,
    HotelCenterLinkInvitationIdentifier? hotelCenter,
    MerchantCenterLinkInvitationIdentifier? merchantCenter,
    $3045.LinkedProductTypeEnum_LinkedProductType? type,
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(_omitMessageNames ? '' : 'ProductLinkInvitation', package: const $pb.PackageName(_omitMessageNames ? '' : 'google.ads.googleads.v16.resources'), createEmptyInstance: create)
    ...
    ..e<$3046.ProductLinkInvitationStatusEnum_ProductLinkInvitationStatus>(3, _omitFieldNames ? '' : 'status', $pb.PbFieldType.OE, defaultOrMaker: $3046.ProductLinkInvitationStatusEnum_ProductLinkInvitationStatus.UNSPECIFIED, valueOf: $3046.ProductLinkInvitationStatusEnum_ProductLinkInvitationStatus.valueOf, enumValues: $3046.ProductLinkInvitationStatusEnum_ProductLinkInvitationStatus.values)
    ...
    ..e<$3045.LinkedProductTypeEnum_LinkedProductType>(6, _omitFieldNames ? '' : 'type', $pb.PbFieldType.OE, defaultOrMaker: $3045.LinkedProductTypeEnum_LinkedProductType.UNSPECIFIED, valueOf: $3045.LinkedProductTypeEnum_LinkedProductType.valueOf, enumValues: $3045.LinkedProductTypeEnum_LinkedProductType.values)
  ...
  /// This field is read only.
  @$pb.TagNumber(3)
  $3046.ProductLinkInvitationStatusEnum_ProductLinkInvitationStatus get status => $_getN(2);
  @$pb.TagNumber(3)
  set status($3046.ProductLinkInvitationStatusEnum_ProductLinkInvitationStatus v) { setField(3, v); }
  @$pb.TagNumber(3)
  ...
  @$pb.TagNumber(6)
  $3045.LinkedProductTypeEnum_LinkedProductType get type => $_getN(5);
  @$pb.TagNumber(6)
  set type($3045.LinkedProductTypeEnum_LinkedProductType v) { setField(6, v); }
  @$pb.TagNumber(6)
