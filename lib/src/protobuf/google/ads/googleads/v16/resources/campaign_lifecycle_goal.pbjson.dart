...
const CampaignLifecycleGoal$json = {
  ...
  '2': [
    ...
    {'1': 'customer_acquisition_goal_settings', '3': 3, '4': 1, '5': 11, '6': '.google.ads.googleads.v16.resources.CustomerAcquisitionGoalSettings', '8': {}, '10': 'customerAcquisitionGoalSettings'},
  ],
  '7': {},
};
...
final $typed_data.Uint8List campaignLifecycleGoalDescriptor = $convert.base64Decode(
    ...
    'aW5ncxgDIAEoCzJDLmdvb2dsZS5hZHMuZ29vZ2xlYWRzLnYxNi5yZXNvdXJjZXMuQ3VzdG9tZX'
...
const CustomerAcquisitionGoalSettings$json = {
  ...
  '2': [
    {'1': 'optimization_mode', '3': 1, '4': 1, '5': 14, '6': '.google.ads.googleads.v16.enums.CustomerAcquisitionOptimizationModeEnum.CustomerAcquisitionOptimizationMode', '8': {}, '10': 'optimizationMode'},
    {'1': 'value_settings', '3': 2, '4': 1, '5': 11, '6': '.google.ads.googleads.v16.common.LifecycleGoalValueSettings', '8': {}, '10': 'valueSettings'},
  ],
};
...
final $typed_data.Uint8List customerAcquisitionGoalSettingsDescriptor = $convert.base64Decode(
    ...
    'gBIAEoDjJrLmdvb2dsZS5hZHMuZ29vZ2xlYWRzLnYxNi5lbnVtcy5DdXN0b21lckFjcXVpc2l0'
    ...
    'b2dsZS5hZHMuZ29vZ2xlYWRzLnYxNi5jb21tb24uTGlmZWN5Y2xlR29hbFZhbHVlU2V0dGluZ3'
