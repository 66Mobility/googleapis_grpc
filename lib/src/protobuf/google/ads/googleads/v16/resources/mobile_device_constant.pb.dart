...
import '../enums/mobile_device_type.pbenum.dart' as $3035;

/// A mobile device constant.
class MobileDeviceConstant extends $pb.GeneratedMessage {
  factory MobileDeviceConstant({
    $core.String? resourceName,
    $3035.MobileDeviceTypeEnum_MobileDeviceType? type,
    $fixnum.Int64? id,
    $core.String? name,
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(_omitMessageNames ? '' : 'MobileDeviceConstant', package: const $pb.PackageName(_omitMessageNames ? '' : 'google.ads.googleads.v16.resources'), createEmptyInstance: create)
    ..aOS(1, _omitFieldNames ? '' : 'resourceName')
    ..e<$3035.MobileDeviceTypeEnum_MobileDeviceType>(6, _omitFieldNames ? '' : 'type', $pb.PbFieldType.OE, defaultOrMaker: $3035.MobileDeviceTypeEnum_MobileDeviceType.UNSPECIFIED, valueOf: $3035.MobileDeviceTypeEnum_MobileDeviceType.valueOf, enumValues: $3035.MobileDeviceTypeEnum_MobileDeviceType.values)
  ...
  @$pb.TagNumber(6)
  $3035.MobileDeviceTypeEnum_MobileDeviceType get type => $_getN(1);
  @$pb.TagNumber(6)
  set type($3035.MobileDeviceTypeEnum_MobileDeviceType v) { setField(6, v); }
  @$pb.TagNumber(6)
