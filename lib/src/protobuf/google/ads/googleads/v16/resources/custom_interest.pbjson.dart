...
const CustomInterest$json = {
  ...
  '2': [
    ...
    {'1': 'status', '3': 3, '4': 1, '5': 14, '6': '.google.ads.googleads.v16.enums.CustomInterestStatusEnum.CustomInterestStatus', '10': 'status'},
    {'1': 'name', '3': 9, '4': 1, '5': 9, '9': 1, '10': 'name', '17': true},
    {'1': 'type', '3': 5, '4': 1, '5': 14, '6': '.google.ads.googleads.v16.enums.CustomInterestTypeEnum.CustomInterestType', '10': 'type'},
    {'1': 'description', '3': 10, '4': 1, '5': 9, '9': 2, '10': 'description', '17': true},
    {'1': 'members', '3': 7, '4': 3, '5': 11, '6': '.google.ads.googleads.v16.resources.CustomInterestMember', '10': 'members'},
  ],
  '7': {},
  '8': [
    {'1': '_id'},
...
final $typed_data.Uint8List customInterestDescriptor = $convert.base64Decode(
    ...
    'MudjE2LmVudW1zLkN1c3RvbUludGVyZXN0U3RhdHVzRW51bS5DdXN0b21JbnRlcmVzdFN0YXR1'
    'c1IGc3RhdHVzEhcKBG5hbWUYCSABKAlIAVIEbmFtZYgBARJdCgR0eXBlGAUgASgOMkkuZ29vZ2'
    'xlLmFkcy5nb29nbGVhZHMudjE2LmVudW1zLkN1c3RvbUludGVyZXN0VHlwZUVudW0uQ3VzdG9t'
    'SW50ZXJlc3RUeXBlUgR0eXBlEiUKC2Rlc2NyaXB0aW9uGAogASgJSAJSC2Rlc2NyaXB0aW9uiA'
    'EBElIKB21lbWJlcnMYByADKAsyOC5nb29nbGUuYWRzLmdvb2dsZWFkcy52MTYucmVzb3VyY2Vz'
...
const CustomInterestMember$json = {
  ...
  '2': [
    {'1': 'member_type', '3': 1, '4': 1, '5': 14, '6': '.google.ads.googleads.v16.enums.CustomInterestMemberTypeEnum.CustomInterestMemberType', '10': 'memberType'},
...
final $typed_data.Uint8List customInterestMemberDescriptor = $convert.base64Decode(
    ...
    'MuZ29vZ2xlYWRzLnYxNi5lbnVtcy5DdXN0b21JbnRlcmVzdE1lbWJlclR5cGVFbnVtLkN1c3Rv'
