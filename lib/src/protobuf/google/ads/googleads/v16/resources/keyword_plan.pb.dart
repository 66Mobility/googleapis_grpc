...
import '../enums/keyword_plan_forecast_interval.pbenum.dart' as $3016;
...
class KeywordPlanForecastPeriod extends $pb.GeneratedMessage {
  factory KeywordPlanForecastPeriod({
    $3016.KeywordPlanForecastIntervalEnum_KeywordPlanForecastInterval? dateInterval,
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(_omitMessageNames ? '' : 'KeywordPlanForecastPeriod', package: const $pb.PackageName(_omitMessageNames ? '' : 'google.ads.googleads.v16.resources'), createEmptyInstance: create)
    ..oo(0, [1, 2])
    ..e<$3016.KeywordPlanForecastIntervalEnum_KeywordPlanForecastInterval>(1, _omitFieldNames ? '' : 'dateInterval', $pb.PbFieldType.OE, defaultOrMaker: $3016.KeywordPlanForecastIntervalEnum_KeywordPlanForecastInterval.UNSPECIFIED, valueOf: $3016.KeywordPlanForecastIntervalEnum_KeywordPlanForecastInterval.valueOf, enumValues: $3016.KeywordPlanForecastIntervalEnum_KeywordPlanForecastInterval.values)
    ..aOM<$2598.DateRange>(2, _omitFieldNames ? '' : 'dateRange', subBuilder: $2598.DateRange.create)
    ..hasRequiredFields = false
  ;
  ...
  @$pb.TagNumber(1)
  $3016.KeywordPlanForecastIntervalEnum_KeywordPlanForecastInterval get dateInterval => $_getN(0);
  @$pb.TagNumber(1)
  set dateInterval($3016.KeywordPlanForecastIntervalEnum_KeywordPlanForecastInterval v) { setField(1, v); }
  @$pb.TagNumber(1)
  ...
  @$pb.TagNumber(2)
  set dateRange($2598.DateRange v) { setField(2, v); }
  @$pb.TagNumber(2)
