...
class CampaignConversionGoal extends $pb.GeneratedMessage {
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(_omitMessageNames ? '' : 'CampaignConversionGoal', package: const $pb.PackageName(_omitMessageNames ? '' : 'google.ads.googleads.v16.resources'), createEmptyInstance: create)
    ...
    ..e<$2619.ConversionActionCategoryEnum_ConversionActionCategory>(3, _omitFieldNames ? '' : 'category', $pb.PbFieldType.OE, defaultOrMaker: $2619.ConversionActionCategoryEnum_ConversionActionCategory.UNSPECIFIED, valueOf: $2619.ConversionActionCategoryEnum_ConversionActionCategory.valueOf, enumValues: $2619.ConversionActionCategoryEnum_ConversionActionCategory.values)
    ..e<$2903.ConversionOriginEnum_ConversionOrigin>(4, _omitFieldNames ? '' : 'origin', $pb.PbFieldType.OE, defaultOrMaker: $2903.ConversionOriginEnum_ConversionOrigin.UNSPECIFIED, valueOf: $2903.ConversionOriginEnum_ConversionOrigin.valueOf, enumValues: $2903.ConversionOriginEnum_ConversionOrigin.values)
  ...
  @$pb.TagNumber(3)
  $2619.ConversionActionCategoryEnum_ConversionActionCategory get category => $_getN(2);
  @$pb.TagNumber(3)
  set category($2619.ConversionActionCategoryEnum_ConversionActionCategory v) { setField(3, v); }
  @$pb.TagNumber(3)
  ...
  @$pb.TagNumber(4)
  $2903.ConversionOriginEnum_ConversionOrigin get origin => $_getN(3);
  @$pb.TagNumber(4)
  set origin($2903.ConversionOriginEnum_ConversionOrigin v) { setField(4, v); }
  @$pb.TagNumber(4)
