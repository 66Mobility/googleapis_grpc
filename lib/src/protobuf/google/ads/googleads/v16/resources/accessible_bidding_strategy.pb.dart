...
class AccessibleBiddingStrategy_MaximizeConversionValue extends $pb.GeneratedMessage {
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(_omitMessageNames ? '' : 'AccessibleBiddingStrategy.MaximizeConversionValue', package: const $pb.PackageName(_omitMessageNames ? '' : 'google.ads.googleads.v16.resources'), createEmptyInstance: create)
...
class AccessibleBiddingStrategy_MaximizeConversions extends $pb.GeneratedMessage {
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(_omitMessageNames ? '' : 'AccessibleBiddingStrategy.MaximizeConversions', package: const $pb.PackageName(_omitMessageNames ? '' : 'google.ads.googleads.v16.resources'), createEmptyInstance: create)
...
class AccessibleBiddingStrategy_TargetCpa extends $pb.GeneratedMessage {
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(_omitMessageNames ? '' : 'AccessibleBiddingStrategy.TargetCpa', package: const $pb.PackageName(_omitMessageNames ? '' : 'google.ads.googleads.v16.resources'), createEmptyInstance: create)
...
class AccessibleBiddingStrategy_TargetImpressionShare extends $pb.GeneratedMessage {
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(_omitMessageNames ? '' : 'AccessibleBiddingStrategy.TargetImpressionShare', package: const $pb.PackageName(_omitMessageNames ? '' : 'google.ads.googleads.v16.resources'), createEmptyInstance: create)
...
class AccessibleBiddingStrategy_TargetRoas extends $pb.GeneratedMessage {
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(_omitMessageNames ? '' : 'AccessibleBiddingStrategy.TargetRoas', package: const $pb.PackageName(_omitMessageNames ? '' : 'google.ads.googleads.v16.resources'), createEmptyInstance: create)
    ..a<$core.double>(1, _omitFieldNames ? '' : 'targetRoas', $pb.PbFieldType.OD)
    ..hasRequiredFields = false
  ;
...
class AccessibleBiddingStrategy_TargetSpend extends $pb.GeneratedMessage {
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(_omitMessageNames ? '' : 'AccessibleBiddingStrategy.TargetSpend', package: const $pb.PackageName(_omitMessageNames ? '' : 'google.ads.googleads.v16.resources'), createEmptyInstance: create)
...
class AccessibleBiddingStrategy extends $pb.GeneratedMessage {
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(_omitMessageNames ? '' : 'AccessibleBiddingStrategy', package: const $pb.PackageName(_omitMessageNames ? '' : 'google.ads.googleads.v16.resources'), createEmptyInstance: create)
    ..oo(0, [7, 8, 9, 10, 11, 12])
    ..aOS(1, _omitFieldNames ? '' : 'resourceName')
    ..aInt64(2, _omitFieldNames ? '' : 'id')
    ..aOS(3, _omitFieldNames ? '' : 'name')
    ..e<$2801.BiddingStrategyTypeEnum_BiddingStrategyType>(4, _omitFieldNames ? '' : 'type', $pb.PbFieldType.OE, defaultOrMaker: $2801.BiddingStrategyTypeEnum_BiddingStrategyType.UNSPECIFIED, valueOf: $2801.BiddingStrategyTypeEnum_BiddingStrategyType.valueOf, enumValues: $2801.BiddingStrategyTypeEnum_BiddingStrategyType.values)
  ...
  @$pb.TagNumber(4)
  $2801.BiddingStrategyTypeEnum_BiddingStrategyType get type => $_getN(3);
  @$pb.TagNumber(4)
  set type($2801.BiddingStrategyTypeEnum_BiddingStrategyType v) { setField(4, v); }
  @$pb.TagNumber(4)
