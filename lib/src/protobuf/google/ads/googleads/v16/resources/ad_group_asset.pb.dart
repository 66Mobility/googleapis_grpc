...
class AdGroupAsset extends $pb.GeneratedMessage {
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(_omitMessageNames ? '' : 'AdGroupAsset', package: const $pb.PackageName(_omitMessageNames ? '' : 'google.ads.googleads.v16.resources'), createEmptyInstance: create)
    ...
    ..e<$2827.AssetSourceEnum_AssetSource>(6, _omitFieldNames ? '' : 'source', $pb.PbFieldType.OE, defaultOrMaker: $2827.AssetSourceEnum_AssetSource.UNSPECIFIED, valueOf: $2827.AssetSourceEnum_AssetSource.valueOf, enumValues: $2827.AssetSourceEnum_AssetSource.values)
    ..e<$2529.AssetLinkPrimaryStatusEnum_AssetLinkPrimaryStatus>(7, _omitFieldNames ? '' : 'primaryStatus', $pb.PbFieldType.OE, defaultOrMaker: $2529.AssetLinkPrimaryStatusEnum_AssetLinkPrimaryStatus.UNSPECIFIED, valueOf: $2529.AssetLinkPrimaryStatusEnum_AssetLinkPrimaryStatus.valueOf, enumValues: $2529.AssetLinkPrimaryStatusEnum_AssetLinkPrimaryStatus.values)
    ..pc<$2531.AssetLinkPrimaryStatusDetails>(8, _omitFieldNames ? '' : 'primaryStatusDetails', $pb.PbFieldType.PM, subBuilder: $2531.AssetLinkPrimaryStatusDetails.create)
  ...
  @$pb.TagNumber(6)
  set source($2827.AssetSourceEnum_AssetSource v) { setField(6, v); }
  @$pb.TagNumber(6)
  ...
  @$pb.TagNumber(7)
  set primaryStatus($2529.AssetLinkPrimaryStatusEnum_AssetLinkPrimaryStatus v) { setField(7, v); }
  @$pb.TagNumber(7)
