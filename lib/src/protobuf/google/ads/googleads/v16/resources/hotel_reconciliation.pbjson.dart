...
const HotelReconciliation$json = {
  ...
  '2': [
    ...
    {'1': 'status', '3': 10, '4': 1, '5': 14, '6': '.google.ads.googleads.v16.enums.HotelReconciliationStatusEnum.HotelReconciliationStatus', '8': {}, '10': 'status'},
  ],
  '7': {},
};
...
final $typed_data.Uint8List hotelReconciliationDescriptor = $convert.base64Decode(
    ...
    'MTYuZW51bXMuSG90ZWxSZWNvbmNpbGlhdGlvblN0YXR1c0VudW0uSG90ZWxSZWNvbmNpbGlhdG'
