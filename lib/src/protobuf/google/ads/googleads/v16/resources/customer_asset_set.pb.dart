...
import '../enums/asset_set_link_status.pbenum.dart' as $2830;
...
class CustomerAssetSet extends $pb.GeneratedMessage {
  factory CustomerAssetSet({
    ...
    $2830.AssetSetLinkStatusEnum_AssetSetLinkStatus? status,
  }) {
    final $result = create();
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(_omitMessageNames ? '' : 'CustomerAssetSet', package: const $pb.PackageName(_omitMessageNames ? '' : 'google.ads.googleads.v16.resources'), createEmptyInstance: create)
    ..aOS(1, _omitFieldNames ? '' : 'resourceName')
    ..aOS(2, _omitFieldNames ? '' : 'assetSet')
    ..aOS(3, _omitFieldNames ? '' : 'customer')
    ..e<$2830.AssetSetLinkStatusEnum_AssetSetLinkStatus>(4, _omitFieldNames ? '' : 'status', $pb.PbFieldType.OE, defaultOrMaker: $2830.AssetSetLinkStatusEnum_AssetSetLinkStatus.UNSPECIFIED, valueOf: $2830.AssetSetLinkStatusEnum_AssetSetLinkStatus.valueOf, enumValues: $2830.AssetSetLinkStatusEnum_AssetSetLinkStatus.values)
  ...
  @$pb.TagNumber(4)
  $2830.AssetSetLinkStatusEnum_AssetSetLinkStatus get status => $_getN(3);
  @$pb.TagNumber(4)
  set status($2830.AssetSetLinkStatusEnum_AssetSetLinkStatus v) { setField(4, v); }
  @$pb.TagNumber(4)
