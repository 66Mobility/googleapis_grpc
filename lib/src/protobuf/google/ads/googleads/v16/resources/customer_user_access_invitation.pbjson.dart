...
const CustomerUserAccessInvitation$json = {
  ...
  '2': [
    ...
    {'1': 'access_role', '3': 3, '4': 1, '5': 14, '6': '.google.ads.googleads.v16.enums.AccessRoleEnum.AccessRole', '8': {}, '10': 'accessRole'},
    {'1': 'email_address', '3': 4, '4': 1, '5': 9, '8': {}, '10': 'emailAddress'},
    {'1': 'creation_date_time', '3': 5, '4': 1, '5': 9, '8': {}, '10': 'creationDateTime'},
    {'1': 'invitation_status', '3': 6, '4': 1, '5': 14, '6': '.google.ads.googleads.v16.enums.AccessInvitationStatusEnum.AccessInvitationStatus', '8': {}, '10': 'invitationStatus'},
  ],
  '7': {},
};
...
final $typed_data.Uint8List customerUserAccessInvitationDescriptor = $convert.base64Decode(
    ...
    'Rpb25JZBJfCgthY2Nlc3Nfcm9sZRgDIAEoDjI5Lmdvb2dsZS5hZHMuZ29vZ2xlYWRzLnYxNi5l'
    ...
    'gOMlEuZ29vZ2xlLmFkcy5nb29nbGVhZHMudjE2LmVudW1zLkFjY2Vzc0ludml0YXRpb25TdGF0'
