...
import '../enums/attribution_model.pbenum.dart' as $2948;
import '../enums/conversion_action_category.pbenum.dart' as $2619;
import '../enums/conversion_action_counting_type.pbenum.dart' as $2947;
import '../enums/conversion_action_status.pbenum.dart' as $2945;
import '../enums/conversion_action_type.pbenum.dart' as $2946;
import '../enums/conversion_origin.pbenum.dart' as $2903;
import '../enums/data_driven_model_status.pbenum.dart' as $2949;
...
class ConversionAction_AttributionModelSettings extends $pb.GeneratedMessage {
  factory ConversionAction_AttributionModelSettings({
    $2948.AttributionModelEnum_AttributionModel? attributionModel,
    $2949.DataDrivenModelStatusEnum_DataDrivenModelStatus? dataDrivenModelStatus,
  }) {
    final $result = create();
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(_omitMessageNames ? '' : 'ConversionAction.AttributionModelSettings', package: const $pb.PackageName(_omitMessageNames ? '' : 'google.ads.googleads.v16.resources'), createEmptyInstance: create)
    ..e<$2948.AttributionModelEnum_AttributionModel>(1, _omitFieldNames ? '' : 'attributionModel', $pb.PbFieldType.OE, defaultOrMaker: $2948.AttributionModelEnum_AttributionModel.UNSPECIFIED, valueOf: $2948.AttributionModelEnum_AttributionModel.valueOf, enumValues: $2948.AttributionModelEnum_AttributionModel.values)
    ..e<$2949.DataDrivenModelStatusEnum_DataDrivenModelStatus>(2, _omitFieldNames ? '' : 'dataDrivenModelStatus', $pb.PbFieldType.OE, defaultOrMaker: $2949.DataDrivenModelStatusEnum_DataDrivenModelStatus.UNSPECIFIED, valueOf: $2949.DataDrivenModelStatusEnum_DataDrivenModelStatus.valueOf, enumValues: $2949.DataDrivenModelStatusEnum_DataDrivenModelStatus.values)
  ...
  @$pb.TagNumber(1)
  $2948.AttributionModelEnum_AttributionModel get attributionModel => $_getN(0);
  @$pb.TagNumber(1)
  set attributionModel($2948.AttributionModelEnum_AttributionModel v) { setField(1, v); }
  @$pb.TagNumber(1)
  ...
  /// conversion action.
  @$pb.TagNumber(2)
  $2949.DataDrivenModelStatusEnum_DataDrivenModelStatus get dataDrivenModelStatus => $_getN(1);
  @$pb.TagNumber(2)
  set dataDrivenModelStatus($2949.DataDrivenModelStatusEnum_DataDrivenModelStatus v) { setField(2, v); }
  @$pb.TagNumber(2)
...
class ConversionAction extends $pb.GeneratedMessage {
  factory ConversionAction({
    ...
    $2945.ConversionActionStatusEnum_ConversionActionStatus? status,
    $2946.ConversionActionTypeEnum_ConversionActionType? type,
    $2619.ConversionActionCategoryEnum_ConversionActionCategory? category,
    ConversionAction_ValueSettings? valueSettings,
    $2947.ConversionActionCountingTypeEnum_ConversionActionCountingType? countingType,
    ConversionAction_AttributionModelSettings? attributionModelSettings,
    $core.Iterable<$2944.TagSnippet>? tagSnippets,
    $2578.MobileAppVendorEnum_MobileAppVendor? mobileAppVendor,
    ...
    $core.String? appId,
    $2903.ConversionOriginEnum_ConversionOrigin? origin,
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(_omitMessageNames ? '' : 'ConversionAction', package: const $pb.PackageName(_omitMessageNames ? '' : 'google.ads.googleads.v16.resources'), createEmptyInstance: create)
    ...
    ..e<$2945.ConversionActionStatusEnum_ConversionActionStatus>(4, _omitFieldNames ? '' : 'status', $pb.PbFieldType.OE, defaultOrMaker: $2945.ConversionActionStatusEnum_ConversionActionStatus.UNSPECIFIED, valueOf: $2945.ConversionActionStatusEnum_ConversionActionStatus.valueOf, enumValues: $2945.ConversionActionStatusEnum_ConversionActionStatus.values)
    ..e<$2946.ConversionActionTypeEnum_ConversionActionType>(5, _omitFieldNames ? '' : 'type', $pb.PbFieldType.OE, defaultOrMaker: $2946.ConversionActionTypeEnum_ConversionActionType.UNSPECIFIED, valueOf: $2946.ConversionActionTypeEnum_ConversionActionType.valueOf, enumValues: $2946.ConversionActionTypeEnum_ConversionActionType.values)
    ..e<$2619.ConversionActionCategoryEnum_ConversionActionCategory>(6, _omitFieldNames ? '' : 'category', $pb.PbFieldType.OE, defaultOrMaker: $2619.ConversionActionCategoryEnum_ConversionActionCategory.UNSPECIFIED, valueOf: $2619.ConversionActionCategoryEnum_ConversionActionCategory.valueOf, enumValues: $2619.ConversionActionCategoryEnum_ConversionActionCategory.values)
    ..aOM<ConversionAction_ValueSettings>(11, _omitFieldNames ? '' : 'valueSettings', subBuilder: ConversionAction_ValueSettings.create)
    ..e<$2947.ConversionActionCountingTypeEnum_ConversionActionCountingType>(12, _omitFieldNames ? '' : 'countingType', $pb.PbFieldType.OE, defaultOrMaker: $2947.ConversionActionCountingTypeEnum_ConversionActionCountingType.UNSPECIFIED, valueOf: $2947.ConversionActionCountingTypeEnum_ConversionActionCountingType.valueOf, enumValues: $2947.ConversionActionCountingTypeEnum_ConversionActionCountingType.values)
    ...
    ..pc<$2944.TagSnippet>(14, _omitFieldNames ? '' : 'tagSnippets', $pb.PbFieldType.PM, subBuilder: $2944.TagSnippet.create)
    ..e<$2578.MobileAppVendorEnum_MobileAppVendor>(17, _omitFieldNames ? '' : 'mobileAppVendor', $pb.PbFieldType.OE, defaultOrMaker: $2578.MobileAppVendorEnum_MobileAppVendor.UNSPECIFIED, valueOf: $2578.MobileAppVendorEnum_MobileAppVendor.valueOf, enumValues: $2578.MobileAppVendorEnum_MobileAppVendor.values)
    ...
    ..e<$2903.ConversionOriginEnum_ConversionOrigin>(30, _omitFieldNames ? '' : 'origin', $pb.PbFieldType.OE, defaultOrMaker: $2903.ConversionOriginEnum_ConversionOrigin.UNSPECIFIED, valueOf: $2903.ConversionOriginEnum_ConversionOrigin.valueOf, enumValues: $2903.ConversionOriginEnum_ConversionOrigin.values)
  ...
  @$pb.TagNumber(4)
  $2945.ConversionActionStatusEnum_ConversionActionStatus get status => $_getN(1);
  @$pb.TagNumber(4)
  set status($2945.ConversionActionStatusEnum_ConversionActionStatus v) { setField(4, v); }
  @$pb.TagNumber(4)
  ...
  @$pb.TagNumber(5)
  $2946.ConversionActionTypeEnum_ConversionActionType get type => $_getN(2);
  @$pb.TagNumber(5)
  set type($2946.ConversionActionTypeEnum_ConversionActionType v) { setField(5, v); }
  @$pb.TagNumber(5)
  ...
  @$pb.TagNumber(6)
  $2619.ConversionActionCategoryEnum_ConversionActionCategory get category => $_getN(3);
  @$pb.TagNumber(6)
  set category($2619.ConversionActionCategoryEnum_ConversionActionCategory v) { setField(6, v); }
  @$pb.TagNumber(6)
  ...
  @$pb.TagNumber(12)
  $2947.ConversionActionCountingTypeEnum_ConversionActionCountingType get countingType => $_getN(5);
  @$pb.TagNumber(12)
  set countingType($2947.ConversionActionCountingTypeEnum_ConversionActionCountingType v) { setField(12, v); }
  @$pb.TagNumber(12)
  ...
  @$pb.TagNumber(14)
  $core.List<$2944.TagSnippet> get tagSnippets => $_getList(7);

  /// Output only. Mobile app vendor for an app conversion action.
  @$pb.TagNumber(17)
  $2578.MobileAppVendorEnum_MobileAppVendor get mobileAppVendor => $_getN(8);
  @$pb.TagNumber(17)
  set mobileAppVendor($2578.MobileAppVendorEnum_MobileAppVendor v) { setField(17, v); }
  @$pb.TagNumber(17)
  ...
  @$pb.TagNumber(30)
  $2903.ConversionOriginEnum_ConversionOrigin get origin => $_getN(19);
  @$pb.TagNumber(30)
  set origin($2903.ConversionOriginEnum_ConversionOrigin v) { setField(30, v); }
  @$pb.TagNumber(30)
