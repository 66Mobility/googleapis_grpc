...
import '../enums/campaign_draft_status.pbenum.dart' as $2905;

/// A campaign draft.
class CampaignDraft extends $pb.GeneratedMessage {
  factory CampaignDraft({
    $core.String? resourceName,
    $2905.CampaignDraftStatusEnum_CampaignDraftStatus? status,
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(_omitMessageNames ? '' : 'CampaignDraft', package: const $pb.PackageName(_omitMessageNames ? '' : 'google.ads.googleads.v16.resources'), createEmptyInstance: create)
    ...
    ..e<$2905.CampaignDraftStatusEnum_CampaignDraftStatus>(6, _omitFieldNames ? '' : 'status', $pb.PbFieldType.OE, defaultOrMaker: $2905.CampaignDraftStatusEnum_CampaignDraftStatus.UNSPECIFIED, valueOf: $2905.CampaignDraftStatusEnum_CampaignDraftStatus.valueOf, enumValues: $2905.CampaignDraftStatusEnum_CampaignDraftStatus.values)
  ...
  @$pb.TagNumber(6)
  $2905.CampaignDraftStatusEnum_CampaignDraftStatus get status => $_getN(1);
  @$pb.TagNumber(6)
  set status($2905.CampaignDraftStatusEnum_CampaignDraftStatus v) { setField(6, v); }
  @$pb.TagNumber(6)
