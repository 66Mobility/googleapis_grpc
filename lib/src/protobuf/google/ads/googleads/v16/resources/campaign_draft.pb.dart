...
import '../enums/campaign_draft_status.pbenum.dart' as $2904;

/// A campaign draft.
class CampaignDraft extends $pb.GeneratedMessage {
  factory CampaignDraft({
    $core.String? resourceName,
    $2904.CampaignDraftStatusEnum_CampaignDraftStatus? status,
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(_omitMessageNames ? '' : 'CampaignDraft', package: const $pb.PackageName(_omitMessageNames ? '' : 'google.ads.googleads.v16.resources'), createEmptyInstance: create)
    ..aOS(1, _omitFieldNames ? '' : 'resourceName')
    ..e<$2904.CampaignDraftStatusEnum_CampaignDraftStatus>(6, _omitFieldNames ? '' : 'status', $pb.PbFieldType.OE, defaultOrMaker: $2904.CampaignDraftStatusEnum_CampaignDraftStatus.UNSPECIFIED, valueOf: $2904.CampaignDraftStatusEnum_CampaignDraftStatus.valueOf, enumValues: $2904.CampaignDraftStatusEnum_CampaignDraftStatus.values)
  ...
  @$pb.TagNumber(6)
  $2904.CampaignDraftStatusEnum_CampaignDraftStatus get status => $_getN(1);
  @$pb.TagNumber(6)
  set status($2904.CampaignDraftStatusEnum_CampaignDraftStatus v) { setField(6, v); }
  @$pb.TagNumber(6)
