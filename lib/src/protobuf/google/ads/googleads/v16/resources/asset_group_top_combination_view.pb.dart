...
class AssetGroupTopCombinationView extends $pb.GeneratedMessage {
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(_omitMessageNames ? '' : 'AssetGroupTopCombinationView', package: const $pb.PackageName(_omitMessageNames ? '' : 'google.ads.googleads.v16.resources'), createEmptyInstance: create)
...
class AssetGroupAssetCombinationData extends $pb.GeneratedMessage {
  factory AssetGroupAssetCombinationData({
    $core.Iterable<$2827.AssetUsage>? assetCombinationServedAssets,
  }) {
    final $result = create();
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(_omitMessageNames ? '' : 'AssetGroupAssetCombinationData', package: const $pb.PackageName(_omitMessageNames ? '' : 'google.ads.googleads.v16.resources'), createEmptyInstance: create)
    ..pc<$2827.AssetUsage>(1, _omitFieldNames ? '' : 'assetCombinationServedAssets', $pb.PbFieldType.PM, subBuilder: $2827.AssetUsage.create)
    ..hasRequiredFields = false
  ;
  ...
  @$pb.TagNumber(1)
  $core.List<$2827.AssetUsage> get assetCombinationServedAssets => $_getList(0);
}
