...
class CampaignExtensionSetting extends $pb.GeneratedMessage {
  ...
  @$pb.TagNumber(5)
  set device($2842.ExtensionSettingDeviceEnum_ExtensionSettingDevice v) { setField(5, v); }
  @$pb.TagNumber(5)
