...
class KeywordPlanCampaign extends $pb.GeneratedMessage {
  ...
  ///  campaigns.
  @$pb.TagNumber(6)
  $3018.KeywordPlanNetworkEnum_KeywordPlanNetwork get keywordPlanNetwork => $_getN(1);
  @$pb.TagNumber(6)
  set keywordPlanNetwork($3018.KeywordPlanNetworkEnum_KeywordPlanNetwork v) { setField(6, v); }
  @$pb.TagNumber(6)
