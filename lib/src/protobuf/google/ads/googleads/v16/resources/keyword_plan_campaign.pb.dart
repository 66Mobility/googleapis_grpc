...
class KeywordPlanCampaign extends $pb.GeneratedMessage {
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(_omitMessageNames ? '' : 'KeywordPlanCampaign', package: const $pb.PackageName(_omitMessageNames ? '' : 'google.ads.googleads.v16.resources'), createEmptyInstance: create)
    ..aOS(1, _omitFieldNames ? '' : 'resourceName')
    ..e<$3017.KeywordPlanNetworkEnum_KeywordPlanNetwork>(6, _omitFieldNames ? '' : 'keywordPlanNetwork', $pb.PbFieldType.OE, defaultOrMaker: $3017.KeywordPlanNetworkEnum_KeywordPlanNetwork.UNSPECIFIED, valueOf: $3017.KeywordPlanNetworkEnum_KeywordPlanNetwork.valueOf, enumValues: $3017.KeywordPlanNetworkEnum_KeywordPlanNetwork.values)
  ...
  ///  campaigns.
  @$pb.TagNumber(6)
  $3017.KeywordPlanNetworkEnum_KeywordPlanNetwork get keywordPlanNetwork => $_getN(1);
  @$pb.TagNumber(6)
  set keywordPlanNetwork($3017.KeywordPlanNetworkEnum_KeywordPlanNetwork v) { setField(6, v); }
  @$pb.TagNumber(6)
...
class KeywordPlanGeoTarget extends $pb.GeneratedMessage {
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(_omitMessageNames ? '' : 'KeywordPlanGeoTarget', package: const $pb.PackageName(_omitMessageNames ? '' : 'google.ads.googleads.v16.resources'), createEmptyInstance: create)
