...
class ProductLink extends $pb.GeneratedMessage {
  factory ProductLink({
    ...
    AdvertisingPartnerIdentifier? advertisingPartner,
  }) {
    final $result = create();
  ...
  static const $core.Map<$core.int, ProductLink_LinkedProduct> _ProductLink_LinkedProductByTag = {
    ...
    13 : ProductLink_LinkedProduct.advertisingPartner,
    0 : ProductLink_LinkedProduct.notSet
  };
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(_omitMessageNames ? '' : 'ProductLink', package: const $pb.PackageName(_omitMessageNames ? '' : 'google.ads.googleads.v16.resources'), createEmptyInstance: create)
    ..oo(0, [4, 5, 12, 13])
    ..aOS(1, _omitFieldNames ? '' : 'resourceName')
    ..aInt64(2, _omitFieldNames ? '' : 'productLinkId')
    ..e<$3046.LinkedProductTypeEnum_LinkedProductType>(3, _omitFieldNames ? '' : 'type', $pb.PbFieldType.OE, defaultOrMaker: $3046.LinkedProductTypeEnum_LinkedProductType.UNSPECIFIED, valueOf: $3046.LinkedProductTypeEnum_LinkedProductType.valueOf, enumValues: $3046.LinkedProductTypeEnum_LinkedProductType.values)
    ...
    ..aOM<AdvertisingPartnerIdentifier>(13, _omitFieldNames ? '' : 'advertisingPartner', subBuilder: AdvertisingPartnerIdentifier.create)
  ...
  @$pb.TagNumber(3)
  $3046.LinkedProductTypeEnum_LinkedProductType get type => $_getN(2);
  @$pb.TagNumber(3)
  set type($3046.LinkedProductTypeEnum_LinkedProductType v) { setField(3, v); }
  @$pb.TagNumber(3)
  ...
  @$pb.TagNumber(13)
  AdvertisingPartnerIdentifier get advertisingPartner => $_getN(6);
  @$pb.TagNumber(13)
  set advertisingPartner(AdvertisingPartnerIdentifier v) { setField(13, v); }
  @$pb.TagNumber(13)
  $core.bool hasAdvertisingPartner() => $_has(6);
  @$pb.TagNumber(13)
  void clearAdvertisingPartner() => clearField(13);
  @$pb.TagNumber(13)
  AdvertisingPartnerIdentifier ensureAdvertisingPartner() => $_ensure(6);
}
...
class DataPartnerIdentifier extends $pb.GeneratedMessage {
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(_omitMessageNames ? '' : 'DataPartnerIdentifier', package: const $pb.PackageName(_omitMessageNames ? '' : 'google.ads.googleads.v16.resources'), createEmptyInstance: create)
...
class GoogleAdsIdentifier extends $pb.GeneratedMessage {
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(_omitMessageNames ? '' : 'GoogleAdsIdentifier', package: const $pb.PackageName(_omitMessageNames ? '' : 'google.ads.googleads.v16.resources'), createEmptyInstance: create)
...
class MerchantCenterIdentifier extends $pb.GeneratedMessage {
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(_omitMessageNames ? '' : 'MerchantCenterIdentifier', package: const $pb.PackageName(_omitMessageNames ? '' : 'google.ads.googleads.v16.resources'), createEmptyInstance: create)
...
class AdvertisingPartnerIdentifier extends $pb.GeneratedMessage {
  factory AdvertisingPartnerIdentifier({
    $core.String? customer,
  }) {
    final $result = create();
    if (customer != null) {
  ...
  AdvertisingPartnerIdentifier._() : super();
  factory AdvertisingPartnerIdentifier.fromBuffer($core.List<$core.int> i, [$pb.ExtensionRegistry r = $pb.ExtensionRegistry.EMPTY]) => create()..mergeFromBuffer(i, r);
  factory AdvertisingPartnerIdentifier.fromJson($core.String i, [$pb.ExtensionRegistry r = $pb.ExtensionRegistry.EMPTY]) => create()..mergeFromJson(i, r);

  static final $pb.BuilderInfo _i = $pb.BuilderInfo(_omitMessageNames ? '' : 'AdvertisingPartnerIdentifier', package: const $pb.PackageName(_omitMessageNames ? '' : 'google.ads.googleads.v16.resources'), createEmptyInstance: create)
    ..aOS(1, _omitFieldNames ? '' : 'customer')
    ..hasRequiredFields = false
  ;
  ...
  'Use [GeneratedMessageGenericExtensions.deepCopy] instead. '
  'Will be removed in next major version')
  AdvertisingPartnerIdentifier clone() => AdvertisingPartnerIdentifier()..mergeFromMessage(this);
  @$core.Deprecated(
  'Using this can add significant overhead to your binary. '
  'Use [GeneratedMessageGenericExtensions.rebuild] instead. '
  'Will be removed in next major version')
  AdvertisingPartnerIdentifier copyWith(void Function(AdvertisingPartnerIdentifier) updates) => super.copyWith((message) => updates(message as AdvertisingPartnerIdentifier)) as AdvertisingPartnerIdentifier;

  $pb.BuilderInfo get info_ => _i;

  @$core.pragma('dart2js:noInline')
  static AdvertisingPartnerIdentifier create() => AdvertisingPartnerIdentifier._();
  AdvertisingPartnerIdentifier createEmptyInstance() => create();
  static $pb.PbList<AdvertisingPartnerIdentifier> createRepeated() => $pb.PbList<AdvertisingPartnerIdentifier>();
  @$core.pragma('dart2js:noInline')
  static AdvertisingPartnerIdentifier getDefault() => _defaultInstance ??= $pb.GeneratedMessage.$_defaultFor<AdvertisingPartnerIdentifier>(create);
  static AdvertisingPartnerIdentifier? _defaultInstance;
