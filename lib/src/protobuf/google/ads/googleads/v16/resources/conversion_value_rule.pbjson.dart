...
const ConversionValueRule$json = {
  ...
  '2': [
    ...
    {'1': 'action', '3': 3, '4': 1, '5': 11, '6': '.google.ads.googleads.v16.resources.ConversionValueRule.ValueRuleAction', '10': 'action'},
    {'1': 'geo_location_condition', '3': 4, '4': 1, '5': 11, '6': '.google.ads.googleads.v16.resources.ConversionValueRule.ValueRuleGeoLocationCondition', '10': 'geoLocationCondition'},
    {'1': 'device_condition', '3': 5, '4': 1, '5': 11, '6': '.google.ads.googleads.v16.resources.ConversionValueRule.ValueRuleDeviceCondition', '10': 'deviceCondition'},
    {'1': 'audience_condition', '3': 6, '4': 1, '5': 11, '6': '.google.ads.googleads.v16.resources.ConversionValueRule.ValueRuleAudienceCondition', '10': 'audienceCondition'},
    {'1': 'owner_customer', '3': 7, '4': 1, '5': 9, '8': {}, '10': 'ownerCustomer'},
    {'1': 'status', '3': 8, '4': 1, '5': 14, '6': '.google.ads.googleads.v16.enums.ConversionValueRuleStatusEnum.ConversionValueRuleStatus', '10': 'status'},
  ],
...
const ConversionValueRule_ValueRuleAction$json = {
  '1': 'ValueRuleAction',
  '2': [
    {'1': 'operation', '3': 1, '4': 1, '5': 14, '6': '.google.ads.googleads.v16.enums.ValueRuleOperationEnum.ValueRuleOperation', '10': 'operation'},
...
const ConversionValueRule_ValueRuleGeoLocationCondition$json = {
  ...
  '2': [
    ...
    {'1': 'excluded_geo_match_type', '3': 2, '4': 1, '5': 14, '6': '.google.ads.googleads.v16.enums.ValueRuleGeoLocationMatchTypeEnum.ValueRuleGeoLocationMatchType', '10': 'excludedGeoMatchType'},
    {'1': 'geo_target_constants', '3': 3, '4': 3, '5': 9, '8': {}, '10': 'geoTargetConstants'},
    {'1': 'geo_match_type', '3': 4, '4': 1, '5': 14, '6': '.google.ads.googleads.v16.enums.ValueRuleGeoLocationMatchTypeEnum.ValueRuleGeoLocationMatchType', '10': 'geoMatchType'},
  ],
};
...
const ConversionValueRule_ValueRuleDeviceCondition$json = {
  ...
  '2': [
    {'1': 'device_types', '3': 1, '4': 3, '5': 14, '6': '.google.ads.googleads.v16.enums.ValueRuleDeviceTypeEnum.ValueRuleDeviceType', '10': 'deviceTypes'},
  ],
};
...
final $typed_data.Uint8List conversionValueRuleDescriptor = $convert.base64Decode(
    ...
    'dsZWFkcy52MTYucmVzb3VyY2VzLkNvbnZlcnNpb25WYWx1ZVJ1bGUuVmFsdWVSdWxlQWN0aW9u'
    'UgZhY3Rpb24SiwEKFmdlb19sb2NhdGlvbl9jb25kaXRpb24YBCABKAsyVS5nb29nbGUuYWRzLm'
    'dvb2dsZWFkcy52MTYucmVzb3VyY2VzLkNvbnZlcnNpb25WYWx1ZVJ1bGUuVmFsdWVSdWxlR2Vv'
    'TG9jYXRpb25Db25kaXRpb25SFGdlb0xvY2F0aW9uQ29uZGl0aW9uEnsKEGRldmljZV9jb25kaX'
    'Rpb24YBSABKAsyUC5nb29nbGUuYWRzLmdvb2dsZWFkcy52MTYucmVzb3VyY2VzLkNvbnZlcnNp'
    'b25WYWx1ZVJ1bGUuVmFsdWVSdWxlRGV2aWNlQ29uZGl0aW9uUg9kZXZpY2VDb25kaXRpb24SgQ'
    'EKEmF1ZGllbmNlX2NvbmRpdGlvbhgGIAEoCzJSLmdvb2dsZS5hZHMuZ29vZ2xlYWRzLnYxNi5y'
    ...
    'gIIAEoDjJXLmdvb2dsZS5hZHMuZ29vZ2xlYWRzLnYxNi5lbnVtcy5Db252ZXJzaW9uVmFsdWVS'
    ...
    'MTYuZW51bXMuVmFsdWVSdWxlT3BlcmF0aW9uRW51bS5WYWx1ZVJ1bGVPcGVyYXRpb25SCW9wZX'
    ...
    'Fkcy5nb29nbGVhZHMudjE2LmVudW1zLlZhbHVlUnVsZUdlb0xvY2F0aW9uTWF0Y2hUeXBlRW51'
    ...
    '90eXBlGAQgASgOMl8uZ29vZ2xlLmFkcy5nb29nbGVhZHMudjE2LmVudW1zLlZhbHVlUnVsZUdl'
    ...
    'GAEgAygOMksuZ29vZ2xlLmFkcy5nb29nbGVhZHMudjE2LmVudW1zLlZhbHVlUnVsZURldmljZV'
