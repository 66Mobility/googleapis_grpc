...
const Feed$json = {
  ...
  '2': [
    ...
    {'1': 'attributes', '3': 4, '4': 3, '5': 11, '6': '.google.ads.googleads.v16.resources.FeedAttribute', '10': 'attributes'},
    {'1': 'attribute_operations', '3': 9, '4': 3, '5': 11, '6': '.google.ads.googleads.v16.resources.FeedAttributeOperation', '10': 'attributeOperations'},
    {'1': 'origin', '3': 5, '4': 1, '5': 14, '6': '.google.ads.googleads.v16.enums.FeedOriginEnum.FeedOrigin', '8': {}, '10': 'origin'},
    {'1': 'status', '3': 8, '4': 1, '5': 14, '6': '.google.ads.googleads.v16.enums.FeedStatusEnum.FeedStatus', '8': {}, '10': 'status'},
    {'1': 'places_location_feed_data', '3': 6, '4': 1, '5': 11, '6': '.google.ads.googleads.v16.resources.Feed.PlacesLocationFeedData', '9': 0, '10': 'placesLocationFeedData'},
    {'1': 'affiliate_location_feed_data', '3': 7, '4': 1, '5': 11, '6': '.google.ads.googleads.v16.resources.Feed.AffiliateLocationFeedData', '9': 0, '10': 'affiliateLocationFeedData'},
  ],
...
const Feed_PlacesLocationFeedData$json = {
  ...
  '2': [
    {'1': 'oauth_info', '3': 1, '4': 1, '5': 11, '6': '.google.ads.googleads.v16.resources.Feed.PlacesLocationFeedData.OAuthInfo', '8': {}, '10': 'oauthInfo'},
...
const Feed_AffiliateLocationFeedData$json = {
  ...
  '2': [
    ...
    {'1': 'relationship_type', '3': 2, '4': 1, '5': 14, '6': '.google.ads.googleads.v16.enums.AffiliateLocationFeedRelationshipTypeEnum.AffiliateLocationFeedRelationshipType', '10': 'relationshipType'},
  ],
};
...
final $typed_data.Uint8List feedDescriptor = $convert.base64Decode(
    ...
    'UuYWRzLmdvb2dsZWFkcy52MTYucmVzb3VyY2VzLkZlZWRBdHRyaWJ1dGVSCmF0dHJpYnV0ZXMS'
    'bQoUYXR0cmlidXRlX29wZXJhdGlvbnMYCSADKAsyOi5nb29nbGUuYWRzLmdvb2dsZWFkcy52MT'
    'YucmVzb3VyY2VzLkZlZWRBdHRyaWJ1dGVPcGVyYXRpb25SE2F0dHJpYnV0ZU9wZXJhdGlvbnMS'
    'VgoGb3JpZ2luGAUgASgOMjkuZ29vZ2xlLmFkcy5nb29nbGVhZHMudjE2LmVudW1zLkZlZWRPcm'
    'lnaW5FbnVtLkZlZWRPcmlnaW5CA+BBBVIGb3JpZ2luElYKBnN0YXR1cxgIIAEoDjI5Lmdvb2ds'
    'ZS5hZHMuZ29vZ2xlYWRzLnYxNi5lbnVtcy5GZWVkU3RhdHVzRW51bS5GZWVkU3RhdHVzQgPgQQ'
    'NSBnN0YXR1cxJ8ChlwbGFjZXNfbG9jYXRpb25fZmVlZF9kYXRhGAYgASgLMj8uZ29vZ2xlLmFk'
    'cy5nb29nbGVhZHMudjE2LnJlc291cmNlcy5GZWVkLlBsYWNlc0xvY2F0aW9uRmVlZERhdGFIAF'
    'IWcGxhY2VzTG9jYXRpb25GZWVkRGF0YRKFAQocYWZmaWxpYXRlX2xvY2F0aW9uX2ZlZWRfZGF0'
    'YRgHIAEoCzJCLmdvb2dsZS5hZHMuZ29vZ2xlYWRzLnYxNi5yZXNvdXJjZXMuRmVlZC5BZmZpbG'
    ...
    '9vZ2xlYWRzLnYxNi5yZXNvdXJjZXMuRmVlZC5QbGFjZXNMb2NhdGlvbkZlZWREYXRhLk9BdXRo'
    ...
    '9vZ2xlLmFkcy5nb29nbGVhZHMudjE2LmVudW1zLkFmZmlsaWF0ZUxvY2F0aW9uRmVlZFJlbGF0'
...
const FeedAttribute$json = {
  ...
  '2': [
    ...
    {'1': 'type', '3': 3, '4': 1, '5': 14, '6': '.google.ads.googleads.v16.enums.FeedAttributeTypeEnum.FeedAttributeType', '10': 'type'},
...
final $typed_data.Uint8List feedAttributeDescriptor = $convert.base64Decode(
    ...
    'FtZYgBARJbCgR0eXBlGAMgASgOMkcuZ29vZ2xlLmFkcy5nb29nbGVhZHMudjE2LmVudW1zLkZl'
...
const FeedAttributeOperation$json = {
  ...
  '2': [
    {'1': 'operator', '3': 1, '4': 1, '5': 14, '6': '.google.ads.googleads.v16.resources.FeedAttributeOperation.Operator', '8': {}, '10': 'operator'},
    {'1': 'value', '3': 2, '4': 1, '5': 11, '6': '.google.ads.googleads.v16.resources.FeedAttribute', '8': {}, '10': 'value'},
  ],
...
final $typed_data.Uint8List feedAttributeOperationDescriptor = $convert.base64Decode(
    ...
    '5nb29nbGVhZHMudjE2LnJlc291cmNlcy5GZWVkQXR0cmlidXRlT3BlcmF0aW9uLk9wZXJhdG9y'
    'QgPgQQNSCG9wZXJhdG9yEkwKBXZhbHVlGAIgASgLMjEuZ29vZ2xlLmFkcy5nb29nbGVhZHMudj'
    'E2LnJlc291cmNlcy5GZWVkQXR0cmlidXRlQgPgQQNSBXZhbHVlIjEKCE9wZXJhdG9yEg8KC1VO'
