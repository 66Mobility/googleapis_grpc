...
import '../enums/search_term_targeting_status.pbenum.dart' as $3052;
...
class SearchTermView extends $pb.GeneratedMessage {
  factory SearchTermView({
    ...
    $3052.SearchTermTargetingStatusEnum_SearchTermTargetingStatus? status,
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(_omitMessageNames ? '' : 'SearchTermView', package: const $pb.PackageName(_omitMessageNames ? '' : 'google.ads.googleads.v16.resources'), createEmptyInstance: create)
    ...
    ..e<$3052.SearchTermTargetingStatusEnum_SearchTermTargetingStatus>(4, _omitFieldNames ? '' : 'status', $pb.PbFieldType.OE, defaultOrMaker: $3052.SearchTermTargetingStatusEnum_SearchTermTargetingStatus.UNSPECIFIED, valueOf: $3052.SearchTermTargetingStatusEnum_SearchTermTargetingStatus.valueOf, enumValues: $3052.SearchTermTargetingStatusEnum_SearchTermTargetingStatus.values)
  ...
  @$pb.TagNumber(4)
  $3052.SearchTermTargetingStatusEnum_SearchTermTargetingStatus get status => $_getN(1);
  @$pb.TagNumber(4)
  set status($3052.SearchTermTargetingStatusEnum_SearchTermTargetingStatus v) { setField(4, v); }
  @$pb.TagNumber(4)
