...
import '../enums/search_term_targeting_status.pbenum.dart' as $3051;
...
class SearchTermView extends $pb.GeneratedMessage {
  factory SearchTermView({
    ...
    $3051.SearchTermTargetingStatusEnum_SearchTermTargetingStatus? status,
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(_omitMessageNames ? '' : 'SearchTermView', package: const $pb.PackageName(_omitMessageNames ? '' : 'google.ads.googleads.v16.resources'), createEmptyInstance: create)
    ..aOS(1, _omitFieldNames ? '' : 'resourceName')
    ..e<$3051.SearchTermTargetingStatusEnum_SearchTermTargetingStatus>(4, _omitFieldNames ? '' : 'status', $pb.PbFieldType.OE, defaultOrMaker: $3051.SearchTermTargetingStatusEnum_SearchTermTargetingStatus.UNSPECIFIED, valueOf: $3051.SearchTermTargetingStatusEnum_SearchTermTargetingStatus.valueOf, enumValues: $3051.SearchTermTargetingStatusEnum_SearchTermTargetingStatus.values)
  ...
  @$pb.TagNumber(4)
  $3051.SearchTermTargetingStatusEnum_SearchTermTargetingStatus get status => $_getN(1);
  @$pb.TagNumber(4)
  set status($3051.SearchTermTargetingStatusEnum_SearchTermTargetingStatus v) { setField(4, v); }
  @$pb.TagNumber(4)
