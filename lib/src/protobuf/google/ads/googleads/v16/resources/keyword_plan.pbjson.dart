...
const KeywordPlan$json = {
  ...
  '2': [
    ...
    {'1': 'forecast_period', '3': 4, '4': 1, '5': 11, '6': '.google.ads.googleads.v16.resources.KeywordPlanForecastPeriod', '10': 'forecastPeriod'},
  ],
  '7': {},
  '8': [
    {'1': '_id'},
...
final $typed_data.Uint8List keywordPlanDescriptor = $convert.base64Decode(
    ...
    'gEIAEoCzI9Lmdvb2dsZS5hZHMuZ29vZ2xlYWRzLnYxNi5yZXNvdXJjZXMuS2V5d29yZFBsYW5G'
...
const KeywordPlanForecastPeriod$json = {
  ...
  '2': [
    {'1': 'date_interval', '3': 1, '4': 1, '5': 14, '6': '.google.ads.googleads.v16.enums.KeywordPlanForecastIntervalEnum.KeywordPlanForecastInterval', '9': 0, '10': 'dateInterval'},
    {'1': 'date_range', '3': 2, '4': 1, '5': 11, '6': '.google.ads.googleads.v16.common.DateRange', '9': 0, '10': 'dateRange'},
  ],
  '8': [
    {'1': 'interval'},
  ],
...
final $typed_data.Uint8List keywordPlanForecastPeriodDescriptor = $convert.base64Decode(
    ...
    '9vZ2xlLmFkcy5nb29nbGVhZHMudjE2LmVudW1zLktleXdvcmRQbGFuRm9yZWNhc3RJbnRlcnZh'
    'bEVudW0uS2V5d29yZFBsYW5Gb3JlY2FzdEludGVydmFsSABSDGRhdGVJbnRlcnZhbBJLCgpkYX'
    'RlX3JhbmdlGAIgASgLMiouZ29vZ2xlLmFkcy5nb29nbGVhZHMudjE2LmNvbW1vbi5EYXRlUmFu'
