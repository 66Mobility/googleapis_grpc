...
class ProductLinkErrorEnum_ProductLinkError extends $pb.ProtobufEnum {
  ...
  static const ProductLinkErrorEnum_ProductLinkError INVITATION_EXISTS = ProductLinkErrorEnum_ProductLinkError._(4, _omitEnumNames ? '' : 'INVITATION_EXISTS');
  static const ProductLinkErrorEnum_ProductLinkError LINK_EXISTS = ProductLinkErrorEnum_ProductLinkError._(5, _omitEnumNames ? '' : 'LINK_EXISTS');
