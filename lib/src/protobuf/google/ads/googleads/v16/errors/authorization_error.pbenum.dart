...
class AuthorizationErrorEnum_AuthorizationError extends $pb.ProtobufEnum {
  ...
  static const AuthorizationErrorEnum_AuthorizationError DEVELOPER_TOKEN_NOT_ON_ALLOWLIST = AuthorizationErrorEnum_AuthorizationError._(13, _omitEnumNames ? '' : 'DEVELOPER_TOKEN_NOT_ON_ALLOWLIST');
  static const AuthorizationErrorEnum_AuthorizationError DEVELOPER_TOKEN_PROHIBITED = AuthorizationErrorEnum_AuthorizationError._(4, _omitEnumNames ? '' : 'DEVELOPER_TOKEN_PROHIBITED');
  ...
  static const AuthorizationErrorEnum_AuthorizationError DEVELOPER_TOKEN_NOT_APPROVED = AuthorizationErrorEnum_AuthorizationError._(10, _omitEnumNames ? '' : 'DEVELOPER_TOKEN_NOT_APPROVED');
  ...
  static const AuthorizationErrorEnum_AuthorizationError CLOUD_PROJECT_NOT_UNDER_ORGANIZATION = AuthorizationErrorEnum_AuthorizationError._(27, _omitEnumNames ? '' : 'CLOUD_PROJECT_NOT_UNDER_ORGANIZATION');
  static const AuthorizationErrorEnum_AuthorizationError ACTION_NOT_PERMITTED_FOR_SUSPENDED_ACCOUNT = AuthorizationErrorEnum_AuthorizationError._(28, _omitEnumNames ? '' : 'ACTION_NOT_PERMITTED_FOR_SUSPENDED_ACCOUNT');
