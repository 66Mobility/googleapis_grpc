...
class RecommendationErrorEnum_RecommendationError extends $pb.ProtobufEnum {
  ...
  static const RecommendationErrorEnum_RecommendationError ADVERTISING_CHANNEL_TYPE_GENERATE_NOT_SUPPORTED = RecommendationErrorEnum_RecommendationError._(19, _omitEnumNames ? '' : 'ADVERTISING_CHANNEL_TYPE_GENERATE_NOT_SUPPORTED');
  static const RecommendationErrorEnum_RecommendationError RECOMMENDATION_TYPE_GENERATE_NOT_SUPPORTED = RecommendationErrorEnum_RecommendationError._(20, _omitEnumNames ? '' : 'RECOMMENDATION_TYPE_GENERATE_NOT_SUPPORTED');
  static const RecommendationErrorEnum_RecommendationError RECOMMENDATION_TYPES_CANNOT_BE_EMPTY = RecommendationErrorEnum_RecommendationError._(21, _omitEnumNames ? '' : 'RECOMMENDATION_TYPES_CANNOT_BE_EMPTY');
