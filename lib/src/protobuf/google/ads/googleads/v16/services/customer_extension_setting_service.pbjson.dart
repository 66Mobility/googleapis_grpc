...
const MutateCustomerExtensionSettingsRequest$json = {
  ...
  '2': [
    ...
    {'1': 'operations', '3': 2, '4': 3, '5': 11, '6': '.google.ads.googleads.v16.services.CustomerExtensionSettingOperation', '8': {}, '10': 'operations'},
...
final $typed_data.Uint8List mutateCustomerExtensionSettingsRequestDescriptor = $convert.base64Decode(
    ...
    'Lmdvb2dsZWFkcy52MTYuc2VydmljZXMuQ3VzdG9tZXJFeHRlbnNpb25TZXR0aW5nT3BlcmF0aW'
...
const CustomerExtensionSettingOperation$json = {
  ...
  '2': [
    ...
    {'1': 'create', '3': 1, '4': 1, '5': 11, '6': '.google.ads.googleads.v16.resources.CustomerExtensionSetting', '9': 0, '10': 'create'},
    {'1': 'update', '3': 2, '4': 1, '5': 11, '6': '.google.ads.googleads.v16.resources.CustomerExtensionSetting', '9': 0, '10': 'update'},
...
final $typed_data.Uint8List customerExtensionSettingOperationDescriptor = $convert.base64Decode(
    ...
    'CzI8Lmdvb2dsZS5hZHMuZ29vZ2xlYWRzLnYxNi5yZXNvdXJjZXMuQ3VzdG9tZXJFeHRlbnNpb2'
    '5TZXR0aW5nSABSBmNyZWF0ZRJWCgZ1cGRhdGUYAiABKAsyPC5nb29nbGUuYWRzLmdvb2dsZWFk'
    'cy52MTYucmVzb3VyY2VzLkN1c3RvbWVyRXh0ZW5zaW9uU2V0dGluZ0gAUgZ1cGRhdGUSUAoGcm'
...
const MutateCustomerExtensionSettingsResponse$json = {
  ...
  '2': [
    ...
    {'1': 'results', '3': 2, '4': 3, '5': 11, '6': '.google.ads.googleads.v16.services.MutateCustomerExtensionSettingResult', '10': 'results'},
  ],
};
...
const MutateCustomerExtensionSettingResult$json = {
  ...
  '2': [
    ...
    {'1': 'customer_extension_setting', '3': 2, '4': 1, '5': 11, '6': '.google.ads.googleads.v16.resources.CustomerExtensionSetting', '10': 'customerExtensionSetting'},
  ],
};
...
final $typed_data.Uint8List mutateCustomerExtensionSettingResultDescriptor = $convert.base64Decode(
    ...
    'syPC5nb29nbGUuYWRzLmdvb2dsZWFkcy52MTYucmVzb3VyY2VzLkN1c3RvbWVyRXh0ZW5zaW9u'
