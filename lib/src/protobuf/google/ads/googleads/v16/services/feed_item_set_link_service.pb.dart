...
class FeedItemSetLinkOperation extends $pb.GeneratedMessage {
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(_omitMessageNames ? '' : 'FeedItemSetLinkOperation', package: const $pb.PackageName(_omitMessageNames ? '' : 'google.ads.googleads.v16.services'), createEmptyInstance: create)
    ..oo(0, [1, 2])
    ..aOM<$3107.FeedItemSetLink>(1, _omitFieldNames ? '' : 'create', subBuilder: $3107.FeedItemSetLink.create)
  ...
  @$pb.TagNumber(1)
  $3107.FeedItemSetLink get create_1 => $_getN(0);
  @$pb.TagNumber(1)
  set create_1($3107.FeedItemSetLink v) { setField(1, v); }
  @$pb.TagNumber(1)
  $core.bool hasCreate_1() => $_has(0);
  @$pb.TagNumber(1)
  void clearCreate_1() => clearField(1);
  @$pb.TagNumber(1)
  $3107.FeedItemSetLink ensureCreate_1() => $_ensure(0);
