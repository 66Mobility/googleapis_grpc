...
const MutateExperimentArmsRequest$json = {
  ...
  '2': [
    ...
    {'1': 'operations', '3': 2, '4': 3, '5': 11, '6': '.google.ads.googleads.v16.services.ExperimentArmOperation', '8': {}, '10': 'operations'},
...
final $typed_data.Uint8List mutateExperimentArmsRequestDescriptor = $convert.base64Decode(
    ...
    'djE2LnNlcnZpY2VzLkV4cGVyaW1lbnRBcm1PcGVyYXRpb25CA+BBAlIKb3BlcmF0aW9ucxInCg'
...
const ExperimentArmOperation$json = {
  ...
  '2': [
    ...
    {'1': 'create', '3': 1, '4': 1, '5': 11, '6': '.google.ads.googleads.v16.resources.ExperimentArm', '9': 0, '10': 'create'},
    {'1': 'update', '3': 2, '4': 1, '5': 11, '6': '.google.ads.googleads.v16.resources.ExperimentArm', '9': 0, '10': 'update'},
...
final $typed_data.Uint8List experimentArmOperationDescriptor = $convert.base64Decode(
    ...
    'YWRzLmdvb2dsZWFkcy52MTYucmVzb3VyY2VzLkV4cGVyaW1lbnRBcm1IAFIGY3JlYXRlEksKBn'
    'VwZGF0ZRgCIAEoCzIxLmdvb2dsZS5hZHMuZ29vZ2xlYWRzLnYxNi5yZXNvdXJjZXMuRXhwZXJp'
...
const MutateExperimentArmsResponse$json = {
  ...
  '2': [
    ...
    {'1': 'results', '3': 2, '4': 3, '5': 11, '6': '.google.ads.googleads.v16.services.MutateExperimentArmResult', '10': 'results'},
  ],
};
...
final $typed_data.Uint8List mutateExperimentArmsResponseDescriptor = $convert.base64Decode(
    ...
    'dHMYAiADKAsyPC5nb29nbGUuYWRzLmdvb2dsZWFkcy52MTYuc2VydmljZXMuTXV0YXRlRXhwZX'
...
const MutateExperimentArmResult$json = {
  ...
  '2': [
    ...
    {'1': 'experiment_arm', '3': 2, '4': 1, '5': 11, '6': '.google.ads.googleads.v16.resources.ExperimentArm', '10': 'experimentArm'},
  ],
};
...
final $typed_data.Uint8List mutateExperimentArmResultDescriptor = $convert.base64Decode(
    ...
    'Cg5leHBlcmltZW50X2FybRgCIAEoCzIxLmdvb2dsZS5hZHMuZ29vZ2xlYWRzLnYxNi5yZXNvdX'
