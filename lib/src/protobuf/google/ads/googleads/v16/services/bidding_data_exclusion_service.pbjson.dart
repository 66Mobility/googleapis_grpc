...
const MutateBiddingDataExclusionsRequest$json = {
  ...
  '2': [
    ...
    {'1': 'operations', '3': 2, '4': 3, '5': 11, '6': '.google.ads.googleads.v16.services.BiddingDataExclusionOperation', '8': {}, '10': 'operations'},
...
final $typed_data.Uint8List mutateBiddingDataExclusionsRequestDescriptor = $convert.base64Decode(
    ...
    'Z2xlYWRzLnYxNi5zZXJ2aWNlcy5CaWRkaW5nRGF0YUV4Y2x1c2lvbk9wZXJhdGlvbkID4EECUg'
...
const BiddingDataExclusionOperation$json = {
  ...
  '2': [
    ...
    {'1': 'create', '3': 1, '4': 1, '5': 11, '6': '.google.ads.googleads.v16.resources.BiddingDataExclusion', '9': 0, '10': 'create'},
    {'1': 'update', '3': 2, '4': 1, '5': 11, '6': '.google.ads.googleads.v16.resources.BiddingDataExclusion', '9': 0, '10': 'update'},
...
final $typed_data.Uint8List biddingDataExclusionOperationDescriptor = $convert.base64Decode(
    ...
    'Z29vZ2xlLmFkcy5nb29nbGVhZHMudjE2LnJlc291cmNlcy5CaWRkaW5nRGF0YUV4Y2x1c2lvbk'
...
const MutateBiddingDataExclusionsResponse$json = {
  ...
  '2': [
    ...
    {'1': 'results', '3': 2, '4': 3, '5': 11, '6': '.google.ads.googleads.v16.services.MutateBiddingDataExclusionsResult', '10': 'results'},
  ],
};
...
final $typed_data.Uint8List mutateBiddingDataExclusionsResponseDescriptor = $convert.base64Decode(
    ...
    'CgdyZXN1bHRzGAIgAygLMkQuZ29vZ2xlLmFkcy5nb29nbGVhZHMudjE2LnNlcnZpY2VzLk11dG'
...
const MutateBiddingDataExclusionsResult$json = {
  ...
  '2': [
    ...
    {'1': 'bidding_data_exclusion', '3': 2, '4': 1, '5': 11, '6': '.google.ads.googleads.v16.resources.BiddingDataExclusion', '10': 'biddingDataExclusion'},
  ],
};
...
final $typed_data.Uint8List mutateBiddingDataExclusionsResultDescriptor = $convert.base64Decode(
    ...
    'Fkcy5nb29nbGVhZHMudjE2LnJlc291cmNlcy5CaWRkaW5nRGF0YUV4Y2x1c2lvblIUYmlkZGlu'
    'Z0RhdGFFeGNsdXNpb24=');
