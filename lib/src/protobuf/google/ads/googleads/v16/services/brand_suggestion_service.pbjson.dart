...
const SuggestBrandsResponse$json = {
  ...
  '2': [
    {'1': 'brands', '3': 1, '4': 3, '5': 11, '6': '.google.ads.googleads.v16.services.BrandSuggestion', '10': 'brands'},
  ],
};
...
final $typed_data.Uint8List suggestBrandsResponseDescriptor = $convert.base64Decode(
    ...
    '9nbGVhZHMudjE2LnNlcnZpY2VzLkJyYW5kU3VnZ2VzdGlvblIGYnJhbmRz');
...
const BrandSuggestion$json = {
  ...
  '2': [
    ...
    {'1': 'state', '3': 4, '4': 1, '5': 14, '6': '.google.ads.googleads.v16.enums.BrandStateEnum.BrandState', '10': 'state'},
  ],
};
...
final $typed_data.Uint8List brandSuggestionDescriptor = $convert.base64Decode(
    ...
    'LnYxNi5lbnVtcy5CcmFuZFN0YXRlRW51bS5CcmFuZFN0YXRlUgVzdGF0ZQ==');
