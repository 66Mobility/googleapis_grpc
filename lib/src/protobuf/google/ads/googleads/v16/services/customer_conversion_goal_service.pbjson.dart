...
const MutateCustomerConversionGoalsRequest$json = {
  ...
  '2': [
    ...
    {'1': 'operations', '3': 2, '4': 3, '5': 11, '6': '.google.ads.googleads.v16.services.CustomerConversionGoalOperation', '8': {}, '10': 'operations'},
...
final $typed_data.Uint8List mutateCustomerConversionGoalsRequestDescriptor = $convert.base64Decode(
    ...
    'b29nbGVhZHMudjE2LnNlcnZpY2VzLkN1c3RvbWVyQ29udmVyc2lvbkdvYWxPcGVyYXRpb25CA+'
...
const CustomerConversionGoalOperation$json = {
  ...
  '2': [
    ...
    {'1': 'update', '3': 1, '4': 1, '5': 11, '6': '.google.ads.googleads.v16.resources.CustomerConversionGoal', '9': 0, '10': 'update'},
  ],
  '8': [
    {'1': 'operation'},
  ],
...
final $typed_data.Uint8List customerConversionGoalOperationDescriptor = $convert.base64Decode(
    ...
    'Oi5nb29nbGUuYWRzLmdvb2dsZWFkcy52MTYucmVzb3VyY2VzLkN1c3RvbWVyQ29udmVyc2lvbk'
...
const MutateCustomerConversionGoalsResponse$json = {
  ...
  '2': [
    {'1': 'results', '3': 1, '4': 3, '5': 11, '6': '.google.ads.googleads.v16.services.MutateCustomerConversionGoalResult', '10': 'results'},
  ],
};
...
final $typed_data.Uint8List mutateCustomerConversionGoalsResponseDescriptor = $convert.base64Decode(
    ...
    'syRS5nb29nbGUuYWRzLmdvb2dsZWFkcy52MTYuc2VydmljZXMuTXV0YXRlQ3VzdG9tZXJDb252'
