...
const MutateCampaignSharedSetsRequest$json = {
  ...
  '2': [
    ...
    {'1': 'operations', '3': 2, '4': 3, '5': 11, '6': '.google.ads.googleads.v16.services.CampaignSharedSetOperation', '8': {}, '10': 'operations'},
...
final $typed_data.Uint8List mutateCampaignSharedSetsRequestDescriptor = $convert.base64Decode(
    ...
    'YWRzLnYxNi5zZXJ2aWNlcy5DYW1wYWlnblNoYXJlZFNldE9wZXJhdGlvbkID4EECUgpvcGVyYX'
...
const CampaignSharedSetOperation$json = {
  ...
  '2': [
    {'1': 'create', '3': 1, '4': 1, '5': 11, '6': '.google.ads.googleads.v16.resources.CampaignSharedSet', '9': 0, '10': 'create'},
...
final $typed_data.Uint8List campaignSharedSetOperationDescriptor = $convert.base64Decode(
    ...
    'RzLmdvb2dsZWFkcy52MTYucmVzb3VyY2VzLkNhbXBhaWduU2hhcmVkU2V0SABSBmNyZWF0ZRJJ'
...
const MutateCampaignSharedSetsResponse$json = {
  ...
  '2': [
    ...
    {'1': 'results', '3': 2, '4': 3, '5': 11, '6': '.google.ads.googleads.v16.services.MutateCampaignSharedSetResult', '10': 'results'},
  ],
};
...
const MutateCampaignSharedSetResult$json = {
  ...
  '2': [
    ...
    {'1': 'campaign_shared_set', '3': 2, '4': 1, '5': 11, '6': '.google.ads.googleads.v16.resources.CampaignSharedSet', '10': 'campaignSharedSet'},
  ],
};
...
final $typed_data.Uint8List mutateCampaignSharedSetResultDescriptor = $convert.base64Decode(
    ...
    'Fkcy52MTYucmVzb3VyY2VzLkNhbXBhaWduU2hhcmVkU2V0UhFjYW1wYWlnblNoYXJlZFNldA==');
