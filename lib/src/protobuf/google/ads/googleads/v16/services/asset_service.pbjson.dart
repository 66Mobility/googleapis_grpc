...
const MutateAssetsRequest$json = {
  ...
  '2': [
    ...
    {'1': 'operations', '3': 2, '4': 3, '5': 11, '6': '.google.ads.googleads.v16.services.AssetOperation', '8': {}, '10': 'operations'},
    {'1': 'partial_failure', '3': 5, '4': 1, '5': 8, '10': 'partialFailure'},
    {'1': 'response_content_type', '3': 3, '4': 1, '5': 14, '6': '.google.ads.googleads.v16.enums.ResponseContentTypeEnum.ResponseContentType', '10': 'responseContentType'},
...
final $typed_data.Uint8List mutateAssetsRequestDescriptor = $convert.base64Decode(
    ...
    'Z29vZ2xlLmFkcy5nb29nbGVhZHMudjE2LmVudW1zLlJlc3BvbnNlQ29udGVudFR5cGVFbnVtLl'
...
const AssetOperation$json = {
  ...
  '2': [
    ...
    {'1': 'create', '3': 1, '4': 1, '5': 11, '6': '.google.ads.googleads.v16.resources.Asset', '9': 0, '10': 'create'},
    {'1': 'update', '3': 2, '4': 1, '5': 11, '6': '.google.ads.googleads.v16.resources.Asset', '9': 0, '10': 'update'},
  ],
  '8': [
    {'1': 'operation'},
  ],
...
final $typed_data.Uint8List assetOperationDescriptor = $convert.base64Decode(
    ...
    'bGVhZHMudjE2LnJlc291cmNlcy5Bc3NldEgAUgZjcmVhdGUSQwoGdXBkYXRlGAIgASgLMikuZ2'
    '9vZ2xlLmFkcy5nb29nbGVhZHMudjE2LnJlc291cmNlcy5Bc3NldEgAUgZ1cGRhdGVCCwoJb3Bl'
    'cmF0aW9u');
...
const MutateAssetsResponse$json = {
  ...
  '2': [
    ...
    {'1': 'results', '3': 2, '4': 3, '5': 11, '6': '.google.ads.googleads.v16.services.MutateAssetResult', '10': 'results'},
  ],
};
...
final $typed_data.Uint8List mutateAssetsResponseDescriptor = $convert.base64Decode(
    ...
    'MjQuZ29vZ2xlLmFkcy5nb29nbGVhZHMudjE2LnNlcnZpY2VzLk11dGF0ZUFzc2V0UmVzdWx0Ug'
    'dyZXN1bHRz');
...
const MutateAssetResult$json = {
  ...
  '2': [
    ...
    {'1': 'asset', '3': 2, '4': 1, '5': 11, '6': '.google.ads.googleads.v16.resources.Asset', '10': 'asset'},
  ],
};
...
final $typed_data.Uint8List mutateAssetResultDescriptor = $convert.base64Decode(
    ...
    'Z29vZ2xlLmFkcy5nb29nbGVhZHMudjE2LnJlc291cmNlcy5Bc3NldFIFYXNzZXQ=');
