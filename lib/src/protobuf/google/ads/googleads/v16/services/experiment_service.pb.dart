...
class ExperimentOperation extends $pb.GeneratedMessage {
  factory ExperimentOperation({
    $3106.Experiment? create_1,
    $3106.Experiment? update,
    $core.String? remove,
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(_omitMessageNames ? '' : 'ExperimentOperation', package: const $pb.PackageName(_omitMessageNames ? '' : 'google.ads.googleads.v16.services'), createEmptyInstance: create)
    ..oo(0, [1, 2, 3])
    ..aOM<$3106.Experiment>(1, _omitFieldNames ? '' : 'create', subBuilder: $3106.Experiment.create)
    ..aOM<$3106.Experiment>(2, _omitFieldNames ? '' : 'update', subBuilder: $3106.Experiment.create)
  ...
  /// Create operation
  @$pb.TagNumber(1)
  $3106.Experiment get create_1 => $_getN(0);
  @$pb.TagNumber(1)
  set create_1($3106.Experiment v) { setField(1, v); }
  @$pb.TagNumber(1)
  $core.bool hasCreate_1() => $_has(0);
  @$pb.TagNumber(1)
  void clearCreate_1() => clearField(1);
  @$pb.TagNumber(1)
  $3106.Experiment ensureCreate_1() => $_ensure(0);

  /// Update operation: The experiment is expected to have a valid
  /// resource name.
  @$pb.TagNumber(2)
  $3106.Experiment get update => $_getN(1);
  @$pb.TagNumber(2)
  set update($3106.Experiment v) { setField(2, v); }
  @$pb.TagNumber(2)
  $core.bool hasUpdate() => $_has(1);
  @$pb.TagNumber(2)
  void clearUpdate() => clearField(2);
  @$pb.TagNumber(2)
  $3106.Experiment ensureUpdate() => $_ensure(1);
