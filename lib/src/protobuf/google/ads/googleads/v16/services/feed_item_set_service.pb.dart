...
class MutateFeedItemSetsRequest extends $pb.GeneratedMessage {
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(_omitMessageNames ? '' : 'MutateFeedItemSetsRequest', package: const $pb.PackageName(_omitMessageNames ? '' : 'google.ads.googleads.v16.services'), createEmptyInstance: create)
...
class FeedItemSetOperation extends $pb.GeneratedMessage {
  factory FeedItemSetOperation({
    $3108.FeedItemSet? create_1,
    $3108.FeedItemSet? update,
    $core.String? remove,
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(_omitMessageNames ? '' : 'FeedItemSetOperation', package: const $pb.PackageName(_omitMessageNames ? '' : 'google.ads.googleads.v16.services'), createEmptyInstance: create)
    ..oo(0, [1, 2, 3])
    ..aOM<$3108.FeedItemSet>(1, _omitFieldNames ? '' : 'create', subBuilder: $3108.FeedItemSet.create)
    ..aOM<$3108.FeedItemSet>(2, _omitFieldNames ? '' : 'update', subBuilder: $3108.FeedItemSet.create)
  ...
  @$pb.TagNumber(1)
  $3108.FeedItemSet get create_1 => $_getN(0);
  @$pb.TagNumber(1)
  set create_1($3108.FeedItemSet v) { setField(1, v); }
  @$pb.TagNumber(1)
  $core.bool hasCreate_1() => $_has(0);
  @$pb.TagNumber(1)
  void clearCreate_1() => clearField(1);
  @$pb.TagNumber(1)
  $3108.FeedItemSet ensureCreate_1() => $_ensure(0);

  /// Update operation: The feed item set is expected to have a valid resource
  /// name.
  @$pb.TagNumber(2)
  $3108.FeedItemSet get update => $_getN(1);
  @$pb.TagNumber(2)
  set update($3108.FeedItemSet v) { setField(2, v); }
  @$pb.TagNumber(2)
  $core.bool hasUpdate() => $_has(1);
  @$pb.TagNumber(2)
  void clearUpdate() => clearField(2);
  @$pb.TagNumber(2)
  $3108.FeedItemSet ensureUpdate() => $_ensure(1);
...
class MutateFeedItemSetsResponse extends $pb.GeneratedMessage {
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(_omitMessageNames ? '' : 'MutateFeedItemSetsResponse', package: const $pb.PackageName(_omitMessageNames ? '' : 'google.ads.googleads.v16.services'), createEmptyInstance: create)
...
class MutateFeedItemSetResult extends $pb.GeneratedMessage {
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(_omitMessageNames ? '' : 'MutateFeedItemSetResult', package: const $pb.PackageName(_omitMessageNames ? '' : 'google.ads.googleads.v16.services'), createEmptyInstance: create)
