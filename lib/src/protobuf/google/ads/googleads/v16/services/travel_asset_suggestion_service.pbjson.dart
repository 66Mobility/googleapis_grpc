...
const SuggestTravelAssetsResponse$json = {
  ...
  '2': [
    {'1': 'hotel_asset_suggestions', '3': 1, '4': 3, '5': 11, '6': '.google.ads.googleads.v16.services.HotelAssetSuggestion', '10': 'hotelAssetSuggestions'},
  ],
};
...
final $typed_data.Uint8List suggestTravelAssetsResponseDescriptor = $convert.base64Decode(
    ...
    'MYASADKAsyNy5nb29nbGUuYWRzLmdvb2dsZWFkcy52MTYuc2VydmljZXMuSG90ZWxBc3NldFN1'
...
const HotelAssetSuggestion$json = {
  ...
  '2': [
    ...
    {'1': 'call_to_action', '3': 4, '4': 1, '5': 14, '6': '.google.ads.googleads.v16.enums.CallToActionTypeEnum.CallToActionType', '10': 'callToAction'},
    {'1': 'text_assets', '3': 5, '4': 3, '5': 11, '6': '.google.ads.googleads.v16.services.HotelTextAsset', '10': 'textAssets'},
    {'1': 'image_assets', '3': 6, '4': 3, '5': 11, '6': '.google.ads.googleads.v16.services.HotelImageAsset', '10': 'imageAssets'},
    {'1': 'status', '3': 7, '4': 1, '5': 14, '6': '.google.ads.googleads.v16.enums.HotelAssetSuggestionStatusEnum.HotelAssetSuggestionStatus', '10': 'status'},
  ],
};
...
final $typed_data.Uint8List hotelAssetSuggestionDescriptor = $convert.base64Decode(
    ...
    'Cg5jYWxsX3RvX2FjdGlvbhgEIAEoDjJFLmdvb2dsZS5hZHMuZ29vZ2xlYWRzLnYxNi5lbnVtcy'
    '5DYWxsVG9BY3Rpb25UeXBlRW51bS5DYWxsVG9BY3Rpb25UeXBlUgxjYWxsVG9BY3Rpb24SUgoL'
    'dGV4dF9hc3NldHMYBSADKAsyMS5nb29nbGUuYWRzLmdvb2dsZWFkcy52MTYuc2VydmljZXMuSG'
    '90ZWxUZXh0QXNzZXRSCnRleHRBc3NldHMSVQoMaW1hZ2VfYXNzZXRzGAYgAygLMjIuZ29vZ2xl'
    'LmFkcy5nb29nbGVhZHMudjE2LnNlcnZpY2VzLkhvdGVsSW1hZ2VBc3NldFILaW1hZ2VBc3NldH'
    'MScQoGc3RhdHVzGAcgASgOMlkuZ29vZ2xlLmFkcy5nb29nbGVhZHMudjE2LmVudW1zLkhvdGVs'
...
const HotelTextAsset$json = {
  ...
  '2': [
    ...
    {'1': 'asset_field_type', '3': 2, '4': 1, '5': 14, '6': '.google.ads.googleads.v16.enums.AssetFieldTypeEnum.AssetFieldType', '10': 'assetFieldType'},
  ],
};
...
final $typed_data.Uint8List hotelTextAssetDescriptor = $convert.base64Decode(
    ...
    'UYAiABKA4yQS5nb29nbGUuYWRzLmdvb2dsZWFkcy52MTYuZW51bXMuQXNzZXRGaWVsZFR5cGVF'
...
final $typed_data.Uint8List hotelImageAssetDescriptor = $convert.base64Decode(
    ...
    'gCIAEoDjJBLmdvb2dsZS5hZHMuZ29vZ2xlYWRzLnYxNi5lbnVtcy5Bc3NldEZpZWxkVHlwZUVu'
