...
class AdGroupAdOperation extends $pb.GeneratedMessage {
  factory AdGroupAdOperation({
    $2928.AdGroupAd? create_1,
    $2928.AdGroupAd? update,
    $core.String? remove,
    $2209.FieldMask? updateMask,
    $2525.PolicyValidationParameter? policyValidationParameter,
  }) {
    final $result = create();
    if (create_1 != null) {
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(_omitMessageNames ? '' : 'AdGroupAdOperation', package: const $pb.PackageName(_omitMessageNames ? '' : 'google.ads.googleads.v16.services'), createEmptyInstance: create)
    ..oo(0, [1, 2, 3])
    ..aOM<$2928.AdGroupAd>(1, _omitFieldNames ? '' : 'create', subBuilder: $2928.AdGroupAd.create)
    ..aOM<$2928.AdGroupAd>(2, _omitFieldNames ? '' : 'update', subBuilder: $2928.AdGroupAd.create)
    ..aOS(3, _omitFieldNames ? '' : 'remove')
    ..aOM<$2209.FieldMask>(4, _omitFieldNames ? '' : 'updateMask', subBuilder: $2209.FieldMask.create)
    ..aOM<$2525.PolicyValidationParameter>(5, _omitFieldNames ? '' : 'policyValidationParameter', subBuilder: $2525.PolicyValidationParameter.create)
    ..hasRequiredFields = false
  ;
  ...
  @$pb.TagNumber(1)
  $2928.AdGroupAd get create_1 => $_getN(0);
  @$pb.TagNumber(1)
  set create_1($2928.AdGroupAd v) { setField(1, v); }
  @$pb.TagNumber(1)
  $core.bool hasCreate_1() => $_has(0);
  @$pb.TagNumber(1)
  void clearCreate_1() => clearField(1);
  @$pb.TagNumber(1)
  $2928.AdGroupAd ensureCreate_1() => $_ensure(0);

  /// Update operation: The ad is expected to have a valid resource name.
  @$pb.TagNumber(2)
  $2928.AdGroupAd get update => $_getN(1);
  @$pb.TagNumber(2)
  set update($2928.AdGroupAd v) { setField(2, v); }
  @$pb.TagNumber(2)
  $core.bool hasUpdate() => $_has(1);
  @$pb.TagNumber(2)
  void clearUpdate() => clearField(2);
  @$pb.TagNumber(2)
  $2928.AdGroupAd ensureUpdate() => $_ensure(1);
  ...
  @$pb.TagNumber(5)
  $2525.PolicyValidationParameter get policyValidationParameter => $_getN(4);
  @$pb.TagNumber(5)
  set policyValidationParameter($2525.PolicyValidationParameter v) { setField(5, v); }
  @$pb.TagNumber(5)
  $core.bool hasPolicyValidationParameter() => $_has(4);
  @$pb.TagNumber(5)
  void clearPolicyValidationParameter() => clearField(5);
  @$pb.TagNumber(5)
  $2525.PolicyValidationParameter ensurePolicyValidationParameter() => $_ensure(4);
}
...
class MutateAdGroupAdResult extends $pb.GeneratedMessage {
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(_omitMessageNames ? '' : 'MutateAdGroupAdResult', package: const $pb.PackageName(_omitMessageNames ? '' : 'google.ads.googleads.v16.services'), createEmptyInstance: create)
    ...
    ..aOM<$2928.AdGroupAd>(2, _omitFieldNames ? '' : 'adGroupAd', subBuilder: $2928.AdGroupAd.create)
    ..hasRequiredFields = false
  ;
  ...
  /// "MUTABLE_RESOURCE".
  @$pb.TagNumber(2)
  $2928.AdGroupAd get adGroupAd => $_getN(1);
  @$pb.TagNumber(2)
  set adGroupAd($2928.AdGroupAd v) { setField(2, v); }
  @$pb.TagNumber(2)
  $core.bool hasAdGroupAd() => $_has(1);
  @$pb.TagNumber(2)
  void clearAdGroupAd() => clearField(2);
  @$pb.TagNumber(2)
  $2928.AdGroupAd ensureAdGroupAd() => $_ensure(1);
}
