...
class AdGroupAssetSetOperation extends $pb.GeneratedMessage {
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(_omitMessageNames ? '' : 'AdGroupAssetSetOperation', package: const $pb.PackageName(_omitMessageNames ? '' : 'google.ads.googleads.v16.services'), createEmptyInstance: create)
    ..oo(0, [1, 2])
    ..aOM<$3066.AdGroupAssetSet>(1, _omitFieldNames ? '' : 'create', subBuilder: $3066.AdGroupAssetSet.create)
  ...
  /// set.
  @$pb.TagNumber(1)
  $3066.AdGroupAssetSet get create_1 => $_getN(0);
  @$pb.TagNumber(1)
  set create_1($3066.AdGroupAssetSet v) { setField(1, v); }
  @$pb.TagNumber(1)
  $core.bool hasCreate_1() => $_has(0);
  @$pb.TagNumber(1)
  void clearCreate_1() => clearField(1);
  @$pb.TagNumber(1)
  $3066.AdGroupAssetSet ensureCreate_1() => $_ensure(0);
...
class MutateAdGroupAssetSetResult extends $pb.GeneratedMessage {
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(_omitMessageNames ? '' : 'MutateAdGroupAssetSetResult', package: const $pb.PackageName(_omitMessageNames ? '' : 'google.ads.googleads.v16.services'), createEmptyInstance: create)
    ...
    ..aOM<$3066.AdGroupAssetSet>(2, _omitFieldNames ? '' : 'adGroupAssetSet', subBuilder: $3066.AdGroupAssetSet.create)
    ..hasRequiredFields = false
  ;
  ...
  /// "MUTABLE_RESOURCE".
  @$pb.TagNumber(2)
  $3066.AdGroupAssetSet get adGroupAssetSet => $_getN(1);
  @$pb.TagNumber(2)
  set adGroupAssetSet($3066.AdGroupAssetSet v) { setField(2, v); }
  @$pb.TagNumber(2)
  $core.bool hasAdGroupAssetSet() => $_has(1);
  @$pb.TagNumber(2)
  void clearAdGroupAssetSet() => clearField(2);
  @$pb.TagNumber(2)
  $3066.AdGroupAssetSet ensureAdGroupAssetSet() => $_ensure(1);
}
