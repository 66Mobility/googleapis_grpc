...
const MutateCustomerLabelsRequest$json = {
  ...
  '2': [
    ...
    {'1': 'operations', '3': 2, '4': 3, '5': 11, '6': '.google.ads.googleads.v16.services.CustomerLabelOperation', '8': {}, '10': 'operations'},
...
final $typed_data.Uint8List mutateCustomerLabelsRequestDescriptor = $convert.base64Decode(
    ...
    'djE2LnNlcnZpY2VzLkN1c3RvbWVyTGFiZWxPcGVyYXRpb25CA+BBAlIKb3BlcmF0aW9ucxInCg'
...
const CustomerLabelOperation$json = {
  ...
  '2': [
    {'1': 'create', '3': 1, '4': 1, '5': 11, '6': '.google.ads.googleads.v16.resources.CustomerLabel', '9': 0, '10': 'create'},
...
final $typed_data.Uint8List customerLabelOperationDescriptor = $convert.base64Decode(
    ...
    '9vZ2xlYWRzLnYxNi5yZXNvdXJjZXMuQ3VzdG9tZXJMYWJlbEgAUgZjcmVhdGUSRQoGcmVtb3Zl'
...
const MutateCustomerLabelsResponse$json = {
  ...
  '2': [
    ...
    {'1': 'results', '3': 2, '4': 3, '5': 11, '6': '.google.ads.googleads.v16.services.MutateCustomerLabelResult', '10': 'results'},
  ],
};
