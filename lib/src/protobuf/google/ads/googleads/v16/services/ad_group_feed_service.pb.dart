...
class MutateAdGroupFeedsRequest extends $pb.GeneratedMessage {
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(_omitMessageNames ? '' : 'MutateAdGroupFeedsRequest', package: const $pb.PackageName(_omitMessageNames ? '' : 'google.ads.googleads.v16.services'), createEmptyInstance: create)
...
class AdGroupFeedOperation extends $pb.GeneratedMessage {
  factory AdGroupFeedOperation({
    $2928.AdGroupFeed? create_1,
    $2928.AdGroupFeed? update,
    $core.String? remove,
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(_omitMessageNames ? '' : 'AdGroupFeedOperation', package: const $pb.PackageName(_omitMessageNames ? '' : 'google.ads.googleads.v16.services'), createEmptyInstance: create)
    ..oo(0, [1, 2, 3])
    ..aOM<$2928.AdGroupFeed>(1, _omitFieldNames ? '' : 'create', subBuilder: $2928.AdGroupFeed.create)
    ..aOM<$2928.AdGroupFeed>(2, _omitFieldNames ? '' : 'update', subBuilder: $2928.AdGroupFeed.create)
  ...
  @$pb.TagNumber(1)
  $2928.AdGroupFeed get create_1 => $_getN(0);
  @$pb.TagNumber(1)
  set create_1($2928.AdGroupFeed v) { setField(1, v); }
  @$pb.TagNumber(1)
  $core.bool hasCreate_1() => $_has(0);
  @$pb.TagNumber(1)
  void clearCreate_1() => clearField(1);
  @$pb.TagNumber(1)
  $2928.AdGroupFeed ensureCreate_1() => $_ensure(0);

  /// Update operation: The ad group feed is expected to have a valid resource
  /// name.
  @$pb.TagNumber(2)
  $2928.AdGroupFeed get update => $_getN(1);
  @$pb.TagNumber(2)
  set update($2928.AdGroupFeed v) { setField(2, v); }
  @$pb.TagNumber(2)
  $core.bool hasUpdate() => $_has(1);
  @$pb.TagNumber(2)
  void clearUpdate() => clearField(2);
  @$pb.TagNumber(2)
  $2928.AdGroupFeed ensureUpdate() => $_ensure(1);
...
class MutateAdGroupFeedsResponse extends $pb.GeneratedMessage {
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(_omitMessageNames ? '' : 'MutateAdGroupFeedsResponse', package: const $pb.PackageName(_omitMessageNames ? '' : 'google.ads.googleads.v16.services'), createEmptyInstance: create)
...
class MutateAdGroupFeedResult extends $pb.GeneratedMessage {
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(_omitMessageNames ? '' : 'MutateAdGroupFeedResult', package: const $pb.PackageName(_omitMessageNames ? '' : 'google.ads.googleads.v16.services'), createEmptyInstance: create)
    ..aOS(1, _omitFieldNames ? '' : 'resourceName')
    ..aOM<$2928.AdGroupFeed>(2, _omitFieldNames ? '' : 'adGroupFeed', subBuilder: $2928.AdGroupFeed.create)
    ..hasRequiredFields = false
  ;
  ...
  /// "MUTABLE_RESOURCE".
  @$pb.TagNumber(2)
  $2928.AdGroupFeed get adGroupFeed => $_getN(1);
  @$pb.TagNumber(2)
  set adGroupFeed($2928.AdGroupFeed v) { setField(2, v); }
  @$pb.TagNumber(2)
  $core.bool hasAdGroupFeed() => $_has(1);
  @$pb.TagNumber(2)
  void clearAdGroupFeed() => clearField(2);
  @$pb.TagNumber(2)
  $2928.AdGroupFeed ensureAdGroupFeed() => $_ensure(1);
}
