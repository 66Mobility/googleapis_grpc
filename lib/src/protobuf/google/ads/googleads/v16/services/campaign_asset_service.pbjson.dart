...
const MutateCampaignAssetsRequest$json = {
  ...
  '2': [
    ...
    {'1': 'operations', '3': 2, '4': 3, '5': 11, '6': '.google.ads.googleads.v16.services.CampaignAssetOperation', '8': {}, '10': 'operations'},
...
final $typed_data.Uint8List mutateCampaignAssetsRequestDescriptor = $convert.base64Decode(
    ...
    'djE2LnNlcnZpY2VzLkNhbXBhaWduQXNzZXRPcGVyYXRpb25CA+BBAlIKb3BlcmF0aW9ucxInCg'
...
const CampaignAssetOperation$json = {
  ...
  '2': [
    ...
    {'1': 'create', '3': 1, '4': 1, '5': 11, '6': '.google.ads.googleads.v16.resources.CampaignAsset', '9': 0, '10': 'create'},
    {'1': 'update', '3': 3, '4': 1, '5': 11, '6': '.google.ads.googleads.v16.resources.CampaignAsset', '9': 0, '10': 'update'},
...
final $typed_data.Uint8List campaignAssetOperationDescriptor = $convert.base64Decode(
    ...
    'YWRzLmdvb2dsZWFkcy52MTYucmVzb3VyY2VzLkNhbXBhaWduQXNzZXRIAFIGY3JlYXRlEksKBn'
    'VwZGF0ZRgDIAEoCzIxLmdvb2dsZS5hZHMuZ29vZ2xlYWRzLnYxNi5yZXNvdXJjZXMuQ2FtcGFp'
...
const MutateCampaignAssetsResponse$json = {
  ...
  '2': [
    ...
    {'1': 'results', '3': 2, '4': 3, '5': 11, '6': '.google.ads.googleads.v16.services.MutateCampaignAssetResult', '10': 'results'},
  ],
};
...
const MutateCampaignAssetResult$json = {
  ...
  '2': [
    ...
    {'1': 'campaign_asset', '3': 2, '4': 1, '5': 11, '6': '.google.ads.googleads.v16.resources.CampaignAsset', '10': 'campaignAsset'},
  ],
};
...
final $typed_data.Uint8List mutateCampaignAssetResultDescriptor = $convert.base64Decode(
    ...
    'Cg5jYW1wYWlnbl9hc3NldBgCIAEoCzIxLmdvb2dsZS5hZHMuZ29vZ2xlYWRzLnYxNi5yZXNvdX'
