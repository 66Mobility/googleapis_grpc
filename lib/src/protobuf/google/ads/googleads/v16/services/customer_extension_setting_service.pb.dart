...
class CustomerExtensionSettingOperation extends $pb.GeneratedMessage {
  factory CustomerExtensionSettingOperation({
    $3098.CustomerExtensionSetting? create_1,
    $3098.CustomerExtensionSetting? update,
    $core.String? remove,
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(_omitMessageNames ? '' : 'CustomerExtensionSettingOperation', package: const $pb.PackageName(_omitMessageNames ? '' : 'google.ads.googleads.v16.services'), createEmptyInstance: create)
    ..oo(0, [1, 2, 3])
    ..aOM<$3098.CustomerExtensionSetting>(1, _omitFieldNames ? '' : 'create', subBuilder: $3098.CustomerExtensionSetting.create)
    ..aOM<$3098.CustomerExtensionSetting>(2, _omitFieldNames ? '' : 'update', subBuilder: $3098.CustomerExtensionSetting.create)
  ...
  /// extension setting.
  @$pb.TagNumber(1)
  $3098.CustomerExtensionSetting get create_1 => $_getN(0);
  @$pb.TagNumber(1)
  set create_1($3098.CustomerExtensionSetting v) { setField(1, v); }
  @$pb.TagNumber(1)
  $core.bool hasCreate_1() => $_has(0);
  @$pb.TagNumber(1)
  void clearCreate_1() => clearField(1);
  @$pb.TagNumber(1)
  $3098.CustomerExtensionSetting ensureCreate_1() => $_ensure(0);

  /// Update operation: The customer extension setting is expected to have a
  /// valid resource name.
  @$pb.TagNumber(2)
  $3098.CustomerExtensionSetting get update => $_getN(1);
  @$pb.TagNumber(2)
  set update($3098.CustomerExtensionSetting v) { setField(2, v); }
  @$pb.TagNumber(2)
  $core.bool hasUpdate() => $_has(1);
  @$pb.TagNumber(2)
  void clearUpdate() => clearField(2);
  @$pb.TagNumber(2)
  $3098.CustomerExtensionSetting ensureUpdate() => $_ensure(1);
...
class MutateCustomerExtensionSettingResult extends $pb.GeneratedMessage {
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(_omitMessageNames ? '' : 'MutateCustomerExtensionSettingResult', package: const $pb.PackageName(_omitMessageNames ? '' : 'google.ads.googleads.v16.services'), createEmptyInstance: create)
    ...
    ..aOM<$3098.CustomerExtensionSetting>(2, _omitFieldNames ? '' : 'customerExtensionSetting', subBuilder: $3098.CustomerExtensionSetting.create)
    ..hasRequiredFields = false
  ;
  ...
  /// "MUTABLE_RESOURCE".
  @$pb.TagNumber(2)
  $3098.CustomerExtensionSetting get customerExtensionSetting => $_getN(1);
  @$pb.TagNumber(2)
  set customerExtensionSetting($3098.CustomerExtensionSetting v) { setField(2, v); }
  @$pb.TagNumber(2)
  $core.bool hasCustomerExtensionSetting() => $_has(1);
  @$pb.TagNumber(2)
  void clearCustomerExtensionSetting() => clearField(2);
  @$pb.TagNumber(2)
  $3098.CustomerExtensionSetting ensureCustomerExtensionSetting() => $_ensure(1);
}
