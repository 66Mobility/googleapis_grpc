...
const MutateCampaignCriteriaRequest$json = {
  ...
  '2': [
    ...
    {'1': 'operations', '3': 2, '4': 3, '5': 11, '6': '.google.ads.googleads.v16.services.CampaignCriterionOperation', '8': {}, '10': 'operations'},
...
final $typed_data.Uint8List mutateCampaignCriteriaRequestDescriptor = $convert.base64Decode(
    ...
    'cy52MTYuc2VydmljZXMuQ2FtcGFpZ25Dcml0ZXJpb25PcGVyYXRpb25CA+BBAlIKb3BlcmF0aW'
...
const CampaignCriterionOperation$json = {
  ...
  '2': [
    ...
    {'1': 'create', '3': 1, '4': 1, '5': 11, '6': '.google.ads.googleads.v16.resources.CampaignCriterion', '9': 0, '10': 'create'},
    {'1': 'update', '3': 2, '4': 1, '5': 11, '6': '.google.ads.googleads.v16.resources.CampaignCriterion', '9': 0, '10': 'update'},
...
final $typed_data.Uint8List campaignCriterionOperationDescriptor = $convert.base64Decode(
    ...
    'Z2xlLmFkcy5nb29nbGVhZHMudjE2LnJlc291cmNlcy5DYW1wYWlnbkNyaXRlcmlvbkgAUgZjcm'
...
const MutateCampaignCriteriaResponse$json = {
  ...
  '2': [
    ...
    {'1': 'results', '3': 2, '4': 3, '5': 11, '6': '.google.ads.googleads.v16.services.MutateCampaignCriterionResult', '10': 'results'},
  ],
};
...
final $typed_data.Uint8List mutateCampaignCriteriaResponseDescriptor = $convert.base64Decode(
    ...
    'dWx0cxgCIAMoCzJALmdvb2dsZS5hZHMuZ29vZ2xlYWRzLnYxNi5zZXJ2aWNlcy5NdXRhdGVDYW'
...
const MutateCampaignCriterionResult$json = {
  ...
  '2': [
    ...
    {'1': 'campaign_criterion', '3': 2, '4': 1, '5': 11, '6': '.google.ads.googleads.v16.resources.CampaignCriterion', '10': 'campaignCriterion'},
  ],
};
...
final $typed_data.Uint8List mutateCampaignCriterionResultDescriptor = $convert.base64Decode(
    ...
    'RzLnYxNi5yZXNvdXJjZXMuQ2FtcGFpZ25Dcml0ZXJpb25SEWNhbXBhaWduQ3JpdGVyaW9u');
