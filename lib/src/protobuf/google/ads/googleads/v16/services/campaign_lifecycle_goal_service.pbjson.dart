...
const ConfigureCampaignLifecycleGoalsRequest$json = {
  ...
  '2': [
    ...
    {'1': 'operation', '3': 2, '4': 1, '5': 11, '6': '.google.ads.googleads.v16.services.CampaignLifecycleGoalOperation', '8': {}, '10': 'operation'},
...
final $typed_data.Uint8List configureCampaignLifecycleGoalsRequestDescriptor = $convert.base64Decode(
    ...
    'Z29vZ2xlYWRzLnYxNi5zZXJ2aWNlcy5DYW1wYWlnbkxpZmVjeWNsZUdvYWxPcGVyYXRpb25CA+'
...
const CampaignLifecycleGoalOperation$json = {
  ...
  '2': [
    ...
    {'1': 'create', '3': 1, '4': 1, '5': 11, '6': '.google.ads.googleads.v16.resources.CampaignLifecycleGoal', '9': 0, '10': 'create'},
    {'1': 'update', '3': 3, '4': 1, '5': 11, '6': '.google.ads.googleads.v16.resources.CampaignLifecycleGoal', '9': 0, '10': 'update'},
  ],
  '8': [
    {'1': 'operation'},
  ],
...
final $typed_data.Uint8List campaignLifecycleGoalOperationDescriptor = $convert.base64Decode(
    ...
    'ASgLMjkuZ29vZ2xlLmFkcy5nb29nbGVhZHMudjE2LnJlc291cmNlcy5DYW1wYWlnbkxpZmVjeW'
    'NsZUdvYWxIAFIGY3JlYXRlElMKBnVwZGF0ZRgDIAEoCzI5Lmdvb2dsZS5hZHMuZ29vZ2xlYWRz'
    'LnYxNi5yZXNvdXJjZXMuQ2FtcGFpZ25MaWZlY3ljbGVHb2FsSABSBnVwZGF0ZUILCglvcGVyYX'
    'Rpb24=');
...
const ConfigureCampaignLifecycleGoalsResponse$json = {
  ...
  '2': [
    {'1': 'result', '3': 1, '4': 1, '5': 11, '6': '.google.ads.googleads.v16.services.ConfigureCampaignLifecycleGoalsResult', '10': 'result'},
  ],
};
...
final $typed_data.Uint8List configureCampaignLifecycleGoalsResponseDescriptor = $convert.base64Decode(
    ...
    'gLMkguZ29vZ2xlLmFkcy5nb29nbGVhZHMudjE2LnNlcnZpY2VzLkNvbmZpZ3VyZUNhbXBhaWdu'
