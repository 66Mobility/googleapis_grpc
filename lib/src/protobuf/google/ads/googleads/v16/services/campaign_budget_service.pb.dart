...
class MutateCampaignBudgetsRequest extends $pb.GeneratedMessage {
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(_omitMessageNames ? '' : 'MutateCampaignBudgetsRequest', package: const $pb.PackageName(_omitMessageNames ? '' : 'google.ads.googleads.v16.services'), createEmptyInstance: create)
...
class CampaignBudgetOperation extends $pb.GeneratedMessage {
  factory CampaignBudgetOperation({
    $2921.CampaignBudget? create_1,
    $2921.CampaignBudget? update,
    $core.String? remove,
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(_omitMessageNames ? '' : 'CampaignBudgetOperation', package: const $pb.PackageName(_omitMessageNames ? '' : 'google.ads.googleads.v16.services'), createEmptyInstance: create)
    ..oo(0, [1, 2, 3])
    ..aOM<$2921.CampaignBudget>(1, _omitFieldNames ? '' : 'create', subBuilder: $2921.CampaignBudget.create)
    ..aOM<$2921.CampaignBudget>(2, _omitFieldNames ? '' : 'update', subBuilder: $2921.CampaignBudget.create)
  ...
  @$pb.TagNumber(1)
  $2921.CampaignBudget get create_1 => $_getN(0);
  @$pb.TagNumber(1)
  set create_1($2921.CampaignBudget v) { setField(1, v); }
  @$pb.TagNumber(1)
  $core.bool hasCreate_1() => $_has(0);
  @$pb.TagNumber(1)
  void clearCreate_1() => clearField(1);
  @$pb.TagNumber(1)
  $2921.CampaignBudget ensureCreate_1() => $_ensure(0);

  /// Update operation: The campaign budget is expected to have a valid
  /// resource name.
  @$pb.TagNumber(2)
  $2921.CampaignBudget get update => $_getN(1);
  @$pb.TagNumber(2)
  set update($2921.CampaignBudget v) { setField(2, v); }
  @$pb.TagNumber(2)
  $core.bool hasUpdate() => $_has(1);
  @$pb.TagNumber(2)
  void clearUpdate() => clearField(2);
  @$pb.TagNumber(2)
  $2921.CampaignBudget ensureUpdate() => $_ensure(1);
...
class MutateCampaignBudgetsResponse extends $pb.GeneratedMessage {
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(_omitMessageNames ? '' : 'MutateCampaignBudgetsResponse', package: const $pb.PackageName(_omitMessageNames ? '' : 'google.ads.googleads.v16.services'), createEmptyInstance: create)
...
class MutateCampaignBudgetResult extends $pb.GeneratedMessage {
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(_omitMessageNames ? '' : 'MutateCampaignBudgetResult', package: const $pb.PackageName(_omitMessageNames ? '' : 'google.ads.googleads.v16.services'), createEmptyInstance: create)
    ..aOS(1, _omitFieldNames ? '' : 'resourceName')
    ..aOM<$2921.CampaignBudget>(2, _omitFieldNames ? '' : 'campaignBudget', subBuilder: $2921.CampaignBudget.create)
    ..hasRequiredFields = false
  ;
  ...
  /// "MUTABLE_RESOURCE".
  @$pb.TagNumber(2)
  $2921.CampaignBudget get campaignBudget => $_getN(1);
  @$pb.TagNumber(2)
  set campaignBudget($2921.CampaignBudget v) { setField(2, v); }
  @$pb.TagNumber(2)
  $core.bool hasCampaignBudget() => $_has(1);
  @$pb.TagNumber(2)
  void clearCampaignBudget() => clearField(2);
  @$pb.TagNumber(2)
  $2921.CampaignBudget ensureCampaignBudget() => $_ensure(1);
}
