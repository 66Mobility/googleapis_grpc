...
const ConfigureCustomerLifecycleGoalsRequest$json = {
  ...
  '2': [
    ...
    {'1': 'operation', '3': 2, '4': 1, '5': 11, '6': '.google.ads.googleads.v16.services.CustomerLifecycleGoalOperation', '8': {}, '10': 'operation'},
...
final $typed_data.Uint8List configureCustomerLifecycleGoalsRequestDescriptor = $convert.base64Decode(
    ...
    'Z29vZ2xlYWRzLnYxNi5zZXJ2aWNlcy5DdXN0b21lckxpZmVjeWNsZUdvYWxPcGVyYXRpb25CA+'
...
const CustomerLifecycleGoalOperation$json = {
  ...
  '2': [
    ...
    {'1': 'create', '3': 1, '4': 1, '5': 11, '6': '.google.ads.googleads.v16.resources.CustomerLifecycleGoal', '9': 0, '10': 'create'},
    {'1': 'update', '3': 3, '4': 1, '5': 11, '6': '.google.ads.googleads.v16.resources.CustomerLifecycleGoal', '9': 0, '10': 'update'},
  ],
  '8': [
    {'1': 'operation'},
  ],
...
final $typed_data.Uint8List customerLifecycleGoalOperationDescriptor = $convert.base64Decode(
    ...
    'ASgLMjkuZ29vZ2xlLmFkcy5nb29nbGVhZHMudjE2LnJlc291cmNlcy5DdXN0b21lckxpZmVjeW'
    'NsZUdvYWxIAFIGY3JlYXRlElMKBnVwZGF0ZRgDIAEoCzI5Lmdvb2dsZS5hZHMuZ29vZ2xlYWRz'
    'LnYxNi5yZXNvdXJjZXMuQ3VzdG9tZXJMaWZlY3ljbGVHb2FsSABSBnVwZGF0ZUILCglvcGVyYX'
    'Rpb24=');
...
const ConfigureCustomerLifecycleGoalsResponse$json = {
  ...
  '2': [
    {'1': 'result', '3': 1, '4': 1, '5': 11, '6': '.google.ads.googleads.v16.services.ConfigureCustomerLifecycleGoalsResult', '10': 'result'},
  ],
};
...
final $typed_data.Uint8List configureCustomerLifecycleGoalsResponseDescriptor = $convert.base64Decode(
    ...
    'gLMkguZ29vZ2xlLmFkcy5nb29nbGVhZHMudjE2LnNlcnZpY2VzLkNvbmZpZ3VyZUN1c3RvbWVy'
