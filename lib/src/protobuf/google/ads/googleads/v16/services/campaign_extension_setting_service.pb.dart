...
class CampaignExtensionSettingOperation extends $pb.GeneratedMessage {
  factory CampaignExtensionSettingOperation({
    $3087.CampaignExtensionSetting? create_1,
    $3087.CampaignExtensionSetting? update,
    $core.String? remove,
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(_omitMessageNames ? '' : 'CampaignExtensionSettingOperation', package: const $pb.PackageName(_omitMessageNames ? '' : 'google.ads.googleads.v16.services'), createEmptyInstance: create)
    ..oo(0, [1, 2, 3])
    ..aOM<$3087.CampaignExtensionSetting>(1, _omitFieldNames ? '' : 'create', subBuilder: $3087.CampaignExtensionSetting.create)
    ..aOM<$3087.CampaignExtensionSetting>(2, _omitFieldNames ? '' : 'update', subBuilder: $3087.CampaignExtensionSetting.create)
  ...
  /// extension setting.
  @$pb.TagNumber(1)
  $3087.CampaignExtensionSetting get create_1 => $_getN(0);
  @$pb.TagNumber(1)
  set create_1($3087.CampaignExtensionSetting v) { setField(1, v); }
  @$pb.TagNumber(1)
  $core.bool hasCreate_1() => $_has(0);
  @$pb.TagNumber(1)
  void clearCreate_1() => clearField(1);
  @$pb.TagNumber(1)
  $3087.CampaignExtensionSetting ensureCreate_1() => $_ensure(0);

  /// Update operation: The campaign extension setting is expected to have a
  /// valid resource name.
  @$pb.TagNumber(2)
  $3087.CampaignExtensionSetting get update => $_getN(1);
  @$pb.TagNumber(2)
  set update($3087.CampaignExtensionSetting v) { setField(2, v); }
  @$pb.TagNumber(2)
  $core.bool hasUpdate() => $_has(1);
  @$pb.TagNumber(2)
  void clearUpdate() => clearField(2);
  @$pb.TagNumber(2)
  $3087.CampaignExtensionSetting ensureUpdate() => $_ensure(1);
...
class MutateCampaignExtensionSettingResult extends $pb.GeneratedMessage {
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(_omitMessageNames ? '' : 'MutateCampaignExtensionSettingResult', package: const $pb.PackageName(_omitMessageNames ? '' : 'google.ads.googleads.v16.services'), createEmptyInstance: create)
    ...
    ..aOM<$3087.CampaignExtensionSetting>(2, _omitFieldNames ? '' : 'campaignExtensionSetting', subBuilder: $3087.CampaignExtensionSetting.create)
    ..hasRequiredFields = false
  ;
  ...
  /// to "MUTABLE_RESOURCE".
  @$pb.TagNumber(2)
  $3087.CampaignExtensionSetting get campaignExtensionSetting => $_getN(1);
  @$pb.TagNumber(2)
  set campaignExtensionSetting($3087.CampaignExtensionSetting v) { setField(2, v); }
  @$pb.TagNumber(2)
  $core.bool hasCampaignExtensionSetting() => $_has(1);
  @$pb.TagNumber(2)
  void clearCampaignExtensionSetting() => clearField(2);
  @$pb.TagNumber(2)
  $3087.CampaignExtensionSetting ensureCampaignExtensionSetting() => $_ensure(1);
}
