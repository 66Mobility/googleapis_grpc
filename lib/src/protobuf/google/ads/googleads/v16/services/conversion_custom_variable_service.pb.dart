...
class ConversionCustomVariableOperation extends $pb.GeneratedMessage {
  factory ConversionCustomVariableOperation({
    $3091.ConversionCustomVariable? create_1,
    $3091.ConversionCustomVariable? update,
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(_omitMessageNames ? '' : 'ConversionCustomVariableOperation', package: const $pb.PackageName(_omitMessageNames ? '' : 'google.ads.googleads.v16.services'), createEmptyInstance: create)
    ..oo(0, [1, 2])
    ..aOM<$3091.ConversionCustomVariable>(1, _omitFieldNames ? '' : 'create', subBuilder: $3091.ConversionCustomVariable.create)
    ..aOM<$3091.ConversionCustomVariable>(2, _omitFieldNames ? '' : 'update', subBuilder: $3091.ConversionCustomVariable.create)
  ...
  /// custom variable.
  @$pb.TagNumber(1)
  $3091.ConversionCustomVariable get create_1 => $_getN(0);
  @$pb.TagNumber(1)
  set create_1($3091.ConversionCustomVariable v) { setField(1, v); }
  @$pb.TagNumber(1)
  $core.bool hasCreate_1() => $_has(0);
  @$pb.TagNumber(1)
  void clearCreate_1() => clearField(1);
  @$pb.TagNumber(1)
  $3091.ConversionCustomVariable ensureCreate_1() => $_ensure(0);

  /// Update operation: The conversion custom variable is expected to have a
  /// valid resource name.
  @$pb.TagNumber(2)
  $3091.ConversionCustomVariable get update => $_getN(1);
  @$pb.TagNumber(2)
  set update($3091.ConversionCustomVariable v) { setField(2, v); }
  @$pb.TagNumber(2)
  $core.bool hasUpdate() => $_has(1);
  @$pb.TagNumber(2)
  void clearUpdate() => clearField(2);
  @$pb.TagNumber(2)
  $3091.ConversionCustomVariable ensureUpdate() => $_ensure(1);
...
class MutateConversionCustomVariableResult extends $pb.GeneratedMessage {
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(_omitMessageNames ? '' : 'MutateConversionCustomVariableResult', package: const $pb.PackageName(_omitMessageNames ? '' : 'google.ads.googleads.v16.services'), createEmptyInstance: create)
    ...
    ..aOM<$3091.ConversionCustomVariable>(2, _omitFieldNames ? '' : 'conversionCustomVariable', subBuilder: $3091.ConversionCustomVariable.create)
    ..hasRequiredFields = false
  ;
  ...
  /// to "MUTABLE_RESOURCE".
  @$pb.TagNumber(2)
  $3091.ConversionCustomVariable get conversionCustomVariable => $_getN(1);
  @$pb.TagNumber(2)
  set conversionCustomVariable($3091.ConversionCustomVariable v) { setField(2, v); }
  @$pb.TagNumber(2)
  $core.bool hasConversionCustomVariable() => $_has(1);
  @$pb.TagNumber(2)
  void clearConversionCustomVariable() => clearField(2);
  @$pb.TagNumber(2)
  $3091.ConversionCustomVariable ensureConversionCustomVariable() => $_ensure(1);
}
