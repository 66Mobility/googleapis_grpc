...
const MutateCustomerCustomizersRequest$json = {
  ...
  '2': [
    ...
    {'1': 'operations', '3': 2, '4': 3, '5': 11, '6': '.google.ads.googleads.v16.services.CustomerCustomizerOperation', '8': {}, '10': 'operations'},
...
final $typed_data.Uint8List mutateCustomerCustomizersRequestDescriptor = $convert.base64Decode(
    ...
    'ZWFkcy52MTYuc2VydmljZXMuQ3VzdG9tZXJDdXN0b21pemVyT3BlcmF0aW9uQgPgQQJSCm9wZX'
...
const CustomerCustomizerOperation$json = {
  ...
  '2': [
    {'1': 'create', '3': 1, '4': 1, '5': 11, '6': '.google.ads.googleads.v16.resources.CustomerCustomizer', '9': 0, '10': 'create'},
...
final $typed_data.Uint8List customerCustomizerOperationDescriptor = $convert.base64Decode(
    ...
    'Fkcy5nb29nbGVhZHMudjE2LnJlc291cmNlcy5DdXN0b21lckN1c3RvbWl6ZXJIAFIGY3JlYXRl'
...
const MutateCustomerCustomizersResponse$json = {
  ...
  '2': [
    {'1': 'results', '3': 1, '4': 3, '5': 11, '6': '.google.ads.googleads.v16.services.MutateCustomerCustomizerResult', '10': 'results'},
...
final $typed_data.Uint8List mutateCustomerCustomizersResponseDescriptor = $convert.base64Decode(
    ...
    'dvb2dsZS5hZHMuZ29vZ2xlYWRzLnYxNi5zZXJ2aWNlcy5NdXRhdGVDdXN0b21lckN1c3RvbWl6'
...
const MutateCustomerCustomizerResult$json = {
  ...
  '2': [
    ...
    {'1': 'customer_customizer', '3': 2, '4': 1, '5': 11, '6': '.google.ads.googleads.v16.resources.CustomerCustomizer', '10': 'customerCustomizer'},
  ],
};
...
final $typed_data.Uint8List mutateCustomerCustomizerResultDescriptor = $convert.base64Decode(
    ...
    'xlYWRzLnYxNi5yZXNvdXJjZXMuQ3VzdG9tZXJDdXN0b21pemVyUhJjdXN0b21lckN1c3RvbWl6'
    'ZXI=');
