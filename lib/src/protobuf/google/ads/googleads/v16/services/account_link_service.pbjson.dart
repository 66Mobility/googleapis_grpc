...
const CreateAccountLinkRequest$json = {
  ...
  '2': [
    ...
    {'1': 'account_link', '3': 2, '4': 1, '5': 11, '6': '.google.ads.googleads.v16.resources.AccountLink', '8': {}, '10': 'accountLink'},
  ],
};
...
final $typed_data.Uint8List createAccountLinkRequestDescriptor = $convert.base64Decode(
    ...
    'MTYucmVzb3VyY2VzLkFjY291bnRMaW5rQgPgQQJSC2FjY291bnRMaW5r');
...
const MutateAccountLinkRequest$json = {
  ...
  '2': [
    {'1': 'customer_id', '3': 1, '4': 1, '5': 9, '8': {}, '10': 'customerId'},
    {'1': 'operation', '3': 2, '4': 1, '5': 11, '6': '.google.ads.googleads.v16.services.AccountLinkOperation', '8': {}, '10': 'operation'},
...
final $typed_data.Uint8List mutateAccountLinkRequestDescriptor = $convert.base64Decode(
    ...
    'VzdG9tZXJJZBJaCglvcGVyYXRpb24YAiABKAsyNy5nb29nbGUuYWRzLmdvb2dsZWFkcy52MTYu'
...
const AccountLinkOperation$json = {
  ...
  '2': [
    ...
    {'1': 'update', '3': 2, '4': 1, '5': 11, '6': '.google.ads.googleads.v16.resources.AccountLink', '9': 0, '10': 'update'},
...
final $typed_data.Uint8List accountLinkOperationDescriptor = $convert.base64Decode(
    ...
    'cy5nb29nbGVhZHMudjE2LnJlc291cmNlcy5BY2NvdW50TGlua0gAUgZ1cGRhdGUSQwoGcmVtb3'
...
const MutateAccountLinkResponse$json = {
  ...
  '2': [
    {'1': 'result', '3': 1, '4': 1, '5': 11, '6': '.google.ads.googleads.v16.services.MutateAccountLinkResult', '10': 'result'},
...
final $typed_data.Uint8List mutateAccountLinkResponseDescriptor = $convert.base64Decode(
    ...
    'MuZ29vZ2xlYWRzLnYxNi5zZXJ2aWNlcy5NdXRhdGVBY2NvdW50TGlua1Jlc3VsdFIGcmVzdWx0'
