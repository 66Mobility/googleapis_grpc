...
class MutateCustomerNegativeCriteriaRequest extends $pb.GeneratedMessage {
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(_omitMessageNames ? '' : 'MutateCustomerNegativeCriteriaRequest', package: const $pb.PackageName(_omitMessageNames ? '' : 'google.ads.googleads.v16.services'), createEmptyInstance: create)
...
class CustomerNegativeCriterionOperation extends $pb.GeneratedMessage {
  factory CustomerNegativeCriterionOperation({
    $3101.CustomerNegativeCriterion? create_1,
    $core.String? remove,
  }) {
    final $result = create();
    if (create_1 != null) {
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(_omitMessageNames ? '' : 'CustomerNegativeCriterionOperation', package: const $pb.PackageName(_omitMessageNames ? '' : 'google.ads.googleads.v16.services'), createEmptyInstance: create)
    ..oo(0, [1, 2])
    ..aOM<$3101.CustomerNegativeCriterion>(1, _omitFieldNames ? '' : 'create', subBuilder: $3101.CustomerNegativeCriterion.create)
  ...
  @$pb.TagNumber(1)
  $3101.CustomerNegativeCriterion get create_1 => $_getN(0);
  @$pb.TagNumber(1)
  set create_1($3101.CustomerNegativeCriterion v) { setField(1, v); }
  @$pb.TagNumber(1)
  $core.bool hasCreate_1() => $_has(0);
  @$pb.TagNumber(1)
  void clearCreate_1() => clearField(1);
  @$pb.TagNumber(1)
  $3101.CustomerNegativeCriterion ensureCreate_1() => $_ensure(0);
...
class MutateCustomerNegativeCriteriaResponse extends $pb.GeneratedMessage {
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(_omitMessageNames ? '' : 'MutateCustomerNegativeCriteriaResponse', package: const $pb.PackageName(_omitMessageNames ? '' : 'google.ads.googleads.v16.services'), createEmptyInstance: create)
...
class MutateCustomerNegativeCriteriaResult extends $pb.GeneratedMessage {
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(_omitMessageNames ? '' : 'MutateCustomerNegativeCriteriaResult', package: const $pb.PackageName(_omitMessageNames ? '' : 'google.ads.googleads.v16.services'), createEmptyInstance: create)
    ..aOS(1, _omitFieldNames ? '' : 'resourceName')
    ..aOM<$3101.CustomerNegativeCriterion>(2, _omitFieldNames ? '' : 'customerNegativeCriterion', subBuilder: $3101.CustomerNegativeCriterion.create)
    ..hasRequiredFields = false
  ;
  ...
  @$pb.TagNumber(2)
  $3101.CustomerNegativeCriterion get customerNegativeCriterion => $_getN(1);
  @$pb.TagNumber(2)
  set customerNegativeCriterion($3101.CustomerNegativeCriterion v) { setField(2, v); }
  @$pb.TagNumber(2)
  $core.bool hasCustomerNegativeCriterion() => $_has(1);
  @$pb.TagNumber(2)
  void clearCustomerNegativeCriterion() => clearField(2);
  @$pb.TagNumber(2)
  $3101.CustomerNegativeCriterion ensureCustomerNegativeCriterion() => $_ensure(1);
}
