...
import '../enums/identity_verification_program.pbenum.dart' as $3227;
import '../enums/identity_verification_program_status.pbenum.dart' as $3228;
...
class StartIdentityVerificationRequest extends $pb.GeneratedMessage {
  factory StartIdentityVerificationRequest({
    ...
    $3227.IdentityVerificationProgramEnum_IdentityVerificationProgram? verificationProgram,
  }) {
    final $result = create();
    if (customerId != null) {
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(_omitMessageNames ? '' : 'StartIdentityVerificationRequest', package: const $pb.PackageName(_omitMessageNames ? '' : 'google.ads.googleads.v16.services'), createEmptyInstance: create)
    ..aOS(1, _omitFieldNames ? '' : 'customerId')
    ..e<$3227.IdentityVerificationProgramEnum_IdentityVerificationProgram>(2, _omitFieldNames ? '' : 'verificationProgram', $pb.PbFieldType.OE, defaultOrMaker: $3227.IdentityVerificationProgramEnum_IdentityVerificationProgram.UNSPECIFIED, valueOf: $3227.IdentityVerificationProgramEnum_IdentityVerificationProgram.valueOf, enumValues: $3227.IdentityVerificationProgramEnum_IdentityVerificationProgram.values)
  ...
  /// verification.
  @$pb.TagNumber(2)
  $3227.IdentityVerificationProgramEnum_IdentityVerificationProgram get verificationProgram => $_getN(1);
  @$pb.TagNumber(2)
  set verificationProgram($3227.IdentityVerificationProgramEnum_IdentityVerificationProgram v) { setField(2, v); }
  @$pb.TagNumber(2)
...
class GetIdentityVerificationRequest extends $pb.GeneratedMessage {
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(_omitMessageNames ? '' : 'GetIdentityVerificationRequest', package: const $pb.PackageName(_omitMessageNames ? '' : 'google.ads.googleads.v16.services'), createEmptyInstance: create)
    ..aOS(1, _omitFieldNames ? '' : 'customerId')
    ..hasRequiredFields = false
  ;
...
class GetIdentityVerificationResponse extends $pb.GeneratedMessage {
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(_omitMessageNames ? '' : 'GetIdentityVerificationResponse', package: const $pb.PackageName(_omitMessageNames ? '' : 'google.ads.googleads.v16.services'), createEmptyInstance: create)
...
class IdentityVerification extends $pb.GeneratedMessage {
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(_omitMessageNames ? '' : 'IdentityVerification', package: const $pb.PackageName(_omitMessageNames ? '' : 'google.ads.googleads.v16.services'), createEmptyInstance: create)
    ..e<$3227.IdentityVerificationProgramEnum_IdentityVerificationProgram>(1, _omitFieldNames ? '' : 'verificationProgram', $pb.PbFieldType.OE, defaultOrMaker: $3227.IdentityVerificationProgramEnum_IdentityVerificationProgram.UNSPECIFIED, valueOf: $3227.IdentityVerificationProgramEnum_IdentityVerificationProgram.valueOf, enumValues: $3227.IdentityVerificationProgramEnum_IdentityVerificationProgram.values)
  ...
  @$pb.TagNumber(1)
  $3227.IdentityVerificationProgramEnum_IdentityVerificationProgram get verificationProgram => $_getN(0);
  @$pb.TagNumber(1)
  set verificationProgram($3227.IdentityVerificationProgramEnum_IdentityVerificationProgram v) { setField(1, v); }
  @$pb.TagNumber(1)
...
class IdentityVerificationProgress extends $pb.GeneratedMessage {
  factory IdentityVerificationProgress({
    $3228.IdentityVerificationProgramStatusEnum_IdentityVerificationProgramStatus? programStatus,
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(_omitMessageNames ? '' : 'IdentityVerificationProgress', package: const $pb.PackageName(_omitMessageNames ? '' : 'google.ads.googleads.v16.services'), createEmptyInstance: create)
    ..e<$3228.IdentityVerificationProgramStatusEnum_IdentityVerificationProgramStatus>(1, _omitFieldNames ? '' : 'programStatus', $pb.PbFieldType.OE, defaultOrMaker: $3228.IdentityVerificationProgramStatusEnum_IdentityVerificationProgramStatus.UNSPECIFIED, valueOf: $3228.IdentityVerificationProgramStatusEnum_IdentityVerificationProgramStatus.valueOf, enumValues: $3228.IdentityVerificationProgramStatusEnum_IdentityVerificationProgramStatus.values)
  ...
  @$pb.TagNumber(1)
  $3228.IdentityVerificationProgramStatusEnum_IdentityVerificationProgramStatus get programStatus => $_getN(0);
  @$pb.TagNumber(1)
  set programStatus($3228.IdentityVerificationProgramStatusEnum_IdentityVerificationProgramStatus v) { setField(1, v); }
  @$pb.TagNumber(1)
...
class IdentityVerificationRequirement extends $pb.GeneratedMessage {
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(_omitMessageNames ? '' : 'IdentityVerificationRequirement', package: const $pb.PackageName(_omitMessageNames ? '' : 'google.ads.googleads.v16.services'), createEmptyInstance: create)
