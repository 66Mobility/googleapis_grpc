...
const MutateCampaignDraftsRequest$json = {
  ...
  '2': [
    ...
    {'1': 'operations', '3': 2, '4': 3, '5': 11, '6': '.google.ads.googleads.v16.services.CampaignDraftOperation', '8': {}, '10': 'operations'},
...
final $typed_data.Uint8List mutateCampaignDraftsRequestDescriptor = $convert.base64Decode(
    ...
    'djE2LnNlcnZpY2VzLkNhbXBhaWduRHJhZnRPcGVyYXRpb25CA+BBAlIKb3BlcmF0aW9ucxInCg'
...
const CampaignDraftOperation$json = {
  ...
  '2': [
    ...
    {'1': 'create', '3': 1, '4': 1, '5': 11, '6': '.google.ads.googleads.v16.resources.CampaignDraft', '9': 0, '10': 'create'},
    {'1': 'update', '3': 2, '4': 1, '5': 11, '6': '.google.ads.googleads.v16.resources.CampaignDraft', '9': 0, '10': 'update'},
...
final $typed_data.Uint8List campaignDraftOperationDescriptor = $convert.base64Decode(
    ...
    'YWRzLmdvb2dsZWFkcy52MTYucmVzb3VyY2VzLkNhbXBhaWduRHJhZnRIAFIGY3JlYXRlEksKBn'
...
const MutateCampaignDraftsResponse$json = {
  ...
  '2': [
    ...
    {'1': 'results', '3': 2, '4': 3, '5': 11, '6': '.google.ads.googleads.v16.services.MutateCampaignDraftResult', '10': 'results'},
  ],
};
...
const MutateCampaignDraftResult$json = {
  ...
  '2': [
    ...
    {'1': 'campaign_draft', '3': 2, '4': 1, '5': 11, '6': '.google.ads.googleads.v16.resources.CampaignDraft', '10': 'campaignDraft'},
  ],
};
...
final $typed_data.Uint8List mutateCampaignDraftResultDescriptor = $convert.base64Decode(
    ...
    'Cg5jYW1wYWlnbl9kcmFmdBgCIAEoCzIxLmdvb2dsZS5hZHMuZ29vZ2xlYWRzLnYxNi5yZXNvdX'
