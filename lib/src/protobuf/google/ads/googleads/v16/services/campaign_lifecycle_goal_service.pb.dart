...
class CampaignLifecycleGoalOperation extends $pb.GeneratedMessage {
  factory CampaignLifecycleGoalOperation({
    $3215.CampaignLifecycleGoal? create_1,
    $2209.FieldMask? updateMask,
    $3215.CampaignLifecycleGoal? update,
  }) {
    final $result = create();
    if (create_1 != null) {
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(_omitMessageNames ? '' : 'CampaignLifecycleGoalOperation', package: const $pb.PackageName(_omitMessageNames ? '' : 'google.ads.googleads.v16.services'), createEmptyInstance: create)
    ..oo(0, [1, 3])
    ..aOM<$3215.CampaignLifecycleGoal>(1, _omitFieldNames ? '' : 'create', subBuilder: $3215.CampaignLifecycleGoal.create)
    ..aOM<$2209.FieldMask>(2, _omitFieldNames ? '' : 'updateMask', subBuilder: $2209.FieldMask.create)
    ..aOM<$3215.CampaignLifecycleGoal>(3, _omitFieldNames ? '' : 'update', subBuilder: $3215.CampaignLifecycleGoal.create)
    ..hasRequiredFields = false
  ;
  ...
  @$pb.TagNumber(1)
  $3215.CampaignLifecycleGoal get create_1 => $_getN(0);
  @$pb.TagNumber(1)
  set create_1($3215.CampaignLifecycleGoal v) { setField(1, v); }
  @$pb.TagNumber(1)
  $core.bool hasCreate_1() => $_has(0);
  @$pb.TagNumber(1)
  void clearCreate_1() => clearField(1);
  @$pb.TagNumber(1)
  $3215.CampaignLifecycleGoal ensureCreate_1() => $_ensure(0);
  ...
  @$pb.TagNumber(3)
  $3215.CampaignLifecycleGoal get update => $_getN(2);
  @$pb.TagNumber(3)
  set update($3215.CampaignLifecycleGoal v) { setField(3, v); }
  @$pb.TagNumber(3)
  $core.bool hasUpdate() => $_has(2);
  @$pb.TagNumber(3)
  void clearUpdate() => clearField(3);
  @$pb.TagNumber(3)
  $3215.CampaignLifecycleGoal ensureUpdate() => $_ensure(2);
}
