...
class MutateCustomerClientLinkRequest extends $pb.GeneratedMessage {
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(_omitMessageNames ? '' : 'MutateCustomerClientLinkRequest', package: const $pb.PackageName(_omitMessageNames ? '' : 'google.ads.googleads.v16.services'), createEmptyInstance: create)
...
class CustomerClientLinkOperation extends $pb.GeneratedMessage {
  factory CustomerClientLinkOperation({
    $3146.CustomerClientLink? create_1,
    $3146.CustomerClientLink? update,
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(_omitMessageNames ? '' : 'CustomerClientLinkOperation', package: const $pb.PackageName(_omitMessageNames ? '' : 'google.ads.googleads.v16.services'), createEmptyInstance: create)
    ..oo(0, [1, 2])
    ..aOM<$3146.CustomerClientLink>(1, _omitFieldNames ? '' : 'create', subBuilder: $3146.CustomerClientLink.create)
    ..aOM<$3146.CustomerClientLink>(2, _omitFieldNames ? '' : 'update', subBuilder: $3146.CustomerClientLink.create)
  ...
  @$pb.TagNumber(1)
  $3146.CustomerClientLink get create_1 => $_getN(0);
  @$pb.TagNumber(1)
  set create_1($3146.CustomerClientLink v) { setField(1, v); }
  @$pb.TagNumber(1)
  $core.bool hasCreate_1() => $_has(0);
  @$pb.TagNumber(1)
  void clearCreate_1() => clearField(1);
  @$pb.TagNumber(1)
  $3146.CustomerClientLink ensureCreate_1() => $_ensure(0);

  /// Update operation: The link is expected to have a valid resource name.
  @$pb.TagNumber(2)
  $3146.CustomerClientLink get update => $_getN(1);
  @$pb.TagNumber(2)
  set update($3146.CustomerClientLink v) { setField(2, v); }
  @$pb.TagNumber(2)
  $core.bool hasUpdate() => $_has(1);
  @$pb.TagNumber(2)
  void clearUpdate() => clearField(2);
  @$pb.TagNumber(2)
  $3146.CustomerClientLink ensureUpdate() => $_ensure(1);
...
class MutateCustomerClientLinkResponse extends $pb.GeneratedMessage {
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(_omitMessageNames ? '' : 'MutateCustomerClientLinkResponse', package: const $pb.PackageName(_omitMessageNames ? '' : 'google.ads.googleads.v16.services'), createEmptyInstance: create)
...
class MutateCustomerClientLinkResult extends $pb.GeneratedMessage {
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(_omitMessageNames ? '' : 'MutateCustomerClientLinkResult', package: const $pb.PackageName(_omitMessageNames ? '' : 'google.ads.googleads.v16.services'), createEmptyInstance: create)
