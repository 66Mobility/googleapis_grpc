...
const MutateAdGroupCriterionCustomizersRequest$json = {
  ...
  '2': [
    ...
    {'1': 'operations', '3': 2, '4': 3, '5': 11, '6': '.google.ads.googleads.v16.services.AdGroupCriterionCustomizerOperation', '8': {}, '10': 'operations'},
...
final $typed_data.Uint8List mutateAdGroupCriterionCustomizersRequestDescriptor = $convert.base64Decode(
    ...
    'ZHMuZ29vZ2xlYWRzLnYxNi5zZXJ2aWNlcy5BZEdyb3VwQ3JpdGVyaW9uQ3VzdG9taXplck9wZX'
    ...
    'NlX2NvbnRlbnRfdHlwZRgFIAEoDjJLLmdvb2dsZS5hZHMuZ29vZ2xlYWRzLnYxNi5lbnVtcy5S'
...
const AdGroupCriterionCustomizerOperation$json = {
  ...
  '2': [
    {'1': 'create', '3': 1, '4': 1, '5': 11, '6': '.google.ads.googleads.v16.resources.AdGroupCriterionCustomizer', '9': 0, '10': 'create'},
...
final $typed_data.Uint8List adGroupCriterionCustomizerOperationDescriptor = $convert.base64Decode(
    ...
    '5nb29nbGUuYWRzLmdvb2dsZWFkcy52MTYucmVzb3VyY2VzLkFkR3JvdXBDcml0ZXJpb25DdXN0'
...
const MutateAdGroupCriterionCustomizersResponse$json = {
  ...
  '2': [
    {'1': 'results', '3': 1, '4': 3, '5': 11, '6': '.google.ads.googleads.v16.services.MutateAdGroupCriterionCustomizerResult', '10': 'results'},
...
final $typed_data.Uint8List mutateAdGroupCriterionCustomizersResponseDescriptor = $convert.base64Decode(
    ...
    'EgAygLMkkuZ29vZ2xlLmFkcy5nb29nbGVhZHMudjE2LnNlcnZpY2VzLk11dGF0ZUFkR3JvdXBD'
...
const MutateAdGroupCriterionCustomizerResult$json = {
  ...
  '2': [
    ...
    {'1': 'ad_group_criterion_customizer', '3': 2, '4': 1, '5': 11, '6': '.google.ads.googleads.v16.resources.AdGroupCriterionCustomizer', '10': 'adGroupCriterionCustomizer'},
  ],
};
...
final $typed_data.Uint8List mutateAdGroupCriterionCustomizerResultDescriptor = $convert.base64Decode(
    ...
    'plchgCIAEoCzI+Lmdvb2dsZS5hZHMuZ29vZ2xlYWRzLnYxNi5yZXNvdXJjZXMuQWRHcm91cENy'
