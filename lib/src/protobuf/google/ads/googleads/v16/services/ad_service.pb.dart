...
class GetAdRequest extends $pb.GeneratedMessage {
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(_omitMessageNames ? '' : 'GetAdRequest', package: const $pb.PackageName(_omitMessageNames ? '' : 'google.ads.googleads.v16.services'), createEmptyInstance: create)
  ...
  'Will be removed in next major version')
  GetAdRequest copyWith(void Function(GetAdRequest) updates) => super.copyWith((message) => updates(message as GetAdRequest)) as GetAdRequest;
...
class MutateAdsRequest extends $pb.GeneratedMessage {
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(_omitMessageNames ? '' : 'MutateAdsRequest', package: const $pb.PackageName(_omitMessageNames ? '' : 'google.ads.googleads.v16.services'), createEmptyInstance: create)
...
class AdOperation extends $pb.GeneratedMessage {
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(_omitMessageNames ? '' : 'AdOperation', package: const $pb.PackageName(_omitMessageNames ? '' : 'google.ads.googleads.v16.services'), createEmptyInstance: create)
    ..oo(0, [1])
    ..aOM<$153.Ad>(1, _omitFieldNames ? '' : 'update', subBuilder: $153.Ad.create)
    ..aOM<$2210.FieldMask>(2, _omitFieldNames ? '' : 'updateMask', subBuilder: $2210.FieldMask.create)
    ..aOM<$2526.PolicyValidationParameter>(3, _omitFieldNames ? '' : 'policyValidationParameter', subBuilder: $2526.PolicyValidationParameter.create)
    ..hasRequiredFields = false
  ;
  ...
  @$pb.TagNumber(1)
  $153.Ad get update => $_getN(0);
  @$pb.TagNumber(1)
  set update($153.Ad v) { setField(1, v); }
  @$pb.TagNumber(1)
  $core.bool hasUpdate() => $_has(0);
  @$pb.TagNumber(1)
  void clearUpdate() => clearField(1);
  @$pb.TagNumber(1)
  $153.Ad ensureUpdate() => $_ensure(0);
  ...
  @$pb.TagNumber(3)
  $2526.PolicyValidationParameter get policyValidationParameter => $_getN(2);
  @$pb.TagNumber(3)
  set policyValidationParameter($2526.PolicyValidationParameter v) { setField(3, v); }
  @$pb.TagNumber(3)
  $core.bool hasPolicyValidationParameter() => $_has(2);
  @$pb.TagNumber(3)
  void clearPolicyValidationParameter() => clearField(3);
  @$pb.TagNumber(3)
  $2526.PolicyValidationParameter ensurePolicyValidationParameter() => $_ensure(2);
}
...
class MutateAdsResponse extends $pb.GeneratedMessage {
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(_omitMessageNames ? '' : 'MutateAdsResponse', package: const $pb.PackageName(_omitMessageNames ? '' : 'google.ads.googleads.v16.services'), createEmptyInstance: create)
...
class MutateAdResult extends $pb.GeneratedMessage {
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(_omitMessageNames ? '' : 'MutateAdResult', package: const $pb.PackageName(_omitMessageNames ? '' : 'google.ads.googleads.v16.services'), createEmptyInstance: create)
    ..aOS(1, _omitFieldNames ? '' : 'resourceName')
    ..aOM<$153.Ad>(2, _omitFieldNames ? '' : 'ad', subBuilder: $153.Ad.create)
    ..hasRequiredFields = false
  ;
  ...
  @$pb.TagNumber(2)
  $153.Ad get ad => $_getN(1);
  @$pb.TagNumber(2)
  set ad($153.Ad v) { setField(2, v); }
  @$pb.TagNumber(2)
  $core.bool hasAd() => $_has(1);
  @$pb.TagNumber(2)
  void clearAd() => clearField(2);
  @$pb.TagNumber(2)
  $153.Ad ensureAd() => $_ensure(1);
}
