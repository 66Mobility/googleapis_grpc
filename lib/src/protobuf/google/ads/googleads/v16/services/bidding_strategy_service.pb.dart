...
class MutateBiddingStrategiesRequest extends $pb.GeneratedMessage {
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(_omitMessageNames ? '' : 'MutateBiddingStrategiesRequest', package: const $pb.PackageName(_omitMessageNames ? '' : 'google.ads.googleads.v16.services'), createEmptyInstance: create)
...
class BiddingStrategyOperation extends $pb.GeneratedMessage {
  factory BiddingStrategyOperation({
    $3082.BiddingStrategy? create_1,
    $3082.BiddingStrategy? update,
    $core.String? remove,
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(_omitMessageNames ? '' : 'BiddingStrategyOperation', package: const $pb.PackageName(_omitMessageNames ? '' : 'google.ads.googleads.v16.services'), createEmptyInstance: create)
    ..oo(0, [1, 2, 3])
    ..aOM<$3082.BiddingStrategy>(1, _omitFieldNames ? '' : 'create', subBuilder: $3082.BiddingStrategy.create)
    ..aOM<$3082.BiddingStrategy>(2, _omitFieldNames ? '' : 'update', subBuilder: $3082.BiddingStrategy.create)
  ...
  /// strategy.
  @$pb.TagNumber(1)
  $3082.BiddingStrategy get create_1 => $_getN(0);
  @$pb.TagNumber(1)
  set create_1($3082.BiddingStrategy v) { setField(1, v); }
  @$pb.TagNumber(1)
  $core.bool hasCreate_1() => $_has(0);
  @$pb.TagNumber(1)
  void clearCreate_1() => clearField(1);
  @$pb.TagNumber(1)
  $3082.BiddingStrategy ensureCreate_1() => $_ensure(0);

  /// Update operation: The bidding strategy is expected to have a valid
  /// resource name.
  @$pb.TagNumber(2)
  $3082.BiddingStrategy get update => $_getN(1);
  @$pb.TagNumber(2)
  set update($3082.BiddingStrategy v) { setField(2, v); }
  @$pb.TagNumber(2)
  $core.bool hasUpdate() => $_has(1);
  @$pb.TagNumber(2)
  void clearUpdate() => clearField(2);
  @$pb.TagNumber(2)
  $3082.BiddingStrategy ensureUpdate() => $_ensure(1);
...
class MutateBiddingStrategiesResponse extends $pb.GeneratedMessage {
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(_omitMessageNames ? '' : 'MutateBiddingStrategiesResponse', package: const $pb.PackageName(_omitMessageNames ? '' : 'google.ads.googleads.v16.services'), createEmptyInstance: create)
...
class MutateBiddingStrategyResult extends $pb.GeneratedMessage {
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(_omitMessageNames ? '' : 'MutateBiddingStrategyResult', package: const $pb.PackageName(_omitMessageNames ? '' : 'google.ads.googleads.v16.services'), createEmptyInstance: create)
    ..aOS(1, _omitFieldNames ? '' : 'resourceName')
    ..aOM<$3082.BiddingStrategy>(2, _omitFieldNames ? '' : 'biddingStrategy', subBuilder: $3082.BiddingStrategy.create)
    ..hasRequiredFields = false
  ;
  ...
  /// "MUTABLE_RESOURCE".
  @$pb.TagNumber(2)
  $3082.BiddingStrategy get biddingStrategy => $_getN(1);
  @$pb.TagNumber(2)
  set biddingStrategy($3082.BiddingStrategy v) { setField(2, v); }
  @$pb.TagNumber(2)
  $core.bool hasBiddingStrategy() => $_has(1);
  @$pb.TagNumber(2)
  void clearBiddingStrategy() => clearField(2);
  @$pb.TagNumber(2)
  $3082.BiddingStrategy ensureBiddingStrategy() => $_ensure(1);
}
