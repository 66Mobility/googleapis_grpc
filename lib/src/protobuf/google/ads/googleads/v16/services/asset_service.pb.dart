...
class MutateAssetsRequest extends $pb.GeneratedMessage {
  ...
  @$pb.TagNumber(3)
  $3065.ResponseContentTypeEnum_ResponseContentType get responseContentType => $_getN(2);
  @$pb.TagNumber(3)
  set responseContentType($3065.ResponseContentTypeEnum_ResponseContentType v) { setField(3, v); }
  @$pb.TagNumber(3)
...
class AssetOperation extends $pb.GeneratedMessage {
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(_omitMessageNames ? '' : 'AssetOperation', package: const $pb.PackageName(_omitMessageNames ? '' : 'google.ads.googleads.v16.services'), createEmptyInstance: create)
    ..oo(0, [1, 2])
    ..aOM<$2929.Asset>(1, _omitFieldNames ? '' : 'create', subBuilder: $2929.Asset.create)
    ..aOM<$2929.Asset>(2, _omitFieldNames ? '' : 'update', subBuilder: $2929.Asset.create)
  ...
  @$pb.TagNumber(1)
  $2929.Asset get create_1 => $_getN(0);
  @$pb.TagNumber(1)
  set create_1($2929.Asset v) { setField(1, v); }
  @$pb.TagNumber(1)
  $core.bool hasCreate_1() => $_has(0);
  @$pb.TagNumber(1)
  void clearCreate_1() => clearField(1);
  @$pb.TagNumber(1)
  $2929.Asset ensureCreate_1() => $_ensure(0);
  ...
  @$pb.TagNumber(2)
  $2929.Asset get update => $_getN(1);
  @$pb.TagNumber(2)
  set update($2929.Asset v) { setField(2, v); }
  @$pb.TagNumber(2)
  $core.bool hasUpdate() => $_has(1);
  @$pb.TagNumber(2)
  void clearUpdate() => clearField(2);
  @$pb.TagNumber(2)
  $2929.Asset ensureUpdate() => $_ensure(1);
...
class MutateAssetResult extends $pb.GeneratedMessage {
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(_omitMessageNames ? '' : 'MutateAssetResult', package: const $pb.PackageName(_omitMessageNames ? '' : 'google.ads.googleads.v16.services'), createEmptyInstance: create)
    ...
    ..aOM<$2929.Asset>(2, _omitFieldNames ? '' : 'asset', subBuilder: $2929.Asset.create)
    ..hasRequiredFields = false
  ;
  ...
  @$pb.TagNumber(2)
  $2929.Asset get asset => $_getN(1);
  @$pb.TagNumber(2)
  set asset($2929.Asset v) { setField(2, v); }
  @$pb.TagNumber(2)
  $core.bool hasAsset() => $_has(1);
  @$pb.TagNumber(2)
  void clearAsset() => clearField(2);
  @$pb.TagNumber(2)
  $2929.Asset ensureAsset() => $_ensure(1);
}
