...
const MutateCampaignAssetSetsRequest$json = {
  ...
  '2': [
    ...
    {'1': 'operations', '3': 2, '4': 3, '5': 11, '6': '.google.ads.googleads.v16.services.CampaignAssetSetOperation', '8': {}, '10': 'operations'},
...
final $typed_data.Uint8List mutateCampaignAssetSetsRequestDescriptor = $convert.base64Decode(
    ...
    'ZHMudjE2LnNlcnZpY2VzLkNhbXBhaWduQXNzZXRTZXRPcGVyYXRpb25CA+BBAlIKb3BlcmF0aW'
...
const CampaignAssetSetOperation$json = {
  ...
  '2': [
    {'1': 'create', '3': 1, '4': 1, '5': 11, '6': '.google.ads.googleads.v16.resources.CampaignAssetSet', '9': 0, '10': 'create'},
...
final $typed_data.Uint8List campaignAssetSetOperationDescriptor = $convert.base64Decode(
    ...
    'MuZ29vZ2xlYWRzLnYxNi5yZXNvdXJjZXMuQ2FtcGFpZ25Bc3NldFNldEgAUgZjcmVhdGUSSAoG'
...
const MutateCampaignAssetSetsResponse$json = {
  ...
  '2': [
    {'1': 'results', '3': 1, '4': 3, '5': 11, '6': '.google.ads.googleads.v16.services.MutateCampaignAssetSetResult', '10': 'results'},
...
final $typed_data.Uint8List mutateCampaignAssetSetsResponseDescriptor = $convert.base64Decode(
    ...
    '9nbGUuYWRzLmdvb2dsZWFkcy52MTYuc2VydmljZXMuTXV0YXRlQ2FtcGFpZ25Bc3NldFNldFJl'
...
const MutateCampaignAssetSetResult$json = {
  ...
  '2': [
    ...
    {'1': 'campaign_asset_set', '3': 2, '4': 1, '5': 11, '6': '.google.ads.googleads.v16.resources.CampaignAssetSet', '10': 'campaignAssetSet'},
  ],
};
...
final $typed_data.Uint8List mutateCampaignAssetSetResultDescriptor = $convert.base64Decode(
    ...
    '52MTYucmVzb3VyY2VzLkNhbXBhaWduQXNzZXRTZXRSEGNhbXBhaWduQXNzZXRTZXQ=');
