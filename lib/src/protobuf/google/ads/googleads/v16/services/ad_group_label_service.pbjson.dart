...
const MutateAdGroupLabelsRequest$json = {
  ...
  '2': [
    ...
    {'1': 'operations', '3': 2, '4': 3, '5': 11, '6': '.google.ads.googleads.v16.services.AdGroupLabelOperation', '8': {}, '10': 'operations'},
...
final $typed_data.Uint8List mutateAdGroupLabelsRequestDescriptor = $convert.base64Decode(
    ...
    'MTYuc2VydmljZXMuQWRHcm91cExhYmVsT3BlcmF0aW9uQgPgQQJSCm9wZXJhdGlvbnMSJwoPcG'
...
const AdGroupLabelOperation$json = {
  ...
  '2': [
    {'1': 'create', '3': 1, '4': 1, '5': 11, '6': '.google.ads.googleads.v16.resources.AdGroupLabel', '9': 0, '10': 'create'},
...
final $typed_data.Uint8List adGroupLabelOperationDescriptor = $convert.base64Decode(
    ...
    '9nbGVhZHMudjE2LnJlc291cmNlcy5BZEdyb3VwTGFiZWxIAFIGY3JlYXRlEkQKBnJlbW92ZRgC'
...
const MutateAdGroupLabelsResponse$json = {
  ...
  '2': [
    ...
    {'1': 'results', '3': 2, '4': 3, '5': 11, '6': '.google.ads.googleads.v16.services.MutateAdGroupLabelResult', '10': 'results'},
  ],
};
