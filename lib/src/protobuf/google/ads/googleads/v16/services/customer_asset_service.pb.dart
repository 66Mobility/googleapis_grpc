...
class CustomerAssetOperation extends $pb.GeneratedMessage {
  factory CustomerAssetOperation({
    $2931.CustomerAsset? create_1,
    $core.String? remove,
    $2931.CustomerAsset? update,
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(_omitMessageNames ? '' : 'CustomerAssetOperation', package: const $pb.PackageName(_omitMessageNames ? '' : 'google.ads.googleads.v16.services'), createEmptyInstance: create)
    ..oo(0, [1, 2, 3])
    ..aOM<$2931.CustomerAsset>(1, _omitFieldNames ? '' : 'create', subBuilder: $2931.CustomerAsset.create)
    ..aOS(2, _omitFieldNames ? '' : 'remove')
    ..aOM<$2931.CustomerAsset>(3, _omitFieldNames ? '' : 'update', subBuilder: $2931.CustomerAsset.create)
  ...
  /// asset.
  @$pb.TagNumber(1)
  $2931.CustomerAsset get create_1 => $_getN(0);
  @$pb.TagNumber(1)
  set create_1($2931.CustomerAsset v) { setField(1, v); }
  @$pb.TagNumber(1)
  $core.bool hasCreate_1() => $_has(0);
  @$pb.TagNumber(1)
  void clearCreate_1() => clearField(1);
  @$pb.TagNumber(1)
  $2931.CustomerAsset ensureCreate_1() => $_ensure(0);
  ...
  /// name.
  @$pb.TagNumber(3)
  $2931.CustomerAsset get update => $_getN(2);
  @$pb.TagNumber(3)
  set update($2931.CustomerAsset v) { setField(3, v); }
  @$pb.TagNumber(3)
  $core.bool hasUpdate() => $_has(2);
  @$pb.TagNumber(3)
  void clearUpdate() => clearField(3);
  @$pb.TagNumber(3)
  $2931.CustomerAsset ensureUpdate() => $_ensure(2);
...
class MutateCustomerAssetResult extends $pb.GeneratedMessage {
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(_omitMessageNames ? '' : 'MutateCustomerAssetResult', package: const $pb.PackageName(_omitMessageNames ? '' : 'google.ads.googleads.v16.services'), createEmptyInstance: create)
    ...
    ..aOM<$2931.CustomerAsset>(2, _omitFieldNames ? '' : 'customerAsset', subBuilder: $2931.CustomerAsset.create)
    ..hasRequiredFields = false
  ;
  ...
  /// to "MUTABLE_RESOURCE".
  @$pb.TagNumber(2)
  $2931.CustomerAsset get customerAsset => $_getN(1);
  @$pb.TagNumber(2)
  set customerAsset($2931.CustomerAsset v) { setField(2, v); }
  @$pb.TagNumber(2)
  $core.bool hasCustomerAsset() => $_has(1);
  @$pb.TagNumber(2)
  void clearCustomerAsset() => clearField(2);
  @$pb.TagNumber(2)
  $2931.CustomerAsset ensureCustomerAsset() => $_ensure(1);
}
