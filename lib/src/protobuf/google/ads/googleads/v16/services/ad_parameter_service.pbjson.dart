...
const MutateAdParametersRequest$json = {
  ...
  '2': [
    ...
    {'1': 'operations', '3': 2, '4': 3, '5': 11, '6': '.google.ads.googleads.v16.services.AdParameterOperation', '8': {}, '10': 'operations'},
...
final $typed_data.Uint8List mutateAdParametersRequestDescriptor = $convert.base64Decode(
    ...
    'Ni5zZXJ2aWNlcy5BZFBhcmFtZXRlck9wZXJhdGlvbkID4EECUgpvcGVyYXRpb25zEicKD3Bhcn'
...
const AdParameterOperation$json = {
  ...
  '2': [
    ...
    {'1': 'create', '3': 1, '4': 1, '5': 11, '6': '.google.ads.googleads.v16.resources.AdParameter', '9': 0, '10': 'create'},
    {'1': 'update', '3': 2, '4': 1, '5': 11, '6': '.google.ads.googleads.v16.resources.AdParameter', '9': 0, '10': 'update'},
...
final $typed_data.Uint8List adParameterOperationDescriptor = $convert.base64Decode(
    ...
    'cy5nb29nbGVhZHMudjE2LnJlc291cmNlcy5BZFBhcmFtZXRlckgAUgZjcmVhdGUSSQoGdXBkYX'
    'RlGAIgASgLMi8uZ29vZ2xlLmFkcy5nb29nbGVhZHMudjE2LnJlc291cmNlcy5BZFBhcmFtZXRl'
...
const MutateAdParametersResponse$json = {
  ...
  '2': [
    ...
    {'1': 'results', '3': 2, '4': 3, '5': 11, '6': '.google.ads.googleads.v16.services.MutateAdParameterResult', '10': 'results'},
  ],
};
...
final $typed_data.Uint8List mutateAdParametersResponseDescriptor = $convert.base64Decode(
    ...
    'GAIgAygLMjouZ29vZ2xlLmFkcy5nb29nbGVhZHMudjE2LnNlcnZpY2VzLk11dGF0ZUFkUGFyYW'
...
const MutateAdParameterResult$json = {
  ...
  '2': [
    ...
    {'1': 'ad_parameter', '3': 2, '4': 1, '5': 11, '6': '.google.ads.googleads.v16.resources.AdParameter', '10': 'adParameter'},
  ],
};
...
final $typed_data.Uint8List mutateAdParameterResultDescriptor = $convert.base64Decode(
    ...
    'X3BhcmFtZXRlchgCIAEoCzIvLmdvb2dsZS5hZHMuZ29vZ2xlYWRzLnYxNi5yZXNvdXJjZXMuQW'
