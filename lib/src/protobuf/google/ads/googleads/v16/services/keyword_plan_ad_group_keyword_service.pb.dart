...
class KeywordPlanAdGroupKeywordOperation extends $pb.GeneratedMessage {
  factory KeywordPlanAdGroupKeywordOperation({
    $3112.KeywordPlanAdGroupKeyword? create_1,
    $3112.KeywordPlanAdGroupKeyword? update,
    $core.String? remove,
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(_omitMessageNames ? '' : 'KeywordPlanAdGroupKeywordOperation', package: const $pb.PackageName(_omitMessageNames ? '' : 'google.ads.googleads.v16.services'), createEmptyInstance: create)
    ..oo(0, [1, 2, 3])
    ..aOM<$3112.KeywordPlanAdGroupKeyword>(1, _omitFieldNames ? '' : 'create', subBuilder: $3112.KeywordPlanAdGroupKeyword.create)
    ..aOM<$3112.KeywordPlanAdGroupKeyword>(2, _omitFieldNames ? '' : 'update', subBuilder: $3112.KeywordPlanAdGroupKeyword.create)
  ...
  /// ad group keyword.
  @$pb.TagNumber(1)
  $3112.KeywordPlanAdGroupKeyword get create_1 => $_getN(0);
  @$pb.TagNumber(1)
  set create_1($3112.KeywordPlanAdGroupKeyword v) { setField(1, v); }
  @$pb.TagNumber(1)
  $core.bool hasCreate_1() => $_has(0);
  @$pb.TagNumber(1)
  void clearCreate_1() => clearField(1);
  @$pb.TagNumber(1)
  $3112.KeywordPlanAdGroupKeyword ensureCreate_1() => $_ensure(0);

  /// Update operation: The Keyword Plan ad group keyword is expected to have a
  /// valid resource name.
  @$pb.TagNumber(2)
  $3112.KeywordPlanAdGroupKeyword get update => $_getN(1);
  @$pb.TagNumber(2)
  set update($3112.KeywordPlanAdGroupKeyword v) { setField(2, v); }
  @$pb.TagNumber(2)
  $core.bool hasUpdate() => $_has(1);
  @$pb.TagNumber(2)
  void clearUpdate() => clearField(2);
  @$pb.TagNumber(2)
  $3112.KeywordPlanAdGroupKeyword ensureUpdate() => $_ensure(1);
