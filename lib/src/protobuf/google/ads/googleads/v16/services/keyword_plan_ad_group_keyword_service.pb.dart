...
class MutateKeywordPlanAdGroupKeywordsRequest extends $pb.GeneratedMessage {
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(_omitMessageNames ? '' : 'MutateKeywordPlanAdGroupKeywordsRequest', package: const $pb.PackageName(_omitMessageNames ? '' : 'google.ads.googleads.v16.services'), createEmptyInstance: create)
...
class KeywordPlanAdGroupKeywordOperation extends $pb.GeneratedMessage {
  factory KeywordPlanAdGroupKeywordOperation({
    $3111.KeywordPlanAdGroupKeyword? create_1,
    $3111.KeywordPlanAdGroupKeyword? update,
    $core.String? remove,
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(_omitMessageNames ? '' : 'KeywordPlanAdGroupKeywordOperation', package: const $pb.PackageName(_omitMessageNames ? '' : 'google.ads.googleads.v16.services'), createEmptyInstance: create)
    ..oo(0, [1, 2, 3])
    ..aOM<$3111.KeywordPlanAdGroupKeyword>(1, _omitFieldNames ? '' : 'create', subBuilder: $3111.KeywordPlanAdGroupKeyword.create)
    ..aOM<$3111.KeywordPlanAdGroupKeyword>(2, _omitFieldNames ? '' : 'update', subBuilder: $3111.KeywordPlanAdGroupKeyword.create)
  ...
  /// ad group keyword.
  @$pb.TagNumber(1)
  $3111.KeywordPlanAdGroupKeyword get create_1 => $_getN(0);
  @$pb.TagNumber(1)
  set create_1($3111.KeywordPlanAdGroupKeyword v) { setField(1, v); }
  @$pb.TagNumber(1)
  $core.bool hasCreate_1() => $_has(0);
  @$pb.TagNumber(1)
  void clearCreate_1() => clearField(1);
  @$pb.TagNumber(1)
  $3111.KeywordPlanAdGroupKeyword ensureCreate_1() => $_ensure(0);

  /// Update operation: The Keyword Plan ad group keyword is expected to have a
  /// valid resource name.
  @$pb.TagNumber(2)
  $3111.KeywordPlanAdGroupKeyword get update => $_getN(1);
  @$pb.TagNumber(2)
  set update($3111.KeywordPlanAdGroupKeyword v) { setField(2, v); }
  @$pb.TagNumber(2)
  $core.bool hasUpdate() => $_has(1);
  @$pb.TagNumber(2)
  void clearUpdate() => clearField(2);
  @$pb.TagNumber(2)
  $3111.KeywordPlanAdGroupKeyword ensureUpdate() => $_ensure(1);
...
class MutateKeywordPlanAdGroupKeywordsResponse extends $pb.GeneratedMessage {
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(_omitMessageNames ? '' : 'MutateKeywordPlanAdGroupKeywordsResponse', package: const $pb.PackageName(_omitMessageNames ? '' : 'google.ads.googleads.v16.services'), createEmptyInstance: create)
...
class MutateKeywordPlanAdGroupKeywordResult extends $pb.GeneratedMessage {
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(_omitMessageNames ? '' : 'MutateKeywordPlanAdGroupKeywordResult', package: const $pb.PackageName(_omitMessageNames ? '' : 'google.ads.googleads.v16.services'), createEmptyInstance: create)
