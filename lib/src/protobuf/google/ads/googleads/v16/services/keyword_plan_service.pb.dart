...
class KeywordPlanOperation extends $pb.GeneratedMessage {
  factory KeywordPlanOperation({
    $3115.KeywordPlan? create_1,
    $3115.KeywordPlan? update,
    $core.String? remove,
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(_omitMessageNames ? '' : 'KeywordPlanOperation', package: const $pb.PackageName(_omitMessageNames ? '' : 'google.ads.googleads.v16.services'), createEmptyInstance: create)
    ..oo(0, [1, 2, 3])
    ..aOM<$3115.KeywordPlan>(1, _omitFieldNames ? '' : 'create', subBuilder: $3115.KeywordPlan.create)
    ..aOM<$3115.KeywordPlan>(2, _omitFieldNames ? '' : 'update', subBuilder: $3115.KeywordPlan.create)
  ...
  @$pb.TagNumber(1)
  $3115.KeywordPlan get create_1 => $_getN(0);
  @$pb.TagNumber(1)
  set create_1($3115.KeywordPlan v) { setField(1, v); }
  @$pb.TagNumber(1)
  $core.bool hasCreate_1() => $_has(0);
  @$pb.TagNumber(1)
  void clearCreate_1() => clearField(1);
  @$pb.TagNumber(1)
  $3115.KeywordPlan ensureCreate_1() => $_ensure(0);

  /// Update operation: The keyword plan is expected to have a valid resource
  /// name.
  @$pb.TagNumber(2)
  $3115.KeywordPlan get update => $_getN(1);
  @$pb.TagNumber(2)
  set update($3115.KeywordPlan v) { setField(2, v); }
  @$pb.TagNumber(2)
  $core.bool hasUpdate() => $_has(1);
  @$pb.TagNumber(2)
  void clearUpdate() => clearField(2);
  @$pb.TagNumber(2)
  $3115.KeywordPlan ensureUpdate() => $_ensure(1);
