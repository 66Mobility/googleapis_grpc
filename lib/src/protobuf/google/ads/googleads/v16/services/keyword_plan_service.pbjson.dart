...
const MutateKeywordPlansRequest$json = {
  ...
  '2': [
    ...
    {'1': 'operations', '3': 2, '4': 3, '5': 11, '6': '.google.ads.googleads.v16.services.KeywordPlanOperation', '8': {}, '10': 'operations'},
...
final $typed_data.Uint8List mutateKeywordPlansRequestDescriptor = $convert.base64Decode(
    ...
    'Ni5zZXJ2aWNlcy5LZXl3b3JkUGxhbk9wZXJhdGlvbkID4EECUgpvcGVyYXRpb25zEicKD3Bhcn'
...
const KeywordPlanOperation$json = {
  ...
  '2': [
    ...
    {'1': 'create', '3': 1, '4': 1, '5': 11, '6': '.google.ads.googleads.v16.resources.KeywordPlan', '9': 0, '10': 'create'},
    {'1': 'update', '3': 2, '4': 1, '5': 11, '6': '.google.ads.googleads.v16.resources.KeywordPlan', '9': 0, '10': 'update'},
...
final $typed_data.Uint8List keywordPlanOperationDescriptor = $convert.base64Decode(
    ...
    'cy5nb29nbGVhZHMudjE2LnJlc291cmNlcy5LZXl3b3JkUGxhbkgAUgZjcmVhdGUSSQoGdXBkYX'
    'RlGAIgASgLMi8uZ29vZ2xlLmFkcy5nb29nbGVhZHMudjE2LnJlc291cmNlcy5LZXl3b3JkUGxh'
...
const MutateKeywordPlansResponse$json = {
  ...
  '2': [
    ...
    {'1': 'results', '3': 2, '4': 3, '5': 11, '6': '.google.ads.googleads.v16.services.MutateKeywordPlansResult', '10': 'results'},
  ],
};
...
final $typed_data.Uint8List mutateKeywordPlansResponseDescriptor = $convert.base64Decode(
    ...
    'GAIgAygLMjsuZ29vZ2xlLmFkcy5nb29nbGVhZHMudjE2LnNlcnZpY2VzLk11dGF0ZUtleXdvcm'
