...
const MutateKeywordPlanCampaignsRequest$json = {
  ...
  '2': [
    ...
    {'1': 'operations', '3': 2, '4': 3, '5': 11, '6': '.google.ads.googleads.v16.services.KeywordPlanCampaignOperation', '8': {}, '10': 'operations'},
...
final $typed_data.Uint8List mutateKeywordPlanCampaignsRequestDescriptor = $convert.base64Decode(
    ...
    'bGVhZHMudjE2LnNlcnZpY2VzLktleXdvcmRQbGFuQ2FtcGFpZ25PcGVyYXRpb25CA+BBAlIKb3'
...
const KeywordPlanCampaignOperation$json = {
  ...
  '2': [
    ...
    {'1': 'create', '3': 1, '4': 1, '5': 11, '6': '.google.ads.googleads.v16.resources.KeywordPlanCampaign', '9': 0, '10': 'create'},
    {'1': 'update', '3': 2, '4': 1, '5': 11, '6': '.google.ads.googleads.v16.resources.KeywordPlanCampaign', '9': 0, '10': 'update'},
...
final $typed_data.Uint8List keywordPlanCampaignOperationDescriptor = $convert.base64Decode(
    ...
    'b29nbGUuYWRzLmdvb2dsZWFkcy52MTYucmVzb3VyY2VzLktleXdvcmRQbGFuQ2FtcGFpZ25IAF'
...
const MutateKeywordPlanCampaignsResponse$json = {
  ...
  '2': [
    ...
    {'1': 'results', '3': 2, '4': 3, '5': 11, '6': '.google.ads.googleads.v16.services.MutateKeywordPlanCampaignResult', '10': 'results'},
  ],
};
