...
const MutateCustomerRequest$json = {
  ...
  '2': [
    ...
    {'1': 'operation', '3': 4, '4': 1, '5': 11, '6': '.google.ads.googleads.v16.services.CustomerOperation', '8': {}, '10': 'operation'},
    {'1': 'validate_only', '3': 5, '4': 1, '5': 8, '10': 'validateOnly'},
    {'1': 'response_content_type', '3': 6, '4': 1, '5': 14, '6': '.google.ads.googleads.v16.enums.ResponseContentTypeEnum.ResponseContentType', '10': 'responseContentType'},
  ],
};
...
final $typed_data.Uint8List mutateCustomerRequestDescriptor = $convert.base64Decode(
    ...
    '9tZXJJZBJXCglvcGVyYXRpb24YBCABKAsyNC5nb29nbGUuYWRzLmdvb2dsZWFkcy52MTYuc2Vy'
    ...
    'b29nbGUuYWRzLmdvb2dsZWFkcy52MTYuZW51bXMuUmVzcG9uc2VDb250ZW50VHlwZUVudW0uUm'
...
const CreateCustomerClientRequest$json = {
  ...
  '2': [
    {'1': 'customer_id', '3': 1, '4': 1, '5': 9, '8': {}, '10': 'customerId'},
    {'1': 'customer_client', '3': 2, '4': 1, '5': 11, '6': '.google.ads.googleads.v16.resources.Customer', '8': {}, '10': 'customerClient'},
    {'1': 'email_address', '3': 5, '4': 1, '5': 9, '9': 0, '10': 'emailAddress', '17': true},
    {'1': 'access_role', '3': 4, '4': 1, '5': 14, '6': '.google.ads.googleads.v16.enums.AccessRoleEnum.AccessRole', '10': 'accessRole'},
...
final $typed_data.Uint8List createCustomerClientRequestDescriptor = $convert.base64Decode(
    ...
    'ZWFkcy52MTYucmVzb3VyY2VzLkN1c3RvbWVyQgPgQQJSDmN1c3RvbWVyQ2xpZW50EigKDWVtYW'
    'lsX2FkZHJlc3MYBSABKAlIAFIMZW1haWxBZGRyZXNziAEBEloKC2FjY2Vzc19yb2xlGAQgASgO'
    'MjkuZ29vZ2xlLmFkcy5nb29nbGVhZHMudjE2LmVudW1zLkFjY2Vzc1JvbGVFbnVtLkFjY2Vzc1'
...
const CustomerOperation$json = {
  '1': 'CustomerOperation',
  '2': [
    {'1': 'update', '3': 1, '4': 1, '5': 11, '6': '.google.ads.googleads.v16.resources.Customer', '10': 'update'},
...
final $typed_data.Uint8List customerOperationDescriptor = $convert.base64Decode(
    ...
    'Fkcy52MTYucmVzb3VyY2VzLkN1c3RvbWVyUgZ1cGRhdGUSOwoLdXBkYXRlX21hc2sYAiABKAsy'
...
const MutateCustomerResponse$json = {
  ...
  '2': [
    {'1': 'result', '3': 2, '4': 1, '5': 11, '6': '.google.ads.googleads.v16.services.MutateCustomerResult', '10': 'result'},
  ],
};
...
final $typed_data.Uint8List mutateCustomerResponseDescriptor = $convert.base64Decode(
    ...
    '9vZ2xlYWRzLnYxNi5zZXJ2aWNlcy5NdXRhdGVDdXN0b21lclJlc3VsdFIGcmVzdWx0');
...
const MutateCustomerResult$json = {
  ...
  '2': [
    ...
    {'1': 'customer', '3': 2, '4': 1, '5': 11, '6': '.google.ads.googleads.v16.resources.Customer', '10': 'customer'},
  ],
};
...
final $typed_data.Uint8List mutateCustomerResultDescriptor = $convert.base64Decode(
    ...
    'GAIgASgLMiwuZ29vZ2xlLmFkcy5nb29nbGVhZHMudjE2LnJlc291cmNlcy5DdXN0b21lclIIY3'
    'VzdG9tZXI=');
