...
const MutateAssetSetsRequest$json = {
  ...
  '2': [
    ...
    {'1': 'operations', '3': 2, '4': 3, '5': 11, '6': '.google.ads.googleads.v16.services.AssetSetOperation', '8': {}, '10': 'operations'},
...
final $typed_data.Uint8List mutateAssetSetsRequestDescriptor = $convert.base64Decode(
    ...
    'RvbWVySWQSWQoKb3BlcmF0aW9ucxgCIAMoCzI0Lmdvb2dsZS5hZHMuZ29vZ2xlYWRzLnYxNi5z'
    ...
    '9vZ2xlYWRzLnYxNi5lbnVtcy5SZXNwb25zZUNvbnRlbnRUeXBlRW51bS5SZXNwb25zZUNvbnRl'
...
const AssetSetOperation$json = {
  ...
  '2': [
    ...
    {'1': 'create', '3': 1, '4': 1, '5': 11, '6': '.google.ads.googleads.v16.resources.AssetSet', '9': 0, '10': 'create'},
    {'1': 'update', '3': 2, '4': 1, '5': 11, '6': '.google.ads.googleads.v16.resources.AssetSet', '9': 0, '10': 'update'},
...
final $typed_data.Uint8List assetSetOperationDescriptor = $convert.base64Decode(
    ...
    'b29nbGVhZHMudjE2LnJlc291cmNlcy5Bc3NldFNldEgAUgZjcmVhdGUSRgoGdXBkYXRlGAIgAS'
    'gLMiwuZ29vZ2xlLmFkcy5nb29nbGVhZHMudjE2LnJlc291cmNlcy5Bc3NldFNldEgAUgZ1cGRh'
...
const MutateAssetSetsResponse$json = {
  ...
  '2': [
    {'1': 'results', '3': 1, '4': 3, '5': 11, '6': '.google.ads.googleads.v16.services.MutateAssetSetResult', '10': 'results'},
...
final $typed_data.Uint8List mutateAssetSetsResponseDescriptor = $convert.base64Decode(
    ...
    '5nb29nbGVhZHMudjE2LnNlcnZpY2VzLk11dGF0ZUFzc2V0U2V0UmVzdWx0UgdyZXN1bHRzEkYK'
...
const MutateAssetSetResult$json = {
  ...
  '2': [
    ...
    {'1': 'asset_set', '3': 2, '4': 1, '5': 11, '6': '.google.ads.googleads.v16.resources.AssetSet', '10': 'assetSet'},
  ],
};
...
final $typed_data.Uint8List mutateAssetSetResultDescriptor = $convert.base64Decode(
    ...
    'dBgCIAEoCzIsLmdvb2dsZS5hZHMuZ29vZ2xlYWRzLnYxNi5yZXNvdXJjZXMuQXNzZXRTZXRSCG'
    'Fzc2V0U2V0');
