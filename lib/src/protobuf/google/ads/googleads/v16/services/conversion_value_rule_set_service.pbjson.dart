...
const MutateConversionValueRuleSetsRequest$json = {
  ...
  '2': [
    ...
    {'1': 'operations', '3': 2, '4': 3, '5': 11, '6': '.google.ads.googleads.v16.services.ConversionValueRuleSetOperation', '8': {}, '10': 'operations'},
...
final $typed_data.Uint8List mutateConversionValueRuleSetsRequestDescriptor = $convert.base64Decode(
    ...
    'b29nbGVhZHMudjE2LnNlcnZpY2VzLkNvbnZlcnNpb25WYWx1ZVJ1bGVTZXRPcGVyYXRpb25CA+'
    ...
    '50X3R5cGUYBCABKA4ySy5nb29nbGUuYWRzLmdvb2dsZWFkcy52MTYuZW51bXMuUmVzcG9uc2VD'
...
const ConversionValueRuleSetOperation$json = {
  ...
  '2': [
    ...
    {'1': 'create', '3': 1, '4': 1, '5': 11, '6': '.google.ads.googleads.v16.resources.ConversionValueRuleSet', '9': 0, '10': 'create'},
    {'1': 'update', '3': 2, '4': 1, '5': 11, '6': '.google.ads.googleads.v16.resources.ConversionValueRuleSet', '9': 0, '10': 'update'},
...
final $typed_data.Uint8List conversionValueRuleSetOperationDescriptor = $convert.base64Decode(
    ...
    'Oi5nb29nbGUuYWRzLmdvb2dsZWFkcy52MTYucmVzb3VyY2VzLkNvbnZlcnNpb25WYWx1ZVJ1bG'
    'VTZXRIAFIGY3JlYXRlElQKBnVwZGF0ZRgCIAEoCzI6Lmdvb2dsZS5hZHMuZ29vZ2xlYWRzLnYx'
    'Ni5yZXNvdXJjZXMuQ29udmVyc2lvblZhbHVlUnVsZVNldEgAUgZ1cGRhdGUSTgoGcmVtb3ZlGA'
...
const MutateConversionValueRuleSetsResponse$json = {
  ...
  '2': [
    {'1': 'results', '3': 1, '4': 3, '5': 11, '6': '.google.ads.googleads.v16.services.MutateConversionValueRuleSetResult', '10': 'results'},
...
final $typed_data.Uint8List mutateConversionValueRuleSetsResponseDescriptor = $convert.base64Decode(
    ...
    'syRS5nb29nbGUuYWRzLmdvb2dsZWFkcy52MTYuc2VydmljZXMuTXV0YXRlQ29udmVyc2lvblZh'
...
const MutateConversionValueRuleSetResult$json = {
  ...
  '2': [
    ...
    {'1': 'conversion_value_rule_set', '3': 2, '4': 1, '5': 11, '6': '.google.ads.googleads.v16.resources.ConversionValueRuleSet', '10': 'conversionValueRuleSet'},
  ],
};
...
final $typed_data.Uint8List mutateConversionValueRuleSetResultDescriptor = $convert.base64Decode(
    ...
    '9vZ2xlLmFkcy5nb29nbGVhZHMudjE2LnJlc291cmNlcy5Db252ZXJzaW9uVmFsdWVSdWxlU2V0'
