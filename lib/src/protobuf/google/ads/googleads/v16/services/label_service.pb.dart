...
class MutateLabelsRequest extends $pb.GeneratedMessage {
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(_omitMessageNames ? '' : 'MutateLabelsRequest', package: const $pb.PackageName(_omitMessageNames ? '' : 'google.ads.googleads.v16.services'), createEmptyInstance: create)
...
class LabelOperation extends $pb.GeneratedMessage {
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(_omitMessageNames ? '' : 'LabelOperation', package: const $pb.PackageName(_omitMessageNames ? '' : 'google.ads.googleads.v16.services'), createEmptyInstance: create)
    ..oo(0, [1, 2, 3])
    ..aOM<$3117.Label>(1, _omitFieldNames ? '' : 'create', subBuilder: $3117.Label.create)
    ..aOM<$3117.Label>(2, _omitFieldNames ? '' : 'update', subBuilder: $3117.Label.create)
  ...
  @$pb.TagNumber(1)
  $3117.Label get create_1 => $_getN(0);
  @$pb.TagNumber(1)
  set create_1($3117.Label v) { setField(1, v); }
  @$pb.TagNumber(1)
  $core.bool hasCreate_1() => $_has(0);
  @$pb.TagNumber(1)
  void clearCreate_1() => clearField(1);
  @$pb.TagNumber(1)
  $3117.Label ensureCreate_1() => $_ensure(0);

  /// Update operation: The label is expected to have a valid resource name.
  @$pb.TagNumber(2)
  $3117.Label get update => $_getN(1);
  @$pb.TagNumber(2)
  set update($3117.Label v) { setField(2, v); }
  @$pb.TagNumber(2)
  $core.bool hasUpdate() => $_has(1);
  @$pb.TagNumber(2)
  void clearUpdate() => clearField(2);
  @$pb.TagNumber(2)
  $3117.Label ensureUpdate() => $_ensure(1);
...
class MutateLabelsResponse extends $pb.GeneratedMessage {
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(_omitMessageNames ? '' : 'MutateLabelsResponse', package: const $pb.PackageName(_omitMessageNames ? '' : 'google.ads.googleads.v16.services'), createEmptyInstance: create)
...
class MutateLabelResult extends $pb.GeneratedMessage {
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(_omitMessageNames ? '' : 'MutateLabelResult', package: const $pb.PackageName(_omitMessageNames ? '' : 'google.ads.googleads.v16.services'), createEmptyInstance: create)
    ..aOS(1, _omitFieldNames ? '' : 'resourceName')
    ..aOM<$3117.Label>(2, _omitFieldNames ? '' : 'label', subBuilder: $3117.Label.create)
    ..hasRequiredFields = false
  ;
  ...
  @$pb.TagNumber(2)
  $3117.Label get label => $_getN(1);
  @$pb.TagNumber(2)
  set label($3117.Label v) { setField(2, v); }
  @$pb.TagNumber(2)
  $core.bool hasLabel() => $_has(1);
  @$pb.TagNumber(2)
  void clearLabel() => clearField(2);
  @$pb.TagNumber(2)
  $3117.Label ensureLabel() => $_ensure(1);
}
