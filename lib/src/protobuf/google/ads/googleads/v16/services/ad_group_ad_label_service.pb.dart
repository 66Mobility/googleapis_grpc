...
class AdGroupAdLabelOperation extends $pb.GeneratedMessage {
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(_omitMessageNames ? '' : 'AdGroupAdLabelOperation', package: const $pb.PackageName(_omitMessageNames ? '' : 'google.ads.googleads.v16.services'), createEmptyInstance: create)
    ..oo(0, [1, 2])
    ..aOM<$3065.AdGroupAdLabel>(1, _omitFieldNames ? '' : 'create', subBuilder: $3065.AdGroupAdLabel.create)
  ...
  /// label.
  @$pb.TagNumber(1)
  $3065.AdGroupAdLabel get create_1 => $_getN(0);
  @$pb.TagNumber(1)
  set create_1($3065.AdGroupAdLabel v) { setField(1, v); }
  @$pb.TagNumber(1)
  $core.bool hasCreate_1() => $_has(0);
  @$pb.TagNumber(1)
  void clearCreate_1() => clearField(1);
  @$pb.TagNumber(1)
  $3065.AdGroupAdLabel ensureCreate_1() => $_ensure(0);
