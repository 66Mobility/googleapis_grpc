...
const MutateBatchJobRequest$json = {
  ...
  '2': [
    ...
    {'1': 'operation', '3': 2, '4': 1, '5': 11, '6': '.google.ads.googleads.v16.services.BatchJobOperation', '8': {}, '10': 'operation'},
  ],
};
...
final $typed_data.Uint8List mutateBatchJobRequestDescriptor = $convert.base64Decode(
    ...
    '9tZXJJZBJXCglvcGVyYXRpb24YAiABKAsyNC5nb29nbGUuYWRzLmdvb2dsZWFkcy52MTYuc2Vy'
...
const BatchJobOperation$json = {
  '1': 'BatchJobOperation',
  '2': [
    {'1': 'create', '3': 1, '4': 1, '5': 11, '6': '.google.ads.googleads.v16.resources.BatchJob', '9': 0, '10': 'create'},
...
final $typed_data.Uint8List batchJobOperationDescriptor = $convert.base64Decode(
    ...
    'Fkcy52MTYucmVzb3VyY2VzLkJhdGNoSm9iSABSBmNyZWF0ZRJACgZyZW1vdmUYBCABKAlCJvpB'
...
const MutateBatchJobResponse$json = {
  ...
  '2': [
    {'1': 'result', '3': 1, '4': 1, '5': 11, '6': '.google.ads.googleads.v16.services.MutateBatchJobResult', '10': 'result'},
  ],
};
...
final $typed_data.Uint8List mutateBatchJobResponseDescriptor = $convert.base64Decode(
    ...
    '9vZ2xlYWRzLnYxNi5zZXJ2aWNlcy5NdXRhdGVCYXRjaEpvYlJlc3VsdFIGcmVzdWx0');
...
const AddBatchJobOperationsRequest$json = {
  ...
  '2': [
    ...
    {'1': 'mutate_operations', '3': 3, '4': 3, '5': 11, '6': '.google.ads.googleads.v16.services.MutateOperation', '8': {}, '10': 'mutateOperations'},
  ],
};
...
final $typed_data.Uint8List addBatchJobOperationsRequestDescriptor = $convert.base64Decode(
    ...
    'lvbnMYAyADKAsyMi5nb29nbGUuYWRzLmdvb2dsZWFkcy52MTYuc2VydmljZXMuTXV0YXRlT3Bl'
...
final $typed_data.Uint8List listBatchJobResultsRequestDescriptor = $convert.base64Decode(
    ...
    'LnYxNi5lbnVtcy5SZXNwb25zZUNvbnRlbnRUeXBlRW51bS5SZXNwb25zZUNvbnRlbnRUeXBlUh'
...
const ListBatchJobResultsResponse$json = {
  ...
  '2': [
    {'1': 'results', '3': 1, '4': 3, '5': 11, '6': '.google.ads.googleads.v16.services.BatchJobResult', '10': 'results'},
...
final $typed_data.Uint8List listBatchJobResultsResponseDescriptor = $convert.base64Decode(
    ...
    '5hZHMuZ29vZ2xlYWRzLnYxNi5zZXJ2aWNlcy5CYXRjaEpvYlJlc3VsdFIHcmVzdWx0cxImCg9u'
...
const BatchJobResult$json = {
  ...
  '2': [
    ...
    {'1': 'mutate_operation_response', '3': 2, '4': 1, '5': 11, '6': '.google.ads.googleads.v16.services.MutateOperationResponse', '10': 'mutateOperationResponse'},
...
final $typed_data.Uint8List batchJobResultDescriptor = $convert.base64Decode(
    ...
    'ZWFkcy52MTYuc2VydmljZXMuTXV0YXRlT3BlcmF0aW9uUmVzcG9uc2VSF211dGF0ZU9wZXJhdG'
