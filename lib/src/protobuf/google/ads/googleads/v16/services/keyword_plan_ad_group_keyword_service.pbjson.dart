...
const MutateKeywordPlanAdGroupKeywordsRequest$json = {
  ...
  '2': [
    ...
    {'1': 'operations', '3': 2, '4': 3, '5': 11, '6': '.google.ads.googleads.v16.services.KeywordPlanAdGroupKeywordOperation', '8': {}, '10': 'operations'},
...
final $typed_data.Uint8List mutateKeywordPlanAdGroupKeywordsRequestDescriptor = $convert.base64Decode(
    ...
    'cy5nb29nbGVhZHMudjE2LnNlcnZpY2VzLktleXdvcmRQbGFuQWRHcm91cEtleXdvcmRPcGVyYX'
...
const KeywordPlanAdGroupKeywordOperation$json = {
  ...
  '2': [
    ...
    {'1': 'create', '3': 1, '4': 1, '5': 11, '6': '.google.ads.googleads.v16.resources.KeywordPlanAdGroupKeyword', '9': 0, '10': 'create'},
    {'1': 'update', '3': 2, '4': 1, '5': 11, '6': '.google.ads.googleads.v16.resources.KeywordPlanAdGroupKeyword', '9': 0, '10': 'update'},
...
final $typed_data.Uint8List keywordPlanAdGroupKeywordOperationDescriptor = $convert.base64Decode(
    ...
    'KAsyPS5nb29nbGUuYWRzLmdvb2dsZWFkcy52MTYucmVzb3VyY2VzLktleXdvcmRQbGFuQWRHcm'
    '91cEtleXdvcmRIAFIGY3JlYXRlElcKBnVwZGF0ZRgCIAEoCzI9Lmdvb2dsZS5hZHMuZ29vZ2xl'
    'YWRzLnYxNi5yZXNvdXJjZXMuS2V5d29yZFBsYW5BZEdyb3VwS2V5d29yZEgAUgZ1cGRhdGUSUQ'
...
const MutateKeywordPlanAdGroupKeywordsResponse$json = {
  ...
  '2': [
    ...
    {'1': 'results', '3': 2, '4': 3, '5': 11, '6': '.google.ads.googleads.v16.services.MutateKeywordPlanAdGroupKeywordResult', '10': 'results'},
  ],
};
...
final $typed_data.Uint8List mutateKeywordPlanAdGroupKeywordsResponseDescriptor = $convert.base64Decode(
    ...
    'cm9yEmIKB3Jlc3VsdHMYAiADKAsySC5nb29nbGUuYWRzLmdvb2dsZWFkcy52MTYuc2VydmljZX'
