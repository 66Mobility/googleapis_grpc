...
const MutateSharedCriteriaRequest$json = {
  ...
  '2': [
    ...
    {'1': 'operations', '3': 2, '4': 3, '5': 11, '6': '.google.ads.googleads.v16.services.SharedCriterionOperation', '8': {}, '10': 'operations'},
...
final $typed_data.Uint8List mutateSharedCriteriaRequestDescriptor = $convert.base64Decode(
    ...
    'djE2LnNlcnZpY2VzLlNoYXJlZENyaXRlcmlvbk9wZXJhdGlvbkID4EECUgpvcGVyYXRpb25zEi'
...
const SharedCriterionOperation$json = {
  ...
  '2': [
    {'1': 'create', '3': 1, '4': 1, '5': 11, '6': '.google.ads.googleads.v16.resources.SharedCriterion', '9': 0, '10': 'create'},
...
final $typed_data.Uint8List sharedCriterionOperationDescriptor = $convert.base64Decode(
    ...
    '5nb29nbGVhZHMudjE2LnJlc291cmNlcy5TaGFyZWRDcml0ZXJpb25IAFIGY3JlYXRlEkcKBnJl'
...
const MutateSharedCriteriaResponse$json = {
  ...
  '2': [
    ...
    {'1': 'results', '3': 2, '4': 3, '5': 11, '6': '.google.ads.googleads.v16.services.MutateSharedCriterionResult', '10': 'results'},
  ],
};
...
final $typed_data.Uint8List mutateSharedCriteriaResponseDescriptor = $convert.base64Decode(
    ...
    'dHMYAiADKAsyPi5nb29nbGUuYWRzLmdvb2dsZWFkcy52MTYuc2VydmljZXMuTXV0YXRlU2hhcm'
...
const MutateSharedCriterionResult$json = {
  ...
  '2': [
    ...
    {'1': 'shared_criterion', '3': 2, '4': 1, '5': 11, '6': '.google.ads.googleads.v16.resources.SharedCriterion', '10': 'sharedCriterion'},
  ],
};
...
final $typed_data.Uint8List mutateSharedCriterionResultDescriptor = $convert.base64Decode(
    ...
    'bWUSXgoQc2hhcmVkX2NyaXRlcmlvbhgCIAEoCzIzLmdvb2dsZS5hZHMuZ29vZ2xlYWRzLnYxNi'
