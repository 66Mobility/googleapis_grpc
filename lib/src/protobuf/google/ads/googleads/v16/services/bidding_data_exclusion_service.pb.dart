...
class MutateBiddingDataExclusionsRequest extends $pb.GeneratedMessage {
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(_omitMessageNames ? '' : 'MutateBiddingDataExclusionsRequest', package: const $pb.PackageName(_omitMessageNames ? '' : 'google.ads.googleads.v16.services'), createEmptyInstance: create)
...
class BiddingDataExclusionOperation extends $pb.GeneratedMessage {
  factory BiddingDataExclusionOperation({
    $3079.BiddingDataExclusion? create_1,
    $3079.BiddingDataExclusion? update,
    $core.String? remove,
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(_omitMessageNames ? '' : 'BiddingDataExclusionOperation', package: const $pb.PackageName(_omitMessageNames ? '' : 'google.ads.googleads.v16.services'), createEmptyInstance: create)
    ..oo(0, [1, 2, 3])
    ..aOM<$3079.BiddingDataExclusion>(1, _omitFieldNames ? '' : 'create', subBuilder: $3079.BiddingDataExclusion.create)
    ..aOM<$3079.BiddingDataExclusion>(2, _omitFieldNames ? '' : 'update', subBuilder: $3079.BiddingDataExclusion.create)
  ...
  /// exclusion.
  @$pb.TagNumber(1)
  $3079.BiddingDataExclusion get create_1 => $_getN(0);
  @$pb.TagNumber(1)
  set create_1($3079.BiddingDataExclusion v) { setField(1, v); }
  @$pb.TagNumber(1)
  $core.bool hasCreate_1() => $_has(0);
  @$pb.TagNumber(1)
  void clearCreate_1() => clearField(1);
  @$pb.TagNumber(1)
  $3079.BiddingDataExclusion ensureCreate_1() => $_ensure(0);

  /// Update operation: The data exclusion is expected to have a valid
  /// resource name.
  @$pb.TagNumber(2)
  $3079.BiddingDataExclusion get update => $_getN(1);
  @$pb.TagNumber(2)
  set update($3079.BiddingDataExclusion v) { setField(2, v); }
  @$pb.TagNumber(2)
  $core.bool hasUpdate() => $_has(1);
  @$pb.TagNumber(2)
  void clearUpdate() => clearField(2);
  @$pb.TagNumber(2)
  $3079.BiddingDataExclusion ensureUpdate() => $_ensure(1);
...
class MutateBiddingDataExclusionsResponse extends $pb.GeneratedMessage {
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(_omitMessageNames ? '' : 'MutateBiddingDataExclusionsResponse', package: const $pb.PackageName(_omitMessageNames ? '' : 'google.ads.googleads.v16.services'), createEmptyInstance: create)
...
class MutateBiddingDataExclusionsResult extends $pb.GeneratedMessage {
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(_omitMessageNames ? '' : 'MutateBiddingDataExclusionsResult', package: const $pb.PackageName(_omitMessageNames ? '' : 'google.ads.googleads.v16.services'), createEmptyInstance: create)
    ..aOS(1, _omitFieldNames ? '' : 'resourceName')
    ..aOM<$3079.BiddingDataExclusion>(2, _omitFieldNames ? '' : 'biddingDataExclusion', subBuilder: $3079.BiddingDataExclusion.create)
    ..hasRequiredFields = false
  ;
  ...
  /// to "MUTABLE_RESOURCE".
  @$pb.TagNumber(2)
  $3079.BiddingDataExclusion get biddingDataExclusion => $_getN(1);
  @$pb.TagNumber(2)
  set biddingDataExclusion($3079.BiddingDataExclusion v) { setField(2, v); }
  @$pb.TagNumber(2)
  $core.bool hasBiddingDataExclusion() => $_has(1);
  @$pb.TagNumber(2)
  void clearBiddingDataExclusion() => clearField(2);
  @$pb.TagNumber(2)
  $3079.BiddingDataExclusion ensureBiddingDataExclusion() => $_ensure(1);
}
