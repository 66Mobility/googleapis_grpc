...
class BiddingDataExclusionOperation extends $pb.GeneratedMessage {
  factory BiddingDataExclusionOperation({
    $3080.BiddingDataExclusion? create_1,
    $3080.BiddingDataExclusion? update,
    $core.String? remove,
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(_omitMessageNames ? '' : 'BiddingDataExclusionOperation', package: const $pb.PackageName(_omitMessageNames ? '' : 'google.ads.googleads.v16.services'), createEmptyInstance: create)
    ..oo(0, [1, 2, 3])
    ..aOM<$3080.BiddingDataExclusion>(1, _omitFieldNames ? '' : 'create', subBuilder: $3080.BiddingDataExclusion.create)
    ..aOM<$3080.BiddingDataExclusion>(2, _omitFieldNames ? '' : 'update', subBuilder: $3080.BiddingDataExclusion.create)
  ...
  /// exclusion.
  @$pb.TagNumber(1)
  $3080.BiddingDataExclusion get create_1 => $_getN(0);
  @$pb.TagNumber(1)
  set create_1($3080.BiddingDataExclusion v) { setField(1, v); }
  @$pb.TagNumber(1)
  $core.bool hasCreate_1() => $_has(0);
  @$pb.TagNumber(1)
  void clearCreate_1() => clearField(1);
  @$pb.TagNumber(1)
  $3080.BiddingDataExclusion ensureCreate_1() => $_ensure(0);

  /// Update operation: The data exclusion is expected to have a valid
  /// resource name.
  @$pb.TagNumber(2)
  $3080.BiddingDataExclusion get update => $_getN(1);
  @$pb.TagNumber(2)
  set update($3080.BiddingDataExclusion v) { setField(2, v); }
  @$pb.TagNumber(2)
  $core.bool hasUpdate() => $_has(1);
  @$pb.TagNumber(2)
  void clearUpdate() => clearField(2);
  @$pb.TagNumber(2)
  $3080.BiddingDataExclusion ensureUpdate() => $_ensure(1);
...
class MutateBiddingDataExclusionsResult extends $pb.GeneratedMessage {
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(_omitMessageNames ? '' : 'MutateBiddingDataExclusionsResult', package: const $pb.PackageName(_omitMessageNames ? '' : 'google.ads.googleads.v16.services'), createEmptyInstance: create)
    ...
    ..aOM<$3080.BiddingDataExclusion>(2, _omitFieldNames ? '' : 'biddingDataExclusion', subBuilder: $3080.BiddingDataExclusion.create)
    ..hasRequiredFields = false
  ;
  ...
  /// to "MUTABLE_RESOURCE".
  @$pb.TagNumber(2)
  $3080.BiddingDataExclusion get biddingDataExclusion => $_getN(1);
  @$pb.TagNumber(2)
  set biddingDataExclusion($3080.BiddingDataExclusion v) { setField(2, v); }
  @$pb.TagNumber(2)
  $core.bool hasBiddingDataExclusion() => $_has(1);
  @$pb.TagNumber(2)
  void clearBiddingDataExclusion() => clearField(2);
  @$pb.TagNumber(2)
  $3080.BiddingDataExclusion ensureBiddingDataExclusion() => $_ensure(1);
}
