...
const MutateFeedItemTargetsRequest$json = {
  ...
  '2': [
    ...
    {'1': 'operations', '3': 2, '4': 3, '5': 11, '6': '.google.ads.googleads.v16.services.FeedItemTargetOperation', '8': {}, '10': 'operations'},
...
final $typed_data.Uint8List mutateFeedItemTargetsRequestDescriptor = $convert.base64Decode(
    ...
    'LnYxNi5zZXJ2aWNlcy5GZWVkSXRlbVRhcmdldE9wZXJhdGlvbkID4EECUgpvcGVyYXRpb25zEi'
...
const FeedItemTargetOperation$json = {
  ...
  '2': [
    {'1': 'create', '3': 1, '4': 1, '5': 11, '6': '.google.ads.googleads.v16.resources.FeedItemTarget', '9': 0, '10': 'create'},
...
final $typed_data.Uint8List feedItemTargetOperationDescriptor = $convert.base64Decode(
    ...
    'dvb2dsZWFkcy52MTYucmVzb3VyY2VzLkZlZWRJdGVtVGFyZ2V0SABSBmNyZWF0ZRJGCgZyZW1v'
...
const MutateFeedItemTargetsResponse$json = {
  ...
  '2': [
    ...
    {'1': 'results', '3': 2, '4': 3, '5': 11, '6': '.google.ads.googleads.v16.services.MutateFeedItemTargetResult', '10': 'results'},
  ],
};
...
final $typed_data.Uint8List mutateFeedItemTargetsResponseDescriptor = $convert.base64Decode(
    ...
    'bHRzGAIgAygLMj0uZ29vZ2xlLmFkcy5nb29nbGVhZHMudjE2LnNlcnZpY2VzLk11dGF0ZUZlZW'
...
const MutateFeedItemTargetResult$json = {
  ...
  '2': [
    ...
    {'1': 'feed_item_target', '3': 2, '4': 1, '5': 11, '6': '.google.ads.googleads.v16.resources.FeedItemTarget', '10': 'feedItemTarget'},
  ],
};
...
final $typed_data.Uint8List mutateFeedItemTargetResultDescriptor = $convert.base64Decode(
    ...
    'ElwKEGZlZWRfaXRlbV90YXJnZXQYAiABKAsyMi5nb29nbGUuYWRzLmdvb2dsZWFkcy52MTYucm'
