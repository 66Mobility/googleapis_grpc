...
const MutateRecommendationSubscriptionRequest$json = {
  ...
  '2': [
    ...
    {'1': 'operations', '3': 2, '4': 3, '5': 11, '6': '.google.ads.googleads.v16.services.RecommendationSubscriptionOperation', '8': {}, '10': 'operations'},
...
final $typed_data.Uint8List mutateRecommendationSubscriptionRequestDescriptor = $convert.base64Decode(
    ...
    'cy5nb29nbGVhZHMudjE2LnNlcnZpY2VzLlJlY29tbWVuZGF0aW9uU3Vic2NyaXB0aW9uT3Blcm'
    ...
    'VfY29udGVudF90eXBlGAUgASgOMksuZ29vZ2xlLmFkcy5nb29nbGVhZHMudjE2LmVudW1zLlJl'
...
const RecommendationSubscriptionOperation$json = {
  ...
  '2': [
    ...
    {'1': 'create', '3': 1, '4': 1, '5': 11, '6': '.google.ads.googleads.v16.resources.RecommendationSubscription', '9': 0, '10': 'create'},
    {'1': 'update', '3': 2, '4': 1, '5': 11, '6': '.google.ads.googleads.v16.resources.RecommendationSubscription', '9': 0, '10': 'update'},
  ],
  '8': [
    {'1': 'operation'},
  ],
...
final $typed_data.Uint8List recommendationSubscriptionOperationDescriptor = $convert.base64Decode(
    ...
    'dGUYASABKAsyPi5nb29nbGUuYWRzLmdvb2dsZWFkcy52MTYucmVzb3VyY2VzLlJlY29tbWVuZG'
    'F0aW9uU3Vic2NyaXB0aW9uSABSBmNyZWF0ZRJYCgZ1cGRhdGUYAiABKAsyPi5nb29nbGUuYWRz'
    'Lmdvb2dsZWFkcy52MTYucmVzb3VyY2VzLlJlY29tbWVuZGF0aW9uU3Vic2NyaXB0aW9uSABSBn'
...
const MutateRecommendationSubscriptionResponse$json = {
  ...
  '2': [
    {'1': 'results', '3': 1, '4': 3, '5': 11, '6': '.google.ads.googleads.v16.services.MutateRecommendationSubscriptionResult', '10': 'results'},
...
final $typed_data.Uint8List mutateRecommendationSubscriptionResponseDescriptor = $convert.base64Decode(
    ...
    'ADKAsySS5nb29nbGUuYWRzLmdvb2dsZWFkcy52MTYuc2VydmljZXMuTXV0YXRlUmVjb21tZW5k'
...
const MutateRecommendationSubscriptionResult$json = {
  ...
  '2': [
    ...
    {'1': 'recommendation_subscription', '3': 2, '4': 1, '5': 11, '6': '.google.ads.googleads.v16.resources.RecommendationSubscription', '10': 'recommendationSubscription'},
  ],
};
...
final $typed_data.Uint8List mutateRecommendationSubscriptionResultDescriptor = $convert.base64Decode(
    ...
    'gCIAEoCzI+Lmdvb2dsZS5hZHMuZ29vZ2xlYWRzLnYxNi5yZXNvdXJjZXMuUmVjb21tZW5kYXRp'
