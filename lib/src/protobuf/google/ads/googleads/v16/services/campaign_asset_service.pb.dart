...
class CampaignAssetOperation extends $pb.GeneratedMessage {
  factory CampaignAssetOperation({
    $2932.CampaignAsset? create_1,
    $core.String? remove,
    $2932.CampaignAsset? update,
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(_omitMessageNames ? '' : 'CampaignAssetOperation', package: const $pb.PackageName(_omitMessageNames ? '' : 'google.ads.googleads.v16.services'), createEmptyInstance: create)
    ..oo(0, [1, 2, 3])
    ..aOM<$2932.CampaignAsset>(1, _omitFieldNames ? '' : 'create', subBuilder: $2932.CampaignAsset.create)
    ..aOS(2, _omitFieldNames ? '' : 'remove')
    ..aOM<$2932.CampaignAsset>(3, _omitFieldNames ? '' : 'update', subBuilder: $2932.CampaignAsset.create)
  ...
  /// asset.
  @$pb.TagNumber(1)
  $2932.CampaignAsset get create_1 => $_getN(0);
  @$pb.TagNumber(1)
  set create_1($2932.CampaignAsset v) { setField(1, v); }
  @$pb.TagNumber(1)
  $core.bool hasCreate_1() => $_has(0);
  @$pb.TagNumber(1)
  void clearCreate_1() => clearField(1);
  @$pb.TagNumber(1)
  $2932.CampaignAsset ensureCreate_1() => $_ensure(0);
  ...
  /// name.
  @$pb.TagNumber(3)
  $2932.CampaignAsset get update => $_getN(2);
  @$pb.TagNumber(3)
  set update($2932.CampaignAsset v) { setField(3, v); }
  @$pb.TagNumber(3)
  $core.bool hasUpdate() => $_has(2);
  @$pb.TagNumber(3)
  void clearUpdate() => clearField(3);
  @$pb.TagNumber(3)
  $2932.CampaignAsset ensureUpdate() => $_ensure(2);
...
class MutateCampaignAssetResult extends $pb.GeneratedMessage {
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(_omitMessageNames ? '' : 'MutateCampaignAssetResult', package: const $pb.PackageName(_omitMessageNames ? '' : 'google.ads.googleads.v16.services'), createEmptyInstance: create)
    ...
    ..aOM<$2932.CampaignAsset>(2, _omitFieldNames ? '' : 'campaignAsset', subBuilder: $2932.CampaignAsset.create)
    ..hasRequiredFields = false
  ;
  ...
  /// to "MUTABLE_RESOURCE".
  @$pb.TagNumber(2)
  $2932.CampaignAsset get campaignAsset => $_getN(1);
  @$pb.TagNumber(2)
  set campaignAsset($2932.CampaignAsset v) { setField(2, v); }
  @$pb.TagNumber(2)
  $core.bool hasCampaignAsset() => $_has(1);
  @$pb.TagNumber(2)
  void clearCampaignAsset() => clearField(2);
  @$pb.TagNumber(2)
  $2932.CampaignAsset ensureCampaignAsset() => $_ensure(1);
}
