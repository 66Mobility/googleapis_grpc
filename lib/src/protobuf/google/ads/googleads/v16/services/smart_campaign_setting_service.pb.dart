...
import '../enums/smart_campaign_not_eligible_reason.pbenum.dart' as $3123;
import '../enums/smart_campaign_status.pbenum.dart' as $3124;
...
class GetSmartCampaignStatusRequest extends $pb.GeneratedMessage {
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(_omitMessageNames ? '' : 'GetSmartCampaignStatusRequest', package: const $pb.PackageName(_omitMessageNames ? '' : 'google.ads.googleads.v16.services'), createEmptyInstance: create)
...
class SmartCampaignNotEligibleDetails extends $pb.GeneratedMessage {
  factory SmartCampaignNotEligibleDetails({
    $3123.SmartCampaignNotEligibleReasonEnum_SmartCampaignNotEligibleReason? notEligibleReason,
  }) {
    final $result = create();
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(_omitMessageNames ? '' : 'SmartCampaignNotEligibleDetails', package: const $pb.PackageName(_omitMessageNames ? '' : 'google.ads.googleads.v16.services'), createEmptyInstance: create)
    ..e<$3123.SmartCampaignNotEligibleReasonEnum_SmartCampaignNotEligibleReason>(1, _omitFieldNames ? '' : 'notEligibleReason', $pb.PbFieldType.OE, defaultOrMaker: $3123.SmartCampaignNotEligibleReasonEnum_SmartCampaignNotEligibleReason.UNSPECIFIED, valueOf: $3123.SmartCampaignNotEligibleReasonEnum_SmartCampaignNotEligibleReason.valueOf, enumValues: $3123.SmartCampaignNotEligibleReasonEnum_SmartCampaignNotEligibleReason.values)
    ..hasRequiredFields = false
  ;
  ...
  @$pb.TagNumber(1)
  $3123.SmartCampaignNotEligibleReasonEnum_SmartCampaignNotEligibleReason get notEligibleReason => $_getN(0);
  @$pb.TagNumber(1)
  set notEligibleReason($3123.SmartCampaignNotEligibleReasonEnum_SmartCampaignNotEligibleReason v) { setField(1, v); }
  @$pb.TagNumber(1)
...
class SmartCampaignEligibleDetails extends $pb.GeneratedMessage {
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(_omitMessageNames ? '' : 'SmartCampaignEligibleDetails', package: const $pb.PackageName(_omitMessageNames ? '' : 'google.ads.googleads.v16.services'), createEmptyInstance: create)
...
class SmartCampaignPausedDetails extends $pb.GeneratedMessage {
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(_omitMessageNames ? '' : 'SmartCampaignPausedDetails', package: const $pb.PackageName(_omitMessageNames ? '' : 'google.ads.googleads.v16.services'), createEmptyInstance: create)
...
class SmartCampaignRemovedDetails extends $pb.GeneratedMessage {
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(_omitMessageNames ? '' : 'SmartCampaignRemovedDetails', package: const $pb.PackageName(_omitMessageNames ? '' : 'google.ads.googleads.v16.services'), createEmptyInstance: create)
...
class SmartCampaignEndedDetails extends $pb.GeneratedMessage {
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(_omitMessageNames ? '' : 'SmartCampaignEndedDetails', package: const $pb.PackageName(_omitMessageNames ? '' : 'google.ads.googleads.v16.services'), createEmptyInstance: create)
...
class GetSmartCampaignStatusResponse extends $pb.GeneratedMessage {
  factory GetSmartCampaignStatusResponse({
    $3124.SmartCampaignStatusEnum_SmartCampaignStatus? smartCampaignStatus,
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(_omitMessageNames ? '' : 'GetSmartCampaignStatusResponse', package: const $pb.PackageName(_omitMessageNames ? '' : 'google.ads.googleads.v16.services'), createEmptyInstance: create)
    ..oo(0, [2, 3, 4, 5, 6])
    ..e<$3124.SmartCampaignStatusEnum_SmartCampaignStatus>(1, _omitFieldNames ? '' : 'smartCampaignStatus', $pb.PbFieldType.OE, defaultOrMaker: $3124.SmartCampaignStatusEnum_SmartCampaignStatus.UNSPECIFIED, valueOf: $3124.SmartCampaignStatusEnum_SmartCampaignStatus.valueOf, enumValues: $3124.SmartCampaignStatusEnum_SmartCampaignStatus.values)
  ...
  @$pb.TagNumber(1)
  $3124.SmartCampaignStatusEnum_SmartCampaignStatus get smartCampaignStatus => $_getN(0);
  @$pb.TagNumber(1)
  set smartCampaignStatus($3124.SmartCampaignStatusEnum_SmartCampaignStatus v) { setField(1, v); }
  @$pb.TagNumber(1)
...
class MutateSmartCampaignSettingsRequest extends $pb.GeneratedMessage {
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(_omitMessageNames ? '' : 'MutateSmartCampaignSettingsRequest', package: const $pb.PackageName(_omitMessageNames ? '' : 'google.ads.googleads.v16.services'), createEmptyInstance: create)
...
class SmartCampaignSettingOperation extends $pb.GeneratedMessage {
  factory SmartCampaignSettingOperation({
    $3122.SmartCampaignSetting? update,
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(_omitMessageNames ? '' : 'SmartCampaignSettingOperation', package: const $pb.PackageName(_omitMessageNames ? '' : 'google.ads.googleads.v16.services'), createEmptyInstance: create)
    ..aOM<$3122.SmartCampaignSetting>(1, _omitFieldNames ? '' : 'update', subBuilder: $3122.SmartCampaignSetting.create)
  ...
  /// resource name.
  @$pb.TagNumber(1)
  $3122.SmartCampaignSetting get update => $_getN(0);
  @$pb.TagNumber(1)
  set update($3122.SmartCampaignSetting v) { setField(1, v); }
  @$pb.TagNumber(1)
  $core.bool hasUpdate() => $_has(0);
  @$pb.TagNumber(1)
  void clearUpdate() => clearField(1);
  @$pb.TagNumber(1)
  $3122.SmartCampaignSetting ensureUpdate() => $_ensure(0);
...
class MutateSmartCampaignSettingsResponse extends $pb.GeneratedMessage {
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(_omitMessageNames ? '' : 'MutateSmartCampaignSettingsResponse', package: const $pb.PackageName(_omitMessageNames ? '' : 'google.ads.googleads.v16.services'), createEmptyInstance: create)
...
class MutateSmartCampaignSettingResult extends $pb.GeneratedMessage {
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(_omitMessageNames ? '' : 'MutateSmartCampaignSettingResult', package: const $pb.PackageName(_omitMessageNames ? '' : 'google.ads.googleads.v16.services'), createEmptyInstance: create)
    ..aOS(1, _omitFieldNames ? '' : 'resourceName')
    ..aOM<$3122.SmartCampaignSetting>(2, _omitFieldNames ? '' : 'smartCampaignSetting', subBuilder: $3122.SmartCampaignSetting.create)
    ..hasRequiredFields = false
  ;
  ...
  /// "MUTABLE_RESOURCE".
  @$pb.TagNumber(2)
  $3122.SmartCampaignSetting get smartCampaignSetting => $_getN(1);
  @$pb.TagNumber(2)
  set smartCampaignSetting($3122.SmartCampaignSetting v) { setField(2, v); }
  @$pb.TagNumber(2)
  $core.bool hasSmartCampaignSetting() => $_has(1);
  @$pb.TagNumber(2)
  void clearSmartCampaignSetting() => clearField(2);
  @$pb.TagNumber(2)
  $3122.SmartCampaignSetting ensureSmartCampaignSetting() => $_ensure(1);
}
