...
import '../enums/smart_campaign_not_eligible_reason.pbenum.dart' as $3122;
import '../enums/smart_campaign_status.pbenum.dart' as $3123;
...
class SmartCampaignNotEligibleDetails extends $pb.GeneratedMessage {
  factory SmartCampaignNotEligibleDetails({
    $3122.SmartCampaignNotEligibleReasonEnum_SmartCampaignNotEligibleReason? notEligibleReason,
  }) {
    final $result = create();
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(_omitMessageNames ? '' : 'SmartCampaignNotEligibleDetails', package: const $pb.PackageName(_omitMessageNames ? '' : 'google.ads.googleads.v16.services'), createEmptyInstance: create)
    ..e<$3122.SmartCampaignNotEligibleReasonEnum_SmartCampaignNotEligibleReason>(1, _omitFieldNames ? '' : 'notEligibleReason', $pb.PbFieldType.OE, defaultOrMaker: $3122.SmartCampaignNotEligibleReasonEnum_SmartCampaignNotEligibleReason.UNSPECIFIED, valueOf: $3122.SmartCampaignNotEligibleReasonEnum_SmartCampaignNotEligibleReason.valueOf, enumValues: $3122.SmartCampaignNotEligibleReasonEnum_SmartCampaignNotEligibleReason.values)
    ..hasRequiredFields = false
  ;
  ...
  @$pb.TagNumber(1)
  $3122.SmartCampaignNotEligibleReasonEnum_SmartCampaignNotEligibleReason get notEligibleReason => $_getN(0);
  @$pb.TagNumber(1)
  set notEligibleReason($3122.SmartCampaignNotEligibleReasonEnum_SmartCampaignNotEligibleReason v) { setField(1, v); }
  @$pb.TagNumber(1)
...
class GetSmartCampaignStatusResponse extends $pb.GeneratedMessage {
  factory GetSmartCampaignStatusResponse({
    $3123.SmartCampaignStatusEnum_SmartCampaignStatus? smartCampaignStatus,
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(_omitMessageNames ? '' : 'GetSmartCampaignStatusResponse', package: const $pb.PackageName(_omitMessageNames ? '' : 'google.ads.googleads.v16.services'), createEmptyInstance: create)
    ..oo(0, [2, 3, 4, 5, 6])
    ..e<$3123.SmartCampaignStatusEnum_SmartCampaignStatus>(1, _omitFieldNames ? '' : 'smartCampaignStatus', $pb.PbFieldType.OE, defaultOrMaker: $3123.SmartCampaignStatusEnum_SmartCampaignStatus.UNSPECIFIED, valueOf: $3123.SmartCampaignStatusEnum_SmartCampaignStatus.valueOf, enumValues: $3123.SmartCampaignStatusEnum_SmartCampaignStatus.values)
  ...
  @$pb.TagNumber(1)
  $3123.SmartCampaignStatusEnum_SmartCampaignStatus get smartCampaignStatus => $_getN(0);
  @$pb.TagNumber(1)
  set smartCampaignStatus($3123.SmartCampaignStatusEnum_SmartCampaignStatus v) { setField(1, v); }
  @$pb.TagNumber(1)
...
class SmartCampaignSettingOperation extends $pb.GeneratedMessage {
  factory SmartCampaignSettingOperation({
    $3121.SmartCampaignSetting? update,
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(_omitMessageNames ? '' : 'SmartCampaignSettingOperation', package: const $pb.PackageName(_omitMessageNames ? '' : 'google.ads.googleads.v16.services'), createEmptyInstance: create)
    ..aOM<$3121.SmartCampaignSetting>(1, _omitFieldNames ? '' : 'update', subBuilder: $3121.SmartCampaignSetting.create)
  ...
  /// resource name.
  @$pb.TagNumber(1)
  $3121.SmartCampaignSetting get update => $_getN(0);
  @$pb.TagNumber(1)
  set update($3121.SmartCampaignSetting v) { setField(1, v); }
  @$pb.TagNumber(1)
  $core.bool hasUpdate() => $_has(0);
  @$pb.TagNumber(1)
  void clearUpdate() => clearField(1);
  @$pb.TagNumber(1)
  $3121.SmartCampaignSetting ensureUpdate() => $_ensure(0);
...
class MutateSmartCampaignSettingResult extends $pb.GeneratedMessage {
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(_omitMessageNames ? '' : 'MutateSmartCampaignSettingResult', package: const $pb.PackageName(_omitMessageNames ? '' : 'google.ads.googleads.v16.services'), createEmptyInstance: create)
    ..aOS(1, _omitFieldNames ? '' : 'resourceName')
    ..aOM<$3121.SmartCampaignSetting>(2, _omitFieldNames ? '' : 'smartCampaignSetting', subBuilder: $3121.SmartCampaignSetting.create)
    ..hasRequiredFields = false
  ;
  ...
  /// "MUTABLE_RESOURCE".
  @$pb.TagNumber(2)
  $3121.SmartCampaignSetting get smartCampaignSetting => $_getN(1);
  @$pb.TagNumber(2)
  set smartCampaignSetting($3121.SmartCampaignSetting v) { setField(2, v); }
  @$pb.TagNumber(2)
  $core.bool hasSmartCampaignSetting() => $_has(1);
  @$pb.TagNumber(2)
  void clearSmartCampaignSetting() => clearField(2);
  @$pb.TagNumber(2)
  $3121.SmartCampaignSetting ensureSmartCampaignSetting() => $_ensure(1);
}
