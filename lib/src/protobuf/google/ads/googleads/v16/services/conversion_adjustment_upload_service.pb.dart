...
import '../enums/conversion_adjustment_type.pbenum.dart' as $3223;
...
class ConversionAdjustment extends $pb.GeneratedMessage {
  factory ConversionAdjustment({
    $3223.ConversionAdjustmentTypeEnum_ConversionAdjustmentType? adjustmentType,
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(_omitMessageNames ? '' : 'ConversionAdjustment', package: const $pb.PackageName(_omitMessageNames ? '' : 'google.ads.googleads.v16.services'), createEmptyInstance: create)
    ..e<$3223.ConversionAdjustmentTypeEnum_ConversionAdjustmentType>(5, _omitFieldNames ? '' : 'adjustmentType', $pb.PbFieldType.OE, defaultOrMaker: $3223.ConversionAdjustmentTypeEnum_ConversionAdjustmentType.UNSPECIFIED, valueOf: $3223.ConversionAdjustmentTypeEnum_ConversionAdjustmentType.valueOf, enumValues: $3223.ConversionAdjustmentTypeEnum_ConversionAdjustmentType.values)
    ...
    ..pc<$3038.UserIdentifier>(10, _omitFieldNames ? '' : 'userIdentifiers', $pb.PbFieldType.PM, subBuilder: $3038.UserIdentifier.create)
  ...
  /// The adjustment type.
  @$pb.TagNumber(5)
  $3223.ConversionAdjustmentTypeEnum_ConversionAdjustmentType get adjustmentType => $_getN(0);
  @$pb.TagNumber(5)
  set adjustmentType($3223.ConversionAdjustmentTypeEnum_ConversionAdjustmentType v) { setField(5, v); }
  @$pb.TagNumber(5)
  ...
  /// enhancement is 5.
  @$pb.TagNumber(10)
  $core.List<$3038.UserIdentifier> get userIdentifiers => $_getList(4);
