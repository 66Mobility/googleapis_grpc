...
const MutateRemarketingActionsRequest$json = {
  ...
  '2': [
    ...
    {'1': 'operations', '3': 2, '4': 3, '5': 11, '6': '.google.ads.googleads.v16.services.RemarketingActionOperation', '8': {}, '10': 'operations'},
...
final $typed_data.Uint8List mutateRemarketingActionsRequestDescriptor = $convert.base64Decode(
    ...
    'YWRzLnYxNi5zZXJ2aWNlcy5SZW1hcmtldGluZ0FjdGlvbk9wZXJhdGlvbkID4EECUgpvcGVyYX'
...
const RemarketingActionOperation$json = {
  ...
  '2': [
    ...
    {'1': 'create', '3': 1, '4': 1, '5': 11, '6': '.google.ads.googleads.v16.resources.RemarketingAction', '9': 0, '10': 'create'},
    {'1': 'update', '3': 2, '4': 1, '5': 11, '6': '.google.ads.googleads.v16.resources.RemarketingAction', '9': 0, '10': 'update'},
  ],
  '8': [
    {'1': 'operation'},
  ],
...
final $typed_data.Uint8List remarketingActionOperationDescriptor = $convert.base64Decode(
    ...
    'Z2xlLmFkcy5nb29nbGVhZHMudjE2LnJlc291cmNlcy5SZW1hcmtldGluZ0FjdGlvbkgAUgZjcm'
...
const MutateRemarketingActionsResponse$json = {
  ...
  '2': [
    ...
    {'1': 'results', '3': 2, '4': 3, '5': 11, '6': '.google.ads.googleads.v16.services.MutateRemarketingActionResult', '10': 'results'},
  ],
};
...
final $typed_data.Uint8List mutateRemarketingActionsResponseDescriptor = $convert.base64Decode(
    ...
    'ZXN1bHRzGAIgAygLMkAuZ29vZ2xlLmFkcy5nb29nbGVhZHMudjE2LnNlcnZpY2VzLk11dGF0ZV'
