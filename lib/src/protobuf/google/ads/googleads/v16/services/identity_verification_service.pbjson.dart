...
const StartIdentityVerificationRequest$json = {
  ...
  '2': [
    ...
    {'1': 'verification_program', '3': 2, '4': 1, '5': 14, '6': '.google.ads.googleads.v16.enums.IdentityVerificationProgramEnum.IdentityVerificationProgram', '8': {}, '10': 'verificationProgram'},
  ],
};
...
final $typed_data.Uint8List startIdentityVerificationRequestDescriptor = $convert.base64Decode(
    ...
    'ZS5hZHMuZ29vZ2xlYWRzLnYxNi5lbnVtcy5JZGVudGl0eVZlcmlmaWNhdGlvblByb2dyYW1Fbn'
...
const GetIdentityVerificationResponse$json = {
  ...
  '2': [
    {'1': 'identity_verification', '3': 1, '4': 3, '5': 11, '6': '.google.ads.googleads.v16.services.IdentityVerification', '10': 'identityVerification'},
  ],
};
...
final $typed_data.Uint8List getIdentityVerificationResponseDescriptor = $convert.base64Decode(
    ...
    'lvbhgBIAMoCzI3Lmdvb2dsZS5hZHMuZ29vZ2xlYWRzLnYxNi5zZXJ2aWNlcy5JZGVudGl0eVZl'
...
const IdentityVerification$json = {
  ...
  '2': [
    {'1': 'verification_program', '3': 1, '4': 1, '5': 14, '6': '.google.ads.googleads.v16.enums.IdentityVerificationProgramEnum.IdentityVerificationProgram', '10': 'verificationProgram'},
    {'1': 'identity_verification_requirement', '3': 2, '4': 1, '5': 11, '6': '.google.ads.googleads.v16.services.IdentityVerificationRequirement', '9': 0, '10': 'identityVerificationRequirement', '17': true},
    {'1': 'verification_progress', '3': 3, '4': 1, '5': 11, '6': '.google.ads.googleads.v16.services.IdentityVerificationProgress', '9': 1, '10': 'verificationProgress', '17': true},
  ],
  '8': [
...
final $typed_data.Uint8List identityVerificationDescriptor = $convert.base64Decode(
    ...
    '5nb29nbGUuYWRzLmdvb2dsZWFkcy52MTYuZW51bXMuSWRlbnRpdHlWZXJpZmljYXRpb25Qcm9n'
    ...
    'ZHMuZ29vZ2xlYWRzLnYxNi5zZXJ2aWNlcy5JZGVudGl0eVZlcmlmaWNhdGlvblJlcXVpcmVtZW'
    '50SABSH2lkZW50aXR5VmVyaWZpY2F0aW9uUmVxdWlyZW1lbnSIAQESeQoVdmVyaWZpY2F0aW9u'
    'X3Byb2dyZXNzGAMgASgLMj8uZ29vZ2xlLmFkcy5nb29nbGVhZHMudjE2LnNlcnZpY2VzLklkZW'
...
const IdentityVerificationProgress$json = {
  ...
  '2': [
    {'1': 'program_status', '3': 1, '4': 1, '5': 14, '6': '.google.ads.googleads.v16.enums.IdentityVerificationProgramStatusEnum.IdentityVerificationProgramStatus', '10': 'programStatus'},
...
final $typed_data.Uint8List identityVerificationProgressDescriptor = $convert.base64Decode(
    ...
    'JnLmdvb2dsZS5hZHMuZ29vZ2xlYWRzLnYxNi5lbnVtcy5JZGVudGl0eVZlcmlmaWNhdGlvblBy'
