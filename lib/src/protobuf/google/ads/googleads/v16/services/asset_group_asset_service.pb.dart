...
class MutateAssetGroupAssetsRequest extends $pb.GeneratedMessage {
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(_omitMessageNames ? '' : 'MutateAssetGroupAssetsRequest', package: const $pb.PackageName(_omitMessageNames ? '' : 'google.ads.googleads.v16.services'), createEmptyInstance: create)
...
class AssetGroupAssetOperation extends $pb.GeneratedMessage {
  factory AssetGroupAssetOperation({
    $3073.AssetGroupAsset? create_1,
    $3073.AssetGroupAsset? update,
    $core.String? remove,
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(_omitMessageNames ? '' : 'AssetGroupAssetOperation', package: const $pb.PackageName(_omitMessageNames ? '' : 'google.ads.googleads.v16.services'), createEmptyInstance: create)
    ..oo(0, [1, 2, 3])
    ..aOM<$3073.AssetGroupAsset>(1, _omitFieldNames ? '' : 'create', subBuilder: $3073.AssetGroupAsset.create)
    ..aOM<$3073.AssetGroupAsset>(2, _omitFieldNames ? '' : 'update', subBuilder: $3073.AssetGroupAsset.create)
  ...
  /// asset.
  @$pb.TagNumber(1)
  $3073.AssetGroupAsset get create_1 => $_getN(0);
  @$pb.TagNumber(1)
  set create_1($3073.AssetGroupAsset v) { setField(1, v); }
  @$pb.TagNumber(1)
  $core.bool hasCreate_1() => $_has(0);
  @$pb.TagNumber(1)
  void clearCreate_1() => clearField(1);
  @$pb.TagNumber(1)
  $3073.AssetGroupAsset ensureCreate_1() => $_ensure(0);

  /// Update operation: The asset group asset is expected to have a valid
  /// resource name.
  @$pb.TagNumber(2)
  $3073.AssetGroupAsset get update => $_getN(1);
  @$pb.TagNumber(2)
  set update($3073.AssetGroupAsset v) { setField(2, v); }
  @$pb.TagNumber(2)
  $core.bool hasUpdate() => $_has(1);
  @$pb.TagNumber(2)
  void clearUpdate() => clearField(2);
  @$pb.TagNumber(2)
  $3073.AssetGroupAsset ensureUpdate() => $_ensure(1);
...
class MutateAssetGroupAssetsResponse extends $pb.GeneratedMessage {
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(_omitMessageNames ? '' : 'MutateAssetGroupAssetsResponse', package: const $pb.PackageName(_omitMessageNames ? '' : 'google.ads.googleads.v16.services'), createEmptyInstance: create)
...
class MutateAssetGroupAssetResult extends $pb.GeneratedMessage {
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(_omitMessageNames ? '' : 'MutateAssetGroupAssetResult', package: const $pb.PackageName(_omitMessageNames ? '' : 'google.ads.googleads.v16.services'), createEmptyInstance: create)
