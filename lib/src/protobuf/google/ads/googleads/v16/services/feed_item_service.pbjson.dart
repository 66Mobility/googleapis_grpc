...
const MutateFeedItemsRequest$json = {
  ...
  '2': [
    ...
    {'1': 'operations', '3': 2, '4': 3, '5': 11, '6': '.google.ads.googleads.v16.services.FeedItemOperation', '8': {}, '10': 'operations'},
...
const FeedItemOperation$json = {
  ...
  '2': [
    ...
    {'1': 'create', '3': 1, '4': 1, '5': 11, '6': '.google.ads.googleads.v16.resources.FeedItem', '9': 0, '10': 'create'},
    {'1': 'update', '3': 2, '4': 1, '5': 11, '6': '.google.ads.googleads.v16.resources.FeedItem', '9': 0, '10': 'update'},
...
final $typed_data.Uint8List feedItemOperationDescriptor = $convert.base64Decode(
    ...
    'b29nbGVhZHMudjE2LnJlc291cmNlcy5GZWVkSXRlbUgAUgZjcmVhdGUSRgoGdXBkYXRlGAIgAS'
    'gLMiwuZ29vZ2xlLmFkcy5nb29nbGVhZHMudjE2LnJlc291cmNlcy5GZWVkSXRlbUgAUgZ1cGRh'
...
const MutateFeedItemsResponse$json = {
  ...
  '2': [
    ...
    {'1': 'results', '3': 2, '4': 3, '5': 11, '6': '.google.ads.googleads.v16.services.MutateFeedItemResult', '10': 'results'},
  ],
};
...
final $typed_data.Uint8List mutateFeedItemsResponseDescriptor = $convert.base64Decode(
    ...
    'AygLMjcuZ29vZ2xlLmFkcy5nb29nbGVhZHMudjE2LnNlcnZpY2VzLk11dGF0ZUZlZWRJdGVtUm'
    'VzdWx0UgdyZXN1bHRz');
...
const MutateFeedItemResult$json = {
  ...
  '2': [
    ...
    {'1': 'feed_item', '3': 2, '4': 1, '5': 11, '6': '.google.ads.googleads.v16.resources.FeedItem', '10': 'feedItem'},
  ],
};
...
final $typed_data.Uint8List mutateFeedItemResultDescriptor = $convert.base64Decode(
    ...
    'bRgCIAEoCzIsLmdvb2dsZS5hZHMuZ29vZ2xlYWRzLnYxNi5yZXNvdXJjZXMuRmVlZEl0ZW1SCG'
    'ZlZWRJdGVt');
