...
const MutateSharedSetsRequest$json = {
  ...
  '2': [
    ...
    {'1': 'operations', '3': 2, '4': 3, '5': 11, '6': '.google.ads.googleads.v16.services.SharedSetOperation', '8': {}, '10': 'operations'},
...
const SharedSetOperation$json = {
  ...
  '2': [
    ...
    {'1': 'create', '3': 1, '4': 1, '5': 11, '6': '.google.ads.googleads.v16.resources.SharedSet', '9': 0, '10': 'create'},
    {'1': 'update', '3': 2, '4': 1, '5': 11, '6': '.google.ads.googleads.v16.resources.SharedSet', '9': 0, '10': 'update'},
...
final $typed_data.Uint8List sharedSetOperationDescriptor = $convert.base64Decode(
    ...
    'Z29vZ2xlYWRzLnYxNi5yZXNvdXJjZXMuU2hhcmVkU2V0SABSBmNyZWF0ZRJHCgZ1cGRhdGUYAi'
    'ABKAsyLS5nb29nbGUuYWRzLmdvb2dsZWFkcy52MTYucmVzb3VyY2VzLlNoYXJlZFNldEgAUgZ1'
...
const MutateSharedSetsResponse$json = {
  ...
  '2': [
    ...
    {'1': 'results', '3': 2, '4': 3, '5': 11, '6': '.google.ads.googleads.v16.services.MutateSharedSetResult', '10': 'results'},
  ],
};
...
final $typed_data.Uint8List mutateSharedSetsResponseDescriptor = $convert.base64Decode(
    ...
    'IAMoCzI4Lmdvb2dsZS5hZHMuZ29vZ2xlYWRzLnYxNi5zZXJ2aWNlcy5NdXRhdGVTaGFyZWRTZX'
...
const MutateSharedSetResult$json = {
  ...
  '2': [
    ...
    {'1': 'shared_set', '3': 2, '4': 1, '5': 11, '6': '.google.ads.googleads.v16.resources.SharedSet', '10': 'sharedSet'},
  ],
};
...
final $typed_data.Uint8List mutateSharedSetResultDescriptor = $convert.base64Decode(
    ...
    'X3NldBgCIAEoCzItLmdvb2dsZS5hZHMuZ29vZ2xlYWRzLnYxNi5yZXNvdXJjZXMuU2hhcmVkU2'
    'V0UglzaGFyZWRTZXQ=');
