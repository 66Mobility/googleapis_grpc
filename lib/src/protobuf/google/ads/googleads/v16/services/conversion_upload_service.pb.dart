...
import '../common/consent.pb.dart' as $2608;
import '../common/offline_user_data.pb.dart' as $3038;
import '../enums/conversion_environment_enum.pbenum.dart' as $3224;
...
class UploadClickConversionsRequest extends $pb.GeneratedMessage {
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(_omitMessageNames ? '' : 'UploadClickConversionsRequest', package: const $pb.PackageName(_omitMessageNames ? '' : 'google.ads.googleads.v16.services'), createEmptyInstance: create)
...
class UploadClickConversionsResponse extends $pb.GeneratedMessage {
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(_omitMessageNames ? '' : 'UploadClickConversionsResponse', package: const $pb.PackageName(_omitMessageNames ? '' : 'google.ads.googleads.v16.services'), createEmptyInstance: create)
...
class UploadCallConversionsRequest extends $pb.GeneratedMessage {
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(_omitMessageNames ? '' : 'UploadCallConversionsRequest', package: const $pb.PackageName(_omitMessageNames ? '' : 'google.ads.googleads.v16.services'), createEmptyInstance: create)
    ..aOS(1, _omitFieldNames ? '' : 'customerId')
...
class UploadCallConversionsResponse extends $pb.GeneratedMessage {
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(_omitMessageNames ? '' : 'UploadCallConversionsResponse', package: const $pb.PackageName(_omitMessageNames ? '' : 'google.ads.googleads.v16.services'), createEmptyInstance: create)
    ..aOM<$1795.Status>(1, _omitFieldNames ? '' : 'partialFailureError', subBuilder: $1795.Status.create)
...
class ClickConversion extends $pb.GeneratedMessage {
  factory ClickConversion({
    ...
    CartData? cartData,
    $core.Iterable<$3038.UserIdentifier>? userIdentifiers,
    $core.String? gbraid,
    $core.String? wbraid,
    $3224.ConversionEnvironmentEnum_ConversionEnvironment? conversionEnvironment,
    $2608.Consent? consent,
  }) {
    final $result = create();
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(_omitMessageNames ? '' : 'ClickConversion', package: const $pb.PackageName(_omitMessageNames ? '' : 'google.ads.googleads.v16.services'), createEmptyInstance: create)
    ...
    ..pc<$3038.UserIdentifier>(17, _omitFieldNames ? '' : 'userIdentifiers', $pb.PbFieldType.PM, subBuilder: $3038.UserIdentifier.create)
    ..aOS(18, _omitFieldNames ? '' : 'gbraid')
    ..aOS(19, _omitFieldNames ? '' : 'wbraid')
    ..e<$3224.ConversionEnvironmentEnum_ConversionEnvironment>(20, _omitFieldNames ? '' : 'conversionEnvironment', $pb.PbFieldType.OE, defaultOrMaker: $3224.ConversionEnvironmentEnum_ConversionEnvironment.UNSPECIFIED, valueOf: $3224.ConversionEnvironmentEnum_ConversionEnvironment.valueOf, enumValues: $3224.ConversionEnvironmentEnum_ConversionEnvironment.values)
    ..aOM<$2608.Consent>(23, _omitFieldNames ? '' : 'consent', subBuilder: $2608.Consent.create)
    ..hasRequiredFields = false
  ;
  ...
  @$pb.TagNumber(17)
  $core.List<$3038.UserIdentifier> get userIdentifiers => $_getList(9);
  ...
  @$pb.TagNumber(20)
  $3224.ConversionEnvironmentEnum_ConversionEnvironment get conversionEnvironment => $_getN(12);
  @$pb.TagNumber(20)
  set conversionEnvironment($3224.ConversionEnvironmentEnum_ConversionEnvironment v) { setField(20, v); }
  @$pb.TagNumber(20)
  ...
  @$pb.TagNumber(23)
  $2608.Consent get consent => $_getN(13);
  @$pb.TagNumber(23)
  set consent($2608.Consent v) { setField(23, v); }
  @$pb.TagNumber(23)
  $core.bool hasConsent() => $_has(13);
  @$pb.TagNumber(23)
  void clearConsent() => clearField(23);
  @$pb.TagNumber(23)
  $2608.Consent ensureConsent() => $_ensure(13);
}
...
class CallConversion extends $pb.GeneratedMessage {
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(_omitMessageNames ? '' : 'CallConversion', package: const $pb.PackageName(_omitMessageNames ? '' : 'google.ads.googleads.v16.services'), createEmptyInstance: create)
    ...
    ..aOM<$2608.Consent>(14, _omitFieldNames ? '' : 'consent', subBuilder: $2608.Consent.create)
    ..hasRequiredFields = false
  ;
  ...
  /// The consent setting for the event.
  @$pb.TagNumber(14)
  $2608.Consent get consent => $_getN(7);
  @$pb.TagNumber(14)
  set consent($2608.Consent v) { setField(14, v); }
  @$pb.TagNumber(14)
  $core.bool hasConsent() => $_has(7);
  @$pb.TagNumber(14)
  void clearConsent() => clearField(14);
  @$pb.TagNumber(14)
  $2608.Consent ensureConsent() => $_ensure(7);
}
...
class ExternalAttributionData extends $pb.GeneratedMessage {
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(_omitMessageNames ? '' : 'ExternalAttributionData', package: const $pb.PackageName(_omitMessageNames ? '' : 'google.ads.googleads.v16.services'), createEmptyInstance: create)
...
class ClickConversionResult extends $pb.GeneratedMessage {
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(_omitMessageNames ? '' : 'ClickConversionResult', package: const $pb.PackageName(_omitMessageNames ? '' : 'google.ads.googleads.v16.services'), createEmptyInstance: create)
    ..aOS(4, _omitFieldNames ? '' : 'gclid')
    ..aOS(5, _omitFieldNames ? '' : 'conversionAction')
    ..aOS(6, _omitFieldNames ? '' : 'conversionDateTime')
    ..pc<$3038.UserIdentifier>(7, _omitFieldNames ? '' : 'userIdentifiers', $pb.PbFieldType.PM, subBuilder: $3038.UserIdentifier.create)
  ...
  /// number of user identifiers for each conversion is 5.
  @$pb.TagNumber(7)
  $core.List<$3038.UserIdentifier> get userIdentifiers => $_getList(3);
...
class CallConversionResult extends $pb.GeneratedMessage {
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(_omitMessageNames ? '' : 'CallConversionResult', package: const $pb.PackageName(_omitMessageNames ? '' : 'google.ads.googleads.v16.services'), createEmptyInstance: create)
...
class CustomVariable extends $pb.GeneratedMessage {
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(_omitMessageNames ? '' : 'CustomVariable', package: const $pb.PackageName(_omitMessageNames ? '' : 'google.ads.googleads.v16.services'), createEmptyInstance: create)
...
class CartData_Item extends $pb.GeneratedMessage {
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(_omitMessageNames ? '' : 'CartData.Item', package: const $pb.PackageName(_omitMessageNames ? '' : 'google.ads.googleads.v16.services'), createEmptyInstance: create)
...
class CartData extends $pb.GeneratedMessage {
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(_omitMessageNames ? '' : 'CartData', package: const $pb.PackageName(_omitMessageNames ? '' : 'google.ads.googleads.v16.services'), createEmptyInstance: create)
