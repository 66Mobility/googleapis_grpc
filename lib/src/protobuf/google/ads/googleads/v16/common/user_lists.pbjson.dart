...
const LookalikeUserListInfo$json = {
  ...
  '2': [
    ...
    {'1': 'expansion_level', '3': 2, '4': 1, '5': 14, '6': '.google.ads.googleads.v16.enums.LookalikeExpansionLevelEnum.LookalikeExpansionLevel', '10': 'expansionLevel'},
...
final $typed_data.Uint8List lookalikeUserListInfoDescriptor = $convert.base64Decode(
    ...
    'bGVhZHMudjE2LmVudW1zLkxvb2thbGlrZUV4cGFuc2lvbkxldmVsRW51bS5Mb29rYWxpa2VFeH'
...
const CrmBasedUserListInfo$json = {
  ...
  '2': [
    ...
    {'1': 'upload_key_type', '3': 2, '4': 1, '5': 14, '6': '.google.ads.googleads.v16.enums.CustomerMatchUploadKeyTypeEnum.CustomerMatchUploadKeyType', '10': 'uploadKeyType'},
    {'1': 'data_source_type', '3': 3, '4': 1, '5': 14, '6': '.google.ads.googleads.v16.enums.UserListCrmDataSourceTypeEnum.UserListCrmDataSourceType', '10': 'dataSourceType'},
  ],
  '8': [
    {'1': '_app_id'},
  ],
...
final $typed_data.Uint8List crmBasedUserListInfoDescriptor = $convert.base64Decode(
    ...
    'VwbG9hZF9rZXlfdHlwZRgCIAEoDjJZLmdvb2dsZS5hZHMuZ29vZ2xlYWRzLnYxNi5lbnVtcy5D'
    ...
    'Lmdvb2dsZWFkcy52MTYuZW51bXMuVXNlckxpc3RDcm1EYXRhU291cmNlVHlwZUVudW0uVXNlck'
...
const UserListRuleInfo$json = {
  '1': 'UserListRuleInfo',
  '2': [
    {'1': 'rule_type', '3': 1, '4': 1, '5': 14, '6': '.google.ads.googleads.v16.enums.UserListRuleTypeEnum.UserListRuleType', '10': 'ruleType'},
    {'1': 'rule_item_groups', '3': 2, '4': 3, '5': 11, '6': '.google.ads.googleads.v16.common.UserListRuleItemGroupInfo', '10': 'ruleItemGroups'},
  ],
};
...
final $typed_data.Uint8List userListRuleInfoDescriptor = $convert.base64Decode(
    ...
    'xlYWRzLnYxNi5lbnVtcy5Vc2VyTGlzdFJ1bGVUeXBlRW51bS5Vc2VyTGlzdFJ1bGVUeXBlUghy'
    'dWxlVHlwZRJkChBydWxlX2l0ZW1fZ3JvdXBzGAIgAygLMjouZ29vZ2xlLmFkcy5nb29nbGVhZH'
    'MudjE2LmNvbW1vbi5Vc2VyTGlzdFJ1bGVJdGVtR3JvdXBJbmZvUg5ydWxlSXRlbUdyb3Vwcw==');
...
const UserListRuleItemGroupInfo$json = {
  ...
  '2': [
    {'1': 'rule_items', '3': 1, '4': 3, '5': 11, '6': '.google.ads.googleads.v16.common.UserListRuleItemInfo', '10': 'ruleItems'},
  ],
};
...
final $typed_data.Uint8List userListRuleItemGroupInfoDescriptor = $convert.base64Decode(
    ...
    'UuYWRzLmdvb2dsZWFkcy52MTYuY29tbW9uLlVzZXJMaXN0UnVsZUl0ZW1JbmZvUglydWxlSXRl'
    'bXM=');
...
const UserListRuleItemInfo$json = {
  ...
  '2': [
    ...
    {'1': 'number_rule_item', '3': 2, '4': 1, '5': 11, '6': '.google.ads.googleads.v16.common.UserListNumberRuleItemInfo', '9': 0, '10': 'numberRuleItem'},
    {'1': 'string_rule_item', '3': 3, '4': 1, '5': 11, '6': '.google.ads.googleads.v16.common.UserListStringRuleItemInfo', '9': 0, '10': 'stringRuleItem'},
    {'1': 'date_rule_item', '3': 4, '4': 1, '5': 11, '6': '.google.ads.googleads.v16.common.UserListDateRuleItemInfo', '9': 0, '10': 'dateRuleItem'},
  ],
  '8': [
    {'1': 'rule_item'},
    {'1': '_name'},
...
final $typed_data.Uint8List userListRuleItemInfoDescriptor = $convert.base64Decode(
    ...
    'VyX3J1bGVfaXRlbRgCIAEoCzI7Lmdvb2dsZS5hZHMuZ29vZ2xlYWRzLnYxNi5jb21tb24uVXNl'
    'ckxpc3ROdW1iZXJSdWxlSXRlbUluZm9IAFIObnVtYmVyUnVsZUl0ZW0SZwoQc3RyaW5nX3J1bG'
    'VfaXRlbRgDIAEoCzI7Lmdvb2dsZS5hZHMuZ29vZ2xlYWRzLnYxNi5jb21tb24uVXNlckxpc3RT'
    'dHJpbmdSdWxlSXRlbUluZm9IAFIOc3RyaW5nUnVsZUl0ZW0SYQoOZGF0ZV9ydWxlX2l0ZW0YBC'
    'ABKAsyOS5nb29nbGUuYWRzLmdvb2dsZWFkcy52MTYuY29tbW9uLlVzZXJMaXN0RGF0ZVJ1bGVJ'
...
const UserListDateRuleItemInfo$json = {
  ...
  '2': [
    {'1': 'operator', '3': 1, '4': 1, '5': 14, '6': '.google.ads.googleads.v16.enums.UserListDateRuleItemOperatorEnum.UserListDateRuleItemOperator', '10': 'operator'},
...
final $typed_data.Uint8List userListDateRuleItemInfoDescriptor = $convert.base64Decode(
    ...
    'RzLmdvb2dsZWFkcy52MTYuZW51bXMuVXNlckxpc3REYXRlUnVsZUl0ZW1PcGVyYXRvckVudW0u'
...
const UserListNumberRuleItemInfo$json = {
  ...
  '2': [
    {'1': 'operator', '3': 1, '4': 1, '5': 14, '6': '.google.ads.googleads.v16.enums.UserListNumberRuleItemOperatorEnum.UserListNumberRuleItemOperator', '10': 'operator'},
...
final $typed_data.Uint8List userListNumberRuleItemInfoDescriptor = $convert.base64Decode(
    ...
    '5hZHMuZ29vZ2xlYWRzLnYxNi5lbnVtcy5Vc2VyTGlzdE51bWJlclJ1bGVJdGVtT3BlcmF0b3JF'
...
const UserListStringRuleItemInfo$json = {
  ...
  '2': [
    {'1': 'operator', '3': 1, '4': 1, '5': 14, '6': '.google.ads.googleads.v16.enums.UserListStringRuleItemOperatorEnum.UserListStringRuleItemOperator', '10': 'operator'},
...
final $typed_data.Uint8List userListStringRuleItemInfoDescriptor = $convert.base64Decode(
    ...
    '5hZHMuZ29vZ2xlYWRzLnYxNi5lbnVtcy5Vc2VyTGlzdFN0cmluZ1J1bGVJdGVtT3BlcmF0b3JF'
...
const FlexibleRuleOperandInfo$json = {
  ...
  '2': [
    {'1': 'rule', '3': 1, '4': 1, '5': 11, '6': '.google.ads.googleads.v16.common.UserListRuleInfo', '10': 'rule'},
...
final $typed_data.Uint8List flexibleRuleOperandInfoDescriptor = $convert.base64Decode(
    ...
    '9nbGVhZHMudjE2LmNvbW1vbi5Vc2VyTGlzdFJ1bGVJbmZvUgRydWxlEjUKFGxvb2tiYWNrX3dp'
...
const FlexibleRuleUserListInfo$json = {
  ...
  '2': [
    {'1': 'inclusive_rule_operator', '3': 1, '4': 1, '5': 14, '6': '.google.ads.googleads.v16.enums.UserListFlexibleRuleOperatorEnum.UserListFlexibleRuleOperator', '10': 'inclusiveRuleOperator'},
    {'1': 'inclusive_operands', '3': 2, '4': 3, '5': 11, '6': '.google.ads.googleads.v16.common.FlexibleRuleOperandInfo', '10': 'inclusiveOperands'},
    {'1': 'exclusive_operands', '3': 3, '4': 3, '5': 11, '6': '.google.ads.googleads.v16.common.FlexibleRuleOperandInfo', '10': 'exclusiveOperands'},
  ],
};
...
final $typed_data.Uint8List flexibleRuleUserListInfoDescriptor = $convert.base64Decode(
    ...
    'EgASgOMl0uZ29vZ2xlLmFkcy5nb29nbGVhZHMudjE2LmVudW1zLlVzZXJMaXN0RmxleGlibGVS'
    ...
    'b2dsZWFkcy52MTYuY29tbW9uLkZsZXhpYmxlUnVsZU9wZXJhbmRJbmZvUhFpbmNsdXNpdmVPcG'
    'VyYW5kcxJnChJleGNsdXNpdmVfb3BlcmFuZHMYAyADKAsyOC5nb29nbGUuYWRzLmdvb2dsZWFk'
    'cy52MTYuY29tbW9uLkZsZXhpYmxlUnVsZU9wZXJhbmRJbmZvUhFleGNsdXNpdmVPcGVyYW5kcw'
    '==');
...
const RuleBasedUserListInfo$json = {
  ...
  '2': [
    {'1': 'prepopulation_status', '3': 1, '4': 1, '5': 14, '6': '.google.ads.googleads.v16.enums.UserListPrepopulationStatusEnum.UserListPrepopulationStatus', '10': 'prepopulationStatus'},
    {'1': 'flexible_rule_user_list', '3': 5, '4': 1, '5': 11, '6': '.google.ads.googleads.v16.common.FlexibleRuleUserListInfo', '10': 'flexibleRuleUserList'},
  ],
};
...
final $typed_data.Uint8List ruleBasedUserListInfoDescriptor = $convert.base64Decode(
    ...
    'suZ29vZ2xlLmFkcy5nb29nbGVhZHMudjE2LmVudW1zLlVzZXJMaXN0UHJlcG9wdWxhdGlvblN0'
    ...
    'ZHMudjE2LmNvbW1vbi5GbGV4aWJsZVJ1bGVVc2VyTGlzdEluZm9SFGZsZXhpYmxlUnVsZVVzZX'
    'JMaXN0');
...
const LogicalUserListInfo$json = {
  ...
  '2': [
    {'1': 'rules', '3': 1, '4': 3, '5': 11, '6': '.google.ads.googleads.v16.common.UserListLogicalRuleInfo', '10': 'rules'},
  ],
};
...
final $typed_data.Uint8List logicalUserListInfoDescriptor = $convert.base64Decode(
    ...
    'VhZHMudjE2LmNvbW1vbi5Vc2VyTGlzdExvZ2ljYWxSdWxlSW5mb1IFcnVsZXM=');

@$core.Deprecated('Use userListLogicalRuleInfoDescriptor instead')
const UserListLogicalRuleInfo$json = {
  '1': 'UserListLogicalRuleInfo',
  '2': [
    {'1': 'operator', '3': 1, '4': 1, '5': 14, '6': '.google.ads.googleads.v16.enums.UserListLogicalRuleOperatorEnum.UserListLogicalRuleOperator', '10': 'operator'},
    {'1': 'rule_operands', '3': 2, '4': 3, '5': 11, '6': '.google.ads.googleads.v16.common.LogicalUserListOperandInfo', '10': 'ruleOperands'},
  ],
};
...
final $typed_data.Uint8List userListLogicalRuleInfoDescriptor = $convert.base64Decode(
    ...
    'MuZ29vZ2xlYWRzLnYxNi5lbnVtcy5Vc2VyTGlzdExvZ2ljYWxSdWxlT3BlcmF0b3JFbnVtLlVz'
    'ZXJMaXN0TG9naWNhbFJ1bGVPcGVyYXRvclIIb3BlcmF0b3ISYAoNcnVsZV9vcGVyYW5kcxgCIA'
    'MoCzI7Lmdvb2dsZS5hZHMuZ29vZ2xlYWRzLnYxNi5jb21tb24uTG9naWNhbFVzZXJMaXN0T3Bl'
...
const BasicUserListInfo$json = {
  '1': 'BasicUserListInfo',
  '2': [
    {'1': 'actions', '3': 1, '4': 3, '5': 11, '6': '.google.ads.googleads.v16.common.UserListActionInfo', '10': 'actions'},
  ],
};
...
final $typed_data.Uint8List basicUserListInfoDescriptor = $convert.base64Decode(
    ...
    'VhZHMudjE2LmNvbW1vbi5Vc2VyTGlzdEFjdGlvbkluZm9SB2FjdGlvbnM=');
