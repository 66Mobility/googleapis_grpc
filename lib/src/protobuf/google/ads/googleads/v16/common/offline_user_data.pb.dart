...
import '../enums/user_identifier_source.pbenum.dart' as $2609;
import 'consent.pb.dart' as $2608;
...
class OfflineUserAddressInfo extends $pb.GeneratedMessage {
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(_omitMessageNames ? '' : 'OfflineUserAddressInfo', package: const $pb.PackageName(_omitMessageNames ? '' : 'google.ads.googleads.v16.common'), createEmptyInstance: create)
...
class UserIdentifier extends $pb.GeneratedMessage {
  factory UserIdentifier({
    ...
    $2609.UserIdentifierSourceEnum_UserIdentifierSource? userIdentifierSource,
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(_omitMessageNames ? '' : 'UserIdentifier', package: const $pb.PackageName(_omitMessageNames ? '' : 'google.ads.googleads.v16.common'), createEmptyInstance: create)
    ..oo(0, [5, 7, 8, 9, 10])
    ..aOM<OfflineUserAddressInfo>(5, _omitFieldNames ? '' : 'addressInfo', subBuilder: OfflineUserAddressInfo.create)
    ..e<$2609.UserIdentifierSourceEnum_UserIdentifierSource>(6, _omitFieldNames ? '' : 'userIdentifierSource', $pb.PbFieldType.OE, defaultOrMaker: $2609.UserIdentifierSourceEnum_UserIdentifierSource.UNSPECIFIED, valueOf: $2609.UserIdentifierSourceEnum_UserIdentifierSource.valueOf, enumValues: $2609.UserIdentifierSourceEnum_UserIdentifierSource.values)
  ...
  @$pb.TagNumber(6)
  $2609.UserIdentifierSourceEnum_UserIdentifierSource get userIdentifierSource => $_getN(1);
  @$pb.TagNumber(6)
  set userIdentifierSource($2609.UserIdentifierSourceEnum_UserIdentifierSource v) { setField(6, v); }
  @$pb.TagNumber(6)
...
class TransactionAttribute extends $pb.GeneratedMessage {
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(_omitMessageNames ? '' : 'TransactionAttribute', package: const $pb.PackageName(_omitMessageNames ? '' : 'google.ads.googleads.v16.common'), createEmptyInstance: create)
...
class StoreAttribute extends $pb.GeneratedMessage {
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(_omitMessageNames ? '' : 'StoreAttribute', package: const $pb.PackageName(_omitMessageNames ? '' : 'google.ads.googleads.v16.common'), createEmptyInstance: create)
...
class ItemAttribute extends $pb.GeneratedMessage {
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(_omitMessageNames ? '' : 'ItemAttribute', package: const $pb.PackageName(_omitMessageNames ? '' : 'google.ads.googleads.v16.common'), createEmptyInstance: create)
...
class UserData extends $pb.GeneratedMessage {
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(_omitMessageNames ? '' : 'UserData', package: const $pb.PackageName(_omitMessageNames ? '' : 'google.ads.googleads.v16.common'), createEmptyInstance: create)
    ...
    ..aOM<$2608.Consent>(4, _omitFieldNames ? '' : 'consent', subBuilder: $2608.Consent.create)
    ..hasRequiredFields = false
  ;
  ...
  @$pb.TagNumber(4)
  $2608.Consent get consent => $_getN(3);
  @$pb.TagNumber(4)
  set consent($2608.Consent v) { setField(4, v); }
  @$pb.TagNumber(4)
  $core.bool hasConsent() => $_has(3);
  @$pb.TagNumber(4)
  void clearConsent() => clearField(4);
  @$pb.TagNumber(4)
  $2608.Consent ensureConsent() => $_ensure(3);
}
...
class UserAttribute extends $pb.GeneratedMessage {
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(_omitMessageNames ? '' : 'UserAttribute', package: const $pb.PackageName(_omitMessageNames ? '' : 'google.ads.googleads.v16.common'), createEmptyInstance: create)
...
class EventAttribute extends $pb.GeneratedMessage {
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(_omitMessageNames ? '' : 'EventAttribute', package: const $pb.PackageName(_omitMessageNames ? '' : 'google.ads.googleads.v16.common'), createEmptyInstance: create)
...
class EventItemAttribute extends $pb.GeneratedMessage {
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(_omitMessageNames ? '' : 'EventItemAttribute', package: const $pb.PackageName(_omitMessageNames ? '' : 'google.ads.googleads.v16.common'), createEmptyInstance: create)
    ..aOS(1, _omitFieldNames ? '' : 'itemId')
    ..hasRequiredFields = false
  ;
...
class ShoppingLoyalty extends $pb.GeneratedMessage {
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(_omitMessageNames ? '' : 'ShoppingLoyalty', package: const $pb.PackageName(_omitMessageNames ? '' : 'google.ads.googleads.v16.common'), createEmptyInstance: create)
...
class CustomerMatchUserListMetadata extends $pb.GeneratedMessage {
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(_omitMessageNames ? '' : 'CustomerMatchUserListMetadata', package: const $pb.PackageName(_omitMessageNames ? '' : 'google.ads.googleads.v16.common'), createEmptyInstance: create)
    ..aOS(2, _omitFieldNames ? '' : 'userList')
    ..aOM<$2608.Consent>(3, _omitFieldNames ? '' : 'consent', subBuilder: $2608.Consent.create)
    ..hasRequiredFields = false
  ;
  ...
  @$pb.TagNumber(3)
  $2608.Consent get consent => $_getN(1);
  @$pb.TagNumber(3)
  set consent($2608.Consent v) { setField(3, v); }
  @$pb.TagNumber(3)
  $core.bool hasConsent() => $_has(1);
  @$pb.TagNumber(3)
  void clearConsent() => clearField(3);
  @$pb.TagNumber(3)
  $2608.Consent ensureConsent() => $_ensure(1);
}
...
class StoreSalesMetadata extends $pb.GeneratedMessage {
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(_omitMessageNames ? '' : 'StoreSalesMetadata', package: const $pb.PackageName(_omitMessageNames ? '' : 'google.ads.googleads.v16.common'), createEmptyInstance: create)
...
class StoreSalesThirdPartyMetadata extends $pb.GeneratedMessage {
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(_omitMessageNames ? '' : 'StoreSalesThirdPartyMetadata', package: const $pb.PackageName(_omitMessageNames ? '' : 'google.ads.googleads.v16.common'), createEmptyInstance: create)
