...
import '../enums/app_store.pbenum.dart' as $2592;
...
class AppFeedItem extends $pb.GeneratedMessage {
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(_omitMessageNames ? '' : 'AppFeedItem', package: const $pb.PackageName(_omitMessageNames ? '' : 'google.ads.googleads.v16.common'), createEmptyInstance: create)
    ..e<$2592.AppStoreEnum_AppStore>(3, _omitFieldNames ? '' : 'appStore', $pb.PbFieldType.OE, defaultOrMaker: $2592.AppStoreEnum_AppStore.UNSPECIFIED, valueOf: $2592.AppStoreEnum_AppStore.valueOf, enumValues: $2592.AppStoreEnum_AppStore.values)
    ..pc<$2591.CustomParameter>(7, _omitFieldNames ? '' : 'urlCustomParameters', $pb.PbFieldType.PM, subBuilder: $2591.CustomParameter.create)
  ...
  @$pb.TagNumber(3)
  $2592.AppStoreEnum_AppStore get appStore => $_getN(0);
  @$pb.TagNumber(3)
  set appStore($2592.AppStoreEnum_AppStore v) { setField(3, v); }
  @$pb.TagNumber(3)
  ...
  @$pb.TagNumber(7)
  $core.List<$2591.CustomParameter> get urlCustomParameters => $_getList(1);
...
class CallFeedItem extends $pb.GeneratedMessage {
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(_omitMessageNames ? '' : 'CallFeedItem', package: const $pb.PackageName(_omitMessageNames ? '' : 'google.ads.googleads.v16.common'), createEmptyInstance: create)
    ..e<$2540.CallConversionReportingStateEnum_CallConversionReportingState>(6, _omitFieldNames ? '' : 'callConversionReportingState', $pb.PbFieldType.OE, defaultOrMaker: $2540.CallConversionReportingStateEnum_CallConversionReportingState.UNSPECIFIED, valueOf: $2540.CallConversionReportingStateEnum_CallConversionReportingState.valueOf, enumValues: $2540.CallConversionReportingStateEnum_CallConversionReportingState.values)
  ...
  @$pb.TagNumber(6)
  $2540.CallConversionReportingStateEnum_CallConversionReportingState get callConversionReportingState => $_getN(0);
  @$pb.TagNumber(6)
  set callConversionReportingState($2540.CallConversionReportingStateEnum_CallConversionReportingState v) { setField(6, v); }
  @$pb.TagNumber(6)
...
class CalloutFeedItem extends $pb.GeneratedMessage {
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(_omitMessageNames ? '' : 'CalloutFeedItem', package: const $pb.PackageName(_omitMessageNames ? '' : 'google.ads.googleads.v16.common'), createEmptyInstance: create)
...
class LocationFeedItem extends $pb.GeneratedMessage {
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(_omitMessageNames ? '' : 'LocationFeedItem', package: const $pb.PackageName(_omitMessageNames ? '' : 'google.ads.googleads.v16.common'), createEmptyInstance: create)
...
class AffiliateLocationFeedItem extends $pb.GeneratedMessage {
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(_omitMessageNames ? '' : 'AffiliateLocationFeedItem', package: const $pb.PackageName(_omitMessageNames ? '' : 'google.ads.googleads.v16.common'), createEmptyInstance: create)
...
class TextMessageFeedItem extends $pb.GeneratedMessage {
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(_omitMessageNames ? '' : 'TextMessageFeedItem', package: const $pb.PackageName(_omitMessageNames ? '' : 'google.ads.googleads.v16.common'), createEmptyInstance: create)
...
class PriceFeedItem extends $pb.GeneratedMessage {
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(_omitMessageNames ? '' : 'PriceFeedItem', package: const $pb.PackageName(_omitMessageNames ? '' : 'google.ads.googleads.v16.common'), createEmptyInstance: create)
...
class PriceOffer extends $pb.GeneratedMessage {
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(_omitMessageNames ? '' : 'PriceOffer', package: const $pb.PackageName(_omitMessageNames ? '' : 'google.ads.googleads.v16.common'), createEmptyInstance: create)
  ...
  @$pb.TagNumber(3)
  $2569.Money ensurePrice() => $_ensure(0);

  /// Price unit for this offer.
  @$pb.TagNumber(4)
  $2580.PriceExtensionPriceUnitEnum_PriceExtensionPriceUnit get unit => $_getN(1);
  @$pb.TagNumber(4)
...
class PromotionFeedItem extends $pb.GeneratedMessage {
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(_omitMessageNames ? '' : 'PromotionFeedItem', package: const $pb.PackageName(_omitMessageNames ? '' : 'google.ads.googleads.v16.common'), createEmptyInstance: create)
    ..oo(0, [4, 17])
    ..oo(1, [6, 18])
    ...
    ..pc<$2591.CustomParameter>(13, _omitFieldNames ? '' : 'urlCustomParameters', $pb.PbFieldType.PM, subBuilder: $2591.CustomParameter.create)
  ...
  @$pb.TagNumber(2)
  $2575.PromotionExtensionDiscountModifierEnum_PromotionExtensionDiscountModifier get discountModifier => $_getN(0);
  @$pb.TagNumber(2)
  ...
  @$pb.TagNumber(4)
  $2569.Money get moneyAmountOff => $_getN(1);
  @$pb.TagNumber(4)
  ...
  @$pb.TagNumber(4)
  $2569.Money ensureMoneyAmountOff() => $_ensure(1);

  /// The amount the total order needs to be for the user to be eligible for
  /// the promotion.
  @$pb.TagNumber(6)
  $2569.Money get ordersOverAmount => $_getN(2);
  @$pb.TagNumber(6)
  ...
  @$pb.TagNumber(6)
  $2569.Money ensureOrdersOverAmount() => $_ensure(2);

  /// The occasion the promotion was intended for.
  /// If an occasion is set, the redemption window will need to fall within
  /// the date range associated with the occasion.
  @$pb.TagNumber(9)
  $2576.PromotionExtensionOccasionEnum_PromotionExtensionOccasion get occasion => $_getN(3);
  @$pb.TagNumber(9)
...
class StructuredSnippetFeedItem extends $pb.GeneratedMessage {
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(_omitMessageNames ? '' : 'StructuredSnippetFeedItem', package: const $pb.PackageName(_omitMessageNames ? '' : 'google.ads.googleads.v16.common'), createEmptyInstance: create)
...
class SitelinkFeedItem extends $pb.GeneratedMessage {
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(_omitMessageNames ? '' : 'SitelinkFeedItem', package: const $pb.PackageName(_omitMessageNames ? '' : 'google.ads.googleads.v16.common'), createEmptyInstance: create)
    ..pc<$2591.CustomParameter>(7, _omitFieldNames ? '' : 'urlCustomParameters', $pb.PbFieldType.PM, subBuilder: $2591.CustomParameter.create)
    ..aOS(9, _omitFieldNames ? '' : 'linkText')
  ...
  /// the tracking_url_template, final_urls, and/or final_mobile_urls.
  @$pb.TagNumber(7)
  $core.List<$2591.CustomParameter> get urlCustomParameters => $_getList(0);
...
class HotelCalloutFeedItem extends $pb.GeneratedMessage {
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(_omitMessageNames ? '' : 'HotelCalloutFeedItem', package: const $pb.PackageName(_omitMessageNames ? '' : 'google.ads.googleads.v16.common'), createEmptyInstance: create)
...
class ImageFeedItem extends $pb.GeneratedMessage {
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(_omitMessageNames ? '' : 'ImageFeedItem', package: const $pb.PackageName(_omitMessageNames ? '' : 'google.ads.googleads.v16.common'), createEmptyInstance: create)
