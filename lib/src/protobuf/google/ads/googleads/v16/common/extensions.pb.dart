...
import '../enums/app_store.pbenum.dart' as $2593;
...
class AppFeedItem extends $pb.GeneratedMessage {
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(_omitMessageNames ? '' : 'AppFeedItem', package: const $pb.PackageName(_omitMessageNames ? '' : 'google.ads.googleads.v16.common'), createEmptyInstance: create)
    ..e<$2593.AppStoreEnum_AppStore>(3, _omitFieldNames ? '' : 'appStore', $pb.PbFieldType.OE, defaultOrMaker: $2593.AppStoreEnum_AppStore.UNSPECIFIED, valueOf: $2593.AppStoreEnum_AppStore.valueOf, enumValues: $2593.AppStoreEnum_AppStore.values)
    ..pc<$2592.CustomParameter>(7, _omitFieldNames ? '' : 'urlCustomParameters', $pb.PbFieldType.PM, subBuilder: $2592.CustomParameter.create)
  ...
  @$pb.TagNumber(3)
  $2593.AppStoreEnum_AppStore get appStore => $_getN(0);
  @$pb.TagNumber(3)
  set appStore($2593.AppStoreEnum_AppStore v) { setField(3, v); }
  @$pb.TagNumber(3)
  ...
  @$pb.TagNumber(7)
  $core.List<$2592.CustomParameter> get urlCustomParameters => $_getList(1);
...
class CallFeedItem extends $pb.GeneratedMessage {
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(_omitMessageNames ? '' : 'CallFeedItem', package: const $pb.PackageName(_omitMessageNames ? '' : 'google.ads.googleads.v16.common'), createEmptyInstance: create)
    ..e<$2541.CallConversionReportingStateEnum_CallConversionReportingState>(6, _omitFieldNames ? '' : 'callConversionReportingState', $pb.PbFieldType.OE, defaultOrMaker: $2541.CallConversionReportingStateEnum_CallConversionReportingState.UNSPECIFIED, valueOf: $2541.CallConversionReportingStateEnum_CallConversionReportingState.valueOf, enumValues: $2541.CallConversionReportingStateEnum_CallConversionReportingState.values)
  ...
  @$pb.TagNumber(6)
  $2541.CallConversionReportingStateEnum_CallConversionReportingState get callConversionReportingState => $_getN(0);
  @$pb.TagNumber(6)
  set callConversionReportingState($2541.CallConversionReportingStateEnum_CallConversionReportingState v) { setField(6, v); }
  @$pb.TagNumber(6)
...
class PriceOffer extends $pb.GeneratedMessage {
  ...
  @$pb.TagNumber(3)
  $2570.Money ensurePrice() => $_ensure(0);

  /// Price unit for this offer.
  @$pb.TagNumber(4)
  $2581.PriceExtensionPriceUnitEnum_PriceExtensionPriceUnit get unit => $_getN(1);
  @$pb.TagNumber(4)
...
class PromotionFeedItem extends $pb.GeneratedMessage {
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(_omitMessageNames ? '' : 'PromotionFeedItem', package: const $pb.PackageName(_omitMessageNames ? '' : 'google.ads.googleads.v16.common'), createEmptyInstance: create)
    ...
    ..pc<$2592.CustomParameter>(13, _omitFieldNames ? '' : 'urlCustomParameters', $pb.PbFieldType.PM, subBuilder: $2592.CustomParameter.create)
  ...
  @$pb.TagNumber(2)
  $2576.PromotionExtensionDiscountModifierEnum_PromotionExtensionDiscountModifier get discountModifier => $_getN(0);
  @$pb.TagNumber(2)
  ...
  @$pb.TagNumber(4)
  $2570.Money get moneyAmountOff => $_getN(1);
  @$pb.TagNumber(4)
  ...
  @$pb.TagNumber(4)
  $2570.Money ensureMoneyAmountOff() => $_ensure(1);

  /// The amount the total order needs to be for the user to be eligible for
  /// the promotion.
  @$pb.TagNumber(6)
  $2570.Money get ordersOverAmount => $_getN(2);
  @$pb.TagNumber(6)
  ...
  @$pb.TagNumber(6)
  $2570.Money ensureOrdersOverAmount() => $_ensure(2);

  /// The occasion the promotion was intended for.
  /// If an occasion is set, the redemption window will need to fall within
  /// the date range associated with the occasion.
  @$pb.TagNumber(9)
  $2577.PromotionExtensionOccasionEnum_PromotionExtensionOccasion get occasion => $_getN(3);
  @$pb.TagNumber(9)
...
class SitelinkFeedItem extends $pb.GeneratedMessage {
  ...
  /// the tracking_url_template, final_urls, and/or final_mobile_urls.
  @$pb.TagNumber(7)
  $core.List<$2592.CustomParameter> get urlCustomParameters => $_getList(0);
