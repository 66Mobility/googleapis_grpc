...
import '../enums/matching_function_context_type.pbenum.dart' as $2603;
import '../enums/matching_function_operator.pbenum.dart' as $2602;
...
class MatchingFunction extends $pb.GeneratedMessage {
  factory MatchingFunction({
    ...
    $2602.MatchingFunctionOperatorEnum_MatchingFunctionOperator? operator,
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(_omitMessageNames ? '' : 'MatchingFunction', package: const $pb.PackageName(_omitMessageNames ? '' : 'google.ads.googleads.v16.common'), createEmptyInstance: create)
    ...
    ..e<$2602.MatchingFunctionOperatorEnum_MatchingFunctionOperator>(4, _omitFieldNames ? '' : 'operator', $pb.PbFieldType.OE, defaultOrMaker: $2602.MatchingFunctionOperatorEnum_MatchingFunctionOperator.UNSPECIFIED, valueOf: $2602.MatchingFunctionOperatorEnum_MatchingFunctionOperator.valueOf, enumValues: $2602.MatchingFunctionOperatorEnum_MatchingFunctionOperator.values)
  ...
  @$pb.TagNumber(4)
  $2602.MatchingFunctionOperatorEnum_MatchingFunctionOperator get operator => $_getN(2);
  @$pb.TagNumber(4)
  set operator($2602.MatchingFunctionOperatorEnum_MatchingFunctionOperator v) { setField(4, v); }
  @$pb.TagNumber(4)
...
class Operand_RequestContextOperand extends $pb.GeneratedMessage {
  factory Operand_RequestContextOperand({
    $2603.MatchingFunctionContextTypeEnum_MatchingFunctionContextType? contextType,
  }) {
    final $result = create();
    if (contextType != null) {
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(_omitMessageNames ? '' : 'Operand.RequestContextOperand', package: const $pb.PackageName(_omitMessageNames ? '' : 'google.ads.googleads.v16.common'), createEmptyInstance: create)
    ..e<$2603.MatchingFunctionContextTypeEnum_MatchingFunctionContextType>(1, _omitFieldNames ? '' : 'contextType', $pb.PbFieldType.OE, defaultOrMaker: $2603.MatchingFunctionContextTypeEnum_MatchingFunctionContextType.UNSPECIFIED, valueOf: $2603.MatchingFunctionContextTypeEnum_MatchingFunctionContextType.valueOf, enumValues: $2603.MatchingFunctionContextTypeEnum_MatchingFunctionContextType.values)
    ..hasRequiredFields = false
  ;
  ...
  @$pb.TagNumber(1)
  $2603.MatchingFunctionContextTypeEnum_MatchingFunctionContextType get contextType => $_getN(0);
  @$pb.TagNumber(1)
  set contextType($2603.MatchingFunctionContextTypeEnum_MatchingFunctionContextType v) { setField(1, v); }
  @$pb.TagNumber(1)
