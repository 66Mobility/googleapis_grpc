...
import '../enums/chain_relationship_type.pbenum.dart' as $2542;
import '../enums/location_ownership_type.pbenum.dart' as $2541;
import '../enums/location_string_filter_type.pbenum.dart' as $2543;
...
class LocationSet extends $pb.GeneratedMessage {
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(_omitMessageNames ? '' : 'LocationSet', package: const $pb.PackageName(_omitMessageNames ? '' : 'google.ads.googleads.v16.common'), createEmptyInstance: create)
    ..oo(0, [1, 2, 5])
...
class BusinessProfileLocationSet extends $pb.GeneratedMessage {
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(_omitMessageNames ? '' : 'BusinessProfileLocationSet', package: const $pb.PackageName(_omitMessageNames ? '' : 'google.ads.googleads.v16.common'), createEmptyInstance: create)
...
class ChainSet extends $pb.GeneratedMessage {
  factory ChainSet({
    $2542.ChainRelationshipTypeEnum_ChainRelationshipType? relationshipType,
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(_omitMessageNames ? '' : 'ChainSet', package: const $pb.PackageName(_omitMessageNames ? '' : 'google.ads.googleads.v16.common'), createEmptyInstance: create)
    ..e<$2542.ChainRelationshipTypeEnum_ChainRelationshipType>(1, _omitFieldNames ? '' : 'relationshipType', $pb.PbFieldType.OE, defaultOrMaker: $2542.ChainRelationshipTypeEnum_ChainRelationshipType.UNSPECIFIED, valueOf: $2542.ChainRelationshipTypeEnum_ChainRelationshipType.valueOf, enumValues: $2542.ChainRelationshipTypeEnum_ChainRelationshipType.values)
  ...
  /// advertiser.
  @$pb.TagNumber(1)
  $2542.ChainRelationshipTypeEnum_ChainRelationshipType get relationshipType => $_getN(0);
  @$pb.TagNumber(1)
  set relationshipType($2542.ChainRelationshipTypeEnum_ChainRelationshipType v) { setField(1, v); }
  @$pb.TagNumber(1)
...
class ChainFilter extends $pb.GeneratedMessage {
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(_omitMessageNames ? '' : 'ChainFilter', package: const $pb.PackageName(_omitMessageNames ? '' : 'google.ads.googleads.v16.common'), createEmptyInstance: create)
...
class MapsLocationSet extends $pb.GeneratedMessage {
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(_omitMessageNames ? '' : 'MapsLocationSet', package: const $pb.PackageName(_omitMessageNames ? '' : 'google.ads.googleads.v16.common'), createEmptyInstance: create)
...
class MapsLocationInfo extends $pb.GeneratedMessage {
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(_omitMessageNames ? '' : 'MapsLocationInfo', package: const $pb.PackageName(_omitMessageNames ? '' : 'google.ads.googleads.v16.common'), createEmptyInstance: create)
...
class BusinessProfileLocationGroup extends $pb.GeneratedMessage {
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(_omitMessageNames ? '' : 'BusinessProfileLocationGroup', package: const $pb.PackageName(_omitMessageNames ? '' : 'google.ads.googleads.v16.common'), createEmptyInstance: create)
...
class DynamicBusinessProfileLocationGroupFilter extends $pb.GeneratedMessage {
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(_omitMessageNames ? '' : 'DynamicBusinessProfileLocationGroupFilter', package: const $pb.PackageName(_omitMessageNames ? '' : 'google.ads.googleads.v16.common'), createEmptyInstance: create)
...
class BusinessProfileBusinessNameFilter extends $pb.GeneratedMessage {
  factory BusinessProfileBusinessNameFilter({
    ...
    $2543.LocationStringFilterTypeEnum_LocationStringFilterType? filterType,
  }) {
    final $result = create();
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(_omitMessageNames ? '' : 'BusinessProfileBusinessNameFilter', package: const $pb.PackageName(_omitMessageNames ? '' : 'google.ads.googleads.v16.common'), createEmptyInstance: create)
    ..aOS(1, _omitFieldNames ? '' : 'businessName')
    ..e<$2543.LocationStringFilterTypeEnum_LocationStringFilterType>(2, _omitFieldNames ? '' : 'filterType', $pb.PbFieldType.OE, defaultOrMaker: $2543.LocationStringFilterTypeEnum_LocationStringFilterType.UNSPECIFIED, valueOf: $2543.LocationStringFilterTypeEnum_LocationStringFilterType.valueOf, enumValues: $2543.LocationStringFilterTypeEnum_LocationStringFilterType.values)
    ..hasRequiredFields = false
  ;
  ...
  @$pb.TagNumber(2)
  $2543.LocationStringFilterTypeEnum_LocationStringFilterType get filterType => $_getN(1);
  @$pb.TagNumber(2)
  set filterType($2543.LocationStringFilterTypeEnum_LocationStringFilterType v) { setField(2, v); }
  @$pb.TagNumber(2)
...
class ChainLocationGroup extends $pb.GeneratedMessage {
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(_omitMessageNames ? '' : 'ChainLocationGroup', package: const $pb.PackageName(_omitMessageNames ? '' : 'google.ads.googleads.v16.common'), createEmptyInstance: create)
