...
import '../enums/display_ad_format_setting.pbenum.dart' as $2538;
import '../enums/display_upload_product_type.pbenum.dart' as $2540;
import '../enums/legacy_app_install_ad_app_store.pbenum.dart' as $2539;
import '../enums/mime_type.pbenum.dart' as $2536;
import '../enums/video_thumbnail.pbenum.dart' as $2537;
import 'ad_asset.pb.dart' as $2535;
...
class ImageAdInfo extends $pb.GeneratedMessage {
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(_omitMessageNames ? '' : 'ImageAdInfo', package: const $pb.PackageName(_omitMessageNames ? '' : 'google.ads.googleads.v16.common'), createEmptyInstance: create)
    ..oo(0, [13, 14, 22])
    ..e<$2536.MimeTypeEnum_MimeType>(10, _omitFieldNames ? '' : 'mimeType', $pb.PbFieldType.OE, defaultOrMaker: $2536.MimeTypeEnum_MimeType.UNSPECIFIED, valueOf: $2536.MimeTypeEnum_MimeType.valueOf, enumValues: $2536.MimeTypeEnum_MimeType.values)
    ...
    ..aOM<$2535.AdImageAsset>(22, _omitFieldNames ? '' : 'imageAsset', subBuilder: $2535.AdImageAsset.create)
    ..hasRequiredFields = false
  ;
  ...
  @$pb.TagNumber(10)
  set mimeType($2536.MimeTypeEnum_MimeType v) { setField(10, v); }
  @$pb.TagNumber(10)
  ...
  @$pb.TagNumber(22)
  $2535.AdImageAsset get imageAsset => $_getN(10);
  @$pb.TagNumber(22)
  set imageAsset($2535.AdImageAsset v) { setField(22, v); }
  @$pb.TagNumber(22)
  $core.bool hasImageAsset() => $_has(10);
  @$pb.TagNumber(22)
  void clearImageAsset() => clearField(22);
  @$pb.TagNumber(22)
  $2535.AdImageAsset ensureImageAsset() => $_ensure(10);
}
...
class VideoBumperInStreamAdInfo extends $pb.GeneratedMessage {
  factory VideoBumperInStreamAdInfo({
    $2535.AdImageAsset? companionBanner,
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(_omitMessageNames ? '' : 'VideoBumperInStreamAdInfo', package: const $pb.PackageName(_omitMessageNames ? '' : 'google.ads.googleads.v16.common'), createEmptyInstance: create)
    ..aOM<$2535.AdImageAsset>(3, _omitFieldNames ? '' : 'companionBanner', subBuilder: $2535.AdImageAsset.create)
  ...
  @$pb.TagNumber(3)
  $2535.AdImageAsset get companionBanner => $_getN(0);
  @$pb.TagNumber(3)
  set companionBanner($2535.AdImageAsset v) { setField(3, v); }
  @$pb.TagNumber(3)
  $core.bool hasCompanionBanner() => $_has(0);
  @$pb.TagNumber(3)
  void clearCompanionBanner() => clearField(3);
  @$pb.TagNumber(3)
  $2535.AdImageAsset ensureCompanionBanner() => $_ensure(0);
...
class VideoNonSkippableInStreamAdInfo extends $pb.GeneratedMessage {
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(_omitMessageNames ? '' : 'VideoNonSkippableInStreamAdInfo', package: const $pb.PackageName(_omitMessageNames ? '' : 'google.ads.googleads.v16.common'), createEmptyInstance: create)
    ...
    ..aOM<$2535.AdImageAsset>(5, _omitFieldNames ? '' : 'companionBanner', subBuilder: $2535.AdImageAsset.create)
    ..hasRequiredFields = false
  ;
  ...
  /// The image assets of the companion banner used with the ad.
  @$pb.TagNumber(5)
  $2535.AdImageAsset get companionBanner => $_getN(2);
  @$pb.TagNumber(5)
  set companionBanner($2535.AdImageAsset v) { setField(5, v); }
  @$pb.TagNumber(5)
  $core.bool hasCompanionBanner() => $_has(2);
  @$pb.TagNumber(5)
  void clearCompanionBanner() => clearField(5);
  @$pb.TagNumber(5)
  $2535.AdImageAsset ensureCompanionBanner() => $_ensure(2);
}
...
class VideoTrueViewInStreamAdInfo extends $pb.GeneratedMessage {
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(_omitMessageNames ? '' : 'VideoTrueViewInStreamAdInfo', package: const $pb.PackageName(_omitMessageNames ? '' : 'google.ads.googleads.v16.common'), createEmptyInstance: create)
    ..aOS(4, _omitFieldNames ? '' : 'actionButtonLabel')
    ..aOS(5, _omitFieldNames ? '' : 'actionHeadline')
    ..aOM<$2535.AdImageAsset>(7, _omitFieldNames ? '' : 'companionBanner', subBuilder: $2535.AdImageAsset.create)
    ..hasRequiredFields = false
  ;
  ...
  $2535.AdImageAsset get companionBanner => $_getN(2);
  @$pb.TagNumber(7)
  set companionBanner($2535.AdImageAsset v) { setField(7, v); }
  @$pb.TagNumber(7)
  $core.bool hasCompanionBanner() => $_has(2);
  @$pb.TagNumber(7)
...
class InFeedVideoAdInfo extends $pb.GeneratedMessage {
  factory InFeedVideoAdInfo({
    ...
    $core.String? description1,
    $core.String? description2,
    $2537.VideoThumbnailEnum_VideoThumbnail? thumbnail,
  }) {
    final $result = create();
    if (headline != null) {
      $result.headline = headline;
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(_omitMessageNames ? '' : 'InFeedVideoAdInfo', package: const $pb.PackageName(_omitMessageNames ? '' : 'google.ads.googleads.v16.common'), createEmptyInstance: create)
    ...
    ..e<$2537.VideoThumbnailEnum_VideoThumbnail>(4, _omitFieldNames ? '' : 'thumbnail', $pb.PbFieldType.OE, defaultOrMaker: $2537.VideoThumbnailEnum_VideoThumbnail.UNSPECIFIED, valueOf: $2537.VideoThumbnailEnum_VideoThumbnail.valueOf, enumValues: $2537.VideoThumbnailEnum_VideoThumbnail.values)
    ..hasRequiredFields = false
  ;
  ...
  @$pb.TagNumber(4)
  $2537.VideoThumbnailEnum_VideoThumbnail get thumbnail => $_getN(3);
  @$pb.TagNumber(4)
  set thumbnail($2537.VideoThumbnailEnum_VideoThumbnail v) { setField(4, v); }
  @$pb.TagNumber(4)
...
class VideoAdInfo extends $pb.GeneratedMessage {
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(_omitMessageNames ? '' : 'VideoAdInfo', package: const $pb.PackageName(_omitMessageNames ? '' : 'google.ads.googleads.v16.common'), createEmptyInstance: create)
    ...
    ..aOM<$2535.AdVideoAsset>(8, _omitFieldNames ? '' : 'video', subBuilder: $2535.AdVideoAsset.create)
  ...
  @$pb.TagNumber(8)
  $2535.AdVideoAsset get video => $_getN(4);
  @$pb.TagNumber(8)
  set video($2535.AdVideoAsset v) { setField(8, v); }
  @$pb.TagNumber(8)
  $core.bool hasVideo() => $_has(4);
  @$pb.TagNumber(8)
  void clearVideo() => clearField(8);
  @$pb.TagNumber(8)
  $2535.AdVideoAsset ensureVideo() => $_ensure(4);
...
class VideoResponsiveAdInfo extends $pb.GeneratedMessage {
  factory VideoResponsiveAdInfo({
    $core.Iterable<$2535.AdTextAsset>? headlines,
    $core.Iterable<$2535.AdTextAsset>? longHeadlines,
    $core.Iterable<$2535.AdTextAsset>? descriptions,
    $core.Iterable<$2535.AdTextAsset>? callToActions,
    $core.Iterable<$2535.AdVideoAsset>? videos,
    $core.Iterable<$2535.AdImageAsset>? companionBanners,
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(_omitMessageNames ? '' : 'VideoResponsiveAdInfo', package: const $pb.PackageName(_omitMessageNames ? '' : 'google.ads.googleads.v16.common'), createEmptyInstance: create)
    ..pc<$2535.AdTextAsset>(1, _omitFieldNames ? '' : 'headlines', $pb.PbFieldType.PM, subBuilder: $2535.AdTextAsset.create)
    ..pc<$2535.AdTextAsset>(2, _omitFieldNames ? '' : 'longHeadlines', $pb.PbFieldType.PM, subBuilder: $2535.AdTextAsset.create)
    ..pc<$2535.AdTextAsset>(3, _omitFieldNames ? '' : 'descriptions', $pb.PbFieldType.PM, subBuilder: $2535.AdTextAsset.create)
    ..pc<$2535.AdTextAsset>(4, _omitFieldNames ? '' : 'callToActions', $pb.PbFieldType.PM, subBuilder: $2535.AdTextAsset.create)
    ..pc<$2535.AdVideoAsset>(5, _omitFieldNames ? '' : 'videos', $pb.PbFieldType.PM, subBuilder: $2535.AdVideoAsset.create)
    ..pc<$2535.AdImageAsset>(6, _omitFieldNames ? '' : 'companionBanners', $pb.PbFieldType.PM, subBuilder: $2535.AdImageAsset.create)
  ...
  @$pb.TagNumber(6)
  $core.List<$2535.AdImageAsset> get companionBanners => $_getList(5);
...
class ResponsiveSearchAdInfo extends $pb.GeneratedMessage {
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(_omitMessageNames ? '' : 'ResponsiveSearchAdInfo', package: const $pb.PackageName(_omitMessageNames ? '' : 'google.ads.googleads.v16.common'), createEmptyInstance: create)
    ..pc<$2535.AdTextAsset>(1, _omitFieldNames ? '' : 'headlines', $pb.PbFieldType.PM, subBuilder: $2535.AdTextAsset.create)
    ..pc<$2535.AdTextAsset>(2, _omitFieldNames ? '' : 'descriptions', $pb.PbFieldType.PM, subBuilder: $2535.AdTextAsset.create)
  ...
  @$pb.TagNumber(2)
  $core.List<$2535.AdTextAsset> get descriptions => $_getList(1);
...
class LegacyResponsiveDisplayAdInfo extends $pb.GeneratedMessage {
  factory LegacyResponsiveDisplayAdInfo({
    $2538.DisplayAdFormatSettingEnum_DisplayAdFormatSetting? formatSetting,
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(_omitMessageNames ? '' : 'LegacyResponsiveDisplayAdInfo', package: const $pb.PackageName(_omitMessageNames ? '' : 'google.ads.googleads.v16.common'), createEmptyInstance: create)
    ..e<$2538.DisplayAdFormatSettingEnum_DisplayAdFormatSetting>(13, _omitFieldNames ? '' : 'formatSetting', $pb.PbFieldType.OE, defaultOrMaker: $2538.DisplayAdFormatSettingEnum_DisplayAdFormatSetting.UNSPECIFIED, valueOf: $2538.DisplayAdFormatSettingEnum_DisplayAdFormatSetting.valueOf, enumValues: $2538.DisplayAdFormatSettingEnum_DisplayAdFormatSetting.values)
  ...
  @$pb.TagNumber(13)
  $2538.DisplayAdFormatSettingEnum_DisplayAdFormatSetting get formatSetting => $_getN(0);
  @$pb.TagNumber(13)
  set formatSetting($2538.DisplayAdFormatSettingEnum_DisplayAdFormatSetting v) { setField(13, v); }
  @$pb.TagNumber(13)
...
class AppAdInfo extends $pb.GeneratedMessage {
  factory AppAdInfo({
    $2535.AdTextAsset? mandatoryAdText,
    $core.Iterable<$2535.AdTextAsset>? headlines,
    $core.Iterable<$2535.AdTextAsset>? descriptions,
    $core.Iterable<$2535.AdImageAsset>? images,
    $core.Iterable<$2535.AdVideoAsset>? youtubeVideos,
    $core.Iterable<$2535.AdMediaBundleAsset>? html5MediaBundles,
  }) {
    final $result = create();
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(_omitMessageNames ? '' : 'AppAdInfo', package: const $pb.PackageName(_omitMessageNames ? '' : 'google.ads.googleads.v16.common'), createEmptyInstance: create)
    ..aOM<$2535.AdTextAsset>(1, _omitFieldNames ? '' : 'mandatoryAdText', subBuilder: $2535.AdTextAsset.create)
    ..pc<$2535.AdTextAsset>(2, _omitFieldNames ? '' : 'headlines', $pb.PbFieldType.PM, subBuilder: $2535.AdTextAsset.create)
    ..pc<$2535.AdTextAsset>(3, _omitFieldNames ? '' : 'descriptions', $pb.PbFieldType.PM, subBuilder: $2535.AdTextAsset.create)
    ..pc<$2535.AdImageAsset>(4, _omitFieldNames ? '' : 'images', $pb.PbFieldType.PM, subBuilder: $2535.AdImageAsset.create)
    ..pc<$2535.AdVideoAsset>(5, _omitFieldNames ? '' : 'youtubeVideos', $pb.PbFieldType.PM, subBuilder: $2535.AdVideoAsset.create)
    ..pc<$2535.AdMediaBundleAsset>(6, _omitFieldNames ? '' : 'html5MediaBundles', $pb.PbFieldType.PM, subBuilder: $2535.AdMediaBundleAsset.create)
    ..hasRequiredFields = false
  ;
  ...
  /// Mandatory ad text.
  @$pb.TagNumber(1)
  $2535.AdTextAsset get mandatoryAdText => $_getN(0);
  @$pb.TagNumber(1)
  set mandatoryAdText($2535.AdTextAsset v) { setField(1, v); }
  @$pb.TagNumber(1)
  $core.bool hasMandatoryAdText() => $_has(0);
  @$pb.TagNumber(1)
  void clearMandatoryAdText() => clearField(1);
  @$pb.TagNumber(1)
  $2535.AdTextAsset ensureMandatoryAdText() => $_ensure(0);

  /// List of text assets for headlines. When the ad serves the headlines will
  /// be selected from this list.
  @$pb.TagNumber(2)
  $core.List<$2535.AdTextAsset> get headlines => $_getList(1);
  ...
  @$pb.TagNumber(4)
  $core.List<$2535.AdImageAsset> get images => $_getList(3);

  /// List of YouTube video assets that may be displayed with the ad.
  @$pb.TagNumber(5)
  $core.List<$2535.AdVideoAsset> get youtubeVideos => $_getList(4);

  /// List of media bundle assets that may be used with the ad.
  @$pb.TagNumber(6)
  $core.List<$2535.AdMediaBundleAsset> get html5MediaBundles => $_getList(5);
}
...
class AppEngagementAdInfo extends $pb.GeneratedMessage {
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(_omitMessageNames ? '' : 'AppEngagementAdInfo', package: const $pb.PackageName(_omitMessageNames ? '' : 'google.ads.googleads.v16.common'), createEmptyInstance: create)
    ..pc<$2535.AdTextAsset>(1, _omitFieldNames ? '' : 'headlines', $pb.PbFieldType.PM, subBuilder: $2535.AdTextAsset.create)
    ..pc<$2535.AdTextAsset>(2, _omitFieldNames ? '' : 'descriptions', $pb.PbFieldType.PM, subBuilder: $2535.AdTextAsset.create)
    ..pc<$2535.AdImageAsset>(3, _omitFieldNames ? '' : 'images', $pb.PbFieldType.PM, subBuilder: $2535.AdImageAsset.create)
    ..pc<$2535.AdVideoAsset>(4, _omitFieldNames ? '' : 'videos', $pb.PbFieldType.PM, subBuilder: $2535.AdVideoAsset.create)
    ..hasRequiredFields = false
  ;
  ...
  /// List of image assets that may be displayed with the ad.
  @$pb.TagNumber(3)
  $core.List<$2535.AdImageAsset> get images => $_getList(2);

  /// List of video assets that may be displayed with the ad.
  @$pb.TagNumber(4)
  $core.List<$2535.AdVideoAsset> get videos => $_getList(3);
}
...
class AppPreRegistrationAdInfo extends $pb.GeneratedMessage {
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(_omitMessageNames ? '' : 'AppPreRegistrationAdInfo', package: const $pb.PackageName(_omitMessageNames ? '' : 'google.ads.googleads.v16.common'), createEmptyInstance: create)
    ...
    ..pc<$2535.AdTextAsset>(2, _omitFieldNames ? '' : 'descriptions', $pb.PbFieldType.PM, subBuilder: $2535.AdTextAsset.create)
    ..pc<$2535.AdImageAsset>(3, _omitFieldNames ? '' : 'images', $pb.PbFieldType.PM, subBuilder: $2535.AdImageAsset.create)
    ..pc<$2535.AdVideoAsset>(4, _omitFieldNames ? '' : 'youtubeVideos', $pb.PbFieldType.PM, subBuilder: $2535.AdVideoAsset.create)
    ..hasRequiredFields = false
  ;
  ...
  @$pb.TagNumber(4)
  $core.List<$2535.AdVideoAsset> get youtubeVideos => $_getList(3);
}

/// A legacy app install ad that only can be used by a few select customers.
class LegacyAppInstallAdInfo extends $pb.GeneratedMessage {
  factory LegacyAppInstallAdInfo({
    $2539.LegacyAppInstallAdAppStoreEnum_LegacyAppInstallAdAppStore? appStore,
    $core.String? appId,
    $core.String? headline,
    $core.String? description1,
    $core.String? description2,
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(_omitMessageNames ? '' : 'LegacyAppInstallAdInfo', package: const $pb.PackageName(_omitMessageNames ? '' : 'google.ads.googleads.v16.common'), createEmptyInstance: create)
    ..e<$2539.LegacyAppInstallAdAppStoreEnum_LegacyAppInstallAdAppStore>(2, _omitFieldNames ? '' : 'appStore', $pb.PbFieldType.OE, defaultOrMaker: $2539.LegacyAppInstallAdAppStoreEnum_LegacyAppInstallAdAppStore.UNSPECIFIED, valueOf: $2539.LegacyAppInstallAdAppStoreEnum_LegacyAppInstallAdAppStore.valueOf, enumValues: $2539.LegacyAppInstallAdAppStoreEnum_LegacyAppInstallAdAppStore.values)
  ...
  @$pb.TagNumber(2)
  $2539.LegacyAppInstallAdAppStoreEnum_LegacyAppInstallAdAppStore get appStore => $_getN(0);
  @$pb.TagNumber(2)
  set appStore($2539.LegacyAppInstallAdAppStoreEnum_LegacyAppInstallAdAppStore v) { setField(2, v); }
  @$pb.TagNumber(2)
...
class ResponsiveDisplayAdInfo extends $pb.GeneratedMessage {
  factory ResponsiveDisplayAdInfo({
    $core.Iterable<$2535.AdImageAsset>? marketingImages,
    $core.Iterable<$2535.AdImageAsset>? squareMarketingImages,
    $core.Iterable<$2535.AdImageAsset>? logoImages,
    $core.Iterable<$2535.AdImageAsset>? squareLogoImages,
    $core.Iterable<$2535.AdTextAsset>? headlines,
    $2535.AdTextAsset? longHeadline,
    $core.Iterable<$2535.AdTextAsset>? descriptions,
    $core.Iterable<$2535.AdVideoAsset>? youtubeVideos,
    $2538.DisplayAdFormatSettingEnum_DisplayAdFormatSetting? formatSetting,
    $core.String? businessName,
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(_omitMessageNames ? '' : 'ResponsiveDisplayAdInfo', package: const $pb.PackageName(_omitMessageNames ? '' : 'google.ads.googleads.v16.common'), createEmptyInstance: create)
    ..pc<$2535.AdImageAsset>(1, _omitFieldNames ? '' : 'marketingImages', $pb.PbFieldType.PM, subBuilder: $2535.AdImageAsset.create)
    ..pc<$2535.AdImageAsset>(2, _omitFieldNames ? '' : 'squareMarketingImages', $pb.PbFieldType.PM, subBuilder: $2535.AdImageAsset.create)
    ..pc<$2535.AdImageAsset>(3, _omitFieldNames ? '' : 'logoImages', $pb.PbFieldType.PM, subBuilder: $2535.AdImageAsset.create)
    ..pc<$2535.AdImageAsset>(4, _omitFieldNames ? '' : 'squareLogoImages', $pb.PbFieldType.PM, subBuilder: $2535.AdImageAsset.create)
    ..pc<$2535.AdTextAsset>(5, _omitFieldNames ? '' : 'headlines', $pb.PbFieldType.PM, subBuilder: $2535.AdTextAsset.create)
    ..aOM<$2535.AdTextAsset>(6, _omitFieldNames ? '' : 'longHeadline', subBuilder: $2535.AdTextAsset.create)
    ..pc<$2535.AdTextAsset>(7, _omitFieldNames ? '' : 'descriptions', $pb.PbFieldType.PM, subBuilder: $2535.AdTextAsset.create)
    ..pc<$2535.AdVideoAsset>(8, _omitFieldNames ? '' : 'youtubeVideos', $pb.PbFieldType.PM, subBuilder: $2535.AdVideoAsset.create)
    ..e<$2538.DisplayAdFormatSettingEnum_DisplayAdFormatSetting>(16, _omitFieldNames ? '' : 'formatSetting', $pb.PbFieldType.OE, defaultOrMaker: $2538.DisplayAdFormatSettingEnum_DisplayAdFormatSetting.UNSPECIFIED, valueOf: $2538.DisplayAdFormatSettingEnum_DisplayAdFormatSetting.valueOf, enumValues: $2538.DisplayAdFormatSettingEnum_DisplayAdFormatSetting.values)
  ...
  @$pb.TagNumber(1)
  $core.List<$2535.AdImageAsset> get marketingImages => $_getList(0);
  ...
  @$pb.TagNumber(2)
  $core.List<$2535.AdImageAsset> get squareMarketingImages => $_getList(1);

  /// Logo images to be used in the ad. Valid image types are GIF,
  /// JPEG, and PNG. The minimum size is 512x128 and the aspect ratio must
  /// be 4:1 (+-1%). Combined with `square_logo_images`, the maximum is 5.
  @$pb.TagNumber(3)
  $core.List<$2535.AdImageAsset> get logoImages => $_getList(2);

  /// Square logo images to be used in the ad. Valid image types are GIF,
  /// JPEG, and PNG. The minimum size is 128x128 and the aspect ratio must
  /// be 1:1 (+-1%). Combined with `logo_images`, the maximum is 5.
  @$pb.TagNumber(4)
  $core.List<$2535.AdImageAsset> get squareLogoImages => $_getList(3);

  /// Short format headlines for the ad. The maximum length is 30 characters.
  /// At least 1 and max 5 headlines can be specified.
  @$pb.TagNumber(5)
  $core.List<$2535.AdTextAsset> get headlines => $_getList(4);

  /// A required long format headline. The maximum length is 90 characters.
  @$pb.TagNumber(6)
  $2535.AdTextAsset get longHeadline => $_getN(5);
  @$pb.TagNumber(6)
  set longHeadline($2535.AdTextAsset v) { setField(6, v); }
  @$pb.TagNumber(6)
  $core.bool hasLongHeadline() => $_has(5);
  @$pb.TagNumber(6)
  void clearLongHeadline() => clearField(6);
  @$pb.TagNumber(6)
  $2535.AdTextAsset ensureLongHeadline() => $_ensure(5);

  /// Descriptive texts for the ad. The maximum length is 90 characters. At
  /// least 1 and max 5 headlines can be specified.
  @$pb.TagNumber(7)
  $core.List<$2535.AdTextAsset> get descriptions => $_getList(6);

  /// Optional YouTube videos for the ad. A maximum of 5 videos can be specified.
  @$pb.TagNumber(8)
  $core.List<$2535.AdVideoAsset> get youtubeVideos => $_getList(7);

  /// Specifies which format the ad will be served in. Default is ALL_FORMATS.
  @$pb.TagNumber(16)
  $2538.DisplayAdFormatSettingEnum_DisplayAdFormatSetting get formatSetting => $_getN(8);
  @$pb.TagNumber(16)
  set formatSetting($2538.DisplayAdFormatSettingEnum_DisplayAdFormatSetting v) { setField(16, v); }
  @$pb.TagNumber(16)
...
class LocalAdInfo extends $pb.GeneratedMessage {
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(_omitMessageNames ? '' : 'LocalAdInfo', package: const $pb.PackageName(_omitMessageNames ? '' : 'google.ads.googleads.v16.common'), createEmptyInstance: create)
    ..pc<$2535.AdTextAsset>(1, _omitFieldNames ? '' : 'headlines', $pb.PbFieldType.PM, subBuilder: $2535.AdTextAsset.create)
    ..pc<$2535.AdTextAsset>(2, _omitFieldNames ? '' : 'descriptions', $pb.PbFieldType.PM, subBuilder: $2535.AdTextAsset.create)
    ..pc<$2535.AdTextAsset>(3, _omitFieldNames ? '' : 'callToActions', $pb.PbFieldType.PM, subBuilder: $2535.AdTextAsset.create)
    ..pc<$2535.AdImageAsset>(4, _omitFieldNames ? '' : 'marketingImages', $pb.PbFieldType.PM, subBuilder: $2535.AdImageAsset.create)
    ..pc<$2535.AdImageAsset>(5, _omitFieldNames ? '' : 'logoImages', $pb.PbFieldType.PM, subBuilder: $2535.AdImageAsset.create)
    ..pc<$2535.AdVideoAsset>(6, _omitFieldNames ? '' : 'videos', $pb.PbFieldType.PM, subBuilder: $2535.AdVideoAsset.create)
  ...
  @$pb.TagNumber(3)
  $core.List<$2535.AdTextAsset> get callToActions => $_getList(2);
  ...
  @$pb.TagNumber(4)
  $core.List<$2535.AdImageAsset> get marketingImages => $_getList(3);
...
class DisplayUploadAdInfo extends $pb.GeneratedMessage {
  factory DisplayUploadAdInfo({
    $2540.DisplayUploadProductTypeEnum_DisplayUploadProductType? displayUploadProductType,
    $2535.AdMediaBundleAsset? mediaBundle,
  }) {
    final $result = create();
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(_omitMessageNames ? '' : 'DisplayUploadAdInfo', package: const $pb.PackageName(_omitMessageNames ? '' : 'google.ads.googleads.v16.common'), createEmptyInstance: create)
    ..oo(0, [2])
    ..e<$2540.DisplayUploadProductTypeEnum_DisplayUploadProductType>(1, _omitFieldNames ? '' : 'displayUploadProductType', $pb.PbFieldType.OE, defaultOrMaker: $2540.DisplayUploadProductTypeEnum_DisplayUploadProductType.UNSPECIFIED, valueOf: $2540.DisplayUploadProductTypeEnum_DisplayUploadProductType.valueOf, enumValues: $2540.DisplayUploadProductTypeEnum_DisplayUploadProductType.values)
    ..aOM<$2535.AdMediaBundleAsset>(2, _omitFieldNames ? '' : 'mediaBundle', subBuilder: $2535.AdMediaBundleAsset.create)
    ..hasRequiredFields = false
  ;
  ...
  @$pb.TagNumber(1)
  $2540.DisplayUploadProductTypeEnum_DisplayUploadProductType get displayUploadProductType => $_getN(0);
  @$pb.TagNumber(1)
  set displayUploadProductType($2540.DisplayUploadProductTypeEnum_DisplayUploadProductType v) { setField(1, v); }
  @$pb.TagNumber(1)
  ...
  /// information.
  @$pb.TagNumber(2)
  $2535.AdMediaBundleAsset get mediaBundle => $_getN(1);
  @$pb.TagNumber(2)
  set mediaBundle($2535.AdMediaBundleAsset v) { setField(2, v); }
  @$pb.TagNumber(2)
  $core.bool hasMediaBundle() => $_has(1);
  @$pb.TagNumber(2)
  void clearMediaBundle() => clearField(2);
  @$pb.TagNumber(2)
  $2535.AdMediaBundleAsset ensureMediaBundle() => $_ensure(1);
}
...
class CallAdInfo extends $pb.GeneratedMessage {
  factory CallAdInfo({
    ...
    $2541.CallConversionReportingStateEnum_CallConversionReportingState? conversionReportingState,
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(_omitMessageNames ? '' : 'CallAdInfo', package: const $pb.PackageName(_omitMessageNames ? '' : 'google.ads.googleads.v16.common'), createEmptyInstance: create)
    ...
    ..e<$2541.CallConversionReportingStateEnum_CallConversionReportingState>(10, _omitFieldNames ? '' : 'conversionReportingState', $pb.PbFieldType.OE, defaultOrMaker: $2541.CallConversionReportingStateEnum_CallConversionReportingState.UNSPECIFIED, valueOf: $2541.CallConversionReportingStateEnum_CallConversionReportingState.valueOf, enumValues: $2541.CallConversionReportingStateEnum_CallConversionReportingState.values)
  ...
  @$pb.TagNumber(10)
  $2541.CallConversionReportingStateEnum_CallConversionReportingState get conversionReportingState => $_getN(9);
  @$pb.TagNumber(10)
  set conversionReportingState($2541.CallConversionReportingStateEnum_CallConversionReportingState v) { setField(10, v); }
  @$pb.TagNumber(10)
...
class DiscoveryMultiAssetAdInfo extends $pb.GeneratedMessage {
  factory DiscoveryMultiAssetAdInfo({
    $core.Iterable<$2535.AdImageAsset>? marketingImages,
    $core.Iterable<$2535.AdImageAsset>? squareMarketingImages,
    $core.Iterable<$2535.AdImageAsset>? portraitMarketingImages,
    $core.Iterable<$2535.AdImageAsset>? logoImages,
    $core.Iterable<$2535.AdTextAsset>? headlines,
    $core.Iterable<$2535.AdTextAsset>? descriptions,
    $core.String? businessName,
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(_omitMessageNames ? '' : 'DiscoveryMultiAssetAdInfo', package: const $pb.PackageName(_omitMessageNames ? '' : 'google.ads.googleads.v16.common'), createEmptyInstance: create)
    ..pc<$2535.AdImageAsset>(1, _omitFieldNames ? '' : 'marketingImages', $pb.PbFieldType.PM, subBuilder: $2535.AdImageAsset.create)
    ..pc<$2535.AdImageAsset>(2, _omitFieldNames ? '' : 'squareMarketingImages', $pb.PbFieldType.PM, subBuilder: $2535.AdImageAsset.create)
    ..pc<$2535.AdImageAsset>(3, _omitFieldNames ? '' : 'portraitMarketingImages', $pb.PbFieldType.PM, subBuilder: $2535.AdImageAsset.create)
    ..pc<$2535.AdImageAsset>(4, _omitFieldNames ? '' : 'logoImages', $pb.PbFieldType.PM, subBuilder: $2535.AdImageAsset.create)
    ..pc<$2535.AdTextAsset>(5, _omitFieldNames ? '' : 'headlines', $pb.PbFieldType.PM, subBuilder: $2535.AdTextAsset.create)
    ..pc<$2535.AdTextAsset>(6, _omitFieldNames ? '' : 'descriptions', $pb.PbFieldType.PM, subBuilder: $2535.AdTextAsset.create)
  ...
  @$pb.TagNumber(3)
  $core.List<$2535.AdImageAsset> get portraitMarketingImages => $_getList(2);
  ...
  @$pb.TagNumber(4)
  $core.List<$2535.AdImageAsset> get logoImages => $_getList(3);
  ...
  @$pb.TagNumber(6)
  $core.List<$2535.AdTextAsset> get descriptions => $_getList(5);
...
class DiscoveryCarouselAdInfo extends $pb.GeneratedMessage {
  factory DiscoveryCarouselAdInfo({
    $core.String? businessName,
    $2535.AdImageAsset? logoImage,
    $2535.AdTextAsset? headline,
    $2535.AdTextAsset? description,
    $core.String? callToActionText,
    $core.Iterable<$2535.AdDiscoveryCarouselCardAsset>? carouselCards,
  }) {
    final $result = create();
    if (businessName != null) {
      $result.businessName = businessName;
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(_omitMessageNames ? '' : 'DiscoveryCarouselAdInfo', package: const $pb.PackageName(_omitMessageNames ? '' : 'google.ads.googleads.v16.common'), createEmptyInstance: create)
    ...
    ..aOM<$2535.AdImageAsset>(2, _omitFieldNames ? '' : 'logoImage', subBuilder: $2535.AdImageAsset.create)
    ..aOM<$2535.AdTextAsset>(3, _omitFieldNames ? '' : 'headline', subBuilder: $2535.AdTextAsset.create)
    ..aOM<$2535.AdTextAsset>(4, _omitFieldNames ? '' : 'description', subBuilder: $2535.AdTextAsset.create)
    ..aOS(5, _omitFieldNames ? '' : 'callToActionText')
    ..pc<$2535.AdDiscoveryCarouselCardAsset>(6, _omitFieldNames ? '' : 'carouselCards', $pb.PbFieldType.PM, subBuilder: $2535.AdDiscoveryCarouselCardAsset.create)
    ..hasRequiredFields = false
  ;
  ...
  @$pb.TagNumber(2)
  $2535.AdImageAsset get logoImage => $_getN(1);
  @$pb.TagNumber(2)
  set logoImage($2535.AdImageAsset v) { setField(2, v); }
  @$pb.TagNumber(2)
  $core.bool hasLogoImage() => $_has(1);
  @$pb.TagNumber(2)
  void clearLogoImage() => clearField(2);
  @$pb.TagNumber(2)
  $2535.AdImageAsset ensureLogoImage() => $_ensure(1);

  /// Required. Headline of the ad.
  @$pb.TagNumber(3)
  $2535.AdTextAsset get headline => $_getN(2);
  @$pb.TagNumber(3)
  set headline($2535.AdTextAsset v) { setField(3, v); }
  @$pb.TagNumber(3)
  $core.bool hasHeadline() => $_has(2);
  @$pb.TagNumber(3)
  void clearHeadline() => clearField(3);
  @$pb.TagNumber(3)
  $2535.AdTextAsset ensureHeadline() => $_ensure(2);

  /// Required. The descriptive text of the ad.
  @$pb.TagNumber(4)
  $2535.AdTextAsset get description => $_getN(3);
  @$pb.TagNumber(4)
  set description($2535.AdTextAsset v) { setField(4, v); }
  @$pb.TagNumber(4)
  $core.bool hasDescription() => $_has(3);
  @$pb.TagNumber(4)
  void clearDescription() => clearField(4);
  @$pb.TagNumber(4)
  $2535.AdTextAsset ensureDescription() => $_ensure(3);
  ...
  @$pb.TagNumber(6)
  $core.List<$2535.AdDiscoveryCarouselCardAsset> get carouselCards => $_getList(5);
}
...
class DiscoveryVideoResponsiveAdInfo extends $pb.GeneratedMessage {
  factory DiscoveryVideoResponsiveAdInfo({
    ...
    $core.String? breadcrumb1,
    $core.String? breadcrumb2,
    $2535.AdTextAsset? businessName,
    $core.Iterable<$2535.AdCallToActionAsset>? callToActions,
  }) {
    final $result = create();
    if (headlines != null) {
      $result.headlines.addAll(headlines);
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(_omitMessageNames ? '' : 'DiscoveryVideoResponsiveAdInfo', package: const $pb.PackageName(_omitMessageNames ? '' : 'google.ads.googleads.v16.common'), createEmptyInstance: create)
    ...
    ..aOM<$2535.AdTextAsset>(8, _omitFieldNames ? '' : 'businessName', subBuilder: $2535.AdTextAsset.create)
    ..pc<$2535.AdCallToActionAsset>(9, _omitFieldNames ? '' : 'callToActions', $pb.PbFieldType.PM, subBuilder: $2535.AdCallToActionAsset.create)
    ..hasRequiredFields = false
  ;
  ...
  /// Required. The advertiser/brand name.
  @$pb.TagNumber(8)
  $2535.AdTextAsset get businessName => $_getN(7);
  @$pb.TagNumber(8)
  set businessName($2535.AdTextAsset v) { setField(8, v); }
  @$pb.TagNumber(8)
  $core.bool hasBusinessName() => $_has(7);
  @$pb.TagNumber(8)
  void clearBusinessName() => clearField(8);
  @$pb.TagNumber(8)
  $2535.AdTextAsset ensureBusinessName() => $_ensure(7);

  /// Assets of type CallToActionAsset used for the "Call To Action" button.
  @$pb.TagNumber(9)
  $core.List<$2535.AdCallToActionAsset> get callToActions => $_getList(8);
}
...
class DemandGenProductAdInfo extends $pb.GeneratedMessage {
  factory DemandGenProductAdInfo({
    ...
    $core.String? breadcrumb2,
    $2535.AdTextAsset? businessName,
    $2535.AdCallToActionAsset? callToAction,
  }) {
    final $result = create();
    if (headline != null) {
      $result.headline = headline;
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(_omitMessageNames ? '' : 'DemandGenProductAdInfo', package: const $pb.PackageName(_omitMessageNames ? '' : 'google.ads.googleads.v16.common'), createEmptyInstance: create)
    ..aOM<$2535.AdTextAsset>(1, _omitFieldNames ? '' : 'headline', subBuilder: $2535.AdTextAsset.create)
    ..aOM<$2535.AdTextAsset>(2, _omitFieldNames ? '' : 'description', subBuilder: $2535.AdTextAsset.create)
    ..aOM<$2535.AdImageAsset>(3, _omitFieldNames ? '' : 'logoImage', subBuilder: $2535.AdImageAsset.create)
    ..aOS(4, _omitFieldNames ? '' : 'breadcrumb1')
    ..aOS(5, _omitFieldNames ? '' : 'breadcrumb2')
    ..aOM<$2535.AdTextAsset>(6, _omitFieldNames ? '' : 'businessName', subBuilder: $2535.AdTextAsset.create)
    ..aOM<$2535.AdCallToActionAsset>(7, _omitFieldNames ? '' : 'callToAction', subBuilder: $2535.AdCallToActionAsset.create)
    ..hasRequiredFields = false
  ;
  ...
  @$pb.TagNumber(1)
  $2535.AdTextAsset get headline => $_getN(0);
  @$pb.TagNumber(1)
  set headline($2535.AdTextAsset v) { setField(1, v); }
  @$pb.TagNumber(1)
  $core.bool hasHeadline() => $_has(0);
  @$pb.TagNumber(1)
  void clearHeadline() => clearField(1);
  @$pb.TagNumber(1)
  $2535.AdTextAsset ensureHeadline() => $_ensure(0);

  /// Required. Text asset used for the description.
  @$pb.TagNumber(2)
  $2535.AdTextAsset get description => $_getN(1);
  @$pb.TagNumber(2)
  set description($2535.AdTextAsset v) { setField(2, v); }
  @$pb.TagNumber(2)
  $core.bool hasDescription() => $_has(1);
  @$pb.TagNumber(2)
  void clearDescription() => clearField(2);
  @$pb.TagNumber(2)
  $2535.AdTextAsset ensureDescription() => $_ensure(1);
  ...
  /// (+-1%).
  @$pb.TagNumber(3)
  $2535.AdImageAsset get logoImage => $_getN(2);
  @$pb.TagNumber(3)
  set logoImage($2535.AdImageAsset v) { setField(3, v); }
  @$pb.TagNumber(3)
  $core.bool hasLogoImage() => $_has(2);
  @$pb.TagNumber(3)
  void clearLogoImage() => clearField(3);
  @$pb.TagNumber(3)
  $2535.AdImageAsset ensureLogoImage() => $_ensure(2);
  ...
  /// Required. The advertiser/brand name.
  @$pb.TagNumber(6)
  $2535.AdTextAsset get businessName => $_getN(5);
  @$pb.TagNumber(6)
  set businessName($2535.AdTextAsset v) { setField(6, v); }
  @$pb.TagNumber(6)
  $core.bool hasBusinessName() => $_has(5);
  @$pb.TagNumber(6)
  void clearBusinessName() => clearField(6);
  @$pb.TagNumber(6)
  $2535.AdTextAsset ensureBusinessName() => $_ensure(5);

  /// Asset of type CallToActionAsset used for the "Call To Action" button.
  @$pb.TagNumber(7)
  $2535.AdCallToActionAsset get callToAction => $_getN(6);
  @$pb.TagNumber(7)
  set callToAction($2535.AdCallToActionAsset v) { setField(7, v); }
  @$pb.TagNumber(7)
  $core.bool hasCallToAction() => $_has(6);
  @$pb.TagNumber(7)
  void clearCallToAction() => clearField(7);
  @$pb.TagNumber(7)
  $2535.AdCallToActionAsset ensureCallToAction() => $_ensure(6);
}
