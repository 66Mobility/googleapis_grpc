...
const LocationSet$json = {
  '1': 'LocationSet',
  '2': [
    {'1': 'location_ownership_type', '3': 3, '4': 1, '5': 14, '6': '.google.ads.googleads.v16.enums.LocationOwnershipTypeEnum.LocationOwnershipType', '8': {}, '10': 'locationOwnershipType'},
    {'1': 'business_profile_location_set', '3': 1, '4': 1, '5': 11, '6': '.google.ads.googleads.v16.common.BusinessProfileLocationSet', '9': 0, '10': 'businessProfileLocationSet'},
    {'1': 'chain_location_set', '3': 2, '4': 1, '5': 11, '6': '.google.ads.googleads.v16.common.ChainSet', '9': 0, '10': 'chainLocationSet'},
    {'1': 'maps_location_set', '3': 5, '4': 1, '5': 11, '6': '.google.ads.googleads.v16.common.MapsLocationSet', '9': 0, '10': 'mapsLocationSet'},
  ],
  '8': [
    {'1': 'source'},
  ],
...
final $typed_data.Uint8List locationSetDescriptor = $convert.base64Decode(
    ...
    'UuYWRzLmdvb2dsZWFkcy52MTYuZW51bXMuTG9jYXRpb25Pd25lcnNoaXBUeXBlRW51bS5Mb2Nh'
    ...
    'LnYxNi5jb21tb24uQnVzaW5lc3NQcm9maWxlTG9jYXRpb25TZXRIAFIaYnVzaW5lc3NQcm9maW'
    'xlTG9jYXRpb25TZXQSWQoSY2hhaW5fbG9jYXRpb25fc2V0GAIgASgLMikuZ29vZ2xlLmFkcy5n'
    'b29nbGVhZHMudjE2LmNvbW1vbi5DaGFpblNldEgAUhBjaGFpbkxvY2F0aW9uU2V0El4KEW1hcH'
    'NfbG9jYXRpb25fc2V0GAUgASgLMjAuZ29vZ2xlLmFkcy5nb29nbGVhZHMudjE2LmNvbW1vbi5N'
...
const ChainSet$json = {
  '1': 'ChainSet',
  '2': [
    {'1': 'relationship_type', '3': 1, '4': 1, '5': 14, '6': '.google.ads.googleads.v16.enums.ChainRelationshipTypeEnum.ChainRelationshipType', '8': {}, '10': 'relationshipType'},
    {'1': 'chains', '3': 2, '4': 3, '5': 11, '6': '.google.ads.googleads.v16.common.ChainFilter', '8': {}, '10': 'chains'},
  ],
};
...
final $typed_data.Uint8List chainSetDescriptor = $convert.base64Decode(
    ...
    'dsZWFkcy52MTYuZW51bXMuQ2hhaW5SZWxhdGlvbnNoaXBUeXBlRW51bS5DaGFpblJlbGF0aW9u'
    'c2hpcFR5cGVCBuBBAuBBBVIQcmVsYXRpb25zaGlwVHlwZRJJCgZjaGFpbnMYAiADKAsyLC5nb2'
    '9nbGUuYWRzLmdvb2dsZWFkcy52MTYuY29tbW9uLkNoYWluRmlsdGVyQgPgQQJSBmNoYWlucw==');
...
const MapsLocationSet$json = {
  '1': 'MapsLocationSet',
  '2': [
    {'1': 'maps_locations', '3': 1, '4': 3, '5': 11, '6': '.google.ads.googleads.v16.common.MapsLocationInfo', '8': {}, '10': 'mapsLocations'},
  ],
};
...
final $typed_data.Uint8List mapsLocationSetDescriptor = $convert.base64Decode(
    ...
    'dvb2dsZWFkcy52MTYuY29tbW9uLk1hcHNMb2NhdGlvbkluZm9CA+BBAlINbWFwc0xvY2F0aW9u'
    'cw==');
...
const BusinessProfileLocationGroup$json = {
  ...
  '2': [
    {'1': 'dynamic_business_profile_location_group_filter', '3': 1, '4': 1, '5': 11, '6': '.google.ads.googleads.v16.common.DynamicBusinessProfileLocationGroupFilter', '10': 'dynamicBusinessProfileLocationGroupFilter'},
  ],
};
...
final $typed_data.Uint8List businessProfileLocationGroupDescriptor = $convert.base64Decode(
    ...
    'djE2LmNvbW1vbi5EeW5hbWljQnVzaW5lc3NQcm9maWxlTG9jYXRpb25Hcm91cEZpbHRlclIpZH'
...
const DynamicBusinessProfileLocationGroupFilter$json = {
  ...
  '2': [
    ...
    {'1': 'business_name_filter', '3': 2, '4': 1, '5': 11, '6': '.google.ads.googleads.v16.common.BusinessProfileBusinessNameFilter', '9': 0, '10': 'businessNameFilter', '17': true},
...
final $typed_data.Uint8List dynamicBusinessProfileLocationGroupFilterDescriptor = $convert.base64Decode(
    ...
    'Qi5nb29nbGUuYWRzLmdvb2dsZWFkcy52MTYuY29tbW9uLkJ1c2luZXNzUHJvZmlsZUJ1c2luZX'
...
const BusinessProfileBusinessNameFilter$json = {
  ...
  '2': [
    ...
    {'1': 'filter_type', '3': 2, '4': 1, '5': 14, '6': '.google.ads.googleads.v16.enums.LocationStringFilterTypeEnum.LocationStringFilterType', '10': 'filterType'},
  ],
};
...
final $typed_data.Uint8List businessProfileBusinessNameFilterDescriptor = $convert.base64Decode(
    ...
    'bGVhZHMudjE2LmVudW1zLkxvY2F0aW9uU3RyaW5nRmlsdGVyVHlwZUVudW0uTG9jYXRpb25TdH'
...
const ChainLocationGroup$json = {
  ...
  '2': [
    {'1': 'dynamic_chain_location_group_filters', '3': 1, '4': 3, '5': 11, '6': '.google.ads.googleads.v16.common.ChainFilter', '10': 'dynamicChainLocationGroupFilters'},
  ],
};
...
final $typed_data.Uint8List chainLocationGroupDescriptor = $convert.base64Decode(
    ...
    'x0ZXJzGAEgAygLMiwuZ29vZ2xlLmFkcy5nb29nbGVhZHMudjE2LmNvbW1vbi5DaGFpbkZpbHRl'
