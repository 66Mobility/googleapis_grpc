...
const ImageAsset$json = {
  ...
  '2': [
    ...
    {'1': 'mime_type', '3': 3, '4': 1, '5': 14, '6': '.google.ads.googleads.v16.enums.MimeTypeEnum.MimeType', '10': 'mimeType'},
    {'1': 'full_size', '3': 4, '4': 1, '5': 11, '6': '.google.ads.googleads.v16.common.ImageDimension', '10': 'fullSize'},
  ],
  '8': [
    {'1': '_data'},
    {'1': '_file_size'},
...
final $typed_data.Uint8List imageAssetDescriptor = $convert.base64Decode(
    ...
    'ZHMudjE2LmVudW1zLk1pbWVUeXBlRW51bS5NaW1lVHlwZVIIbWltZVR5cGUSTAoJZnVsbF9zaX'
    'plGAQgASgLMi8uZ29vZ2xlLmFkcy5nb29nbGVhZHMudjE2LmNvbW1vbi5JbWFnZURpbWVuc2lv'
...
const LeadFormAsset$json = {
  ...
  '2': [
    ...
    {'1': 'call_to_action_type', '3': 17, '4': 1, '5': 14, '6': '.google.ads.googleads.v16.enums.LeadFormCallToActionTypeEnum.LeadFormCallToActionType', '8': {}, '10': 'callToActionType'},
    ...
    {'1': 'fields', '3': 8, '4': 3, '5': 11, '6': '.google.ads.googleads.v16.common.LeadFormField', '10': 'fields'},
    {'1': 'custom_question_fields', '3': 23, '4': 3, '5': 11, '6': '.google.ads.googleads.v16.common.LeadFormCustomQuestionField', '10': 'customQuestionFields'},
    {'1': 'delivery_methods', '3': 9, '4': 3, '5': 11, '6': '.google.ads.googleads.v16.common.LeadFormDeliveryMethod', '10': 'deliveryMethods'},
    {'1': 'post_submit_call_to_action_type', '3': 19, '4': 1, '5': 14, '6': '.google.ads.googleads.v16.enums.LeadFormPostSubmitCallToActionTypeEnum.LeadFormPostSubmitCallToActionType', '10': 'postSubmitCallToActionType'},
    {'1': 'background_image_asset', '3': 20, '4': 1, '5': 9, '9': 2, '10': 'backgroundImageAsset', '17': true},
    {'1': 'desired_intent', '3': 21, '4': 1, '5': 14, '6': '.google.ads.googleads.v16.enums.LeadFormDesiredIntentEnum.LeadFormDesiredIntent', '10': 'desiredIntent'},
...
final $typed_data.Uint8List leadFormAssetDescriptor = $convert.base64Decode(
    ...
    'djE2LmVudW1zLkxlYWRGb3JtQ2FsbFRvQWN0aW9uVHlwZUVudW0uTGVhZEZvcm1DYWxsVG9BY3'
    ...
    'gBARJGCgZmaWVsZHMYCCADKAsyLi5nb29nbGUuYWRzLmdvb2dsZWFkcy52MTYuY29tbW9uLkxl'
    'YWRGb3JtRmllbGRSBmZpZWxkcxJyChZjdXN0b21fcXVlc3Rpb25fZmllbGRzGBcgAygLMjwuZ2'
    '9vZ2xlLmFkcy5nb29nbGVhZHMudjE2LmNvbW1vbi5MZWFkRm9ybUN1c3RvbVF1ZXN0aW9uRmll'
    'bGRSFGN1c3RvbVF1ZXN0aW9uRmllbGRzEmIKEGRlbGl2ZXJ5X21ldGhvZHMYCSADKAsyNy5nb2'
    '9nbGUuYWRzLmdvb2dsZWFkcy52MTYuY29tbW9uLkxlYWRGb3JtRGVsaXZlcnlNZXRob2RSD2Rl'
    'bGl2ZXJ5TWV0aG9kcxKuAQofcG9zdF9zdWJtaXRfY2FsbF90b19hY3Rpb25fdHlwZRgTIAEoDj'
    'JpLmdvb2dsZS5hZHMuZ29vZ2xlYWRzLnYxNi5lbnVtcy5MZWFkRm9ybVBvc3RTdWJtaXRDYWxs'
    ...
    '9vZ2xlLmFkcy5nb29nbGVhZHMudjE2LmVudW1zLkxlYWRGb3JtRGVzaXJlZEludGVudEVudW0u'
...
const LeadFormField$json = {
  '1': 'LeadFormField',
  '2': [
    {'1': 'input_type', '3': 1, '4': 1, '5': 14, '6': '.google.ads.googleads.v16.enums.LeadFormFieldUserInputTypeEnum.LeadFormFieldUserInputType', '10': 'inputType'},
    {'1': 'single_choice_answers', '3': 2, '4': 1, '5': 11, '6': '.google.ads.googleads.v16.common.LeadFormSingleChoiceAnswers', '9': 0, '10': 'singleChoiceAnswers'},
...
final $typed_data.Uint8List leadFormFieldDescriptor = $convert.base64Decode(
    ...
    'Fkcy52MTYuZW51bXMuTGVhZEZvcm1GaWVsZFVzZXJJbnB1dFR5cGVFbnVtLkxlYWRGb3JtRmll'
    'bGRVc2VySW5wdXRUeXBlUglpbnB1dFR5cGUScgoVc2luZ2xlX2Nob2ljZV9hbnN3ZXJzGAIgAS'
    'gLMjwuZ29vZ2xlLmFkcy5nb29nbGVhZHMudjE2LmNvbW1vbi5MZWFkRm9ybVNpbmdsZUNob2lj'
...
final $typed_data.Uint8List leadFormCustomQuestionFieldDescriptor = $convert.base64Decode(
    ...
    'PC5nb29nbGUuYWRzLmdvb2dsZWFkcy52MTYuY29tbW9uLkxlYWRGb3JtU2luZ2xlQ2hvaWNlQW'
...
const LeadFormDeliveryMethod$json = {
  ...
  '2': [
    {'1': 'webhook', '3': 1, '4': 1, '5': 11, '6': '.google.ads.googleads.v16.common.WebhookDelivery', '9': 0, '10': 'webhook'},
  ],
  '8': [
    {'1': 'delivery_details'},
  ],
...
final $typed_data.Uint8List leadFormDeliveryMethodDescriptor = $convert.base64Decode(
    ...
    'dvb2dsZWFkcy52MTYuY29tbW9uLldlYmhvb2tEZWxpdmVyeUgAUgd3ZWJob29rQhIKEGRlbGl2'
    'ZXJ5X2RldGFpbHM=');
...
const PromotionAsset$json = {
  ...
  '2': [
    ...
    {'1': 'discount_modifier', '3': 2, '4': 1, '5': 14, '6': '.google.ads.googleads.v16.enums.PromotionExtensionDiscountModifierEnum.PromotionExtensionDiscountModifier', '10': 'discountModifier'},
    {'1': 'redemption_start_date', '3': 7, '4': 1, '5': 9, '10': 'redemptionStartDate'},
    {'1': 'redemption_end_date', '3': 8, '4': 1, '5': 9, '10': 'redemptionEndDate'},
    {'1': 'occasion', '3': 9, '4': 1, '5': 14, '6': '.google.ads.googleads.v16.enums.PromotionExtensionOccasionEnum.PromotionExtensionOccasion', '10': 'occasion'},
    {'1': 'language_code', '3': 10, '4': 1, '5': 9, '10': 'languageCode'},
    {'1': 'start_date', '3': 11, '4': 1, '5': 9, '10': 'startDate'},
    {'1': 'end_date', '3': 12, '4': 1, '5': 9, '10': 'endDate'},
    {'1': 'ad_schedule_targets', '3': 13, '4': 3, '5': 11, '6': '.google.ads.googleads.v16.common.AdScheduleInfo', '10': 'adScheduleTargets'},
    {'1': 'percent_off', '3': 3, '4': 1, '5': 3, '9': 0, '10': 'percentOff'},
    {'1': 'money_amount_off', '3': 4, '4': 1, '5': 11, '6': '.google.ads.googleads.v16.common.Money', '9': 0, '10': 'moneyAmountOff'},
    {'1': 'promotion_code', '3': 5, '4': 1, '5': 9, '9': 1, '10': 'promotionCode'},
    {'1': 'orders_over_amount', '3': 6, '4': 1, '5': 11, '6': '.google.ads.googleads.v16.common.Money', '9': 1, '10': 'ordersOverAmount'},
  ],
  '8': [
    {'1': 'discount_type'},
    {'1': 'promotion_trigger'},
...
final $typed_data.Uint8List promotionAssetDescriptor = $convert.base64Decode(
    ...
    'ZWFkcy52MTYuZW51bXMuUHJvbW90aW9uRXh0ZW5zaW9uRGlzY291bnRNb2RpZmllckVudW0uUH'
    ...
    'KA4yWS5nb29nbGUuYWRzLmdvb2dsZWFkcy52MTYuZW51bXMuUHJvbW90aW9uRXh0ZW5zaW9uT2'
    ...
    'DSADKAsyLy5nb29nbGUuYWRzLmdvb2dsZWFkcy52MTYuY29tbW9uLkFkU2NoZWR1bGVJbmZvUh'
    'FhZFNjaGVkdWxlVGFyZ2V0cxIhCgtwZXJjZW50X29mZhgDIAEoA0gAUgpwZXJjZW50T2ZmElIK'
    'EG1vbmV5X2Ftb3VudF9vZmYYBCABKAsyJi5nb29nbGUuYWRzLmdvb2dsZWFkcy52MTYuY29tbW'
    ...
    '9nbGVhZHMudjE2LmNvbW1vbi5Nb25leUgBUhBvcmRlcnNPdmVyQW1vdW50Qg8KDWRpc2NvdW50'
...
const CalloutAsset$json = {
  ...
  '2': [
    ...
    {'1': 'ad_schedule_targets', '3': 4, '4': 3, '5': 11, '6': '.google.ads.googleads.v16.common.AdScheduleInfo', '10': 'adScheduleTargets'},
  ],
};
...
final $typed_data.Uint8List calloutAssetDescriptor = $convert.base64Decode(
    ...
    'E2LmNvbW1vbi5BZFNjaGVkdWxlSW5mb1IRYWRTY2hlZHVsZVRhcmdldHM=');
...
const SitelinkAsset$json = {
  ...
  '2': [
    ...
    {'1': 'ad_schedule_targets', '3': 6, '4': 3, '5': 11, '6': '.google.ads.googleads.v16.common.AdScheduleInfo', '10': 'adScheduleTargets'},
  ],
};
...
final $typed_data.Uint8List sitelinkAssetDescriptor = $convert.base64Decode(
    ...
    'Z29vZ2xlYWRzLnYxNi5jb21tb24uQWRTY2hlZHVsZUluZm9SEWFkU2NoZWR1bGVUYXJnZXRz');
...
const MobileAppAsset$json = {
  ...
  '2': [
    ...
    {'1': 'app_store', '3': 2, '4': 1, '5': 14, '6': '.google.ads.googleads.v16.enums.MobileAppVendorEnum.MobileAppVendor', '8': {}, '10': 'appStore'},
...
final $typed_data.Uint8List mobileAppAssetDescriptor = $convert.base64Decode(
    ...
    'JlGAIgASgOMkMuZ29vZ2xlLmFkcy5nb29nbGVhZHMudjE2LmVudW1zLk1vYmlsZUFwcFZlbmRv'
...
const CallAsset$json = {
  ...
  '2': [
    ...
    {'1': 'call_conversion_reporting_state', '3': 3, '4': 1, '5': 14, '6': '.google.ads.googleads.v16.enums.CallConversionReportingStateEnum.CallConversionReportingState', '10': 'callConversionReportingState'},
    {'1': 'call_conversion_action', '3': 4, '4': 1, '5': 9, '8': {}, '10': 'callConversionAction'},
    {'1': 'ad_schedule_targets', '3': 5, '4': 3, '5': 11, '6': '.google.ads.googleads.v16.common.AdScheduleInfo', '10': 'adScheduleTargets'},
  ],
};
...
final $typed_data.Uint8List callAssetDescriptor = $convert.base64Decode(
    ...
    'X3JlcG9ydGluZ19zdGF0ZRgDIAEoDjJdLmdvb2dsZS5hZHMuZ29vZ2xlYWRzLnYxNi5lbnVtcy'
    ...
    'syLy5nb29nbGUuYWRzLmdvb2dsZWFkcy52MTYuY29tbW9uLkFkU2NoZWR1bGVJbmZvUhFhZFNj'
    'aGVkdWxlVGFyZ2V0cw==');
...
const PriceAsset$json = {
  '1': 'PriceAsset',
  '2': [
    {'1': 'type', '3': 1, '4': 1, '5': 14, '6': '.google.ads.googleads.v16.enums.PriceExtensionTypeEnum.PriceExtensionType', '8': {}, '10': 'type'},
    {'1': 'price_qualifier', '3': 2, '4': 1, '5': 14, '6': '.google.ads.googleads.v16.enums.PriceExtensionPriceQualifierEnum.PriceExtensionPriceQualifier', '10': 'priceQualifier'},
    {'1': 'language_code', '3': 3, '4': 1, '5': 9, '8': {}, '10': 'languageCode'},
    {'1': 'price_offerings', '3': 4, '4': 3, '5': 11, '6': '.google.ads.googleads.v16.common.PriceOffering', '10': 'priceOfferings'},
  ],
};
...
final $typed_data.Uint8List priceAssetDescriptor = $convert.base64Decode(
    'CgpQcmljZUFzc2V0EmIKBHR5cGUYASABKA4ySS5nb29nbGUuYWRzLmdvb2dsZWFkcy52MTYuZW'
    '51bXMuUHJpY2VFeHRlbnNpb25UeXBlRW51bS5QcmljZUV4dGVuc2lvblR5cGVCA+BBAlIEdHlw'
    'ZRKGAQoPcHJpY2VfcXVhbGlmaWVyGAIgASgOMl0uZ29vZ2xlLmFkcy5nb29nbGVhZHMudjE2Lm'
    ...
    'Z2xlYWRzLnYxNi5jb21tb24uUHJpY2VPZmZlcmluZ1IOcHJpY2VPZmZlcmluZ3M=');
...
const PriceOffering$json = {
  ...
  '2': [
    ...
    {'1': 'price', '3': 3, '4': 1, '5': 11, '6': '.google.ads.googleads.v16.common.Money', '8': {}, '10': 'price'},
    {'1': 'unit', '3': 4, '4': 1, '5': 14, '6': '.google.ads.googleads.v16.enums.PriceExtensionPriceUnitEnum.PriceExtensionPriceUnit', '10': 'unit'},
...
final $typed_data.Uint8List priceOfferingDescriptor = $convert.base64Decode(
    ...
    'Lmdvb2dsZWFkcy52MTYuY29tbW9uLk1vbmV5QgPgQQJSBXByaWNlEmcKBHVuaXQYBCABKA4yUy'
    '5nb29nbGUuYWRzLmdvb2dsZWFkcy52MTYuZW51bXMuUHJpY2VFeHRlbnNpb25QcmljZVVuaXRF'
...
const CallToActionAsset$json = {
  '1': 'CallToActionAsset',
  '2': [
    {'1': 'call_to_action', '3': 1, '4': 1, '5': 14, '6': '.google.ads.googleads.v16.enums.CallToActionTypeEnum.CallToActionType', '10': 'callToAction'},
  ],
};
...
final $typed_data.Uint8List callToActionAssetDescriptor = $convert.base64Decode(
    ...
    'MuZ29vZ2xlYWRzLnYxNi5lbnVtcy5DYWxsVG9BY3Rpb25UeXBlRW51bS5DYWxsVG9BY3Rpb25U'
...
const LocationAsset$json = {
  ...
  '2': [
    ...
    {'1': 'business_profile_locations', '3': 2, '4': 3, '5': 11, '6': '.google.ads.googleads.v16.common.BusinessProfileLocation', '10': 'businessProfileLocations'},
    {'1': 'location_ownership_type', '3': 3, '4': 1, '5': 14, '6': '.google.ads.googleads.v16.enums.LocationOwnershipTypeEnum.LocationOwnershipType', '10': 'locationOwnershipType'},
  ],
};
...
final $typed_data.Uint8List locationAssetDescriptor = $convert.base64Decode(
    ...
    'Byb2ZpbGVfbG9jYXRpb25zGAIgAygLMjguZ29vZ2xlLmFkcy5nb29nbGVhZHMudjE2LmNvbW1v'
    ...
    'Ni5lbnVtcy5Mb2NhdGlvbk93bmVyc2hpcFR5cGVFbnVtLkxvY2F0aW9uT3duZXJzaGlwVHlwZV'
