...
class ContentLabelTypeEnum extends $pb.GeneratedMessage {
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(_omitMessageNames ? '' : 'ContentLabelTypeEnum', package: const $pb.PackageName(_omitMessageNames ? '' : 'google.ads.googleads.v17.enums'), createEmptyInstance: create)
  ...
  'Will be removed in next major version')
  ContentLabelTypeEnum copyWith(void Function(ContentLabelTypeEnum) updates) => super.copyWith((message) => updates(message as ContentLabelTypeEnum)) as ContentLabelTypeEnum;
