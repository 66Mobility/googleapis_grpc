...
class LocalPlaceholderFieldEnum extends $pb.GeneratedMessage {
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(_omitMessageNames ? '' : 'LocalPlaceholderFieldEnum', package: const $pb.PackageName(_omitMessageNames ? '' : 'google.ads.googleads.v17.enums'), createEmptyInstance: create)
  ...
  'Will be removed in next major version')
  LocalPlaceholderFieldEnum copyWith(void Function(LocalPlaceholderFieldEnum) updates) => super.copyWith((message) => updates(message as LocalPlaceholderFieldEnum)) as LocalPlaceholderFieldEnum;
