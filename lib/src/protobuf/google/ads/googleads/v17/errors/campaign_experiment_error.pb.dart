...
class CampaignExperimentErrorEnum extends $pb.GeneratedMessage {
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(_omitMessageNames ? '' : 'CampaignExperimentErrorEnum', package: const $pb.PackageName(_omitMessageNames ? '' : 'google.ads.googleads.v17.errors'), createEmptyInstance: create)
  ...
  'Will be removed in next major version')
  CampaignExperimentErrorEnum copyWith(void Function(CampaignExperimentErrorEnum) updates) => super.copyWith((message) => updates(message as CampaignExperimentErrorEnum)) as CampaignExperimentErrorEnum;
