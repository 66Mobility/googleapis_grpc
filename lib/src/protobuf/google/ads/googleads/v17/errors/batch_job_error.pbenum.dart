...
class BatchJobErrorEnum_BatchJobError extends $pb.ProtobufEnum {
  ...
  static const BatchJobErrorEnum_BatchJobError ASSET_GROUP_AND_ASSET_GROUP_ASSET_TRANSACTION_FAILURE = BatchJobErrorEnum_BatchJobError._(9, _omitEnumNames ? '' : 'ASSET_GROUP_AND_ASSET_GROUP_ASSET_TRANSACTION_FAILURE');
  static const BatchJobErrorEnum_BatchJobError ASSET_GROUP_LISTING_GROUP_FILTER_TRANSACTION_FAILURE = BatchJobErrorEnum_BatchJobError._(10, _omitEnumNames ? '' : 'ASSET_GROUP_LISTING_GROUP_FILTER_TRANSACTION_FAILURE');
  static const BatchJobErrorEnum_BatchJobError REQUEST_TOO_LARGE = BatchJobErrorEnum_BatchJobError._(11, _omitEnumNames ? '' : 'REQUEST_TOO_LARGE');
