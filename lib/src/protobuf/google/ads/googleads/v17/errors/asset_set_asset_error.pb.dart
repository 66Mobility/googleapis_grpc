...
class AssetSetAssetErrorEnum extends $pb.GeneratedMessage {
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(_omitMessageNames ? '' : 'AssetSetAssetErrorEnum', package: const $pb.PackageName(_omitMessageNames ? '' : 'google.ads.googleads.v17.errors'), createEmptyInstance: create)
  ...
  'Will be removed in next major version')
  AssetSetAssetErrorEnum copyWith(void Function(AssetSetAssetErrorEnum) updates) => super.copyWith((message) => updates(message as AssetSetAssetErrorEnum)) as AssetSetAssetErrorEnum;
