...
class CampaignErrorEnum_CampaignError extends $pb.ProtobufEnum {
  ...
  static const CampaignErrorEnum_CampaignError CANNOT_SET_CAMPAIGN_KEYWORD_MATCH_TYPE = CampaignErrorEnum_CampaignError._(90, _omitEnumNames ? '' : 'CANNOT_SET_CAMPAIGN_KEYWORD_MATCH_TYPE');
  static const CampaignErrorEnum_CampaignError CANNOT_DISABLE_BROAD_MATCH_WHEN_KEYWORD_CONVERSION_IN_PROCESS = CampaignErrorEnum_CampaignError._(91, _omitEnumNames ? '' : 'CANNOT_DISABLE_BROAD_MATCH_WHEN_KEYWORD_CONVERSION_IN_PROCESS');
  static const CampaignErrorEnum_CampaignError CANNOT_DISABLE_BROAD_MATCH_WHEN_TARGETING_BRANDS = CampaignErrorEnum_CampaignError._(92, _omitEnumNames ? '' : 'CANNOT_DISABLE_BROAD_MATCH_WHEN_TARGETING_BRANDS');
  static const CampaignErrorEnum_CampaignError CANNOT_ENABLE_BROAD_MATCH_FOR_BASE_CAMPAIGN_WITH_PROMOTING_TRIAL = CampaignErrorEnum_CampaignError._(93, _omitEnumNames ? '' : 'CANNOT_ENABLE_BROAD_MATCH_FOR_BASE_CAMPAIGN_WITH_PROMOTING_TRIAL');
  static const CampaignErrorEnum_CampaignError CANNOT_ENABLE_BROAD_MATCH_FOR_PROMOTING_TRIAL_CAMPAIGN = CampaignErrorEnum_CampaignError._(94, _omitEnumNames ? '' : 'CANNOT_ENABLE_BROAD_MATCH_FOR_PROMOTING_TRIAL_CAMPAIGN');
