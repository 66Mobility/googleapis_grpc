...
const BatchJobErrorEnum_BatchJobError$json = {
  ...
  '2': [
    ...
    {'1': 'ASSET_GROUP_AND_ASSET_GROUP_ASSET_TRANSACTION_FAILURE', '2': 9},
    {'1': 'ASSET_GROUP_LISTING_GROUP_FILTER_TRANSACTION_FAILURE', '2': 10},
    {'1': 'REQUEST_TOO_LARGE', '2': 11},
  ],
};
...
final $typed_data.Uint8List batchJobErrorEnumDescriptor = $convert.base64Decode(
    'ChFCYXRjaEpvYkVycm9yRW51bSKDAwoNQmF0Y2hKb2JFcnJvchIPCgtVTlNQRUNJRklFRBAAEg'
    ...
    'WV9SRU1PVkVfUEVORElOR19KT0IQBxIXChNDQU5OT1RfTElTVF9SRVNVTFRTEAgSOQo1QVNTRV'
    'RfR1JPVVBfQU5EX0FTU0VUX0dST1VQX0FTU0VUX1RSQU5TQUNUSU9OX0ZBSUxVUkUQCRI4CjRB'
    'U1NFVF9HUk9VUF9MSVNUSU5HX0dST1VQX0ZJTFRFUl9UUkFOU0FDVElPTl9GQUlMVVJFEAoSFQ'
    'oRUkVRVUVTVF9UT09fTEFSR0UQCw==');
