...
class AssetGroupListingGroupFilterErrorEnum_AssetGroupListingGroupFilterError extends $pb.ProtobufEnum {
  ...
  static const AssetGroupListingGroupFilterErrorEnum_AssetGroupListingGroupFilterError DIMENSION_TYPE_NOT_ALLOWED = AssetGroupListingGroupFilterErrorEnum_AssetGroupListingGroupFilterError._(15, _omitEnumNames ? '' : 'DIMENSION_TYPE_NOT_ALLOWED');
  static const AssetGroupListingGroupFilterErrorEnum_AssetGroupListingGroupFilterError DUPLICATE_WEBPAGE_FILTER_UNDER_ASSET_GROUP = AssetGroupListingGroupFilterErrorEnum_AssetGroupListingGroupFilterError._(16, _omitEnumNames ? '' : 'DUPLICATE_WEBPAGE_FILTER_UNDER_ASSET_GROUP');
  static const AssetGroupListingGroupFilterErrorEnum_AssetGroupListingGroupFilterError LISTING_SOURCE_NOT_ALLOWED = AssetGroupListingGroupFilterErrorEnum_AssetGroupListingGroupFilterError._(17, _omitEnumNames ? '' : 'LISTING_SOURCE_NOT_ALLOWED');
  static const AssetGroupListingGroupFilterErrorEnum_AssetGroupListingGroupFilterError FILTER_EXCLUSION_NOT_ALLOWED = AssetGroupListingGroupFilterErrorEnum_AssetGroupListingGroupFilterError._(18, _omitEnumNames ? '' : 'FILTER_EXCLUSION_NOT_ALLOWED');
  static const AssetGroupListingGroupFilterErrorEnum_AssetGroupListingGroupFilterError MULTIPLE_LISTING_SOURCES = AssetGroupListingGroupFilterErrorEnum_AssetGroupListingGroupFilterError._(19, _omitEnumNames ? '' : 'MULTIPLE_LISTING_SOURCES');
  static const AssetGroupListingGroupFilterErrorEnum_AssetGroupListingGroupFilterError MULTIPLE_WEBPAGE_CONDITION_TYPES_NOT_ALLOWED = AssetGroupListingGroupFilterErrorEnum_AssetGroupListingGroupFilterError._(20, _omitEnumNames ? '' : 'MULTIPLE_WEBPAGE_CONDITION_TYPES_NOT_ALLOWED');
  static const AssetGroupListingGroupFilterErrorEnum_AssetGroupListingGroupFilterError MULTIPLE_WEBPAGE_TYPES_PER_ASSET_GROUP = AssetGroupListingGroupFilterErrorEnum_AssetGroupListingGroupFilterError._(21, _omitEnumNames ? '' : 'MULTIPLE_WEBPAGE_TYPES_PER_ASSET_GROUP');
  static const AssetGroupListingGroupFilterErrorEnum_AssetGroupListingGroupFilterError PAGE_FEED_FILTER_HAS_PARENT = AssetGroupListingGroupFilterErrorEnum_AssetGroupListingGroupFilterError._(22, _omitEnumNames ? '' : 'PAGE_FEED_FILTER_HAS_PARENT');
