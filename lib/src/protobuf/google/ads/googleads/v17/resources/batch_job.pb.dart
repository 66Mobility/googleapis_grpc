...
import '../enums/batch_job_status.pbenum.dart' as $3592;
...
class BatchJob extends $pb.GeneratedMessage {
  factory BatchJob({
    ...
    $3592.BatchJobStatusEnum_BatchJobStatus? status,
    $fixnum.Int64? id,
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(_omitMessageNames ? '' : 'BatchJob', package: const $pb.PackageName(_omitMessageNames ? '' : 'google.ads.googleads.v17.resources'), createEmptyInstance: create)
    ...
    ..e<$3592.BatchJobStatusEnum_BatchJobStatus>(5, _omitFieldNames ? '' : 'status', $pb.PbFieldType.OE, defaultOrMaker: $3592.BatchJobStatusEnum_BatchJobStatus.UNSPECIFIED, valueOf: $3592.BatchJobStatusEnum_BatchJobStatus.valueOf, enumValues: $3592.BatchJobStatusEnum_BatchJobStatus.values)
  ...
  @$pb.TagNumber(5)
  $3592.BatchJobStatusEnum_BatchJobStatus get status => $_getN(2);
  @$pb.TagNumber(5)
  set status($3592.BatchJobStatusEnum_BatchJobStatus v) { setField(5, v); }
  @$pb.TagNumber(5)
