...
class RemarketingAction extends $pb.GeneratedMessage {
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(_omitMessageNames ? '' : 'RemarketingAction', package: const $pb.PackageName(_omitMessageNames ? '' : 'google.ads.googleads.v17.resources'), createEmptyInstance: create)
    ..aOS(1, _omitFieldNames ? '' : 'resourceName')
    ..pc<$3670.TagSnippet>(4, _omitFieldNames ? '' : 'tagSnippets', $pb.PbFieldType.PM, subBuilder: $3670.TagSnippet.create)
  ...
  @$pb.TagNumber(4)
  $core.List<$3670.TagSnippet> get tagSnippets => $_getList(1);
