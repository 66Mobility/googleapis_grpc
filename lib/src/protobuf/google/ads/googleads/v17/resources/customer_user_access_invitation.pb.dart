...
import '../enums/access_invitation_status.pbenum.dart' as $3698;
...
class CustomerUserAccessInvitation extends $pb.GeneratedMessage {
  factory CustomerUserAccessInvitation({
    ...
    $3698.AccessInvitationStatusEnum_AccessInvitationStatus? invitationStatus,
  }) {
    final $result = create();
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(_omitMessageNames ? '' : 'CustomerUserAccessInvitation', package: const $pb.PackageName(_omitMessageNames ? '' : 'google.ads.googleads.v17.resources'), createEmptyInstance: create)
    ...
    ..e<$3697.AccessRoleEnum_AccessRole>(3, _omitFieldNames ? '' : 'accessRole', $pb.PbFieldType.OE, defaultOrMaker: $3697.AccessRoleEnum_AccessRole.UNSPECIFIED, valueOf: $3697.AccessRoleEnum_AccessRole.valueOf, enumValues: $3697.AccessRoleEnum_AccessRole.values)
    ..aOS(4, _omitFieldNames ? '' : 'emailAddress')
    ..aOS(5, _omitFieldNames ? '' : 'creationDateTime')
    ..e<$3698.AccessInvitationStatusEnum_AccessInvitationStatus>(6, _omitFieldNames ? '' : 'invitationStatus', $pb.PbFieldType.OE, defaultOrMaker: $3698.AccessInvitationStatusEnum_AccessInvitationStatus.UNSPECIFIED, valueOf: $3698.AccessInvitationStatusEnum_AccessInvitationStatus.valueOf, enumValues: $3698.AccessInvitationStatusEnum_AccessInvitationStatus.values)
  ...
  @$pb.TagNumber(3)
  set accessRole($3697.AccessRoleEnum_AccessRole v) { setField(3, v); }
  @$pb.TagNumber(3)
  ...
  @$pb.TagNumber(6)
  $3698.AccessInvitationStatusEnum_AccessInvitationStatus get invitationStatus => $_getN(5);
  @$pb.TagNumber(6)
  set invitationStatus($3698.AccessInvitationStatusEnum_AccessInvitationStatus v) { setField(6, v); }
  @$pb.TagNumber(6)
