...
class BiddingStrategySimulation extends $pb.GeneratedMessage {
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(_omitMessageNames ? '' : 'BiddingStrategySimulation', package: const $pb.PackageName(_omitMessageNames ? '' : 'google.ads.googleads.v17.resources'), createEmptyInstance: create)
    ..oo(0, [7, 8])
    ...
    ..aOM<$3562.TargetCpaSimulationPointList>(7, _omitFieldNames ? '' : 'targetCpaPointList', subBuilder: $3562.TargetCpaSimulationPointList.create)
    ..aOM<$3562.TargetRoasSimulationPointList>(8, _omitFieldNames ? '' : 'targetRoasPointList', subBuilder: $3562.TargetRoasSimulationPointList.create)
  ...
  @$pb.TagNumber(7)
  $3562.TargetCpaSimulationPointList get targetCpaPointList => $_getN(6);
  @$pb.TagNumber(7)
  set targetCpaPointList($3562.TargetCpaSimulationPointList v) { setField(7, v); }
  @$pb.TagNumber(7)
  $core.bool hasTargetCpaPointList() => $_has(6);
  @$pb.TagNumber(7)
  void clearTargetCpaPointList() => clearField(7);
  @$pb.TagNumber(7)
  $3562.TargetCpaSimulationPointList ensureTargetCpaPointList() => $_ensure(6);

  /// Output only. Simulation points if the simulation type is TARGET_ROAS.
  @$pb.TagNumber(8)
  $3562.TargetRoasSimulationPointList get targetRoasPointList => $_getN(7);
  @$pb.TagNumber(8)
  set targetRoasPointList($3562.TargetRoasSimulationPointList v) { setField(8, v); }
  @$pb.TagNumber(8)
  $core.bool hasTargetRoasPointList() => $_has(7);
  @$pb.TagNumber(8)
  void clearTargetRoasPointList() => clearField(8);
  @$pb.TagNumber(8)
  $3562.TargetRoasSimulationPointList ensureTargetRoasPointList() => $_ensure(7);
}
