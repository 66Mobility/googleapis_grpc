...
import '../enums/custom_conversion_goal_status.pbenum.dart' as $3688;
...
class CustomConversionGoal extends $pb.GeneratedMessage {
  factory CustomConversionGoal({
    ...
    $3688.CustomConversionGoalStatusEnum_CustomConversionGoalStatus? status,
  }) {
    final $result = create();
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(_omitMessageNames ? '' : 'CustomConversionGoal', package: const $pb.PackageName(_omitMessageNames ? '' : 'google.ads.googleads.v17.resources'), createEmptyInstance: create)
    ...
    ..e<$3688.CustomConversionGoalStatusEnum_CustomConversionGoalStatus>(5, _omitFieldNames ? '' : 'status', $pb.PbFieldType.OE, defaultOrMaker: $3688.CustomConversionGoalStatusEnum_CustomConversionGoalStatus.UNSPECIFIED, valueOf: $3688.CustomConversionGoalStatusEnum_CustomConversionGoalStatus.valueOf, enumValues: $3688.CustomConversionGoalStatusEnum_CustomConversionGoalStatus.values)
  ...
  @$pb.TagNumber(5)
  $3688.CustomConversionGoalStatusEnum_CustomConversionGoalStatus get status => $_getN(4);
  @$pb.TagNumber(5)
  set status($3688.CustomConversionGoalStatusEnum_CustomConversionGoalStatus v) { setField(5, v); }
  @$pb.TagNumber(5)
