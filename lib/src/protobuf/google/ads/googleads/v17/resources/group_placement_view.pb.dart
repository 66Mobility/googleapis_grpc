...
class GroupPlacementView extends $pb.GeneratedMessage {
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(_omitMessageNames ? '' : 'GroupPlacementView', package: const $pb.PackageName(_omitMessageNames ? '' : 'google.ads.googleads.v17.resources'), createEmptyInstance: create)
    ...
    ..e<$3700.PlacementTypeEnum_PlacementType>(5, _omitFieldNames ? '' : 'placementType', $pb.PbFieldType.OE, defaultOrMaker: $3700.PlacementTypeEnum_PlacementType.UNSPECIFIED, valueOf: $3700.PlacementTypeEnum_PlacementType.valueOf, enumValues: $3700.PlacementTypeEnum_PlacementType.values)
  ...
  @$pb.TagNumber(5)
  set placementType($3700.PlacementTypeEnum_PlacementType v) { setField(5, v); }
  @$pb.TagNumber(5)
