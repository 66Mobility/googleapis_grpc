...
import '../enums/combined_audience_status.pbenum.dart' as $3669;
...
class CombinedAudience extends $pb.GeneratedMessage {
  factory CombinedAudience({
    ...
    $fixnum.Int64? id,
    $3669.CombinedAudienceStatusEnum_CombinedAudienceStatus? status,
    $core.String? name,
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(_omitMessageNames ? '' : 'CombinedAudience', package: const $pb.PackageName(_omitMessageNames ? '' : 'google.ads.googleads.v17.resources'), createEmptyInstance: create)
    ...
    ..e<$3669.CombinedAudienceStatusEnum_CombinedAudienceStatus>(3, _omitFieldNames ? '' : 'status', $pb.PbFieldType.OE, defaultOrMaker: $3669.CombinedAudienceStatusEnum_CombinedAudienceStatus.UNSPECIFIED, valueOf: $3669.CombinedAudienceStatusEnum_CombinedAudienceStatus.valueOf, enumValues: $3669.CombinedAudienceStatusEnum_CombinedAudienceStatus.values)
  ...
  @$pb.TagNumber(3)
  $3669.CombinedAudienceStatusEnum_CombinedAudienceStatus get status => $_getN(2);
  @$pb.TagNumber(3)
  set status($3669.CombinedAudienceStatusEnum_CombinedAudienceStatus v) { setField(3, v); }
  @$pb.TagNumber(3)
