...
class CustomerExtensionSetting extends $pb.GeneratedMessage {
  ...
  @$pb.TagNumber(4)
  set device($3567.ExtensionSettingDeviceEnum_ExtensionSettingDevice v) { setField(4, v); }
  @$pb.TagNumber(4)
