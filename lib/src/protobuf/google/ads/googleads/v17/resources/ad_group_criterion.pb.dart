...
class AdGroupCriterion_PositionEstimates extends $pb.GeneratedMessage {
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(_omitMessageNames ? '' : 'AdGroupCriterion.PositionEstimates', package: const $pb.PackageName(_omitMessageNames ? '' : 'google.ads.googleads.v17.resources'), createEmptyInstance: create)
...
class AdGroupCriterion extends $pb.GeneratedMessage {
  ...
  @$pb.TagNumber(85)
  void clearPrimaryStatus() => clearField(85);
