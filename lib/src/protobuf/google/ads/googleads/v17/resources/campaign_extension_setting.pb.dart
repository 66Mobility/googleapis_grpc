...
class CampaignExtensionSetting extends $pb.GeneratedMessage {
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(_omitMessageNames ? '' : 'CampaignExtensionSetting', package: const $pb.PackageName(_omitMessageNames ? '' : 'google.ads.googleads.v17.resources'), createEmptyInstance: create)
    ...
    ..e<$3566.ExtensionSettingDeviceEnum_ExtensionSettingDevice>(5, _omitFieldNames ? '' : 'device', $pb.PbFieldType.OE, defaultOrMaker: $3566.ExtensionSettingDeviceEnum_ExtensionSettingDevice.UNSPECIFIED, valueOf: $3566.ExtensionSettingDeviceEnum_ExtensionSettingDevice.valueOf, enumValues: $3566.ExtensionSettingDeviceEnum_ExtensionSettingDevice.values)
  ...
  @$pb.TagNumber(5)
  set device($3566.ExtensionSettingDeviceEnum_ExtensionSettingDevice v) { setField(5, v); }
  @$pb.TagNumber(5)
