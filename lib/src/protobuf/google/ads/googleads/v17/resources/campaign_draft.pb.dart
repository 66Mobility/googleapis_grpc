...
import '../enums/campaign_draft_status.pbenum.dart' as $3630;

/// A campaign draft.
class CampaignDraft extends $pb.GeneratedMessage {
  factory CampaignDraft({
    $core.String? resourceName,
    $3630.CampaignDraftStatusEnum_CampaignDraftStatus? status,
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(_omitMessageNames ? '' : 'CampaignDraft', package: const $pb.PackageName(_omitMessageNames ? '' : 'google.ads.googleads.v17.resources'), createEmptyInstance: create)
    ...
    ..e<$3630.CampaignDraftStatusEnum_CampaignDraftStatus>(6, _omitFieldNames ? '' : 'status', $pb.PbFieldType.OE, defaultOrMaker: $3630.CampaignDraftStatusEnum_CampaignDraftStatus.UNSPECIFIED, valueOf: $3630.CampaignDraftStatusEnum_CampaignDraftStatus.valueOf, enumValues: $3630.CampaignDraftStatusEnum_CampaignDraftStatus.values)
  ...
  @$pb.TagNumber(6)
  $3630.CampaignDraftStatusEnum_CampaignDraftStatus get status => $_getN(1);
  @$pb.TagNumber(6)
  set status($3630.CampaignDraftStatusEnum_CampaignDraftStatus v) { setField(6, v); }
  @$pb.TagNumber(6)
