...
import '../enums/distance_bucket.pbenum.dart' as $3702;
...
class DistanceView extends $pb.GeneratedMessage {
  factory DistanceView({
    ...
    $3702.DistanceBucketEnum_DistanceBucket? distanceBucket,
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(_omitMessageNames ? '' : 'DistanceView', package: const $pb.PackageName(_omitMessageNames ? '' : 'google.ads.googleads.v17.resources'), createEmptyInstance: create)
    ..aOS(1, _omitFieldNames ? '' : 'resourceName')
    ..e<$3702.DistanceBucketEnum_DistanceBucket>(2, _omitFieldNames ? '' : 'distanceBucket', $pb.PbFieldType.OE, defaultOrMaker: $3702.DistanceBucketEnum_DistanceBucket.UNSPECIFIED, valueOf: $3702.DistanceBucketEnum_DistanceBucket.valueOf, enumValues: $3702.DistanceBucketEnum_DistanceBucket.values)
  ...
  @$pb.TagNumber(2)
  $3702.DistanceBucketEnum_DistanceBucket get distanceBucket => $_getN(1);
  @$pb.TagNumber(2)
  set distanceBucket($3702.DistanceBucketEnum_DistanceBucket v) { setField(2, v); }
  @$pb.TagNumber(2)
