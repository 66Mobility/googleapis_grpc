...
class ProductLink extends $pb.GeneratedMessage {
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(_omitMessageNames ? '' : 'ProductLink', package: const $pb.PackageName(_omitMessageNames ? '' : 'google.ads.googleads.v17.resources'), createEmptyInstance: create)
    ..oo(0, [4, 5, 12, 13])
    ..aOS(1, _omitFieldNames ? '' : 'resourceName')
    ..aInt64(2, _omitFieldNames ? '' : 'productLinkId')
    ..e<$3772.LinkedProductTypeEnum_LinkedProductType>(3, _omitFieldNames ? '' : 'type', $pb.PbFieldType.OE, defaultOrMaker: $3772.LinkedProductTypeEnum_LinkedProductType.UNSPECIFIED, valueOf: $3772.LinkedProductTypeEnum_LinkedProductType.valueOf, enumValues: $3772.LinkedProductTypeEnum_LinkedProductType.values)
  ...
  @$pb.TagNumber(3)
  $3772.LinkedProductTypeEnum_LinkedProductType get type => $_getN(2);
  @$pb.TagNumber(3)
  set type($3772.LinkedProductTypeEnum_LinkedProductType v) { setField(3, v); }
  @$pb.TagNumber(3)
...
class DataPartnerIdentifier extends $pb.GeneratedMessage {
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(_omitMessageNames ? '' : 'DataPartnerIdentifier', package: const $pb.PackageName(_omitMessageNames ? '' : 'google.ads.googleads.v17.resources'), createEmptyInstance: create)
...
class GoogleAdsIdentifier extends $pb.GeneratedMessage {
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(_omitMessageNames ? '' : 'GoogleAdsIdentifier', package: const $pb.PackageName(_omitMessageNames ? '' : 'google.ads.googleads.v17.resources'), createEmptyInstance: create)
...
class MerchantCenterIdentifier extends $pb.GeneratedMessage {
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(_omitMessageNames ? '' : 'MerchantCenterIdentifier', package: const $pb.PackageName(_omitMessageNames ? '' : 'google.ads.googleads.v17.resources'), createEmptyInstance: create)
...
class AdvertisingPartnerIdentifier extends $pb.GeneratedMessage {
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(_omitMessageNames ? '' : 'AdvertisingPartnerIdentifier', package: const $pb.PackageName(_omitMessageNames ? '' : 'google.ads.googleads.v17.resources'), createEmptyInstance: create)
    ..aOS(1, _omitFieldNames ? '' : 'customer')
    ..hasRequiredFields = false
  ;
