...
class CustomerSkAdNetworkConversionValueSchema_SkAdNetworkConversionValueSchema_PostbackMapping extends $pb.GeneratedMessage {
  factory CustomerSkAdNetworkConversionValueSchema_SkAdNetworkConversionValueSchema_PostbackMapping({
    ...
    $3347.SkAdNetworkCoarseConversionValueEnum_SkAdNetworkCoarseConversionValue? lockWindowCoarseConversionValue,
  ...
  /// window lock.
  @$pb.TagNumber(3)
  $3347.SkAdNetworkCoarseConversionValueEnum_SkAdNetworkCoarseConversionValue get lockWindowCoarseConversionValue => $_getN(2);
  @$pb.TagNumber(3)
  set lockWindowCoarseConversionValue($3347.SkAdNetworkCoarseConversionValueEnum_SkAdNetworkCoarseConversionValue v) { setField(3, v); }
  @$pb.TagNumber(3)
