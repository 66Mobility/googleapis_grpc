...
class CampaignAsset extends $pb.GeneratedMessage {
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(_omitMessageNames ? '' : 'CampaignAsset', package: const $pb.PackageName(_omitMessageNames ? '' : 'google.ads.googleads.v17.resources'), createEmptyInstance: create)
    ...
    ..e<$3551.AssetSourceEnum_AssetSource>(8, _omitFieldNames ? '' : 'source', $pb.PbFieldType.OE, defaultOrMaker: $3551.AssetSourceEnum_AssetSource.UNSPECIFIED, valueOf: $3551.AssetSourceEnum_AssetSource.valueOf, enumValues: $3551.AssetSourceEnum_AssetSource.values)
    ..e<$3245.AssetLinkPrimaryStatusEnum_AssetLinkPrimaryStatus>(9, _omitFieldNames ? '' : 'primaryStatus', $pb.PbFieldType.OE, defaultOrMaker: $3245.AssetLinkPrimaryStatusEnum_AssetLinkPrimaryStatus.UNSPECIFIED, valueOf: $3245.AssetLinkPrimaryStatusEnum_AssetLinkPrimaryStatus.valueOf, enumValues: $3245.AssetLinkPrimaryStatusEnum_AssetLinkPrimaryStatus.values)
    ...
    ..pc<$3244.AssetLinkPrimaryStatusReasonEnum_AssetLinkPrimaryStatusReason>(11, _omitFieldNames ? '' : 'primaryStatusReasons', $pb.PbFieldType.KE, valueOf: $3244.AssetLinkPrimaryStatusReasonEnum_AssetLinkPrimaryStatusReason.valueOf, enumValues: $3244.AssetLinkPrimaryStatusReasonEnum_AssetLinkPrimaryStatusReason.values, defaultEnumValue: $3244.AssetLinkPrimaryStatusReasonEnum_AssetLinkPrimaryStatusReason.UNSPECIFIED)
  ...
  @$pb.TagNumber(5)
  $3552.AssetLinkStatusEnum_AssetLinkStatus get status => $_getN(2);
  @$pb.TagNumber(5)
  ...
  @$pb.TagNumber(8)
  set source($3551.AssetSourceEnum_AssetSource v) { setField(8, v); }
  @$pb.TagNumber(8)
  ...
  @$pb.TagNumber(9)
  set primaryStatus($3245.AssetLinkPrimaryStatusEnum_AssetLinkPrimaryStatus v) { setField(9, v); }
  @$pb.TagNumber(9)
