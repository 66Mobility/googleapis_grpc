...
import '../common/user_lists.pb.dart' as $3785;
import '../enums/access_reason.pbenum.dart' as $3790;
import '../enums/user_list_access_status.pbenum.dart' as $3791;
import '../enums/user_list_closing_reason.pbenum.dart' as $3789;
import '../enums/user_list_membership_status.pbenum.dart' as $3786;
import '../enums/user_list_size_range.pbenum.dart' as $3787;
import '../enums/user_list_type.pbenum.dart' as $3788;
...
class UserList extends $pb.GeneratedMessage {
  factory UserList({
    ...
    $3786.UserListMembershipStatusEnum_UserListMembershipStatus? membershipStatus,
    $3787.UserListSizeRangeEnum_UserListSizeRange? sizeRangeForDisplay,
    $3787.UserListSizeRangeEnum_UserListSizeRange? sizeRangeForSearch,
    $3788.UserListTypeEnum_UserListType? type,
    $3789.UserListClosingReasonEnum_UserListClosingReason? closingReason,
    $3790.AccessReasonEnum_AccessReason? accessReason,
    $3791.UserListAccessStatusEnum_UserListAccessStatus? accountUserListStatus,
    $3785.CrmBasedUserListInfo? crmBasedUserList,
    $3785.SimilarUserListInfo? similarUserList,
    $3785.RuleBasedUserListInfo? ruleBasedUserList,
    $3785.LogicalUserListInfo? logicalUserList,
    $3785.BasicUserListInfo? basicUserList,
    ...
    $3785.LookalikeUserListInfo? lookalikeUserList,
  }) {
    final $result = create();
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(_omitMessageNames ? '' : 'UserList', package: const $pb.PackageName(_omitMessageNames ? '' : 'google.ads.googleads.v17.resources'), createEmptyInstance: create)
    ...
    ..e<$3786.UserListMembershipStatusEnum_UserListMembershipStatus>(6, _omitFieldNames ? '' : 'membershipStatus', $pb.PbFieldType.OE, defaultOrMaker: $3786.UserListMembershipStatusEnum_UserListMembershipStatus.UNSPECIFIED, valueOf: $3786.UserListMembershipStatusEnum_UserListMembershipStatus.valueOf, enumValues: $3786.UserListMembershipStatusEnum_UserListMembershipStatus.values)
    ..e<$3787.UserListSizeRangeEnum_UserListSizeRange>(10, _omitFieldNames ? '' : 'sizeRangeForDisplay', $pb.PbFieldType.OE, defaultOrMaker: $3787.UserListSizeRangeEnum_UserListSizeRange.UNSPECIFIED, valueOf: $3787.UserListSizeRangeEnum_UserListSizeRange.valueOf, enumValues: $3787.UserListSizeRangeEnum_UserListSizeRange.values)
    ..e<$3787.UserListSizeRangeEnum_UserListSizeRange>(12, _omitFieldNames ? '' : 'sizeRangeForSearch', $pb.PbFieldType.OE, defaultOrMaker: $3787.UserListSizeRangeEnum_UserListSizeRange.UNSPECIFIED, valueOf: $3787.UserListSizeRangeEnum_UserListSizeRange.valueOf, enumValues: $3787.UserListSizeRangeEnum_UserListSizeRange.values)
    ..e<$3788.UserListTypeEnum_UserListType>(13, _omitFieldNames ? '' : 'type', $pb.PbFieldType.OE, defaultOrMaker: $3788.UserListTypeEnum_UserListType.UNSPECIFIED, valueOf: $3788.UserListTypeEnum_UserListType.valueOf, enumValues: $3788.UserListTypeEnum_UserListType.values)
    ..e<$3789.UserListClosingReasonEnum_UserListClosingReason>(14, _omitFieldNames ? '' : 'closingReason', $pb.PbFieldType.OE, defaultOrMaker: $3789.UserListClosingReasonEnum_UserListClosingReason.UNSPECIFIED, valueOf: $3789.UserListClosingReasonEnum_UserListClosingReason.valueOf, enumValues: $3789.UserListClosingReasonEnum_UserListClosingReason.values)
    ..e<$3790.AccessReasonEnum_AccessReason>(15, _omitFieldNames ? '' : 'accessReason', $pb.PbFieldType.OE, defaultOrMaker: $3790.AccessReasonEnum_AccessReason.UNSPECIFIED, valueOf: $3790.AccessReasonEnum_AccessReason.valueOf, enumValues: $3790.AccessReasonEnum_AccessReason.values)
    ..e<$3791.UserListAccessStatusEnum_UserListAccessStatus>(16, _omitFieldNames ? '' : 'accountUserListStatus', $pb.PbFieldType.OE, defaultOrMaker: $3791.UserListAccessStatusEnum_UserListAccessStatus.UNSPECIFIED, valueOf: $3791.UserListAccessStatusEnum_UserListAccessStatus.valueOf, enumValues: $3791.UserListAccessStatusEnum_UserListAccessStatus.values)
    ..aOM<$3785.CrmBasedUserListInfo>(19, _omitFieldNames ? '' : 'crmBasedUserList', subBuilder: $3785.CrmBasedUserListInfo.create)
    ..aOM<$3785.SimilarUserListInfo>(20, _omitFieldNames ? '' : 'similarUserList', subBuilder: $3785.SimilarUserListInfo.create)
    ..aOM<$3785.RuleBasedUserListInfo>(21, _omitFieldNames ? '' : 'ruleBasedUserList', subBuilder: $3785.RuleBasedUserListInfo.create)
    ..aOM<$3785.LogicalUserListInfo>(22, _omitFieldNames ? '' : 'logicalUserList', subBuilder: $3785.LogicalUserListInfo.create)
    ..aOM<$3785.BasicUserListInfo>(23, _omitFieldNames ? '' : 'basicUserList', subBuilder: $3785.BasicUserListInfo.create)
    ...
    ..aOM<$3785.LookalikeUserListInfo>(36, _omitFieldNames ? '' : 'lookalikeUserList', subBuilder: $3785.LookalikeUserListInfo.create)
  ...
  /// targeted to.
  @$pb.TagNumber(6)
  $3786.UserListMembershipStatusEnum_UserListMembershipStatus get membershipStatus => $_getN(1);
  @$pb.TagNumber(6)
  set membershipStatus($3786.UserListMembershipStatusEnum_UserListMembershipStatus v) { setField(6, v); }
  @$pb.TagNumber(6)
  ...
  @$pb.TagNumber(10)
  $3787.UserListSizeRangeEnum_UserListSizeRange get sizeRangeForDisplay => $_getN(2);
  @$pb.TagNumber(10)
  set sizeRangeForDisplay($3787.UserListSizeRangeEnum_UserListSizeRange v) { setField(10, v); }
  @$pb.TagNumber(10)
  ...
  ///  This field is read-only.
  @$pb.TagNumber(12)
  $3787.UserListSizeRangeEnum_UserListSizeRange get sizeRangeForSearch => $_getN(3);
  @$pb.TagNumber(12)
  set sizeRangeForSearch($3787.UserListSizeRangeEnum_UserListSizeRange v) { setField(12, v); }
  @$pb.TagNumber(12)
  ...
  ///  This field is read-only.
  @$pb.TagNumber(13)
  $3788.UserListTypeEnum_UserListType get type => $_getN(4);
  @$pb.TagNumber(13)
  set type($3788.UserListTypeEnum_UserListType v) { setField(13, v); }
  @$pb.TagNumber(13)
  ...
  @$pb.TagNumber(14)
  $3789.UserListClosingReasonEnum_UserListClosingReason get closingReason => $_getN(5);
  @$pb.TagNumber(14)
  set closingReason($3789.UserListClosingReasonEnum_UserListClosingReason v) { setField(14, v); }
  @$pb.TagNumber(14)
  ...
  ///  This field is read-only.
  @$pb.TagNumber(15)
  $3790.AccessReasonEnum_AccessReason get accessReason => $_getN(6);
  @$pb.TagNumber(15)
  set accessReason($3790.AccessReasonEnum_AccessReason v) { setField(15, v); }
  @$pb.TagNumber(15)
  ...
  @$pb.TagNumber(16)
  $3791.UserListAccessStatusEnum_UserListAccessStatus get accountUserListStatus => $_getN(7);
  @$pb.TagNumber(16)
  set accountUserListStatus($3791.UserListAccessStatusEnum_UserListAccessStatus v) { setField(16, v); }
  @$pb.TagNumber(16)
  ...
  @$pb.TagNumber(19)
  $3785.CrmBasedUserListInfo get crmBasedUserList => $_getN(8);
  @$pb.TagNumber(19)
  set crmBasedUserList($3785.CrmBasedUserListInfo v) { setField(19, v); }
  @$pb.TagNumber(19)
  $core.bool hasCrmBasedUserList() => $_has(8);
  @$pb.TagNumber(19)
  void clearCrmBasedUserList() => clearField(19);
  @$pb.TagNumber(19)
  $3785.CrmBasedUserListInfo ensureCrmBasedUserList() => $_ensure(8);
  ...
  @$pb.TagNumber(20)
  $3785.SimilarUserListInfo get similarUserList => $_getN(9);
  @$pb.TagNumber(20)
  set similarUserList($3785.SimilarUserListInfo v) { setField(20, v); }
  @$pb.TagNumber(20)
  $core.bool hasSimilarUserList() => $_has(9);
  @$pb.TagNumber(20)
  void clearSimilarUserList() => clearField(20);
  @$pb.TagNumber(20)
  $3785.SimilarUserListInfo ensureSimilarUserList() => $_ensure(9);

  /// User list generated by a rule.
  @$pb.TagNumber(21)
  $3785.RuleBasedUserListInfo get ruleBasedUserList => $_getN(10);
  @$pb.TagNumber(21)
  set ruleBasedUserList($3785.RuleBasedUserListInfo v) { setField(21, v); }
  @$pb.TagNumber(21)
  $core.bool hasRuleBasedUserList() => $_has(10);
  @$pb.TagNumber(21)
  void clearRuleBasedUserList() => clearField(21);
  @$pb.TagNumber(21)
  $3785.RuleBasedUserListInfo ensureRuleBasedUserList() => $_ensure(10);

  /// User list that is a custom combination of user lists and user interests.
  @$pb.TagNumber(22)
  $3785.LogicalUserListInfo get logicalUserList => $_getN(11);
  @$pb.TagNumber(22)
  set logicalUserList($3785.LogicalUserListInfo v) { setField(22, v); }
  @$pb.TagNumber(22)
  $core.bool hasLogicalUserList() => $_has(11);
  @$pb.TagNumber(22)
  void clearLogicalUserList() => clearField(22);
  @$pb.TagNumber(22)
  $3785.LogicalUserListInfo ensureLogicalUserList() => $_ensure(11);

  /// User list targeting as a collection of conversion or remarketing actions.
  @$pb.TagNumber(23)
  $3785.BasicUserListInfo get basicUserList => $_getN(12);
  @$pb.TagNumber(23)
  set basicUserList($3785.BasicUserListInfo v) { setField(23, v); }
  @$pb.TagNumber(23)
  $core.bool hasBasicUserList() => $_has(12);
  @$pb.TagNumber(23)
  void clearBasicUserList() => clearField(23);
  @$pb.TagNumber(23)
  $3785.BasicUserListInfo ensureBasicUserList() => $_ensure(12);
  ...
  @$pb.TagNumber(36)
  $3785.LookalikeUserListInfo get lookalikeUserList => $_getN(24);
  @$pb.TagNumber(36)
  set lookalikeUserList($3785.LookalikeUserListInfo v) { setField(36, v); }
  @$pb.TagNumber(36)
  $core.bool hasLookalikeUserList() => $_has(24);
  @$pb.TagNumber(36)
  void clearLookalikeUserList() => clearField(36);
  @$pb.TagNumber(36)
  $3785.LookalikeUserListInfo ensureLookalikeUserList() => $_ensure(24);
}
