...
import '../common/user_lists.pb.dart' as $3786;
import '../enums/access_reason.pbenum.dart' as $3791;
import '../enums/user_list_access_status.pbenum.dart' as $3792;
import '../enums/user_list_closing_reason.pbenum.dart' as $3790;
import '../enums/user_list_membership_status.pbenum.dart' as $3787;
import '../enums/user_list_size_range.pbenum.dart' as $3788;
import '../enums/user_list_type.pbenum.dart' as $3789;
...
class UserList extends $pb.GeneratedMessage {
  factory UserList({
    ...
    $3787.UserListMembershipStatusEnum_UserListMembershipStatus? membershipStatus,
    $3788.UserListSizeRangeEnum_UserListSizeRange? sizeRangeForDisplay,
    $3788.UserListSizeRangeEnum_UserListSizeRange? sizeRangeForSearch,
    $3789.UserListTypeEnum_UserListType? type,
    $3790.UserListClosingReasonEnum_UserListClosingReason? closingReason,
    $3791.AccessReasonEnum_AccessReason? accessReason,
    $3792.UserListAccessStatusEnum_UserListAccessStatus? accountUserListStatus,
    $3786.CrmBasedUserListInfo? crmBasedUserList,
    $3786.SimilarUserListInfo? similarUserList,
    $3786.RuleBasedUserListInfo? ruleBasedUserList,
    $3786.LogicalUserListInfo? logicalUserList,
    $3786.BasicUserListInfo? basicUserList,
    ...
    $3786.LookalikeUserListInfo? lookalikeUserList,
  }) {
    final $result = create();
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(_omitMessageNames ? '' : 'UserList', package: const $pb.PackageName(_omitMessageNames ? '' : 'google.ads.googleads.v17.resources'), createEmptyInstance: create)
    ..oo(0, [19, 20, 21, 22, 23, 36])
    ..aOS(1, _omitFieldNames ? '' : 'resourceName')
    ..e<$3787.UserListMembershipStatusEnum_UserListMembershipStatus>(6, _omitFieldNames ? '' : 'membershipStatus', $pb.PbFieldType.OE, defaultOrMaker: $3787.UserListMembershipStatusEnum_UserListMembershipStatus.UNSPECIFIED, valueOf: $3787.UserListMembershipStatusEnum_UserListMembershipStatus.valueOf, enumValues: $3787.UserListMembershipStatusEnum_UserListMembershipStatus.values)
    ..e<$3788.UserListSizeRangeEnum_UserListSizeRange>(10, _omitFieldNames ? '' : 'sizeRangeForDisplay', $pb.PbFieldType.OE, defaultOrMaker: $3788.UserListSizeRangeEnum_UserListSizeRange.UNSPECIFIED, valueOf: $3788.UserListSizeRangeEnum_UserListSizeRange.valueOf, enumValues: $3788.UserListSizeRangeEnum_UserListSizeRange.values)
    ..e<$3788.UserListSizeRangeEnum_UserListSizeRange>(12, _omitFieldNames ? '' : 'sizeRangeForSearch', $pb.PbFieldType.OE, defaultOrMaker: $3788.UserListSizeRangeEnum_UserListSizeRange.UNSPECIFIED, valueOf: $3788.UserListSizeRangeEnum_UserListSizeRange.valueOf, enumValues: $3788.UserListSizeRangeEnum_UserListSizeRange.values)
    ..e<$3789.UserListTypeEnum_UserListType>(13, _omitFieldNames ? '' : 'type', $pb.PbFieldType.OE, defaultOrMaker: $3789.UserListTypeEnum_UserListType.UNSPECIFIED, valueOf: $3789.UserListTypeEnum_UserListType.valueOf, enumValues: $3789.UserListTypeEnum_UserListType.values)
    ..e<$3790.UserListClosingReasonEnum_UserListClosingReason>(14, _omitFieldNames ? '' : 'closingReason', $pb.PbFieldType.OE, defaultOrMaker: $3790.UserListClosingReasonEnum_UserListClosingReason.UNSPECIFIED, valueOf: $3790.UserListClosingReasonEnum_UserListClosingReason.valueOf, enumValues: $3790.UserListClosingReasonEnum_UserListClosingReason.values)
    ..e<$3791.AccessReasonEnum_AccessReason>(15, _omitFieldNames ? '' : 'accessReason', $pb.PbFieldType.OE, defaultOrMaker: $3791.AccessReasonEnum_AccessReason.UNSPECIFIED, valueOf: $3791.AccessReasonEnum_AccessReason.valueOf, enumValues: $3791.AccessReasonEnum_AccessReason.values)
    ..e<$3792.UserListAccessStatusEnum_UserListAccessStatus>(16, _omitFieldNames ? '' : 'accountUserListStatus', $pb.PbFieldType.OE, defaultOrMaker: $3792.UserListAccessStatusEnum_UserListAccessStatus.UNSPECIFIED, valueOf: $3792.UserListAccessStatusEnum_UserListAccessStatus.valueOf, enumValues: $3792.UserListAccessStatusEnum_UserListAccessStatus.values)
    ..aOM<$3786.CrmBasedUserListInfo>(19, _omitFieldNames ? '' : 'crmBasedUserList', subBuilder: $3786.CrmBasedUserListInfo.create)
    ..aOM<$3786.SimilarUserListInfo>(20, _omitFieldNames ? '' : 'similarUserList', subBuilder: $3786.SimilarUserListInfo.create)
    ..aOM<$3786.RuleBasedUserListInfo>(21, _omitFieldNames ? '' : 'ruleBasedUserList', subBuilder: $3786.RuleBasedUserListInfo.create)
    ..aOM<$3786.LogicalUserListInfo>(22, _omitFieldNames ? '' : 'logicalUserList', subBuilder: $3786.LogicalUserListInfo.create)
    ..aOM<$3786.BasicUserListInfo>(23, _omitFieldNames ? '' : 'basicUserList', subBuilder: $3786.BasicUserListInfo.create)
    ...
    ..aOM<$3786.LookalikeUserListInfo>(36, _omitFieldNames ? '' : 'lookalikeUserList', subBuilder: $3786.LookalikeUserListInfo.create)
  ...
  /// targeted to.
  @$pb.TagNumber(6)
  $3787.UserListMembershipStatusEnum_UserListMembershipStatus get membershipStatus => $_getN(1);
  @$pb.TagNumber(6)
  set membershipStatus($3787.UserListMembershipStatusEnum_UserListMembershipStatus v) { setField(6, v); }
  @$pb.TagNumber(6)
  ...
  @$pb.TagNumber(10)
  $3788.UserListSizeRangeEnum_UserListSizeRange get sizeRangeForDisplay => $_getN(2);
  @$pb.TagNumber(10)
  set sizeRangeForDisplay($3788.UserListSizeRangeEnum_UserListSizeRange v) { setField(10, v); }
  @$pb.TagNumber(10)
  ...
  ///  This field is read-only.
  @$pb.TagNumber(12)
  $3788.UserListSizeRangeEnum_UserListSizeRange get sizeRangeForSearch => $_getN(3);
  @$pb.TagNumber(12)
  set sizeRangeForSearch($3788.UserListSizeRangeEnum_UserListSizeRange v) { setField(12, v); }
  @$pb.TagNumber(12)
  ...
  ///  This field is read-only.
  @$pb.TagNumber(13)
  $3789.UserListTypeEnum_UserListType get type => $_getN(4);
  @$pb.TagNumber(13)
  set type($3789.UserListTypeEnum_UserListType v) { setField(13, v); }
  @$pb.TagNumber(13)
  ...
  @$pb.TagNumber(14)
  $3790.UserListClosingReasonEnum_UserListClosingReason get closingReason => $_getN(5);
  @$pb.TagNumber(14)
  set closingReason($3790.UserListClosingReasonEnum_UserListClosingReason v) { setField(14, v); }
  @$pb.TagNumber(14)
  ...
  ///  This field is read-only.
  @$pb.TagNumber(15)
  $3791.AccessReasonEnum_AccessReason get accessReason => $_getN(6);
  @$pb.TagNumber(15)
  set accessReason($3791.AccessReasonEnum_AccessReason v) { setField(15, v); }
  @$pb.TagNumber(15)
  ...
  @$pb.TagNumber(16)
  $3792.UserListAccessStatusEnum_UserListAccessStatus get accountUserListStatus => $_getN(7);
  @$pb.TagNumber(16)
  set accountUserListStatus($3792.UserListAccessStatusEnum_UserListAccessStatus v) { setField(16, v); }
  @$pb.TagNumber(16)
  ...
  @$pb.TagNumber(19)
  $3786.CrmBasedUserListInfo get crmBasedUserList => $_getN(8);
  @$pb.TagNumber(19)
  set crmBasedUserList($3786.CrmBasedUserListInfo v) { setField(19, v); }
  @$pb.TagNumber(19)
  $core.bool hasCrmBasedUserList() => $_has(8);
  @$pb.TagNumber(19)
  void clearCrmBasedUserList() => clearField(19);
  @$pb.TagNumber(19)
  $3786.CrmBasedUserListInfo ensureCrmBasedUserList() => $_ensure(8);
  ...
  @$pb.TagNumber(20)
  $3786.SimilarUserListInfo get similarUserList => $_getN(9);
  @$pb.TagNumber(20)
  set similarUserList($3786.SimilarUserListInfo v) { setField(20, v); }
  @$pb.TagNumber(20)
  $core.bool hasSimilarUserList() => $_has(9);
  @$pb.TagNumber(20)
  void clearSimilarUserList() => clearField(20);
  @$pb.TagNumber(20)
  $3786.SimilarUserListInfo ensureSimilarUserList() => $_ensure(9);

  /// User list generated by a rule.
  @$pb.TagNumber(21)
  $3786.RuleBasedUserListInfo get ruleBasedUserList => $_getN(10);
  @$pb.TagNumber(21)
  set ruleBasedUserList($3786.RuleBasedUserListInfo v) { setField(21, v); }
  @$pb.TagNumber(21)
  $core.bool hasRuleBasedUserList() => $_has(10);
  @$pb.TagNumber(21)
  void clearRuleBasedUserList() => clearField(21);
  @$pb.TagNumber(21)
  $3786.RuleBasedUserListInfo ensureRuleBasedUserList() => $_ensure(10);

  /// User list that is a custom combination of user lists and user interests.
  @$pb.TagNumber(22)
  $3786.LogicalUserListInfo get logicalUserList => $_getN(11);
  @$pb.TagNumber(22)
  set logicalUserList($3786.LogicalUserListInfo v) { setField(22, v); }
  @$pb.TagNumber(22)
  $core.bool hasLogicalUserList() => $_has(11);
  @$pb.TagNumber(22)
  void clearLogicalUserList() => clearField(22);
  @$pb.TagNumber(22)
  $3786.LogicalUserListInfo ensureLogicalUserList() => $_ensure(11);

  /// User list targeting as a collection of conversion or remarketing actions.
  @$pb.TagNumber(23)
  $3786.BasicUserListInfo get basicUserList => $_getN(12);
  @$pb.TagNumber(23)
  set basicUserList($3786.BasicUserListInfo v) { setField(23, v); }
  @$pb.TagNumber(23)
  $core.bool hasBasicUserList() => $_has(12);
  @$pb.TagNumber(23)
  void clearBasicUserList() => clearField(23);
  @$pb.TagNumber(23)
  $3786.BasicUserListInfo ensureBasicUserList() => $_ensure(12);
  ...
  @$pb.TagNumber(36)
  $3786.LookalikeUserListInfo get lookalikeUserList => $_getN(24);
  @$pb.TagNumber(36)
  set lookalikeUserList($3786.LookalikeUserListInfo v) { setField(36, v); }
  @$pb.TagNumber(36)
  $core.bool hasLookalikeUserList() => $_has(24);
  @$pb.TagNumber(36)
  void clearLookalikeUserList() => clearField(36);
  @$pb.TagNumber(36)
  $3786.LookalikeUserListInfo ensureLookalikeUserList() => $_ensure(24);
}
