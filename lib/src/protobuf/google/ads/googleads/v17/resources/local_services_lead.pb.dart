...
import '../enums/local_services_lead_credit_state.pbenum.dart' as $3751;
import '../enums/local_services_lead_status.pbenum.dart' as $3750;
import '../enums/local_services_lead_type.pbenum.dart' as $3749;
...
class LocalServicesLead extends $pb.GeneratedMessage {
  factory LocalServicesLead({
    ...
    $3749.LocalServicesLeadTypeEnum_LeadType? leadType,
    $3750.LocalServicesLeadStatusEnum_LeadStatus? leadStatus,
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(_omitMessageNames ? '' : 'LocalServicesLead', package: const $pb.PackageName(_omitMessageNames ? '' : 'google.ads.googleads.v17.resources'), createEmptyInstance: create)
    ...
    ..e<$3749.LocalServicesLeadTypeEnum_LeadType>(6, _omitFieldNames ? '' : 'leadType', $pb.PbFieldType.OE, defaultOrMaker: $3749.LocalServicesLeadTypeEnum_LeadType.UNSPECIFIED, valueOf: $3749.LocalServicesLeadTypeEnum_LeadType.valueOf, enumValues: $3749.LocalServicesLeadTypeEnum_LeadType.values)
    ..e<$3750.LocalServicesLeadStatusEnum_LeadStatus>(7, _omitFieldNames ? '' : 'leadStatus', $pb.PbFieldType.OE, defaultOrMaker: $3750.LocalServicesLeadStatusEnum_LeadStatus.UNSPECIFIED, valueOf: $3750.LocalServicesLeadStatusEnum_LeadStatus.valueOf, enumValues: $3750.LocalServicesLeadStatusEnum_LeadStatus.values)
  ...
  @$pb.TagNumber(6)
  $3749.LocalServicesLeadTypeEnum_LeadType get leadType => $_getN(5);
  @$pb.TagNumber(6)
  set leadType($3749.LocalServicesLeadTypeEnum_LeadType v) { setField(6, v); }
  @$pb.TagNumber(6)
  ...
  @$pb.TagNumber(7)
  $3750.LocalServicesLeadStatusEnum_LeadStatus get leadStatus => $_getN(6);
  @$pb.TagNumber(7)
  set leadStatus($3750.LocalServicesLeadStatusEnum_LeadStatus v) { setField(7, v); }
  @$pb.TagNumber(7)
...
class ContactDetails extends $pb.GeneratedMessage {
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(_omitMessageNames ? '' : 'ContactDetails', package: const $pb.PackageName(_omitMessageNames ? '' : 'google.ads.googleads.v17.resources'), createEmptyInstance: create)
...
class Note extends $pb.GeneratedMessage {
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(_omitMessageNames ? '' : 'Note', package: const $pb.PackageName(_omitMessageNames ? '' : 'google.ads.googleads.v17.resources'), createEmptyInstance: create)
...
class CreditDetails extends $pb.GeneratedMessage {
  factory CreditDetails({
    $3751.LocalServicesCreditStateEnum_CreditState? creditState,
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(_omitMessageNames ? '' : 'CreditDetails', package: const $pb.PackageName(_omitMessageNames ? '' : 'google.ads.googleads.v17.resources'), createEmptyInstance: create)
    ..e<$3751.LocalServicesCreditStateEnum_CreditState>(1, _omitFieldNames ? '' : 'creditState', $pb.PbFieldType.OE, defaultOrMaker: $3751.LocalServicesCreditStateEnum_CreditState.UNSPECIFIED, valueOf: $3751.LocalServicesCreditStateEnum_CreditState.valueOf, enumValues: $3751.LocalServicesCreditStateEnum_CreditState.values)
  ...
  @$pb.TagNumber(1)
  $3751.LocalServicesCreditStateEnum_CreditState get creditState => $_getN(0);
  @$pb.TagNumber(1)
  set creditState($3751.LocalServicesCreditStateEnum_CreditState v) { setField(1, v); }
  @$pb.TagNumber(1)
