...
class ChangeStatus extends $pb.GeneratedMessage {
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(_omitMessageNames ? '' : 'ChangeStatus', package: const $pb.PackageName(_omitMessageNames ? '' : 'google.ads.googleads.v17.resources'), createEmptyInstance: create)
    ...
    ..aOS(41, _omitFieldNames ? '' : 'assetGroup')
  ...
  @$pb.TagNumber(41)
  $core.String get assetGroup => $_getSZ(21);
  @$pb.TagNumber(41)
  set assetGroup($core.String v) { $_setString(21, v); }
  @$pb.TagNumber(41)
  $core.bool hasAssetGroup() => $_has(21);
  @$pb.TagNumber(41)
  void clearAssetGroup() => clearField(41);
}
