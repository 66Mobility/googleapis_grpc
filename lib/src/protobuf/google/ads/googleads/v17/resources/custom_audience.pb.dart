...
import '../enums/custom_audience_member_type.pbenum.dart' as $3686;
import '../enums/custom_audience_status.pbenum.dart' as $3684;
import '../enums/custom_audience_type.pbenum.dart' as $3685;
...
class CustomAudience extends $pb.GeneratedMessage {
  factory CustomAudience({
    ...
    $fixnum.Int64? id,
    $3684.CustomAudienceStatusEnum_CustomAudienceStatus? status,
    $core.String? name,
    $3685.CustomAudienceTypeEnum_CustomAudienceType? type,
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(_omitMessageNames ? '' : 'CustomAudience', package: const $pb.PackageName(_omitMessageNames ? '' : 'google.ads.googleads.v17.resources'), createEmptyInstance: create)
    ..aOS(1, _omitFieldNames ? '' : 'resourceName')
    ..aInt64(2, _omitFieldNames ? '' : 'id')
    ..e<$3684.CustomAudienceStatusEnum_CustomAudienceStatus>(3, _omitFieldNames ? '' : 'status', $pb.PbFieldType.OE, defaultOrMaker: $3684.CustomAudienceStatusEnum_CustomAudienceStatus.UNSPECIFIED, valueOf: $3684.CustomAudienceStatusEnum_CustomAudienceStatus.valueOf, enumValues: $3684.CustomAudienceStatusEnum_CustomAudienceStatus.values)
    ..aOS(4, _omitFieldNames ? '' : 'name')
    ..e<$3685.CustomAudienceTypeEnum_CustomAudienceType>(5, _omitFieldNames ? '' : 'type', $pb.PbFieldType.OE, defaultOrMaker: $3685.CustomAudienceTypeEnum_CustomAudienceType.UNSPECIFIED, valueOf: $3685.CustomAudienceTypeEnum_CustomAudienceType.valueOf, enumValues: $3685.CustomAudienceTypeEnum_CustomAudienceType.values)
  ...
  @$pb.TagNumber(3)
  $3684.CustomAudienceStatusEnum_CustomAudienceStatus get status => $_getN(2);
  @$pb.TagNumber(3)
  set status($3684.CustomAudienceStatusEnum_CustomAudienceStatus v) { setField(3, v); }
  @$pb.TagNumber(3)
  ...
  @$pb.TagNumber(5)
  $3685.CustomAudienceTypeEnum_CustomAudienceType get type => $_getN(4);
  @$pb.TagNumber(5)
  set type($3685.CustomAudienceTypeEnum_CustomAudienceType v) { setField(5, v); }
  @$pb.TagNumber(5)
...
class CustomAudienceMember extends $pb.GeneratedMessage {
  factory CustomAudienceMember({
    $3686.CustomAudienceMemberTypeEnum_CustomAudienceMemberType? memberType,
    $core.String? keyword,
    $core.String? url,
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(_omitMessageNames ? '' : 'CustomAudienceMember', package: const $pb.PackageName(_omitMessageNames ? '' : 'google.ads.googleads.v17.resources'), createEmptyInstance: create)
    ..oo(0, [2, 3, 4, 5])
    ..e<$3686.CustomAudienceMemberTypeEnum_CustomAudienceMemberType>(1, _omitFieldNames ? '' : 'memberType', $pb.PbFieldType.OE, defaultOrMaker: $3686.CustomAudienceMemberTypeEnum_CustomAudienceMemberType.UNSPECIFIED, valueOf: $3686.CustomAudienceMemberTypeEnum_CustomAudienceMemberType.valueOf, enumValues: $3686.CustomAudienceMemberTypeEnum_CustomAudienceMemberType.values)
  ...
  @$pb.TagNumber(1)
  $3686.CustomAudienceMemberTypeEnum_CustomAudienceMemberType get memberType => $_getN(0);
  @$pb.TagNumber(1)
  set memberType($3686.CustomAudienceMemberTypeEnum_CustomAudienceMemberType v) { setField(1, v); }
  @$pb.TagNumber(1)
