...
import '../enums/campaign_shared_set_status.pbenum.dart' as $3634;
...
class CampaignSharedSet extends $pb.GeneratedMessage {
  factory CampaignSharedSet({
    ...
    $3634.CampaignSharedSetStatusEnum_CampaignSharedSetStatus? status,
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(_omitMessageNames ? '' : 'CampaignSharedSet', package: const $pb.PackageName(_omitMessageNames ? '' : 'google.ads.googleads.v17.resources'), createEmptyInstance: create)
    ..aOS(1, _omitFieldNames ? '' : 'resourceName')
    ..e<$3634.CampaignSharedSetStatusEnum_CampaignSharedSetStatus>(2, _omitFieldNames ? '' : 'status', $pb.PbFieldType.OE, defaultOrMaker: $3634.CampaignSharedSetStatusEnum_CampaignSharedSetStatus.UNSPECIFIED, valueOf: $3634.CampaignSharedSetStatusEnum_CampaignSharedSetStatus.valueOf, enumValues: $3634.CampaignSharedSetStatusEnum_CampaignSharedSetStatus.values)
  ...
  @$pb.TagNumber(2)
  $3634.CampaignSharedSetStatusEnum_CampaignSharedSetStatus get status => $_getN(1);
  @$pb.TagNumber(2)
  set status($3634.CampaignSharedSetStatusEnum_CampaignSharedSetStatus v) { setField(2, v); }
  @$pb.TagNumber(2)
