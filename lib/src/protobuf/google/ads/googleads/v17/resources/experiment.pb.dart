...
import '../common/metric_goal.pb.dart' as $3703;
import '../enums/async_action_status.pbenum.dart' as $3706;
import '../enums/experiment_status.pbenum.dart' as $3705;
import '../enums/experiment_type.pbenum.dart' as $3704;
...
class Experiment extends $pb.GeneratedMessage {
  factory Experiment({
    ...
    $core.String? suffix,
    $3704.ExperimentTypeEnum_ExperimentType? type,
    $3705.ExperimentStatusEnum_ExperimentStatus? status,
    $core.String? startDate,
    $core.String? endDate,
    $core.Iterable<$3703.MetricGoal>? goals,
    $core.String? longRunningOperation,
    $3706.AsyncActionStatusEnum_AsyncActionStatus? promoteStatus,
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(_omitMessageNames ? '' : 'Experiment', package: const $pb.PackageName(_omitMessageNames ? '' : 'google.ads.googleads.v17.resources'), createEmptyInstance: create)
    ...
    ..e<$3704.ExperimentTypeEnum_ExperimentType>(13, _omitFieldNames ? '' : 'type', $pb.PbFieldType.OE, defaultOrMaker: $3704.ExperimentTypeEnum_ExperimentType.UNSPECIFIED, valueOf: $3704.ExperimentTypeEnum_ExperimentType.valueOf, enumValues: $3704.ExperimentTypeEnum_ExperimentType.values)
    ..e<$3705.ExperimentStatusEnum_ExperimentStatus>(14, _omitFieldNames ? '' : 'status', $pb.PbFieldType.OE, defaultOrMaker: $3705.ExperimentStatusEnum_ExperimentStatus.UNSPECIFIED, valueOf: $3705.ExperimentStatusEnum_ExperimentStatus.valueOf, enumValues: $3705.ExperimentStatusEnum_ExperimentStatus.values)
    ..aOS(15, _omitFieldNames ? '' : 'startDate')
    ..aOS(16, _omitFieldNames ? '' : 'endDate')
    ..pc<$3703.MetricGoal>(17, _omitFieldNames ? '' : 'goals', $pb.PbFieldType.PM, subBuilder: $3703.MetricGoal.create)
    ..aOS(18, _omitFieldNames ? '' : 'longRunningOperation')
    ..e<$3706.AsyncActionStatusEnum_AsyncActionStatus>(19, _omitFieldNames ? '' : 'promoteStatus', $pb.PbFieldType.OE, defaultOrMaker: $3706.AsyncActionStatusEnum_AsyncActionStatus.UNSPECIFIED, valueOf: $3706.AsyncActionStatusEnum_AsyncActionStatus.valueOf, enumValues: $3706.AsyncActionStatusEnum_AsyncActionStatus.values)
  ...
  @$pb.TagNumber(13)
  $3704.ExperimentTypeEnum_ExperimentType get type => $_getN(5);
  @$pb.TagNumber(13)
  set type($3704.ExperimentTypeEnum_ExperimentType v) { setField(13, v); }
  @$pb.TagNumber(13)
  ...
  @$pb.TagNumber(14)
  $3705.ExperimentStatusEnum_ExperimentStatus get status => $_getN(6);
  @$pb.TagNumber(14)
  set status($3705.ExperimentStatusEnum_ExperimentStatus v) { setField(14, v); }
  @$pb.TagNumber(14)
  ...
  @$pb.TagNumber(17)
  $core.List<$3703.MetricGoal> get goals => $_getList(9);
  ...
  @$pb.TagNumber(19)
  $3706.AsyncActionStatusEnum_AsyncActionStatus get promoteStatus => $_getN(11);
  @$pb.TagNumber(19)
  set promoteStatus($3706.AsyncActionStatusEnum_AsyncActionStatus v) { setField(19, v); }
  @$pb.TagNumber(19)
