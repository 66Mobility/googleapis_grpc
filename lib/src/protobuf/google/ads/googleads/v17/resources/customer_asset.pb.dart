...
class CustomerAsset extends $pb.GeneratedMessage {
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(_omitMessageNames ? '' : 'CustomerAsset', package: const $pb.PackageName(_omitMessageNames ? '' : 'google.ads.googleads.v17.resources'), createEmptyInstance: create)
    ...
    ..e<$3551.AssetLinkStatusEnum_AssetLinkStatus>(4, _omitFieldNames ? '' : 'status', $pb.PbFieldType.OE, defaultOrMaker: $3551.AssetLinkStatusEnum_AssetLinkStatus.UNSPECIFIED, valueOf: $3551.AssetLinkStatusEnum_AssetLinkStatus.valueOf, enumValues: $3551.AssetLinkStatusEnum_AssetLinkStatus.values)
    ..e<$3550.AssetSourceEnum_AssetSource>(5, _omitFieldNames ? '' : 'source', $pb.PbFieldType.OE, defaultOrMaker: $3550.AssetSourceEnum_AssetSource.UNSPECIFIED, valueOf: $3550.AssetSourceEnum_AssetSource.valueOf, enumValues: $3550.AssetSourceEnum_AssetSource.values)
    ..e<$3244.AssetLinkPrimaryStatusEnum_AssetLinkPrimaryStatus>(6, _omitFieldNames ? '' : 'primaryStatus', $pb.PbFieldType.OE, defaultOrMaker: $3244.AssetLinkPrimaryStatusEnum_AssetLinkPrimaryStatus.UNSPECIFIED, valueOf: $3244.AssetLinkPrimaryStatusEnum_AssetLinkPrimaryStatus.valueOf, enumValues: $3244.AssetLinkPrimaryStatusEnum_AssetLinkPrimaryStatus.values)
    ..pc<$3246.AssetLinkPrimaryStatusDetails>(7, _omitFieldNames ? '' : 'primaryStatusDetails', $pb.PbFieldType.PM, subBuilder: $3246.AssetLinkPrimaryStatusDetails.create)
    ..pc<$3243.AssetLinkPrimaryStatusReasonEnum_AssetLinkPrimaryStatusReason>(8, _omitFieldNames ? '' : 'primaryStatusReasons', $pb.PbFieldType.KE, valueOf: $3243.AssetLinkPrimaryStatusReasonEnum_AssetLinkPrimaryStatusReason.valueOf, enumValues: $3243.AssetLinkPrimaryStatusReasonEnum_AssetLinkPrimaryStatusReason.values, defaultEnumValue: $3243.AssetLinkPrimaryStatusReasonEnum_AssetLinkPrimaryStatusReason.UNSPECIFIED)
  ...
  @$pb.TagNumber(3)
  $3540.AssetFieldTypeEnum_AssetFieldType get fieldType => $_getN(2);
  @$pb.TagNumber(3)
  ...
  @$pb.TagNumber(4)
  $3551.AssetLinkStatusEnum_AssetLinkStatus get status => $_getN(3);
  @$pb.TagNumber(4)
  set status($3551.AssetLinkStatusEnum_AssetLinkStatus v) { setField(4, v); }
  @$pb.TagNumber(4)
  ...
  @$pb.TagNumber(5)
  $3550.AssetSourceEnum_AssetSource get source => $_getN(4);
  @$pb.TagNumber(5)
  set source($3550.AssetSourceEnum_AssetSource v) { setField(5, v); }
  @$pb.TagNumber(5)
  ...
  @$pb.TagNumber(6)
  $3244.AssetLinkPrimaryStatusEnum_AssetLinkPrimaryStatus get primaryStatus => $_getN(5);
  @$pb.TagNumber(6)
  set primaryStatus($3244.AssetLinkPrimaryStatusEnum_AssetLinkPrimaryStatus v) { setField(6, v); }
  @$pb.TagNumber(6)
  ...
  /// reasons.
  @$pb.TagNumber(7)
  $core.List<$3246.AssetLinkPrimaryStatusDetails> get primaryStatusDetails => $_getList(6);

  /// Output only. Provides a list of reasons for why an asset is not serving or
  /// not serving at full capacity.
  @$pb.TagNumber(8)
  $core.List<$3243.AssetLinkPrimaryStatusReasonEnum_AssetLinkPrimaryStatusReason> get primaryStatusReasons => $_getList(7);
}
