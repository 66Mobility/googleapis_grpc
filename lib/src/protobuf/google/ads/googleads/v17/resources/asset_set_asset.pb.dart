...
import '../enums/asset_set_asset_status.pbenum.dart' as $3587;
...
class AssetSetAsset extends $pb.GeneratedMessage {
  factory AssetSetAsset({
    ...
    $core.String? asset,
    $3587.AssetSetAssetStatusEnum_AssetSetAssetStatus? status,
  }) {
    final $result = create();
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(_omitMessageNames ? '' : 'AssetSetAsset', package: const $pb.PackageName(_omitMessageNames ? '' : 'google.ads.googleads.v17.resources'), createEmptyInstance: create)
    ..aOS(1, _omitFieldNames ? '' : 'resourceName')
    ..aOS(2, _omitFieldNames ? '' : 'assetSet')
    ..aOS(3, _omitFieldNames ? '' : 'asset')
    ..e<$3587.AssetSetAssetStatusEnum_AssetSetAssetStatus>(4, _omitFieldNames ? '' : 'status', $pb.PbFieldType.OE, defaultOrMaker: $3587.AssetSetAssetStatusEnum_AssetSetAssetStatus.UNSPECIFIED, valueOf: $3587.AssetSetAssetStatusEnum_AssetSetAssetStatus.valueOf, enumValues: $3587.AssetSetAssetStatusEnum_AssetSetAssetStatus.values)
  ...
  @$pb.TagNumber(4)
  $3587.AssetSetAssetStatusEnum_AssetSetAssetStatus get status => $_getN(3);
  @$pb.TagNumber(4)
  set status($3587.AssetSetAssetStatusEnum_AssetSetAssetStatus v) { setField(4, v); }
  @$pb.TagNumber(4)
