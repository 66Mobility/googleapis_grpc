...
import '../enums/media_type.pbenum.dart' as $3760;
...
class MediaFile extends $pb.GeneratedMessage {
  factory MediaFile({
    ...
    $3760.MediaTypeEnum_MediaType? type,
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(_omitMessageNames ? '' : 'MediaFile', package: const $pb.PackageName(_omitMessageNames ? '' : 'google.ads.googleads.v17.resources'), createEmptyInstance: create)
    ..oo(0, [3, 4, 10, 11])
    ...
    ..e<$3760.MediaTypeEnum_MediaType>(5, _omitFieldNames ? '' : 'type', $pb.PbFieldType.OE, defaultOrMaker: $3760.MediaTypeEnum_MediaType.UNSPECIFIED, valueOf: $3760.MediaTypeEnum_MediaType.valueOf, enumValues: $3760.MediaTypeEnum_MediaType.values)
    ..e<$3250.MimeTypeEnum_MimeType>(6, _omitFieldNames ? '' : 'mimeType', $pb.PbFieldType.OE, defaultOrMaker: $3250.MimeTypeEnum_MimeType.UNSPECIFIED, valueOf: $3250.MimeTypeEnum_MimeType.valueOf, enumValues: $3250.MimeTypeEnum_MimeType.values)
  ...
  @$pb.TagNumber(5)
  $3760.MediaTypeEnum_MediaType get type => $_getN(3);
  @$pb.TagNumber(5)
  set type($3760.MediaTypeEnum_MediaType v) { setField(5, v); }
  @$pb.TagNumber(5)
  ...
  @$pb.TagNumber(6)
  $3250.MimeTypeEnum_MimeType get mimeType => $_getN(4);
  @$pb.TagNumber(6)
  set mimeType($3250.MimeTypeEnum_MimeType v) { setField(6, v); }
  @$pb.TagNumber(6)
...
class MediaImage extends $pb.GeneratedMessage {
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(_omitMessageNames ? '' : 'MediaImage', package: const $pb.PackageName(_omitMessageNames ? '' : 'google.ads.googleads.v17.resources'), createEmptyInstance: create)
...
class MediaBundle extends $pb.GeneratedMessage {
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(_omitMessageNames ? '' : 'MediaBundle', package: const $pb.PackageName(_omitMessageNames ? '' : 'google.ads.googleads.v17.resources'), createEmptyInstance: create)
...
class MediaAudio extends $pb.GeneratedMessage {
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(_omitMessageNames ? '' : 'MediaAudio', package: const $pb.PackageName(_omitMessageNames ? '' : 'google.ads.googleads.v17.resources'), createEmptyInstance: create)
...
class MediaVideo extends $pb.GeneratedMessage {
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(_omitMessageNames ? '' : 'MediaVideo', package: const $pb.PackageName(_omitMessageNames ? '' : 'google.ads.googleads.v17.resources'), createEmptyInstance: create)
