...
const LeadFormSubmissionData$json = {
  ...
  '2': [
    ...
    {'1': 'lead_form_submission_fields', '3': 5, '4': 3, '5': 11, '6': '.google.ads.googleads.v17.resources.LeadFormSubmissionField', '8': {}, '10': 'leadFormSubmissionFields'},
    {'1': 'custom_lead_form_submission_fields', '3': 10, '4': 3, '5': 11, '6': '.google.ads.googleads.v17.resources.CustomLeadFormSubmissionField', '8': {}, '10': 'customLeadFormSubmissionFields'},
...
final $typed_data.Uint8List leadFormSubmissionDataDescriptor = $convert.base64Decode(
    ...
    'djE3LnJlc291cmNlcy5MZWFkRm9ybVN1Ym1pc3Npb25GaWVsZEID4EEDUhhsZWFkRm9ybVN1Ym'
    '1pc3Npb25GaWVsZHMSkgEKImN1c3RvbV9sZWFkX2Zvcm1fc3VibWlzc2lvbl9maWVsZHMYCiAD'
    'KAsyQS5nb29nbGUuYWRzLmdvb2dsZWFkcy52MTcucmVzb3VyY2VzLkN1c3RvbUxlYWRGb3JtU3'
...
const LeadFormSubmissionField$json = {
  ...
  '2': [
    {'1': 'field_type', '3': 1, '4': 1, '5': 14, '6': '.google.ads.googleads.v17.enums.LeadFormFieldUserInputTypeEnum.LeadFormFieldUserInputType', '8': {}, '10': 'fieldType'},
...
final $typed_data.Uint8List leadFormSubmissionFieldDescriptor = $convert.base64Decode(
    ...
    'Fkcy5nb29nbGVhZHMudjE3LmVudW1zLkxlYWRGb3JtRmllbGRVc2VySW5wdXRUeXBlRW51bS5M'
