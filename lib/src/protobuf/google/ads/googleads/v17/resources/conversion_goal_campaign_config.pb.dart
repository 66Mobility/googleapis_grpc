...
import '../enums/goal_config_level.pbenum.dart' as $3677;
...
class ConversionGoalCampaignConfig extends $pb.GeneratedMessage {
  factory ConversionGoalCampaignConfig({
    ...
    $3677.GoalConfigLevelEnum_GoalConfigLevel? goalConfigLevel,
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(_omitMessageNames ? '' : 'ConversionGoalCampaignConfig', package: const $pb.PackageName(_omitMessageNames ? '' : 'google.ads.googleads.v17.resources'), createEmptyInstance: create)
    ...
    ..e<$3677.GoalConfigLevelEnum_GoalConfigLevel>(3, _omitFieldNames ? '' : 'goalConfigLevel', $pb.PbFieldType.OE, defaultOrMaker: $3677.GoalConfigLevelEnum_GoalConfigLevel.UNSPECIFIED, valueOf: $3677.GoalConfigLevelEnum_GoalConfigLevel.valueOf, enumValues: $3677.GoalConfigLevelEnum_GoalConfigLevel.values)
  ...
  @$pb.TagNumber(3)
  $3677.GoalConfigLevelEnum_GoalConfigLevel get goalConfigLevel => $_getN(2);
  @$pb.TagNumber(3)
  set goalConfigLevel($3677.GoalConfigLevelEnum_GoalConfigLevel v) { setField(3, v); }
  @$pb.TagNumber(3)
