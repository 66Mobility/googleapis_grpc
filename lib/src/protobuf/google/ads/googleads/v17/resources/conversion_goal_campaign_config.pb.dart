...
import '../enums/goal_config_level.pbenum.dart' as $3676;
...
class ConversionGoalCampaignConfig extends $pb.GeneratedMessage {
  factory ConversionGoalCampaignConfig({
    ...
    $3676.GoalConfigLevelEnum_GoalConfigLevel? goalConfigLevel,
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(_omitMessageNames ? '' : 'ConversionGoalCampaignConfig', package: const $pb.PackageName(_omitMessageNames ? '' : 'google.ads.googleads.v17.resources'), createEmptyInstance: create)
    ..aOS(1, _omitFieldNames ? '' : 'resourceName')
    ..aOS(2, _omitFieldNames ? '' : 'campaign')
    ..e<$3676.GoalConfigLevelEnum_GoalConfigLevel>(3, _omitFieldNames ? '' : 'goalConfigLevel', $pb.PbFieldType.OE, defaultOrMaker: $3676.GoalConfigLevelEnum_GoalConfigLevel.UNSPECIFIED, valueOf: $3676.GoalConfigLevelEnum_GoalConfigLevel.valueOf, enumValues: $3676.GoalConfigLevelEnum_GoalConfigLevel.values)
  ...
  @$pb.TagNumber(3)
  $3676.GoalConfigLevelEnum_GoalConfigLevel get goalConfigLevel => $_getN(2);
  @$pb.TagNumber(3)
  set goalConfigLevel($3676.GoalConfigLevelEnum_GoalConfigLevel v) { setField(3, v); }
  @$pb.TagNumber(3)
