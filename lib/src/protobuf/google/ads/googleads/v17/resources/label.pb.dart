...
import '../common/text_label.pb.dart' as $3744;
import '../enums/label_status.pbenum.dart' as $3745;

/// A label.
class Label extends $pb.GeneratedMessage {
  factory Label({
    $core.String? resourceName,
    $3745.LabelStatusEnum_LabelStatus? status,
    $3744.TextLabel? textLabel,
    $fixnum.Int64? id,
    $core.String? name,
  }) {
    final $result = create();
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(_omitMessageNames ? '' : 'Label', package: const $pb.PackageName(_omitMessageNames ? '' : 'google.ads.googleads.v17.resources'), createEmptyInstance: create)
    ..aOS(1, _omitFieldNames ? '' : 'resourceName')
    ..e<$3745.LabelStatusEnum_LabelStatus>(4, _omitFieldNames ? '' : 'status', $pb.PbFieldType.OE, defaultOrMaker: $3745.LabelStatusEnum_LabelStatus.UNSPECIFIED, valueOf: $3745.LabelStatusEnum_LabelStatus.valueOf, enumValues: $3745.LabelStatusEnum_LabelStatus.values)
    ..aOM<$3744.TextLabel>(5, _omitFieldNames ? '' : 'textLabel', subBuilder: $3744.TextLabel.create)
  ...
  @$pb.TagNumber(4)
  $3745.LabelStatusEnum_LabelStatus get status => $_getN(1);
  @$pb.TagNumber(4)
  set status($3745.LabelStatusEnum_LabelStatus v) { setField(4, v); }
  @$pb.TagNumber(4)
  ...
  @$pb.TagNumber(5)
  $3744.TextLabel get textLabel => $_getN(2);
  @$pb.TagNumber(5)
  set textLabel($3744.TextLabel v) { setField(5, v); }
  @$pb.TagNumber(5)
  $core.bool hasTextLabel() => $_has(2);
  @$pb.TagNumber(5)
  void clearTextLabel() => clearField(5);
  @$pb.TagNumber(5)
  $3744.TextLabel ensureTextLabel() => $_ensure(2);
