...
class CustomerClient extends $pb.GeneratedMessage {
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(_omitMessageNames ? '' : 'CustomerClient', package: const $pb.PackageName(_omitMessageNames ? '' : 'google.ads.googleads.v17.resources'), createEmptyInstance: create)
    ...
    ..e<$3692.CustomerStatusEnum_CustomerStatus>(22, _omitFieldNames ? '' : 'status', $pb.PbFieldType.OE, defaultOrMaker: $3692.CustomerStatusEnum_CustomerStatus.UNSPECIFIED, valueOf: $3692.CustomerStatusEnum_CustomerStatus.valueOf, enumValues: $3692.CustomerStatusEnum_CustomerStatus.values)
  ...
  @$pb.TagNumber(22)
  $3692.CustomerStatusEnum_CustomerStatus get status => $_getN(11);
  @$pb.TagNumber(22)
  set status($3692.CustomerStatusEnum_CustomerStatus v) { setField(22, v); }
  @$pb.TagNumber(22)
