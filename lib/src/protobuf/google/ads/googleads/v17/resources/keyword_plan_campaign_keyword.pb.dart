...
class KeywordPlanCampaignKeyword extends $pb.GeneratedMessage {
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(_omitMessageNames ? '' : 'KeywordPlanCampaignKeyword', package: const $pb.PackageName(_omitMessageNames ? '' : 'google.ads.googleads.v17.resources'), createEmptyInstance: create)
    ..aOS(1, _omitFieldNames ? '' : 'resourceName')
    ..e<$3260.KeywordMatchTypeEnum_KeywordMatchType>(5, _omitFieldNames ? '' : 'matchType', $pb.PbFieldType.OE, defaultOrMaker: $3260.KeywordMatchTypeEnum_KeywordMatchType.UNSPECIFIED, valueOf: $3260.KeywordMatchTypeEnum_KeywordMatchType.valueOf, enumValues: $3260.KeywordMatchTypeEnum_KeywordMatchType.values)
  ...
  @$pb.TagNumber(5)
  $3260.KeywordMatchTypeEnum_KeywordMatchType get matchType => $_getN(1);
  @$pb.TagNumber(5)
  set matchType($3260.KeywordMatchTypeEnum_KeywordMatchType v) { setField(5, v); }
  @$pb.TagNumber(5)
