...
import '../enums/placement_type.pbenum.dart' as $3699;

/// A view with metrics aggregated by ad group and URL or YouTube video.
class DetailPlacementView extends $pb.GeneratedMessage {
  factory DetailPlacementView({
    $core.String? resourceName,
    $3699.PlacementTypeEnum_PlacementType? placementType,
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(_omitMessageNames ? '' : 'DetailPlacementView', package: const $pb.PackageName(_omitMessageNames ? '' : 'google.ads.googleads.v17.resources'), createEmptyInstance: create)
    ..aOS(1, _omitFieldNames ? '' : 'resourceName')
    ..e<$3699.PlacementTypeEnum_PlacementType>(6, _omitFieldNames ? '' : 'placementType', $pb.PbFieldType.OE, defaultOrMaker: $3699.PlacementTypeEnum_PlacementType.UNSPECIFIED, valueOf: $3699.PlacementTypeEnum_PlacementType.valueOf, enumValues: $3699.PlacementTypeEnum_PlacementType.values)
  ...
  @$pb.TagNumber(6)
  $3699.PlacementTypeEnum_PlacementType get placementType => $_getN(1);
  @$pb.TagNumber(6)
  set placementType($3699.PlacementTypeEnum_PlacementType v) { setField(6, v); }
  @$pb.TagNumber(6)
