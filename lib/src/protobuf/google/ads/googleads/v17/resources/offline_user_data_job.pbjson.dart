...
const OfflineUserDataJob$json = {
  ...
  '2': [
    ...
    {'1': 'type', '3': 4, '4': 1, '5': 14, '6': '.google.ads.googleads.v17.enums.OfflineUserDataJobTypeEnum.OfflineUserDataJobType', '8': {}, '10': 'type'},
    {'1': 'status', '3': 5, '4': 1, '5': 14, '6': '.google.ads.googleads.v17.enums.OfflineUserDataJobStatusEnum.OfflineUserDataJobStatus', '8': {}, '10': 'status'},
    {'1': 'failure_reason', '3': 6, '4': 1, '5': 14, '6': '.google.ads.googleads.v17.enums.OfflineUserDataJobFailureReasonEnum.OfflineUserDataJobFailureReason', '8': {}, '10': 'failureReason'},
    {'1': 'operation_metadata', '3': 11, '4': 1, '5': 11, '6': '.google.ads.googleads.v17.resources.OfflineUserDataJobMetadata', '8': {}, '10': 'operationMetadata'},
    {'1': 'customer_match_user_list_metadata', '3': 7, '4': 1, '5': 11, '6': '.google.ads.googleads.v17.common.CustomerMatchUserListMetadata', '8': {}, '9': 0, '10': 'customerMatchUserListMetadata'},
    {'1': 'store_sales_metadata', '3': 8, '4': 1, '5': 11, '6': '.google.ads.googleads.v17.common.StoreSalesMetadata', '8': {}, '9': 0, '10': 'storeSalesMetadata'},
  ],
  '7': {},
  '8': [
    {'1': 'metadata'},
...
final $typed_data.Uint8List offlineUserDataJobDescriptor = $convert.base64Decode(
    ...
    'V4dGVybmFsSWSIAQESagoEdHlwZRgEIAEoDjJRLmdvb2dsZS5hZHMuZ29vZ2xlYWRzLnYxNy5l'
    'bnVtcy5PZmZsaW5lVXNlckRhdGFKb2JUeXBlRW51bS5PZmZsaW5lVXNlckRhdGFKb2JUeXBlQg'
    'PgQQVSBHR5cGUScgoGc3RhdHVzGAUgASgOMlUuZ29vZ2xlLmFkcy5nb29nbGVhZHMudjE3LmVu'
    ...
    'b2dsZWFkcy52MTcuZW51bXMuT2ZmbGluZVVzZXJEYXRhSm9iRmFpbHVyZVJlYXNvbkVudW0uT2'
    'ZmbGluZVVzZXJEYXRhSm9iRmFpbHVyZVJlYXNvbkID4EEDUg1mYWlsdXJlUmVhc29uEnIKEm9w'
    'ZXJhdGlvbl9tZXRhZGF0YRgLIAEoCzI+Lmdvb2dsZS5hZHMuZ29vZ2xlYWRzLnYxNy5yZXNvdX'
    ...
    'MuZ29vZ2xlYWRzLnYxNy5jb21tb24uQ3VzdG9tZXJNYXRjaFVzZXJMaXN0TWV0YWRhdGFCA+BB'
    'BUgAUh1jdXN0b21lck1hdGNoVXNlckxpc3RNZXRhZGF0YRJsChRzdG9yZV9zYWxlc19tZXRhZG'
    'F0YRgIIAEoCzIzLmdvb2dsZS5hZHMuZ29vZ2xlYWRzLnYxNy5jb21tb24uU3RvcmVTYWxlc01l'
...
const OfflineUserDataJobMetadata$json = {
  ...
  '2': [
    {'1': 'match_rate_range', '3': 1, '4': 1, '5': 14, '6': '.google.ads.googleads.v17.enums.OfflineUserDataJobMatchRateRangeEnum.OfflineUserDataJobMatchRateRange', '8': {}, '10': 'matchRateRange'},
  ],
};
...
final $typed_data.Uint8List offlineUserDataJobMetadataDescriptor = $convert.base64Decode(
    ...
    'JlLmdvb2dsZS5hZHMuZ29vZ2xlYWRzLnYxNy5lbnVtcy5PZmZsaW5lVXNlckRhdGFKb2JNYXRj'
