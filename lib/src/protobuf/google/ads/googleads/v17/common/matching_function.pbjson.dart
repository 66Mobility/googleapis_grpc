...
const MatchingFunction$json = {
  ...
  '2': [
    ...
    {'1': 'operator', '3': 4, '4': 1, '5': 14, '6': '.google.ads.googleads.v17.enums.MatchingFunctionOperatorEnum.MatchingFunctionOperator', '10': 'operator'},
    {'1': 'left_operands', '3': 2, '4': 3, '5': 11, '6': '.google.ads.googleads.v17.common.Operand', '10': 'leftOperands'},
    {'1': 'right_operands', '3': 3, '4': 3, '5': 11, '6': '.google.ads.googleads.v17.common.Operand', '10': 'rightOperands'},
  ],
  '8': [
    {'1': '_function_string'},
  ],
...
final $typed_data.Uint8List matchingFunctionDescriptor = $convert.base64Decode(
    ...
    'N0cmluZ4gBARJxCghvcGVyYXRvchgEIAEoDjJVLmdvb2dsZS5hZHMuZ29vZ2xlYWRzLnYxNy5l'
    ...
    'YWRzLnYxNy5jb21tb24uT3BlcmFuZFIMbGVmdE9wZXJhbmRzEk8KDnJpZ2h0X29wZXJhbmRzGA'
    'MgAygLMiguZ29vZ2xlLmFkcy5nb29nbGVhZHMudjE3LmNvbW1vbi5PcGVyYW5kUg1yaWdodE9w'
...
const Operand$json = {
  '1': 'Operand',
  '2': [
    {'1': 'constant_operand', '3': 1, '4': 1, '5': 11, '6': '.google.ads.googleads.v17.common.Operand.ConstantOperand', '9': 0, '10': 'constantOperand'},
    {'1': 'feed_attribute_operand', '3': 2, '4': 1, '5': 11, '6': '.google.ads.googleads.v17.common.Operand.FeedAttributeOperand', '9': 0, '10': 'feedAttributeOperand'},
    {'1': 'function_operand', '3': 3, '4': 1, '5': 11, '6': '.google.ads.googleads.v17.common.Operand.FunctionOperand', '9': 0, '10': 'functionOperand'},
    {'1': 'request_context_operand', '3': 4, '4': 1, '5': 11, '6': '.google.ads.googleads.v17.common.Operand.RequestContextOperand', '9': 0, '10': 'requestContextOperand'},
  ],
...
const Operand_FunctionOperand$json = {
  '1': 'FunctionOperand',
  '2': [
    {'1': 'matching_function', '3': 1, '4': 1, '5': 11, '6': '.google.ads.googleads.v17.common.MatchingFunction', '10': 'matchingFunction'},
  ],
};
...
const Operand_RequestContextOperand$json = {
  ...
  '2': [
    {'1': 'context_type', '3': 1, '4': 1, '5': 14, '6': '.google.ads.googleads.v17.enums.MatchingFunctionContextTypeEnum.MatchingFunctionContextType', '10': 'contextType'},
  ],
};
...
final $typed_data.Uint8List operandDescriptor = $convert.base64Decode(
    ...
    'Fkcy52MTcuY29tbW9uLk9wZXJhbmQuQ29uc3RhbnRPcGVyYW5kSABSD2NvbnN0YW50T3BlcmFu'
    'ZBJ1ChZmZWVkX2F0dHJpYnV0ZV9vcGVyYW5kGAIgASgLMj0uZ29vZ2xlLmFkcy5nb29nbGVhZH'
    'MudjE3LmNvbW1vbi5PcGVyYW5kLkZlZWRBdHRyaWJ1dGVPcGVyYW5kSABSFGZlZWRBdHRyaWJ1'
    'dGVPcGVyYW5kEmUKEGZ1bmN0aW9uX29wZXJhbmQYAyABKAsyOC5nb29nbGUuYWRzLmdvb2dsZW'
    'Fkcy52MTcuY29tbW9uLk9wZXJhbmQuRnVuY3Rpb25PcGVyYW5kSABSD2Z1bmN0aW9uT3BlcmFu'
    'ZBJ4ChdyZXF1ZXN0X2NvbnRleHRfb3BlcmFuZBgEIAEoCzI+Lmdvb2dsZS5hZHMuZ29vZ2xlYW'
    'RzLnYxNy5jb21tb24uT3BlcmFuZC5SZXF1ZXN0Q29udGV4dE9wZXJhbmRIAFIVcmVxdWVzdENv'
    ...
    'IxLmdvb2dsZS5hZHMuZ29vZ2xlYWRzLnYxNy5jb21tb24uTWF0Y2hpbmdGdW5jdGlvblIQbWF0'
    'Y2hpbmdGdW5jdGlvbhqXAQoVUmVxdWVzdENvbnRleHRPcGVyYW5kEn4KDGNvbnRleHRfdHlwZR'
    'gBIAEoDjJbLmdvb2dsZS5hZHMuZ29vZ2xlYWRzLnYxNy5lbnVtcy5NYXRjaGluZ0Z1bmN0aW9u'
