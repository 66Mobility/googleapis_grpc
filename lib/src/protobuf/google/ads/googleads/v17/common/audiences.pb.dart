...
class GenderDimension extends $pb.GeneratedMessage {
  factory GenderDimension({
    $core.Iterable<$3274.GenderTypeEnum_GenderType>? genders,
    $core.bool? includeUndetermined,
  }) {
    final $result = create();
    if (genders != null) {
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(_omitMessageNames ? '' : 'GenderDimension', package: const $pb.PackageName(_omitMessageNames ? '' : 'google.ads.googleads.v17.common'), createEmptyInstance: create)
    ..pc<$3274.GenderTypeEnum_GenderType>(1, _omitFieldNames ? '' : 'genders', $pb.PbFieldType.KE, valueOf: $3274.GenderTypeEnum_GenderType.valueOf, enumValues: $3274.GenderTypeEnum_GenderType.values, defaultEnumValue: $3274.GenderTypeEnum_GenderType.UNSPECIFIED)
    ..aOB(2, _omitFieldNames ? '' : 'includeUndetermined')
    ..hasRequiredFields = false
  ;
  ...
  @$pb.TagNumber(1)
  $core.List<$3274.GenderTypeEnum_GenderType> get genders => $_getList(0);
...
class HouseholdIncomeDimension extends $pb.GeneratedMessage {
  factory HouseholdIncomeDimension({
    $core.Iterable<$3275.IncomeRangeTypeEnum_IncomeRangeType>? incomeRanges,
    $core.bool? includeUndetermined,
  }) {
    final $result = create();
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(_omitMessageNames ? '' : 'HouseholdIncomeDimension', package: const $pb.PackageName(_omitMessageNames ? '' : 'google.ads.googleads.v17.common'), createEmptyInstance: create)
    ..pc<$3275.IncomeRangeTypeEnum_IncomeRangeType>(1, _omitFieldNames ? '' : 'incomeRanges', $pb.PbFieldType.KE, valueOf: $3275.IncomeRangeTypeEnum_IncomeRangeType.valueOf, enumValues: $3275.IncomeRangeTypeEnum_IncomeRangeType.values, defaultEnumValue: $3275.IncomeRangeTypeEnum_IncomeRangeType.UNSPECIFIED)
    ..aOB(2, _omitFieldNames ? '' : 'includeUndetermined')
    ..hasRequiredFields = false
  ;
  ...
  @$pb.TagNumber(1)
  $core.List<$3275.IncomeRangeTypeEnum_IncomeRangeType> get incomeRanges => $_getList(0);
...
class ParentalStatusDimension extends $pb.GeneratedMessage {
  factory ParentalStatusDimension({
    $core.Iterable<$3276.ParentalStatusTypeEnum_ParentalStatusType>? parentalStatuses,
    $core.bool? includeUndetermined,
  }) {
    final $result = create();
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(_omitMessageNames ? '' : 'ParentalStatusDimension', package: const $pb.PackageName(_omitMessageNames ? '' : 'google.ads.googleads.v17.common'), createEmptyInstance: create)
    ..pc<$3276.ParentalStatusTypeEnum_ParentalStatusType>(1, _omitFieldNames ? '' : 'parentalStatuses', $pb.PbFieldType.KE, valueOf: $3276.ParentalStatusTypeEnum_ParentalStatusType.valueOf, enumValues: $3276.ParentalStatusTypeEnum_ParentalStatusType.values, defaultEnumValue: $3276.ParentalStatusTypeEnum_ParentalStatusType.UNSPECIFIED)
    ..aOB(2, _omitFieldNames ? '' : 'includeUndetermined')
    ..hasRequiredFields = false
  ;
  ...
  @$pb.TagNumber(1)
  $core.List<$3276.ParentalStatusTypeEnum_ParentalStatusType> get parentalStatuses => $_getList(0);
