...
import '../enums/policy_topic_entry_type.pbenum.dart' as $3237;
import '../enums/policy_topic_evidence_destination_mismatch_url_type.pbenum.dart' as $3238;
import '../enums/policy_topic_evidence_destination_not_working_device.pbenum.dart' as $3240;
import '../enums/policy_topic_evidence_destination_not_working_dns_error_type.pbenum.dart' as $3239;
...
class PolicyTopicEntry extends $pb.GeneratedMessage {
  factory PolicyTopicEntry({
    $3237.PolicyTopicEntryTypeEnum_PolicyTopicEntryType? type,
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(_omitMessageNames ? '' : 'PolicyTopicEntry', package: const $pb.PackageName(_omitMessageNames ? '' : 'google.ads.googleads.v17.common'), createEmptyInstance: create)
    ..e<$3237.PolicyTopicEntryTypeEnum_PolicyTopicEntryType>(2, _omitFieldNames ? '' : 'type', $pb.PbFieldType.OE, defaultOrMaker: $3237.PolicyTopicEntryTypeEnum_PolicyTopicEntryType.UNSPECIFIED, valueOf: $3237.PolicyTopicEntryTypeEnum_PolicyTopicEntryType.valueOf, enumValues: $3237.PolicyTopicEntryTypeEnum_PolicyTopicEntryType.values)
  ...
  @$pb.TagNumber(2)
  $3237.PolicyTopicEntryTypeEnum_PolicyTopicEntryType get type => $_getN(0);
  @$pb.TagNumber(2)
  set type($3237.PolicyTopicEntryTypeEnum_PolicyTopicEntryType v) { setField(2, v); }
  @$pb.TagNumber(2)
...
class PolicyTopicEvidence_DestinationMismatch extends $pb.GeneratedMessage {
  factory PolicyTopicEvidence_DestinationMismatch({
    $core.Iterable<$3238.PolicyTopicEvidenceDestinationMismatchUrlTypeEnum_PolicyTopicEvidenceDestinationMismatchUrlType>? urlTypes,
  }) {
    final $result = create();
    if (urlTypes != null) {
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(_omitMessageNames ? '' : 'PolicyTopicEvidence.DestinationMismatch', package: const $pb.PackageName(_omitMessageNames ? '' : 'google.ads.googleads.v17.common'), createEmptyInstance: create)
    ..pc<$3238.PolicyTopicEvidenceDestinationMismatchUrlTypeEnum_PolicyTopicEvidenceDestinationMismatchUrlType>(1, _omitFieldNames ? '' : 'urlTypes', $pb.PbFieldType.KE, valueOf: $3238.PolicyTopicEvidenceDestinationMismatchUrlTypeEnum_PolicyTopicEvidenceDestinationMismatchUrlType.valueOf, enumValues: $3238.PolicyTopicEvidenceDestinationMismatchUrlTypeEnum_PolicyTopicEvidenceDestinationMismatchUrlType.values, defaultEnumValue: $3238.PolicyTopicEvidenceDestinationMismatchUrlTypeEnum_PolicyTopicEvidenceDestinationMismatchUrlType.UNSPECIFIED)
    ..hasRequiredFields = false
  ;
  ...
  @$pb.TagNumber(1)
  $core.List<$3238.PolicyTopicEvidenceDestinationMismatchUrlTypeEnum_PolicyTopicEvidenceDestinationMismatchUrlType> get urlTypes => $_getList(0);
}
...
class PolicyTopicEvidence_DestinationNotWorking extends $pb.GeneratedMessage {
  factory PolicyTopicEvidence_DestinationNotWorking({
    $3239.PolicyTopicEvidenceDestinationNotWorkingDnsErrorTypeEnum_PolicyTopicEvidenceDestinationNotWorkingDnsErrorType? dnsErrorType,
    $3240.PolicyTopicEvidenceDestinationNotWorkingDeviceEnum_PolicyTopicEvidenceDestinationNotWorkingDevice? device,
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(_omitMessageNames ? '' : 'PolicyTopicEvidence.DestinationNotWorking', package: const $pb.PackageName(_omitMessageNames ? '' : 'google.ads.googleads.v17.common'), createEmptyInstance: create)
    ..oo(0, [1, 6])
    ..e<$3239.PolicyTopicEvidenceDestinationNotWorkingDnsErrorTypeEnum_PolicyTopicEvidenceDestinationNotWorkingDnsErrorType>(1, _omitFieldNames ? '' : 'dnsErrorType', $pb.PbFieldType.OE, defaultOrMaker: $3239.PolicyTopicEvidenceDestinationNotWorkingDnsErrorTypeEnum_PolicyTopicEvidenceDestinationNotWorkingDnsErrorType.UNSPECIFIED, valueOf: $3239.PolicyTopicEvidenceDestinationNotWorkingDnsErrorTypeEnum_PolicyTopicEvidenceDestinationNotWorkingDnsErrorType.valueOf, enumValues: $3239.PolicyTopicEvidenceDestinationNotWorkingDnsErrorTypeEnum_PolicyTopicEvidenceDestinationNotWorkingDnsErrorType.values)
    ..e<$3240.PolicyTopicEvidenceDestinationNotWorkingDeviceEnum_PolicyTopicEvidenceDestinationNotWorkingDevice>(4, _omitFieldNames ? '' : 'device', $pb.PbFieldType.OE, defaultOrMaker: $3240.PolicyTopicEvidenceDestinationNotWorkingDeviceEnum_PolicyTopicEvidenceDestinationNotWorkingDevice.UNSPECIFIED, valueOf: $3240.PolicyTopicEvidenceDestinationNotWorkingDeviceEnum_PolicyTopicEvidenceDestinationNotWorkingDevice.valueOf, enumValues: $3240.PolicyTopicEvidenceDestinationNotWorkingDeviceEnum_PolicyTopicEvidenceDestinationNotWorkingDevice.values)
  ...
  @$pb.TagNumber(1)
  $3239.PolicyTopicEvidenceDestinationNotWorkingDnsErrorTypeEnum_PolicyTopicEvidenceDestinationNotWorkingDnsErrorType get dnsErrorType => $_getN(0);
  @$pb.TagNumber(1)
  set dnsErrorType($3239.PolicyTopicEvidenceDestinationNotWorkingDnsErrorTypeEnum_PolicyTopicEvidenceDestinationNotWorkingDnsErrorType v) { setField(1, v); }
  @$pb.TagNumber(1)
  ...
  @$pb.TagNumber(4)
  $3240.PolicyTopicEvidenceDestinationNotWorkingDeviceEnum_PolicyTopicEvidenceDestinationNotWorkingDevice get device => $_getN(1);
  @$pb.TagNumber(4)
  set device($3240.PolicyTopicEvidenceDestinationNotWorkingDeviceEnum_PolicyTopicEvidenceDestinationNotWorkingDevice v) { setField(4, v); }
  @$pb.TagNumber(4)
