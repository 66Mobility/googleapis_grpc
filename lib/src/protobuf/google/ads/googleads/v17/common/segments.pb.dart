...
class Segments extends $pb.GeneratedMessage {
  factory Segments({
    ...
    if (skAdNetworkFineConversionValue != null) {
      $result.skAdNetworkFineConversionValue = skAdNetworkFineConversionValue;
    }
    ...
    if (skAdNetworkRedistributedFineConversionValue != null) {
      $result.skAdNetworkRedistributedFineConversionValue = skAdNetworkRedistributedFineConversionValue;
    }
    if (adFormatType != null) {
      $result.adFormatType = adFormatType;
    }
    if (skAdNetworkVersion != null) {
      $result.skAdNetworkVersion = skAdNetworkVersion;
    }
    return $result;
  }
  Segments._() : super();
  ...
  /// campaign.
  @$pb.TagNumber(137)
  $fixnum.Int64 get skAdNetworkFineConversionValue => $_getI64(75);
  @$pb.TagNumber(137)
  set skAdNetworkFineConversionValue($fixnum.Int64 v) { $_setInt64(75, v); }
  @$pb.TagNumber(137)
  $core.bool hasSkAdNetworkFineConversionValue() => $_has(75);
  @$pb.TagNumber(137)
  void clearSkAdNetworkFineConversionValue() => clearField(137);
  ...
  ///  to lean more.
  @$pb.TagNumber(190)
  $fixnum.Int64 get skAdNetworkRedistributedFineConversionValue => $_getI64(106);
  @$pb.TagNumber(190)
  set skAdNetworkRedistributedFineConversionValue($fixnum.Int64 v) { $_setInt64(106, v); }
  @$pb.TagNumber(190)
  $core.bool hasSkAdNetworkRedistributedFineConversionValue() => $_has(106);
  @$pb.TagNumber(190)
  void clearSkAdNetworkRedistributedFineConversionValue() => clearField(190);
  ...
  @$pb.TagNumber(191)
  void clearAdFormatType() => clearField(191);

  /// The version of the SKAdNetwork API used.
  @$pb.TagNumber(192)
  $core.String get skAdNetworkVersion => $_getSZ(108);
  @$pb.TagNumber(192)
  set skAdNetworkVersion($core.String v) { $_setString(108, v); }
  @$pb.TagNumber(192)
  $core.bool hasSkAdNetworkVersion() => $_has(108);
  @$pb.TagNumber(192)
  void clearSkAdNetworkVersion() => clearField(192);
}
...
class AssetInteractionTarget extends $pb.GeneratedMessage {
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(_omitMessageNames ? '' : 'AssetInteractionTarget', package: const $pb.PackageName(_omitMessageNames ? '' : 'google.ads.googleads.v17.common'), createEmptyInstance: create)
...
class SkAdNetworkSourceApp extends $pb.GeneratedMessage {
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(_omitMessageNames ? '' : 'SkAdNetworkSourceApp', package: const $pb.PackageName(_omitMessageNames ? '' : 'google.ads.googleads.v17.common'), createEmptyInstance: create)
