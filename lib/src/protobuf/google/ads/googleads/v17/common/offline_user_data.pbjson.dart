...
const UserIdentifier$json = {
  '1': 'UserIdentifier',
  '2': [
    {'1': 'user_identifier_source', '3': 6, '4': 1, '5': 14, '6': '.google.ads.googleads.v17.enums.UserIdentifierSourceEnum.UserIdentifierSource', '10': 'userIdentifierSource'},
    ...
    {'1': 'address_info', '3': 5, '4': 1, '5': 11, '6': '.google.ads.googleads.v17.common.OfflineUserAddressInfo', '9': 0, '10': 'addressInfo'},
  ],
  '8': [
    {'1': 'identifier'},
  ],
...
final $typed_data.Uint8List userIdentifierDescriptor = $convert.base64Decode(
    ...
    'dsZS5hZHMuZ29vZ2xlYWRzLnYxNy5lbnVtcy5Vc2VySWRlbnRpZmllclNvdXJjZUVudW0uVXNl'
    ...
    'GAUgASgLMjcuZ29vZ2xlLmFkcy5nb29nbGVhZHMudjE3LmNvbW1vbi5PZmZsaW5lVXNlckFkZH'
...
const TransactionAttribute$json = {
  ...
  '2': [
    ...
    {'1': 'store_attribute', '3': 6, '4': 1, '5': 11, '6': '.google.ads.googleads.v17.common.StoreAttribute', '10': 'storeAttribute'},
    {'1': 'custom_value', '3': 13, '4': 1, '5': 9, '9': 5, '10': 'customValue', '17': true},
    {'1': 'item_attribute', '3': 14, '4': 1, '5': 11, '6': '.google.ads.googleads.v17.common.ItemAttribute', '10': 'itemAttribute'},
  ],
  '8': [
...
final $typed_data.Uint8List transactionAttributeDescriptor = $convert.base64Decode(
    ...
    '9hdHRyaWJ1dGUYBiABKAsyLy5nb29nbGUuYWRzLmdvb2dsZWFkcy52MTcuY29tbW9uLlN0b3Jl'
    ...
    'cy52MTcuY29tbW9uLkl0ZW1BdHRyaWJ1dGVSDWl0ZW1BdHRyaWJ1dGVCGAoWX3RyYW5zYWN0aW'
...
const UserData$json = {
  '1': 'UserData',
  '2': [
    {'1': 'user_identifiers', '3': 1, '4': 3, '5': 11, '6': '.google.ads.googleads.v17.common.UserIdentifier', '10': 'userIdentifiers'},
    {'1': 'transaction_attribute', '3': 2, '4': 1, '5': 11, '6': '.google.ads.googleads.v17.common.TransactionAttribute', '10': 'transactionAttribute'},
    {'1': 'user_attribute', '3': 3, '4': 1, '5': 11, '6': '.google.ads.googleads.v17.common.UserAttribute', '10': 'userAttribute'},
    {'1': 'consent', '3': 4, '4': 1, '5': 11, '6': '.google.ads.googleads.v17.common.Consent', '9': 0, '10': 'consent', '17': true},
  ],
  '8': [
    {'1': '_consent'},
  ],
...
final $typed_data.Uint8List userDataDescriptor = $convert.base64Decode(
    ...
    'VhZHMudjE3LmNvbW1vbi5Vc2VySWRlbnRpZmllclIPdXNlcklkZW50aWZpZXJzEmoKFXRyYW5z'
    'YWN0aW9uX2F0dHJpYnV0ZRgCIAEoCzI1Lmdvb2dsZS5hZHMuZ29vZ2xlYWRzLnYxNy5jb21tb2'
    '4uVHJhbnNhY3Rpb25BdHRyaWJ1dGVSFHRyYW5zYWN0aW9uQXR0cmlidXRlElUKDnVzZXJfYXR0'
    'cmlidXRlGAMgASgLMi4uZ29vZ2xlLmFkcy5nb29nbGVhZHMudjE3LmNvbW1vbi5Vc2VyQXR0cm'
    'lidXRlUg11c2VyQXR0cmlidXRlEkcKB2NvbnNlbnQYBCABKAsyKC5nb29nbGUuYWRzLmdvb2ds'
    'ZWFkcy52MTcuY29tbW9uLkNvbnNlbnRIAFIHY29uc2VudIgBAUIKCghfY29uc2VudA==');
...
const UserAttribute$json = {
  ...
  '2': [
    ...
    {'1': 'shopping_loyalty', '3': 7, '4': 1, '5': 11, '6': '.google.ads.googleads.v17.common.ShoppingLoyalty', '9': 2, '10': 'shoppingLoyalty', '17': true},
    {'1': 'lifecycle_stage', '3': 8, '4': 1, '5': 9, '8': {}, '10': 'lifecycleStage'},
    {'1': 'first_purchase_date_time', '3': 9, '4': 1, '5': 9, '8': {}, '10': 'firstPurchaseDateTime'},
    {'1': 'event_attribute', '3': 10, '4': 3, '5': 11, '6': '.google.ads.googleads.v17.common.EventAttribute', '8': {}, '10': 'eventAttribute'},
  ],
  '8': [
...
final $typed_data.Uint8List userAttributeDescriptor = $convert.base64Decode(
    ...
    '9nbGUuYWRzLmdvb2dsZWFkcy52MTcuY29tbW9uLlNob3BwaW5nTG95YWx0eUgCUg9zaG9wcGlu'
    ...
    'MudjE3LmNvbW1vbi5FdmVudEF0dHJpYnV0ZUID4EEBUg5ldmVudEF0dHJpYnV0ZUIYChZfbGlm'
...
const EventAttribute$json = {
  ...
  '2': [
    ...
    {'1': 'item_attribute', '3': 3, '4': 3, '5': 11, '6': '.google.ads.googleads.v17.common.EventItemAttribute', '8': {}, '10': 'itemAttribute'},
  ],
};
...
final $typed_data.Uint8List eventAttributeDescriptor = $convert.base64Decode(
    ...
    'CzIzLmdvb2dsZS5hZHMuZ29vZ2xlYWRzLnYxNy5jb21tb24uRXZlbnRJdGVtQXR0cmlidXRlQg'
...
const CustomerMatchUserListMetadata$json = {
  ...
  '2': [
    ...
    {'1': 'consent', '3': 3, '4': 1, '5': 11, '6': '.google.ads.googleads.v17.common.Consent', '9': 1, '10': 'consent', '17': true},
  ],
  '8': [
    {'1': '_user_list'},
    {'1': '_consent'},
...
final $typed_data.Uint8List customerMatchUserListMetadataDescriptor = $convert.base64Decode(
    ...
    'Nlckxpc3SIAQESRwoHY29uc2VudBgDIAEoCzIoLmdvb2dsZS5hZHMuZ29vZ2xlYWRzLnYxNy5j'
...
const StoreSalesMetadata$json = {
  ...
  '2': [
    ...
    {'1': 'third_party_metadata', '3': 3, '4': 1, '5': 11, '6': '.google.ads.googleads.v17.common.StoreSalesThirdPartyMetadata', '10': 'thirdPartyMetadata'},
  ],
  '8': [
    {'1': '_loyalty_fraction'},
...
final $typed_data.Uint8List storeSalesMetadataDescriptor = $convert.base64Decode(
    ...
    'ZWFkcy52MTcuY29tbW9uLlN0b3JlU2FsZXNUaGlyZFBhcnR5TWV0YWRhdGFSEnRoaXJkUGFydH'
