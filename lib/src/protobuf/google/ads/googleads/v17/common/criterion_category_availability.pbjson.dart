...
const CriterionCategoryAvailability$json = {
  ...
  '2': [
    {'1': 'channel', '3': 1, '4': 1, '5': 11, '6': '.google.ads.googleads.v17.common.CriterionCategoryChannelAvailability', '10': 'channel'},
    {'1': 'locale', '3': 2, '4': 3, '5': 11, '6': '.google.ads.googleads.v17.common.CriterionCategoryLocaleAvailability', '10': 'locale'},
  ],
};
...
final $typed_data.Uint8List criterionCategoryAvailabilityDescriptor = $convert.base64Decode(
    ...
    'xlLmFkcy5nb29nbGVhZHMudjE3LmNvbW1vbi5Dcml0ZXJpb25DYXRlZ29yeUNoYW5uZWxBdmFp'
    'bGFiaWxpdHlSB2NoYW5uZWwSXAoGbG9jYWxlGAIgAygLMkQuZ29vZ2xlLmFkcy5nb29nbGVhZH'
    'MudjE3LmNvbW1vbi5Dcml0ZXJpb25DYXRlZ29yeUxvY2FsZUF2YWlsYWJpbGl0eVIGbG9jYWxl');
...
const CriterionCategoryChannelAvailability$json = {
  ...
  '2': [
    {'1': 'availability_mode', '3': 1, '4': 1, '5': 14, '6': '.google.ads.googleads.v17.enums.CriterionCategoryChannelAvailabilityModeEnum.CriterionCategoryChannelAvailabilityMode', '10': 'availabilityMode'},
    {'1': 'advertising_channel_type', '3': 2, '4': 1, '5': 14, '6': '.google.ads.googleads.v17.enums.AdvertisingChannelTypeEnum.AdvertisingChannelType', '10': 'advertisingChannelType'},
    {'1': 'advertising_channel_sub_type', '3': 3, '4': 3, '5': 14, '6': '.google.ads.googleads.v17.enums.AdvertisingChannelSubTypeEnum.AdvertisingChannelSubType', '10': 'advertisingChannelSubType'},
...
final $typed_data.Uint8List criterionCategoryChannelAvailabilityDescriptor = $convert.base64Decode(
    ...
    '9tb2RlGAEgASgOMnUuZ29vZ2xlLmFkcy5nb29nbGVhZHMudjE3LmVudW1zLkNyaXRlcmlvbkNh'
    ...
    'YW5uZWxfdHlwZRgCIAEoDjJRLmdvb2dsZS5hZHMuZ29vZ2xlYWRzLnYxNy5lbnVtcy5BZHZlcn'
    ...
    '9vZ2xlLmFkcy5nb29nbGVhZHMudjE3LmVudW1zLkFkdmVydGlzaW5nQ2hhbm5lbFN1YlR5cGVF'
...
const CriterionCategoryLocaleAvailability$json = {
  ...
  '2': [
    {'1': 'availability_mode', '3': 1, '4': 1, '5': 14, '6': '.google.ads.googleads.v17.enums.CriterionCategoryLocaleAvailabilityModeEnum.CriterionCategoryLocaleAvailabilityMode', '10': 'availabilityMode'},
...
final $typed_data.Uint8List criterionCategoryLocaleAvailabilityDescriptor = $convert.base64Decode(
    ...
    '1vZGUYASABKA4ycy5nb29nbGUuYWRzLmdvb2dsZWFkcy52MTcuZW51bXMuQ3JpdGVyaW9uQ2F0'
