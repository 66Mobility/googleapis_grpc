...
const PolicyValidationParameter$json = {
  ...
  '2': [
    ...
    {'1': 'exempt_policy_violation_keys', '3': 2, '4': 3, '5': 11, '6': '.google.ads.googleads.v17.common.PolicyViolationKey', '10': 'exemptPolicyViolationKeys'},
  ],
};
...
final $typed_data.Uint8List policyValidationParameterDescriptor = $convert.base64Decode(
    ...
    'a2V5cxgCIAMoCzIzLmdvb2dsZS5hZHMuZ29vZ2xlYWRzLnYxNy5jb21tb24uUG9saWN5VmlvbG'
...
const PolicyTopicEntry$json = {
  ...
  '2': [
    ...
    {'1': 'type', '3': 2, '4': 1, '5': 14, '6': '.google.ads.googleads.v17.enums.PolicyTopicEntryTypeEnum.PolicyTopicEntryType', '10': 'type'},
    {'1': 'evidences', '3': 3, '4': 3, '5': 11, '6': '.google.ads.googleads.v17.common.PolicyTopicEvidence', '10': 'evidences'},
    {'1': 'constraints', '3': 4, '4': 3, '5': 11, '6': '.google.ads.googleads.v17.common.PolicyTopicConstraint', '10': 'constraints'},
  ],
  '8': [
    {'1': '_topic'},
  ],
...
final $typed_data.Uint8List policyTopicEntryDescriptor = $convert.base64Decode(
    ...
    'ABKA4yTS5nb29nbGUuYWRzLmdvb2dsZWFkcy52MTcuZW51bXMuUG9saWN5VG9waWNFbnRyeVR5'
    'cGVFbnVtLlBvbGljeVRvcGljRW50cnlUeXBlUgR0eXBlElIKCWV2aWRlbmNlcxgDIAMoCzI0Lm'
    'dvb2dsZS5hZHMuZ29vZ2xlYWRzLnYxNy5jb21tb24uUG9saWN5VG9waWNFdmlkZW5jZVIJZXZp'
    'ZGVuY2VzElgKC2NvbnN0cmFpbnRzGAQgAygLMjYuZ29vZ2xlLmFkcy5nb29nbGVhZHMudjE3Lm'
...
const PolicyTopicEvidence$json = {
  ...
  '2': [
    {'1': 'website_list', '3': 3, '4': 1, '5': 11, '6': '.google.ads.googleads.v17.common.PolicyTopicEvidence.WebsiteList', '9': 0, '10': 'websiteList'},
    {'1': 'text_list', '3': 4, '4': 1, '5': 11, '6': '.google.ads.googleads.v17.common.PolicyTopicEvidence.TextList', '9': 0, '10': 'textList'},
    {'1': 'language_code', '3': 9, '4': 1, '5': 9, '9': 0, '10': 'languageCode'},
    {'1': 'destination_text_list', '3': 6, '4': 1, '5': 11, '6': '.google.ads.googleads.v17.common.PolicyTopicEvidence.DestinationTextList', '9': 0, '10': 'destinationTextList'},
    {'1': 'destination_mismatch', '3': 7, '4': 1, '5': 11, '6': '.google.ads.googleads.v17.common.PolicyTopicEvidence.DestinationMismatch', '9': 0, '10': 'destinationMismatch'},
    {'1': 'destination_not_working', '3': 8, '4': 1, '5': 11, '6': '.google.ads.googleads.v17.common.PolicyTopicEvidence.DestinationNotWorking', '9': 0, '10': 'destinationNotWorking'},
  ],
...
const PolicyTopicEvidence_DestinationMismatch$json = {
  ...
  '2': [
    {'1': 'url_types', '3': 1, '4': 3, '5': 14, '6': '.google.ads.googleads.v17.enums.PolicyTopicEvidenceDestinationMismatchUrlTypeEnum.PolicyTopicEvidenceDestinationMismatchUrlType', '10': 'urlTypes'},
  ],
};
...
const PolicyTopicEvidence_DestinationNotWorking$json = {
  ...
  '2': [
    ...
    {'1': 'device', '3': 4, '4': 1, '5': 14, '6': '.google.ads.googleads.v17.enums.PolicyTopicEvidenceDestinationNotWorkingDeviceEnum.PolicyTopicEvidenceDestinationNotWorkingDevice', '10': 'device'},
    {'1': 'last_checked_date_time', '3': 8, '4': 1, '5': 9, '9': 2, '10': 'lastCheckedDateTime', '17': true},
    {'1': 'dns_error_type', '3': 1, '4': 1, '5': 14, '6': '.google.ads.googleads.v17.enums.PolicyTopicEvidenceDestinationNotWorkingDnsErrorTypeEnum.PolicyTopicEvidenceDestinationNotWorkingDnsErrorType', '9': 0, '10': 'dnsErrorType'},
...
final $typed_data.Uint8List policyTopicEvidenceDescriptor = $convert.base64Decode(
    ...
    'MuZ29vZ2xlYWRzLnYxNy5jb21tb24uUG9saWN5VG9waWNFdmlkZW5jZS5XZWJzaXRlTGlzdEgA'
    'Ugt3ZWJzaXRlTGlzdBJcCgl0ZXh0X2xpc3QYBCABKAsyPS5nb29nbGUuYWRzLmdvb2dsZWFkcy'
    '52MTcuY29tbW9uLlBvbGljeVRvcGljRXZpZGVuY2UuVGV4dExpc3RIAFIIdGV4dExpc3QSJQoN'
    'bGFuZ3VhZ2VfY29kZRgJIAEoCUgAUgxsYW5ndWFnZUNvZGUSfgoVZGVzdGluYXRpb25fdGV4dF'
    '9saXN0GAYgASgLMkguZ29vZ2xlLmFkcy5nb29nbGVhZHMudjE3LmNvbW1vbi5Qb2xpY3lUb3Bp'
    'Y0V2aWRlbmNlLkRlc3RpbmF0aW9uVGV4dExpc3RIAFITZGVzdGluYXRpb25UZXh0TGlzdBJ9Ch'
    'RkZXN0aW5hdGlvbl9taXNtYXRjaBgHIAEoCzJILmdvb2dsZS5hZHMuZ29vZ2xlYWRzLnYxNy5j'
    ...
    'LmFkcy5nb29nbGVhZHMudjE3LmNvbW1vbi5Qb2xpY3lUb3BpY0V2aWRlbmNlLkRlc3RpbmF0aW'
    ...
    'ADKA4yfy5nb29nbGUuYWRzLmdvb2dsZWFkcy52MTcuZW51bXMuUG9saWN5VG9waWNFdmlkZW5j'
    ...
    'ABKA4ygQEuZ29vZ2xlLmFkcy5nb29nbGVhZHMudjE3LmVudW1zLlBvbGljeVRvcGljRXZpZGVu'
    ...
    'EgASgOMo0BLmdvb2dsZS5hZHMuZ29vZ2xlYWRzLnYxNy5lbnVtcy5Qb2xpY3lUb3BpY0V2aWRl'
...
const PolicyTopicConstraint$json = {
  ...
  '2': [
    {'1': 'country_constraint_list', '3': 1, '4': 1, '5': 11, '6': '.google.ads.googleads.v17.common.PolicyTopicConstraint.CountryConstraintList', '9': 0, '10': 'countryConstraintList'},
    {'1': 'reseller_constraint', '3': 2, '4': 1, '5': 11, '6': '.google.ads.googleads.v17.common.PolicyTopicConstraint.ResellerConstraint', '9': 0, '10': 'resellerConstraint'},
    {'1': 'certificate_missing_in_country_list', '3': 3, '4': 1, '5': 11, '6': '.google.ads.googleads.v17.common.PolicyTopicConstraint.CountryConstraintList', '9': 0, '10': 'certificateMissingInCountryList'},
    {'1': 'certificate_domain_mismatch_in_country_list', '3': 4, '4': 1, '5': 11, '6': '.google.ads.googleads.v17.common.PolicyTopicConstraint.CountryConstraintList', '9': 0, '10': 'certificateDomainMismatchInCountryList'},
  ],
...
const PolicyTopicConstraint_CountryConstraintList$json = {
  ...
  '2': [
    ...
    {'1': 'countries', '3': 2, '4': 3, '5': 11, '6': '.google.ads.googleads.v17.common.PolicyTopicConstraint.CountryConstraint', '10': 'countries'},
  ],
  '8': [
...
final $typed_data.Uint8List policyTopicConstraintDescriptor = $convert.base64Decode(
    ...
    'gLMkwuZ29vZ2xlLmFkcy5nb29nbGVhZHMudjE3LmNvbW1vbi5Qb2xpY3lUb3BpY0NvbnN0cmFp'
    'bnQuQ291bnRyeUNvbnN0cmFpbnRMaXN0SABSFWNvdW50cnlDb25zdHJhaW50TGlzdBJ8ChNyZX'
    'NlbGxlcl9jb25zdHJhaW50GAIgASgLMkkuZ29vZ2xlLmFkcy5nb29nbGVhZHMudjE3LmNvbW1v'
    ...
    'TC5nb29nbGUuYWRzLmdvb2dsZWFkcy52MTcuY29tbW9uLlBvbGljeVRvcGljQ29uc3RyYWludC'
    ...
    'JMLmdvb2dsZS5hZHMuZ29vZ2xlYWRzLnYxNy5jb21tb24uUG9saWN5VG9waWNDb25zdHJhaW50'
    ...
    'gCIAMoCzJILmdvb2dsZS5hZHMuZ29vZ2xlYWRzLnYxNy5jb21tb24uUG9saWN5VG9waWNDb25z'
