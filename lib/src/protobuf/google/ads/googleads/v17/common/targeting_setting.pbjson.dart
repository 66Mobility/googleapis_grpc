...
const TargetingSetting$json = {
  '1': 'TargetingSetting',
  '2': [
    {'1': 'target_restrictions', '3': 1, '4': 3, '5': 11, '6': '.google.ads.googleads.v17.common.TargetRestriction', '10': 'targetRestrictions'},
    {'1': 'target_restriction_operations', '3': 2, '4': 3, '5': 11, '6': '.google.ads.googleads.v17.common.TargetRestrictionOperation', '10': 'targetRestrictionOperations'},
  ],
};
...
final $typed_data.Uint8List targetingSettingDescriptor = $convert.base64Decode(
    ...
    'UuYWRzLmdvb2dsZWFkcy52MTcuY29tbW9uLlRhcmdldFJlc3RyaWN0aW9uUhJ0YXJnZXRSZXN0'
    'cmljdGlvbnMSfwoddGFyZ2V0X3Jlc3RyaWN0aW9uX29wZXJhdGlvbnMYAiADKAsyOy5nb29nbG'
    'UuYWRzLmdvb2dsZWFkcy52MTcuY29tbW9uLlRhcmdldFJlc3RyaWN0aW9uT3BlcmF0aW9uUht0'
...
const TargetRestriction$json = {
  '1': 'TargetRestriction',
  '2': [
    {'1': 'targeting_dimension', '3': 1, '4': 1, '5': 14, '6': '.google.ads.googleads.v17.enums.TargetingDimensionEnum.TargetingDimension', '10': 'targetingDimension'},
...
final $typed_data.Uint8List targetRestrictionDescriptor = $convert.base64Decode(
    ...
    'xlLmFkcy5nb29nbGVhZHMudjE3LmVudW1zLlRhcmdldGluZ0RpbWVuc2lvbkVudW0uVGFyZ2V0'
...
const TargetRestrictionOperation$json = {
  ...
  '2': [
    {'1': 'operator', '3': 1, '4': 1, '5': 14, '6': '.google.ads.googleads.v17.common.TargetRestrictionOperation.Operator', '10': 'operator'},
    {'1': 'value', '3': 2, '4': 1, '5': 11, '6': '.google.ads.googleads.v17.common.TargetRestriction', '10': 'value'},
  ],
...
final $typed_data.Uint8List targetRestrictionOperationDescriptor = $convert.base64Decode(
    ...
    '5hZHMuZ29vZ2xlYWRzLnYxNy5jb21tb24uVGFyZ2V0UmVzdHJpY3Rpb25PcGVyYXRpb24uT3Bl'
    'cmF0b3JSCG9wZXJhdG9yEkgKBXZhbHVlGAIgASgLMjIuZ29vZ2xlLmFkcy5nb29nbGVhZHMudj'
    'E3LmNvbW1vbi5UYXJnZXRSZXN0cmljdGlvblIFdmFsdWUiPQoIT3BlcmF0b3ISDwoLVU5TUEVD'
