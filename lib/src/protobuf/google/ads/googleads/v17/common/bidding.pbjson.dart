...
const TargetCpm$json = {
  '1': 'TargetCpm',
  '2': [
    {'1': 'target_frequency_goal', '3': 1, '4': 1, '5': 11, '6': '.google.ads.googleads.v17.common.TargetCpmTargetFrequencyGoal', '9': 0, '10': 'targetFrequencyGoal'},
  ],
  '8': [
    {'1': 'goal'},
  ],
...
final $typed_data.Uint8List targetCpmDescriptor = $convert.base64Decode(
    ...
    '5nb29nbGVhZHMudjE3LmNvbW1vbi5UYXJnZXRDcG1UYXJnZXRGcmVxdWVuY3lHb2FsSABSE3Rh'
...
const TargetCpmTargetFrequencyGoal$json = {
  ...
  '2': [
    ...
    {'1': 'time_unit', '3': 2, '4': 1, '5': 14, '6': '.google.ads.googleads.v17.enums.TargetFrequencyTimeUnitEnum.TargetFrequencyTimeUnit', '10': 'timeUnit'},
  ],
};
...
final $typed_data.Uint8List targetCpmTargetFrequencyGoalDescriptor = $convert.base64Decode(
    ...
    'FyZ2V0Q291bnQScAoJdGltZV91bml0GAIgASgOMlMuZ29vZ2xlLmFkcy5nb29nbGVhZHMudjE3'
...
const TargetImpressionShare$json = {
  ...
  '2': [
    {'1': 'location', '3': 1, '4': 1, '5': 14, '6': '.google.ads.googleads.v17.enums.TargetImpressionShareLocationEnum.TargetImpressionShareLocation', '10': 'location'},
...
final $typed_data.Uint8List targetImpressionShareDescriptor = $convert.base64Decode(
    ...
    'dvb2dsZWFkcy52MTcuZW51bXMuVGFyZ2V0SW1wcmVzc2lvblNoYXJlTG9jYXRpb25FbnVtLlRh'
...
@$core.Deprecated('Use fixedCpmDescriptor instead')
const FixedCpm$json = {
  '1': 'FixedCpm',
  '2': [
    {'1': 'goal', '3': 1, '4': 1, '5': 14, '6': '.google.ads.googleads.v17.enums.FixedCpmGoalEnum.FixedCpmGoal', '10': 'goal'},
    {'1': 'target_frequency_info', '3': 2, '4': 1, '5': 11, '6': '.google.ads.googleads.v17.common.FixedCpmTargetFrequencyGoalInfo', '9': 0, '10': 'targetFrequencyInfo'},
  ],
  '8': [
    {'1': 'goal_info'},
  ],
...
/// Descriptor for `FixedCpm`. Decode as a `google.protobuf.DescriptorProto`.
final $typed_data.Uint8List fixedCpmDescriptor = $convert.base64Decode(
    'CghGaXhlZENwbRJRCgRnb2FsGAEgASgOMj0uZ29vZ2xlLmFkcy5nb29nbGVhZHMudjE3LmVudW'
    '1zLkZpeGVkQ3BtR29hbEVudW0uRml4ZWRDcG1Hb2FsUgRnb2FsEnYKFXRhcmdldF9mcmVxdWVu'
    'Y3lfaW5mbxgCIAEoCzJALmdvb2dsZS5hZHMuZ29vZ2xlYWRzLnYxNy5jb21tb24uRml4ZWRDcG'
    '1UYXJnZXRGcmVxdWVuY3lHb2FsSW5mb0gAUhN0YXJnZXRGcmVxdWVuY3lJbmZvQgsKCWdvYWxf'
    'aW5mbw==');

@$core.Deprecated('Use fixedCpmTargetFrequencyGoalInfoDescriptor instead')
const FixedCpmTargetFrequencyGoalInfo$json = {
  '1': 'FixedCpmTargetFrequencyGoalInfo',
  '2': [
    {'1': 'target_count', '3': 1, '4': 1, '5': 3, '10': 'targetCount'},
    {'1': 'time_unit', '3': 2, '4': 1, '5': 14, '6': '.google.ads.googleads.v17.enums.FixedCpmTargetFrequencyTimeUnitEnum.FixedCpmTargetFrequencyTimeUnit', '10': 'timeUnit'},
  ],
};

/// Descriptor for `FixedCpmTargetFrequencyGoalInfo`. Decode as a `google.protobuf.DescriptorProto`.
final $typed_data.Uint8List fixedCpmTargetFrequencyGoalInfoDescriptor = $convert.base64Decode(
    'Ch9GaXhlZENwbVRhcmdldEZyZXF1ZW5jeUdvYWxJbmZvEiEKDHRhcmdldF9jb3VudBgBIAEoA1'
    'ILdGFyZ2V0Q291bnQSgAEKCXRpbWVfdW5pdBgCIAEoDjJjLmdvb2dsZS5hZHMuZ29vZ2xlYWRz'
    'LnYxNy5lbnVtcy5GaXhlZENwbVRhcmdldEZyZXF1ZW5jeVRpbWVVbml0RW51bS5GaXhlZENwbV'
    'RhcmdldEZyZXF1ZW5jeVRpbWVVbml0Ugh0aW1lVW5pdA==');

@$core.Deprecated('Use targetCpvDescriptor instead')
const TargetCpv$json = {
  '1': 'TargetCpv',
};

/// Descriptor for `TargetCpv`. Decode as a `google.protobuf.DescriptorProto`.
final $typed_data.Uint8List targetCpvDescriptor = $convert.base64Decode(
    'CglUYXJnZXRDcHY=');
