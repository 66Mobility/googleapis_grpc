...
class TargetRestriction extends $pb.GeneratedMessage {
  factory TargetRestriction({
    $3354.TargetingDimensionEnum_TargetingDimension? targetingDimension,
    $core.bool? bidOnly,
  }) {
    final $result = create();
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(_omitMessageNames ? '' : 'TargetRestriction', package: const $pb.PackageName(_omitMessageNames ? '' : 'google.ads.googleads.v17.common'), createEmptyInstance: create)
    ..e<$3354.TargetingDimensionEnum_TargetingDimension>(1, _omitFieldNames ? '' : 'targetingDimension', $pb.PbFieldType.OE, defaultOrMaker: $3354.TargetingDimensionEnum_TargetingDimension.UNSPECIFIED, valueOf: $3354.TargetingDimensionEnum_TargetingDimension.valueOf, enumValues: $3354.TargetingDimensionEnum_TargetingDimension.values)
  ...
  @$pb.TagNumber(1)
  $3354.TargetingDimensionEnum_TargetingDimension get targetingDimension => $_getN(0);
  @$pb.TagNumber(1)
  set targetingDimension($3354.TargetingDimensionEnum_TargetingDimension v) { setField(1, v); }
  @$pb.TagNumber(1)
