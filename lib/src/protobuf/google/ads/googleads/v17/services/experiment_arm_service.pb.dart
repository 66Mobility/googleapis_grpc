...
class ExperimentArmOperation extends $pb.GeneratedMessage {
  factory ExperimentArmOperation({
    $3835.ExperimentArm? create_1,
    $3835.ExperimentArm? update,
    $core.String? remove,
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(_omitMessageNames ? '' : 'ExperimentArmOperation', package: const $pb.PackageName(_omitMessageNames ? '' : 'google.ads.googleads.v17.services'), createEmptyInstance: create)
    ..oo(0, [1, 2, 3])
    ..aOM<$3835.ExperimentArm>(1, _omitFieldNames ? '' : 'create', subBuilder: $3835.ExperimentArm.create)
    ..aOM<$3835.ExperimentArm>(2, _omitFieldNames ? '' : 'update', subBuilder: $3835.ExperimentArm.create)
  ...
  /// Create operation
  @$pb.TagNumber(1)
  $3835.ExperimentArm get create_1 => $_getN(0);
  @$pb.TagNumber(1)
  set create_1($3835.ExperimentArm v) { setField(1, v); }
  @$pb.TagNumber(1)
  $core.bool hasCreate_1() => $_has(0);
  @$pb.TagNumber(1)
  void clearCreate_1() => clearField(1);
  @$pb.TagNumber(1)
  $3835.ExperimentArm ensureCreate_1() => $_ensure(0);

  /// Update operation: The experiment arm is expected to have a valid
  /// resource name.
  @$pb.TagNumber(2)
  $3835.ExperimentArm get update => $_getN(1);
  @$pb.TagNumber(2)
  set update($3835.ExperimentArm v) { setField(2, v); }
  @$pb.TagNumber(2)
  $core.bool hasUpdate() => $_has(1);
  @$pb.TagNumber(2)
  void clearUpdate() => clearField(2);
  @$pb.TagNumber(2)
  $3835.ExperimentArm ensureUpdate() => $_ensure(1);
...
class MutateExperimentArmResult extends $pb.GeneratedMessage {
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(_omitMessageNames ? '' : 'MutateExperimentArmResult', package: const $pb.PackageName(_omitMessageNames ? '' : 'google.ads.googleads.v17.services'), createEmptyInstance: create)
    ...
    ..aOM<$3835.ExperimentArm>(2, _omitFieldNames ? '' : 'experimentArm', subBuilder: $3835.ExperimentArm.create)
    ..hasRequiredFields = false
  ;
  ...
  /// "MUTABLE_RESOURCE".
  @$pb.TagNumber(2)
  $3835.ExperimentArm get experimentArm => $_getN(1);
  @$pb.TagNumber(2)
  set experimentArm($3835.ExperimentArm v) { setField(2, v); }
  @$pb.TagNumber(2)
  $core.bool hasExperimentArm() => $_has(1);
  @$pb.TagNumber(2)
  void clearExperimentArm() => clearField(2);
  @$pb.TagNumber(2)
  $3835.ExperimentArm ensureExperimentArm() => $_ensure(1);
}
