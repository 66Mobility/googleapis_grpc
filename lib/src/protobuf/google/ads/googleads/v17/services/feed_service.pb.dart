...
class MutateFeedsRequest extends $pb.GeneratedMessage {
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(_omitMessageNames ? '' : 'MutateFeedsRequest', package: const $pb.PackageName(_omitMessageNames ? '' : 'google.ads.googleads.v17.services'), createEmptyInstance: create)
...
class FeedOperation extends $pb.GeneratedMessage {
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(_omitMessageNames ? '' : 'FeedOperation', package: const $pb.PackageName(_omitMessageNames ? '' : 'google.ads.googleads.v17.services'), createEmptyInstance: create)
    ..oo(0, [1, 2, 3])
    ..aOM<$3650.Feed>(1, _omitFieldNames ? '' : 'create', subBuilder: $3650.Feed.create)
    ..aOM<$3650.Feed>(2, _omitFieldNames ? '' : 'update', subBuilder: $3650.Feed.create)
  ...
  @$pb.TagNumber(1)
  $3650.Feed get create_1 => $_getN(0);
  @$pb.TagNumber(1)
  set create_1($3650.Feed v) { setField(1, v); }
  @$pb.TagNumber(1)
  $core.bool hasCreate_1() => $_has(0);
  @$pb.TagNumber(1)
  void clearCreate_1() => clearField(1);
  @$pb.TagNumber(1)
  $3650.Feed ensureCreate_1() => $_ensure(0);

  /// Update operation: The feed is expected to have a valid resource
  /// name.
  @$pb.TagNumber(2)
  $3650.Feed get update => $_getN(1);
  @$pb.TagNumber(2)
  set update($3650.Feed v) { setField(2, v); }
  @$pb.TagNumber(2)
  $core.bool hasUpdate() => $_has(1);
  @$pb.TagNumber(2)
  void clearUpdate() => clearField(2);
  @$pb.TagNumber(2)
  $3650.Feed ensureUpdate() => $_ensure(1);
...
class MutateFeedsResponse extends $pb.GeneratedMessage {
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(_omitMessageNames ? '' : 'MutateFeedsResponse', package: const $pb.PackageName(_omitMessageNames ? '' : 'google.ads.googleads.v17.services'), createEmptyInstance: create)
...
class MutateFeedResult extends $pb.GeneratedMessage {
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(_omitMessageNames ? '' : 'MutateFeedResult', package: const $pb.PackageName(_omitMessageNames ? '' : 'google.ads.googleads.v17.services'), createEmptyInstance: create)
    ..aOS(1, _omitFieldNames ? '' : 'resourceName')
    ..aOM<$3650.Feed>(2, _omitFieldNames ? '' : 'feed', subBuilder: $3650.Feed.create)
    ..hasRequiredFields = false
  ;
  ...
  @$pb.TagNumber(2)
  $3650.Feed get feed => $_getN(1);
  @$pb.TagNumber(2)
  set feed($3650.Feed v) { setField(2, v); }
  @$pb.TagNumber(2)
  $core.bool hasFeed() => $_has(1);
  @$pb.TagNumber(2)
  void clearFeed() => clearField(2);
  @$pb.TagNumber(2)
  $3650.Feed ensureFeed() => $_ensure(1);
}
