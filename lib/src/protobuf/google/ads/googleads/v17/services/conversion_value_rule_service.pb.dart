...
class MutateConversionValueRulesRequest extends $pb.GeneratedMessage {
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(_omitMessageNames ? '' : 'MutateConversionValueRulesRequest', package: const $pb.PackageName(_omitMessageNames ? '' : 'google.ads.googleads.v17.services'), createEmptyInstance: create)
...
class ConversionValueRuleOperation extends $pb.GeneratedMessage {
  factory ConversionValueRuleOperation({
    $3825.ConversionValueRule? create_1,
    $3825.ConversionValueRule? update,
    $core.String? remove,
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(_omitMessageNames ? '' : 'ConversionValueRuleOperation', package: const $pb.PackageName(_omitMessageNames ? '' : 'google.ads.googleads.v17.services'), createEmptyInstance: create)
    ..oo(0, [1, 2, 3])
    ..aOM<$3825.ConversionValueRule>(1, _omitFieldNames ? '' : 'create', subBuilder: $3825.ConversionValueRule.create)
    ..aOM<$3825.ConversionValueRule>(2, _omitFieldNames ? '' : 'update', subBuilder: $3825.ConversionValueRule.create)
  ...
  /// value rule.
  @$pb.TagNumber(1)
  $3825.ConversionValueRule get create_1 => $_getN(0);
  @$pb.TagNumber(1)
  set create_1($3825.ConversionValueRule v) { setField(1, v); }
  @$pb.TagNumber(1)
  $core.bool hasCreate_1() => $_has(0);
  @$pb.TagNumber(1)
  void clearCreate_1() => clearField(1);
  @$pb.TagNumber(1)
  $3825.ConversionValueRule ensureCreate_1() => $_ensure(0);

  /// Update operation: The conversion value rule is expected to have a valid
  /// resource name.
  @$pb.TagNumber(2)
  $3825.ConversionValueRule get update => $_getN(1);
  @$pb.TagNumber(2)
  set update($3825.ConversionValueRule v) { setField(2, v); }
  @$pb.TagNumber(2)
  $core.bool hasUpdate() => $_has(1);
  @$pb.TagNumber(2)
  void clearUpdate() => clearField(2);
  @$pb.TagNumber(2)
  $3825.ConversionValueRule ensureUpdate() => $_ensure(1);
...
class MutateConversionValueRulesResponse extends $pb.GeneratedMessage {
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(_omitMessageNames ? '' : 'MutateConversionValueRulesResponse', package: const $pb.PackageName(_omitMessageNames ? '' : 'google.ads.googleads.v17.services'), createEmptyInstance: create)
...
class MutateConversionValueRuleResult extends $pb.GeneratedMessage {
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(_omitMessageNames ? '' : 'MutateConversionValueRuleResult', package: const $pb.PackageName(_omitMessageNames ? '' : 'google.ads.googleads.v17.services'), createEmptyInstance: create)
    ..aOS(1, _omitFieldNames ? '' : 'resourceName')
    ..aOM<$3825.ConversionValueRule>(2, _omitFieldNames ? '' : 'conversionValueRule', subBuilder: $3825.ConversionValueRule.create)
    ..hasRequiredFields = false
  ;
  ...
  /// to "MUTABLE_RESOURCE".
  @$pb.TagNumber(2)
  $3825.ConversionValueRule get conversionValueRule => $_getN(1);
  @$pb.TagNumber(2)
  set conversionValueRule($3825.ConversionValueRule v) { setField(2, v); }
  @$pb.TagNumber(2)
  $core.bool hasConversionValueRule() => $_has(1);
  @$pb.TagNumber(2)
  void clearConversionValueRule() => clearField(2);
  @$pb.TagNumber(2)
  $3825.ConversionValueRule ensureConversionValueRule() => $_ensure(1);
}
