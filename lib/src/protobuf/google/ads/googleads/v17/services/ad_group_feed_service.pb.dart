...
class AdGroupFeedOperation extends $pb.GeneratedMessage {
  factory AdGroupFeedOperation({
    $3654.AdGroupFeed? create_1,
    $3654.AdGroupFeed? update,
    $core.String? remove,
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(_omitMessageNames ? '' : 'AdGroupFeedOperation', package: const $pb.PackageName(_omitMessageNames ? '' : 'google.ads.googleads.v17.services'), createEmptyInstance: create)
    ..oo(0, [1, 2, 3])
    ..aOM<$3654.AdGroupFeed>(1, _omitFieldNames ? '' : 'create', subBuilder: $3654.AdGroupFeed.create)
    ..aOM<$3654.AdGroupFeed>(2, _omitFieldNames ? '' : 'update', subBuilder: $3654.AdGroupFeed.create)
  ...
  @$pb.TagNumber(1)
  $3654.AdGroupFeed get create_1 => $_getN(0);
  @$pb.TagNumber(1)
  set create_1($3654.AdGroupFeed v) { setField(1, v); }
  @$pb.TagNumber(1)
  $core.bool hasCreate_1() => $_has(0);
  @$pb.TagNumber(1)
  void clearCreate_1() => clearField(1);
  @$pb.TagNumber(1)
  $3654.AdGroupFeed ensureCreate_1() => $_ensure(0);

  /// Update operation: The ad group feed is expected to have a valid resource
  /// name.
  @$pb.TagNumber(2)
  $3654.AdGroupFeed get update => $_getN(1);
  @$pb.TagNumber(2)
  set update($3654.AdGroupFeed v) { setField(2, v); }
  @$pb.TagNumber(2)
  $core.bool hasUpdate() => $_has(1);
  @$pb.TagNumber(2)
  void clearUpdate() => clearField(2);
  @$pb.TagNumber(2)
  $3654.AdGroupFeed ensureUpdate() => $_ensure(1);
...
class MutateAdGroupFeedResult extends $pb.GeneratedMessage {
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(_omitMessageNames ? '' : 'MutateAdGroupFeedResult', package: const $pb.PackageName(_omitMessageNames ? '' : 'google.ads.googleads.v17.services'), createEmptyInstance: create)
    ...
    ..aOM<$3654.AdGroupFeed>(2, _omitFieldNames ? '' : 'adGroupFeed', subBuilder: $3654.AdGroupFeed.create)
    ..hasRequiredFields = false
  ;
  ...
  /// "MUTABLE_RESOURCE".
  @$pb.TagNumber(2)
  $3654.AdGroupFeed get adGroupFeed => $_getN(1);
  @$pb.TagNumber(2)
  set adGroupFeed($3654.AdGroupFeed v) { setField(2, v); }
  @$pb.TagNumber(2)
  $core.bool hasAdGroupFeed() => $_has(1);
  @$pb.TagNumber(2)
  void clearAdGroupFeed() => clearField(2);
  @$pb.TagNumber(2)
  $3654.AdGroupFeed ensureAdGroupFeed() => $_ensure(1);
}
