...
const MutateLabelsRequest$json = {
  ...
  '2': [
    ...
    {'1': 'operations', '3': 2, '4': 3, '5': 11, '6': '.google.ads.googleads.v17.services.LabelOperation', '8': {}, '10': 'operations'},
...
final $typed_data.Uint8List mutateLabelsRequestDescriptor = $convert.base64Decode(
    ...
    'RzLnYxNy5lbnVtcy5SZXNwb25zZUNvbnRlbnRUeXBlRW51bS5SZXNwb25zZUNvbnRlbnRUeXBl'
...
const LabelOperation$json = {
  ...
  '2': [
    ...
    {'1': 'create', '3': 1, '4': 1, '5': 11, '6': '.google.ads.googleads.v17.resources.Label', '9': 0, '10': 'create'},
    {'1': 'update', '3': 2, '4': 1, '5': 11, '6': '.google.ads.googleads.v17.resources.Label', '9': 0, '10': 'update'},
...
final $typed_data.Uint8List labelOperationDescriptor = $convert.base64Decode(
    ...
    'bGVhZHMudjE3LnJlc291cmNlcy5MYWJlbEgAUgZjcmVhdGUSQwoGdXBkYXRlGAIgASgLMikuZ2'
    '9vZ2xlLmFkcy5nb29nbGVhZHMudjE3LnJlc291cmNlcy5MYWJlbEgAUgZ1cGRhdGUSPQoGcmVt'
...
const MutateLabelsResponse$json = {
  ...
  '2': [
    ...
    {'1': 'results', '3': 2, '4': 3, '5': 11, '6': '.google.ads.googleads.v17.services.MutateLabelResult', '10': 'results'},
  ],
};
...
final $typed_data.Uint8List mutateLabelsResponseDescriptor = $convert.base64Decode(
    ...
    'MjQuZ29vZ2xlLmFkcy5nb29nbGVhZHMudjE3LnNlcnZpY2VzLk11dGF0ZUxhYmVsUmVzdWx0Ug'
    'dyZXN1bHRz');
...
const MutateLabelResult$json = {
  ...
  '2': [
    ...
    {'1': 'label', '3': 2, '4': 1, '5': 11, '6': '.google.ads.googleads.v17.resources.Label', '10': 'label'},
  ],
};
...
final $typed_data.Uint8List mutateLabelResultDescriptor = $convert.base64Decode(
    ...
    'Z29vZ2xlLmFkcy5nb29nbGVhZHMudjE3LnJlc291cmNlcy5MYWJlbFIFbGFiZWw=');
