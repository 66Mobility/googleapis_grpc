...
const MutateCampaignExtensionSettingsRequest$json = {
  ...
  '2': [
    ...
    {'1': 'operations', '3': 2, '4': 3, '5': 11, '6': '.google.ads.googleads.v17.services.CampaignExtensionSettingOperation', '8': {}, '10': 'operations'},
...
final $typed_data.Uint8List mutateCampaignExtensionSettingsRequestDescriptor = $convert.base64Decode(
    ...
    'Lmdvb2dsZWFkcy52MTcuc2VydmljZXMuQ2FtcGFpZ25FeHRlbnNpb25TZXR0aW5nT3BlcmF0aW'
...
const CampaignExtensionSettingOperation$json = {
  ...
  '2': [
    ...
    {'1': 'create', '3': 1, '4': 1, '5': 11, '6': '.google.ads.googleads.v17.resources.CampaignExtensionSetting', '9': 0, '10': 'create'},
    {'1': 'update', '3': 2, '4': 1, '5': 11, '6': '.google.ads.googleads.v17.resources.CampaignExtensionSetting', '9': 0, '10': 'update'},
...
final $typed_data.Uint8List campaignExtensionSettingOperationDescriptor = $convert.base64Decode(
    ...
    'CzI8Lmdvb2dsZS5hZHMuZ29vZ2xlYWRzLnYxNy5yZXNvdXJjZXMuQ2FtcGFpZ25FeHRlbnNpb2'
    '5TZXR0aW5nSABSBmNyZWF0ZRJWCgZ1cGRhdGUYAiABKAsyPC5nb29nbGUuYWRzLmdvb2dsZWFk'
    'cy52MTcucmVzb3VyY2VzLkNhbXBhaWduRXh0ZW5zaW9uU2V0dGluZ0gAUgZ1cGRhdGUSUAoGcm'
...
const MutateCampaignExtensionSettingsResponse$json = {
  ...
  '2': [
    ...
    {'1': 'results', '3': 2, '4': 3, '5': 11, '6': '.google.ads.googleads.v17.services.MutateCampaignExtensionSettingResult', '10': 'results'},
  ],
};
...
final $typed_data.Uint8List mutateCampaignExtensionSettingsResponseDescriptor = $convert.base64Decode(
    ...
    'b3ISYQoHcmVzdWx0cxgCIAMoCzJHLmdvb2dsZS5hZHMuZ29vZ2xlYWRzLnYxNy5zZXJ2aWNlcy'
...
const MutateCampaignExtensionSettingResult$json = {
  ...
  '2': [
    ...
    {'1': 'campaign_extension_setting', '3': 2, '4': 1, '5': 11, '6': '.google.ads.googleads.v17.resources.CampaignExtensionSetting', '10': 'campaignExtensionSetting'},
  ],
};
...
final $typed_data.Uint8List mutateCampaignExtensionSettingResultDescriptor = $convert.base64Decode(
    ...
    'syPC5nb29nbGUuYWRzLmdvb2dsZWFkcy52MTcucmVzb3VyY2VzLkNhbXBhaWduRXh0ZW5zaW9u'
