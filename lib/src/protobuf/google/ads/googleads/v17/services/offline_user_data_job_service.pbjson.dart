...
const CreateOfflineUserDataJobRequest$json = {
  ...
  '2': [
    ...
    {'1': 'job', '3': 2, '4': 1, '5': 11, '6': '.google.ads.googleads.v17.resources.OfflineUserDataJob', '8': {}, '10': 'job'},
...
final $typed_data.Uint8List createOfflineUserDataJobRequestDescriptor = $convert.base64Decode(
    ...
    'PgQQJSCmN1c3RvbWVySWQSTQoDam9iGAIgASgLMjYuZ29vZ2xlLmFkcy5nb29nbGVhZHMudjE3'
...
const AddOfflineUserDataJobOperationsRequest$json = {
  ...
  '2': [
    ...
    {'1': 'operations', '3': 3, '4': 3, '5': 11, '6': '.google.ads.googleads.v17.services.OfflineUserDataJobOperation', '8': {}, '10': 'operations'},
...
final $typed_data.Uint8List addOfflineUserDataJobOperationsRequestDescriptor = $convert.base64Decode(
    ...
    'MudjE3LnNlcnZpY2VzLk9mZmxpbmVVc2VyRGF0YUpvYk9wZXJhdGlvbkID4EECUgpvcGVyYXRp'
...
final $typed_data.Uint8List offlineUserDataJobOperationDescriptor = $convert.base64Decode(
    ...
    'Fkcy5nb29nbGVhZHMudjE3LmNvbW1vbi5Vc2VyRGF0YUgAUgZjcmVhdGUSQwoGcmVtb3ZlGAIg'
    'ASgLMikuZ29vZ2xlLmFkcy5nb29nbGVhZHMudjE3LmNvbW1vbi5Vc2VyRGF0YUgAUgZyZW1vdm'
