...
class MutateCustomInterestsRequest extends $pb.GeneratedMessage {
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(_omitMessageNames ? '' : 'MutateCustomInterestsRequest', package: const $pb.PackageName(_omitMessageNames ? '' : 'google.ads.googleads.v17.services'), createEmptyInstance: create)
...
class CustomInterestOperation extends $pb.GeneratedMessage {
  factory CustomInterestOperation({
    $3892.CustomInterest? create_1,
    $3892.CustomInterest? update,
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(_omitMessageNames ? '' : 'CustomInterestOperation', package: const $pb.PackageName(_omitMessageNames ? '' : 'google.ads.googleads.v17.services'), createEmptyInstance: create)
    ..oo(0, [1, 2])
    ..aOM<$3892.CustomInterest>(1, _omitFieldNames ? '' : 'create', subBuilder: $3892.CustomInterest.create)
    ..aOM<$3892.CustomInterest>(2, _omitFieldNames ? '' : 'update', subBuilder: $3892.CustomInterest.create)
  ...
  /// interest.
  @$pb.TagNumber(1)
  $3892.CustomInterest get create_1 => $_getN(0);
  @$pb.TagNumber(1)
  set create_1($3892.CustomInterest v) { setField(1, v); }
  @$pb.TagNumber(1)
  $core.bool hasCreate_1() => $_has(0);
  @$pb.TagNumber(1)
  void clearCreate_1() => clearField(1);
  @$pb.TagNumber(1)
  $3892.CustomInterest ensureCreate_1() => $_ensure(0);

  /// Update operation: The custom interest is expected to have a valid
  /// resource name.
  @$pb.TagNumber(2)
  $3892.CustomInterest get update => $_getN(1);
  @$pb.TagNumber(2)
  set update($3892.CustomInterest v) { setField(2, v); }
  @$pb.TagNumber(2)
  $core.bool hasUpdate() => $_has(1);
  @$pb.TagNumber(2)
  void clearUpdate() => clearField(2);
  @$pb.TagNumber(2)
  $3892.CustomInterest ensureUpdate() => $_ensure(1);
...
class MutateCustomInterestsResponse extends $pb.GeneratedMessage {
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(_omitMessageNames ? '' : 'MutateCustomInterestsResponse', package: const $pb.PackageName(_omitMessageNames ? '' : 'google.ads.googleads.v17.services'), createEmptyInstance: create)
...
class MutateCustomInterestResult extends $pb.GeneratedMessage {
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(_omitMessageNames ? '' : 'MutateCustomInterestResult', package: const $pb.PackageName(_omitMessageNames ? '' : 'google.ads.googleads.v17.services'), createEmptyInstance: create)
