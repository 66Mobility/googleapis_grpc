...
const MutateCampaignsRequest$json = {
  ...
  '2': [
    ...
    {'1': 'operations', '3': 2, '4': 3, '5': 11, '6': '.google.ads.googleads.v17.services.CampaignOperation', '8': {}, '10': 'operations'},
...
const CampaignOperation$json = {
  ...
  '2': [
    ...
    {'1': 'create', '3': 1, '4': 1, '5': 11, '6': '.google.ads.googleads.v17.resources.Campaign', '9': 0, '10': 'create'},
    {'1': 'update', '3': 2, '4': 1, '5': 11, '6': '.google.ads.googleads.v17.resources.Campaign', '9': 0, '10': 'update'},
...
final $typed_data.Uint8List campaignOperationDescriptor = $convert.base64Decode(
    ...
    'b29nbGVhZHMudjE3LnJlc291cmNlcy5DYW1wYWlnbkgAUgZjcmVhdGUSRgoGdXBkYXRlGAIgAS'
    'gLMiwuZ29vZ2xlLmFkcy5nb29nbGVhZHMudjE3LnJlc291cmNlcy5DYW1wYWlnbkgAUgZ1cGRh'
...
const MutateCampaignsResponse$json = {
  ...
  '2': [
    ...
    {'1': 'results', '3': 2, '4': 3, '5': 11, '6': '.google.ads.googleads.v17.services.MutateCampaignResult', '10': 'results'},
  ],
};
...
final $typed_data.Uint8List mutateCampaignsResponseDescriptor = $convert.base64Decode(
    ...
    'AygLMjcuZ29vZ2xlLmFkcy5nb29nbGVhZHMudjE3LnNlcnZpY2VzLk11dGF0ZUNhbXBhaWduUm'
    'VzdWx0UgdyZXN1bHRz');
...
final $typed_data.Uint8List mutateCampaignResultDescriptor = $convert.base64Decode(
    ...
    'GAIgASgLMiwuZ29vZ2xlLmFkcy5nb29nbGVhZHMudjE3LnJlc291cmNlcy5DYW1wYWlnblIIY2'
    'FtcGFpZ24=');
