...
const MutateAdGroupFeedsRequest$json = {
  ...
  '2': [
    ...
    {'1': 'operations', '3': 2, '4': 3, '5': 11, '6': '.google.ads.googleads.v17.services.AdGroupFeedOperation', '8': {}, '10': 'operations'},
...
final $typed_data.Uint8List mutateAdGroupFeedsRequestDescriptor = $convert.base64Decode(
    ...
    'Ny5zZXJ2aWNlcy5BZEdyb3VwRmVlZE9wZXJhdGlvbkID4EECUgpvcGVyYXRpb25zEicKD3Bhcn'
    ...
    '5hZHMuZ29vZ2xlYWRzLnYxNy5lbnVtcy5SZXNwb25zZUNvbnRlbnRUeXBlRW51bS5SZXNwb25z'
...
const AdGroupFeedOperation$json = {
  ...
  '2': [
    ...
    {'1': 'create', '3': 1, '4': 1, '5': 11, '6': '.google.ads.googleads.v17.resources.AdGroupFeed', '9': 0, '10': 'create'},
    {'1': 'update', '3': 2, '4': 1, '5': 11, '6': '.google.ads.googleads.v17.resources.AdGroupFeed', '9': 0, '10': 'update'},
...
final $typed_data.Uint8List adGroupFeedOperationDescriptor = $convert.base64Decode(
    ...
    'cy5nb29nbGVhZHMudjE3LnJlc291cmNlcy5BZEdyb3VwRmVlZEgAUgZjcmVhdGUSSQoGdXBkYX'
    'RlGAIgASgLMi8uZ29vZ2xlLmFkcy5nb29nbGVhZHMudjE3LnJlc291cmNlcy5BZEdyb3VwRmVl'
...
const MutateAdGroupFeedsResponse$json = {
  ...
  '2': [
    ...
    {'1': 'results', '3': 2, '4': 3, '5': 11, '6': '.google.ads.googleads.v17.services.MutateAdGroupFeedResult', '10': 'results'},
  ],
};
...
final $typed_data.Uint8List mutateAdGroupFeedsResponseDescriptor = $convert.base64Decode(
    ...
    'GAIgAygLMjouZ29vZ2xlLmFkcy5nb29nbGVhZHMudjE3LnNlcnZpY2VzLk11dGF0ZUFkR3JvdX'
...
const MutateAdGroupFeedResult$json = {
  ...
  '2': [
    ...
    {'1': 'ad_group_feed', '3': 2, '4': 1, '5': 11, '6': '.google.ads.googleads.v17.resources.AdGroupFeed', '10': 'adGroupFeed'},
  ],
};
...
final $typed_data.Uint8List mutateAdGroupFeedResultDescriptor = $convert.base64Decode(
    ...
    'X2dyb3VwX2ZlZWQYAiABKAsyLy5nb29nbGUuYWRzLmdvb2dsZWFkcy52MTcucmVzb3VyY2VzLk'
