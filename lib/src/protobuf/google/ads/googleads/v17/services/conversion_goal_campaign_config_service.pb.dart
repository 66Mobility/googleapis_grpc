...
class MutateConversionGoalCampaignConfigsRequest extends $pb.GeneratedMessage {
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(_omitMessageNames ? '' : 'MutateConversionGoalCampaignConfigsRequest', package: const $pb.PackageName(_omitMessageNames ? '' : 'google.ads.googleads.v17.services'), createEmptyInstance: create)
...
class ConversionGoalCampaignConfigOperation extends $pb.GeneratedMessage {
  factory ConversionGoalCampaignConfigOperation({
    $3823.ConversionGoalCampaignConfig? update,
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(_omitMessageNames ? '' : 'ConversionGoalCampaignConfigOperation', package: const $pb.PackageName(_omitMessageNames ? '' : 'google.ads.googleads.v17.services'), createEmptyInstance: create)
    ..oo(0, [1])
    ..aOM<$3823.ConversionGoalCampaignConfig>(1, _omitFieldNames ? '' : 'update', subBuilder: $3823.ConversionGoalCampaignConfig.create)
  ...
  @$pb.TagNumber(1)
  $3823.ConversionGoalCampaignConfig get update => $_getN(0);
  @$pb.TagNumber(1)
  set update($3823.ConversionGoalCampaignConfig v) { setField(1, v); }
  @$pb.TagNumber(1)
  $core.bool hasUpdate() => $_has(0);
  @$pb.TagNumber(1)
  void clearUpdate() => clearField(1);
  @$pb.TagNumber(1)
  $3823.ConversionGoalCampaignConfig ensureUpdate() => $_ensure(0);
...
class MutateConversionGoalCampaignConfigsResponse extends $pb.GeneratedMessage {
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(_omitMessageNames ? '' : 'MutateConversionGoalCampaignConfigsResponse', package: const $pb.PackageName(_omitMessageNames ? '' : 'google.ads.googleads.v17.services'), createEmptyInstance: create)
...
class MutateConversionGoalCampaignConfigResult extends $pb.GeneratedMessage {
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(_omitMessageNames ? '' : 'MutateConversionGoalCampaignConfigResult', package: const $pb.PackageName(_omitMessageNames ? '' : 'google.ads.googleads.v17.services'), createEmptyInstance: create)
    ..aOS(1, _omitFieldNames ? '' : 'resourceName')
    ..aOM<$3823.ConversionGoalCampaignConfig>(2, _omitFieldNames ? '' : 'conversionGoalCampaignConfig', subBuilder: $3823.ConversionGoalCampaignConfig.create)
    ..hasRequiredFields = false
  ;
  ...
  /// to "MUTABLE_RESOURCE".
  @$pb.TagNumber(2)
  $3823.ConversionGoalCampaignConfig get conversionGoalCampaignConfig => $_getN(1);
  @$pb.TagNumber(2)
  set conversionGoalCampaignConfig($3823.ConversionGoalCampaignConfig v) { setField(2, v); }
  @$pb.TagNumber(2)
  $core.bool hasConversionGoalCampaignConfig() => $_has(1);
  @$pb.TagNumber(2)
  void clearConversionGoalCampaignConfig() => clearField(2);
  @$pb.TagNumber(2)
  $3823.ConversionGoalCampaignConfig ensureConversionGoalCampaignConfig() => $_ensure(1);
}
