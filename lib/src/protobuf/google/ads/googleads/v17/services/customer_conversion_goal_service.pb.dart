...
class CustomerConversionGoalOperation extends $pb.GeneratedMessage {
  factory CustomerConversionGoalOperation({
    $3828.CustomerConversionGoal? update,
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(_omitMessageNames ? '' : 'CustomerConversionGoalOperation', package: const $pb.PackageName(_omitMessageNames ? '' : 'google.ads.googleads.v17.services'), createEmptyInstance: create)
    ..oo(0, [1])
    ..aOM<$3828.CustomerConversionGoal>(1, _omitFieldNames ? '' : 'update', subBuilder: $3828.CustomerConversionGoal.create)
  ...
  /// valid resource name.
  @$pb.TagNumber(1)
  $3828.CustomerConversionGoal get update => $_getN(0);
  @$pb.TagNumber(1)
  set update($3828.CustomerConversionGoal v) { setField(1, v); }
  @$pb.TagNumber(1)
  $core.bool hasUpdate() => $_has(0);
  @$pb.TagNumber(1)
  void clearUpdate() => clearField(1);
  @$pb.TagNumber(1)
  $3828.CustomerConversionGoal ensureUpdate() => $_ensure(0);
