...
const MutateBiddingStrategiesRequest$json = {
  ...
  '2': [
    ...
    {'1': 'operations', '3': 2, '4': 3, '5': 11, '6': '.google.ads.googleads.v17.services.BiddingStrategyOperation', '8': {}, '10': 'operations'},
...
final $typed_data.Uint8List mutateBiddingStrategiesRequestDescriptor = $convert.base64Decode(
    ...
    'ZHMudjE3LnNlcnZpY2VzLkJpZGRpbmdTdHJhdGVneU9wZXJhdGlvbkID4EECUgpvcGVyYXRpb2'
    ...
    'JLLmdvb2dsZS5hZHMuZ29vZ2xlYWRzLnYxNy5lbnVtcy5SZXNwb25zZUNvbnRlbnRUeXBlRW51'
...
const BiddingStrategyOperation$json = {
  ...
  '2': [
    ...
    {'1': 'create', '3': 1, '4': 1, '5': 11, '6': '.google.ads.googleads.v17.resources.BiddingStrategy', '9': 0, '10': 'create'},
    {'1': 'update', '3': 2, '4': 1, '5': 11, '6': '.google.ads.googleads.v17.resources.BiddingStrategy', '9': 0, '10': 'update'},
...
final $typed_data.Uint8List biddingStrategyOperationDescriptor = $convert.base64Decode(
    ...
    'ZS5hZHMuZ29vZ2xlYWRzLnYxNy5yZXNvdXJjZXMuQmlkZGluZ1N0cmF0ZWd5SABSBmNyZWF0ZR'
    'JNCgZ1cGRhdGUYAiABKAsyMy5nb29nbGUuYWRzLmdvb2dsZWFkcy52MTcucmVzb3VyY2VzLkJp'
...
const MutateBiddingStrategiesResponse$json = {
  ...
  '2': [
    ...
    {'1': 'results', '3': 2, '4': 3, '5': 11, '6': '.google.ads.googleads.v17.services.MutateBiddingStrategyResult', '10': 'results'},
  ],
};
...
final $typed_data.Uint8List mutateBiddingStrategiesResponseDescriptor = $convert.base64Decode(
    ...
    'c3VsdHMYAiADKAsyPi5nb29nbGUuYWRzLmdvb2dsZWFkcy52MTcuc2VydmljZXMuTXV0YXRlQm'
...
const MutateBiddingStrategyResult$json = {
  ...
  '2': [
    ...
    {'1': 'bidding_strategy', '3': 2, '4': 1, '5': 11, '6': '.google.ads.googleads.v17.resources.BiddingStrategy', '10': 'biddingStrategy'},
  ],
};
...
final $typed_data.Uint8List mutateBiddingStrategyResultDescriptor = $convert.base64Decode(
    ...
    'bWUSXgoQYmlkZGluZ19zdHJhdGVneRgCIAEoCzIzLmdvb2dsZS5hZHMuZ29vZ2xlYWRzLnYxNy'
