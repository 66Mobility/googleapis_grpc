...
const MutateFeedItemSetsRequest$json = {
  ...
  '2': [
    ...
    {'1': 'operations', '3': 2, '4': 3, '5': 11, '6': '.google.ads.googleads.v17.services.FeedItemSetOperation', '8': {}, '10': 'operations'},
...
final $typed_data.Uint8List mutateFeedItemSetsRequestDescriptor = $convert.base64Decode(
    ...
    'Ny5zZXJ2aWNlcy5GZWVkSXRlbVNldE9wZXJhdGlvbkID4EECUgpvcGVyYXRpb25zEicKD3Bhcn'
...
const FeedItemSetOperation$json = {
  ...
  '2': [
    ...
    {'1': 'create', '3': 1, '4': 1, '5': 11, '6': '.google.ads.googleads.v17.resources.FeedItemSet', '9': 0, '10': 'create'},
    {'1': 'update', '3': 2, '4': 1, '5': 11, '6': '.google.ads.googleads.v17.resources.FeedItemSet', '9': 0, '10': 'update'},
...
final $typed_data.Uint8List feedItemSetOperationDescriptor = $convert.base64Decode(
    ...
    'cy5nb29nbGVhZHMudjE3LnJlc291cmNlcy5GZWVkSXRlbVNldEgAUgZjcmVhdGUSSQoGdXBkYX'
    'RlGAIgASgLMi8uZ29vZ2xlLmFkcy5nb29nbGVhZHMudjE3LnJlc291cmNlcy5GZWVkSXRlbVNl'
...
const MutateFeedItemSetsResponse$json = {
  ...
  '2': [
    {'1': 'results', '3': 1, '4': 3, '5': 11, '6': '.google.ads.googleads.v17.services.MutateFeedItemSetResult', '10': 'results'},
...
final $typed_data.Uint8List mutateFeedItemSetsResponseDescriptor = $convert.base64Decode(
    ...
    'Fkcy5nb29nbGVhZHMudjE3LnNlcnZpY2VzLk11dGF0ZUZlZWRJdGVtU2V0UmVzdWx0UgdyZXN1'
