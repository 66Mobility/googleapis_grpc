...
const MutateCampaignCustomizersRequest$json = {
  ...
  '2': [
    ...
    {'1': 'operations', '3': 2, '4': 3, '5': 11, '6': '.google.ads.googleads.v17.services.CampaignCustomizerOperation', '8': {}, '10': 'operations'},
...
final $typed_data.Uint8List mutateCampaignCustomizersRequestDescriptor = $convert.base64Decode(
    ...
    'ZWFkcy52MTcuc2VydmljZXMuQ2FtcGFpZ25DdXN0b21pemVyT3BlcmF0aW9uQgPgQQJSCm9wZX'
...
const CampaignCustomizerOperation$json = {
  ...
  '2': [
    {'1': 'create', '3': 1, '4': 1, '5': 11, '6': '.google.ads.googleads.v17.resources.CampaignCustomizer', '9': 0, '10': 'create'},
...
final $typed_data.Uint8List campaignCustomizerOperationDescriptor = $convert.base64Decode(
    ...
    'Fkcy5nb29nbGVhZHMudjE3LnJlc291cmNlcy5DYW1wYWlnbkN1c3RvbWl6ZXJIAFIGY3JlYXRl'
...
const MutateCampaignCustomizersResponse$json = {
  ...
  '2': [
    {'1': 'results', '3': 1, '4': 3, '5': 11, '6': '.google.ads.googleads.v17.services.MutateCampaignCustomizerResult', '10': 'results'},
...
final $typed_data.Uint8List mutateCampaignCustomizersResponseDescriptor = $convert.base64Decode(
    ...
    'dvb2dsZS5hZHMuZ29vZ2xlYWRzLnYxNy5zZXJ2aWNlcy5NdXRhdGVDYW1wYWlnbkN1c3RvbWl6'
...
const MutateCampaignCustomizerResult$json = {
  ...
  '2': [
    ...
    {'1': 'campaign_customizer', '3': 2, '4': 1, '5': 11, '6': '.google.ads.googleads.v17.resources.CampaignCustomizer', '10': 'campaignCustomizer'},
  ],
};
...
final $typed_data.Uint8List mutateCampaignCustomizerResultDescriptor = $convert.base64Decode(
    ...
    'xlYWRzLnYxNy5yZXNvdXJjZXMuQ2FtcGFpZ25DdXN0b21pemVyUhJjYW1wYWlnbkN1c3RvbWl6'
    'ZXI=');
