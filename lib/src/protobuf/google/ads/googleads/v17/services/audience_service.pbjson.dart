...
const MutateAudiencesRequest$json = {
  ...
  '2': [
    ...
    {'1': 'operations', '3': 2, '4': 3, '5': 11, '6': '.google.ads.googleads.v17.services.AudienceOperation', '8': {}, '10': 'operations'},
...
const MutateAudiencesResponse$json = {
  ...
  '2': [
    {'1': 'results', '3': 1, '4': 3, '5': 11, '6': '.google.ads.googleads.v17.services.MutateAudienceResult', '10': 'results'},
...
final $typed_data.Uint8List mutateAudiencesResponseDescriptor = $convert.base64Decode(
    ...
    '5nb29nbGVhZHMudjE3LnNlcnZpY2VzLk11dGF0ZUF1ZGllbmNlUmVzdWx0UgdyZXN1bHRzEkYK'
...
const AudienceOperation$json = {
  ...
  '2': [
    ...
    {'1': 'create', '3': 1, '4': 1, '5': 11, '6': '.google.ads.googleads.v17.resources.Audience', '9': 0, '10': 'create'},
    {'1': 'update', '3': 2, '4': 1, '5': 11, '6': '.google.ads.googleads.v17.resources.Audience', '9': 0, '10': 'update'},
  ],
  '8': [
    {'1': 'operation'},
  ],
...
final $typed_data.Uint8List audienceOperationDescriptor = $convert.base64Decode(
    ...
    'b29nbGVhZHMudjE3LnJlc291cmNlcy5BdWRpZW5jZUgAUgZjcmVhdGUSRgoGdXBkYXRlGAIgAS'
    'gLMiwuZ29vZ2xlLmFkcy5nb29nbGVhZHMudjE3LnJlc291cmNlcy5BdWRpZW5jZUgAUgZ1cGRh'
...
const MutateAudienceResult$json = {
  ...
  '2': [
    ...
    {'1': 'audience', '3': 2, '4': 1, '5': 11, '6': '.google.ads.googleads.v17.resources.Audience', '10': 'audience'},
  ],
};
...
final $typed_data.Uint8List mutateAudienceResultDescriptor = $convert.base64Decode(
    ...
    'GAIgASgLMiwuZ29vZ2xlLmFkcy5nb29nbGVhZHMudjE3LnJlc291cmNlcy5BdWRpZW5jZVIIYX'
    'VkaWVuY2U=');
