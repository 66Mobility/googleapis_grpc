...
const MutateAdGroupCriteriaRequest$json = {
  ...
  '2': [
    ...
    {'1': 'operations', '3': 2, '4': 3, '5': 11, '6': '.google.ads.googleads.v17.services.AdGroupCriterionOperation', '8': {}, '10': 'operations'},
...
final $typed_data.Uint8List mutateAdGroupCriteriaRequestDescriptor = $convert.base64Decode(
    ...
    'LnYxNy5zZXJ2aWNlcy5BZEdyb3VwQ3JpdGVyaW9uT3BlcmF0aW9uQgPgQQJSCm9wZXJhdGlvbn'
    ...
    'suZ29vZ2xlLmFkcy5nb29nbGVhZHMudjE3LmVudW1zLlJlc3BvbnNlQ29udGVudFR5cGVFbnVt'
...
const AdGroupCriterionOperation$json = {
  ...
  '2': [
    ...
    {'1': 'exempt_policy_violation_keys', '3': 5, '4': 3, '5': 11, '6': '.google.ads.googleads.v17.common.PolicyViolationKey', '10': 'exemptPolicyViolationKeys'},
    {'1': 'create', '3': 1, '4': 1, '5': 11, '6': '.google.ads.googleads.v17.resources.AdGroupCriterion', '9': 0, '10': 'create'},
    {'1': 'update', '3': 2, '4': 1, '5': 11, '6': '.google.ads.googleads.v17.resources.AdGroupCriterion', '9': 0, '10': 'update'},
...
final $typed_data.Uint8List adGroupCriterionOperationDescriptor = $convert.base64Decode(
    ...
    'dGlvbl9rZXlzGAUgAygLMjMuZ29vZ2xlLmFkcy5nb29nbGVhZHMudjE3LmNvbW1vbi5Qb2xpY3'
    'lWaW9sYXRpb25LZXlSGWV4ZW1wdFBvbGljeVZpb2xhdGlvbktleXMSTgoGY3JlYXRlGAEgASgL'
    'MjQuZ29vZ2xlLmFkcy5nb29nbGVhZHMudjE3LnJlc291cmNlcy5BZEdyb3VwQ3JpdGVyaW9uSA'
    'BSBmNyZWF0ZRJOCgZ1cGRhdGUYAiABKAsyNC5nb29nbGUuYWRzLmdvb2dsZWFkcy52MTcucmVz'
...
const MutateAdGroupCriteriaResponse$json = {
  ...
  '2': [
    ...
    {'1': 'results', '3': 2, '4': 3, '5': 11, '6': '.google.ads.googleads.v17.services.MutateAdGroupCriterionResult', '10': 'results'},
  ],
};
...
final $typed_data.Uint8List mutateAdGroupCriteriaResponseDescriptor = $convert.base64Decode(
    ...
    'bHRzGAIgAygLMj8uZ29vZ2xlLmFkcy5nb29nbGVhZHMudjE3LnNlcnZpY2VzLk11dGF0ZUFkR3'
...
const MutateAdGroupCriterionResult$json = {
  ...
  '2': [
    ...
    {'1': 'ad_group_criterion', '3': 2, '4': 1, '5': 11, '6': '.google.ads.googleads.v17.resources.AdGroupCriterion', '10': 'adGroupCriterion'},
  ],
};
...
final $typed_data.Uint8List mutateAdGroupCriterionResultDescriptor = $convert.base64Decode(
    ...
    '52MTcucmVzb3VyY2VzLkFkR3JvdXBDcml0ZXJpb25SEGFkR3JvdXBDcml0ZXJpb24=');
