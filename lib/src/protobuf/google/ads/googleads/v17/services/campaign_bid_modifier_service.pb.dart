...
class MutateCampaignBidModifiersRequest extends $pb.GeneratedMessage {
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(_omitMessageNames ? '' : 'MutateCampaignBidModifiersRequest', package: const $pb.PackageName(_omitMessageNames ? '' : 'google.ads.googleads.v17.services'), createEmptyInstance: create)
...
class CampaignBidModifierOperation extends $pb.GeneratedMessage {
  factory CampaignBidModifierOperation({
    $3813.CampaignBidModifier? create_1,
    $3813.CampaignBidModifier? update,
    $core.String? remove,
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(_omitMessageNames ? '' : 'CampaignBidModifierOperation', package: const $pb.PackageName(_omitMessageNames ? '' : 'google.ads.googleads.v17.services'), createEmptyInstance: create)
    ..oo(0, [1, 2, 3])
    ..aOM<$3813.CampaignBidModifier>(1, _omitFieldNames ? '' : 'create', subBuilder: $3813.CampaignBidModifier.create)
    ..aOM<$3813.CampaignBidModifier>(2, _omitFieldNames ? '' : 'update', subBuilder: $3813.CampaignBidModifier.create)
  ...
  /// modifier.
  @$pb.TagNumber(1)
  $3813.CampaignBidModifier get create_1 => $_getN(0);
  @$pb.TagNumber(1)
  set create_1($3813.CampaignBidModifier v) { setField(1, v); }
  @$pb.TagNumber(1)
  $core.bool hasCreate_1() => $_has(0);
  @$pb.TagNumber(1)
  void clearCreate_1() => clearField(1);
  @$pb.TagNumber(1)
  $3813.CampaignBidModifier ensureCreate_1() => $_ensure(0);

  /// Update operation: The campaign bid modifier is expected to have a valid
  /// resource name.
  @$pb.TagNumber(2)
  $3813.CampaignBidModifier get update => $_getN(1);
  @$pb.TagNumber(2)
  set update($3813.CampaignBidModifier v) { setField(2, v); }
  @$pb.TagNumber(2)
  $core.bool hasUpdate() => $_has(1);
  @$pb.TagNumber(2)
  void clearUpdate() => clearField(2);
  @$pb.TagNumber(2)
  $3813.CampaignBidModifier ensureUpdate() => $_ensure(1);
...
class MutateCampaignBidModifiersResponse extends $pb.GeneratedMessage {
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(_omitMessageNames ? '' : 'MutateCampaignBidModifiersResponse', package: const $pb.PackageName(_omitMessageNames ? '' : 'google.ads.googleads.v17.services'), createEmptyInstance: create)
...
class MutateCampaignBidModifierResult extends $pb.GeneratedMessage {
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(_omitMessageNames ? '' : 'MutateCampaignBidModifierResult', package: const $pb.PackageName(_omitMessageNames ? '' : 'google.ads.googleads.v17.services'), createEmptyInstance: create)
    ..aOS(1, _omitFieldNames ? '' : 'resourceName')
    ..aOM<$3813.CampaignBidModifier>(2, _omitFieldNames ? '' : 'campaignBidModifier', subBuilder: $3813.CampaignBidModifier.create)
    ..hasRequiredFields = false
  ;
  ...
  /// "MUTABLE_RESOURCE".
  @$pb.TagNumber(2)
  $3813.CampaignBidModifier get campaignBidModifier => $_getN(1);
  @$pb.TagNumber(2)
  set campaignBidModifier($3813.CampaignBidModifier v) { setField(2, v); }
  @$pb.TagNumber(2)
  $core.bool hasCampaignBidModifier() => $_has(1);
  @$pb.TagNumber(2)
  void clearCampaignBidModifier() => clearField(2);
  @$pb.TagNumber(2)
  $3813.CampaignBidModifier ensureCampaignBidModifier() => $_ensure(1);
}
