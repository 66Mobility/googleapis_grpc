...
class CustomAudienceOperation extends $pb.GeneratedMessage {
  factory CustomAudienceOperation({
    $3915.CustomAudience? create_1,
    $3915.CustomAudience? update,
    $core.String? remove,
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(_omitMessageNames ? '' : 'CustomAudienceOperation', package: const $pb.PackageName(_omitMessageNames ? '' : 'google.ads.googleads.v17.services'), createEmptyInstance: create)
    ..oo(0, [1, 2, 3])
    ..aOM<$3915.CustomAudience>(1, _omitFieldNames ? '' : 'create', subBuilder: $3915.CustomAudience.create)
    ..aOM<$3915.CustomAudience>(2, _omitFieldNames ? '' : 'update', subBuilder: $3915.CustomAudience.create)
  ...
  /// audience.
  @$pb.TagNumber(1)
  $3915.CustomAudience get create_1 => $_getN(0);
  @$pb.TagNumber(1)
  set create_1($3915.CustomAudience v) { setField(1, v); }
  @$pb.TagNumber(1)
  $core.bool hasCreate_1() => $_has(0);
  @$pb.TagNumber(1)
  void clearCreate_1() => clearField(1);
  @$pb.TagNumber(1)
  $3915.CustomAudience ensureCreate_1() => $_ensure(0);

  /// Update operation: The custom audience is expected to have a valid
  /// resource name.
  @$pb.TagNumber(2)
  $3915.CustomAudience get update => $_getN(1);
  @$pb.TagNumber(2)
  set update($3915.CustomAudience v) { setField(2, v); }
  @$pb.TagNumber(2)
  $core.bool hasUpdate() => $_has(1);
  @$pb.TagNumber(2)
  void clearUpdate() => clearField(2);
  @$pb.TagNumber(2)
  $3915.CustomAudience ensureUpdate() => $_ensure(1);
