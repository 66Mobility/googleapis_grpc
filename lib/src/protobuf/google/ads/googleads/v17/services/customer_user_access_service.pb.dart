...
class CustomerUserAccessOperation extends $pb.GeneratedMessage {
  factory CustomerUserAccessOperation({
    $3913.CustomerUserAccess? update,
    $core.String? remove,
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(_omitMessageNames ? '' : 'CustomerUserAccessOperation', package: const $pb.PackageName(_omitMessageNames ? '' : 'google.ads.googleads.v17.services'), createEmptyInstance: create)
    ..oo(0, [1, 2])
    ..aOM<$3913.CustomerUserAccess>(1, _omitFieldNames ? '' : 'update', subBuilder: $3913.CustomerUserAccess.create)
  ...
  /// resource name.
  @$pb.TagNumber(1)
  $3913.CustomerUserAccess get update => $_getN(0);
  @$pb.TagNumber(1)
  set update($3913.CustomerUserAccess v) { setField(1, v); }
  @$pb.TagNumber(1)
  $core.bool hasUpdate() => $_has(0);
  @$pb.TagNumber(1)
  void clearUpdate() => clearField(1);
  @$pb.TagNumber(1)
  $3913.CustomerUserAccess ensureUpdate() => $_ensure(0);
