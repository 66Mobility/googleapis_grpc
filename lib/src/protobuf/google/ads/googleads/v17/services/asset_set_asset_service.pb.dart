...
class AssetSetAssetOperation extends $pb.GeneratedMessage {
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(_omitMessageNames ? '' : 'AssetSetAssetOperation', package: const $pb.PackageName(_omitMessageNames ? '' : 'google.ads.googleads.v17.services'), createEmptyInstance: create)
    ..oo(0, [1, 2])
    ..aOM<$3661.AssetSetAsset>(1, _omitFieldNames ? '' : 'create', subBuilder: $3661.AssetSetAsset.create)
  ...
  /// asset
  @$pb.TagNumber(1)
  $3661.AssetSetAsset get create_1 => $_getN(0);
  @$pb.TagNumber(1)
  set create_1($3661.AssetSetAsset v) { setField(1, v); }
  @$pb.TagNumber(1)
  $core.bool hasCreate_1() => $_has(0);
  @$pb.TagNumber(1)
  void clearCreate_1() => clearField(1);
  @$pb.TagNumber(1)
  $3661.AssetSetAsset ensureCreate_1() => $_ensure(0);
...
class MutateAssetSetAssetResult extends $pb.GeneratedMessage {
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(_omitMessageNames ? '' : 'MutateAssetSetAssetResult', package: const $pb.PackageName(_omitMessageNames ? '' : 'google.ads.googleads.v17.services'), createEmptyInstance: create)
    ...
    ..aOM<$3661.AssetSetAsset>(2, _omitFieldNames ? '' : 'assetSetAsset', subBuilder: $3661.AssetSetAsset.create)
    ..hasRequiredFields = false
  ;
  ...
  /// "MUTABLE_RESOURCE".
  @$pb.TagNumber(2)
  $3661.AssetSetAsset get assetSetAsset => $_getN(1);
  @$pb.TagNumber(2)
  set assetSetAsset($3661.AssetSetAsset v) { setField(2, v); }
  @$pb.TagNumber(2)
  $core.bool hasAssetSetAsset() => $_has(1);
  @$pb.TagNumber(2)
  void clearAssetSetAsset() => clearField(2);
  @$pb.TagNumber(2)
  $3661.AssetSetAsset ensureAssetSetAsset() => $_ensure(1);
}
