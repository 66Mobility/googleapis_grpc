...
class MutateFeedMappingsRequest extends $pb.GeneratedMessage {
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(_omitMessageNames ? '' : 'MutateFeedMappingsRequest', package: const $pb.PackageName(_omitMessageNames ? '' : 'google.ads.googleads.v17.services'), createEmptyInstance: create)
...
class FeedMappingOperation extends $pb.GeneratedMessage {
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(_omitMessageNames ? '' : 'FeedMappingOperation', package: const $pb.PackageName(_omitMessageNames ? '' : 'google.ads.googleads.v17.services'), createEmptyInstance: create)
    ..oo(0, [1, 3])
    ..aOM<$3841.FeedMapping>(1, _omitFieldNames ? '' : 'create', subBuilder: $3841.FeedMapping.create)
  ...
  @$pb.TagNumber(1)
  $3841.FeedMapping get create_1 => $_getN(0);
  @$pb.TagNumber(1)
  set create_1($3841.FeedMapping v) { setField(1, v); }
  @$pb.TagNumber(1)
  $core.bool hasCreate_1() => $_has(0);
  @$pb.TagNumber(1)
  void clearCreate_1() => clearField(1);
  @$pb.TagNumber(1)
  $3841.FeedMapping ensureCreate_1() => $_ensure(0);
...
class MutateFeedMappingsResponse extends $pb.GeneratedMessage {
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(_omitMessageNames ? '' : 'MutateFeedMappingsResponse', package: const $pb.PackageName(_omitMessageNames ? '' : 'google.ads.googleads.v17.services'), createEmptyInstance: create)
...
class MutateFeedMappingResult extends $pb.GeneratedMessage {
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(_omitMessageNames ? '' : 'MutateFeedMappingResult', package: const $pb.PackageName(_omitMessageNames ? '' : 'google.ads.googleads.v17.services'), createEmptyInstance: create)
    ..aOS(1, _omitFieldNames ? '' : 'resourceName')
    ..aOM<$3841.FeedMapping>(2, _omitFieldNames ? '' : 'feedMapping', subBuilder: $3841.FeedMapping.create)
    ..hasRequiredFields = false
  ;
  ...
  /// "MUTABLE_RESOURCE".
  @$pb.TagNumber(2)
  $3841.FeedMapping get feedMapping => $_getN(1);
  @$pb.TagNumber(2)
  set feedMapping($3841.FeedMapping v) { setField(2, v); }
  @$pb.TagNumber(2)
  $core.bool hasFeedMapping() => $_has(1);
  @$pb.TagNumber(2)
  void clearFeedMapping() => clearField(2);
  @$pb.TagNumber(2)
  $3841.FeedMapping ensureFeedMapping() => $_ensure(1);
}
