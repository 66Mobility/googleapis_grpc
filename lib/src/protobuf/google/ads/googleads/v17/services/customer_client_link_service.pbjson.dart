...
const MutateCustomerClientLinkRequest$json = {
  ...
  '2': [
    ...
    {'1': 'operation', '3': 2, '4': 1, '5': 11, '6': '.google.ads.googleads.v17.services.CustomerClientLinkOperation', '8': {}, '10': 'operation'},
...
final $typed_data.Uint8List mutateCustomerClientLinkRequestDescriptor = $convert.base64Decode(
    ...
    'ZHMudjE3LnNlcnZpY2VzLkN1c3RvbWVyQ2xpZW50TGlua09wZXJhdGlvbkID4EECUglvcGVyYX'
...
const CustomerClientLinkOperation$json = {
  ...
  '2': [
    ...
    {'1': 'create', '3': 1, '4': 1, '5': 11, '6': '.google.ads.googleads.v17.resources.CustomerClientLink', '9': 0, '10': 'create'},
    {'1': 'update', '3': 2, '4': 1, '5': 11, '6': '.google.ads.googleads.v17.resources.CustomerClientLink', '9': 0, '10': 'update'},
  ],
  '8': [
    {'1': 'operation'},
  ],
...
final $typed_data.Uint8List customerClientLinkOperationDescriptor = $convert.base64Decode(
    ...
    'b2dsZS5hZHMuZ29vZ2xlYWRzLnYxNy5yZXNvdXJjZXMuQ3VzdG9tZXJDbGllbnRMaW5rSABSBm'
...
const MutateCustomerClientLinkResponse$json = {
  ...
  '2': [
    {'1': 'result', '3': 1, '4': 1, '5': 11, '6': '.google.ads.googleads.v17.services.MutateCustomerClientLinkResult', '10': 'result'},
  ],
};
...
final $typed_data.Uint8List mutateCustomerClientLinkResponseDescriptor = $convert.base64Decode(
    ...
    '9nbGUuYWRzLmdvb2dsZWFkcy52MTcuc2VydmljZXMuTXV0YXRlQ3VzdG9tZXJDbGllbnRMaW5r'
    'UmVzdWx0UgZyZXN1bHQ=');
