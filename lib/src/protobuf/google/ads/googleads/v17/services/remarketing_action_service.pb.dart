...
class MutateRemarketingActionsRequest extends $pb.GeneratedMessage {
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(_omitMessageNames ? '' : 'MutateRemarketingActionsRequest', package: const $pb.PackageName(_omitMessageNames ? '' : 'google.ads.googleads.v17.services'), createEmptyInstance: create)
...
class RemarketingActionOperation extends $pb.GeneratedMessage {
  factory RemarketingActionOperation({
    $3850.RemarketingAction? create_1,
    $3850.RemarketingAction? update,
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(_omitMessageNames ? '' : 'RemarketingActionOperation', package: const $pb.PackageName(_omitMessageNames ? '' : 'google.ads.googleads.v17.services'), createEmptyInstance: create)
    ..oo(0, [1, 2])
    ..aOM<$3850.RemarketingAction>(1, _omitFieldNames ? '' : 'create', subBuilder: $3850.RemarketingAction.create)
    ..aOM<$3850.RemarketingAction>(2, _omitFieldNames ? '' : 'update', subBuilder: $3850.RemarketingAction.create)
  ...
  /// action.
  @$pb.TagNumber(1)
  $3850.RemarketingAction get create_1 => $_getN(0);
  @$pb.TagNumber(1)
  set create_1($3850.RemarketingAction v) { setField(1, v); }
  @$pb.TagNumber(1)
  $core.bool hasCreate_1() => $_has(0);
  @$pb.TagNumber(1)
  void clearCreate_1() => clearField(1);
  @$pb.TagNumber(1)
  $3850.RemarketingAction ensureCreate_1() => $_ensure(0);

  /// Update operation: The remarketing action is expected to have a valid
  /// resource name.
  @$pb.TagNumber(2)
  $3850.RemarketingAction get update => $_getN(1);
  @$pb.TagNumber(2)
  set update($3850.RemarketingAction v) { setField(2, v); }
  @$pb.TagNumber(2)
  $core.bool hasUpdate() => $_has(1);
  @$pb.TagNumber(2)
  void clearUpdate() => clearField(2);
  @$pb.TagNumber(2)
  $3850.RemarketingAction ensureUpdate() => $_ensure(1);
...
class MutateRemarketingActionsResponse extends $pb.GeneratedMessage {
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(_omitMessageNames ? '' : 'MutateRemarketingActionsResponse', package: const $pb.PackageName(_omitMessageNames ? '' : 'google.ads.googleads.v17.services'), createEmptyInstance: create)
...
class MutateRemarketingActionResult extends $pb.GeneratedMessage {
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(_omitMessageNames ? '' : 'MutateRemarketingActionResult', package: const $pb.PackageName(_omitMessageNames ? '' : 'google.ads.googleads.v17.services'), createEmptyInstance: create)
