...
class AdGroupBidModifierOperation extends $pb.GeneratedMessage {
  factory AdGroupBidModifierOperation({
    $3648.AdGroupBidModifier? create_1,
    $3648.AdGroupBidModifier? update,
    $core.String? remove,
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(_omitMessageNames ? '' : 'AdGroupBidModifierOperation', package: const $pb.PackageName(_omitMessageNames ? '' : 'google.ads.googleads.v17.services'), createEmptyInstance: create)
    ..oo(0, [1, 2, 3])
    ..aOM<$3648.AdGroupBidModifier>(1, _omitFieldNames ? '' : 'create', subBuilder: $3648.AdGroupBidModifier.create)
    ..aOM<$3648.AdGroupBidModifier>(2, _omitFieldNames ? '' : 'update', subBuilder: $3648.AdGroupBidModifier.create)
  ...
  /// modifier.
  @$pb.TagNumber(1)
  $3648.AdGroupBidModifier get create_1 => $_getN(0);
  @$pb.TagNumber(1)
  set create_1($3648.AdGroupBidModifier v) { setField(1, v); }
  @$pb.TagNumber(1)
  $core.bool hasCreate_1() => $_has(0);
  @$pb.TagNumber(1)
  void clearCreate_1() => clearField(1);
  @$pb.TagNumber(1)
  $3648.AdGroupBidModifier ensureCreate_1() => $_ensure(0);

  /// Update operation: The ad group bid modifier is expected to have a valid
  /// resource name.
  @$pb.TagNumber(2)
  $3648.AdGroupBidModifier get update => $_getN(1);
  @$pb.TagNumber(2)
  set update($3648.AdGroupBidModifier v) { setField(2, v); }
  @$pb.TagNumber(2)
  $core.bool hasUpdate() => $_has(1);
  @$pb.TagNumber(2)
  void clearUpdate() => clearField(2);
  @$pb.TagNumber(2)
  $3648.AdGroupBidModifier ensureUpdate() => $_ensure(1);
...
class MutateAdGroupBidModifierResult extends $pb.GeneratedMessage {
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(_omitMessageNames ? '' : 'MutateAdGroupBidModifierResult', package: const $pb.PackageName(_omitMessageNames ? '' : 'google.ads.googleads.v17.services'), createEmptyInstance: create)
    ...
    ..aOM<$3648.AdGroupBidModifier>(2, _omitFieldNames ? '' : 'adGroupBidModifier', subBuilder: $3648.AdGroupBidModifier.create)
    ..hasRequiredFields = false
  ;
  ...
  /// "MUTABLE_RESOURCE".
  @$pb.TagNumber(2)
  $3648.AdGroupBidModifier get adGroupBidModifier => $_getN(1);
  @$pb.TagNumber(2)
  set adGroupBidModifier($3648.AdGroupBidModifier v) { setField(2, v); }
  @$pb.TagNumber(2)
  $core.bool hasAdGroupBidModifier() => $_has(1);
  @$pb.TagNumber(2)
  void clearAdGroupBidModifier() => clearField(2);
  @$pb.TagNumber(2)
  $3648.AdGroupBidModifier ensureAdGroupBidModifier() => $_ensure(1);
}
