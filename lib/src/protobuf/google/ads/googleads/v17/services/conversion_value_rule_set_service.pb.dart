...
class MutateConversionValueRuleSetsRequest extends $pb.GeneratedMessage {
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(_omitMessageNames ? '' : 'MutateConversionValueRuleSetsRequest', package: const $pb.PackageName(_omitMessageNames ? '' : 'google.ads.googleads.v17.services'), createEmptyInstance: create)
...
class ConversionValueRuleSetOperation extends $pb.GeneratedMessage {
  factory ConversionValueRuleSetOperation({
    $3825.ConversionValueRuleSet? create_1,
    $3825.ConversionValueRuleSet? update,
    $core.String? remove,
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(_omitMessageNames ? '' : 'ConversionValueRuleSetOperation', package: const $pb.PackageName(_omitMessageNames ? '' : 'google.ads.googleads.v17.services'), createEmptyInstance: create)
    ..oo(0, [1, 2, 3])
    ..aOM<$3825.ConversionValueRuleSet>(1, _omitFieldNames ? '' : 'create', subBuilder: $3825.ConversionValueRuleSet.create)
    ..aOM<$3825.ConversionValueRuleSet>(2, _omitFieldNames ? '' : 'update', subBuilder: $3825.ConversionValueRuleSet.create)
  ...
  /// value rule set.
  @$pb.TagNumber(1)
  $3825.ConversionValueRuleSet get create_1 => $_getN(0);
  @$pb.TagNumber(1)
  set create_1($3825.ConversionValueRuleSet v) { setField(1, v); }
  @$pb.TagNumber(1)
  $core.bool hasCreate_1() => $_has(0);
  @$pb.TagNumber(1)
  void clearCreate_1() => clearField(1);
  @$pb.TagNumber(1)
  $3825.ConversionValueRuleSet ensureCreate_1() => $_ensure(0);

  /// Update operation: The conversion value rule set is expected to have a
  /// valid resource name.
  @$pb.TagNumber(2)
  $3825.ConversionValueRuleSet get update => $_getN(1);
  @$pb.TagNumber(2)
  set update($3825.ConversionValueRuleSet v) { setField(2, v); }
  @$pb.TagNumber(2)
  $core.bool hasUpdate() => $_has(1);
  @$pb.TagNumber(2)
  void clearUpdate() => clearField(2);
  @$pb.TagNumber(2)
  $3825.ConversionValueRuleSet ensureUpdate() => $_ensure(1);
...
class MutateConversionValueRuleSetsResponse extends $pb.GeneratedMessage {
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(_omitMessageNames ? '' : 'MutateConversionValueRuleSetsResponse', package: const $pb.PackageName(_omitMessageNames ? '' : 'google.ads.googleads.v17.services'), createEmptyInstance: create)
...
class MutateConversionValueRuleSetResult extends $pb.GeneratedMessage {
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(_omitMessageNames ? '' : 'MutateConversionValueRuleSetResult', package: const $pb.PackageName(_omitMessageNames ? '' : 'google.ads.googleads.v17.services'), createEmptyInstance: create)
    ..aOS(1, _omitFieldNames ? '' : 'resourceName')
    ..aOM<$3825.ConversionValueRuleSet>(2, _omitFieldNames ? '' : 'conversionValueRuleSet', subBuilder: $3825.ConversionValueRuleSet.create)
    ..hasRequiredFields = false
  ;
  ...
  /// to "MUTABLE_RESOURCE".
  @$pb.TagNumber(2)
  $3825.ConversionValueRuleSet get conversionValueRuleSet => $_getN(1);
  @$pb.TagNumber(2)
  set conversionValueRuleSet($3825.ConversionValueRuleSet v) { setField(2, v); }
  @$pb.TagNumber(2)
  $core.bool hasConversionValueRuleSet() => $_has(1);
  @$pb.TagNumber(2)
  void clearConversionValueRuleSet() => clearField(2);
  @$pb.TagNumber(2)
  $3825.ConversionValueRuleSet ensureConversionValueRuleSet() => $_ensure(1);
}
