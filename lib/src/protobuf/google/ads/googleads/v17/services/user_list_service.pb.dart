...
class MutateUserListsRequest extends $pb.GeneratedMessage {
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(_omitMessageNames ? '' : 'MutateUserListsRequest', package: const $pb.PackageName(_omitMessageNames ? '' : 'google.ads.googleads.v17.services'), createEmptyInstance: create)
...
class UserListOperation extends $pb.GeneratedMessage {
  factory UserListOperation({
    $3856.UserList? create_1,
    $3856.UserList? update,
    $core.String? remove,
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(_omitMessageNames ? '' : 'UserListOperation', package: const $pb.PackageName(_omitMessageNames ? '' : 'google.ads.googleads.v17.services'), createEmptyInstance: create)
    ..oo(0, [1, 2, 3])
    ..aOM<$3856.UserList>(1, _omitFieldNames ? '' : 'create', subBuilder: $3856.UserList.create)
    ..aOM<$3856.UserList>(2, _omitFieldNames ? '' : 'update', subBuilder: $3856.UserList.create)
  ...
  @$pb.TagNumber(1)
  $3856.UserList get create_1 => $_getN(0);
  @$pb.TagNumber(1)
  set create_1($3856.UserList v) { setField(1, v); }
  @$pb.TagNumber(1)
  $core.bool hasCreate_1() => $_has(0);
  @$pb.TagNumber(1)
  void clearCreate_1() => clearField(1);
  @$pb.TagNumber(1)
  $3856.UserList ensureCreate_1() => $_ensure(0);

  /// Update operation: The user list is expected to have a valid resource
  /// name.
  @$pb.TagNumber(2)
  $3856.UserList get update => $_getN(1);
  @$pb.TagNumber(2)
  set update($3856.UserList v) { setField(2, v); }
  @$pb.TagNumber(2)
  $core.bool hasUpdate() => $_has(1);
  @$pb.TagNumber(2)
  void clearUpdate() => clearField(2);
  @$pb.TagNumber(2)
  $3856.UserList ensureUpdate() => $_ensure(1);
...
class MutateUserListsResponse extends $pb.GeneratedMessage {
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(_omitMessageNames ? '' : 'MutateUserListsResponse', package: const $pb.PackageName(_omitMessageNames ? '' : 'google.ads.googleads.v17.services'), createEmptyInstance: create)
...
class MutateUserListResult extends $pb.GeneratedMessage {
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(_omitMessageNames ? '' : 'MutateUserListResult', package: const $pb.PackageName(_omitMessageNames ? '' : 'google.ads.googleads.v17.services'), createEmptyInstance: create)
