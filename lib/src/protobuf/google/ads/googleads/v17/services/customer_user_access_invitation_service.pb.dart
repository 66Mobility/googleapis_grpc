...
class CustomerUserAccessInvitationOperation extends $pb.GeneratedMessage {
  factory CustomerUserAccessInvitationOperation({
    $3917.CustomerUserAccessInvitation? create_1,
    $core.String? remove,
  }) {
    final $result = create();
    if (create_1 != null) {
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(_omitMessageNames ? '' : 'CustomerUserAccessInvitationOperation', package: const $pb.PackageName(_omitMessageNames ? '' : 'google.ads.googleads.v17.services'), createEmptyInstance: create)
    ..oo(0, [1, 2])
    ..aOM<$3917.CustomerUserAccessInvitation>(1, _omitFieldNames ? '' : 'create', subBuilder: $3917.CustomerUserAccessInvitation.create)
  ...
  /// invitation.
  @$pb.TagNumber(1)
  $3917.CustomerUserAccessInvitation get create_1 => $_getN(0);
  @$pb.TagNumber(1)
  set create_1($3917.CustomerUserAccessInvitation v) { setField(1, v); }
  @$pb.TagNumber(1)
  $core.bool hasCreate_1() => $_has(0);
  @$pb.TagNumber(1)
  void clearCreate_1() => clearField(1);
  @$pb.TagNumber(1)
  $3917.CustomerUserAccessInvitation ensureCreate_1() => $_ensure(0);
