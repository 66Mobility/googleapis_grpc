...
class CreateProductLinkRequest extends $pb.GeneratedMessage {
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(_omitMessageNames ? '' : 'CreateProductLinkRequest', package: const $pb.PackageName(_omitMessageNames ? '' : 'google.ads.googleads.v17.services'), createEmptyInstance: create)
    ..aOS(1, _omitFieldNames ? '' : 'customerId')
    ..aOM<$3931.ProductLink>(2, _omitFieldNames ? '' : 'productLink', subBuilder: $3931.ProductLink.create)
  ...
  @$pb.TagNumber(2)
  $3931.ProductLink get productLink => $_getN(1);
  @$pb.TagNumber(2)
  set productLink($3931.ProductLink v) { setField(2, v); }
  @$pb.TagNumber(2)
  $core.bool hasProductLink() => $_has(1);
  @$pb.TagNumber(2)
  void clearProductLink() => clearField(2);
  @$pb.TagNumber(2)
  $3931.ProductLink ensureProductLink() => $_ensure(1);
}
...
class CreateProductLinkResponse extends $pb.GeneratedMessage {
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(_omitMessageNames ? '' : 'CreateProductLinkResponse', package: const $pb.PackageName(_omitMessageNames ? '' : 'google.ads.googleads.v17.services'), createEmptyInstance: create)
...
class RemoveProductLinkRequest extends $pb.GeneratedMessage {
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(_omitMessageNames ? '' : 'RemoveProductLinkRequest', package: const $pb.PackageName(_omitMessageNames ? '' : 'google.ads.googleads.v17.services'), createEmptyInstance: create)
    ..aOS(1, _omitFieldNames ? '' : 'customerId')
...
class RemoveProductLinkResponse extends $pb.GeneratedMessage {
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(_omitMessageNames ? '' : 'RemoveProductLinkResponse', package: const $pb.PackageName(_omitMessageNames ? '' : 'google.ads.googleads.v17.services'), createEmptyInstance: create)
    ..aOS(1, _omitFieldNames ? '' : 'resourceName')
    ..hasRequiredFields = false
  ;
