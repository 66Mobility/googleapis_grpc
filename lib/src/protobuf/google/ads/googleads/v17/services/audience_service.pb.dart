...
class MutateAudiencesRequest extends $pb.GeneratedMessage {
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(_omitMessageNames ? '' : 'MutateAudiencesRequest', package: const $pb.PackageName(_omitMessageNames ? '' : 'google.ads.googleads.v17.services'), createEmptyInstance: create)
...
class MutateAudiencesResponse extends $pb.GeneratedMessage {
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(_omitMessageNames ? '' : 'MutateAudiencesResponse', package: const $pb.PackageName(_omitMessageNames ? '' : 'google.ads.googleads.v17.services'), createEmptyInstance: create)
...
class AudienceOperation extends $pb.GeneratedMessage {
  factory AudienceOperation({
    $3809.Audience? create_1,
    $3809.Audience? update,
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(_omitMessageNames ? '' : 'AudienceOperation', package: const $pb.PackageName(_omitMessageNames ? '' : 'google.ads.googleads.v17.services'), createEmptyInstance: create)
    ..oo(0, [1, 2])
    ..aOM<$3809.Audience>(1, _omitFieldNames ? '' : 'create', subBuilder: $3809.Audience.create)
    ..aOM<$3809.Audience>(2, _omitFieldNames ? '' : 'update', subBuilder: $3809.Audience.create)
  ...
  @$pb.TagNumber(1)
  $3809.Audience get create_1 => $_getN(0);
  @$pb.TagNumber(1)
  set create_1($3809.Audience v) { setField(1, v); }
  @$pb.TagNumber(1)
  $core.bool hasCreate_1() => $_has(0);
  @$pb.TagNumber(1)
  void clearCreate_1() => clearField(1);
  @$pb.TagNumber(1)
  $3809.Audience ensureCreate_1() => $_ensure(0);

  /// Update operation: The audience is expected to have a valid resource
  /// name.
  @$pb.TagNumber(2)
  $3809.Audience get update => $_getN(1);
  @$pb.TagNumber(2)
  set update($3809.Audience v) { setField(2, v); }
  @$pb.TagNumber(2)
  $core.bool hasUpdate() => $_has(1);
  @$pb.TagNumber(2)
  void clearUpdate() => clearField(2);
  @$pb.TagNumber(2)
  $3809.Audience ensureUpdate() => $_ensure(1);
...
class MutateAudienceResult extends $pb.GeneratedMessage {
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(_omitMessageNames ? '' : 'MutateAudienceResult', package: const $pb.PackageName(_omitMessageNames ? '' : 'google.ads.googleads.v17.services'), createEmptyInstance: create)
    ..aOS(1, _omitFieldNames ? '' : 'resourceName')
    ..aOM<$3809.Audience>(2, _omitFieldNames ? '' : 'audience', subBuilder: $3809.Audience.create)
    ..hasRequiredFields = false
  ;
  ...
  /// "MUTABLE_RESOURCE".
  @$pb.TagNumber(2)
  $3809.Audience get audience => $_getN(1);
  @$pb.TagNumber(2)
  set audience($3809.Audience v) { setField(2, v); }
  @$pb.TagNumber(2)
  $core.bool hasAudience() => $_has(1);
  @$pb.TagNumber(2)
  void clearAudience() => clearField(2);
  @$pb.TagNumber(2)
  $3809.Audience ensureAudience() => $_ensure(1);
}
