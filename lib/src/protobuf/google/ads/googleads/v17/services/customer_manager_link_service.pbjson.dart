...
const MutateCustomerManagerLinkRequest$json = {
  ...
  '2': [
    ...
    {'1': 'operations', '3': 2, '4': 3, '5': 11, '6': '.google.ads.googleads.v17.services.CustomerManagerLinkOperation', '8': {}, '10': 'operations'},
...
final $typed_data.Uint8List mutateCustomerManagerLinkRequestDescriptor = $convert.base64Decode(
    ...
    'ZWFkcy52MTcuc2VydmljZXMuQ3VzdG9tZXJNYW5hZ2VyTGlua09wZXJhdGlvbkID4EECUgpvcG'
...
const CustomerManagerLinkOperation$json = {
  ...
  '2': [
    ...
    {'1': 'update', '3': 2, '4': 1, '5': 11, '6': '.google.ads.googleads.v17.resources.CustomerManagerLink', '9': 0, '10': 'update'},
  ],
  '8': [
    {'1': 'operation'},
  ],
...
final $typed_data.Uint8List customerManagerLinkOperationDescriptor = $convert.base64Decode(
    ...
    'b29nbGUuYWRzLmdvb2dsZWFkcy52MTcucmVzb3VyY2VzLkN1c3RvbWVyTWFuYWdlckxpbmtIAF'
...
const MutateCustomerManagerLinkResponse$json = {
  ...
  '2': [
    {'1': 'results', '3': 1, '4': 3, '5': 11, '6': '.google.ads.googleads.v17.services.MutateCustomerManagerLinkResult', '10': 'results'},
  ],
};
...
final $typed_data.Uint8List mutateCustomerManagerLinkResponseDescriptor = $convert.base64Decode(
    ...
    'dvb2dsZS5hZHMuZ29vZ2xlYWRzLnYxNy5zZXJ2aWNlcy5NdXRhdGVDdXN0b21lck1hbmFnZXJM'
