...
class AdOperation extends $pb.GeneratedMessage {
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(_omitMessageNames ? '' : 'AdOperation', package: const $pb.PackageName(_omitMessageNames ? '' : 'google.ads.googleads.v17.services'), createEmptyInstance: create)
    ..oo(0, [1])
    ..aOM<$3544.Ad>(1, _omitFieldNames ? '' : 'update', subBuilder: $3544.Ad.create)
    ..aOM<$2209.FieldMask>(2, _omitFieldNames ? '' : 'updateMask', subBuilder: $2209.FieldMask.create)
    ..aOM<$3240.PolicyValidationParameter>(3, _omitFieldNames ? '' : 'policyValidationParameter', subBuilder: $3240.PolicyValidationParameter.create)
    ..hasRequiredFields = false
  ;
  ...
  @$pb.TagNumber(1)
  $3544.Ad get update => $_getN(0);
  @$pb.TagNumber(1)
  set update($3544.Ad v) { setField(1, v); }
  @$pb.TagNumber(1)
  $core.bool hasUpdate() => $_has(0);
  @$pb.TagNumber(1)
  void clearUpdate() => clearField(1);
  @$pb.TagNumber(1)
  $3544.Ad ensureUpdate() => $_ensure(0);
  ...
  @$pb.TagNumber(3)
  $3240.PolicyValidationParameter get policyValidationParameter => $_getN(2);
  @$pb.TagNumber(3)
  set policyValidationParameter($3240.PolicyValidationParameter v) { setField(3, v); }
  @$pb.TagNumber(3)
  $core.bool hasPolicyValidationParameter() => $_has(2);
  @$pb.TagNumber(3)
  void clearPolicyValidationParameter() => clearField(3);
  @$pb.TagNumber(3)
  $3240.PolicyValidationParameter ensurePolicyValidationParameter() => $_ensure(2);
}
...
class MutateAdResult extends $pb.GeneratedMessage {
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(_omitMessageNames ? '' : 'MutateAdResult', package: const $pb.PackageName(_omitMessageNames ? '' : 'google.ads.googleads.v17.services'), createEmptyInstance: create)
    ...
    ..aOM<$3544.Ad>(2, _omitFieldNames ? '' : 'ad', subBuilder: $3544.Ad.create)
    ..hasRequiredFields = false
  ;
  ...
  @$pb.TagNumber(2)
  $3544.Ad get ad => $_getN(1);
  @$pb.TagNumber(2)
  set ad($3544.Ad v) { setField(2, v); }
  @$pb.TagNumber(2)
  $core.bool hasAd() => $_has(1);
  @$pb.TagNumber(2)
  void clearAd() => clearField(2);
  @$pb.TagNumber(2)
  $3544.Ad ensureAd() => $_ensure(1);
}
