...
const MutateCustomizerAttributesRequest$json = {
  ...
  '2': [
    ...
    {'1': 'operations', '3': 2, '4': 3, '5': 11, '6': '.google.ads.googleads.v17.services.CustomizerAttributeOperation', '8': {}, '10': 'operations'},
...
final $typed_data.Uint8List mutateCustomizerAttributesRequestDescriptor = $convert.base64Decode(
    ...
    'bGVhZHMudjE3LnNlcnZpY2VzLkN1c3RvbWl6ZXJBdHRyaWJ1dGVPcGVyYXRpb25CA+BBAlIKb3'
...
const CustomizerAttributeOperation$json = {
  ...
  '2': [
    ...
    {'1': 'create', '3': 1, '4': 1, '5': 11, '6': '.google.ads.googleads.v17.resources.CustomizerAttribute', '9': 0, '10': 'create'},
...
final $typed_data.Uint8List customizerAttributeOperationDescriptor = $convert.base64Decode(
    ...
    'b29nbGUuYWRzLmdvb2dsZWFkcy52MTcucmVzb3VyY2VzLkN1c3RvbWl6ZXJBdHRyaWJ1dGVIAF'
...
const MutateCustomizerAttributesResponse$json = {
  ...
  '2': [
    {'1': 'results', '3': 1, '4': 3, '5': 11, '6': '.google.ads.googleads.v17.services.MutateCustomizerAttributeResult', '10': 'results'},
...
final $typed_data.Uint8List mutateCustomizerAttributesResponseDescriptor = $convert.base64Decode(
    ...
    '5nb29nbGUuYWRzLmdvb2dsZWFkcy52MTcuc2VydmljZXMuTXV0YXRlQ3VzdG9taXplckF0dHJp'
...
const MutateCustomizerAttributeResult$json = {
  ...
  '2': [
    ...
    {'1': 'customizer_attribute', '3': 2, '4': 1, '5': 11, '6': '.google.ads.googleads.v17.resources.CustomizerAttribute', '10': 'customizerAttribute'},
  ],
};
...
final $typed_data.Uint8List mutateCustomizerAttributeResultDescriptor = $convert.base64Decode(
    ...
    '9vZ2xlYWRzLnYxNy5yZXNvdXJjZXMuQ3VzdG9taXplckF0dHJpYnV0ZVITY3VzdG9taXplckF0'
    'dHJpYnV0ZQ==');
