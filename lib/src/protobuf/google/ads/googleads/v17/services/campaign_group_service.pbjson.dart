...
const MutateCampaignGroupsRequest$json = {
  ...
  '2': [
    ...
    {'1': 'operations', '3': 2, '4': 3, '5': 11, '6': '.google.ads.googleads.v17.services.CampaignGroupOperation', '8': {}, '10': 'operations'},
...
final $typed_data.Uint8List mutateCampaignGroupsRequestDescriptor = $convert.base64Decode(
    ...
    'djE3LnNlcnZpY2VzLkNhbXBhaWduR3JvdXBPcGVyYXRpb25CA+BBAlIKb3BlcmF0aW9ucxInCg'
...
const CampaignGroupOperation$json = {
  ...
  '2': [
    ...
    {'1': 'create', '3': 1, '4': 1, '5': 11, '6': '.google.ads.googleads.v17.resources.CampaignGroup', '9': 0, '10': 'create'},
    {'1': 'update', '3': 2, '4': 1, '5': 11, '6': '.google.ads.googleads.v17.resources.CampaignGroup', '9': 0, '10': 'update'},
...
final $typed_data.Uint8List campaignGroupOperationDescriptor = $convert.base64Decode(
    ...
    'YWRzLmdvb2dsZWFkcy52MTcucmVzb3VyY2VzLkNhbXBhaWduR3JvdXBIAFIGY3JlYXRlEksKBn'
...
const MutateCampaignGroupsResponse$json = {
  ...
  '2': [
    {'1': 'results', '3': 2, '4': 3, '5': 11, '6': '.google.ads.googleads.v17.services.MutateCampaignGroupResult', '10': 'results'},
...
final $typed_data.Uint8List mutateCampaignGroupsResponseDescriptor = $convert.base64Decode(
    ...
    'UuYWRzLmdvb2dsZWFkcy52MTcuc2VydmljZXMuTXV0YXRlQ2FtcGFpZ25Hcm91cFJlc3VsdFIH'
...
const MutateCampaignGroupResult$json = {
  ...
  '2': [
    ...
    {'1': 'campaign_group', '3': 2, '4': 1, '5': 11, '6': '.google.ads.googleads.v17.resources.CampaignGroup', '10': 'campaignGroup'},
  ],
};
...
final $typed_data.Uint8List mutateCampaignGroupResultDescriptor = $convert.base64Decode(
    ...
    'ZRJYCg5jYW1wYWlnbl9ncm91cBgCIAEoCzIxLmdvb2dsZS5hZHMuZ29vZ2xlYWRzLnYxNy5yZX'
