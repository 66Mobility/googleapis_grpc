...
import '../resources/customer_sk_ad_network_conversion_value_schema.pb.dart' as $3961;
...
class CustomerSkAdNetworkConversionValueSchemaOperation extends $pb.GeneratedMessage {
  factory CustomerSkAdNetworkConversionValueSchemaOperation({
    $3961.CustomerSkAdNetworkConversionValueSchema? update,
  }) {
    final $result = create();
    if (update != null) {
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(_omitMessageNames ? '' : 'CustomerSkAdNetworkConversionValueSchemaOperation', package: const $pb.PackageName(_omitMessageNames ? '' : 'google.ads.googleads.v17.services'), createEmptyInstance: create)
    ..aOM<$3961.CustomerSkAdNetworkConversionValueSchema>(1, _omitFieldNames ? '' : 'update', subBuilder: $3961.CustomerSkAdNetworkConversionValueSchema.create)
  ...
  @$pb.TagNumber(1)
  $3961.CustomerSkAdNetworkConversionValueSchema get update => $_getN(0);
  @$pb.TagNumber(1)
  set update($3961.CustomerSkAdNetworkConversionValueSchema v) { setField(1, v); }
  @$pb.TagNumber(1)
  $core.bool hasUpdate() => $_has(0);
  @$pb.TagNumber(1)
  void clearUpdate() => clearField(1);
  @$pb.TagNumber(1)
  $3961.CustomerSkAdNetworkConversionValueSchema ensureUpdate() => $_ensure(0);
}
...
class MutateCustomerSkAdNetworkConversionValueSchemaRequest extends $pb.GeneratedMessage {
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(_omitMessageNames ? '' : 'MutateCustomerSkAdNetworkConversionValueSchemaRequest', package: const $pb.PackageName(_omitMessageNames ? '' : 'google.ads.googleads.v17.services'), createEmptyInstance: create)
    ...
    ..aOB(4, _omitFieldNames ? '' : 'enableWarnings')
    ..hasRequiredFields = false
  ;
  ...
  /// operation.
  @$pb.TagNumber(4)
  $core.bool get enableWarnings => $_getBF(3);
  @$pb.TagNumber(4)
  set enableWarnings($core.bool v) { $_setBool(3, v); }
  @$pb.TagNumber(4)
  $core.bool hasEnableWarnings() => $_has(3);
  @$pb.TagNumber(4)
  void clearEnableWarnings() => clearField(4);
}
...
class MutateCustomerSkAdNetworkConversionValueSchemaResult extends $pb.GeneratedMessage {
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(_omitMessageNames ? '' : 'MutateCustomerSkAdNetworkConversionValueSchemaResult', package: const $pb.PackageName(_omitMessageNames ? '' : 'google.ads.googleads.v17.services'), createEmptyInstance: create)
...
class MutateCustomerSkAdNetworkConversionValueSchemaResponse extends $pb.GeneratedMessage {
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(_omitMessageNames ? '' : 'MutateCustomerSkAdNetworkConversionValueSchemaResponse', package: const $pb.PackageName(_omitMessageNames ? '' : 'google.ads.googleads.v17.services'), createEmptyInstance: create)
