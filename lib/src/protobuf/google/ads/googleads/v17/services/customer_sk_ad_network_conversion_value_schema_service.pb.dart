...
import '../resources/customer_sk_ad_network_conversion_value_schema.pb.dart' as $3960;
...
class CustomerSkAdNetworkConversionValueSchemaOperation extends $pb.GeneratedMessage {
  factory CustomerSkAdNetworkConversionValueSchemaOperation({
    $3960.CustomerSkAdNetworkConversionValueSchema? update,
  }) {
    final $result = create();
    if (update != null) {
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(_omitMessageNames ? '' : 'CustomerSkAdNetworkConversionValueSchemaOperation', package: const $pb.PackageName(_omitMessageNames ? '' : 'google.ads.googleads.v17.services'), createEmptyInstance: create)
    ..aOM<$3960.CustomerSkAdNetworkConversionValueSchema>(1, _omitFieldNames ? '' : 'update', subBuilder: $3960.CustomerSkAdNetworkConversionValueSchema.create)
  ...
  @$pb.TagNumber(1)
  $3960.CustomerSkAdNetworkConversionValueSchema get update => $_getN(0);
  @$pb.TagNumber(1)
  set update($3960.CustomerSkAdNetworkConversionValueSchema v) { setField(1, v); }
  @$pb.TagNumber(1)
  $core.bool hasUpdate() => $_has(0);
  @$pb.TagNumber(1)
  void clearUpdate() => clearField(1);
  @$pb.TagNumber(1)
  $3960.CustomerSkAdNetworkConversionValueSchema ensureUpdate() => $_ensure(0);
}
