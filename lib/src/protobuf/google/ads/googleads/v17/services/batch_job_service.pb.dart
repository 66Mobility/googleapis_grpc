...
class BatchJobOperation extends $pb.GeneratedMessage {
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(_omitMessageNames ? '' : 'BatchJobOperation', package: const $pb.PackageName(_omitMessageNames ? '' : 'google.ads.googleads.v17.services'), createEmptyInstance: create)
    ..oo(0, [1, 4])
    ..aOM<$3910.BatchJob>(1, _omitFieldNames ? '' : 'create', subBuilder: $3910.BatchJob.create)
  ...
  @$pb.TagNumber(1)
  $3910.BatchJob get create_1 => $_getN(0);
  @$pb.TagNumber(1)
  set create_1($3910.BatchJob v) { setField(1, v); }
  @$pb.TagNumber(1)
  $core.bool hasCreate_1() => $_has(0);
  @$pb.TagNumber(1)
  void clearCreate_1() => clearField(1);
  @$pb.TagNumber(1)
  $3910.BatchJob ensureCreate_1() => $_ensure(0);
