...
const MutateAdsRequest$json = {
  ...
  '2': [
    ...
    {'1': 'operations', '3': 2, '4': 3, '5': 11, '6': '.google.ads.googleads.v17.services.AdOperation', '8': {}, '10': 'operations'},
...
final $typed_data.Uint8List mutateAdsRequestDescriptor = $convert.base64Decode(
    ...
    'QSUwoKb3BlcmF0aW9ucxgCIAMoCzIuLmdvb2dsZS5hZHMuZ29vZ2xlYWRzLnYxNy5zZXJ2aWNl'
    ...
    'LmFkcy5nb29nbGVhZHMudjE3LmVudW1zLlJlc3BvbnNlQ29udGVudFR5cGVFbnVtLlJlc3Bvbn'
...
const AdOperation$json = {
  ...
  '2': [
    ...
    {'1': 'policy_validation_parameter', '3': 3, '4': 1, '5': 11, '6': '.google.ads.googleads.v17.common.PolicyValidationParameter', '10': 'policyValidationParameter'},
    {'1': 'update', '3': 1, '4': 1, '5': 11, '6': '.google.ads.googleads.v17.resources.Ad', '9': 0, '10': 'update'},
  ],
  '8': [
    {'1': 'operation'},
  ],
...
final $typed_data.Uint8List adOperationDescriptor = $convert.base64Decode(
    ...
    'MjouZ29vZ2xlLmFkcy5nb29nbGVhZHMudjE3LmNvbW1vbi5Qb2xpY3lWYWxpZGF0aW9uUGFyYW'
    '1ldGVyUhlwb2xpY3lWYWxpZGF0aW9uUGFyYW1ldGVyEkAKBnVwZGF0ZRgBIAEoCzImLmdvb2ds'
    'ZS5hZHMuZ29vZ2xlYWRzLnYxNy5yZXNvdXJjZXMuQWRIAFIGdXBkYXRlQgsKCW9wZXJhdGlvbg'
    '==');
...
const MutateAdsResponse$json = {
  ...
  '2': [
    ...
    {'1': 'results', '3': 2, '4': 3, '5': 11, '6': '.google.ads.googleads.v17.services.MutateAdResult', '10': 'results'},
  ],
};
...
final $typed_data.Uint8List mutateAdsResponseDescriptor = $convert.base64Decode(
    ...
    'Z29vZ2xlLmFkcy5nb29nbGVhZHMudjE3LnNlcnZpY2VzLk11dGF0ZUFkUmVzdWx0UgdyZXN1bH'
    'Rz');
...
const MutateAdResult$json = {
  ...
  '2': [
    ...
    {'1': 'ad', '3': 2, '4': 1, '5': 11, '6': '.google.ads.googleads.v17.resources.Ad', '10': 'ad'},
  ],
};
...
final $typed_data.Uint8List mutateAdResultDescriptor = $convert.base64Decode(
    ...
    'cy5nb29nbGVhZHMudjE3LnJlc291cmNlcy5BZFICYWQ=');
