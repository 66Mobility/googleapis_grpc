...
class CreateOfflineUserDataJobRequest extends $pb.GeneratedMessage {
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(_omitMessageNames ? '' : 'CreateOfflineUserDataJobRequest', package: const $pb.PackageName(_omitMessageNames ? '' : 'google.ads.googleads.v17.services'), createEmptyInstance: create)
    ..aOS(1, _omitFieldNames ? '' : 'customerId')
    ..aOM<$3908.OfflineUserDataJob>(2, _omitFieldNames ? '' : 'job', subBuilder: $3908.OfflineUserDataJob.create)
  ...
  @$pb.TagNumber(2)
  $3908.OfflineUserDataJob get job => $_getN(1);
  @$pb.TagNumber(2)
  set job($3908.OfflineUserDataJob v) { setField(2, v); }
  @$pb.TagNumber(2)
  $core.bool hasJob() => $_has(1);
  @$pb.TagNumber(2)
  void clearJob() => clearField(2);
  @$pb.TagNumber(2)
  $3908.OfflineUserDataJob ensureJob() => $_ensure(1);
...
class CreateOfflineUserDataJobResponse extends $pb.GeneratedMessage {
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(_omitMessageNames ? '' : 'CreateOfflineUserDataJobResponse', package: const $pb.PackageName(_omitMessageNames ? '' : 'google.ads.googleads.v17.services'), createEmptyInstance: create)
...
class RunOfflineUserDataJobRequest extends $pb.GeneratedMessage {
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(_omitMessageNames ? '' : 'RunOfflineUserDataJobRequest', package: const $pb.PackageName(_omitMessageNames ? '' : 'google.ads.googleads.v17.services'), createEmptyInstance: create)
    ..aOS(1, _omitFieldNames ? '' : 'resourceName')
...
class AddOfflineUserDataJobOperationsRequest extends $pb.GeneratedMessage {
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(_omitMessageNames ? '' : 'AddOfflineUserDataJobOperationsRequest', package: const $pb.PackageName(_omitMessageNames ? '' : 'google.ads.googleads.v17.services'), createEmptyInstance: create)
    ..aOS(1, _omitFieldNames ? '' : 'resourceName')
...
class OfflineUserDataJobOperation extends $pb.GeneratedMessage {
  factory OfflineUserDataJobOperation({
    $3765.UserData? create_1,
    $3765.UserData? remove,
    $core.bool? removeAll,
  }) {
    final $result = create();
    if (create_1 != null) {
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(_omitMessageNames ? '' : 'OfflineUserDataJobOperation', package: const $pb.PackageName(_omitMessageNames ? '' : 'google.ads.googleads.v17.services'), createEmptyInstance: create)
    ..oo(0, [1, 2, 3])
    ..aOM<$3765.UserData>(1, _omitFieldNames ? '' : 'create', subBuilder: $3765.UserData.create)
    ..aOM<$3765.UserData>(2, _omitFieldNames ? '' : 'remove', subBuilder: $3765.UserData.create)
  ...
  /// being uploaded.
  @$pb.TagNumber(1)
  $3765.UserData get create_1 => $_getN(0);
  @$pb.TagNumber(1)
  set create_1($3765.UserData v) { setField(1, v); }
  @$pb.TagNumber(1)
  $core.bool hasCreate_1() => $_has(0);
  @$pb.TagNumber(1)
  void clearCreate_1() => clearField(1);
  @$pb.TagNumber(1)
  $3765.UserData ensureCreate_1() => $_ensure(0);

  /// Remove the provided data from the transaction. Data cannot be retrieved
  /// after being uploaded.
  @$pb.TagNumber(2)
  $3765.UserData get remove => $_getN(1);
  @$pb.TagNumber(2)
  set remove($3765.UserData v) { setField(2, v); }
  @$pb.TagNumber(2)
  $core.bool hasRemove() => $_has(1);
  @$pb.TagNumber(2)
  void clearRemove() => clearField(2);
  @$pb.TagNumber(2)
  $3765.UserData ensureRemove() => $_ensure(1);
...
class AddOfflineUserDataJobOperationsResponse extends $pb.GeneratedMessage {
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(_omitMessageNames ? '' : 'AddOfflineUserDataJobOperationsResponse', package: const $pb.PackageName(_omitMessageNames ? '' : 'google.ads.googleads.v17.services'), createEmptyInstance: create)
