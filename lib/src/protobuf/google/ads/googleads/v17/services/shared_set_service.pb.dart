...
class SharedSetOperation extends $pb.GeneratedMessage {
  factory SharedSetOperation({
    $3852.SharedSet? create_1,
    $3852.SharedSet? update,
    $core.String? remove,
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(_omitMessageNames ? '' : 'SharedSetOperation', package: const $pb.PackageName(_omitMessageNames ? '' : 'google.ads.googleads.v17.services'), createEmptyInstance: create)
    ..oo(0, [1, 2, 3])
    ..aOM<$3852.SharedSet>(1, _omitFieldNames ? '' : 'create', subBuilder: $3852.SharedSet.create)
    ..aOM<$3852.SharedSet>(2, _omitFieldNames ? '' : 'update', subBuilder: $3852.SharedSet.create)
  ...
  @$pb.TagNumber(1)
  $3852.SharedSet get create_1 => $_getN(0);
  @$pb.TagNumber(1)
  set create_1($3852.SharedSet v) { setField(1, v); }
  @$pb.TagNumber(1)
  $core.bool hasCreate_1() => $_has(0);
  @$pb.TagNumber(1)
  void clearCreate_1() => clearField(1);
  @$pb.TagNumber(1)
  $3852.SharedSet ensureCreate_1() => $_ensure(0);

  /// Update operation: The shared set is expected to have a valid resource
  /// name.
  @$pb.TagNumber(2)
  $3852.SharedSet get update => $_getN(1);
  @$pb.TagNumber(2)
  set update($3852.SharedSet v) { setField(2, v); }
  @$pb.TagNumber(2)
  $core.bool hasUpdate() => $_has(1);
  @$pb.TagNumber(2)
  void clearUpdate() => clearField(2);
  @$pb.TagNumber(2)
  $3852.SharedSet ensureUpdate() => $_ensure(1);
...
class MutateSharedSetResult extends $pb.GeneratedMessage {
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(_omitMessageNames ? '' : 'MutateSharedSetResult', package: const $pb.PackageName(_omitMessageNames ? '' : 'google.ads.googleads.v17.services'), createEmptyInstance: create)
    ...
    ..aOM<$3852.SharedSet>(2, _omitFieldNames ? '' : 'sharedSet', subBuilder: $3852.SharedSet.create)
    ..hasRequiredFields = false
  ;
  ...
  /// "MUTABLE_RESOURCE".
  @$pb.TagNumber(2)
  $3852.SharedSet get sharedSet => $_getN(1);
  @$pb.TagNumber(2)
  set sharedSet($3852.SharedSet v) { setField(2, v); }
  @$pb.TagNumber(2)
  $core.bool hasSharedSet() => $_has(1);
  @$pb.TagNumber(2)
  void clearSharedSet() => clearField(2);
  @$pb.TagNumber(2)
  $3852.SharedSet ensureSharedSet() => $_ensure(1);
}
