...
class MutateSharedSetsRequest extends $pb.GeneratedMessage {
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(_omitMessageNames ? '' : 'MutateSharedSetsRequest', package: const $pb.PackageName(_omitMessageNames ? '' : 'google.ads.googleads.v17.services'), createEmptyInstance: create)
...
class SharedSetOperation extends $pb.GeneratedMessage {
  factory SharedSetOperation({
    $3851.SharedSet? create_1,
    $3851.SharedSet? update,
    $core.String? remove,
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(_omitMessageNames ? '' : 'SharedSetOperation', package: const $pb.PackageName(_omitMessageNames ? '' : 'google.ads.googleads.v17.services'), createEmptyInstance: create)
    ..oo(0, [1, 2, 3])
    ..aOM<$3851.SharedSet>(1, _omitFieldNames ? '' : 'create', subBuilder: $3851.SharedSet.create)
    ..aOM<$3851.SharedSet>(2, _omitFieldNames ? '' : 'update', subBuilder: $3851.SharedSet.create)
  ...
  @$pb.TagNumber(1)
  $3851.SharedSet get create_1 => $_getN(0);
  @$pb.TagNumber(1)
  set create_1($3851.SharedSet v) { setField(1, v); }
  @$pb.TagNumber(1)
  $core.bool hasCreate_1() => $_has(0);
  @$pb.TagNumber(1)
  void clearCreate_1() => clearField(1);
  @$pb.TagNumber(1)
  $3851.SharedSet ensureCreate_1() => $_ensure(0);

  /// Update operation: The shared set is expected to have a valid resource
  /// name.
  @$pb.TagNumber(2)
  $3851.SharedSet get update => $_getN(1);
  @$pb.TagNumber(2)
  set update($3851.SharedSet v) { setField(2, v); }
  @$pb.TagNumber(2)
  $core.bool hasUpdate() => $_has(1);
  @$pb.TagNumber(2)
  void clearUpdate() => clearField(2);
  @$pb.TagNumber(2)
  $3851.SharedSet ensureUpdate() => $_ensure(1);
...
class MutateSharedSetsResponse extends $pb.GeneratedMessage {
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(_omitMessageNames ? '' : 'MutateSharedSetsResponse', package: const $pb.PackageName(_omitMessageNames ? '' : 'google.ads.googleads.v17.services'), createEmptyInstance: create)
...
class MutateSharedSetResult extends $pb.GeneratedMessage {
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(_omitMessageNames ? '' : 'MutateSharedSetResult', package: const $pb.PackageName(_omitMessageNames ? '' : 'google.ads.googleads.v17.services'), createEmptyInstance: create)
    ..aOS(1, _omitFieldNames ? '' : 'resourceName')
    ..aOM<$3851.SharedSet>(2, _omitFieldNames ? '' : 'sharedSet', subBuilder: $3851.SharedSet.create)
    ..hasRequiredFields = false
  ;
  ...
  /// "MUTABLE_RESOURCE".
  @$pb.TagNumber(2)
  $3851.SharedSet get sharedSet => $_getN(1);
  @$pb.TagNumber(2)
  set sharedSet($3851.SharedSet v) { setField(2, v); }
  @$pb.TagNumber(2)
  $core.bool hasSharedSet() => $_has(1);
  @$pb.TagNumber(2)
  void clearSharedSet() => clearField(2);
  @$pb.TagNumber(2)
  $3851.SharedSet ensureSharedSet() => $_ensure(1);
}
