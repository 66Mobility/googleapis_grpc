...
const SmartCampaignNotEligibleDetails$json = {
  ...
  '2': [
    {'1': 'not_eligible_reason', '3': 1, '4': 1, '5': 14, '6': '.google.ads.googleads.v17.enums.SmartCampaignNotEligibleReasonEnum.SmartCampaignNotEligibleReason', '9': 0, '10': 'notEligibleReason', '17': true},
  ],
  '8': [
...
final $typed_data.Uint8List smartCampaignNotEligibleDetailsDescriptor = $convert.base64Decode(
    ...
    '9uGAEgASgOMmEuZ29vZ2xlLmFkcy5nb29nbGVhZHMudjE3LmVudW1zLlNtYXJ0Q2FtcGFpZ25O'
...
const GetSmartCampaignStatusResponse$json = {
  ...
  '2': [
    {'1': 'smart_campaign_status', '3': 1, '4': 1, '5': 14, '6': '.google.ads.googleads.v17.enums.SmartCampaignStatusEnum.SmartCampaignStatus', '10': 'smartCampaignStatus'},
    {'1': 'not_eligible_details', '3': 2, '4': 1, '5': 11, '6': '.google.ads.googleads.v17.services.SmartCampaignNotEligibleDetails', '9': 0, '10': 'notEligibleDetails'},
    {'1': 'eligible_details', '3': 3, '4': 1, '5': 11, '6': '.google.ads.googleads.v17.services.SmartCampaignEligibleDetails', '9': 0, '10': 'eligibleDetails'},
    {'1': 'paused_details', '3': 4, '4': 1, '5': 11, '6': '.google.ads.googleads.v17.services.SmartCampaignPausedDetails', '9': 0, '10': 'pausedDetails'},
    {'1': 'removed_details', '3': 5, '4': 1, '5': 11, '6': '.google.ads.googleads.v17.services.SmartCampaignRemovedDetails', '9': 0, '10': 'removedDetails'},
    {'1': 'ended_details', '3': 6, '4': 1, '5': 11, '6': '.google.ads.googleads.v17.services.SmartCampaignEndedDetails', '9': 0, '10': 'endedDetails'},
  ],
  '8': [
...
final $typed_data.Uint8List getSmartCampaignStatusResponseDescriptor = $convert.base64Decode(
    ...
    'VzGAEgASgOMksuZ29vZ2xlLmFkcy5nb29nbGVhZHMudjE3LmVudW1zLlNtYXJ0Q2FtcGFpZ25T'
    'dGF0dXNFbnVtLlNtYXJ0Q2FtcGFpZ25TdGF0dXNSE3NtYXJ0Q2FtcGFpZ25TdGF0dXMSdgoUbm'
    '90X2VsaWdpYmxlX2RldGFpbHMYAiABKAsyQi5nb29nbGUuYWRzLmdvb2dsZWFkcy52MTcuc2Vy'
    ...
    'Ny5zZXJ2aWNlcy5TbWFydENhbXBhaWduRWxpZ2libGVEZXRhaWxzSABSD2VsaWdpYmxlRGV0YW'
    'lscxJmCg5wYXVzZWRfZGV0YWlscxgEIAEoCzI9Lmdvb2dsZS5hZHMuZ29vZ2xlYWRzLnYxNy5z'
    'ZXJ2aWNlcy5TbWFydENhbXBhaWduUGF1c2VkRGV0YWlsc0gAUg1wYXVzZWREZXRhaWxzEmkKD3'
    'JlbW92ZWRfZGV0YWlscxgFIAEoCzI+Lmdvb2dsZS5hZHMuZ29vZ2xlYWRzLnYxNy5zZXJ2aWNl'
    'cy5TbWFydENhbXBhaWduUmVtb3ZlZERldGFpbHNIAFIOcmVtb3ZlZERldGFpbHMSYwoNZW5kZW'
    'RfZGV0YWlscxgGIAEoCzI8Lmdvb2dsZS5hZHMuZ29vZ2xlYWRzLnYxNy5zZXJ2aWNlcy5TbWFy'
...
const MutateSmartCampaignSettingsRequest$json = {
  ...
  '2': [
    ...
    {'1': 'operations', '3': 2, '4': 3, '5': 11, '6': '.google.ads.googleads.v17.services.SmartCampaignSettingOperation', '8': {}, '10': 'operations'},
...
final $typed_data.Uint8List mutateSmartCampaignSettingsRequestDescriptor = $convert.base64Decode(
    ...
    'Z2xlYWRzLnYxNy5zZXJ2aWNlcy5TbWFydENhbXBhaWduU2V0dGluZ09wZXJhdGlvbkID4EECUg'
...
const SmartCampaignSettingOperation$json = {
  ...
  '2': [
    {'1': 'update', '3': 1, '4': 1, '5': 11, '6': '.google.ads.googleads.v17.resources.SmartCampaignSetting', '10': 'update'},
...
final $typed_data.Uint8List smartCampaignSettingOperationDescriptor = $convert.base64Decode(
    ...
    'UuYWRzLmdvb2dsZWFkcy52MTcucmVzb3VyY2VzLlNtYXJ0Q2FtcGFpZ25TZXR0aW5nUgZ1cGRh'
...
const MutateSmartCampaignSettingsResponse$json = {
  ...
  '2': [
    ...
    {'1': 'results', '3': 2, '4': 3, '5': 11, '6': '.google.ads.googleads.v17.services.MutateSmartCampaignSettingResult', '10': 'results'},
  ],
};
...
const MutateSmartCampaignSettingResult$json = {
  ...
  '2': [
    {'1': 'resource_name', '3': 1, '4': 1, '5': 9, '8': {}, '10': 'resourceName'},
    {'1': 'smart_campaign_setting', '3': 2, '4': 1, '5': 11, '6': '.google.ads.googleads.v17.resources.SmartCampaignSetting', '10': 'smartCampaignSetting'},
  ],
};
...
final $typed_data.Uint8List mutateSmartCampaignSettingResultDescriptor = $convert.base64Decode(
    ...
    'RzLmdvb2dsZWFkcy52MTcucmVzb3VyY2VzLlNtYXJ0Q2FtcGFpZ25TZXR0aW5nUhRzbWFydENh'
    'bXBhaWduU2V0dGluZw==');
