...
class CampaignFeedOperation extends $pb.GeneratedMessage {
  factory CampaignFeedOperation({
    $3652.CampaignFeed? create_1,
    $3652.CampaignFeed? update,
    $core.String? remove,
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(_omitMessageNames ? '' : 'CampaignFeedOperation', package: const $pb.PackageName(_omitMessageNames ? '' : 'google.ads.googleads.v17.services'), createEmptyInstance: create)
    ..oo(0, [1, 2, 3])
    ..aOM<$3652.CampaignFeed>(1, _omitFieldNames ? '' : 'create', subBuilder: $3652.CampaignFeed.create)
    ..aOM<$3652.CampaignFeed>(2, _omitFieldNames ? '' : 'update', subBuilder: $3652.CampaignFeed.create)
  ...
  @$pb.TagNumber(1)
  $3652.CampaignFeed get create_1 => $_getN(0);
  @$pb.TagNumber(1)
  set create_1($3652.CampaignFeed v) { setField(1, v); }
  @$pb.TagNumber(1)
  $core.bool hasCreate_1() => $_has(0);
  @$pb.TagNumber(1)
  void clearCreate_1() => clearField(1);
  @$pb.TagNumber(1)
  $3652.CampaignFeed ensureCreate_1() => $_ensure(0);

  /// Update operation: The campaign feed is expected to have a valid resource
  /// name.
  @$pb.TagNumber(2)
  $3652.CampaignFeed get update => $_getN(1);
  @$pb.TagNumber(2)
  set update($3652.CampaignFeed v) { setField(2, v); }
  @$pb.TagNumber(2)
  $core.bool hasUpdate() => $_has(1);
  @$pb.TagNumber(2)
  void clearUpdate() => clearField(2);
  @$pb.TagNumber(2)
  $3652.CampaignFeed ensureUpdate() => $_ensure(1);
...
class MutateCampaignFeedResult extends $pb.GeneratedMessage {
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(_omitMessageNames ? '' : 'MutateCampaignFeedResult', package: const $pb.PackageName(_omitMessageNames ? '' : 'google.ads.googleads.v17.services'), createEmptyInstance: create)
    ...
    ..aOM<$3652.CampaignFeed>(2, _omitFieldNames ? '' : 'campaignFeed', subBuilder: $3652.CampaignFeed.create)
    ..hasRequiredFields = false
  ;
  ...
  /// "MUTABLE_RESOURCE".
  @$pb.TagNumber(2)
  $3652.CampaignFeed get campaignFeed => $_getN(1);
  @$pb.TagNumber(2)
  set campaignFeed($3652.CampaignFeed v) { setField(2, v); }
  @$pb.TagNumber(2)
  $core.bool hasCampaignFeed() => $_has(1);
  @$pb.TagNumber(2)
  void clearCampaignFeed() => clearField(2);
  @$pb.TagNumber(2)
  $3652.CampaignFeed ensureCampaignFeed() => $_ensure(1);
}
