...
const MutateCustomConversionGoalsRequest$json = {
  ...
  '2': [
    ...
    {'1': 'operations', '3': 2, '4': 3, '5': 11, '6': '.google.ads.googleads.v17.services.CustomConversionGoalOperation', '8': {}, '10': 'operations'},
...
final $typed_data.Uint8List mutateCustomConversionGoalsRequestDescriptor = $convert.base64Decode(
    ...
    'Z2xlYWRzLnYxNy5zZXJ2aWNlcy5DdXN0b21Db252ZXJzaW9uR29hbE9wZXJhdGlvbkID4EECUg'
    'pvcGVyYXRpb25zEiMKDXZhbGlkYXRlX29ubHkYAyABKAhSDHZhbGlkYXRlT25seRJ/ChVyZXNw'
    'b25zZV9jb250ZW50X3R5cGUYBCABKA4ySy5nb29nbGUuYWRzLmdvb2dsZWFkcy52MTcuZW51bX'
...
const CustomConversionGoalOperation$json = {
  ...
  '2': [
    ...
    {'1': 'create', '3': 1, '4': 1, '5': 11, '6': '.google.ads.googleads.v17.resources.CustomConversionGoal', '9': 0, '10': 'create'},
    {'1': 'update', '3': 2, '4': 1, '5': 11, '6': '.google.ads.googleads.v17.resources.CustomConversionGoal', '9': 0, '10': 'update'},
...
final $typed_data.Uint8List customConversionGoalOperationDescriptor = $convert.base64Decode(
    ...
    'Z29vZ2xlLmFkcy5nb29nbGVhZHMudjE3LnJlc291cmNlcy5DdXN0b21Db252ZXJzaW9uR29hbE'
...
const MutateCustomConversionGoalsResponse$json = {
  ...
  '2': [
    {'1': 'results', '3': 1, '4': 3, '5': 11, '6': '.google.ads.googleads.v17.services.MutateCustomConversionGoalResult', '10': 'results'},
  ],
};
...
final $typed_data.Uint8List mutateCustomConversionGoalsResponseDescriptor = $convert.base64Decode(
    ...
    'MuZ29vZ2xlLmFkcy5nb29nbGVhZHMudjE3LnNlcnZpY2VzLk11dGF0ZUN1c3RvbUNvbnZlcnNp'
...
const MutateCustomConversionGoalResult$json = {
  ...
  '2': [
    ...
    {'1': 'custom_conversion_goal', '3': 2, '4': 1, '5': 11, '6': '.google.ads.googleads.v17.resources.CustomConversionGoal', '10': 'customConversionGoal'},
  ],
};
...
final $typed_data.Uint8List mutateCustomConversionGoalResultDescriptor = $convert.base64Decode(
    ...
    'RzLmdvb2dsZWFkcy52MTcucmVzb3VyY2VzLkN1c3RvbUNvbnZlcnNpb25Hb2FsUhRjdXN0b21D'
    'b252ZXJzaW9uR29hbA==');
