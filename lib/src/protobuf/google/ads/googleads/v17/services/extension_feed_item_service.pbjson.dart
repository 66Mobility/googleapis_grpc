...
const MutateExtensionFeedItemsRequest$json = {
  ...
  '2': [
    ...
    {'1': 'operations', '3': 2, '4': 3, '5': 11, '6': '.google.ads.googleads.v17.services.ExtensionFeedItemOperation', '8': {}, '10': 'operations'},
...
final $typed_data.Uint8List mutateExtensionFeedItemsRequestDescriptor = $convert.base64Decode(
    ...
    'YWRzLnYxNy5zZXJ2aWNlcy5FeHRlbnNpb25GZWVkSXRlbU9wZXJhdGlvbkID4EECUgpvcGVyYX'
    ...
    'EoDjJLLmdvb2dsZS5hZHMuZ29vZ2xlYWRzLnYxNy5lbnVtcy5SZXNwb25zZUNvbnRlbnRUeXBl'
...
const ExtensionFeedItemOperation$json = {
  ...
  '2': [
    ...
    {'1': 'create', '3': 1, '4': 1, '5': 11, '6': '.google.ads.googleads.v17.resources.ExtensionFeedItem', '9': 0, '10': 'create'},
    {'1': 'update', '3': 2, '4': 1, '5': 11, '6': '.google.ads.googleads.v17.resources.ExtensionFeedItem', '9': 0, '10': 'update'},
...
final $typed_data.Uint8List extensionFeedItemOperationDescriptor = $convert.base64Decode(
    ...
    'Z2xlLmFkcy5nb29nbGVhZHMudjE3LnJlc291cmNlcy5FeHRlbnNpb25GZWVkSXRlbUgAUgZjcm'
...
const MutateExtensionFeedItemsResponse$json = {
  ...
  '2': [
    ...
    {'1': 'results', '3': 2, '4': 3, '5': 11, '6': '.google.ads.googleads.v17.services.MutateExtensionFeedItemResult', '10': 'results'},
  ],
};
...
final $typed_data.Uint8List mutateExtensionFeedItemsResponseDescriptor = $convert.base64Decode(
    ...
    'ZXN1bHRzGAIgAygLMkAuZ29vZ2xlLmFkcy5nb29nbGVhZHMudjE3LnNlcnZpY2VzLk11dGF0ZU'
...
const MutateExtensionFeedItemResult$json = {
  ...
  '2': [
    ...
    {'1': 'extension_feed_item', '3': 2, '4': 1, '5': 11, '6': '.google.ads.googleads.v17.resources.ExtensionFeedItem', '10': 'extensionFeedItem'},
  ],
};
...
final $typed_data.Uint8List mutateExtensionFeedItemResultDescriptor = $convert.base64Decode(
    ...
    'Fkcy52MTcucmVzb3VyY2VzLkV4dGVuc2lvbkZlZWRJdGVtUhFleHRlbnNpb25GZWVkSXRlbQ==');
