...
class MutateAccountBudgetProposalRequest extends $pb.GeneratedMessage {
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(_omitMessageNames ? '' : 'MutateAccountBudgetProposalRequest', package: const $pb.PackageName(_omitMessageNames ? '' : 'google.ads.googleads.v17.services'), createEmptyInstance: create)
...
class AccountBudgetProposalOperation extends $pb.GeneratedMessage {
  factory AccountBudgetProposalOperation({
    $core.String? remove,
    $3793.AccountBudgetProposal? create_2,
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(_omitMessageNames ? '' : 'AccountBudgetProposalOperation', package: const $pb.PackageName(_omitMessageNames ? '' : 'google.ads.googleads.v17.services'), createEmptyInstance: create)
    ..oo(0, [1, 2])
    ..aOS(1, _omitFieldNames ? '' : 'remove')
    ..aOM<$3793.AccountBudgetProposal>(2, _omitFieldNames ? '' : 'create', subBuilder: $3793.AccountBudgetProposal.create)
  ...
  @$pb.TagNumber(2)
  $3793.AccountBudgetProposal get create_2 => $_getN(1);
  @$pb.TagNumber(2)
  set create_2($3793.AccountBudgetProposal v) { setField(2, v); }
  @$pb.TagNumber(2)
  $core.bool hasCreate_2() => $_has(1);
  @$pb.TagNumber(2)
  void clearCreate_2() => clearField(2);
  @$pb.TagNumber(2)
  $3793.AccountBudgetProposal ensureCreate_2() => $_ensure(1);
...
class MutateAccountBudgetProposalResponse extends $pb.GeneratedMessage {
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(_omitMessageNames ? '' : 'MutateAccountBudgetProposalResponse', package: const $pb.PackageName(_omitMessageNames ? '' : 'google.ads.googleads.v17.services'), createEmptyInstance: create)
...
class MutateAccountBudgetProposalResult extends $pb.GeneratedMessage {
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(_omitMessageNames ? '' : 'MutateAccountBudgetProposalResult', package: const $pb.PackageName(_omitMessageNames ? '' : 'google.ads.googleads.v17.services'), createEmptyInstance: create)
