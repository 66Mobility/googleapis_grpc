...
class AccountBudgetProposalOperation extends $pb.GeneratedMessage {
  factory AccountBudgetProposalOperation({
    $core.String? remove,
    $3794.AccountBudgetProposal? create_2,
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(_omitMessageNames ? '' : 'AccountBudgetProposalOperation', package: const $pb.PackageName(_omitMessageNames ? '' : 'google.ads.googleads.v17.services'), createEmptyInstance: create)
    ...
    ..aOM<$3794.AccountBudgetProposal>(2, _omitFieldNames ? '' : 'create', subBuilder: $3794.AccountBudgetProposal.create)
  ...
  @$pb.TagNumber(2)
  $3794.AccountBudgetProposal get create_2 => $_getN(1);
  @$pb.TagNumber(2)
  set create_2($3794.AccountBudgetProposal v) { setField(2, v); }
  @$pb.TagNumber(2)
  $core.bool hasCreate_2() => $_has(1);
  @$pb.TagNumber(2)
  void clearCreate_2() => clearField(2);
  @$pb.TagNumber(2)
  $3794.AccountBudgetProposal ensureCreate_2() => $_ensure(1);
