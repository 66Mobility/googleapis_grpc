...
class MutateKeywordPlanCampaignKeywordsRequest extends $pb.GeneratedMessage {
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(_omitMessageNames ? '' : 'MutateKeywordPlanCampaignKeywordsRequest', package: const $pb.PackageName(_omitMessageNames ? '' : 'google.ads.googleads.v17.services'), createEmptyInstance: create)
...
class KeywordPlanCampaignKeywordOperation extends $pb.GeneratedMessage {
  factory KeywordPlanCampaignKeywordOperation({
    $3844.KeywordPlanCampaignKeyword? create_1,
    $3844.KeywordPlanCampaignKeyword? update,
    $core.String? remove,
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(_omitMessageNames ? '' : 'KeywordPlanCampaignKeywordOperation', package: const $pb.PackageName(_omitMessageNames ? '' : 'google.ads.googleads.v17.services'), createEmptyInstance: create)
    ..oo(0, [1, 2, 3])
    ..aOM<$3844.KeywordPlanCampaignKeyword>(1, _omitFieldNames ? '' : 'create', subBuilder: $3844.KeywordPlanCampaignKeyword.create)
    ..aOM<$3844.KeywordPlanCampaignKeyword>(2, _omitFieldNames ? '' : 'update', subBuilder: $3844.KeywordPlanCampaignKeyword.create)
  ...
  /// campaign keyword.
  @$pb.TagNumber(1)
  $3844.KeywordPlanCampaignKeyword get create_1 => $_getN(0);
  @$pb.TagNumber(1)
  set create_1($3844.KeywordPlanCampaignKeyword v) { setField(1, v); }
  @$pb.TagNumber(1)
  $core.bool hasCreate_1() => $_has(0);
  @$pb.TagNumber(1)
  void clearCreate_1() => clearField(1);
  @$pb.TagNumber(1)
  $3844.KeywordPlanCampaignKeyword ensureCreate_1() => $_ensure(0);

  /// Update operation: The Keyword Plan campaign keyword expected to have a
  /// valid resource name.
  @$pb.TagNumber(2)
  $3844.KeywordPlanCampaignKeyword get update => $_getN(1);
  @$pb.TagNumber(2)
  set update($3844.KeywordPlanCampaignKeyword v) { setField(2, v); }
  @$pb.TagNumber(2)
  $core.bool hasUpdate() => $_has(1);
  @$pb.TagNumber(2)
  void clearUpdate() => clearField(2);
  @$pb.TagNumber(2)
  $3844.KeywordPlanCampaignKeyword ensureUpdate() => $_ensure(1);
...
class MutateKeywordPlanCampaignKeywordsResponse extends $pb.GeneratedMessage {
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(_omitMessageNames ? '' : 'MutateKeywordPlanCampaignKeywordsResponse', package: const $pb.PackageName(_omitMessageNames ? '' : 'google.ads.googleads.v17.services'), createEmptyInstance: create)
...
class MutateKeywordPlanCampaignKeywordResult extends $pb.GeneratedMessage {
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(_omitMessageNames ? '' : 'MutateKeywordPlanCampaignKeywordResult', package: const $pb.PackageName(_omitMessageNames ? '' : 'google.ads.googleads.v17.services'), createEmptyInstance: create)
