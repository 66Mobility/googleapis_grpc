...
const UploadClickConversionsRequest$json = {
  ...
  '2': [
    ...
    {'1': 'conversions', '3': 2, '4': 3, '5': 11, '6': '.google.ads.googleads.v17.services.ClickConversion', '8': {}, '10': 'conversions'},
...
final $typed_data.Uint8List uploadClickConversionsRequestDescriptor = $convert.base64Decode(
    ...
    'ZHMudjE3LnNlcnZpY2VzLkNsaWNrQ29udmVyc2lvbkID4EECUgtjb252ZXJzaW9ucxIsCg9wYX'
...
const UploadClickConversionsResponse$json = {
  ...
  '2': [
    ...
    {'1': 'results', '3': 2, '4': 3, '5': 11, '6': '.google.ads.googleads.v17.services.ClickConversionResult', '10': 'results'},
...
final $typed_data.Uint8List uploadClickConversionsResponseDescriptor = $convert.base64Decode(
    ...
    'dWx0cxgCIAMoCzI4Lmdvb2dsZS5hZHMuZ29vZ2xlYWRzLnYxNy5zZXJ2aWNlcy5DbGlja0Nvbn'
...
const UploadCallConversionsRequest$json = {
  ...
  '2': [
    {'1': 'customer_id', '3': 1, '4': 1, '5': 9, '8': {}, '10': 'customerId'},
    {'1': 'conversions', '3': 2, '4': 3, '5': 11, '6': '.google.ads.googleads.v17.services.CallConversion', '8': {}, '10': 'conversions'},
    {'1': 'partial_failure', '3': 3, '4': 1, '5': 8, '8': {}, '10': 'partialFailure'},
    {'1': 'validate_only', '3': 4, '4': 1, '5': 8, '10': 'validateOnly'},
  ],
};
...
final $typed_data.Uint8List uploadCallConversionsRequestDescriptor = $convert.base64Decode(
    ...
    'cy52MTcuc2VydmljZXMuQ2FsbENvbnZlcnNpb25CA+BBAlILY29udmVyc2lvbnMSLAoPcGFydG'
...
const UploadCallConversionsResponse$json = {
  ...
  '2': [
    {'1': 'partial_failure_error', '3': 1, '4': 1, '5': 11, '6': '.google.rpc.Status', '10': 'partialFailureError'},
    {'1': 'results', '3': 2, '4': 3, '5': 11, '6': '.google.ads.googleads.v17.services.CallConversionResult', '10': 'results'},
  ],
};
...
final $typed_data.Uint8List uploadCallConversionsResponseDescriptor = $convert.base64Decode(
    ...
    'bHRzGAIgAygLMjcuZ29vZ2xlLmFkcy5nb29nbGVhZHMudjE3LnNlcnZpY2VzLkNhbGxDb252ZX'
...
const ClickConversion$json = {
  ...
  '2': [
    ...
    {'1': 'external_attribution_data', '3': 7, '4': 1, '5': 11, '6': '.google.ads.googleads.v17.services.ExternalAttributionData', '10': 'externalAttributionData'},
    {'1': 'custom_variables', '3': 15, '4': 3, '5': 11, '6': '.google.ads.googleads.v17.services.CustomVariable', '10': 'customVariables'},
    {'1': 'cart_data', '3': 16, '4': 1, '5': 11, '6': '.google.ads.googleads.v17.services.CartData', '10': 'cartData'},
    {'1': 'user_identifiers', '3': 17, '4': 3, '5': 11, '6': '.google.ads.googleads.v17.common.UserIdentifier', '10': 'userIdentifiers'},
    {'1': 'conversion_environment', '3': 20, '4': 1, '5': 14, '6': '.google.ads.googleads.v17.enums.ConversionEnvironmentEnum.ConversionEnvironment', '10': 'conversionEnvironment'},
    {'1': 'consent', '3': 23, '4': 1, '5': 11, '6': '.google.ads.googleads.v17.common.Consent', '10': 'consent'},
  ],
  '8': [
    {'1': '_gclid'},
...
final $typed_data.Uint8List clickConversionDescriptor = $convert.base64Decode(
    ...
    'dHRyaWJ1dGlvbl9kYXRhGAcgASgLMjouZ29vZ2xlLmFkcy5nb29nbGVhZHMudjE3LnNlcnZpY2'
    'VzLkV4dGVybmFsQXR0cmlidXRpb25EYXRhUhdleHRlcm5hbEF0dHJpYnV0aW9uRGF0YRJcChBj'
    'dXN0b21fdmFyaWFibGVzGA8gAygLMjEuZ29vZ2xlLmFkcy5nb29nbGVhZHMudjE3LnNlcnZpY2'
    'VzLkN1c3RvbVZhcmlhYmxlUg9jdXN0b21WYXJpYWJsZXMSSAoJY2FydF9kYXRhGBAgASgLMisu'
    'Z29vZ2xlLmFkcy5nb29nbGVhZHMudjE3LnNlcnZpY2VzLkNhcnREYXRhUghjYXJ0RGF0YRJaCh'
    'B1c2VyX2lkZW50aWZpZXJzGBEgAygLMi8uZ29vZ2xlLmFkcy5nb29nbGVhZHMudjE3LmNvbW1v'
    'bi5Vc2VySWRlbnRpZmllclIPdXNlcklkZW50aWZpZXJzEoYBChZjb252ZXJzaW9uX2Vudmlyb2'
    '5tZW50GBQgASgOMk8uZ29vZ2xlLmFkcy5nb29nbGVhZHMudjE3LmVudW1zLkNvbnZlcnNpb25F'
    'bnZpcm9ubWVudEVudW0uQ29udmVyc2lvbkVudmlyb25tZW50UhVjb252ZXJzaW9uRW52aXJvbm'
    '1lbnQSQgoHY29uc2VudBgXIAEoCzIoLmdvb2dsZS5hZHMuZ29vZ2xlYWRzLnYxNy5jb21tb24u'
...
const CallConversion$json = {
  ...
  '2': [
    ...
    {'1': 'custom_variables', '3': 13, '4': 3, '5': 11, '6': '.google.ads.googleads.v17.services.CustomVariable', '10': 'customVariables'},
    {'1': 'consent', '3': 14, '4': 1, '5': 11, '6': '.google.ads.googleads.v17.common.Consent', '10': 'consent'},
  ],
  '8': [
    {'1': '_caller_id'},
...
final $typed_data.Uint8List callConversionDescriptor = $convert.base64Decode(
    ...
    'ZS5hZHMuZ29vZ2xlYWRzLnYxNy5zZXJ2aWNlcy5DdXN0b21WYXJpYWJsZVIPY3VzdG9tVmFyaW'
    'FibGVzEkIKB2NvbnNlbnQYDiABKAsyKC5nb29nbGUuYWRzLmdvb2dsZWFkcy52MTcuY29tbW9u'
...
const ClickConversionResult$json = {
  ...
  '2': [
    ...
    {'1': 'user_identifiers', '3': 7, '4': 3, '5': 11, '6': '.google.ads.googleads.v17.common.UserIdentifier', '10': 'userIdentifiers'},
  ],
  '8': [
    {'1': '_gclid'},
    {'1': '_conversion_action'},
...
final $typed_data.Uint8List clickConversionResultDescriptor = $convert.base64Decode(
    ...
    'cxgHIAMoCzIvLmdvb2dsZS5hZHMuZ29vZ2xlYWRzLnYxNy5jb21tb24uVXNlcklkZW50aWZpZX'
...
const CartData$json = {
  ...
  '2': [
    ...
    {'1': 'items', '3': 5, '4': 3, '5': 11, '6': '.google.ads.googleads.v17.services.CartData.Item', '10': 'items'},
  ],
...
final $typed_data.Uint8List cartDataDescriptor = $convert.base64Decode(
    ...
    'YWRzLnYxNy5zZXJ2aWNlcy5DYXJ0RGF0YS5JdGVtUgVpdGVtcxpgCgRJdGVtEh0KCnByb2R1Y3'
