...
const MutateAdGroupAssetSetsRequest$json = {
  ...
  '2': [
    ...
    {'1': 'operations', '3': 2, '4': 3, '5': 11, '6': '.google.ads.googleads.v17.services.AdGroupAssetSetOperation', '8': {}, '10': 'operations'},
...
final $typed_data.Uint8List mutateAdGroupAssetSetsRequestDescriptor = $convert.base64Decode(
    ...
    'cy52MTcuc2VydmljZXMuQWRHcm91cEFzc2V0U2V0T3BlcmF0aW9uQgPgQQJSCm9wZXJhdGlvbn'
...
const AdGroupAssetSetOperation$json = {
  ...
  '2': [
    {'1': 'create', '3': 1, '4': 1, '5': 11, '6': '.google.ads.googleads.v17.resources.AdGroupAssetSet', '9': 0, '10': 'create'},
...
final $typed_data.Uint8List adGroupAssetSetOperationDescriptor = $convert.base64Decode(
    ...
    '5nb29nbGVhZHMudjE3LnJlc291cmNlcy5BZEdyb3VwQXNzZXRTZXRIAFIGY3JlYXRlEkcKBnJl'
...
const MutateAdGroupAssetSetsResponse$json = {
  ...
  '2': [
    {'1': 'results', '3': 1, '4': 3, '5': 11, '6': '.google.ads.googleads.v17.services.MutateAdGroupAssetSetResult', '10': 'results'},
...
final $typed_data.Uint8List mutateAdGroupAssetSetsResponseDescriptor = $convert.base64Decode(
    ...
    'dsZS5hZHMuZ29vZ2xlYWRzLnYxNy5zZXJ2aWNlcy5NdXRhdGVBZEdyb3VwQXNzZXRTZXRSZXN1'
...
const MutateAdGroupAssetSetResult$json = {
  ...
  '2': [
    ...
    {'1': 'ad_group_asset_set', '3': 2, '4': 1, '5': 11, '6': '.google.ads.googleads.v17.resources.AdGroupAssetSet', '10': 'adGroupAssetSet'},
  ],
};
...
final $typed_data.Uint8List mutateAdGroupAssetSetResultDescriptor = $convert.base64Decode(
    ...
    'E3LnJlc291cmNlcy5BZEdyb3VwQXNzZXRTZXRSD2FkR3JvdXBBc3NldFNldA==');
