...
const ListPlannableLocationsResponse$json = {
  ...
  '2': [
    {'1': 'plannable_locations', '3': 1, '4': 3, '5': 11, '6': '.google.ads.googleads.v17.services.PlannableLocation', '10': 'plannableLocations'},
  ],
};
...
final $typed_data.Uint8List listPlannableLocationsResponseDescriptor = $convert.base64Decode(
    ...
    'gBIAMoCzI0Lmdvb2dsZS5hZHMuZ29vZ2xlYWRzLnYxNy5zZXJ2aWNlcy5QbGFubmFibGVMb2Nh'
...
const ListPlannableProductsResponse$json = {
  ...
  '2': [
    {'1': 'product_metadata', '3': 1, '4': 3, '5': 11, '6': '.google.ads.googleads.v17.services.ProductMetadata', '10': 'productMetadata'},
  ],
};
...
final $typed_data.Uint8List listPlannableProductsResponseDescriptor = $convert.base64Decode(
    ...
    'gLMjIuZ29vZ2xlLmFkcy5nb29nbGVhZHMudjE3LnNlcnZpY2VzLlByb2R1Y3RNZXRhZGF0YVIP'
...
const ProductMetadata$json = {
  ...
  '2': [
    ...
    {'1': 'plannable_targeting', '3': 2, '4': 1, '5': 11, '6': '.google.ads.googleads.v17.services.PlannableTargeting', '10': 'plannableTargeting'},
  ],
  '8': [
...
final $typed_data.Uint8List productMetadataDescriptor = $convert.base64Decode(
    ...
    'xlLmFkcy5nb29nbGVhZHMudjE3LnNlcnZpY2VzLlBsYW5uYWJsZVRhcmdldGluZ1IScGxhbm5h'
...
const PlannableTargeting$json = {
  ...
  '2': [
    {'1': 'age_ranges', '3': 1, '4': 3, '5': 14, '6': '.google.ads.googleads.v17.enums.ReachPlanAgeRangeEnum.ReachPlanAgeRange', '10': 'ageRanges'},
    {'1': 'genders', '3': 2, '4': 3, '5': 11, '6': '.google.ads.googleads.v17.common.GenderInfo', '10': 'genders'},
    {'1': 'devices', '3': 3, '4': 3, '5': 11, '6': '.google.ads.googleads.v17.common.DeviceInfo', '10': 'devices'},
    {'1': 'networks', '3': 4, '4': 3, '5': 14, '6': '.google.ads.googleads.v17.enums.ReachPlanNetworkEnum.ReachPlanNetwork', '10': 'networks'},
    {'1': 'youtube_select_lineups', '3': 5, '4': 3, '5': 11, '6': '.google.ads.googleads.v17.services.YouTubeSelectLineUp', '10': 'youtubeSelectLineups'},
    {'1': 'surface_targeting', '3': 6, '4': 1, '5': 11, '6': '.google.ads.googleads.v17.services.SurfaceTargetingCombinations', '10': 'surfaceTargeting'},
  ],
};
...
final $typed_data.Uint8List plannableTargetingDescriptor = $convert.base64Decode(
    ...
    '9vZ2xlYWRzLnYxNy5lbnVtcy5SZWFjaFBsYW5BZ2VSYW5nZUVudW0uUmVhY2hQbGFuQWdlUmFu'
    'Z2VSCWFnZVJhbmdlcxJFCgdnZW5kZXJzGAIgAygLMisuZ29vZ2xlLmFkcy5nb29nbGVhZHMudj'
    'E3LmNvbW1vbi5HZW5kZXJJbmZvUgdnZW5kZXJzEkUKB2RldmljZXMYAyADKAsyKy5nb29nbGUu'
    'YWRzLmdvb2dsZWFkcy52MTcuY29tbW9uLkRldmljZUluZm9SB2RldmljZXMSYQoIbmV0d29ya3'
    'MYBCADKA4yRS5nb29nbGUuYWRzLmdvb2dsZWFkcy52MTcuZW51bXMuUmVhY2hQbGFuTmV0d29y'
    'a0VudW0uUmVhY2hQbGFuTmV0d29ya1IIbmV0d29ya3MSbAoWeW91dHViZV9zZWxlY3RfbGluZX'
    'VwcxgFIAMoCzI2Lmdvb2dsZS5hZHMuZ29vZ2xlYWRzLnYxNy5zZXJ2aWNlcy5Zb3VUdWJlU2Vs'
    'ZWN0TGluZVVwUhR5b3V0dWJlU2VsZWN0TGluZXVwcxJsChFzdXJmYWNlX3RhcmdldGluZxgGIA'
    'EoCzI/Lmdvb2dsZS5hZHMuZ29vZ2xlYWRzLnYxNy5zZXJ2aWNlcy5TdXJmYWNlVGFyZ2V0aW5n'
...
const GenerateReachForecastRequest$json = {
  ...
  '2': [
    ...
    {'1': 'campaign_duration', '3': 3, '4': 1, '5': 11, '6': '.google.ads.googleads.v17.services.CampaignDuration', '8': {}, '10': 'campaignDuration'},
    {'1': 'cookie_frequency_cap', '3': 10, '4': 1, '5': 5, '9': 1, '10': 'cookieFrequencyCap', '17': true},
    {'1': 'cookie_frequency_cap_setting', '3': 8, '4': 1, '5': 11, '6': '.google.ads.googleads.v17.services.FrequencyCap', '10': 'cookieFrequencyCapSetting'},
    {'1': 'min_effective_frequency', '3': 11, '4': 1, '5': 5, '9': 2, '10': 'minEffectiveFrequency', '17': true},
    {'1': 'effective_frequency_limit', '3': 12, '4': 1, '5': 11, '6': '.google.ads.googleads.v17.services.EffectiveFrequencyLimit', '9': 3, '10': 'effectiveFrequencyLimit', '17': true},
    {'1': 'targeting', '3': 6, '4': 1, '5': 11, '6': '.google.ads.googleads.v17.services.Targeting', '10': 'targeting'},
    {'1': 'planned_products', '3': 7, '4': 3, '5': 11, '6': '.google.ads.googleads.v17.services.PlannedProduct', '8': {}, '10': 'plannedProducts'},
    {'1': 'forecast_metric_options', '3': 13, '4': 1, '5': 11, '6': '.google.ads.googleads.v17.services.ForecastMetricOptions', '10': 'forecastMetricOptions'},
...
final $typed_data.Uint8List generateReachForecastRequestDescriptor = $convert.base64Decode(
    ...
    'ZQoRY2FtcGFpZ25fZHVyYXRpb24YAyABKAsyMy5nb29nbGUuYWRzLmdvb2dsZWFkcy52MTcuc2'
    ...
    'VfZnJlcXVlbmN5X2NhcF9zZXR0aW5nGAggASgLMi8uZ29vZ2xlLmFkcy5nb29nbGVhZHMudjE3'
    ...
    'RzLnYxNy5zZXJ2aWNlcy5FZmZlY3RpdmVGcmVxdWVuY3lMaW1pdEgDUhdlZmZlY3RpdmVGcmVx'
    'dWVuY3lMaW1pdIgBARJKCgl0YXJnZXRpbmcYBiABKAsyLC5nb29nbGUuYWRzLmdvb2dsZWFkcy'
    '52MTcuc2VydmljZXMuVGFyZ2V0aW5nUgl0YXJnZXRpbmcSYQoQcGxhbm5lZF9wcm9kdWN0cxgH'
    'IAMoCzIxLmdvb2dsZS5hZHMuZ29vZ2xlYWRzLnYxNy5zZXJ2aWNlcy5QbGFubmVkUHJvZHVjdE'
    'ID4EECUg9wbGFubmVkUHJvZHVjdHMScAoXZm9yZWNhc3RfbWV0cmljX29wdGlvbnMYDSABKAsy'
    'OC5nb29nbGUuYWRzLmdvb2dsZWFkcy52MTcuc2VydmljZXMuRm9yZWNhc3RNZXRyaWNPcHRpb2'
...
const FrequencyCap$json = {
  ...
  '2': [
    ...
    {'1': 'time_unit', '3': 2, '4': 1, '5': 14, '6': '.google.ads.googleads.v17.enums.FrequencyCapTimeUnitEnum.FrequencyCapTimeUnit', '8': {}, '10': 'timeUnit'},
  ],
};
...
final $typed_data.Uint8List frequencyCapDescriptor = $convert.base64Decode(
    ...
    'oJdGltZV91bml0GAIgASgOMk0uZ29vZ2xlLmFkcy5nb29nbGVhZHMudjE3LmVudW1zLkZyZXF1'
...
const Targeting$json = {
  ...
  '2': [
    ...
    {'1': 'age_range', '3': 2, '4': 1, '5': 14, '6': '.google.ads.googleads.v17.enums.ReachPlanAgeRangeEnum.ReachPlanAgeRange', '10': 'ageRange'},
    {'1': 'genders', '3': 3, '4': 3, '5': 11, '6': '.google.ads.googleads.v17.common.GenderInfo', '10': 'genders'},
    {'1': 'devices', '3': 4, '4': 3, '5': 11, '6': '.google.ads.googleads.v17.common.DeviceInfo', '10': 'devices'},
    {'1': 'network', '3': 5, '4': 1, '5': 14, '6': '.google.ads.googleads.v17.enums.ReachPlanNetworkEnum.ReachPlanNetwork', '10': 'network'},
    {'1': 'audience_targeting', '3': 7, '4': 1, '5': 11, '6': '.google.ads.googleads.v17.services.AudienceTargeting', '10': 'audienceTargeting'},
  ],
  '8': [
...
final $typed_data.Uint8List targetingDescriptor = $convert.base64Decode(
    ...
    'E3LmVudW1zLlJlYWNoUGxhbkFnZVJhbmdlRW51bS5SZWFjaFBsYW5BZ2VSYW5nZVIIYWdlUmFu'
    'Z2USRQoHZ2VuZGVycxgDIAMoCzIrLmdvb2dsZS5hZHMuZ29vZ2xlYWRzLnYxNy5jb21tb24uR2'
    'VuZGVySW5mb1IHZ2VuZGVycxJFCgdkZXZpY2VzGAQgAygLMisuZ29vZ2xlLmFkcy5nb29nbGVh'
    'ZHMudjE3LmNvbW1vbi5EZXZpY2VJbmZvUgdkZXZpY2VzEl8KB25ldHdvcmsYBSABKA4yRS5nb2'
    '9nbGUuYWRzLmdvb2dsZWFkcy52MTcuZW51bXMuUmVhY2hQbGFuTmV0d29ya0VudW0uUmVhY2hQ'
    'bGFuTmV0d29ya1IHbmV0d29yaxJjChJhdWRpZW5jZV90YXJnZXRpbmcYByABKAsyNC5nb29nbG'
    'UuYWRzLmdvb2dsZWFkcy52MTcuc2VydmljZXMuQXVkaWVuY2VUYXJnZXRpbmdSEWF1ZGllbmNl'
...
const CampaignDuration$json = {
  ...
  '2': [
    ...
    {'1': 'date_range', '3': 3, '4': 1, '5': 11, '6': '.google.ads.googleads.v17.common.DateRange', '10': 'dateRange'},
  ],
  '8': [
    {'1': '_duration_in_days'},
  ],
...
final $typed_data.Uint8List campaignDurationDescriptor = $convert.base64Decode(
    ...
    'Ny5jb21tb24uRGF0ZVJhbmdlUglkYXRlUmFuZ2VCEwoRX2R1cmF0aW9uX2luX2RheXM=');
...
const PlannedProduct$json = {
  ...
  '2': [
    ...
    {'1': 'advanced_product_targeting', '3': 5, '4': 1, '5': 11, '6': '.google.ads.googleads.v17.services.AdvancedProductTargeting', '10': 'advancedProductTargeting'},
  ],
  '8': [
    {'1': '_plannable_product_code'},
    {'1': '_budget_micros'},
...
final $typed_data.Uint8List plannedProductDescriptor = $convert.base64Decode(
    ...
    'dvb2dsZS5hZHMuZ29vZ2xlYWRzLnYxNy5zZXJ2aWNlcy5BZHZhbmNlZFByb2R1Y3RUYXJnZXRp'
...
const GenerateReachForecastResponse$json = {
  ...
  '2': [
    {'1': 'on_target_audience_metrics', '3': 1, '4': 1, '5': 11, '6': '.google.ads.googleads.v17.services.OnTargetAudienceMetrics', '10': 'onTargetAudienceMetrics'},
    {'1': 'reach_curve', '3': 2, '4': 1, '5': 11, '6': '.google.ads.googleads.v17.services.ReachCurve', '10': 'reachCurve'},
  ],
};
...
final $typed_data.Uint8List generateReachForecastResponseDescriptor = $convert.base64Decode(
    ...
    'V0cmljcxgBIAEoCzI6Lmdvb2dsZS5hZHMuZ29vZ2xlYWRzLnYxNy5zZXJ2aWNlcy5PblRhcmdl'
    'dEF1ZGllbmNlTWV0cmljc1IXb25UYXJnZXRBdWRpZW5jZU1ldHJpY3MSTgoLcmVhY2hfY3Vydm'
    'UYAiABKAsyLS5nb29nbGUuYWRzLmdvb2dsZWFkcy52MTcuc2VydmljZXMuUmVhY2hDdXJ2ZVIK'
    'cmVhY2hDdXJ2ZQ==');
...
const ReachCurve$json = {
  '1': 'ReachCurve',
  '2': [
    {'1': 'reach_forecasts', '3': 1, '4': 3, '5': 11, '6': '.google.ads.googleads.v17.services.ReachForecast', '10': 'reachForecasts'},
  ],
};
...
final $typed_data.Uint8List reachCurveDescriptor = $convert.base64Decode(
    ...
    'xlYWRzLnYxNy5zZXJ2aWNlcy5SZWFjaEZvcmVjYXN0Ug5yZWFjaEZvcmVjYXN0cw==');
...
const ReachForecast$json = {
  ...
  '2': [
    ...
    {'1': 'forecast', '3': 2, '4': 1, '5': 11, '6': '.google.ads.googleads.v17.services.Forecast', '10': 'forecast'},
    {'1': 'planned_product_reach_forecasts', '3': 4, '4': 3, '5': 11, '6': '.google.ads.googleads.v17.services.PlannedProductReachForecast', '10': 'plannedProductReachForecasts'},
  ],
};
...
final $typed_data.Uint8List reachForecastDescriptor = $convert.base64Decode(
    ...
    'VjYXN0GAIgASgLMisuZ29vZ2xlLmFkcy5nb29nbGVhZHMudjE3LnNlcnZpY2VzLkZvcmVjYXN0'
    'Ughmb3JlY2FzdBKFAQofcGxhbm5lZF9wcm9kdWN0X3JlYWNoX2ZvcmVjYXN0cxgEIAMoCzI+Lm'
    'dvb2dsZS5hZHMuZ29vZ2xlYWRzLnYxNy5zZXJ2aWNlcy5QbGFubmVkUHJvZHVjdFJlYWNoRm9y'
...
const Forecast$json = {
  ...
  '2': [
    ...
    {'1': 'effective_frequency_breakdowns', '3': 10, '4': 3, '5': 11, '6': '.google.ads.googleads.v17.services.EffectiveFrequencyBreakdown', '10': 'effectiveFrequencyBreakdowns'},
...
final $typed_data.Uint8List forecastDescriptor = $convert.base64Decode(
    ...
    '5jeV9icmVha2Rvd25zGAogAygLMj4uZ29vZ2xlLmFkcy5nb29nbGVhZHMudjE3LnNlcnZpY2Vz'
...
const PlannedProductReachForecast$json = {
  ...
  '2': [
    ...
    {'1': 'planned_product_forecast', '3': 3, '4': 1, '5': 11, '6': '.google.ads.googleads.v17.services.PlannedProductForecast', '10': 'plannedProductForecast'},
  ],
};
...
final $typed_data.Uint8List plannedProductReachForecastDescriptor = $convert.base64Decode(
    ...
    '9nbGVhZHMudjE3LnNlcnZpY2VzLlBsYW5uZWRQcm9kdWN0Rm9yZWNhc3RSFnBsYW5uZWRQcm9k'
    'dWN0Rm9yZWNhc3Q=');
...
const AudienceTargeting$json = {
  '1': 'AudienceTargeting',
  '2': [
    {'1': 'user_interest', '3': 1, '4': 3, '5': 11, '6': '.google.ads.googleads.v17.common.UserInterestInfo', '10': 'userInterest'},
  ],
};
...
final $typed_data.Uint8List audienceTargetingDescriptor = $convert.base64Decode(
    ...
    '5nb29nbGVhZHMudjE3LmNvbW1vbi5Vc2VySW50ZXJlc3RJbmZvUgx1c2VySW50ZXJlc3Q=');
...
const AdvancedProductTargeting$json = {
  ...
  '2': [
    {'1': 'surface_targeting_settings', '3': 2, '4': 1, '5': 11, '6': '.google.ads.googleads.v17.services.SurfaceTargeting', '10': 'surfaceTargetingSettings'},
    {'1': 'target_frequency_settings', '3': 3, '4': 1, '5': 11, '6': '.google.ads.googleads.v17.services.TargetFrequencySettings', '10': 'targetFrequencySettings'},
    {'1': 'youtube_select_settings', '3': 1, '4': 1, '5': 11, '6': '.google.ads.googleads.v17.services.YouTubeSelectSettings', '9': 0, '10': 'youtubeSelectSettings'},
  ],
  '8': [
...
final $typed_data.Uint8List advancedProductTargetingDescriptor = $convert.base64Decode(
    ...
    'MYAiABKAsyMy5nb29nbGUuYWRzLmdvb2dsZWFkcy52MTcuc2VydmljZXMuU3VyZmFjZVRhcmdl'
    'dGluZ1IYc3VyZmFjZVRhcmdldGluZ1NldHRpbmdzEnYKGXRhcmdldF9mcmVxdWVuY3lfc2V0dG'
    'luZ3MYAyABKAsyOi5nb29nbGUuYWRzLmdvb2dsZWFkcy52MTcuc2VydmljZXMuVGFyZ2V0RnJl'
    'cXVlbmN5U2V0dGluZ3NSF3RhcmdldEZyZXF1ZW5jeVNldHRpbmdzEnIKF3lvdXR1YmVfc2VsZW'
    'N0X3NldHRpbmdzGAEgASgLMjguZ29vZ2xlLmFkcy5nb29nbGVhZHMudjE3LnNlcnZpY2VzLllv'
...
const SurfaceTargetingCombinations$json = {
  ...
  '2': [
    {'1': 'default_targeting', '3': 1, '4': 1, '5': 11, '6': '.google.ads.googleads.v17.services.SurfaceTargeting', '10': 'defaultTargeting'},
    {'1': 'available_targeting_combinations', '3': 2, '4': 3, '5': 11, '6': '.google.ads.googleads.v17.services.SurfaceTargeting', '10': 'availableTargetingCombinations'},
  ],
};
...
final $typed_data.Uint8List surfaceTargetingCombinationsDescriptor = $convert.base64Decode(
    ...
    'gLMjMuZ29vZ2xlLmFkcy5nb29nbGVhZHMudjE3LnNlcnZpY2VzLlN1cmZhY2VUYXJnZXRpbmdS'
    'EGRlZmF1bHRUYXJnZXRpbmcSfQogYXZhaWxhYmxlX3RhcmdldGluZ19jb21iaW5hdGlvbnMYAi'
    'ADKAsyMy5nb29nbGUuYWRzLmdvb2dsZWFkcy52MTcuc2VydmljZXMuU3VyZmFjZVRhcmdldGlu'
...
const SurfaceTargeting$json = {
  '1': 'SurfaceTargeting',
  '2': [
    {'1': 'surfaces', '3': 1, '4': 3, '5': 14, '6': '.google.ads.googleads.v17.enums.ReachPlanSurfaceEnum.ReachPlanSurface', '10': 'surfaces'},
  ],
};
...
final $typed_data.Uint8List surfaceTargetingDescriptor = $convert.base64Decode(
    ...
    'VhZHMudjE3LmVudW1zLlJlYWNoUGxhblN1cmZhY2VFbnVtLlJlYWNoUGxhblN1cmZhY2VSCHN1'
    'cmZhY2Vz');
...
const TargetFrequencySettings$json = {
  ...
  '2': [
    {'1': 'time_unit', '3': 1, '4': 1, '5': 14, '6': '.google.ads.googleads.v17.enums.TargetFrequencyTimeUnitEnum.TargetFrequencyTimeUnit', '8': {}, '10': 'timeUnit'},
...
final $typed_data.Uint8List targetFrequencySettingsDescriptor = $convert.base64Decode(
    ...
    'RzLmdvb2dsZWFkcy52MTcuZW51bXMuVGFyZ2V0RnJlcXVlbmN5VGltZVVuaXRFbnVtLlRhcmdl'
