...
class AdGroupLabelOperation extends $pb.GeneratedMessage {
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(_omitMessageNames ? '' : 'AdGroupLabelOperation', package: const $pb.PackageName(_omitMessageNames ? '' : 'google.ads.googleads.v17.services'), createEmptyInstance: create)
    ..oo(0, [1, 2])
    ..aOM<$3803.AdGroupLabel>(1, _omitFieldNames ? '' : 'create', subBuilder: $3803.AdGroupLabel.create)
  ...
  /// label.
  @$pb.TagNumber(1)
  $3803.AdGroupLabel get create_1 => $_getN(0);
  @$pb.TagNumber(1)
  set create_1($3803.AdGroupLabel v) { setField(1, v); }
  @$pb.TagNumber(1)
  $core.bool hasCreate_1() => $_has(0);
  @$pb.TagNumber(1)
  void clearCreate_1() => clearField(1);
  @$pb.TagNumber(1)
  $3803.AdGroupLabel ensureCreate_1() => $_ensure(0);
