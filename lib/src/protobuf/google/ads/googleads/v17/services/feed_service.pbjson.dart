...
const MutateFeedsRequest$json = {
  ...
  '2': [
    ...
    {'1': 'operations', '3': 2, '4': 3, '5': 11, '6': '.google.ads.googleads.v17.services.FeedOperation', '8': {}, '10': 'operations'},
...
final $typed_data.Uint8List mutateFeedsRequestDescriptor = $convert.base64Decode(
    ...
    'JJZBJVCgpvcGVyYXRpb25zGAIgAygLMjAuZ29vZ2xlLmFkcy5nb29nbGVhZHMudjE3LnNlcnZp'
    ...
    '52MTcuZW51bXMuUmVzcG9uc2VDb250ZW50VHlwZUVudW0uUmVzcG9uc2VDb250ZW50VHlwZVIT'
...
const FeedOperation$json = {
  ...
  '2': [
    ...
    {'1': 'create', '3': 1, '4': 1, '5': 11, '6': '.google.ads.googleads.v17.resources.Feed', '9': 0, '10': 'create'},
    {'1': 'update', '3': 2, '4': 1, '5': 11, '6': '.google.ads.googleads.v17.resources.Feed', '9': 0, '10': 'update'},
...
final $typed_data.Uint8List feedOperationDescriptor = $convert.base64Decode(
    ...
    'ZWFkcy52MTcucmVzb3VyY2VzLkZlZWRIAFIGY3JlYXRlEkIKBnVwZGF0ZRgCIAEoCzIoLmdvb2'
    'dsZS5hZHMuZ29vZ2xlYWRzLnYxNy5yZXNvdXJjZXMuRmVlZEgAUgZ1cGRhdGUSPAoGcmVtb3Zl'
...
const MutateFeedsResponse$json = {
  ...
  '2': [
    ...
    {'1': 'results', '3': 2, '4': 3, '5': 11, '6': '.google.ads.googleads.v17.services.MutateFeedResult', '10': 'results'},
  ],
};
...
final $typed_data.Uint8List mutateFeedsResponseDescriptor = $convert.base64Decode(
    ...
    'My5nb29nbGUuYWRzLmdvb2dsZWFkcy52MTcuc2VydmljZXMuTXV0YXRlRmVlZFJlc3VsdFIHcm'
    'VzdWx0cw==');
...
const MutateFeedResult$json = {
  ...
  '2': [
    ...
    {'1': 'feed', '3': 2, '4': 1, '5': 11, '6': '.google.ads.googleads.v17.resources.Feed', '10': 'feed'},
  ],
};
...
final $typed_data.Uint8List mutateFeedResultDescriptor = $convert.base64Decode(
    ...
    'Z2xlLmFkcy5nb29nbGVhZHMudjE3LnJlc291cmNlcy5GZWVkUgRmZWVk');
