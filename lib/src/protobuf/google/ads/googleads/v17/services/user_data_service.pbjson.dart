...
const UploadUserDataRequest$json = {
  ...
  '2': [
    ...
    {'1': 'operations', '3': 3, '4': 3, '5': 11, '6': '.google.ads.googleads.v17.services.UserDataOperation', '8': {}, '10': 'operations'},
    {'1': 'customer_match_user_list_metadata', '3': 2, '4': 1, '5': 11, '6': '.google.ads.googleads.v17.common.CustomerMatchUserListMetadata', '9': 0, '10': 'customerMatchUserListMetadata'},
  ],
  '8': [
    {'1': 'metadata'},
  ],
...
final $typed_data.Uint8List uploadUserDataRequestDescriptor = $convert.base64Decode(
    ...
    '9tZXJJZBJZCgpvcGVyYXRpb25zGAMgAygLMjQuZ29vZ2xlLmFkcy5nb29nbGVhZHMudjE3LnNl'
    ...
    'Ny5jb21tb24uQ3VzdG9tZXJNYXRjaFVzZXJMaXN0TWV0YWRhdGFIAFIdY3VzdG9tZXJNYXRjaF'
...
const UserDataOperation$json = {
  '1': 'UserDataOperation',
  '2': [
    {'1': 'create', '3': 1, '4': 1, '5': 11, '6': '.google.ads.googleads.v17.common.UserData', '9': 0, '10': 'create'},
    {'1': 'remove', '3': 2, '4': 1, '5': 11, '6': '.google.ads.googleads.v17.common.UserData', '9': 0, '10': 'remove'},
  ],
  '8': [
    {'1': 'operation'},
  ],
...
final $typed_data.Uint8List userDataOperationDescriptor = $convert.base64Decode(
    ...
    'Fkcy52MTcuY29tbW9uLlVzZXJEYXRhSABSBmNyZWF0ZRJDCgZyZW1vdmUYAiABKAsyKS5nb29n'
    'bGUuYWRzLmdvb2dsZWFkcy52MTcuY29tbW9uLlVzZXJEYXRhSABSBnJlbW92ZUILCglvcGVyYX'
    'Rpb24=');
