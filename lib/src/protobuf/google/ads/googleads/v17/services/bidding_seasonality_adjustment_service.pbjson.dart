...
const MutateBiddingSeasonalityAdjustmentsRequest$json = {
  ...
  '2': [
    ...
    {'1': 'operations', '3': 2, '4': 3, '5': 11, '6': '.google.ads.googleads.v17.services.BiddingSeasonalityAdjustmentOperation', '8': {}, '10': 'operations'},
...
final $typed_data.Uint8List mutateBiddingSeasonalityAdjustmentsRequestDescriptor = $convert.base64Decode(
    ...
    'LmFkcy5nb29nbGVhZHMudjE3LnNlcnZpY2VzLkJpZGRpbmdTZWFzb25hbGl0eUFkanVzdG1lbn'
    ...
    'Nwb25zZV9jb250ZW50X3R5cGUYBSABKA4ySy5nb29nbGUuYWRzLmdvb2dsZWFkcy52MTcuZW51'
...
const BiddingSeasonalityAdjustmentOperation$json = {
  ...
  '2': [
    ...
    {'1': 'create', '3': 1, '4': 1, '5': 11, '6': '.google.ads.googleads.v17.resources.BiddingSeasonalityAdjustment', '9': 0, '10': 'create'},
    {'1': 'update', '3': 2, '4': 1, '5': 11, '6': '.google.ads.googleads.v17.resources.BiddingSeasonalityAdjustment', '9': 0, '10': 'update'},
...
final $typed_data.Uint8List biddingSeasonalityAdjustmentOperationDescriptor = $convert.base64Decode(
    ...
    'ASABKAsyQC5nb29nbGUuYWRzLmdvb2dsZWFkcy52MTcucmVzb3VyY2VzLkJpZGRpbmdTZWFzb2'
    '5hbGl0eUFkanVzdG1lbnRIAFIGY3JlYXRlEloKBnVwZGF0ZRgCIAEoCzJALmdvb2dsZS5hZHMu'
    'Z29vZ2xlYWRzLnYxNy5yZXNvdXJjZXMuQmlkZGluZ1NlYXNvbmFsaXR5QWRqdXN0bWVudEgAUg'
...
const MutateBiddingSeasonalityAdjustmentsResponse$json = {
  ...
  '2': [
    ...
    {'1': 'results', '3': 2, '4': 3, '5': 11, '6': '.google.ads.googleads.v17.services.MutateBiddingSeasonalityAdjustmentsResult', '10': 'results'},
  ],
};
...
final $typed_data.Uint8List mutateBiddingSeasonalityAdjustmentsResponseDescriptor = $convert.base64Decode(
    ...
    'ZUVycm9yEmYKB3Jlc3VsdHMYAiADKAsyTC5nb29nbGUuYWRzLmdvb2dsZWFkcy52MTcuc2Vydm'
...
const MutateBiddingSeasonalityAdjustmentsResult$json = {
  ...
  '2': [
    ...
    {'1': 'bidding_seasonality_adjustment', '3': 2, '4': 1, '5': 11, '6': '.google.ads.googleads.v17.resources.BiddingSeasonalityAdjustment', '10': 'biddingSeasonalityAdjustment'},
  ],
};
...
final $typed_data.Uint8List mutateBiddingSeasonalityAdjustmentsResultDescriptor = $convert.base64Decode(
    ...
    'RqdXN0bWVudBgCIAEoCzJALmdvb2dsZS5hZHMuZ29vZ2xlYWRzLnYxNy5yZXNvdXJjZXMuQmlk'
