...
const MutateAssetGroupAssetsRequest$json = {
  ...
  '2': [
    ...
    {'1': 'operations', '3': 2, '4': 3, '5': 11, '6': '.google.ads.googleads.v17.services.AssetGroupAssetOperation', '8': {}, '10': 'operations'},
...
final $typed_data.Uint8List mutateAssetGroupAssetsRequestDescriptor = $convert.base64Decode(
    ...
    'cy52MTcuc2VydmljZXMuQXNzZXRHcm91cEFzc2V0T3BlcmF0aW9uQgPgQQJSCm9wZXJhdGlvbn'
...
const AssetGroupAssetOperation$json = {
  ...
  '2': [
    ...
    {'1': 'create', '3': 1, '4': 1, '5': 11, '6': '.google.ads.googleads.v17.resources.AssetGroupAsset', '9': 0, '10': 'create'},
    {'1': 'update', '3': 2, '4': 1, '5': 11, '6': '.google.ads.googleads.v17.resources.AssetGroupAsset', '9': 0, '10': 'update'},
...
final $typed_data.Uint8List assetGroupAssetOperationDescriptor = $convert.base64Decode(
    ...
    'ZS5hZHMuZ29vZ2xlYWRzLnYxNy5yZXNvdXJjZXMuQXNzZXRHcm91cEFzc2V0SABSBmNyZWF0ZR'
    'JNCgZ1cGRhdGUYAiABKAsyMy5nb29nbGUuYWRzLmdvb2dsZWFkcy52MTcucmVzb3VyY2VzLkFz'
...
const MutateAssetGroupAssetsResponse$json = {
  ...
  '2': [
    {'1': 'results', '3': 1, '4': 3, '5': 11, '6': '.google.ads.googleads.v17.services.MutateAssetGroupAssetResult', '10': 'results'},
...
final $typed_data.Uint8List mutateAssetGroupAssetsResponseDescriptor = $convert.base64Decode(
    ...
    'dsZS5hZHMuZ29vZ2xlYWRzLnYxNy5zZXJ2aWNlcy5NdXRhdGVBc3NldEdyb3VwQXNzZXRSZXN1'
