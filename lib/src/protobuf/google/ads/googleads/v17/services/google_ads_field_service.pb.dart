...
class GetGoogleAdsFieldRequest extends $pb.GeneratedMessage {
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(_omitMessageNames ? '' : 'GetGoogleAdsFieldRequest', package: const $pb.PackageName(_omitMessageNames ? '' : 'google.ads.googleads.v17.services'), createEmptyInstance: create)
...
class SearchGoogleAdsFieldsRequest extends $pb.GeneratedMessage {
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(_omitMessageNames ? '' : 'SearchGoogleAdsFieldsRequest', package: const $pb.PackageName(_omitMessageNames ? '' : 'google.ads.googleads.v17.services'), createEmptyInstance: create)
...
class SearchGoogleAdsFieldsResponse extends $pb.GeneratedMessage {
  factory SearchGoogleAdsFieldsResponse({
    $core.Iterable<$346.GoogleAdsField>? results,
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(_omitMessageNames ? '' : 'SearchGoogleAdsFieldsResponse', package: const $pb.PackageName(_omitMessageNames ? '' : 'google.ads.googleads.v17.services'), createEmptyInstance: create)
    ..pc<$346.GoogleAdsField>(1, _omitFieldNames ? '' : 'results', $pb.PbFieldType.PM, subBuilder: $346.GoogleAdsField.create)
  ...
  @$pb.TagNumber(1)
  $core.List<$346.GoogleAdsField> get results => $_getList(0);
