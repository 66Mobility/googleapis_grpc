...
class MutateCustomerRequest extends $pb.GeneratedMessage {
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(_omitMessageNames ? '' : 'MutateCustomerRequest', package: const $pb.PackageName(_omitMessageNames ? '' : 'google.ads.googleads.v17.services'), createEmptyInstance: create)
    ...
    ..e<$3797.ResponseContentTypeEnum_ResponseContentType>(6, _omitFieldNames ? '' : 'responseContentType', $pb.PbFieldType.OE, defaultOrMaker: $3797.ResponseContentTypeEnum_ResponseContentType.UNSPECIFIED, valueOf: $3797.ResponseContentTypeEnum_ResponseContentType.valueOf, enumValues: $3797.ResponseContentTypeEnum_ResponseContentType.values)
  ...
  @$pb.TagNumber(6)
  set responseContentType($3797.ResponseContentTypeEnum_ResponseContentType v) { setField(6, v); }
  @$pb.TagNumber(6)
...
class CreateCustomerClientRequest extends $pb.GeneratedMessage {
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(_omitMessageNames ? '' : 'CreateCustomerClientRequest', package: const $pb.PackageName(_omitMessageNames ? '' : 'google.ads.googleads.v17.services'), createEmptyInstance: create)
    ..aOS(1, _omitFieldNames ? '' : 'customerId')
    ..aOM<$3834.Customer>(2, _omitFieldNames ? '' : 'customerClient', subBuilder: $3834.Customer.create)
  ...
  @$pb.TagNumber(2)
  $3834.Customer get customerClient => $_getN(1);
  @$pb.TagNumber(2)
  set customerClient($3834.Customer v) { setField(2, v); }
  @$pb.TagNumber(2)
  $core.bool hasCustomerClient() => $_has(1);
  @$pb.TagNumber(2)
  void clearCustomerClient() => clearField(2);
  @$pb.TagNumber(2)
  $3834.Customer ensureCustomerClient() => $_ensure(1);

  /// The proposed role of user on the created client customer.
  /// Accessible only to customers on the allow-list.
  @$pb.TagNumber(4)
  $3697.AccessRoleEnum_AccessRole get accessRole => $_getN(2);
  @$pb.TagNumber(4)
...
class CustomerOperation extends $pb.GeneratedMessage {
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(_omitMessageNames ? '' : 'CustomerOperation', package: const $pb.PackageName(_omitMessageNames ? '' : 'google.ads.googleads.v17.services'), createEmptyInstance: create)
    ..aOM<$3834.Customer>(1, _omitFieldNames ? '' : 'update', subBuilder: $3834.Customer.create)
  ...
  @$pb.TagNumber(1)
  $3834.Customer get update => $_getN(0);
  @$pb.TagNumber(1)
  set update($3834.Customer v) { setField(1, v); }
  @$pb.TagNumber(1)
  $core.bool hasUpdate() => $_has(0);
  @$pb.TagNumber(1)
  void clearUpdate() => clearField(1);
  @$pb.TagNumber(1)
  $3834.Customer ensureUpdate() => $_ensure(0);
...
class MutateCustomerResult extends $pb.GeneratedMessage {
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(_omitMessageNames ? '' : 'MutateCustomerResult', package: const $pb.PackageName(_omitMessageNames ? '' : 'google.ads.googleads.v17.services'), createEmptyInstance: create)
    ...
    ..aOM<$3834.Customer>(2, _omitFieldNames ? '' : 'customer', subBuilder: $3834.Customer.create)
    ..hasRequiredFields = false
  ;
  ...
  @$pb.TagNumber(2)
  $3834.Customer get customer => $_getN(1);
  @$pb.TagNumber(2)
  set customer($3834.Customer v) { setField(2, v); }
  @$pb.TagNumber(2)
  $core.bool hasCustomer() => $_has(1);
  @$pb.TagNumber(2)
  void clearCustomer() => clearField(2);
  @$pb.TagNumber(2)
  $3834.Customer ensureCustomer() => $_ensure(1);
}
