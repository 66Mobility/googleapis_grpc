...
class MutateCustomerRequest extends $pb.GeneratedMessage {
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(_omitMessageNames ? '' : 'MutateCustomerRequest', package: const $pb.PackageName(_omitMessageNames ? '' : 'google.ads.googleads.v17.services'), createEmptyInstance: create)
  ...
  @$pb.TagNumber(6)
  set responseContentType($3796.ResponseContentTypeEnum_ResponseContentType v) { setField(6, v); }
  @$pb.TagNumber(6)
...
class CreateCustomerClientRequest extends $pb.GeneratedMessage {
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(_omitMessageNames ? '' : 'CreateCustomerClientRequest', package: const $pb.PackageName(_omitMessageNames ? '' : 'google.ads.googleads.v17.services'), createEmptyInstance: create)
    ..aOS(1, _omitFieldNames ? '' : 'customerId')
    ..aOM<$3833.Customer>(2, _omitFieldNames ? '' : 'customerClient', subBuilder: $3833.Customer.create)
    ..e<$3696.AccessRoleEnum_AccessRole>(4, _omitFieldNames ? '' : 'accessRole', $pb.PbFieldType.OE, defaultOrMaker: $3696.AccessRoleEnum_AccessRole.UNSPECIFIED, valueOf: $3696.AccessRoleEnum_AccessRole.valueOf, enumValues: $3696.AccessRoleEnum_AccessRole.values)
  ...
  @$pb.TagNumber(2)
  $3833.Customer get customerClient => $_getN(1);
  @$pb.TagNumber(2)
  set customerClient($3833.Customer v) { setField(2, v); }
  @$pb.TagNumber(2)
  $core.bool hasCustomerClient() => $_has(1);
  @$pb.TagNumber(2)
  void clearCustomerClient() => clearField(2);
  @$pb.TagNumber(2)
  $3833.Customer ensureCustomerClient() => $_ensure(1);
  ...
  @$pb.TagNumber(4)
  set accessRole($3696.AccessRoleEnum_AccessRole v) { setField(4, v); }
  @$pb.TagNumber(4)
...
class CustomerOperation extends $pb.GeneratedMessage {
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(_omitMessageNames ? '' : 'CustomerOperation', package: const $pb.PackageName(_omitMessageNames ? '' : 'google.ads.googleads.v17.services'), createEmptyInstance: create)
    ..aOM<$3833.Customer>(1, _omitFieldNames ? '' : 'update', subBuilder: $3833.Customer.create)
  ...
  @$pb.TagNumber(1)
  $3833.Customer get update => $_getN(0);
  @$pb.TagNumber(1)
  set update($3833.Customer v) { setField(1, v); }
  @$pb.TagNumber(1)
  $core.bool hasUpdate() => $_has(0);
  @$pb.TagNumber(1)
  void clearUpdate() => clearField(1);
  @$pb.TagNumber(1)
  $3833.Customer ensureUpdate() => $_ensure(0);
...
class CreateCustomerClientResponse extends $pb.GeneratedMessage {
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(_omitMessageNames ? '' : 'CreateCustomerClientResponse', package: const $pb.PackageName(_omitMessageNames ? '' : 'google.ads.googleads.v17.services'), createEmptyInstance: create)
...
class MutateCustomerResponse extends $pb.GeneratedMessage {
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(_omitMessageNames ? '' : 'MutateCustomerResponse', package: const $pb.PackageName(_omitMessageNames ? '' : 'google.ads.googleads.v17.services'), createEmptyInstance: create)
...
class MutateCustomerResult extends $pb.GeneratedMessage {
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(_omitMessageNames ? '' : 'MutateCustomerResult', package: const $pb.PackageName(_omitMessageNames ? '' : 'google.ads.googleads.v17.services'), createEmptyInstance: create)
    ..aOS(1, _omitFieldNames ? '' : 'resourceName')
    ..aOM<$3833.Customer>(2, _omitFieldNames ? '' : 'customer', subBuilder: $3833.Customer.create)
    ..hasRequiredFields = false
  ;
  ...
  @$pb.TagNumber(2)
  $3833.Customer get customer => $_getN(1);
  @$pb.TagNumber(2)
  set customer($3833.Customer v) { setField(2, v); }
  @$pb.TagNumber(2)
  $core.bool hasCustomer() => $_has(1);
  @$pb.TagNumber(2)
  void clearCustomer() => clearField(2);
  @$pb.TagNumber(2)
  $3833.Customer ensureCustomer() => $_ensure(1);
}
...
class ListAccessibleCustomersRequest extends $pb.GeneratedMessage {
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(_omitMessageNames ? '' : 'ListAccessibleCustomersRequest', package: const $pb.PackageName(_omitMessageNames ? '' : 'google.ads.googleads.v17.services'), createEmptyInstance: create)
    ..hasRequiredFields = false
  ;
...
class ListAccessibleCustomersResponse extends $pb.GeneratedMessage {
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(_omitMessageNames ? '' : 'ListAccessibleCustomersResponse', package: const $pb.PackageName(_omitMessageNames ? '' : 'google.ads.googleads.v17.services'), createEmptyInstance: create)
