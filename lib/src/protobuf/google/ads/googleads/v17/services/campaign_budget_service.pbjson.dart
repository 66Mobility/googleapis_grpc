...
const MutateCampaignBudgetsRequest$json = {
  ...
  '2': [
    ...
    {'1': 'operations', '3': 2, '4': 3, '5': 11, '6': '.google.ads.googleads.v17.services.CampaignBudgetOperation', '8': {}, '10': 'operations'},
...
final $typed_data.Uint8List mutateCampaignBudgetsRequestDescriptor = $convert.base64Decode(
    ...
    'LnYxNy5zZXJ2aWNlcy5DYW1wYWlnbkJ1ZGdldE9wZXJhdGlvbkID4EECUgpvcGVyYXRpb25zEi'
...
const CampaignBudgetOperation$json = {
  ...
  '2': [
    ...
    {'1': 'create', '3': 1, '4': 1, '5': 11, '6': '.google.ads.googleads.v17.resources.CampaignBudget', '9': 0, '10': 'create'},
    {'1': 'update', '3': 2, '4': 1, '5': 11, '6': '.google.ads.googleads.v17.resources.CampaignBudget', '9': 0, '10': 'update'},
...
final $typed_data.Uint8List campaignBudgetOperationDescriptor = $convert.base64Decode(
    ...
    'LmFkcy5nb29nbGVhZHMudjE3LnJlc291cmNlcy5DYW1wYWlnbkJ1ZGdldEgAUgZjcmVhdGUSTA'
    'oGdXBkYXRlGAIgASgLMjIuZ29vZ2xlLmFkcy5nb29nbGVhZHMudjE3LnJlc291cmNlcy5DYW1w'
...
const MutateCampaignBudgetsResponse$json = {
  ...
  '2': [
    ...
    {'1': 'results', '3': 2, '4': 3, '5': 11, '6': '.google.ads.googleads.v17.services.MutateCampaignBudgetResult', '10': 'results'},
  ],
};
...
final $typed_data.Uint8List mutateCampaignBudgetsResponseDescriptor = $convert.base64Decode(
    ...
    'bHRzGAIgAygLMj0uZ29vZ2xlLmFkcy5nb29nbGVhZHMudjE3LnNlcnZpY2VzLk11dGF0ZUNhbX'
...
const MutateCampaignBudgetResult$json = {
  ...
  '2': [
    ...
    {'1': 'campaign_budget', '3': 2, '4': 1, '5': 11, '6': '.google.ads.googleads.v17.resources.CampaignBudget', '10': 'campaignBudget'},
  ],
};
...
final $typed_data.Uint8List mutateCampaignBudgetResultDescriptor = $convert.base64Decode(
    ...
    'ElsKD2NhbXBhaWduX2J1ZGdldBgCIAEoCzIyLmdvb2dsZS5hZHMuZ29vZ2xlYWRzLnYxNy5yZX'
