...
const MutateFeedMappingsRequest$json = {
  ...
  '2': [
    ...
    {'1': 'operations', '3': 2, '4': 3, '5': 11, '6': '.google.ads.googleads.v17.services.FeedMappingOperation', '8': {}, '10': 'operations'},
...
final $typed_data.Uint8List mutateFeedMappingsRequestDescriptor = $convert.base64Decode(
    ...
    'Ny5zZXJ2aWNlcy5GZWVkTWFwcGluZ09wZXJhdGlvbkID4EECUgpvcGVyYXRpb25zEicKD3Bhcn'
...
const FeedMappingOperation$json = {
  ...
  '2': [
    {'1': 'create', '3': 1, '4': 1, '5': 11, '6': '.google.ads.googleads.v17.resources.FeedMapping', '9': 0, '10': 'create'},
...
final $typed_data.Uint8List feedMappingOperationDescriptor = $convert.base64Decode(
    ...
    'dsZWFkcy52MTcucmVzb3VyY2VzLkZlZWRNYXBwaW5nSABSBmNyZWF0ZRJDCgZyZW1vdmUYAyAB'
...
const MutateFeedMappingsResponse$json = {
  ...
  '2': [
    ...
    {'1': 'results', '3': 2, '4': 3, '5': 11, '6': '.google.ads.googleads.v17.services.MutateFeedMappingResult', '10': 'results'},
  ],
};
...
final $typed_data.Uint8List mutateFeedMappingsResponseDescriptor = $convert.base64Decode(
    ...
    'GAIgAygLMjouZ29vZ2xlLmFkcy5nb29nbGVhZHMudjE3LnNlcnZpY2VzLk11dGF0ZUZlZWRNYX'
...
const MutateFeedMappingResult$json = {
  ...
  '2': [
    ...
    {'1': 'feed_mapping', '3': 2, '4': 1, '5': 11, '6': '.google.ads.googleads.v17.resources.FeedMapping', '10': 'feedMapping'},
  ],
};
...
final $typed_data.Uint8List mutateFeedMappingResultDescriptor = $convert.base64Decode(
    ...
    'ZWRfbWFwcGluZxgCIAEoCzIvLmdvb2dsZS5hZHMuZ29vZ2xlYWRzLnYxNy5yZXNvdXJjZXMuRm'
