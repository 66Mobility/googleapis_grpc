...
const MutateKeywordPlanAdGroupsRequest$json = {
  ...
  '2': [
    ...
    {'1': 'operations', '3': 2, '4': 3, '5': 11, '6': '.google.ads.googleads.v17.services.KeywordPlanAdGroupOperation', '8': {}, '10': 'operations'},
...
final $typed_data.Uint8List mutateKeywordPlanAdGroupsRequestDescriptor = $convert.base64Decode(
    ...
    'ZWFkcy52MTcuc2VydmljZXMuS2V5d29yZFBsYW5BZEdyb3VwT3BlcmF0aW9uQgPgQQJSCm9wZX'
...
const KeywordPlanAdGroupOperation$json = {
  ...
  '2': [
    ...
    {'1': 'create', '3': 1, '4': 1, '5': 11, '6': '.google.ads.googleads.v17.resources.KeywordPlanAdGroup', '9': 0, '10': 'create'},
    {'1': 'update', '3': 2, '4': 1, '5': 11, '6': '.google.ads.googleads.v17.resources.KeywordPlanAdGroup', '9': 0, '10': 'update'},
...
final $typed_data.Uint8List keywordPlanAdGroupOperationDescriptor = $convert.base64Decode(
    ...
    'b2dsZS5hZHMuZ29vZ2xlYWRzLnYxNy5yZXNvdXJjZXMuS2V5d29yZFBsYW5BZEdyb3VwSABSBm'
...
const MutateKeywordPlanAdGroupsResponse$json = {
  ...
  '2': [
    ...
    {'1': 'results', '3': 2, '4': 3, '5': 11, '6': '.google.ads.googleads.v17.services.MutateKeywordPlanAdGroupResult', '10': 'results'},
  ],
};
