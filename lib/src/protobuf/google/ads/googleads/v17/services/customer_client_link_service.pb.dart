...
class CustomerClientLinkOperation extends $pb.GeneratedMessage {
  factory CustomerClientLinkOperation({
    $3878.CustomerClientLink? create_1,
    $3878.CustomerClientLink? update,
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(_omitMessageNames ? '' : 'CustomerClientLinkOperation', package: const $pb.PackageName(_omitMessageNames ? '' : 'google.ads.googleads.v17.services'), createEmptyInstance: create)
    ..oo(0, [1, 2])
    ..aOM<$3878.CustomerClientLink>(1, _omitFieldNames ? '' : 'create', subBuilder: $3878.CustomerClientLink.create)
    ..aOM<$3878.CustomerClientLink>(2, _omitFieldNames ? '' : 'update', subBuilder: $3878.CustomerClientLink.create)
  ...
  @$pb.TagNumber(1)
  $3878.CustomerClientLink get create_1 => $_getN(0);
  @$pb.TagNumber(1)
  set create_1($3878.CustomerClientLink v) { setField(1, v); }
  @$pb.TagNumber(1)
  $core.bool hasCreate_1() => $_has(0);
  @$pb.TagNumber(1)
  void clearCreate_1() => clearField(1);
  @$pb.TagNumber(1)
  $3878.CustomerClientLink ensureCreate_1() => $_ensure(0);

  /// Update operation: The link is expected to have a valid resource name.
  @$pb.TagNumber(2)
  $3878.CustomerClientLink get update => $_getN(1);
  @$pb.TagNumber(2)
  set update($3878.CustomerClientLink v) { setField(2, v); }
  @$pb.TagNumber(2)
  $core.bool hasUpdate() => $_has(1);
  @$pb.TagNumber(2)
  void clearUpdate() => clearField(2);
  @$pb.TagNumber(2)
  $3878.CustomerClientLink ensureUpdate() => $_ensure(1);
