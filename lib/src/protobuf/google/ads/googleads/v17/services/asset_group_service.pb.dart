...
class MutateAssetGroupsRequest extends $pb.GeneratedMessage {
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(_omitMessageNames ? '' : 'MutateAssetGroupsRequest', package: const $pb.PackageName(_omitMessageNames ? '' : 'google.ads.googleads.v17.services'), createEmptyInstance: create)
...
class AssetGroupOperation extends $pb.GeneratedMessage {
  factory AssetGroupOperation({
    $3806.AssetGroup? create_1,
    $3806.AssetGroup? update,
    $core.String? remove,
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(_omitMessageNames ? '' : 'AssetGroupOperation', package: const $pb.PackageName(_omitMessageNames ? '' : 'google.ads.googleads.v17.services'), createEmptyInstance: create)
    ..oo(0, [1, 2, 3])
    ..aOM<$3806.AssetGroup>(1, _omitFieldNames ? '' : 'create', subBuilder: $3806.AssetGroup.create)
    ..aOM<$3806.AssetGroup>(2, _omitFieldNames ? '' : 'update', subBuilder: $3806.AssetGroup.create)
  ...
  @$pb.TagNumber(1)
  $3806.AssetGroup get create_1 => $_getN(0);
  @$pb.TagNumber(1)
  set create_1($3806.AssetGroup v) { setField(1, v); }
  @$pb.TagNumber(1)
  $core.bool hasCreate_1() => $_has(0);
  @$pb.TagNumber(1)
  void clearCreate_1() => clearField(1);
  @$pb.TagNumber(1)
  $3806.AssetGroup ensureCreate_1() => $_ensure(0);

  /// Update operation: The asset group is expected to have a valid resource
  /// name.
  @$pb.TagNumber(2)
  $3806.AssetGroup get update => $_getN(1);
  @$pb.TagNumber(2)
  set update($3806.AssetGroup v) { setField(2, v); }
  @$pb.TagNumber(2)
  $core.bool hasUpdate() => $_has(1);
  @$pb.TagNumber(2)
  void clearUpdate() => clearField(2);
  @$pb.TagNumber(2)
  $3806.AssetGroup ensureUpdate() => $_ensure(1);
...
class MutateAssetGroupsResponse extends $pb.GeneratedMessage {
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(_omitMessageNames ? '' : 'MutateAssetGroupsResponse', package: const $pb.PackageName(_omitMessageNames ? '' : 'google.ads.googleads.v17.services'), createEmptyInstance: create)
...
class MutateAssetGroupResult extends $pb.GeneratedMessage {
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(_omitMessageNames ? '' : 'MutateAssetGroupResult', package: const $pb.PackageName(_omitMessageNames ? '' : 'google.ads.googleads.v17.services'), createEmptyInstance: create)
