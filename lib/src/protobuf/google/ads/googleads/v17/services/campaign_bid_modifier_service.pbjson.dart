...
const MutateCampaignBidModifiersRequest$json = {
  ...
  '2': [
    ...
    {'1': 'operations', '3': 2, '4': 3, '5': 11, '6': '.google.ads.googleads.v17.services.CampaignBidModifierOperation', '8': {}, '10': 'operations'},
...
final $typed_data.Uint8List mutateCampaignBidModifiersRequestDescriptor = $convert.base64Decode(
    ...
    'bGVhZHMudjE3LnNlcnZpY2VzLkNhbXBhaWduQmlkTW9kaWZpZXJPcGVyYXRpb25CA+BBAlIKb3'
    ...
    'UYBSABKA4ySy5nb29nbGUuYWRzLmdvb2dsZWFkcy52MTcuZW51bXMuUmVzcG9uc2VDb250ZW50'
...
const CampaignBidModifierOperation$json = {
  ...
  '2': [
    ...
    {'1': 'create', '3': 1, '4': 1, '5': 11, '6': '.google.ads.googleads.v17.resources.CampaignBidModifier', '9': 0, '10': 'create'},
    {'1': 'update', '3': 2, '4': 1, '5': 11, '6': '.google.ads.googleads.v17.resources.CampaignBidModifier', '9': 0, '10': 'update'},
...
final $typed_data.Uint8List campaignBidModifierOperationDescriptor = $convert.base64Decode(
    ...
    'b29nbGUuYWRzLmdvb2dsZWFkcy52MTcucmVzb3VyY2VzLkNhbXBhaWduQmlkTW9kaWZpZXJIAF'
...
const MutateCampaignBidModifiersResponse$json = {
  ...
  '2': [
    ...
    {'1': 'results', '3': 2, '4': 3, '5': 11, '6': '.google.ads.googleads.v17.services.MutateCampaignBidModifierResult', '10': 'results'},
  ],
};
...
final $typed_data.Uint8List mutateCampaignBidModifiersResponseDescriptor = $convert.base64Decode(
    ...
    'B3Jlc3VsdHMYAiADKAsyQi5nb29nbGUuYWRzLmdvb2dsZWFkcy52MTcuc2VydmljZXMuTXV0YX'
...
const MutateCampaignBidModifierResult$json = {
  ...
  '2': [
    ...
    {'1': 'campaign_bid_modifier', '3': 2, '4': 1, '5': 11, '6': '.google.ads.googleads.v17.resources.CampaignBidModifier', '10': 'campaignBidModifier'},
  ],
};
...
final $typed_data.Uint8List mutateCampaignBidModifierResultDescriptor = $convert.base64Decode(
    ...
    'dvb2dsZWFkcy52MTcucmVzb3VyY2VzLkNhbXBhaWduQmlkTW9kaWZpZXJSE2NhbXBhaWduQmlk'
    'TW9kaWZpZXI=');
