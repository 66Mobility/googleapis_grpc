...
const MutateAdGroupCustomizersRequest$json = {
  ...
  '2': [
    ...
    {'1': 'operations', '3': 2, '4': 3, '5': 11, '6': '.google.ads.googleads.v17.services.AdGroupCustomizerOperation', '8': {}, '10': 'operations'},
...
final $typed_data.Uint8List mutateAdGroupCustomizersRequestDescriptor = $convert.base64Decode(
    ...
    'YWRzLnYxNy5zZXJ2aWNlcy5BZEdyb3VwQ3VzdG9taXplck9wZXJhdGlvbkID4EECUgpvcGVyYX'
...
const AdGroupCustomizerOperation$json = {
  ...
  '2': [
    {'1': 'create', '3': 1, '4': 1, '5': 11, '6': '.google.ads.googleads.v17.resources.AdGroupCustomizer', '9': 0, '10': 'create'},
...
final $typed_data.Uint8List adGroupCustomizerOperationDescriptor = $convert.base64Decode(
    ...
    'RzLmdvb2dsZWFkcy52MTcucmVzb3VyY2VzLkFkR3JvdXBDdXN0b21pemVySABSBmNyZWF0ZRJJ'
...
const MutateAdGroupCustomizersResponse$json = {
  ...
  '2': [
    {'1': 'results', '3': 1, '4': 3, '5': 11, '6': '.google.ads.googleads.v17.services.MutateAdGroupCustomizerResult', '10': 'results'},
...
final $typed_data.Uint8List mutateAdGroupCustomizersResponseDescriptor = $convert.base64Decode(
    ...
    '9vZ2xlLmFkcy5nb29nbGVhZHMudjE3LnNlcnZpY2VzLk11dGF0ZUFkR3JvdXBDdXN0b21pemVy'
...
const MutateAdGroupCustomizerResult$json = {
  ...
  '2': [
    ...
    {'1': 'ad_group_customizer', '3': 2, '4': 1, '5': 11, '6': '.google.ads.googleads.v17.resources.AdGroupCustomizer', '10': 'adGroupCustomizer'},
  ],
};
...
final $typed_data.Uint8List mutateAdGroupCustomizerResultDescriptor = $convert.base64Decode(
    ...
    'Fkcy52MTcucmVzb3VyY2VzLkFkR3JvdXBDdXN0b21pemVyUhFhZEdyb3VwQ3VzdG9taXplcg==');
