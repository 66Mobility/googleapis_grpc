...
const MutateAdGroupCriterionLabelsRequest$json = {
  ...
  '2': [
    ...
    {'1': 'operations', '3': 2, '4': 3, '5': 11, '6': '.google.ads.googleads.v17.services.AdGroupCriterionLabelOperation', '8': {}, '10': 'operations'},
...
final $typed_data.Uint8List mutateAdGroupCriterionLabelsRequestDescriptor = $convert.base64Decode(
    ...
    'b2dsZWFkcy52MTcuc2VydmljZXMuQWRHcm91cENyaXRlcmlvbkxhYmVsT3BlcmF0aW9uQgPgQQ'
...
const AdGroupCriterionLabelOperation$json = {
  ...
  '2': [
    {'1': 'create', '3': 1, '4': 1, '5': 11, '6': '.google.ads.googleads.v17.resources.AdGroupCriterionLabel', '9': 0, '10': 'create'},
...
final $typed_data.Uint8List adGroupCriterionLabelOperationDescriptor = $convert.base64Decode(
    ...
    'xlLmFkcy5nb29nbGVhZHMudjE3LnJlc291cmNlcy5BZEdyb3VwQ3JpdGVyaW9uTGFiZWxIAFIG'
...
const MutateAdGroupCriterionLabelsResponse$json = {
  ...
  '2': [
    ...
    {'1': 'results', '3': 2, '4': 3, '5': 11, '6': '.google.ads.googleads.v17.services.MutateAdGroupCriterionLabelResult', '10': 'results'},
  ],
};
...
final $typed_data.Uint8List mutateAdGroupCriterionLabelsResponseDescriptor = $convert.base64Decode(
    ...
    'XgoHcmVzdWx0cxgCIAMoCzJELmdvb2dsZS5hZHMuZ29vZ2xlYWRzLnYxNy5zZXJ2aWNlcy5NdX'
