...
const MutateCustomerUserAccessInvitationRequest$json = {
  ...
  '2': [
    ...
    {'1': 'operation', '3': 2, '4': 1, '5': 11, '6': '.google.ads.googleads.v17.services.CustomerUserAccessInvitationOperation', '8': {}, '10': 'operation'},
  ],
};
...
final $typed_data.Uint8List mutateCustomerUserAccessInvitationRequestDescriptor = $convert.base64Decode(
    ...
    'ZHMuZ29vZ2xlYWRzLnYxNy5zZXJ2aWNlcy5DdXN0b21lclVzZXJBY2Nlc3NJbnZpdGF0aW9uT3'
...
const CustomerUserAccessInvitationOperation$json = {
  ...
  '2': [
    {'1': 'create', '3': 1, '4': 1, '5': 11, '6': '.google.ads.googleads.v17.resources.CustomerUserAccessInvitation', '9': 0, '10': 'create'},
...
final $typed_data.Uint8List customerUserAccessInvitationOperationDescriptor = $convert.base64Decode(
    ...
    'JALmdvb2dsZS5hZHMuZ29vZ2xlYWRzLnYxNy5yZXNvdXJjZXMuQ3VzdG9tZXJVc2VyQWNjZXNz'
...
const MutateCustomerUserAccessInvitationResponse$json = {
  ...
  '2': [
    {'1': 'result', '3': 1, '4': 1, '5': 11, '6': '.google.ads.googleads.v17.services.MutateCustomerUserAccessInvitationResult', '10': 'result'},
  ],
};
...
final $typed_data.Uint8List mutateCustomerUserAccessInvitationResponseDescriptor = $convert.base64Decode(
    ...
    'EgASgLMksuZ29vZ2xlLmFkcy5nb29nbGVhZHMudjE3LnNlcnZpY2VzLk11dGF0ZUN1c3RvbWVy'
