...
class MutateAdGroupCriterionCustomizersRequest extends $pb.GeneratedMessage {
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(_omitMessageNames ? '' : 'MutateAdGroupCriterionCustomizersRequest', package: const $pb.PackageName(_omitMessageNames ? '' : 'google.ads.googleads.v17.services'), createEmptyInstance: create)
...
class AdGroupCriterionCustomizerOperation extends $pb.GeneratedMessage {
  factory AdGroupCriterionCustomizerOperation({
    $3799.AdGroupCriterionCustomizer? create_1,
    $core.String? remove,
  }) {
    final $result = create();
    if (create_1 != null) {
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(_omitMessageNames ? '' : 'AdGroupCriterionCustomizerOperation', package: const $pb.PackageName(_omitMessageNames ? '' : 'google.ads.googleads.v17.services'), createEmptyInstance: create)
    ..oo(0, [1, 2])
    ..aOM<$3799.AdGroupCriterionCustomizer>(1, _omitFieldNames ? '' : 'create', subBuilder: $3799.AdGroupCriterionCustomizer.create)
  ...
  @$pb.TagNumber(1)
  $3799.AdGroupCriterionCustomizer get create_1 => $_getN(0);
  @$pb.TagNumber(1)
  set create_1($3799.AdGroupCriterionCustomizer v) { setField(1, v); }
  @$pb.TagNumber(1)
  $core.bool hasCreate_1() => $_has(0);
  @$pb.TagNumber(1)
  void clearCreate_1() => clearField(1);
  @$pb.TagNumber(1)
  $3799.AdGroupCriterionCustomizer ensureCreate_1() => $_ensure(0);
...
class MutateAdGroupCriterionCustomizersResponse extends $pb.GeneratedMessage {
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(_omitMessageNames ? '' : 'MutateAdGroupCriterionCustomizersResponse', package: const $pb.PackageName(_omitMessageNames ? '' : 'google.ads.googleads.v17.services'), createEmptyInstance: create)
...
class MutateAdGroupCriterionCustomizerResult extends $pb.GeneratedMessage {
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(_omitMessageNames ? '' : 'MutateAdGroupCriterionCustomizerResult', package: const $pb.PackageName(_omitMessageNames ? '' : 'google.ads.googleads.v17.services'), createEmptyInstance: create)
    ..aOS(1, _omitFieldNames ? '' : 'resourceName')
    ..aOM<$3799.AdGroupCriterionCustomizer>(2, _omitFieldNames ? '' : 'adGroupCriterionCustomizer', subBuilder: $3799.AdGroupCriterionCustomizer.create)
    ..hasRequiredFields = false
  ;
  ...
  /// to "MUTABLE_RESOURCE".
  @$pb.TagNumber(2)
  $3799.AdGroupCriterionCustomizer get adGroupCriterionCustomizer => $_getN(1);
  @$pb.TagNumber(2)
  set adGroupCriterionCustomizer($3799.AdGroupCriterionCustomizer v) { setField(2, v); }
  @$pb.TagNumber(2)
  $core.bool hasAdGroupCriterionCustomizer() => $_has(1);
  @$pb.TagNumber(2)
  void clearAdGroupCriterionCustomizer() => clearField(2);
  @$pb.TagNumber(2)
  $3799.AdGroupCriterionCustomizer ensureAdGroupCriterionCustomizer() => $_ensure(1);
}
