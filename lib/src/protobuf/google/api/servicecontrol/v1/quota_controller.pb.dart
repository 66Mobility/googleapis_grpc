...
class QuotaOperation extends $pb.GeneratedMessage {
  factory QuotaOperation({
    ...
    $core.Iterable<$402.MetricValueSet>? quotaMetrics,
  ...
  @$pb.TagNumber(5)
  $core.List<$402.MetricValueSet> get quotaMetrics => $_getList(4);
...
class AllocateQuotaResponse extends $pb.GeneratedMessage {
  ...
  @$pb.TagNumber(3)
  $core.List<$402.MetricValueSet> get quotaMetrics => $_getList(2);
...
class QuotaError extends $pb.GeneratedMessage {
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(
    ...
    ..aOM<$350.Status>(4, _omitFieldNames ? '' : 'status',
  ...
  @$pb.TagNumber(4)
  $350.Status ensureStatus() => $_ensure(3);
}
