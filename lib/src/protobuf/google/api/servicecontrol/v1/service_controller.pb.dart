...
import 'check_error.pb.dart' as $405;
import 'operation.pb.dart' as $404;
...
class CheckRequest extends $pb.GeneratedMessage {
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(
    ...
    ..aOM<$404.Operation>(2, _omitFieldNames ? '' : 'operation',
        subBuilder: $404.Operation.create)
  ...
  @$pb.TagNumber(2)
  $404.Operation get operation => $_getN(1);
  @$pb.TagNumber(2)
  set operation($404.Operation v) {
    setField(2, v);
  }
  ...
  @$pb.TagNumber(2)
  $404.Operation ensureOperation() => $_ensure(1);
...
class CheckResponse extends $pb.GeneratedMessage {
  factory CheckResponse({
    ...
    $core.Iterable<$405.CheckError>? checkErrors,
    $core.String? serviceConfigId,
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(
    ...
    ..pc<$405.CheckError>(
        ...
        subBuilder: $405.CheckError.create)
  ...
  ///  appropriate action.
  @$pb.TagNumber(2)
  $core.List<$405.CheckError> get checkErrors => $_getList(1);
...
class ReportRequest extends $pb.GeneratedMessage {
  factory ReportRequest({
    $core.String? serviceName,
    $core.Iterable<$404.Operation>? operations,
    $core.String? serviceConfigId,
  }) {
    final $result = create();
    if (serviceName != null) {
  ...
  @$pb.TagNumber(2)
  $core.List<$404.Operation> get operations => $_getList(1);
