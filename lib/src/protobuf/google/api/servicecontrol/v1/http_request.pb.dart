...
class HttpRequest extends $pb.GeneratedMessage {
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(_omitMessageNames ? '' : 'HttpRequest', package: const $pb.PackageName(_omitMessageNames ? '' : 'google.api.servicecontrol.v1'), createEmptyInstance: create)
    ...
    ..aOM<$261.Duration>(14, _omitFieldNames ? '' : 'latency', subBuilder: $261.Duration.create)
  ...
  @$pb.TagNumber(14)
  $261.Duration get latency => $_getN(13);
  @$pb.TagNumber(14)
  set latency($261.Duration v) { setField(14, v); }
  @$pb.TagNumber(14)
  $core.bool hasLatency() => $_has(13);
  @$pb.TagNumber(14)
  void clearLatency() => clearField(14);
  @$pb.TagNumber(14)
  $261.Duration ensureLatency() => $_ensure(13);
