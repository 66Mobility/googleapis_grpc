...
import '../../distribution.pb.dart' as $366;
...
class Distribution_LinearBuckets extends $pb.GeneratedMessage {
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(_omitMessageNames ? '' : 'Distribution.LinearBuckets', package: const $pb.PackageName(_omitMessageNames ? '' : 'google.api.servicecontrol.v1'), createEmptyInstance: create)
  ...
  'Will be removed in next major version')
  Distribution_LinearBuckets copyWith(void Function(Distribution_LinearBuckets) updates) => super.copyWith((message) => updates(message as Distribution_LinearBuckets)) as Distribution_LinearBuckets;
...
class Distribution_ExponentialBuckets extends $pb.GeneratedMessage {
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(_omitMessageNames ? '' : 'Distribution.ExponentialBuckets', package: const $pb.PackageName(_omitMessageNames ? '' : 'google.api.servicecontrol.v1'), createEmptyInstance: create)
    ..a<$core.int>(1, _omitFieldNames ? '' : 'numFiniteBuckets', $pb.PbFieldType.O3)
  ...
  'Use [GeneratedMessageGenericExtensions.rebuild] instead. '
  'Will be removed in next major version')
  Distribution_ExponentialBuckets copyWith(void Function(Distribution_ExponentialBuckets) updates) => super.copyWith((message) => updates(message as Distribution_ExponentialBuckets)) as Distribution_ExponentialBuckets;
...
class Distribution_ExplicitBuckets extends $pb.GeneratedMessage {
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(_omitMessageNames ? '' : 'Distribution.ExplicitBuckets', package: const $pb.PackageName(_omitMessageNames ? '' : 'google.api.servicecontrol.v1'), createEmptyInstance: create)
  ...
  'Use [GeneratedMessageGenericExtensions.rebuild] instead. '
  'Will be removed in next major version')
  Distribution_ExplicitBuckets copyWith(void Function(Distribution_ExplicitBuckets) updates) => super.copyWith((message) => updates(message as Distribution_ExplicitBuckets)) as Distribution_ExplicitBuckets;
...
class Distribution extends $pb.GeneratedMessage {
  factory Distribution({
    ...
    $core.Iterable<$366.Distribution_Exemplar>? exemplars,
  }) {
    final $result = create();
    if (count != null) {
      $result.count = count;
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(_omitMessageNames ? '' : 'Distribution', package: const $pb.PackageName(_omitMessageNames ? '' : 'google.api.servicecontrol.v1'), createEmptyInstance: create)
    ..oo(0, [7, 8, 9])
    ...
    ..a<$core.double>(5, _omitFieldNames ? '' : 'sumOfSquaredDeviation', $pb.PbFieldType.OD)
    ..p<$fixnum.Int64>(6, _omitFieldNames ? '' : 'bucketCounts', $pb.PbFieldType.K6)
    ...
    ..pc<$366.Distribution_Exemplar>(10, _omitFieldNames ? '' : 'exemplars', $pb.PbFieldType.PM, subBuilder: $366.Distribution_Exemplar.create)
    ..hasRequiredFields = false
  ;
  ...
  @$pb.TagNumber(10)
  $core.List<$366.Distribution_Exemplar> get exemplars => $_getList(9);
}
