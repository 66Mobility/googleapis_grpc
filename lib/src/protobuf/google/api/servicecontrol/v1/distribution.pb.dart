...
import '../../distribution.pb.dart' as $364;
...
class Distribution extends $pb.GeneratedMessage {
  factory Distribution({
    ...
    $core.Iterable<$364.Distribution_Exemplar>? exemplars,
  }) {
    final $result = create();
    if (count != null) {
      $result.count = count;
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(_omitMessageNames ? '' : 'Distribution', package: const $pb.PackageName(_omitMessageNames ? '' : 'google.api.servicecontrol.v1'), createEmptyInstance: create)
    ...
    ..pc<$364.Distribution_Exemplar>(10, _omitFieldNames ? '' : 'exemplars', $pb.PbFieldType.PM, subBuilder: $364.Distribution_Exemplar.create)
    ..hasRequiredFields = false
  ;
  ...
  @$pb.TagNumber(10)
  $core.List<$364.Distribution_Exemplar> get exemplars => $_getList(9);
}
