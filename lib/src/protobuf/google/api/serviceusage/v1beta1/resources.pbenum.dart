...
class QuotaView extends $pb.ProtobufEnum {
  static const QuotaView QUOTA_VIEW_UNSPECIFIED = QuotaView._(0, _omitEnumNames ? '' : 'QUOTA_VIEW_UNSPECIFIED');
...
class QuotaSafetyCheck extends $pb.ProtobufEnum {
  ...
  static const QuotaSafetyCheck LIMIT_DECREASE_BELOW_USAGE = QuotaSafetyCheck._(1, _omitEnumNames ? '' : 'LIMIT_DECREASE_BELOW_USAGE');
  static const QuotaSafetyCheck LIMIT_DECREASE_PERCENTAGE_TOO_HIGH = QuotaSafetyCheck._(2, _omitEnumNames ? '' : 'LIMIT_DECREASE_PERCENTAGE_TOO_HIGH');
