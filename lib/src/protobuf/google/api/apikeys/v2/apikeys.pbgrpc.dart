...
class ApiKeysClient extends $grpc.Client {
  ...
  $grpc.ResponseFuture<$13.Operation> createKey($34.CreateKeyRequest request,
      {$grpc.CallOptions? options}) {
    return $createUnaryCall(_$createKey, request, options: options);
  }

  $grpc.ResponseFuture<$34.ListKeysResponse> listKeys(
      $34.ListKeysRequest request,
      {$grpc.CallOptions? options}) {
    return $createUnaryCall(_$listKeys, request, options: options);
  }

  $grpc.ResponseFuture<$35.Key> getKey($34.GetKeyRequest request,
      {$grpc.CallOptions? options}) {
    return $createUnaryCall(_$getKey, request, options: options);
  }

  $grpc.ResponseFuture<$34.GetKeyStringResponse> getKeyString(
      $34.GetKeyStringRequest request,
      {$grpc.CallOptions? options}) {
    return $createUnaryCall(_$getKeyString, request, options: options);
  }

  $grpc.ResponseFuture<$13.Operation> updateKey($34.UpdateKeyRequest request,
      {$grpc.CallOptions? options}) {
    return $createUnaryCall(_$updateKey, request, options: options);
  }

  $grpc.ResponseFuture<$13.Operation> deleteKey($34.DeleteKeyRequest request,
      {$grpc.CallOptions? options}) {
    return $createUnaryCall(_$deleteKey, request, options: options);
  }

  $grpc.ResponseFuture<$13.Operation> undeleteKey(
      $34.UndeleteKeyRequest request,
      {$grpc.CallOptions? options}) {
    return $createUnaryCall(_$undeleteKey, request, options: options);
  }

  $grpc.ResponseFuture<$34.LookupKeyResponse> lookupKey(
      $34.LookupKeyRequest request,
      {$grpc.CallOptions? options}) {
...
abstract class ApiKeysServiceBase extends $grpc.Service {
  ...
  ApiKeysServiceBase() {
    ...
    $addMethod(
        $grpc.ServiceMethod<$34.GetKeyStringRequest, $34.GetKeyStringResponse>(
            'GetKeyString',
            getKeyString_Pre,
            false,
            false,
            ($core.List<$core.int> value) =>
                $34.GetKeyStringRequest.fromBuffer(value),
    ...
    $addMethod($grpc.ServiceMethod<$34.UndeleteKeyRequest, $13.Operation>(
        ...
        false,
        ($core.List<$core.int> value) =>
            $34.UndeleteKeyRequest.fromBuffer(value),
        ($13.Operation value) => value.writeToBuffer()));
  ...
  $async.Future<$13.Operation> createKey_Pre($grpc.ServiceCall call,
      $async.Future<$34.CreateKeyRequest> request) async {
    return createKey(call, await request);
  }

  $async.Future<$34.ListKeysResponse> listKeys_Pre($grpc.ServiceCall call,
      $async.Future<$34.ListKeysRequest> request) async {
    return listKeys(call, await request);
  }

  $async.Future<$35.Key> getKey_Pre(
      $grpc.ServiceCall call, $async.Future<$34.GetKeyRequest> request) async {
    return getKey(call, await request);
  }

  $async.Future<$34.GetKeyStringResponse> getKeyString_Pre(
      $grpc.ServiceCall call,
      $async.Future<$34.GetKeyStringRequest> request) async {
    return getKeyString(call, await request);
  }

  $async.Future<$13.Operation> updateKey_Pre($grpc.ServiceCall call,
      $async.Future<$34.UpdateKeyRequest> request) async {
    return updateKey(call, await request);
  }

  $async.Future<$13.Operation> deleteKey_Pre($grpc.ServiceCall call,
      $async.Future<$34.DeleteKeyRequest> request) async {
    return deleteKey(call, await request);
  }

  $async.Future<$13.Operation> undeleteKey_Pre($grpc.ServiceCall call,
      $async.Future<$34.UndeleteKeyRequest> request) async {
    return undeleteKey(call, await request);
  }

  $async.Future<$34.LookupKeyResponse> lookupKey_Pre($grpc.ServiceCall call,
      $async.Future<$34.LookupKeyRequest> request) async {
    return lookupKey(call, await request);
  }

  $async.Future<$13.Operation> createKey(
      $grpc.ServiceCall call, $34.CreateKeyRequest request);
  $async.Future<$34.ListKeysResponse> listKeys(
      $grpc.ServiceCall call, $34.ListKeysRequest request);
  $async.Future<$35.Key> getKey(
      $grpc.ServiceCall call, $34.GetKeyRequest request);
  $async.Future<$34.GetKeyStringResponse> getKeyString(
      $grpc.ServiceCall call, $34.GetKeyStringRequest request);
  $async.Future<$13.Operation> updateKey(
      $grpc.ServiceCall call, $34.UpdateKeyRequest request);
  $async.Future<$13.Operation> deleteKey(
      $grpc.ServiceCall call, $34.DeleteKeyRequest request);
  $async.Future<$13.Operation> undeleteKey(
      $grpc.ServiceCall call, $34.UndeleteKeyRequest request);
  $async.Future<$34.LookupKeyResponse> lookupKey(
      $grpc.ServiceCall call, $34.LookupKeyRequest request);
}
