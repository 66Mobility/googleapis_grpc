...
class Control extends $pb.GeneratedMessage {
  factory Control({
    ...
    $core.Iterable<$371.MethodPolicy>? methodPolicies,
  }) {
    final $result = create();
    if (environment != null) {
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(
    ...
    ..pc<$371.MethodPolicy>(
        ...
        subBuilder: $371.MethodPolicy.create)
  ...
  @$pb.TagNumber(4)
  $core.List<$371.MethodPolicy> get methodPolicies => $_getList(1);
}
