...
import '../protobuf/type.pb.dart' as $381;
import '../protobuf/wrappers.pb.dart' as $335;
import 'auth.pb.dart' as $386;
import 'backend.pb.dart' as $384;
import 'billing.pb.dart' as $392;
import 'client.pb.dart' as $397;
import 'context.pb.dart' as $387;
import 'control.pb.dart' as $390;
import 'documentation.pb.dart' as $383;
import 'endpoint.pb.dart' as $389;
import 'http.pb.dart' as $331;
import 'log.pb.dart' as $391;
import 'logging.pb.dart' as $393;
import 'metric.pb.dart' as $223;
import 'monitored_resource.pb.dart' as $222;
import 'monitoring.pb.dart' as $394;
import 'quota.pb.dart' as $385;
import 'source_info.pb.dart' as $396;
import 'system_parameter.pb.dart' as $395;
...
class Service extends $pb.GeneratedMessage {
  factory Service({
    ...
    $core.Iterable<$381.Type>? types,
    $core.Iterable<$381.Enum>? enums,
    ...
    $335.UInt32Value? configVersion,
    $390.Control? control,
    $core.String? producerProjectId,
    $core.Iterable<$391.LogDescriptor>? logs,
    $core.Iterable<$223.MetricDescriptor>? metrics,
    $core.Iterable<$222.MonitoredResourceDescriptor>? monitoredResources,
    $392.Billing? billing,
    $393.Logging? logging,
    $394.Monitoring? monitoring,
    $395.SystemParameters? systemParameters,
    $core.String? id,
    $396.SourceInfo? sourceInfo,
    $397.Publishing? publishing,
  }) {
    final $result = create();
    if (name != null) {
      $result.name = name;
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(
    ...
    ..pc<$381.Type>(4, _omitFieldNames ? '' : 'types', $pb.PbFieldType.PM,
        subBuilder: $381.Type.create)
    ..pc<$381.Enum>(5, _omitFieldNames ? '' : 'enums', $pb.PbFieldType.PM,
        subBuilder: $381.Enum.create)
    ..aOM<$383.Documentation>(6, _omitFieldNames ? '' : 'documentation',
        subBuilder: $383.Documentation.create)
    ..aOM<$384.Backend>(8, _omitFieldNames ? '' : 'backend',
        subBuilder: $384.Backend.create)
    ..aOM<$331.Http>(9, _omitFieldNames ? '' : 'http',
        subBuilder: $331.Http.create)
    ...
    ..aOM<$387.Context>(12, _omitFieldNames ? '' : 'context',
        subBuilder: $387.Context.create)
    ...
    ..aOM<$335.UInt32Value>(20, _omitFieldNames ? '' : 'configVersion',
        subBuilder: $335.UInt32Value.create)
    ..aOM<$390.Control>(21, _omitFieldNames ? '' : 'control',
        subBuilder: $390.Control.create)
    ..aOS(22, _omitFieldNames ? '' : 'producerProjectId')
    ..pc<$391.LogDescriptor>(
        23, _omitFieldNames ? '' : 'logs', $pb.PbFieldType.PM,
        subBuilder: $391.LogDescriptor.create)
    ..pc<$223.MetricDescriptor>(
    ...
    ..aOM<$392.Billing>(26, _omitFieldNames ? '' : 'billing',
        subBuilder: $392.Billing.create)
    ..aOM<$393.Logging>(27, _omitFieldNames ? '' : 'logging',
        subBuilder: $393.Logging.create)
    ..aOM<$394.Monitoring>(28, _omitFieldNames ? '' : 'monitoring',
        subBuilder: $394.Monitoring.create)
    ..aOM<$395.SystemParameters>(29, _omitFieldNames ? '' : 'systemParameters',
        subBuilder: $395.SystemParameters.create)
    ..aOS(33, _omitFieldNames ? '' : 'id')
    ..aOM<$396.SourceInfo>(37, _omitFieldNames ? '' : 'sourceInfo',
        subBuilder: $396.SourceInfo.create)
    ..aOM<$397.Publishing>(45, _omitFieldNames ? '' : 'publishing',
        subBuilder: $397.Publishing.create)
  ...
  @$pb.TagNumber(4)
  $core.List<$381.Type> get types => $_getList(3);
  ...
  @$pb.TagNumber(5)
  $core.List<$381.Enum> get enums => $_getList(4);

  /// Additional API documentation.
  @$pb.TagNumber(6)
  $383.Documentation get documentation => $_getN(5);
  @$pb.TagNumber(6)
  ...
  @$pb.TagNumber(6)
  $383.Documentation ensureDocumentation() => $_ensure(5);

  /// API backend configuration.
  @$pb.TagNumber(8)
  $384.Backend get backend => $_getN(6);
  @$pb.TagNumber(8)
  set backend($384.Backend v) {
    setField(8, v);
  }
  ...
  @$pb.TagNumber(8)
  $384.Backend ensureBackend() => $_ensure(6);

  /// HTTP configuration.
  @$pb.TagNumber(9)
  $331.Http get http => $_getN(7);
  @$pb.TagNumber(9)
  set http($331.Http v) {
    setField(9, v);
  }
  ...
  @$pb.TagNumber(9)
  $331.Http ensureHttp() => $_ensure(7);

  /// Quota configuration.
  @$pb.TagNumber(10)
  $385.Quota get quota => $_getN(8);
  @$pb.TagNumber(10)
  ...
  @$pb.TagNumber(10)
  $385.Quota ensureQuota() => $_ensure(8);

  /// Auth configuration.
  @$pb.TagNumber(11)
  $386.Authentication get authentication => $_getN(9);
  @$pb.TagNumber(11)
  ...
  @$pb.TagNumber(11)
  $386.Authentication ensureAuthentication() => $_ensure(9);

  /// Context configuration.
  @$pb.TagNumber(12)
  $387.Context get context => $_getN(10);
  @$pb.TagNumber(12)
  set context($387.Context v) {
    setField(12, v);
  }
  ...
  @$pb.TagNumber(12)
  $387.Context ensureContext() => $_ensure(10);

  /// Configuration controlling usage of this service.
  @$pb.TagNumber(15)
  $388.Usage get usage => $_getN(11);
  @$pb.TagNumber(15)
  ...
  @$pb.TagNumber(15)
  $388.Usage ensureUsage() => $_ensure(11);

  /// Configuration for network endpoints.  If this is empty, then an endpoint
  /// with the same name as the service is automatically generated to service all
  /// defined APIs.
  @$pb.TagNumber(18)
  $core.List<$389.Endpoint> get endpoints => $_getList(12);
  ...
  @$pb.TagNumber(20)
  $335.UInt32Value get configVersion => $_getN(13);
  @$pb.TagNumber(20)
  set configVersion($335.UInt32Value v) {
    setField(20, v);
  }
  ...
  @$pb.TagNumber(20)
  $335.UInt32Value ensureConfigVersion() => $_ensure(13);

  /// Configuration for the service control plane.
  @$pb.TagNumber(21)
  $390.Control get control => $_getN(14);
  @$pb.TagNumber(21)
  set control($390.Control v) {
    setField(21, v);
  }
  ...
  @$pb.TagNumber(21)
  $390.Control ensureControl() => $_ensure(14);
  ...
  @$pb.TagNumber(23)
  $core.List<$391.LogDescriptor> get logs => $_getList(16);

  /// Defines the metrics used by this service.
  @$pb.TagNumber(24)
  $core.List<$223.MetricDescriptor> get metrics => $_getList(17);
  ...
  @$pb.TagNumber(26)
  $392.Billing get billing => $_getN(19);
  @$pb.TagNumber(26)
  set billing($392.Billing v) {
    setField(26, v);
  }
  ...
  @$pb.TagNumber(26)
  $392.Billing ensureBilling() => $_ensure(19);

  /// Logging configuration.
  @$pb.TagNumber(27)
  $393.Logging get logging => $_getN(20);
  @$pb.TagNumber(27)
  set logging($393.Logging v) {
    setField(27, v);
  }
  ...
  @$pb.TagNumber(27)
  $393.Logging ensureLogging() => $_ensure(20);

  /// Monitoring configuration.
  @$pb.TagNumber(28)
  $394.Monitoring get monitoring => $_getN(21);
  @$pb.TagNumber(28)
  ...
  @$pb.TagNumber(28)
  $394.Monitoring ensureMonitoring() => $_ensure(21);

  /// System parameter configuration.
  @$pb.TagNumber(29)
  $395.SystemParameters get systemParameters => $_getN(22);
  @$pb.TagNumber(29)
  set systemParameters($395.SystemParameters v) {
    setField(29, v);
  }
  ...
  @$pb.TagNumber(29)
  $395.SystemParameters ensureSystemParameters() => $_ensure(22);
  ...
  @$pb.TagNumber(37)
  $396.SourceInfo get sourceInfo => $_getN(24);
  @$pb.TagNumber(37)
  set sourceInfo($396.SourceInfo v) {
    setField(37, v);
  }
  ...
  @$pb.TagNumber(37)
  $396.SourceInfo ensureSourceInfo() => $_ensure(24);

  /// Settings for [Google Cloud Client
  /// libraries](https://cloud.google.com/apis/docs/cloud-client-libraries)
  /// generated from APIs defined as protocol buffers.
  @$pb.TagNumber(45)
  $397.Publishing get publishing => $_getN(25);
  @$pb.TagNumber(45)
  set publishing($397.Publishing v) {
    setField(45, v);
  }
  ...
  @$pb.TagNumber(45)
  $397.Publishing ensurePublishing() => $_ensure(25);
}
