...
class SourceInfo extends $pb.GeneratedMessage {
  factory SourceInfo({
    $core.Iterable<$1795.Any>? sourceFiles,
  }) {
    final $result = create();
    if (sourceFiles != null) {
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(_omitMessageNames ? '' : 'SourceInfo', package: const $pb.PackageName(_omitMessageNames ? '' : 'google.api'), createEmptyInstance: create)
    ..pc<$1795.Any>(1, _omitFieldNames ? '' : 'sourceFiles', $pb.PbFieldType.PM, subBuilder: $1795.Any.create)
  ...
  @$pb.TagNumber(1)
  $core.List<$1795.Any> get sourceFiles => $_getList(0);
}
