...
import 'resources.pbenum.dart' as $54;
...
class ListQuotaInfosResponse extends $pb.GeneratedMessage {
  factory ListQuotaInfosResponse({
    $core.Iterable<$54.QuotaInfo>? quotaInfos,
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(
    ...
    ..pc<$54.QuotaInfo>(
        ...
        subBuilder: $54.QuotaInfo.create)
  ...
  @$pb.TagNumber(1)
  $core.List<$54.QuotaInfo> get quotaInfos => $_getList(0);
...
class ListQuotaPreferencesResponse extends $pb.GeneratedMessage {
  factory ListQuotaPreferencesResponse({
    $core.Iterable<$54.QuotaPreference>? quotaPreferences,
    $core.String? nextPageToken,
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(
      ...
      package: const $pb.PackageName(
          _omitMessageNames ? '' : 'google.api.cloudquotas.v1beta'),
      createEmptyInstance: create)
    ..pc<$54.QuotaPreference>(
        1, _omitFieldNames ? '' : 'quotaPreferences', $pb.PbFieldType.PM,
        subBuilder: $54.QuotaPreference.create)
    ..aOS(2, _omitFieldNames ? '' : 'nextPageToken')
  ...
  @$pb.TagNumber(1)
  $core.List<$54.QuotaPreference> get quotaPreferences => $_getList(0);
...
class CreateQuotaPreferenceRequest extends $pb.GeneratedMessage {
  factory CreateQuotaPreferenceRequest({
    ...
    $54.QuotaPreference? quotaPreference,
    $core.Iterable<$54.QuotaSafetyCheck>? ignoreSafetyChecks,
  }) {
    final $result = create();
    if (parent != null) {
      $result.parent = parent;
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(
    ...
    ..aOM<$54.QuotaPreference>(3, _omitFieldNames ? '' : 'quotaPreference',
        subBuilder: $54.QuotaPreference.create)
    ..pc<$54.QuotaSafetyCheck>(
        4, _omitFieldNames ? '' : 'ignoreSafetyChecks', $pb.PbFieldType.KE,
        valueOf: $54.QuotaSafetyCheck.valueOf,
        enumValues: $54.QuotaSafetyCheck.values,
        defaultEnumValue: $54.QuotaSafetyCheck.QUOTA_SAFETY_CHECK_UNSPECIFIED)
    ..hasRequiredFields = false;
  ...
  @$pb.TagNumber(3)
  $54.QuotaPreference get quotaPreference => $_getN(2);
  @$pb.TagNumber(3)
  set quotaPreference($54.QuotaPreference v) {
    setField(3, v);
  }
  ...
  @$pb.TagNumber(3)
  $54.QuotaPreference ensureQuotaPreference() => $_ensure(2);

  /// The list of quota safety checks to be ignored.
  @$pb.TagNumber(4)
  $core.List<$54.QuotaSafetyCheck> get ignoreSafetyChecks => $_getList(3);
}
...
class UpdateQuotaPreferenceRequest extends $pb.GeneratedMessage {
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(
    ...
    ..aOM<$54.QuotaPreference>(2, _omitFieldNames ? '' : 'quotaPreference',
        subBuilder: $54.QuotaPreference.create)
  ...
  @$pb.TagNumber(2)
  $54.QuotaPreference get quotaPreference => $_getN(1);
  @$pb.TagNumber(2)
  set quotaPreference($54.QuotaPreference v) {
    setField(2, v);
  }
  ...
  @$pb.TagNumber(2)
  $54.QuotaPreference ensureQuotaPreference() => $_ensure(1);
  ...
  /// The list of quota safety checks to be ignored.
  @$pb.TagNumber(5)
  $core.List<$54.QuotaSafetyCheck> get ignoreSafetyChecks => $_getList(4);
}
