...
class ExprValue extends $pb.GeneratedMessage {
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(
      ...
      createEmptyInstance: create)
    ..oo(0, [1, 2, 3])
    ..aOM<$378.Value>(1, _omitFieldNames ? '' : 'value',
        subBuilder: $378.Value.create)
  ...
  /// A concrete value.
  @$pb.TagNumber(1)
  $378.Value get value => $_getN(0);
  @$pb.TagNumber(1)
  set value($378.Value v) {
    setField(1, v);
  }
  ...
  @$pb.TagNumber(1)
  $378.Value ensureValue() => $_ensure(0);
...
class ErrorSet extends $pb.GeneratedMessage {
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(
      ...
      package: const $pb.PackageName(
          _omitMessageNames ? '' : 'google.api.expr.v1beta1'),
      createEmptyInstance: create)
    ..pc<$350.Status>(1, _omitFieldNames ? '' : 'errors', $pb.PbFieldType.PM,
  ...
  @$pb.TagNumber(1)
  $core.List<$350.Status> get errors => $_getList(0);
}
