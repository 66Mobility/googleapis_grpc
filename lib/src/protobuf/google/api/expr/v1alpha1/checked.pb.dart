...
import '../../../protobuf/struct.pbenum.dart' as $289;
import 'checked.pbenum.dart';
import 'syntax.pb.dart' as $372;
...
class CheckedExpr extends $pb.GeneratedMessage {
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(
    ...
    ..m<$fixnum.Int64, Type>(3, _omitFieldNames ? '' : 'typeMap',
        ...
        packageName: const $pb.PackageName('google.api.expr.v1alpha1'))
    ..aOM<$372.Expr>(4, _omitFieldNames ? '' : 'expr',
        subBuilder: $372.Expr.create)
    ..aOM<$372.SourceInfo>(5, _omitFieldNames ? '' : 'sourceInfo',
        subBuilder: $372.SourceInfo.create)
  ...
  @$pb.TagNumber(4)
  $372.Expr ensureExpr() => $_ensure(2);

  /// The source info derived from input that generated the parsed `expr` and
  /// any optimizations made during the type-checking pass.
  @$pb.TagNumber(5)
  $372.SourceInfo get sourceInfo => $_getN(3);
  @$pb.TagNumber(5)
  set sourceInfo($372.SourceInfo v) {
    setField(5, v);
  }
  ...
  @$pb.TagNumber(5)
  $372.SourceInfo ensureSourceInfo() => $_ensure(3);
...
class Type extends $pb.GeneratedMessage {
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(
    ...
    ..e<$289.NullValue>(2, _omitFieldNames ? '' : 'null', $pb.PbFieldType.OE,
        defaultOrMaker: $289.NullValue.NULL_VALUE,
        valueOf: $289.NullValue.valueOf,
        enumValues: $289.NullValue.values)
  ...
  /// Null value.
  @$pb.TagNumber(2)
  $289.NullValue get null_2 => $_getN(1);
  @$pb.TagNumber(2)
  set null_2($289.NullValue v) {
    setField(2, v);
  }
...
class Decl_IdentDecl extends $pb.GeneratedMessage {
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(
    ...
    ..aOM<$372.Constant>(2, _omitFieldNames ? '' : 'value',
        subBuilder: $372.Constant.create)
  ...
  @$pb.TagNumber(2)
  $372.Constant get value => $_getN(1);
  @$pb.TagNumber(2)
  set value($372.Constant v) {
    setField(2, v);
  }
  ...
  @$pb.TagNumber(2)
  $372.Constant ensureValue() => $_ensure(1);
...
class Reference extends $pb.GeneratedMessage {
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(
    ...
    ..aOM<$372.Constant>(4, _omitFieldNames ? '' : 'value',
        subBuilder: $372.Constant.create)
    ..hasRequiredFields = false;
  ...
  @$pb.TagNumber(4)
  $372.Constant get value => $_getN(2);
  @$pb.TagNumber(4)
  set value($372.Constant v) {
    setField(4, v);
  }
  ...
  @$pb.TagNumber(4)
  $372.Constant ensureValue() => $_ensure(2);
}
