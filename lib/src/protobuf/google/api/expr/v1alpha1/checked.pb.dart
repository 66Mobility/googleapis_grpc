...
class CheckedExpr extends $pb.GeneratedMessage {
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(_omitMessageNames ? '' : 'CheckedExpr', package: const $pb.PackageName(_omitMessageNames ? '' : 'google.api.expr.v1alpha1'), createEmptyInstance: create)
    ...
    ..aOM<$4156.Expr>(4, _omitFieldNames ? '' : 'expr', subBuilder: $4156.Expr.create)
    ..aOM<$4156.SourceInfo>(5, _omitFieldNames ? '' : 'sourceInfo', subBuilder: $4156.SourceInfo.create)
  ...
  @$pb.TagNumber(4)
  $4156.Expr get expr => $_getN(2);
  @$pb.TagNumber(4)
  set expr($4156.Expr v) { setField(4, v); }
  @$pb.TagNumber(4)
  $core.bool hasExpr() => $_has(2);
  @$pb.TagNumber(4)
  void clearExpr() => clearField(4);
  @$pb.TagNumber(4)
  $4156.Expr ensureExpr() => $_ensure(2);

  /// The source info derived from input that generated the parsed `expr` and
  /// any optimizations made during the type-checking pass.
  @$pb.TagNumber(5)
  $4156.SourceInfo get sourceInfo => $_getN(3);
  @$pb.TagNumber(5)
  set sourceInfo($4156.SourceInfo v) { setField(5, v); }
  @$pb.TagNumber(5)
  $core.bool hasSourceInfo() => $_has(3);
  @$pb.TagNumber(5)
  void clearSourceInfo() => clearField(5);
  @$pb.TagNumber(5)
  $4156.SourceInfo ensureSourceInfo() => $_ensure(3);
...
class Type extends $pb.GeneratedMessage {
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(_omitMessageNames ? '' : 'Type', package: const $pb.PackageName(_omitMessageNames ? '' : 'google.api.expr.v1alpha1'), createEmptyInstance: create)
    ...
    ..e<$1735.NullValue>(2, _omitFieldNames ? '' : 'null', $pb.PbFieldType.OE, defaultOrMaker: $1735.NullValue.NULL_VALUE, valueOf: $1735.NullValue.valueOf, enumValues: $1735.NullValue.values)
  ...
  @$pb.TagNumber(1)
  $3.Empty ensureDyn() => $_ensure(0);

  /// Null value.
  @$pb.TagNumber(2)
  $1735.NullValue get null_2 => $_getN(1);
  @$pb.TagNumber(2)
  set null_2($1735.NullValue v) { setField(2, v); }
  @$pb.TagNumber(2)
  ...
  @$pb.TagNumber(12)
  $3.Empty ensureError() => $_ensure(11);
...
class Decl_IdentDecl extends $pb.GeneratedMessage {
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(_omitMessageNames ? '' : 'Decl.IdentDecl', package: const $pb.PackageName(_omitMessageNames ? '' : 'google.api.expr.v1alpha1'), createEmptyInstance: create)
    ...
    ..aOM<$4156.Constant>(2, _omitFieldNames ? '' : 'value', subBuilder: $4156.Constant.create)
  ...
  @$pb.TagNumber(2)
  $4156.Constant get value => $_getN(1);
  @$pb.TagNumber(2)
  set value($4156.Constant v) { setField(2, v); }
  @$pb.TagNumber(2)
  $core.bool hasValue() => $_has(1);
  @$pb.TagNumber(2)
  void clearValue() => clearField(2);
  @$pb.TagNumber(2)
  $4156.Constant ensureValue() => $_ensure(1);
...
class Reference extends $pb.GeneratedMessage {
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(_omitMessageNames ? '' : 'Reference', package: const $pb.PackageName(_omitMessageNames ? '' : 'google.api.expr.v1alpha1'), createEmptyInstance: create)
    ...
    ..aOM<$4156.Constant>(4, _omitFieldNames ? '' : 'value', subBuilder: $4156.Constant.create)
    ..hasRequiredFields = false
  ;
  ...
  @$pb.TagNumber(4)
  $4156.Constant get value => $_getN(2);
  @$pb.TagNumber(4)
  set value($4156.Constant v) { setField(4, v); }
  @$pb.TagNumber(4)
  $core.bool hasValue() => $_has(2);
  @$pb.TagNumber(4)
  void clearValue() => clearField(4);
  @$pb.TagNumber(4)
  $4156.Constant ensureValue() => $_ensure(2);
}
