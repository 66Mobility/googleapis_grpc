...
class CheckedExpr extends $pb.GeneratedMessage {
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(_omitMessageNames ? '' : 'CheckedExpr', package: const $pb.PackageName(_omitMessageNames ? '' : 'google.api.expr.v1alpha1'), createEmptyInstance: create)
    ...
    ..aOM<$4155.Expr>(4, _omitFieldNames ? '' : 'expr', subBuilder: $4155.Expr.create)
    ..aOM<$4155.SourceInfo>(5, _omitFieldNames ? '' : 'sourceInfo', subBuilder: $4155.SourceInfo.create)
  ...
  @$pb.TagNumber(4)
  $4155.Expr get expr => $_getN(2);
  @$pb.TagNumber(4)
  set expr($4155.Expr v) { setField(4, v); }
  @$pb.TagNumber(4)
  $core.bool hasExpr() => $_has(2);
  @$pb.TagNumber(4)
  void clearExpr() => clearField(4);
  @$pb.TagNumber(4)
  $4155.Expr ensureExpr() => $_ensure(2);

  /// The source info derived from input that generated the parsed `expr` and
  /// any optimizations made during the type-checking pass.
  @$pb.TagNumber(5)
  $4155.SourceInfo get sourceInfo => $_getN(3);
  @$pb.TagNumber(5)
  set sourceInfo($4155.SourceInfo v) { setField(5, v); }
  @$pb.TagNumber(5)
  $core.bool hasSourceInfo() => $_has(3);
  @$pb.TagNumber(5)
  void clearSourceInfo() => clearField(5);
  @$pb.TagNumber(5)
  $4155.SourceInfo ensureSourceInfo() => $_ensure(3);
...
class Type extends $pb.GeneratedMessage {
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(_omitMessageNames ? '' : 'Type', package: const $pb.PackageName(_omitMessageNames ? '' : 'google.api.expr.v1alpha1'), createEmptyInstance: create)
    ...
    ..e<$1734.NullValue>(2, _omitFieldNames ? '' : 'null', $pb.PbFieldType.OE, defaultOrMaker: $1734.NullValue.NULL_VALUE, valueOf: $1734.NullValue.valueOf, enumValues: $1734.NullValue.values)
  ...
  /// Null value.
  @$pb.TagNumber(2)
  $1734.NullValue get null_2 => $_getN(1);
  @$pb.TagNumber(2)
  set null_2($1734.NullValue v) { setField(2, v); }
  @$pb.TagNumber(2)
...
class Decl_IdentDecl extends $pb.GeneratedMessage {
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(_omitMessageNames ? '' : 'Decl.IdentDecl', package: const $pb.PackageName(_omitMessageNames ? '' : 'google.api.expr.v1alpha1'), createEmptyInstance: create)
    ...
    ..aOM<$4155.Constant>(2, _omitFieldNames ? '' : 'value', subBuilder: $4155.Constant.create)
  ...
  @$pb.TagNumber(2)
  $4155.Constant get value => $_getN(1);
  @$pb.TagNumber(2)
  set value($4155.Constant v) { setField(2, v); }
  @$pb.TagNumber(2)
  $core.bool hasValue() => $_has(1);
  @$pb.TagNumber(2)
  void clearValue() => clearField(2);
  @$pb.TagNumber(2)
  $4155.Constant ensureValue() => $_ensure(1);
...
class Reference extends $pb.GeneratedMessage {
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(_omitMessageNames ? '' : 'Reference', package: const $pb.PackageName(_omitMessageNames ? '' : 'google.api.expr.v1alpha1'), createEmptyInstance: create)
    ...
    ..aOM<$4155.Constant>(4, _omitFieldNames ? '' : 'value', subBuilder: $4155.Constant.create)
    ..hasRequiredFields = false
  ;
  ...
  @$pb.TagNumber(4)
  $4155.Constant get value => $_getN(2);
  @$pb.TagNumber(4)
  set value($4155.Constant v) { setField(4, v); }
  @$pb.TagNumber(4)
  $core.bool hasValue() => $_has(2);
  @$pb.TagNumber(4)
  void clearValue() => clearField(4);
  @$pb.TagNumber(4)
  $4155.Constant ensureValue() => $_ensure(2);
}
