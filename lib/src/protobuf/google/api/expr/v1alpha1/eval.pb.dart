...
class ExprValue extends $pb.GeneratedMessage {
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(
      ...
      createEmptyInstance: create)
    ..oo(0, [1, 2, 3])
    ..aOM<$373.Value>(1, _omitFieldNames ? '' : 'value',
        subBuilder: $373.Value.create)
  ...
  /// A concrete value.
  @$pb.TagNumber(1)
  $373.Value get value => $_getN(0);
  @$pb.TagNumber(1)
  set value($373.Value v) {
    setField(1, v);
  }
  ...
  @$pb.TagNumber(1)
  $373.Value ensureValue() => $_ensure(0);
