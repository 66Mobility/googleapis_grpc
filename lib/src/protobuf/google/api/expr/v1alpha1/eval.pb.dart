...
class ExprValue extends $pb.GeneratedMessage {
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(_omitMessageNames ? '' : 'ExprValue', package: const $pb.PackageName(_omitMessageNames ? '' : 'google.api.expr.v1alpha1'), createEmptyInstance: create)
    ..oo(0, [1, 2, 3])
    ..aOM<$4156.Value>(1, _omitFieldNames ? '' : 'value', subBuilder: $4156.Value.create)
  ...
  /// A concrete value.
  @$pb.TagNumber(1)
  $4156.Value get value => $_getN(0);
  @$pb.TagNumber(1)
  set value($4156.Value v) { setField(1, v); }
  @$pb.TagNumber(1)
  $core.bool hasValue() => $_has(0);
  @$pb.TagNumber(1)
  void clearValue() => clearField(1);
  @$pb.TagNumber(1)
  $4156.Value ensureValue() => $_ensure(0);
