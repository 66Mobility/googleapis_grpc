...
class ClientLibrarySettings extends $pb.GeneratedMessage {
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(_omitMessageNames ? '' : 'ClientLibrarySettings', package: const $pb.PackageName(_omitMessageNames ? '' : 'google.api'), createEmptyInstance: create)
    ...
    ..e<$303.LaunchStage>(2, _omitFieldNames ? '' : 'launchStage', $pb.PbFieldType.OE, defaultOrMaker: $303.LaunchStage.LAUNCH_STAGE_UNSPECIFIED, valueOf: $303.LaunchStage.valueOf, enumValues: $303.LaunchStage.values)
  ...
  @$pb.TagNumber(2)
  $303.LaunchStage get launchStage => $_getN(1);
  @$pb.TagNumber(2)
  set launchStage($303.LaunchStage v) { setField(2, v); }
  @$pb.TagNumber(2)
...
class MethodSettings_LongRunning extends $pb.GeneratedMessage {
  factory MethodSettings_LongRunning({
    $263.Duration? initialPollDelay,
    $core.double? pollDelayMultiplier,
    $263.Duration? maxPollDelay,
    $263.Duration? totalPollTimeout,
  }) {
    final $result = create();
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(_omitMessageNames ? '' : 'MethodSettings.LongRunning', package: const $pb.PackageName(_omitMessageNames ? '' : 'google.api'), createEmptyInstance: create)
    ..aOM<$263.Duration>(1, _omitFieldNames ? '' : 'initialPollDelay', subBuilder: $263.Duration.create)
    ..a<$core.double>(2, _omitFieldNames ? '' : 'pollDelayMultiplier', $pb.PbFieldType.OF)
    ..aOM<$263.Duration>(3, _omitFieldNames ? '' : 'maxPollDelay', subBuilder: $263.Duration.create)
    ..aOM<$263.Duration>(4, _omitFieldNames ? '' : 'totalPollTimeout', subBuilder: $263.Duration.create)
    ..hasRequiredFields = false
  ;
  ...
  @$pb.TagNumber(1)
  $263.Duration get initialPollDelay => $_getN(0);
  @$pb.TagNumber(1)
  set initialPollDelay($263.Duration v) { setField(1, v); }
  @$pb.TagNumber(1)
  $core.bool hasInitialPollDelay() => $_has(0);
  @$pb.TagNumber(1)
  void clearInitialPollDelay() => clearField(1);
  @$pb.TagNumber(1)
  $263.Duration ensureInitialPollDelay() => $_ensure(0);
  ...
  @$pb.TagNumber(3)
  $263.Duration get maxPollDelay => $_getN(2);
  @$pb.TagNumber(3)
  set maxPollDelay($263.Duration v) { setField(3, v); }
  @$pb.TagNumber(3)
  $core.bool hasMaxPollDelay() => $_has(2);
  @$pb.TagNumber(3)
  void clearMaxPollDelay() => clearField(3);
  @$pb.TagNumber(3)
  $263.Duration ensureMaxPollDelay() => $_ensure(2);

  /// Total polling timeout.
  /// Default value: 5 minutes.
  @$pb.TagNumber(4)
  $263.Duration get totalPollTimeout => $_getN(3);
  @$pb.TagNumber(4)
  set totalPollTimeout($263.Duration v) { setField(4, v); }
  @$pb.TagNumber(4)
  $core.bool hasTotalPollTimeout() => $_has(3);
  @$pb.TagNumber(4)
  void clearTotalPollTimeout() => clearField(4);
  @$pb.TagNumber(4)
  $263.Duration ensureTotalPollTimeout() => $_ensure(3);
}
