...
class SubscriberClient extends $grpc.Client {
  static final _$createSubscription =
      $grpc.ClientMethod<$210.Subscription, $210.Subscription>(
  ...
  static final _$getSubscription =
      $grpc.ClientMethod<$210.GetSubscriptionRequest, $210.Subscription>(
  ...
  static final _$listSubscriptions = $grpc.ClientMethod<
          $210.ListSubscriptionsRequest, $210.ListSubscriptionsResponse>(
      '/google.pubsub.v1beta2.Subscriber/ListSubscriptions',
      ($210.ListSubscriptionsRequest value) => value.writeToBuffer(),
      ($core.List<$core.int> value) =>
          $210.ListSubscriptionsResponse.fromBuffer(value));
  static final _$deleteSubscription =
      $grpc.ClientMethod<$210.DeleteSubscriptionRequest, $3.Empty>(
  ...
  static final _$modifyAckDeadline =
      $grpc.ClientMethod<$210.ModifyAckDeadlineRequest, $3.Empty>(
  ...
  static final _$acknowledge =
      $grpc.ClientMethod<$210.AcknowledgeRequest, $3.Empty>(
  ...
  static final _$modifyPushConfig =
      $grpc.ClientMethod<$210.ModifyPushConfigRequest, $3.Empty>(
...
abstract class SubscriberServiceBase extends $grpc.Service {
  ...
  SubscriberServiceBase() {
    $addMethod($grpc.ServiceMethod<$210.Subscription, $210.Subscription>(
        ...
        ($210.Subscription value) => value.writeToBuffer()));
    $addMethod(
        $grpc.ServiceMethod<$210.GetSubscriptionRequest, $210.Subscription>(
            'GetSubscription',
            getSubscription_Pre,
            false,
            false,
            ($core.List<$core.int> value) =>
                $210.GetSubscriptionRequest.fromBuffer(value),
            ($210.Subscription value) => value.writeToBuffer()));
    $addMethod($grpc.ServiceMethod<$210.ListSubscriptionsRequest,
            $210.ListSubscriptionsResponse>(
        'ListSubscriptions',
        listSubscriptions_Pre,
        false,
        false,
        ($core.List<$core.int> value) =>
            $210.ListSubscriptionsRequest.fromBuffer(value),
    ...
    $addMethod($grpc.ServiceMethod<$210.DeleteSubscriptionRequest, $3.Empty>(
        ...
        false,
        ($core.List<$core.int> value) =>
            $210.DeleteSubscriptionRequest.fromBuffer(value),
    ...
    $addMethod($grpc.ServiceMethod<$210.ModifyAckDeadlineRequest, $3.Empty>(
        ...
        false,
        ($core.List<$core.int> value) =>
            $210.ModifyAckDeadlineRequest.fromBuffer(value),
        ($3.Empty value) => value.writeToBuffer()));
    $addMethod($grpc.ServiceMethod<$210.AcknowledgeRequest, $3.Empty>(
        ...
        false,
        ($core.List<$core.int> value) =>
            $210.AcknowledgeRequest.fromBuffer(value),
        ($3.Empty value) => value.writeToBuffer()));
    ...
    $addMethod($grpc.ServiceMethod<$210.ModifyPushConfigRequest, $3.Empty>(
        ...
        false,
        ($core.List<$core.int> value) =>
            $210.ModifyPushConfigRequest.fromBuffer(value),
        ($3.Empty value) => value.writeToBuffer()));
  }

  $async.Future<$210.Subscription> createSubscription_Pre(
      $grpc.ServiceCall call, $async.Future<$210.Subscription> request) async {
    return createSubscription(call, await request);
  }

  $async.Future<$210.Subscription> getSubscription_Pre($grpc.ServiceCall call,
      $async.Future<$210.GetSubscriptionRequest> request) async {
    return getSubscription(call, await request);
  }

  $async.Future<$210.ListSubscriptionsResponse> listSubscriptions_Pre(
      $grpc.ServiceCall call,
      $async.Future<$210.ListSubscriptionsRequest> request) async {
    return listSubscriptions(call, await request);
  }

  $async.Future<$3.Empty> deleteSubscription_Pre($grpc.ServiceCall call,
      $async.Future<$210.DeleteSubscriptionRequest> request) async {
    return deleteSubscription(call, await request);
  }

  $async.Future<$3.Empty> modifyAckDeadline_Pre($grpc.ServiceCall call,
      $async.Future<$210.ModifyAckDeadlineRequest> request) async {
    return modifyAckDeadline(call, await request);
  }

  $async.Future<$3.Empty> acknowledge_Pre($grpc.ServiceCall call,
      $async.Future<$210.AcknowledgeRequest> request) async {
    return acknowledge(call, await request);
  }

  $async.Future<$210.PullResponse> pull_Pre(
      $grpc.ServiceCall call, $async.Future<$210.PullRequest> request) async {
    return pull(call, await request);
  }

  $async.Future<$3.Empty> modifyPushConfig_Pre($grpc.ServiceCall call,
      $async.Future<$210.ModifyPushConfigRequest> request) async {
    return modifyPushConfig(call, await request);
  }

  $async.Future<$210.Subscription> createSubscription(
      $grpc.ServiceCall call, $210.Subscription request);
  $async.Future<$210.Subscription> getSubscription(
      $grpc.ServiceCall call, $210.GetSubscriptionRequest request);
  $async.Future<$210.ListSubscriptionsResponse> listSubscriptions(
      $grpc.ServiceCall call, $210.ListSubscriptionsRequest request);
  $async.Future<$3.Empty> deleteSubscription(
      $grpc.ServiceCall call, $210.DeleteSubscriptionRequest request);
  $async.Future<$3.Empty> modifyAckDeadline(
      $grpc.ServiceCall call, $210.ModifyAckDeadlineRequest request);
  $async.Future<$3.Empty> acknowledge(
      $grpc.ServiceCall call, $210.AcknowledgeRequest request);
  $async.Future<$210.PullResponse> pull(
      $grpc.ServiceCall call, $210.PullRequest request);
  $async.Future<$3.Empty> modifyPushConfig(
      $grpc.ServiceCall call, $210.ModifyPushConfigRequest request);
}
...
class PublisherClient extends $grpc.Client {
  ...
  $grpc.ResponseFuture<$210.Topic> createTopic($210.Topic request,
      {$grpc.CallOptions? options}) {
    return $createUnaryCall(_$createTopic, request, options: options);
  }

  $grpc.ResponseFuture<$210.PublishResponse> publish(
      $210.PublishRequest request,
      {$grpc.CallOptions? options}) {
    return $createUnaryCall(_$publish, request, options: options);
  }

  $grpc.ResponseFuture<$210.Topic> getTopic($210.GetTopicRequest request,
      {$grpc.CallOptions? options}) {
    return $createUnaryCall(_$getTopic, request, options: options);
  }

  $grpc.ResponseFuture<$210.ListTopicsResponse> listTopics(
      $210.ListTopicsRequest request,
      {$grpc.CallOptions? options}) {
    return $createUnaryCall(_$listTopics, request, options: options);
  }

  $grpc.ResponseFuture<$210.ListTopicSubscriptionsResponse>
      listTopicSubscriptions($210.ListTopicSubscriptionsRequest request,
          {$grpc.CallOptions? options}) {
    return $createUnaryCall(_$listTopicSubscriptions, request,
        options: options);
  }

  $grpc.ResponseFuture<$3.Empty> deleteTopic($210.DeleteTopicRequest request,
      {$grpc.CallOptions? options}) {
...
abstract class PublisherServiceBase extends $grpc.Service {
  ...
  PublisherServiceBase() {
    ...
    $addMethod($grpc.ServiceMethod<$210.GetTopicRequest, $210.Topic>(
        ...
        ($210.Topic value) => value.writeToBuffer()));
    $addMethod(
        $grpc.ServiceMethod<$210.ListTopicsRequest, $210.ListTopicsResponse>(
            'ListTopics',
            listTopics_Pre,
            false,
            false,
            ($core.List<$core.int> value) =>
                $210.ListTopicsRequest.fromBuffer(value),
            ($210.ListTopicsResponse value) => value.writeToBuffer()));
    $addMethod($grpc.ServiceMethod<$210.ListTopicSubscriptionsRequest,
            $210.ListTopicSubscriptionsResponse>(
        ...
        false,
        ($core.List<$core.int> value) =>
            $210.ListTopicSubscriptionsRequest.fromBuffer(value),
    ...
    $addMethod($grpc.ServiceMethod<$210.DeleteTopicRequest, $3.Empty>(
        ...
        false,
        ($core.List<$core.int> value) =>
            $210.DeleteTopicRequest.fromBuffer(value),
        ($3.Empty value) => value.writeToBuffer()));
  }

  $async.Future<$210.Topic> createTopic_Pre(
      $grpc.ServiceCall call, $async.Future<$210.Topic> request) async {
    return createTopic(call, await request);
  }

  $async.Future<$210.PublishResponse> publish_Pre($grpc.ServiceCall call,
      $async.Future<$210.PublishRequest> request) async {
    return publish(call, await request);
  }

  $async.Future<$210.Topic> getTopic_Pre($grpc.ServiceCall call,
      $async.Future<$210.GetTopicRequest> request) async {
    return getTopic(call, await request);
  }

  $async.Future<$210.ListTopicsResponse> listTopics_Pre($grpc.ServiceCall call,
      $async.Future<$210.ListTopicsRequest> request) async {
    return listTopics(call, await request);
  }

  $async.Future<$210.ListTopicSubscriptionsResponse> listTopicSubscriptions_Pre(
      $grpc.ServiceCall call,
      $async.Future<$210.ListTopicSubscriptionsRequest> request) async {
    return listTopicSubscriptions(call, await request);
  }

  $async.Future<$3.Empty> deleteTopic_Pre($grpc.ServiceCall call,
      $async.Future<$210.DeleteTopicRequest> request) async {
    return deleteTopic(call, await request);
  }

  $async.Future<$210.Topic> createTopic(
      $grpc.ServiceCall call, $210.Topic request);
  $async.Future<$210.PublishResponse> publish(
      $grpc.ServiceCall call, $210.PublishRequest request);
  $async.Future<$210.Topic> getTopic(
      $grpc.ServiceCall call, $210.GetTopicRequest request);
  $async.Future<$210.ListTopicsResponse> listTopics(
      $grpc.ServiceCall call, $210.ListTopicsRequest request);
  $async.Future<$210.ListTopicSubscriptionsResponse> listTopicSubscriptions(
      $grpc.ServiceCall call, $210.ListTopicSubscriptionsRequest request);
  $async.Future<$3.Empty> deleteTopic(
      $grpc.ServiceCall call, $210.DeleteTopicRequest request);
}
