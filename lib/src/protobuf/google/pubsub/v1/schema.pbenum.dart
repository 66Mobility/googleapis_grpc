...
class SchemaView extends $pb.ProtobufEnum {
  static const SchemaView SCHEMA_VIEW_UNSPECIFIED = SchemaView._(0, _omitEnumNames ? '' : 'SCHEMA_VIEW_UNSPECIFIED');
  static const SchemaView BASIC = SchemaView._(1, _omitEnumNames ? '' : 'BASIC');
...
class Encoding extends $pb.ProtobufEnum {
  static const Encoding ENCODING_UNSPECIFIED = Encoding._(0, _omitEnumNames ? '' : 'ENCODING_UNSPECIFIED');
...
class Schema_Type extends $pb.ProtobufEnum {
  ...
  static const Schema_Type AVRO = Schema_Type._(2, _omitEnumNames ? '' : 'AVRO');
