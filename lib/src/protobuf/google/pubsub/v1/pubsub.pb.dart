...
class SchemaSettings extends $pb.GeneratedMessage {
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(_omitMessageNames ? '' : 'SchemaSettings', package: const $pb.PackageName(_omitMessageNames ? '' : 'google.pubsub.v1'), createEmptyInstance: create)
    ...
    ..e<$1684.Encoding>(2, _omitFieldNames ? '' : 'encoding', $pb.PbFieldType.OE, defaultOrMaker: $1684.Encoding.ENCODING_UNSPECIFIED, valueOf: $1684.Encoding.valueOf, enumValues: $1684.Encoding.values)
  ...
  @$pb.TagNumber(2)
  $1684.Encoding get encoding => $_getN(1);
  @$pb.TagNumber(2)
  set encoding($1684.Encoding v) { setField(2, v); }
  @$pb.TagNumber(2)
