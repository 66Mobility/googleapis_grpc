...
import 'common.pbenum.dart' as $4870;
import 'mutation_record.pb.dart' as $4869;
...
class AlertPolicy_Condition_MetricThreshold_ForecastOptions extends $pb.GeneratedMessage {
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(_omitMessageNames ? '' : 'AlertPolicy.Condition.MetricThreshold.ForecastOptions', package: const $pb.PackageName(_omitMessageNames ? '' : 'google.monitoring.v3'), createEmptyInstance: create)
    ..aOM<$1738.Duration>(1, _omitFieldNames ? '' : 'forecastHorizon', subBuilder: $1738.Duration.create)
    ..hasRequiredFields = false
  ;
  ...
  @$pb.TagNumber(1)
  $1738.Duration get forecastHorizon => $_getN(0);
  @$pb.TagNumber(1)
  set forecastHorizon($1738.Duration v) { setField(1, v); }
  @$pb.TagNumber(1)
  $core.bool hasForecastHorizon() => $_has(0);
  @$pb.TagNumber(1)
  void clearForecastHorizon() => clearField(1);
  @$pb.TagNumber(1)
  $1738.Duration ensureForecastHorizon() => $_ensure(0);
}
...
class AlertPolicy_Condition_MetricThreshold extends $pb.GeneratedMessage {
  factory AlertPolicy_Condition_MetricThreshold({
    $core.String? filter,
    $4870.ComparisonType? comparison,
    $core.double? thresholdValue,
    $1738.Duration? duration,
    AlertPolicy_Condition_Trigger? trigger,
    $core.Iterable<$4870.Aggregation>? aggregations,
    $core.String? denominatorFilter,
    $core.Iterable<$4870.Aggregation>? denominatorAggregations,
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(_omitMessageNames ? '' : 'AlertPolicy.Condition.MetricThreshold', package: const $pb.PackageName(_omitMessageNames ? '' : 'google.monitoring.v3'), createEmptyInstance: create)
    ...
    ..e<$4870.ComparisonType>(4, _omitFieldNames ? '' : 'comparison', $pb.PbFieldType.OE, defaultOrMaker: $4870.ComparisonType.COMPARISON_UNSPECIFIED, valueOf: $4870.ComparisonType.valueOf, enumValues: $4870.ComparisonType.values)
    ...
    ..pc<$4870.Aggregation>(8, _omitFieldNames ? '' : 'aggregations', $pb.PbFieldType.PM, subBuilder: $4870.Aggregation.create)
    ..aOS(9, _omitFieldNames ? '' : 'denominatorFilter')
    ..pc<$4870.Aggregation>(10, _omitFieldNames ? '' : 'denominatorAggregations', $pb.PbFieldType.PM, subBuilder: $4870.Aggregation.create)
  ...
  @$pb.TagNumber(4)
  $4870.ComparisonType get comparison => $_getN(1);
  @$pb.TagNumber(4)
  set comparison($4870.ComparisonType v) { setField(4, v); }
  @$pb.TagNumber(4)
  ...
  ///  field.
  @$pb.TagNumber(8)
  $core.List<$4870.Aggregation> get aggregations => $_getList(5);
  ...
  @$pb.TagNumber(10)
  $core.List<$4870.Aggregation> get denominatorAggregations => $_getList(7);
...
class AlertPolicy_Condition_MetricAbsence extends $pb.GeneratedMessage {
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(_omitMessageNames ? '' : 'AlertPolicy.Condition.MetricAbsence', package: const $pb.PackageName(_omitMessageNames ? '' : 'google.monitoring.v3'), createEmptyInstance: create)
    ...
    ..pc<$4870.Aggregation>(5, _omitFieldNames ? '' : 'aggregations', $pb.PbFieldType.PM, subBuilder: $4870.Aggregation.create)
    ..hasRequiredFields = false
  ;
  ...
  ///  field.
  @$pb.TagNumber(5)
  $core.List<$4870.Aggregation> get aggregations => $_getList(3);
}
...
class AlertPolicy_Condition_PrometheusQueryLanguageCondition extends $pb.GeneratedMessage {
  factory AlertPolicy_Condition_PrometheusQueryLanguageCondition({
    $core.String? query,
    $1738.Duration? duration,
    $1738.Duration? evaluationInterval,
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(_omitMessageNames ? '' : 'AlertPolicy.Condition.PrometheusQueryLanguageCondition', package: const $pb.PackageName(_omitMessageNames ? '' : 'google.monitoring.v3'), createEmptyInstance: create)
    ..aOS(1, _omitFieldNames ? '' : 'query')
    ..aOM<$1738.Duration>(2, _omitFieldNames ? '' : 'duration', subBuilder: $1738.Duration.create)
    ..aOM<$1738.Duration>(3, _omitFieldNames ? '' : 'evaluationInterval', subBuilder: $1738.Duration.create)
  ...
  @$pb.TagNumber(3)
  $1738.Duration get evaluationInterval => $_getN(2);
  @$pb.TagNumber(3)
  set evaluationInterval($1738.Duration v) { setField(3, v); }
  @$pb.TagNumber(3)
  $core.bool hasEvaluationInterval() => $_has(2);
  @$pb.TagNumber(3)
  void clearEvaluationInterval() => clearField(3);
  @$pb.TagNumber(3)
  $1738.Duration ensureEvaluationInterval() => $_ensure(2);
...
class AlertPolicy_AlertStrategy_NotificationChannelStrategy extends $pb.GeneratedMessage {
  factory AlertPolicy_AlertStrategy_NotificationChannelStrategy({
    ...
    $1738.Duration? renotifyInterval,
  }) {
    final $result = create();
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(_omitMessageNames ? '' : 'AlertPolicy.AlertStrategy.NotificationChannelStrategy', package: const $pb.PackageName(_omitMessageNames ? '' : 'google.monitoring.v3'), createEmptyInstance: create)
    ...
    ..aOM<$1738.Duration>(2, _omitFieldNames ? '' : 'renotifyInterval', subBuilder: $1738.Duration.create)
    ..hasRequiredFields = false
  ;
  ...
  /// incidents.
  @$pb.TagNumber(2)
  $1738.Duration get renotifyInterval => $_getN(1);
  @$pb.TagNumber(2)
  set renotifyInterval($1738.Duration v) { setField(2, v); }
  @$pb.TagNumber(2)
  $core.bool hasRenotifyInterval() => $_has(1);
  @$pb.TagNumber(2)
  void clearRenotifyInterval() => clearField(2);
  @$pb.TagNumber(2)
  $1738.Duration ensureRenotifyInterval() => $_ensure(1);
}
...
class AlertPolicy_AlertStrategy extends $pb.GeneratedMessage {
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(_omitMessageNames ? '' : 'AlertPolicy.AlertStrategy', package: const $pb.PackageName(_omitMessageNames ? '' : 'google.monitoring.v3'), createEmptyInstance: create)
    ...
    ..aOM<$1738.Duration>(3, _omitFieldNames ? '' : 'autoClose', subBuilder: $1738.Duration.create)
  ...
  @$pb.TagNumber(3)
  $1738.Duration get autoClose => $_getN(1);
  @$pb.TagNumber(3)
  set autoClose($1738.Duration v) { setField(3, v); }
  @$pb.TagNumber(3)
  $core.bool hasAutoClose() => $_has(1);
  @$pb.TagNumber(3)
  void clearAutoClose() => clearField(3);
  @$pb.TagNumber(3)
  $1738.Duration ensureAutoClose() => $_ensure(1);
...
class AlertPolicy extends $pb.GeneratedMessage {
  factory AlertPolicy({
    ...
    $4869.MutationRecord? creationRecord,
    $4869.MutationRecord? mutationRecord,
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(_omitMessageNames ? '' : 'AlertPolicy', package: const $pb.PackageName(_omitMessageNames ? '' : 'google.monitoring.v3'), createEmptyInstance: create)
    ...
    ..aOM<$4869.MutationRecord>(10, _omitFieldNames ? '' : 'creationRecord', subBuilder: $4869.MutationRecord.create)
    ..aOM<$4869.MutationRecord>(11, _omitFieldNames ? '' : 'mutationRecord', subBuilder: $4869.MutationRecord.create)
    ...
    ..aOM<$1781.BoolValue>(17, _omitFieldNames ? '' : 'enabled', subBuilder: $1781.BoolValue.create)
    ..aOM<$1796.Status>(18, _omitFieldNames ? '' : 'validity', subBuilder: $1796.Status.create)
  ...
  @$pb.TagNumber(10)
  $4869.MutationRecord get creationRecord => $_getN(3);
  @$pb.TagNumber(10)
  set creationRecord($4869.MutationRecord v) { setField(10, v); }
  @$pb.TagNumber(10)
  $core.bool hasCreationRecord() => $_has(3);
  @$pb.TagNumber(10)
  void clearCreationRecord() => clearField(10);
  @$pb.TagNumber(10)
  $4869.MutationRecord ensureCreationRecord() => $_ensure(3);

  /// A read-only record of the most recent change to the alerting policy. If
  /// provided in a call to create or update, this field will be ignored.
  @$pb.TagNumber(11)
  $4869.MutationRecord get mutationRecord => $_getN(4);
  @$pb.TagNumber(11)
  set mutationRecord($4869.MutationRecord v) { setField(11, v); }
  @$pb.TagNumber(11)
  $core.bool hasMutationRecord() => $_has(4);
  @$pb.TagNumber(11)
  void clearMutationRecord() => clearField(11);
  @$pb.TagNumber(11)
  $4869.MutationRecord ensureMutationRecord() => $_ensure(4);
  ...
  @$pb.TagNumber(17)
  $1781.BoolValue get enabled => $_getN(9);
  @$pb.TagNumber(17)
  set enabled($1781.BoolValue v) { setField(17, v); }
  @$pb.TagNumber(17)
  $core.bool hasEnabled() => $_has(9);
  @$pb.TagNumber(17)
  void clearEnabled() => clearField(17);
  @$pb.TagNumber(17)
  $1781.BoolValue ensureEnabled() => $_ensure(9);
  ...
  /// generate incidents.
  @$pb.TagNumber(18)
  $1796.Status get validity => $_getN(10);
  @$pb.TagNumber(18)
  set validity($1796.Status v) { setField(18, v); }
  @$pb.TagNumber(18)
  $core.bool hasValidity() => $_has(10);
  @$pb.TagNumber(18)
  void clearValidity() => clearField(18);
  @$pb.TagNumber(18)
  $1796.Status ensureValidity() => $_ensure(10);
