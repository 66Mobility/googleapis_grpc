...
class DroppedLabels extends $pb.GeneratedMessage {
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(_omitMessageNames ? '' : 'DroppedLabels', package: const $pb.PackageName(_omitMessageNames ? '' : 'google.monitoring.v3'), createEmptyInstance: create)
    ..m<$core.String, $core.String>(1, _omitFieldNames ? '' : 'label', entryClassName: 'DroppedLabels.LabelEntry', keyFieldType: $pb.PbFieldType.OS, valueFieldType: $pb.PbFieldType.OS, packageName: const $pb.PackageName('google.monitoring.v3'))
  ...
  'Will be removed in next major version')
  DroppedLabels copyWith(void Function(DroppedLabels) updates) => super.copyWith((message) => updates(message as DroppedLabels)) as DroppedLabels;
