...
const ListUptimeCheckConfigsResponse$json = {
  ...
  '2': [
    {'1': 'uptime_check_configs', '3': 1, '4': 3, '5': 11, '6': '.google.monitoring.v3.UptimeCheckConfig', '10': 'uptimeCheckConfigs'},
...
final $typed_data.Uint8List listUptimeCheckConfigsResponseDescriptor = $convert.base64Decode(
...
final $typed_data.Uint8List getUptimeCheckConfigRequestDescriptor = $convert.base64Decode(
...
const CreateUptimeCheckConfigRequest$json = {
  ...
  '2': [
    {'1': 'parent', '3': 1, '4': 1, '5': 9, '8': {}, '10': 'parent'},
    {'1': 'uptime_check_config', '3': 2, '4': 1, '5': 11, '6': '.google.monitoring.v3.UptimeCheckConfig', '8': {}, '10': 'uptimeCheckConfig'},
  ],
};

/// Descriptor for `CreateUptimeCheckConfigRequest`. Decode as a `google.protobuf.DescriptorProto`.
final $typed_data.Uint8List createUptimeCheckConfigRequestDescriptor = $convert.base64Decode(
...
const UpdateUptimeCheckConfigRequest$json = {
  ...
  '2': [
    ...
    {'1': 'uptime_check_config', '3': 3, '4': 1, '5': 11, '6': '.google.monitoring.v3.UptimeCheckConfig', '8': {}, '10': 'uptimeCheckConfig'},
  ],
};

/// Descriptor for `UpdateUptimeCheckConfigRequest`. Decode as a `google.protobuf.DescriptorProto`.
final $typed_data.Uint8List updateUptimeCheckConfigRequestDescriptor = $convert.base64Decode(
...
final $typed_data.Uint8List deleteUptimeCheckConfigRequestDescriptor = $convert.base64Decode(
...
final $typed_data.Uint8List listUptimeCheckIpsRequestDescriptor = $convert.base64Decode(
...
const ListUptimeCheckIpsResponse$json = {
  ...
  '2': [
    {'1': 'uptime_check_ips', '3': 1, '4': 3, '5': 11, '6': '.google.monitoring.v3.UptimeCheckIp', '10': 'uptimeCheckIps'},
    {'1': 'next_page_token', '3': 2, '4': 1, '5': 9, '10': 'nextPageToken'},
  ],
};

/// Descriptor for `ListUptimeCheckIpsResponse`. Decode as a `google.protobuf.DescriptorProto`.
final $typed_data.Uint8List listUptimeCheckIpsResponseDescriptor = $convert.base64Decode(
