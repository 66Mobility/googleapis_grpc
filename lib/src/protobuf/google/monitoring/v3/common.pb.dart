...
class TypedValue extends $pb.GeneratedMessage {
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(
    ...
    ..aOM<$369.Distribution>(5, _omitFieldNames ? '' : 'distributionValue',
        subBuilder: $369.Distribution.create)
  ...
  @$pb.TagNumber(5)
  $369.Distribution get distributionValue => $_getN(4);
  @$pb.TagNumber(5)
  set distributionValue($369.Distribution v) {
    setField(5, v);
  }
  ...
  @$pb.TagNumber(5)
  $369.Distribution ensureDistributionValue() => $_ensure(4);
}
...
class Aggregation extends $pb.GeneratedMessage {
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(
      ...
      package: const $pb.PackageName(
          _omitMessageNames ? '' : 'google.monitoring.v3'),
      createEmptyInstance: create)
    ..aOM<$266.Duration>(1, _omitFieldNames ? '' : 'alignmentPeriod',
  ...
  @$pb.TagNumber(1)
  $266.Duration get alignmentPeriod => $_getN(0);
  @$pb.TagNumber(1)
  set alignmentPeriod($266.Duration v) {
    setField(1, v);
  }
  ...
  @$pb.TagNumber(1)
  $266.Duration ensureAlignmentPeriod() => $_ensure(0);
