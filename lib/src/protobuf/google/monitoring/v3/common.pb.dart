...
class TypedValue extends $pb.GeneratedMessage {
  factory TypedValue({
    ...
    $398.Distribution? distributionValue,
  }) {
    final $result = create();
    if (boolValue != null) {
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(
    ...
    ..aOM<$398.Distribution>(5, _omitFieldNames ? '' : 'distributionValue',
        subBuilder: $398.Distribution.create)
  ...
  @$pb.TagNumber(5)
  $398.Distribution get distributionValue => $_getN(4);
  @$pb.TagNumber(5)
  set distributionValue($398.Distribution v) {
    setField(5, v);
  }
  ...
  @$pb.TagNumber(5)
  $398.Distribution ensureDistributionValue() => $_ensure(4);
}
...
class Aggregation extends $pb.GeneratedMessage {
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(
      ...
      package: const $pb.PackageName(
          _omitMessageNames ? '' : 'google.monitoring.v3'),
      createEmptyInstance: create)
    ..aOM<$292.Duration>(1, _omitFieldNames ? '' : 'alignmentPeriod',
  ...
  @$pb.TagNumber(1)
  $292.Duration get alignmentPeriod => $_getN(0);
  @$pb.TagNumber(1)
  set alignmentPeriod($292.Duration v) {
    setField(1, v);
  }
  ...
  @$pb.TagNumber(1)
  $292.Duration ensureAlignmentPeriod() => $_ensure(0);
