...
class ListGroupMembersRequest extends $pb.GeneratedMessage {
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(_omitMessageNames ? '' : 'ListGroupMembersRequest', package: const $pb.PackageName(_omitMessageNames ? '' : 'google.monitoring.v3'), createEmptyInstance: create)
    ...
    ..aOM<$4868.TimeInterval>(6, _omitFieldNames ? '' : 'interval', subBuilder: $4868.TimeInterval.create)
    ..aOS(7, _omitFieldNames ? '' : 'name')
    ..hasRequiredFields = false
  ;
  ...
  @$pb.TagNumber(6)
  $4868.TimeInterval get interval => $_getN(3);
  @$pb.TagNumber(6)
  set interval($4868.TimeInterval v) { setField(6, v); }
  @$pb.TagNumber(6)
  $core.bool hasInterval() => $_has(3);
  @$pb.TagNumber(6)
  void clearInterval() => clearField(6);
  @$pb.TagNumber(6)
  $4868.TimeInterval ensureInterval() => $_ensure(3);
