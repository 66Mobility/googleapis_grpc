...
class NotificationChannelDescriptor extends $pb.GeneratedMessage {
  ...
  @$core.Deprecated('This field is deprecated.')
    $core.Iterable<$4868.ServiceTier>? supportedTiers,
    $core.String? name,
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(_omitMessageNames ? '' : 'NotificationChannelDescriptor', package: const $pb.PackageName(_omitMessageNames ? '' : 'google.monitoring.v3'), createEmptyInstance: create)
    ...
    ..pc<$4162.LabelDescriptor>(4, _omitFieldNames ? '' : 'labels', $pb.PbFieldType.PM, subBuilder: $4162.LabelDescriptor.create)
    ..pc<$4868.ServiceTier>(5, _omitFieldNames ? '' : 'supportedTiers', $pb.PbFieldType.KE, valueOf: $4868.ServiceTier.valueOf, enumValues: $4868.ServiceTier.values, defaultEnumValue: $4868.ServiceTier.SERVICE_TIER_UNSPECIFIED)
    ..aOS(6, _omitFieldNames ? '' : 'name')
    ..e<$1777.LaunchStage>(7, _omitFieldNames ? '' : 'launchStage', $pb.PbFieldType.OE, defaultOrMaker: $1777.LaunchStage.LAUNCH_STAGE_UNSPECIFIED, valueOf: $1777.LaunchStage.valueOf, enumValues: $1777.LaunchStage.values)
  ...
  @$pb.TagNumber(4)
  $core.List<$4162.LabelDescriptor> get labels => $_getList(3);

  /// The tiers that support this notification channel; the project service tier
  /// must be one of the supported_tiers.
  @$core.Deprecated('This field is deprecated.')
  @$pb.TagNumber(5)
  $core.List<$4868.ServiceTier> get supportedTiers => $_getList(4);
  ...
  @$pb.TagNumber(7)
  $1777.LaunchStage get launchStage => $_getN(6);
  @$pb.TagNumber(7)
  set launchStage($1777.LaunchStage v) { setField(7, v); }
  @$pb.TagNumber(7)
...
class NotificationChannel extends $pb.GeneratedMessage {
  factory NotificationChannel({
    ...
    $core.Iterable<$4867.MutationRecord>? mutationRecords,
  }) {
    final $result = create();
    if (type != null) {
      $result.type = type;
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(_omitMessageNames ? '' : 'NotificationChannel', package: const $pb.PackageName(_omitMessageNames ? '' : 'google.monitoring.v3'), createEmptyInstance: create)
    ...
    ..aOM<$1780.BoolValue>(11, _omitFieldNames ? '' : 'enabled', subBuilder: $1780.BoolValue.create)
    ..aOM<$4867.MutationRecord>(12, _omitFieldNames ? '' : 'creationRecord', subBuilder: $4867.MutationRecord.create)
    ..pc<$4867.MutationRecord>(13, _omitFieldNames ? '' : 'mutationRecords', $pb.PbFieldType.PM, subBuilder: $4867.MutationRecord.create)
    ..hasRequiredFields = false
  ;
  ...
  @$pb.TagNumber(11)
  $1780.BoolValue get enabled => $_getN(7);
  @$pb.TagNumber(11)
  set enabled($1780.BoolValue v) { setField(11, v); }
  @$pb.TagNumber(11)
  $core.bool hasEnabled() => $_has(7);
  @$pb.TagNumber(11)
  void clearEnabled() => clearField(11);
  @$pb.TagNumber(11)
  $1780.BoolValue ensureEnabled() => $_ensure(7);

  /// Record of the creation of this channel.
  @$pb.TagNumber(12)
  $4867.MutationRecord get creationRecord => $_getN(8);
  @$pb.TagNumber(12)
  set creationRecord($4867.MutationRecord v) { setField(12, v); }
  @$pb.TagNumber(12)
  $core.bool hasCreationRecord() => $_has(8);
  @$pb.TagNumber(12)
  void clearCreationRecord() => clearField(12);
  @$pb.TagNumber(12)
  $4867.MutationRecord ensureCreationRecord() => $_ensure(8);

  /// Records of the modification of this channel.
  @$pb.TagNumber(13)
  $core.List<$4867.MutationRecord> get mutationRecords => $_getList(9);
}
