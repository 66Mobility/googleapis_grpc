...
const CreateServiceRequest$json = {
  ...
  '2': [
    ...
    {'1': 'service', '3': 2, '4': 1, '5': 11, '6': '.google.monitoring.v3.Service', '8': {}, '10': 'service'},
  ],
};
...
const ListServicesResponse$json = {
  ...
  '2': [
    {'1': 'services', '3': 1, '4': 3, '5': 11, '6': '.google.monitoring.v3.Service', '10': 'services'},
...
const UpdateServiceRequest$json = {
  ...
  '2': [
    {'1': 'service', '3': 1, '4': 1, '5': 11, '6': '.google.monitoring.v3.Service', '8': {}, '10': 'service'},
...
const CreateServiceLevelObjectiveRequest$json = {
  ...
  '2': [
    {'1': 'parent', '3': 1, '4': 1, '5': 9, '8': {}, '10': 'parent'},
    {'1': 'service_level_objective_id', '3': 3, '4': 1, '5': 9, '10': 'serviceLevelObjectiveId'},
    {'1': 'service_level_objective', '3': 2, '4': 1, '5': 11, '6': '.google.monitoring.v3.ServiceLevelObjective', '8': {}, '10': 'serviceLevelObjective'},
  ],
};

/// Descriptor for `CreateServiceLevelObjectiveRequest`. Decode as a `google.protobuf.DescriptorProto`.
final $typed_data.Uint8List createServiceLevelObjectiveRequestDescriptor = $convert.base64Decode(
...
const GetServiceLevelObjectiveRequest$json = {
  ...
  '2': [
    {'1': 'name', '3': 1, '4': 1, '5': 9, '8': {}, '10': 'name'},
    {'1': 'view', '3': 2, '4': 1, '5': 14, '6': '.google.monitoring.v3.ServiceLevelObjective.View', '10': 'view'},
  ],
};

/// Descriptor for `GetServiceLevelObjectiveRequest`. Decode as a `google.protobuf.DescriptorProto`.
final $typed_data.Uint8List getServiceLevelObjectiveRequestDescriptor = $convert.base64Decode(
...
const ListServiceLevelObjectivesRequest$json = {
  ...
  '2': [
    ...
    {'1': 'page_size', '3': 3, '4': 1, '5': 5, '10': 'pageSize'},
    {'1': 'page_token', '3': 4, '4': 1, '5': 9, '10': 'pageToken'},
    {'1': 'view', '3': 5, '4': 1, '5': 14, '6': '.google.monitoring.v3.ServiceLevelObjective.View', '10': 'view'},
  ],
};
...
const ListServiceLevelObjectivesResponse$json = {
  ...
  '2': [
    {'1': 'service_level_objectives', '3': 1, '4': 3, '5': 11, '6': '.google.monitoring.v3.ServiceLevelObjective', '10': 'serviceLevelObjectives'},
    {'1': 'next_page_token', '3': 2, '4': 1, '5': 9, '10': 'nextPageToken'},
  ],
};

/// Descriptor for `ListServiceLevelObjectivesResponse`. Decode as a `google.protobuf.DescriptorProto`.
final $typed_data.Uint8List listServiceLevelObjectivesResponseDescriptor = $convert.base64Decode(
...
const UpdateServiceLevelObjectiveRequest$json = {
  ...
  '2': [
    {'1': 'service_level_objective', '3': 1, '4': 1, '5': 11, '6': '.google.monitoring.v3.ServiceLevelObjective', '8': {}, '10': 'serviceLevelObjective'},
    {'1': 'update_mask', '3': 2, '4': 1, '5': 11, '6': '.google.protobuf.FieldMask', '10': 'updateMask'},
  ],
};

/// Descriptor for `UpdateServiceLevelObjectiveRequest`. Decode as a `google.protobuf.DescriptorProto`.
final $typed_data.Uint8List updateServiceLevelObjectiveRequestDescriptor = $convert.base64Decode(
...
final $typed_data.Uint8List deleteServiceLevelObjectiveRequestDescriptor = $convert.base64Decode(
