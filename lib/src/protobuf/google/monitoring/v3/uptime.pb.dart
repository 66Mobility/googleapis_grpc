...
class UptimeCheckConfig extends $pb.GeneratedMessage {
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(_omitMessageNames ? '' : 'UptimeCheckConfig', package: const $pb.PackageName(_omitMessageNames ? '' : 'google.monitoring.v3'), createEmptyInstance: create)
    ...
    ..aOM<$1737.Duration>(7, _omitFieldNames ? '' : 'period', subBuilder: $1737.Duration.create)
  ...
  /// defaults to `60s`.
  @$pb.TagNumber(7)
  $1737.Duration get period => $_getN(6);
  @$pb.TagNumber(7)
  set period($1737.Duration v) { setField(7, v); }
  @$pb.TagNumber(7)
  $core.bool hasPeriod() => $_has(6);
  @$pb.TagNumber(7)
  void clearPeriod() => clearField(7);
  @$pb.TagNumber(7)
  $1737.Duration ensurePeriod() => $_ensure(6);
