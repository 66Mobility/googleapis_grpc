...
class InternalChecker extends $pb.GeneratedMessage {
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(_omitMessageNames ? '' : 'InternalChecker', package: const $pb.PackageName(_omitMessageNames ? '' : 'google.monitoring.v3'), createEmptyInstance: create)
    ..aOS(1, _omitFieldNames ? '' : 'name')
    ..aOS(2, _omitFieldNames ? '' : 'displayName')
    ..aOS(3, _omitFieldNames ? '' : 'network')
    ..aOS(4, _omitFieldNames ? '' : 'gcpZone')
    ..aOS(6, _omitFieldNames ? '' : 'peerProjectId')
    ..e<InternalChecker_State>(7, _omitFieldNames ? '' : 'state', $pb.PbFieldType.OE, defaultOrMaker: InternalChecker_State.UNSPECIFIED, valueOf: InternalChecker_State.valueOf, enumValues: InternalChecker_State.values)
  ...
  'Will be removed in next major version')
  InternalChecker copyWith(void Function(InternalChecker) updates) => super.copyWith((message) => updates(message as InternalChecker)) as InternalChecker;
...
class SyntheticMonitorTarget_CloudFunctionV2Target extends $pb.GeneratedMessage {
  factory SyntheticMonitorTarget_CloudFunctionV2Target({
    $core.String? name,
    $196.MonitoredResource? cloudRunRevision,
  }) {
    final $result = create();
    if (name != null) {
      $result.name = name;
  ...
  factory SyntheticMonitorTarget_CloudFunctionV2Target.fromBuffer($core.List<$core.int> i, [$pb.ExtensionRegistry r = $pb.ExtensionRegistry.EMPTY]) => create()..mergeFromBuffer(i, r);
  factory SyntheticMonitorTarget_CloudFunctionV2Target.fromJson($core.String i, [$pb.ExtensionRegistry r = $pb.ExtensionRegistry.EMPTY]) => create()..mergeFromJson(i, r);
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(_omitMessageNames ? '' : 'SyntheticMonitorTarget.CloudFunctionV2Target', package: const $pb.PackageName(_omitMessageNames ? '' : 'google.monitoring.v3'), createEmptyInstance: create)
    ..aOS(1, _omitFieldNames ? '' : 'name')
    ..aOM<$196.MonitoredResource>(2, _omitFieldNames ? '' : 'cloudRunRevision', subBuilder: $196.MonitoredResource.create)
    ..hasRequiredFields = false
  ;
  ...
  'Use [GeneratedMessageGenericExtensions.deepCopy] instead. '
  'Will be removed in next major version')
  SyntheticMonitorTarget_CloudFunctionV2Target clone() => SyntheticMonitorTarget_CloudFunctionV2Target()..mergeFromMessage(this);
  @$core.Deprecated(
  'Using this can add significant overhead to your binary. '
  'Use [GeneratedMessageGenericExtensions.rebuild] instead. '
  'Will be removed in next major version')
  SyntheticMonitorTarget_CloudFunctionV2Target copyWith(void Function(SyntheticMonitorTarget_CloudFunctionV2Target) updates) => super.copyWith((message) => updates(message as SyntheticMonitorTarget_CloudFunctionV2Target)) as SyntheticMonitorTarget_CloudFunctionV2Target;

  $pb.BuilderInfo get info_ => _i;

  @$core.pragma('dart2js:noInline')
  static SyntheticMonitorTarget_CloudFunctionV2Target create() => SyntheticMonitorTarget_CloudFunctionV2Target._();
  SyntheticMonitorTarget_CloudFunctionV2Target createEmptyInstance() => create();
  static $pb.PbList<SyntheticMonitorTarget_CloudFunctionV2Target> createRepeated() => $pb.PbList<SyntheticMonitorTarget_CloudFunctionV2Target>();
  @$core.pragma('dart2js:noInline')
  static SyntheticMonitorTarget_CloudFunctionV2Target getDefault() => _defaultInstance ??= $pb.GeneratedMessage.$_defaultFor<SyntheticMonitorTarget_CloudFunctionV2Target>(create);
  ...
  /// only.
  @$pb.TagNumber(2)
  $196.MonitoredResource get cloudRunRevision => $_getN(1);
  @$pb.TagNumber(2)
  set cloudRunRevision($196.MonitoredResource v) { setField(2, v); }
  @$pb.TagNumber(2)
  $core.bool hasCloudRunRevision() => $_has(1);
  @$pb.TagNumber(2)
  void clearCloudRunRevision() => clearField(2);
  @$pb.TagNumber(2)
  $196.MonitoredResource ensureCloudRunRevision() => $_ensure(1);
}
...
class SyntheticMonitorTarget extends $pb.GeneratedMessage {
  ...
  factory SyntheticMonitorTarget.fromBuffer($core.List<$core.int> i, [$pb.ExtensionRegistry r = $pb.ExtensionRegistry.EMPTY]) => create()..mergeFromBuffer(i, r);
  factory SyntheticMonitorTarget.fromJson($core.String i, [$pb.ExtensionRegistry r = $pb.ExtensionRegistry.EMPTY]) => create()..mergeFromJson(i, r);

  static const $core.Map<$core.int, SyntheticMonitorTarget_Target> _SyntheticMonitorTarget_TargetByTag = {
    1 : SyntheticMonitorTarget_Target.cloudFunctionV2,
    0 : SyntheticMonitorTarget_Target.notSet
  };
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(_omitMessageNames ? '' : 'SyntheticMonitorTarget', package: const $pb.PackageName(_omitMessageNames ? '' : 'google.monitoring.v3'), createEmptyInstance: create)
    ..oo(0, [1])
    ..aOM<SyntheticMonitorTarget_CloudFunctionV2Target>(1, _omitFieldNames ? '' : 'cloudFunctionV2', subBuilder: SyntheticMonitorTarget_CloudFunctionV2Target.create)
    ..hasRequiredFields = false
  ;
  ...
  'Use [GeneratedMessageGenericExtensions.deepCopy] instead. '
  'Will be removed in next major version')
  SyntheticMonitorTarget clone() => SyntheticMonitorTarget()..mergeFromMessage(this);
  @$core.Deprecated(
  'Using this can add significant overhead to your binary. '
  'Use [GeneratedMessageGenericExtensions.rebuild] instead. '
  'Will be removed in next major version')
  SyntheticMonitorTarget copyWith(void Function(SyntheticMonitorTarget) updates) => super.copyWith((message) => updates(message as SyntheticMonitorTarget)) as SyntheticMonitorTarget;
  ...
  static $pb.PbList<SyntheticMonitorTarget> createRepeated() => $pb.PbList<SyntheticMonitorTarget>();
  @$core.pragma('dart2js:noInline')
  static SyntheticMonitorTarget getDefault() => _defaultInstance ??= $pb.GeneratedMessage.$_defaultFor<SyntheticMonitorTarget>(create);
  static SyntheticMonitorTarget? _defaultInstance;

  SyntheticMonitorTarget_Target whichTarget() => _SyntheticMonitorTarget_TargetByTag[$_whichOneof(0)]!;
  ...
  @$pb.TagNumber(1)
  set cloudFunctionV2(SyntheticMonitorTarget_CloudFunctionV2Target v) { setField(1, v); }
  @$pb.TagNumber(1)
  $core.bool hasCloudFunctionV2() => $_has(0);
  @$pb.TagNumber(1)
  void clearCloudFunctionV2() => clearField(1);
  @$pb.TagNumber(1)
  SyntheticMonitorTarget_CloudFunctionV2Target ensureCloudFunctionV2() => $_ensure(0);
}
...
class UptimeCheckConfig_ResourceGroup extends $pb.GeneratedMessage {
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(_omitMessageNames ? '' : 'UptimeCheckConfig.ResourceGroup', package: const $pb.PackageName(_omitMessageNames ? '' : 'google.monitoring.v3'), createEmptyInstance: create)
    ..aOS(1, _omitFieldNames ? '' : 'groupId')
    ..e<GroupResourceType>(2, _omitFieldNames ? '' : 'resourceType', $pb.PbFieldType.OE, defaultOrMaker: GroupResourceType.RESOURCE_TYPE_UNSPECIFIED, valueOf: GroupResourceType.valueOf, enumValues: GroupResourceType.values)
    ..hasRequiredFields = false
  ;
  ...
  'Use [GeneratedMessageGenericExtensions.rebuild] instead. '
  'Will be removed in next major version')
  UptimeCheckConfig_ResourceGroup copyWith(void Function(UptimeCheckConfig_ResourceGroup) updates) => super.copyWith((message) => updates(message as UptimeCheckConfig_ResourceGroup)) as UptimeCheckConfig_ResourceGroup;
...
class UptimeCheckConfig_PingConfig extends $pb.GeneratedMessage {
  ...
  factory UptimeCheckConfig_PingConfig.fromBuffer($core.List<$core.int> i, [$pb.ExtensionRegistry r = $pb.ExtensionRegistry.EMPTY]) => create()..mergeFromBuffer(i, r);
  factory UptimeCheckConfig_PingConfig.fromJson($core.String i, [$pb.ExtensionRegistry r = $pb.ExtensionRegistry.EMPTY]) => create()..mergeFromJson(i, r);

  static final $pb.BuilderInfo _i = $pb.BuilderInfo(_omitMessageNames ? '' : 'UptimeCheckConfig.PingConfig', package: const $pb.PackageName(_omitMessageNames ? '' : 'google.monitoring.v3'), createEmptyInstance: create)
  ...
  'Use [GeneratedMessageGenericExtensions.deepCopy] instead. '
  'Will be removed in next major version')
  UptimeCheckConfig_PingConfig clone() => UptimeCheckConfig_PingConfig()..mergeFromMessage(this);
  @$core.Deprecated(
  'Using this can add significant overhead to your binary. '
  'Use [GeneratedMessageGenericExtensions.rebuild] instead. '
  'Will be removed in next major version')
  UptimeCheckConfig_PingConfig copyWith(void Function(UptimeCheckConfig_PingConfig) updates) => super.copyWith((message) => updates(message as UptimeCheckConfig_PingConfig)) as UptimeCheckConfig_PingConfig;

  $pb.BuilderInfo get info_ => _i;

  @$core.pragma('dart2js:noInline')
  static UptimeCheckConfig_PingConfig create() => UptimeCheckConfig_PingConfig._();
  UptimeCheckConfig_PingConfig createEmptyInstance() => create();
  static $pb.PbList<UptimeCheckConfig_PingConfig> createRepeated() => $pb.PbList<UptimeCheckConfig_PingConfig>();
  @$core.pragma('dart2js:noInline')
  static UptimeCheckConfig_PingConfig getDefault() => _defaultInstance ??= $pb.GeneratedMessage.$_defaultFor<UptimeCheckConfig_PingConfig>(create);
  ...
  @$pb.TagNumber(1)
  set pingsCount($core.int v) { $_setSignedInt32(0, v); }
  @$pb.TagNumber(1)
...
class UptimeCheckConfig_HttpCheck_BasicAuthentication extends $pb.GeneratedMessage {
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(_omitMessageNames ? '' : 'UptimeCheckConfig.HttpCheck.BasicAuthentication', package: const $pb.PackageName(_omitMessageNames ? '' : 'google.monitoring.v3'), createEmptyInstance: create)
  ...
  'Use [GeneratedMessageGenericExtensions.rebuild] instead. '
  'Will be removed in next major version')
  UptimeCheckConfig_HttpCheck_BasicAuthentication copyWith(void Function(UptimeCheckConfig_HttpCheck_BasicAuthentication) updates) => super.copyWith((message) => updates(message as UptimeCheckConfig_HttpCheck_BasicAuthentication)) as UptimeCheckConfig_HttpCheck_BasicAuthentication;
...
class UptimeCheckConfig_HttpCheck_ResponseStatusCode extends $pb.GeneratedMessage {
  ...
  factory UptimeCheckConfig_HttpCheck_ResponseStatusCode.fromBuffer($core.List<$core.int> i, [$pb.ExtensionRegistry r = $pb.ExtensionRegistry.EMPTY]) => create()..mergeFromBuffer(i, r);
  factory UptimeCheckConfig_HttpCheck_ResponseStatusCode.fromJson($core.String i, [$pb.ExtensionRegistry r = $pb.ExtensionRegistry.EMPTY]) => create()..mergeFromJson(i, r);

  static const $core.Map<$core.int, UptimeCheckConfig_HttpCheck_ResponseStatusCode_StatusCode> _UptimeCheckConfig_HttpCheck_ResponseStatusCode_StatusCodeByTag = {
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(_omitMessageNames ? '' : 'UptimeCheckConfig.HttpCheck.ResponseStatusCode', package: const $pb.PackageName(_omitMessageNames ? '' : 'google.monitoring.v3'), createEmptyInstance: create)
    ..oo(0, [1, 2])
    ..a<$core.int>(1, _omitFieldNames ? '' : 'statusValue', $pb.PbFieldType.O3)
    ..e<UptimeCheckConfig_HttpCheck_ResponseStatusCode_StatusClass>(2, _omitFieldNames ? '' : 'statusClass', $pb.PbFieldType.OE, defaultOrMaker: UptimeCheckConfig_HttpCheck_ResponseStatusCode_StatusClass.STATUS_CLASS_UNSPECIFIED, valueOf: UptimeCheckConfig_HttpCheck_ResponseStatusCode_StatusClass.valueOf, enumValues: UptimeCheckConfig_HttpCheck_ResponseStatusCode_StatusClass.values)
    ..hasRequiredFields = false
  ;
  ...
  'Use [GeneratedMessageGenericExtensions.deepCopy] instead. '
  'Will be removed in next major version')
  UptimeCheckConfig_HttpCheck_ResponseStatusCode clone() => UptimeCheckConfig_HttpCheck_ResponseStatusCode()..mergeFromMessage(this);
  @$core.Deprecated(
  'Using this can add significant overhead to your binary. '
  'Use [GeneratedMessageGenericExtensions.rebuild] instead. '
  'Will be removed in next major version')
  UptimeCheckConfig_HttpCheck_ResponseStatusCode copyWith(void Function(UptimeCheckConfig_HttpCheck_ResponseStatusCode) updates) => super.copyWith((message) => updates(message as UptimeCheckConfig_HttpCheck_ResponseStatusCode)) as UptimeCheckConfig_HttpCheck_ResponseStatusCode;

  $pb.BuilderInfo get info_ => _i;

  @$core.pragma('dart2js:noInline')
  static UptimeCheckConfig_HttpCheck_ResponseStatusCode create() => UptimeCheckConfig_HttpCheck_ResponseStatusCode._();
  UptimeCheckConfig_HttpCheck_ResponseStatusCode createEmptyInstance() => create();
  static $pb.PbList<UptimeCheckConfig_HttpCheck_ResponseStatusCode> createRepeated() => $pb.PbList<UptimeCheckConfig_HttpCheck_ResponseStatusCode>();
  @$core.pragma('dart2js:noInline')
  static UptimeCheckConfig_HttpCheck_ResponseStatusCode getDefault() => _defaultInstance ??= $pb.GeneratedMessage.$_defaultFor<UptimeCheckConfig_HttpCheck_ResponseStatusCode>(create);
  static UptimeCheckConfig_HttpCheck_ResponseStatusCode? _defaultInstance;

  UptimeCheckConfig_HttpCheck_ResponseStatusCode_StatusCode whichStatusCode() => _UptimeCheckConfig_HttpCheck_ResponseStatusCode_StatusCodeByTag[$_whichOneof(0)]!;
  ...
  @$pb.TagNumber(1)
  set statusValue($core.int v) { $_setSignedInt32(0, v); }
  @$pb.TagNumber(1)
  ...
  @$pb.TagNumber(2)
  UptimeCheckConfig_HttpCheck_ResponseStatusCode_StatusClass get statusClass => $_getN(1);
  @$pb.TagNumber(2)
  set statusClass(UptimeCheckConfig_HttpCheck_ResponseStatusCode_StatusClass v) { setField(2, v); }
  @$pb.TagNumber(2)
...
/// account.
class UptimeCheckConfig_HttpCheck_ServiceAgentAuthentication extends $pb.GeneratedMessage {
  factory UptimeCheckConfig_HttpCheck_ServiceAgentAuthentication({
    UptimeCheckConfig_HttpCheck_ServiceAgentAuthentication_ServiceAgentAuthenticationType? type,
  }) {
    final $result = create();
    if (type != null) {
      $result.type = type;
  ...
  factory UptimeCheckConfig_HttpCheck_ServiceAgentAuthentication.fromBuffer($core.List<$core.int> i, [$pb.ExtensionRegistry r = $pb.ExtensionRegistry.EMPTY]) => create()..mergeFromBuffer(i, r);
  factory UptimeCheckConfig_HttpCheck_ServiceAgentAuthentication.fromJson($core.String i, [$pb.ExtensionRegistry r = $pb.ExtensionRegistry.EMPTY]) => create()..mergeFromJson(i, r);

  static final $pb.BuilderInfo _i = $pb.BuilderInfo(_omitMessageNames ? '' : 'UptimeCheckConfig.HttpCheck.ServiceAgentAuthentication', package: const $pb.PackageName(_omitMessageNames ? '' : 'google.monitoring.v3'), createEmptyInstance: create)
    ..e<UptimeCheckConfig_HttpCheck_ServiceAgentAuthentication_ServiceAgentAuthenticationType>(1, _omitFieldNames ? '' : 'type', $pb.PbFieldType.OE, defaultOrMaker: UptimeCheckConfig_HttpCheck_ServiceAgentAuthentication_ServiceAgentAuthenticationType.SERVICE_AGENT_AUTHENTICATION_TYPE_UNSPECIFIED, valueOf: UptimeCheckConfig_HttpCheck_ServiceAgentAuthentication_ServiceAgentAuthenticationType.valueOf, enumValues: UptimeCheckConfig_HttpCheck_ServiceAgentAuthentication_ServiceAgentAuthenticationType.values)
    ..hasRequiredFields = false
  ;
  ...
  'Use [GeneratedMessageGenericExtensions.deepCopy] instead. '
  'Will be removed in next major version')
  UptimeCheckConfig_HttpCheck_ServiceAgentAuthentication clone() => UptimeCheckConfig_HttpCheck_ServiceAgentAuthentication()..mergeFromMessage(this);
  @$core.Deprecated(
  'Using this can add significant overhead to your binary. '
  'Use [GeneratedMessageGenericExtensions.rebuild] instead. '
  'Will be removed in next major version')
  UptimeCheckConfig_HttpCheck_ServiceAgentAuthentication copyWith(void Function(UptimeCheckConfig_HttpCheck_ServiceAgentAuthentication) updates) => super.copyWith((message) => updates(message as UptimeCheckConfig_HttpCheck_ServiceAgentAuthentication)) as UptimeCheckConfig_HttpCheck_ServiceAgentAuthentication;

  $pb.BuilderInfo get info_ => _i;

  @$core.pragma('dart2js:noInline')
  static UptimeCheckConfig_HttpCheck_ServiceAgentAuthentication create() => UptimeCheckConfig_HttpCheck_ServiceAgentAuthentication._();
  UptimeCheckConfig_HttpCheck_ServiceAgentAuthentication createEmptyInstance() => create();
  static $pb.PbList<UptimeCheckConfig_HttpCheck_ServiceAgentAuthentication> createRepeated() => $pb.PbList<UptimeCheckConfig_HttpCheck_ServiceAgentAuthentication>();
  @$core.pragma('dart2js:noInline')
  static UptimeCheckConfig_HttpCheck_ServiceAgentAuthentication getDefault() => _defaultInstance ??= $pb.GeneratedMessage.$_defaultFor<UptimeCheckConfig_HttpCheck_ServiceAgentAuthentication>(create);
  static UptimeCheckConfig_HttpCheck_ServiceAgentAuthentication? _defaultInstance;

  /// Type of authentication.
  @$pb.TagNumber(1)
  UptimeCheckConfig_HttpCheck_ServiceAgentAuthentication_ServiceAgentAuthenticationType get type => $_getN(0);
  @$pb.TagNumber(1)
  set type(UptimeCheckConfig_HttpCheck_ServiceAgentAuthentication_ServiceAgentAuthenticationType v) { setField(1, v); }
  @$pb.TagNumber(1)
...
class UptimeCheckConfig_HttpCheck extends $pb.GeneratedMessage {
  factory UptimeCheckConfig_HttpCheck({
    ...
    $core.Iterable<UptimeCheckConfig_HttpCheck_ResponseStatusCode>? acceptedResponseStatusCodes,
    UptimeCheckConfig_PingConfig? pingConfig,
    $core.String? customContentType,
    UptimeCheckConfig_HttpCheck_ServiceAgentAuthentication? serviceAgentAuthentication,
  }) {
    final $result = create();
    if (useSsl != null) {
  ...
  static const $core.Map<$core.int, UptimeCheckConfig_HttpCheck_AuthMethod> _UptimeCheckConfig_HttpCheck_AuthMethodByTag = {
    14 : UptimeCheckConfig_HttpCheck_AuthMethod.serviceAgentAuthentication,
    0 : UptimeCheckConfig_HttpCheck_AuthMethod.notSet
  };
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(_omitMessageNames ? '' : 'UptimeCheckConfig.HttpCheck', package: const $pb.PackageName(_omitMessageNames ? '' : 'google.monitoring.v3'), createEmptyInstance: create)
    ..oo(0, [14])
    ..aOB(1, _omitFieldNames ? '' : 'useSsl')
    ..aOS(2, _omitFieldNames ? '' : 'path')
    ..a<$core.int>(3, _omitFieldNames ? '' : 'port', $pb.PbFieldType.O3)
    ..aOM<UptimeCheckConfig_HttpCheck_BasicAuthentication>(4, _omitFieldNames ? '' : 'authInfo', subBuilder: UptimeCheckConfig_HttpCheck_BasicAuthentication.create)
    ..aOB(5, _omitFieldNames ? '' : 'maskHeaders')
    ..m<$core.String, $core.String>(6, _omitFieldNames ? '' : 'headers', entryClassName: 'UptimeCheckConfig.HttpCheck.HeadersEntry', keyFieldType: $pb.PbFieldType.OS, valueFieldType: $pb.PbFieldType.OS, packageName: const $pb.PackageName('google.monitoring.v3'))
    ..aOB(7, _omitFieldNames ? '' : 'validateSsl')
    ..e<UptimeCheckConfig_HttpCheck_RequestMethod>(8, _omitFieldNames ? '' : 'requestMethod', $pb.PbFieldType.OE, defaultOrMaker: UptimeCheckConfig_HttpCheck_RequestMethod.METHOD_UNSPECIFIED, valueOf: UptimeCheckConfig_HttpCheck_RequestMethod.valueOf, enumValues: UptimeCheckConfig_HttpCheck_RequestMethod.values)
    ..e<UptimeCheckConfig_HttpCheck_ContentType>(9, _omitFieldNames ? '' : 'contentType', $pb.PbFieldType.OE, defaultOrMaker: UptimeCheckConfig_HttpCheck_ContentType.TYPE_UNSPECIFIED, valueOf: UptimeCheckConfig_HttpCheck_ContentType.valueOf, enumValues: UptimeCheckConfig_HttpCheck_ContentType.values)
    ..a<$core.List<$core.int>>(10, _omitFieldNames ? '' : 'body', $pb.PbFieldType.OY)
    ..pc<UptimeCheckConfig_HttpCheck_ResponseStatusCode>(11, _omitFieldNames ? '' : 'acceptedResponseStatusCodes', $pb.PbFieldType.PM, subBuilder: UptimeCheckConfig_HttpCheck_ResponseStatusCode.create)
    ..aOM<UptimeCheckConfig_PingConfig>(12, _omitFieldNames ? '' : 'pingConfig', subBuilder: UptimeCheckConfig_PingConfig.create)
    ..aOS(13, _omitFieldNames ? '' : 'customContentType')
    ..aOM<UptimeCheckConfig_HttpCheck_ServiceAgentAuthentication>(14, _omitFieldNames ? '' : 'serviceAgentAuthentication', subBuilder: UptimeCheckConfig_HttpCheck_ServiceAgentAuthentication.create)
    ..hasRequiredFields = false
  ;
  ...
  'Use [GeneratedMessageGenericExtensions.rebuild] instead. '
  'Will be removed in next major version')
  UptimeCheckConfig_HttpCheck copyWith(void Function(UptimeCheckConfig_HttpCheck) updates) => super.copyWith((message) => updates(message as UptimeCheckConfig_HttpCheck)) as UptimeCheckConfig_HttpCheck;
  ...
  UptimeCheckConfig_HttpCheck_AuthMethod whichAuthMethod() => _UptimeCheckConfig_HttpCheck_AuthMethodByTag[$_whichOneof(0)]!;
  ...
  @$pb.TagNumber(11)
  $core.List<UptimeCheckConfig_HttpCheck_ResponseStatusCode> get acceptedResponseStatusCodes => $_getList(10);

  /// Contains information needed to add pings to an HTTP check.
  @$pb.TagNumber(12)
  UptimeCheckConfig_PingConfig get pingConfig => $_getN(11);
  @$pb.TagNumber(12)
  set pingConfig(UptimeCheckConfig_PingConfig v) { setField(12, v); }
  @$pb.TagNumber(12)
  ...
  @$pb.TagNumber(13)
  set customContentType($core.String v) { $_setString(12, v); }
  @$pb.TagNumber(13)
  ...
  @$pb.TagNumber(14)
  UptimeCheckConfig_HttpCheck_ServiceAgentAuthentication get serviceAgentAuthentication => $_getN(13);
  @$pb.TagNumber(14)
  set serviceAgentAuthentication(UptimeCheckConfig_HttpCheck_ServiceAgentAuthentication v) { setField(14, v); }
  @$pb.TagNumber(14)
  $core.bool hasServiceAgentAuthentication() => $_has(13);
  @$pb.TagNumber(14)
  void clearServiceAgentAuthentication() => clearField(14);
  @$pb.TagNumber(14)
  UptimeCheckConfig_HttpCheck_ServiceAgentAuthentication ensureServiceAgentAuthentication() => $_ensure(13);
}
...
class UptimeCheckConfig_TcpCheck extends $pb.GeneratedMessage {
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(_omitMessageNames ? '' : 'UptimeCheckConfig.TcpCheck', package: const $pb.PackageName(_omitMessageNames ? '' : 'google.monitoring.v3'), createEmptyInstance: create)
    ..a<$core.int>(1, _omitFieldNames ? '' : 'port', $pb.PbFieldType.O3)
    ..aOM<UptimeCheckConfig_PingConfig>(2, _omitFieldNames ? '' : 'pingConfig', subBuilder: UptimeCheckConfig_PingConfig.create)
    ..hasRequiredFields = false
  ;
  ...
  'Use [GeneratedMessageGenericExtensions.rebuild] instead. '
  'Will be removed in next major version')
  UptimeCheckConfig_TcpCheck copyWith(void Function(UptimeCheckConfig_TcpCheck) updates) => super.copyWith((message) => updates(message as UptimeCheckConfig_TcpCheck)) as UptimeCheckConfig_TcpCheck;
  ...
  @$pb.TagNumber(2)
  set pingConfig(UptimeCheckConfig_PingConfig v) { setField(2, v); }
  @$pb.TagNumber(2)
...
class UptimeCheckConfig_ContentMatcher_JsonPathMatcher extends $pb.GeneratedMessage {
  factory UptimeCheckConfig_ContentMatcher_JsonPathMatcher({
    $core.String? jsonPath,
    UptimeCheckConfig_ContentMatcher_JsonPathMatcher_JsonPathMatcherOption? jsonMatcher,
  }) {
    final $result = create();
    if (jsonPath != null) {
  ...
  factory UptimeCheckConfig_ContentMatcher_JsonPathMatcher.fromBuffer($core.List<$core.int> i, [$pb.ExtensionRegistry r = $pb.ExtensionRegistry.EMPTY]) => create()..mergeFromBuffer(i, r);
  factory UptimeCheckConfig_ContentMatcher_JsonPathMatcher.fromJson($core.String i, [$pb.ExtensionRegistry r = $pb.ExtensionRegistry.EMPTY]) => create()..mergeFromJson(i, r);

  static final $pb.BuilderInfo _i = $pb.BuilderInfo(_omitMessageNames ? '' : 'UptimeCheckConfig.ContentMatcher.JsonPathMatcher', package: const $pb.PackageName(_omitMessageNames ? '' : 'google.monitoring.v3'), createEmptyInstance: create)
    ..aOS(1, _omitFieldNames ? '' : 'jsonPath')
    ..e<UptimeCheckConfig_ContentMatcher_JsonPathMatcher_JsonPathMatcherOption>(2, _omitFieldNames ? '' : 'jsonMatcher', $pb.PbFieldType.OE, defaultOrMaker: UptimeCheckConfig_ContentMatcher_JsonPathMatcher_JsonPathMatcherOption.JSON_PATH_MATCHER_OPTION_UNSPECIFIED, valueOf: UptimeCheckConfig_ContentMatcher_JsonPathMatcher_JsonPathMatcherOption.valueOf, enumValues: UptimeCheckConfig_ContentMatcher_JsonPathMatcher_JsonPathMatcherOption.values)
    ..hasRequiredFields = false
  ;
  ...
  'Use [GeneratedMessageGenericExtensions.deepCopy] instead. '
  'Will be removed in next major version')
  UptimeCheckConfig_ContentMatcher_JsonPathMatcher clone() => UptimeCheckConfig_ContentMatcher_JsonPathMatcher()..mergeFromMessage(this);
  @$core.Deprecated(
  'Using this can add significant overhead to your binary. '
  'Use [GeneratedMessageGenericExtensions.rebuild] instead. '
  'Will be removed in next major version')
  UptimeCheckConfig_ContentMatcher_JsonPathMatcher copyWith(void Function(UptimeCheckConfig_ContentMatcher_JsonPathMatcher) updates) => super.copyWith((message) => updates(message as UptimeCheckConfig_ContentMatcher_JsonPathMatcher)) as UptimeCheckConfig_ContentMatcher_JsonPathMatcher;

  $pb.BuilderInfo get info_ => _i;

  @$core.pragma('dart2js:noInline')
  static UptimeCheckConfig_ContentMatcher_JsonPathMatcher create() => UptimeCheckConfig_ContentMatcher_JsonPathMatcher._();
  UptimeCheckConfig_ContentMatcher_JsonPathMatcher createEmptyInstance() => create();
  static $pb.PbList<UptimeCheckConfig_ContentMatcher_JsonPathMatcher> createRepeated() => $pb.PbList<UptimeCheckConfig_ContentMatcher_JsonPathMatcher>();
  @$core.pragma('dart2js:noInline')
  static UptimeCheckConfig_ContentMatcher_JsonPathMatcher getDefault() => _defaultInstance ??= $pb.GeneratedMessage.$_defaultFor<UptimeCheckConfig_ContentMatcher_JsonPathMatcher>(create);
  ...
  @$pb.TagNumber(2)
  UptimeCheckConfig_ContentMatcher_JsonPathMatcher_JsonPathMatcherOption get jsonMatcher => $_getN(1);
  @$pb.TagNumber(2)
  set jsonMatcher(UptimeCheckConfig_ContentMatcher_JsonPathMatcher_JsonPathMatcherOption v) { setField(2, v); }
  @$pb.TagNumber(2)
...
class UptimeCheckConfig_ContentMatcher extends $pb.GeneratedMessage {
  ...
  static const $core.Map<$core.int, UptimeCheckConfig_ContentMatcher_AdditionalMatcherInfo> _UptimeCheckConfig_ContentMatcher_AdditionalMatcherInfoByTag = {
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(_omitMessageNames ? '' : 'UptimeCheckConfig.ContentMatcher', package: const $pb.PackageName(_omitMessageNames ? '' : 'google.monitoring.v3'), createEmptyInstance: create)
    ..oo(0, [3])
    ..aOS(1, _omitFieldNames ? '' : 'content')
    ..e<UptimeCheckConfig_ContentMatcher_ContentMatcherOption>(2, _omitFieldNames ? '' : 'matcher', $pb.PbFieldType.OE, defaultOrMaker: UptimeCheckConfig_ContentMatcher_ContentMatcherOption.CONTENT_MATCHER_OPTION_UNSPECIFIED, valueOf: UptimeCheckConfig_ContentMatcher_ContentMatcherOption.valueOf, enumValues: UptimeCheckConfig_ContentMatcher_ContentMatcherOption.values)
    ..aOM<UptimeCheckConfig_ContentMatcher_JsonPathMatcher>(3, _omitFieldNames ? '' : 'jsonPathMatcher', subBuilder: UptimeCheckConfig_ContentMatcher_JsonPathMatcher.create)
    ..hasRequiredFields = false
  ;
  ...
  'Use [GeneratedMessageGenericExtensions.rebuild] instead. '
  'Will be removed in next major version')
  UptimeCheckConfig_ContentMatcher copyWith(void Function(UptimeCheckConfig_ContentMatcher) updates) => super.copyWith((message) => updates(message as UptimeCheckConfig_ContentMatcher)) as UptimeCheckConfig_ContentMatcher;
  ...
  UptimeCheckConfig_ContentMatcher_AdditionalMatcherInfo whichAdditionalMatcherInfo() => _UptimeCheckConfig_ContentMatcher_AdditionalMatcherInfoByTag[$_whichOneof(0)]!;
  ...
  @$pb.TagNumber(3)
  UptimeCheckConfig_ContentMatcher_JsonPathMatcher get jsonPathMatcher => $_getN(2);
  @$pb.TagNumber(3)
  set jsonPathMatcher(UptimeCheckConfig_ContentMatcher_JsonPathMatcher v) { setField(3, v); }
  @$pb.TagNumber(3)
  $core.bool hasJsonPathMatcher() => $_has(2);
  @$pb.TagNumber(3)
  void clearJsonPathMatcher() => clearField(3);
  @$pb.TagNumber(3)
  UptimeCheckConfig_ContentMatcher_JsonPathMatcher ensureJsonPathMatcher() => $_ensure(2);
}
...
class UptimeCheckConfig extends $pb.GeneratedMessage {
  factory UptimeCheckConfig({
    $core.String? name,
    $core.String? displayName,
    $196.MonitoredResource? monitoredResource,
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(_omitMessageNames ? '' : 'UptimeCheckConfig', package: const $pb.PackageName(_omitMessageNames ? '' : 'google.monitoring.v3'), createEmptyInstance: create)
    ..oo(0, [3, 4, 21])
    ..oo(1, [5, 6])
    ..aOS(1, _omitFieldNames ? '' : 'name')
    ..aOS(2, _omitFieldNames ? '' : 'displayName')
    ..aOM<$196.MonitoredResource>(3, _omitFieldNames ? '' : 'monitoredResource', subBuilder: $196.MonitoredResource.create)
    ...
    ..e<UptimeCheckConfig_CheckerType>(17, _omitFieldNames ? '' : 'checkerType', $pb.PbFieldType.OE, defaultOrMaker: UptimeCheckConfig_CheckerType.CHECKER_TYPE_UNSPECIFIED, valueOf: UptimeCheckConfig_CheckerType.valueOf, enumValues: UptimeCheckConfig_CheckerType.values)
    ..m<$core.String, $core.String>(20, _omitFieldNames ? '' : 'userLabels', entryClassName: 'UptimeCheckConfig.UserLabelsEntry', keyFieldType: $pb.PbFieldType.OS, valueFieldType: $pb.PbFieldType.OS, packageName: const $pb.PackageName('google.monitoring.v3'))
    ..aOM<SyntheticMonitorTarget>(21, _omitFieldNames ? '' : 'syntheticMonitor', subBuilder: SyntheticMonitorTarget.create)
    ..hasRequiredFields = false
  ;
  ...
  'Use [GeneratedMessageGenericExtensions.rebuild] instead. '
  'Will be removed in next major version')
  UptimeCheckConfig copyWith(void Function(UptimeCheckConfig) updates) => super.copyWith((message) => updates(message as UptimeCheckConfig)) as UptimeCheckConfig;
  ...
  ///   `cloud_run_revision`
  @$pb.TagNumber(3)
  $196.MonitoredResource get monitoredResource => $_getN(2);
  @$pb.TagNumber(3)
  set monitoredResource($196.MonitoredResource v) { setField(3, v); }
  @$pb.TagNumber(3)
  $core.bool hasMonitoredResource() => $_has(2);
  @$pb.TagNumber(3)
  void clearMonitoredResource() => clearField(3);
  @$pb.TagNumber(3)
  $196.MonitoredResource ensureMonitoredResource() => $_ensure(2);
  ...
  @$pb.TagNumber(17)
  set checkerType(UptimeCheckConfig_CheckerType v) { setField(17, v); }
  @$pb.TagNumber(17)
  ...
  @$pb.TagNumber(21)
  set syntheticMonitor(SyntheticMonitorTarget v) { setField(21, v); }
  @$pb.TagNumber(21)
...
class UptimeCheckIp extends $pb.GeneratedMessage {
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(_omitMessageNames ? '' : 'UptimeCheckIp', package: const $pb.PackageName(_omitMessageNames ? '' : 'google.monitoring.v3'), createEmptyInstance: create)
    ..e<UptimeCheckRegion>(1, _omitFieldNames ? '' : 'region', $pb.PbFieldType.OE, defaultOrMaker: UptimeCheckRegion.REGION_UNSPECIFIED, valueOf: UptimeCheckRegion.valueOf, enumValues: UptimeCheckRegion.values)
  ...
  'Use [GeneratedMessageGenericExtensions.rebuild] instead. '
  'Will be removed in next major version')
  UptimeCheckIp copyWith(void Function(UptimeCheckIp) updates) => super.copyWith((message) => updates(message as UptimeCheckIp)) as UptimeCheckIp;
