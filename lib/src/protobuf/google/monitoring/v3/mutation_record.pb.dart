...
class MutationRecord extends $pb.GeneratedMessage {
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(
    ...
    ..aOM<$330.Timestamp>(1, _omitFieldNames ? '' : 'mutateTime',
  ...
  @$pb.TagNumber(1)
  $330.Timestamp get mutateTime => $_getN(0);
  @$pb.TagNumber(1)
  set mutateTime($330.Timestamp v) {
    setField(1, v);
  }
  ...
  @$pb.TagNumber(1)
  $330.Timestamp ensureMutateTime() => $_ensure(0);
