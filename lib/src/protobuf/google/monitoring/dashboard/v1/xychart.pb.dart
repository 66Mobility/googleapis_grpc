...
class XyChart_DataSet extends $pb.GeneratedMessage {
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(
    ...
    ..aOM<$292.Duration>(4, _omitFieldNames ? '' : 'minAlignmentPeriod',
  ...
  @$pb.TagNumber(4)
  $292.Duration get minAlignmentPeriod => $_getN(3);
  @$pb.TagNumber(4)
  ...
  @$pb.TagNumber(4)
  $292.Duration ensureMinAlignmentPeriod() => $_ensure(3);
...
class XyChart extends $pb.GeneratedMessage {
  factory XyChart({
    ...
    $292.Duration? timeshiftDuration,
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(
    ...
    ..aOM<$292.Duration>(4, _omitFieldNames ? '' : 'timeshiftDuration',
        subBuilder: $292.Duration.create)
    ..pc<$546.Threshold>(
  ...
  @$pb.TagNumber(4)
  $292.Duration get timeshiftDuration => $_getN(1);
  @$pb.TagNumber(4)
  set timeshiftDuration($292.Duration v) {
    setField(4, v);
  }
  ...
  @$pb.TagNumber(4)
  $292.Duration ensureTimeshiftDuration() => $_ensure(1);

  /// Threshold lines drawn horizontally across the chart.
  @$pb.TagNumber(5)
  $core.List<$546.Threshold> get thresholds => $_getList(2);
