...
import 'metrics.pbenum.dart' as $517;
...
class Scorecard_SparkChartView extends $pb.GeneratedMessage {
  factory Scorecard_SparkChartView({
    $517.SparkChartType? sparkChartType,
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(
      ...
      package: const $pb.PackageName(
          _omitMessageNames ? '' : 'google.monitoring.dashboard.v1'),
      createEmptyInstance: create)
    ..e<$517.SparkChartType>(
        1, _omitFieldNames ? '' : 'sparkChartType', $pb.PbFieldType.OE,
        defaultOrMaker: $517.SparkChartType.SPARK_CHART_TYPE_UNSPECIFIED,
        valueOf: $517.SparkChartType.valueOf,
        enumValues: $517.SparkChartType.values)
    ..aOM<$266.Duration>(2, _omitFieldNames ? '' : 'minAlignmentPeriod',
  ...
  @$pb.TagNumber(1)
  $517.SparkChartType get sparkChartType => $_getN(0);
  @$pb.TagNumber(1)
  set sparkChartType($517.SparkChartType v) {
    setField(1, v);
  }
  ...
  @$pb.TagNumber(2)
  $266.Duration get minAlignmentPeriod => $_getN(1);
  @$pb.TagNumber(2)
  ...
  @$pb.TagNumber(2)
  $266.Duration ensureMinAlignmentPeriod() => $_ensure(1);
}
...
class Scorecard extends $pb.GeneratedMessage {
  ...
  ///  90 a DANGER state.
  @$pb.TagNumber(6)
  $core.List<$517.Threshold> get thresholds => $_getList(3);
