...
import 'metrics.pbenum.dart' as $546;
...
class Scorecard_SparkChartView extends $pb.GeneratedMessage {
  factory Scorecard_SparkChartView({
    $546.SparkChartType? sparkChartType,
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(
      ...
      package: const $pb.PackageName(
          _omitMessageNames ? '' : 'google.monitoring.dashboard.v1'),
      createEmptyInstance: create)
    ..e<$546.SparkChartType>(
        1, _omitFieldNames ? '' : 'sparkChartType', $pb.PbFieldType.OE,
        defaultOrMaker: $546.SparkChartType.SPARK_CHART_TYPE_UNSPECIFIED,
        valueOf: $546.SparkChartType.valueOf,
        enumValues: $546.SparkChartType.values)
    ..aOM<$292.Duration>(2, _omitFieldNames ? '' : 'minAlignmentPeriod',
  ...
  @$pb.TagNumber(1)
  $546.SparkChartType get sparkChartType => $_getN(0);
  @$pb.TagNumber(1)
  set sparkChartType($546.SparkChartType v) {
    setField(1, v);
  }
  ...
  @$pb.TagNumber(2)
  $292.Duration get minAlignmentPeriod => $_getN(1);
  @$pb.TagNumber(2)
  ...
  @$pb.TagNumber(2)
  $292.Duration ensureMinAlignmentPeriod() => $_ensure(1);
}
...
class Scorecard extends $pb.GeneratedMessage {
  factory Scorecard({
    ...
    $core.Iterable<$546.Threshold>? thresholds,
    $3.Empty? blankView,
  }) {
    final $result = create();
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(
    ...
    ..pc<$546.Threshold>(
        ...
        subBuilder: $546.Threshold.create)
  ...
  ///  90 a DANGER state.
  @$pb.TagNumber(6)
  $core.List<$546.Threshold> get thresholds => $_getList(3);
