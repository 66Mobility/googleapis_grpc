...
class PickTimeSeriesFilter_Method extends $pb.ProtobufEnum {
  static const PickTimeSeriesFilter_Method METHOD_UNSPECIFIED = PickTimeSeriesFilter_Method._(0, _omitEnumNames ? '' : 'METHOD_UNSPECIFIED');
  static const PickTimeSeriesFilter_Method METHOD_MEAN = PickTimeSeriesFilter_Method._(1, _omitEnumNames ? '' : 'METHOD_MEAN');
  static const PickTimeSeriesFilter_Method METHOD_MAX = PickTimeSeriesFilter_Method._(2, _omitEnumNames ? '' : 'METHOD_MAX');
  static const PickTimeSeriesFilter_Method METHOD_MIN = PickTimeSeriesFilter_Method._(3, _omitEnumNames ? '' : 'METHOD_MIN');
  static const PickTimeSeriesFilter_Method METHOD_SUM = PickTimeSeriesFilter_Method._(4, _omitEnumNames ? '' : 'METHOD_SUM');
  static const PickTimeSeriesFilter_Method METHOD_LATEST = PickTimeSeriesFilter_Method._(5, _omitEnumNames ? '' : 'METHOD_LATEST');
...
class PickTimeSeriesFilter_Direction extends $pb.ProtobufEnum {
  static const PickTimeSeriesFilter_Direction DIRECTION_UNSPECIFIED = PickTimeSeriesFilter_Direction._(0, _omitEnumNames ? '' : 'DIRECTION_UNSPECIFIED');
  static const PickTimeSeriesFilter_Direction TOP = PickTimeSeriesFilter_Direction._(1, _omitEnumNames ? '' : 'TOP');
  static const PickTimeSeriesFilter_Direction BOTTOM = PickTimeSeriesFilter_Direction._(2, _omitEnumNames ? '' : 'BOTTOM');
...
class StatisticalTimeSeriesFilter_Method extends $pb.ProtobufEnum {
  static const StatisticalTimeSeriesFilter_Method METHOD_UNSPECIFIED = StatisticalTimeSeriesFilter_Method._(0, _omitEnumNames ? '' : 'METHOD_UNSPECIFIED');
  static const StatisticalTimeSeriesFilter_Method METHOD_CLUSTER_OUTLIER = StatisticalTimeSeriesFilter_Method._(1, _omitEnumNames ? '' : 'METHOD_CLUSTER_OUTLIER');
