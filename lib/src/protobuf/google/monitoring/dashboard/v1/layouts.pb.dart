...
class GridLayout extends $pb.GeneratedMessage {
  factory GridLayout({
    ...
    $core.Iterable<$560.Widget>? widgets,
  }) {
    final $result = create();
    if (columns != null) {
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(
    ...
    ..pc<$560.Widget>(2, _omitFieldNames ? '' : 'widgets', $pb.PbFieldType.PM,
        subBuilder: $560.Widget.create)
  ...
  @$pb.TagNumber(2)
  $core.List<$560.Widget> get widgets => $_getList(1);
}
...
class MosaicLayout_Tile extends $pb.GeneratedMessage {
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(
    ...
    ..aOM<$560.Widget>(5, _omitFieldNames ? '' : 'widget',
        subBuilder: $560.Widget.create)
    ..hasRequiredFields = false;
  ...
  @$pb.TagNumber(5)
  $560.Widget get widget => $_getN(4);
  @$pb.TagNumber(5)
  set widget($560.Widget v) {
    setField(5, v);
  }
  ...
  @$pb.TagNumber(5)
  $560.Widget ensureWidget() => $_ensure(4);
}
