...
class GridLayout extends $pb.GeneratedMessage {
  factory GridLayout({
    ...
    $core.Iterable<$519.Widget>? widgets,
  }) {
    final $result = create();
    if (columns != null) {
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(_omitMessageNames ? '' : 'GridLayout', package: const $pb.PackageName(_omitMessageNames ? '' : 'google.monitoring.dashboard.v1'), createEmptyInstance: create)
    ...
    ..pc<$519.Widget>(2, _omitFieldNames ? '' : 'widgets', $pb.PbFieldType.PM, subBuilder: $519.Widget.create)
  ...
  @$pb.TagNumber(2)
  $core.List<$519.Widget> get widgets => $_getList(1);
}
...
class MosaicLayout_Tile extends $pb.GeneratedMessage {
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(_omitMessageNames ? '' : 'MosaicLayout.Tile', package: const $pb.PackageName(_omitMessageNames ? '' : 'google.monitoring.dashboard.v1'), createEmptyInstance: create)
    ...
    ..aOM<$519.Widget>(5, _omitFieldNames ? '' : 'widget', subBuilder: $519.Widget.create)
    ..hasRequiredFields = false
  ;
  ...
  @$pb.TagNumber(5)
  $519.Widget get widget => $_getN(4);
  @$pb.TagNumber(5)
  set widget($519.Widget v) { setField(5, v); }
  @$pb.TagNumber(5)
  $core.bool hasWidget() => $_has(4);
  @$pb.TagNumber(5)
  void clearWidget() => clearField(5);
  @$pb.TagNumber(5)
  $519.Widget ensureWidget() => $_ensure(4);
}
