...
class PickTimeSeriesFilter extends $pb.GeneratedMessage {
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(_omitMessageNames ? '' : 'PickTimeSeriesFilter', package: const $pb.PackageName(_omitMessageNames ? '' : 'google.monitoring.dashboard.v1'), createEmptyInstance: create)
    ...
    ..aOM<$4256.Interval>(4, _omitFieldNames ? '' : 'interval', subBuilder: $4256.Interval.create)
    ..hasRequiredFields = false
  ;
  ...
  @$pb.TagNumber(4)
  $4256.Interval get interval => $_getN(3);
  @$pb.TagNumber(4)
  set interval($4256.Interval v) { setField(4, v); }
  @$pb.TagNumber(4)
  $core.bool hasInterval() => $_has(3);
  @$pb.TagNumber(4)
  void clearInterval() => clearField(4);
  @$pb.TagNumber(4)
  $4256.Interval ensureInterval() => $_ensure(3);
}
