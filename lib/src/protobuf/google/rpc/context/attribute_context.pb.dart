...
class AttributeContext_Auth extends $pb.GeneratedMessage {
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(
    ...
    ..aOM<$7.Struct>(4, _omitFieldNames ? '' : 'claims',
...
class AttributeContext_Request extends $pb.GeneratedMessage {
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(
    ...
    ..aOM<$18.Timestamp>(9, _omitFieldNames ? '' : 'time',
  ...
  @$pb.TagNumber(9)
  $18.Timestamp ensureTime() => $_ensure(7);
...
class AttributeContext_Response extends $pb.GeneratedMessage {
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(
    ...
    ..m<$core.String, $core.String>(3, _omitFieldNames ? '' : 'headers',
        ...
        valueFieldType: $pb.PbFieldType.OS,
        packageName: const $pb.PackageName('google.rpc.context'))
    ..aOM<$18.Timestamp>(4, _omitFieldNames ? '' : 'time',
        subBuilder: $18.Timestamp.create)
    ..aOM<$10.Duration>(5, _omitFieldNames ? '' : 'backendLatency',
  ...
  @$pb.TagNumber(4)
  $18.Timestamp ensureTime() => $_ensure(3);
  ...
  @$pb.TagNumber(5)
  $10.Duration get backendLatency => $_getN(4);
  @$pb.TagNumber(5)
  set backendLatency($10.Duration v) {
    setField(5, v);
  }
  ...
  @$pb.TagNumber(5)
  $10.Duration ensureBackendLatency() => $_ensure(4);
}
...
class AttributeContext_Resource extends $pb.GeneratedMessage {
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(
    ...
    ..aOM<$18.Timestamp>(8, _omitFieldNames ? '' : 'createTime',
        subBuilder: $18.Timestamp.create)
    ..aOM<$18.Timestamp>(9, _omitFieldNames ? '' : 'updateTime',
        subBuilder: $18.Timestamp.create)
    ..aOM<$18.Timestamp>(10, _omitFieldNames ? '' : 'deleteTime',
        subBuilder: $18.Timestamp.create)
  ...
  @$pb.TagNumber(8)
  $18.Timestamp ensureCreateTime() => $_ensure(7);
  ...
  @$pb.TagNumber(9)
  $18.Timestamp ensureUpdateTime() => $_ensure(8);

  /// Output only. The timestamp when the resource was deleted.
  /// If the resource is not deleted, this must be empty.
  @$pb.TagNumber(10)
  $18.Timestamp get deleteTime => $_getN(9);
  @$pb.TagNumber(10)
  set deleteTime($18.Timestamp v) {
    setField(10, v);
  }
  ...
  @$pb.TagNumber(10)
  $18.Timestamp ensureDeleteTime() => $_ensure(9);
...
class AttributeContext extends $pb.GeneratedMessage {
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(
    ...
    ..aOM<AttributeContext_Peer>(7, _omitFieldNames ? '' : 'origin',
        subBuilder: AttributeContext_Peer.create)
    ..pc<$1.Any>(8, _omitFieldNames ? '' : 'extensions', $pb.PbFieldType.PM,
  ...
  @$pb.TagNumber(8)
  $core.List<$1.Any> get extensions => $_getList(7);
}
