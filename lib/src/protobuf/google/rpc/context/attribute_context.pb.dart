...
class AttributeContext_Auth extends $pb.GeneratedMessage {
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(_omitMessageNames ? '' : 'AttributeContext.Auth', package: const $pb.PackageName(_omitMessageNames ? '' : 'google.rpc.context'), createEmptyInstance: create)
    ...
    ..aOM<$258.Struct>(4, _omitFieldNames ? '' : 'claims', subBuilder: $258.Struct.create)
  ...
  ///  dependent structure.
  @$pb.TagNumber(4)
  $258.Struct get claims => $_getN(3);
  @$pb.TagNumber(4)
  set claims($258.Struct v) { setField(4, v); }
  @$pb.TagNumber(4)
  $core.bool hasClaims() => $_has(3);
  @$pb.TagNumber(4)
  void clearClaims() => clearField(4);
  @$pb.TagNumber(4)
  $258.Struct ensureClaims() => $_ensure(3);
...
class AttributeContext_Request extends $pb.GeneratedMessage {
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(_omitMessageNames ? '' : 'AttributeContext.Request', package: const $pb.PackageName(_omitMessageNames ? '' : 'google.rpc.context'), createEmptyInstance: create)
    ...
    ..aOM<$299.Timestamp>(9, _omitFieldNames ? '' : 'time', subBuilder: $299.Timestamp.create)
  ...
  /// the request.
  @$pb.TagNumber(9)
  $299.Timestamp get time => $_getN(7);
  @$pb.TagNumber(9)
  set time($299.Timestamp v) { setField(9, v); }
  @$pb.TagNumber(9)
  $core.bool hasTime() => $_has(7);
  @$pb.TagNumber(9)
  void clearTime() => clearField(9);
  @$pb.TagNumber(9)
  $299.Timestamp ensureTime() => $_ensure(7);
...
class AttributeContext_Response extends $pb.GeneratedMessage {
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(_omitMessageNames ? '' : 'AttributeContext.Response', package: const $pb.PackageName(_omitMessageNames ? '' : 'google.rpc.context'), createEmptyInstance: create)
    ...
    ..aOM<$299.Timestamp>(4, _omitFieldNames ? '' : 'time', subBuilder: $299.Timestamp.create)
    ..aOM<$261.Duration>(5, _omitFieldNames ? '' : 'backendLatency', subBuilder: $261.Duration.create)
    ..hasRequiredFields = false
  ;
  ...
  /// the response.
  @$pb.TagNumber(4)
  $299.Timestamp get time => $_getN(3);
  @$pb.TagNumber(4)
  set time($299.Timestamp v) { setField(4, v); }
  @$pb.TagNumber(4)
  $core.bool hasTime() => $_has(3);
  @$pb.TagNumber(4)
  void clearTime() => clearField(4);
  @$pb.TagNumber(4)
  $299.Timestamp ensureTime() => $_ensure(3);
  ...
  @$pb.TagNumber(5)
  $261.Duration get backendLatency => $_getN(4);
  @$pb.TagNumber(5)
  set backendLatency($261.Duration v) { setField(5, v); }
  @$pb.TagNumber(5)
  $core.bool hasBackendLatency() => $_has(4);
  @$pb.TagNumber(5)
  void clearBackendLatency() => clearField(5);
  @$pb.TagNumber(5)
  $261.Duration ensureBackendLatency() => $_ensure(4);
}
...
class AttributeContext_Resource extends $pb.GeneratedMessage {
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(_omitMessageNames ? '' : 'AttributeContext.Resource', package: const $pb.PackageName(_omitMessageNames ? '' : 'google.rpc.context'), createEmptyInstance: create)
    ...
    ..aOM<$299.Timestamp>(10, _omitFieldNames ? '' : 'deleteTime', subBuilder: $299.Timestamp.create)
  ...
  @$pb.TagNumber(10)
  $299.Timestamp get deleteTime => $_getN(9);
  @$pb.TagNumber(10)
  set deleteTime($299.Timestamp v) { setField(10, v); }
  @$pb.TagNumber(10)
  $core.bool hasDeleteTime() => $_has(9);
  @$pb.TagNumber(10)
  void clearDeleteTime() => clearField(10);
  @$pb.TagNumber(10)
  $299.Timestamp ensureDeleteTime() => $_ensure(9);
...
class AttributeContext extends $pb.GeneratedMessage {
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(_omitMessageNames ? '' : 'AttributeContext', package: const $pb.PackageName(_omitMessageNames ? '' : 'google.rpc.context'), createEmptyInstance: create)
    ...
    ..pc<$318.Any>(8, _omitFieldNames ? '' : 'extensions', $pb.PbFieldType.PM, subBuilder: $318.Any.create)
    ..hasRequiredFields = false
  ;
  ...
  @$pb.TagNumber(8)
  $core.List<$318.Any> get extensions => $_getList(7);
}
