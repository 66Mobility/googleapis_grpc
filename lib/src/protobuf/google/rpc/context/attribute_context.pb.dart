...
class AttributeContext_Auth extends $pb.GeneratedMessage {
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(_omitMessageNames ? '' : 'AttributeContext.Auth', package: const $pb.PackageName(_omitMessageNames ? '' : 'google.rpc.context'), createEmptyInstance: create)
    ...
    ..aOM<$261.Struct>(4, _omitFieldNames ? '' : 'claims', subBuilder: $261.Struct.create)
  ...
  ///  dependent structure.
  @$pb.TagNumber(4)
  $261.Struct get claims => $_getN(3);
  @$pb.TagNumber(4)
  set claims($261.Struct v) { setField(4, v); }
  @$pb.TagNumber(4)
  $core.bool hasClaims() => $_has(3);
  @$pb.TagNumber(4)
  void clearClaims() => clearField(4);
  @$pb.TagNumber(4)
  $261.Struct ensureClaims() => $_ensure(3);
...
class AttributeContext_Request extends $pb.GeneratedMessage {
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(_omitMessageNames ? '' : 'AttributeContext.Request', package: const $pb.PackageName(_omitMessageNames ? '' : 'google.rpc.context'), createEmptyInstance: create)
    ...
    ..aOM<$302.Timestamp>(9, _omitFieldNames ? '' : 'time', subBuilder: $302.Timestamp.create)
  ...
  /// the request.
  @$pb.TagNumber(9)
  $302.Timestamp get time => $_getN(7);
  @$pb.TagNumber(9)
  set time($302.Timestamp v) { setField(9, v); }
  @$pb.TagNumber(9)
  $core.bool hasTime() => $_has(7);
  @$pb.TagNumber(9)
  void clearTime() => clearField(9);
  @$pb.TagNumber(9)
  $302.Timestamp ensureTime() => $_ensure(7);
...
class AttributeContext_Response extends $pb.GeneratedMessage {
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(_omitMessageNames ? '' : 'AttributeContext.Response', package: const $pb.PackageName(_omitMessageNames ? '' : 'google.rpc.context'), createEmptyInstance: create)
    ...
    ..aOM<$302.Timestamp>(4, _omitFieldNames ? '' : 'time', subBuilder: $302.Timestamp.create)
    ..aOM<$264.Duration>(5, _omitFieldNames ? '' : 'backendLatency', subBuilder: $264.Duration.create)
    ..hasRequiredFields = false
  ;
  ...
  /// the response.
  @$pb.TagNumber(4)
  $302.Timestamp get time => $_getN(3);
  @$pb.TagNumber(4)
  set time($302.Timestamp v) { setField(4, v); }
  @$pb.TagNumber(4)
  $core.bool hasTime() => $_has(3);
  @$pb.TagNumber(4)
  void clearTime() => clearField(4);
  @$pb.TagNumber(4)
  $302.Timestamp ensureTime() => $_ensure(3);
  ...
  @$pb.TagNumber(5)
  $264.Duration get backendLatency => $_getN(4);
  @$pb.TagNumber(5)
  set backendLatency($264.Duration v) { setField(5, v); }
  @$pb.TagNumber(5)
  $core.bool hasBackendLatency() => $_has(4);
  @$pb.TagNumber(5)
  void clearBackendLatency() => clearField(5);
  @$pb.TagNumber(5)
  $264.Duration ensureBackendLatency() => $_ensure(4);
}
...
class AttributeContext_Resource extends $pb.GeneratedMessage {
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(_omitMessageNames ? '' : 'AttributeContext.Resource', package: const $pb.PackageName(_omitMessageNames ? '' : 'google.rpc.context'), createEmptyInstance: create)
    ...
    ..aOM<$302.Timestamp>(10, _omitFieldNames ? '' : 'deleteTime', subBuilder: $302.Timestamp.create)
  ...
  @$pb.TagNumber(10)
  $302.Timestamp get deleteTime => $_getN(9);
  @$pb.TagNumber(10)
  set deleteTime($302.Timestamp v) { setField(10, v); }
  @$pb.TagNumber(10)
  $core.bool hasDeleteTime() => $_has(9);
  @$pb.TagNumber(10)
  void clearDeleteTime() => clearField(10);
  @$pb.TagNumber(10)
  $302.Timestamp ensureDeleteTime() => $_ensure(9);
...
class AttributeContext extends $pb.GeneratedMessage {
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(_omitMessageNames ? '' : 'AttributeContext', package: const $pb.PackageName(_omitMessageNames ? '' : 'google.rpc.context'), createEmptyInstance: create)
    ...
    ..pc<$321.Any>(8, _omitFieldNames ? '' : 'extensions', $pb.PbFieldType.PM, subBuilder: $321.Any.create)
    ..hasRequiredFields = false
  ;
  ...
  @$pb.TagNumber(8)
  $core.List<$321.Any> get extensions => $_getList(7);
}
