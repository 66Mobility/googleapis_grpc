...
class AuditContext extends $pb.GeneratedMessage {
  factory AuditContext({
    ...
    $7.Struct? scrubbedRequest,
    $7.Struct? scrubbedResponse,
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(
    ...
    ..aOM<$7.Struct>(2, _omitFieldNames ? '' : 'scrubbedRequest',
        subBuilder: $7.Struct.create)
    ..aOM<$7.Struct>(3, _omitFieldNames ? '' : 'scrubbedResponse',
        subBuilder: $7.Struct.create)
  ...
  @$pb.TagNumber(2)
  $7.Struct ensureScrubbedRequest() => $_ensure(1);
  ...
  /// Logs and Google internal audit logs.
  @$pb.TagNumber(3)
  $7.Struct get scrubbedResponse => $_getN(2);
  @$pb.TagNumber(3)
  set scrubbedResponse($7.Struct v) {
    setField(3, v);
  }
  ...
  @$pb.TagNumber(3)
  $7.Struct ensureScrubbedResponse() => $_ensure(2);
