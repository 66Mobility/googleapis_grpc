...
class EmbeddedAssistantClient extends $grpc.Client {
  static final _$assist = $grpc.ClientMethod<$86.AssistRequest, $86.AssistResponse>(
      '/google.assistant.embedded.v1alpha2.EmbeddedAssistant/Assist',
      ($86.AssistRequest value) => value.writeToBuffer(),
      ($core.List<$core.int> value) => $86.AssistResponse.fromBuffer(value));
  ...
  $grpc.ResponseStream<$86.AssistResponse> assist($async.Stream<$86.AssistRequest> request, {$grpc.CallOptions? options}) {
...
abstract class EmbeddedAssistantServiceBase extends $grpc.Service {
  ...
  $async.Stream<$86.AssistResponse> assist($grpc.ServiceCall call, $async.Stream<$86.AssistRequest> request);
}
