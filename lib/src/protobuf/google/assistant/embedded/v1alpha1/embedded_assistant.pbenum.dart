...
class ConverseResult_MicrophoneMode extends $pb.ProtobufEnum {
  static const ConverseResult_MicrophoneMode MICROPHONE_MODE_UNSPECIFIED = ConverseResult_MicrophoneMode._(0, _omitEnumNames ? '' : 'MICROPHONE_MODE_UNSPECIFIED');
  static const ConverseResult_MicrophoneMode CLOSE_MICROPHONE = ConverseResult_MicrophoneMode._(1, _omitEnumNames ? '' : 'CLOSE_MICROPHONE');
  static const ConverseResult_MicrophoneMode DIALOG_FOLLOW_ON = ConverseResult_MicrophoneMode._(2, _omitEnumNames ? '' : 'DIALOG_FOLLOW_ON');
...
class ConverseResponse_EventType extends $pb.ProtobufEnum {
  static const ConverseResponse_EventType EVENT_TYPE_UNSPECIFIED = ConverseResponse_EventType._(0, _omitEnumNames ? '' : 'EVENT_TYPE_UNSPECIFIED');
  static const ConverseResponse_EventType END_OF_UTTERANCE = ConverseResponse_EventType._(1, _omitEnumNames ? '' : 'END_OF_UTTERANCE');
