...
class GoFeatures extends $pb.GeneratedMessage {
  ...
  GoFeatures._() : super();
  factory GoFeatures.fromBuffer($core.List<$core.int> i,
          [$pb.ExtensionRegistry r = $pb.ExtensionRegistry.EMPTY]) =>
      create()..mergeFromBuffer(i, r);
  factory GoFeatures.fromJson($core.String i,
          [$pb.ExtensionRegistry r = $pb.ExtensionRegistry.EMPTY]) =>
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(
    ...
    ..e<GoFeatures_APILevel>(
        2, _omitFieldNames ? '' : 'apiLevel', $pb.PbFieldType.OE,
        defaultOrMaker: GoFeatures_APILevel.API_LEVEL_UNSPECIFIED,
        valueOf: GoFeatures_APILevel.valueOf,
  ...
  @$pb.TagNumber(1)
  set legacyUnmarshalJsonEnum($core.bool v) {
    $_setBool(0, v);
  }
  ...
  @$pb.TagNumber(2)
  set apiLevel(GoFeatures_APILevel v) {
    setField(2, v);
  }
