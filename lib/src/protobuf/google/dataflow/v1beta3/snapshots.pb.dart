...
class Snapshot extends $pb.GeneratedMessage {
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(_omitMessageNames ? '' : 'Snapshot', package: const $pb.PackageName(_omitMessageNames ? '' : 'google.dataflow.v1beta3'), createEmptyInstance: create)
    ...
    ..aOM<$1737.Duration>(5, _omitFieldNames ? '' : 'ttl', subBuilder: $1737.Duration.create)
  ...
  @$pb.TagNumber(5)
  $1737.Duration get ttl => $_getN(4);
  @$pb.TagNumber(5)
  set ttl($1737.Duration v) { setField(5, v); }
  @$pb.TagNumber(5)
  $core.bool hasTtl() => $_has(4);
  @$pb.TagNumber(5)
  void clearTtl() => clearField(5);
  @$pb.TagNumber(5)
  $1737.Duration ensureTtl() => $_ensure(4);
