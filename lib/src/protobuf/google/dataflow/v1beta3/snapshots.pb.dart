...
class Snapshot extends $pb.GeneratedMessage {
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(
    ...
    ..aOM<$330.Timestamp>(4, _omitFieldNames ? '' : 'creationTime',
        subBuilder: $330.Timestamp.create)
    ..aOM<$292.Duration>(5, _omitFieldNames ? '' : 'ttl',
  ...
  @$pb.TagNumber(4)
  $330.Timestamp get creationTime => $_getN(3);
  @$pb.TagNumber(4)
  ...
  @$pb.TagNumber(4)
  $330.Timestamp ensureCreationTime() => $_ensure(3);

  /// The time after which this snapshot will be automatically deleted.
  @$pb.TagNumber(5)
  $292.Duration get ttl => $_getN(4);
  @$pb.TagNumber(5)
  ...
  @$pb.TagNumber(5)
  $292.Duration ensureTtl() => $_ensure(4);
