...
class MetricUpdate extends $pb.GeneratedMessage {
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(
    ...
    ..aOM<$289.Value>(4, _omitFieldNames ? '' : 'scalar',
        subBuilder: $289.Value.create)
    ..aOM<$289.Value>(5, _omitFieldNames ? '' : 'meanSum',
        subBuilder: $289.Value.create)
    ..aOM<$289.Value>(6, _omitFieldNames ? '' : 'meanCount',
        subBuilder: $289.Value.create)
    ..aOM<$289.Value>(7, _omitFieldNames ? '' : 'set',
        subBuilder: $289.Value.create)
    ..aOM<$289.Value>(8, _omitFieldNames ? '' : 'internal',
        subBuilder: $289.Value.create)
    ..aOM<$330.Timestamp>(9, _omitFieldNames ? '' : 'updateTime',
        subBuilder: $330.Timestamp.create)
    ..aOM<$289.Value>(11, _omitFieldNames ? '' : 'distribution',
        subBuilder: $289.Value.create)
    ..aOM<$289.Value>(12, _omitFieldNames ? '' : 'gauge',
        subBuilder: $289.Value.create)
    ..hasRequiredFields = false;
  ...
  @$pb.TagNumber(4)
  $289.Value get scalar => $_getN(3);
  @$pb.TagNumber(4)
  set scalar($289.Value v) {
    setField(4, v);
  }
  ...
  @$pb.TagNumber(4)
  $289.Value ensureScalar() => $_ensure(3);
  ...
  @$pb.TagNumber(5)
  $289.Value get meanSum => $_getN(4);
  @$pb.TagNumber(5)
  set meanSum($289.Value v) {
    setField(5, v);
  }
  ...
  @$pb.TagNumber(5)
  $289.Value ensureMeanSum() => $_ensure(4);
  ...
  @$pb.TagNumber(6)
  $289.Value get meanCount => $_getN(5);
  @$pb.TagNumber(6)
  set meanCount($289.Value v) {
    setField(6, v);
  }
  ...
  @$pb.TagNumber(6)
  $289.Value ensureMeanCount() => $_ensure(5);
  ...
  @$pb.TagNumber(7)
  $289.Value ensureSet() => $_ensure(6);

  /// Worker-computed aggregate value for internal use by the Dataflow
  /// service.
  @$pb.TagNumber(8)
  $289.Value get internal => $_getN(7);
  @$pb.TagNumber(8)
  set internal($289.Value v) {
    setField(8, v);
  }
  ...
  @$pb.TagNumber(8)
  $289.Value ensureInternal() => $_ensure(7);
  ...
  @$pb.TagNumber(11)
  $289.Value get distribution => $_getN(9);
  @$pb.TagNumber(11)
  set distribution($289.Value v) {
    setField(11, v);
  }
  ...
  @$pb.TagNumber(11)
  $289.Value ensureDistribution() => $_ensure(9);

  /// A struct value describing properties of a Gauge.
  /// Metrics of gauge type show the value of a metric across time, and is
  /// aggregated based on the newest value.
  @$pb.TagNumber(12)
  $289.Value get gauge => $_getN(10);
  @$pb.TagNumber(12)
  set gauge($289.Value v) {
    setField(12, v);
  }
  ...
  @$pb.TagNumber(12)
  $289.Value ensureGauge() => $_ensure(10);
}
...
class JobMetrics extends $pb.GeneratedMessage {
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(
      ...
      package: const $pb.PackageName(
          _omitMessageNames ? '' : 'google.dataflow.v1beta3'),
      createEmptyInstance: create)
    ..aOM<$330.Timestamp>(1, _omitFieldNames ? '' : 'metricTime',
        subBuilder: $330.Timestamp.create)
  ...
  @$pb.TagNumber(1)
  $330.Timestamp get metricTime => $_getN(0);
  @$pb.TagNumber(1)
  set metricTime($330.Timestamp v) {
    setField(1, v);
  }
  ...
  @$pb.TagNumber(1)
  $330.Timestamp ensureMetricTime() => $_ensure(0);
...
class ProgressTimeseries_Point extends $pb.GeneratedMessage {
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(
      ...
      package: const $pb.PackageName(
          _omitMessageNames ? '' : 'google.dataflow.v1beta3'),
      createEmptyInstance: create)
    ..aOM<$330.Timestamp>(1, _omitFieldNames ? '' : 'time',
        subBuilder: $330.Timestamp.create)
  ...
  @$pb.TagNumber(1)
  $330.Timestamp get time => $_getN(0);
  @$pb.TagNumber(1)
  ...
  @$pb.TagNumber(1)
  $330.Timestamp ensureTime() => $_ensure(0);
...
class GetStageExecutionDetailsRequest extends $pb.GeneratedMessage {
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(
    ...
    ..aOM<$330.Timestamp>(7, _omitFieldNames ? '' : 'startTime',
        subBuilder: $330.Timestamp.create)
    ..aOM<$330.Timestamp>(8, _omitFieldNames ? '' : 'endTime',
        subBuilder: $330.Timestamp.create)
    ..hasRequiredFields = false;
  ...
  @$pb.TagNumber(7)
  $330.Timestamp get startTime => $_getN(6);
  @$pb.TagNumber(7)
  set startTime($330.Timestamp v) {
    setField(7, v);
  }
  ...
  @$pb.TagNumber(7)
  $330.Timestamp ensureStartTime() => $_ensure(6);

  /// Upper time bound of work items to include, by start time.
  @$pb.TagNumber(8)
  $330.Timestamp get endTime => $_getN(7);
  @$pb.TagNumber(8)
  set endTime($330.Timestamp v) {
    setField(8, v);
  }
  ...
  @$pb.TagNumber(8)
  $330.Timestamp ensureEndTime() => $_ensure(7);
}
