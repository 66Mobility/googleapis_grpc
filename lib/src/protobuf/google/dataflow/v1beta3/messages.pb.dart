...
class StructuredMessage_Parameter extends $pb.GeneratedMessage {
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(
    ...
    ..aOM<$289.Value>(2, _omitFieldNames ? '' : 'value',
  ...
  @$pb.TagNumber(2)
  $289.Value ensureValue() => $_ensure(1);
}
...
class AutoscalingEvent extends $pb.GeneratedMessage {
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(
    ...
    ..aOM<$330.Timestamp>(5, _omitFieldNames ? '' : 'time',
        subBuilder: $330.Timestamp.create)
  ...
  /// num_workers value.
  @$pb.TagNumber(5)
  $330.Timestamp get time => $_getN(4);
  @$pb.TagNumber(5)
  set time($330.Timestamp v) {
    setField(5, v);
  }
  ...
  @$pb.TagNumber(5)
  $330.Timestamp ensureTime() => $_ensure(4);
...
class ListJobMessagesRequest extends $pb.GeneratedMessage {
  ...
  @$pb.TagNumber(6)
  $330.Timestamp get startTime => $_getN(5);
  @$pb.TagNumber(6)
  ...
  @$pb.TagNumber(6)
  $330.Timestamp ensureStartTime() => $_ensure(5);

  /// Return only messages with timestamps < end_time. The default is now
  /// (i.e. return up to the latest messages available).
  @$pb.TagNumber(7)
  $330.Timestamp get endTime => $_getN(6);
  @$pb.TagNumber(7)
  ...
  @$pb.TagNumber(7)
  $330.Timestamp ensureEndTime() => $_ensure(6);
