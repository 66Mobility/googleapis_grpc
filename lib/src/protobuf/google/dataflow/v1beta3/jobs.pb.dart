...
import 'environment.pb.dart' as $4744;
import 'environment.pbenum.dart' as $4744;
...
class Job extends $pb.GeneratedMessage {
  factory Job({
    ...
    $core.String? name,
    $4744.JobType? type,
    $4744.Environment? environment,
    $core.Iterable<Step>? steps,
    JobState? currentState,
    $1775.Timestamp? currentStateTime,
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(_omitMessageNames ? '' : 'Job', package: const $pb.PackageName(_omitMessageNames ? '' : 'google.dataflow.v1beta3'), createEmptyInstance: create)
    ...
    ..e<$4744.JobType>(4, _omitFieldNames ? '' : 'type', $pb.PbFieldType.OE, defaultOrMaker: $4744.JobType.JOB_TYPE_UNKNOWN, valueOf: $4744.JobType.valueOf, enumValues: $4744.JobType.values)
    ..aOM<$4744.Environment>(5, _omitFieldNames ? '' : 'environment', subBuilder: $4744.Environment.create)
    ...
    ..aOM<$1775.Timestamp>(8, _omitFieldNames ? '' : 'currentStateTime', subBuilder: $1775.Timestamp.create)
  ...
  @$pb.TagNumber(4)
  $4744.JobType get type => $_getN(3);
  @$pb.TagNumber(4)
  set type($4744.JobType v) { setField(4, v); }
  @$pb.TagNumber(4)
  ...
  @$pb.TagNumber(5)
  $4744.Environment get environment => $_getN(4);
  @$pb.TagNumber(5)
  set environment($4744.Environment v) { setField(5, v); }
  @$pb.TagNumber(5)
  $core.bool hasEnvironment() => $_has(4);
  @$pb.TagNumber(5)
  void clearEnvironment() => clearField(5);
  @$pb.TagNumber(5)
  $4744.Environment ensureEnvironment() => $_ensure(4);
  ...
  @$pb.TagNumber(8)
  $1775.Timestamp get currentStateTime => $_getN(7);
  @$pb.TagNumber(8)
  set currentStateTime($1775.Timestamp v) { setField(8, v); }
  @$pb.TagNumber(8)
  $core.bool hasCurrentStateTime() => $_has(7);
  @$pb.TagNumber(8)
  void clearCurrentStateTime() => clearField(8);
  @$pb.TagNumber(8)
  $1775.Timestamp ensureCurrentStateTime() => $_ensure(7);
...
class ExecutionStageState extends $pb.GeneratedMessage {
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(_omitMessageNames ? '' : 'ExecutionStageState', package: const $pb.PackageName(_omitMessageNames ? '' : 'google.dataflow.v1beta3'), createEmptyInstance: create)
    ...
    ..aOM<$1775.Timestamp>(3, _omitFieldNames ? '' : 'currentStateTime', subBuilder: $1775.Timestamp.create)
    ..hasRequiredFields = false
  ;
  ...
  @$pb.TagNumber(3)
  $1775.Timestamp get currentStateTime => $_getN(2);
  @$pb.TagNumber(3)
  set currentStateTime($1775.Timestamp v) { setField(3, v); }
  @$pb.TagNumber(3)
  $core.bool hasCurrentStateTime() => $_has(2);
  @$pb.TagNumber(3)
  void clearCurrentStateTime() => clearField(3);
  @$pb.TagNumber(3)
  $1775.Timestamp ensureCurrentStateTime() => $_ensure(2);
}
...
class DisplayData extends $pb.GeneratedMessage {
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(_omitMessageNames ? '' : 'DisplayData', package: const $pb.PackageName(_omitMessageNames ? '' : 'google.dataflow.v1beta3'), createEmptyInstance: create)
    ...
    ..aOM<$1737.Duration>(9, _omitFieldNames ? '' : 'durationValue', subBuilder: $1737.Duration.create)
  ...
  @$pb.TagNumber(8)
  $1775.Timestamp get timestampValue => $_getN(6);
  @$pb.TagNumber(8)
  ...
  @$pb.TagNumber(8)
  $1775.Timestamp ensureTimestampValue() => $_ensure(6);

  /// Contains value if the data is of duration type.
  @$pb.TagNumber(9)
  $1737.Duration get durationValue => $_getN(7);
  @$pb.TagNumber(9)
  set durationValue($1737.Duration v) { setField(9, v); }
  @$pb.TagNumber(9)
  $core.bool hasDurationValue() => $_has(7);
  @$pb.TagNumber(9)
  void clearDurationValue() => clearField(9);
  @$pb.TagNumber(9)
  $1737.Duration ensureDurationValue() => $_ensure(7);
...
class Step extends $pb.GeneratedMessage {
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(_omitMessageNames ? '' : 'Step', package: const $pb.PackageName(_omitMessageNames ? '' : 'google.dataflow.v1beta3'), createEmptyInstance: create)
    ...
    ..aOS(2, _omitFieldNames ? '' : 'name')
    ..aOM<$1734.Struct>(3, _omitFieldNames ? '' : 'properties', subBuilder: $1734.Struct.create)
    ..hasRequiredFields = false
  ;
  ...
  @$pb.TagNumber(3)
  $1734.Struct get properties => $_getN(2);
  @$pb.TagNumber(3)
  set properties($1734.Struct v) { setField(3, v); }
  @$pb.TagNumber(3)
  $core.bool hasProperties() => $_has(2);
  @$pb.TagNumber(3)
  void clearProperties() => clearField(3);
  @$pb.TagNumber(3)
  $1734.Struct ensureProperties() => $_ensure(2);
}
