...
import 'environment.pb.dart' as $4746;
import 'environment.pbenum.dart' as $4746;
...
class Job extends $pb.GeneratedMessage {
  factory Job({
    ...
    $core.String? name,
    $4746.JobType? type,
    $4746.Environment? environment,
    $core.Iterable<Step>? steps,
    JobState? currentState,
    $1776.Timestamp? currentStateTime,
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(_omitMessageNames ? '' : 'Job', package: const $pb.PackageName(_omitMessageNames ? '' : 'google.dataflow.v1beta3'), createEmptyInstance: create)
    ...
    ..e<$4746.JobType>(4, _omitFieldNames ? '' : 'type', $pb.PbFieldType.OE, defaultOrMaker: $4746.JobType.JOB_TYPE_UNKNOWN, valueOf: $4746.JobType.valueOf, enumValues: $4746.JobType.values)
    ..aOM<$4746.Environment>(5, _omitFieldNames ? '' : 'environment', subBuilder: $4746.Environment.create)
    ...
    ..aOM<$1776.Timestamp>(8, _omitFieldNames ? '' : 'currentStateTime', subBuilder: $1776.Timestamp.create)
  ...
  @$pb.TagNumber(4)
  $4746.JobType get type => $_getN(3);
  @$pb.TagNumber(4)
  set type($4746.JobType v) { setField(4, v); }
  @$pb.TagNumber(4)
  ...
  @$pb.TagNumber(5)
  $4746.Environment get environment => $_getN(4);
  @$pb.TagNumber(5)
  set environment($4746.Environment v) { setField(5, v); }
  @$pb.TagNumber(5)
  $core.bool hasEnvironment() => $_has(4);
  @$pb.TagNumber(5)
  void clearEnvironment() => clearField(5);
  @$pb.TagNumber(5)
  $4746.Environment ensureEnvironment() => $_ensure(4);
  ...
  @$pb.TagNumber(8)
  $1776.Timestamp get currentStateTime => $_getN(7);
  @$pb.TagNumber(8)
  set currentStateTime($1776.Timestamp v) { setField(8, v); }
  @$pb.TagNumber(8)
  $core.bool hasCurrentStateTime() => $_has(7);
  @$pb.TagNumber(8)
  void clearCurrentStateTime() => clearField(8);
  @$pb.TagNumber(8)
  $1776.Timestamp ensureCurrentStateTime() => $_ensure(7);
...
class ExecutionStageState extends $pb.GeneratedMessage {
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(_omitMessageNames ? '' : 'ExecutionStageState', package: const $pb.PackageName(_omitMessageNames ? '' : 'google.dataflow.v1beta3'), createEmptyInstance: create)
    ...
    ..aOM<$1776.Timestamp>(3, _omitFieldNames ? '' : 'currentStateTime', subBuilder: $1776.Timestamp.create)
    ..hasRequiredFields = false
  ;
  ...
  @$pb.TagNumber(3)
  $1776.Timestamp get currentStateTime => $_getN(2);
  @$pb.TagNumber(3)
  set currentStateTime($1776.Timestamp v) { setField(3, v); }
  @$pb.TagNumber(3)
  $core.bool hasCurrentStateTime() => $_has(2);
  @$pb.TagNumber(3)
  void clearCurrentStateTime() => clearField(3);
  @$pb.TagNumber(3)
  $1776.Timestamp ensureCurrentStateTime() => $_ensure(2);
}
...
class DisplayData extends $pb.GeneratedMessage {
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(_omitMessageNames ? '' : 'DisplayData', package: const $pb.PackageName(_omitMessageNames ? '' : 'google.dataflow.v1beta3'), createEmptyInstance: create)
    ...
    ..aOM<$1738.Duration>(9, _omitFieldNames ? '' : 'durationValue', subBuilder: $1738.Duration.create)
  ...
  @$pb.TagNumber(8)
  $1776.Timestamp get timestampValue => $_getN(6);
  @$pb.TagNumber(8)
  ...
  @$pb.TagNumber(8)
  $1776.Timestamp ensureTimestampValue() => $_ensure(6);

  /// Contains value if the data is of duration type.
  @$pb.TagNumber(9)
  $1738.Duration get durationValue => $_getN(7);
  @$pb.TagNumber(9)
  set durationValue($1738.Duration v) { setField(9, v); }
  @$pb.TagNumber(9)
  $core.bool hasDurationValue() => $_has(7);
  @$pb.TagNumber(9)
  void clearDurationValue() => clearField(9);
  @$pb.TagNumber(9)
  $1738.Duration ensureDurationValue() => $_ensure(7);
...
class Step extends $pb.GeneratedMessage {
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(_omitMessageNames ? '' : 'Step', package: const $pb.PackageName(_omitMessageNames ? '' : 'google.dataflow.v1beta3'), createEmptyInstance: create)
    ...
    ..aOS(2, _omitFieldNames ? '' : 'name')
    ..aOM<$1735.Struct>(3, _omitFieldNames ? '' : 'properties', subBuilder: $1735.Struct.create)
    ..hasRequiredFields = false
  ;
  ...
  @$pb.TagNumber(3)
  $1735.Struct get properties => $_getN(2);
  @$pb.TagNumber(3)
  set properties($1735.Struct v) { setField(3, v); }
  @$pb.TagNumber(3)
  $core.bool hasProperties() => $_has(2);
  @$pb.TagNumber(3)
  void clearProperties() => clearField(3);
  @$pb.TagNumber(3)
  $1735.Struct ensureProperties() => $_ensure(2);
}
